...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.end ], [ 0, %for.cond ]
  %cmp3 = icmp sgt i32 %3, 0
  br i1 %cmp3, label %for.cond5.preheader, label %for.cond

for.cond5.preheader:                              ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @matrix, i64 0, i64 %indvars.iv
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.body8
  %4 = phi i32 [ %2, %for.cond5.preheader ], [ %.pre23, %for.body8 ]
  %cmp7 = icmp sgt i32 %4, 0
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond5
  %call11 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
...
for.cond115:                                      ; preds = %for.cond, %for.body118
  %5 = phi i32 [ %.pre22, %for.body118 ], [ %1, %for.cond ]
  %cmp117 = icmp sgt i32 %5, 0
