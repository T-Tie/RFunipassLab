...
for.cond:                                         ; preds = %sw.epilog, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc20.i4, %sw.epilog ]
...
sw.epilog:                                        ; preds = %for.cond4.preheader, %for.cond
  %i.1 = phi i32 [ %i.0, %for.cond ], [ -1, %for.cond4.preheader ]
  %inc20.i4 = add nsw i32 %i.1, 1
  br label %for.cond
}
