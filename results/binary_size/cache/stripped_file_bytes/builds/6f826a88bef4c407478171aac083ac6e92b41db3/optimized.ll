...
entry:
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv33 = phi i32 [ %indvars.iv.next34, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv28 = phi i32 [ %indvars.iv.next29, %for.inc29 ], [ 0, %entry ]
  ...
  br i1 %exitcond24.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv19
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = add nuw nsw i64 %indvars.iv, %indvars.iv19
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv25 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next26, %for.inc40 ]
  %exitcond32.not = icmp eq i64 %indvars.iv25, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv25
  %5 = load i8, ptr %arrayidx37, align 1, !tbaa !5, !invariant.load !8
  %conv38 = sext i8 %5 to i32
  %putchar14 = call i32 @putchar(i32 noundef %conv38) #7
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv33 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc53 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv36, %7
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv36
