...
for.cond25.preheader:                             ; preds = %for.cond
  ...
  %smax = call i32 @llvm.smax.i32(i32 %sub26, i32 0)
...
for.cond6:                                        ; preds = %for.body8, %for.body
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.body8 ], [ %indvars.iv, %for.body ]
  %f.1 = phi i32 [ %spec.select, %for.body8 ], [ 0, %for.body ]
  %cmp7 = icmp sgt i64 %indvars.iv2, 0
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond6
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, -1
  %arrayidx10 = getelementptr inbounds nuw [300 x i32], ptr %w, i64 0, i64 %indvars.iv.next3
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc32
  %indvars.iv6 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next7, %for.inc32 ]
...
for.inc32:                                        ; preds = %for.cond25
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv6
