...
entry:
  ...
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) @strin) #11
...
for.cond:                                         ; preds = %for.end42, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.end42 ], [ 0, %entry ]
  %maxtime.0 = phi i32 [ %spec.select, %for.end42 ], [ 0, %entry ]
  %exitcond24 = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24, label %for.end50, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond
  br i1 %cmp5, label %for.cond4, label %for.cond9.preheader

for.cond4:                                        ; preds = %for.cond4.preheader, %for.cond4
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond4 ], [ 0, %for.cond4.preheader ]
  %arrayidx = getelementptr inbounds nuw [503 x i8], ptr @strin, i64 0, i64 %indvars.iv25
  %4 = load i8, ptr %arrayidx, align 1, !tbaa !9, !invariant.load !10
  %arrayidx8 = getelementptr inbounds nuw [10 x i8], ptr @str2, i64 0, i64 %indvars.iv25
  store i8 %4, ptr %arrayidx8, align 1, !tbaa !9
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond4

for.cond9.preheader:                              ; preds = %for.cond4.preheader
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr @jilu, i64 0, i64 %indvars.iv20
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc40
  %indvars.iv = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next, %for.inc40 ]
  %exitcond = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond, label %for.end42, label %for.body12
...
for.body12:                                       ; preds = %for.cond9
  ...
  br i1 %cmp15, label %for.inc40, label %if.end39

if.end39:                                         ; preds = %for.body12
...
for.inc40:                                        ; preds = %for.body12, %if.end39
...
for.end42:                                        ; preds = %for.cond9
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %maxtime.0, i32 %7)
...
for.cond56:                                       ; preds = %if.end75, %if.else
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %if.end75 ], [ 0, %if.else ]
...
for.cond64:                                       ; preds = %for.body59, %for.body66
  ...
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body66 ], [ 0, %for.body59 ]
  %cmp65 = icmp sgt i32 %10, 0
  br i1 %cmp65, label %for.body66, label %for.end73

for.body66:                                       ; preds = %for.cond64
  %11 = add nuw nsw i64 %indvars.iv29, %indvars.iv33
