...
for.cond:                                         ; preds = %if.end15, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc23, %if.end15 ]
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %4 = call i32 @llvm.smin.i32(i32 %2, i32 %1)
...
for.cond3:                                        ; preds = %for.body5, %if.end
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body5 ], [ %smin, %if.end ]
  %d.0 = phi i32 [ %add, %for.body5 ], [ 0, %if.end ]
