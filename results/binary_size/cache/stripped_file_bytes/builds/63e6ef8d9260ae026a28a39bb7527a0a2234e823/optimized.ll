...
for.cond16:                                       ; preds = %for.end10, %for.inc30
  ...
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc30 ], [ 1, %for.end10 ]
  %7 = sext i32 %6 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv41, %7
...
for.cond33.preheader:                             ; preds = %for.cond16
  ...
  %smax51 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %11 = add nuw i32 %smax51, 1
  %smax57 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 0)
  %12 = add nuw i32 %smax57, 1
...
for.cond19:                                       ; preds = %for.cond16, %for.inc27
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc27 ], [ 1, %for.cond16 ]
  %13 = load i32, ptr %y2, align 4, !tbaa !5
  %14 = sext i32 %13 to i64
  %cmp20.not = icmp sgt i64 %indvars.iv38, %14
  br i1 %cmp20.not, label %for.inc30, label %for.inc27

for.inc27:                                        ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv41, i64 %indvars.iv38
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc64
  %indvars.iv54 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next55, %for.inc64 ]
  %exitcond59 = icmp eq i64 %indvars.iv54, %wide.trip.count58
  br i1 %exitcond59, label %for.cond67, label %for.cond36

for.cond36:                                       ; preds = %for.cond33, %for.inc61
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc61 ], [ 1, %for.cond33 ]
  %exitcond53 = icmp eq i64 %indvars.iv48, %wide.trip.count52
  br i1 %exitcond53, label %for.inc64, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv54, i64 %indvars.iv48
  store i32 0, ptr %arrayidx42, align 4, !tbaa !5
  br label %for.cond43

for.cond43:                                       ; preds = %for.inc58, %for.body38
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc58 ], [ 1, %for.body38 ]
...
for.inc58:                                        ; preds = %for.cond43
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv44
  %15 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !15
  %arrayidx53 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv44, i64 %indvars.iv48
...
for.cond67:                                       ; preds = %for.cond33, %for.inc87
  %17 = phi i32 [ %.pre66, %for.inc87 ], [ %8, %for.cond33 ]
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc87 ], [ 1, %for.cond33 ]
  %18 = sext i32 %17 to i64
  %cmp68.not = icmp sgt i64 %indvars.iv63, %18
  br i1 %cmp68.not, label %cleanup, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv63, i64 1
...
for.cond74:                                       ; preds = %for.inc83, %for.body69
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc83 ], [ 2, %for.body69 ]
  %20 = load i32, ptr %y2, align 4, !tbaa !5
  %21 = sext i32 %20 to i64
  %cmp75.not = icmp sgt i64 %indvars.iv60, %21
...
for.inc83:                                        ; preds = %for.cond74
  ...
  %arrayidx81 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv63, i64 %indvars.iv60
...
for.inc87:                                        ; preds = %for.cond74
  ...
  %.pre66 = load i32, ptr %x1, align 4, !tbaa !5
