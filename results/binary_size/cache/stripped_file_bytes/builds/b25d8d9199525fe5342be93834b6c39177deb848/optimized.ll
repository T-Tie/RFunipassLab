...
for.cond:                                         ; preds = %for.inc35, %entry
  ...
  %exitcond10.not = icmp eq i64 %indvars.iv5, 1000
  br i1 %exitcond10.not, label %for.end37, label %for.cond1
...
for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond14.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond14.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv11
  ...
  %reass.add18 = sub i32 %9, %6
  %reass.mul19 = mul i32 %reass.add18, 3600
  %reass.sub20 = sub i32 %11, %8
  %12 = add i32 %reass.sub20, 43200
  %13 = add i32 %12, %reass.mul19
