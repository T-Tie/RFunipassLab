...
for.body:                                         ; preds = %for.cond
  %conv2 = zext nneg i32 %1 to i64
  %mul3 = shl nuw nsw i64 %conv2, 2
...
for.cond5:                                        ; preds = %for.cond, %_Z3ansiPPi.exit
  %2 = phi i32 [ %.pre, %_Z3ansiPPi.exit ], [ %1, %for.cond ]
  %cmp6 = icmp sgt i32 %2, 0
  br i1 %cmp6, label %for.cond10, label %for.cond35

for.cond10:                                       ; preds = %for.cond5, %for.inc26
  %3 = phi i32 [ %4, %for.inc26 ], [ %2, %for.cond5 ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc26 ], [ 0, %for.cond5 ]
  %cmp11 = icmp sgt i32 %3, 0
  br i1 %cmp11, label %for.cond14.preheader, label %_Z3ansiPPi.exit

for.cond14.preheader:                             ; preds = %for.cond10
  %arrayidx19 = getelementptr inbounds nuw ptr, ptr %call1, i64 %indvars.iv13
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %4 = phi i32 [ %3, %for.cond14.preheader ], [ %.pre20, %for.inc23 ]
...
for.inc23:                                        ; preds = %for.cond14
  %5 = load ptr, ptr %arrayidx19, align 8, !tbaa !5, !invariant.load !10
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %5, i64 %indvars.iv10
...
_Z3ansiPPi.exit:                                  ; preds = %for.cond10
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 0)
  %.pre = load i32, ptr %n, align 4, !tbaa !11
  br label %for.cond5

for.cond35:                                       ; preds = %for.cond5, %for.body38
  %6 = phi i32 [ %.pre19, %for.body38 ], [ %2, %for.cond5 ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body38 ], [ 0, %for.cond5 ]
  %cmp36 = icmp sgt i32 %6, 0
  br i1 %cmp36, label %for.body38, label %for.end43

for.body38:                                       ; preds = %for.cond35
  %arrayidx40 = getelementptr inbounds nuw ptr, ptr %call1, i64 %indvars.iv16
  %7 = load ptr, ptr %arrayidx40, align 8, !tbaa !5, !invariant.load !10
  call void @free(ptr noundef %7) #10
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %.pre19 = load i32, ptr %n, align 4, !tbaa !11
  br label %for.cond35
