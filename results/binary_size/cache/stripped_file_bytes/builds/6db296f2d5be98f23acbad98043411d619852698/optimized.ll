...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %a) #9
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call3 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %a) #11
...
if.else14:                                        ; preds = %if.else
  ...
  br i1 %cmp15.not, label %if.end, label %if.end29
...
if.end29:                                         ; preds = %if.else14, %if.then10, %if.end, %if.then
  %sum.1 = phi i32 [ %conv, %if.then ], [ %conv, %if.then10 ], [ 0, %if.end ], [ %add4, %if.else14 ]
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 dereferenceable(50) %a) #10
