...
for.cond11:                                       ; preds = %for.inc35, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc35 ], [ 0, %for.end ]
  %num.0 = phi i32 [ %num.1, %for.inc35 ], [ 0, %for.end ]
  %exitcond23.not = icmp eq i64 %indvars.iv20, 16
  br i1 %exitcond23.not, label %for.cond38.preheader, label %for.cond14.preheader

for.cond38.preheader:                             ; preds = %for.cond11
  br label %for.cond38

for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv20
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc43
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc43 ], [ 0, %for.cond38.preheader ]
  %exitcond27.not = icmp eq i64 %indvars.iv24, 16
  br i1 %exitcond27.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv24
