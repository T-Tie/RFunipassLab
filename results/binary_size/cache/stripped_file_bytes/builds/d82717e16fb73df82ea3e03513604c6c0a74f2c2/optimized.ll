...
entry:
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call1, i8 noundef signext %call.i9)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  %1 = load i32, ptr %sum, align 4, !tbaa !5
  %.fr = freeze i32 %1
  %2 = srem i32 %.fr, 100
  store i32 %2, ptr %sum, align 4, !tbaa !5
  %div4.lhs.trunc = trunc nsw i32 %2 to i8
  %div437 = sdiv i8 %div4.lhs.trunc, 50
  %div4.sext = sext i8 %div437 to i32
  ...
  %vtable.i10 = load ptr, ptr %call5, align 8, !tbaa !9
  %vbase.offset.ptr.i11 = getelementptr i8, ptr %vtable.i10, i64 -24
  %vbase.offset.i12 = load i64, ptr %vbase.offset.ptr.i11, align 8
  %add.ptr.i13 = getelementptr inbounds i8, ptr %call5, i64 %vbase.offset.i12
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i13, i8 noundef signext 10)
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call5, i8 noundef signext %call.i)
  ...
  %.fr1 = freeze i32 %3
  %4 = srem i32 %.fr1, 50
  store i32 %4, ptr %sum, align 4, !tbaa !5
  %div10.lhs.trunc = trunc nsw i32 %4 to i8
  %div1038 = sdiv i8 %div10.lhs.trunc, 20
  %div10.sext = sext i8 %div1038 to i32
  ...
  %vtable.i16 = load ptr, ptr %call11, align 8, !tbaa !9
  ...
  %call1.i21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call11, i8 noundef signext %call.i20)
  ...
  %div16.lhs.trunc = trunc nsw i32 %6 to i8
  %div1639 = sdiv i8 %div16.lhs.trunc, 10
  %div16.sext = sext i8 %div1639 to i32
  ...
  %call1.i28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call17, i8 noundef signext %call.i27)
  ...
  %div22.lhs.trunc = trunc nsw i32 %8 to i8
  %div2240 = sdiv i8 %div22.lhs.trunc, 5
  %div22.sext = sext i8 %div2240 to i32
  ...
  %call1.i35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call23, i8 noundef signext %call.i34)
  ...
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
