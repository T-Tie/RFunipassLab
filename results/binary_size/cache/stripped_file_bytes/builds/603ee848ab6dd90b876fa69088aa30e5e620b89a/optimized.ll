...
for.cond1:                                        ; preds = %for.cond, %if.end10
  %1 = phi i32 [ %.pre7, %if.end10 ], [ %0, %for.cond ]
  %j.0 = phi i32 [ %inc, %if.end10 ], [ 1, %for.cond ]
  %a1.1 = phi i32 [ %a1.3, %if.end10 ], [ %a1.0, %for.cond ]
  %a2.1 = phi i32 [ %a2.3, %if.end10 ], [ %a2.0, %for.cond ]
  %b1.1 = phi i32 [ %b1.2, %if.end10 ], [ %b1.0, %for.cond ]
  %b2.1 = phi i32 [ %b2.2, %if.end10 ], [ %b2.0, %for.cond ]
...
land.lhs.true:                                    ; preds = %for.body4
  ...
  %spec.select = select i1 %cmp7, i32 %i.0, i32 %a1.1
  %spec.select6 = select i1 %cmp7, i32 %j.0, i32 %a2.1
  br label %if.end10

if.end10:                                         ; preds = %land.lhs.true, %for.body4
  %a1.3 = phi i32 [ %a1.1, %for.body4 ], [ %spec.select, %land.lhs.true ]
  %a2.3 = phi i32 [ %a2.1, %for.body4 ], [ %spec.select6, %land.lhs.true ]
...
for.end13:                                        ; preds = %for.cond
  ...
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %mul) #5
