...
entry:
  ...
  tail call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) @head)
...
if.end:                                           ; preds = %land.lhs.true19, %land.lhs.true, %for.cond
  tail call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) @p2)
...
print:                                            ; preds = %land.lhs.true19
  ...
  tail call void @_Z6resultP3stu(ptr nofree noundef nonnull align 8 dereferenceable(112) %7) #10
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  tail call fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull align 8 dereferenceable(112) %x) #10
  %putchar = tail call i32 @putchar(i32 noundef 10) #10
  br label %if.end

if.else:                                          ; preds = %entry
  tail call void @_Z6resultP3stu(ptr nofree noundef nonnull align 8 dereferenceable(112) %0) #7
  tail call fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull align 8 dereferenceable(112) %x) #10
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %putchar3 = tail call i32 @putchar(i32 noundef 10) #10
  ret void
}
...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) unnamed_addr #5 {
...
define internal fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull align 8 dereferenceable(112) %0) unnamed_addr #6 {
if.then_after_outline.exitStub:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull align 8 dereferenceable(112) %0) #7
  %name = getelementptr inbounds nuw i8, ptr %0, i64 30
  %call2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %name) #7
  ...
  %call4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %2) #7
  ...
  %call6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %conv5) #7
  %add = getelementptr inbounds nuw i8, ptr %0, i64 72
  %call8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, ptr noundef nonnull %add) #7
  ret void
}
...
attributes #6 = { minsize mustprogress nofree nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
