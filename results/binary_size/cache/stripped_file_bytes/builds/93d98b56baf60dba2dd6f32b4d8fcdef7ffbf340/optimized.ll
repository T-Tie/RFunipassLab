...
land.lhs.true.i18:                                ; preds = %if.then6.i12
  %_M_width.i4.i19 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i4.i19, align 8, !tbaa !13, !invariant.load !12
  %3 = add i64 %2, -261
...
land.lhs.true.i45:                                ; preds = %if.then6.i39
  %_M_width.i4.i46 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i4.i46, align 8, !tbaa !13, !invariant.load !12
  %5 = add i64 %4, -261
