...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %d) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 8 %d)
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull %u) #6
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp.not, label %for.cond4.preheader, label %for.inc
