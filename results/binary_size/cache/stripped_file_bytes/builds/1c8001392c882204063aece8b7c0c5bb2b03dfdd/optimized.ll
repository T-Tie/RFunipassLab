...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %6 = phi double [ undef, %for.cond16.preheader ], [ %.pre9, %for.body19 ]
  %7 = phi i32 [ %2, %for.cond16.preheader ], [ %.pre, %for.body19 ]
  %indvars.iv6 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next7, %for.body19 ]
  %sub17 = add nsw i32 %7, -2
  %8 = sext i32 %sub17 to i64
  %cmp18 = icmp slt i64 %indvars.iv6, %8
...
for.body19:                                       ; preds = %for.cond16
  ...
  %puts3 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.sink) #5
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  %.phi.trans.insert = getelementptr inbounds nuw [100 x double], ptr %sz, i64 0, i64 %indvars.iv.next7
  %.pre9 = load double, ptr %.phi.trans.insert, align 8, !tbaa !10, !invariant.load !9
