...
if.then:                                          ; preds = %for.body3
  ...
  %spec.select10 = select i1 %cmp8, i32 %4, i32 %y1.1
  br label %for.inc

for.inc:                                          ; preds = %for.body3, %if.then
  %x1.3 = phi i32 [ %spec.select, %if.then ], [ %x1.1, %for.body3 ]
  %y1.3 = phi i32 [ %spec.select10, %if.then ], [ %y1.1, %for.body3 ]
  %x2.2 = phi i32 [ %i.0, %if.then ], [ %x2.1, %for.body3 ]
  %y2.2 = phi i32 [ %4, %if.then ], [ %y2.1, %for.body3 ]
