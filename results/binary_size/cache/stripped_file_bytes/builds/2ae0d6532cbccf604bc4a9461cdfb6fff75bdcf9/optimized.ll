...
for.cond5:                                        ; preds = %for.cond5.loopexit, %for.cond5.preheader
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.cond5.loopexit ], [ %1, %for.cond5.preheader ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond5.loopexit ], [ %3, %for.cond5.preheader ]
  %indvars.iv.next15 = add nsw i64 %indvars.iv14, -1
  %cmp6 = icmp sgt i64 %indvars.iv14, 0
  br i1 %cmp6, label %for.cond9.preheader, label %for.end34

for.cond9.preheader:                              ; preds = %for.cond5
  %arrayidx15 = getelementptr inbounds [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next15
  %arrayidx21 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next15
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %if.end
  %indvars.iv11 = phi i64 [ %indvars.iv9, %for.cond9.preheader ], [ %indvars.iv.next12, %if.end ]
  %cmp10 = icmp slt i64 %indvars.iv11, %1
  br i1 %cmp10, label %for.body12, label %for.cond5.loopexit

for.body12:                                       ; preds = %for.cond9
  %4 = icmp eq i64 %indvars.iv11, %indvars.iv.next15
...
land.lhs.true:                                    ; preds = %for.body12
  ...
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %a, i64 0, i64 %indvars.iv11
...
land.lhs.true19:                                  ; preds = %land.lhs.true
  ...
  %arrayidx23 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv11
...
for.cond37:                                       ; preds = %for.body40, %for.end34
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body40 ], [ 0, %for.end34 ]
...
for.body40:                                       ; preds = %for.cond37
  %arrayidx42 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv17
...
for.end50:                                        ; preds = %for.cond37
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %max.0) #6
