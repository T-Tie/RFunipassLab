...
if.then6.i12:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i17 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
  br i1 %call16.i17, label %land.lhs.true.i18, label %if.then6.i39

land.lhs.true.i18:                                ; preds = %if.then6.i12
  %_M_width.i13.i19 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i13.i19, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
...
if.then19.i23:                                    ; preds = %land.lhs.true.i18
  %call24.i24 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
if.then6.i39:                                     ; preds = %if.then28.i30, %if.then19.i23, %land.lhs.true.i18, %if.then6.i12
  ...
  %call16.i44 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
land.lhs.true.i45:                                ; preds = %if.then6.i39
  %_M_width.i13.i46 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i13.i46, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
...
if.then19.i50:                                    ; preds = %land.lhs.true.i45
  %call24.i51 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit58: ; preds = %if.then6.i39, %land.lhs.true.i45, %if.then19.i50, %if.then28.i57
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #12
...
for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit58
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv72 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next73, %for.end ]
  br label %for.cond10
...
for.body13:                                       ; preds = %for.cond10
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv72
  ...
  br i1 %cmp18, label %if.then, label %for.end.split.loop.exit85

if.then:                                          ; preds = %for.body13
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond10, !llvm.loop !23

for.end.split.loop.exit85:                        ; preds = %for.body13
  %9 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.cond10, %for.end.split.loop.exit85
  %j.0.lcssa = phi i32 [ %9, %for.end.split.loop.exit85 ], [ %smax, %for.cond10 ]
...
for.cond21.preheader:                             ; preds = %for.end
  %cmp22.not = icmp eq i64 %indvars.iv72, 0
  ...
  %wide.trip.count83 = and i64 %call6, 4294967295
  br label %for.cond33

for.cond33:                                       ; preds = %for.body35, %for.cond21.preheader
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.body35 ], [ %10, %for.cond21.preheader ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count83
  br i1 %exitcond84.not, label %if.end49, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %str, i64 0, i64 %indvars.iv79
...
if.then46:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit58
...
if.end49:                                         ; preds = %for.cond33, %if.then46
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull captures(none) %str) #11
  ret i32 0
}
