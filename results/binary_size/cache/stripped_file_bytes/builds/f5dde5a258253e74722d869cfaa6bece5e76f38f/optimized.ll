...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre33, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond10:                                       ; preds = %if.then25, %for.cond10.preheader
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %if.then25 ], [ 0, %for.cond10.preheader ]
  %a.0 = phi i32 [ %a.238, %if.then25 ], [ undef, %for.cond10.preheader ]
  %b.0 = phi i32 [ %b.239, %if.then25 ], [ undef, %for.cond10.preheader ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end36, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv23 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next24, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond.not, label %if.then25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv27, i64 %indvars.iv23
...
if.then25:                                        ; preds = %for.cond13, %for.end23
  %b.239 = phi i32 [ %6, %for.end23 ], [ %b.0, %for.cond13 ]
  %a.238 = phi i32 [ %4, %for.end23 ], [ %a.0, %for.cond13 ]
  %arrayidx29 = getelementptr inbounds [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv27, i64 %idxprom28
...
for.end36:                                        ; preds = %for.end23, %if.then25, %for.cond10
  %a.1 = phi i32 [ %a.238, %if.then25 ], [ %4, %for.end23 ], [ %a.0, %for.cond10 ]
  %b.1 = phi i32 [ %b.239, %if.then25 ], [ %6, %for.end23 ], [ %b.0, %for.cond10 ]
  %sub37 = add i32 %0, -1
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc52
  %sub37.sink1 = phi i32 [ %dec, %for.inc52 ], [ %sub37, %for.cond42.preheader ]
  %cmp43 = icmp sgt i32 %sub37.sink1, -1
  br i1 %cmp43, label %for.body44, label %if.then55

for.body44:                                       ; preds = %for.cond42
  %idxprom47 = zext nneg i32 %sub37.sink1 to i64
...
for.end66:                                        ; preds = %if.then55, %for.cond38, %for.body44
  %sub37.sink18 = phi i32 [ %sub37.sink, %for.body44 ], [ %smin, %for.cond38 ], [ %sub37.sink, %if.then55 ]
  %d.1 = phi i32 [ %sub37.sink1, %for.body44 ], [ undef, %for.cond38 ], [ undef, %if.then55 ]
  %10 = xor i32 %b.1, -1
  %sub68 = add i32 %d.1, %10
  %11 = xor i32 %a.1, -1
  %sub70 = add i32 %sub37.sink18, %11
