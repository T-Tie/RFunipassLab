...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %length) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr %sumlen) #11
  store i32 0, ptr %sumlen, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 41, ptr %word) #11
...
for.body:                                         ; preds = %for.cond
  %arraydecay = getelementptr inbounds [41 x i8], ptr %word, i64 0, i64 0
  ...
  %arraydecay2 = getelementptr inbounds [41 x i8], ptr %word, i64 0, i64 0
  %call3 = call i64 @strlen(ptr noundef %arraydecay2) #12
  %conv = trunc i64 %call3 to i32
  store i32 %conv, ptr %length, align 4, !tbaa !5
  %2 = load i32, ptr %sumlen, align 4, !tbaa !5
  %cmp4 = icmp ne i32 %2, 0
  br i1 %cmp4, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %3 = load i32, ptr %sumlen, align 4, !tbaa !5
  %4 = load i32, ptr %length, align 4, !tbaa !5
  %add = add nsw i32 %3, %4
  store i32 %add, ptr %sumlen, align 4, !tbaa !5
  %5 = load i32, ptr %sumlen, align 4, !tbaa !5
  %cmp5 = icmp slt i32 %5, 79
  br i1 %cmp5, label %if.then6, label %if.end

if.then6:                                         ; preds = %if.then
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  %arraydecay8 = getelementptr inbounds [41 x i8], ptr %word, i64 0, i64 0
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call7, ptr noundef %arraydecay8)
  %6 = load i32, ptr %sumlen, align 4, !tbaa !5
  %inc = add nsw i32 %6, 1
  store i32 %inc, ptr %sumlen, align 4, !tbaa !5
  br label %for.inc

if.end:                                           ; preds = %if.then
  %7 = load i32, ptr %sumlen, align 4, !tbaa !5
  %cmp10 = icmp eq i32 %7, 80
  br i1 %cmp10, label %if.then12, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end
  %8 = load i32, ptr %sumlen, align 4, !tbaa !5
  %cmp11 = icmp eq i32 %8, 79
...
if.then12:                                        ; preds = %lor.lhs.false, %if.end
  ...
  %arraydecay14 = getelementptr inbounds [41 x i8], ptr %word, i64 0, i64 0
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call13, ptr noundef %arraydecay14)
...
if.end17:                                         ; preds = %if.then12, %lor.lhs.false
  %9 = load i32, ptr %sumlen, align 4, !tbaa !5
  %cmp18 = icmp sgt i32 %9, 80
  br i1 %cmp18, label %if.then19, label %if.end24

if.then19:                                        ; preds = %if.end17
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %arraydecay21 = getelementptr inbounds [41 x i8], ptr %word, i64 0, i64 0
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call20, ptr noundef %arraydecay21)
  %10 = load i32, ptr %length, align 4, !tbaa !5
  %add23 = add nsw i32 %10, 1
  store i32 %add23, ptr %sumlen, align 4, !tbaa !5
  br label %if.end24
...
if.else:                                          ; preds = %for.body
  %arraydecay25 = getelementptr inbounds [41 x i8], ptr %word, i64 0, i64 0
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay25)
  %11 = load i32, ptr %length, align 4, !tbaa !5
  %add27 = add nsw i32 %11, 1
  store i32 %add27, ptr %sumlen, align 4, !tbaa !5
  br label %if.end28
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 41, ptr %word) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %sumlen) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %length) #11
...
entry:
  ...
  store ptr %__in, ptr %__in.addr, align 8, !tbaa !12
  ...
  store i64 %1, ptr %__n, align 8, !tbaa !17
...
do.end:                                           ; preds = %do.cond
  %3 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  ...
  %4 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  %vtable1 = load ptr, ptr %4, align 8, !tbaa !21
...
if.then6:                                         ; preds = %if.else
  ...
  %div = udiv i64 %6, 1
  store i64 %div, ptr %__n, align 8, !tbaa !17
  call void @llvm.lifetime.start.p0(i64 8, ptr %__w) #11
  %7 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  ...
  store i64 %call11, ptr %__w, align 8, !tbaa !17
  %8 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  %9 = load ptr, ptr %__s.addr, align 8, !tbaa !15
  %10 = load i64, ptr %__n, align 8, !tbaa !17
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) %8, ptr noundef %9, i64 noundef %10)
  %11 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  %vtable12 = load ptr, ptr %11, align 8, !tbaa !21
...
land.lhs.true:                                    ; preds = %if.then6
  %12 = load i64, ptr %__w, align 8, !tbaa !17
  %cmp17 = icmp sle i64 %12, 0
  br i1 %cmp17, label %if.then19, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true
  %13 = load i64, ptr %__n, align 8, !tbaa !17
  %14 = load i64, ptr %__w, align 8, !tbaa !17
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %15 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  %vtable20 = load ptr, ptr %15, align 8, !tbaa !21
  ...
  store i8 %storedv, ptr %__eof, align 1, !tbaa !23
  %16 = load i8, ptr %__eof, align 1, !tbaa !23, !range !25, !noundef !19
...
if.then28:                                        ; preds = %if.then19
  %17 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  %vtable29 = load ptr, ptr %17, align 8, !tbaa !21
...
if.else34:                                        ; preds = %if.else
  ...
  store i64 9223372036854775807, ptr %__n35, align 8, !tbaa !17
  %18 = load i64, ptr %__n35, align 8, !tbaa !17
  %div36 = udiv i64 %18, 1
  store i64 %div36, ptr %__n35, align 8, !tbaa !17
  %19 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
  %20 = load ptr, ptr %__s.addr, align 8, !tbaa !15
  %21 = load i64, ptr %__n35, align 8, !tbaa !17
...
if.end38:                                         ; preds = %if.end37, %do.end
  %22 = load ptr, ptr %__in.addr, align 8, !tbaa !12, !nonnull !19, !align !20
...
entry:
  ...
  %__s.addr = alloca ptr, align 8
  store ptr %__out, ptr %__out.addr, align 8, !tbaa !26
  store ptr %__s, ptr %__s.addr, align 8, !tbaa !15
  %0 = load ptr, ptr %__s.addr, align 8, !tbaa !15
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %__out.addr, align 8, !tbaa !26, !nonnull !19, !align !20
...
if.else:                                          ; preds = %entry
  %2 = load ptr, ptr %__out.addr, align 8, !tbaa !26, !nonnull !19, !align !20
...
if.end:                                           ; preds = %if.else, %if.then
  %5 = load ptr, ptr %__out.addr, align 8, !tbaa !26, !nonnull !19, !align !20
  ret ptr %5
}
...
entry:
  ...
  %0 = load ptr, ptr %__os.addr, align 8, !tbaa !26, !nonnull !19, !align !20
  %1 = load ptr, ptr %__os.addr, align 8, !tbaa !26, !nonnull !19, !align !20
  %vtable = load ptr, ptr %1, align 8, !tbaa !21
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %1, i64 %vbase.offset
...
entry:
  ...
  store i64 %__wide, ptr %__wide.addr, align 8, !tbaa !17
  %this1 = load ptr, ptr %this.addr, align 8
  ...
  store i64 %0, ptr %__old, align 8, !tbaa !17
  %1 = load i64, ptr %__wide.addr, align 8, !tbaa !17
  %_M_width2 = getelementptr inbounds nuw %"class.std::ios_base", ptr %this1, i32 0, i32 2
  store i64 %1, ptr %_M_width2, align 8, !tbaa !31
  %2 = load i64, ptr %__old, align 8, !tbaa !17
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !43
  ret ptr %0
}
...
entry:
  ...
  store ptr %__c1, ptr %__c1.addr, align 8, !tbaa !50
  store ptr %__c2, ptr %__c2.addr, align 8, !tbaa !50
  %0 = load ptr, ptr %__c1.addr, align 8, !tbaa !50, !nonnull !19, !align !52
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %2 = load ptr, ptr %__c2.addr, align 8, !tbaa !50, !nonnull !19, !align !52
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !54
  ret ptr %0
}
...
entry:
  ...
  store ptr %__c, ptr %__c.addr, align 8, !tbaa !15
  %0 = load ptr, ptr %__c.addr, align 8, !tbaa !15, !nonnull !19
...
entry:
  ...
  store ptr %this, ptr %this.addr, align 8, !tbaa !40
  store i8 %__c, ptr %__c.addr, align 1, !tbaa !57
  %this1 = load ptr, ptr %this.addr, align 8
  %_M_ctype = getelementptr inbounds nuw %"class.std::basic_ios", ptr %this1, i32 0, i32 5
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !58
  %call = call noundef nonnull align 8 dereferenceable(570) ptr @_ZSt13__check_facetISt5ctypeIcEERKT_PS3_(ptr noundef %0)
  %1 = load i8, ptr %__c.addr, align 1, !tbaa !57
...
entry:
  ...
  store ptr %__f, ptr %__f.addr, align 8, !tbaa !59
  %0 = load ptr, ptr %__f.addr, align 8, !tbaa !59
  %tobool = icmp ne ptr %0, null
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %__f.addr, align 8, !tbaa !59
  ret ptr %1
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !60
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !57
  store i8 %2, ptr %retval, align 1
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this1)
  %3 = load i8, ptr %__c.addr, align 1, !tbaa !57
  %vtable = load ptr, ptr %this1, align 8, !tbaa !21
...
!25 = !{i8 0, i8 2}
!26 = !{!27, !27, i64 0}
!27 = !{!"p1 _ZTSSo", !14, i64 0}
!28 = !{!14, !14, i64 0}
!29 = !{!30, !30, i64 0}
!30 = !{!"p1 _ZTSSt8ios_base", !14, i64 0}
!31 = !{!32, !18, i64 16}
!32 = !{!"_ZTSSt8ios_base", !18, i64 8, !18, i64 16, !33, i64 24, !34, i64 28, !34, i64 32, !35, i64 40, !36, i64 48, !7, i64 64, !6, i64 192, !37, i64 200, !38, i64 208}
!33 = !{!"_ZTSSt13_Ios_Fmtflags", !7, i64 0}
!34 = !{!"_ZTSSt12_Ios_Iostate", !7, i64 0}
!35 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !14, i64 0}
!36 = !{!"_ZTSNSt8ios_base6_WordsE", !14, i64 0, !18, i64 8}
!37 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !14, i64 0}
!38 = !{!"_ZTSSt6locale", !39, i64 0}
!39 = !{!"p1 _ZTSNSt6locale5_ImplE", !14, i64 0}
!40 = !{!41, !41, i64 0}
!41 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !14, i64 0}
!42 = !{!34, !34, i64 0}
!43 = !{!44, !45, i64 232}
!44 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !32, i64 0, !27, i64 216, !7, i64 224, !24, i64 225, !45, i64 232, !46, i64 240, !47, i64 248, !48, i64 256}
!45 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !14, i64 0}
!46 = !{!"p1 _ZTSSt5ctypeIcE", !14, i64 0}
!47 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !14, i64 0}
!48 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !14, i64 0}
!49 = !{!45, !45, i64 0}
!50 = !{!51, !51, i64 0}
!51 = !{!"p1 int", !14, i64 0}
!52 = !{i64 4}
!53 = !{!32, !34, i64 32}
!54 = !{!55, !16, i64 16}
!55 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !16, i64 8, !16, i64 16, !16, i64 24, !16, i64 32, !16, i64 40, !16, i64 48, !38, i64 56}
!56 = !{!55, !16, i64 24}
!57 = !{!7, !7, i64 0}
!58 = !{!44, !46, i64 240}
!59 = !{!46, !46, i64 0}
!60 = !{!61, !7, i64 56}
!61 = !{!"_ZTSSt5ctypeIcE", !62, i64 0, !63, i64 16, !24, i64 24, !51, i64 32, !51, i64 40, !64, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!62 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!63 = !{!"p1 _ZTS15__locale_struct", !14, i64 0}
