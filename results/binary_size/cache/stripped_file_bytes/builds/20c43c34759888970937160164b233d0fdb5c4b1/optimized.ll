...
while.cond10.preheader:                           ; preds = %while.cond
  %smax16 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
  %2 = add nuw i32 %smax16, 1
...
while.cond10:                                     ; preds = %while.cond10.preheader, %while.end34
  %indvars.iv13.in = phi i32 [ %t.0, %while.cond10.preheader ], [ %indvars.iv13, %while.end34 ]
  %s.0 = phi i32 [ 1, %while.cond10.preheader ], [ %inc35, %while.end34 ]
  %indvars.iv13 = add i32 %indvars.iv13.in, -1
  %exitcond17 = icmp eq i32 %s.0, %2
  br i1 %exitcond17, label %while.cond37.preheader, label %while.cond13.preheader

while.cond13.preheader:                           ; preds = %while.cond10
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv13, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %while.cond13

while.cond37.preheader:                           ; preds = %while.cond10
  %5 = load i32, ptr %b, align 16
  %wide.trip.count21 = zext nneg i32 %smax16 to i64
  br label %while.cond37

while.cond13:                                     ; preds = %while.cond13.preheader, %if.end32
  %indvars.iv9 = phi i64 [ 0, %while.cond13.preheader ], [ %indvars.iv.next10, %if.end32 ]
...
while.body15:                                     ; preds = %while.cond13
  %arrayidx17 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv9
  %6 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %arrayidx19 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next10
...
while.cond37:                                     ; preds = %while.cond37.preheader, %if.end47
  %indvars.iv18 = phi i64 [ 0, %while.cond37.preheader ], [ %indvars.iv.next19, %if.end47 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count21
  br i1 %exitcond22.not, label %while.end49, label %while.body39

while.body39:                                     ; preds = %while.cond37
  %cmp40 = icmp eq i64 %indvars.iv18, 0
  br i1 %cmp40, label %if.then41, label %if.else

if.then41:                                        ; preds = %while.body39
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5) #6
  br label %if.end47

if.else:                                          ; preds = %while.body39
  %arrayidx45 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv18
  %8 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !9
  %call46 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %8) #6
  br label %if.end47
