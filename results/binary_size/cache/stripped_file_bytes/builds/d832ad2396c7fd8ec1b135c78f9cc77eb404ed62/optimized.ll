...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %shu, i64 0, i64 %indvars.iv29, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %shu, i64 0, i64 %indvars.iv36, i64 %indvars.iv32
...
for.cond30:                                       ; preds = %for.end46, %for.end29
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.end46 ], [ 0, %for.end29 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count40
  br i1 %exitcond52.not, label %for.end52, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.body35
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body35 ], [ 0, %for.cond30 ]
  %s.2 = phi i32 [ %spec.select27, %for.body35 ], [ 0, %for.cond30 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond47.not, label %for.end46, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %shu, i64 0, i64 %indvars.iv42, i64 %indvars.iv48
  %5 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !13
  %cmp40 = icmp eq i32 %5, 0
  %add42 = zext i1 %cmp40 to i32
  %spec.select27 = add nuw nsw i32 %s.2, %add42
