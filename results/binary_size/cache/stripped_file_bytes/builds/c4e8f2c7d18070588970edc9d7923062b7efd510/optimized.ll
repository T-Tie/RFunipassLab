...
for.end12:                                        ; preds = %for.cond1
  ...
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %11)
...
define dso_local void @_Z6rezerov() #3 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom
  %arrayidx4 = getelementptr inbounds [100 x i32], ptr %arrayidx, i64 0, i64 0
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx9 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom8
  %9 = load i32, ptr %j, align 4, !tbaa !5
...
for.cond31:                                       ; preds = %for.inc64, %for.end30
  %24 = load i32, ptr %i, align 4, !tbaa !5
  %25 = load i32, ptr @b, align 4, !tbaa !5
  %cmp32 = icmp slt i32 %24, %25
  br i1 %cmp32, label %for.body33, label %for.end66

for.body33:                                       ; preds = %for.cond31
  %26 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom34 = sext i32 %26 to i64
  %arrayidx35 = getelementptr inbounds [100 x i32], ptr @a, i64 0, i64 %idxprom34
  %27 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  store i32 %27, ptr %min, align 4, !tbaa !5
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc50, %for.body33
...
if.then44:                                        ; preds = %for.body38
  ...
  %36 = load i32, ptr %arrayidx48, align 4, !tbaa !5
...
define dso_local void @_Z4delev() #5 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr %j) #7
  %0 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
...
for.body21:                                       ; preds = %for.cond18
  ...
  store i32 %19, ptr %arrayidx30, align 4, !tbaa !5
  br label %for.inc31
...
!33 = !{!34, !34, i64 0}
!34 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !23, i64 0}
!35 = !{!7, !7, i64 0}
!36 = !{!37, !49, i64 240}
!37 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !38, i64 0, !22, i64 216, !7, i64 224, !47, i64 225, !48, i64 232, !49, i64 240, !50, i64 248, !51, i64 256}
...
!43 = !{!"_ZTSNSt8ios_base6_WordsE", !23, i64 0, !39, i64 8}
