...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.end26 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  ...
  %5 = sext i32 %4 to i64
  %cmp17 = icmp slt i64 %indvars.iv33, %5
...
for.cond64:                                       ; preds = %for.cond61, %for.inc82
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc82 ], [ 0, %for.cond61 ]
  %7 = load i32, ptr %y2, align 4, !tbaa !5
  %8 = sext i32 %7 to i64
  %cmp65 = icmp slt i64 %indvars.iv55, %8
  br i1 %cmp65, label %for.body66, label %for.cond61

for.body66:                                       ; preds = %for.cond64
  %sub = add nsw i32 %7, -1
  %9 = zext i32 %sub to i64
  %cmp67 = icmp eq i64 %indvars.iv55, %9
