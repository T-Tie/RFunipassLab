...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre36, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc46
  %indvars.iv17 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next18, %for.inc46 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc89
  %indvars.iv30 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next31, %for.inc89 ]
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc86
  %indvars.iv23 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next24, %for.inc86 ]
  %exitcond29.not = icmp eq i64 %indvars.iv23, %wide.trip.count28
  br i1 %exitcond29.not, label %for.inc89, label %for.body54
...
land.lhs.true64:                                  ; preds = %for.body54
  ...
  br i1 %brmerge7, label %for.inc89.split.loop.exit, label %for.inc86
...
for.inc89:                                        ; preds = %if.end82, %for.cond52, %for.inc89.split.loop.exit
  ...
  %t.3 = phi i32 [ %.mux8.le, %for.inc89.split.loop.exit ], [ %t.2, %for.cond52 ], [ %t.2, %if.end82 ]
