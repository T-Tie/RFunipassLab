...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.cond6.loopexit
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond6.loopexit ], [ 0, %for.cond6.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond6.loopexit ], [ 1, %for.cond6.preheader ]
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv20
  br label %for.cond11

for.cond11:                                       ; preds = %if.end29, %for.cond6
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %if.end29 ], [ %indvars.iv, %for.cond6 ]
  %6 = trunc nuw i64 %indvars.iv17 to i32
