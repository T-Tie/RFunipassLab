...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc22
  %indvars.iv21 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next22, %for.inc22 ]
  %exitcond25 = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25, label %for.cond25.preheader, label %for.cond9
...
for.cond25.preheader:                             ; preds = %for.cond5
  ...
  %wide.trip.count36 = zext i32 %sub to i64
  %wide.trip.count29 = zext nneg i32 %smax18 to i64
  br label %for.cond25

for.cond9:                                        ; preds = %for.cond5, %for.inc19
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc19 ], [ 0, %for.cond5 ]
  %exitcond20.not = icmp eq i64 %indvars.iv12, %wide.trip.count19
  br i1 %exitcond20.not, label %for.inc22, label %for.inc19

for.inc19:                                        ; preds = %for.cond9
  %2 = add nuw nsw i64 %indvars.iv12, %indvars.iv21
  ...
  %arrayidx17 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv21, i64 %indvars.iv12
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc69
  %indvars.iv31 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next32, %for.inc69 ]
  %exitcond41.not = icmp eq i64 %indvars.iv31, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end71, label %for.cond30.preheader

for.cond30.preheader:                             ; preds = %for.cond25
  %arrayidx35 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv31
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv31
  br label %for.cond30

for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc66
  %indvars.iv33 = phi i64 [ %indvars.iv31, %for.cond30.preheader ], [ %indvars.iv.next34, %for.inc66 ]
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count36
  br i1 %exitcond37.not, label %for.inc69, label %for.body33
...
land.lhs.true:                                    ; preds = %for.body33
  %arrayidx40 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv.next34
...
for.cond56:                                       ; preds = %for.inc63, %if.then
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc63 ], [ 0, %if.then ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count29
  br i1 %exitcond30.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv.next34, i64 %indvars.iv26
...
for.end71:                                        ; preds = %for.cond25
  ...
  %8 = add nuw i32 %smax39, 1
  %wide.trip.count45 = zext i32 %8 to i64
  br label %for.cond73

for.cond73:                                       ; preds = %for.body76, %for.end71
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body76 ], [ 1, %for.end71 ]
  %m.0 = phi i32 [ %spec.select, %for.body76 ], [ %7, %for.end71 ]
  %exitcond46 = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46, label %for.end86, label %for.body76

for.body76:                                       ; preds = %for.cond73
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv42
...
if.then88:                                        ; preds = %for.end86
  %puts10 = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  br label %cleanup
...
for.cond91:                                       ; preds = %for.inc104, %if.else
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc104 ], [ 0, %if.else ]
  %10 = load i32, ptr %n, align 4, !tbaa !5
  %sub92 = sub nsw i32 %conv, %10
  %11 = sext i32 %sub92 to i64
  %cmp93.not = icmp sgt i64 %indvars.iv47, %11
  br i1 %cmp93.not, label %cleanup, label %for.body94

for.body94:                                       ; preds = %for.cond91
  %arrayidx96 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv47
...
if.then98:                                        ; preds = %for.body94
  %arrayidx100 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv47
