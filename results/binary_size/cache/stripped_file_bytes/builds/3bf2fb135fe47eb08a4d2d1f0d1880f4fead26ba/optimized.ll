...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %.pre17 = load i32, ptr %e, align 4, !tbaa !5
  %.pre18 = load i32, ptr %f, align 4, !tbaa !5
  br i1 %or.cond9, label %land.lhs.true4, label %if.then20

land.lhs.true4:                                   ; preds = %for.cond
  %cmp5 = icmp eq i32 %.pre, 0
  %cmp7 = icmp eq i32 %.pre17, 0
  %or.cond10 = select i1 %cmp5, i1 %cmp7, i1 false
  %cmp9 = icmp eq i32 %.pre18, 0
  %or.cond11 = select i1 %or.cond10, i1 %cmp9, i1 false
  br i1 %or.cond11, label %for.end, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true4
  %cmp15 = icmp ne i32 %.pre, 0
  %cmp17 = icmp ne i32 %.pre17, 0
  %or.cond14 = select i1 %cmp15, i1 true, i1 %cmp17
  %cmp19 = icmp ne i32 %.pre18, 0
  %or.cond15 = select i1 %or.cond14, i1 true, i1 %cmp19
  br i1 %or.cond15, label %if.then20, label %for.inc

if.then20:                                        ; preds = %for.cond, %lor.lhs.false
  %reass.sub = sub i32 %.pre, %0
  %3 = mul i32 %reass.sub, 3600
  %sub22 = sub nsw i32 %.pre17, %1
  %mul23 = mul nsw i32 %sub22, 60
  %reass.sub20 = sub i32 %3, %2
  %add24 = add i32 %reass.sub20, 43200
  %add25 = add i32 %add24, %.pre18
  %sub26 = add i32 %add25, %mul23
  %call27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %sub26)
  br label %for.inc

for.inc:                                          ; preds = %lor.lhs.false, %if.then20
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %land.lhs.true4
