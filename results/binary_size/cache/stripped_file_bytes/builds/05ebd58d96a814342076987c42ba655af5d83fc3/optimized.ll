...
for.cond:                                         ; preds = %for.inc7, %while.body
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc7 ], [ 0, %while.body ]
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv34, %6
...
for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv34, %2
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %8
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %9 = phi i32 [ %5, %for.cond1.preheader ], [ %.pre90, %for.inc ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc137
  %indvars.iv87 = phi i64 [ %7, %for.cond10.preheader ], [ %indvars.iv.next88, %for.inc137 ]
  %sum.0 = phi i32 [ 0, %for.cond10.preheader ], [ %add, %for.inc137 ]
  %11 = trunc nuw i64 %indvars.iv87 to i32
  %cmp11 = icmp sgt i32 %11, 1
  br i1 %cmp11, label %for.cond13, label %for.end138

for.cond13:                                       ; preds = %for.cond10, %for.inc48
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc48 ], [ 0, %for.cond10 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %indvars.iv87
  br i1 %exitcond49.not, label %for.cond51, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %12 = mul nuw nsw i64 %indvars.iv45, %2
...
for.cond19:                                       ; preds = %for.body21, %for.body15
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body21 ], [ 1, %for.body15 ]
  %min.0 = phi i32 [ %spec.select, %for.body21 ], [ %13, %for.body15 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %indvars.iv87
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw i32, ptr %arrayidx17, i64 %indvars.iv37
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv40 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next41, %for.inc45 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %indvars.iv87
  br i1 %exitcond44.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw i32, ptr %arrayidx17, i64 %indvars.iv40
...
for.cond51:                                       ; preds = %for.cond13, %for.inc90
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc90 ], [ 0, %for.cond13 ]
  %exitcond64.not = icmp eq i64 %indvars.iv60, %indvars.iv87
  br i1 %exitcond64.not, label %for.end92, label %for.body53

for.body53:                                       ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv60
  %16 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body53
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body60 ], [ 1, %for.body53 ]
  %min54.0 = phi i32 [ %spec.select30, %for.body60 ], [ %16, %for.body53 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %indvars.iv87
  br i1 %exitcond54.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %17 = mul nuw nsw i64 %indvars.iv50, %2
  %gep = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %17
  %18 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select30 = call i32 @llvm.smin.i32(i32 %18, i32 %min54.0)
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br label %for.cond58, !llvm.loop !17

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv55 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next56, %for.inc87 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %indvars.iv87
  br i1 %exitcond59.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %19 = mul nuw nsw i64 %indvars.iv55, %2
  %gep32 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %19
  %20 = load i32, ptr %gep32, align 4, !tbaa !5, !invariant.load !13
  %sub82 = sub nsw i32 %20, %min54.0
  store i32 %sub82, ptr %gep32, align 4, !tbaa !5
...
for.cond95:                                       ; preds = %for.inc113, %for.end92
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc113 ], [ 2, %for.end92 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %indvars.iv87
  br i1 %exitcond74.not, label %for.cond116, label %for.cond98.preheader

for.cond98.preheader:                             ; preds = %for.cond95
  %invariant.gep = getelementptr i32, ptr %vla, i64 %indvars.iv70
  br label %for.cond98

for.cond98:                                       ; preds = %for.cond98.preheader, %for.inc110
  %indvars.iv65 = phi i64 [ 0, %for.cond98.preheader ], [ %indvars.iv.next66, %for.inc110 ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %indvars.iv87
  br i1 %exitcond69.not, label %for.inc113, label %for.inc110

for.inc110:                                       ; preds = %for.cond98
  %22 = mul nuw nsw i64 %indvars.iv65, %2
  %gep92 = getelementptr i32, ptr %invariant.gep, i64 %22
  %23 = load i32, ptr %gep92, align 4, !tbaa !5, !invariant.load !13
  %arrayidx109 = getelementptr i8, ptr %gep92, i64 -4
...
for.cond116:                                      ; preds = %for.cond95, %for.inc134
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc134 ], [ 2, %for.cond95 ]
  %exitcond85.not = icmp eq i64 %indvars.iv80, %indvars.iv87
  br i1 %exitcond85.not, label %for.inc137, label %for.cond119.preheader

for.cond119.preheader:                            ; preds = %for.cond116
  %24 = mul nuw nsw i64 %indvars.iv80, %2
  %arrayidx123 = getelementptr inbounds nuw i32, ptr %vla, i64 %24
  %25 = add nsw i64 %indvars.iv80, -1
...
for.cond119:                                      ; preds = %for.cond119.preheader, %for.inc131
  %indvars.iv75 = phi i64 [ 0, %for.cond119.preheader ], [ %indvars.iv.next76, %for.inc131 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %indvars.iv87
  br i1 %exitcond79.not, label %for.inc134, label %for.inc131

for.inc131:                                       ; preds = %for.cond119
  %arrayidx125 = getelementptr inbounds nuw i32, ptr %arrayidx123, i64 %indvars.iv75
  %27 = load i32, ptr %arrayidx125, align 4, !tbaa !5, !invariant.load !13
  %arrayidx130 = getelementptr inbounds nuw i32, ptr %arrayidx128, i64 %indvars.iv75
