...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.end27
  %indvars.iv25 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next26, %for.end27 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.cond31.preheader, label %for.body3
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv25
  %3 = load i32, ptr %arrayidx, align 16, !tbaa !5, !invariant.load !12
  br label %for.cond5

for.cond5:                                        ; preds = %for.body7, %for.body3
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body7 ], [ 0, %for.body3 ]
  %min.0 = phi i32 [ %spec.select, %for.body7 ], [ %3, %for.body3 ]
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv25, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.body19
  %indvars.iv20 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next21, %for.body19 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.end27, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv25, i64 %indvars.iv20
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %sub24 = sub nsw i32 %5, %min.0
...
for.cond31:                                       ; preds = %for.cond53, %for.cond31.preheader.split
  br label %for.cond36

for.cond36:                                       ; preds = %for.body38, %for.cond31
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body38 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select16, %for.body38 ], [ %2, %for.cond31 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.cond53.preheader, label %for.body38

for.cond53.preheader:                             ; preds = %for.cond36
  br label %for.cond53

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv30
  %6 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !12
  %spec.select16 = tail call i32 @llvm.smin.i32(i32 %6, i32 %min.2)
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond36, !llvm.loop !16

for.cond53:                                       ; preds = %for.cond53.preheader, %for.body55
  %indvars.iv36 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next37, %for.body55 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count34
  br i1 %exitcond41.not, label %for.cond31, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv36
  %7 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !12
  %sub60 = sub nsw i32 %7, %min.2
  store i32 %sub60, ptr %arrayidx57, align 4, !tbaa !5
...
entry:
  ...
  %smax11 = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
...
for.cond:                                         ; preds = %for.end, %entry
  ...
  br i1 %exitcond13.not, label %for.cond14.preheader, label %for.cond1

for.cond14.preheader:                             ; preds = %for.cond
  %cmp16 = icmp sgt i32 %2, 1
  br i1 %cmp16, label %for.cond14.preheader6, label %for.end36

for.cond14.preheader6:                            ; preds = %for.cond14.preheader
...
for.body3:                                        ; preds = %for.cond1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv.next
...
for.cond14:                                       ; preds = %for.cond18, %for.cond14.preheader6
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond14, %for.body21
  %indvars.iv14 = phi i64 [ 1, %for.cond14 ], [ %indvars.iv.next15, %for.body21 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond14, label %for.body21

for.body21:                                       ; preds = %for.cond18
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %arrayidx24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next15
  %4 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !12
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv14
