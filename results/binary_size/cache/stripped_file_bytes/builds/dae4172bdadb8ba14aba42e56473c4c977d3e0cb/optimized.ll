...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.end26 ], [ 0, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv19, %4
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body18 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv16, %9
  br i1 %cmp17, label %for.body18, label %for.end26

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv19, i64 %indvars.iv16
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.end60
  %indvars.iv31 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next32, %for.end60 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond64.preheader, label %for.cond33
...
for.cond33:                                       ; preds = %for.cond30, %for.end57
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.end57 ], [ 0, %for.cond30 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end60, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv31, i64 %indvars.iv25
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.body42, %for.body35
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body42 ], [ 0, %for.body35 ]
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond.not, label %for.end57, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv22
  %11 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !14
  %arrayidx50 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv22, i64 %indvars.iv25
...
for.cond64:                                       ; preds = %for.cond64.preheader, %for.end82
  ...
  %indvars.iv40 = phi i64 [ 0, %for.cond64.preheader ], [ %indvars.iv.next41, %for.end82 ]
...
for.cond71:                                       ; preds = %for.body73, %for.body66
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body73 ], [ 1, %for.body66 ]
...
for.body73:                                       ; preds = %for.cond71
  ...
  %arrayidx78 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv40, i64 %indvars.iv37
