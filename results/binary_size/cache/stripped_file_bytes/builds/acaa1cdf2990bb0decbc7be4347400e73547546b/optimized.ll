...
for.end:                                          ; preds = %if.then7, %if.then, %for.cond
  %arrayidx11 = getelementptr inbounds [16 x i32], ptr %a, i64 0, i64 0
  %8 = load i32, ptr %arrayidx11, align 16, !tbaa !5
...
for.cond15:                                       ; preds = %for.inc32, %if.end14
...
for.body20:                                       ; preds = %for.cond18
  ...
  %cmp25 = icmp eq i32 %14, %mul
  br i1 %cmp25, label %if.then26, label %if.end28

if.then26:                                        ; preds = %for.body20
  %17 = load i32, ptr %sum, align 4, !tbaa !5
  %inc27 = add nsw i32 %17, 1
  store i32 %inc27, ptr %sum, align 4, !tbaa !5
  br label %if.end28

if.end28:                                         ; preds = %if.then26, %for.body20
  br label %for.inc29
