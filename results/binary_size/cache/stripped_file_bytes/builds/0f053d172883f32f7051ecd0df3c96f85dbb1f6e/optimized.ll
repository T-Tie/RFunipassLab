...
lor.lhs.false381:                                 ; preds = %if.end373
  ...
  %spec.select235 = select i1 %cmp388, ptr @.str.2, ptr @.str.3
  br label %for.inc395

for.inc395:                                       ; preds = %lor.lhs.false381, %lor.lhs.false193, %if.end373, %if.end186
  %.str.3.sink = phi ptr [ @.str.2, %if.end186 ], [ @.str.2, %if.end373 ], [ %spec.select, %lor.lhs.false193 ], [ %spec.select235, %lor.lhs.false381 ]
