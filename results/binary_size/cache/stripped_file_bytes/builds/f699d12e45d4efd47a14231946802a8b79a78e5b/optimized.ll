...
for.cond:                                         ; preds = %do.body, %for.cond.cleanup7
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond.cleanup7 ], [ 0, %do.body ]
  %m.0 = phi i32 [ %m.1, %for.cond.cleanup7 ], [ 0, %do.body ]
  %exitcond12.not = icmp eq i64 %indvars.iv9, 15
  br i1 %exitcond12.not, label %for.cond.cleanup, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond
  %arrayidx12 = getelementptr inbounds nuw [15 x i32], ptr %s, i64 0, i64 %indvars.iv9
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body8
  %indvars.iv6 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next7, %for.body8 ]
  %m.1 = phi i32 [ %m.0, %for.cond5.preheader ], [ %m.2, %for.body8 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, 15
...
for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [15 x i32], ptr %s, i64 0, i64 %indvars.iv6
