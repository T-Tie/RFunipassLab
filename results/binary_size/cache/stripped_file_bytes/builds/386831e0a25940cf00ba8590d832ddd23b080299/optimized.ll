...
for.cond:                                         ; preds = %for.body, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc13, %for.body ]
  %flag.0 = phi i32 [ 1, %entry ], [ %flag.1, %for.body ]
  %a.0 = phi i32 [ 0, %entry ], [ %spec.select, %for.body ]
  %b.0 = phi i32 [ 0, %entry ], [ %b.1, %for.body ]
...
for.body:                                         ; preds = %for.cond
  ...
  %flag.1 = select i1 %or.cond1, i32 0, i32 %flag.0
  %inc11 = zext i1 %cmp2 to i32
  %b.1 = add nuw nsw i32 %b.0, %inc11
  %inc13 = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  %mul14 = shl nuw nsw i32 %a.0, 1
  ...
  %vtable.i = load ptr, ptr %call17, align 8, !tbaa !12
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call17, i8 noundef signext %call.i8)
