...
for.cond:                                         ; preds = %for.inc, %entry
  %1 = phi i32 [ %7, %for.inc ], [ %.pre6, %entry ]
...
for.cond2:                                        ; preds = %for.cond, %for.inc7
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc7 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
...
for.cond10.preheader:                             ; preds = %for.cond2
  ...
  %sub = add nsw i32 %4, -1
  %smax = tail call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv20 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next21, %for.inc28 ]
