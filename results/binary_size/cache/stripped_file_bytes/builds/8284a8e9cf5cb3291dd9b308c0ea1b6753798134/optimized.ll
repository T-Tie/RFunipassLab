...
for.end:                                          ; preds = %for.body, %entry
  ...
  %cmp5.i = icmp eq i32 %.lcssa, 0
  br i1 %cmp5.i, label %_Z1fPii.exit, label %if.else.i

if.else.i:                                        ; preds = %for.end, %if.else.i
  %n.tr8.i = phi i32 [ %sub.i, %if.else.i ], [ %.lcssa, %for.end ]
  %a.tr7.i = phi ptr [ %add.ptr.i, %if.else.i ], [ %a, %for.end ]
  %accumulator.tr6.i = phi i32 [ %cond.i.i, %if.else.i ], [ -2147483648, %for.end ]
  %add.ptr.i = getelementptr inbounds nuw i8, ptr %a.tr7.i, i64 4
  %sub.i = add nsw i32 %n.tr8.i, -1
  %3 = load i32, ptr %a.tr7.i, align 4, !tbaa !5
  %call.i = call noundef i32 @_Z1gPiii(ptr noundef nonnull %add.ptr.i, i32 noundef %sub.i, i32 noundef %3)
  %add.i = add nsw i32 %call.i, 1
  %cond.i.i = call noundef i32 @llvm.smax.i32(i32 %add.i, i32 %accumulator.tr6.i)
  %cmp.i = icmp eq i32 %sub.i, 0
  br i1 %cmp.i, label %_Z1fPii.exit, label %if.else.i

_Z1fPii.exit:                                     ; preds = %if.else.i, %for.end
  %accumulator.tr.lcssa.i = phi i32 [ -2147483648, %for.end ], [ %cond.i.i, %if.else.i ]
  %accumulator.ret.tr.i = call noundef range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %accumulator.tr.lcssa.i, i32 0)
  %call3 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %accumulator.ret.tr.i)
...
if.else:                                          ; preds = %entry, %if.else
  %n.tr8 = phi i32 [ %sub, %if.else ], [ %n, %entry ]
  %a.tr7 = phi ptr [ %add.ptr, %if.else ], [ %a, %entry ]
  %accumulator.tr6 = phi i32 [ %cond.i, %if.else ], [ -2147483648, %entry ]
  %add.ptr = getelementptr inbounds nuw i8, ptr %a.tr7, i64 4
  %sub = add nsw i32 %n.tr8, -1
  %0 = load i32, ptr %a.tr7, align 4, !tbaa !5
  %call = tail call noundef i32 @_Z1gPiii(ptr noundef nonnull %add.ptr, i32 noundef %sub, i32 noundef %0)
  %add = add nsw i32 %call, 1
  %cond.i = tail call noundef i32 @llvm.smax.i32(i32 %add, i32 %accumulator.tr6)
  %cmp = icmp eq i32 %sub, 0
  br i1 %cmp, label %return, label %if.else

return:                                           ; preds = %if.else, %entry
  %accumulator.tr.lcssa = phi i32 [ -2147483648, %entry ], [ %cond.i, %if.else ]
  %accumulator.ret.tr = tail call noundef i32 @llvm.smax.i32(i32 %accumulator.tr.lcssa, i32 0)
