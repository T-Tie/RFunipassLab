...
for.cond3:                                        ; preds = %for.body5, %for.end
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.body5 ], [ 0, %for.end ]
  %flag.1 = phi i32 [ %spec.select, %for.body5 ], [ %flag.0, %for.end ]
  %exitcond8 = icmp eq i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond8, label %for.end14, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv4
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc23
  %indvars.iv16 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next17, %for.inc23 ]
  %exitcond19 = icmp eq i64 %indvars.iv16, %5
  br i1 %exitcond19, label %if.end67, label %for.inc23

for.inc23:                                        ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv16
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc44
  %indvars.iv9 = phi i64 [ %7, %for.cond37.preheader ], [ %indvars.iv.next10, %for.inc44 ]
...
for.inc44:                                        ; preds = %for.cond37
  ...
  %arrayidx42 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv.next10
  %10 = load i8, ptr %arrayidx42, align 1, !tbaa !9
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc64
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc64 ], [ 0, %for.cond51.preheader ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, 100
  br i1 %exitcond15.not, label %if.end67, label %for.body53

for.body53:                                       ; preds = %for.cond51
  %arrayidx55 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv12
