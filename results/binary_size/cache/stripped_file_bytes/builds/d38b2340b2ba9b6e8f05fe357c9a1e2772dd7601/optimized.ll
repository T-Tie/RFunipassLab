...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv7 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next8, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 0)
  %3 = add nuw i32 %smax19, 1
  %wide.trip.count20 = zext i32 %3 to i64
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %s, i64 0, i64 %indvars.iv7
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc46
  %indvars.iv14 = phi i64 [ 1, %for.cond16.preheader ], [ %indvars.iv.next15, %for.inc46 ]
  %exitcond21 = icmp eq i64 %indvars.iv14, %wide.trip.count20
  br i1 %exitcond21, label %for.end48, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %6 = sub nsw i64 %2, %indvars.iv14
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc43
  %indvars.iv11 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next12, %for.inc43 ]
  %m.0 = phi i32 [ 0, %for.cond19.preheader ], [ %spec.select, %for.inc43 ]
  %cmp20.not = icmp sgt i64 %indvars.iv11, %6
  br i1 %cmp20.not, label %for.inc46, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv11
...
if.else:                                          ; preds = %for.end48
  %smax26 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 1)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond55

for.cond55:                                       ; preds = %for.inc61, %if.else
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc61 ], [ 1, %if.else ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %if.end64, label %for.inc61

for.inc61:                                        ; preds = %for.cond55
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv22
