...
_ZNSi7getlineEPcl.exit:                           ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call2.i = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPclc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %str, i64 noundef 101, i8 noundef signext %retval.0.i.i.i)
  ...
  %cmp16 = icmp sgt i64 %idx.ext, 0
  br i1 %cmp16, label %for.body, label %for.end27

for.body:                                         ; preds = %_ZNSi7getlineEPcl.exit, %for.inc
  %q.018 = phi ptr [ %incdec.ptr11, %for.inc ], [ %b, %_ZNSi7getlineEPcl.exit ]
  %p.017 = phi ptr [ %incdec.ptr, %for.inc ], [ %str, %_ZNSi7getlineEPcl.exit ]
  %4 = load i8, ptr %p.017, align 1, !tbaa !34
  %cmp7 = icmp eq i8 %4, 32
  br i1 %cmp7, label %land.lhs.true, label %for.inc

land.lhs.true:                                    ; preds = %for.body
  %add.ptr8 = getelementptr inbounds nuw i8, ptr %p.017, i64 1
  %5 = load i8, ptr %add.ptr8, align 1, !tbaa !34
  %cmp10 = icmp eq i8 %5, 32
  br i1 %cmp10, label %if.then, label %for.inc

if.then:                                          ; preds = %land.lhs.true
  store i32 1, ptr %q.018, align 4, !tbaa !35
  br label %for.inc

for.inc:                                          ; preds = %for.body, %land.lhs.true, %if.then
  %incdec.ptr = getelementptr inbounds nuw i8, ptr %p.017, i64 1
  %incdec.ptr11 = getelementptr inbounds nuw i8, ptr %q.018, i64 4
  %cmp = icmp ult ptr %incdec.ptr, %add.ptr
  br i1 %cmp, label %for.body, label %for.body19, !llvm.loop !36

for.body19:                                       ; preds = %for.inc, %for.inc24
  %q.121 = phi ptr [ %incdec.ptr26, %for.inc24 ], [ %b, %for.inc ]
  %p.120 = phi ptr [ %incdec.ptr25, %for.inc24 ], [ %str, %for.inc ]
  %6 = load i32, ptr %q.121, align 4, !tbaa !35
  %cmp20.not = icmp eq i32 %6, 1
  br i1 %cmp20.not, label %for.inc24, label %if.then21

if.then21:                                        ; preds = %for.body19
  %7 = load i8, ptr %p.120, align 1, !tbaa !34
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %7, ptr %__c.addr.i, align 1, !tbaa !34
  ...
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i13
  %8 = load i64, ptr %gep, align 8, !tbaa !39
...
if.end.i:                                         ; preds = %if.then21
  %call2.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %7)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
...
for.inc24:                                        ; preds = %for.body19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %incdec.ptr25 = getelementptr inbounds nuw i8, ptr %p.120, i64 1
  %incdec.ptr26 = getelementptr inbounds nuw i8, ptr %q.121, i64 4
  %cmp18 = icmp ult ptr %incdec.ptr25, %add.ptr
  br i1 %cmp18, label %for.body19, label %for.end27, !llvm.loop !40

for.end27:                                        ; preds = %for.inc24, %_ZNSi7getlineEPcl.exit
