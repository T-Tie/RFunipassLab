...
for.cond:                                         ; preds = %for.inc, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %t.0.in = phi i64 [ %call3, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ %t.1.in, %for.inc ]
  %4 = load i32, ptr %n, align 4, !tbaa !31
  %cmp = icmp slt i32 %i.0, %4
  br i1 %cmp, label %if.then6.i16, label %for.end

if.then6.i16:                                     ; preds = %for.cond
  ...
  %_M_streambuf_state.i.i.i26 = getelementptr inbounds nuw i8, ptr %add.ptr15.i25, i64 32
  %6 = load i32, ptr %_M_streambuf_state.i.i.i26, align 8, !tbaa !21
  %cmp.i.i27 = icmp eq i32 %6, 0
  %7 = add i64 %5, -81
  %or.cond.i31 = icmp ult i64 %7, -80
  %or.cond71 = select i1 %cmp.i.i27, i1 %or.cond.i31, i1 false
  br i1 %or.cond71, label %if.then19.i32, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41

if.then19.i32:                                    ; preds = %if.then6.i16
  %_M_streambuf.i.i33 = getelementptr inbounds nuw i8, ptr %add.ptr15.i25, i64 232
  %8 = load ptr, ptr %_M_streambuf.i.i33, align 8, !tbaa !22
  %call25.i34 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %8)
  %cmp.i18.i35 = icmp eq i32 %call25.i34, -1
  br i1 %cmp.i18.i35, label %if.then28.i36, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41, !prof !30

if.then28.i36:                                    ; preds = %if.then19.i32
  ...
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41: ; preds = %if.then6.i16, %if.then19.i32, %if.then28.i36
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41
  ...
  %gep72 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i44
  %9 = load i64, ptr %gep72, align 8, !tbaa !8
  %cmp.not.i = icmp eq i64 %9, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.then
  %call1.i47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i, i64 noundef 1)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  %retval.0.i = phi ptr [ %call1.i47, %if.then.i ], [ @_ZSt4cout, %if.end.i ]
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i)
  %call.i.i48 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #5
  %call1.i49 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull %a, i64 noundef %call.i.i48)
  %call18 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #6
  %add19 = add i64 %call18, %conv8
  br label %for.inc

if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41
  ...
  %call.i.i56 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #5
  %call1.i57 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i70, ptr noundef nonnull %a, i64 noundef %call.i.i56)
  %call26 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #6
  br label %for.inc

for.inc:                                          ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.else
  %t.1.in = phi i64 [ %add19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %call26, %if.else ]
