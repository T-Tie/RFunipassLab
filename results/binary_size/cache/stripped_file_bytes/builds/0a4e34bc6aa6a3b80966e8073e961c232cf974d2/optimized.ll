...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc24
  %indvars.iv11 = phi i64 [ %indvars.iv, %for.cond4.preheader ], [ %indvars.iv.next12, %for.inc24 ]
  %count.1 = phi i32 [ 0, %for.cond4.preheader ], [ %count.2, %for.inc24 ]
  %cmp9.not = icmp ult i64 %sub, %indvars.iv11
...
for.cond11.preheader.split:                       ; preds = %for.cond11.preheader
  %arrayidx17 = getelementptr inbounds nuw [500 x i8], ptr @a, i64 0, i64 %indvars.iv11
