...
entry:
  ...
  %wide.trip.count97 = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc16, %entry
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc16 ], [ 0, %entry ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %wide.trip.count97
  br i1 %exitcond98.not, label %for.cond19.preheader, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond
  %5 = mul nsw i64 %indvars.iv94, %3
  %arrayidx = getelementptr inbounds i32, ptr %vla1, i64 %5
  br label %for.cond2

for.cond19.preheader:                             ; preds = %for.cond
  %sub149 = add i32 %0, -1
  %smax143 = call i32 @llvm.smax.i32(i32 %sub149, i32 noundef 0)
  %wide.trip.count144 = zext nneg i32 %smax143 to i64
  br label %for.cond19

for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv89 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next90, %for.inc13 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %1
  br i1 %exitcond93.not, label %for.inc16, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %6 = mul nuw nsw i64 %indvars.iv89, %1
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc173
  %indvars.iv154 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next155, %for.inc173 ]
  %exitcond158.not = icmp eq i64 %indvars.iv154, %wide.trip.count97
  br i1 %exitcond158.not, label %for.cond176, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv154
  store i32 0, ptr %arrayidx23, align 4, !tbaa !5
  %7 = mul nsw i64 %indvars.iv154, %3
...
for.cond24:                                       ; preds = %for.inc171, %for.body21
  %indvars.iv151 = phi i64 [ %indvars.iv.next152, %for.inc171 ], [ %1, %for.body21 ]
  %cmp25 = icmp sgt i64 %indvars.iv151, 1
  br i1 %cmp25, label %for.cond27, label %for.inc173

for.cond27:                                       ; preds = %for.cond24, %for.inc66
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.inc66 ], [ 0, %for.cond24 ]
  %exitcond113.not = icmp eq i64 %indvars.iv109, %indvars.iv151
  br i1 %exitcond113.not, label %for.cond69, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %8 = mul nuw nsw i64 %indvars.iv109, %1
...
for.cond35:                                       ; preds = %for.body37, %for.body29
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.body37 ], [ 1, %for.body29 ]
  %min.0 = phi i32 [ %spec.select, %for.body37 ], [ %9, %for.body29 ]
  %exitcond103.not = icmp eq i64 %indvars.iv99, %indvars.iv151
  br i1 %exitcond103.not, label %for.cond54.preheader, label %for.body37

for.cond54.preheader:                             ; preds = %for.cond35
  br label %for.cond54

for.body37:                                       ; preds = %for.cond35
  %arrayidx43 = getelementptr inbounds nuw i32, ptr %arrayidx33, i64 %indvars.iv99
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc63
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.inc63 ], [ 0, %for.cond54.preheader ]
  %exitcond108.not = icmp eq i64 %indvars.iv104, %indvars.iv151
  br i1 %exitcond108.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond54
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx33, i64 %indvars.iv104
...
for.cond69:                                       ; preds = %for.cond27, %for.inc111
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %for.inc111 ], [ 0, %for.cond27 ]
  %exitcond128.not = icmp eq i64 %indvars.iv124, %indvars.iv151
  br i1 %exitcond128.not, label %for.end113, label %for.body71

for.body71:                                       ; preds = %for.cond69
  %arrayidx76 = getelementptr inbounds nuw i32, ptr %arrayidx31, i64 %indvars.iv124
  %12 = load i32, ptr %arrayidx76, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond77

for.cond77:                                       ; preds = %for.body79, %for.body71
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.body79 ], [ 1, %for.body71 ]
  %min.2 = phi i32 [ %spec.select85, %for.body79 ], [ %12, %for.body71 ]
  %exitcond118.not = icmp eq i64 %indvars.iv114, %indvars.iv151
  br i1 %exitcond118.not, label %for.cond98.preheader, label %for.body79

for.cond98.preheader:                             ; preds = %for.cond77
  br label %for.cond98

for.body79:                                       ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv114, %1
  %gep = getelementptr inbounds nuw i32, ptr %arrayidx76, i64 %13
  %14 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !14
  %spec.select85 = call i32 @llvm.smin.i32(i32 %14, i32 %min.2)
  %indvars.iv.next115 = add nuw nsw i64 %indvars.iv114, 1
  br label %for.cond77, !llvm.loop !18

for.cond98:                                       ; preds = %for.cond98.preheader, %for.inc108
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %for.inc108 ], [ 0, %for.cond98.preheader ]
  %exitcond123.not = icmp eq i64 %indvars.iv119, %indvars.iv151
  br i1 %exitcond123.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond98
  %15 = mul nuw nsw i64 %indvars.iv119, %1
  %gep87 = getelementptr inbounds nuw i32, ptr %arrayidx76, i64 %15
  %16 = load i32, ptr %gep87, align 4, !tbaa !5, !invariant.load !14
  %sub107 = sub nsw i32 %16, %min.2
  store i32 %sub107, ptr %gep87, align 4, !tbaa !5
...
for.cond120:                                      ; preds = %for.inc142, %for.end113
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %for.inc142 ], [ 2, %for.end113 ]
  %exitcond139.not = icmp eq i64 %indvars.iv134, %indvars.iv151
  br i1 %exitcond139.not, label %for.cond145, label %for.cond123.preheader

for.cond123.preheader:                            ; preds = %for.cond120
  %18 = mul nuw nsw i64 %indvars.iv134, %1
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx31, i64 %18
  %19 = add nsw i64 %indvars.iv134, -1
...
for.cond123:                                      ; preds = %for.cond123.preheader, %for.inc139
  %indvars.iv129 = phi i64 [ 0, %for.cond123.preheader ], [ %indvars.iv.next130, %for.inc139 ]
  %exitcond133.not = icmp eq i64 %indvars.iv129, %1
  br i1 %exitcond133.not, label %for.inc142, label %for.inc139

for.inc139:                                       ; preds = %for.cond123
  %arrayidx131 = getelementptr inbounds nuw i32, ptr %arrayidx129, i64 %indvars.iv129
  %21 = load i32, ptr %arrayidx131, align 4, !tbaa !5, !invariant.load !14
  %arrayidx138 = getelementptr inbounds nuw i32, ptr %arrayidx136, i64 %indvars.iv129
...
for.cond145:                                      ; preds = %for.cond120, %for.inc168
  %indvars.iv146 = phi i64 [ %indvars.iv.next147, %for.inc168 ], [ 2, %for.cond120 ]
  %exitcond150.not = icmp eq i64 %indvars.iv146, %indvars.iv151
  br i1 %exitcond150.not, label %for.inc171, label %for.cond148.preheader

for.cond148.preheader:                            ; preds = %for.cond145
  %invariant.gep = getelementptr i32, ptr %arrayidx31, i64 %indvars.iv146
  br label %for.cond148

for.cond148:                                      ; preds = %for.cond148.preheader, %for.inc165
  %indvars.iv140 = phi i64 [ 0, %for.cond148.preheader ], [ %indvars.iv.next141, %for.inc165 ]
  %exitcond145.not = icmp eq i64 %indvars.iv140, %wide.trip.count144
  br i1 %exitcond145.not, label %for.inc168, label %for.inc165

for.inc165:                                       ; preds = %for.cond148
  %22 = mul nuw nsw i64 %indvars.iv140, %1
  %gep164 = getelementptr i32, ptr %invariant.gep, i64 %22
  %23 = load i32, ptr %gep164, align 4, !tbaa !5, !invariant.load !14
  %arrayidx164 = getelementptr i8, ptr %gep164, i64 -4
...
for.cond176:                                      ; preds = %for.cond19, %for.inc183
  %indvars.iv159 = phi i64 [ %indvars.iv.next160, %for.inc183 ], [ 0, %for.cond19 ]
  %exitcond163.not = icmp eq i64 %indvars.iv159, %wide.trip.count97
  br i1 %exitcond163.not, label %for.end185, label %for.inc183

for.inc183:                                       ; preds = %for.cond176
  %arrayidx180 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv159
