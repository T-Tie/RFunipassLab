...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.end26 ], [ 0, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv42, %4
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  br i1 %cmp31, label %for.cond30.preheader34, label %for.end65

for.cond30.preheader34:                           ; preds = %for.cond30.preheader
...
for.cond30:                                       ; preds = %for.cond30.preheader34, %for.end62
  %indvars.iv66 = phi i64 [ 0, %for.cond30.preheader34 ], [ %indvars.iv.next67, %for.end62 ]
  br label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.end59
  %indvars.iv60 = phi i64 [ 0, %for.cond30 ], [ %indvars.iv.next61, %for.end59 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count64
  br i1 %exitcond65.not, label %for.end62, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx51 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv66, i64 %indvars.iv60
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv54 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next55, %for.body39 ]
  %exitcond.not = icmp eq i64 %indvars.iv54, %wide.trip.count
  br i1 %exitcond.not, label %for.end59, label %for.body39

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv54
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !14
  %arrayidx47 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv54, i64 %indvars.iv60
...
for.cond69:                                       ; preds = %for.body71, %for.end65
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.body71 ], [ 1, %for.end65 ]
  %12 = load i32, ptr %y2, align 4, !tbaa !5
  %13 = sext i32 %12 to i64
  %cmp70 = icmp slt i64 %indvars.iv45, %13
...
for.body71:                                       ; preds = %for.cond69
  ...
  %arrayidx75 = getelementptr inbounds nuw [100 x i32], ptr %c, i64 0, i64 %indvars.iv45
...
for.cond80:                                       ; preds = %for.cond69, %for.end99
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.end99 ], [ 1, %for.cond69 ]
...
for.body82:                                       ; preds = %for.cond80
  ...
  %arrayidx85 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv51
...
for.cond88:                                       ; preds = %for.body90, %for.body82
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body90 ], [ 1, %for.body82 ]
  %17 = load i32, ptr %y2, align 4, !tbaa !5
  %18 = sext i32 %17 to i64
  %cmp89 = icmp slt i64 %indvars.iv48, %18
...
for.body90:                                       ; preds = %for.cond88
  ...
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv51, i64 %indvars.iv48
