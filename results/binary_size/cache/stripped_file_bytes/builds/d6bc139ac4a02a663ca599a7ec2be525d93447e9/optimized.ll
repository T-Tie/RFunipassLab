...
for.cond11.preheader:                             ; preds = %for.cond
  %smax32 = call i32 @llvm.smax.i32(i32 %k.0, i32 1)
  br label %for.cond11
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc37
  %indvars.iv29.in = phi i32 [ %k.0, %for.cond11.preheader ], [ %indvars.iv29, %for.inc37 ]
  %i.1 = phi i32 [ 1, %for.cond11.preheader ], [ %inc38, %for.inc37 ]
  %indvars.iv29 = add i32 %indvars.iv29.in, -1
  %exitcond33.not = icmp eq i32 %i.1, %smax32
  br i1 %exitcond33.not, label %for.end39, label %for.cond14.preheader
...
for.cond14:                                       ; preds = %for.cond14.backedge, %for.cond14.preheader
  ...
  br i1 %exitcond.not, label %for.inc37, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv25
  %7 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %arrayidx20 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv.next26
  %8 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %cmp21.not = icmp slt i32 %7, %8
  br i1 %cmp21.not, label %for.cond14.backedge, label %if.then22
...
for.inc37:                                        ; preds = %for.cond14
  %inc38 = add nuw i32 %i.1, 1
  br label %for.cond11, !llvm.loop !13

for.end39:                                        ; preds = %for.cond11
  %9 = load i32, ptr %vla1, align 16, !tbaa !5
  %call41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
  %wide.trip.count37 = zext nneg i32 %smax32 to i64
  br label %for.cond42

for.cond42:                                       ; preds = %for.body44, %for.end39
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body44 ], [ 1, %for.end39 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count37
  br i1 %exitcond38.not, label %for.end51, label %for.body44
...
for.body44:                                       ; preds = %for.cond42
  ...
  %arrayidx47 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv34
  %10 = load i32, ptr %arrayidx47, align 4, !tbaa !5
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
