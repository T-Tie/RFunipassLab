...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %c) #8
...
while.cond:                                       ; preds = %if.end40, %entry
  %number.0 = phi i32 [ 0, %entry ], [ %number.3, %if.end40 ]
...
while.cond1:                                      ; preds = %while.cond1.preheader, %if.end28
  %number.1 = phi i32 [ %conv26, %if.end28 ], [ %number.0, %while.cond1.preheader ]
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %0 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !6, !invariant.load !5
  %1 = add i64 %0, -101
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
  br label %if.end28

if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %conv11 = sext i32 %number.1 to i64
  %call13 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
...
if.end:                                           ; preds = %if.else
  ...
  %call23 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
  %add25 = add i64 %add14, %call23
  br label %if.end28

if.end28:                                         ; preds = %if.end, %if.then
  %add25.sink = phi i64 [ %add25, %if.end ], [ %call8, %if.then ]
  %conv26 = trunc i64 %add25.sink to i32
  %2 = load i32, ptr %c, align 4, !tbaa !20
  %cmp29 = icmp eq i32 %add, %2
  br i1 %cmp29, label %while.end, label %while.cond1, !llvm.loop !21

while.end:                                        ; preds = %if.else, %while.cond1, %if.end28
  %number.2 = phi i32 [ %conv26, %if.end28 ], [ %number.1, %while.cond1 ], [ %number.1, %if.else ]
  %m.1 = phi i32 [ 0, %if.end28 ], [ %m.0, %while.cond1 ], [ %m.0, %if.else ]
  %an_number.2 = phi i32 [ %add, %if.end28 ], [ %an_number.1, %while.cond1 ], [ %add, %if.else ]
  %3 = load i32, ptr %c, align 4, !tbaa !20
  %cmp32.not = icmp eq i32 %an_number.2, %3
...
if.then33:                                        ; preds = %while.end
  ...
  %call38 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
  %conv39 = trunc i64 %call38 to i32
  br label %if.end40

if.end40:                                         ; preds = %if.then33, %while.end
  %number.3 = phi i32 [ %conv39, %if.then33 ], [ %number.2, %while.end ]
  br label %while.cond, !llvm.loop !24

while.end41:                                      ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %c) #9
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull align 16 dereferenceable(100) %a) #9
  ret i32 0
}
