...
define dso_local noundef i32 @_Z9factorizeii(i32 noundef %m, i32 noundef %k) #0 {
entry:
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %call = call noundef double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 noundef %3)
...
if.then2:                                         ; preds = %for.body
  ...
  %div = sdiv i32 %6, %7
  %8 = load i32, ptr %k.addr, align 4, !tbaa !5
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call4 = call noundef i32 @_Z9factorizeii(i32 noundef %div, i32 noundef %cond)
  %12 = load i32, ptr %c, align 4, !tbaa !5
  %add = add nsw i32 %12, %call4
  store i32 %add, ptr %c, align 4, !tbaa !5
  br label %if.end5

if.end5:                                          ; preds = %cond.end, %for.body
  br label %for.inc
...
define linkonce_odr dso_local noundef double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 noundef %__x) #2 comdat {
entry:
...
entry:
  ...
  store ptr %argv, ptr %argv.addr, align 8, !tbaa !12
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z9factorizeii(i32 noundef %1, i32 noundef 2)
...
!24 = !{!25, !25, i64 0}
!25 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !15, i64 0}
!26 = !{!7, !7, i64 0}
!27 = !{!28, !40, i64 240}
...
!33 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !15, i64 0}
!34 = !{!"_ZTSNSt8ios_base6_WordsE", !15, i64 0, !30, i64 8}
!35 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !15, i64 0}
!36 = !{!"_ZTSSt6locale", !37, i64 0}
!37 = !{!"p1 _ZTSNSt6locale5_ImplE", !15, i64 0}
!38 = !{!"bool", !7, i64 0}
!39 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !15, i64 0}
!40 = !{!"p1 _ZTSSt5ctypeIcE", !15, i64 0}
!41 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !15, i64 0}
!42 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !15, i64 0}
!43 = !{!40, !40, i64 0}
!44 = !{!45, !7, i64 56}
