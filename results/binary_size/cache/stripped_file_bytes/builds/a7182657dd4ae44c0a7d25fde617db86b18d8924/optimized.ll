...
if.then:                                          ; preds = %for.body
  ...
  %call.i5 = call noundef float @sqrtf(float noundef nofpclass(nzero) %6) #6, !tbaa !5
  %sub = fsub float %fneg63, %call.i5
...
if.else60:                                        ; preds = %for.body
  ...
  %call.i6 = call noundef float @sqrtf(float noundef %7) #6, !tbaa !5
  %conv83 = fpext float %call.i6 to double
