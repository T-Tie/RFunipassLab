...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %words) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %n) #6
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %.pr = load i32, ptr %n, align 4, !tbaa !5
  %cmp41 = icmp sgt i32 %.pr, 0
  br i1 %cmp41, label %if.then6.i, label %while.end

if.then6.i:                                       ; preds = %entry, %if.end22
  %sum.043 = phi i32 [ %sum.1, %if.end22 ], [ 0, %entry ]
  %temp.042 = phi i32 [ %temp.1, %if.end22 ], [ 0, %entry ]
  ...
  %0 = load i64, ptr %gep, align 8, !tbaa !11
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %words, i64 noundef 50)
  ...
  %1 = load i32, ptr %_M_streambuf_state.i.i18.i, align 8, !tbaa !22
...
if.then19.i:                                      ; preds = %if.then6.i
  ...
  %4 = load ptr, ptr %_M_in_cur.i.i.i, align 8, !tbaa !31
  %_M_in_end.i.i.i = getelementptr inbounds nuw i8, ptr %3, i64 24
  %5 = load ptr, ptr %_M_in_end.i.i.i, align 8, !tbaa !34
...
_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv.exit.i: ; preds = %if.then19.i
  %vtable.i.i = load ptr, ptr %3, align 8, !tbaa !9
...
if.then28.i:                                      ; preds = %_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv.exit.i
  ...
  %7 = load i32, ptr %_M_streambuf_state.i.i21.i, align 8, !tbaa !22
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %if.then19.i, %_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv.exit.i, %if.then28.i
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #6
  %conv = trunc i64 %call3 to i32
  %add = add nsw i32 %sum.043, %conv
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %cmp5 = icmp eq i32 %temp.042, 0
  br i1 %cmp5, label %if.then6, label %if.else

if.then6:                                         ; preds = %if.then
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %words, i64 noundef %call3)
  br label %if.end22

if.else:                                          ; preds = %if.then
  %call1.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  %call.i.i16 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #6
  %call1.i17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %words, i64 noundef %call.i.i16)
  %add14 = add nsw i32 %add, 1
  %inc15 = add nsw i32 %temp.042, 1
  br label %if.end22
...
if.else16:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %gep40 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 240), i64 %vbase.offset.i36
  %8 = load ptr, ptr %gep40, align 8, !tbaa !37
  %tobool.not.i.i.i = icmp eq ptr %8, null
  br i1 %tobool.not.i.i.i, label %if.then.i.i.i, label %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i

if.then.i.i.i:                                    ; preds = %if.else16
  call void @_ZSt16__throw_bad_castv() #7
  unreachable

_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %if.else16
...
if.then.i2.i.i:                                   ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  ...
  %10 = load i8, ptr %arrayidx.i.i.i, align 1, !tbaa !44
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %retval.0.i.i.i)
  ...
  %call.i.i24 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #6
  %call1.i25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i39, ptr noundef nonnull %words, i64 noundef %call.i.i24)
  %call1.i33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i39, ptr noundef nonnull @.str, i64 noundef 1)
  %add21 = add nsw i32 %conv, 1
  br label %if.end22

if.end22:                                         ; preds = %if.then6, %if.else, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %temp.1 = phi i32 [ 1, %if.then6 ], [ %inc15, %if.else ], [ 0, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %sum.1 = phi i32 [ %add, %if.then6 ], [ %add14, %if.else ], [ %add21, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %dec = add nsw i32 %12, -1
  store i32 %dec, ptr %n, align 4, !tbaa !5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(50) %words, i8 0, i64 50, i1 false)
  %cmp = icmp sgt i32 %12, 1
  br i1 %cmp, label %if.then6.i, label %while.end, !llvm.loop !45

while.end:                                        ; preds = %if.end22, %entry
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #6
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %words) #6
  ret i32 0
}
