...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc28
  %indvars.iv18 = phi i32 [ %sub, %for.cond2.preheader ], [ %indvars.iv.next19, %for.inc28 ]
  %i.1 = phi i32 [ 0, %for.cond2.preheader ], [ %inc29, %for.inc28 ]
  %exitcond21.not = icmp eq i32 %i.1, %smax20
  br i1 %exitcond21.not, label %for.end30, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.backedge, %for.cond5.preheader
  %indvars.iv15 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next16, %for.cond5.backedge ]
...
for.body9:                                        ; preds = %for.cond5
  ...
  %arrayidx13 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next16
