...
for.cond3:                                        ; preds = %for.body5, %for.end
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body5 ], [ 0, %for.end ]
  %flag.1 = phi i32 [ %spec.select, %for.body5 ], [ %flag.0, %for.end ]
  %exitcond32 = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond32, label %for.end14, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv28
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc23
  %indvars.iv40 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next41, %for.inc23 ]
  %exitcond43 = icmp eq i64 %indvars.iv40, %5
  br i1 %exitcond43, label %if.end67, label %for.inc23

for.inc23:                                        ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv40
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc44
  %indvars.iv33 = phi i64 [ %7, %for.cond37.preheader ], [ %indvars.iv.next34, %for.inc44 ]
...
for.inc44:                                        ; preds = %for.cond37
  ...
  %arrayidx42 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv.next34
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc64
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc64 ], [ 0, %for.cond51.preheader ]
  %exitcond39.not = icmp eq i64 %indvars.iv36, 100
  br i1 %exitcond39.not, label %if.end67, label %for.body53

for.body53:                                       ; preds = %for.cond51
  %arrayidx55 = getelementptr inbounds nuw [100 x i8], ptr %word, i64 0, i64 %indvars.iv36
