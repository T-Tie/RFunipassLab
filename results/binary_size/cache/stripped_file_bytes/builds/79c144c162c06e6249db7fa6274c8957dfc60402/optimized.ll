...
if.then:                                          ; preds = %for.body
  ...
  %call.i6 = call noundef float @sqrtf(float noundef nofpclass(nzero) %6) #6, !tbaa !5
  %sub = fsub float %fneg, %call.i6
...
if.else60:                                        ; preds = %for.body
  ...
  %call.i7 = call noundef float @sqrtf(float noundef %7) #6, !tbaa !5
