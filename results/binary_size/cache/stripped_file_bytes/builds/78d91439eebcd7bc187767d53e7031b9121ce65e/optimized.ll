...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4800, ptr nonnull %a) #4
...
for.cond1.preheader:                              ; preds = %entry, %if.else
  %indvars.iv23 = phi i64 [ 0, %entry ], [ %indvars.iv.next24, %if.else ]
  br label %for.body3

for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body3 ]
  %arrayidx5 = getelementptr inbounds nuw [6 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv, i64 %indvars.iv23
...
for.end:                                          ; preds = %for.body3
  %arrayidx8 = getelementptr inbounds nuw [200 x i32], ptr %a, i64 0, i64 %indvars.iv23
  %0 = load i32, ptr %arrayidx8, align 4, !tbaa !8
  %cmp9 = icmp eq i32 %0, 0
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx10, i64 0, i64 %indvars.iv23
...
if.else:                                          ; preds = %for.end, %land.lhs.true29, %land.lhs.true24, %land.lhs.true19, %land.lhs.true14
  %6 = phi i32 [ 0, %land.lhs.true29 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true19 ], [ 0, %land.lhs.true14 ], [ %1, %for.end ]
  %arrayidx43 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx15, i64 0, i64 %indvars.iv23
  %7 = load i32, ptr %arrayidx43, align 4, !tbaa !8
  %arrayidx47 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx20, i64 0, i64 %indvars.iv23
  %8 = load i32, ptr %arrayidx47, align 4, !tbaa !8
  %arrayidx52 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx25, i64 0, i64 %indvars.iv23
  %9 = load i32, ptr %arrayidx52, align 4, !tbaa !8
  %arrayidx57 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx30, i64 0, i64 %indvars.iv23
  %10 = load i32, ptr %arrayidx57, align 4, !tbaa !8
  %reass.add = sub i32 %9, %6
  %reass.mul = mul i32 %reass.add, 60
  %reass.add18 = sub i32 %8, %0
  %reass.mul19 = mul i32 %reass.add18, 3600
  %reass.sub = sub i32 %10, %7
  %add54 = add i32 %reass.sub, 43200
  ...
  %exitcond26.not = icmp eq i64 %indvars.iv.next24, 200
  br i1 %exitcond26.not, label %for.end62, label %for.cond1.preheader, !llvm.loop !12

for.end62:                                        ; preds = %land.lhs.true29, %if.else
  call void @llvm.lifetime.end.p0(i64 4800, ptr nonnull %a) #4
  ret i32 0
}
