...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %s) #6
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp, label %for.inc, label %for.cond7
...
for.inc:                                          ; preds = %for.cond
  ...
  %call3 = call i32 @getchar() #8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond

for.cond7:                                        ; preds = %for.cond
  %1 = load i32, ptr %s, align 16, !tbaa !5
  %call5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1) #8
  %call6 = call i32 @getchar() #8
  %2 = load i32, ptr %n, align 4, !tbaa !5
  %cmp8 = icmp slt i32 %2, 2
  call void @llvm.assume(i1 %cmp8)
  %putchar = call i32 @putchar(i32 10)
  %call32 = call i32 @getchar() #8
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %s) #8
