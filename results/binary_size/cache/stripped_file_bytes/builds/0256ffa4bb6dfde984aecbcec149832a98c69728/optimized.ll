...
for.cond12:                                       ; preds = %for.cond
  %cmp13 = icmp sgt i32 %j.0, 0
  br i1 %cmp13, label %for.body20, label %for.end61

for.body20:                                       ; preds = %for.cond12, %if.end37
  %3 = phi i32 [ %5, %if.end37 ], [ undef, %for.cond12 ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %if.end37 ], [ 0, %for.cond12 ]
...
if.end37:                                         ; preds = %if.then26, %for.body20
  %5 = phi i32 [ %3, %if.then26 ], [ %4, %for.body20 ]
  br label %for.body20

for.end61:                                        ; preds = %for.cond12
