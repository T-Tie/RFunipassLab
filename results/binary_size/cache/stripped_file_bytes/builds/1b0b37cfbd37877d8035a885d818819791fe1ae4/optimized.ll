...
for.cond33:                                       ; preds = %for.inc53, %for.body32
...
for.end49:                                        ; preds = %for.cond36
  ...
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %30)
  %31 = load i32, ptr %j, align 4, !tbaa !5
  %32 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = sub nsw i32 %32, 1
  %cmp51 = icmp slt i32 %31, %sub
  br i1 %cmp51, label %if.then, label %if.end

if.then:                                          ; preds = %for.end49
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  br label %if.end
