...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %num) #5
...
for.body17:                                       ; preds = %for.cond15
  %puts17 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.3.sink) #6
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond15

for.end39:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %num) #6
