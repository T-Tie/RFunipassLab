...
for.cond:                                         ; preds = %for.cond.preheader, %if.end39
  %indvars.iv27 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next28, %if.end39 ]
...
for.inc36:                                        ; preds = %for.cond26
  %arrayidx35 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv27, i64 %indvars.iv
