...
for.cond:                                         ; preds = %entry, %while.cond
  store i32 %0, ptr %n, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull %a) #9
  br label %for.cond1

for.cond1:                                        ; preds = %for.inc12, %for.cond
  %1 = phi i32 [ %3, %for.inc12 ], [ %0, %for.cond ]
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv46, %2
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv
...
while.cond:                                       ; preds = %for.cond1
  %cmp15 = icmp slt i32 %1, 2
  call void @llvm.assume(i1 noundef %cmp15)
  %call163 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
