...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %ju1) #7
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv14, %5
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc24 ], [ 0, %for.cond13 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %10 = sext i32 %9 to i64
  %cmp17 = icmp slt i64 %indvars.iv11, %10
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv14, i64 %indvars.iv11
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc61
  %indvars.iv26 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next27, %for.inc61 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond64, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc58
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc58 ], [ 0, %for.cond30 ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25.not, label %for.inc61, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx42 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ans, i64 0, i64 %indvars.iv26, i64 %indvars.iv20
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc55
  %indvars.iv17 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next18, %for.inc55 ]
...
for.inc55:                                        ; preds = %for.cond36
  ...
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv26, i64 %indvars.iv17
  %12 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !15
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv17, i64 %indvars.iv20
...
for.cond64:                                       ; preds = %for.cond30, %for.inc86
  ...
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc86 ], [ 0, %for.cond30 ]
  %16 = sext i32 %15 to i64
  %cmp65 = icmp slt i64 %indvars.iv35, %16
  br i1 %cmp65, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond64, %for.inc83
  %17 = phi i32 [ %.pre38, %for.inc83 ], [ %14, %for.cond64 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc83 ], [ 0, %for.cond64 ]
  %18 = sext i32 %17 to i64
  %cmp68 = icmp slt i64 %indvars.iv32, %18
  br i1 %cmp68, label %for.body69, label %for.inc86

for.body69:                                       ; preds = %for.cond67
  %sub = add nsw i32 %17, -1
  %19 = zext i32 %sub to i64
  %cmp70 = icmp eq i64 %indvars.iv32, %19
  %20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ans, i64 0, i64 %indvars.iv35, i64 %indvars.iv32
  %21 = load i32, ptr %20, align 4, !tbaa !5, !invariant.load !15
  %call75 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %21)
