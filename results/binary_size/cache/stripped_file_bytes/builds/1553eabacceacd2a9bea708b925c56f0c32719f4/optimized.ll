...
tailrecurse:                                      ; preds = %for.end28, %entry
  ...
  %spec.select17 = phi i32 [ %spec.select, %for.end28 ], [ %maximum.promoted, %entry ]
  %3 = icmp eq i64 %indvars.iv, %sext
...
for.cond:                                         ; preds = %if.end24, %if.end.split
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %if.end24 ], [ %2, %if.end.split ]
  %add.ptr9 = getelementptr inbounds i8, ptr @str, i64 %indvars.iv26
  br i1 %cmp5.le, label %for.cond3, label %for.end.split

for.cond3:                                        ; preds = %for.cond, %for.cond3
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond3 ], [ 0, %for.cond ]
  %add.ptr11 = getelementptr inbounds nuw i8, ptr %add.ptr9, i64 %indvars.iv20
  %4 = load i8, ptr %add.ptr11, align 1, !tbaa !9, !invariant.load !10
  %add.ptr15 = getelementptr inbounds nuw i8, ptr %add.ptr13.le, i64 %indvars.iv20
  %5 = load i8, ptr %add.ptr15, align 1, !tbaa !9, !invariant.load !10
  %cmp17 = icmp eq i8 %4, %5
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br i1 %cmp17, label %for.cond3, label %for.end.split.loopexit

for.end.split.loopexit:                           ; preds = %for.cond3
  %6 = trunc i64 %indvars.iv20 to i32
  br label %for.end.split

for.end.split:                                    ; preds = %for.end.split.loopexit, %for.cond
  %indvars.iv20.lcssa.split = phi i32 [ 0, %for.cond ], [ %6, %for.end.split.loopexit ]
  %cmp21 = icmp eq i32 %1, %indvars.iv20.lcssa.split
  br i1 %cmp21, label %if.then22, label %if.end24

if.then22:                                        ; preds = %for.end.split
  %7 = load i32, ptr %add.ptr, align 4, !tbaa !5
  %inc.i9 = add nsw i32 %7, 1
  store i32 %inc.i9, ptr %add.ptr, align 4, !tbaa !5
  br label %if.end24

if.end24:                                         ; preds = %if.then22, %for.end.split
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, 1
  br label %for.cond

for.end28:                                        ; preds = %if.end
  %8 = load i32, ptr %add.ptr, align 4, !tbaa !5, !invariant.load !10
  %spec.select = tail call i32 @llvm.smax.i32(i32 %8, i32 %spec.select17)
  store i32 %spec.select, ptr @maximum, align 4, !tbaa !5
...
entry:
  ...
  %.pre14 = load i32, ptr @len, align 4, !tbaa !5
  %.pre16 = load i32, ptr @n, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %if.end, %entry
  %2 = phi i32 [ %7, %if.end ], [ %.pre16, %entry ]
  %3 = phi i32 [ %8, %if.end ], [ %.pre14, %entry ]
...
for.cond3.preheader:                              ; preds = %for.body
  %add.ptr9 = getelementptr inbounds nuw i8, ptr @str, i64 %indvars.iv11
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond3.preheader, %for.body7
  %5 = phi i32 [ %2, %for.cond3.preheader ], [ %.pre17, %for.body7 ]
...
if.end:                                           ; preds = %for.end, %for.body
  %7 = phi i32 [ %.pre15, %for.end ], [ %2, %for.body ]
