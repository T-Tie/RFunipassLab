...
for.cond67:                                       ; preds = %for.cond64, %for.body69
  ...
  %cmp68 = icmp slt i64 %indvars.iv59, %17
...
for.body69:                                       ; preds = %for.cond67
  ...
  %18 = load i32, ptr %arrayidx73, align 4, !tbaa !5
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %18)
...
for.end78:                                        ; preds = %for.cond67
  %arrayidx83 = getelementptr inbounds [100 x [100 x i32]], ptr @c, i64 0, i64 %indvars.iv62, i64 %17
  %19 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %call84 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %19)
