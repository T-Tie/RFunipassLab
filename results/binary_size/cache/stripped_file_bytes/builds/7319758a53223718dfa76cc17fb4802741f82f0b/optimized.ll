...
for.cond18:                                       ; preds = %for.cond, %for.inc40
  %6 = phi i32 [ %.pre, %for.inc40 ], [ %2, %for.cond ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc40 ], [ 1, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv17, %7
  br i1 %cmp20.not.not, label %for.body21, label %for.end42

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %result, i64 0, i64 %indvars.iv17
