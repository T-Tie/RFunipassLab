...
for.body:                                         ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %i.03 = phi i32 [ %inc, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 1, %entry ]
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %cmp.not.not = icmp slt i32 %i.03, %6
...
define dso_local noundef i32 @_Z1fii(i32 noundef %n, i32 noundef %m) local_unnamed_addr #3 {
entry:
  %conv.i = sitofp i32 %n to double
  %call.i8 = tail call noundef double @sqrt(double noundef %conv.i) #6, !tbaa !5
  %conv9 = fptosi double %call.i8 to i32
  %cmp.not10 = icmp sgt i32 %m, %conv9
  br i1 %cmp.not10, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.inc
  %number.012 = phi i32 [ %number.1, %for.inc ], [ 1, %entry ]
  %j.011 = phi i32 [ %inc, %for.inc ], [ %m, %entry ]
  %rem = srem i32 %n, %j.011
  %div = sdiv i32 %n, %j.011
  %cmp1 = icmp eq i32 %rem, 0
  br i1 %cmp1, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %call2 = tail call noundef i32 @_Z1fii(i32 noundef %div, i32 noundef %j.011)
  %add = add nsw i32 %call2, %number.012
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then
  %number.1 = phi i32 [ %add, %if.then ], [ %number.012, %for.body ]
  %inc = add nsw i32 %j.011, 1
  %call.i = tail call noundef double @sqrt(double noundef %conv.i) #6, !tbaa !5
  %conv = fptosi double %call.i to i32
  %cmp.not.not = icmp slt i32 %j.011, %conv
  br i1 %cmp.not.not, label %for.body, label %for.end, !llvm.loop !39

for.end:                                          ; preds = %for.inc, %entry
  %number.0.lcssa = phi i32 [ 1, %entry ], [ %number.1, %for.inc ]
