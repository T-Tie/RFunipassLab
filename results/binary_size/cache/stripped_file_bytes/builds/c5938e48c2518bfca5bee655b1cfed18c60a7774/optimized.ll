...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %maxtemp) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %maxtemp2) #9
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  store i32 %4, ptr %maxtemp2, align 4, !tbaa !5
  store i32 %4, ptr %maxtemp, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %i3) #9
...
for.cond.cleanup6:                                ; preds = %for.cond4
  call void @llvm.lifetime.end.p0(i64 4, ptr %i3) #9
  br label %for.end13

for.body7:                                        ; preds = %for.cond4
  %7 = load i32, ptr %maxtemp, align 4, !tbaa !5
  ...
  %call10 = call noundef i32 @_Z3maxii(i32 noundef %7, i32 noundef %9)
  store i32 %call10, ptr %maxtemp, align 4, !tbaa !5
  br label %for.inc11

for.inc11:                                        ; preds = %for.body7
  %10 = load i32, ptr %i3, align 4, !tbaa !5
  %inc12 = add nsw i32 %10, 1
  store i32 %inc12, ptr %i3, align 4, !tbaa !5
  br label %for.cond4, !llvm.loop !12

for.end13:                                        ; preds = %for.cond.cleanup6
  call void @llvm.lifetime.start.p0(i64 4, ptr %i14) #9
  store i32 0, ptr %i14, align 4, !tbaa !5
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc24, %for.end13
  %11 = load i32, ptr %i14, align 4, !tbaa !5
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %cmp16 = icmp slt i32 %11, %12
  br i1 %cmp16, label %for.body18, label %for.cond.cleanup17

for.cond.cleanup17:                               ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 4, ptr %i14) #9
  br label %for.end26

for.body18:                                       ; preds = %for.cond15
  %13 = load i32, ptr %i14, align 4, !tbaa !5
  %idxprom19 = sext i32 %13 to i64
  %arrayidx20 = getelementptr inbounds [1000 x i32], ptr %a, i64 0, i64 %idxprom19
  %14 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %15 = load i32, ptr %maxtemp, align 4, !tbaa !5
  %cmp21 = icmp eq i32 %14, %15
  br i1 %cmp21, label %if.then, label %if.end

if.then:                                          ; preds = %for.body18
  %16 = load i32, ptr %i14, align 4, !tbaa !5
...
for.inc24:                                        ; preds = %if.end
  %17 = load i32, ptr %i14, align 4, !tbaa !5
  %inc25 = add nsw i32 %17, 1
  store i32 %inc25, ptr %i14, align 4, !tbaa !5
  br label %for.cond15, !llvm.loop !13

for.end26:                                        ; preds = %for.cond.cleanup17
  call void @llvm.lifetime.start.p0(i64 4, ptr %i27) #9
  store i32 0, ptr %i27, align 4, !tbaa !5
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc35, %for.end26
  %18 = load i32, ptr %i27, align 4, !tbaa !5
...
for.cond.cleanup30:                               ; preds = %for.cond28
  call void @llvm.lifetime.end.p0(i64 4, ptr %i27) #9
  br label %for.end37

for.body31:                                       ; preds = %for.cond28
  %20 = load i32, ptr %maxtemp2, align 4, !tbaa !5
  %21 = load i32, ptr %i27, align 4, !tbaa !5
  ...
  %call34 = call noundef i32 @_Z3maxii(i32 noundef %20, i32 noundef %22)
  store i32 %call34, ptr %maxtemp2, align 4, !tbaa !5
  br label %for.inc35

for.inc35:                                        ; preds = %for.body31
  %23 = load i32, ptr %i27, align 4, !tbaa !5
  %inc36 = add nsw i32 %23, 1
  store i32 %inc36, ptr %i27, align 4, !tbaa !5
  br label %for.cond28, !llvm.loop !14

for.end37:                                        ; preds = %for.cond.cleanup30
  %24 = load i32, ptr %maxtemp, align 4, !tbaa !5
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %24)
  ...
  %25 = load i32, ptr %maxtemp2, align 4, !tbaa !5
  %call40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call39, i32 noundef %25)
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %maxtemp2) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %maxtemp) #9
  call void @llvm.lifetime.end.p0(i64 4000, ptr %a) #9
