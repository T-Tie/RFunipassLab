...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre61, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv37, i64 %indvars.iv
  %call6 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre61 = load i32, ptr %n, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc36
  %indvars.iv45 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next46, %for.inc36 ]
  ...
  br i1 %exitcond51.not, label %for.cond39.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc33
  %indvars.iv40 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next41, %for.inc33 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
...
land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %4, i64 %indvars.iv40
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  ...
  %arrayidx31 = getelementptr inbounds [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv45, i64 %8
  ...
  %spec.select33 = select i1 %cmp32.not, i32 %b1.1, i32 %10
  br label %for.inc33
...
for.inc33:                                        ; preds = %land.lhs.true26, %for.body15, %land.lhs.true
  ...
  %b1.2 = phi i32 [ %b1.1, %land.lhs.true ], [ %b1.1, %for.body15 ], [ %spec.select33, %land.lhs.true26 ]
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc67
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc67 ], [ %wide.trip.count, %for.cond39.preheader ]
...
for.cond42.preheader:                             ; preds = %for.cond39
  %12 = add nuw nsw i64 %indvars.iv57, 1
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc65
  %indvars.iv53 = phi i64 [ %wide.trip.count, %for.cond42.preheader ], [ %indvars.iv.next54, %for.inc65 ]
  %a2.1 = phi i32 [ %a2.0, %for.cond42.preheader ], [ %a2.2, %for.inc65 ]
  %b2.1 = phi i32 [ %b2.0, %for.cond42.preheader ], [ %b2.2, %for.inc65 ]
  %cmp43 = icmp sgt i64 %indvars.iv53, 0
  br i1 %cmp43, label %for.body44, label %for.inc67

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv57, i64 %indvars.iv53
...
land.lhs.true50:                                  ; preds = %for.body44
  %arrayidx54 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %12, i64 %indvars.iv53
...
land.lhs.true56:                                  ; preds = %land.lhs.true50
  %15 = add nuw nsw i64 %indvars.iv53, 1
  %arrayidx61 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv57, i64 %15
  %16 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !13
  %cmp62.not = icmp eq i32 %16, 0
  %spec.select34 = select i1 %cmp62.not, i32 %a2.1, i32 %11
  %17 = trunc nuw nsw i64 %indvars.iv53 to i32
  %spec.select35 = select i1 %cmp62.not, i32 %b2.1, i32 %17
  br label %for.inc65

for.inc65:                                        ; preds = %land.lhs.true56, %for.body44, %land.lhs.true50
  %a2.2 = phi i32 [ %a2.1, %land.lhs.true50 ], [ %a2.1, %for.body44 ], [ %spec.select34, %land.lhs.true56 ]
  %b2.2 = phi i32 [ %b2.1, %land.lhs.true50 ], [ %b2.1, %for.body44 ], [ %spec.select35, %land.lhs.true56 ]
