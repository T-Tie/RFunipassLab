...
for.body:                                         ; preds = %entry, %if.end
  ...
  br i1 %cmp13, label %for.end, label %if.end
...
for.end:                                          ; preds = %for.body, %if.end
  ...
  %cmp21.not30 = icmp eq i32 %2, 0
  br i1 %cmp21.not30, label %for.end65, label %while.cond.preheader

while.cond.preheader:                             ; preds = %for.end, %while.end
  %arrayidx20.promoted = phi i32 [ %10, %while.end ], [ %2, %for.end ]
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %while.end ], [ 0, %for.end ]
  %arrayidx2033 = phi ptr [ %arrayidx20, %while.end ], [ %a, %for.end ]
  %arrayidx34 = getelementptr inbounds nuw [100 x i32], ptr %c, i64 0, i64 %indvars.iv35
  %arrayidx26 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv35
  %3 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %arrayidx29 = getelementptr inbounds nuw [100 x i32], ptr %b, i64 0, i64 %indvars.iv35
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr %e, i64 0, i64 %indvars.iv35
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %f, i64 0, i64 %indvars.iv35
  br label %while.cond.outer

while.cond.outer:                                 ; preds = %if.then55, %while.cond.preheader
  %inc6029.ph = phi i32 [ %inc60, %if.then55 ], [ %arrayidx20.promoted, %while.cond.preheader ]
  %sum.1.ph = phi i32 [ %sum.2, %if.then55 ], [ 0, %while.cond.preheader ]
  %cmp27.not = icmp eq i32 %inc6029.ph, %3
  br label %while.cond
...
if.else:                                          ; preds = %while.body
  ...
  %.pre40 = load i32, ptr %arrayidx29, align 4, !tbaa !5
  br label %if.end51

if.end51:                                         ; preds = %if.else, %if.then41
  %9 = phi i32 [ %inc46, %if.then41 ], [ %.pre40, %if.else ]
...
if.then55:                                        ; preds = %if.end51
  ...
  %inc60 = add nsw i32 %inc6029.ph, 1
  store i32 %inc60, ptr %arrayidx2033, align 4, !tbaa !5
...
while.end:                                        ; preds = %lor.rhs
  ...
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next36
  %10 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %cmp21.not = icmp eq i32 %10, 0
  br i1 %cmp21.not, label %for.end65, label %while.cond.preheader, !llvm.loop !13

for.end65:                                        ; preds = %while.end, %for.end
