...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc8
  %indvars.iv30 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next31, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv30
  store i32 0, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond3, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond3, %for.inc22
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc22 ], [ 0, %for.cond3 ]
  %a.0 = phi i32 [ %a.1, %for.inc22 ], [ 0, %for.cond3 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond38.not, label %for.cond25.preheader, label %for.body13

for.cond25.preheader:                             ; preds = %for.cond11
  %smax49 = call i32 @llvm.smax.i32(i32 %5, i32 1)
  br label %for.cond25

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv34
...
if.end:                                           ; preds = %for.body13
  ...
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv34
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc51
  %indvars.iv43.in = phi i32 [ %5, %for.cond25.preheader ], [ %indvars.iv43, %for.inc51 ]
  %k.0 = phi i32 [ 1, %for.cond25.preheader ], [ %inc52, %for.inc51 ]
  %indvars.iv43 = add i32 %indvars.iv43.in, -1
  %exitcond50.not = icmp eq i32 %k.0, %smax49
  br i1 %exitcond50.not, label %for.end53, label %for.cond28.preheader

for.cond28.preheader:                             ; preds = %for.cond25
  %smax45 = call i32 @llvm.smax.i32(i32 %indvars.iv43, i32 0)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc48
  %indvars.iv39 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next40, %for.inc48 ]
  %exitcond47.not = icmp eq i64 %indvars.iv39, %wide.trip.count46
  br i1 %exitcond47.not, label %for.inc51, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv39
  %9 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !13
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv.next40
...
for.cond55:                                       ; preds = %for.inc62, %for.end53
  %12 = phi i32 [ %.pre54, %for.inc62 ], [ %5, %for.end53 ]
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc62 ], [ %11, %for.end53 ]
  %sub56 = add nsw i32 %12, -1
  %13 = sext i32 %sub56 to i64
  %cmp57 = icmp slt i64 %indvars.iv51, %13
  br i1 %cmp57, label %for.inc62, label %for.end64

for.inc62:                                        ; preds = %for.cond55
  %arrayidx60 = getelementptr inbounds i32, ptr %vla1, i64 %indvars.iv51
