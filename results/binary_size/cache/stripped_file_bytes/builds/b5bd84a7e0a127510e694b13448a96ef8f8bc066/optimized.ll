...
for.cond11:                                       ; preds = %for.inc25, %for.end9
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc25 ], [ 0, %for.end9 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp12 = icmp slt i64 %indvars.iv9, %5
  br i1 %cmp12, label %for.cond14, label %for.cond58

for.cond14:                                       ; preds = %for.cond11, %for.inc22
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc22 ], [ 0, %for.cond11 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp15 = icmp slt i64 %indvars.iv6, %7
  br i1 %cmp15, label %for.inc22, label %for.inc25

for.inc22:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv9, i64 %indvars.iv6
...
for.body63:                                       ; preds = %for.cond61
  ...
  %putchar1 = call i32 @putchar(i32 noundef %.) #5
