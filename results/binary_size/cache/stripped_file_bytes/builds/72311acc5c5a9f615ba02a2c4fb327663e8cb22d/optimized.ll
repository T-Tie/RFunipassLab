...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv5
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
  %arrayidx3 = getelementptr inbounds nuw [25 x i32], ptr %s, i64 0, i64 %indvars.iv5
  br label %for.cond4
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body24
  %indvars.iv8 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next9, %for.body24 ]
  %max.2 = phi i32 [ 0, %for.cond22.preheader ], [ %spec.select3, %for.body24 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond12.not, label %for.end34, label %for.body24

for.body24:                                       ; preds = %for.cond22
  %arrayidx26 = getelementptr inbounds nuw [25 x i32], ptr %s, i64 0, i64 %indvars.iv8
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %spec.select3 = call i32 @llvm.smax.i32(i32 %max.2, i32 %5)
