...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv19 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next20, %for.inc23 ]
  %sum.0 = phi i32 [ 0, %for.cond.preheader ], [ %sum.1, %for.inc23 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %cleanup.cont, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond
  %arrayidx15 = getelementptr inbounds nuw [20 x i32], ptr %a, i64 0, i64 %indvars.iv19
  %1 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
  %mul = shl nsw i32 %1, 1
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.body13
  %indvars.iv14 = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next15, %for.body13 ]
  %sum.1 = phi i32 [ %sum.0, %for.cond9.preheader ], [ %spec.select, %for.body13 ]
  %exitcond.not = icmp eq i64 %indvars.iv14, %wide.trip.count23
  br i1 %exitcond.not, label %for.inc23, label %for.body13

for.body13:                                       ; preds = %for.cond9
  %arrayidx17 = getelementptr inbounds nuw [20 x i32], ptr %a, i64 0, i64 %indvars.iv14
