...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %y) #7
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %m1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %m2) #7
...
for.cond6:                                        ; preds = %for.cond, %for.body9
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body9 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp7 = icmp slt i64 %indvars.iv17, %3
  br i1 %cmp7, label %for.body9, label %for.end25

for.body9:                                        ; preds = %for.cond6
  %arrayidx11 = getelementptr inbounds nuw [200 x i32], ptr %y, i64 0, i64 %indvars.iv17
  %4 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !9
  %arrayidx13 = getelementptr inbounds nuw [200 x i32], ptr %m1, i64 0, i64 %indvars.iv17
  %5 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !9
  %call14 = call noundef i32 @_Z8dijitianiii(i32 noundef %4, i32 noundef %5, i32 noundef 1) #8
  %arrayidx18 = getelementptr inbounds nuw [200 x i32], ptr %m2, i64 0, i64 %indvars.iv17
  %6 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %call19 = call noundef i32 @_Z8dijitianiii(i32 noundef %4, i32 noundef %6, i32 noundef 1) #8
  %sub = sub nsw i32 %call14, %call19
  %rem = srem i32 %sub, 7
  %cmp20 = icmp eq i32 %rem, 0
  %str.2.str = select i1 %cmp20, ptr @str.2, ptr @str
...
for.end25:                                        ; preds = %for.cond6
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %m2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %m1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %y) #8
  ret i32 0
}
...
entry:
  ...
  %or.cond20 = or i1 %cmp28, %or.cond
  %.sink1 = select i1 %or.cond20, i32 29, i32 28
  %smax = call i32 @llvm.smax.i32(i32 %m, i32 0)
  br label %for.cond

for.cond:                                         ; preds = %if.end35, %entry
  %d.0 = phi i32 [ 0, %entry ], [ %d.1, %if.end35 ]
  %k.0 = phi i32 [ 0, %entry ], [ %inc.i, %if.end35 ]
  %exitcond.not = icmp eq i32 %k.0, %smax
  br i1 %exitcond.not, label %for.end, label %for.body

for.body:                                         ; preds = %for.cond
  switch i32 %k.0, label %if.end35 [
    i32 1, label %if.then
    i32 3, label %if.then
    i32 5, label %if.then
    i32 7, label %if.then
...
if.then:                                          ; preds = %for.body, %for.body, %for.body, %for.body, %for.body, %for.body
  %add = add nsw i32 %d.0, 31
  br label %if.end35

if.then18:                                        ; preds = %for.body, %for.body, %for.body, %for.body
  %add19 = add nsw i32 %d.0, 30
  br label %if.end35

if.then22:                                        ; preds = %for.body
  %add32 = add nsw i32 %d.0, %.sink1
  br label %if.end35

if.end35:                                         ; preds = %for.body, %if.then18, %if.then22, %if.then
  %d.1 = phi i32 [ %add, %if.then ], [ %add19, %if.then18 ], [ %add32, %if.then22 ], [ %d.0, %for.body ]
