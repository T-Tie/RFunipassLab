...
entry:
  ...
  %cmp19 = icmp sgt i32 %conv10, 1
  br label %for.cond

for.cond:                                         ; preds = %if.end34, %entry
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %if.end34 ], [ 0, %entry ]
  %n.0 = phi i32 [ %n.1, %if.end34 ], [ 0, %entry ]
  br i1 %cmp, label %for.body, label %for.cond49.preheader

for.body:                                         ; preds = %for.cond
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %s, i64 0, i64 %indvars.iv29
  %1 = load i8, ptr %arrayidx15, align 1, !tbaa !5, !invariant.load !8
  %cmp17 = icmp eq i8 %0, %1
  br i1 %cmp17, label %for.cond18, label %if.end31

for.cond18:                                       ; preds = %for.body, %for.body20
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body20 ], [ 1, %for.body ]
  %n.2.in = phi i32 [ %n.2, %for.body20 ], [ %n.0, %for.body ]
  %n.2 = add nsw i32 %n.2.in, 1
  br i1 %cmp19, label %for.body20, label %if.end31

for.body20:                                       ; preds = %for.cond18
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv29
  %arrayidx22 = getelementptr inbounds nuw [1000 x i8], ptr %s, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx22, align 1, !tbaa !5, !invariant.load !8
  %arrayidx25 = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv
  %4 = load i8, ptr %arrayidx25, align 1, !tbaa !5, !invariant.load !8
  %cmp27 = icmp eq i8 %3, %4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %cmp27, label %for.cond18, label %if.end31

if.end31:                                         ; preds = %for.body20, %for.cond18, %for.body
  %n.1 = phi i32 [ %n.0, %for.body ], [ %n.2, %for.cond18 ], [ 0, %for.body20 ]
  %cmp32 = icmp eq i32 %n.1, %conv10
  br i1 %cmp32, label %for.end37, label %if.end34

if.end34:                                         ; preds = %if.end31
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  br label %for.cond

for.end37:                                        ; preds = %if.end31
  %cmp39.not = icmp eq i64 %indvars.iv29, 0
  %5 = load i8, ptr %s, align 16
  %conv43 = sext i8 %5 to i32
  br i1 %cmp39.not, label %for.cond49.preheader, label %for.cond38

for.cond38:                                       ; preds = %for.end37, %for.cond38
  %putchar25 = call i32 @putchar(i32 %conv43)
  %call45.i = call i32 @getchar(), !noalias !9
  br label %for.cond38

for.cond49.preheader:                             ; preds = %for.cond, %for.end37
  %cmp50.not = icmp eq i32 %conv, 0
  %6 = load i8, ptr %b, align 16
  %conv55 = sext i8 %6 to i32
  br i1 %cmp50.not, label %for.end75.split, label %for.cond49.preheader26

for.cond49.preheader26:                           ; preds = %for.cond49.preheader
  %smax = call i32 @llvm.smax.i32(i32 %conv13, i32 0)
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader26, %for.body52
  %k.2 = phi i32 [ %inc30.i.i4, %for.body52 ], [ 0, %for.cond49.preheader26 ]
  %exitcond.not = icmp eq i32 %k.2, %smax
  br i1 %exitcond.not, label %for.cond62.preheader, label %for.body52

for.cond62.preheader:                             ; preds = %for.cond49
  %sext = shl i64 %call9, 32
  %7 = ashr exact i64 %sext, 32
  %smax35 = call i32 @llvm.smax.i32(i32 %conv10, i32 %conv)
  %wide.trip.count = sext i32 %smax35 to i64
  br label %for.cond62

for.body52:                                       ; preds = %for.cond49
  %putchar24 = call i32 @putchar(i32 %conv55)
  %call45.i3 = call i32 @getchar(), !noalias !12
  %inc30.i.i4 = add nuw i32 %k.2, 1
  br label %for.cond49

for.cond62:                                       ; preds = %for.cond62.preheader, %for.body67
  %indvars.iv32 = phi i64 [ %7, %for.cond62.preheader ], [ %indvars.iv.next33, %for.body67 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36.not, label %for.end75.split, label %for.body67

for.body67:                                       ; preds = %for.cond62
  %arrayidx69 = getelementptr inbounds [1000 x i8], ptr %s, i64 0, i64 %indvars.iv32
  %8 = load i8, ptr %arrayidx69, align 1, !tbaa !5, !invariant.load !8
  %conv70 = sext i8 %8 to i32
  %putchar = call i32 @putchar(i32 %conv70)
  %call45.i5 = call i32 @getchar(), !noalias !15
...
!12 = !{!13}
!13 = distinct !{!13, !14, !"outlined_ir_func_0: argument 0"}
!14 = distinct !{!14, !"outlined_ir_func_0"}
!15 = !{!16}
