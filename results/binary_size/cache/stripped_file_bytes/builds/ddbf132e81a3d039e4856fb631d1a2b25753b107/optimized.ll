...
define dso_local void @_Z4zeroPA100_ii(ptr nofree noundef readnone captures(none) %a, i32 noundef %n) local_unnamed_addr #0 {
for.cond:
  %cmp = icmp slt i32 %n, 1
  tail call void @llvm.assume(i1 noundef %cmp) #8
  ret void
}
...
define dso_local void @_Z10subductionPA100_ii(ptr nofree noundef captures(none) %a, i32 noundef %n) local_unnamed_addr #2 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  br label %for.cond

for.cond:                                         ; preds = %while.cond.preheader, %entry
...
while.cond.preheader:                             ; preds = %for.cond1
  %2 = icmp eq i32 %0, 1
  call void @llvm.assume(i1 noundef %2)
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
...
for.end23:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %a) #10
