...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv6
  ...
  %5 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv6
  store i32 %spec.select, ptr %5, align 4, !tbaa !5
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %for.cond2, !llvm.loop !13

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc49
  %indvars.iv14.in = phi i32 [ %0, %for.cond23.preheader ], [ %indvars.iv14, %for.inc49 ]
  %a.0 = phi i32 [ 1, %for.cond23.preheader ], [ %inc50, %for.inc49 ]
  %indvars.iv14 = add i32 %indvars.iv14.in, -1
  %exitcond19 = icmp eq i32 %a.0, %2
  br i1 %exitcond19, label %for.cond52, label %for.cond26.preheader

for.cond26.preheader:                             ; preds = %for.cond23
  %smax16 = call i32 @llvm.smax.i32(i32 %indvars.iv14, i32 0)
  %wide.trip.count17 = zext nneg i32 %smax16 to i64
  br label %for.cond26

for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc46
  %indvars.iv10 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next11, %for.inc46 ]
  %exitcond18.not = icmp eq i64 %indvars.iv10, %wide.trip.count17
  br i1 %exitcond18.not, label %for.inc49, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv10
  %6 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv.next11
...
for.cond52:                                       ; preds = %for.cond23, %for.inc64
  %.pre23 = phi i32 [ %.pre, %for.inc64 ], [ %0, %for.cond23 ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc64 ], [ 0, %for.cond23 ]
  %sub53 = add nsw i32 %.pre23, -1
  %8 = sext i32 %sub53 to i64
  %cmp54 = icmp slt i64 %indvars.iv20, %8
  br i1 %cmp54, label %for.body55, label %for.end66

for.body55:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv20
...
for.inc64:                                        ; preds = %for.body55, %if.then59
  %.pre = phi i32 [ %.pre23, %for.body55 ], [ %.pre.pre, %if.then59 ]
