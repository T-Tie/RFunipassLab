...
for.cond11.preheader:                             ; preds = %for.cond
  %cmp12 = icmp slt i32 %k.0, 2
  call void @llvm.assume(i1 noundef %cmp12)
  %4 = load i32, ptr %vla1, align 16, !tbaa !5
  %call41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %4)
