...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  br i1 %cmp, label %for.cond1.preheader, label %for.cond13
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre15, %for.inc ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %3 = sext i32 %2 to i64
  %cmp2 = icmp slt i64 %indvars.iv, %3
  br i1 %cmp2, label %for.inc, label %for.cond, !llvm.loop !9

for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv.next6, i64 %indvars.iv
...
for.inc29:                                        ; preds = %for.cond17
  ...
  %8 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !12
