...
for.cond:                                         ; preds = %for.body, %entry
  %n.promoted8 = phi i32 [ %n.promoted, %entry ], [ %sub, %for.body ]
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body5
  %n.promoted10 = phi i32 [ %sub3, %for.body5 ], [ %n.promoted8, %for.cond2.preheader ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.body13
  %n.promoted12 = phi i32 [ %sub11, %for.body13 ], [ %n.promoted10, %for.cond10.preheader ]
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body21
  %n.promoted14 = phi i32 [ %sub19, %for.body21 ], [ %n.promoted12, %for.cond18.preheader ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.body29
  %n.promoted16 = phi i32 [ %sub27, %for.body29 ], [ %n.promoted14, %for.cond26.preheader ]
...
for.cond34.preheader:                             ; preds = %for.cond26
  %smin = call i32 @llvm.smin.i32(i32 %n.promoted16, i32 noundef 0)
  %0 = add nsw i32 %n.promoted16, 1
  %smin.neg = sub i32 0, %smin
  %1 = add i32 %0, %smin.neg
  br label %for.cond34
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.body37
  %sub3517 = phi i32 [ %sub35, %for.body37 ], [ %n.promoted16, %for.cond34.preheader ]
