...
land.lhs.true.i21:                                ; preds = %if.then6.i15
  %_M_width.i10.i22 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i10.i22, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
...
land.lhs.true.i48:                                ; preds = %if.then6.i42
  %_M_width.i10.i49 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i10.i49, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
