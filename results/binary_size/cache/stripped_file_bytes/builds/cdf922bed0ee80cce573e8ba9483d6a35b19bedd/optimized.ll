...
if.end24:                                         ; preds = %if.then20, %for.body18
  %.pre13 = phi i32 [ %.pre12, %if.then20 ], [ 1, %for.body18 ]
  %sub25 = add nsw i32 %.pre13, -1
...
if.end31:                                         ; preds = %if.then27, %if.end24
  %.pre = phi i32 [ %.pre.pre, %if.then27 ], [ %.pre13, %if.end24 ]
