...
for.cond11:                                       ; preds = %for.inc18, %for.end
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc18 ], [ 0, %for.end ]
...
for.inc18:                                        ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw i32, ptr %call7, i64 %indvars.iv52
  store i32 0, ptr %arrayidx15, align 4, !tbaa !5
  %arrayidx17 = getelementptr inbounds nuw i32, ptr %call10, i64 %indvars.iv52
...
for.cond21:                                       ; preds = %for.cond11, %for.inc50
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc50 ], [ 0, %for.cond11 ]
  %7 = sext i32 %6 to i64
  %cmp22 = icmp slt i64 %indvars.iv58, %7
  br i1 %cmp22, label %for.cond24.preheader, label %for.cond53.preheader

for.cond24.preheader:                             ; preds = %for.cond21
  %arrayidx28 = getelementptr inbounds nuw ptr, ptr %call1, i64 %indvars.iv58
  %arrayidx33 = getelementptr inbounds nuw i32, ptr %call7, i64 %indvars.iv58
  %arrayidx46 = getelementptr inbounds nuw i32, ptr %call10, i64 %indvars.iv58
  br label %for.cond24

for.cond53.preheader:                             ; preds = %for.cond21
  %smax71 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond24:                                       ; preds = %for.cond24.preheader, %for.inc47
  %indvars.iv55 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next56, %for.inc47 ]
  %8 = load i32, ptr %l, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp25 = icmp slt i64 %indvars.iv55, %9
  br i1 %cmp25, label %for.body26, label %for.inc50

for.body26:                                       ; preds = %for.cond24
  %10 = load ptr, ptr %arrayidx28, align 8, !tbaa !9, !invariant.load !16
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %10, i64 %indvars.iv55
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc78
  %indvars.iv67 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next68, %for.inc78 ]
  %exitcond73.not = icmp eq i64 %indvars.iv67, %wide.trip.count72
  br i1 %exitcond73.not, label %if.else, label %for.cond56.preheader

for.cond56.preheader:                             ; preds = %for.cond53
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %call7, i64 %indvars.iv67
  %arrayidx64 = getelementptr inbounds nuw i32, ptr %call10, i64 %indvars.iv67
  br label %for.cond56

for.cond56:                                       ; preds = %for.body58, %for.cond56.preheader
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.body58 ], [ 0, %for.cond56.preheader ]
  %exitcond66.not = icmp eq i64 %indvars.iv61, %wide.trip.count65
  br i1 %exitcond66.not, label %if.then83, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %14 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !16
  %arrayidx62 = getelementptr inbounds nuw ptr, ptr %call1, i64 %indvars.iv61
...
if.then83:                                        ; preds = %for.cond56
  %18 = trunc nuw nsw i64 %indvars.iv67 to i32
  %idxprom75 = and i64 %indvars.iv67, 4294967295
