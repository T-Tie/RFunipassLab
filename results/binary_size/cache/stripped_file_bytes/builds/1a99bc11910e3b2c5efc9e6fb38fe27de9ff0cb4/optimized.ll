...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %or.cond15 = select i1 %or.cond, i1 %cmp3, i1 false
  %3 = load i32, ptr %d, align 4
  %cmp5 = icmp eq i32 %3, 0
  %or.cond16 = select i1 %or.cond15, i1 %cmp5, i1 false
  %4 = load i32, ptr %e, align 4
  %cmp7 = icmp eq i32 %4, 0
  %or.cond17 = select i1 %or.cond16, i1 %cmp7, i1 false
  %.pre = load i32, ptr %f, align 4, !tbaa !5
  %cmp9 = icmp eq i32 %.pre, 0
  %or.cond21 = select i1 %or.cond17, i1 %cmp9, i1 false
  br i1 %or.cond21, label %for.end, label %for.inc
...
for.inc:                                          ; preds = %for.cond
  ...
  %reass.sub24 = sub i32 %5, %2
  %add24 = add i32 %reass.sub24, 43200
