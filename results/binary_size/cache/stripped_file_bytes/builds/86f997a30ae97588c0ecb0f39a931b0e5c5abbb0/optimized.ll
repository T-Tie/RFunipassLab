...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %h1) #4
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %h2) #4
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %m1) #4
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %m2) #4
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %s1) #4
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %s2) #4
  br label %while.cond

while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv33 = phi i32 [ %indvars.iv.next34, %while.cond ], [ 0, %entry ]
...
for.cond.preheader:                               ; preds = %while.cond
  %cmp2727.not = icmp eq i64 %indvars.iv, 0
  br i1 %cmp2727.not, label %for.end, label %for.body.preheader
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx29 = getelementptr inbounds nuw [100 x i32], ptr %h2, i64 0, i64 %indvars.iv30
  %6 = load i32, ptr %arrayidx29, align 4, !tbaa !5
  %add30 = add nsw i32 %6, 12
  store i32 %add30, ptr %arrayidx29, align 4, !tbaa !5
  %arrayidx34 = getelementptr inbounds nuw [100 x i32], ptr %h1, i64 0, i64 %indvars.iv30
  %7 = load i32, ptr %arrayidx34, align 4, !tbaa !5
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %m1, i64 0, i64 %indvars.iv30
  %8 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  %arrayidx40 = getelementptr inbounds nuw [100 x i32], ptr %s1, i64 0, i64 %indvars.iv30
  %9 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [100 x i32], ptr %m2, i64 0, i64 %indvars.iv30
  %10 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %arrayidx50 = getelementptr inbounds nuw [100 x i32], ptr %s2, i64 0, i64 %indvars.iv30
...
for.end:                                          ; preds = %for.body, %for.cond.preheader
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %s2) #4
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %s1) #4
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %m2) #4
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %m1) #4
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %h2) #4
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %h1) #4
  ret i32 0
}
