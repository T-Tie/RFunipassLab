...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv22 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next23, %for.body3 ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv22
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv30.in = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv30, %for.body15 ]
  %indvars.iv27 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next28, %for.body15 ]
  %cmp14 = icmp sgt i64 %indvars.iv27, 0
  br i1 %cmp14, label %for.body15, label %for.end33

for.body15:                                       ; preds = %for.cond13
  %indvars.iv30 = add nsw i64 %indvars.iv30.in, -1
  %indvars.iv.next28 = add nsw i64 %indvars.iv27, -1
  %arrayidx17 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next28
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv33 = phi i64 [ %indvars.iv30, %for.cond22.preheader ], [ %indvars.iv.next34, %for.inc28 ]
  %cmp23.not.not = icmp slt i64 %indvars.iv33, %6
  br i1 %cmp23.not.not, label %for.inc28, label %for.end33.loopexit

for.inc28:                                        ; preds = %for.cond22
  %indvars.iv.next34 = add nsw i64 %indvars.iv33, 1
  %arrayidx26 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next34
...
for.end33.loopexit:                               ; preds = %for.cond22
  ...
  %.pre54 = and i64 %indvars.iv.next28, 4294967295
  br label %for.end33

for.end33:                                        ; preds = %for.cond13, %for.end33.loopexit
  %.pre-phi = phi i64 [ %.pre54, %for.end33.loopexit ], [ %4, %for.cond13 ]
...
for.cond35:                                       ; preds = %for.inc55, %for.end33
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc55 ], [ %.pre-phi, %for.end33 ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc55 ], [ %10, %for.end33 ]
...
for.body37:                                       ; preds = %for.cond35
  %idxprom38 = and i64 %indvars.iv.next42, 4294967295
...
for.cond45:                                       ; preds = %for.inc51, %if.then42
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc51 ], [ %indvars.iv36, %if.then42 ]
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, 1
  %cmp46 = icmp slt i64 %indvars.iv.next39, %13
  br i1 %cmp46, label %for.inc51, label %for.inc55

for.inc51:                                        ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next39
...
for.cond74:                                       ; preds = %for.end10, %for.inc80
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc80 ], [ 0, %for.end10 ]
  %exitcond53 = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond53, label %if.end83, label %for.inc80

for.inc80:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv48
