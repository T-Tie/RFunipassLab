...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.end26 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %y1, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv40, %5
  br i1 %cmp14, label %for.cond16, label %for.cond68

for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body18 ], [ 0, %for.cond13 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17 = icmp slt i64 %indvars.iv37, %7
