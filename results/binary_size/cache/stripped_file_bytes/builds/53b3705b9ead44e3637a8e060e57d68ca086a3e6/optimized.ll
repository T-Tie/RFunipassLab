...
for.cond8:                                        ; preds = %for.cond, %for.body11
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body11 ], [ 0, %for.cond ]
  %e.0 = phi i32 [ %e.1, %for.body11 ], [ undef, %for.cond ]
  %f.0 = phi i32 [ %f.1, %for.body11 ], [ 0, %for.cond ]
...
for.end23:                                        ; preds = %for.cond8
  ...
  %reass.sub17 = sub i32 %div24, %div
  %add28 = add i32 %reass.sub17, 1
