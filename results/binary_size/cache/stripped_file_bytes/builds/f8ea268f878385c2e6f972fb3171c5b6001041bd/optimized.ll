...
for.cond46.preheader:                             ; preds = %for.cond10
  ...
  %smax24 = call i32 @llvm.smax.i32(i32 %sub47, i32 0)
...
for.end26:                                        ; preds = %for.cond13
  ...
  %14 = trunc nuw nsw i64 %indvars.iv16 to i32
  %15 = xor i32 %14, -1
  %sub41 = add i32 %j.0, %15
  %max.3 = select i1 %cmp38, i32 %sub41, i32 %max.1
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond10, !llvm.loop !14

for.cond46:                                       ; preds = %for.cond46.preheader, %for.body49
  %indvars.iv21 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next22, %for.body49 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end55, label %for.body49

for.body49:                                       ; preds = %for.cond46
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv21
  %16 = load i32, ptr %arrayidx51, align 4, !tbaa !5
  %call52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %16) #6
...
if.then58:                                        ; preds = %for.end55
  ...
  %call61 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %17) #6
  br label %if.end62
