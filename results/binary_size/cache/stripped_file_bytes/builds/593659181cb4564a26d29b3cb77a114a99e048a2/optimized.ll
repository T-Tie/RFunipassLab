...
for.cond14:                                       ; preds = %for.end27, %for.end10
  ...
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.end27 ], [ 0, %for.end10 ]
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc25
  %18 = phi i32 [ %15, %for.cond17.preheader ], [ %.pre33, %for.inc25 ]
  %indvars.iv20 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next21, %for.inc25 ]
  %19 = sext i32 %18 to i64
  %cmp18 = icmp slt i64 %indvars.iv20, %19
  br i1 %cmp18, label %for.inc25, label %for.end27

for.inc25:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv20
...
for.cond34:                                       ; preds = %for.cond31, %for.inc69
  %22 = phi i32 [ %.pre32, %for.inc69 ], [ %20, %for.cond31 ]
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc69 ], [ 0, %for.cond31 ]
  %23 = sext i32 %22 to i64
  %cmp35 = icmp slt i64 %indvars.iv26, %23
...
for.cond37.preheader:                             ; preds = %for.cond34
  ...
  %cmp55 = icmp slt i64 %indvars.iv26, %25
