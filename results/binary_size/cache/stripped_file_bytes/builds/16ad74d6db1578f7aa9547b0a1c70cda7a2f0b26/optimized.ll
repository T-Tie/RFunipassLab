...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  br i1 %cmp, label %for.cond, label %for.end25

for.end25:                                        ; preds = %for.cond
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef poison)
...
if.end:                                           ; preds = %while.body
  ...
  %div.i13 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i13
...
while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div89, %if.end ], [ %dec, %while.body ]
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %cmp.i8 = icmp sgt i64 %__holeIndex.addr.0.i, %__holeIndex
  br i1 %cmp.i8, label %land.end.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit
