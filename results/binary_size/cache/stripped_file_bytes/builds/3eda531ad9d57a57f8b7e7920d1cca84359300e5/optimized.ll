...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %mona) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %monb) #6
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %k.0 = phi i32 [ 1, %entry ], [ %inc28, %for.end ]
...
for.inc.gvnsink.split:                            ; preds = %for.body12, %for.body12, %for.body12, %for.body12, %for.body12, %for.body12, %for.body12, %sw.bb13, %sw.bb15
  %add16.sink = phi i32 [ %conv, %sw.bb15 ], [ 30, %sw.bb13 ], [ 31, %for.body12 ], [ 31, %for.body12 ], [ 31, %for.body12 ], [ 31, %for.body12 ], [ 31, %for.body12 ], [ 31, %for.body12 ], [ 31, %for.body12 ]
  %add17 = add nsw i32 %add16.sink, %days.0
  br label %for.inc

for.inc:                                          ; preds = %for.inc.gvnsink.split, %for.body12
  %days.1 = phi i32 [ %days.0, %for.body12 ], [ %add17, %for.inc.gvnsink.split ]
  %inc = add i32 %mon.0, 1
...
for.end:                                          ; preds = %for.cond10
  ...
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.1)
