...
entry:
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count18 = zext nneg i32 %smax17 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv28 = phi i32 [ %indvars.iv.next29, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv23 = phi i32 [ %indvars.iv.next24, %for.inc29 ], [ 0, %entry ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc29 ], [ 0, %entry ]
  %g.0 = phi i32 [ %g.1, %for.inc29 ], [ undef, %entry ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv14
...
for.cond33.preheader:                             ; preds = %for.end
  %wide.trip.count26 = zext i32 %indvars.iv23 to i64
  br label %for.cond33
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv20 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next21, %for.inc40 ]
  %exitcond27.not = icmp eq i64 %indvars.iv20, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv20
  %5 = load i8, ptr %arrayidx37, align 1, !tbaa !5
  %conv38 = sext i8 %5 to i32
  %putchar9 = call i32 @putchar(i32 noundef %conv38) #7
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv28 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc53 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv31, %7
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv31
