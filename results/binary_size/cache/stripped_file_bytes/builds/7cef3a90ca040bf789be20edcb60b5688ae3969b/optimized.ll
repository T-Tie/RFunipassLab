...
for.end29:
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %x1, ptr noundef nonnull align 4 dereferenceable(4) %y1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr noundef nonnull align 4 dereferenceable(4) %num)
  call void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %x2, ptr noundef nonnull align 4 dereferenceable(4) %y2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr noundef nonnull align 4 dereferenceable(4) %num)
...
for.cond30:                                       ; preds = %for.cond33.preheader, %for.end29
  ...
  %exitcond.not = icmp eq i32 %storemerge, %smax14
...
for.cond64:                                       ; preds = %for.cond30, %for.end85
  ...
  %storemerge8 = phi i32 [ %inc87, %for.end85 ], [ 0, %for.cond30 ]
  %cmp65 = icmp slt i32 %storemerge8, %3
  br i1 %cmp65, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond64, %if.end
  %4 = phi i32 [ %.pre15, %if.end ], [ %2, %for.cond64 ]
  %storemerge9 = phi i32 [ %inc84, %if.end ], [ 0, %for.cond64 ]
  %cmp68 = icmp slt i32 %storemerge9, %4
  br i1 %cmp68, label %for.body69, label %for.end85

for.body69:                                       ; preds = %for.cond67
  %sub = add nsw i32 %4, -1
  %cmp70 = icmp slt i32 %storemerge9, %sub
...
if.end:                                           ; preds = %if.else, %if.then
  %inc84 = add nuw nsw i32 %storemerge9, 1
  %.pre15 = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.cond67, !llvm.loop !12

for.end85:                                        ; preds = %for.cond67
  %inc87 = add nuw nsw i32 %storemerge8, 1
...
define internal void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) initializes((0, 4)) %2, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %3, ptr noundef nonnull align 4 dereferenceable(4) %4) #5 {
entry_to_outline:
