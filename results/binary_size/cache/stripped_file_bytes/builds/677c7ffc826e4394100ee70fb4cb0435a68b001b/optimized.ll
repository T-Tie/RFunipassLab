...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %t) #11
  store i32 0, ptr %t, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 80, ptr %a) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr %j) #11
  %arraydecay = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  ...
  %arraydecay2 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  %call3 = call i64 @strlen(ptr noundef %arraydecay2) #12
  %add = add i64 %call3, 1
  %conv = trunc i64 %add to i32
  store i32 %conv, ptr %t, align 4, !tbaa !5
  %arraydecay4 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  %call5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay4)
...
for.body:                                         ; preds = %for.cond
  %arraydecay6 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  %call7 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %arraydecay6)
  %2 = load i32, ptr %t, align 4, !tbaa !5
  %conv8 = sext i32 %2 to i64
  %arraydecay9 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  %call10 = call i64 @strlen(ptr noundef %arraydecay9) #12
  %add11 = add i64 %conv8, %call10
  %cmp12 = icmp ule i64 %add11, 80
  br i1 %cmp12, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  %arraydecay14 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  ...
  %arraydecay17 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  ...
  store i32 %conv21, ptr %t, align 4, !tbaa !5
  br label %if.end
...
if.else:                                          ; preds = %for.body
  ...
  %arraydecay23 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call22, ptr noundef %arraydecay23)
  %arraydecay25 = getelementptr inbounds [80 x i8], ptr %a, i64 0, i64 0
  %call26 = call i64 @strlen(ptr noundef %arraydecay25) #12
  %add27 = add i64 %call26, 1
  %conv28 = trunc i64 %add27 to i32
  store i32 %conv28, ptr %t, align 4, !tbaa !5
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 80, ptr %a) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %t) #11
