...
for.cond:                                         ; preds = %for.inc25, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc25 ], [ 0, %entry ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond28.preheader, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv3 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next4, %for.inc22 ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond7.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv3
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv23 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next24, %for.inc63 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count11
  br i1 %exitcond27.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body33 ], [ 0, %for.cond28 ]
  %min.4 = phi i32 [ %spec.select1, %for.body33 ], [ 10000, %for.cond28 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv13, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select1 = tail call i32 @llvm.smin.i32(i32 %min.4, i32 %2)
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv18 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next19, %for.inc60 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count16
  br i1 %exitcond22.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv18, i64 %indvars.iv23
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond1, %for.inc66
  ...
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %for.inc66 ], [ -1, %for.cond1 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %7 = add nsw i32 %6, %indvars.iv9
  %8 = sext i32 %sub17 to i64
  %wide.trip.count = zext i32 %7 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond20, %for.body15
  %indvars.iv11 = phi i64 [ 1, %for.body15 ], [ %indvars.iv.next12, %for.cond20 ]
  %cmp18 = icmp slt i64 %indvars.iv11, %8
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv6 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next7, %for.inc34 ]
...
for.inc34:                                        ; preds = %for.cond20
  ...
  %arrayidx29 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv.next12, i64 %indvars.iv.next7
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !9
  %arrayidx33 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv6
  store i32 %9, ptr %arrayidx33, align 4, !tbaa !5
  br label %for.cond20, !llvm.loop !21

for.cond40:                                       ; preds = %for.cond16, %for.inc49
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc49 ], [ 1, %for.cond16 ]
  %cmp42 = icmp slt i64 %indvars.iv14, %8
  br i1 %cmp42, label %for.inc49, label %for.cond52

for.inc49:                                        ; preds = %for.cond40
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr @a, i64 0, i64 %indvars.iv.next15
  %10 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !9
  %arrayidx48 = getelementptr inbounds nuw [1000 x i32], ptr @a, i64 0, i64 %indvars.iv14
  store i32 %10, ptr %arrayidx48, align 4, !tbaa !5
  br label %for.cond40, !llvm.loop !22

for.cond52:                                       ; preds = %for.cond40, %for.inc63
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc63 ], [ 1, %for.cond40 ]
  %cmp54 = icmp slt i64 %indvars.iv17, %8
  br i1 %cmp54, label %for.inc63, label %for.inc66

for.inc63:                                        ; preds = %for.cond52
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %arrayidx58 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv.next18
  %11 = load i32, ptr %arrayidx58, align 16, !tbaa !5, !invariant.load !9
  %arrayidx61 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv17
