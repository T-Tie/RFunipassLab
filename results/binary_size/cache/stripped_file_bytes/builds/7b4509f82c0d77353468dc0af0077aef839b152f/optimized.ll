...
for.cond:                                         ; preds = %for.cond.cleanup10, %entry
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.cond.cleanup10 ], [ %1, %entry ]
  %cmp.i.not = icmp sgt i64 %indvars.iv59, %2
  br i1 %cmp.i.not, label %for.cond29, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %add.ptr13 = getelementptr inbounds [200 x i32], ptr @a, i64 %indvars.iv59
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond1.preheader, %for.body11
  %indvars.iv = phi i64 [ %1, %for.cond1.preheader ], [ %indvars.iv.next, %for.body11 ]
  %cmp.i.i.i.not = icmp sgt i64 %indvars.iv, %2
  br i1 %cmp.i.i.i.not, label %for.cond.cleanup10, label %for.body11
...
for.cond29:                                       ; preds = %for.cond, %for.cond.cleanup50
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.cond.cleanup50 ], [ %1, %for.cond ]
  %cmp.i.i.i20.not = icmp sgt i64 %indvars.iv68, %2
  br i1 %cmp.i.i.i20.not, label %for.end68, label %for.cond34.preheader

for.cond34.preheader:                             ; preds = %for.cond29
  %invariant.gep = getelementptr i32, ptr @a, i64 %indvars.iv68
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body37
  %indvars.iv62 = phi i64 [ %1, %for.cond34.preheader ], [ %indvars.iv.next63, %for.body37 ]
  %mi.3 = phi i32 [ 1000, %for.cond34.preheader ], [ %.sroa.speculated, %for.body37 ]
  %cmp.i.i.i21.not = icmp sgt i64 %indvars.iv62, %2
  br i1 %cmp.i.i.i21.not, label %for.cond48.preheader, label %for.body37

for.cond48.preheader:                             ; preds = %for.cond34
  br label %for.cond48

for.body37:                                       ; preds = %for.cond34
  %gep = getelementptr [200 x i32], ptr %invariant.gep, i64 %indvars.iv62
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.body51
  %indvars.iv65 = phi i64 [ %1, %for.cond48.preheader ], [ %indvars.iv.next66, %for.body51 ]
  %cmp.i.i.i25.not = icmp sgt i64 %indvars.iv65, %2
  br i1 %cmp.i.i.i25.not, label %for.cond.cleanup50, label %for.body51
...
for.body51:                                       ; preds = %for.cond48
  %gep56 = getelementptr [200 x i32], ptr %invariant.gep, i64 %indvars.iv65
  %5 = load i32, ptr %gep56, align 4, !tbaa !5, !invariant.load !12
  %sub57 = sub nsw i32 %5, %mi.3
  store i32 %sub57, ptr %gep56, align 4, !tbaa !5
...
for.cond:                                         ; preds = %for.cond.cleanup57, %entry
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.cond.cleanup57 ], [ 1, %entry ]
  %0 = load i32, ptr @n, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.i.i.i.not = icmp sgt i64 %indvars.iv107, %1
  br i1 %cmp.i.i.i.not, label %for.end141, label %for.body
...
for.cond1:                                        ; preds = %for.cond.cleanup7, %for.body
  ...
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.cond.cleanup7 ], [ 1, %for.body ]
  %3 = sext i32 %2 to i64
  %cmp.i.i.i27.not = icmp sgt i64 %indvars.iv84, %3
  br i1 %cmp.i.i.i27.not, label %for.cond15.preheader, label %for.cond5.preheader
...
for.cond5.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [200 x i32], ptr @a, i64 %indvars.iv84
  br label %for.cond5
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %6 = sext i32 %5 to i64
  %cmp.i.i.i28.not = icmp sgt i64 %indvars.iv, %6
  br i1 %cmp.i.i.i28.not, label %for.cond.cleanup7, label %for.body8
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.body18
  %indvars.iv87 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next88, %for.body18 ]
  %exitcond = icmp eq i64 %indvars.iv87, %wide.trip.count
  br i1 %exitcond, label %for.cond31, label %for.body18

for.body18:                                       ; preds = %for.cond15
  %add.ptr20 = getelementptr inbounds nuw i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 800), i64 %indvars.iv87
  %7 = load i32, ptr %add.ptr20, align 4, !tbaa !5, !invariant.load !12
  store i32 %7, ptr @temp, align 4, !tbaa !5
  %add.ptr22 = getelementptr inbounds nuw i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 1600), i64 %indvars.iv87
...
for.cond31:                                       ; preds = %for.cond15, %for.body34
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.body34 ], [ 1, %for.cond15 ]
  %exitcond95 = icmp eq i64 %indvars.iv91, %wide.trip.count
  br i1 %exitcond95, label %for.cond55.preheader, label %for.body34

for.cond55.preheader:                             ; preds = %for.cond31
  %arrayidx65 = getelementptr inbounds nuw [200 x i32], ptr @sum, i64 0, i64 %indvars.iv107
  br label %for.cond55

for.body34:                                       ; preds = %for.cond31
  %add.ptr36 = getelementptr inbounds nuw [200 x i32], ptr @a, i64 %indvars.iv91
...
for.cond55:                                       ; preds = %for.cond55.loopexit, %for.cond55.preheader
  ...
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.cond55.loopexit ], [ 1, %for.cond55.preheader ]
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.cond55.loopexit ], [ 2, %for.cond55.preheader ]
...
for.body58:                                       ; preds = %for.cond55
  %13 = trunc nuw nsw i64 %indvars.iv101 to i32
  tail call void @_Z4zeroi(i32 noundef %13) #8
  %add.ptr60 = getelementptr inbounds nuw [200 x i32], ptr @a, i64 %indvars.iv101
  %add.ptr63 = getelementptr inbounds nuw i32, ptr %add.ptr60, i64 %indvars.iv101
...
for.cond68:                                       ; preds = %for.body71, %for.body58
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.body71 ], [ %indvars.iv96, %for.body58 ]
  %17 = trunc nuw i64 %indvars.iv98 to i32
  %cmp.i.i.i34.not = icmp slt i32 %16, %17
  br i1 %cmp.i.i.i34.not, label %for.cond101.preheader, label %for.body71

for.cond101.preheader:                            ; preds = %for.cond68
  %invariant.gep = getelementptr inbounds nuw i32, ptr @a, i64 %indvars.iv101
  %18 = sext i32 %16 to i64
  br label %for.cond101

for.body71:                                       ; preds = %for.cond68
  %add.ptr77 = getelementptr inbounds nuw i32, ptr %add.ptr74, i64 %indvars.iv98
  %19 = load i32, ptr %add.ptr77, align 4, !tbaa !5, !invariant.load !12
  store i32 %19, ptr @temp, align 4, !tbaa !5
  %add.ptr83 = getelementptr inbounds nuw i32, ptr %add.ptr80, i64 %indvars.iv98
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.body104
  %indvars.iv103 = phi i64 [ %indvars.iv101, %for.cond101.preheader ], [ %indvars.iv.next104, %for.body104 ]
  %cmp.i.i.i36.not.not = icmp slt i64 %indvars.iv103, %18
  br i1 %cmp.i.i.i36.not.not, label %for.body104, label %for.cond55.loopexit

for.body104:                                      ; preds = %for.cond101
  %indvars.iv.next104 = add nuw nsw i64 %indvars.iv103, 1
  %gep = getelementptr inbounds nuw [200 x i32], ptr %invariant.gep, i64 %indvars.iv.next104
