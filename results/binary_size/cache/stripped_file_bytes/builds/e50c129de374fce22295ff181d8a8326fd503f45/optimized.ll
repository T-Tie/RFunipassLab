...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  ...
  %exitcond21.not = icmp eq i32 %i.3, %smax20
  br i1 %exitcond21.not, label %for.end46, label %for.cond19.preheader
...
for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv12
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next13
...
for.end46:                                        ; preds = %for.cond16
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 1)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond49

for.cond49:                                       ; preds = %for.inc56, %for.end46
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc56 ], [ 1, %for.end46 ]
...
for.inc56:                                        ; preds = %for.cond49
  ...
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv22
