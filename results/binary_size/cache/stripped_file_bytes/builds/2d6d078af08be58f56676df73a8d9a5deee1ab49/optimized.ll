...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %word) #10
  %vtable7.i = load ptr, ptr @_ZSt3cin, align 8
  %vbase.offset.ptr8.i = getelementptr i8, ptr %vtable7.i, i64 -24
  br label %for.cond

for.cond:                                         ; preds = %if.end25, %entry
  %len.0 = phi i64 [ 0, %entry ], [ %len.1, %if.end25 ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %if.end25 ]
...
if.then6.i:                                       ; preds = %for.cond
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(100) %word, i64 noundef 100)
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %word)
...
if.then14:                                        ; preds = %if.else
  ...
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call15, ptr noundef nonnull %word)
  br label %if.end25
...
if.else18:                                        ; preds = %if.else
  ...
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call19, ptr noundef nonnull %word)
  %call23 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #11
  br label %if.end25

if.end25:                                         ; preds = %if.then14, %if.else18, %if.then
  %len.1 = phi i64 [ %dec, %if.then ], [ %add4, %if.then14 ], [ %call23, %if.else18 ]
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %word) #10
