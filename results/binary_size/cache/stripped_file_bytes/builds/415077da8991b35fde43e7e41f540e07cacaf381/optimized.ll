...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.cond13.preheader:                             ; preds = %for.cond1
  ...
  %smax62 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  %smax75 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %wide.trip.count63 = zext nneg i32 %smax62 to i64
  %wide.trip.count56 = zext i32 %sub to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc159
  %indvars.iv25 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next26, %for.inc159 ]
  %k.0 = phi i32 [ 0, %for.cond13.preheader ], [ %inc160, %for.inc159 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc159 ]
  %exitcond76.not = icmp eq i32 %k.0, %smax75
  br i1 %exitcond76.not, label %for.inc164, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  %smax50 = call i32 @llvm.smax.i32(i32 %indvars.iv25, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc55
  %indvars.iv32 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next33, %for.inc55 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond58.preheader, label %for.body19

for.cond58.preheader:                             ; preds = %for.cond16
  %wide.trip.count40 = zext i32 %indvars.iv25 to i64
  br label %for.cond58

for.body19:                                       ; preds = %for.cond16
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32
  %5 = load i32, ptr %arrayidx21, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond23

for.cond23:                                       ; preds = %for.body26, %for.body19
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body26 ], [ 0, %for.body19 ]
...
for.body26:                                       ; preds = %for.cond23
  %arrayidx30 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv21
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc52
  %indvars.iv27 = phi i64 [ 0, %for.cond39.preheader ], [ %indvars.iv.next28, %for.inc52 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.inc55, label %for.inc52

for.inc52:                                        ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv27
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc99
  %indvars.iv47 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next48, %for.inc99 ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count35
  br i1 %exitcond52.not, label %for.end101, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv47
  %8 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond65

for.cond65:                                       ; preds = %for.body68, %for.body61
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body68 ], [ 0, %for.body61 ]
  %min.2 = phi i32 [ %spec.select16, %for.body68 ], [ %8, %for.body61 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond83.preheader, label %for.body68

for.cond83.preheader:                             ; preds = %for.cond65
  br label %for.cond83

for.body68:                                       ; preds = %for.cond65
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv37, i64 %indvars.iv47
  %9 = load i32, ptr %arrayidx72, align 4, !tbaa !5, !invariant.load !13
  %spec.select16 = call i32 @llvm.smin.i32(i32 %9, i32 %min.2)
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  br label %for.cond65, !llvm.loop !17

for.cond83:                                       ; preds = %for.cond83.preheader, %for.inc96
  %indvars.iv42 = phi i64 [ 0, %for.cond83.preheader ], [ %indvars.iv.next43, %for.inc96 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count40
  br i1 %exitcond46.not, label %for.inc99, label %for.inc96

for.inc96:                                        ; preds = %for.cond83
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %indvars.iv47
...
for.cond104:                                      ; preds = %for.inc128, %for.end101
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc128 ], [ 0, %for.end101 ]
  %exitcond64.not = icmp eq i64 %indvars.iv58, %wide.trip.count63
  br i1 %exitcond64.not, label %for.cond131, label %for.cond107

for.cond107:                                      ; preds = %for.cond104, %for.inc120
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc120 ], [ 1, %for.cond104 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count56
  br i1 %exitcond57.not, label %for.inc128, label %for.inc120

for.inc120:                                       ; preds = %for.cond107
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv.next54
  %12 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !13
  %arrayidx119 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv53
  store i32 %12, ptr %arrayidx119, align 4, !tbaa !5
  br label %for.cond107, !llvm.loop !20

for.inc128:                                       ; preds = %for.cond107
  %arrayidx127 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %idxprom126
...
for.cond131:                                      ; preds = %for.cond104, %for.inc156
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc156 ], [ 0, %for.cond104 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %wide.trip.count73
  br i1 %exitcond74.not, label %for.inc159, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %wide.trip.count73
  br i1 %exitcond69.not, label %for.inc156, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next66, i64 %indvars.iv70
  %13 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !13
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %indvars.iv70
  store i32 %13, ptr %arrayidx147, align 4, !tbaa !5
  br label %for.cond135, !llvm.loop !22

for.inc156:                                       ; preds = %for.cond135
  %arrayidx155 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom126, i64 %indvars.iv70
