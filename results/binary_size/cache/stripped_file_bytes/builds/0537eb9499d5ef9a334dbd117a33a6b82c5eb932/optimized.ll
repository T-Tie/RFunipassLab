...
define dso_local noundef i32 @_Z6getonePc(ptr noundef %s) #0 {
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi3getERc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 1 dereferenceable(1) %0)
  %vtable = load ptr, ptr %call, align 8, !tbaa !12
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %call, i64 %vbase.offset
  %call1 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEEntEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr)
...
while.body:                                       ; preds = %land.end
  ...
  store ptr %incdec.ptr, ptr %s.addr, align 8, !tbaa !5
  %7 = load i32, ptr %count, align 4, !tbaa !10
  %inc = add nsw i32 %7, 1
  store i32 %inc, ptr %count, align 4, !tbaa !10
  %8 = load ptr, ptr %s.addr, align 8, !tbaa !5
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi3getERc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 1 dereferenceable(1) %8)
  ...
  %call9 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEEntEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr8)
...
while.end:                                        ; preds = %if.then10, %land.end
  %9 = load ptr, ptr %s.addr, align 8, !tbaa !5
  store i8 0, ptr %9, align 1, !tbaa !14
  %10 = load i32, ptr %count, align 4, !tbaa !10
...
; Function Attrs: mustprogress uwtable
define available_externally noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEEntEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #0 align 2 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %r) #9
  store i32 80, ptr %r, align 4, !tbaa !10
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z6getonePc(ptr noundef %arraydecay)
  store i32 %call2, ptr %c, align 4, !tbaa !10
  %2 = load i32, ptr %r, align 4, !tbaa !10
  %cmp3 = icmp eq i32 %2, 80
  br i1 %cmp3, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %arraydecay4 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  ...
  %4 = load i32, ptr %r, align 4, !tbaa !10
  %sub = sub nsw i32 %4, %3
  store i32 %sub, ptr %r, align 4, !tbaa !10
  br label %if.end17

if.else:                                          ; preds = %for.body
  %5 = load i32, ptr %r, align 4, !tbaa !10
  %6 = load i32, ptr %c, align 4, !tbaa !10
...
if.then7:                                         ; preds = %if.else
  ...
  %arraydecay9 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call8, ptr noundef %arraydecay9)
  %7 = load i32, ptr %c, align 4, !tbaa !10
  %add = add nsw i32 %7, 1
  %8 = load i32, ptr %r, align 4, !tbaa !10
  %sub11 = sub nsw i32 %8, %add
  store i32 %sub11, ptr %r, align 4, !tbaa !10
  br label %if.end
...
if.else12:                                        ; preds = %if.else
  ...
  %sub16 = sub nsw i32 80, %9
  store i32 %sub16, ptr %r, align 4, !tbaa !10
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p0(i64 4, ptr %r) #9
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %__out.addr, align 8, !tbaa !21, !nonnull !23, !align !24
...
if.else:                                          ; preds = %entry
  %2 = load ptr, ptr %__out.addr, align 8, !tbaa !21, !nonnull !23, !align !24
...
if.end:                                           ; preds = %if.else, %if.then
  %5 = load ptr, ptr %__out.addr, align 8, !tbaa !21, !nonnull !23, !align !24
  ret ptr %5
}
...
entry:
  ...
  %0 = load ptr, ptr %__out.addr, align 8, !tbaa !21, !nonnull !23, !align !24
...
if.end:                                           ; preds = %entry
  ...
  %4 = load ptr, ptr %__out.addr, align 8, !tbaa !21, !nonnull !23, !align !24
...
entry:
  ...
  %0 = load ptr, ptr %__os.addr, align 8, !tbaa !21, !nonnull !23, !align !24
  %1 = load ptr, ptr %__os.addr, align 8, !tbaa !21, !nonnull !23, !align !24
  %vtable = load ptr, ptr %1, align 8, !tbaa !12
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %1, i64 %vbase.offset
...
!18 = !{!19, !19, i64 0}
!19 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !7, i64 0}
!20 = distinct !{!20, !16, !17}
!21 = !{!22, !22, i64 0}
!22 = !{!"p1 _ZTSSo", !7, i64 0}
!23 = !{}
!24 = !{i64 8}
!25 = !{!7, !7, i64 0}
!26 = !{!27, !27, i64 0}
...
!28 = !{!29, !27, i64 32}
!29 = !{!"_ZTSSt8ios_base", !30, i64 8, !30, i64 16, !31, i64 24, !27, i64 28, !27, i64 32, !32, i64 40, !33, i64 48, !8, i64 64, !11, i64 192, !34, i64 200, !35, i64 208}
!30 = !{!"long", !8, i64 0}
...
!37 = !{!38, !38, i64 0}
!38 = !{!"p1 _ZTSSt8ios_base", !7, i64 0}
!39 = !{!29, !30, i64 16}
!40 = !{!41, !44, i64 240}
!41 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !29, i64 0, !22, i64 216, !8, i64 224, !42, i64 225, !43, i64 232, !44, i64 240, !45, i64 248, !46, i64 256}
!42 = !{!"bool", !8, i64 0}
