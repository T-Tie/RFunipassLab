...
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(10000) %a, i64 noundef 10000)
...
for.cond:                                         ; preds = %for.inc25, %entry
  ...
  %i.0 = phi i32 [ 0, %entry ], [ %inc.i10, %for.inc25 ]
...
for.cond29.preheader:                             ; preds = %for.cond
  ...
  %call40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull captures(none) %a) #9
  ret i32 0
...
for.end:                                          ; preds = %for.cond14
  ...
  %inc.i9 = add nsw i32 %num.0, 1
  br label %for.inc25

for.inc25:                                        ; preds = %for.cond, %land.lhs.true, %for.end
  %num.1 = phi i32 [ %inc.i9, %for.end ], [ %num.0, %land.lhs.true ], [ %num.0, %for.cond ]
  %i.1 = phi i32 [ %dec, %for.end ], [ %i.0, %land.lhs.true ], [ %i.0, %for.cond ]
  %inc.i10 = add nsw i32 %i.1, 1
  br label %for.cond
}
