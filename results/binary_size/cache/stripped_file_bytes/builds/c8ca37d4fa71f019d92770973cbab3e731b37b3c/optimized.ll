...
for.cond14:                                       ; preds = %for.cond14.preheader, %if.end35
  ...
  %indvars.iv8 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next9, %if.end35 ]
  %sub15 = add nsw i32 %6, -1
  %7 = sext i32 %sub15 to i64
  %cmp16 = icmp slt i64 %indvars.iv8, %7
  br i1 %cmp16, label %for.body17, label %for.end38

for.body17:                                       ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [10000 x double], ptr %extra, i64 0, i64 %indvars.iv8
