...
for.body:                                         ; preds = %entry, %for.inc
  %i.013 = phi i32 [ %inc6, %for.inc ], [ %j, %entry ]
  %rem = srem i32 %n, %i.013
  %div = sdiv i32 %n, %i.013
  %cmp1.not = icmp ne i32 %rem, 0
  %cmp4.not = icmp slt i32 %div, %i.013
...
if.then:                                          ; preds = %for.body
  ...
  %call = tail call noundef i32 @_Z5yinziii(i32 noundef %i.013, i32 noundef %div)
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then
  %inc6 = add i32 %i.013, 1
  %exitcond.not = icmp eq i32 %inc6, %n
...
for.body:                                         ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %j.011 = phi i32 [ %inc14, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 0, %entry ]
  ...
  %cmp3.not8 = icmp slt i32 %1, 2
  br i1 %cmp3.not8, label %for.cond.cleanup4, label %for.body5
...
if.then.i.i.i:                                    ; preds = %for.cond.cleanup4
  call void @_ZSt16__throw_bad_castv() #6
  unreachable

_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %for.cond.cleanup4
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call11, i8 noundef signext %retval.0.i.i.i)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  store i32 1, ptr @a, align 4, !tbaa !5
  %inc14 = add nuw nsw i32 %j.011, 1
...
for.body5:                                        ; preds = %for.body, %for.inc
  %8 = phi i32 [ %10, %for.inc ], [ %1, %for.body ]
  %i.09 = phi i32 [ %inc10, %for.inc ], [ 2, %for.body ]
  %rem = srem i32 %8, %i.09
  %div = sdiv i32 %8, %i.09
  %cmp6 = icmp ne i32 %rem, 0
  %cmp7.not = icmp slt i32 %div, %i.09
...
if.then:                                          ; preds = %for.body5
  ...
  %inc = add nsw i32 %9, 1
  store i32 %inc, ptr @a, align 4, !tbaa !5
  %call9 = call noundef i32 @_Z5yinziii(i32 noundef %i.09, i32 noundef %div)
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.body5, %if.then
  %10 = phi i32 [ %8, %for.body5 ], [ %.pre, %if.then ]
  %inc10 = add nuw nsw i32 %i.09, 1
  %cmp3.not.not = icmp slt i32 %i.09, %10
  br i1 %cmp3.not.not, label %for.body5, label %for.cond.cleanup4, !llvm.loop !40
}
