...
while.cond:                                       ; preds = %if.end31, %entry
  %n.0 = phi i32 [ 0, %entry ], [ %n.1, %if.end31 ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.cond.loopexit
  ...
  br i1 %exitcond19.not, label %for.end23, label %for.body
...
if.end31:                                         ; preds = %for.end23, %if.else26
  %n.1 = phi i32 [ 0, %for.end23 ], [ %inc29, %if.else26 ]
