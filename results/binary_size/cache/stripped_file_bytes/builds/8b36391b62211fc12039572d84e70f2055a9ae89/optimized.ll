...
lor.lhs.false67:                                  ; preds = %lor.lhs.false63
  %cmp68 = icmp eq i32 %5, 9
  %cmp70 = icmp eq i32 %4, 12
  %or.cond11 = and i1 %cmp68, %cmp70
  %spec.select27 = select i1 %or.cond11, ptr @str.3, ptr @str.2
  br label %for.inc
...
for.inc:                                          ; preds = %lor.lhs.false67, %lor.lhs.false39, %if.else47, %lor.lhs.false51, %lor.lhs.false55, %lor.lhs.false63, %if.then19, %lor.lhs.false23, %lor.lhs.false27, %lor.lhs.false31
  %str.2.sink = phi ptr [ @str.3, %lor.lhs.false31 ], [ @str.3, %lor.lhs.false27 ], [ @str.3, %lor.lhs.false23 ], [ @str.3, %if.then19 ], [ @str.3, %lor.lhs.false63 ], [ @str.3, %lor.lhs.false55 ], [ @str.3, %lor.lhs.false51 ], [ @str.3, %if.else47 ], [ %spec.select, %lor.lhs.false39 ], [ %spec.select27, %lor.lhs.false67 ]
