...
for.cond4:                                        ; preds = %for.inc21, %sw.bb3
...
for.body8:                                        ; preds = %for.cond5
  ...
  %arrayidx12 = getelementptr inbounds [16 x i32], ptr %a, i64 0, i64 %idxprom11
  %12 = load i32, ptr %arrayidx12, align 4, !tbaa !5
  %mul = mul nsw i32 2, %12
  %cmp13 = icmp eq i32 %10, %mul
...
for.end23:                                        ; preds = %for.cond.cleanup
  ...
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %20)
...
sw.epilog:                                        ; preds = %for.end23, %for.cond
  br label %for.inc26
