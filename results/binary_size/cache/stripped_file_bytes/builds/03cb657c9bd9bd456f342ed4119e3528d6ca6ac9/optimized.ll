...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 257, ptr %str) #12
  call void @llvm.memset.p0.i64(ptr align 16 %str, i8 0, i64 257, i1 false)
  call void @llvm.lifetime.start.p0(i64 257, ptr %substr) #12
  call void @llvm.memset.p0.i64(ptr align 16 %substr, i8 0, i64 257, i1 false)
  call void @llvm.lifetime.start.p0(i64 257, ptr %replace) #12
  call void @llvm.memset.p0.i64(ptr align 16 %replace, i8 0, i64 257, i1 false)
  ...
  %arraydecay1 = getelementptr inbounds [257 x i8], ptr %substr, i64 0, i64 0
  ...
  %arraydecay3 = getelementptr inbounds [257 x i8], ptr %replace, i64 0, i64 0
  ...
  %arraydecay5 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 0
  %arraydecay6 = getelementptr inbounds [257 x i8], ptr %substr, i64 0, i64 0
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %flag) #12
  %arraydecay8 = getelementptr inbounds [257 x i8], ptr %substr, i64 0, i64 0
  %call9 = call i64 @strlen(ptr noundef %arraydecay8) #13
  %conv = trunc i64 %call9 to i32
  store i32 %conv, ptr %flag, align 4, !tbaa !10
  %0 = load ptr, ptr %p, align 8, !tbaa !5
  %cmp = icmp eq ptr %0, null
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %arraydecay10 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 0
...
for.cond:                                         ; preds = %for.inc, %if.else
  %arraydecay13 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 0
...
for.body:                                         ; preds = %for.cond
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %4)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %arraydecay16 = getelementptr inbounds [257 x i8], ptr %replace, i64 0, i64 0
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay16)
  %6 = load i32, ptr %i, align 4, !tbaa !10
  %7 = load i32, ptr %flag, align 4, !tbaa !10
  %add = add nsw i32 %6, %7
...
for.cond18:                                       ; preds = %for.inc27, %for.end
  ...
  %arraydecay20 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 0
  %call21 = call i64 @strlen(ptr noundef %arraydecay20) #13
...
for.body23:                                       ; preds = %for.cond18
  ...
  %arrayidx25 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 %idxprom24
  %10 = load i8, ptr %arrayidx25, align 1, !tbaa !12
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %10)
  br label %for.inc27

for.inc27:                                        ; preds = %for.body23
  %11 = load i32, ptr %i, align 4, !tbaa !10
  %inc28 = add nsw i32 %11, 1
...
if.end:                                           ; preds = %for.end29, %if.then
  call void @llvm.lifetime.end.p0(i64 4, ptr %flag) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #12
  call void @llvm.lifetime.end.p0(i64 257, ptr %replace) #12
  call void @llvm.lifetime.end.p0(i64 257, ptr %substr) #12
  call void @llvm.lifetime.end.p0(i64 257, ptr %str) #12
  ret i32 0
}
...
entry:
  ...
  store ptr %__in, ptr %__in.addr, align 8, !tbaa !17
...
do.end:                                           ; preds = %do.cond
  %3 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
  ...
  %4 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.then6:                                         ; preds = %if.else
  ...
  %7 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
  ...
  %8 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
  %9 = load ptr, ptr %__s.addr, align 8, !tbaa !5
  %10 = load i64, ptr %__n, align 8, !tbaa !19
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) %8, ptr noundef %9, i64 noundef %10)
  %11 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %15 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.then28:                                        ; preds = %if.then19
  %17 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.else34:                                        ; preds = %if.else
  ...
  %19 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.end38:                                         ; preds = %if.end37, %do.end
  %22 = load ptr, ptr %__in.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
entry:
  ...
  %0 = load ptr, ptr %__out.addr, align 8, !tbaa !28, !nonnull !21, !align !22
...
if.end:                                           ; preds = %entry
  ...
  %4 = load ptr, ptr %__out.addr, align 8, !tbaa !28, !nonnull !21, !align !22
...
entry:
  ...
  %0 = load ptr, ptr %__c.addr, align 8, !tbaa !5, !nonnull !21
...
!30 = !{!7, !7, i64 0}
!31 = !{!32, !32, i64 0}
!32 = !{!"p1 _ZTSSt8ios_base", !7, i64 0}
!33 = !{!34, !20, i64 16}
!34 = !{!"_ZTSSt8ios_base", !20, i64 8, !20, i64 16, !35, i64 24, !36, i64 28, !36, i64 32, !37, i64 40, !38, i64 48, !8, i64 64, !11, i64 192, !39, i64 200, !40, i64 208}
!35 = !{!"_ZTSSt13_Ios_Fmtflags", !8, i64 0}
!36 = !{!"_ZTSSt12_Ios_Iostate", !8, i64 0}
!37 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !7, i64 0}
!38 = !{!"_ZTSNSt8ios_base6_WordsE", !7, i64 0, !20, i64 8}
!39 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !7, i64 0}
!40 = !{!"_ZTSSt6locale", !41, i64 0}
!41 = !{!"p1 _ZTSNSt6locale5_ImplE", !7, i64 0}
!42 = !{!43, !43, i64 0}
!43 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !7, i64 0}
!44 = !{!36, !36, i64 0}
!45 = !{!46, !47, i64 232}
!46 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !34, i64 0, !29, i64 216, !8, i64 224, !26, i64 225, !47, i64 232, !48, i64 240, !49, i64 248, !50, i64 256}
...
!55 = !{!34, !36, i64 32}
!56 = !{!57, !6, i64 16}
!57 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !40, i64 56}
!58 = !{!57, !6, i64 24}
!59 = !{!46, !48, i64 240}
!60 = !{!48, !48, i64 0}
!61 = !{!62, !8, i64 56}
!62 = !{!"_ZTSSt5ctypeIcE", !63, i64 0, !64, i64 16, !26, i64 24, !53, i64 32, !53, i64 40, !65, i64 48, !8, i64 56, !8, i64 57, !8, i64 313, !8, i64 569}
!63 = !{!"_ZTSNSt6locale5facetE", !11, i64 8}
