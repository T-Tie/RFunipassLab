...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 240, ptr nonnull %c) #7
...
for.inc:                                          ; preds = %for.body, %if.then
  %j.1 = phi i32 [ 0, %if.then ], [ %j.0, %for.body ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.cond24:                                       ; preds = %for.cond, %for.inc35
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc35 ], [ 0, %for.cond ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, 60
  br i1 %exitcond19.not, label %for.end37, label %for.body26

for.body26:                                       ; preds = %for.cond24
  %arrayidx28 = getelementptr inbounds nuw [60 x i32], ptr %c, i64 0, i64 %indvars.iv15
...
if.end40:                                         ; preds = %if.then38, %for.end37
  ...
  call void @llvm.lifetime.end.p0(i64 240, ptr nonnull %c) #7
  ret i32 0
}
