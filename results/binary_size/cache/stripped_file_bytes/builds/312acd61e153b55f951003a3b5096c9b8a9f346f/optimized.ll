...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %.pr2 = phi i32 [ %.pr, %entry ], [ %sub, %while.body ]
  %cmp = icmp sgt i32 %.pr2, 99
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %sub = add nsw i32 %.pr2, -100
...
while.cond1:                                      ; preds = %while.body3, %while.end
  ...
  %.pr3 = phi i32 [ %.pr2, %while.end ], [ %sub4, %while.body3 ]
  %cmp2 = icmp sgt i32 %.pr3, 49
  br i1 %cmp2, label %while.body3, label %while.end6

while.body3:                                      ; preds = %while.cond1
  %sub4 = add nsw i32 %.pr3, -50
...
while.cond7:                                      ; preds = %while.body9, %while.end6
  ...
  %.pr4 = phi i32 [ %.pr3, %while.end6 ], [ %sub10, %while.body9 ]
  %cmp8 = icmp sgt i32 %.pr4, 19
  br i1 %cmp8, label %while.body9, label %while.end12

while.body9:                                      ; preds = %while.cond7
  %sub10 = add nsw i32 %.pr4, -20
...
while.cond13:                                     ; preds = %while.body15, %while.end12
  ...
  %.pr5 = phi i32 [ %.pr4, %while.end12 ], [ %sub16, %while.body15 ]
  %cmp14 = icmp sgt i32 %.pr5, 9
  br i1 %cmp14, label %while.body15, label %while.end18

while.body15:                                     ; preds = %while.cond13
  %sub16 = add nsw i32 %.pr5, -10
...
while.cond19:                                     ; preds = %while.body21, %while.end18
  ...
  %.pr6 = phi i32 [ %.pr5, %while.end18 ], [ %sub22, %while.body21 ]
  %cmp20 = icmp sgt i32 %.pr6, 4
  br i1 %cmp20, label %while.body21, label %while.end24

while.body21:                                     ; preds = %while.cond19
  %sub22 = add nsw i32 %.pr6, -5
...
while.end24:                                      ; preds = %while.cond19
  %smin = call i32 @llvm.smin.i32(i32 %.pr6, i32 noundef 0)
  %0 = sub i32 %.pr6, %smin
  br label %while.cond25

while.cond25:                                     ; preds = %while.body27, %while.end24
  %f.0 = phi i32 [ 0, %while.end24 ], [ %inc29, %while.body27 ]
  %1 = phi i32 [ %.pr6, %while.end24 ], [ %sub28, %while.body27 ]
...
while.end30:                                      ; preds = %while.cond25
  ...
  %call41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call40, i32 noundef %0)
