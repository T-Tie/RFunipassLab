...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv3 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next4, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax15 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %3 = add nuw i32 %smax15, 1
  %wide.trip.count16 = zext i32 %3 to i64
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %s, i64 0, i64 %indvars.iv3
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc46
  %indvars.iv10 = phi i64 [ 1, %for.cond16.preheader ], [ %indvars.iv.next11, %for.inc46 ]
  %exitcond17 = icmp eq i64 %indvars.iv10, %wide.trip.count16
  br i1 %exitcond17, label %for.end48, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %6 = sub nsw i64 %2, %indvars.iv10
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc43
  %indvars.iv7 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next8, %for.inc43 ]
  %m.0 = phi i32 [ 0, %for.cond19.preheader ], [ %spec.select, %for.inc43 ]
  %cmp20.not = icmp sgt i64 %indvars.iv7, %6
  br i1 %cmp20.not, label %for.inc46, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv7
...
if.else:                                          ; preds = %for.end48
  %smax22 = call i32 @llvm.smax.i32(i32 %z.0, i32 1)
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  br label %for.cond55

for.cond55:                                       ; preds = %for.inc61, %if.else
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc61 ], [ 1, %if.else ]
  %exitcond24.not = icmp eq i64 %indvars.iv18, %wide.trip.count23
  br i1 %exitcond24.not, label %if.end64, label %for.inc61

for.inc61:                                        ; preds = %for.cond55
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv18
