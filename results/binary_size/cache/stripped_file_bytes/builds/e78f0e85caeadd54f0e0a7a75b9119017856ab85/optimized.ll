...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre66, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv60 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next61, %for.inc27 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %2
  br i1 %exitcond65.not, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc21 ], [ 0, %for.cond10 ]
  %exitcond.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv60, i64 %indvars.iv56
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.151 = phi i32 [ %6, %for.end29.loopexit ], [ %smax, %for.cond10 ]
  %j1.1 = phi i32 [ %8, %for.end29.loopexit ], [ undef, %for.cond10 ]
  %sub = add i32 %0, -1
...
for.end51:                                        ; preds = %for.cond30, %for.body36
  %i.248 = phi i32 [ %i.2, %for.body36 ], [ %smin, %for.cond30 ]
  %j2.1 = phi i32 [ %j.2, %for.body36 ], [ undef, %for.cond30 ]
  %10 = xor i32 %i.151, -1
  %sub53 = add i32 %i.248, %10
