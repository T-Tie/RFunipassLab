...
for.cond43:                                       ; preds = %land.lhs.true, %for.inc52
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc52 ], [ %idxprom35, %land.lhs.true ]
  %exitcond.not = icmp eq i64 %indvars.iv30, %wide.trip.count39
  br i1 %exitcond.not, label %for.end55, label %for.inc52

for.inc52:                                        ; preds = %for.cond43
  %indvars.iv.next31 = add nsw i64 %indvars.iv30, 1
  %arrayidx49 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv.next31
  %4 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %arrayidx51 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv30
...
for.cond67:                                       ; preds = %land.lhs.true, %for.inc76
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc76 ], [ %idxprom35, %land.lhs.true ]
  %exitcond40.not = icmp eq i64 %indvars.iv34, %wide.trip.count39
  br i1 %exitcond40.not, label %for.end79, label %for.inc76

for.inc76:                                        ; preds = %for.cond67
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %arrayidx73 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv.next35
  %5 = load i32, ptr %arrayidx73, align 4, !tbaa !5, !invariant.load !9
  %arrayidx75 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv34
...
for.cond88:                                       ; preds = %for.cond88.preheader, %for.inc97
  ...
  %indvars.iv41 = phi i64 [ 0, %for.cond88.preheader ], [ %indvars.iv.next42, %for.inc97 ]
  %sub89 = add i32 %6, %1
  %7 = sext i32 %sub89 to i64
  %cmp90 = icmp slt i64 %indvars.iv41, %7
  br i1 %cmp90, label %for.inc97, label %for.end100

for.inc97:                                        ; preds = %for.cond88
  %arrayidx94 = getelementptr inbounds nuw [20001 x i32], ptr %num, i64 0, i64 %indvars.iv41
