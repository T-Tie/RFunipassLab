...
for.cond17:                                       ; preds = %if.end32, %for.body
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %if.end32 ], [ %indvars.iv, %for.body ]
...
for.cond59:                                       ; preds = %if.end71, %if.else
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %if.end71 ], [ 1, %if.else ]
