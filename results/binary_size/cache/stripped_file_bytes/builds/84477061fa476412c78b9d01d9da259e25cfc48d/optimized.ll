...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.cond33
  %putchar10 = call i32 @putchar(i32 noundef %conv38) #9
  br label %for.cond33
...
for.cond46:                                       ; preds = %for.body48, %for.end42
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body48 ], [ 0, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv19, %3
  br i1 %cmp47, label %for.body48, label %if.end58

for.body48:                                       ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds nuw [257 x i8], ptr %str, i64 0, i64 %indvars.iv19
