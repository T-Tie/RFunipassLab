...
for.cond4:                                        ; preds = %for.cond1, %for.body6
  ...
  br i1 %cmp5, label %for.body6, label %for.cond1

for.body6:                                        ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv
...
for.cond:                                         ; preds = %for.end27, %entry
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.end27 ], [ 0, %entry ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count38
  br i1 %exitcond39.not, label %for.cond31.preheader, label %for.body
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv35, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv30 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next31, %for.body16 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv35, i64 %indvars.iv30
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end70
  %indvars.iv50 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next51, %for.end70 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count38
  br i1 %exitcond54.not, label %for.end73, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv50
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body39 ], [ 0, %for.body33 ]
  %s.1 = phi i32 [ %spec.select28, %for.body39 ], [ %3, %for.body33 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond56.preheader, label %for.body39

for.cond56.preheader:                             ; preds = %for.cond37
  br label %for.cond56

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv40, i64 %indvars.iv50
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !12
  %spec.select28 = tail call i32 @llvm.smin.i32(i32 %s.1, i32 %4)
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  br label %for.cond37, !llvm.loop !16

for.cond56:                                       ; preds = %for.cond56.preheader, %for.body58
  %indvars.iv45 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next46, %for.body58 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count43
  br i1 %exitcond49.not, label %for.end70, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv45, i64 %indvars.iv50
...
if.then:                                          ; preds = %for.end73
  %7 = load i32, ptr %a, align 4, !tbaa !5, !invariant.load !12
  store i32 %7, ptr %b, align 16, !tbaa !5
  %wide.trip.count59 = zext nneg i32 %n to i64
  br label %for.cond81

for.cond81:                                       ; preds = %for.body83, %if.then
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.body83 ], [ 2, %if.then ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %wide.trip.count59
  br i1 %exitcond60.not, label %for.cond101, label %for.body83

for.body83:                                       ; preds = %for.cond81
  %arrayidx86 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv55
  ...
  %arrayidx92 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv55
...
for.cond101:                                      ; preds = %for.cond81, %for.end119
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.end119 ], [ 2, %for.cond81 ]
  %exitcond72.not = icmp eq i64 %indvars.iv67, %wide.trip.count59
  br i1 %exitcond72.not, label %for.end122, label %for.cond104.preheader

for.cond104.preheader:                            ; preds = %for.cond101
  %11 = add nsw i64 %indvars.iv67, -1
  br label %for.cond104

for.cond104:                                      ; preds = %for.cond104.preheader, %for.body106
  %indvars.iv61 = phi i64 [ 2, %for.cond104.preheader ], [ %indvars.iv.next62, %for.body106 ]
  %exitcond66.not = icmp eq i64 %indvars.iv61, %wide.trip.count59
  br i1 %exitcond66.not, label %for.end119, label %for.body106

for.body106:                                      ; preds = %for.cond104
  %arrayidx110 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv67, i64 %indvars.iv61
  %12 = load i32, ptr %arrayidx110, align 4, !tbaa !5, !invariant.load !12
  %13 = add nsw i64 %indvars.iv61, -1
