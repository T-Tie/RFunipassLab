...
for.cond35:                                       ; preds = %for.cond31, %for.inc50
  %sub.sink1 = phi i32 [ %dec, %for.inc50 ], [ %sub, %for.cond31 ]
  %cmp36 = icmp sgt i32 %sub.sink1, 0
  br i1 %cmp36, label %for.body37, label %for.inc52

for.body37:                                       ; preds = %for.cond35
  %idxprom40 = zext nneg i32 %sub.sink1 to i64
...
if.then43:                                        ; preds = %for.body37
  ...
  store i32 %sub.sink1, ptr %arrayidx48, align 4, !tbaa !5
  br label %for.inc52

for.inc50:                                        ; preds = %for.body37
  %dec = add nsw i32 %sub.sink1, -1
