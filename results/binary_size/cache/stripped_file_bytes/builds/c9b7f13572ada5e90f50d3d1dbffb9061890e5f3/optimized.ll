...
for.cond1.preheader:                              ; preds = %entry, %if.end
  %indvars.iv16 = phi i64 [ 0, %entry ], [ %indvars.iv.next17, %if.end ]
  br label %for.body3
...
if.end:                                           ; preds = %for.end
  ...
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr %peo, i64 0, i64 %indvars.iv16
  store i32 %add18, ptr %arrayidx20, align 4, !tbaa !8
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond19.not = icmp eq i64 %indvars.iv.next17, 1000
  br i1 %exitcond19.not, label %for.body26.preheader, label %for.cond1.preheader, !llvm.loop !12

for.end23:                                        ; preds = %for.end
  %cmp2513.not = icmp eq i64 %indvars.iv16, 0
  br i1 %cmp2513.not, label %for.end32, label %for.body26.preheader

for.body26.preheader:                             ; preds = %if.end, %for.end23
  %i.0.lcssa26 = phi i64 [ %indvars.iv16, %for.end23 ], [ 1000, %if.end ]
  %wide.trip.count = and i64 %i.0.lcssa26, 4294967295
  br label %for.body26

for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  %indvars.iv20 = phi i64 [ 0, %for.body26.preheader ], [ %indvars.iv.next21, %for.body26 ]
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %peo, i64 0, i64 %indvars.iv20
  ...
  br i1 %exitcond23.not, label %for.end32, label %for.body26, !llvm.loop !13

for.end32:                                        ; preds = %for.body26, %for.end23
