...
define dso_local noundef i32 @_Z1fii(i32 noundef %a, i32 noundef %b) local_unnamed_addr #0 {
entry:
  %mul = shl nsw i32 %b, 1
  %cmp.not = icmp slt i32 %a, %mul
  br i1 %cmp.not, label %if.end8, label %for.cond.preheader

for.cond.preheader:                               ; preds = %entry
  %div = sdiv i32 %a, %b
  %cmp1.not14 = icmp sgt i32 %b, %div
  br i1 %cmp1.not14, label %if.end8, label %for.body

for.body:                                         ; preds = %for.cond.preheader, %for.inc
  %i.016 = phi i32 [ %inc, %for.inc ], [ %b, %for.cond.preheader ]
  %k.015 = phi i32 [ %k.1, %for.inc ], [ 0, %for.cond.preheader ]
  %rem = srem i32 %a, %i.016
  %div3 = sdiv i32 %a, %i.016
  %cmp2 = icmp ne i32 %rem, 0
  %cmp4.not = icmp slt i32 %div3, %i.016
  %or.cond = or i1 %cmp2, %cmp4.not
  br i1 %or.cond, label %for.inc, label %if.then5

if.then5:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z1fii(i32 noundef %div3, i32 noundef %i.016)
  %add = add i32 %k.015, 1
  %add7 = add i32 %add, %call
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then5
  %k.1 = phi i32 [ %add7, %if.then5 ], [ %k.015, %for.body ]
  %inc = add i32 %i.016, 1
  %exitcond.not = icmp eq i32 %i.016, %div
  br i1 %exitcond.not, label %if.end8, label %for.body, !llvm.loop !5

if.end8:                                          ; preds = %for.inc, %for.cond.preheader, %entry
  %k.2 = phi i32 [ 0, %entry ], [ 0, %for.cond.preheader ], [ %k.1, %for.inc ]
  ret i32 %k.2
}
...
entry:
  ...
  store i32 %dec1, ptr %n, align 4, !tbaa !8
...
!14 = !{!15, !29, i64 240}
!15 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !16, i64 0, !26, i64 216, !10, i64 224, !27, i64 225, !28, i64 232, !29, i64 240, !30, i64 248, !31, i64 256}
!16 = !{!"_ZTSSt8ios_base", !17, i64 8, !17, i64 16, !18, i64 24, !19, i64 28, !19, i64 32, !20, i64 40, !22, i64 48, !10, i64 64, !9, i64 192, !23, i64 200, !24, i64 208}
!17 = !{!"long", !10, i64 0}
...
!32 = !{!33, !10, i64 56}
!33 = !{!"_ZTSSt5ctypeIcE", !34, i64 0, !35, i64 16, !27, i64 24, !36, i64 32, !36, i64 40, !37, i64 48, !10, i64 56, !10, i64 57, !10, i64 313, !10, i64 569}
!34 = !{!"_ZTSNSt6locale5facetE", !9, i64 8}
