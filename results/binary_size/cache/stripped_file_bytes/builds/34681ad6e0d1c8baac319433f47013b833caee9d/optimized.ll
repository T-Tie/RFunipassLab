...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc7
  ...
  %3 = sext i32 %2 to i64
  %cmp = icmp slt i64 %indvars.iv12, %3
  br i1 %cmp, label %for.cond1, label %while.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre15, %for.inc ], [ %2, %for.cond ]
...
while.cond10:                                     ; preds = %for.cond, %while.body12
  ...
  %p.0.in = phi i32 [ %p.0, %while.body12 ], [ %2, %for.cond ]
...
for.cond:                                         ; preds = %if.end28, %entry.split
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %if.end28 ], [ 0, %entry.split ]
  br label %for.cond2
...
if.end:                                           ; preds = %for.body4
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv26, i64 %indvars.iv
...
for.cond18:                                       ; preds = %for.end, %for.inc25
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc25 ], [ 0, %for.end ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv26, i64 %indvars.iv21
...
if.end:                                           ; preds = %for.body4
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv, i64 %indvars.iv26
  %1 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !15
  %spec.select = tail call i32 @llvm.smin.i32(i32 %1, i32 %min.0)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.inc25:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv21, i64 %indvars.iv26
  %2 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !15
  %sub = sub nsw i32 %2, %min.0
  store i32 %sub, ptr %arrayidx24, align 4, !tbaa !5
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv17 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next18, %for.end ]
  br label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv17, i64 %indvars.iv.next
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !15
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv17, i64 %indvars.iv
