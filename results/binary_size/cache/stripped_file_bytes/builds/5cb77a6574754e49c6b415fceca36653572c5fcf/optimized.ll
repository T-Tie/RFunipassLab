...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10500, ptr noundef nonnull align 16 dereferenceable(10500) %a) #8
  %vtable.i = load ptr, ptr @_ZSt3cin, align 8
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  br label %while.body

while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ 0, %entry ]
  %arrayidx = getelementptr inbounds nuw [100 x [105 x i8]], ptr %a, i64 0, i64 %indvars.iv
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %arrayidx, i1 false, i1 true, i1 false)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  ...
  br i1 %cmp, label %for.cond, label %while.body, !llvm.loop !20

for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.inc
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc ], [ %indvars.iv, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ]
  %cmp2 = icmp sgt i64 %indvars.iv6, 0
  br i1 %cmp2, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [100 x [105 x i8]], ptr %a, i64 0, i64 %indvars.iv6
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx4)
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call6, ptr noundef nonnull @.str)
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, -1
  br label %for.cond, !llvm.loop !23

for.end:                                          ; preds = %for.cond
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a)
  call void @llvm.lifetime.end.p0(i64 noundef 10500, ptr noundef nonnull %a) #9
  ret i32 0
}
