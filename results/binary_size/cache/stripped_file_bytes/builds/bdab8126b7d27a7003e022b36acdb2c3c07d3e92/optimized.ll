...
for.cond:                                         ; preds = %for.end160, %entry
  ...
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.end160 ], [ 1, %entry ]
  %2 = sext i32 %1 to i64
  %cmp.not = icmp sgt i64 %indvars.iv126, %2
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %5 = sext i32 %4 to i64
  %cmp2.not.not = icmp slt i64 %indvars.iv72, %5
  br i1 %cmp2.not.not, label %for.cond4, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond1
  %arrayidx105 = getelementptr inbounds nuw [101 x i32], ptr %sum, i64 0, i64 %indvars.iv126
  %smax123 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  %wide.trip.count124 = zext nneg i32 %smax123 to i64
  br label %for.cond14

for.cond4:                                        ; preds = %for.cond1, %for.body7
  %6 = phi i32 [ %.pre132, %for.body7 ], [ %3, %for.cond1 ]
...
for.body7:                                        ; preds = %for.cond4
  %arrayidx9 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.end157
  %indvars.iv118 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next119, %for.end157 ]
  %indvars.iv109.in = phi i32 [ %4, %for.cond14.preheader ], [ %indvars.iv109, %for.end157 ]
  %indvars.iv79 = phi i32 [ %4, %for.cond14.preheader ], [ %indvars.iv.next80, %for.end157 ]
  %indvars.iv109 = add i32 %indvars.iv109.in, -1
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv109, i32 1)
  %exitcond125.not = icmp eq i64 %indvars.iv118, %wide.trip.count124
  br i1 %exitcond125.not, label %for.end160, label %for.cond18.preheader

for.cond18.preheader:                             ; preds = %for.cond14
  %8 = sub nsw i64 %5, %indvars.iv118
  %wide.trip.count = zext i32 %indvars.iv79 to i64
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond18.preheader, %for.end56
  %indvars.iv86 = phi i64 [ 0, %for.cond18.preheader ], [ %indvars.iv.next87, %for.end56 ]
  %cmp20.not = icmp sgt i64 %indvars.iv86, %8
  br i1 %cmp20.not, label %for.cond60.preheader, label %for.body21

for.cond60.preheader:                             ; preds = %for.cond18
  %wide.trip.count92 = zext i32 %indvars.iv79 to i64
  br label %for.cond60

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv86
  %9 = load i32, ptr %arrayidx23, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond25

for.cond25:                                       ; preds = %for.body28, %for.body21
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.body28 ], [ 0, %for.body21 ]
  %min.0 = phi i32 [ %spec.select, %for.body28 ], [ %9, %for.body21 ]
  %exitcond = icmp eq i64 %indvars.iv75, %wide.trip.count
...
for.body28:                                       ; preds = %for.cond25
  %arrayidx32 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv86, i64 %indvars.iv75
...
for.cond41:                                       ; preds = %for.cond41.preheader, %for.body44
  %indvars.iv81 = phi i64 [ 0, %for.cond41.preheader ], [ %indvars.iv.next82, %for.body44 ]
  %exitcond85 = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond85, label %for.end56, label %for.body44

for.body44:                                       ; preds = %for.cond41
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv86, i64 %indvars.iv81
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.end100
  %indvars.iv99 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next100, %for.end100 ]
  %cmp62.not = icmp sgt i64 %indvars.iv99, %8
  br i1 %cmp62.not, label %for.end103, label %for.body63

for.body63:                                       ; preds = %for.cond60
  %arrayidx66 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv99
  %12 = load i32, ptr %arrayidx66, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond67

for.cond67:                                       ; preds = %for.body70, %for.body63
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.body70 ], [ 0, %for.body63 ]
  %min.2 = phi i32 [ %spec.select70, %for.body70 ], [ %12, %for.body63 ]
  %exitcond93 = icmp eq i64 %indvars.iv89, %wide.trip.count92
  br i1 %exitcond93, label %for.cond85.preheader, label %for.body70

for.cond85.preheader:                             ; preds = %for.cond67
  br label %for.cond85

for.body70:                                       ; preds = %for.cond67
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv89, i64 %indvars.iv99
  %13 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !13
  %spec.select70 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  br label %for.cond67, !llvm.loop !17

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body88
  %indvars.iv94 = phi i64 [ 0, %for.cond85.preheader ], [ %indvars.iv.next95, %for.body88 ]
  %exitcond98 = icmp eq i64 %indvars.iv94, %wide.trip.count92
  br i1 %exitcond98, label %for.end100, label %for.body88

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
...
for.cond110:                                      ; preds = %for.body114, %for.end103
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.body114 ], [ 1, %for.end103 ]
  %cmp113.not.not = icmp slt i64 %indvars.iv102, %8
...
for.body114:                                      ; preds = %for.cond110
  ...
  %arrayidx118 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next103
  %17 = load i32, ptr %arrayidx118, align 4, !tbaa !5, !invariant.load !13
  %arrayidx121 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv102
  store i32 %17, ptr %arrayidx121, align 4, !tbaa !5
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next103
  %18 = load i32, ptr %arrayidx124, align 16, !tbaa !5, !invariant.load !13
  %arrayidx127 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv102
...
for.cond132:                                      ; preds = %for.cond137, %for.cond132.preheader
  %indvars.iv113 = phi i64 [ 1, %for.cond132.preheader ], [ %indvars.iv.next114, %for.cond137 ]
  %exitcond117.not = icmp eq i64 %indvars.iv113, %wide.trip.count116
  br i1 %exitcond117.not, label %for.end157, label %for.cond137.preheader
...
for.cond137:                                      ; preds = %for.cond137.preheader, %for.body141
  %indvars.iv105 = phi i64 [ 1, %for.cond137.preheader ], [ %indvars.iv.next106, %for.body141 ]
  %exitcond112.not = icmp eq i64 %indvars.iv105, %wide.trip.count111
  br i1 %exitcond112.not, label %for.cond132, label %for.body141, !llvm.loop !21

for.body141:                                      ; preds = %for.cond137
  %indvars.iv.next106 = add nuw nsw i64 %indvars.iv105, 1
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next114, i64 %indvars.iv.next106
  %19 = load i32, ptr %arrayidx147, align 4, !tbaa !5, !invariant.load !13
  %arrayidx151 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv113, i64 %indvars.iv105
...
for.cond164:                                      ; preds = %for.cond, %for.body166
  %20 = phi i32 [ %.pre133, %for.body166 ], [ %0, %for.cond ]
  %indvars.iv129 = phi i64 [ %indvars.iv.next130, %for.body166 ], [ 1, %for.cond ]
  %21 = sext i32 %20 to i64
  %cmp165.not = icmp sgt i64 %indvars.iv129, %21
  br i1 %cmp165.not, label %for.end173, label %for.body166

for.body166:                                      ; preds = %for.cond164
  %arrayidx168 = getelementptr inbounds nuw [101 x i32], ptr %sum, i64 0, i64 %indvars.iv129
