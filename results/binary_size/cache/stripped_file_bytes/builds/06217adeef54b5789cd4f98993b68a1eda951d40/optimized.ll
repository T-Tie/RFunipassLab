...
for.cond:                                         ; preds = %for.inc, %if.end
  %y.addr.0 = phi i32 [ %y, %if.end ], [ %inc, %for.inc ]
...
if.then3:                                         ; preds = %for.body
  ...
  tail call void @_Z6numberii(i32 noundef %div, i32 noundef %y.addr.0) #6
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then3
  %inc = add nsw i32 %y.addr.0, 1
...
for.inc:                                          ; preds = %for.cond
  ...
  call void @_Z6numberii(i32 noundef %1, i32 noundef %2) #8
