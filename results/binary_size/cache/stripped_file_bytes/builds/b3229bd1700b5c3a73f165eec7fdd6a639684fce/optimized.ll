...
for.cond:                                         ; preds = %for.body, %if.end
  ...
  br i1 %exitcond.not, label %for.cond22.preheader, label %for.body
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load i8, ptr %call4, align 8, !tbaa !14
  %cmp16 = icmp eq i8 %0, 101
  %inc = add nuw nsw i32 %i.0, 1
  br i1 %cmp16, label %if.then17, label %for.cond, !llvm.loop !15
...
if.then17:                                        ; preds = %for.body
  ...
  store ptr null, ptr %next19, align 8, !tbaa !13
  br label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond, %if.then17
  %p.1.ph = phi ptr [ %1, %if.then17 ], [ undef, %for.cond ]
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.body24
  %p.1 = phi ptr [ %5, %for.body24 ], [ %p.1.ph, %for.cond22.preheader ]
...
for.body24:                                       ; preds = %for.cond22
  ...
  %call36 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, ptr noundef nonnull %p.1, ptr noundef nonnull %name27, i32 noundef %conv30, i32 noundef %3, double noundef %conv33, ptr noundef nonnull %address34)
