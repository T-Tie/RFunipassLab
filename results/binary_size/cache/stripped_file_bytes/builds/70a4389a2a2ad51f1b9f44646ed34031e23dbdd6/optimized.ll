...
for.cond:                                         ; preds = %entry, %for.inc
  ...
  switch i8 %0, label %if.end80 [
    i8 0, label %for.cond52.preheader
...
for.cond52.preheader:                             ; preds = %for.cond
  %1 = load i8, ptr %a, align 16, !tbaa !5
  %cmp56.not16 = icmp eq i8 %1, 0
  br i1 %cmp56.not16, label %for.end70, label %for.body57
...
for.body57:                                       ; preds = %for.cond52.preheader, %for.body57
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body57 ], [ 0, %for.cond52.preheader ]
  %3 = phi i8 [ %5, %for.body57 ], [ %1, %for.cond52.preheader ]
  %j.017 = phi i32 [ %spec.select, %for.body57 ], [ 0, %for.cond52.preheader ]
  %arrayidx62 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv21
  %4 = load i8, ptr %arrayidx62, align 1, !tbaa !5
  %cmp64 = icmp eq i8 %3, %4
  %inc66 = zext i1 %cmp64 to i32
  %spec.select = add nuw nsw i32 %j.017, %inc66
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv.next22
  %5 = load i8, ptr %arrayidx54, align 1, !tbaa !5
  %cmp56.not = icmp eq i8 %5, 0
  br i1 %cmp56.not, label %for.end70.loopexit, label %for.body57, !llvm.loop !11

for.end70.loopexit:                               ; preds = %for.body57
  %6 = uitofp nneg i32 %spec.select to double
  br label %for.end70

for.end70:                                        ; preds = %for.end70.loopexit, %for.cond52.preheader
  %j.0.lcssa = phi double [ 0.000000e+00, %for.cond52.preheader ], [ %6, %for.end70.loopexit ]
  %conv72 = sitofp i32 %conv to double
  %div = fdiv double %j.0.lcssa, %conv72
  %7 = load double, ptr %s, align 8, !tbaa !12
  %cmp73 = fcmp ult double %div, %7
