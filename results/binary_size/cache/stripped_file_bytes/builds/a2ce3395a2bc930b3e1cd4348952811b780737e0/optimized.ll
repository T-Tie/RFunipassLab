...
while.cond:                                       ; preds = %if.end32, %entry
  %k.0 = phi i32 [ undef, %entry ], [ %k.219, %if.end32 ]
  %flag.0 = phi i32 [ 1, %entry ], [ %flag.120, %if.end32 ]
...
for.cond11:                                       ; preds = %for.end, %for.end27
  %indvars.iv28 = phi i64 [ 0, %for.end ], [ %indvars.iv.next29, %for.end27 ]
  %s.0 = phi i32 [ 0, %for.end ], [ %s.1, %for.end27 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end30, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv28
  br label %for.cond14
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  ...
  %exitcond27.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond27.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %2 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %arrayidx20 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
if.end32:                                         ; preds = %for.body, %for.end30
  %flag.120 = phi i32 [ %flag.0, %for.end30 ], [ 0, %for.body ]
  %k.219 = phi i32 [ %k.2, %for.end30 ], [ %1, %for.body ]
