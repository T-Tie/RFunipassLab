...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.end26 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc24 ], [ 0, %for.cond13 ]
  %4 = load i32, ptr %y2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp17 = icmp slt i64 %indvars.iv26, %5
  br i1 %cmp17, label %for.inc24, label %for.end26

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv29, i64 %indvars.iv26
...
for.cond33:                                       ; preds = %for.cond30, %if.end
  %j.2 = phi i32 [ %inc9.i4, %if.end ], [ 0, %for.cond30 ]
...
for.cond36.preheader:                             ; preds = %for.cond33
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %8, -1
  %cmp51 = icmp slt i32 %j.2, %sub
  br i1 %cmp51, label %if.then, label %if.end

if.then:                                          ; preds = %for.cond36.preheader
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.cond36.preheader
  %inc9.i4 = add nuw nsw i32 %j.2, 1
  br label %for.cond33
