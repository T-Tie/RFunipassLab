...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end ], [ 1, %entry ]
...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.end26 ], [ 1, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body18 ], [ 1, %for.cond13 ]
  %4 = load i32, ptr %y2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv18, %5
...
if.else:                                          ; preds = %for.cond36.preheader
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call63, ptr noundef nonnull dereferenceable(2) @.str)
  br label %if.end
