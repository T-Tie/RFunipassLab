...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc13
  %indvars.iv22 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next23, %for.inc13 ]
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond.not, label %for.end15, label %for.inc13
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc37
  %indvars.iv26 = phi i64 [ %4, %for.cond19.preheader ], [ %indvars.iv.next27, %for.inc37 ]
