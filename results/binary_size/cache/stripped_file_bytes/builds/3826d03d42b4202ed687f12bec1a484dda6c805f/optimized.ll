...
entry:
  ...
  %jishu17 = alloca i8, i32 0, align 16
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2004, ptr noundef nonnull %jishu17) #4
  call void @llvm.lifetime.start.p0(i64 noundef 2004, ptr noundef nonnull %sz) #4
  br label %for.cond
...
for.cond17:                                       ; preds = %for.cond12.preheader
  unreachable

for.end61:                                        ; preds = %for.cond12.preheader
  call void @llvm.lifetime.end.p0(i64 noundef 2004, ptr noundef nonnull %sz) #4
  call void @llvm.lifetime.end.p0(i64 noundef 2004, ptr noundef nonnull %jishu17) #4
