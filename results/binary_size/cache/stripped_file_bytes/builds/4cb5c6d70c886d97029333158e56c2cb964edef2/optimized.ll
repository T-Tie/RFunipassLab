...
for.end:                                          ; preds = %for.cond
  ...
  call void @_ZSt4sortIPiEvT_S1_(ptr noundef %vla, ptr noundef %add.ptr)
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond2
...
if.then:                                          ; preds = %for.body4
  ...
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %13)
  br label %if.end
...
for.end13:                                        ; preds = %if.end, %for.cond2
...
if.then21:                                        ; preds = %for.body16
  ...
  %21 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call22, i32 noundef %21)
  br label %if.end26

if.end26:                                         ; preds = %if.then21, %for.body16
  br label %for.inc27
...
for.end29:                                        ; preds = %for.cond14
  store i32 0, ptr %retval, align 4
  %23 = load ptr, ptr %saved_stack, align 8
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %__out.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.else:                                          ; preds = %entry
  %2 = load ptr, ptr %__out.addr, align 8, !tbaa !17, !nonnull !21, !align !22
...
if.end:                                           ; preds = %if.else, %if.then
  %5 = load ptr, ptr %__out.addr, align 8, !tbaa !17, !nonnull !21, !align !22
  ret ptr %5
}
...
entry:
  ...
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !14
  store ptr %__last, ptr %__last.addr, align 8, !tbaa !14
  store i64 %__depth_limit, ptr %__depth_limit.addr, align 8, !tbaa !25
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  %2 = load i64, ptr %__depth_limit.addr, align 8, !tbaa !25
...
if.end:                                           ; preds = %while.body
  %6 = load i64, ptr %__depth_limit.addr, align 8, !tbaa !25
  %dec = add nsw i64 %6, -1
  store i64 %dec, ptr %__depth_limit.addr, align 8, !tbaa !25
  call void @llvm.lifetime.start.p0(i64 8, ptr %__cut) #12
  ...
  %11 = load i64, ptr %__depth_limit.addr, align 8, !tbaa !25
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %__cut) #12
...
entry:
  ...
  %call = call noundef i32 @_ZSt11__bit_widthImEiT_(i64 noundef %0) #12
...
entry:
  ...
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !14
  store ptr %__last, ptr %__last.addr, align 8, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 8, ptr %__mid) #12
  %0 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %1 = load ptr, ptr %__last.addr, align 8, !tbaa !14
  %2 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %__mid) #12
  ret ptr %call
}
...
entry:
  ...
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !14
  store ptr %__last, ptr %__last.addr, align 8, !tbaa !14
  store ptr %__comp, ptr %__comp.addr, align 8, !tbaa !29
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %4 = load ptr, ptr %__last.addr, align 8, !tbaa !14
  %5 = load ptr, ptr %__last.addr, align 8, !tbaa !14
  %6 = load ptr, ptr %__comp.addr, align 8, !tbaa !29, !nonnull !21
...
if.end:                                           ; preds = %entry
  ...
  store i64 %sub.ptr.div4, ptr %__len, align 8, !tbaa !25
  call void @llvm.lifetime.start.p0(i64 8, ptr %__parent) #12
  %4 = load i64, ptr %__len, align 8, !tbaa !25
  %sub = sub nsw i64 %4, 2
  %div = sdiv i64 %sub, 2
  store i64 %div, ptr %__parent, align 8, !tbaa !25
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 4, ptr %__value) #12
  %5 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %6 = load i64, ptr %__parent, align 8, !tbaa !25
  ...
  %9 = load i64, ptr %__parent, align 8, !tbaa !25
  %10 = load i64, ptr %__len, align 8, !tbaa !25
  %11 = load i32, ptr %__value, align 4, !tbaa !5
  %12 = load ptr, ptr %__comp.addr, align 8, !tbaa !29, !nonnull !21
  ...
  %13 = load i64, ptr %__parent, align 8, !tbaa !25
...
if.end7:                                          ; preds = %while.body
  %14 = load i64, ptr %__parent, align 8, !tbaa !25
  %dec = add nsw i64 %14, -1
  store i64 %dec, ptr %__parent, align 8, !tbaa !25
  store i32 0, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end7, %if.then6
  call void @llvm.lifetime.end.p0(i64 4, ptr %__value) #12
...
entry:
  ...
  %9 = load ptr, ptr %__comp.addr, align 8, !tbaa !29, !nonnull !21
...
entry:
  ...
  %agg.tmp = alloca %"struct.__gnu_cxx::__ops::_Iter_less_iter", align 1
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !14
  store i64 %__holeIndex, ptr %__holeIndex.addr, align 8, !tbaa !25
  store i64 %__len, ptr %__len.addr, align 8, !tbaa !25
  store i32 %__value, ptr %__value.addr, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 8, ptr %__topIndex) #12
  %0 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  store i64 %0, ptr %__topIndex, align 8, !tbaa !25
  call void @llvm.lifetime.start.p0(i64 8, ptr %__secondChild) #12
  %1 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  store i64 %1, ptr %__secondChild, align 8, !tbaa !25
  br label %while.cond

while.cond:                                       ; preds = %if.end, %entry
  %2 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %3 = load i64, ptr %__len.addr, align 8, !tbaa !25
  %sub = sub nsw i64 %3, 1
  %div = sdiv i64 %sub, 2
...
while.body:                                       ; preds = %while.cond
  %4 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %add = add nsw i64 %4, 1
  %mul = mul nsw i64 2, %add
  store i64 %mul, ptr %__secondChild, align 8, !tbaa !25
  %5 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %6 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %add.ptr = getelementptr inbounds i32, ptr %5, i64 %6
  %7 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %8 = load i64, ptr %__secondChild, align 8, !tbaa !25
...
if.then:                                          ; preds = %while.body
  %9 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %dec = add nsw i64 %9, -1
  store i64 %dec, ptr %__secondChild, align 8, !tbaa !25
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %10 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %11 = load i64, ptr %__secondChild, align 8, !tbaa !25
  ...
  %14 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %add.ptr4 = getelementptr inbounds i32, ptr %13, i64 %14
  store i32 %12, ptr %add.ptr4, align 4, !tbaa !5
  %15 = load i64, ptr %__secondChild, align 8, !tbaa !25
  store i64 %15, ptr %__holeIndex.addr, align 8, !tbaa !25
  br label %while.cond, !llvm.loop !33

while.end:                                        ; preds = %while.cond
  %16 = load i64, ptr %__len.addr, align 8, !tbaa !25
  %and = and i64 %16, 1
  %cmp5 = icmp eq i64 %and, 0
  br i1 %cmp5, label %land.lhs.true, label %if.end16

land.lhs.true:                                    ; preds = %while.end
  %17 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %18 = load i64, ptr %__len.addr, align 8, !tbaa !25
...
if.then9:                                         ; preds = %land.lhs.true
  %19 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %add10 = add nsw i64 %19, 1
  %mul11 = mul nsw i64 2, %add10
  store i64 %mul11, ptr %__secondChild, align 8, !tbaa !25
  %20 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %21 = load i64, ptr %__secondChild, align 8, !tbaa !25
  ...
  %24 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %add.ptr14 = getelementptr inbounds i32, ptr %23, i64 %24
  store i32 %22, ptr %add.ptr14, align 4, !tbaa !5
  %25 = load i64, ptr %__secondChild, align 8, !tbaa !25
  %sub15 = sub nsw i64 %25, 1
  store i64 %sub15, ptr %__holeIndex.addr, align 8, !tbaa !25
  br label %if.end16

if.end16:                                         ; preds = %if.then9, %land.lhs.true, %while.end
  call void @llvm.lifetime.start.p0(i64 1, ptr %__cmp) #12
  ...
  %27 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %28 = load i64, ptr %__topIndex, align 8, !tbaa !25
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %__topIndex) #12
  ret void
}
...
entry:
  ...
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !14
  store i64 %__holeIndex, ptr %__holeIndex.addr, align 8, !tbaa !25
  store i64 %__topIndex, ptr %__topIndex.addr, align 8, !tbaa !25
  store i32 %__value, ptr %__value.addr, align 4, !tbaa !5
  store ptr %__comp, ptr %__comp.addr, align 8, !tbaa !34
  call void @llvm.lifetime.start.p0(i64 8, ptr %__parent) #12
  %0 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %sub = sub nsw i64 %0, 1
  %div = sdiv i64 %sub, 2
...
while.cond:                                       ; preds = %while.body, %entry
  %1 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %2 = load i64, ptr %__topIndex.addr, align 8, !tbaa !25
  %cmp = icmp sgt i64 %1, %2
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %while.cond
  %3 = load ptr, ptr %__comp.addr, align 8, !tbaa !34, !nonnull !21
  %4 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %5 = load i64, ptr %__parent, align 8, !tbaa !25
...
while.body:                                       ; preds = %land.end
  %7 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %8 = load i64, ptr %__parent, align 8, !tbaa !25
  %add.ptr1 = getelementptr inbounds i32, ptr %7, i64 %8
  %9 = load i32, ptr %add.ptr1, align 4, !tbaa !5
  %10 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %11 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %add.ptr2 = getelementptr inbounds i32, ptr %10, i64 %11
  store i32 %9, ptr %add.ptr2, align 4, !tbaa !5
  %12 = load i64, ptr %__parent, align 8, !tbaa !25
  store i64 %12, ptr %__holeIndex.addr, align 8, !tbaa !25
  %13 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
  %sub3 = sub nsw i64 %13, 1
  %div4 = sdiv i64 %sub3, 2
  store i64 %div4, ptr %__parent, align 8, !tbaa !25
  br label %while.cond, !llvm.loop !36

while.end:                                        ; preds = %land.end
  %14 = load i32, ptr %__value.addr, align 4, !tbaa !5
  %15 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %16 = load i64, ptr %__holeIndex.addr, align 8, !tbaa !25
...
entry:
  ...
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %2 = load ptr, ptr %__val.addr, align 8, !tbaa !14, !nonnull !21, !align !37
  %3 = load i32, ptr %2, align 4, !tbaa !5
  %cmp = icmp slt i32 %1, %3
  ret i1 %cmp
}
...
entry:
  ...
  %0 = load ptr, ptr %__a.addr, align 8, !tbaa !14
  %1 = load ptr, ptr %__b.addr, align 8, !tbaa !14
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1) #12
  ret void
}
...
entry:
  ...
  store ptr %__a, ptr %__a.addr, align 8, !tbaa !14
  store ptr %__b, ptr %__b.addr, align 8, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 4, ptr %__tmp) #12
  %0 = load ptr, ptr %__a.addr, align 8, !tbaa !14, !nonnull !21, !align !37
  %1 = load i32, ptr %0, align 4, !tbaa !5
  store i32 %1, ptr %__tmp, align 4, !tbaa !5
  %2 = load ptr, ptr %__b.addr, align 8, !tbaa !14, !nonnull !21, !align !37
  %3 = load i32, ptr %2, align 4, !tbaa !5
  %4 = load ptr, ptr %__a.addr, align 8, !tbaa !14, !nonnull !21, !align !37
  store i32 %3, ptr %4, align 4, !tbaa !5
  %5 = load i32, ptr %__tmp, align 4, !tbaa !5
  %6 = load ptr, ptr %__b.addr, align 8, !tbaa !14, !nonnull !21, !align !37
  store i32 %5, ptr %6, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 4, ptr %__tmp) #12
  ret void
}
...
entry:
  ...
  store i64 %__x, ptr %__x.addr, align 8, !tbaa !25
  call void @llvm.lifetime.start.p0(i64 4, ptr %_Nd) #12
  store i32 64, ptr %_Nd, align 4, !tbaa !5
  %0 = load i64, ptr %__x.addr, align 8, !tbaa !25
  %call = call noundef i32 @_ZSt13__countl_zeroImEiT_(i64 noundef %0) #12
  %sub = sub nsw i32 64, %call
  call void @llvm.lifetime.end.p0(i64 4, ptr %_Nd) #12
  ret i32 %sub
}
...
if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 4, ptr %_Nd_ull) #12
  store i32 64, ptr %_Nd_ull, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %_Nd_ul) #12
  store i32 64, ptr %_Nd_ul, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %_Nd_u) #12
  store i32 32, ptr %_Nd_u, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %__diff) #12
  store i32 0, ptr %__diff, align 4, !tbaa !5
  %1 = load i64, ptr %__x.addr, align 8, !tbaa !25
  %2 = call i64 @llvm.ctlz.i64(i64 %1, i1 true)
  %cast = trunc i64 %2 to i32
  %sub = sub nsw i32 %cast, 0
  store i32 %sub, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr %__diff) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %_Nd_u) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %_Nd_ul) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %_Nd_ull) #12
  br label %cleanup
...
if.then2:                                         ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 4, ptr %__val) #12
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %__next) #12
  %2 = load ptr, ptr %__last.addr, align 8, !tbaa !14
...
if.then:                                          ; preds = %entry
  ...
  %4 = load i64, ptr %_Num, align 8, !tbaa !25
  %idx.neg = sub i64 0, %4
  %add.ptr = getelementptr inbounds i32, ptr %3, i64 %idx.neg
  %5 = load ptr, ptr %__first.addr, align 8, !tbaa !14
  %6 = load i64, ptr %_Num, align 8, !tbaa !25
  %mul = mul i64 4, %6
...
if.end4:                                          ; preds = %if.end, %if.then
  %10 = load ptr, ptr %__result.addr, align 8, !tbaa !14
  %11 = load i64, ptr %_Num, align 8, !tbaa !25
...
entry:
  ...
  store ptr %__it, ptr %__it.addr, align 8, !tbaa !14
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = load ptr, ptr %__val.addr, align 8, !tbaa !14, !nonnull !21, !align !37
  %1 = load i32, ptr %0, align 4, !tbaa !5
...
!29 = !{!30, !30, i64 0}
!30 = !{!"p1 _ZTSN9__gnu_cxx5__ops15_Iter_less_iterE", !16, i64 0}
!31 = distinct !{!31, !10, !11}
!32 = distinct !{!32, !10, !11}
!33 = distinct !{!33, !10, !11}
!34 = !{!35, !35, i64 0}
!35 = !{!"p1 _ZTSN9__gnu_cxx5__ops14_Iter_less_valE", !16, i64 0}
...
!47 = !{!48, !48, i64 0}
!48 = !{!"p1 _ZTSN9__gnu_cxx5__ops14_Val_less_iterE", !16, i64 0}
!49 = !{!50, !50, i64 0}
!50 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !16, i64 0}
!51 = !{!52, !52, i64 0}
!52 = !{!"_ZTSSt12_Ios_Iostate", !7, i64 0}
!53 = !{!54, !52, i64 32}
!54 = !{!"_ZTSSt8ios_base", !26, i64 8, !26, i64 16, !55, i64 24, !52, i64 28, !52, i64 32, !56, i64 40, !57, i64 48, !7, i64 64, !6, i64 192, !58, i64 200, !59, i64 208}
!55 = !{!"_ZTSSt13_Ios_Fmtflags", !7, i64 0}
!56 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !16, i64 0}
!57 = !{!"_ZTSNSt8ios_base6_WordsE", !16, i64 0, !26, i64 8}
