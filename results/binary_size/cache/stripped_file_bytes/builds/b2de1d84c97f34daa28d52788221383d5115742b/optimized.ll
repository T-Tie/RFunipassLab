...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv6 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next7, %for.inc33 ]
  %exitcond11.not = icmp eq i64 %indvars.iv6, %wide.trip.count10
  br i1 %exitcond11.not, label %for.cond37, label %for.body6

for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [27 x i32], ptr @f, i64 0, i64 %indvars.iv6
  %arrayidx16 = getelementptr inbounds nuw [27 x i32], ptr @a, i64 0, i64 %indvars.iv6
  br label %for.cond9

for.cond9:                                        ; preds = %for.inc27, %for.body6
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc27 ], [ 0, %for.body6 ]
  %exitcond.not = icmp eq i64 %indvars.iv3, %indvars.iv6
  br i1 %exitcond.not, label %for.inc33, label %for.body12

for.body12:                                       ; preds = %for.cond9
  %arrayidx14 = getelementptr inbounds nuw [27 x i32], ptr @a, i64 0, i64 %indvars.iv3
...
land.lhs.true:                                    ; preds = %for.body12
  %arrayidx19 = getelementptr inbounds nuw [27 x i32], ptr @f, i64 0, i64 %indvars.iv3
...
for.cond37:                                       ; preds = %for.cond3, %for.body40
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body40 ], [ 0, %for.cond3 ]
  %max.0 = phi i32 [ %spec.select, %for.body40 ], [ 0, %for.cond3 ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, %wide.trip.count10
  br i1 %exitcond15.not, label %for.end50, label %for.body40

for.body40:                                       ; preds = %for.cond37
  %arrayidx42 = getelementptr inbounds nuw [27 x i32], ptr @f, i64 0, i64 %indvars.iv12
