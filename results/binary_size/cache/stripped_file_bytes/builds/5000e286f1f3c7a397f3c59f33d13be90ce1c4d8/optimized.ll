...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv31 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next32, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %3 = add nuw i32 %smax43, 1
  %wide.trip.count44 = zext i32 %3 to i64
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %s, i64 0, i64 %indvars.iv31
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc46
  %indvars.iv38 = phi i64 [ 1, %for.cond16.preheader ], [ %indvars.iv.next39, %for.inc46 ]
  %exitcond45 = icmp eq i64 %indvars.iv38, %wide.trip.count44
  br i1 %exitcond45, label %for.end48, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %6 = sub nsw i64 %2, %indvars.iv38
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc43
  %indvars.iv35 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next36, %for.inc43 ]
  %m.0 = phi i32 [ 0, %for.cond19.preheader ], [ %spec.select, %for.inc43 ]
  %cmp20.not = icmp sgt i64 %indvars.iv35, %6
  br i1 %cmp20.not, label %for.inc46, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv35
...
if.else:                                          ; preds = %for.end48
  %smax50 = call i32 @llvm.smax.i32(i32 %z.0, i32 1)
  %wide.trip.count51 = zext nneg i32 %smax50 to i64
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.else
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body57 ], [ 1, %if.else ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count51
  br i1 %exitcond52.not, label %if.end64, label %for.body57

for.body57:                                       ; preds = %for.cond55
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv46
