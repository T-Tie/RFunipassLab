...
define dso_local noundef i32 @_Z2ffiii(i32 noundef %pos, i32 noundef %highflag, i32 noundef %count) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr @k, align 4, !tbaa !5
  %add5 = add nsw i32 %count, 1
  %sext = sext i32 %0 to i64
  br label %tailrecurse.outer

tailrecurse.outer:                                ; preds = %if.then2, %entry
  %accumulator.tr.ph = phi i32 [ %call.call7, %if.then2 ], [ -2147483648, %entry ]
  %pos.tr.ph = phi i32 [ %add, %if.then2 ], [ %pos, %entry ]
  %1 = sext i32 %pos.tr.ph to i64
  br label %tailrecurse

tailrecurse:                                      ; preds = %tailrecurse.outer, %if.else11
  %indvars.iv = phi i64 [ %1, %tailrecurse.outer ], [ %indvars.iv.next, %if.else11 ]
  %2 = icmp eq i64 %indvars.iv, %sext
  br i1 %2, label %return, label %if.end

if.end:                                           ; preds = %tailrecurse
  %arrayidx = getelementptr inbounds [30 x i32], ptr @high, i64 0, i64 %indvars.iv
  %3 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %cmp1.not = icmp sgt i32 %3, %highflag
  br i1 %cmp1.not, label %if.else11, label %if.then2

if.then2:                                         ; preds = %if.end
  %4 = trunc nsw i64 %indvars.iv to i32
  %add = add nsw i32 %4, 1
  %call = tail call noundef i32 @_Z2ffiii(i32 noundef %add, i32 noundef %3, i32 noundef %add5)
  %call.call7 = tail call i32 @llvm.smax.i32(i32 %call, i32 %accumulator.tr.ph)
  br label %tailrecurse.outer
...
return:                                           ; preds = %tailrecurse
  %accumulator.ret.tr = tail call i32 @llvm.smax.i32(i32 %count, i32 %accumulator.tr.ph)
...
for.end:                                          ; preds = %for.cond
  %call2 = tail call noundef i32 @_Z2ffiii(i32 noundef 0, i32 noundef 99999, i32 noundef 0)
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call3, i8 noundef signext %call.i3)
