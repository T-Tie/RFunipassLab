...
for.cond:                                         ; preds = %if.end56, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end56 ]
...
if.then23:                                        ; preds = %if.end
  %call29 = call double @sqrt(double noundef %.pre-phi16) #6, !tbaa !5
...
if.end34:                                         ; preds = %if.then23, %if.end
  %mul36.pre-phi = phi double [ %.pre17, %if.then23 ], [ %mul19.pre-phi, %if.end ]
