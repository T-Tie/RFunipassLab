...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 64, ptr noundef nonnull align 16 %sz) #4
  br label %for.cond

for.cond:                                         ; preds = %if.end30, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc9.i5, %if.end30 ]
...
for.cond10.preheader:                             ; preds = %for.cond3
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 0)
  br label %if.end30
...
if.end30:                                         ; preds = %for.cond10.preheader, %for.cond
  %i.1 = phi i32 [ -1, %for.cond10.preheader ], [ %i.0, %for.cond ]
  %cmp33 = icmp eq i32 %0, -1
  %inc9.i5 = add nsw i32 %i.1, 1
  br i1 %cmp33, label %for.end38, label %for.cond

for.end38:                                        ; preds = %if.end30
  call void @llvm.lifetime.end.p0(i64 noundef 64, ptr noundef nonnull %sz) #5
  ret i32 0
}
