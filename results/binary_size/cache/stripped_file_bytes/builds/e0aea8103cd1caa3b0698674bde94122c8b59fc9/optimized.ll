...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv31
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv38 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next39, %for.inc44 ]
  %i.3 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond44.not = icmp eq i32 %i.3, %smax43
  br i1 %exitcond44.not, label %for.end46, label %for.cond19.preheader
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv35 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next36, %for.inc41 ]
  %exitcond42.not = icmp eq i64 %indvars.iv35, %wide.trip.count41
  br i1 %exitcond42.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv35
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next36
...
for.end46:                                        ; preds = %for.cond16
  ...
  %smax49 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 1)
  %wide.trip.count50 = zext nneg i32 %smax49 to i64
  br label %for.cond49

for.cond49:                                       ; preds = %for.inc56, %for.end46
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc56 ], [ 1, %for.end46 ]
  %exitcond51.not = icmp eq i64 %indvars.iv45, %wide.trip.count50
  br i1 %exitcond51.not, label %for.end58, label %for.inc56
...
for.inc56:                                        ; preds = %for.cond49
  ...
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv45
