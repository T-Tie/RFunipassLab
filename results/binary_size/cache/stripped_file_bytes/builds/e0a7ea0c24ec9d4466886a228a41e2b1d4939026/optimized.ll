...
if.end:                                           ; preds = %while.body
  ...
  %call.i = tail call noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull %__last.addr.0, ptr noundef nonnull align 4 %__first) #12
...
while.body:                                       ; preds = %while.body, %if.end
  ...
  br i1 %cmp5, label %return, label %while.body, !llvm.loop !15
...
while.cond1:                                      ; preds = %while.cond1, %while.body
  ...
  br i1 %cmp.i, label %while.cond1, label %while.cond4.preheader, !llvm.loop !17
...
while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  ...
  br i1 %cmp.i1, label %while.cond4, label %while.end8, !llvm.loop !18
