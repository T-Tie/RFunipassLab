...
do.body:                                          ; preds = %do.body, %while.body
  ...
  br i1 %cmp3.not, label %for.cond5.preheader, label %do.body, !llvm.loop !9

for.cond5.preheader:                              ; preds = %do.body, %for.cond.cleanup7
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond.cleanup7 ], [ 0, %do.body ]
  %m.010 = phi i32 [ %m.2, %for.cond.cleanup7 ], [ 0, %do.body ]
  %arrayidx12 = getelementptr inbounds nuw [15 x i32], ptr %s, i64 0, i64 %indvars.iv17
  %3 = load i32, ptr %arrayidx12, align 4, !tbaa !5
  %mul = shl nsw i32 %3, 1
  %cmp16.not = icmp ne i32 %3, 0
  br label %for.body8

for.cond.cleanup:                                 ; preds = %for.cond.cleanup7
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %m.2)
  ...
  %4 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !14
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call22, i8 noundef signext %retval.0.i.i.i)
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %exitcond20.not = icmp eq i64 %indvars.iv.next18, 15
  br i1 %exitcond20.not, label %for.cond.cleanup, label %for.cond5.preheader, !llvm.loop !40

for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  %indvars.iv14 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next15, %for.body8 ]
  %m.18 = phi i32 [ %m.010, %for.cond5.preheader ], [ %m.2, %for.body8 ]
  %arrayidx10 = getelementptr inbounds nuw [15 x i32], ptr %s, i64 0, i64 %indvars.iv14
  ...
  %m.2 = add nsw i32 %m.18, %inc17
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next15, 15
  br i1 %exitcond.not, label %for.cond.cleanup7, label %for.body8, !llvm.loop !41
