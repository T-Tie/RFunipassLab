...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %a) #7
  call void @llvm.lifetime.start.p0(i64 400, ptr %result) #7
  ...
  %arraydecay1 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %arraydecay1, i8 0, i64 400, i1 false)
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx7 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 %idxprom6
...
for.cond8:                                        ; preds = %for.inc23, %for.end
  ...
  %cmp9 = icmp slt i32 %7, 100
  br i1 %cmp9, label %for.body10, label %for.end25

for.body10:                                       ; preds = %for.cond8
  %8 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom11 = sext i32 %8 to i64
  %arrayidx12 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 %idxprom11
...
if.then:                                          ; preds = %for.body10
  ...
  %arrayidx17 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 %idxprom16
  %13 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %add18 = add nsw i32 %13, %div
  store i32 %add18, ptr %arrayidx17, align 4, !tbaa !5
  %14 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom19 = sext i32 %14 to i64
  %arrayidx20 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 %idxprom19
  %15 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %rem = srem i32 %15, 10
  %16 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom21 = sext i32 %16 to i64
  %arrayidx22 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 %idxprom21
...
for.cond26:                                       ; preds = %for.inc33, %for.end25
  ...
  %cmp27 = icmp slt i32 %18, 100
  br i1 %cmp27, label %for.body28, label %for.end35

for.body28:                                       ; preds = %for.cond26
  %19 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom29 = sext i32 %19 to i64
  %arrayidx30 = getelementptr inbounds [100 x i32], ptr %result, i64 0, i64 %idxprom29
  ...
  store i32 %20, ptr %arrayidx32, align 4, !tbaa !5
  br label %for.inc33
...
for.cond42:                                       ; preds = %for.inc48, %while.end
...
for.body44:                                       ; preds = %for.cond42
  ...
  %arrayidx46 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom45
  %29 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %call47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %29)
  br label %for.inc48

for.inc48:                                        ; preds = %for.body44
  %30 = load i32, ptr %j, align 4, !tbaa !5
  %dec49 = add nsw i32 %30, -1
  store i32 %dec49, ptr %j, align 4, !tbaa !5
  br label %for.cond42, !llvm.loop !16

for.end50:                                        ; preds = %for.cond42
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  call void @llvm.lifetime.end.p0(i64 400, ptr %result) #7
  call void @llvm.lifetime.end.p0(i64 400, ptr %a) #7
