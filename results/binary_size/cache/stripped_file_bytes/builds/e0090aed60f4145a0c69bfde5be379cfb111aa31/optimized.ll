...
for.cond1:                                        ; preds = %for.cond, %for.inc11
  ...
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc11 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv82, %2
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv82
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc176
  %indvars.iv139 = phi i64 [ %6, %for.cond14.preheader ], [ %indvars.iv.next140, %for.inc176 ]
  %indvars.iv136 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next137, %for.inc176 ]
  %sum.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.inc176 ]
  %min.1 = phi i32 [ %min.0, %for.cond14.preheader ], [ %min.5, %for.inc176 ]
  %9 = trunc nuw i64 %indvars.iv139 to i32
  %cmp15 = icmp sgt i32 %9, 1
  br i1 %cmp15, label %for.cond17, label %for.inc180

for.cond17:                                       ; preds = %for.cond14, %for.inc61
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc61 ], [ 0, %for.cond14 ]
  %min.2 = phi i32 [ %min.3, %for.inc61 ], [ %min.1, %for.cond14 ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %indvars.iv139
  br i1 %exitcond97.not, label %for.cond64, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond17
  %add.ptr30 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv93
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc42
  %indvars.iv85 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next86, %for.inc42 ]
  %min.3 = phi i32 [ %min.2, %for.cond20.preheader ], [ %min.4, %for.inc42 ]
  %exitcond.not = icmp eq i64 %indvars.iv85, %indvars.iv139
...
for.body22:                                       ; preds = %for.cond20
  %cmp23 = icmp eq i64 %indvars.iv85, 0
...
if.else:                                          ; preds = %for.body22
  %add.ptr33 = getelementptr inbounds nuw i32, ptr %add.ptr30, i64 %indvars.iv85
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc58
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc58 ], [ 0, %for.cond45.preheader ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %indvars.iv139
  br i1 %exitcond92.not, label %for.inc61, label %for.inc58

for.inc58:                                        ; preds = %for.cond45
  %add.ptr52 = getelementptr inbounds nuw i32, ptr %add.ptr30, i64 %indvars.iv88
...
if.else77:                                        ; preds = %for.body69
  %gep = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv98
  %14 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select74 = call i32 @llvm.smin.i32(i32 %14, i32 %min.6)
  br label %for.inc92

for.inc92:                                        ; preds = %if.else77, %if.then71
  %min.7 = phi i32 [ %13, %if.then71 ], [ %spec.select74, %if.else77 ]
  %indvars.iv.next99 = add nuw nsw i64 %indvars.iv98, 1
  br label %for.cond67, !llvm.loop !17

for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc109
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %for.inc109 ], [ 0, %for.cond95.preheader ]
  %exitcond107.not = icmp eq i64 %indvars.iv103, %indvars.iv139
  br i1 %exitcond107.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond95
  %gep78 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv103
  %15 = load i32, ptr %gep78, align 4, !tbaa !5, !invariant.load !13
  %sub103 = sub nsw i32 %15, %min.6
  store i32 %sub103, ptr %gep78, align 4, !tbaa !5
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc131
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc131 ], [ 1, %for.cond118.preheader ]
  %exitcond120.not = icmp eq i64 %indvars.iv113, %indvars.iv136
  br i1 %exitcond120.not, label %for.cond134, label %for.inc131

for.inc131:                                       ; preds = %for.cond118
  %add.ptr125 = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv113
...
for.cond134:                                      ; preds = %for.cond118, %for.inc147
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %for.inc147 ], [ 1, %for.cond118 ]
  %exitcond125.not = icmp eq i64 %indvars.iv121, %indvars.iv136
  br i1 %exitcond125.not, label %for.cond150, label %for.inc147

for.inc147:                                       ; preds = %for.cond134
  %add.ptr139 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv121
...
for.cond150:                                      ; preds = %for.cond134, %for.inc173
  %indvars.iv131 = phi i64 [ %indvars.iv.next132, %for.inc173 ], [ 1, %for.cond134 ]
  %exitcond135.not = icmp eq i64 %indvars.iv131, %indvars.iv136
  br i1 %exitcond135.not, label %for.inc176, label %for.cond154.preheader

for.cond154.preheader:                            ; preds = %for.cond150
  %add.ptr159 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv131
  %invariant.gep79 = getelementptr inbounds nuw i8, ptr %add.ptr159, i64 404
  br label %for.cond154

for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc170
  %indvars.iv126 = phi i64 [ 1, %for.cond154.preheader ], [ %indvars.iv.next127, %for.inc170 ]
  %exitcond130.not = icmp eq i64 %indvars.iv126, %indvars.iv136
  br i1 %exitcond130.not, label %for.inc173, label %for.inc170

for.inc170:                                       ; preds = %for.cond154
  %gep80 = getelementptr inbounds nuw i32, ptr %invariant.gep79, i64 %indvars.iv126
  %18 = load i32, ptr %gep80, align 4, !tbaa !5, !invariant.load !13
  %add.ptr169 = getelementptr inbounds nuw i32, ptr %add.ptr159, i64 %indvars.iv126
