...
for.cond:                                         ; preds = %entry, %if.end16
  %2 = phi i8 [ %.pre32, %if.end16 ], [ undef, %entry ]
  %3 = phi i8 [ %.pre31, %if.end16 ], [ %0, %entry ]
...
if.end16:                                         ; preds = %for.cond, %if.then
  ...
  %.pre31 = load i8, ptr %arrayidx9.phi.trans.insert, align 1, !tbaa !5, !invariant.load !8
  ...
  %.pre32 = load i8, ptr %arrayidx12.phi.trans.insert, align 1, !tbaa !5, !invariant.load !8
  br label %for.cond

for.end.split:                                    ; preds = %if.then, %entry
  %indvars.iv18.lcssa.split = phi i64 [ 2, %entry ], [ %indvars.iv18, %if.then ]
...
for.cond40:                                       ; preds = %for.body45, %for.end36
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body45 ], [ %indvars.iv18.lcssa.split, %for.end36 ]
