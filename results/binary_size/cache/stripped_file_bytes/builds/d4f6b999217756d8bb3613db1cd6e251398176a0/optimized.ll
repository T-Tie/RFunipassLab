...
for.cond10:                                       ; preds = %for.inc35, %if.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc35 ], [ 3, %if.end ]
  %5 = phi i32 [ %8, %for.inc35 ], [ %3, %if.end ]
  %6 = phi i32 [ %9, %for.inc35 ], [ %arrayidx2.promoted, %if.end ]
  %exitcond = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond, label %for.end37, label %for.body12

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv12
...
for.inc35.sink.split:                             ; preds = %if.else23, %if.then17
  ...
  %.ph19 = phi i32 [ %7, %if.then17 ], [ %6, %if.else23 ]
  store i32 %.sink, ptr %arrayidx3, align 8, !tbaa !5
  br label %for.inc35

for.inc35:                                        ; preds = %for.inc35.sink.split, %if.else23
  %8 = phi i32 [ %5, %if.else23 ], [ %.sink, %for.inc35.sink.split ]
  %9 = phi i32 [ %6, %if.else23 ], [ %.ph19, %for.inc35.sink.split ]
