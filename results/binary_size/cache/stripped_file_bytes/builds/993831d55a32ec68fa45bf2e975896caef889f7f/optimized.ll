...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.end34
  %indvars.iv9 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next10, %for.end34 ]
...
for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv9
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %if.end31
  %indvars.iv11 = phi i64 [ %indvars.iv9, %for.cond14.preheader ], [ %indvars.iv.next12, %if.end31 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv.next12
...
for.cond38:                                       ; preds = %for.cond11, %for.body41
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body41 ], [ 0, %for.cond11 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.end48, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv15
