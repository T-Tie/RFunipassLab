...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %t.1 = phi i32 [ %t.2, %for.inc ], [ %t.0, %entry ]
...
for.cond30:                                       ; preds = %for.cond, %for.inc56
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc56 ], [ 0, %for.cond ]
  %t.3 = phi i32 [ %t.4, %for.inc56 ], [ %t.1, %for.cond ]
...
for.body33:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [501 x i8], ptr %b, i64 0, i64 %indvars.iv25
...
for.cond62:                                       ; preds = %for.end58, %for.body65
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body65 ], [ 0, %for.end58 ]
...
for.body65:                                       ; preds = %for.cond62
  %arrayidx67 = getelementptr inbounds nuw [501 x i8], ptr %a, i64 0, i64 %indvars.iv28
  %5 = load i8, ptr %arrayidx67, align 1, !tbaa !5
  %arrayidx70 = getelementptr inbounds nuw [501 x i8], ptr %b, i64 0, i64 %indvars.iv28
  %6 = load i8, ptr %arrayidx70, align 1, !tbaa !5
