...
if.then:                                          ; preds = %while.body
  ...
  %fneg5 = fneg double %5
  %call6 = call double @sqrt(double noundef %fneg5) #6, !tbaa !5
  %div7 = fmul double %call6, 5.000000e-01
  %div8 = fdiv double %div7, %2
  %call9 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div4, double noundef %div8, double noundef %div4, double noundef %div8)
  br label %while.cond.backedge

if.else:                                          ; preds = %while.body
  %cmp10 = fcmp oeq double %5, 0.000000e+00
  %div13 = fmul double %1, -5.000000e-01
  %div14 = fdiv double %div13, %2
  br i1 %cmp10, label %if.then11, label %if.else16

if.then11:                                        ; preds = %if.else
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div14)
  br label %while.cond.backedge

while.cond.backedge:                              ; preds = %if.then11, %if.else16, %if.then
  br label %while.cond, !llvm.loop !11

if.else16:                                        ; preds = %if.else
  %call20 = call double @sqrt(double noundef %5) #6, !tbaa !5
  %div21 = fmul double %call20, 5.000000e-01
  %div22 = fdiv double %div21, %2
  %add = fadd double %div14, %div22
  %sub = fsub double %div14, %div22
  %call23 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %add, double noundef %sub)
  br label %while.cond.backedge
