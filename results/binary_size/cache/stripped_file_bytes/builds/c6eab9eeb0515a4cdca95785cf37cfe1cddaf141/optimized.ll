...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  ...
  %cmp17 = icmp slt i64 %indvars.iv35, %10
...
for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv50, i64 %indvars.iv44
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.body38
  %indvars.iv41 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next42, %for.body38 ]
  %exitcond.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond.not, label %for.inc54, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv41
  %11 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv41, i64 %indvars.iv44
...
for.cond60:                                       ; preds = %for.cond30, %for.end78
  %14 = phi i32 [ %.pre, %for.end78 ], [ %6, %for.cond30 ]
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.end78 ], [ 0, %for.cond30 ]
  %15 = sext i32 %14 to i64
  %cmp61 = icmp slt i64 %indvars.iv59, %15
  br i1 %cmp61, label %for.body62, label %for.end82

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv59
  %16 = load i32, ptr %arrayidx64, align 16, !tbaa !5
  %call66 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %16)
  br label %for.cond67

for.cond67:                                       ; preds = %for.body69, %for.body62
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body69 ], [ 1, %for.body62 ]
  %17 = load i32, ptr %y2, align 4, !tbaa !5
  %18 = sext i32 %17 to i64
  %cmp68 = icmp slt i64 %indvars.iv56, %18
...
for.body69:                                       ; preds = %for.cond67
  ...
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv59, i64 %indvars.iv56
  %19 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %call75 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %19)
