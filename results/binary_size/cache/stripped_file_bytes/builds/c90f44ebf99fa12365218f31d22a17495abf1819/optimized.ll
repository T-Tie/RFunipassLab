...
while.cond:                                       ; preds = %if.end33, %entry
  %h.0 = phi i32 [ undef, %entry ], [ %h.118, %if.end33 ]
  %flag.0 = phi i32 [ 1, %entry ], [ %flag.119, %if.end33 ]
...
for.cond12:                                       ; preds = %for.end, %for.inc29
  %indvars.iv25 = phi i64 [ 0, %for.end ], [ %indvars.iv.next26, %for.inc29 ]
  %t.2 = phi i32 [ 0, %for.end ], [ %t.3, %for.inc29 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.end31, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond12
  %arrayidx19 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv25
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv21 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next22, %for.body17 ]
  %t.3 = phi i32 [ %t.2, %for.cond15.preheader ], [ %spec.select, %for.body17 ]
  %exitcond24.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond24.not, label %for.inc29, label %for.body17

for.body17:                                       ; preds = %for.cond15
  %2 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !9
  %arrayidx21 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv21
...
if.end33:                                         ; preds = %for.body, %for.end31
  %flag.119 = phi i32 [ %flag.0, %for.end31 ], [ 0, %for.body ]
  %h.118 = phi i32 [ %h.1, %for.end31 ], [ %h.0, %for.body ]
