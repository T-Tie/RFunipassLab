...
if.then.i.i:                                      ; preds = %for.end15
  ...
  %4 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %idx.ext, i1 true)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end15, %if.then.i.i
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.body19, %_ZSt4sortIPiEvT_S1_.exit
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body19 ], [ 0, %_ZSt4sortIPiEvT_S1_.exit ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end25, label %for.body19
...
for.body19:                                       ; preds = %for.cond17
  ...
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5)
