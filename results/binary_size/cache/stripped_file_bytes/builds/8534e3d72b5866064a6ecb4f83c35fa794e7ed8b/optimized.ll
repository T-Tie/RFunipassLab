...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv33, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  ...
  %8 = sext i32 %7 to i64
  %cmp17 = icmp slt i64 %indvars.iv36, %8
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv39, i64 %indvars.iv36
...
for.cond64:                                       ; preds = %for.cond30.preheader, %for.inc86
  %9 = phi i32 [ %12, %for.inc86 ], [ %6, %for.cond30.preheader ]
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc86 ], [ 0, %for.cond30.preheader ]
  %10 = load i32, ptr %x1, align 4, !tbaa !5
  %11 = sext i32 %10 to i64
  %cmp65 = icmp slt i64 %indvars.iv60, %11
  br i1 %cmp65, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond64, %for.inc83
  %12 = phi i32 [ %.pre63, %for.inc83 ], [ %9, %for.cond64 ]
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc83 ], [ 0, %for.cond64 ]
  %13 = sext i32 %12 to i64
  %cmp68 = icmp slt i64 %indvars.iv57, %13
  br i1 %cmp68, label %for.body69, label %for.inc86

for.body69:                                       ; preds = %for.cond67
  %sub = add nsw i32 %12, -1
  %14 = zext i32 %sub to i64
  %cmp70 = icmp eq i64 %indvars.iv57, %14
