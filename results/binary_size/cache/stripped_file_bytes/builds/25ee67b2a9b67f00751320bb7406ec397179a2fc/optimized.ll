...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv38 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next39, %for.inc27 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %2
  br i1 %exitcond43.not, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc21 ], [ 0, %for.cond10 ]
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.129 = phi i32 [ %6, %for.end29.loopexit ], [ %smax, %for.cond10 ]
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc44
  %sub.sink8 = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.cond34.preheader ]
  %cmp35 = icmp sgt i32 %sub.sink8, -1
  br i1 %cmp35, label %for.body36, label %for.inc49

for.body36:                                       ; preds = %for.cond34
  %idxprom39 = zext nneg i32 %sub.sink8 to i64
...
for.end51:                                        ; preds = %for.cond30, %for.body36
  %sub.sink26 = phi i32 [ %sub.sink, %for.body36 ], [ %smin, %for.cond30 ]
  %j2.0 = phi i32 [ %sub.sink8, %for.body36 ], [ undef, %for.cond30 ]
  %10 = xor i32 %i.129, -1
  %sub53 = add i32 %sub.sink26, %10
