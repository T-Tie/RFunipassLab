...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv31 = phi i64 [ %7, %for.cond22.preheader ], [ %indvars.iv.next32, %for.inc28 ]
...
for.cond35:                                       ; preds = %for.inc55, %for.end33
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc55 ], [ %12, %for.end33 ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc55 ], [ %11, %for.end33 ]
  %j.2 = phi i32 [ %j.3, %for.inc55 ], [ %j.1, %for.end33 ]
...
for.cond45:                                       ; preds = %for.inc51, %if.then42
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc51 ], [ %indvars.iv34, %if.then42 ]
  %indvars.iv.next37 = add nsw i64 %indvars.iv36, 1
  %cmp46 = icmp slt i64 %indvars.iv.next37, %14
  br i1 %cmp46, label %for.inc51, label %for.inc55.loopexit
...
for.cond74:                                       ; preds = %for.end10, %for.inc80
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc80 ], [ 0, %for.end10 ]
  %exitcond49 = icmp eq i64 %indvars.iv45, %wide.trip.count
  br i1 %exitcond49, label %if.end83, label %for.inc80
