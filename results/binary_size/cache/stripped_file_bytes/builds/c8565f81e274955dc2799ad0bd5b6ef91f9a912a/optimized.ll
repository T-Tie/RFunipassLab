...
for.cond.preheader:                               ; preds = %entry
  %cmp19 = icmp sgt i32 %a, 1
  br i1 %cmp19, label %for.body, label %cleanup

for.body:                                         ; preds = %for.cond.preheader, %for.inc
  %i.012 = phi i32 [ %dec, %for.inc ], [ %a, %for.cond.preheader ]
  %t.011 = phi i32 [ %t.1, %for.inc ], [ 0, %for.cond.preheader ]
  %s.010 = phi i32 [ %s.1, %for.inc ], [ 0, %for.cond.preheader ]
  %rem = srem i32 %n, %i.012
  %div = sdiv i32 %n, %i.012
  %cmp2 = icmp eq i32 %rem, 0
  br i1 %cmp2, label %if.then3, label %for.inc

if.then3:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z6divideii(i32 noundef %div, i32 noundef %i.012)
  %add = add nsw i32 %call, %s.010
  %inc = add nsw i32 %t.011, 1
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then3
  %s.1 = phi i32 [ %add, %if.then3 ], [ %s.010, %for.body ]
  %t.1 = phi i32 [ %inc, %if.then3 ], [ %t.011, %for.body ]
  %dec = add nsw i32 %i.012, -1
  %cmp1 = icmp sgt i32 %i.012, 2
  br i1 %cmp1, label %for.body, label %for.end.loopexit, !llvm.loop !5

for.end.loopexit:                                 ; preds = %for.inc
  %0 = icmp eq i32 %t.1, 0
  %1 = select i1 %0, i32 0, i32 %s.1
  br label %cleanup

cleanup:                                          ; preds = %for.cond.preheader, %for.end.loopexit, %entry
  %retval.0 = phi i32 [ 1, %entry ], [ 0, %for.cond.preheader ], [ %1, %for.end.loopexit ]
  ret i32 %retval.0
}
...
while.body:                                       ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  %call2 = call noundef i32 @_Z6divideii(i32 noundef %0, i32 noundef %0)
  ...
  %1 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !14
