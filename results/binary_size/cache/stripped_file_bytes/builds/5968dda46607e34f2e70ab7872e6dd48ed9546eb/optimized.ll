...
entry:
  ...
  %c = alloca i8, align 1
  call void @llvm.lifetime.start.p0(i64 11000, ptr nonnull %str) #6
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %lon) #6
...
if.end:                                           ; preds = %if.then, %do.body
  ...
  %spec.select = add nuw nsw i32 %n.0, %inc12
  %cmp15.not = icmp eq i8 %0, 10
  br i1 %cmp15.not, label %for.cond, label %do.body, !llvm.loop !10

for.cond:                                         ; preds = %if.end, %for.inc33
  %i.0 = phi i32 [ %dec, %for.inc33 ], [ %spec.select, %if.end ]
  %cmp16 = icmp sgt i32 %i.0, -1
  br i1 %cmp16, label %for.cond17.preheader, label %for.end34

for.cond17.preheader:                             ; preds = %for.cond
  %idxprom18 = zext nneg i32 %i.0 to i64
...
for.cond17:                                       ; preds = %for.cond17.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
...
if.then29:                                        ; preds = %for.end
  ...
  %gep30 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i14
  %6 = load i64, ptr %gep30, align 8, !tbaa !15
...
for.inc33:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit23, %if.else
  %dec = add nsw i32 %i.0, -1
  br label %for.cond, !llvm.loop !27

for.end34:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %c) #6
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %lon) #6
  call void @llvm.lifetime.end.p0(i64 11000, ptr nonnull %str) #6
  ret i32 0
}
