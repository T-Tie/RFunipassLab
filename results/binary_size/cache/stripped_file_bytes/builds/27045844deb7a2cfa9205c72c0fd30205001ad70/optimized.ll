...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre40, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv34 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next35, %for.inc27 ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %2
  br i1 %exitcond39.not, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc21 ], [ 0, %for.cond10 ]
  %exitcond.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv30
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.125 = phi i32 [ %6, %for.end29.loopexit ], [ %smax, %for.cond10 ]
...
for.end51:                                        ; preds = %for.cond30, %for.body36
  %sub.sink22 = phi i32 [ %sub.sink, %for.body36 ], [ %smin, %for.cond30 ]
  %j2.0 = phi i32 [ %sub.sink4, %for.body36 ], [ undef, %for.cond30 ]
  %10 = xor i32 %i.125, -1
  %sub53 = add i32 %sub.sink22, %10
