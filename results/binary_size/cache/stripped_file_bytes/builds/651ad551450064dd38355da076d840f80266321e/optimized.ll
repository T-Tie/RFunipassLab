...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %cocktail1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %cocktail2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %extra1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %extra2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %extra) #6
...
for.cond14:                                       ; preds = %for.cond14.preheader, %if.end35
  %.pre10 = phi i32 [ %2, %for.cond14.preheader ], [ %.pre, %if.end35 ]
  %indvars.iv7 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next8, %if.end35 ]
  %sub15 = add nsw i32 %.pre10, -1
  %6 = sext i32 %sub15 to i64
  %cmp16 = icmp slt i64 %indvars.iv7, %6
  br i1 %cmp16, label %for.body17, label %for.end38

for.body17:                                       ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [10000 x double], ptr %extra, i64 0, i64 %indvars.iv7
  %7 = load double, ptr %arrayidx19, align 8, !tbaa !5, !invariant.load !11
  %sub20 = fsub double %7, %div
...
if.else28:                                        ; preds = %if.else
  %8 = call double @llvm.fabs.f64(double %sub20)
  %or.cond = fcmp ugt double %8, 5.000000e-02
...
if.end35.sink.split:                              ; preds = %if.else28, %if.else, %for.body17
  ...
  %call22.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.1.sink)
  %call23.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call22.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !9
  br label %if.end35

if.end35:                                         ; preds = %if.end35.sink.split, %if.else28
  %.pre = phi i32 [ %.pre.pre, %if.end35.sink.split ], [ %.pre10, %if.else28 ]
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  br label %for.cond14, !llvm.loop !15

for.end38:                                        ; preds = %for.cond14
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %extra) #7
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %extra2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %extra1) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %cocktail2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %cocktail1) #7
