...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %for.inc29 ], [ 0, %entry ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv17 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next18, %for.inc40 ]
  %exitcond24.not = icmp eq i64 %indvars.iv17, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end42, label %for.inc40
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %putchar6 = call i32 @putchar(i32 noundef %conv38) #7
...
for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc53 ], [ %6, %for.end42 ]
