...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 501, ptr nonnull %s) #8
  call void @llvm.lifetime.start.p0(i64 2500, ptr nonnull %str) #8
...
for.cond5.preheader:                              ; preds = %for.cond
  %smax48 = call i32 @llvm.smax.i32(i32 %0, i32 0)
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc22
  %indvars.iv51 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next52, %for.inc22 ]
  %exitcond55 = icmp eq i64 %indvars.iv51, %wide.trip.count
  br i1 %exitcond55, label %for.cond25.preheader, label %for.cond9

for.cond25.preheader:                             ; preds = %for.cond5
  %smax69 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %wide.trip.count70 = zext nneg i32 %smax69 to i64
  %wide.trip.count59 = zext nneg i32 %smax48 to i64
  br label %for.cond25

for.cond9:                                        ; preds = %for.cond5, %for.body11
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body11 ], [ 0, %for.cond5 ]
  %exitcond50.not = icmp eq i64 %indvars.iv42, %wide.trip.count49
  br i1 %exitcond50.not, label %for.inc22, label %for.body11

for.body11:                                       ; preds = %for.cond9
  %2 = add nuw nsw i64 %indvars.iv42, %indvars.iv51
  %arrayidx13 = getelementptr inbounds nuw [501 x i8], ptr %s, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx13, align 1, !tbaa !12
  %arrayidx17 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv51, i64 %indvars.iv42
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.cond25.loopexit
  %indvars.iv66 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next67, %for.cond25.loopexit ]
  %indvars.iv61 = phi i64 [ 1, %for.cond25.preheader ], [ %indvars.iv.next62, %for.cond25.loopexit ]
  %exitcond71.not = icmp eq i64 %indvars.iv66, %wide.trip.count70
  br i1 %exitcond71.not, label %for.end71, label %for.body28

for.body28:                                       ; preds = %for.cond25
  %arrayidx35 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv66
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv66
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc66, %for.body28
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc66 ], [ %indvars.iv61, %for.body28 ]
  %4 = trunc nuw i64 %indvars.iv63 to i32
...
land.lhs.true:                                    ; preds = %for.body33
  %arrayidx40 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv63
  %6 = load i8, ptr %arrayidx40, align 1, !tbaa !12
  %cmp43.not = icmp eq i8 %6, 48
  br i1 %cmp43.not, label %for.inc66, label %land.lhs.true44

land.lhs.true44:                                  ; preds = %land.lhs.true
  %call51 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx40) #9
  %cmp52 = icmp eq i32 %call51, 0
  br i1 %cmp52, label %if.then, label %for.inc66

if.then:                                          ; preds = %land.lhs.true44
  %7 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  %inc55 = add nsw i32 %7, 1
  store i32 %inc55, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond56

for.cond56:                                       ; preds = %for.body58, %if.then
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body58 ], [ 0, %if.then ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %wide.trip.count59
  br i1 %exitcond60.not, label %for.inc66, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv63, i64 %indvars.iv56
...
for.end71:                                        ; preds = %for.cond25
  ...
  %9 = add nuw i32 %smax69, 1
  %wide.trip.count75 = zext i32 %9 to i64
  br label %for.cond73

for.cond73:                                       ; preds = %for.body76, %for.end71
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.body76 ], [ 1, %for.end71 ]
  %m.0 = phi i32 [ %spec.select, %for.body76 ], [ %8, %for.end71 ]
  %exitcond76 = icmp eq i64 %indvars.iv72, %wide.trip.count75
  br i1 %exitcond76, label %for.end86, label %for.body76

for.body76:                                       ; preds = %for.cond73
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv72
  %10 = load i32, ptr %arrayidx78, align 4, !tbaa !5
...
for.cond91:                                       ; preds = %for.inc104, %if.else
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc104 ], [ 0, %if.else ]
  %11 = load i32, ptr %n, align 4, !tbaa !5
  %sub92 = sub nsw i32 %conv, %11
  %12 = sext i32 %sub92 to i64
  %cmp93.not = icmp sgt i64 %indvars.iv77, %12
  br i1 %cmp93.not, label %cleanup, label %for.body94

for.body94:                                       ; preds = %for.cond91
  %arrayidx96 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv77
...
if.then98:                                        ; preds = %for.body94
  %arrayidx100 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv77
...
cleanup:                                          ; preds = %for.cond91, %if.then88
  ...
  call void @llvm.lifetime.end.p0(i64 2500, ptr nonnull %str) #8
  call void @llvm.lifetime.end.p0(i64 501, ptr nonnull %s) #8
