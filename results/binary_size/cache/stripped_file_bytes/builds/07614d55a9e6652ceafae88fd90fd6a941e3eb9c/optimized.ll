...
define dso_local void @_Z4tempiii(i32 noundef %b, i32 noundef %k, i32 noundef %c) #0 {
entry:
...
if.then:                                          ; preds = %for.body
  %5 = load i32, ptr %b.addr, align 4, !tbaa !5
  %6 = load i32, ptr %i, align 4, !tbaa !5
  %div = sdiv i32 %5, %6
  store i32 %div, ptr %b.addr, align 4, !tbaa !5
  %7 = load i32, ptr @s, align 4, !tbaa !5
  %8 = load i32, ptr %i, align 4, !tbaa !5
  %mul = mul nsw i32 %7, %8
  store i32 %mul, ptr @s, align 4, !tbaa !5
  %9 = load i32, ptr %i, align 4, !tbaa !5
  store i32 %9, ptr %k.addr, align 4, !tbaa !5
  %10 = load i32, ptr @s, align 4, !tbaa !5
  %11 = load i32, ptr %c.addr, align 4, !tbaa !5
...
if.else:                                          ; preds = %if.then
  ...
  %14 = load i32, ptr %k.addr, align 4, !tbaa !5
  %15 = load i32, ptr %c.addr, align 4, !tbaa !5
  call void @_Z4tempiii(i32 noundef %13, i32 noundef %14, i32 noundef %15)
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then3
  ...
  %18 = load i32, ptr %b.addr, align 4, !tbaa !5
  %19 = load i32, ptr %i, align 4, !tbaa !5
  %mul5 = mul nsw i32 %18, %19
  store i32 %mul5, ptr %b.addr, align 4, !tbaa !5
  br label %if.end6
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_Z4tempiii(i32 noundef %2, i32 noundef 2, i32 noundef %3)
