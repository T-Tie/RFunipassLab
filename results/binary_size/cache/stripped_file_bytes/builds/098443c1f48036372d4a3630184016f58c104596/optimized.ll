...
for.cond:                                         ; preds = %for.inc31, %entry
  ...
  br i1 %exitcond12.not, label %for.cond34.preheader, label %for.body
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc75
  %indvars.iv23 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next24, %for.inc75 ]
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define dso_local void @_Z4movePA100_ii(ptr nofree noundef captures(none) %a, i32 noundef %n) local_unnamed_addr #0 {
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 2)
  %smax8 = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
...
entry:
  %cmp.peel.not = icmp eq i32 %n, 1
  br i1 %cmp.peel.not, label %return, label %if.else.peel

if.else.peel:                                     ; preds = %entry
  %arrayidx1 = getelementptr inbounds nuw i8, ptr %a, i64 404
  tail call void @_Z4xiaoPA100_ii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(408) %a, i32 noundef %n) #5
  %0 = load i32, ptr %arrayidx1, align 4, !tbaa !5, !invariant.load !9
  %add.peel = add nsw i32 %0, %s
  br label %tailrecurse

tailrecurse:                                      ; preds = %if.else, %if.else.peel
  %n.tr.sink = phi i32 [ %n.tr, %if.else ], [ %n, %if.else.peel ]
  tail call void @_Z4movePA100_ii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(408) %a, i32 noundef %n.tr.sink) #5
  %n.tr = add nsw i32 %n.tr.sink, -1
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %if.else

if.else:                                          ; preds = %tailrecurse
  tail call void @_Z4xiaoPA100_ii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(408) %a, i32 noundef %n.tr) #5
  br label %tailrecurse, !llvm.loop !22

return:                                           ; preds = %tailrecurse, %entry
  %current.ret.tr1 = phi i32 [ %s, %entry ], [ %add.peel, %tailrecurse ]
  ret i32 %current.ret.tr1
}
...
for.end10:                                        ; preds = %for.cond
  %call11 = call noundef i32 @_Z5countPA100_iii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %1, i32 noundef 0) #7
