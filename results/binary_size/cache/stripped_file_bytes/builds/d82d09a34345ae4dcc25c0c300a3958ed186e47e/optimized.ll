...
entry:
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef -1)
  %0 = add i32 %smax28, 1
...
for.cond67.preheader:                             ; preds = %for.cond
  %smax54 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond34.preheader:                             ; preds = %for.cond24
  %smax42 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
...
for.body26:                                       ; preds = %for.cond24
  ...
  %putchar18 = call i32 @putchar(i32 noundef %conv29) #7
...
for.body36:                                       ; preds = %for.cond34
  ...
  %putchar17 = call i32 @putchar(i32 noundef %conv39) #7
...
for.body51:                                       ; preds = %for.cond49
  ...
  %putchar16 = call i32 @putchar(i32 noundef %conv54) #7
