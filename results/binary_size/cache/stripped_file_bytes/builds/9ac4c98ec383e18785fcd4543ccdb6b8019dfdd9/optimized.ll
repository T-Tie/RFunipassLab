...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef nonnull align 16 %w) #5
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef nonnull align 16 %s) #5
...
for.cond:                                         ; preds = %if.end21, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end21 ], [ 1, %entry ]
  %k.0 = phi i32 [ %k.1, %if.end21 ], [ 1, %entry ]
...
for.cond6:                                        ; preds = %for.body8, %for.body
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.body8 ], [ %indvars.iv, %for.body ]
  %f.1 = phi i32 [ %spec.select, %for.body8 ], [ 0, %for.body ]
  %cmp7 = icmp sgt i64 %indvars.iv3, 0
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond6
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, -1
  %arrayidx10 = getelementptr inbounds [300 x i32], ptr %w, i64 0, i64 %indvars.iv.next4
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.body28
  %indvars.iv7 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next8, %for.body28 ]
  %exitcond.not = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond.not, label %for.end34, label %for.body28

for.body28:                                       ; preds = %for.cond25
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv7
  %4 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !9
  %call31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4) #6
...
for.end34:                                        ; preds = %for.cond25
  ...
  %call38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5) #6
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef nonnull %s) #6
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef nonnull %w) #6
