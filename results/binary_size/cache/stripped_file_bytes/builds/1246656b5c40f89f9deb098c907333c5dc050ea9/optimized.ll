...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc8 ], [ 1, %entry ]
...
for.cond16:                                       ; preds = %for.end10, %for.inc30
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc30 ], [ 1, %for.end10 ]
  %7 = sext i32 %6 to i64
...
for.cond33.preheader:                             ; preds = %for.cond16
  ...
  %11 = add nuw i32 %smax44, 1
  %smax50 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 0)
  %12 = add nuw i32 %smax50, 1
  %wide.trip.count51 = zext i32 %12 to i64
  %wide.trip.count45 = zext i32 %11 to i64
  %wide.trip.count = zext i32 %10 to i64
  br label %for.cond33

for.cond19:                                       ; preds = %for.cond16, %for.inc27
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc27 ], [ 1, %for.cond16 ]
  %13 = load i32, ptr %y2, align 4, !tbaa !5
  %14 = sext i32 %13 to i64
  %cmp20.not = icmp sgt i64 %indvars.iv31, %14
  br i1 %cmp20.not, label %for.inc30, label %for.inc27

for.inc27:                                        ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv34, i64 %indvars.iv31
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc64
  %indvars.iv47 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next48, %for.inc64 ]
  %exitcond52 = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52, label %for.cond67, label %for.cond36

for.cond36:                                       ; preds = %for.cond33, %for.inc61
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc61 ], [ 1, %for.cond33 ]
  %exitcond46 = icmp eq i64 %indvars.iv41, %wide.trip.count45
  br i1 %exitcond46, label %for.inc64, label %for.body38
...
for.cond43:                                       ; preds = %for.inc58, %for.body38
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc58 ], [ 1, %for.body38 ]
...
for.inc58:                                        ; preds = %for.cond43
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv37
  %15 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !15
  %arrayidx53 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv37, i64 %indvars.iv41
...
for.cond67:                                       ; preds = %for.cond33, %for.inc87
  %17 = phi i32 [ %.pre59, %for.inc87 ], [ %8, %for.cond33 ]
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc87 ], [ 1, %for.cond33 ]
  %18 = sext i32 %17 to i64
  %cmp68.not = icmp sgt i64 %indvars.iv56, %18
  br i1 %cmp68.not, label %cleanup, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 1
...
for.cond74:                                       ; preds = %for.inc83, %for.body69
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc83 ], [ 2, %for.body69 ]
  %20 = load i32, ptr %y2, align 4, !tbaa !5
  %21 = sext i32 %20 to i64
  %cmp75.not = icmp sgt i64 %indvars.iv53, %21
...
for.inc83:                                        ; preds = %for.cond74
  ...
  %arrayidx81 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv53
...
for.inc87:                                        ; preds = %for.cond74
  ...
  %.pre59 = load i32, ptr %x1, align 4, !tbaa !5
