...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select31 = select i1 %cmp4, i32 %2, i32 0
  %4 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv
  store i32 %spec.select31, ptr %4, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv20 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next21, %for.body13 ]
...
for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv20
  %5 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
  %spec.select = call i32 @llvm.smax.i32(i32 %5, i32 %p.0)
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond11, !llvm.loop !13

for.cond24:                                       ; preds = %for.cond24.preheader, %for.end40
  %.pre27 = phi i32 [ %.pre28, %for.end40 ], [ %0, %for.cond24.preheader ]
  %r.0 = phi i32 [ %add, %for.end40 ], [ 1, %for.cond24.preheader ]
  %cmp25.not = icmp sgt i32 %r.0, %sub
  br i1 %cmp25.not, label %for.end42, label %for.cond27

for.cond27:                                       ; preds = %for.cond24, %if.end37
  %.pre28 = phi i32 [ %.pre, %if.end37 ], [ %.pre27, %for.cond24 ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end37 ], [ 0, %for.cond24 ]
  %6 = sext i32 %.pre28 to i64
  %cmp28 = icmp slt i64 %indvars.iv24, %6
  br i1 %cmp28, label %for.body29, label %for.end40

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv24
  %7 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !9
  %cmp32 = icmp eq i32 %7, %r.0
...
if.end37:                                         ; preds = %if.then33, %for.body29
  %.pre = phi i32 [ %.pre.pre, %if.then33 ], [ %.pre28, %for.body29 ]
