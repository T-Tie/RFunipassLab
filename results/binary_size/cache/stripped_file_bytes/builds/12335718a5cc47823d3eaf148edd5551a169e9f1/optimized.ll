...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.end34
  %indvars.iv21 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next22, %for.end34 ]
...
for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv21
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %if.end31
  %indvars.iv23 = phi i64 [ %indvars.iv21, %for.cond14.preheader ], [ %indvars.iv.next24, %if.end31 ]
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %4 = trunc nuw i64 %indvars.iv.next24 to i32
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv.next24
...
for.cond38:                                       ; preds = %for.cond11, %for.body41
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body41 ], [ 0, %for.cond11 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.end48, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv27
