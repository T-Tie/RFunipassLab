...
tailrecurse:                                      ; preds = %for.end28, %entry
  ...
  %spec.select12 = phi i32 [ %spec.select, %for.end28 ], [ %maximum.promoted, %entry ]
...
if.end.split:                                     ; preds = %if.end
  %cmp5.i.le = icmp sgt i32 %1, 0
  %add.ptr13.le = getelementptr inbounds i8, ptr @str, i64 %2
  br label %for.cond

for.cond:                                         ; preds = %if.end24, %if.end.split
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %if.end24 ], [ %2, %if.end.split ]
  %add.ptr9 = getelementptr inbounds i8, ptr @str, i64 %indvars.iv21
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond, %if.end19
  %indvars.iv15 = phi i64 [ 0, %for.cond ], [ %indvars.iv.next16, %if.end19 ]
  br i1 %cmp5.i.le, label %for.body7, label %for.end

for.body7:                                        ; preds = %for.cond3
  %add.ptr11 = getelementptr inbounds nuw i8, ptr %add.ptr9, i64 %indvars.iv15
  %4 = load i8, ptr %add.ptr11, align 1, !tbaa !9, !invariant.load !10
  %add.ptr15 = getelementptr inbounds nuw i8, ptr %add.ptr13.le, i64 %indvars.iv15
...
for.end:                                          ; preds = %for.cond3, %for.body7
  %indvars.iv15.lcssa = phi i64 [ 0, %for.cond3 ], [ %indvars.iv15, %for.body7 ]
  %indvars17.le = trunc i64 %indvars.iv15.lcssa to i32
  %cmp21 = icmp eq i32 %1, %indvars17.le
  br i1 %cmp21, label %if.then22, label %if.end24

if.then22:                                        ; preds = %for.end
  %6 = load i32, ptr %add.ptr, align 4, !tbaa !5
  %inc.i4 = add nsw i32 %6, 1
  store i32 %inc.i4, ptr %add.ptr, align 4, !tbaa !5
  br label %if.end24
...
for.end28:                                        ; preds = %if.end
  ...
  %spec.select = tail call i32 @llvm.smax.i32(i32 %7, i32 %spec.select12)
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.body7
  ...
  br i1 %cmp5.i, label %for.body7, label %for.end
