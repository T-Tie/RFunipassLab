...
for.cond:                                         ; preds = %do.end, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %do.end ], [ 0, %entry ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp sgt i32 %0, 0
  br i1 %cmp, label %do.cond.preheader, label %for.end30

do.cond.preheader:                                ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds nuw [300 x i32], ptr @_ZZ4mainE1a, i64 0, i64 %indvars.iv
  br label %do.cond

do.cond:                                          ; preds = %do.cond.preheader, %do.cond
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull @_ZZ4mainE1a)
  %1 = load i32, ptr %arrayidx3, align 4, !tbaa !5, !invariant.load !9
  %cmp4 = icmp eq i32 %1, 32
  br i1 %cmp4, label %do.cond, label %do.end, !llvm.loop !10
