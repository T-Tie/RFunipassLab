...
entry:
  ...
  %call21 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %num)
...
for.cond.preheader:                               ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  %cmp3.not12 = icmp eq i32 %1, 0
  br i1 %cmp3.not12, label %for.end37, label %for.body

for.cond7.preheader:                              ; preds = %for.body
  %.pre = load i32, ptr %num, align 16, !tbaa !5
  %cmp10.not17 = icmp eq i32 %.pre, 0
  br i1 %cmp10.not17, label %for.end37, label %for.cond12.preheader
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  br i1 %cmp3.not, label %for.cond7.preheader, label %for.body, !llvm.loop !9

for.cond12.preheader:                             ; preds = %for.cond7.preheader, %for.cond12.for.inc35_crit_edge
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.cond12.for.inc35_crit_edge ], [ 0, %for.cond7.preheader ]
  %3 = phi i32 [ %6, %for.cond12.for.inc35_crit_edge ], [ %.pre, %for.cond7.preheader ]
  %sum.119 = phi i32 [ %sum.3, %for.cond12.for.inc35_crit_edge ], [ 0, %for.cond7.preheader ]
  br label %for.body16

for.body16:                                       ; preds = %for.cond12.preheader, %for.body16
  %indvars.iv25 = phi i64 [ 0, %for.cond12.preheader ], [ %indvars.iv.next26, %for.body16 ]
  %4 = phi i32 [ %.pre, %for.cond12.preheader ], [ %5, %for.body16 ]
  %sum.216 = phi i32 [ %sum.119, %for.cond12.preheader ], [ %sum.3, %for.body16 ]
  %mul = shl nsw i32 %4, 1
  %cmp21.not = icmp eq i32 %3, %mul
  %inc30 = zext i1 %cmp21.not to i32
  %sum.3 = add nsw i32 %sum.216, %inc30
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %arrayidx14 = getelementptr inbounds nuw [16 x i32], ptr %num, i64 0, i64 %indvars.iv.next26
  %5 = load i32, ptr %arrayidx14, align 4, !tbaa !5
  %cmp15.not = icmp eq i32 %5, 0
  br i1 %cmp15.not, label %for.cond12.for.inc35_crit_edge, label %for.body16, !llvm.loop !12

for.cond12.for.inc35_crit_edge:                   ; preds = %for.body16
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %arrayidx9 = getelementptr inbounds nuw [16 x i32], ptr %num, i64 0, i64 %indvars.iv.next29
  %6 = load i32, ptr %arrayidx9, align 4, !tbaa !5
  %cmp10.not = icmp eq i32 %6, 0
  br i1 %cmp10.not, label %for.end37, label %for.cond12.preheader, !llvm.loop !13

for.end37:                                        ; preds = %for.cond12.for.inc35_crit_edge, %for.cond.preheader, %for.cond7.preheader
  %sum.1.lcssa = phi i32 [ 0, %for.cond7.preheader ], [ 0, %for.cond.preheader ], [ %sum.3, %for.cond12.for.inc35_crit_edge ]
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %sum.1.lcssa)
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call38, i8 noundef signext %retval.0.i.i.i)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %num)
  %11 = load i32, ptr %num, align 16, !tbaa !5
  %cmp = icmp eq i32 %11, -1
  br i1 %cmp, label %while.end, label %for.cond.preheader, !llvm.loop !41
