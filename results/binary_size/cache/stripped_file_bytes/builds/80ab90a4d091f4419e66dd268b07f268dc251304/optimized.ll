...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc7
  ...
  %indvars.iv12 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next13, %for.inc7 ]
  %2 = sext i32 %1 to i64
  %cmp = icmp slt i64 %indvars.iv12, %2
  br i1 %cmp, label %for.cond1, label %while.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre15, %for.inc ], [ %1, %for.cond ]
...
while.body12:                                     ; preds = %while.cond10
  call void @_Z2m1iPA100_i(i32 noundef %p.0.in, ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
  call void @_Z2m2iPA100_i(i32 noundef %p.0.in, ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
  %5 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %add17 = add nsw i32 %5, %sum.0
  call void @_Z4dealiPA100_i(i32 noundef %p.0.in, ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
...
for.cond:                                         ; preds = %if.end28, %entry.split
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end28 ], [ 0, %entry.split ]
  br label %for.cond2
...
for.inc25:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv24, i64 %indvars.iv19
...
for.inc25:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv19, i64 %indvars.iv24
  %2 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !15
  %sub = sub nsw i32 %2, %min.0
  store i32 %sub, ptr %arrayidx24, align 4, !tbaa !5
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv15 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next16, %for.end ]
  br label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv15, i64 %indvars.iv.next
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !15
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv15, i64 %indvars.iv
