...
entry:
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef -1)
  %0 = add i32 %smax23, 1
...
for.cond:                                         ; preds = %if.end61, %entry
  %indvars.iv40 = phi i32 [ %indvars.iv.next41, %if.end61 ], [ %conv9, %entry ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %if.end61 ], [ 0, %entry ]
  %exitcond25 = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25, label %for.cond67.preheader, label %for.cond13
...
for.body15:                                       ; preds = %for.cond13
  ...
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv20
  ...
  %spec.select = add nuw nsw i32 %inc, %e.0
...
for.cond24.preheader:                             ; preds = %for.end
  %indvars64.le = trunc i64 %indvars.iv20 to i32
  %wide.trip.count32 = and i64 %indvars.iv20, 4294967295
  br label %for.cond24

for.cond24:                                       ; preds = %for.cond24.preheader, %for.body26
  %indvars.iv26 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next27, %for.body26 ]
  %exitcond33.not = icmp eq i64 %indvars.iv26, %wide.trip.count32
  br i1 %exitcond33.not, label %for.cond34.preheader, label %for.body26
...
for.body26:                                       ; preds = %for.cond24
  %arrayidx28 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv26
  %4 = load i8, ptr %arrayidx28, align 1, !tbaa !5, !invariant.load !8
  %conv29 = sext i8 %4 to i32
  %putchar13 = call i32 @putchar(i32 noundef %conv29) #7
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond24, !llvm.loop !12

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv34 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next35, %for.body36 ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count38
  br i1 %exitcond39.not, label %for.end43, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [300 x i8], ptr %h, i64 0, i64 %indvars.iv34
  %5 = load i8, ptr %arrayidx38, align 1, !tbaa !5, !invariant.load !8
  %conv39 = sext i8 %5 to i32
  %putchar12 = call i32 @putchar(i32 noundef %conv39) #7
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  br label %for.cond34, !llvm.loop !13

for.end43:                                        ; preds = %for.cond34
  %add44 = add nsw i32 %indvars64.le, %conv9
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.body51
  %indvars.iv43 = phi i64 [ %6, %for.cond49.preheader ], [ %indvars.iv.next44, %for.body51 ]
  %cmp50 = icmp slt i64 %indvars.iv43, %7
  br i1 %cmp50, label %for.body51, label %if.end77

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds [300 x i8], ptr %s, i64 0, i64 %indvars.iv43
  %8 = load i8, ptr %arrayidx53, align 1, !tbaa !5, !invariant.load !8
  %conv54 = sext i8 %8 to i32
  %putchar11 = call i32 @putchar(i32 noundef %conv54) #7
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv46 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next47, %for.body69 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count50
  br i1 %exitcond51.not, label %if.end77, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx71 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv46
  %9 = load i8, ptr %arrayidx71, align 1, !tbaa !5, !invariant.load !8
