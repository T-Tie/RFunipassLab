...
for.cond:                                         ; preds = %for.cond, %entry
  %indvars.iv26 = phi i32 [ %indvars.iv.next27, %for.cond ], [ 0, %entry ]
...
for.cond20.preheader:                             ; preds = %for.cond
  %cmp2120.not = icmp eq i64 %indvars.iv, 0
  br i1 %cmp2120.not, label %for.end60, label %for.body22.preheader
...
for.body22:                                       ; preds = %for.body22.preheader, %for.body22
  %indvars.iv23 = phi i64 [ 0, %for.body22.preheader ], [ %indvars.iv.next24, %for.body22 ]
  %arrayidx24 = getelementptr inbounds nuw [1000 x [6 x i32]], ptr %time, i64 0, i64 %indvars.iv23
  ...
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %jg, i64 0, i64 %indvars.iv23
  ...
  br i1 %exitcond.not, label %for.end60, label %for.body22, !llvm.loop !12

for.end60:                                        ; preds = %for.body22, %for.cond20.preheader
