...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %s) #4
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %k) #4
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv16 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next17, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 0)
  %3 = add nuw i32 %smax28, 1
  %wide.trip.count29 = zext i32 %3 to i64
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %s, i64 0, i64 %indvars.iv16
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc46
  %indvars.iv23 = phi i64 [ 1, %for.cond16.preheader ], [ %indvars.iv.next24, %for.inc46 ]
  %exitcond30 = icmp eq i64 %indvars.iv23, %wide.trip.count29
  br i1 %exitcond30, label %for.end48, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %6 = sub nsw i64 %2, %indvars.iv23
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc43
  %indvars.iv20 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next21, %for.inc43 ]
  %m.0 = phi i32 [ 0, %for.cond19.preheader ], [ %spec.select, %for.inc43 ]
  %cmp20.not = icmp sgt i64 %indvars.iv20, %6
  br i1 %cmp20.not, label %for.inc46, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv20
...
for.end48:                                        ; preds = %for.cond16
  ...
  %call52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %13)
  br i1 %cmp49, label %if.end64, label %if.else

if.else:                                          ; preds = %for.end48
  %smax35 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 1)
  %wide.trip.count36 = zext nneg i32 %smax35 to i64
  br label %for.cond55

for.cond55:                                       ; preds = %for.inc61, %if.else
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc61 ], [ 1, %if.else ]
  %exitcond37.not = icmp eq i64 %indvars.iv31, %wide.trip.count36
  br i1 %exitcond37.not, label %if.end64, label %for.inc61

for.inc61:                                        ; preds = %for.cond55
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv31
  %14 = load i32, ptr %arrayidx59, align 4, !tbaa !5, !invariant.load !12
  %call60 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %14)
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  br label %for.cond55, !llvm.loop !16

if.end64:                                         ; preds = %for.cond55, %for.end48
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %k) #5
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %s) #5
