...
if.end34:                                         ; preds = %if.then32, %if.end
  %8 = phi double [ %.pre, %if.then32 ], [ %7, %if.end ]
  %cmp37 = fcmp oeq double %8, 0.000000e+00
  %or.cond1 = select i1 %cmp30, i1 %cmp37, i1 false
  br i1 %or.cond1, label %if.then38, label %if.end40
...
for.inc:                                          ; preds = %if.end40, %if.then42
  ...
  %cmp.not.not = icmp slt i32 %i.014, %9
