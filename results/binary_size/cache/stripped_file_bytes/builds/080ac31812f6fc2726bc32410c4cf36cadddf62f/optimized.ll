...
for.cond16.preheader:                             ; preds = %for.cond2
  %2 = add i32 %x.0, -1
  %smax47 = call i32 @llvm.smax.i32(i32 %x.0, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc43
  %indvars.iv41 = phi i32 [ %2, %for.cond16.preheader ], [ %indvars.iv.next42, %for.inc43 ]
  %k.0 = phi i32 [ 1, %for.cond16.preheader ], [ %add44, %for.inc43 ]
  %exitcond48 = icmp eq i32 %k.0, %3
  br i1 %exitcond48, label %for.cond46.preheader, label %for.cond19.preheader
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc40
  %indvars.iv37 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next38, %for.inc40 ]
  %exitcond45.not = icmp eq i64 %indvars.iv37, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc43, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv37
  %6 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %arrayidx26 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next38
