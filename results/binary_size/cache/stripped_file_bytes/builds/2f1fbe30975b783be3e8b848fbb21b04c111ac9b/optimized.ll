...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 360, ptr nonnull %num) #4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(360) %num, i8 0, i64 360, i1 false)
  ...
  %cmp.not6 = icmp slt i32 %2, 2
  br i1 %cmp.not6, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 2, %entry ]
  %arrayidx7 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv
...
if.then:                                          ; preds = %for.body
  ...
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %5)
  br label %for.inc
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  call void @llvm.lifetime.end.p0(i64 360, ptr nonnull %num) #4
