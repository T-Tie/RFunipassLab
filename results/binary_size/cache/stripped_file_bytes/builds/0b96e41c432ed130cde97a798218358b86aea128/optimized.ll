...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %land.lhs.true.i, %if.then19.i, %if.then28.i
  ...
  br i1 %cmp.not, label %for.end53, label %for.cond.preheader
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end
  ...
  %add.ptr = getelementptr inbounds nuw i8, ptr @a, i64 %indvars.iv8
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond, %for.body5
  %indvars.iv = phi i64 [ 0, %for.cond ], [ %indvars.iv.next, %for.body5 ]
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx9 = getelementptr inbounds nuw [6 x i8], ptr @b, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond60:                                       ; preds = %if.end74, %if.else
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %if.end74 ], [ 0, %if.else ]
  %5 = load i32, ptr %n, align 4, !tbaa !22
  %sub61 = sub nsw i32 %conv, %5
  %6 = sext i32 %sub61 to i64
  %cmp62 = icmp slt i64 %indvars.iv11, %6
  br i1 %cmp62, label %for.body63, label %if.end78

for.body63:                                       ; preds = %for.cond60
  %arrayidx65 = getelementptr inbounds nuw i8, ptr @c, i64 %indvars.iv11
  %7 = load i8, ptr %arrayidx65, align 1, !tbaa !23, !invariant.load !8
  %cmp67 = icmp eq i8 %7, %4
  br i1 %cmp67, label %if.then68, label %if.end74

if.then68:                                        ; preds = %for.body63
  %arrayidx70 = getelementptr inbounds nuw [6 x i8], ptr @b, i64 %indvars.iv11
