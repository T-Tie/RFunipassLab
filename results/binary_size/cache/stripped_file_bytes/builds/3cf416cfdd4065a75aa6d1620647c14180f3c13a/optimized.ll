...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax54 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
  %smax60 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc24 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv41, %9
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv44, i64 %indvars.iv41
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc65
  %indvars.iv57 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next58, %for.inc65 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count61
  br i1 %exitcond62.not, label %while.cond, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc62
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc62 ], [ 0, %for.cond30 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %wide.trip.count55
  br i1 %exitcond56.not, label %for.inc65, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv57, i64 %indvars.iv51
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.inc59, %for.body35
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc59 ], [ 0, %for.body35 ]
...
for.inc59:                                        ; preds = %for.cond40
  %arrayidx50 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv47
  %10 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !15
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv47, i64 %indvars.iv51
...
while.cond:                                       ; preds = %for.cond30, %for.end80
  ...
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.end80 ], [ 0, %for.cond30 ]
  %13 = sext i32 %12 to i64
  %cmp68 = icmp slt i64 %indvars.iv66, %13
  br i1 %cmp68, label %for.cond69, label %while.end

for.cond69:                                       ; preds = %while.cond, %for.inc78
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc78 ], [ 0, %while.cond ]
  %14 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %14, -1
  %15 = sext i32 %sub to i64
  %cmp70 = icmp slt i64 %indvars.iv63, %15
  br i1 %cmp70, label %for.inc78, label %for.end80

for.inc78:                                        ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv66, i64 %indvars.iv63
...
for.end80:                                        ; preds = %for.cond69
  %arrayidx85 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv66, i64 %15
