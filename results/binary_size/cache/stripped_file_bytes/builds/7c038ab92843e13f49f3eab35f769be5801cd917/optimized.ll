...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr nonnull %c) #6
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %c, i64 noundef 1000)
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #7
  %conv = trunc i64 %call2 to i32
  br label %for.cond

for.cond:                                         ; preds = %for.inc22, %entry
  %l.0 = phi i32 [ %conv, %entry ], [ %l.1, %for.inc22 ]
...
for.cond26.preheader:                             ; preds = %for.cond
  %smax = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.body15
  ...
  br i1 %exitcond.not, label %for.cond.cleanup14, label %for.body15
...
for.body15:                                       ; preds = %for.cond12
  ...
  store i8 %2, ptr %arrayidx20, align 1, !tbaa !5
  br label %for.cond12, !llvm.loop !8

for.inc22:                                        ; preds = %for.body, %land.lhs.true, %for.cond.cleanup14
  %l.1 = phi i32 [ %sub, %for.cond.cleanup14 ], [ %l.0, %land.lhs.true ], [ %l.0, %for.body ]
  %i.1 = phi i32 [ %dec21, %for.cond.cleanup14 ], [ %i.0, %land.lhs.true ], [ %i.0, %for.body ]
  %inc23 = add nsw i32 %i.1, 1
  br label %for.cond, !llvm.loop !11

for.cond26:                                       ; preds = %for.cond26.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv16 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next17, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  %exitcond21.not = icmp eq i64 %indvars.iv16, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond.cleanup28, label %for.body29

for.cond.cleanup28:                               ; preds = %for.cond26
  call void @llvm.lifetime.end.p0(i64 1000, ptr nonnull %c) #6
  ret i32 0

for.body29:                                       ; preds = %for.cond26
  %arrayidx31 = getelementptr inbounds nuw [1000 x i8], ptr %c, i64 0, i64 %indvars.iv16
  ...
  %4 = load i64, ptr %gep, align 8, !tbaa !14
