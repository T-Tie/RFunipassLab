...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %total) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %eff) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %total2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %eff2) #6
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call11.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.sink)
  %call12.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call11.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %eff2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %total2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %eff) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %total) #6
