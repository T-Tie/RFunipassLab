...
entry:
  ...
  %rem41 = srem i8 %rem4.lhs.trunc, 50
  %rem4.sext = sext i8 %rem41 to i32
  %sub5 = sub nsw i32 %rem, %rem4.sext
  %div6.lhs.trunc = trunc nsw i32 %sub5 to i16
  %div62 = sdiv i16 %div6.lhs.trunc, 50
  ...
  %rem103 = srem i8 %rem41, 20
  %div124 = sdiv i8 %rem41, 20
  ...
  %rem165 = srem i8 %rem103, 10
  %div186 = sdiv i8 %rem103, 10
  ...
  %rem227 = srem i8 %rem165, 5
  %rem22.sext = sext i8 %rem227 to i32
  %div248 = sdiv i8 %rem165, 5
  %div24.sext = sext i8 %div248 to i32
  call void @outlined_ir_func_0(i32 %div24.sext)
  call void @outlined_ir_func_0(i32 %rem22.sext)
...
entry_after_outline.exitStub:
  %call26 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %0)
