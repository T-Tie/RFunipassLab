...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre69, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv
  %call6 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre69 = load i32, ptr %n, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc46
  %indvars.iv50 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next51, %for.inc46 ]
  ...
  br i1 %exitcond55.not, label %for.cond49.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.backedge, %for.cond13.preheader
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.cond13.backedge ], [ 0, %for.cond13.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond.not, label %for.inc46, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv46
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv.next47
...
land.lhs.true:                                    ; preds = %for.body15
  %arrayidx33 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next51, i64 %indvars.iv46
...
for.inc46.split.loop.exit:                        ; preds = %land.lhs.true
  ...
  %9 = trunc nuw nsw i64 %indvars.iv46 to i32
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc89
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc89 ], [ 0, %for.cond49.preheader ]
  %m2.0 = phi i32 [ %m2.1, %for.inc89 ], [ undef, %for.cond49.preheader ]
  %n2.0 = phi i32 [ %n2.1, %for.inc89 ], [ undef, %for.cond49.preheader ]
  %t.2 = phi i32 [ %t.3, %for.inc89 ], [ 0, %for.cond49.preheader ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count54
  br i1 %exitcond68.not, label %for.end91, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %10 = add nsw i64 %indvars.iv63, -1
  %tobool83.not = icmp ne i32 %t.2, 0
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc86
  %indvars.iv56 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next57, %for.inc86 ]
  %exitcond62.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond62.not, label %for.inc89, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx58 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv56, i64 %indvars.iv63
  %11 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !13
  %arrayidx62 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv56, i64 %10
...
land.lhs.true64:                                  ; preds = %for.body54
  ...
  %arrayidx73 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %13, i64 %indvars.iv63
  %14 = load i32, ptr %arrayidx73, align 4, !tbaa !5, !invariant.load !13
  %15 = or i32 %14, %11
  %or.cond39 = icmp eq i32 %15, 0
  %brmerge40 = select i1 %or.cond39, i1 true, i1 %tobool83.not
  br i1 %brmerge40, label %for.inc89.split.loop.exit, label %for.inc86
...
for.inc89.split.loop.exit:                        ; preds = %land.lhs.true64
  ...
  %i.2.mux.le = select i1 %or.cond39, i32 %16, i32 %m2.0
  %17 = trunc nuw nsw i64 %indvars.iv63 to i32
  %j.2.mux.le = select i1 %or.cond39, i32 %17, i32 %n2.0
  %.mux41.le = select i1 %or.cond39, i32 1, i32 %t.2
  br label %for.inc89
...
for.inc89:                                        ; preds = %if.end82, %for.cond52, %for.inc89.split.loop.exit
  ...
  %t.3 = phi i32 [ %.mux41.le, %for.inc89.split.loop.exit ], [ %t.2, %for.cond52 ], [ %t.2, %if.end82 ]
