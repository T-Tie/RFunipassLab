...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80004, ptr nonnull %a) #3
...
for.cond4:                                        ; preds = %for.inc25, %for.end
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc25 ], [ 2, %for.end ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp5.not = icmp sgt i64 %indvars.iv16, %4
  br i1 %cmp5.not, label %for.end27, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %arrayidx11 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv16
  %5 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv13 = phi i64 [ 1, %for.cond7.preheader ], [ %indvars.iv.next14, %for.body9 ]
  %b.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body9 ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %indvars.iv16
  br i1 %exitcond.not, label %for.end17, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv13
  %6 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %cmp14.not = icmp ne i32 %5, %6
  %add = zext i1 %cmp14.not to i32
  %spec.select = add nuw nsw i32 %b.0, %add
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond7, !llvm.loop !12

for.end17:                                        ; preds = %for.cond7
  %7 = add nsw i64 %indvars.iv16, -1
  %8 = zext nneg i32 %b.0 to i64
...
for.end27:                                        ; preds = %for.cond4
  call void @llvm.lifetime.end.p0(i64 80004, ptr nonnull %a) #3
