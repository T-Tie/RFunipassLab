; ModuleID = '/tmp/tmp65g1knxe.cpp'
source_filename = "/tmp/tmp65g1knxe.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 42000, ptr %a) #11
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1000 x [42 x i8]], ptr %a, i64 0, i64 %idxprom
  %arraydecay = getelementptr inbounds [42 x i8], ptr %arrayidx, i64 0, i64 0
  ...
  %arrayidx3 = getelementptr inbounds [1000 x [42 x i8]], ptr %a, i64 0, i64 %idxprom2
  %arraydecay4 = getelementptr inbounds [42 x i8], ptr %arrayidx3, i64 0, i64 0
...
if.then9:                                         ; preds = %if.then
  ...
  %arrayidx12 = getelementptr inbounds [1000 x [42 x i8]], ptr %a, i64 0, i64 %idxprom11
  %arraydecay13 = getelementptr inbounds [42 x i8], ptr %arrayidx12, i64 0, i64 0
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef %arraydecay13)
...
if.else:                                          ; preds = %if.then
  ...
  %arrayidx18 = getelementptr inbounds [1000 x [42 x i8]], ptr %a, i64 0, i64 %idxprom17
  %arraydecay19 = getelementptr inbounds [42 x i8], ptr %arrayidx18, i64 0, i64 0
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay19)
...
if.else22:                                        ; preds = %for.body
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %13 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom24 = sext i32 %13 to i64
  %arrayidx25 = getelementptr inbounds [1000 x [42 x i8]], ptr %a, i64 0, i64 %idxprom24
  %arraydecay26 = getelementptr inbounds [42 x i8], ptr %arrayidx25, i64 0, i64 0
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay26)
  store i32 0, ptr %sum, align 4, !tbaa !5
  %14 = load i32, ptr %sum, align 4, !tbaa !5
  %15 = load i32, ptr %m, align 4, !tbaa !5
  %add28 = add nsw i32 %14, %15
  store i32 %add28, ptr %sum, align 4, !tbaa !5
  br label %if.end29

if.end29:                                         ; preds = %if.else22, %if.end
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 42000, ptr %a) #11
  ret i32 0
}
