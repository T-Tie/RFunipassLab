...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %s) #4
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
land.lhs.true:                                    ; preds = %for.body6
  ...
  %4 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !9
...
for.inc19:                                        ; preds = %for.cond4
  %arrayidx3 = getelementptr inbounds nuw [25 x i32], ptr %s, i64 0, i64 %indvars.iv24
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body24
  %indvars.iv27 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next28, %for.body24 ]
  %max.2 = phi i32 [ 0, %for.cond22.preheader ], [ %spec.select22, %for.body24 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.end34, label %for.body24

for.body24:                                       ; preds = %for.cond22
  %arrayidx26 = getelementptr inbounds nuw [25 x i32], ptr %s, i64 0, i64 %indvars.iv27
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %spec.select22 = call i32 @llvm.smax.i32(i32 %max.2, i32 %5)
...
for.end34:                                        ; preds = %for.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %s) #5
  ret i32 0
}
