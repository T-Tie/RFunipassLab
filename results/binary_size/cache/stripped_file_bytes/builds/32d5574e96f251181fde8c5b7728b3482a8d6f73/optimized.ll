...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41, ptr nonnull %c) #5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp19 = icmp sgt i32 %0, 0
  br i1 %cmp19, label %if.then6.i, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %if.end17, %entry
  call void @llvm.lifetime.end.p0(i64 41, ptr nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #5
  ret i32 0

if.then6.i:                                       ; preds = %entry, %if.end17
  %i.022 = phi i32 [ %inc, %if.end17 ], [ 0, %entry ]
  %cmp14.not21 = phi i1 [ false, %if.end17 ], [ true, %entry ]
  %s.020 = phi i64 [ %s.1, %if.end17 ], [ 0, %entry ]
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %c, i64 noundef 41)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %if.then19.i, %_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv.exit.i, %if.then28.i
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #6
  %sext = shl i64 %s.020, 32
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %gep18 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 240), i64 %vbase.offset.i14
  %9 = load ptr, ptr %gep18, align 8, !tbaa !37
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #6
  %add10 = add i64 %call9, 1
  br label %if.end17

if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  br i1 %cmp14.not21, label %if.end17, label %if.then15
...
if.end17:                                         ; preds = %if.else, %if.then15, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %s.1 = phi i64 [ %add10, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ %add4, %if.then15 ], [ %add4, %if.else ]
  %call.i.i4 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #5
  %call1.i5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %c, i64 noundef %call.i.i4)
