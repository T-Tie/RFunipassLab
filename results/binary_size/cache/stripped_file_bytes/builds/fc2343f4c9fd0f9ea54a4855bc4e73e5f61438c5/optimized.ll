...
entry:
  ...
  br i1 %cmp.not30, label %for.end112, label %for.body

for.cond67.preheader:                             ; preds = %for.inc
  %1 = icmp slt i32 %8, 1
  br i1 %1, label %for.end112, label %for.body69
...
for.inc:                                          ; preds = %for.inc.sink.split, %if.else37
  ...
  br i1 %cmp.not.not, label %for.body, label %for.cond67.preheader, !llvm.loop !11

for.body69:                                       ; preds = %for.cond67.preheader, %for.inc110
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc110 ], [ 1, %for.cond67.preheader ]
  %arrayidx71 = getelementptr inbounds nuw [100 x double], ptr %x1, i64 0, i64 %indvars.iv35
  %10 = load double, ptr %arrayidx71, align 8, !tbaa !9
  %arrayidx73 = getelementptr inbounds nuw [100 x double], ptr %x2, i64 0, i64 %indvars.iv35
...
land.lhs.true:                                    ; preds = %for.body69
  %arrayidx76 = getelementptr inbounds nuw [100 x double], ptr %s2, i64 0, i64 %indvars.iv35
...
if.else82:                                        ; preds = %land.lhs.true, %for.body69
  ...
  %arrayidx90 = getelementptr inbounds nuw [100 x double], ptr %s2, i64 0, i64 %indvars.iv35
...
if.else98:                                        ; preds = %if.else82
  %arrayidx100 = getelementptr inbounds nuw [100 x double], ptr %s1, i64 0, i64 %indvars.iv35
...
for.inc110:                                       ; preds = %if.then78, %if.else98, %if.then92
  ...
  %cmp68.not.not = icmp slt i64 %indvars.iv35, %16
  br i1 %cmp68.not.not, label %for.body69, label %for.end112, !llvm.loop !14

for.end112:                                       ; preds = %for.inc110, %entry, %for.cond67.preheader
