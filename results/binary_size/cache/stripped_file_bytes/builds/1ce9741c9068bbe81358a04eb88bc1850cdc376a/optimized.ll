...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 42000, ptr noundef nonnull dereferenceable(42000) %a) #9
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %sum.0 = phi i32 [ %.sink, %for.inc ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [1000 x [42 x i8]], ptr %a, i64 0, i64 %indvars.iv
...
if.else22:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
for.inc:                                          ; preds = %if.then, %if.else22, %if.then9
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %if.else22 ], [ %call10, %if.then9 ], [ @_ZSt4cout, %if.then ]
  %.sink = phi i32 [ %conv, %if.else22 ], [ %add6, %if.then9 ], [ %add, %if.then ]
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, ptr noundef nonnull %arrayidx)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #10
  call void @llvm.lifetime.end.p0(i64 noundef 42000, ptr noundef nonnull %a) #10
  ret i32 0
}
