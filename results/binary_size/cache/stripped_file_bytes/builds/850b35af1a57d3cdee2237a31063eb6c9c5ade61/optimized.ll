...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.end ], [ 0, %for.cond ]
  %cmp3 = icmp sgt i32 %3, 0
  br i1 %cmp3, label %for.cond5, label %for.cond

for.cond5:                                        ; preds = %for.cond1, %for.body8
  %4 = phi i32 [ %.pre27, %for.body8 ], [ %2, %for.cond1 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body8 ], [ 0, %for.cond1 ]
  %cmp7 = icmp sgt i32 %4, 0
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @matrix, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond115:                                      ; preds = %for.cond, %for.body118
  %5 = phi i32 [ %.pre26, %for.body118 ], [ %1, %for.cond ]
