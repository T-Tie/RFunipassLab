...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %x, i64 0, i64 %indvars.iv29, i64 %indvars.iv
  %call6 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre42 = load i32, ptr %a, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.end23
  %indvars.iv36 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next37, %for.end23 ]
  ...
  br i1 %exitcond41.not, label %for.end26, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv32 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next33, %for.body15 ]
  %a1.1 = phi i32 [ %a1.0, %for.cond13.preheader ], [ %spec.select, %for.body15 ]
  %b1.1 = phi i32 [ %b1.0, %for.cond13.preheader ], [ %spec.select24, %for.body15 ]
  %exitcond.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %x, i64 0, i64 %indvars.iv36, i64 %indvars.iv32
  ...
  %spec.select24 = select i1 %cmp20, i32 %6, i32 %b1.1
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  ...
  %a2.1 = phi i32 [ %spec.select25, %for.body33 ], [ %a2.0, %for.cond31.preheader ]
  %b2.1 = phi i32 [ %spec.select26, %for.body33 ], [ %b2.0, %for.cond31.preheader ]
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select25 = select i1 %cmp38, i32 %i.2, i32 %a2.1
  %spec.select26 = select i1 %cmp38, i32 %j.2, i32 %b2.1
...
for.end45:                                        ; preds = %for.cond27
  ...
  %reass.sub27 = sub i32 %a2.0, %a1.0
  %add48 = add i32 %reass.sub27, 1
