...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 301, ptr noundef nonnull align 16 %zi) #3
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 16 %zi)
  unreachable
}
