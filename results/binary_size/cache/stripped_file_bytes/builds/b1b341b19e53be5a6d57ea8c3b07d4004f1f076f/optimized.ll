...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 48400, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 48400, ptr %b) #9
  call void @llvm.lifetime.start.p0(i64 48400, ptr %c) #9
...
for.body18:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [110 x [110 x i32]], ptr %b, i64 0, i64 %idxprom20
...
for.body38:                                       ; preds = %for.cond36
  ...
  %arrayidx52 = getelementptr inbounds [110 x [110 x i32]], ptr %c, i64 0, i64 %idxprom51
  %34 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom53 = sext i32 %34 to i64
  %arrayidx54 = getelementptr inbounds [110 x i32], ptr %arrayidx52, i64 0, i64 %idxprom53
...
if.then:                                          ; preds = %for.body69
  ...
  %arrayidx72 = getelementptr inbounds [110 x [110 x i32]], ptr %c, i64 0, i64 %idxprom71
  %45 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom73 = sext i32 %45 to i64
  %arrayidx74 = getelementptr inbounds [110 x i32], ptr %arrayidx72, i64 0, i64 %idxprom73
  %46 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %call75 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %46)
  %call76 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call75, ptr noundef @.str)
  br label %if.end

if.else:                                          ; preds = %for.body69
  %47 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom77 = sext i32 %47 to i64
  %arrayidx78 = getelementptr inbounds [110 x [110 x i32]], ptr %c, i64 0, i64 %idxprom77
  %48 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom79 = sext i32 %48 to i64
  %arrayidx80 = getelementptr inbounds [110 x i32], ptr %arrayidx78, i64 0, i64 %idxprom79
  %49 = load i32, ptr %arrayidx80, align 4, !tbaa !5
  %call81 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %49)
...
for.end88:                                        ; preds = %for.cond64
  ...
  call void @llvm.lifetime.end.p0(i64 48400, ptr %c) #9
  call void @llvm.lifetime.end.p0(i64 48400, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 48400, ptr %a) #9
