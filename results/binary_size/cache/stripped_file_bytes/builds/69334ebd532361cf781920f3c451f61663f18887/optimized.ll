...
for.cond:                                         ; preds = %for.inc51, %entry
  %indvars.iv27 = phi i32 [ %indvars.iv.next28, %for.inc51 ], [ 0, %entry ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc51 ], [ 0, %entry ]
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv21
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %cmp.not = icmp eq i8 %0, 0
  br i1 %cmp.not, label %for.end55, label %for.cond5

for.cond5:                                        ; preds = %for.cond, %for.cond5
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.cond5 ], [ %indvars.iv21, %for.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond5 ], [ 0, %for.cond ]
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv24 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next25, %for.body25 ]
  %exitcond.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond.not, label %for.cond.cleanup24, label %for.body25
...
for.body25:                                       ; preds = %for.cond22
  %arrayidx27 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv24
  %4 = load i8, ptr %arrayidx27, align 1, !tbaa !5
  %conv28 = sext i8 %4 to i32
  %putchar16 = call i32 @putchar(i32 %conv28)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond22, !llvm.loop !11

for.cond37:                                       ; preds = %for.body43, %for.cond.cleanup24
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body43 ], [ %indvars.iv30, %for.cond.cleanup24 ]
  %arrayidx39 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv32
