...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %rep) #9
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %0 = load i64, ptr %_M_width.i4.i, align 8, !tbaa !13, !invariant.load !12
  %1 = add i64 %0, -261
...
if.then6.i15:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i20 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  br i1 %call16.i20, label %land.lhs.true.i21, label %if.then6.i42

land.lhs.true.i21:                                ; preds = %if.then6.i15
  %_M_width.i4.i22 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i4.i22, align 8, !tbaa !13, !invariant.load !12
  %3 = add i64 %2, -261
  %or.cond.i25 = icmp ult i64 %3, -260
  br i1 %or.cond.i25, label %if.then19.i26, label %if.then6.i42

if.then19.i26:                                    ; preds = %land.lhs.true.i21
  %call24.i27 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
...
if.then6.i42:                                     ; preds = %if.then28.i33, %if.then19.i26, %land.lhs.true.i21, %if.then6.i15
  ...
  %call16.i47 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
...
land.lhs.true.i48:                                ; preds = %if.then6.i42
  %_M_width.i4.i49 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i4.i49, align 8, !tbaa !13, !invariant.load !12
  %5 = add i64 %4, -261
  %or.cond.i52 = icmp ult i64 %5, -260
...
if.then19.i53:                                    ; preds = %land.lhs.true.i48
  %call24.i54 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  ...
  %expval.i58 = call i64 @llvm.expect.i64(i64 noundef %conv.i57, i64 noundef 1)
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit61
...
while.end27:                                      ; preds = %while.cond15
  call fastcc void @outlined_ir_func_0.4(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(8) %rep)
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit61, %while.end27
  %node.sink = phi ptr [ %node, %while.end27 ], [ %start, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit61 ]
  call fastcc void @outlined_ir_func_0.4(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(8) %node.sink)
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %rep) #10
...
while.cond15.exitStub:
  ...
  %call19 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %2)
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.4(ptr noalias nofree noundef nonnull align 8 captures(none) dereferenceable(8) %0) unnamed_addr #8 {
