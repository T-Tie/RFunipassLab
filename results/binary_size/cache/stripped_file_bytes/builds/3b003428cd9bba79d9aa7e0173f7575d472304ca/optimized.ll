...
; Function Attrs: mustprogress nofree norecurse noreturn nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @_Z4zeroi(i32 noundef %i) local_unnamed_addr #0 {
for.body:
  %0 = sext i32 %i to i64
  %add.ptr13 = getelementptr inbounds [200 x i32], ptr @a, i64 %0
  br label %for.body11
...
for.body11:                                       ; preds = %for.body, %for.body11
  ...
  %1 = load i32, ptr %add.ptr16, align 4, !tbaa !5, !invariant.load !9
  %sub = add nsw i32 %1, -1000
  store i32 %sub, ptr %add.ptr16, align 4, !tbaa !5
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  br label %for.body11, !llvm.loop !10
}
...
for.cond:
  ...
  br i1 %cmp.i, label %for.body8.preheader, label %for.end141

for.body8.preheader:                              ; preds = %for.cond
  store i32 0, ptr getelementptr inbounds nuw (i8, ptr @sum, i64 4), align 4, !tbaa !5
  br label %for.body8

for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  %indvars.iv28 = phi i64 [ 1, %for.body8.preheader ], [ %indvars.iv.next29, %for.body8 ]
  %add.ptr10 = getelementptr inbounds nuw i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 800), i64 %indvars.iv28
  ...
  br label %for.body8, !llvm.loop !13
...
attributes #0 = { mustprogress nofree norecurse noreturn nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
