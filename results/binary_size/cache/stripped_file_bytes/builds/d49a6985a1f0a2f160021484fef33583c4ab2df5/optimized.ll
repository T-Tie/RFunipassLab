...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.end ], [ 1, %entry ]
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.end26 ], [ 1, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc24 ], [ 1, %for.cond13 ]
  %4 = load i32, ptr %y2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv35, %5
  br i1 %cmp17.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv38, i64 %indvars.iv35
...
for.cond33:                                       ; preds = %for.cond40.preheader.peel, %for.cond40.preheader
  ...
  %call63.peel = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, i32 noundef 0)
