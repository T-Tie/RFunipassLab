...
while.cond3:                                      ; preds = %while.cond, %while.body16
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %while.body16 ], [ 0, %while.cond ]
...
while.body16:                                     ; preds = %land.end15
  ...
  %indvars.iv.next26 = add nuw nsw i32 %indvars.iv25, 1
  br label %while.cond3, !llvm.loop !12

while.end:                                        ; preds = %while.cond3, %land.end15
  %wide.trip.count29 = zext nneg i32 %indvars.iv25 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.end, %while.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.end ], [ 0, %while.end ]
  %n.0 = phi i32 [ %n.1, %for.end ], [ 0, %while.end ]
  %exitcond30.not = icmp eq i64 %indvars.iv20, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end36, label %for.cond18.preheader
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body20
  %indvars.iv22 = phi i64 [ %indvars.iv20, %for.cond18.preheader ], [ %indvars.iv.next23, %for.body20 ]
  %n.1 = phi i32 [ %n.0, %for.cond18.preheader ], [ %n.2, %for.body20 ]
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count29
  br i1 %exitcond.not, label %for.end, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %2 = load i32, ptr %arrayidx22, align 4, !tbaa !9, !invariant.load !8
  %arrayidx24 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv.next23
  ...
  %or.cond18 = select i1 %cmp25, i1 true, i1 %cmp31
  %inc32 = zext i1 %or.cond18 to i32
