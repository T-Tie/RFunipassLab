...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc
  ...
  br i1 %exitcond31.not, label %for.end, label %for.inc
...
if.then14:                                        ; preds = %for.end
  %puts10 = call i32 @puts(ptr nonnull dereferenceable(1) @str.6)
  br label %for.inc82

if.else:                                          ; preds = %for.end
  %puts9 = call i32 @puts(ptr nonnull dereferenceable(1) @str.5)
  br label %for.inc82
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc27
  ...
  br i1 %exitcond24.not, label %for.end29, label %for.inc27
...
for.end29:                                        ; preds = %for.cond20
  call void @outlined_ir_func_0(i32 %total.1)
  br label %for.inc82
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc49
  ...
  br i1 %exitcond18.not, label %for.end51, label %for.inc49
...
if.then54:                                        ; preds = %for.end51
  %puts8 = call i32 @puts(ptr nonnull dereferenceable(1) @str.4)
  br label %for.inc82
...
for.cond62:                                       ; preds = %for.cond62.preheader, %for.inc69
  ...
  br i1 %exitcond.not, label %for.end71, label %for.inc69
...
for.end71:                                        ; preds = %for.cond62
  call void @outlined_ir_func_0(i32 %total.3)
  br label %for.inc82

for.inc82:                                        ; preds = %for.end71, %for.end29, %if.else17, %if.then14, %if.else, %if.else59, %if.then54, %if.else56
...
define internal void @outlined_ir_func_0(i32 %0) #4 {
for.end29_to_outline:
  %rem30 = srem i32 %0, 7
  %cmp31 = icmp eq i32 %rem30, 0
  %str.2.str = select i1 %cmp31, ptr @str.2, ptr @str
