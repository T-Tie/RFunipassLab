...
for.cond:                                         ; preds = %if.end, %entry
  %p.0 = phi ptr [ %str, %entry ], [ %incdec.ptr, %if.end ]
  %q.0 = phi ptr [ %b, %entry ], [ %incdec.ptr11, %if.end ]
...
for.cond14:                                       ; preds = %for.cond, %if.end23
  %p.1 = phi ptr [ %incdec.ptr25, %if.end23 ], [ %str, %for.cond ]
  %q.1 = phi ptr [ %incdec.ptr26, %if.end23 ], [ %b, %for.cond ]
