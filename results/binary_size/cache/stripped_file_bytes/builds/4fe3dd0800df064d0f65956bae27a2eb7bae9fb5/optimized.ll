...
land.lhs.true.i16:                                ; preds = %if.then6.i10
  %_M_width.i8.i17 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i8.i17, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -258
  %or.cond.i20 = icmp ult i64 %3, -257
...
land.lhs.true.i43:                                ; preds = %if.then6.i37
  %_M_width.i8.i44 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i8.i44, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -258
  %or.cond.i47 = icmp ult i64 %5, -257
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv59 = phi i32 [ %conv, %for.cond.preheader ], [ %indvars.iv.next60, %for.inc ]
...
for.end:                                          ; preds = %for.cond
  ...
  %7 = sext i32 %indvars.iv59 to i64
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc27, %for.end
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc27 ], [ %7, %for.end ]
  %call21 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #13
  %cmp22 = icmp ugt i64 %call21, %indvars.iv61
  br i1 %cmp22, label %for.inc27, label %if.end

for.inc27:                                        ; preds = %for.cond18
  %arrayidx25 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 %indvars.iv61
