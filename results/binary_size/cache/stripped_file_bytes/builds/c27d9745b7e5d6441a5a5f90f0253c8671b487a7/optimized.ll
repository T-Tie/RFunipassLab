...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80004, ptr noundef nonnull align 16 %num) #4
...
for.end100:                                       ; preds = %for.cond88
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80004, ptr noundef nonnull %num) #5
