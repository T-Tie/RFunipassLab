...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %n) #5
...
_ZNSi7getlineEPcl.exit:                           ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call2.i = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPclc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %n, i64 noundef 50, i8 noundef signext %retval.0.i.i.i)
  call void @_Z1fPc(ptr noundef nonnull %n)
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %n) #5
  ret i32 0
}
...
entry:
  ...
  %.pre = load i8, ptr %p, align 1, !tbaa !34
...
if.else.peel:                                     ; preds = %entry
  ...
  %0 = load i8, ptr %add.ptr.peel, align 1, !tbaa !34
...
tailrecurse:                                      ; preds = %if.else.peel, %tailrecurse
  ...
  %1 = load i8, ptr %add.ptr, align 1, !tbaa !34
  %cmp5.not = icmp eq i8 %1, 32
  br i1 %cmp5.not, label %tailrecurse, label %if.then6, !llvm.loop !35

if.then3:                                         ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %.pre, ptr %__c.addr.i, align 1, !tbaa !34
  ...
  %2 = load i64, ptr %_M_width.i.i, align 8, !tbaa !37
...
if.then6:                                         ; preds = %tailrecurse, %if.else.peel
  ...
  store i8 32, ptr %__c.addr.i8, align 1, !tbaa !34
  ...
  %3 = load i64, ptr %_M_width.i.i13, align 8, !tbaa !37
