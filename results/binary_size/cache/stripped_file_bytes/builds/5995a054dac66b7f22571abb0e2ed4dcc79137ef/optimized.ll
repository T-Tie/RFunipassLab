...
entry:
  ...
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %a, ptr noundef nonnull %b, ptr noundef nonnull %c, ptr noundef nonnull %d, ptr noundef nonnull %e, ptr noundef nonnull %f)
  %0 = load i32, ptr %d, align 4, !tbaa !5
  %cmp2 = icmp eq i32 %0, 0
  br i1 %cmp2, label %for.end, label %if.else

if.else:                                          ; preds = %entry, %if.else
  %1 = phi i32 [ %9, %if.else ], [ %0, %entry ]
  %2 = load i32, ptr %c, align 4, !tbaa !5
  %3 = load i32, ptr %f, align 4, !tbaa !5
  %4 = load i32, ptr %b, align 4, !tbaa !5
  %5 = load i32, ptr %e, align 4, !tbaa !5
  %add6 = add nsw i32 %1, 12
  %6 = load i32, ptr %a, align 4, !tbaa !5
  %7 = xor i32 %6, -1
  %sub8 = add i32 %add6, %7
  %mul9 = mul nsw i32 %sub8, 3600
  %reass.sub = sub i32 %5, %4
  %8 = mul i32 %reass.sub, 60
  %reass.sub3 = sub i32 %3, %2
  %reass.mul = add i32 %reass.sub3, %8
  %add5 = add i32 %reass.mul, 3600
  ...
  %cmp = icmp eq i32 %9, 0
  br i1 %cmp, label %for.end, label %if.else, !llvm.loop !9
