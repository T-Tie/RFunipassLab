...
entry:
  ...
  store i32 100, ptr %rmb, align 16, !tbaa !5
  %arrayidx1 = getelementptr inbounds nuw i8, ptr %rmb, i64 4
  store i32 50, ptr %arrayidx1, align 4, !tbaa !5
  %arrayidx2 = getelementptr inbounds nuw i8, ptr %rmb, i64 8
  store i32 20, ptr %arrayidx2, align 8, !tbaa !5
  %arrayidx3 = getelementptr inbounds nuw i8, ptr %rmb, i64 12
...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %sub9 = phi i32 [ %sub.recomposed, %for.body ], [ %a.promoted, %entry ]
...
for.cond13.preheader:                             ; preds = %for.cond
  store i32 %sub9, ptr %a, align 4, !tbaa !5
  br label %for.cond13
...
for.body:                                         ; preds = %for.cond
  ...
  %sub.recomposed = srem i32 %sub9, %0
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  ...
  %exitcond14.not = icmp eq i64 %indvars.iv11, 5
  br i1 %exitcond14.not, label %for.end21, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [6 x i32], ptr %sz, i64 0, i64 %indvars.iv11
