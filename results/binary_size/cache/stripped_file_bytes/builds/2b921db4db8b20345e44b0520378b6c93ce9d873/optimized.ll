...
while.cond:                                       ; preds = %if.end32, %entry
  %k.0 = phi i32 [ undef, %entry ], [ %k.211, %if.end32 ]
  %flag.0 = phi i32 [ 1, %entry ], [ %flag.112, %if.end32 ]
...
for.cond11:                                       ; preds = %for.end, %for.end27
  %indvars.iv20 = phi i64 [ 0, %for.end ], [ %indvars.iv.next21, %for.end27 ]
...
for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv20
  br label %for.cond14
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  ...
  br i1 %exitcond19.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %2 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %arrayidx20 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv16
...
for.end30:                                        ; preds = %for.cond11
  %call31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %s.0) #6
  br label %if.end32

if.end32:                                         ; preds = %for.body, %for.end30
  %flag.112 = phi i32 [ %flag.0, %for.end30 ], [ 0, %for.body ]
  %k.211 = phi i32 [ %k.2, %for.end30 ], [ %1, %for.body ]
  br label %while.cond, !llvm.loop !15

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 60, ptr noundef nonnull align 16 %a) #6
  ret i32 0
}
