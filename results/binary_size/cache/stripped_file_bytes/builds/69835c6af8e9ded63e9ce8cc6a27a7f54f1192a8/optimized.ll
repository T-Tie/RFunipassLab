...
for.cond:                                         ; preds = %for.inc7, %while.body
  ...
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc7 ], [ 0, %while.body ]
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv72, %6
...
for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv72, %2
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %8
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %9 = phi i32 [ %5, %for.cond1.preheader ], [ %.pre128, %for.inc ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc137
  %indvars.iv125 = phi i64 [ %7, %for.cond10.preheader ], [ %indvars.iv.next126, %for.inc137 ]
  %sum.0 = phi i32 [ 0, %for.cond10.preheader ], [ %add, %for.inc137 ]
  %11 = trunc nuw i64 %indvars.iv125 to i32
  %cmp11 = icmp sgt i32 %11, 1
  br i1 %cmp11, label %for.cond13, label %for.end138

for.cond13:                                       ; preds = %for.cond10, %for.inc48
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc48 ], [ 0, %for.cond10 ]
  %exitcond87.not = icmp eq i64 %indvars.iv83, %indvars.iv125
  br i1 %exitcond87.not, label %for.cond51, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %12 = mul nuw nsw i64 %indvars.iv83, %2
...
for.cond19:                                       ; preds = %for.body21, %for.body15
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.body21 ], [ 1, %for.body15 ]
  %min.0 = phi i32 [ %spec.select, %for.body21 ], [ %13, %for.body15 ]
  %exitcond.not = icmp eq i64 %indvars.iv75, %indvars.iv125
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw i32, ptr %arrayidx17, i64 %indvars.iv75
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc45 ], [ 0, %for.cond34.preheader ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %indvars.iv125
  br i1 %exitcond82.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw i32, ptr %arrayidx17, i64 %indvars.iv78
...
for.cond51:                                       ; preds = %for.cond13, %for.inc90
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.inc90 ], [ 0, %for.cond13 ]
  %exitcond102.not = icmp eq i64 %indvars.iv98, %indvars.iv125
  br i1 %exitcond102.not, label %for.end92, label %for.body53

for.body53:                                       ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv98
  %16 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body53
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.body60 ], [ 1, %for.body53 ]
  %min54.0 = phi i32 [ %spec.select68, %for.body60 ], [ %16, %for.body53 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %indvars.iv125
...
for.body60:                                       ; preds = %for.cond58
  %17 = mul nuw nsw i64 %indvars.iv88, %2
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  ...
  %exitcond97.not = icmp eq i64 %indvars.iv93, %indvars.iv125
  br i1 %exitcond97.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %19 = mul nuw nsw i64 %indvars.iv93, %2
  %gep70 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %19
  %20 = load i32, ptr %gep70, align 4, !tbaa !5, !invariant.load !13
  %sub82 = sub nsw i32 %20, %min54.0
  store i32 %sub82, ptr %gep70, align 4, !tbaa !5
...
for.cond95:                                       ; preds = %for.inc113, %for.end92
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.inc113 ], [ 2, %for.end92 ]
  %exitcond112.not = icmp eq i64 %indvars.iv108, %indvars.iv125
  br i1 %exitcond112.not, label %for.cond116, label %for.cond98.preheader

for.cond98.preheader:                             ; preds = %for.cond95
  %invariant.gep = getelementptr i32, ptr %vla, i64 %indvars.iv108
  br label %for.cond98

for.cond98:                                       ; preds = %for.cond98.preheader, %for.inc110
  %indvars.iv103 = phi i64 [ 0, %for.cond98.preheader ], [ %indvars.iv.next104, %for.inc110 ]
  %exitcond107.not = icmp eq i64 %indvars.iv103, %indvars.iv125
  br i1 %exitcond107.not, label %for.inc113, label %for.inc110

for.inc110:                                       ; preds = %for.cond98
  %22 = mul nuw nsw i64 %indvars.iv103, %2
  %gep130 = getelementptr i32, ptr %invariant.gep, i64 %22
  %23 = load i32, ptr %gep130, align 4, !tbaa !5, !invariant.load !13
  %arrayidx109 = getelementptr i8, ptr %gep130, i64 -4
...
for.cond116:                                      ; preds = %for.cond95, %for.inc134
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc134 ], [ 2, %for.cond95 ]
  %exitcond123.not = icmp eq i64 %indvars.iv118, %indvars.iv125
  br i1 %exitcond123.not, label %for.inc137, label %for.cond119.preheader

for.cond119.preheader:                            ; preds = %for.cond116
  %24 = mul nuw nsw i64 %indvars.iv118, %2
  %arrayidx123 = getelementptr inbounds nuw i32, ptr %vla, i64 %24
  %25 = add nsw i64 %indvars.iv118, -1
...
for.cond119:                                      ; preds = %for.cond119.preheader, %for.inc131
  %indvars.iv113 = phi i64 [ 0, %for.cond119.preheader ], [ %indvars.iv.next114, %for.inc131 ]
  %exitcond117.not = icmp eq i64 %indvars.iv113, %indvars.iv125
  br i1 %exitcond117.not, label %for.inc134, label %for.inc131

for.inc131:                                       ; preds = %for.cond119
  %arrayidx125 = getelementptr inbounds nuw i32, ptr %arrayidx123, i64 %indvars.iv113
  %27 = load i32, ptr %arrayidx125, align 4, !tbaa !5, !invariant.load !13
  %arrayidx130 = getelementptr inbounds nuw i32, ptr %arrayidx128, i64 %indvars.iv113
