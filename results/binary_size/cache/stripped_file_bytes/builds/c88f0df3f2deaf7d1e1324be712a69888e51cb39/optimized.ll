...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 120, ptr %count) #6
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [30 x i32], ptr %count, i64 0, i64 %idxprom2
...
for.body9:                                        ; preds = %for.cond7
  ...
  br i1 %cmp14, label %if.then, label %if.end26

if.then:                                          ; preds = %for.body9
  %13 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom15 = sext i32 %13 to i64
  %arrayidx16 = getelementptr inbounds [30 x i32], ptr %count, i64 0, i64 %idxprom15
  %14 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %15 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom17 = sext i32 %15 to i64
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %count, i64 0, i64 %idxprom17
  %16 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %add = add nsw i32 %16, 1
  %cmp19 = icmp slt i32 %14, %add
  br i1 %cmp19, label %if.then20, label %if.end

if.then20:                                        ; preds = %if.then
  %17 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom21 = sext i32 %17 to i64
  %arrayidx22 = getelementptr inbounds [30 x i32], ptr %count, i64 0, i64 %idxprom21
  %18 = load i32, ptr %arrayidx22, align 4, !tbaa !5
  %add23 = add nsw i32 %18, 1
  %19 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom24 = sext i32 %19 to i64
  %arrayidx25 = getelementptr inbounds [30 x i32], ptr %count, i64 0, i64 %idxprom24
...
if.end26:                                         ; preds = %if.end, %for.body9
  br label %for.inc27
...
for.body35:                                       ; preds = %for.cond33
  ...
  %cmp38 = icmp sgt i32 %25, %26
  br i1 %cmp38, label %if.then39, label %if.end42

if.then39:                                        ; preds = %for.body35
  %27 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom40 = sext i32 %27 to i64
  %arrayidx41 = getelementptr inbounds [30 x i32], ptr %count, i64 0, i64 %idxprom40
  %28 = load i32, ptr %arrayidx41, align 4, !tbaa !5
  store i32 %28, ptr %max, align 4, !tbaa !5
  br label %if.end42

if.end42:                                         ; preds = %if.then39, %for.body35
  br label %for.inc43
...
for.end45:                                        ; preds = %for.cond33
  ...
  %call46 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %30)
  ...
  call void @llvm.lifetime.end.p0(i64 120, ptr %count) #6
