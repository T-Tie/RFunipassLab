...
@c = dso_local global [502 x i8] zeroinitializer, align 16
...
entry:
  ...
  store ptr @b, ptr %q, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 8, ptr %r) #11
  store ptr @c, ptr %r, align 8, !tbaa !5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef @a)
  call void @llvm.lifetime.start.p0(i64 4, ptr %len) #11
  %call2 = call i64 @strlen(ptr noundef @a) #12
  %conv = trunc i64 %call2 to i32
  store i32 %conv, ptr %len, align 4, !tbaa !10
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %3 = load i32, ptr %j, align 4, !tbaa !10
...
for.body5:                                        ; preds = %for.cond3
  ...
  %8 = load i8, ptr %add.ptr7, align 1, !tbaa !12
  %9 = load ptr, ptr %q, align 8, !tbaa !5
  %10 = load i32, ptr %i, align 4, !tbaa !10
  %idxprom = sext i32 %10 to i64
  %arrayidx = getelementptr inbounds [6 x i8], ptr %9, i64 %idxprom
  %11 = load i32, ptr %j, align 4, !tbaa !10
  %idxprom8 = sext i32 %11 to i64
  %arrayidx9 = getelementptr inbounds [6 x i8], ptr %arrayidx, i64 0, i64 %idxprom8
  store i8 %8, ptr %arrayidx9, align 1, !tbaa !12
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %12 = load i32, ptr %j, align 4, !tbaa !10
...
for.cond13:                                       ; preds = %for.inc34, %for.end12
  %14 = load i32, ptr %i, align 4, !tbaa !10
  %15 = load i32, ptr %len, align 4, !tbaa !10
...
for.body20:                                       ; preds = %for.cond17
  ...
  %arrayidx22 = getelementptr inbounds [6 x i8], ptr %21, i64 %idxprom21
  %arraydecay = getelementptr inbounds [6 x i8], ptr %arrayidx22, i64 0, i64 0
  %23 = load ptr, ptr %q, align 8, !tbaa !5
  %24 = load i32, ptr %j, align 4, !tbaa !10
  %idxprom23 = sext i32 %24 to i64
  %arrayidx24 = getelementptr inbounds [6 x i8], ptr %23, i64 %idxprom23
  %arraydecay25 = getelementptr inbounds [6 x i8], ptr %arrayidx24, i64 0, i64 0
  %call26 = call i32 @strcmp(ptr noundef %arraydecay, ptr noundef %arraydecay25) #12
  %cmp27 = icmp eq i32 %call26, 0
  br i1 %cmp27, label %if.then, label %if.end

if.then:                                          ; preds = %for.body20
  %25 = load ptr, ptr %r, align 8, !tbaa !5
  %26 = load i32, ptr %i, align 4, !tbaa !10
  %idxprom28 = sext i32 %26 to i64
  %arrayidx29 = getelementptr inbounds i8, ptr %25, i64 %idxprom28
  %27 = load i8, ptr %arrayidx29, align 1, !tbaa !12
  %inc30 = add i8 %27, 1
  store i8 %inc30, ptr %arrayidx29, align 1, !tbaa !12
  br label %if.end
...
if.then46:                                        ; preds = %for.body41
  ...
  %40 = load i8, ptr %arrayidx48, align 1, !tbaa !12
  %conv49 = sext i8 %40 to i32
  store i32 %conv49, ptr %max, align 4, !tbaa !10
  br label %if.end50
...
for.inc51:                                        ; preds = %if.end50
  ...
  store i32 %inc52, ptr %i, align 4, !tbaa !10
  br label %for.cond38, !llvm.loop !19

for.end53:                                        ; preds = %for.cond38
  %42 = load i32, ptr %max, align 4, !tbaa !10
  %cmp54 = icmp sle i32 %42, 0
...
if.else:                                          ; preds = %for.end53
  %43 = load i32, ptr %max, align 4, !tbaa !10
...
for.cond60:                                       ; preds = %for.inc75, %if.else
  ...
  %45 = load i32, ptr %len, align 4, !tbaa !10
  %46 = load i32, ptr %n, align 4, !tbaa !10
  %sub61 = sub nsw i32 %45, %46
  %cmp62 = icmp slt i32 %44, %sub61
  br i1 %cmp62, label %for.body63, label %for.end77
...
for.body63:                                       ; preds = %for.cond60
  ...
  %49 = load i8, ptr %arrayidx65, align 1, !tbaa !12
  %conv66 = sext i8 %49 to i32
  %50 = load i32, ptr %max, align 4, !tbaa !10
...
if.then68:                                        ; preds = %for.body63
  ...
  %arrayidx70 = getelementptr inbounds [6 x i8], ptr %51, i64 %idxprom69
  %arraydecay71 = getelementptr inbounds [6 x i8], ptr %arrayidx70, i64 0, i64 0
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay71)
...
entry:
  ...
  store ptr %__c1, ptr %__c1.addr, align 8, !tbaa !56
  store ptr %__c2, ptr %__c2.addr, align 8, !tbaa !56
  %0 = load ptr, ptr %__c1.addr, align 8, !tbaa !56, !nonnull !25, !align !58
  %1 = load i32, ptr %0, align 4, !tbaa !10
  %2 = load ptr, ptr %__c2.addr, align 8, !tbaa !56, !nonnull !25, !align !58
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !60
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %__c.addr, align 8, !tbaa !5, !nonnull !25
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !63
...
entry:
  ...
  store ptr %__f, ptr %__f.addr, align 8, !tbaa !64
  %0 = load ptr, ptr %__f.addr, align 8, !tbaa !64
  %tobool = icmp ne ptr %0, null
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %__f.addr, align 8, !tbaa !64
  ret ptr %1
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !65
...
!34 = !{!7, !7, i64 0}
!35 = !{!36, !36, i64 0}
!36 = !{!"p1 _ZTSSt8ios_base", !7, i64 0}
!37 = !{!38, !24, i64 16}
!38 = !{!"_ZTSSt8ios_base", !24, i64 8, !24, i64 16, !39, i64 24, !40, i64 28, !40, i64 32, !41, i64 40, !42, i64 48, !8, i64 64, !11, i64 192, !43, i64 200, !44, i64 208}
!39 = !{!"_ZTSSt13_Ios_Fmtflags", !8, i64 0}
!40 = !{!"_ZTSSt12_Ios_Iostate", !8, i64 0}
!41 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !7, i64 0}
!42 = !{!"_ZTSNSt8ios_base6_WordsE", !7, i64 0, !24, i64 8}
!43 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !7, i64 0}
!44 = !{!"_ZTSSt6locale", !45, i64 0}
!45 = !{!"p1 _ZTSNSt6locale5_ImplE", !7, i64 0}
!46 = !{!47, !47, i64 0}
!47 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !7, i64 0}
!48 = !{!40, !40, i64 0}
!49 = !{!50, !51, i64 232}
!50 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !38, i64 0, !33, i64 216, !8, i64 224, !30, i64 225, !51, i64 232, !52, i64 240, !53, i64 248, !54, i64 256}
...
!59 = !{!38, !40, i64 32}
!60 = !{!61, !6, i64 16}
!61 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !44, i64 56}
!62 = !{!61, !6, i64 24}
!63 = !{!50, !52, i64 240}
!64 = !{!52, !52, i64 0}
!65 = !{!66, !8, i64 56}
!66 = !{!"_ZTSSt5ctypeIcE", !67, i64 0, !68, i64 16, !30, i64 24, !57, i64 32, !57, i64 40, !69, i64 48, !8, i64 56, !8, i64 57, !8, i64 313, !8, i64 569}
