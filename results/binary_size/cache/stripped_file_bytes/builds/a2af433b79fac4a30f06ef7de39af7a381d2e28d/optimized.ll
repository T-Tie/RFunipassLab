...
for.cond:                                         ; preds = %for.inc13, %entry
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc13 ], [ 0, %entry ]
...
for.cond1.preheader:                              ; preds = %for.cond
  %6 = mul nuw nsw i64 %indvars.iv6, %1
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %8 = phi i32 [ %4, %for.cond1.preheader ], [ %.pre16, %for.inc ]
...
for.cond16:                                       ; preds = %for.cond20, %for.cond16.preheader
  %indvars.iv13 = phi i64 [ %5, %for.cond16.preheader ], [ %indvars.iv.next14, %for.cond20 ]
  ...
  %cmp17 = icmp sgt i64 %indvars.iv13, 0
  br i1 %cmp17, label %for.body18, label %for.end41

for.body18:                                       ; preds = %for.cond16
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %13 = mul nsw i64 %indvars.iv.next14, %1
  %arrayidx24 = getelementptr inbounds i32, ptr %vla, i64 %13
  %14 = sext i32 %12 to i64
  %15 = trunc nsw i64 %indvars.iv.next14 to i32
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc37, %for.body18
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc37 ], [ %14, %for.body18 ]
  ...
  %cmp21 = icmp sgt i64 %indvars.iv9, 0
  br i1 %cmp21, label %for.body22, label %for.cond16, !llvm.loop !14

for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds i32, ptr %arrayidx24, i64 %indvars.iv.next10
...
if.then35:                                        ; preds = %land.lhs.true29
  %17 = trunc nsw i64 %indvars.iv.next10 to i32
  br label %for.inc37
