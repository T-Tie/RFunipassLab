...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %z) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %e) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %y) #5
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull %x) #5
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.body32
  %indvars.iv5 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next6, %for.body32 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond.not, label %for.end39, label %for.body32

for.body32:                                       ; preds = %for.cond30
  %arrayidx34 = getelementptr inbounds nuw [100 x [10 x i8]], ptr %x, i64 0, i64 %indvars.iv5
