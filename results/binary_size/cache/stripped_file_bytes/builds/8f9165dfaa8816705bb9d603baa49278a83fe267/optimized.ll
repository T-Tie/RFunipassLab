...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv20
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv25 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next26, %for.body15 ]
  %cmp14 = icmp sgt i64 %indvars.iv25, 0
  br i1 %cmp14, label %for.body15, label %for.end33

for.body15:                                       ; preds = %for.cond13
  %indvars.iv.next26 = add nsw i64 %indvars.iv25, -1
  %arrayidx17 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next26
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body24
  %indvars.iv29 = phi i64 [ %indvars.iv25, %for.cond22.preheader ], [ %indvars.iv.next30, %for.body24 ]
  %6 = icmp sgt i64 %indvars.iv29, %sext
  br i1 %6, label %for.end33.loopexit, label %for.body24

for.body24:                                       ; preds = %for.cond22
  %arrayidx26 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv29
...
for.end33.loopexit:                               ; preds = %for.cond22
  %8 = trunc nsw i64 %indvars.iv.next26 to i32
  %.pre48 = and i64 %indvars.iv.next26, 4294967295
  br label %for.end33
...
for.cond35:                                       ; preds = %if.end54, %for.end33
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %if.end54 ], [ %9, %for.end33 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %if.end54 ], [ %.pre-phi, %for.end33 ]
  %j.2 = phi i32 [ %j.3, %if.end54 ], [ %j.1, %for.end33 ]
  %indvars.iv.next38 = add nsw i64 %indvars.iv37, -1
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, -1
  %cmp36 = icmp sgt i64 %indvars.iv37, 0
  br i1 %cmp36, label %for.body37, label %for.end57

for.body37:                                       ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next38
  %10 = load i8, ptr %arrayidx39, align 1, !tbaa !5, !invariant.load !11
  %cmp41 = icmp eq i8 %10, 32
...
for.cond45:                                       ; preds = %for.body47, %if.then42
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body47 ], [ %indvars.iv32, %if.then42 ]
  %11 = trunc nuw i64 %indvars.iv34 to i32
  %cmp46 = icmp sgt i32 %j.2, %11
  br i1 %cmp46, label %for.body47, label %if.end54.loopexit

for.body47:                                       ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv34
  %12 = load i8, ptr %arrayidx49, align 1, !tbaa !5
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %12)
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  br label %for.cond45, !llvm.loop !15

if.end54.loopexit:                                ; preds = %for.cond45
  %13 = trunc nsw i64 %indvars.iv.next38 to i32
  br label %if.end54

if.end54:                                         ; preds = %if.end54.loopexit, %for.body37
  %j.3 = phi i32 [ %j.2, %for.body37 ], [ %13, %if.end54.loopexit ]
...
for.cond74:                                       ; preds = %for.end10, %for.body76
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.body76 ], [ 0, %for.end10 ]
  %exitcond47 = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond47, label %if.end83, label %for.body76

for.body76:                                       ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv43
  %14 = load i8, ptr %arrayidx78, align 1, !tbaa !5, !invariant.load !11
  %call79 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %14)
