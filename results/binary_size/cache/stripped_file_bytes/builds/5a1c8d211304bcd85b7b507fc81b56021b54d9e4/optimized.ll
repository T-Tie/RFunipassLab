...
for.cond:                                         ; preds = %for.inc9, %entry
  ...
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc9 ], [ 0, %entry ]
  %12 = sext i32 %11 to i64
  %cmp = icmp slt i64 %indvars.iv45, %12
  br i1 %cmp, label %for.cond3.preheader, label %for.cond12.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %13 = mul nuw nsw i64 %indvars.iv45, %3
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.body5
  %14 = phi i32 [ %10, %for.cond3.preheader ], [ %.pre89, %for.body5 ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.body14
  %indvars.iv48 = phi i64 [ 0, %for.cond12.preheader ], [ %indvars.iv.next49, %for.body14 ]
  %exitcond.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond.not, label %for.cond23.preheader, label %for.body14

for.cond23.preheader:                             ; preds = %for.cond12
  %smax55 = call i32 @llvm.smax.i32(i32 %10, i32 0)
  %wide.trip.count56 = zext nneg i32 %smax55 to i64
  br label %for.cond23

for.body14:                                       ; preds = %for.cond12
  %16 = mul nuw nsw i64 %indvars.iv48, %3
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %16
  %17 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv48
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.body25
  %indvars.iv52 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next53, %for.body25 ]
  %exitcond57.not = icmp eq i64 %indvars.iv52, %wide.trip.count56
  br i1 %exitcond57.not, label %for.cond34, label %for.body25

for.body25:                                       ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv52
  %18 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv52
  store i32 %18, ptr %arrayidx30, align 4, !tbaa !5
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  br label %for.cond23, !llvm.loop !14

for.cond34:                                       ; preds = %for.cond23, %for.inc56
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc56 ], [ 0, %for.cond23 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond67.not, label %for.cond59, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond34
  %19 = mul nuw nsw i64 %indvars.iv63, %3
  %arrayidx41 = getelementptr inbounds nuw i32, ptr %vla, i64 %19
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv63
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv58 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next59, %for.body39 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count56
  br i1 %exitcond62.not, label %for.inc56, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw i32, ptr %arrayidx41, i64 %indvars.iv58
...
for.cond59:                                       ; preds = %for.cond34, %for.inc83
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc83 ], [ 0, %for.cond34 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count56
  br i1 %exitcond77.not, label %for.cond86, label %for.cond62.preheader

for.cond62.preheader:                             ; preds = %for.cond59
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv73
  %arrayidx70 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv73
  br label %for.cond62

for.cond62:                                       ; preds = %for.cond62.preheader, %for.body64
  %indvars.iv68 = phi i64 [ 0, %for.cond62.preheader ], [ %indvars.iv.next69, %for.body64 ]
  %exitcond72.not = icmp eq i64 %indvars.iv68, %wide.trip.count
  br i1 %exitcond72.not, label %for.inc83, label %for.body64

for.body64:                                       ; preds = %for.cond62
  %22 = mul nuw nsw i64 %indvars.iv68, %3
  ...
  %spec.store.select42 = call i32 @llvm.smin.i32(i32 %23, i32 %24)
  store i32 %spec.store.select42, ptr %arrayidx70, align 4
...
for.cond86:                                       ; preds = %for.cond59, %for.inc103
  %.pre8586 = phi i32 [ %.pre8587, %for.inc103 ], [ %10, %for.cond59 ]
  %25 = phi i32 [ %29, %for.inc103 ], [ %10, %for.cond59 ]
  %26 = phi i32 [ %.pre84, %for.inc103 ], [ %11, %for.cond59 ]
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc103 ], [ 0, %for.cond59 ]
  %k.0 = phi i32 [ %k.1, %for.inc103 ], [ 0, %for.cond59 ]
  %27 = sext i32 %26 to i64
  %cmp87 = icmp slt i64 %indvars.iv81, %27
  br i1 %cmp87, label %for.cond89.preheader, label %for.end105

for.cond89.preheader:                             ; preds = %for.cond86
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv81
  %28 = trunc nuw nsw i64 %indvars.iv81 to i32
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc100
  %.pre8587 = phi i32 [ %.pre8586, %for.cond89.preheader ], [ %.pre85, %for.inc100 ]
  %29 = phi i32 [ %25, %for.cond89.preheader ], [ %.pre85, %for.inc100 ]
  %indvars.iv78 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next79, %for.inc100 ]
  %k.1 = phi i32 [ %k.0, %for.cond89.preheader ], [ %k.2, %for.inc100 ]
  %30 = sext i32 %29 to i64
  %cmp90 = icmp slt i64 %indvars.iv78, %30
  br i1 %cmp90, label %for.body91, label %for.inc103

for.body91:                                       ; preds = %for.cond89
  %31 = load i32, ptr %arrayidx93, align 4, !tbaa !5
  %arrayidx95 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv78
  %32 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %cmp96 = icmp eq i32 %31, %32
  br i1 %cmp96, label %if.then97, label %for.inc100

if.then97:                                        ; preds = %for.body91
  %33 = trunc nuw nsw i64 %indvars.iv78 to i32
  %call98 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %28, i32 noundef %33)
  %.pre85.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc100

for.inc100:                                       ; preds = %for.body91, %if.then97
  %.pre85 = phi i32 [ %.pre85.pre, %if.then97 ], [ %.pre8587, %for.body91 ]
...
for.inc103:                                       ; preds = %for.cond89
  ...
  %.pre84 = load i32, ptr %m, align 4, !tbaa !5
