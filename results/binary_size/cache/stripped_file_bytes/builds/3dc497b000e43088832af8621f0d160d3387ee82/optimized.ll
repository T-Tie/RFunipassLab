...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80004, ptr noundef nonnull align 16 %num) #6
...
for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count44 = sext i32 %0 to i64
  br label %for.cond31
...
for.cond31:                                       ; preds = %for.cond31.preheader, %if.end82
  ...
  %i30.0 = phi i32 [ %inc.i5, %if.end82 ], [ 0, %for.cond31.preheader ]
...
for.cond43:                                       ; preds = %land.lhs.true, %for.inc52
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc52 ], [ %idxprom35, %land.lhs.true ]
  %exitcond.not = icmp eq i64 %indvars.iv35, %wide.trip.count44
  br i1 %exitcond.not, label %for.end55, label %for.inc52

for.inc52:                                        ; preds = %for.cond43
  %indvars.iv.next36 = add nsw i64 %indvars.iv35, 1
  %arrayidx49 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv.next36
  %4 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %arrayidx51 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv35
...
for.cond67:                                       ; preds = %land.lhs.true, %for.inc76
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc76 ], [ %idxprom35, %land.lhs.true ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45.not, label %for.end79, label %for.inc76

for.inc76:                                        ; preds = %for.cond67
  %indvars.iv.next40 = add nsw i64 %indvars.iv39, 1
  %arrayidx73 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv.next40
  %5 = load i32, ptr %arrayidx73, align 4, !tbaa !5, !invariant.load !9
  %arrayidx75 = getelementptr inbounds [20001 x i32], ptr %num, i64 0, i64 %indvars.iv39
...
if.end82:                                         ; preds = %for.body34, %for.end79, %for.end55
  ...
  %inc.i5 = add nsw i32 %i30.1, 1
  br label %for.cond31

for.cond88:                                       ; preds = %for.cond88.preheader, %for.inc97
  %6 = phi i32 [ %0, %for.cond88.preheader ], [ %.pre, %for.inc97 ]
  %indvars.iv46 = phi i64 [ 0, %for.cond88.preheader ], [ %indvars.iv.next47, %for.inc97 ]
  %sub89 = add i32 %6, %1
  %7 = sext i32 %sub89 to i64
  %cmp90 = icmp slt i64 %indvars.iv46, %7
  br i1 %cmp90, label %for.inc97, label %for.end100

for.inc97:                                        ; preds = %for.cond88
  %arrayidx94 = getelementptr inbounds nuw [20001 x i32], ptr %num, i64 0, i64 %indvars.iv46
...
for.end100:                                       ; preds = %for.cond88
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80004, ptr noundef nonnull %num) #7
