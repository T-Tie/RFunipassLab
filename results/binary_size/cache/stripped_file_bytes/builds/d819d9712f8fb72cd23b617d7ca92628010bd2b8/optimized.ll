...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80004, ptr %a) #9
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 80004, i1 false)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [20001 x i32], ptr %a, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx4 = getelementptr inbounds [20001 x i32], ptr %a, i64 0, i64 %idxprom3
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx11 = getelementptr inbounds [20001 x i32], ptr %a, i64 0, i64 %idxprom10
  %9 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %10 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom12 = sext i32 %10 to i64
  %arrayidx13 = getelementptr inbounds [20001 x i32], ptr %a, i64 0, i64 %idxprom12
...
if.end:                                           ; preds = %if.then15, %for.body9
  br label %for.inc
...
if.then18:                                        ; preds = %for.end
  ...
  %arrayidx21 = getelementptr inbounds [20001 x i32], ptr %a, i64 0, i64 %idxprom20
  %16 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call19, i32 noundef %16)
  br label %if.end23
...
for.end27:                                        ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0(i64 80004, ptr %a) #9
...
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !15, i64 0}
!24 = !{!25, !25, i64 0}
...
!31 = !{!"_ZTSNSt8ios_base6_WordsE", !15, i64 0, !28, i64 8}
