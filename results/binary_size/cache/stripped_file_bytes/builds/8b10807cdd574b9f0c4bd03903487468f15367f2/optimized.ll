...
for.end30.loopexit:                               ; preds = %for.cond
  ...
  %.pre18 = load i32, ptr %arrayidx32.phi.trans.insert, align 4, !tbaa !5
  %call33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %.pre, i32 noundef %.pre18)
