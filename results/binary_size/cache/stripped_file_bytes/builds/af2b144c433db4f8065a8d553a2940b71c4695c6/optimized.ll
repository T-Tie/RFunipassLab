...
if.then10:                                        ; preds = %lor.lhs.false, %if.end
  %smax24 = call i32 @llvm.smax.i32(i32 %.pr.i, i32 %2)
...
for.cond11.i:                                     ; preds = %for.inc.i, %if.then10
  ...
  %exitcond25.not = icmp eq i32 %5, %smax24
  br i1 %exitcond25.not, label %if.end53, label %for.body13.i
...
for.inc.i:                                        ; preds = %for.inc.fold.split.i, %if.else25.i, %for.body13.i
  %.sink1.i = phi i32 [ 31, %if.else25.i ], [ 29, %for.body13.i ], [ 30, %for.inc.fold.split.i ]
  %add26.i = add nuw nsw i32 %.sink1.i, %sum.2
  %inc.i = add i32 %5, 1
...
if.else29:                                        ; preds = %lor.lhs.false
  ...
  br label %for.cond11.i9

for.cond11.i9:                                    ; preds = %for.inc.i13, %if.else29
  %sum.3 = phi i32 [ 0, %if.else29 ], [ %add26.i15, %for.inc.i13 ]
  %6 = phi i32 [ %.pr.i, %if.else29 ], [ %inc.i16, %for.inc.i13 ]
  %exitcond.not = icmp eq i32 %6, %smax
  br i1 %exitcond.not, label %if.end53, label %for.body13.i11

for.body13.i11:                                   ; preds = %for.cond11.i9
  switch i32 %6, label %if.else25.i17 [
    i32 2, label %for.inc.i13
    i32 4, label %for.inc.fold.split.i12
    i32 6, label %for.inc.fold.split.i12
    i32 9, label %for.inc.fold.split.i12
    i32 11, label %for.inc.fold.split.i12
  ]

if.else25.i17:                                    ; preds = %for.body13.i11
  br label %for.inc.i13

for.inc.fold.split.i12:                           ; preds = %for.body13.i11, %for.body13.i11, %for.body13.i11, %for.body13.i11
  br label %for.inc.i13

for.inc.i13:                                      ; preds = %for.inc.fold.split.i12, %if.else25.i17, %for.body13.i11
  %.sink1.i14 = phi i32 [ 31, %if.else25.i17 ], [ 28, %for.body13.i11 ], [ 30, %for.inc.fold.split.i12 ]
  %add26.i15 = add nuw nsw i32 %.sink1.i14, %sum.3
  %inc.i16 = add i32 %6, 1
  store i32 %inc.i16, ptr %b, align 4, !tbaa !5, !noalias !15
  br label %for.cond11.i9, !llvm.loop !12

if.end53:                                         ; preds = %for.cond11.i9, %for.cond11.i
  %sum.1 = phi i32 [ %sum.2, %for.cond11.i ], [ %sum.3, %for.cond11.i9 ]
  %rem54 = srem i32 %sum.1, 7
  %cmp55 = icmp eq i32 %rem54, 0
  %.str..str.1 = select i1 %cmp55, ptr @.str, ptr @.str.1
  %call57 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.1)
