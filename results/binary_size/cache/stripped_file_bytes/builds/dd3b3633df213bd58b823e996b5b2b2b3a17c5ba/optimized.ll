...
if.end:
  %call = tail call noalias dereferenceable_or_null(88) ptr @malloc(i64 noundef 88) #3
...
for.body:                                         ; preds = %for.cond
  %call4 = tail call noalias dereferenceable_or_null(88) ptr @malloc(i64 noundef 88) #3
