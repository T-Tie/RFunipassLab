...
for.cond1:                                        ; preds = %for.cond, %for.inc7
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc7 ], [ 0, %for.cond ]
...
for.inc7:                                         ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10000 x i32], ptr %n, i64 0, i64 %indvars.iv3
...
for.cond10:                                       ; preds = %for.cond1, %for.inc17
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc17 ], [ 0, %for.cond1 ]
  %3 = sext i32 %2 to i64
  %cmp11 = icmp slt i64 %indvars.iv6, %3
  br i1 %cmp11, label %for.inc17, label %for.end19

for.inc17:                                        ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [10000 x i32], ptr %n, i64 0, i64 %indvars.iv6
...
entry:
  ...
  %add = add nsw i32 %j, 1
  %smax = call i32 @llvm.smax.i32(i32 %sum, i32 1)
...
if.else:                                          ; preds = %if.then
  ...
  tail call void @_Z6fenjieii(i32 noundef %add, i32 noundef %div) #9
  br label %for.inc
