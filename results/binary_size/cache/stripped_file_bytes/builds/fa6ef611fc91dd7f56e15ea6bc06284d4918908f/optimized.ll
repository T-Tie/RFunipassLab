...
if.then:                                          ; preds = %do.body
  ...
  call fastcc void @outlined_ir_func_0(double %div10)
...
if.else49:                                        ; preds = %if.then26
  ...
  call fastcc void @outlined_ir_func_0(double %div37)
  br label %if.end
...
do.cond.sink.split:                               ; preds = %if.then17, %if.end, %if.then
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.3)
...
define internal fastcc void @outlined_ir_func_0(double %0) unnamed_addr #8 {
