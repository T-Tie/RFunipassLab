...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %c) #4
...
for.cond30:                                       ; preds = %for.cond, %if.end55
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %if.end55 ], [ 0, %for.cond ]
  %t.3 = phi i32 [ %t.4, %if.end55 ], [ %t.1, %for.cond ]
  %2 = trunc nuw nsw i64 %indvars.iv31 to i32
  %conv31 = uitofp nneg i32 %2 to double
  %cmp32 = fcmp olt double %conv31, %conv8
  br i1 %cmp32, label %for.body33, label %for.end58

for.body33:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [501 x i8], ptr %b, i64 0, i64 %indvars.iv31
...
for.cond62:                                       ; preds = %for.end58, %for.body65
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body65 ], [ 0, %for.end58 ]
...
for.body65:                                       ; preds = %for.cond62
  %arrayidx67 = getelementptr inbounds nuw [501 x i8], ptr %a, i64 0, i64 %indvars.iv34
  %5 = load i8, ptr %arrayidx67, align 1, !tbaa !5, !invariant.load !8
  %arrayidx70 = getelementptr inbounds nuw [501 x i8], ptr %b, i64 0, i64 %indvars.iv34
