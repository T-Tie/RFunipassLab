...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc48
  ...
  %exitcond21.not = icmp eq i32 %i.0, %smax
  br i1 %exitcond21.not, label %while.cond51, label %if.end17
...
while.cond:                                       ; preds = %if.end36, %if.end17
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %if.end36 ], [ 0, %if.end17 ]
  %yushu.1 = phi i32 [ %yushu.2, %if.end36 ], [ 0, %if.end17 ]
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond16.not = icmp eq i64 %indvars.iv13, 49
  br i1 %exitcond16.not, label %for.cond38, label %while.body

while.body:                                       ; preds = %while.cond
  %arrayidx21 = getelementptr inbounds nuw [50 x i32], ptr %a, i64 0, i64 %indvars.iv.next14
...
if.then30:                                        ; preds = %while.body
  %rem3110 = urem i32 %add23, 10
  %div3411 = udiv i32 %add23, 10
  br label %if.end36

if.end36:                                         ; preds = %while.body, %if.then30
  %rem3110.sink = phi i32 [ %rem3110, %if.then30 ], [ %add23, %while.body ]
  %yushu.2 = phi i32 [ %div3411, %if.then30 ], [ 0, %while.body ]
  %2 = getelementptr inbounds nuw [50 x i32], ptr %b, i64 0, i64 %indvars.iv.next14
  store i32 %rem3110.sink, ptr %2, align 4, !tbaa !5
  br label %while.cond, !llvm.loop !13

for.cond38:                                       ; preds = %while.cond, %for.inc45
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc45 ], [ 0, %while.cond ]
  %exitcond20.not = icmp eq i64 %indvars.iv17, 50
  br i1 %exitcond20.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [50 x i32], ptr %b, i64 0, i64 %indvars.iv17
  %3 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [50 x i32], ptr %a, i64 0, i64 %indvars.iv17
...
while.cond51:                                     ; preds = %for.cond5, %while.cond51
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %while.cond51 ], [ 49, %for.cond5 ]
  %indvars.iv.next23 = add nsw i64 %indvars.iv22, -1
  %arrayidx53 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %indvars.iv22
...
for.cond58.preheader:                             ; preds = %while.cond51
  %5 = trunc nsw i64 %indvars.iv.next23 to i32
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc64
  %i.2 = phi i32 [ %inc57, %for.inc64 ], [ %5, %for.cond58.preheader ]
  %.sink2 = phi i32 [ -1, %for.inc64 ], [ 1, %for.cond58.preheader ]
  %inc57 = add nsw i32 %.sink2, %i.2
