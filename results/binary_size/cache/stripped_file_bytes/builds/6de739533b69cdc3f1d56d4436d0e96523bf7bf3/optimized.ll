...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond33 = or i1 %cmp12, %or.cond
  %cmp13 = icmp slt i32 %cond7, 3
  %or.cond34 = and i1 %cmp13, %or.cond33
  %cmp15 = icmp sgt i32 %spec.select, 2
  %or.cond35 = and i1 %cmp15, %or.cond34
  %p.0 = zext i1 %or.cond35 to i32
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc, %for.body
  %p.1 = phi i32 [ %p.0, %for.body ], [ %p.4, %for.inc ]
  %j.0 = phi i32 [ %cond7, %for.body ], [ %inc, %for.inc ]
...
for.end:                                          ; preds = %for.cond18
  ...
  %puts36 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
