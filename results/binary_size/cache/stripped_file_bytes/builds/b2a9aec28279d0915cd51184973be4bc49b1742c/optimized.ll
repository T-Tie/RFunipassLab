...
common.ret28:                                     ; preds = %tailrecurse, %if.then2, %if.else10
  %common.ret28.op = phi i32 [ %spec.select.i, %if.else10 ], [ %spec.select, %if.then2 ], [ 0, %tailrecurse ]
