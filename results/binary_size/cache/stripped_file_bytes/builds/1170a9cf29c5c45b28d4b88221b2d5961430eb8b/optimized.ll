...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc48
  %i.1 = phi i32 [ %inc49, %for.inc48 ], [ 0, %for.cond5.preheader ]
  %exitcond43.not = icmp eq i32 %i.1, %smax
  br i1 %exitcond43.not, label %while.cond51, label %if.end17
...
while.cond:                                       ; preds = %if.end36, %if.end17
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %if.end36 ], [ 1, %if.end17 ]
  %yushu.1 = phi i32 [ %yushu.2, %if.end36 ], [ 0, %if.end17 ]
  %exitcond38.not = icmp eq i64 %indvars.iv35, 50
  br i1 %exitcond38.not, label %for.cond38, label %while.body

while.body:                                       ; preds = %while.cond
  %arrayidx21 = getelementptr inbounds nuw [50 x i32], ptr %a, i64 0, i64 %indvars.iv35
...
if.then30:                                        ; preds = %while.body
  %rem3130 = urem i32 %add23, 10
  %div3431 = udiv i32 %add23, 10
  br label %if.end36

if.end36:                                         ; preds = %while.body, %if.then30
  %rem3130.sink = phi i32 [ %rem3130, %if.then30 ], [ %add23, %while.body ]
  %yushu.2 = phi i32 [ %div3431, %if.then30 ], [ 0, %while.body ]
  %2 = getelementptr inbounds nuw [50 x i32], ptr %b, i64 0, i64 %indvars.iv35
  store i32 %rem3130.sink, ptr %2, align 4, !tbaa !5
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  br label %while.cond, !llvm.loop !13

for.cond38:                                       ; preds = %while.cond, %for.inc45
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc45 ], [ 0, %while.cond ]
  %exitcond42.not = icmp eq i64 %indvars.iv39, 50
  br i1 %exitcond42.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [50 x i32], ptr %b, i64 0, i64 %indvars.iv39
  %3 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [50 x i32], ptr %a, i64 0, i64 %indvars.iv39
...
while.cond51:                                     ; preds = %for.cond5, %while.cond51
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %while.cond51 ], [ 49, %for.cond5 ]
  %indvars.iv.next45 = add nsw i64 %indvars.iv44, -1
  %arrayidx53 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %indvars.iv44
...
for.cond58.preheader:                             ; preds = %while.cond51
  %5 = trunc nsw i64 %indvars.iv44 to i32
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc64
  %i.3 = phi i32 [ %dec65, %for.inc64 ], [ %5, %for.cond58.preheader ]
