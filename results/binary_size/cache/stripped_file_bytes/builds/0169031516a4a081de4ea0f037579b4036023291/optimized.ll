...
for.cond:                                         ; preds = %if.end, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc3, %if.end ]
  %n.0 = phi i32 [ 0, %entry ], [ %n.1, %if.end ]
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.cond.cleanup24
  %indvars.iv8 = phi i32 [ %7, %for.cond18.preheader ], [ %indvars.iv.next9, %for.cond.cleanup24 ]
  %.sink = phi i32 [ %n.0, %for.cond18.preheader ], [ %dec, %for.cond.cleanup24 ]
  %cmp19 = icmp sgt i32 %.sink, -1
  br i1 %cmp19, label %for.cond22.preheader, label %for.cond49.preheader

for.cond22.preheader:                             ; preds = %for.cond18
  %smax10 = call i32 @llvm.smax.i32(i32 %indvars.iv8, i32 noundef 0)
...
for.cond22:                                       ; preds = %for.cond22.preheader, %if.end42
  %indvars.iv4 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next5, %if.end42 ]
  %exitcond12.not = icmp eq i64 %indvars.iv4, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond.cleanup24, label %for.body25
...
for.body25:                                       ; preds = %for.cond22
  %arrayidx27 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv4
  %10 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %arrayidx29 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv.next5
...
for.cond49:                                       ; preds = %for.cond49.preheader, %if.end64
  %indvars.iv13 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next14, %if.end64 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond17.not, label %for.end67, label %for.body52

for.body52:                                       ; preds = %for.cond49
  %cmp54 = icmp eq i64 %indvars.iv13, %9
  %12 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv13
