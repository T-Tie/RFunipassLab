...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc61
  %indvars.iv26 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next27, %for.inc61 ]
  %m.0 = phi i32 [ 0, %for.cond15.preheader ], [ %m.2, %for.inc61 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.end63, label %for.body17

for.body17:                                       ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %indvars.iv26
...
if.end38:                                         ; preds = %for.body17, %if.then36
  ...
  %arrayidx40 = getelementptr inbounds nuw [500 x i8], ptr %b, i64 0, i64 %indvars.iv26
