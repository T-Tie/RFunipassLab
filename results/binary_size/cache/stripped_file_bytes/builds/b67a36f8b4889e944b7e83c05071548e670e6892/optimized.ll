...
if.then7:                                         ; preds = %if.end
  ...
  %sub13 = sub nsw i32 %6, %mul12
  store i32 %sub13, ptr %sum, align 4, !tbaa !5
  br label %if.end17
...
if.then19:                                        ; preds = %if.end17
  ...
  %div23 = sdiv i32 %11, 20
  %mul24 = mul nsw i32 20, %div23
  %sub25 = sub nsw i32 %10, %mul24
  store i32 %sub25, ptr %sum, align 4, !tbaa !5
  br label %if.end29
...
if.then31:                                        ; preds = %if.end29
  ...
  %div35 = sdiv i32 %15, 10
  %mul36 = mul nsw i32 10, %div35
  %sub37 = sub nsw i32 %14, %mul36
  store i32 %sub37, ptr %sum, align 4, !tbaa !5
  br label %if.end41
...
if.then43:                                        ; preds = %if.end41
  ...
  %sub49 = sub nsw i32 %18, %mul48
  store i32 %sub49, ptr %sum, align 4, !tbaa !5
  br label %if.end53
...
if.end53:                                         ; preds = %if.else50, %if.then43
  ...
  %call54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %20)
