...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %a) #7
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %b) #7
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %n)
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp14 = icmp sgt i32 %0, 0
  br i1 %cmp14, label %for.body, label %for.end25

for.cond2.preheader:                              ; preds = %for.body
  %cmp316 = icmp sgt i32 %1, 0
  br i1 %cmp316, label %for.body4.preheader, label %for.end25
...
for.body4:                                        ; preds = %for.body4.preheader, %for.inc13
  %indvars.iv25 = phi i64 [ 0, %for.body4.preheader ], [ %indvars.iv.next26, %for.inc13 ]
  %j.018 = phi i32 [ 0, %for.body4.preheader ], [ %j.1, %for.inc13 ]
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv25
...
if.then:                                          ; preds = %for.body4
  %idxprom10 = sext i32 %j.018 to i64
  %arrayidx11 = getelementptr inbounds [500 x i32], ptr %b, i64 0, i64 %idxprom10
  store i32 %3, ptr %arrayidx11, align 4, !tbaa !5
  %inc12 = add nsw i32 %j.018, 1
  br label %for.inc13

for.inc13:                                        ; preds = %for.body4, %if.then
  %j.1 = phi i32 [ %inc12, %if.then ], [ %j.018, %for.body4 ]
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next26, %wide.trip.count
  br i1 %exitcond.not, label %for.end15, label %for.body4, !llvm.loop !12

for.end15:                                        ; preds = %for.inc13
  %cmp.not.i.i = icmp eq i32 %j.1, 0
  br i1 %cmp.not.i.i, label %for.end25, label %_ZSt4sortIPiEvT_S1_.exit

_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end15
  %idx.ext = sext i32 %j.1 to i64
  %add.ptr.idx = shl nsw i64 %idx.ext, 2
  %add.ptr = getelementptr inbounds i8, ptr %b, i64 %add.ptr.idx
  %5 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %idx.ext, i1 true)
  %sub.i.i.i = shl nuw nsw i64 %5, 1
  %mul.i.i = xor i64 %sub.i.i.i, 126
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull %b, ptr noundef nonnull %add.ptr, i64 noundef %mul.i.i)
  call void @_ZSt22__final_insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef nonnull %b, ptr noundef nonnull %add.ptr)
  %sub = add i32 %j.1, -1
  %cmp1820 = icmp sgt i32 %j.1, 1
  br i1 %cmp1820, label %for.body19.preheader, label %for.end25

for.body19.preheader:                             ; preds = %_ZSt4sortIPiEvT_S1_.exit
  %wide.trip.count31 = zext nneg i32 %sub to i64
  br label %for.body19

for.body19:                                       ; preds = %for.body19.preheader, %for.body19
  %indvars.iv28 = phi i64 [ 0, %for.body19.preheader ], [ %indvars.iv.next29, %for.body19 ]
  %arrayidx21 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv28
  ...
  br i1 %exitcond32.not, label %for.end25, label %for.body19, !llvm.loop !13

for.end25:                                        ; preds = %for.body19, %entry, %for.cond2.preheader, %for.end15, %_ZSt4sortIPiEvT_S1_.exit
  %sub41 = phi i32 [ %sub, %_ZSt4sortIPiEvT_S1_.exit ], [ -1, %for.end15 ], [ -1, %for.cond2.preheader ], [ -1, %entry ], [ %sub, %for.body19 ]
  %idxprom27 = sext i32 %sub41 to i64
  ...
  call void @llvm.lifetime.end.p0(i64 2000, ptr nonnull %a) #7
