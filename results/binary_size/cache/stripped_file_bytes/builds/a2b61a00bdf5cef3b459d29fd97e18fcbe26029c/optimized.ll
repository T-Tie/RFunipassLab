...
for.cond:                                         ; preds = %for.end35, %entry
  ...
  %exitcond36 = icmp eq i32 %i.0, %1
  br i1 %exitcond36, label %while.cond, label %for.cond2
...
for.cond8:                                        ; preds = %for.cond2, %if.end
  %indvars.iv27 = phi i64 [ %indvars.iv.next28.pre-phi, %if.end ], [ 0, %for.cond2 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, 100
  br i1 %exitcond31.not, label %for.cond26, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %arrayidx12 = getelementptr inbounds nuw [100 x i32], ptr %result, i64 0, i64 %indvars.iv27
...
if.then:                                          ; preds = %for.body10
  ...
  %add18 = add nsw i32 %5, %div24
  store i32 %add18, ptr %arrayidx17, align 4, !tbaa !5
  %rem25 = urem i32 %3, 10
  store i32 %rem25, ptr %arrayidx12, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %for.body10.if.end_crit_edge, %if.then
  %indvars.iv.next28.pre-phi = phi i64 [ %.pre, %for.body10.if.end_crit_edge ], [ %4, %if.then ]
  br label %for.cond8, !llvm.loop !13

for.cond26:                                       ; preds = %for.cond8, %for.body28
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body28 ], [ 0, %for.cond8 ]
  %exitcond35.not = icmp eq i64 %indvars.iv32, 100
  br i1 %exitcond35.not, label %for.end35, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [100 x i32], ptr %result, i64 0, i64 %indvars.iv32
  %6 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !9
  %arrayidx32 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv32
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %while.cond ], [ 99, %for.cond ]
  %arrayidx40 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %indvars.iv37
...
for.cond42.preheader:                             ; preds = %while.cond
  %8 = trunc nsw i64 %indvars.iv37 to i32
  br label %for.cond42
