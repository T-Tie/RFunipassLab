...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv46 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next47, %for.inc46 ]
...
for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc43 ], [ 0, %for.cond31 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc83
  %indvars.iv65 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next66, %for.inc83 ]
...
for.cond53:                                       ; preds = %for.cond49, %for.inc80
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc80 ], [ 0, %for.cond49 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count
  br i1 %exitcond64.not, label %for.inc83, label %for.cond57.preheader
...
for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc77
  %indvars.iv52 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next53, %for.inc77 ]
  %exitcond58.not = icmp eq i64 %indvars.iv52, %wide.trip.count57
  br i1 %exitcond58.not, label %for.inc80, label %for.inc77
...
for.cond86:                                       ; preds = %for.cond49, %for.inc109
  ...
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc109 ], [ 0, %for.cond49 ]
...
for.body93:                                       ; preds = %for.cond90
  ...
  %call100 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2..str.3, i32 noundef %20)
