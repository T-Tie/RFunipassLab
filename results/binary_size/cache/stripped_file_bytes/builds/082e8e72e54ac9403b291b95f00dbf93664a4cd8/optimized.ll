...
for.cond:                                         ; preds = %while.cond, %for.inc
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc ], [ %indvars.iv, %while.cond ]
  %cmp24 = icmp sgt i64 %indvars.iv22, 0
  br i1 %cmp24, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %indvars.iv.next23 = add nsw i64 %indvars.iv22, -1
  %arrayidx26 = getelementptr inbounds nuw [1000 x %struct.student], ptr %stu, i64 0, i64 %indvars.iv.next23
