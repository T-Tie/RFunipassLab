...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef nonnull align 16 %s) #6
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc22
  %indvars.iv6 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next7, %for.inc22 ]
  %exitcond15.not = icmp eq i64 %indvars.iv6, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond25, label %for.cond8.preheader

for.cond8.preheader:                              ; preds = %for.cond5
  %arrayidx12 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv6
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc19
  %indvars.iv8 = phi i64 [ %indvars.iv6, %for.cond8.preheader ], [ %indvars.iv.next9, %for.inc19 ]
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond.not, label %for.inc22, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %3 = load i32, ptr %arrayidx12, align 4, !tbaa !5, !invariant.load !12
  %arrayidx14 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv.next9
...
if.then:                                          ; preds = %for.body10
  %arrayidx17 = getelementptr inbounds nuw [300 x i32], ptr %c, i64 0, i64 %indvars.iv.next9
...
for.inc22:                                        ; preds = %for.cond8
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %for.cond5, !llvm.loop !14

for.cond25:                                       ; preds = %for.cond5, %for.body27
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body27 ], [ 0, %for.cond5 ]
  %q.0 = phi i32 [ %spec.select, %for.body27 ], [ undef, %for.cond5 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count14
  br i1 %exitcond20.not, label %for.cond36.preheader, label %for.body27

for.cond36.preheader:                             ; preds = %for.cond25
  %smax25 = call i32 @llvm.smax.i32(i32 %q.0, i32 0)
  %wide.trip.count26 = zext nneg i32 %smax25 to i64
  br label %for.cond36

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [300 x i32], ptr %c, i64 0, i64 %indvars.iv16
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc48
  %indvars.iv21 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next22, %for.inc48 ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end50, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [300 x i32], ptr %c, i64 0, i64 %indvars.iv21
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !12
  %cmp41 = icmp eq i32 %8, 0
  br i1 %cmp41, label %if.then42, label %for.inc48

if.then42:                                        ; preds = %for.body38
  %arrayidx44 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv21
  %9 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !12
