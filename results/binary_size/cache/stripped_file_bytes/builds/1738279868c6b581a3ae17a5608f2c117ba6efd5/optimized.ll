...
for.cond1:                                        ; preds = %for.inc12, %for.body
  ...
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc12 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv66
  br label %for.cond4
...
for.cond18:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv80 = phi i64 [ 0, %for.cond15 ], [ %indvars.iv.next81, %for.inc56 ]
  %exitcond84.not = icmp eq i64 %indvars.iv80, %wide.trip.count83
  br i1 %exitcond84.not, label %for.cond59, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond18
  %add.ptr28 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv80
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv69 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next70, %for.body25 ]
  %min.0 = phi i32 [ 100000, %for.cond22.preheader ], [ %spec.select, %for.body25 ]
  %exitcond.not = icmp eq i64 %indvars.iv69, %wide.trip.count83
...
for.body25:                                       ; preds = %for.cond22
  %add.ptr31 = getelementptr inbounds nuw i32, ptr %add.ptr28, i64 %indvars.iv69
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc53
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc53 ], [ 0, %for.cond42.preheader ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count83
  br i1 %exitcond79.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond42
  %add.ptr51 = getelementptr inbounds nuw i32, ptr %add.ptr28, i64 %indvars.iv75
...
for.cond59:                                       ; preds = %for.cond18, %for.end98
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %for.end98 ], [ 0, %for.cond18 ]
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv121
  br label %for.cond63

for.cond63:                                       ; preds = %for.cond59, %for.body66
  %indvars.iv109 = phi i64 [ 0, %for.cond59 ], [ %indvars.iv.next110, %for.body66 ]
  %min.2 = phi i32 [ 100000, %for.cond59 ], [ %spec.select59, %for.body66 ]
  %exitcond114.not = icmp eq i64 %indvars.iv109, %wide.trip.count83
  br i1 %exitcond114.not, label %for.cond85.preheader, label %for.body66

for.cond85.preheader:                             ; preds = %for.cond63
  br label %for.cond85

for.body66:                                       ; preds = %for.cond63
  %gep = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv109
  %7 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select59 = call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  br label %for.cond63, !llvm.loop !17

for.cond85:                                       ; preds = %for.cond85.preheader, %for.inc96
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %for.inc96 ], [ 0, %for.cond85.preheader ]
  %exitcond120.not = icmp eq i64 %indvars.iv115, %wide.trip.count83
  br i1 %exitcond120.not, label %for.end98, label %for.inc96

for.inc96:                                        ; preds = %for.cond85
  %gep61 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv115
  %8 = load i32, ptr %gep61, align 4, !tbaa !5, !invariant.load !13
