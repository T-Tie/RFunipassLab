...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc27 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body18 ], [ 0, %for.cond13 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17 = icmp slt i64 %indvars.iv29, %7
  br i1 %cmp17, label %for.body18, label %for.inc27

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv32, i64 %indvars.iv29
...
for.cond30:                                       ; preds = %for.cond13, %for.end55
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.end55 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp31 = icmp slt i64 %indvars.iv41, %9
  br i1 %cmp31, label %for.cond33, label %for.end59

for.cond33:                                       ; preds = %for.cond30, %for.inc53
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc53 ], [ 0, %for.cond30 ]
  %10 = load i32, ptr %y2, align 4, !tbaa !5
  %11 = sext i32 %10 to i64
  %cmp34 = icmp slt i64 %indvars.iv38, %11
  br i1 %cmp34, label %for.cond36.preheader, label %for.end55
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body38
  %indvars.iv35 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next36, %for.body38 ]
...
for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %indvars.iv35
  %13 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv35, i64 %indvars.iv38
...
for.end49:                                        ; preds = %for.cond36
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %sum.0)
  %15 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %15, -1
  %16 = sext i32 %sub to i64
  %cmp51 = icmp slt i64 %indvars.iv38, %16
