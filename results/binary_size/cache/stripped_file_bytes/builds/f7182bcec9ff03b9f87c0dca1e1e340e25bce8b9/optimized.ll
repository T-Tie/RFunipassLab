...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.cond7.loopexit
  %indvars.iv18 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next19, %for.cond7.loopexit ]
  %indvars.iv = phi i64 [ 1, %for.cond7.preheader ], [ %indvars.iv.next, %for.cond7.loopexit ]
  %num.1 = phi i32 [ 0, %for.cond7.preheader ], [ %num.2, %for.cond7.loopexit ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end28, label %for.body

for.body:                                         ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [16 x i32], ptr %shuzu, i64 0, i64 %indvars.iv18
  br label %for.cond9

for.cond9:                                        ; preds = %for.body11, %for.body
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body11 ], [ %indvars.iv, %for.body ]
  %num.2 = phi i32 [ %num.3, %for.body11 ], [ %num.1, %for.body ]
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx15 = getelementptr inbounds nuw [16 x i32], ptr %shuzu, i64 0, i64 %indvars.iv15
  ...
  %num.3 = add nsw i32 %num.2, %inc
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond9, !llvm.loop !12

for.end28:                                        ; preds = %for.cond7
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %num.1)
  br label %for.inc31
