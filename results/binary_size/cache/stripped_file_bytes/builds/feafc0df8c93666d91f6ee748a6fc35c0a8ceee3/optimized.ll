...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull %num) #6
  br label %for.cond
...
for.end61:                                        ; preds = %for.cond
  %call65 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 undef) #6
