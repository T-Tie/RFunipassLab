...
for.cond.outer:                                   ; preds = %if.then, %entry
  %indvars.iv.ph = phi i64 [ %indvars.iv.next, %if.then ], [ %0, %entry ]
  %cmp5 = phi i1 [ false, %if.then ], [ true, %entry ]
  %.ph = load i32, ptr @n, align 4, !tbaa !5
  %1 = sext i32 %.ph to i64
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %cmp1.not = icmp sgt i32 %2, %c
  br i1 %cmp1.not, label %for.cond, label %if.then, !llvm.loop !9
...
if.then:                                          ; preds = %for.body
  ...
  tail call void @_Z3daoii(i32 noundef %2, i32 noundef %4)
...
for.cond2:                                        ; preds = %for.cond, %for.body4
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body4 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv17, %3
  br i1 %cmp3, label %for.body4, label %for.cond10.preheader

for.cond10.preheader:                             ; preds = %for.cond2
  %4 = load i32, ptr @m, align 4, !tbaa !5
  %sub = add nsw i32 %4, -1
  %smax = tail call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond10

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr @a, i64 0, i64 %indvars.iv17
...
for.cond10:                                       ; preds = %for.cond10.backedge, %for.cond10.preheader
  %indvars.iv20 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next21, %for.cond10.backedge ]
  %exitcond.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond.not, label %for.end30, label %for.body12

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv20
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !5
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %arrayidx16 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv.next21
  %8 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %cmp17 = icmp sgt i32 %7, %8
  br i1 %cmp17, label %if.then, label %for.cond10.backedge

for.cond10.backedge:                              ; preds = %for.body12, %if.then
