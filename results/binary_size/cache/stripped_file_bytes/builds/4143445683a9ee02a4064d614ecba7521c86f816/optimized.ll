...
for.end:                                          ; preds = %for.cond
  ...
  br i1 %cmp.not.i.i, label %for.end13, label %for.cond2

for.cond2:                                        ; preds = %for.end
  ...
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull align 16 %vla, ptr noundef nonnull %add.ptr, i64 noundef %mul.i.i)
  call void @_ZSt22__final_insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef nonnull align 16 %vla, ptr noundef nonnull %add.ptr)
  %.pre = load i32, ptr %N, align 4, !tbaa !5
  br label %for.end13

for.end13:                                        ; preds = %for.cond2, %for.end
  %6 = phi i32 [ %.pre, %for.cond2 ], [ 0, %for.end ]
  br label %for.cond14

for.cond14:                                       ; preds = %if.end26, %for.end13
  %.pre1112 = phi i32 [ %.pre11, %if.end26 ], [ %6, %for.end13 ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %if.end26 ], [ 1, %for.end13 ]
  %7 = sext i32 %.pre1112 to i64
  %cmp15 = icmp slt i64 %indvars.iv8, %7
  br i1 %cmp15, label %for.body16, label %for.end29

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv8
  %8 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !12
  %9 = and i32 %8, 1
  %cmp20.not = icmp eq i32 %9, 0
  br i1 %cmp20.not, label %if.end26, label %if.then21

if.then21:                                        ; preds = %for.body16
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call22, i32 noundef %8)
  %.pre11.pre = load i32, ptr %N, align 4, !tbaa !5
  br label %if.end26

if.end26:                                         ; preds = %if.then21, %for.body16
  %.pre11 = phi i32 [ %.pre11.pre, %if.then21 ], [ %.pre1112, %for.body16 ]
...
if.end:                                           ; preds = %while.body
  ...
  %call.i = tail call noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull %add.ptr1.i, ptr noundef %__last.addr.0, ptr noundef %__first) #11
...
if.end:                                           ; preds = %entry
  ...
  %div1415 = lshr i64 %sub, 1
  br label %while.cond

while.cond:                                       ; preds = %while.cond, %if.end
  %__parent.0 = phi i64 [ %div1415, %if.end ], [ %dec, %while.cond ]
  ...
  br i1 %cmp5, label %return, label %while.cond, !llvm.loop !19
