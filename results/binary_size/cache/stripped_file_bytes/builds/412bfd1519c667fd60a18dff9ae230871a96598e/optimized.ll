...
for.cond12:                                       ; preds = %for.end, %for.inc29
  %indvars.iv10 = phi i64 [ 0, %for.end ], [ %indvars.iv.next11, %for.inc29 ]
  %t.2 = phi i32 [ 0, %for.end ], [ %t.3, %for.inc29 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end31, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond12
  %arrayidx19 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv10
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv6 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next7, %for.body17 ]
  %t.3 = phi i32 [ %t.2, %for.cond15.preheader ], [ %spec.select, %for.body17 ]
  %exitcond9.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond9.not, label %for.inc29, label %for.body17

for.body17:                                       ; preds = %for.cond15
  %2 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !9
  %arrayidx21 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv6
