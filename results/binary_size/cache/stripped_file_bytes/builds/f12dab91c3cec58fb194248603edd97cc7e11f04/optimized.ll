...
if.then:                                          ; preds = %for.body
  ...
  %call16 = call double @sqrt(double noundef %5) #8, !tbaa !5
  ...
  %.pre6 = load double, ptr %a, align 8, !tbaa !9
  %.pre7 = load double, ptr %c, align 8, !tbaa !9
  %.pre11 = fmul double %.pre6, 4.000000e+00
  %.pre12 = fneg double %.pre7
  %.pre13 = fmul double %.pre11, %.pre12
  %.pre14 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre13)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi15 = phi double [ %.pre14, %if.then ], [ %5, %for.body ]
  %mul24.pre-phi = phi double [ %.pre11, %if.then ], [ %mul4, %for.body ]
  %6 = phi double [ %.pre7, %if.then ], [ %3, %for.body ]
  %7 = phi double [ %.pre6, %if.then ], [ %2, %for.body ]
  %8 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi15, 0.000000e+00
...
if.then28:                                        ; preds = %if.end
  ...
  %.pre8 = load double, ptr %b, align 8, !tbaa !9
  %.pre9 = load double, ptr %a, align 8, !tbaa !9
  %.pre10 = load double, ptr %c, align 8, !tbaa !9
  %.pre16 = fmul double %.pre9, 4.000000e+00
  %.pre17 = fneg double %.pre10
  %.pre19 = fmul double %.pre16, %.pre17
  %.pre20 = call double @llvm.fmuladd.f64(double %.pre8, double %.pre8, double %.pre19)
  br label %if.end34

if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi21 = phi double [ %.pre20, %if.then28 ], [ %.pre-phi15, %if.end ]
  %mul36.pre-phi = phi double [ %.pre16, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %9 = phi double [ %.pre10, %if.then28 ], [ %6, %if.end ]
  %10 = phi double [ %.pre9, %if.then28 ], [ %7, %if.end ]
  %11 = phi double [ %.pre8, %if.then28 ], [ %8, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi21, 0.000000e+00
...
if.then40:                                        ; preds = %if.end34
  ...
  %call45 = call double @sqrt(double noundef %13) #8, !tbaa !5
