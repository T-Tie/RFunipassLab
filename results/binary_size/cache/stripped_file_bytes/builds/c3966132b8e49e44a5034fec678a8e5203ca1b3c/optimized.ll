...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc32
  %indvars.iv23 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next24, %for.inc32 ]
  %sum.1 = phi i32 [ 0, %for.cond15.preheader ], [ %sum.2, %for.inc32 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end34, label %for.cond18.preheader

for.cond18.preheader:                             ; preds = %for.cond15
  %arrayidx22 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond18.preheader, %for.body20
  %indvars.iv19 = phi i64 [ 0, %for.cond18.preheader ], [ %indvars.iv.next20, %for.body20 ]
  %sum.2 = phi i32 [ %sum.1, %for.cond18.preheader ], [ %spec.select, %for.body20 ]
  %exitcond22.not = icmp eq i64 %indvars.iv19, %wide.trip.count26
  br i1 %exitcond22.not, label %for.inc32, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv19
