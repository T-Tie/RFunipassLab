...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull %b) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull %c) #6
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.end ], [ 0, %entry ]
...
for.cond12:                                       ; preds = %for.end27, %for.end10
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.end27 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond12, %for.body19
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body19 ], [ 0, %for.cond12 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end45
  %indvars.iv51 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next52, %for.end45 ]
...
for.cond49.preheader:                             ; preds = %for.cond31
  %smax61 = call i32 @llvm.smax.i32(i32 %4, i32 0)
...
for.cond35:                                       ; preds = %for.cond31, %for.body38
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body38 ], [ 0, %for.cond31 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.end82
  %indvars.iv70 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next71, %for.end82 ]
...
for.cond53:                                       ; preds = %for.cond49, %for.end79
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.end79 ], [ 0, %for.cond49 ]
  %exitcond69.not = icmp eq i64 %indvars.iv64, %wide.trip.count68
  br i1 %exitcond69.not, label %for.end82, label %for.cond57.preheader
...
for.cond57:                                       ; preds = %for.cond57.preheader, %for.body60
  %indvars.iv57 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next58, %for.body60 ]
  %exitcond63.not = icmp eq i64 %indvars.iv57, %wide.trip.count62
  br i1 %exitcond63.not, label %for.end79, label %for.body60
...
for.cond86:                                       ; preds = %for.cond49, %for.end108
  ...
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.end108 ], [ 0, %for.cond49 ]
