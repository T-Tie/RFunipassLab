...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.end26 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body18 ], [ 0, %for.cond13 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17 = icmp slt i64 %indvars.iv14, %7
  br i1 %cmp17, label %for.body18, label %for.end26

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv17, i64 %indvars.iv14
