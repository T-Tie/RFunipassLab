...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  br i1 %cmp, label %for.cond1, label %for.cond21.preheader

for.cond21.preheader:                             ; preds = %for.cond
  %1 = load i32, ptr %b, align 4, !tbaa !5
  %cmp22 = icmp slt i32 %1, 1
  call void @llvm.assume(i1 noundef %cmp22)
  br label %for.cond47
...
for.body3:                                        ; preds = %for.cond1
  %call6 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull align 16 %A)
  br label %for.cond1

for.cond47:                                       ; preds = %for.cond21.preheader, %if.end61
  %3 = phi i32 [ %.pre, %if.end61 ], [ %0, %for.cond21.preheader ]
  %f.0 = phi i32 [ %inc57, %if.end61 ], [ 0, %for.cond21.preheader ]
  %cmp48 = icmp sgt i32 %3, 0
  br i1 %cmp48, label %if.end61, label %for.end64

if.end61:                                         ; preds = %for.cond47
  %inc57 = add nuw nsw i32 %f.0, 1
  %call60 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef 0, i32 noundef 0)
