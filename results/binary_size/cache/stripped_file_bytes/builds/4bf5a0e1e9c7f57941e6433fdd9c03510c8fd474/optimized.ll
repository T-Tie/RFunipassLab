...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %1 = load i64, ptr %_M_width.i3.i, align 8, !tbaa !6, !invariant.load !5
...
land.lhs.true.i15:                                ; preds = %if.then6.i9
  %_M_width.i3.i16 = getelementptr inbounds nuw i8, ptr %add.ptr10.i13, i64 16
  %7 = load i64, ptr %_M_width.i3.i16, align 8, !tbaa !6, !invariant.load !5
...
land.lhs.true.i42:                                ; preds = %if.then6.i36
  %_M_width.i3.i43 = getelementptr inbounds nuw i8, ptr %add.ptr10.i40, i64 16
  %9 = load i64, ptr %_M_width.i3.i43, align 8, !tbaa !6, !invariant.load !5
...
land.lhs.true.i69:                                ; preds = %if.then6.i63
  %_M_width.i3.i70 = getelementptr inbounds nuw i8, ptr %add.ptr10.i67, i64 16
  %11 = load i64, ptr %_M_width.i3.i70, align 8, !tbaa !6, !invariant.load !5
