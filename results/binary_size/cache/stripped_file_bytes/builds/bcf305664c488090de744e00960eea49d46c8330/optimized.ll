...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 404, ptr noundef nonnull %s) #4
...
for.body3:                                        ; preds = %for.cond1
  ...
  br i1 %cmp7, label %if.then, label %for.inc15

if.then:                                          ; preds = %for.body3
  %cmp8.not = icmp eq i32 %i.1, 0
...
if.end:                                           ; preds = %if.then9, %if.then
  %3 = phi i32 [ %.pre, %if.then9 ], [ %1, %if.then ]
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %3)
...
for.inc15:                                        ; preds = %for.body3, %if.end
  %inc16 = add nuw nsw i32 %i.1, 1
  br label %for.cond1, !llvm.loop !13

for.end17:                                        ; preds = %for.cond1
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %x) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #5
  call void @llvm.lifetime.end.p0(i64 noundef 404, ptr noundef nonnull %s) #5
  ret i32 0
}
