...
entry:
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %0 = add i32 %smax42, 1
...
for.cond:                                         ; preds = %for.inc62, %entry
  %indvars.iv59 = phi i32 [ %indvars.iv.next60, %for.inc62 ], [ %conv9, %entry ]
  %indvars.iv48 = phi i32 [ %indvars.iv.next49, %for.inc62 ], [ 0, %entry ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc62 ], [ 0, %entry ]
  %exitcond44 = icmp eq i64 %indvars.iv39, %wide.trip.count43
  br i1 %exitcond44, label %for.cond67.preheader, label %for.cond13

for.cond67.preheader:                             ; preds = %for.cond
  %smax68 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.body15:                                       ; preds = %for.cond13
  ...
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv39
...
for.end:                                          ; preds = %for.cond13
  ...
  br i1 %cmp22, label %for.cond24.preheader, label %for.inc62

for.cond24.preheader:                             ; preds = %for.end
  %wide.trip.count51 = zext i32 %indvars.iv48 to i64
  br label %for.cond24

for.cond24:                                       ; preds = %for.cond24.preheader, %for.body26
  %indvars.iv45 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next46, %for.body26 ]
  %exitcond52.not = icmp eq i64 %indvars.iv45, %wide.trip.count51
  br i1 %exitcond52.not, label %for.cond34.preheader, label %for.body26

for.cond34.preheader:                             ; preds = %for.cond24
  %smax56 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %wide.trip.count57 = zext nneg i32 %smax56 to i64
  br label %for.cond34

for.body26:                                       ; preds = %for.cond24
  %arrayidx28 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv45
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv53 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next54, %for.body36 ]
  %exitcond58.not = icmp eq i64 %indvars.iv53, %wide.trip.count57
  br i1 %exitcond58.not, label %for.end43, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [300 x i8], ptr %h, i64 0, i64 %indvars.iv53
  %5 = load i8, ptr %arrayidx38, align 1, !tbaa !5
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.body51
  %indvars.iv62 = phi i64 [ %7, %for.cond49.preheader ], [ %indvars.iv.next63, %for.body51 ]
  %cmp50 = icmp slt i64 %indvars.iv62, %8
  br i1 %cmp50, label %for.body51, label %if.end77

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds [300 x i8], ptr %s, i64 0, i64 %indvars.iv62
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv65 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next66, %for.body69 ]
  %exitcond70.not = icmp eq i64 %indvars.iv65, %wide.trip.count69
  br i1 %exitcond70.not, label %if.end77, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx71 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv65
  %10 = load i8, ptr %arrayidx71, align 1, !tbaa !5
