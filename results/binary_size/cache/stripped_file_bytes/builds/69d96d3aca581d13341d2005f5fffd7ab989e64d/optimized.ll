...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv30
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc15 ], [ %indvars.iv24, %for.body4 ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv26
...
for.cond21:                                       ; preds = %for.cond2, %for.body23
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body23 ], [ 0, %for.cond2 ]
  %k.0 = phi i32 [ %spec.select, %for.body23 ], [ 0, %for.cond2 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count34
  br i1 %exitcond40.not, label %while.cond.preheader, label %for.body23
...
for.body23:                                       ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv36
...
while.cond:                                       ; preds = %while.cond.preheader, %if.end48
  ...
  %indvars.iv41 = phi i64 [ 0, %while.cond.preheader ], [ %indvars.iv.next42, %if.end48 ]
  %l.0 = phi i32 [ 0, %while.cond.preheader ], [ %l.1, %if.end48 ]
  %6 = sext i32 %5 to i64
  %cmp33 = icmp slt i64 %indvars.iv41, %6
  br i1 %cmp33, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %arrayidx35 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv41
