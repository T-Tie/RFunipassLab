...
for.cond11:                                       ; preds = %for.cond14, %for.cond11.preheader
  %indvars.iv30.in = phi i32 [ %k.0, %for.cond11.preheader ], [ %indvars.iv30, %for.cond14 ]
...
for.cond14:                                       ; preds = %for.cond11, %if.end33
  %indvars.iv26 = phi i64 [ 0, %for.cond11 ], [ %indvars.iv.next27, %if.end33 ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond.not, label %for.cond11, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv26
  %6 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %arrayidx20 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv.next27
