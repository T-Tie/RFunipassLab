...
while.cond:                                       ; preds = %if.end41, %entry
  ...
  %or.cond9 = select i1 %cmp, i1 %cmp1, i1 false
  %2 = load i32, ptr %d, align 4
  %cmp3 = icmp eq i32 %0, %2
  %or.cond10 = select i1 %or.cond9, i1 %cmp3, i1 false
  %3 = load i32, ptr %e, align 4
  %cmp5 = icmp eq i32 %0, %3
  %or.cond11 = select i1 %or.cond10, i1 %cmp5, i1 false
  br i1 %or.cond11, label %land.lhs.true6, label %if.else
