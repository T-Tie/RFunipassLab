...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv34, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv41 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next42, %for.inc27 ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count45
  br i1 %exitcond46.not, label %for.end29.loopexit30, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc21 ], [ 0, %for.cond10 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv41, i64 %indvars.iv37
...
for.end29.loopexit30:                             ; preds = %for.cond10
  %.pre55 = zext i32 %0 to i64
  br label %for.end29

for.end29:                                        ; preds = %for.end29.loopexit30, %for.end29.loopexit
  %.pre-phi = phi i64 [ %.pre55, %for.end29.loopexit30 ], [ %wide.trip.count, %for.end29.loopexit ]
  %x1.1 = phi i32 [ 0, %for.end29.loopexit30 ], [ %7, %for.end29.loopexit ]
  %y1.1 = phi i32 [ undef, %for.end29.loopexit30 ], [ %8, %for.end29.loopexit ]
  br label %for.cond30

for.cond30:                                       ; preds = %for.end45, %for.end29
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.end45 ], [ %.pre-phi, %for.end29 ]
  %y2.0 = phi i32 [ %y2.2, %for.end45 ], [ undef, %for.end29 ]
  %indvars.iv.next52 = add nsw i64 %indvars.iv51, -1
  %indvars = trunc i64 %indvars.iv.next52 to i32
  %9 = trunc nuw i64 %indvars.iv51 to i32
  %cmp31 = icmp sgt i32 %9, 0
  br i1 %cmp31, label %for.cond34.preheader, label %for.end51

for.cond34.preheader:                             ; preds = %for.cond30
  %idxprom37 = and i64 %indvars.iv.next52, 4294967295
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv48 = phi i64 [ %.pre-phi, %for.cond34.preheader ], [ %indvars.iv.next49, %for.body36 ]
  %cmp35 = icmp sgt i64 %indvars.iv48, 0
  br i1 %cmp35, label %for.body36, label %for.end45

for.body36:                                       ; preds = %for.cond34
  %indvars.iv.next49 = add nsw i64 %indvars.iv48, -1
  %arrayidx40 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %idxprom37, i64 %indvars.iv.next49
...
for.end45.split.loop.exit:                        ; preds = %for.body36
  %11 = trunc nsw i64 %indvars.iv.next49 to i32
  br label %for.end45

for.end45:                                        ; preds = %for.cond34, %for.end45.split.loop.exit
  %x2.2 = phi i32 [ %indvars, %for.end45.split.loop.exit ], [ -1, %for.cond34 ]
  %y2.2 = phi i32 [ %11, %for.end45.split.loop.exit ], [ %y2.0, %for.cond34 ]
  %cmp46 = icmp eq i32 %x2.2, -1
  br i1 %cmp46, label %for.cond30, label %for.end51, !llvm.loop !16
