...
for.cond38:                                       ; preds = %if.end61, %for.end36
  %i.2 = phi i32 [ %sub37, %for.end36 ], [ %dec65, %if.end61 ]
...
for.cond42:                                       ; preds = %for.cond42.preheader, %if.end51
  %k.2 = phi i32 [ %dec, %if.end51 ], [ %sub37, %for.cond42.preheader ]
...
for.end66:                                        ; preds = %for.cond38, %if.then55, %for.body44
  %i.220 = phi i32 [ %i.2, %for.body44 ], [ %i.2, %if.then55 ], [ %smin, %for.cond38 ]
  %d.1 = phi i32 [ %k.2, %for.body44 ], [ undef, %if.then55 ], [ undef, %for.cond38 ]
  %10 = xor i32 %b.1, -1
  %sub68 = add i32 %d.1, %10
  %11 = xor i32 %a.1, -1
  %sub70 = add i32 %i.220, %11
