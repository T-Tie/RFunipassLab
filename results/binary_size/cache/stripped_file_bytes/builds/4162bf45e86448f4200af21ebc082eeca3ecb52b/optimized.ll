...
while.cond:                                       ; preds = %while.cond.preheader, %while.cond.loopexit
  %indvars.iv64 = phi i64 [ %5, %while.cond.preheader ], [ %indvars.iv.next65, %while.cond.loopexit ]
  %indvars.iv57 = phi i64 [ %4, %while.cond.preheader ], [ %indvars.iv.next58, %while.cond.loopexit ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %while.cond.loopexit ]
  %8 = trunc nuw i64 %indvars.iv64 to i32
  %cmp13 = icmp sgt i32 %8, 1
  br i1 %cmp13, label %for.cond14, label %while.end

for.cond14:                                       ; preds = %while.cond, %for.inc49
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc49 ], [ 0, %while.cond ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv64
...
for.cond20:                                       ; preds = %for.body22, %for.body16
  ...
  %exitcond.not = icmp eq i64 %indvars.iv6, %indvars.iv64
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv6
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  ...
  %exitcond13.not = icmp eq i64 %indvars.iv9, %indvars.iv64
  br i1 %exitcond13.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  ...
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv64
  br i1 %exitcond33.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv29
...
for.cond58:                                       ; preds = %for.body60, %for.body54
  ...
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv64
...
for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !14
  %spec.select1 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  ...
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv64
  br i1 %exitcond28.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
...
for.cond95:                                       ; preds = %for.inc106, %for.end92
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc106 ], [ 1, %for.end92 ]
  %exitcond41.not = icmp eq i64 %indvars.iv34, %indvars.iv57
  br i1 %exitcond41.not, label %for.cond109, label %for.inc106

for.inc106:                                       ; preds = %for.cond95
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next35
  %16 = load i32, ptr %arrayidx101, align 16, !tbaa !5, !invariant.load !14
  %arrayidx104 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv34
  store i32 %16, ptr %arrayidx104, align 16, !tbaa !5
  br label %for.cond95, !llvm.loop !21

for.cond109:                                      ; preds = %for.cond95, %for.inc120
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc120 ], [ 1, %for.cond95 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %indvars.iv57
  br i1 %exitcond46.not, label %for.cond123, label %for.inc120

for.inc120:                                       ; preds = %for.cond109
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %arrayidx116 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next43
  %17 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !14
  %arrayidx119 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv42
  store i32 %17, ptr %arrayidx119, align 4, !tbaa !5
  br label %for.cond109, !llvm.loop !22

for.cond123:                                      ; preds = %for.cond127, %for.cond109
  %indvars.iv52 = phi i64 [ 1, %for.cond109 ], [ %indvars.iv.next53, %for.cond127 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %indvars.iv57
  br i1 %exitcond56.not, label %while.cond.loopexit, label %for.cond127.preheader
...
for.cond127:                                      ; preds = %for.cond127.preheader, %for.inc141
  %indvars.iv47 = phi i64 [ 1, %for.cond127.preheader ], [ %indvars.iv.next48, %for.inc141 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %indvars.iv57
  br i1 %exitcond51.not, label %for.cond123, label %for.inc141, !llvm.loop !23

for.inc141:                                       ; preds = %for.cond127
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %arrayidx136 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next53, i64 %indvars.iv.next48
  %18 = load i32, ptr %arrayidx136, align 4, !tbaa !5, !invariant.load !14
  %arrayidx140 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv52, i64 %indvars.iv47
