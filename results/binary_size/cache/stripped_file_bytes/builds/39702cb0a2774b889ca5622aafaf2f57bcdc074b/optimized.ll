...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv37, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc27 ], [ 1, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv43, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax52 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
  %10 = add nuw i32 %smax52, 1
  %smax58 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
  %11 = add nuw i32 %smax58, 1
  %wide.trip.count59 = zext i32 %11 to i64
  %wide.trip.count53 = zext i32 %10 to i64
  %wide.trip.count = zext i32 %9 to i64
  br label %for.cond30

for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc24 ], [ 1, %for.cond13 ]
  %12 = load i32, ptr %y2, align 4, !tbaa !5
  %13 = sext i32 %12 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv40, %13
  br i1 %cmp17.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv43, i64 %indvars.iv40
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc65
  %indvars.iv55 = phi i64 [ 1, %for.cond30.preheader ], [ %indvars.iv.next56, %for.inc65 ]
  %exitcond60 = icmp eq i64 %indvars.iv55, %wide.trip.count59
  br i1 %exitcond60, label %for.cond68, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc62
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc62 ], [ 1, %for.cond30 ]
  %exitcond54 = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54, label %for.inc65, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv55, i64 %indvars.iv49
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.inc59, %for.body35
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc59 ], [ 1, %for.body35 ]
...
for.inc59:                                        ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv46
  %14 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !15
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv46, i64 %indvars.iv49
...
for.cond68:                                       ; preds = %for.cond30, %for.inc90
  ...
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc90 ], [ 1, %for.cond30 ]
  %18 = sext i32 %17 to i64
  %cmp69.not = icmp sgt i64 %indvars.iv64, %18
  br i1 %cmp69.not, label %for.end92, label %for.cond71

for.cond71:                                       ; preds = %for.cond68, %for.inc87
  %19 = phi i32 [ %.pre67, %for.inc87 ], [ %16, %for.cond68 ]
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc87 ], [ 1, %for.cond68 ]
  %20 = sext i32 %19 to i64
  %cmp72.not = icmp sgt i64 %indvars.iv61, %20
  br i1 %cmp72.not, label %for.inc90, label %for.body73

for.body73:                                       ; preds = %for.cond71
  %21 = zext i32 %19 to i64
  %cmp74.not = icmp eq i64 %indvars.iv61, %21
  %arrayidx84 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv64, i64 %indvars.iv61
  %22 = load i32, ptr %arrayidx84, align 4, !tbaa !5, !invariant.load !15
  %call85 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %22)
