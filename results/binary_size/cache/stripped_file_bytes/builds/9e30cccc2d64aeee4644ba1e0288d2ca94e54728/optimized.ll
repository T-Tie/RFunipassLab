...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 24000, ptr noundef nonnull align 16 %time) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %jg) #4
  br label %for.cond
...
for.body22:                                       ; preds = %for.cond20
  ...
  %reass.mul27 = add i32 %8, 43200
  %add = sub i32 %4, %3
  %add47 = add i32 %add, %7
  %add51 = add i32 %add47, %reass.mul27
...
for.end60:                                        ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %jg) #5
  call void @llvm.lifetime.end.p0(i64 noundef 24000, ptr noundef nonnull %time) #5
  ret i32 0
}
