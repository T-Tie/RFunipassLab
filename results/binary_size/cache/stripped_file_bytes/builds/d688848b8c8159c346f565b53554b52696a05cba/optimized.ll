...
entry:
  ...
  %rem14 = srem i32 %0, 5
  %call16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div, i32 noundef %div1.sext, i32 noundef %div4.sext, i32 noundef %div8.sext, i32 noundef %div13.sext, i32 noundef %rem14)
