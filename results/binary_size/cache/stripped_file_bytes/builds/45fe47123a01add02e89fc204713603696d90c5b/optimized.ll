...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3runi(i32 noundef %1) #7
...
for.end28:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %date2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %date1) #7
