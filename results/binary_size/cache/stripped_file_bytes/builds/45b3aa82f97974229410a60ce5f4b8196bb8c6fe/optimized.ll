...
if.then6.i14:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i19 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  br i1 %call16.i19, label %land.lhs.true.i20, label %if.then6.i41

land.lhs.true.i20:                                ; preds = %if.then6.i14
  %_M_width.i5.i21 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i5.i21, align 8, !tbaa !13, !invariant.load !12
  %3 = add i64 %2, -261
  %or.cond.i24 = icmp ult i64 %3, -260
  br i1 %or.cond.i24, label %if.then19.i25, label %if.then6.i41

if.then19.i25:                                    ; preds = %land.lhs.true.i20
  %call24.i26 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  ...
  %expval.i30 = call i64 @llvm.expect.i64(i64 noundef %conv.i29, i64 noundef 1)
...
if.then6.i41:                                     ; preds = %if.then28.i32, %if.then19.i25, %land.lhs.true.i20, %if.then6.i14
  ...
  %call16.i46 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
...
land.lhs.true.i47:                                ; preds = %if.then6.i41
  %_M_width.i5.i48 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i5.i48, align 8, !tbaa !13, !invariant.load !12
  %5 = add i64 %4, -261
  %or.cond.i51 = icmp ult i64 %5, -260
...
if.then19.i52:                                    ; preds = %land.lhs.true.i47
  %call24.i53 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  ...
  %expval.i57 = call i64 @llvm.expect.i64(i64 noundef %conv.i56, i64 noundef 1)
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit60
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit60, %while.end27
  %node.sink = phi ptr [ %node, %while.end27 ], [ %start, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit60 ]
