...
land.lhs.true.i17:                                ; preds = %while.body
  %3 = load i64, ptr %_M_width.i4.i18, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -41
  %or.cond.i21 = icmp ult i64 %4, -40
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30: ; preds = %if.then19.i22, %while.body, %land.lhs.true.i17
