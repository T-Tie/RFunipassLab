...
for.cond:                                         ; preds = %for.body, %entry
  ...
  br i1 %exitcond.not, label %for.cond15, label %for.body
...
for.cond15:                                       ; preds = %for.cond, %for.inc61
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc61 ], [ 0, %for.cond ]
  %m.0 = phi i32 [ %m.2, %for.inc61 ], [ 0, %for.cond ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond28.not, label %for.end63, label %for.body17

for.body17:                                       ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %indvars.iv24
...
if.end38:                                         ; preds = %for.body17, %if.then36
  ...
  %arrayidx40 = getelementptr inbounds nuw [500 x i8], ptr %b, i64 0, i64 %indvars.iv24
...
if.then68:                                        ; preds = %for.end63
  %4 = load double, ptr %x, align 8, !tbaa !12
