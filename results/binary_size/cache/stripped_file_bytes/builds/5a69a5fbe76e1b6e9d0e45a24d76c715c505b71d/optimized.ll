...
if.then19.i:                                      ; preds = %land.lhs.true.i
  call void @outlined_ir_func_0(ptr %add.ptr10.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry, %land.lhs.true.i
  ...
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) @b) #13
  %conv = trunc i64 %call3 to i32
  store i32 %conv, ptr @linelen, align 4, !tbaa !22
  %_M_width.i4.i17 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  br label %while.body
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %if.end34
  ...
  %call16.i15 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
  br i1 %call16.i15, label %land.lhs.true.i16, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit29

land.lhs.true.i16:                                ; preds = %while.body
  %3 = load i64, ptr %_M_width.i4.i17, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -41
  %or.cond.i20 = icmp ult i64 %4, -40
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit29: ; preds = %if.then19.i21, %while.body, %land.lhs.true.i16
  %call5 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) @a) #13
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit29
...
define internal void @outlined_ir_func_0(ptr nonnull %0) #10 {
if.then19.i_to_outline:
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #12
