...
for.cond.preheader:                               ; preds = %while.cond5
  ...
  %sext16 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext16, 32
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.body
  %indvars.iv13 = phi i64 [ %3, %for.cond.preheader ], [ %indvars.iv.next14, %for.body ]
  %cmp8 = icmp slt i64 %indvars.iv13, %4
...
for.body:                                         ; preds = %for.cond
  %arrayidx10 = getelementptr inbounds [3200 x i8], ptr %a, i64 0, i64 %indvars.iv13
