...
for.cond:                                         ; preds = %while.end, %entry
  ...
  %exitcond151.not = icmp eq i32 %q.0, %smax
  br i1 %exitcond151.not, label %for.end167, label %for.body
...
for.cond1:                                        ; preds = %for.end, %for.body
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.end ], [ 0, %for.body ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %wide.trip.count74
  br i1 %exitcond75.not, label %for.end12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.body6
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body6 ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count74
...
while.cond:                                       ; preds = %for.end162, %for.end12
  %indvars.iv148 = phi i64 [ %indvars.iv.next149, %for.end162 ], [ %1, %for.end12 ]
  %d.0 = phi i32 [ %add, %for.end162 ], [ 0, %for.end12 ]
  %2 = trunc nuw i64 %indvars.iv148 to i32
  %cmp13 = icmp sgt i32 %2, 1
  br i1 %cmp13, label %for.cond14, label %while.end

for.cond14:                                       ; preds = %while.cond, %for.body16
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.body16 ], [ 0, %while.cond ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %indvars.iv148
  br i1 %exitcond80.not, label %for.cond22, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv76
  store i32 1000, ptr %arrayidx18, align 4, !tbaa !5
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  br label %for.cond14, !llvm.loop !13

for.cond22:                                       ; preds = %for.cond14, %for.body24
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.body24 ], [ 0, %for.cond14 ]
  %exitcond85.not = icmp eq i64 %indvars.iv81, %indvars.iv148
  br i1 %exitcond85.not, label %for.cond30, label %for.body24

for.body24:                                       ; preds = %for.cond22
  %arrayidx26 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv81
...
for.cond30:                                       ; preds = %for.cond22, %for.end51
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.end51 ], [ 0, %for.cond22 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %indvars.iv148
  br i1 %exitcond95.not, label %for.cond55, label %for.cond33.preheader

for.cond33.preheader:                             ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv91
  br label %for.cond33

for.cond33:                                       ; preds = %for.cond33.preheader, %for.body35
  %indvars.iv86 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next87, %for.body35 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %indvars.iv148
  br i1 %exitcond90.not, label %for.end51, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !15
  %arrayidx41 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv91, i64 %indvars.iv86
...
for.cond55:                                       ; preds = %for.cond30, %for.end69
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.end69 ], [ 0, %for.cond30 ]
  %exitcond105.not = icmp eq i64 %indvars.iv101, %indvars.iv148
  br i1 %exitcond105.not, label %for.cond73, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv101
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body60
  %indvars.iv96 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next97, %for.body60 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %indvars.iv148
  br i1 %exitcond100.not, label %for.end69, label %for.body60

for.body60:                                       ; preds = %for.cond58
  %5 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !15
  %arrayidx66 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv101, i64 %indvars.iv96
...
for.cond73:                                       ; preds = %for.cond55, %for.end96
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.end96 ], [ 0, %for.cond55 ]
  %exitcond115.not = icmp eq i64 %indvars.iv111, %indvars.iv148
  br i1 %exitcond115.not, label %for.cond100, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond73
  %arrayidx80 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv111
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.body78
  %indvars.iv106 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next107, %for.body78 ]
  %exitcond110.not = icmp eq i64 %indvars.iv106, %indvars.iv148
  br i1 %exitcond110.not, label %for.end96, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %7 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !15
  %arrayidx84 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv106, i64 %indvars.iv111
...
for.cond100:                                      ; preds = %for.cond73, %for.end115
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %for.end115 ], [ 0, %for.cond73 ]
  %exitcond125.not = icmp eq i64 %indvars.iv121, %indvars.iv148
  br i1 %exitcond125.not, label %for.end118, label %for.cond103.preheader

for.cond103.preheader:                            ; preds = %for.cond100
  %arrayidx107 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv121
  br label %for.cond103

for.cond103:                                      ; preds = %for.cond103.preheader, %for.body105
  %indvars.iv116 = phi i64 [ 0, %for.cond103.preheader ], [ %indvars.iv.next117, %for.body105 ]
  %exitcond120.not = icmp eq i64 %indvars.iv116, %indvars.iv148
  br i1 %exitcond120.not, label %for.end115, label %for.body105

for.body105:                                      ; preds = %for.cond103
  %9 = load i32, ptr %arrayidx107, align 4, !tbaa !5, !invariant.load !15
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv116, i64 %indvars.iv121
...
for.cond121:                                      ; preds = %for.end138, %for.end118
  %indvars.iv132 = phi i64 [ %indvars.iv.next133, %for.end138 ], [ 0, %for.end118 ]
  %exitcond136.not = icmp eq i64 %indvars.iv132, %indvars.iv148
  br i1 %exitcond136.not, label %for.cond142, label %for.cond124

for.cond124:                                      ; preds = %for.cond121, %for.body126
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.body126 ], [ 2, %for.cond121 ]
  %exitcond131.not = icmp eq i64 %indvars.iv126, %indvars.iv148
  br i1 %exitcond131.not, label %for.end138, label %for.body126

for.body126:                                      ; preds = %for.cond124
  %arrayidx130 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv126, i64 %indvars.iv132
  %12 = load i32, ptr %arrayidx130, align 4, !tbaa !5, !invariant.load !15
  %13 = add nsw i64 %indvars.iv126, -1
  %arrayidx135 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %13, i64 %indvars.iv132
...
for.cond142:                                      ; preds = %for.cond121, %for.end159
  %indvars.iv143 = phi i64 [ %indvars.iv.next144, %for.end159 ], [ 0, %for.cond121 ]
  %exitcond147.not = icmp eq i64 %indvars.iv143, %indvars.iv148
  br i1 %exitcond147.not, label %for.end162, label %for.cond145

for.cond145:                                      ; preds = %for.cond142, %for.body147
  %indvars.iv137 = phi i64 [ %indvars.iv.next138, %for.body147 ], [ 2, %for.cond142 ]
  %exitcond142.not = icmp eq i64 %indvars.iv137, %indvars.iv148
  br i1 %exitcond142.not, label %for.end159, label %for.body147

for.body147:                                      ; preds = %for.cond145
  %arrayidx151 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv143, i64 %indvars.iv137
  %14 = load i32, ptr %arrayidx151, align 4, !tbaa !5
  %15 = add nsw i64 %indvars.iv137, -1
  %arrayidx156 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv143, i64 %15
