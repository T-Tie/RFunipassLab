...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc18
  %indvars.iv27 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next28, %for.inc18 ]
  %exitcond36.not = icmp eq i64 %indvars.iv27, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond21, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc15
  %indvars.iv29 = phi i64 [ %indvars.iv27, %for.cond5.preheader ], [ %indvars.iv.next30, %for.inc15 ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv.next30
...
for.cond21:                                       ; preds = %for.cond2, %for.body23
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body23 ], [ 0, %for.cond2 ]
  %k.0 = phi i32 [ %spec.select, %for.body23 ], [ 0, %for.cond2 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count35
  br i1 %exitcond41.not, label %while.cond.preheader, label %for.body23
...
for.body23:                                       ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv37
...
while.cond:                                       ; preds = %while.cond.preheader, %if.end48
  ...
  %indvars.iv42 = phi i64 [ 0, %while.cond.preheader ], [ %indvars.iv.next43, %if.end48 ]
  %l.0 = phi i32 [ 0, %while.cond.preheader ], [ %l.1, %if.end48 ]
  %7 = sext i32 %6 to i64
  %cmp33 = icmp slt i64 %indvars.iv42, %7
  br i1 %cmp33, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %arrayidx35 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv42
