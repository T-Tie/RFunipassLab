...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %end) #4
  store i32 0, ptr %end, align 4, !tbaa !5
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %n)
  call void @llvm.lifetime.start.p0(i64 50, ptr %dz) #4
...
for.body3:                                        ; preds = %for.cond1
  %arraydecay = getelementptr inbounds [50 x i8], ptr %dz, i64 0, i64 0
  %call4 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str.1, ptr noundef %arraydecay)
  %arraydecay5 = getelementptr inbounds [50 x i8], ptr %dz, i64 0, i64 0
...
if.then11:                                        ; preds = %if.else
  ...
  %7 = load i32, ptr %end, align 4, !tbaa !5
  %inc = add nsw i32 %7, 1
...
if.end13:                                         ; preds = %if.end, %if.then
  %arraydecay14 = getelementptr inbounds [50 x i8], ptr %dz, i64 0, i64 0
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %arraydecay14)
  %8 = load i32, ptr %k, align 4, !tbaa !5
  %9 = load i32, ptr %end, align 4, !tbaa !5
...
for.end20:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 50, ptr %dz) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %end) #4
