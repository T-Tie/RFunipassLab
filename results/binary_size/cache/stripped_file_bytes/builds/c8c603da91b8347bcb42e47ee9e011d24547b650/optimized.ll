; ModuleID = '/tmp/tmpx7ag6pf9.cpp'
source_filename = "/tmp/tmpx7ag6pf9.cpp"
...
define dso_local noundef i32 @_Z1fii(i32 noundef %n, i32 noundef %m) #3 {
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %number) #8
  store i32 1, ptr %number, align 4, !tbaa !5
...
if.then:                                          ; preds = %for.body
  ...
  %call2 = call noundef i32 @_Z1fii(i32 noundef %div, i32 noundef %8)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %number) #8
