...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv24, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond, %for.inc60
  %.pre.pre43 = phi i32 [ %.pre.pre44, %for.inc60 ], [ %0, %for.cond ]
  %.pre41 = phi i32 [ %.pre, %for.inc60 ], [ %0, %for.cond ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc60 ], [ 0, %for.cond ]
  %f4.0 = phi i32 [ %f4.1, %for.inc60 ], [ 0, %for.cond ]
  %4 = sext i32 %.pre41 to i64
  %cmp13.not.not = icmp slt i64 %indvars.iv38, %4
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc57
  %.pre.pre44 = phi i32 [ %.pre.pre43, %for.cond15.preheader ], [ %.pre.pre, %for.inc57 ]
  %.pre = phi i32 [ %.pre41, %for.cond15.preheader ], [ %.pre.pre, %for.inc57 ]
  %indvars.iv35 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next36, %for.inc57 ]
  %f4.1 = phi i32 [ %f4.0, %for.cond15.preheader ], [ %f4.2, %for.inc57 ]
  %6 = load i32, ptr %l, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17.not.not = icmp slt i64 %indvars.iv35, %7
  br i1 %cmp17.not.not, label %for.cond19.preheader, label %for.inc60

for.cond19.preheader:                             ; preds = %for.cond15
  %arrayidx30 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv38, i64 %indvars.iv35
  %smax = call i32 @llvm.smax.i32(i32 %.pre, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.body22
  %indvars.iv27 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next28, %for.body22 ]
...
for.cond35.preheader:                             ; preds = %for.cond19
  %wide.trip.count33 = zext i32 %6 to i64
  br label %for.cond35

for.body22:                                       ; preds = %for.cond19
  %arrayidx26 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv27, i64 %indvars.iv35
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.body38
  %indvars.iv30 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next31, %for.body38 ]
  %f2.0 = phi i32 [ 1, %for.cond35.preheader ], [ %spec.select22, %for.body38 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33
  br i1 %exitcond34.not, label %for.end52, label %for.body38

for.body38:                                       ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv38, i64 %indvars.iv30
  ...
  %spec.select22 = select i1 %cmp47, i32 0, i32 %f2.0
...
for.inc57:                                        ; preds = %for.end52, %if.then54
  %.pre.pre = phi i32 [ %.pre.pre.pre, %if.then54 ], [ %.pre.pre44, %for.end52 ]
