...
entry:
  ...
  %div137 = sdiv i8 %div13.lhs.trunc, 5
  %div13.sext = sext i8 %div137 to i32
  %rem14 = srem i32 %0, 5
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div, i32 noundef %div1.sext, i32 noundef %div4, i32 noundef %div11, i32 noundef %div13.sext, i32 noundef %rem14)
