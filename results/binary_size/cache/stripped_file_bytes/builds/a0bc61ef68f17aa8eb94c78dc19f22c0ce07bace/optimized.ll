...
entry:
  ...
  %arrayidx12 = getelementptr inbounds nuw i8, ptr %a, i64 4
  br label %for.cond

for.cond:                                         ; preds = %for.cond3, %entry
  %t.0 = phi i32 [ 1, %entry ], [ %t.1, %for.cond3 ]
...
for.cond19.preheader:                             ; preds = %for.cond
  ...
  br i1 %cmp21, label %for.cond19, label %for.end31
...
for.cond3:                                        ; preds = %if.end13, %for.body
  %t.1 = phi i32 [ %t.0, %for.body ], [ %t.2, %if.end13 ]
  br i1 %cmp8, label %for.cond, label %if.end

if.end:                                           ; preds = %for.cond3
  %cmp9 = icmp eq i32 %t.1, 1
...
if.end13:                                         ; preds = %if.then10, %if.end
  %t.2 = phi i32 [ 2, %if.then10 ], [ %t.1, %if.end ]
  br label %for.cond3

for.cond19:                                       ; preds = %for.cond19.preheader, %for.cond19
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %1)
...
for.end31:                                        ; preds = %for.cond19.preheader
  %sub20 = add nsw i32 %t.0, -1
  %idxprom33 = zext nneg i32 %sub20 to i64
  %arrayidx34 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %idxprom33
  %4 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !9
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %4)
