...
for.cond38:                                       ; preds = %for.inc64, %for.end36
  %sub37.sink = phi i32 [ %sub, %for.end36 ], [ %dec65, %for.inc64 ]
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc52
  %sub41.sink = phi i32 [ %dec, %for.inc52 ], [ %sub, %for.cond42.preheader ]
...
for.end66:                                        ; preds = %if.then55, %for.cond38, %for.body44
  %sub37.sink20 = phi i32 [ %sub37.sink, %for.body44 ], [ %smin, %for.cond38 ], [ %sub37.sink, %if.then55 ]
