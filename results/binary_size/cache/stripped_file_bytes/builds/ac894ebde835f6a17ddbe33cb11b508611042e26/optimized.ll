...
while.cond:                                       ; preds = %for.cond7, %entry
...
for.cond:                                         ; preds = %while.cond, %if.end5
  %1 = phi i32 [ %.pre, %if.end5 ], [ %0, %while.cond ]
  %i.0 = phi i32 [ %inc.i, %if.end5 ], [ 0, %while.cond ]
  %cmp2 = icmp samesign ugt i32 %i.0, 15
  %cmp3 = icmp eq i32 %1, 0
  %or.cond = select i1 %cmp2, i1 true, i1 %cmp3
  br i1 %or.cond, label %for.cond7, label %if.end5
...
for.cond7:                                        ; preds = %for.cond
  %cmp8 = icmp samesign ult i32 %i.0, 2
  call void @llvm.assume(i1 noundef %cmp8)
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
