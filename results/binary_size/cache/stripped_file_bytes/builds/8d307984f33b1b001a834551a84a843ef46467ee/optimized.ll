...
entry:
  ...
  %0 = add i32 %smax, 1
  %smax8 = call i32 @llvm.smax.i32(i32 noundef %i, i32 noundef %m)
  %wide.trip.count = zext i32 %0 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc12, %entry
  %a.0 = phi i32 [ %i, %entry ], [ %inc13, %for.inc12 ]
  %exitcond9.not = icmp eq i32 %a.0, %smax8
  br i1 %exitcond9.not, label %for.end14.loopexit, label %for.body
