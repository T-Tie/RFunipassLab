...
if.then10:                                        ; preds = %lor.lhs.false, %if.end
  %smax23 = call i32 @llvm.smax.i32(i32 %.pr.i, i32 %2)
...
for.cond11.i:                                     ; preds = %for.inc.i, %if.then10
  ...
  %exitcond24.not = icmp eq i32 %5, %smax23
  br i1 %exitcond24.not, label %if.end53, label %for.body13.i
...
if.else29:                                        ; preds = %lor.lhs.false
  ...
  br label %for.cond11.i8

for.cond11.i8:                                    ; preds = %for.inc.i12, %if.else29
  %sum.3 = phi i32 [ 0, %if.else29 ], [ %add26.i14, %for.inc.i12 ]
  %6 = phi i32 [ %.pr.i, %if.else29 ], [ %inc.i15, %for.inc.i12 ]
  %exitcond.not = icmp eq i32 %6, %smax
  br i1 %exitcond.not, label %if.end53, label %for.body13.i10

for.body13.i10:                                   ; preds = %for.cond11.i8
  switch i32 %6, label %if.else25.i16 [
    i32 2, label %for.inc.i12
    i32 4, label %for.inc.fold.split.i11
    i32 6, label %for.inc.fold.split.i11
    i32 9, label %for.inc.fold.split.i11
    i32 11, label %for.inc.fold.split.i11
  ]

if.else25.i16:                                    ; preds = %for.body13.i10
  br label %for.inc.i12

for.inc.fold.split.i11:                           ; preds = %for.body13.i10, %for.body13.i10, %for.body13.i10, %for.body13.i10
  br label %for.inc.i12

for.inc.i12:                                      ; preds = %for.inc.fold.split.i11, %if.else25.i16, %for.body13.i10
  %.sink1.sink.i13 = phi i32 [ 28, %for.body13.i10 ], [ 31, %if.else25.i16 ], [ 30, %for.inc.fold.split.i11 ]
  %add26.i14 = add nuw nsw i32 %.sink1.sink.i13, %sum.3
  %inc.i15 = add i32 %6, 1
  store i32 %inc.i15, ptr %b, align 4, !tbaa !5, !noalias !15
  br label %for.cond11.i8, !llvm.loop !12

if.end53:                                         ; preds = %for.cond11.i8, %for.cond11.i
  %sum.1 = phi i32 [ %sum.2, %for.cond11.i ], [ %sum.3, %for.cond11.i8 ]
