...
tailrecurse:                                      ; preds = %for.end98, %entry
  %indvars.iv45.in = phi i32 [ %indvars.iv45, %for.end98 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add100, %for.end98 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub70, %for.end98 ], [ %n, %entry ]
  %indvars.iv45 = add i32 %indvars.iv45.in, -1
  %smax52 = call i32 @llvm.smax.i32(i32 %indvars.iv45, i32 0)
  %smax39 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count24 = zext nneg i32 %smax39 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count29 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %t, i64 %indvars.iv21
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %t, i64 %indvars.iv21, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv16 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next17, %for.inc21 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %t, i64 %indvars.iv21, i64 %indvars.iv16
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc61
  %indvars.iv36 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next37, %for.inc61 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count24
  br i1 %exitcond41.not, label %for.end63, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx32 = getelementptr inbounds nuw [100 x i32], ptr %t, i64 0, i64 %indvars.iv36
  %3 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond33

for.cond33:                                       ; preds = %for.body35, %for.body29
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body35 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select13, %for.body35 ], [ %3, %for.body29 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond50.preheader, label %for.body35

for.cond50.preheader:                             ; preds = %for.cond33
  br label %for.cond50

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [100 x i32], ptr %t, i64 %indvars.iv26, i64 %indvars.iv36
...
for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc58
  %indvars.iv31 = phi i64 [ 0, %for.cond50.preheader ], [ %indvars.iv.next32, %for.inc58 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count29
  br i1 %exitcond35.not, label %for.inc61, label %for.inc58

for.inc58:                                        ; preds = %for.cond50
  %arrayidx56 = getelementptr inbounds nuw [100 x i32], ptr %t, i64 %indvars.iv31, i64 %indvars.iv36
...
for.cond69:                                       ; preds = %for.cond73, %for.cond69.preheader
  %indvars.iv49 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next50, %for.cond73 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54.not, label %for.end98, label %for.cond73.preheader

for.cond73.preheader:                             ; preds = %for.cond69
  %cmp80 = icmp eq i64 %indvars.iv49, 0
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %7 = and i64 %indvars.iv.next50, 4294967295
  %idxprom85 = select i1 %cmp80, i64 0, i64 %7
  br label %for.cond73

for.cond73:                                       ; preds = %for.cond73.preheader, %for.body76
  %indvars.iv42 = phi i64 [ 0, %for.cond73.preheader ], [ %indvars.iv.next43, %for.body76 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48.not, label %for.cond69, label %for.body76, !llvm.loop !18

for.body76:                                       ; preds = %for.cond73
  %cmp77 = icmp eq i64 %indvars.iv42, 0
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %8 = and i64 %indvars.iv.next43, 4294967295
  ...
  %arrayidx92 = getelementptr inbounds nuw [100 x i32], ptr %t, i64 %indvars.iv49, i64 %indvars.iv42
