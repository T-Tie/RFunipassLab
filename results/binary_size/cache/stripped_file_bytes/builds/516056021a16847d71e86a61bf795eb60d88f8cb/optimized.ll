...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %times) #7
...
while.body:                                       ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %k.011 = phi i32 [ %inc16, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 1, %entry ]
...
vector.body:                                      ; preds = %vector.body, %while.body
  %index = phi i64 [ 0, %while.body ], [ %index.next, %vector.body ]
  %vec.phi = phi <4 x i32> [ zeroinitializer, %while.body ], [ %5, %vector.body ]
  %2 = getelementptr inbounds nuw [9999 x i32], ptr @result, i64 0, i64 %index
...
for.cond.cleanup:                                 ; preds = %for.body
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %spec.select)
  %vtable.i = load ptr, ptr %call4, align 8, !tbaa !14
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call4, i8 noundef signext %retval.0.i.i.i)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(39996) @result, i8 0, i64 39996, i1 false), !tbaa !5
  %inc16 = add nuw nsw i32 %k.011, 1
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %num) #7
  %12 = load i32, ptr %times, align 4, !tbaa !5
  %cmp.not.not = icmp slt i32 %k.011, %12
  br i1 %cmp.not.not, label %while.body, label %while.end, !llvm.loop !41

for.body:                                         ; preds = %middle.block, %for.body
  %indvars.iv = phi i64 [ 9996, %middle.block ], [ %indvars.iv.next, %for.body ]
  %ansf.07 = phi i32 [ %7, %middle.block ], [ %spec.select, %for.body ]
  ...
  %spec.select = add nuw nsw i32 %ansf.07, %inc
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 9999
...
while.end:                                        ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit, %entry
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %times) #7
  ret i32 0
}
...
if.end:                                           ; preds = %if.then, %entry
  %cmp1.not8 = icmp sgt i32 %start, %num
  br i1 %cmp1.not8, label %for.cond.cleanup, label %for.body

for.cond.cleanup:                                 ; preds = %for.inc, %if.end
  ret void

for.body:                                         ; preds = %if.end, %for.inc
  %i.09 = phi i32 [ %inc5, %for.inc ], [ %start, %if.end ]
  %rem = srem i32 %num, %i.09
  %div = sdiv i32 %num, %i.09
  %cmp2 = icmp eq i32 %rem, 0
  br i1 %cmp2, label %if.then3, label %for.inc

if.then3:                                         ; preds = %for.body
  tail call void @_Z6factorii(i32 noundef %i.09, i32 noundef %div)
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then3
  %inc5 = add i32 %i.09, 1
  %exitcond.not = icmp eq i32 %i.09, %num
