...
for.cond:                                         ; preds = %while.cond, %for.body
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body ], [ %indvars.iv, %while.cond ]
  %cmp24 = icmp sgt i64 %indvars.iv6, 0
  br i1 %cmp24, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, -1
  %arrayidx26 = getelementptr inbounds [1000 x %struct.student], ptr %stu, i64 0, i64 %indvars.iv.next7
