...
for.body:                                         ; preds = %for.body.preheader, %outlined_ir_func_0.exit
  %i.2 = phi i32 [ %inc37.i, %outlined_ir_func_0.exit ], [ 65, %for.body.preheader ]
  br label %for.cond21

for.cond21:                                       ; preds = %for.body23, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body23 ], [ 0, %for.body ]
  %k.0 = phi i32 [ %spec.select, %for.body23 ], [ 0, %for.body ]
