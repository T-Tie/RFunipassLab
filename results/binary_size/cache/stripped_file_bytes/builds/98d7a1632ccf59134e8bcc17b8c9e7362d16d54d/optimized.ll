...
entry:
  ...
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(503) @strin, i64 noundef 500)
...
for.cond16:                                       ; preds = %for.body12, %for.body18
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body18 ], [ 0, %for.body12 ]
  %pd.0 = phi i32 [ %spec.select, %for.body18 ], [ 1, %for.body12 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end31, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv19
  %arrayidx21 = getelementptr inbounds nuw [503 x i8], ptr @strin, i64 0, i64 %6
  %7 = load i8, ptr %arrayidx21, align 1, !tbaa !9, !invariant.load !10
  %arrayidx24 = getelementptr inbounds nuw [10 x i8], ptr @str2, i64 0, i64 %indvars.iv
  %8 = load i8, ptr %arrayidx24, align 1, !tbaa !9, !invariant.load !10
  %cmp26.not = icmp eq i8 %7, %8
...
if.then33:                                        ; preds = %for.end31
  %9 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !10
...
for.end42:                                        ; preds = %for.cond9
  %10 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !10
  %spec.select13 = call i32 @llvm.smax.i32(i32 %maxtime.0, i32 %10)
...
if.then52:                                        ; preds = %for.end50
  %call53 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) @.str)
  br label %if.end79

if.else:                                          ; preds = %for.end50
  %call54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %maxtime.0)
...
for.cond64:                                       ; preds = %for.body59, %for.body66
  %13 = phi i32 [ %.pre, %for.body66 ], [ %12, %for.body59 ]
...
for.body66:                                       ; preds = %for.cond64
  %14 = add nuw nsw i64 %indvars.iv34, %indvars.iv38
  %arrayidx69 = getelementptr inbounds nuw [503 x i8], ptr @strin, i64 0, i64 %14
  %15 = load i8, ptr %arrayidx69, align 1, !tbaa !9, !invariant.load !10
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %15)
