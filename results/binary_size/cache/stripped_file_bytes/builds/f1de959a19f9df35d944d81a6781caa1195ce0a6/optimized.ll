...
define dso_local noundef range(i32 -2147483647, -2147483648) i32 @_Z6getonePc(ptr noundef nonnull dereferenceable(1) %s) local_unnamed_addr #0 {
entry:
  %targetBlock = tail call fastcc i1 @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %s)
...
while.body:                                       ; preds = %while.cond
  ...
  %targetBlock1 = tail call fastcc i1 @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %incdec.ptr)
...
for.body:                                         ; preds = %for.cond
  %call2 = call noundef range(i32 -1, -2147483648) i32 @_Z6getonePc(ptr noundef nonnull align 16 dereferenceable(41) %s)
...
define internal fastcc noundef i1 @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #5 {
entry_to_outline:
  %call = tail call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi3getERc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 1 dereferenceable(1) %0)
