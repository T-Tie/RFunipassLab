...
for.cond:                                         ; preds = %for.inc13, %entry
  ...
  %exitcond17.not = icmp eq i32 %k.0, 123
  br i1 %exitcond17.not, label %for.cond16, label %for.cond3
...
for.cond16:                                       ; preds = %for.cond, %for.body18
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body18 ], [ 0, %for.cond ]
  %sum.4 = phi i32 [ %sum.5, %for.body18 ], [ 0, %for.cond ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.end31, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [300 x i8], ptr %zfc, i64 0, i64 %indvars.iv18
