...
while.cond:                                       ; preds = %if.end, %entry
  %indvars.iv31 = phi i32 [ %indvars.iv.next32, %if.end ], [ 0, %entry ]
...
for.cond.preheader:                               ; preds = %land.lhs.true28
  ...
  %cmp3323.not = icmp eq i64 %6, 0
  br i1 %cmp3323.not, label %for.end, label %for.body.preheader
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv28 = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next29, %for.body ]
  ...
  %sub50 = add i32 %11, %mul
  %add45 = add i32 %sub50, %mul44
  %add51 = sub i32 %add45, %12
