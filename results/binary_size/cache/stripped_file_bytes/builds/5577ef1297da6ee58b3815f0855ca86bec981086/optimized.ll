...
for.cond2.preheader:                              ; preds = %for.cond
  %smax37 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc26
  %indvars.iv34.in = phi i32 [ %3, %for.cond2.preheader ], [ %indvars.iv34, %for.inc26 ]
  %k.0 = phi i32 [ 1, %for.cond2.preheader ], [ %inc27, %for.inc26 ]
  %indvars.iv34 = add i32 %indvars.iv34.in, -1
  %exitcond38 = icmp eq i32 %k.0, %5
  br i1 %exitcond38, label %for.cond29.preheader, label %for.cond5.preheader

for.cond29.preheader:                             ; preds = %for.cond2
  %wide.trip.count42 = zext nneg i32 %smax37 to i64
  br label %for.cond29

for.cond5.preheader:                              ; preds = %for.cond2
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv34, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc23
  %indvars.iv30 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next31, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv30
  %6 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %arrayidx11 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next31
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.body31
  %indvars.iv39 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next40, %for.body31 ]
  %d.0 = phi i32 [ 0, %for.cond29.preheader ], [ %spec.select, %for.body31 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count42
  br i1 %exitcond43.not, label %for.cond40.preheader, label %for.body31

for.cond40.preheader:                             ; preds = %for.cond29
  %wide.trip.count48 = zext i32 %d.0 to i64
  br label %for.cond40

for.body31:                                       ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv39
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc52
  %indvars.iv44 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next45, %for.inc52 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %for.end54, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx44 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv44
...
for.end54:                                        ; preds = %for.cond40
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla, i64 %wide.trip.count48
