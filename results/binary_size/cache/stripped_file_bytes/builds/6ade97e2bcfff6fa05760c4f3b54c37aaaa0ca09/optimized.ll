; ModuleID = '/tmp/tmphloxqdvw.cpp'
source_filename = "/tmp/tmphloxqdvw.cpp"
...
define dso_local void @_Z6divideii(i32 noundef %n, i32 noundef %n2) #0 {
entry:
  ...
  store i32 %n2, ptr %n2.addr, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr %m1) #7
  %0 = load i32, ptr %n.addr, align 4, !tbaa !5
  %conv = sitofp i32 %0 to double
  %call = call double @sqrt(double noundef %conv) #7, !tbaa !5
  %conv1 = fptosi double %call to i32
  store i32 %conv1, ptr %m1, align 4, !tbaa !5
  %1 = load i32, ptr %n2.addr, align 4, !tbaa !5
...
if.then:                                          ; preds = %for.body
  ...
  call void @_Z6divideii(i32 noundef %div, i32 noundef %9)
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %m1) #7
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_Z6divideii(i32 noundef %2, i32 noundef 2)
