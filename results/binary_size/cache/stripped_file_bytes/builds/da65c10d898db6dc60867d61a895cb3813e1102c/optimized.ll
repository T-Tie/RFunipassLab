...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv24, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax39 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc24 ], [ 0, %for.cond13 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %10 = sext i32 %9 to i64
  %cmp17 = icmp slt i64 %indvars.iv21, %10
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv24, i64 %indvars.iv21
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc61
  %indvars.iv36 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next37, %for.inc61 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond64, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc58
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc58 ], [ 0, %for.cond30 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.inc61, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc55
  %indvars.iv27 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next28, %for.inc55 ]
...
for.cond64:                                       ; preds = %for.cond30, %for.inc86
  ...
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc86 ], [ 0, %for.cond30 ]
  %13 = sext i32 %12 to i64
  %cmp65 = icmp slt i64 %indvars.iv45, %13
  br i1 %cmp65, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond64, %for.inc83
  %14 = phi i32 [ %.pre48, %for.inc83 ], [ %11, %for.cond64 ]
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc83 ], [ 0, %for.cond64 ]
  %15 = sext i32 %14 to i64
  %cmp68 = icmp slt i64 %indvars.iv42, %15
  br i1 %cmp68, label %for.body69, label %for.inc86

for.body69:                                       ; preds = %for.cond67
  %sub = add nsw i32 %14, -1
  %16 = zext i32 %sub to i64
  %cmp70 = icmp eq i64 %indvars.iv42, %16
