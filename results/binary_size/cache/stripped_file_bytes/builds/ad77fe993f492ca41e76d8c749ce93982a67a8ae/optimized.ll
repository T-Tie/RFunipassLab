...
for.body8:                                        ; preds = %for.cond6
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %high, i64 0, i64 %indvars.iv.next18
...
if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv.next18
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %cmp.i4 = icmp sgt i64 %__holeIndex.addr.0.i, %__holeIndex
  br i1 %cmp.i4, label %land.end.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit
