...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %h) #10
  call void @llvm.lifetime.start.p0(i64 40804, ptr %a) #10
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 40804, i1 false)
  call void @llvm.lifetime.start.p0(i64 40804, ptr %b) #10
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 40804, i1 false)
...
for.body38:                                       ; preds = %for.cond36
  ...
  %arrayidx40 = getelementptr inbounds [101 x [101 x i32]], ptr %a, i64 0, i64 %idxprom39
  ...
  %arrayidx44 = getelementptr inbounds [101 x [101 x i32]], ptr %b, i64 0, i64 %idxprom43
  ...
  %arrayidx48 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom47
...
for.inc51:                                        ; preds = %for.body38
  ...
  store i32 %inc52, ptr %h, align 4, !tbaa !5
...
for.inc54:                                        ; preds = %for.end53
  ...
  store i32 %inc55, ptr %l, align 4, !tbaa !5
...
for.body65:                                       ; preds = %for.cond63
  ...
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %40)
  %call71 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call70, ptr noundef @.str)
  br label %for.inc72

for.inc72:                                        ; preds = %for.body65
  %41 = load i32, ptr %j, align 4, !tbaa !5
  %inc73 = add nsw i32 %41, 1
  store i32 %inc73, ptr %j, align 4, !tbaa !5
...
for.end74:                                        ; preds = %for.cond63
  ...
  %arrayidx79 = getelementptr inbounds [101 x i32], ptr %arrayidx76, i64 0, i64 %idxprom78
  %44 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %call80 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %44)
  %call81 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call80, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc82
...
for.end84:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %h) #10
