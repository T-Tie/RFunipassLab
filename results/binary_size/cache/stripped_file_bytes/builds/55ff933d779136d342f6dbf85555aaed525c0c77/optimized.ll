...
for.cond5:                                        ; preds = %for.cond5.loopexit, %for.cond5.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond5.loopexit ], [ %1, %for.cond5.preheader ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.cond5.loopexit ], [ %3, %for.cond5.preheader ]
...
for.cond9.preheader:                              ; preds = %for.cond5
  %arrayidx15 = getelementptr inbounds [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next10
  %arrayidx21 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next10
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %if.end
  %indvars.iv6 = phi i64 [ %indvars.iv4, %for.cond9.preheader ], [ %indvars.iv.next7, %if.end ]
  %cmp10 = icmp slt i64 %indvars.iv6, %1
  br i1 %cmp10, label %for.body12, label %for.cond5.loopexit

for.body12:                                       ; preds = %for.cond9
  %4 = icmp eq i64 %indvars.iv6, %indvars.iv.next10
...
land.lhs.true:                                    ; preds = %for.body12
  ...
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %a, i64 0, i64 %indvars.iv6
...
land.lhs.true19:                                  ; preds = %land.lhs.true
  ...
  %arrayidx23 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv6
...
for.cond37:                                       ; preds = %for.body40, %for.end34
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body40 ], [ 0, %for.end34 ]
...
for.body40:                                       ; preds = %for.cond37
  %arrayidx42 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv12
