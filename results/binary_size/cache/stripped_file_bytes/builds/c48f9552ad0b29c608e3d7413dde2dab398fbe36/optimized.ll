...
for.cond:                                         ; preds = %for.inc31, %entry
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc31 ], [ 0, %entry ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count50
  br i1 %exitcond51.not, label %for.cond34, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv47
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv47, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.end, %for.inc27
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc27 ], [ 0, %for.end ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond46.not, label %for.inc31, label %for.inc27

for.inc27:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv47, i64 %indvars.iv42
...
for.cond34:                                       ; preds = %for.cond, %for.inc75
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc75 ], [ 0, %for.cond ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count50
  br i1 %exitcond66.not, label %for.end77, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx39 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv62
  %3 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond40

for.cond40:                                       ; preds = %for.body42, %for.body36
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body42 ], [ 0, %for.body36 ]
  %min.2 = phi i32 [ %spec.select40, %for.body42 ], [ %3, %for.body36 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.end56, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv52, i64 %indvars.iv62
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !9
  %spec.select40 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
...
for.cond59:                                       ; preds = %for.end56, %for.inc71
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc71 ], [ 0, %for.end56 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count
  br i1 %exitcond61.not, label %for.inc75, label %for.inc71

for.inc71:                                        ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv57, i64 %indvars.iv62
...
entry:
  ...
  %smax28 = tail call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #6
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc28
  %indvars.iv31 = phi i64 [ 2, %for.cond16.preheader ], [ %indvars.iv.next32, %for.inc28 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.inc31, label %for.inc28
...
for.cond2:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre10, %for.inc ], [ %1, %for.cond ]
