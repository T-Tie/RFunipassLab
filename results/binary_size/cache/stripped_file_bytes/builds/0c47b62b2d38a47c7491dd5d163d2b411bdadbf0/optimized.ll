...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %or.cond6 = select i1 %or.cond5, i1 %cmp5, i1 false
  %4 = load i32, ptr %e, align 4
  %cmp7 = icmp eq i32 %4, 0
  %or.cond7 = select i1 %or.cond6, i1 %cmp7, i1 false
  %5 = load i32, ptr %f, align 4
  %cmp9 = icmp eq i32 %5, 0
  %or.cond8 = select i1 %or.cond7, i1 %cmp9, i1 false
  br i1 %or.cond8, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %reass.sub = sub i32 %4, %1
  %6 = mul i32 %reass.sub, 60
  %reass.sub11 = sub i32 %3, %0
  %7 = mul i32 %reass.sub11, 3600
  %reass.sub12 = sub i32 %7, %2
  %add20 = add i32 %reass.sub12, 43200
  %reass.mul10 = add i32 %add20, %5
  %sub21 = add i32 %reass.mul10, %6
