...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 %s) #4
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv37, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv44 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next45, %for.inc27 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc21 ], [ 0, %for.cond10 ]
  %exitcond.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv44, i64 %indvars.iv40
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %a.1 = phi i32 [ %7, %for.end29.loopexit ], [ 0, %for.cond10 ]
  %b.1 = phi i32 [ %8, %for.end29.loopexit ], [ 0, %for.cond10 ]
  %sub = add nsw i32 %0, -1
  br label %for.cond30

for.cond30:                                       ; preds = %for.end45, %for.end29
  %c.0 = phi i32 [ -1, %for.end29 ], [ %c.2, %for.end45 ]
  %d.0 = phi i32 [ -1, %for.end29 ], [ %d.2, %for.end45 ]
  %sub.sink = phi i32 [ %sub, %for.end29 ], [ %dec50, %for.end45 ]
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc44
  %sub33.sink = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.cond34.preheader ]
  %cmp35 = icmp sgt i32 %sub33.sink, -1
  br i1 %cmp35, label %for.body36, label %for.end45

for.body36:                                       ; preds = %for.cond34
  %idxprom39 = zext nneg i32 %sub33.sink to i64
  %arrayidx40 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %idxprom37, i64 %idxprom39
  %9 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !13
  %cmp41 = icmp eq i32 %9, 0
  br i1 %cmp41, label %for.end45, label %for.inc44

for.inc44:                                        ; preds = %for.body36
  %dec = add nsw i32 %sub33.sink, -1
  br label %for.cond34, !llvm.loop !16

for.end45:                                        ; preds = %for.cond34, %for.body36
  %c.2 = phi i32 [ %sub.sink, %for.body36 ], [ %c.0, %for.cond34 ]
  %d.2 = phi i32 [ %sub33.sink, %for.body36 ], [ %d.0, %for.cond34 ]
...
for.end51:                                        ; preds = %for.end45, %for.cond30
  %c.1 = phi i32 [ %c.2, %for.end45 ], [ %c.0, %for.cond30 ]
