...
entry:
  %__c.addr.i10 = alloca i8, align 1
...
_ZNSi7getlineEPcl.exit:                           ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call2.i = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPclc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %a, i64 noundef 201, i8 noundef signext %retval.0.i.i.i)
...
for.body.preheader:                               ; preds = %_ZNSi7getlineEPcl.exit
  %4 = add i64 %call2, 4294967295
  %5 = and i64 %4, 4294967295
  %scevgep = getelementptr i8, ptr %a, i64 %5
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc
  %p.045 = phi ptr [ %p.1, %for.inc ], [ %a, %for.body.preheader ]
  %j.043 = phi i32 [ %j.1, %for.inc ], [ undef, %for.body.preheader ]
  %6 = load i8, ptr %p.045, align 1, !tbaa !34
...
if.then:                                          ; preds = %for.body
  ...
  %vtable.i5 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !5
  %vbase.offset.ptr.i6 = getelementptr i8, ptr %vtable.i5, i64 -24
  %vbase.offset.i7 = load i64, ptr %vbase.offset.ptr.i6, align 8
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i7
  %7 = load i64, ptr %gep, align 8, !tbaa !35
...
if.end.i:                                         ; preds = %if.then
  %call2.i9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %6)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
...
if.else:                                          ; preds = %for.body
  %cmp7 = icmp eq i32 %j.043, 0
  br i1 %cmp7, label %if.then8, label %for.inc

if.then8:                                         ; preds = %if.else
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i10)
  store i8 32, ptr %__c.addr.i10, align 1, !tbaa !34
  ...
  %gep41 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i13
  %8 = load i64, ptr %gep41, align 8, !tbaa !35
  %cmp.not.i16 = icmp eq i64 %8, 0
  br i1 %cmp.not.i16, label %if.end.i20, label %if.then.i17

if.then.i17:                                      ; preds = %if.then8
  %call1.i18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i10, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit22

if.end.i20:                                       ; preds = %if.then8
  %call2.i21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit22

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit22: ; preds = %if.then.i17, %if.end.i20
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i10)
  br label %for.inc

for.inc:                                          ; preds = %if.else, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit22, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %j.1 = phi i32 [ 0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 1, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit22 ], [ 1, %if.else ]
  %p.1 = getelementptr inbounds nuw i8, ptr %p.045, i64 1
  %exitcond.not = icmp eq ptr %p.045, %scevgep
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !36

for.end:                                          ; preds = %for.inc, %_ZNSi7getlineEPcl.exit
  ...
  %9 = load ptr, ptr %_M_ctype.i.i27, align 8, !tbaa !8
  %tobool.not.i.i.i28 = icmp eq ptr %9, null
  br i1 %tobool.not.i.i.i28, label %if.then.i.i.i40, label %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i29

if.then.i.i.i40:                                  ; preds = %for.end
  call void @_ZSt16__throw_bad_castv() #6
  unreachable

_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i29: ; preds = %for.end
  %_M_widen_ok.i.i.i30 = getelementptr inbounds nuw i8, ptr %9, i64 56
  %10 = load i8, ptr %_M_widen_ok.i.i.i30, align 8, !tbaa !28
  %tobool.not.i1.i.i31 = icmp eq i8 %10, 0
  br i1 %tobool.not.i1.i.i31, label %if.end.i.i.i36, label %if.then.i2.i.i32

if.then.i2.i.i32:                                 ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i29
  %arrayidx.i.i.i33 = getelementptr inbounds nuw i8, ptr %9, i64 67
  %11 = load i8, ptr %arrayidx.i.i.i33, align 1, !tbaa !34
  br label %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit

if.end.i.i.i36:                                   ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i29
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %9)
  %vtable.i.i.i37 = load ptr, ptr %9, align 8, !tbaa !5
  %vfn.i.i.i38 = getelementptr inbounds nuw i8, ptr %vtable.i.i.i37, i64 48
  %12 = load ptr, ptr %vfn.i.i.i38, align 8
  %call.i.i.i39 = call noundef signext i8 %12(ptr noundef nonnull align 8 dereferenceable(570) %9, i8 noundef signext 10)
  br label %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit

_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i32, %if.end.i.i.i36
  %retval.0.i.i.i34 = phi i8 [ %11, %if.then.i2.i.i32 ], [ %call.i.i.i39, %if.end.i.i.i36 ]
