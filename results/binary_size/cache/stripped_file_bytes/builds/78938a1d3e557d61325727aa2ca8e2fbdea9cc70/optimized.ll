...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre35, %for.body3 ], [ %0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv22, i64 %indvars.iv
  %call6 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre35 = load i32, ptr %n, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %if.then25, %for.cond10.preheader
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %if.then25 ], [ 0, %for.cond10.preheader ]
  %a.0 = phi i32 [ %a.240, %if.then25 ], [ undef, %for.cond10.preheader ]
  %b.0 = phi i32 [ %b.241, %if.then25 ], [ undef, %for.cond10.preheader ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count33
  br i1 %exitcond34.not, label %for.end36, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %if.end
  %indvars.iv25 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next26, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond.not, label %if.then25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv29, i64 %indvars.iv25
...
if.then25:                                        ; preds = %for.cond13, %for.end23
  %b.241 = phi i32 [ %6, %for.end23 ], [ %b.0, %for.cond13 ]
  %a.240 = phi i32 [ %4, %for.end23 ], [ %a.0, %for.cond13 ]
  %arrayidx29 = getelementptr inbounds [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv29, i64 %idxprom28
...
for.end36:                                        ; preds = %for.cond10, %for.end23, %if.then25
  %a.1 = phi i32 [ %a.240, %if.then25 ], [ %4, %for.end23 ], [ %a.0, %for.cond10 ]
  %b.1 = phi i32 [ %b.241, %if.then25 ], [ %6, %for.end23 ], [ %b.0, %for.cond10 ]
  %sub37 = add i32 %0, -1
  %smin = call i32 @llvm.smin.i32(i32 %sub37, i32 noundef -1)
  br label %for.cond38

for.cond38:                                       ; preds = %if.end61, %for.end36
  %sub37.sink = phi i32 [ %sub37, %for.end36 ], [ %dec65, %if.end61 ]
  %cmp39 = icmp sgt i32 %sub37.sink, -1
  br i1 %cmp39, label %for.cond42.preheader, label %for.end66

for.cond42.preheader:                             ; preds = %for.cond38
  %idxprom45 = zext nneg i32 %sub37.sink to i64
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42.preheader, %if.end51
  %sub37.sink4 = phi i32 [ %dec, %if.end51 ], [ %sub37, %for.cond42.preheader ]
  %cmp43 = icmp sgt i32 %sub37.sink4, -1
  br i1 %cmp43, label %for.body44, label %if.then55

for.body44:                                       ; preds = %for.cond42
  %idxprom47 = zext nneg i32 %sub37.sink4 to i64
  ...
  %cmp49 = icmp eq i32 %8, 0
  br i1 %cmp49, label %for.end66, label %if.end51

if.end51:                                         ; preds = %for.body44
  %dec = add nsw i32 %sub37.sink4, -1
...
if.then55:                                        ; preds = %for.cond42
  ...
  %9 = load i32, ptr %arrayidx57, align 16, !tbaa !5, !invariant.load !13
  %cmp59 = icmp eq i32 %9, 0
  br i1 %cmp59, label %for.end66, label %if.end61

if.end61:                                         ; preds = %if.then55
  %dec65 = add nsw i32 %sub37.sink, -1
  br label %for.cond38, !llvm.loop !17

for.end66:                                        ; preds = %for.cond38, %if.then55, %for.body44
  %sub37.sink20 = phi i32 [ %sub37.sink, %for.body44 ], [ %sub37.sink, %if.then55 ], [ %smin, %for.cond38 ]
  %d.1 = phi i32 [ %sub37.sink4, %for.body44 ], [ undef, %if.then55 ], [ undef, %for.cond38 ]
  %10 = xor i32 %b.1, -1
  %sub68 = add i32 %d.1, %10
  %11 = xor i32 %a.1, -1
  %sub70 = add i32 %sub37.sink20, %11
