...
for.cond13.preheader:                             ; preds = %for.cond1
  %sub = add nsw i32 %1, -1
  %smax131 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc152
  %indvars.iv114 = phi i32 [ %sub, %for.cond13.preheader ], [ %indvars.iv.next115, %for.inc152 ]
  %indvars.iv77 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next78, %for.inc152 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc152 ]
  %q.0 = phi i32 [ 0, %for.cond13.preheader ], [ %inc153, %for.inc152 ]
  %smax128 = call i32 @llvm.smax.i32(i32 %indvars.iv114, i32 noundef 1)
  %exitcond132.not = icmp eq i32 %q.0, %smax131
  br i1 %exitcond132.not, label %for.inc157, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  %smax122 = call i32 @llvm.smax.i32(i32 %indvars.iv77, i32 noundef 0)
  %wide.trip.count87 = zext nneg i32 %smax122 to i64
  %wide.trip.count = zext i32 %indvars.iv77 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc55
  %indvars.iv84 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next85, %for.inc55 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %wide.trip.count87
  br i1 %exitcond88.not, label %for.cond58, label %for.body19

for.body19:                                       ; preds = %for.cond16
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84
  %5 = load i32, ptr %arrayidx21, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond23

for.cond23:                                       ; preds = %for.body26, %for.body19
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body26 ], [ 0, %for.body19 ]
...
for.body26:                                       ; preds = %for.cond23
  %arrayidx30 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv73
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc52
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc52 ], [ 0, %for.cond39.preheader ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %wide.trip.count
  br i1 %exitcond83.not, label %for.inc55, label %for.inc52

for.inc52:                                        ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv79
...
for.cond58:                                       ; preds = %for.cond16, %for.inc99
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc99 ], [ 0, %for.cond16 ]
  %exitcond104.not = icmp eq i64 %indvars.iv99, %wide.trip.count87
  br i1 %exitcond104.not, label %for.end101, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv99
  %8 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond65

for.cond65:                                       ; preds = %for.body68, %for.body61
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.body68 ], [ 0, %for.body61 ]
  %t.2 = phi i32 [ %spec.select68, %for.body68 ], [ %8, %for.body61 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %wide.trip.count
  br i1 %exitcond93.not, label %for.cond83.preheader, label %for.body68

for.cond83.preheader:                             ; preds = %for.cond65
  br label %for.cond83

for.body68:                                       ; preds = %for.cond65
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv89, i64 %indvars.iv99
...
for.cond83:                                       ; preds = %for.cond83.preheader, %for.inc96
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc96 ], [ 0, %for.cond83.preheader ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %wide.trip.count
  br i1 %exitcond98.not, label %for.inc99, label %for.inc96

for.inc96:                                        ; preds = %for.cond83
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
...
for.end101:                                       ; preds = %for.cond58
  ...
  %wide.trip.count117 = zext nneg i32 %smax128 to i64
  br label %for.cond104

for.cond104:                                      ; preds = %for.cond109, %for.end101
  %indvars.iv111 = phi i64 [ 1, %for.end101 ], [ %indvars.iv.next112, %for.cond109 ]
  %exitcond118.not = icmp eq i64 %indvars.iv111, %wide.trip.count117
  br i1 %exitcond118.not, label %for.cond128, label %for.cond109.preheader
...
for.cond109:                                      ; preds = %for.cond109.preheader, %for.inc122
  %indvars.iv105 = phi i64 [ 0, %for.cond109.preheader ], [ %indvars.iv.next106, %for.inc122 ]
  %exitcond110.not = icmp eq i64 %indvars.iv105, %wide.trip.count87
  br i1 %exitcond110.not, label %for.cond104, label %for.inc122, !llvm.loop !20

for.inc122:                                       ; preds = %for.cond109
  %arrayidx117 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next112, i64 %indvars.iv105
  %12 = load i32, ptr %arrayidx117, align 4, !tbaa !5, !invariant.load !13
  %arrayidx121 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv111, i64 %indvars.iv105
...
for.cond128:                                      ; preds = %for.cond133, %for.cond104
  %indvars.iv125 = phi i64 [ 1, %for.cond104 ], [ %indvars.iv.next126, %for.cond133 ]
  %exitcond130.not = icmp eq i64 %indvars.iv125, %wide.trip.count117
  br i1 %exitcond130.not, label %for.inc152, label %for.cond133.preheader
...
for.cond133:                                      ; preds = %for.cond133.preheader, %for.inc146
  %indvars.iv119 = phi i64 [ 0, %for.cond133.preheader ], [ %indvars.iv.next120, %for.inc146 ]
  %exitcond124.not = icmp eq i64 %indvars.iv119, %wide.trip.count87
  br i1 %exitcond124.not, label %for.cond128, label %for.inc146, !llvm.loop !22

for.inc146:                                       ; preds = %for.cond133
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv119, i64 %indvars.iv.next126
  %13 = load i32, ptr %arrayidx141, align 4, !tbaa !5, !invariant.load !13
  %arrayidx145 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv119, i64 %indvars.iv125
