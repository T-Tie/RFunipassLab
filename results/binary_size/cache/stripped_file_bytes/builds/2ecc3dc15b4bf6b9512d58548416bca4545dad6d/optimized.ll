...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %5 = load i64, ptr %_M_width.i6.i, align 8, !tbaa !10, !invariant.load !9
...
for.cond14:                                       ; preds = %for.cond, %if.end57
  %.pre1112 = phi i32 [ %.pre11, %if.end57 ], [ %4, %for.cond ]
  %i.2 = phi i32 [ %inc.i6, %if.end57 ], [ 0, %for.cond ]
  %cmp15 = icmp slt i32 %i.2, %.pre1112
  br i1 %cmp15, label %if.else, label %for.end60

if.else:                                          ; preds = %for.cond14
  %sub38 = add nsw i32 %.pre1112, -1
...
if.end57.loopexit:                                ; preds = %for.cond41
  %.pre11.pre = load i32, ptr %m, align 4, !tbaa !5
  br label %if.end57

if.end57:                                         ; preds = %if.end57.loopexit, %if.else
  %.pre11 = phi i32 [ %.pre11.pre, %if.end57.loopexit ], [ %.pre1112, %if.else ]
  %inc.i6 = add nuw nsw i32 %i.2, 1
  br label %for.cond14
