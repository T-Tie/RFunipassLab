...
if.end:                                           ; preds = %for.cond
  ...
  %cmp11 = icmp ne i32 %1, 0
  %or.cond5 = select i1 %cmp10, i1 true, i1 %cmp11
  %cmp13 = icmp ne i32 %2, 0
  %or.cond6 = select i1 %or.cond5, i1 true, i1 %cmp13
  %cmp15 = icmp ne i32 %3, 0
  %or.cond7 = select i1 %or.cond6, i1 true, i1 %cmp15
  %cmp17 = icmp ne i32 %4, 0
  %or.cond8 = select i1 %or.cond7, i1 true, i1 %cmp17
  %cmp19 = icmp ne i32 %5, 0
  %or.cond9 = select i1 %or.cond8, i1 true, i1 %cmp19
  br i1 %or.cond9, label %if.then20, label %for.cond.backedge

if.then20:                                        ; preds = %if.end
  %reass.sub = sub i32 %3, %0
  %6 = mul i32 %reass.sub, 3600
  %mul21 = add i32 %6, 43200
  %sub22 = sub nsw i32 %4, %1
  %mul23 = mul nsw i32 %sub22, 60
  %add24 = sub i32 %mul21, %2
  %add25 = add i32 %add24, %5
  %sub26 = add i32 %add25, %mul23
  %call27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %sub26)
  br label %for.cond.backedge

for.cond.backedge:                                ; preds = %if.then20, %if.end
