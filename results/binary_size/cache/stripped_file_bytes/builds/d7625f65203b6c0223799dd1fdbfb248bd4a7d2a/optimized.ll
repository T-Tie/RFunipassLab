...
entry:
  ...
  %4 = add i32 %.pr, 49
  %smin22 = call i32 @llvm.smin.i32(i32 %3, i32 49)
  %5 = add i32 %smin22, %2
  %6 = sub i32 %4, %5
  %7 = udiv i32 %6, 50
  %8 = mul nuw i32 %7, 50
  ...
  %11 = add i32 %.pr, 19
  %smin23 = call i32 @llvm.smin.i32(i32 %10, i32 19)
  %12 = add i32 %smin23, %8
  %13 = add i32 %12, %2
  %14 = sub i32 %11, %13
  %15 = udiv i32 %14, 20
  ...
  %20 = add i32 %.pr, 9
  %smin25 = call i32 @llvm.smin.i32(i32 %19, i32 9)
  %21 = add i32 %smin25, %16
  %22 = add i32 %21, %8
  %23 = add i32 %22, %2
  %24 = sub i32 %20, %23
  %25 = udiv i32 %24, 10
  ...
  %31 = add i32 %.pr, 4
  %smin28 = call i32 @llvm.smin.i32(i32 %30, i32 4)
  %32 = add i32 %smin28, %26
  %33 = add i32 %32, %16
  %34 = add i32 %33, %8
  %35 = add i32 %34, %2
  %36 = sub i32 %31, %35
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %exitcond.not, label %for.end53, label %for.body, !llvm.loop !9
