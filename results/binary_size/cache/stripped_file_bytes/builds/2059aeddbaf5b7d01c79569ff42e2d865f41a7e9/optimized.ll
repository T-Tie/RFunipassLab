...
for.cond11:                                       ; preds = %for.inc18, %for.end
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc18 ], [ 0, %for.end ]
...
for.inc18:                                        ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw i32, ptr %call7, i64 %indvars.iv51
  store i32 0, ptr %arrayidx15, align 4, !tbaa !5
  %arrayidx17 = getelementptr inbounds nuw i32, ptr %call10, i64 %indvars.iv51
...
for.cond21:                                       ; preds = %for.cond11, %for.inc50
  ...
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc50 ], [ 0, %for.cond11 ]
  %7 = sext i32 %6 to i64
  %cmp22 = icmp slt i64 %indvars.iv57, %7
  br i1 %cmp22, label %for.cond24.preheader, label %for.cond53.preheader

for.cond24.preheader:                             ; preds = %for.cond21
  %arrayidx28 = getelementptr inbounds nuw ptr, ptr %call1, i64 %indvars.iv57
  %arrayidx33 = getelementptr inbounds nuw i32, ptr %call7, i64 %indvars.iv57
  %arrayidx46 = getelementptr inbounds nuw i32, ptr %call10, i64 %indvars.iv57
  br label %for.cond24
...
for.cond24:                                       ; preds = %for.cond24.preheader, %for.inc47
  %indvars.iv54 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next55, %for.inc47 ]
  %8 = load i32, ptr %l, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp25 = icmp slt i64 %indvars.iv54, %9
  br i1 %cmp25, label %for.body26, label %for.inc50

for.body26:                                       ; preds = %for.cond24
  %10 = load ptr, ptr %arrayidx28, align 8, !tbaa !9, !invariant.load !16
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %10, i64 %indvars.iv54
...
if.then:                                          ; preds = %for.body26
  ...
  %13 = trunc nuw nsw i64 %indvars.iv54 to i32
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc78
  %indvars.iv66 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next67, %for.inc78 ]
  %exitcond72.not = icmp eq i64 %indvars.iv66, %wide.trip.count71
  br i1 %exitcond72.not, label %if.else, label %for.cond56.preheader

for.cond56.preheader:                             ; preds = %for.cond53
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %call7, i64 %indvars.iv66
  %arrayidx64 = getelementptr inbounds nuw i32, ptr %call10, i64 %indvars.iv66
  br label %for.cond56

for.cond56:                                       ; preds = %for.body58, %for.cond56.preheader
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.body58 ], [ 0, %for.cond56.preheader ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count64
  br i1 %exitcond65.not, label %if.then83, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %14 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !16
  %arrayidx62 = getelementptr inbounds nuw ptr, ptr %call1, i64 %indvars.iv60
...
if.then83:                                        ; preds = %for.cond56
  %18 = trunc nuw nsw i64 %indvars.iv66 to i32
  %idxprom75 = and i64 %indvars.iv66, 4294967295
