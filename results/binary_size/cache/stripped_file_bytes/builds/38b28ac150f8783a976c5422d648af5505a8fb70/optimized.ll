...
for.cond.preheader:                               ; preds = %do.cond
  %wide.trip.count27 = and i64 %indvars.iv, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv18 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next19, %for.inc27 ]
  %count.0 = phi i32 [ 0, %for.cond.preheader ], [ %count.1, %for.inc27 ]
  %exitcond28.not = icmp eq i64 %indvars.iv18, %wide.trip.count27
  br i1 %exitcond28.not, label %if.end32, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond
  %arrayidx16 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv18
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.body12
  %indvars.iv20 = phi i64 [ %indvars.iv18, %for.cond9.preheader ], [ %indvars.iv.next21, %for.body12 ]
  %count.1 = phi i32 [ %count.0, %for.cond9.preheader ], [ %count.2, %for.body12 ]
  %exitcond.not = icmp eq i64 %indvars.iv20, %wide.trip.count27
  br i1 %exitcond.not, label %for.inc27, label %for.body12

for.body12:                                       ; preds = %for.cond9
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %arrayidx14 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv.next21
  ...
  %or.cond16 = or i1 %cmp17, %cmp23
  %inc25 = zext i1 %or.cond16 to i32
