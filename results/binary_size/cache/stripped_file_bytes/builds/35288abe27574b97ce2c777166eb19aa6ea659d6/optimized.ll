...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 48400, ptr noundef nonnull %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 48400, ptr noundef nonnull %b) #4
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [110 x [110 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc27 ], [ 1, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv28, %4
  br i1 %cmp14.not, label %for.cond60, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc24 ], [ 1, %for.cond13 ]
  %5 = load i32, ptr %y2, align 4, !tbaa !5
  %6 = sext i32 %5 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv25, %6
  br i1 %cmp17.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [110 x [110 x i32]], ptr %b, i64 0, i64 %indvars.iv28, i64 %indvars.iv25
...
for.end81:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 48400, ptr noundef nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 48400, ptr noundef nonnull %a) #5
  ret i32 0
}
