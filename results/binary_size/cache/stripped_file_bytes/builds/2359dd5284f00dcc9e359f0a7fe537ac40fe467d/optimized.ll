...
for.cond:                                         ; preds = %for.inc, %entry
  %1 = phi i32 [ %7, %for.inc ], [ %.pre5, %entry ]
...
for.cond2:                                        ; preds = %for.cond, %for.inc7
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc7 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv5, %3
...
for.inc7:                                         ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr @a, i64 0, i64 %indvars.iv5
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv8 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next9, %for.inc28 ]
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond.not, label %for.end30, label %for.body12

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv8
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %arrayidx16 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv.next9
