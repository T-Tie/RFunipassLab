...
entry:
  ...
  store i32 80, ptr %e, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 3200, ptr %a) #9
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 3200, i1 false)
  ...
  %arraydecay = getelementptr inbounds [3200 x i8], ptr %a, i64 0, i64 0
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %arraydecay, i64 noundef 3200)
  %arraydecay3 = getelementptr inbounds [3200 x i8], ptr %a, i64 0, i64 0
  %call4 = call i64 @strlen(ptr noundef %arraydecay3) #10
  %arrayidx = getelementptr inbounds nuw [3200 x i8], ptr %a, i64 0, i64 %call4
  store i8 32, ptr %arrayidx, align 1, !tbaa !9
  br label %while.cond
...
while.cond5:                                      ; preds = %while.body7, %while.body
  ...
  %arrayidx6 = getelementptr inbounds [3200 x i8], ptr %a, i64 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx10 = getelementptr inbounds [3200 x i8], ptr %a, i64 0, i64 %idxprom9
  %7 = load i8, ptr %arrayidx10, align 1, !tbaa !9
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %7)
  br label %for.inc
...
if.then:                                          ; preds = %for.end
  call void @llvm.lifetime.end.p0(i64 3200, ptr %a) #9
...
if.end:                                           ; preds = %for.end
  ...
  store i32 %add17, ptr %s, align 4, !tbaa !5
  %12 = load i32, ptr %s, align 4, !tbaa !5
  %add18 = add nsw i32 %12, 80
  store i32 %add18, ptr %e, align 4, !tbaa !5
...
!36 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !17, i64 0}
!37 = !{!"_ZTSNSt8ios_base6_WordsE", !17, i64 0, !21, i64 8}
!38 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !17, i64 0}
!39 = !{!"_ZTSSt6locale", !40, i64 0}
!40 = !{!"p1 _ZTSNSt6locale5_ImplE", !17, i64 0}
!41 = !{!"bool", !7, i64 0}
...
!53 = !{!54, !54, i64 0}
!54 = !{!"p1 _ZTSSt8ios_base", !17, i64 0}
!55 = !{!33, !21, i64 16}
