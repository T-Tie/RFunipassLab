...
for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  %0 = phi i32 [ %2, %for.cond.cleanup3 ], [ %.pre, %entry ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond.cleanup3 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.body4
  %2 = phi i32 [ %.pre38, %for.body4 ], [ %0, %for.cond ]
...
for.cond11:                                       ; preds = %for.cond11.preheader, %cleanup
  %indvars.iv25 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next26, %cleanup ]
  %r.0 = phi i32 [ undef, %for.cond11.preheader ], [ %r.1, %cleanup ]
  %s.0 = phi i32 [ undef, %for.cond11.preheader ], [ %s.1, %cleanup ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond31.preheader, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond11
  %4 = trunc nuw nsw i64 %indvars.iv25 to i32
  br label %for.cond15

for.cond31.preheader:                             ; preds = %for.cond11
  %5 = zext i32 %0 to i64
  br label %for.cond31.outer

for.cond31.outer:                                 ; preds = %cleanup48.split.loop.exit, %for.cond31.preheader
  %indvars.iv35.ph = phi i64 [ %indvars.iv.next36, %cleanup48.split.loop.exit ], [ %5, %for.cond31.preheader ]
  %p.0.ph = phi i32 [ %indvars.le, %cleanup48.split.loop.exit ], [ undef, %for.cond31.preheader ]
  %q.0.ph = phi i32 [ %12, %cleanup48.split.loop.exit ], [ undef, %for.cond31.preheader ]
  br label %for.cond31
...
for.body18:                                       ; preds = %for.cond15
  ...
  br i1 %cmp23, label %cleanup.split.loop.exit, label %for.inc24

for.inc24:                                        ; preds = %for.body18
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond15, !llvm.loop !13

cleanup.split.loop.exit:                          ; preds = %for.body18
  %7 = trunc nuw nsw i64 %indvars.iv21 to i32
  br label %cleanup

cleanup:                                          ; preds = %for.cond15, %cleanup.split.loop.exit
  %r.1 = phi i32 [ %4, %cleanup.split.loop.exit ], [ %r.0, %for.cond15 ]
  %s.1 = phi i32 [ %7, %cleanup.split.loop.exit ], [ %s.0, %for.cond15 ]
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond11, !llvm.loop !14

for.cond31:                                       ; preds = %for.cond36, %for.cond31.outer
  %indvars.iv35 = phi i64 [ %indvars.iv35.ph, %for.cond31.outer ], [ %indvars.iv.next36, %for.cond36 ]
  %indvars.iv.next36 = add nsw i64 %indvars.iv35, -1
  %8 = trunc nuw i64 %indvars.iv35 to i32
...
for.cond36.preheader:                             ; preds = %for.cond31
  %idxprom40 = and i64 %indvars.iv.next36, 4294967295
  br label %for.cond36
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv32 = phi i64 [ %5, %for.cond36.preheader ], [ %indvars.iv.next33, %for.body39 ]
  %cmp37 = icmp sgt i64 %indvars.iv32, 0
  br i1 %cmp37, label %for.body39, label %for.cond31, !llvm.loop !15

for.body39:                                       ; preds = %for.cond36
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, -1
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %idxprom40, i64 %indvars.iv.next33
  %11 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %cmp44 = icmp eq i32 %11, 0
...
cleanup48.split.loop.exit:                        ; preds = %for.body39
  ...
  %12 = trunc nsw i64 %indvars.iv.next33 to i32
