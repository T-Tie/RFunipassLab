; ModuleID = '/tmp/tmpzc01ic6o.cpp'
source_filename = "/tmp/tmpzc01ic6o.cpp"
...
define dso_local noundef i32 @_Z1fii(i32 noundef %a, i32 noundef %b) #0 {
entry:
...
land.lhs.true:                                    ; preds = %for.body
  %8 = load i32, ptr %a.addr, align 4, !tbaa !5
...
if.then5:                                         ; preds = %land.lhs.true
  %11 = load i32, ptr %a.addr, align 4, !tbaa !5
  %12 = load i32, ptr %i, align 4, !tbaa !5
  %div6 = sdiv i32 %11, %12
  %13 = load i32, ptr %i, align 4, !tbaa !5
  %call = call noundef i32 @_Z1fii(i32 noundef %div6, i32 noundef %13)
  %add = add nsw i32 %call, 1
  %14 = load i32, ptr %k, align 4, !tbaa !5
  %add7 = add nsw i32 %14, %add
  store i32 %add7, ptr %k, align 4, !tbaa !5
  br label %if.end
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z1fii(i32 noundef %1, i32 noundef 2)
