...
for.body:                                         ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  call void @_Z6fenjiei(i32 noundef %1)
...
entry:
  ...
  %cmp10 = icmp slt i32 %1, %x
  br i1 %cmp10, label %for.body, label %for.end

for.body:                                         ; preds = %entry, %for.inc
  %2 = phi i32 [ %6, %for.inc ], [ %0, %entry ]
  %j.011 = phi i32 [ %inc9, %for.inc ], [ %1, %entry ]
  %rem = srem i32 %x, %j.011
  %div = sdiv i32 %x, %j.011
  %cmp1 = icmp ne i32 %rem, 0
  %cmp2.not = icmp slt i32 %div, %j.011
...
if.then:                                          ; preds = %for.body
  ...
  store i32 %j.011, ptr %arrayidx4, align 4, !tbaa !5
  tail call void @_Z6fenjiei(i32 noundef %div)
...
for.inc:                                          ; preds = %for.body, %if.then
  %6 = phi i32 [ %dec, %if.then ], [ %2, %for.body ]
  %j.1 = phi i32 [ %4, %if.then ], [ %j.011, %for.body ]
  %inc9 = add nsw i32 %j.1, 1
  %cmp = icmp slt i32 %inc9, %x
