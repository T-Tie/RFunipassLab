...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %exitcond = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond, label %for.end10, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv18
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv26.in = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv26, %for.body15 ]
  %indvars.iv23 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next24, %for.body15 ]
  %cmp14 = icmp sgt i64 %indvars.iv23, 0
  br i1 %cmp14, label %for.body15, label %for.end33

for.body15:                                       ; preds = %for.cond13
  %indvars.iv26 = add nsw i64 %indvars.iv26.in, -1
  %indvars.iv.next24 = add nsw i64 %indvars.iv23, -1
  %arrayidx17 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next24
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv29 = phi i64 [ %indvars.iv26, %for.cond22.preheader ], [ %indvars.iv.next30, %for.inc28 ]
  %cmp23.not.not = icmp slt i64 %indvars.iv29, %6
  br i1 %cmp23.not.not, label %for.inc28, label %for.end33.loopexit

for.inc28:                                        ; preds = %for.cond22
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, 1
  %arrayidx26 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next30
...
for.end33.loopexit:                               ; preds = %for.cond22
  %8 = trunc nsw i64 %indvars.iv.next24 to i32
  %.pre50 = and i64 %indvars.iv.next24, 4294967295
  br label %for.end33

for.end33:                                        ; preds = %for.cond13, %for.end33.loopexit
  %.pre-phi = phi i64 [ %.pre50, %for.end33.loopexit ], [ %4, %for.cond13 ]
...
for.cond35:                                       ; preds = %for.inc55, %for.end33
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc55 ], [ %.pre-phi, %for.end33 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc55 ], [ %10, %for.end33 ]
  %j.2 = phi i32 [ %j.3, %for.inc55 ], [ %j.1, %for.end33 ]
  %indvars.iv.next38 = add nsw i64 %indvars.iv37, -1
  %indvars = trunc i64 %indvars.iv.next38 to i32
  %11 = trunc nuw i64 %indvars.iv37 to i32
  %cmp36 = icmp sgt i32 %11, 0
  br i1 %cmp36, label %for.body37, label %for.end57

for.body37:                                       ; preds = %for.cond35
  %idxprom38 = and i64 %indvars.iv.next38, 4294967295
...
for.cond45:                                       ; preds = %for.inc51, %if.then42
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc51 ], [ %indvars.iv32, %if.then42 ]
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %cmp46 = icmp slt i64 %indvars.iv.next35, %13
  br i1 %cmp46, label %for.inc51, label %for.inc55

for.inc51:                                        ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next35
...
for.cond59:                                       ; preds = %for.inc68, %for.end57
  ...
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc68 ], [ 0, %for.end57 ]
...
for.inc68:                                        ; preds = %for.cond59
  ...
  %arrayidx61.phi.trans.insert = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next41
...
for.cond74:                                       ; preds = %for.end10, %for.inc80
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc80 ], [ 0, %for.end10 ]
  %exitcond49 = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond49, label %if.end83, label %for.inc80

for.inc80:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv44
