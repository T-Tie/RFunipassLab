...
for.cond24:                                       ; preds = %for.cond24.preheader, %for.inc41
  %.pre27 = phi i32 [ %.pre28, %for.inc41 ], [ %0, %for.cond24.preheader ]
...
for.cond27:                                       ; preds = %for.cond24, %for.inc38
  %.pre28 = phi i32 [ %.pre, %for.inc38 ], [ %.pre27, %for.cond24 ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc38 ], [ 0, %for.cond24 ]
...
for.inc38:                                        ; preds = %for.body29, %if.then33
  %.pre = phi i32 [ %.pre28, %for.body29 ], [ %.pre.pre, %if.then33 ]
