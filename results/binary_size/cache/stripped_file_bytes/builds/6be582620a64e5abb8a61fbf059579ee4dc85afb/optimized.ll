...
entry:
  ...
  %sub = add i32 %0, -1
  %1 = zext i32 %0 to i64
  %smax93 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count95 = zext nneg i32 %smax93 to i64
  %exitcond90.not = icmp slt i32 %sub, 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc174, %entry
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc174 ], [ 0, %entry ]
  %exitcond96.not = icmp eq i64 %indvars.iv91, %wide.trip.count95
  br i1 %exitcond96.not, label %for.cond177.preheader, label %for.cond1
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %exitcond34.not = icmp eq i64 %indvars.iv30, %1
  br i1 %exitcond34.not, label %for.end12, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv30, i64 %indvars.iv
...
for.end12:                                        ; preds = %for.cond1
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %sum, i64 0, i64 %indvars.iv91
  store i32 %0, ptr %n, align 4, !tbaa !5
  br i1 %exitcond90.not, label %for.inc174, label %for.cond18

for.cond18:                                       ; preds = %for.end12, %for.inc40
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc40 ], [ 0, %for.end12 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count95
  br i1 %exitcond44.not, label %for.cond43, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv40
...
for.cond29:                                       ; preds = %for.body20, %for.inc37
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc37 ], [ 0, %for.body20 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %1
  br i1 %exitcond39.not, label %for.inc40, label %for.inc37

for.inc37:                                        ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv40, i64 %indvars.iv35
...
for.cond43:                                       ; preds = %for.cond18, %for.inc60
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc60 ], [ 0, %for.cond18 ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count95
  br i1 %exitcond55.not, label %for.cond63, label %for.cond46

for.cond46:                                       ; preds = %for.cond43, %for.inc57
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc57 ], [ 0, %for.cond43 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %1
  br i1 %exitcond49.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv50, i64 %indvars.iv45
  %4 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !9
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv45, i64 %indvars.iv50
...
for.cond63:                                       ; preds = %for.cond43, %for.inc88
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc88 ], [ 0, %for.cond43 ]
  %exitcond66.not = icmp eq i64 %indvars.iv61, %wide.trip.count95
  br i1 %exitcond66.not, label %for.cond91, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx67 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv61
...
for.cond76:                                       ; preds = %for.body65, %for.inc84
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc84 ], [ 0, %for.body65 ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %1
  br i1 %exitcond60.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond76
  %arrayidx82 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv61, i64 %indvars.iv56
...
for.cond94:                                       ; preds = %for.cond91, %for.inc105
  %indvars.iv97 = phi i64 [ 0, %for.cond91 ], [ %indvars.iv.next98, %for.inc105 ]
  %exitcond101.not = icmp eq i64 %indvars.iv97, %wide.trip.count95
  br i1 %exitcond101.not, label %for.cond91, label %for.inc105

for.inc105:                                       ; preds = %for.cond94
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv97
  %7 = load i32, ptr %arrayidx98, align 4, !tbaa !5, !invariant.load !9
  %arrayidx104 = getelementptr inbounds nuw [100 x i32], ptr %row, i64 0, i64 %indvars.iv97
