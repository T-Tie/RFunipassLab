...
cleanup.cont:                                     ; preds = %if.end
  ...
  %call = tail call noundef i32 @_Z3wrhiiPiii(i32 noundef %add, i32 noundef %div12, ptr nofree noundef nonnull captures(none) %b, i32 noundef %i.0, i32 noundef %a) #7
  br label %if.end15
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %s) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 dereferenceable(800) %b) #8
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z3wrhiiPiii(i32 noundef 1, i32 noundef %1, ptr noalias nofree noundef nonnull align 16 captures(none) dereferenceable(800) %b, i32 noundef 2, i32 noundef %1) #9
  %2 = load i32, ptr @num, align 4, !tbaa !5
  %add = add nsw i32 %2, 1
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull align 16 dereferenceable(800) %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %a) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s) #9
  ret i32 0
}
