...
for.cond1:                                        ; preds = %for.inc12, %for.cond
  ...
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
while.cond:                                       ; preds = %while.cond.preheader, %for.cond17
  %indvars.iv60 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next61, %for.cond17 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.cond17 ]
  %cmp15 = icmp sgt i32 %indvars.iv60, 1
...
for.cond17:                                       ; preds = %while.cond
  ...
  store i32 %indvars.iv.next61, ptr %n, align 4, !tbaa !5
