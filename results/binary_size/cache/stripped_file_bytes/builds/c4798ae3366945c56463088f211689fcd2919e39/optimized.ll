...
for.cond:                                         ; preds = %for.inc29, %entry.split
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc29 ], [ 1, %entry.split ]
  %arrayidx3 = getelementptr inbounds nuw [5 x i8], ptr %s, i64 %indvars.iv11
...
for.body10:                                       ; preds = %for.cond7
  ...
  %arrayidx19 = getelementptr inbounds nuw [5 x i8], ptr %s, i64 %indvars.iv11, i64 %indvars.iv
...
cleanup.cont:                                     ; preds = %for.cond.cleanup9, %for.end31
  %idxprom32.sink = phi i64 [ %idxprom32, %for.end31 ], [ %indvars.iv11, %for.cond.cleanup9 ]
  %arrayidx33 = getelementptr inbounds [200 x i32], ptr @num, i64 0, i64 %idxprom32.sink
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !12
  %inc16.i.i1 = add nsw i32 %5, 1
  store i32 %inc16.i.i1, ptr %arrayidx33, align 4, !tbaa !12
  ret void
}
...
for.cond:                                         ; preds = %for.cond.preheader, %for.cond.cleanup7
  %j.0 = phi i32 [ %inc16.i.i5, %for.cond.cleanup7 ], [ 1, %for.cond.preheader ]
...
for.cond5:                                        ; preds = %for.cond5.preheader.split, %for.cond5
  %indvars.iv29 = phi i64 [ 0, %for.cond5.preheader.split ], [ %indvars.iv.next30, %for.cond5 ]
  %2 = add nuw nsw i64 %indvars.iv29, %idxprom12.le
  %arrayidx11 = getelementptr inbounds nuw [500 x i8], ptr %c, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx11, align 1, !tbaa !5, !invariant.load !8
  %arrayidx15 = getelementptr inbounds nuw [200 x [5 x i8]], ptr %s, i64 0, i64 %idxprom12.le, i64 %indvars.iv29
...
for.cond.cleanup7:                                ; preds = %for.cond5.preheader
  ...
  %inc16.i.i5 = add nuw nsw i32 %j.0, 1
  br label %for.cond
...
for.cond42:                                       ; preds = %if.end65, %if.else
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %if.end65 ], [ 1, %if.else ]
  %4 = load i32, ptr @n, align 4, !tbaa !12
  %sub43 = sub nsw i32 %0, %4
  %5 = sext i32 %sub43 to i64
  %cmp45.not = icmp sgt i64 %indvars.iv36, %5
  br i1 %cmp45.not, label %if.end70, label %for.body47

for.body47:                                       ; preds = %for.cond42
  %arrayidx49 = getelementptr inbounds nuw [200 x i32], ptr @num, i64 0, i64 %indvars.iv36
...
for.cond53:                                       ; preds = %for.body47, %for.body56
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body56 ], [ 0, %for.body47 ]
  %cmp54 = icmp sgt i32 %7, 0
  br i1 %cmp54, label %for.body56, label %if.end65

for.body56:                                       ; preds = %for.cond53
  %arrayidx60 = getelementptr inbounds nuw [200 x [5 x i8]], ptr %s, i64 0, i64 %indvars.iv36, i64 %indvars.iv33
