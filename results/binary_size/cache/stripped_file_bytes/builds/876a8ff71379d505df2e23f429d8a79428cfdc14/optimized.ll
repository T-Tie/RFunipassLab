...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1200, ptr %b) #11
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 1200, i1 false)
  call void @llvm.lifetime.start.p0(i64 12000, ptr %a) #11
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [300 x [40 x i8]], ptr %a, i64 0, i64 %idxprom
  ...
  %arrayidx3 = getelementptr inbounds [300 x [40 x i8]], ptr %a, i64 0, i64 %idxprom2
  ...
  %arrayidx7 = getelementptr inbounds [300 x i32], ptr %b, i64 0, i64 %idxprom6
...
for.cond8:                                        ; preds = %for.inc30, %for.end
...
for.body11:                                       ; preds = %for.cond8
  ...
  store i32 %add14, ptr %m, align 4, !tbaa !5
  %11 = load i32, ptr %m, align 4, !tbaa !5
  %cmp15 = icmp sle i32 %11, 81
  br i1 %cmp15, label %if.then, label %if.else

if.then:                                          ; preds = %for.body11
  %12 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom16 = sext i32 %12 to i64
  %arrayidx17 = getelementptr inbounds [300 x [40 x i8]], ptr %a, i64 0, i64 %idxprom16
  %arraydecay18 = getelementptr inbounds [40 x i8], ptr %arrayidx17, i64 0, i64 0
...
for.end32:                                        ; preds = %for.cond.cleanup10
  call void @llvm.lifetime.end.p0(i64 12000, ptr %a) #11
  call void @llvm.lifetime.end.p0(i64 1200, ptr %b) #11
...
; Function Attrs: mustprogress uwtable
define available_externally noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #8 align 2 {
entry:
  %this.addr = alloca ptr, align 8
