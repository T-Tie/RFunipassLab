...
for.inc8:                                         ; preds = %for.end
  ...
  store i32 %inc9, ptr %r, align 4, !tbaa !5
...
for.inc55:                                        ; preds = %for.body38
  ...
  store i32 %inc56, ptr %q, align 4, !tbaa !5
...
for.inc58:                                        ; preds = %for.end57
  ...
  store i32 %inc59, ptr %p, align 4, !tbaa !5
...
for.inc61:                                        ; preds = %for.end60
  ...
  store i32 %inc62, ptr %r, align 4, !tbaa !5
...
for.cond67:                                       ; preds = %for.inc76, %for.body66
  %38 = load i32, ptr %p, align 4, !tbaa !5
...
for.inc76:                                        ; preds = %for.body69
  ...
  store i32 %inc77, ptr %p, align 4, !tbaa !5
...
for.end78:                                        ; preds = %for.cond67
  ...
  %call85 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call84, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc86

for.inc86:                                        ; preds = %for.end78
  %47 = load i32, ptr %r, align 4, !tbaa !5
  %inc87 = add nsw i32 %47, 1
  store i32 %inc87, ptr %r, align 4, !tbaa !5
