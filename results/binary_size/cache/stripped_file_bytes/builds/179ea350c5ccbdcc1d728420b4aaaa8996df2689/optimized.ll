...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %a) #10
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry
  ...
  %vtable7.i13 = load ptr, ptr @_ZSt3cin, align 8
  %vbase.offset.ptr8.i14 = getelementptr i8, ptr %vtable7.i13, i64 -24
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  br i1 %cmp, label %if.then6.i12, label %for.end

if.then6.i12:                                     ; preds = %for.cond
  call void @outlined_ir_func_0(ptr %vbase.offset.ptr8.i14, ptr %a)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit31

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit31: ; preds = %if.then6.i12
...
for.inc:                                          ; preds = %if.then, %if.else
  ...
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a)
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !12

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #12
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %a) #12
  ret i32 0
}
...
entry_to_outline:                                 ; preds = %newFuncRoot
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(100) %1, i64 noundef 100)
