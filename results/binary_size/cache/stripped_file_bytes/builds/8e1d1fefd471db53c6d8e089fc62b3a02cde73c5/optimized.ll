...
entry:
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %wide.trip.count20 = zext nneg i32 %smax19 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv30 = phi i32 [ %indvars.iv.next31, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %for.inc29 ], [ 0, %entry ]
  ...
  br i1 %exitcond21.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv16
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = add nuw nsw i64 %indvars.iv, %indvars.iv16
...
for.cond33.preheader:                             ; preds = %for.end
  %wide.trip.count28 = zext i32 %indvars.iv25 to i64
  br label %for.cond33
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv22 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next23, %for.inc40 ]
  %exitcond29.not = icmp eq i64 %indvars.iv22, %wide.trip.count28
  br i1 %exitcond29.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv22
  %5 = load i8, ptr %arrayidx37, align 1, !tbaa !5
  %conv38 = sext i8 %5 to i32
  %putchar11 = call i32 @putchar(i32 %conv38)
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv30 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc53 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv33, %7
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv33
