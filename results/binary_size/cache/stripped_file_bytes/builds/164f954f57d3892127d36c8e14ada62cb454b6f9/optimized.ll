...
for.cond3:                                        ; preds = %for.cond, %if.end52
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %if.end52 ], [ 0, %for.cond ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond56, label %for.cond7
...
for.cond7:                                        ; preds = %for.cond3, %for.inc
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count39
...
for.body10:                                       ; preds = %for.cond7
  %arrayidx14 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv31 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next32, %for.body39 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count39
  br i1 %exitcond35.not, label %if.end52, label %for.body39

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
...
for.cond56:                                       ; preds = %for.cond3, %if.end110
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %if.end110 ], [ 0, %for.cond3 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %wide.trip.count39
  br i1 %exitcond55.not, label %if.end114, label %for.cond60

for.cond60:                                       ; preds = %for.cond56, %for.inc89
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc89 ], [ 0, %for.cond56 ]
  %min.3 = phi i32 [ %min.4, %for.inc89 ], [ 1000, %for.cond56 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count39
  br i1 %exitcond45.not, label %for.cond94.preheader, label %for.body63

for.cond94.preheader:                             ; preds = %for.cond60
  br label %for.cond94

for.body63:                                       ; preds = %for.cond60
  %arrayidx67 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv51
...
if.end77:                                         ; preds = %if.end70
  %spec.select21 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.3)
  br label %for.inc89

for.inc89:                                        ; preds = %if.end77, %for.body63
  %min.4 = phi i32 [ %min.3, %for.body63 ], [ %spec.select21, %if.end77 ]
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond60, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.body97
  %indvars.iv46 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next47, %for.body97 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count39
  br i1 %exitcond50.not, label %if.end110, label %for.body97

for.body97:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv46, i64 %indvars.iv51
