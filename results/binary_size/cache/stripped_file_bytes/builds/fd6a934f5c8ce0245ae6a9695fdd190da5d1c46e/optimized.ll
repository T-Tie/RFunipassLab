...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %delta) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %x1) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %x2) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %x1r) #10
...
do.body:                                          ; preds = %do.cond, %entry
  ...
  store double %4, ptr %delta, align 8, !tbaa !5
  %5 = load double, ptr %delta, align 8, !tbaa !5
...
if.then:                                          ; preds = %do.body
  ...
  %fneg = fneg double %6
  %7 = load double, ptr %delta, align 8, !tbaa !5
  %call6 = call double @sqrt(double noundef %7) #10, !tbaa !9
  %add = fadd double %fneg, %call6
  %8 = load double, ptr %a, align 8, !tbaa !5
  %mul = fmul double 2.000000e+00, %8
  %div = fdiv double %add, %mul
  store double %div, ptr %x1, align 8, !tbaa !5
  %9 = load double, ptr %b, align 8, !tbaa !5
  %fneg7 = fneg double %9
  %10 = load double, ptr %delta, align 8, !tbaa !5
  %call8 = call double @sqrt(double noundef %10) #10, !tbaa !9
  %sub = fsub double %fneg7, %call8
  %11 = load double, ptr %a, align 8, !tbaa !5
  %mul9 = fmul double 2.000000e+00, %11
  %div10 = fdiv double %sub, %mul9
  store double %div10, ptr %x2, align 8, !tbaa !5
  %12 = load double, ptr %x1, align 8, !tbaa !5
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %12)
  ...
  %13 = load double, ptr %x2, align 8, !tbaa !5
  %call13 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %13)
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.3)
...
if.else:                                          ; preds = %do.body
  %14 = load double, ptr %delta, align 8, !tbaa !5
...
if.then17:                                        ; preds = %if.else
  ...
  %mul18 = fmul double 2.000000e+00, %16
  %div19 = fdiv double %15, %mul18
  store double %div19, ptr %x1, align 8, !tbaa !5
  %17 = load double, ptr %x1, align 8, !tbaa !5
  %fneg20 = fneg double %17
  %call21 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg20)
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.3)
...
if.else24:                                        ; preds = %if.else
  %18 = load double, ptr %delta, align 8, !tbaa !5
  %cmp25 = fcmp olt double %18, 0.000000e+00
  br i1 %cmp25, label %if.then26, label %if.end57

if.then26:                                        ; preds = %if.else24
  %19 = load double, ptr %delta, align 8, !tbaa !5
  %fneg27 = fneg double %19
  store double %fneg27, ptr %delta, align 8, !tbaa !5
  %20 = load double, ptr %delta, align 8, !tbaa !5
  %call28 = call double @sqrt(double noundef %20) #10, !tbaa !9
  %21 = load double, ptr %a, align 8, !tbaa !5
  %mul29 = fmul double 2.000000e+00, %21
  %div30 = fdiv double %call28, %mul29
  store double %div30, ptr %x1, align 8, !tbaa !5
  %22 = load double, ptr %delta, align 8, !tbaa !5
  %call31 = call double @sqrt(double noundef %22) #10, !tbaa !9
  %fneg32 = fneg double %call31
  %23 = load double, ptr %a, align 8, !tbaa !5
  %mul33 = fmul double 2.000000e+00, %23
  %div34 = fdiv double %fneg32, %mul33
  store double %div34, ptr %x2, align 8, !tbaa !5
  %24 = load double, ptr %b, align 8, !tbaa !5
  %fneg35 = fneg double %24
  %25 = load double, ptr %a, align 8, !tbaa !5
  %mul36 = fmul double 2.000000e+00, %25
  %div37 = fdiv double %fneg35, %mul36
  store double %div37, ptr %x1r, align 8, !tbaa !5
  %26 = load double, ptr %x1r, align 8, !tbaa !5
  %cmp38 = fcmp oeq double %26, 0.000000e+00
  br i1 %cmp38, label %if.then39, label %if.else49

if.then39:                                        ; preds = %if.then26
  %27 = load double, ptr %x1r, align 8, !tbaa !5
  %fneg40 = fneg double %27
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %fneg40)
  %28 = load double, ptr %x1, align 8, !tbaa !5
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, double noundef %28)
  %call43 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
  %29 = load double, ptr %x1r, align 8, !tbaa !5
  %fneg44 = fneg double %29
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %fneg44)
  %30 = load double, ptr %x2, align 8, !tbaa !5
  %call46 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, double noundef %30)
  %call47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.3)
...
if.else49:                                        ; preds = %if.then26
  %31 = load double, ptr %x1r, align 8, !tbaa !5
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %31)
  %32 = load double, ptr %x1, align 8, !tbaa !5
  %call51 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, double noundef %32)
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
  %33 = load double, ptr %x1r, align 8, !tbaa !5
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %33)
  %34 = load double, ptr %x2, align 8, !tbaa !5
  %call54 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, double noundef %34)
  %call55 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.3)
...
if.end:                                           ; preds = %if.else49, %if.then39
  br label %if.end57

if.end57:                                         ; preds = %if.end, %if.else24
  br label %if.end58

if.end58:                                         ; preds = %if.end57, %if.then17
  br label %if.end59

if.end59:                                         ; preds = %if.end58, %if.then
  %35 = load i32, ptr %n, align 4, !tbaa !9
  %sub60 = sub nsw i32 %35, 1
  store i32 %sub60, ptr %n, align 4, !tbaa !9
  br label %do.cond

do.cond:                                          ; preds = %if.end59
  %36 = load i32, ptr %n, align 4, !tbaa !9
  %cmp61 = icmp sge i32 %36, 1
  br i1 %cmp61, label %do.body, label %do.end, !llvm.loop !11

do.end:                                           ; preds = %do.cond
  call void @llvm.lifetime.end.p0(i64 8, ptr %x1r) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %x2) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %x1) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %delta) #10
...
!32 = !{!33, !31, i64 32}
!33 = !{!"_ZTSSt8ios_base", !34, i64 8, !34, i64 16, !35, i64 24, !31, i64 28, !31, i64 32, !36, i64 40, !37, i64 48, !7, i64 64, !10, i64 192, !38, i64 200, !39, i64 208}
!34 = !{!"long", !7, i64 0}
