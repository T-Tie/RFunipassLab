...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 505, ptr noundef nonnull align 16 %x) #5
  call void @llvm.lifetime.start.p0(i64 noundef 505, ptr noundef nonnull align 16 %y) #5
