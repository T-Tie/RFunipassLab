...
for.cond:                                         ; preds = %for.cond.cleanup12, %if.else
  ...
  %exitcond22.not = icmp eq i32 %i.0, %smax
  br i1 %exitcond22.not, label %while.cond, label %for.cond3
...
for.cond10:                                       ; preds = %for.cond3, %if.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end ], [ 0, %for.cond3 ]
  %exitcond21.not = icmp eq i64 %indvars.iv18, 90
  br i1 %exitcond21.not, label %for.cond.cleanup12, label %for.body13
...
for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %an, i64 0, i64 %indvars.iv18
...
if.then17:                                        ; preds = %for.body13
  ...
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %an, i64 0, i64 %indvars.iv.next19
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %while.cond ], [ 90, %for.cond ]
  %arrayidx32 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv23
...
for.cond34.preheader:                             ; preds = %while.cond
  %5 = trunc nsw i64 %indvars.iv23 to i32
  br label %for.cond34
