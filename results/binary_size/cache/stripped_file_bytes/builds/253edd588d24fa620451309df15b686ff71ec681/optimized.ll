...
for.cond33:                                       ; preds = %for.cond, %for.inc61
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc61 ], [ 0, %for.cond ]
  %arrayidx35 = getelementptr inbounds nuw [100 x i8], ptr %b, i64 0, i64 %indvars.iv28
  %1 = load i8, ptr %arrayidx35, align 1, !tbaa !5
  switch i8 %1, label %if.end98 [
    i8 0, label %for.cond68.preheader
...
for.cond68.preheader:                             ; preds = %for.cond33
  %2 = load i8, ptr %a, align 16, !tbaa !5
  %tobool71.not23 = icmp eq i8 %2, 0
  br i1 %tobool71.not23, label %for.end85, label %for.body72
...
for.body72:                                       ; preds = %for.cond68.preheader, %for.body72
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body72 ], [ 0, %for.cond68.preheader ]
  %3 = phi i8 [ %5, %for.body72 ], [ %2, %for.cond68.preheader ]
  %t.024 = phi i32 [ %spec.select, %for.body72 ], [ 0, %for.cond68.preheader ]
  %arrayidx77 = getelementptr inbounds nuw [100 x i8], ptr %b, i64 0, i64 %indvars.iv31
  %4 = load i8, ptr %arrayidx77, align 1, !tbaa !5
  %cmp79 = icmp eq i8 %3, %4
  %inc81 = zext i1 %cmp79 to i32
  %spec.select = add nuw nsw i32 %t.024, %inc81
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %arrayidx70 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 0, i64 %indvars.iv.next32
  %5 = load i8, ptr %arrayidx70, align 1, !tbaa !5
  %tobool71.not = icmp eq i8 %5, 0
  br i1 %tobool71.not, label %for.end85.loopexit, label %for.body72, !llvm.loop !12

for.end85.loopexit:                               ; preds = %for.body72
  %6 = uitofp nneg i32 %spec.select to double
  br label %for.end85

for.end85:                                        ; preds = %for.end85.loopexit, %for.cond68.preheader
  %t.0.lcssa = phi double [ 0.000000e+00, %for.cond68.preheader ], [ %6, %for.end85.loopexit ]
  ...
  %div = fdiv double %t.0.lcssa, %conv89
  %7 = load double, ptr %n, align 8, !tbaa !13
  %cmp91 = fcmp ogt double %div, %7
