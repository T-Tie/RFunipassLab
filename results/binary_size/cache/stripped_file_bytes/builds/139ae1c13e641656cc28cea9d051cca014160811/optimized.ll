...
for.cond3:                                        ; preds = %for.cond, %for.inc75
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc75 ], [ 0, %for.cond ]
  %counter.0 = phi i32 [ %conv72.sink, %for.inc75 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp4 = icmp slt i64 %indvars.iv22, %5
...
if.then:                                          ; preds = %for.body6
  %add.ptr = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv22
...
if.else:                                          ; preds = %for.body6
  ...
  %add.ptr20 = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv22
...
if.then26:                                        ; preds = %if.else
  ...
  %6 = trunc i64 %call37 to i32
  %7 = add i32 %counter.0, 1
  %conv41 = add i32 %7, %6
  br label %for.inc75
...
for.inc75:                                        ; preds = %if.then, %if.then52, %if.else60, %if.then26
  %conv72.sink = phi i32 [ %conv72, %if.else60 ], [ 0, %if.then52 ], [ %conv41, %if.then26 ], [ %conv16, %if.then ]
