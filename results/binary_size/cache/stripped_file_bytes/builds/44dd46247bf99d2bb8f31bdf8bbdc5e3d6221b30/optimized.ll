...
for.cond:                                         ; preds = %if.end, %entry
  %1 = phi i32 [ %7, %if.end ], [ %.pre2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end ], [ %0, %entry ]
  %flag.0 = phi i32 [ %flag.1, %if.end ], [ 0, %entry ]
...
if.then:                                          ; preds = %for.body
  ...
  tail call void @_Z3daoii(i32 noundef %3, i32 noundef %5) #6
...
for.cond2:                                        ; preds = %for.cond, %for.body4
  ...
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.body4 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv4, %3
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr @a, i64 0, i64 %indvars.iv4
  %5 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  %6 = trunc nuw nsw i64 %indvars.iv4 to i32
  tail call void @_Z3daoii(i32 noundef %5, i32 noundef %6) #7
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %.pre = load i32, ptr @n, align 4, !tbaa !5
  br label %for.cond2, !llvm.loop !14

for.cond10:                                       ; preds = %for.cond10.preheader, %if.end
  %indvars.iv7 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next8, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond.not, label %for.end30, label %for.body12

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv7
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %arrayidx16 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv.next8
...
for.end30:                                        ; preds = %for.cond10
  ...
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %9) #7
  ret i32 0
}
