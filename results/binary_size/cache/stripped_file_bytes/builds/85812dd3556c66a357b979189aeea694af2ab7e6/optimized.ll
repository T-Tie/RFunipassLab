...
for.cond7:                                        ; preds = %for.body9, %for.end
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body9 ], [ 2, %for.end ]
  %5 = sext i32 %4 to i64
  %cmp8.not = icmp sgt i64 %indvars.iv18, %5
  br i1 %cmp8.not, label %for.end35, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [1000 x float], ptr %b, i64 0, i64 %indvars.iv18
  %6 = load float, ptr %arrayidx11, align 4, !tbaa !12
  %arrayidx13 = getelementptr inbounds nuw [1000 x float], ptr %a, i64 0, i64 %indvars.iv18
  %7 = load float, ptr %arrayidx13, align 4, !tbaa !12
  %div14 = fdiv float %6, %7
  %arrayidx16 = getelementptr inbounds nuw [1000 x float], ptr %c, i64 0, i64 %indvars.iv18
...
for.end35:                                        ; preds = %for.cond7
  ...
  %call.i = call i32 @getc(ptr noundef %9)
  %10 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i13 = call i32 @getc(ptr noundef %10)
