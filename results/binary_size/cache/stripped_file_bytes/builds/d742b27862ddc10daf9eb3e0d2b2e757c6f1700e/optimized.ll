...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50, ptr %str) #12
  %arraydecay = getelementptr inbounds [50 x i8], ptr %str, i64 0, i64 0
  ...
  %arraydecay1 = getelementptr inbounds [50 x i8], ptr %str, i64 0, i64 0
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay1)
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arraydecay4 = getelementptr inbounds [50 x i8], ptr %str, i64 0, i64 0
  %call5 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %arraydecay4)
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  %arraydecay7 = getelementptr inbounds [50 x i8], ptr %str, i64 0, i64 0
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call6, ptr noundef %arraydecay7)
  %arraydecay9 = getelementptr inbounds [50 x i8], ptr %str, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %arraydecay9, i8 0, i64 50, i1 false)
  br label %for.cond, !llvm.loop !5

for.end:                                          ; preds = %for.cond
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  call void @llvm.lifetime.end.p0(i64 50, ptr %str) #12
  ret i32 0
}
...
entry:
  ...
  store ptr %__in, ptr %__in.addr, align 8, !tbaa !8
  ...
  store i64 %1, ptr %__n, align 8, !tbaa !15
  %2 = load i64, ptr %__n, align 8, !tbaa !15
...
do.end:                                           ; preds = %do.cond
  %3 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  ...
  %4 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %vtable1 = load ptr, ptr %4, align 8, !tbaa !19
...
if.else:                                          ; preds = %entry
  %5 = load i64, ptr %__n, align 8, !tbaa !15
  %cmp5 = icmp ne i64 %5, -1
  br i1 %cmp5, label %if.then6, label %if.else34

if.then6:                                         ; preds = %if.else
  %6 = load i64, ptr %__n, align 8, !tbaa !15
  %div = udiv i64 %6, 1
  store i64 %div, ptr %__n, align 8, !tbaa !15
  call void @llvm.lifetime.start.p0(i64 8, ptr %__w) #12
  %7 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %vtable7 = load ptr, ptr %7, align 8, !tbaa !19
  ...
  store i64 %call11, ptr %__w, align 8, !tbaa !15
  %8 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %9 = load ptr, ptr %__s.addr, align 8, !tbaa !13
  %10 = load i64, ptr %__n, align 8, !tbaa !15
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) %8, ptr noundef %9, i64 noundef %10)
  %11 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %vtable12 = load ptr, ptr %11, align 8, !tbaa !19
...
land.lhs.true:                                    ; preds = %if.then6
  %12 = load i64, ptr %__w, align 8, !tbaa !15
  %cmp17 = icmp sle i64 %12, 0
  br i1 %cmp17, label %if.then19, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true
  %13 = load i64, ptr %__n, align 8, !tbaa !15
  %14 = load i64, ptr %__w, align 8, !tbaa !15
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %15 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %vtable20 = load ptr, ptr %15, align 8, !tbaa !19
  ...
  %16 = load i8, ptr %__eof, align 1, !tbaa !23, !range !25, !noundef !17
...
if.then28:                                        ; preds = %if.then19
  %17 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %vtable29 = load ptr, ptr %17, align 8, !tbaa !19
...
if.else34:                                        ; preds = %if.else
  ...
  store i64 9223372036854775807, ptr %__n35, align 8, !tbaa !15
  %18 = load i64, ptr %__n35, align 8, !tbaa !15
  %div36 = udiv i64 %18, 1
  store i64 %div36, ptr %__n35, align 8, !tbaa !15
  %19 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
  %20 = load ptr, ptr %__s.addr, align 8, !tbaa !13
  %21 = load i64, ptr %__n35, align 8, !tbaa !15
...
if.end38:                                         ; preds = %if.end37, %do.end
  %22 = load ptr, ptr %__in.addr, align 8, !tbaa !8, !nonnull !17, !align !18
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %__out.addr, align 8, !tbaa !26, !nonnull !17, !align !18
...
if.else:                                          ; preds = %entry
  %2 = load ptr, ptr %__out.addr, align 8, !tbaa !26, !nonnull !17, !align !18
  %3 = load ptr, ptr %__s.addr, align 8, !tbaa !13
  %4 = load ptr, ptr %__s.addr, align 8, !tbaa !13
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %4)
  %call1 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef %3, i64 noundef %call)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %5 = load ptr, ptr %__out.addr, align 8, !tbaa !26, !nonnull !17, !align !18
  ret ptr %5
}
...
entry:
  ...
  %0 = load ptr, ptr %__os.addr, align 8, !tbaa !26, !nonnull !17, !align !18
  %1 = load ptr, ptr %__os.addr, align 8, !tbaa !26, !nonnull !17, !align !18
  %vtable = load ptr, ptr %1, align 8, !tbaa !19
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %1, i64 %vbase.offset
...
entry:
  ...
  store i64 %__wide, ptr %__wide.addr, align 8, !tbaa !15
  %this1 = load ptr, ptr %this.addr, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i32 %call4, ptr %__ret, align 4, !tbaa !21
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  store i32 %call5, ptr %__ret, align 4, !tbaa !21
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %1 = load i32, ptr %__ret, align 4, !tbaa !21
...
entry:
  ...
  %0 = load ptr, ptr %__c1.addr, align 8, !tbaa !50, !nonnull !17, !align !52
  %1 = load i32, ptr %0, align 4, !tbaa !21
  %2 = load ptr, ptr %__c2.addr, align 8, !tbaa !50, !nonnull !17, !align !52
...
entry:
  ...
  store ptr %__c, ptr %__c.addr, align 8, !tbaa !13
  %0 = load ptr, ptr %__c.addr, align 8, !tbaa !13, !nonnull !17
...
!28 = !{!10, !10, i64 0}
!29 = !{!30, !30, i64 0}
!30 = !{!"p1 _ZTSSt8ios_base", !10, i64 0}
!31 = !{!32, !16, i64 16}
!32 = !{!"_ZTSSt8ios_base", !16, i64 8, !16, i64 16, !33, i64 24, !34, i64 28, !34, i64 32, !35, i64 40, !36, i64 48, !11, i64 64, !22, i64 192, !37, i64 200, !38, i64 208}
!33 = !{!"_ZTSSt13_Ios_Fmtflags", !11, i64 0}
!34 = !{!"_ZTSSt12_Ios_Iostate", !11, i64 0}
!35 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !10, i64 0}
!36 = !{!"_ZTSNSt8ios_base6_WordsE", !10, i64 0, !16, i64 8}
!37 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !10, i64 0}
!38 = !{!"_ZTSSt6locale", !39, i64 0}
!39 = !{!"p1 _ZTSNSt6locale5_ImplE", !10, i64 0}
!40 = !{!41, !41, i64 0}
!41 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0}
!42 = !{!34, !34, i64 0}
!43 = !{!44, !45, i64 232}
!44 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !32, i64 0, !27, i64 216, !11, i64 224, !24, i64 225, !45, i64 232, !46, i64 240, !47, i64 248, !48, i64 256}
!45 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !10, i64 0}
!46 = !{!"p1 _ZTSSt5ctypeIcE", !10, i64 0}
!47 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !10, i64 0}
!48 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !10, i64 0}
!49 = !{!45, !45, i64 0}
!50 = !{!51, !51, i64 0}
!51 = !{!"p1 int", !10, i64 0}
!52 = !{i64 4}
!53 = !{!32, !34, i64 32}
!54 = !{!55, !14, i64 16}
!55 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !14, i64 8, !14, i64 16, !14, i64 24, !14, i64 32, !14, i64 40, !14, i64 48, !38, i64 56}
!56 = !{!55, !14, i64 24}
!57 = !{!11, !11, i64 0}
!58 = !{!44, !46, i64 240}
!59 = !{!46, !46, i64 0}
!60 = !{!61, !11, i64 56}
!61 = !{!"_ZTSSt5ctypeIcE", !62, i64 0, !63, i64 16, !24, i64 24, !51, i64 32, !51, i64 40, !64, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
