; ModuleID = '<stdin>'
source_filename = "/tmp/tmpz8om39ip.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %p) #4
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %div = sdiv i32 %0, 100
  store i32 %div, ptr %p, align 16, !tbaa !5
  %rem = srem i32 %0, 100
  %div1.lhs.trunc = trunc nsw i32 %rem to i8
  %div13 = sdiv i8 %div1.lhs.trunc, 50
  %div1.sext = sext i8 %div13 to i32
  %arrayidx2 = getelementptr inbounds nuw i8, ptr %p, i64 4
  store i32 %div1.sext, ptr %arrayidx2, align 4, !tbaa !5
  %rem3 = srem i32 %0, 50
  %div4.lhs.trunc = trunc nsw i32 %rem3 to i8
  %div44 = sdiv i8 %div4.lhs.trunc, 20
  %div4.sext = sext i8 %div44 to i32
  %arrayidx5 = getelementptr inbounds nuw i8, ptr %p, i64 8
  store i32 %div4.sext, ptr %arrayidx5, align 8, !tbaa !5
  %mul.neg = mul nsw i32 %div4.sext, 236
  %sub = add nsw i32 %mul.neg, %rem3
  %div8.lhs.trunc = trunc i32 %sub to i8
  %div85 = sdiv i8 %div8.lhs.trunc, 10
  %div8.sext = sext i8 %div85 to i32
  %arrayidx9 = getelementptr inbounds nuw i8, ptr %p, i64 12
  store i32 %div8.sext, ptr %arrayidx9, align 4, !tbaa !5
  %rem10 = srem i32 %0, 10
  %div11.lhs.trunc = trunc nsw i32 %rem10 to i8
  %div116 = sdiv i8 %div11.lhs.trunc, 5
  %div11.sext = sext i8 %div116 to i32
  %arrayidx12 = getelementptr inbounds nuw i8, ptr %p, i64 16
  store i32 %div11.sext, ptr %arrayidx12, align 16, !tbaa !5
  %rem13 = srem i32 %0, 5
  %arrayidx14 = getelementptr inbounds nuw i8, ptr %p, i64 20
  store i32 %rem13, ptr %arrayidx14, align 4, !tbaa !5
  br label %for.body

for.cond.cleanup:                                 ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %p) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #4
  ret i32 0

for.body:                                         ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %arrayidx15 = getelementptr inbounds nuw [6 x i32], ptr %p, i64 0, i64 %indvars.iv
  %1 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %1)
  %vtable.i = load ptr, ptr %call16, align 8, !tbaa !9
