...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  %indvars.iv5 = phi i64 [ %indvars.iv, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc8 ]
  %cmp3 = icmp sgt i64 %indvars.iv5, 0
...
for.inc8:                                         ; preds = %for.cond2
  ...
  %2 = trunc nsw i64 %indvars.iv.next6 to i32
  %call5 = call noundef i32 @_Z6searchii(i32 noundef %2, i32 noundef %0) #7
  %add = add nuw nsw i32 %call5, 1
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr @num, i64 0, i64 %indvars.iv.next6
  store i32 %add, ptr %arrayidx7, align 4, !tbaa !5
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv8 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next9, %for.body13 ]
...
for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr @num, i64 0, i64 %indvars.iv8
