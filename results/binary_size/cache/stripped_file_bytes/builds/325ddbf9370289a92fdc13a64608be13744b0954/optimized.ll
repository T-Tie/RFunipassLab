...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %c) #9
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp14.not = phi i1 [ true, %entry ], [ false, %for.inc ]
...
if.then6.i:                                       ; preds = %for.cond
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(41) %c, i64 noundef 41)
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %1 = load i64, ptr %_M_width.i8.i, align 8, !tbaa !10, !invariant.load !9
  %2 = add i64 %1, -42
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #11
  %sext = shl i64 %s.0, 32
  %conv = ashr exact i64 %sext, 32
  %add = add nsw i64 %conv, 1
  %add4 = add i64 %add, %call3
  %conv5 = trunc i64 %add4 to i32
  %cmp6 = icmp sgt i32 %conv5, 81
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #11
...
for.inc:                                          ; preds = %if.then, %if.then15, %if.else
  %s.1 = phi i64 [ %add10, %if.then ], [ %add4, %if.then15 ], [ %add4, %if.else ]
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %c)
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %c) #10
