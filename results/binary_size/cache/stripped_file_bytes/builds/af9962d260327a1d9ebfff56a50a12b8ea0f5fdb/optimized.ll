...
for.cond18:                                       ; preds = %for.cond, %for.inc40
  %.pre25 = phi i32 [ %.pre, %for.inc40 ], [ %2, %for.cond ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc40 ], [ 1, %for.cond ]
  %6 = sext i32 %.pre25 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv22, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end42

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %result, i64 0, i64 %indvars.iv22
...
for.inc40.sink.split:                             ; preds = %for.body21, %if.then37, %if.then31
  ...
  %puts19 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.sink) #5
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc40

for.inc40:                                        ; preds = %for.inc40.sink.split, %for.body21
  %.pre = phi i32 [ %.pre.pre, %for.inc40.sink.split ], [ %.pre25, %for.body21 ]
