...
entry:
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count15 = zext nneg i32 %smax14 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %if.end28, %entry
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %if.end28 ], [ %conv9, %entry ]
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %if.end28 ], [ 0, %entry ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %if.end28 ], [ 0, %entry ]
  %g.0 = phi i32 [ %g.1, %if.end28 ], [ undef, %entry ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv11
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = add nuw nsw i64 %indvars.iv, %indvars.iv11
...
for.cond33.preheader:                             ; preds = %for.end
  %wide.trip.count23 = zext i32 %indvars.iv20 to i64
  br label %for.cond33

if.end28:                                         ; preds = %for.end, %for.body
  %g.1 = phi i32 [ %g.2, %for.end ], [ %g.0, %for.body ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body35
  %indvars.iv17 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next18, %for.body35 ]
  %exitcond24.not = icmp eq i64 %indvars.iv17, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end42, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv17
  %5 = load i8, ptr %arrayidx37, align 1, !tbaa !5
  %conv38 = sext i8 %5 to i32
  %putchar6 = call i32 @putchar(i32 noundef %conv38) #8
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv25 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.body48, %for.end42
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body48 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv28, %7
  br i1 %cmp47, label %for.body48, label %if.end58

for.body48:                                       ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv28
