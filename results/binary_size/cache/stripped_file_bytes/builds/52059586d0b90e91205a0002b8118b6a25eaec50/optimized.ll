...
for.cond5:                                        ; preds = %entry, %for.body8
  %p.0 = phi i32 [ %inc13, %for.body8 ], [ 0, %entry ]
  %exitcond.not = icmp eq i32 %p.0, 6
  br i1 %exitcond.not, label %for.end14, label %for.body8

for.body8:                                        ; preds = %for.cond5
  %call11 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 poison) #7
