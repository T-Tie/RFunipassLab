...
for.cond:                                         ; preds = %for.inc9, %entry
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc9 ], [ 0, %entry ]
  %12 = sext i32 %11 to i64
  %cmp = icmp slt i64 %indvars.iv16, %12
  br i1 %cmp, label %for.cond3.preheader, label %for.cond12.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %13 = mul nuw nsw i64 %indvars.iv16, %3
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %14 = phi i32 [ %10, %for.cond3.preheader ], [ %.pre60, %for.inc ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.inc20
  %indvars.iv19 = phi i64 [ 0, %for.cond12.preheader ], [ %indvars.iv.next20, %for.inc20 ]
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv23 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next24, %for.inc31 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond34, label %for.inc31

for.inc31:                                        ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv23
  %18 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv23
  store i32 %18, ptr %arrayidx30, align 4, !tbaa !5
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond23, !llvm.loop !15

for.cond34:                                       ; preds = %for.cond23, %for.inc56
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc56 ], [ 0, %for.cond23 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond38.not, label %for.cond59, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond34
  %19 = mul nuw nsw i64 %indvars.iv34, %3
  %arrayidx41 = getelementptr inbounds nuw i32, ptr %vla, i64 %19
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv34
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  ...
  br i1 %exitcond33.not, label %for.inc56, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw i32, ptr %arrayidx41, i64 %indvars.iv29
...
for.cond59:                                       ; preds = %for.cond34, %for.inc83
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc83 ], [ 0, %for.cond34 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count27
  br i1 %exitcond48.not, label %for.cond86, label %for.cond62.preheader

for.cond62.preheader:                             ; preds = %for.cond59
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv44
  %arrayidx70 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv44
  br label %for.cond62

for.cond62:                                       ; preds = %for.cond62.preheader, %for.body64
  %indvars.iv39 = phi i64 [ 0, %for.cond62.preheader ], [ %indvars.iv.next40, %for.body64 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count
  br i1 %exitcond43.not, label %for.inc83, label %for.body64

for.body64:                                       ; preds = %for.cond62
  %22 = mul nuw nsw i64 %indvars.iv39, %3
  ...
  %spec.store.select13 = call i32 @llvm.smin.i32(i32 %23, i32 %24)
  store i32 %spec.store.select13, ptr %arrayidx70, align 4
...
for.cond86:                                       ; preds = %for.cond59, %for.inc103
  %.pre5657 = phi i32 [ %.pre5658, %for.inc103 ], [ %10, %for.cond59 ]
  %25 = phi i32 [ %29, %for.inc103 ], [ %10, %for.cond59 ]
  %26 = phi i32 [ %.pre55, %for.inc103 ], [ %11, %for.cond59 ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc103 ], [ 0, %for.cond59 ]
  %k.0 = phi i32 [ %k.1, %for.inc103 ], [ 0, %for.cond59 ]
  %27 = sext i32 %26 to i64
  %cmp87 = icmp slt i64 %indvars.iv52, %27
  br i1 %cmp87, label %for.cond89.preheader, label %for.end105

for.cond89.preheader:                             ; preds = %for.cond86
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv52
  %28 = trunc nuw nsw i64 %indvars.iv52 to i32
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc100
  %.pre5658 = phi i32 [ %.pre5657, %for.cond89.preheader ], [ %.pre56, %for.inc100 ]
  %29 = phi i32 [ %25, %for.cond89.preheader ], [ %.pre56, %for.inc100 ]
  %indvars.iv49 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next50, %for.inc100 ]
  %k.1 = phi i32 [ %k.0, %for.cond89.preheader ], [ %k.2, %for.inc100 ]
  %30 = sext i32 %29 to i64
  %cmp90 = icmp slt i64 %indvars.iv49, %30
...
for.body91:                                       ; preds = %for.cond89
  ...
  %arrayidx95 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv49
...
for.inc103:                                       ; preds = %for.cond89
  ...
  %.pre55 = load i32, ptr %m, align 4, !tbaa !5
