...
if.then6.i:                                       ; preds = %for.cond
  ...
  %or.cond52 = select i1 %cmp.i.i, i1 %or.cond.i, i1 false
  br i1 %or.cond52, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
if.end:                                           ; preds = %if.then
  %5 = add nsw i32 %add, -79
  %or.cond = icmp samesign ult i32 %5, 2
  br i1 %or.cond, label %if.end17, label %if.then19
...
if.end17:                                         ; preds = %if.end
  ...
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %word, i64 noundef %call.i.i18)
...
if.then19:                                        ; preds = %if.end
  %vtable.i44 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  ...
  %call1.i48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
  ...
  %call.i.i25 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i49, ptr noundef nonnull %word, i64 noundef %call.i.i25)
  %add23 = add nsw i32 %conv, 1
  br label %for.inc

if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call1.i32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %word, i64 noundef %call3)
  %add27 = add nsw i32 %conv, 1
  br label %for.inc

for.inc:                                          ; preds = %if.end17, %if.else, %if.then19, %if.then6
  %sumlen.1 = phi i32 [ %inc, %if.then6 ], [ %add23, %if.then19 ], [ 0, %if.end17 ], [ %add27, %if.else ]
