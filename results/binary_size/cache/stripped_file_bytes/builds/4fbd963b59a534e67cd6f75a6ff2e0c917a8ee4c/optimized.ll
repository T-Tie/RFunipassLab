...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.end26 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body18 ], [ 0, %for.cond13 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17 = icmp slt i64 %indvars.iv11, %7
...
for.cond64:                                       ; preds = %for.cond13, %for.end85
  %i.3 = phi i32 [ %inc87, %for.end85 ], [ 0, %for.cond13 ]
...
for.cond67:                                       ; preds = %for.cond64, %if.end
  %j.3 = phi i32 [ %inc84, %if.end ], [ 0, %for.cond64 ]
