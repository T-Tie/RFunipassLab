...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %total) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %eff) #9
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %e1) #9
  ...
  store double %div, ptr %e1, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 4, ptr %total2) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %eff2) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr %e2) #9
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load i32, ptr %eff2, align 4, !tbaa !5
  %conv6 = sitofp i32 %4 to double
  %5 = load i32, ptr %total2, align 4, !tbaa !5
  %conv7 = sitofp i32 %5 to double
  %div8 = fdiv double %conv6, %conv7
  store double %div8, ptr %e2, align 8, !tbaa !9
  %6 = load double, ptr %e2, align 8, !tbaa !9
  %7 = load double, ptr %e1, align 8, !tbaa !9
  %sub9 = fsub double %6, %7
  %cmp10 = fcmp ogt double %sub9, 5.000000e-02
  br i1 %cmp10, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
if.else:                                          ; preds = %for.body
  %8 = load double, ptr %e1, align 8, !tbaa !9
  %9 = load double, ptr %e2, align 8, !tbaa !9
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p0(i64 8, ptr %e2) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %eff2) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %total2) #9
  call void @llvm.lifetime.end.p0(i64 8, ptr %e1) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %eff) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %total) #9
