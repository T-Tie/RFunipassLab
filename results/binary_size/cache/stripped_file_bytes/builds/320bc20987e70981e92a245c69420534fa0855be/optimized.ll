...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre29, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv16, i64 %indvars.iv
...
for.cond10:                                       ; preds = %if.then25, %for.cond10.preheader
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %if.then25 ], [ 0, %for.cond10.preheader ]
  %a.0 = phi i32 [ %a.234, %if.then25 ], [ undef, %for.cond10.preheader ]
  %b.0 = phi i32 [ %b.235, %if.then25 ], [ undef, %for.cond10.preheader ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end36, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv23 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv19 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next20, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond.not, label %if.then25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv23, i64 %indvars.iv19
...
if.then25:                                        ; preds = %for.cond13, %for.end23
  %b.235 = phi i32 [ %6, %for.end23 ], [ %b.0, %for.cond13 ]
  %a.234 = phi i32 [ %4, %for.end23 ], [ %a.0, %for.cond13 ]
  %arrayidx29 = getelementptr inbounds [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv23, i64 %idxprom28
...
for.end36:                                        ; preds = %for.end23, %if.then25, %for.cond10
  %a.1 = phi i32 [ %a.234, %if.then25 ], [ %4, %for.end23 ], [ %a.0, %for.cond10 ]
  %b.1 = phi i32 [ %b.235, %if.then25 ], [ %6, %for.end23 ], [ %b.0, %for.cond10 ]
  %sub37 = add i32 %0, -1
  %smin = call i32 @llvm.smin.i32(i32 %sub37, i32 -1)
  br label %for.cond38
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc52
  %sub41.sink = phi i32 [ %dec, %for.inc52 ], [ %sub37, %for.cond42.preheader ]
  %cmp43 = icmp sgt i32 %sub41.sink, -1
  br i1 %cmp43, label %for.body44, label %if.then55

for.body44:                                       ; preds = %for.cond42
  %idxprom47 = zext nneg i32 %sub41.sink to i64
...
for.end66:                                        ; preds = %if.then55, %for.cond38, %for.body44
  %sub37.sink14 = phi i32 [ %sub37.sink, %for.body44 ], [ %smin, %for.cond38 ], [ %sub37.sink, %if.then55 ]
  %d.1 = phi i32 [ %sub41.sink, %for.body44 ], [ undef, %for.cond38 ], [ undef, %if.then55 ]
  %10 = xor i32 %b.1, -1
  %sub68 = add i32 %d.1, %10
  %11 = xor i32 %a.1, -1
  %sub70 = add i32 %sub37.sink14, %11
