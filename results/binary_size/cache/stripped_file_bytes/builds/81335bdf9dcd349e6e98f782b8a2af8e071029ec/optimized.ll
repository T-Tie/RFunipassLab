...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.end34
  %indvars.iv15 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next16, %for.end34 ]
...
for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv15
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %if.end31
  %indvars.iv17 = phi i64 [ %indvars.iv15, %for.cond14.preheader ], [ %indvars.iv.next18, %if.end31 ]
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %4 = trunc nuw i64 %indvars.iv.next18 to i32
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv.next18
...
for.cond38:                                       ; preds = %for.cond11, %for.body41
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body41 ], [ 0, %for.cond11 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.end48, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv21
