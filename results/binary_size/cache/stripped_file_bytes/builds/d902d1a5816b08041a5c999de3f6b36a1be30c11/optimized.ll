...
for.cond11:                                       ; preds = %for.inc35, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc35 ], [ 0, %for.end ]
  %num.0 = phi i32 [ %num.1, %for.inc35 ], [ 0, %for.end ]
  %exitcond11.not = icmp eq i64 %indvars.iv8, 16
  br i1 %exitcond11.not, label %for.cond38.preheader, label %for.cond14.preheader

for.cond38.preheader:                             ; preds = %for.cond11
  br label %for.cond38

for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc32
  %indvars.iv4 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next5, %for.inc32 ]
  %num.1 = phi i32 [ %num.0, %for.cond14.preheader ], [ %num.2, %for.inc32 ]
  %exitcond7.not = icmp eq i64 %indvars.iv4, 16
  br i1 %exitcond7.not, label %for.inc35, label %for.body16

for.body16:                                       ; preds = %for.cond14
  br i1 %cmp19.not, label %for.inc32, label %land.lhs.true

land.lhs.true:                                    ; preds = %for.body16
  %arrayidx21 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv4
  %3 = load i32, ptr %arrayidx21, align 4, !tbaa !9, !invariant.load !8
  %cmp22 = icmp ne i32 %3, 0
  %mul = shl nsw i32 %3, 1
  %cmp28 = icmp eq i32 %2, %mul
  %or.cond2 = select i1 %cmp22, i1 %cmp28, i1 false
  %inc30 = zext i1 %or.cond2 to i32
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc43
  %indvars.iv12 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next13, %for.inc43 ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, 16
  br i1 %exitcond15.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv12
