...
for.cond:                                         ; preds = %for.cond161.preheader, %entry
...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.end ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.cond13:                                       ; preds = %for.cond1
  ...
  br i1 %cmp14, label %if.end70, label %for.cond161.preheader

for.cond161.preheader:                            ; preds = %for.cond13
  %call171 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 0) #7
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %a) #7
  br label %for.cond

if.end70:                                         ; preds = %for.cond13, %if.end70
  br label %if.end70
