...
for.cond14.preheader:                             ; preds = %for.cond
  %3 = add i32 %k.0, -1
  %smax35 = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
  %4 = add nuw i32 %smax35, 1
  br label %for.cond14
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.end39
  %indvars.iv32 = phi i32 [ %3, %for.cond14.preheader ], [ %indvars.iv.next33, %for.end39 ]
  %m.0 = phi i32 [ 1, %for.cond14.preheader ], [ %inc41, %for.end39 ]
  %exitcond36 = icmp eq i32 %m.0, %4
  br i1 %exitcond36, label %for.cond43.preheader, label %for.cond17.preheader

for.cond17.preheader:                             ; preds = %for.cond14
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv32, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond17

for.cond43.preheader:                             ; preds = %for.cond14
  %smax40 = call i32 @llvm.smax.i32(i32 %3, i32 0)
  %wide.trip.count41 = zext nneg i32 %smax40 to i64
  br label %for.cond43

for.cond17:                                       ; preds = %for.cond17.preheader, %if.end36
  %indvars.iv28 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next29, %if.end36 ]
  %exitcond.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond.not, label %for.end39, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %call4, i64 %indvars.iv.next29
  %7 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !9
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %call4, i64 %indvars.iv28
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.body46
  %indvars.iv37 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next38, %for.body46 ]
  %exitcond42.not = icmp eq i64 %indvars.iv37, %wide.trip.count41
  br i1 %exitcond42.not, label %for.end53, label %for.body46

for.body46:                                       ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds nuw i32, ptr %call4, i64 %indvars.iv37
