...
for.body:                                         ; preds = %entry, %if.end77
  %i.03 = phi i32 [ %inc, %if.end77 ], [ 0, %entry ]
...
if.then:                                          ; preds = %for.body
  ...
  %fneg10 = fneg double %1
  %5 = fneg double %3
  %neg14 = fmul double %mul2, %5
  %6 = call double @llvm.fmuladd.f64(double %1, double %1, double %neg14)
  %call15 = call double @sqrt(double noundef %6) #6, !tbaa !5
...
if.then23:                                        ; preds = %if.else
  ...
  %7 = call double @llvm.fmuladd.f64(double %1, double %1, double %neg28)
  %call29 = call double @sqrt(double noundef %7) #6, !tbaa !5
...
if.then36:                                        ; preds = %if.else34
  %8 = call double @llvm.fmuladd.f64(double %fneg37, double %1, double %mul3)
  %call41 = call double @sqrt(double noundef %8) #6, !tbaa !5
  %mul42 = fmul double %2, 2.000000e+00
  %div43 = fdiv double %call41, %mul42
  %fneg49 = fneg double %call41
...
if.else53:                                        ; preds = %if.else34
  ...
  %9 = call double @llvm.fmuladd.f64(double %fneg37, double %1, double %mul3)
  %call61 = call double @sqrt(double noundef %9) #6, !tbaa !5
  %div63 = fdiv double %call61, %mul55
  %fneg72 = fneg double %call61
...
if.end77:                                         ; preds = %if.then23, %if.else53, %if.then36, %if.then
