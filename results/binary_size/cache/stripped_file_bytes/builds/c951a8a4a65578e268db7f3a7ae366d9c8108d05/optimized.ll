...
entry:
  ...
  %smax32 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count33 = zext nneg i32 %smax32 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv43 = phi i32 [ %indvars.iv.next44, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc29 ], [ 0, %entry ]
  %g.0 = phi i32 [ %g.1, %for.inc29 ], [ undef, %entry ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count33
  br i1 %exitcond34.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv29
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv35 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next36, %for.inc40 ]
  %exitcond42.not = icmp eq i64 %indvars.iv35, %wide.trip.count41
  br i1 %exitcond42.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv35
  %5 = load i8, ptr %arrayidx37, align 1, !tbaa !5
  %conv38 = sext i8 %5 to i32
  %putchar24 = call i32 @putchar(i32 noundef %conv38) #8
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv43 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc53 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv46, %7
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv46
