...
for.cond:                                         ; preds = %if.else34.i, %entry
  ...
  br i1 %cmp, label %if.else34.i, label %for.cond.cleanup
...
for.cond11:                                       ; preds = %for.inc35, %for.cond.cleanup
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc35 ], [ 1, %for.cond.cleanup ]
  %s.0 = phi i64 [ %s.1, %for.inc35 ], [ %call6, %for.cond.cleanup ]
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %6 = sext i32 %5 to i64
  %cmp12 = icmp slt i64 %indvars.iv33, %6
...
for.body14:                                       ; preds = %for.cond11
  %arrayidx16 = getelementptr inbounds nuw [20 x i8], ptr %vla, i64 %indvars.iv33
...
if.then:                                          ; preds = %for.body14
  ...
  %7 = mul nuw nsw i64 %indvars.iv33, 20
...
if.else:                                          ; preds = %for.body14
  %vtable.i24 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !12
  ...
  %8 = mul nuw nsw i64 %indvars.iv33, 20
  %add.ptr28 = getelementptr inbounds nuw i8, ptr %vla, i64 %8
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr28) #6
  %call1.i19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i30, ptr noundef nonnull %add.ptr28, i64 noundef %call.i.i18)
