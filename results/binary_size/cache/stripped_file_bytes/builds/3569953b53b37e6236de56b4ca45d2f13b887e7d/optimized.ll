...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv11, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv11, %3
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc71
  %indvars.iv31 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next32, %for.inc71 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond74, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx47 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv31
  %17 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !13
  %arrayidx49 = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv31
  store i32 %17, ptr %arrayidx49, align 4, !tbaa !5
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc68, %for.body44
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc68 ], [ 1, %for.body44 ]
  %exitcond30.not = icmp eq i64 %indvars.iv24, %wide.trip.count29
  br i1 %exitcond30.not, label %for.inc71, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %18 = mul nuw nsw i64 %indvars.iv24, %3
...
for.cond74:                                       ; preds = %for.cond42, %for.inc100
  %.pre4344 = phi i32 [ %.pre4345, %for.inc100 ], [ %12, %for.cond42 ]
  %20 = phi i32 [ %25, %for.inc100 ], [ %12, %for.cond42 ]
  %21 = phi i32 [ %.pre, %for.inc100 ], [ %6, %for.cond42 ]
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc100 ], [ 0, %for.cond42 ]
  %s.0 = phi i32 [ %s.1, %for.inc100 ], [ 0, %for.cond42 ]
  %22 = sext i32 %21 to i64
  %cmp75 = icmp slt i64 %indvars.iv40, %22
  br i1 %cmp75, label %for.cond77.preheader, label %for.end102

for.cond77.preheader:                             ; preds = %for.cond74
  %23 = mul nuw nsw i64 %indvars.iv40, %3
  %arrayidx81 = getelementptr inbounds nuw i32, ptr %vla, i64 %23
  %arrayidx85 = getelementptr inbounds nuw i32, ptr %vla10, i64 %indvars.iv40
  %24 = trunc nuw nsw i64 %indvars.iv40 to i32
  br label %for.cond77

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc97
  %.pre4345 = phi i32 [ %.pre4344, %for.cond77.preheader ], [ %.pre43, %for.inc97 ]
  %25 = phi i32 [ %20, %for.cond77.preheader ], [ %.pre43, %for.inc97 ]
  %indvars.iv37 = phi i64 [ 0, %for.cond77.preheader ], [ %indvars.iv.next38, %for.inc97 ]
  %s.1 = phi i32 [ %s.0, %for.cond77.preheader ], [ %s.2, %for.inc97 ]
  %26 = sext i32 %25 to i64
  %cmp78 = icmp slt i64 %indvars.iv37, %26
  br i1 %cmp78, label %for.body79, label %for.inc100

for.body79:                                       ; preds = %for.cond77
  %arrayidx83 = getelementptr inbounds nuw i32, ptr %arrayidx81, i64 %indvars.iv37
...
land.lhs.true:                                    ; preds = %for.body79
  %arrayidx92 = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv37
...
if.then94:                                        ; preds = %land.lhs.true
  %30 = trunc nuw nsw i64 %indvars.iv37 to i32
  ...
  %.pre43.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc97

for.inc97:                                        ; preds = %for.body79, %land.lhs.true, %if.then94
  %.pre43 = phi i32 [ %.pre43.pre, %if.then94 ], [ %.pre4345, %land.lhs.true ], [ %.pre4345, %for.body79 ]
