...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr %p) #6
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %div = sdiv i32 %0, 100
  %arrayidx = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 0
  store i32 %div, ptr %arrayidx, align 16, !tbaa !5
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %rem = srem i32 %1, 100
  %div1 = sdiv i32 %rem, 50
  %arrayidx2 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 1
  store i32 %div1, ptr %arrayidx2, align 4, !tbaa !5
  %2 = load i32, ptr %n, align 4, !tbaa !5
  %rem3 = srem i32 %2, 50
  %div4 = sdiv i32 %rem3, 20
  %arrayidx5 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 2
  store i32 %div4, ptr %arrayidx5, align 8, !tbaa !5
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %rem6 = srem i32 %3, 50
  %arrayidx7 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 2
  %4 = load i32, ptr %arrayidx7, align 8, !tbaa !5
  %mul = mul nsw i32 %4, 20
  %sub = sub nsw i32 %rem6, %mul
  %div8 = sdiv i32 %sub, 10
  %arrayidx9 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 3
  store i32 %div8, ptr %arrayidx9, align 4, !tbaa !5
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %rem10 = srem i32 %5, 10
  %div11 = sdiv i32 %rem10, 5
  %arrayidx12 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 4
  store i32 %div11, ptr %arrayidx12, align 16, !tbaa !5
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %rem13 = srem i32 %6, 5
  %arrayidx14 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 5
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx15 = getelementptr inbounds [6 x i32], ptr %p, i64 0, i64 %idxprom
  %9 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p0(i64 24, ptr %p) #6
