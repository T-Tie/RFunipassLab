...
for.cond52:                                       ; preds = %for.cond, %for.body57
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body57 ], [ 0, %for.cond ]
...
for.body57:                                       ; preds = %for.cond52
  %arrayidx62 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv20
  ...
  %arrayidx54.phi.trans.insert = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv.next21
...
if.end80:                                         ; preds = %for.end70, %for.cond, %lor.lhs.false, %entry
  %.str.2.sink = phi ptr [ @.str.2, %entry ], [ @.str.2, %lor.lhs.false ], [ @.str.2, %for.cond ], [ %.str.4..str.3, %for.end70 ]
