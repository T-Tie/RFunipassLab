...
entry.split.split:                                ; preds = %entry
  ...
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %c) #6
  br label %for.body43

for.body43:                                       ; preds = %entry.split.split, %for.body43
  %putchar = call i32 @putchar(i32 noundef %conv.le) #6
  br label %for.body43

cleanup58:                                        ; preds = %entry
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %a) #6
