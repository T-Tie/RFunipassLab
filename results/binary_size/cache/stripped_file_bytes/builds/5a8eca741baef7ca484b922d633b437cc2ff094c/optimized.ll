...
for.cond14:                                       ; preds = %for.inc27, %for.end13
  %.pre1112 = phi i32 [ %.pre11, %for.inc27 ], [ %6, %for.end13 ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc27 ], [ 1, %for.end13 ]
...
for.inc27:                                        ; preds = %for.body16, %if.then21
  %.pre11 = phi i32 [ %.pre1112, %for.body16 ], [ %.pre11.pre, %if.then21 ]
...
while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div1415, %if.end ], [ %dec, %while.body ]
