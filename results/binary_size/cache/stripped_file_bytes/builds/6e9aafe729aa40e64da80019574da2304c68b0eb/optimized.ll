...
for.cond:                                         ; preds = %for.inc30, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc30 ], [ 0, %entry ]
  %exitcond11.not = icmp eq i64 %indvars.iv6, 11
  br i1 %exitcond11.not, label %for.end32, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx19 = getelementptr inbounds nuw [15 x i32], ptr %t, i64 0, i64 %indvars.iv6
  br label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [16 x [16 x i32]], ptr %a, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.end:                                          ; preds = %for.body3, %for.body3, %for.cond1
  ...
  %arrayidx25 = getelementptr inbounds nuw [16 x [16 x i32]], ptr %a, i64 0, i64 %indvars.iv6, i64 %idxprom24
...
for.end32:                                        ; preds = %for.end, %for.cond
  %wide.trip.count24 = and i64 %indvars.iv6, 4294967295
  br label %for.cond33

for.cond33:                                       ; preds = %for.inc77, %for.end32
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc77 ], [ 0, %for.end32 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond80, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw [15 x i32], ptr %t, i64 0, i64 %indvars.iv21
  %3 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !9
  %arrayidx68 = getelementptr inbounds nuw [16 x i32], ptr %b, i64 0, i64 %indvars.iv21
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc74
  %indvars.iv12 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next13, %for.inc74 ]
  %exitcond20.not = icmp eq i64 %indvars.iv12, %wide.trip.count19
  br i1 %exitcond20.not, label %for.inc77, label %for.cond42.preheader

for.cond42.preheader:                             ; preds = %for.cond36
  %arrayidx50 = getelementptr inbounds nuw [16 x [16 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv12
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc71
  %indvars.iv14 = phi i64 [ %indvars.iv12, %for.cond42.preheader ], [ %indvars.iv.next15, %for.inc71 ]
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %exitcond17.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond17.not, label %for.inc74, label %for.body46

for.body46:                                       ; preds = %for.cond42
  %4 = load i32, ptr %arrayidx50, align 4, !tbaa !5
  %arrayidx54 = getelementptr inbounds nuw [16 x [16 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv.next15
...
for.cond80:                                       ; preds = %for.cond33, %for.inc86
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc86 ], [ 0, %for.cond33 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count24
  br i1 %exitcond30.not, label %for.end88, label %for.inc86

for.inc86:                                        ; preds = %for.cond80
  %arrayidx84 = getelementptr inbounds nuw [16 x i32], ptr %b, i64 0, i64 %indvars.iv26
