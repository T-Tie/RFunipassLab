...
for.cond6.preheader:                              ; preds = %for.cond
  ...
  %wide.trip.count21 = sext i32 %smax to i64
  br label %for.cond6
...
for.cond38:                                       ; preds = %for.body42, %if.then33
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body42 ], [ %3, %if.then33 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %if.end80, label %for.body42
...
if.end80:                                         ; preds = %for.cond61, %for.cond38
  %puts1.i = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str) #7
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond6

for.end83:                                        ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %c) #7
