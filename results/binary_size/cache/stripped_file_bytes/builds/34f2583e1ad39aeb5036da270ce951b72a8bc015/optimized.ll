...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  %call4 = call double @sqrt(double noundef %conv3) #7, !tbaa !5
...
if.then:                                          ; preds = %for.body6
  ...
  %call8 = call noundef i32 @_Z1tii(i32 noundef %div, i32 noundef %8)
  br label %if.end
...
for.end:                                          ; preds = %for.cond2
  ...
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
...
define dso_local noundef i32 @_Z1tii(i32 noundef %a, i32 noundef %b) #4 {
entry:
...
if.end:                                           ; preds = %if.then
  ...
  %call = call noundef i32 @_Z1tii(i32 noundef %div4, i32 noundef %10)
  br label %if.end5
