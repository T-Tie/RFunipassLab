...
define dso_local noundef range(i32 -2147483647, -2147483648) i32 @_Z6getonePc(ptr noundef nonnull %s) local_unnamed_addr #0 {
entry:
  %targetBlock = tail call fastcc i1 @outlined_ir_func_0(ptr noundef nonnull %s)
...
while.body:                                       ; preds = %while.cond
  ...
  %targetBlock1 = tail call fastcc i1 @outlined_ir_func_0(ptr noundef nonnull %incdec.ptr)
