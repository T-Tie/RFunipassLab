...
for.cond3:                                        ; preds = %for.cond, %for.inc9
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc9 ], [ %indvars.iv, %for.cond ]
  %cmp4 = icmp sgt i64 %indvars.iv5, 0
  br i1 %cmp4, label %for.inc9, label %for.end10

for.inc9:                                         ; preds = %for.cond3
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %str, i64 0, i64 %indvars.iv5
