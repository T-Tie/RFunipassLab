...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %z) #4
  call void @llvm.lifetime.start.p0(i64 noundef 20, ptr noundef nonnull align 16 %x) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %h) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 4 %n)
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %z)
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %z) #6
...
if.then78:                                        ; preds = %for.end73
  ...
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %13)
  br label %for.end86
...
for.end132:                                       ; preds = %for.cond122
  ...
  %puts = call i32 @puts(ptr noundef nonnull readonly captures(none) dereferenceable(1) %x) #7
  br label %for.inc138
...
if.end144:                                        ; preds = %if.then142, %for.end140
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %h) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #7
  call void @llvm.lifetime.end.p0(i64 noundef 20, ptr noundef nonnull %x) #7
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull %z) #7
  ret i32 0
}
