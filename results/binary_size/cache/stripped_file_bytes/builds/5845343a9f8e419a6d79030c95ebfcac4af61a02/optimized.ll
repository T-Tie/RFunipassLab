...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc
  %indvars.iv25 = phi i64 [ %5, %for.cond9.preheader ], [ %indvars.iv.next26, %for.inc ]
  %total.0 = phi i32 [ 0, %for.cond9.preheader ], [ %add, %for.inc ]
  %exitcond31.not = icmp eq i64 %indvars.iv25, %wide.trip.count30
  br i1 %exitcond31.not, label %for.inc82.gvnsink.split, label %for.inc
...
for.cond20.preheader:                             ; preds = %if.else17
  %8 = sext i32 %3 to i64
  %wide.trip.count23 = sext i32 %4 to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc27
  %indvars.iv19 = phi i64 [ %8, %for.cond20.preheader ], [ %indvars.iv.next20, %for.inc27 ]
  %total.1 = phi i32 [ 0, %for.cond20.preheader ], [ %add26, %for.inc27 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.inc82.gvnsink.split, label %for.inc27
...
for.cond42.preheader:                             ; preds = %if.else39
  ...
  %wide.trip.count17 = sext i32 %3 to i64
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc49
  %indvars.iv13 = phi i64 [ %11, %for.cond42.preheader ], [ %indvars.iv.next14, %for.inc49 ]
  %total.2 = phi i32 [ 0, %for.cond42.preheader ], [ %add48, %for.inc49 ]
  %exitcond18.not = icmp eq i64 %indvars.iv13, %wide.trip.count17
  br i1 %exitcond18.not, label %for.inc82.gvnsink.split, label %for.inc49

for.inc49:                                        ; preds = %for.cond42
  %12 = add nsw i64 %indvars.iv13, -1
...
for.inc82.gvnsink.split:                          ; preds = %for.cond62, %for.cond42, %for.cond20, %for.cond9
  ...
  %spec.select10 = select i1 %cmp73, ptr @.str.2, ptr @.str.3
  %call77 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select10)
  br label %for.inc82
