...
entry:
  ...
  %.not.not = icmp slt i32 %0, %i
  call void @llvm.assume(i1 noundef %.not.not) #6
  ret void
}
...
for.cond1:                                        ; preds = %for.cond5, %for.body
  %1 = phi i32 [ %0, %for.body ], [ %2, %for.cond5 ]
  %cmp2 = icmp sgt i32 %1, 0
  br i1 %cmp2, label %for.cond5, label %for.cond.cleanup57

for.cond5:                                        ; preds = %for.cond1, %for.body8
  %2 = phi i32 [ %.pre, %for.body8 ], [ %1, %for.cond1 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body8 ], [ 1, %for.cond1 ]
  %3 = sext i32 %2 to i64
  %cmp6.not = icmp sgt i64 %indvars.iv, %3
  br i1 %cmp6.not, label %for.cond1, label %for.body8

for.body8:                                        ; preds = %for.cond5
  %add.ptr10 = getelementptr inbounds nuw i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 800), i64 %indvars.iv
...
for.cond.cleanup57:                               ; preds = %for.cond1
  %call137 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
