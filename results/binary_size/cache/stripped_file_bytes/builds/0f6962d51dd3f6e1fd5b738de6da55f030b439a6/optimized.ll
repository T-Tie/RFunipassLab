...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv26, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv26, %3
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc71
  %indvars.iv46 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next47, %for.inc71 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count50
  br i1 %exitcond51.not, label %for.cond74, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx47 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv46
  %17 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !13
  %arrayidx49 = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv46
  store i32 %17, ptr %arrayidx49, align 4, !tbaa !5
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc68, %for.body44
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc68 ], [ 1, %for.body44 ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc71, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %18 = mul nuw nsw i64 %indvars.iv39, %3
...
for.cond74:                                       ; preds = %for.cond42, %for.inc100
  %.pre5859 = phi i32 [ %.pre5860, %for.inc100 ], [ %12, %for.cond42 ]
  %20 = phi i32 [ %25, %for.inc100 ], [ %12, %for.cond42 ]
  %21 = phi i32 [ %.pre, %for.inc100 ], [ %6, %for.cond42 ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc100 ], [ 0, %for.cond42 ]
  %s.0 = phi i32 [ %s.1, %for.inc100 ], [ 0, %for.cond42 ]
  %22 = sext i32 %21 to i64
  %cmp75 = icmp slt i64 %indvars.iv55, %22
  br i1 %cmp75, label %for.cond77.preheader, label %for.end102

for.cond77.preheader:                             ; preds = %for.cond74
  %23 = mul nuw nsw i64 %indvars.iv55, %3
  %arrayidx81 = getelementptr inbounds nuw i32, ptr %vla, i64 %23
  %arrayidx85 = getelementptr inbounds nuw i32, ptr %vla10, i64 %indvars.iv55
  %24 = trunc nuw nsw i64 %indvars.iv55 to i32
  br label %for.cond77

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc97
  %.pre5860 = phi i32 [ %.pre5859, %for.cond77.preheader ], [ %.pre58, %for.inc97 ]
  %25 = phi i32 [ %20, %for.cond77.preheader ], [ %.pre58, %for.inc97 ]
  %indvars.iv52 = phi i64 [ 0, %for.cond77.preheader ], [ %indvars.iv.next53, %for.inc97 ]
  %s.1 = phi i32 [ %s.0, %for.cond77.preheader ], [ %s.2, %for.inc97 ]
  %26 = sext i32 %25 to i64
  %cmp78 = icmp slt i64 %indvars.iv52, %26
  br i1 %cmp78, label %for.body79, label %for.inc100

for.body79:                                       ; preds = %for.cond77
  %arrayidx83 = getelementptr inbounds nuw i32, ptr %arrayidx81, i64 %indvars.iv52
...
land.lhs.true:                                    ; preds = %for.body79
  %arrayidx92 = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv52
...
if.then94:                                        ; preds = %land.lhs.true
  %30 = trunc nuw nsw i64 %indvars.iv52 to i32
  %call95 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %24, i32 noundef %30)
  %add = add nsw i32 %s.1, 1
  %.pre58.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc97

for.inc97:                                        ; preds = %for.body79, %land.lhs.true, %if.then94
  %.pre58 = phi i32 [ %.pre58.pre, %if.then94 ], [ %.pre5860, %land.lhs.true ], [ %.pre5860, %for.body79 ]
