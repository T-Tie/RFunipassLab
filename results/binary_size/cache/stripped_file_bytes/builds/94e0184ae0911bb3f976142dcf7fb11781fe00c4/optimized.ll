...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %d) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %e) #6
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 8 %a, ptr noundef nonnull align 8 %b, ptr noundef nonnull align 8 %c, ptr noundef nonnull align 8 %d, ptr noundef nonnull align 8 %e)
  ...
  %call4 = call double @cos(double noundef %div3) #7, !tbaa !9
...
if.else:                                          ; preds = %entry
  %call30 = call double @sqrt(double noundef %6) #7, !tbaa !9
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %e) #7
