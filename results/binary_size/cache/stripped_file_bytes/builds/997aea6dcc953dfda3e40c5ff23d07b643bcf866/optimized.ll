...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %a1) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr %b1) #9
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load double, ptr %b1, align 8, !tbaa !9
  %3 = load double, ptr %a1, align 8, !tbaa !9
  %div = fdiv double %2, %3
  %4 = load double, ptr %b, align 8, !tbaa !9
  %5 = load double, ptr %a, align 8, !tbaa !9
  %div5 = fdiv double %4, %5
  %sub6 = fsub double %div, %div5
  store double %sub6, ptr %y, align 8, !tbaa !9
  %6 = load double, ptr %y, align 8, !tbaa !9
  %cmp7 = fcmp ogt double %6, 5.000000e-02
...
if.else:                                          ; preds = %for.body
  ...
  %cmp10 = fcmp olt double %7, -5.000000e-02
...
if.else14:                                        ; preds = %if.else
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.2)
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 8, ptr %b1) #9
  call void @llvm.lifetime.end.p0(i64 8, ptr %a1) #9
