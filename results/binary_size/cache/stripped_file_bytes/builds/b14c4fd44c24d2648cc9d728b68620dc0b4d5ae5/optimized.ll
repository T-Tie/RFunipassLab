...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %a) #3
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %b) #3
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %c) #3
...
if.end80:                                         ; preds = %for.cond61, %for.cond38
  %puts1.i = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str) #5
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond6

for.end83:                                        ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %a) #5
