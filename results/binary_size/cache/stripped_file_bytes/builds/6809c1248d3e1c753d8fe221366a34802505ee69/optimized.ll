...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef nonnull align 16 %before) #7
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull dereferenceable(1) %c) #7
...
while.body:                                       ; preds = %for.cond, %while.body
  %targetBlock = call fastcc i1 @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly captures(none) dereferenceable(1) %c)
...
while.end:                                        ; preds = %while.body
  ...
  store i8 %2, ptr %add.ptr, align 1, !tbaa !9
  br label %while.body8

while.body8:                                      ; preds = %while.end, %if.end
  %p.0 = phi ptr [ %add.ptr, %while.end ], [ %incdec.ptr, %if.end ]
  %targetBlock1 = call fastcc i1 @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly captures(none) dereferenceable(1) %c)
...
if.end:                                           ; preds = %while.body8
  ...
  store i8 %3, ptr %incdec.ptr, align 1, !tbaa !9
...
for.cond20:                                       ; preds = %for.cond, %for.inc60
  %4 = phi i32 [ %.pre, %for.inc60 ], [ %0, %for.cond ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc60 ], [ 0, %for.cond ]
  %sum.0 = phi i32 [ %inc58, %for.inc60 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp21 = icmp slt i64 %indvars.iv8, %5
  br i1 %cmp21, label %for.body22, label %for.end62

for.body22:                                       ; preds = %for.cond20
  %arrayidx = getelementptr inbounds nuw [500 x [40 x i8]], ptr %before, i64 0, i64 %indvars.iv8
  %call24 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx) #8
  %conv25 = trunc i64 %call24 to i32
  %add = add nsw i32 %sum.0, %conv25
  %add26 = add nsw i32 %add, 1
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x [40 x i8]], ptr %before, i64 0, i64 %indvars.iv.next9
  %call32 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx30) #8
  %6 = trunc i64 %call32 to i32
  %conv34 = add i32 %add26, %6
  %cmp35 = icmp sgt i32 %add, 80
  br i1 %cmp35, label %if.then36, label %if.end47

if.then36:                                        ; preds = %for.body22
  %7 = add i64 %call24, 1
  %add44 = add i64 %7, %call32
...
if.end47:                                         ; preds = %if.then36, %for.body22
  ...
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx)
  %8 = load i32, ptr %n, align 4, !tbaa !5
  %sub = add nsw i32 %8, -1
  %9 = sext i32 %sub to i64
  %cmp52 = icmp slt i64 %indvars.iv8, %9
...
for.inc60:                                        ; preds = %if.then54, %if.end47
  %.pre = phi i32 [ %.pre.pre, %if.then54 ], [ %8, %if.end47 ]
  %inc58 = add nsw i32 %sum.1, 1
  br label %for.cond20, !llvm.loop !14

for.end62:                                        ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull %c) #9
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef nonnull %before) #9
...
define internal fastcc noundef i1 @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly captures(none) dereferenceable(1) initializes((0, 1)) %0) unnamed_addr #6 {
