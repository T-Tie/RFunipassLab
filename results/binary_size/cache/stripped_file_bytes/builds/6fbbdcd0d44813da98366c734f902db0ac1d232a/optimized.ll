...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv73, i64 %indvars.iv
...
while.cond:                                       ; preds = %while.cond.preheader, %while.cond.loopexit
  %indvars.iv134 = phi i64 [ %5, %while.cond.preheader ], [ %indvars.iv.next135, %while.cond.loopexit ]
  %indvars.iv127 = phi i64 [ %4, %while.cond.preheader ], [ %indvars.iv.next128, %while.cond.loopexit ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %while.cond.loopexit ]
  %8 = trunc nuw i64 %indvars.iv134 to i32
  %cmp13 = icmp sgt i32 %8, 1
  br i1 %cmp13, label %for.cond14, label %while.end

for.cond14:                                       ; preds = %while.cond, %for.inc49
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc49 ], [ 0, %while.cond ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %indvars.iv134
  br i1 %exitcond88.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84
  %9 = load i32, ptr %arrayidx18, align 16, !tbaa !5, !invariant.load !14
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.body22 ], [ 0, %for.body16 ]
  %min.0 = phi i32 [ %spec.select, %for.body22 ], [ %9, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv76, %indvars.iv134
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv76
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc46 ], [ 0, %for.cond35.preheader ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %indvars.iv134
  br i1 %exitcond83.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv79
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond103.not = icmp eq i64 %indvars.iv99, %indvars.iv134
  br i1 %exitcond103.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv99
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select71, %for.body60 ], [ %12, %for.body54 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %indvars.iv134
  br i1 %exitcond93.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv89, i64 %indvars.iv99
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !14
  %spec.select71 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  br label %for.cond58, !llvm.loop !18

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc87 ], [ 0, %for.cond75.preheader ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %indvars.iv134
  br i1 %exitcond98.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
...
for.cond95:                                       ; preds = %for.inc106, %for.end92
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.inc106 ], [ 1, %for.end92 ]
  %exitcond111.not = icmp eq i64 %indvars.iv104, %indvars.iv127
  br i1 %exitcond111.not, label %for.cond109, label %for.inc106

for.inc106:                                       ; preds = %for.cond95
  %indvars.iv.next105 = add nuw nsw i64 %indvars.iv104, 1
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next105
  %16 = load i32, ptr %arrayidx101, align 16, !tbaa !5, !invariant.load !14
  %arrayidx104 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv104
  store i32 %16, ptr %arrayidx104, align 16, !tbaa !5
  br label %for.cond95, !llvm.loop !21

for.cond109:                                      ; preds = %for.cond95, %for.inc120
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.inc120 ], [ 1, %for.cond95 ]
  %exitcond116.not = icmp eq i64 %indvars.iv112, %indvars.iv127
  br i1 %exitcond116.not, label %for.cond123, label %for.inc120

for.inc120:                                       ; preds = %for.cond109
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %arrayidx116 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next113
  %17 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !14
  %arrayidx119 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv112
  store i32 %17, ptr %arrayidx119, align 4, !tbaa !5
  br label %for.cond109, !llvm.loop !22

for.cond123:                                      ; preds = %for.cond127, %for.cond109
  %indvars.iv122 = phi i64 [ 1, %for.cond109 ], [ %indvars.iv.next123, %for.cond127 ]
  %exitcond126.not = icmp eq i64 %indvars.iv122, %indvars.iv127
  br i1 %exitcond126.not, label %while.cond.loopexit, label %for.cond127.preheader
...
for.cond127:                                      ; preds = %for.cond127.preheader, %for.inc141
  %indvars.iv117 = phi i64 [ 1, %for.cond127.preheader ], [ %indvars.iv.next118, %for.inc141 ]
  %exitcond121.not = icmp eq i64 %indvars.iv117, %indvars.iv127
  br i1 %exitcond121.not, label %for.cond123, label %for.inc141, !llvm.loop !23

for.inc141:                                       ; preds = %for.cond127
  %indvars.iv.next118 = add nuw nsw i64 %indvars.iv117, 1
  %arrayidx136 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next123, i64 %indvars.iv.next118
  %18 = load i32, ptr %arrayidx136, align 4, !tbaa !5, !invariant.load !14
  %arrayidx140 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv122, i64 %indvars.iv117
