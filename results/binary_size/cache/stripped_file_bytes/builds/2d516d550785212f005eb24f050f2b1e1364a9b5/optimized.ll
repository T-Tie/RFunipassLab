...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %c) #8
...
while.body:                                       ; preds = %for.cond, %while.body
  %targetBlock = call i1 @outlined_ir_func_1(ptr noalias nofree noundef nonnull captures(none) dereferenceable(1) %c)
...
while.body8:                                      ; preds = %while.end, %if.end
  ...
  %targetBlock1 = call i1 @outlined_ir_func_1(ptr noalias nofree noundef nonnull captures(none) dereferenceable(1) %c)
...
for.end62:                                        ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %c) #10
...
define internal noundef i1 @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly captures(none) dereferenceable(1) initializes((0, 1)) %0) #6 {
