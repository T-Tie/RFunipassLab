...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv7 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next8, %if.end ]
  %z.0 = phi i32 [ 0, %for.cond2.preheader ], [ %z.1, %if.end ]
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.end45
  %indvars.iv14 = phi i64 [ 1, %for.cond16.preheader ], [ %indvars.iv.next15, %for.end45 ]
...
for.cond19:                                       ; preds = %for.cond19.preheader, %if.end42
  %indvars.iv11 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next12, %if.end42 ]
  %m.0 = phi i32 [ 0, %for.cond19.preheader ], [ %spec.select, %if.end42 ]
  %cmp20.not = icmp sgt i64 %indvars.iv11, %6
  br i1 %cmp20.not, label %for.end45, label %for.body21
...
if.end42:                                         ; preds = %if.then31, %for.body21
...
for.cond55:                                       ; preds = %for.body57, %if.else
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body57 ], [ 1, %if.else ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %if.end64, label %for.body57
