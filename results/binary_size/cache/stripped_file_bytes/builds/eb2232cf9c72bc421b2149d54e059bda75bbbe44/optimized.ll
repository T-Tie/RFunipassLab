...
land.lhs.true:                                    ; preds = %do.body
  ...
  br i1 %cmp2, label %if.then, label %do.cond
...
for.inc:                                          ; preds = %for.cond17
  ...
  %4 = load i8, ptr %arrayidx25, align 1, !tbaa !5, !invariant.load !10
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %4)
