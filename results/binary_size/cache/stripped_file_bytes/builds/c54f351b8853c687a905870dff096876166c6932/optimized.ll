...
for.cond:                                         ; preds = %if.end17, %entry
  %s.0 = phi i64 [ 0, %entry ], [ %s.1, %if.end17 ]
  %cmp14.not = phi i1 [ true, %entry ], [ false, %if.end17 ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %if.end17 ]
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call.i14 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i13, i8 noundef signext 10)
