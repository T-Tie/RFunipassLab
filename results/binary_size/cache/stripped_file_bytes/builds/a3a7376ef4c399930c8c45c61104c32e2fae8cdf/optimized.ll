...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1002, ptr noundef nonnull align 16 %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %n) #6
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv20 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next21, %for.end ]
...
for.cond13:                                       ; preds = %for.cond, %if.else43
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.else43 ], [ 0, %for.cond ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %0 = load i8, ptr %arrayidx18, align 1, !tbaa !5, !invariant.load !8
  switch i8 %0, label %cleanup [
    i8 65, label %if.else43
    i8 84, label %if.else43
    i8 71, label %if.else43
    i8 67, label %if.else43
  ]

if.else43:                                        ; preds = %for.body15, %for.body15, %for.body15, %for.body15
...
for.body49:                                       ; preds = %for.cond47
  ...
  %1 = load i8, ptr %arrayidx52, align 1, !tbaa !5, !invariant.load !8
  %arrayidx56 = getelementptr inbounds nuw [501 x i8], ptr %arrayidx1, i64 0, i64 %indvars.iv24
  %2 = load i8, ptr %arrayidx56, align 1, !tbaa !5, !invariant.load !8
...
for.end63:                                        ; preds = %for.cond47
  ...
  %3 = load double, ptr %n, align 8, !tbaa !14
  %cmp65 = fcmp ult double %div, %3
  %.str.4..str.3 = select i1 %cmp65, ptr @.str.4, ptr @.str.3
  br label %cleanup

cleanup:                                          ; preds = %for.end63, %for.body15, %entry
  %.str.3.sink = phi ptr [ @.str.2, %entry ], [ @.str.2, %for.body15 ], [ %.str.4..str.3, %for.end63 ]
  %call67 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink) #8
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %n) #8
  call void @llvm.lifetime.end.p0(i64 noundef 1002, ptr noundef nonnull %s) #8
  ret i32 0
}
