...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(40804) %c, i8 noundef 0, i64 noundef 40804, i1 noundef false) #7
  ...
  %arrayidx = getelementptr inbounds nuw i8, ptr %a, i64 404
  br label %for.cond
...
for.cond2:                                        ; preds = %for.cond, %for.body4
  ...
  br i1 %cmp3.not, label %for.cond, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x i32], ptr %arrayidx, i64 0, i64 %indvars.iv
...
for.end10:                                        ; preds = %for.cond
  ...
  %arrayidx20 = getelementptr inbounds nuw i8, ptr %b, i64 404
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond16, %for.end10
...
for.cond30.preheader:                             ; preds = %for.cond13
  %4 = getelementptr inbounds nuw i8, ptr %c, i64 404
  br label %for.cond30

for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body18 ], [ 1, %for.cond13 ]
  %5 = load i32, ptr %y2, align 4, !tbaa !5
  %6 = sext i32 %5 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv10, %6
  br i1 %cmp17.not, label %for.cond13, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x i32], ptr %arrayidx20, i64 0, i64 %indvars.iv10
...
for.cond30:                                       ; preds = %for.cond33, %for.cond30.preheader
  %7 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp31 = icmp sgt i32 %7, 0
  br i1 %cmp31, label %for.cond33, label %for.end76

for.cond33:                                       ; preds = %for.cond30, %if.end
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %if.end ], [ 1, %for.cond30 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp34.not = icmp sgt i64 %indvars.iv13, %9
  br i1 %cmp34.not, label %for.cond30, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %10 = getelementptr inbounds nuw [101 x i32], ptr %4, i64 0, i64 %indvars.iv13
  %.promoted = load i32, ptr %10, align 4, !tbaa !5
  %11 = zext i32 %8 to i64
  %cmp58 = icmp eq i64 %indvars.iv13, %11
  %call63 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %.promoted)
  br i1 %cmp58, label %if.then, label %if.else

if.then:                                          ; preds = %for.cond36.preheader
  %call64 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call63, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %if.end

if.else:                                          ; preds = %for.cond36.preheader
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call63, ptr noundef nonnull @.str)
  br label %if.end
