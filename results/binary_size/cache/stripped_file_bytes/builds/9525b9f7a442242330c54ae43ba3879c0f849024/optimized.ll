...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2400, ptr nonnull %shuzu) #4
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %arrayidx96.sink42 = phi ptr [ %arrayidx96, %while.body ], [ %shuzu, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.body ], [ 0, %entry ]
  %arrayidx100 = getelementptr inbounds nuw i8, ptr %arrayidx96.sink42, i64 4
  %arrayidx103 = getelementptr inbounds nuw i8, ptr %arrayidx96.sink42, i64 8
  %arrayidx106 = getelementptr inbounds nuw i8, ptr %arrayidx96.sink42, i64 12
  %arrayidx109 = getelementptr inbounds nuw i8, ptr %arrayidx96.sink42, i64 16
  %arrayidx112 = getelementptr inbounds nuw i8, ptr %arrayidx96.sink42, i64 20
  %call113 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx96.sink42, ptr noundef nonnull %arrayidx100, ptr noundef nonnull %arrayidx103, ptr noundef nonnull %arrayidx106, ptr noundef nonnull %arrayidx109, ptr noundef nonnull %arrayidx112)
...
land.lhs.true24:                                  ; preds = %while.cond
  ...
  %2 = load i32, ptr %arrayidx27, align 8, !tbaa !5
...
land.lhs.true34:                                  ; preds = %land.lhs.true29
  ...
  %4 = load i32, ptr %arrayidx37, align 8, !tbaa !5
  %cmp38 = icmp eq i32 %4, 0
  br i1 %cmp38, label %land.rhs, label %while.body
...
while.body:                                       ; preds = %while.cond, %land.lhs.true34, %land.lhs.true29, %land.lhs.true24, %land.rhs
  %6 = phi i32 [ 0, %land.lhs.true34 ], [ 0, %land.lhs.true29 ], [ 0, %land.lhs.true24 ], [ 0, %land.rhs ], [ %1, %while.cond ]
  ...
  %8 = load i32, ptr %arrayidx48, align 8, !tbaa !5
  ...
  %10 = load i32, ptr %arrayidx66, align 8, !tbaa !5
  %reass.sub35 = sub i32 %10, %6
  %11 = mul i32 %reass.sub35, 60
  ...
  %reass.sub36 = sub i32 %9, %8
  %add72 = add i32 %reass.sub36, 3600
