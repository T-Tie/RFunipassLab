...
for.cond2:                                        ; preds = %for.inc7, %for.end
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc7 ], [ 1, %for.end ]
...
for.inc7:                                         ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv23
  store i32 1, ptr %arrayidx6, align 4, !tbaa !5
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond2, !llvm.loop !12

for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc36
  %indvars.iv34 = phi i64 [ %1, %for.cond10.preheader ], [ %indvars.iv.next35, %for.inc36 ]
  %indvars.iv28 = phi i64 [ %3, %for.cond10.preheader ], [ %indvars.iv.next29, %for.inc36 ]
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, -1
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, -1
  %cmp11 = icmp sgt i64 %indvars.iv34, 1
  br i1 %cmp11, label %for.cond13.preheader, label %for.cond38

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx19 = getelementptr inbounds [26 x i32], ptr %h, i64 0, i64 %indvars.iv.next35
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc28
  %indvars.iv30 = phi i64 [ %indvars.iv28, %for.cond13.preheader ], [ %indvars.iv.next31, %for.inc28 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [26 x i32], ptr %h, i64 0, i64 %indvars.iv30
...
if.then:                                          ; preds = %for.body15
  %arrayidx22 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv30
...
for.inc36:                                        ; preds = %for.cond13
  %arrayidx32 = getelementptr inbounds [26 x i32], ptr %q, i64 0, i64 %indvars.iv.next35
...
for.cond38:                                       ; preds = %for.cond10, %for.body40
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body40 ], [ 1, %for.cond10 ]
  %m.3 = phi i32 [ %spec.select21, %for.body40 ], [ 0, %for.cond10 ]
  %exitcond41 = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41, label %for.end50, label %for.body40

for.body40:                                       ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv37
  %9 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !13
  %spec.select21 = call i32 @llvm.smax.i32(i32 %m.3, i32 %9)
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  br label %for.cond38, !llvm.loop !16

for.end50:                                        ; preds = %for.cond38
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %m.3) #6
