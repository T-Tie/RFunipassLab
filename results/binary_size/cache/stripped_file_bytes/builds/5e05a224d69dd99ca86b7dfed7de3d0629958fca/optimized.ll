...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80004, ptr nonnull %b) #6
  call void @llvm.lifetime.start.p0(i64 80004, ptr nonnull %c) #6
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %n)
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp.not15 = icmp slt i32 %0, 1
  br i1 %cmp.not15, label %for.end34, label %for.body

for.cond2.preheader:                              ; preds = %for.body
  %cmp3.not17 = icmp slt i32 %2, 1
  br i1 %cmp3.not17, label %for.end34, label %for.body4.preheader
...
for.cond22.preheader:                             ; preds = %for.inc19
  %cmp23.not21 = icmp slt i32 %j.1, 1
  br i1 %cmp23.not21, label %for.end34, label %for.body24.preheader

for.body24.preheader:                             ; preds = %for.cond22.preheader
  %4 = zext nneg i32 %j.1 to i64
  %5 = add nuw i32 %j.1, 1
  %wide.trip.count31 = zext i32 %5 to i64
  br label %for.body24

for.body4:                                        ; preds = %for.body4.preheader, %for.inc19
  %indvars.iv25 = phi i64 [ 1, %for.body4.preheader ], [ %indvars.iv.next26, %for.inc19 ]
  %j.019 = phi i32 [ 0, %for.body4.preheader ], [ %j.1, %for.inc19 ]
  %arrayidx6 = getelementptr inbounds nuw [20001 x i32], ptr %b, i64 0, i64 %indvars.iv25
...
for.inc19:                                        ; preds = %for.body4, %if.then
  %j.1 = phi i32 [ %inc10, %if.then ], [ %j.019, %for.body4 ]
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next26, %wide.trip.count
  br i1 %exitcond.not, label %for.cond22.preheader, label %for.body4, !llvm.loop !12

for.body24:                                       ; preds = %for.body24.preheader, %for.inc32
  %indvars.iv28 = phi i64 [ 1, %for.body24.preheader ], [ %indvars.iv.next29, %for.inc32 ]
  %arrayidx26 = getelementptr inbounds nuw [20001 x i32], ptr %c, i64 0, i64 %indvars.iv28
  %8 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %call27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8)
  %cmp28.not = icmp eq i64 %indvars.iv28, %4
...
for.inc32:                                        ; preds = %for.body24, %if.then29
  ...
  br i1 %exitcond32.not, label %for.end34, label %for.body24, !llvm.loop !13

for.end34:                                        ; preds = %for.inc32, %entry, %for.cond2.preheader, %for.cond22.preheader
  call void @llvm.lifetime.end.p0(i64 80004, ptr nonnull %c) #6
  call void @llvm.lifetime.end.p0(i64 80004, ptr nonnull %b) #6
