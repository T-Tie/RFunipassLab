...
entry:
  ...
  call void @llvm.assume(i1 noundef %tobool.not)
  %puts = call i32 @puts(ptr noundef nonnull dereferenceable(1) %s) #6
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %t) #6
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %s1) #6
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %s) #6
  ret i32 0
}
