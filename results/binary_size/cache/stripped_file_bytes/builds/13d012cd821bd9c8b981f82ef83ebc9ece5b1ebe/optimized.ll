...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 200, ptr %a) #7
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 200, i1 false)
  ...
  store i32 48, ptr %p, align 4, !tbaa !5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %arrayidx = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 49
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom
  ...
  %arrayidx6 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom5
  store i32 %add, ptr %arrayidx6, align 4, !tbaa !5
  %8 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom7 = sext i32 %8 to i64
  %arrayidx8 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom7
...
if.then:                                          ; preds = %for.body3
  ...
  %arrayidx11 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom10
  %11 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %sub = sub nsw i32 %11, 10
  %12 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom12 = sext i32 %12 to i64
  %arrayidx13 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom12
...
for.end:                                          ; preds = %for.cond1
  ...
  %arrayidx15 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom14
...
if.then17:                                        ; preds = %for.end
  ...
  store i32 %dec18, ptr %p, align 4, !tbaa !5
  br label %if.end19
...
while.cond:                                       ; preds = %while.body, %for.end21
  ...
  %arrayidx23 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom22
...
while.body:                                       ; preds = %while.cond
  ...
  store i32 %inc25, ptr %p, align 4, !tbaa !5
  br label %while.cond, !llvm.loop !13

while.end:                                        ; preds = %while.cond
  %21 = load i32, ptr %p, align 4, !tbaa !5
  store i32 %21, ptr %i, align 4, !tbaa !5
  br label %for.cond26

for.cond26:                                       ; preds = %for.inc32, %while.end
  %22 = load i32, ptr %i, align 4, !tbaa !5
  %cmp27 = icmp sle i32 %22, 49
  br i1 %cmp27, label %for.body28, label %for.end34

for.body28:                                       ; preds = %for.cond26
  %23 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom29 = sext i32 %23 to i64
  %arrayidx30 = getelementptr inbounds [50 x i32], ptr %a, i64 0, i64 %idxprom29
  %24 = load i32, ptr %arrayidx30, align 4, !tbaa !5
  %call31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %24)
  br label %for.inc32
...
for.end34:                                        ; preds = %for.cond26
  ...
  call void @llvm.lifetime.end.p0(i64 200, ptr %a) #7
  ret i32 0
}
