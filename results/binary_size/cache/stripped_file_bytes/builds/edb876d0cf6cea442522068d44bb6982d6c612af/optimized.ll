...
for.cond:                                         ; preds = %for.inc9, %entry
  ...
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc9 ], [ 0, %entry ]
  %12 = sext i32 %11 to i64
  %cmp = icmp slt i64 %indvars.iv12, %12
  br i1 %cmp, label %for.cond3.preheader, label %for.cond12.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %13 = mul nuw nsw i64 %indvars.iv12, %3
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %14 = phi i32 [ %10, %for.cond3.preheader ], [ %.pre56, %for.inc ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.inc20
  %indvars.iv15 = phi i64 [ 0, %for.cond12.preheader ], [ %indvars.iv.next16, %for.inc20 ]
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv19 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next20, %for.inc31 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.cond34, label %for.inc31

for.inc31:                                        ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv19
  %18 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv19
  store i32 %18, ptr %arrayidx30, align 4, !tbaa !5
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond23, !llvm.loop !15

for.cond34:                                       ; preds = %for.cond23, %for.inc56
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc56 ], [ 0, %for.cond23 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.cond59, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond34
  %19 = mul nuw nsw i64 %indvars.iv30, %3
  %arrayidx41 = getelementptr inbounds nuw i32, ptr %vla, i64 %19
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv30
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv25 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next26, %for.body39 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count23
  br i1 %exitcond29.not, label %for.inc56, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw i32, ptr %arrayidx41, i64 %indvars.iv25
...
for.cond59:                                       ; preds = %for.cond34, %for.inc83
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc83 ], [ 0, %for.cond34 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count23
  br i1 %exitcond44.not, label %for.cond86, label %for.cond62.preheader

for.cond62.preheader:                             ; preds = %for.cond59
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv40
  %arrayidx70 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv40
  br label %for.cond62

for.cond62:                                       ; preds = %for.cond62.preheader, %for.body64
  %indvars.iv35 = phi i64 [ 0, %for.cond62.preheader ], [ %indvars.iv.next36, %for.body64 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond39.not, label %for.inc83, label %for.body64

for.body64:                                       ; preds = %for.cond62
  %22 = mul nuw nsw i64 %indvars.iv35, %3
  ...
  %spec.store.select9 = call i32 @llvm.smin.i32(i32 %23, i32 %24)
  store i32 %spec.store.select9, ptr %arrayidx70, align 4
...
for.cond86:                                       ; preds = %for.cond59, %for.inc103
  %.pre5253 = phi i32 [ %.pre5254, %for.inc103 ], [ %10, %for.cond59 ]
  %25 = phi i32 [ %29, %for.inc103 ], [ %10, %for.cond59 ]
  %26 = phi i32 [ %.pre51, %for.inc103 ], [ %11, %for.cond59 ]
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc103 ], [ 0, %for.cond59 ]
  %k.0 = phi i32 [ %k.1, %for.inc103 ], [ 0, %for.cond59 ]
  %27 = sext i32 %26 to i64
  %cmp87 = icmp slt i64 %indvars.iv48, %27
  br i1 %cmp87, label %for.cond89.preheader, label %for.end105

for.cond89.preheader:                             ; preds = %for.cond86
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv48
  %28 = trunc nuw nsw i64 %indvars.iv48 to i32
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc100
  %.pre5254 = phi i32 [ %.pre5253, %for.cond89.preheader ], [ %.pre52, %for.inc100 ]
  %29 = phi i32 [ %25, %for.cond89.preheader ], [ %.pre52, %for.inc100 ]
  %indvars.iv45 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next46, %for.inc100 ]
  %k.1 = phi i32 [ %k.0, %for.cond89.preheader ], [ %k.2, %for.inc100 ]
  %30 = sext i32 %29 to i64
  %cmp90 = icmp slt i64 %indvars.iv45, %30
...
for.body91:                                       ; preds = %for.cond89
  ...
  %arrayidx95 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv45
...
if.then97:                                        ; preds = %for.body91
  %33 = trunc nuw nsw i64 %indvars.iv45 to i32
...
for.inc100:                                       ; preds = %for.body91, %if.then97
  %.pre52 = phi i32 [ %.pre52.pre, %if.then97 ], [ %.pre5254, %for.body91 ]
...
for.inc103:                                       ; preds = %for.cond89
  ...
  %.pre51 = load i32, ptr %m, align 4, !tbaa !5
