...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %word) #5
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp36 = icmp sgt i32 %0, 0
  br i1 %cmp36, label %if.then6.i, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.inc, %entry
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %word) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #5
  ret i32 0

if.then6.i:                                       ; preds = %entry, %for.inc
  %i.038 = phi i32 [ %inc, %for.inc ], [ 0, %entry ]
  %len.037 = phi i64 [ %len.1, %for.inc ], [ 0, %entry ]
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %word, i64 noundef 100)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %if.then19.i, %_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv.exit.i, %if.then28.i
  ...
  %add = add i64 %call3, %len.037
  %add4 = add i64 %add, 1
  %conv6 = and i64 %add4, 4294967295
  %add9 = add i64 %call3, 1
  %cmp10 = icmp eq i64 %conv6, %add9
  br i1 %cmp10, label %if.then, label %if.else

if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %word, i64 noundef %call3)
  %dec = add i64 %add, 4294967296
  br label %for.inc

if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %conv5 = trunc i64 %add4 to i32
  %cmp13 = icmp ult i32 %conv5, 81
  br i1 %cmp13, label %if.then14, label %if.else18

if.then14:                                        ; preds = %if.else
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %word, i64 noundef %call.i.i13)
  br label %for.inc

if.else18:                                        ; preds = %if.else
  %vtable.i29 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i30 = getelementptr i8, ptr %vtable.i29, i64 -24
  %vbase.offset.i31 = load i64, ptr %vbase.offset.ptr.i30, align 8
  %gep35 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 240), i64 %vbase.offset.i31
  %9 = load ptr, ptr %gep35, align 8, !tbaa !37
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %if.else18
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %retval.0.i.i.i)
  ...
  %call.i.i21 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i34, ptr noundef nonnull %word, i64 noundef %call.i.i21)
  %call23 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
  br label %for.inc

for.inc:                                          ; preds = %if.then, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit, %if.then14
  %len.1 = phi i64 [ %dec, %if.then ], [ %add4, %if.then14 ], [ %call23, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
