...
entry:
  ...
  store i32 0, ptr %num1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %n1) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %num2) #6
  store i32 0, ptr %num2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %n2) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %num3) #6
  store i32 0, ptr %num3, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %n3) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %num4) #6
  store i32 0, ptr %num4, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %n4) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %num5) #6
  store i32 0, ptr %num5, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %n5) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %num6) #6
  store i32 0, ptr %num6, align 4, !tbaa !5
  ...
  store i32 %div, ptr %num1, align 4, !tbaa !5
  %2 = load i32, ptr %n, align 4, !tbaa !5
  %rem1 = srem i32 %2, 100
  store i32 %rem1, ptr %n1, align 4, !tbaa !5
  %3 = load i32, ptr %num1, align 4, !tbaa !5
  ...
  %rem4 = srem i32 %5, 50
  %sub5 = sub nsw i32 %4, %rem4
  %div6 = sdiv i32 %sub5, 50
  store i32 %div6, ptr %num2, align 4, !tbaa !5
  %6 = load i32, ptr %n1, align 4, !tbaa !5
  %rem7 = srem i32 %6, 50
  store i32 %rem7, ptr %n2, align 4, !tbaa !5
  %7 = load i32, ptr %num2, align 4, !tbaa !5
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %7)
  ...
  %8 = load i32, ptr %n2, align 4, !tbaa !5
  %9 = load i32, ptr %n2, align 4, !tbaa !5
  %rem10 = srem i32 %9, 20
  %sub11 = sub nsw i32 %8, %rem10
  %div12 = sdiv i32 %sub11, 20
  store i32 %div12, ptr %num3, align 4, !tbaa !5
  %10 = load i32, ptr %n2, align 4, !tbaa !5
  %rem13 = srem i32 %10, 20
  store i32 %rem13, ptr %n3, align 4, !tbaa !5
  %11 = load i32, ptr %num3, align 4, !tbaa !5
  ...
  %12 = load i32, ptr %n3, align 4, !tbaa !5
  %13 = load i32, ptr %n3, align 4, !tbaa !5
  %rem16 = srem i32 %13, 10
  %sub17 = sub nsw i32 %12, %rem16
  %div18 = sdiv i32 %sub17, 10
  store i32 %div18, ptr %num4, align 4, !tbaa !5
  %14 = load i32, ptr %n3, align 4, !tbaa !5
  %rem19 = srem i32 %14, 10
  store i32 %rem19, ptr %n4, align 4, !tbaa !5
  %15 = load i32, ptr %num4, align 4, !tbaa !5
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %15)
  ...
  %16 = load i32, ptr %n4, align 4, !tbaa !5
  %17 = load i32, ptr %n4, align 4, !tbaa !5
  %rem22 = srem i32 %17, 5
  %sub23 = sub nsw i32 %16, %rem22
  %div24 = sdiv i32 %sub23, 5
  store i32 %div24, ptr %num5, align 4, !tbaa !5
  %18 = load i32, ptr %n4, align 4, !tbaa !5
  %rem25 = srem i32 %18, 5
  store i32 %rem25, ptr %n5, align 4, !tbaa !5
  %19 = load i32, ptr %num5, align 4, !tbaa !5
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %19)
  ...
  %20 = load i32, ptr %n5, align 4, !tbaa !5
  store i32 %20, ptr %num6, align 4, !tbaa !5
  %21 = load i32, ptr %num6, align 4, !tbaa !5
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %21)
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %num6) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n5) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %num5) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n4) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %num4) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n3) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %num3) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n2) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %num2) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n1) #6
...
entry:
  ...
  store ptr %__pf, ptr %__pf.addr, align 8, !tbaa !12
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = load ptr, ptr %__pf.addr, align 8, !tbaa !12
...
entry:
  ...
  store ptr %__os, ptr %__os.addr, align 8, !tbaa !9
  %0 = load ptr, ptr %__os.addr, align 8, !tbaa !9, !nonnull !13, !align !14
  %1 = load ptr, ptr %__os.addr, align 8, !tbaa !9, !nonnull !13, !align !14
...
entry:
  ...
  store ptr %__f, ptr %__f.addr, align 8, !tbaa !36
  %0 = load ptr, ptr %__f.addr, align 8, !tbaa !36
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %__f.addr, align 8, !tbaa !36
  ret ptr %1
}
...
!17 = !{!18, !18, i64 0}
!18 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !11, i64 0}
!19 = !{!7, !7, i64 0}
!20 = !{!21, !33, i64 240}
!21 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !22, i64 0, !10, i64 216, !7, i64 224, !31, i64 225, !32, i64 232, !33, i64 240, !34, i64 248, !35, i64 256}
!22 = !{!"_ZTSSt8ios_base", !23, i64 8, !23, i64 16, !24, i64 24, !25, i64 28, !25, i64 32, !26, i64 40, !27, i64 48, !7, i64 64, !6, i64 192, !28, i64 200, !29, i64 208}
!23 = !{!"long", !7, i64 0}
!24 = !{!"_ZTSSt13_Ios_Fmtflags", !7, i64 0}
!25 = !{!"_ZTSSt12_Ios_Iostate", !7, i64 0}
!26 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !11, i64 0}
!27 = !{!"_ZTSNSt8ios_base6_WordsE", !11, i64 0, !23, i64 8}
