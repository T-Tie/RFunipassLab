...
for.cond:                                         ; preds = %for.inc28, %entry
  ...
  %flag.0 = phi i32 [ 0, %entry ], [ %flag.17, %for.inc28 ]
...
if.then16:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call19 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
  %add20 = add i64 %call19, 1
  br label %if.end24

if.end24:                                         ; preds = %if.then9, %if.then, %if.then16
  %flag.17 = phi i32 [ %flag.0, %if.then16 ], [ 1, %if.then ], [ 1, %if.then9 ]
