...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  %indvars.iv13 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next14, %for.body8 ]
  %arrayidx10 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv13
  ...
  %exitcond16.not = icmp eq i64 %indvars.iv.next14, 6
  br i1 %exitcond16.not, label %for.cond.cleanup7, label %for.body8, !llvm.loop !12
}
