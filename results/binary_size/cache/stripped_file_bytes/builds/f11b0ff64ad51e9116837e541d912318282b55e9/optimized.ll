...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc46
  %indvars.iv8 = phi i32 [ %7, %for.cond18.preheader ], [ %indvars.iv.next9, %for.inc46 ]
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc43
  %indvars.iv4 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next5, %for.inc43 ]
  %exitcond12.not = icmp eq i64 %indvars.iv4, %wide.trip.count11
  br i1 %exitcond12.not, label %for.inc46, label %for.body25
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc65
  %indvars.iv13 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next14, %for.inc65 ]
...
if.else:                                          ; preds = %for.body52
  %arrayidx61 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv13
  %12 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !12
  %call62 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %12)
