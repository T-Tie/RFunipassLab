...
for.cond8:                                        ; preds = %for.inc24, %for.end
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc24 ], [ 1, %for.end ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %2 = sext i32 %1 to i64
  %cmp9 = icmp slt i64 %indvars.iv3, %2
  br i1 %cmp9, label %for.body10, label %for.end26

for.body10:                                       ; preds = %for.cond8
  %arrayidx12 = getelementptr inbounds nuw [100000 x i32], ptr %sz, i64 0, i64 %indvars.iv3
