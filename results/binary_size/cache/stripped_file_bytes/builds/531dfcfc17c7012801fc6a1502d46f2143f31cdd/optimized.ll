...
entry:
  %cmp = icmp eq i32 %n, 1
  br i1 %cmp, label %common.ret, label %for.cond.preheader
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv57 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next58, %for.inc27 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond30, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv57
...
for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv57, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc24
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc24 ], [ 0, %for.cond17.preheader ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv57, i64 %indvars.iv52
...
for.cond30:                                       ; preds = %for.cond, %for.end63
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.end63 ], [ 0, %for.cond ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count60
  br i1 %exitcond76.not, label %for.end66, label %for.body32

for.body32:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv72
  %3 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond36

for.cond36:                                       ; preds = %for.body38, %for.body32
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body38 ], [ 1, %for.body32 ]
  %min.2 = phi i32 [ %spec.select49, %for.body38 ], [ %3, %for.body32 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66.not, label %for.cond53.preheader, label %for.body38

for.cond53.preheader:                             ; preds = %for.cond36
  br label %for.cond53

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv62, i64 %indvars.iv72
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc61
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc61 ], [ 0, %for.cond53.preheader ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count
  br i1 %exitcond71.not, label %for.end63, label %for.inc61

for.inc61:                                        ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv67, i64 %indvars.iv72
...
for.end66:                                        ; preds = %for.cond30
  ...
  %sub73 = add i32 %n, -1
  %smax80 = tail call i32 @llvm.smax.i32(i32 noundef %sub73, i32 noundef 1)
  %wide.trip.count81 = zext nneg i32 %smax80 to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc88, %for.end66
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc88 ], [ 0, %for.end66 ]
  %exitcond87.not = icmp eq i64 %indvars.iv83, %wide.trip.count60
  br i1 %exitcond87.not, label %for.cond91.preheader, label %for.cond72

for.cond91.preheader:                             ; preds = %for.cond69
  %cmp93 = icmp sgt i32 %n, 2
  %invariant.gep = getelementptr inbounds nuw i8, ptr %a, i64 400
  br i1 %cmp93, label %for.cond91.preheader50, label %for.end113

for.cond91.preheader50:                           ; preds = %for.cond91.preheader
  %wide.trip.count91 = zext nneg i32 %sub73 to i64
  br label %for.cond91

for.cond72:                                       ; preds = %for.cond69, %for.inc85
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc85 ], [ 1, %for.cond69 ]
  %exitcond82.not = icmp eq i64 %indvars.iv77, %wide.trip.count81
  br i1 %exitcond82.not, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond72
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %arrayidx80 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv83, i64 %indvars.iv.next78
  %8 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !9
  %arrayidx84 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv83, i64 %indvars.iv77
...
for.cond91:                                       ; preds = %for.cond91.preheader50, %for.end110
  %indvars.iv93 = phi i64 [ 1, %for.cond91.preheader50 ], [ %indvars.iv.next94, %for.end110 ]
  br label %for.cond95

for.cond95:                                       ; preds = %for.cond91, %for.inc108
  %indvars.iv88 = phi i64 [ 0, %for.cond91 ], [ %indvars.iv.next89, %for.inc108 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %wide.trip.count91
  br i1 %exitcond92.not, label %for.end110, label %for.inc108

for.inc108:                                       ; preds = %for.cond95
  %arrayidx103 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv93, i64 %indvars.iv88
  %9 = load i32, ptr %arrayidx103, align 4, !tbaa !5, !invariant.load !9
  %arrayidx107 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv93, i64 %indvars.iv88
...
common.ret:                                       ; preds = %entry, %for.end113
  %common.ret.op = phi i32 [ %10, %for.end113 ], [ 1, %entry ]
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.end ], [ 0, %for.cond ]
