...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 404, ptr nonnull %mark) #4
  br label %for.cond
...
for.cond.cleanup:                                 ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 80020, ptr nonnull %num) #4
  br label %for.cond2
...
for.cond2:                                        ; preds = %for.body5, %for.cond.cleanup
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body5 ], [ 0, %for.cond.cleanup ]
...
for.cond.cleanup4:                                ; preds = %for.cond2
  ...
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %2)
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [20005 x i32], ptr %num, i64 0, i64 %indvars.iv13
...
for.cond18:                                       ; preds = %for.inc35, %for.cond.cleanup4
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc35 ], [ 0, %for.cond.cleanup4 ]
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp19 = icmp slt i64 %indvars.iv16, %5
...
for.cond.cleanup20:                               ; preds = %for.cond18
  ...
  call void @llvm.lifetime.end.p0(i64 80020, ptr nonnull %num) #4
  call void @llvm.lifetime.end.p0(i64 404, ptr nonnull %mark) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #4
  ret i32 0

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [20005 x i32], ptr %num, i64 0, i64 %indvars.iv16
