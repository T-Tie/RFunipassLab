...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr %res) #4
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %res, ptr align 16 @__const.main.res, i64 32, i1 false)
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx7 = getelementptr inbounds [32 x i8], ptr %res, i64 0, i64 %idxprom6
  store i8 %conv5, ptr %arrayidx7, align 1, !tbaa !9
...
land.rhs:                                         ; preds = %for.cond10
  ...
  %13 = load i8, ptr %arrayidx13, align 1, !tbaa !9
...
land.end:                                         ; preds = %land.rhs, %for.cond10
  ...
  br i1 %14, label %for.body16, label %for.end19
...
for.body22:                                       ; preds = %for.cond20
  ...
  %19 = load i8, ptr %arrayidx24, align 1, !tbaa !9
  ...
  store i8 %19, ptr %arrayidx27, align 1, !tbaa !9
  br label %for.inc28
...
for.end30:                                        ; preds = %for.cond20
  ...
  %arraydecay = getelementptr inbounds [32 x i8], ptr %res, i64 0, i64 0
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %arraydecay)
  call void @llvm.lifetime.end.p0(i64 4, ptr %t) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %c) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %j) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #4
  call void @llvm.lifetime.end.p0(i64 32, ptr %res) #4
  ret i32 0
}
