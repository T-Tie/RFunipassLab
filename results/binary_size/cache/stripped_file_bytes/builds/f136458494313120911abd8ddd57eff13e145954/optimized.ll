...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.end22
  %indvars.iv44 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next45, %for.end22 ]
  %exitcond53.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond53.not, label %for.cond30, label %for.cond8.preheader
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.body12
  %indvars.iv46 = phi i64 [ %indvars.iv44, %for.cond8.preheader ], [ %indvars.iv.next47, %for.body12 ]
  %indvars.iv42 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next43, %for.body12 ]
  %cmp11.not = icmp sgt i64 %indvars.iv46, %2
  br i1 %cmp11.not, label %for.end22, label %for.body12

for.body12:                                       ; preds = %for.cond8
  %arrayidx14 = getelementptr inbounds nuw [600 x i8], ptr %word, i64 0, i64 %indvars.iv46
  %3 = load i8, ptr %arrayidx14, align 1, !tbaa !12, !invariant.load !13
  %arrayidx18 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv44, i64 %indvars.iv42
...
for.end22:                                        ; preds = %for.cond8
  %arrayidx26 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv44, i64 %indvars.iv42
...
for.cond30:                                       ; preds = %for.cond5, %for.body34
  ...
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.body34 ], [ 0, %for.cond5 ]
  %sub31 = sub nsw i32 %conv, %4
  %5 = sext i32 %sub31 to i64
  %cmp33.not = icmp sgt i64 %indvars.iv54, %5
  br i1 %cmp33.not, label %for.cond45.preheader, label %for.body34

for.cond45.preheader:                             ; preds = %for.cond30
  %6 = sub i32 %sub, %4
  %smax65 = call i32 @llvm.smax.i32(i32 %sub31, i32 noundef -1)
  %7 = add i32 %smax65, 1
  %wide.trip.count66 = zext i32 %7 to i64
  %wide.trip.count60 = zext i32 %6 to i64
  br label %for.cond45

for.body34:                                       ; preds = %for.cond30
  %arrayidx36 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %temp, i64 0, i64 %indvars.iv54
  %arrayidx39 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv54
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.end68
  %indvars.iv62 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next63, %for.end68 ]
  %exitcond67 = icmp eq i64 %indvars.iv62, %wide.trip.count66
  br i1 %exitcond67, label %for.cond72, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %arrayidx56 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv62
  %arrayidx64 = getelementptr inbounds nuw [600 x i32], ptr %cnt, i64 0, i64 %indvars.iv62
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %if.end
  %indvars.iv57 = phi i64 [ 0, %for.cond50.preheader ], [ %indvars.iv.next58, %if.end ]
  %exitcond61 = icmp eq i64 %indvars.iv57, %wide.trip.count60
  br i1 %exitcond61, label %for.end68, label %for.body54

for.body54:                                       ; preds = %for.cond50
  %arrayidx59 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %temp, i64 0, i64 %indvars.iv57
...
for.cond72:                                       ; preds = %for.cond45, %for.body76
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.body76 ], [ 0, %for.cond45 ]
  %max.0 = phi i32 [ %spec.select, %for.body76 ], [ 1, %for.cond45 ]
  %exitcond72 = icmp eq i64 %indvars.iv68, %wide.trip.count66
  br i1 %exitcond72, label %for.end86, label %for.body76

for.body76:                                       ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [600 x i32], ptr %cnt, i64 0, i64 %indvars.iv68
...
for.cond91:                                       ; preds = %if.end138, %if.then88
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %if.end138 ], [ 0, %if.then88 ]
  %10 = load i32, ptr %n, align 4, !tbaa !5
  %add93 = sub i32 %sub, %10
  %11 = sext i32 %add93 to i64
  %cmp94 = icmp slt i64 %indvars.iv78, %11
  br i1 %cmp94, label %for.body95, label %if.end144

for.body95:                                       ; preds = %for.cond91
  %arrayidx97 = getelementptr inbounds nuw [600 x i32], ptr %cnt, i64 0, i64 %indvars.iv78
  %12 = load i32, ptr %arrayidx97, align 4, !tbaa !5
  %cmp98 = icmp eq i32 %12, %max.0
  br i1 %cmp98, label %land.lhs.true, label %if.end138

land.lhs.true:                                    ; preds = %for.body95
  %cmp99 = icmp eq i64 %indvars.iv78, 0
  br i1 %cmp99, label %land.lhs.true110.thread, label %for.cond113.preheader

for.cond113.preheader:                            ; preds = %land.lhs.true
  %arrayidx117 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv78
  %13 = add nuw i64 %indvars.iv78, 4294967295
...
for.cond113:                                      ; preds = %for.cond113.preheader, %if.end134
  %indvars.iv73 = phi i64 [ 0, %for.cond113.preheader ], [ %indvars.iv.next74, %if.end134 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %indvars.iv78
  br i1 %exitcond77.not, label %if.end138, label %for.body115

for.body115:                                      ; preds = %for.cond113
  %arrayidx120 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv73
...
if.end125:                                        ; preds = %for.body115
  %cmp127 = icmp eq i64 %indvars.iv73, %14
