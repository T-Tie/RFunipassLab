...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %x1) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %x2) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %s) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %t) #5
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load double, ptr %arrayidx2, align 8, !tbaa !9, !invariant.load !11
  %3 = load double, ptr %arrayidx, align 8, !tbaa !9, !invariant.load !11
  %mul12 = fmul double %3, 4.000000e+00
  %4 = load double, ptr %arrayidx4, align 8, !tbaa !9, !invariant.load !11
  %5 = fneg double %4
...
if.then:                                          ; preds = %for.body
  ...
  %call50 = call double @sqrt(double noundef %6) #6, !tbaa !5
  %sub = fsub double %fneg, %call50
...
for.cond127:                                      ; preds = %for.cond, %for.inc192
  ...
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc192 ], [ 0, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp128 = icmp slt i64 %indvars.iv70, %8
  br i1 %cmp128, label %for.body129, label %for.end194

for.body129:                                      ; preds = %for.cond127
  %arrayidx131 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv70
  %9 = load double, ptr %arrayidx131, align 8, !tbaa !9, !invariant.load !11
  %arrayidx136 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %indvars.iv70
  %10 = load double, ptr %arrayidx136, align 8, !tbaa !9, !invariant.load !11
  %mul137 = fmul double %10, 4.000000e+00
  %arrayidx139 = getelementptr inbounds nuw [100 x double], ptr %c, i64 0, i64 %indvars.iv70
  %11 = load double, ptr %arrayidx139, align 8, !tbaa !9, !invariant.load !11
  %12 = fneg double %11
...
if.then143:                                       ; preds = %for.body129
  %arrayidx145 = getelementptr inbounds nuw [100 x double], ptr %x1, i64 0, i64 %indvars.iv70
  %14 = load double, ptr %arrayidx145, align 8, !tbaa !9, !invariant.load !11
  %arrayidx147 = getelementptr inbounds nuw [100 x double], ptr %x2, i64 0, i64 %indvars.iv70
  %15 = load double, ptr %arrayidx147, align 8, !tbaa !9, !invariant.load !11
...
if.end149:                                        ; preds = %if.then143, %for.body129
  %cmp162 = fcmp oeq double %13, 0.000000e+00
  br i1 %cmp162, label %if.then163, label %if.end167

if.then163:                                       ; preds = %if.end149
  %arrayidx165 = getelementptr inbounds nuw [100 x double], ptr %x1, i64 0, i64 %indvars.iv70
  %16 = load double, ptr %arrayidx165, align 8, !tbaa !9, !invariant.load !11
...
if.end167:                                        ; preds = %if.then163, %if.end149
  %cmp180 = fcmp olt double %13, 0.000000e+00
  br i1 %cmp180, label %if.then181, label %for.inc192

if.then181:                                       ; preds = %if.end167
  %arrayidx183 = getelementptr inbounds nuw [100 x double], ptr %s, i64 0, i64 %indvars.iv70
  %17 = load double, ptr %arrayidx183, align 8, !tbaa !9, !invariant.load !11
  %arrayidx185 = getelementptr inbounds nuw [100 x double], ptr %t, i64 0, i64 %indvars.iv70
  %18 = load double, ptr %arrayidx185, align 8, !tbaa !9, !invariant.load !11
...
for.inc192:                                       ; preds = %if.end167, %if.then181
  ...
  br label %for.cond127, !llvm.loop !15

for.end194:                                       ; preds = %for.cond127
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %t) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %s) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %x2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %x1) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %c) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %a) #6
