...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z1sii(i32 noundef %2, i32 noundef 2)
...
define dso_local noundef i32 @_Z1sii(i32 noundef %a, i32 noundef %b) #3 {
entry:
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %cmp2 = icmp sge i32 %div, %7
  br i1 %cmp2, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  %8 = load i32, ptr %t, align 4, !tbaa !5
  %9 = load i32, ptr %a.addr, align 4, !tbaa !5
  %10 = load i32, ptr %i, align 4, !tbaa !5
  %div3 = sdiv i32 %9, %10
  %11 = load i32, ptr %i, align 4, !tbaa !5
  %call = call noundef i32 @_Z1sii(i32 noundef %div3, i32 noundef %11)
