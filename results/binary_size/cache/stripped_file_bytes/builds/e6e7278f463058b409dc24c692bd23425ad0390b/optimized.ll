...
for.cond13:                                       ; preds = %entry, %for.inc19
  %i.1 = phi i32 [ %inc20, %for.inc19 ], [ 0, %entry ]
  %exitcond.not = icmp eq i32 %i.1, 5
  br i1 %exitcond.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond13
  %call18 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 poison)
  %inc20 = add nuw nsw i32 %i.1, 1
  br label %for.cond13, !llvm.loop !5

for.end21:                                        ; preds = %for.cond13
  %0 = load i32, ptr %a, align 4, !tbaa !8
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %0)
