...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %a.sink)
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp sgt i32 %0, 0
  br i1 %cmp, label %for.cond, label %for.cond17

for.cond17:                                       ; preds = %for.cond
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef undef)
...
while.cond.i.i:                                   ; preds = %while.body.i.i, %for.inc.i
  %__next.0.i.i = phi ptr [ %__first.addr.0.i, %for.inc.i ], [ %incdec.ptr.i.i, %while.body.i.i ]
  %incdec.ptr.i.i = getelementptr inbounds i8, ptr %__next.0.i.i, i64 -4
...
while.body.i.i:                                   ; preds = %while.cond.i.i
  store i32 %1, ptr %__next.0.i.i, align 4, !tbaa !5
...
_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_.exit.i: ; preds = %while.cond.i.i
  store i32 %0, ptr %__next.0.i.i, align 4, !tbaa !5
...
if.then:                                          ; preds = %entry
  %cmp.i2 = icmp slt i32 %1, %2
  br i1 %cmp.i2, label %if.end16, label %if.else

if.else:                                          ; preds = %if.then
  %cmp.i3 = icmp slt i32 %0, %2
  %3 = call i32 @llvm.smax.i32(i32 %0, i32 %2)
  %spec.select = select i1 %cmp.i3, ptr %__c, ptr %__a
  br label %if.end16

if.else7:                                         ; preds = %entry
  %cmp.i4 = icmp slt i32 %0, %2
  br i1 %cmp.i4, label %if.end16, label %if.else10

if.else10:                                        ; preds = %if.else7
  %cmp.i5 = icmp slt i32 %1, %2
  %4 = call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %spec.select6 = select i1 %cmp.i5, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.then, %if.else10, %if.else, %if.else7
  %5 = phi i32 [ %0, %if.else7 ], [ %3, %if.else ], [ %4, %if.else10 ], [ %1, %if.then ]
  %__b.addr.sink.sroa.speculated = phi ptr [ %__a, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select6, %if.else10 ], [ %__b, %if.then ]
...
while.cond.i:                                     ; preds = %for.body, %while.body.i
  %__next.0.i = phi ptr [ %incdec.ptr.i, %while.body.i ], [ %__i.0, %for.body ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %__next.0.i, i64 -4
...
while.body.i:                                     ; preds = %while.cond.i
  store i32 %2, ptr %__next.0.i, align 4, !tbaa !5
  br label %while.cond.i, !llvm.loop !13

for.inc:                                          ; preds = %while.cond.i, %if.then2
  %__first.sink = phi ptr [ %__first, %if.then2 ], [ %__next.0.i, %while.cond.i ]
