...
entry:
  ...
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div2)
  ...
  %rem7 = srem i32 %3, 50
  store i32 %rem7, ptr %a, align 4, !tbaa !5
  %4 = load i32, ptr %a, align 4, !tbaa !5
  %rem8 = srem i32 %4, 20
  %div9 = sdiv i32 %rem8, 10
  %call10 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div9)
  ...
  %rem14 = srem i32 %6, 5
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %rem14)
