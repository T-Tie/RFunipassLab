...
for.cond:                                         ; preds = %if.end30, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc25.i5, %if.end30 ]
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.cond7.loopexit
  %indvars.iv22 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next23, %for.cond7.loopexit ]
  ...
  br i1 %exitcond26.not, label %for.end28, label %for.body

for.body:                                         ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [16 x i32], ptr %shuzu, i64 0, i64 %indvars.iv22
  br label %for.cond9

for.cond9:                                        ; preds = %for.body11, %for.body
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body11 ], [ %indvars.iv, %for.body ]
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx15 = getelementptr inbounds nuw [16 x i32], ptr %shuzu, i64 0, i64 %indvars.iv19
