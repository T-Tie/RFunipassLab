...
entry:
  ...
  %need.promoted2 = load i32, ptr @need, align 4, !tbaa !5
  br label %while.cond

while.cond:                                       ; preds = %while.end, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.end ], [ 0, %entry ]
  %need.promoted4 = phi i32 [ %need.promoted3, %while.end ], [ %need.promoted2, %entry ]
  %cmp = icmp sgt i32 %need.promoted4, 0
...
while.cond1:                                      ; preds = %while.cond1.preheader, %while.body3
  %need.promoted3 = phi i32 [ %need.promoted4, %while.cond1.preheader ], [ %sub, %while.body3 ]
  %cmp2.not = icmp slt i32 %need.promoted3, %0
...
while.body3:                                      ; preds = %while.cond1
  ...
  %sub = sub nsw i32 %need.promoted3, %0
...
for.cond:                                         ; preds = %while.cond, %for.inc
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc ], [ 0, %while.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv6, 6
  br i1 %exitcond.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %arrayidx12 = getelementptr inbounds nuw [6 x i32], ptr @ans, i64 0, i64 %indvars.iv6
