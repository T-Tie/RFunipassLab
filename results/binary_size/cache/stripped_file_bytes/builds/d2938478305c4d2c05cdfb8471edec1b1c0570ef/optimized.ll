...
if.end27.gvnsink.split:                           ; preds = %while.body, %if.then20
  ...
  %call21.sink = phi ptr [ %call21, %if.then20 ], [ @_ZSt4cout, %while.body ]
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call21.sink, ptr noundef nonnull %p.1)
