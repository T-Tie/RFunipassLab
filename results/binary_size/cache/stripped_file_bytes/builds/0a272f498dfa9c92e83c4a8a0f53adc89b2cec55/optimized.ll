...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv37, %5
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body18 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv34, %9
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc57
  %indvars.iv50 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next51, %for.inc57 ]
...
for.cond33:                                       ; preds = %for.cond30, %for.inc54
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc54 ], [ 0, %for.cond30 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %for.inc57, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv50, i64 %indvars.iv44
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.body38
  %indvars.iv40 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next41, %for.body38 ]
  %exitcond.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond.not, label %for.inc54, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv40
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv40, i64 %indvars.iv44
...
for.cond60:                                       ; preds = %for.cond30, %for.end74
  %13 = phi i32 [ %.pre, %for.end74 ], [ %6, %for.cond30 ]
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.end74 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp61 = icmp slt i64 %indvars.iv59, %14
  br i1 %cmp61, label %for.cond63, label %for.end84

for.cond63:                                       ; preds = %for.cond60, %for.body65
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body65 ], [ 0, %for.cond60 ]
  %15 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %15, -1
  %16 = sext i32 %sub to i64
  %cmp64 = icmp slt i64 %indvars.iv56, %16
  br i1 %cmp64, label %for.body65, label %for.end74

for.body65:                                       ; preds = %for.cond63
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv59, i64 %indvars.iv56
  %17 = load i32, ptr %arrayidx69, align 4, !tbaa !5
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %17)
...
for.end74:                                        ; preds = %for.cond63
  %arrayidx79 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv59, i64 %16
  %18 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %call80 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %18)
  %vtable.i = load ptr, ptr %call80, align 8, !tbaa !19
  ...
  %call1.i28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call80, i8 noundef signext %call.i27)
