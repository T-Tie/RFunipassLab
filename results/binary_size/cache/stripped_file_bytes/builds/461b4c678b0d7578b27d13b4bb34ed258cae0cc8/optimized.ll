...
for.cond8:                                        ; preds = %for.end, %for.body
  ...
  %r.0 = phi i32 [ 1, %for.body ], [ %spec.select35, %for.end ]
...
for.end:                                          ; preds = %for.cond14
  ...
  %spec.select35 = add nuw nsw i32 %r.0, %inc27
...
if.else49:                                        ; preds = %for.end44
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %d.0, i32 noundef 0)
  %wide.trip.count45 = zext nneg i32 %smax44 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.end65, %if.else49
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.end65 ], [ 0, %if.else49 ]
  %exitcond46.not = icmp eq i64 %indvars.iv40, %wide.trip.count45
  br i1 %exitcond46.not, label %if.end70, label %for.cond55.preheader

for.cond55.preheader:                             ; preds = %for.cond52
  %arrayidx59 = getelementptr inbounds nuw [250 x ptr], ptr %record, i64 0, i64 %indvars.iv40
  br label %for.cond55

for.cond55:                                       ; preds = %for.cond55.preheader, %for.body57
  %indvars.iv37 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next38, %for.body57 ]
  %5 = load i32, ptr %n, align 4, !tbaa !29
  %6 = sext i32 %5 to i64
  %cmp56 = icmp slt i64 %indvars.iv37, %6
  br i1 %cmp56, label %for.body57, label %for.end65

for.body57:                                       ; preds = %for.cond55
  %7 = load ptr, ptr %arrayidx59, align 8, !tbaa !26
  %add.ptr61 = getelementptr inbounds nuw i8, ptr %7, i64 %indvars.iv37
