; ModuleID = '/tmp/tmp3wf8slc8.cpp'
source_filename = "/tmp/tmp3wf8slc8.cpp"
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z1fii(i32 noundef %2, i32 noundef 2)
  %add = add nsw i32 %call2, 1
  store i32 %add, ptr %s, align 4, !tbaa !5
  %3 = load i32, ptr %s, align 4, !tbaa !5
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %3)
...
define dso_local noundef i32 @_Z1fii(i32 noundef %a, i32 noundef %j) #3 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call = call noundef double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 noundef %2)
...
if.else:                                          ; preds = %if.then
  %10 = load i32, ptr %a.addr, align 4, !tbaa !5
  %11 = load i32, ptr %i, align 4, !tbaa !5
  %div4 = sdiv i32 %10, %11
  %12 = load i32, ptr %j.addr, align 4, !tbaa !5
  %call5 = call noundef i32 @_Z1fii(i32 noundef %div4, i32 noundef %12)
  %add6 = add nsw i32 %call5, 1
  %13 = load i32, ptr %count, align 4, !tbaa !5
  %add7 = add nsw i32 %13, %add6
  store i32 %add7, ptr %count, align 4, !tbaa !5
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %tem) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #8
  ret i32 %15
}
