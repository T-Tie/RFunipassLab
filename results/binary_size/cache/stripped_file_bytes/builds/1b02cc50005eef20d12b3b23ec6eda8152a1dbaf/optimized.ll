...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.end26 ], [ 1, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc24 ], [ 1, %for.cond13 ]
  %4 = load i32, ptr %y2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv37, %5
  br i1 %cmp17.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv40, i64 %indvars.iv37
