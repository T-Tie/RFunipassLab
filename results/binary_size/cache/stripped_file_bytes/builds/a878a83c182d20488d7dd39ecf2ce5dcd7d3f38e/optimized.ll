...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %x1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %y1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %x2) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %y2) #9
...
for.cond14:                                       ; preds = %for.end27, %for.end10
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end27 ], [ 0, %for.end10 ]
  %cmp15 = icmp sgt i32 %16, 0
  br i1 %cmp15, label %for.cond17.preheader, label %for.end30

for.cond17.preheader:                             ; preds = %for.cond14
  %17 = mul nuw nsw i64 %indvars.iv22, %13
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla13, i64 %17
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc25
  %18 = phi i32 [ %15, %for.cond17.preheader ], [ %.pre32, %for.inc25 ]
  %indvars.iv19 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next20, %for.inc25 ]
  %19 = sext i32 %18 to i64
  %cmp18 = icmp slt i64 %indvars.iv19, %19
  br i1 %cmp18, label %for.inc25, label %for.end27

for.inc25:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv19
  ...
  %.pre32 = load i32, ptr %y2, align 4, !tbaa !5
...
for.cond31:                                       ; preds = %for.end71, %for.end30
  %20 = phi i32 [ %22, %for.end71 ], [ %15, %for.end30 ]
...
for.cond34:                                       ; preds = %for.cond31, %for.inc69
  %22 = phi i32 [ %.pre31, %for.inc69 ], [ %20, %for.cond31 ]
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc69 ], [ 0, %for.cond31 ]
  %23 = sext i32 %22 to i64
  %cmp35 = icmp slt i64 %indvars.iv25, %23
  br i1 %cmp35, label %for.cond37.preheader, label %for.end71

for.cond37.preheader:                             ; preds = %for.cond34
  %24 = load i32, ptr %x2, align 4, !tbaa !5
  %cmp38 = icmp slt i32 %24, 1
  call void @llvm.assume(i1 %cmp38)
  %sub = add nsw i32 %22, -1
  %25 = sext i32 %sub to i64
  %cmp55 = icmp slt i64 %indvars.iv25, %25
  br i1 %cmp55, label %if.then, label %if.else

if.then:                                          ; preds = %for.cond37.preheader
  %call60 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef undef)
...
if.else:                                          ; preds = %for.cond37.preheader
  %call67 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef undef)
  %call68 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call67, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc69
