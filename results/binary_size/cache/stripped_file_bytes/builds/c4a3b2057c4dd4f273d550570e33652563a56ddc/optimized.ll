...
define dso_local void @_Z6numberii(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i32 %x, 1
...
if.end:                                           ; preds = %if.then, %entry
  %cmp1.not8 = icmp sgt i32 %y, %x
  br i1 %cmp1.not8, label %for.end, label %for.body

for.body:                                         ; preds = %if.end, %for.inc
  %i.09 = phi i32 [ %inc, %for.inc ], [ %y, %if.end ]
  %rem = srem i32 %x, %i.09
  %div = sdiv i32 %x, %i.09
...
if.then3:                                         ; preds = %for.body
  tail call void @_Z6numberii(i32 noundef %div, i32 noundef %i.09)
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then3
  %inc = add i32 %i.09, 1
  %exitcond.not = icmp eq i32 %i.09, %x
...
for.body:                                         ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  call void @_Z6numberii(i32 noundef %1, i32 noundef %2)
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %cmp.not.not = icmp slt i32 %i.03, %8
