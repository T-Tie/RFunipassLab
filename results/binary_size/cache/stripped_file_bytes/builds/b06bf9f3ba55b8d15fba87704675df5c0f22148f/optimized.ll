...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 44100, ptr noundef nonnull %board) #9
...
for.end140:                                       ; preds = %for.cond1
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 44100, ptr noundef nonnull %board) #9
  br label %for.cond
