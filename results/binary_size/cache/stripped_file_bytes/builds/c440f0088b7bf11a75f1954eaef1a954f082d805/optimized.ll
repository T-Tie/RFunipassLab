...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.end26
  %indvars.iv12 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next13, %for.end26 ]
...
for.body16:                                       ; preds = %for.cond13
  %arrayidx18 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv9
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %cmp21 = icmp sgt i32 %9, %8
  %10 = trunc nuw nsw i64 %indvars.iv9 to i32
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.body49
  %indvars.iv17 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next18, %for.body49 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end55, label %for.body49

for.body49:                                       ; preds = %for.cond46
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv17
