...
entry:
  ...
  %arrayidx = getelementptr inbounds [20 x i8], ptr %vla, i64 0
  %arraydecay = getelementptr inbounds [20 x i8], ptr %arrayidx, i64 0, i64 0
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx1 = getelementptr inbounds [20 x i8], ptr %vla, i64 %idxprom
  %arraydecay2 = getelementptr inbounds [20 x i8], ptr %arrayidx1, i64 0, i64 0
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %arraydecay2)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.cleanup
  %arrayidx4 = getelementptr inbounds [20 x i8], ptr %vla, i64 0
  %arraydecay5 = getelementptr inbounds [20 x i8], ptr %arrayidx4, i64 0, i64 0
  %call6 = call i64 @strlen(ptr noundef %arraydecay5) #13
  %conv = trunc i64 %call6 to i32
  store i32 %conv, ptr %s, align 4, !tbaa !5
  %arrayidx7 = getelementptr inbounds [20 x i8], ptr %vla, i64 0
  %arraydecay8 = getelementptr inbounds [20 x i8], ptr %arrayidx7, i64 0, i64 0
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay8)
  call void @llvm.lifetime.start.p0(i64 4, ptr %i10) #12
  store i32 1, ptr %i10, align 4, !tbaa !5
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc35, %for.end
  %7 = load i32, ptr %i10, align 4, !tbaa !5
  %8 = load i32, ptr %n, align 4, !tbaa !5
  %cmp12 = icmp slt i32 %7, %8
  br i1 %cmp12, label %for.body14, label %for.cond.cleanup13

for.cond.cleanup13:                               ; preds = %for.cond11
  call void @llvm.lifetime.end.p0(i64 4, ptr %i10) #12
  br label %for.end37

for.body14:                                       ; preds = %for.cond11
  %9 = load i32, ptr %i10, align 4, !tbaa !5
  %idxprom15 = sext i32 %9 to i64
  %arrayidx16 = getelementptr inbounds [20 x i8], ptr %vla, i64 %idxprom15
  %arraydecay17 = getelementptr inbounds [20 x i8], ptr %arrayidx16, i64 0, i64 0
  ...
  %add20 = add i64 %conv19, %add
  %conv21 = trunc i64 %add20 to i32
  store i32 %conv21, ptr %s, align 4, !tbaa !5
  %11 = load i32, ptr %s, align 4, !tbaa !5
  %cmp22 = icmp sle i32 %11, 80
...
if.then:                                          ; preds = %for.body14
  ...
  %13 = load i32, ptr %i10, align 4, !tbaa !5
  %mul = mul nsw i32 %13, 20
  %idx.ext = sext i32 %mul to i64
  %add.ptr = getelementptr inbounds i8, ptr %12, i64 %idx.ext
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call23, ptr noundef %add.ptr)
  br label %if.end
...
if.else:                                          ; preds = %for.body14
  ...
  %15 = load i32, ptr %i10, align 4, !tbaa !5
  %mul26 = mul nsw i32 %15, 20
  %idx.ext27 = sext i32 %mul26 to i64
  %add.ptr28 = getelementptr inbounds i8, ptr %14, i64 %idx.ext27
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call25, ptr noundef %add.ptr28)
  %16 = load i32, ptr %i10, align 4, !tbaa !5
  %idxprom30 = sext i32 %16 to i64
  %arrayidx31 = getelementptr inbounds [20 x i8], ptr %vla, i64 %idxprom30
  %arraydecay32 = getelementptr inbounds [20 x i8], ptr %arrayidx31, i64 0, i64 0
  %call33 = call i64 @strlen(ptr noundef %arraydecay32) #13
  %conv34 = trunc i64 %call33 to i32
  store i32 %conv34, ptr %s, align 4, !tbaa !5
  br label %if.end
...
for.inc35:                                        ; preds = %if.end
  %17 = load i32, ptr %i10, align 4, !tbaa !5
  %inc36 = add nsw i32 %17, 1
  store i32 %inc36, ptr %i10, align 4, !tbaa !5
  br label %for.cond11, !llvm.loop !15

for.end37:                                        ; preds = %for.cond.cleanup13
...
!37 = !{!"_ZTSNSt8ios_base6_WordsE", !11, i64 0, !19, i64 8}
