...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv14 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next15, %for.inc44 ]
  %i.3 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond20.not = icmp eq i32 %i.3, %smax19
  br i1 %exitcond20.not, label %for.end46, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax16 = call i32 @llvm.smax.i32(i32 %indvars.iv14, i32 noundef 0)
  %wide.trip.count17 = zext nneg i32 %smax16 to i64
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv11 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next12, %for.inc41 ]
  %exitcond18.not = icmp eq i64 %indvars.iv11, %wide.trip.count17
  br i1 %exitcond18.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv11
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next12
...
for.end46:                                        ; preds = %for.cond16
  ...
  %smax25 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 1)
  %wide.trip.count26 = zext nneg i32 %smax25 to i64
  br label %for.cond49

for.cond49:                                       ; preds = %for.inc56, %for.end46
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc56 ], [ 1, %for.end46 ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end58, label %for.inc56
