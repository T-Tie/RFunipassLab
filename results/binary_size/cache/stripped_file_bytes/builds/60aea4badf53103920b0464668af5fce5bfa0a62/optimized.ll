...
for.cond31:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc57 ], [ 0, %for.cond ]
...
for.body34:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [505 x i8], ptr %y, i64 0, i64 %indvars.iv23
...
for.cond60:                                       ; preds = %for.cond31, %for.body63
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body63 ], [ 0, %for.cond31 ]
...
for.body63:                                       ; preds = %for.cond60
  %arrayidx65 = getelementptr inbounds nuw [505 x i8], ptr %x, i64 0, i64 %indvars.iv26
  %5 = load i8, ptr %arrayidx65, align 1, !tbaa !5, !invariant.load !8
  %arrayidx68 = getelementptr inbounds nuw [505 x i8], ptr %y, i64 0, i64 %indvars.iv26
