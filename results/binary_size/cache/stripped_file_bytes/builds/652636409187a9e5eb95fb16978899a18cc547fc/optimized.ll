...
for.cond:                                         ; preds = %if.end23, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %if.end23 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54 ]
  %exitcond77 = icmp eq i64 %indvars.iv72, %wide.trip.count76
  br i1 %exitcond77, label %if.end47, label %for.cond13

for.cond13:                                       ; preds = %for.cond, %if.end
...
for.body15:                                       ; preds = %for.cond13
  ...
  br i1 %cmp20.not, label %if.end, label %for.end.split.loop.exit88

if.end:                                           ; preds = %for.body15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond13, !llvm.loop !23

for.end.split.loop.exit88:                        ; preds = %for.body15
  %10 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.cond13, %for.end.split.loop.exit88
  %j.0.lcssa = phi i32 [ %10, %for.end.split.loop.exit88 ], [ %smax, %for.cond13 ]
  %cmp21 = icmp eq i32 %j.0.lcssa, %conv9
  br i1 %cmp21, label %for.cond28.preheader, label %if.end23
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv78 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next79, %for.body30 ]
  %exitcond85.not = icmp eq i64 %indvars.iv78, %wide.trip.count84
  br i1 %exitcond85.not, label %for.end36, label %for.body30
