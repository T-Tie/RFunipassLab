...
for.cond6:                                        ; preds = %for.cond, %for.inc62
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc62 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp8.not.not = icmp slt i64 %indvars.iv9, %3
  br i1 %cmp8.not.not, label %for.body9, label %for.end64

for.body9:                                        ; preds = %for.cond6
  %arrayidx11 = getelementptr inbounds nuw [1000 x float], ptr %b, i64 0, i64 %indvars.iv9
  %4 = load float, ptr %arrayidx11, align 4, !tbaa !12, !invariant.load !14
  %arrayidx15 = getelementptr inbounds nuw [1000 x float], ptr %a, i64 0, i64 %indvars.iv9
  %5 = load float, ptr %arrayidx15, align 4, !tbaa !12, !invariant.load !14
  %mul16 = fmul float %5, 4.000000e+00
  %arrayidx18 = getelementptr inbounds nuw [1000 x float], ptr %c, i64 0, i64 %indvars.iv9
...
if.else37:                                        ; preds = %if.else
  %fneg38 = fneg float %8
  %call.i6 = call noundef float @sqrtf(float noundef nofpclass(pzero) %fneg38) #8, !tbaa !5
  %div43 = fdiv float %call.i6, %mul
