...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %shu) #3
...
for.cond2:                                        ; preds = %for.inc26, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc26 ], [ %2, %for.end ]
...
for.cond5:                                        ; preds = %for.cond2, %for.inc23
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc23 ], [ 0, %for.cond2 ]
...
for.end27:                                        ; preds = %for.cond2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %shu) #4
