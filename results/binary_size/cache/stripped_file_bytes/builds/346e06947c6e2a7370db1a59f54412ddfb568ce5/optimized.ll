...
for.cond.preheader:                               ; preds = %while.cond
  %cmp1942.not = icmp eq i32 %i.0.ph.ph, 0
  br i1 %cmp1942.not, label %for.cond38.preheader, label %for.cond20.preheader.preheader
...
for.cond20.preheader:                             ; preds = %for.cond20.preheader.preheader, %for.end
  %indvars.iv50 = phi i64 [ 0, %for.cond20.preheader.preheader ], [ %indvars.iv.next51, %for.end ]
  %arrayidx2439 = getelementptr inbounds nuw [10000 x [50 x i8]], ptr %a, i64 0, i64 %indvars.iv50, i64 0
  %3 = load i8, ptr %arrayidx2439, align 2, !tbaa !13
  %cmp26.not40 = icmp eq i8 %3, 0
  br i1 %cmp26.not40, label %for.end, label %for.body27

for.cond38.preheader:                             ; preds = %for.end, %for.cond.preheader
  %idxprom39 = zext nneg i32 %i.0.ph.ph to i64
  %arrayidx4245 = getelementptr inbounds nuw [10000 x [50 x i8]], ptr %a, i64 0, i64 %idxprom39, i64 0
  %4 = load i8, ptr %arrayidx4245, align 2, !tbaa !13
  %cmp44.not46 = icmp eq i8 %4, 0
  br i1 %cmp44.not46, label %for.end53, label %for.body45

for.body27:                                       ; preds = %for.cond20.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv = phi i64 [ %indvars.iv.next, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %for.cond20.preheader ]
  %5 = phi i8 [ %7, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %3, %for.cond20.preheader ]
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %5, ptr %__c.addr.i, align 1, !tbaa !13
  ...
  %6 = load i64, ptr %gep, align 8, !tbaa !16
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %arrayidx24 = getelementptr inbounds nuw [10000 x [50 x i8]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv.next
  %7 = load i8, ptr %arrayidx24, align 1, !tbaa !13
  %cmp26.not = icmp eq i8 %7, 0
  br i1 %cmp26.not, label %for.end, label %for.body27, !llvm.loop !27

for.end:                                          ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %for.cond20.preheader
  ...
  br i1 %exitcond.not, label %for.cond38.preheader, label %for.cond20.preheader, !llvm.loop !28

for.body45:                                       ; preds = %for.cond38.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36 ], [ 0, %for.cond38.preheader ]
  %8 = phi i8 [ %10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36 ], [ %4, %for.cond38.preheader ]
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i24)
  store i8 %8, ptr %__c.addr.i24, align 1, !tbaa !13
  ...
  %gep44 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i27
  %9 = load i64, ptr %gep44, align 8, !tbaa !16
  %cmp.not.i30 = icmp eq i64 %9, 0
...
if.end.i34:                                       ; preds = %for.body45
  %call2.i35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %8)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36: ; preds = %if.then.i31, %if.end.i34
  ...
  %arrayidx42 = getelementptr inbounds nuw [10000 x [50 x i8]], ptr %a, i64 0, i64 %idxprom39, i64 %indvars.iv.next55
  %10 = load i8, ptr %arrayidx42, align 1, !tbaa !13
  %cmp44.not = icmp eq i8 %10, 0
  br i1 %cmp44.not, label %for.end53, label %for.body45, !llvm.loop !29

for.end53:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit36, %for.cond38.preheader
