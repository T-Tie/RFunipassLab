...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc15
  %indvars.iv10 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next11, %for.inc15 ]
  %result.2 = phi i32 [ 0, %for.cond.preheader ], [ %result.3, %for.inc15 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end17, label %for.cond3.preheader
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.body6
  ...
  br i1 %exitcond.not, label %for.inc15, label %for.body6
...
if.end20:                                         ; preds = %for.end17, %if.then
  %count.1 = phi i32 [ %inc, %if.then ], [ 1, %for.end17 ]
