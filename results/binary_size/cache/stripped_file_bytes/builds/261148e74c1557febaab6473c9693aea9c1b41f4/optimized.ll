...
for.cond:                                         ; preds = %for.cond.cleanup10, %entry
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.cond.cleanup10 ], [ %1, %entry ]
  %cmp.i.not = icmp sgt i64 %indvars.iv51, %2
  br i1 %cmp.i.not, label %for.cond29, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %add.ptr13 = getelementptr inbounds [200 x i32], ptr @a, i64 %indvars.iv51
  br label %for.cond8
...
for.cond29:                                       ; preds = %for.cond
  %cmp.i14.not = icmp sgt i32 %i, %0
  call void @llvm.assume(i1 %cmp.i14.not)
  ret void
}
...
for.cond:                                         ; preds = %for.cond.cleanup57, %entry
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.cond.cleanup57 ], [ 1, %entry ]
  %0 = load i32, ptr @n, align 4, !tbaa !5
  %cmp.i.i = icmp sgt i32 %0, 0
  br i1 %cmp.i.i, label %for.body, label %for.end141
...
for.cond1:                                        ; preds = %for.cond.cleanup7, %for.body
  ...
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.cond.cleanup7 ], [ 1, %for.body ]
  %cmp.i.i21 = icmp sgt i32 %1, 0
  br i1 %cmp.i.i21, label %for.cond5.preheader, label %for.cond55.preheader

for.cond55.preheader:                             ; preds = %for.cond1
  %arrayidx65 = getelementptr inbounds nuw [200 x i32], ptr @sum, i64 0, i64 %indvars.iv87
  br label %for.cond55
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %3 = sext i32 %2 to i64
  %cmp.i.i22.not = icmp sgt i64 %indvars.iv, %3
...
for.cond55:                                       ; preds = %for.cond55.loopexit, %for.cond55.preheader
  ...
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.cond55.loopexit ], [ 1, %for.cond55.preheader ]
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.cond55.loopexit ], [ 2, %for.cond55.preheader ]
...
for.body58:                                       ; preds = %for.cond55
  %6 = trunc nuw nsw i64 %indvars.iv81 to i32
  tail call void @_Z4zeroi(i32 noundef %6) #9
  %add.ptr60 = getelementptr inbounds nuw [200 x i32], ptr @a, i64 %indvars.iv81
  %add.ptr63 = getelementptr inbounds nuw i32, ptr %add.ptr60, i64 %indvars.iv81
...
for.cond68:                                       ; preds = %for.body71, %for.body58
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.body71 ], [ %indvars.iv76, %for.body58 ]
  %10 = trunc nuw i64 %indvars.iv78 to i32
  %cmp.i.i28.not = icmp slt i32 %9, %10
  br i1 %cmp.i.i28.not, label %for.cond101.preheader, label %for.body71

for.cond101.preheader:                            ; preds = %for.cond68
  %invariant.gep = getelementptr inbounds nuw i32, ptr @a, i64 %indvars.iv81
  %11 = sext i32 %9 to i64
  br label %for.cond101

for.body71:                                       ; preds = %for.cond68
  %add.ptr77 = getelementptr inbounds nuw i32, ptr %add.ptr74, i64 %indvars.iv78
  %12 = load i32, ptr %add.ptr77, align 4, !tbaa !5, !invariant.load !12
  store i32 %12, ptr @temp, align 4, !tbaa !5
  %add.ptr83 = getelementptr inbounds nuw i32, ptr %add.ptr80, i64 %indvars.iv78
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.body104
  %indvars.iv83 = phi i64 [ %indvars.iv81, %for.cond101.preheader ], [ %indvars.iv.next84, %for.body104 ]
  %cmp.i.i30.not.not = icmp slt i64 %indvars.iv83, %11
  br i1 %cmp.i.i30.not.not, label %for.body104, label %for.cond55.loopexit

for.body104:                                      ; preds = %for.cond101
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1
  %gep = getelementptr inbounds nuw [200 x i32], ptr %invariant.gep, i64 %indvars.iv.next84
