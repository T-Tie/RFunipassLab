...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %land.lhs.true.i, %if.then19.i, %if.then28.i
  ...
  call void @llvm.assume(i1 noundef %cmp.not)
  %3 = load i8, ptr @c, align 16, !tbaa !23
  %cmp54 = icmp slt i8 %3, 1
  br i1 %cmp54, label %if.then55, label %if.else

if.then55:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
for.cond60:                                       ; preds = %if.end74, %if.else
  %call72.sink = phi ptr [ %call72, %if.end74 ], [ %call58, %if.else ]
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call72.sink, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %4 = load i32, ptr %n, align 4, !tbaa !22
  %cmp62 = icmp slt i32 %4, %conv
  br i1 %cmp62, label %if.end74, label %if.end78

if.end74:                                         ; preds = %for.cond60
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @b)
  br label %for.cond60
