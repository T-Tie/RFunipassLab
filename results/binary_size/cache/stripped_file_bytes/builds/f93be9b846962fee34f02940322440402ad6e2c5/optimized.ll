...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %l) #4
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv22, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond, %for.inc60
  %.pre.pre41 = phi i32 [ %.pre.pre42, %for.inc60 ], [ %0, %for.cond ]
  %.pre39 = phi i32 [ %.pre, %for.inc60 ], [ %0, %for.cond ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc60 ], [ 0, %for.cond ]
  %f4.0 = phi i32 [ %f4.1, %for.inc60 ], [ 0, %for.cond ]
  %4 = sext i32 %.pre39 to i64
  %cmp13.not.not = icmp slt i64 %indvars.iv36, %4
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc57
  %.pre.pre42 = phi i32 [ %.pre.pre41, %for.cond15.preheader ], [ %.pre.pre, %for.inc57 ]
  %.pre = phi i32 [ %.pre39, %for.cond15.preheader ], [ %.pre.pre, %for.inc57 ]
  %indvars.iv33 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next34, %for.inc57 ]
  %f4.1 = phi i32 [ %f4.0, %for.cond15.preheader ], [ %f4.2, %for.inc57 ]
  %6 = load i32, ptr %l, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17.not.not = icmp slt i64 %indvars.iv33, %7
  br i1 %cmp17.not.not, label %for.cond19.preheader, label %for.inc60

for.cond19.preheader:                             ; preds = %for.cond15
  %arrayidx30 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv36, i64 %indvars.iv33
  %smax = call i32 @llvm.smax.i32(i32 %.pre, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.body22
  %indvars.iv25 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next26, %for.body22 ]
...
for.cond35.preheader:                             ; preds = %for.cond19
  %wide.trip.count31 = zext i32 %6 to i64
  br label %for.cond35

for.body22:                                       ; preds = %for.cond19
  %arrayidx26 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv25, i64 %indvars.iv33
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.body38
  %indvars.iv28 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next29, %for.body38 ]
  %f2.0 = phi i32 [ 1, %for.cond35.preheader ], [ %spec.select20, %for.body38 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end52, label %for.body38

for.body38:                                       ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv36, i64 %indvars.iv28
  ...
  %spec.select20 = select i1 %cmp47, i32 0, i32 %f2.0
...
if.then54:                                        ; preds = %for.end52
  ...
  %call55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %5, i32 noundef %12)
  %.pre.pre.pre = load i32, ptr %h, align 4, !tbaa !5
  br label %for.inc57

for.inc57:                                        ; preds = %for.end52, %if.then54
  %.pre.pre = phi i32 [ %.pre.pre.pre, %if.then54 ], [ %.pre.pre42, %for.end52 ]
...
if.end66:                                         ; preds = %if.then64, %for.end62
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %l) #5
