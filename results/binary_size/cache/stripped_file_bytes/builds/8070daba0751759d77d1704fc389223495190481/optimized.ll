...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  ...
  %exitcond48.not = icmp eq i64 %indvars.iv43, %2
  br i1 %exitcond48.not, label %for.end29, label %for.cond13
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv39
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.134 = phi i32 [ %6, %for.end29.loopexit ], [ %smax, %for.cond10 ]
...
for.end51:                                        ; preds = %for.cond30, %for.body36
  %i.231 = phi i32 [ %i.2, %for.body36 ], [ %smin, %for.cond30 ]
  %j2.0 = phi i32 [ %j.2, %for.body36 ], [ undef, %for.cond30 ]
  %10 = xor i32 %i.134, -1
  %sub53 = add i32 %i.231, %10
