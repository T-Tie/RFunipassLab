...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc30
  %indvars.iv47 = phi i64 [ %4, %for.cond2.preheader ], [ %indvars.iv.next48, %for.inc30 ]
  %indvars.iv34 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next35, %for.inc30 ]
  %smax49 = call i64 @llvm.smax.i64(i64 %indvars.iv47, i64 noundef 0)
...
for.cond5:                                        ; preds = %for.cond2, %for.body7
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body7 ], [ 0, %for.cond2 ]
  %max.0 = phi i32 [ %spec.select, %for.body7 ], [ 0, %for.cond2 ]
  %exitcond50 = icmp eq i64 %indvars.iv31, %smax49
  br i1 %exitcond50, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv31
...
for.cond33:                                       ; preds = %for.cond2, %for.inc53
  %.pre42 = phi i32 [ %.pre, %for.inc53 ], [ %3, %for.cond2 ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc53 ], [ 0, %for.cond2 ]
  %13 = sext i32 %.pre42 to i64
  %cmp34 = icmp slt i64 %indvars.iv39, %13
  br i1 %cmp34, label %for.body35, label %for.end55

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv39
...
if.then39:                                        ; preds = %for.body35
  %sub40 = add nsw i32 %.pre42, -2
  %16 = zext i32 %sub40 to i64
  %cmp41 = icmp eq i64 %indvars.iv39, %16
  %sub42 = add nsw i32 %.pre42, -1
  %17 = zext i32 %sub42 to i64
  %cmp43 = icmp eq i64 %indvars.iv39, %17
...
for.inc53:                                        ; preds = %for.body35, %if.then39
  %.pre = phi i32 [ %.pre42, %for.body35 ], [ %.pre.pre, %if.then39 ]
