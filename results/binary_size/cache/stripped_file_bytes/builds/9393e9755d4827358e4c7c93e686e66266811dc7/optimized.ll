...
entry:
  ...
  tail call void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) @head)
...
if.end:                                           ; preds = %land.lhs.true19, %land.lhs.true, %for.cond
  tail call void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) @p2)
...
if.then:                                          ; preds = %entry
  tail call void @outlined_ir_func_1(ptr nofree noundef nonnull align 8 dereferenceable(112) %x) #10
...
define internal void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) #5 {
...
define internal void @outlined_ir_func_1(ptr nofree noundef nonnull align 8 dereferenceable(112) %0) #6 {
