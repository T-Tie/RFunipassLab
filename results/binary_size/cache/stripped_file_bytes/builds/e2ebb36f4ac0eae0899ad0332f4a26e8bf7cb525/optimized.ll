...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc46
  %indvars.iv10 = phi i32 [ %7, %for.cond18.preheader ], [ %indvars.iv.next11, %for.inc46 ]
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc43
  %indvars.iv6 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next7, %for.inc43 ]
  %exitcond14.not = icmp eq i64 %indvars.iv6, %wide.trip.count13
  br i1 %exitcond14.not, label %for.inc46, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx27 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv6
  %10 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx29 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv.next7
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc65
  %indvars.iv15 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next16, %for.inc65 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.end67, label %for.body52

for.body52:                                       ; preds = %for.cond49
  %cmp54 = icmp eq i64 %indvars.iv15, %9
  %12 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv15
