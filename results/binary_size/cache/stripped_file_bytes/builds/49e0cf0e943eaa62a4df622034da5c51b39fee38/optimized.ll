...
for.cond1:                                        ; preds = %for.cond, %for.end
  %phiofops = phi i1 [ %cmp, %for.cond ], [ false, %for.end ]
  %1 = phi i32 [ %2, %for.end ], [ %0, %for.cond ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.end ], [ 0, %for.cond ]
  br i1 %phiofops, label %for.cond4, label %for.end12
...
for.cond:                                         ; preds = %for.end27, %entry
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.end27 ], [ 0, %entry ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33
  br i1 %exitcond34.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv30
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv30, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body16 ], [ 0, %for.cond14.preheader ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv30, i64 %indvars.iv25
...
for.cond31:                                       ; preds = %for.cond, %for.end70
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.end70 ], [ 0, %for.cond ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count33
  br i1 %exitcond49.not, label %for.end73, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv45
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.body39 ], [ 0, %for.body33 ]
  %s.1 = phi i32 [ %spec.select23, %for.body39 ], [ %3, %for.body33 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond39.not, label %for.cond56.preheader, label %for.body39

for.cond56.preheader:                             ; preds = %for.cond37
  br label %for.cond56

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv35, i64 %indvars.iv45
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %spec.select23 = tail call i32 @llvm.smin.i32(i32 %s.1, i32 %4)
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  br label %for.cond37, !llvm.loop !14

for.cond56:                                       ; preds = %for.cond56.preheader, %for.body58
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body58 ], [ 0, %for.cond56.preheader ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond44.not, label %for.end70, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv40, i64 %indvars.iv45
...
for.end73:                                        ; preds = %for.cond31
  ...
  %6 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !9
  %cmp76 = icmp sgt i32 %n, 2
  br i1 %cmp76, label %if.then, label %if.end

if.then:                                          ; preds = %for.end73
  %7 = load i32, ptr %a, align 4, !tbaa !5, !invariant.load !9
  store i32 %7, ptr %b, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.body83, %if.then
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body83 ], [ 2, %if.then ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count
  br i1 %exitcond55.not, label %for.cond101, label %for.body83

for.body83:                                       ; preds = %for.cond81
  %arrayidx86 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv50
  %8 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !9
  %9 = add nsw i64 %indvars.iv50, -1
  %arrayidx90 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %9
  store i32 %8, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx92 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv50
...
for.cond101:                                      ; preds = %for.cond81, %for.end119
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.end119 ], [ 2, %for.cond81 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond67.not, label %for.end122, label %for.cond104.preheader
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.body106
  %indvars.iv56 = phi i64 [ 2, %for.cond104.preheader ], [ %indvars.iv.next57, %for.body106 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond61.not, label %for.end119, label %for.body106

for.body106:                                      ; preds = %for.cond104
  %arrayidx110 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv62, i64 %indvars.iv56
  %12 = load i32, ptr %arrayidx110, align 4, !tbaa !5, !invariant.load !9
  %13 = add nsw i64 %indvars.iv56, -1
