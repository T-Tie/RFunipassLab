...
for.cond:                                         ; preds = %while.cond, %for.inc
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc ], [ %indvars.iv, %while.cond ]
  %cmp24 = icmp sgt i64 %indvars.iv7, 0
  br i1 %cmp24, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %indvars.iv.next8 = add nsw i64 %indvars.iv7, -1
  %arrayidx26 = getelementptr inbounds nuw [1000 x %struct.student], ptr %stu, i64 0, i64 %indvars.iv.next8
