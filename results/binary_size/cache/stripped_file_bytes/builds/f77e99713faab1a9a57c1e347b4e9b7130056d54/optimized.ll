; ModuleID = '/tmp/tmp8jd7_lvs.cpp'
source_filename = "/tmp/tmp8jd7_lvs.cpp"
...
define dso_local noundef i32 @_Z2ffiii(i32 noundef %pos, i32 noundef %highflag, i32 noundef %count) #0 {
entry:
  ...
  store i32 %pos, ptr %pos.addr, align 4, !tbaa !5
  store i32 %highflag, ptr %highflag.addr, align 4, !tbaa !5
  store i32 %count, ptr %count.addr, align 4, !tbaa !5
  %0 = load i32, ptr %pos.addr, align 4, !tbaa !5
...
if.end:                                           ; preds = %entry
  %3 = load i32, ptr %pos.addr, align 4, !tbaa !5
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [30 x i32], ptr @high, i64 0, i64 %idxprom
  %4 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %5 = load i32, ptr %highflag.addr, align 4, !tbaa !5
  %cmp1 = icmp sle i32 %4, %5
  br i1 %cmp1, label %if.then2, label %if.else11

if.then2:                                         ; preds = %if.end
  call void @llvm.lifetime.start.p0(i64 4, ptr %tmp1) #6
  %6 = load i32, ptr %pos.addr, align 4, !tbaa !5
  %add = add nsw i32 %6, 1
  %7 = load i32, ptr %pos.addr, align 4, !tbaa !5
  %idxprom3 = sext i32 %7 to i64
  %arrayidx4 = getelementptr inbounds [30 x i32], ptr @high, i64 0, i64 %idxprom3
  %8 = load i32, ptr %arrayidx4, align 4, !tbaa !5
  %9 = load i32, ptr %count.addr, align 4, !tbaa !5
  %add5 = add nsw i32 %9, 1
  %call = call noundef i32 @_Z2ffiii(i32 noundef %add, i32 noundef %8, i32 noundef %add5)
  store i32 %call, ptr %tmp1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %tmp2) #6
  %10 = load i32, ptr %pos.addr, align 4, !tbaa !5
  %add6 = add nsw i32 %10, 1
  %11 = load i32, ptr %highflag.addr, align 4, !tbaa !5
  %12 = load i32, ptr %count.addr, align 4, !tbaa !5
  %call7 = call noundef i32 @_Z2ffiii(i32 noundef %add6, i32 noundef %11, i32 noundef %12)
  store i32 %call7, ptr %tmp2, align 4, !tbaa !5
  %13 = load i32, ptr %tmp1, align 4, !tbaa !5
  %14 = load i32, ptr %tmp2, align 4, !tbaa !5
  %cmp8 = icmp sgt i32 %13, %14
  br i1 %cmp8, label %if.then9, label %if.else

if.then9:                                         ; preds = %if.then2
  %15 = load i32, ptr %tmp1, align 4, !tbaa !5
  store i32 %15, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

if.else:                                          ; preds = %if.then2
  %16 = load i32, ptr %tmp2, align 4, !tbaa !5
...
if.else11:                                        ; preds = %if.end
  %17 = load i32, ptr %pos.addr, align 4, !tbaa !5
  %add12 = add nsw i32 %17, 1
  %18 = load i32, ptr %highflag.addr, align 4, !tbaa !5
  %19 = load i32, ptr %count.addr, align 4, !tbaa !5
  %call13 = call noundef i32 @_Z2ffiii(i32 noundef %add12, i32 noundef %18, i32 noundef %19)
  store i32 %call13, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.else11, %cleanup, %if.then
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 4, ptr %result) #6
  %call2 = call noundef i32 @_Z2ffiii(i32 noundef 0, i32 noundef 99999, i32 noundef 0)
  store i32 %call2, ptr %result, align 4, !tbaa !5
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %result) #6
