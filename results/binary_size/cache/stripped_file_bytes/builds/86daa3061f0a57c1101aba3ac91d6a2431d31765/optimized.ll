...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80004, ptr noundef nonnull %b) #4
...
for.cond2:                                        ; preds = %for.cond
  ...
  call void @llvm.assume(i1 noundef %cmp3)
  call void @llvm.lifetime.end.p0(i64 noundef 80004, ptr noundef nonnull %b) #5
