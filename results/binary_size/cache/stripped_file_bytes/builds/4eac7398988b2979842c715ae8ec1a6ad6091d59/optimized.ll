...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc8
  %indvars.iv10 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next11, %for.inc8 ]
...
if.end:                                           ; preds = %for.body13
  ...
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv14
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc51
  %indvars.iv23.in = phi i32 [ %5, %for.cond25.preheader ], [ %indvars.iv23, %for.inc51 ]
  %k.0 = phi i32 [ 1, %for.cond25.preheader ], [ %inc52, %for.inc51 ]
  %indvars.iv23 = add i32 %indvars.iv23.in, -1
  %exitcond30.not = icmp eq i32 %k.0, %smax29
  br i1 %exitcond30.not, label %for.end53, label %for.cond28.preheader

for.cond28.preheader:                             ; preds = %for.cond25
  %smax25 = call i32 @llvm.smax.i32(i32 %indvars.iv23, i32 0)
  %wide.trip.count26 = zext nneg i32 %smax25 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc48
  %indvars.iv19 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next20, %for.inc48 ]
  %exitcond27.not = icmp eq i64 %indvars.iv19, %wide.trip.count26
  br i1 %exitcond27.not, label %for.inc51, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv19
  %9 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !13
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv.next20
...
for.cond55:                                       ; preds = %for.inc62, %for.end53
  %12 = phi i32 [ %.pre34, %for.inc62 ], [ %5, %for.end53 ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc62 ], [ %11, %for.end53 ]
  %sub56 = add nsw i32 %12, -1
  %13 = sext i32 %sub56 to i64
  %cmp57 = icmp slt i64 %indvars.iv31, %13
  br i1 %cmp57, label %for.inc62, label %for.end64

for.inc62:                                        ; preds = %for.cond55
  %arrayidx60 = getelementptr inbounds i32, ptr %vla1, i64 %indvars.iv31
