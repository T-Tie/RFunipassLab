...
entry:
  ...
  %smin20 = call i32 @llvm.smin.i32(i32 %3, i32 49)
  %5 = add i32 %smin20, %2
  %.fr27 = freeze i32 %5
  %6 = sub i32 %4, %.fr27
  %7 = urem i32 %6, 50
  ...
  %smin21 = call i32 @llvm.smin.i32(i32 %10, i32 19)
  %12 = add i32 %smin21, %8
  %13 = add i32 %12, %2
  %.fr28 = freeze i32 %13
  %14 = sub i32 %11, %.fr28
  ...
  %smin23 = call i32 @llvm.smin.i32(i32 %19, i32 9)
  %21 = add i32 %smin23, %16
  %22 = add i32 %21, %8
  %23 = add i32 %22, %2
  %.fr29 = freeze i32 %23
  %24 = sub i32 %20, %.fr29
  ...
  %smin26 = call i32 @llvm.smin.i32(i32 %30, i32 4)
  %32 = add i32 %smin26, %26
  %33 = add i32 %32, %16
  %34 = add i32 %33, %8
  %35 = add i32 %34, %2
  %.fr30 = freeze i32 %35
