...
tailrecurse:                                      ; preds = %for.cond58.preheader, %entry
  %indvars.iv78.in = phi i64 [ %indvars.iv78, %for.cond58.preheader ], [ %0, %entry ]
  %sum.tr = phi i32 [ %add, %for.cond58.preheader ], [ %sum, %entry ]
  %indvars.iv78 = add i64 %indvars.iv78.in, -1
  %smax = tail call i64 @llvm.smax.i64(i64 %indvars.iv78, i64 noundef 1)
  %1 = icmp eq i64 %indvars.iv78.in, 1
  br i1 %1, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %2 = trunc nsw i64 %indvars.iv78.in to i32
  %smax60 = tail call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %wide.trip.count41 = zext nneg i32 %smax60 to i64
  %wide.trip.count = and i64 %indvars.iv78.in, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc11
  %indvars.iv38 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next39, %for.inc11 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond14, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx.i = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond, %for.inc33
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc33 ], [ 0, %for.cond ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count41
  br i1 %exitcond53.not, label %for.end35, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18.i = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv48
  %min.3.i3 = load i32, ptr %arrayidx18.i, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc30, %for.body16
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc30 ], [ 0, %for.body16 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond47.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
  %4 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %sub25 = sub nsw i32 %4, %min.3.i3
...
for.cond36:                                       ; preds = %for.inc55, %for.end35
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc55 ], [ 0, %for.end35 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count41
  br i1 %exitcond62.not, label %for.cond58.preheader, label %for.cond39
...
for.cond58.preheader.split:                       ; preds = %for.cond58.preheader
  ...
  %smax80 = tail call i64 @llvm.smax.i64(i64 %6, i64 noundef 1)
  br label %for.cond58

for.cond39:                                       ; preds = %for.cond36, %for.inc52
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc52 ], [ 1, %for.cond36 ]
  %exitcond.not82 = icmp eq i64 %indvars.iv54, %smax
  br i1 %exitcond.not82, label %for.inc55, label %for.inc52

for.inc52:                                        ; preds = %for.cond39
  %indvars.iv.next55 = add nuw i64 %indvars.iv54, 1
  %arrayidx47 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next55, i64 %indvars.iv57
  %7 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !9
  %arrayidx51 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv54, i64 %indvars.iv57
...
for.cond58:                                       ; preds = %for.cond58.preheader.split, %for.end76
  %indvars.iv69 = phi i64 [ 0, %for.cond58.preheader.split ], [ %indvars.iv.next70, %for.end76 ]
  br label %for.cond61

for.cond61:                                       ; preds = %for.cond58, %for.inc74
  %indvars.iv66 = phi i64 [ 1, %for.cond58 ], [ %indvars.iv.next67, %for.inc74 ]
  %exitcond81.not = icmp eq i64 %indvars.iv66, %smax80
  br i1 %exitcond81.not, label %for.end76, label %for.inc74

for.inc74:                                        ; preds = %for.cond61
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %arrayidx69 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv69, i64 %indvars.iv.next67
  %8 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !9
  %arrayidx73 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv69, i64 %indvars.iv66
