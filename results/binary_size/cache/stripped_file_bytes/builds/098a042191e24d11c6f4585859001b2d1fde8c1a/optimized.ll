...
for.body:                                         ; preds = %for.cond
  ...
  %3 = load float, ptr %arrayidx, align 4, !tbaa !9
  %mul12 = fmul float %3, 4.000000e+00
  %4 = load float, ptr %arrayidx4, align 4, !tbaa !9
  %5 = fneg float %4
  %neg = fmul float %mul12, %5
  %6 = call float @llvm.fmuladd.f32(float %2, float %2, float %neg)
  %cmp16 = fcmp ult float %6, 0.000000e+00
  br i1 %cmp16, label %if.else60, label %if.then

if.then:                                          ; preds = %for.body
  %call.i = call noundef float @sqrtf(float noundef %6) #6, !tbaa !5
...
if.else60:                                        ; preds = %for.body
  ...
  %call.i34 = call noundef float @sqrtf(float noundef %7) #6, !tbaa !5
