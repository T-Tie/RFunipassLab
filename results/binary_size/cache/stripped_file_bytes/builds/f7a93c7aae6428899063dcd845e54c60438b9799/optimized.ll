...
for.cond:                                         ; preds = %for.cond.preheader, %for.body
  %indvars.iv59 = phi i32 [ %conv, %for.cond.preheader ], [ %indvars.iv.next60, %for.body ]
...
for.cond18:                                       ; preds = %for.body23, %for.end
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.body23 ], [ %7, %for.end ]
