...
for.cond:                                         ; preds = %for.inc28, %entry
  ...
  %flag.0 = phi i32 [ 0, %entry ], [ %flag.135, %for.inc28 ]
...
if.then9:                                         ; preds = %if.then
  ...
  %gep37 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i8
...
if.then16:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call1.i31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i30)
  ...
  %call19 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #5
  %add20 = add i64 %call19, 1
  br label %if.end24

if.end24:                                         ; preds = %if.end13, %if.then16
  %call.i.i.sink = phi i64 [ %call.i.i, %if.end13 ], [ %call19, %if.then16 ]
  %flag.135 = phi i32 [ 1, %if.end13 ], [ %flag.0, %if.then16 ]
  %lenth.1 = phi i64 [ %add5, %if.end13 ], [ %add20, %if.then16 ]
...
for.cond25:                                       ; preds = %for.body27, %if.end24
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body27 ], [ 0, %if.end24 ]
  %exitcond.not = icmp eq i64 %indvars.iv, 40
  br i1 %exitcond.not, label %for.inc28, label %for.body27
