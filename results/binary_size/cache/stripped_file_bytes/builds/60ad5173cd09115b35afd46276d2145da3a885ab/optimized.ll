...
for.cond2:                                        ; preds = %if.end, %for.body
  ...
  %call4 = call double @sqrt(double noundef %conv3) #8, !tbaa !5
...
if.then:                                          ; preds = %for.body6
  %div = sdiv i32 %2, %3
  %call8 = call noundef i32 @_Z1tii(i32 noundef %div, i32 noundef %3) #8
...
if.end:                                           ; preds = %if.then
  %call = tail call noundef i32 @_Z1tii(i32 noundef %div, i32 noundef %k.0) #9
  br label %if.end5
