...
for.body:                                         ; preds = %for.cond
  ...
  %2 = add i32 %1, -13
  %or.cond11 = icmp ult i32 %2, -12
  br i1 %or.cond11, label %if.then15, label %lor.lhs.false11

lor.lhs.false11:                                  ; preds = %for.body
  %3 = load i32, ptr %m2, align 4, !tbaa !5
  %4 = add i32 %3, -13
  %or.cond12 = icmp ult i32 %4, -12
  br i1 %or.cond12, label %if.then15, label %if.else
