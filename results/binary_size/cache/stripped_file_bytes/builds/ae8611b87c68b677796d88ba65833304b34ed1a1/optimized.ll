...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %count1.0 = phi i32 [ %add, %for.inc ], [ 0, %entry ]
...
while.end15:                                      ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 64, ptr noundef nonnull align 16 captures(none) dereferenceable(64) %temp) #7
  ret i32 0
}
