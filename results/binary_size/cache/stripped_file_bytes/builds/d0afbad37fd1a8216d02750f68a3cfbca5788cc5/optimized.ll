...
if.then:                                          ; preds = %land.lhs.true3
  call void @outlined_ir_func_0() #7
  %call = tail call noundef i32 @_Z5yinziii(i32 noundef %i.0, i32 noundef %div) #8
  br label %if.end
...
for.cond2:                                        ; preds = %if.end, %for.body
  %i.0 = phi i32 [ 2, %for.body ], [ %inc6.i4, %if.end ]
