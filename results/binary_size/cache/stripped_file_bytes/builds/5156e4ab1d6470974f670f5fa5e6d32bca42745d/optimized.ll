...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre62, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv38, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc36
  %indvars.iv46 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next47, %for.inc36 ]
  ...
  br i1 %exitcond52.not, label %for.cond39.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc33
  %indvars.iv41 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next42, %for.inc33 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv46, i64 %indvars.iv41
...
land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %4, i64 %indvars.iv41
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  ...
  %arrayidx31 = getelementptr inbounds [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv46, i64 %8
  ...
  %spec.select34 = select i1 %cmp32.not, i32 %b1.1, i32 %10
  br label %for.inc33
...
for.inc33:                                        ; preds = %land.lhs.true26, %for.body15, %land.lhs.true
  ...
  %b1.2 = phi i32 [ %b1.1, %land.lhs.true ], [ %b1.1, %for.body15 ], [ %spec.select34, %land.lhs.true26 ]
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc67
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc67 ], [ %wide.trip.count, %for.cond39.preheader ]
  %a2.0 = phi i32 [ %a2.1, %for.inc67 ], [ undef, %for.cond39.preheader ]
  %b2.0 = phi i32 [ %b2.1, %for.inc67 ], [ undef, %for.cond39.preheader ]
  %11 = trunc nuw i64 %indvars.iv58 to i32
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc65
  %indvars.iv54 = phi i64 [ %wide.trip.count, %for.cond42.preheader ], [ %indvars.iv.next55, %for.inc65 ]
  %a2.1 = phi i32 [ %a2.0, %for.cond42.preheader ], [ %a2.2, %for.inc65 ]
  %b2.1 = phi i32 [ %b2.0, %for.cond42.preheader ], [ %b2.2, %for.inc65 ]
  %cmp43 = icmp sgt i64 %indvars.iv54, 0
  br i1 %cmp43, label %for.body44, label %for.inc67

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv58, i64 %indvars.iv54
...
land.lhs.true50:                                  ; preds = %for.body44
  %arrayidx54 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %12, i64 %indvars.iv54
...
land.lhs.true56:                                  ; preds = %land.lhs.true50
  %15 = add nuw nsw i64 %indvars.iv54, 1
  %arrayidx61 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv58, i64 %15
  %16 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !13
  %cmp62.not = icmp eq i32 %16, 0
  %spec.select35 = select i1 %cmp62.not, i32 %a2.1, i32 %11
  %17 = trunc nuw nsw i64 %indvars.iv54 to i32
  %spec.select36 = select i1 %cmp62.not, i32 %b2.1, i32 %17
  br label %for.inc65

for.inc65:                                        ; preds = %land.lhs.true56, %for.body44, %land.lhs.true50
  %a2.2 = phi i32 [ %a2.1, %land.lhs.true50 ], [ %a2.1, %for.body44 ], [ %spec.select35, %land.lhs.true56 ]
  %b2.2 = phi i32 [ %b2.1, %land.lhs.true50 ], [ %b2.1, %for.body44 ], [ %spec.select36, %land.lhs.true56 ]
