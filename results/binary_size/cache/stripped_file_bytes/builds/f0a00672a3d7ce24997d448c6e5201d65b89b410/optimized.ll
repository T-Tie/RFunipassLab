...
for.cond:                                         ; preds = %for.inc, %entry
  %len.0 = phi i64 [ 0, %entry ], [ %len.1, %for.inc ]
...
if.then14:                                        ; preds = %if.else
  ...
  %call.i.i11 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %word, i64 noundef %call.i.i11)
  br label %for.inc
...
if.else18:                                        ; preds = %if.else
  ...
  %call.i.i17 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i29, ptr noundef nonnull %word, i64 noundef %call.i.i17)
  %call23 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #6
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else18, %if.then14
