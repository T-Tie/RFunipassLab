...
for.cond:                                         ; preds = %for.body, %entry
  ...
  br i1 %cmp.not.not, label %for.body, label %for.cond6
...
for.cond6:                                        ; preds = %for.cond, %for.inc62
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc62 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp8.not.not = icmp slt i64 %indvars.iv34, %3
  br i1 %cmp8.not.not, label %for.body9, label %for.end64

for.body9:                                        ; preds = %for.cond6
  %arrayidx11 = getelementptr inbounds nuw [1000 x float], ptr %b, i64 0, i64 %indvars.iv34
  %4 = load float, ptr %arrayidx11, align 4, !tbaa !12
  %arrayidx15 = getelementptr inbounds nuw [1000 x float], ptr %a, i64 0, i64 %indvars.iv34
  %5 = load float, ptr %arrayidx15, align 4, !tbaa !12
  %mul16 = fmul float %5, 4.000000e+00
  %arrayidx18 = getelementptr inbounds nuw [1000 x float], ptr %c, i64 0, i64 %indvars.iv34
