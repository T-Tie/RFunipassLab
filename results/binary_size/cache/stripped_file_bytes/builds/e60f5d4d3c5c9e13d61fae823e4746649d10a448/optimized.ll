...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv48 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next49, %for.inc27 ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count52
  br i1 %exitcond53.not, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc21 ], [ 0, %for.cond10 ]
  %exitcond.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv48, i64 %indvars.iv44
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %b.0 = phi i32 [ %7, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %c.0 = phi i32 [ %8, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %sub = add nsw i32 %0, -1
  br label %for.cond30
...
for.end51:                                        ; preds = %for.cond30, %for.body36
  %d.0 = phi i32 [ %i.2, %for.body36 ], [ 0, %for.cond30 ]
  %e.0 = phi i32 [ %j.2, %for.body36 ], [ 0, %for.cond30 ]
  %sub53 = add nsw i32 %d.0, %b.0
  %sub55 = add nsw i32 %e.0, %c.0
