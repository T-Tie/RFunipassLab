...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 88000, ptr noundef nonnull align 16 %stu) #3
  br label %while.cond
...
for.cond:                                         ; preds = %while.cond, %for.inc
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc ], [ %indvars.iv, %while.cond ]
  %cmp24 = icmp sgt i64 %indvars.iv6, 0
  br i1 %cmp24, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, -1
  %arrayidx26 = getelementptr inbounds nuw [1000 x %struct.student], ptr %stu, i64 0, i64 %indvars.iv.next7
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 88000, ptr noundef nonnull %stu) #4
  ret i32 0
}
