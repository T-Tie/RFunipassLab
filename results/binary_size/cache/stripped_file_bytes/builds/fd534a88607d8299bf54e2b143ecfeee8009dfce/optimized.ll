...
for.cond7:                                        ; preds = %for.inc26, %for.end
  ...
  br i1 %exitcond21.not, label %for.cond30.preheader, label %for.body11

for.cond30.preheader:                             ; preds = %for.cond7
  %idxprom36 = zext nneg i32 %sumblank.0 to i64
  %arrayidx37 = getelementptr inbounds nuw [100 x [101 x i8]], ptr %word, i64 0, i64 %idxprom36
  br label %for.cond30

for.body11:                                       ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [101 x i8], ptr %input, i64 0, i64 %indvars.iv17
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc47
  %i29.0 = phi i32 [ %dec, %for.inc47 ], [ %sumblank.0, %for.cond30.preheader ]
...
if.then35:                                        ; preds = %for.body33
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx37)
  br label %for.inc47
...
if.else40:                                        ; preds = %for.body33
  ...
  %idxprom42 = zext nneg i32 %i29.0 to i64
  %arrayidx43 = getelementptr inbounds nuw [100 x [101 x i8]], ptr %word, i64 0, i64 %idxprom42
  %call45 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call41, ptr noundef nonnull %arrayidx43)
  br label %for.inc47

for.inc47:                                        ; preds = %if.then35, %if.else40
