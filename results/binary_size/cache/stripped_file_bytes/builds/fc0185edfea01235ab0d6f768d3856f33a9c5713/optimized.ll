...
for.end:                                          ; preds = %for.cond
  ...
  %call8 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %a) #9
  br label %for.cond11
...
for.body15:                                       ; preds = %for.cond11
  %call16 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %p.0) #8
...
if.then:                                          ; preds = %for.body15
  %call21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, ptr noundef nonnull %p.0) #9
  %call22 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %p.0) #8
  br label %for.inc30

if.end:                                           ; preds = %for.body15
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, ptr noundef nonnull %p.0) #9
  %call25 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %p.0) #8
...
for.end32:                                        ; preds = %for.cond11
  ...
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %add.ptr33) #9
