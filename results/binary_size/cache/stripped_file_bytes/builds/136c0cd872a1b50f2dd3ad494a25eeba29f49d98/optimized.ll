...
for.cond1:                                        ; preds = %for.inc12, %for.body
  ...
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc12 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv64, %2
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv64
  br label %for.cond4
...
for.cond18:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv78 = phi i64 [ 0, %for.cond15 ], [ %indvars.iv.next79, %for.inc56 ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %wide.trip.count81
  br i1 %exitcond82.not, label %for.cond59, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond18
  %add.ptr28 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv78
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv67 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next68, %for.body25 ]
  %min.0 = phi i32 [ 100000, %for.cond22.preheader ], [ %spec.select, %for.body25 ]
  %exitcond.not = icmp eq i64 %indvars.iv67, %wide.trip.count81
...
for.body25:                                       ; preds = %for.cond22
  %add.ptr31 = getelementptr inbounds nuw i32, ptr %add.ptr28, i64 %indvars.iv67
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc53
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc53 ], [ 0, %for.cond42.preheader ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count81
  br i1 %exitcond77.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond42
  %add.ptr51 = getelementptr inbounds nuw i32, ptr %add.ptr28, i64 %indvars.iv73
...
for.cond59:                                       ; preds = %for.cond18, %for.end98
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %for.end98 ], [ 0, %for.cond18 ]
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv119
  br label %for.cond63

for.cond63:                                       ; preds = %for.cond59, %for.body66
  %indvars.iv107 = phi i64 [ 0, %for.cond59 ], [ %indvars.iv.next108, %for.body66 ]
  %min.2 = phi i32 [ 100000, %for.cond59 ], [ %spec.select57, %for.body66 ]
  %exitcond112.not = icmp eq i64 %indvars.iv107, %wide.trip.count81
  br i1 %exitcond112.not, label %for.cond85.preheader, label %for.body66

for.cond85.preheader:                             ; preds = %for.cond63
  br label %for.cond85

for.body66:                                       ; preds = %for.cond63
  %gep = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv107
  %7 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select57 = call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  br label %for.cond63, !llvm.loop !17

for.cond85:                                       ; preds = %for.cond85.preheader, %for.inc96
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc96 ], [ 0, %for.cond85.preheader ]
  %exitcond118.not = icmp eq i64 %indvars.iv113, %wide.trip.count81
  br i1 %exitcond118.not, label %for.end98, label %for.inc96

for.inc96:                                        ; preds = %for.cond85
  %gep59 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv113
  %8 = load i32, ptr %gep59, align 4, !tbaa !5, !invariant.load !13
  %sub95 = sub nsw i32 %8, %min.2
  store i32 %sub95, ptr %gep59, align 4, !tbaa !5
