...
if.then24:                                        ; preds = %if.else22
  %call = tail call noundef i32 @_Z9isRunNiani(i32 noundef %year)
...
for.inc:                                          ; preds = %if.then, %if.else22, %if.else27, %if.then25, %if.then20
  %result.1 = phi i32 [ %add, %if.then ], [ %add21, %if.then20 ], [ %add26, %if.then25 ], [ %add28, %if.else27 ], [ %result.0, %if.else22 ]
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call3 = call noundef i32 @_Z8DijiTianiii(i32 noundef %5, i32 noundef %4, i32 noundef 1)
  %call4 = call noundef i32 @_Z8DijiTianiii(i32 noundef %5, i32 noundef %3, i32 noundef 1)
