...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv27.in = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv27, %for.body15 ]
...
for.body15:                                       ; preds = %for.cond13
  %indvars.iv27 = add nsw i64 %indvars.iv27.in, -1
  %indvars.iv.next25 = add nsw i64 %indvars.iv24, -1
  %arrayidx17 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next25
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv30 = phi i64 [ %indvars.iv27, %for.cond22.preheader ], [ %indvars.iv.next31, %for.inc28 ]
  %cmp23.not.not = icmp slt i64 %indvars.iv30, %6
  br i1 %cmp23.not.not, label %for.inc28, label %for.end33.loopexit

for.inc28:                                        ; preds = %for.cond22
  %indvars.iv.next31 = add nsw i64 %indvars.iv30, 1
  %arrayidx26 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next31
...
for.end33.loopexit:                               ; preds = %for.cond22
  %8 = trunc nsw i64 %indvars.iv.next25 to i32
  %.pre51 = and i64 %indvars.iv.next25, 4294967295
  br label %for.end33

for.end33:                                        ; preds = %for.cond13, %for.end33.loopexit
  %.pre-phi = phi i64 [ %.pre51, %for.end33.loopexit ], [ %4, %for.cond13 ]
  %j.1 = phi i32 [ %8, %for.end33.loopexit ], [ %j.0, %for.cond13 ]
  %9 = add i32 %j.1, -1
  %10 = sext i32 %9 to i64
  br label %for.cond35

for.cond35:                                       ; preds = %for.inc55, %for.end33
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc55 ], [ %.pre-phi, %for.end33 ]
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc55 ], [ %10, %for.end33 ]
  %j.2 = phi i32 [ %j.3, %for.inc55 ], [ %j.1, %for.end33 ]
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, -1
  %indvars = trunc i64 %indvars.iv.next39 to i32
  %11 = trunc nuw i64 %indvars.iv38 to i32
  %cmp36 = icmp sgt i32 %11, 0
  br i1 %cmp36, label %for.body37, label %for.end57

for.body37:                                       ; preds = %for.cond35
  %idxprom38 = and i64 %indvars.iv.next39, 4294967295
...
if.then42:                                        ; preds = %for.body37
  ...
  %13 = sext i32 %j.2 to i64
  br label %for.cond45

for.cond45:                                       ; preds = %for.inc51, %if.then42
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc51 ], [ %indvars.iv33, %if.then42 ]
  %indvars.iv.next36 = add nsw i64 %indvars.iv35, 1
  %cmp46 = icmp slt i64 %indvars.iv.next36, %13
  br i1 %cmp46, label %for.inc51, label %for.inc55

for.inc51:                                        ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next36
...
for.inc55:                                        ; preds = %for.cond45, %for.body37
  %j.3 = phi i32 [ %j.2, %for.body37 ], [ %indvars, %for.cond45 ]
...
for.cond59:                                       ; preds = %for.inc68, %for.end57
  %15 = phi i8 [ %.pre, %for.inc68 ], [ undef, %for.end57 ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc68 ], [ 0, %for.end57 ]
  %cmp63.not = icmp eq i8 %15, 32
  br i1 %cmp63.not, label %if.end83, label %for.inc68

for.inc68:                                        ; preds = %for.cond59
  %call67 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %15)
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %arrayidx61.phi.trans.insert = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next42
  %.pre = load i8, ptr %arrayidx61.phi.trans.insert, align 1, !tbaa !5, !invariant.load !11
...
for.cond74:                                       ; preds = %for.end10, %for.inc80
  ...
  %exitcond50 = icmp eq i64 %indvars.iv45, %wide.trip.count
  br i1 %exitcond50, label %if.end83, label %for.inc80

for.inc80:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv45
  %16 = load i8, ptr %arrayidx78, align 1, !tbaa !5, !invariant.load !11
  %call79 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %16)
