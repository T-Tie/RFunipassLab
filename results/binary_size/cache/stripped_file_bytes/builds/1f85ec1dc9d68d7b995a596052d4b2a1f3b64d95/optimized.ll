...
for.cond:                                         ; preds = %if.end25, %entry
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %if.end25 ], [ 0, %entry ]
  %exitcond36.not = icmp eq i64 %indvars.iv33, 15
  br i1 %exitcond36.not, label %for.end28, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [15 x [15 x i32]], ptr %num, i64 0, i64 %indvars.iv33, i64 %indvars.iv
...
if.then16:                                        ; preds = %for.body3
  ...
  %arrayidx18 = getelementptr inbounds nuw [15 x i32], ptr %w, i64 0, i64 %indvars.iv33
...
for.end:                                          ; preds = %for.body3, %for.cond1, %if.then16
  %arrayidx21 = getelementptr inbounds nuw [15 x [15 x i32]], ptr %num, i64 0, i64 %indvars.iv33
...
for.end28:                                        ; preds = %for.end, %for.cond
  %wide.trip.count49 = and i64 %indvars.iv33, 4294967295
  br label %for.cond29

for.cond29:                                       ; preds = %for.end61, %for.end28
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.end61 ], [ 0, %for.end28 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count49
  br i1 %exitcond50.not, label %for.end67, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw [15 x i32], ptr %w, i64 0, i64 %indvars.iv46
  %3 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !9
  %arrayidx53 = getelementptr inbounds nuw [15 x i32], ptr %doub, i64 0, i64 %indvars.iv46
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc59
  %indvars.iv41 = phi i64 [ 0, %for.cond32.preheader ], [ %indvars.iv.next42, %for.inc59 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.end61, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond32
  %arrayidx49 = getelementptr inbounds nuw [15 x [15 x i32]], ptr %num, i64 0, i64 %indvars.iv46, i64 %indvars.iv41
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %if.end55
  %indvars.iv37 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next38, %if.end55 ]
  %exitcond40.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond40.not, label %for.inc59, label %for.body41

for.body41:                                       ; preds = %for.cond37
  %arrayidx45 = getelementptr inbounds nuw [15 x [15 x i32]], ptr %num, i64 0, i64 %indvars.iv46, i64 %indvars.iv37
