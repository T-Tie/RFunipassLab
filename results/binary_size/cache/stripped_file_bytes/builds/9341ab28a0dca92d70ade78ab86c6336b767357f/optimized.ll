...
for.cond:                                         ; preds = %if.end11, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc27, %if.end11 ]
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %mon1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %mon2) #7
...
if.end11:                                         ; preds = %if.then10, %for.body
  %call21.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(4) @.str)
  %call22.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call21.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
