...
for.cond3:                                        ; preds = %for.cond, %for.inc75
  ...
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc75 ], [ 0, %for.cond ]
  %counter.0 = phi i32 [ %conv72.sink, %for.inc75 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp4 = icmp slt i64 %indvars.iv21, %5
...
if.then:                                          ; preds = %for.body6
  %add.ptr = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv21
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr)
...
if.else:                                          ; preds = %for.body6
  ...
  %add.ptr20 = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv21
...
if.then26:                                        ; preds = %if.else
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
