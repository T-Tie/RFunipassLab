...
for.cond127:                                      ; preds = %for.cond, %for.inc192
  ...
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc192 ], [ 0, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp128 = icmp slt i64 %indvars.iv4, %8
  br i1 %cmp128, label %for.body129, label %for.end194

for.body129:                                      ; preds = %for.cond127
  %arrayidx131 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv4
  %9 = load double, ptr %arrayidx131, align 8, !tbaa !9, !invariant.load !11
  %arrayidx136 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %indvars.iv4
  %10 = load double, ptr %arrayidx136, align 8, !tbaa !9, !invariant.load !11
  %mul137 = fmul double %10, 4.000000e+00
  %arrayidx139 = getelementptr inbounds nuw [100 x double], ptr %c, i64 0, i64 %indvars.iv4
...
if.then143:                                       ; preds = %for.body129
  %arrayidx145 = getelementptr inbounds nuw [100 x double], ptr %x1, i64 0, i64 %indvars.iv4
  %14 = load double, ptr %arrayidx145, align 8, !tbaa !9, !invariant.load !11
  %arrayidx147 = getelementptr inbounds nuw [100 x double], ptr %x2, i64 0, i64 %indvars.iv4
...
if.then163:                                       ; preds = %if.end149
  %arrayidx165 = getelementptr inbounds nuw [100 x double], ptr %x1, i64 0, i64 %indvars.iv4
...
if.then181:                                       ; preds = %if.end167
  %arrayidx183 = getelementptr inbounds nuw [100 x double], ptr %s, i64 0, i64 %indvars.iv4
  %17 = load double, ptr %arrayidx183, align 8, !tbaa !9, !invariant.load !11
  %arrayidx185 = getelementptr inbounds nuw [100 x double], ptr %t, i64 0, i64 %indvars.iv4
