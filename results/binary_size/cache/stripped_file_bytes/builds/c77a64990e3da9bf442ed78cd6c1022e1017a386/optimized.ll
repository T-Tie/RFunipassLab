...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 360, ptr noundef nonnull dereferenceable(360) %num) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(360) %num, i8 noundef 0, i64 noundef 360, i1 noundef false) #6
...
for.body:                                         ; preds = %for.cond
  ...
  %inc.i2 = add nsw i32 %4, 1
  store i32 %inc.i2, ptr %arrayidx13, align 4, !tbaa !5
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 360, ptr noundef nonnull %num) #7
