...
entry:
  ...
  %2 = icmp sgt i32 %1, 0
  %or.cond102 = select i1 %cmp35, i1 %2, i1 false
  br i1 %or.cond102, label %for.cond2.preheader, label %for.end10
...
for.body4:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv
...
for.end10:                                        ; preds = %for.inc8, %entry
  ...
  %or.cond104 = select i1 %cmp1439, i1 %12, i1 false
  br i1 %or.cond104, label %for.cond16.preheader, label %for.cond30.preheader
...
for.cond33.preheader.lr.ph:                       ; preds = %for.cond30.preheader
  ...
  %cmp3741 = icmp sgt i32 %.lcssa, 0
  %or.cond = and i1 %cmp3443, %cmp3741
...
for.cond36.preheader.us.us.us:                    ; preds = %for.cond36.for.inc58_crit_edge.us.us.us, %for.cond33.preheader.us.us
  ...
  %arrayidx42.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv83, i64 %indvars.iv78
...
vector.ph:                                        ; preds = %for.cond36.preheader.us.us.us
  %17 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %arrayidx42.promoted.us.us.us, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv83, i64 %index
  %wide.load = load <4 x i32>, ptr %21, align 16, !tbaa !5
  %22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %index, i64 %indvars.iv78
  %23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %18, i64 %indvars.iv78
  %24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %19, i64 %indvars.iv78
  %25 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %20, i64 %indvars.iv78
...
for.body38.us.us.us.preheader:                    ; preds = %for.cond36.preheader.us.us.us, %middle.block
  ...
  %.ph = phi i32 [ %arrayidx42.promoted.us.us.us, %for.cond36.preheader.us.us.us ], [ %37, %middle.block ]
...
for.body38.us.us.us:                              ; preds = %for.body38.us.us.us.preheader, %for.body38.us.us.us
  ...
  %arrayidx46.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv83, i64 %indvars.iv75
  %39 = load i32, ptr %arrayidx46.us.us.us, align 4, !tbaa !5
  %arrayidx50.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv75, i64 %indvars.iv78
...
for.cond33.for.inc61_crit_edge.split.us.us.us:    ; preds = %for.cond36.for.inc58_crit_edge.us.us.us
  ...
  br i1 %exitcond87.not, label %for.cond67.preheader.preheader, label %for.cond33.preheader.us.us, !llvm.loop !19

for.body18:                                       ; preds = %for.cond16.preheader, %for.body18
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.body18 ], [ 0, %for.cond16.preheader ]
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv72, i64 %indvars.iv69
...
for.cond67.preheader:                             ; preds = %for.cond67.preheader.preheader, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 0, %for.cond67.preheader.preheader ]
  %46 = load i32, ptr %k, align 4, !tbaa !5
  %cmp6854 = icmp sgt i32 %46, 1
...
for.cond67.preheader.for.end78_crit_edge:         ; preds = %for.cond67.preheader
  ...
  %.pre95 = sext i32 %sub53 to i64
  br label %for.end78

for.body69:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.body69 ], [ 0, %for.cond67.preheader ]
  %arrayidx73 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv91, i64 %indvars.iv88
  %47 = load i32, ptr %arrayidx73, align 4, !tbaa !5
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %47)
  ...
  %cmp68 = icmp slt i64 %indvars.iv.next89, %49
...
for.end78:                                        ; preds = %for.body69, %for.cond67.preheader.for.end78_crit_edge
  %idxprom82.pre-phi = phi i64 [ %.pre95, %for.cond67.preheader.for.end78_crit_edge ], [ %49, %for.body69 ]
  %arrayidx83 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv91, i64 %idxprom82.pre-phi
  %50 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %call84 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %50)
  %vtable.i = load ptr, ptr %call84, align 8, !tbaa !23
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call84, i8 noundef signext %retval.0.i.i.i)
  ...
  %cmp65 = icmp slt i64 %indvars.iv.next92, %56
