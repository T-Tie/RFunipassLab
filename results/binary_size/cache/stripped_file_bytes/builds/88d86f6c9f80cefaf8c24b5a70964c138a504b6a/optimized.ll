...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax9 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond10
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc38
  %indvars.iv7 = phi i32 [ %sub, %for.cond10.preheader ], [ %indvars.iv.next8, %for.inc38 ]
  %i.1 = phi i32 [ 0, %for.cond10.preheader ], [ %inc39, %for.inc38 ]
  %exitcond10.not = icmp eq i32 %i.1, %smax9
  br i1 %exitcond10.not, label %for.cond41.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc35
  %indvars.iv4 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next5, %for.inc35 ]
  %exitcond.not = icmp eq i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond.not, label %for.inc38, label %for.body17

for.body17:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv4
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %arrayidx21 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next5
...
for.cond41:                                       ; preds = %for.cond41.preheader, %for.body43
  %indvars.iv11 = phi i64 [ 0, %for.cond41.preheader ], [ %indvars.iv.next12, %for.body43 ]
  %exitcond19.not = icmp eq i64 %indvars.iv11, %wide.trip.count18
  br i1 %exitcond19.not, label %for.end56, label %for.body43

for.body43:                                       ; preds = %for.cond41
  %6 = and i64 %indvars.iv11, 4294967295
  %cmp44 = icmp eq i64 %6, 0
  %spec.select = select i1 %cmp44, ptr @.str, ptr @.str.1
  %arrayidx50 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv11
  %7 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !9
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %7)
