...
for.body:                                         ; preds = %for.cond
  ...
  store double %div5, ptr %y, align 8, !tbaa !5
  %6 = load double, ptr %y, align 8, !tbaa !5
  %7 = load double, ptr %x, align 8, !tbaa !5
  %cmp6 = fcmp ogt double %6, %7
  br i1 %cmp6, label %if.then, label %if.else14

if.then:                                          ; preds = %for.body
  %8 = load double, ptr %y, align 8, !tbaa !5
...
if.else14:                                        ; preds = %for.body
  %10 = load double, ptr %x, align 8, !tbaa !5
  %11 = load double, ptr %y, align 8, !tbaa !5
  %sub15 = fsub double %10, %11
  %cmp16 = fcmp ogt double %sub15, 5.000000e-02
  br i1 %cmp16, label %if.then17, label %if.else20

if.then17:                                        ; preds = %if.else14
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.2)
...
if.else20:                                        ; preds = %if.else14
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
