...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %s) #4
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %b) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 8 %s)
...
for.cond52:                                       ; preds = %for.cond, %for.body57
  %2 = phi i8 [ %.pre, %for.body57 ], [ undef, %for.cond ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body57 ], [ 0, %for.cond ]
...
for.body57:                                       ; preds = %for.cond52
  %arrayidx62 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv9
  %3 = load i8, ptr %arrayidx62, align 1, !tbaa !5, !invariant.load !8
  %cmp64 = icmp eq i8 %2, %3
  %inc66 = zext i1 %cmp64 to i32
  %spec.select = add nuw nsw i32 %j.0, %inc66
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %arrayidx54.phi.trans.insert = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv.next10
  %.pre = load i8, ptr %arrayidx54.phi.trans.insert, align 1, !tbaa !5, !invariant.load !8
...
for.end70:                                        ; preds = %for.cond52
  ...
  %4 = load double, ptr %s, align 8, !tbaa !13
  %cmp73 = fcmp ult double %div, %4
  br i1 %cmp73, label %if.else76, label %if.end80

if.else76:                                        ; preds = %for.end70
  br label %if.end80

if.end80:                                         ; preds = %lor.lhs.false, %for.cond, %for.end70, %entry, %if.else76
  %.str.4.sink = phi ptr [ @.str.4, %if.else76 ], [ @.str.2, %entry ], [ @.str.3, %for.end70 ], [ @.str.2, %for.cond ], [ @.str.2, %lor.lhs.false ]
  %call77 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.4.sink)
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull %a) #6
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %s) #6
  ret i32 0
}
