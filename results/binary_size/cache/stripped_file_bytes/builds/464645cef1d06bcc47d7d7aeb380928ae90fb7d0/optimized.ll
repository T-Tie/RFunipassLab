...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 64, ptr noundef nonnull align 16 captures(none) dereferenceable(64) %temp) #5
  br label %while.cond
...
while.end:                                        ; preds = %while.cond3
  ...
  %call11 = call noundef range(i32 0, -2147483648) i32 @_Z5countPii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(64) %temp, i32 noundef %2) #6
...
while.end15:                                      ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 64, ptr noundef nonnull align 16 dereferenceable(64) %temp) #6
  ret i32 0
}
