...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.cond16
  ...
  %indvars.iv12 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next13, %for.cond16 ]
  %arrayidx22 = getelementptr inbounds nuw [200 x i32], ptr @a, i64 0, i64 %indvars.iv12
  %sub = sub nsw i32 %2, %min.0
  store i32 %sub, ptr %arrayidx22, align 4, !tbaa !8
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %arrayidx22.phi.trans.insert = getelementptr inbounds nuw [200 x i32], ptr @a, i64 0, i64 %indvars.iv.next13
...
for.cond1:                                        ; preds = %for.inc11, %for.body
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc11 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx9 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
