...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %ch) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(40000) %ch, i8 noundef 0, i64 noundef 40000, i1 noundef false) #11
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %p.0 = phi ptr [ %ch, %entry ], [ %incdec.ptr, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ]
...
for.inc:                                          ; preds = %for.cond
  ...
  %1 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %p.0, i1 noundef false, i1 noundef true, i1 noundef false)
  switch i64 %1, label %if.then6.i [
...
if.then6.i:                                       ; preds = %for.inc
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %p.0, i64 noundef %1)
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %2 = load i64, ptr %_M_width.i3.i, align 8, !tbaa !10, !invariant.load !9
  %cmp17.i = icmp slt i64 %2, 1
  %cmp18.i = icmp ult i64 %1, %2
...
while.cond:                                       ; preds = %for.cond, %if.end27
  %3 = phi i32 [ %.pre, %if.end27 ], [ %0, %for.cond ]
...
while.body:                                       ; preds = %while.cond
  ...
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %p.1) #13
  %conv9 = trunc i64 %call8 to i32
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %p.1)
  %incdec.ptr12 = getelementptr inbounds nuw i8, ptr %p.1, i64 40
  br label %if.end27

if.else:                                          ; preds = %while.body
  %4 = add i32 %counter.0, 1
  %conv18 = add i32 %4, %conv9
  %cmp19 = icmp slt i32 %conv18, 81
  br i1 %cmp19, label %if.then20, label %if.else25

if.then20:                                        ; preds = %if.else
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext 32)
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call21, ptr noundef nonnull %p.1)
...
if.end27:                                         ; preds = %if.then20, %if.else25, %if.then
  %p.2 = phi ptr [ %incdec.ptr12, %if.then ], [ %incdec.ptr24, %if.then20 ], [ %p.1, %if.else25 ]
  %counter.1 = phi i32 [ %conv9, %if.then ], [ %conv18, %if.then20 ], [ 0, %if.else25 ]
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %while.cond, !llvm.loop !24

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #12
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %ch) #12
  ret i32 0
}
