...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 404, ptr nonnull %mark) #6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(404) %mark, i8 0, i64 404, i1 false), !tbaa !5
  call void @llvm.lifetime.start.p0(i64 80020, ptr nonnull %num) #6
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp312 = icmp sgt i32 %0, 0
  call void @llvm.assume(i1 %cmp312)
  br label %for.body5

for.cond.cleanup4.loopexit:                       ; preds = %for.body5
  %.pre = load i32, ptr %num, align 16, !tbaa !5
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %.pre)
  %1 = load i32, ptr %num, align 16, !tbaa !5
  %idxprom15 = sext i32 %1 to i64
  %arrayidx16 = getelementptr inbounds [101 x i32], ptr %mark, i64 0, i64 %idxprom15
  store i32 1, ptr %arrayidx16, align 4, !tbaa !5
  %2 = load i32, ptr %n, align 4, !tbaa !5
  %cmp1914 = icmp sgt i32 %2, 0
  br i1 %cmp1914, label %for.body21, label %for.cond.cleanup20

for.body5:                                        ; preds = %entry, %for.body5
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body5 ], [ 0, %entry ]
  %arrayidx7 = getelementptr inbounds nuw [20005 x i32], ptr %num, i64 0, i64 %indvars.iv
  ...
  br i1 %cmp3, label %for.body5, label %for.cond.cleanup4.loopexit, !llvm.loop !9

for.cond.cleanup20:                               ; preds = %for.inc35, %for.cond.cleanup4.loopexit
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !12
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i
  %_M_ctype.i.i = getelementptr inbounds nuw i8, ptr %add.ptr.i, i64 240
  %5 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !14
  %tobool.not.i.i.i = icmp eq ptr %5, null
  br i1 %tobool.not.i.i.i, label %if.then.i.i.i, label %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i

if.then.i.i.i:                                    ; preds = %for.cond.cleanup20
  call void @_ZSt16__throw_bad_castv() #7
  unreachable

_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %for.cond.cleanup20
...
if.then.i2.i.i:                                   ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  ...
  %7 = load i8, ptr %arrayidx.i.i.i, align 1, !tbaa !38
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %retval.0.i.i.i)
  ...
  call void @llvm.lifetime.end.p0(i64 80020, ptr nonnull %num) #6
  call void @llvm.lifetime.end.p0(i64 404, ptr nonnull %mark) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #6
  ret i32 0

for.body21:                                       ; preds = %for.cond.cleanup4.loopexit, %for.inc35
  %9 = phi i32 [ %13, %for.inc35 ], [ %2, %for.cond.cleanup4.loopexit ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc35 ], [ 0, %for.cond.cleanup4.loopexit ]
  %arrayidx23 = getelementptr inbounds nuw [20005 x i32], ptr %num, i64 0, i64 %indvars.iv18
...
if.then:                                          ; preds = %for.body21
  ...
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %12)
  %.pre21 = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc35

for.inc35:                                        ; preds = %for.body21, %if.then
  %13 = phi i32 [ %9, %for.body21 ], [ %.pre21, %if.then ]
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %14 = sext i32 %13 to i64
  %cmp19 = icmp slt i64 %indvars.iv.next19, %14
  br i1 %cmp19, label %for.body21, label %for.cond.cleanup20, !llvm.loop !39
}
