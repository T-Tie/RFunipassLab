...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.end26 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body18 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv17, %9
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.end60
  %indvars.iv32 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next33, %for.end60 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37.not, label %for.cond64.preheader, label %for.cond33
...
for.cond33:                                       ; preds = %for.cond30, %for.end57
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.end57 ], [ 0, %for.cond30 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.end60, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv32, i64 %indvars.iv26
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.body42, %for.body35
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body42 ], [ 0, %for.body35 ]
  %exitcond.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond.not, label %for.end57, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv23
  %11 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !14
  %arrayidx50 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv23, i64 %indvars.iv26
...
for.cond64:                                       ; preds = %for.cond64.preheader, %for.end82
  ...
  %indvars.iv41 = phi i64 [ 0, %for.cond64.preheader ], [ %indvars.iv.next42, %for.end82 ]
  %cmp65 = icmp sgt i32 %13, 0
  br i1 %cmp65, label %for.body66, label %for.end86

for.body66:                                       ; preds = %for.cond64
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %10)
  br label %for.cond71

for.cond71:                                       ; preds = %for.body73, %for.body66
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body73 ], [ 1, %for.body66 ]
  %14 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp72 = icmp sgt i32 %14, 1
  br i1 %cmp72, label %for.body73, label %for.end82

for.body73:                                       ; preds = %for.cond71
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(2) @.str)
  %arrayidx78 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv41, i64 %indvars.iv38
...
for.end82:                                        ; preds = %for.cond71
  %call83 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
