...
for.cond8:                                        ; preds = %for.cond, %if.end29
  %4 = phi i32 [ %.pre, %if.end29 ], [ %0, %for.cond ]
  %m.0 = phi i32 [ %m.1, %if.end29 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %inc31, %if.end29 ], [ 1, %for.cond ]
...
if.end29:                                         ; preds = %if.then, %land.lhs.true, %if.then26, %if.else
