...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef nonnull %a) #4
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp.not, label %for.cond4, label %for.inc
...
for.cond4:                                        ; preds = %for.cond
  ...
  %arrayidx31 = getelementptr inbounds nuw i8, ptr %a, i64 4
  %2 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %2)
