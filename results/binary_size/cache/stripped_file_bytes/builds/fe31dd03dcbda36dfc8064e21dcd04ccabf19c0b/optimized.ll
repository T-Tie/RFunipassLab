; ModuleID = '/tmp/tmpl1h5o1gf.cpp'
source_filename = "/tmp/tmpl1h5o1gf.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41, ptr %c) #11
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 4, ptr %f) #11
  store i32 0, ptr %f, align 4, !tbaa !5
  %arraydecay = getelementptr inbounds [41 x i8], ptr %c, i64 0, i64 0
  ...
  %arraydecay2 = getelementptr inbounds [41 x i8], ptr %c, i64 0, i64 0
  %call3 = call i64 @strlen(ptr noundef %arraydecay2) #12
  %add = add i64 %call3, 1
  %2 = load i32, ptr %s, align 4, !tbaa !5
  %conv = sext i32 %2 to i64
  %add4 = add i64 %conv, %add
  %conv5 = trunc i64 %add4 to i32
  store i32 %conv5, ptr %s, align 4, !tbaa !5
  %3 = load i32, ptr %s, align 4, !tbaa !5
  %cmp6 = icmp sgt i32 %3, 81
...
if.then:                                          ; preds = %for.body
  ...
  store i32 0, ptr %s, align 4, !tbaa !5
  %arraydecay8 = getelementptr inbounds [41 x i8], ptr %c, i64 0, i64 0
  ...
  store i32 %conv13, ptr %s, align 4, !tbaa !5
...
if.then15:                                        ; preds = %if.else
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  br label %if.end
...
if.end17:                                         ; preds = %if.end, %if.then
  ...
  %arraydecay18 = getelementptr inbounds [41 x i8], ptr %c, i64 0, i64 0
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %f) #11
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0(i64 41, ptr %c) #11
