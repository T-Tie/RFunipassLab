...
for.cond:                                         ; preds = %for.inc49, %if.else5
  ...
  %exitcond41.not = icmp eq i32 %i.0, %smax
  br i1 %exitcond41.not, label %for.cond53, label %for.cond7
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc
  %indvars.iv33 = phi i64 [ 0, %for.cond21.preheader ], [ %7, %for.inc ]
  %exitcond40.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond40.not, label %for.inc49, label %for.body24

for.body24:                                       ; preds = %for.cond21
  %arrayidx26 = getelementptr inbounds nuw [1000 x i32], ptr %ans, i64 0, i64 %indvars.iv33
  %6 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %cmp27 = icmp sgt i32 %6, 9
  %7 = add nuw nsw i64 %indvars.iv33, 1
...
if.then28:                                        ; preds = %for.body24
  ...
  %rem22 = urem i32 %6, 10
  store i32 %rem22, ptr %arrayidx26, align 4, !tbaa !5
  br label %for.inc
...
for.cond53:                                       ; preds = %for.cond, %for.inc73
  %indvars.iv42 = phi i64 [ %10, %for.inc73 ], [ 0, %for.cond ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, 1000
  br i1 %exitcond47.not, label %for.end76, label %for.body56

for.body56:                                       ; preds = %for.cond53
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %ans, i64 0, i64 %indvars.iv42
  %9 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !9
  %cmp59 = icmp eq i32 %9, 0
  %10 = add nuw nsw i64 %indvars.iv42, 1
...
for.inc83:                                        ; preds = %for.cond77
  ...
  %15 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !9
