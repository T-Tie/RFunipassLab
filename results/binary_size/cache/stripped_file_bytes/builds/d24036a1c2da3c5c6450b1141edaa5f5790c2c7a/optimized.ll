...
for.cond:                                         ; preds = %while.cond, %if.end5
  %2 = phi i32 [ %.pre, %if.end5 ], [ %1, %while.cond ]
  %indvars.iv27 = phi i32 [ %indvars.iv.next28, %if.end5 ], [ -1, %while.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end5 ], [ 0, %while.cond ]
  %cmp2 = icmp samesign ugt i64 %indvars.iv, 15
  %cmp3 = icmp eq i32 %2, 0
  %or.cond1 = select i1 %cmp2, i1 true, i1 %cmp3
  br i1 %or.cond1, label %for.cond7.preheader, label %if.end5
...
if.end5:                                          ; preds = %for.cond
  ...
  store i32 %2, ptr %arrayidx, align 4, !tbaa !21
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc32
  %indvars.iv23 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next24, %for.inc32 ]
  %cnt.1 = phi i32 [ 0, %for.cond7.preheader ], [ %cnt.2, %for.inc32 ]
  %exitcond.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond.not, label %for.end34, label %for.cond10.preheader

for.cond10.preheader:                             ; preds = %for.cond7
  %4 = sub nsw i64 %3, %indvars.iv23
  %arrayidx15 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv23
  br label %for.cond10

for.cond10:                                       ; preds = %for.cond10.preheader, %for.body13
  %indvars.iv19 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next20, %for.body13 ]
  %cnt.2 = phi i32 [ %cnt.1, %for.cond10.preheader ], [ %cnt.3, %for.body13 ]
  %cmp12 = icmp slt i64 %indvars.iv19, %4
  br i1 %cmp12, label %for.body13, label %for.inc32

for.body13:                                       ; preds = %for.cond10
  %5 = load i32, ptr %arrayidx15, align 4, !tbaa !21
  %6 = add nuw nsw i64 %indvars.iv19, %indvars.iv23
  %arrayidx17 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %6
  %7 = load i32, ptr %arrayidx17, align 4, !tbaa !21
  %mul = shl nsw i32 %7, 1
  %cmp18 = icmp eq i32 %5, %mul
  %mul24 = shl nsw i32 %5, 1
  %cmp25 = icmp eq i32 %7, %mul24
  %or.cond = select i1 %cmp18, i1 true, i1 %cmp25
  %inc27 = zext i1 %or.cond to i32
  %cnt.3 = add nsw i32 %cnt.2, %inc27
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond10, !llvm.loop !25

for.inc32:                                        ; preds = %for.cond10
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond7, !llvm.loop !26

for.end34:                                        ; preds = %for.cond7
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %cnt.1)
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call35, i8 noundef signext %call.i17)
