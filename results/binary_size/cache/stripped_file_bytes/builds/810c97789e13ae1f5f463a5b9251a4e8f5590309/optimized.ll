...
while.end25:                                      ; preds = %while.cond
  ...
  call void @outlined_ir_func_0(i32 %7)
  ...
  call void @outlined_ir_func_0(i32 %10)
...
newFuncRoot:
  br label %while.end25_to_outline

while.end25_to_outline:                           ; preds = %newFuncRoot
  ...
  br label %while.end25_after_outline.exitStub

while.end25_after_outline.exitStub:               ; preds = %while.end25_to_outline
  ret void
}
