...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc10 ], [ 1, %entry ]
  %sub = add nsw i32 %0, -1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv5, i64 %indvars.iv
  %4 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !9
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv5, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond17, %for.cond
  ...
  %indvars.iv11 = phi i64 [ 1, %for.cond ], [ %indvars.iv.next12, %for.cond17 ]
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc29
  %6 = phi i32 [ %5, %for.cond17.preheader ], [ %.pre14, %for.inc29 ]
  %indvars.iv8 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next9, %for.inc29 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv8, %7
  br i1 %cmp18, label %for.inc29, label %for.cond13

for.inc29:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv8, i64 %indvars.iv.next12
  %8 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv8, i64 %indvars.iv11
...
for.inc:                                          ; preds = %for.cond6
  %arrayidx11 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
