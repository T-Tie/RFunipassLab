...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.end ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv70, %2
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv70
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.end148
  %indvars.iv127 = phi i64 [ %6, %for.cond14.preheader ], [ %indvars.iv.next128, %for.end148 ]
  %indvars.iv124 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next125, %for.end148 ]
  %sum.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.end148 ]
  %9 = trunc nuw i64 %indvars.iv127 to i32
  %cmp15 = icmp sgt i32 %9, 1
  br i1 %cmp15, label %for.cond17, label %for.end150

for.cond17:                                       ; preds = %for.cond14, %for.end52
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.end52 ], [ 1, %for.cond14 ]
  %exitcond88 = icmp eq i64 %indvars.iv84, %indvars.iv124
  br i1 %exitcond88, label %for.cond56, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond17
  %add.ptr24 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv84
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.body22
  %indvars.iv73 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next74, %for.body22 ]
  %min.0 = phi i32 [ 100000, %for.cond20.preheader ], [ %spec.select, %for.body22 ]
  %exitcond = icmp eq i64 %indvars.iv73, %indvars.iv124
...
for.body22:                                       ; preds = %for.cond20
  %add.ptr27 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv73
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv79 = phi i64 [ 1, %for.cond37.preheader ], [ %indvars.iv.next80, %for.body39 ]
  %exitcond83 = icmp eq i64 %indvars.iv79, %indvars.iv124
  br i1 %exitcond83, label %for.end52, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %add.ptr44 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv79
...
for.cond56:                                       ; preds = %for.cond17, %for.end94
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.end94 ], [ 1, %for.cond17 ]
  %exitcond103 = icmp eq i64 %indvars.iv99, %indvars.iv124
  br i1 %exitcond103, label %for.cond101, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv99
  br label %for.cond59

for.cond59:                                       ; preds = %for.cond59.preheader, %for.body61
  %indvars.iv89 = phi i64 [ 1, %for.cond59.preheader ], [ %indvars.iv.next90, %for.body61 ]
  %min.2 = phi i32 [ 100000, %for.cond59.preheader ], [ %spec.select64, %for.body61 ]
  %exitcond93 = icmp eq i64 %indvars.iv89, %indvars.iv124
  br i1 %exitcond93, label %for.cond78.preheader, label %for.body61

for.cond78.preheader:                             ; preds = %for.cond59
  br label %for.cond78

for.body61:                                       ; preds = %for.cond59
  %gep = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv89
  %12 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select64 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  br label %for.cond59, !llvm.loop !17

for.cond78:                                       ; preds = %for.cond78.preheader, %for.body80
  %indvars.iv94 = phi i64 [ 1, %for.cond78.preheader ], [ %indvars.iv.next95, %for.body80 ]
  %exitcond98 = icmp eq i64 %indvars.iv94, %indvars.iv124
  br i1 %exitcond98, label %for.end94, label %for.body80

for.body80:                                       ; preds = %for.cond78
  %gep66 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv94
  %13 = load i32, ptr %gep66, align 4, !tbaa !5, !invariant.load !13
  %sub86 = sub nsw i32 %13, %min.2
  store i32 %sub86, ptr %gep66, align 4, !tbaa !5
...
for.cond101:                                      ; preds = %for.cond56, %for.end121
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.end121 ], [ 2, %for.cond56 ]
  %exitcond113.not = icmp eq i64 %indvars.iv109, %indvars.iv127
  br i1 %exitcond113.not, label %for.cond125, label %for.cond105.preheader

for.cond105.preheader:                            ; preds = %for.cond101
  %add.ptr109 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv109
  %add.ptr110 = getelementptr inbounds nuw i8, ptr %add.ptr109, i64 440
  br label %for.cond105

for.cond105:                                      ; preds = %for.cond105.preheader, %for.body107
  %indvars.iv104 = phi i64 [ 1, %for.cond105.preheader ], [ %indvars.iv.next105, %for.body107 ]
  %exitcond108 = icmp eq i64 %indvars.iv104, %indvars.iv124
  br i1 %exitcond108, label %for.end121, label %for.body107

for.body107:                                      ; preds = %for.cond105
  %add.ptr113 = getelementptr inbounds nuw i32, ptr %add.ptr110, i64 %indvars.iv104
  %14 = load i32, ptr %add.ptr113, align 4, !tbaa !5, !invariant.load !13
  %add.ptr118 = getelementptr inbounds nuw i32, ptr %add.ptr109, i64 %indvars.iv104
...
for.cond125:                                      ; preds = %for.cond101, %for.end145
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %for.end145 ], [ 2, %for.cond101 ]
  %exitcond123.not = icmp eq i64 %indvars.iv119, %indvars.iv127
  br i1 %exitcond123.not, label %for.end148, label %for.cond129.preheader

for.cond129.preheader:                            ; preds = %for.cond125
  %invariant.gep67 = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv119
  br label %for.cond129

for.cond129:                                      ; preds = %for.cond129.preheader, %for.body131
  %indvars.iv114 = phi i64 [ 1, %for.cond129.preheader ], [ %indvars.iv.next115, %for.body131 ]
  %exitcond118 = icmp eq i64 %indvars.iv114, %indvars.iv124
  br i1 %exitcond118, label %for.end145, label %for.body131

for.body131:                                      ; preds = %for.cond129
  %gep68 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep67, i64 %indvars.iv114
  %add.ptr137 = getelementptr inbounds nuw i8, ptr %gep68, i64 4
  %15 = load i32, ptr %add.ptr137, align 4, !tbaa !5, !invariant.load !13
  store i32 %15, ptr %gep68, align 4, !tbaa !5
