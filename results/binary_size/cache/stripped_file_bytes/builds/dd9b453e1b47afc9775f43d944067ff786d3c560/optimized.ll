...
for.cond18:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv79 = phi i64 [ 0, %for.cond15 ], [ %indvars.iv.next80, %for.inc56 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %wide.trip.count82
  br i1 %exitcond83.not, label %for.cond59, label %for.cond22.preheader
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  ...
  %exitcond.not = icmp eq i64 %indvars.iv68, %wide.trip.count82
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc53
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc53 ], [ 0, %for.cond42.preheader ]
...
for.cond59:                                       ; preds = %for.cond18, %for.end98
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.end98 ], [ 0, %for.cond18 ]
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv120
  br label %for.cond63

for.cond63:                                       ; preds = %for.cond59, %for.body66
  %indvars.iv108 = phi i64 [ 0, %for.cond59 ], [ %indvars.iv.next109, %for.body66 ]
  %min.2 = phi i32 [ 100000, %for.cond59 ], [ %spec.select58, %for.body66 ]
  %exitcond113.not = icmp eq i64 %indvars.iv108, %wide.trip.count82
  br i1 %exitcond113.not, label %for.cond85.preheader, label %for.body66

for.cond85.preheader:                             ; preds = %for.cond63
  br label %for.cond85

for.body66:                                       ; preds = %for.cond63
  %gep = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv108
  %7 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select58 = call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next109 = add nuw nsw i64 %indvars.iv108, 1
  br label %for.cond63, !llvm.loop !17

for.cond85:                                       ; preds = %for.cond85.preheader, %for.inc96
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc96 ], [ 0, %for.cond85.preheader ]
  %exitcond119.not = icmp eq i64 %indvars.iv114, %wide.trip.count82
  br i1 %exitcond119.not, label %for.end98, label %for.inc96

for.inc96:                                        ; preds = %for.cond85
  %gep60 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv114
  %8 = load i32, ptr %gep60, align 4, !tbaa !5, !invariant.load !13
  %sub95 = sub nsw i32 %8, %min.2
  store i32 %sub95, ptr %gep60, align 4, !tbaa !5
