...
for.cond14:                                       ; preds = %for.cond, %if.end57
  %.pre1516 = phi i32 [ %.pre15, %if.end57 ], [ %4, %for.cond ]
  %i.2 = phi i32 [ %inc.i10, %if.end57 ], [ 0, %for.cond ]
  %cmp15 = icmp slt i32 %i.2, %.pre1516
  br i1 %cmp15, label %if.else, label %for.end60

if.else:                                          ; preds = %for.cond14
  %sub38 = add nsw i32 %.pre1516, -1
...
if.end57.loopexit:                                ; preds = %for.cond41
  %.pre15.pre = load i32, ptr %m, align 4, !tbaa !5
  br label %if.end57

if.end57:                                         ; preds = %if.end57.loopexit, %if.else
  %.pre15 = phi i32 [ %.pre15.pre, %if.end57.loopexit ], [ %.pre1516, %if.else ]
  %inc.i10 = add nuw nsw i32 %i.2, 1
  br label %for.cond14
