...
if.end:                                           ; preds = %if.then, %while.body
  %.pr = phi i32 [ %1, %if.then ], [ %2, %while.body ]
  %3 = phi i32 [ %2, %if.then ], [ %1, %while.body ]
  ...
  %or.cond10 = or i1 %cmp8, %or.cond
  %cmp23 = icmp slt i32 %3, 3
  %cmp25 = icmp sgt i32 %.pr, 2
  %or.cond11 = and i1 %cmp25, %cmp23
  %spec.select = select i1 %or.cond11, ptr @.str.1, ptr @.str
  %.str.1.sink = select i1 %or.cond10, ptr @.str, ptr %spec.select
  %call33.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str.1.sink)
  %call34.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call33.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
