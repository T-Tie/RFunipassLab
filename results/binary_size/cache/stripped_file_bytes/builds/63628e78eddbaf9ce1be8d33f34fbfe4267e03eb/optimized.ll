...
if.end:                                           ; preds = %if.then, %for.body
  %d.1 = phi i32 [ %inc, %if.then ], [ %d.0, %for.body ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.cond11:                                       ; preds = %for.cond11.preheader, %for.end34
  %indvars.iv11 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next12, %for.end34 ]
...
for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv11
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %if.end31
  %indvars.iv13 = phi i64 [ %indvars.iv11, %for.cond14.preheader ], [ %indvars.iv.next14, %if.end31 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv.next14
...
for.cond38:                                       ; preds = %for.cond11, %for.body41
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body41 ], [ 0, %for.cond11 ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21.not, label %for.end48, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv17
