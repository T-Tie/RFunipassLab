...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 800, ptr nonnull %used) #3
  br label %for.cond
...
for.cond1:                                        ; preds = %for.body3, %for.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body3 ], [ 0, %for.end ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp2 = icmp slt i64 %indvars.iv12, %1
  br i1 %cmp2, label %for.body3, label %for.end9

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv12
...
for.cond15:                                       ; preds = %for.inc30, %for.end9
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc30 ], [ 1, %for.end9 ]
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp16 = icmp slt i64 %indvars.iv15, %5
  br i1 %cmp16, label %for.body17, label %for.end32

for.body17:                                       ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv15
...
for.end32:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 800, ptr nonnull %used) #3
