...
@linelen = dso_local global i32 0, align 4
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %cnt) #11
  store i32 0, ptr %cnt, align 4, !tbaa !5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef @b)
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @b)
  %call3 = call i64 @strlen(ptr noundef @b) #12
  %conv = trunc i64 %call3 to i32
  store i32 %conv, ptr %k, align 4, !tbaa !5
  %0 = load i32, ptr %k, align 4, !tbaa !5
  store i32 %0, ptr @linelen, align 4, !tbaa !5
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef @a)
  %call5 = call i64 @strlen(ptr noundef @a) #12
  %conv6 = trunc i64 %call5 to i32
  store i32 %conv6, ptr @num, align 4, !tbaa !5
  %1 = load i32, ptr @linelen, align 4, !tbaa !5
  %cmp = icmp eq i32 %1, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call7, ptr noundef @a)
  %2 = load i32, ptr %cnt, align 4, !tbaa !5
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr %cnt, align 4, !tbaa !5
  %3 = load i32, ptr @linelen, align 4, !tbaa !5
  %4 = load i32, ptr @num, align 4, !tbaa !5
  %add = add nsw i32 %3, %4
  store i32 %add, ptr @linelen, align 4, !tbaa !5
  br label %if.end34

if.else:                                          ; preds = %while.body
  %5 = load i32, ptr @num, align 4, !tbaa !5
  %6 = load i32, ptr @linelen, align 4, !tbaa !5
  %add9 = add nsw i32 %5, %6
  %add10 = add nsw i32 %add9, 1
  %cmp11 = icmp sgt i32 %add10, 80
...
if.then12:                                        ; preds = %if.else
  ...
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call13, ptr noundef @a)
  %7 = load i32, ptr %cnt, align 4, !tbaa !5
  %inc15 = add nsw i32 %7, 1
  store i32 %inc15, ptr %cnt, align 4, !tbaa !5
  %8 = load i32, ptr @num, align 4, !tbaa !5
  store i32 %8, ptr @linelen, align 4, !tbaa !5
  br label %if.end30

if.else16:                                        ; preds = %if.else
  %9 = load i32, ptr @num, align 4, !tbaa !5
  %10 = load i32, ptr @linelen, align 4, !tbaa !5
  %add17 = add nsw i32 %9, %10
  %add18 = add nsw i32 %add17, 1
  %cmp19 = icmp eq i32 %add18, 80
...
if.then20:                                        ; preds = %if.else16
  ...
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call21, ptr noundef @a)
  %11 = load i32, ptr %cnt, align 4, !tbaa !5
  %inc23 = add nsw i32 %11, 1
  store i32 %inc23, ptr %cnt, align 4, !tbaa !5
  store i32 0, ptr @linelen, align 4, !tbaa !5
  br label %if.end

if.else24:                                        ; preds = %if.else16
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call25, ptr noundef @a)
  %12 = load i32, ptr %cnt, align 4, !tbaa !5
  %inc27 = add nsw i32 %12, 1
  store i32 %inc27, ptr %cnt, align 4, !tbaa !5
  %13 = load i32, ptr @linelen, align 4, !tbaa !5
  %14 = load i32, ptr @num, align 4, !tbaa !5
  %add28 = add nsw i32 %13, %14
  %add29 = add nsw i32 %add28, 1
  store i32 %add29, ptr @linelen, align 4, !tbaa !5
  br label %if.end
...
while.end:                                        ; preds = %if.then32
  call void @llvm.lifetime.end.p0(i64 4, ptr %cnt) #11
