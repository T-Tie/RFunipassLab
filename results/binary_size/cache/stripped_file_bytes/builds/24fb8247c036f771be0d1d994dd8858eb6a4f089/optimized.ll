...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.inc25, %for.end9
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc25 ], [ 0, %for.end9 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp12 = icmp slt i64 %indvars.iv34, %5
  br i1 %cmp12, label %for.cond14, label %for.cond28

for.cond14:                                       ; preds = %for.cond11, %for.body16
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body16 ], [ 0, %for.cond11 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp15 = icmp slt i64 %indvars.iv31, %7
  br i1 %cmp15, label %for.body16, label %for.inc25

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv34, i64 %indvars.iv31
...
for.cond28:                                       ; preds = %for.cond11, %for.end65
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.end65 ], [ 0, %for.cond11 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp29 = icmp slt i64 %indvars.iv43, %9
  br i1 %cmp29, label %for.cond31, label %for.end69

for.cond31:                                       ; preds = %for.cond28, %for.end51
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.end51 ], [ 0, %for.cond28 ]
  %10 = load i32, ptr %y2, align 4, !tbaa !5
  %11 = sext i32 %10 to i64
  %cmp32 = icmp slt i64 %indvars.iv40, %11
...
for.cond34.preheader:                             ; preds = %for.cond31
  ...
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv43, i64 %indvars.iv40
  %smax = call i32 @llvm.smax.i32(i32 %12, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv37 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next38, %for.body36 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond.not, label %for.end51, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv37
  %13 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv37, i64 %indvars.iv40
...
for.end51:                                        ; preds = %for.cond34
  ...
  %cmp52 = icmp eq i64 %indvars.iv40, %16
  %17 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %.str.1..str.2 = select i1 %cmp52, ptr @.str.1, ptr @.str.2
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.1..str.2, i32 noundef %17)
