...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 15000, ptr noundef nonnull dereferenceable(15000) %a) #9
...
for.cond3:                                        ; preds = %for.cond, %for.inc75
  %4 = phi i32 [ %.pre, %for.inc75 ], [ %0, %for.cond ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc75 ], [ 0, %for.cond ]
  %counter.0 = phi i32 [ %conv72.sink, %for.inc75 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp4 = icmp slt i64 %indvars.iv24, %5
  br i1 %cmp4, label %for.body6, label %for.end77
...
if.then:                                          ; preds = %for.body6
  %add.ptr = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv24
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr)
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr) #11
  br label %for.inc75.gvnsink.split

if.else:                                          ; preds = %for.body6
  %conv17 = sext i32 %counter.0 to i64
  %add.ptr20 = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv24
  %call22 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr20) #11
...
if.then26:                                        ; preds = %if.else
  ...
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call27, ptr noundef nonnull %add.ptr20)
  %call37 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr20) #11
...
if.then52:                                        ; preds = %if.else42
  %call53 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(2) @.str)
  %call58 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call53, ptr noundef nonnull %add.ptr20)
...
if.else60:                                        ; preds = %if.else42
  %call61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call66 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call61, ptr noundef nonnull %add.ptr20)
  %call71 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr20) #11
  %conv72 = trunc i64 %call71 to i32
  br label %for.inc75

for.inc75.gvnsink.split:                          ; preds = %if.then, %if.then26
  %add38.sink = phi i64 [ %add38, %if.then26 ], [ %call15, %if.then ]
  %6 = trunc i64 %add38.sink to i32
  %conv41 = add i32 %counter.0, %6
  br label %for.inc75

for.inc75:                                        ; preds = %for.inc75.gvnsink.split, %if.then52, %if.else60
  %conv72.sink = phi i32 [ %conv72, %if.else60 ], [ 0, %if.then52 ], [ %conv41, %for.inc75.gvnsink.split ]
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond3, !llvm.loop !24

for.end77:                                        ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 15000, ptr noundef nonnull %a) #10
