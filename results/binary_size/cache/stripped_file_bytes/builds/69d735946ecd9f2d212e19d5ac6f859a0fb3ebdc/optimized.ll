...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %0 = load i64, ptr %_M_width.i6.i, align 8, !tbaa !9, !invariant.load !8
  %1 = add i64 %0, -257
...
if.then6.i14:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i19 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
  br i1 %call16.i19, label %land.lhs.true.i20, label %if.then6.i41

land.lhs.true.i20:                                ; preds = %if.then6.i14
  %_M_width.i6.i21 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i6.i21, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
...
if.then19.i25:                                    ; preds = %land.lhs.true.i20
  %call24.i26 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
if.then6.i41:                                     ; preds = %if.then28.i32, %if.then19.i25, %land.lhs.true.i20, %if.then6.i14
  ...
  %call16.i46 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
land.lhs.true.i47:                                ; preds = %if.then6.i41
  %_M_width.i6.i48 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i6.i48, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
...
if.then19.i52:                                    ; preds = %land.lhs.true.i47
  %call24.i53 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
