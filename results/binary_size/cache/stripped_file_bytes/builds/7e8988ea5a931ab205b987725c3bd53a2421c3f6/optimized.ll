...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.end26 ], [ 0, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %cmp14 = icmp sgt i32 %3, 0
  br i1 %cmp14, label %for.cond16, label %for.cond61
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  ...
  %5 = sext i32 %4 to i64
  %cmp17 = icmp slt i64 %indvars.iv27, %5
...
for.cond61:                                       ; preds = %for.cond64, %for.cond13
  %6 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp62 = icmp sgt i32 %6, 0
  br i1 %cmp62, label %for.cond64, label %for.end87

for.cond64:                                       ; preds = %for.cond61, %for.inc82
  %z.0 = phi i32 [ %inc83, %for.inc82 ], [ 0, %for.cond61 ]
  %7 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp65 = icmp slt i32 %z.0, %7
  br i1 %cmp65, label %for.body66, label %for.cond61

for.body66:                                       ; preds = %for.cond64
  %sub = add nsw i32 %7, -1
  %cmp67 = icmp eq i32 %z.0, %sub
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 undef)
...
if.else:                                          ; preds = %for.body66
  %call80 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call73, ptr noundef nonnull dereferenceable(2) @.str)
  br label %for.inc82

for.inc82:                                        ; preds = %if.then68, %if.else
  %inc83 = add nuw nsw i32 %z.0, 1
