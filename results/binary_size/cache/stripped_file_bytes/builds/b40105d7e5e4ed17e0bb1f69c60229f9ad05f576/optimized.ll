...
for.cond11:                                       ; preds = %for.end24, %for.end9
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.end24 ], [ 0, %for.end9 ]
...
for.cond14:                                       ; preds = %for.cond11, %for.body16
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body16 ], [ 0, %for.cond11 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv28, i64 %indvars.iv25
...
for.cond31:                                       ; preds = %for.cond28, %for.cond34.preheader
  %j.2 = phi i32 [ %inc8.i7, %for.cond34.preheader ], [ 0, %for.cond28 ]
...
for.cond34.preheader:                             ; preds = %for.cond31
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 undef) #8
  %inc8.i7 = add nuw nsw i32 %j.2, 1
  br label %for.cond31
