...
for.cond1:                                        ; preds = %for.inc12, %for.cond
  ...
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv26, %2
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv
...
while.cond:                                       ; preds = %while.cond.preheader, %for.cond17
  %indvars.iv35 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next36, %for.cond17 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.cond17 ]
  %cmp15 = icmp sgt i32 %indvars.iv35, 1
...
for.cond17:                                       ; preds = %while.cond
  ...
  store i32 %indvars.iv.next36, ptr %n, align 4, !tbaa !5
