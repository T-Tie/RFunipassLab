...
land.lhs.true.i:                                  ; preds = %entry
  %_M_width.i9.i = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %0 = load i64, ptr %_M_width.i9.i, align 8, !tbaa !9, !invariant.load !8
  %1 = add i64 %0, -258
...
if.then6.i13:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i18 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
  br i1 %call16.i18, label %land.lhs.true.i19, label %if.then6.i40

land.lhs.true.i19:                                ; preds = %if.then6.i13
  %_M_width.i9.i20 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i9.i20, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -258
  %or.cond.i23 = icmp ult i64 %3, -257
  br i1 %or.cond.i23, label %if.then19.i24, label %if.then6.i40

if.then19.i24:                                    ; preds = %land.lhs.true.i19
  %call24.i25 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
  ...
  %expval.i29 = call i64 @llvm.expect.i64(i64 noundef %conv.i28, i64 noundef 1)
...
if.then6.i40:                                     ; preds = %if.then28.i31, %if.then19.i24, %land.lhs.true.i19, %if.then6.i13
  ...
  %call16.i45 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
land.lhs.true.i46:                                ; preds = %if.then6.i40
  %_M_width.i9.i47 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i9.i47, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -258
  %or.cond.i50 = icmp ult i64 %5, -257
...
if.then19.i51:                                    ; preds = %land.lhs.true.i46
  %call24.i52 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit59
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit59, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit59 ]
