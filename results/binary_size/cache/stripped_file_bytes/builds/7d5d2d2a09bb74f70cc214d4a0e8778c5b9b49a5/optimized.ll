...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body39 ], [ 0, %for.cond36.preheader ]
...
for.cond94:                                       ; preds = %for.cond94.preheader, %for.body97
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body97 ], [ 0, %for.cond94.preheader ]
...
for.cond3.preheader:                              ; preds = %for.cond
  ...
  tail call void @llvm.assume(i1 noundef %cmp5) #10
  ret void
