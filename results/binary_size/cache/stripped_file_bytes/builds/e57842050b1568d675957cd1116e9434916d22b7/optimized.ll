...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc23 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv8, i64 %indvars.iv
  ...
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv8, i64 %indvars.iv
  store i32 %5, ptr %arrayidx14, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc53
  %indvars.iv14 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next15, %for.inc53 ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond56.preheader, label %for.cond29
...
for.cond29:                                       ; preds = %for.cond26, %for.inc50
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc50 ], [ 0, %for.cond26 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.inc53, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv14, i64 %indvars.iv11
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %arrayidx39 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv14, i64 %indvars.iv.next12
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc78
  %indvars.iv27 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next28, %for.inc78 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count19
  br i1 %exitcond31.not, label %for.cond81.preheader, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %arrayidx69 = getelementptr inbounds [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv27, i64 %idxprom68
  %arrayidx73 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv27
  br label %for.cond59
...
for.cond59:                                       ; preds = %for.cond59.preheader, %for.inc75
  %indvars.iv21 = phi i64 [ 0, %for.cond59.preheader ], [ %indvars.iv.next22, %for.inc75 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.inc78, label %for.body61

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv27, i64 %indvars.iv21
...
if.then71:                                        ; preds = %for.body61
  %10 = trunc nuw nsw i64 %indvars.iv21 to i32
...
for.cond81:                                       ; preds = %for.cond81.preheader, %for.inc111
  %indvars.iv37 = phi i64 [ 0, %for.cond81.preheader ], [ %indvars.iv.next38, %for.inc111 ]
  %exitcond42.not = icmp eq i64 %indvars.iv37, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond114.preheader, label %for.cond84
...
for.cond84:                                       ; preds = %for.cond81, %for.body86
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body86 ], [ 0, %for.cond81 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count19
  br i1 %exitcond36.not, label %for.inc111, label %for.body86

for.body86:                                       ; preds = %for.cond84
  %arrayidx90 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv32, i64 %indvars.iv37
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %arrayidx95 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv.next33, i64 %indvars.iv37
...
for.cond114:                                      ; preds = %for.cond114.preheader, %for.inc137
  %indvars.iv48 = phi i64 [ 0, %for.cond114.preheader ], [ %indvars.iv.next49, %for.inc137 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count41
  br i1 %exitcond52.not, label %for.cond140, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %arrayidx128 = getelementptr inbounds [8 x [8 x i32]], ptr %bj, i64 0, i64 %idxprom125, i64 %indvars.iv48
  %arrayidx132 = getelementptr inbounds nuw [8 x i32], ptr %hd, i64 0, i64 %indvars.iv48
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc134
  %indvars.iv43 = phi i64 [ 0, %for.cond117.preheader ], [ %indvars.iv.next44, %for.inc134 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count19
  br i1 %exitcond47.not, label %for.inc137, label %for.body119

for.body119:                                      ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
...
for.cond140:                                      ; preds = %for.cond114, %for.inc150
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc150 ], [ 0, %for.cond114 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count19
  br i1 %exitcond57.not, label %for.end152, label %for.body142

for.body142:                                      ; preds = %for.cond140
  %arrayidx144 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv53
  ...
  %cmp147 = icmp eq i64 %indvars.iv53, %18
  br i1 %cmp147, label %if.then148, label %for.inc150

if.then148:                                       ; preds = %for.body142
  %19 = trunc nuw nsw i64 %indvars.iv53 to i32
