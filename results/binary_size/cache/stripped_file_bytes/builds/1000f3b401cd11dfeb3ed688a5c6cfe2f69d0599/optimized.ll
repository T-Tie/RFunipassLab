...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  ...
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv43, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax53 = call i32 @llvm.smax.i32(i32 %7, i32 0)
  %smax59 = call i32 @llvm.smax.i32(i32 %6, i32 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  ...
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv40, %9
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc65
  %indvars.iv56 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next57, %for.inc65 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count60
  br i1 %exitcond61.not, label %while.cond, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc62
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc62 ], [ 0, %for.cond30 ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count54
  br i1 %exitcond55.not, label %for.inc65, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv50
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.body42, %for.body35
  %10 = phi i32 [ %add, %for.body42 ], [ 0, %for.body35 ]
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body42 ], [ 0, %for.body35 ]
  %exitcond.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond.not, label %for.inc62, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx50 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv56, i64 %indvars.iv46
  %11 = load i32, ptr %arrayidx50, align 4, !tbaa !5
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv46, i64 %indvars.iv50
...
while.cond:                                       ; preds = %for.cond30, %for.end80
  %13 = phi i32 [ %.pre, %for.end80 ], [ %6, %for.cond30 ]
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.end80 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp68 = icmp slt i64 %indvars.iv65, %14
  br i1 %cmp68, label %for.cond69, label %while.end

for.cond69:                                       ; preds = %while.cond, %for.body71
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body71 ], [ 0, %while.cond ]
  %15 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %15, -1
  %16 = sext i32 %sub to i64
  %cmp70 = icmp slt i64 %indvars.iv62, %16
  br i1 %cmp70, label %for.body71, label %for.end80

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 %indvars.iv62
  %17 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %call76 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %17)
...
for.end80:                                        ; preds = %for.cond69
  %arrayidx85 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 %16
  %18 = load i32, ptr %arrayidx85, align 4, !tbaa !5
  %call86 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %18)
  %vtable.i = load ptr, ptr %call86, align 8, !tbaa !19
  ...
  %call1.i34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call86, i8 noundef signext %call.i33)
