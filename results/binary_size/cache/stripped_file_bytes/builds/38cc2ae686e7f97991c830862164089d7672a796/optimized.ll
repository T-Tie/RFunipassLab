...
entry:
  ...
  br i1 %call16.i, label %land.lhs.true.i, label %if.then6.i11
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  br i1 %or.cond.i, label %if.then19.i, label %if.then6.i11
...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  br i1 %call16.i16, label %land.lhs.true.i17, label %if.then6.i38

land.lhs.true.i17:                                ; preds = %if.then6.i11
  %_M_width.i5.i18 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i5.i18, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
  %or.cond.i21 = icmp ult i64 %3, -256
  br i1 %or.cond.i21, label %if.then19.i22, label %if.then6.i38

if.then19.i22:                                    ; preds = %land.lhs.true.i17
  %call24.i23 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  ...
  %expval.i27 = call i64 @llvm.expect.i64(i64 noundef %conv.i26, i64 noundef 1)
  %tobool.not.i28 = icmp eq i64 %expval.i27, 0
  br i1 %tobool.not.i28, label %if.then6.i38, label %if.then28.i29

if.then28.i29:                                    ; preds = %if.then19.i22
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i, i32 noundef 2)
  br label %if.then6.i38

if.then6.i38:                                     ; preds = %if.then28.i29, %if.then19.i22, %land.lhs.true.i17, %if.then6.i11
  ...
  %call16.i43 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  br i1 %call16.i43, label %land.lhs.true.i44, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57

land.lhs.true.i44:                                ; preds = %if.then6.i38
  %_M_width.i5.i45 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i5.i45, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
  %or.cond.i48 = icmp ult i64 %5, -256
  br i1 %or.cond.i48, label %if.then19.i49, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57

if.then19.i49:                                    ; preds = %land.lhs.true.i44
  %call24.i50 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  %call25.i51 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %call24.i50)
  %cmp.i.i52 = icmp eq i32 %call25.i51, -1
  %conv.i53 = zext i1 %cmp.i.i52 to i64
  %expval.i54 = call i64 @llvm.expect.i64(i64 noundef %conv.i53, i64 noundef 1)
  %tobool.not.i55 = icmp eq i64 %expval.i54, 0
  br i1 %tobool.not.i55, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57, label %if.then28.i56

if.then28.i56:                                    ; preds = %if.then19.i49
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i, i32 noundef 2)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57: ; preds = %if.then6.i38, %land.lhs.true.i44, %if.then19.i49, %if.then28.i56
...
for.cond:                                         ; preds = %if.end33, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %if.end33 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %c.0 = phi i32 [ %c.2, %if.end33 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %exitcond70.not = icmp eq i64 %indvars.iv67, 256
  br i1 %exitcond70.not, label %for.end36, label %land.end

land.end:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %str, i64 0, i64 %indvars.iv67
  %7 = load i8, ptr %arrayidx, align 1, !tbaa !22, !invariant.load !8
  %cmp11.not = icmp eq i8 %7, 0
  br i1 %cmp11.not, label %for.end36.split.loop.exit93, label %for.body
...
for.body20:                                       ; preds = %for.cond18
  %8 = add nuw nsw i64 %indvars.iv, %indvars.iv67
...
if.end30:                                         ; preds = %for.body20, %for.cond18, %for.body
  ...
  br i1 %cmp31, label %for.end36.split.loop.exit96, label %if.end33

if.end33:                                         ; preds = %if.end30
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  br label %for.cond, !llvm.loop !26

for.end36.split.loop.exit93:                      ; preds = %land.end
  %11 = trunc nuw nsw i64 %indvars.iv67 to i32
  br label %for.end36

for.end36.split.loop.exit96:                      ; preds = %if.end30
  %12 = trunc nuw nsw i64 %indvars.iv67 to i32
  br label %for.end36

for.end36:                                        ; preds = %for.cond, %for.end36.split.loop.exit96, %for.end36.split.loop.exit93
  %i.0.lcssa = phi i32 [ %11, %for.end36.split.loop.exit93 ], [ %12, %for.end36.split.loop.exit96 ], [ 256, %for.cond ]
  %c.1 = phi i32 [ %c.0, %for.end36.split.loop.exit93 ], [ %conv, %for.end36.split.loop.exit96 ], [ %c.0, %for.cond ]
  %cmp37 = icmp eq i32 %c.1, 0
  br i1 %cmp37, label %for.cond39, label %if.end54

for.cond39:                                       ; preds = %for.end36, %for.body47
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.body47 ], [ 0, %for.end36 ]
  %exitcond74.not = icmp eq i64 %indvars.iv71, 256
  br i1 %exitcond74.not, label %if.end54, label %land.end46

land.end46:                                       ; preds = %for.cond39
  %arrayidx43 = getelementptr inbounds nuw [256 x i8], ptr %str, i64 0, i64 %indvars.iv71
...
for.body47:                                       ; preds = %land.end46
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %13)
...
for.cond57.preheader:                             ; preds = %if.end54
  %wide.trip.count78 = zext i32 %i.0.lcssa to i64
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.body59
  %indvars.iv75 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next76, %for.body59 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count78
  br i1 %exitcond79.not, label %for.cond66.preheader, label %for.body59

for.cond66.preheader:                             ; preds = %for.cond57
  %add67 = add nsw i32 %i.0.lcssa, %conv9
  %14 = sext i32 %i.0.lcssa to i64
  %smax84 = call i32 @llvm.smax.i32(i32 %i.0.lcssa, i32 %add67)
  %wide.trip.count85 = zext i32 %smax84 to i64
  br label %for.cond66

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [256 x i8], ptr %str, i64 0, i64 %indvars.iv75
  %15 = load i8, ptr %arrayidx61, align 1, !tbaa !22
  %call62 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %15)
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  br label %for.cond57, !llvm.loop !28

for.cond66:                                       ; preds = %for.cond66.preheader, %for.body69
  %indvars.iv80 = phi i64 [ %wide.trip.count78, %for.cond66.preheader ], [ %indvars.iv.next81, %for.body69 ]
  %exitcond86.not = icmp eq i64 %indvars.iv80, %wide.trip.count85
  br i1 %exitcond86.not, label %for.cond77.preheader, label %for.body69

for.cond77.preheader:                             ; preds = %for.cond66
  %16 = sext i32 %add67 to i64
  %smax90 = call i32 @llvm.smax.i32(i32 %add67, i32 noundef 256)
  %wide.trip.count91 = zext nneg i32 %smax90 to i64
  br label %for.cond77

for.body69:                                       ; preds = %for.cond66
  %17 = sub nuw nsw i64 %indvars.iv80, %14
  %arrayidx71 = getelementptr inbounds nuw [256 x i8], ptr %rpl, i64 0, i64 %17
  %18 = load i8, ptr %arrayidx71, align 1, !tbaa !22
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %18)
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  br label %for.cond66, !llvm.loop !29

for.cond77:                                       ; preds = %for.cond77.preheader, %for.body85
  %indvars.iv87 = phi i64 [ %16, %for.cond77.preheader ], [ %indvars.iv.next88, %for.body85 ]
  %exitcond92.not = icmp eq i64 %indvars.iv87, %wide.trip.count91
  br i1 %exitcond92.not, label %if.end92, label %land.end84

land.end84:                                       ; preds = %for.cond77
  %arrayidx81 = getelementptr inbounds [256 x i8], ptr %str, i64 0, i64 %indvars.iv87
...
for.body85:                                       ; preds = %land.end84
  %call88 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %19)
