...
define dso_local noundef i32 @_Z4fjysiiiiPi(i32 noundef %n, i32 noundef %m, i32 noundef %i, i32 noundef %d, ptr noundef %ji) #0 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
  %i.addr = alloca i32, align 4
  %d.addr = alloca i32, align 4
  %ji.addr = alloca ptr, align 8
  ...
  store ptr %ji, ptr %ji.addr, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 4, ptr %a) #7
...
if.then:                                          ; preds = %for.body
  ...
  %6 = load ptr, ptr %ji.addr, align 8, !tbaa !9
  %7 = load i32, ptr %d.addr, align 4, !tbaa !5
  %idxprom = sext i32 %7 to i64
  %arrayidx = getelementptr inbounds i32, ptr %6, i64 %idxprom
  store i32 %5, ptr %arrayidx, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %chenji) #7
  store i32 1, ptr %chenji, align 4, !tbaa !5
...
for.cond2:                                        ; preds = %for.inc, %if.then
  ...
  %9 = load i32, ptr %d.addr, align 4, !tbaa !5
  %cmp3 = icmp sle i32 %8, %9
  br i1 %cmp3, label %for.body4, label %for.end

for.body4:                                        ; preds = %for.cond2
  %10 = load i32, ptr %chenji, align 4, !tbaa !5
  %11 = load ptr, ptr %ji.addr, align 8, !tbaa !9
  ...
  store i32 %mul, ptr %chenji, align 4, !tbaa !5
  br label %for.inc
...
for.end:                                          ; preds = %for.cond2
  %15 = load i32, ptr %chenji, align 4, !tbaa !5
...
if.else:                                          ; preds = %for.end
  ...
  %22 = load i32, ptr %d.addr, align 4, !tbaa !5
  %add = add nsw i32 %22, 1
  %23 = load ptr, ptr %ji.addr, align 8, !tbaa !9
  %call = call noundef i32 @_Z4fjysiiiiPi(i32 noundef %div, i32 noundef %20, i32 noundef %21, i32 noundef %add, ptr noundef %23)
  br label %if.end
...
cleanup:                                          ; preds = %if.end, %if.then8
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %chenji) #7
...
if.end11:                                         ; preds = %cleanup.cont, %for.body
  br label %for.inc12

for.inc12:                                        ; preds = %if.end11
  %24 = load i32, ptr %a, align 4, !tbaa !5
  %inc13 = add nsw i32 %24, 1
  store i32 %inc13, ptr %a, align 4, !tbaa !5
  br label %for.cond, !llvm.loop !15

for.end14:                                        ; preds = %cleanup, %for.cond
  %25 = load i32, ptr @num, align 4, !tbaa !5
  store i32 1, ptr %cleanup.dest.slot, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr %a) #7
  ret i32 %25
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80, ptr %ji) #7
  call void @llvm.memset.p0.i64(ptr align 16 %ji, i8 0, i64 80, i1 false)
...
for.body:                                         ; preds = %for.cond
  ...
  %arraydecay = getelementptr inbounds [20 x i32], ptr %ji, i64 0, i64 0
  %call2 = call noundef i32 @_Z4fjysiiiiPi(i32 noundef %2, i32 noundef %3, i32 noundef 2, i32 noundef 0, ptr noundef %arraydecay)
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 80, ptr %ji) #7
