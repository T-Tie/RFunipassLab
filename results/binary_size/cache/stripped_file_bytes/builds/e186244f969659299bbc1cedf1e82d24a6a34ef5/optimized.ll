...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %str) #10
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %delspace) #10
  call void @llvm.memset.p0.i64(ptr align 16 %delspace, i8 0, i64 100, i1 false)
...
while.cond6:                                      ; preds = %while.body11, %if.then
  ...
  %8 = load i8, ptr %arrayidx8, align 1, !tbaa !12
...
if.end:                                           ; preds = %while.end, %while.body
  ...
  %12 = load i8, ptr %arrayidx14, align 1, !tbaa !12
  %13 = load i32, ptr %j, align 4, !tbaa !10
  %inc15 = add nsw i32 %13, 1
  store i32 %inc15, ptr %j, align 4, !tbaa !10
  %idxprom16 = sext i32 %13 to i64
  %arrayidx17 = getelementptr inbounds [100 x i8], ptr %delspace, i64 0, i64 %idxprom16
  store i8 %12, ptr %arrayidx17, align 1, !tbaa !12
  br label %while.cond, !llvm.loop !16

while.end18:                                      ; preds = %while.cond
  %arraydecay19 = getelementptr inbounds [100 x i8], ptr %delspace, i64 0, i64 0
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr %delspace) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #10
  call void @llvm.lifetime.end.p0(i64 100, ptr %str) #10
  ret i32 0
}
...
!27 = !{!7, !7, i64 0}
!28 = !{!29, !29, i64 0}
!29 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !7, i64 0}
!30 = !{!31, !42, i64 240}
!31 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !32, i64 0, !24, i64 216, !8, i64 224, !40, i64 225, !41, i64 232, !42, i64 240, !43, i64 248, !44, i64 256}
!32 = !{!"_ZTSSt8ios_base", !20, i64 8, !20, i64 16, !33, i64 24, !34, i64 28, !34, i64 32, !35, i64 40, !36, i64 48, !8, i64 64, !11, i64 192, !37, i64 200, !38, i64 208}
...
!45 = !{!42, !42, i64 0}
!46 = !{!47, !8, i64 56}
!47 = !{!"_ZTSSt5ctypeIcE", !48, i64 0, !49, i64 16, !40, i64 24, !50, i64 32, !50, i64 40, !51, i64 48, !8, i64 56, !8, i64 57, !8, i64 313, !8, i64 569}
