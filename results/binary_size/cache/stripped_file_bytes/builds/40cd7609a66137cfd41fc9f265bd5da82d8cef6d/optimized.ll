...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 42000, ptr nonnull %a) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %n) #5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp.not46 = icmp slt i32 %0, 1
  br i1 %cmp.not46, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 1, %entry ]
  %sum.048 = phi i32 [ %sum.1, %for.inc ], [ 0, %entry ]
  ...
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx) #5
  %conv = trunc i64 %call5 to i32
  %add = add nsw i32 %sum.048, %conv
  %add6 = add nsw i32 %add, 1
  %cmp7 = icmp slt i32 %add, 80
  br i1 %cmp7, label %if.then, label %if.else22

if.then:                                          ; preds = %for.body
  %cmp8.not = icmp eq i32 %sum.048, 0
...
if.else22:                                        ; preds = %for.body
  ...
  %gep45 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 240), i64 %vbase.offset.i40
  %1 = load ptr, ptr %gep45, align 8, !tbaa !11
...
for.inc.sink.split:                               ; preds = %if.then9, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %sum.1.ph = phi i32 [ %conv, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ %add6, %if.then9 ]
  %call.i.i30 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx) #5
  br label %for.inc

for.inc:                                          ; preds = %for.inc.sink.split, %if.then
  %call.i.i30.sink = phi i64 [ %call5, %if.then ], [ %call.i.i30, %for.inc.sink.split ]
  %sum.1 = phi i32 [ %add, %if.then ], [ %sum.1.ph, %for.inc.sink.split ]
  %call1.i31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx, i64 noundef %call.i.i30.sink)
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  call void @llvm.lifetime.end.p0(i64 42000, ptr nonnull %a) #5
  ret i32 0
}
