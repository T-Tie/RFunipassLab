...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.end ], [ 1, %entry ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.end28
  %indvars.iv34 = phi i64 [ 1, %for.cond12.preheader ], [ %indvars.iv.next35, %for.end28 ]
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv29 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next30, %for.body17 ]
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.end50
  %indvars.iv44 = phi i64 [ 1, %for.cond32.preheader ], [ %indvars.iv.next45, %for.end50 ]
...
for.cond35.preheader:                             ; preds = %for.cond32
  %10 = add nsw i64 %indvars.iv44, -1
  br label %for.cond35

for.cond35:                                       ; preds = %for.cond35.preheader, %for.body37
  %indvars.iv38 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next39, %for.body37 ]
  %p.1 = phi i32 [ 0, %for.cond35.preheader ], [ %spec.select22, %for.body37 ]
  %exitcond43 = icmp eq i64 %indvars.iv38, %wide.trip.count42
  br i1 %exitcond43, label %for.end50, label %for.body37
...
for.body37:                                       ; preds = %for.cond35
  ...
  %spec.select22 = add nuw nsw i32 %p.1, %inc46
