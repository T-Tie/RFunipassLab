...
entry:
  ...
  %arrayidx = getelementptr inbounds nuw i8, ptr %a, i64 444
  br label %for.cond

for.cond:                                         ; preds = %for.end181, %entry
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp sgt i32 %0, 0
  br i1 %cmp, label %for.cond1, label %for.end186

for.cond1:                                        ; preds = %for.cond4, %for.cond
  %1 = phi i32 [ %0, %for.cond ], [ %2, %for.cond4 ]
  %cmp2 = icmp sgt i32 %1, 0
  br i1 %cmp2, label %for.cond4, label %for.end181
...
for.cond4:                                        ; preds = %for.cond1, %for.body6
  ...
  br i1 %cmp5.not, label %for.cond1, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx, i64 0, i64 %indvars.iv
  %call9 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx8)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond4, !llvm.loop !9

for.end181:                                       ; preds = %for.cond1
  %call182 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
