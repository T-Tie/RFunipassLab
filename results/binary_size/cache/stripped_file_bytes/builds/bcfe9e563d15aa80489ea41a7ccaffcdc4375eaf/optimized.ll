...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 %B) #3
...
for.cond41.preheader:                             ; preds = %for.cond37
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.1..str.3, i32 noundef 0)
