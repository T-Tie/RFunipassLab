...
for.end10:                                        ; preds = %for.cond
  ...
  %8 = load i32, ptr %x2, align 4, !tbaa !5
  %9 = load i32, ptr %y1, align 4, !tbaa !5
  %cmp13 = icmp ne i32 %8, %9
  br i1 %cmp13, label %if.then, label %if.end

if.then:                                          ; preds = %for.end10
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
for.cond16:                                       ; preds = %for.inc30, %if.end
...
for.body21:                                       ; preds = %for.cond19
  ...
  %arrayidx23 = getelementptr inbounds [101 x [101 x i32]], ptr %b, i64 0, i64 %idxprom22
...
for.cond33:                                       ; preds = %for.inc64, %for.end32
  ...
  %19 = load i32, ptr %x1, align 4, !tbaa !5
...
for.cond43:                                       ; preds = %for.inc58, %for.body38
  ...
  %25 = load i32, ptr %x2, align 4, !tbaa !5
  %cmp44 = icmp sle i32 %24, %25
  br i1 %cmp44, label %for.body45, label %for.end60

for.body45:                                       ; preds = %for.cond43
  %26 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom46 = sext i32 %26 to i64
  %arrayidx47 = getelementptr inbounds [101 x [101 x i32]], ptr %a, i64 0, i64 %idxprom46
  ...
  %arrayidx51 = getelementptr inbounds [101 x [101 x i32]], ptr %b, i64 0, i64 %idxprom50
  %30 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom52 = sext i32 %30 to i64
  %arrayidx53 = getelementptr inbounds [101 x i32], ptr %arrayidx51, i64 0, i64 %idxprom52
  ...
  %arrayidx55 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom54
  %33 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom56 = sext i32 %33 to i64
  %arrayidx57 = getelementptr inbounds [101 x i32], ptr %arrayidx55, i64 0, i64 %idxprom56
  %34 = load i32, ptr %arrayidx57, align 4, !tbaa !5
  %add = add nsw i32 %34, %mul
  store i32 %add, ptr %arrayidx57, align 4, !tbaa !5
  br label %for.inc58
...
for.cond67:                                       ; preds = %for.inc87, %for.end66
  ...
  %cmp68 = icmp sle i32 %38, %39
  br i1 %cmp68, label %for.body69, label %for.end89

for.body69:                                       ; preds = %for.cond67
  %40 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom70 = sext i32 %40 to i64
  %arrayidx71 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom70
  %arrayidx72 = getelementptr inbounds [101 x i32], ptr %arrayidx71, i64 0, i64 1
  %41 = load i32, ptr %arrayidx72, align 4, !tbaa !5
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %41)
...
for.cond74:                                       ; preds = %for.inc83, %for.body69
  ...
  %cmp75 = icmp sle i32 %42, %43
  br i1 %cmp75, label %for.body76, label %for.end85

for.body76:                                       ; preds = %for.cond74
  %call77 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
  ...
  %46 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %call82 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call77, i32 noundef %46)
  br label %for.inc83
...
for.end85:                                        ; preds = %for.cond74
  %call86 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc87
