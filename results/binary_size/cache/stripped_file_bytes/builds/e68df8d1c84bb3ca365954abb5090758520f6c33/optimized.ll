...
for.cond13:                                       ; preds = %for.cond13.preheader, %if.end
  %indvars.iv17 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next18, %if.end ]
...
for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit42
  %a.2 = phi i32 [ %4, %for.end23.split.loop.exit42 ], [ %a.0, %for.cond13 ]
  %b.2 = phi i32 [ %6, %for.end23.split.loop.exit42 ], [ %b.0, %for.cond13 ]
...
for.cond34:                                       ; preds = %for.end52, %for.end33
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.end52 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.end52 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.end52 ], [ 0, %for.end33 ]
  %exitcond39.not = icmp eq i64 %indvars.iv33, %wide.trip.count25
  br i1 %exitcond39.not, label %for.end55, label %for.cond37.preheader
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  ...
  br i1 %exitcond32.not, label %for.end52, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv33, i64 %indvars.iv27
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv33, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv27, %11
  %or.cond12 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond12, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv27 to i32
  %d.2 = select i1 %or.cond12, i32 %12, i32 %d.1
