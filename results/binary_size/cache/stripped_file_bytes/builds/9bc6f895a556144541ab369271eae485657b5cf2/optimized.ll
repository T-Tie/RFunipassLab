...
entry:
  %targetBlock = tail call fastcc i1 @outlined_ir_func_0()
...
while.body:                                       ; preds = %while.cond
  ...
  %targetBlock1 = tail call fastcc i1 @outlined_ir_func_0()
...
define internal fastcc noundef i1 @outlined_ir_func_0() unnamed_addr #5 {
entry_to_outline:
