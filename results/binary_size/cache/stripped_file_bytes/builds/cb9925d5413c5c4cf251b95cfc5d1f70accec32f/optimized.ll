...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 captures(none) dereferenceable(2000) %b) #8
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv5 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc13 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc13 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond.not, label %for.end15, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
for.end15:                                        ; preds = %for.cond2
  %cmp.not.i.i = icmp eq i32 %j.0, 0
  br i1 %cmp.not.i.i, label %_ZSt4sortIPiEvT_S1_.exit, label %if.then.i.i

if.then.i.i:                                      ; preds = %for.end15
  %idx.ext = sext i32 %j.0 to i64
  %add.ptr.idx = shl nsw i64 %idx.ext, 2
  %add.ptr = getelementptr inbounds i8, ptr %b, i64 %add.ptr.idx
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull align 16 dereferenceable(2000) %b, ptr noundef nonnull %add.ptr, i64 noundef -2)
  call void @_ZSt22__final_insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef nonnull align 16 dereferenceable(2000) %b, ptr noundef nonnull %add.ptr)
  br label %_ZSt4sortIPiEvT_S1_.exit

_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end15, %if.then.i.i
  %sub = add nsw i32 %j.0, -1
  %smax12 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %wide.trip.count13 = zext nneg i32 %smax12 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc23, %_ZSt4sortIPiEvT_S1_.exit
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc23 ], [ 0, %_ZSt4sortIPiEvT_S1_.exit ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end25, label %for.inc23

for.inc23:                                        ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv9
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4)
...
for.end25:                                        ; preds = %for.cond17
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5)
...
if.end:                                           ; preds = %while.body
  ...
  %div.i3 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i3
  ...
  %call.i = tail call noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull %__last.addr.0, ptr noundef nonnull align 4 %__first) #9
...
for.cond.i:                                       ; preds = %_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_.exit.i, %if.then
  %__first.addr.0.i = phi ptr [ %add.ptr, %if.then ], [ %incdec.ptr.i, %_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_.exit.i ]
  %cmp.not.i = icmp eq ptr %__first.addr.0.i, %__last
  br i1 %cmp.not.i, label %if.end, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond.i
  %0 = load i32, ptr %__first.addr.0.i, align 4, !tbaa !5, !invariant.load !12
  br label %while.cond.i.i

while.cond.i.i:                                   ; preds = %while.body.i.i, %for.inc.i
  %__last.addr.0.i.i = phi ptr [ %__first.addr.0.i, %for.inc.i ], [ %incdec.ptr.i.i, %while.body.i.i ]
  %incdec.ptr.i.i = getelementptr inbounds i8, ptr %__last.addr.0.i.i, i64 -4
  %1 = load i32, ptr %incdec.ptr.i.i, align 4, !tbaa !5, !invariant.load !12
...
_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_.exit.i: ; preds = %while.cond.i.i
  ...
  %incdec.ptr.i = getelementptr inbounds nuw i8, ptr %__first.addr.0.i, i64 4
...
if.end:                                           ; preds = %entry
  ...
  %div78 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %div.sink = phi i64 [ %div78, %if.end ], [ %dec, %while.body ]
  %add.ptr = getelementptr inbounds i32, ptr %__first, i64 %div.sink
  %0 = load i32, ptr %add.ptr, align 4, !tbaa !5, !invariant.load !12
  tail call void @_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_(ptr noundef %__first, i64 noundef %div.sink, i64 noundef %sub.ptr.div, i32 noundef %0)
  %cmp5 = icmp eq i64 %div.sink, 0
  %dec = add nsw i64 %div.sink, -1
  br i1 %cmp5, label %return, label %while.body, !llvm.loop !20
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  %__holeIndex.addr.0.i = phi i64 [ %__holeIndex.addr.1, %if.end16 ], [ %div.i, %while.body.i ]
  %sub.i = add nsw i64 %__holeIndex.addr.0.i, -1
  %div.i = sdiv i64 %sub.i, 2
  %cmp.i5 = icmp sgt i64 %__holeIndex.addr.0.i, %__holeIndex
  br i1 %cmp.i5, label %land.end.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef %__c) local_unnamed_addr #3 comdat {
entry:
...
if.then:                                          ; preds = %entry
  %cmp.i3 = icmp slt i32 %1, %2
  br i1 %cmp.i3, label %if.end16, label %if.else

if.else:                                          ; preds = %if.then
  %cmp.i4 = icmp slt i32 %0, %2
  %3 = call i32 @llvm.smax.i32(i32 %0, i32 %2)
  %spec.select = select i1 %cmp.i4, ptr %__c, ptr %__a
  br label %if.end16

if.else7:                                         ; preds = %entry
  %cmp.i5 = icmp slt i32 %0, %2
  br i1 %cmp.i5, label %if.end16, label %if.else10

if.else10:                                        ; preds = %if.else7
  %cmp.i6 = icmp slt i32 %1, %2
  %4 = call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %spec.select7 = select i1 %cmp.i6, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.then, %if.else10, %if.else, %if.else7
  %5 = phi i32 [ %0, %if.else7 ], [ %3, %if.else ], [ %4, %if.else10 ], [ %1, %if.then ]
  %__b.addr.sink.sroa.speculated = phi ptr [ %__a, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select7, %if.else10 ], [ %__b, %if.then ]
  %6 = load i32, ptr %__result, align 4, !tbaa !5, !invariant.load !12
  store i32 %5, ptr %__result, align 4, !tbaa !5
  store i32 %6, ptr %__b.addr.sink.sroa.speculated, align 4, !tbaa !5
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef align 4 %__pivot) local_unnamed_addr #4 comdat {
entry:
...
while.cond1:                                      ; preds = %while.cond1, %while.body
  ...
  br i1 %cmp.i, label %while.cond1, label %while.cond4.preheader, !llvm.loop !23

while.cond4.preheader:                            ; preds = %while.cond1
  br label %while.cond4

while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  %.sink = phi ptr [ %incdec.ptr3, %while.cond4 ], [ %__last.addr.0, %while.cond4.preheader ]
  %incdec.ptr3 = getelementptr inbounds i8, ptr %.sink, i64 -4
  %2 = load i32, ptr %incdec.ptr3, align 4, !tbaa !5, !invariant.load !12
  %cmp.i2 = icmp slt i32 %0, %2
  br i1 %cmp.i2, label %while.cond4, label %while.end8, !llvm.loop !24
...
while.cond.i:                                     ; preds = %for.body, %while.body.i
  ...
  %2 = load i32, ptr %incdec.ptr.i, align 4, !tbaa !5, !invariant.load !12
