...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc7 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond10:                                       ; preds = %if.then25, %for.cond10.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %if.then25 ], [ 0, %for.cond10.preheader ]
  %a.0 = phi i32 [ %a.241, %if.then25 ], [ undef, %for.cond10.preheader ]
  %b.0 = phi i32 [ %b.242, %if.then25 ], [ undef, %for.cond10.preheader ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end36, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv26 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next27, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond.not, label %if.then25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv30, i64 %indvars.iv26
...
for.end23:                                        ; preds = %for.body15
  %6 = trunc nuw nsw i64 %indvars.iv26 to i32
  %cmp24 = icmp eq i32 %0, %6
  br i1 %cmp24, label %if.then25, label %for.end36

if.then25:                                        ; preds = %for.cond13, %for.end23
  %b.242 = phi i32 [ %6, %for.end23 ], [ %b.0, %for.cond13 ]
  %a.241 = phi i32 [ %4, %for.end23 ], [ %a.0, %for.cond13 ]
  %arrayidx29 = getelementptr inbounds [1000 x [1000 x i32]], ptr @s, i64 0, i64 %indvars.iv30, i64 %idxprom28
...
for.end36:                                        ; preds = %for.end23, %if.then25, %for.cond10
  %a.1 = phi i32 [ %a.241, %if.then25 ], [ %4, %for.end23 ], [ %a.0, %for.cond10 ]
  %b.1 = phi i32 [ %b.242, %if.then25 ], [ %6, %for.end23 ], [ %b.0, %for.cond10 ]
  %sub37 = add i32 %0, -1
  %smin = call i32 @llvm.smin.i32(i32 %sub37, i32 noundef -1)
  br label %for.cond38

for.cond38:                                       ; preds = %for.inc64, %for.end36
  %sub37.sink = phi i32 [ %sub37, %for.end36 ], [ %dec65, %for.inc64 ]
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc52
  %sub37.sink4 = phi i32 [ %dec, %for.inc52 ], [ %sub37, %for.cond42.preheader ]
...
for.end66:                                        ; preds = %if.then55, %for.cond38, %for.body44
  %sub37.sink21 = phi i32 [ %sub37.sink, %for.body44 ], [ %smin, %for.cond38 ], [ %sub37.sink, %if.then55 ]
  %d.1 = phi i32 [ %sub37.sink4, %for.body44 ], [ undef, %for.cond38 ], [ undef, %if.then55 ]
  %10 = xor i32 %b.1, -1
  %sub68 = add i32 %d.1, %10
  %11 = xor i32 %a.1, -1
  %sub70 = add i32 %sub37.sink21, %11
