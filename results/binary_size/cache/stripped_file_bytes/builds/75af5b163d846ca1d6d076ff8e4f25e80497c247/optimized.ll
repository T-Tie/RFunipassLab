...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count42 = zext nneg i32 %smax36 to i64
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end44, %for.cond10.preheader
  %indvars.iv39 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next40, %for.end44 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count42
  br i1 %exitcond43.not, label %if.then53, label %for.cond13
...
for.cond28.preheader:                             ; preds = %for.cond13
  ...
  %arrayidx38 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %idxprom33
  %5 = trunc nuw nsw i64 %indvars.iv39 to i32
  br label %for.cond28

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv29
  %6 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %idxprom22 = zext nneg i32 %max.0 to i64
  %arrayidx23 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %idxprom22
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv32 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next33, %for.body30 ]
  %min.0 = phi i32 [ %5, %for.cond28.preheader ], [ %spec.select22, %for.body30 ]
  %exitcond38.not = icmp eq i64 %indvars.iv32, %wide.trip.count42
  br i1 %exitcond38.not, label %for.end44, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx34 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %idxprom33
