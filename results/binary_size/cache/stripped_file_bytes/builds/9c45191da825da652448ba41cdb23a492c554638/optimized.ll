...
do.body:                                          ; preds = %do.body, %entry
  %indvars.iv24 = phi i32 [ %indvars.iv.next25, %do.body ], [ 0, %entry ]
...
for.cond.preheader:                               ; preds = %do.body
  %cmp1418.not = icmp eq i64 %indvars.iv, 0
  br i1 %cmp1418.not, label %for.end, label %for.body.preheader
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx16 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv21
  %1 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %arrayidx18 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv21
  %2 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %sub19 = sub nsw i32 %1, %2
  %3 = mul i32 %sub19, 3600
  %mul = add i32 %3, 43200
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %e, i64 0, i64 %indvars.iv21
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %b, i64 0, i64 %indvars.iv21
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %sub24 = sub nsw i32 %4, %5
  %mul25 = mul nsw i32 %sub24, 60
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %f, i64 0, i64 %indvars.iv21
  %6 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr %c, i64 0, i64 %indvars.iv21
