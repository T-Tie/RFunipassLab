...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 257, ptr noundef nonnull align 16 captures(none) dereferenceable(257) %str) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(257) %str, i8 noundef 0, i64 noundef 257, i1 noundef false) #10
  call void @llvm.lifetime.start.p0(i64 noundef 257, ptr noundef nonnull align 16 captures(none) dereferenceable(257) %substr) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(257) %substr, i8 noundef 0, i64 noundef 257, i1 noundef false) #10
  call void @llvm.lifetime.start.p0(i64 noundef 257, ptr noundef nonnull align 16 captures(none) dereferenceable(257) %replace) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(257) %replace, i8 noundef 0, i64 noundef 257, i1 noundef false) #10
...
if.then6.i8:                                      ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i13 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
if.then19.i19:                                    ; preds = %land.lhs.true.i14
  %call24.i20 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
if.then6.i35:                                     ; preds = %if.then28.i26, %if.then19.i19, %land.lhs.true.i14, %if.then6.i8
  ...
  %call16.i40 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
if.then19.i46:                                    ; preds = %land.lhs.true.i41
  %call24.i47 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54: ; preds = %if.then6.i35, %land.lhs.true.i41, %if.then19.i46, %if.then28.i53
  %call7 = call noundef ptr @strstr(ptr noundef nonnull dereferenceable(1) %str, ptr noundef nonnull dereferenceable(1) %substr) #12
...
for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %substr) #12
...
for.cond18:                                       ; preds = %for.inc27, %for.end
  ...
  %call21 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #12
...
if.end:                                           ; preds = %for.cond18, %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 257, ptr noundef nonnull captures(none) %replace) #11
  call void @llvm.lifetime.end.p0(i64 noundef 257, ptr noundef nonnull captures(none) %substr) #11
  call void @llvm.lifetime.end.p0(i64 noundef 257, ptr noundef nonnull captures(none) %str) #11
  ret i32 0
}
