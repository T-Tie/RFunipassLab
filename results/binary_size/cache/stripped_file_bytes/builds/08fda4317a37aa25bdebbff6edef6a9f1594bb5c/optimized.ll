...
for.cond13:                                       ; preds = %for.inc159, %for.end12
  %10 = load i32, ptr %k, align 4, !tbaa !5
  %11 = load i32, ptr %n, align 4, !tbaa !5
  %sub = sub nsw i32 %11, 1
  %cmp14 = icmp slt i32 %10, %sub
  br i1 %cmp14, label %for.body15, label %for.end161
...
for.body26:                                       ; preds = %for.cond23
  ...
  %23 = load i32, ptr %min, align 4, !tbaa !5
...
for.cond104:                                      ; preds = %for.inc128, %for.end101
  ...
  br i1 %cmp105, label %for.body106, label %for.end130

for.body106:                                      ; preds = %for.cond104
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond107

for.cond107:                                      ; preds = %for.inc120, %for.body106
  %70 = load i32, ptr %j, align 4, !tbaa !5
  %71 = load i32, ptr %n, align 4, !tbaa !5
  %sub108 = sub nsw i32 %71, 1
  %cmp109 = icmp slt i32 %70, %sub108
...
for.body110:                                      ; preds = %for.cond107
  ...
  %add113 = add nsw i32 %73, 1
  %idxprom114 = sext i32 %add113 to i64
  %arrayidx115 = getelementptr inbounds [100 x i32], ptr %arrayidx112, i64 0, i64 %idxprom114
  %74 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  ...
  store i32 %74, ptr %arrayidx119, align 4, !tbaa !5
  br label %for.inc120

for.inc120:                                       ; preds = %for.body110
...
for.end122:                                       ; preds = %for.cond107
  ...
  %sub125 = sub nsw i32 %79, 1
  %idxprom126 = sext i32 %sub125 to i64
  %arrayidx127 = getelementptr inbounds [100 x i32], ptr %arrayidx124, i64 0, i64 %idxprom126
  store i32 0, ptr %arrayidx127, align 4, !tbaa !5
  br label %for.inc128

for.inc128:                                       ; preds = %for.end122
...
for.cond131:                                      ; preds = %for.inc156, %for.end130
  %81 = load i32, ptr %j, align 4, !tbaa !5
  %82 = load i32, ptr %n, align 4, !tbaa !5
  %sub132 = sub nsw i32 %82, 1
  %cmp133 = icmp slt i32 %81, %sub132
...
for.cond135:                                      ; preds = %for.inc148, %for.body134
  ...
  %sub136 = sub nsw i32 %84, 1
  %cmp137 = icmp slt i32 %83, %sub136
...
for.body138:                                      ; preds = %for.cond135
  ...
  %arrayidx143 = getelementptr inbounds [100 x i32], ptr %arrayidx141, i64 0, i64 %idxprom142
  %87 = load i32, ptr %arrayidx143, align 4, !tbaa !5
  ...
  %89 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom146 = sext i32 %89 to i64
  %arrayidx147 = getelementptr inbounds [100 x i32], ptr %arrayidx145, i64 0, i64 %idxprom146
  store i32 %87, ptr %arrayidx147, align 4, !tbaa !5
  br label %for.inc148

for.inc148:                                       ; preds = %for.body138
  %90 = load i32, ptr %i, align 4, !tbaa !5
  %inc149 = add nsw i32 %90, 1
  store i32 %inc149, ptr %i, align 4, !tbaa !5
  br label %for.cond135, !llvm.loop !21

for.end150:                                       ; preds = %for.cond135
  %91 = load i32, ptr %n, align 4, !tbaa !5
  %sub151 = sub nsw i32 %91, 1
...
for.inc156:                                       ; preds = %for.end150
  %93 = load i32, ptr %j, align 4, !tbaa !5
  %inc157 = add nsw i32 %93, 1
  store i32 %inc157, ptr %j, align 4, !tbaa !5
  br label %for.cond131, !llvm.loop !22

for.end158:                                       ; preds = %for.cond131
  br label %for.inc159
...
for.end161:                                       ; preds = %for.cond13
  ...
  %call162 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %95)
  %call163 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call162, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc164

for.inc164:                                       ; preds = %for.end161
  %96 = load i32, ptr %m, align 4, !tbaa !5
  %inc165 = add nsw i32 %96, 1
  store i32 %inc165, ptr %m, align 4, !tbaa !5
