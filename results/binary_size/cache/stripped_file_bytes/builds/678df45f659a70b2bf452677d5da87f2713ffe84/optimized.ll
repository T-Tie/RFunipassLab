...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.end21
  %indvars.iv19 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next20, %for.end21 ]
...
for.cond9:                                        ; preds = %for.cond5, %for.body11
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body11 ], [ 0, %for.cond5 ]
  %exitcond18.not = icmp eq i64 %indvars.iv10, %wide.trip.count17
  br i1 %exitcond18.not, label %for.end21, label %for.body11
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.cond25.loopexit
  %indvars.iv34 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next35, %for.cond25.loopexit ]
  %indvars.iv29 = phi i64 [ 1, %for.cond25.preheader ], [ %indvars.iv.next30, %for.cond25.loopexit ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count38
  br i1 %exitcond39.not, label %for.end71, label %for.body28

for.body28:                                       ; preds = %for.cond25
  %arrayidx35 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv34
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv34
  br label %for.cond30

for.cond30:                                       ; preds = %if.end, %for.body28
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %if.end ], [ %indvars.iv29, %for.body28 ]
...
land.lhs.true:                                    ; preds = %for.body33
  %arrayidx40 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv31
...
for.cond56:                                       ; preds = %for.body58, %if.then
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body58 ], [ 0, %if.then ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %if.end, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv31, i64 %indvars.iv24
...
if.then88:                                        ; preds = %for.end86
  %puts8 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str) #9
  br label %cleanup
...
for.cond91:                                       ; preds = %if.end103, %if.else
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %if.end103 ], [ 0, %if.else ]
  %11 = load i32, ptr %n, align 4, !tbaa !5
  %sub92 = sub nsw i32 %conv, %11
  %12 = sext i32 %sub92 to i64
  %cmp93.not = icmp sgt i64 %indvars.iv45, %12
