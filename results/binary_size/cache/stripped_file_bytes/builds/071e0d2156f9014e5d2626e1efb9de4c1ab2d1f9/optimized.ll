...
entry:
  ...
  br i1 %call16.i, label %land.lhs.true.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  br i1 %or.cond.i, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  ...
  br i1 %tobool.not.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56, label %if.then28.i
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56, %for.inc
  ...
  %p.0 = phi ptr [ %incdec.ptr, %for.inc ], [ %call7, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
...
if.end:                                           ; preds = %for.cond, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
...
if.then6.i10_to_outline:
  ...
  %call16.i15 = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %1) #10
  br i1 %call16.i15, label %land.lhs.true.i16, label %if.then6.i37.exitStub

land.lhs.true.i16:                                ; preds = %if.then6.i10_to_outline
  %_M_width.i4.i17 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %2 = load i64, ptr %_M_width.i4.i17, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -71
  %or.cond.i20 = icmp ult i64 %3, -70
  br i1 %or.cond.i20, label %if.then19.i21, label %if.then6.i37.exitStub

if.then19.i21:                                    ; preds = %land.lhs.true.i16
  %call24.i22 = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %1) #10
  %call25.i23 = tail call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %call24.i22)
  %cmp.i.i24 = icmp eq i32 %call25.i23, -1
  %conv.i25 = zext i1 %cmp.i.i24 to i64
  %expval.i26 = tail call i64 @llvm.expect.i64(i64 noundef %conv.i25, i64 noundef 1)
  %tobool.not.i27 = icmp eq i64 %expval.i26, 0
  br i1 %tobool.not.i27, label %if.then6.i37.exitStub, label %if.then28.i28
...
if.then28.i28:                                    ; preds = %if.then19.i21
  ...
  br label %if.then6.i37.exitStub

if.then6.i37.exitStub:                            ; preds = %if.then28.i28, %if.then19.i21, %land.lhs.true.i16, %if.then6.i10_to_outline
  ret void
}
