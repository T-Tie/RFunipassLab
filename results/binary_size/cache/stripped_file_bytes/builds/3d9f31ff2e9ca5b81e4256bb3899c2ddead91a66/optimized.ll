...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc23 ], [ 0, %entry ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv69, %1
...
for.cond26.preheader:                             ; preds = %for.cond
  ...
  %smax79 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv69, i64 %indvars.iv
  ...
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv69, i64 %indvars.iv
  store i32 %5, ptr %arrayidx14, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv69, i64 %indvars.iv
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc53
  %indvars.iv75 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next76, %for.inc53 ]
  %exitcond81.not = icmp eq i64 %indvars.iv75, %wide.trip.count80
  br i1 %exitcond81.not, label %for.cond56.preheader, label %for.cond29
...
for.cond29:                                       ; preds = %for.cond26, %for.inc50
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc50 ], [ 0, %for.cond26 ]
  %exitcond.not = icmp eq i64 %indvars.iv72, %wide.trip.count
  br i1 %exitcond.not, label %for.inc53, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv75, i64 %indvars.iv72
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %arrayidx39 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv75, i64 %indvars.iv.next73
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc78
  %indvars.iv88 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next89, %for.inc78 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %wide.trip.count80
  br i1 %exitcond92.not, label %for.cond81, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %arrayidx69 = getelementptr inbounds [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv88, i64 %idxprom68
  %arrayidx73 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv88
  br label %for.cond59

for.cond59:                                       ; preds = %for.cond59.preheader, %for.inc75
  %indvars.iv82 = phi i64 [ 0, %for.cond59.preheader ], [ %indvars.iv.next83, %for.inc75 ]
  %exitcond87.not = icmp eq i64 %indvars.iv82, %wide.trip.count
  br i1 %exitcond87.not, label %for.inc78, label %for.body61

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv88, i64 %indvars.iv82
...
if.then71:                                        ; preds = %for.body61
  %10 = trunc nuw nsw i64 %indvars.iv82 to i32
...
for.cond81:                                       ; preds = %for.cond56, %for.inc111
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.inc111 ], [ 0, %for.cond56 ]
  %exitcond103.not = icmp eq i64 %indvars.iv98, %wide.trip.count
  br i1 %exitcond103.not, label %for.cond114.preheader, label %for.cond84
...
for.cond84:                                       ; preds = %for.cond81, %for.body86
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.body86 ], [ 0, %for.cond81 ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %wide.trip.count80
  br i1 %exitcond97.not, label %for.inc111, label %for.body86

for.body86:                                       ; preds = %for.cond84
  %arrayidx90 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv93, i64 %indvars.iv98
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next94 = add nuw nsw i64 %indvars.iv93, 1
  %arrayidx95 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv.next94, i64 %indvars.iv98
...
for.cond114:                                      ; preds = %for.cond114.preheader, %for.inc137
  %indvars.iv109 = phi i64 [ 0, %for.cond114.preheader ], [ %indvars.iv.next110, %for.inc137 ]
  %exitcond113.not = icmp eq i64 %indvars.iv109, %wide.trip.count
  br i1 %exitcond113.not, label %for.cond140, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %arrayidx128 = getelementptr inbounds [8 x [8 x i32]], ptr %bj, i64 0, i64 %idxprom125, i64 %indvars.iv109
  %arrayidx132 = getelementptr inbounds nuw [8 x i32], ptr %hd, i64 0, i64 %indvars.iv109
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc134
  %indvars.iv104 = phi i64 [ 0, %for.cond117.preheader ], [ %indvars.iv.next105, %for.inc134 ]
  %exitcond108.not = icmp eq i64 %indvars.iv104, %wide.trip.count80
  br i1 %exitcond108.not, label %for.inc137, label %for.body119

for.body119:                                      ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv104, i64 %indvars.iv109
...
if.then130:                                       ; preds = %for.body119
  %15 = trunc nuw nsw i64 %indvars.iv104 to i32
...
for.cond140:                                      ; preds = %for.cond114, %for.inc150
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc150 ], [ 0, %for.cond114 ]
  %exitcond118.not = icmp eq i64 %indvars.iv114, %wide.trip.count80
  br i1 %exitcond118.not, label %for.end152, label %for.body142

for.body142:                                      ; preds = %for.cond140
  %arrayidx144 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv114
  ...
  %cmp147 = icmp eq i64 %indvars.iv114, %18
  br i1 %cmp147, label %if.then148, label %for.inc150

if.then148:                                       ; preds = %for.body142
  %19 = trunc nuw nsw i64 %indvars.iv114 to i32
