...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond14.not = icmp eq i32 %1, %2
  br i1 %or.cond14.not, label %if.end81, label %if.end81.gvnsink.split

if.end81.gvnsink.split:                           ; preds = %for.body
  %puts = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str) #6
  br label %if.end81

if.end81:                                         ; preds = %for.body, %if.end81.gvnsink.split
