...
for.cond.preheader:                               ; preds = %entry
  %wide.trip.count8 = zext nneg i32 %n to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond2, %for.cond.preheader
  %indvars.iv5 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next6, %for.cond2 ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count8
  br i1 %exitcond9.not, label %for.cond14, label %for.cond2.preheader
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv.next6, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx6, align 4, !tbaa !8, !invariant.load !12
  %arrayidx10 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
  store i32 %0, ptr %arrayidx10, align 4, !tbaa !8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond2, !llvm.loop !13

for.cond14:                                       ; preds = %for.cond17, %for.cond
  %indvars.iv15 = phi i64 [ 1, %for.cond ], [ %indvars.iv.next16, %for.cond17 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count8
  br i1 %exitcond19.not, label %if.end, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc29
  ...
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count8
  br i1 %exitcond14.not, label %for.cond14, label %for.inc29, !llvm.loop !14

for.inc29:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv.next16
  %1 = load i32, ptr %arrayidx24, align 4, !tbaa !8, !invariant.load !12
  %arrayidx28 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv15
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.cond16
  ...
  %indvars.iv13 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next14, %for.cond16 ]
  %arrayidx22 = getelementptr inbounds nuw [200 x i32], ptr @a, i64 0, i64 %indvars.iv13
  %sub = sub nsw i32 %2, %min.0
  store i32 %sub, ptr %arrayidx22, align 4, !tbaa !8
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %arrayidx22.phi.trans.insert = getelementptr inbounds nuw [200 x i32], ptr @a, i64 0, i64 %indvars.iv.next14
