...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %ju1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %ju2) #6
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc27 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  ...
  %7 = sext i32 %6 to i64
  %cmp17 = icmp slt i64 %indvars.iv26, %7
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv29, i64 %indvars.iv26
...
if.else:                                          ; preds = %for.body69
  %call82 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call75, ptr noundef nonnull dereferenceable(2) @.str)
  br label %for.inc83
...
for.end88:                                        ; preds = %for.cond64
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef nonnull %ju2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef nonnull %ju1) #7
