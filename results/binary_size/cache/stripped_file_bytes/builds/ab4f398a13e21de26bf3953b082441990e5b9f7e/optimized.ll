...
while.cond:                                       ; preds = %if.end32, %entry
  %k.0 = phi i32 [ undef, %entry ], [ %k.27, %if.end32 ]
  %flag.0 = phi i32 [ 1, %entry ], [ %flag.18, %if.end32 ]
...
for.cond11:                                       ; preds = %for.end, %for.end27
  %indvars.iv16 = phi i64 [ 0, %for.end ], [ %indvars.iv.next17, %for.end27 ]
  %s.0 = phi i32 [ 0, %for.end ], [ %s.1, %for.end27 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end30, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv16
  br label %for.cond14
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  ...
  br i1 %exitcond15.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %2 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %arrayidx20 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv12
...
if.end32:                                         ; preds = %for.body, %for.end30
  %flag.18 = phi i32 [ %flag.0, %for.end30 ], [ 0, %for.body ]
  %k.27 = phi i32 [ %k.2, %for.end30 ], [ %1, %for.body ]
