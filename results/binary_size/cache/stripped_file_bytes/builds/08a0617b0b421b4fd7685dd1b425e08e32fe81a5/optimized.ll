...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc38
  %indvars.iv29 = phi i32 [ %sub, %for.cond10.preheader ], [ %indvars.iv.next30, %for.inc38 ]
  %i.1 = phi i32 [ 0, %for.cond10.preheader ], [ %inc39, %for.inc38 ]
  %exitcond32.not = icmp eq i32 %i.1, %smax31
  br i1 %exitcond32.not, label %for.cond41.preheader, label %for.cond13.preheader

for.cond41.preheader:                             ; preds = %for.cond10
  %smax39 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.cond13:                                       ; preds = %for.cond13.backedge, %for.cond13.preheader
  %indvars.iv26 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next27, %for.cond13.backedge ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond.not, label %for.inc38, label %for.body17

for.body17:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv26
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %arrayidx21 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next27
  %5 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %cmp22 = icmp sgt i32 %4, %5
  br i1 %cmp22, label %if.then23, label %for.cond13.backedge

for.cond13.backedge:                              ; preds = %for.body17, %if.then23
...
for.cond41:                                       ; preds = %for.cond41.preheader, %for.body43
  %indvars.iv33 = phi i64 [ 0, %for.cond41.preheader ], [ %indvars.iv.next34, %for.body43 ]
  %exitcond41.not = icmp eq i64 %indvars.iv33, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end56, label %for.body43

for.body43:                                       ; preds = %for.cond41
  %6 = and i64 %indvars.iv33, 4294967295
  %cmp44 = icmp eq i64 %6, 0
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv33
  %7 = load i32, ptr %arrayidx47, align 4, !tbaa !5
  %.str..str.1 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %7)
