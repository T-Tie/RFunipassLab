...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %or.cond12 = select i1 %or.cond, i1 %cmp3, i1 false
  %3 = load i32, ptr %d, align 4
  %cmp5 = icmp eq i32 %3, 0
  %or.cond13 = select i1 %or.cond12, i1 %cmp5, i1 false
  %4 = load i32, ptr %e, align 4
  %cmp7 = icmp eq i32 %4, 0
  %or.cond14 = select i1 %or.cond13, i1 %cmp7, i1 false
  %.pre = load i32, ptr %f, align 4, !tbaa !5
  %cmp9 = icmp eq i32 %.pre, 0
  %or.cond18 = select i1 %or.cond14, i1 %cmp9, i1 false
  br i1 %or.cond18, label %for.end, label %for.inc
