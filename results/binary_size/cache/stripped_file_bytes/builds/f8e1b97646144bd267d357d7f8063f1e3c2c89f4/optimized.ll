...
tailrecurse:                                      ; preds = %for.end79, %entry
  %indvars.iv77.in = phi i64 [ %indvars.iv77, %for.end79 ], [ %0, %entry ]
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.end79 ], [ %0, %entry ]
  %sum.tr = phi i32 [ %add, %for.end79 ], [ %sum, %entry ]
  %indvars.iv77 = add i64 %indvars.iv77.in, -1
  %smax79 = call i64 @llvm.smax.i64(i64 %indvars.iv77, i64 1)
  %1 = icmp eq i64 %indvars.iv74, 1
  br i1 %1, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %2 = trunc nsw i64 %indvars.iv74 to i32
  %smax71 = tail call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %wide.trip.count43 = zext nneg i32 %smax71 to i64
  %wide.trip.count = and i64 %indvars.iv74, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc11
  %indvars.iv40 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next41, %for.inc11 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond14, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx.i = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv40
...
for.cond14:                                       ; preds = %for.cond, %for.inc33
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc33 ], [ 0, %for.cond ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count43
  br i1 %exitcond55.not, label %for.end35, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18.i = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv50
  %min.3.i3 = load i32, ptr %arrayidx18.i, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc30, %for.body16
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc30 ], [ 0, %for.body16 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count
  br i1 %exitcond49.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %indvars.iv50
...
for.cond36:                                       ; preds = %for.inc55, %for.end35
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc55 ], [ 0, %for.end35 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count43
  br i1 %exitcond64.not, label %for.cond58, label %for.cond39

for.cond39:                                       ; preds = %for.cond36, %for.inc52
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc52 ], [ 1, %for.cond36 ]
  %exitcond.not81 = icmp eq i64 %indvars.iv56, %smax79
  br i1 %exitcond.not81, label %for.inc55, label %for.inc52

for.inc52:                                        ; preds = %for.cond39
  %indvars.iv.next57 = add nuw i64 %indvars.iv56, 1
  %arrayidx47 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next57, i64 %indvars.iv59
  %6 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !9
  %arrayidx51 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv56, i64 %indvars.iv59
...
for.cond58:                                       ; preds = %for.cond36, %for.inc77
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc77 ], [ 0, %for.cond36 ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %wide.trip.count43
  br i1 %exitcond73.not, label %for.end79, label %for.cond61

for.cond61:                                       ; preds = %for.cond58, %for.inc74
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc74 ], [ 1, %for.cond58 ]
  %exitcond80.not = icmp eq i64 %indvars.iv65, %smax79
  br i1 %exitcond80.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond61
  %indvars.iv.next66 = add nuw i64 %indvars.iv65, 1
  %arrayidx69 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv68, i64 %indvars.iv.next66
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !9
  %arrayidx73 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv68, i64 %indvars.iv65
