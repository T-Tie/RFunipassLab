...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull %b) #5
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull %r) #5
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 %a) #5
...
for.cond:                                         ; preds = %for.cond.preheader, %for.cond
  ...
  %call21 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %a, ptr noundef nonnull dereferenceable(1) %b) #6
...
for.end42:                                        ; preds = %for.cond26
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull %a) #7
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull %r) #7
