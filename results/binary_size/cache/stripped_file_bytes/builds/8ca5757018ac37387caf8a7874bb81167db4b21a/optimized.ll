...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call3 = call noundef i32 @_Z2fciii(i32 noundef %5, i32 noundef %4, i32 noundef %3) #7
...
if.then:                                          ; preds = %entry, %land.lhs.true
  ...
  %rem82 = urem i32 %year, 100
  %cmp9 = icmp ne i32 %rem82, 0
  %or.cond4 = and i1 %cmp9, %or.cond
  br i1 %or.cond4, label %if.end22, label %if.else

if.else:                                          ; preds = %if.then
  %rem12 = srem i32 %year, 100
  %cmp15 = icmp sgt i32 %year, 99
  %rem173 = urem i32 %year, 400
  %1 = or i32 %rem173, %rem12
  %2 = icmp eq i32 %1, 0
  %or.cond6 = and i1 %cmp15, %2
  %spec.select = zext i1 %or.cond6 to i32
  br label %if.end22
