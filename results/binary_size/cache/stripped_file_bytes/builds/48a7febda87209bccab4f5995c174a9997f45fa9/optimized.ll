...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv9, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc35
  %indvars.iv15 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next16, %for.inc35 ]
  %exitcond21.not = icmp eq i64 %indvars.iv15, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond38.preheader, label %for.body12
...
for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv15
  %5 = load i32, ptr %arrayidx14, align 16, !tbaa !5, !invariant.load !13
  %arrayidx17 = getelementptr inbounds nuw [8 x i32], ptr %djl, i64 0, i64 %indvars.iv15
  store i32 0, ptr %arrayidx17, align 4, !tbaa !5
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc32, %for.body12
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc32 ], [ 0, %for.body12 ]
...
for.body20:                                       ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv15, i64 %indvars.iv12
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc65
  %indvars.iv27 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next28, %for.inc65 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.cond68, label %for.body40

for.body40:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds nuw [8 x i32], ptr %s, i64 0, i64 %indvars.iv27
  %8 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %arrayidx45 = getelementptr inbounds nuw [8 x i32], ptr %djh, i64 0, i64 %indvars.iv27
  store i32 0, ptr %arrayidx45, align 4, !tbaa !5
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc62, %for.body40
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc62 ], [ 0, %for.body40 ]
  %min.0 = phi i32 [ %min.1, %for.inc62 ], [ %8, %for.body40 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count20
  br i1 %exitcond26.not, label %for.inc65, label %for.body48

for.body48:                                       ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv22, i64 %indvars.iv27
...
if.then54:                                        ; preds = %for.body48
  %10 = trunc nuw nsw i64 %indvars.iv22 to i32
