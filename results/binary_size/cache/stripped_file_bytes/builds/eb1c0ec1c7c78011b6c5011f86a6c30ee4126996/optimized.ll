...
if.then:                                          ; preds = %for.body
  ...
  call void @outlined_ir_func_0(double %sub7, ptr noundef nonnull dereferenceable(7) @.str)
  br label %if.end24

if.else14:                                        ; preds = %for.body
  %sub15 = fsub double %div, %div5
  call void @outlined_ir_func_0(double %sub15, ptr noundef nonnull dereferenceable(6) @.str.2)
  br label %if.end24
...
define internal void @outlined_ir_func_0(double %0, ptr noundef nonnull dereferenceable(6) %1) #5 {
if.then_to_outline:
  %cmp8 = fcmp ogt double %0, 5.000000e-02
  %..str.1 = select i1 %cmp8, ptr %1, ptr @.str.1
  %call10 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %..str.1)
