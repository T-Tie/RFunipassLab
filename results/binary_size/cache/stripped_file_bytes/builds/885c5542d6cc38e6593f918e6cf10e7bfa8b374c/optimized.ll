...
for.cond7:                                        ; preds = %for.inc13, %for.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc13 ], [ 0, %for.end ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, 9999
  br i1 %exitcond15.not, label %for.end15, label %for.inc13

for.inc13:                                        ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [9999 x i32], ptr @result, i64 0, i64 %indvars.iv12
