...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %1 = add i64 %0, -41
  %or.cond.i = icmp ult i64 %1, -40
  br i1 %or.cond.i, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit

if.then19.i:                                      ; preds = %land.lhs.true.i
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry, %land.lhs.true.i
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) @b)
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) @b) #11
  %conv = trunc i64 %call3 to i32
  store i32 %conv, ptr @linelen, align 4, !tbaa !22
  %_M_width.i1.i15 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  br label %while.body

while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %if.end34
  %2 = phi i32 [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ %cnt.1, %if.end34 ]
  ...
  br i1 %call16.i13, label %land.lhs.true.i14, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27

land.lhs.true.i14:                                ; preds = %while.body
  %3 = load i64, ptr %_M_width.i1.i15, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -41
  %or.cond.i18 = icmp ult i64 %4, -40
  br i1 %or.cond.i18, label %if.then19.i19, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27

if.then19.i19:                                    ; preds = %land.lhs.true.i14
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27: ; preds = %if.then19.i19, %while.body, %land.lhs.true.i14
  %call5 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) @a) #11
  %conv6 = trunc i64 %call5 to i32
  store i32 %conv6, ptr @num, align 4, !tbaa !22
  %5 = load i32, ptr @linelen, align 4, !tbaa !22
  %cmp = icmp eq i32 %5, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call7, ptr noundef nonnull align 16 dereferenceable(40) @a)
  %6 = load i32, ptr @linelen, align 4, !tbaa !22
  %7 = load i32, ptr @num, align 4, !tbaa !22
  %add = add nsw i32 %7, %6
  store i32 %add, ptr @linelen, align 4, !tbaa !22
  br label %if.end34

if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27
  %add9 = add nsw i32 %5, %conv6
...
if.then12:                                        ; preds = %if.else
  ...
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call13, ptr noundef nonnull align 16 dereferenceable(40) @a)
  %8 = load i32, ptr @num, align 4, !tbaa !22
  br label %if.end30

if.else16:                                        ; preds = %if.else
  %cmp19 = icmp eq i32 %add9, 79
  %call21.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(2) @.str), !noalias !23
  %call22.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call21.i, ptr noundef nonnull align 16 dereferenceable(40) @a), !noalias !23
  br i1 %cmp19, label %if.end30, label %if.else24

if.else24:                                        ; preds = %if.else16
  %9 = load i32, ptr @linelen, align 4, !tbaa !22
  %10 = load i32, ptr @num, align 4, !tbaa !22
  %add28 = add i32 %9, 1
  %add29 = add i32 %add28, %10
  br label %if.end30

if.end30:                                         ; preds = %if.else16, %if.else24, %if.then12
  %.sink = phi i32 [ %8, %if.then12 ], [ 0, %if.else16 ], [ %add29, %if.else24 ]
  store i32 %.sink, ptr @linelen, align 4, !tbaa !22
  %11 = load i32, ptr %n, align 4, !tbaa !22
  %12 = add i32 %11, -2
  %cmp31 = icmp eq i32 %2, %12
  br i1 %cmp31, label %while.end, label %if.end34

if.end34:                                         ; preds = %if.end30, %if.then
  %cnt.1 = add nuw nsw i32 %2, 1
...
if.then19.i_to_outline:
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #10
...
if.then28.i:                                      ; preds = %if.then19.i_to_outline
  tail call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %0, i32 noundef 2)
