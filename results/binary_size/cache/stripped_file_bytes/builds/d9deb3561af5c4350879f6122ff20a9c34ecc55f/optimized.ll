...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv28 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next29, %for.body5 ]
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [99 x i32], ptr %sz, i64 0, i64 %indvars.iv28
...
if.end27:                                         ; preds = %if.then16, %for.end13
  ...
  %smax35 = call i32 @llvm.smax.i32(i32 %sub29, i32 noundef -1)
  %7 = add nsw i32 %smax35, 1
  %wide.trip.count36 = zext nneg i32 %7 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body31, %if.end27
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body31 ], [ 0, %if.end27 ]
  %max.2 = phi i32 [ %spec.select25, %for.body31 ], [ 0, %if.end27 ]
  %exitcond37 = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37, label %for.end41, label %for.body31

for.body31:                                       ; preds = %for.cond28
  %arrayidx33 = getelementptr inbounds nuw [99 x i32], ptr %sz, i64 0, i64 %indvars.iv32
  ...
  %spec.select25 = select i1 %cmp36, i32 %10, i32 %max.2
