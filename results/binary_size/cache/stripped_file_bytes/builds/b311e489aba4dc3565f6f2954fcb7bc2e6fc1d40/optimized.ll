; ModuleID = '/tmp/tmp04j0gt48.cpp'
source_filename = "/tmp/tmp04j0gt48.cpp"
...
define dso_local noundef i32 @_Z6divideii(i32 noundef %n, i32 noundef %a) #0 {
entry:
...
if.then3:                                         ; preds = %for.body
  ...
  %call = call noundef i32 @_Z6divideii(i32 noundef %div, i32 noundef %7)
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z6divideii(i32 noundef %1, i32 noundef %2)
