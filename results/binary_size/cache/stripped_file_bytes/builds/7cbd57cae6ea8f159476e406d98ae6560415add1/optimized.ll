...
for.cond13.preheader:                             ; preds = %for.cond1
  %sub = add nsw i32 %1, -1
  %smax132 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc152
  ...
  %smax129 = call i32 @llvm.smax.i32(i32 %indvars.iv115, i32 noundef 1)
  %exitcond133.not = icmp eq i32 %q.0, %smax132
  br i1 %exitcond133.not, label %for.inc157, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  %smax123 = call i32 @llvm.smax.i32(i32 %indvars.iv78, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc55
  ...
  br i1 %exitcond89.not, label %for.cond58, label %for.body19
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc52
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc52 ], [ 0, %for.cond39.preheader ]
  %exitcond84.not = icmp eq i64 %indvars.iv80, %wide.trip.count
  br i1 %exitcond84.not, label %for.inc55, label %for.inc52
...
for.cond58:                                       ; preds = %for.cond16, %for.inc99
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %for.inc99 ], [ 0, %for.cond16 ]
...
for.cond65:                                       ; preds = %for.body68, %for.body61
  ...
  %t.2 = phi i32 [ %spec.select69, %for.body68 ], [ %8, %for.body61 ]
  %exitcond94.not = icmp eq i64 %indvars.iv90, %wide.trip.count
  br i1 %exitcond94.not, label %for.cond83.preheader, label %for.body68
...
for.body68:                                       ; preds = %for.cond65
  ...
  %spec.select69 = call i32 @llvm.smin.i32(i32 %9, i32 %t.2)
  %indvars.iv.next91 = add nuw nsw i64 %indvars.iv90, 1
  br label %for.cond65, !llvm.loop !17

for.cond83:                                       ; preds = %for.cond83.preheader, %for.inc96
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc96 ], [ 0, %for.cond83.preheader ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %wide.trip.count
  br i1 %exitcond99.not, label %for.inc99, label %for.inc96
...
for.cond109:                                      ; preds = %for.cond109.preheader, %for.inc122
  %indvars.iv106 = phi i64 [ 0, %for.cond109.preheader ], [ %indvars.iv.next107, %for.inc122 ]
  %exitcond111.not = icmp eq i64 %indvars.iv106, %wide.trip.count88
  br i1 %exitcond111.not, label %for.cond104, label %for.inc122, !llvm.loop !20
...
for.cond133:                                      ; preds = %for.cond133.preheader, %for.inc146
  %indvars.iv120 = phi i64 [ 0, %for.cond133.preheader ], [ %indvars.iv.next121, %for.inc146 ]
  %exitcond125.not = icmp eq i64 %indvars.iv120, %wide.trip.count88
  br i1 %exitcond125.not, label %for.cond128, label %for.inc146, !llvm.loop !22
