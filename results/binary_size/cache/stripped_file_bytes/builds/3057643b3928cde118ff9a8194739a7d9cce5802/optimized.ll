...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 404, ptr %mark) #9
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [101 x i32], ptr %mark, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.start.p0(i64 80020, ptr %num) #9
...
for.body5:                                        ; preds = %for.cond2
  ...
  %arrayidx7 = getelementptr inbounds [20005 x i32], ptr %num, i64 0, i64 %idxprom6
...
for.end11:                                        ; preds = %for.cond.cleanup4
  %arrayidx12 = getelementptr inbounds [20005 x i32], ptr %num, i64 0, i64 0
  %7 = load i32, ptr %arrayidx12, align 16, !tbaa !5
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %7)
  %arrayidx14 = getelementptr inbounds [20005 x i32], ptr %num, i64 0, i64 0
  %8 = load i32, ptr %arrayidx14, align 16, !tbaa !5
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %i17) #9
  store i32 0, ptr %i17, align 4, !tbaa !5
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc35, %for.end11
  %9 = load i32, ptr %i17, align 4, !tbaa !5
  %10 = load i32, ptr %n, align 4, !tbaa !5
  %cmp19 = icmp slt i32 %9, %10
  br i1 %cmp19, label %for.body21, label %for.cond.cleanup20

for.cond.cleanup20:                               ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 4, ptr %i17) #9
  br label %for.end37

for.body21:                                       ; preds = %for.cond18
  %11 = load i32, ptr %i17, align 4, !tbaa !5
  %idxprom22 = sext i32 %11 to i64
  %arrayidx23 = getelementptr inbounds [20005 x i32], ptr %num, i64 0, i64 %idxprom22
...
if.then:                                          ; preds = %for.body21
  %14 = load i32, ptr %i17, align 4, !tbaa !5
  %idxprom27 = sext i32 %14 to i64
  %arrayidx28 = getelementptr inbounds [20005 x i32], ptr %num, i64 0, i64 %idxprom27
  %15 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %idxprom29 = sext i32 %15 to i64
  %arrayidx30 = getelementptr inbounds [101 x i32], ptr %mark, i64 0, i64 %idxprom29
  ...
  %16 = load i32, ptr %i17, align 4, !tbaa !5
  %idxprom32 = sext i32 %16 to i64
  %arrayidx33 = getelementptr inbounds [20005 x i32], ptr %num, i64 0, i64 %idxprom32
  %17 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call31, i32 noundef %17)
  br label %if.end
...
for.inc35:                                        ; preds = %if.end
  %18 = load i32, ptr %i17, align 4, !tbaa !5
  %inc36 = add nsw i32 %18, 1
  store i32 %inc36, ptr %i17, align 4, !tbaa !5
  br label %for.cond18, !llvm.loop !13

for.end37:                                        ; preds = %for.cond.cleanup20
  ...
  call void @llvm.lifetime.end.p0(i64 80020, ptr %num) #9
  call void @llvm.lifetime.end.p0(i64 404, ptr %mark) #9
