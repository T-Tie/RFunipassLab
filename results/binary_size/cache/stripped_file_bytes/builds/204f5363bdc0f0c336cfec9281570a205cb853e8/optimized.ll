...
if.end:                                           ; preds = %if.then, %entry
  ...
  %1 = phi i32 [ %rem15, %if.then ], [ %0, %entry ]
...
if.then7:                                         ; preds = %if.end5
  ...
  %div816 = udiv i8 %div8.lhs.trunc, 20
  %div8.zext = zext nneg i8 %div816 to i32
  %rem917 = urem i8 %div8.lhs.trunc, 20
  %rem9.zext = zext nneg i8 %rem917 to i32
