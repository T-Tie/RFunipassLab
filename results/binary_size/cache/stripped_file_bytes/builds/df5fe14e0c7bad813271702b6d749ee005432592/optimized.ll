...
for.cond3:                                        ; preds = %for.inc25, %for.end
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc25 ], [ 1, %for.end ]
...
for.cond6.preheader:                              ; preds = %for.cond3
  %arrayidx10 = getelementptr inbounds nuw [30 x i32], ptr %high, i64 0, i64 %indvars.iv15
  %2 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc21
  %indvars.iv17 = phi i64 [ %indvars.iv15, %for.cond6.preheader ], [ %indvars.iv.next18, %for.inc21 ]
  %max.0 = phi i32 [ 0, %for.cond6.preheader ], [ %max.1, %for.inc21 ]
  %indvars.iv.next18 = add nsw i64 %indvars.iv17, -1
  %cmp7 = icmp sgt i64 %indvars.iv17, 0
  br i1 %cmp7, label %for.body8, label %for.inc25

for.body8:                                        ; preds = %for.cond6
  %arrayidx12 = getelementptr inbounds [30 x i32], ptr %high, i64 0, i64 %indvars.iv.next18
...
if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds [30 x i32], ptr %num, i64 0, i64 %indvars.iv.next18
...
for.inc25:                                        ; preds = %for.cond6
  ...
  %arrayidx24 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv15
...
if.end:                                           ; preds = %while.body
  ...
  %div.i24 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i24
...
while.cond.i.i:                                   ; preds = %while.body.i.i, %for.inc.i
  %__last.addr.0.i.i = phi ptr [ %__first.addr.0.i, %for.inc.i ], [ %__next.0.i.i, %while.body.i.i ]
...
if.end16:                                         ; preds = %if.then9, %if.else13, %if.then12, %if.then2, %if.else5, %if.then4
  ...
  %.sink = phi i32 [ %6, %if.else13 ], [ %6, %if.then12 ], [ %5, %if.then9 ], [ %4, %if.else5 ], [ %4, %if.then4 ], [ %3, %if.then2 ]
  store i32 %.sink, ptr %__b.sink, align 4, !tbaa !5
  ret void
}
