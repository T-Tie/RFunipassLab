...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end26 ], [ 0, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv13, %4
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
  %smax28 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body18 ], [ 0, %for.cond13 ]
...
for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv13, i64 %indvars.iv10
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.end60
  %indvars.iv25 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next26, %for.end60 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond64.preheader, label %for.cond33

for.cond64.preheader:                             ; preds = %for.cond30
  %10 = load i32, ptr %c, align 16
  %arrayidx78 = getelementptr inbounds nuw i8, ptr %c, i64 4
  %11 = load i32, ptr %arrayidx78, align 4
  br label %for.cond64

for.cond33:                                       ; preds = %for.cond30, %for.end57
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.end57 ], [ 0, %for.cond30 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end60, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv25, i64 %indvars.iv19
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.body42, %for.body35
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body42 ], [ 0, %for.body35 ]
  %exitcond.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond.not, label %for.end57, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv16
  %12 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !14
  %arrayidx50 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv16, i64 %indvars.iv19
  %13 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !14
...
for.cond64:                                       ; preds = %for.cond64.preheader, %for.end82
  %14 = phi i32 [ %5, %for.cond64.preheader ], [ %.pre, %for.end82 ]
  %cmp65 = icmp sgt i32 %14, 0
...
for.body73:                                       ; preds = %for.cond71
  ...
  %call79 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call74, i32 noundef %11)
  br label %for.cond71
