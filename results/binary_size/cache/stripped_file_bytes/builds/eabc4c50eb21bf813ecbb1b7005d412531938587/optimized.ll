...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc49
  ...
  %exitcond32.not = icmp eq i32 %i.1, %smax
  br i1 %exitcond32.not, label %for.cond52, label %for.cond7

for.cond7:                                        ; preds = %for.cond4, %for.inc16
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc16 ], [ 0, %for.cond4 ]
  %exitcond26.not = icmp eq i64 %indvars.iv23, 1000000
  br i1 %exitcond26.not, label %for.cond19, label %for.inc16

for.inc16:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [1000000 x i8], ptr %a, i64 0, i64 %indvars.iv23
...
for.cond19:                                       ; preds = %for.cond7, %for.inc46
  %indvars.iv27 = phi i64 [ %4, %for.inc46 ], [ 0, %for.cond7 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, 1000000
  br i1 %exitcond31.not, label %for.inc49, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [1000000 x i8], ptr %a, i64 0, i64 %indvars.iv27
