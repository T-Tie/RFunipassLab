...
for.cond:                                         ; preds = %entry, %for.inc
  ...
  %i.0 = phi i32 [ %dec, %for.inc ], [ %a, %entry ]
...
if.then3:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z6divideii(i32 noundef %div, i32 noundef %i.0)
...
for.end:                                          ; preds = %for.cond
  ...
  %.s.0 = select i1 %cmp5, i32 0, i32 %s.0
  br label %cleanup

cleanup:                                          ; preds = %for.end, %entry
  %retval.0 = phi i32 [ 1, %entry ], [ %.s.0, %for.end ]
  ret i32 %retval.0
}
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z6divideii(i32 noundef %1, i32 noundef %1)
