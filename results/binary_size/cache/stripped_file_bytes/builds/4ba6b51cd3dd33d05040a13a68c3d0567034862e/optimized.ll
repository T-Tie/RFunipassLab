...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv22, %2
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv22
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.end148
  %indvars.iv79 = phi i64 [ %6, %for.cond14.preheader ], [ %indvars.iv.next80, %for.end148 ]
  %indvars.iv76 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next77, %for.end148 ]
...
for.cond17:                                       ; preds = %for.cond14, %for.end52
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.end52 ], [ 1, %for.cond14 ]
  %exitcond40 = icmp eq i64 %indvars.iv36, %indvars.iv76
  br i1 %exitcond40, label %for.cond56, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond17
  %add.ptr24 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv36
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.body22
  %indvars.iv25 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next26, %for.body22 ]
  %min.0 = phi i32 [ 100000, %for.cond20.preheader ], [ %spec.select, %for.body22 ]
  %exitcond = icmp eq i64 %indvars.iv25, %indvars.iv76
...
for.body22:                                       ; preds = %for.cond20
  %add.ptr27 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv25
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body39 ], [ 1, %for.cond37.preheader ]
  %exitcond35 = icmp eq i64 %indvars.iv31, %indvars.iv76
  br i1 %exitcond35, label %for.end52, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %add.ptr44 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv31
...
for.cond56:                                       ; preds = %for.cond17, %for.end94
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.end94 ], [ 1, %for.cond17 ]
  %exitcond55 = icmp eq i64 %indvars.iv51, %indvars.iv76
  br i1 %exitcond55, label %for.cond101, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv51
  br label %for.cond59

for.cond59:                                       ; preds = %for.cond59.preheader, %for.body61
  %indvars.iv41 = phi i64 [ 1, %for.cond59.preheader ], [ %indvars.iv.next42, %for.body61 ]
  %min.2 = phi i32 [ 100000, %for.cond59.preheader ], [ %spec.select16, %for.body61 ]
  %exitcond45 = icmp eq i64 %indvars.iv41, %indvars.iv76
  br i1 %exitcond45, label %for.cond78.preheader, label %for.body61

for.cond78.preheader:                             ; preds = %for.cond59
  br label %for.cond78

for.body61:                                       ; preds = %for.cond59
  %gep = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv41
  %12 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select16 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond59, !llvm.loop !17

for.cond78:                                       ; preds = %for.cond78.preheader, %for.body80
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body80 ], [ 1, %for.cond78.preheader ]
  %exitcond50 = icmp eq i64 %indvars.iv46, %indvars.iv76
  br i1 %exitcond50, label %for.end94, label %for.body80

for.body80:                                       ; preds = %for.cond78
  %gep18 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv46
  %13 = load i32, ptr %gep18, align 4, !tbaa !5, !invariant.load !13
  %sub86 = sub nsw i32 %13, %min.2
  store i32 %sub86, ptr %gep18, align 4, !tbaa !5
...
for.cond101:                                      ; preds = %for.cond56, %for.end121
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.end121 ], [ 2, %for.cond56 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %indvars.iv79
  br i1 %exitcond65.not, label %for.cond125, label %for.cond105.preheader

for.cond105.preheader:                            ; preds = %for.cond101
  %add.ptr109 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv61
  %add.ptr110 = getelementptr inbounds nuw i8, ptr %add.ptr109, i64 440
  br label %for.cond105

for.cond105:                                      ; preds = %for.cond105.preheader, %for.body107
  %indvars.iv56 = phi i64 [ 1, %for.cond105.preheader ], [ %indvars.iv.next57, %for.body107 ]
  %exitcond60 = icmp eq i64 %indvars.iv56, %indvars.iv76
  br i1 %exitcond60, label %for.end121, label %for.body107

for.body107:                                      ; preds = %for.cond105
  %add.ptr113 = getelementptr inbounds nuw i32, ptr %add.ptr110, i64 %indvars.iv56
  %14 = load i32, ptr %add.ptr113, align 4, !tbaa !5, !invariant.load !13
  %add.ptr118 = getelementptr inbounds nuw i32, ptr %add.ptr109, i64 %indvars.iv56
...
for.cond125:                                      ; preds = %for.cond101, %for.end145
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.end145 ], [ 2, %for.cond101 ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %indvars.iv79
  br i1 %exitcond75.not, label %for.end148, label %for.cond129.preheader

for.cond129.preheader:                            ; preds = %for.cond125
  %invariant.gep19 = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv71
  br label %for.cond129

for.cond129:                                      ; preds = %for.cond129.preheader, %for.body131
  %indvars.iv66 = phi i64 [ 1, %for.cond129.preheader ], [ %indvars.iv.next67, %for.body131 ]
  %exitcond70 = icmp eq i64 %indvars.iv66, %indvars.iv76
  br i1 %exitcond70, label %for.end145, label %for.body131

for.body131:                                      ; preds = %for.cond129
  %gep20 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep19, i64 %indvars.iv66
  %add.ptr137 = getelementptr inbounds nuw i8, ptr %gep20, i64 4
  %15 = load i32, ptr %add.ptr137, align 4, !tbaa !5, !invariant.load !13
  store i32 %15, ptr %gep20, align 4, !tbaa !5
