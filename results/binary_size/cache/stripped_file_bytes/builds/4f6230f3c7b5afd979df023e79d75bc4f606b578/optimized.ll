...
for.cond:                                         ; preds = %while.cond, %if.end9
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end9 ], [ 0, %while.cond ]
...
for.cond12:                                       ; preds = %for.end, %for.end28
  %indvars.iv11 = phi i64 [ 0, %for.end ], [ %indvars.iv.next12, %for.end28 ]
  %t.2 = phi i32 [ 0, %for.end ], [ %t.3, %for.end28 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.end31, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond12
  %arrayidx19 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv11
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv7 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next8, %for.body17 ]
  %t.3 = phi i32 [ %t.2, %for.cond15.preheader ], [ %spec.select, %for.body17 ]
  %exitcond10.not = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond10.not, label %for.end28, label %for.body17
...
if.end33:                                         ; preds = %for.body, %for.end31
  ...
  %flag.1 = phi i32 [ %flag.0, %for.end31 ], [ 0, %for.body ]
