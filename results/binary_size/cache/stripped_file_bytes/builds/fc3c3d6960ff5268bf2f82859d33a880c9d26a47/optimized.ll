...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 41, ptr %s) #11
  %arraydecay = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
...
if.then:                                          ; preds = %for.body
  %arraydecay3 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay3)
  %arraydecay5 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
...
if.else:                                          ; preds = %for.body
  ...
  %arraydecay8 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  %call9 = call i64 @strlen(ptr noundef %arraydecay8) #12
...
if.then12:                                        ; preds = %if.else
  ...
  %arraydecay14 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  ...
  %arraydecay16 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  %call17 = call i64 @strlen(ptr noundef %arraydecay16) #12
  %add18 = add i64 %call17, 1
  %4 = load i32, ptr %count, align 4, !tbaa !5
  %conv19 = sext i32 %4 to i64
  %add20 = add i64 %conv19, %add18
  %conv21 = trunc i64 %add20 to i32
  store i32 %conv21, ptr %count, align 4, !tbaa !5
  br label %if.end
...
if.else22:                                        ; preds = %if.else
  ...
  %arraydecay24 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  ...
  %arraydecay26 = getelementptr inbounds [41 x i8], ptr %s, i64 0, i64 0
  %call27 = call i64 @strlen(ptr noundef %arraydecay26) #12
  %conv28 = trunc i64 %call27 to i32
  store i32 %conv28, ptr %count, align 4, !tbaa !5
  br label %if.end
...
if.end29:                                         ; preds = %if.end, %if.then
  call void @llvm.lifetime.end.p0(i64 41, ptr %s) #11
  br label %for.inc
