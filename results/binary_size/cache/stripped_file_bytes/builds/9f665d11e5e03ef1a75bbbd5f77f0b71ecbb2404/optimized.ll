...
while.cond:                                       ; preds = %if.end, %entry
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %if.end ], [ 0, %entry ]
...
if.end.loopexit:                                  ; preds = %while.cond6
  ...
  %.pre13 = load i8, ptr %arrayidx14.phi.trans.insert, align 1, !tbaa !5, !invariant.load !8
  br label %if.end

if.end:                                           ; preds = %if.end.loopexit, %while.cond
  %3 = phi i8 [ %.pre13, %if.end.loopexit ], [ %0, %while.cond ]
  %i.1 = phi i32 [ %2, %if.end.loopexit ], [ %i.0, %while.cond ]
  %inc12 = add nsw i32 %i.1, 1
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx17 = getelementptr inbounds nuw [100 x i8], ptr %delspace, i64 0, i64 %indvars.iv10
