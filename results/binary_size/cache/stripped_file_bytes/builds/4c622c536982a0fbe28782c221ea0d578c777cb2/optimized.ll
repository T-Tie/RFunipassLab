...
for.cond:                                         ; preds = %if.else34.i20, %entry
  ...
  br i1 %exitcond.not, label %for.cond37.preheader, label %for.body
...
land.lhs.true12:                                  ; preds = %land.lhs.true
  ...
  br i1 %cmp18, label %if.then, label %if.else34.i20
...
for.cond37.preheader:                             ; preds = %for.cond, %if.then
  %i.1.ph = phi i32 [ %sub, %if.then ], [ undef, %for.cond ]
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %i.1 = phi i32 [ %dec, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %i.1.ph, %for.cond37.preheader ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %call1.i130 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  %name48 = getelementptr inbounds nuw i8, ptr %arrayidx41, i64 20
  %call.i.i131 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %name48) #5
  %call1.i132 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %name48, i64 noundef %call.i.i131)
  %call1.i138 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  ...
  %vtable.i139 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !14
  ...
  %gep185 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i141
  %5 = load i64, ptr %gep185, align 8, !tbaa !16
  %cmp.not.i = icmp eq i64 %5, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.body39
  %call1.i144 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i, i64 noundef 1)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  %retval.0.i = phi ptr [ %call1.i144, %if.then.i ], [ @_ZSt4cout, %if.end.i ]
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i)
  %call1.i146 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull @.str, i64 noundef 1)
  ...
  %call1.i149 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call60, ptr noundef nonnull @.str, i64 noundef 1)
  %score64 = getelementptr inbounds nuw i8, ptr %arrayidx41, i64 48
  %call.i.i151 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %score64) #5
  %call1.i152 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call60, ptr noundef nonnull %score64, i64 noundef %call.i.i151)
  %call1.i160 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call60, ptr noundef nonnull @.str, i64 noundef 1)
  %address70 = getelementptr inbounds nuw i8, ptr %arrayidx41, i64 148
  %call.i.i162 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %address70) #5
  %call1.i163 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call60, ptr noundef nonnull %address70, i64 noundef %call.i.i162)
  %vtable.i170 = load ptr, ptr %call60, align 8, !tbaa !14
  ...
  %add.ptr.i173 = getelementptr inbounds i8, ptr %call60, i64 %vbase.offset.i172
  %call.i174 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i173, i8 noundef signext 10)
  %call1.i175 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call60, i8 noundef signext %call.i174)
  %call.i.i176 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i175)
