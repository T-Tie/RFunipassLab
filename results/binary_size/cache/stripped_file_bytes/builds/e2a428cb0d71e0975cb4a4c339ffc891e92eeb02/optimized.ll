...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc27 ], [ 0, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv30, %4
  br i1 %cmp14, label %for.cond16, label %for.cond60

for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc24 ], [ 0, %for.cond13 ]
  %5 = load i32, ptr %y2, align 4, !tbaa !5
  %6 = sext i32 %5 to i64
  %cmp17 = icmp slt i64 %indvars.iv27, %6
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv30, i64 %indvars.iv27
