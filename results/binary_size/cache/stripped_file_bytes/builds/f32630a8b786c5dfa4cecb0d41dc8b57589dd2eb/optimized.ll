...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond9 = select i1 %or.cond, i1 %cmp4, i1 false
  %3 = load i32, ptr %d, align 4
  %cmp6 = icmp eq i32 %3, 0
  %or.cond10 = select i1 %or.cond9, i1 %cmp6, i1 false
  %4 = load i32, ptr %e, align 4
  %cmp8 = icmp eq i32 %4, 0
  %or.cond11 = select i1 %or.cond10, i1 %cmp8, i1 false
  %5 = load i32, ptr %f, align 4
  %cmp10 = icmp eq i32 %5, 0
  %or.cond12 = select i1 %or.cond11, i1 %cmp10, i1 false
  br i1 %or.cond12, label %cleanup, label %if.else

if.else:                                          ; preds = %for.body
  %cmp11.not = icmp sgt i32 %2, %5
  %cmp13.not = icmp sgt i32 %1, %4
  %or.cond14 = select i1 %cmp11.not, i1 true, i1 %cmp13.not
  br i1 %or.cond14, label %if.else21, label %for.inc.gvnsink.split

if.else21:                                        ; preds = %if.else
  %cmp22.not = icmp slt i32 %2, %5
  %cmp24.not = icmp sgt i32 %1, %4
  %or.cond15 = select i1 %cmp22.not, i1 true, i1 %cmp24.not
  %cmp38.not = icmp slt i32 %1, %4
  %or.cond16 = select i1 %cmp11.not, i1 true, i1 %cmp38.not
  %or.cond18 = select i1 %or.cond15, i1 %or.cond16, i1 false
  %cmp52.not = icmp slt i32 %1, %4
  %or.cond17 = select i1 %cmp22.not, i1 true, i1 %cmp52.not
  %or.cond19 = select i1 %or.cond18, i1 %or.cond17, i1 false
  br i1 %or.cond19, label %for.inc, label %for.inc.gvnsink.split
