...
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) @need)
  br label %while.cond

while.cond:                                       ; preds = %while.end, %entry
  %0 = load i32, ptr @need, align 4, !tbaa !5
...
while.cond1:                                      ; preds = %while.body3, %while.body
  %1 = load i32, ptr @need, align 4, !tbaa !5
  %2 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom = sext i32 %2 to i64
  %arrayidx = getelementptr inbounds [6 x i32], ptr @money, i64 0, i64 %idxprom
...
while.body3:                                      ; preds = %while.cond1
  ...
  %arrayidx5 = getelementptr inbounds [6 x i32], ptr @ans, i64 0, i64 %idxprom4
  %5 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %inc = add nsw i32 %5, 1
  store i32 %inc, ptr %arrayidx5, align 4, !tbaa !5
  %6 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom6 = sext i32 %6 to i64
  %arrayidx7 = getelementptr inbounds [6 x i32], ptr @money, i64 0, i64 %idxprom6
  %7 = load i32, ptr %arrayidx7, align 4, !tbaa !5
  %8 = load i32, ptr @need, align 4, !tbaa !5
  %sub = sub nsw i32 %8, %7
...
for.cond:                                         ; preds = %for.inc, %while.end9
  ...
  %cmp10 = icmp slt i32 %10, 6
  br i1 %cmp10, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %11 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom11 = sext i32 %11 to i64
  %arrayidx12 = getelementptr inbounds [6 x i32], ptr @ans, i64 0, i64 %idxprom11
  %12 = load i32, ptr %arrayidx12, align 4, !tbaa !5
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %12)
