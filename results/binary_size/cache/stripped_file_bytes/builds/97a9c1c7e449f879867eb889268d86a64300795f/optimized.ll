...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %2 = sext i32 %1 to i64
  %cmp3.not.not = icmp slt i64 %indvars.iv10, %2
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %num, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %for.cond105, %entry
  ...
  %smax85 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count70 = zext nneg i32 %smax85 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc31, %tailrecurse
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc31 ], [ 0, %tailrecurse ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count70
  br i1 %exitcond71.not, label %for.cond34, label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv67, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.end, %for.inc27
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc27 ], [ 0, %for.end ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66.not, label %for.inc31, label %for.inc27

for.inc27:                                        ; preds = %for.cond14
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv67, i64 %indvars.iv62
...
for.cond34:                                       ; preds = %for.cond, %for.inc78
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc78 ], [ 0, %for.cond ]
  %exitcond87.not = icmp eq i64 %indvars.iv82, %wide.trip.count70
  br i1 %exitcond87.not, label %for.end80, label %for.cond38

for.cond38:                                       ; preds = %for.cond34, %for.inc56
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc56 ], [ 0, %for.cond34 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ 1000, %for.cond34 ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count
  br i1 %exitcond76.not, label %for.end58, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv72, i64 %indvars.iv82
...
for.cond61:                                       ; preds = %for.end58, %for.inc74
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc74 ], [ 0, %for.end58 ]
  %exitcond81.not = icmp eq i64 %indvars.iv77, %wide.trip.count
  br i1 %exitcond81.not, label %for.inc78, label %for.inc74

for.inc74:                                        ; preds = %for.cond61
  %arrayidx68 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv77, i64 %indvars.iv82
...
for.end80:                                        ; preds = %for.cond34
  %smax104 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
...
for.cond85.preheader:                             ; preds = %for.end80
  ...
  %4 = add nuw i32 %smax92, 1
  %wide.trip.count93 = zext i32 %4 to i64
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.inc102
  %indvars.iv88 = phi i64 [ 2, %for.cond85.preheader ], [ %indvars.iv.next89, %for.inc102 ]
  %exitcond94 = icmp eq i64 %indvars.iv88, %wide.trip.count93
  br i1 %exitcond94, label %for.cond105.preheader, label %for.inc102
...
for.inc102:                                       ; preds = %for.cond85
  %arrayidx90 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 0, i64 %indvars.iv88
  %5 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !14
  %6 = add nsw i64 %indvars.iv88, -1
  %arrayidx94 = getelementptr inbounds [200 x i32], ptr %num, i64 0, i64 %6
  store i32 %5, ptr %arrayidx94, align 4, !tbaa !5
  %arrayidx96 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv88
...
for.cond105:                                      ; preds = %for.cond105.preheader, %for.inc126
  %indvars.iv101 = phi i64 [ 2, %for.cond105.preheader ], [ %indvars.iv.next102, %for.inc126 ]
  %exitcond106.not = icmp eq i64 %indvars.iv101, %wide.trip.count105
  br i1 %exitcond106.not, label %tailrecurse, label %for.cond109

for.cond109:                                      ; preds = %for.cond105, %for.inc123
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc123 ], [ 2, %for.cond105 ]
  %exitcond100.not = icmp eq i64 %indvars.iv95, %wide.trip.count
  br i1 %exitcond100.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv101, i64 %indvars.iv95
  %8 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !14
  %9 = add nsw i64 %indvars.iv95, -1
  %arrayidx122 = getelementptr [200 x i32], ptr %invariant.gep, i64 %indvars.iv101, i64 %9
