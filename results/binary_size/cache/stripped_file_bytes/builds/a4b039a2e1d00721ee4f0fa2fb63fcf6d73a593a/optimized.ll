...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 104, ptr noundef nonnull %h) #5
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 104, ptr noundef nonnull %q) #5
...
for.cond2:                                        ; preds = %for.inc7, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc7 ], [ 1, %for.end ]
...
for.inc7:                                         ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv20
  store i32 1, ptr %arrayidx6, align 4, !tbaa !5
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond2, !llvm.loop !12

for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc36
  %indvars.iv31 = phi i64 [ %1, %for.cond10.preheader ], [ %indvars.iv.next32, %for.inc36 ]
  %indvars.iv25 = phi i64 [ %3, %for.cond10.preheader ], [ %indvars.iv.next26, %for.inc36 ]
  %indvars.iv.next32 = add nsw i64 %indvars.iv31, -1
  %indvars.iv.next26 = add nsw i64 %indvars.iv25, -1
  %cmp11 = icmp sgt i64 %indvars.iv31, 1
  br i1 %cmp11, label %for.cond13.preheader, label %for.cond38

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx19 = getelementptr inbounds [26 x i32], ptr %h, i64 0, i64 %indvars.iv.next32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc28
  %indvars.iv27 = phi i64 [ %indvars.iv25, %for.cond13.preheader ], [ %indvars.iv.next28, %for.inc28 ]
  %m.0 = phi i32 [ 0, %for.cond13.preheader ], [ %m.1, %for.inc28 ]
  %4 = trunc nuw i64 %indvars.iv27 to i32
  %cmp14.not = icmp slt i32 %0, %4
  br i1 %cmp14.not, label %for.inc36, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [26 x i32], ptr %h, i64 0, i64 %indvars.iv27
...
if.then:                                          ; preds = %for.body15
  %arrayidx22 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv27
...
for.inc36:                                        ; preds = %for.cond13
  %arrayidx32 = getelementptr inbounds [26 x i32], ptr %q, i64 0, i64 %indvars.iv.next32
...
for.cond38:                                       ; preds = %for.cond10, %for.body40
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body40 ], [ 1, %for.cond10 ]
  %m.2 = phi i32 [ %spec.select18, %for.body40 ], [ 0, %for.cond10 ]
  %exitcond38 = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond38, label %for.end50, label %for.body40

for.body40:                                       ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv34
  %9 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !13
  %spec.select18 = call i32 @llvm.smax.i32(i32 %m.2, i32 %9)
...
for.end50:                                        ; preds = %for.cond38
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 104, ptr noundef nonnull %q) #5
  call void @llvm.lifetime.end.p0(i64 noundef 104, ptr noundef nonnull %h) #5
