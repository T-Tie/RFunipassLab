...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv40 = phi i32 [ %indvars.iv.next41, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc29 ], [ 0, %entry ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv32 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next33, %for.inc40 ]
  %exitcond39.not = icmp eq i64 %indvars.iv32, %wide.trip.count38
  br i1 %exitcond39.not, label %for.end42, label %for.inc40
...
for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc53 ], [ %6, %for.end42 ]
