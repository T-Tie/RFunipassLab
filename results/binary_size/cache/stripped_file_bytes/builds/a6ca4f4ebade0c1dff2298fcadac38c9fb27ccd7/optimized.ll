...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc30
  %indvars.iv49 = phi i64 [ %4, %for.cond2.preheader ], [ %indvars.iv.next50, %for.inc30 ]
  %indvars.iv36 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next37, %for.inc30 ]
  %smax51 = call i64 @llvm.smax.i64(i64 %indvars.iv49, i64 noundef 0)
...
for.cond5:                                        ; preds = %for.cond2, %for.body7
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body7 ], [ 0, %for.cond2 ]
  %max.0 = phi i32 [ %spec.select, %for.body7 ], [ 0, %for.cond2 ]
  %exitcond52 = icmp eq i64 %indvars.iv33, %smax51
  br i1 %exitcond52, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv33
...
for.cond33:                                       ; preds = %for.cond2, %for.inc53
  %.pre44 = phi i32 [ %.pre, %for.inc53 ], [ %3, %for.cond2 ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc53 ], [ 0, %for.cond2 ]
  %13 = sext i32 %.pre44 to i64
  %cmp34 = icmp slt i64 %indvars.iv41, %13
  br i1 %cmp34, label %for.body35, label %for.end55

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv41
...
if.then39:                                        ; preds = %for.body35
  %sub40 = add nsw i32 %.pre44, -2
  %16 = zext i32 %sub40 to i64
  %cmp41 = icmp eq i64 %indvars.iv41, %16
  %sub42 = add nsw i32 %.pre44, -1
  %17 = zext i32 %sub42 to i64
  %cmp43 = icmp eq i64 %indvars.iv41, %17
...
for.inc53:                                        ; preds = %if.then39, %for.body35
  %.pre = phi i32 [ %.pre.pre, %if.then39 ], [ %.pre44, %for.body35 ]
