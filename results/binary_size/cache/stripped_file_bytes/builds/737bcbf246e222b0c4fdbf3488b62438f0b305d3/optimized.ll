...
for.cond2:                                        ; preds = %for.inc26, %for.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc26 ], [ %2, %for.end ]
  %3 = trunc nuw i64 %indvars.iv18 to i32
  %cmp3 = icmp sgt i32 %3, 0
  br i1 %cmp3, label %for.cond5, label %for.end27

for.cond5:                                        ; preds = %for.cond2, %for.inc23
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc23 ], [ 0, %for.cond2 ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %indvars.iv18
  br i1 %exitcond.not, label %for.inc26, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %shu, i64 0, i64 %indvars.iv15
  %4 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %shu, i64 0, i64 %indvars.iv.next16
