...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80004, ptr nonnull %b) #4
...
for.cond:                                         ; preds = %for.body, %entry
  ...
  br i1 %exitcond, label %for.cond1, label %for.body
...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre, %for.body3 ], [ %0, %for.cond ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body3 ], [ 1, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv13, %3
  br i1 %cmp2.not, label %for.end13, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv13
...
for.end13:                                        ; preds = %for.cond1
  ...
  %8 = sub i32 %7, %smin
  %wide.trip.count19 = zext i32 %8 to i64
  br label %do.body

do.body:                                          ; preds = %if.end, %for.end13
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %if.end ], [ 2, %for.end13 ]
  %arrayidx20 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv16
...
if.then:                                          ; preds = %do.body
  ...
  %11 = load i64, ptr %gep, align 8, !tbaa !16
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, i32 noundef %12)
...
if.end:                                           ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %do.body
  ...
  br i1 %exitcond20.not, label %do.end, label %do.body, !llvm.loop !27

do.end:                                           ; preds = %if.end
  call void @llvm.lifetime.end.p0(i64 80004, ptr nonnull %b) #4
