...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %cocktail1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %cocktail2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 dereferenceable(80000) %extra1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 dereferenceable(80000) %extra2) #6
  ...
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %cocktail1)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %if.end35
  ...
  %indvars.iv5 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next6, %if.end35 ]
  %sub15 = add nsw i32 %6, -1
  %7 = sext i32 %sub15 to i64
  %cmp16 = icmp slt i64 %indvars.iv5, %7
  br i1 %cmp16, label %for.body17, label %for.end38

for.body17:                                       ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [10000 x double], ptr %extra, i64 0, i64 %indvars.iv5
...
if.end35.sink.split:                              ; preds = %if.else28, %if.else, %for.body17
  ...
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.1.sink)
