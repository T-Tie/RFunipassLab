...
lor.lhs.false:                                    ; preds = %if.end
  ...
  %or.cond.not = or i1 %cmp6, %cmp8
  %6 = zext i1 %or.cond.not to i64
  br label %if.end10

if.end10:                                         ; preds = %lor.lhs.false, %if.end
  %leap.0 = phi i64 [ 0, %if.end ], [ %6, %lor.lhs.false ]
  %7 = sext i32 %3 to i64
...
for.cond:                                         ; preds = %for.inc, %if.end10
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ %7, %if.end10 ]
  %days.1 = phi i32 [ %add, %for.inc ], [ 0, %if.end10 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %8 = add nsw i64 %indvars.iv, -1
  %arrayidx13 = getelementptr inbounds [2 x [12 x i32]], ptr @__const.main.day, i64 0, i64 %leap.0, i64 %8
  %9 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !9
  %add = add nsw i32 %9, %days.1
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond
  %rem14 = srem i32 %days.1, 7
  %cmp15 = icmp eq i32 %rem14, 0
  %.str..str.1 = select i1 %cmp15, ptr @.str, ptr @.str.1
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.1)
