...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z6changePA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %1) #8
  %call14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %call13) #8
  br label %for.cond
...
define dso_local noundef i32 @_Z6changePA100_ii(ptr nofree noundef captures(none) %a, i32 noundef %n) local_unnamed_addr #4 {
entry:
...
for.cond:                                         ; preds = %for.end27, %entry
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.end27 ], [ 0, %entry ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond31.preheader, label %for.body
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv36, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv31 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next32, %for.body16 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv36, i64 %indvars.iv31
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end70
  %indvars.iv51 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next52, %for.end70 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %wide.trip.count39
  br i1 %exitcond55.not, label %for.end73, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv51
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body39 ], [ 0, %for.body33 ]
  %s.1 = phi i32 [ %spec.select29, %for.body39 ], [ %3, %for.body33 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.cond56.preheader, label %for.body39

for.cond56.preheader:                             ; preds = %for.cond37
  br label %for.cond56

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv41, i64 %indvars.iv51
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %spec.select29 = tail call i32 @llvm.smin.i32(i32 %s.1, i32 %4)
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond37, !llvm.loop !14

for.cond56:                                       ; preds = %for.cond56.preheader, %for.body58
  %indvars.iv46 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next47, %for.body58 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count44
  br i1 %exitcond50.not, label %for.end70, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv46, i64 %indvars.iv51
...
if.then:                                          ; preds = %for.end73
  ...
  %wide.trip.count60 = zext nneg i32 %n to i64
  br label %for.cond81

for.cond81:                                       ; preds = %for.body83, %if.then
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body83 ], [ 2, %if.then ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond101, label %for.body83

for.body83:                                       ; preds = %for.cond81
  %arrayidx86 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv56
  %8 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !9
  %9 = add nsw i64 %indvars.iv56, -1
  %arrayidx90 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %9
  store i32 %8, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx92 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv56
...
for.cond101:                                      ; preds = %for.cond81, %for.end119
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.end119 ], [ 2, %for.cond81 ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %wide.trip.count60
  br i1 %exitcond73.not, label %for.end122, label %for.cond104.preheader

for.cond104.preheader:                            ; preds = %for.cond101
  %11 = add nsw i64 %indvars.iv68, -1
  br label %for.cond104

for.cond104:                                      ; preds = %for.cond104.preheader, %for.body106
  %indvars.iv62 = phi i64 [ 2, %for.cond104.preheader ], [ %indvars.iv.next63, %for.body106 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %wide.trip.count60
  br i1 %exitcond67.not, label %for.end119, label %for.body106

for.body106:                                      ; preds = %for.cond104
  %arrayidx110 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv68, i64 %indvars.iv62
...
for.end122:                                       ; preds = %for.cond101
  ...
  %call = call noundef i32 @_Z6changePA100_ii(ptr noalias nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %b, i32 noundef %sub123) #9
