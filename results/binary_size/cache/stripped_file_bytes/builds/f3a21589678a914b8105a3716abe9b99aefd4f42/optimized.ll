...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr noundef nonnull dereferenceable(100) %arrayidx, i1 noundef false, i1 noundef true, i1 noundef false) #9
...
for.cond5:                                        ; preds = %for.inc14, %for.end
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc14 ], [ %2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv2, 0
  br i1 %cmp6, label %for.inc14, label %for.end16

for.inc14:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %words, i64 0, i64 %indvars.iv2
...
for.end16:                                        ; preds = %for.cond5
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %words) #10
  ret i32 0
}
