...
while.cond:                                       ; preds = %for.end135, %entry
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.end135 ], [ %3, %entry ]
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.end135 ], [ %2, %entry ]
  %ans.0 = phi i32 [ %add, %for.end135 ], [ 0, %entry ]
  %4 = trunc nuw i64 %indvars.iv128 to i32
  %cmp = icmp sgt i32 %4, 1
  br i1 %cmp, label %for.cond, label %while.end

for.cond:                                         ; preds = %while.cond, %for.inc25
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc25 ], [ 1, %while.cond ]
  %exitcond80 = icmp eq i64 %indvars.iv76, %indvars.iv126
  br i1 %exitcond80, label %for.cond28, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx2 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv76, i64 1
...
for.cond3:                                        ; preds = %for.body5, %for.body
  ...
  %exitcond = icmp eq i64 %indvars.iv, %indvars.iv126
...
for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv76, i64 %indvars.iv
  %6 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !9
  %spec.select = tail call i32 @llvm.smin.i32(i32 %6, i32 %min.0) #7
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond3, !llvm.loop !10

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc22
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc22 ], [ 1, %for.cond15.preheader ]
  %exitcond75 = icmp eq i64 %indvars.iv71, %indvars.iv126
  br i1 %exitcond75, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv76, i64 %indvars.iv71
...
for.cond28:                                       ; preds = %for.cond, %for.end60
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.end60 ], [ 1, %for.cond ]
  %exitcond95 = icmp eq i64 %indvars.iv91, %indvars.iv126
  br i1 %exitcond95, label %for.end63, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @a, i64 404), i64 0, i64 %indvars.iv91
  %8 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond33

for.cond33:                                       ; preds = %for.body35, %for.body30
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.body35 ], [ 1, %for.body30 ]
  %min.2 = phi i32 [ %spec.select67, %for.body35 ], [ %8, %for.body30 ]
  %exitcond85 = icmp eq i64 %indvars.iv81, %indvars.iv126
  br i1 %exitcond85, label %for.cond50.preheader, label %for.body35

for.cond50.preheader:                             ; preds = %for.cond33
  br label %for.cond50

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv81, i64 %indvars.iv91
  %9 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !9
  %spec.select67 = tail call i32 @llvm.smin.i32(i32 %9, i32 %min.2) #7
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  br label %for.cond33, !llvm.loop !15

for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc58
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc58 ], [ 1, %for.cond50.preheader ]
  %exitcond90 = icmp eq i64 %indvars.iv86, %indvars.iv126
  br i1 %exitcond90, label %for.end60, label %for.inc58

for.inc58:                                        ; preds = %for.cond50
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv86, i64 %indvars.iv91
...
for.cond64:                                       ; preds = %for.inc75, %for.end63
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc75 ], [ 2, %for.end63 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %indvars.iv128
  br i1 %exitcond100.not, label %for.cond78, label %for.inc75

for.inc75:                                        ; preds = %for.cond64
  %indvars.iv.next97 = add nuw nsw i64 %indvars.iv96, 1
  %arrayidx71 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next97, i64 1
  %13 = load i32, ptr %arrayidx71, align 4, !tbaa !5, !invariant.load !9
  %arrayidx74 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @b, i64 0, i64 %indvars.iv96, i64 1
  store i32 %13, ptr %arrayidx74, align 4, !tbaa !5
  br label %for.cond64, !llvm.loop !17

for.cond78:                                       ; preds = %for.cond64, %for.inc87
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.inc87 ], [ 2, %for.cond64 ]
  %exitcond105.not = icmp eq i64 %indvars.iv101, %indvars.iv128
  br i1 %exitcond105.not, label %for.cond90, label %for.inc87

for.inc87:                                        ; preds = %for.cond78
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1
  %arrayidx84 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @a, i64 404), i64 0, i64 %indvars.iv.next102
  %14 = load i32, ptr %arrayidx84, align 4, !tbaa !5, !invariant.load !9
  %arrayidx86 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @b, i64 404), i64 0, i64 %indvars.iv101
  store i32 %14, ptr %arrayidx86, align 4, !tbaa !5
  br label %for.cond78, !llvm.loop !18

for.cond90:                                       ; preds = %for.cond94, %for.cond78
  %indvars.iv111 = phi i64 [ 2, %for.cond78 ], [ %indvars.iv.next112, %for.cond94 ]
  %exitcond115.not = icmp eq i64 %indvars.iv111, %indvars.iv128
  br i1 %exitcond115.not, label %for.cond114, label %for.cond94.preheader
...
for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc108
  %indvars.iv106 = phi i64 [ 2, %for.cond94.preheader ], [ %indvars.iv.next107, %for.inc108 ]
  %exitcond110.not = icmp eq i64 %indvars.iv106, %indvars.iv128
  br i1 %exitcond110.not, label %for.cond90, label %for.inc108, !llvm.loop !19

for.inc108:                                       ; preds = %for.cond94
  %indvars.iv.next107 = add nuw nsw i64 %indvars.iv106, 1
  %arrayidx103 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next112, i64 %indvars.iv.next107
  %15 = load i32, ptr %arrayidx103, align 4, !tbaa !5, !invariant.load !9
  %arrayidx107 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @b, i64 0, i64 %indvars.iv111, i64 %indvars.iv106
  store i32 %15, ptr %arrayidx107, align 4, !tbaa !5
  br label %for.cond94, !llvm.loop !20

for.cond114:                                      ; preds = %for.cond90, %for.inc133
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %for.inc133 ], [ 1, %for.cond90 ]
  %exitcond125.not = icmp eq i64 %indvars.iv121, %indvars.iv128
  br i1 %exitcond125.not, label %for.end135, label %for.cond118

for.cond118:                                      ; preds = %for.cond114, %for.inc130
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.inc130 ], [ 1, %for.cond114 ]
  %exitcond120.not = icmp eq i64 %indvars.iv116, %indvars.iv128
  br i1 %exitcond120.not, label %for.inc133, label %for.inc130

for.inc130:                                       ; preds = %for.cond118
  %arrayidx125 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @b, i64 0, i64 %indvars.iv121, i64 %indvars.iv116
  %16 = load i32, ptr %arrayidx125, align 4, !tbaa !5, !invariant.load !9
  %arrayidx129 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv121, i64 %indvars.iv116
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.end ], [ 1, %for.cond ]
