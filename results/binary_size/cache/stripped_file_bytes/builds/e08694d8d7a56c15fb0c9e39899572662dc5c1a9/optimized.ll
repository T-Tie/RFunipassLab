...
if.then:                                          ; preds = %entry, %land.lhs.true
  ...
  %rem84 = urem i32 %year, 100
  %cmp9 = icmp ne i32 %rem84, 0
  %or.cond6 = and i1 %cmp9, %or.cond
  br i1 %or.cond6, label %if.end22, label %if.else

if.else:                                          ; preds = %if.then
  %rem12 = srem i32 %year, 100
  %cmp15 = icmp sgt i32 %year, 99
  %rem175 = urem i32 %year, 400
  %1 = or i32 %rem175, %rem12
  %2 = icmp eq i32 %1, 0
  %or.cond8 = and i1 %cmp15, %2
