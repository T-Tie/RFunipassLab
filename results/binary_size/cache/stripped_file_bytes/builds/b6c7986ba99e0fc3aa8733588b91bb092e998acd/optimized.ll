...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count23 = zext nneg i32 %smax17 to i64
...
for.cond10:                                       ; preds = %for.end44, %for.cond10.preheader
  %indvars.iv20 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next21, %for.end44 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %if.then53, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body15 ], [ 0, %for.cond10 ]
...
for.cond28.preheader:                             ; preds = %for.cond13
  ...
  %arrayidx38 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %idxprom33
  %5 = trunc nuw nsw i64 %indvars.iv20 to i32
  br label %for.cond28

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv10
  %6 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %idxprom22 = zext nneg i32 %max.0 to i64
  %arrayidx23 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %idxprom22
  %7 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !13
  %cmp24 = icmp sgt i32 %6, %7
  %8 = trunc nuw nsw i64 %indvars.iv10 to i32
  %spec.select = select i1 %cmp24, i32 %8, i32 %max.0
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv13 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next14, %for.body30 ]
  %min.0 = phi i32 [ %5, %for.cond28.preheader ], [ %spec.select3, %for.body30 ]
  %exitcond19.not = icmp eq i64 %indvars.iv13, %wide.trip.count23
  br i1 %exitcond19.not, label %for.end44, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx34 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv13, i64 %idxprom33
  ...
  %11 = trunc nuw nsw i64 %indvars.iv13 to i32
  %spec.select3 = select i1 %cmp39, i32 %11, i32 %min.0
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond28, !llvm.loop !15

for.end44:                                        ; preds = %for.cond28
  %12 = zext i32 %min.0 to i64
  %cmp45 = icmp eq i64 %indvars.iv20, %12
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br i1 %cmp45, label %for.end51, label %for.cond10, !llvm.loop !16
