...
for.cond:                                         ; preds = %for.cond.cleanup10, %entry
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.cond.cleanup10 ], [ %1, %entry ]
  %cmp.i.not = icmp sgt i64 %indvars.iv35, %2
  br i1 %cmp.i.not, label %for.cond29, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %add.ptr13 = getelementptr inbounds [200 x i32], ptr @a, i64 %indvars.iv35
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond1.preheader, %for.body11
  %indvars.iv = phi i64 [ %1, %for.cond1.preheader ], [ %indvars.iv.next, %for.body11 ]
  %cmp.i10.not = icmp sgt i64 %indvars.iv, %2
  br i1 %cmp.i10.not, label %for.cond.cleanup10, label %for.body11
...
for.cond29:                                       ; preds = %for.cond
  %cmp.i8.not = icmp sgt i32 %i, %0
  call void @llvm.assume(i1 noundef %cmp.i8.not)
  ret void
}
