...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.end ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv38, %2
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv38
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.end148
  %indvars.iv95 = phi i64 [ %6, %for.cond14.preheader ], [ %indvars.iv.next96, %for.end148 ]
  %indvars.iv92 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next93, %for.end148 ]
  %sum.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.end148 ]
  %9 = trunc nuw i64 %indvars.iv95 to i32
  %cmp15 = icmp sgt i32 %9, 1
  br i1 %cmp15, label %for.cond17, label %for.end150

for.cond17:                                       ; preds = %for.cond14, %for.end52
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.end52 ], [ 1, %for.cond14 ]
  %exitcond56 = icmp eq i64 %indvars.iv52, %indvars.iv92
  br i1 %exitcond56, label %for.cond56, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond17
  %add.ptr24 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv52
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.body22
  %indvars.iv41 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next42, %for.body22 ]
  %min.0 = phi i32 [ 100000, %for.cond20.preheader ], [ %spec.select, %for.body22 ]
  %exitcond = icmp eq i64 %indvars.iv41, %indvars.iv92
...
for.body22:                                       ; preds = %for.cond20
  %add.ptr27 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv41
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv47 = phi i64 [ 1, %for.cond37.preheader ], [ %indvars.iv.next48, %for.body39 ]
  %exitcond51 = icmp eq i64 %indvars.iv47, %indvars.iv92
  br i1 %exitcond51, label %for.end52, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %add.ptr44 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv47
...
for.cond56:                                       ; preds = %for.cond17, %for.end94
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.end94 ], [ 1, %for.cond17 ]
  %exitcond71 = icmp eq i64 %indvars.iv67, %indvars.iv92
  br i1 %exitcond71, label %for.cond101, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv67
  br label %for.cond59

for.cond59:                                       ; preds = %for.cond59.preheader, %for.body61
  %indvars.iv57 = phi i64 [ 1, %for.cond59.preheader ], [ %indvars.iv.next58, %for.body61 ]
  %min.2 = phi i32 [ 100000, %for.cond59.preheader ], [ %spec.select32, %for.body61 ]
  %exitcond61 = icmp eq i64 %indvars.iv57, %indvars.iv92
  br i1 %exitcond61, label %for.cond78.preheader, label %for.body61

for.cond78.preheader:                             ; preds = %for.cond59
  br label %for.cond78

for.body61:                                       ; preds = %for.cond59
  %gep = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv57
  %12 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select32 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  br label %for.cond59, !llvm.loop !17

for.cond78:                                       ; preds = %for.cond78.preheader, %for.body80
  %indvars.iv62 = phi i64 [ 1, %for.cond78.preheader ], [ %indvars.iv.next63, %for.body80 ]
  %exitcond66 = icmp eq i64 %indvars.iv62, %indvars.iv92
  br i1 %exitcond66, label %for.end94, label %for.body80

for.body80:                                       ; preds = %for.cond78
  %gep34 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv62
  %13 = load i32, ptr %gep34, align 4, !tbaa !5, !invariant.load !13
  %sub86 = sub nsw i32 %13, %min.2
  store i32 %sub86, ptr %gep34, align 4, !tbaa !5
...
for.cond101:                                      ; preds = %for.cond56, %for.end121
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.end121 ], [ 2, %for.cond56 ]
  %exitcond81.not = icmp eq i64 %indvars.iv77, %indvars.iv95
  br i1 %exitcond81.not, label %for.cond125, label %for.cond105.preheader

for.cond105.preheader:                            ; preds = %for.cond101
  %add.ptr109 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv77
  %add.ptr110 = getelementptr inbounds nuw i8, ptr %add.ptr109, i64 440
  br label %for.cond105

for.cond105:                                      ; preds = %for.cond105.preheader, %for.body107
  %indvars.iv72 = phi i64 [ 1, %for.cond105.preheader ], [ %indvars.iv.next73, %for.body107 ]
  %exitcond76 = icmp eq i64 %indvars.iv72, %indvars.iv92
  br i1 %exitcond76, label %for.end121, label %for.body107

for.body107:                                      ; preds = %for.cond105
  %add.ptr113 = getelementptr inbounds nuw i32, ptr %add.ptr110, i64 %indvars.iv72
  %14 = load i32, ptr %add.ptr113, align 4, !tbaa !5, !invariant.load !13
  %add.ptr118 = getelementptr inbounds nuw i32, ptr %add.ptr109, i64 %indvars.iv72
...
for.cond125:                                      ; preds = %for.cond101, %for.end145
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.end145 ], [ 2, %for.cond101 ]
  %exitcond91.not = icmp eq i64 %indvars.iv87, %indvars.iv95
  br i1 %exitcond91.not, label %for.end148, label %for.cond129.preheader

for.cond129.preheader:                            ; preds = %for.cond125
  %invariant.gep35 = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv87
  br label %for.cond129

for.cond129:                                      ; preds = %for.cond129.preheader, %for.body131
  %indvars.iv82 = phi i64 [ 1, %for.cond129.preheader ], [ %indvars.iv.next83, %for.body131 ]
  %exitcond86 = icmp eq i64 %indvars.iv82, %indvars.iv92
  br i1 %exitcond86, label %for.end145, label %for.body131

for.body131:                                      ; preds = %for.cond129
  %gep36 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep35, i64 %indvars.iv82
  %add.ptr137 = getelementptr inbounds nuw i8, ptr %gep36, i64 4
  %15 = load i32, ptr %add.ptr137, align 4, !tbaa !5, !invariant.load !13
  store i32 %15, ptr %gep36, align 4, !tbaa !5
