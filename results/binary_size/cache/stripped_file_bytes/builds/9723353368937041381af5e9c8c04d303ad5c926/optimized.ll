...
entry:
  ...
  %wide.trip.count96 = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc16, %entry
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc16 ], [ 0, %entry ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %wide.trip.count96
  br i1 %exitcond97.not, label %for.cond19.preheader, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond
  %5 = mul nsw i64 %indvars.iv93, %3
  %arrayidx = getelementptr inbounds i32, ptr %vla1, i64 %5
  br label %for.cond2

for.cond19.preheader:                             ; preds = %for.cond
  %sub149 = add i32 %0, -1
  %smax142 = call i32 @llvm.smax.i32(i32 %sub149, i32 noundef 0)
  %wide.trip.count143 = zext nneg i32 %smax142 to i64
  br label %for.cond19

for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv88 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next89, %for.inc13 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %1
  br i1 %exitcond92.not, label %for.inc16, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %6 = mul nuw nsw i64 %indvars.iv88, %1
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc173
  %indvars.iv153 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next154, %for.inc173 ]
  %exitcond157.not = icmp eq i64 %indvars.iv153, %wide.trip.count96
  br i1 %exitcond157.not, label %for.cond176, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv153
  store i32 0, ptr %arrayidx23, align 4, !tbaa !5
  %7 = mul nsw i64 %indvars.iv153, %3
...
for.cond24:                                       ; preds = %for.inc171, %for.body21
  %indvars.iv150 = phi i64 [ %indvars.iv.next151, %for.inc171 ], [ %1, %for.body21 ]
  %cmp25 = icmp sgt i64 %indvars.iv150, 1
  br i1 %cmp25, label %for.cond27, label %for.inc173

for.cond27:                                       ; preds = %for.cond24, %for.inc66
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.inc66 ], [ 0, %for.cond24 ]
  %exitcond112.not = icmp eq i64 %indvars.iv108, %indvars.iv150
  br i1 %exitcond112.not, label %for.cond69, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %8 = mul nuw nsw i64 %indvars.iv108, %1
...
for.cond35:                                       ; preds = %for.body37, %for.body29
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.body37 ], [ 1, %for.body29 ]
  %min.0 = phi i32 [ %spec.select, %for.body37 ], [ %9, %for.body29 ]
  %exitcond102.not = icmp eq i64 %indvars.iv98, %indvars.iv150
  br i1 %exitcond102.not, label %for.cond54.preheader, label %for.body37

for.cond54.preheader:                             ; preds = %for.cond35
  br label %for.cond54

for.body37:                                       ; preds = %for.cond35
  %arrayidx43 = getelementptr inbounds nuw i32, ptr %arrayidx33, i64 %indvars.iv98
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc63
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %for.inc63 ], [ 0, %for.cond54.preheader ]
  %exitcond107.not = icmp eq i64 %indvars.iv103, %indvars.iv150
  br i1 %exitcond107.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond54
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx33, i64 %indvars.iv103
...
for.cond69:                                       ; preds = %for.cond27, %for.inc111
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %for.inc111 ], [ 0, %for.cond27 ]
  %exitcond127.not = icmp eq i64 %indvars.iv123, %indvars.iv150
  br i1 %exitcond127.not, label %for.end113, label %for.body71

for.body71:                                       ; preds = %for.cond69
  %arrayidx76 = getelementptr inbounds nuw i32, ptr %arrayidx31, i64 %indvars.iv123
  %12 = load i32, ptr %arrayidx76, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond77

for.cond77:                                       ; preds = %for.body79, %for.body71
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.body79 ], [ 1, %for.body71 ]
  %min.2 = phi i32 [ %spec.select84, %for.body79 ], [ %12, %for.body71 ]
  %exitcond117.not = icmp eq i64 %indvars.iv113, %indvars.iv150
  br i1 %exitcond117.not, label %for.cond98.preheader, label %for.body79

for.cond98.preheader:                             ; preds = %for.cond77
  br label %for.cond98

for.body79:                                       ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv113, %1
  %gep = getelementptr inbounds nuw i32, ptr %arrayidx76, i64 %13
  %14 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !14
  %spec.select84 = call i32 @llvm.smin.i32(i32 %14, i32 %min.2)
  %indvars.iv.next114 = add nuw nsw i64 %indvars.iv113, 1
  br label %for.cond77, !llvm.loop !18

for.cond98:                                       ; preds = %for.cond98.preheader, %for.inc108
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc108 ], [ 0, %for.cond98.preheader ]
  %exitcond122.not = icmp eq i64 %indvars.iv118, %indvars.iv150
  br i1 %exitcond122.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond98
  %15 = mul nuw nsw i64 %indvars.iv118, %1
  %gep86 = getelementptr inbounds nuw i32, ptr %arrayidx76, i64 %15
  %16 = load i32, ptr %gep86, align 4, !tbaa !5, !invariant.load !14
  %sub107 = sub nsw i32 %16, %min.2
  store i32 %sub107, ptr %gep86, align 4, !tbaa !5
...
for.end113:                                       ; preds = %for.cond69
  %17 = load i32, ptr %arrayidx117, align 4, !tbaa !5
  store i32 %17, ptr %arrayidx23, align 4, !tbaa !5
  br label %for.cond120

for.cond120:                                      ; preds = %for.inc142, %for.end113
  %indvars.iv133 = phi i64 [ %indvars.iv.next134, %for.inc142 ], [ 2, %for.end113 ]
  %exitcond138.not = icmp eq i64 %indvars.iv133, %indvars.iv150
  br i1 %exitcond138.not, label %for.cond145, label %for.cond123.preheader

for.cond123.preheader:                            ; preds = %for.cond120
  %18 = mul nuw nsw i64 %indvars.iv133, %1
...
for.cond123:                                      ; preds = %for.cond123.preheader, %for.inc139
  %indvars.iv128 = phi i64 [ 0, %for.cond123.preheader ], [ %indvars.iv.next129, %for.inc139 ]
  %exitcond132.not = icmp eq i64 %indvars.iv128, %1
  br i1 %exitcond132.not, label %for.inc142, label %for.inc139

for.inc139:                                       ; preds = %for.cond123
  %arrayidx131 = getelementptr inbounds nuw i32, ptr %arrayidx129, i64 %indvars.iv128
  %21 = load i32, ptr %arrayidx131, align 4, !tbaa !5, !invariant.load !14
  %arrayidx138 = getelementptr inbounds nuw i32, ptr %arrayidx136, i64 %indvars.iv128
...
for.cond145:                                      ; preds = %for.cond120, %for.inc168
  %indvars.iv145 = phi i64 [ %indvars.iv.next146, %for.inc168 ], [ 2, %for.cond120 ]
  %exitcond149.not = icmp eq i64 %indvars.iv145, %indvars.iv150
  br i1 %exitcond149.not, label %for.inc171, label %for.cond148.preheader

for.cond148.preheader:                            ; preds = %for.cond145
  %invariant.gep = getelementptr i32, ptr %arrayidx31, i64 %indvars.iv145
  br label %for.cond148

for.cond148:                                      ; preds = %for.cond148.preheader, %for.inc165
  %indvars.iv139 = phi i64 [ 0, %for.cond148.preheader ], [ %indvars.iv.next140, %for.inc165 ]
  %exitcond144.not = icmp eq i64 %indvars.iv139, %wide.trip.count143
  br i1 %exitcond144.not, label %for.inc168, label %for.inc165

for.inc165:                                       ; preds = %for.cond148
  %22 = mul nuw nsw i64 %indvars.iv139, %1
  %gep163 = getelementptr i32, ptr %invariant.gep, i64 %22
  %23 = load i32, ptr %gep163, align 4, !tbaa !5, !invariant.load !14
  %arrayidx164 = getelementptr i8, ptr %gep163, i64 -4
...
for.cond176:                                      ; preds = %for.cond19, %for.inc183
  %indvars.iv158 = phi i64 [ %indvars.iv.next159, %for.inc183 ], [ 0, %for.cond19 ]
  %exitcond162.not = icmp eq i64 %indvars.iv158, %wide.trip.count96
  br i1 %exitcond162.not, label %for.end185, label %for.inc183

for.inc183:                                       ; preds = %for.cond176
  %arrayidx180 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv158
