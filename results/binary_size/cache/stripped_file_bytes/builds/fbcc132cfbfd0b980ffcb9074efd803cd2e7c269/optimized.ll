...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %a) #6
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %b) #6
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %c) #6
...
for.cond6.preheader:                              ; preds = %for.cond
  ...
  %wide.trip.count16 = sext i32 %smax to i64
  br label %for.cond6
...
for.cond38:                                       ; preds = %for.body42, %if.then33
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body42 ], [ %3, %if.then33 ]
  %exitcond17.not = icmp eq i64 %indvars.iv11, %wide.trip.count16
  br i1 %exitcond17.not, label %if.end80, label %for.body42

for.body42:                                       ; preds = %for.cond38
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  br label %for.cond38

for.cond61:                                       ; preds = %for.body65, %lor.lhs.false
...
if.end80:                                         ; preds = %for.cond61, %for.cond38
  call fastcc void @outlined_ir_func_1() #9
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond6

for.end83:                                        ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %c) #9
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %a) #9
...
define internal fastcc void @outlined_ir_func_1() unnamed_addr #5 {
for.end48_to_outline:
  %puts1 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) @str) #9
  ret void
}
...
attributes #5 = { minsize mustprogress nofree norecurse nounwind optsize memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
