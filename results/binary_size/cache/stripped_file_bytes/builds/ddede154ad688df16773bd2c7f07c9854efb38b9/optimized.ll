...
for.cond45.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count86 = zext i32 %add47 to i64
  br label %for.cond45
...
for.cond4:                                        ; preds = %for.inc, %for.body
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc ], [ %indvars.iv, %for.body ]
  %cmp5 = icmp slt i64 %indvars.iv69, %4
  br i1 %cmp5, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [1000 x i8], ptr %z, i64 0, i64 %indvars.iv69
  %5 = load i8, ptr %arrayidx8, align 1, !tbaa !9, !invariant.load !10
  %6 = sub nuw nsw i64 %indvars.iv69, %indvars.iv
...
for.cond14:                                       ; preds = %if.end38, %for.end
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %if.end38 ], [ %indvars.iv, %for.end ]
  %cmp15 = icmp slt i64 %indvars.iv73, %1
  br i1 %cmp15, label %for.cond17.preheader, label %for.end41

for.cond17.preheader:                             ; preds = %for.cond14
  %7 = add nsw i64 %indvars.iv73, %idxprom12
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.body20
  %indvars.iv75 = phi i64 [ %indvars.iv73, %for.cond17.preheader ], [ %indvars.iv.next76, %for.body20 ]
  %p.0 = phi i32 [ 0, %for.cond17.preheader ], [ %spec.select, %for.body20 ]
  %cmp19 = icmp slt i64 %indvars.iv75, %7
  br i1 %cmp19, label %for.body20, label %for.end32

for.body20:                                       ; preds = %for.cond17
  %8 = sub nuw nsw i64 %indvars.iv75, %indvars.iv73
  %arrayidx23 = getelementptr inbounds nuw [20 x i8], ptr %x, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx23, align 1, !tbaa !9, !invariant.load !10
  %arrayidx26 = getelementptr inbounds nuw [1000 x i8], ptr %z, i64 0, i64 %indvars.iv75
...
for.cond45:                                       ; preds = %for.cond45.preheader, %if.end83
  %indvars.iv88 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next89, %if.end83 ]
  %exitcond92 = icmp eq i64 %indvars.iv88, %wide.trip.count
  br i1 %exitcond92, label %for.end86, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %arrayidx56 = getelementptr inbounds nuw [1000 x i32], ptr %h, i64 0, i64 %indvars.iv88
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %for.body54
  %indvars.iv83 = phi i64 [ 0, %for.cond50.preheader ], [ %indvars.iv.next84, %for.body54 ]
  %count.0 = phi i32 [ 0, %for.cond50.preheader ], [ %spec.select60, %for.body54 ]
  %dount.0 = phi i32 [ 0, %for.cond50.preheader ], [ %dount.1, %for.body54 ]
  %exitcond87 = icmp eq i64 %indvars.iv83, %wide.trip.count86
  br i1 %exitcond87, label %for.end73, label %for.body54

for.body54:                                       ; preds = %for.cond50
  %11 = load i32, ptr %arrayidx56, align 4, !tbaa !5, !invariant.load !10
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %h, i64 0, i64 %indvars.iv83
  %12 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !10
  %cmp59.not = icmp sge i32 %11, %12
  %inc61 = zext i1 %cmp59.not to i32
  %spec.select60 = add nuw nsw i32 %count.0, %inc61
...
if.then78:                                        ; preds = %for.end73
  %idxprom79 = and i64 %indvars.iv88, 4294967295
...
for.end86:                                        ; preds = %for.cond45, %if.then78
  %indvars.iv88116 = phi i64 [ %indvars.iv88, %if.then78 ], [ %wide.trip.count, %for.cond45 ]
  %14 = add i32 %conv, 1
  br label %for.cond87

for.cond87:                                       ; preds = %for.inc138, %for.end86
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.inc138 ], [ 0, %for.end86 ]
  %15 = load i32, ptr %n, align 4, !tbaa !5
  %sub88 = sub nsw i32 %conv, %15
  %add89 = add nsw i32 %sub88, 1
  %16 = sext i32 %sub88 to i64
  %cmp90.not = icmp sgt i64 %indvars.iv105, %16
  br i1 %cmp90.not, label %for.end140, label %for.cond92.preheader

for.cond92.preheader:                             ; preds = %for.cond87
  %arrayidx98 = getelementptr inbounds nuw [1000 x i32], ptr %h, i64 0, i64 %indvars.iv105
  %17 = sub i32 %14, %15
  %wide.trip.count96 = zext i32 %17 to i64
  br label %for.cond92

for.cond92:                                       ; preds = %for.cond92.preheader, %for.body96
  %indvars.iv93 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next94, %for.body96 ]
  %count.2 = phi i32 [ 0, %for.cond92.preheader ], [ %spec.select61, %for.body96 ]
  %dount.2 = phi i32 [ 0, %for.cond92.preheader ], [ %dount.3, %for.body96 ]
  %exitcond97 = icmp eq i64 %indvars.iv93, %wide.trip.count96
  br i1 %exitcond97, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond92
  %18 = load i32, ptr %arrayidx98, align 4, !tbaa !5, !invariant.load !10
  %arrayidx100 = getelementptr inbounds nuw [1000 x i32], ptr %h, i64 0, i64 %indvars.iv93
  ...
  %spec.select61 = add nuw nsw i32 %count.2, %inc103
...
for.end115:                                       ; preds = %for.cond92
  ...
  %or.cond62 = select i1 %cmp116, i1 %cmp120, i1 false
  br i1 %or.cond62, label %for.cond122.preheader, label %for.inc138

for.cond122.preheader:                            ; preds = %for.end115
  %smax102 = call i32 @llvm.smax.i32(i32 %15, i32 noundef 0)
  %wide.trip.count103 = zext nneg i32 %smax102 to i64
  br label %for.cond122

for.cond122:                                      ; preds = %for.cond122.preheader, %for.inc130
  %indvars.iv98 = phi i64 [ 0, %for.cond122.preheader ], [ %indvars.iv.next99, %for.inc130 ]
  %exitcond104.not = icmp eq i64 %indvars.iv98, %wide.trip.count103
  br i1 %exitcond104.not, label %for.end132, label %for.inc130

for.inc130:                                       ; preds = %for.cond122
  %20 = add nuw nsw i64 %indvars.iv98, %indvars.iv105
  %arrayidx127 = getelementptr inbounds nuw [1000 x i8], ptr %z, i64 0, i64 %20
  %21 = load i8, ptr %arrayidx127, align 1, !tbaa !9
  %arrayidx129 = getelementptr inbounds nuw [20 x i8], ptr %x, i64 0, i64 %indvars.iv98
...
for.end140:                                       ; preds = %for.cond87
  %cmp48.not109 = icmp sgt i64 %indvars.iv88116, %3
  br i1 %cmp48.not109, label %if.then142, label %if.end144
