...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.end26 ], [ 0, %for.end10 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv47, %4
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax59 = call i32 @llvm.smax.i32(i32 %5, i32 0)
  %wide.trip.count60 = zext nneg i32 %smax59 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond30

for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body18 ], [ 0, %for.cond13 ]
  %7 = load i32, ptr %y2, align 4, !tbaa !5
  %8 = sext i32 %7 to i64
  %cmp17 = icmp slt i64 %indvars.iv44, %8
  br i1 %cmp17, label %for.body18, label %for.end26

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv47, i64 %indvars.iv44
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.end56
  %indvars.iv56 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next57, %for.end56 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond60, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.cond36.preheader
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.cond36.preheader ], [ 0, %for.cond30 ]
...
for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx53 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv53
...
for.cond60:                                       ; preds = %for.cond30, %for.end101
  ...
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.end101 ], [ 0, %for.cond30 ]
  %cmp61 = icmp sgt i32 %10, 0
  br i1 %cmp61, label %for.cond63.preheader, label %for.end104

for.cond63.preheader:                             ; preds = %for.cond60
  %arrayidx78 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 0
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 0
  br label %for.cond63

for.cond63:                                       ; preds = %for.cond63.preheader, %if.end98
  %11 = phi i32 [ %9, %for.cond63.preheader ], [ %.pre68, %if.end98 ]
  %indvars.iv62 = phi i64 [ 0, %for.cond63.preheader ], [ %indvars.iv.next63, %if.end98 ]
  %12 = sext i32 %11 to i64
  %cmp64 = icmp slt i64 %indvars.iv62, %12
  br i1 %cmp64, label %for.body65, label %for.end101

for.body65:                                       ; preds = %for.cond63
  %cmp66 = icmp eq i64 %indvars.iv62, 0
...
if.else80:                                        ; preds = %for.body65
  ...
  %cmp81 = icmp eq i64 %indvars.iv62, %15
  ...
  %arrayidx87 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 %indvars.iv62
