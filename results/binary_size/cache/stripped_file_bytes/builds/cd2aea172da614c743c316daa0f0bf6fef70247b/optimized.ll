...
for.cond2:                                        ; preds = %for.cond, %for.body4
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body4 ], [ %indvars.iv, %for.cond ]
  %cmp3 = icmp sgt i64 %indvars.iv14, 0
...
for.body4:                                        ; preds = %for.cond2
  ...
  %2 = trunc nsw i64 %indvars.iv.next15 to i32
  %call5 = call noundef i32 @_Z6searchii(i32 noundef %2, i32 noundef %0)
  %add = add nuw nsw i32 %call5, 1
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr @num, i64 0, i64 %indvars.iv.next15
  store i32 %add, ptr %arrayidx7, align 4, !tbaa !5
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv17 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next18, %for.body13 ]
...
for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr @num, i64 0, i64 %indvars.iv17
...
for.end21:                                        ; preds = %for.cond11
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %k.0)
...
for.cond.outer:                                   ; preds = %if.then, %entry
  %indvars.iv.ph = phi i64 [ %indvars.iv.next, %if.then ], [ %idxprom1, %entry ]
  %q.0.ph = phi i32 [ %spec.select, %if.then ], [ 0, %entry ]
  br label %for.cond
