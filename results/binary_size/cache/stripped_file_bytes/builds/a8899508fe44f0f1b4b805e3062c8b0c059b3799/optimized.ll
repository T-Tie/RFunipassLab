...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.end48
  %indvars.iv34.in = phi i32 [ %0, %for.cond23.preheader ], [ %indvars.iv34, %for.end48 ]
  %a.0 = phi i32 [ 1, %for.cond23.preheader ], [ %inc50, %for.end48 ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %if.end45
  %indvars.iv30 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next31, %if.end45 ]
  %exitcond38.not = icmp eq i64 %indvars.iv30, %wide.trip.count37
  br i1 %exitcond38.not, label %for.end48, label %for.body28
...
for.cond52:                                       ; preds = %for.cond23, %if.end63
  %.pre43 = phi i32 [ %.pre, %if.end63 ], [ %0, %for.cond23 ]
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %if.end63 ], [ 0, %for.cond23 ]
...
if.end63:                                         ; preds = %if.then59, %for.body55
  %.pre = phi i32 [ %.pre.pre, %if.then59 ], [ %.pre43, %for.body55 ]
