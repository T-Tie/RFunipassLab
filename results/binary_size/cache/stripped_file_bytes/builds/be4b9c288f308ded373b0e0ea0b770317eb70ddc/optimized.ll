...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc8 ], [ 1, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv38, %1
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc27 ], [ 1, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv44, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %10 = add nuw i32 %smax53, 1
  %smax59 = call i32 @llvm.smax.i32(i32 %6, i32 0)
  %11 = add nuw i32 %smax59, 1
  %wide.trip.count60 = zext i32 %11 to i64
  %wide.trip.count54 = zext i32 %10 to i64
  %wide.trip.count = zext i32 %9 to i64
  br label %for.cond30

for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc24 ], [ 1, %for.cond13 ]
  %12 = load i32, ptr %y2, align 4, !tbaa !5
  %13 = sext i32 %12 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv41, %13
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc65
  %indvars.iv56 = phi i64 [ 1, %for.cond30.preheader ], [ %indvars.iv.next57, %for.inc65 ]
  %exitcond61 = icmp eq i64 %indvars.iv56, %wide.trip.count60
  br i1 %exitcond61, label %for.cond68, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc62
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc62 ], [ 1, %for.cond30 ]
  %exitcond55 = icmp eq i64 %indvars.iv50, %wide.trip.count54
  br i1 %exitcond55, label %for.inc65, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv50
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.inc59, %for.body35
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc59 ], [ 1, %for.body35 ]
...
for.inc59:                                        ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv56, i64 %indvars.iv47
  %14 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !15
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv47, i64 %indvars.iv50
...
for.cond68:                                       ; preds = %for.cond30, %for.inc90
  ...
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc90 ], [ 1, %for.cond30 ]
  %18 = sext i32 %17 to i64
  %cmp69.not = icmp sgt i64 %indvars.iv65, %18
  br i1 %cmp69.not, label %for.end92, label %for.cond71

for.cond71:                                       ; preds = %for.cond68, %for.inc87
  %19 = phi i32 [ %.pre68, %for.inc87 ], [ %16, %for.cond68 ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc87 ], [ 1, %for.cond68 ]
  %20 = sext i32 %19 to i64
  %cmp72.not = icmp sgt i64 %indvars.iv62, %20
  br i1 %cmp72.not, label %for.inc90, label %for.body73

for.body73:                                       ; preds = %for.cond71
  %21 = zext i32 %19 to i64
  %cmp74.not = icmp eq i64 %indvars.iv62, %21
  %arrayidx84 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 %indvars.iv62
