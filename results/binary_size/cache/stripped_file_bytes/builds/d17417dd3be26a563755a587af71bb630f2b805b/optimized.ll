...
for.cond:                                         ; preds = %if.end61, %entry
  %indvars.iv38 = phi i32 [ %indvars.iv.next39, %if.end61 ], [ %conv9, %entry ]
  %indvars.iv27 = phi i32 [ %indvars.iv.next28, %if.end61 ], [ 0, %entry ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end61 ], [ 0, %entry ]
  %exitcond23 = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23, label %for.cond67.preheader, label %for.cond13

for.cond67.preheader:                             ; preds = %for.cond
  %smax47 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond24:                                       ; preds = %for.cond24.preheader, %for.body26
  %indvars.iv24 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next25, %for.body26 ]
  %exitcond31.not = icmp eq i64 %indvars.iv24, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond34.preheader, label %for.body26

for.cond34.preheader:                             ; preds = %for.cond24
  %smax35 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
  %wide.trip.count36 = zext nneg i32 %smax35 to i64
  br label %for.cond34

for.body26:                                       ; preds = %for.cond24
  %arrayidx28 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv24
  %4 = load i8, ptr %arrayidx28, align 1, !tbaa !5, !invariant.load !8
  %conv29 = sext i8 %4 to i32
  %putchar11 = call i32 @putchar(i32 noundef %conv29) #7
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond24, !llvm.loop !12

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv32 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next33, %for.body36 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37.not, label %for.end43, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [300 x i8], ptr %h, i64 0, i64 %indvars.iv32
  %5 = load i8, ptr %arrayidx38, align 1, !tbaa !5, !invariant.load !8
  %conv39 = sext i8 %5 to i32
  %putchar10 = call i32 @putchar(i32 noundef %conv39) #7
...
for.cond49.preheader:                             ; preds = %for.end43
  %7 = sext i32 %indvars.iv38 to i64
  %sext = shl i64 %call6, 32
  %8 = ashr exact i64 %sext, 32
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.body51
  %indvars.iv41 = phi i64 [ %7, %for.cond49.preheader ], [ %indvars.iv.next42, %for.body51 ]
  %cmp50 = icmp slt i64 %indvars.iv41, %8
  br i1 %cmp50, label %for.body51, label %if.end77

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds [300 x i8], ptr %s, i64 0, i64 %indvars.iv41
  %9 = load i8, ptr %arrayidx53, align 1, !tbaa !5, !invariant.load !8
  %conv54 = sext i8 %9 to i32
  %putchar9 = call i32 @putchar(i32 noundef %conv54) #7
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv44 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next45, %for.body69 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %if.end77, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx71 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv44
