...
loop:                                             ; preds = %loop, %entry
  %indvars.iv17 = phi i32 [ %indvars.iv.next18, %loop ], [ 1, %entry ]
...
for.cond.preheader:                               ; preds = %loop
  %1 = zext i32 %indvars.iv17 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv19 = phi i64 [ %1, %for.cond.preheader ], [ %indvars.iv.next20, %for.end ]
  %b.0 = phi i32 [ 0, %for.cond.preheader ], [ %b.1, %for.end ]
