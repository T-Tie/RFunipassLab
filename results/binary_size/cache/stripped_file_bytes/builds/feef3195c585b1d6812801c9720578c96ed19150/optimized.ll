...
for.cond.preheader:                               ; preds = %while.body2
  %wide.trip.count43 = and i64 %indvars.iv, 4294967295
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv38 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next39, %for.inc23 ]
  %total.0 = phi i32 [ 0, %for.cond.preheader ], [ %total.1, %for.inc23 ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.end25, label %for.cond11.preheader

for.cond11.preheader:                             ; preds = %for.cond
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv38
  %1 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !12
  %mul = shl nsw i32 %1, 1
  br label %for.cond11

for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv32 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next33, %for.body13 ]
  %total.1 = phi i32 [ %total.0, %for.cond11.preheader ], [ %spec.select, %for.body13 ]
  %exitcond.not = icmp eq i64 %indvars.iv32, %wide.trip.count43
  br i1 %exitcond.not, label %for.inc23, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv32
