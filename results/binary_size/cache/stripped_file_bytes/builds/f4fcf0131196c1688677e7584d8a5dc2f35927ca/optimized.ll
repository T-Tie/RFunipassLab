...
for.body:                                         ; preds = %entry, %if.end66
  %ans.026 = phi i32 [ undef, %entry ], [ %ans.1, %if.end66 ]
  %i.025 = phi i32 [ 0, %entry ], [ %inc, %if.end66 ]
...
if.end66:                                         ; preds = %if.then14, %if.then39, %if.then53, %if.else49, %if.then25
  %ans.1 = phi i32 [ %add20, %if.then14 ], [ %add34, %if.then25 ], [ %add48, %if.then39 ], [ %add62, %if.then53 ], [ %ans.026, %if.else49 ]
...
cleanup:                                          ; preds = %if.end66, %for.body
