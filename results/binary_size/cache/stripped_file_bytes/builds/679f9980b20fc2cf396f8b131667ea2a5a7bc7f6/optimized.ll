...
for.cond13:                                       ; preds = %for.cond13.preheader, %if.end142
  %indvars.iv120 = phi i64 [ %3, %for.cond13.preheader ], [ %indvars.iv.next121, %if.end142 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add97, %if.end142 ]
  %6 = trunc nuw i64 %indvars.iv120 to i32
  %cmp14 = icmp sgt i32 %6, 1
  br i1 %cmp14, label %for.cond16, label %for.end145

for.cond16:                                       ; preds = %for.cond13, %for.end50
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.end50 ], [ 0, %for.cond13 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %indvars.iv120
  br i1 %exitcond88.not, label %for.cond54, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84
  %7 = load i32, ptr %arrayidx20, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.body24 ], [ 1, %for.body18 ]
  %min.0 = phi i32 [ %spec.select, %for.body24 ], [ %7, %for.body18 ]
  %exitcond.not = icmp eq i64 %indvars.iv76, %indvars.iv120
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv76
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv79 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next80, %for.body39 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %indvars.iv120
  br i1 %exitcond83.not, label %for.end50, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv79
...
for.cond54:                                       ; preds = %for.cond16, %for.end91
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.end91 ], [ 0, %for.cond16 ]
  %exitcond103.not = icmp eq i64 %indvars.iv99, %indvars.iv120
  br i1 %exitcond103.not, label %for.end94, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv99
  %10 = load i32, ptr %arrayidx59, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond60

for.cond60:                                       ; preds = %for.body62, %for.body56
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.body62 ], [ 1, %for.body56 ]
  %min.2 = phi i32 [ %spec.select71, %for.body62 ], [ %10, %for.body56 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %indvars.iv120
  br i1 %exitcond93.not, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %arrayidx66 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv89, i64 %indvars.iv99
...
for.cond77:                                       ; preds = %for.cond77.preheader, %for.body79
  %indvars.iv94 = phi i64 [ 0, %for.cond77.preheader ], [ %indvars.iv.next95, %for.body79 ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %indvars.iv120
  br i1 %exitcond98.not, label %for.end91, label %for.body79

for.body79:                                       ; preds = %for.cond77
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
...
for.end94:                                        ; preds = %for.cond54
  ...
  %cmp98.not = icmp eq i64 %indvars.iv120, 2
  br i1 %cmp98.not, label %if.end142, label %for.cond100

for.cond100:                                      ; preds = %for.end94, %for.body102
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.body102 ], [ 1, %for.end94 ]
  %exitcond108.not = icmp eq i64 %indvars.iv104, %indvars.iv120
  br i1 %exitcond108.not, label %for.cond120, label %for.body102

for.body102:                                      ; preds = %for.cond100
  %indvars.iv.next105 = add nuw nsw i64 %indvars.iv104, 1
  %arrayidx106 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next105
  %14 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv104
  store i32 %14, ptr %arrayidx109, align 4, !tbaa !5
  %arrayidx112 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next105
  %15 = load i32, ptr %arrayidx112, align 16, !tbaa !5, !invariant.load !13
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv104
  store i32 %15, ptr %arrayidx115, align 16, !tbaa !5
  br label %for.cond100, !llvm.loop !20

for.cond120:                                      ; preds = %for.cond123, %for.cond100
  %indvars.iv114 = phi i64 [ 1, %for.cond100 ], [ %indvars.iv.next115, %for.cond123 ]
  %exitcond118.not = icmp eq i64 %indvars.iv114, %indvars.iv120
  br i1 %exitcond118.not, label %if.end142, label %for.cond123.preheader
...
for.cond123:                                      ; preds = %for.cond123.preheader, %for.body125
  %indvars.iv109 = phi i64 [ 1, %for.cond123.preheader ], [ %indvars.iv.next110, %for.body125 ]
  %exitcond113.not = icmp eq i64 %indvars.iv109, %indvars.iv120
  br i1 %exitcond113.not, label %for.cond120, label %for.body125, !llvm.loop !21

for.body125:                                      ; preds = %for.cond123
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  %arrayidx131 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next115, i64 %indvars.iv.next110
  %16 = load i32, ptr %arrayidx131, align 4, !tbaa !5, !invariant.load !13
  %arrayidx135 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv114, i64 %indvars.iv109
