...
for.body8:                                        ; preds = %for.cond6
  ...
  %arrayidx30 = getelementptr inbounds [14 x i32], ptr %__const.main.x.4.__const.main.x, i64 0, i64 %idxprom29
  %7 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
  %arrayidx34 = getelementptr inbounds [14 x i32], ptr %__const.main.x.4.__const.main.x, i64 0, i64 %idxprom33
  %8 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !12
  %sub35 = sub nsw i32 %7, %8
  %rem.i = srem i32 %sub35, 7
