...
define dso_local noundef i32 @_Z3getii(i32 noundef %n, i32 noundef %m) #0 {
entry:
...
if.end4:                                          ; preds = %while.body
  ...
  %dec = add nsw i32 %4, -1
  store i32 %dec, ptr %m.addr, align 4, !tbaa !5
...
if.end7:                                          ; preds = %while.end
  ...
  %call = call noundef i32 @_Z3getii(i32 noundef %div, i32 noundef %8)
  %9 = load i32, ptr %n.addr, align 4, !tbaa !5
  %10 = load i32, ptr %m.addr, align 4, !tbaa !5
  %sub = sub nsw i32 %10, 1
  %call8 = call noundef i32 @_Z3getii(i32 noundef %9, i32 noundef %sub)
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3getii(i32 noundef %2, i32 noundef %3)
