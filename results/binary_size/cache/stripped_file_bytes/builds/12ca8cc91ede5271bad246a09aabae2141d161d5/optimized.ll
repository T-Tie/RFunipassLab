...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull %a) #10
  br label %for.cond

for.cond:                                         ; preds = %if.end, %entry
  %f.0 = phi i32 [ 1, %entry ], [ %inc21, %if.end ]
...
for.cond1:                                        ; preds = %for.cond, %for.cond.cleanup8
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.cond.cleanup8 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
if.end:                                           ; preds = %for.cond.cleanup3, %if.else
...
for.cond:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull %mtuta) #9
  call void @_Z11SubtractionPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %mtuta, i32 noundef %sub) #11
