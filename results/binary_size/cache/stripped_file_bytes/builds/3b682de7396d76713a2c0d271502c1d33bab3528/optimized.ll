...
entry:
  ...
  %sub = add i32 %0, -1
  %1 = zext i32 %0 to i64
  %smax89 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count91 = zext nneg i32 %smax89 to i64
  %exitcond86.not = icmp slt i32 %sub, 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc174, %entry
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc174 ], [ 0, %entry ]
  %exitcond92.not = icmp eq i64 %indvars.iv87, %wide.trip.count91
  br i1 %exitcond92.not, label %for.cond177.preheader, label %for.cond1
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc10 ], [ 0, %for.cond ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %1
  br i1 %exitcond30.not, label %for.end12, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv26, i64 %indvars.iv
...
for.end12:                                        ; preds = %for.cond1
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %sum, i64 0, i64 %indvars.iv87
  store i32 %0, ptr %n, align 4, !tbaa !5
  br i1 %exitcond86.not, label %for.inc174, label %for.cond18

for.cond18:                                       ; preds = %for.end12, %for.inc40
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc40 ], [ 0, %for.end12 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count91
  br i1 %exitcond40.not, label %for.cond43, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv36
...
for.cond29:                                       ; preds = %for.body20, %for.inc37
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc37 ], [ 0, %for.body20 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %1
  br i1 %exitcond35.not, label %for.inc40, label %for.inc37

for.inc37:                                        ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
...
for.cond43:                                       ; preds = %for.cond18, %for.inc60
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc60 ], [ 0, %for.cond18 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count91
  br i1 %exitcond51.not, label %for.cond63, label %for.cond46

for.cond46:                                       ; preds = %for.cond43, %for.inc57
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc57 ], [ 0, %for.cond43 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %1
  br i1 %exitcond45.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %row, i64 0, i64 %indvars.iv46, i64 %indvars.iv41
  %4 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !9
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv41, i64 %indvars.iv46
...
for.cond63:                                       ; preds = %for.cond43, %for.inc88
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc88 ], [ 0, %for.cond43 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count91
  br i1 %exitcond62.not, label %for.cond91, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx67 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv57
...
for.cond76:                                       ; preds = %for.body65, %for.inc84
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc84 ], [ 0, %for.body65 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %1
  br i1 %exitcond56.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond76
  %arrayidx82 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv57, i64 %indvars.iv52
...
for.cond94:                                       ; preds = %for.cond91, %for.inc105
  %indvars.iv93 = phi i64 [ 0, %for.cond91 ], [ %indvars.iv.next94, %for.inc105 ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %wide.trip.count91
  br i1 %exitcond97.not, label %for.cond91, label %for.inc105

for.inc105:                                       ; preds = %for.cond94
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %col, i64 0, i64 %indvars.iv93
  %7 = load i32, ptr %arrayidx98, align 4, !tbaa !5, !invariant.load !9
  %arrayidx104 = getelementptr inbounds nuw [100 x i32], ptr %row, i64 0, i64 %indvars.iv93
