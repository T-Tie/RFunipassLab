...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv28 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next29, %for.body4 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv28
  ...
  %5 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv28
  store i32 %spec.select, ptr %5, align 4, !tbaa !5
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  br label %for.cond2, !llvm.loop !13

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc49
  %indvars.iv36.in = phi i32 [ %0, %for.cond23.preheader ], [ %indvars.iv36, %for.inc49 ]
  %a.0 = phi i32 [ 1, %for.cond23.preheader ], [ %inc50, %for.inc49 ]
  %indvars.iv36 = add i32 %indvars.iv36.in, -1
  %exitcond41 = icmp eq i32 %a.0, %2
  br i1 %exitcond41, label %for.cond52, label %for.cond26.preheader
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc46
  %indvars.iv32 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next33, %for.inc46 ]
  %exitcond40.not = icmp eq i64 %indvars.iv32, %wide.trip.count39
  br i1 %exitcond40.not, label %for.inc49, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv32
  %6 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv.next33
...
for.cond52:                                       ; preds = %for.cond23, %for.inc64
  %.pre45 = phi i32 [ %.pre, %for.inc64 ], [ %0, %for.cond23 ]
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc64 ], [ 0, %for.cond23 ]
  %sub53 = add nsw i32 %.pre45, -1
  %8 = sext i32 %sub53 to i64
  %cmp54 = icmp slt i64 %indvars.iv42, %8
  br i1 %cmp54, label %for.body55, label %for.end66

for.body55:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %jishu, i64 0, i64 %indvars.iv42
...
for.inc64:                                        ; preds = %for.body55, %if.then59
  %.pre = phi i32 [ %.pre45, %for.body55 ], [ %.pre.pre, %if.then59 ]
