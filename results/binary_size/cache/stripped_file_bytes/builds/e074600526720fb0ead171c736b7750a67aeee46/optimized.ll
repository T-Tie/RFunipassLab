...
for.end:                                          ; preds = %for.body, %entry
  ...
  %cmp.not.i.i = icmp eq i32 %.lcssa, 0
  br i1 %cmp.not.i.i, label %for.end29, label %_ZSt4sortIPiEvT_S1_.exit
...
for.body4:                                        ; preds = %_ZSt4sortIPiEvT_S1_.exit
  ...
  br i1 %cmp7.not, label %for.end13, label %if.then
...
for.end13:                                        ; preds = %for.body4, %if.then
  %9 = phi i32 [ %.pre, %for.body4 ], [ %.pre20, %if.then ]
  %cmp1513 = icmp sgt i32 %9, 1
  br i1 %cmp1513, label %for.body16, label %for.end29

for.body16:                                       ; preds = %for.end13, %for.inc27
  %10 = phi i32 [ %14, %for.inc27 ], [ %9, %for.end13 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc27 ], [ 1, %for.end13 ]
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv17
...
for.inc27:                                        ; preds = %for.body16, %if.then21
  %14 = phi i32 [ %10, %for.body16 ], [ %.pre21, %if.then21 ]
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %15 = sext i32 %14 to i64
  %cmp15 = icmp slt i64 %indvars.iv.next18, %15
  br i1 %cmp15, label %for.body16, label %for.end29, !llvm.loop !12

for.end29:                                        ; preds = %for.inc27, %for.end, %_ZSt4sortIPiEvT_S1_.exit, %for.end13
...
while.body.i.i.i.i.i:                             ; preds = %land.rhs.i.i.i.i.i
  ...
  br i1 %cmp.i23.i.not.i.i.i, label %_ZSt10__pop_heapIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_RT0_.exit.i.i, label %land.rhs.i.i.i.i.i, !llvm.loop !14
...
while.cond1.i.i:                                  ; preds = %while.cond1.i.i, %while.body.i.i10
  ...
  br i1 %cmp.i.i8.i, label %while.cond1.i.i, label %while.cond4.i.i, !llvm.loop !16
...
while.cond4.i.i:                                  ; preds = %while.cond1.i.i, %while.cond4.i.i
  ...
  br i1 %cmp.i11.i.i, label %while.cond4.i.i, label %while.end8.i.i, !llvm.loop !17
...
if.end.i.i:                                       ; preds = %while.end8.i.i
  ...
  br label %while.body.i.i10, !llvm.loop !18
...
if.then2.i:                                       ; preds = %for.body.i
  ...
  br i1 %cmp.i.i.i.i.i.i, label %if.then.i.i.i.i.i.i, label %if.then2.i.i.i.i.i.i, !prof !20
...
while.body.i.i:                                   ; preds = %if.else.i, %while.body.i.i
  ...
  br i1 %cmp.i.i.i, label %while.body.i.i, label %for.inc.i, !llvm.loop !21
...
for.inc.i:                                        ; preds = %while.body.i.i, %if.else.i, %if.then2.i.i.i.i.i.i, %if.then.i.i.i.i.i.i
  ...
  br i1 %cmp1.not.i, label %_ZSt16__insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_.exit, label %for.body.i, !llvm.loop !22
...
while.body.i.i9:                                  ; preds = %for.body.i7, %while.body.i.i9
  ...
  br i1 %cmp.i.i.i13, label %while.body.i.i9, label %_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_.exit.i, !llvm.loop !21
...
if.then2.i31:                                     ; preds = %for.body.i16
  ...
  br i1 %cmp.i.i.i.i.i.i35, label %if.then.i.i.i.i.i.i40, label %if.else.i.i.i.i.i.i36, !prof !20
...
while.body.i.i26:                                 ; preds = %if.else.i20, %while.body.i.i26
  ...
  br i1 %cmp.i.i.i30, label %while.body.i.i26, label %for.inc.i22, !llvm.loop !21
...
for.inc.i22:                                      ; preds = %while.body.i.i26, %if.else.i20, %if.then2.i.i.i.i.i.i38, %if.else.i.i.i.i.i.i36, %if.then.i.i.i.i.i.i40
  ...
  br i1 %cmp1.not.i25, label %if.end, label %for.body.i16, !llvm.loop !22
...
while.body.i.us:                                  ; preds = %while.cond.us, %while.body.i.us
  ...
  br i1 %cmp.i.us, label %while.body.i.us, label %while.end.i.us, !llvm.loop !13
...
while.body.i.i.us:                                ; preds = %land.rhs.i.i.us
  ...
  br i1 %cmp.i23.i.us, label %land.rhs.i.i.us, label %_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_.exit.us, !llvm.loop !14
...
_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_.exit.us: ; preds = %land.rhs.i.i.us, %while.body.i.i.us, %while.cond.us, %while.end.i.us
  ...
  br i1 %cmp5.not.us, label %return, label %while.cond.us, !llvm.loop !24
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  br i1 %cmp.i23.i, label %land.rhs.i.i, label %_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_.exit, !llvm.loop !14
...
_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_.exit: ; preds = %land.rhs.i.i, %while.body.i.i, %if.end16.i
  ...
  br i1 %cmp5.not, label %return, label %while.cond, !llvm.loop !24
