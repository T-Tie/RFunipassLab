...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %length) #7
  store i32 0, ptr %length, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 440, ptr noundef nonnull align 16 %a) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(440) %a, i8 noundef 0, i64 noundef 440, i1 noundef false) #8
...
while.cond3:                                      ; preds = %while.cond3.preheader, %if.end
  %indvars.iv24 = phi i64 [ 0, %while.cond3.preheader ], [ %indvars.iv.next25, %if.end ]
  %4 = add nuw nsw i64 %indvars.iv24, %3
  %cmp5 = icmp slt i64 %4, %1
  br i1 %cmp5, label %while.body6, label %while.cond, !llvm.loop !12

while.body6:                                      ; preds = %while.cond3
  %arrayidx8 = getelementptr inbounds [110 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
if.end:                                           ; preds = %if.then, %while.body6
  %indvars.iv.next25 = add nsw i64 %indvars.iv24, %2
...
while.end25:                                      ; preds = %while.cond
  ...
  %div22 = lshr i32 %sec.0, 2
  %idxprom29 = zext nneg i32 %div22 to i64
  ...
  %spec.select = select i1 %cmp34, i32 %div22, i32 %mul31
  %idxprom41 = zext nneg i32 %spec.select to i64
  %arrayidx42 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 0, i64 %idxprom41
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !13
  call fastcc void @outlined_ir_func_0(i32 noundef %10)
  call void @llvm.lifetime.end.p0(i64 noundef 440, ptr noundef nonnull %a) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %length) #9
  ret i32 0
}
