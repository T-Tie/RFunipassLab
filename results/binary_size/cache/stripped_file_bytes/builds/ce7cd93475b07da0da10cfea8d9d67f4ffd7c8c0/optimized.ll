...
for.cond:                                         ; preds = %for.end24, %entry
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.end24 ], [ 0, %entry ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond28.preheader, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv9 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next10, %for.body13 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond13.not, label %for.end24, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.end62
  %indvars.iv29 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next30, %for.end62 ]
...
for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body33 ], [ 0, %for.cond28 ]
  %min.4 = phi i32 [ %spec.select7, %for.body33 ], [ 10000, %for.cond28 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select7 = tail call i32 @llvm.smin.i32(i32 %min.4, i32 %2)
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.body50
  %indvars.iv24 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next25, %for.body50 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count22
  br i1 %exitcond28.not, label %for.end62, label %for.body50

for.body50:                                       ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
...
for.cond13:                                       ; preds = %for.cond1, %for.end65
  %5 = phi i32 [ %6, %for.end65 ], [ %1, %for.cond1 ]
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %for.end65 ], [ -1, %for.cond1 ]
  %p.0 = phi i32 [ %inc67, %for.end65 ], [ 1, %for.cond1 ]
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.body23
  %indvars.iv9 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next10, %for.body23 ]
  %exitcond.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond.not, label %for.cond16, label %for.body23, !llvm.loop !20
...
for.cond40:                                       ; preds = %for.cond16, %for.body43
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body43 ], [ 1, %for.cond16 ]
...
for.cond52:                                       ; preds = %for.cond40, %for.body55
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body55 ], [ 1, %for.cond40 ]
