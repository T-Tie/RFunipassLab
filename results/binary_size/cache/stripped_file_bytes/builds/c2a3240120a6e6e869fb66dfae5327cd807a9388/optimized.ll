...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.end ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %b) #7
...
for.cond:                                         ; preds = %for.end27, %entry
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.end27 ], [ 0, %entry ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond31.preheader, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv19 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next20, %for.body16 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv24, i64 %indvars.iv19
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end70
  %indvars.iv39 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next40, %for.end70 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count27
  br i1 %exitcond43.not, label %for.end73, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv39
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body39 ], [ 0, %for.body33 ]
  %s.1 = phi i32 [ %spec.select17, %for.body39 ], [ %3, %for.body33 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond33.not, label %for.cond56.preheader, label %for.body39

for.cond56.preheader:                             ; preds = %for.cond37
  br label %for.cond56

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv29, i64 %indvars.iv39
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !14
  %spec.select17 = tail call i32 @llvm.smin.i32(i32 %s.1, i32 %4)
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  br label %for.cond37, !llvm.loop !18

for.cond56:                                       ; preds = %for.cond56.preheader, %for.body58
  %indvars.iv34 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next35, %for.body58 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond38.not, label %for.end70, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv34, i64 %indvars.iv39
  %5 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !14
...
for.end73:                                        ; preds = %for.cond31
  ...
  %6 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !14
  %cmp76 = icmp sgt i32 %n, 2
  br i1 %cmp76, label %if.then, label %if.end

if.then:                                          ; preds = %for.end73
  %7 = load i32, ptr %a, align 4, !tbaa !5, !invariant.load !14
  store i32 %7, ptr %b, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.body83, %if.then
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body83 ], [ 2, %if.then ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond49.not, label %for.cond101, label %for.body83

for.body83:                                       ; preds = %for.cond81
  %arrayidx86 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv44
  %8 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !14
  ...
  %arrayidx92 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv44
  %10 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !14
...
for.cond101:                                      ; preds = %for.cond81, %for.end119
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.end119 ], [ 2, %for.cond81 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond61.not, label %for.end122, label %for.cond104.preheader
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.body106
  %indvars.iv50 = phi i64 [ 2, %for.cond104.preheader ], [ %indvars.iv.next51, %for.body106 ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count
  br i1 %exitcond55.not, label %for.end119, label %for.body106

for.body106:                                      ; preds = %for.cond104
  %arrayidx110 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv56, i64 %indvars.iv50
  %12 = load i32, ptr %arrayidx110, align 4, !tbaa !5, !invariant.load !14
  %13 = add nsw i64 %indvars.iv50, -1
  ...
  br label %for.cond104, !llvm.loop !22
...
for.end122:                                       ; preds = %for.cond101
  ...
  %call = call noundef i32 @_Z6changePA100_ii(ptr noalias nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %b, i32 noundef %sub123) #8
  %add = add nsw i32 %call, %6
  br label %if.end

if.end:                                           ; preds = %for.end122, %for.end73
  %f.0 = phi i32 [ %add, %for.end122 ], [ %6, %for.end73 ]
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %b) #7
  ret i32 %f.0
}
