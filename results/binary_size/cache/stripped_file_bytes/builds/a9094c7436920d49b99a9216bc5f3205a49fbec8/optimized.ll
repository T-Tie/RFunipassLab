...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 %z) #5
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 %h) #5
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %0 = add i32 %smax28, 1
...
for.cond:                                         ; preds = %if.end61, %entry
  %indvars.iv45 = phi i32 [ %indvars.iv.next46, %if.end61 ], [ %conv9, %entry ]
  %indvars.iv34 = phi i32 [ %indvars.iv.next35, %if.end61 ], [ 0, %entry ]
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %if.end61 ], [ 0, %entry ]
  %exitcond30 = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30, label %for.cond67.preheader, label %for.cond13

for.cond67.preheader:                             ; preds = %for.cond
  %smax54 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.body15:                                       ; preds = %for.cond13
  ...
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv25
...
for.cond24.preheader:                             ; preds = %for.end
  %wide.trip.count37 = zext i32 %indvars.iv34 to i64
  br label %for.cond24

for.cond24:                                       ; preds = %for.cond24.preheader, %for.body26
  %indvars.iv31 = phi i64 [ 0, %for.cond24.preheader ], [ %indvars.iv.next32, %for.body26 ]
  %exitcond38.not = icmp eq i64 %indvars.iv31, %wide.trip.count37
  br i1 %exitcond38.not, label %for.cond34.preheader, label %for.body26

for.cond34.preheader:                             ; preds = %for.cond24
  %smax42 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %wide.trip.count43 = zext nneg i32 %smax42 to i64
  br label %for.cond34

for.body26:                                       ; preds = %for.cond24
  %arrayidx28 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv31
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv39 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next40, %for.body36 ]
  %exitcond44.not = icmp eq i64 %indvars.iv39, %wide.trip.count43
  br i1 %exitcond44.not, label %for.end43, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [300 x i8], ptr %h, i64 0, i64 %indvars.iv39
...
for.cond49.preheader:                             ; preds = %for.end43
  %7 = sext i32 %indvars.iv45 to i64
  %sext = shl i64 %call6, 32
  %8 = ashr exact i64 %sext, 32
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.body51
  %indvars.iv48 = phi i64 [ %7, %for.cond49.preheader ], [ %indvars.iv.next49, %for.body51 ]
  %cmp50 = icmp slt i64 %indvars.iv48, %8
  br i1 %cmp50, label %for.body51, label %if.end77

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds [300 x i8], ptr %s, i64 0, i64 %indvars.iv48
  %9 = load i8, ptr %arrayidx53, align 1, !tbaa !5, !invariant.load !8
  %conv54 = sext i8 %9 to i32
  %putchar16 = call i32 @putchar(i32 %conv54)
  %indvars.iv.next49 = add nsw i64 %indvars.iv48, 1
  br label %for.cond49, !llvm.loop !14

if.end61:                                         ; preds = %for.end
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %indvars.iv.next35 = add nuw i32 %indvars.iv34, 1
  %indvars.iv.next46 = add i32 %indvars.iv45, 1
  br label %for.cond, !llvm.loop !15

for.cond67:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv51 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next52, %for.body69 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %wide.trip.count55
  br i1 %exitcond56.not, label %if.end77, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx71 = getelementptr inbounds nuw [300 x i8], ptr %s, i64 0, i64 %indvars.iv51
...
if.end77:                                         ; preds = %for.cond49, %for.cond67, %for.end43
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %h) #8
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %z) #8
