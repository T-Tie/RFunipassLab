...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 captures(none) dereferenceable(256) %str1) #10
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 captures(none) dereferenceable(256) %str2) #10
...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i15 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
  br i1 %call16.i15, label %land.lhs.true.i16, label %if.then6.i37
...
land.lhs.true.i16:                                ; preds = %if.then6.i10
  ...
  %3 = add i64 %2, -257
  %or.cond.i20 = icmp ult i64 %3, -256
  br i1 %or.cond.i20, label %if.then19.i21, label %if.then6.i37

if.then19.i21:                                    ; preds = %land.lhs.true.i16
  %call24.i22 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
  ...
  br i1 %tobool.not.i27, label %if.then6.i37, label %if.then28.i28

if.then28.i28:                                    ; preds = %if.then19.i21
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i, i32 noundef 2)
  br label %if.then6.i37

if.then6.i37:                                     ; preds = %if.then28.i28, %if.then19.i21, %land.lhs.true.i16, %if.then6.i10
  ...
  %call16.i42 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
  br i1 %call16.i42, label %land.lhs.true.i43, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56

land.lhs.true.i43:                                ; preds = %if.then6.i37
  %_M_width.i5.i44 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i5.i44, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
  %or.cond.i47 = icmp ult i64 %5, -256
...
if.then19.i48:                                    ; preds = %land.lhs.true.i43
  %call24.i49 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
  %call25.i50 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %call24.i49)
  %cmp.i.i51 = icmp eq i32 %call25.i50, -1
  %conv.i52 = zext i1 %cmp.i.i51 to i64
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then6.i37, %land.lhs.true.i43, %if.then19.i48, %if.then28.i55
  %call6 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(256) %str) #12
  %conv = trunc i64 %call6 to i32
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str1) #12
  %conv9 = trunc i64 %call8 to i32
  %cmp.not = icmp slt i32 %conv, %conv9
  br i1 %cmp.not, label %if.then46, label %for.cond.preheader

for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv70 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next71, %for.end ]
  br label %for.cond10
...
for.body13:                                       ; preds = %for.cond10
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv70
  ...
  br i1 %cmp18, label %if.then, label %for.end.split.loop.exit83

if.then:                                          ; preds = %for.body13
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond10, !llvm.loop !23

for.end.split.loop.exit83:                        ; preds = %for.body13
  %9 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.cond10, %for.end.split.loop.exit83
  %j.0.lcssa = phi i32 [ %9, %for.end.split.loop.exit83 ], [ %smax, %for.cond10 ]
...
for.cond21.preheader:                             ; preds = %for.end
  %cmp22.not = icmp eq i64 %indvars.iv70, 0
  call void @llvm.assume(i1 noundef %cmp22.not)
  %call31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(256) %str2)
  %10 = and i64 %call8, 4294967295
  %smax80 = call i32 @llvm.smax.i32(i32 %conv9, i32 %conv)
  %wide.trip.count81 = zext i32 %smax80 to i64
  br label %for.cond33

for.cond33:                                       ; preds = %for.body35, %for.cond21.preheader
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.body35 ], [ %10, %for.cond21.preheader ]
  %exitcond82.not = icmp eq i64 %indvars.iv77, %wide.trip.count81
  br i1 %exitcond82.not, label %if.end49, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %str, i64 0, i64 %indvars.iv77
  %11 = load i8, ptr %arrayidx37, align 1, !tbaa !22, !invariant.load !8
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %11)
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  br label %for.cond33

if.then46:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(256) %str)
  br label %if.end49

if.end49:                                         ; preds = %for.cond33, %if.then46
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull captures(none) %str2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull captures(none) %str1) #11
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull align 16 captures(none) dereferenceable(256) %str) #11
  ret i32 0
}
