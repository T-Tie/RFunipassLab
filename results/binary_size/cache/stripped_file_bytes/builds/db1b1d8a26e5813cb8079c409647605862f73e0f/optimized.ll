...
define dso_local noundef i32 @_Z4findPiii(ptr nofree noundef readonly captures(none) %x, i32 noundef %y, i32 noundef %z) local_unnamed_addr #0 {
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %y, i32 noundef 0)
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local noundef i32 @_Z5countPii(ptr nofree noundef readonly captures(none) %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %smax.i = tail call i32 @llvm.smax.i32(i32 noundef %y, i32 noundef 0)
...
for.cond.i:                                       ; preds = %for.body.i, %for.inc
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body.i ], [ 0, %for.inc ]
  %count.0.i = phi i32 [ %spec.select.i, %for.body.i ], [ 0, %for.inc ]
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 64, ptr noundef nonnull align 16 captures(none) dereferenceable(64) %temp) #6
  br label %while.cond

while.cond:                                       ; preds = %while.end, %entry
  %call14 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 16 dereferenceable(64) %temp)
...
while.body7:                                      ; preds = %while.cond3
  ...
  %.pre = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !9
  br label %while.cond3, !llvm.loop !14

while.end:                                        ; preds = %while.cond3
  %2 = trunc nuw nsw i64 %indvars.iv to i32
  %call11 = call noundef range(i32 0, -2147483648) i32 @_Z5countPii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(64) %temp, i32 noundef %2) #7
  %call12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %call11) #7
  br label %while.cond, !llvm.loop !15

while.end15:                                      ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 64, ptr noundef nonnull align 16 dereferenceable(64) %temp) #7
  ret i32 0
}
