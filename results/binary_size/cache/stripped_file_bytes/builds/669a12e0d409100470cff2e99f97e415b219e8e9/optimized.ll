...
for.cond:                                         ; preds = %if.else, %entry
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %if.else ], [ 0, %entry ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, 200
  br i1 %exitcond15.not, label %for.end62, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [6 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv, i64 %indvars.iv12
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [200 x i32], ptr %a, i64 0, i64 %indvars.iv12
  %0 = load i32, ptr %arrayidx8, align 4, !tbaa !8
  %cmp9 = icmp eq i32 %0, 0
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx10, i64 0, i64 %indvars.iv12
...
land.lhs.true14:                                  ; preds = %for.end
  %arrayidx17 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx15, i64 0, i64 %indvars.iv12
...
land.lhs.true19:                                  ; preds = %land.lhs.true14
  %arrayidx22 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx20, i64 0, i64 %indvars.iv12
...
land.lhs.true24:                                  ; preds = %land.lhs.true19
  %arrayidx27 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx25, i64 0, i64 %indvars.iv12
...
land.lhs.true29:                                  ; preds = %land.lhs.true24
  %arrayidx32 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx30, i64 0, i64 %indvars.iv12
...
if.else:                                          ; preds = %for.end, %land.lhs.true29, %land.lhs.true24, %land.lhs.true19, %land.lhs.true14
  ...
  %arrayidx43 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx15, i64 0, i64 %indvars.iv12
  %7 = load i32, ptr %arrayidx43, align 4, !tbaa !8, !invariant.load !12
  %arrayidx47 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx20, i64 0, i64 %indvars.iv12
  %8 = load i32, ptr %arrayidx47, align 4, !tbaa !8, !invariant.load !12
  %arrayidx52 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx25, i64 0, i64 %indvars.iv12
  %9 = load i32, ptr %arrayidx52, align 4, !tbaa !8, !invariant.load !12
  %arrayidx57 = getelementptr inbounds nuw [200 x i32], ptr %arrayidx30, i64 0, i64 %indvars.iv12
  ...
  %reass.sub10 = sub i32 %10, %7
  %add54 = add i32 %reass.sub10, 43200
