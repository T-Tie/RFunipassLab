...
tailrecurse:                                      ; preds = %for.cond58.preheader, %entry
  %indvars.iv83.in = phi i64 [ %indvars.iv83, %for.cond58.preheader ], [ %0, %entry ]
  %sum.tr = phi i32 [ %add, %for.cond58.preheader ], [ %sum, %entry ]
  %indvars.iv83 = add i64 %indvars.iv83.in, -1
  %smax = tail call i64 @llvm.smax.i64(i64 %indvars.iv83, i64 1)
  %1 = icmp eq i64 %indvars.iv83.in, 1
  br i1 %1, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %2 = trunc nsw i64 %indvars.iv83.in to i32
  %smax65 = tail call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %wide.trip.count46 = zext nneg i32 %smax65 to i64
  %wide.trip.count = and i64 %indvars.iv83.in, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc11
  %indvars.iv43 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next44, %for.inc11 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond14, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx.i = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43
...
for.cond14:                                       ; preds = %for.cond, %for.inc33
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc33 ], [ 0, %for.cond ]
  %exitcond58.not = icmp eq i64 %indvars.iv53, %wide.trip.count46
  br i1 %exitcond58.not, label %for.end35, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18.i = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv53
  %min.3.i5 = load i32, ptr %arrayidx18.i, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc30, %for.body16
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc30 ], [ 0, %for.body16 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond52.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv48, i64 %indvars.iv53
  %4 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %sub25 = sub nsw i32 %4, %min.3.i5
...
for.cond36:                                       ; preds = %for.inc55, %for.end35
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc55 ], [ 0, %for.end35 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %wide.trip.count46
  br i1 %exitcond67.not, label %for.cond58.preheader, label %for.cond39

for.cond58.preheader:                             ; preds = %for.cond36
  %add = add nsw i32 %5, %sum.tr
  br i1 %cmp59, label %for.cond58.preheader.split, label %tailrecurse

for.cond58.preheader.split:                       ; preds = %for.cond58.preheader
  %sub62.le = shl nuw nsw i64 %0, 32
  %sext = add nsw i64 %sub62.le, -4294967296
  %6 = ashr exact i64 %sext, 32
  %smax85 = tail call i64 @llvm.smax.i64(i64 %6, i64 1)
  br label %for.cond58

for.cond39:                                       ; preds = %for.cond36, %for.inc52
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc52 ], [ 1, %for.cond36 ]
  %exitcond.not87 = icmp eq i64 %indvars.iv59, %smax
  br i1 %exitcond.not87, label %for.inc55, label %for.inc52

for.inc52:                                        ; preds = %for.cond39
  %indvars.iv.next60 = add nuw i64 %indvars.iv59, 1
  %arrayidx47 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next60, i64 %indvars.iv62
  %7 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !9
  %arrayidx51 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv59, i64 %indvars.iv62
...
for.cond58:                                       ; preds = %for.cond58.preheader.split, %for.end76
  %indvars.iv74 = phi i64 [ 0, %for.cond58.preheader.split ], [ %indvars.iv.next75, %for.end76 ]
  br label %for.cond61

for.cond61:                                       ; preds = %for.cond58, %for.inc74
  %indvars.iv71 = phi i64 [ 1, %for.cond58 ], [ %indvars.iv.next72, %for.inc74 ]
  %exitcond86.not = icmp eq i64 %indvars.iv71, %smax85
  br i1 %exitcond86.not, label %for.end76, label %for.inc74

for.inc74:                                        ; preds = %for.cond61
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %arrayidx69 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv74, i64 %indvars.iv.next72
  %8 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !9
  %arrayidx73 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv74, i64 %indvars.iv71
...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z3decii(i32 noundef %1, i32 noundef 0) #10
