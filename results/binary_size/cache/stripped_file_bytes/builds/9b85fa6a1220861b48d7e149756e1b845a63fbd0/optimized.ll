...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc30
  %indvars.iv9 = phi i64 [ 1, %for.cond6.preheader ], [ %indvars.iv.next10, %for.inc30 ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end32, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond6
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %h, i64 0, i64 %indvars.iv9
  %2 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
  %arrayidx20 = getelementptr inbounds nuw [30 x i32], ptr %l, i64 0, i64 %indvars.iv9
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc27
  %indvars.iv6 = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next7, %for.inc27 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %indvars.iv9
  br i1 %exitcond.not, label %for.inc30, label %for.body11

for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds nuw [30 x i32], ptr %h, i64 0, i64 %indvars.iv6
...
land.lhs.true:                                    ; preds = %for.body11
  %arrayidx18 = getelementptr inbounds nuw [30 x i32], ptr %l, i64 0, i64 %indvars.iv6
...
for.cond33:                                       ; preds = %for.inc63, %for.end32
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc63 ], [ %6, %for.end32 ]
  %cmp34 = icmp sgt i64 %indvars.iv19, 0
...
for.cond66.preheader:                             ; preds = %for.cond33
  ...
  %wide.trip.count = zext nneg i32 %smax26 to i64
  br label %for.cond66

for.cond38.preheader:                             ; preds = %for.cond33
  %arrayidx45 = getelementptr inbounds nuw [30 x i32], ptr %h, i64 0, i64 %indvars.iv19
  %arrayidx52 = getelementptr inbounds nuw [30 x i32], ptr %r, i64 0, i64 %indvars.iv19
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc61
  %indvars.iv16 = phi i64 [ %1, %for.cond38.preheader ], [ %indvars.iv.next17, %for.inc61 ]
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, -1
  %cmp39 = icmp sgt i64 %indvars.iv.next17, %indvars.iv19
  br i1 %cmp39, label %for.body41, label %for.inc63

for.body41:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds [30 x i32], ptr %h, i64 0, i64 %indvars.iv.next17
...
land.lhs.true47:                                  ; preds = %for.body41
  %arrayidx49 = getelementptr inbounds [30 x i32], ptr %r, i64 0, i64 %indvars.iv.next17
  ...
  %spec.store.select4 = call i32 @llvm.smax.i32(i32 %add50, i32 %10)
  store i32 %spec.store.select4, ptr %arrayidx52, align 4
  br label %for.inc61
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.body68
  %indvars.iv22 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next23, %for.body68 ]
  %m.0 = phi i32 [ 0, %for.cond66.preheader ], [ %spec.select, %for.body68 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond27.not, label %for.end86, label %for.body68

for.body68:                                       ; preds = %for.cond66
  %arrayidx70 = getelementptr inbounds nuw [30 x i32], ptr %l, i64 0, i64 %indvars.iv22
  %11 = load i32, ptr %arrayidx70, align 4, !tbaa !5, !invariant.load !12
  %arrayidx72 = getelementptr inbounds nuw [30 x i32], ptr %r, i64 0, i64 %indvars.iv22
