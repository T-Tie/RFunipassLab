...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %useful) #10
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %sum)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %call1, ptr noundef nonnull align 8 dereferenceable(8) %useful)
  %0 = load double, ptr %useful, align 8, !tbaa !5
  %1 = load double, ptr %sum, align 8, !tbaa !5
  %div = fdiv double %0, %1
  store double %div, ptr @standard, align 8, !tbaa !5
  store i32 2, ptr %i, align 4, !tbaa !9
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %sum)
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %call3, ptr noundef nonnull align 8 dereferenceable(8) %useful)
  %4 = load double, ptr %sum, align 8, !tbaa !5
  %5 = load double, ptr %useful, align 8, !tbaa !5
  call void @_Z5judgedd(double noundef %4, double noundef %5)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 8, ptr %useful) #10
...
; Function Attrs: mustprogress uwtable
define dso_local void @_Z5judgedd(double noundef %sum, double noundef %useful) #3 {
entry:
  %sum.addr = alloca double, align 8
  %useful.addr = alloca double, align 8
  %rate = alloca double, align 8
  store double %sum, ptr %sum.addr, align 8, !tbaa !5
  store double %useful, ptr %useful.addr, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 8, ptr %rate) #10
  %0 = load double, ptr %useful.addr, align 8, !tbaa !5
  %1 = load double, ptr %sum.addr, align 8, !tbaa !5
  %div = fdiv double %0, %1
  store double %div, ptr %rate, align 8, !tbaa !5
  %2 = load double, ptr %rate, align 8, !tbaa !5
  %3 = load double, ptr @standard, align 8, !tbaa !5
  %sub = fsub double %2, %3
  %call = call noundef double @_ZSt3absd(double noundef %sub)
  %cmp = fcmp ole double %call, 5.000000e-02
...
if.else:                                          ; preds = %entry
  %4 = load double, ptr %rate, align 8, !tbaa !5
  %5 = load double, ptr @standard, align 8, !tbaa !5
  %sub3 = fsub double %4, %5
  %cmp4 = fcmp ogt double %sub3, 5.000000e-02
...
if.else8:                                         ; preds = %if.else
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.2)
...
if.end11:                                         ; preds = %if.end, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %rate) #10
  ret void
}
...
define linkonce_odr dso_local noundef double @_ZSt3absd(double noundef %__x) #4 comdat {
entry:
  %__x.addr = alloca double, align 8
  store double %__x, ptr %__x.addr, align 8, !tbaa !5
  %0 = load double, ptr %__x.addr, align 8, !tbaa !5
...
; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) #4 comdat {
entry:
