...
for.cond2:                                        ; preds = %for.inc7, %for.end
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc7 ], [ 1, %for.end ]
...
for.inc7:                                         ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv39
  store i32 1, ptr %arrayidx6, align 4, !tbaa !5
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  br label %for.cond2, !llvm.loop !12

for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc36
  %indvars.iv49 = phi i64 [ %1, %for.cond10.preheader ], [ %indvars.iv.next50, %for.inc36 ]
  %indvars.iv44 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next45, %for.inc36 ]
  %indvars.iv.next50 = add nsw i64 %indvars.iv49, -1
  %cmp11 = icmp sgt i64 %indvars.iv49, 1
  br i1 %cmp11, label %for.cond13.preheader, label %for.cond38

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx19 = getelementptr inbounds [26 x i32], ptr %h, i64 0, i64 %indvars.iv.next50
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc28
  %indvars.iv46 = phi i64 [ %indvars.iv44, %for.cond13.preheader ], [ %indvars.iv.next47, %for.inc28 ]
  %m.0 = phi i32 [ 0, %for.cond13.preheader ], [ %m.1, %for.inc28 ]
  %indvars.iv.next47 = add nsw i64 %indvars.iv46, 1
  %cmp14.not.not = icmp slt i64 %indvars.iv46, %1
  br i1 %cmp14.not.not, label %for.body15, label %for.inc36

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds [26 x i32], ptr %h, i64 0, i64 %indvars.iv.next47
...
if.then:                                          ; preds = %for.body15
  %arrayidx22 = getelementptr inbounds [26 x i32], ptr %q, i64 0, i64 %indvars.iv.next47
...
for.inc36:                                        ; preds = %for.cond13
  %arrayidx32 = getelementptr inbounds [26 x i32], ptr %q, i64 0, i64 %indvars.iv.next50
...
for.cond38:                                       ; preds = %for.cond10, %for.body40
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body40 ], [ 1, %for.cond10 ]
  %m.3 = phi i32 [ %spec.select37, %for.body40 ], [ 0, %for.cond10 ]
  %exitcond56 = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56, label %for.end50, label %for.body40

for.body40:                                       ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [26 x i32], ptr %q, i64 0, i64 %indvars.iv52
  %9 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !13
  %spec.select37 = call i32 @llvm.smax.i32(i32 %m.3, i32 %9)
