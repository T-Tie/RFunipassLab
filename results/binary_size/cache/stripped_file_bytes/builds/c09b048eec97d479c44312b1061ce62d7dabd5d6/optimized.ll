...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %sz) #3
...
for.end33:                                        ; preds = %for.cond5.preheader
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %sz) #4
