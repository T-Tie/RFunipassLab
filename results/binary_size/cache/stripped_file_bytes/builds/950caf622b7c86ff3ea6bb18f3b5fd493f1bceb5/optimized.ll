...
for.cond:                                         ; preds = %for.inc13, %entry
  ...
  %exitcond15.not = icmp eq i32 %k.0, 123
  br i1 %exitcond15.not, label %for.cond16.preheader, label %for.cond3
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body18
  %indvars.iv16 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next17, %for.body18 ]
  %sum.4 = phi i32 [ 0, %for.cond16.preheader ], [ %sum.5, %for.body18 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end31, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [300 x i8], ptr %zfc, i64 0, i64 %indvars.iv16
