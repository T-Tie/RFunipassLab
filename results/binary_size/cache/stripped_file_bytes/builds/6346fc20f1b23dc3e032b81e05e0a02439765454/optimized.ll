...
entry:
  ...
  %arrayidx = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 0
...
for.body6:                                        ; preds = %for.cond3
  ...
  %arrayidx7 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %idxprom
...
cleanup:                                          ; preds = %if.then, %for.cond.cleanup5
...
for.end17:                                        ; preds = %for.cond.cleanup
  call void @llvm.lifetime.start.p0(i64 4, ptr %i18) #7
  store i32 0, ptr %i18, align 4, !tbaa !5
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc28, %for.end17
  %14 = load i32, ptr %i18, align 4, !tbaa !5
  %15 = load i32, ptr %t, align 4, !tbaa !5
  %sub20 = sub nsw i32 %15, 1
  %cmp21 = icmp slt i32 %14, %sub20
  br i1 %cmp21, label %for.body23, label %for.cond.cleanup22

for.cond.cleanup22:                               ; preds = %for.cond19
  store i32 8, ptr %cleanup.dest.slot, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr %i18) #7
  br label %for.end31

for.body23:                                       ; preds = %for.cond19
  %16 = load i32, ptr %i18, align 4, !tbaa !5
  %idxprom24 = sext i32 %16 to i64
  %arrayidx25 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %idxprom24
...
for.inc28:                                        ; preds = %for.body23
  %18 = load i32, ptr %i18, align 4, !tbaa !5
  %inc29 = add nsw i32 %18, 1
  store i32 %inc29, ptr %i18, align 4, !tbaa !5
...
for.end31:                                        ; preds = %for.cond.cleanup22
  ...
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %20)
...
entry:
  ...
  %1 = load i8, ptr %__c.addr, align 1, !tbaa !17
...
!22 = !{!16, !16, i64 0}
!23 = !{!24, !24, i64 0}
!24 = !{!"p1 _ZTSSt8ios_base", !16, i64 0}
!25 = !{!26, !27, i64 16}
...
!30 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !16, i64 0}
!31 = !{!"_ZTSNSt8ios_base6_WordsE", !16, i64 0, !27, i64 8}
!32 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !16, i64 0}
!33 = !{!"_ZTSSt6locale", !34, i64 0}
!34 = !{!"p1 _ZTSNSt6locale5_ImplE", !16, i64 0}
!35 = !{!36, !36, i64 0}
!36 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !16, i64 0}
!37 = !{!38, !41, i64 240}
!38 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !26, i64 0, !15, i64 216, !7, i64 224, !39, i64 225, !40, i64 232, !41, i64 240, !42, i64 248, !43, i64 256}
!39 = !{!"bool", !7, i64 0}
