...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.end26
  %indvars.iv27 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next28, %for.end26 ]
  %max.0 = phi i32 [ 0, %for.cond10.preheader ], [ %spec.select21, %for.end26 ]
...
for.body16:                                       ; preds = %for.cond13
  %arrayidx18 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv24
...
for.end26:                                        ; preds = %for.cond13
  ...
  %15 = add i32 %14, -1
  %spec.select21 = select i1 %cmp38, i32 %15, i32 %max.1
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.body49
  ...
  br i1 %exitcond38.not, label %for.end55, label %for.body49

for.body49:                                       ; preds = %for.cond46
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv33
