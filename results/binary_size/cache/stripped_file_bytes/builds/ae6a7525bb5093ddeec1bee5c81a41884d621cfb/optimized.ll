...
for.cond2:                                        ; preds = %for.inc26, %for.end
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc26 ], [ %2, %for.end ]
...
for.cond5:                                        ; preds = %for.cond2, %for.inc23
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc23 ], [ 0, %for.cond2 ]
  %exitcond.not = icmp eq i64 %indvars.iv12, %indvars.iv15
  br i1 %exitcond.not, label %for.inc26, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %shu, i64 0, i64 %indvars.iv12
  %4 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %shu, i64 0, i64 %indvars.iv.next13
