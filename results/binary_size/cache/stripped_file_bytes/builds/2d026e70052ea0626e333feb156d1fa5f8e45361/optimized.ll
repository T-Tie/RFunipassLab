...
for.cond:                                         ; preds = %for.inc25, %entry
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc25 ], [ 0, %entry ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv
...
for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv16
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  ...
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count24
  br i1 %exitcond40.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body33 ], [ 0, %for.cond28 ]
  %min.4 = phi i32 [ %spec.select14, %for.body33 ], [ 10000, %for.cond28 ]
...
for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv36
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select14 = tail call i32 @llvm.smin.i32(i32 %min.4, i32 %2)
...
for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv31, i64 %indvars.iv36
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond1, %for.inc66
  ...
  %indvars.iv21 = phi i32 [ %indvars.iv.next22, %for.inc66 ], [ -1, %for.cond1 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %7 = add nsw i32 %6, %indvars.iv21
  %8 = sext i32 %sub17 to i64
  %wide.trip.count = zext i32 %7 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond20, %for.body15
  %indvars.iv23 = phi i64 [ 1, %for.body15 ], [ %indvars.iv.next24, %for.cond20 ]
  %cmp18 = icmp slt i64 %indvars.iv23, %8
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv18 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next19, %for.inc34 ]
...
for.inc34:                                        ; preds = %for.cond20
  ...
  %arrayidx29 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv.next24, i64 %indvars.iv.next19
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !9
  %arrayidx33 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv23, i64 %indvars.iv18
  store i32 %9, ptr %arrayidx33, align 4, !tbaa !5
  br label %for.cond20, !llvm.loop !21

for.cond40:                                       ; preds = %for.cond16, %for.inc49
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc49 ], [ 1, %for.cond16 ]
  %cmp42 = icmp slt i64 %indvars.iv26, %8
  br i1 %cmp42, label %for.inc49, label %for.cond52

for.inc49:                                        ; preds = %for.cond40
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr @a, i64 0, i64 %indvars.iv.next27
  %10 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !9
  %arrayidx48 = getelementptr inbounds nuw [1000 x i32], ptr @a, i64 0, i64 %indvars.iv26
  store i32 %10, ptr %arrayidx48, align 4, !tbaa !5
  br label %for.cond40, !llvm.loop !22

for.cond52:                                       ; preds = %for.cond40, %for.inc63
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc63 ], [ 1, %for.cond40 ]
  %cmp54 = icmp slt i64 %indvars.iv29, %8
  br i1 %cmp54, label %for.inc63, label %for.inc66

for.inc63:                                        ; preds = %for.cond52
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %arrayidx58 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv.next30
  %11 = load i32, ptr %arrayidx58, align 16, !tbaa !5, !invariant.load !9
  %arrayidx61 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv29
