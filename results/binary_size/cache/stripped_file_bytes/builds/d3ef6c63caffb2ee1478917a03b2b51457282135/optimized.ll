...
if.then:                                          ; preds = %do.body
  ...
  %call8 = call double @sqrt(double noundef %4) #10, !tbaa !9
...
if.then26:                                        ; preds = %if.else24
  ...
  %call31 = call double @sqrt(double noundef %fneg27) #10, !tbaa !9
...
if.then39:                                        ; preds = %if.then26
  ...
  call fastcc void @outlined_ir_func_0(double noundef %fneg40, double %div34)
  br label %do.cond
...
if.else49:                                        ; preds = %if.then26
  ...
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1)
  call fastcc void @outlined_ir_func_0(double noundef %div37, double %div34)
  br label %do.cond

do.cond:                                          ; preds = %if.then17, %if.then, %if.else24, %if.else49, %if.then39
...
define internal fastcc void @outlined_ir_func_0(double noundef %0, double %1) unnamed_addr #7 {
if.end.exitStub:
  %call45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %0)
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %1)
  tail call fastcc void @outlined_ir_func_0.4()
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.4() unnamed_addr #8 {
if.end.exitStub_after_outline.exitStub:
  %call47 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.3)
  %call48 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call47, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
...
attributes #7 = { minsize mustprogress norecurse optsize memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
