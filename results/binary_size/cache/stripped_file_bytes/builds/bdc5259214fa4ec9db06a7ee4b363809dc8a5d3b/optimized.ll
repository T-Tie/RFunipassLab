...
if.then:                                          ; preds = %for.body
  ...
  tail call void @_Z3daoii(i32 noundef %3, i32 noundef %5) #4
...
for.cond2:                                        ; preds = %for.cond, %for.inc7
  ...
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv3, %3
...
for.inc7:                                         ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [26 x i32], ptr @a, i64 0, i64 %indvars.iv3
  %5 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  %6 = trunc nuw nsw i64 %indvars.iv3 to i32
  tail call void @_Z3daoii(i32 noundef %5, i32 noundef %6) #5
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %.pre = load i32, ptr @n, align 4, !tbaa !5
  br label %for.cond2, !llvm.loop !14

for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv6 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next7, %for.inc28 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond.not, label %for.end30, label %for.body12

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv6
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx16 = getelementptr inbounds nuw [10000 x i32], ptr @b, i64 0, i64 %indvars.iv.next7
