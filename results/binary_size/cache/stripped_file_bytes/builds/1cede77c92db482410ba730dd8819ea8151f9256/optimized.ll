...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %c) #6
...
for.body9:                                        ; preds = %for.cond7
  ...
  %puts12 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.sink) #7
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond7, !llvm.loop !15

for.end35:                                        ; preds = %for.cond7
  %call36 = call i32 @getchar() #7
  %call37 = call i32 @getchar() #7
  %call38 = call i32 @getchar() #7
  %call39 = call i32 @getchar() #7
  %call40 = call i32 @getchar() #7
