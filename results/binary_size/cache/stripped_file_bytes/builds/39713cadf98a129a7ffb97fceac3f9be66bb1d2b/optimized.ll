...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc23 ], [ 0, %entry ]
...
for.cond26.preheader:                             ; preds = %for.cond
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv34, i64 %indvars.iv
  ...
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv34, i64 %indvars.iv
  store i32 %5, ptr %arrayidx14, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv34, i64 %indvars.iv
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc53
  %indvars.iv40 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next41, %for.inc53 ]
  %exitcond46.not = icmp eq i64 %indvars.iv40, %wide.trip.count45
  br i1 %exitcond46.not, label %for.cond56.preheader, label %for.cond29
...
for.cond29:                                       ; preds = %for.cond26, %for.inc50
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc50 ], [ 0, %for.cond26 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond.not, label %for.inc53, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv40, i64 %indvars.iv37
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %arrayidx39 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv40, i64 %indvars.iv.next38
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc78
  %indvars.iv53 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next54, %for.inc78 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count45
  br i1 %exitcond57.not, label %for.cond81.preheader, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %arrayidx69 = getelementptr inbounds [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv53, i64 %idxprom68
  %arrayidx73 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv53
  br label %for.cond59
...
for.cond59:                                       ; preds = %for.cond59.preheader, %for.inc75
  %indvars.iv47 = phi i64 [ 0, %for.cond59.preheader ], [ %indvars.iv.next48, %for.inc75 ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52.not, label %for.inc78, label %for.body61

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv53, i64 %indvars.iv47
...
for.cond81:                                       ; preds = %for.cond81.preheader, %for.inc111
  %indvars.iv63 = phi i64 [ 0, %for.cond81.preheader ], [ %indvars.iv.next64, %for.inc111 ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count67
  br i1 %exitcond68.not, label %for.cond114.preheader, label %for.cond84
...
for.cond84:                                       ; preds = %for.cond81, %for.body86
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.body86 ], [ 0, %for.cond81 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count45
  br i1 %exitcond62.not, label %for.inc111, label %for.body86

for.body86:                                       ; preds = %for.cond84
  %arrayidx90 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv58, i64 %indvars.iv63
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %arrayidx95 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv.next59, i64 %indvars.iv63
...
for.cond114:                                      ; preds = %for.cond114.preheader, %for.inc137
  %indvars.iv74 = phi i64 [ 0, %for.cond114.preheader ], [ %indvars.iv.next75, %for.inc137 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %wide.trip.count67
  br i1 %exitcond78.not, label %for.cond140, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %arrayidx128 = getelementptr inbounds [8 x [8 x i32]], ptr %bj, i64 0, i64 %idxprom125, i64 %indvars.iv74
  %arrayidx132 = getelementptr inbounds nuw [8 x i32], ptr %hd, i64 0, i64 %indvars.iv74
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc134
  %indvars.iv69 = phi i64 [ 0, %for.cond117.preheader ], [ %indvars.iv.next70, %for.inc134 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %wide.trip.count45
  br i1 %exitcond73.not, label %for.inc137, label %for.body119

for.body119:                                      ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv69, i64 %indvars.iv74
...
if.then130:                                       ; preds = %for.body119
  %15 = trunc nuw nsw i64 %indvars.iv69 to i32
...
for.cond140:                                      ; preds = %for.cond114, %for.inc150
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc150 ], [ 0, %for.cond114 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %wide.trip.count45
  br i1 %exitcond83.not, label %for.end152, label %for.body142

for.body142:                                      ; preds = %for.cond140
  %arrayidx144 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv79
  ...
  %cmp147 = icmp eq i64 %indvars.iv79, %18
  br i1 %cmp147, label %if.then148, label %for.inc150

if.then148:                                       ; preds = %for.body142
  %19 = trunc nuw nsw i64 %indvars.iv79 to i32
