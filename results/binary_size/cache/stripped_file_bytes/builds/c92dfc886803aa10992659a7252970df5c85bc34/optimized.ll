...
for.cond:                                         ; preds = %for.inc25, %entry
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc25 ], [ 0, %entry ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond28, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc22 ], [ 0, %for.cond11.preheader ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc63 ], [ 0, %for.cond ]
...
for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body33 ], [ 0, %for.cond28 ]
  %min.4 = phi i32 [ %spec.select29, %for.body33 ], [ 10000, %for.cond28 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond45.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv51
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select29 = tail call i32 @llvm.smin.i32(i32 %min.4, i32 %2)
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc60 ], [ 0, %for.cond48.preheader ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond50.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv46, i64 %indvars.iv51
...
for.cond13:                                       ; preds = %for.cond1, %for.inc66
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc66 ], [ -1, %for.cond1 ]
...
for.body15:                                       ; preds = %for.cond13
  %indvars56 = trunc i64 %indvars.iv50 to i32
  %reass.sub = add nuw i32 %5, 1
  %add = sub i32 %reass.sub, %p.0
  call void @_Z3cuti(i32 noundef %add) #8
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %7 = add nsw i32 %6, %indvars56
  %wide.trip.count = zext i32 %7 to i64
  %8 = sext i32 %6 to i64
  %9 = add nsw i64 %indvars.iv50, %8
  %smax = call i64 @llvm.smax.i64(i64 %9, i64 noundef 1)
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond20, %for.body15
  %indvars.iv38 = phi i64 [ 1, %for.body15 ], [ %indvars.iv.next39, %for.cond20 ]
  %exitcond.not57 = icmp eq i64 %indvars.iv38, %smax
  br i1 %exitcond.not57, label %for.cond40, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv33 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next34, %for.inc34 ]
...
for.cond40:                                       ; preds = %for.cond16, %for.inc49
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc49 ], [ 1, %for.cond16 ]
  %exitcond53.not = icmp eq i64 %indvars.iv41, %smax
  br i1 %exitcond53.not, label %for.cond52, label %for.inc49

for.inc49:                                        ; preds = %for.cond40
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr @a, i64 0, i64 %indvars.iv.next42
  %11 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !9
...
for.cond52:                                       ; preds = %for.cond40, %for.inc63
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc63 ], [ 1, %for.cond40 ]
  %exitcond55.not = icmp eq i64 %indvars.iv44, %smax
  br i1 %exitcond55.not, label %for.inc66, label %for.inc63
...
for.inc63:                                        ; preds = %for.cond52
  ...
  %12 = load i32, ptr %arrayidx58, align 16, !tbaa !5, !invariant.load !9
  %arrayidx61 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr @a, i64 0, i64 %indvars.iv44
  store i32 %12, ptr %arrayidx61, align 16, !tbaa !5
...
for.inc71:                                        ; preds = %for.cond13
  ...
  %call69 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %13)
