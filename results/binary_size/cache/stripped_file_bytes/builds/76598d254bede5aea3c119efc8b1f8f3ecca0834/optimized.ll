...
for.end:                                          ; preds = %for.cond
  ...
  %1 = load i32, ptr %sz, align 16, !tbaa !5
...
for.cond8:                                        ; preds = %if.end, %for.end
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %if.end ], [ 1, %for.end ]
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx12 = getelementptr inbounds nuw [100000 x i32], ptr %sz, i64 0, i64 %indvars.iv10
...
if.then:                                          ; preds = %for.body10
  %call21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4)
  br label %if.end
