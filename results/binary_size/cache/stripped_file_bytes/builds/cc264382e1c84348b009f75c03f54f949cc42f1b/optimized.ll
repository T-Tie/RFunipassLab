...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv37, i64 %indvars.iv
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax58 = call i32 @llvm.smax.i32(i32 %6, i32 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  ...
  %cmp17 = icmp slt i64 %indvars.iv40, %10
  br i1 %cmp17, label %for.body18, label %for.inc27

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv43, i64 %indvars.iv40
...
for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx42 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ans, i64 0, i64 %indvars.iv55, i64 %indvars.iv49
  br label %for.cond36
...
for.body38:                                       ; preds = %for.cond36
  ...
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju1, i64 0, i64 %indvars.iv55, i64 %indvars.iv46
  %12 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ju2, i64 0, i64 %indvars.iv46, i64 %indvars.iv49
...
for.cond64:                                       ; preds = %for.cond30, %for.inc86
  ...
  %cmp65 = icmp slt i64 %indvars.iv64, %16
  br i1 %cmp65, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond64, %for.inc83
  %17 = phi i32 [ %.pre67, %for.inc83 ], [ %14, %for.cond64 ]
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc83 ], [ 0, %for.cond64 ]
  %18 = sext i32 %17 to i64
  %cmp68 = icmp slt i64 %indvars.iv61, %18
  br i1 %cmp68, label %for.body69, label %for.inc86

for.body69:                                       ; preds = %for.cond67
  %sub = add nsw i32 %17, -1
  %19 = zext i32 %sub to i64
  %cmp70 = icmp eq i64 %indvars.iv61, %19
  %arrayidx74 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %ans, i64 0, i64 %indvars.iv64, i64 %indvars.iv61
