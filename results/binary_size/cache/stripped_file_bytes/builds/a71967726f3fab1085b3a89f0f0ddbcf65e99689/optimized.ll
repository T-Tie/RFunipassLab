...
for.cond.preheader:                               ; preds = %entry
  %wide.trip.count9 = zext nneg i32 %n to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond2, %for.cond.preheader
  %indvars.iv6 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next7, %for.cond2 ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, %wide.trip.count9
  br i1 %exitcond10.not, label %for.cond14, label %for.cond2.preheader
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv.next7, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx6, align 4, !tbaa !8, !invariant.load !12
  %arrayidx10 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv6, i64 %indvars.iv
  store i32 %0, ptr %arrayidx10, align 4, !tbaa !8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond2, !llvm.loop !13

for.cond14:                                       ; preds = %for.cond17, %for.cond
  %indvars.iv16 = phi i64 [ 1, %for.cond ], [ %indvars.iv.next17, %for.cond17 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count9
  br i1 %exitcond20.not, label %if.end, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc29
  %indvars.iv11 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next12, %for.inc29 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count9
  br i1 %exitcond15.not, label %for.cond14, label %for.inc29, !llvm.loop !14

for.inc29:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv.next17
  %1 = load i32, ptr %arrayidx24, align 4, !tbaa !8, !invariant.load !12
  %arrayidx28 = getelementptr inbounds nuw [200 x [200 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv16
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.cond16
  ...
  %indvars.iv16 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next17, %for.cond16 ]
  %arrayidx22 = getelementptr inbounds nuw [200 x i32], ptr @a, i64 0, i64 %indvars.iv16
  %sub = sub nsw i32 %2, %min.0
  store i32 %sub, ptr %arrayidx22, align 4, !tbaa !8
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx22.phi.trans.insert = getelementptr inbounds nuw [200 x i32], ptr @a, i64 0, i64 %indvars.iv.next17
