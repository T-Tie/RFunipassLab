...
for.cond:                                         ; preds = %for.body, %if.end10
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ %6, %if.end10 ]
  %days.1 = phi i32 [ %add, %for.body ], [ 0, %if.end10 ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx13 = getelementptr inbounds [2 x [12 x i32]], ptr @__const.main.day, i64 0, i64 %leap.0, i64 %7
  %8 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %add = add nsw i32 %8, %days.1
