...
for.cond13.preheader:                             ; preds = %for.cond1
  %sub = add nsw i32 %1, -1
  %smax70 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc111
  %indvars.iv66 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next67, %for.inc111 ]
  %indvars.iv44 = phi i32 [ %sub, %for.cond13.preheader ], [ %indvars.iv.next45, %for.inc111 ]
  %indvars.iv23 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next24, %for.inc111 ]
  %m.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc111 ]
  %smax63 = call i32 @llvm.smax.i32(i32 %indvars.iv44, i32 0)
  %smax46 = call i32 @llvm.smax.i32(i32 %indvars.iv44, i32 1)
  %exitcond72.not = icmp eq i64 %indvars.iv66, %wide.trip.count71
  br i1 %exitcond72.not, label %for.inc116, label %for.cond17.preheader

for.cond17.preheader:                             ; preds = %for.cond13
  %smax52 = call i32 @llvm.smax.i32(i32 %indvars.iv23, i32 0)
  %5 = sub nsw i64 %2, %indvars.iv66
  %wide.trip.count28 = zext nneg i32 %smax52 to i64
  %wide.trip.count = zext i32 %indvars.iv23 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc35
  %indvars.iv25 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next26, %for.inc35 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.cond38.preheader, label %for.body20

for.cond38.preheader:                             ; preds = %for.cond17
  %wide.trip.count33 = zext i32 %indvars.iv23 to i64
  br label %for.cond38

for.body20:                                       ; preds = %for.cond17
  %arrayidx.i = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv25
  %6 = load i32, ptr %arrayidx.i, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.body.i, %for.body20
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.body.i ], [ 0, %for.body20 ]
  %t.0.i = phi i32 [ %spec.select.i, %for.body.i ], [ %6, %for.body20 ]
  %exitcond16.not.i = icmp eq i64 %indvars.iv11.i, %5
  br i1 %exitcond16.not.i, label %for.cond23.preheader, label %for.body.i

for.cond23.preheader:                             ; preds = %for.cond.i
  br label %for.cond23

for.body.i:                                       ; preds = %for.cond.i
  %arrayidx6.i = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv25, i64 %indvars.iv11.i
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc32
  %indvars.iv19 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next20, %for.inc32 ]
...
for.inc32:                                        ; preds = %for.cond23
  %arrayidx30 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv19
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc57
  %indvars.iv35 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next36, %for.inc57 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count28
  br i1 %exitcond40.not, label %for.end59, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx15.i = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv35
...
for.cond16.i:                                     ; preds = %for.body19.i, %for.body41
  ...
  %t.3.i = phi i32 [ %spec.select7.i, %for.body19.i ], [ %9, %for.body41 ]
...
for.body19.i:                                     ; preds = %for.cond16.i
  %arrayidx23.i = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv.i, i64 %indvars.iv35
  %10 = load i32, ptr %arrayidx23.i, align 4, !tbaa !5, !invariant.load !13
  %spec.select7.i = call i32 @llvm.smin.i32(i32 %t.3.i, i32 %10)
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond16.i, !llvm.loop !17

for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc54
  %indvars.iv30 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next31, %for.inc54 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33
  br i1 %exitcond34.not, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv35
...
for.cond62:                                       ; preds = %for.inc83, %for.end59
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc83 ], [ 0, %for.end59 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count28
  br i1 %exitcond54.not, label %for.cond86.preheader, label %for.cond66

for.cond86.preheader:                             ; preds = %for.cond62
  %wide.trip.count64 = zext nneg i32 %smax63 to i64
  %wide.trip.count58 = zext i32 %indvars.iv44 to i64
  br label %for.cond86

for.cond66:                                       ; preds = %for.cond62, %for.inc80
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc80 ], [ 1, %for.cond62 ]
  %exitcond48.not = icmp eq i64 %indvars.iv41, %wide.trip.count47
  br i1 %exitcond48.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond66
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv49, i64 %indvars.iv.next42
  %13 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !13
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv49, i64 %indvars.iv41
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc108
  %indvars.iv60 = phi i64 [ 0, %for.cond86.preheader ], [ %indvars.iv.next61, %for.inc108 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count64
  br i1 %exitcond65.not, label %for.inc111, label %for.cond91

for.cond91:                                       ; preds = %for.cond86, %for.inc105
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc105 ], [ 1, %for.cond86 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count58
  br i1 %exitcond59.not, label %for.inc108, label %for.inc105

for.inc105:                                       ; preds = %for.cond91
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %arrayidx100 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next56, i64 %indvars.iv60
  %14 = load i32, ptr %arrayidx100, align 4, !tbaa !5, !invariant.load !13
  %arrayidx104 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv60
...
entry:
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %n, i32 0)
...
for.cond:                                         ; preds = %for.body, %if.then
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body ], [ 0, %if.then ]
  %t.0 = phi i32 [ %spec.select, %for.body ], [ %0, %if.then ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %if.end34, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx6 = getelementptr inbounds [100 x i32], ptr %a, i64 %idxprom, i64 %indvars.iv11
...
for.cond16:                                       ; preds = %for.body19, %if.else
  ...
  %t.3 = phi i32 [ %spec.select7, %for.body19 ], [ %2, %if.else ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count15
...
for.body19:                                       ; preds = %for.cond16
  ...
  %spec.select7 = tail call i32 @llvm.smin.i32(i32 %t.3, i32 %3)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
