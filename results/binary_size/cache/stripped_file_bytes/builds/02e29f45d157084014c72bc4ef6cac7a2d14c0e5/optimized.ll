...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond, %for.inc59
  ...
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc59 ], [ 0, %for.cond ]
  %c.0 = phi i32 [ %c.1, %for.inc59 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp11 = icmp slt i64 %indvars.iv46, %5
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc56
  %indvars.iv43 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next44, %for.inc56 ]
  %c.1 = phi i32 [ %c.0, %for.cond13.preheader ], [ %c.2, %for.inc56 ]
  %7 = load i32, ptr %n, align 4, !tbaa !5
  %8 = sext i32 %7 to i64
  %cmp14 = icmp slt i64 %indvars.iv43, %8
  br i1 %cmp14, label %for.cond16.preheader, label %for.inc59

for.cond16.preheader:                             ; preds = %for.cond13
  %arrayidx26 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv46, i64 %indvars.iv43
  %wide.trip.count = zext i32 %7 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc29
  %indvars.iv31 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next32, %for.inc29 ]
...
for.end31.thread:                                 ; preds = %for.cond16
  %.pre4952 = load i32, ptr %m, align 4, !tbaa !5
  br label %for.cond34.preheader

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv46, i64 %indvars.iv31
...
for.end31:                                        ; preds = %for.body18
  ...
  %cmp32 = icmp eq i32 %7, %indvars35.le
...
for.cond34.preheader:                             ; preds = %for.end31.thread, %for.end31
  %.pre4953 = phi i32 [ %.pre4952, %for.end31.thread ], [ %.pre49, %for.end31 ]
  %smax = call i32 @llvm.smax.i32(i32 %.pre4953, i32 0)
  %wide.trip.count41 = zext nneg i32 %smax to i64
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc49
  %indvars.iv36 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next37, %for.inc49 ]
  %exitcond42.not = icmp eq i64 %indvars.iv36, %wide.trip.count41
  br i1 %exitcond42.not, label %if.end, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv36, i64 %indvars.iv43
...
if.end:                                           ; preds = %if.end.loopexit.split.loop.exit, %for.cond34, %for.end31
  %.pre4954 = phi i32 [ %.pre49, %for.end31 ], [ %.pre4953, %for.cond34 ], [ %.pre4953, %if.end.loopexit.split.loop.exit ]
  %b.0 = phi i32 [ 0, %for.end31 ], [ %smax, %for.cond34 ], [ %indvars40.le, %if.end.loopexit.split.loop.exit ]
  %cmp52 = icmp eq i32 %b.0, %.pre4954
