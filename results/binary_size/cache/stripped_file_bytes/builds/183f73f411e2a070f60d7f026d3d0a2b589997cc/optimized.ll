...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) @a) #10
  %conv = trunc i64 %call2 to i32
  %2 = load i32, ptr %n, align 4, !tbaa !22
  %cmp.not = icmp sgt i32 %2, %conv
  br i1 %cmp.not, label %for.end53, label %for.cond3

for.cond3:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.cond3
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond3 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ]
  %add.ptr7 = getelementptr inbounds nuw i8, ptr @a, i64 %indvars.iv
  %3 = load i8, ptr %add.ptr7, align 1, !tbaa !23, !invariant.load !8
  %arrayidx9 = getelementptr inbounds nuw [6 x i8], ptr @b, i64 0, i64 %indvars.iv
  store i8 %3, ptr %arrayidx9, align 1, !tbaa !23
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond3

for.end53:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %4 = load i8, ptr @c, align 16, !tbaa !23
  %cmp54 = icmp slt i8 %4, 1
  br i1 %cmp54, label %if.then55, label %if.else

if.then55:                                        ; preds = %for.end53
  %call56 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) @.str)
  br label %if.end78

if.else:                                          ; preds = %for.end53
  %narrow = add nuw i8 %4, 1
  %add57 = zext i8 %narrow to i32
  %call58 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %add57)
...
for.cond60:                                       ; preds = %if.then68, %if.else
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %if.then68 ], [ 0, %if.else ]
  %5 = load i32, ptr %n, align 4, !tbaa !22
  %cmp62 = icmp slt i32 %5, %conv
  br i1 %cmp62, label %if.then68, label %if.end78

if.then68:                                        ; preds = %for.cond60
  %arrayidx70 = getelementptr inbounds nuw [6 x i8], ptr @b, i64 %indvars.iv28
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx70)
