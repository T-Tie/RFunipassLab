...
while.body:                                       ; preds = %for.cond, %while.body
  %targetBlock = call fastcc i1 @outlined_ir_func_1(ptr noalias nofree noundef nonnull captures(none) dereferenceable(1) %c)
...
while.body8:                                      ; preds = %while.end, %if.end
  ...
  %targetBlock1 = call fastcc i1 @outlined_ir_func_1(ptr noalias nofree noundef nonnull captures(none) dereferenceable(1) %c)
