...
for.body36:                                       ; preds = %for.cond34
  ...
  store i32 %24, ptr %n1, align 4, !tbaa !5
  ...
  store i32 %27, ptr %n2, align 4, !tbaa !5
  %28 = load i32, ptr %sum, align 4, !tbaa !5
  %29 = load i32, ptr %n1, align 4, !tbaa !5
...
for.inc45:                                        ; preds = %for.body36
  ...
  store i32 %inc46, ptr %m, align 4, !tbaa !5
...
for.end47:                                        ; preds = %for.cond34
  ...
  store i32 %32, ptr %arrayidx51, align 4, !tbaa !5
  br label %for.inc52
...
for.body60:                                       ; preds = %for.cond58
  ...
  %arrayidx63 = getelementptr inbounds [100 x i32], ptr %arrayidx62, i64 0, i64 0
  %40 = load i32, ptr %arrayidx63, align 16, !tbaa !5
  %call64 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40)
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond65

for.cond65:                                       ; preds = %for.inc73, %for.body60
...
for.body67:                                       ; preds = %for.cond65
  ...
  %arrayidx69 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom68
  %44 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom70 = sext i32 %44 to i64
  %arrayidx71 = getelementptr inbounds [100 x i32], ptr %arrayidx69, i64 0, i64 %idxprom70
  %45 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %call72 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %45)
  br label %for.inc73
