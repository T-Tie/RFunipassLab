...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv37, %6
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [2 x double], ptr %vla1, i64 %indvars.iv37, i64 %indvars.iv
...
for.end:                                          ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [2 x double], ptr %vla1, i64 %indvars.iv37
  %arrayidx10 = getelementptr inbounds nuw i8, ptr %arrayidx9, i64 8
  %7 = load double, ptr %arrayidx10, align 8, !tbaa !12
  %8 = load double, ptr %arrayidx9, align 16, !tbaa !12
  %div = fdiv double %7, %8
  %arrayidx15 = getelementptr inbounds nuw double, ptr %vla, i64 %indvars.iv37
...
for.cond19:                                       ; preds = %for.cond, %for.inc40
  %9 = phi i32 [ %.pre43, %for.inc40 ], [ %5, %for.cond ]
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc40 ], [ 1, %for.cond ]
  %10 = sext i32 %9 to i64
  %cmp20 = icmp slt i64 %indvars.iv40, %10
  br i1 %cmp20, label %for.body21, label %for.end42

for.body21:                                       ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw double, ptr %vla, i64 %indvars.iv40
  %11 = load double, ptr %arrayidx23, align 8, !tbaa !12
...
for.inc40:                                        ; preds = %if.then, %if.else36, %if.then33
