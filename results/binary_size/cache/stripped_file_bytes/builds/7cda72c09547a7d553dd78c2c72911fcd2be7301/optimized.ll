...
entry:
  ...
  %smax13 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %wide.trip.count14 = zext nneg i32 %smax13 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv24 = phi i32 [ %indvars.iv.next25, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv19 = phi i32 [ %indvars.iv.next20, %for.inc29 ], [ 0, %entry ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc29 ], [ 0, %entry ]
  %g.0 = phi i32 [ %g.3, %for.inc29 ], [ undef, %entry ]
  %exitcond15.not = icmp eq i64 %indvars.iv10, %wide.trip.count14
  br i1 %exitcond15.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv10
...
for.cond33.preheader:                             ; preds = %for.end
  %wide.trip.count22 = zext i32 %indvars.iv19 to i64
  br label %for.cond33
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv16 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next17, %for.inc40 ]
  %exitcond23.not = icmp eq i64 %indvars.iv16, %wide.trip.count22
  br i1 %exitcond23.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv16
  %5 = load i8, ptr %arrayidx37, align 1, !tbaa !5, !invariant.load !8
  %conv38 = sext i8 %5 to i32
  %putchar5 = call i32 @putchar(i32 %conv38)
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv24 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc53 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv27, %7
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv27
