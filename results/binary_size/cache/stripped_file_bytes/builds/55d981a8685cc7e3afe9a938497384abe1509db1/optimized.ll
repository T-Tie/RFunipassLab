...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %6 = phi i32 [ %2, %for.cond16.preheader ], [ %.pre, %for.body19 ]
  %indvars.iv19 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next20, %for.body19 ]
  %sub17 = add nsw i32 %6, -2
  %7 = sext i32 %sub17 to i64
  %cmp18 = icmp slt i64 %indvars.iv19, %7
  br i1 %cmp18, label %for.body19, label %for.end36

for.body19:                                       ; preds = %for.cond16
  %arrayidx21 = getelementptr inbounds nuw [100 x double], ptr %sz, i64 0, i64 %indvars.iv19
...
for.end36:                                        ; preds = %for.cond16
  %idxprom37 = and i64 %indvars.iv19, 4294967295
  %arrayidx38 = getelementptr inbounds nuw [100 x double], ptr %sz, i64 0, i64 %idxprom37
  %9 = load double, ptr %arrayidx38, align 8, !tbaa !9
  %sub39 = fsub double %9, %div
  %cmp40 = fcmp ogt double %sub39, 5.000000e-02
  %sub46 = fsub double %div, %9
