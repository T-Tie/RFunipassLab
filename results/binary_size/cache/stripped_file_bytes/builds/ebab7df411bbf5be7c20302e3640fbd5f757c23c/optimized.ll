...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv85, %2
...
for.cond13.preheader:                             ; preds = %for.cond1
  ...
  %wide.trip.count143 = zext i32 %4 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv85, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc179
  %indvars.iv100 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next101, %for.inc179 ]
  %indvars.iv88 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next89, %for.inc179 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add178, %for.inc179 ]
  %exitcond144.not = icmp eq i64 %indvars.iv100, %wide.trip.count143
  br i1 %exitcond144.not, label %for.inc184, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc23
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.inc23 ], [ %indvars.iv88, %for.cond13 ]
...
for.inc23:                                        ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx19, i64 0, i64 %indvars.iv.next91
...
for.cond30:                                       ; preds = %for.inc39, %for.end25
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc39 ], [ %indvars.iv88, %for.end25 ]
  %exitcond99.not = icmp eq i64 %indvars.iv94, %wide.trip.count
  br i1 %exitcond99.not, label %for.end41, label %for.inc39

for.inc39:                                        ; preds = %for.cond30
  %indvars.iv.next95 = add nuw nsw i64 %indvars.iv94, 1
  %arrayidx35 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx19, i64 0, i64 %indvars.iv.next95
...
for.cond48:                                       ; preds = %for.inc90, %for.end41
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.inc90 ], [ %indvars.iv88, %for.end41 ]
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1
  %exitcond116.not = icmp eq i64 %indvars.iv111, %wide.trip.count
  br i1 %exitcond116.not, label %for.cond94, label %for.cond52

for.cond52:                                       ; preds = %for.cond48, %for.inc60
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.inc60 ], [ %indvars.iv100, %for.cond48 ]
  %Min.1 = phi i32 [ %.sroa.speculated42, %for.inc60 ], [ 10000, %for.cond48 ]
  %9 = trunc nuw i64 %indvars.iv102 to i32
  %cmp53.not = icmp slt i32 %1, %9
  br i1 %cmp53.not, label %for.end62, label %for.inc60

for.inc60:                                        ; preds = %for.cond52
  %arrayidx58 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next112, i64 %indvars.iv102
...
for.end62:                                        ; preds = %for.cond52
  %arrayidx65 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next112, i64 1
...
for.cond68:                                       ; preds = %for.inc80, %for.end62
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.inc80 ], [ %indvars.iv88, %for.end62 ]
  %exitcond110.not = icmp eq i64 %indvars.iv105, %wide.trip.count
  br i1 %exitcond110.not, label %for.inc90, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %indvars.iv.next106 = add nuw nsw i64 %indvars.iv105, 1
  %arrayidx74 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next112, i64 %indvars.iv.next106
...
for.cond94:                                       ; preds = %for.cond48, %for.inc101
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.inc101 ], [ %indvars.iv100, %for.cond48 ]
  %Min.2 = phi i32 [ %.sroa.speculated36, %for.inc101 ], [ 10000, %for.cond48 ]
  %13 = trunc nuw i64 %indvars.iv117 to i32
  %cmp95.not = icmp slt i32 %1, %13
  br i1 %cmp95.not, label %for.end103, label %for.inc101

for.inc101:                                       ; preds = %for.cond94
  %arrayidx99 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv117, i64 1
...
for.cond108:                                      ; preds = %for.inc118, %for.end103
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.inc118 ], [ %indvars.iv88, %for.end103 ]
  %exitcond125.not = icmp eq i64 %indvars.iv120, %wide.trip.count
  br i1 %exitcond125.not, label %for.end120, label %for.inc118

for.inc118:                                       ; preds = %for.cond108
  %indvars.iv.next121 = add nuw nsw i64 %indvars.iv120, 1
  %arrayidx113 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next121, i64 1
...
for.cond127:                                      ; preds = %for.inc169, %for.end120
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %for.inc169 ], [ %indvars.iv88, %for.end120 ]
  %indvars.iv.next136 = add nuw nsw i64 %indvars.iv135, 1
  %exitcond140.not = icmp eq i64 %indvars.iv135, %wide.trip.count
  br i1 %exitcond140.not, label %for.inc179, label %for.cond131

for.cond131:                                      ; preds = %for.cond127, %for.inc139
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.inc139 ], [ %indvars.iv100, %for.cond127 ]
  %Min.3 = phi i32 [ %.sroa.speculated30, %for.inc139 ], [ 10000, %for.cond127 ]
  %16 = trunc nuw i64 %indvars.iv126 to i32
  %cmp132.not = icmp slt i32 %1, %16
  br i1 %cmp132.not, label %for.end141, label %for.inc139

for.inc139:                                       ; preds = %for.cond131
  %arrayidx137 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv126, i64 %indvars.iv.next136
...
for.end141:                                       ; preds = %for.cond131
  %arrayidx144 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx19, i64 0, i64 %indvars.iv.next136
...
for.cond147:                                      ; preds = %for.inc159, %for.end141
  %indvars.iv129 = phi i64 [ %indvars.iv.next130, %for.inc159 ], [ %indvars.iv88, %for.end141 ]
...
for.inc159:                                       ; preds = %for.cond147
  ...
  %arrayidx153 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next130, i64 %indvars.iv.next136
...
for.inc179:                                       ; preds = %for.cond127
  ...
  %arrayidx177 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next89, i64 %indvars.iv.next89
