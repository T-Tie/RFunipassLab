...
entry:
  ...
  br i1 %cmp33, label %for.cond1.preheader, label %for.cond10.preheader.for.end29_crit_edge

for.cond1.preheader:                              ; preds = %entry, %for.inc7
  %1 = phi i32 [ %5, %for.inc7 ], [ %0, %entry ]
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc7 ], [ 0, %entry ]
  %cmp231 = icmp sgt i32 %1, 0
  br i1 %cmp231, label %for.body3, label %for.cond1.preheader.for.inc7_crit_edge
...
for.cond10.preheader:                             ; preds = %for.inc7
  %cmp1137 = icmp sgt i32 %5, 0
  br i1 %cmp1137, label %for.cond13.preheader.us.preheader, label %for.cond10.preheader.for.end29_crit_edge

for.cond10.preheader.for.end29_crit_edge:         ; preds = %entry, %for.cond10.preheader
  %.lcssa68 = phi i32 [ %5, %for.cond10.preheader ], [ %0, %entry ]
  %.pre64 = zext i32 %.lcssa68 to i64
  br label %for.end29

for.cond13.preheader.us.preheader:                ; preds = %for.cond10.preheader
  %wide.trip.count56 = zext nneg i32 %5 to i64
...
for.cond13.preheader.us:                          ; preds = %for.cond13.preheader.us.preheader, %for.cond13.for.inc27_crit_edge.us
  %indvars.iv53 = phi i64 [ 0, %for.cond13.preheader.us.preheader ], [ %indvars.iv.next54, %for.cond13.for.inc27_crit_edge.us ]
  br label %for.body15.us

for.body15.us:                                    ; preds = %for.cond13.preheader.us, %for.inc21.us
  %indvars.iv50 = phi i64 [ 0, %for.cond13.preheader.us ], [ %indvars.iv.next51, %for.inc21.us ]
  %arrayidx19.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv53, i64 %indvars.iv50
...
for.inc21.us:                                     ; preds = %for.body15.us
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next51, %wide.trip.count56
...
for.cond13.for.inc27_crit_edge.us:                ; preds = %for.inc21.us
  ...
  br i1 %exitcond57.not, label %for.end29, label %for.cond13.preheader.us, !llvm.loop !12

for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body3 ], [ 0, %for.cond1.preheader ]
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv47, i64 %indvars.iv
...
for.end29:                                        ; preds = %for.cond13.for.inc27_crit_edge.us, %for.cond10.preheader.for.end29_crit_edge, %for.end29.loopexit
  %.pre-phi65 = phi i64 [ %.pre64, %for.cond10.preheader.for.end29_crit_edge ], [ %wide.trip.count56, %for.end29.loopexit ], [ %wide.trip.count56, %for.cond13.for.inc27_crit_edge.us ]
  %a.1 = phi i32 [ 0, %for.cond10.preheader.for.end29_crit_edge ], [ %8, %for.end29.loopexit ], [ 0, %for.cond13.for.inc27_crit_edge.us ]
  %b.1 = phi i32 [ 0, %for.cond10.preheader.for.end29_crit_edge ], [ %9, %for.end29.loopexit ], [ 0, %for.cond13.for.inc27_crit_edge.us ]
  br label %for.cond30

for.cond30:                                       ; preds = %for.end45, %for.end29
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.end45 ], [ %.pre-phi65, %for.end29 ]
  %d.0 = phi i32 [ %d.2, %for.end45 ], [ -1, %for.end29 ]
  %indvars.iv.next62 = add nsw i64 %indvars.iv61, -1
  %indvars = trunc i64 %indvars.iv.next62 to i32
...
for.cond34.preheader:                             ; preds = %for.cond30
  %idxprom37 = and i64 %indvars.iv.next62, 4294967295
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv58 = phi i64 [ %.pre-phi65, %for.cond34.preheader ], [ %indvars.iv.next59, %for.body36 ]
  %cmp35 = icmp sgt i64 %indvars.iv58, 0
  br i1 %cmp35, label %for.body36, label %for.end45

for.body36:                                       ; preds = %for.cond34
  %indvars.iv.next59 = add nsw i64 %indvars.iv58, -1
  %arrayidx40 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %idxprom37, i64 %indvars.iv.next59
...
for.end45.split.loop.exit:                        ; preds = %for.body36
  %12 = trunc nsw i64 %indvars.iv.next59 to i32
  br label %for.end45

for.end45:                                        ; preds = %for.cond34, %for.end45.split.loop.exit
  %c.2 = phi i32 [ %indvars, %for.end45.split.loop.exit ], [ -1, %for.cond34 ]
  %d.2 = phi i32 [ %12, %for.end45.split.loop.exit ], [ %d.0, %for.cond34 ]
  %cmp46 = icmp sgt i32 %c.2, -1
  br i1 %cmp46, label %for.end51, label %for.cond30, !llvm.loop !17
