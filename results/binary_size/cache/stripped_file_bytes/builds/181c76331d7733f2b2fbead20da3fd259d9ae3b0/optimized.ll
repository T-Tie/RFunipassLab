...
if.end7:                                          ; preds = %while.body, %while.end
  %m.addr.05 = phi i32 [ %m.tr, %while.end ], [ %m.addr.0, %while.body ]
  %div = sdiv i32 %n, %m.addr.05
  %call = tail call noundef i32 @_Z3getii(i32 noundef %div, i32 noundef %m.addr.05) #6
  %sub = add nsw i32 %m.addr.05, -1
...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3getii(i32 noundef %1, i32 noundef %1) #9
