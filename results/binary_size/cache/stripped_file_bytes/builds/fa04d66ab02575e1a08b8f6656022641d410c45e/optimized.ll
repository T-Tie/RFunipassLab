; ModuleID = '/tmp/tmp1qxfdmt8.cpp'
source_filename = "/tmp/tmp1qxfdmt8.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %word) #11
...
for.body:                                         ; preds = %for.cond
  ...
  %arraydecay2 = getelementptr inbounds [100 x i8], ptr %word, i64 0, i64 0
  %call3 = call i64 @strlen(ptr noundef %arraydecay2) #12
  %add = add i64 %conv, %call3
  %add4 = add i64 %add, 1
  %conv5 = trunc i64 %add4 to i32
  store i32 %conv5, ptr %len, align 4, !tbaa !5
  %3 = load i32, ptr %len, align 4, !tbaa !5
  %conv6 = zext i32 %3 to i64
  %arraydecay7 = getelementptr inbounds [100 x i8], ptr %word, i64 0, i64 0
  %call8 = call i64 @strlen(ptr noundef %arraydecay7) #12
  %add9 = add i64 %call8, 1
  %cmp10 = icmp eq i64 %conv6, %add9
  br i1 %cmp10, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %arraydecay11 = getelementptr inbounds [100 x i8], ptr %word, i64 0, i64 0
  ...
  %dec = add i32 %4, -1
  store i32 %dec, ptr %len, align 4, !tbaa !5
  br label %if.end25

if.else:                                          ; preds = %for.body
  %5 = load i32, ptr %len, align 4, !tbaa !5
  %cmp13 = icmp ule i32 %5, 80
  br i1 %cmp13, label %if.then14, label %if.else18

if.then14:                                        ; preds = %if.else
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  %arraydecay16 = getelementptr inbounds [100 x i8], ptr %word, i64 0, i64 0
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call15, ptr noundef %arraydecay16)
  br label %if.end

if.else18:                                        ; preds = %if.else
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %arraydecay20 = getelementptr inbounds [100 x i8], ptr %word, i64 0, i64 0
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call19, ptr noundef %arraydecay20)
  %arraydecay22 = getelementptr inbounds [100 x i8], ptr %word, i64 0, i64 0
  %call23 = call i64 @strlen(ptr noundef %arraydecay22) #12
  %conv24 = trunc i64 %call23 to i32
  store i32 %conv24, ptr %len, align 4, !tbaa !5
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr %word) #11
