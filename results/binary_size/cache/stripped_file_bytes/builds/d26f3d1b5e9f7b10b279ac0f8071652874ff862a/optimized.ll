...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 104, ptr noundef nonnull %s) #5
  call void @llvm.lifetime.start.p0(i64 noundef 104, ptr noundef nonnull align 16 %d) #5
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv33 = phi i64 [ %1, %for.cond2.preheader ], [ %indvars.iv.next34, %for.inc24 ]
  %indvars.iv28 = phi i64 [ %3, %for.cond2.preheader ], [ %indvars.iv.next29, %for.inc24 ]
  %indvars.iv.next34 = add nsw i64 %indvars.iv33, -1
  %cmp3 = icmp sgt i64 %indvars.iv33, 0
...
for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx12 = getelementptr inbounds [26 x i32], ptr %s, i64 0, i64 %indvars.iv.next34
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc18
  %indvars.iv30 = phi i64 [ %indvars.iv28, %for.cond5.preheader ], [ %indvars.iv.next31, %for.inc18 ]
  %k.0 = phi i32 [ 0, %for.cond5.preheader ], [ %k.1, %for.inc18 ]
  %indvars.iv.next31 = add nsw i64 %indvars.iv30, 1
  %cmp6 = icmp slt i64 %indvars.iv.next31, %1
  br i1 %cmp6, label %for.body7, label %for.inc24

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds [26 x i32], ptr %d, i64 0, i64 %indvars.iv.next31
...
land.lhs.true:                                    ; preds = %for.body7
  ...
  %arrayidx14 = getelementptr inbounds [26 x i32], ptr %s, i64 0, i64 %indvars.iv.next31
  %6 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !12
  %cmp15.not = icmp slt i32 %5, %6
  %spec.select = select i1 %cmp15.not, i32 %k.0, i32 %4
  br label %for.inc18
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx23 = getelementptr inbounds [26 x i32], ptr %d, i64 0, i64 %indvars.iv.next34
  store i32 %inc21, ptr %arrayidx23, align 4, !tbaa !5
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, -1
  br label %for.cond2, !llvm.loop !14

for.cond26:                                       ; preds = %for.cond26.preheader, %for.body28
  %indvars.iv36 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next37, %for.body28 ]
  %k.2 = phi i32 [ 0, %for.cond26.preheader ], [ %spec.select25, %for.body28 ]
  %exitcond.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [26 x i32], ptr %d, i64 0, i64 %indvars.iv36
  %7 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
  %spec.select25 = call i32 @llvm.smax.i32(i32 %7, i32 %k.2)
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond26, !llvm.loop !15

for.end38:                                        ; preds = %for.cond26
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %k.2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #6
  call void @llvm.lifetime.end.p0(i64 noundef 104, ptr noundef nonnull %d) #6
  call void @llvm.lifetime.end.p0(i64 noundef 104, ptr noundef nonnull %s) #6
  ret i32 0
}
