...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc46
  %indvars.iv11 = phi i32 [ %7, %for.cond18.preheader ], [ %indvars.iv.next12, %for.inc46 ]
  %9 = phi i32 [ %n.0, %for.cond18.preheader ], [ %dec, %for.inc46 ]
  %cmp19 = icmp sgt i32 %9, -1
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc43
  %indvars.iv7 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next8, %for.inc43 ]
  %exitcond15.not = icmp eq i64 %indvars.iv7, %wide.trip.count14
  br i1 %exitcond15.not, label %for.inc46, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx27 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv7
  %11 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %arrayidx29 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv.next8
  %12 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc65
  %indvars.iv16 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next17, %for.inc65 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.end67, label %for.body52

for.body52:                                       ; preds = %for.cond49
  %cmp54 = icmp eq i64 %indvars.iv16, %10
  %13 = getelementptr inbounds nuw i32, ptr %vla4, i64 %indvars.iv16
