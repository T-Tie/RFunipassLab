...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc47
  %indvars.iv66 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next67, %for.inc47 ]
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc44
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc44 ], [ 0, %for.cond37.preheader ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count70
  br i1 %exitcond65.not, label %for.inc47, label %for.inc44
...
for.cond73:                                       ; preds = %for.cond73.preheader, %for.inc81
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc81 ], [ 0, %for.cond73.preheader ]
  %exitcond83.not = icmp eq i64 %indvars.iv78, %wide.trip.count70
  br i1 %exitcond83.not, label %for.end83, label %for.inc81
