...
for.body36:                                       ; preds = %for.cond34
  ...
  %arrayidx38 = getelementptr inbounds [100 x [100 x i32]], ptr %s, i64 0, i64 %idxprom37
...
if.then42:                                        ; preds = %for.body36
  ...
  store i32 %27, ptr %c, align 4, !tbaa !5
  %28 = load i32, ptr %j, align 4, !tbaa !5
  store i32 %28, ptr %d, align 4, !tbaa !5
  br label %for.end45
...
for.end51:                                        ; preds = %if.then47, %for.cond30
  ...
  store i32 %mul, ptr %result, align 4, !tbaa !5
  %36 = load i32, ptr %result, align 4, !tbaa !5
