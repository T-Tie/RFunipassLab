...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc10 ], [ 1, %entry ]
  %sub = add nsw i32 %0, -1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv6, i64 %indvars.iv
  %4 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !9
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv6, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond17, %for.cond
  ...
  %indvars.iv12 = phi i64 [ 1, %for.cond ], [ %indvars.iv.next13, %for.cond17 ]
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc29
  %6 = phi i32 [ %5, %for.cond17.preheader ], [ %.pre15, %for.inc29 ]
...
for.inc29:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv9, i64 %indvars.iv.next13
  %8 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv9, i64 %indvars.iv12
