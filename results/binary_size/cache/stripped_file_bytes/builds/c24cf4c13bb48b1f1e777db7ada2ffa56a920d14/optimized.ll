...
if.end:                                           ; preds = %if.then, %entry
  %cmp1.not8 = icmp sgt i32 %x, %num
  br i1 %cmp1.not8, label %for.end, label %for.body

for.body:                                         ; preds = %if.end, %for.inc
  %i.09 = phi i32 [ %inc5, %for.inc ], [ %x, %if.end ]
...
if.then3:                                         ; preds = %for.body
  tail call void @_Z6divideii(i32 noundef %div, i32 noundef %i.09)
  br label %for.inc
...
entry:
  ...
  br i1 %cmp.not6, label %for.end11, label %for.body

for.cond2.preheader:                              ; preds = %for.body
  %1 = icmp slt i32 %4, 1
  br i1 %1, label %for.end11, label %for.body4
...
for.body4:                                        ; preds = %for.cond2.preheader, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 1, %for.cond2.preheader ]
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv11
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call7, i8 noundef signext %retval.0.i.i.i)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %11 = load i32, ptr %n, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp3.not.not = icmp slt i64 %indvars.iv11, %12
  br i1 %cmp3.not.not, label %for.body4, label %for.end11, !llvm.loop !40

for.end11:                                        ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit, %entry, %for.cond2.preheader
