...
for.cond:                                         ; preds = %for.inc35, %entry
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc35 ], [ 0, %entry ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, 1000
  br i1 %exitcond30.not, label %for.end37, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv25, i64 %indvars.iv
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv25
...
for.end37:                                        ; preds = %land.lhs.true29, %for.cond
  %wide.trip.count = and i64 %indvars.iv25, 4294967295
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond34.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond34.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv31
  ...
  %reass.add38 = sub i32 %9, %6
  %reass.mul39 = mul i32 %reass.add38, 3600
  %reass.sub40 = sub i32 %11, %8
  %12 = add i32 %reass.sub40, 43200
  %13 = add i32 %12, %reass.mul39
  %14 = add i32 %13, %reass.mul
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %14)
