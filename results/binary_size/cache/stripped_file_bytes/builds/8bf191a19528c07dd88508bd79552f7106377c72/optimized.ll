...
if.then2:                                         ; preds = %if.end
  ...
  %call = tail call noundef i32 @_Z6daodanii(i32 noundef %4, i32 noundef %3) #6
  %add5 = add nuw nsw i32 %call, 1
  %spec.select.i = tail call noundef i32 @llvm.smax.i32(i32 %add5, i32 %accumulator.tr.ph)
  br label %tailrecurse.outer
...
for.end:                                          ; preds = %for.cond
  %call2 = tail call noundef i32 @_Z6daodanii(i32 noundef 0, i32 noundef 31999) #7
