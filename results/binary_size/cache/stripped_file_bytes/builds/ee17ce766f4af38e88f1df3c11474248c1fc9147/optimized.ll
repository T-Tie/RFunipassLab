...
for.cond9.preheader:                              ; preds = %if.then
  %5 = sext i32 %4 to i64
  %wide.trip.count25 = sext i32 %3 to i64
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc
  %indvars.iv20 = phi i64 [ %5, %for.cond9.preheader ], [ %indvars.iv.next21, %for.inc ]
  %total.0 = phi i32 [ 0, %for.cond9.preheader ], [ %add, %for.inc ]
  %exitcond26.not = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26.not, label %for.inc82.gvnsink.split, label %for.inc
...
for.cond20.preheader:                             ; preds = %if.else17
  %8 = sext i32 %3 to i64
  %wide.trip.count18 = sext i32 %4 to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc27
  %indvars.iv14 = phi i64 [ %8, %for.cond20.preheader ], [ %indvars.iv.next15, %for.inc27 ]
  %total.1 = phi i32 [ 0, %for.cond20.preheader ], [ %add26, %for.inc27 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %for.inc82.gvnsink.split, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %9 = add nsw i64 %indvars.iv14, -1
...
for.cond42.preheader:                             ; preds = %if.else39
  ...
  %wide.trip.count12 = sext i32 %3 to i64
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc49
  %indvars.iv8 = phi i64 [ %11, %for.cond42.preheader ], [ %indvars.iv.next9, %for.inc49 ]
  %total.2 = phi i32 [ 0, %for.cond42.preheader ], [ %add48, %for.inc49 ]
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc82.gvnsink.split, label %for.inc49

for.inc49:                                        ; preds = %for.cond42
  %12 = add nsw i64 %indvars.iv8, -1
...
for.inc82.gvnsink.split:                          ; preds = %for.cond62, %for.cond42, %for.cond20, %for.cond9
  ...
  %spec.select5 = select i1 %cmp73, ptr @.str.2, ptr @.str.3
  %call77 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select5)
  br label %for.inc82
