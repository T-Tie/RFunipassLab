...
while.cond1:                                      ; preds = %while.cond1.backedge, %entry
  %indvars.iv17 = phi i32 [ 0, %entry ], [ %indvars.iv17.be, %while.cond1.backedge ]
...
for.cond.preheader:                               ; preds = %while.cond1
  %wide.trip.count25 = zext i32 %indvars.iv17 to i64
  br label %for.cond
...
while.cond1.backedge:                             ; preds = %if.end9, %for.end25
  %indvars.iv17.be = phi i32 [ %indvars.iv.next18, %if.end9 ], [ 0, %for.end25 ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv20 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next21, %for.inc23 ]
  %total.0 = phi i32 [ 0, %for.cond.preheader ], [ %total.1, %for.inc23 ]
  %exitcond26.not = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end25, label %for.cond11.preheader
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv14 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next15, %for.body13 ]
  %total.1 = phi i32 [ %total.0, %for.cond11.preheader ], [ %spec.select, %for.body13 ]
  %exitcond.not = icmp eq i64 %indvars.iv14, %wide.trip.count25
  br i1 %exitcond.not, label %for.inc23, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv14
