...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end24
  %indvars.iv27 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next28, %if.end24 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %if.end24 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.cond28.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %input, i64 0, i64 %indvars.iv27
  br label %for.cond5

for.cond28.preheader:                             ; preds = %for.cond2
  %smax37 = call i32 @llvm.smax.i32(i32 %k.0, i32 1)
  %wide.trip.count = zext nneg i32 %smax37 to i64
  br label %for.cond28

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %input, i64 0, i64 %indvars.iv24
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv33 = phi i64 [ 1, %for.cond28.preheader ], [ %indvars.iv.next34, %for.body30 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond38.not, label %for.end36, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %output, i64 0, i64 %indvars.iv33
