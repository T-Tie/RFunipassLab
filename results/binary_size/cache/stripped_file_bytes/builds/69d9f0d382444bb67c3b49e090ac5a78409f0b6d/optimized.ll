...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull dereferenceable(10000) %words) #9
...
for.end16:                                        ; preds = %for.cond5
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %words) #11
  ret i32 0
}
