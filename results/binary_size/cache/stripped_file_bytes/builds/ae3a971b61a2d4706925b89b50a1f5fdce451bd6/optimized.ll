...
for.cond:                                         ; preds = %if.end20, %entry
  %indvars.iv44 = phi i32 [ %indvars.iv.next45, %if.end20 ], [ %conv7, %entry ]
  %indvars.iv39 = phi i32 [ %indvars.iv.next40, %if.end20 ], [ 0, %entry ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %if.end20 ], [ 0, %entry ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %if.then25, label %for.cond8
...
for.cond28.preheader:                             ; preds = %for.cond8
  %wide.trip.count42 = zext i32 %indvars.iv39 to i64
  br label %for.cond28

for.body10:                                       ; preds = %for.cond8
  %0 = add nuw nsw i64 %indvars.iv, %indvars.iv30
  %arrayidx12 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %0
  %1 = load i8, ptr %arrayidx12, align 1, !tbaa !5, !invariant.load !8
  %arrayidx15 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv
  %2 = load i8, ptr %arrayidx15, align 1, !tbaa !5, !invariant.load !8
  %cmp17.not = icmp eq i8 %1, %2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %cmp17.not, label %for.cond8, label %if.end20, !llvm.loop !9
...
if.then25:                                        ; preds = %for.cond
  %call27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %a) #8
  br label %if.end51

for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv36 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next37, %for.body30 ]
  %exitcond43.not = icmp eq i64 %indvars.iv36, %wide.trip.count42
  br i1 %exitcond43.not, label %for.end37, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv36
  %3 = load i8, ptr %arrayidx32, align 1, !tbaa !5, !invariant.load !8
...
for.end37:                                        ; preds = %for.cond28
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %c) #8
  %4 = sext i32 %indvars.iv44 to i64
  %sext50 = shl i64 %call4, 32
  %5 = ashr exact i64 %sext50, 32
  br label %for.cond41

for.cond41:                                       ; preds = %for.body43, %for.end37
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body43 ], [ %4, %for.end37 ]
  %cmp42 = icmp slt i64 %indvars.iv47, %5
  br i1 %cmp42, label %for.body43, label %if.end51

for.body43:                                       ; preds = %for.cond41
  %arrayidx45 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv47
  %6 = load i8, ptr %arrayidx45, align 1, !tbaa !5, !invariant.load !8
