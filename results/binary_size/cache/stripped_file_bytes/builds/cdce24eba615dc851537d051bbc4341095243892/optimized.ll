...
for.cond:                                         ; preds = %for.inc25, %entry
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc25 ], [ 0, %entry ]
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv9 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next10, %for.inc22 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond13.not, label %for.inc25, label %for.inc22
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv29 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next30, %for.inc63 ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv24 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next25, %for.inc60 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count22
  br i1 %exitcond28.not, label %for.inc63, label %for.inc60
