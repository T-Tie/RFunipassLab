...
for.cond10:                                       ; preds = %if.end34, %if.end
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %if.end34 ], [ 3, %if.end ]
...
for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv21
...
if.end34.sink.split:                              ; preds = %if.else23, %if.then17
  ...
  %.ph28 = phi i32 [ %7, %if.then17 ], [ %6, %if.else23 ]
...
if.end34:                                         ; preds = %if.end34.sink.split, %if.else23
  ...
  %9 = phi i32 [ %6, %if.else23 ], [ %.ph28, %if.end34.sink.split ]
