...
print:                                            ; preds = %land.lhs.true19
  ...
  tail call void @_Z6resultP3stu(ptr noundef nonnull align 8 dereferenceable(112) %7)
  ret i32 0
}
...
define dso_local void @_Z6resultP3stu(ptr noundef nonnull align 8 dereferenceable(112) %x) local_unnamed_addr #3 {
entry:
...
if.then:                                          ; preds = %entry
  tail call fastcc void @outlined_ir_func_1(ptr noundef nonnull align 8 dereferenceable(112) %x)
  %putchar = tail call i32 @putchar(i32 noundef 10) #8
  br label %if.end

if.else:                                          ; preds = %entry
  tail call void @_Z6resultP3stu(ptr noundef nonnull align 8 dereferenceable(112) %0)
  tail call fastcc void @outlined_ir_func_1(ptr noundef nonnull align 8 dereferenceable(112) %x)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %putchar3 = tail call i32 @putchar(i32 noundef 10) #8
  ret void
}
...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) unnamed_addr #4 {
...
define internal fastcc void @outlined_ir_func_1(ptr noundef nonnull align 8 dereferenceable(112) %0) unnamed_addr #5 {
if.then_after_outline.exitStub:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull align 8 dereferenceable(112) %0)
  ...
  %putchar = tail call i32 @putchar(i32 noundef %conv) #8
