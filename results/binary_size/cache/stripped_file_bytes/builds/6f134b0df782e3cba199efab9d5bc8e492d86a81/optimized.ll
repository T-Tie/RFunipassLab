...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %words) #9
...
while.cond:                                       ; preds = %if.end22, %entry
  %0 = phi i32 [ %dec, %if.end22 ], [ %.pr, %entry ]
  %temp.0 = phi i32 [ %temp.2, %if.end22 ], [ 0, %entry ]
  %sum.0 = phi i32 [ %sum.2, %if.end22 ], [ 0, %entry ]
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #11
...
if.then6:                                         ; preds = %if.then
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %words)
  br label %if.end22

if.else:                                          ; preds = %if.then
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef nonnull %words)
...
if.else16:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call17, ptr noundef nonnull %words)
...
if.end22:                                         ; preds = %if.then6, %if.else, %if.else16
  %temp.2 = phi i32 [ 0, %if.else16 ], [ 1, %if.then6 ], [ %inc15, %if.else ]
  %sum.2 = phi i32 [ %add21, %if.else16 ], [ %add, %if.then6 ], [ %add14, %if.else ]
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %words) #10
  ret i32 0
}
