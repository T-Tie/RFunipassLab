...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %num100) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %num50) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %num20) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %num10) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %num5) #9
  call void @llvm.lifetime.start.p0(i64 4, ptr %num1) #9
...
if.then8:                                         ; preds = %if.end
  ...
  %div9 = sdiv i32 %6, 50
  store i32 %div9, ptr %num50, align 4, !tbaa !5
  %7 = load i32, ptr %money, align 4, !tbaa !5
  %8 = load i32, ptr %num50, align 4, !tbaa !5
  %mul10 = mul nsw i32 50, %8
  %sub11 = sub nsw i32 %7, %mul10
  store i32 %sub11, ptr %money, align 4, !tbaa !5
  %9 = load i32, ptr %num50, align 4, !tbaa !5
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
...
if.end17:                                         ; preds = %if.else14, %if.then8
  ...
  %div18 = sdiv i32 %10, 20
  %cmp19 = icmp sgt i32 %div18, 0
  br i1 %cmp19, label %if.then20, label %if.else26

if.then20:                                        ; preds = %if.end17
  %11 = load i32, ptr %money, align 4, !tbaa !5
  %div21 = sdiv i32 %11, 20
  store i32 %div21, ptr %num20, align 4, !tbaa !5
  %12 = load i32, ptr %money, align 4, !tbaa !5
  %13 = load i32, ptr %num20, align 4, !tbaa !5
  %mul22 = mul nsw i32 20, %13
  %sub23 = sub nsw i32 %12, %mul22
  store i32 %sub23, ptr %money, align 4, !tbaa !5
  %14 = load i32, ptr %num20, align 4, !tbaa !5
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %14)
...
if.end29:                                         ; preds = %if.else26, %if.then20
  ...
  %div30 = sdiv i32 %15, 10
  %cmp31 = icmp sgt i32 %div30, 0
  br i1 %cmp31, label %if.then32, label %if.else38

if.then32:                                        ; preds = %if.end29
  %16 = load i32, ptr %money, align 4, !tbaa !5
  %div33 = sdiv i32 %16, 10
  store i32 %div33, ptr %num10, align 4, !tbaa !5
  %17 = load i32, ptr %money, align 4, !tbaa !5
  %18 = load i32, ptr %num10, align 4, !tbaa !5
  %mul34 = mul nsw i32 10, %18
  %sub35 = sub nsw i32 %17, %mul34
  store i32 %sub35, ptr %money, align 4, !tbaa !5
  %19 = load i32, ptr %num10, align 4, !tbaa !5
  %call36 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %19)
...
if.else38:                                        ; preds = %if.end29
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
if.then44:                                        ; preds = %if.end41
  %21 = load i32, ptr %money, align 4, !tbaa !5
  %div45 = sdiv i32 %21, 5
  store i32 %div45, ptr %num5, align 4, !tbaa !5
  %22 = load i32, ptr %money, align 4, !tbaa !5
  %23 = load i32, ptr %num5, align 4, !tbaa !5
  %mul46 = mul nsw i32 5, %23
  %sub47 = sub nsw i32 %22, %mul46
  store i32 %sub47, ptr %money, align 4, !tbaa !5
  %24 = load i32, ptr %num5, align 4, !tbaa !5
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %24)
...
if.else50:                                        ; preds = %if.end41
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
if.end53:                                         ; preds = %if.else50, %if.then44
  ...
  %call54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %25)
  call void @llvm.lifetime.end.p0(i64 4, ptr %num1) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %num5) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %num10) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %num20) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %num50) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %num100) #9
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %__out.addr, align 8, !tbaa !9, !nonnull !13, !align !14
  %vtable = load ptr, ptr %1, align 8, !tbaa !15
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %1, i64 %vbase.offset
...
if.else:                                          ; preds = %entry
  %2 = load ptr, ptr %__out.addr, align 8, !tbaa !9, !nonnull !13, !align !14
...
if.end:                                           ; preds = %if.else, %if.then
  %5 = load ptr, ptr %__out.addr, align 8, !tbaa !9, !nonnull !13, !align !14
  ret ptr %5
}
...
entry:
  ...
  store i8 %__c, ptr %__c.addr, align 1, !tbaa !21
  %this1 = load ptr, ptr %this.addr, align 8
  %_M_ctype = getelementptr inbounds nuw %"class.std::basic_ios", ptr %this1, i32 0, i32 5
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !22
  %call = call noundef nonnull align 8 dereferenceable(570) ptr @_ZSt13__check_facetISt5ctypeIcEERKT_PS3_(ptr noundef %0)
  %1 = load i8, ptr %__c.addr, align 1, !tbaa !21
...
entry:
  ...
  store ptr %__f, ptr %__f.addr, align 8, !tbaa !38
  %0 = load ptr, ptr %__f.addr, align 8, !tbaa !38
  %tobool = icmp ne ptr %0, null
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %__f.addr, align 8, !tbaa !38
  ret ptr %1
}
...
if.end:                                           ; preds = %entry
  ...
  %3 = load i8, ptr %__c.addr, align 1, !tbaa !21
...
!19 = !{!20, !20, i64 0}
!20 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !11, i64 0}
!21 = !{!7, !7, i64 0}
!22 = !{!23, !35, i64 240}
!23 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !24, i64 0, !10, i64 216, !7, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
...
!29 = !{!"_ZTSNSt8ios_base6_WordsE", !11, i64 0, !25, i64 8}
!30 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !11, i64 0}
!31 = !{!"_ZTSSt6locale", !32, i64 0}
!32 = !{!"p1 _ZTSNSt6locale5_ImplE", !11, i64 0}
!33 = !{!"bool", !7, i64 0}
...
!38 = !{!35, !35, i64 0}
!39 = !{!40, !7, i64 56}
!40 = !{!"_ZTSSt5ctypeIcE", !41, i64 0, !42, i64 16, !33, i64 24, !43, i64 32, !43, i64 40, !44, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
