...
if.else26:                                        ; preds = %if.else
  %cmp31 = fcmp olt double %4, 0.000000e+00
  br i1 %cmp31, label %if.then32, label %if.end62

if.then32:                                        ; preds = %if.else26
  %cmp33 = fcmp une double %0, 0.000000e+00
  br i1 %cmp33, label %if.then34, label %if.then49

if.then34:                                        ; preds = %if.then32
  %div37 = fdiv double %fneg5, %mul11
  %neg41 = fmul double %0, %fneg5
  %5 = call double @llvm.fmuladd.f64(double %mul2, double %2, double %neg41)
  %call42 = call double @sqrt(double noundef %5) #6, !tbaa !9
...
if.then49:                                        ; preds = %if.then32
  %neg53 = fmul double %0, %fneg5
  %6 = call double @llvm.fmuladd.f64(double %mul2, double %2, double %neg53)
  %call54 = call double @sqrt(double noundef %6) #6, !tbaa !9
