...
for.cond:                                         ; preds = %if.end28, %entry
  %indvars.iv23 = phi i32 [ %indvars.iv.next24, %if.end28 ], [ %conv9, %entry ]
  %indvars.iv18 = phi i32 [ %indvars.iv.next19, %if.end28 ], [ 0, %entry ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %if.end28 ], [ 0, %entry ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body35
  %indvars.iv15 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next16, %for.body35 ]
  %exitcond22.not = icmp eq i64 %indvars.iv15, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end42, label %for.body35
...
for.cond46:                                       ; preds = %for.body48, %for.end42
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body48 ], [ %6, %for.end42 ]
