...
for.cond33:                                       ; preds = %if.end55, %for.cond7.preheader
  %call31.i1 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4) #4
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %cmp34 = icmp sgt i32 %1, 2
  br i1 %cmp34, label %if.end55, label %for.end58

if.end55:                                         ; preds = %for.cond33
