...
entry:
  ...
  %2 = icmp sgt i32 %1, 0
  %or.cond91 = select i1 %cmp32, i1 %2, i1 false
  br i1 %or.cond91, label %for.cond2.preheader, label %for.end10

for.cond2.preheader:                              ; preds = %entry, %for.inc8
  %3 = phi i32 [ %7, %for.inc8 ], [ %0, %entry ]
  %4 = phi i32 [ %8, %for.inc8 ], [ %1, %entry ]
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc8 ], [ 0, %entry ]
...
for.body4:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv
...
for.inc8:                                         ; preds = %for.inc8.loopexit, %for.cond2.preheader
  ...
  %9 = sext i32 %7 to i64
  %cmp = icmp slt i64 %indvars.iv.next60, %9
...
for.end10:                                        ; preds = %for.inc8, %entry
  ...
  %or.cond93 = select i1 %cmp1436, i1 %12, i1 false
  br i1 %or.cond93, label %for.cond16.preheader, label %for.cond30.preheader

for.cond16.preheader:                             ; preds = %for.end10, %for.inc27
  %13 = phi i32 [ %44, %for.inc27 ], [ %10, %for.end10 ]
  %14 = phi i32 [ %45, %for.inc27 ], [ %11, %for.end10 ]
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc27 ], [ 0, %for.end10 ]
...
for.cond30.preheader:                             ; preds = %for.inc27, %for.end10
  ...
  br i1 %cmp3142, label %for.cond33.preheader.lr.ph, label %for.end82
...
for.cond33.preheader.lr.ph:                       ; preds = %for.cond30.preheader
  ...
  %cmp3738 = icmp sgt i32 %17, 0
  %or.cond = select i1 %cmp3440, i1 %cmp3738, i1 false
  br i1 %or.cond, label %for.cond33.preheader.us.us.preheader, label %for.body62.preheader

for.body62.preheader:                             ; preds = %for.cond33.for.inc57_crit_edge.split.us.us.us, %for.cond33.preheader.lr.ph
  br label %for.body62

for.cond33.preheader.us.us.preheader:             ; preds = %for.cond33.preheader.lr.ph
  %wide.trip.count79 = zext nneg i32 %15 to i64
  %wide.trip.count74 = zext nneg i32 %16 to i64
...
for.cond33.preheader.us.us:                       ; preds = %for.cond33.preheader.us.us.preheader, %for.cond33.for.inc57_crit_edge.split.us.us.us
  %indvars.iv76 = phi i64 [ 0, %for.cond33.preheader.us.us.preheader ], [ %indvars.iv.next77, %for.cond33.for.inc57_crit_edge.split.us.us.us ]
...
for.cond36.preheader.us.us.us:                    ; preds = %for.cond36.for.inc54_crit_edge.us.us.us, %for.cond33.preheader.us.us
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.cond36.for.inc54_crit_edge.us.us.us ], [ 0, %for.cond33.preheader.us.us ]
  %arrayidx50.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv76, i64 %indvars.iv71
...
vector.ph:                                        ; preds = %for.cond36.preheader.us.us.us
  %18 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %arrayidx50.promoted.us.us.us, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv76, i64 %index
  %wide.load = load <4 x i32>, ptr %22, align 16, !tbaa !5
  %23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %index, i64 %indvars.iv71
  %24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %19, i64 %indvars.iv71
  %25 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %20, i64 %indvars.iv71
  %26 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %21, i64 %indvars.iv71
...
for.body38.us.us.us.preheader:                    ; preds = %for.cond36.preheader.us.us.us, %middle.block
  %indvars.iv68.ph = phi i64 [ 0, %for.cond36.preheader.us.us.us ], [ %n.vec, %middle.block ]
  %.ph = phi i32 [ %arrayidx50.promoted.us.us.us, %for.cond36.preheader.us.us.us ], [ %38, %middle.block ]
  br label %for.body38.us.us.us

for.body38.us.us.us:                              ; preds = %for.body38.us.us.us.preheader, %for.body38.us.us.us
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.body38.us.us.us ], [ %indvars.iv68.ph, %for.body38.us.us.us.preheader ]
  %39 = phi i32 [ %add.us.us.us, %for.body38.us.us.us ], [ %.ph, %for.body38.us.us.us.preheader ]
  %arrayidx42.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv76, i64 %indvars.iv68
  %40 = load i32, ptr %arrayidx42.us.us.us, align 4, !tbaa !5
  %arrayidx46.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv68, i64 %indvars.iv71
  %41 = load i32, ptr %arrayidx46.us.us.us, align 4, !tbaa !5
  %mul.us.us.us = mul nsw i32 %41, %40
  %add.us.us.us = add nsw i32 %39, %mul.us.us.us
...
for.cond36.for.inc54_crit_edge.us.us.us:          ; preds = %for.body38.us.us.us, %middle.block
  ...
  br i1 %exitcond75.not, label %for.cond33.for.inc57_crit_edge.split.us.us.us, label %for.cond36.preheader.us.us.us, !llvm.loop !18

for.cond33.for.inc57_crit_edge.split.us.us.us:    ; preds = %for.cond36.for.inc54_crit_edge.us.us.us
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %exitcond80.not = icmp eq i64 %indvars.iv.next77, %wide.trip.count79
  br i1 %exitcond80.not, label %for.body62.preheader, label %for.cond33.preheader.us.us, !llvm.loop !19

for.body18:                                       ; preds = %for.cond16.preheader, %for.body18
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body18 ], [ 0, %for.cond16.preheader ]
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv65, i64 %indvars.iv62
  ...
  %cmp17 = icmp slt i64 %indvars.iv.next63, %43
  br i1 %cmp17, label %for.body18, label %for.inc27.loopexit, !llvm.loop !20

for.inc27.loopexit:                               ; preds = %for.body18
  %.pre87 = load i32, ptr %x2, align 4, !tbaa !5
  br label %for.inc27

for.inc27:                                        ; preds = %for.inc27.loopexit, %for.cond16.preheader
  %44 = phi i32 [ %.pre87, %for.inc27.loopexit ], [ %13, %for.cond16.preheader ]
  %45 = phi i32 [ %42, %for.inc27.loopexit ], [ %14, %for.cond16.preheader ]
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %46 = sext i32 %44 to i64
  %cmp14 = icmp slt i64 %indvars.iv.next66, %46
  br i1 %cmp14, label %for.cond16.preheader, label %for.cond30.preheader, !llvm.loop !21

for.body62:                                       ; preds = %for.body62.preheader, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 0, %for.body62.preheader ]
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv84
  %47 = load i32, ptr %arrayidx64, align 16, !tbaa !5
  %call66 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %47)
  %48 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp6850 = icmp sgt i32 %48, 1
  br i1 %cmp6850, label %for.body69, label %for.end78

for.body69:                                       ; preds = %for.body62, %for.body69
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.body69 ], [ 1, %for.body62 ]
  ...
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv84, i64 %indvars.iv81
  %49 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %call75 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %49)
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %50 = load i32, ptr %y2, align 4, !tbaa !5
  %51 = sext i32 %50 to i64
  %cmp68 = icmp slt i64 %indvars.iv.next82, %51
  br i1 %cmp68, label %for.body69, label %for.end78, !llvm.loop !22

for.end78:                                        ; preds = %for.body69, %for.body62
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %cmp61 = icmp slt i64 %indvars.iv.next85, %57
  br i1 %cmp61, label %for.body62, label %for.end82, !llvm.loop !50

for.end82:                                        ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit, %for.cond30.preheader
