; ModuleID = '/tmp/tmpno9q_r2u.cpp'
source_filename = "/tmp/tmpno9q_r2u.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %f) #12
  store i32 0, ptr %f, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %f1) #12
  store i32 0, ptr %f1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 41, ptr %w) #12
...
while.cond:                                       ; preds = %if.end26, %entry
  %arraydecay = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  ...
  %vtable = load ptr, ptr %call2, align 8, !tbaa !9
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %call2, i64 %vbase.offset
  %call3 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEEcvbEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr)
...
while.body:                                       ; preds = %while.cond
  ...
  %arraydecay4 = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  %call5 = call i64 @strlen(ptr noundef %arraydecay4) #13
  %add6 = add i64 %conv, %call5
  %cmp = icmp ule i64 %add6, 80
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %1 = load i32, ptr %f1, align 4, !tbaa !5
...
if.then8:                                         ; preds = %if.then
  ...
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  br label %if.end

if.end:                                           ; preds = %if.then8, %if.then
  %arraydecay10 = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  ...
  store i32 %inc12, ptr %f1, align 4, !tbaa !5
  %arraydecay13 = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  ...
  store i32 %conv17, ptr %f, align 4, !tbaa !5
  br label %if.end26

if.else:                                          ; preds = %while.body
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  store i32 0, ptr %f1, align 4, !tbaa !5
  %arraydecay19 = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  ...
  %arraydecay22 = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  %call23 = call i64 @strlen(ptr noundef %arraydecay22) #13
  %add24 = add i64 %call23, 1
  %conv25 = trunc i64 %add24 to i32
  store i32 %conv25, ptr %f, align 4, !tbaa !5
  br label %if.end26

if.end26:                                         ; preds = %if.else, %if.end
  %arraydecay27 = getelementptr inbounds [41 x i8], ptr %w, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %arraydecay27, i8 0, i64 41, i1 false)
  br label %while.cond, !llvm.loop !11

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 41, ptr %w) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %f1) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %f) #12
...
do.end:                                           ; preds = %do.cond
  ...
  %vtable1 = load ptr, ptr %4, align 8, !tbaa !9
...
if.then6:                                         ; preds = %if.else
  ...
  %vtable7 = load ptr, ptr %7, align 8, !tbaa !9
  ...
  %vtable12 = load ptr, ptr %11, align 8, !tbaa !9
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %15, align 8, !tbaa !9
  ...
  %16 = load i8, ptr %__eof, align 1, !tbaa !23, !range !25, !noundef !21
...
if.then28:                                        ; preds = %if.then19
  ...
  %vtable29 = load ptr, ptr %17, align 8, !tbaa !9
...
entry:
  ...
  %0 = load ptr, ptr %__c1.addr, align 8, !tbaa !50, !nonnull !21, !align !52
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %2 = load ptr, ptr %__c2.addr, align 8, !tbaa !50, !nonnull !21, !align !52
...
; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) #10 comdat {
entry:
  %__a.addr = alloca i32, align 4
  %__b.addr = alloca i32, align 4
  store i32 %__a, ptr %__a.addr, align 4, !tbaa !42
...
!25 = !{i8 0, i8 2}
!26 = !{!27, !27, i64 0}
!27 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !16, i64 0}
!28 = !{!29, !29, i64 0}
...
!42 = !{!36, !36, i64 0}
!43 = !{!44, !45, i64 232}
!44 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !34, i64 0, !29, i64 216, !7, i64 224, !24, i64 225, !45, i64 232, !46, i64 240, !47, i64 248, !48, i64 256}
...
!53 = !{!34, !36, i64 32}
!54 = !{!55, !18, i64 16}
!55 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !18, i64 8, !18, i64 16, !18, i64 24, !18, i64 32, !18, i64 40, !18, i64 48, !40, i64 56}
!56 = !{!55, !18, i64 24}
!57 = !{!7, !7, i64 0}
!58 = !{!44, !46, i64 240}
!59 = !{!46, !46, i64 0}
...
!63 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!64 = !{!"p1 short", !16, i64 0}
