...
for.cond:                                         ; preds = %if.end43, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %if.end43 ], [ 0, %entry ]
  %indvars.iv27 = phi i32 [ %indvars.iv.next28, %if.end43 ], [ %conv, %entry ]
...
lor.lhs.false:                                    ; preds = %for.body15
  ...
  br i1 %cmp22.not, label %for.inc, label %for.end.split.loop.exit62

for.inc:                                          ; preds = %lor.lhs.false
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond13, !llvm.loop !9

for.end.split.loop.exit62:                        ; preds = %lor.lhs.false
  %3 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.cond13, %for.body15, %for.end.split.loop.exit62
  %j.0.lcssa = phi i32 [ %3, %for.end.split.loop.exit62 ], [ %indvars.iv27, %for.body15 ], [ %smax, %for.cond13 ]
  %cmp23 = icmp eq i32 %j.0.lcssa, %conv9
  br i1 %cmp23, label %for.cond25.preheader, label %if.end43
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc33
  %indvars.iv43 = phi i64 [ %indvars.iv32, %for.cond25.preheader ], [ %indvars.iv.next44, %for.inc33 ]
  %indvars.iv40 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next41, %for.inc33 ]
  %exitcond50.not = icmp eq i64 %indvars.iv40, %wide.trip.count49
  br i1 %exitcond50.not, label %for.end35, label %for.inc33

for.inc33:                                        ; preds = %for.cond25
...
for.cond45:                                       ; preds = %for.inc53, %for.end44
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc53 ], [ %7, %for.end44 ]
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc53 ], [ %.pre-phi, %for.end44 ]
  %exitcond60.not = icmp eq i64 %indvars.iv53, %wide.trip.count59
  br i1 %exitcond60.not, label %for.end55, label %for.inc53
