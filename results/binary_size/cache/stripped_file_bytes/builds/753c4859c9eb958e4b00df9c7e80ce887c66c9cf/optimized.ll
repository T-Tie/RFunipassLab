...
while.cond:                                       ; preds = %if.end30, %entry
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %if.end30 ], [ %conv7, %entry ]
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %if.end30 ], [ 0, %entry ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %if.end30 ], [ 0, %entry ]
  %arrayidx = getelementptr inbounds nuw [257 x i8], ptr %str, i64 0, i64 %indvars.iv14
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp25.not, label %for.inc, label %for.end.split.loop.exit33

for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.end.split.loop.exit33:                        ; preds = %for.body
  %5 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.cond, %for.end.split.loop.exit33
  %i.0.lcssa = phi i32 [ %5, %for.end.split.loop.exit33 ], [ %smax, %for.cond ]
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [257 x i8], ptr %str, i64 0, i64 %indvars.iv17
  %6 = load i8, ptr %arrayidx37, align 1, !tbaa !5, !invariant.load !8
  %conv38 = sext i8 %6 to i32
  %putchar9 = call i32 @putchar(i32 noundef %conv38) #8
...
for.end42:                                        ; preds = %for.cond33
  ...
  %7 = sext i32 %indvars.iv25 to i64
  %sext = shl i64 %call4, 32
  %8 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc53 ], [ %7, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv28, %8
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 %indvars.iv28
