...
for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr %num, i64 0, i64 %indvars.iv8
...
if.then19:                                        ; preds = %for.body15
  %div5 = udiv i32 %5, 10
  %arrayidx23 = getelementptr inbounds nuw [1000 x i32], ptr %num, i64 0, i64 %indvars.iv.next9
  %6 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !9
  %add24 = add nsw i32 %6, %div5
  store i32 %add24, ptr %arrayidx23, align 4, !tbaa !5
  %rem6 = urem i32 %5, 10
  store i32 %rem6, ptr %arrayidx17, align 4, !tbaa !5
  br label %for.inc30
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc44
  %j.3 = phi i32 [ %dec45, %for.inc44 ], [ 999, %for.cond36.preheader ]
...
for.body38:                                       ; preds = %for.cond36
  ...
  %7 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !9
...
for.end46:                                        ; preds = %for.body38, %for.cond36
  %len.2 = phi i32 [ %len.0, %for.cond36 ], [ %j.3, %for.body38 ]
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc53, %for.end46
  %.sink = phi i32 [ %len.2, %for.end46 ], [ %dec54, %for.inc53 ]
  %cmp48 = icmp sgt i32 %.sink, -1
  br i1 %cmp48, label %for.inc53, label %for.end55

for.inc53:                                        ; preds = %for.cond47
  %idxprom50 = zext nneg i32 %.sink to i64
