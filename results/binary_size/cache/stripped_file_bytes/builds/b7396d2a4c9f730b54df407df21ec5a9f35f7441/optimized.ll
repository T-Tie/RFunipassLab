...
for.cond1:                                        ; preds = %for.cond, %for.cond.cleanup7
  %1 = phi i32 [ %2, %for.cond.cleanup7 ], [ %0, %for.cond ]
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.cond.cleanup7 ], [ 0, %for.cond ]
  %cmp2 = icmp sgt i32 %1, 0
  br i1 %cmp2, label %for.cond5, label %for.cond15

for.cond5:                                        ; preds = %for.cond1, %for.body8
  %2 = phi i32 [ %.pre, %for.body8 ], [ %1, %for.cond1 ]
...
for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond1, %for.cond.cleanup72
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.cond.cleanup72 ], [ 0, %for.cond1 ]
  %total.0 = phi i32 [ %add130, %for.cond.cleanup72 ], [ 0, %for.cond1 ]
  %exitcond88.not = icmp eq i64 %indvars.iv62, 0
  br i1 %exitcond88.not, label %for.cond.cleanup17, label %for.cond.cleanup72
...
for.cond.cleanup72:                               ; preds = %for.cond15
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %arrayidx129 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next63, i64 %indvars.iv.next63
  %3 = load i32, ptr %arrayidx129, align 4, !tbaa !5, !invariant.load !9
  %add130 = add nsw i32 %3, %total.0
