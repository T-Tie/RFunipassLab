...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 32, ptr noundef nonnull align 16 %min) #5
  call void @llvm.lifetime.start.p0(i64 noundef 32, ptr noundef nonnull align 16 %arrow) #5
  call void @llvm.lifetime.start.p0(i64 noundef 32, ptr noundef nonnull align 16 %low) #5
...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc7 ], [ 0, %entry ]
  %0 = load i32, ptr %m, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv52, %1
  br i1 %cmp, label %for.cond1, label %for.cond10.preheader

for.cond10.preheader:                             ; preds = %for.cond
  %2 = load i32, ptr %n, align 4
  %smax = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %smax62 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv52, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc39
  %indvars.iv58 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next59, %for.inc39 ]
  %exitcond64.not = icmp eq i64 %indvars.iv58, %wide.trip.count63
  br i1 %exitcond64.not, label %for.cond42, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv58
  %arrayidx35 = getelementptr inbounds nuw [8 x i32], ptr %arrow, i64 0, i64 %indvars.iv58
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc36
  %indvars.iv55 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next56, %for.inc36 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx24 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv55
...
for.cond42:                                       ; preds = %for.cond10, %for.inc73
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc73 ], [ 0, %for.cond10 ]
  %exitcond75.not = icmp eq i64 %indvars.iv70, %wide.trip.count
  br i1 %exitcond75.not, label %for.cond76, label %for.cond45.preheader

for.cond45.preheader:                             ; preds = %for.cond42
  %arrayidx50 = getelementptr inbounds nuw [8 x i32], ptr %a, i64 0, i64 %indvars.iv70
  %arrayidx52 = getelementptr inbounds nuw [8 x i32], ptr %min, i64 0, i64 %indvars.iv70
  %arrayidx68 = getelementptr inbounds nuw [8 x i32], ptr %low, i64 0, i64 %indvars.iv70
  br label %for.cond45

for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc70
  %indvars.iv65 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next66, %for.inc70 ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %wide.trip.count63
  br i1 %exitcond69.not, label %for.inc73, label %for.body47

for.body47:                                       ; preds = %for.cond45
  %8 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !13
  store i32 %8, ptr %arrayidx52, align 4, !tbaa !5
  %arrayidx56 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %indvars.iv70
...
if.then60:                                        ; preds = %for.body47
  ...
  %10 = trunc nuw nsw i64 %indvars.iv65 to i32
...
for.cond76:                                       ; preds = %for.cond42, %for.inc98
  %.pre85 = phi i32 [ %.pre, %for.inc98 ], [ %0, %for.cond42 ]
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc98 ], [ 0, %for.cond42 ]
  %p.0 = phi i32 [ %p.1, %for.inc98 ], [ 0, %for.cond42 ]
  %11 = sext i32 %.pre85 to i64
  %cmp77 = icmp slt i64 %indvars.iv82, %11
  br i1 %cmp77, label %for.cond79.preheader, label %for.end100

for.cond79.preheader:                             ; preds = %for.cond76
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds nuw [8 x i32], ptr %arrow, i64 0, i64 %indvars.iv82
  %smax79 = call i32 @llvm.smax.i32(i32 %12, i32 noundef 0)
  %wide.trip.count80 = zext nneg i32 %smax79 to i64
  br label %for.cond79

for.cond79:                                       ; preds = %for.cond79.preheader, %for.inc95
  %indvars.iv76 = phi i64 [ 0, %for.cond79.preheader ], [ %indvars.iv.next77, %for.inc95 ]
  %exitcond81.not = icmp eq i64 %indvars.iv76, %wide.trip.count80
  br i1 %exitcond81.not, label %for.inc98, label %for.body81

for.body81:                                       ; preds = %for.cond79
  %arrayidx83 = getelementptr inbounds nuw [8 x i32], ptr %min, i64 0, i64 %indvars.iv76
...
land.lhs.true:                                    ; preds = %for.body81
  %arrayidx85 = getelementptr inbounds nuw [8 x i32], ptr %low, i64 0, i64 %indvars.iv76
  %14 = load i32, ptr %arrayidx85, align 4, !tbaa !5, !invariant.load !13
  %15 = zext i32 %14 to i64
  %cmp86 = icmp eq i64 %indvars.iv82, %15
...
land.end:                                         ; preds = %land.lhs.true
  ...
  %cmp89 = icmp eq i64 %indvars.iv76, %17
...
for.inc98:                                        ; preds = %for.cond79, %if.then92
  %.pre = phi i32 [ %.pre.pre, %if.then92 ], [ %.pre85, %for.cond79 ]
...
if.end104:                                        ; preds = %if.then102, %for.end100
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 32, ptr noundef nonnull %low) #6
  call void @llvm.lifetime.end.p0(i64 noundef 32, ptr noundef nonnull %arrow) #6
  call void @llvm.lifetime.end.p0(i64 noundef 32, ptr noundef nonnull %min) #6
