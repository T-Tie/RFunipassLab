...
for.cond:                                         ; preds = %for.cond.cleanup12, %if.else
  ...
  br i1 %exitcond11.not, label %while.cond, label %for.cond3
...
for.cond10:                                       ; preds = %for.cond3, %if.end
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %if.end ], [ 0, %for.cond3 ]
  %exitcond10.not = icmp eq i64 %indvars.iv7, 90
  br i1 %exitcond10.not, label %for.cond.cleanup12, label %for.body13
...
for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %an, i64 0, i64 %indvars.iv7
...
if.then17:                                        ; preds = %for.body13
  ...
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %an, i64 0, i64 %indvars.iv.next8
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %while.cond ], [ 90, %for.cond ]
  %arrayidx32 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv12
...
for.cond34.preheader:                             ; preds = %while.cond
  %5 = trunc nsw i64 %indvars.iv12 to i32
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body37
  %mm.0 = phi i32 [ %dec42, %for.body37 ], [ %5, %for.cond34.preheader ]
