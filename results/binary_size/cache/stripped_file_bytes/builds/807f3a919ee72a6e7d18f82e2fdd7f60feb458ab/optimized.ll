...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv34 = phi i64 [ %1, %for.cond2.preheader ], [ %indvars.iv.next35, %for.inc24 ]
  %indvars.iv29 = phi i64 [ %3, %for.cond2.preheader ], [ %indvars.iv.next30, %for.inc24 ]
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, -1
  %cmp3 = icmp sgt i64 %indvars.iv34, 0
...
for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx12 = getelementptr inbounds [26 x i32], ptr %s, i64 0, i64 %indvars.iv.next35
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc18
  %indvars.iv31 = phi i64 [ %indvars.iv29, %for.cond5.preheader ], [ %indvars.iv.next32, %for.inc18 ]
  %k.0 = phi i32 [ 0, %for.cond5.preheader ], [ %k.1, %for.inc18 ]
  %indvars.iv.next32 = add nsw i64 %indvars.iv31, 1
  %cmp6 = icmp slt i64 %indvars.iv.next32, %1
  br i1 %cmp6, label %for.body7, label %for.inc24

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds [26 x i32], ptr %d, i64 0, i64 %indvars.iv.next32
...
land.lhs.true:                                    ; preds = %for.body7
  ...
  %arrayidx14 = getelementptr inbounds [26 x i32], ptr %s, i64 0, i64 %indvars.iv.next32
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx23 = getelementptr inbounds [26 x i32], ptr %d, i64 0, i64 %indvars.iv.next35
  store i32 %inc21, ptr %arrayidx23, align 4, !tbaa !5
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, -1
  br label %for.cond2, !llvm.loop !14

for.cond26:                                       ; preds = %for.cond26.preheader, %for.body28
  %indvars.iv37 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next38, %for.body28 ]
  %k.2 = phi i32 [ 0, %for.cond26.preheader ], [ %spec.select26, %for.body28 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [26 x i32], ptr %d, i64 0, i64 %indvars.iv37
  %7 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
  %spec.select26 = call i32 @llvm.smax.i32(i32 %7, i32 %k.2)
