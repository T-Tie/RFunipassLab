...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %ju) #4
...
_ZNSi7getlineEPcl.exit:                           ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call2.i = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPclc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %ju, i64 noundef 99, i8 noundef signext %retval.0.i.i.i)
  br label %while.cond

while.cond:                                       ; preds = %if.end11, %_ZNSi7getlineEPcl.exit
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %if.end11 ], [ 0, %_ZNSi7getlineEPcl.exit ]
  %p.0 = phi ptr [ %incdec.ptr, %if.end11 ], [ %ju, %_ZNSi7getlineEPcl.exit ]
  %4 = load i8, ptr %p.0, align 1, !tbaa !34
  switch i8 %4, label %if.end11 [
...
for.cond.preheader:                               ; preds = %while.cond
  ...
  %sub.ptr.rhs.cast = ptrtoint ptr %ju to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %cmp1315 = icmp sgt i64 %sub.ptr.sub, 0
  br i1 %cmp1315, label %for.body, label %for.end

if.then:                                          ; preds = %while.cond
  %add.ptr = getelementptr inbounds i8, ptr %p.0, i64 -1
  %5 = load i8, ptr %add.ptr, align 1, !tbaa !34
...
if.then10:                                        ; preds = %if.then, %if.then
  store i8 0, ptr %p.0, align 1, !tbaa !34
  br label %if.end11
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %6 = load i8, ptr %arrayidx, align 1, !tbaa !34
...
if.then16:                                        ; preds = %for.body
  ...
  %vtable.i10 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !5
...
for.inc:                                          ; preds = %for.body, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %indvars.iv19
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !39

for.end:                                          ; preds = %for.inc, %for.cond.preheader
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %ju) #4
  ret i32 0
}
