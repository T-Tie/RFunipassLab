...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.body31
  %indvars.iv35 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next36, %for.body31 ]
  %exitcond42.not = icmp eq i64 %indvars.iv35, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond39.preheader, label %for.body31
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.body41
  %indvars.iv43 = phi i64 [ 0, %for.cond39.preheader ], [ %indvars.iv.next44, %for.body41 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end48, label %for.body41
...
for.cond50:                                       ; preds = %for.body52, %for.end48
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body52 ], [ %8, %for.end48 ]
