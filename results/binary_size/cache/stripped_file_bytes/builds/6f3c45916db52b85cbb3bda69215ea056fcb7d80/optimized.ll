...
for.cond:                                         ; preds = %if.end4, %if.end.split
  %i.0 = phi i32 [ %x, %if.end.split ], [ %inc5.i, %if.end4 ]
...
if.end4:                                          ; preds = %if.then3, %for.cond
  %inc5.i = add nsw i32 %i.0, 1
  br label %for.cond
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %4 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre, %for.body4 ]
