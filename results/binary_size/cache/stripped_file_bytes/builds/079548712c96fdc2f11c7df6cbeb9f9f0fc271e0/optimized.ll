...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %or.cond11, label %if.then, label %if.else39
...
for.cond9.preheader:                              ; preds = %if.then
  %5 = sext i32 %4 to i64
  %wide.trip.count38 = sext i32 %3 to i64
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc
  %indvars.iv33 = phi i64 [ %5, %for.cond9.preheader ], [ %indvars.iv.next34, %for.inc ]
  %total.0 = phi i32 [ 0, %for.cond9.preheader ], [ %add, %for.inc ]
  %exitcond39.not = icmp eq i64 %indvars.iv33, %wide.trip.count38
  br i1 %exitcond39.not, label %for.end, label %for.inc
...
for.cond20.preheader:                             ; preds = %if.else17
  %8 = sext i32 %3 to i64
  %wide.trip.count31 = sext i32 %4 to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc27
  %indvars.iv27 = phi i64 [ %8, %for.cond20.preheader ], [ %indvars.iv.next28, %for.inc27 ]
  %total.1 = phi i32 [ 0, %for.cond20.preheader ], [ %add26, %for.inc27 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end29, label %for.inc27
...
for.end29:                                        ; preds = %for.cond20
  ...
  %str.5.str.4 = select i1 %cmp31, ptr @str.5, ptr @str.4
  br label %for.inc82.sink.split
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc49
  %indvars.iv21 = phi i64 [ %11, %for.cond42.preheader ], [ %indvars.iv.next22, %for.inc49 ]
  %total.2 = phi i32 [ 0, %for.cond42.preheader ], [ %add48, %for.inc49 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end51, label %for.inc49
...
for.end51:                                        ; preds = %for.cond42
  ...
  %str.3.str.2 = select i1 %cmp53, ptr @str.3, ptr @str.2
  br label %for.inc82.sink.split
...
for.end71:                                        ; preds = %for.cond62
  ...
  %str.1.str = select i1 %cmp73, ptr @str.1, ptr @str
  br label %for.inc82.sink.split
...
for.inc82.sink.split:                             ; preds = %for.end71, %for.end51, %for.end29, %for.end
  ...
  %puts15 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.4.sink) #6
  br label %for.inc82
