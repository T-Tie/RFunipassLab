...
do.cond:                                          ; preds = %while.cond, %do.cond
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %do.cond ], [ 0, %while.cond ]
...
for.cond.preheader:                               ; preds = %do.cond
  %wide.trip.count13 = zext nneg i32 %indvars.iv9 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv4 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next5, %for.inc27 ]
  %count.0 = phi i32 [ 0, %for.cond.preheader ], [ %count.1, %for.inc27 ]
  %exitcond14.not = icmp eq i64 %indvars.iv4, %wide.trip.count13
  br i1 %exitcond14.not, label %if.end32, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond
  %arrayidx16 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv4
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.body12
  %indvars.iv6 = phi i64 [ %indvars.iv4, %for.cond9.preheader ], [ %indvars.iv.next7, %for.body12 ]
  %count.1 = phi i32 [ %count.0, %for.cond9.preheader ], [ %count.2, %for.body12 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %wide.trip.count13
  br i1 %exitcond.not, label %for.inc27, label %for.body12

for.body12:                                       ; preds = %for.cond9
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx14 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv.next7
