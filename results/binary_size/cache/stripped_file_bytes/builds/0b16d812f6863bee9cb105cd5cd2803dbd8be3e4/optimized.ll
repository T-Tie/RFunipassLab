...
entry:
  ...
  br i1 %cmp33, label %for.cond1.preheader, label %for.end51
...
for.cond10.preheader:                             ; preds = %for.inc7
  ...
  br i1 %cmp1137, label %for.cond13.preheader.us.preheader, label %for.end51
...
for.cond13.preheader.us:                          ; preds = %for.cond13.preheader.us.preheader, %for.cond13.for.inc27_crit_edge.us
  %indvars.iv60 = phi i64 [ 0, %for.cond13.preheader.us.preheader ], [ %indvars.iv.next61, %for.cond13.for.inc27_crit_edge.us ]
  br label %for.body15.us

for.body15.us:                                    ; preds = %for.cond13.preheader.us, %for.inc21.us
  %indvars.iv57 = phi i64 [ 0, %for.cond13.preheader.us ], [ %indvars.iv.next58, %for.inc21.us ]
  %arrayidx19.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv60, i64 %indvars.iv57
...
for.inc21.us:                                     ; preds = %for.body15.us
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next58, %wide.trip.count63
...
for.cond13.for.inc27_crit_edge.us:                ; preds = %for.inc21.us
  ...
  br i1 %exitcond64.not, label %for.cond34.preheader.preheader, label %for.cond13.preheader.us, !llvm.loop !12

for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body3 ], [ 0, %for.cond1.preheader ]
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv
...
for.inc7:                                         ; preds = %for.body3, %for.cond1.preheader.for.inc7_crit_edge
  ...
  %cmp = icmp slt i64 %indvars.iv.next55, %.pre-phi
...
for.cond34.preheader.preheader:                   ; preds = %for.cond13.for.inc27_crit_edge.us, %for.end29.loopexit
  %j1.183 = phi i32 [ %8, %for.end29.loopexit ], [ undef, %for.cond13.for.inc27_crit_edge.us ]
  %i.13082 = phi i32 [ %6, %for.end29.loopexit ], [ %5, %for.cond13.for.inc27_crit_edge.us ]
  %9 = zext nneg i32 %5 to i64
  br label %for.cond34.preheader

for.cond30.loopexit:                              ; preds = %for.cond34
  %cmp31 = icmp sgt i64 %indvars.iv68, 1
...
for.cond34.preheader:                             ; preds = %for.cond34.preheader.preheader, %for.cond30.loopexit
  %indvars.iv68 = phi i64 [ %9, %for.cond34.preheader.preheader ], [ %indvars.iv.next69, %for.cond30.loopexit ]
  %indvars.iv.next69 = add nsw i64 %indvars.iv68, -1
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv65 = phi i64 [ %9, %for.cond34.preheader ], [ %indvars.iv.next66, %for.body36 ]
  %cmp35 = icmp sgt i64 %indvars.iv65, 0
  br i1 %cmp35, label %for.body36, label %for.cond30.loopexit

for.body36:                                       ; preds = %for.cond34
  %indvars.iv.next66 = add nsw i64 %indvars.iv65, -1
  %arrayidx40 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next69, i64 %indvars.iv.next66
...
for.end51.loopexit:                               ; preds = %for.body36
  %11 = trunc nuw nsw i64 %indvars.iv.next69 to i32
  %12 = trunc nsw i64 %indvars.iv.next66 to i32
  br label %for.end51

for.end51:                                        ; preds = %for.cond30.loopexit, %entry, %for.cond10.preheader, %for.end51.loopexit
  %j1.180 = phi i32 [ %j1.183, %for.end51.loopexit ], [ undef, %for.cond10.preheader ], [ undef, %entry ], [ %j1.183, %for.cond30.loopexit ]
  %i.13079 = phi i32 [ %i.13082, %for.end51.loopexit ], [ 0, %for.cond10.preheader ], [ 0, %entry ], [ %i.13082, %for.cond30.loopexit ]
  %i2.1 = phi i32 [ %11, %for.end51.loopexit ], [ undef, %for.cond10.preheader ], [ undef, %entry ], [ undef, %for.cond30.loopexit ]
  %j2.1 = phi i32 [ %12, %for.end51.loopexit ], [ undef, %for.cond10.preheader ], [ undef, %entry ], [ undef, %for.cond30.loopexit ]
  %13 = xor i32 %i.13079, -1
  %sub53 = add i32 %i2.1, %13
  %sub55 = add i32 %j2.1, %j1.180
