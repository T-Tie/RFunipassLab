...
for.cond12:                                       ; preds = %for.cond5, %if.end32
  %indvars.iv20 = phi i64 [ %4, %if.end32 ], [ 0, %for.cond5 ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond25.not, label %for.cond.cleanup14, label %for.body15
...
if.end32:                                         ; preds = %for.body15, %if.then19
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.body49
  %8 = phi i32 [ %.pre31, %for.body49 ], [ %.fr, %for.cond43.preheader ]
  ...
  br i1 %or.cond18, label %for.body49, label %for.end55
