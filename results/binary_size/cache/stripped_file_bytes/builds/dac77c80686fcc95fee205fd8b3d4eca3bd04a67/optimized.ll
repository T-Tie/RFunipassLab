...
for.cond5:                                        ; preds = %for.inc26, %for.end
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc26 ], [ 1, %for.end ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp6 = icmp slt i64 %indvars.iv16, %4
  br i1 %cmp6, label %for.cond8.preheader, label %for.end28
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.body10
  %indvars.iv13 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next14, %for.body10 ]
  %k.0 = phi i32 [ 0, %for.cond8.preheader ], [ %spec.select, %for.body10 ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %indvars.iv16
  br i1 %exitcond.not, label %for.end19, label %for.body10
...
for.body10:                                       ; preds = %for.cond8
  ...
  %spec.select = add nuw nsw i32 %k.0, %inc16
