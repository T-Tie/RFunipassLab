...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc30
  %indvars.iv26 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next27, %for.inc30 ]
  %exitcond = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond, label %for.cond33, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %6 = sub nsw i64 %4, %indvars.iv26
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.body7
  %indvars.iv23 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next24, %for.body7 ]
  %max.0 = phi i32 [ 0, %for.cond5.preheader ], [ %spec.select, %for.body7 ]
  %cmp6.not = icmp sgt i64 %indvars.iv23, %6
...
for.body7:                                        ; preds = %for.cond5
  ...
  %spec.select = select i1 %cmp12, i32 %9, i32 %max.0
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond5, !llvm.loop !12

for.end15:                                        ; preds = %for.cond5
  %10 = trunc nsw i64 %6 to i32
...
if.then18:                                        ; preds = %for.end15
  ...
  %arrayidx23 = getelementptr inbounds i32, ptr %vla, i64 %6
...
for.cond33:                                       ; preds = %for.cond2, %for.inc53
  %13 = phi i32 [ %.pre, %for.inc53 ], [ %3, %for.cond2 ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc53 ], [ 0, %for.cond2 ]
  %14 = sext i32 %13 to i64
  %cmp34 = icmp slt i64 %indvars.iv31, %14
  br i1 %cmp34, label %for.body35, label %for.end55

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv31
...
if.then39:                                        ; preds = %for.body35
  %sub40 = add nsw i32 %13, -2
  %17 = zext i32 %sub40 to i64
  %cmp41 = icmp eq i64 %indvars.iv31, %17
  %sub42 = add nsw i32 %13, -1
  %18 = zext i32 %sub42 to i64
  %cmp43 = icmp eq i64 %indvars.iv31, %18
  %or.cond = select i1 %cmp41, i1 true, i1 %cmp43
  %.str..str.1 = select i1 %or.cond, ptr @.str, ptr @.str.1
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %15)
  br label %for.inc53
