...
for.body66:                                       ; preds = %for.cond64
  ...
  %arrayidx68 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom67
  %arrayidx69 = getelementptr inbounds [100 x i32], ptr %arrayidx68, i64 0, i64 0
  %39 = load i32, ptr %arrayidx69, align 16, !tbaa !5
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %39)
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond71

for.cond71:                                       ; preds = %for.inc80, %for.body66
...
for.body73:                                       ; preds = %for.cond71
  ...
  %call79 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call74, i32 noundef %44)
  br label %for.inc80
