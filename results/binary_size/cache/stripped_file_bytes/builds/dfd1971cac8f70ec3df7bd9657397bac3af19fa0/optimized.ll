...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %shu, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.end23 ], [ 0, %for.cond10.preheader ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end29, label %for.cond13
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %shu, i64 0, i64 %indvars.iv30, i64 %indvars.iv26
...
for.cond30:                                       ; preds = %for.end46, %for.end29
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.end46 ], [ 0, %for.end29 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count34
  br i1 %exitcond46.not, label %for.end52, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.body35
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body35 ], [ 0, %for.cond30 ]
  %s.2 = phi i32 [ %spec.select21, %for.body35 ], [ 0, %for.cond30 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end46, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %shu, i64 0, i64 %indvars.iv36, i64 %indvars.iv42
  %5 = load i32, ptr %arrayidx39, align 4, !tbaa !5
  %cmp40 = icmp eq i32 %5, 0
  %add42 = zext i1 %cmp40 to i32
  %spec.select21 = add nuw nsw i32 %s.2, %add42
