...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 64, ptr noundef nonnull align 16 %shuzu) #5
  br label %for.cond

for.cond:                                         ; preds = %if.end30, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc25.i3, %if.end30 ]
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.cond7.loopexit
  %indvars.iv20 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next21, %for.cond7.loopexit ]
  ...
  br i1 %exitcond24.not, label %for.end28, label %for.body

for.body:                                         ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [16 x i32], ptr %shuzu, i64 0, i64 %indvars.iv20
  br label %for.cond9

for.cond9:                                        ; preds = %for.body11, %for.body
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body11 ], [ %indvars.iv, %for.body ]
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx15 = getelementptr inbounds nuw [16 x i32], ptr %shuzu, i64 0, i64 %indvars.iv17
...
if.end30:                                         ; preds = %for.cond, %for.end28
  ...
  %inc25.i3 = add nsw i32 %i.1, 1
  br label %for.cond

for.end33:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 64, ptr noundef nonnull %shuzu) #6
  ret i32 0
}
