...
do.cond:                                          ; preds = %while.cond, %do.cond
  %indvars.iv14 = phi i32 [ %indvars.iv.next15, %do.cond ], [ 0, %while.cond ]
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %do.cond ], [ 1, %while.cond ]
...
for.cond:                                         ; preds = %for.cond.loopexit, %for.cond.preheader
  ...
  br i1 %exitcond17.not, label %if.end32, label %for.body
