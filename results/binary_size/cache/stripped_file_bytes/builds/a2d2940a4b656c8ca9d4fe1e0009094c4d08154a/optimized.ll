...
entry:
  ...
  %smax26 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count28 = zext nneg i32 %smax26 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc20, %entry
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc20 ], [ 0, %entry ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  %spec.select = add nuw nsw i32 %inc, %e.2
...
for.cond25.preheader.loopexit:                    ; preds = %for.end
  ...
  %.pre = and i64 %indvars.iv24, 4294967295
  br label %for.cond25.preheader

for.cond25.preheader:                             ; preds = %for.cond25.preheader.loopexit, %for.end22
  %wide.trip.count33.pre-phi = phi i64 [ %.pre, %for.cond25.preheader.loopexit ], [ %wide.trip.count28, %for.end22 ]
  %i.0.lcssa44 = phi i32 [ %3, %for.cond25.preheader.loopexit ], [ %smax26, %for.end22 ]
  br label %for.cond25

for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc32
  %indvars.iv30 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next31, %for.inc32 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33.pre-phi
  br i1 %exitcond34.not, label %for.end34, label %for.inc32

for.inc32:                                        ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [256 x i8], ptr %str, i64 0, i64 %indvars.iv30
  %4 = load i8, ptr %arrayidx29, align 1, !tbaa !5, !invariant.load !8
  %conv30 = sext i8 %4 to i32
  %putchar21 = call i32 @putchar(i32 noundef %conv30) #7
...
for.end34:                                        ; preds = %for.cond25
  ...
  %add37 = add i32 %i.0.lcssa44, %conv7
  %5 = sext i32 %add37 to i64
  %smax38 = call i32 @llvm.smax.i32(i32 %add37, i32 %conv)
  %wide.trip.count39 = sext i32 %smax38 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.inc45, %for.end34
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc45 ], [ %5, %for.end34 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count39
  br i1 %exitcond40.not, label %if.end50, label %for.inc45

for.inc45:                                        ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds [256 x i8], ptr %str, i64 0, i64 %indvars.iv35
