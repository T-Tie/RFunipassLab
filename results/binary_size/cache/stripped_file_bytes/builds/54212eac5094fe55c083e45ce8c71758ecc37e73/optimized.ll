...
for.cond1:                                        ; preds = %for.cond, %for.inc11
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc11 ], [ 1, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv5, %3
  br i1 %cmp2.not, label %for.end13, label %for.inc11

for.inc11:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
do.body:                                          ; preds = %do.cond, %for.end13
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %do.cond ], [ 2, %for.end13 ]
  %arrayidx20 = getelementptr inbounds nuw [20001 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
do.cond:                                          ; preds = %do.body, %if.then
  ...
  br i1 %exitcond12.not, label %do.end, label %do.body, !llvm.loop !14
