...
@numcount = dso_local local_unnamed_addr global i32 0, align 4
...
if.then:                                          ; preds = %entry
  ...
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @numcount, align 4, !tbaa !5
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %i.0 = phi i32 [ %inc5, %for.inc ], [ %x, %for.cond.preheader ]
...
if.then3:                                         ; preds = %for.body
  tail call void @_Z6divideii(i32 noundef %div, i32 noundef %i.0)
  br label %for.inc
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %ans) #5
...
for.cond2:                                        ; preds = %for.cond, %for.body4
  %4 = phi i32 [ %.pre, %for.body4 ], [ %0, %for.cond ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body4 ], [ 1, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3.not = icmp sgt i64 %indvars.iv8, %5
  br i1 %cmp3.not, label %for.end11, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv8
  %6 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %6)
  %vtable.i = load ptr, ptr %call7, align 8, !tbaa !13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call7, i8 noundef signext %call.i6)
...
for.end11:                                        ; preds = %for.cond2
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %ans) #5
