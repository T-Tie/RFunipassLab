...
for.cond60:                                       ; preds = %if.then68, %if.else
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %if.then68 ], [ 0, %if.else ]
...
if.then68:                                        ; preds = %for.cond60
  %arrayidx70 = getelementptr inbounds nuw [6 x i8], ptr @b, i64 %indvars.iv27
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx70)
