...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %s) #5
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 %a) #5
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 %b) #5
...
for.end75.split:                                  ; preds = %for.cond62, %for.cond49.preheader
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %b) #8
