...
do.cond:                                          ; preds = %while.cond, %do.cond
  %indvars.iv10 = phi i32 [ %indvars.iv.next11, %do.cond ], [ 0, %while.cond ]
...
for.cond.preheader:                               ; preds = %do.cond
  %wide.trip.count14 = zext nneg i32 %indvars.iv10 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv5 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next6, %for.inc27 ]
  %count.0 = phi i32 [ 0, %for.cond.preheader ], [ %count.1, %for.inc27 ]
  %exitcond15.not = icmp eq i64 %indvars.iv5, %wide.trip.count14
  br i1 %exitcond15.not, label %if.end32, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond
  %arrayidx16 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv5
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.body12
  %indvars.iv7 = phi i64 [ %indvars.iv5, %for.cond9.preheader ], [ %indvars.iv.next8, %for.body12 ]
  %count.1 = phi i32 [ %count.0, %for.cond9.preheader ], [ %count.2, %for.body12 ]
  %exitcond.not = icmp eq i64 %indvars.iv7, %wide.trip.count14
  br i1 %exitcond.not, label %for.inc27, label %for.body12

for.body12:                                       ; preds = %for.cond9
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %arrayidx14 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv.next8
  ...
  %or.cond3 = or i1 %cmp17, %cmp23
  %inc25 = zext i1 %or.cond3 to i32
