...
entry:
  ...
  %j = alloca i8, align 1
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 %p) #5
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %j) #5
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond19 = select i1 %cmp8, i1 true, i1 %or.cond
  %inc = zext i1 %or.cond19 to i32
...
for.cond51:                                       ; preds = %for.cond55.preheader, %for.end50
  %3 = phi i8 [ %.pre28, %for.cond55.preheader ], [ 97, %for.end50 ]
  %cmp53 = icmp slt i8 %3, 123
  br i1 %cmp53, label %for.cond55.preheader, label %if.end80

for.cond55.preheader:                             ; preds = %for.cond51
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull captures(none) dereferenceable(1) %j)
  %.pre28 = load i8, ptr %j, align 1, !tbaa !5
  br label %for.cond51

if.end80:                                         ; preds = %for.cond51, %if.then20
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %j) #6
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %p) #6
  ret i32 0
}
...
declare i64 @strlen(ptr captures(none)) #4
