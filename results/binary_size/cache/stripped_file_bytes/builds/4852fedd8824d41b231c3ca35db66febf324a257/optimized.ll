...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc18
  ...
  %exitcond12.not = icmp eq i64 %indvars.iv3, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond21, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv3
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc15
  %indvars.iv5 = phi i64 [ %indvars.iv3, %for.cond5.preheader ], [ %indvars.iv.next6, %for.inc15 ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv.next6
...
for.cond21:                                       ; preds = %for.cond2, %for.body23
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body23 ], [ 0, %for.cond2 ]
  %k.0 = phi i32 [ %spec.select, %for.body23 ], [ 0, %for.cond2 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count11
  br i1 %exitcond17.not, label %while.cond.preheader, label %for.body23
...
for.body23:                                       ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv13
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %cmp26.not = icmp ne i32 %5, 0
...
while.cond:                                       ; preds = %while.cond.preheader, %if.end48
  %6 = phi i32 [ %0, %while.cond.preheader ], [ %.pre, %if.end48 ]
  %indvars.iv18 = phi i64 [ 0, %while.cond.preheader ], [ %indvars.iv.next19, %if.end48 ]
  %l.0 = phi i32 [ 0, %while.cond.preheader ], [ %l.1, %if.end48 ]
  %7 = sext i32 %6 to i64
  %cmp33 = icmp slt i64 %indvars.iv18, %7
  br i1 %cmp33, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %arrayidx35 = getelementptr inbounds nuw [20000 x i32], ptr %u, i64 0, i64 %indvars.iv18
...
if.then39:                                        ; preds = %if.then37
  %call42 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %8)
  %inc43 = add nsw i32 %l.0, 1
  br label %if.end48

if.else:                                          ; preds = %if.then37
  %call46 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8)
  br label %if.end48
