...
for.cond:                                         ; preds = %if.end35, %entry
  %.pr1632 = phi i32 [ %n.promoted, %entry ], [ %.pr1633, %if.end35 ]
...
land.lhs.true16:                                  ; preds = %if.end14, %land.lhs.true9
  %.pr1628 = phi i32 [ %.pr1630, %land.lhs.true9 ], [ %sub13, %if.end14 ]
  %a20.2 = phi i32 [ %a20.0, %land.lhs.true9 ], [ %add12, %if.end14 ]
  %cmp17 = icmp sgt i32 %.pr1628, 9
  %sub20 = add nsw i32 %.pr1628, -10
  %.pr1626.ph = select i1 %cmp17, i32 %sub20, i32 %.pr1628
  %add19 = zext i1 %cmp17 to i32
  %a10.1.ph = add nsw i32 %a10.0, %add19
  %cmp24 = icmp sgt i32 %.pr1626.ph, 4
  %sub27 = add nsw i32 %.pr1626.ph, -5
  %.pr1625 = select i1 %cmp24, i32 %sub27, i32 %.pr1626.ph
  %add26 = zext i1 %cmp24 to i32
  %a5.2 = add nsw i32 %a5.0, %add26
  %0 = or i1 %cmp17, %cmp24
  %cmp31 = icmp sgt i32 %.pr1625, 0
  %sub34 = sext i1 %cmp31 to i32
  %.pr1633.ph = add nsw i32 %.pr1625, %sub34
...
2:                                                ; preds = %land.lhs.true16
  store i32 %.pr1633.ph, ptr %n, align 4, !tbaa !5
  br label %if.end35

if.end35:                                         ; preds = %2, %land.lhs.true16, %if.end14, %if.end
  %.pr1633 = phi i32 [ %sub, %if.end ], [ %sub13, %if.end14 ], [ %.pr1633.ph, %land.lhs.true16 ], [ %.pr1633.ph, %2 ]
