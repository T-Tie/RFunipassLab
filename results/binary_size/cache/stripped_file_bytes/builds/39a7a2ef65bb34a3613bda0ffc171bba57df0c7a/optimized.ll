...
if.then:                                          ; preds = %entry
  %div4 = udiv i32 %0, 100
  %call1 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div4)
...
if.then7:                                         ; preds = %if.end
  %div85 = udiv i32 %3, 50
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div85)
...
if.else14:                                        ; preds = %if.end
  ...
  %.pr1 = load i32, ptr %sum, align 4, !tbaa !5
  br label %if.end17

if.end17:                                         ; preds = %if.else14, %if.then7
  %6 = phi i32 [ %.pr1, %if.else14 ], [ %5, %if.then7 ]
  %cmp18 = icmp sgt i32 %6, 19
  br i1 %cmp18, label %if.then19, label %if.else26

if.then19:                                        ; preds = %if.end17
  %div206 = udiv i32 %6, 20
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div206)
...
if.end29:                                         ; preds = %if.else26, %if.then19
  %9 = phi i32 [ %.pr2, %if.else26 ], [ %8, %if.then19 ]
  %cmp30 = icmp sgt i32 %9, 9
  br i1 %cmp30, label %if.then31, label %if.else38

if.then31:                                        ; preds = %if.end29
  %div327 = udiv i32 %9, 10
  %call33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div327)
...
if.end41:                                         ; preds = %if.else38, %if.then31
  %12 = phi i32 [ %.pr3, %if.else38 ], [ %11, %if.then31 ]
  %cmp42 = icmp sgt i32 %12, 4
  br i1 %cmp42, label %if.then43, label %if.else50

if.then43:                                        ; preds = %if.end41
  %div448 = udiv i32 %12, 5
  %call45 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div448)
