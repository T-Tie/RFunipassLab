...
tailrecurse.outer:                                ; preds = %if.then2, %entry
  ...
  %pos.tr.ph = phi i32 [ %add6, %if.then2 ], [ %pos, %entry ]
...
if.then2:                                         ; preds = %if.end
  ...
  %spec.select = tail call i32 @llvm.smax.i32(i32 %add5, i32 %accumulator.tr.ph)
  br label %tailrecurse.outer
...
for.end:                                          ; preds = %for.cond
  %call2 = tail call noundef i32 @_Z2ffiii(i32 noundef 0, i32 noundef 99999, i32 noundef 0) #6
