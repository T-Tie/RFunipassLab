...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %total) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %eff) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %total2) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %eff2) #7
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %.str.1..str.2 = select i1 %cmp14, ptr @.str.1, ptr @.str.2
  %.str.sink = select i1 %cmp10, ptr @.str, ptr %.str.1..str.2
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(5) %.str.sink)
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %eff2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %total2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %eff) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %total) #7
...
if.end21.exitStub:
  %call11 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
