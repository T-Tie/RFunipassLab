...
for.cond38:                                       ; preds = %for.inc64, %for.end36
  %8 = phi i32 [ %dec65, %for.inc64 ], [ %sub37, %for.end36 ]
  %cmp39 = icmp sgt i32 %8, -1
  br i1 %cmp39, label %for.cond42.preheader, label %for.end66

for.cond42.preheader:                             ; preds = %for.cond38
  %idxprom45 = zext nneg i32 %8 to i64
  br label %for.cond42

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc52
  %9 = phi i32 [ %dec, %for.inc52 ], [ %sub37, %for.cond42.preheader ]
  %cmp43 = icmp sgt i32 %9, -1
  br i1 %cmp43, label %for.body44, label %if.then55

for.body44:                                       ; preds = %for.cond42
  %idxprom47 = zext nneg i32 %9 to i64
...
for.inc64:                                        ; preds = %if.then55
  %dec65 = add nsw i32 %8, -1
  br label %for.cond38, !llvm.loop !17

for.end66:                                        ; preds = %if.then55, %for.cond38, %for.body44
  %12 = phi i32 [ %8, %for.body44 ], [ %smin, %for.cond38 ], [ %8, %if.then55 ]
  %d.0 = phi i32 [ %9, %for.body44 ], [ undef, %for.cond38 ], [ undef, %if.then55 ]
  %13 = xor i32 %b.1, -1
  %sub68 = add i32 %d.0, %13
  %14 = xor i32 %a.1, -1
  %sub70 = add i32 %12, %14
