...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv4
...
for.end19:                                        ; preds = %for.cond2
  call fastcc void @outlined_ir_func_0(i32 noundef %p.0)
  call fastcc void @outlined_ir_func_0(i32 noundef %q.0)
