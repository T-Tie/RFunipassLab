...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc27 ], [ 1, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv39, %5
  br i1 %cmp14.not, label %for.cond30, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body18 ], [ 1, %for.cond13 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv36, %7
  br i1 %cmp17.not, label %for.inc27, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv39, i64 %indvars.iv36
...
for.cond30:                                       ; preds = %for.cond13, %for.inc74
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc74 ], [ 1, %for.cond13 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp31.not = icmp sgt i64 %indvars.iv48, %9
  br i1 %cmp31.not, label %for.end76, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc71
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc71 ], [ 1, %for.cond30 ]
  %10 = load i32, ptr %y2, align 4, !tbaa !5
  %11 = sext i32 %10 to i64
  %cmp34.not = icmp sgt i64 %indvars.iv45, %11
  br i1 %cmp34.not, label %for.inc74, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %12 = load i32, ptr %y1, align 4, !tbaa !5
  %arrayidx42 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv48, i64 %indvars.iv45
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body38
  %indvars.iv42 = phi i64 [ 1, %for.cond36.preheader ], [ %indvars.iv.next43, %for.body38 ]
  %exitcond = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond, label %for.end57, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %14 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv48, i64 %indvars.iv42
  %15 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv42, i64 %indvars.iv45
...
for.end57:                                        ; preds = %for.cond36
  ...
  %cmp58 = icmp eq i64 %indvars.iv45, %17
  %18 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %call63 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %18)
  br i1 %cmp58, label %if.then, label %if.else

if.then:                                          ; preds = %for.end57
  %vtable.i = load ptr, ptr %call63, align 8, !tbaa !16
  ...
  %call1.i30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call63, i8 noundef signext %call.i29)
...
for.inc71:                                        ; preds = %if.then, %if.else
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  br label %for.cond33, !llvm.loop !18

for.inc74:                                        ; preds = %for.cond33
