...
for.body:                                         ; preds = %entry, %if.else
  %j.06 = phi i32 [ 0, %entry ], [ %inc, %if.else ]
...
for.body.if.else_crit_edge:                       ; preds = %for.body
  ...
  %.pre8 = load i32, ptr %c, align 4, !tbaa !5
  br label %if.else

land.lhs.true:                                    ; preds = %for.body
  %2 = load i32, ptr %c, align 4, !tbaa !5
  %cmp2 = icmp eq i32 %0, %2
  %.pre7 = load i32, ptr %d, align 4, !tbaa !5
  br i1 %cmp2, label %land.lhs.true3, label %if.else

land.lhs.true3:                                   ; preds = %land.lhs.true
  %cmp4 = icmp eq i32 %0, %.pre7
...
if.else:                                          ; preds = %for.body.if.else_crit_edge, %land.lhs.true7, %land.lhs.true5, %land.lhs.true3, %land.lhs.true
  %6 = phi i32 [ %.pre8, %for.body.if.else_crit_edge ], [ %0, %land.lhs.true7 ], [ %0, %land.lhs.true5 ], [ %0, %land.lhs.true3 ], [ %2, %land.lhs.true ]
  %7 = phi i32 [ %.pre, %for.body.if.else_crit_edge ], [ %0, %land.lhs.true7 ], [ %0, %land.lhs.true5 ], [ %.pre7, %land.lhs.true3 ], [ %.pre7, %land.lhs.true ]
...
cleanup:                                          ; preds = %if.else, %land.lhs.true7
