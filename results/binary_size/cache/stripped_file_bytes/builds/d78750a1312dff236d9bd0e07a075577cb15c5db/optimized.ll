...
sw.epilog:                                        ; preds = %sw.bb11, %sw.bb10, %sw.bb9, %sw.bb8, %sw.bb7, %sw.bb6, %sw.bb5, %sw.bb4, %sw.bb3, %entry
  ...
  %rem135 = srem i8 %rem13.lhs.trunc, 5
  %rem13.sext = sext i8 %rem135 to i32
  %call14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div, i32 noundef %k.0, i32 noundef %f.0, i32 noundef %e.0, i32 noundef %spec.select, i32 noundef %rem13.sext)
