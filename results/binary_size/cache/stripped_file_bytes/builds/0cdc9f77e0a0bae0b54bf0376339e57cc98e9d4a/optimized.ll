...
define dso_local noundef range(i32 0, 2) i32 @_Z8functionii(i32 noundef %num, i32 noundef %k) local_unnamed_addr #0 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %num) #7
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %spec.select.i)
...
for.end12:                                        ; preds = %for.cond2
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %num) #7
