...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.end ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv21, %2
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv21
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.end148
  %indvars.iv78 = phi i64 [ %6, %for.cond14.preheader ], [ %indvars.iv.next79, %for.end148 ]
  %indvars.iv75 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next76, %for.end148 ]
  %sum.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.end148 ]
  %9 = trunc nuw i64 %indvars.iv78 to i32
  %cmp15 = icmp sgt i32 %9, 1
  br i1 %cmp15, label %for.cond17, label %for.end150

for.cond17:                                       ; preds = %for.cond14, %for.end52
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.end52 ], [ 1, %for.cond14 ]
  %exitcond39 = icmp eq i64 %indvars.iv35, %indvars.iv75
  br i1 %exitcond39, label %for.cond56, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond17
  %add.ptr24 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv35
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.body22
  %indvars.iv24 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next25, %for.body22 ]
  %min.0 = phi i32 [ 100000, %for.cond20.preheader ], [ %spec.select, %for.body22 ]
  %exitcond = icmp eq i64 %indvars.iv24, %indvars.iv75
...
for.body22:                                       ; preds = %for.cond20
  %add.ptr27 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv24
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv30 = phi i64 [ 1, %for.cond37.preheader ], [ %indvars.iv.next31, %for.body39 ]
  %exitcond34 = icmp eq i64 %indvars.iv30, %indvars.iv75
  br i1 %exitcond34, label %for.end52, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %add.ptr44 = getelementptr inbounds nuw i32, ptr %add.ptr24, i64 %indvars.iv30
...
for.cond56:                                       ; preds = %for.cond17, %for.end94
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.end94 ], [ 1, %for.cond17 ]
  %exitcond54 = icmp eq i64 %indvars.iv50, %indvars.iv75
  br i1 %exitcond54, label %for.cond101, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %invariant.gep = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv50
  br label %for.cond59

for.cond59:                                       ; preds = %for.cond59.preheader, %for.body61
  %indvars.iv40 = phi i64 [ 1, %for.cond59.preheader ], [ %indvars.iv.next41, %for.body61 ]
  %min.2 = phi i32 [ 100000, %for.cond59.preheader ], [ %spec.select15, %for.body61 ]
  %exitcond44 = icmp eq i64 %indvars.iv40, %indvars.iv75
  br i1 %exitcond44, label %for.cond78.preheader, label %for.body61

for.cond78.preheader:                             ; preds = %for.cond59
  br label %for.cond78

for.body61:                                       ; preds = %for.cond59
  %gep = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv40
  %12 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %spec.select15 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  br label %for.cond59, !llvm.loop !17

for.cond78:                                       ; preds = %for.cond78.preheader, %for.body80
  %indvars.iv45 = phi i64 [ 1, %for.cond78.preheader ], [ %indvars.iv.next46, %for.body80 ]
  %exitcond49 = icmp eq i64 %indvars.iv45, %indvars.iv75
  br i1 %exitcond49, label %for.end94, label %for.body80

for.body80:                                       ; preds = %for.cond78
  %gep17 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep, i64 %indvars.iv45
  %13 = load i32, ptr %gep17, align 4, !tbaa !5, !invariant.load !13
  %sub86 = sub nsw i32 %13, %min.2
  store i32 %sub86, ptr %gep17, align 4, !tbaa !5
...
for.cond101:                                      ; preds = %for.cond56, %for.end121
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.end121 ], [ 2, %for.cond56 ]
  %exitcond64.not = icmp eq i64 %indvars.iv60, %indvars.iv78
  br i1 %exitcond64.not, label %for.cond125, label %for.cond105.preheader

for.cond105.preheader:                            ; preds = %for.cond101
  %add.ptr109 = getelementptr inbounds nuw [110 x i32], ptr %a, i64 %indvars.iv60
  %add.ptr110 = getelementptr inbounds nuw i8, ptr %add.ptr109, i64 440
  br label %for.cond105

for.cond105:                                      ; preds = %for.cond105.preheader, %for.body107
  %indvars.iv55 = phi i64 [ 1, %for.cond105.preheader ], [ %indvars.iv.next56, %for.body107 ]
  %exitcond59 = icmp eq i64 %indvars.iv55, %indvars.iv75
  br i1 %exitcond59, label %for.end121, label %for.body107

for.body107:                                      ; preds = %for.cond105
  %add.ptr113 = getelementptr inbounds nuw i32, ptr %add.ptr110, i64 %indvars.iv55
  %14 = load i32, ptr %add.ptr113, align 4, !tbaa !5, !invariant.load !13
  %add.ptr118 = getelementptr inbounds nuw i32, ptr %add.ptr109, i64 %indvars.iv55
...
for.cond125:                                      ; preds = %for.cond101, %for.end145
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.end145 ], [ 2, %for.cond101 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %indvars.iv78
  br i1 %exitcond74.not, label %for.end148, label %for.cond129.preheader

for.cond129.preheader:                            ; preds = %for.cond125
  %invariant.gep18 = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv70
  br label %for.cond129

for.cond129:                                      ; preds = %for.cond129.preheader, %for.body131
  %indvars.iv65 = phi i64 [ 1, %for.cond129.preheader ], [ %indvars.iv.next66, %for.body131 ]
  %exitcond69 = icmp eq i64 %indvars.iv65, %indvars.iv75
  br i1 %exitcond69, label %for.end145, label %for.body131

for.body131:                                      ; preds = %for.cond129
  %gep19 = getelementptr inbounds nuw [110 x i32], ptr %invariant.gep18, i64 %indvars.iv65
  %add.ptr137 = getelementptr inbounds nuw i8, ptr %gep19, i64 4
  %15 = load i32, ptr %add.ptr137, align 4, !tbaa !5, !invariant.load !13
  store i32 %15, ptr %gep19, align 4, !tbaa !5
