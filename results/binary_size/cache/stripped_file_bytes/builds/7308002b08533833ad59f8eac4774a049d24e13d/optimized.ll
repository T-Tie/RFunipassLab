...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc13 ], [ 0, %for.end ]
...
for.inc13:                                        ; preds = %for.body4, %if.then
  %p.1 = phi i32 [ %inc10, %if.then ], [ %p.0, %for.body4 ]
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond2, !llvm.loop !12

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv33 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next34, %for.inc44 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond39.not = icmp eq i32 %m.0, %smax38
  br i1 %exitcond39.not, label %for.cond47.preheader, label %for.cond19.preheader
...
for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count43 = zext nneg i32 %smax38 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.backedge, %for.cond19.preheader
  %indvars.iv30 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next31, %for.cond19.backedge ]
  %exitcond37.not = icmp eq i64 %indvars.iv30, %wide.trip.count36
  br i1 %exitcond37.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv30
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next31
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.body50
  %indvars.iv40 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next41, %for.body50 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count43
  br i1 %exitcond44.not, label %for.end57, label %for.body50

for.body50:                                       ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv40
...
for.end57:                                        ; preds = %for.cond47
  ...
  %8 = load ptr, ptr @stdin, align 8, !tbaa !16
  %call.i = call i32 @getc(ptr noundef %8)
  %9 = load ptr, ptr @stdin, align 8, !tbaa !16
  %call.i24 = call i32 @getc(ptr noundef %9)
