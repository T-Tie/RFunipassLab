...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %power) #7
  call void @llvm.lifetime.start.p0(i64 136, ptr %output) #7
  call void @llvm.memset.p0.i64(ptr align 16 %output, i8 0, i64 136, i1 false)
  %0 = getelementptr inbounds <{ i32, [33 x i32] }>, ptr %output, i32 0, i32 0
  store i32 1, ptr %0, align 16
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr %j) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr %numEnd) #7
...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %2 = load i32, ptr %power, align 4, !tbaa !5
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %3, 34
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %4 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom = sext i32 %4 to i64
  %arrayidx = getelementptr inbounds [34 x i32], ptr %output, i64 0, i64 %idxprom
...
for.cond4:                                        ; preds = %for.inc15, %for.end
  ...
  %cmp5 = icmp slt i32 %7, 34
  br i1 %cmp5, label %for.body6, label %for.end17

for.body6:                                        ; preds = %for.cond4
  %8 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom7 = sext i32 %8 to i64
  %arrayidx8 = getelementptr inbounds [34 x i32], ptr %output, i64 0, i64 %idxprom7
...
if.then:                                          ; preds = %for.body6
  ...
  %arrayidx11 = getelementptr inbounds [34 x i32], ptr %output, i64 0, i64 %idxprom10
  ...
  %arrayidx13 = getelementptr inbounds [34 x i32], ptr %output, i64 0, i64 %idxprom12
...
for.end20:                                        ; preds = %for.cond
  store i32 33, ptr %numEnd, align 4, !tbaa !5
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc29, %for.end20
  %16 = load i32, ptr %numEnd, align 4, !tbaa !5
  %cmp22 = icmp sgt i32 %16, 0
  br i1 %cmp22, label %for.body23, label %for.end30

for.body23:                                       ; preds = %for.cond21
  %17 = load i32, ptr %numEnd, align 4, !tbaa !5
  %idxprom24 = sext i32 %17 to i64
  %arrayidx25 = getelementptr inbounds [34 x i32], ptr %output, i64 0, i64 %idxprom24
...
for.inc29:                                        ; preds = %if.end28
  %19 = load i32, ptr %numEnd, align 4, !tbaa !5
  %dec = add nsw i32 %19, -1
  store i32 %dec, ptr %numEnd, align 4, !tbaa !5
  br label %for.cond21, !llvm.loop !14

for.end30:                                        ; preds = %if.else, %for.cond21
  %20 = load i32, ptr %numEnd, align 4, !tbaa !5
...
for.body33:                                       ; preds = %for.cond31
  ...
  %arrayidx35 = getelementptr inbounds [34 x i32], ptr %output, i64 0, i64 %idxprom34
  %23 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %call36 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %23)
  br label %for.inc37

for.inc37:                                        ; preds = %for.body33
  %24 = load i32, ptr %i, align 4, !tbaa !5
  %dec38 = add nsw i32 %24, -1
  store i32 %dec38, ptr %i, align 4, !tbaa !5
...
for.end39:                                        ; preds = %for.cond31
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %numEnd) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr %j) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #7
  call void @llvm.lifetime.end.p0(i64 136, ptr %output) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr %power) #7
  ret i32 0
}
