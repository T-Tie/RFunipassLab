...
for.cond1:                                        ; preds = %for.cond, %for.body4
  %1 = phi i32 [ %.pre9, %for.body4 ], [ %0, %for.cond ]
  %j.0 = phi i32 [ %inc, %for.body4 ], [ 1, %for.cond ]
  %a1.1 = phi i32 [ %spec.select, %for.body4 ], [ %a1.0, %for.cond ]
  %a2.1 = phi i32 [ %spec.select8, %for.body4 ], [ %a2.0, %for.cond ]
  %b1.1 = phi i32 [ %b1.2, %for.body4 ], [ %b1.0, %for.cond ]
  %b2.1 = phi i32 [ %b2.2, %for.body4 ], [ %b2.0, %for.cond ]
...
for.body4:                                        ; preds = %for.cond1
  ...
  %spec.select = select i1 %or.cond, i32 %i.0, i32 %a1.1
  %spec.select8 = select i1 %or.cond, i32 %j.0, i32 %a2.1
  %b1.2 = select i1 %cmp6, i32 %i.0, i32 %b1.1
  %b2.2 = select i1 %cmp6, i32 %j.0, i32 %b2.1
