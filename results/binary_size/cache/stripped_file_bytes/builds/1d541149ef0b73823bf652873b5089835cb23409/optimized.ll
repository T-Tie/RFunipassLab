...
for.cond6.preheader:                              ; preds = %for.cond
  ...
  br i1 %cmp7, label %for.cond6.preheader13, label %for.end35

for.cond6.preheader13:                            ; preds = %for.cond6.preheader
...
for.cond6:                                        ; preds = %for.cond6.preheader13, %for.cond.cleanup13
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader13 ], [ %indvars.iv.next, %for.cond.cleanup13 ]
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv
  br label %for.cond11

for.cond11:                                       ; preds = %for.cond6, %if.end29
  %indvars.iv14 = phi i64 [ %indvars.iv, %for.cond6 ], [ %indvars.iv.next15, %if.end29 ]
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %cmp12 = icmp samesign ult i64 %indvars.iv.next15, %4
...
for.body14:                                       ; preds = %for.cond11
  ...
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next15
...
for.end35:                                        ; preds = %for.cond6.preheader
  ...
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %9)
