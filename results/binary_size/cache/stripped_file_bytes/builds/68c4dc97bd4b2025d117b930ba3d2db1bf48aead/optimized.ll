...
for.inc:                                          ; preds = %for.body, %if.else, %if.else14
  %.str.2.sink.sink = phi ptr [ @.str, %for.body ], [ @.str.2, %if.else14 ], [ @.str.1, %if.else ]
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str.2.sink.sink)
