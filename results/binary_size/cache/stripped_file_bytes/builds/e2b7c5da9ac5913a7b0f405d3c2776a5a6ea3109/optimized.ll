...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.end ], [ 0, %for.cond ]
...
for.cond:                                         ; preds = %for.end27, %entry
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.end27 ], [ 0, %entry ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count56
  br i1 %exitcond57.not, label %for.cond31.preheader, label %for.body
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv53
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv53, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv48 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next49, %for.body16 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond52.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv53, i64 %indvars.iv48
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end70
  %indvars.iv68 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next69, %for.end70 ]
  %exitcond72.not = icmp eq i64 %indvars.iv68, %wide.trip.count56
  br i1 %exitcond72.not, label %for.end73, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv68
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.body39 ], [ 0, %for.body33 ]
  %s.1 = phi i32 [ %spec.select46, %for.body39 ], [ %3, %for.body33 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count61
  br i1 %exitcond62.not, label %for.cond56.preheader, label %for.body39

for.cond56.preheader:                             ; preds = %for.cond37
  br label %for.cond56

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv58, i64 %indvars.iv68
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !12
  %spec.select46 = tail call i32 @llvm.smin.i32(i32 %s.1, i32 %4)
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  br label %for.cond37, !llvm.loop !16

for.cond56:                                       ; preds = %for.cond56.preheader, %for.body58
  %indvars.iv63 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next64, %for.body58 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count61
  br i1 %exitcond67.not, label %for.end70, label %for.body58

for.body58:                                       ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv63, i64 %indvars.iv68
  %5 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
...
for.cond81:                                       ; preds = %for.body83, %if.then
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body83 ], [ 2, %if.then ]
  %exitcond78.not = icmp eq i64 %indvars.iv73, %wide.trip.count77
  br i1 %exitcond78.not, label %for.cond101, label %for.body83

for.body83:                                       ; preds = %for.cond81
  %arrayidx86 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv73
  %8 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !12
  %9 = add nsw i64 %indvars.iv73, -1
  %arrayidx90 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %9
  store i32 %8, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx92 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv73
  %10 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !12
...
for.cond101:                                      ; preds = %for.cond81, %for.end119
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.end119 ], [ 2, %for.cond81 ]
  %exitcond90.not = icmp eq i64 %indvars.iv85, %wide.trip.count77
  br i1 %exitcond90.not, label %for.end122, label %for.cond104.preheader

for.cond104.preheader:                            ; preds = %for.cond101
  %11 = add nsw i64 %indvars.iv85, -1
  br label %for.cond104

for.cond104:                                      ; preds = %for.cond104.preheader, %for.body106
  %indvars.iv79 = phi i64 [ 2, %for.cond104.preheader ], [ %indvars.iv.next80, %for.body106 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count77
  br i1 %exitcond84.not, label %for.end119, label %for.body106

for.body106:                                      ; preds = %for.cond104
  %arrayidx110 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv85, i64 %indvars.iv79
  %12 = load i32, ptr %arrayidx110, align 4, !tbaa !5, !invariant.load !12
  %13 = add nsw i64 %indvars.iv79, -1
