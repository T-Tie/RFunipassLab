...
for.cond6:                                        ; preds = %for.cond, %for.inc395
  ...
  %indvars.iv195 = phi i64 [ %indvars.iv.next196, %for.inc395 ], [ 1, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp7.not = icmp sgt i64 %indvars.iv195, %3
  br i1 %cmp7.not, label %for.end397, label %for.body8

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [200 x i32], ptr %year, i64 0, i64 %indvars.iv195
  ...
  %or.cond183 = or i1 %cmp19, %or.cond
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %mon1, i64 0, i64 %indvars.iv195
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  br i1 %or.cond183, label %if.then, label %if.else205
...
if.end102:                                        ; preds = %if.end102.sink.split, %if.then
  %arrayidx104 = getelementptr inbounds nuw [200 x i32], ptr %mon2, i64 0, i64 %indvars.iv195
  ...
  switch i32 %7, label %if.end186 [
    ...
    i32 3, label %if.end144.thread201
    i32 4, label %if.end144.thread201.fold.split
...
if.end144.thread201.fold.split:                   ; preds = %if.end102
  br label %if.end186.sink.split

if.end144.thread201:                              ; preds = %if.end102
  br label %if.end186.sink.split
...
if.end186.sink.split:                             ; preds = %if.end172.thread.fold.split, %if.end158.thread.fold.split, %if.end144.thread.fold.split, %if.end144.thread201.fold.split, %if.end102, %if.then183, %if.end179.thread, %if.then113, %if.end172.thread, %if.end144.thread, %if.end144.thread201, %if.end158.thread
  %storemerge190.sink = phi i32 [ 32, %if.then113 ], [ 306, %if.end179.thread ], [ 336, %if.then183 ], [ 1, %if.end102 ], [ 92, %if.end144.thread201.fold.split ], [ 61, %if.end144.thread201 ], [ 153, %if.end144.thread.fold.split ], [ 122, %if.end144.thread ], [ 214, %if.end158.thread.fold.split ], [ 183, %if.end158.thread ], [ 275, %if.end172.thread.fold.split ], [ 245, %if.end172.thread ]
  store i32 %storemerge190.sink, ptr %arrayidx104, align 4, !tbaa !5
  br label %if.end186

if.end186:                                        ; preds = %if.end186.sink.split, %if.end102
  %8 = phi i32 [ %7, %if.end102 ], [ %storemerge190.sink, %if.end186.sink.split ]
  %sub = sub nsw i32 %8, %6
...
if.end289.sink.split:                             ; preds = %if.else205, %if.then286, %if.then279, %if.then272, %if.then265, %if.then258, %if.then251, %if.then244, %if.then237, %if.then230, %if.then223, %if.then216
  %.sink239 = phi i32 [ 32, %if.then216 ], [ 60, %if.then223 ], [ 91, %if.then230 ], [ 121, %if.then237 ], [ 152, %if.then244 ], [ 182, %if.then251 ], [ 213, %if.then258 ], [ 244, %if.then265 ], [ 274, %if.then272 ], [ 305, %if.then279 ], [ 335, %if.then286 ], [ 1, %if.else205 ]
  store i32 %.sink239, ptr %arrayidx21, align 4, !tbaa !5
  br label %if.end289

if.end289:                                        ; preds = %if.end289.sink.split, %if.else205
  %arrayidx291 = getelementptr inbounds nuw [200 x i32], ptr %mon2, i64 0, i64 %indvars.iv195
  ...
  switch i32 %9, label %if.end373 [
    ...
    i32 3, label %if.end331.thread221
    i32 4, label %if.end331.thread221.fold.split
...
if.end331.thread221.fold.split:                   ; preds = %if.end289
  br label %if.end373.sink.split

if.end331.thread221:                              ; preds = %if.end289
  br label %if.end373.sink.split
...
if.end373.sink.split:                             ; preds = %if.end359.thread.fold.split, %if.end345.thread.fold.split, %if.end331.thread.fold.split, %if.end331.thread221.fold.split, %if.end289, %if.then370, %if.end366.thread, %if.then300, %if.end359.thread, %if.end331.thread, %if.end331.thread221, %if.end345.thread
  %storemerge185.sink = phi i32 [ 32, %if.then300 ], [ 305, %if.end366.thread ], [ 335, %if.then370 ], [ 1, %if.end289 ], [ 91, %if.end331.thread221.fold.split ], [ 60, %if.end331.thread221 ], [ 152, %if.end331.thread.fold.split ], [ 121, %if.end331.thread ], [ 213, %if.end345.thread.fold.split ], [ 182, %if.end345.thread ], [ 274, %if.end359.thread.fold.split ], [ 244, %if.end359.thread ]
  store i32 %storemerge185.sink, ptr %arrayidx291, align 4, !tbaa !5
  br label %if.end373

if.end373:                                        ; preds = %if.end373.sink.split, %if.end289
  %10 = phi i32 [ %9, %if.end289 ], [ %storemerge185.sink, %if.end373.sink.split ]
...
lor.lhs.false381:                                 ; preds = %if.end373
  ...
  %spec.select241 = select i1 %cmp388, ptr @str.1, ptr @str
  br label %for.inc395

for.inc395:                                       ; preds = %lor.lhs.false381, %lor.lhs.false193, %if.end373, %if.end186
  %str.2.sink = phi ptr [ @str.3, %if.end186 ], [ @str.1, %if.end373 ], [ %spec.select, %lor.lhs.false193 ], [ %spec.select241, %lor.lhs.false381 ]
  %puts192 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.sink) #5
