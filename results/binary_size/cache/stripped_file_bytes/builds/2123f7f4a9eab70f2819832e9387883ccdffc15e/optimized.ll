...
for.cond12:                                       ; preds = %for.inc39, %for.end9
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc39 ], [ 0, %for.end9 ]
...
for.cond20:                                       ; preds = %for.inc36, %for.body14
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc36 ], [ 1, %for.body14 ]
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc71
  %indvars.iv29 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next30, %for.inc71 ]
...
for.cond50:                                       ; preds = %for.inc68, %for.body44
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc68 ], [ 1, %for.body44 ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %for.inc71, label %for.body52
...
for.cond74:                                       ; preds = %for.cond42, %for.inc100
  %.pre4142 = phi i32 [ %.pre4143, %for.inc100 ], [ %12, %for.cond42 ]
  %20 = phi i32 [ %25, %for.inc100 ], [ %12, %for.cond42 ]
  %21 = phi i32 [ %.pre, %for.inc100 ], [ %6, %for.cond42 ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc100 ], [ 0, %for.cond42 ]
...
for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc97
  %.pre4143 = phi i32 [ %.pre4142, %for.cond77.preheader ], [ %.pre41, %for.inc97 ]
  %25 = phi i32 [ %20, %for.cond77.preheader ], [ %.pre41, %for.inc97 ]
  %indvars.iv35 = phi i64 [ 0, %for.cond77.preheader ], [ %indvars.iv.next36, %for.inc97 ]
