...
for.cond:                                         ; preds = %while.cond, %for.body
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body ], [ %indvars.iv, %while.cond ]
  %cmp24 = icmp sgt i64 %indvars.iv20, 0
  br i1 %cmp24, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %indvars.iv.next21 = add nsw i64 %indvars.iv20, -1
  %arrayidx26 = getelementptr inbounds nuw [1000 x %struct.student], ptr %stu, i64 0, i64 %indvars.iv.next21
  %name31 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 20
  %sex35 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 40
  %1 = load i8, ptr %sex35, align 8, !tbaa !11
  %conv36 = sext i8 %1 to i32
  %age39 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 44
  %2 = load i32, ptr %age39, align 4, !tbaa !14
  %score42 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 48
  %add46 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 68
  %call48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, ptr noundef nonnull %arrayidx26, ptr noundef nonnull %name31, i32 noundef %conv36, i32 noundef %2, ptr noundef nonnull %score42, ptr noundef nonnull %add46)
