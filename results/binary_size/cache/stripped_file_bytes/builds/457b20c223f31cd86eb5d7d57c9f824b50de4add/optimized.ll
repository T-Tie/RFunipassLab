...
for.cond:                                         ; preds = %for.inc16, %entry
  %i.0 = phi i32 [ %y, %entry ], [ %inc17, %for.inc16 ]
...
cleanup:                                          ; preds = %if.end
  %call = tail call noundef i32 @_Z3wrhiiPiii(i32 noundef %add, i32 noundef %div12, ptr noundef nonnull %b, i32 noundef %i.0, i32 noundef %a)
  br label %for.inc16
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z3wrhiiPiii(i32 noundef 1, i32 noundef %1, ptr noundef nonnull %b, i32 noundef 2, i32 noundef %1)
  %2 = load i32, ptr @num, align 4, !tbaa !5
  %add = add nsw i32 %2, 1
