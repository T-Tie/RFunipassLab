...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10500, ptr nonnull %a) #4
...
if.else34.i:                                      ; preds = %entry, %if.else34.i
  ...
  br i1 %cmp, label %for.cond, label %if.else34.i, !llvm.loop !5

for.cond:                                         ; preds = %if.else34.i, %for.body
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body ], [ %indvars.iv, %if.else34.i ]
  %cmp2 = icmp sgt i64 %indvars.iv19, 0
  br i1 %cmp2, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #4
  ...
  call void @llvm.lifetime.end.p0(i64 10500, ptr nonnull %a) #4
  ret i32 0

for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [100 x [105 x i8]], ptr %a, i64 0, i64 %indvars.iv19
  %call.i.i9 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx4) #4
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx4, i64 noundef %call.i.i9)
