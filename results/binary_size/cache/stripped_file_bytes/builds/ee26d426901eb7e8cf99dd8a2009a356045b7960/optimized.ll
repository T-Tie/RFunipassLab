...
for.cond:                                         ; preds = %for.inc29, %entry.split
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc29 ], [ 1, %entry.split ]
  %arrayidx3 = getelementptr inbounds nuw [5 x i8], ptr %s, i64 %indvars.iv17
...
for.body10:                                       ; preds = %for.cond7
  ...
  %arrayidx19 = getelementptr inbounds nuw [5 x i8], ptr %s, i64 %indvars.iv17, i64 %indvars.iv
...
cleanup.cont:                                     ; preds = %for.cond.cleanup9, %for.end31
  %idxprom32.sink = phi i64 [ %idxprom32, %for.end31 ], [ %indvars.iv17, %for.cond.cleanup9 ]
  %arrayidx33 = getelementptr inbounds [200 x i32], ptr @num, i64 0, i64 %idxprom32.sink
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !12
  %inc16.i.i7 = add nsw i32 %5, 1
  store i32 %inc16.i.i7, ptr %arrayidx33, align 4, !tbaa !12
  ret void
}
