...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc22
  %indvars.iv20 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next21, %for.inc22 ]
  %exitcond24 = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24, label %for.cond25.preheader, label %for.cond9
...
for.cond25.preheader:                             ; preds = %for.cond5
  ...
  %wide.trip.count35 = zext i32 %sub to i64
  %wide.trip.count28 = zext nneg i32 %smax17 to i64
  br label %for.cond25

for.cond9:                                        ; preds = %for.cond5, %for.inc19
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc19 ], [ 0, %for.cond5 ]
  %exitcond19.not = icmp eq i64 %indvars.iv11, %wide.trip.count18
  br i1 %exitcond19.not, label %for.inc22, label %for.inc19

for.inc19:                                        ; preds = %for.cond9
  %2 = add nuw nsw i64 %indvars.iv11, %indvars.iv20
  ...
  %arrayidx17 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv20, i64 %indvars.iv11
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc69
  %indvars.iv30 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next31, %for.inc69 ]
  %exitcond40.not = icmp eq i64 %indvars.iv30, %wide.trip.count39
  br i1 %exitcond40.not, label %for.end71, label %for.cond30.preheader

for.cond30.preheader:                             ; preds = %for.cond25
  %arrayidx35 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv30
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv30
  br label %for.cond30
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc66
  ...
  br i1 %exitcond36.not, label %for.inc69, label %for.body33
...
land.lhs.true:                                    ; preds = %for.body33
  %arrayidx40 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv.next33
...
for.cond56:                                       ; preds = %for.inc63, %if.then
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc63 ], [ 0, %if.then ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv.next33, i64 %indvars.iv25
...
for.end71:                                        ; preds = %for.cond25
  ...
  %8 = add nuw i32 %smax38, 1
  %wide.trip.count44 = zext i32 %8 to i64
  br label %for.cond73

for.cond73:                                       ; preds = %for.body76, %for.end71
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body76 ], [ 1, %for.end71 ]
  %m.0 = phi i32 [ %spec.select, %for.body76 ], [ %7, %for.end71 ]
  %exitcond45 = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45, label %for.end86, label %for.body76

for.body76:                                       ; preds = %for.cond73
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv41
...
if.then88:                                        ; preds = %for.end86
  %puts9 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str) #8
  br label %cleanup
...
for.cond91:                                       ; preds = %for.inc104, %if.else
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc104 ], [ 0, %if.else ]
  %10 = load i32, ptr %n, align 4, !tbaa !5
  %sub92 = sub nsw i32 %conv, %10
  %11 = sext i32 %sub92 to i64
  %cmp93.not = icmp sgt i64 %indvars.iv46, %11
  br i1 %cmp93.not, label %cleanup, label %for.body94

for.body94:                                       ; preds = %for.cond91
  %arrayidx96 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv46
...
if.then98:                                        ; preds = %for.body94
  %arrayidx100 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv46
  %puts = call i32 @puts(ptr noundef nonnull readonly captures(none) dereferenceable(1) %arrayidx100) #8
  br label %for.inc104
