...
entry:
  ...
  br i1 %call16.i, label %land.lhs.true.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  br i1 %or.cond.i, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  ...
  br i1 %tobool.not.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57, label %if.then28.i
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57: ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %p.0 = phi ptr [ %incdec.ptr, %for.inc ], [ %call7, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
...
if.end:                                           ; preds = %for.cond, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57
...
if.then6.i11_to_outline:
  ...
  %call16.i16 = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %1) #10
  br i1 %call16.i16, label %land.lhs.true.i17, label %if.then6.i38.exitStub

land.lhs.true.i17:                                ; preds = %if.then6.i11_to_outline
  %_M_width.i4.i18 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %2 = load i64, ptr %_M_width.i4.i18, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -71
  %or.cond.i21 = icmp ult i64 %3, -70
  br i1 %or.cond.i21, label %if.then19.i22, label %if.then6.i38.exitStub

if.then19.i22:                                    ; preds = %land.lhs.true.i17
  %call24.i23 = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %1) #10
  %call25.i24 = tail call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %call24.i23)
  %cmp.i.i25 = icmp eq i32 %call25.i24, -1
  %conv.i26 = zext i1 %cmp.i.i25 to i64
  %expval.i27 = tail call i64 @llvm.expect.i64(i64 noundef %conv.i26, i64 noundef 1)
  %tobool.not.i28 = icmp eq i64 %expval.i27, 0
  br i1 %tobool.not.i28, label %if.then6.i38.exitStub, label %if.then28.i29
...
if.then28.i29:                                    ; preds = %if.then19.i22
  ...
  br label %if.then6.i38.exitStub

if.then6.i38.exitStub:                            ; preds = %if.then28.i29, %if.then19.i22, %land.lhs.true.i17, %if.then6.i11_to_outline
  ret void
}
