...
for.cond6.preheader:                              ; preds = %for.body
  %1 = icmp sgt i32 %2, 0
  br i1 %1, label %for.body8, label %for.end46
...
for.body8:                                        ; preds = %for.cond6.preheader, %for.inc44
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc44 ], [ 0, %for.cond6.preheader ]
  %arrayidx10 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv23
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %5 = and i32 %4, 3
  %cmp.i = icmp ne i32 %5, 0
  %rem1.i = srem i32 %4, 100
  %cmp2.not.i = icmp eq i32 %rem1.i, 0
  %or.cond.not4.i.not17 = or i1 %cmp.i, %cmp2.not.i
  %rem3.i = srem i32 %4, 400
  %cmp4.i = icmp ne i32 %rem3.i, 0
  %or.cond3.i.not = and i1 %cmp4.i, %or.cond.not4.i.not17
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv23
  %6 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %idxprom29 = sext i32 %6 to i64
  %arrayidx32 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv23
  %7 = load i32, ptr %arrayidx32, align 4, !tbaa !5
  %idxprom33 = sext i32 %7 to i64
  br i1 %or.cond3.i.not, label %if.else25, label %if.then
...
for.inc44:                                        ; preds = %if.else25, %if.then
  ...
  %cmp7 = icmp slt i64 %indvars.iv.next24, %13
  br i1 %cmp7, label %for.body8, label %for.end46, !llvm.loop !12

for.end46:                                        ; preds = %for.inc44, %entry, %for.cond6.preheader
  %14 = load ptr, ptr @stdin, align 8, !tbaa !13
  %call.i = call i32 @getc(ptr noundef %14)
  %15 = load ptr, ptr @stdin, align 8, !tbaa !13
  %call.i15 = call i32 @getc(ptr noundef %15)
  %16 = load ptr, ptr @stdin, align 8, !tbaa !13
  %call.i16 = call i32 @getc(ptr noundef %16)
