...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count45 = zext nneg i32 %smax39 to i64
...
for.cond10:                                       ; preds = %for.end44, %for.cond10.preheader
  %indvars.iv42 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next43, %for.end44 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %if.then53, label %for.cond13
...
for.cond28.preheader:                             ; preds = %for.cond13
  ...
  %arrayidx38 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %idxprom33
  %5 = trunc nuw nsw i64 %indvars.iv42 to i32
  br label %for.cond28

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %indvars.iv32
  %6 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %idxprom22 = zext nneg i32 %max.0 to i64
  %arrayidx23 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %idxprom22
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv35 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next36, %for.body30 ]
  %min.0 = phi i32 [ %5, %for.cond28.preheader ], [ %spec.select25, %for.body30 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count45
  br i1 %exitcond41.not, label %for.end44, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx34 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv35, i64 %idxprom33
