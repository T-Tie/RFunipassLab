...
while.cond10:                                     ; preds = %while.cond10.preheader, %while.end34
  %indvars.iv8.in = phi i32 [ %t.0, %while.cond10.preheader ], [ %indvars.iv8, %while.end34 ]
  %s.0 = phi i32 [ 1, %while.cond10.preheader ], [ %inc35, %while.end34 ]
  %indvars.iv8 = add i32 %indvars.iv8.in, -1
  %exitcond12 = icmp eq i32 %s.0, %2
  br i1 %exitcond12, label %while.cond37.preheader, label %while.cond13.preheader
...
while.cond13:                                     ; preds = %while.cond13.preheader, %if.end32
  %indvars.iv4 = phi i64 [ 0, %while.cond13.preheader ], [ %indvars.iv.next5, %if.end32 ]
...
while.body15:                                     ; preds = %while.cond13
  %arrayidx17 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv4
  %6 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %arrayidx19 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next5
...
while.cond37:                                     ; preds = %while.cond37.preheader, %if.end47
  %indvars.iv13 = phi i64 [ 0, %while.cond37.preheader ], [ %indvars.iv.next14, %if.end47 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %while.end49, label %while.body39

while.body39:                                     ; preds = %while.cond37
  %cmp40 = icmp eq i64 %indvars.iv13, 0
...
if.else:                                          ; preds = %while.body39
  %arrayidx45 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv13
