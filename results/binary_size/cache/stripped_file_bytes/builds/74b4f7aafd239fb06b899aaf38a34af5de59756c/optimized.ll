...
for.cond:                                         ; preds = %for.inc, %entry
  %1 = phi i32 [ %7, %for.inc ], [ %.pre2, %entry ]
...
for.cond2:                                        ; preds = %for.cond, %for.inc7
  ...
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc7 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv7 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next8, %for.inc28 ]
