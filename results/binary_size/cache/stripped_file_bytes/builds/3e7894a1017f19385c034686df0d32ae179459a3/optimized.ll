...
for.cond:                                         ; preds = %for.inc31, %tailrecurse
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc31 ], [ 0, %tailrecurse ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count66
  br i1 %exitcond67.not, label %for.cond34, label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv63, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.end, %for.inc27
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc27 ], [ 0, %for.end ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count
  br i1 %exitcond62.not, label %for.inc31, label %for.inc27

for.inc27:                                        ; preds = %for.cond14
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv63, i64 %indvars.iv58
...
for.cond34:                                       ; preds = %for.cond, %for.inc78
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc78 ], [ 0, %for.cond ]
  %exitcond83.not = icmp eq i64 %indvars.iv78, %wide.trip.count66
  br i1 %exitcond83.not, label %for.end80, label %for.cond38

for.cond38:                                       ; preds = %for.cond34, %for.inc56
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc56 ], [ 0, %for.cond34 ]
  %min.2 = phi i32 [ %min.4, %for.inc56 ], [ 1000, %for.cond34 ]
  %exitcond72.not = icmp eq i64 %indvars.iv68, %wide.trip.count
  br i1 %exitcond72.not, label %for.end58, label %for.body41

for.body41:                                       ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv68, i64 %indvars.iv78
...
for.cond61:                                       ; preds = %for.end58, %for.inc74
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc74 ], [ 0, %for.end58 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count
  br i1 %exitcond77.not, label %for.inc78, label %for.inc74

for.inc74:                                        ; preds = %for.cond61
  %arrayidx68 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv73, i64 %indvars.iv78
...
for.end80:                                        ; preds = %for.cond34
  %smax100 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
...
for.cond85.preheader:                             ; preds = %for.end80
  ...
  %4 = add nuw i32 %smax88, 1
  %wide.trip.count89 = zext i32 %4 to i64
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.inc102
  %indvars.iv84 = phi i64 [ 2, %for.cond85.preheader ], [ %indvars.iv.next85, %for.inc102 ]
  %exitcond90 = icmp eq i64 %indvars.iv84, %wide.trip.count89
  br i1 %exitcond90, label %for.cond105.preheader, label %for.inc102
...
for.inc102:                                       ; preds = %for.cond85
  %arrayidx90 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 0, i64 %indvars.iv84
  %5 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !14
  %6 = add nsw i64 %indvars.iv84, -1
  %arrayidx94 = getelementptr inbounds [200 x i32], ptr %num, i64 0, i64 %6
  store i32 %5, ptr %arrayidx94, align 4, !tbaa !5
  %arrayidx96 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv84
...
for.cond105:                                      ; preds = %for.cond105.preheader, %for.inc126
  %indvars.iv97 = phi i64 [ 2, %for.cond105.preheader ], [ %indvars.iv.next98, %for.inc126 ]
  %exitcond102.not = icmp eq i64 %indvars.iv97, %wide.trip.count101
  br i1 %exitcond102.not, label %tailrecurse, label %for.cond109

for.cond109:                                      ; preds = %for.cond105, %for.inc123
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc123 ], [ 2, %for.cond105 ]
  %exitcond96.not = icmp eq i64 %indvars.iv91, %wide.trip.count
  br i1 %exitcond96.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [200 x i32], ptr %num, i64 %indvars.iv97, i64 %indvars.iv91
  %8 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !14
  %9 = add nsw i64 %indvars.iv91, -1
  %arrayidx122 = getelementptr [200 x i32], ptr %invariant.gep, i64 %indvars.iv97, i64 %9
