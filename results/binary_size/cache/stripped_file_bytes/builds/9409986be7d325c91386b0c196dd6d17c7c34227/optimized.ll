...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %q) #5
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %p) #5
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull %w) #5
  ...
  %smax12 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count13 = zext nneg i32 %smax12 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv23 = phi i32 [ %indvars.iv.next24, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv18 = phi i32 [ %indvars.iv.next19, %for.inc29 ], [ 0, %entry ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc29 ], [ 0, %entry ]
  %g.0 = phi i32 [ %g.3, %for.inc29 ], [ undef, %entry ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv9
  %1 = load i8, ptr %arrayidx11, align 1, !tbaa !5, !invariant.load !8
  %cmp13 = icmp eq i8 %0, %1
  br i1 %cmp13, label %for.cond14, label %for.inc29

for.cond14:                                       ; preds = %for.body, %for.body16
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body16 ], [ 1, %for.body ]
  %g.1 = phi i32 [ %spec.select, %for.body16 ], [ %g.0, %for.body ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = add nuw nsw i64 %indvars.iv, %indvars.iv9
...
for.end:                                          ; preds = %for.cond14
  %cmp25 = icmp eq i32 %g.1, 1
  br i1 %cmp25, label %for.cond33.preheader, label %for.inc29

for.cond33.preheader:                             ; preds = %for.end
  %wide.trip.count21 = zext i32 %indvars.iv18 to i64
  br label %for.cond33

for.inc29:                                        ; preds = %for.body, %for.end
  %g.3 = phi i32 [ %g.1, %for.end ], [ %g.0, %for.body ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv15 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next16, %for.inc40 ]
  %exitcond22.not = icmp eq i64 %indvars.iv15, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv15
...
for.end42:                                        ; preds = %for.cond33
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %w) #8
  %6 = sext i32 %indvars.iv23 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc53 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv26, %7
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv26
...
if.else:                                          ; preds = %for.cond
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %q) #8
  br label %if.end58

if.end58:                                         ; preds = %for.cond46, %if.else
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %w) #8
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %p) #8
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %q) #8
  ret i32 0
}
