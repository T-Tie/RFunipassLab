...
if.then19:                                        ; preds = %for.end17
  ...
  %arrayidx22 = getelementptr inbounds [20001 x i32], ptr %a, i64 0, i64 %idxprom21
  %18 = load i32, ptr %arrayidx22, align 4, !tbaa !5
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call20, i32 noundef %18)
  br label %if.end24

if.end24:                                         ; preds = %if.then19, %for.end17
  br label %for.inc25
