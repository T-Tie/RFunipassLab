...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40000, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 40000, ptr %b) #9
  call void @llvm.lifetime.start.p0(i64 40000, ptr %c) #9
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx37 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom36
...
for.body42:                                       ; preds = %for.cond40
  ...
  %arrayidx44 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom43
  ...
  %arrayidx48 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom47
  ...
  %arrayidx52 = getelementptr inbounds [100 x [100 x i32]], ptr %b, i64 0, i64 %idxprom51
  ...
  %arrayidx56 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom55
...
while.cond:                                       ; preds = %for.end80, %for.end67
...
for.body71:                                       ; preds = %for.cond69
  ...
  %call76 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %44)
  %call77 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call76, ptr noundef @.str)
  br label %for.inc78
...
for.end80:                                        ; preds = %for.cond69
  ...
  %arrayidx82 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom81
  %47 = load i32, ptr %y2, align 4, !tbaa !5
  %sub83 = sub nsw i32 %47, 1
  %idxprom84 = sext i32 %sub83 to i64
  %arrayidx85 = getelementptr inbounds [100 x i32], ptr %arrayidx82, i64 0, i64 %idxprom84
  %48 = load i32, ptr %arrayidx85, align 4, !tbaa !5
  %call86 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %48)
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 40000, ptr %c) #9
  call void @llvm.lifetime.end.p0(i64 40000, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 40000, ptr %a) #9
