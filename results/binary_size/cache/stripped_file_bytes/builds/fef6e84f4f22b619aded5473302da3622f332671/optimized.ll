...
for.body20:                                       ; preds = %for.cond14
  ...
  tail call void @_Z8xiaojiani(i32 noundef %7) #9
...
for.cond3:                                        ; preds = %for.cond, %if.end52
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %if.end52 ], [ 0, %for.cond ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond56, label %for.cond7
...
for.body10:                                       ; preds = %for.cond7
  %arrayidx14 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv32 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next33, %for.body39 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count40
  br i1 %exitcond36.not, label %if.end52, label %for.body39

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv32
...
for.cond56:                                       ; preds = %for.cond3, %if.end110
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %if.end110 ], [ 0, %for.cond3 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count40
  br i1 %exitcond56.not, label %if.end114, label %for.cond60

for.cond60:                                       ; preds = %for.cond56, %for.inc89
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc89 ], [ 0, %for.cond56 ]
  %min.3 = phi i32 [ %min.4, %for.inc89 ], [ 1000, %for.cond56 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count40
  br i1 %exitcond46.not, label %for.cond94.preheader, label %for.body63

for.cond94.preheader:                             ; preds = %for.cond60
  br label %for.cond94

for.body63:                                       ; preds = %for.cond60
  %arrayidx67 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv52
...
if.end77:                                         ; preds = %if.end70
  %spec.select22 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.3)
  br label %for.inc89

for.inc89:                                        ; preds = %if.end77, %for.body63
  %min.4 = phi i32 [ %min.3, %for.body63 ], [ %spec.select22, %if.end77 ]
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  br label %for.cond60, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.body97
  %indvars.iv47 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next48, %for.body97 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count40
  br i1 %exitcond51.not, label %if.end110, label %for.body97

for.body97:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv52
...
define dso_local void @_Z8xiaojiani(i32 noundef %cishu) local_unnamed_addr #4 {
entry:
  %0 = load i32, ptr @g_n, align 4, !tbaa !5
