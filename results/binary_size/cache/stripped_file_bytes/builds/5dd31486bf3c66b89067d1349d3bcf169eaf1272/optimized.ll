...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40000, ptr nonnull %n) #6
...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body3 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10000 x i32], ptr %n, i64 0, i64 %indvars.iv11
...
for.cond10:                                       ; preds = %for.cond1, %for.body12
  ...
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body12 ], [ 0, %for.cond1 ]
  %3 = sext i32 %2 to i64
  %cmp11 = icmp slt i64 %indvars.iv14, %3
  br i1 %cmp11, label %for.body12, label %for.end19

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [10000 x i32], ptr %n, i64 0, i64 %indvars.iv14
  %4 = load i32, ptr %arrayidx14, align 4, !tbaa !5
  call void @_Z6fenjieii(i32 noundef 1, i32 noundef %4)
...
for.end19:                                        ; preds = %for.cond10
  call void @llvm.lifetime.end.p0(i64 40000, ptr nonnull %n) #6
...
entry:
  ...
  %add = add nsw i32 %j, 1
  %smax = tail call i32 @llvm.smax.i32(i32 %sum, i32 1)
  %0 = add nuw i32 %smax, 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 2, %entry ], [ %inc8, %for.inc ]
...
if.else:                                          ; preds = %if.then
  tail call void @_Z6fenjieii(i32 noundef %add, i32 noundef %div)
  br label %for.inc

for.inc:                                          ; preds = %for.body, %land.lhs.true, %if.else, %if.then6
