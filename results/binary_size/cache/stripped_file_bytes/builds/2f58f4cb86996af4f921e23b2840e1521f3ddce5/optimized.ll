...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %a) #11
  call void @llvm.lifetime.start.p0(i64 1, ptr %v) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr %number) #11
  store i32 0, ptr %number, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %c) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr %m) #11
  store i32 1, ptr %m, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %an_number) #11
  store i32 0, ptr %an_number, align 4, !tbaa !5
  ...
  store i32 80, ptr %max, align 4, !tbaa !5
  br label %while.cond
...
while.cond1:                                      ; preds = %if.end31, %while.body
  ...
  %cmp = icmp sle i32 %1, 80
  br i1 %cmp, label %while.body2, label %while.end

while.body2:                                      ; preds = %while.cond1
  %arraydecay = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %arraydecay)
  %2 = load i32, ptr %an_number, align 4, !tbaa !5
  %add = add nsw i32 %2, 1
  store i32 %add, ptr %an_number, align 4, !tbaa !5
  %3 = load i32, ptr %number, align 4, !tbaa !5
  %cmp4 = icmp eq i32 %3, 0
  br i1 %cmp4, label %if.then, label %if.else

if.then:                                          ; preds = %while.body2
  %arraydecay5 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay5)
  %4 = load i32, ptr %number, align 4, !tbaa !5
  %conv = sext i32 %4 to i64
  %arraydecay7 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  %call8 = call i64 @strlen(ptr noundef %arraydecay7) #12
  %add9 = add i64 %conv, %call8
  %conv10 = trunc i64 %add9 to i32
  store i32 %conv10, ptr %number, align 4, !tbaa !5
  br label %if.end28

if.else:                                          ; preds = %while.body2
  %5 = load i32, ptr %number, align 4, !tbaa !5
  %conv11 = sext i32 %5 to i64
  %arraydecay12 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  %call13 = call i64 @strlen(ptr noundef %arraydecay12) #12
  %add14 = add i64 %conv11, %call13
  %add15 = add i64 %add14, 1
  %cmp16 = icmp ule i64 %add15, 80
...
if.then17:                                        ; preds = %if.else
  ...
  %arraydecay19 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call18, ptr noundef %arraydecay19)
  %6 = load i32, ptr %number, align 4, !tbaa !5
  %conv21 = sext i32 %6 to i64
  %arraydecay22 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  ...
  store i32 %conv26, ptr %number, align 4, !tbaa !5
  br label %if.end
...
if.end28:                                         ; preds = %if.end, %if.then
  %7 = load i32, ptr %an_number, align 4, !tbaa !5
...
while.end:                                        ; preds = %if.then30, %if.else27, %while.cond1
  %9 = load i32, ptr %an_number, align 4, !tbaa !5
  %10 = load i32, ptr %c, align 4, !tbaa !5
  %cmp32 = icmp ne i32 %9, %10
  br i1 %cmp32, label %if.then33, label %if.end40

if.then33:                                        ; preds = %while.end
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %arraydecay35 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  ...
  %arraydecay37 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 0
  %call38 = call i64 @strlen(ptr noundef %arraydecay37) #12
  %conv39 = trunc i64 %call38 to i32
  store i32 %conv39, ptr %number, align 4, !tbaa !5
  br label %if.end40
...
while.end41:                                      ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %an_number) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %m) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %c) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %number) #11
  call void @llvm.lifetime.end.p0(i64 1, ptr %v) #11
  call void @llvm.lifetime.end.p0(i64 100, ptr %a) #11
  ret i32 0
}
...
entry:
  ...
  %0 = load ptr, ptr %__out.addr, align 8, !tbaa !27, !nonnull !20, !align !21
...
if.end:                                           ; preds = %entry
  ...
  %4 = load ptr, ptr %__out.addr, align 8, !tbaa !27, !nonnull !20, !align !21
...
entry:
  ...
  %0 = load ptr, ptr %__c1.addr, align 8, !tbaa !52, !nonnull !20, !align !54
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %2 = load ptr, ptr %__c2.addr, align 8, !tbaa !52, !nonnull !20, !align !54
...
!30 = !{!15, !15, i64 0}
!31 = !{!32, !32, i64 0}
!32 = !{!"p1 _ZTSSt8ios_base", !15, i64 0}
!33 = !{!34, !19, i64 16}
!34 = !{!"_ZTSSt8ios_base", !19, i64 8, !19, i64 16, !35, i64 24, !36, i64 28, !36, i64 32, !37, i64 40, !38, i64 48, !7, i64 64, !6, i64 192, !39, i64 200, !40, i64 208}
!35 = !{!"_ZTSSt13_Ios_Fmtflags", !7, i64 0}
!36 = !{!"_ZTSSt12_Ios_Iostate", !7, i64 0}
!37 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !15, i64 0}
!38 = !{!"_ZTSNSt8ios_base6_WordsE", !15, i64 0, !19, i64 8}
!39 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !15, i64 0}
!40 = !{!"_ZTSSt6locale", !41, i64 0}
!41 = !{!"p1 _ZTSNSt6locale5_ImplE", !15, i64 0}
!42 = !{!43, !43, i64 0}
!43 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !15, i64 0}
!44 = !{!36, !36, i64 0}
!45 = !{!46, !47, i64 232}
!46 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !34, i64 0, !28, i64 216, !7, i64 224, !25, i64 225, !47, i64 232, !48, i64 240, !49, i64 248, !50, i64 256}
...
!55 = !{!34, !36, i64 32}
!56 = !{!57, !17, i64 16}
!57 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !17, i64 8, !17, i64 16, !17, i64 24, !17, i64 32, !17, i64 40, !17, i64 48, !40, i64 56}
!58 = !{!57, !17, i64 24}
!59 = !{!46, !48, i64 240}
!60 = !{!48, !48, i64 0}
!61 = !{!62, !7, i64 56}
!62 = !{!"_ZTSSt5ctypeIcE", !63, i64 0, !64, i64 16, !25, i64 24, !53, i64 32, !53, i64 40, !65, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
