...
for.cond18:                                       ; preds = %if.end34, %for.body
  %p.1 = phi i32 [ %p.0, %for.body ], [ %p.4, %if.end34 ]
  %j.0 = phi i32 [ %cond7, %for.body ], [ %inc, %if.end34 ]
  %exitcond.not = icmp eq i32 %j.0, %cond
