...
entry:
  ...
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 16 %stu)
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.body ], [ 0, %entry ]
  %phiofops = phi i32 [ %1, %while.body ], [ -1, %entry ]
...
for.cond:                                         ; preds = %while.cond, %for.inc
  %i.1 = phi i32 [ %dec, %for.inc ], [ %phiofops, %while.cond ]
  %cmp24 = icmp sgt i32 %i.1, -1
  br i1 %cmp24, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %idxprom25 = zext nneg i32 %i.1 to i64
  %arrayidx26 = getelementptr inbounds nuw [1000 x %struct.student], ptr %stu, i64 0, i64 %idxprom25
  %name31 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 20
  %sex35 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 40
  %2 = load i8, ptr %sex35, align 8, !tbaa !11, !invariant.load !14
  %conv36 = sext i8 %2 to i32
  %age39 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 44
  %3 = load i32, ptr %age39, align 4, !tbaa !15, !invariant.load !14
  %score42 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 48
  %add46 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 68
  %call48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, ptr noundef nonnull %arrayidx26, ptr noundef nonnull %name31, i32 noundef %conv36, i32 noundef %3, ptr noundef nonnull %score42, ptr noundef nonnull %add46) #5
