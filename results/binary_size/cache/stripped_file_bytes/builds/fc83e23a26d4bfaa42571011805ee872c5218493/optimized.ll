...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z1sii(i32 noundef %1, i32 noundef 2) #8
...
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %b, i32 noundef %a)
  br label %for.cond
...
if.then:                                          ; preds = %land.lhs.true
  %call = tail call noundef i32 @_Z1sii(i32 noundef %div, i32 noundef %i.0) #10
  %add = add nsw i32 %call, %t.0
  br label %for.inc

for.inc:                                          ; preds = %for.body, %land.lhs.true, %if.then
  %t.1 = phi i32 [ %add, %if.then ], [ %t.0, %land.lhs.true ], [ %t.0, %for.body ]
  %inc = add i32 %i.0, 1
