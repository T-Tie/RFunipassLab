...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv47 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next48, %for.cond13 ]
  ...
  br i1 %exitcond52.not, label %for.end76, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %4 = add nsw i64 %indvars.iv47, -1
  %5 = trunc nuw nsw i64 %indvars.iv47 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc71
  %indvars.iv42 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next43, %for.inc71 ]
  %s1.1 = phi i32 [ %s1.0, %for.cond13.preheader ], [ %s1.233, %for.inc71 ]
  %s2.1 = phi i32 [ %s2.0, %for.cond13.preheader ], [ %s2.2, %for.inc71 ]
  %l1.1 = phi i32 [ %l1.0, %for.cond13.preheader ], [ %l1.234, %for.inc71 ]
...
for.body16:                                       ; preds = %for.cond13
  %arrayidx20 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv42
...
land.lhs.true:                                    ; preds = %for.body16
  ...
  %arrayidx26 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %7
...
land.lhs.true28:                                  ; preds = %land.lhs.true
  %arrayidx33 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %4, i64 %indvars.iv42
...
land.lhs.true35:                                  ; preds = %land.lhs.true28
  ...
  %spec.select35 = select i1 %cmp42, i32 %5, i32 %s1.1
  br label %for.inc71

land.lhs.true48:                                  ; preds = %for.body16
  %12 = add nuw nsw i64 %indvars.iv42, 1
  %arrayidx52 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %12
...
land.lhs.true54:                                  ; preds = %land.lhs.true48
  %arrayidx59 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next48, i64 %indvars.iv42
...
land.lhs.true61:                                  ; preds = %land.lhs.true54
  %arrayidx67 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next48, i64 %12
  %15 = load i32, ptr %arrayidx67, align 4, !tbaa !5
  %cmp68 = icmp eq i32 %15, 255
  %spec.select36 = select i1 %cmp68, i32 %5, i32 %s2.1
  %16 = trunc nuw nsw i64 %indvars.iv42 to i32
  %spec.select37 = select i1 %cmp68, i32 %16, i32 %l2.1
  br label %for.inc71

for.inc71:                                        ; preds = %land.lhs.true61, %land.lhs.true35, %for.body16, %land.lhs.true, %land.lhs.true28, %land.lhs.true48, %land.lhs.true54
  %l1.234 = phi i32 [ %l1.1, %land.lhs.true54 ], [ %l1.1, %land.lhs.true48 ], [ %l1.1, %land.lhs.true ], [ %l1.1, %land.lhs.true28 ], [ %spec.select, %land.lhs.true35 ], [ %l1.1, %for.body16 ], [ %l1.1, %land.lhs.true61 ]
  %s1.233 = phi i32 [ %s1.1, %land.lhs.true54 ], [ %s1.1, %land.lhs.true48 ], [ %s1.1, %land.lhs.true ], [ %s1.1, %land.lhs.true28 ], [ %spec.select35, %land.lhs.true35 ], [ %s1.1, %for.body16 ], [ %s1.1, %land.lhs.true61 ]
  %s2.2 = phi i32 [ %s2.1, %land.lhs.true54 ], [ %s2.1, %land.lhs.true48 ], [ %s2.1, %land.lhs.true ], [ %s2.1, %land.lhs.true28 ], [ %s2.1, %land.lhs.true35 ], [ %s2.1, %for.body16 ], [ %spec.select36, %land.lhs.true61 ]
  %l2.2 = phi i32 [ %l2.1, %land.lhs.true54 ], [ %l2.1, %land.lhs.true48 ], [ %l2.1, %land.lhs.true ], [ %l2.1, %land.lhs.true28 ], [ %l2.1, %land.lhs.true35 ], [ %l2.1, %for.body16 ], [ %spec.select37, %land.lhs.true61 ]
