...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %k) #6
...
for.cond6.preheader:                              ; preds = %for.cond
  %cmp7 = icmp slt i32 %j.0, 1
  call void @llvm.assume(i1 noundef %cmp7)
  %4 = load i32, ptr %vla, align 16, !tbaa !5
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %4)
