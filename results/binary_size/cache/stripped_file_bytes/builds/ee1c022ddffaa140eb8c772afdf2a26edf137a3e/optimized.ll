...
for.cond45:                                       ; preds = %for.cond, %if.end56
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end56 ], [ 0, %for.cond ]
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %1 = load i32, ptr %N, align 4, !tbaa !5
  %2 = sext i32 %1 to i64
  %cmp46 = icmp slt i64 %indvars.iv.next25, %2
  br i1 %cmp46, label %for.body47, label %for.end59

for.body47:                                       ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next25
