...
while.cond:                                       ; preds = %while.cond.backedge, %entry
  %n.0 = phi i32 [ 0, %entry ], [ %n.0.be, %while.cond.backedge ]
  ...
  br i1 %or.cond.not, label %if.else, label %while.end
...
for.cond:                                         ; preds = %for.cond.preheader, %for.cond.loopexit
  %indvars.iv17 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next18, %for.cond.loopexit ]
  ...
  br i1 %exitcond21.not, label %for.cond.cleanup, label %for.body
...
while.cond.backedge:                              ; preds = %for.cond.cleanup, %if.else26
  %n.0.be = phi i32 [ 0, %for.cond.cleanup ], [ %inc29, %if.else26 ]
  br label %while.cond, !llvm.loop !24

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv17
  br label %for.cond5

for.cond5:                                        ; preds = %for.body9, %for.body
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body9 ], [ %indvars.iv, %for.body ]
...
for.body9:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv14
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !25
  %mul = shl nsw i32 %3, 1
  %cmp12 = icmp eq i32 %2, %mul
  %mul17 = shl nsw i32 %2, 1
  %cmp18 = icmp eq i32 %3, %mul17
...
if.else26:                                        ; preds = %if.else
  ...
  store i32 %1, ptr %arrayidx28, align 4, !tbaa !25
