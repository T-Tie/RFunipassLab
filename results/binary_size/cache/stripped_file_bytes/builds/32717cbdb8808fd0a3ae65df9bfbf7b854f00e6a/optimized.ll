...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40000, ptr %ch) #12
  call void @llvm.memset.p0.i64(ptr align 16 %ch, i8 0, i64 40000, i1 false)
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %counter) #12
  store i32 0, ptr %counter, align 4, !tbaa !5
  %arraydecay = getelementptr inbounds [1000 x [40 x i8]], ptr %ch, i64 0, i64 0
...
for.body:                                         ; preds = %for.cond
  ...
  %incdec.ptr = getelementptr inbounds nuw [40 x i8], ptr %2, i32 1
  store ptr %incdec.ptr, ptr %p, align 8, !tbaa !9
  %arraydecay1 = getelementptr inbounds [40 x i8], ptr %2, i64 0, i64 0
...
for.end:                                          ; preds = %for.cond
  %arraydecay3 = getelementptr inbounds [1000 x [40 x i8]], ptr %ch, i64 0, i64 0
  store ptr %arraydecay3, ptr %p, align 8, !tbaa !9
  br label %while.cond

while.cond:                                       ; preds = %if.end27, %for.end
  %4 = load ptr, ptr %p, align 8, !tbaa !9
  %arraydecay4 = getelementptr inbounds [1000 x [40 x i8]], ptr %ch, i64 0, i64 0
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %idx.ext = sext i32 %5 to i64
  %add.ptr = getelementptr inbounds [40 x i8], ptr %arraydecay4, i64 %idx.ext
...
if.then:                                          ; preds = %while.body
  ...
  %arraydecay7 = getelementptr inbounds [40 x i8], ptr %7, i64 0, i64 0
  %call8 = call i64 @strlen(ptr noundef %arraydecay7) #13
  %8 = load i32, ptr %counter, align 4, !tbaa !5
  %conv = sext i32 %8 to i64
  %add = add i64 %conv, %call8
  %conv9 = trunc i64 %add to i32
  store i32 %conv9, ptr %counter, align 4, !tbaa !5
  %9 = load ptr, ptr %p, align 8, !tbaa !9
  %arraydecay10 = getelementptr inbounds [40 x i8], ptr %9, i64 0, i64 0
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay10)
  %10 = load ptr, ptr %p, align 8, !tbaa !9
  %incdec.ptr12 = getelementptr inbounds nuw [40 x i8], ptr %10, i32 1
  store ptr %incdec.ptr12, ptr %p, align 8, !tbaa !9
  br label %if.end27

if.else:                                          ; preds = %while.body
  %11 = load ptr, ptr %p, align 8, !tbaa !9
  %arraydecay13 = getelementptr inbounds [40 x i8], ptr %11, i64 0, i64 0
  %call14 = call i64 @strlen(ptr noundef %arraydecay13) #13
  %add15 = add i64 %call14, 1
  %12 = load i32, ptr %counter, align 4, !tbaa !5
  %conv16 = sext i32 %12 to i64
  %add17 = add i64 %conv16, %add15
  %conv18 = trunc i64 %add17 to i32
  store i32 %conv18, ptr %counter, align 4, !tbaa !5
  %13 = load i32, ptr %counter, align 4, !tbaa !5
  %cmp19 = icmp sle i32 %13, 80
  br i1 %cmp19, label %if.then20, label %if.else25

if.then20:                                        ; preds = %if.else
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  %14 = load ptr, ptr %p, align 8, !tbaa !9
  %arraydecay22 = getelementptr inbounds [40 x i8], ptr %14, i64 0, i64 0
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call21, ptr noundef %arraydecay22)
  %15 = load ptr, ptr %p, align 8, !tbaa !9
  %incdec.ptr24 = getelementptr inbounds nuw [40 x i8], ptr %15, i32 1
  store ptr %incdec.ptr24, ptr %p, align 8, !tbaa !9
  br label %if.end
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %counter) #12
  ...
  call void @llvm.lifetime.end.p0(i64 40000, ptr %ch) #12
  ret i32 0
}
...
do.end:                                           ; preds = %do.cond
  %3 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
  ...
  %4 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
...
if.then6:                                         ; preds = %if.else
  ...
  %7 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
  ...
  %8 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
  %9 = load ptr, ptr %__s.addr, align 8, !tbaa !9
  %10 = load i64, ptr %__n, align 8, !tbaa !18
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) %8, ptr noundef %9, i64 noundef %10)
  %11 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %15 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
...
if.then28:                                        ; preds = %if.then19
  %17 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
...
if.else34:                                        ; preds = %if.else
  ...
  %19 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
...
if.end38:                                         ; preds = %if.end37, %do.end
  %22 = load ptr, ptr %__in.addr, align 8, !tbaa !16, !nonnull !20, !align !21
...
entry:
  ...
  %0 = load ptr, ptr %__c.addr, align 8, !tbaa !9, !nonnull !20
...
!30 = !{!11, !11, i64 0}
!31 = !{!32, !32, i64 0}
!32 = !{!"p1 _ZTSSt8ios_base", !11, i64 0}
!33 = !{!34, !19, i64 16}
...
!37 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !11, i64 0}
!38 = !{!"_ZTSNSt8ios_base6_WordsE", !11, i64 0, !19, i64 8}
!39 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !11, i64 0}
!40 = !{!"_ZTSSt6locale", !41, i64 0}
!41 = !{!"p1 _ZTSNSt6locale5_ImplE", !11, i64 0}
!42 = !{!43, !43, i64 0}
!43 = !{!"p1 _ZTSSt9basic_iosIcSt11char_traitsIcEE", !11, i64 0}
!44 = !{!36, !36, i64 0}
!45 = !{!46, !47, i64 232}
...
!55 = !{!34, !36, i64 32}
!56 = !{!57, !10, i64 16}
!57 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !10, i64 8, !10, i64 16, !10, i64 24, !10, i64 32, !10, i64 40, !10, i64 48, !40, i64 56}
!58 = !{!57, !10, i64 24}
!59 = !{!46, !48, i64 240}
!60 = !{!48, !48, i64 0}
!61 = !{!62, !7, i64 56}
...
!64 = !{!"p1 _ZTS15__locale_struct", !11, i64 0}
