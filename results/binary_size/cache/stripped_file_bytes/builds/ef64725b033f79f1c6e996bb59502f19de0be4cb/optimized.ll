...
for.cond26:                                       ; preds = %for.cond26.backedge, %for.cond26.preheader
  %indvars.iv30 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next31, %for.cond26.backedge ]
...
for.body28:                                       ; preds = %for.cond26
  ...
  br i1 %cmp33, label %if.then34, label %for.cond26.backedge

for.cond26.backedge:                              ; preds = %for.body28, %if.then34
