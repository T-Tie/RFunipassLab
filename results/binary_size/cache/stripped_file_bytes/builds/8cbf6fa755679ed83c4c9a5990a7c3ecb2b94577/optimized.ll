...
for.cond8:                                        ; preds = %for.end, %for.body
  ...
  %r.0 = phi i32 [ 1, %for.body ], [ %spec.select34, %for.end ]
...
for.end:                                          ; preds = %for.cond14
  ...
  %spec.select34 = add nuw nsw i32 %r.0, %inc27
...
if.then46:                                        ; preds = %for.end44
  %call47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) @.str)
...
if.else49:                                        ; preds = %for.end44
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %num.0)
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %d.0, i32 noundef 0)
  %wide.trip.count44 = zext nneg i32 %smax43 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.end65, %if.else49
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.end65 ], [ 0, %if.else49 ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45.not, label %if.end70, label %for.cond55.preheader

for.cond55.preheader:                             ; preds = %for.cond52
  %arrayidx59 = getelementptr inbounds nuw [250 x ptr], ptr %record, i64 0, i64 %indvars.iv39
  br label %for.cond55

for.cond55:                                       ; preds = %for.cond55.preheader, %for.body57
  %indvars.iv36 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next37, %for.body57 ]
  %5 = load i32, ptr %n, align 4, !tbaa !29
  %6 = sext i32 %5 to i64
  %cmp56 = icmp slt i64 %indvars.iv36, %6
  br i1 %cmp56, label %for.body57, label %for.end65

for.body57:                                       ; preds = %for.cond55
  %7 = load ptr, ptr %arrayidx59, align 8, !tbaa !26
  %add.ptr61 = getelementptr inbounds nuw i8, ptr %7, i64 %indvars.iv36
  %8 = load i8, ptr %add.ptr61, align 1, !tbaa !22, !invariant.load !8
  %call62 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %8)
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond55

for.end65:                                        ; preds = %for.cond55
  %call66 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
