...
entry:
  ...
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) @strin) #9
...
for.cond:                                         ; preds = %for.end42, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end42 ], [ 0, %entry ]
  %maxtime.0 = phi i32 [ %spec.select, %for.end42 ], [ 0, %entry ]
  %exitcond17 = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17, label %for.end50, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond
  call void @llvm.assume(i1 noundef %cmp5)
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr @jilu, i64 0, i64 %indvars.iv13
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond4.preheader, %for.inc40
...
for.end42:                                        ; preds = %for.cond9
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %maxtime.0, i32 %6)
...
if.else:                                          ; preds = %for.end50
  ...
  %7 = load i32, ptr @jilu, align 16
  %cmp62 = icmp eq i32 %7, %maxtime.0
  br label %for.cond56

for.cond56:                                       ; preds = %if.end75, %if.else
  %8 = load i32, ptr %n, align 4, !tbaa !5
  %cmp58.not = icmp sgt i32 %8, %conv
  br i1 %cmp58.not, label %if.end79, label %for.body59

for.body59:                                       ; preds = %for.cond56
  br i1 %cmp62, label %for.cond64.preheader, label %if.end75

for.cond64.preheader:                             ; preds = %for.body59
  %9 = load i8, ptr @strin, align 16
  br label %for.cond64

for.cond64:                                       ; preds = %for.cond64.preheader, %for.body66
  %10 = phi i32 [ %8, %for.cond64.preheader ], [ %.pre, %for.body66 ]
  %cmp65 = icmp sgt i32 %10, 0
  br i1 %cmp65, label %for.body66, label %for.end73

for.body66:                                       ; preds = %for.cond64
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %9)
