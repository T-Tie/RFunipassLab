...
define dso_local noundef i32 @_Z5yinziii(i32 noundef %j, i32 noundef %n) #0 {
entry:
...
if.then:                                          ; preds = %land.lhs.true3
  ...
  %div5 = sdiv i32 %12, %13
  %call = call noundef i32 @_Z5yinziii(i32 noundef %11, i32 noundef %div5)
  br label %if.end
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %div8 = sdiv i32 %11, %12
  %call9 = call noundef i32 @_Z5yinziii(i32 noundef %10, i32 noundef %div8)
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup4
  ...
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %14)
