...
for.cond:                                         ; preds = %for.inc25, %entry
  ...
  br i1 %exitcond20.not, label %cleanup29, label %for.body
...
for.cond4:                                        ; preds = %for.body, %if.end15
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %if.end15 ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond.not, label %for.inc25, label %for.body7

for.body7:                                        ; preds = %for.cond4
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %p, i64 %indvars.iv15
