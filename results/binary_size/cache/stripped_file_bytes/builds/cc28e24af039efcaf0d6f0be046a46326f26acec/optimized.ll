...
if.end15:                                         ; preds = %if.end10.thread, %if.then14
  ...
  %cmp113 = phi i1 [ false, %if.then14 ], [ %cmp112, %if.end10.thread ]
  %cmp21 = icmp sle i32 %6, %4
  %brmerge6 = or i1 %cmp21, %cmp113
  br i1 %brmerge6, label %if.end25, label %if.then24
...
if.end25:                                         ; preds = %if.end10, %if.end15, %if.then24
  ...
  %or.cond7 = and i1 %cmp26, %cmp28
  br i1 %or.cond7, label %if.then29, label %for.inc
