...
for.cond4:                                        ; preds = %for.cond1, %for.body7
  %2 = phi i32 [ %.pre8, %for.body7 ], [ %1, %for.cond1 ]
...
for.body7:                                        ; preds = %for.cond4
  ...
  %.pre8 = load i32, ptr @g_n, align 4, !tbaa !5
  br label %for.cond4, !llvm.loop !9

for.cond14:                                       ; preds = %for.cond1, %for.body20
  %4 = phi i32 [ %.pre, %for.body20 ], [ %1, %for.cond1 ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.body20 ], [ 1, %for.cond1 ]
...
for.body20:                                       ; preds = %for.cond14
  ...
  %arrayidx24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv5, i64 %indvars.iv5
  %6 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %add = add nsw i32 %6, %sum.0
  %7 = trunc nuw nsw i64 %indvars.iv5 to i32
...
for.cond3:                                        ; preds = %for.cond, %if.end52
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %if.end52 ], [ 0, %for.cond ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count58
  br i1 %exitcond59.not, label %for.cond56, label %for.cond7
...
for.cond7:                                        ; preds = %for.cond3, %for.inc
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count58
...
for.body10:                                       ; preds = %for.cond7
  %arrayidx14 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv55, i64 %indvars.iv
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv50 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next51, %for.body39 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count58
  br i1 %exitcond54.not, label %if.end52, label %for.body39

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv55, i64 %indvars.iv50
...
for.cond56:                                       ; preds = %for.cond3, %if.end110
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %if.end110 ], [ 0, %for.cond3 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %wide.trip.count58
  br i1 %exitcond74.not, label %if.end114, label %for.cond60

for.cond60:                                       ; preds = %for.cond56, %for.inc89
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc89 ], [ 0, %for.cond56 ]
  %min.3 = phi i32 [ %min.4, %for.inc89 ], [ 1000, %for.cond56 ]
  %exitcond64.not = icmp eq i64 %indvars.iv60, %wide.trip.count58
  br i1 %exitcond64.not, label %for.cond94.preheader, label %for.body63

for.cond94.preheader:                             ; preds = %for.cond60
  br label %for.cond94

for.body63:                                       ; preds = %for.cond60
  %arrayidx67 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv60, i64 %indvars.iv70
...
if.end77:                                         ; preds = %if.end70
  %spec.select40 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.3)
  br label %for.inc89

for.inc89:                                        ; preds = %if.end77, %for.body63
  %min.4 = phi i32 [ %min.3, %for.body63 ], [ %spec.select40, %if.end77 ]
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  br label %for.cond60, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.body97
  %indvars.iv65 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next66, %for.body97 ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %wide.trip.count58
  br i1 %exitcond69.not, label %if.end110, label %for.body97

for.body97:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv65, i64 %indvars.iv70
