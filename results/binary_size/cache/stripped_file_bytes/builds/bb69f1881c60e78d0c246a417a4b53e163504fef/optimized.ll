...
if.then:                                          ; preds = %entry, %land.lhs.true
  ...
  %rem85 = urem i32 %year, 100
  %cmp9 = icmp ne i32 %rem85, 0
  %or.cond7 = and i1 %cmp9, %or.cond
  br i1 %or.cond7, label %if.end22, label %if.else

if.else:                                          ; preds = %if.then
  %rem12 = srem i32 %year, 100
  %cmp15 = icmp sgt i32 %year, 99
  %rem176 = urem i32 %year, 400
  %1 = or i32 %rem176, %rem12
  %2 = icmp eq i32 %1, 0
  %or.cond9 = and i1 %cmp15, %2
  %spec.select = zext i1 %or.cond9 to i32
  br label %if.end22
