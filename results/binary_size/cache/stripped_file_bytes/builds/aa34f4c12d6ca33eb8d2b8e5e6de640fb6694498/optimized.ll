...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %a) #10
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 captures(none) dereferenceable(2000) %b) #10
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv15 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next16, %for.inc13 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv15
...
if.then.i.i:                                      ; preds = %for.end15
  ...
  %4 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %idx.ext, i1 noundef true)
  %sub.i.i.i = shl nuw nsw i64 %4, 1
  %mul.i.i = xor i64 %sub.i.i.i, 126
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull align 16 dereferenceable(2000) %b, ptr noundef nonnull %add.ptr, i64 noundef %mul.i.i)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end15, %if.then.i.i
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc23, %_ZSt4sortIPiEvT_S1_.exit
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc23 ], [ 0, %_ZSt4sortIPiEvT_S1_.exit ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end25, label %for.inc23

for.inc23:                                        ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv19
  %5 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5) #11
...
for.end25:                                        ; preds = %for.cond17
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6) #11
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull captures(none) %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %a) #11
...
if.end:                                           ; preds = %while.body
  ...
  %div.i20 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i20
...
while.cond.i.i:                                   ; preds = %while.body.i.i, %for.body.i
  %__last.addr.0.i.i = phi ptr [ %__i.0.i, %for.body.i ], [ %incdec.ptr.i.i, %while.body.i.i ]
...
while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div1516, %if.end ], [ %dec, %while.body ]
...
if.else10:                                        ; preds = %if.else7
  ...
  %spec.select16 = select i1 %cmp.i4, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.else7, %if.then, %if.else10, %if.else
  %.sink17 = phi i32 [ %4, %if.else10 ], [ %3, %if.else ], [ %1, %if.then ], [ %0, %if.else7 ]
  %__a.sink = phi ptr [ %spec.select16, %if.else10 ], [ %spec.select, %if.else ], [ %__b, %if.then ], [ %__a, %if.else7 ]
  %5 = load i32, ptr %__result, align 4, !tbaa !5, !invariant.load !12
  store i32 %.sink17, ptr %__result, align 4, !tbaa !5
  store i32 %5, ptr %__a.sink, align 4, !tbaa !5
  ret void
}
