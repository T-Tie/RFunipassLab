...
entry:
  ...
  %1 = add nuw i32 %smax13, 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc33, %entry
  %len.0 = phi i32 [ undef, %entry ], [ %len.1, %for.inc33 ]
  %i.0 = phi i32 [ 1, %entry ], [ %inc34, %for.inc33 ]
  %exitcond14 = icmp eq i32 %i.0, %1
  br i1 %exitcond14, label %for.cond36.preheader, label %for.cond1

for.cond36.preheader:                             ; preds = %for.cond
  br label %for.cond36

for.cond1:                                        ; preds = %for.cond, %for.inc
  %.sink2 = phi i32 [ %dec, %for.inc ], [ 999, %for.cond ]
  %cmp2 = icmp sgt i32 %.sink2, -1
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %idxprom = zext nneg i32 %.sink2 to i64
...
for.end:                                          ; preds = %for.body3, %for.cond1
  %len.1 = phi i32 [ %len.0, %for.cond1 ], [ %.sink2, %for.body3 ]
...
for.cond13:                                       ; preds = %for.cond6, %for.inc30
  %indvars.iv7 = phi i64 [ %indvars.iv.next8.pre-phi, %for.inc30 ], [ 0, %for.cond6 ]
  %exitcond12 = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond12, label %for.inc33, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr %num, i64 0, i64 %indvars.iv7
...
for.body15.for.inc30_crit_edge:                   ; preds = %for.body15
  %.pre = add nuw nsw i64 %indvars.iv7, 1
  br label %for.inc30

if.then19:                                        ; preds = %for.body15
  %div4 = udiv i32 %5, 10
  %6 = add nuw nsw i64 %indvars.iv7, 1
  ...
  %add24 = add nsw i32 %7, %div4
  store i32 %add24, ptr %arrayidx23, align 4, !tbaa !5
  %rem5 = urem i32 %5, 10
  store i32 %rem5, ptr %arrayidx17, align 4, !tbaa !5
  br label %for.inc30

for.inc30:                                        ; preds = %for.body15.for.inc30_crit_edge, %if.then19
  %indvars.iv.next8.pre-phi = phi i64 [ %.pre, %for.body15.for.inc30_crit_edge ], [ %6, %if.then19 ]
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc44
  %.sink = phi i32 [ %dec45, %for.inc44 ], [ 999, %for.cond36.preheader ]
  %cmp37 = icmp sgt i32 %.sink, -1
  br i1 %cmp37, label %for.body38, label %for.end46

for.body38:                                       ; preds = %for.cond36
  %idxprom39 = zext nneg i32 %.sink to i64
...
for.inc44:                                        ; preds = %for.body38
  %dec45 = add nsw i32 %.sink, -1
  br label %for.cond36, !llvm.loop !16

for.end46:                                        ; preds = %for.body38, %for.cond36
  %len.2 = phi i32 [ %len.0, %for.cond36 ], [ %.sink, %for.body38 ]
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc53, %for.end46
  %.sink1 = phi i32 [ %len.2, %for.end46 ], [ %dec54, %for.inc53 ]
  %cmp48 = icmp sgt i32 %.sink1, -1
  br i1 %cmp48, label %for.inc53, label %for.end55

for.inc53:                                        ; preds = %for.cond47
  %idxprom50 = zext nneg i32 %.sink1 to i64
