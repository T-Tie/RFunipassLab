...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %x1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %x2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %s1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %s2) #6
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 4 %n)
  br label %for.cond

for.cond:                                         ; preds = %if.end66, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end66 ], [ 1, %entry ]
...
if.then14:                                        ; preds = %if.else
  %fneg15 = fneg double %2
  %call20 = call double @sqrt(double noundef %6) #7, !tbaa !5
...
if.then43:                                        ; preds = %if.else37
  ...
  %call59 = call double @sqrt(double noundef %7) #7, !tbaa !5
  %div61 = fdiv double %call59, %mul45
  br label %if.end66.sink.split

if.end66.sink.split:                              ; preds = %if.then, %if.then43, %if.then14
  %.sink = phi double [ 0.000000e+00, %if.then14 ], [ %div61, %if.then43 ], [ 0.000000e+00, %if.then ]
  %arrayidx36 = getelementptr inbounds nuw [100 x double], ptr %s2, i64 0, i64 %indvars.iv
  store double %.sink, ptr %arrayidx36, align 8, !tbaa !9
  br label %if.end66

if.end66:                                         ; preds = %if.end66.sink.split, %if.else37
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !11

for.cond67:                                       ; preds = %for.cond, %if.end109
  %8 = phi i32 [ %.pre, %if.end109 ], [ %0, %for.cond ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %if.end109 ], [ 1, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp68.not = icmp sgt i64 %indvars.iv32, %9
  br i1 %cmp68.not, label %for.end112, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %arrayidx71 = getelementptr inbounds nuw [100 x double], ptr %x1, i64 0, i64 %indvars.iv32
  %10 = load double, ptr %arrayidx71, align 8, !tbaa !9, !invariant.load !14
  %arrayidx73 = getelementptr inbounds nuw [100 x double], ptr %x2, i64 0, i64 %indvars.iv32
  %11 = load double, ptr %arrayidx73, align 8, !tbaa !9, !invariant.load !14
  %cmp74 = fcmp oeq double %10, %11
  br i1 %cmp74, label %land.lhs.true, label %if.else82

land.lhs.true:                                    ; preds = %for.body69
  %arrayidx76 = getelementptr inbounds nuw [100 x double], ptr %s2, i64 0, i64 %indvars.iv32
  %12 = load double, ptr %arrayidx76, align 8, !tbaa !9, !invariant.load !14
  %cmp77 = fcmp oeq double %12, 0.000000e+00
  br i1 %cmp77, label %if.then78, label %if.else82

if.then78:                                        ; preds = %land.lhs.true
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %10) #8
  br label %if.end109

if.else82:                                        ; preds = %land.lhs.true, %for.body69
  %cmp87 = fcmp une double %10, %11
  %arrayidx90 = getelementptr inbounds nuw [100 x double], ptr %s2, i64 0, i64 %indvars.iv32
  %13 = load double, ptr %arrayidx90, align 8, !tbaa !9, !invariant.load !14
...
if.then92:                                        ; preds = %if.else82
  %call97 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %10, double noundef %11) #8
  br label %if.end109

if.else98:                                        ; preds = %if.else82
  %arrayidx100 = getelementptr inbounds nuw [100 x double], ptr %s1, i64 0, i64 %indvars.iv32
  %14 = load double, ptr %arrayidx100, align 8, !tbaa !9, !invariant.load !14
  %call107 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %14, double noundef %13, double noundef %14, double noundef %13) #8
  br label %if.end109

if.end109:                                        ; preds = %if.then92, %if.else98, %if.then78
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond67, !llvm.loop !15

for.end112:                                       ; preds = %for.cond67
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %s2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %s1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %x2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %x1) #8
