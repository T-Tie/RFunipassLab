...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv9
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv17.in = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv17, %for.body15 ]
  %indvars.iv14 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next15, %for.body15 ]
  %cmp14 = icmp sgt i64 %indvars.iv14, 0
  br i1 %cmp14, label %for.body15, label %for.end33

for.body15:                                       ; preds = %for.cond13
  %indvars.iv17 = add nsw i64 %indvars.iv17.in, -1
  %indvars.iv.next15 = add nsw i64 %indvars.iv14, -1
  %arrayidx17 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next15
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv20 = phi i64 [ %indvars.iv17, %for.cond22.preheader ], [ %indvars.iv.next21, %for.inc28 ]
  %cmp23.not.not = icmp slt i64 %indvars.iv20, %6
...
for.inc28:                                        ; preds = %for.cond22
  ...
  %arrayidx26 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next21
...
for.end33.loopexit:                               ; preds = %for.cond22
  %8 = trunc nsw i64 %indvars.iv.next15 to i32
  %.pre41 = and i64 %indvars.iv.next15, 4294967295
  br label %for.end33

for.end33:                                        ; preds = %for.cond13, %for.end33.loopexit
  %.pre-phi = phi i64 [ %.pre41, %for.end33.loopexit ], [ %4, %for.cond13 ]
...
for.cond35:                                       ; preds = %for.inc55, %for.end33
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc55 ], [ %.pre-phi, %for.end33 ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc55 ], [ %10, %for.end33 ]
  %j.2 = phi i32 [ %j.3, %for.inc55 ], [ %j.1, %for.end33 ]
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, -1
  %indvars = trunc i64 %indvars.iv.next29 to i32
  %11 = trunc nuw i64 %indvars.iv28 to i32
  %cmp36 = icmp sgt i32 %11, 0
  br i1 %cmp36, label %for.body37, label %for.end57

for.body37:                                       ; preds = %for.cond35
  %idxprom38 = and i64 %indvars.iv.next29, 4294967295
...
for.cond45:                                       ; preds = %for.inc51, %if.then42
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc51 ], [ %indvars.iv23, %if.then42 ]
  %indvars.iv.next26 = add nsw i64 %indvars.iv25, 1
  %cmp46 = icmp slt i64 %indvars.iv.next26, %13
  br i1 %cmp46, label %for.inc51, label %for.inc55

for.inc51:                                        ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next26
...
for.cond59:                                       ; preds = %for.inc68, %for.end57
  ...
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc68 ], [ 0, %for.end57 ]
...
for.inc68:                                        ; preds = %for.cond59
  ...
  %arrayidx61.phi.trans.insert = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next32
...
for.cond74:                                       ; preds = %for.end10, %for.inc80
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc80 ], [ 0, %for.end10 ]
  %exitcond40 = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond40, label %if.end83, label %for.inc80

for.inc80:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv35
