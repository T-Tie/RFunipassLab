...
for.cond4.preheader:                              ; preds = %for.cond
  %7 = mul nuw nsw i64 %indvars.iv61, %3
...
for.cond18:                                       ; preds = %for.end33, %for.end13
  ...
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.end33 ], [ 0, %for.end13 ]
  %cmp20 = icmp sgt i32 %16, 0
  br i1 %cmp20, label %for.cond22.preheader, label %for.cond37

for.cond22.preheader:                             ; preds = %for.cond18
  %17 = mul nuw nsw i64 %indvars.iv67, %13
  %arrayidx27 = getelementptr inbounds nuw i32, ptr %vla16, i64 %17
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc31
  %18 = phi i32 [ %15, %for.cond22.preheader ], [ %.pre91, %for.inc31 ]
  %indvars.iv64 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next65, %for.inc31 ]
  %19 = sext i32 %18 to i64
  %cmp24.not.not = icmp slt i64 %indvars.iv64, %19
  br i1 %cmp24.not.not, label %for.inc31, label %for.end33

for.inc31:                                        ; preds = %for.cond22
  %arrayidx29 = getelementptr inbounds nuw i32, ptr %arrayidx27, i64 %indvars.iv64
  ...
  %.pre91 = load i32, ptr %y2, align 4, !tbaa !5
...
for.cond37:                                       ; preds = %for.cond18, %for.end107
  ...
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.end107 ], [ 0, %for.cond18 ]
...
for.cond41.preheader:                             ; preds = %for.cond37
  %22 = mul nuw nsw i64 %indvars.iv86, %3
  %arrayidx50 = getelementptr inbounds nuw i32, ptr %vla, i64 %22
  br label %for.cond41

for.cond41:                                       ; preds = %for.cond41.preheader, %for.inc70
  %23 = phi i32 [ %20, %for.cond41.preheader ], [ %.pre89, %for.inc70 ]
  %indvars.iv73 = phi i64 [ 0, %for.cond41.preheader ], [ %indvars.iv.next74, %for.inc70 ]
  %sub42 = add nsw i32 %23, -2
  %24 = sext i32 %sub42 to i64
  %cmp43.not = icmp sgt i64 %indvars.iv73, %24
...
for.cond45.preheader:                             ; preds = %for.cond41
  ...
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla16, i64 %indvars.iv73
  %smax = call i32 @llvm.smax.i32(i32 %25, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond45

for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc57
  %indvars.iv70 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next71, %for.inc57 ]
...
for.inc57:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw i32, ptr %arrayidx50, i64 %indvars.iv70
  %26 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !13
  %27 = mul nuw nsw i64 %indvars.iv70, %13
...
for.cond74:                                       ; preds = %for.inc105, %for.end72
  %31 = phi i32 [ %.pre90, %for.inc105 ], [ %23, %for.end72 ]
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc105 ], [ %30, %for.end72 ]
  %32 = sext i32 %31 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv83, %32
...
for.cond78.preheader:                             ; preds = %for.cond74
  ...
  %invariant.gep58 = getelementptr i32, ptr %vla16, i64 %indvars.iv83
  %smax79 = call i32 @llvm.smax.i32(i32 %33, i32 noundef 0)
  %wide.trip.count80 = zext nneg i32 %smax79 to i64
  br label %for.cond78

for.cond78:                                       ; preds = %for.cond78.preheader, %for.inc92
  %indvars.iv76 = phi i64 [ 0, %for.cond78.preheader ], [ %indvars.iv.next77, %for.inc92 ]
  %d.4 = phi i32 [ 0, %for.cond78.preheader ], [ %add91, %for.inc92 ]
  %exitcond81.not = icmp eq i64 %indvars.iv76, %wide.trip.count80
  br i1 %exitcond81.not, label %for.inc105, label %for.inc92

for.inc92:                                        ; preds = %for.cond78
  %arrayidx85 = getelementptr inbounds nuw i32, ptr %arrayidx50, i64 %indvars.iv76
  %34 = load i32, ptr %arrayidx85, align 4, !tbaa !5, !invariant.load !13
  %35 = mul nuw nsw i64 %indvars.iv76, %13
  %gep59 = getelementptr i32, ptr %invariant.gep58, i64 %35
  %36 = load i32, ptr %gep59, align 4, !tbaa !5, !invariant.load !13
