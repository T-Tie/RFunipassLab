...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %2 = load i64, ptr %_M_width.i4.i, align 8, !tbaa !10, !invariant.load !9
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp6, label %if.end27.gvnsink.split, label %if.else
...
if.then20:                                        ; preds = %if.else
  ...
  br label %if.end27.gvnsink.split
...
if.end27.gvnsink.split:                           ; preds = %while.body, %if.then20
  %_ZSt4cout.sink = phi ptr [ %call21, %if.then20 ], [ @_ZSt4cout, %while.body ]
  %counter.2 = phi i32 [ %conv18, %if.then20 ], [ %conv9, %while.body ]
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, ptr noundef nonnull %p.1)
  %incdec.ptr24 = getelementptr inbounds nuw i8, ptr %p.1, i64 40
  br label %if.end27

if.end27:                                         ; preds = %if.end27.gvnsink.split, %if.else25
  %p.2 = phi ptr [ %incdec.ptr24, %if.end27.gvnsink.split ], [ %p.1, %if.else25 ]
  %counter.1 = phi i32 [ %counter.2, %if.end27.gvnsink.split ], [ 0, %if.else25 ]
