...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %words) #8
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i8]], ptr %words, i64 0, i64 %indvars.iv
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull dereferenceable(100) %arrayidx, i1 false, i1 true, i1 false)
...
if.then6.i:                                       ; preds = %for.body
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull dereferenceable(100) %arrayidx, i64 noundef %0)
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %1 = load i64, ptr %_M_width.i8.i, align 8, !tbaa !6, !invariant.load !5
...
if.else34.i:                                      ; preds = %for.body
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull dereferenceable(100) %arrayidx, i64 noundef 9223372036854775807)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
for.cond5:                                        ; preds = %for.inc14, %for.end
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc14 ], [ %2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv5, 0
  br i1 %cmp6, label %for.inc14, label %for.end16

for.inc14:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %words, i64 0, i64 %indvars.iv5
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx10)
...
for.end16:                                        ; preds = %for.cond5
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %words)
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %words) #9
  ret i32 0
}
