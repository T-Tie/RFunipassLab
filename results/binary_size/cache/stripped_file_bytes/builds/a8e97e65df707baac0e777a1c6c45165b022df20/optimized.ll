...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef nonnull align 16 %sz) #3
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %a) #3
...
for.end:                                          ; preds = %for.cond
  ...
  %call4 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %0)
  br label %for.cond8

for.cond8:                                        ; preds = %for.inc24, %for.end
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc24 ], [ 1, %for.end ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %2 = sext i32 %1 to i64
  %cmp9 = icmp slt i64 %indvars.iv11, %2
  br i1 %cmp9, label %for.body10, label %for.end26

for.body10:                                       ; preds = %for.cond8
  %arrayidx12 = getelementptr inbounds nuw [100000 x i32], ptr %sz, i64 0, i64 %indvars.iv11
  ...
  br i1 %cmp18.not, label %for.inc24, label %if.then
...
for.end26:                                        ; preds = %for.cond8
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef nonnull %sz) #4
  ret i32 0
}
