...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull %n) #7
...
for.cond1:                                        ; preds = %for.cond, %for.inc7
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc7 ], [ 0, %for.cond ]
  %0 = load i32, ptr %t, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp2 = icmp slt i64 %indvars.iv11, %1
  br i1 %cmp2, label %for.inc7, label %for.cond10
...
for.cond10:                                       ; preds = %for.cond1, %for.inc17
  %2 = phi i32 [ %.pre, %for.inc17 ], [ %0, %for.cond1 ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc17 ], [ 0, %for.cond1 ]
  %3 = sext i32 %2 to i64
...
entry:
  ...
  %add = add nsw i32 %j, 1
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %sum, i32 noundef 1) #9
