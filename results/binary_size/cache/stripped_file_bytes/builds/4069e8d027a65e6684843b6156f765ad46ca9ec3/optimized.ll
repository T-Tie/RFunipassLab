...
entry:
  %call = tail call noalias dereferenceable_or_null(112) ptr @malloc(i64 noundef 112) #7
  ...
  %next = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr null, ptr %next, align 8, !tbaa !10
  br label %for.cond

for.cond:                                         ; preds = %if.end, %entry
  %call9 = tail call noalias dereferenceable_or_null(112) ptr @malloc(i64 noundef 112) #7
  store ptr %call9, ptr @p1, align 8, !tbaa !5
  %1 = load ptr, ptr @p2, align 8, !tbaa !5
  %next10 = getelementptr inbounds nuw i8, ptr %1, i64 104
  ...
  %3 = load i8, ptr %2, align 8, !tbaa !14, !invariant.load !15
  %cmp = icmp eq i8 %3, 101
  br i1 %cmp, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %for.cond
  %arrayidx16 = getelementptr inbounds nuw i8, ptr %2, i64 1
  %4 = load i8, ptr %arrayidx16, align 1, !tbaa !14, !invariant.load !15
  %cmp18 = icmp eq i8 %4, 110
  br i1 %cmp18, label %land.lhs.true19, label %if.end

land.lhs.true19:                                  ; preds = %land.lhs.true
  %arrayidx21 = getelementptr inbounds nuw i8, ptr %2, i64 2
  %5 = load i8, ptr %arrayidx21, align 2, !tbaa !14, !invariant.load !15
  %cmp23 = icmp eq i8 %5, 100
...
print:                                            ; preds = %land.lhs.true19
  %6 = load ptr, ptr @p2, align 8, !tbaa !5
  %next24 = getelementptr inbounds nuw i8, ptr %6, i64 104
  store ptr null, ptr %next24, align 8, !tbaa !10
  %7 = load ptr, ptr @head, align 8, !tbaa !5
  tail call void @_Z6resultP3stu(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(112) %7)
  ret i32 0
}
...
define dso_local void @_Z6resultP3stu(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(112) %x) local_unnamed_addr #3 {
entry:
  %next = getelementptr inbounds nuw i8, ptr %x, i64 104
  %0 = load ptr, ptr %next, align 8, !tbaa !10, !invariant.load !15
  %cmp = icmp eq ptr %0, null
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  tail call fastcc void @outlined_ir_func_0()
  %putchar = tail call i32 @putchar(i32 noundef 10) #8
  br label %if.end

if.else:                                          ; preds = %entry
  tail call void @_Z6resultP3stu(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(112) %0)
  tail call fastcc void @outlined_ir_func_0()
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %putchar1 = tail call i32 @putchar(i32 noundef 10) #8
  ret void
}
...
define internal fastcc void @outlined_ir_func_0() unnamed_addr #4 {
if.then_after_outline.exitStub:
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr undef)
  %call2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef undef)
  %putchar = tail call i32 @putchar(i32 noundef 0) #8
  %call4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 undef)
  %call6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef undef)
  %call8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, ptr noundef undef)
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) unnamed_addr #5 {
entry_after_outline.exitStub:
  %1 = load ptr, ptr @p1, align 8, !tbaa !5
  %name = getelementptr inbounds nuw i8, ptr %1, i64 30
  %call3 = tail call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %name)
  %2 = load ptr, ptr @p1, align 8, !tbaa !5
  %sex = getelementptr inbounds nuw i8, ptr %2, i64 60
  %call4 = tail call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %sex)
  %3 = load ptr, ptr @p1, align 8, !tbaa !5
  %age = getelementptr inbounds nuw i8, ptr %3, i64 64
  %call5 = tail call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.2, ptr noundef nonnull %age)
  %4 = load ptr, ptr @p1, align 8, !tbaa !5
  %score = getelementptr inbounds nuw i8, ptr %4, i64 68
  ...
  %add = getelementptr inbounds nuw i8, ptr %5, i64 72
...
attributes #4 = { minsize mustprogress optsize memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
