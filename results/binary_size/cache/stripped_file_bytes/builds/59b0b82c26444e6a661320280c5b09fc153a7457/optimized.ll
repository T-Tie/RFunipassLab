...
if.end7:                                          ; preds = %while.body, %while.end
  %m.addr.0.lcssa10 = phi i32 [ %smin, %while.end ], [ %m.addr.0, %while.body ]
  %div = sdiv i32 %n, %m.addr.0.lcssa10
  %call = tail call noundef i32 @_Z3getii(i32 noundef %div, i32 noundef %m.addr.0.lcssa10) #7
  %sub = add nsw i32 %m.addr.0.lcssa10, -1
