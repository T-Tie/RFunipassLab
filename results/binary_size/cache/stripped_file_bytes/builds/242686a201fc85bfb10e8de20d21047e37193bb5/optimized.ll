...
if.end10:                                         ; preds = %if.then5, %if.end
  ...
  tail call void @_Z10reduce_miniiii(i32 noundef %add, i32 noundef %add11, i32 noundef %dx, i32 noundef %dy) #6
...
for.inc26:                                        ; preds = %for.cond16
  ...
  tail call void @_Z10reduce_miniiii(i32 noundef %mul19, i32 noundef %mul22, i32 noundef %div, i32 noundef %sub) #7
