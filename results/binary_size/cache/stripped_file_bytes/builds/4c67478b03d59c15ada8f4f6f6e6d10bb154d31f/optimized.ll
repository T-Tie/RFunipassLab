...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 120, ptr nonnull %high) #10
  call void @llvm.lifetime.start.p0(i64 120, ptr nonnull %num) #10
...
for.cond3:                                        ; preds = %for.end22, %for.end
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end22 ], [ 1, %for.end ]
...
for.cond6.outer:                                  ; preds = %if.then, %for.cond6.preheader
  %indvars.iv17.ph = phi i64 [ %indvars.iv.next18, %if.then ], [ %indvars.iv15, %for.cond6.preheader ]
  %max.0.ph = phi i32 [ %spec.select, %if.then ], [ 0, %for.cond6.preheader ]
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.outer, %for.body8
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body8 ], [ %indvars.iv17.ph, %for.cond6.outer ]
...
for.body8:                                        ; preds = %for.cond6
  ...
  br i1 %cmp13.not, label %for.cond6, label %if.then, !llvm.loop !12
...
if.then:                                          ; preds = %for.body8
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %max.0.ph, i32 %4)
  br label %for.cond6.outer, !llvm.loop !12
...
if.then.i.i:                                      ; preds = %for.end27
  ...
  %5 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %1, i1 true)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end27, %if.then.i.i
  ...
  call void @llvm.lifetime.end.p0(i64 120, ptr nonnull %num) #10
  call void @llvm.lifetime.end.p0(i64 120, ptr nonnull %high) #10
...
while.cond:                                       ; preds = %while.cond, %if.end
  ...
  br i1 %cmp5.not, label %return, label %while.cond, !llvm.loop !19
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  br i1 %cmp.i.i, label %while.cond.i.sink.split, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit, !llvm.loop !21
...
while.cond1:                                      ; preds = %while.cond1, %while.body
  ...
  br i1 %cmp.i, label %while.cond1, label %while.cond4, !llvm.loop !22
...
while.cond4:                                      ; preds = %while.cond1, %while.cond4
  ...
  br i1 %cmp.i11, label %while.cond4, label %while.end8, !llvm.loop !23
...
entry:
  ...
  br i1 %cmp, label %if.then, label %if.else, !prof !26
