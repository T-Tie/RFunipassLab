...
for.end9:                                         ; preds = %for.cond
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond42.preheader:                             ; preds = %for.cond12
  %smax64 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 1)
  %smax70 = call i32 @llvm.smax.i32(i32 %12, i32 noundef 0)
...
for.cond20:                                       ; preds = %for.inc36, %for.body14
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc36 ], [ 1, %for.body14 ]
...
for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc97
  ...
  %24 = sext i32 %.pre7981 to i64
  %cmp78 = icmp slt i64 %indvars.iv73, %24
...
for.body79:                                       ; preds = %for.cond77
  ...
  %25 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !13
  %26 = load i32, ptr %arrayidx85, align 4, !tbaa !5, !invariant.load !13
  %cmp86 = icmp eq i32 %25, %26
...
land.lhs.true:                                    ; preds = %for.body79
  ...
  %27 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
  %cmp93 = icmp eq i32 %25, %27
  br i1 %cmp93, label %if.then94, label %for.inc97

if.then94:                                        ; preds = %land.lhs.true
  %28 = trunc nuw nsw i64 %indvars.iv73 to i32
  %call95 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %23, i32 noundef %28) #7
