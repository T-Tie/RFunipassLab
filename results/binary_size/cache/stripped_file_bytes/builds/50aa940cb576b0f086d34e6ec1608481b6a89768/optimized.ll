...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %q) #7
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %p) #7
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %w) #7
  ...
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %q) #8
  %conv = trunc i64 %call6 to i32
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %p) #8
...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv37 = phi i32 [ %indvars.iv.next38, %for.inc29 ], [ %conv9, %entry ]
  %indvars.iv32 = phi i32 [ %indvars.iv.next33, %for.inc29 ], [ 0, %entry ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc29 ], [ 0, %entry ]
  %g.0 = phi i32 [ %g.3, %for.inc29 ], [ undef, %entry ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %if.else, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx11 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv23
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = add nuw nsw i64 %indvars.iv, %indvars.iv23
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body35
  %indvars.iv29 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next30, %for.body35 ]
  %exitcond36.not = icmp eq i64 %indvars.iv29, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end42, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [256 x i8], ptr %q, i64 0, i64 %indvars.iv29
...
for.end42:                                        ; preds = %for.cond33
  ...
  %6 = sext i32 %indvars.iv37 to i64
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.body48, %for.end42
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body48 ], [ %6, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv40, %7
  br i1 %cmp47, label %for.body48, label %if.end58

for.body48:                                       ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [256 x i8], ptr %q, i64 0, i64 %indvars.iv40
...
if.end58:                                         ; preds = %for.cond46, %if.else
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %w) #7
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %p) #7
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %q) #7
  ret i32 0
}
