...
while.cond:                                       ; preds = %if.end30, %entry
  %indvars.iv22 = phi i32 [ %indvars.iv.next23, %if.end30 ], [ %conv7, %entry ]
  %indvars.iv17 = phi i32 [ %indvars.iv.next18, %if.end30 ], [ 0, %entry ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %if.end30 ], [ 0, %entry ]
  %arrayidx = getelementptr inbounds nuw [257 x i8], ptr %str, i64 0, i64 %indvars.iv11
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp25.not, label %for.inc, label %for.end.split.loop.exit30

for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.end.split.loop.exit30:                        ; preds = %for.body
  %5 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.cond, %for.end.split.loop.exit30
  %i.0.lcssa = phi i32 [ %5, %for.end.split.loop.exit30 ], [ %smax, %for.cond ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  ...
  br i1 %exitcond21.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [257 x i8], ptr %str, i64 0, i64 %indvars.iv14
...
for.end42:                                        ; preds = %for.cond33
  ...
  %7 = sext i32 %indvars.iv22 to i64
  %sext = shl i64 %call4, 32
  %8 = ashr exact i64 %sext, 32
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc53, %for.end42
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc53 ], [ %7, %for.end42 ]
  %cmp47 = icmp slt i64 %indvars.iv25, %8
  br i1 %cmp47, label %for.inc53, label %if.end58

for.inc53:                                        ; preds = %for.cond46
  %arrayidx50 = getelementptr inbounds [257 x i8], ptr %str, i64 0, i64 %indvars.iv25
