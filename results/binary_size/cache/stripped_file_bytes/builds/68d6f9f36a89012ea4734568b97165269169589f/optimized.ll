...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv17, %2
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv17, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc145
  %indvars.iv35 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next36, %for.inc145 ]
  %indvars.iv24 = phi i32 [ %3, %for.cond13.preheader ], [ %indvars.iv.next25, %for.inc145 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc145 ]
  %t.0 = phi i32 [ 0, %for.cond13.preheader ], [ %inc146, %for.inc145 ]
  %smax72 = call i32 @llvm.smax.i32(i32 %indvars.iv35, i32 noundef 2)
  %8 = add nuw i32 %smax72, 1
  %exitcond76 = icmp eq i32 %t.0, %5
  br i1 %exitcond76, label %for.inc150, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  %smax52 = call i32 @llvm.smax.i32(i32 %indvars.iv35, i32 noundef 0)
  %9 = add nuw i32 %smax52, 1
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc52
  %indvars.iv31 = phi i64 [ 1, %for.cond16.preheader ], [ %indvars.iv.next32, %for.inc52 ]
  %exitcond38 = icmp eq i64 %indvars.iv31, %wide.trip.count37
  br i1 %exitcond38, label %for.cond55.preheader, label %for.cond20

for.cond55.preheader:                             ; preds = %for.cond16
  %wide.trip.count42 = zext i32 %indvars.iv24 to i64
  br label %for.cond55

for.cond20:                                       ; preds = %for.cond16, %for.body23
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body23 ], [ 1, %for.cond16 ]
...
for.body23:                                       ; preds = %for.cond20
  %arrayidx27 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv20
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv26 = phi i64 [ 1, %for.cond36.preheader ], [ %indvars.iv.next27, %for.inc49 ]
  %exitcond30 = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30, label %for.inc52, label %for.inc49

for.inc49:                                        ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv26
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc95
  %indvars.iv49 = phi i64 [ 1, %for.cond55.preheader ], [ %indvars.iv.next50, %for.inc95 ]
  %exitcond54 = icmp eq i64 %indvars.iv49, %wide.trip.count37
  br i1 %exitcond54, label %for.end97, label %for.cond59

for.cond59:                                       ; preds = %for.cond55, %for.body62
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.body62 ], [ 1, %for.cond55 ]
  %min.1 = phi i32 [ %spec.select15, %for.body62 ], [ 100000, %for.cond55 ]
  %exitcond43 = icmp eq i64 %indvars.iv39, %wide.trip.count42
  br i1 %exitcond43, label %for.cond79.preheader, label %for.body62

for.cond79.preheader:                             ; preds = %for.cond59
  br label %for.cond79

for.body62:                                       ; preds = %for.cond59
  %arrayidx66 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv49
  %12 = load i32, ptr %arrayidx66, align 4, !tbaa !5, !invariant.load !13
  %spec.select15 = call i32 @llvm.smin.i32(i32 %min.1, i32 %12)
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  br label %for.cond59, !llvm.loop !17

for.cond79:                                       ; preds = %for.cond79.preheader, %for.inc92
  %indvars.iv44 = phi i64 [ 1, %for.cond79.preheader ], [ %indvars.iv.next45, %for.inc92 ]
  %exitcond48 = icmp eq i64 %indvars.iv44, %wide.trip.count42
  br i1 %exitcond48, label %for.inc95, label %for.inc92

for.inc92:                                        ; preds = %for.cond79
  %arrayidx86 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv49
...
for.cond100:                                      ; preds = %for.inc118, %for.end97
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc118 ], [ 3, %for.end97 ]
  %exitcond61 = icmp eq i64 %indvars.iv55, %wide.trip.count60
  br i1 %exitcond61, label %for.cond121.preheader, label %for.inc118

for.cond121.preheader:                            ; preds = %for.cond100
  %wide.trip.count66 = zext i32 %indvars.iv24 to i64
  br label %for.cond121

for.inc118:                                       ; preds = %for.cond100
  %arrayidx106 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 1
  %15 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %16 = add nsw i64 %indvars.iv55, -1
  %arrayidx110 = getelementptr inbounds [102 x [102 x i32]], ptr %a, i64 0, i64 %16, i64 1
  store i32 %15, ptr %arrayidx110, align 4, !tbaa !5
  %arrayidx113 = getelementptr inbounds nuw [102 x i32], ptr %arrayidx111, i64 0, i64 %indvars.iv55
...
for.cond121:                                      ; preds = %for.cond121.preheader, %for.inc142
  %indvars.iv68 = phi i64 [ 3, %for.cond121.preheader ], [ %indvars.iv.next69, %for.inc142 ]
  %exitcond74 = icmp eq i64 %indvars.iv68, %wide.trip.count60
  br i1 %exitcond74, label %for.inc145, label %for.cond125.preheader
...
for.cond125:                                      ; preds = %for.cond125.preheader, %for.inc139
  %indvars.iv62 = phi i64 [ 3, %for.cond125.preheader ], [ %indvars.iv.next63, %for.inc139 ]
  %exitcond67 = icmp eq i64 %indvars.iv62, %wide.trip.count66
  br i1 %exitcond67, label %for.inc142, label %for.inc139

for.inc139:                                       ; preds = %for.cond125
  %arrayidx132 = getelementptr inbounds nuw [102 x [102 x i32]], ptr %a, i64 0, i64 %indvars.iv68, i64 %indvars.iv62
  %19 = load i32, ptr %arrayidx132, align 4, !tbaa !5, !invariant.load !13
  %20 = add nsw i64 %indvars.iv62, -1
