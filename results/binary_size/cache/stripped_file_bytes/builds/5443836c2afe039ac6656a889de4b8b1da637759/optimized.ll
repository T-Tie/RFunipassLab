...
for.cond1:                                        ; preds = %for.cond, %for.cond.cleanup7
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.cond.cleanup7 ], [ 0, %for.cond ]
...
for.cond15:                                       ; preds = %for.cond1, %for.cond.cleanup72
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.cond.cleanup72 ], [ 0, %for.cond1 ]
  %total.0 = phi i32 [ %add130, %for.cond.cleanup72 ], [ 0, %for.cond1 ]
  %exitcond87.not = icmp eq i64 %indvars.iv61, 0
  br i1 %exitcond87.not, label %for.cond.cleanup17, label %for.cond.cleanup72
