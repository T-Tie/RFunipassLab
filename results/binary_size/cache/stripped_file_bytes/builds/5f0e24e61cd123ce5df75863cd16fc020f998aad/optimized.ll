...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 60, ptr %s) #7
  call void @llvm.memset.p0.i64(ptr align 16 %s, i8 0, i64 60, i1 false)
  ...
  %arrayidx = getelementptr inbounds [15 x i32], ptr %s, i64 0, i64 0
...
do.body:                                          ; preds = %do.cond, %while.body
  ...
  %arrayidx2 = getelementptr inbounds [15 x i32], ptr %s, i64 0, i64 %idxprom
...
for.body8:                                        ; preds = %for.cond5
  ...
  %arrayidx10 = getelementptr inbounds [15 x i32], ptr %s, i64 0, i64 %idxprom9
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %10 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom11 = sext i32 %10 to i64
  %arrayidx12 = getelementptr inbounds [15 x i32], ptr %s, i64 0, i64 %idxprom11
...
land.lhs.true:                                    ; preds = %for.body8
  ...
  %arrayidx15 = getelementptr inbounds [15 x i32], ptr %s, i64 0, i64 %idxprom14
...
for.end21:                                        ; preds = %for.cond.cleanup
  ...
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %17)
  ...
  call void @llvm.lifetime.end.p0(i64 60, ptr %s) #7
