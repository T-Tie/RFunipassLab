...
if.end.split:                                     ; preds = %if.end
  ...
  %add.ptr13.le = getelementptr inbounds i8, ptr @str, i64 %indvars.iv
  br label %for.cond

for.cond:                                         ; preds = %if.end24, %if.end.split
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end24 ], [ %indvars.iv, %if.end.split ]
...
for.end:                                          ; preds = %for.cond3, %for.body7
  %indvars16.le = trunc i64 %indvars.iv12 to i32
