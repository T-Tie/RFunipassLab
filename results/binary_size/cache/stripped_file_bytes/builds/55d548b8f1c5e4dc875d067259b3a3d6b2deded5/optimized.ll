...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef nonnull align 16 captures(none) dereferenceable(600) %word) #9
  ...
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(600) %word, i64 noundef 600)
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.end22
  %indvars.iv19 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next20, %for.end22 ]
  %exitcond28.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond28.not, label %for.cond30, label %for.cond8.preheader

for.cond8.preheader:                              ; preds = %for.cond5
  %2 = add nsw i64 %indvars.iv19, %1
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.body12
  %indvars.iv21 = phi i64 [ %indvars.iv19, %for.cond8.preheader ], [ %indvars.iv.next22, %for.body12 ]
  %indvars.iv17 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next18, %for.body12 ]
  %cmp11.not = icmp sgt i64 %indvars.iv21, %2
  br i1 %cmp11.not, label %for.end22, label %for.body12

for.body12:                                       ; preds = %for.cond8
  %arrayidx14 = getelementptr inbounds nuw [600 x i8], ptr %word, i64 0, i64 %indvars.iv21
  %3 = load i8, ptr %arrayidx14, align 1, !tbaa !12, !invariant.load !13
  %arrayidx18 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv19, i64 %indvars.iv17
...
for.end22:                                        ; preds = %for.cond8
  %arrayidx26 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv19, i64 %indvars.iv17
...
for.cond30:                                       ; preds = %for.cond5, %for.body34
  ...
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body34 ], [ 0, %for.cond5 ]
  %add32 = sub i32 %sub, %4
  %5 = sext i32 %add32 to i64
  %cmp33 = icmp slt i64 %indvars.iv29, %5
  br i1 %cmp33, label %for.body34, label %for.cond45.preheader

for.cond45.preheader:                             ; preds = %for.cond30
  %smax40 = call i32 @llvm.smax.i32(i32 %add32, i32 noundef 0)
  %wide.trip.count41 = zext nneg i32 %smax40 to i64
  %wide.trip.count35 = zext i32 %add32 to i64
  br label %for.cond45

for.body34:                                       ; preds = %for.cond30
  %arrayidx36 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %temp, i64 0, i64 %indvars.iv29
  %arrayidx39 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv29
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.end68
  %indvars.iv37 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next38, %for.end68 ]
  %exitcond42.not = icmp eq i64 %indvars.iv37, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond72, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %arrayidx56 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv37
  %arrayidx64 = getelementptr inbounds nuw [600 x i32], ptr %cnt, i64 0, i64 %indvars.iv37
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %if.end
  %indvars.iv32 = phi i64 [ 0, %for.cond50.preheader ], [ %indvars.iv.next33, %if.end ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end68, label %for.body54

for.body54:                                       ; preds = %for.cond50
  %arrayidx59 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %temp, i64 0, i64 %indvars.iv32
...
for.cond72:                                       ; preds = %for.cond45, %for.body76
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.body76 ], [ 0, %for.cond45 ]
  %max.0 = phi i32 [ %spec.select, %for.body76 ], [ 1, %for.cond45 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count41
  br i1 %exitcond47.not, label %for.end86, label %for.body76

for.body76:                                       ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [600 x i32], ptr %cnt, i64 0, i64 %indvars.iv43
...
if.then88:                                        ; preds = %for.end86
  %call89 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %max.0)
...
for.cond91:                                       ; preds = %if.end138, %if.then88
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %if.end138 ], [ 0, %if.then88 ]
  %8 = load i32, ptr %n, align 4, !tbaa !5
  %add93 = sub i32 %sub, %8
  %9 = sext i32 %add93 to i64
  %cmp94 = icmp slt i64 %indvars.iv53, %9
  br i1 %cmp94, label %for.body95, label %if.end144

for.body95:                                       ; preds = %for.cond91
  %arrayidx97 = getelementptr inbounds nuw [600 x i32], ptr %cnt, i64 0, i64 %indvars.iv53
...
land.lhs.true:                                    ; preds = %for.body95
  %cmp99 = icmp eq i64 %indvars.iv53, 0
  br i1 %cmp99, label %land.lhs.true110.thread, label %for.cond113.preheader

for.cond113.preheader:                            ; preds = %land.lhs.true
  %arrayidx117 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv53
  %11 = add nuw i64 %indvars.iv53, 4294967295
...
for.cond113:                                      ; preds = %for.cond113.preheader, %if.end134
  %indvars.iv48 = phi i64 [ 0, %for.cond113.preheader ], [ %indvars.iv.next49, %if.end134 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %indvars.iv53
  br i1 %exitcond52.not, label %if.end138, label %for.body115

for.body115:                                      ; preds = %for.cond113
  %arrayidx120 = getelementptr inbounds nuw [600 x [10 x i8]], ptr %gram, i64 0, i64 %indvars.iv48
...
if.end125:                                        ; preds = %for.body115
  %cmp127 = icmp eq i64 %indvars.iv48, %12
...
if.else:                                          ; preds = %for.end86
  %call142 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) @.str)
  %call143 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call142, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %if.end144
...
if.end106.exitStub:
  %call104 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0)
