...
tailrecurse.outer:                                ; preds = %if.then2, %entry
  %accumulator.tr.ph = phi i32 [ %spec.select, %if.then2 ], [ -2147483648, %entry ]
...
if.then2:                                         ; preds = %if.end
  ...
  %add = add nsw i32 %4, 1
  %call = tail call noundef i32 @_Z2ffiii(i32 noundef %add, i32 noundef %3, i32 noundef %add5) #6
  %spec.select = tail call i32 @llvm.smax.i32(i32 noundef %call, i32 %accumulator.tr.ph)
  br label %tailrecurse.outer
...
return:                                           ; preds = %tailrecurse
  %accumulator.ret.tr = tail call i32 @llvm.smax.i32(i32 noundef %count, i32 %accumulator.tr.ph)
...
for.end:                                          ; preds = %for.cond
  %call2 = tail call noundef i32 @_Z2ffiii(i32 noundef 0, i32 noundef 99999, i32 noundef 0) #7
...
attributes #6 = { nofree nosync nounwind memory(read) }
