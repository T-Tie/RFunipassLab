...
for.cond3:                                        ; preds = %for.cond, %for.inc75
  ...
  %5 = sext i32 %4 to i64
  %cmp4 = icmp slt i64 %indvars.iv23, %5
...
if.then:                                          ; preds = %for.body6
  %add.ptr = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv23
...
if.else:                                          ; preds = %for.body6
  ...
  %add.ptr20 = getelementptr inbounds nuw [50 x i8], ptr %a, i64 %indvars.iv23
