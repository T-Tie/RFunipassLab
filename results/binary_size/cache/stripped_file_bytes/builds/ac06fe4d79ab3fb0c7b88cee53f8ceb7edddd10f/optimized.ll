...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %sum) #7
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %useful) #7
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %useful) #8
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %sum) #8
...
entry:
  ...
  %1 = tail call noundef double @llvm.fabs.f64(double %sub) #9
  %cmp = fcmp ugt double %1, 5.000000e-02
  %cmp4 = fcmp ogt double %sub, 5.000000e-02
  %.str.1..str.2 = select i1 %cmp4, ptr @.str.1, ptr @.str.2
  %.str.1.sink = select i1 %cmp, ptr %.str.1..str.2, ptr @.str
  tail call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(5) %.str.1.sink)
  ret void
}
...
if.end11.exitStub:
  %call1 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
