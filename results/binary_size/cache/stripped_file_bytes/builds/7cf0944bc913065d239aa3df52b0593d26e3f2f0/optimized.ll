...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc24
  %indvars.iv6 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next7, %for.inc24 ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, %wide.trip.count
...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %m, i32 noundef 2)
  %smax13 = call i32 @llvm.smax.i32(i32 noundef %m, i32 noundef 0)
