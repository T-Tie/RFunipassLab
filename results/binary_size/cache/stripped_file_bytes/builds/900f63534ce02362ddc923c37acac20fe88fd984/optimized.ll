...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 396, ptr nonnull %sz) #5
  br label %for.cond
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv21 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next22, %for.body5 ]
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [99 x i32], ptr %sz, i64 0, i64 %indvars.iv21
...
for.end13:                                        ; preds = %for.cond2
  %sub3.le = add nsw i32 %0, -1
  %cmp15.not = icmp eq i32 %max.0, %sub3.le
...
if.end27:                                         ; preds = %if.then16, %for.end13
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %sub29, i32 -1)
  %7 = add nsw i32 %smax28, 1
  %wide.trip.count29 = zext nneg i32 %7 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body31, %if.end27
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body31 ], [ 0, %if.end27 ]
  %max.2 = phi i32 [ %spec.select19, %for.body31 ], [ 0, %if.end27 ]
  %exitcond30 = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30, label %for.end41, label %for.body31

for.body31:                                       ; preds = %for.cond28
  %arrayidx33 = getelementptr inbounds nuw [99 x i32], ptr %sz, i64 0, i64 %indvars.iv25
  ...
  %10 = trunc nuw nsw i64 %indvars.iv25 to i32
  %spec.select19 = select i1 %cmp36, i32 %10, i32 %max.2
...
if.end55:                                         ; preds = %if.then44, %for.end41
  ...
  call void @llvm.lifetime.end.p0(i64 396, ptr nonnull %sz) #5
