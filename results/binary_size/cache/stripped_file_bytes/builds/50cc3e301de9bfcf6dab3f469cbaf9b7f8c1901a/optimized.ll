...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %day) #10
  store i32 0, ptr %day, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 48, ptr %a) #10
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %a, ptr align 16 @__const.main.a, i64 48, i1 false)
...
if.then:                                          ; preds = %while.body
  ...
  store i32 %4, ptr %month1, align 4, !tbaa !5
  %5 = load i32, ptr %i, align 4, !tbaa !5
  store i32 %5, ptr %month2, align 4, !tbaa !5
  br label %if.end
...
for.body:                                         ; preds = %for.cond
  %12 = load i32, ptr %day, align 4, !tbaa !5
...
if.else:                                          ; preds = %lor.lhs.false
  %16 = load i32, ptr %month1, align 4, !tbaa !5
  %sub12 = sub nsw i32 %16, 1
  store i32 %sub12, ptr %i, align 4, !tbaa !5
  br label %for.cond13

for.cond13:                                       ; preds = %for.inc20, %if.else
  %17 = load i32, ptr %i, align 4, !tbaa !5
  %18 = load i32, ptr %month2, align 4, !tbaa !5
...
for.body16:                                       ; preds = %for.cond13
  ...
  %arrayidx18 = getelementptr inbounds [12 x i32], ptr %a, i64 0, i64 %idxprom17
  %21 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %add19 = add nsw i32 %19, %21
...
for.end22:                                        ; preds = %for.cond13
  %23 = load i32, ptr %month1, align 4, !tbaa !5
  %cmp23 = icmp sle i32 %23, 2
  br i1 %cmp23, label %land.lhs.true24, label %if.end28

land.lhs.true24:                                  ; preds = %for.end22
  %24 = load i32, ptr %month2, align 4, !tbaa !5
  %cmp25 = icmp sgt i32 %24, 2
  br i1 %cmp25, label %if.then26, label %if.end28

if.then26:                                        ; preds = %land.lhs.true24
  %25 = load i32, ptr %day, align 4, !tbaa !5
  %sub27 = sub nsw i32 %25, 1
  store i32 %sub27, ptr %day, align 4, !tbaa !5
  br label %if.end28

if.end28:                                         ; preds = %if.then26, %land.lhs.true24, %for.end22
  br label %if.end29
...
if.then32:                                        ; preds = %if.end29
  %call33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
if.else35:                                        ; preds = %if.end29
  %call36 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 48, ptr %a) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %day) #10
