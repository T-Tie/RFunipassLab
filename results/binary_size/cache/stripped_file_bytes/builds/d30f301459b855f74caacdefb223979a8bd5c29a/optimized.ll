...
for.body43:                                       ; preds = %for.cond41
  %cmp44 = icmp eq i64 %indvars.iv11, 0
  ...
  %6 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !9
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %6)
