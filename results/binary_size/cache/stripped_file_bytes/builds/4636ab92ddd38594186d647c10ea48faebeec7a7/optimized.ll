...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %input) #5
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %output) #5
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc25
  %indvars.iv23 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next24, %for.inc25 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %for.inc25 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond28.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %input, i64 0, i64 %indvars.iv23
  br label %for.cond5

for.cond28.preheader:                             ; preds = %for.cond2
  %smax33 = call i32 @llvm.smax.i32(i32 %k.0, i32 1)
  %wide.trip.count = zext nneg i32 %smax33 to i64
  br label %for.cond28

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %input, i64 0, i64 %indvars.iv20
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %cmp12 = icmp eq i32 %2, %3
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br i1 %cmp12, label %for.inc25, label %for.cond5, !llvm.loop !12
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv29 = phi i64 [ 1, %for.cond28.preheader ], [ %indvars.iv.next30, %for.body30 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond34.not, label %for.end36, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %output, i64 0, i64 %indvars.iv29
  %5 = load i32, ptr %arrayidx32, align 4, !tbaa !5
  %call33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5)
...
if.then38:                                        ; preds = %for.end36
  ...
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %6)
  br label %if.end42

if.end42:                                         ; preds = %if.then38, %for.end36
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %output) #5
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %input) #5
