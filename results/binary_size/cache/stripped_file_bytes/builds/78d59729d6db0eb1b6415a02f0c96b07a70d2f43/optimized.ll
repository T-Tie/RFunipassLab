...
for.cond5:                                        ; preds = %for.inc14, %for.end
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc14 ], [ %2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv3, 0
  br i1 %cmp6, label %for.inc14, label %for.end16

for.inc14:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %words, i64 0, i64 %indvars.iv3
