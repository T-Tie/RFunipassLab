...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.end27
  %indvars.iv53 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next54, %for.end27 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count56
  br i1 %exitcond57.not, label %for.cond31.preheader, label %for.body3
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.body7 ], [ 0, %for.body3 ]
  %min.0 = phi i32 [ %spec.select, %for.body7 ], [ %2, %for.body3 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond17.preheader, label %for.body7

for.cond17.preheader:                             ; preds = %for.cond5
  br label %for.cond17

for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv53, i64 %indvars.iv43
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.body19
  %indvars.iv48 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next49, %for.body19 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count46
  br i1 %exitcond52.not, label %for.end27, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv53, i64 %indvars.iv48
...
for.cond31:                                       ; preds = %for.cond31.preheader.split, %for.end63
  %indvars.iv40 = phi i64 [ 0, %for.cond31.preheader.split ], [ %indvars.iv.next41, %for.end63 ]
  %arrayidx35 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv40
...
for.cond36:                                       ; preds = %for.body38, %for.cond31
  ...
  %min.2 = phi i32 [ %spec.select31, %for.body38 ], [ %5, %for.cond31 ]
...
for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv40
  %6 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !12
  %spec.select31 = tail call i32 @llvm.smin.i32(i32 %6, i32 %min.2)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond36, !llvm.loop !16

for.cond53:                                       ; preds = %for.cond53.preheader, %for.body55
  %indvars.iv34 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next35, %for.body55 ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond39.not, label %for.end63, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv34, i64 %indvars.iv40
...
entry:
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
...
for.cond:                                         ; preds = %for.end, %entry
  ...
  br i1 %exitcond20.not, label %for.cond14.preheader, label %for.cond1

for.cond14.preheader:                             ; preds = %for.cond
  %cmp16 = icmp sgt i32 %2, 1
  br i1 %cmp16, label %for.cond14.preheader13, label %for.end36

for.cond14.preheader13:                           ; preds = %for.cond14.preheader
...
for.body3:                                        ; preds = %for.cond1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv.next
  %3 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !12
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader13, %for.end33
  %indvars.iv26 = phi i64 [ 0, %for.cond14.preheader13 ], [ %indvars.iv.next27, %for.end33 ]
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond14, %for.body21
  %indvars.iv21 = phi i64 [ 1, %for.cond14 ], [ %indvars.iv.next22, %for.body21 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.end33, label %for.body21

for.body21:                                       ; preds = %for.cond18
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %arrayidx26 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next22, i64 %indvars.iv26
  %4 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !12
  %arrayidx30 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
