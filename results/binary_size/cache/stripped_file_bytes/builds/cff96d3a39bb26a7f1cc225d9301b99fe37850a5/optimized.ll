...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %or.cond9 = or i1 %cmp8, %or.cond
  %cmp23 = icmp slt i32 %3, 3
  %cmp25 = icmp sgt i32 %.pr, 2
  %or.cond10 = and i1 %cmp25, %cmp23
  %spec.select = select i1 %or.cond10, ptr @.str.1, ptr @.str
  %.str.1.sink = select i1 %or.cond9, ptr @.str, ptr %spec.select
