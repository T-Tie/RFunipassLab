...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1200, ptr nonnull %w) #5
  call void @llvm.lifetime.start.p0(i64 1200, ptr nonnull %s) #5
...
for.cond6:                                        ; preds = %for.body8, %for.body
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body8 ], [ %indvars.iv, %for.body ]
  %f.1 = phi i32 [ %spec.select, %for.body8 ], [ 0, %for.body ]
  %cmp7 = icmp sgt i64 %indvars.iv15, 0
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond6
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  %arrayidx10 = getelementptr inbounds nuw [300 x i32], ptr %w, i64 0, i64 %indvars.iv.next16
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.body28
  %indvars.iv19 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next20, %for.body28 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond.not, label %for.end34, label %for.body28

for.body28:                                       ; preds = %for.cond25
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv19
...
for.end34:                                        ; preds = %for.cond25
  ...
  %call38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6)
  call void @llvm.lifetime.end.p0(i64 1200, ptr nonnull %s) #5
  call void @llvm.lifetime.end.p0(i64 1200, ptr nonnull %w) #5
