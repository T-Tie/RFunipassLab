...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %year) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %mon1) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %mon2) #5
...
for.body8:                                        ; preds = %for.cond6
  ...
  %or.cond234 = or i1 %cmp19, %or.cond
  ...
  br i1 %or.cond234, label %if.then, label %if.else205
...
lor.lhs.false381:                                 ; preds = %if.end373
  ...
  %spec.select292 = select i1 %cmp388, ptr @str.1, ptr @str
  br label %for.inc395

for.inc395:                                       ; preds = %lor.lhs.false381, %lor.lhs.false193, %if.end373, %if.end186
  %str.2.sink = phi ptr [ @str.3, %if.end186 ], [ @str.1, %if.end373 ], [ %spec.select, %lor.lhs.false193 ], [ %spec.select292, %lor.lhs.false381 ]
  %puts243 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.sink) #6
