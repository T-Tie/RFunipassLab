...
entry:
  ...
  %div34 = sdiv i8 %div3.lhs.trunc, 50
  ...
  %div145 = sdiv i8 %5, 20
  %div14.sext = sext i8 %div145 to i32
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div14.sext)
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %.fr2 = freeze i32 %6
  %7 = srem i32 %.fr2, 100
  %.lhs.trunc6 = trunc nsw i32 %7 to i8
  %8 = srem i8 %.lhs.trunc6, 50
  %9 = srem i8 %8, 20
  %div3710 = sdiv i8 %9, 10
  %div37.sext = sext i8 %div3710 to i32
  %call38 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div37.sext)
  %10 = load i32, ptr %n, align 4, !tbaa !5
  %.fr3 = freeze i32 %10
  %11 = srem i32 %.fr3, 100
  %.lhs.trunc11 = trunc nsw i32 %11 to i8
  %12 = srem i8 %.lhs.trunc11, 50
  %13 = srem i8 %12, 20
  %14 = srem i8 %13, 10
  %div8417 = sdiv i8 %14, 5
  %div84.sext = sext i8 %div8417 to i32
