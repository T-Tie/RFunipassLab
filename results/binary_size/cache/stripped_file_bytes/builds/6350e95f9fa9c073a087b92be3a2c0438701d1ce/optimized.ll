...
if.then:                                          ; preds = %entry, %land.lhs.true
  ...
  %rem81 = urem i32 %year, 100
  %cmp9 = icmp ne i32 %rem81, 0
  %or.cond3 = and i1 %cmp9, %or.cond
  br i1 %or.cond3, label %if.end22, label %if.else

if.else:                                          ; preds = %if.then
  %rem12 = srem i32 %year, 100
  %cmp15 = icmp sgt i32 %year, 99
  %rem172 = urem i32 %year, 400
  %1 = or i32 %rem172, %rem12
  %2 = icmp eq i32 %1, 0
  %or.cond5 = and i1 %cmp15, %2
