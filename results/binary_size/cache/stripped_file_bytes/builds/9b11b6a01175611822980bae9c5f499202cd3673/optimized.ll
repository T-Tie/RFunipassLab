...
for.cond5:                                        ; preds = %for.inc27, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc27 ], [ 1, %for.end ]
  %k.0 = phi i32 [ %k.1, %for.inc27 ], [ 1, %for.end ]
  %exitcond14.not = icmp eq i64 %indvars.iv8, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end29, label %for.cond8.preheader

for.cond8.preheader:                              ; preds = %for.cond5
  %arrayidx12 = getelementptr inbounds nuw [310 x i32], ptr %x, i64 0, i64 %indvars.iv8
  %smax = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc16
  %indvars.iv5 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next6, %for.inc16 ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  %arrayidx14 = getelementptr inbounds nuw [310 x i32], ptr %y, i64 0, i64 %indvars.iv5
...
for.end29:                                        ; preds = %for.cond5
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %k.0, i32 1)
  %wide.trip.count20 = zext nneg i32 %smax19 to i64
  br label %for.cond32

for.cond32:                                       ; preds = %for.inc38, %for.end29
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc38 ], [ 1, %for.end29 ]
...
for.inc38:                                        ; preds = %for.cond32
  %arrayidx36 = getelementptr inbounds nuw [310 x i32], ptr %y, i64 0, i64 %indvars.iv15
