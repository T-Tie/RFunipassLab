...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %n) #10
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %w) #10
  ...
  %_M_width.i8.i = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  br label %while.cond

while.cond:                                       ; preds = %if.end26, %entry
  %f.0 = phi i32 [ 0, %entry ], [ %conv25, %if.end26 ]
  %f1.0 = phi i32 [ 0, %entry ], [ %f1.1, %if.end26 ]
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(41) %w, i64 noundef 41)
...
land.lhs.true.i:                                  ; preds = %while.cond
  %0 = load i64, ptr %_M_width.i8.i, align 8, !tbaa !9, !invariant.load !8
  %1 = add i64 %0, -42
  %or.cond.i = icmp ult i64 %1, -41
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %add = add nsw i32 %f.0, 1
  %conv = sext i32 %add to i64
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %w) #12
  %add6 = add i64 %call5, %conv
  %cmp = icmp ult i64 %add6, 81
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %cmp7.not = icmp eq i32 %f1.0, 0
  br i1 %cmp7.not, label %if.then.if.end_crit_edge, label %if.then8

if.then.if.end_crit_edge:                         ; preds = %if.then
  %.pre2 = zext i32 %f.0 to i64
  br label %if.end

if.then8:                                         ; preds = %if.then
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %if.end

if.end:                                           ; preds = %if.then.if.end_crit_edge, %if.then8
  %conv15.pre-phi = phi i64 [ %.pre2, %if.then.if.end_crit_edge ], [ %conv, %if.then8 ]
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %w)
  %inc12 = add nsw i32 %f1.0, 1
  br label %if.end26

if.else:                                          ; preds = %while.body
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %w)
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call20, ptr noundef nonnull @.str)
  br label %if.end26

if.end26:                                         ; preds = %if.else, %if.end
  %.sink = phi i64 [ 1, %if.else ], [ %conv15.pre-phi, %if.end ]
  %f1.1 = phi i32 [ 0, %if.else ], [ %inc12, %if.end ]
  %call23 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %w) #12
  %add24 = add i64 %call23, %.sink
  %conv25 = trunc i64 %add24 to i32
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(41) %w, i8 noundef 0, i64 noundef 41, i1 noundef false)
  br label %while.cond, !llvm.loop !22

while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %w) #11
