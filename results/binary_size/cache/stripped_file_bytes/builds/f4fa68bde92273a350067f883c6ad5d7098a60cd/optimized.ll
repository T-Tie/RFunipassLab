...
land.lhs.true3:                                   ; preds = %for.cond
  %div = sdiv i32 %n, %j
  %cmp4.not = icmp slt i32 %div, %j
  br i1 %cmp4.not, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true3
  call fastcc void @outlined_ir_func_0() #7
  %call = tail call noundef i32 @_Z5yinziii(i32 noundef %j, i32 noundef %div) #8
  br label %if.end
...
for.body5:                                        ; preds = %for.cond2
  %rem2 = and i32 %1, 1
  %cmp6 = icmp ne i32 %rem2, 0
  %cmp7.not = icmp eq i32 %1, 2
  %or.cond = or i1 %cmp7.not, %cmp6
  br i1 %or.cond, label %if.end, label %if.then

if.then:                                          ; preds = %for.body5
  %div34 = lshr exact i32 %1, 1
  call fastcc void @outlined_ir_func_0() #7
  %call9 = call noundef i32 @_Z5yinziii(i32 noundef 2, i32 noundef %div34) #7
  br label %if.end
