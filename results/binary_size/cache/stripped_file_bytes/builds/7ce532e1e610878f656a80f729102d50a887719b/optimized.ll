...
do.cond:                                          ; preds = %while.cond, %do.cond
  %indvars.iv11 = phi i32 [ %indvars.iv.next12, %do.cond ], [ 0, %while.cond ]
  ...
  %indvars.iv.next12 = add nuw nsw i32 %indvars.iv11, 1
  br i1 %cmp7, label %do.cond, label %for.cond.preheader, !llvm.loop !12

for.cond.preheader:                               ; preds = %do.cond
  %wide.trip.count15 = zext nneg i32 %indvars.iv11 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv6 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next7, %for.inc27 ]
  %count.0 = phi i32 [ 0, %for.cond.preheader ], [ %count.1, %for.inc27 ]
  %exitcond16.not = icmp eq i64 %indvars.iv6, %wide.trip.count15
  br i1 %exitcond16.not, label %if.end32, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.cond
  %arrayidx16 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv6
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.body12
  %indvars.iv8 = phi i64 [ %indvars.iv6, %for.cond9.preheader ], [ %indvars.iv.next9, %for.body12 ]
  %count.1 = phi i32 [ %count.0, %for.cond9.preheader ], [ %count.2, %for.body12 ]
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count15
  br i1 %exitcond.not, label %for.inc27, label %for.body12

for.body12:                                       ; preds = %for.cond9
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %arrayidx14 = getelementptr inbounds nuw [16 x double], ptr %a, i64 0, i64 %indvars.iv.next9
  ...
  %or.cond4 = or i1 %cmp17, %cmp23
  %inc25 = zext i1 %or.cond4 to i32
  %count.2 = add nsw i32 %count.1, %inc25
  br label %for.cond9, !llvm.loop !15

for.inc27:                                        ; preds = %for.cond9
