...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %mon1) #10
  call void @llvm.lifetime.start.p0(i64 4, ptr %mon2) #10
...
if.then10:                                        ; preds = %if.end
  ...
  %7 = load i32, ptr %mon1, align 4, !tbaa !5
  store i32 %7, ptr %t, align 4, !tbaa !5
  %8 = load i32, ptr %mon2, align 4, !tbaa !5
  store i32 %8, ptr %mon1, align 4, !tbaa !5
  %9 = load i32, ptr %t, align 4, !tbaa !5
  store i32 %9, ptr %mon2, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 4, ptr %t) #10
  br label %if.end11

if.end11:                                         ; preds = %if.then10, %if.end
  call void @llvm.lifetime.start.p0(i64 4, ptr %i12) #10
  %10 = load i32, ptr %mon1, align 4, !tbaa !5
  store i32 %10, ptr %i12, align 4, !tbaa !5
  br label %for.cond13

for.cond13:                                       ; preds = %for.inc, %if.end11
  %11 = load i32, ptr %i12, align 4, !tbaa !5
...
for.cond.cleanup15:                               ; preds = %for.cond13
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %i12) #10
  br label %for.end

for.body16:                                       ; preds = %for.cond13
  %13 = load i32, ptr %sum, align 4, !tbaa !5
  %14 = load i32, ptr %i12, align 4, !tbaa !5
  %idxprom = sext i32 %14 to i64
  %arrayidx17 = getelementptr inbounds [13 x i32], ptr %a, i64 0, i64 %idxprom
...
for.inc:                                          ; preds = %for.body16
  %16 = load i32, ptr %i12, align 4, !tbaa !5
  %inc = add nsw i32 %16, 1
  store i32 %inc, ptr %i12, align 4, !tbaa !5
...
if.end25:                                         ; preds = %if.else, %if.then20
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon2) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon1) #10
