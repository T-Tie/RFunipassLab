...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 301, ptr nonnull %str) #8
  call void @llvm.lifetime.start.p0(i64 104, ptr nonnull %counter) #8
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %exitcond.not, label %for.cond11, label %for.body
...
if.then:                                          ; preds = %for.body
  ...
  %2 = load i32, ptr %arrayidx9, align 4, !tbaa !8
  %inc = add nsw i32 %2, 1
...
for.cond11:                                       ; preds = %for.cond, %for.inc28
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc28 ], [ 97, %for.cond ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, 123
  br i1 %exitcond17.not, label %for.end30, label %for.body14

for.body14:                                       ; preds = %for.cond11
  %3 = add nsw i64 %indvars.iv13, -97
  %arrayidx18 = getelementptr inbounds [26 x i32], ptr %counter, i64 0, i64 %3
  %4 = load i32, ptr %arrayidx18, align 4, !tbaa !8
...
if.then20:                                        ; preds = %for.body14
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5, i32 noundef %4)
  br label %for.inc28
...
if.end33:                                         ; preds = %if.then31, %for.end30
  call void @llvm.lifetime.end.p0(i64 104, ptr nonnull %counter) #8
  call void @llvm.lifetime.end.p0(i64 301, ptr nonnull %str) #8
  ret i32 0
}
...
for.cond8:                                        ; preds = %for.end, %for.inc19
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc19 ], [ 0, %for.end ]
  %exitcond.not = icmp eq i64 %indvars.iv, 26
  br i1 %exitcond.not, label %if.end22, label %for.body10
...
if.then14:                                        ; preds = %for.body10
  ...
  %5 = add i32 %4, 97
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5, i32 noundef %3)
  br label %for.inc19
...
if.end22:                                         ; preds = %for.cond8, %if.then6
  call void @llvm.lifetime.end.p0(i64 104, ptr nonnull %counter) #8
  call void @llvm.lifetime.end.p0(i64 301, ptr nonnull %str) #8
  ret i32 0
}
