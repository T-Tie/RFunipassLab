...
for.cond3:                                        ; preds = %for.inc25, %for.end
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc25 ], [ 1, %for.end ]
...
for.cond6.preheader:                              ; preds = %for.cond3
  %arrayidx10 = getelementptr inbounds nuw [30 x i32], ptr %high, i64 0, i64 %indvars.iv2
  %2 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc21
  %indvars.iv4 = phi i64 [ %indvars.iv2, %for.cond6.preheader ], [ %indvars.iv.next5, %for.inc21 ]
  %max.0 = phi i32 [ 0, %for.cond6.preheader ], [ %max.1, %for.inc21 ]
  %indvars.iv.next5 = add nsw i64 %indvars.iv4, -1
  %cmp7 = icmp sgt i64 %indvars.iv4, 0
  br i1 %cmp7, label %for.body8, label %for.inc25

for.body8:                                        ; preds = %for.cond6
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %high, i64 0, i64 %indvars.iv.next5
...
if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv.next5
...
for.inc25:                                        ; preds = %for.cond6
  ...
  %arrayidx24 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv2
...
if.end:                                           ; preds = %while.body
  ...
  %div.i7 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i7
...
entry:
  ...
  %__last.sink = select i1 %cmp, ptr %add.ptr, ptr %__last
  tail call void @_ZSt16__insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef %__first, ptr noundef %__last.sink)
  ret void
}
...
if.end:                                           ; preds = %entry
  ...
  %div67 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div67, %if.end ], [ %dec, %while.body ]
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef align 4 %__c) local_unnamed_addr #4 comdat {
entry:
...
if.else:                                          ; preds = %if.then
  ...
  %4 = load i32, ptr %__result, align 4, !tbaa !5, !invariant.load !12
...
if.then9:                                         ; preds = %if.else7
  %5 = load i32, ptr %__result, align 4, !tbaa !5, !invariant.load !12
  store i32 %0, ptr %__result, align 4, !tbaa !5
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load i32, ptr %__first, align 4, !tbaa !5, !invariant.load !12
  %cmp.i = icmp slt i32 %0, %1
  br i1 %cmp.i, label %if.then2, label %for.inc
