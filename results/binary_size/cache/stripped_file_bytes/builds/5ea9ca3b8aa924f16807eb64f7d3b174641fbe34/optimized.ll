...
for.cond:                                         ; preds = %do.cond, %for.inc33
  %i.0 = phi i32 [ %dec, %for.inc33 ], [ %n.1, %do.cond ]
...
for.cond17.preheader:                             ; preds = %for.cond
  ...
  %smax = call i32 @llvm.smax.i32(i32 undef, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond17
  ...
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %1)
