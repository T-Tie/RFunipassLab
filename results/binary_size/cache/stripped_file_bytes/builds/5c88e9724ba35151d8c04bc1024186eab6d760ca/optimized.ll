...
for.cond11:                                       ; preds = %for.end34, %for.end
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.end34 ], [ 0, %for.end ]
  %num.0 = phi i32 [ %num.1, %for.end34 ], [ 0, %for.end ]
  %exitcond12.not = icmp eq i64 %indvars.iv9, 16
  br i1 %exitcond12.not, label %for.cond38.preheader, label %for.cond14.preheader

for.cond38.preheader:                             ; preds = %for.cond11
  br label %for.cond38

for.cond14.preheader:                             ; preds = %for.cond11
  %arrayidx18 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv9
  %2 = load i32, ptr %arrayidx18, align 4, !tbaa !9
  %cmp19.not = icmp eq i32 %2, 0
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %if.end31
  %indvars.iv5 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next6, %if.end31 ]
  %num.1 = phi i32 [ %num.0, %for.cond14.preheader ], [ %num.2, %if.end31 ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, 16
  br i1 %exitcond8.not, label %for.end34, label %for.body16
...
land.lhs.true:                                    ; preds = %for.body16
  ...
  %or.cond3 = select i1 %cmp22, i1 %cmp28, i1 false
  %inc30 = zext i1 %or.cond3 to i32
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.body40
  %indvars.iv13 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next14, %for.body40 ]
  %exitcond16.not = icmp eq i64 %indvars.iv13, 16
  br i1 %exitcond16.not, label %for.end45, label %for.body40

for.body40:                                       ; preds = %for.cond38
  %arrayidx42 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv13
