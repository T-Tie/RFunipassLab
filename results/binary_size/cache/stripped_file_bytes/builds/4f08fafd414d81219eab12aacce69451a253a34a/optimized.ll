...
entry:
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %0, i32 noundef -1) #5
  %1 = add i32 %smax, 1
...
for.cond1:                                        ; preds = %for.inc5, %for.end
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc5 ], [ %2, %for.end ]
  %cmp2 = icmp sgt i64 %indvars.iv, 0
  br i1 %cmp2, label %for.inc5, label %for.end6

for.inc5:                                         ; preds = %for.cond1
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %arrayidx = getelementptr inbounds [1000 x i32], ptr @num, i64 0, i64 %indvars.iv.next
  %3 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !9
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %3)
