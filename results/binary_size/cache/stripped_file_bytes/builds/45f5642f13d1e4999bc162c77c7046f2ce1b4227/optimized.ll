...
for.body:                                         ; preds = %for.cond
  ...
  %.pre6 = load i32, ptr %c, align 4, !tbaa !5
  %.pre = load i32, ptr %d, align 4, !tbaa !5
  %cmp2 = icmp eq i32 %0, %.pre6
  %or.cond8 = select i1 %cmp1, i1 %cmp2, i1 false
  br i1 %or.cond8, label %land.lhs.true3, label %for.body.for.inc_crit_edge

for.body.for.inc_crit_edge:                       ; preds = %for.body
  %.pre10 = load i32, ptr %e, align 4, !tbaa !5
  br label %for.inc

land.lhs.true3:                                   ; preds = %for.body
  %cmp4 = icmp eq i32 %0, %.pre
  %.pre11 = load i32, ptr %e, align 4, !tbaa !5
  br i1 %cmp4, label %land.lhs.true5, label %for.inc

land.lhs.true5:                                   ; preds = %land.lhs.true3
  %cmp6 = icmp eq i32 %0, %.pre11
...
for.inc:                                          ; preds = %for.body.for.inc_crit_edge, %land.lhs.true7, %land.lhs.true5, %land.lhs.true3
  %4 = phi i32 [ %0, %land.lhs.true7 ], [ %.pre11, %land.lhs.true5 ], [ %.pre11, %land.lhs.true3 ], [ %.pre10, %for.body.for.inc_crit_edge ]
  %5 = phi i32 [ %0, %land.lhs.true7 ], [ %0, %land.lhs.true5 ], [ %0, %land.lhs.true3 ], [ %.pre6, %for.body.for.inc_crit_edge ]
  ...
  %reass.sub4 = sub i32 %4, %1
  %8 = mul i32 %reass.sub4, 60
  %9 = load i32, ptr %f, align 4, !tbaa !5
  %reass.sub9 = sub i32 %7, %5
  %add17 = add i32 %reass.sub9, 43200
