...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %6 = load i64, ptr %_M_width.i11.i, align 8, !tbaa !10, !invariant.load !9
...
for.cond11:                                       ; preds = %for.inc35, %for.end
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc35 ], [ 1, %for.end ]
  %s.0 = phi i64 [ %s.1, %for.inc35 ], [ %call6, %for.end ]
  %7 = load i32, ptr %n, align 4, !tbaa !5
  %8 = sext i32 %7 to i64
  %cmp12 = icmp slt i64 %indvars.iv5, %8
  br i1 %cmp12, label %for.body14, label %for.end37

for.body14:                                       ; preds = %for.cond11
  %arrayidx16 = getelementptr inbounds nuw [20 x i8], ptr %vla, i64 %indvars.iv5
  ...
  %9 = mul nuw nsw i64 %indvars.iv5, 20
