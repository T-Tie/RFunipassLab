...
entry:
  ...
  br i1 %cmp.not17, label %for.end35, label %for.body
...
for.end:                                          ; preds = %for.body
  %arrayidx4.phi.trans.insert = getelementptr inbounds nuw i8, ptr %b, i64 4
  %.pre = load float, ptr %arrayidx4.phi.trans.insert, align 4, !tbaa !12
  %arrayidx5.phi.trans.insert = getelementptr inbounds nuw i8, ptr %a, i64 4
  %.pre25 = load float, ptr %arrayidx5.phi.trans.insert, align 4, !tbaa !12
  %3 = fdiv float %.pre, %.pre25
  %4 = icmp slt i32 %1, 2
  %arrayidx6 = getelementptr inbounds nuw i8, ptr %c, i64 4
  store float %3, ptr %arrayidx6, align 4, !tbaa !12
  br i1 %4, label %for.end35, label %for.body9

for.body9:                                        ; preds = %for.end, %for.body9
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body9 ], [ 2, %for.end ]
  %arrayidx11 = getelementptr inbounds nuw [1000 x float], ptr %b, i64 0, i64 %indvars.iv22
  %5 = load float, ptr %arrayidx11, align 4, !tbaa !12
  %arrayidx13 = getelementptr inbounds nuw [1000 x float], ptr %a, i64 0, i64 %indvars.iv22
  %6 = load float, ptr %arrayidx13, align 4, !tbaa !12
  %div14 = fdiv float %5, %6
  %arrayidx16 = getelementptr inbounds nuw [1000 x float], ptr %c, i64 0, i64 %indvars.iv22
  store float %div14, ptr %arrayidx16, align 4, !tbaa !12
  %7 = load float, ptr %arrayidx6, align 4, !tbaa !12
  %sub = fsub float %div14, %7
  %conv = fpext float %sub to double
  %cmp20 = fcmp ogt double %conv, 5.000000e-02
  %sub25 = fsub float %7, %div14
  ...
  %9 = sext i32 %8 to i64
  %cmp8.not.not = icmp slt i64 %indvars.iv22, %9
  br i1 %cmp8.not.not, label %for.body9, label %for.end35, !llvm.loop !14

for.end35:                                        ; preds = %for.body9, %entry, %for.end
  %10 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i = call i32 @getc(ptr noundef %10)
  %11 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i13 = call i32 @getc(ptr noundef %11)
  %12 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i14 = call i32 @getc(ptr noundef %12)
  %13 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i15 = call i32 @getc(ptr noundef %13)
  %14 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i16 = call i32 @getc(ptr noundef %14)
