...
if.else:                                          ; preds = %tailrecurse
  ...
  %call = tail call noundef range(i32 -2147483646, -2147483648) i32 @_Z1gPiii(ptr nofree noundef nonnull readonly captures(none) %add.ptr, i32 noundef %sub, i32 noundef %0) #9
...
common.ret19:                                     ; preds = %tailrecurse, %if.then2, %if.else10
  %common.ret19.op = phi i32 [ %spec.select.i, %if.else10 ], [ %spec.select, %if.then2 ], [ 0, %tailrecurse ]
