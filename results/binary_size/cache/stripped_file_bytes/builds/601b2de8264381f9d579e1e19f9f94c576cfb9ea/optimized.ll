...
entry:
  ...
  %cmp.not324 = icmp slt i32 %0, 1
  br i1 %cmp.not324, label %for.end397, label %for.body

for.cond6.preheader:                              ; preds = %for.body
  %1 = icmp slt i32 %2, 1
  br i1 %1, label %for.end397, label %for.body8
...
for.body8:                                        ; preds = %for.cond6.preheader, %for.inc395
  %indvars.iv329 = phi i64 [ %indvars.iv.next330, %for.inc395 ], [ 1, %for.cond6.preheader ]
  %arrayidx10 = getelementptr inbounds nuw [200 x i32], ptr %year, i64 0, i64 %indvars.iv329
  ...
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %mon1, i64 0, i64 %indvars.iv329
...
if.end102:                                        ; preds = %if.then, %switch.lookup
  ...
  %arrayidx104 = getelementptr inbounds nuw [200 x i32], ptr %mon2, i64 0, i64 %indvars.iv329
  %10 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %switch.tableidx421 = add i32 %10, -1
  %11 = icmp ult i32 %switch.tableidx421, 12
  br i1 %11, label %switch.lookup420, label %if.end186

switch.lookup420:                                 ; preds = %if.end102
  %12 = zext nneg i32 %switch.tableidx421 to i64
  %switch.gep422 = getelementptr inbounds nuw [12 x i32], ptr @switch.table.main.4, i64 0, i64 %12
  %switch.load423 = load i32, ptr %switch.gep422, align 4
  store i32 %switch.load423, ptr %arrayidx104, align 4, !tbaa !5
  br label %if.end186

if.end186:                                        ; preds = %if.end102, %switch.lookup420
  %13 = phi i32 [ %10, %if.end102 ], [ %switch.load423, %switch.lookup420 ]
...
if.else205:                                       ; preds = %for.body8
  br i1 %7, label %switch.lookup424, label %if.end289

switch.lookup424:                                 ; preds = %if.else205
  %14 = zext nneg i32 %switch.tableidx to i64
  %switch.gep426 = getelementptr inbounds nuw [12 x i32], ptr @switch.table.main.6, i64 0, i64 %14
  %switch.load427 = load i32, ptr %switch.gep426, align 4
  store i32 %switch.load427, ptr %arrayidx21, align 4, !tbaa !5
  br label %if.end289

if.end289:                                        ; preds = %if.else205, %switch.lookup424
  %15 = phi i32 [ %6, %if.else205 ], [ %switch.load427, %switch.lookup424 ]
  %arrayidx291 = getelementptr inbounds nuw [200 x i32], ptr %mon2, i64 0, i64 %indvars.iv329
  %16 = load i32, ptr %arrayidx291, align 4, !tbaa !5
  %switch.tableidx429 = add i32 %16, -1
  %17 = icmp ult i32 %switch.tableidx429, 12
  br i1 %17, label %switch.lookup428, label %if.end373

switch.lookup428:                                 ; preds = %if.end289
  %18 = zext nneg i32 %switch.tableidx429 to i64
  %switch.gep430 = getelementptr inbounds nuw [12 x i32], ptr @switch.table.main.6, i64 0, i64 %18
  %switch.load431 = load i32, ptr %switch.gep430, align 4
  store i32 %switch.load431, ptr %arrayidx291, align 4, !tbaa !5
  br label %if.end373

if.end373:                                        ; preds = %if.end289, %switch.lookup428
  %19 = phi i32 [ %16, %if.end289 ], [ %switch.load431, %switch.lookup428 ]
...
lor.lhs.false381:                                 ; preds = %if.end373
  ...
  %spec.select419 = select i1 %cmp388, ptr @str.3, ptr @str.2
  br label %for.inc395

for.inc395:                                       ; preds = %lor.lhs.false381, %lor.lhs.false193, %if.end373, %if.end186
  %str.2.sink = phi ptr [ @str.3, %if.end186 ], [ @str.3, %if.end373 ], [ %spec.select, %lor.lhs.false193 ], [ %spec.select419, %lor.lhs.false381 ]
  %puts115 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink)
  %indvars.iv.next330 = add nuw nsw i64 %indvars.iv329, 1
  %20 = load i32, ptr %n, align 4, !tbaa !5
  %21 = sext i32 %20 to i64
  %cmp7.not.not = icmp slt i64 %indvars.iv329, %21
  br i1 %cmp7.not.not, label %for.body8, label %for.end397, !llvm.loop !12

for.end397:                                       ; preds = %for.inc395, %entry, %for.cond6.preheader
