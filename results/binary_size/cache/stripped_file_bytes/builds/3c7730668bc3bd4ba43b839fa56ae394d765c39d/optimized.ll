...
for.cond9.preheader:                              ; preds = %if.then
  %5 = sext i32 %4 to i64
  %wide.trip.count44 = sext i32 %3 to i64
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc
  %indvars.iv39 = phi i64 [ %5, %for.cond9.preheader ], [ %indvars.iv.next40, %for.inc ]
  %total.0 = phi i32 [ 0, %for.cond9.preheader ], [ %add, %for.inc ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc82.sink.split, label %for.inc
...
for.cond20.preheader:                             ; preds = %if.else17
  %8 = sext i32 %3 to i64
  %wide.trip.count37 = sext i32 %4 to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc27
  %indvars.iv33 = phi i64 [ %8, %for.cond20.preheader ], [ %indvars.iv.next34, %for.inc27 ]
  %total.1 = phi i32 [ 0, %for.cond20.preheader ], [ %add26, %for.inc27 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38.not, label %for.inc82.sink.split, label %for.inc27
...
for.inc27:                                        ; preds = %for.cond20
  ...
  %10 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !9
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc49
  %indvars.iv27 = phi i64 [ %11, %for.cond42.preheader ], [ %indvars.iv.next28, %for.inc49 ]
  %total.2 = phi i32 [ 0, %for.cond42.preheader ], [ %add48, %for.inc49 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.inc82.sink.split, label %for.inc49

for.inc49:                                        ; preds = %for.cond42
  %12 = add nsw i64 %indvars.iv27, -1
  %arrayidx47 = getelementptr inbounds [12 x i32], ptr @__const.main.t1, i64 0, i64 %12
  %13 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !9
...
for.cond62:                                       ; preds = %for.cond62.preheader, %for.inc69
  %indvars.iv = phi i64 [ %14, %for.cond62.preheader ], [ %indvars.iv.next, %for.inc69 ]
  %total.3 = phi i32 [ 0, %for.cond62.preheader ], [ %add68, %for.inc69 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.inc82.sink.split, label %for.inc69

for.inc69:                                        ; preds = %for.cond62
  %15 = add nsw i64 %indvars.iv, -1
  %arrayidx67 = getelementptr inbounds [12 x i32], ptr @__const.main.t1, i64 0, i64 %15
  %16 = load i32, ptr %arrayidx67, align 4, !tbaa !5, !invariant.load !9
  %add68 = add nsw i32 %16, %total.3
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  br label %for.cond62, !llvm.loop !15

for.inc82.sink.split:                             ; preds = %for.cond62, %for.cond42, %for.cond20, %for.cond9
  %total.3.sink = phi i32 [ %total.0, %for.cond9 ], [ %total.1, %for.cond20 ], [ %total.2, %for.cond42 ], [ %total.3, %for.cond62 ]
  %str.sink = phi ptr [ @str.6, %for.cond9 ], [ @str.4, %for.cond20 ], [ @str.2, %for.cond42 ], [ @str, %for.cond62 ]
  %str.1.sink = phi ptr [ @str.7, %for.cond9 ], [ @str.5, %for.cond20 ], [ @str.3, %for.cond42 ], [ @str.1, %for.cond62 ]
  %rem72 = srem i32 %total.3.sink, 7
  %cmp73 = icmp eq i32 %rem72, 0
  %str.1.str = select i1 %cmp73, ptr %str.1.sink, ptr %str.sink
  %puts21 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #7
  br label %for.inc82
