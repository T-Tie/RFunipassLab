...
for.cond4:                                        ; preds = %for.end24, %for.end
  %.pre2021 = phi i32 [ %.pre2022, %for.end24 ], [ %.pre, %for.end ]
  %2 = phi i32 [ %5, %for.end24 ], [ %.pre, %for.end ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.end24 ], [ 0, %for.end ]
...
for.cond7.preheader:                              ; preds = %for.cond4
  ...
  %3 = add nuw i64 %indvars.iv16, 4294967295
  %4 = and i64 %3, 4294967295
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %if.end21
  %.pre2022 = phi i32 [ %.pre2021, %for.cond7.preheader ], [ %.pre20, %if.end21 ]
  %5 = phi i32 [ %2, %for.cond7.preheader ], [ %.pre20, %if.end21 ]
  %indvars.iv13 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next14, %if.end21 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv13
...
if.end:                                           ; preds = %for.body9
  %cmp15 = icmp eq i64 %indvars.iv13, %4
  br i1 %cmp15, label %if.then16, label %if.end21

if.then16:                                        ; preds = %if.end
  %putchar = call i32 @putchar(i32 noundef 32) #5
  %call20 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6)
  %.pre20.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end21

if.end21:                                         ; preds = %if.then16, %if.end
  %.pre20 = phi i32 [ %.pre20.pre, %if.then16 ], [ %.pre2022, %if.end ]
