...
for.cond14:                                       ; preds = %for.cond10.preheader, %if.end34
  ...
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %if.end34 ], [ 0, %for.cond10.preheader ]
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %st, i64 0, i64 %indvars.iv.next28
...
if.then23:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [10000 x i32], ptr %st, i64 0, i64 %indvars.iv27
