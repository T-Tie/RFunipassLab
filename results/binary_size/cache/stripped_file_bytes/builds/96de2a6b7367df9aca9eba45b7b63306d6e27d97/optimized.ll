...
for.cond1:                                        ; preds = %for.cond, %for.inc11
  ...
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc11 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv68
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc176
  %indvars.iv125 = phi i64 [ %6, %for.cond14.preheader ], [ %indvars.iv.next126, %for.inc176 ]
  %indvars.iv122 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next123, %for.inc176 ]
  %sum.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.inc176 ]
  %min.1 = phi i32 [ %min.0, %for.cond14.preheader ], [ %min.5, %for.inc176 ]
  %9 = trunc nuw i64 %indvars.iv125 to i32
  %cmp15 = icmp sgt i32 %9, 1
  br i1 %cmp15, label %for.cond17, label %for.inc180

for.cond17:                                       ; preds = %for.cond14, %for.inc61
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc61 ], [ 0, %for.cond14 ]
  %min.2 = phi i32 [ %min.3, %for.inc61 ], [ %min.1, %for.cond14 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %indvars.iv125
  br i1 %exitcond83.not, label %for.cond64, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond17
  %10 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv79
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.body22
  %indvars.iv71 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next72, %for.body22 ]
...
for.body22:                                       ; preds = %for.cond20
  %cmp23 = icmp eq i64 %indvars.iv71, 0
  %11 = getelementptr inbounds nuw i32, ptr %10, i64 %indvars.iv71
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc58
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc58 ], [ 0, %for.cond45.preheader ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %indvars.iv125
  br i1 %exitcond78.not, label %for.inc61, label %for.inc58

for.inc58:                                        ; preds = %for.cond45
  %add.ptr52 = getelementptr inbounds nuw i32, ptr %10, i64 %indvars.iv74
...
for.cond64:                                       ; preds = %for.cond17, %for.inc112
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc112 ], [ 0, %for.cond17 ]
  %min.5 = phi i32 [ %min.6, %for.inc112 ], [ %min.2, %for.cond17 ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %indvars.iv125
  br i1 %exitcond98.not, label %for.cond118.preheader, label %for.cond67.preheader
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv84 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next85, %for.body69 ]
  %min.6 = phi i32 [ %min.5, %for.cond67.preheader ], [ %min.7, %for.body69 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %indvars.iv125
  br i1 %exitcond88.not, label %for.cond95.preheader, label %for.body69

for.cond95.preheader:                             ; preds = %for.cond67
  br label %for.cond95

for.body69:                                       ; preds = %for.cond67
  %cmp70 = icmp eq i64 %indvars.iv84, 0
  ...
  %spec.select62 = call i32 @llvm.smin.i32(i32 %14, i32 %min.6)
  %min.7 = select i1 %cmp70, i32 %14, i32 %spec.select62
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  br label %for.cond67, !llvm.loop !17

for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc109
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc109 ], [ 0, %for.cond95.preheader ]
...
for.inc109:                                       ; preds = %for.cond95
  %gep64 = getelementptr inbounds nuw [100 x i32], ptr %invariant.gep, i64 %indvars.iv89
  %15 = load i32, ptr %gep64, align 4, !tbaa !5, !invariant.load !13
  %sub103 = sub nsw i32 %15, %min.6
  store i32 %sub103, ptr %gep64, align 4, !tbaa !5
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc131
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc131 ], [ 1, %for.cond118.preheader ]
  %exitcond106.not = icmp eq i64 %indvars.iv99, %indvars.iv122
  br i1 %exitcond106.not, label %for.cond134, label %for.inc131

for.inc131:                                       ; preds = %for.cond118
  %add.ptr125 = getelementptr inbounds nuw i32, ptr %a, i64 %indvars.iv99
...
for.cond134:                                      ; preds = %for.cond118, %for.inc147
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc147 ], [ 1, %for.cond118 ]
  %exitcond111.not = icmp eq i64 %indvars.iv107, %indvars.iv122
  br i1 %exitcond111.not, label %for.cond150, label %for.inc147

for.inc147:                                       ; preds = %for.cond134
  %add.ptr139 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv107
...
for.cond150:                                      ; preds = %for.cond134, %for.inc173
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.inc173 ], [ 1, %for.cond134 ]
  %exitcond121.not = icmp eq i64 %indvars.iv117, %indvars.iv122
  br i1 %exitcond121.not, label %for.inc176, label %for.cond154.preheader

for.cond154.preheader:                            ; preds = %for.cond150
  %add.ptr159 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv117
  %invariant.gep65 = getelementptr inbounds nuw i8, ptr %add.ptr159, i64 404
  br label %for.cond154

for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc170
  %indvars.iv112 = phi i64 [ 1, %for.cond154.preheader ], [ %indvars.iv.next113, %for.inc170 ]
  %exitcond116.not = icmp eq i64 %indvars.iv112, %indvars.iv122
  br i1 %exitcond116.not, label %for.inc173, label %for.inc170

for.inc170:                                       ; preds = %for.cond154
  %gep66 = getelementptr inbounds nuw i32, ptr %invariant.gep65, i64 %indvars.iv112
  %18 = load i32, ptr %gep66, align 4, !tbaa !5, !invariant.load !13
  %add.ptr169 = getelementptr inbounds nuw i32, ptr %add.ptr159, i64 %indvars.iv112
