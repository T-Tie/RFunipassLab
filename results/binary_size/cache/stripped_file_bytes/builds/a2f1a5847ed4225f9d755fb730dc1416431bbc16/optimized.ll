...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc8 ], [ 1, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv8, %1
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc27 ], [ 1, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv14, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %10 = add nuw i32 %smax23, 1
  %smax29 = call i32 @llvm.smax.i32(i32 %6, i32 0)
  %11 = add nuw i32 %smax29, 1
  %wide.trip.count30 = zext i32 %11 to i64
  %wide.trip.count24 = zext i32 %10 to i64
  %wide.trip.count = zext i32 %9 to i64
  br label %for.cond30

for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc24 ], [ 1, %for.cond13 ]
  %12 = load i32, ptr %y2, align 4, !tbaa !5
  %13 = sext i32 %12 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv11, %13
  br i1 %cmp17.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv14, i64 %indvars.iv11
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc65
  %indvars.iv26 = phi i64 [ 1, %for.cond30.preheader ], [ %indvars.iv.next27, %for.inc65 ]
  %exitcond31 = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31, label %for.cond68, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc62
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc62 ], [ 1, %for.cond30 ]
  %exitcond25 = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25, label %for.inc65, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv26, i64 %indvars.iv20
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.inc59, %for.body35
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc59 ], [ 1, %for.body35 ]
  %exitcond = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond40
  %arrayidx46 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv17
  %14 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !15
  %arrayidx50 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv17, i64 %indvars.iv20
...
for.cond68:                                       ; preds = %for.cond30, %for.inc90
  ...
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc90 ], [ 1, %for.cond30 ]
  %18 = sext i32 %17 to i64
  %cmp69.not = icmp sgt i64 %indvars.iv35, %18
  br i1 %cmp69.not, label %for.end92, label %for.cond71

for.cond71:                                       ; preds = %for.cond68, %for.inc87
  %19 = phi i32 [ %.pre38, %for.inc87 ], [ %16, %for.cond68 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc87 ], [ 1, %for.cond68 ]
  %20 = sext i32 %19 to i64
  %cmp72.not = icmp sgt i64 %indvars.iv32, %20
  br i1 %cmp72.not, label %for.inc90, label %for.body73

for.body73:                                       ; preds = %for.cond71
  %21 = zext i32 %19 to i64
  %cmp74.not = icmp eq i64 %indvars.iv32, %21
  %22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv35, i64 %indvars.iv32
