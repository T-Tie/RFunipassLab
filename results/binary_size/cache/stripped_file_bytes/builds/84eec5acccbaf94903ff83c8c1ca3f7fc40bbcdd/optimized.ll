...
for.cond31:                                       ; preds = %for.inc58, %if.then
...
for.cond34:                                       ; preds = %for.inc55, %for.body33
...
if.end:                                           ; preds = %for.end60, %for.end29
  store i32 0, ptr %n, align 4, !tbaa !5
  br label %for.cond61

for.cond61:                                       ; preds = %for.inc85, %if.end
...
for.body66:                                       ; preds = %for.cond64
  %40 = load i32, ptr %z, align 4, !tbaa !5
  %41 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = sub nsw i32 %41, 1
  %cmp67 = icmp eq i32 %40, %sub
...
if.then68:                                        ; preds = %for.body66
  ...
  %43 = load i32, ptr %z, align 4, !tbaa !5
  ...
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %44)
...
if.else:                                          ; preds = %for.body66
  ...
  %46 = load i32, ptr %z, align 4, !tbaa !5
  ...
  %call79 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %47)
...
for.inc82:                                        ; preds = %if.end81
  %48 = load i32, ptr %z, align 4, !tbaa !5
  %inc83 = add nsw i32 %48, 1
  store i32 %inc83, ptr %z, align 4, !tbaa !5
...
for.inc85:                                        ; preds = %for.end84
  ...
  store i32 %inc86, ptr %n, align 4, !tbaa !5
