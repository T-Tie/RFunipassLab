...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr nonnull %words) #5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %exitcond.not = icmp eq i64 %indvars.iv, 100
  br i1 %exitcond.not, label %cleanup, label %if.else34.i
...
for.inc:                                          ; preds = %if.else34.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

cleanup:                                          ; preds = %if.else34.i, %for.cond
  %1 = and i64 %indvars.iv, 4294967295
  br label %for.cond5

for.cond5:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %cleanup
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %1, %cleanup ]
  %cmp6 = icmp sgt i64 %indvars.iv25, 0
  br i1 %cmp6, label %for.body8, label %for.cond.cleanup7

for.cond.cleanup7:                                ; preds = %for.cond5
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #5
  ...
  call void @llvm.lifetime.end.p0(i64 10000, ptr nonnull %words) #5
  ret i32 0

for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %words, i64 0, i64 %indvars.iv25
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx10) #5
  %call1.i11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx10, i64 noundef %call.i.i10)
  ...
  %gep23 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i18
  %2 = load i64, ptr %gep23, align 8, !tbaa !16
