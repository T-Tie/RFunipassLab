...
for.cond:                                         ; preds = %entry, %for.inc
  ...
  %conv11 = uitofp nneg i32 %1 to float
...
for.cond31:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc57 ], [ 0, %for.cond ]
  %3 = trunc nuw nsw i64 %indvars.iv22 to i32
  %conv32 = uitofp nneg i32 %3 to float
  %cmp33 = fcmp olt float %conv32, %conv9
  br i1 %cmp33, label %for.body34, label %for.cond60

for.body34:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [505 x i8], ptr %y, i64 0, i64 %indvars.iv22
...
for.cond60:                                       ; preds = %for.cond31, %for.body63
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body63 ], [ 0, %for.cond31 ]
  %count.0 = phi float [ %count.1, %for.body63 ], [ 0.000000e+00, %for.cond31 ]
  %5 = trunc nuw nsw i64 %indvars.iv25 to i32
  %conv61 = uitofp nneg i32 %5 to float
  %cmp62 = fcmp olt float %conv61, %conv
  br i1 %cmp62, label %for.body63, label %for.end76

for.body63:                                       ; preds = %for.cond60
  %arrayidx65 = getelementptr inbounds nuw [505 x i8], ptr %x, i64 0, i64 %indvars.iv25
  %6 = load i8, ptr %arrayidx65, align 1, !tbaa !10
  %arrayidx68 = getelementptr inbounds nuw [505 x i8], ptr %y, i64 0, i64 %indvars.iv25
  %7 = load i8, ptr %arrayidx68, align 1, !tbaa !10
  %cmp70 = icmp eq i8 %6, %7
