...
while.cond.outer:                                 ; preds = %if.end16, %entry
  ...
  %call17 = tail call i32 @getchar() #6
  %cmp4.not = icmp eq i32 %count.0.ph, 0
  br label %while.cond

while.cond:                                       ; preds = %while.cond.outer, %if.then5
  %c.0.in = phi i32 [ %call6, %if.then5 ], [ %call17, %while.cond.outer ]
...
if.then:                                          ; preds = %while.cond
  br i1 %cmp4.not, label %if.then9, label %if.then5

if.then5:                                         ; preds = %if.then
  %call6 = tail call i32 @getchar() #8
