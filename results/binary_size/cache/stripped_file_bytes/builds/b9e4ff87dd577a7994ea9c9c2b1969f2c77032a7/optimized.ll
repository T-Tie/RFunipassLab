...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %words) #10
...
while.cond:                                       ; preds = %if.end22, %entry
  %sum.0 = phi i32 [ 0, %entry ], [ %sum.1, %if.end22 ]
  %temp.0 = phi i32 [ 0, %entry ], [ %.sink, %if.end22 ]
  %0 = phi i32 [ %.pr, %entry ], [ %dec, %if.end22 ]
...
if.then6.i:                                       ; preds = %while.cond
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(50) %words, i64 noundef 50)
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  %_M_width.i6.i = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %1 = load i64, ptr %_M_width.i6.i, align 8, !tbaa !10, !invariant.load !9
  %2 = add i64 %1, -51
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #12
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %cmp5 = icmp eq i32 %temp.0, 0
  br i1 %cmp5, label %if.then6, label %if.else

if.then6:                                         ; preds = %if.then
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(50) %words)
  br label %if.end22
...
if.else:                                          ; preds = %if.then
  ...
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef nonnull align 16 dereferenceable(50) %words)
  %add14 = add nsw i32 %add, 1
  %inc15 = add nsw i32 %temp.0, 1
  br label %if.end22

if.else16:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call17, ptr noundef nonnull align 16 dereferenceable(50) %words)
...
if.end22:                                         ; preds = %if.then6, %if.else, %if.else16
  %sum.1 = phi i32 [ %add, %if.then6 ], [ %add14, %if.else ], [ %add21, %if.else16 ]
  %.sink = phi i32 [ 1, %if.then6 ], [ %inc15, %if.else ], [ 0, %if.else16 ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %dec = add nsw i32 %3, -1
  store i32 %dec, ptr %n, align 4, !tbaa !5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(50) %words, i8 noundef 0, i64 noundef 50, i1 noundef false)
  br label %while.cond, !llvm.loop !21

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #11
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %words) #11
  ret i32 0
}
