...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.end110
  %indvars.iv65 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next66, %for.end110 ]
  %indvars.iv43 = phi i32 [ %sub, %for.cond13.preheader ], [ %indvars.iv.next44, %for.end110 ]
  %indvars.iv22 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next23, %for.end110 ]
  %m.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.end110 ]
  ...
  br i1 %exitcond71.not, label %for.cond.cleanup15, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.end34
  %indvars.iv24 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next25, %for.end34 ]
...
for.body20:                                       ; preds = %for.cond17
  ...
  %6 = load i32, ptr %arrayidx.i, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond.i
...
for.body.i:                                       ; preds = %for.cond.i
  ...
  %7 = load i32, ptr %arrayidx6.i, align 4, !tbaa !5, !invariant.load !14
  %spec.select.i = call i32 @llvm.smin.i32(i32 %t.0.i, i32 %7)
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  br label %for.cond.i, !llvm.loop !15

for.cond23:                                       ; preds = %for.cond23.preheader, %for.body26
  %indvars.iv18 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next19, %for.body26 ]
  %exitcond.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond.not, label %for.end34, label %for.body26
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.end56
  %indvars.iv34 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next35, %for.end56 ]
...
for.body41:                                       ; preds = %for.cond38
  ...
  %9 = load i32, ptr %arrayidx15.i, align 4, !tbaa !5, !invariant.load !14
...
for.body19.i:                                     ; preds = %for.cond16.i
  ...
  %10 = load i32, ptr %arrayidx23.i, align 4, !tbaa !5, !invariant.load !14
  %spec.select3.i = call i32 @llvm.smin.i32(i32 %t.3.i, i32 %10)
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond16.i, !llvm.loop !18

for.cond45:                                       ; preds = %for.cond45.preheader, %for.body48
  %indvars.iv29 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next30, %for.body48 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count32
  br i1 %exitcond33.not, label %for.end56, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv34
  %11 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !14
...
for.cond62:                                       ; preds = %for.end82, %for.end59
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.end82 ], [ 0, %for.end59 ]
...
for.cond66:                                       ; preds = %for.cond62, %for.body70
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body70 ], [ 1, %for.cond62 ]
  %exitcond47.not = icmp eq i64 %indvars.iv40, %wide.trip.count46
  br i1 %exitcond47.not, label %for.end82, label %for.body70
...
for.body70:                                       ; preds = %for.cond66
  ...
  %13 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !14
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.end107
  %indvars.iv59 = phi i64 [ 0, %for.cond86.preheader ], [ %indvars.iv.next60, %for.end107 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count63
  br i1 %exitcond64.not, label %for.end110, label %for.cond91

for.cond91:                                       ; preds = %for.cond86, %for.body95
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.body95 ], [ 1, %for.cond86 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count57
  br i1 %exitcond58.not, label %for.end107, label %for.body95
...
for.body95:                                       ; preds = %for.cond91
  ...
  %14 = load i32, ptr %arrayidx100, align 4, !tbaa !5, !invariant.load !14
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !14
...
if.else:                                          ; preds = %entry
  ...
  %2 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond16
...
for.body19:                                       ; preds = %for.cond16
  ...
  %3 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !14
