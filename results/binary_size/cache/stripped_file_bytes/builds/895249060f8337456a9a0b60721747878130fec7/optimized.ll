...
for.cond8:                                        ; preds = %for.cond1.preheader, %for.body11
  ...
  br i1 %exitcond, label %for.cond.cleanup10, label %for.body11
...
for.body11:                                       ; preds = %for.cond8
  ...
  %4 = load i32, ptr %add.ptr16, align 4, !tbaa !5, !invariant.load !12
  %sub = add nsw i32 %4, -1000
...
for.cond29:                                       ; preds = %for.cond
  ...
  tail call void @llvm.assume(i1 noundef %cmp.i7.not)
  ret void
}
...
for.cond1:                                        ; preds = %for.cond.cleanup7, %for.body
  ...
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.cond.cleanup7 ], [ 1, %for.body ]
...
for.cond5.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [200 x i32], ptr @a, i64 %indvars.iv29
  br label %for.cond5
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %cmp.i9 = icmp sgt i32 %2, 0
  br i1 %cmp.i9, label %for.body8, label %for.cond.cleanup7
