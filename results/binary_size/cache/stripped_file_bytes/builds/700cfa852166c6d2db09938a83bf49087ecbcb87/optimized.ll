...
for.cond7:                                        ; preds = %for.inc26, %for.end
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc26 ], [ 0, %for.end ]
  ...
  br i1 %exitcond10.not, label %for.cond30, label %for.body11

for.body11:                                       ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [101 x i8], ptr %input, i64 0, i64 %indvars.iv6
