...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 captures(none) dereferenceable(2000) %b) #9
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end15, %if.then.i.i
  ...
  %smax12 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.inc23:                                        ; preds = %for.cond17
  ...
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4) #10
...
for.end25:                                        ; preds = %for.cond17
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5) #10
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull captures(none) %b) #10
...
while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div23, %if.end ], [ %dec, %while.body ]
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %cmp.i1 = icmp sgt i64 %__holeIndex.addr.0.i, %__holeIndex
