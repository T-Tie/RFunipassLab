...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  br i1 %cmp11, label %for.cond14, label %for.end57
...
for.cond14:                                       ; preds = %for.cond10.preheader, %if.end34
  ...
  %arrayidx21 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv.next27
...
if.then23:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv26
...
for.end57:                                        ; preds = %for.cond10.preheader
