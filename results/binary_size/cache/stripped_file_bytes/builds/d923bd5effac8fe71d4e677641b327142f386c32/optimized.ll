...
for.cond:                                         ; preds = %for.inc184, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc11.i19, %for.inc184 ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv97 = phi i64 [ %indvars.iv.next98, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv97, %2
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv97, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc179
  %indvars.iv106 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next107, %for.inc179 ]
  %indvars.iv100 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next101, %for.inc179 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add178, %for.inc179 ]
  %exitcond141.not = icmp eq i64 %indvars.iv106, %wide.trip.count140
  br i1 %exitcond141.not, label %for.inc184, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc23
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.inc23 ], [ %indvars.iv100, %for.cond13 ]
  %Min.0 = phi i32 [ %.sroa.speculated48, %for.inc23 ], [ 10000, %for.cond13 ]
  %exitcond.not = icmp eq i64 %indvars.iv102, %wide.trip.count
  br i1 %exitcond.not, label %for.end25, label %for.inc23

for.inc23:                                        ; preds = %for.cond16
  %indvars.iv.next103 = add nuw nsw i64 %indvars.iv102, 1
  %arrayidx21 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx19, i64 0, i64 %indvars.iv.next103
...
for.cond30:                                       ; preds = %for.inc39, %for.end25
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.inc39 ], [ %indvars.iv106, %for.end25 ]
  %8 = trunc nuw i64 %indvars.iv108 to i32
  %cmp31.not = icmp slt i32 %1, %8
  br i1 %cmp31.not, label %for.end41, label %for.inc39

for.inc39:                                        ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx19, i64 0, i64 %indvars.iv108
  %9 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !12
  %sub = sub nsw i32 %9, %.sroa.speculated45
...
for.cond48:                                       ; preds = %for.inc90, %for.end41
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.inc90 ], [ %indvars.iv106, %for.end41 ]
  %10 = trunc nuw i64 %indvars.iv117 to i32
  %cmp49.not = icmp slt i32 %1, %10
  br i1 %cmp49.not, label %for.cond94, label %for.cond52

for.cond52:                                       ; preds = %for.cond48, %for.inc60
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.inc60 ], [ %indvars.iv106, %for.cond48 ]
  %Min.1 = phi i32 [ %.sroa.speculated42, %for.inc60 ], [ 10000, %for.cond48 ]
  %11 = trunc nuw i64 %indvars.iv111 to i32
  %cmp53.not = icmp slt i32 %1, %11
  br i1 %cmp53.not, label %for.end62, label %for.inc60

for.inc60:                                        ; preds = %for.cond52
  %arrayidx58 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv117, i64 %indvars.iv111
  %12 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !12
  %.sroa.speculated42 = call i32 @llvm.smin.i32(i32 %12, i32 %Min.1)
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1
  br label %for.cond52

for.end62:                                        ; preds = %for.cond52
  %arrayidx65 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv117, i64 1
  %13 = load i32, ptr %arrayidx65, align 4, !tbaa !5, !invariant.load !12
  %.sroa.speculated39 = call i32 @llvm.smin.i32(i32 %13, i32 %Min.1)
  br label %for.cond68

for.cond68:                                       ; preds = %for.inc80, %for.end62
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc80 ], [ %indvars.iv106, %for.end62 ]
  %14 = trunc nuw i64 %indvars.iv114 to i32
  %cmp69.not = icmp slt i32 %1, %14
  br i1 %cmp69.not, label %for.inc90, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv117, i64 %indvars.iv114
  %15 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !12
  %sub75 = sub nsw i32 %15, %.sroa.speculated39
  store i32 %sub75, ptr %arrayidx74, align 4, !tbaa !5
  %indvars.iv.next115 = add nuw nsw i64 %indvars.iv114, 1
  br label %for.cond68

for.inc90:                                        ; preds = %for.cond68
  %sub86 = sub nsw i32 %13, %.sroa.speculated39
  store i32 %sub86, ptr %arrayidx65, align 4, !tbaa !5
  %indvars.iv.next118 = add nuw nsw i64 %indvars.iv117, 1
  br label %for.cond48

for.cond94:                                       ; preds = %for.cond48, %for.inc101
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.inc101 ], [ %indvars.iv106, %for.cond48 ]
  %Min.2 = phi i32 [ %.sroa.speculated36, %for.inc101 ], [ 10000, %for.cond48 ]
  %16 = trunc nuw i64 %indvars.iv120 to i32
  %cmp95.not = icmp slt i32 %1, %16
  br i1 %cmp95.not, label %for.end103, label %for.inc101

for.inc101:                                       ; preds = %for.cond94
  %arrayidx99 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv120, i64 1
  %17 = load i32, ptr %arrayidx99, align 4, !tbaa !5, !invariant.load !12
  %.sroa.speculated36 = call i32 @llvm.smin.i32(i32 %17, i32 %Min.2)
...
for.cond108:                                      ; preds = %for.inc118, %for.end103
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %for.inc118 ], [ %indvars.iv106, %for.end103 ]
  %18 = trunc nuw i64 %indvars.iv123 to i32
  %cmp109.not = icmp slt i32 %1, %18
  br i1 %cmp109.not, label %for.end120, label %for.inc118

for.inc118:                                       ; preds = %for.cond108
  %arrayidx113 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv123, i64 1
  %19 = load i32, ptr %arrayidx113, align 4, !tbaa !5, !invariant.load !12
  %sub114 = sub nsw i32 %19, %.sroa.speculated33
...
for.cond127:                                      ; preds = %for.inc169, %for.end120
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %for.inc169 ], [ %indvars.iv106, %for.end120 ]
  %20 = trunc nuw i64 %indvars.iv135 to i32
  %cmp128.not = icmp slt i32 %1, %20
  br i1 %cmp128.not, label %for.inc179, label %for.cond131

for.cond131:                                      ; preds = %for.cond127, %for.inc139
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.inc139 ], [ %indvars.iv106, %for.cond127 ]
  %Min.3 = phi i32 [ %.sroa.speculated30, %for.inc139 ], [ 10000, %for.cond127 ]
  %21 = trunc nuw i64 %indvars.iv126 to i32
  %cmp132.not = icmp slt i32 %1, %21
  br i1 %cmp132.not, label %for.end141, label %for.inc139

for.inc139:                                       ; preds = %for.cond131
  %arrayidx137 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv126, i64 %indvars.iv135
  %22 = load i32, ptr %arrayidx137, align 4, !tbaa !5, !invariant.load !12
  %.sroa.speculated30 = call i32 @llvm.smin.i32(i32 %22, i32 %Min.3)
  %indvars.iv.next127 = add nuw nsw i64 %indvars.iv126, 1
  br label %for.cond131, !llvm.loop !17

for.end141:                                       ; preds = %for.cond131
  %arrayidx144 = getelementptr inbounds nuw [111 x i32], ptr %arrayidx19, i64 0, i64 %indvars.iv135
  %23 = load i32, ptr %arrayidx144, align 4, !tbaa !5, !invariant.load !12
  %.sroa.speculated = call i32 @llvm.smin.i32(i32 %23, i32 %Min.3)
  br label %for.cond147

for.cond147:                                      ; preds = %for.inc159, %for.end141
  %indvars.iv129 = phi i64 [ %indvars.iv.next130, %for.inc159 ], [ %indvars.iv100, %for.end141 ]
  %exitcond134.not = icmp eq i64 %indvars.iv129, %wide.trip.count
  br i1 %exitcond134.not, label %for.inc169, label %for.inc159

for.inc159:                                       ; preds = %for.cond147
  %indvars.iv.next130 = add nuw nsw i64 %indvars.iv129, 1
  %arrayidx153 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next130, i64 %indvars.iv135
  %24 = load i32, ptr %arrayidx153, align 4, !tbaa !5
  %sub154 = sub nsw i32 %24, %.sroa.speculated
...
for.inc179:                                       ; preds = %for.cond127
  ...
  %arrayidx177 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv.next101, i64 %indvars.iv.next101
  %25 = load i32, ptr %arrayidx177, align 4, !tbaa !5, !invariant.load !12
  %add178 = add nsw i32 %25, %sum.0
...
for.inc184:                                       ; preds = %for.cond13
  ...
  %inc11.i19 = add nuw nsw i32 %i.0, 1
  br label %for.cond
