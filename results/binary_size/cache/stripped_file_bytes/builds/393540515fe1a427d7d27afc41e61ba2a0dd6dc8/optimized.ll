...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull dereferenceable(40000) %a) #9
...
while.cond9.preheader:                            ; preds = %while.cond
  ...
  %.pre25 = load i32, ptr %arrayidx11.phi.trans.insert, align 4, !tbaa !5, !invariant.load !9
  br label %while.cond9

while.cond9:                                      ; preds = %while.cond9.preheader, %if.end
  %7 = phi i32 [ %.pre25, %while.cond9.preheader ], [ %8, %if.end ]
  %indvars.iv22 = phi i64 [ %6, %while.cond9.preheader ], [ %indvars.iv.next23, %if.end ]
...
while.body14:                                     ; preds = %while.cond9
  ...
  %arrayidx20 = getelementptr inbounds [1000 x i32], ptr %len, i64 0, i64 %indvars.iv.next23
  ...
  %cmp24 = icmp slt i64 %indvars.iv22, %10
  %cmp27 = and i1 %cmp22, %cmp24
  %arrayidx29 = getelementptr inbounds [1000 x [40 x i8]], ptr %a, i64 0, i64 %indvars.iv22
...
while.end:                                        ; preds = %while.cond9
  %11 = trunc nsw i64 %indvars.iv22 to i32
