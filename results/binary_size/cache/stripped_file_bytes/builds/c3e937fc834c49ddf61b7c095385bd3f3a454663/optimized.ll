...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %a) #3
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %b) #3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %b) #4
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %a) #4
  ret i32 0
}
