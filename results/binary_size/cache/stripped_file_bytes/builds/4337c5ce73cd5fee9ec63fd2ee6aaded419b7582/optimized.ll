...
entry:
  ...
  %2 = icmp sgt i32 %1, 0
  %or.cond98 = select i1 %cmp35, i1 %2, i1 false
  br i1 %or.cond98, label %for.cond2.preheader, label %for.end10

for.cond2.preheader:                              ; preds = %entry, %for.inc8
  %3 = phi i32 [ %7, %for.inc8 ], [ %0, %entry ]
  %4 = phi i32 [ %8, %for.inc8 ], [ %1, %entry ]
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc8 ], [ 0, %entry ]
...
for.body4:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv64, i64 %indvars.iv
...
for.inc8:                                         ; preds = %for.inc8.loopexit, %for.cond2.preheader
  ...
  %9 = sext i32 %7 to i64
  %cmp = icmp slt i64 %indvars.iv.next65, %9
...
for.end10:                                        ; preds = %for.inc8, %entry
  ...
  %or.cond100 = select i1 %cmp1439, i1 %12, i1 false
  br i1 %or.cond100, label %for.cond16.preheader, label %for.cond30.preheader

for.cond16.preheader:                             ; preds = %for.end10, %for.inc27
  %13 = phi i32 [ %44, %for.inc27 ], [ %10, %for.end10 ]
  %14 = phi i32 [ %45, %for.inc27 ], [ %11, %for.end10 ]
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc27 ], [ 0, %for.end10 ]
...
for.cond30.preheader:                             ; preds = %for.inc27, %for.end10
  ...
  %cmp3145 = icmp sgt i32 %15, 0
  br i1 %cmp3145, label %for.cond33.preheader.lr.ph, label %for.end88

for.cond33.preheader.lr.ph:                       ; preds = %for.cond30.preheader
  %16 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp3443 = icmp sgt i32 %16, 0
  %17 = load i32, ptr %y1, align 4
  %cmp3741 = icmp sgt i32 %17, 0
  %or.cond = select i1 %cmp3443, i1 %cmp3741, i1 false
  br i1 %or.cond, label %for.cond33.preheader.us.us.preheader, label %for.cond67.preheader.preheader

for.cond67.preheader.preheader:                   ; preds = %for.cond33.for.inc61_crit_edge.split.us.us.us, %for.cond33.preheader.lr.ph
...
for.cond33.preheader.us.us.preheader:             ; preds = %for.cond33.preheader.lr.ph
  ...
  %wide.trip.count79 = zext nneg i32 %16 to i64
...
for.cond33.preheader.us.us:                       ; preds = %for.cond33.preheader.us.us.preheader, %for.cond33.for.inc61_crit_edge.split.us.us.us
  %indvars.iv81 = phi i64 [ 0, %for.cond33.preheader.us.us.preheader ], [ %indvars.iv.next82, %for.cond33.for.inc61_crit_edge.split.us.us.us ]
...
for.cond36.preheader.us.us.us:                    ; preds = %for.cond36.for.inc58_crit_edge.us.us.us, %for.cond33.preheader.us.us
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.cond36.for.inc58_crit_edge.us.us.us ], [ 0, %for.cond33.preheader.us.us ]
  %arrayidx42.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr @c, i64 0, i64 %indvars.iv81, i64 %indvars.iv76
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv81, i64 %index
  %wide.load = load <4 x i32>, ptr %22, align 16, !tbaa !5
  %23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @b, i64 0, i64 %index, i64 %indvars.iv76
  %24 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @b, i64 0, i64 %19, i64 %indvars.iv76
  %25 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @b, i64 0, i64 %20, i64 %indvars.iv76
  %26 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @b, i64 0, i64 %21, i64 %indvars.iv76
...
for.body38.us.us.us.preheader:                    ; preds = %for.cond36.preheader.us.us.us, %middle.block
  %indvars.iv73.ph = phi i64 [ 0, %for.cond36.preheader.us.us.us ], [ %n.vec, %middle.block ]
  %.ph = phi i32 [ %arrayidx42.promoted.us.us.us, %for.cond36.preheader.us.us.us ], [ %38, %middle.block ]
  br label %for.body38.us.us.us

for.body38.us.us.us:                              ; preds = %for.body38.us.us.us.preheader, %for.body38.us.us.us
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body38.us.us.us ], [ %indvars.iv73.ph, %for.body38.us.us.us.preheader ]
  %39 = phi i32 [ %add.us.us.us, %for.body38.us.us.us ], [ %.ph, %for.body38.us.us.us.preheader ]
  %arrayidx46.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv81, i64 %indvars.iv73
  %40 = load i32, ptr %arrayidx46.us.us.us, align 4, !tbaa !5
  %arrayidx50.us.us.us = getelementptr inbounds nuw [100 x [100 x i32]], ptr @b, i64 0, i64 %indvars.iv73, i64 %indvars.iv76
...
for.cond36.for.inc58_crit_edge.us.us.us:          ; preds = %for.body38.us.us.us, %middle.block
  ...
  br i1 %exitcond80.not, label %for.cond33.for.inc61_crit_edge.split.us.us.us, label %for.cond36.preheader.us.us.us, !llvm.loop !18

for.cond33.for.inc61_crit_edge.split.us.us.us:    ; preds = %for.cond36.for.inc58_crit_edge.us.us.us
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %exitcond85.not = icmp eq i64 %indvars.iv.next82, %wide.trip.count84
  br i1 %exitcond85.not, label %for.cond67.preheader.preheader, label %for.cond33.preheader.us.us, !llvm.loop !19

for.body18:                                       ; preds = %for.cond16.preheader, %for.body18
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.body18 ], [ 0, %for.cond16.preheader ]
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @b, i64 0, i64 %indvars.iv70, i64 %indvars.iv67
  ...
  %cmp17 = icmp slt i64 %indvars.iv.next68, %43
  br i1 %cmp17, label %for.body18, label %for.inc27.loopexit, !llvm.loop !20

for.inc27.loopexit:                               ; preds = %for.body18
  %.pre92 = load i32, ptr %x2, align 4, !tbaa !5
  br label %for.inc27

for.inc27:                                        ; preds = %for.inc27.loopexit, %for.cond16.preheader
  %44 = phi i32 [ %.pre92, %for.inc27.loopexit ], [ %13, %for.cond16.preheader ]
  %45 = phi i32 [ %42, %for.inc27.loopexit ], [ %14, %for.cond16.preheader ]
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  %46 = sext i32 %44 to i64
  %cmp14 = icmp slt i64 %indvars.iv.next71, %46
  br i1 %cmp14, label %for.cond16.preheader, label %for.cond30.preheader, !llvm.loop !21

for.cond67.preheader:                             ; preds = %for.cond67.preheader.preheader, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 0, %for.cond67.preheader.preheader ]
  %47 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp6854 = icmp sgt i32 %47, 1
  br i1 %cmp6854, label %for.body69, label %for.cond67.preheader.for.end78_crit_edge

for.cond67.preheader.for.end78_crit_edge:         ; preds = %for.cond67.preheader
  %sub53 = add nsw i32 %47, -1
  %.pre93 = sext i32 %sub53 to i64
  br label %for.end78

for.body69:                                       ; preds = %for.cond67.preheader, %for.body69
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.body69 ], [ 0, %for.cond67.preheader ]
  %arrayidx73 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @c, i64 0, i64 %indvars.iv89, i64 %indvars.iv86
  %48 = load i32, ptr %arrayidx73, align 4, !tbaa !5
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %48)
  ...
  %cmp68 = icmp slt i64 %indvars.iv.next87, %50
  br i1 %cmp68, label %for.body69, label %for.end78, !llvm.loop !22

for.end78:                                        ; preds = %for.body69, %for.cond67.preheader.for.end78_crit_edge
  %idxprom82.pre-phi = phi i64 [ %.pre93, %for.cond67.preheader.for.end78_crit_edge ], [ %50, %for.body69 ]
  %arrayidx83 = getelementptr inbounds [100 x [100 x i32]], ptr @c, i64 0, i64 %indvars.iv89, i64 %idxprom82.pre-phi
  %51 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %call84 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %51)
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %for.end78
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %cmp65 = icmp slt i64 %indvars.iv.next90, %57
  br i1 %cmp65, label %for.cond67.preheader, label %for.end88, !llvm.loop !50

for.end88:                                        ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit, %for.cond30.preheader
