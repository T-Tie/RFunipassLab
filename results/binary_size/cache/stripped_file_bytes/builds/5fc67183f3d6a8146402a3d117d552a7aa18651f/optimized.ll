...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.end ], [ 1, %entry ]
...
for.cond11:                                       ; preds = %for.inc25, %for.end9
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc25 ], [ 1, %for.end9 ]
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp12.not = icmp sgt i64 %indvars.iv41, %4
...
for.cond28.preheader:                             ; preds = %for.cond11
  ...
  %9 = add nuw i32 %smax50, 1
  %smax56 = call i32 @llvm.smax.i32(i32 %5, i32 0)
  %10 = add nuw i32 %smax56, 1
  %wide.trip.count57 = zext i32 %10 to i64
  %wide.trip.count51 = zext i32 %9 to i64
  %wide.trip.count = zext i32 %8 to i64
  br label %for.cond28

for.cond14:                                       ; preds = %for.cond11, %for.inc22
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc22 ], [ 1, %for.cond11 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp15.not = icmp sgt i64 %indvars.iv38, %12
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv53 = phi i64 [ 1, %for.cond28.preheader ], [ %indvars.iv.next54, %for.inc63 ]
  %exitcond58 = icmp eq i64 %indvars.iv53, %wide.trip.count57
  br i1 %exitcond58, label %for.cond66, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.inc60
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc60 ], [ 1, %for.cond28 ]
  %exitcond52 = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52, label %for.inc63, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv53, i64 %indvars.iv47
  store i32 0, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond38

for.cond38:                                       ; preds = %for.inc57, %for.body33
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc57 ], [ 1, %for.body33 ]
...
for.inc57:                                        ; preds = %for.cond38
  %arrayidx48 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv53, i64 %indvars.iv44
  %13 = load i32, ptr %arrayidx48, align 4, !tbaa !5, !invariant.load !14
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv44, i64 %indvars.iv47
...
for.cond66:                                       ; preds = %for.cond28, %for.end79
  %15 = phi i32 [ %.pre, %for.end79 ], [ %5, %for.cond28 ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.end79 ], [ 1, %for.cond28 ]
  %cmp67 = icmp sgt i32 %15, 0
  br i1 %cmp67, label %for.cond69, label %for.end87

for.cond69:                                       ; preds = %for.cond66, %for.body71
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body71 ], [ 1, %for.cond66 ]
  %16 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp70 = icmp sgt i32 %16, 1
  br i1 %cmp70, label %for.body71, label %for.end79

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv62, i64 %indvars.iv59
...
for.end79:                                        ; preds = %for.cond69
  ...
  %arrayidx83 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv62, i64 %idxprom82
