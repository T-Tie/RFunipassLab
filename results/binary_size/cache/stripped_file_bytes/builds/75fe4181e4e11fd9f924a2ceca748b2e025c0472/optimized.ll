...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond, %for.inc60
  ...
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc60 ], [ 0, %for.cond ]
  %f4.0 = phi i32 [ %f4.1, %for.inc60 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp13.not.not = icmp slt i64 %indvars.iv37, %5
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc57
  %indvars.iv34 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next35, %for.inc57 ]
  %f4.1 = phi i32 [ %f4.0, %for.cond15.preheader ], [ %f4.2, %for.inc57 ]
  %7 = load i32, ptr %l, align 4, !tbaa !5
  %8 = sext i32 %7 to i64
  %cmp17.not.not = icmp slt i64 %indvars.iv34, %8
...
for.cond19.preheader:                             ; preds = %for.cond15
  ...
  %arrayidx30 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv37, i64 %indvars.iv34
  %smax = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.body22
  %indvars.iv26 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next27, %for.body22 ]
...
for.cond35.preheader:                             ; preds = %for.cond19
  %wide.trip.count32 = zext i32 %7 to i64
  br label %for.cond35

for.body22:                                       ; preds = %for.cond19
  %arrayidx26 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv26, i64 %indvars.iv34
  %10 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %11 = load i32, ptr %arrayidx30, align 4, !tbaa !5
  %cmp31 = icmp slt i32 %10, %11
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.body38
  %indvars.iv29 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next30, %for.body38 ]
  %f2.0 = phi i32 [ 1, %for.cond35.preheader ], [ %spec.select21, %for.body38 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count32
  br i1 %exitcond33.not, label %for.end52, label %for.body38

for.body38:                                       ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv37, i64 %indvars.iv29
  %12 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %13 = load i32, ptr %arrayidx30, align 4, !tbaa !5
  %cmp47 = icmp sgt i32 %12, %13
  %spec.select21 = select i1 %cmp47, i32 0, i32 %f2.0
...
if.then54:                                        ; preds = %for.end52
  %14 = trunc nuw nsw i64 %indvars.iv34 to i32
  %call55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %6, i32 noundef %14)
  br label %for.inc57
