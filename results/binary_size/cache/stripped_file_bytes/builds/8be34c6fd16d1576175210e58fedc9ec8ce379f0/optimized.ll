...
for.cond:                                         ; preds = %for.inc19, %entry
  ...
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc19 ], [ 0, %entry ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %3 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre18, %for.inc ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv15, i64 %indvars.iv
...
for.end21:                                        ; preds = %for.cond
  ...
  %7 = load i32, ptr %arrayidx23, align 8, !tbaa !5
  ...
  %vtable.i = load ptr, ptr %call37, align 8, !tbaa !13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call37, i8 noundef signext %call.i13)
