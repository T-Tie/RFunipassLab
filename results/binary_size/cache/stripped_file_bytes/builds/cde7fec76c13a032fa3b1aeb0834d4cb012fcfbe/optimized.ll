...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  br i1 %cmp, label %for.cond3.preheader, label %for.cond, !llvm.loop !10

for.cond3.preheader:                              ; preds = %for.cond
  %cmp45.not = icmp eq i64 %indvars.iv, 0
  br i1 %cmp45.not, label %for.end10, label %for.body

for.body:                                         ; preds = %for.cond3.preheader, %for.body
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body ], [ %indvars.iv, %for.cond3.preheader ]
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %str, i64 0, i64 %indvars.iv8
  ...
  %cmp4 = icmp sgt i64 %indvars.iv8, 1
  br i1 %cmp4, label %for.body, label %for.end10, !llvm.loop !13

for.end10:                                        ; preds = %for.body, %for.cond3.preheader
