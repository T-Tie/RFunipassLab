...
for.cond:                                         ; preds = %entry, %if.end4
  %s.0 = phi i32 [ %s.1, %if.end4 ], [ 0, %entry ]
  %t.0 = phi i32 [ %t.1, %if.end4 ], [ 0, %entry ]
  %i.0 = phi i32 [ %dec, %if.end4 ], [ %a, %entry ]
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %n, %i.0
  %call = tail call noundef i32 @_Z6divideii(i32 noundef %div, i32 noundef %i.0) #6
