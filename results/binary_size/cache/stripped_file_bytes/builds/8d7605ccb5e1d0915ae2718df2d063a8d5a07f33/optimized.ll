...
for.cond6:                                        ; preds = %for.body8, %for.body
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.body8 ], [ %indvars.iv, %for.body ]
...
for.body8:                                        ; preds = %for.cond6
  ...
  %arrayidx10 = getelementptr inbounds nuw [300 x i32], ptr %w, i64 0, i64 %indvars.iv.next5
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc32
  %indvars.iv8 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next9, %for.inc32 ]
...
for.inc32:                                        ; preds = %for.cond25
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %s, i64 0, i64 %indvars.iv8
