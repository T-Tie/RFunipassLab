...
for.cond:                                         ; preds = %if.end29, %entry
  %count.0 = phi i64 [ 0, %entry ], [ %count.1, %if.end29 ]
...
if.then12:                                        ; preds = %if.else
  ...
  %gep37 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i10
  %5 = load i64, ptr %gep37, align 8, !tbaa !11
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  %retval.0.i = phi ptr [ %call1.i13, %if.then.i ], [ @_ZSt4cout, %if.end.i ]
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i)
  %call.i.i14 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #5
  %call1.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull %s, i64 noundef %call.i.i14)
...
if.else22:                                        ; preds = %if.else
  ...
  %call.i.i22 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #5
...
if.end29:                                         ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.else22, %if.then
