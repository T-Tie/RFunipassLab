...
for.cond60:                                       ; preds = %if.end74, %if.else
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %if.end74 ], [ 0, %if.else ]
  %5 = load i32, ptr %n, align 4, !tbaa !22
  %cmp62 = icmp slt i32 %5, %conv
  br i1 %cmp62, label %if.end74, label %if.end78

if.end74:                                         ; preds = %for.cond60
  %arrayidx70 = getelementptr inbounds nuw [6 x i8], ptr @b, i64 %indvars.iv12
