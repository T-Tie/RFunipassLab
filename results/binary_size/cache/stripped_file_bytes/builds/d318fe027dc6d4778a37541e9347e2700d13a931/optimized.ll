...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %year) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %month1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %month2) #9
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %smin9 = sext i32 %5 to i64
  %6 = call i32 @llvm.smax.i32(i32 %1, i32 %2)
  br i1 %or.cond8, label %for.cond15, label %for.cond28

for.cond15:                                       ; preds = %for.body, %for.inc
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc ], [ %smin9, %for.body ]
  %sum.0 = phi i32 [ %add, %for.inc ], [ 0, %for.body ]
  %lftr.wideiv12 = trunc i64 %indvars.iv10 to i32
  %exitcond13.not = icmp eq i32 %6, %lftr.wideiv12
  br i1 %exitcond13.not, label %for.inc48, label %for.inc

for.inc:                                          ; preds = %for.cond15
  %arrayidx = getelementptr inbounds [13 x i32], ptr @__const.main.b, i64 0, i64 %indvars.iv10
  %7 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !9
  %add = add nsw i32 %7, %sum.0
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, 1
  br label %for.cond15, !llvm.loop !10

for.cond28:                                       ; preds = %for.body, %for.inc35
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc35 ], [ %smin9, %for.body ]
  %sum26.0 = phi i32 [ %add34, %for.inc35 ], [ 0, %for.body ]
...
for.inc48:                                        ; preds = %for.cond28, %for.cond15
  %sum.0.lcssa.sink = phi i32 [ %sum.0, %for.cond15 ], [ %sum26.0, %for.cond28 ]
  call fastcc void @outlined_ir_func_0(i32 %sum.0.lcssa.sink)
  %inc49 = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !14

for.end50:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %month2) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %month1) #9
...
attributes #6 = { minsize mustprogress norecurse optsize memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
