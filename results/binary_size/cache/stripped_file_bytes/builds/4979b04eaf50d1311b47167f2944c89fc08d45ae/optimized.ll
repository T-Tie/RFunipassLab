...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv26, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.end23
  %indvars.iv33 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next34, %for.end23 ]
  ...
  br i1 %exitcond38.not, label %for.end26, label %for.cond13.preheader
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %sz, i64 0, i64 %indvars.iv33, i64 %indvars.iv29
...
for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit41
  %x1.1 = phi i32 [ %6, %for.end23.split.loop.exit41 ], [ %x1.0, %for.cond13 ]
  %y1.1 = phi i32 [ %4, %for.end23.split.loop.exit41 ], [ %y1.0, %for.cond13 ]
