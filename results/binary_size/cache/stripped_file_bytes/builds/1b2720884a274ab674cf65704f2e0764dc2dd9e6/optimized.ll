...
entry:
  ...
  br i1 %cmp43, label %if.then6.i, label %for.end30

if.then6.i:                                       ; preds = %entry, %if.end24
  %lenth.046 = phi i64 [ %lenth.1, %if.end24 ], [ 0, %entry ]
  %flag.045 = phi i32 [ %flag.138, %if.end24 ], [ 0, %entry ]
  %i.044 = phi i32 [ %inc29, %if.end24 ], [ 0, %entry ]
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %cmp8.not = icmp eq i32 %flag.045, 0
...
if.then9:                                         ; preds = %if.then
  ...
  %gep42 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i8
  %9 = load i64, ptr %gep42, align 8, !tbaa !11
...
if.end13:                                         ; preds = %if.then, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #6
  br label %if.end24
...
if.then16:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %gep41 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 240), i64 %vbase.offset.i32
  %10 = load ptr, ptr %gep41, align 8, !tbaa !38
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %call19 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #6
  %add20 = add i64 %call19, 1
  br label %if.end24

if.end24:                                         ; preds = %if.end13, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %call.i.i.sink = phi i64 [ %call.i.i, %if.end13 ], [ %call19, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %flag.138 = phi i32 [ 1, %if.end13 ], [ %flag.045, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %lenth.1 = phi i64 [ %add5, %if.end13 ], [ %add20, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ]
  %call1.i11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a, i64 noundef %call.i.i.sink)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(40) %a, i8 0, i64 40, i1 false), !tbaa !37
  %inc29 = add nuw nsw i32 %i.044, 1
  %14 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp slt i32 %inc29, %14
  br i1 %cmp, label %if.then6.i, label %for.end30, !llvm.loop !45

for.end30:                                        ; preds = %if.end24, %entry
