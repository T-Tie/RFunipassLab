...
for.cond.preheader:                               ; preds = %while.cond
  ...
  br i1 %cmp19, label %for.cond.preheader30, label %for.cond38.preheader

for.cond.preheader30:                             ; preds = %for.cond.preheader
...
for.cond:                                         ; preds = %for.cond.preheader30, %for.cond
  %call34 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %for.cond
...
for.cond20:                                       ; preds = %for.cond.preheader30, %for.cond20
  %2 = phi i8 [ %.pre, %for.cond20 ], [ %0, %for.cond.preheader30 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond20 ], [ 0, %for.cond.preheader30 ]
  %call32 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %2)
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.cond38
  %call50 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %1)
  br label %for.cond38
