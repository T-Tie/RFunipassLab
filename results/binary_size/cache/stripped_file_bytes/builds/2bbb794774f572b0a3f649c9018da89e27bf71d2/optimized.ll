...
entry:
  %targetBlock = tail call i1 @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %s)
...
while.body:                                       ; preds = %while.cond
  ...
  %targetBlock1 = tail call i1 @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %incdec.ptr)
...
define internal noundef i1 @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) #5 {
entry_to_outline:
