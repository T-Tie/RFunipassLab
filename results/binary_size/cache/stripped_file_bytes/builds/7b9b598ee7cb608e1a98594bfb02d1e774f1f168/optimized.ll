...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc19
  %indvars.iv15 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next16, %for.inc19 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond22, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc16
  %indvars.iv11 = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next12, %for.inc16 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.inc19, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv11
  ...
  %cmp13 = icmp ne i64 %indvars.iv11, %indvars.iv15
...
for.cond22:                                       ; preds = %for.cond2, %for.inc33
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc33 ], [ 0, %for.cond2 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond25.not, label %loop, label %for.body24

for.body24:                                       ; preds = %for.cond22
  %arrayidx26 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv21
...
if.then28:                                        ; preds = %for.body24
  ...
  %.pre = and i64 %indvars.iv21, 4294967295
  br label %loop
...
loop:                                             ; preds = %for.cond22, %if.then28
  %.pre-phi = phi i64 [ %.pre, %if.then28 ], [ %wide.trip.count19, %for.cond22 ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc47, %loop
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc47 ], [ %.pre-phi, %loop ]
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %6 = sext i32 %5 to i64
  %cmp37 = icmp slt i64 %indvars.iv.next27, %6
  br i1 %cmp37, label %for.body38, label %for.end49

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next27
