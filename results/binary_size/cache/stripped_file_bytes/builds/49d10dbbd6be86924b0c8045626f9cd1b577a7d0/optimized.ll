...
for.body:                                         ; preds = %for.cond
  ...
  %call8 = call double @sqrt(double noundef %6) #7, !tbaa !5
  ...
  %sub25 = fsub double %fneg, %call16
  %div27 = fdiv double %sub25, %mul
  %cmp28 = fcmp oeq double %5, 0.000000e+00
  br i1 %cmp28, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div) #8
  br label %if.end
...
if.then32:                                        ; preds = %land.lhs.true
  %call33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div, double noundef %div10, double noundef %div, double noundef %div10) #8
...
if.then38:                                        ; preds = %land.lhs.true36
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %sub, double noundef %div10, double noundef %sub, double noundef %div10) #8
  br label %if.end40
...
if.then42:                                        ; preds = %if.end40
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div18, double noundef %div27) #8
  br label %for.inc
