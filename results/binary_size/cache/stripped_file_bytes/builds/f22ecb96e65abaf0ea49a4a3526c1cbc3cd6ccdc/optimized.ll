...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc24 ], [ 1, %for.cond13 ]
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc65
  %indvars.iv47 = phi i64 [ 1, %for.cond30.preheader ], [ %indvars.iv.next48, %for.inc65 ]
  %exitcond52 = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52, label %for.cond68, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc62
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc62 ], [ 1, %for.cond30 ]
  %exitcond46 = icmp eq i64 %indvars.iv41, %wide.trip.count45
  br i1 %exitcond46, label %for.inc65, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv47, i64 %indvars.iv41
  store i32 0, ptr %arrayidx39, align 4, !tbaa !5
  br label %for.cond40

for.cond40:                                       ; preds = %for.inc59, %for.body35
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc59 ], [ 1, %for.body35 ]
...
for.cond68:                                       ; preds = %for.cond30, %for.inc90
  ...
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc90 ], [ 1, %for.cond30 ]
  %18 = sext i32 %17 to i64
  %cmp69.not = icmp sgt i64 %indvars.iv56, %18
  br i1 %cmp69.not, label %for.end92, label %for.cond71

for.cond71:                                       ; preds = %for.cond68, %for.inc87
  %19 = phi i32 [ %.pre59, %for.inc87 ], [ %16, %for.cond68 ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc87 ], [ 1, %for.cond68 ]
  %20 = sext i32 %19 to i64
  %cmp72.not = icmp sgt i64 %indvars.iv53, %20
  br i1 %cmp72.not, label %for.inc90, label %for.body73

for.body73:                                       ; preds = %for.cond71
  %21 = zext i32 %19 to i64
  %cmp74.not = icmp eq i64 %indvars.iv53, %21
  %22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv53
