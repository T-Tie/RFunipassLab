...
entry:
  ...
  %1 = sext i32 %0 to i64
  %smax80 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count21 = zext i32 %0 to i64
  br label %while.cond

while.cond:                                       ; preds = %for.end143, %entry
  %q.0 = phi i32 [ 0, %entry ], [ %inc146, %for.end143 ]
  %exitcond81.not = icmp eq i32 %q.0, %smax80
  br i1 %exitcond81.not, label %while.end, label %for.cond

for.cond:                                         ; preds = %while.cond, %for.inc8
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc8 ], [ 0, %while.cond ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end10, label %for.cond2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.inc141, %for.end10
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc141 ], [ %1, %for.end10 ]
  %indvars.iv66.in = phi i32 [ %indvars.iv66, %for.inc141 ], [ %0, %for.end10 ]
  %m.0 = phi i32 [ %inc142, %for.inc141 ], [ 1, %for.end10 ]
  %s.0 = phi i32 [ %add, %for.inc141 ], [ 0, %for.end10 ]
  %indvars.iv66 = add i32 %indvars.iv66.in, -1
  %smax73 = call i32 @llvm.smax.i32(i32 %indvars.iv66, i32 noundef 1)
  %exitcond79.not = icmp eq i32 %m.0, %0
  br i1 %exitcond79.not, label %for.end143, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %2 = trunc nsw i64 %indvars.iv76 to i32
  %smax60 = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %wide.trip.count36 = zext nneg i32 %smax60 to i64
  %wide.trip.count26 = and i64 %indvars.iv76, 4294967295
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc50
  %indvars.iv33 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next34, %for.inc50 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count36
  br i1 %exitcond37.not, label %for.cond53.preheader, label %for.body16

for.cond53.preheader:                             ; preds = %for.cond14
  %wide.trip.count41 = and i64 %indvars.iv76, 4294967295
  br label %for.cond53

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv33
  %3 = load i32, ptr %arrayidx18, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body22 ], [ 0, %for.body16 ]
  %l.0 = phi i32 [ %spec.select, %for.body22 ], [ %3, %for.body16 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond35.preheader, label %for.body22

for.cond35.preheader:                             ; preds = %for.cond20
  br label %for.cond35

for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv33, i64 %indvars.iv23
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc47
  %indvars.iv28 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next29, %for.inc47 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count26
  br i1 %exitcond32.not, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv33, i64 %indvars.iv28
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc91
  %indvars.iv48 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next49, %for.inc91 ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count36
  br i1 %exitcond53.not, label %for.end93, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx58 = getelementptr inbounds nuw [200 x i32], ptr %a, i64 0, i64 %indvars.iv48
  %6 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond59

for.cond59:                                       ; preds = %for.body61, %for.body55
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body61 ], [ 0, %for.body55 ]
  %l.2 = phi i32 [ %spec.select15, %for.body61 ], [ %6, %for.body55 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond76.preheader, label %for.body61

for.cond76.preheader:                             ; preds = %for.cond59
  br label %for.cond76

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv48
  %7 = load i32, ptr %arrayidx65, align 4, !tbaa !5, !invariant.load !13
  %spec.select15 = call i32 @llvm.smin.i32(i32 %l.2, i32 %7)
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond59, !llvm.loop !17

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc88
  %indvars.iv43 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next44, %for.inc88 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count41
  br i1 %exitcond47.not, label %for.inc91, label %for.inc88

for.inc88:                                        ; preds = %for.cond76
  %arrayidx82 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  ...
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count36
  br i1 %exitcond62.not, label %for.cond118.preheader, label %for.cond99
...
for.cond99:                                       ; preds = %for.cond96, %for.inc112
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc112 ], [ 1, %for.cond96 ]
  %cmp101 = icmp slt i64 %indvars.iv54, %indvars.iv.next77
  br i1 %cmp101, label %for.inc112, label %for.inc115

for.inc112:                                       ; preds = %for.cond99
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %arrayidx107 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv.next55
  %10 = load i32, ptr %arrayidx107, align 4, !tbaa !5, !invariant.load !13
  %arrayidx111 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv54
...
for.cond118:                                      ; preds = %for.cond122, %for.cond118.preheader
  %indvars.iv70 = phi i64 [ 1, %for.cond118.preheader ], [ %indvars.iv.next71, %for.cond122 ]
  %exitcond75.not = icmp eq i64 %indvars.iv70, %wide.trip.count74
  br i1 %exitcond75.not, label %for.inc141, label %for.cond122.preheader
...
for.cond122:                                      ; preds = %for.cond122.preheader, %for.inc135
  %indvars.iv63 = phi i64 [ 0, %for.cond122.preheader ], [ %indvars.iv.next64, %for.inc135 ]
  %exitcond69.not = icmp eq i64 %indvars.iv63, %wide.trip.count68
  br i1 %exitcond69.not, label %for.cond118, label %for.inc135, !llvm.loop !22

for.inc135:                                       ; preds = %for.cond122
  %arrayidx130 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv.next71, i64 %indvars.iv63
  %11 = load i32, ptr %arrayidx130, align 4, !tbaa !5, !invariant.load !13
  %arrayidx134 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv70, i64 %indvars.iv63
...
for.inc141:                                       ; preds = %for.cond118
  ...
  %12 = trunc nsw i64 %indvars.iv.next77 to i32
