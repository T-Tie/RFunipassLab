...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv29 = phi i64 [ %1, %for.cond2.preheader ], [ %indvars.iv.next30, %for.inc24 ]
  %indvars.iv23 = phi i64 [ %2, %for.cond2.preheader ], [ %indvars.iv.next24, %for.inc24 ]
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, -1
  %indvars.iv.next24 = add nsw i64 %indvars.iv23, -1
  %cmp3 = icmp sgt i64 %indvars.iv29, 0
...
for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx12 = getelementptr inbounds [26 x i32], ptr %s, i64 0, i64 %indvars.iv.next30
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc18
  %indvars.iv25 = phi i64 [ %indvars.iv23, %for.cond5.preheader ], [ %indvars.iv.next26, %for.inc18 ]
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [26 x i32], ptr %d, i64 0, i64 %indvars.iv25
...
land.lhs.true:                                    ; preds = %for.body7
  ...
  %arrayidx14 = getelementptr inbounds nuw [26 x i32], ptr %s, i64 0, i64 %indvars.iv25
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx23 = getelementptr inbounds [26 x i32], ptr %d, i64 0, i64 %indvars.iv.next30
  store i32 %inc21, ptr %arrayidx23, align 4, !tbaa !5
  br label %for.cond2, !llvm.loop !14

for.cond26:                                       ; preds = %for.cond26.preheader, %for.body28
  %indvars.iv32 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next33, %for.body28 ]
  %k.2 = phi i32 [ 0, %for.cond26.preheader ], [ %spec.select20, %for.body28 ]
  %exitcond.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [26 x i32], ptr %d, i64 0, i64 %indvars.iv32
  %7 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
  %spec.select20 = call i32 @llvm.smax.i32(i32 %7, i32 %k.2)
