...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc34
  %indvars.iv21 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next22, %for.inc34 ]
  %max.0 = phi i32 [ 1, %for.cond4.preheader ], [ %max.1, %for.inc34 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end36, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %arrayidx11 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv21
  %arrayidx16 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv21
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc31
  %indvars.iv18 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next19, %for.inc31 ]
  %max.1 = phi i32 [ %max.0, %for.cond7.preheader ], [ %max.2, %for.inc31 ]
  %exitcond.not = icmp eq i64 %indvars.iv18, %indvars.iv21
  br i1 %exitcond.not, label %for.inc34, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %2 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %arrayidx13 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv18
...
land.lhs.true:                                    ; preds = %for.body9
  ...
  %arrayidx18 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv18
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %max.1, i32 %add)
  br label %for.inc31
