...
define dso_local noundef i32 @_Z6getonePc(ptr noundef nonnull dereferenceable(1) %s) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  %call2 = call noundef range(i32 -1, -2147483647) i32 @_Z6getonePc(ptr noundef nonnull align 16 dereferenceable(41) %s)
