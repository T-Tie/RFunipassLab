...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv34 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next35, %for.inc44 ]
  %i.3 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond40.not = icmp eq i32 %i.3, %smax39
  br i1 %exitcond40.not, label %for.end46, label %for.cond19.preheader
...
for.cond19:                                       ; preds = %for.cond19.backedge, %for.cond19.preheader
  %indvars.iv31 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next32, %for.cond19.backedge ]
  %exitcond38.not = icmp eq i64 %indvars.iv31, %wide.trip.count37
  br i1 %exitcond38.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv31
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next32
  %5 = load i32, ptr %arrayidx27, align 4, !tbaa !5
  %cmp28 = icmp sgt i32 %4, %5
  br i1 %cmp28, label %if.then29, label %for.cond19.backedge

for.cond19.backedge:                              ; preds = %for.body23, %if.then29
...
for.end46:                                        ; preds = %for.cond16
  ...
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %6)
  %smax45 = call i32 @llvm.smax.i32(i32 %m.0, i32 1)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond49

for.cond49:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %for.end46
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 1, %for.end46 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47.not, label %for.end58, label %for.body51
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv41
  %8 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  %call55 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, i32 noundef %8)
