...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc35
  %indvars.iv14 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next15, %for.inc35 ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond38.preheader, label %for.body12
...
for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv14
  %5 = load i32, ptr %arrayidx14, align 16, !tbaa !5, !invariant.load !13
  %arrayidx17 = getelementptr inbounds nuw [8 x i32], ptr %djl, i64 0, i64 %indvars.iv14
  store i32 0, ptr %arrayidx17, align 4, !tbaa !5
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc32, %for.body12
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc32 ], [ 0, %for.body12 ]
...
for.body20:                                       ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv14, i64 %indvars.iv11
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc65
  %indvars.iv26 = phi i64 [ 0, %for.cond38.preheader ], [ %indvars.iv.next27, %for.inc65 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond68, label %for.body40

for.body40:                                       ; preds = %for.cond38
  %arrayidx43 = getelementptr inbounds nuw [8 x i32], ptr %s, i64 0, i64 %indvars.iv26
  %8 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %arrayidx45 = getelementptr inbounds nuw [8 x i32], ptr %djh, i64 0, i64 %indvars.iv26
  store i32 0, ptr %arrayidx45, align 4, !tbaa !5
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc62, %for.body40
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc62 ], [ 0, %for.body40 ]
  %min.0 = phi i32 [ %min.1, %for.inc62 ], [ %8, %for.body40 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond25.not, label %for.inc65, label %for.body48

for.body48:                                       ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %s, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
...
for.inc83:                                        ; preds = %for.body73, %land.lhs.true, %if.then80
  %.pre38 = phi i32 [ %.pre38.pre, %if.then80 ], [ %.pre3840, %land.lhs.true ], [ %.pre3840, %for.body73 ]
