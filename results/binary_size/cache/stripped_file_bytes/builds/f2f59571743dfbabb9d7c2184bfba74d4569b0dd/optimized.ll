...
for.cond:                                         ; preds = %if.end65, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %if.end65 ]
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %or.cond9, label %if.else21, label %if.then14
...
if.else21:                                        ; preds = %if.else
  ...
  br i1 %or.cond10, label %if.else35, label %if.then25

if.then25:                                        ; preds = %if.else21
  %reass.sub6 = sub i32 %3, %0
  %7 = mul i32 %reass.sub6, 3600
...
if.else35:                                        ; preds = %if.else21
  ...
  br i1 %or.cond11, label %if.else49, label %if.then39

if.then39:                                        ; preds = %if.else35
  %reass.sub7 = sub i32 %3, %0
  %8 = mul i32 %reass.sub7, 3600
...
if.else49:                                        ; preds = %if.else35
  ...
  br i1 %or.cond12, label %if.end65, label %if.then53

if.then53:                                        ; preds = %if.else49
  %reass.sub8 = sub i32 %3, %0
  %9 = mul i32 %reass.sub8, 3600
...
if.end65:                                         ; preds = %if.then25, %if.else49, %if.then53, %if.then39, %if.then14
