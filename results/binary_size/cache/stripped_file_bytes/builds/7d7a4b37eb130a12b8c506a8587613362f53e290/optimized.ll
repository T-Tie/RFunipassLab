...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  br i1 %exitcond20.not, label %for.cond13.preheader, label %for.cond1
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv26 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next27, %for.inc31 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body18 ], [ 1, %for.cond13 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.inc31, label %for.body18
...
for.cond:                                         ; preds = %for.end30, %entry
  %t.0 = phi i32 [ 0, %entry ], [ %inc33, %for.end30 ]
...
for.cond4:                                        ; preds = %for.cond1, %for.body6
  %3 = phi i32 [ %.pre19, %for.body6 ], [ %1, %for.cond1 ]
...
for.cond13:                                       ; preds = %for.cond1, %for.end28
  %storemerge = phi i32 [ %dec, %for.end28 ], [ %1, %for.cond1 ]
  %sum.0 = phi i32 [ %add, %for.end28 ], [ 0, %for.cond1 ]
  store i32 %storemerge, ptr @m, align 4, !tbaa !5
  %cmp14 = icmp sgt i32 %storemerge, 0
  br i1 %cmp14, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond13, %for.body18
  %5 = phi i32 [ %.pre, %for.body18 ], [ %storemerge, %for.cond13 ]
  %i.1 = phi i32 [ %inc27, %for.body18 ], [ 0, %for.cond13 ]
  %mul = shl nsw i32 %5, 1
