...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.end26 ], [ 0, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc24 ], [ 0, %for.cond13 ]
  %4 = load i32, ptr %y2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp17 = icmp slt i64 %indvars.iv24, %5
  br i1 %cmp17, label %for.inc24, label %for.end26

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv27, i64 %indvars.iv24
...
if.else:                                          ; preds = %for.body66
  %call80 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call73, ptr noundef nonnull @.str)
  br label %for.inc82
