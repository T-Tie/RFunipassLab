...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 404, ptr nonnull %s) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %n) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %x) #4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(404) %s, i8 0, i64 404, i1 false), !tbaa !5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp27 = icmp sgt i32 %0, 0
  br i1 %cmp27, label %for.body3, label %for.end17

for.body3:                                        ; preds = %entry, %for.inc15
  %i.18 = phi i32 [ %inc16, %for.inc15 ], [ 0, %entry ]
...
if.then:                                          ; preds = %for.body3
  %cmp8.not = icmp eq i32 %i.18, 0
  br i1 %cmp8.not, label %if.end, label %if.then9

if.then9:                                         ; preds = %if.then
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 32, ptr %__c.addr.i, align 1, !tbaa !9
...
if.end:                                           ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.then
  %4 = phi i32 [ %.pre, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %1, %if.then ]
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %4)
...
for.inc15:                                        ; preds = %for.body3, %if.end
  %inc16 = add nuw nsw i32 %i.18, 1
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %cmp2 = icmp slt i32 %inc16, %6
  br i1 %cmp2, label %for.body3, label %for.end17, !llvm.loop !23

for.end17:                                        ; preds = %for.inc15, %entry
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %x) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #4
  call void @llvm.lifetime.end.p0(i64 404, ptr nonnull %s) #4
  ret i32 0
}
