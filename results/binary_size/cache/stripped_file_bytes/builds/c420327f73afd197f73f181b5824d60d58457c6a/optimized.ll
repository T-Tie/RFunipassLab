...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %k1) #3
...
if.then:                                          ; preds = %for.body15
  ...
  store i32 %15, ptr %i1, align 4, !tbaa !5
  %16 = load i32, ptr %j, align 4, !tbaa !5
  store i32 %16, ptr %j1, align 4, !tbaa !5
  store i32 1, ptr %k1, align 4, !tbaa !5
  br label %for.end23
...
for.end23:                                        ; preds = %if.then, %for.cond13
  %18 = load i32, ptr %k1, align 4, !tbaa !5
...
if.then42:                                        ; preds = %for.body36
  ...
  store i32 %27, ptr %i2, align 4, !tbaa !5
  %28 = load i32, ptr %j, align 4, !tbaa !5
  store i32 %28, ptr %j2, align 4, !tbaa !5
...
for.end45:                                        ; preds = %if.then42, %for.cond34
  %30 = load i32, ptr %k2, align 4, !tbaa !5
...
for.end51:                                        ; preds = %if.then47, %for.cond30
  %32 = load i32, ptr %i2, align 4, !tbaa !5
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %mul)
  call void @llvm.lifetime.end.p0(i64 4, ptr %k2) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %k1) #3
