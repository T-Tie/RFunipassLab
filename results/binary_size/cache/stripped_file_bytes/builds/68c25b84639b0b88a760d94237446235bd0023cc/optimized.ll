...
for.cond:                                         ; preds = %for.inc13, %entry
  ...
  %exitcond10.not = icmp ne i64 %indvars.iv6, %wide.trip.count9
  call void @llvm.assume(i1 %exitcond10.not)
  %add.ptr = getelementptr inbounds nuw i32, ptr %p, i64 %indvars.iv6
  br label %for.cond1
...
for.end:                                          ; preds = %for.body3, %for.cond1
  %j.0.lcssa.in = phi i64 [ %indvars.iv, %for.body3 ], [ %indvars.iv6, %for.cond1 ]
  %2 = and i64 %j.0.lcssa.in, 4294967295
  %cmp7 = icmp eq i64 %2, %indvars.iv6
