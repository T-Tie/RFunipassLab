...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %k) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 120, ptr noundef nonnull %high) #10
  call void @llvm.lifetime.start.p0(i64 noundef 120, ptr noundef nonnull align 16 captures(none) dereferenceable(120) %num) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 captures(none) dereferenceable(120) %num, i8 noundef 0, i64 noundef 120, i1 noundef false)
  br label %for.cond
...
for.cond3:                                        ; preds = %for.inc25, %for.end
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc25 ], [ 1, %for.end ]
  %exitcond.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond.not, label %for.end27, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond3
  %arrayidx10 = getelementptr inbounds nuw [30 x i32], ptr %high, i64 0, i64 %indvars.iv16
  %2 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc21
  %indvars.iv18 = phi i64 [ %indvars.iv16, %for.cond6.preheader ], [ %indvars.iv.next19, %for.inc21 ]
  %max.0 = phi i32 [ 0, %for.cond6.preheader ], [ %max.1, %for.inc21 ]
  %indvars.iv.next19 = add nsw i64 %indvars.iv18, -1
  %cmp7 = icmp sgt i64 %indvars.iv18, 0
  br i1 %cmp7, label %for.body8, label %for.inc25

for.body8:                                        ; preds = %for.cond6
  %arrayidx12 = getelementptr inbounds [30 x i32], ptr %high, i64 0, i64 %indvars.iv.next19
  %3 = load i32, ptr %arrayidx12, align 4, !tbaa !5, !invariant.load !12
  %cmp13.not = icmp sgt i32 %2, %3
  br i1 %cmp13.not, label %for.inc21, label %if.then

if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds [30 x i32], ptr %num, i64 0, i64 %indvars.iv.next19
  %4 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
  %spec.select = call i32 @llvm.smax.i32(i32 %max.0, i32 %4)
  br label %for.inc21

for.inc21:                                        ; preds = %if.then, %for.body8
  %max.1 = phi i32 [ %max.0, %for.body8 ], [ %spec.select, %if.then ]
  br label %for.cond6, !llvm.loop !13

for.inc25:                                        ; preds = %for.cond6
  %add = add nuw nsw i32 %max.0, 1
  %arrayidx24 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv16
...
if.then.i.i:                                      ; preds = %for.end27
  %add.ptr.idx = shl nsw i64 %1, 2
  %add.ptr = getelementptr inbounds i8, ptr %num, i64 %add.ptr.idx
  %5 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %1, i1 noundef true)
  %sub.i.i.i = shl nuw nsw i64 %5, 1
  %mul.i.i = xor i64 %sub.i.i.i, 126
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull align 16 dereferenceable(120) %num, ptr noundef nonnull %add.ptr, i64 noundef %mul.i.i)
  call void @_ZSt22__final_insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef nonnull align 16 dereferenceable(120) %num, ptr noundef nonnull %add.ptr)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end27, %if.then.i.i
  %sub29 = phi i64 [ -1, %for.end27 ], [ %7, %if.then.i.i ]
  %arrayidx31 = getelementptr inbounds [30 x i32], ptr %num, i64 0, i64 %sub29
  %8 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !12
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8)
  call void @llvm.lifetime.end.p0(i64 noundef 120, ptr noundef nonnull captures(none) %num) #10
  call void @llvm.lifetime.end.p0(i64 noundef 120, ptr noundef nonnull %high) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %k) #10
  ret i32 0
}
...
if.end:                                           ; preds = %while.body
  ...
  %div.i28 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i28
...
if.end:                                           ; preds = %entry
  ...
  %div1314 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div1314, %if.end ], [ %dec, %while.body ]
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %cmp.i6 = icmp sgt i64 %__holeIndex.addr.0.i, %__holeIndex
  br i1 %cmp.i6, label %land.end.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit
...
if.else10:                                        ; preds = %if.else7
  ...
  %spec.select17 = select i1 %cmp.i9, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.then, %if.else10, %if.else, %if.else7
  %5 = phi i32 [ %0, %if.else7 ], [ %3, %if.else ], [ %4, %if.else10 ], [ %1, %if.then ]
  %__b.addr.sink.sink.sink.sroa.speculated = phi ptr [ %__a, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select17, %if.else10 ], [ %__b, %if.then ]
...
while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  ...
  br i1 %cmp.i1, label %while.cond4, label %while.end8, !llvm.loop !24
