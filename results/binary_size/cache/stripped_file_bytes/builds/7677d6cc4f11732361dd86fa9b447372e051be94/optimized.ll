...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80004, ptr noundef nonnull %a) #4
...
for.cond4:                                        ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %1)
