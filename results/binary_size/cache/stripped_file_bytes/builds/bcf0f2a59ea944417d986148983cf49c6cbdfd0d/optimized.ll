...
for.cond16:                                       ; preds = %for.cond12, %for.body19
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body19 ], [ 0, %for.cond12 ]
...
for.cond35:                                       ; preds = %for.cond31, %for.body38
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body38 ], [ 0, %for.cond31 ]
...
for.cond57:                                       ; preds = %for.cond57.preheader, %for.body60
  %indvars.iv59 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next60, %for.body60 ]
  %exitcond65.not = icmp eq i64 %indvars.iv59, %wide.trip.count64
  br i1 %exitcond65.not, label %for.inc80, label %for.body60
