...
for.cond:                                         ; preds = %for.body, %entry
  %n.0 = phi i32 [ 0, %entry ], [ %spec.select, %for.body ]
  %1 = load i32, ptr %N, align 4, !tbaa !5
  %cmp = icmp sgt i32 %1, 0
  br i1 %cmp, label %for.body, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond
  %cmp7.not = icmp eq i32 %n.0, 0
  call void @llvm.assume(i1 noundef %cmp7.not)
...
for.body:                                         ; preds = %for.cond
  ...
  %inc.i = zext i1 %cmp2 to i32
  %spec.select = add nuw nsw i32 %n.0, %inc.i
  br label %for.cond
}
