...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv7, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc39
  %indvars.iv13 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next14, %for.inc39 ]
  %exitcond19.not = icmp eq i64 %indvars.iv13, %wide.trip.count18
  br i1 %exitcond19.not, label %for.cond42, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv13
  %arrayidx35 = getelementptr inbounds nuw [8 x i32], ptr %arrow, i64 0, i64 %indvars.iv13
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc36
  %indvars.iv10 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next11, %for.inc36 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx24 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv13, i64 %indvars.iv10
...
if.then:                                          ; preds = %for.body15
  %7 = trunc nuw nsw i64 %indvars.iv10 to i32
...
for.cond42:                                       ; preds = %for.cond10, %for.inc73
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc73 ], [ 0, %for.cond10 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond30.not, label %for.cond76, label %for.cond45.preheader

for.cond45.preheader:                             ; preds = %for.cond42
  %arrayidx50 = getelementptr inbounds nuw [8 x i32], ptr %a, i64 0, i64 %indvars.iv25
  %arrayidx52 = getelementptr inbounds nuw [8 x i32], ptr %min, i64 0, i64 %indvars.iv25
  %arrayidx68 = getelementptr inbounds nuw [8 x i32], ptr %low, i64 0, i64 %indvars.iv25
  br label %for.cond45

for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc70
  %indvars.iv20 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next21, %for.inc70 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count18
  br i1 %exitcond24.not, label %for.inc73, label %for.body47

for.body47:                                       ; preds = %for.cond45
  %8 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !13
  store i32 %8, ptr %arrayidx52, align 4, !tbaa !5
  %arrayidx56 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv25
...
if.then60:                                        ; preds = %for.body47
  ...
  %10 = trunc nuw nsw i64 %indvars.iv20 to i32
...
for.cond76:                                       ; preds = %for.cond42, %for.inc98
  %.pre40 = phi i32 [ %.pre, %for.inc98 ], [ %0, %for.cond42 ]
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc98 ], [ 0, %for.cond42 ]
  %p.0 = phi i32 [ %p.1, %for.inc98 ], [ 0, %for.cond42 ]
  %11 = sext i32 %.pre40 to i64
  %cmp77 = icmp slt i64 %indvars.iv37, %11
  br i1 %cmp77, label %for.cond79.preheader, label %for.end100

for.cond79.preheader:                             ; preds = %for.cond76
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds nuw [8 x i32], ptr %arrow, i64 0, i64 %indvars.iv37
  %smax34 = call i32 @llvm.smax.i32(i32 %12, i32 noundef 0)
  %wide.trip.count35 = zext nneg i32 %smax34 to i64
  br label %for.cond79

for.cond79:                                       ; preds = %for.cond79.preheader, %for.inc95
  %indvars.iv31 = phi i64 [ 0, %for.cond79.preheader ], [ %indvars.iv.next32, %for.inc95 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.inc98, label %for.body81

for.body81:                                       ; preds = %for.cond79
  %arrayidx83 = getelementptr inbounds nuw [8 x i32], ptr %min, i64 0, i64 %indvars.iv31
...
land.lhs.true:                                    ; preds = %for.body81
  %arrayidx85 = getelementptr inbounds nuw [8 x i32], ptr %low, i64 0, i64 %indvars.iv31
  %14 = load i32, ptr %arrayidx85, align 4, !tbaa !5, !invariant.load !13
  %15 = zext i32 %14 to i64
  %cmp86 = icmp eq i64 %indvars.iv37, %15
...
land.end:                                         ; preds = %land.lhs.true
  ...
  %cmp89 = icmp eq i64 %indvars.iv31, %17
  br i1 %cmp89, label %if.then92, label %for.inc95

if.then92:                                        ; preds = %land.end
  %18 = trunc nuw nsw i64 %indvars.iv31 to i32
  %19 = trunc nuw nsw i64 %indvars.iv37 to i32
...
for.inc98:                                        ; preds = %for.cond79, %if.then92
  %.pre = phi i32 [ %.pre.pre, %if.then92 ], [ %.pre40, %for.cond79 ]
