...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre63, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv57 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next58, %for.inc27 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %2
  br i1 %exitcond62.not, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc21 ], [ 0, %for.cond10 ]
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.148 = phi i32 [ %6, %for.end29.loopexit ], [ %smax, %for.cond10 ]
...
for.end51:                                        ; preds = %for.cond30, %for.body36
  %i.245 = phi i32 [ %i.2, %for.body36 ], [ %smin, %for.cond30 ]
  %j2.0 = phi i32 [ %j.2, %for.body36 ], [ undef, %for.cond30 ]
  %10 = xor i32 %i.148, -1
  %sub53 = add i32 %i.245, %10
