...
for.cond:                                         ; preds = %for.inc, %while.end
  %j.0 = phi i64 [ %i.0, %while.end ], [ %inc10, %for.inc ]
...
for.end:                                          ; preds = %for.cond
  ...
  %cmp12.not = icmp slt i64 %rem, %rem11
  %spec.select = select i1 %cmp12.not, i64 %e.0, i64 %i.0
  %spec.select31 = select i1 %cmp12.not, i64 %i.0, i64 %e.0
  %div28 = sdiv i64 %e.0, %3
  %div31 = sdiv i64 %i.0, %3
  %4 = xor i64 %div31, -1
  %sub33 = add i64 %div28, %4
  %rem34 = srem i64 %spec.select, %3
  %rem35 = srem i64 %spec.select31, %3
  %5 = xor i64 %rem35, -1
  %sub37 = add i64 %rem34, %5
  %mul38 = mul nsw i64 %sub37, %sub33
