...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.end ], [ 0, %for.cond ]
...
for.end12:                                        ; preds = %for.cond1
  tail call void @_Z3Tryi(i32 noundef 0) #7
...
tailrecurse:                                      ; preds = %tailrecurse, %entry
  ...
  %sub = sub nsw i32 %1, %2
  tail call void @_Z1ri(i32 noundef %sub) #8
  %3 = load i32, ptr @n, align 4, !tbaa !5
  %sub1 = sub nsw i32 %3, %2
  tail call void @_Z1li(i32 noundef %sub1) #8
  ...
  tail call void @_Z3funi(i32 noundef %sub2) #8
...
define dso_local void @_Z1ri(i32 noundef %m) local_unnamed_addr #5 {
entry:
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end27
  %indvars.iv22 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next23, %for.end27 ]
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc25 ], [ 0, %for.cond14.preheader ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv17
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @_Z1li(i32 noundef %m) local_unnamed_addr #5 {
entry:
  %cmp = icmp sgt i32 %m, 0
  %0 = load i32, ptr @a, align 16
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end26
  %indvars.iv22 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next23, %for.end26 ]
  br label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv22
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc24
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc24 ], [ 0, %for.cond13.preheader ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv17, i64 %indvars.iv22
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @_Z3funi(i32 noundef %m) local_unnamed_addr #5 {
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %m, i32 noundef 2)
  %smax23 = tail call i32 @llvm.smax.i32(i32 noundef %m, i32 noundef 0)
...
for.cond13.preheader:                             ; preds = %for.cond
  ...
  br i1 %cmp15, label %for.cond13.preheader17, label %for.end34

for.cond13.preheader17:                           ; preds = %for.cond13.preheader
  %wide.trip.count30 = zext nneg i32 %m to i64
  br label %for.cond13
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx9 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %1
...
for.cond13:                                       ; preds = %for.cond13.preheader17, %for.end31
  %indvars.iv32 = phi i64 [ 0, %for.cond13.preheader17 ], [ %indvars.iv.next33, %for.end31 ]
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond13, %for.inc29
  %indvars.iv26 = phi i64 [ 2, %for.cond13 ], [ %indvars.iv.next27, %for.inc29 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.end31, label %for.inc29
...
for.inc29:                                        ; preds = %for.cond17
  ...
  %arrayidx28 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %3, i64 %indvars.iv32
