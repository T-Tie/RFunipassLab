...
for.cond:                                         ; preds = %for.inc30, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc30 ], [ 0, %entry ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, 11
  br i1 %exitcond25.not, label %for.cond33, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [16 x [16 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.end:                                          ; preds = %for.body3, %for.body3, %for.cond1
  ...
  %arrayidx25 = getelementptr inbounds nuw [16 x [16 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %idxprom24
...
for.cond33:                                       ; preds = %for.cond, %for.end
  ...
  call void @llvm.assume(i1 %cmp34.not)
  call void @llvm.lifetime.end.p0(i64 noundef 1024, ptr noundef nonnull %a) #6
  ret i32 0
}
