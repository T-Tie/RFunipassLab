...
while.body:                                       ; preds = %while.cond
  call void @_Z4zeroPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %m.0) #8
  %5 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %add = add nsw i32 %5, %s.0
  %dec = add nsw i32 %m.0, -1
  call void @_Z10subductionPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %m.0) #8
