...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv17, %2
  br i1 %cmp2, label %for.cond4, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond1
  %sub = add nsw i32 %1, -1
  %idxprom126 = sext i32 %sub to i64
  %smax61 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  %smax74 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc159
  %indvars.iv24 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next25, %for.inc159 ]
  %k.0 = phi i32 [ 0, %for.cond13.preheader ], [ %inc160, %for.inc159 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc159 ]
  %exitcond75.not = icmp eq i32 %k.0, %smax74
  br i1 %exitcond75.not, label %for.inc164, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  %smax49 = call i32 @llvm.smax.i32(i32 %indvars.iv24, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc55
  %indvars.iv31 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next32, %for.inc55 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count34
  br i1 %exitcond35.not, label %for.cond58.preheader, label %for.body19

for.cond58.preheader:                             ; preds = %for.cond16
  %wide.trip.count39 = zext i32 %indvars.iv24 to i64
  br label %for.cond58

for.body19:                                       ; preds = %for.cond16
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31
  %5 = load i32, ptr %arrayidx21, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond23

for.cond23:                                       ; preds = %for.body26, %for.body19
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body26 ], [ 0, %for.body19 ]
...
for.body26:                                       ; preds = %for.cond23
  %arrayidx30 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv20
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc52
  %indvars.iv26 = phi i64 [ 0, %for.cond39.preheader ], [ %indvars.iv.next27, %for.inc52 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.inc55, label %for.inc52

for.inc52:                                        ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv26
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc99
  %indvars.iv46 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next47, %for.inc99 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count34
  br i1 %exitcond51.not, label %for.end101, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv46
  %8 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond65

for.cond65:                                       ; preds = %for.body68, %for.body61
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body68 ], [ 0, %for.body61 ]
  %min.2 = phi i32 [ %spec.select15, %for.body68 ], [ %8, %for.body61 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond83.preheader, label %for.body68

for.cond83.preheader:                             ; preds = %for.cond65
  br label %for.cond83

for.body68:                                       ; preds = %for.cond65
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv36, i64 %indvars.iv46
  %9 = load i32, ptr %arrayidx72, align 4, !tbaa !5, !invariant.load !13
  %spec.select15 = call i32 @llvm.smin.i32(i32 %9, i32 %min.2)
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond65, !llvm.loop !17

for.cond83:                                       ; preds = %for.cond83.preheader, %for.inc96
  %indvars.iv41 = phi i64 [ 0, %for.cond83.preheader ], [ %indvars.iv.next42, %for.inc96 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count39
  br i1 %exitcond45.not, label %for.inc99, label %for.inc96

for.inc96:                                        ; preds = %for.cond83
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %indvars.iv46
...
for.cond104:                                      ; preds = %for.inc128, %for.end101
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc128 ], [ 0, %for.end101 ]
  %exitcond63.not = icmp eq i64 %indvars.iv57, %wide.trip.count62
  br i1 %exitcond63.not, label %for.cond131, label %for.cond107

for.cond107:                                      ; preds = %for.cond104, %for.inc120
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc120 ], [ 1, %for.cond104 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count55
  br i1 %exitcond56.not, label %for.inc128, label %for.inc120

for.inc120:                                       ; preds = %for.cond107
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv.next53
  %12 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !13
  %arrayidx119 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv52
  store i32 %12, ptr %arrayidx119, align 4, !tbaa !5
  br label %for.cond107, !llvm.loop !20

for.inc128:                                       ; preds = %for.cond107
  %arrayidx127 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %idxprom126
...
for.cond131:                                      ; preds = %for.cond104, %for.inc156
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc156 ], [ 0, %for.cond104 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %wide.trip.count72
  br i1 %exitcond73.not, label %for.inc159, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond68.not = icmp eq i64 %indvars.iv64, %wide.trip.count72
  br i1 %exitcond68.not, label %for.inc156, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next65, i64 %indvars.iv69
  %13 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !13
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv64, i64 %indvars.iv69
  store i32 %13, ptr %arrayidx147, align 4, !tbaa !5
  br label %for.cond135, !llvm.loop !22

for.inc156:                                       ; preds = %for.cond135
  %arrayidx155 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom126, i64 %indvars.iv69
