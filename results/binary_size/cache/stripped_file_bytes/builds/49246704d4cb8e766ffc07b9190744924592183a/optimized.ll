...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 11000, ptr %str) #8
  call void @llvm.lifetime.start.p0(i64 400, ptr %lon) #8
  call void @llvm.memset.p0.i64(ptr align 16 %lon, i8 0, i64 400, i1 false)
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr %c) #8
  br label %do.body
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx = getelementptr inbounds [100 x [110 x i8]], ptr %str, i64 0, i64 %idxprom
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %idxprom3 = sext i32 %4 to i64
  %arrayidx4 = getelementptr inbounds [100 x i32], ptr %lon, i64 0, i64 %idxprom3
  %5 = load i32, ptr %arrayidx4, align 4, !tbaa !5
  %idxprom5 = sext i32 %5 to i64
  %arrayidx6 = getelementptr inbounds [110 x i8], ptr %arrayidx, i64 0, i64 %idxprom5
  store i8 %2, ptr %arrayidx6, align 1, !tbaa !9
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %idxprom7 = sext i32 %6 to i64
  %arrayidx8 = getelementptr inbounds [100 x i32], ptr %lon, i64 0, i64 %idxprom7
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %do.body
  %8 = load i8, ptr %c, align 1, !tbaa !9
...
if.then11:                                        ; preds = %if.end
  ...
  store i32 %inc12, ptr %n, align 4, !tbaa !5
  br label %if.end13
...
do.cond:                                          ; preds = %if.end13
  %10 = load i8, ptr %c, align 1, !tbaa !9
...
for.cond:                                         ; preds = %for.inc33, %do.end
  %12 = load i32, ptr %i, align 4, !tbaa !5
  %cmp16 = icmp sge i32 %12, 0
  br i1 %cmp16, label %for.body, label %for.end34
...
for.cond17:                                       ; preds = %for.inc, %for.body
  ...
  %arrayidx19 = getelementptr inbounds [100 x i32], ptr %lon, i64 0, i64 %idxprom18
...
for.body21:                                       ; preds = %for.cond17
  ...
  %arrayidx23 = getelementptr inbounds [100 x [110 x i8]], ptr %str, i64 0, i64 %idxprom22
  %17 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom24 = sext i32 %17 to i64
  %arrayidx25 = getelementptr inbounds [110 x i8], ptr %arrayidx23, i64 0, i64 %idxprom24
  %18 = load i8, ptr %arrayidx25, align 1, !tbaa !9
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %18)
  br label %for.inc
...
if.else:                                          ; preds = %for.end
  %call31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %if.end32
...
for.end34:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 1, ptr %c) #8
  ...
  call void @llvm.lifetime.end.p0(i64 400, ptr %lon) #8
  call void @llvm.lifetime.end.p0(i64 11000, ptr %str) #8
  ret i32 0
}
...
entry:
  ...
  %0 = load ptr, ptr %__os.addr, align 8, !tbaa !15, !nonnull !18, !align !19
  %1 = load ptr, ptr %__os.addr, align 8, !tbaa !15, !nonnull !18, !align !19
...
!37 = !{!38, !41, i64 240}
!38 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !26, i64 0, !16, i64 216, !7, i64 224, !39, i64 225, !40, i64 232, !41, i64 240, !42, i64 248, !43, i64 256}
!39 = !{!"bool", !7, i64 0}
!40 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !17, i64 0}
!41 = !{!"p1 _ZTSSt5ctypeIcE", !17, i64 0}
!42 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!43 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!44 = !{!41, !41, i64 0}
!45 = !{!46, !7, i64 56}
...
!48 = !{!"p1 _ZTS15__locale_struct", !17, i64 0}
!49 = !{!"p1 int", !17, i64 0}
!50 = !{!"p1 short", !17, i64 0}
