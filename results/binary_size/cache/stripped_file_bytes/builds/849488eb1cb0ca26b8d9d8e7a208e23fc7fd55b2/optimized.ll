...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv17, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv24 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next25, %for.inc28 ]
  %s.0 = phi i32 [ 0, %for.cond10.preheader ], [ %s.1, %for.inc28 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count28
  br i1 %exitcond29.not, label %for.end30, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc25
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc25 ], [ 0, %for.cond10 ]
  %exitcond.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond.not, label %for.inc28, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv20
...
for.cond31:                                       ; preds = %for.inc52, %for.end30
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc52 ], [ %7, %for.end30 ]
...
for.cond35:                                       ; preds = %for.cond31, %for.inc50
  %sub.sink7 = phi i32 [ %dec, %for.inc50 ], [ %sub, %for.cond31 ]
  %cmp36 = icmp sgt i32 %sub.sink7, 0
  br i1 %cmp36, label %for.body37, label %for.inc52

for.body37:                                       ; preds = %for.cond35
  %idxprom40 = zext nneg i32 %sub.sink7 to i64
  %arrayidx41 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %idxprom40
...
if.then43:                                        ; preds = %for.body37
  ...
  store i32 %sub.sink7, ptr %arrayidx48, align 4, !tbaa !5
  br label %for.inc52

for.inc50:                                        ; preds = %for.body37
  %dec = add nsw i32 %sub.sink7, -1
