...
for.end10:                                        ; preds = %for.inc8, %entry
  ...
  %or.cond71 = select i1 %cmp14.not37, i1 true, i1 %12
  br i1 %or.cond71, label %for.cond30.preheader, label %for.cond16.preheader
...
for.cond30.preheader:                             ; preds = %for.inc27, %for.end10
  ...
  %cmp31.not44 = icmp slt i32 %15, 1
  br i1 %cmp31.not44, label %for.end76, label %for.cond33.preheader
...
for.body18:                                       ; preds = %for.cond16.preheader, %for.body18
  ...
  %cmp17.not.not = icmp slt i64 %indvars.iv52, %17
...
for.inc27:                                        ; preds = %for.inc27.loopexit, %for.cond16.preheader
  %18 = phi i32 [ %.pre67, %for.inc27.loopexit ], [ %13, %for.cond16.preheader ]
  %19 = phi i32 [ %16, %for.inc27.loopexit ], [ %14, %for.cond16.preheader ]
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %20 = sext i32 %18 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv55, %20
...
for.cond33.preheader:                             ; preds = %for.cond30.preheader, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit ], [ 1, %for.cond30.preheader ]
  %21 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp34.not42 = icmp slt i32 %21, 1
  br i1 %cmp34.not42, label %for.end72, label %for.body35

for.body35:                                       ; preds = %for.cond33.preheader, %for.inc70
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc70 ], [ 1, %for.cond33.preheader ]
  %22 = load i32, ptr %y1, align 4, !tbaa !5
  %cmp41.not39 = icmp slt i32 %22, 1
  br i1 %cmp41.not39, label %for.end57, label %for.body42.lr.ph

for.body42.lr.ph:                                 ; preds = %for.body35
  %23 = add nuw i32 %22, 1
...
vector.ph:                                        ; preds = %for.body42.lr.ph
  %n.vec = and i64 %24, 2147483644
  %25 = or disjoint i64 %n.vec, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %28 = add i64 %index, 4
  %29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv64, i64 %offset.idx
  %wide.load = load <4 x i32>, ptr %29, align 4, !tbaa !5
  %30 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %offset.idx, i64 %indvars.iv61
  %31 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %26, i64 %indvars.iv61
  %32 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %27, i64 %indvars.iv61
  %33 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %28, i64 %indvars.iv61
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end57, label %for.body42.preheader

for.body42.preheader:                             ; preds = %for.body42.lr.ph, %middle.block
  %indvars.iv58.ph = phi i64 [ 1, %for.body42.lr.ph ], [ %25, %middle.block ]
  %add41.ph = phi i32 [ 0, %for.body42.lr.ph ], [ %45, %middle.block ]
  br label %for.body42

for.body42:                                       ; preds = %for.body42.preheader, %for.body42
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.body42 ], [ %indvars.iv58.ph, %for.body42.preheader ]
  %add41 = phi i32 [ %add, %for.body42 ], [ %add41.ph, %for.body42.preheader ]
  ...
  %add = add nsw i32 %add41, %mul
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next59, %wide.trip.count
  br i1 %exitcond.not, label %for.end57, label %for.body42, !llvm.loop !19

for.end57:                                        ; preds = %for.body42, %middle.block, %for.body35
  %48 = phi i32 [ 0, %for.body35 ], [ %45, %middle.block ], [ %add, %for.body42 ]
  %cmp58 = icmp eq i64 %indvars.iv61, 1
  br i1 %cmp58, label %for.inc70, label %if.else
...
for.inc70:                                        ; preds = %for.end57, %if.else
  %call63 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %48)
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %49 = load i32, ptr %y2, align 4, !tbaa !5
  %50 = sext i32 %49 to i64
  %cmp34.not.not = icmp slt i64 %indvars.iv61, %50
  br i1 %cmp34.not.not, label %for.body35, label %for.end72, !llvm.loop !20

for.end72:                                        ; preds = %for.inc70, %for.cond33.preheader
  ...
  %51 = load ptr, ptr %gep, align 8, !tbaa !23
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %cmp31.not.not = icmp slt i64 %indvars.iv64, %56
  br i1 %cmp31.not.not, label %for.cond33.preheader, label %for.end76, !llvm.loop !48

for.end76:                                        ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit, %for.cond30.preheader
