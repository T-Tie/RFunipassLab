...
while.cond3:                                      ; preds = %while.cond3.preheader, %if.end
  %indvars.iv22 = phi i64 [ 0, %while.cond3.preheader ], [ %indvars.iv.next23, %if.end ]
  %4 = add nuw nsw i64 %indvars.iv22, %3
  %cmp5 = icmp slt i64 %4, %1
  br i1 %cmp5, label %while.body6, label %while.cond, !llvm.loop !12

while.body6:                                      ; preds = %while.cond3
  %arrayidx8 = getelementptr inbounds [110 x i32], ptr %a, i64 0, i64 %indvars.iv22
...
while.end25:                                      ; preds = %while.cond
  ...
  %div20 = lshr i32 %sec.0, 2
  %idxprom29 = zext nneg i32 %div20 to i64
  ...
  %spec.select = select i1 %cmp34, i32 %div20, i32 %mul31
