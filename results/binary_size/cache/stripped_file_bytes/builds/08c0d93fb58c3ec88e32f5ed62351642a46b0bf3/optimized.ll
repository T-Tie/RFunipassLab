...
entry:
  ...
  %1 = sext i32 %0 to i64
  %smax82 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count23 = zext i32 %0 to i64
  br label %while.cond

while.cond:                                       ; preds = %for.end143, %entry
  %q.0 = phi i32 [ 0, %entry ], [ %inc146, %for.end143 ]
  %exitcond83.not = icmp eq i32 %q.0, %smax82
  br i1 %exitcond83.not, label %while.end, label %for.cond

for.cond:                                         ; preds = %while.cond, %for.inc8
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc8 ], [ 0, %while.cond ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end10, label %for.cond2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.inc141, %for.end10
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc141 ], [ %1, %for.end10 ]
  %indvars.iv68.in = phi i32 [ %indvars.iv68, %for.inc141 ], [ %0, %for.end10 ]
  %m.0 = phi i32 [ %inc142, %for.inc141 ], [ 1, %for.end10 ]
  %s.0 = phi i32 [ %add, %for.inc141 ], [ 0, %for.end10 ]
  %indvars.iv68 = add i32 %indvars.iv68.in, -1
  %smax75 = call i32 @llvm.smax.i32(i32 %indvars.iv68, i32 noundef 1)
  %exitcond81.not = icmp eq i32 %m.0, %0
  br i1 %exitcond81.not, label %for.end143, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %2 = trunc nsw i64 %indvars.iv78 to i32
  %smax62 = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %wide.trip.count38 = zext nneg i32 %smax62 to i64
  %wide.trip.count28 = and i64 %indvars.iv78, 4294967295
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc50
  %indvars.iv35 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next36, %for.inc50 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count38
  br i1 %exitcond39.not, label %for.cond53.preheader, label %for.body16

for.cond53.preheader:                             ; preds = %for.cond14
  %wide.trip.count43 = and i64 %indvars.iv78, 4294967295
  br label %for.cond53

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv35
  %3 = load i32, ptr %arrayidx18, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body22 ], [ 0, %for.body16 ]
  %l.0 = phi i32 [ %spec.select, %for.body22 ], [ %3, %for.body16 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.cond35.preheader, label %for.body22

for.cond35.preheader:                             ; preds = %for.cond20
  br label %for.cond35

for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv35, i64 %indvars.iv25
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc47
  %indvars.iv30 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next31, %for.inc47 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count28
  br i1 %exitcond34.not, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv35, i64 %indvars.iv30
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc91
  %indvars.iv50 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next51, %for.inc91 ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count38
  br i1 %exitcond55.not, label %for.end93, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx58 = getelementptr inbounds nuw [200 x i32], ptr %a, i64 0, i64 %indvars.iv50
  %6 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond59

for.cond59:                                       ; preds = %for.body61, %for.body55
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body61 ], [ 0, %for.body55 ]
  %l.2 = phi i32 [ %spec.select17, %for.body61 ], [ %6, %for.body55 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond76.preheader, label %for.body61

for.cond76.preheader:                             ; preds = %for.cond59
  br label %for.cond76

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv40, i64 %indvars.iv50
  %7 = load i32, ptr %arrayidx65, align 4, !tbaa !5, !invariant.load !13
  %spec.select17 = call i32 @llvm.smin.i32(i32 %l.2, i32 %7)
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  br label %for.cond59, !llvm.loop !17

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc88
  %indvars.iv45 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next46, %for.inc88 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count43
  br i1 %exitcond49.not, label %for.inc91, label %for.inc88

for.inc88:                                        ; preds = %for.cond76
  %arrayidx82 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv45, i64 %indvars.iv50
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  ...
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count38
  br i1 %exitcond64.not, label %for.cond118.preheader, label %for.cond99
...
for.cond99:                                       ; preds = %for.cond96, %for.inc112
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc112 ], [ 1, %for.cond96 ]
  %cmp101 = icmp slt i64 %indvars.iv56, %indvars.iv.next79
  br i1 %cmp101, label %for.inc112, label %for.inc115

for.inc112:                                       ; preds = %for.cond99
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %arrayidx107 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv.next57
  %10 = load i32, ptr %arrayidx107, align 4, !tbaa !5, !invariant.load !13
  %arrayidx111 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv56
...
for.cond118:                                      ; preds = %for.cond122, %for.cond118.preheader
  %indvars.iv72 = phi i64 [ 1, %for.cond118.preheader ], [ %indvars.iv.next73, %for.cond122 ]
  %exitcond77.not = icmp eq i64 %indvars.iv72, %wide.trip.count76
  br i1 %exitcond77.not, label %for.inc141, label %for.cond122.preheader
...
for.cond122:                                      ; preds = %for.cond122.preheader, %for.inc135
  %indvars.iv65 = phi i64 [ 0, %for.cond122.preheader ], [ %indvars.iv.next66, %for.inc135 ]
  %exitcond71.not = icmp eq i64 %indvars.iv65, %wide.trip.count70
  br i1 %exitcond71.not, label %for.cond118, label %for.inc135, !llvm.loop !22

for.inc135:                                       ; preds = %for.cond122
  %arrayidx130 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv.next73, i64 %indvars.iv65
  %11 = load i32, ptr %arrayidx130, align 4, !tbaa !5, !invariant.load !13
  %arrayidx134 = getelementptr inbounds nuw [200 x [200 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv65
...
for.inc141:                                       ; preds = %for.cond118
  ...
  %12 = trunc nsw i64 %indvars.iv.next79 to i32
