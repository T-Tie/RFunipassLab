...
for.cond5.preheader:                              ; preds = %for.cond
  %smax8 = call i32 @llvm.smax.i32(i32 %0, i32 0)
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc22
  %indvars.iv11 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next12, %for.inc22 ]
  %exitcond15 = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond15, label %for.cond25.preheader, label %for.cond9

for.cond25.preheader:                             ; preds = %for.cond5
  %smax29 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %wide.trip.count30 = zext nneg i32 %smax29 to i64
  %wide.trip.count26 = zext i32 %sub to i64
  %wide.trip.count19 = zext nneg i32 %smax8 to i64
  br label %for.cond25

for.cond9:                                        ; preds = %for.cond5, %for.inc19
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc19 ], [ 0, %for.cond5 ]
  %exitcond10.not = icmp eq i64 %indvars.iv4, %wide.trip.count9
  br i1 %exitcond10.not, label %for.inc22, label %for.inc19

for.inc19:                                        ; preds = %for.cond9
  %2 = add nuw nsw i64 %indvars.iv4, %indvars.iv11
  ...
  %arrayidx17 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv11, i64 %indvars.iv4
...
for.cond25:                                       ; preds = %for.cond25.preheader, %for.inc69
  %indvars.iv21 = phi i64 [ 0, %for.cond25.preheader ], [ %indvars.iv.next22, %for.inc69 ]
  %exitcond31.not = icmp eq i64 %indvars.iv21, %wide.trip.count30
  br i1 %exitcond31.not, label %for.end71, label %for.cond30.preheader

for.cond30.preheader:                             ; preds = %for.cond25
  %arrayidx35 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv21
  %arrayidx54 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv21
  br label %for.cond30

for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc66
  %indvars.iv23 = phi i64 [ %indvars.iv21, %for.cond30.preheader ], [ %indvars.iv.next24, %for.inc66 ]
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.inc69, label %for.body33
...
land.lhs.true:                                    ; preds = %for.body33
  %arrayidx40 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv.next24
...
for.cond56:                                       ; preds = %for.inc63, %if.then
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc63 ], [ 0, %if.then ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond56
  %arrayidx62 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv.next24, i64 %indvars.iv16
...
for.end71:                                        ; preds = %for.cond25
  ...
  %8 = add nuw i32 %smax29, 1
  %wide.trip.count35 = zext i32 %8 to i64
  br label %for.cond73

for.cond73:                                       ; preds = %for.body76, %for.end71
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body76 ], [ 1, %for.end71 ]
  %m.0 = phi i32 [ %spec.select, %for.body76 ], [ %7, %for.end71 ]
  %exitcond36 = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36, label %for.end86, label %for.body76

for.body76:                                       ; preds = %for.cond73
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv32
...
if.then88:                                        ; preds = %for.end86
  %puts2 = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  br label %cleanup
...
for.cond91:                                       ; preds = %for.inc104, %if.else
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc104 ], [ 0, %if.else ]
  %10 = load i32, ptr %n, align 4, !tbaa !5
  %sub92 = sub nsw i32 %conv, %10
  %11 = sext i32 %sub92 to i64
  %cmp93.not = icmp sgt i64 %indvars.iv37, %11
  br i1 %cmp93.not, label %cleanup, label %for.body94

for.body94:                                       ; preds = %for.cond91
  %arrayidx96 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv37
...
if.then98:                                        ; preds = %for.body94
  %arrayidx100 = getelementptr inbounds nuw [500 x [5 x i8]], ptr %str, i64 0, i64 %indvars.iv37
