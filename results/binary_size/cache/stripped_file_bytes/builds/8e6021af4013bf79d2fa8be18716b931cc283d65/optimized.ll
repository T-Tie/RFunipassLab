...
define dso_local void @_Z6divideii(i32 noundef %num, i32 noundef %x) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load i32, ptr @numcount, align 4, !tbaa !5
  %inc = add nsw i32 %1, 1
...
entry:
  ...
  store i32 2, ptr %first, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 400, ptr %ans) #6
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_Z6divideii(i32 noundef %2, i32 noundef %3)
  %4 = load i32, ptr @numcount, align 4, !tbaa !5
  %5 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom = sext i32 %5 to i64
  %arrayidx = getelementptr inbounds [100 x i32], ptr %ans, i64 0, i64 %idxprom
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds [100 x i32], ptr %ans, i64 0, i64 %idxprom5
  %10 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
...
for.end11:                                        ; preds = %for.cond2
  call void @llvm.lifetime.end.p0(i64 400, ptr %ans) #6
