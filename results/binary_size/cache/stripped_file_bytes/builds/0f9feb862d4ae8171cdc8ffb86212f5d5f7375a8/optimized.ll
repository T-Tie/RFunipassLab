...
for.cond7:                                        ; preds = %for.cond, %for.end34
  %2 = phi i32 [ %.pre24, %for.end34 ], [ %0, %for.cond ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.end34 ], [ 0, %for.cond ]
...
for.cond12:                                       ; preds = %for.cond7, %for.body16
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body16 ], [ 0, %for.cond7 ]
  %sum.1 = phi i32 [ %spec.select, %for.body16 ], [ %sum.0, %for.cond7 ]
  %arrayidx14 = getelementptr inbounds nuw [16 x i32], ptr %num, i64 0, i64 %indvars.iv18
...
for.end34:                                        ; preds = %for.cond12
  ...
  %arrayidx9.phi.trans.insert = getelementptr inbounds nuw [16 x i32], ptr %num, i64 0, i64 %indvars.iv.next22
  %.pre24 = load i32, ptr %arrayidx9.phi.trans.insert, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond7
