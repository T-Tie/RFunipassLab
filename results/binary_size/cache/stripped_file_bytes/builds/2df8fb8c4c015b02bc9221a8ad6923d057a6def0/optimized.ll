...
for.cond:                                         ; preds = %for.inc9, %entry
  ...
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc9 ], [ 0, %entry ]
  %12 = sext i32 %11 to i64
  %cmp = icmp slt i64 %indvars.iv15, %12
  br i1 %cmp, label %for.cond3.preheader, label %for.cond12.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %13 = mul nuw nsw i64 %indvars.iv15, %3
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %14 = phi i32 [ %10, %for.cond3.preheader ], [ %.pre59, %for.inc ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.inc20
  %indvars.iv18 = phi i64 [ 0, %for.cond12.preheader ], [ %indvars.iv.next19, %for.inc20 ]
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv22 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next23, %for.inc31 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond34, label %for.inc31

for.inc31:                                        ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv22
  %18 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv22
  store i32 %18, ptr %arrayidx30, align 4, !tbaa !5
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  br label %for.cond23, !llvm.loop !15

for.cond34:                                       ; preds = %for.cond23, %for.inc56
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc56 ], [ 0, %for.cond23 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond37.not, label %for.cond59, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond34
  %19 = mul nuw nsw i64 %indvars.iv33, %3
  %arrayidx41 = getelementptr inbounds nuw i32, ptr %vla, i64 %19
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv33
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv28 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next29, %for.body39 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count26
  br i1 %exitcond32.not, label %for.inc56, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw i32, ptr %arrayidx41, i64 %indvars.iv28
...
for.cond59:                                       ; preds = %for.cond34, %for.inc83
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc83 ], [ 0, %for.cond34 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count26
  br i1 %exitcond47.not, label %for.cond86, label %for.cond62.preheader

for.cond62.preheader:                             ; preds = %for.cond59
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv43
  %arrayidx70 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv43
  br label %for.cond62

for.cond62:                                       ; preds = %for.cond62.preheader, %for.body64
  %indvars.iv38 = phi i64 [ 0, %for.cond62.preheader ], [ %indvars.iv.next39, %for.body64 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count
  br i1 %exitcond42.not, label %for.inc83, label %for.body64

for.body64:                                       ; preds = %for.cond62
  %22 = mul nuw nsw i64 %indvars.iv38, %3
  ...
  %spec.store.select12 = call i32 @llvm.smin.i32(i32 %23, i32 %24)
  store i32 %spec.store.select12, ptr %arrayidx70, align 4
...
for.cond86:                                       ; preds = %for.cond59, %for.inc103
  %.pre5556 = phi i32 [ %.pre5557, %for.inc103 ], [ %10, %for.cond59 ]
  %25 = phi i32 [ %29, %for.inc103 ], [ %10, %for.cond59 ]
  %26 = phi i32 [ %.pre54, %for.inc103 ], [ %11, %for.cond59 ]
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc103 ], [ 0, %for.cond59 ]
  %k.0 = phi i32 [ %k.1, %for.inc103 ], [ 0, %for.cond59 ]
  %27 = sext i32 %26 to i64
  %cmp87 = icmp slt i64 %indvars.iv51, %27
  br i1 %cmp87, label %for.cond89.preheader, label %for.end105

for.cond89.preheader:                             ; preds = %for.cond86
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv51
  %28 = trunc nuw nsw i64 %indvars.iv51 to i32
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc100
  %.pre5557 = phi i32 [ %.pre5556, %for.cond89.preheader ], [ %.pre55, %for.inc100 ]
  %29 = phi i32 [ %25, %for.cond89.preheader ], [ %.pre55, %for.inc100 ]
  %indvars.iv48 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next49, %for.inc100 ]
  %k.1 = phi i32 [ %k.0, %for.cond89.preheader ], [ %k.2, %for.inc100 ]
  %30 = sext i32 %29 to i64
  %cmp90 = icmp slt i64 %indvars.iv48, %30
...
for.body91:                                       ; preds = %for.cond89
  ...
  %arrayidx95 = getelementptr inbounds nuw i32, ptr %vla2, i64 %indvars.iv48
...
for.inc103:                                       ; preds = %for.cond89
  ...
  %.pre54 = load i32, ptr %m, align 4, !tbaa !5
