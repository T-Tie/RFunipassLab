...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call3 = call noundef i32 @_ZNSi3getEv(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin)
  %cmp.not = icmp eq i32 %call3, 10
  br i1 %cmp.not, label %for.end, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30: ; preds = %for.cond
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr8.i13, ptr noundef nonnull align 16 dereferenceable(50) %str)
...
land.lhs.true.i:                                  ; preds = %entry_to_outline
  ...
  %2 = load i64, ptr %_M_width.i4.i, align 8, !tbaa !12, !invariant.load !8
  %3 = add i64 %2, -51
