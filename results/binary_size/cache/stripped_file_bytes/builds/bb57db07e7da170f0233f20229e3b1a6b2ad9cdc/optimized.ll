...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond3 = select i1 %or.cond2, i1 %cmp6, i1 false
  %4 = load i32, ptr %e, align 4
  %cmp8 = icmp eq i32 %4, 0
  %or.cond4 = select i1 %or.cond3, i1 %cmp8, i1 false
  %5 = load i32, ptr %f, align 4
  %cmp10 = icmp eq i32 %5, 0
  %or.cond5 = select i1 %or.cond4, i1 %cmp10, i1 false
  br i1 %or.cond5, label %cleanup, label %if.else

if.else:                                          ; preds = %for.body
  %cmp11.not = icmp sgt i32 %2, %5
  %cmp13.not = icmp sgt i32 %1, %4
  %or.cond10 = select i1 %cmp11.not, i1 true, i1 %cmp13.not
  br i1 %or.cond10, label %if.else21, label %if.then14
...
if.then14:                                        ; preds = %if.else
  ...
  %add17 = sub i32 %5, %2
  %sub18 = add i32 %add17, %mul16
  %add20 = add i32 %sub18, %mul
  br label %for.inc

if.else21:                                        ; preds = %if.else
  %cmp22.not = icmp slt i32 %2, %5
  %cmp24.not = icmp sgt i32 %1, %4
  %or.cond11 = select i1 %cmp22.not, i1 true, i1 %cmp24.not
  br i1 %or.cond11, label %if.else35, label %if.then25

if.then25:                                        ; preds = %if.else21
  %reass.sub7 = sub i32 %3, %0
  %7 = mul i32 %reass.sub7, 3600
  %mul28 = add i32 %7, 43200
...
if.else35:                                        ; preds = %if.else21
  ...
  %or.cond12 = select i1 %cmp11.not, i1 true, i1 %cmp38.not
  br i1 %or.cond12, label %if.else49, label %if.then39

if.then39:                                        ; preds = %if.else35
  %reass.sub8 = sub i32 %3, %0
  %8 = mul i32 %reass.sub8, 3600
  %mul42 = add i32 %8, 43200
...
if.else49:                                        ; preds = %if.else35
  ...
  %or.cond13 = select i1 %cmp22.not, i1 true, i1 %cmp52.not
  br i1 %or.cond13, label %for.inc, label %if.then53

if.then53:                                        ; preds = %if.else49
  %reass.sub9 = sub i32 %3, %0
  %9 = mul i32 %reass.sub9, 3600
  %mul56 = add i32 %9, 43200
