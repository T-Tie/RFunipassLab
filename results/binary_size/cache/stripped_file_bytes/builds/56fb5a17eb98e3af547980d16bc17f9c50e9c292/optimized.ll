...
entry:
  ...
  %1 = add nuw i32 %smax14, 1
  br label %for.cond

for.cond:                                         ; preds = %entry
  %exitcond15 = icmp eq i32 1, %1
  br i1 %exitcond15, label %for.cond36.preheader, label %for.cond1
...
for.body15.for.inc30_crit_edge:                   ; No predecessors!
  unreachable
...
for.cond36:                                       ; preds = %for.cond36.preheader
  br label %for.body38
