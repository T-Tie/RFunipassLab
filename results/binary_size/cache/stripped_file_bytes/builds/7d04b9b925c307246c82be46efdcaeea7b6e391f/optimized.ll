...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %str) #10
  %vtable7.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !5, !invariant.load !8
  %vbase.offset.ptr8.i = getelementptr i8, ptr %vtable7.i, i64 -24
  call void @outlined_ir_func_0(ptr %vbase.offset.ptr8.i, ptr nonnull %str)
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call3 = call noundef i32 @_ZNSi3getEv(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin)
  %cmp.not = icmp eq i32 %call3, 10
  br i1 %cmp.not, label %for.end, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %for.cond
  call void @outlined_ir_func_0(ptr %vbase.offset.ptr8.i11, ptr nonnull %str)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull captures(none) %str) #11
  ret i32 0
}
...
define internal void @outlined_ir_func_0(ptr readonly captures(none) %0, ptr %1) #9 {
entry_to_outline:
