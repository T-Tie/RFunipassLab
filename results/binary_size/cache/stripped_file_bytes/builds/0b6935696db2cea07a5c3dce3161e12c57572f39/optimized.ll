...
entry:
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %wide.trip.count35 = zext nneg i32 %smax34 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %if.end20, %entry
  %indvars.iv45 = phi i32 [ %indvars.iv.next46, %if.end20 ], [ %conv7, %entry ]
  %indvars.iv40 = phi i32 [ %indvars.iv.next41, %if.end20 ], [ 0, %entry ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %if.end20 ], [ 0, %entry ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %if.then25, label %for.cond8
...
for.cond28.preheader:                             ; preds = %for.cond8
  %wide.trip.count43 = zext i32 %indvars.iv40 to i64
  br label %for.cond28

for.body10:                                       ; preds = %for.cond8
  %0 = add nuw nsw i64 %indvars.iv, %indvars.iv31
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  ...
  br i1 %exitcond44.not, label %for.end37, label %for.body30
...
for.end37:                                        ; preds = %for.cond28
  ...
  %4 = sext i32 %indvars.iv45 to i64
  %sext51 = shl i64 %call4, 32
  %5 = ashr exact i64 %sext51, 32
  br label %for.cond41

for.cond41:                                       ; preds = %for.body43, %for.end37
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body43 ], [ %4, %for.end37 ]
  %cmp42 = icmp slt i64 %indvars.iv48, %5
  br i1 %cmp42, label %for.body43, label %if.end51

for.body43:                                       ; preds = %for.cond41
  %arrayidx45 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv48
