...
if.then:                                          ; preds = %entry
  %div17 = udiv i32 %0, 100
  %rem18 = urem i32 %0, 100
  store i32 %rem18, ptr %n, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %a.0 = phi i32 [ %div17, %if.then ], [ 0, %entry ]
  %1 = phi i32 [ %rem18, %if.then ], [ %0, %entry ]
...
if.then7:                                         ; preds = %if.end5
  ...
  %div819 = udiv i8 %div8.lhs.trunc, 20
  %div8.zext = zext nneg i8 %div819 to i32
  %rem920 = urem i8 %div8.lhs.trunc, 20
  %rem9.zext = zext nneg i8 %rem920 to i32
