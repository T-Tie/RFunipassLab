...
for.cond:                                         ; preds = %for.end42, %entry
  ...
  %exitcond28 = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28, label %for.end50, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond
  br i1 %cmp5, label %for.cond4, label %for.cond9.preheader

for.cond4:                                        ; preds = %for.cond4.preheader, %for.cond4
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.cond4 ], [ 0, %for.cond4.preheader ]
  %arrayidx = getelementptr inbounds nuw [503 x i8], ptr @strin, i64 0, i64 %indvars.iv29
  %4 = load i8, ptr %arrayidx, align 1, !tbaa !9, !invariant.load !10
  %arrayidx8 = getelementptr inbounds nuw [10 x i8], ptr @str2, i64 0, i64 %indvars.iv29
...
for.cond56:                                       ; preds = %if.end75, %if.else
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %if.end75 ], [ 0, %if.else ]
...
for.cond64:                                       ; preds = %for.body59, %for.body66
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body66 ], [ 0, %for.body59 ]
  %cmp65 = icmp sgt i32 %10, 0
  br i1 %cmp65, label %for.body66, label %for.end73

for.body66:                                       ; preds = %for.cond64
  %11 = add nuw nsw i64 %indvars.iv33, %indvars.iv37
