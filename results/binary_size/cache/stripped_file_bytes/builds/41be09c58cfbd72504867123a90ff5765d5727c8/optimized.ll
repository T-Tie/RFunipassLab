; ModuleID = '/tmp/tmppzfs0qzq.cpp'
source_filename = "/tmp/tmppzfs0qzq.cpp"
...
define dso_local void @_Z6numberii(i32 noundef %x, i32 noundef %y) #0 {
entry:
...
if.then3:                                         ; preds = %for.body
  ...
  call void @_Z6numberii(i32 noundef %div, i32 noundef %9)
  br label %if.end4
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_Z6numberii(i32 noundef %2, i32 noundef %3)
