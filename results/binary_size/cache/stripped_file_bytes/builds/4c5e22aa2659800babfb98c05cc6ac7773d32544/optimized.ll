...
for.end:                                          ; preds = %for.cond
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc27, %for.end
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc27 ], [ 1, %for.end ]
  %k.0 = phi i32 [ %k.1, %for.inc27 ], [ 1, %for.end ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end29, label %for.cond8.preheader

for.cond8.preheader:                              ; preds = %for.cond5
  %arrayidx12 = getelementptr inbounds nuw [310 x i32], ptr %x, i64 0, i64 %indvars.iv22
  %smax = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc16
  %indvars.iv19 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next20, %for.inc16 ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  %arrayidx14 = getelementptr inbounds nuw [310 x i32], ptr %y, i64 0, i64 %indvars.iv19
...
for.cond32:                                       ; preds = %for.body34, %for.end29
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body34 ], [ 1, %for.end29 ]
  %exitcond35.not = icmp eq i64 %indvars.iv29, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end40, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx36 = getelementptr inbounds nuw [310 x i32], ptr %y, i64 0, i64 %indvars.iv29
