...
entry:
  ...
  br i1 %cmp65, label %for.body, label %for.end194

for.cond127.preheader:                            ; preds = %for.inc
  %1 = icmp sgt i32 %7, 0
  br i1 %1, label %for.body129, label %for.end194
...
for.inc:                                          ; preds = %if.end82, %if.then96
  ...
  br i1 %cmp, label %for.body, label %for.cond127.preheader, !llvm.loop !11

for.body129:                                      ; preds = %for.cond127.preheader, %for.inc192
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc192 ], [ 0, %for.cond127.preheader ]
...
if.then143:                                       ; preds = %for.body129
  ...
  %.pre = load double, ptr %arrayidx131, align 8, !tbaa !9
  %.pre73 = load double, ptr %arrayidx136, align 8, !tbaa !9
  %.pre74 = load double, ptr %arrayidx139, align 8, !tbaa !9
  %.pre78 = fmul double %.pre73, 4.000000e+00
  %.pre79 = fneg double %.pre74
  %.pre80 = fmul double %.pre78, %.pre79
  %.pre81 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre80)
  br label %if.end149

if.end149:                                        ; preds = %if.then143, %for.body129
  %.pre-phi82 = phi double [ %.pre81, %if.then143 ], [ %13, %for.body129 ]
  %cmp162 = fcmp oeq double %.pre-phi82, 0.000000e+00
...
if.then163:                                       ; preds = %if.end149
  ...
  %.pre75 = load double, ptr %arrayidx131, align 8, !tbaa !9
  %.pre76 = load double, ptr %arrayidx136, align 8, !tbaa !9
  %.pre77 = load double, ptr %arrayidx139, align 8, !tbaa !9
  %.pre83 = fmul double %.pre76, 4.000000e+00
  %.pre84 = fneg double %.pre77
  %.pre86 = fmul double %.pre83, %.pre84
  %.pre87 = call double @llvm.fmuladd.f64(double %.pre75, double %.pre75, double %.pre86)
  br label %if.end167

if.end167:                                        ; preds = %if.then163, %if.end149
  %.pre-phi88 = phi double [ %.pre87, %if.then163 ], [ %.pre-phi82, %if.end149 ]
  %cmp180 = fcmp olt double %.pre-phi88, 0.000000e+00
...
for.inc192:                                       ; preds = %if.end167, %if.then181
  ...
  %cmp128 = icmp slt i64 %indvars.iv.next71, %20
  br i1 %cmp128, label %for.body129, label %for.end194, !llvm.loop !14

for.end194:                                       ; preds = %for.inc192, %entry, %for.cond127.preheader
