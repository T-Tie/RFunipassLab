...
NodeBlock:                                        ; preds = %entry, %sw.epilog
  %i.0 = phi i32 [ 0, %entry ], [ %inc20.i, %sw.epilog ]
...
LeafBlock4:                                       ; preds = %NodeBlock
  %SwitchLeaf5 = icmp eq i32 %0, 0
  br i1 %SwitchLeaf5, label %for.end23, label %sw.epilog
...
sw.epilog:                                        ; preds = %LeafBlock4, %LeafBlock, %for.end23
  %i.1 = phi i32 [ %i.0, %LeafBlock ], [ -1, %for.end23 ], [ %i.0, %LeafBlock4 ]
  %inc20.i = add nsw i32 %i.1, 1
  br label %NodeBlock
}
