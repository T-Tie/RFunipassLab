...
for.cond9:                                        ; preds = %for.cond, %if.end55
  ...
  %.pre4849 = phi i32 [ %.pre48, %if.end55 ], [ %4, %for.cond ]
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %if.end55 ], [ 0, %for.cond ]
  %cmp10 = icmp sgt i32 %.pre4849, 0
  br i1 %cmp10, label %if.end34, label %for.end58

if.end34:                                         ; preds = %for.cond9
  %sub35 = add nsw i32 %.pre4849, -1
  %6 = zext nneg i32 %sub35 to i64
  %cmp36 = icmp eq i64 %indvars.iv44, %6
  %cmp37 = icmp ne i64 %indvars.iv44, 0
  %or.cond = and i1 %cmp37, %cmp36
  br i1 %or.cond, label %for.cond39, label %if.end55

for.cond39:                                       ; preds = %if.end34, %if.end51
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %if.end51 ], [ 0, %if.end34 ]
  %exitcond = icmp eq i64 %indvars.iv41, %indvars.iv
  br i1 %exitcond, label %if.end55.loopexit, label %for.body41

for.body41:                                       ; preds = %for.cond39
  %arrayidx43 = getelementptr inbounds nuw [41 x i8], ptr %vla1, i64 %indvars.iv41
  ...
  %cmp46.not = icmp eq i64 %indvars.iv41, %indvars.iv44
...
if.end55.loopexit:                                ; preds = %for.cond39
  %.pre48.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end55

if.end55:                                         ; preds = %if.end55.loopexit, %if.end34
  %.pre48 = phi i32 [ %.pre48.pre, %if.end55.loopexit ], [ %.pre4849, %if.end34 ]
