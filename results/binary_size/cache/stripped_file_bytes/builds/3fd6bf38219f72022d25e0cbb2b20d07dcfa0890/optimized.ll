...
if.then:                                          ; preds = %entry
  call void @outlined_ir_func_0(i32 noundef 1)
  br label %if.end71

if.then4:                                         ; preds = %entry
  call void @outlined_ir_func_0(i32 noundef 2)
  br label %if.end71

for.cond:                                         ; preds = %for.cond.preheader, %for.end35
  %i.0 = phi i32 [ %inc37, %for.end35 ], [ 1, %for.cond.preheader ]
  %m.0 = phi i32 [ %add, %for.end35 ], [ undef, %for.cond.preheader ]
...
for.cond17:                                       ; preds = %for.cond11, %if.end
  %indvars.iv25 = phi i64 [ %5, %if.end ], [ 0, %for.cond11 ]
  %exitcond32 = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond32, label %for.end35, label %for.body19
...
if.end:                                           ; preds = %for.body19, %if.then23
...
for.cond44:                                       ; preds = %for.cond44.preheader, %for.body46
  %indvars.iv36 = phi i64 [ %8, %for.cond44.preheader ], [ %10, %for.body46 ]
...
for.cond58:                                       ; preds = %for.end38, %for.body60
  ...
  br i1 %cmp59, label %for.body60, label %if.end68
...
define internal void @outlined_ir_func_0(i32 noundef %0) #7 {
if.end71.exitStub:
