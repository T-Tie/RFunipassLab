...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  ...
  %exitcond54.not = icmp eq i64 %indvars.iv48, %wide.trip.count40
  br i1 %exitcond54.not, label %for.end55, label %for.cond37.preheader
...
for.body39:                                       ; preds = %for.cond37
  ...
  %cmp44 = icmp ne i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45.not = icmp samesign ult i64 %indvars.iv48, %10
  %or.cond = select i1 %cmp44, i1 true, i1 %cmp45.not
  %11 = zext i32 %d.1 to i64
  %cmp47.not = icmp samesign ult i64 %indvars.iv42, %11
  %or.cond27 = select i1 %or.cond, i1 true, i1 %cmp47.not
  %c.2 = select i1 %or.cond27, i32 %c.1, i32 %8
  %12 = trunc nuw nsw i64 %indvars.iv42 to i32
  %d.2 = select i1 %or.cond27, i32 %d.1, i32 %12
