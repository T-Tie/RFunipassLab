...
tailrecurse:                                      ; preds = %tailrecurse.backedge, %entry
  %y.tr = phi i32 [ %y, %entry ], [ %y.tr.be, %tailrecurse.backedge ]
  %cmp = icmp eq i32 %x, %y.tr
