...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  ...
  br i1 %exitcond39.not, label %for.cond30.preheader, label %for.body
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc24
  %indvars.iv30 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next31, %for.inc24 ]
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.end63
  %indvars.iv50 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next51, %for.end63 ]
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc61
  %indvars.iv45 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next46, %for.inc61 ]
...
for.end66:                                        ; preds = %for.cond30
  ...
  %sub73 = add i32 %n, -1
  %smax58 = call i32 @llvm.smax.i32(i32 noundef %sub73, i32 noundef 1)
...
for.cond91.preheader28:                           ; preds = %for.cond91.preheader
  %wide.trip.count69 = zext i32 %sub73 to i64
  br label %for.cond91
