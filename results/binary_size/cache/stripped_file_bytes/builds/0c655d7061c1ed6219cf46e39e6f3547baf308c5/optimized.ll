...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %or.cond9 = select i1 %or.cond8, i1 %cmp7, i1 false
  %5 = load i32, ptr %f, align 4
  %cmp9 = icmp eq i32 %5, 0
  %or.cond10 = select i1 %or.cond9, i1 %cmp9, i1 false
  br i1 %or.cond10, label %for.end, label %for.inc
...
for.inc:                                          ; preds = %for.cond
  ...
  %reass.sub14 = sub i32 %7, %2
  %add20 = add i32 %reass.sub14, 43200
  %reass.mul12 = add i32 %add20, %5
  %sub21 = add i32 %reass.mul12, %6
