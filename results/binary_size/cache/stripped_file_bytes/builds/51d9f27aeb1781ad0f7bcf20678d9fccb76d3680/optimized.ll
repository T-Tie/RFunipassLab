; ModuleID = '/tmp/tmpoe34_ykb.cpp'
source_filename = "/tmp/tmpoe34_ykb.cpp"
...
define dso_local noundef i32 @_Z6factorii(i32 noundef %num, i32 noundef %minA1) #0 {
entry:
...
if.end:                                           ; preds = %entry
  %2 = load i32, ptr %num.addr, align 4, !tbaa !5
  %conv = sitofp i32 %2 to double
  %call = call double @sqrt(double noundef %conv) #7, !tbaa !5
  %conv1 = fptosi double %call to i32
  store i32 %conv1, ptr %sqrtNum, align 4, !tbaa !5
  %3 = load i32, ptr %minA1.addr, align 4, !tbaa !5
  store i32 %3, ptr %i, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.end
  %4 = load i32, ptr %i, align 4, !tbaa !5
  %5 = load i32, ptr %sqrtNum, align 4, !tbaa !5
...
if.then4:                                         ; preds = %for.body
  ...
  %call5 = call noundef i32 @_Z6factorii(i32 noundef %div, i32 noundef %11)
...
cleanup:                                          ; preds = %for.end, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %sqrtNum) #7
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z6factorii(i32 noundef %1, i32 noundef 2)
