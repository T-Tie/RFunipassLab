...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.end ], [ 1, %entry ]
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.end26, %for.end10
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.end26 ], [ 1, %for.end10 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc24 ], [ 1, %for.cond13 ]
  %4 = load i32, ptr %y2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv33, %5
  br i1 %cmp17.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv36, i64 %indvars.iv33
...
for.cond30:                                       ; preds = %for.cond13, %for.end72
  %6 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp31 = icmp sgt i32 %6, 0
  br i1 %cmp31, label %for.cond33.preheader, label %for.end76

for.cond33.preheader:                             ; preds = %for.cond30
  %7 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp34.peel = icmp sgt i32 %7, 0
  br i1 %cmp34.peel, label %for.cond40.preheader.peel, label %for.end72

for.cond40.preheader.peel:                        ; preds = %for.cond33.preheader
  %8 = load i32, ptr %y1, align 4, !tbaa !5
  %cmp41.peel = icmp slt i32 %8, 1
  call void @llvm.assume(i1 noundef %cmp41.peel)
  br label %for.cond33

for.cond33:                                       ; preds = %for.cond40.preheader.peel, %for.cond40.preheader
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %for.cond40.preheader.peel ], [ %call64, %for.cond40.preheader ]
  %call69.peel = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, i32 noundef 0)
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp34 = icmp sgt i32 %9, 0
  br i1 %cmp34, label %for.cond40.preheader, label %for.end72

for.cond40.preheader:                             ; preds = %for.cond33
  %10 = load i32, ptr %y1, align 4, !tbaa !5
  %cmp41 = icmp slt i32 %10, 1
  call void @llvm.assume(i1 noundef %cmp41)
  %call64 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %for.cond33, !llvm.loop !13

for.end72:                                        ; preds = %for.cond33, %for.cond33.preheader
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.cond30
