...
define dso_local void @_Z6yinshuii(i32 noundef %x, i32 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp14 = icmp eq i32 %x, %y
...
if.else:                                          ; preds = %entry, %tailrecurse.backedge
  %y.tr15 = phi i32 [ %y.tr.be, %tailrecurse.backedge ], [ %y, %entry ]
  %rem = srem i32 %x, %y.tr15
  %div = sdiv i32 %x, %y.tr15
  %cmp1 = icmp eq i32 %rem, 0
  %cmp2 = icmp sgt i32 %x, %y.tr15
  %or.cond = and i1 %cmp2, %cmp1
  br i1 %or.cond, label %if.then3, label %if.else4

if.then3:                                         ; preds = %if.else
  tail call void @_Z6yinshuii(i32 noundef %div, i32 noundef %y.tr15)
  br label %tailrecurse.backedge

tailrecurse.backedge:                             ; preds = %if.else4, %if.then3
  %y.tr.be = add nsw i32 %y.tr15, 1
  %cmp = icmp eq i32 %x, %y.tr.be
  br i1 %cmp, label %if.then, label %if.else

if.else4:                                         ; preds = %if.else
  br i1 %cmp2, label %tailrecurse.backedge, label %if.end9
...
entry:
  ...
  br i1 %cmp.not2, label %for.cond.cleanup, label %for.body
...
for.body:                                         ; preds = %entry, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  call void @_Z6yinshuii(i32 noundef %1, i32 noundef 2)
  ...
  %3 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !11
...
if.end.i.i.i:                                     ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  ...
  %vtable.i.i.i = load ptr, ptr %3, align 8, !tbaa !9
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit: ; preds = %if.then.i2.i.i, %if.end.i.i.i
  ...
  %cmp.not.not = icmp slt i32 %i.03, %7
  br i1 %cmp.not.not, label %for.body, label %for.cond.cleanup, !llvm.loop !36
}
