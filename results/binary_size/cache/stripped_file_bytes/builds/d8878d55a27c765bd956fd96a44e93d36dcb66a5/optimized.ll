...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx17 = getelementptr inbounds [100 x [100 x i32]], ptr %sz, i64 0, i64 %idxprom16
...
if.else26:                                        ; preds = %for.end23
  br label %for.end29

for.inc27:                                        ; preds = %if.then25
  %19 = load i32, ptr %i, align 4, !tbaa !5
  %inc28 = add nsw i32 %19, 1
  store i32 %inc28, ptr %i, align 4, !tbaa !5
  br label %for.cond10, !llvm.loop !14

for.end29:                                        ; preds = %if.else26, %for.cond10
...
for.body36:                                       ; preds = %for.cond34
  ...
  %arrayidx38 = getelementptr inbounds [100 x [100 x i32]], ptr %sz, i64 0, i64 %idxprom37
...
if.then42:                                        ; preds = %for.body36
  ...
  store i32 %27, ptr %x2, align 4, !tbaa !5
  %28 = load i32, ptr %j, align 4, !tbaa !5
  store i32 %28, ptr %y2, align 4, !tbaa !5
  br label %for.end45

if.else43:                                        ; preds = %for.body36
  br label %for.inc44

for.inc44:                                        ; preds = %if.else43
...
if.else48:                                        ; preds = %for.end45
  br label %for.end51

for.inc49:                                        ; preds = %if.then47
...
for.end51:                                        ; preds = %if.else48, %for.cond30
  %32 = load i32, ptr %x2, align 4, !tbaa !5
  %33 = load i32, ptr %x1, align 4, !tbaa !5
