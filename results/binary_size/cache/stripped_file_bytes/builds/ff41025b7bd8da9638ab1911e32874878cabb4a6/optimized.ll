; ModuleID = '/tmp/tmpkgd2_6lu.cpp'
source_filename = "/tmp/tmpkgd2_6lu.cpp"
...
entry:
  ...
  %words = alloca [50 x i8], align 16
  %n = alloca i32, align 4
  %sum = alloca i32, align 4
  %temp = alloca i32, align 4
  %lens = alloca i32, align 4
  store i32 0, ptr %retval, align 4
  call void @llvm.lifetime.start.p0(i64 50, ptr %words) #12
  call void @llvm.lifetime.start.p0(i64 4, ptr %n) #12
  call void @llvm.lifetime.start.p0(i64 4, ptr %sum) #12
  store i32 0, ptr %sum, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %temp) #12
  store i32 0, ptr %temp, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %lens) #12
...
while.body:                                       ; preds = %while.cond
  %arraydecay = getelementptr inbounds [50 x i8], ptr %words, i64 0, i64 0
  ...
  %arraydecay2 = getelementptr inbounds [50 x i8], ptr %words, i64 0, i64 0
  %call3 = call i64 @strlen(ptr noundef %arraydecay2) #13
  %conv = trunc i64 %call3 to i32
  store i32 %conv, ptr %lens, align 4, !tbaa !5
  %1 = load i32, ptr %lens, align 4, !tbaa !5
  %2 = load i32, ptr %sum, align 4, !tbaa !5
  %add = add nsw i32 %1, %2
  %cmp4 = icmp slt i32 %add, 80
...
if.then6:                                         ; preds = %if.then
  %arraydecay7 = getelementptr inbounds [50 x i8], ptr %words, i64 0, i64 0
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arraydecay7)
  %4 = load i32, ptr %sum, align 4, !tbaa !5
  %5 = load i32, ptr %lens, align 4, !tbaa !5
  %add9 = add nsw i32 %4, %5
  store i32 %add9, ptr %sum, align 4, !tbaa !5
...
if.else:                                          ; preds = %if.then
  ...
  %arraydecay11 = getelementptr inbounds [50 x i8], ptr %words, i64 0, i64 0
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef %arraydecay11)
  %7 = load i32, ptr %sum, align 4, !tbaa !5
  %8 = load i32, ptr %lens, align 4, !tbaa !5
  %add13 = add nsw i32 %7, %8
  %add14 = add nsw i32 %add13, 1
  store i32 %add14, ptr %sum, align 4, !tbaa !5
  %9 = load i32, ptr %temp, align 4, !tbaa !5
  %inc15 = add nsw i32 %9, 1
  store i32 %inc15, ptr %temp, align 4, !tbaa !5
  br label %if.end
...
if.else16:                                        ; preds = %while.body
  ...
  %arraydecay18 = getelementptr inbounds [50 x i8], ptr %words, i64 0, i64 0
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call17, ptr noundef %arraydecay18)
  ...
  %10 = load i32, ptr %lens, align 4, !tbaa !5
  %add21 = add nsw i32 %10, 1
  store i32 %add21, ptr %sum, align 4, !tbaa !5
  store i32 0, ptr %temp, align 4, !tbaa !5
  br label %if.end22
...
if.end22:                                         ; preds = %if.else16, %if.end
  ...
  %arraydecay23 = getelementptr inbounds [50 x i8], ptr %words, i64 0, i64 0
  call void @llvm.memset.p0.i64(ptr align 16 %arraydecay23, i8 0, i64 50, i1 false)
  br label %while.cond, !llvm.loop !9

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %lens) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %temp) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %sum) #12
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #12
  call void @llvm.lifetime.end.p0(i64 50, ptr %words) #12
  ret i32 0
}
