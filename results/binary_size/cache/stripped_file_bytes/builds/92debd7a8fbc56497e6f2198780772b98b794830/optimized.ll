...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call noundef i32 @_Z2fjii(i32 noundef %4, i32 noundef 2)
...
define dso_local noundef i32 @_Z2fjii(i32 noundef %m, i32 noundef %min) #3 {
entry:
  %retval = alloca i32, align 4
  ...
  store i32 %min, ptr %min.addr, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %counter) #6
  store i32 1, ptr %counter, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #6
  %0 = load i32, ptr %m.addr, align 4, !tbaa !5
  %1 = load i32, ptr %min.addr, align 4, !tbaa !5
...
if.end:                                           ; preds = %entry
  %2 = load i32, ptr %min.addr, align 4, !tbaa !5
...
if.then3:                                         ; preds = %for.body
  ...
  %call = call noundef i32 @_Z2fjii(i32 noundef %div, i32 noundef %9)
  %10 = load i32, ptr %counter, align 4, !tbaa !5
  %add = add nsw i32 %call, %10
  store i32 %add, ptr %counter, align 4, !tbaa !5
  br label %if.end4
...
cleanup:                                          ; preds = %for.end, %if.then
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %counter) #6
