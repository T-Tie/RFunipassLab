...
for.cond:                                         ; preds = %for.end161, %entry
  %m.0 = phi i32 [ 0, %entry ], [ %inc165, %for.end161 ]
...
for.cond13.preheader:                             ; preds = %for.cond1
  ...
  %smax113 = call i32 @llvm.smax.i32(i32 %1, i32 0)
  %smax126 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc159
  %indvars.iv76 = phi i32 [ %1, %for.cond13.preheader ], [ %indvars.iv.next77, %for.inc159 ]
  %k.0 = phi i32 [ 0, %for.cond13.preheader ], [ %inc160, %for.inc159 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc159 ]
  %exitcond127.not = icmp eq i32 %k.0, %smax126
  br i1 %exitcond127.not, label %for.end161, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  %smax101 = call i32 @llvm.smax.i32(i32 %indvars.iv76, i32 0)
  %wide.trip.count86 = zext nneg i32 %smax101 to i64
  %wide.trip.count = zext i32 %indvars.iv76 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc55
  %indvars.iv83 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next84, %for.inc55 ]
  %exitcond87.not = icmp eq i64 %indvars.iv83, %wide.trip.count86
  br i1 %exitcond87.not, label %for.cond58.preheader, label %for.body19

for.cond58.preheader:                             ; preds = %for.cond16
  %wide.trip.count91 = zext i32 %indvars.iv76 to i64
  br label %for.cond58

for.body19:                                       ; preds = %for.cond16
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv83
  %5 = load i32, ptr %arrayidx21, align 16, !tbaa !5
  br label %for.cond23

for.cond23:                                       ; preds = %for.body26, %for.body19
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.body26 ], [ 0, %for.body19 ]
...
for.body26:                                       ; preds = %for.cond23
  %arrayidx30 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv83, i64 %indvars.iv72
...
for.cond39:                                       ; preds = %for.cond23, %for.body42
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.body42 ], [ 0, %for.cond23 ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %wide.trip.count
  br i1 %exitcond82.not, label %for.inc55, label %for.body42

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv83, i64 %indvars.iv78
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc99
  %indvars.iv98 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next99, %for.inc99 ]
  %exitcond103.not = icmp eq i64 %indvars.iv98, %wide.trip.count86
  br i1 %exitcond103.not, label %for.end101, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv98
  %8 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  br label %for.cond65

for.cond65:                                       ; preds = %for.body68, %for.body61
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.body68 ], [ 0, %for.body61 ]
  %min.2 = phi i32 [ %spec.select66, %for.body68 ], [ %8, %for.body61 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %wide.trip.count91
  br i1 %exitcond92.not, label %for.cond83, label %for.body68

for.body68:                                       ; preds = %for.cond65
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv88, i64 %indvars.iv98
  %9 = load i32, ptr %arrayidx72, align 4, !tbaa !5
  %spec.select66 = call i32 @llvm.smin.i32(i32 %9, i32 %min.2)
  %indvars.iv.next89 = add nuw nsw i64 %indvars.iv88, 1
  br label %for.cond65, !llvm.loop !16

for.cond83:                                       ; preds = %for.cond65, %for.body86
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.body86 ], [ 0, %for.cond65 ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %wide.trip.count91
  br i1 %exitcond97.not, label %for.inc99, label %for.body86

for.body86:                                       ; preds = %for.cond83
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv93, i64 %indvars.iv98
...
for.cond104:                                      ; preds = %for.end122, %for.end101
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.end122 ], [ 0, %for.end101 ]
  %exitcond115.not = icmp eq i64 %indvars.iv109, %wide.trip.count114
  br i1 %exitcond115.not, label %for.cond131, label %for.cond107

for.cond107:                                      ; preds = %for.cond104, %for.body110
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.body110 ], [ 1, %for.cond104 ]
  %exitcond108.not = icmp eq i64 %indvars.iv104, %wide.trip.count107
  br i1 %exitcond108.not, label %for.end122, label %for.body110

for.body110:                                      ; preds = %for.cond107
  %indvars.iv.next105 = add nuw nsw i64 %indvars.iv104, 1
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv109, i64 %indvars.iv.next105
  %12 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx119 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv109, i64 %indvars.iv104
  store i32 %12, ptr %arrayidx119, align 4, !tbaa !5
  br label %for.cond107, !llvm.loop !19

for.end122:                                       ; preds = %for.cond107
  %arrayidx127 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv109, i64 %idxprom126
  store i32 0, ptr %arrayidx127, align 4, !tbaa !5
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  br label %for.cond104, !llvm.loop !20

for.cond131:                                      ; preds = %for.cond104, %for.end150
  %indvars.iv121 = phi i64 [ %indvars.iv.next122, %for.end150 ], [ 0, %for.cond104 ]
  %exitcond125.not = icmp eq i64 %indvars.iv121, %wide.trip.count124
  br i1 %exitcond125.not, label %for.inc159, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.body138
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.body138 ], [ 1, %for.cond131 ]
  %exitcond120.not = icmp eq i64 %indvars.iv116, %wide.trip.count124
  br i1 %exitcond120.not, label %for.end150, label %for.body138

for.body138:                                      ; preds = %for.cond135
  %indvars.iv.next117 = add nuw nsw i64 %indvars.iv116, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next117, i64 %indvars.iv121
  %13 = load i32, ptr %arrayidx143, align 4, !tbaa !5
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv116, i64 %indvars.iv121
  store i32 %13, ptr %arrayidx147, align 4, !tbaa !5
  br label %for.cond135, !llvm.loop !21

for.end150:                                       ; preds = %for.cond135
  %arrayidx155 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom126, i64 %indvars.iv121
...
for.end161:                                       ; preds = %for.cond13
  ...
  %vtable.i = load ptr, ptr %call162, align 8, !tbaa !24
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8
  %add.ptr.i = getelementptr inbounds i8, ptr %call162, i64 %vbase.offset.i
  %call.i67 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i, i8 noundef signext 10)
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call162, i8 noundef signext %call.i67)
