...
for.cond10:                                       ; preds = %if.then25, %for.cond10.preheader
  ...
  %a.0 = phi i32 [ %a.232, %if.then25 ], [ undef, %for.cond10.preheader ]
  %b.0 = phi i32 [ %b.233, %if.then25 ], [ undef, %for.cond10.preheader ]
...
if.then25:                                        ; preds = %for.cond13, %for.end23
  %b.233 = phi i32 [ %6, %for.end23 ], [ %b.0, %for.cond13 ]
  %a.232 = phi i32 [ %4, %for.end23 ], [ %a.0, %for.cond13 ]
...
for.end36:                                        ; preds = %for.end23, %if.then25, %for.cond10
  %a.1 = phi i32 [ %a.232, %if.then25 ], [ %4, %for.end23 ], [ %a.0, %for.cond10 ]
  %b.1 = phi i32 [ %b.233, %if.then25 ], [ %6, %for.end23 ], [ %b.0, %for.cond10 ]
...
for.end66:                                        ; preds = %if.then55, %for.cond38, %for.body44
  %i.212 = phi i32 [ %i.2, %for.body44 ], [ %smin, %for.cond38 ], [ %i.2, %if.then55 ]
  %d.1 = phi i32 [ %k.2, %for.body44 ], [ undef, %for.cond38 ], [ undef, %if.then55 ]
  %10 = xor i32 %b.1, -1
  %sub68 = add i32 %d.1, %10
  %11 = xor i32 %a.1, -1
  %sub70 = add i32 %i.212, %11
