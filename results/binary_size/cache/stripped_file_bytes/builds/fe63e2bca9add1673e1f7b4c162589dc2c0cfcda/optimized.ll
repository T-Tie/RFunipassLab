...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef nonnull %b) #9
  call void @llvm.lifetime.start.p0(i64 noundef 12000, ptr noundef nonnull dereferenceable(12000) %a) #9
...
for.end32:                                        ; preds = %for.cond8
  call void @llvm.lifetime.end.p0(i64 noundef 12000, ptr noundef nonnull %a) #10
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef nonnull %b) #10
