...
do.body:                                          ; preds = %do.body, %entry
  %n.0 = phi i32 [ 0, %entry ], [ %n.1, %do.body ]
  ...
  %n.1 = add nuw nsw i32 %n.0, %spec.select
  %cmp15.not = icmp eq i8 %0, 10
  br i1 %cmp15.not, label %for.cond, label %do.body, !llvm.loop !8

for.cond:                                         ; preds = %do.body, %for.inc33
  %i.0 = phi i32 [ %dec, %for.inc33 ], [ %n.1, %do.body ]
  %cmp16 = icmp sgt i32 %i.0, -1
  br i1 %cmp16, label %for.end, label %for.end34
