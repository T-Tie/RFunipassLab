...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr %a) #8
  call void @llvm.lifetime.start.p0(i64 4000, ptr %b) #8
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %f) #8
...
if.then:                                          ; preds = %for.body
  ...
  store i32 %inc9, ptr %d, align 4, !tbaa !5
  br label %if.end
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx18 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom17
  %17 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %18 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom19 = sext i32 %18 to i64
  %arrayidx20 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom19
...
if.then22:                                        ; preds = %for.body16
  ...
  %arrayidx24 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom23
  %21 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  store i32 %21, ptr %f, align 4, !tbaa !5
  %22 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom25 = sext i32 %22 to i64
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom25
  ...
  %arrayidx30 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom29
  store i32 %25, ptr %arrayidx30, align 4, !tbaa !5
  br label %if.end31
...
for.cond38:                                       ; preds = %for.inc46, %for.end37
  ...
  %cmp40 = icmp slt i32 %29, %sub39
  br i1 %cmp40, label %for.body41, label %for.end48

for.body41:                                       ; preds = %for.cond38
  %31 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom42 = sext i32 %31 to i64
  %arrayidx43 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom42
  %32 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %32)
  %call45 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call44, ptr noundef @.str)
  br label %for.inc46
...
for.end48:                                        ; preds = %for.cond38
  %34 = load i32, ptr %d, align 4, !tbaa !5
  ...
  %35 = load i32, ptr %arrayidx51, align 4, !tbaa !5
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %35)
  call void @llvm.lifetime.end.p0(i64 4, ptr %j) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr %f) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr %d) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr %s) #8
  call void @llvm.lifetime.end.p0(i64 4000, ptr %b) #8
  call void @llvm.lifetime.end.p0(i64 4000, ptr %a) #8
