...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.body19
  %indvars.iv27 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next28, %for.body19 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader.split, %for.end63
  %indvars.iv19 = phi i64 [ 0, %for.cond31.preheader.split ], [ %indvars.iv.next20, %for.end63 ]
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.body55
  %indvars.iv13 = phi i64 [ 0, %for.cond53.preheader ], [ %indvars.iv.next14, %for.body55 ]
...
entry:
  ...
  %smax9 = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
