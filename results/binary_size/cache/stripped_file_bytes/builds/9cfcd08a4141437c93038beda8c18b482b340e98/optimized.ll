...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv48 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next49, %for.body3 ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv48
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv56.in = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv56, %for.body15 ]
  %cmp14 = icmp sgt i64 %indvars.iv56.in, 0
  br i1 %cmp14, label %for.body15, label %for.end33

for.body15:                                       ; preds = %for.cond13
  %indvars.iv56 = add nsw i64 %indvars.iv56.in, -1
  %arrayidx17 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv56
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv59 = phi i64 [ %indvars.iv56, %for.cond22.preheader ], [ %indvars.iv.next60, %for.inc28 ]
  %cmp23.not.not = icmp slt i64 %indvars.iv59, %6
  br i1 %cmp23.not.not, label %for.inc28, label %for.end33.loopexit

for.inc28:                                        ; preds = %for.cond22
  %indvars.iv.next60 = add nsw i64 %indvars.iv59, 1
  %arrayidx26 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next60
...
for.end33.loopexit:                               ; preds = %for.cond22
  %8 = trunc nsw i64 %indvars.iv56 to i32
  br label %for.end33

for.end33:                                        ; preds = %for.cond13, %for.end33.loopexit
  %.pre-phi = phi i64 [ %indvars.iv56, %for.end33.loopexit ], [ %4, %for.cond13 ]
...
for.cond35:                                       ; preds = %for.inc55, %for.end33
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc55 ], [ %.pre-phi, %for.end33 ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc55 ], [ %10, %for.end33 ]
  %j.3 = phi i32 [ %j.4, %for.inc55 ], [ %j.2, %for.end33 ]
  %indvars.iv.next68 = add nsw i64 %indvars.iv67, -1
  %indvars = trunc i64 %indvars.iv.next68 to i32
  %11 = trunc i64 %indvars.iv67 to i32
  %cmp36 = icmp sgt i32 %11, 0
  br i1 %cmp36, label %for.body37, label %for.end57

for.body37:                                       ; preds = %for.cond35
  %idxprom38 = and i64 %indvars.iv.next68, 4294967295
...
for.cond45:                                       ; preds = %for.inc51, %if.then42
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc51 ], [ %indvars.iv62, %if.then42 ]
  %indvars.iv.next65 = add nsw i64 %indvars.iv64, 1
  %cmp46 = icmp slt i64 %indvars.iv.next65, %13
  br i1 %cmp46, label %for.inc51, label %for.inc55

for.inc51:                                        ; preds = %for.cond45
  %arrayidx49 = getelementptr inbounds [100 x i8], ptr %str, i64 0, i64 %indvars.iv.next65
...
for.cond74:                                       ; preds = %for.end10, %for.inc80
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc80 ], [ 0, %for.end10 ]
  %exitcond79 = icmp eq i64 %indvars.iv74, %wide.trip.count
  br i1 %exitcond79, label %if.end83, label %for.inc80

for.inc80:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [100 x i8], ptr %str, i64 0, i64 %indvars.iv74
