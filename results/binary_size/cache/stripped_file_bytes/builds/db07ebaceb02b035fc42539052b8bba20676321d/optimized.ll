...
for.cond17:                                       ; preds = %for.cond
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef undef) #12
...
if.end:                                           ; preds = %while.body
  ...
  %call.i = tail call noundef nonnull ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull align 4 %__last.addr.0, ptr noundef nonnull align 4 %__first) #12
...
while.cond:                                       ; preds = %while.cond, %if.end
  %__parent.0 = phi i64 [ %div23, %if.end ], [ %dec, %while.cond ]
  ...
  br i1 %cmp5, label %return, label %while.cond, !llvm.loop !17
...
while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  ...
  %cmp.i2 = icmp slt i32 %0, %2
  br i1 %cmp.i2, label %while.cond4, label %while.end8, !llvm.loop !21
...
for.cond:                                         ; preds = %entry, %if.end6
  %__first.pn = phi ptr [ %__i.0, %if.end6 ], [ %__first, %entry ]
...
while.cond.i:                                     ; preds = %for.body, %while.body.i
  ...
  br i1 %cmp.i.i, label %while.body.i, label %if.end6

while.body.i:                                     ; preds = %while.cond.i
  store i32 %2, ptr %__last.addr.0.i, align 4, !tbaa !5
  br label %while.cond.i, !llvm.loop !13

if.end6:                                          ; preds = %while.cond.i, %if.then2
  %__last.addr.0.i.lcssa.sink = phi ptr [ %__first, %if.then2 ], [ %__last.addr.0.i, %while.cond.i ]
  store i32 %0, ptr %__last.addr.0.i.lcssa.sink, align 4, !tbaa !5
