...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 40000, i1 false)
...
for.cond35:                                       ; preds = %for.inc43, %for.body34
  ...
  %sub36 = sub nsw i32 %19, 1
  %cmp37 = icmp sle i32 %18, %sub36
...
for.cond49:                                       ; preds = %for.inc83, %for.end48
  ...
  %sub50 = sub nsw i32 %25, 1
  %cmp51 = icmp sle i32 %24, %sub50
...
for.cond57:                                       ; preds = %for.inc77, %for.body56
  ...
  %29 = load i32, ptr %x2, align 4, !tbaa !5
  %sub58 = sub nsw i32 %29, 1
  %cmp59 = icmp sle i32 %28, %sub58
...
for.body60:                                       ; preds = %for.cond57
  ...
  %arrayidx70 = getelementptr inbounds [100 x [100 x i32]], ptr %b, i64 0, i64 %idxprom69
  ...
  %38 = load i32, ptr %arrayidx72, align 4, !tbaa !5
  %mul = mul nsw i32 %35, %38
  %add = add nsw i32 %32, %mul
  %39 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom73 = sext i32 %39 to i64
  %arrayidx74 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom73
  ...
  store i32 %add, ptr %arrayidx76, align 4, !tbaa !5
  br label %for.inc77
...
for.cond86:                                       ; preds = %for.inc109, %for.end85
  ...
  %45 = load i32, ptr %x1, align 4, !tbaa !5
  %sub87 = sub nsw i32 %45, 1
  %cmp88 = icmp sle i32 %44, %sub87
...
if.then:                                          ; preds = %for.body93
  ...
  %52 = load i32, ptr %arrayidx99, align 4, !tbaa !5
  %call100 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %52)
  br label %if.end
...
if.else:                                          ; preds = %for.body93
  ...
  %55 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %55)
  br label %if.end
