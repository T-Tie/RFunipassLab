...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 251001, ptr noundef nonnull %b) #6
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc23
  %indvars.iv88 = phi i32 [ -1, %for.cond2.preheader ], [ %indvars.iv.next89, %for.inc23 ]
  %indvars.iv73 = phi i32 [ 0, %for.cond2.preheader ], [ %indvars.iv.next74, %for.inc23 ]
  %indvars.iv51 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next52, %for.inc23 ]
  ...
  %cmp6 = icmp ugt i64 %add.reass, %indvars.iv51
  br i1 %cmp6, label %for.cond8.preheader, label %for.cond26.preheader

for.cond8.preheader:                              ; preds = %for.cond2
  %1 = add nsw i64 %indvars.iv51, %conv5
  br label %for.cond8

for.cond26.preheader:                             ; preds = %for.cond2
  %wide.trip.count83 = zext i32 %indvars.iv73 to i64
  br label %for.cond26

for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc19
  %indvars.iv55 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next56, %for.inc19 ]
  %indvars.iv53 = phi i64 [ %indvars.iv51, %for.cond8.preheader ], [ %indvars.iv.next54, %for.inc19 ]
  %cmp10 = icmp slt i64 %indvars.iv53, %1
  br i1 %cmp10, label %for.inc19, label %for.inc23

for.inc19:                                        ; preds = %for.cond8
  %arrayidx13 = getelementptr inbounds nuw [501 x i8], ptr %a, i64 0, i64 %indvars.iv53
  %2 = load i8, ptr %arrayidx13, align 1, !tbaa !12, !invariant.load !13
  %arrayidx17 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %b, i64 0, i64 %indvars.iv51, i64 %indvars.iv55
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc70
  %indvars.iv77 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next78, %for.inc70 ]
  %indvars.iv68 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next69, %for.inc70 ]
  %exitcond84.not = icmp eq i64 %indvars.iv77, %wide.trip.count83
  br i1 %exitcond84.not, label %for.cond73.preheader, label %for.body28

for.cond73.preheader:                             ; preds = %for.cond26
  %umax = call i32 @llvm.umax.i32(i32 %indvars.iv73, i32 1)
  br label %for.cond73

for.body28:                                       ; preds = %for.cond26
  %arrayidx34 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %b, i64 0, i64 %indvars.iv77
  %arrayidx47 = getelementptr inbounds nuw [501 x i32], ptr %c, i64 0, i64 %indvars.iv77
  %arrayidx60 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %d, i64 0, i64 %indvars.iv77
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc66, %for.body28
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc66 ], [ %indvars.iv68, %for.body28 ]
  %exitcond76.not = icmp eq i64 %indvars.iv70, %wide.trip.count83
  br i1 %exitcond76.not, label %for.inc70, label %for.body32

for.body32:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %b, i64 0, i64 %indvars.iv70
...
for.cond49:                                       ; preds = %for.inc56, %if.then
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc56 ], [ 0, %if.then ]
  %exitcond67.not = icmp eq i64 %indvars.iv64, %wide.trip.count
  br i1 %exitcond67.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %b, i64 0, i64 %indvars.iv70, i64 %indvars.iv64
...
for.cond73:                                       ; preds = %for.cond73.preheader, %for.inc120
  %indvars.iv90 = phi i32 [ %indvars.iv88, %for.cond73.preheader ], [ %indvars.iv.next91, %for.inc120 ]
  %i.3 = phi i32 [ 1, %for.cond73.preheader ], [ %inc121, %for.inc120 ]
  %exitcond95.not = icmp eq i32 %i.3, %umax
  br i1 %exitcond95.not, label %for.end122, label %for.cond76.preheader
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc117
  %indvars.iv85 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next86, %for.inc117 ]
  %exitcond93.not = icmp eq i64 %indvars.iv85, %wide.trip.count92
  br i1 %exitcond93.not, label %for.inc120, label %for.body79

for.body79:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x i32], ptr %c, i64 0, i64 %indvars.iv85
  %6 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !13
  %indvars.iv.next86 = add nuw nsw i64 %indvars.iv85, 1
  %arrayidx84 = getelementptr inbounds nuw [501 x i32], ptr %c, i64 0, i64 %indvars.iv.next86
...
if.then86:                                        ; preds = %for.body79
  ...
  %arrayidx99 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %d, i64 0, i64 %indvars.iv85
  %call101 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %str, ptr noundef nonnull dereferenceable(1) %arrayidx99) #8
  %arrayidx107 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %d, i64 0, i64 %indvars.iv.next86
...
for.inc120:                                       ; preds = %for.cond76
  ...
  %indvars.iv.next91 = add nsw i32 %indvars.iv90, -1
...
for.cond128:                                      ; preds = %for.inc141, %if.then125
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc141 ], [ 0, %if.then125 ]
  %exitcond101.not = icmp eq i64 %indvars.iv96, %wide.trip.count83
  br i1 %exitcond101.not, label %if.end146, label %for.body130

for.body130:                                      ; preds = %for.cond128
  %arrayidx132 = getelementptr inbounds nuw [501 x i32], ptr %c, i64 0, i64 %indvars.iv96
...
for.inc141:                                       ; preds = %for.body130
  %arrayidx137 = getelementptr inbounds nuw [501 x [501 x i8]], ptr %d, i64 0, i64 %indvars.iv96
