...
for.cond:                                         ; preds = %if.end51, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc53, %if.end51 ]
...
if.end44:                                         ; preds = %if.then26, %if.then37, %if.else39, %if.else28, %if.then18
  %total.1 = phi i32 [ %add, %if.then18 ], [ %add27, %if.then26 ], [ %total.0, %if.else28 ], [ %add38, %if.then37 ], [ %add40, %if.else39 ]
