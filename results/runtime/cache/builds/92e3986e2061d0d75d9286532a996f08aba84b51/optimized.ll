...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000000, ptr noundef nonnull align 16 %board) #5
...
for.end48:                                        ; preds = %for.cond29
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000000, ptr noundef nonnull %board) #6
  ret i32 0
}
