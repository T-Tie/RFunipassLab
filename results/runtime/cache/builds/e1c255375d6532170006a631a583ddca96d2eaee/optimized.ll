...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr %c) #5
  call void @llvm.memset.p0.i64(ptr align 16 %c, i8 0, i64 10000, i1 false)
  br label %for.cond
...
for.end27:                                        ; preds = %for.cond19
  ...
  call void @llvm.lifetime.end.p0(i64 10000, ptr %c) #5
  ret i32 0
}
