...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax94 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
  %wide.trip.count65 = zext nneg i32 %smax94 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.end24, %tailrecurse
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.end24 ], [ 0, %tailrecurse ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count65
  br i1 %exitcond66.not, label %for.cond28, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.body13 ], [ 0, %for.cond11.preheader ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count
  br i1 %exitcond61.not, label %for.end24, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv57
...
for.cond28:                                       ; preds = %for.cond, %for.end62
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.end62 ], [ 0, %for.cond ]
  %exitcond82.not = icmp eq i64 %indvars.iv77, %wide.trip.count65
  br i1 %exitcond82.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select55, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count
  br i1 %exitcond71.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv67, i64 %indvars.iv77
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select55 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.body50
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.body50 ], [ 0, %for.cond48.preheader ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count
  br i1 %exitcond76.not, label %for.end62, label %for.body50

for.body50:                                       ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv72, i64 %indvars.iv77
...
for.end65:                                        ; preds = %for.cond28
  ...
  br i1 %cmp66, label %cleanup, label %for.cond69

for.cond69:                                       ; preds = %for.end65, %for.end124
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.end124 ], [ 0, %for.end65 ]
  %exitcond96.not = icmp eq i64 %indvars.iv90, %wide.trip.count65
  br i1 %exitcond96.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %5 = add nsw i64 %indvars.iv90, -1
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 0
  %Pivot = icmp eq i64 %indvars.iv90, 0
  %SwitchLeaf98 = icmp eq i64 %indvars.iv90, 1
  br label %for.cond72

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv83 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next84, %for.inc122 ]
  %exitcond89.not = icmp eq i64 %indvars.iv83, %wide.trip.count
  br i1 %exitcond89.not, label %for.end124, label %for.body75

for.body75:                                       ; preds = %for.cond72
  br i1 %Pivot, label %land.lhs.true, label %LeafBlock97

LeafBlock97:                                      ; preds = %for.body75
  %cmp8152 = icmp eq i64 %indvars.iv83, 1
  %or.cond = or i1 %SwitchLeaf98, %cmp8152
  br i1 %or.cond, label %for.inc122, label %if.else95

land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv83, 2
  br i1 %switch, label %for.inc122, label %if.then85

if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 0, i64 %indvars.iv83
  %6 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
  %7 = add nsw i64 %indvars.iv83, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 0, i64 %7
  store i32 %6, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.else95:                                        ; preds = %LeafBlock97
  %cmp96 = icmp eq i64 %indvars.iv83, 0
  %8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv90, i64 %indvars.iv83
  %9 = load i32, ptr %8, align 4, !tbaa !5, !invariant.load !9
  br i1 %cmp96, label %if.then97, label %if.else107

if.then97:                                        ; preds = %if.else95
  store i32 %9, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %if.else95
  %10 = add nsw i64 %indvars.iv83, -1
  %arrayidx117 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 %10
  store i32 %9, ptr %arrayidx117, align 4, !tbaa !5
  br label %for.inc122

for.inc122:                                       ; preds = %LeafBlock97, %land.lhs.true, %if.then85, %if.else107, %if.then97
...
for.cond:                                         ; preds = %for.end28, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc33, %for.end28 ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.end
  %indvars.iv13 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next14, %for.end ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.body6
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body6 ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count16
...
for.cond12:                                       ; preds = %for.cond1, %for.end25
  %1 = phi i32 [ %3, %for.end25 ], [ %0, %for.cond1 ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.end25 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv21, %2
  br i1 %cmp13, label %for.cond15, label %for.end28

for.cond15:                                       ; preds = %for.cond12, %for.body17
  %3 = phi i32 [ %.pre, %for.body17 ], [ %1, %for.cond12 ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body17 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
  %cmp16 = icmp slt i64 %indvars.iv18, %4
  br i1 %cmp16, label %for.body17, label %for.end25

for.body17:                                       ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv18
