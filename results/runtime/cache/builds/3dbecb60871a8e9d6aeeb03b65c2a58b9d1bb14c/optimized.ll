...
for.cond3:                                        ; preds = %if.end32, %for.end
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %if.end32 ], [ 1, %for.end ]
  %ans.0 = phi i32 [ %spec.select4, %if.end32 ], [ 1, %for.end ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end42, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond3
  %arrayidx12 = getelementptr inbounds nuw [25 x i32], ptr %h, i64 0, i64 %indvars.iv9
  %2 = load i32, ptr %arrayidx12, align 4, !tbaa !5
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc21
  %indvars.iv6 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next7, %for.inc21 ]
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [25 x i32], ptr %h, i64 0, i64 %indvars.iv6
  %3 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %cmp13.not = icmp slt i32 %3, %2
  br i1 %cmp13.not, label %for.inc21, label %if.then

if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv6
  ...
  %spec.select3 = select i1 %cmp16, i32 %5, i32 %tIndex.0
  br label %for.inc21

for.inc21:                                        ; preds = %if.then, %for.body8
  %temp.1 = phi i32 [ %temp.0, %for.body8 ], [ %spec.select, %if.then ]
  %tIndex.1 = phi i32 [ %tIndex.0, %for.body8 ], [ %spec.select3, %if.then ]
...
if.end32:                                         ; preds = %for.end23, %if.else
  ...
  %arrayidx31 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv9
  store i32 %add.sink, ptr %arrayidx31, align 4, !tbaa !5
  %spec.select4 = call i32 @llvm.smax.i32(i32 %add.sink, i32 %ans.0)
