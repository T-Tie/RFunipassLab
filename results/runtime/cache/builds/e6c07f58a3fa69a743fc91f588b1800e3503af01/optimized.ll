...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %d) #6
...
land.lhs.true:                                    ; preds = %for.body
  ...
  br i1 %cmp9, label %if.end20, label %if.else

if.else:                                          ; preds = %land.lhs.true, %for.body
  %cmp13 = fcmp ogt double %sub6, 5.000000e-02
  br i1 %cmp13, label %if.end20, label %if.else17

if.else17:                                        ; preds = %if.else
  br label %if.end20

if.end20:                                         ; preds = %if.else, %land.lhs.true, %if.else17
