...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 49284, ptr %a) #5
  call void @llvm.lifetime.start.p0(i64 49284, ptr %b) #5
  call void @llvm.lifetime.start.p0(i64 49284, ptr %c) #5
...
for.end80:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 49284, ptr %c) #5
  call void @llvm.lifetime.end.p0(i64 49284, ptr %b) #5
  call void @llvm.lifetime.end.p0(i64 49284, ptr %a) #5
  ret i32 0
}
