...
for.body8:                                        ; preds = %for.cond6
  ...
  %10 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  ...
  %11 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !12
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef %a) #6
  ret i32 0
}
