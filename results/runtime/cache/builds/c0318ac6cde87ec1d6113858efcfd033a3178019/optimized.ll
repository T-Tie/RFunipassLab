...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv34 = phi i32 [ %indvars.iv.next35, %for.inc ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre37, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre37, %land.lhs.true ]
