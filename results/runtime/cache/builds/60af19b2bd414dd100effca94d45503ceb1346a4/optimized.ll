...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %j.0 = phi i32 [ 1, %for.end ], [ %inc17, %for.inc16 ]
  %cmp8 = icmp sle i32 %j.0, %.sink
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !9
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !9
  %vbase.offset.ptr2 = getelementptr i8, ptr %vtable1, i64 -24
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !12
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !9
  %vbase.offset.ptr8 = getelementptr i8, ptr %vtable7, i64 -24
  %vbase.offset9 = load i64, ptr %vbase.offset.ptr8, align 8, !invariant.load !12
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !9
  %vbase.offset.ptr13 = getelementptr i8, ptr %vtable12, i64 -24
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !12
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !9
  %vbase.offset.ptr21 = getelementptr i8, ptr %vtable20, i64 -24
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !12
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !9
  %vbase.offset.ptr30 = getelementptr i8, ptr %vtable29, i64 -24
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !12
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !9
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !12
...
if.else:                                          ; preds = %entry
  ...
  %0 = load ptr, ptr %vfn, align 8, !invariant.load !12
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !13
  %1 = load i32, ptr %__c2, align 4, !tbaa !13
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
!19 = !{!20, !21, i64 16}
!20 = !{!"_ZTSSt8ios_base", !21, i64 8, !21, i64 16, !22, i64 24, !23, i64 28, !23, i64 32, !24, i64 40, !25, i64 48, !15, i64 64, !14, i64 192, !26, i64 200, !27, i64 208}
!21 = !{!"long", !15, i64 0}
!22 = !{!"_ZTSSt13_Ios_Fmtflags", !15, i64 0}
!23 = !{!"_ZTSSt12_Ios_Iostate", !15, i64 0}
...
!29 = !{!30, !33, i64 232}
!30 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !20, i64 0, !31, i64 216, !15, i64 224, !32, i64 225, !33, i64 232, !34, i64 240, !35, i64 248, !36, i64 256}
