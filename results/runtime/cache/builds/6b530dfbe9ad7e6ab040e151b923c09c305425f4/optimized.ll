...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  ...
  br i1 %exitcond21.not, label %for.cond47.preheader, label %for.inc44
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc53
  %indvars.iv22 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next23, %for.inc53 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond26.not, label %for.end55, label %for.body49
