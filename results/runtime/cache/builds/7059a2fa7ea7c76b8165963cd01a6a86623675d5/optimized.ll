...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax83 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax59 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc9, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc9 ], [ 0, %entry ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, %wide.trip.count9
  br i1 %exitcond10.not, label %for.end11, label %for.cond1
