...
for.cond6:                                        ; preds = %for.inc12, %for.body5
  %.sink5 = phi i32 [ 0, %for.body5 ], [ %inc13, %for.inc12 ]
  %cmp7 = icmp slt i32 %.sink5, 39
  br i1 %cmp7, label %for.inc12, label %for.end14

for.inc12:                                        ; preds = %for.cond6
  %idxprom = sext i32 %.sink5 to i64
...
for.cond15:                                       ; preds = %for.inc30, %for.end14
  %.sink6 = phi i32 [ 0, %for.end14 ], [ %add, %for.inc30 ]
  %cmp16 = icmp sle i32 %.sink6, 39
  br i1 %cmp16, label %for.inc30, label %for.inc33

for.inc30:                                        ; preds = %for.cond15
  %idxprom18 = sext i32 %.sink6 to i64
...
for.inc45:                                        ; preds = %for.cond39
  ...
  %5 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !12
