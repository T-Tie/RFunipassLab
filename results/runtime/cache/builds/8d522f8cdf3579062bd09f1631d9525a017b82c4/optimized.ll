...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec14 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
  %k.0 = phi i32 [ 1, %entry ], [ %k.1, %for.cond1 ]
  %dec = add nsw i32 %dec14, -1
  %tobool.not = icmp eq i32 %dec14, 0
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv16 = phi i64 [ %indvars.iv.next17.pre-phi, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv16
