...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv34 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next35, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  %2 = add i32 %j.0, -1
  %smax48 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count49 = zext nneg i32 %smax48 to i64
  %wide.trip.count44 = zext i32 %2 to i64
  br label %for.cond15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv34
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc40
  %indvars.iv38 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next39, %for.inc40 ]
  %exitcond50.not = icmp eq i64 %indvars.iv38, %wide.trip.count49
  br i1 %exitcond50.not, label %for.cond43.preheader, label %for.cond19.preheader
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc37
  %indvars.iv40 = phi i64 [ %indvars.iv38, %for.cond19.preheader ], [ %indvars.iv.next41, %for.inc37 ]
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc40, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %6 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next41
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv51 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next52, %for.inc53 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %wide.trip.count49
  br i1 %exitcond55.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv51
  ...
  %cmp49 = icmp slt i64 %indvars.iv51, %5
