...
entry:
  ...
  %sub11 = sub nsw i32 %0, %mul
  %mul12 = mul nsw i32 50, %div5
  %sub13 = sub nsw i32 %sub11, %mul12
  %mul14 = mul nsw i32 20, %div10
  %sub15 = sub nsw i32 %sub13, %mul14
  %rem22 = srem i32 %sub15, 10
  %sub23 = sub nsw i32 %sub15, %rem22
  %div24 = sdiv i32 %sub23, 10
  %rem25 = srem i32 %0, 10
  %rem27 = srem i32 %rem25, 5
  %sub28 = sub nsw i32 %rem25, %rem27
  %div29 = sdiv i32 %sub28, 5
  %mul36 = mul nsw i32 10, %div24
  %sub37 = sub nsw i32 %sub15, %mul36
  %mul38 = mul nsw i32 5, %div29
  %sub39 = sub nsw i32 %sub37, %mul38
  %call40 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div, i32 noundef %div5, i32 noundef %div10, i32 noundef %div24, i32 noundef %div29, i32 noundef %sub39) #5
