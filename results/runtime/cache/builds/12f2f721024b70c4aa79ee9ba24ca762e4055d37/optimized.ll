...
if.then:                                          ; preds = %while.body
  ...
  %.pre6 = fdiv double %.pre, %.pre3
  %.pre7 = fsub double %.pre6, %div
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %sub10.pre-phi = phi double [ %.pre7, %if.then ], [ %sub, %while.body ]
...
if.then12:                                        ; preds = %if.end
  ...
  %.pre4 = load double, ptr %b, align 8, !tbaa !5
  %.pre5 = load double, ptr %a, align 8, !tbaa !5
  %.pre8 = fdiv double %.pre4, %.pre5
  %.pre9 = fsub double %.pre8, %div
  br label %if.end15

if.end15:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi double [ %.pre9, %if.then12 ], [ %sub10.pre-phi, %if.end ]
