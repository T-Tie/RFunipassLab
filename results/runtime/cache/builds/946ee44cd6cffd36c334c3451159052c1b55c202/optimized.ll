...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 16000, ptr noundef align 16 %sv) #4
...
for.end9:                                         ; preds = %for.cond
  ...
  %3 = load double, ptr %arrayidx11, align 8, !tbaa !9
  %4 = load double, ptr %sv, align 16, !tbaa !9
  %div = fdiv double %3, %4
...
for.body16:                                       ; preds = %for.cond14
  ...
  %7 = load double, ptr %arrayidx19, align 8, !tbaa !9
  %8 = load double, ptr %arrayidx18, align 16, !tbaa !9
  %div23 = fdiv double %7, %8
...
land.lhs.true:                                    ; preds = %for.body16
  ...
  br i1 %cmp33, label %if.end58, label %if.else
...
land.lhs.true44:                                  ; preds = %if.else
  ...
  br i1 %cmp53, label %if.end58, label %if.else56

if.else56:                                        ; preds = %land.lhs.true44, %if.else
  br label %if.end58

if.end58:                                         ; preds = %land.lhs.true44, %land.lhs.true, %if.else56
...
for.end61:                                        ; preds = %for.cond14
  call void @llvm.lifetime.end.p0(i64 noundef 16000, ptr noundef %sv) #5
