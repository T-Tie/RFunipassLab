...
for.cond:                                         ; preds = %for.inc, %entry
  %n.promoted11 = phi i32 [ %.pre, %for.inc ], [ %0, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %1 = sext i32 %n.promoted11 to i64
...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  %2 = phi i32 [ %3, %for.inc30 ], [ %n.promoted11, %for.cond ]
...
for.cond6:                                        ; preds = %for.cond3, %for.inc27
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc27 ], [ 0, %for.cond3 ]
  %i.1 = phi i32 [ %i.2, %for.inc27 ], [ %i.0, %for.cond3 ]
  %4 = sext i32 %i.1 to i64
  %cmp7 = icmp slt i64 %indvars.iv19, %4
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv19
...
for.cond15.preheader:                             ; preds = %for.body9
  %smax = call i32 @llvm.smax.i32(i32 %i.1, i32 %3)
  %wide.trip.count = sext i32 %smax to i64
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv16 = phi i64 [ %4, %for.cond15.preheader ], [ %indvars.iv.next17, %for.inc23 ]
...
for.inc23:                                        ; preds = %for.cond15
  ...
  %arrayidx20 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv.next17
  %7 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv16
...
for.cond33:                                       ; preds = %for.cond3, %for.body35
  %9 = phi i32 [ %.pre25, %for.body35 ], [ %2, %for.cond3 ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body35 ], [ 0, %for.cond3 ]
  %10 = sext i32 %9 to i64
  %cmp34 = icmp slt i64 %indvars.iv22, %10
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %9, -1
  %11 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv22, %11
  %spec.select = select i1 %cmp36, ptr @.str, ptr @.str.1
  %arrayidx42 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv22
