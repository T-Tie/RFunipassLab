...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax56 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %13 = mul nsw i64 %indvars.iv51, %11
  %14 = mul nsw i64 %indvars.iv51, %12
  %15 = getelementptr i32, ptr %call36, i64 %13
  %16 = getelementptr i32, ptr %call2, i64 %14
  br label %for.cond40
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %15, i64 %indvars.iv44
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  %21 = phi i32 [ %23, %for.inc98 ], [ %9, %for.cond37 ]
  %22 = phi i32 [ %.pre, %for.inc98 ], [ %8, %for.cond37 ]
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %23 = phi i32 [ %.pre59, %for.inc95 ], [ %21, %for.cond77 ]
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %26 = phi i32 [ %.pre60, %if.then ], [ %25, %for.body82 ]
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre59 = phi i32 [ %26, %if.end ], [ %.pre59.pre, %if.then92 ]
