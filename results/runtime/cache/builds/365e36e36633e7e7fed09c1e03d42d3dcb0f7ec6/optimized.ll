...
for.cond3:                                        ; preds = %for.cond, %for.inc
  ...
  %2 = phi i32 [ %6, %for.inc ], [ %.pre12, %for.cond ]
...
for.body6:                                        ; preds = %for.cond3
  %4 = or i64 %indvars.iv, %indvars.iv8
...
for.inc:                                          ; preds = %for.body6, %if.then
  ...
  %6 = phi i32 [ %2, %for.body6 ], [ %.pre11, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.inc17:                                        ; preds = %for.cond13
  ...
  tail call void @_Z7zerocoli(i32 noundef %7)
  %8 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 408), align 4, !tbaa !5
  ...
  tail call void @_Z4jiani(i32 noundef %10)
