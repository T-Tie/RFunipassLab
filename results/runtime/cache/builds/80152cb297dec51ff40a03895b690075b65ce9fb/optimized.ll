...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = tail call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %0)
...
entry:
  ...
  %0 = load i32, ptr %arrayidx9, align 4, !tbaa !5
...
if.else5:                                         ; preds = %tailrecurse
  ...
  %cmp10.not = icmp sgt i32 %4, %0
  br i1 %cmp10.not, label %if.else16, label %if.then11

if.then11:                                        ; preds = %if.else5
  %5 = trunc nsw i64 %indvars.iv to i32
  %add = add nsw i32 %5, 1
  %call = tail call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %5, i32 noundef %n) #7
