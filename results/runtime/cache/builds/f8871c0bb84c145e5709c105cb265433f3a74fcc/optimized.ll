...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc27 ], [ 0, %tailrecurse ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond31.preheader, label %for.body
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv8
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv3
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc70
  %indvars.iv23 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next24, %for.inc70 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count11
  br i1 %exitcond28.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv23
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select1, %for.body42 ], [ %3, %for.body34 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv13, i64 %indvars.iv23
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %spec.select1 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond39, !llvm.loop !17

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv18 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next19, %for.inc67 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count16
  br i1 %exitcond22.not, label %for.inc70, label %for.inc67

for.inc67:                                        ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv18, i64 %indvars.iv23
...
for.end72:                                        ; preds = %for.cond31
  %6 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 424), align 4, !tbaa !5
