...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2004, ptr noundef nonnull %jishu) #5
  call void @llvm.lifetime.start.p0(i64 noundef 2004, ptr noundef nonnull %sz) #5
  br label %for.cond
...
for.cond12.preheader:                             ; preds = %for.cond
  ...
  br i1 %cmp13, label %for.cond17, label %for.end61
...
for.cond17:                                       ; preds = %for.cond12.preheader, %if.end37
  %3 = phi i32 [ %5, %if.end37 ], [ undef, %for.cond12.preheader ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %if.end37 ], [ 0, %for.cond12.preheader ]
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %arrayidx24 = getelementptr inbounds nuw [501 x i32], ptr %jishu, i64 0, i64 %indvars.iv.next12
...
if.then26:                                        ; preds = %for.cond17
  %arrayidx22 = getelementptr inbounds nuw [501 x i32], ptr %jishu, i64 0, i64 %indvars.iv11
  store i32 %4, ptr %arrayidx22, align 4, !tbaa !5
  store i32 %3, ptr %arrayidx24, align 4, !tbaa !5
  br label %if.end37

if.end37:                                         ; preds = %if.then26, %for.cond17
  %5 = phi i32 [ %3, %if.then26 ], [ %4, %for.cond17 ]
  br label %for.cond17

for.end61:                                        ; preds = %for.cond12.preheader
  call void @llvm.lifetime.end.p0(i64 noundef 2004, ptr noundef nonnull %sz) #5
  call void @llvm.lifetime.end.p0(i64 noundef 2004, ptr noundef nonnull %jishu) #5
