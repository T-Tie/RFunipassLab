...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 dereferenceable(1000) %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 dereferenceable(1000) %b) #9
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %if.then6.i9
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv30
  %2 = load i8, ptr %arrayidx54, align 1, !tbaa !9, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv30
...
if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull %a) #11
  ret i32 0
}
...
entry_to_outline:                                 ; preds = %newFuncRoot
  %call16.i = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #11
  br i1 %call16.i, label %land.lhs.true.i, label %if.then6.i9.exitStub

land.lhs.true.i:                                  ; preds = %entry_to_outline
  %_M_width.i1.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %1 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !17, !invariant.load !8
  %2 = add i64 %1, -1001
  %or.cond.i = icmp ult i64 %2, -1000
  br i1 %or.cond.i, label %if.then19.i, label %if.then6.i9.exitStub

if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #11
  ...
  br i1 %tobool.not.i, label %if.then6.i9.exitStub, label %if.then28.i
...
if.then28.i:                                      ; preds = %if.then19.i
  ...
  br label %if.then6.i9.exitStub

if.then6.i9.exitStub:                             ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry_to_outline
  ret void
}
