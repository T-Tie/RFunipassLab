...
for.cond12:                                       ; preds = %if.end, %if.then
  %j.0 = phi i32 [ %i.0, %if.then ], [ %inc, %if.end ]
  %k.2 = phi i32 [ 1, %if.then ], [ %k.3, %if.end ]
...
if.end:                                           ; preds = %if.then22, %for.body14
...
for.end:                                          ; preds = %for.cond12
  ...
  br i1 %tobool, label %if.then30, label %if.end25
...
for.cond31:                                       ; preds = %for.body33, %if.then30
  %i.1 = phi i32 [ 0, %if.then30 ], [ %inc39, %for.body33 ]
...
for.body33:                                       ; preds = %for.cond31
  ...
  %4 = load i8, ptr %arrayidx35, align 1, !tbaa !5
...
for.end40:                                        ; preds = %for.cond31
  ...
  %add43 = add nsw i32 %i.0, %conv
  br label %for.cond44

for.cond44:                                       ; preds = %for.body46, %for.end40
  %i.2 = phi i32 [ %add43, %for.end40 ], [ %inc52, %for.body46 ]
