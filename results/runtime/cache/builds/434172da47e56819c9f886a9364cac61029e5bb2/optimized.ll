...
entry:
  %vtable = load ptr, ptr %this, align 8, !tbaa !12, !invariant.load !8
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !12, !invariant.load !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !14, !invariant.load !8
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !33, !invariant.load !8
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !39, !invariant.load !8
  ret i64 %0
}
