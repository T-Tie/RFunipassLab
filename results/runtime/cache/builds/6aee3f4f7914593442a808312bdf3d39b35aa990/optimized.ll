...
while.cond.preheader:                             ; preds = %for.cond1
  %smax73 = call i32 @llvm.smax.i32(i32 %1, i32 0)
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end176
  %indvars.iv10 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next11, %for.end176 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.end176 ]
  %p.0 = phi i32 [ 0, %while.cond.preheader ], [ %inc177, %for.end176 ]
  %exitcond74.not = icmp eq i32 %p.0, %smax73
  br i1 %exitcond74.not, label %for.inc179, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %while.cond
  %smax69 = call i32 @llvm.smax.i32(i32 %indvars.iv10, i32 0)
  %wide.trip.count15 = zext nneg i32 %smax69 to i64
  %wide.trip.count = zext i32 %indvars.iv10 to i64
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  %indvars.iv12 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next13, %for.inc42 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond45.preheader, label %for.body16

for.cond45.preheader:                             ; preds = %for.cond14
  %wide.trip.count20 = zext i32 %indvars.iv10 to i64
  br label %for.cond45

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv12
  %5 = load i32, ptr %arrayidx18, align 16, !tbaa !5
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv12
...
for.cond22:                                       ; preds = %for.body25, %for.body16
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body25 ], [ 0, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv12, i64 %indvars.iv6
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc67
  %indvars.iv22 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next23, %for.inc67 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count15
  br i1 %exitcond27.not, label %for.cond70.preheader, label %for.cond49.preheader

for.cond70.preheader:                             ; preds = %for.cond45
  %wide.trip.count31 = zext i32 %indvars.iv10 to i64
  br label %for.cond70

for.cond49.preheader:                             ; preds = %for.cond45
  %arrayidx58 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv22
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  %indvars.iv17 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next18, %for.inc64 ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count20
  br i1 %exitcond21.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond49
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv17
...
for.cond70:                                       ; preds = %for.cond70.preheader, %for.inc101
  %indvars.iv33 = phi i64 [ 0, %for.cond70.preheader ], [ %indvars.iv.next34, %for.inc101 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count15
  br i1 %exitcond38.not, label %for.cond104.preheader, label %for.body73

for.cond104.preheader:                            ; preds = %for.cond70
  %wide.trip.count42 = zext i32 %indvars.iv10 to i64
  br label %for.cond104

for.body73:                                       ; preds = %for.cond70
  %arrayidx76 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv33
  %10 = load i32, ptr %arrayidx76, align 4, !tbaa !5
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv33
  store i32 %10, ptr %arrayidx78, align 4, !tbaa !5
  br label %for.cond79

for.cond79:                                       ; preds = %for.body82, %for.body73
  %11 = phi i32 [ %spec.store.select1, %for.body82 ], [ %10, %for.body73 ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body82 ], [ 0, %for.body73 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count31
  br i1 %exitcond32.not, label %for.inc101, label %for.body82

for.body82:                                       ; preds = %for.cond79
  %arrayidx88 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv33
  %12 = load i32, ptr %arrayidx88, align 4, !tbaa !5
  %spec.store.select1 = call i32 @llvm.smin.i32(i32 %11, i32 %12)
  store i32 %spec.store.select1, ptr %arrayidx78, align 4
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  %indvars.iv44 = phi i64 [ 0, %for.cond104.preheader ], [ %indvars.iv.next45, %for.inc126 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count15
  br i1 %exitcond49.not, label %for.end128, label %for.cond108

for.cond108:                                      ; preds = %for.cond104, %for.inc123
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc123 ], [ 0, %for.cond104 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count42
  br i1 %exitcond43.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond108
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv39
  %13 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx117 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv39
...
for.end128:                                       ; preds = %for.cond104
  ...
  %wide.trip.count53 = zext i32 %indvars.iv10 to i64
  br label %for.cond131

for.cond131:                                      ; preds = %for.inc151, %for.end128
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc151 ], [ 0, %for.end128 ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %wide.trip.count15
  br i1 %exitcond60.not, label %for.cond154.preheader, label %for.cond135

for.cond154.preheader:                            ; preds = %for.cond131
  %wide.trip.count64 = zext i32 %indvars.iv10 to i64
  br label %for.cond154

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count53
  br i1 %exitcond54.not, label %for.inc151, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next51
  %16 = load i32, ptr %arrayidx143, align 4, !tbaa !5
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv50
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  %indvars.iv66 = phi i64 [ 0, %for.cond154.preheader ], [ %indvars.iv.next67, %for.inc174 ]
  %exitcond71.not = icmp eq i64 %indvars.iv66, %wide.trip.count15
  br i1 %exitcond71.not, label %for.end176, label %for.cond158

for.cond158:                                      ; preds = %for.cond154, %for.inc171
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc171 ], [ 1, %for.cond154 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count64
  br i1 %exitcond65.not, label %for.inc174, label %for.inc171

for.inc171:                                       ; preds = %for.cond158
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %arrayidx166 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next62, i64 %indvars.iv66
  %17 = load i32, ptr %arrayidx166, align 4, !tbaa !5
  %arrayidx170 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv61, i64 %indvars.iv66
