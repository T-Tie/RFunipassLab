...
for.cond2:                                        ; preds = %for.body4, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc8, %for.body4 ]
...
for.cond13:                                       ; preds = %if.end39, %for.body12
  %i.2.sink = phi i32 [ %i.2, %for.body12 ], [ %add, %if.end39 ]
...
for.cond45:                                       ; preds = %for.end76, %for.end44
  %i.3 = phi i32 [ 0, %for.end44 ], [ %add49, %for.end76 ]
  %sub46 = sub nsw i32 %0, 1
  %cmp47 = icmp slt i32 %i.3, %sub46
  br i1 %cmp47, label %for.body48, label %for.end79

for.body48:                                       ; preds = %for.cond45
  %add49 = add nsw i32 %i.3, 1
  br label %for.cond50

for.cond50:                                       ; preds = %if.end73, %for.body48
  %j.1 = phi i32 [ %add49, %for.body48 ], [ %inc75, %if.end73 ]
  %cmp51 = icmp slt i32 %j.1, %0
...
for.body52:                                       ; preds = %for.cond50
  ...
  %5 = load i32, ptr %h55, align 4, !tbaa !12
  ...
  %6 = load i32, ptr %h58, align 4, !tbaa !12
...
for.end79:                                        ; preds = %for.cond45
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %7) #5
