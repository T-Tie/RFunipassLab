...
for.cond33:                                       ; preds = %for.cond30, %for.inc71
  ...
  br i1 %cmp34.not, label %for.inc74, label %for.body35
...
for.end57:                                        ; preds = %for.cond40
  ...
  %cmp64.not = icmp eq i64 %indvars.iv48, %20
  %or.cond = select i1 %cmp63, i1 true, i1 %cmp64.not
...
for.inc71:                                        ; preds = %if.then, %if.then68, %if.else
