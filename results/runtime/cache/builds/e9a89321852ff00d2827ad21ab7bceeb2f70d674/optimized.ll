...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond7 = icmp eq i64 %indvars.iv4, %2
  br i1 %exitcond7, label %for.cond21.preheader, label %for.cond6
...
for.inc:                                          ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv4
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv8 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next9, %for.inc26 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond29.preheader, label %for.inc26
...
for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv8
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv13 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next14, %for.inc54 ]
  %exitcond20.not = icmp eq i64 %indvars.iv13, %wide.trip.count11
  br i1 %exitcond20.not, label %for.cond57, label %for.cond32.preheader
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  ...
  %cmp33 = icmp samesign ult i64 %indvars.iv15, %8
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count11
  br i1 %exitcond25.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv21
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc89 ], [ 0, %if.else ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count11
  br i1 %exitcond30.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv26
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv26
...
if.end92.exitStub:
  %call72 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %0)
