...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.body5 ], [ 0, %for.cond3.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv7, %idxprom6
  br i1 %exitcond.not, label %for.end24, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv7
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv10 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next11, %for.inc19 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond11
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next11
  %8 = load i32, ptr %arrayidx16, align 4, !tbaa !5, !invariant.load !13
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv10
...
for.cond29:                                       ; preds = %while.cond, %for.inc37
  ...
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc37 ], [ 0, %while.cond ]
  %sub30 = add nsw i32 %10, -1
  %11 = sext i32 %sub30 to i64
  %cmp31 = icmp slt i64 %indvars.iv15, %11
  br i1 %cmp31, label %for.inc37, label %for.end39

for.inc37:                                        ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv15
  ...
  %call36 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call35, ptr noundef nonnull @.str)
