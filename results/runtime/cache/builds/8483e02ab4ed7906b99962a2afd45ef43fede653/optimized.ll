...
if.else:                                          ; preds = %while.body
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i2)
  store i8 32, ptr %__c.addr.i2, align 1, !tbaa !5
  %vtable.i3 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !8
  %vbase.offset.ptr.i4 = getelementptr i8, ptr %vtable.i3, i64 -24
  %vbase.offset.i5 = load i64, ptr %vbase.offset.ptr.i4, align 8, !invariant.load !10
  %gep17 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i5
  %2 = load i64, ptr %gep17, align 8, !tbaa !11
  %cmp.not.i8 = icmp eq i64 %2, 0
  br i1 %cmp.not.i8, label %if.end.i12, label %if.then.i9

if.then.i9:                                       ; preds = %if.else
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i2, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14

if.end.i12:                                       ; preds = %if.else
  %call2.i13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14: ; preds = %if.then.i9, %if.end.i12
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i2)
  br label %while.cond8

while.cond8:                                      ; preds = %while.body11, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14
  %3 = phi i8 [ 32, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14 ], [ %.pre, %while.body11 ]
  %p.2 = phi ptr [ %p.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14 ], [ %incdec.ptr12, %while.body11 ]
  %i.2 = phi i32 [ %i.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14 ], [ %inc13, %while.body11 ]
...
while.body11:                                     ; preds = %while.cond8
  ...
  %.pre = load i8, ptr %incdec.ptr12, align 1, !tbaa !5, !invariant.load !10
...
!27 = !{!28, !32, i64 240}
!28 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !12, i64 0, !29, i64 216, !6, i64 224, !30, i64 225, !31, i64 232, !32, i64 240, !33, i64 248, !34, i64 256}
