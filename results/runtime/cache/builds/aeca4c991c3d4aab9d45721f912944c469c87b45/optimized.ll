...
for.body77:                                       ; preds = %for.cond74
  ...
  %9 = load double, ptr %arrayidx80, align 8, !tbaa !9, !invariant.load !11
  %10 = load double, ptr %arrayidx79, align 16, !tbaa !9, !invariant.load !11
  %mul88 = fmul double 4.000000e+00, %10
  %arrayidx91 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 2
  %11 = load double, ptr %arrayidx91, align 16, !tbaa !9, !invariant.load !11
  ...
  %14 = load double, ptr %13, align 8, !tbaa !9, !invariant.load !11
  %15 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %16 = load double, ptr %15, align 16, !tbaa !9, !invariant.load !11
...
if.else117:                                       ; preds = %for.body77
  ...
  %17 = load double, ptr %arrayidx129, align 8, !tbaa !9, !invariant.load !11
