...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 792, ptr %x1) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %x2) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %a) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %b) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %c) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %disc) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %realpart) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %imagpart) #5
  br label %for.cond
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul15 = fmul double %3, 4.000000e+00
...
if.else:                                          ; preds = %for.body8
  %cmp31 = fcmp ogt double %5, 0.000000e+00
  br i1 %cmp31, label %if.then32, label %if.else62

if.then32:                                        ; preds = %if.else
  %fneg35 = fneg double %2
  %call38 = call double @sqrt(double noundef %5) #5, !tbaa !5
  %add = fadd double %fneg35, %call38
  %mul41 = fmul double %3, 2.000000e+00
  ...
  %call50 = call double @sqrt(double noundef %5) #5, !tbaa !5
...
if.else62:                                        ; preds = %if.else
  ...
  %mul68 = fmul double %3, 2.000000e+00
...
for.end108:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 792, ptr %imagpart) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %realpart) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %disc) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %c) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %b) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %a) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %x2) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr %x1) #5
