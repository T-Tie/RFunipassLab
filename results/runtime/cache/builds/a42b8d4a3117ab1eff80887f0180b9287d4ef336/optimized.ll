...
for.inc8:                                         ; preds = %for.cond2
  ...
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %2, i32 noundef %0) #7
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv3 = phi i64 [ %idxprom7, %for.cond2.preheader ], [ %indvars.iv.next4, %for.inc13 ]
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, 1
  %cmp3 = icmp slt i64 %indvars.iv.next4, %0
  br i1 %cmp3, label %for.body4, label %for.end15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv.next4
...
if.then10:                                        ; preds = %for.body4
  ...
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %3, i32 noundef %m) #9
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next4
...
for.cond20:                                       ; preds = %for.body22, %for.end15
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body22 ], [ %idxprom7, %for.end15 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ %4, %for.end15 ]
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, 1
  %cmp21 = icmp slt i64 %indvars.iv.next7, %0
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next7
