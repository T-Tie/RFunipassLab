...
for.cond10:                                       ; preds = %for.inc28, %for.end9
  %p.0 = phi i32 [ 0, %for.end9 ], [ %p.3, %for.inc28 ]
  %b1.0 = phi i32 [ undef, %for.end9 ], [ %b1.3, %for.inc28 ]
  %a1.0 = phi i32 [ undef, %for.end9 ], [ %a1.3, %for.inc28 ]
...
for.cond14:                                       ; preds = %for.inc24, %if.then
  %p.1 = phi i32 [ %p.0, %if.then ], [ %p.2, %for.inc24 ]
  %b1.1 = phi i32 [ %b1.0, %if.then ], [ %b1.2, %for.inc24 ]
  %a1.1 = phi i32 [ %a1.0, %if.then ], [ %a1.2, %for.inc24 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %cmp21 = icmp eq i32 %4, 0
  br i1 %cmp21, label %if.then22, label %for.inc24

if.then22:                                        ; preds = %for.body16
  %add23 = add nsw i32 %p.1, 1
  br label %for.inc24

for.inc24:                                        ; preds = %for.body16, %if.then22
  %p.2 = phi i32 [ %add23, %if.then22 ], [ %p.1, %for.body16 ]
  %b1.2 = phi i32 [ %3, %if.then22 ], [ %b1.1, %for.body16 ]
  %a1.2 = phi i32 [ %i.1, %if.then22 ], [ %a1.1, %for.body16 ]
  %add25 = add nsw i32 %3, 1
  store i32 %add25, ptr %j, align 4, !tbaa !5
  br label %for.cond14, !llvm.loop !13

for.inc28:                                        ; preds = %for.body12, %for.cond14
  %p.3 = phi i32 [ %p.1, %for.cond14 ], [ %p.0, %for.body12 ]
  %b1.3 = phi i32 [ %b1.1, %for.cond14 ], [ %b1.0, %for.body12 ]
  %a1.3 = phi i32 [ %a1.1, %for.cond14 ], [ %a1.0, %for.body12 ]
...
for.cond31:                                       ; preds = %for.inc52, %for.end30
  %p.4 = phi i32 [ 0, %for.end30 ], [ %p.7, %for.inc52 ]
  %b2.0 = phi i32 [ undef, %for.end30 ], [ %b2.3, %for.inc52 ]
  %a2.0 = phi i32 [ undef, %for.end30 ], [ %a2.3, %for.inc52 ]
  %sub.sink = phi i32 [ %sub, %for.end30 ], [ %dec, %for.inc52 ]
...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  %p.5 = phi i32 [ %p.4, %if.then35 ], [ %p.6, %for.inc48 ]
  %b2.1 = phi i32 [ %b2.0, %if.then35 ], [ %b2.2, %for.inc48 ]
  %a2.1 = phi i32 [ %a2.0, %if.then35 ], [ %a2.2, %for.inc48 ]
  %n.sink = phi ptr [ %n, %if.then35 ], [ %j, %for.inc48 ]
  %5 = load i32, ptr %n.sink, align 4, !tbaa !5
  %sub36 = sub nsw i32 %5, 1
  store i32 %sub36, ptr %j, align 4, !tbaa !5
  %cmp38 = icmp sge i32 %sub36, 0
...
for.body39:                                       ; preds = %for.cond37
  ...
  %idxprom42 = sext i32 %sub36 to i64
...
if.then45:                                        ; preds = %for.body39
  %add46 = add nsw i32 %p.5, 1
  br label %for.inc48

for.inc48:                                        ; preds = %for.body39, %if.then45
  %p.6 = phi i32 [ %add46, %if.then45 ], [ %p.5, %for.body39 ]
  %b2.2 = phi i32 [ %sub36, %if.then45 ], [ %b2.1, %for.body39 ]
  %a2.2 = phi i32 [ %sub.sink, %if.then45 ], [ %a2.1, %for.body39 ]
  br label %for.cond37, !llvm.loop !15

for.inc52:                                        ; preds = %for.body33, %for.cond37
  %p.7 = phi i32 [ %p.5, %for.cond37 ], [ %p.4, %for.body33 ]
  %b2.3 = phi i32 [ %b2.1, %for.cond37 ], [ %b2.0, %for.body33 ]
  %a2.3 = phi i32 [ %a2.1, %for.cond37 ], [ %a2.0, %for.body33 ]
  %dec = add nsw i32 %sub.sink, -1
  br label %for.cond31, !llvm.loop !16

for.end53:                                        ; preds = %for.cond31
  %.neg = sub i32 0, %b1.0
  %sub54 = add i32 %b2.0, 1
  %add55 = add i32 %sub54, %.neg
  %.neg1 = sub i32 0, %a2.0
  %sub56 = add i32 %a1.0, 1
  %add57 = add i32 %sub56, %.neg1
