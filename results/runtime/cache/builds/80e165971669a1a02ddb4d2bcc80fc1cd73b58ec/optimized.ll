...
land.lhs.true.i17:                                ; preds = %if.then6.i11
  ...
  %3 = add i64 %2, -1001
  %or.cond.i21 = icmp ult i64 %3, -1000
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30: ; preds = %if.then6.i11, %land.lhs.true.i17, %if.then19.i22, %if.then28.i29
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #11
  %conv = trunc i64 %call5 to i32
  %call7 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %b) #11
  %conv8 = trunc i64 %call7 to i32
  %cmp.not = icmp eq i32 %conv, %conv8
  br i1 %cmp.not, label %for.cond.preheader, label %if.end75

for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count
  br i1 %exitcond54.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv50
  %6 = load i8, ptr %arrayidx54, align 1, !tbaa !22, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv50
...
if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ], [ %.str.3..str.2, %for.end65 ]
