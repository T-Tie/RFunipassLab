...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select4 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select4
  ...
  %or.cond5 = or i1 %cmp12, %or.cond
  %x.promoted8 = load i32, ptr %x, align 4
  %smax11 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond5, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %add199 = phi i32 [ %add, %for.inc ], [ %x.promoted8, %for.body ]
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond12.not = icmp eq i32 %m.0, %smax11
  br i1 %exitcond12.not, label %for.inc53, label %for.body16
...
for.inc:                                          ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %sw.bb17, %sw.default
  ...
  %add = add nsw i32 %add199, %.sink
  %inc = add i32 %m.0, 1
  br label %for.cond14, !llvm.loop !9

for.cond30:                                       ; preds = %for.body, %for.inc40
  %add386 = phi i32 [ %add34, %for.inc40 ], [ %x.promoted8, %for.body ]
  %m.1 = phi i32 [ %inc41, %for.inc40 ], [ %a.1, %for.body ]
  %exitcond.not = icmp eq i32 %m.1, %smax11
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  %.sink13 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add34 = add nsw i32 %add386, %.sink13
  %inc41 = add i32 %m.1, 1
  br label %for.cond30, !llvm.loop !12

for.inc53:                                        ; preds = %for.cond30, %for.cond14
  %add199.lcssa.sink = phi i32 [ %add199, %for.cond14 ], [ %add386, %for.cond30 ]
  store i32 %add199.lcssa.sink, ptr %x, align 4
