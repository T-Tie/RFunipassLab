...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  %indvars.iv5 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond2
  %2 = trunc nuw nsw i64 %indvars.iv5 to i32
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %2, i32 noundef %0) #8
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv5
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond13.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv9
...
for.end21:                                        ; preds = %for.cond11
  ...
  %call23 = call i32 @getchar() #8
  %call24 = call i32 @getchar() #8
  %call25 = call i32 @getchar() #8
...
entry:
  %b = alloca [25 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %b) #9
  %sub = add nsw i32 %m, -1
...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc13 ], [ %0, %for.end ]
  %cmp3 = icmp slt i64 %indvars.iv2, %1
  br i1 %cmp3, label %for.body4, label %for.end15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv2
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !15
  %3 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !15
  %cmp9.not = icmp sgt i32 %2, %3
  br i1 %cmp9.not, label %for.inc13, label %if.then10

if.then10:                                        ; preds = %for.body4
  %4 = trunc nsw i64 %indvars.iv2 to i32
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %4, i32 noundef %m) #10
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv2
...
for.cond20:                                       ; preds = %for.body22, %for.end15
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.body22 ], [ %0, %for.end15 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ %5, %for.end15 ]
  %cmp21 = icmp slt i64 %indvars.iv5, %1
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv5
...
cleanup:                                          ; preds = %entry, %for.end32
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull align 16 %b) #9
  ret i32 %retval.0
}
...
attributes #5 = { inlinehint mustprogress nofree nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
