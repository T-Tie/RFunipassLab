...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  ...
  %exitcond24.not = icmp eq i32 %j.0, %smax23
...
for.cond47.preheader:                             ; preds = %for.cond16
  ...
  %smax29 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv25 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next26, %for.inc58 ]
  %exitcond31.not = icmp eq i64 %indvars.iv25, %wide.trip.count30
  br i1 %exitcond31.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv25
  ...
  %cmp54.not = icmp eq i64 %indvars.iv25, %4
