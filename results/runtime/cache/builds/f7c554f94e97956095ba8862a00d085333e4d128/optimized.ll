...
if.then15:                                        ; preds = %for.end13
  ...
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 4 captures(none) %add.ptr16, i32 noundef %n, i32 noundef %sub17) #5
  br label %if.end18
...
if.then18:                                        ; preds = %for.end16
  ...
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 4 captures(none) %add.ptr19, i32 noundef %n, i32 noundef %sub20) #5
  br label %if.end21
...
for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %6, i32 noundef %6) #6
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %6, i32 noundef %6) #6
...
for.cond40:                                       ; preds = %for.inc60, %for.end39
  ...
  %sub41 = sub nsw i32 %6, 1
  %cmp42 = icmp slt i32 %12, %sub41
...
for.cond44:                                       ; preds = %for.inc57, %for.body43
  ...
  %cmp46 = icmp slt i32 %13, %sub41
  br i1 %cmp46, label %for.body47, label %for.end59

for.body47:                                       ; preds = %for.cond44
  %add48 = add nsw i32 %13, 1
  ...
  %14 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !17
  ...
  store i32 %14, ptr %arrayidx56, align 4, !tbaa !5
  br label %for.inc57
...
for.end64:                                        ; preds = %for.cond14
  ...
  %call65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15)
  br label %for.inc66
