...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 %a) #6
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv8
...
while.end19:                                      ; preds = %while.cond8, %while.cond8
  %4 = trunc nuw nsw i64 %indvars.iv8 to i32
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %j, i32 %lenq.0, ptr nonnull %incdec.ptr23)
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 captures(none) dereferenceable(4) initializes((0, 4)) %0, i32 %1, ptr readonly captures(none) %2) unnamed_addr #5 {
if.then_to_outline:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then_to_outline
  %storemerge = phi i32 [ 0, %if.then_to_outline ], [ %inc29, %for.inc ]
  store i32 %storemerge, ptr %0, align 4, !tbaa !11
  %cmp25.not.not = icmp slt i32 %storemerge, %1
  br i1 %cmp25.not.not, label %for.inc, label %for.end.exitStub

for.inc:                                          ; preds = %for.cond
  %idx.ext26 = sext i32 %storemerge to i64
  %add.ptr27 = getelementptr inbounds i8, ptr %2, i64 %idx.ext26
  %3 = load i8, ptr %add.ptr27, align 1, !tbaa !5, !invariant.load !13
  %call28 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %3)
