...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %5) #6
  %6 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %6) #6
...
for.body19:                                       ; preds = %for.cond17
  ...
  %10 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !13
  %cmp22 = icmp eq i32 %10, 1
  br i1 %cmp22, label %if.then23, label %if.else

if.then23:                                        ; preds = %for.body19
  %call24 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #7
  br label %for.inc27

if.else:                                          ; preds = %for.body19
  %call25 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #7
  br label %for.inc27
...
for.end29:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %sz) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %result) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %year) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %mon2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %mon1) #7
...
for.inc.gvnsink.split:                            ; preds = %if.else33, %land.lhs.true, %if.then24, %if.else, %lor.lhs.false14, %lor.lhs.false16, %lor.lhs.false18, %for.body, %lor.lhs.false, %lor.lhs.false3, %lor.lhs.false5, %lor.lhs.false7, %lor.lhs.false9, %lor.lhs.false11
  %.sink1.sink = phi i32 [ 31, %lor.lhs.false11 ], [ 31, %lor.lhs.false9 ], [ 31, %lor.lhs.false7 ], [ 31, %lor.lhs.false5 ], [ 31, %lor.lhs.false3 ], [ 31, %lor.lhs.false ], [ 31, %for.body ], [ 30, %lor.lhs.false18 ], [ 30, %lor.lhs.false16 ], [ 30, %lor.lhs.false14 ], [ 30, %if.else ], [ 28, %if.else33 ], [ 29, %land.lhs.true ], [ 29, %if.then24 ]
  %1 = load i32, ptr %result, align 4, !tbaa !5
  %add34 = add nsw i32 %1, %.sink1.sink
