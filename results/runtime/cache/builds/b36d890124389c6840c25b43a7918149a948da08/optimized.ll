...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 15000, ptr nonnull %b) #6
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 15000, ptr nonnull %b) #6
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !39
