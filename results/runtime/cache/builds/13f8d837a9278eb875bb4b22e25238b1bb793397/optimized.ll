...
for.end46:                                        ; preds = %for.cond34
  %m.0.lcssa = phi i32 [ %m.0, %for.cond34 ]
  %call47 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %m.0.lcssa) #5
