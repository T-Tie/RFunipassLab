...
for.cond13:                                       ; preds = %for.inc38, %for.end9
  %3 = phi i32 [ %dec, %for.inc38 ], [ %sub12, %for.end9 ]
...
for.cond16:                                       ; preds = %for.inc35, %for.body15
  %.sink2 = phi i32 [ %3, %for.body15 ], [ %add, %for.inc35 ]
...
for.end52:                                        ; preds = %for.cond40
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %9) #5
