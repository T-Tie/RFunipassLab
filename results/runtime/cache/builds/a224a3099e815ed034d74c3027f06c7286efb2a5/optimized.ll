...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond21 = select i1 %cmp7, i1 true, i1 %or.cond
  br i1 %or.cond21, label %if.then, label %for.inc
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink, i32 noundef %6) #6
  %.pre23 = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc36

for.inc36:                                        ; preds = %for.body27, %if.then31
  %7 = phi i32 [ %.sink, %for.body27 ], [ %.pre23, %if.then31 ]
  %inc37 = add nsw i32 %7, 1
  br label %for.cond25, !llvm.loop !13

for.cond39:                                       ; preds = %for.cond25, %for.inc50
  %.sink17 = phi i32 [ %inc51, %for.inc50 ], [ 97, %for.cond25 ]
  store i32 %.sink17, ptr @i, align 4, !tbaa !5
  %cmp40 = icmp slt i32 %.sink17, 123
  br i1 %cmp40, label %for.body41, label %for.end52

for.body41:                                       ; preds = %for.cond39
  %idxprom42 = sext i32 %.sink17 to i64
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink17, i32 noundef %8) #6
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.body41, %if.then45
  %9 = phi i32 [ %.sink17, %for.body41 ], [ %.pre, %if.then45 ]
