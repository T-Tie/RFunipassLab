...
NodeBlock15:                                      ; preds = %NodeBlock17
  %Pivot16 = icmp slt i32 %rem1, 7
  br i1 %Pivot16, label %NodeBlock9, label %NodeBlock13

NodeBlock13:                                      ; preds = %NodeBlock15
  %Pivot14 = icmp slt i32 %rem1, 8
  br i1 %Pivot14, label %sw.epilog.gvnsink.split, label %NodeBlock11

NodeBlock11:                                      ; preds = %NodeBlock13
  %Pivot12 = icmp slt i32 %rem1, 9
  br i1 %Pivot12, label %sw.bb12, label %sw.epilog.gvnsink.split

NodeBlock9:                                       ; preds = %NodeBlock15
  %Pivot10 = icmp slt i32 %rem1, 6
  br i1 %Pivot10, label %sw.bb33, label %sw.epilog.gvnsink.split

NodeBlock7:                                       ; preds = %NodeBlock17
  %Pivot8 = icmp slt i32 %rem1, 2
  br i1 %Pivot8, label %NodeBlock, label %NodeBlock5

NodeBlock5:                                       ; preds = %NodeBlock7
  %Pivot6 = icmp slt i32 %rem1, 3
  br i1 %Pivot6, label %sw.epilog.gvnsink.split, label %NodeBlock3

NodeBlock3:                                       ; preds = %NodeBlock5
  %Pivot4 = icmp slt i32 %rem1, 4
  br i1 %Pivot4, label %sw.bb47, label %sw.epilog.gvnsink.split
...
sw.bb33:                                          ; preds = %NodeBlock9
  br label %sw.epilog.gvnsink.split

sw.bb47:                                          ; preds = %NodeBlock3
  br label %sw.epilog.gvnsink.split

sw.epilog.gvnsink.split:                          ; preds = %LeafBlock, %NodeBlock, %NodeBlock5, %NodeBlock3, %NodeBlock9, %NodeBlock13, %NodeBlock11, %sw.bb12, %sw.bb33, %sw.bb47
  %.sink2 = phi i32 [ 0, %sw.bb47 ], [ 1, %sw.bb33 ], [ 1, %sw.bb12 ], [ 1, %NodeBlock11 ], [ 1, %NodeBlock13 ], [ 1, %NodeBlock9 ], [ 0, %NodeBlock3 ], [ 0, %NodeBlock5 ], [ 0, %NodeBlock ], [ 0, %LeafBlock ]
  %.sink1 = phi i32 [ 1, %sw.bb47 ], [ 0, %sw.bb33 ], [ 1, %sw.bb12 ], [ 2, %NodeBlock11 ], [ 1, %NodeBlock13 ], [ 0, %NodeBlock9 ], [ 2, %NodeBlock3 ], [ 1, %NodeBlock5 ], [ 0, %NodeBlock ], [ 0, %LeafBlock ]
  %.sink = phi i32 [ 1, %sw.bb47 ], [ 0, %sw.bb33 ], [ 1, %sw.bb12 ], [ 0, %NodeBlock11 ], [ 0, %NodeBlock13 ], [ 1, %NodeBlock9 ], [ 0, %NodeBlock3 ], [ 0, %NodeBlock5 ], [ 1, %NodeBlock ], [ 0, %LeafBlock ]
