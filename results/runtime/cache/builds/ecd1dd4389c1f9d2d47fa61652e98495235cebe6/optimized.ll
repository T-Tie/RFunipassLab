...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv24 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next25, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv31 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next32, %for.inc44 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond37.not = icmp eq i32 %m.0, %smax36
  br i1 %exitcond37.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax33 = call i32 @llvm.smax.i32(i32 %indvars.iv31, i32 0)
  %wide.trip.count34 = zext nneg i32 %smax33 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count41 = zext nneg i32 %smax36 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.backedge, %for.cond19.preheader
  %indvars.iv28 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next29, %for.cond19.backedge ]
  %exitcond35.not = icmp eq i64 %indvars.iv28, %wide.trip.count34
  br i1 %exitcond35.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv28
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next29
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.body50
  %indvars.iv38 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next39, %for.body50 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count41
  br i1 %exitcond42.not, label %for.end57, label %for.body50

for.body50:                                       ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv38
