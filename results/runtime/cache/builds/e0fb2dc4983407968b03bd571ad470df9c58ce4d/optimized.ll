...
for.end.split.loop.exit:                          ; preds = %for.body16
  %8 = trunc nuw nsw i64 %indvars.iv114 to i32
  br label %for.end
...
for.end45:                                        ; preds = %for.cond37
  ...
  %11 = sext i32 %indvars.iv131 to i64
  %sext = shl i64 %call6, 32
  %12 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %for.inc54 ], [ %11, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv134, %12
...
for.body50:                                       ; preds = %for.cond48
  ...
  %14 = load i64, ptr %gep110, align 8, !tbaa !22, !invariant.load !8
...
land.lhs.true.i15_to_outline:                     ; preds = %newFuncRoot
  ...
  %_M_width.i1.i16 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %2 = load i64, ptr %_M_width.i1.i16, align 8, !tbaa !22, !invariant.load !8
  %3 = add i64 %2, -257
  %or.cond.i19 = icmp ult i64 %3, -256
  br i1 %or.cond.i19, label %if.then19.i20, label %land.lhs.true.i43.exitStub

if.then19.i20:                                    ; preds = %land.lhs.true.i15_to_outline
  %_M_streambuf.i.i21 = getelementptr inbounds nuw i8, ptr %1, i64 232
  ...
  br i1 %tobool.not.i26, label %land.lhs.true.i43.exitStub, label %if.then28.i27

if.then28.i27:                                    ; preds = %if.then19.i20
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %1, i32 noundef 2)
  br label %land.lhs.true.i43.exitStub

land.lhs.true.i43.exitStub:                       ; preds = %if.then28.i27, %if.then19.i20, %land.lhs.true.i15_to_outline
  ret void
}
