...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv9 = phi i64 [ %1, %for.cond.preheader ], [ %3, %for.inc ]
  %2 = trunc nuw i64 %indvars.iv9 to i32
...
for.end:                                          ; preds = %for.cond
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i6)
