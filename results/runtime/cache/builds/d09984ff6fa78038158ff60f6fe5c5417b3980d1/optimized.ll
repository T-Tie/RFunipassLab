...
for.cond30.preheader:                             ; preds = %for.cond7
  ...
  %smax27 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond30
...
for.inc56:                                        ; preds = %for.body32, %if.else52, %if.then50
  ...
  %add35 = add nuw nsw i32 %.sink29, %n2.0
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
...
for.inc109:                                       ; preds = %for.body87, %if.else105, %if.then103
  ...
  %add90 = add nuw nsw i32 %.sink30, %n182.0
...
for.inc138:                                       ; preds = %for.body114, %if.else134, %if.then132
  ...
  %add117 = add nuw nsw i32 %.sink31, %n283.0
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts22 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.7.sink) #6
  br label %for.inc164
