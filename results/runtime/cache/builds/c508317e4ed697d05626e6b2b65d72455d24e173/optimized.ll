...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec8 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv10 = phi i64 [ %indvars.iv.next11.pre-phi, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv10
