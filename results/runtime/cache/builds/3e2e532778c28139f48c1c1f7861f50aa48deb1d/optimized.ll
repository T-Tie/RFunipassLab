...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond144.not, label %if.end178.loopexit167, label %for.inc148
...
if.end178.loopexit167:                            ; preds = %for.cond137
  %.pre168 = add nuw nsw i64 %indvars.iv151, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit167
  %.pre.pre-phi = phi i64 [ %.pre168, %if.end178.loopexit167 ], [ %20, %for.cond158 ]
