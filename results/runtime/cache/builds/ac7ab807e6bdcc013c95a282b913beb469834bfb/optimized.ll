...
for.end32:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #6
  store ptr null, ptr %a, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #6
...
for.cond40:                                       ; preds = %for.inc71, %for.body39
  ...
  %cmp41 = icmp slt i32 %3, %1
  br i1 %cmp41, label %for.body42, label %for.inc74

for.body42:                                       ; preds = %for.cond40
  %mul43 = mul nsw i32 %2, %1
  %add44 = add nsw i32 %mul43, %3
...
for.cond47:                                       ; preds = %for.inc68, %for.body42
  ...
  %4 = load i32, ptr %x2, align 4, !tbaa !10
  %cmp48 = icmp slt i32 %k.0, %4
  br i1 %cmp48, label %for.inc68, label %for.inc71

for.inc68:                                        ; preds = %for.cond47
  %5 = load i32, ptr %arrayidx46, align 4, !tbaa !10, !invariant.load !12
  %6 = load ptr, ptr %a, align 8, !tbaa !5
  %7 = load i32, ptr %y1, align 4, !tbaa !10
  %mul54 = mul nsw i32 %2, %7
  %add55 = add nsw i32 %mul54, %k.0
  %idxprom56 = sext i32 %add55 to i64
  %arrayidx57 = getelementptr inbounds i32, ptr %6, i64 %idxprom56
  %8 = load i32, ptr %arrayidx57, align 4, !tbaa !10, !invariant.load !12
  %9 = load ptr, ptr %b, align 8, !tbaa !5
  %mul58 = mul nsw i32 %k.0, %1
  %add59 = add nsw i32 %mul58, %3
  %idxprom60 = sext i32 %add59 to i64
  %arrayidx61 = getelementptr inbounds i32, ptr %9, i64 %idxprom60
  %10 = load i32, ptr %arrayidx61, align 4, !tbaa !10, !invariant.load !12
  %mul62 = mul nsw i32 %8, %10
...
for.cond77:                                       ; preds = %for.inc98, %for.end76
  ...
  %12 = load i32, ptr %x1, align 4, !tbaa !10
  %cmp78 = icmp slt i32 %11, %12
...
for.cond80:                                       ; preds = %for.inc95, %for.body79
  ...
  %14 = load i32, ptr %y2, align 4, !tbaa !10
  %cmp81 = icmp slt i32 %13, %14
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %11, %14
  %add84 = add nsw i32 %mul83, %13
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %15 = load i32, ptr %arrayidx86, align 4, !tbaa !10, !invariant.load !12
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15) #8
  %16 = load i32, ptr %y2, align 4, !tbaa !10
  %sub = sub nsw i32 %16, 1
  %cmp88 = icmp slt i32 %13, %sub
  br i1 %cmp88, label %if.then, label %if.end

if.then:                                          ; preds = %for.body82
  %call89 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #8
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %17 = load i32, ptr %y2, align 4, !tbaa !10
  %sub90 = sub nsw i32 %17, 1
  %cmp91 = icmp eq i32 %13, %sub90
  br i1 %cmp91, label %if.then92, label %for.inc95

if.then92:                                        ; preds = %if.end
  %call93 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #8
  br label %for.inc95

for.inc95:                                        ; preds = %if.end, %if.then92
  %inc96 = add nsw i32 %13, 1
  store i32 %inc96, ptr %j, align 4, !tbaa !10
  br label %for.cond80, !llvm.loop !18

for.inc98:                                        ; preds = %for.cond80
  %inc99 = add nsw i32 %11, 1
...
for.end100:                                       ; preds = %for.cond77
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %y2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %y1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %x2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %x1) #8
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %3, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %4) unnamed_addr #5 {
entry_to_outline:
