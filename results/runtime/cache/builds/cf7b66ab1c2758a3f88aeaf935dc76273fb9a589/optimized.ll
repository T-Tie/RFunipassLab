...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #9
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %blank.0 = phi i64 [ 0, %entry ], [ 1, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load i64, ptr %gep, align 8, !tbaa !12
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(40) %letter, i64 noundef 40)
  ...
  %2 = load i32, ptr %_M_streambuf_state.i.i.i, align 8, !tbaa !23
  %cmp.i.i = icmp eq i32 %2, 0
  %3 = add i64 %1, -41
  %or.cond.i = icmp ult i64 %3, -40
...
if.then19.i:                                      ; preds = %for.body
  ...
  %4 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !24
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %if.then19.i, %if.then28.i
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %letter) #10
  %conv5 = sext i32 %num.0 to i64
  %add = add nsw i64 %blank.0, %conv5
  %add6 = add i64 %add, %call4
  %cmp7 = icmp ugt i64 %add6, 80
  br i1 %cmp7, label %if.end.thread, label %if.end

if.end.thread:                                    ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  br i1 %tobool.not, label %for.inc, label %if.then9

if.then9:                                         ; preds = %if.end
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 32, ptr %__c.addr.i, align 1, !tbaa !32
  %vtable.i2 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i3 = getelementptr i8, ptr %vtable.i2, i64 -24
  %vbase.offset.i4 = load i64, ptr %vbase.offset.ptr.i3, align 8, !invariant.load !11
  %gep23 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i4
  %5 = load i64, ptr %gep23, align 8, !tbaa !12
...
for.inc:                                          ; preds = %if.end, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end.thread
  %num.1 = phi i32 [ 0, %if.end.thread ], [ %num.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %num.0, %if.end ]
  %conv16 = phi i64 [ 0, %if.end.thread ], [ 1, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %if.end ]
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %letter) #11
  %call1.i8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %letter, i64 noundef %call.i.i)
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #10
  %add17 = add i64 %call15, %conv16
  %6 = trunc i64 %add17 to i32
  %conv20 = add i32 %num.1, %6
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !33

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #11
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #11
  ret i32 0
}
