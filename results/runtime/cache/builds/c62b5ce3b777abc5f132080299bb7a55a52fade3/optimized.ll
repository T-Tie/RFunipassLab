...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef %c) #4
...
for.cond:                                         ; preds = %if.end19, %entry
  %s.0 = phi i32 [ 0, %entry ], [ %s.2, %if.end19 ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc21, %if.end19 ]
...
for.cond8:                                        ; preds = %if.end, %for.body
  %k.0 = phi i32 [ 0, %for.body ], [ %inc16, %if.end ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  br i1 %cmp15, label %if.end19, label %if.end
...
if.end19:                                         ; preds = %for.body10
  %s.2 = phi i32 [ 1, %for.body10 ]
  %inc21 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !11

for.end22:                                        ; preds = %for.cond
  %s.1 = phi i32 [ %s.0, %for.cond ]
  %cmp23 = icmp eq i32 %s.1, 0
...
for.cond25:                                       ; preds = %for.body27, %if.then24
  %d.0 = phi i32 [ %i.0, %if.then24 ], [ %inc33, %for.body27 ]
  %e.0 = phi i32 [ 0, %if.then24 ], [ %inc34, %for.body27 ]
  %add = add nsw i32 %i.0, %conv
  %cmp26 = icmp slt i32 %d.0, %add
  br i1 %cmp26, label %for.body27, label %if.end36
