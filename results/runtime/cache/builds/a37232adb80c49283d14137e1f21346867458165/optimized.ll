...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc45 ], [ %idxprom2, %for.body24 ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  %12 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv10
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select2 = call i32 @llvm.smax.i32(i32 %13, i32 %sum.2)
