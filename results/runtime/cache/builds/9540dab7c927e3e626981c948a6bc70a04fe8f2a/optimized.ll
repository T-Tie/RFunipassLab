...
for.cond3:                                        ; preds = %for.cond, %for.inc40
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc40 ], [ 0, %for.cond ]
  %sum.0 = phi i64 [ %sum.1, %for.inc40 ], [ 0, %for.cond ]
  %sub = add nsw i32 %2, -1
  %3 = sext i32 %sub to i64
  %cmp4 = icmp slt i64 %indvars.iv22, %3
  br i1 %cmp4, label %for.body5, label %for.end42

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv22
  ...
  %sext20 = shl i64 %add10, 32
  %conv12 = ashr exact i64 %sext20, 32
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx15 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv.next23
...
for.end42:                                        ; preds = %for.cond3
  ...
  %call.i.i7 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx45) #7
  %call1.i8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx45, i64 noundef %call.i.i7)
  %vtable.i13 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !12
  %vbase.offset.ptr.i14 = getelementptr i8, ptr %vtable.i13, i64 -24
  %vbase.offset.i15 = load i64, ptr %vbase.offset.ptr.i14, align 8, !invariant.load !14
