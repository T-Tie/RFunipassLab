...
for.cond4:                                        ; preds = %for.end30, %for.end
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.end30 ], [ 1, %for.end ]
  %exitcond = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond, label %for.cond34, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv19
  store i32 1, ptr %arrayidx8, align 4, !tbaa !5
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %w, i64 0, i64 %indvars.iv19
  %3 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond9

for.cond9:                                        ; preds = %if.end28, %for.body6
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %if.end28 ], [ %indvars.iv19, %for.body6 ]
  %indvars.iv.next22 = add nsw i64 %indvars.iv21, -1
  %cmp10 = icmp sgt i64 %indvars.iv21, 0
  br i1 %cmp10, label %for.body11, label %for.end30

for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds nuw [30 x i32], ptr %w, i64 0, i64 %indvars.iv.next22
  %4 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !12
  %cmp16.not = icmp slt i32 %4, %3
  br i1 %cmp16.not, label %if.end28, label %if.then

if.then:                                          ; preds = %for.body11
  %arrayidx18 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv.next22
...
if.end28:                                         ; preds = %if.then, %if.then22, %for.body11
...
for.cond34:                                       ; preds = %for.cond4, %for.body36
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body36 ], [ 1, %for.cond4 ]
  %m.0 = phi i32 [ %spec.select, %for.body36 ], [ 0, %for.cond4 ]
  %exitcond30 = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30, label %for.end46, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv26
