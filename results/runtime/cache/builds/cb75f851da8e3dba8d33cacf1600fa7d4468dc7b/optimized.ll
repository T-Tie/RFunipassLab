...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond9 = select i1 %cmp8, i1 true, i1 %or.cond
  %inc19 = zext i1 %or.cond9 to i32
  %spec.select10 = add nsw i32 %a.0, %inc19
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %for.body
  %a.1 = phi i32 [ %a.0, %for.body ], [ %spec.select10, %land.lhs.true ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv12
...
if.then46:                                        ; preds = %for.end44
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink, i32 noundef %t.1)
  br label %for.inc51
...
for.cond54:                                       ; preds = %for.cond26, %for.inc80
  %.sink1 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.cond26 ]
  %exitcond18.not = icmp eq i32 %.sink1, 123
  br i1 %exitcond18.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select8, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv15
...
for.body62:                                       ; preds = %for.cond57
  ...
  %cmp66 = icmp eq i32 %.sink1, %conv60
  %inc68 = zext i1 %cmp66 to i32
  %spec.select8 = add nuw nsw i32 %l.1, %inc68
...
if.then74:                                        ; preds = %for.end72
  %call78 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink1, i32 noundef %l.1)
  br label %for.inc80

for.inc80:                                        ; preds = %for.end72, %if.then74
  %inc81 = add nuw nsw i32 %.sink1, 1
