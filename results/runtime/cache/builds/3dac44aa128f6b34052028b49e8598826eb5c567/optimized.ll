...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4016016, ptr noundef nonnull %shuzu) #7
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre60, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv44, i64 %indvars.iv
  ...
  %.pre60 = load i32, ptr %n, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv53 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next54, %for.cond13 ]
  ...
  %exitcond59 = icmp eq i64 %indvars.iv53, %wide.trip.count58
  br i1 %exitcond59, label %for.end58, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv47 = phi i64 [ 1, %for.cond13.preheader ], [ %9, %for.inc53 ]
  %x1.1 = phi i32 [ %x1.0, %for.cond13.preheader ], [ %x1.234, %for.inc53 ]
  %y1.1 = phi i32 [ %y1.0, %for.cond13.preheader ], [ %y1.236, %for.inc53 ]
  %x2.1 = phi i32 [ %x2.0, %for.cond13.preheader ], [ %x2.2, %for.inc53 ]
  %y2.1 = phi i32 [ %y2.0, %for.cond13.preheader ], [ %y2.2, %for.inc53 ]
  %exitcond = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond, label %for.cond10, label %for.body15, !llvm.loop !13

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv53, i64 %indvars.iv47
  %8 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !14
  %cmp20 = icmp eq i32 %8, 0
  %9 = add nuw nsw i64 %indvars.iv47, 1
  br i1 %cmp20, label %land.lhs.true, label %for.inc53

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv53, i64 %9
  %10 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !14
  %cmp25 = icmp eq i32 %10, 0
  br i1 %cmp25, label %land.lhs.true26, label %land.lhs.true38

land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next54, i64 %indvars.iv47
  %11 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !14
  %cmp32 = icmp eq i32 %11, 0
  %spec.select = select i1 %cmp32, i32 %7, i32 %x1.1
  %12 = trunc nuw nsw i64 %indvars.iv47 to i32
  %spec.select38 = select i1 %cmp32, i32 %12, i32 %y1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %y1.2.ph = phi i32 [ %y1.1, %land.lhs.true ], [ %spec.select38, %land.lhs.true26 ]
  %13 = add nsw i64 %indvars.iv47, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv53, i64 %13
  %14 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !14
  %cmp43 = icmp eq i32 %14, 0
  br i1 %cmp43, label %land.lhs.true44, label %for.inc53

land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv47
  %15 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !14
  %cmp50 = icmp eq i32 %15, 0
  %spec.select39 = select i1 %cmp50, i32 %7, i32 %x2.1
  %16 = trunc nuw nsw i64 %indvars.iv47 to i32
  %spec.select40 = select i1 %cmp50, i32 %16, i32 %y2.1
  br label %for.inc53

for.inc53:                                        ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
  %y1.236 = phi i32 [ %y1.2.ph, %land.lhs.true44 ], [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1, %for.body15 ]
  %x1.234 = phi i32 [ %x1.2.ph, %land.lhs.true44 ], [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1, %for.body15 ]
  %x2.2 = phi i32 [ %spec.select39, %land.lhs.true44 ], [ %x2.1, %land.lhs.true38 ], [ %x2.1, %for.body15 ]
  %y2.2 = phi i32 [ %spec.select40, %land.lhs.true44 ], [ %y2.1, %land.lhs.true38 ], [ %y2.1, %for.body15 ]
  br label %for.cond13, !llvm.loop !15

for.end58:                                        ; preds = %for.cond10
  %reass.sub = sub i32 %x2.0, %x1.0
  %add60 = add i32 %reass.sub, 1
  %sub61 = sub nsw i32 %y2.0, %y1.0
  %mul6541 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6541, %add60
  %17 = shl i32 %sub61, 1
  %reass.sub42 = sub i32 %sub66, %17
  %add71 = add i32 %reass.sub42, 2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4016016, ptr noundef nonnull %shuzu) #8
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !16, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !24, !invariant.load !14
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !25, !invariant.load !14
