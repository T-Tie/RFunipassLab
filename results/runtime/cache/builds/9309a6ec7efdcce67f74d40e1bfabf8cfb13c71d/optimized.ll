...
for.end38:                                        ; preds = %for.cond24
  %min.0.lcssa = phi i32 [ %min.0, %for.cond24 ]
  br label %for.cond39
...
for.inc47:                                        ; preds = %for.cond39
  ...
  %sub46 = sub nsw i32 %8, %min.0.lcssa
...
for.end76:                                        ; preds = %for.cond60
  %min.2.lcssa = phi i32 [ %min.2, %for.cond60 ]
  br label %for.cond77
...
for.inc85:                                        ; preds = %for.cond77
  ...
  %sub84 = sub nsw i32 %14, %min.2.lcssa
...
for.end90:                                        ; preds = %for.cond53
  %idxprom98.lcssa = phi i64 [ %idxprom98, %for.cond53 ]
  %.lcssa = phi i64 [ %9, %for.cond53 ]
  ...
  %arrayidx99 = getelementptr inbounds i32, ptr %vla, i64 %.lcssa
  %arrayidx101 = getelementptr inbounds i32, ptr %arrayidx99, i64 %idxprom98.lcssa
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %arrayidx124 = getelementptr inbounds i32, ptr %arrayidx122, i64 %idxprom98.lcssa
...
for.inc138:                                       ; preds = %for.cond14
  %number.0.lcssa = phi i32 [ %number.0, %for.cond14 ]
  %call136 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %number.0.lcssa)
