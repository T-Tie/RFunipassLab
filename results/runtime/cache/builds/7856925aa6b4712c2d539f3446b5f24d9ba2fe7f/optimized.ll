...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %sentence) #7
  br label %while.cond
...
while.end16:                                      ; preds = %while.cond2
  ...
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %sentence) #7
  ret i32 0
}
...
if.then_to_outline:                               ; preds = %newFuncRoot
  ...
  %2 = load i64, ptr %gep, align 8, !tbaa !26
...
!18 = !{!19, !8, i64 56}
!19 = !{!"_ZTSSt5ctypeIcE", !20, i64 0, !22, i64 16, !23, i64 24, !24, i64 32, !24, i64 40, !25, i64 48, !8, i64 56, !8, i64 57, !8, i64 313, !8, i64 569}
!20 = !{!"_ZTSNSt6locale5facetE", !21, i64 8}
!21 = !{!"int", !8, i64 0}
!22 = !{!"p1 _ZTS15__locale_struct", !7, i64 0}
!23 = !{!"bool", !8, i64 0}
!24 = !{!"p1 int", !7, i64 0}
!25 = !{!"p1 short", !7, i64 0}
!26 = !{!27, !28, i64 16}
!27 = !{!"_ZTSSt8ios_base", !28, i64 8, !28, i64 16, !29, i64 24, !30, i64 28, !30, i64 32, !31, i64 40, !32, i64 48, !8, i64 64, !21, i64 192, !33, i64 200, !34, i64 208}
!28 = !{!"long", !8, i64 0}
!29 = !{!"_ZTSSt13_Ios_Fmtflags", !8, i64 0}
!30 = !{!"_ZTSSt12_Ios_Iostate", !8, i64 0}
!31 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !7, i64 0}
!32 = !{!"_ZTSNSt8ios_base6_WordsE", !7, i64 0, !28, i64 8}
