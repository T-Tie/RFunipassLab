...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  ...
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv11, %7
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread19
  ...
  %.ph21 = phi i32 [ %s.0, %if.end35.thread19 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %10 = phi i32 [ %s.0, %if.end35 ], [ %.ph21, %for.inc47.sink.split ]
  %add45 = add i32 %8, 1
  %add46 = add i32 %add45, %10
