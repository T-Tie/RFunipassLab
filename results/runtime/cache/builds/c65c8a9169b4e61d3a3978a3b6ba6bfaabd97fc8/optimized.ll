...
for.cond:                                         ; preds = %for.inc26, %entry
  %indvars.iv42 = phi i32 [ %indvars.iv.next43, %for.inc26 ], [ %conv, %entry ]
  %indvars.iv37 = phi i32 [ %indvars.iv.next38, %for.inc26 ], [ 0, %entry ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.body14
  %indvars.iv28 = phi i64 [ %indvars.iv, %for.cond12.preheader ], [ %indvars.iv.next29, %for.body14 ]
  %k.2 = phi i32 [ 1, %for.cond12.preheader ], [ %spec.select, %for.body14 ]
  %cmp13 = icmp slt i64 %indvars.iv28, %3
  br i1 %cmp13, label %for.body14, label %for.end

for.body14:                                       ; preds = %for.cond12
  %4 = sub nuw nsw i64 %indvars.iv28, %indvars.iv
  %arrayidx16 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx16, align 1, !tbaa !5, !invariant.load !8
  %arrayidx19 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv28
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc38
  %indvars.iv34 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next35, %for.inc38 ]
  %exitcond41.not = icmp eq i64 %indvars.iv34, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end40, label %for.inc38

for.inc38:                                        ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv34
  %7 = load i8, ptr %arrayidx35, align 1, !tbaa !5, !invariant.load !8
  %conv36 = sext i8 %7 to i32
  %putchar25 = call i32 @putchar(i32 noundef %conv36) #7
...
for.end40:                                        ; preds = %for.cond31
  ...
  %8 = sext i32 %indvars.iv42 to i64
  %sext48 = shl i64 %call6, 32
  %9 = ashr exact i64 %sext48, 32
  br label %for.cond44

for.cond44:                                       ; preds = %for.inc51, %for.end40
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc51 ], [ %8, %for.end40 ]
  %cmp45 = icmp slt i64 %indvars.iv45, %9
  br i1 %cmp45, label %for.inc51, label %if.end56

for.inc51:                                        ; preds = %for.cond44
  %arrayidx48 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv45
