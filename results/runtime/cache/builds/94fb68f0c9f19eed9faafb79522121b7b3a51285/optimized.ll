...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc27
  %indvars.iv14 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next15, %for.inc27 ]
  %exitcond24 = icmp eq i64 %indvars.iv14, %wide.trip.count23
  br i1 %exitcond24, label %for.cond30, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %4 = add nsw i64 %indvars.iv14, -1
...
for.cond9:                                        ; preds = %for.body4, %for.inc24
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc24 ], [ %indvars.iv14, %for.body4 ]
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %exitcond.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body11

for.body11:                                       ; preds = %for.cond9
  %arrayidx14 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv16
...
for.cond30:                                       ; preds = %for.cond2, %for.inc53
  ...
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc53 ], [ 0, %for.cond2 ]
  %b.0 = phi i32 [ %b.1, %for.inc53 ], [ 0, %for.cond2 ]
  %9 = sext i32 %8 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv25, %9
  br i1 %cmp32.not.not, label %for.body33, label %for.end55

for.body33:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv25
