...
for.cond:                                         ; preds = %for.body, %entry
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body ], [ 0, %entry ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %if.end
  %indvars.iv14 = phi i64 [ %indvars.iv12, %for.cond13.preheader ], [ %indvars.iv.next15, %if.end ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  br i1 %cmp20.not, label %if.end, label %land.lhs.true
