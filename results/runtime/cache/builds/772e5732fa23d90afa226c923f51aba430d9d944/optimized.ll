...
for.cond2:                                        ; preds = %for.inc11, %for.body
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc11 ], [ 1, %for.body ]
  %exitcond91 = icmp eq i64 %indvars.iv87, %1
  br i1 %exitcond91, label %for.cond14.preheader, label %for.cond5.preheader

for.cond14.preheader:                             ; preds = %for.cond2
  %4 = add i32 %0, 2
  %wide.trip.count130 = zext i32 %4 to i64
  br label %for.cond14

for.cond5.preheader:                              ; preds = %for.cond2
  %5 = mul nuw nsw i64 %indvars.iv87, %1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  %indvars.iv124 = phi i64 [ 3, %for.cond14.preheader ], [ %indvars.iv.next125, %for.cond14.loopexit ]
  %indvars.iv92 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next93, %for.cond14.loopexit ]
  %number.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add97, %for.cond14.loopexit ]
  %exitcond131.not = icmp eq i64 %indvars.iv124, %wide.trip.count130
  br i1 %exitcond131.not, label %for.inc138, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.inc50
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.inc50 ], [ %indvars.iv92, %for.cond14 ]
  %exitcond108 = icmp eq i64 %indvars.iv104, %1
  br i1 %exitcond108, label %for.cond53.preheader, label %for.body19

for.cond53.preheader:                             ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv92, %1
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  br label %for.cond53

for.body19:                                       ; preds = %for.cond17
  %7 = mul nuw nsw i64 %indvars.iv104, %1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla, i64 %7
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv92
  %8 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  br label %for.cond24

for.cond24:                                       ; preds = %for.body26, %for.body19
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.body26 ], [ %indvars.iv92, %for.body19 ]
  %min.0 = phi i32 [ %spec.select, %for.body26 ], [ %8, %for.body19 ]
  %exitcond98 = icmp eq i64 %indvars.iv94, %1
  br i1 %exitcond98, label %for.cond39.preheader, label %for.body26

for.cond39.preheader:                             ; preds = %for.cond24
  br label %for.cond39

for.body26:                                       ; preds = %for.cond24
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv94
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv99 = phi i64 [ %indvars.iv92, %for.cond39.preheader ], [ %indvars.iv.next100, %for.inc47 ]
  %exitcond103 = icmp eq i64 %indvars.iv99, %1
  br i1 %exitcond103, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv99
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc88
  %indvars.iv119 = phi i64 [ %indvars.iv92, %for.cond53.preheader ], [ %indvars.iv.next120, %for.inc88 ]
  %exitcond123 = icmp eq i64 %indvars.iv119, %1
  br i1 %exitcond123, label %for.end90, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv119
  %11 = load i32, ptr %arrayidx59, align 4, !tbaa !5
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv119
  br label %for.cond60

for.cond60:                                       ; preds = %for.body62, %for.body55
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.body62 ], [ %indvars.iv92, %for.body55 ]
  %min.2 = phi i32 [ %spec.select83, %for.body62 ], [ %11, %for.body55 ]
  %exitcond113 = icmp eq i64 %indvars.iv109, %1
  br i1 %exitcond113, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %12 = mul nuw nsw i64 %indvars.iv109, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %12
  %13 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select83 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv114 = phi i64 [ %indvars.iv92, %for.cond77.preheader ], [ %indvars.iv.next115, %for.inc85 ]
  %exitcond118 = icmp eq i64 %indvars.iv114, %1
  br i1 %exitcond118, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %14 = mul nuw nsw i64 %indvars.iv114, %1
  %gep85 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %14
  %15 = load i32, ptr %gep85, align 4, !tbaa !5
  %sub84 = sub nsw i32 %15, %min.2
  store i32 %sub84, ptr %gep85, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %16 = mul nuw nsw i64 %indvars.iv.next93, %1
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla, i64 %16
  %arrayidx96 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv.next93
  %17 = load i32, ptr %arrayidx96, align 4, !tbaa !5, !invariant.load !20
  %arrayidx101 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv92
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.inc130 ], [ %indvars.iv124, %for.end90 ]
...
for.inc130:                                       ; preds = %for.cond109
  %arrayidx115 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv126
  %20 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx120 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv126
  store i32 %20, ptr %arrayidx120, align 4, !tbaa !5
  %21 = mul nuw nsw i64 %indvars.iv126, %1
  %arrayidx122 = getelementptr inbounds nuw i32, ptr %vla, i64 %21
  %arrayidx124 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv92
  %22 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv.next93
