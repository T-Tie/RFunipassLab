...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc7 ], [ 0, %entry ]
  %6 = load i32, ptr %x1, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv5, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv5, %3
...
for.cond12:                                       ; preds = %for.inc26, %for.end9
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc26 ], [ 0, %for.end9 ]
  %18 = sext i32 %17 to i64
  %cmp13 = icmp slt i64 %indvars.iv11, %18
  br i1 %cmp13, label %for.cond15.preheader, label %for.end28

for.cond15.preheader:                             ; preds = %for.cond12
  %19 = mul nuw nsw i64 %indvars.iv11, %14
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %vla11, i64 %19
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre47, %for.inc23 ]
  %indvars.iv8 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next9, %for.inc23 ]
  %21 = sext i32 %20 to i64
  %cmp16 = icmp slt i64 %indvars.iv8, %21
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %arrayidx19, i64 %indvars.iv8
  %call22 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %arrayidx21)
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %.pre47 = load i32, ptr %y2, align 4, !tbaa !5
...
for.end28:                                        ; preds = %for.cond12
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %22, i32 noundef 0)
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc43, %for.end28
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc43 ], [ 0, %for.end28 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond46.preheader, label %for.cond33.preheader

for.cond46.preheader:                             ; preds = %for.cond30
  %smax27 = call i32 @llvm.smax.i32(i32 %17, i32 noundef 0)
...
for.cond33.preheader:                             ; preds = %for.cond30
  %26 = mul nuw nsw i64 %indvars.iv17, %24
  %arrayidx37 = getelementptr inbounds nuw i32, ptr %vla29, i64 %26
  br label %for.cond33

for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv14 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next15, %for.inc40 ]
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv14
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv35 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next36, %for.inc77 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count21
  br i1 %exitcond39.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %27 = mul nuw nsw i64 %indvars.iv35, %24
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %27
  %28 = mul nuw nsw i64 %indvars.iv35, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %28
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv30 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next31, %for.inc74 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33
  br i1 %exitcond34.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv30
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv30
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv23 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next24, %for.inc71 ]
  %exitcond29.not = icmp eq i64 %indvars.iv23, %wide.trip.count28
  br i1 %exitcond29.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %29 = load i32, ptr %arrayidx58, align 4, !tbaa !5
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv23
  %30 = load i32, ptr %arrayidx62, align 4, !tbaa !5
  %31 = mul nuw nsw i64 %indvars.iv23, %14
...
for.cond80:                                       ; preds = %for.cond46, %for.inc99
  %33 = phi i32 [ %.pre46, %for.inc99 ], [ %22, %for.cond46 ]
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc99 ], [ 0, %for.cond46 ]
  %34 = sext i32 %33 to i64
  %cmp81 = icmp slt i64 %indvars.iv43, %34
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %35 = mul nuw nsw i64 %indvars.iv43, %24
...
for.cond87:                                       ; preds = %for.inc95, %for.body82
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc95 ], [ 1, %for.body82 ]
  %37 = load i32, ptr %y2, align 4, !tbaa !5
  %38 = sext i32 %37 to i64
  %cmp88 = icmp slt i64 %indvars.iv40, %38
  br i1 %cmp88, label %for.inc95, label %for.inc99

for.inc95:                                        ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx84, i64 %indvars.iv40
...
for.inc99:                                        ; preds = %for.cond87
  ...
  %.pre46 = load i32, ptr %x1, align 4, !tbaa !5
