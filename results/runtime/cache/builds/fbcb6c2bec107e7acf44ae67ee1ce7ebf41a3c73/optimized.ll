...
for.cond:                                         ; preds = %for.end133, %entry
  %k.0 = phi i32 [ 0, %entry ], [ %inc.i5, %for.end133 ]
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.end ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  %indvars.iv80 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next81, %for.inc131 ]
  %indvars.iv57 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next58, %for.inc131 ]
  %total.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add130, %for.inc131 ]
  %exitcond85.not = icmp eq i64 %indvars.iv80, %wide.trip.count84
  br i1 %exitcond85.not, label %for.end133, label %for.cond20

for.cond20:                                       ; preds = %for.cond15, %for.inc66
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc66 ], [ 0, %for.cond15 ]
  %exitcond.not = icmp eq i64 %indvars.iv65, %wide.trip.count
  br i1 %exitcond.not, label %for.cond70, label %for.body23

for.body23:                                       ; preds = %for.cond20
  %6 = add nuw i64 %indvars.iv65, 4294967295
  %7 = and i64 %6, 4294967295
  %or.cond = icmp samesign ult i64 %7, %indvars.iv80
  br i1 %or.cond, label %for.inc66, label %if.end

if.end:                                           ; preds = %for.body23
  %arrayidx27 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv65
  %8 = load i32, ptr %arrayidx27, align 16, !tbaa !5, !invariant.load !9
  br label %for.cond30

for.cond30:                                       ; preds = %for.body33, %if.end
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body33 ], [ %indvars.iv57, %if.end ]
  %minValue.0 = phi i32 [ %spec.select, %for.body33 ], [ %8, %if.end ]
  %9 = trunc nuw i64 %indvars.iv59 to i32
  %cmp31 = icmp sgt i32 %1, %9
  br i1 %cmp31, label %for.body33, label %for.end47

for.body33:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %indvars.iv59
...
for.cond54:                                       ; preds = %for.body57, %for.end47
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body57 ], [ %indvars.iv57, %for.end47 ]
  %11 = trunc nuw i64 %indvars.iv62 to i32
  %cmp55 = icmp sgt i32 %1, %11
  br i1 %cmp55, label %for.body57, label %for.inc66

for.body57:                                       ; preds = %for.cond54
  %arrayidx61 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %indvars.iv62
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc121 ], [ 0, %for.cond20 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count
  br i1 %exitcond79.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw i64 %indvars.iv75, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond51 = icmp samesign ult i64 %14, %indvars.iv80
  br i1 %or.cond51, label %for.inc121, label %if.end78

if.end78:                                         ; preds = %for.body73
  %arrayidx82 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv75
  %15 = load i32, ptr %arrayidx82, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond85

for.cond85:                                       ; preds = %for.body88, %if.end78
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.body88 ], [ %indvars.iv57, %if.end78 ]
  %minValue79.0 = phi i32 [ %spec.select52, %for.body88 ], [ %15, %if.end78 ]
  %16 = trunc nuw i64 %indvars.iv69 to i32
  %cmp86 = icmp sgt i32 %1, %16
  br i1 %cmp86, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv69, i64 %indvars.iv75
  %17 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !9
  %spec.select52 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.body112, %for.end102
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.body112 ], [ %indvars.iv57, %for.end102 ]
  %18 = trunc nuw i64 %indvars.iv72 to i32
  %cmp110 = icmp sgt i32 %1, %18
  br i1 %cmp110, label %for.body112, label %for.inc121

for.body112:                                      ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv75
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %arrayidx129 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next81, i64 %indvars.iv.next81
