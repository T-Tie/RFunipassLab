...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %invariant.gep14 = getelementptr i8, ptr %a, i64 -1
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  %8 = and i64 %indvars.iv20, 4294967295
  ...
  %gep15 = getelementptr i8, ptr %invariant.gep14, i64 %7
...
for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep14, i64 %indvars.iv.i
...
if.end50:                                         ; preds = %for.body45
  br i1 %s.0, label %for.cond.i3, label %for.inc55
...
for.inc.i6:                                       ; preds = %for.cond.i3
  %gep.i7 = getelementptr i8, ptr %invariant.gep14, i64 %indvars.iv.i4
