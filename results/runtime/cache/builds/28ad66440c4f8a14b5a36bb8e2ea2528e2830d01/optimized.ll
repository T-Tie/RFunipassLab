...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef align 16 %sz) #3
...
for.inc:                                          ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom
...
for.cond2:                                        ; preds = %for.inc30, %for.end
  %k.0 = phi i32 [ 1, %for.end ], [ %inc31, %for.inc30 ]
  %cmp3 = icmp sle i32 %k.0, %0
...
for.cond5:                                        ; preds = %for.inc13, %for.body4
  %max.0 = phi i32 [ 0, %for.body4 ], [ %max.1, %for.inc13 ]
  %i.1 = phi i32 [ 0, %for.body4 ], [ %inc14, %for.inc13 ]
  %sub = sub nsw i32 %0, %k.0
  %cmp6 = icmp sle i32 %i.1, %sub
  br i1 %cmp6, label %for.body7, label %for.end15

for.body7:                                        ; preds = %for.cond5
  %idxprom8 = sext i32 %i.1 to i64
  %arrayidx9 = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom8
  %1 = load i32, ptr %arrayidx9, align 4, !tbaa !5
  %idxprom10 = sext i32 %max.0 to i64
  %arrayidx11 = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom10
...
for.inc13:                                        ; preds = %for.body7, %if.then
  %max.1 = phi i32 [ %i.1, %if.then ], [ %max.0, %for.body7 ]
  %inc14 = add nsw i32 %i.1, 1
  br label %for.cond5, !llvm.loop !12

for.end15:                                        ; preds = %for.cond5
  %cmp17 = icmp ne i32 %max.0, %sub
  br i1 %cmp17, label %if.then18, label %for.inc30

if.then18:                                        ; preds = %for.end15
  %idxprom19 = sext i32 %max.0 to i64
  %arrayidx20 = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom19
  %3 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %idxprom22 = sext i32 %sub to i64
  %arrayidx23 = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom22
...
for.cond33:                                       ; preds = %for.inc44, %for.end32
  %i.2 = phi i32 [ 0, %for.end32 ], [ %inc45, %for.inc44 ]
  %cmp34 = icmp slt i32 %i.2, %0
  br i1 %cmp34, label %for.body35, label %for.end46

for.body35:                                       ; preds = %for.cond33
  %idxprom36 = sext i32 %i.2 to i64
  %arrayidx37 = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom36
...
if.then39:                                        ; preds = %for.body35
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5)
  br label %for.end46
...
for.end46:                                        ; preds = %if.then39, %for.cond33
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc59, %for.end46
  %.sink = phi i32 [ %i.2, %for.end46 ], [ %add, %for.inc59 ]
  %add = add nsw i32 %.sink, 1
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %cmp48 = icmp slt i32 %add, %6
  br i1 %cmp48, label %for.body49, label %for.end61

for.body49:                                       ; preds = %for.cond47
  %idxprom50 = sext i32 %add to i64
  %arrayidx51 = getelementptr inbounds [10000 x i32], ptr %sz, i64 0, i64 %idxprom50
  %7 = load i32, ptr %arrayidx51, align 4, !tbaa !5
  %rem52 = srem i32 %7, 2
  %cmp53 = icmp eq i32 %rem52, 1
  br i1 %cmp53, label %if.then54, label %for.inc59

if.then54:                                        ; preds = %for.body49
  %call57 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %7)
  br label %for.inc59

for.inc59:                                        ; preds = %for.body49, %if.then54
  br label %for.cond47, !llvm.loop !15

for.end61:                                        ; preds = %for.cond47
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef %sz) #4
