...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.end ], [ 0, %entry ]
  %exitcond = icmp eq i64 %indvars.iv36, %2
  br i1 %exitcond, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %3 = trunc i64 %call4 to i32
  %reass.sub = sub i32 %3, %0
  %4 = add i32 %reass.sub, 1
  %wide.trip.count46 = zext i32 %4 to i64
  br label %for.cond21
...
for.body8:                                        ; preds = %for.cond6
  %5 = add nuw nsw i64 %indvars.iv, %indvars.iv36
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %5
  %6 = load i8, ptr %arrayidx, align 1, !tbaa !9, !invariant.load !10
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv36, i64 %indvars.iv
  store i8 %6, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !11

for.end:                                          ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv36, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.body23
  %indvars.iv41 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next42, %for.body23 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond29, label %for.body23

for.body23:                                       ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv41
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond21, !llvm.loop !15

for.cond29:                                       ; preds = %for.cond21, %for.end53
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.end53 ], [ 0, %for.cond21 ]
  %exitcond59.not = icmp eq i64 %indvars.iv48, %wide.trip.count46
  br i1 %exitcond59.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv48
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv48
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %if.end
  %indvars.iv50 = phi i64 [ %indvars.iv48, %for.cond32.preheader ], [ %indvars.iv.next51, %if.end ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %wide.trip.count46
  br i1 %exitcond55.not, label %for.end53, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv50
  %call41 = call i32 @strcmp(ptr noundef nonnull readonly captures(none) dereferenceable(1) %arrayidx36, ptr noundef nonnull readonly captures(none) dereferenceable(1) %arrayidx39) #8
  %cmp42 = icmp eq i32 %call41, 0
  br i1 %cmp42, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %for.body34
  %7 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !10
  %cmp45 = icmp sgt i32 %7, 0
  br i1 %cmp45, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  %inc48 = add nuw nsw i32 %7, 1
  store i32 %inc48, ptr %arrayidx44, align 4, !tbaa !5
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv50
  %8 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !10
  %dec = add nsw i32 %8, -1
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count46
  br i1 %exitcond65.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv60
  %9 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !10
...
for.cond76:                                       ; preds = %if.end88, %if.else
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %if.end88 ], [ 0, %if.else ]
  %exitcond71.not = icmp eq i64 %indvars.iv66, %wide.trip.count46
  br i1 %exitcond71.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv66
  %10 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !10
  %cmp81 = icmp eq i32 %10, %max.0
  br i1 %cmp81, label %if.then82, label %if.end88

if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv66
