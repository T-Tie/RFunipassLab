...
for.cond4:                                        ; preds = %for.inc24, %for.end
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc24 ], [ 1, %for.end ]
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp5 = icmp slt i64 %indvars.iv21, %5
  br i1 %cmp5, label %for.cond7.preheader, label %for.end26

for.cond7.preheader:                              ; preds = %for.cond4
  %add.ptr11 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv21
  %6 = load i32, ptr %add.ptr11, align 4, !tbaa !5
  br label %for.cond7

for.cond7:                                        ; preds = %for.body9, %for.cond7.preheader
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body9 ], [ 0, %for.cond7.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv18, %indvars.iv21
  br i1 %exitcond.not, label %if.then19, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %add.ptr13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv18
