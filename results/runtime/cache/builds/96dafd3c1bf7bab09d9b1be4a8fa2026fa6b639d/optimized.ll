...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.end24
  %indvars.iv23 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next24, %for.end24 ]
  %sum.0 = phi i32 [ 0, %for.cond10.preheader ], [ %sum.1, %for.end24 ]
...
for.cond13:                                       ; preds = %for.cond10, %for.body15
  ...
  br i1 %exitcond22.not, label %for.end24, label %for.body15
...
for.end27:                                        ; preds = %for.cond10
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %mul) #6
