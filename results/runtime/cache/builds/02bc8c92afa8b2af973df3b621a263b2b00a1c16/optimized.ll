...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv19, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv25, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv22, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv25, i64 %indvars.iv22
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax31 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax36 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax37 = call i32 @llvm.smax.i32(i32 %smax36, i32 noundef 0)
...
for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond39.not = icmp eq i64 %indvars.iv32, %wide.trip.count38
  br i1 %exitcond39.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax43 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count44 = zext nneg i32 %smax43 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv32, i64 %indvars.iv28
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv53 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next54, %for.inc83 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count38
  br i1 %exitcond57.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond52.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv53, i64 %indvars.iv46
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv40 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next41, %for.inc77 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv53, i64 %indvars.iv40
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv40, i64 %indvars.iv46
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count38
  br i1 %exitcond62.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv58
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax36 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %wide.trip.count38
  br i1 %exitcond74.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv70
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax36, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax36, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv63 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next64, %for.inc112 ]
  %exitcond69.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond69.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv70, i64 %indvars.iv63
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv87 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond94.not = icmp eq i64 %indvars.iv87, %wide.trip.count38
  br i1 %exitcond94.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv87
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv87, 0
  %or.cond14 = and i1 %or.cond, %cmp128
  br i1 %or.cond14, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv87
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax78 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count79 = zext nneg i32 %smax78 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond80.not = icmp eq i64 %indvars.iv75, %wide.trip.count79
  br i1 %exitcond80.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv87, i64 %indvars.iv75
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv87, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax84 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count85 = zext nneg i32 %smax84 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond86.not = icmp eq i64 %indvars.iv81, %wide.trip.count85
  br i1 %exitcond86.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv87, i64 %indvars.iv81
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv87, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv87, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar15 = call i32 @putchar(i32 noundef 10) #6
  br label %for.inc198
