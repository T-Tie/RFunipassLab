...
for.cond16:                                       ; preds = %for.end29, %for.end10
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc9.i1, %for.end29 ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %11, i32 0)
  %15 = sext i32 %13 to i64
  %smax54 = call i32 @llvm.smax.i32(i32 %10, i32 0)
...
for.cond37:                                       ; preds = %for.end73, %for.end32
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.end73 ], [ 0, %for.end32 ]
  %exitcond56.not = icmp eq i64 %indvars.iv49, %wide.trip.count55
  br i1 %exitcond56.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv49, %14
  %17 = mul nsw i64 %indvars.iv49, %15
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv42 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next43, %for.inc71 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end73, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv42
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv42
  br label %for.cond47
...
if.then:                                          ; preds = %for.body82
  ...
  %.pre58 = load i32, ptr %y2, align 4, !tbaa !5
  %.pre60 = add nsw i32 %.pre58, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre60, %if.then ], [ %sub, %for.body82 ]
  %28 = phi i32 [ %.pre58, %if.then ], [ %27, %for.body82 ]
...
if.then92:                                        ; preds = %if.end
  ...
  %.pre57.pre = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.inc95

for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre57 = phi i32 [ %28, %if.end ], [ %.pre57.pre, %if.then92 ]
