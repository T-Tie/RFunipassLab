...
for.cond15:                                       ; preds = %for.cond.cleanup168, %for.cond.cleanup3
  %n.0 = phi i32 [ %1, %for.cond.cleanup3 ], [ %dec, %for.cond.cleanup168 ]
  %min.1 = phi i32 [ %min.0, %for.cond.cleanup3 ], [ %min.5, %for.cond.cleanup168 ]
  %s.0 = phi i32 [ 0, %for.cond.cleanup3 ], [ %add, %for.cond.cleanup168 ]
...
for.cond19:                                       ; preds = %for.cond.cleanup47, %for.body18
  %k.0 = phi i32 [ 0, %for.body18 ], [ %inc57, %for.cond.cleanup47 ]
  %min.2 = phi i32 [ %min.1, %for.body18 ], [ %min.3, %for.cond.cleanup47 ]
...
for.cond23:                                       ; preds = %if.end, %for.body22
  %l.0 = phi i32 [ 0, %for.body22 ], [ %inc42, %if.end ]
...
if.else:                                          ; preds = %for.body26
  %arrayidx33 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom28
...
if.end:                                           ; preds = %cond.false, %if.else, %if.then
  %min.4 = phi i32 [ %3, %if.then ], [ %min.3, %cond.false ], [ %4, %if.else ]
  %inc42 = add nsw i32 %l.0, 1
  br label %for.cond23, !llvm.loop !14

for.cond45:                                       ; preds = %for.body48, %for.cond.cleanup25
  %l44.0 = phi i32 [ 0, %for.cond.cleanup25 ], [ %inc54, %for.body48 ]
...
for.body48:                                       ; preds = %for.cond45
  ...
  %sub = sub nsw i32 %5, %min.3
  store i32 %sub, ptr %arrayidx52, align 4, !tbaa !5
  %inc54 = add nsw i32 %l44.0, 1
  br label %for.cond45, !llvm.loop !16

for.cond60:                                       ; preds = %for.cond.cleanup96, %for.cond.cleanup21
  %k59.0 = phi i32 [ 0, %for.cond.cleanup21 ], [ %inc107, %for.cond.cleanup96 ]
  %min.5 = phi i32 [ %min.2, %for.cond.cleanup21 ], [ %min.6, %for.cond.cleanup96 ]
...
for.cond.cleanup62:                               ; preds = %for.cond60
  ...
  %6 = load i32, ptr %arrayidx110, align 4, !tbaa !5
  %add = add nsw i32 %s.0, %6
...
for.cond65:                                       ; preds = %if.end89, %for.body63
  %l64.0 = phi i32 [ 0, %for.body63 ], [ %inc91, %if.end89 ]
...
if.else75:                                        ; preds = %for.body68
  %idxprom76 = sext i32 %l64.0 to i64
...
if.end89:                                         ; preds = %cond.false86, %if.else75, %if.then70
  %min.7 = phi i32 [ %7, %if.then70 ], [ %min.6, %cond.false86 ], [ %8, %if.else75 ]
  %inc91 = add nsw i32 %l64.0, 1
  br label %for.cond65, !llvm.loop !17

for.cond94:                                       ; preds = %for.body97, %for.cond.cleanup67
  %l93.0 = phi i32 [ 0, %for.cond.cleanup67 ], [ %inc104, %for.body97 ]
...
for.cond112:                                      ; preds = %for.cond.cleanup119, %for.cond.cleanup62
  %i111.0 = phi i32 [ 0, %for.cond.cleanup62 ], [ %inc133, %for.cond.cleanup119 ]
...
for.cond117:                                      ; preds = %for.body120, %for.body115
  %j116.0 = phi i32 [ 0, %for.body115 ], [ %inc130, %for.body120 ]
...
for.body120:                                      ; preds = %for.cond117
  ...
  %10 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  ...
  store i32 %10, ptr %arrayidx128, align 4, !tbaa !5
  %inc130 = add nsw i32 %j116.0, 1
  br label %for.cond117, !llvm.loop !21

for.cond136:                                      ; preds = %for.body139, %for.cond.cleanup114
  %i135.0 = phi i32 [ 2, %for.cond.cleanup114 ], [ %inc148, %for.body139 ]
...
for.body139:                                      ; preds = %for.cond136
  ...
  %11 = load i32, ptr %arrayidx141, align 16, !tbaa !5
  ...
  store i32 %11, ptr %arrayidx145, align 16, !tbaa !5
  %inc148 = add nsw i32 %i135.0, 1
  br label %for.cond136, !llvm.loop !22

for.cond151:                                      ; preds = %for.body154, %for.cond.cleanup138
  %i150.0 = phi i32 [ 2, %for.cond.cleanup138 ], [ %inc163, %for.body154 ]
...
for.body154:                                      ; preds = %for.cond151
  ...
  %12 = load i32, ptr %arrayidx157, align 4, !tbaa !5
  ...
  store i32 %12, ptr %arrayidx161, align 4, !tbaa !5
  %inc163 = add nsw i32 %i150.0, 1
  br label %for.cond151, !llvm.loop !23

for.cond166:                                      ; preds = %for.cond.cleanup173, %for.cond.cleanup153
  %i165.0 = phi i32 [ 2, %for.cond.cleanup153 ], [ %inc189, %for.cond.cleanup173 ]
...
for.cond171:                                      ; preds = %for.body174, %for.body169
  %j170.0 = phi i32 [ 2, %for.body169 ], [ %inc186, %for.body174 ]
...
for.body174:                                      ; preds = %for.cond171
  ...
  store i32 %13, ptr %arrayidx184, align 4, !tbaa !5
  %inc186 = add nsw i32 %j170.0, 1
  br label %for.cond171, !llvm.loop !26
