...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull %a) #7
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body21
  ...
  %indvars.iv15 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next16, %for.body21 ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv15, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv15
...
for.end43:                                        ; preds = %for.cond18
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1600, ptr noundef nonnull %a) #8
