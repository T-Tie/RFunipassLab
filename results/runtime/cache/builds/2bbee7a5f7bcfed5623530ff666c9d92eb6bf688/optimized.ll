...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull %a) #7
...
while.cond:                                       ; preds = %if.end29, %entry
  ...
  %or.cond57 = select i1 %cmp.i.i, i1 %or.cond.i, i1 false
  br i1 %or.cond57, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %if.then19.i, %if.then28.i
  %vtable = phi ptr [ %vtable12.i, %while.cond ], [ %vtable.pre59, %if.then19.i ], [ %vtable.pre, %if.then28.i ]
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
  %gep58 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 32), i64 %vbase.offset
  %4 = load i32, ptr %gep58, align 8, !tbaa !22
...
if.else14:                                        ; preds = %if.end.thread
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #8
  br label %if.end19
...
if.end19:                                         ; preds = %if.end, %if.else14
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a, i64 noundef %call4.sink)
...
if.then25:                                        ; preds = %if.end, %if.end.thread
  call fastcc void @outlined_ir_func_0()
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #8
  %call1.i19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a, i64 noundef %call.i.i18)
  br label %if.end29
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %a) #8
  ret i32 0
}
...
if.then21_after_outline.exitStub:
  ...
  %vbase.offset.i26 = load i64, ptr %vbase.offset.ptr.i25, align 8, !invariant.load !8
