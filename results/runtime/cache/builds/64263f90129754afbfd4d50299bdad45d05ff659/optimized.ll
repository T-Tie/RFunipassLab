...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax100 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax105 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax106 = call i32 @llvm.smax.i32(i32 %smax105, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax112 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count120 = zext nneg i32 %smax100 to i64
...
for.cond55:                                       ; preds = %for.cond52, %for.inc80
  ...
  %exitcond121.not = icmp eq i64 %indvars.iv115, %wide.trip.count120
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count137 = zext nneg i32 %smax100 to i64
  br label %for.cond96
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond138.not = icmp eq i64 %indvars.iv132, %wide.trip.count137
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv156 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax147 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond149.not, label %if.end178, label %for.inc148
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax153 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  ...
  %.pre = add nuw nsw i64 %indvars.iv156, 1
