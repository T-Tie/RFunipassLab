...
for.cond1:                                        ; preds = %for.inc, %for.body
  %f.1 = phi i32 [ %f.0, %for.body ], [ %f.25, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.body ], [ %end2.2, %for.inc ]
  %end1.1 = phi i32 [ %end1.0, %for.body ], [ %end1.2, %for.inc ]
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.27, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.29, %for.inc ]
...
for.end24:                                        ; preds = %for.cond
  %.neg = sub i32 0, %star1.0
  %sub25 = add i32 %end1.0, 1
  %add26 = add i32 %sub25, %.neg
  %.neg1 = sub i32 0, %star2.0
  %sub27 = add i32 %end2.0, 1
  %add28 = add i32 %sub27, %.neg1
