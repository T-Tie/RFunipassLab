...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %b) #8
...
for.cond:                                         ; preds = %for.inc15, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc15 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv13, i64 %indvars.iv
...
for.inc15:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv13
  ...
  %div = fdiv double %3, %4
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv13
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body21
  ...
  %indvars.iv16 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next17, %for.body21 ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv16, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv16
...
for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 1600, ptr noundef nonnull %a) #9
...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %__s) #9
  ret i64 %call
}
