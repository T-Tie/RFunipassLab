...
for.body7:                                        ; preds = %for.cond5
  ...
  %cmp12 = icmp sgt i32 %5, %7
  br i1 %cmp12, label %if.then, label %for.inc13

if.then:                                          ; preds = %for.body7
  store i32 %4, ptr %index, align 4, !tbaa !5
  br label %for.inc13
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %9 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !12
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11, i32 noundef %12)
