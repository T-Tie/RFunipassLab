...
for.cond50:                                       ; preds = %for.cond, %for.body55
  %2 = phi i8 [ %.pre, %for.body55 ], [ undef, %for.cond ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.body55 ], [ 0, %for.cond ]
...
for.body55:                                       ; preds = %for.cond50
  ...
  %3 = load i8, ptr %arrayidx60, align 1, !tbaa !5, !invariant.load !8
  %cmp62 = icmp eq i8 %2, %3
  %inc64 = zext i1 %cmp62 to i32
  %spec.select = add nuw nsw i32 %number.0, %inc64
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %arrayidx52.phi.trans.insert = getelementptr inbounds nuw [501 x i8], ptr %a, i64 0, i64 %indvars.iv.next3
  %.pre = load i8, ptr %arrayidx52.phi.trans.insert, align 1, !tbaa !5, !invariant.load !8
...
for.end68:                                        ; preds = %for.cond50
  ...
  %4 = load double, ptr %percent, align 8, !tbaa !13
...
cleanup:                                          ; preds = %land.lhs.true, %for.cond, %for.end68, %entry, %if.else76
  %.str.4.sink = phi ptr [ @.str.4, %if.else76 ], [ @.str.2, %entry ], [ @.str.3, %for.end68 ], [ @.str.2, %for.cond ], [ @.str.2, %land.lhs.true ]
