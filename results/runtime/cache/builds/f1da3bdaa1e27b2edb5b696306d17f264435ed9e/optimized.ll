...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 200, ptr noundef nonnull align 16 dereferenceable(200) %str) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(200) %str, i8 noundef 0, i64 noundef 200, i1 noundef false) #8
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 200, ptr noundef nonnull %str) #9
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %num) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(800) %num, i8 noundef 0, i64 noundef 800, i1 noundef false) #8
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %str) #10
