...
while.cond:                                       ; preds = %while.body, %for.end
  %phiofops = phi i32 [ -1, %for.end ], [ %i.0, %while.body ]
...
while.cond11:                                     ; preds = %if.end, %for.body10
  %sub7.sink.sink = phi i32 [ %sub7.sink, %for.body10 ], [ %add, %if.end ]
  %n.0 = phi i32 [ 0, %for.body10 ], [ %n.1, %if.end ]
  %add = add nsw i32 %sub7.sink.sink, 1
...
while.body13:                                     ; preds = %while.cond11
  ...
  %0 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %while.body13
  %n.1 = phi i32 [ %3, %if.then ], [ %n.0, %land.lhs.true ], [ %n.0, %while.body13 ]
...
for.inc41:                                        ; preds = %for.body33, %if.then37
  %n.3 = phi i32 [ %4, %if.then37 ], [ %n.2, %for.body33 ]
