...
if.else5:                                         ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %z) #8
...
if.then11:                                        ; preds = %if.else5
  ...
  store i32 %call15, ptr %z, align 4, !tbaa !5
  br label %if.end
...
if.else16:                                        ; preds = %if.else5
  ...
  store i32 %call18, ptr %z, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %if.else16, %if.then11
  %4 = load i32, ptr %z, align 4, !tbaa !5
  store i32 %4, ptr %retval, align 4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %z) #7
  br label %return
