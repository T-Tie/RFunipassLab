...
if.then24:                                        ; preds = %if.end
  ...
  %vbase.offset.i16 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !11
...
if.then45:                                        ; preds = %lor.lhs.false, %if.end27
  ...
  %vbase.offset.i23 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !11
...
for.inc:                                          ; preds = %lor.lhs.false, %if.then45
