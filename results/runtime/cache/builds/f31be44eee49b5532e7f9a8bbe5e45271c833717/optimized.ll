...
if.then35:                                        ; preds = %for.body31
  %call38 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3)
  br label %for.end42
...
for.cond44:                                       ; preds = %for.inc56, %for.end42
  %.sink = phi i32 [ %i.2, %for.end42 ], [ %add43, %for.inc56 ]
  %add43 = add nsw i32 %.sink, 1
...
if.then51:                                        ; preds = %for.body46
  %call54 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
  br label %for.inc56
