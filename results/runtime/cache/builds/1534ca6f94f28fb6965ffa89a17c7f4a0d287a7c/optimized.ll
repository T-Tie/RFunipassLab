...
while.body:                                       ; preds = %while.body, %if.end
  ...
  br i1 %cmp5, label %return.loopexit, label %while.body, !llvm.loop !18
...
if.end16:                                         ; preds = %if.then9, %if.else13, %if.then12, %if.then2, %if.else5, %if.then4
  %.sink = phi i32 [ %1, %if.else13 ], [ %2, %if.then12 ], [ %0, %if.then9 ], [ %0, %if.else5 ], [ %2, %if.then4 ], [ %1, %if.then2 ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %__first.pn = phi ptr [ %__i.0, %for.inc ], [ %__first, %for.cond.preheader ]
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load i32, ptr %__first, align 4, !tbaa !5
  %cmp.i = icmp slt i32 %0, %1
  br i1 %cmp.i, label %if.then2, label %while.cond.i.preheader
...
while.cond.i:                                     ; preds = %while.cond.i.preheader, %while.body.i
  %__last.addr.0.i = phi ptr [ %__next.0.i, %while.body.i ], [ %__i.0, %while.cond.i.preheader ]
  ...
  br i1 %cmp.i.i, label %while.body.i, label %for.inc.loopexit

while.body.i:                                     ; preds = %while.cond.i
  store i32 %2, ptr %__last.addr.0.i, align 4, !tbaa !5
  br label %while.cond.i, !llvm.loop !14

for.inc.loopexit:                                 ; preds = %while.cond.i
  br label %for.inc

for.inc:                                          ; preds = %for.inc.loopexit, %if.then2
  %__first.sink = phi ptr [ %__first, %if.then2 ], [ %__last.addr.0.i, %for.inc.loopexit ]
