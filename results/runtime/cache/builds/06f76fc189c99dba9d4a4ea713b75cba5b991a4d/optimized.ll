...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv7
...
for.cond38.preheader:                             ; preds = %for.cond29
  %3 = and i64 %indvars.iv7, 4294967295
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc45
  %indvars.iv12 = phi i64 [ %3, %for.cond38.preheader ], [ %5, %for.inc45 ]
