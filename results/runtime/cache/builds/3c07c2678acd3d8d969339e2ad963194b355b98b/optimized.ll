...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %num) #4
...
for.body16:                                       ; preds = %for.cond14
  ...
  %9 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !9
...
for.inc45:                                        ; preds = %for.cond39
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11) #5
...
for.end47:                                        ; preds = %for.cond39
  ...
  %12 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12) #5
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %num) #5
