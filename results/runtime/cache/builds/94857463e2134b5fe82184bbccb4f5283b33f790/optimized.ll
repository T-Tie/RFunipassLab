...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  %indvars.iv32 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next33, %for.inc131 ]
  %indvars.iv9 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next10, %for.inc131 ]
...
for.cond20:                                       ; preds = %for.cond15, %for.inc66
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc66 ], [ 0, %for.cond15 ]
  %exitcond.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond.not, label %for.cond70, label %for.body23

for.body23:                                       ; preds = %for.cond20
  %6 = add nuw nsw i64 %indvars.iv17, 4294967295
  %7 = and i64 %6, 4294967295
  %or.cond = icmp samesign ult i64 %7, %indvars.iv32
  br i1 %or.cond, label %for.inc66, label %if.end

if.end:                                           ; preds = %for.body23
  %arrayidx27 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv17
  %8 = load i32, ptr %arrayidx27, align 16, !tbaa !5
  br label %for.cond30

for.cond30:                                       ; preds = %for.body33, %if.end
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body33 ], [ %indvars.iv9, %if.end ]
  %minValue.0 = phi i32 [ %spec.select, %for.body33 ], [ %8, %if.end ]
  %9 = icmp slt i64 %indvars.iv11, %2
  br i1 %9, label %for.body33, label %for.end47

for.body33:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv17, i64 %indvars.iv11
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc63 ], [ %indvars.iv9, %for.end47 ]
  %11 = icmp slt i64 %indvars.iv14, %2
  br i1 %11, label %for.inc63, label %for.inc66

for.inc63:                                        ; preds = %for.cond54
  %arrayidx61 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv17, i64 %indvars.iv14
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc121 ], [ 0, %for.cond20 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw nsw i64 %indvars.iv27, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond3 = icmp samesign ult i64 %14, %indvars.iv32
  br i1 %or.cond3, label %for.inc121, label %if.end78

if.end78:                                         ; preds = %for.body73
  %arrayidx82 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv27
  %15 = load i32, ptr %arrayidx82, align 4, !tbaa !5
  br label %for.cond85

for.cond85:                                       ; preds = %for.body88, %if.end78
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body88 ], [ %indvars.iv9, %if.end78 ]
  %minValue79.0 = phi i32 [ %spec.select4, %for.body88 ], [ %15, %if.end78 ]
  %16 = icmp slt i64 %indvars.iv21, %2
  br i1 %16, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv27
  %17 = load i32, ptr %arrayidx92, align 4, !tbaa !5
  %spec.select4 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc118 ], [ %indvars.iv9, %for.end102 ]
  %18 = icmp slt i64 %indvars.iv24, %2
  br i1 %18, label %for.inc118, label %for.inc121

for.inc118:                                       ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv27
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %arrayidx129 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next33, i64 %indvars.iv.next33
