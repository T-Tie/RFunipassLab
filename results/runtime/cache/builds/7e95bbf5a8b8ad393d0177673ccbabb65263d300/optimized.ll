...
for.cond33:                                       ; preds = %for.inc58, %for.end
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc58 ], [ 0, %for.end ]
  %exitcond30.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond30.not, label %for.end60, label %for.inc58

for.inc58:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv27
  %6 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %arrayidx39 = getelementptr inbounds nuw [1000 x i32], ptr %f, i64 0, i64 %indvars.iv27
  %7 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !9
  %arrayidx41 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv27
  %8 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !9
  %arrayidx44 = getelementptr inbounds nuw [1000 x i32], ptr %e, i64 0, i64 %indvars.iv27
  %9 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !9
  %reass.sub24 = sub i32 %9, %8
  %10 = mul i32 %reass.sub24, 60
  %arrayidx49 = getelementptr inbounds nuw [1000 x i32], ptr %d, i64 0, i64 %indvars.iv27
  %11 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %add50 = add nsw i32 %11, 12
  %arrayidx52 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv27
  %12 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !9
  %13 = xor i32 %12, -1
  %sub54 = add i32 %add50, %13
  %mul55 = mul nsw i32 %sub54, 3600
  %.neg = sub i32 0, %6
  %reass.sub25 = add i32 %.neg, 3600
  %mul = add i32 %reass.sub25, %7
