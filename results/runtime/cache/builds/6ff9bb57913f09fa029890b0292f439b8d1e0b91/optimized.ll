...
for.end23:                                        ; preds = %for.cond6
  %temp.0.lcssa = phi i32 [ %temp.0, %for.cond6 ]
  %tIndex.0.lcssa = phi i32 [ %tIndex.0, %for.cond6 ]
  %cmp24 = icmp eq i32 %temp.0.lcssa, -1
  br i1 %cmp24, label %if.end32, label %if.else

if.else:                                          ; preds = %for.end23
  %idxprom28 = sext i32 %tIndex.0.lcssa to i64
...
for.end42:                                        ; preds = %for.cond3
  %ans.0.lcssa = phi i32 [ %ans.0, %for.cond3 ]
  %call43 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %ans.0.lcssa)
