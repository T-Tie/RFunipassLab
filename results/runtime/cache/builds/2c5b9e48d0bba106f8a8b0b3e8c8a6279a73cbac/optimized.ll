...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv23
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv30 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next31, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond36.not = icmp eq i32 %i.2, %smax35
  br i1 %exitcond36.not, label %for.end49, label %for.cond22.preheader
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv27 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next28, %for.inc44 ]
  %exitcond34.not = icmp eq i64 %indvars.iv27, %wide.trip.count33
  br i1 %exitcond34.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv27
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next28
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax41 = call i32 @llvm.smax.i32(i32 %len.0, i32 1)
...
for.cond52:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %for.end49
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 1, %for.end49 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %cleanup, label %for.inc59
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv37
  ...
  br label %for.cond52, !llvm.loop !30
