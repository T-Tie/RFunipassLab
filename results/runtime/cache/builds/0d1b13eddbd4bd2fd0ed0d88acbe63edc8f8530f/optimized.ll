...
for.cond:                                         ; preds = %for.inc35, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc35 ], [ 0, %entry ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, 1000
  br i1 %exitcond8.not, label %for.end37, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv5, i64 %indvars.iv
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv5
...
for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond12.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond12.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv9
  ...
  %reass.add16 = add i32 %9, %neg15
  %reass.mul17 = mul i32 %reass.add16, 3600
  %12 = add i32 %.neg14, 43200
  %13 = add i32 %12, %11
  %14 = add i32 %13, %reass.mul17
  %15 = add i32 %14, %reass.mul
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %15) #5
