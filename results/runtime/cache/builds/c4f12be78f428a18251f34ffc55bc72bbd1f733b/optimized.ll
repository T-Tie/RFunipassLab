...
if.then85:                                        ; preds = %lor.lhs.false
  ...
  %5 = getelementptr inbounds [100 x i32], ptr @a, i64 0, i64 %idxprom88
  %6 = load i32, ptr %5, align 4, !tbaa !5, !invariant.load !9
...
if.else95:                                        ; preds = %lor.lhs.false.thread
  %idxprom863 = sext i32 %i.2 to i64
  %idxprom884 = sext i32 %j.4 to i64
  %7 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom863
  %8 = getelementptr inbounds [100 x i32], ptr %7, i64 0, i64 %idxprom884
