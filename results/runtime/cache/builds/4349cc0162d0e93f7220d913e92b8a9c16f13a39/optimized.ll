...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %exitcond13 = icmp eq i32 %i.0, %1
  br i1 %exitcond13, label %for.end, label %for.inc
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  ...
  %exitcond9 = icmp eq i32 %i.1, %2
  br i1 %exitcond9, label %while.cond, label %for.cond6
...
for.cond15:                                       ; preds = %for.cond6, %for.inc30
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc30 ], [ 0, %for.cond6 ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, 40
  br i1 %exitcond8.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv5
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %div = sdiv i32 %4, 10
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %arrayidx21 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv.next6
...
while.cond:                                       ; preds = %for.cond3, %while.cond
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %while.cond ], [ 39, %for.cond3 ]
  %arrayidx37 = getelementptr inbounds [40 x i32], ptr %sum, i64 0, i64 %indvars.iv10
