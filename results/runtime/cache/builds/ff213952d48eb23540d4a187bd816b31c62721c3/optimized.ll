...
for.cond134:                                      ; preds = %if.then147, %if.else
  %phiofops = phi i32 [ 0, %if.else ], [ %i.3, %if.then147 ]
  %i.3 = phi i32 [ 1, %if.else ], [ %inc148, %if.then147 ]
