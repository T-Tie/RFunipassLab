...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond12 = icmp eq i64 %indvars.iv, %wide.trip.count11
  br i1 %exitcond12, label %for.end20, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv7 = phi i64 [ %indvars.iv, %for.cond1.preheader ], [ %indvars.iv.next8, %for.body3 ]
  %m.0 = phi i32 [ %2, %for.cond1.preheader ], [ %spec.select, %for.body3 ]
  %exitcond = icmp eq i64 %indvars.iv7, %wide.trip.count
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv7
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %while.cond ], [ 0, %for.cond ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv16
...
while.end:                                        ; preds = %while.cond
  %0 = trunc nuw nsw i64 %indvars.iv16 to i32
  %sub = shl i64 %indvars.iv16, 32
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv19 = phi i64 [ %2, %while.cond11.preheader ], [ %indvars.iv.next20, %if.end ]
...
while.body13:                                     ; preds = %while.cond11
  ...
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next20
...
land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next20
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv22 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next23, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select14, %for.body33 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond27.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv22
  %7 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select14 = tail call i32 @llvm.smax.i32(i32 %7, i32 %n.2)
