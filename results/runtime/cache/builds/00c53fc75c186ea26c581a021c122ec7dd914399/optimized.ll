...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax61 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %smax37 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond23.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count27 = zext i32 %n.tr to i64
  br label %for.cond27
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv14 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next15, %for.inc21 ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv34 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next35, %for.inc60 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv29 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next30, %for.inc57 ]
...
for.cond65.preheader:                             ; preds = %for.end62
  ...
  %wide.trip.count43 = zext i32 %n.tr to i64
  br label %for.cond65
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond51.not, label %for.cond86.preheader, label %for.cond68.preheader

for.cond86.preheader:                             ; preds = %for.cond65
  %wide.trip.count55 = zext i32 %n.tr to i64
  br label %for.cond86
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv57 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next58, %for.inc104 ]
