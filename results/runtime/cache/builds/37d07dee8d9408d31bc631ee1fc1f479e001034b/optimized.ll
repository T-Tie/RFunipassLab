...
for.cond:                                         ; preds = %for.inc, %entry
  %t.addr.0 = phi i32 [ %t, %entry ], [ %inc, %for.inc ]
  %cmp = icmp sle i32 %t.addr.0, %l
  br i1 %cmp, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %sub = sub nsw i32 %t.addr.0, 1
  %idxprom = sext i32 %sub to i64
  %arrayidx = getelementptr inbounds i8, ptr %a, i64 %idxprom
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %sub1 = sub nsw i32 %t.addr.0, 2
  %idxprom2 = sext i32 %sub1 to i64
  %arrayidx3 = getelementptr inbounds i8, ptr %a, i64 %idxprom2
  store i8 %0, ptr %arrayidx3, align 1, !tbaa !5
  %inc = add nsw i32 %t.addr.0, 1
...
if.end17:                                         ; preds = %if.else, %if.else15, %if.then
  %phiofops2 = phi i1 [ false, %if.else ], [ true, %if.else15 ], [ false, %if.then ]
...
if.end50:                                         ; preds = %for.body45
  br i1 %phiofops2, label %if.then52, label %for.inc55
...
for.inc55:                                        ; preds = %if.end50.thread, %if.end50, %if.then52
