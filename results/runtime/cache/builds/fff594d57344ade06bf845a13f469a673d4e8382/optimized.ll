...
while.cond:                                       ; preds = %while.body, %entry
  %__holeIndex.addr.0 = phi i64 [ %__holeIndex, %entry ], [ %__parent.0, %while.body ]
  %__parent.0 = phi i64 [ %div, %entry ], [ %div4, %while.body ]
...
while.body:                                       ; preds = %land.end
  %add.ptr1 = getelementptr inbounds i32, ptr %__first, i64 %__parent.0
...
if.then2:                                         ; preds = %if.then
  call void @_ZSt9iter_swapIPiS0_EvT_T0_(ptr noundef align 4 %__result, ptr noundef align 4 %__b) #11
  br label %if.end16
...
if.then4:                                         ; preds = %if.else
  call void @_ZSt9iter_swapIPiS0_EvT_T0_(ptr noundef align 4 %__result, ptr noundef align 4 %__c) #11
  br label %if.end16

if.else5:                                         ; preds = %if.else
  call void @_ZSt9iter_swapIPiS0_EvT_T0_(ptr noundef align 4 %__result, ptr noundef align 4 %__a) #11
  br label %if.end16
...
while.end:                                        ; preds = %while.cond1
  %incdec.ptr3 = getelementptr inbounds i32, ptr %__last.addr.0, i32 -1
  br label %while.cond4

while.cond4:                                      ; preds = %while.body6, %while.end
  %__last.addr.1 = phi ptr [ %incdec.ptr3, %while.end ], [ %incdec.ptr7, %while.body6 ]
  %call5 = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops15_Iter_less_iterclIPiS3_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %__comp, ptr noundef align 4 %__pivot, ptr noundef nonnull align 4 %__last.addr.1) #11
  br i1 %call5, label %while.body6, label %while.end8

while.body6:                                      ; preds = %while.cond4
  %incdec.ptr7 = getelementptr inbounds i32, ptr %__last.addr.1, i32 -1
...
if.end:                                           ; preds = %while.end8
  call void @_ZSt9iter_swapIPiS0_EvT_T0_(ptr noundef align 4 %__first.addr.1, ptr noundef nonnull align 4 %__last.addr.1) #11
...
while.cond:                                       ; preds = %while.body, %entry
  %__next.0 = phi ptr [ %incdec.ptr, %entry ], [ %incdec.ptr1, %while.body ]
  %__last.addr.0 = phi ptr [ %__last, %entry ], [ %__next.0, %while.body ]
  %call = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops14_Val_less_iterclIiPiEEbRT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %__comp, ptr noundef nonnull align 4 dereferenceable(4) %__val, ptr noundef nonnull align 4 %__next.0) #11
  br i1 %call, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %1 = load i32, ptr %__next.0, align 4, !tbaa !5
  store i32 %1, ptr %__last.addr.0, align 4, !tbaa !5
  %incdec.ptr1 = getelementptr inbounds i32, ptr %__next.0, i32 -1
