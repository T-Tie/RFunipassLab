...
entry:
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call1)
  ret void
}
...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #10
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0) unnamed_addr #7 {
entry_after_outline.exitStub:
  %vtable.i = load ptr, ptr %0, align 8, !tbaa !35
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !37
