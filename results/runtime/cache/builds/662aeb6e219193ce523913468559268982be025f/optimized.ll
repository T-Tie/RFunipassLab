...
for.inc:                                          ; preds = %if.end26.thread, %if.end26, %if.else, %if.then35
  %total1.3 = phi i32 [ %add36, %if.then35 ], [ %add37, %if.else ], [ %total1.1, %if.end26 ], [ %add25, %if.end26.thread ]
...
for.inc85:                                        ; preds = %if.end68.thread, %if.end68, %if.else81, %if.then79
  %total2.3 = phi i32 [ %add80, %if.then79 ], [ %add82, %if.else81 ], [ %total2.1, %if.end68 ], [ %add67, %if.end68.thread ]
