...
for.cond:                                         ; preds = %if.end50, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end50 ]
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %5) #8, !tbaa !5
...
if.then11:                                        ; preds = %if.then
  %call12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div9) #7
  br label %if.end
...
if.then14:                                        ; preds = %if.end
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div9) #7
  br label %if.end17
...
if.then19:                                        ; preds = %if.end17
  ...
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div22) #7
  %cmp33 = fcmp ogt double %div26, 0.000000e+00
  br i1 %cmp33, label %if.then34, label %if.end36

if.then34:                                        ; preds = %if.then19
  %call35 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div26) #7
  br label %if.end36
...
if.then38:                                        ; preds = %if.end36
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %div26) #7
  br label %if.end40

if.end40:                                         ; preds = %if.then38, %if.end36
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %div22) #7
  %cmp42 = fcmp ogt double %div31, 0.000000e+00
  br i1 %cmp42, label %if.then43, label %if.end45

if.then43:                                        ; preds = %if.end40
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div31) #7
  br label %if.end45
...
if.then47:                                        ; preds = %if.end45
  %call48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, double noundef %div31) #7
  br label %if.end50

if.end50:                                         ; preds = %if.end45, %if.then47, %if.end17
