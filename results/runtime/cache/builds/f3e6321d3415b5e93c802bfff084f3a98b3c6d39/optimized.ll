...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %num) #4
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull %a) #4
...
for.end:                                          ; preds = %for.cond
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %sub5, i32 noundef 0)
  %3 = add nuw nsw i32 %smax22, 1
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc32, %for.end
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %for.inc32 ], [ %sub5, %for.end ]
  %k.0 = phi i32 [ %inc33, %for.inc32 ], [ 1, %for.end ]
  %exitcond23 = icmp eq i32 %k.0, %3
  br i1 %exitcond23, label %for.cond35.preheader, label %for.cond8.preheader

for.cond35.preheader:                             ; preds = %for.cond4
  %sub = add nsw i32 %j.0, -1
  %4 = zext i32 %sub to i64
  %smax28 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 1)
...
for.cond8.preheader:                              ; preds = %for.cond4
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv20, i32 noundef 0)
  %5 = add nuw i32 %smax, 1
  %wide.trip.count = zext i32 %5 to i64
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc29
  %indvars.iv = phi i64 [ 1, %for.cond8.preheader ], [ %indvars.iv.next, %for.inc29 ]
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc48
  %indvars.iv24 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next25, %for.inc48 ]
  %exitcond30.not = icmp eq i64 %indvars.iv24, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end50, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %cmp38.not = icmp eq i64 %indvars.iv24, %4
  br i1 %cmp38.not, label %if.else, label %if.then39

if.then39:                                        ; preds = %for.body37
  %arrayidx41 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
if.else:                                          ; preds = %for.body37
  %9 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !12
...
for.end50:                                        ; preds = %for.cond35
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %num) #5
