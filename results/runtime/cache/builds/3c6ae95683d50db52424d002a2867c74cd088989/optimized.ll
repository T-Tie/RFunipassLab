...
for.cond72:                                       ; preds = %for.inc122, %for.body71
  %.sink12 = phi i32 [ 0, %for.body71 ], [ %inc123, %for.inc122 ]
  store i32 %.sink12, ptr %j, align 4, !tbaa !5
  %cmp74 = icmp slt i32 %.sink12, %t
...
if.else107:                                       ; preds = %if.else95
  ...
  %idxprom110 = sext i32 %.sink12 to i64
