...
for.cond2:                                        ; preds = %for.cond, %for.inc55
  %.pre15 = phi i32 [ %.pre, %for.inc55 ], [ %0, %for.cond ]
  ...
  %2 = sext i32 %.pre15 to i64
  %cmp3 = icmp slt i64 %indvars.iv8, %2
...
for.inc55:                                        ; preds = %for.inc55.sink.split, %if.end
  %.pre = phi i32 [ %.pre15, %if.end ], [ %.pre.pre, %for.inc55.sink.split ]
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  ...
  %4 = sext i32 %3 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next13, %4
