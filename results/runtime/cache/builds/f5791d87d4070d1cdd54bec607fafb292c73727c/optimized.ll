...
for.cond30:                                       ; preds = %for.inc45, %if.end
  ...
  %9 = load i32, ptr %t.sink2, align 4, !tbaa !5
  %add = add nsw i32 %9, 1
  store i32 %add, ptr %j29, align 4, !tbaa !5
  %cmp31 = icmp slt i32 %add, %3
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  ...
  %13 = load i32, ptr %t.sink3, align 4, !tbaa !5
  %add53 = add nsw i32 %13, 1
  store i32 %add53, ptr %j52, align 4, !tbaa !5
  %cmp55 = icmp slt i32 %add53, %3
...
for.inc63:                                        ; preds = %for.cond54
  ...
  %14 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !13
...
if.end78:                                         ; preds = %land.lhs.true75, %for.body73
  ...
  %16 = load i32, ptr %arrayidx82, align 4, !tbaa !5, !invariant.load !13
...
for.cond85:                                       ; preds = %for.inc100, %if.end78
  ...
  %17 = load i32, ptr %t.sink, align 4, !tbaa !5
  %add84 = add nsw i32 %17, 1
  store i32 %add84, ptr %i83, align 4, !tbaa !5
  %cmp86 = icmp slt i32 %add84, %3
...
for.body88:                                       ; preds = %for.cond85
  ...
  %18 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  ...
  %21 = load i32, ptr %t.sink1, align 4, !tbaa !5
  %add108 = add nsw i32 %21, 1
  store i32 %add108, ptr %i107, align 4, !tbaa !5
  %cmp110 = icmp slt i32 %add108, %3
...
for.inc118:                                       ; preds = %for.cond109
  ...
  %22 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %23 = load i32, ptr %arrayidx129, align 4, !tbaa !5, !invariant.load !13
