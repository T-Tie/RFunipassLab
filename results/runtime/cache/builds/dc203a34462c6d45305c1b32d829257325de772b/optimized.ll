...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count45 = zext i32 %narrow to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre51, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv41 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next42, %for.inc27 ]
  %exitcond46 = icmp eq i64 %indvars.iv41, %wide.trip.count45
  br i1 %exitcond46, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc21 ], [ 1, %for.cond10 ]
  %exitcond = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %indvars.iv37
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.131 = phi i32 [ %6, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc48 ], [ %9, %for.end29 ]
  %10 = trunc nuw i64 %indvars.iv48 to i32
  %cmp31 = icmp sgt i32 %10, 0
  br i1 %cmp31, label %for.cond33, label %for.end50

for.cond33:                                       ; preds = %for.cond30, %for.inc43
  %11 = phi i32 [ %dec, %for.inc43 ], [ %0, %for.cond30 ]
  %cmp34 = icmp sgt i32 %11, 0
  br i1 %cmp34, label %for.body35, label %for.inc48

for.body35:                                       ; preds = %for.cond33
  %idxprom38 = zext nneg i32 %11 to i64
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv48, i64 %idxprom38
...
for.end50:                                        ; preds = %for.cond30, %for.body35
  %13 = phi i32 [ %10, %for.body35 ], [ %smin, %for.cond30 ]
  %x2.0 = phi i32 [ %11, %for.body35 ], [ 0, %for.cond30 ]
  %sub51 = add nsw i32 %x2.0, %x1.1
  %sub52 = xor i32 %i.131, -1
  %sub53 = add i32 %13, %sub52
