...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %u) #4
  br label %for.cond
...
for.cond2:                                        ; preds = %for.end17, %for.end
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end17 ], [ 0, %for.end ]
  %q.0 = phi ptr [ %incdec.ptr20, %for.end17 ], [ @__const.main.t, %for.end ]
  %f.0 = phi i32 [ %f.1, %for.end17 ], [ 0, %for.end ]
  %0 = load i8, ptr %q.0, align 1, !tbaa !12, !invariant.load !13
  %exitcond18 = icmp eq i64 %indvars.iv15, 52
  br i1 %exitcond18, label %for.cond23.preheader, label %for.cond6.preheader

for.cond23.preheader:                             ; preds = %for.cond2
  br label %for.cond23

for.cond6.preheader:                              ; preds = %for.cond2
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv15
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %if.end
  %p.0 = phi ptr [ %incdec.ptr, %if.end ], [ %s, %for.cond6.preheader ]
  %f.1 = phi i32 [ %f.2, %if.end ], [ %f.0, %for.cond6.preheader ]
  %1 = load i8, ptr %p.0, align 1, !tbaa !12, !invariant.load !13
  %cmp8.not = icmp eq i8 %1, 0
  br i1 %cmp8.not, label %for.end17, label %for.body9
...
for.cond23:                                       ; preds = %for.cond23.preheader, %if.end36
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %if.end36 ], [ 0, %for.cond23.preheader ]
  %q.1 = phi ptr [ %incdec.ptr39, %if.end36 ], [ @__const.main.t, %for.cond23.preheader ]
  %3 = load i8, ptr %q.1, align 1, !tbaa !12, !invariant.load !13
  %conv24 = sext i8 %3 to i32
  %exitcond22 = icmp eq i64 %indvars.iv19, 52
  br i1 %exitcond22, label %for.end40, label %for.body26

for.body26:                                       ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv19
...
if.then30:                                        ; preds = %for.body26
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %conv24, i32 noundef %4) #5
...
if.then42:                                        ; preds = %for.end40
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3) #5
  br label %if.end44

if.end44:                                         ; preds = %if.then42, %for.end40
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %u) #5
