...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  %sub.sink11 = phi i32 [ %sub, %if.then35 ], [ %sub49, %for.inc48 ]
  %cmp38 = icmp sge i32 %sub.sink11, 0
...
for.body39:                                       ; preds = %for.cond37
  ...
  %idxprom42 = sext i32 %sub.sink11 to i64
...
if.then45:                                        ; preds = %for.body39
  ...
  store i32 %sub.sink11, ptr %b2, align 4, !tbaa !5
...
for.inc48:                                        ; preds = %for.body39, %if.then45
  %sub49 = sub nsw i32 %sub.sink11, 1
