...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.210, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.212, %for.inc ]
...
for.inc:                                          ; preds = %for.body3, %if.then19
  %star1.212 = phi i32 [ %star1.2.ph, %if.then19 ], [ %star1.1, %for.body3 ]
  %star2.210 = phi i32 [ %star2.2.ph, %if.then19 ], [ %star2.1, %for.body3 ]
