...
for.end32:                                        ; preds = %for.cond17
  %x.0.lcssa = phi i32 [ %x.0, %for.cond17 ]
  %cmp33 = icmp eq i32 %x.0.lcssa, 0
...
for.end43:                                        ; preds = %for.cond14
  %y.0.lcssa = phi i32 [ %y.0, %for.cond14 ]
  %cmp44 = icmp eq i32 %y.0.lcssa, 0
...
for.end58:                                        ; preds = %for.cond46
  %idxprom59.lcssa = phi i64 [ %idxprom59, %for.cond46 ]
  %arrayidx60 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom59.lcssa
...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  ...
  %cmp77 = icmp slt i32 %j.1, %l.0.lcssa
...
for.cond89:                                       ; preds = %for.inc114, %if.then88
  ...
  br i1 %cmp90, label %for.inc114, label %for.inc118.loopexit
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  ...
  %cmp135 = icmp slt i32 %i.3, %l.0.lcssa
...
for.end153:                                       ; preds = %for.body136, %for.cond134
  %phiofops.lcssa = phi i32 [ %phiofops, %for.body136 ], [ %phiofops, %for.cond134 ]
  %i.3.lcssa = phi i32 [ %i.3, %for.body136 ], [ %i.3, %for.cond134 ]
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %i.4 = phi i32 [ 0, %for.end153 ], [ %add158, %for.inc204 ]
  %cmp156 = icmp slt i32 %i.4, %phiofops.lcssa
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  ...
  %cmp160 = icmp slt i32 %j.2, %i.3.lcssa
...
for.cond172:                                      ; preds = %for.inc197, %if.then171
  ...
  br i1 %cmp173, label %for.inc197, label %for.inc201.loopexit
...
for.cond207:                                      ; preds = %for.inc223, %for.end206
  ...
  %cmp208 = icmp slt i32 %i.5, %i.3.lcssa
  br i1 %cmp208, label %for.body209, label %if.end226.loopexit
