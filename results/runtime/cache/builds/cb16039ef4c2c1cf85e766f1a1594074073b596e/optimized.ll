...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) @a) #8
...
if.then:                                          ; preds = %for.body, %land.lhs.true
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i) #9
...
entry:
  ...
  %vtable7.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !10
  ...
  %0 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !13
  ...
  %vtable12.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !10
  %vbase.offset.ptr13.i = getelementptr i8, ptr %vtable12.i, i64 -24
  %vbase.offset14.i = load i64, ptr %vbase.offset.ptr13.i, align 8, !invariant.load !12
  ...
  %1 = load i32, ptr %_M_streambuf_state.i.i.i, align 8, !tbaa !27
...
if.then19.i:                                      ; preds = %entry
  ...
  %3 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !28
...
if.then28.i:                                      ; preds = %if.then19.i
  %vtable29.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !10
  %vbase.offset.ptr30.i = getelementptr i8, ptr %vtable29.i, i64 -24
  %vbase.offset31.i = load i64, ptr %vbase.offset.ptr30.i, align 8, !invariant.load !12
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !43
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !46
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !9, !invariant.load !12
...
if.else:                                          ; preds = %entry
  ...
  %3 = load ptr, ptr %vfn, align 8, !invariant.load !12
...
!40 = !{!"p1 _ZTS15__locale_struct", !19, i64 0}
!41 = !{!"p1 int", !19, i64 0}
!42 = !{!"p1 short", !19, i64 0}
!43 = !{!44, !45, i64 16}
!44 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !45, i64 8, !45, i64 16, !45, i64 24, !45, i64 32, !45, i64 40, !45, i64 48, !22, i64 56}
