...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 140000, ptr %a) #5
  call void @llvm.lifetime.start.p0(i64 140000, ptr %b) #5
...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 140000, ptr %b) #5
  call void @llvm.lifetime.end.p0(i64 140000, ptr %a) #5
...
cleanup:                                          ; preds = %for.end, %if.then2, %if.then
  %.sink = phi i32 [ %sum.0, %for.end ], [ 1, %if.then2 ], [ 0, %if.then ]
  ret i32 %.sink
}
