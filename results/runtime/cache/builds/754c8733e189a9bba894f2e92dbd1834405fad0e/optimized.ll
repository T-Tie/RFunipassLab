...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv62, %1
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre79, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv69 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next70, %for.inc27 ]
  %exitcond74 = icmp eq i64 %indvars.iv69, %wide.trip.count73
  br i1 %exitcond74, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc21 ], [ 1, %for.cond10 ]
  %exitcond = icmp eq i64 %indvars.iv65, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv69, i64 %indvars.iv65
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.159 = phi i32 [ %7, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %9, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %10 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc48 ], [ %10, %for.end29 ]
  %11 = trunc nuw i64 %indvars.iv76 to i32
  %cmp31 = icmp sgt i32 %11, 0
  br i1 %cmp31, label %for.cond33, label %for.end50

for.cond33:                                       ; preds = %for.cond30, %for.inc43
  %12 = phi i32 [ %dec, %for.inc43 ], [ %0, %for.cond30 ]
  %cmp34 = icmp sgt i32 %12, 0
  br i1 %cmp34, label %for.body35, label %for.inc48

for.body35:                                       ; preds = %for.cond33
  %idxprom38 = zext nneg i32 %12 to i64
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv76, i64 %idxprom38
...
for.end50:                                        ; preds = %for.cond30, %for.body35
  %x2.0 = phi i32 [ %12, %for.body35 ], [ 0, %for.cond30 ]
  %sub51 = add nsw i32 %x2.0, %x1.1
  %14 = xor i32 %i.159, -1
  %sub53 = add i32 %11, %14
