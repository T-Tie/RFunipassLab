...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %17, double noundef %18) #10
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %17) #10
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %17, double noundef %18, double noundef %17, double noundef %19) #10
  br label %for.inc132
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i1 = call i32 @getc(ptr noundef %20) #10
  %21 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i2 = call i32 @getc(ptr noundef %21) #10
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %num) #10
