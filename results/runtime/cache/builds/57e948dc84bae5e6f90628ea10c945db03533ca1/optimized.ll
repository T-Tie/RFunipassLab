...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %sum) #12
  store i32 0, ptr %sum, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %k) #12
...
for.end33:                                        ; preds = %for.cond23
  ...
  %10 = load i32, ptr %add.ptr20, align 4, !tbaa !5
  store i32 %10, ptr %sum, align 4, !tbaa !5
...
for.cond45:                                       ; preds = %for.inc54, %for.end44
  ...
  %sub46 = sub nsw i32 %13, 1
  %cmp47 = icmp slt i32 %12, %sub46
  br i1 %cmp47, label %for.inc54, label %for.end56

for.inc54:                                        ; preds = %for.cond45
  %idx.ext49 = sext i32 %12 to i64
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %k) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %sum) #12
