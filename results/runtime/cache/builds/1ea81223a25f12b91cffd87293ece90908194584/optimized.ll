...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv28.in = phi i32 [ %indvars.iv28, %for.end100 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %indvars.iv28 = add i32 %indvars.iv28.in, -1
  %smax65 = call i32 @llvm.smax.i32(i32 %indvars.iv28, i32 noundef 1)
  %smax54 = call i32 @llvm.smax.i32(i32 %indvars.iv28.in, i32 noundef 0)
  %0 = zext i32 %indvars.iv28 to i64
  %wide.trip.count39 = zext nneg i32 %smax54 to i64
  %wide.trip.count = zext i32 %indvars.iv28.in to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond27.preheader, label %for.body
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  ...
  br i1 %exitcond35.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv28.in, ptr @k, align 4, !tbaa !5
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond, !llvm.loop !14

for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv51 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next52, %for.inc62 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %wide.trip.count39
  br i1 %exitcond56.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv51
  %4 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select20, %for.body34 ], [ %4, %for.body29 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond45.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv51
  %5 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !9
  %spec.select20 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond32, !llvm.loop !15

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv46 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next47, %for.inc59 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond50.not, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv46, i64 %indvars.iv51
...
for.end64:                                        ; preds = %for.cond27
  %cmp65 = icmp eq i32 %indvars.iv28.in, 2
  br i1 %cmp65, label %if.then, label %if.end

if.then:                                          ; preds = %for.end64
  store i32 %smax54, ptr @j, align 4, !tbaa !5
...
for.cond66:                                       ; preds = %for.cond81, %if.end
  %indvars.iv62 = phi i64 [ 1, %if.end ], [ %indvars.iv.next63, %for.cond81 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %wide.trip.count66
  br i1 %exitcond67.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next63
  %9 = load i32, ptr %arrayidx71, align 4, !tbaa !5, !invariant.load !9
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv62
  store i32 %9, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next63
  %10 = load i32, ptr %arrayidx76, align 16, !tbaa !5, !invariant.load !9
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv62
  store i32 %10, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %0
  br i1 %exitcond61.not, label %for.cond66, label %for.inc95, !llvm.loop !18

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next63, i64 %indvars.iv.next58
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !9
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv57
  store i32 %11, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.cond81, !llvm.loop !19

for.end100:                                       ; preds = %for.cond66
  store i32 %smax65, ptr @i, align 4, !tbaa !5
