...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv7 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next8, %for.inc23 ]
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %putchar1 = call i32 @putchar(i32 noundef %conv73) #8
