...
if.then55:                                        ; preds = %for.body51
  ...
  %10 = load double, ptr %arrayidx58, align 8, !tbaa !9, !invariant.load !14
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv30
  %11 = load double, ptr %arrayidx61, align 8, !tbaa !9, !invariant.load !14
...
if.else63:                                        ; preds = %for.body51
  ...
  %12 = load double, ptr %arrayidx70, align 8, !tbaa !9, !invariant.load !14
...
if.then77:                                        ; preds = %if.else72
  ...
  %13 = load double, ptr %arrayidx84, align 8, !tbaa !9, !invariant.load !14
...
if.else93:                                        ; preds = %if.else72
  ...
  %14 = load double, ptr %arrayidx99, align 8, !tbaa !9, !invariant.load !14
