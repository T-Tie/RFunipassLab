...
if.then34:                                        ; preds = %for.end32
  ...
  %11 = load i8, ptr %arrayidx37, align 2, !tbaa !9
  %inc38 = add i8 %11, 1
...
for.body48:                                       ; preds = %for.cond46
  ...
  store i8 %15, ptr %arrayidx55, align 1, !tbaa !9
  br label %for.inc56
...
for.cond71:                                       ; preds = %for.inc121, %for.end70
  ...
  %sub72 = sub nsw i32 %17, 1
  %cmp73 = icmp slt i32 %16, %sub72
  br i1 %cmp73, label %for.body74, label %for.end123

for.body74:                                       ; preds = %for.cond71
  %add75 = add nsw i32 %16, 1
  store i32 %add75, ptr %j, align 4, !tbaa !5
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %18 = load i32, ptr %j, align 4, !tbaa !5
  %cmp77 = icmp slt i32 %18, %17
  br i1 %cmp77, label %for.body78, label %for.end120

for.body78:                                       ; preds = %for.cond76
  %idxprom79 = sext i32 %18 to i64
  ...
  %19 = load i8, ptr %arrayidx81, align 2, !tbaa !9
  %conv82 = sext i8 %19 to i32
  %idxprom83 = sext i32 %16 to i64
  ...
  %20 = load i8, ptr %arrayidx85, align 2, !tbaa !9
  %conv86 = sext i8 %20 to i32
  %cmp87 = icmp sgt i32 %conv82, %conv86
  br i1 %cmp87, label %if.then88, label %if.end117
...
for.cond89:                                       ; preds = %for.inc114, %if.then88
  ...
  %cmp90 = icmp slt i32 %21, 6
  br i1 %cmp90, label %for.body91, label %for.end116

for.body91:                                       ; preds = %for.cond89
  %idxprom94 = sext i32 %21 to i64
  %arrayidx95 = getelementptr inbounds [6 x i8], ptr %arrayidx80, i64 0, i64 %idxprom94
  %22 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  ...
  store i8 %22, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds [6 x i8], ptr %arrayidx84, i64 0, i64 %idxprom94
  %23 = load i8, ptr %arrayidx102, align 1, !tbaa !9
  store i8 %23, ptr %arrayidx95, align 1, !tbaa !9
  %24 = load i8, ptr %arrayidx98, align 1, !tbaa !9
  store i8 %24, ptr %arrayidx102, align 1, !tbaa !9
  br label %for.inc114

for.inc114:                                       ; preds = %for.body91
  %inc115 = add nsw i32 %21, 1
...
if.end117:                                        ; preds = %for.end116, %for.body78
  br label %for.inc118

for.inc118:                                       ; preds = %if.end117
  %inc119 = add nsw i32 %18, 1
...
for.inc121:                                       ; preds = %for.end120
  store i32 %add75, ptr %i, align 4, !tbaa !5
  br label %for.cond71, !llvm.loop !19

for.end123:                                       ; preds = %for.cond71
  %25 = load i8, ptr %arrayidx8, align 4, !tbaa !9
...
for.body136:                                      ; preds = %for.cond134
  ...
  %27 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %conv140 = sext i8 %27 to i32
  %sub141 = sub nsw i32 %26, 1
  ...
  %28 = load i8, ptr %arrayidx144, align 2, !tbaa !9
  %conv145 = sext i8 %28 to i32
  %cmp146 = icmp eq i32 %conv140, %conv145
  br i1 %cmp146, label %if.then147, label %if.else149

if.then147:                                       ; preds = %for.body136
  %29 = load i32, ptr %z, align 4, !tbaa !5
  %inc148 = add nsw i32 %29, 1
  store i32 %inc148, ptr %z, align 4, !tbaa !5
  br label %if.end150

if.else149:                                       ; preds = %for.body136
  br label %for.end153
...
for.inc151:                                       ; preds = %if.end150
  %inc152 = add nsw i32 %26, 1
  store i32 %inc152, ptr %i, align 4, !tbaa !5
  br label %for.cond134, !llvm.loop !20

for.end153:                                       ; preds = %if.else149, %for.cond134
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %30 = load i32, ptr %i, align 4, !tbaa !5
  %31 = load i32, ptr %z, align 4, !tbaa !5
  %sub155 = sub nsw i32 %31, 1
  %cmp156 = icmp slt i32 %30, %sub155
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  ...
  %cmp160 = icmp slt i32 %32, %31
  br i1 %cmp160, label %for.body161, label %for.end203
...
for.body161:                                      ; preds = %for.cond159
  ...
  %33 = load i8, ptr %arrayidx164, align 1, !tbaa !9
  %conv165 = sext i8 %33 to i32
  %idxprom166 = sext i32 %30 to i64
  ...
  %34 = load i8, ptr %arrayidx168, align 1, !tbaa !9
  %conv169 = sext i8 %34 to i32
...
for.cond172:                                      ; preds = %for.inc197, %if.then171
  ...
  %cmp173 = icmp slt i32 %35, 6
  br i1 %cmp173, label %for.body174, label %for.end199

for.body174:                                      ; preds = %for.cond172
  %idxprom177 = sext i32 %35 to i64
  %arrayidx178 = getelementptr inbounds [6 x i8], ptr %arrayidx163, i64 0, i64 %idxprom177
  %36 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  ...
  store i8 %36, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds [6 x i8], ptr %arrayidx167, i64 0, i64 %idxprom177
  %37 = load i8, ptr %arrayidx185, align 1, !tbaa !9
  store i8 %37, ptr %arrayidx178, align 1, !tbaa !9
  %38 = load i8, ptr %arrayidx181, align 1, !tbaa !9
  store i8 %38, ptr %arrayidx185, align 1, !tbaa !9
  br label %for.inc197

for.inc197:                                       ; preds = %for.body174
  %inc198 = add nsw i32 %35, 1
  store i32 %inc198, ptr %k, align 4, !tbaa !5
  br label %for.cond172, !llvm.loop !21

for.end199:                                       ; preds = %for.cond172
  br label %if.end200

if.end200:                                        ; preds = %for.end199, %for.body161
  br label %for.inc201

for.inc201:                                       ; preds = %if.end200
  %inc202 = add nsw i32 %32, 1
  store i32 %inc202, ptr %j, align 4, !tbaa !5
  br label %for.cond159, !llvm.loop !22

for.end203:                                       ; preds = %for.cond159
  br label %for.inc204

for.inc204:                                       ; preds = %for.end203
  store i32 %add158, ptr %i, align 4, !tbaa !5
...
for.cond207:                                      ; preds = %for.inc223, %for.end206
  ...
  %cmp208 = icmp slt i32 %39, %31
  br i1 %cmp208, label %for.body209, label %for.end225
...
if.end226:                                        ; preds = %for.end225, %if.then128
