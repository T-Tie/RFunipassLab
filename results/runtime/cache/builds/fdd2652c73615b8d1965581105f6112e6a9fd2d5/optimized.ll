...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  br i1 %call1, label %while.cond, label %for.cond.preheader, !llvm.loop !8
...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %0 = ashr exact i64 %sext22, 32
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv19, i32 0)
