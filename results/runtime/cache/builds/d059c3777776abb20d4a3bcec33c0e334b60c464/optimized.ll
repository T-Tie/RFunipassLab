...
if.else:                                          ; preds = %land.lhs.true
  ...
  %spec.select3 = add nsw i32 %inc19, %a.0
  br label %for.inc

for.inc:                                          ; preds = %if.else, %for.body, %if.then
  %a.1 = phi i32 [ %inc, %if.then ], [ %a.0, %for.body ], [ %spec.select3, %if.else ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv5
...
for.body34:                                       ; preds = %for.cond29
  ...
  %spec.select = add nuw nsw i32 %inc40, %t.1
...
for.cond54:                                       ; preds = %for.cond26, %for.inc80
  ...
  %exitcond11.not = icmp eq i32 %i.2, 123
  br i1 %exitcond11.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select2, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv8
...
for.body62:                                       ; preds = %for.cond57
  ...
  %spec.select2 = add nuw nsw i32 %inc68, %l.1
