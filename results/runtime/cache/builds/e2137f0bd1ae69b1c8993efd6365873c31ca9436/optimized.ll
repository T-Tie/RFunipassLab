...
cond.end46:                                       ; preds = %cond.false45, %cond.true40
  %cond47 = phi i32 [ %11, %cond.true40 ], [ %12, %cond.false45 ]
  store i32 %cond47, ptr %min, align 4, !tbaa !5
  br label %for.inc48
...
if.end:                                           ; preds = %for.end64
  %17 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
