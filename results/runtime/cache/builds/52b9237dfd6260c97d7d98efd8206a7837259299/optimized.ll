...
entry:
  ...
  %__c.addr.i20 = alloca i8, align 1
...
for.cond2:                                        ; preds = %for.cond, %for.inc55
  ...
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc55 ], [ 0, %for.cond ]
  %csum.0 = phi i64 [ %csum.1, %for.inc55 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.2, %for.inc55 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv99, %3
  br i1 %cmp3, label %for.body4, label %for.end57

for.body4:                                        ; preds = %for.cond2
  %sext = shl i64 %csum.0, 32
  %conv = ashr exact i64 %sext, 32
  %arrayidx6 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv99
...
for.cond17:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.then
  %indvars.iv.next97.sink = phi i64 [ %indvars.iv.next97, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %idxprom12, %if.then ]
  %retval.0.i.sink = phi ptr [ %retval.0.i, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ @_ZSt4cout, %if.then ]
  %arrayidx22 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next97.sink
  %call.i.i4 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx22) #7
  %call1.i5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i.sink, ptr noundef nonnull %arrayidx22, i64 noundef %call.i.i4)
  %indvars.iv.next97 = add nsw i64 %indvars.iv.next97.sink, 1
  %cmp18.not.not = icmp slt i64 %indvars.iv.next97.sink, %indvars.iv99
...
for.inc25:                                        ; preds = %for.cond17
  ...
  %gep90 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %4 = load i64, ptr %gep90, align 8, !tbaa !16
...
for.cond36:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit32, %if.then30
  %indvars.iv.next94.sink = phi i64 [ %indvars.iv.next94, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit32 ], [ %idxprom31, %if.then30 ]
  %retval.0.i29.sink = phi ptr [ %retval.0.i29, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit32 ], [ @_ZSt4cout, %if.then30 ]
  %arrayidx41 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next94.sink
  %call.i.i33 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx41) #7
  %call1.i34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i29.sink, ptr noundef nonnull %arrayidx41, i64 noundef %call.i.i33)
  %indvars.iv.next94 = add nsw i64 %indvars.iv.next94.sink, 1
  %cmp37 = icmp slt i64 %indvars.iv.next94, %indvars.iv99
  br i1 %cmp37, label %for.inc44, label %for.end46

for.inc44:                                        ; preds = %for.cond36
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i20)
  store i8 32, ptr %__c.addr.i20, align 1, !tbaa !12
  %vtable.i21 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !13
  %vbase.offset.ptr.i22 = getelementptr i8, ptr %vtable.i21, i64 -24
  %vbase.offset.i23 = load i64, ptr %vbase.offset.ptr.i22, align 8, !invariant.load !15
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i23
  %5 = load i64, ptr %gep, align 8, !tbaa !16
  %cmp.not.i26 = icmp eq i64 %5, 0
  br i1 %cmp.not.i26, label %if.end.i30, label %if.then.i27

if.then.i27:                                      ; preds = %for.inc44
  %call1.i28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i20, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit32

if.end.i30:                                       ; preds = %for.inc44
  %call2.i31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit32

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit32: ; preds = %if.then.i27, %if.end.i30
  %retval.0.i29 = phi ptr [ %call1.i28, %if.then.i27 ], [ @_ZSt4cout, %if.end.i30 ]
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i20)
...
for.inc55.sink.split:                             ; preds = %for.cond17, %for.end46
  ...
  %j.2.ph.in = phi i64 [ %indvars.iv.next94, %for.end46 ], [ %indvars.iv.next97, %for.cond17 ]
  %j.2.ph = trunc i64 %j.2.ph.in to i32
  %vtable.i78 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !13
  %vbase.offset.ptr.i79 = getelementptr i8, ptr %vtable.i78, i64 -24
  %vbase.offset.i80 = load i64, ptr %vbase.offset.ptr.i79, align 8, !invariant.load !15
  %add.ptr.i81 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i80
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i81, i8 noundef signext 10)
  %call1.i82 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
  %call.i.i83 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i82)
  br label %for.inc55
...
for.cond63:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit62, %for.end57
  %indvars.iv.next104.sink = phi i64 [ %indvars.iv.next104, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit62 ], [ %idxprom58, %for.end57 ]
  %retval.0.i59.sink = phi ptr [ %retval.0.i59, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit62 ], [ @_ZSt4cout, %for.end57 ]
  %arrayidx68 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next104.sink
  %call.i.i63 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx68) #7
  %call1.i64 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i59.sink, ptr noundef nonnull %arrayidx68, i64 noundef %call.i.i63)
  %indvars.iv.next104 = add nsw i64 %indvars.iv.next104.sink, 1
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next104, %7
...
for.inc71:                                        ; preds = %for.cond63
  ...
  store i8 32, ptr %__c.addr.i50, align 1, !tbaa !12
  %vtable.i51 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !13
  %vbase.offset.ptr.i52 = getelementptr i8, ptr %vtable.i51, i64 -24
  %vbase.offset.i53 = load i64, ptr %vbase.offset.ptr.i52, align 8, !invariant.load !15
  %gep91 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i53
  %8 = load i64, ptr %gep91, align 8, !tbaa !16
  %cmp.not.i56 = icmp eq i64 %8, 0
  br i1 %cmp.not.i56, label %if.end.i60, label %if.then.i57

if.then.i57:                                      ; preds = %for.inc71
...
if.end.i60:                                       ; preds = %for.inc71
  %call2.i61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit62

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit62: ; preds = %if.then.i57, %if.end.i60
  %retval.0.i59 = phi ptr [ %call1.i58, %if.then.i57 ], [ @_ZSt4cout, %if.end.i60 ]
