...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 16 @ctt, i8 0, i64 40000, i1 false)
...
newFuncRoot:
  br label %if.end35_to_outline

if.end35_to_outline:                              ; preds = %newFuncRoot
  br label %for.inc36

for.inc36:                                        ; preds = %if.end35_to_outline
  %0 = load i32, ptr @i, align 4, !tbaa !5
  %inc37 = add nsw i32 %0, 1
  store i32 %inc37, ptr @i, align 4, !tbaa !5
  br label %for.cond25.exitStub, !llvm.loop !13

for.cond25.exitStub:                              ; preds = %for.inc36
  ret void
}
