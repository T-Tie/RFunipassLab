...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef align 16 %sum) #4
...
for.inc:                                          ; preds = %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true16, %land.lhs.true, %for.cond
  ...
  %9 = load i32, ptr %arrayidx2, align 4, !tbaa !5, !invariant.load !9
  %mul37 = mul nsw i32 %9, 60
  %add = add nsw i32 %mul34, %mul37
  %10 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
  %add40 = add nsw i32 %add, %10
  %11 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  %mul43 = mul nsw i32 %11, 60
  %mul44 = mul nsw i32 %mul43, 60
  %12 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !9
  %mul47 = mul nsw i32 %12, 60
  %add48 = add nsw i32 %mul44, %mul47
  %13 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !9
  %add51 = add nsw i32 %add48, %13
...
for.inc61:                                        ; preds = %for.cond56
  ...
  %call60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %16) #5
  %inc62 = add nsw i32 %14, 1
...
for.end63:                                        ; preds = %for.cond56
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %sum) #5
