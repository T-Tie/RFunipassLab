...
while.cond1:                                      ; preds = %while.body4, %while.end
  ...
  %0 = add i32 %.pr2, -50
  %or.cond22 = icmp ult i32 %0, 50
  br i1 %or.cond22, label %while.body4, label %while.end7
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %1 = add i32 %.pr3, -20
  %or.cond23 = icmp ult i32 %1, 30
  br i1 %or.cond23, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %2 = add i32 %.pr4, -10
  %or.cond24 = icmp ult i32 %2, 10
  br i1 %or.cond24, label %while.body22, label %while.end25
...
land.end30:                                       ; preds = %while.end25, %while.body31
  ...
  %.pr5 = phi i32 [ %.pr4, %while.end25 ], [ %sub33, %while.body31 ]
