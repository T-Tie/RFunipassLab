...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc28 ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv40
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv40, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  ...
  br i1 %exitcond39.not, label %for.inc28, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv40, i64 %indvars.iv35
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end68
  %indvars.iv55 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next56, %for.end68 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count43
  br i1 %exitcond59.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv55
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select33, %for.body39 ], [ %3, %for.body33 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count48
  br i1 %exitcond49.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %indvars.iv55
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %spec.select33 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv50 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next51, %for.body56 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count48
  br i1 %exitcond54.not, label %for.end68, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv50, i64 %indvars.iv55
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = call i32 @llvm.smax.i32(i32 %n, i32 0)
  %smax19 = call i32 @llvm.smax.i32(i32 %sub, i32 1)
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  ...
  br i1 %exitcond26.not, label %for.cond13, label %for.inc30
...
if.else:                                          ; preds = %tailrecurse
  tail call void @_Z7guilingi(i32 noundef %n.tr) #9
...
for.cond:                                         ; preds = %for.end14, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc26.i2, %for.end14 ]
...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.end ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.end14:                                        ; preds = %for.cond1
  call void @_Z1fi(i32 noundef %1) #11
  ...
  %inc26.i2 = add nuw nsw i32 %i.0, 1
  br label %for.cond
