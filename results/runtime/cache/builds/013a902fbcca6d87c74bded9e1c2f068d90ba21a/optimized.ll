...
cond.end:                                         ; preds = %if.else62, %cond.true
  %.sink2 = phi double [ %fneg87, %cond.true ], [ %div69, %if.else62 ]
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink2, double noundef %div79, double noundef %.sink2, double noundef %div79) #7
  br label %for.inc106
