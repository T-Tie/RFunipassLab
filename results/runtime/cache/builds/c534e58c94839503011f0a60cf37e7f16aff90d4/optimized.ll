...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 676, ptr nonnull %f1) #6
  call void @llvm.lifetime.start.p0(i64 676, ptr nonnull %f2) #6
...
for.end143:                                       ; preds = %for.cond113
  ...
  call void @llvm.lifetime.end.p0(i64 676, ptr nonnull %f2) #6
  call void @llvm.lifetime.end.p0(i64 676, ptr nonnull %f1) #6
  ret i32 0
}
