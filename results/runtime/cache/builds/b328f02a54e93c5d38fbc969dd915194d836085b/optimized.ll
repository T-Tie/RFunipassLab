...
for.end:                                          ; preds = %for.cond
  ...
  %smax25 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %wide.trip.count26 = zext nneg i32 %smax25 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond29.preheader, label %for.cond7.preheader
...
for.cond29.preheader:                             ; preds = %for.cond4
  ...
  %smax31 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %wide.trip.count32 = zext nneg i32 %smax31 to i64
  br label %for.cond29

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv18 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next19, %for.body9 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv18
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv28 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next29, %for.inc36 ]
...
for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv28
