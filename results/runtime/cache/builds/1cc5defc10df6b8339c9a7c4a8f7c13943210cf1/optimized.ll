...
for.cond28:                                       ; preds = %for.cond28.preheader, %if.end49
  %indvars.iv39 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next40, %if.end49 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %if.end49 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %if.end49 ]
...
for.body30:                                       ; preds = %for.cond28
  ...
  br i1 %cmp31, label %if.end49, label %if.end37
...
if.end49:                                         ; preds = %if.end37, %for.body30
