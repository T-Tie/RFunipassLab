...
for.body5:                                        ; preds = %for.cond3
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx7) #10
  ...
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #10
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50000, ptr noundef nonnull %word) #11
  ret i32 0
}
