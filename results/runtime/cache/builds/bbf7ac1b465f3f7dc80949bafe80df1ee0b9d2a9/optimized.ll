...
for.cond2:                                        ; preds = %for.inc19, %for.end
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc19 ], [ 0, %for.end ]
  ...
  %exitcond20 = icmp eq i64 %indvars.iv17, 52
  br i1 %exitcond20, label %for.cond23.preheader, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond2
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv17
  br label %for.cond6
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc38
  %indvars.iv21 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next22, %for.inc38 ]
  ...
  %exitcond24 = icmp eq i64 %indvars.iv21, 52
  br i1 %exitcond24, label %for.end40, label %for.body26

for.body26:                                       ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv21
