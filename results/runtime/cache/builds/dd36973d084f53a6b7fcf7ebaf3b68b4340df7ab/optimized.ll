...
for.cond19:                                       ; preds = %for.cond15, %for.inc56
  ...
  br i1 %exitcond18.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 0
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv6 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next7, %for.inc41 ]
...
if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv6
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  ...
  br i1 %exitcond33.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 0, i64 %indvars.iv29
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv19 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next20, %for.inc90 ]
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !13
  %spec.select1 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select1, %if.else75 ]
