...
if.end23:                                         ; preds = %if.then21, %if.end19
  %sum.2 = phi i32 [ 0, %if.then21 ], [ %sum.1, %if.end19 ]
  %i.1 = phi i32 [ 0, %if.then21 ], [ %inc, %if.end19 ]
  %cmp24 = icmp sgt i32 %sum.2, 80
...
if.end29:                                         ; preds = %if.then25, %if.end23
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.2, %if.end23 ]
  %i.2 = phi i32 [ 1, %if.then25 ], [ %i.1, %if.end23 ]
