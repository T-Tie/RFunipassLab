...
for.body37:                                       ; preds = %for.cond35
  ...
  %9 = load i8, ptr %arrayidx39, align 1, !tbaa !9
  %conv40 = sext i8 %9 to i32
  %10 = load i8, ptr %arrayidx28, align 1, !tbaa !9
...
if.then52:                                        ; preds = %for.end50
  %13 = load i8, ptr %arrayidx28, align 1, !tbaa !9
  %conv55 = sext i8 %13 to i32
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv55, i32 noundef %12)
  br label %for.inc58
