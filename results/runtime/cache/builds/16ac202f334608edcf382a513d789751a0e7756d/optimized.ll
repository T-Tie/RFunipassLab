...
NodeBlock15:
  ...
  %Pivot16 = icmp slt i32 %rem1, 5
  br i1 %Pivot16, label %NodeBlock5, label %NodeBlock13

NodeBlock13:                                      ; preds = %NodeBlock15
  %Pivot14 = icmp slt i32 %rem1, 7
  br i1 %Pivot14, label %NodeBlock7, label %NodeBlock11

NodeBlock11:                                      ; preds = %NodeBlock13
  %Pivot12 = icmp slt i32 %rem1, 8
  br i1 %Pivot12, label %sw.epilog.gvnsink.split, label %NodeBlock9

NodeBlock9:                                       ; preds = %NodeBlock11
  %Pivot10 = icmp slt i32 %rem1, 9
  br i1 %Pivot10, label %sw.bb12, label %sw.epilog.gvnsink.split

NodeBlock7:                                       ; preds = %NodeBlock13
  %Pivot8 = icmp slt i32 %rem1, 6
  br i1 %Pivot8, label %sw.bb33, label %sw.epilog.gvnsink.split
...
NodeBlock3:                                       ; preds = %NodeBlock5
  %Pivot4 = icmp slt i32 %rem1, 3
  br i1 %Pivot4, label %sw.epilog.gvnsink.split, label %NodeBlock1

NodeBlock1:                                       ; preds = %NodeBlock3
  %Pivot2 = icmp slt i32 %rem1, 4
  br i1 %Pivot2, label %sw.bb47, label %sw.epilog.gvnsink.split
...
sw.epilog.gvnsink.split:                          ; preds = %LeafBlock, %NodeBlock, %NodeBlock3, %NodeBlock1, %NodeBlock7, %NodeBlock11, %NodeBlock9, %sw.bb47, %sw.bb33, %sw.bb12
  %.sink22 = phi i32 [ 1, %sw.bb12 ], [ 1, %sw.bb33 ], [ 0, %sw.bb47 ], [ 1, %NodeBlock9 ], [ 1, %NodeBlock11 ], [ 1, %NodeBlock7 ], [ 0, %NodeBlock1 ], [ 0, %NodeBlock3 ], [ 0, %NodeBlock ], [ 0, %LeafBlock ]
  %.sink21 = phi i32 [ 1, %sw.bb12 ], [ 0, %sw.bb33 ], [ 1, %sw.bb47 ], [ 2, %NodeBlock9 ], [ 1, %NodeBlock11 ], [ 0, %NodeBlock7 ], [ 2, %NodeBlock1 ], [ 1, %NodeBlock3 ], [ 0, %NodeBlock ], [ 0, %LeafBlock ]
  %.sink = phi i32 [ 1, %sw.bb12 ], [ 0, %sw.bb33 ], [ 1, %sw.bb47 ], [ 0, %NodeBlock9 ], [ 0, %NodeBlock11 ], [ 1, %NodeBlock7 ], [ 0, %NodeBlock1 ], [ 0, %NodeBlock3 ], [ 1, %NodeBlock ], [ 0, %LeafBlock ]
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %.sink22)
  ...
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call7, i32 noundef %.sink21)
  ...
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call9, i32 noundef %.sink)
...
sw.epilog:                                        ; preds = %sw.epilog.gvnsink.split, %LeafBlock
