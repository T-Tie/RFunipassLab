...
for.cond13:                                       ; preds = %for.inc53, %for.body12
  ...
  %y1.1 = phi i32 [ %y1.0, %for.body12 ], [ %y1.211, %for.inc53 ]
  %x1.1 = phi i32 [ %x1.0, %for.body12 ], [ %x1.213, %for.inc53 ]
...
for.inc53:                                        ; preds = %for.body15, %land.lhs.true38, %land.lhs.true44, %if.then51
  %x1.213 = phi i32 [ %x1.2.ph, %if.then51 ], [ %x1.2.ph, %land.lhs.true44 ], [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1, %for.body15 ]
  %y1.211 = phi i32 [ %y1.2.ph, %if.then51 ], [ %y1.2.ph, %land.lhs.true44 ], [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1, %for.body15 ]
