...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc48
  %indvars.iv35 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next36, %for.inc48 ]
  %j.0 = phi i32 [ 0, %for.cond3.preheader ], [ %j.1, %for.inc48 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond52.preheader, label %for.body6
...
for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv35
...
if.then:                                          ; preds = %for.body6
  ...
  %inc.i1 = add nsw i32 %j.0, 1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body6
  %j.1 = phi i32 [ %inc.i1, %if.then ], [ %j.0, %for.body6 ]
  %smax33 = call i32 @llvm.smax.i32(i32 %j.1, i32 0)
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc45, %if.end
  %indvars.iv31.in = phi i32 [ %indvars.iv31, %for.inc45 ], [ %j.1, %if.end ]
  %p.0 = phi i32 [ %inc46, %for.inc45 ], [ 0, %if.end ]
  %indvars.iv31 = add i32 %indvars.iv31.in, -1
  %exitcond34.not = icmp eq i32 %p.0, %smax33
  br i1 %exitcond34.not, label %for.inc48, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc42
  %indvars.iv28 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next29, %for.inc42 ]
  %exitcond.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond.not, label %for.inc45, label %for.body24

for.body24:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv28
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv.next29
  %6 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc66
  %indvars.iv42 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next43, %for.inc66 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end68, label %for.body55

for.body55:                                       ; preds = %for.cond52
  %cmp57 = icmp slt i64 %indvars.iv42, %2
  %arrayidx60 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv42
  %7 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !9
  br i1 %cmp57, label %if.then58, label %if.else

if.then58:                                        ; preds = %for.body55
  %call61 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %7, i32 noundef 44)
  br label %for.inc66

if.else:                                          ; preds = %for.body55
  %call64 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7)
  br label %for.inc66
