...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 dereferenceable(100000) %a) #9
  br label %for.cond
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef %a) #10
