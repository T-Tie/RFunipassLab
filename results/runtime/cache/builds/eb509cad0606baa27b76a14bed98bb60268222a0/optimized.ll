...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count29 = zext i32 %3 to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre31, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv15, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv24 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next25, %for.cond13 ]
  ...
  %exitcond30 = icmp eq i64 %indvars.iv24, %wide.trip.count29
  br i1 %exitcond30, label %for.end58, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %6 = add nsw i64 %indvars.iv24, -1
  %7 = trunc nuw nsw i64 %indvars.iv24 to i32
  %8 = trunc nuw nsw i64 %indvars.iv24 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv18 = phi i64 [ 1, %for.cond13.preheader ], [ %10, %for.inc53 ]
  %x1.1 = phi i32 [ %x1.0, %for.cond13.preheader ], [ %x1.25, %for.inc53 ]
  %y1.1 = phi i32 [ %y1.0, %for.cond13.preheader ], [ %y1.27, %for.inc53 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv24, i64 %indvars.iv18
  %9 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !14
  %cmp20 = icmp eq i32 %9, 0
  %10 = add nuw nsw i64 %indvars.iv18, 1
  br i1 %cmp20, label %land.lhs.true, label %for.inc53

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv24, i64 %10
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next25, i64 %indvars.iv18
  ...
  %13 = trunc nuw nsw i64 %indvars.iv18 to i32
  %spec.select9 = select i1 %cmp32, i32 %13, i32 %y1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %y1.2.ph = phi i32 [ %y1.1, %land.lhs.true ], [ %spec.select9, %land.lhs.true26 ]
  %14 = add nsw i64 %indvars.iv18, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv24, i64 %14
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv18
  %16 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !14
  %cmp50 = icmp eq i32 %16, 0
  %spec.select10 = select i1 %cmp50, i32 %8, i32 %x2.1
  %17 = trunc nuw nsw i64 %indvars.iv18 to i32
  %spec.select11 = select i1 %cmp50, i32 %17, i32 %y2.1
  br label %for.inc53

for.inc53:                                        ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
  %y1.27 = phi i32 [ %y1.2.ph, %land.lhs.true44 ], [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1, %for.body15 ]
  %x1.25 = phi i32 [ %x1.2.ph, %land.lhs.true44 ], [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1, %for.body15 ]
  %x2.2 = phi i32 [ %spec.select10, %land.lhs.true44 ], [ %x2.1, %land.lhs.true38 ], [ %x2.1, %for.body15 ]
  %y2.2 = phi i32 [ %spec.select11, %land.lhs.true44 ], [ %y2.1, %land.lhs.true38 ], [ %y2.1, %for.body15 ]
...
for.end58:                                        ; preds = %for.cond10
  ...
  %mul6512 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6512, %add60
  %18 = shl i32 %sub61, 1
  %reass.sub13 = sub i32 %sub66, %18
  %add71 = add i32 %reass.sub13, 2
