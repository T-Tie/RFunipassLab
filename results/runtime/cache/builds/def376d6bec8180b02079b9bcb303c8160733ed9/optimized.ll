...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.body14
  %indvars.iv23 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next24, %for.body14 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond.cleanup13, label %for.body14
...
for.cond29:                                       ; preds = %while.cond, %for.body32
  ...
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body32 ], [ 0, %while.cond ]
...
for.end39:                                        ; preds = %for.cond29
  ...
  %call1.i17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call43, i8 noundef signext %call.i16)
