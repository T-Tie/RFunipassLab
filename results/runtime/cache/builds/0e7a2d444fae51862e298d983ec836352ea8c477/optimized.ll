...
if.else:                                          ; preds = %land.lhs.true, %for.body
  ...
  br i1 %cmp13, label %for.inc, label %if.else17

if.else17:                                        ; preds = %if.else
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %if.else, %if.else17
  %.str.2.sink.sink = phi ptr [ @.str, %land.lhs.true ], [ @.str.2, %if.else17 ], [ @.str.1, %if.else ]
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink.sink)
