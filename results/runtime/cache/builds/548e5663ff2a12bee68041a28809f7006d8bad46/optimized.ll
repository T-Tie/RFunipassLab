...
entry:
  %call = call i64 @strlen(ptr noundef readonly %word) #10
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef %word) #13
  call void @llvm.memset.p0.i64(ptr noundef align 16 %word, i8 noundef 0, i64 noundef 25000, i1 noundef false)
  br label %for.cond
