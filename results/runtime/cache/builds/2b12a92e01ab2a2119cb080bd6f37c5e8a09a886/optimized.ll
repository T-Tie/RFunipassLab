...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %c.0 = phi i32 [ 0, %entry ], [ %c.1.lcssa, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond1
  %c.1.lcssa = phi i32 [ %c.1, %for.cond1 ]
...
for.end19:                                        ; preds = %for.cond10, %land.end
  %i.1.lcssa = phi i32 [ %i.1, %for.cond10 ], [ %i.1, %land.end ]
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc28, %for.end19
  %j.1 = phi i32 [ %i.1.lcssa, %for.end19 ], [ %inc29, %for.inc28 ]
  %cmp21 = icmp slt i32 %j.1, 31
  %sub31 = sub nsw i32 %j.1, %i.1.lcssa
...
for.end30:                                        ; preds = %for.cond20
  %idxprom32.lcssa = phi i64 [ %idxprom32, %for.cond20 ]
  %arrayidx33 = getelementptr inbounds [32 x i8], ptr %res, i64 0, i64 %idxprom32.lcssa
