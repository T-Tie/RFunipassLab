...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc110 ], [ 0, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp50 = icmp slt i64 %indvars.iv3, %8
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv3
  %9 = load double, ptr %arrayidx53, align 8, !tbaa !9, !invariant.load !14
  %cmp54 = fcmp ogt double %9, 0.000000e+00
  %10 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv3
...
if.then55:                                        ; preds = %for.body51
  %arrayidx58 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv3
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv3
...
if.else63:                                        ; preds = %for.body51
  ...
  %arrayidx70 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv3
...
if.else72:                                        ; preds = %if.else63
  ...
  %13 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv3
...
if.then77:                                        ; preds = %if.else72
  ...
  %arrayidx84 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv3
...
if.else93:                                        ; preds = %if.else72
  %arrayidx99 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv3
