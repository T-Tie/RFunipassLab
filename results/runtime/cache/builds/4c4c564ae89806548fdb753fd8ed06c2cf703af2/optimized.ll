...
for.cond2:                                        ; preds = %for.inc19, %for.end
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc19 ], [ 0, %for.end ]
  ...
  %exitcond17 = icmp eq i64 %indvars.iv14, 52
  br i1 %exitcond17, label %for.cond23.preheader, label %for.cond6.preheader

for.cond23.preheader:                             ; preds = %for.cond2
  br label %for.cond23

for.cond6.preheader:                              ; preds = %for.cond2
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv14
  br label %for.cond6
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc38
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc38 ], [ 0, %for.cond23.preheader ]
  %q.1 = phi ptr [ %incdec.ptr39, %for.inc38 ], [ @__const.main.t, %for.cond23.preheader ]
  %3 = load i8, ptr %q.1, align 1, !tbaa !12
  %conv24 = sext i8 %3 to i32
  %exitcond21 = icmp eq i64 %indvars.iv18, 52
  br i1 %exitcond21, label %for.end40, label %for.body26

for.body26:                                       ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv18
