...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc11 ], [ %call, %entry ]
...
for.body:                                         ; preds = %for.cond
  %idxprom = and i64 %indvars.iv.next7, 4294967295
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %indvars.iv3 = phi i64 [ %indvars.iv, %for.cond3.preheader ], [ %indvars.iv.next4, %for.inc ]
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, 1
  %cmp4 = icmp slt i64 %indvars.iv.next4, %4
  br i1 %cmp4, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds [110 x i8], ptr @s, i64 0, i64 %indvars.iv.next4
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv9 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next10, %for.inc21 ]
...
for.inc21:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv9
