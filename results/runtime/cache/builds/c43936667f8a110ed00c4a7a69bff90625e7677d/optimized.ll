...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 500, ptr %a) #5
  call void @llvm.lifetime.start.p0(i64 3006, ptr %b) #5
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 3006, i1 false)
  ...
  %call3 = call i64 @strlen(ptr noundef %a) #6
...
if.end226:                                        ; preds = %for.end225, %if.then128
  ...
  call void @llvm.lifetime.end.p0(i64 3006, ptr %b) #5
  call void @llvm.lifetime.end.p0(i64 500, ptr %a) #5
  ret i32 0
}
