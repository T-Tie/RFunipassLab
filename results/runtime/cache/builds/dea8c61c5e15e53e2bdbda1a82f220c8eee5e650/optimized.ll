...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 dereferenceable(100000) %a) #8
  br label %for.cond
...
for.end:                                          ; preds = %for.body, %for.cond
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(100000) %a)
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef %add.ptr13)
  %inc17 = add nsw i32 %0, 1
  store i32 %inc17, ptr %j, align 4, !tbaa !8
  br label %for.cond7, !llvm.loop !12

for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef %a) #9
...
if.then6:                                         ; preds = %if.else
  ...
  %call16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15) #9
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %call24 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23) #9
...
define linkonce_odr dso_local noundef i64 @_ZNSt8ios_base5widthEl(ptr noundef nonnull align 8 dereferenceable(216) %this, i64 noundef %__wide) local_unnamed_addr #4 comdat align 2 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264)) local_unnamed_addr #4 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264)) local_unnamed_addr #4 align 2
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef zeroext i1 @_ZNSt11char_traitsIcE11eq_int_typeERKiS2_(ptr noundef nonnull align 4 dereferenceable(4) %__c1, ptr noundef nonnull align 4 dereferenceable(4) %__c2) local_unnamed_addr #4 comdat align 2 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNSt11char_traitsIcE3eofEv() local_unnamed_addr #4 comdat align 2 {
entry:
  ret i32 -1
}
