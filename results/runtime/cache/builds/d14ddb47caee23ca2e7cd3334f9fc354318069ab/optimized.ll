...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %word) #7
...
if.then21:                                        ; preds = %if.else19
  ...
  call void @outlined_ir_func_0(ptr %__c.addr.i, ptr %retval.0.i.loc)
...
if.else26:                                        ; preds = %if.else19
  ...
  call void @outlined_ir_func_0(ptr %__c.addr.i13, ptr %retval.0.i22.loc)
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %word) #7
...
define internal void @outlined_ir_func_0(ptr %0, ptr %1) #6 {
newFuncRoot:
  br label %if.then21_to_outline

if.then21_to_outline:                             ; preds = %newFuncRoot
  store i8 32, ptr %0, align 1, !tbaa !22
  ...
  %2 = load i64, ptr %gep50, align 8, !tbaa !23
...
!28 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !18, i64 0}
!29 = !{!"_ZTSNSt8ios_base6_WordsE", !18, i64 0, !25, i64 8}
!30 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !18, i64 0}
!31 = !{!"_ZTSSt6locale", !32, i64 0}
!32 = !{!"p1 _ZTSNSt6locale5_ImplE", !18, i64 0}
