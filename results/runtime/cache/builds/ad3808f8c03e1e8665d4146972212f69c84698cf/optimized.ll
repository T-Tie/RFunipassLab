...
entry:
  ...
  %rem3.sext = sext i8 %rem312 to i32
  ...
  %div1015 = sdiv i8 %rem8.lhs.trunc, 20
  %div10.sext = sext i8 %div1015 to i32
  ...
  %div2917 = sdiv i8 %rem27.lhs.trunc, 5
  %div29.sext = sext i8 %div2917 to i32
