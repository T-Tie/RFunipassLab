...
if.end7:                                          ; preds = %if.else, %if.then6, %if.then
  %a.1 = phi i32 [ %1, %if.then ], [ %2, %if.then6 ], [ %a.0, %if.else ]
  %b.1 = phi i32 [ %2, %if.then ], [ %1, %if.then6 ], [ %b.0, %if.else ]
...
for.inc:                                          ; preds = %sw.bb17, %sw.default, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16
  ...
  %add18 = add nsw i32 %x.1, %.sink2
  %inc = add nsw i32 %m.0, 1
  br label %for.cond14, !llvm.loop !9

for.end:                                          ; preds = %for.cond14
  call void @outlined_ir_func_0(i32 %x.1)
  br label %for.inc53
...
define internal void @outlined_ir_func_0(i32 %0) #9 {
newFuncRoot:
