...
if.then6.i9:                                      ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i14 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
  br i1 %call16.i14, label %land.lhs.true.i15, label %if.then6.i36

land.lhs.true.i15:                                ; preds = %if.then6.i9
  %_M_width.i4.i16 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i4.i16, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -301
...
if.then19.i20:                                    ; preds = %land.lhs.true.i15
  %call24.i21 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
...
if.then6.i36:                                     ; preds = %if.then28.i27, %if.then19.i20, %land.lhs.true.i15, %if.then6.i9
  ...
  %call16.i41 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
...
land.lhs.true.i42:                                ; preds = %if.then6.i36
  %_M_width.i4.i43 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i4.i43, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -301
  %or.cond.i46 = icmp ult i64 %5, -300
...
if.then19.i47:                                    ; preds = %land.lhs.true.i42
  %call24.i48 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #10
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55
