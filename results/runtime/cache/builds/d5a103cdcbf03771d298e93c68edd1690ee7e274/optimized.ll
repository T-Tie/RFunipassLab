...
lor.lhs.false:                                    ; preds = %if.end27
  ...
  %or.cond21 = and i1 %cmp39, %cmp44
  br i1 %or.cond21, label %if.then45, label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %v1) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %t1) #10
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %valid) #10
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %total) #10
  ret i32 0
}
