; ModuleID = '<stdin>'
source_filename = "/tmp/tmpe9zg42id.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef %a) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %a, i8 noundef 0, i64 noundef 400, i1 noundef false) #6
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef align 16 %b) #5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc8, %for.inc ]
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx6 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %idxprom5
  store i32 %1, ptr %arrayidx6, align 4, !tbaa !5
  %inc7 = add nsw i32 %k.0, 1
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then
  %k.1 = phi i32 [ %inc7, %if.then ], [ %k.0, %for.body ]
...
for.end18:                                        ; preds = %for.cond9
  ...
  %arrayidx21 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %idxprom20
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %4)
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %b) #7
