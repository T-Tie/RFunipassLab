...
for.cond10:                                       ; preds = %for.cond, %for.inc17
  ...
  %exitcond6.not = icmp eq i64 %indvars.iv, 31
  br i1 %exitcond6.not, label %for.end19, label %land.end
...
land.end:                                         ; preds = %for.cond10
  ...
  br i1 %cmp15, label %for.inc17, label %for.end19.split.loop.exit13

for.inc17:                                        ; preds = %land.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond10, !llvm.loop !14

for.end19.split.loop.exit13:                      ; preds = %land.end
  %5 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end19

for.end19:                                        ; preds = %for.cond10, %for.end19.split.loop.exit13
  %.lcssa = phi i32 [ %5, %for.end19.split.loop.exit13 ], [ 31, %for.cond10 ]
  %6 = zext nneg i32 %.lcssa to i64
  %7 = sext i32 %.lcssa to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc28, %for.end19
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc28 ], [ %6, %for.end19 ]
  %8 = sub nuw nsw i64 %indvars.iv7, %7
  %exitcond11.not = icmp eq i64 %indvars.iv7, 31
  br i1 %exitcond11.not, label %for.end30, label %for.inc28

for.inc28:                                        ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds nuw [32 x i8], ptr %res, i64 0, i64 %indvars.iv7
