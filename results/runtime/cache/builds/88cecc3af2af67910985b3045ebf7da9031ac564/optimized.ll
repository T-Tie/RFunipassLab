...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %num) #6
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(80000) %num, i8 noundef 0, i64 noundef 80000, i1 noundef false) #7
...
if.then:                                          ; preds = %for.body
  %call25 = call double @sqrt(double noundef %6) #8, !tbaa !5
...
if.else:                                          ; preds = %for.body
  ...
  %call57 = call double @sqrt(double noundef %8) #8, !tbaa !5
  ...
  %call67 = call double @sqrt(double noundef %8) #8, !tbaa !5
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i3 = call i32 @getc(ptr noundef %19)
  %20 = load ptr, ptr @stdin, align 8, !tbaa !16
  %call.i4 = call i32 @getc(ptr noundef %20)
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %num) #8
