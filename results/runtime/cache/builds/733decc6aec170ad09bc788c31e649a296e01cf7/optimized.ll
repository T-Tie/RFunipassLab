...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 captures(none) dereferenceable(10000) %a) #8
  br label %while.cond
...
for.body:                                         ; preds = %for.cond
  %idxprom2 = sext i32 %phiofops2 to i64
  ...
  %0 = load i8, ptr %arrayidx5, align 1, !tbaa !12, !invariant.load !8
...
for.cond14:                                       ; preds = %for.inc25, %for.end
  ...
  %cmp16 = icmp slt i32 %j.0, %phiofops2
...
for.end27:                                        ; preds = %for.cond14
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %a) #9
  ret i32 0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !16, !invariant.load !8
  ret i32 %0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !28, !invariant.load !8
  ret i64 %0
}
