...
entry:
  ...
  %2 = getelementptr inbounds [30 x i32], ptr @a, i64 0, i64 %idxprom
...
if.then11:                                        ; preds = %if.else5
  %call = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %i, i32 noundef %n) #6
  %add12 = add nsw i32 1, %call
  %call14 = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %fin, i32 noundef %n) #6
  %call15 = call noundef i32 @_Z3maxii(i32 noundef %add12, i32 noundef %call14) #6
  br label %return

if.else16:                                        ; preds = %if.else5
  %call18 = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %fin, i32 noundef %n) #6
  br label %return

return:                                           ; preds = %if.then11, %if.else16, %if.then, %if.else
  %z.0 = phi i32 [ 0, %if.else ], [ 1, %if.then ], [ %call15, %if.then11 ], [ %call18, %if.else16 ]
  ret i32 %z.0
}
