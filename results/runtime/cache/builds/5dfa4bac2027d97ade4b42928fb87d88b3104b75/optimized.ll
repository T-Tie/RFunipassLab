...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre20, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv14 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next15, %for.inc28 ]
  ...
  br i1 %exitcond19.not, label %for.end30, label %for.body12
...
for.cond14.preheader:                             ; preds = %for.body12
  %4 = trunc nuw nsw i64 %indvars.iv14 to i32
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv10 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next11, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv10
...
for.cond31:                                       ; preds = %for.inc52, %for.end30
  ...
  %7 = phi i32 [ %sub, %for.end30 ], [ %dec, %for.inc52 ]
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %a2.1 = phi i32 [ %a2.2, %for.body39 ], [ %a2.0, %for.cond37.preheader ]
  %b2.1 = phi i32 [ %b2.2, %for.body39 ], [ %b2.0, %for.cond37.preheader ]
  %p.5 = phi i32 [ %p.6, %for.body39 ], [ 0, %for.cond37.preheader ]
  %8 = phi i32 [ %sub49, %for.body39 ], [ %sub, %for.cond37.preheader ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %b2.2 = select i1 %cmp44, i32 %8, i32 %b2.1
  %add46 = zext i1 %cmp44 to i32
  %p.6 = add nuw nsw i32 %p.5, %add46
  %sub49 = add nsw i32 %8, -1
