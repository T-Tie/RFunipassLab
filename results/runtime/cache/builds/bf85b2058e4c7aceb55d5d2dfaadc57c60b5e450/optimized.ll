...
if.then19.i:                                      ; preds = %entry
  call fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %add.ptr15.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry
  call fastcc void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(40) %initial)
...
if.then19.i31:                                    ; preds = %while.body
  call fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %add.ptr15.i24)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call fastcc void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(41) %word)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %0) unnamed_addr #7 {
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(40) %0) unnamed_addr #7 {
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly align 16 dereferenceable(40) %0) #11
