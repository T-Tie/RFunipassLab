...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 captures(none) dereferenceable(41000) %word) #12
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(41000) %word, i8 noundef 0, i64 noundef 41000, i1 noundef false) #13
...
for.end76:                                        ; preds = %for.cond
  ...
  store i8 0, ptr %newword, align 1, !tbaa !23
  %call92 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %newword) #15
  %3 = and i64 %call92, 4294967295
  %cmp98.le = icmp eq i64 %3, 1
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.end76
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext 0)
