...
if.else8:                                         ; preds = %if.end
  %puts11 = call i32 @puts(ptr nonnull dereferenceable(1) @str.1)
...
if.else16:                                        ; preds = %if.end10
  %puts12 = call i32 @puts(ptr nonnull dereferenceable(1) @str.2)
...
if.else24:                                        ; preds = %if.end18
  %puts13 = call i32 @puts(ptr nonnull dereferenceable(1) @str.3)
