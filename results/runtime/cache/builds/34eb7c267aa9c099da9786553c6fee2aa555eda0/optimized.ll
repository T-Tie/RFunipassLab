...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.cond.cleanup9
  %indvars.iv30 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next31, %for.cond.cleanup9 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.cond7.backedge
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.cond7.backedge ], [ %1, %for.cond3 ]
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, -1
  %cmp8 = icmp sgt i64 %indvars.iv.next27, %indvars.iv30
...
for.body10:                                       ; preds = %for.cond7
  %2 = add nsw i64 %indvars.iv26, -2
  %arrayidx13 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %2
  %3 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %arrayidx15 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %indvars.iv.next27
...
for.cond33:                                       ; preds = %for.cond3, %for.inc50
  %.pre38 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.cond3 ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc50 ], [ 0, %for.cond3 ]
  %cnt.0 = phi i32 [ %cnt.1, %for.inc50 ], [ 0, %for.cond3 ]
  %5 = sext i32 %.pre38 to i64
  %cmp34 = icmp slt i64 %indvars.iv34, %5
  br i1 %cmp34, label %for.body36, label %for.cond.cleanup35

for.cond.cleanup35:                               ; preds = %for.cond33
  %vtable.i18 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !14
...
for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw [500 x i32], ptr %num, i64 0, i64 %indvars.iv34
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %.pre37 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  br label %if.end44

if.end44:                                         ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.then40
  %9 = phi i32 [ %.pre37, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %6, %if.then40 ]
...
for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre38, %for.body36 ]
