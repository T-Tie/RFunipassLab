...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
  %wide.trip.count13 = zext nneg i32 %smax43 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond28.preheader, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv5 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next6, %for.inc22 ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond9.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv5
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv25 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next26, %for.inc63 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count13
  br i1 %exitcond30.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select3, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv25
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select3 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv20 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next21, %for.inc60 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv25
...
for.end65:                                        ; preds = %for.cond28
  ...
  %sum.sink.sroa.speculate.load.if.then67 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 404), align 4, !tbaa !5
  br i1 %cmp66, label %if.then67, label %if.end68

if.then67:                                        ; preds = %for.end65
  %accumulator.ret.tr = add nsw i32 %sum.sink.sroa.speculate.load.if.then67, %accumulator.tr
...
for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc125 ], [ 0, %if.end68 ]
  %exitcond45.not = icmp eq i64 %indvars.iv38, %wide.trip.count13
  br i1 %exitcond45.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %4 = add nsw i64 %indvars.iv38, -1
  %5 = trunc nuw nsw i64 %indvars.iv38 to i32
  br label %for.cond72

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv31 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next32, %for.inc122 ]
  %exitcond37.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond37.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv31, 2
...
lor.lhs.false.thread:                             ; preds = %for.body75
  ...
  switch i32 %6, label %for.inc122.gvnsink.split [
    i32 1, label %for.inc122
    i32 0, label %if.then97
  ]

if.then97:                                        ; preds = %lor.lhs.false.thread
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv31
  %7 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !9
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %4, i64 %indvars.iv31
  store i32 %7, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

for.inc122.gvnsink.split:                         ; preds = %lor.lhs.false.thread, %land.lhs.true
  %indvars.iv38.sink = phi i64 [ %indvars.iv38, %land.lhs.true ], [ %4, %lor.lhs.false.thread ]
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv31
  %8 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
  %9 = add nsw i64 %indvars.iv31, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38.sink, i64 %9
...
for.end127:                                       ; preds = %for.cond69
  %add128 = add nsw i32 %sum.sink.sroa.speculate.load.if.then67, %accumulator.tr
  br label %tailrecurse
}
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  %indvars.iv2 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next3, %for.inc9 ]
  %exitcond6.not = icmp eq i64 %indvars.iv2, %wide.trip.count5
  br i1 %exitcond6.not, label %for.cond12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count5
...
for.cond12:                                       ; preds = %for.cond1, %for.inc26
  ...
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc26 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv10, %2
  br i1 %cmp13, label %for.cond15, label %for.inc32

for.cond15:                                       ; preds = %for.cond12, %for.inc23
  %3 = phi i32 [ %.pre, %for.inc23 ], [ %1, %for.cond12 ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc23 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
  %cmp16 = icmp slt i64 %indvars.iv7, %4
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv7
