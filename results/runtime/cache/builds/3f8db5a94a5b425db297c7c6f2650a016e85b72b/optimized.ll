...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %percent) #4
  call void @llvm.lifetime.start.p0(i64 501, ptr %a) #4
  call void @llvm.lifetime.start.p0(i64 501, ptr %b) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %percent)
