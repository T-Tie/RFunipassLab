...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 dereferenceable(1000) %a) #10
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 dereferenceable(1000) %b) #10
...
if.end75:                                         ; preds = %for.end, %if.else71, %if.then69, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef %b) #12
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef %a) #12
  ret i32 0
}
