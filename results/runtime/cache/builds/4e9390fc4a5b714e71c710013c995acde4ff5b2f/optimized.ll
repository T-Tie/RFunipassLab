...
for.cond13.preheader:                             ; preds = %for.cond
  %smax15 = call i32 @llvm.smax.i32(i32 noundef %m2, i32 noundef 1) #9
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc37
  ...
  %exitcond16.not = icmp eq i32 %1, %smax15
  br i1 %exitcond16.not, label %for.end39, label %for.body15
...
if.then28:                                        ; preds = %for.body15
  ...
  %spec.select13.neg = select i1 %tobool30.not, i32 -3, i32 -2
  %sub34 = add nsw i32 %spec.select13.neg, %add16
  br label %for.inc37
