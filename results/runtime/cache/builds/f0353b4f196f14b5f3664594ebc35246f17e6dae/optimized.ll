...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc74
  %indvars.iv28 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next29, %for.inc74 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %for.inc74 ]
  %4 = phi i32 [ 0, %for.cond2.preheader ], [ %inc71.sink, %for.inc74 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv28
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %5 = add i32 %smax42, 1
  %wide.trip.count43 = zext i32 %5 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond44 = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv38
  ...
  %smax35 = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count36 = zext nneg i32 %smax35 to i64
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv32, %6
  %7 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv38, i64 %indvars.iv32
