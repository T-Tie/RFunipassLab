...
for.inc.gvnsink.split:                            ; preds = %if.else39, %lor.lhs.false34, %land.lhs.true, %if.else, %lor.lhs.false20, %lor.lhs.false22, %lor.lhs.false24, %for.body5, %lor.lhs.false, %lor.lhs.false8, %lor.lhs.false10, %lor.lhs.false12, %lor.lhs.false14, %lor.lhs.false16
  %.sink1.sink = phi i32 [ 31, %lor.lhs.false16 ], [ 31, %lor.lhs.false14 ], [ 31, %lor.lhs.false12 ], [ 31, %lor.lhs.false10 ], [ 31, %lor.lhs.false8 ], [ 31, %lor.lhs.false ], [ 31, %for.body5 ], [ 30, %lor.lhs.false24 ], [ 30, %lor.lhs.false22 ], [ 30, %lor.lhs.false20 ], [ 30, %if.else ], [ 28, %if.else39 ], [ 29, %lor.lhs.false34 ], [ 29, %land.lhs.true ]
  %7 = load i32, ptr %total, align 4, !tbaa !5
  %add40 = add nsw i32 %7, %.sink1.sink
