...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv5 = phi i32 [ %indvars.iv.next6, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax52 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax41 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %1 = add nuw i32 %smax41, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv12 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next13, %for.inc23 ]
  %exitcond16 = icmp eq i64 %indvars.iv12, %wide.trip.count15
  br i1 %exitcond16, label %for.cond26, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv12, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc20 ], [ 1, %for.cond13.preheader ]
  %exitcond11 = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond11, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv12, i64 %indvars.iv7
...
for.cond26:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc57 ], [ 1, %for.cond ]
  %exitcond32 = icmp eq i64 %indvars.iv27, %wide.trip.count15
  br i1 %exitcond32, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select3, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond21 = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv17, i64 %indvars.iv27
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc54 ], [ 1, %for.cond46.preheader ]
  %exitcond26 = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond26, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv27
...
for.end59:                                        ; preds = %for.cond26
  ...
  %wide.trip.count36 = zext i32 %n.tr to i64
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond43 = icmp eq i64 %indvars.iv38, %wide.trip.count15
  br i1 %exitcond43, label %for.cond80.preheader, label %for.cond63
...
for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc74 ], [ 2, %for.cond60 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count36
  br i1 %exitcond37.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv.next34
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv33
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv49 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next50, %for.inc98 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc95 ], [ 2, %for.cond80 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count36
  br i1 %exitcond48.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next45, i64 %indvars.iv49
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv49
