...
if.then7:                                         ; preds = %if.then
  %call8 = call double @sqrt(double noundef %5) #5, !tbaa !9
  %add = fsub double %call8, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call10 = call double @sqrt(double noundef %5) #5, !tbaa !9
...
if.else27:                                        ; preds = %while.body
  ...
  %call32 = call double @sqrt(double noundef %fneg31) #5, !tbaa !9
