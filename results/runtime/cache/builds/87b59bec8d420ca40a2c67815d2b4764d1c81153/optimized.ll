...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv36, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv36, %3
...
for.cond12:                                       ; preds = %for.end25, %for.end9
  ...
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.end25 ], [ 0, %for.end9 ]
  %18 = sext i32 %17 to i64
  %cmp13 = icmp slt i64 %indvars.iv42, %18
  br i1 %cmp13, label %for.cond15.preheader, label %for.end28

for.cond15.preheader:                             ; preds = %for.cond12
  %19 = mul nuw nsw i64 %indvars.iv42, %14
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %vla11, i64 %19
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre78, %for.inc23 ]
  %indvars.iv39 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next40, %for.inc23 ]
  %21 = sext i32 %20 to i64
  %cmp16 = icmp slt i64 %indvars.iv39, %21
  br i1 %cmp16, label %for.inc23, label %for.end25

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %arrayidx19, i64 %indvars.iv39
  %call22 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %arrayidx21)
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %.pre78 = load i32, ptr %y2, align 4, !tbaa !5
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv45
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv66 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next67, %for.inc77 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %wide.trip.count52
  br i1 %exitcond70.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %27 = mul nuw nsw i64 %indvars.iv66, %24
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %27
  %28 = mul nuw nsw i64 %indvars.iv66, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %28
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv61 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next62, %for.inc74 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count
  br i1 %exitcond65.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv61
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv61
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv54 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next55, %for.inc71 ]
  %exitcond60.not = icmp eq i64 %indvars.iv54, %wide.trip.count59
  br i1 %exitcond60.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %29 = load i32, ptr %arrayidx58, align 4, !tbaa !5
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv54
  %30 = load i32, ptr %arrayidx62, align 4, !tbaa !5
  %31 = mul nuw nsw i64 %indvars.iv54, %14
...
for.cond80:                                       ; preds = %for.cond46, %for.end97
  %33 = phi i32 [ %.pre77, %for.end97 ], [ %22, %for.cond46 ]
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.end97 ], [ 0, %for.cond46 ]
  %34 = sext i32 %33 to i64
  %cmp81 = icmp slt i64 %indvars.iv74, %34
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %35 = mul nuw nsw i64 %indvars.iv74, %24
  %arrayidx84 = getelementptr inbounds nuw i32, ptr %vla29, i64 %35
  %36 = load i32, ptr %arrayidx84, align 4, !tbaa !5
  %call86 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %36) #7
  br label %for.cond87

for.cond87:                                       ; preds = %for.body89, %for.body82
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.body89 ], [ 1, %for.body82 ]
  %37 = load i32, ptr %y2, align 4, !tbaa !5
  %38 = sext i32 %37 to i64
  %cmp88 = icmp slt i64 %indvars.iv71, %38
  br i1 %cmp88, label %for.body89, label %for.end97

for.body89:                                       ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx84, i64 %indvars.iv71
  %39 = load i32, ptr %arrayidx93, align 4, !tbaa !5, !invariant.load !18
  %call94 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %39) #7
...
for.end97:                                        ; preds = %for.cond87
  ...
  %.pre77 = load i32, ptr %x1, align 4, !tbaa !5
  br label %for.cond80
