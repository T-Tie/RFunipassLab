...
for.cond14:                                       ; preds = %for.inc, %if.then13
  ...
  %4 = phi i32 [ %inc, %for.inc ], [ %a.1, %if.then13 ]
  %cmp15 = icmp slt i32 %4, %b.1
...
for.inc:                                          ; preds = %sw.bb, %sw.bb17, %sw.default
  %.sink4 = phi i32 [ 29, %sw.bb17 ], [ 31, %sw.bb ], [ 30, %sw.default ]
...
for.cond30:                                       ; preds = %for.inc40, %if.else29
  %x.3 = phi i32 [ 0, %if.else29 ], [ %add36, %for.inc40 ]
  %5 = phi i32 [ %inc41, %for.inc40 ], [ %a.1, %if.else29 ]
  %cmp31 = icmp slt i32 %5, %b.1
  br i1 %cmp31, label %for.body32, label %for.end42

for.body32:                                       ; preds = %for.cond30
  switch i32 %5, label %sw.default37 [
    i32 1, label %sw.bb33
    i32 3, label %sw.bb33
    i32 5, label %sw.bb33
    i32 7, label %sw.bb33
