...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  ...
  br i1 %exitcond31.not, label %for.cond21, label %for.body4
...
for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc15 ], [ %indvars.iv20, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv22
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv39.in = phi i32 [ %indvars.iv39, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv39 = add i32 %indvars.iv39.in, -1
  %indvars.iv.next34 = add nsw i64 %indvars.iv33, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next34
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax41 = call i32 @llvm.smax.i32(i32 %indvars.iv39, i32 0)
  %wide.trip.count42 = zext nneg i32 %smax41 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv36 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next37, %for.inc39 ]
  %exitcond43.not = icmp eq i64 %indvars.iv36, %wide.trip.count42
  br i1 %exitcond43.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv36
...
for.end41:                                        ; preds = %for.cond28
  %arrayidx23.le = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next34
