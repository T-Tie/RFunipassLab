...
entry:
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %conv7, i32 0)
...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  br i1 %exitcond35.not, label %for.end22, label %for.cond8

for.cond8:                                        ; preds = %for.cond, %for.inc
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc ], [ 0, %for.cond ]
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc ], [ %indvars.iv, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond.not, label %if.then24.loopexit, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %arrayidx = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv26
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %arrayidx13 = getelementptr inbounds nuw [50 x i8], ptr %b, i64 0, i64 %indvars.iv28
...
if.then24:                                        ; preds = %if.then24.loopexit, %for.end22
  %.pre-phi = phi i64 [ %.pre, %if.then24.loopexit ], [ %wide.trip.count34, %for.end22 ]
  %i.025 = phi i32 [ %i.0, %if.then24.loopexit ], [ %smax33, %for.end22 ]
  %add = add nsw i32 %i.025, %conv
  %smax43 = call i32 @llvm.smax.i32(i32 %i.025, i32 %add)
  %2 = sub nsw i32 %smax43, %i.025
  %wide.trip.count44 = zext i32 %2 to i64
  br label %for.cond25

for.cond25:                                       ; preds = %for.inc32, %if.then24
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc32 ], [ 0, %if.then24 ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc32 ], [ %.pre-phi, %if.then24 ]
  %exitcond45.not = icmp eq i64 %indvars.iv38, %wide.trip.count44
  br i1 %exitcond45.not, label %if.end36, label %for.inc32

for.inc32:                                        ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [50 x i8], ptr %c, i64 0, i64 %indvars.iv38
  %3 = load i8, ptr %arrayidx29, align 1, !tbaa !5, !invariant.load !8
  %arrayidx31 = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv36
