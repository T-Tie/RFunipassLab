...
for.inc:                                          ; preds = %for.body4, %if.then
  %min.1 = phi i32 [ %3, %if.then ], [ %min.0, %for.body4 ]
  %inc = add nsw i32 %2, 1
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx18 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %idxprom17
...
for.cond31:                                       ; preds = %for.end68, %for.end30
...
for.body33:                                       ; preds = %for.cond31
  ...
  %9 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc51, %for.body33
  %min34.0 = phi i32 [ %9, %for.body33 ], [ %min34.1, %for.inc51 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %11 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %cmp44 = icmp slt i32 %11, %min34.0
...
for.inc51:                                        ; preds = %for.body39, %if.then45
  %min34.1 = phi i32 [ %11, %if.then45 ], [ %min34.0, %for.body39 ]
...
for.cond54:                                       ; preds = %for.body56, %for.end53
  %12 = load i32, ptr %j, align 4, !tbaa !5
  %cmp55 = icmp slt i32 %12, %n
...
for.body56:                                       ; preds = %for.cond54
  ...
  %14 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !9
  %sub61 = sub nsw i32 %14, %min34.0
...
for.cond13:                                       ; preds = %for.end32, %for.end12
  %2 = load i32, ptr %i, align 4, !tbaa !5
  %cmp15 = icmp slt i32 %2, %sub
...
for.cond17:                                       ; preds = %for.inc30, %for.body16
  ...
  br i1 %cmp19, label %for.inc30, label %for.end32
...
for.inc30:                                        ; preds = %for.cond17
  ...
  %3 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !9
...
if.else:                                          ; preds = %entry
  call void @_Z7guilingi(i32 noundef %n) #10
  ...
  %sub = sub nsw i32 %n, 1
  call void @_Z1fi(i32 noundef %sub) #10
  br label %if.end
...
for.end14:                                        ; preds = %for.cond1
  ...
  call void @_Z1fi(i32 noundef %3) #11
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !19, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !21, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !45, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !19, !invariant.load !9
...
for.cond14.exitStub:
  ...
  store i32 %inc26, ptr %0, align 4, !tbaa !5
  ret void
}
