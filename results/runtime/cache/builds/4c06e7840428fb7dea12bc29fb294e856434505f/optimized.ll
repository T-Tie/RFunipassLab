...
for.body:                                         ; preds = %for.cond
  ...
  %3 = load i8, ptr %arrayidx4, align 1, !tbaa !9, !invariant.load !13
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %4 = load i8, ptr %arrayidx8, align 1, !tbaa !9, !invariant.load !13
...
if.then30:                                        ; preds = %for.end28
  ...
  %13 = load i8, ptr %arrayidx32, align 1, !tbaa !9, !invariant.load !13
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef %b) #5
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %str) #5
  ret i32 0
}
