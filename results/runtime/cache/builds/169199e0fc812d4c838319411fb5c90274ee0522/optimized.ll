...
for.cond67:                                       ; preds = %for.inc82, %for.body66
  %9 = phi i32 [ %inc83, %for.inc82 ], [ 0, %for.body66 ]
  %10 = load i32, ptr %y2, align 4, !tbaa !5
  %sub68 = sub nsw i32 %10, 1
  %cmp69 = icmp sle i32 %9, %sub68
...
if.then:                                          ; preds = %for.body70
  ...
  %11 = load i32, ptr %arrayidx73, align 4, !tbaa !5, !invariant.load !15
  %call76 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11) #6
  br label %for.inc82
...
if.else:                                          ; preds = %for.body70
  ...
  %12 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !15
  %call81 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %12) #6
  br label %for.inc82

for.inc82:                                        ; preds = %if.then, %if.else
  %inc83 = add nsw i32 %9, 1
