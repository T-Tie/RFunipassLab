...
for.inc8:                                         ; preds = %for.cond2
  %call5 = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %2, i32 noundef %1) #7
...
for.end21:                                        ; preds = %for.cond11
  %call22 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4) #7
...
for.body4:                                        ; preds = %for.cond2
  ...
  %cmp9 = icmp sle i32 %2, %3
  br i1 %cmp9, label %if.then10, label %for.inc13

if.then10:                                        ; preds = %for.body4
  %call = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %1, i32 noundef %m) #8
...
cleanup:                                          ; preds = %for.end32, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %t) #6
