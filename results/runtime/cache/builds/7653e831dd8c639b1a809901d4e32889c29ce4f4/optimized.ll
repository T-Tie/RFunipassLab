...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %letter) #9
...
if.then9:                                         ; preds = %if.end
  ...
  %5 = load i64, ptr %gep30, align 8, !tbaa !11
...
for.inc:                                          ; preds = %if.end, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end.thread
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #9
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %letter) #9
  ret i32 0
}
...
!35 = !{!36, !7, i64 56}
!36 = !{!"_ZTSSt5ctypeIcE", !37, i64 0, !38, i64 16, !26, i64 24, !39, i64 32, !39, i64 40, !40, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
