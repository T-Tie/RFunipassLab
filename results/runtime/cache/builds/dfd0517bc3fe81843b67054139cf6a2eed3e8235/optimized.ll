...
if.then:                                          ; preds = %for.body87
  ...
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %13)
  br label %for.inc103
...
if.else:                                          ; preds = %for.body87
  ...
  %call102 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %14)
  br label %for.inc103

for.inc103:                                       ; preds = %if.then, %if.else
