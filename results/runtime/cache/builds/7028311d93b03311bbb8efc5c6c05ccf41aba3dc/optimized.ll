...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  %13 = phi i32 [ %inc53, %for.inc52 ], [ 0, %for.end41 ]
  %cmp43 = icmp slt i32 %13, 1000
...
if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %14) #9
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc80, %if.else58
  %16 = phi i32 [ %inc81, %for.inc80 ], [ 0, %if.else58 ]
  %cmp61 = icmp slt i32 %16, 1000
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %16, %19
  %cmp69 = icmp slt i32 %18, %add68
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %20 = load i8, ptr %arrayidx72, align 1, !tbaa !12
  %conv73 = sext i8 %20 to i32
