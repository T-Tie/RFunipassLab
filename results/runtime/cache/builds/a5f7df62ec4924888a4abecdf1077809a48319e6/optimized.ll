...
if.then32:                                        ; preds = %if.else
  ...
  %call38 = call double @sqrt(double noundef %6) #6, !tbaa !5
  ...
  %call61 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %7, double noundef %8)
  br label %for.inc106
...
cond.false:                                       ; preds = %if.else62
  %10 = load double, ptr %arrayidx71, align 8, !tbaa !12, !invariant.load !14
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %.sink2 = phi double [ %10, %cond.false ], [ %fneg87, %cond.true ]
  %.sink = phi double [ %10, %cond.false ], [ %fneg87, %cond.true ]
  %11 = load double, ptr %arrayidx81, align 8, !tbaa !12, !invariant.load !14
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink, double noundef %11, double noundef %.sink2, double noundef %11)
  br label %for.inc106

for.inc106:                                       ; preds = %if.then, %cond.end, %if.then32
