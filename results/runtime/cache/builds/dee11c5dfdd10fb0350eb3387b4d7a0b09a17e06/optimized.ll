...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv25, %2
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv71 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next72, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond76.not = icmp eq i64 %indvars.iv71, %wide.trip.count75
  br i1 %exitcond76.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %wide.trip.count42
  br i1 %exitcond43.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv38
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv28
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp3423 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp3423, i32 %min.0, i32 %8
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  br label %for.cond22, !llvm.loop !13

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv32 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next33, %for.inc57 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond37.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv32
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %wide.trip.count42
  br i1 %exitcond60.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv56
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond49.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv56
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp8222 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp8222, i32 %min.2, i32 %12
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  ...
  br i1 %exitcond55.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv56
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv71, i64 %indvars.iv71
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !19
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count42
  br i1 %exitcond65.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv61, i64 %indvars.iv71
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %wide.trip.count42
  br i1 %exitcond70.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv71, i64 %indvars.iv66
