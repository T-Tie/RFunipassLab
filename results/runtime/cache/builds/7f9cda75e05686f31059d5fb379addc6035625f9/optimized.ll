...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  ...
  %indvars.iv6 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, 2
...
for.cond5:                                        ; preds = %for.body7, %for.body4
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body7 ], [ %indvars.iv6, %for.body4 ]
  %index.0 = phi i32 [ %spec.select, %for.body7 ], [ %2, %for.body4 ]
  %cmp6 = icmp slt i64 %indvars.iv8, %1
  br i1 %cmp6, label %for.body7, label %for.inc24

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv11
