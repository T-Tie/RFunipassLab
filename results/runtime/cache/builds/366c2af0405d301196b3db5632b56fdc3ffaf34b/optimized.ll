...
if.end107:                                        ; preds = %if.else72, %if.then77
  %.sink1 = phi double [ %fneg81, %if.then77 ], [ %11, %if.else72 ]
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink1, double noundef %15, double noundef %.sink1, double noundef %15)
  br label %for.inc110
