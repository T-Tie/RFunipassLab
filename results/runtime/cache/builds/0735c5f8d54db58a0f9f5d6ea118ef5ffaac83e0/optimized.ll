...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc25 ], [ 0, %for.cond14.preheader ]
...
for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv3
...
for.cond31:                                       ; preds = %for.cond, %for.inc69
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc69 ], [ 0, %for.cond ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count11
  br i1 %exitcond27.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv23
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select1, %for.body39 ], [ %3, %for.body33 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond17.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv13, i64 %indvars.iv23
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select1 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc66 ], [ 0, %for.cond54.preheader ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.inc69, label %for.inc66

for.inc66:                                        ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv18, i64 %indvars.iv23
