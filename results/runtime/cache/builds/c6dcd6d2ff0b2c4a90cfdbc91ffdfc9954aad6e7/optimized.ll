...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20000, ptr %word) #6
  call void @llvm.memset.p0.i64(ptr align 16 %word, i8 0, i64 20000, i1 false)
  call void @llvm.lifetime.start.p0(i64 4100, ptr %para) #6
  call void @llvm.memset.p0.i64(ptr align 16 %para, i8 0, i64 4100, i1 false)
...
for.end:                                          ; preds = %for.cond
  %call7 = call ptr @strcat(ptr noundef %para, ptr noundef %word) #6
  br label %for.cond8

for.cond8:                                        ; preds = %for.inc40, %for.end
  %i.1 = phi i32 [ 1, %for.end ], [ %inc41, %for.inc40 ]
  %k.0 = phi i32 [ 0, %for.end ], [ %inc32.sink, %for.inc40 ]
...
if.then:                                          ; preds = %for.body10
  %call24 = call ptr @strcat(ptr noundef %arrayidx12, ptr noundef @.str.2) #6
  br label %for.inc40
...
for.inc40:                                        ; preds = %if.then, %if.else
  %inc32.sink = phi i32 [ %inc32, %if.else ], [ %k.0, %if.then ]
  %idxprom33 = sext i32 %inc32.sink to i64
  %arrayidx34 = getelementptr inbounds [50 x [82 x i8]], ptr %para, i64 0, i64 %idxprom33
  %call39 = call ptr @strcat(ptr noundef %arrayidx34, ptr noundef %arrayidx16) #6
...
for.end52:                                        ; preds = %for.cond43
  call void @llvm.lifetime.end.p0(i64 4100, ptr %para) #6
  call void @llvm.lifetime.end.p0(i64 20000, ptr %word) #6
