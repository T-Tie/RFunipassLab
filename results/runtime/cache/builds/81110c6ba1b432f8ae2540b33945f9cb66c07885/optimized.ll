...
if.end:                                           ; preds = %if.else, %if.then
  %phiofops2 = phi i32 [ %4, %if.else ], [ %2, %if.then ]
  %x1.sink = phi ptr [ %x1, %if.else ], [ %x2, %if.then ]
...
if.end35:                                         ; preds = %if.else34, %if.then33
  %phiofops = phi i32 [ %5, %if.else34 ], [ %6, %if.then33 ]
  %y1.sink = phi ptr [ %y1, %if.else34 ], [ %y2, %if.then33 ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %if.end35
  %i.2 = phi i32 [ 0, %if.end35 ], [ %inc50, %for.inc49 ]
  %cmp37 = icmp slt i32 %i.2, %phiofops2
...
for.cond52:                                       ; preds = %for.inc83, %for.end51
  ...
  %cmp53 = icmp slt i32 %i.3, %phiofops2
...
for.cond86:                                       ; preds = %for.inc91, %for.end85
  ...
  %cmp87 = icmp slt i32 %i.4, %phiofops2
...
for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %phiofops2 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  ...
  %cmp97 = icmp slt i32 %i.5, %phiofops2
...
for.cond118:                                      ; preds = %for.inc198, %for.end117
  ...
  %cmp119 = icmp slt i32 %i.6, %phiofops2
...
if.then124:                                       ; preds = %for.body120
  %cmp125 = icmp eq i32 %phiofops2, 100
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  %sub140 = sub nsw i32 %phiofops, %12
...
if.else151:                                       ; preds = %for.body120
  ...
  %cmp155 = icmp ne i32 %15, %phiofops
...
for.cond158:                                      ; preds = %for.inc170, %if.then156
  ...
  %sub162 = sub nsw i32 %phiofops, %15
...
if.end178:                                        ; preds = %for.cond158, %for.cond137
  %sub179 = sub nsw i32 %phiofops2, 1
...
land.lhs.true181:                                 ; preds = %if.end178
  ...
  %cmp185 = icmp ne i32 %17, %phiofops
...
land.lhs.true190:                                 ; preds = %lor.lhs.false
  ...
  %cmp194 = icmp ne i32 %18, %phiofops
