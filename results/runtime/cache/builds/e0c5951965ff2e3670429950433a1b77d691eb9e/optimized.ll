...
for.cond:                                         ; preds = %if.end47, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end47 ]
...
if.then34:                                        ; preds = %if.end28
  ...
  %call45 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div37, double noundef %div44) #8
  %call46 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div37, double noundef %div44) #8
  br label %if.end47

if.end47:                                         ; preds = %if.then34, %if.end28
