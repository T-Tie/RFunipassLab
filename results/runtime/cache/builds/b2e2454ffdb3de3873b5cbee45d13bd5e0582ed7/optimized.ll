...
for.end20:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %m) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %k) #5
...
for.cond8:                                        ; preds = %for.inc29, %while.end
  %2 = phi i32 [ %dec, %for.inc29 ], [ %sub7, %while.end ]
  %cmp9 = icmp sge i32 %2, 0
...
for.body33:                                       ; preds = %for.cond31
  ...
  %12 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
...
for.end43:                                        ; preds = %for.cond31
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %11) #6
