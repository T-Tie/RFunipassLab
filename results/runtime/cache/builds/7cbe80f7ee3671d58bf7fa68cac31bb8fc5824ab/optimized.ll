...
if.then22:                                        ; preds = %for.end
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1) #6
  br label %if.end24
...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %.sink = phi i32 [ 65, %if.end24 ], [ %inc37, %if.end35 ]
...
if.then31:                                        ; preds = %for.body27
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %.sink, i32 noundef %4) #6
  br label %if.end35
...
for.cond39:                                       ; preds = %if.end49, %for.end38
  %.sink5 = phi i32 [ 97, %for.end38 ], [ %inc51, %if.end49 ]
  store i32 %.sink5, ptr @i, align 4, !tbaa !5
  %cmp40 = icmp sle i32 %.sink5, 122
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %.sink5, i32 noundef %6) #6
  br label %if.end49
