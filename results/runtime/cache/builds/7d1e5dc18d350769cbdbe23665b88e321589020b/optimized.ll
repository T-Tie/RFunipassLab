...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit17: ; preds = %if.else
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i5)
  br label %for.inc41
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit33: ; preds = %if.else
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i21)
  br label %for.inc41
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #3 {
if.then_to_outline:
  ...
  %1 = load i64, ptr %gep47, align 8, !tbaa !20
