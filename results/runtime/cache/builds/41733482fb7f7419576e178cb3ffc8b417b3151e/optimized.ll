...
for.cond:                                         ; preds = %if.else, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %if.else ]
...
land.lhs.true28:                                  ; preds = %land.lhs.true24
  ...
  br i1 %cmp31, label %for.end, label %if.else
...
for.cond56:                                       ; preds = %for.body, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc62, %for.body ]
...
for.body:                                         ; preds = %for.cond56
  ...
  %call60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11) #5
