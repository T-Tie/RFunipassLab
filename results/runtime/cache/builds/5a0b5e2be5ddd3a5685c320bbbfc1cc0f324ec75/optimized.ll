...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %b) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %c) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %d) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %e) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %f) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %sum) #3
  br label %for.cond
...
for.end63:                                        ; preds = %for.cond56
  call void @llvm.lifetime.end.p0(i64 4000, ptr %sum) #4
  call void @llvm.lifetime.end.p0(i64 4000, ptr %f) #4
  call void @llvm.lifetime.end.p0(i64 4000, ptr %e) #4
  call void @llvm.lifetime.end.p0(i64 4000, ptr %d) #4
