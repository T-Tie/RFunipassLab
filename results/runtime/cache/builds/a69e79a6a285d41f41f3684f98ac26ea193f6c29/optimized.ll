...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc51
  %7 = phi i32 [ %5, %for.cond6.preheader ], [ %.pre28, %for.inc51 ]
  %indvars.iv25 = phi i64 [ 1, %for.cond6.preheader ], [ %indvars.iv.next26, %for.inc51 ]
  %8 = sext i32 %7 to i64
  %cmp7 = icmp slt i64 %indvars.iv25, %8
  br i1 %cmp7, label %for.body8, label %for.end53

for.body8:                                        ; preds = %for.cond6
  %9 = load i32, ptr %vla1, align 16, !tbaa !5
  %arrayidx11 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv25
  %10 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !12
  %mul = mul nsw i32 %10, %9
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv25
