...
for.cond14.preheader:                             ; preds = %for.cond11
  %smax26 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  ...
  %10 = icmp slt i64 %indvars.iv47, %sext
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %.pre = add nuw i64 %indvars.iv56, 4294967295
  %.pre94 = and i64 %.pre, 4294967295
  %.pre95 = and i64 %indvars.iv56, 4294967295
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %wide.trip.count75.pre-phi = phi i64 [ %.pre95, %for.end153.split.loop.exit ], [ %wide.trip.count64, %for.cond134 ]
  %wide.trip.count80.pre-phi = phi i64 [ %.pre94, %for.end153.split.loop.exit ], [ %wide.trip.count54, %for.cond134 ]
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  ...
  %exitcond81.not = icmp eq i64 %indvars.iv77, %wide.trip.count80.pre-phi
  br i1 %exitcond81.not, label %for.cond207, label %for.body157
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  ...
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count75.pre-phi
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count75.pre-phi
...
for.inc220:                                       ; preds = %for.cond211
  ...
  %putchar15 = call i32 @putchar(i32 noundef %conv218) #9
