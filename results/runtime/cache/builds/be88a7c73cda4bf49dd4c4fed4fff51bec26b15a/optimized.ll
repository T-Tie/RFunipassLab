...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv6 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next7, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax14 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv6
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond18 = icmp eq i32 %q.0, %4
  br i1 %exitcond18, label %for.cond52.preheader, label %for.cond25

for.cond52.preheader:                             ; preds = %for.cond22
  %7 = sext i32 %t.0 to i64
  %smax23 = call i32 @llvm.smax.i32(i32 %t.0, i32 -1)
  %8 = add i32 %smax23, 1
  %wide.trip.count24 = zext i32 %8 to i64
  br label %for.cond52

for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond16.not = icmp eq i64 %indvars.iv10, %wide.trip.count15
  br i1 %exitcond16.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv10
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next11
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv19 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next20, %for.body54 ]
  %exitcond25 = icmp eq i64 %indvars.iv19, %wide.trip.count24
  br i1 %exitcond25, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv19, %7
  %spec.select4 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %arrayidx62 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv19
  %11 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select4, i32 noundef %11)
