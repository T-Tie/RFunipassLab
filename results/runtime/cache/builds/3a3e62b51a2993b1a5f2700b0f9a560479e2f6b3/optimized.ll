...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  br i1 %exitcond.not, label %for.cond13, label %for.body4
...
for.cond13:                                       ; preds = %for.cond2, %for.body15
  ...
  %Max2.0 = phi i32 [ %Max2.1, %for.body15 ], [ 0, %for.cond2 ]
...
for.end28:                                        ; preds = %for.cond13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call29, i8 noundef signext %call.i17)
  ...
  %call1.i22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call31, i8 noundef signext %call.i)
