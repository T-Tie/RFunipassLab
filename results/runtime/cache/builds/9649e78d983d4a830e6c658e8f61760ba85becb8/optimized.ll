...
for.body:                                         ; preds = %for.cond
  %call2 = call i64 @strlen(ptr noundef readonly captures(none) %a) #6
...
for.body5:                                        ; preds = %for.cond3
  %arrayidx6 = getelementptr inbounds [100 x i8], ptr %a, i64 0, i64 %idxprom31
...
for.inc:                                          ; preds = %for.body5, %if.else
  %sub25.sink = phi i32 [ %sub25, %if.else ], [ %add24, %for.body5 ]
  %c.1 = phi i32 [ 1, %if.else ], [ 0, %for.body5 ]
...
for.end47:                                        ; preds = %for.cond
  %call49 = call i64 @strlen(ptr noundef readonly captures(none) %a) #6
