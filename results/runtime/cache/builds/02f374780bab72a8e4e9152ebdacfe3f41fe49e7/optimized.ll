...
for.cond72:                                       ; preds = %for.inc122, %for.body71
  %.sink15 = phi i32 [ 0, %for.body71 ], [ %inc123, %for.inc122 ]
  store i32 %.sink15, ptr %j, align 4, !tbaa !5
  %cmp74 = icmp slt i32 %.sink15, %t
...
if.else95:                                        ; preds = %lor.lhs.false.thread
  %idxprom8612 = sext i32 %.sink to i64
  %idxprom8813 = sext i32 %.sink15 to i64
  %17 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom8612
  %18 = getelementptr inbounds [100 x i32], ptr %17, i64 0, i64 %idxprom8813
  %19 = load i32, ptr %18, align 4, !tbaa !5
  %cmp96 = icmp eq i32 %.sink15, 0
...
if.then97:                                        ; preds = %if.else95
  ...
  %arrayidx106 = getelementptr inbounds [100 x i32], ptr %arrayidx104, i64 0, i64 %idxprom8813
