...
for.cond:                                         ; preds = %for.end12, %entry
  %k.0 = phi i32 [ 0, %entry ], [ %inc11.i1, %for.end12 ]
...
for.end12:                                        ; preds = %for.cond1
  ...
  %inc11.i1 = add nuw nsw i32 %k.0, 1
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv36
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %indvars.iv31 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next32, %for.body19 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.end26, label %for.body19

for.body19:                                       ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end69
  %indvars.iv51 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next52, %for.end69 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %wide.trip.count39
  br i1 %exitcond56.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv51
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select29, %for.body42 ], [ %3, %for.body34 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv51
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !12
  %spec.select29 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond39

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body61
  %indvars.iv46 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next47, %for.body61 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count44
  br i1 %exitcond50.not, label %for.end69, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv46, i64 %indvars.iv51
