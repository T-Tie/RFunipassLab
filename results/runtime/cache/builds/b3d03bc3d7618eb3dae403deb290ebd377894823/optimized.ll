...
for.cond1:                                        ; preds = %for.inc, %for.body
  %.sink4 = phi i32 [ 30, %for.body ], [ %dec, %for.inc ]
  %cmp2 = icmp sge i32 %.sink4, 0
  br i1 %cmp2, label %for.inc, label %for.inc8

for.inc:                                          ; preds = %for.cond1
  %idxprom = sext i32 %.sink4 to i64
...
land.end:                                         ; preds = %for.cond10
  ...
  %4 = load i8, ptr %arrayidx13, align 1, !tbaa !9, !invariant.load !14
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %.sink3 = phi i32 [ %.sink, %for.end19 ], [ %inc29, %for.inc28 ]
  %cmp21 = icmp slt i32 %.sink3, 31
  %sub31 = sub nsw i32 %.sink3, %.sink
  %idxprom32 = sext i32 %sub31 to i64
  br i1 %cmp21, label %for.inc28, label %for.end30

for.inc28:                                        ; preds = %for.cond20
  %idxprom23 = sext i32 %.sink3 to i64
  %arrayidx24 = getelementptr inbounds [32 x i8], ptr %res, i64 0, i64 %idxprom23
  %5 = load i8, ptr %arrayidx24, align 1, !tbaa !9, !invariant.load !14
  %arrayidx27 = getelementptr inbounds [32 x i8], ptr %res, i64 0, i64 %idxprom32
  store i8 %5, ptr %arrayidx27, align 1, !tbaa !9
  %inc29 = add nsw i32 %.sink3, 1
