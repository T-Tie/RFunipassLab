...
for.cond5:                                        ; preds = %for.inc13, %for.body4
  ...
  %cmp6 = icmp slt i32 %i.1, %.lcssa1
  %idxprom16 = sext i32 %index.0 to i64
  %1 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom16
...
for.inc24:                                        ; preds = %for.cond5
  %idxprom16.lcssa = phi i64 [ %idxprom16, %for.cond5 ]
  %.lcssa = phi i32 [ %2, %for.cond5 ]
  %arrayidx17 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom16.lcssa
  ...
  store i32 %.lcssa, ptr %arrayidx19, align 4, !tbaa !5
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5, i32 noundef %6) #5
