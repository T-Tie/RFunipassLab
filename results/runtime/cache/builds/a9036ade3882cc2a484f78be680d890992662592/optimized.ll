...
if.then15:                                        ; preds = %for.end13
  ...
  call void @_Z2f1Piii(ptr nofree noundef nonnull captures(none) %add.ptr16, i32 noundef %n, i32 noundef %sub17) #4
  br label %if.end18
...
if.then18:                                        ; preds = %for.end16
  ...
  call void @_Z2f2Piii(ptr nofree noundef nonnull captures(none) %add.ptr19, i32 noundef %n, i32 noundef %sub20) #4
  br label %if.end21
