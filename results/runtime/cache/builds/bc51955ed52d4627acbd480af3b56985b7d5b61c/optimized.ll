...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1584, ptr %m) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr %x) #5
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call9 = call double @sqrt(double noundef %4) #5, !tbaa !5
  ...
  %call16 = call double @sqrt(double noundef %4) #5, !tbaa !5
...
for.end112:                                       ; preds = %for.cond49
  ...
  call void @llvm.lifetime.end.p0(i64 792, ptr %x) #5
  call void @llvm.lifetime.end.p0(i64 1584, ptr %m) #5
  ret i32 0
}
