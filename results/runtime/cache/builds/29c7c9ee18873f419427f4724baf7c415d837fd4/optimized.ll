...
for.cond:                                         ; preds = %for.inc, %entry
  %n.promoted5 = phi i32 [ %.pre, %for.inc ], [ %0, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %1 = sext i32 %n.promoted5 to i64
...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  %2 = phi i32 [ %3, %for.inc30 ], [ %n.promoted5, %for.cond ]
...
for.cond6:                                        ; preds = %for.cond3, %for.inc27
  ...
  %cmp7 = icmp slt i64 %indvars.iv13, %4
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv10 = phi i64 [ %4, %for.cond15.preheader ], [ %indvars.iv.next11, %for.inc23 ]
