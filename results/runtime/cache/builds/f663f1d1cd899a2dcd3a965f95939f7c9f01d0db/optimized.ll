...
for.cond17:                                       ; preds = %for.inc25, %for.end
  ...
  %2 = trunc nuw i64 %indvars.iv15 to i32
...
for.inc25:                                        ; preds = %if.end.i, %if.then.i
  ...
  %idxprom21 = and i64 %indvars.iv.next16, 4294967295
...
for.end26:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull captures(none) %b) #7
