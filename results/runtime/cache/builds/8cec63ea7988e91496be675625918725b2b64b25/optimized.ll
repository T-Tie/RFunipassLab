...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #4
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i2) #5
...
if.then:                                          ; preds = %for.body6
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j) #5
  br label %if.end
...
for.inc48:                                        ; preds = %for.cond15
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i2) #5
  br label %for.cond3

for.end50:                                        ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i2) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i51) #5
  store i32 0, ptr %i51, align 4, !tbaa !5
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc66, %for.end50
  %8 = load i32, ptr %i51, align 4, !tbaa !5
  %9 = load i32, ptr %j, align 4, !tbaa !5
  %cmp53 = icmp slt i32 %8, %9
  br i1 %cmp53, label %for.body55, label %for.end68

for.body55:                                       ; preds = %for.cond52
  %sub56 = sub nsw i32 %9, 1
  %cmp57 = icmp slt i32 %8, %sub56
...
if.then58:                                        ; preds = %for.body55
  ...
  %call61 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %10, i32 noundef 44)
  br label %for.inc66
...
if.else:                                          ; preds = %for.body55
  ...
  %call64 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %11)
  br label %for.inc66

for.inc66:                                        ; preds = %if.then58, %if.else
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i51) #5
  br label %for.cond52

for.end68:                                        ; preds = %for.cond52
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i51) #5
