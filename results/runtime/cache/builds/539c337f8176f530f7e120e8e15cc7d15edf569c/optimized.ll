...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  ...
  %n.promoted9 = phi i32 [ %n.promoted8, %for.inc30 ], [ %1, %for.cond ]
...
for.cond6:                                        ; preds = %for.cond3, %for.inc27
  ...
  %cmp7 = icmp slt i64 %indvars.iv14, %5
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv11 = phi i64 [ %5, %for.cond15.preheader ], [ %indvars.iv.next12, %for.inc23 ]
