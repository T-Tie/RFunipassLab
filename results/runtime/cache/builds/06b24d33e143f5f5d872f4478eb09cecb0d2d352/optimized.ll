...
for.body3:                                        ; preds = %for.cond1
  ...
  %rem7 = urem i32 %spec.select, 7
  %cmp9 = icmp eq i32 %rem7, 0
  br i1 %cmp9, label %if.then10, label %for.inc14

if.then10:                                        ; preds = %for.body3
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv10
...
for.cond17:                                       ; preds = %for.cond1, %for.body19
  %6 = phi i32 [ %.pre16, %for.body19 ], [ %1, %for.cond1 ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body19 ], [ 0, %for.cond1 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv13, %7
  br i1 %cmp18, label %for.body19, label %for.end29

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv13
  %8 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %cmp22 = icmp eq i32 %8, 1
  %str.1.str = select i1 %cmp22, ptr @str.1, ptr @str
  %puts8 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
...
if.then24:                                        ; preds = %for.body
  %add34 = add nsw i32 %spec.select6, %result.0
  br label %for.inc
