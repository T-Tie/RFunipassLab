...
for.cond14:                                       ; preds = %for.body, %for.inc
  ...
  %exitcond13.not = icmp eq i32 %5, %smax12
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %6, %smax12
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  %.sink14 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add34 = add nuw nsw i32 %x.3, %.sink14
  %inc41 = add i32 %6, 1
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.115 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call46 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str..str.115)
