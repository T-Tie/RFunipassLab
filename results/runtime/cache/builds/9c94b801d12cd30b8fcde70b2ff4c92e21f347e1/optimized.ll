...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %js) #4
...
for.cond3:                                        ; preds = %for.cond3.preheader, %if.end32
  %indvars.iv37 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next38, %if.end32 ]
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv37
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv34 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next35, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv34, %3
  br i1 %cmp8.not, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv34
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv42 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next43, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv42
  %10 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !9
  %11 = and i32 %10, 1
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  ...
  br i1 %exitcond58.not, label %if.end80, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv52
  %12 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !9
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv47 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next48, %for.inc73 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count50
  br i1 %exitcond51.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv47
...
for.end75:                                        ; preds = %for.cond66
  ...
  %14 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !9
