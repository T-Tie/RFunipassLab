...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %s_all) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %s_good) #8
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %all) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %good) #8
  br label %for.cond
...
if.then15:                                        ; preds = %if.else
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i)
...
if.else18:                                        ; preds = %if.else
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i11)
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %good) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %all) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_good) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_all) #8
