...
for.end76:                                        ; preds = %for.cond2
  %k.0.lcssa = phi i32 [ %k.0, %for.cond2 ]
  %j.0.lcssa = phi i32 [ %j.0, %for.cond2 ]
  %idxprom77 = sext i32 %k.0.lcssa to i64
  %arrayidx78 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom77
  %sub79 = sub nsw i32 %j.0.lcssa, 1
  ...
  %idxprom84 = sext i32 %j.0.lcssa to i64
...
for.cond86:                                       ; preds = %for.inc116, %for.end76
  ...
  %cmp87 = icmp sle i32 %i.2, %k.0.lcssa
