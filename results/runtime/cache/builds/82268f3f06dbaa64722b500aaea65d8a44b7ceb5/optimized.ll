...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc86
  ...
  br i1 %exitcond73.not, label %for.cond89.preheader, label %for.cond51.preheader

for.cond89.preheader:                             ; preds = %for.cond48
  br label %for.cond89
...
for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc110
  %.pre8081 = phi i32 [ %.pre8082, %for.inc110 ], [ %2, %for.cond89.preheader ]
  %11 = phi i32 [ %.pre, %for.inc110 ], [ %0, %for.cond89.preheader ]
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc110 ], [ 0, %for.cond89.preheader ]
  %i.0 = phi i32 [ %i.1, %for.inc110 ], [ 0, %for.cond89.preheader ]
