...
for.cond3:                                        ; preds = %for.body, %for.inc
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc ], [ %indvars.iv, %for.body ]
  %3 = trunc nuw i64 %indvars.iv12 to i32
  %cmp4 = icmp sgt i32 %pre.0, %3
  br i1 %cmp4, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv12
