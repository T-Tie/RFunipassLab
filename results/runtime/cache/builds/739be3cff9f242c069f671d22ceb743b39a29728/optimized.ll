...
for.body70:                                       ; preds = %for.cond67
  ...
  %17 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv30, i64 %indvars.iv27
  %18 = load i32, ptr %17, align 4, !tbaa !5, !invariant.load !15
  %.str.1..str.2 = select i1 %cmp71, ptr @.str.1, ptr @.str.2
  %call76 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.1..str.2, i32 noundef %18)
