...
if.then12:                                        ; preds = %if.else
  ...
  %gep40 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i8
  %5 = load i64, ptr %gep40, align 8, !tbaa !12, !invariant.load !11
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #9
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull %s, i64 noundef %call.i.i13)
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #10
  %add20 = add i64 %call17, %add
  br label %for.inc

if.else22:                                        ; preds = %if.else
  %vtable.i30 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i31 = getelementptr i8, ptr %vtable.i30, i64 -24
  %vbase.offset.i32 = load i64, ptr %vbase.offset.ptr.i31, align 8, !invariant.load !11
...
for.inc.gvnsink.split:                            ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %if.else22
  ...
  %call.i.i22 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #9
  %call1.i23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i36.sink, ptr noundef nonnull %s, i64 noundef %call.i.i22)
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !32, !invariant.load !11
