...
NodeBlock:                                        ; preds = %for.inc
  %Pivot = icmp slt i64 %2, 0
  br i1 %Pivot, label %LeafBlock, label %LeafBlock20

LeafBlock20:                                      ; preds = %NodeBlock
  %SwitchLeaf21 = icmp eq i64 %2, 0
  br i1 %SwitchLeaf21, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i64 %2, -1
  br i1 %SwitchLeaf, label %if.else34.i, label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock20
...
if.then6.i:                                       ; preds = %LeafBlock20, %LeafBlock
...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  %6 = phi i32 [ %.pre, %for.inc47 ], [ %0, %for.cond2 ]
...
if.end:                                           ; preds = %for.body19
  ...
  br i1 %9, label %if.end35.thread, label %if.end35
