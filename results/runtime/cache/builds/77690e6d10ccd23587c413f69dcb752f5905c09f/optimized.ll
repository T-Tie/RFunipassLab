...
if.then:                                          ; preds = %for.body
  ...
  %.pre3 = load double, ptr %a, align 8, !tbaa !9
  %.pre4 = load double, ptr %c, align 8, !tbaa !9
  %.pre8 = fmul double %.pre3, 4.000000e+00
  %.pre9 = fneg double %.pre4
  %.pre10 = fmul double %.pre8, %.pre9
  %.pre11 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre10)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi12 = phi double [ %.pre11, %if.then ], [ %5, %for.body ]
  %mul24.pre-phi = phi double [ %.pre8, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre4, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre3, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi12, 0.000000e+00
...
if.then28:                                        ; preds = %if.end
  ...
  %.pre5 = load double, ptr %b, align 8, !tbaa !9
  %.pre6 = load double, ptr %a, align 8, !tbaa !9
  %.pre7 = load double, ptr %c, align 8, !tbaa !9
  %.pre13 = fmul double %.pre6, 4.000000e+00
  %.pre14 = fneg double %.pre7
  %.pre16 = fmul double %.pre13, %.pre14
  %.pre17 = call double @llvm.fmuladd.f64(double %.pre5, double %.pre5, double %.pre16)
  br label %if.end34

if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi18 = phi double [ %.pre17, %if.then28 ], [ %.pre-phi12, %if.end ]
  %mul36.pre-phi = phi double [ %.pre13, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre7, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre6, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre5, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi18, 0.000000e+00
