...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %efficient) #4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 8 dereferenceable(8) %efficient)
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %efficient) #4
