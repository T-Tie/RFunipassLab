...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv13 = phi i32 [ %indvars.iv.next14, %while.cond ], [ -1, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.cond ], [ 0, %entry ]
  %phiofops2 = phi i64 [ %indvars.iv, %while.cond ], [ -1, %entry ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv5
  %0 = load i8, ptr %arrayidx5, align 1, !tbaa !12
  %cmp6 = icmp eq i8 %0, 0
  br i1 %cmp6, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %1 = add nsw i64 %indvars.iv5, -1
  %arrayidx12 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  ...
  %exitcond15.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond15.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %2 = sub nsw i64 %idxprom2, %indvars.iv9
  %arrayidx21 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %2
