...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv24, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond36.not, label %for.end33, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv31 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv27 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next28, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv31, i64 %indvars.iv27
...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc53 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.inc53 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.inc53 ], [ 0, %for.end33 ]
  %exitcond49.not = icmp eq i64 %indvars.iv43, %wide.trip.count35
  br i1 %exitcond49.not, label %for.end55, label %for.cond37.preheader
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv37 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next38, %for.body39 ]
  ...
  br i1 %exitcond42.not, label %for.inc53, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv43, i64 %indvars.iv37
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv43, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv37, %11
  %or.cond22 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond22, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv37 to i32
  %d.2 = select i1 %or.cond22, i32 %12, i32 %d.1
