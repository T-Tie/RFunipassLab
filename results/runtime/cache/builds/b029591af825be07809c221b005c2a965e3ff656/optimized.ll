...
for.inc20:                                        ; preds = %for.cond13
  ...
  %1 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !14
...
for.body31:                                       ; preds = %for.cond29
  ...
  %2 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !14
...
for.inc54:                                        ; preds = %for.cond46
  ...
  %3 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !14
...
for.inc74:                                        ; preds = %for.cond63
  ...
  %5 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !14
...
for.inc95:                                        ; preds = %for.cond83
  ...
  %6 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !14
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !25, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !45, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !51, !invariant.load !14
  br label %return
