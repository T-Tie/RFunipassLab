...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %for.inc18 ], [ 0, %entry ]
...
for.cond21.preheader:                             ; preds = %for.cond
  %wide.trip.count14 = zext i32 %indvars.iv12 to i64
  br label %for.cond21
...
for.inc18:                                        ; preds = %for.cond6
  ...
  %indvars.iv.next13 = add nuw i32 %indvars.iv12, 1
  br label %for.cond, !llvm.loop !14

for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv9 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next10, %for.inc26 ]
  %exitcond15.not = icmp eq i64 %indvars.iv9, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond29, label %for.inc26

for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv9
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  br label %for.cond21, !llvm.loop !15

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond27.not = icmp eq i64 %indvars.iv16, %wide.trip.count14
  br i1 %exitcond27.not, label %for.cond57, label %for.cond32.preheader
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  ...
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count14
  br i1 %exitcond23.not, label %for.inc54, label %for.body34
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count14
  br i1 %exitcond33.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv28
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc89 ], [ 0, %if.else ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count14
  br i1 %exitcond39.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv34
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv34
