...
NodeBlock11:                                      ; preds = %NodeBlock13
  ...
  br i1 %Pivot12, label %sw.bb19, label %NodeBlock9
...
NodeBlock9:                                       ; preds = %NodeBlock11
  ...
  br i1 %Pivot10, label %sw.bb12, label %sw.bb
...
NodeBlock7:                                       ; preds = %NodeBlock13
  ...
  %spec.select = zext i1 %Pivot8 to i32
...
sw.epilog.sink.split:                             ; preds = %NodeBlock7, %sw.bb, %sw.bb12, %sw.bb19, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  %.sink = phi i32 [ 0, %sw.bb ], [ 1, %sw.bb12 ], [ 0, %sw.bb19 ], [ 0, %sw.bb40 ], [ 1, %sw.bb47 ], [ 0, %sw.bb54 ], [ 0, %sw.bb68 ], [ 1, %sw.bb61 ], [ %spec.select, %NodeBlock7 ]
  %call9.sink = phi ptr [ %call9, %sw.bb ], [ %call16, %sw.bb12 ], [ %call23, %sw.bb19 ], [ %call44, %sw.bb40 ], [ %call51, %sw.bb47 ], [ %call58, %sw.bb54 ], [ %call72, %sw.bb68 ], [ %call65, %sw.bb61 ], [ %call37, %NodeBlock7 ]
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call9.sink, i32 noundef %.sink)
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %sw.epilog
