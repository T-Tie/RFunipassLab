...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 %f1, i8 noundef 0, i64 noundef 676, i1 noundef false) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 %f2, i8 noundef 0, i64 noundef 676, i1 noundef false) #7
  br label %for.cond
...
for.cond2:                                        ; preds = %for.inc14, %for.body
  %i.sink1 = phi ptr [ %i, %for.body ], [ %j, %for.inc14 ]
  %0 = load i32, ptr %i.sink1, align 4, !tbaa !5
  %add = add nsw i32 %0, 1
...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  %.sink6 = phi i32 [ 1, %for.end19 ], [ %inc28, %for.inc27 ]
  store i32 %.sink6, ptr %i, align 4, !tbaa !5
  %cmp21 = icmp sle i32 %.sink6, 12
  br i1 %cmp21, label %for.inc27, label %for.end29

for.inc27:                                        ; preds = %for.cond20
  %idxprom23 = sext i32 %.sink6 to i64
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %.sink7 = phi i32 [ 1, %for.end29 ], [ %inc49, %for.inc48 ]
  store i32 %.sink7, ptr %i, align 4, !tbaa !5
  %cmp31 = icmp sle i32 %.sink7, 12
...
for.inc45:                                        ; preds = %for.cond33
  ...
  %idxprom39 = sext i32 %.sink7 to i64
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %.sink8 = phi i32 [ 1, %for.end50 ], [ %inc80, %for.inc79 ]
  store i32 %.sink8, ptr %i, align 4, !tbaa !5
  %cmp52 = icmp sle i32 %.sink8, 12
...
for.cond55:                                       ; preds = %for.inc76, %for.body53
  %i.sink = phi ptr [ %i, %for.body53 ], [ %j, %for.inc76 ]
  %4 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add54 = add nsw i32 %4, 1
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  %k.1 = phi i32 [ %.sink8, %for.body57 ], [ %inc66, %for.inc65 ]
  %sum.1 = phi i32 [ 0, %for.body57 ], [ %add64, %for.inc65 ]
  %cmp60 = icmp sle i32 %k.1, %4
...
if.then70:                                        ; preds = %for.end67
  %idxprom71 = sext i32 %.sink8 to i64
...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %.sink9 = phi i32 [ 1, %for.end81 ], [ %inc90, %for.inc89 ]
  store i32 %.sink9, ptr %i, align 4, !tbaa !5
  %cmp83 = icmp sle i32 %.sink9, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %idxprom85 = sext i32 %.sink9 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %.sink10 = phi i32 [ 1, %for.end91 ], [ %inc111, %for.inc110 ]
  store i32 %.sink10, ptr %i, align 4, !tbaa !5
  %cmp93 = icmp sle i32 %.sink10, 12
...
for.body115:                                      ; preds = %for.cond113
  ...
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %10) #8
  %cmp118 = icmp eq i32 %call117, 1
  %11 = load i32, ptr %mon1, align 4, !tbaa !5
  %12 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom120 = sext i32 %11 to i64
  %idxprom122 = sext i32 %12 to i64
  br i1 %cmp118, label %for.inc141, label %if.else129

if.else129:                                       ; preds = %for.body115
  br label %for.inc141

for.inc141:                                       ; preds = %for.body115, %if.else129
  %f1.sink = phi ptr [ %f1, %if.else129 ], [ %f2, %for.body115 ]
  %arrayidx131 = getelementptr inbounds [13 x [13 x i32]], ptr %f1.sink, i64 0, i64 %idxprom120
  %arrayidx133 = getelementptr inbounds [13 x i32], ptr %arrayidx131, i64 0, i64 %idxprom122
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %arrayidx133)
  %inc142 = add nsw i32 %8, 1
