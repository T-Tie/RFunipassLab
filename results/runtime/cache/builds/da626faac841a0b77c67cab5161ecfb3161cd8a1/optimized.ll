...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %s) #11
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %rep) #11
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %sub) #11
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(300) %s)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) %call, ptr noundef nonnull align 16 dereferenceable(300) %sub)
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) %call2, ptr noundef nonnull align 16 dereferenceable(300) %rep)
  %call7 = call noundef ptr @strstr(ptr noundef nonnull align 16 dereferenceable(300) %s, ptr noundef %sub) #12
  %tobool = icmp ne ptr %call7, null
  br i1 %tobool, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  store i8 0, ptr %call7, align 1, !tbaa !5
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(300) %s)
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call12, ptr noundef nonnull align 16 dereferenceable(300) %rep)
  %call16 = call i64 @strlen(ptr noundef %sub) #12
...
if.else:                                          ; preds = %entry
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(300) %s)
...
if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef captures(none) %sub) #13
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef captures(none) %rep) #13
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef captures(none) %s) #13
  ret i32 0
}
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !8
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !8
  %vbase.offset.ptr2 = getelementptr i8, ptr %vtable1, i64 -24
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !10
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !8
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !8
  %vbase.offset.ptr13 = getelementptr i8, ptr %vtable12, i64 -24
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !10
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !8
  %vbase.offset.ptr21 = getelementptr i8, ptr %vtable20, i64 -24
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !10
  ...
  store i32 %call25, ptr %__c, align 4, !tbaa !11
  ...
  store i32 %call26, ptr %ref.tmp, align 4, !tbaa !11
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !8
  %vbase.offset.ptr30 = getelementptr i8, ptr %vtable29, i64 -24
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !10
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !13
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !24
  ret ptr %0
}
...
if.then:                                          ; preds = %entry
  ...
  store i32 %call4, ptr %__ret, align 4, !tbaa !11
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  store i32 %call5, ptr %__ret, align 4, !tbaa !11
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %1 = load i32, ptr %__ret, align 4, !tbaa !11
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !11
  %1 = load i32, ptr %__c2, align 4, !tbaa !11
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !33
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !36
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !5
...
; Function Attrs: inlinehint mustprogress uwtable
define available_externally noundef nonnull align 8 dereferenceable(8) ptr @_ZSt5flushIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(ptr noundef nonnull align 8 dereferenceable(8) %__os) local_unnamed_addr #2 {
entry:
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr dso_local noundef nonnull align 8 dereferenceable(570) ptr @_ZSt13__check_facetISt5ctypeIcEERKT_PS3_(ptr noundef %__f) local_unnamed_addr #2 comdat {
entry:
...
!12 = !{!"int", !6, i64 0}
!13 = !{!14, !15, i64 16}
!14 = !{!"_ZTSSt8ios_base", !15, i64 8, !15, i64 16, !16, i64 24, !17, i64 28, !17, i64 32, !18, i64 40, !20, i64 48, !6, i64 64, !12, i64 192, !21, i64 200, !22, i64 208}
!15 = !{!"long", !6, i64 0}
...
!24 = !{!25, !28, i64 232}
!25 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !14, i64 0, !26, i64 216, !6, i64 224, !27, i64 225, !28, i64 232, !29, i64 240, !30, i64 248, !31, i64 256}
...
!37 = !{!25, !29, i64 240}
!38 = !{!39, !6, i64 56}
!39 = !{!"_ZTSSt5ctypeIcE", !40, i64 0, !41, i64 16, !27, i64 24, !42, i64 32, !42, i64 40, !43, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
