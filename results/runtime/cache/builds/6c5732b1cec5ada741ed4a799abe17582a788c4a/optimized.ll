...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %a) #8
...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  %call3 = call noundef float @_ZSt4sqrtf(float noundef nofpclass(nan inf nzero sub) %conv) #9
  %conv4 = fptosi float %call3 to i32
  %cmp5 = icmp sle i32 %2, %conv4
...
if.then:                                          ; preds = %for.body6
  ...
  %div = sdiv i32 %4, %2
  call void @_Z1fii(i32 noundef %div, i32 noundef %2) #9
  %5 = load i32, ptr @sum, align 4, !tbaa !5
  %6 = load i32, ptr @res, align 4, !tbaa !5
  %add = add nsw i32 %6, %5
...
for.inc10:                                        ; preds = %for.cond2
  %7 = load i32, ptr @res, align 4, !tbaa !5
...
entry:
  %call = call float @sqrtf(float noundef %__x) #10, !tbaa !5
  ret float %call
}
...
if.then3:                                         ; preds = %while.body
  %div = sdiv i32 %x, %1
  call void @_Z1fii(i32 noundef %div, i32 noundef %1) #11
  br label %if.end4

if.end4:                                          ; preds = %if.then3, %while.body
  %inc5 = add nsw i32 %1, 1
  store i32 %inc5, ptr %y.addr, align 4, !tbaa !5
