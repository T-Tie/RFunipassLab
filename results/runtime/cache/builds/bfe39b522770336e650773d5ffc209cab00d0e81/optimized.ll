...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.end114 ], [ %2, %entry ]
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %3 = trunc nuw i64 %indvars.iv100 to i32
  %smax97 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv102, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv102 to i32
  %smax81 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count60 = zext nneg i32 %smax81 to i64
  %wide.trip.count = and i64 %indvars.iv102, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv57 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next58, %for.inc28 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond31.preheader, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv57, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv52 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next53, %for.inc25 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv57, i64 %indvars.iv52
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv72 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next73, %for.inc66 ]
  %exitcond77.not = icmp eq i64 %indvars.iv72, %wide.trip.count60
  br i1 %exitcond77.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select50, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv62, i64 %indvars.iv72
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !9
  %spec.select50 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  br label %for.cond34, !llvm.loop !15

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv67 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next68, %for.inc63 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count
  br i1 %exitcond71.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv67, i64 %indvars.iv72
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc89 ], [ 1, %for.end68 ]
  %cmp73 = icmp slt i64 %indvars.iv84, %indvars.iv.next103
  br i1 %cmp73, label %for.cond75, label %for.cond92.preheader

for.cond92.preheader:                             ; preds = %for.cond71
  %wide.trip.count98 = zext nneg i32 %smax97 to i64
  br label %for.cond92

for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond83.not = icmp eq i64 %indvars.iv78, %wide.trip.count60
  br i1 %exitcond83.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv84, i64 %indvars.iv78
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !9
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv84, i64 %indvars.iv78
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv94 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next95, %for.inc112 ]
  %exitcond99.not = icmp eq i64 %indvars.iv94, %wide.trip.count98
  br i1 %exitcond99.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond93.not = icmp eq i64 %indvars.iv87, %indvars.iv100
  br i1 %exitcond93.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next88 = add nuw nsw i64 %indvars.iv87, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv94, i64 %indvars.iv.next88
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !9
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv94, i64 %indvars.iv87
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [120 x [120 x i32]], ptr %a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
