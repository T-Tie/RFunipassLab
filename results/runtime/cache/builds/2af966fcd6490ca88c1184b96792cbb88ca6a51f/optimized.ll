...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv21 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next22, %if.end ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %if.end ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.end43
  %indvars.iv28 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next29, %for.end43 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.end43 ]
  %exitcond34.not = icmp eq i32 %m.0, %smax33
  br i1 %exitcond34.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax30 = call i32 @llvm.smax.i32(i32 %indvars.iv28, i32 noundef 0)
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count38 = zext nneg i32 %smax33 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %if.end40
  %indvars.iv25 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next26, %if.end40 ]
  %exitcond32.not = icmp eq i64 %indvars.iv25, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end43, label %for.body23
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.body50
  %indvars.iv35 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next36, %for.body50 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count38
  br i1 %exitcond39.not, label %for.end57, label %for.body50

for.body50:                                       ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv35
