...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %LEN) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %sz) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %js) #4
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv11 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next12, %for.inc33 ]
  %exitcond = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond, label %for.cond36.preheader, label %for.cond7.preheader
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv11
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv8 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next9, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv8, %3
  br i1 %cmp8.not, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv8
  ...
  %6 = trunc nuw nsw i64 %indvars.iv8 to i32
  %spec.select = select i1 %cmp15, i32 %6, i32 %maxIndex.0
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  br label %for.cond7, !llvm.loop !13

for.end18:                                        ; preds = %for.cond7
  %7 = trunc nsw i64 %3 to i32
...
if.then21:                                        ; preds = %for.end18
  ...
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %sz, i64 0, i64 %3
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv16 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next17, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv16
  %10 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !12
  %11 = and i32 %10, 1
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax30 = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count24 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc60
  %indvars.iv26 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next27, %for.inc60 ]
  %exitcond32.not = icmp eq i64 %indvars.iv26, %wide.trip.count31
  br i1 %exitcond32.not, label %if.end80, label %for.inc60

for.inc60:                                        ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv26
  %12 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !12
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12)
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond54, !llvm.loop !16

for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv21 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next22, %for.inc73 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv21
  %13 = load i32, ptr %arrayidx71, align 4, !tbaa !5, !invariant.load !12
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %13)
...
for.end75:                                        ; preds = %for.cond66
  ...
  %14 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !12
  %call79 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %14)
  br label %if.end80

if.end80:                                         ; preds = %for.cond54, %for.end75
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %js) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %sz) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %LEN) #5
  ret i32 0
}
