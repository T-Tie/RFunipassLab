...
for.cond:                                         ; preds = %for.end, %entry
  ...
  br i1 %cmp, label %for.body, label %for.cond17.preheader
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv23
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
  br label %for.cond2

for.cond2:                                        ; preds = %for.inc, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv23
...
for.end:                                          ; preds = %for.body4, %for.cond2
  %j.0.lcssa.in = phi i64 [ %indvars.iv, %for.body4 ], [ %indvars.iv23, %for.cond2 ]
  %4 = and i64 %j.0.lcssa.in, 4294967295
  %cmp10 = icmp eq i64 %indvars.iv23, %4
  %inc12 = zext i1 %cmp10 to i32
  %spec.select = add nuw nsw i32 %inc12, %counter.0
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond, !llvm.loop !13

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc43
  %5 = phi i32 [ %0, %for.cond17.preheader ], [ %.pre, %for.inc43 ]
  %indvars.iv30 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next31, %for.inc43 ]
  %counter.2 = phi i32 [ %counter.0, %for.cond17.preheader ], [ %counter.3, %for.inc43 ]
  %6 = sext i32 %5 to i64
...
for.cond20.preheader:                             ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv30
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc30
  %indvars.iv26 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next27, %for.inc30 ]
  %exitcond29.not = icmp eq i64 %indvars.iv26, %indvars.iv30
  br i1 %exitcond29.not, label %for.end32, label %for.body22

for.body22:                                       ; preds = %for.cond20
  %7 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %arrayidx26 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv26
  %8 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
...
for.end32:                                        ; preds = %for.body22, %for.cond20
  %j.1.lcssa.in = phi i64 [ %indvars.iv26, %for.body22 ], [ %indvars.iv30, %for.cond20 ]
  %9 = and i64 %j.1.lcssa.in, 4294967295
  %cmp33 = icmp eq i64 %indvars.iv30, %9
  br i1 %cmp33, label %if.then34, label %for.inc43

if.then34:                                        ; preds = %for.end32
  %10 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %10)
...
if.then39:                                        ; preds = %if.then34
  ...
  %11 = load i64, ptr %gep, align 8, !tbaa !16, !invariant.load !9
...
for.inc43:                                        ; preds = %for.end32, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.then34
  %counter.3 = phi i32 [ %counter.2, %for.end32 ], [ %dec, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %if.then34 ]
