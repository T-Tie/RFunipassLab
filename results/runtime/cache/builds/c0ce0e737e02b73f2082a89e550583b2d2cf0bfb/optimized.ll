...
if.then8:                                         ; preds = %if.end
  %fneg9 = fneg double %2
  %call13.i = tail call double @sqrt(double noundef %6) #8, !tbaa !5, !noalias !11
  %add = fsub double %call13.i, %2
  %mul = fmul double %3, 2.000000e+00
  %div = fdiv double %add, %mul
  store double %div, ptr @x, align 16, !tbaa !9
  %call13.i3 = tail call double @sqrt(double noundef %6) #8, !tbaa !5, !noalias !14
...
if.then39:                                        ; preds = %if.end37
  ...
  %call50.i = tail call double @sqrt(double noundef %19) #8, !tbaa !5, !noalias !17
  ...
  %26 = tail call double @llvm.fmuladd.f64(double %mul46.i4, double %23, double %neg49.i5) #9
  %call50.i6 = tail call double @sqrt(double noundef %26) #8, !tbaa !5, !noalias !20
