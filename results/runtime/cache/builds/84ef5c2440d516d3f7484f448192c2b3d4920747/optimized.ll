...
for.cond31:                                       ; preds = %for.inc52, %for.end30
  ...
  %3 = phi i32 [ %dec, %for.inc52 ], [ %sub, %for.end30 ]
  %cmp32 = icmp sge i32 %3, 0
...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  ...
  %4 = phi i32 [ %sub49, %for.inc48 ], [ %sub, %if.then35 ]
  %cmp38 = icmp sge i32 %4, 0
...
for.body39:                                       ; preds = %for.cond37
  ...
  %5 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
...
for.inc48:                                        ; preds = %for.body39, %if.then45
  %b2.2 = phi i32 [ %4, %if.then45 ], [ %b2.1, %for.body39 ]
  %a2.2 = phi i32 [ %3, %if.then45 ], [ %a2.1, %for.body39 ]
  %p.6 = phi i32 [ %add46, %if.then45 ], [ %p.5, %for.body39 ]
  %sub49 = sub nsw i32 %4, 1
