...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1280, ptr nonnull %part) #5
  br label %for.cond
...
for.body37:                                       ; preds = %for.cond32
  ...
  %or.cond = and i1 %cmp46, %cmp55
  br i1 %or.cond, label %if.then56, label %for.inc61

if.then56:                                        ; preds = %for.body37
  %6 = load i32, ptr %arrayidx58, align 4, !tbaa !5
  %inc59 = add nsw i32 %6, 1
  store i32 %inc59, ptr %arrayidx58, align 4, !tbaa !5
  br label %for.inc61

for.inc61:                                        ; preds = %for.body37, %if.then56
...
for.cond70:                                       ; preds = %for.cond24, %for.body72
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body72 ], [ 0, %for.cond24 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count48
  br i1 %exitcond54.not, label %for.end79, label %for.body72
...
for.body72:                                       ; preds = %for.cond70
  ...
  %vtable.i = load ptr, ptr %call75, align 8, !tbaa !16
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call75, i8 noundef signext %call.i30)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br label %for.cond70, !llvm.loop !18

for.end79:                                        ; preds = %for.cond70
  call void @llvm.lifetime.end.p0(i64 1280, ptr nonnull %part) #5
  ret i32 0
}
