...
for.cond:                                         ; preds = %for.inc35, %entry
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc35 ], [ 0, %entry ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, 1000
  br i1 %exitcond28.not, label %for.end37, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv23, i64 %indvars.iv
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv23
...
for.end37:                                        ; preds = %land.lhs.true29, %for.cond
  %wide.trip.count = and i64 %indvars.iv23, 4294967295
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond32.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond32.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv29
  ...
  %reass.add36 = add i32 %9, %neg35
  %reass.mul37 = mul i32 %reass.add36, 3600
  %12 = add i32 %.neg34, 43200
  %13 = add i32 %12, %11
  %14 = add i32 %13, %reass.mul37
