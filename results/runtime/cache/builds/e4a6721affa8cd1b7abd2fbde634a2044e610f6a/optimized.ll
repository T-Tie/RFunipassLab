...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv62, %1
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv68, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv65, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv68, i64 %indvars.iv65
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax74 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax79 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax80 = call i32 @llvm.smax.i32(i32 %smax79, i32 0)
  %wide.trip.count81 = zext nneg i32 %smax80 to i64
  %wide.trip.count = zext nneg i32 %smax74 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond82.not = icmp eq i64 %indvars.iv75, %wide.trip.count81
  br i1 %exitcond82.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax86 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count87 = zext nneg i32 %smax86 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv75, i64 %indvars.iv71
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv96 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next97, %for.inc83 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %wide.trip.count81
  br i1 %exitcond100.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond95.not = icmp eq i64 %indvars.iv89, %wide.trip.count
  br i1 %exitcond95.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv96, i64 %indvars.iv89
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv83 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next84, %for.inc77 ]
  %exitcond88.not = icmp eq i64 %indvars.iv83, %wide.trip.count87
  br i1 %exitcond88.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv96, i64 %indvars.iv83
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv83, i64 %indvars.iv89
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond105.not = icmp eq i64 %indvars.iv101, %wide.trip.count81
  br i1 %exitcond105.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv101
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax79 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond117.not = icmp eq i64 %indvars.iv113, %wide.trip.count81
  br i1 %exitcond117.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv113
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax79, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax79, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv106 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next107, %for.inc112 ]
  %exitcond112.not = icmp eq i64 %indvars.iv106, %wide.trip.count
  br i1 %exitcond112.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv113, i64 %indvars.iv106
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv130 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond137.not = icmp eq i64 %indvars.iv130, %wide.trip.count81
  br i1 %exitcond137.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv130
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv130, 0
  %or.cond57 = and i1 %or.cond, %cmp128
  br i1 %or.cond57, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv130
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax121 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
  %wide.trip.count122 = zext nneg i32 %smax121 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond123.not = icmp eq i64 %indvars.iv118, %wide.trip.count122
  br i1 %exitcond123.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv130, i64 %indvars.iv118
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv130, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax127 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
  %wide.trip.count128 = zext nneg i32 %smax127 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond129.not = icmp eq i64 %indvars.iv124, %wide.trip.count128
  br i1 %exitcond129.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv130, i64 %indvars.iv124
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv130, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv130, 2
