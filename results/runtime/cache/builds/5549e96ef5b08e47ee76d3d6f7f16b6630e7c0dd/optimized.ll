...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 501, ptr noundef align 16 %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 2505, ptr noundef align 16 %a) #6
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %a, i8 noundef 0, i64 noundef 2505, i1 noundef false) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %n) #6
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef align 16 %b) #6
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %b, i8 noundef 0, i64 noundef 2000, i1 noundef false) #7
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef align 16 %c) #6
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef align 4 %n)
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str.1, ptr noundef %s)
  %call3 = call i64 @strlen(ptr noundef %s) #8
...
for.end14:                                        ; preds = %for.cond
  %add.lcssa = phi i32 [ %add, %for.cond ]
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc42, %for.end14
  %i.1 = phi i32 [ 0, %for.end14 ], [ %add20, %for.inc42 ]
  %cmp18 = icmp slt i32 %i.1, %add.lcssa
  br i1 %cmp18, label %for.body19, label %for.end44

for.body19:                                       ; preds = %for.cond15
  %add20 = add nsw i32 %i.1, 1
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %j.1 = phi i32 [ %add20, %for.body19 ], [ %inc40, %for.inc39 ]
  %cmp24 = icmp slt i32 %j.1, %add.lcssa
...
for.body25:                                       ; preds = %for.cond21
  ...
  %call32 = call i32 @strcmp(ptr noundef readonly captures(none) %arrayidx27, ptr noundef readonly captures(none) %arrayidx30) #8
...
for.cond49:                                       ; preds = %for.inc63, %for.body48
  ...
  %cmp52 = icmp slt i32 %i.2, %add.lcssa
...
for.inc66:                                        ; preds = %for.cond49
  %z.1.lcssa = phi i32 [ %z.1, %for.cond49 ]
  %dec = add nsw i32 %k.0, -1
  br label %for.cond45, !llvm.loop !17

for.end67:                                        ; preds = %for.cond45
  %k.0.lcssa = phi i32 [ %k.0, %for.cond45 ]
  %z.0.lcssa = phi i32 [ %z.0, %for.cond45 ]
  %cmp68.lcssa = phi i1 [ %cmp68, %for.cond45 ]
  br i1 %cmp68.lcssa, label %if.then69, label %if.else71

if.then69:                                        ; preds = %for.end67
  %call70 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #9
  br label %if.end86

if.else71.loopexit:                               ; preds = %land.end
  %k.0.lcssa8 = phi i32 [ %k.0, %land.end ]
  %z.0.lcssa6 = phi i32 [ %z.0, %land.end ]
  br label %if.else71

if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.09 = phi i32 [ %k.0.lcssa8, %if.else71.loopexit ], [ %k.0.lcssa, %for.end67 ]
  %z.07 = phi i32 [ %z.0.lcssa6, %if.else71.loopexit ], [ %z.0.lcssa, %for.end67 ]
  %add72 = add nsw i32 %k.09, 2
  %call73 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %add72) #9
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %i.3 = phi i32 [ 0, %if.else71 ], [ %inc84, %for.inc83 ]
  %cmp75 = icmp slt i32 %i.3, %z.07
  br i1 %cmp75, label %for.inc83, label %if.end86.loopexit
...
for.inc83:                                        ; preds = %for.cond74
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, ptr noundef %arrayidx80) #9
...
if.end86:                                         ; preds = %if.end86.loopexit, %if.then69
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %c) #9
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2505, ptr noundef %a) #9
  call void @llvm.lifetime.end.p0(i64 noundef 501, ptr noundef %s) #9
  ret i32 0
}
