...
for.end:                                          ; preds = %for.cond7
  %n1.0.lcssa = phi i32 [ %n1.0, %for.cond7 ]
  br label %for.cond30
...
for.end58:                                        ; preds = %for.cond30
  %n2.0.lcssa = phi i32 [ %n2.0, %for.cond30 ]
  %cmp59 = icmp slt i32 %n1.0.lcssa, %n2.0.lcssa
  br i1 %cmp59, label %if.then60, label %if.end68

if.then60:                                        ; preds = %for.end58
  %sub = sub nsw i32 %n2.0.lcssa, %n1.0.lcssa
...
if.end68:                                         ; preds = %if.then63, %if.else65, %for.end58
  %cmp69 = icmp sgt i32 %n1.0.lcssa, %n2.0.lcssa
  br i1 %cmp69, label %if.then70, label %for.inc164

if.then70:                                        ; preds = %if.end68
  %sub71 = sub nsw i32 %n1.0.lcssa, %n2.0.lcssa
...
for.end111:                                       ; preds = %for.cond85
  %n182.0.lcssa = phi i32 [ %n182.0, %for.cond85 ]
...
for.end140:                                       ; preds = %for.cond112
  %n283.0.lcssa = phi i32 [ %n283.0, %for.cond112 ]
  %cmp141 = icmp slt i32 %n182.0.lcssa, %n283.0.lcssa
  br i1 %cmp141, label %if.then142, label %if.end151

if.then142:                                       ; preds = %for.end140
  %sub143 = sub nsw i32 %n283.0.lcssa, %n182.0.lcssa
...
if.end151:                                        ; preds = %if.then146, %if.else148, %for.end140
  %cmp152 = icmp sgt i32 %n182.0.lcssa, %n283.0.lcssa
  br i1 %cmp152, label %if.then153, label %for.inc164

if.then153:                                       ; preds = %if.end151
  %sub154 = sub nsw i32 %n182.0.lcssa, %n283.0.lcssa
