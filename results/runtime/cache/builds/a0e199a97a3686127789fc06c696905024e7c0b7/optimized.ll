...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv15
  %2 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  %cmp32.not = icmp eq i32 %2, -1
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  br i1 %cmp32.not, label %for.cond38, label %for.cond29, !llvm.loop !13

for.cond38:                                       ; preds = %for.cond29, %for.inc45
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc45 ], [ %indvars.iv15, %for.cond29 ]
  %cmp39 = icmp sgt i64 %indvars.iv18, 0
  br i1 %cmp39, label %for.inc45, label %if.end49

for.inc45:                                        ; preds = %for.cond38
  %indvars.iv.next19 = add nsw i64 %indvars.iv18, -1
  %arrayidx43 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv.next19
