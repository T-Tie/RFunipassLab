...
if.else:                                          ; preds = %for.body
  ...
  %div35 = fdiv double %fneg, %mul34
  %5 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom
  store double %div35, ptr %5, align 8, !tbaa !9
...
if.end48:                                         ; preds = %if.then25, %if.else32, %if.then
...
for.cond49:                                       ; preds = %if.end109, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc111, %if.end109 ]
...
if.end109:                                        ; preds = %if.then67, %if.else93, %if.then77, %if.then55
