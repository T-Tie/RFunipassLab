...
for.inc21:                                        ; preds = %for.cond14
  ...
  call void @outlined_ir_func_0.3()
  br label %for.cond14
...
for.cond32:                                       ; preds = %for.inc48, %for.body29
  %min.1 = phi i32 [ %8, %for.body29 ], [ %cond47, %for.inc48 ]
  %9 = load i32, ptr @k, align 4, !tbaa !5
  %cmp33 = icmp slt i32 %9, %n
...
for.inc48:                                        ; preds = %cond.true40, %for.body34
  %cond47 = phi i32 [ %10, %cond.true40 ], [ %min.1, %for.body34 ]
...
for.end61:                                        ; preds = %for.cond51
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) @j) #8
  br label %for.cond27
...
for.end97:                                        ; preds = %for.cond81
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) @i) #8
  br label %for.cond66

for.end100:                                       ; preds = %for.cond66
  %call = call noundef i32 @_Z4xiaoi(i32 noundef %sub67) #8
  %add102 = add nsw i32 %call, %13
  br label %cleanup

cleanup:                                          ; preds = %for.end64, %for.end100
  %retval.0 = phi i32 [ %add102, %for.end100 ], [ %13, %for.end64 ]
  ret i32 %retval.0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef %result) #9
...
for.end:                                          ; preds = %for.cond4
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) @j) #10
  br label %for.cond1

for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z4xiaoi(i32 noundef %3) #10
...
for.body21:                                       ; preds = %for.cond19
  ...
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) @l) #10
  br label %for.cond19

for.end28:                                        ; preds = %for.cond19
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %result) #10
...
define internal void @outlined_ir_func_0.3() #7 {
for.cond14.exitStub:
...
attributes #7 = { minsize mustprogress nofree nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
