...
for.end:                                          ; preds = %for.cond
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %2 = add nuw i32 %smax43, 1
  %wide.trip.count44 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond45 = icmp eq i64 %indvars.iv40, %wide.trip.count44
  br i1 %exitcond45, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax31 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv28 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next29, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count32
  br i1 %exitcond33.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body19 ], [ 0, %for.cond14 ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond14 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond27.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv22, %indvars.iv40
  ...
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv28, i64 %indvars.iv22
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv28, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv34 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next35, %for.inc56 ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond39.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv34, %indvars.iv40
  ...
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom59, i64 %indvars.iv34
...
for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc121
  %indvars.iv50 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next51, %for.inc121 ]
  %exitcond58.not = icmp eq i64 %indvars.iv50, %wide.trip.count57
  br i1 %exitcond58.not, label %for.end123, label %for.cond76.preheader
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc118
  %indvars.iv52 = phi i64 [ %indvars.iv50, %for.cond76.preheader ], [ %indvars.iv.next53, %for.inc118 ]
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %10 = trunc nuw i64 %indvars.iv.next53 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.inc121

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next53, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond49.not = icmp eq i64 %indvars.iv46, 6
  br i1 %exitcond49.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next53, i64 %indvars.iv46
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv46
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv50, i64 %indvars.iv46
...
if.else:                                          ; preds = %for.end123
  ...
  %smax63 = call i32 @llvm.smax.i32(i32 %l.0, i32 1)
  %wide.trip.count67 = zext nneg i32 %smax63 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc151 ], [ 1, %if.else ]
  %exitcond68.not = icmp eq i64 %indvars.iv59, %wide.trip.count67
  br i1 %exitcond68.not, label %for.end153, label %for.body136
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars66.le = trunc i64 %indvars.iv59 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.0.lcssa = phi i32 [ %indvars66.le, %for.end153.split.loop.exit ], [ %smax63, %for.cond134 ]
  %sub155 = add nsw i32 %z.0.lcssa, -1
  %wide.trip.count81 = zext i32 %sub155 to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond82.not = icmp eq i64 %indvars.iv73, %wide.trip.count81
  br i1 %exitcond82.not, label %for.cond207.preheader, label %for.cond159.preheader

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count89 = zext i32 %z.0.lcssa to i64
  br label %for.cond207

for.cond159.preheader:                            ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv73, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  %indvars.iv75 = phi i64 [ %indvars.iv73, %for.cond159.preheader ], [ %indvars.iv.next76, %for.inc201 ]
  %indvars.iv.next76 = add nuw nsw i64 %indvars.iv75, 1
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count81
  br i1 %exitcond79.not, label %for.inc204, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next76, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond72.not = icmp eq i64 %indvars.iv69, 6
  br i1 %exitcond72.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next76, i64 %indvars.iv69
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv69
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv73, i64 %indvars.iv69
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv86 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next87, %for.inc223 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %wide.trip.count89
  br i1 %exitcond90.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv83, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv86, i64 %indvars.iv83
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar20 = call i32 @putchar(i32 %conv218)
