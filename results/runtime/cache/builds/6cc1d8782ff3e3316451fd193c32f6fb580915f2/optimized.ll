...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 302, ptr noundef align 16 %ss) #7
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %ss, i8 noundef 0, i64 noundef 302, i1 noundef false) #8
  store i8 48, ptr %ss, align 16
  call void @llvm.lifetime.start.p0(i64 noundef 27, ptr noundef align 16 %zimu) #7
  call void @llvm.memcpy.p0.p0.i64(ptr noundef writeonly align 16 %zimu, ptr noundef readonly align 16 @__const.main.zimu, i64 noundef 27, i1 noundef false) #8
  ...
  %call2 = call i64 @strlen(ptr noundef %ss) #9
  %conv = trunc i64 %call2 to i32
  br label %for.cond

for.cond:                                         ; preds = %for.inc23, %entry
  %0 = phi i32 [ %inc24, %for.inc23 ], [ 0, %entry ]
...
for.body6:                                        ; preds = %for.cond3
  ...
  %3 = load i8, ptr %arrayidx9, align 1, !tbaa !9, !invariant.load !10
...
if.end22:                                         ; preds = %for.end
  ...
  %7 = load i8, ptr %arrayidx15, align 1, !tbaa !9, !invariant.load !10
  %conv16 = sext i8 %7 to i32
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv16, i32 noundef %5) #10
  store i32 0, ptr %count, align 4, !tbaa !5
  br label %for.inc23
...
if.then27:                                        ; preds = %for.end25
  %call28 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #10
  br label %if.end29

if.end29:                                         ; preds = %if.then27, %for.end25
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %s) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %count) #10
  call void @llvm.lifetime.end.p0(i64 noundef 27, ptr noundef %zimu) #10
  call void @llvm.lifetime.end.p0(i64 noundef 302, ptr noundef %ss) #10
  ret i32 0
}
