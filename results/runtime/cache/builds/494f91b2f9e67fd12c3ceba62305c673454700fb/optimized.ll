...
if.then:                                          ; preds = %for.body
  ...
  %.pre40 = fmul double %.pre35, 4.000000e+00
  %.pre41 = fneg double %.pre36
  %.pre42 = fmul double %.pre40, %.pre41
  %.pre43 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre42)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi44 = phi double [ %.pre43, %if.then ], [ %5, %for.body ]
  %mul24.pre-phi = phi double [ %.pre40, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre36, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre35, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi44, 0.000000e+00
...
if.then28:                                        ; preds = %if.end
  ...
  %.pre37 = load double, ptr %b, align 8, !tbaa !9
  %.pre38 = load double, ptr %a, align 8, !tbaa !9
  %.pre39 = load double, ptr %c, align 8, !tbaa !9
  %.pre45 = fmul double %.pre38, 4.000000e+00
  %.pre46 = fneg double %.pre39
  %.pre48 = fmul double %.pre45, %.pre46
  %.pre49 = call double @llvm.fmuladd.f64(double %.pre37, double %.pre37, double %.pre48)
  br label %if.end34

if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi50 = phi double [ %.pre49, %if.then28 ], [ %.pre-phi44, %if.end ]
  %mul36.pre-phi = phi double [ %.pre45, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre39, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre38, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre37, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi50, 0.000000e+00
...
if.else:                                          ; preds = %if.then40
  ...
  %call68 = call double @sqrt(double noundef %18) #7, !tbaa !5
  ...
  %call80 = call double @sqrt(double noundef %27) #7, !tbaa !5
...
for.inc.sink.split:                               ; preds = %if.then42, %if.else
  %vbase.offset.i30 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !11
