...
if.else72:                                        ; preds = %if.else63
  ...
  %10 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 1
  %11 = getelementptr inbounds [99 x double], ptr %10, i64 0, i64 %idxprom52
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %12, double noundef %fneg81, double noundef %12) #8
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %8, double noundef %12, double noundef %8, double noundef %12) #8
  br label %for.inc110
