...
for.cond:                                         ; preds = %for.end134, %entry
  %sum.0 = phi i32 [ 0, %entry ], [ %add, %for.end134 ]
  %b.0 = phi i32 [ %k, %entry ], [ %dec, %for.end134 ]
...
for.cond1:                                        ; preds = %for.end30, %for.body
  %i.0 = phi i32 [ 0, %for.body ], [ %inc32, %for.end30 ]
...
for.cond5:                                        ; preds = %if.end, %for.body3
  %j.0 = phi i32 [ 1, %for.body3 ], [ %inc, %if.end ]
  %min.0 = phi i32 [ %0, %for.body3 ], [ %min.1, %if.end ]
...
for.cond17:                                       ; preds = %for.body19, %for.end
  %j.1 = phi i32 [ 0, %for.end ], [ %inc29, %for.body19 ]
...
for.cond34:                                       ; preds = %if.end87, %for.end33
  %i.1 = phi i32 [ 0, %for.end33 ], [ %inc89, %if.end87 ]
...
for.cond37:                                       ; preds = %if.end46, %for.body36
  %j.2 = phi i32 [ 1, %for.body36 ], [ %inc48, %if.end46 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  br i1 %cmp44, label %if.end87, label %if.end46
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom42
  %4 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %if.end68, %if.then51
  %j.3 = phi i32 [ 1, %if.then51 ], [ %inc70, %if.end68 ]
  %min.2 = phi i32 [ %4, %if.then51 ], [ %min.3, %if.end68 ]
...
for.body57:                                       ; preds = %for.cond55
  ...
  %arrayidx61 = getelementptr inbounds [100 x i32], ptr %arrayidx59, i64 0, i64 %idxprom42
...
for.cond72:                                       ; preds = %for.body74, %for.end71
  %j.4 = phi i32 [ 0, %for.end71 ], [ %inc85, %for.body74 ]
  %cmp73 = icmp slt i32 %j.4, %b.0
  br i1 %cmp73, label %for.body74, label %if.end87

for.body74:                                       ; preds = %for.cond72
  %idxprom75 = sext i32 %j.4 to i64
  %arrayidx76 = getelementptr inbounds [100 x i32], ptr %a, i64 %idxprom75
  %arrayidx78 = getelementptr inbounds [100 x i32], ptr %arrayidx76, i64 0, i64 %idxprom42
...
if.end87:                                         ; preds = %for.cond72, %for.body39
...
for.cond93:                                       ; preds = %for.end110, %for.end90
  %i.2 = phi i32 [ 0, %for.end90 ], [ %inc112, %for.end110 ]
...
for.cond96:                                       ; preds = %for.body98, %for.body95
  %j.5 = phi i32 [ 2, %for.body95 ], [ %inc109, %for.body98 ]
...
for.cond114:                                      ; preds = %for.end131, %for.end113
  %i.3 = phi i32 [ 0, %for.end113 ], [ %inc133, %for.end131 ]
...
for.cond117:                                      ; preds = %for.body119, %for.body116
  %j.6 = phi i32 [ 2, %for.body116 ], [ %inc130, %for.body119 ]
...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z2jzPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %num, i32 noundef %1) #7
...
for.cond19:                                       ; preds = %for.body21, %for.end18
  %i.1 = phi i32 [ 0, %for.end18 ], [ %inc27, %for.body21 ]
