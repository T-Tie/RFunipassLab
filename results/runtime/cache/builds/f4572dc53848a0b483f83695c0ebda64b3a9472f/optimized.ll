...
for.cond:                                         ; preds = %if.end38, %entry
  %i.0 = phi double [ 1.000000e+00, %entry ], [ %inc, %if.end38 ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %conv = sitofp i32 %0 to double
  %cmp4 = fcmp ole double %i.0, %conv
...
for.body:                                         ; preds = %for.cond
  ...
  %call14 = call double @sqrt(double noundef %4) #8, !tbaa !5
...
if.end38:                                         ; preds = %if.then24, %if.else26, %if.then
