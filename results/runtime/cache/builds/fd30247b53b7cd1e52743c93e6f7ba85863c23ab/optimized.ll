...
for.cond1:                                        ; preds = %for.body3, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body3 ], [ 0, %for.end ]
  %0 = load i32, ptr %k, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp2 = icmp slt i64 %indvars.iv20, %1
  br i1 %cmp2, label %for.body3, label %for.end9

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv20
...
for.cond16:                                       ; preds = %for.cond16.backedge, %for.cond16.preheader
  %indvars.iv23 = phi i64 [ %2, %for.cond16.preheader ], [ %indvars.iv.next24, %for.cond16.backedge ]
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %3 = trunc nuw i64 %indvars.iv.next24 to i32
  %cmp17 = icmp sgt i32 %0, %3
  br i1 %cmp17, label %for.body18, label %for.inc38

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next24
  %4 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !5
  %cmp23.not = icmp sgt i32 %4, %5
  br i1 %cmp23.not, label %for.cond16.backedge, label %land.lhs.true

for.cond16.backedge:                              ; preds = %for.body18, %land.lhs.true, %if.then
  br label %for.cond16, !llvm.loop !13

land.lhs.true:                                    ; preds = %for.body18
  %6 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %arrayidx27 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next24
  %7 = load i32, ptr %arrayidx27, align 4, !tbaa !5
  %cmp29.not = icmp sgt i32 %6, %7
  br i1 %cmp29.not, label %for.cond16.backedge, label %if.then
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.body42
  %indvars.iv26 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next27, %for.body42 ]
  %max.0 = phi i32 [ 0, %for.cond40.preheader ], [ %spec.select, %for.body42 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.end52, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx44 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv26
