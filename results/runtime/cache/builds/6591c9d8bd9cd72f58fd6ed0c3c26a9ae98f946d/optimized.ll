...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax43 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond15.not, label %for.cond28, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc22 ], [ 0, %for.cond11.preheader ]
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc63 ], [ 0, %for.cond ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc60 ], [ 0, %for.cond48.preheader ]
...
for.cond69:                                       ; preds = %for.end65, %for.inc125
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc125 ], [ 0, %for.end65 ]
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  ...
  %exitcond38.not = icmp eq i64 %indvars.iv32, %wide.trip.count
