...
for.body39:                                       ; preds = %for.cond37
  ...
  %3 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
...
for.body57:                                       ; preds = %for.cond55
  ...
  %5 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !9
...
for.inc84:                                        ; preds = %for.cond72
  ...
  %6 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !9
...
for.inc108:                                       ; preds = %for.cond96
  ...
  %8 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !9
...
for.cond114:                                      ; preds = %for.inc132, %for.end113
  ...
  %cmp115 = icmp slt i32 %i.3, %k.sink
...
for.cond117:                                      ; preds = %for.inc129, %for.body116
  ...
  %cmp118 = icmp slt i32 %j.6, %k.sink
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %9 = load i32, ptr %arrayidx123, align 4, !tbaa !5, !invariant.load !9
