...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %s0) #6
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef %s1) #6
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %s1, i8 noundef 0, i64 noundef 10000, i1 noundef false) #7
  ...
  %call6 = call ptr @strcat(ptr noundef %s1, ptr noundef %s) #9
  br label %for.cond
...
for.end:                                          ; preds = %for.cond9
  ...
  %call20 = call i64 @strlen(ptr noundef %s) #8
...
if.end:                                           ; preds = %for.end
  %arrayidx25 = getelementptr inbounds [40 x i8], ptr %s0, i64 0, i64 %idxprom
  store i8 0, ptr %arrayidx25, align 1, !tbaa !9
  %call27 = call ptr @strcat(ptr noundef %s1, ptr noundef @.str.2) #9
  %call30 = call ptr @strcat(ptr noundef %s1, ptr noundef %s0) #9
  br label %for.inc44

if.then32:                                        ; preds = %for.end
  %arrayidx34 = getelementptr inbounds [40 x i8], ptr %s0, i64 0, i64 %idxprom
  store i8 0, ptr %arrayidx34, align 1, !tbaa !9
  %call36 = call ptr @strcat(ptr noundef %s1, ptr noundef @.str.3) #9
  %call39 = call ptr @strcat(ptr noundef %s1, ptr noundef %s0) #9
  %call41 = call i64 @strlen(ptr noundef %s0) #8
...
for.end46:                                        ; preds = %for.cond
  %call48 = call i32 @puts(ptr noundef %s1)
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %s1) #9
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %s0) #9
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %s) #9
