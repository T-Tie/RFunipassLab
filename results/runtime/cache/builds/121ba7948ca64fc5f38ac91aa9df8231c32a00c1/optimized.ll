...
if.then:                                          ; preds = %while.body
  %3 = load i8, ptr %1, align 1, !tbaa !12, !invariant.load !13
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %3)
...
while.cond8:                                      ; preds = %while.body11, %if.else
  ...
  %5 = load i8, ptr %4, align 1, !tbaa !12, !invariant.load !13
  %conv9 = sext i8 %5 to i32
  %cmp10 = icmp eq i32 %conv9, 32
  br i1 %cmp10, label %while.body11, label %if.end

while.body11:                                     ; preds = %while.cond8
  %incdec.ptr12 = getelementptr inbounds nuw i8, ptr %4, i32 1
...
while.end14:                                      ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 201, ptr noundef captures(none) %a) #7
  ret i32 0
}
