...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count31 = zext i32 %3 to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre37, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc24
  %indvars.iv27 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next28, %for.inc24 ]
  ...
  br i1 %exitcond32, label %for.cond27.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv23 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next24, %for.inc21 ]
  %exitcond = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond, label %for.inc24, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv27, i64 %indvars.iv23
...
for.body32:                                       ; preds = %for.cond30
  ...
  %arrayidx36 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv34, i64 %idxprom35
