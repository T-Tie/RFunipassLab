...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %k) #6
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv24 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next25, %for.body4 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv24
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body15 ], [ 0, %for.cond13.preheader ]
  %Max2.0 = phi i32 [ %Max2.1, %for.body15 ], [ 0, %for.cond13.preheader ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond32.not, label %for.end28, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv28
...
for.end28:                                        ; preds = %for.cond13
  ...
  %vtable.i = load ptr, ptr %call29, align 8, !tbaa !15, !invariant.load !12
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !12
  %add.ptr.i = getelementptr inbounds i8, ptr %call29, i64 %vbase.offset.i
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call29, i8 noundef signext %call.i2)
  ...
  %vtable.i3 = load ptr, ptr %call31, align 8, !tbaa !15, !invariant.load !12
  %vbase.offset.ptr.i4 = getelementptr i8, ptr %vtable.i3, i64 -24
  %vbase.offset.i5 = load i64, ptr %vbase.offset.ptr.i4, align 8, !invariant.load !12
  %add.ptr.i6 = getelementptr inbounds i8, ptr %call31, i64 %vbase.offset.i5
  ...
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call31, i8 noundef signext %call.i)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %k) #7
  ret i32 0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !17, !invariant.load !12
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !15, !invariant.load !12
