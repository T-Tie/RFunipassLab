...
for.cond31:                                       ; preds = %for.cond
  %cmp32 = icmp slt i32 0, %n
  br i1 %cmp32, label %for.body33, label %for.end71

for.body33:                                       ; preds = %for.cond31
  %4 = load i32, ptr @a, align 16, !tbaa !5, !invariant.load !9
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc51, %for.body33
  %min34.0 = phi i32 [ %4, %for.body33 ], [ %min34.1, %for.inc51 ]
  %5 = load i32, ptr %j, align 4, !tbaa !5
  %cmp38 = icmp slt i32 %5, %n
...
for.body39:                                       ; preds = %for.cond37
  ...
  %6 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !9
  %cmp44 = icmp slt i32 %6, %min34.0
...
for.inc51:                                        ; preds = %for.body39, %if.then45
  %min34.1 = phi i32 [ %6, %if.then45 ], [ %min34.0, %for.body39 ]
  %inc52 = add nsw i32 %5, 1
...
for.body56:                                       ; preds = %for.end53, %for.body56
  ...
  %sub61 = sub nsw i32 %8, %min34.0
  store i32 %sub61, ptr %arrayidx58, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j) #9
  br label %for.body56
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %j) #10
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond1
...
for.inc17:                                        ; preds = %for.cond1
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %j) #10
