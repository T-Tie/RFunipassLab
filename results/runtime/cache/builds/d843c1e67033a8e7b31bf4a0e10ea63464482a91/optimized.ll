...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !12, !invariant.load !30
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !31, !invariant.load !30
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !37, !invariant.load !30
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !38, !invariant.load !30
  %vfn = getelementptr inbounds nuw i8, ptr %vtable, i64 48
  %2 = load ptr, ptr %vfn, align 8, !invariant.load !30
...
while.end_after_outline.exitStub:
  %1 = load i32, ptr %0, align 4, !tbaa !5, !invariant.load !30
  %call8 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %1)
  %vtable.i = load ptr, ptr %call8, align 8, !tbaa !38, !invariant.load !30
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call8, i8 noundef signext %call.i2)
...
!30 = !{}
!31 = !{!32, !7, i64 56}
!32 = !{!"_ZTSSt5ctypeIcE", !33, i64 0, !34, i64 16, !25, i64 24, !35, i64 32, !35, i64 40, !36, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!33 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!34 = !{!"p1 _ZTS15__locale_struct", !19, i64 0}
!35 = !{!"p1 int", !19, i64 0}
!36 = !{!"p1 short", !19, i64 0}
!37 = !{!7, !7, i64 0}
!38 = !{!39, !39, i64 0}
