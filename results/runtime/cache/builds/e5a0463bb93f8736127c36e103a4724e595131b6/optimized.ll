...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull %c) #7
  ...
  %s.0 = icmp slt i32 %conv9, %conv12
  %0 = load i8, ptr %b, align 16
  %smax = call i32 @llvm.smax.i32(i32 %conv9, i32 1)
  %smax40 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %if.end72, %entry
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %if.end72 ], [ 1, %entry ]
  %exitcond42 = icmp eq i64 %indvars.iv35, %wide.trip.count41
  br i1 %exitcond42, label %for.end75, label %for.body
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext55 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext55, 32
  %arrayidx32 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %idxprom31
  %5 = load i8, ptr %arrayidx32, align 1, !tbaa !5, !invariant.load !12
  ...
  %spec.select25 = select i1 %cmp38.not, i32 %d.0, i32 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond26

for.end:                                          ; preds = %for.cond26
  %cmp41 = icmp eq i32 %d.0, 0
  br i1 %cmp41, label %for.cond43.preheader, label %if.end72

for.cond43.preheader:                             ; preds = %for.end
  %invariant.gep = getelementptr inbounds nuw i8, ptr %a, i64 1
  %invariant.gep29 = getelementptr i8, ptr %a, i64 -1
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  %8 = and i64 %indvars.iv35, 4294967295
  %gep = getelementptr i8, ptr %invariant.gep, i64 %7
  %add49 = add i64 %indvars.iv35, %call8
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %sext53 = shl i64 %add49, 32
  %9 = ashr exact i64 %sext53, 32
  %gep30 = getelementptr i8, ptr %invariant.gep29, i64 %7
  %10 = sub i32 %conv12, %conv9
  %smax43 = call i32 @llvm.abs.i32(i32 %10, i1 false)
  %11 = add nuw i32 %smax43, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %if.end54
  %j.1 = phi i32 [ %inc.i15, %if.end54 ], [ 1, %for.cond43.preheader ]
  %exitcond44 = icmp eq i32 %j.1, %11
  br i1 %exitcond44, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv35, 4294967294
  %smax50 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %12 = add nuw i32 %smax50, 1
  %wide.trip.count51 = zext i32 %12 to i64
  br label %for.cond58

for.body45:                                       ; preds = %for.cond43
  br i1 %cmp.not, label %for.cond.i, label %if.end50

for.cond.i:                                       ; preds = %for.inc.i, %for.body45
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.i ], [ %9, %for.body45 ]
  %cmp.not.i = icmp sgt i64 %indvars.iv.i, %7
  br i1 %cmp.not.i, label %_Z4leftPcii.exit, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep29, i64 %indvars.iv.i
...
_Z4leftPcii.exit:                                 ; preds = %for.cond.i
  store i8 0, ptr %gep30, align 1, !tbaa !5
  br label %if.end54

if.end50:                                         ; preds = %for.body45
  br i1 %s.0, label %for.cond.i9, label %if.end54

for.cond.i9:                                      ; preds = %for.inc.i12, %if.end50
  %indvars.iv.i10 = phi i64 [ %indvars.iv.next.i14, %for.inc.i12 ], [ %7, %if.end50 ]
  %cmp.not.i11 = icmp slt i64 %indvars.iv.i10, %8
  br i1 %cmp.not.i11, label %_Z5rightPcii.exit, label %for.inc.i12

for.inc.i12:                                      ; preds = %for.cond.i9
  %gep.i13 = getelementptr i8, ptr %invariant.gep29, i64 %indvars.iv.i10
  %14 = load i8, ptr %gep.i13, align 1, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i8, ptr %a, i64 %indvars.iv.i10
  store i8 %14, ptr %arrayidx2.i, align 1, !tbaa !5
  %indvars.iv.next.i14 = add nsw i64 %indvars.iv.i10, -1
  br label %for.cond.i9, !llvm.loop !8

_Z5rightPcii.exit:                                ; preds = %for.cond.i9
  store i8 0, ptr %gep, align 1, !tbaa !5
  br label %if.end54

if.end54:                                         ; preds = %_Z4leftPcii.exit, %_Z5rightPcii.exit, %if.end50
  %inc.i15 = add nuw i32 %j.1, 1
  br label %for.cond43

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body60
  %indvars.iv45 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next46, %for.body60 ]
  %exitcond52 = icmp eq i64 %indvars.iv45, %wide.trip.count51
  br i1 %exitcond52, label %for.end75, label %for.body60

for.body60:                                       ; preds = %for.cond58
  %15 = add nsw i64 %indvars.iv45, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx63, align 1, !tbaa !5
  %17 = add nuw nsw i64 %add64, %indvars.iv45
  %sext54 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext54, 32
...
for.end75:                                        ; preds = %for.cond, %for.cond58
  %call77 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull align 16 dereferenceable(256) %a) #9
