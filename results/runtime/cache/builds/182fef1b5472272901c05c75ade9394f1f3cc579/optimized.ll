...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1584, ptr nonnull %m) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %x) #5
...
if.then:                                          ; preds = %for.body
  %call9 = call double @sqrt(double noundef %6) #5, !tbaa !5
  ...
  %call16 = call double @sqrt(double noundef %6) #5, !tbaa !5
...
if.else32:                                        ; preds = %if.else
  ...
  %call42 = call double @sqrt(double noundef %fneg41) #5, !tbaa !5
...
for.end112:                                       ; preds = %for.cond49
  ...
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %x) #5
  call void @llvm.lifetime.end.p0(i64 1584, ptr nonnull %m) #5
  ret i32 0
}
