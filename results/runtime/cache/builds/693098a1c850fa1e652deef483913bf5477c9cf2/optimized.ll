...
for.cond15.preheader:                             ; preds = %for.cond2
  %2 = add i32 %j.0, -1
  %smax16 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc40
  %indvars.iv6 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next7, %for.inc40 ]
  %exitcond18.not = icmp eq i64 %indvars.iv6, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond43.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv6
  br label %for.cond19
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc37
  %indvars.iv8 = phi i64 [ %indvars.iv6, %for.cond19.preheader ], [ %indvars.iv.next9, %for.inc37 ]
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc40, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %6 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next9
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv19 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next20, %for.inc53 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count17
  br i1 %exitcond23.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv19
  ...
  %cmp49 = icmp slt i64 %indvars.iv19, %5
