...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax55 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond26.not, label %for.cond28.preheader, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv17 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next18, %for.inc22 ]
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv37 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next38, %for.inc63 ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv32 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next33, %for.inc60 ]
...
lor.lhs.false.thread:                             ; preds = %for.body75
  %8 = trunc nuw nsw i64 %indvars.iv43 to i32
