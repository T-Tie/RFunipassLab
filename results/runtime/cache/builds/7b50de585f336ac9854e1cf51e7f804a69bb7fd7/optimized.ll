...
for.cond13:                                       ; preds = %for.inc53, %for.body12
  %y1.1 = phi i32 [ %y1.0, %for.body12 ], [ %y1.24, %for.inc53 ]
  %x1.1 = phi i32 [ %x1.0, %for.body12 ], [ %x1.26, %for.inc53 ]
...
for.inc53:                                        ; preds = %land.lhs.true38, %land.lhs.true44, %if.then51, %for.body15
  %x1.26 = phi i32 [ %x1.2.ph, %if.then51 ], [ %x1.2.ph, %land.lhs.true44 ], [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1, %for.body15 ]
  %y1.24 = phi i32 [ %y1.2.ph, %if.then51 ], [ %y1.2.ph, %land.lhs.true44 ], [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1, %for.body15 ]
