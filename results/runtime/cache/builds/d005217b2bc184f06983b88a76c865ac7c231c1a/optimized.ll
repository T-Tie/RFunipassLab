...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !27, !invariant.load !8
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !35, !invariant.load !8
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !36, !invariant.load !8
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !39, !invariant.load !8
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !40, !invariant.load !8
...
!27 = !{!28, !31, i64 232}
!28 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !17, i64 0, !29, i64 216, !15, i64 224, !30, i64 225, !31, i64 232, !32, i64 240, !33, i64 248, !34, i64 256}
