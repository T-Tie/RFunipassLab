...
for.cond1:                                        ; preds = %for.inc, %for.body
  %c.1 = phi i32 [ %c.0, %for.body ], [ %div, %for.inc ]
  %.sink2 = phi i32 [ 30, %for.body ], [ %dec, %for.inc ]
  %cmp2 = icmp sge i32 %.sink2, 0
  br i1 %cmp2, label %for.inc, label %for.inc8

for.inc:                                          ; preds = %for.cond1
  %idxprom = sext i32 %.sink2 to i64
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %.sink1 = phi i32 [ %.sink, %for.end19 ], [ %inc29, %for.inc28 ]
  %cmp21 = icmp slt i32 %.sink1, 31
