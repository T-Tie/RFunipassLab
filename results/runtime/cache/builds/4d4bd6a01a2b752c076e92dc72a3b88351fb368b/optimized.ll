...
if.else:                                          ; preds = %for.body
  %arrayidx4 = getelementptr inbounds [500 x i32], ptr %sz, i64 0, i64 %idxprom
...
for.cond6:                                        ; preds = %if.end18, %for.end
  %t.0 = phi i32 [ -1, %for.end ], [ %t.1, %if.end18 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %inc20, %if.end18 ]
...
for.cond22:                                       ; preds = %for.end48, %for.end21
  %q.0 = phi i32 [ 1, %for.end21 ], [ %inc50, %for.end48 ]
...
for.cond25:                                       ; preds = %if.end45, %for.body24
  %p.0 = phi i32 [ 0, %for.body24 ], [ %add30, %if.end45 ]
...
for.cond52:                                       ; preds = %if.end64, %for.end51
  %p.1 = phi i32 [ 0, %for.end51 ], [ %inc66, %if.end64 ]
  %cmp53 = icmp sle i32 %p.1, %t.0
  br i1 %cmp53, label %for.body54, label %for.end67

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i32 %p.1, %t.0
  %idxprom57 = sext i32 %p.1 to i64
  %4 = getelementptr inbounds [500 x i32], ptr %js, i64 0, i64 %idxprom57
...
if.then56:                                        ; preds = %for.body54
  ...
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %5)
  br label %if.end64

if.else60:                                        ; preds = %for.body54
  %arrayidx62 = getelementptr inbounds [500 x i32], ptr %js, i64 0, i64 %idxprom57
  %call63 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %5)
  br label %if.end64
