...
if.then:                                          ; preds = %for.body
  ...
  %.pre14 = load double, ptr %a, align 8, !tbaa !9
  %.pre15 = load double, ptr %c, align 8, !tbaa !9
  %.pre19 = fmul double %.pre14, 4.000000e+00
  %.pre20 = fneg double %.pre15
  %.pre21 = fmul double %.pre19, %.pre20
  %.pre22 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre21)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi23 = phi double [ %.pre22, %if.then ], [ %5, %for.body ]
  %mul19.pre-phi = phi double [ %.pre19, %if.then ], [ %mul2, %for.body ]
  %6 = phi double [ %.pre15, %if.then ], [ %3, %for.body ]
  %7 = phi double [ %.pre14, %if.then ], [ %2, %for.body ]
  %8 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp22 = fcmp oeq double %.pre-phi23, 0.000000e+00
...
if.then23:                                        ; preds = %if.end
  ...
  %.pre16 = load double, ptr %b, align 8, !tbaa !9
  %.pre17 = load double, ptr %a, align 8, !tbaa !9
  %.pre18 = load double, ptr %c, align 8, !tbaa !9
  %.pre24 = fmul double %.pre17, 4.000000e+00
  %.pre25 = fneg double %.pre18
  %.pre27 = fmul double %.pre24, %.pre25
  %.pre28 = call double @llvm.fmuladd.f64(double %.pre16, double %.pre16, double %.pre27)
  br label %if.end28

if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi29 = phi double [ %.pre28, %if.then23 ], [ %.pre-phi23, %if.end ]
  %mul30.pre-phi = phi double [ %.pre24, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre18, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre17, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre16, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi29, 0.000000e+00
  br i1 %cmp33, label %if.then34, label %for.inc

if.then34:                                        ; preds = %if.end28
  %cmp35 = fcmp oeq double %11, 0.000000e+00
  %fneg45 = fneg double %11
  %mul46 = fmul double %10, 2.000000e+00
  %div47 = fdiv double %fneg45, %mul46
  %A.0 = select i1 %cmp35, double 0.000000e+00, double %div47
  %neg51 = fmul double %11, %fneg45
  %12 = call double @llvm.fmuladd.f64(double %mul30.pre-phi, double %9, double %neg51)
  %call52 = call double @sqrt(double noundef %12) #6, !tbaa !5
  %div54 = fdiv double %call52, %mul46
  %call55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %A.0, double noundef %div54, double noundef %A.0, double noundef %div54)
  br label %for.inc
