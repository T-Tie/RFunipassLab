...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef %a) #12
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef %b) #12
  br label %for.cond
...
for.inc:                                          ; preds = %for.cond
  ...
  %add.ptr = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull %add.ptr)
...
for.cond4:                                        ; preds = %for.inc13, %for.end
  ...
  br i1 %cmp5, label %for.inc13, label %for.end15

for.inc13:                                        ; preds = %for.cond4
  %idx.ext7 = sext i32 %i.1 to i64
  %add.ptr8 = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext7
  %call10 = call i64 @strlen(ptr noundef %add.ptr8) #13
  %add = add i64 %call10, 1
  %conv = trunc i64 %add to i32
  %add.ptr12 = getelementptr inbounds i32, ptr %b, i64 %idx.ext7
...
for.cond16:                                       ; preds = %for.inc42, %for.end15
  %sum.0 = phi i32 [ 0, %for.end15 ], [ %sum.1, %for.inc42 ]
  %i.2 = phi i32 [ 0, %for.end15 ], [ %inc43, %for.inc42 ]
  %k.0 = phi i32 [ 0, %for.end15 ], [ %k.1, %for.inc42 ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %cmp17 = icmp slt i32 %i.2, %1
  br i1 %cmp17, label %for.body18, label %for.end44

for.body18:                                       ; preds = %for.cond16
  %idx.ext19 = sext i32 %i.2 to i64
  %add.ptr20 = getelementptr inbounds i32, ptr %b, i64 %idx.ext19
  %2 = load i32, ptr %add.ptr20, align 4, !tbaa !5, !invariant.load !13
  %add21 = add nsw i32 %sum.0, %2
...
for.cond23:                                       ; preds = %for.inc31, %if.then
  %j.0 = phi i32 [ %k.0, %if.then ], [ %inc32, %for.inc31 ]
  %sub = sub nsw i32 %i.2, 1
  %cmp24 = icmp slt i32 %j.0, %sub
  br i1 %cmp24, label %for.inc31, label %for.end33

for.inc31:                                        ; preds = %for.cond23
  %idx.ext26 = sext i32 %j.0 to i64
  %add.ptr27 = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext26
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr27)
  %call30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) %call29, i8 noundef signext 32)
  %inc32 = add nsw i32 %j.0, 1
  br label %for.cond23, !llvm.loop !14

for.end33:                                        ; preds = %for.cond23
  %add.ptr35 = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext19
  %add.ptr36 = getelementptr inbounds [41 x i8], ptr %add.ptr35, i64 -1
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr36)
...
for.inc42:                                        ; preds = %for.body18, %for.end33
  %sum.1 = phi i32 [ %2, %for.end33 ], [ %add21, %for.body18 ]
  %k.1 = phi i32 [ %i.2, %for.end33 ], [ %k.0, %for.body18 ]
...
for.cond45:                                       ; preds = %for.inc54, %for.end44
  %j.1 = phi i32 [ %k.0, %for.end44 ], [ %inc55, %for.inc54 ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %sub46 = sub nsw i32 %3, 1
  %cmp47 = icmp slt i32 %j.1, %sub46
  br i1 %cmp47, label %for.inc54, label %for.end56

for.inc54:                                        ; preds = %for.cond45
  %idx.ext49 = sext i32 %j.1 to i64
  %add.ptr50 = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext49
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr50)
  %call53 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) %call52, i8 noundef signext 32)
  %inc55 = add nsw i32 %j.1, 1
  br label %for.cond45, !llvm.loop !16

for.end56:                                        ; preds = %for.cond45
  %idx.ext57 = sext i32 %3 to i64
  %add.ptr58 = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext57
  %add.ptr59 = getelementptr inbounds [41 x i8], ptr %add.ptr58, i64 -1
  %call61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr59)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %b) #12
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef %a) #12
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !17, !invariant.load !13
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !17, !invariant.load !13
  %vbase.offset.ptr8 = getelementptr i8, ptr %vtable7, i64 -24
  %vbase.offset9 = load i64, ptr %vbase.offset.ptr8, align 8, !invariant.load !13
  ...
  %call16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10) #12
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %call24 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10) #12
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !17, !invariant.load !13
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !13
...
if.end:                                           ; preds = %entry
  %0 = load i8, ptr %__c.addr, align 1, !tbaa !19
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !17, !invariant.load !13
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !13
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !20, !invariant.load !13
  store i64 %__wide, ptr %_M_width, align 8, !tbaa !20
  ret i64 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !31, !invariant.load !13
  ret ptr %0
}
...
if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !17, !invariant.load !13
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 9
  %0 = load ptr, ptr %vfn, align 8, !invariant.load !13
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !5, !invariant.load !13
  %1 = load i32, ptr %__c2, align 4, !tbaa !5, !invariant.load !13
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !39, !invariant.load !13
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !40, !invariant.load !13
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !43, !invariant.load !13
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !19, !invariant.load !13
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !44, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !45, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !19, !invariant.load !13
  br label %return
...
!31 = !{!32, !35, i64 232}
!32 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !21, i64 0, !33, i64 216, !7, i64 224, !34, i64 225, !35, i64 232, !36, i64 240, !37, i64 248, !38, i64 256}
!33 = !{!"p1 _ZTSSo", !26, i64 0}
!34 = !{!"bool", !7, i64 0}
!35 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !26, i64 0}
!36 = !{!"p1 _ZTSSt5ctypeIcE", !26, i64 0}
!37 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !26, i64 0}
!38 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !26, i64 0}
!39 = !{!21, !24, i64 32}
!40 = !{!41, !42, i64 16}
!41 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !42, i64 8, !42, i64 16, !42, i64 24, !42, i64 32, !42, i64 40, !42, i64 48, !29, i64 56}
!42 = !{!"p1 omnipotent char", !26, i64 0}
!43 = !{!41, !42, i64 24}
!44 = !{!32, !36, i64 240}
!45 = !{!46, !7, i64 56}
!46 = !{!"_ZTSSt5ctypeIcE", !47, i64 0, !48, i64 16, !34, i64 24, !49, i64 32, !49, i64 40, !50, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!47 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!48 = !{!"p1 _ZTS15__locale_struct", !26, i64 0}
!49 = !{!"p1 int", !26, i64 0}
!50 = !{!"p1 short", !26, i64 0}
