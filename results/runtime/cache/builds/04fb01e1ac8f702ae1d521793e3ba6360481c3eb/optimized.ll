...
for.end:                                          ; preds = %for.cond
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEj(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %2)
  br label %if.end
...
for.cond6:                                        ; preds = %for.inc12, %for.body5
  %.sink8 = phi i32 [ 0, %for.body5 ], [ %inc13, %for.inc12 ]
  %cmp7 = icmp slt i32 %.sink8, 39
  br i1 %cmp7, label %for.inc12, label %for.end14

for.inc12:                                        ; preds = %for.cond6
  %idxprom = sext i32 %.sink8 to i64
...
for.cond15:                                       ; preds = %for.inc30, %for.end14
  %.sink9 = phi i32 [ 0, %for.end14 ], [ %add, %for.inc30 ]
  %cmp16 = icmp sle i32 %.sink9, 39
  br i1 %cmp16, label %for.inc30, label %for.inc33

for.inc30:                                        ; preds = %for.cond15
  %idxprom18 = sext i32 %.sink9 to i64
