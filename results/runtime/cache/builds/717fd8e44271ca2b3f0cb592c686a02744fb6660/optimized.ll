...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv5 = phi i64 [ %indvars.iv.next6.pre-phi, %for.inc18 ], [ 0, %for.cond ]
...
if.then:                                          ; preds = %for.body3
  ...
  %cmp14 = icmp eq i64 %indvars.iv5, %6
  %inc16 = zext i1 %cmp14 to i32
  %spec.select = add nsw i32 %k.1, %inc16
  br label %for.inc18

for.inc18:                                        ; preds = %for.body3, %if.then
  %indvars.iv.next6.pre-phi = phi i64 [ %4, %if.then ], [ %4, %for.body3 ]
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv10 = phi i64 [ %0, %for.cond22.preheader ], [ %8, %for.inc28 ]
  %7 = trunc nuw i64 %indvars.iv10 to i32
  %cmp23 = icmp sgt i32 %7, 0
  br i1 %cmp23, label %for.inc28, label %for.end30

for.inc28:                                        ; preds = %for.cond22
  %8 = add nsw i64 %indvars.iv10, -1
