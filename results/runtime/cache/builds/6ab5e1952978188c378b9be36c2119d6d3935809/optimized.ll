...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 dereferenceable(40) %letter) #12
...
for.body:                                         ; preds = %for.cond
  call void @llvm.memset.p0.i64(ptr noundef align 16 %letter, i8 noundef 48, i64 noundef 40, i1 noundef false)
  ...
  %call4 = call i64 @strlen(ptr noundef %letter) #13
...
if.end:                                           ; preds = %for.body
  %num.1 = phi i32 [ %num.0, %for.body ]
  %blank.1 = phi i32 [ %blank.0, %for.body ]
  %tobool = icmp ne i32 %blank.1, 0
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  %blank.15 = phi i32 [ 0, %if.end.thread ], [ %blank.1, %if.then9 ], [ %blank.1, %if.end ]
  %num.14 = phi i32 [ 0, %if.end.thread ], [ %num.1, %if.then9 ], [ %num.1, %if.end ]
  ...
  %conv16 = sext i32 %blank.15 to i64
  %add17 = add i64 %call15, %conv16
  %conv18 = sext i32 %num.14 to i64
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %letter) #14
  ret i32 0
}
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) #14
