...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv17, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc24
  %indvars.iv24 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next25, %for.inc24 ]
  ...
  br i1 %exitcond29, label %for.cond27.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv20 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next21, %for.inc21 ]
  %exitcond = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond, label %for.inc24, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv24, i64 %indvars.iv20
...
for.body32:                                       ; preds = %for.cond30
  ...
  %arrayidx36 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv31, i64 %idxprom35
