...
for.cond:                                         ; preds = %for.cond.preheader, %if.end28
  %indvars.iv10 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next11, %if.end28 ]
  br label %for.cond2
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc25 ], [ 0, %for.end ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond9.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv5
...
for.cond:                                         ; preds = %for.cond.preheader, %if.end27
  %indvars.iv10 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next11, %if.end27 ]
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv10
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc24 ], [ 0, %for.end ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond9.not, label %if.end27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv5, i64 %indvars.iv10
...
for.cond.preheader:                               ; preds = %entry
  %wide.trip.count13 = zext nneg i32 %k to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv15 = phi i64 [ 2, %for.cond.preheader ], [ %indvars.iv.next16, %for.end ]
  %0 = add nsw i64 %indvars.iv15, -1
  br label %for.cond1

for.cond15.preheader:                             ; preds = %entry
  %1 = load i32, ptr @n, align 4, !tbaa !5
  %cmp16 = icmp sgt i32 %1, 2
  br i1 %cmp16, label %for.cond15.preheader4, label %for.end39

for.cond15.preheader4:                            ; preds = %for.cond15.preheader
  %sub21 = add i32 %k, -1
  %smax = call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond15

for.cond1:                                        ; preds = %for.cond, %for.inc
  %indvars.iv10 = phi i64 [ 0, %for.cond ], [ %indvars.iv.next11, %for.inc ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv10
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  %arrayidx10 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %0, i64 %indvars.iv10
...
for.cond15:                                       ; preds = %for.cond15.preheader4, %for.end36
  %indvars.iv6 = phi i64 [ 2, %for.cond15.preheader4 ], [ %indvars.iv.next7, %for.end36 ]
...
for.cond20:                                       ; preds = %for.cond15, %for.inc34
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end36, label %for.inc34

for.inc34:                                        ; preds = %for.cond20
  %arrayidx28 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv6
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %arrayidx33 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %3
...
for.inc17:                                        ; preds = %for.cond13
  tail call void @_Z7zerorowi(i32 noundef %.sink) #8
