...
for.inc57:                                        ; preds = %for.cond39
  %he.0.lcssa = phi i32 [ %he.0, %for.cond39 ]
  %idxprom53.lcssa = phi i64 [ %idxprom53, %for.cond39 ]
  %idxprom55.lcssa = phi i64 [ %idxprom55, %for.cond39 ]
  %arrayidx54 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom53.lcssa
  %arrayidx56 = getelementptr inbounds [101 x i32], ptr %arrayidx54, i64 0, i64 %idxprom55.lcssa
  store i32 %he.0.lcssa, ptr %arrayidx56, align 4, !tbaa !5
