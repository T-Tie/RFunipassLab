...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %3 = phi i32 [ %dec49, %for.inc48 ], [ %0, %for.end29 ]
  %cmp31 = icmp sge i32 %3, 1
...
for.cond33:                                       ; preds = %for.inc43, %for.body32
  %4 = phi i32 [ %dec, %for.inc43 ], [ %0, %for.body32 ]
  %cmp34 = icmp sge i32 %4, 1
...
for.inc48:                                        ; preds = %for.cond33
  %dec49 = add nsw i32 %3, -1
  br label %for.cond30, !llvm.loop !17

for.end50:                                        ; preds = %for.body35, %for.cond30
  %x2.0 = phi i32 [ 0, %for.cond30 ], [ %4, %for.body35 ]
  %sub = sub nsw i32 %x2.0, %x1.1
  %sub51 = sub nsw i32 %sub, 1
  %sub52 = sub nsw i32 %3, %i.1
