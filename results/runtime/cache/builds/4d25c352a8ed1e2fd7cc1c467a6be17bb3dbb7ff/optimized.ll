...
for.cond31:                                       ; preds = %for.inc50, %for.end30
  ...
  %3 = phi i32 [ %dec51, %for.inc50 ], [ %sub, %for.end30 ]
...
for.cond36:                                       ; preds = %for.inc47, %for.body34
  %4 = phi i32 [ %dec, %for.inc47 ], [ %sub, %for.body34 ]
  %cmp37 = icmp sge i32 %4, 0
...
for.inc50:                                        ; preds = %for.body39, %for.cond36
  %q.1 = phi i32 [ %q.0, %for.cond36 ], [ %4, %for.body39 ]
  %p.1 = phi i32 [ %p.0, %for.cond36 ], [ %3, %for.body39 ]
  %dec51 = add nsw i32 %3, -1
