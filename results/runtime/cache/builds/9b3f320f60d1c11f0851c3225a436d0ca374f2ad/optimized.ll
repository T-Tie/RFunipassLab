...
for.end92:                                        ; preds = %for.cond52
  ...
  %25 = load i32, ptr %arrayidx94, align 8, !tbaa !5
...
while.end:                                        ; preds = %while.cond11
  ...
  %call139 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %32)
  ...
  %dec141 = add nsw i32 %33, -1
  store i32 %dec141, ptr %t, align 4, !tbaa !5
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !26
