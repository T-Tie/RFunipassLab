...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond24, label %for.cond15, label %for.cond4
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond34 = icmp eq i64 %indvars.iv30, %wide.trip.count23
  br i1 %exitcond34, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv30
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv30
  br label %for.cond21
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond39 = icmp eq i64 %indvars.iv35, %wide.trip.count23
  br i1 %exitcond39, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv35
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count44 = zext nneg i32 %smax43 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count44
  br i1 %exitcond45.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv40
