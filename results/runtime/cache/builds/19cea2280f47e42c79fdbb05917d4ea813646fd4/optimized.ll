...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %p) #5
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %q) #5
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc34
  %indvars.iv47 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next48, %for.inc34 ]
  %exitcond53.not = icmp eq i64 %indvars.iv47, %wide.trip.count52
  br i1 %exitcond53.not, label %for.cond37.preheader, label %for.body12
...
for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [8 x i32], ptr %p, i64 0, i64 %indvars.iv47
  store i32 0, ptr %arrayidx14, align 4, !tbaa !5
  br label %for.cond15

for.cond15:                                       ; preds = %for.body17, %for.body12
  %5 = phi i32 [ %spec.store.select, %for.body17 ], [ 0, %for.body12 ]
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body17 ], [ 0, %for.body12 ]
  %exitcond.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond.not, label %for.inc34, label %for.body17

for.body17:                                       ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv44
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %idxprom26 = sext i32 %5 to i64
  %arrayidx27 = getelementptr inbounds [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %idxprom26
  %7 = load i32, ptr %arrayidx27, align 4, !tbaa !5
  %cmp28 = icmp sgt i32 %6, %7
  %8 = trunc nuw nsw i64 %indvars.iv44 to i32
  %spec.store.select = select i1 %cmp28, i32 %8, i32 %5
  store i32 %spec.store.select, ptr %arrayidx14, align 4
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc63
  %indvars.iv59 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next60, %for.inc63 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count63
  br i1 %exitcond64.not, label %for.cond66, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [8 x i32], ptr %q, i64 0, i64 %indvars.iv59
  store i32 0, ptr %arrayidx41, align 4, !tbaa !5
  br label %for.cond42

for.cond42:                                       ; preds = %for.body44, %for.body39
  %9 = phi i32 [ %spec.store.select37, %for.body44 ], [ 0, %for.body39 ]
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.body44 ], [ 0, %for.body39 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count52
  br i1 %exitcond58.not, label %for.inc63, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv59
  %10 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %idxprom51 = sext i32 %9 to i64
  %arrayidx54 = getelementptr inbounds [8 x [8 x i32]], ptr %a, i64 0, i64 %idxprom51, i64 %indvars.iv59
  %11 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  %cmp55 = icmp slt i32 %10, %11
  %12 = trunc nuw nsw i64 %indvars.iv54 to i32
  %spec.store.select37 = select i1 %cmp55, i32 %12, i32 %9
  store i32 %spec.store.select37, ptr %arrayidx41, align 4
...
for.cond66:                                       ; preds = %for.cond37, %for.inc84
  %.pre74 = phi i32 [ %.pre, %for.inc84 ], [ %0, %for.cond37 ]
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc84 ], [ 0, %for.cond37 ]
  %r.0 = phi i32 [ %r.1, %for.inc84 ], [ 0, %for.cond37 ]
  %13 = sext i32 %.pre74 to i64
  %cmp67 = icmp slt i64 %indvars.iv71, %13
  br i1 %cmp67, label %for.cond69.preheader, label %for.end86

for.cond69.preheader:                             ; preds = %for.cond66
  %14 = load i32, ptr %n, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [8 x i32], ptr %p, i64 0, i64 %indvars.iv71
  %smax68 = call i32 @llvm.smax.i32(i32 %14, i32 0)
  %wide.trip.count69 = zext nneg i32 %smax68 to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc81
  %indvars.iv65 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next66, %for.inc81 ]
  %exitcond70.not = icmp eq i64 %indvars.iv65, %wide.trip.count69
  br i1 %exitcond70.not, label %for.inc84, label %for.body71

for.body71:                                       ; preds = %for.cond69
  %15 = load i32, ptr %arrayidx73, align 4, !tbaa !5
  %16 = zext i32 %15 to i64
  %cmp74 = icmp eq i64 %indvars.iv65, %16
  br i1 %cmp74, label %land.lhs.true, label %for.inc81

land.lhs.true:                                    ; preds = %for.body71
  %arrayidx76 = getelementptr inbounds nuw [8 x i32], ptr %q, i64 0, i64 %indvars.iv65
  %17 = load i32, ptr %arrayidx76, align 4, !tbaa !5
  %18 = zext i32 %17 to i64
  %cmp77 = icmp eq i64 %indvars.iv71, %18
  br i1 %cmp77, label %if.then78, label %for.inc81

if.then78:                                        ; preds = %land.lhs.true
  %19 = trunc nuw nsw i64 %indvars.iv65 to i32
  %20 = trunc nuw nsw i64 %indvars.iv71 to i32
  %call79 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %20, i32 noundef %19)
...
for.inc84:                                        ; preds = %for.cond69, %if.then78
  %.pre = phi i32 [ %.pre.pre, %if.then78 ], [ %.pre74, %for.cond69 ]
...
if.end90:                                         ; preds = %if.then88, %for.end86
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %q) #5
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %p) #5
