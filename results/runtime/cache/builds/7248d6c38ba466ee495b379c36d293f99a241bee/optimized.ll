...
for.cond3:                                        ; preds = %if.end24, %for.end
  %j.0 = phi i32 [ 1, %for.end ], [ %inc26, %if.end24 ]
...
for.body5:                                        ; preds = %for.cond3
  ...
  br i1 %cmp9, label %if.end24, label %if.else

if.else:                                          ; preds = %for.body5
  %sub15 = fsub float %8, %7
  %conv16 = fpext float %sub15 to double
  %cmp17 = fcmp ogt double %conv16, 5.000000e-02
  br i1 %cmp17, label %if.end24, label %if.else21

if.else21:                                        ; preds = %if.else
  br label %if.end24

if.end24:                                         ; preds = %if.else, %for.body5, %if.else21
