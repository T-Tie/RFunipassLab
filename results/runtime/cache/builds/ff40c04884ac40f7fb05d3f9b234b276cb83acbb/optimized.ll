...
for.inc:                                          ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv36
...
for.cond10:                                       ; preds = %for.cond10.loopexit, %for.cond10.preheader
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.cond10.loopexit ], [ %1, %for.cond10.preheader ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  ...
  %cmp14 = icmp slt i64 %indvars.iv.next26, %1
