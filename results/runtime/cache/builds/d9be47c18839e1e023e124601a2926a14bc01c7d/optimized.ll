...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  br i1 %exitcond57.not, label %for.cond66, label %for.inc95, !llvm.loop !18
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !26, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !50, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !23, !invariant.load !9
