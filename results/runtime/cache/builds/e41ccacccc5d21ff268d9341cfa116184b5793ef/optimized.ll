...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %total) #5
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %valid) #5
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %t1) #5
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %v1) #5
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %v1) #5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %t1) #5
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %valid) #5
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %total) #5
  ret i32 0
}
