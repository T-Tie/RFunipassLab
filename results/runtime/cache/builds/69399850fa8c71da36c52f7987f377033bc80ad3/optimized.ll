...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20500, ptr nonnull %a) #8
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %b) #8
  br label %for.cond
...
if.then6.i:                                       ; preds = %for.body
  ...
  %3 = load i64, ptr %gep99, align 8, !tbaa !11
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_1(ptr %__c.addr.i)
  br label %for.inc31
...
for.end33:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0(ptr %gep101)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit33: ; preds = %for.cond45
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i34)
  call fastcc void @outlined_ir_func_1(ptr %__c.addr.i34)
  br label %for.inc54

for.inc54:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit33
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i34)
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 2000, ptr nonnull %b) #8
  call void @llvm.lifetime.end.p0(i64 20500, ptr nonnull %a) #8
...
for.end33_to_outline:                             ; preds = %newFuncRoot
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #8
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline: ; preds = %newFuncRoot
  store i8 32, ptr %0, align 1, !tbaa !38
  ...
  %1 = load i64, ptr %gep100, align 8, !tbaa !11
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline: ; preds = %newFuncRoot
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #8
