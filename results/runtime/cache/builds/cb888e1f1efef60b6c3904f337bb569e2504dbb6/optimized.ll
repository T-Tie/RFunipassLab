...
entry:
  ...
  %rem141 = srem i8 %rem1.lhs.trunc, 50
  %rem1.sext = sext i8 %rem141 to i32
  %sub2 = sub nsw i32 %rem, %rem1.sext
  %div3.lhs.trunc = trunc nsw i32 %sub2 to i16
  %div342 = sdiv i16 %div3.lhs.trunc, 50
  %div3.sext = sext i16 %div342 to i32
  %rem443 = srem i8 %rem141, 20
  %div644 = sdiv i8 %rem141, 20
  %div6.sext = sext i8 %div644 to i32
  %rem745 = srem i8 %rem443, 10
  %rem7.sext = sext i8 %rem745 to i32
  %div946 = sdiv i8 %rem443, 10
  %div9.sext = sext i8 %div946 to i32
  store i32 %rem7.sext, ptr %n, align 4, !tbaa !5
  %rem1047 = srem i8 %rem745, 5
  %rem10.sext = sext i8 %rem1047 to i32
  %div1248 = sdiv i8 %rem745, 5
  %div12.sext = sext i8 %div1248 to i32
  ...
  %vtable.i = load ptr, ptr %call13, align 8, !tbaa !9, !invariant.load !11
  ...
  %vtable.i7 = load ptr, ptr %call15, align 8, !tbaa !9, !invariant.load !11
  ...
  %vtable.i13 = load ptr, ptr %call17, align 8, !tbaa !9, !invariant.load !11
  ...
  %vtable.i20 = load ptr, ptr %call19, align 8, !tbaa !9, !invariant.load !11
  ...
  %vtable.i27 = load ptr, ptr %call21, align 8, !tbaa !9, !invariant.load !11
  ...
  %vtable.i34 = load ptr, ptr %call23, align 8, !tbaa !9, !invariant.load !11
