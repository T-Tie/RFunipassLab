...
define internal fastcc void @outlined_ir_func_0(ptr %0) unnamed_addr #8 {
newFuncRoot:
  br label %for.end33_to_outline

for.end33_to_outline:                             ; preds = %newFuncRoot
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #10
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0) unnamed_addr #8 {
newFuncRoot:
