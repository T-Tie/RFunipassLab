...
for.cond3:                                        ; preds = %for.cond, %for.body5
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body5 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp4 = icmp slt i64 %indvars.iv8, %8
  br i1 %cmp4, label %for.body5, label %for.end27

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv8
