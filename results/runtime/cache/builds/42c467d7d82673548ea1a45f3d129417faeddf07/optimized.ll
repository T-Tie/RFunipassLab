...
for.inc17:                                        ; preds = %for.cond13
  call void @_Z7zerorowi(i32 noundef %.sink)
  %2 = load i32, ptr @k, align 4, !tbaa !5
  call void @_Z7zerocoli(i32 noundef %2)
  %3 = load i32, ptr getelementptr inbounds ([101 x i32], ptr getelementptr inbounds ([101 x [101 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
  ...
  call void @_Z4jiani(i32 noundef %5)
