...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc35
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre31, %for.inc35 ]
  %indvars.iv28 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next29, %for.inc35 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv28, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv28
