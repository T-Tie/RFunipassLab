...
for.inc43:                                        ; preds = %for.cond37
  ...
  call fastcc void @outlined_ir_func_0(i8 %17, ptr nonnull %__c.addr.i)
...
for.inc54:                                        ; preds = %for.cond48
  ...
  call fastcc void @outlined_ir_func_0(i8 %20, ptr nonnull %__c.addr.i97)
...
define internal fastcc void @outlined_ir_func_0(i8 %0, ptr initializes((0, 1)) %1) unnamed_addr #8 {
...
if.then.i:                                        ; preds = %for.body39_to_outline
  %call1.i87 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %1, i64 noundef 1)
