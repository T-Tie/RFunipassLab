...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %montho) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr %montht) #4
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %montht) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %montho) #4
...
if.end:                                           ; preds = %if.else33, %if.then31
  %.sink = phi i32 [ 28, %if.else33 ], [ 29, %if.then31 ]
  %add34 = add nsw i32 %result.0, %.sink
  br label %if.end35

if.end35:                                         ; preds = %if.end, %if.else22
  %result.3 = phi i32 [ %add34, %if.end ], [ %result.0, %if.else22 ]
  br label %if.end36

if.end36:                                         ; preds = %if.end35, %if.then20
  %result.2 = phi i32 [ %add21, %if.then20 ], [ %result.3, %if.end35 ]
  br label %if.end37

if.end37:                                         ; preds = %if.end36, %if.then
  %result.1 = phi i32 [ %add, %if.then ], [ %result.2, %if.end36 ]
  br label %for.inc
