...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call15 = call double @sqrt(double noundef %4) #8, !tbaa !5
  %add = fadd double %fneg, %call15
  %mul = fmul double 2.000000e+00, %2
  %div = fdiv double %add, %mul
  %call21 = call double @sqrt(double noundef %4) #8, !tbaa !5
...
if.then30:                                        ; preds = %if.else
  ...
  %call36 = call double @sqrt(double noundef %4) #8, !tbaa !5
  %add37 = fadd double %fneg31, %call36
  %mul38 = fmul double 2.000000e+00, %2
  %div39 = fdiv double %add37, %mul38
  %call45 = call double @sqrt(double noundef %4) #8, !tbaa !5
...
if.end67:                                         ; preds = %if.then56, %if.then58
  ...
  %call72 = call double @sqrt(double noundef %5) #8, !tbaa !5
