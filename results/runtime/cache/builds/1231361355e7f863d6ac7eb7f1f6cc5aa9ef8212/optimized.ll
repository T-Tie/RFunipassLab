...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax38 = tail call i32 @llvm.smax.i32(i32 %indvars.iv12.in, i32 noundef 0)
  %wide.trip.count23 = zext nneg i32 %smax38 to i64
  %wide.trip.count = zext i32 %indvars.iv12.in to i64
  br label %for.cond
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv12.in, ptr @k, align 4, !tbaa !5
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond, !llvm.loop !14

for.cond27:                                       ; preds = %for.cond, %for.inc62
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc62 ], [ 0, %for.cond ]
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  ...
  %min.1 = phi i32 [ %spec.select4, %for.body34 ], [ %3, %for.body29 ]
...
for.body34:                                       ; preds = %for.cond32
  ...
  %spec.select4 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.1)
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond32, !llvm.loop !15

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc59 ], [ 0, %for.cond51.preheader ]
...
for.end64:                                        ; preds = %for.cond27
  ...
  %smax49 = tail call i32 @llvm.smax.i32(i32 %indvars.iv12, i32 noundef 1)
  %6 = zext i32 %indvars.iv12 to i64
  %cmp65 = icmp eq i32 %indvars.iv12.in, 2
...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  %exitcond45.not = icmp eq i64 %indvars.iv41, %6
  br i1 %exitcond45.not, label %for.cond66, label %for.inc95, !llvm.loop !18
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre23, %for.inc ], [ %storemerge3, %for.cond1 ]
...
for.inc:                                          ; preds = %for.cond4
  ...
  %.pre23 = load i32, ptr @j, align 4, !tbaa !5
...
for.inc26:                                        ; preds = %for.cond19
  ...
  %vtable.i = load ptr, ptr %call24, align 8, !tbaa !23, !invariant.load !9
