...
if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %a) #9
...
cleanup:                                          ; preds = %for.cond9, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull align 16 %a) #9
  br label %return
