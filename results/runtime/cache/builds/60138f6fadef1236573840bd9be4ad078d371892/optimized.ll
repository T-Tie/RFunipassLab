...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax48 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count19 = zext nneg i32 %smax48 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond28.preheader, label %for.cond1

for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count24 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv11 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next12, %for.inc22 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond15.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv11
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv31 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next32, %for.inc63 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count19
  br i1 %exitcond36.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select9, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv31
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %spec.select9 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond31, !llvm.loop !14

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv26 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next27, %for.inc60 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count24
  br i1 %exitcond30.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv31
...
for.cond69.preheader:                             ; preds = %for.end65
  %wide.trip.count42 = zext i32 %t.tr to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv44 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next45, %for.inc125 ]
  %exitcond50.not = icmp eq i64 %indvars.iv44, %wide.trip.count19
  br i1 %exitcond50.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %5 = add nsw i64 %indvars.iv44, -1
  %arrayidx99 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv37 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next38, %for.inc122 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv37, 2
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv37
  %8 = load i32, ptr %arrayidx89, align 4, !tbaa !5
  %9 = add nsw i64 %indvars.iv37, -1
...
if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv37
