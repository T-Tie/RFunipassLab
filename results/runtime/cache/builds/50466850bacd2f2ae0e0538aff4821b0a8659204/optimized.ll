...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax52 = call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond16, label %for.cond26.preheader, label %for.cond2

for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count20 = zext i32 %indvars.iv5 to i64
  br label %for.cond26
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv7 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next8, %for.inc20 ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv27 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next28, %for.inc57 ]
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv22 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next23, %for.inc54 ]
  %exitcond26 = icmp eq i64 %indvars.iv22, %wide.trip.count20
...
for.cond80.preheader:                             ; preds = %for.cond60
  ...
  %wide.trip.count47 = zext i32 %n.tr to i64
  br label %for.cond80
