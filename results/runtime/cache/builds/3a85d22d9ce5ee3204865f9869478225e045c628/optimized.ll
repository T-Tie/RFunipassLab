...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  ...
  br i1 %exitcond12.not, label %for.cond31, label %for.cond2
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc24 ], [ 0, %for.cond16.preheader ]
...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc67 ], [ 0, %for.cond ]
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc64 ], [ 0, %for.cond55.preheader ]
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  ...
  br i1 %exitcond40.not, label %for.cond96, label %for.cond76.preheader
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc117 ], [ 2, %for.cond71 ]
