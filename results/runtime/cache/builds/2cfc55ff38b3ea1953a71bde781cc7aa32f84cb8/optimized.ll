...
for.cond:                                         ; preds = %for.inc, %if.then
  ...
  br i1 %cmp1, label %for.body, label %if.end18.loopexit
...
for.cond4:                                        ; preds = %for.inc15, %if.else
  ...
  br i1 %cmp6, label %for.body7, label %if.end18.loopexit1
...
if.end18.loopexit1:                               ; preds = %for.cond4
  %sum.3.lcssa = phi i32 [ %sum.3, %for.cond4 ]
  br label %if.end18

if.end18:                                         ; preds = %if.end18.loopexit1, %if.end18.loopexit
  %sum.2 = phi i32 [ %sum.0.lcssa, %if.end18.loopexit ], [ %sum.3.lcssa, %if.end18.loopexit1 ]
  ret i32 %sum.2
}
