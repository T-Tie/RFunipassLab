...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z8DiJiTianiii(i32 noundef %2, i32 noundef %3, i32 noundef 1) #6
  %4 = load i32, ptr %montho, align 4, !tbaa !5
  %call3 = call noundef i32 @_Z8DiJiTianiii(i32 noundef %2, i32 noundef %4, i32 noundef 1) #6
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %montht) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %montho) #7
