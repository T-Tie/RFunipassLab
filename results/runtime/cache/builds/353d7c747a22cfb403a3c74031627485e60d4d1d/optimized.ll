...
while.body:                                       ; preds = %while.cond
  call void @_Z8multiplyPci(ptr noundef nonnull align 16 dereferenceable(200) %str, i32 noundef 2) #9
  %dec = add nsw i32 %0, -1
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  br i1 %cmp.not, label %while.cond8.preheader, label %while.body
...
while.cond8:                                      ; preds = %while.cond8.preheader, %while.body12
  %jump.0 = phi i32 [ %div, %while.body12 ], [ 0, %while.cond8.preheader ]
  %nPtr.1.idx = phi i64 [ %nPtr.1.add, %while.body12 ], [ 796, %while.cond8.preheader ]
  %cmp11.not = icmp eq i64 %nPtr.1.idx, -4
  br i1 %cmp11.not, label %while.cond17.preheader, label %while.body12
...
while.cond17:                                     ; preds = %while.cond17.preheader, %while.cond17
  %nPtr.2.idx = phi i64 [ %nPtr.2.add, %while.cond17 ], [ 0, %while.cond17.preheader ]
  ...
  br i1 %cmp18, label %while.cond17, label %while.cond22.preheader, !llvm.loop !18

while.cond22.preheader:                           ; preds = %while.cond17
  br label %while.cond22

while.cond22:                                     ; preds = %while.cond22.preheader, %while.body26
  %sPtr.1 = phi ptr [ %incdec.ptr30, %while.body26 ], [ %str, %while.cond22.preheader ]
  %nPtr.3.idx = phi i64 [ %nPtr.3.add, %while.body26 ], [ %nPtr.2.idx, %while.cond22.preheader ]
