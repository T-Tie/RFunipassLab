...
for.end87:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull %total1.0.loc)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull %total2.0.loc)
