...
if.end:                                           ; preds = %if.then10, %if.else
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i11) #5
  store i32 0, ptr %i11, align 4, !tbaa !5
  br label %for.cond12

for.cond12:                                       ; preds = %for.inc39, %if.end
  %5 = load i32, ptr %i11, align 4, !tbaa !5
  %6 = load i32, ptr %c2.addr, align 4, !tbaa !5
  %cmp13 = icmp slt i32 %5, %6
  br i1 %cmp13, label %for.body15, label %for.cond.cleanup14

for.cond.cleanup14:                               ; preds = %for.cond12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %i11) #5
  br label %for.end41
...
for.end41:                                        ; preds = %for.cond.cleanup14
  ...
  call void @_Z3sumii(i32 noundef %add42, i32 noundef %6)
  br label %if.end43
