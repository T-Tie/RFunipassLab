...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond27 = select i1 %cmp8, i1 true, i1 %or.cond
  %inc19 = zext i1 %or.cond27 to i32
  %spec.select28 = add nsw i32 %a.0, %inc19
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %for.body
  %a.1 = phi i32 [ %a.0, %for.body ], [ %spec.select28, %land.lhs.true ]
...
for.cond26:                                       ; preds = %for.end, %for.inc51
  %.sink = phi i32 [ %inc52, %for.inc51 ], [ 65, %for.end ]
  %exitcond.not = icmp eq i32 %.sink, 91
  br i1 %exitcond.not, label %for.cond54, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv30
...
if.then46:                                        ; preds = %for.end44
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink, i32 noundef %t.1) #5
  br label %for.inc51

for.inc51:                                        ; preds = %for.end44, %if.then46
  %inc52 = add nuw nsw i32 %.sink, 1
  br label %for.cond26, !llvm.loop !13

for.cond54:                                       ; preds = %for.cond26, %for.inc80
  %.sink17 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.cond26 ]
  %exitcond36.not = icmp eq i32 %.sink17, 123
  br i1 %exitcond36.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select26, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv33
  %3 = load i8, ptr %arrayidx59, align 1, !tbaa !5, !invariant.load !11
...
for.body62:                                       ; preds = %for.cond57
  ...
  %cmp66 = icmp eq i32 %.sink17, %conv60
...
if.then74:                                        ; preds = %for.end72
  %call78 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink17, i32 noundef %l.1) #5
  br label %for.inc80

for.inc80:                                        ; preds = %for.end72, %if.then74
  %inc81 = add nuw nsw i32 %.sink17, 1
