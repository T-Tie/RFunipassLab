...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select6 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select6
  ...
  %or.cond7 = or i1 %cmp12, %or.cond
  %smax8 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond7, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %x.1 = phi i32 [ %add18, %for.inc ], [ 0, %for.body ]
  %exitcond9.not = icmp eq i32 %m.0, %smax8
  br i1 %exitcond9.not, label %for.inc53, label %for.body16
...
for.inc:                                          ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %sw.bb17, %sw.default
  ...
  %add18 = add nuw nsw i32 %.sink1, %x.1
  %inc = add i32 %m.0, 1
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax8
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.110 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.110)
  %call50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call26, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
