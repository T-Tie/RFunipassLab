...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax83 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
...
for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count49 = zext i32 %n.tr to i64
  br label %for.cond31
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count65 = zext i32 %n.tr to i64
  br label %for.cond71
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !29, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !37, !invariant.load !14
  br label %return
...
!29 = !{!30, !7, i64 56}
!30 = !{!"_ZTSSt5ctypeIcE", !31, i64 0, !32, i64 16, !34, i64 24, !35, i64 32, !35, i64 40, !36, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!31 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!32 = !{!"p1 _ZTS15__locale_struct", !33, i64 0}
!33 = !{!"any pointer", !7, i64 0}
!34 = !{!"bool", !7, i64 0}
!35 = !{!"p1 int", !33, i64 0}
!36 = !{!"p1 short", !33, i64 0}
!37 = !{!7, !7, i64 0}
