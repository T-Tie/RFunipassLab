...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %d) #11
...
for.inc:                                          ; preds = %if.else, %land.lhs.true, %if.else17
  %.str.2.sink = phi ptr [ @.str.2, %if.else17 ], [ @.str, %land.lhs.true ], [ @.str.1, %if.else ]
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(5) %.str.2.sink)
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %d) #11
...
for.inc.exitStub:
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
