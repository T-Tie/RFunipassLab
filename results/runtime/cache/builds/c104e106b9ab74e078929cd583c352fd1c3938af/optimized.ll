...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre34, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond33.not, label %for.end33, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv24 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next25, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv24
...
for.end50:                                        ; preds = %for.body40, %for.cond38
  %.lcssa = phi i32 [ %9, %for.body40 ], [ -1, %for.cond38 ]
  %x2.2 = phi i32 [ %8, %for.body40 ], [ %x2.0, %for.cond38 ]
  %y2.2 = phi i32 [ %9, %for.body40 ], [ %y2.0, %for.cond38 ]
