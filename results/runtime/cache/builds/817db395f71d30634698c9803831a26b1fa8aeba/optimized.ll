...
entry:
  ...
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 8 dereferenceable(8) %v1)
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %arrayidx)
  %arrayidx5 = getelementptr inbounds nuw [10000 x double], ptr %valid, i64 0, i64 %indvars.iv
  %call.i5 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i4, ptr noundef nonnull align 8 dereferenceable(8) %arrayidx5)
...
if.then24:                                        ; preds = %if.end
  %call1.i8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 6)
  %vtable.i16 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !11
...
lor.lhs.false:                                    ; preds = %if.end27
  ...
  %or.cond30 = and i1 %cmp39, %cmp44
  br i1 %or.cond30, label %if.then45, label %for.inc
...
if.then45:                                        ; preds = %lor.lhs.false, %if.end27
  ...
  %vtable.i23 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !11
  %vbase.offset.ptr.i24 = getelementptr i8, ptr %vtable.i23, i64 -24
  %vbase.offset.i25 = load i64, ptr %vbase.offset.ptr.i24, align 8, !invariant.load !13
