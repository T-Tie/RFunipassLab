...
for.body4:                                        ; preds = %for.cond2
  %call5 = call noundef i32 @_Z1Fi(i32 noundef %2) #6
  %cmp6 = icmp slt i32 %4, %call5
  br i1 %cmp6, label %if.then, label %for.inc8

if.then:                                          ; preds = %for.body4
  %call7 = call noundef i32 @_Z1Fi(i32 noundef %2) #6
...
for.end10:                                        ; preds = %for.cond2
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %4) #6
...
for.end:                                          ; preds = %for.cond
  %4 = load i32, ptr %z, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %z) #5
