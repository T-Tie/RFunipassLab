...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv12 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next13, %for.inc28 ]
  ...
  br i1 %exitcond17.not, label %for.cond31.preheader, label %for.body12
...
for.cond14.preheader:                             ; preds = %for.body12
  %4 = trunc nuw nsw i64 %indvars.iv12 to i32
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv8 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next9, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv12, i64 %indvars.iv8
  %5 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !13
  %cmp21 = icmp eq i32 %5, 0
  %6 = trunc nuw nsw i64 %indvars.iv8 to i32
  %b1.2 = select i1 %cmp21, i32 %6, i32 %b1.1
  %a1.2 = select i1 %cmp21, i32 %4, i32 %a1.1
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv23 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next24, %for.inc52 ]
  ...
  %cmp32 = icmp sgt i64 %indvars.iv23, 0
...
for.cond37.preheader:                             ; preds = %for.body33
  %7 = trunc nsw i64 %indvars.iv.next24 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv19 = phi i64 [ %wide.trip.count, %for.cond37.preheader ], [ %indvars.iv.next20, %for.body39 ]
  ...
  %8 = trunc nuw i64 %indvars.iv19 to i32
  %cmp38 = icmp sgt i32 %8, 0
  br i1 %cmp38, label %for.body39, label %for.inc52

for.body39:                                       ; preds = %for.cond37
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, -1
  %indvars = trunc i64 %indvars.iv.next20 to i32
  %idxprom42 = and i64 %indvars.iv.next20, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next24, i64 %idxprom42
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %cmp44 = icmp eq i32 %9, 0
  %a2.2 = select i1 %cmp44, i32 %7, i32 %a2.1
