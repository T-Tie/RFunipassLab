...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %m) #6
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %d) #6
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv24 = phi i64 [ %3, %for.cond10.preheader ], [ %indvars.iv.next25, %for.cond13 ]
  %indvars.iv18 = phi i64 [ %2, %for.cond10.preheader ], [ %indvars.iv.next19, %for.cond13 ]
  %indvars.iv.next25 = add nsw i64 %indvars.iv24, -1
  %indvars.iv.next19 = add nsw i64 %indvars.iv18, -1
  %cmp11 = icmp sgt i64 %indvars.iv24, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next25
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next25
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv20 = phi i64 [ %indvars.iv18, %for.cond13.preheader ], [ %indvars.iv.next21, %for.inc31 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx19 = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv20
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv20
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %9, %for.end35 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv27
...
for.end49:                                        ; preds = %for.cond37
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %d) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %i) #6
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %m) #6
