...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %y, i32 noundef 0) #6
  %smax18 = call i32 @llvm.smax.i32(i32 noundef %x, i32 noundef 0) #6
...
for.cond:                                         ; preds = %for.end, %entry
  ...
  br i1 %exitcond20.not, label %for.end9, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [150 x i32], ptr %z, i64 %indvars.iv15, i64 %indvars.iv
...
for.cond:                                         ; preds = %for.end28, %entry
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end28 ], [ 0, %entry ]
  %4 = load i32, ptr %m, align 4, !tbaa !8
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv22, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !8
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv19, %7
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !8, !invariant.load !12
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv19
...
for.end:                                          ; preds = %for.cond6
  ...
  %cmp15 = icmp slt i64 %indvars.iv19, %11
  br i1 %cmp15, label %for.inc26, label %if.else

if.else:                                          ; preds = %for.end
  %12 = zext i32 %sub to i64
  %cmp18 = icmp eq i64 %indvars.iv19, %12
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv22, %14
