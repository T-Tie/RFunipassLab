...
for.cond21:                                       ; preds = %for.inc39, %for.body19
  %i.sink = phi ptr [ %i, %for.body19 ], [ %j, %for.inc39 ]
  %5 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add20 = add nsw i32 %5, 1
  store i32 %add20, ptr %j, align 4, !tbaa !5
...
for.body53:                                       ; preds = %for.cond49
  ...
  %9 = load i32, ptr %arrayidx55, align 4, !tbaa !5, !invariant.load !10
  %cmp56 = icmp eq i32 %9, %7
...
if.then57:                                        ; preds = %for.body53
  ...
  store i32 %add60, ptr %z, align 4, !tbaa !5
  br label %for.inc63

for.inc63:                                        ; preds = %if.then57, %for.body53
  %inc64 = add nsw i32 %8, 1
...
for.cond74:                                       ; preds = %for.inc83, %if.else71
  ...
  %cmp75 = icmp slt i32 %11, %.pr
  br i1 %cmp75, label %for.inc83, label %if.end86

for.inc83:                                        ; preds = %for.cond74
  %idxprom77 = sext i32 %11 to i64
  %arrayidx78 = getelementptr inbounds [500 x i32], ptr %c, i64 0, i64 %idxprom77
  %12 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !10
  %idxprom79 = sext i32 %12 to i64
