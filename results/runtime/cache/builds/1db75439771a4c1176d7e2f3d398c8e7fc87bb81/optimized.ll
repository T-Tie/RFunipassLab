...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv23, %1
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre40, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc24
  %indvars.iv30 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next31, %for.inc24 ]
  ...
  br i1 %exitcond35, label %for.cond27.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv26 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next27, %for.inc21 ]
  %exitcond = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond, label %for.inc24, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv30, i64 %indvars.iv26
  %8 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %cmp20 = icmp eq i32 %8, 0
  br i1 %cmp20, label %for.inc24.split.loop.exit42, label %for.inc21

for.inc21:                                        ; preds = %for.body15
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond13, !llvm.loop !14

for.inc24.split.loop.exit42:                      ; preds = %for.body15
  %9 = trunc nuw nsw i64 %indvars.iv26 to i32
  br label %for.inc24

for.inc24:                                        ; preds = %for.cond13, %for.inc24.split.loop.exit42
  %i1.1 = phi i32 [ %6, %for.inc24.split.loop.exit42 ], [ %i1.0, %for.cond13 ]
  %j1.1 = phi i32 [ %9, %for.inc24.split.loop.exit42 ], [ %j1.0, %for.cond13 ]
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond10, !llvm.loop !15

for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc42
  %indvars.iv37 = phi i64 [ %7, %for.cond27.preheader ], [ %indvars.iv.next38, %for.inc42 ]
...
for.body32:                                       ; preds = %for.cond30
  ...
  %arrayidx36 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv37, i64 %idxprom35
