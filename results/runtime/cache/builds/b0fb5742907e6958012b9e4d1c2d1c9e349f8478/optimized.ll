...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %dm) #5
...
for.end35:                                        ; preds = %for.cond10
  ...
  store i32 %9, ptr %dm, align 4, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.inc47, %for.end35
  ...
  %11 = load i32, ptr %dm, align 4, !tbaa !5
...
for.end49:                                        ; preds = %for.cond37
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %11) #7
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %dm) #7
