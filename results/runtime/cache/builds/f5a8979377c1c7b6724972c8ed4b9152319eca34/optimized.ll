...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc110 ], [ 0, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp50 = icmp slt i64 %indvars.iv13, %8
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv13
  %9 = load double, ptr %arrayidx53, align 8, !tbaa !9
  %cmp54 = fcmp ogt double %9, 0.000000e+00
  %10 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv13
  %11 = load double, ptr %10, align 8, !tbaa !9
  br i1 %cmp54, label %if.then55, label %if.else63

if.then55:                                        ; preds = %for.body51
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv13
...
if.else72:                                        ; preds = %if.else63
  ...
  %arrayidx99 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv13
  %13 = load double, ptr %arrayidx99, align 8, !tbaa !9
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %.sink2, double noundef %13, double noundef %.sink2, double noundef %13) #8
  br label %for.inc110
