...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %b) #9
...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %3 = add i64 %2, -1001
  %or.cond.i24 = icmp ult i64 %3, -1000
  %or.cond43 = select i1 %call16.i20, i1 %or.cond.i24, i1 false
  br i1 %or.cond43, label %if.then19.i25, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41
...
if.then19.i25:                                    ; preds = %if.then6.i10
  ...
  %call24.i30 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i29) #10
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41: ; preds = %if.then6.i10, %if.then19.i25, %if.then28.i36
...
if.end75:                                         ; preds = %for.body, %land.lhs.true, %for.end65, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41 ], [ %.str.3..str.2, %for.end65 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ]
