...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %initial) #9
  ...
  %call5 = call i64 @strlen(ptr noundef %initial) #10
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 41, ptr %word) #9
  ...
  %call9 = call i64 @strlen(ptr noundef %word) #10
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 41, ptr %word) #9
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr %initial) #9
