...
for.cond14:                                       ; preds = %for.inc24, %if.then
  ...
  %p.1 = phi i32 [ 0, %if.then ], [ %p.2, %for.inc24 ]
...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  ...
  %p.5 = phi i32 [ 0, %if.then35 ], [ %p.6, %for.inc48 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %6 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
...
for.inc48:                                        ; preds = %for.body39, %if.then45
  %a2.2 = phi i32 [ %i.2, %if.then45 ], [ %a2.1, %for.body39 ]
