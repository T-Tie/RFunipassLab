...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv46 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next47, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv46
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv54.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv54, %for.cond17 ]
  %.in = phi i32 [ %0, %for.cond14.preheader ], [ %4, %for.cond17 ]
  %indvars.iv54 = add i32 %indvars.iv54.in, -1
  %4 = add nsw i32 %.in, -1
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv50 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next51, %for.inc37 ]
  %exitcond57.not = icmp eq i64 %indvars.iv50, %wide.trip.count56
  br i1 %exitcond57.not, label %for.cond14, label %for.body19, !llvm.loop !13

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv50
  %5 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next51
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc50 ], [ %7, %for.end41 ]
  %sub44 = add nsw i32 %8, -1
  %9 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv58, %9
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv58
  %10 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %10) #6
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11) #6
