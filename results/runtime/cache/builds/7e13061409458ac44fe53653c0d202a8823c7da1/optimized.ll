...
for.inc:                                          ; preds = %for.body
  ...
  %reass.mul4 = add i32 %6, 43200
  %sub = add i32 %reass.mul4, %3
  %sub28 = sub i32 %sub, %5
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc41
  %indvars.iv6 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next7, %for.inc41 ]
  %exitcond = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond, label %for.end43, label %for.inc41

for.inc41:                                        ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [999 x i32], ptr %g, i64 0, i64 %indvars.iv6
