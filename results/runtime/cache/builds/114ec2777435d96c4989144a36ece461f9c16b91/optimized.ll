...
for.end39:
  ...
  call fastcc void @outlined_ir_func_0(ptr %i, i32 %m1, ptr %x1, i32 %y)
  call fastcc void @outlined_ir_func_0(ptr %j, i32 %m2, ptr %x2, i32 %y)
...
define internal fastcc void @outlined_ir_func_0(ptr %0, i32 %1, ptr %2, i32 %3) unnamed_addr #5 {
entry_to_outline:
...
if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %3)
