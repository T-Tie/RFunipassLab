...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv4 = phi i64 [ %1, %for.cond.preheader ], [ %3, %for.inc ]
  %2 = trunc nuw i64 %indvars.iv4 to i32
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0) unnamed_addr #4 {
for.end_after_outline.exitStub:
  %vtable.i = load ptr, ptr %0, align 8, !tbaa !15, !invariant.load !9
