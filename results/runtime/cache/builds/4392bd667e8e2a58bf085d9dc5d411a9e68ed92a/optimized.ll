...
if.end17:                                         ; preds = %if.else, %if.else15, %if.then
  %phiofops11 = phi i1 [ false, %if.else15 ], [ true, %if.then ], [ false, %if.else ]
  %phiofops = phi i1 [ true, %if.else15 ], [ false, %if.then ], [ false, %if.else ]
...
for.body45:                                       ; preds = %for.cond43
  br i1 %phiofops11, label %if.then47, label %if.end50
...
if.end50:                                         ; preds = %if.then47, %for.body45
  br i1 %phiofops, label %if.then52, label %for.inc55
