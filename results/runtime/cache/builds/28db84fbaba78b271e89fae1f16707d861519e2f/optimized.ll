...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.body5 ], [ 0, %for.cond3.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv2, %idxprom6
  br i1 %exitcond.not, label %for.end24, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv2
...
for.cond11.preheader:                             ; preds = %for.body5
  %sub = add nsw i32 %5, -1
  %wide.trip.count8 = zext i32 %sub to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv5 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next6, %for.inc19 ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count8
  br i1 %exitcond9.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond11
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next6
  %8 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv5
...
for.end24:                                        ; preds = %for.cond3, %for.end21
  ...
  %spec.select = add nuw nsw i32 %inc27, %i.1
  br label %while.cond, !llvm.loop !14

for.cond29:                                       ; preds = %while.cond, %for.inc37
  %10 = phi i32 [ %.pre, %for.inc37 ], [ %5, %while.cond ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc37 ], [ 0, %while.cond ]
  %sub30 = add nsw i32 %10, -1
  %11 = sext i32 %sub30 to i64
  %cmp31 = icmp slt i64 %indvars.iv10, %11
  br i1 %cmp31, label %for.inc37, label %for.end39

for.inc37:                                        ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv10
