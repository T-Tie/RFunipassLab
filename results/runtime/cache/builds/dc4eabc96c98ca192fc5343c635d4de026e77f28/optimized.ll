...
for.cond45:                                       ; preds = %for.inc66, %for.end44
  ...
  %3 = phi i32 [ %dec, %for.inc66 ], [ 500, %for.end44 ]
...
for.cond49:                                       ; preds = %for.inc63, %for.body48
  %z.1 = phi i32 [ %z.0, %for.body48 ], [ %z.2, %for.inc63 ]
...
for.inc83:                                        ; preds = %for.cond74
  ...
  %5 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !10
  %idxprom79 = sext i32 %5 to i64
