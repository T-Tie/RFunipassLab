...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 101, ptr %a) #9
  ...
  call void @llvm.lifetime.start.p0(i64 15000, ptr %b) #9
  br label %for.cond
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 15000, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 101, ptr %a) #9
  ret i32 0
}
