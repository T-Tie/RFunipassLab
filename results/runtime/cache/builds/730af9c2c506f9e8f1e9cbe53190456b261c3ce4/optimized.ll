...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40804, ptr %a) #4
  br label %for.cond
...
for.end10:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 40804, ptr %b) #4
  br label %for.cond12
...
for.end30:                                        ; preds = %for.cond12
  call void @llvm.lifetime.start.p0(i64 40804, ptr %c) #4
...
for.end88:                                        ; preds = %for.cond63
  ...
  call void @llvm.lifetime.end.p0(i64 40804, ptr %c) #4
  call void @llvm.lifetime.end.p0(i64 40804, ptr %b) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %y2) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %x2) #4
  call void @llvm.lifetime.end.p0(i64 40804, ptr %a) #4
