...
for.cond13:                                       ; preds = %for.inc53, %for.body12
  ...
  %y1.1 = phi i32 [ %y1.0, %for.body12 ], [ %y1.214, %for.inc53 ]
  %x1.1 = phi i32 [ %x1.0, %for.body12 ], [ %x1.216, %for.inc53 ]
...
for.inc53:                                        ; preds = %for.body15, %land.lhs.true38, %land.lhs.true44, %if.then51
  %x1.216 = phi i32 [ %x1.2.ph, %if.then51 ], [ %x1.2.ph, %land.lhs.true44 ], [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1, %for.body15 ]
  %y1.214 = phi i32 [ %y1.2.ph, %if.then51 ], [ %y1.2.ph, %land.lhs.true44 ], [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1, %for.body15 ]
...
for.end58:                                        ; preds = %for.cond10
  ...
  %add60 = add i32 %sub59, %.neg
  %.neg1 = sub i32 0, %y1.0
  %sub61 = add i32 %y2.0, 1
  %add62 = add i32 %sub61, %.neg1
  %mul = mul nsw i32 %add62, %add60
  %add68 = add i32 %x2.0, 2
  %sub63 = add i32 %add68, %.neg
  %add64 = add i32 %sub63, %y2.0
  %reass.add = add i32 %add64, %.neg1
