...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax102 = call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax91 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond66, label %for.cond26.preheader, label %for.cond2

for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count70 = zext i32 %indvars.iv55 to i64
  br label %for.cond26
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  ...
  br i1 %exitcond82, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select53, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond71 = icmp eq i64 %indvars.iv67, %wide.trip.count70
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  ...
  %exitcond76 = icmp eq i64 %indvars.iv72, %wide.trip.count70
...
for.end59:                                        ; preds = %for.cond26
  %6 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 816), align 8, !tbaa !5
...
for.cond60:                                       ; preds = %for.inc77, %for.end59
  ...
  br i1 %exitcond93, label %for.cond80.preheader, label %for.cond63

for.cond80.preheader:                             ; preds = %for.cond60
  %wide.trip.count103 = zext nneg i32 %smax102 to i64
  %wide.trip.count97 = zext i32 %n.tr to i64
  br label %for.cond80

for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc74 ], [ 2, %for.cond60 ]
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  ...
  br i1 %exitcond104.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc95 ], [ 2, %for.cond80 ]
