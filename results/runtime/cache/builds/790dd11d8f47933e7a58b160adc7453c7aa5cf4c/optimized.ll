...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %0, i32 0)
  %wide.trip.count25 = zext nneg i32 %smax19 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv9, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond26.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select, %for.body15 ], [ %l1.0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select5, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv12
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %cmp20 = icmp sgt i32 %5, %max.0
  %6 = trunc nuw nsw i64 %indvars.iv12 to i32
  %spec.select = select i1 %cmp20, i32 %6, i32 %l1.1
  %spec.select5 = call i32 @llvm.smax.i32(i32 %5, i32 %max.0)
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv15 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next16, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %exitcond21.not = icmp eq i64 %indvars.iv15, %wide.trip.count25
  br i1 %exitcond21.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv15, 0
  %7 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv15, i64 %idxprom40
  %8 = load i32, ptr %7, align 4, !tbaa !5, !invariant.load !13
  br i1 %cmp31, label %for.inc50, label %if.end37

if.end37:                                         ; preds = %for.body30
  %cmp42 = icmp slt i32 %8, %min.1
  %9 = trunc nuw nsw i64 %indvars.iv15 to i32
  %spec.select6 = select i1 %cmp42, i32 %9, i32 %l2.1
  %spec.select7 = call i32 @llvm.smin.i32(i32 %8, i32 %min.1)
  br label %for.inc50

for.inc50:                                        ; preds = %if.end37, %for.body30
  %l2.3 = phi i32 [ 0, %for.body30 ], [ %spec.select6, %if.end37 ]
  %min.3 = phi i32 [ %8, %for.body30 ], [ %spec.select7, %if.end37 ]
