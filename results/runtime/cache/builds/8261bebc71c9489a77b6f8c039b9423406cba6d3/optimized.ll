...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc7 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv30, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond42.not, label %for.end33, label %for.cond13.preheader
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv37, i64 %indvars.iv33
...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc53 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.inc53 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.inc53 ], [ 0, %for.end33 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count41
  br i1 %exitcond55.not, label %for.end55, label %for.cond37.preheader
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv43 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next44, %for.body39 ]
  ...
  br i1 %exitcond48.not, label %for.inc53, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv49, i64 %indvars.iv43
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv49, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv43, %11
  %or.cond28 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond28, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv43 to i32
  %d.2 = select i1 %or.cond28, i32 %12, i32 %d.1
