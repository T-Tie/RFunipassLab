...
if.then19.i:                                      ; preds = %entry
  call fastcc void @outlined_ir_func_1(ptr nonnull %add.ptr15.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry
  call fastcc void @outlined_ir_func_2(ptr nonnull %initial)
...
if.then19.i31:                                    ; preds = %while.body
  call fastcc void @outlined_ir_func_1(ptr nonnull %add.ptr15.i24)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call fastcc void @outlined_ir_func_2(ptr nonnull %word)
...
if.then_after_outline.exitStub:
  ...
  %call.i65 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i64, i8 noundef signext 10)
  %call1.i66 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i65)
  %call.i.i67 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i66)
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr readonly captures(none) %0) unnamed_addr #6 {
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit_after_outline.exitStub:
  %call.i.i = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #8
