...
if.then85:                                        ; preds = %land.lhs.true
  ...
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %9
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %10 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !9
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 %indvars.iv31
  store i32 %10, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv31
