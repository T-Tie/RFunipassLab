...
while.body:                                       ; preds = %while.cond
  call void @_Z8multiplyPci(ptr nofree noundef nonnull align 16 dereferenceable(200) %str, i32 noundef 2) #13
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %num) #11
  ret void
}
