...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %temp) #7
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %temp) #8
...
while.end_after_outline.exitStub:
  %1 = load i32, ptr %0, align 4, !tbaa !5, !invariant.load !20
