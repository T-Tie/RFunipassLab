...
for.cond5:                                        ; preds = %for.inc19, %for.end
  ...
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv24, 0
  %indvars.iv.next25 = add nsw i64 %indvars.iv24, -1
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next25
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
for.inc19:                                        ; preds = %for.body7
  ...
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next25
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !13

for.end20.split.loop.exit:                        ; preds = %for.body7
  %6 = trunc nsw i64 %indvars.iv.next25 to i32
  br label %for.end20
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.end47 ], [ %7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %cmp23 = icmp sgt i64 %indvars.iv30, -1
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv30
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv27 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next28, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %cmp30 = icmp sgt i64 %indvars.iv27, %indvars.iv30
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %8 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv27
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv27
...
for.end47:                                        ; preds = %for.cond29
  ...
  %11 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv30
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  ...
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select22, %for.body62 ]
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select22 = call i32 @llvm.smax.i32(i32 %12, i32 %sum.2)
