...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv35
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv32 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next33, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv32, %3
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax54 = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
