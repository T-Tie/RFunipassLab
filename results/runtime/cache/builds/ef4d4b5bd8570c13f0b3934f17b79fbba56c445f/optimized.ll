...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre32, %for.body3 ], [ %0, %for.cond ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc25
  ...
  %n1.1 = phi i32 [ %n1.0, %for.cond13.preheader ], [ %n1.2, %for.inc25 ]
  %n2.1 = phi i32 [ %n2.0, %for.cond13.preheader ], [ %n2.2, %for.inc25 ]
  %n3.1 = phi i32 [ %n3.0, %for.cond13.preheader ], [ %n3.2, %for.inc25 ]
  %n4.1 = phi i32 [ %n4.0, %for.cond13.preheader ], [ %n4.2, %for.inc25 ]
...
for.inc25:                                        ; preds = %if.then, %for.body15
  %n1.2 = phi i32 [ %n1.1, %for.body15 ], [ %spec.select, %if.then ]
  %n2.2 = phi i32 [ %n2.1, %for.body15 ], [ %spec.select17, %if.then ]
  %n3.2 = phi i32 [ %n3.1, %for.body15 ], [ %4, %if.then ]
  %n4.2 = phi i32 [ %n4.1, %for.body15 ], [ %6, %if.then ]
