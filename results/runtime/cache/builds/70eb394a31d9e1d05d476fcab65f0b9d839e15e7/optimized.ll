...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv29 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next30, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax37 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv29
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond41 = icmp eq i32 %q.0, %4
  br i1 %exitcond41, label %for.cond52.preheader, label %for.cond25

for.cond52.preheader:                             ; preds = %for.cond22
  %7 = sext i32 %t.0 to i64
  %smax46 = call i32 @llvm.smax.i32(i32 %t.0, i32 -1)
  %8 = add i32 %smax46, 1
  %wide.trip.count47 = zext i32 %8 to i64
  br label %for.cond52

for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond39.not = icmp eq i64 %indvars.iv33, %wide.trip.count38
  br i1 %exitcond39.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv33
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next34
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv42 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next43, %for.body54 ]
  %exitcond48 = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv42, %7
  %arrayidx58 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv42
  %11 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !12
