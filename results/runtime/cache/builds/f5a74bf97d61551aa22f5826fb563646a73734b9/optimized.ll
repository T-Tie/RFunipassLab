...
for.end39:
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, i32 noundef %m1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x1, i32 noundef %y) #7
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, i32 noundef %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x2, i32 noundef %y) #7
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %0, i32 %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2, i32 %3) unnamed_addr #5 {
entry_to_outline:
