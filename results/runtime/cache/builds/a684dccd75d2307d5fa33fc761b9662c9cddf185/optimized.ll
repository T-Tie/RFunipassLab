...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond22.not, label %for.end33, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv17 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv13 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next14, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv17, i64 %indvars.iv13
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp eq i32 %5, 0
  br i1 %cmp20, label %for.end23.split.loop.exit38, label %for.inc21

for.inc21:                                        ; preds = %for.body15
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond13, !llvm.loop !13

for.end23.split.loop.exit38:                      ; preds = %for.body15
  %6 = trunc nuw nsw i64 %indvars.iv13 to i32
  br label %for.end23

for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit38
  %b.2 = phi i32 [ %6, %for.end23.split.loop.exit38 ], [ %b.0, %for.cond13 ]
  %a.2 = phi i32 [ %4, %for.end23.split.loop.exit38 ], [ %a.0, %for.cond13 ]
...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc53 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.inc53 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.inc53 ], [ 0, %for.end33 ]
  %exitcond35.not = icmp eq i64 %indvars.iv29, %wide.trip.count21
  br i1 %exitcond35.not, label %for.end55, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond34
  %8 = trunc nuw nsw i64 %indvars.iv29 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv23 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next24, %for.body39 ]
  ...
  br i1 %exitcond28.not, label %for.inc53, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv29, i64 %indvars.iv23
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv29, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv23, %11
  %or.cond8 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond8, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv23 to i32
  %d.2 = select i1 %or.cond8, i32 %12, i32 %d.1
...
for.end55:                                        ; preds = %for.cond34
  %sub = xor i32 %b.1, -1
  %sub56 = add i32 %d.0, %sub
  %sub57 = xor i32 %a.1, -1
  %sub58 = add i32 %c.0, %sub57
  %mul = mul nsw i32 %sub56, %sub58
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %mul) #6
