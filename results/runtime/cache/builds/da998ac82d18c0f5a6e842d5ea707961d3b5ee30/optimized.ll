...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %money) #7
...
for.cond7:                                        ; preds = %entry, %for.inc14
...
for.inc14:                                        ; preds = %for.cond7
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 poison)
...
for.end16:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %money) #8
  ret i32 0
}
...
declare noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8), i32) local_unnamed_addr #4
