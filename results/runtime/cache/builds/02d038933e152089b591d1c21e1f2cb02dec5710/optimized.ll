...
for.inc31:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0.6(ptr nonnull %add.ptr27)
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i)
  call fastcc void @outlined_ir_func_1(ptr nonnull %__c.addr.i)
...
for.inc54:                                        ; preds = %for.cond45
  ...
  call fastcc void @outlined_ir_func_0.6(ptr nonnull %add.ptr50)
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i34)
  call fastcc void @outlined_ir_func_1(ptr nonnull %__c.addr.i34)
...
for.end33_after_outline.exitStub:
  tail call fastcc void @outlined_ir_func_0.6(ptr %0)
  ...
  %call.i62 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i61, i8 noundef signext 10)
  %call1.i63 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i62)
  %call.i.i64 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i63)
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr initializes((0, 1)) %0) unnamed_addr #7 {
...
if.then.i11:                                      ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline
  %call1.i12 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0, i64 noundef 1)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.6(ptr %0) unnamed_addr #7 {
newFuncRoot_after_outline.exitStub:
  %call.i.i15 = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
  %call1.i16 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0, i64 noundef %call.i.i15)
  ret void
}
