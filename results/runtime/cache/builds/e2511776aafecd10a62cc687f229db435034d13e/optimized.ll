...
for.body16:                                       ; preds = %for.cond14
  ...
  %6 = load i32, ptr %add.ptr21, align 4, !tbaa !5, !invariant.load !13
...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %8 = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.body31 ]
  %cmp34 = icmp sge i32 %8, 0
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idx.ext39 = sext i32 %8 to i64
  %add.ptr40 = getelementptr inbounds i32, ptr %add.ptr38, i64 %idx.ext39
  %9 = load i32, ptr %add.ptr40, align 4, !tbaa !5, !invariant.load !13
...
if.then42:                                        ; preds = %for.body35
  ...
  store i32 %8, ptr %c2, align 4, !tbaa !5
...
for.inc46:                                        ; preds = %for.cond33, %if.then42
  ...
  %dec47 = add nsw i32 %10, -1
  br label %for.cond29, !llvm.loop !17

for.end48:                                        ; preds = %for.cond29
  %11 = load i32, ptr %r2, align 4, !tbaa !5
  %12 = load i32, ptr %r1, align 4, !tbaa !5
  %sub49 = sub nsw i32 %11, %12
  %sub50 = sub nsw i32 %sub49, 1
  %13 = load i32, ptr %c2, align 4, !tbaa !5
  %14 = load i32, ptr %c1, align 4, !tbaa !5
  %sub51 = sub nsw i32 %13, %14
