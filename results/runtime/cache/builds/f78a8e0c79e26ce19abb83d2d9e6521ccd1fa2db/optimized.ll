...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 dereferenceable(40) %a) #11
...
while.cond:                                       ; preds = %if.end29, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %i.2, %if.end29 ]
  %sum.0 = phi i32 [ 0, %entry ], [ %sum.3, %if.end29 ]
  ...
  %vtable = load ptr, ptr %call1, align 8, !tbaa !5
...
while.body:                                       ; preds = %land.end
  ...
  %call4 = call i64 @strlen(ptr noundef %a) #12
...
if.end.thread:                                    ; preds = %while.body
  %add6 = add nsw i32 %sum.0, %conv
  %add7 = add nsw i32 %add6, 1
  %cmp82 = icmp sle i32 %add7, 80
  br i1 %cmp82, label %if.else14, label %if.then25

if.then11:                                        ; preds = %if.end
  %sum.14 = phi i32 [ %add, %if.end ]
...
if.end19:                                         ; preds = %if.then11, %if.else14
  %sum.13 = phi i32 [ %add7, %if.else14 ], [ %sum.14, %if.then11 ]
  %cmp20 = icmp eq i32 %sum.13, 80
...
if.then25:                                        ; preds = %if.end, %if.end.thread
  %sum.13.ph = phi i32 [ %add, %if.end ], [ %add7, %if.end.thread ]
...
if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  %i.2 = phi i32 [ 1, %if.then25 ], [ %inc, %if.end19 ], [ 0, %if.then21 ]
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.13, %if.end19 ], [ 0, %if.then21 ]
...
while.end:                                        ; preds = %while.cond, %land.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %a) #13
  ret i32 0
}
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  store i32 %call25, ptr %__c, align 4, !tbaa !9
  ...
  store i32 %call26, ptr %ref.tmp, align 4, !tbaa !9
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !5, !invariant.load !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !5, !invariant.load !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !15, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !26, !invariant.load !8
  ret ptr %0
}
...
if.else:                                          ; preds = %entry
  ...
  %0 = load ptr, ptr %vfn, align 8, !invariant.load !8
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !9, !invariant.load !8
  %1 = load i32, ptr %__c2, align 4, !tbaa !9, !invariant.load !8
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !34, !invariant.load !8
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !35, !invariant.load !8
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !38, !invariant.load !8
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !39, !invariant.load !8
...
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #13
  %call2 = call noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef 1, i32 noundef 4) #13
  %call3 = call noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %call, i32 noundef %call2) #13
...
!26 = !{!27, !30, i64 232}
!27 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !16, i64 0, !28, i64 216, !11, i64 224, !29, i64 225, !30, i64 232, !31, i64 240, !32, i64 248, !33, i64 256}
...
!40 = !{!27, !31, i64 240}
!41 = !{!42, !11, i64 56}
!42 = !{!"_ZTSSt5ctypeIcE", !43, i64 0, !44, i64 16, !29, i64 24, !45, i64 32, !45, i64 40, !46, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
!43 = !{!"_ZTSNSt6locale5facetE", !10, i64 8}
