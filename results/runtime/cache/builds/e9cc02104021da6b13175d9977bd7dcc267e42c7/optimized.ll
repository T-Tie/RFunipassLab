...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  ...
  br i1 %exitcond72.not, label %for.cond80.preheader, label %for.cond49.preheader
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc99
  %33 = phi i32 [ %.pre79, %for.inc99 ], [ %22, %for.cond80.preheader ]
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc99 ], [ 0, %for.cond80.preheader ]
