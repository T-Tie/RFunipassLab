...
for.inc15:                                        ; preds = %for.cond1
  ...
  %1 = load double, ptr %arrayidx9, align 8, !tbaa !12, !invariant.load !14
  %2 = load double, ptr %arrayidx8, align 16, !tbaa !12, !invariant.load !14
  %div = fdiv double %1, %2
...
for.body21:                                       ; preds = %for.cond18
  ...
  %4 = load double, ptr %arrayidx23, align 8, !tbaa !12, !invariant.load !14
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !18, !invariant.load !14
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !20, !invariant.load !14
  ret i32 %0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !31, !invariant.load !14
  ret i64 %0
}
