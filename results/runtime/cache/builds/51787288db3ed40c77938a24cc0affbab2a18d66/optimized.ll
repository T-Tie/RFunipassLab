...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv71, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv71, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv77, %5
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax86 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
  %wide.trip.count87 = zext nneg i32 %smax86 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc25 ], [ 0, %for.cond12 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv74, %9
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv77, i64 %indvars.iv74
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv83 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next84, %for.inc46 ]
  %exitcond88.not = icmp eq i64 %indvars.iv83, %wide.trip.count87
  br i1 %exitcond88.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %smax93 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 0)
...
for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv83, i64 %indvars.iv80
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc83
  %indvars.iv102 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next103, %for.inc83 ]
  %exitcond106.not = icmp eq i64 %indvars.iv102, %wide.trip.count87
  br i1 %exitcond106.not, label %for.cond86, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc80
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc80 ], [ 0, %for.cond49 ]
  %exitcond101.not = icmp eq i64 %indvars.iv96, %wide.trip.count100
  br i1 %exitcond101.not, label %for.inc83, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv102, i64 %indvars.iv96
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc77
  %indvars.iv89 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next90, %for.inc77 ]
  %exitcond95.not = icmp eq i64 %indvars.iv89, %wide.trip.count94
  br i1 %exitcond95.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond57
  %10 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv102, i64 %indvars.iv89
  %11 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv89, i64 %indvars.iv96
...
for.cond86:                                       ; preds = %for.cond49, %for.inc109
  ...
  %indvars.iv110 = phi i64 [ %indvars.iv.next111, %for.inc109 ], [ 0, %for.cond49 ]
  %15 = sext i32 %14 to i64
  %cmp88.not.not = icmp slt i64 %indvars.iv110, %15
  br i1 %cmp88.not.not, label %for.cond90, label %for.end111

for.cond90:                                       ; preds = %for.cond86, %for.body93
  %16 = phi i32 [ %.pre113, %for.body93 ], [ %13, %for.cond86 ]
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.body93 ], [ 0, %for.cond86 ]
  %17 = sext i32 %16 to i64
  %cmp92.not.not = icmp slt i64 %indvars.iv107, %17
  br i1 %cmp92.not.not, label %for.body93, label %for.inc109

for.body93:                                       ; preds = %for.cond90
  %sub91 = add nsw i32 %16, -1
  %18 = sext i32 %sub91 to i64
  %cmp95 = icmp slt i64 %indvars.iv107, %18
  %19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv110, i64 %indvars.iv107
  %20 = load i32, ptr %19, align 4, !tbaa !5
  %.str.2..str.3 = select i1 %cmp95, ptr @.str.2, ptr @.str.3
  %call100 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2..str.3, i32 noundef %20) #8
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %.pre113 = load i32, ptr %y2, align 4, !tbaa !5
