...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %a) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %b) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(4000) %b, i8 noundef 0, i64 noundef 4000, i1 noundef false) #7
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc39
  %indvars.iv33 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next34, %for.inc39 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.inc39 ]
  %exitcond42.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond42.not, label %for.cond42, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %2 = add nsw i64 %indvars.iv33, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv33
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv35 = phi i64 [ %indvars.iv33, %for.cond10.preheader ], [ %indvars.iv.next36, %for.inc23 ]
  %indvars.iv31.in = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv31, %for.inc23 ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %for.inc23 ]
  %indvars.iv31 = add nsw i64 %indvars.iv31.in, 1
  %cmp12 = icmp slt i64 %indvars.iv35, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv35
  %5 = load i8, ptr %arrayidx15, align 1, !tbaa !12
  %arrayidx18 = getelementptr inbounds [1000 x i8], ptr %a, i64 0, i64 %indvars.iv31
...
for.end25:                                        ; preds = %for.body13, %for.cond10
  ...
  %7 = trunc nsw i64 %indvars.iv31 to i32
...
for.cond42:                                       ; preds = %for.cond4, %for.body44
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.body44 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond4 ]
  %exitcond46.not = icmp eq i64 %indvars.iv43, 1000
  br i1 %exitcond46.not, label %for.end54, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv43
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc80 ], [ 0, %if.else58 ]
  %exitcond53.not = icmp eq i64 %indvars.iv47, 1000
  br i1 %exitcond53.not, label %if.end83, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv47
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc75
  %indvars.iv49 = phi i64 [ %indvars.iv47, %for.cond67.preheader ], [ %indvars.iv.next50, %for.inc75 ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %12, %11
  %13 = sext i32 %add68 to i64
  %cmp69 = icmp slt i64 %indvars.iv49, %13
  br i1 %cmp69, label %for.inc75, label %for.end77

for.inc75:                                        ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv49
  %14 = load i8, ptr %arrayidx72, align 1, !tbaa !12
  %conv73 = sext i8 %14 to i32
  %putchar29 = call i32 @putchar(i32 %conv73)
...
if.end83:                                         ; preds = %for.cond60, %if.then56
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %b) #9
