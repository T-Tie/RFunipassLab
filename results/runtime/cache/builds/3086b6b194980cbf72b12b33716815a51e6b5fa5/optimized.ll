...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select21 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select21
  ...
  %or.cond22 = or i1 %cmp12, %or.cond
  %smax25 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond22, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %x.1 = phi i32 [ %add18, %for.inc ], [ 0, %for.body ]
  %5 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond26.not = icmp eq i32 %5, %smax25
  br i1 %exitcond26.not, label %for.inc53, label %for.body16
...
for.inc:                                          ; preds = %sw.bb17, %sw.default, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16
  ...
  %add18 = add nuw nsw i32 %.sink3, %x.1
  %inc = add i32 %5, 1
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %6, %smax25
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %spec.select24 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call.i.i = select i1 %cmp44, i64 3, i64 2
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %spec.select24, i64 noundef %call.i.i)
