...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 120, ptr %a) #3
  call void @llvm.lifetime.start.p0(i64 120, ptr %b) #3
...
for.end72:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 120, ptr %b) #3
  call void @llvm.lifetime.end.p0(i64 120, ptr %a) #3
