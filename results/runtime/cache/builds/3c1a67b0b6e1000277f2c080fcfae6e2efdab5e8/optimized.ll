...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax27 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count12 = zext nneg i32 %smax27 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond27, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv9
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc21 ], [ 0, %for.cond14.preheader ]
  %exitcond8.not = icmp eq i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond8.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv4
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc60 ], [ 0, %for.cond ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count12
  br i1 %exitcond29.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv24
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select2, %for.body34 ], [ %3, %for.body29 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv24
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc57 ], [ 0, %for.cond49.preheader ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv24
...
for.cond65.preheader:                             ; preds = %for.end62
  %smax51 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %wide.trip.count40 = zext nneg i32 %smax51 to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv35 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next36, %for.inc83 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond86, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv30 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next31, %for.inc80 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv35, i64 %indvars.iv30
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv30
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc104 ], [ 2, %for.cond65 ]
  %exitcond53.not = icmp eq i64 %indvars.iv47, %wide.trip.count40
  br i1 %exitcond53.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv47, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv42 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next43, %for.inc101 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond46.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv47
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %9
