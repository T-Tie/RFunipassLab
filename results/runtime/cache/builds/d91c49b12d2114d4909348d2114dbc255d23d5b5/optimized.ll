...
while.end:                                        ; preds = %while.cond
  %indvars15.le = trunc i64 %indvars.iv3 to i32
  ...
  %sub7 = add nsw i32 %indvars15.le, -2
  br label %for.cond8
...
for.cond31.preheader:                             ; preds = %for.cond8
  %wide.trip.count = and i64 %indvars.iv3, 4294967295
  br label %for.cond31
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv6 = phi i64 [ %0, %while.cond11.preheader ], [ %indvars.iv.next7, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %1 = trunc nuw i64 %indvars.iv.next7 to i32
  %cmp12 = icmp slt i32 %1, %indvars15.le
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select1 = tail call i32 @llvm.smax.i32(i32 %5, i32 %n.2)
