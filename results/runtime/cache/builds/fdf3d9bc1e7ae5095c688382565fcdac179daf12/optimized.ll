...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond49.preheader:                             ; preds = %for.cond31
  %smax25 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 0)
...
for.body93:                                       ; preds = %for.cond90
  ...
  %arrayidx104 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv42, i64 %indvars.iv39
  %19 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %call105 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %19) #8
