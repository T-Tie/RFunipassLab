...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv26 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next27, %for.inc14 ]
...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  ...
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc47 ], [ 0, %for.cond2 ]
  %s.0 = phi i32 [ %add46, %for.inc47 ], [ 0, %for.cond2 ]
  %6 = sext i32 %5 to i64
  %cmp18 = icmp slt i64 %indvars.iv30, %6
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread38
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %s.123 = phi i32 [ %s.0, %if.end35 ], [ %s.123.ph, %for.inc47.sink.split ]
  %add45 = add i32 %7, 1
