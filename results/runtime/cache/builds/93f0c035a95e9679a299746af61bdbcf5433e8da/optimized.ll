...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1600) %a, i8 noundef 0, i64 noundef 1600, i1 noundef false)
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  %cmp25 = icmp slt i32 %3, 2
  call void @llvm.assume(i1 noundef %cmp25)
