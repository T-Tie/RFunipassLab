...
while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv17 = phi i32 [ %indvars.iv.next18, %while.body ], [ 0, %entry ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv13 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next14, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv13
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc35
  %indvars.iv25 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next26, %for.inc35 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond30.not, label %for.end37, label %for.cond18

for.cond18:                                       ; preds = %for.cond15, %for.body20
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body20 ], [ 0, %for.cond15 ]
  %sum.0 = phi i32 [ %add, %for.body20 ], [ 0, %for.cond15 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end28, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100000 x i32], ptr %b, i64 0, i64 %indvars.iv19
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !14
  %6 = zext i32 %5 to i64
  %cmp23.not = icmp eq i64 %indvars.iv25, %6
...
if.then30:                                        ; preds = %for.end28
  %arrayidx32 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv25
  ...
  %8 = load i64, ptr %gep, align 8, !tbaa !21
...
!20 = !{}
!21 = !{!22, !23, i64 16}
!22 = !{!"_ZTSSt8ios_base", !23, i64 8, !23, i64 16, !24, i64 24, !25, i64 28, !25, i64 32, !26, i64 40, !27, i64 48, !8, i64 64, !15, i64 192, !28, i64 200, !29, i64 208}
!23 = !{!"long", !8, i64 0}
