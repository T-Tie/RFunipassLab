...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv74 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc31 ], [ 0, %for.cond ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %indvars.iv74
  br i1 %exitcond32.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv28
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv74
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc28 ], [ 0, %for.cond17.preheader ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %indvars.iv74
  br i1 %exitcond27.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv28, i64 %indvars.iv23
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %indvars.iv74
  br i1 %exitcond52.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %indvars.iv74
  br i1 %exitcond37.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv33, i64 %indvars.iv48
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv48
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select17, %for.body57 ], [ %6, %if.then51 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %indvars.iv74
  br i1 %exitcond42.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv38, i64 %indvars.iv48
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %spec.select17 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond55, !llvm.loop !15

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc84 ], [ 0, %for.cond72.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %indvars.iv74
  br i1 %exitcond47.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv43, i64 %indvars.iv48
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %indvars.iv74
  br i1 %exitcond63.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond58.not = icmp eq i64 %indvars.iv53, %indvars.iv74
  br i1 %exitcond58.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv59, i64 %indvars.iv53
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv53, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv59, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %indvars.iv74
  br i1 %exitcond73.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep19 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv69
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv64 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next65, %for.inc129 ]
  %exitcond68.not = icmp eq i64 %indvars.iv64, %indvars.iv74
  br i1 %exitcond68.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv64, i64 %indvars.iv69
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep20 = getelementptr [100 x i32], ptr %invariant.gep19, i64 %indvars.iv64
  store i32 %12, ptr %gep20, align 4, !tbaa !5
...
for.cond:                                         ; preds = %for.inc16, %entry
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc16 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %3 = sext i32 %2 to i64
  %cmp2 = icmp slt i64 %indvars.iv6, %3
  br i1 %cmp2, label %for.cond4, label %for.inc16

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %4 = phi i32 [ %.pre16, %for.inc ], [ %2, %for.cond1 ]
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %num, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.inc16:                                        ; preds = %for.cond1
  ...
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv9
  store i32 %call13, ptr %arrayidx15, align 4, !tbaa !5
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  br label %for.cond, !llvm.loop !25

for.cond19:                                       ; preds = %for.cond, %for.inc26
  %6 = phi i32 [ %.pre15, %for.inc26 ], [ %0, %for.cond ]
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc26 ], [ 0, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp20 = icmp slt i64 %indvars.iv12, %7
  br i1 %cmp20, label %for.inc26, label %for.end28

for.inc26:                                        ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv12
