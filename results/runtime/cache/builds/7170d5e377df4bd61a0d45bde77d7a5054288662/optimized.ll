...
for.cond45:                                       ; preds = %for.cond15, %for.inc66
  ...
  %z.0 = phi i32 [ 0, %for.inc66 ], [ 0, %for.cond15 ]
...
for.cond49:                                       ; preds = %land.end
  %exitcond32 = icmp eq i64 0, %wide.trip.count16
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.09 = phi i32 [ %5, %if.else71.loopexit ], [ 2, %for.end67 ]
...
for.inc83:                                        ; preds = %for.cond74
  %puts = call i32 @puts(ptr noundef nonnull readonly captures(none) dereferenceable(1) %a) #10
