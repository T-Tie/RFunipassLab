...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %k) #7
...
for.cond15:                                       ; preds = %for.inc131, %for.end14
  ...
  br i1 %cmp16, label %for.body18, label %for.end133
...
if.end:                                           ; preds = %land.lhs.true, %for.body23
  ...
  %6 = load i32, ptr %arrayidx27, align 16, !tbaa !5
  %add = add nsw i32 %t.0, 1
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc45, %if.end
  %j29.0 = phi i32 [ %add, %if.end ], [ %inc46, %for.inc45 ]
  %minValue.0 = phi i32 [ %6, %if.end ], [ %minValue.1, %for.inc45 ]
  %cmp31 = icmp slt i32 %j29.0, %3
...
for.body33:                                       ; preds = %for.cond30
  ...
  %cmp38 = icmp slt i32 %7, %minValue.0
...
for.inc45:                                        ; preds = %for.body33, %if.then39
  %minValue.1 = phi i32 [ %7, %if.then39 ], [ %minValue.0, %for.body33 ]
  %inc46 = add nsw i32 %j29.0, 1
  br label %for.cond30, !llvm.loop !9

for.end47:                                        ; preds = %for.cond30
  %sub51 = sub nsw i32 %6, %minValue.0
  store i32 %sub51, ptr %arrayidx27, align 16, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j52) #7
  store i32 %add, ptr %j52, align 4, !tbaa !5
  br label %for.cond54

for.cond54:                                       ; preds = %for.body57, %for.end47
  %8 = load i32, ptr %j52, align 4, !tbaa !5
  %cmp55 = icmp slt i32 %8, %3
  br i1 %cmp55, label %for.body57, label %for.end65

for.body57:                                       ; preds = %for.cond54
  %idxprom60 = sext i32 %8 to i64
  %arrayidx61 = getelementptr inbounds [100 x i32], ptr %arrayidx27, i64 0, i64 %idxprom60
  %9 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %sub62 = sub nsw i32 %9, %minValue.0
  store i32 %sub62, ptr %arrayidx61, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j52) #7
  br label %for.cond54

for.end65:                                        ; preds = %for.cond54
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j52) #7
  br label %for.inc66
...
for.cond85:                                       ; preds = %for.inc100, %if.end78
  %minValue79.0 = phi i32 [ %10, %if.end78 ], [ %minValue79.1, %for.inc100 ]
  %i83.0 = phi i32 [ %add84, %if.end78 ], [ %inc101, %for.inc100 ]
  %cmp86 = icmp slt i32 %i83.0, %3
...
for.body88:                                       ; preds = %for.cond85
  ...
  %cmp93 = icmp slt i32 %11, %minValue79.0
...
for.inc100:                                       ; preds = %for.body88, %if.then94
  %minValue79.1 = phi i32 [ %11, %if.then94 ], [ %minValue79.0, %for.body88 ]
  %inc101 = add nsw i32 %i83.0, 1
  br label %for.cond85, !llvm.loop !13

for.end102:                                       ; preds = %for.cond85
  %sub106 = sub nsw i32 %10, %minValue79.0
  store i32 %sub106, ptr %arrayidx82, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i107) #7
  store i32 %add84, ptr %i107, align 4, !tbaa !5
  br label %for.cond109

for.cond109:                                      ; preds = %for.body112, %for.end102
  %12 = load i32, ptr %i107, align 4, !tbaa !5
  %cmp110 = icmp slt i32 %12, %3
  br i1 %cmp110, label %for.body112, label %for.end120

for.body112:                                      ; preds = %for.cond109
  %idxprom113 = sext i32 %12 to i64
  ...
  %13 = load i32, ptr %arrayidx116, align 4, !tbaa !5
  %sub117 = sub nsw i32 %13, %minValue79.0
  store i32 %sub117, ptr %arrayidx116, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i107) #7
  br label %for.cond109

for.end120:                                       ; preds = %for.cond109
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i107) #7
  br label %for.inc121
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %14 = load i32, ptr %arrayidx129, align 4, !tbaa !5
  %add130 = add nsw i32 %14, %total.0
