...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 200, ptr noundef nonnull align 16 dereferenceable(200) %str) #11
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(200) %str, i8 noundef 0, i64 noundef 200, i1 noundef false) #12
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 200, ptr noundef %str) #13
...
define dso_local void @_Z8multiplyPci(ptr noundef %str, i32 noundef %n) local_unnamed_addr #4 {
entry:
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !18, !invariant.load !13
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !18, !invariant.load !13
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !13
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !20, !invariant.load !13
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !31, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !39, !invariant.load !13
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !18, !invariant.load !13
...
!42 = !{!"p1 _ZTS15__locale_struct", !26, i64 0}
!43 = !{!"p1 int", !26, i64 0}
!44 = !{!"p1 short", !26, i64 0}
