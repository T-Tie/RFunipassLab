...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.end15
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.end15 ], [ 0, %for.cond2.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end15 ], [ 1, %for.cond2.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv27, 2
  br i1 %exitcond.not, label %for.end26, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %2 = trunc nuw nsw i64 %indvars.iv27 to i32
  br label %for.cond5

for.cond5:                                        ; preds = %for.body7, %for.body4
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body7 ], [ %indvars.iv22, %for.body4 ]
  %index.0 = phi i32 [ %spec.select, %for.body7 ], [ %2, %for.body4 ]
  %cmp6 = icmp slt i64 %indvars.iv24, %1
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
for.end15:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv27
