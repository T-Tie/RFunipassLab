...
for.end9:                                         ; preds = %for.cond
  ...
  %4 = load double, ptr %arrayidx11, align 8, !tbaa !13
  %5 = load double, ptr %sv, align 16, !tbaa !13
  %div = fdiv double %4, %5
...
for.body16:                                       ; preds = %for.cond14
  ...
  %8 = load double, ptr %arrayidx19, align 8, !tbaa !13
  %9 = load double, ptr %arrayidx18, align 16, !tbaa !13
