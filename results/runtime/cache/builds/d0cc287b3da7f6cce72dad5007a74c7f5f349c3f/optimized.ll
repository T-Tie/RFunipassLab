...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax10 = call i32 @llvm.smax.i32(i32 %11, i32 noundef 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv13, %14
  %17 = mul nsw i64 %indvars.iv13, %15
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv6
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %25 = phi i32 [ %.pre21, %for.inc95 ], [ %23, %for.cond77 ]
