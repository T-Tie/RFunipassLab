...
for.end:                                          ; preds = %for.cond
  %m.0.lcssa = phi i32 [ %m.0, %for.cond ]
  br label %for.cond4
...
for.cond14:                                       ; preds = %for.inc63, %for.end12
  %j.1 = phi i32 [ %.lcssa, %for.end12 ], [ %dec, %for.inc63 ]
...
for.inc66:                                        ; preds = %for.cond14
  %h.0.lcssa = phi i32 [ %h.0, %for.cond14 ]
  %call65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %h.0.lcssa) #7
