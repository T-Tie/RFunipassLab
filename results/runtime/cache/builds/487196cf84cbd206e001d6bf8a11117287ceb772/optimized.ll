...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %cmp3 = icmp slt i64 %indvars.iv81, %1
...
for.end76:                                        ; preds = %for.cond2
  ...
  %6 = add i32 %smax91, 1
  %wide.trip.count92 = zext i32 %6 to i64
  br label %for.cond86
...
for.body88:                                       ; preds = %for.cond86
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv87, i64 %7
  br label %for.cond94
...
for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv84, %7
