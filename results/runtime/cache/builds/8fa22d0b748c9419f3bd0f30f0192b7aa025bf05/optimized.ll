...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %1 = phi i32 [ %.pre8, %for.inc ], [ %0, %for.cond ]
  %a2.1 = phi i32 [ %a2.23, %for.inc ], [ %a2.0, %for.cond ]
  %a1.1 = phi i32 [ %a1.25, %for.inc ], [ %a1.0, %for.cond ]
...
land.lhs.true:                                    ; preds = %for.body4
  ...
  %spec.select7 = select i1 %cmp7, i32 %j.0, i32 %a2.1
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %for.body4
  %a1.25 = phi i32 [ %a1.1, %for.body4 ], [ %spec.select, %land.lhs.true ]
  %a2.23 = phi i32 [ %a2.1, %for.body4 ], [ %spec.select7, %land.lhs.true ]
