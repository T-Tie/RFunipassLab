...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 dereferenceable(41000) %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef align 16 %b) #9
...
for.inc:                                          ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1000 x [41 x i8]], ptr %a, i64 0, i64 %idxprom
  ...
  %call5 = call i64 @strlen(ptr noundef %arrayidx) #10
  %conv = trunc i64 %call5 to i32
  %arrayidx7 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom
...
for.cond10:                                       ; preds = %for.inc44, %for.end
  %num.0 = phi i32 [ 0, %for.end ], [ %add43, %for.inc44 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %inc45, %for.inc44 ]
...
for.body12:                                       ; preds = %for.cond10
  ...
  %add = add nsw i32 %num.0, %2
  %cmp17 = icmp eq i32 %add, %2
  br i1 %cmp17, label %if.then, label %if.end

if.then:                                          ; preds = %for.body12
  %arrayidx19 = getelementptr inbounds [1000 x [41 x i8]], ptr %a, i64 0, i64 %idxprom13
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arrayidx19)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body12
  %cmp22 = icmp sle i32 %add, 80
  br i1 %cmp22, label %land.lhs.true, label %if.then34

land.lhs.true:                                    ; preds = %if.end
  %cmp25 = icmp ne i32 %add, %2
  br i1 %cmp25, label %if.then26, label %for.inc44
...
if.then26:                                        ; preds = %land.lhs.true
  ...
  br label %for.inc44.gvnsink.split
...
for.inc44.gvnsink.split:                          ; preds = %if.then26, %if.then34
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %if.then34 ], [ %call27, %if.then26 ]
  %num.1.ph = phi i32 [ %add, %if.then26 ], [ %2, %if.then34 ]
  %arrayidx37 = getelementptr inbounds [1000 x [41 x i8]], ptr %a, i64 0, i64 %idxprom13
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, ptr noundef %arrayidx37)
  br label %for.inc44

for.inc44:                                        ; preds = %for.inc44.gvnsink.split, %land.lhs.true
  %num.1 = phi i32 [ %2, %land.lhs.true ], [ %num.1.ph, %for.inc44.gvnsink.split ]
...
for.end46:                                        ; preds = %for.cond10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef %a) #11
  ret i32 0
}
