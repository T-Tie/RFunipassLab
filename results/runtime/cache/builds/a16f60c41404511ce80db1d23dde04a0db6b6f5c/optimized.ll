...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax95 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax100 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax101 = call i32 @llvm.smax.i32(i32 %smax100, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax107 = call i32 @llvm.smax.i32(i32 %9, i32 0)
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax142 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax148 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
