...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv24 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next25, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv32.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv32, %for.cond17 ]
  %indvars.iv32 = add i32 %indvars.iv32.in, -1
  %cmp15 = icmp sgt i32 %indvars.iv32.in, 0
  br i1 %cmp15, label %for.cond17.preheader, label %for.end41

for.cond17.preheader:                             ; preds = %for.cond14
  %wide.trip.count34 = zext i32 %indvars.iv32 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv28 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next29, %for.inc37 ]
  %exitcond35.not = icmp eq i64 %indvars.iv28, %wide.trip.count34
  br i1 %exitcond35.not, label %for.cond14, label %for.body19, !llvm.loop !14

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv28
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next29
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv36, %8
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv36
