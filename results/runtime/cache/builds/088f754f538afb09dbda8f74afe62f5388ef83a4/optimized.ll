...
for.end:                                          ; preds = %for.cond
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !13, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %vtable.i = load ptr, ptr %call1, align 8, !tbaa !13, !invariant.load !9
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !17, !invariant.load !9
