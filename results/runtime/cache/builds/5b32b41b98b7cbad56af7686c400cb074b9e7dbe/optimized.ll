...
while.body:                                       ; preds = %while.cond
  ...
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i2, ptr noundef nonnull align 8 dereferenceable(8) %c)
...
if.then7:                                         ; preds = %if.then
  %call8 = call double @sqrt(double noundef %5) #6, !tbaa !9
  %add = fsub double %call8, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call10 = call double @sqrt(double noundef %5) #6, !tbaa !9
  ...
  %call18 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %x1.0, double noundef %x2.0)
  br label %if.end42
...
if.else:                                          ; preds = %if.then
  ...
  %call25 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %x1.1)
  br label %if.end42
...
if.else27:                                        ; preds = %while.body
  ...
  %call32 = call double @sqrt(double noundef %fneg31) #6, !tbaa !9
  ...
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %x1.2, double noundef %x.0, double noundef %x1.2, double noundef %x.0)
  br label %if.end42
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %c) #6
