...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %i) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %sum) #7
  store i32 1, ptr %sum, align 4, !tbaa !5
  %cmp = icmp eq i32 %n, 1
  %.n = select i1 %cmp, i32 2, i32 %n
  store i32 %.n, ptr %i, align 4, !tbaa !5
  call void @outlined_ir_func_0(ptr nonnull %i, i32 %m, ptr nonnull %sum)
...
define internal void @outlined_ir_func_0(ptr captures(none) %0, i32 %1, ptr captures(none) %2) #6 {
if.then_to_outline:
  %.pre = load i32, ptr %0, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then_to_outline
  %3 = phi i32 [ %inc, %for.inc ], [ %.pre, %if.then_to_outline ]
  %mul = mul nsw i32 %3, %3
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %1, %3
  %call = tail call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %3) #10
