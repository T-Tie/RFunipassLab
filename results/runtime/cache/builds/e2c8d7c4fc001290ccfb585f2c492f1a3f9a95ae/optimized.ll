...
if.end:                                           ; preds = %if.then, %land.lhs.true12, %lor.lhs.false
...
if.end24:                                         ; preds = %if.then22, %for.end
  store i32 65, ptr @i, align 4, !tbaa !5
  br label %for.cond25

for.cond25:                                       ; preds = %if.end35, %if.end24
  %4 = phi i32 [ %.pr, %if.end35 ], [ 65, %if.end24 ]
  %cmp26 = icmp sle i32 %4, 90
...
for.body27:                                       ; preds = %for.cond25
  ...
  %tobool30 = icmp ne i32 %6, 0
  br i1 %tobool30, label %if.then31, label %if.end35

if.then31:                                        ; preds = %for.body27
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %5, i32 noundef %6)
  br label %if.end35
...
for.end38:                                        ; preds = %for.cond25
  store i32 97, ptr @i, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %if.end49, %for.end38
  %7 = phi i32 [ %.pr1, %if.end49 ], [ 97, %for.end38 ]
  %cmp40 = icmp sle i32 %7, 122
...
for.body41:                                       ; preds = %for.cond39
  ...
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !10
  %tobool44 = icmp ne i32 %9, 0
  br i1 %tobool44, label %if.then45, label %if.end49

if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %8, i32 noundef %9)
  br label %if.end49

if.end49:                                         ; preds = %if.then45, %for.body41
  call fastcc void @outlined_ir_func_0() #6
  %.pr1 = load i32, ptr @i, align 4, !tbaa !5
  br label %for.cond39
...
attributes #4 = { minsize mustprogress nofree norecurse nosync nounwind optsize willreturn uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
