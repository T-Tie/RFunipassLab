...
if.then55:                                        ; preds = %for.body51
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %11, double noundef %12) #8
  br label %for.inc110

if.else63:                                        ; preds = %for.body51
  %cmp66 = fcmp oeq double %9, 0.000000e+00
  %13 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
  br i1 %cmp66, label %if.then67, label %if.else72

if.then67:                                        ; preds = %if.else63
  %arrayidx70 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
  %call71 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %11) #8
  br label %for.inc110
...
if.else72:                                        ; preds = %if.else63
  ...
  %14 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 1
  %15 = getelementptr inbounds [99 x double], ptr %14, i64 0, i64 %idxprom52
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %16, double noundef %fneg81, double noundef %16) #8
  br label %for.inc110
...
if.else93:                                        ; preds = %if.else72
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %11, double noundef %16, double noundef %11, double noundef %16) #8
  br label %for.inc110

for.inc110:                                       ; preds = %if.then55, %if.then77, %if.else93, %if.then67
  %inc111 = add nsw i32 %7, 1
