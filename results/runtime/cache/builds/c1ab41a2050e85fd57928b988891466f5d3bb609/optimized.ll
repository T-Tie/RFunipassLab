...
if.then21:                                        ; preds = %if.else19
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %retval.0.i.loc)
  call fastcc void @outlined_ir_func_0(ptr nonnull %__c.addr.i, ptr nonnull %retval.0.i.loc)
  %retval.0.i.reload = load ptr, ptr %retval.0.i.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %retval.0.i.loc)
...
if.else26:                                        ; preds = %if.else19
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %retval.0.i22.loc)
  call fastcc void @outlined_ir_func_0(ptr nonnull %__c.addr.i13, ptr nonnull %retval.0.i22.loc)
  %retval.0.i22.reload = load ptr, ptr %retval.0.i22.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %retval.0.i22.loc)
...
define internal fastcc void @outlined_ir_func_0(ptr initializes((0, 1)) %0, ptr writeonly captures(none) initializes((0, 8)) %1) unnamed_addr #5 {
...
if.then.i:                                        ; preds = %if.then21_to_outline
  %call1.i3 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0, i64 noundef 1)
