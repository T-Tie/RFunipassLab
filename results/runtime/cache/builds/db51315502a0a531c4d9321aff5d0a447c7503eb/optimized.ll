...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  %4 = phi i32 [ %inc28, %for.inc27 ], [ 1, %for.end19 ]
  %cmp21 = icmp sle i32 %4, 12
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %6 = phi i32 [ %inc49, %for.inc48 ], [ 1, %for.end29 ]
  %cmp31 = icmp sle i32 %6, 12
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %10 = phi i32 [ %inc80, %for.inc79 ], [ 1, %for.end50 ]
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  %k.1 = phi i32 [ %12, %for.body57 ], [ %inc66, %for.inc65 ]
  %sum.1 = phi i32 [ 0, %for.body57 ], [ %add64, %for.inc65 ]
  %cmp60 = icmp sle i32 %k.1, %11
...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %14 = phi i32 [ %inc90, %for.inc89 ], [ 1, %for.end81 ]
  %cmp83 = icmp sle i32 %14, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %15 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom85 = sext i32 %15 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %16 = phi i32 [ %inc111, %for.inc110 ], [ 1, %for.end91 ]
  %cmp93 = icmp sle i32 %16, 12
...
for.cond95:                                       ; preds = %for.inc107, %for.body94
  ...
  %sub96 = sub nsw i32 %18, 1
  %cmp97 = icmp sle i32 %17, %sub96
...
for.body115:                                      ; preds = %for.cond113
  ...
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %22) #8
