...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx2.lcssa = phi ptr [ %arrayidx2, %for.cond ]
  store i8 0, ptr %arrayidx2.lcssa, align 1, !tbaa !5
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc26, %for.end
  %j.2 = phi i32 [ %j.0.lcssa, %for.end ], [ %dec, %for.inc26 ]
...
for.inc26:                                        ; preds = %for.cond19
  ...
  %call25 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %arrayidx23) #5
  %dec = add nsw i32 %j.2, -1
  br label %for.cond19, !llvm.loop !11

for.end27:                                        ; preds = %for.cond19
  %call30 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %c) #5
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %c) #5
  ret i32 0
}
