...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %a2.1 = phi i32 [ %a2.0, %for.body ], [ %a2.25, %for.inc ]
  %a1.1 = phi i32 [ %a1.0, %for.body ], [ %a1.27, %for.inc ]
...
for.inc:                                          ; preds = %for.body4, %if.then, %land.lhs.true
  %a1.27 = phi i32 [ %a1.1, %for.body4 ], [ %a1.1, %land.lhs.true ], [ %i.0, %if.then ]
  %a2.25 = phi i32 [ %a2.1, %for.body4 ], [ %a2.1, %land.lhs.true ], [ %j.0, %if.then ]
