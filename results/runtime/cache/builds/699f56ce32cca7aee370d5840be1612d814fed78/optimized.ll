...
for.inc68:                                        ; preds = %for.cond47
  %3 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !9
...
for.body82:                                       ; preds = %for.cond80
  ...
  %9 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !9
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %9) #9
