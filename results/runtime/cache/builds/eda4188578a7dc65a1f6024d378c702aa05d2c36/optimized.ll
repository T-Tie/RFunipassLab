...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.end ], [ 0, %for.cond ]
  %cmp2 = icmp sgt i32 %1, 0
  br i1 %cmp2, label %for.cond5, label %for.end192
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv
...
for.end192:                                       ; preds = %for.cond1
  %call193 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
