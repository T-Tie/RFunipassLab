...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv25
...
for.cond10:                                       ; preds = %for.cond10.loopexit, %for.cond10.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond10.loopexit ], [ %1, %for.cond10.preheader ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  ...
  %cmp14 = icmp slt i64 %indvars.iv.next15, %1
