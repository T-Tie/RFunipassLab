...
for.cond:                                         ; preds = %for.inc26, %entry
  %indvars.iv22 = phi i32 [ %indvars.iv.next23, %for.inc26 ], [ %conv, %entry ]
  %indvars.iv17 = phi i32 [ %indvars.iv.next18, %for.inc26 ], [ 0, %entry ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.body14
  %indvars.iv8 = phi i64 [ %indvars.iv, %for.cond12.preheader ], [ %indvars.iv.next9, %for.body14 ]
  %k.1 = phi i32 [ 1, %for.cond12.preheader ], [ %spec.select, %for.body14 ]
  %cmp13 = icmp slt i64 %indvars.iv8, %3
  br i1 %cmp13, label %for.body14, label %for.end

for.body14:                                       ; preds = %for.cond12
  %4 = sub nuw nsw i64 %indvars.iv8, %indvars.iv
  %arrayidx16 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx16, align 1, !tbaa !5
  %arrayidx19 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv8
  %6 = load i8, ptr %arrayidx19, align 1, !tbaa !5
  %cmp21.not = icmp eq i8 %5, %6
  %spec.select = select i1 %cmp21.not, i32 %k.1, i32 0
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  br label %for.cond12, !llvm.loop !8

for.end:                                          ; preds = %for.cond12
  %tobool.not = icmp eq i32 %k.1, 0
  br i1 %tobool.not, label %for.inc26, label %for.cond31.preheader

for.cond31.preheader:                             ; preds = %for.end
  %wide.trip.count20 = zext i32 %indvars.iv17 to i64
  br label %for.cond31
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc38
  %indvars.iv14 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next15, %for.inc38 ]
  %exitcond21.not = icmp eq i64 %indvars.iv14, %wide.trip.count20
  br i1 %exitcond21.not, label %for.end40, label %for.inc38

for.inc38:                                        ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv14
  %7 = load i8, ptr %arrayidx35, align 1, !tbaa !5
  %conv36 = sext i8 %7 to i32
  %putchar5 = call i32 @putchar(i32 noundef %conv36) #7
...
for.end40:                                        ; preds = %for.cond31
  ...
  %8 = sext i32 %indvars.iv22 to i64
  %sext28 = shl i64 %call6, 32
  %9 = ashr exact i64 %sext28, 32
  br label %for.cond44

for.cond44:                                       ; preds = %for.inc51, %for.end40
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc51 ], [ %8, %for.end40 ]
  %cmp45 = icmp slt i64 %indvars.iv25, %9
  br i1 %cmp45, label %for.inc51, label %if.end56

for.inc51:                                        ; preds = %for.cond44
  %arrayidx48 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv25
