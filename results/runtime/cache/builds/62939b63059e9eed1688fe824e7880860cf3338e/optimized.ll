...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i) #12
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #12
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 81000, ptr noundef align 16 %newword) #12
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %newword, i8 noundef 0, i64 noundef 81000, i1 noundef false) #13
...
for.body:                                         ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #14
  br label %for.cond
...
if.end73.gvnsink.split:                           ; preds = %if.then44, %if.else58, %if.then
  %add.sink7 = phi i32 [ %conv, %if.then ], [ %add, %if.else58 ], [ %add, %if.then44 ]
  ...
  store i32 %add.sink7, ptr %j, align 4, !tbaa !5
  %idxprom69 = sext i32 %add.sink7 to i64
  ...
  %inc71 = add nsw i32 %add.sink7, 1
  br label %if.end73

if.end73:                                         ; preds = %if.end73.gvnsink.split, %if.then33
  %inc71.sink = phi i32 [ 0, %if.then33 ], [ %inc71, %if.end73.gvnsink.split ]
  %k.1 = phi i32 [ %inc41, %if.then33 ], [ %k.1.ph, %if.end73.gvnsink.split ]
  store i32 %inc71.sink, ptr %j, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #14
  br label %for.cond2
...
if.then99:                                        ; preds = %for.body96
  ...
  %8 = load i8, ptr %arrayidx103, align 1, !tbaa !9, !invariant.load !10
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %8)
...
if.else106:                                       ; preds = %for.body96
  %idxprom109 = sext i32 %7 to i64
  %arrayidx110 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom109
  %9 = load i8, ptr %arrayidx110, align 1, !tbaa !9, !invariant.load !10
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %9)
  br label %if.end112

if.end112:                                        ; preds = %if.else106, %if.then99
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j) #14
  br label %for.cond94
...
for.end118:                                       ; preds = %for.cond86
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #14
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i) #14
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !11
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !11
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !11
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !11
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !11
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !11
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0) unnamed_addr #11 {
for.cond.exitStub:
...
attributes #11 = { minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #12 = { nofree nounwind }
attributes #13 = { nofree }
