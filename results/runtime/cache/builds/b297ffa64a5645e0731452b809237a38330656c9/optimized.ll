...
for.cond1:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 30, %for.body ], [ %dec, %for.inc ]
...
for.cond10:                                       ; preds = %for.inc17, %for.end9
  %i.1 = phi i32 [ 0, %for.end9 ], [ %inc18, %for.inc17 ]
...
land.end:                                         ; preds = %land.rhs, %for.cond10
  %3 = phi i1 [ false, %for.cond10 ], [ %cmp15, %land.rhs ]
  br i1 %3, label %for.body16, label %for.end19
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %j.1 = phi i32 [ %i.1, %for.end19 ], [ %inc29, %for.inc28 ]
