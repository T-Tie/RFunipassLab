...
if.end:                                           ; preds = %entry
  ...
  %2 = load ptr, ptr %vfn, align 8, !invariant.load !39
...
while.end_to_outline:                             ; preds = %newFuncRoot
  ...
  %vtable.i = load ptr, ptr %call8, align 8, !tbaa !37
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !39
