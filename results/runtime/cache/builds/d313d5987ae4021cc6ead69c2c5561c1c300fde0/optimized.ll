...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %initial) #8
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 41, ptr nonnull %word) #8
  ...
  %3 = load i64, ptr %gep, align 8, !tbaa !8
...
if.then19.i25:                                    ; preds = %while.body
  ...
  br i1 %tobool.not.i35, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41, label %if.then28.i36
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41: ; preds = %while.body, %if.then19.i25, %if.then28.i36
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 41, ptr nonnull %word) #8
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %initial) #8
