...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc27
  %indvars.iv2 = phi i64 [ %indvars.iv, %for.cond7.preheader ], [ %indvars.iv.next3, %for.inc27 ]
  %max.1 = phi i32 [ %max.0, %for.cond7.preheader ], [ %max.2, %for.inc27 ]
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, -1
  %cmp8 = icmp sgt i64 %indvars.iv2, 0
  br i1 %cmp8, label %for.body9, label %for.inc29

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [25 x i32], ptr @a, i64 0, i64 %indvars.iv.next3
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %cmp14.not = icmp slt i32 %3, %2
  br i1 %cmp14.not, label %for.inc27, label %if.then

if.then:                                          ; preds = %for.body9
  %arrayidx16 = getelementptr inbounds nuw [25 x i32], ptr @b, i64 0, i64 %indvars.iv.next3
