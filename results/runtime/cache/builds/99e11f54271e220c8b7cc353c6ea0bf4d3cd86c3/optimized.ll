...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv5 = phi i64 [ %idxprom7, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc13 ]
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, 1
  %cmp3 = icmp slt i64 %indvars.iv.next6, %0
  br i1 %cmp3, label %for.body4, label %for.cond20

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv.next6
  %1 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !13
  %2 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !13
  %cmp9.not = icmp sgt i32 %1, %2
  br i1 %cmp9.not, label %for.inc13, label %if.then10

if.then10:                                        ; preds = %for.body4
  %3 = trunc nsw i64 %indvars.iv.next6 to i32
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %3, i32 noundef %m) #10
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next6
...
for.cond20:                                       ; preds = %for.cond2, %for.body22
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body22 ], [ %idxprom7, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ undef, %for.cond2 ]
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, 1
  %cmp21 = icmp slt i64 %indvars.iv.next9, %0
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next9
  %4 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !13
  %spec.select = tail call i32 @llvm.smax.i32(i32 %t.0, i32 %4)
