...
while.cond:                                       ; preds = %while.body, %entry
  %.pr8 = phi i32 [ %sub, %while.body ], [ %.pr, %entry ]
  %a.0 = phi i32 [ %inc, %while.body ], [ 0, %entry ]
  %cmp = icmp sgt i32 %.pr8, 99
...
while.cond8:                                      ; preds = %while.cond8.preheader, %while.body13
  %.pr10 = phi i32 [ %1, %while.body13 ], [ %.pr9, %while.cond8.preheader ]
  %c.0 = phi i32 [ %inc14, %while.body13 ], [ 0, %while.cond8.preheader ]
  %1 = add i32 %.pr10, -20
  %or.cond15 = icmp ult i32 %1, 30
  br i1 %or.cond15, label %while.body13, label %while.cond17.preheader
...
while.cond17:                                     ; preds = %while.cond17.preheader, %while.body22
  %.pr11 = phi i32 [ %2, %while.body22 ], [ %.pr10, %while.cond17.preheader ]
  %d.0 = phi i32 [ %inc23, %while.body22 ], [ 0, %while.cond17.preheader ]
  %2 = add i32 %.pr11, -10
  %or.cond16 = icmp ult i32 %2, 10
  br i1 %or.cond16, label %while.body22, label %land.end30.preheader
...
land.end30:                                       ; preds = %land.end30.preheader, %while.body31
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr11, %land.end30.preheader ]
