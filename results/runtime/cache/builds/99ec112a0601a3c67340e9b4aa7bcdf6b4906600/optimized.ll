...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv11
...
if.then9:                                         ; preds = %if.end
  ...
  %invariant.op6.reass = add i32 %invariant.op, %add
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv8, %6
...
for.inc:                                          ; preds = %for.cond17
  ...
  %sub25.reass = add i32 %invariant.op6.reass, %7
  %idxprom26 = sext i32 %sub25.reass to i64
  %arrayidx27 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %idxprom26
  %8 = load i8, ptr %arrayidx27, align 1, !tbaa !5
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv8
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv15 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next16, %for.inc44 ]
  %exitcond22.not = icmp eq i64 %indvars.iv15, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv15, %2
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv15
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond35, !llvm.loop !12

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond27.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv23
