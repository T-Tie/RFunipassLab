...
while.cond4:                                      ; preds = %if.end44, %while.end
  %lenq.0 = phi i32 [ %i.0.lcssa, %while.end ], [ %i.1.lcssa, %if.end44 ]
  %p.0 = phi ptr [ %a, %while.end ], [ %incdec.ptr47, %if.end44 ]
  %len.0 = phi i32 [ %i.0.lcssa, %while.end ], [ %len.1, %if.end44 ]
...
while.end19:                                      ; preds = %while.cond8
  %i.1.lcssa = phi i32 [ %i.1, %while.cond8 ]
  %add = add i32 %len.0, 1
  %inc20 = add i32 %add, %i.1.lcssa
...
if.end44:                                         ; preds = %for.end, %if.then31, %for.end42
  %len.1 = phi i32 [ %i.1.lcssa, %for.end42 ], [ %inc20, %if.then31 ], [ %inc20, %for.end ]
