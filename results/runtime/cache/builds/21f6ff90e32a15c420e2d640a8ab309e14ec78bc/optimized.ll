...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %sum) #10
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %efficient) #10
  br label %for.cond
...
for.inc.gvnsink.split:                            ; preds = %if.then6, %if.then13, %if.else16
  %.str.2.sink = phi ptr [ @.str.2, %if.else16 ], [ @.str.1, %if.then13 ], [ @.str, %if.then6 ]
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %efficient) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %sum) #10
