...
for.cond6:                                        ; preds = %for.cond, %for.inc106
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc106 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp7 = icmp slt i64 %indvars.iv16, %3
  br i1 %cmp7, label %for.body8, label %for.end108

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [99 x double], ptr %b, i64 0, i64 %indvars.iv16
  %4 = load double, ptr %arrayidx10, align 8, !tbaa !12
  %arrayidx14 = getelementptr inbounds nuw [99 x double], ptr %a, i64 0, i64 %indvars.iv16
  %5 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %mul15 = fmul double %5, 4.000000e+00
  %arrayidx17 = getelementptr inbounds nuw [99 x double], ptr %c, i64 0, i64 %indvars.iv16
