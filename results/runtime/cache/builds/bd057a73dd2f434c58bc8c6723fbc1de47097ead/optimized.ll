...
for.cond:                                         ; preds = %for.inc5, %entry
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc5 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv16, %1
  br i1 %cmp, label %for.cond1.preheader, label %for.cond8.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv16
  br label %for.cond1
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  %indvars.iv23 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next24, %for.inc25 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %2
  br i1 %exitcond28.not, label %for.end27, label %for.cond11

for.cond11:                                       ; preds = %for.cond8, %for.inc19
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc19 ], [ 0, %for.cond8 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond.not, label %for.inc25, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv19
...
for.end27.loopexit:                               ; preds = %for.body13
  ...
  %7 = trunc nuw nsw i64 %indvars.iv19 to i32
  %.pre43 = and i64 %indvars.iv23, 4294967295
  br label %for.end27

for.end27:                                        ; preds = %for.cond8, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre43, %for.end27.loopexit ], [ %2, %for.cond8 ]
  %i.114 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.cond8 ]
  %y1.1 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.cond8 ]
  %8 = sext i32 %y1.1 to i64
  %smax32 = call i32 @llvm.smax.i32(i32 %y1.1, i32 %0)
  %wide.trip.count34 = sext i32 %smax32 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body30, %for.end27
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body30 ], [ %8, %for.end27 ]
  %exitcond35.not = icmp eq i64 %indvars.iv29, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end42, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, 1
  %arrayidx34 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %idxprom31.pre-phi, i64 %indvars.iv.next30
  %9 = load i32, ptr %arrayidx34, align 4, !tbaa !5
  %cmp35 = icmp ne i32 %9, 0
  %cmp37 = icmp sge i64 %indvars.iv.next30, %1
...
for.end42.split.loop.exit:                        ; preds = %for.body30
  %10 = trunc nsw i64 %indvars.iv29 to i32
  br label %for.end42

for.end42:                                        ; preds = %for.cond28, %for.end42.split.loop.exit
  %i.2.lcssa = phi i32 [ %10, %for.end42.split.loop.exit ], [ %smax32, %for.cond28 ]
  %smax39 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %i.114, i32 %0)
  %wide.trip.count41 = zext i32 %smax39 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.body45, %for.end42
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body45 ], [ %idxprom31.pre-phi, %for.end42 ]
  %exitcond42.not = icmp eq i64 %indvars.iv36, %wide.trip.count41
  br i1 %exitcond42.not, label %for.end59, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %arrayidx50 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next37, i64 %8
  %11 = load i32, ptr %arrayidx50, align 4, !tbaa !5
  %cmp51 = icmp ne i32 %11, 0
  %12 = trunc nuw i64 %indvars.iv.next37 to i32
  %cmp54 = icmp sle i32 %0, %12
  %or.cond6 = or i1 %cmp54, %cmp51
  br i1 %or.cond6, label %for.end59.split.loop.exit, label %for.cond43, !llvm.loop !16
...
for.end59:                                        ; preds = %for.cond43, %for.end59.split.loop.exit
  %i.3.lcssa = phi i32 [ %13, %for.end59.split.loop.exit ], [ %smax39, %for.cond43 ]
  %sub = sub nsw i32 %i.3.lcssa, %i.114
