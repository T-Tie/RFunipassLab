...
for.end.thread:                                   ; preds = %for.cond2
  %cmp68 = icmp sgt i32 %index.0, -1
  br i1 %cmp68, label %if.then7, label %for.inc12
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc21
  %indvars.iv14 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next15, %for.inc21 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %for.end23, label %for.inc21
