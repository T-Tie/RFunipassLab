...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %d) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %e) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %f) #5
...
while.cond1:                                      ; preds = %while.body4, %while.end
  %2 = phi i32 [ %sub6, %while.body4 ], [ %.pr5, %while.end ]
...
while.cond35:                                     ; preds = %land.end30
  ...
  br i1 %cmp36, label %while.body40, label %while.end41

while.body40:                                     ; preds = %while.cond35
  store i32 %8, ptr %f, align 4, !tbaa !5
  br label %while.end41

while.end41:                                      ; preds = %while.cond35, %while.cond26, %while.body40
  ...
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %10, i32 noundef %11, i32 noundef %12, i32 noundef %13, i32 noundef %14, i32 noundef %15) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %f) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %e) #5
