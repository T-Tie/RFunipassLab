...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body7
  ...
  %cmp6 = icmp slt i64 %indvars.iv.next12, %1
  br i1 %cmp6, label %for.body7, label %for.inc24

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next12
  ...
  %5 = trunc nuw nsw i64 %indvars.iv.next12 to i32
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv9
