...
for.cond52.preheader:                             ; preds = %for.cond36
  ...
  %wide.trip.count119 = zext nneg i32 %smax99 to i64
...
for.cond55:                                       ; preds = %for.cond52, %for.inc80
  ...
  %exitcond120.not = icmp eq i64 %indvars.iv114, %wide.trip.count119
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count136 = zext nneg i32 %smax99 to i64
  br label %for.cond96
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond137.not = icmp eq i64 %indvars.iv131, %wide.trip.count136
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv155 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond148.not, label %if.end178, label %for.inc148
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv155, %14
  %.pre = add nuw nsw i64 %indvars.iv155, 1
