...
for.end17:                                        ; preds = %for.cond7
  %m.1.lcssa = phi i32 [ %m.1, %for.cond7 ]
  %cmp18 = icmp ne i32 %m.1.lcssa, 1
...
for.end28:                                        ; preds = %for.cond4
  %j.0.lcssa = phi i32 [ %j.0, %for.cond4 ]
  br label %for.cond29
...
for.end38:                                        ; preds = %for.cond29
  %sub.lcssa = phi i32 [ %sub, %for.cond29 ]
  %idxprom40 = sext i32 %sub.lcssa to i64
