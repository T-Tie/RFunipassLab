...
land.lhs.true:                                    ; preds = %for.body33
  ...
  br i1 %cmp37, label %for.inc53.gvnsink.split, label %land.lhs.true46

land.lhs.true46:                                  ; preds = %land.lhs.true
  br label %for.inc53.gvnsink.split

for.inc53.gvnsink.split:                          ; preds = %land.lhs.true46, %land.lhs.true
  %.str.1.sink = phi ptr [ @.str, %land.lhs.true ], [ @.str.1, %land.lhs.true46 ]
  %b.1.ph = phi i32 [ 1, %land.lhs.true ], [ %b.0, %land.lhs.true46 ]
  %call51 = call i32 (ptr, ...) @printf(ptr noundef %.str.1.sink, i32 noundef %5) #7
  br label %for.inc53

for.inc53:                                        ; preds = %for.body33, %for.inc53.gvnsink.split
  %b.1 = phi i32 [ %b.1.ph, %for.inc53.gvnsink.split ], [ %b.0, %for.body33 ]
