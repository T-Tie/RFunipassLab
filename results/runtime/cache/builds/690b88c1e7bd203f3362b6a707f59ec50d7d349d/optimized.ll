...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20500, ptr %a) #12
  call void @llvm.lifetime.start.p0(i64 2000, ptr %b) #12
  br label %for.cond
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 2000, ptr %b) #12
  call void @llvm.lifetime.end.p0(i64 20500, ptr %a) #12
...
if.end:                                           ; preds = %entry
  %0 = load i8, ptr %__c.addr, align 1, !tbaa !18
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !18
