...
while.cond:                                       ; preds = %if.end29, %entry
  ...
  %or.cond14 = select i1 %call16.i, i1 %or.cond.i, i1 false
  br i1 %or.cond14, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #11
...
if.end:                                           ; preds = %while.body
  ...
  %cmp8 = icmp slt i32 %add7, 81
  br i1 %cmp8, label %if.else14, label %if.then25

if.end.thread:                                    ; preds = %while.body
  %add = add nsw i32 %sum.0, %conv
  %cmp82 = icmp slt i32 %add, 81
  br i1 %cmp82, label %if.end19, label %if.then25

if.else14:                                        ; preds = %if.end
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %if.end19

if.end19:                                         ; preds = %if.end.thread, %if.else14
  %_ZSt4cout.sink = phi ptr [ %call15, %if.else14 ], [ @_ZSt4cout, %if.end.thread ]
  %sum.13 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end.thread ]
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, ptr noundef nonnull %a)
...
if.then25:                                        ; preds = %if.end, %if.end.thread
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a)
  br label %if.end29
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull captures(none) %a) #10
  ret i32 0
}
