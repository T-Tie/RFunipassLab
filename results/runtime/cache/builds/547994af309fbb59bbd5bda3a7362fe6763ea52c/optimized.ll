...
land.lhs.true.i:                                  ; preds = %for.body
  ...
  %1 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !10, !invariant.load !9
  %2 = add i64 %1, -41
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #14
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  %num.19 = phi i32 [ 0, %if.end.thread ], [ %num.0, %if.then9 ], [ %num.0, %if.end ]
  %blank.18 = phi i64 [ 0, %if.end.thread ], [ 1, %if.then9 ], [ 0, %if.end ]
  ...
  %add17 = add i64 %call15, %blank.18
  %3 = trunc i64 %add17 to i32
  %conv20 = add i32 %num.19, %3
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #13
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %letter) #13
  ret i32 0
}
