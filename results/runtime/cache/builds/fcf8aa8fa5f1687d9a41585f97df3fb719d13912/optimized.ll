...
for.end:                                          ; preds = %for.cond1
  %m.0.lcssa = phi i32 [ %m.0, %for.cond1 ]
  %cmp7 = icmp ne i32 %m.0.lcssa, %j.0
...
if.then8:                                         ; preds = %for.end
  ...
  %idxprom11 = sext i32 %m.0.lcssa to i64
...
while.cond:                                       ; preds = %while.body, %for.end
  %phiofops = phi i32 [ -1, %for.end ], [ %i.1, %while.body ]
...
while.cond11:                                     ; preds = %if.end, %for.body10
  ...
  %cmp12 = icmp slt i32 %add, %i.1.lcssa
...
for.inc29:                                        ; preds = %while.cond11
  %n.0.lcssa = phi i32 [ %n.0, %while.cond11 ]
  %idxprom27.lcssa = phi i64 [ %idxprom27, %while.cond11 ]
  %add26 = add nsw i32 %n.0.lcssa, 1
  %arrayidx28 = getelementptr inbounds [1000 x i32], ptr @D, i64 0, i64 %idxprom27.lcssa
...
for.cond31:                                       ; preds = %for.inc41, %for.end30
  ...
  %cmp32 = icmp slt i32 %j.1, %i.1.lcssa
...
for.end43:                                        ; preds = %for.cond31
  %n.2.lcssa = phi i32 [ %n.2, %for.cond31 ]
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %n.2.lcssa) #4
  ret i32 0
}
