...
if.then30:                                        ; preds = %if.else
  %call15.i13 = call double @sqrt(double noundef %5) #7, !tbaa !5, !noalias !15
  %add.i14 = fsub double %call15.i13, %1
  %mul.i15 = fmul double %2, 2.000000e+00
  %div.i16 = fdiv double %add.i14, %mul.i15
  %call21.i17 = call double @sqrt(double noundef %5) #7, !tbaa !5, !noalias !15
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div.i16)
  br label %for.inc
