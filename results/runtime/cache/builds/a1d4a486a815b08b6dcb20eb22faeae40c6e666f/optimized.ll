...
entry:
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef @a, i64 noundef 100)
  call void @_Z2sfv()
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !40
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !42
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !45
  ret ptr %0
}
...
!41 = !{!16, !19, i64 32}
!42 = !{!43, !44, i64 16}
!43 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !44, i64 8, !44, i64 16, !44, i64 24, !44, i64 32, !44, i64 40, !44, i64 48, !24, i64 56}
!44 = !{!"p1 omnipotent char", !21, i64 0}
!45 = !{!43, !44, i64 24}
