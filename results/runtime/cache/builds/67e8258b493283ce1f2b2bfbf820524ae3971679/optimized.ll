...
while.end.thread:                                 ; preds = %while.cond
  ...
  %call1614 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
if.end10:                                         ; preds = %if.end
  ...
  %call14 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx12) #7
...
for.end:                                          ; preds = %for.cond
  call void @_Z12compose_wordPA25_ci(ptr noundef nonnull %word, i32 noundef %0)
