...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax64 = call i32 @llvm.smax.i32(i32 %indvars.iv27, i32 1)
  %smax53 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond66:                                       ; preds = %for.cond81, %for.cond66.preheader
  %indvars.iv61 = phi i64 [ 1, %for.cond66.preheader ], [ %indvars.iv.next62, %for.cond81 ]
...
for.inc:                                          ; preds = %for.cond4
  ...
  %.pre11 = load i32, ptr @j, align 4, !tbaa !5
