...
entry:
  ...
  %rem148 = srem i8 %rem1.lhs.trunc, 50
  %rem1.sext = sext i8 %rem148 to i32
  %sub2 = sub nsw i32 %rem, %rem1.sext
  %div3.lhs.trunc = trunc nsw i32 %sub2 to i16
  %div349 = sdiv i16 %div3.lhs.trunc, 50
  %div3.sext = sext i16 %div349 to i32
  %rem450 = srem i8 %rem148, 20
  %div651 = sdiv i8 %rem148, 20
  %div6.sext = sext i8 %div651 to i32
  %rem752 = srem i8 %rem450, 10
  %rem7.sext = sext i8 %rem752 to i32
  %div953 = sdiv i8 %rem450, 10
  %div9.sext = sext i8 %div953 to i32
  store i32 %rem7.sext, ptr %n, align 4, !tbaa !5
  %rem1054 = srem i8 %rem752, 5
  %rem10.sext = sext i8 %rem1054 to i32
  %div1255 = sdiv i8 %rem752, 5
  %div12.sext = sext i8 %div1255 to i32
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call13, i8 noundef signext %call.i13)
  ...
  %vtable.i14 = load ptr, ptr %call15, align 8, !tbaa !9
  ...
  %add.ptr.i17 = getelementptr inbounds i8, ptr %call15, i64 %vbase.offset.i16
  ...
  %call1.i18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call15, i8 noundef signext %call.i)
  ...
  %vtable.i20 = load ptr, ptr %call17, align 8, !tbaa !9
  %vbase.offset.ptr.i21 = getelementptr i8, ptr %vtable.i20, i64 -24
  %vbase.offset.i22 = load i64, ptr %vbase.offset.ptr.i21, align 8, !invariant.load !11
  %add.ptr.i23 = getelementptr inbounds i8, ptr %call17, i64 %vbase.offset.i22
  ...
  %call1.i25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call17, i8 noundef signext %call.i24)
  ...
  %vtable.i27 = load ptr, ptr %call19, align 8, !tbaa !9
  ...
  %add.ptr.i30 = getelementptr inbounds i8, ptr %call19, i64 %vbase.offset.i29
  ...
  %call1.i32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call19, i8 noundef signext %call.i31)
  ...
  %vtable.i34 = load ptr, ptr %call21, align 8, !tbaa !9
  ...
  %add.ptr.i37 = getelementptr inbounds i8, ptr %call21, i64 %vbase.offset.i36
  ...
  %call1.i39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call21, i8 noundef signext %call.i38)
  ...
  %vtable.i41 = load ptr, ptr %call23, align 8, !tbaa !9
  ...
  %add.ptr.i44 = getelementptr inbounds i8, ptr %call23, i64 %vbase.offset.i43
  %call.i45 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i44, i8 noundef signext 10)
  %call1.i46 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call23, i8 noundef signext %call.i45)
