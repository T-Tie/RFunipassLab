...
if.then:                                          ; preds = %for.body
  ...
  call fastcc void @outlined_ir_func_0(ptr %vbase.offset.ptr.i)
  br label %if.end
...
define internal fastcc void @outlined_ir_func_0(ptr %0) unnamed_addr #5 {
newFuncRoot:
...
if.end.exitStub:                                  ; preds = %if.then_to_outline
  ret void
}
