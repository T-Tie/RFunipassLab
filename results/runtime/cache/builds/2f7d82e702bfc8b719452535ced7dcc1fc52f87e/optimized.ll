...
entry:
  ...
  %smax6 = tail call i32 @llvm.smax.i32(i32 %x, i32 0)
...
for.cond:                                         ; preds = %for.end28, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.end28 ], [ 0, %entry ]
  %4 = load i32, ptr %m, align 4, !tbaa !8
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv9, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !8
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv6, %7
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv9, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !8, !invariant.load !12
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv6
  %10 = load i32, ptr %arrayidx14, align 4, !tbaa !8
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv9, %14
...
for.inc26:                                        ; preds = %for.end, %land.lhs.true, %if.else23
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.sink.sink, i32 noundef %z.0) #7
