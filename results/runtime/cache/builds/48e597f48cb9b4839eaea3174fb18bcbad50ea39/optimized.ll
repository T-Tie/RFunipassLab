...
for.body51:                                       ; preds = %for.cond49
  ...
  %7 = load double, ptr %arrayidx53, align 8, !tbaa !9, !invariant.load !11
...
if.then55:                                        ; preds = %for.body51
  ...
  %8 = load double, ptr %arrayidx58, align 8, !tbaa !9, !invariant.load !11
  ...
  %9 = load double, ptr %arrayidx61, align 8, !tbaa !9, !invariant.load !11
...
if.then67:                                        ; preds = %if.else63
  ...
  %10 = load double, ptr %arrayidx70, align 8, !tbaa !9, !invariant.load !11
...
if.else72:                                        ; preds = %if.else63
  ...
  %11 = load double, ptr %arrayidx75, align 8, !tbaa !9, !invariant.load !11
...
if.then77:                                        ; preds = %if.else72
  ...
  %12 = load double, ptr %arrayidx84, align 8, !tbaa !9, !invariant.load !11
...
if.else93:                                        ; preds = %if.else72
  ...
  %13 = load double, ptr %arrayidx99, align 8, !tbaa !9, !invariant.load !11
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %11, double noundef %13, double noundef %11, double noundef %13) #8
  br label %for.inc110
