...
entry:
  ...
  %i7 = alloca i8, i32 0, align 4
  %i1 = alloca i8, i32 0, align 4
...
if.then36:                                        ; preds = %if.then34
  ...
  %call41 = call double @sqrt(double noundef %14) #6, !tbaa !5
...
if.else:                                          ; preds = %if.then34
  ...
  %mul50 = fmul double %10, %10
  %neg51 = fneg double %mul50
  %15 = call double @llvm.fmuladd.f64(double %mul30, double %12, double %neg51)
  %call52 = call double @sqrt(double noundef %15) #6, !tbaa !5
