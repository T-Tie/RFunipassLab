...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond77.not, label %if.end178.loopexit96, label %for.inc148
...
if.end178.loopexit96:                             ; preds = %for.cond137
  %.pre97 = add nuw nsw i64 %indvars.iv84, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit96
  %.pre.pre-phi = phi i64 [ %.pre97, %if.end178.loopexit96 ], [ %20, %for.cond158 ]
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar12 = call i32 @putchar(i32 noundef 10) #7
  br label %for.inc198
