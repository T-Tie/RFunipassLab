...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre15, %for.body15 ]
  %indvars.iv12 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next13, %for.body15 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv12, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv12
