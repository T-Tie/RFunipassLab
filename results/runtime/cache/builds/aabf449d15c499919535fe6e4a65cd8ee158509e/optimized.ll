...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv22 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next23, %for.inc24 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc24 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax32 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax32 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body7 ], [ 0, %for.cond5.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %indvars.iv22
  br i1 %exitcond.not, label %if.then17, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv19
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv28 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next29, %for.body29 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond33.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv28, 0
  %spec.select = select i1 %cmp30, ptr @.str, ptr @.str.1
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv28
