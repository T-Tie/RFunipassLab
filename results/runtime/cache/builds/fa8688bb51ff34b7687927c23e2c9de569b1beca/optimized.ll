...
for.body38:                                       ; preds = %for.cond36
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %retval.0.i27.loc)
  call fastcc void @outlined_ir_func_0(ptr nonnull %__c.addr.i18, ptr nonnull %retval.0.i27.loc)
  %retval.0.i27.reload = load ptr, ptr %retval.0.i27.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %retval.0.i27.loc)
...
for.body65:                                       ; preds = %for.cond63
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %retval.0.i57.loc)
  call fastcc void @outlined_ir_func_0(ptr nonnull %__c.addr.i48, ptr nonnull %retval.0.i57.loc)
  %retval.0.i57.reload = load ptr, ptr %retval.0.i57.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %retval.0.i57.loc)
