...
for.cond:                                         ; preds = %for.inc26, %entry
  %indvars.iv24 = phi i32 [ %indvars.iv.next25, %for.inc26 ], [ %conv, %entry ]
  %indvars.iv19 = phi i32 [ %indvars.iv.next20, %for.inc26 ], [ 0, %entry ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.body14
  %indvars.iv10 = phi i64 [ %indvars.iv, %for.cond12.preheader ], [ %indvars.iv.next11, %for.body14 ]
  %k.1 = phi i32 [ 1, %for.cond12.preheader ], [ %spec.select, %for.body14 ]
  %cmp13 = icmp slt i64 %indvars.iv10, %3
  br i1 %cmp13, label %for.body14, label %for.end

for.body14:                                       ; preds = %for.cond12
  %4 = sub nuw nsw i64 %indvars.iv10, %indvars.iv
  %arrayidx16 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx16, align 1, !tbaa !5, !invariant.load !8
  %arrayidx19 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv10
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc38
  %indvars.iv16 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next17, %for.inc38 ]
  %exitcond23.not = icmp eq i64 %indvars.iv16, %wide.trip.count22
  br i1 %exitcond23.not, label %for.end40, label %for.inc38

for.inc38:                                        ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv16
  %7 = load i8, ptr %arrayidx35, align 1, !tbaa !5, !invariant.load !8
  %conv36 = sext i8 %7 to i32
  %putchar7 = call i32 @putchar(i32 %conv36)
...
for.end40:                                        ; preds = %for.cond31
  ...
  %8 = sext i32 %indvars.iv24 to i64
  %sext30 = shl i64 %call6, 32
  %9 = ashr exact i64 %sext30, 32
  br label %for.cond44

for.cond44:                                       ; preds = %for.inc51, %for.end40
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc51 ], [ %8, %for.end40 ]
  %cmp45 = icmp slt i64 %indvars.iv27, %9
  br i1 %cmp45, label %for.inc51, label %if.end56

for.inc51:                                        ; preds = %for.cond44
  %arrayidx48 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv27
