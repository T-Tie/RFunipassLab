...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %b) #11
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(256) %b, i8 noundef 0, i64 noundef 256, i1 noundef false) #12
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull %c) #11
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(256) %c, i8 noundef 0, i64 noundef 256, i1 noundef false) #12
...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  call void @outlined_ir_func_0(ptr %b)
  br label %if.then6.i51

if.then6.i51:                                     ; preds = %if.then6.i10
  call void @outlined_ir_func_0(ptr %c)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82: ; preds = %if.then6.i51
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
  ...
  %indvars.iv123 = phi i32 [ %indvars.iv.next124, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82 ]
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count126 = zext i32 %indvars.iv123 to i64
  br label %for.cond37

for.inc30:                                        ; preds = %for.body, %for.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %indvars.iv.next124 = add nuw i32 %indvars.iv123, 1
...
if.end57:                                         ; preds = %for.cond48, %if.then34
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %c) #13
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %b) #13
...
newFuncRoot:
  br label %if.then6.i10_to_outline

if.then6.i10_to_outline:                          ; preds = %newFuncRoot
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %0, i64 noundef 256)
