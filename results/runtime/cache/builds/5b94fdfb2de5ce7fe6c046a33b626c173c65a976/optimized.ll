...
land.lhs.true6:                                   ; preds = %if.end
  ...
  br i1 %cmp7, label %if.then8, label %land.lhs.true11
...
if.end24:                                         ; preds = %if.then23, %land.lhs.true21, %if.end19
  ...
  %cmp25 = icmp sle i32 %2, %12
  br i1 %cmp25, label %land.lhs.true26, label %if.end29

land.lhs.true26:                                  ; preds = %if.end24
  %13 = load i32, ptr %i, align 4, !tbaa !5
  %cmp27 = icmp sle i32 %12, %13
  br i1 %cmp27, label %if.end29, label %if.end29

if.end29:                                         ; preds = %land.lhs.true26, %land.lhs.true26, %if.end24
...
while.end:                                        ; preds = %while.cond
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %15) #5
  %16 = load i32, ptr %b, align 4, !tbaa !5
  %call31 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %16) #5
