...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull %sub) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %.loc)
  call fastcc void @outlined_ir_func_0.4(i64 %0, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %.loc)
  %.reload = load i64, ptr %.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef captures(none) %.loc)
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %.loc127)
  call fastcc void @outlined_ir_func_0.4(i64 %.reload, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %.loc127)
  %.reload128 = load i64, ptr %.loc127, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef captures(none) %.loc127)
  ...
  %1 = load i32, ptr %_M_streambuf_state.i.i.i58, align 8, !tbaa !22
  %cmp.i.i59 = icmp eq i32 %1, 0
  %2 = add i64 %.reload128, -301
  %or.cond.i63 = icmp ult i64 %2, -300
...
if.then19.i64:                                    ; preds = %entry
  %_M_streambuf.i.i65 = getelementptr inbounds nuw i8, ptr %add.ptr15.i57, i64 232
  %3 = load ptr, ptr %_M_streambuf.i.i65, align 8, !tbaa !23
  %call25.i66 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %3)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76: ; preds = %entry, %if.then19.i64, %if.then28.i71
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %s.sink126)
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #6 {
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #10
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.4(i64 %0, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %1) unnamed_addr #6 {
entry_to_outline:
  ...
  %3 = add i64 %0, -301
  %or.cond.i = icmp ult i64 %3, -300
  %or.cond = select i1 %cmp.i.i, i1 %or.cond.i, i1 false
  br i1 %or.cond, label %if.then19.i, label %entry_after_outline.exitStub
...
if.then19.i:                                      ; preds = %entry_to_outline
  ...
  br i1 %tobool.not.i, label %entry_after_outline.exitStub, label %if.then28.i
...
entry_after_outline.exitStub:                     ; preds = %entry_to_outline, %if.then19.i, %if.then28.i
  %vtable7.i11 = phi ptr [ %vtable7.i11.pre, %if.then28.i ], [ %vtable7.i11.pre122, %if.then19.i ], [ %vtable12.i, %entry_to_outline ]
  ...
  %5 = load i64, ptr %_M_width.i1.i15, align 8, !tbaa !9
...
attributes #10 = { nofree nosync nounwind willreturn memory(read) }
