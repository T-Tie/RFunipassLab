...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50000, ptr noundef nonnull dereferenceable(50000) %word) #9
...
for.body5:                                        ; preds = %for.cond3
  ...
  %call9 = call i64 @strlen(ptr noundef %arrayidx7) #10
  %add = add i64 %call9, 1
  ...
  %call17 = call i64 @strlen(ptr noundef %arrayidx15) #10
...
if.then33:                                        ; preds = %if.else
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx7)
...
for.end42:                                        ; preds = %for.cond3
  ...
  %call47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx45)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50000, ptr noundef %word) #11
  ret i32 0
}
