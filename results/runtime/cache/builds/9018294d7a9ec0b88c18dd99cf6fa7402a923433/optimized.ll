...
if.then15:                                        ; preds = %if.else
  ...
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i13, align 8, !invariant.load !11
  %gep32 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %5 = load i64, ptr %gep32, align 8, !tbaa !13, !invariant.load !11
...
if.else18:                                        ; preds = %if.else
  ...
  store i8 10, ptr %__c.addr.i11, align 1, !tbaa !12
  %vbase.offset.i14 = load i64, ptr %vbase.offset.ptr.i13, align 8, !invariant.load !11
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i14
  %6 = load i64, ptr %gep, align 8, !tbaa !13, !invariant.load !11
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !27, !invariant.load !11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !35, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !12, !invariant.load !11
  br label %return
...
!27 = !{!28, !32, i64 240}
!28 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !14, i64 0, !29, i64 216, !7, i64 224, !30, i64 225, !31, i64 232, !32, i64 240, !33, i64 248, !34, i64 256}
!29 = !{!"p1 _ZTSSo", !19, i64 0}
!30 = !{!"bool", !7, i64 0}
!31 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !19, i64 0}
!32 = !{!"p1 _ZTSSt5ctypeIcE", !19, i64 0}
!33 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !19, i64 0}
!34 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !19, i64 0}
!35 = !{!36, !7, i64 56}
...
!38 = !{!"p1 _ZTS15__locale_struct", !19, i64 0}
!39 = !{!"p1 int", !19, i64 0}
!40 = !{!"p1 short", !19, i64 0}
!41 = !{!42, !42, i64 0}
