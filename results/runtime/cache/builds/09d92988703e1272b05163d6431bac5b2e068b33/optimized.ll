...
if.end37:                                         ; preds = %for.body30
  ...
  %5 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !14
...
if.end37.thread:                                  ; preds = %for.body30
  ...
  %6 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !14
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37.thread, %if.end37, %if.then44
  %min.3 = phi i32 [ %5, %if.then44 ], [ %min.1, %if.end37 ], [ %6, %if.end37.thread ]
  %l2.3 = phi i32 [ %4, %if.then44 ], [ %l2.1, %if.end37 ], [ 0, %if.end37.thread ]
