...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count26 = zext nneg i32 %smax20 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond27.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select, %for.body15 ], [ %l1.0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select6, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv13
  ...
  %spec.select6 = call i32 @llvm.smax.i32(i32 %5, i32 %max.0)
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond13, !llvm.loop !13

for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv16 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next17, %for.body30 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.body30 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.body30 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count26
  br i1 %exitcond22.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv16, 0
  %7 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %idxprom40
  %8 = load i32, ptr %7, align 4, !tbaa !5
  %cmp42 = icmp slt i32 %8, %min.1
  %9 = trunc nuw nsw i64 %indvars.iv16 to i32
  %spec.select7 = select i1 %cmp42, i32 %9, i32 %l2.1
  %spec.select8 = call i32 @llvm.smin.i32(i32 %8, i32 %min.1)
  %l2.3 = select i1 %cmp31, i32 0, i32 %spec.select7
  %min.3 = select i1 %cmp31, i32 %8, i32 %spec.select8
