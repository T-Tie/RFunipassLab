...
if.end24:                                         ; preds = %if.then23, %land.lhs.true21, %if.end19
  ...
  br i1 %cmp25, label %if.end29, label %if.end29

if.end29:                                         ; preds = %if.end24, %if.end24
...
while.end:                                        ; preds = %while.cond
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %14) #5
  %15 = load i32, ptr %b, align 4, !tbaa !5
  %call31 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %15) #5
