...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv137 = phi i64 [ %indvars.iv.next138, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv137 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc31 ], [ 0, %for.cond ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %indvars.iv137
  br i1 %exitcond95.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv91
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv137
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv91, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv86 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next87, %for.inc28 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %indvars.iv137
  br i1 %exitcond90.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv91, i64 %indvars.iv86
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond115.not = icmp eq i64 %indvars.iv111, %indvars.iv137
  br i1 %exitcond115.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %indvars.iv137
  br i1 %exitcond100.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv96, i64 %indvars.iv111
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv111
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select80, %for.body57 ], [ %6, %if.then51 ]
  %exitcond105.not = icmp eq i64 %indvars.iv101, %indvars.iv137
  br i1 %exitcond105.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv101, i64 %indvars.iv111
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %spec.select80 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1
  br label %for.cond55, !llvm.loop !15

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv106 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next107, %for.inc84 ]
  %exitcond110.not = icmp eq i64 %indvars.iv106, %indvars.iv137
  br i1 %exitcond110.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv106, i64 %indvars.iv111
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv122 = phi i64 [ %indvars.iv.next123, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond126.not = icmp eq i64 %indvars.iv122, %indvars.iv137
  br i1 %exitcond126.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond121.not = icmp eq i64 %indvars.iv116, %indvars.iv137
  br i1 %exitcond121.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv122, i64 %indvars.iv116
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv116, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv122, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv132 = phi i64 [ %indvars.iv.next133, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond136.not = icmp eq i64 %indvars.iv132, %indvars.iv137
  br i1 %exitcond136.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep82 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv132
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv127 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next128, %for.inc129 ]
  %exitcond131.not = icmp eq i64 %indvars.iv127, %indvars.iv137
  br i1 %exitcond131.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv127, i64 %indvars.iv132
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep83 = getelementptr [100 x i32], ptr %invariant.gep82, i64 %indvars.iv127
  store i32 %12, ptr %gep83, align 4, !tbaa !5
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z2jzPA100_ii(ptr noundef nonnull %num, i32 noundef %2)
