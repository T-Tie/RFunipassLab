...
for.inc:                                          ; preds = %for.cond
  ...
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx5)
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc35
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre13, %for.inc35 ]
  %indvars.iv10 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next11, %for.inc35 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv10, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv10
  ...
  br i1 %cmp19, label %for.inc35, label %if.else
...
if.else:                                          ; preds = %for.body15
  ...
  br i1 %cmp27, label %for.inc35, label %if.else31

if.else31:                                        ; preds = %if.else
  br label %for.inc35

for.inc35:                                        ; preds = %for.body15, %if.else, %if.else31
  %.str.2.sink.sink = phi ptr [ @.str, %for.body15 ], [ @.str.2, %if.else31 ], [ @.str.1, %if.else ]
