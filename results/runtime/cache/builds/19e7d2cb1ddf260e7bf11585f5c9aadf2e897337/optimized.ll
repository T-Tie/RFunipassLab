...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 550, ptr %a) #10
  ...
  call void @llvm.lifetime.start.p0(i64 3300, ptr %b) #10
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 3300, i1 false)
  call void @llvm.lifetime.start.p0(i64 2200, ptr %num) #10
...
if.end91:                                         ; preds = %for.cond73, %if.then67
  call void @llvm.lifetime.end.p0(i64 2200, ptr %num) #10
  call void @llvm.lifetime.end.p0(i64 3300, ptr %b) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #10
  call void @llvm.lifetime.end.p0(i64 550, ptr %a) #10
  ret i32 0
}
