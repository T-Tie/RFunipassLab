...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %for.cond23
  ...
  store i8 32, ptr %__c.addr.i, align 1, !tbaa !35
  ...
  %12 = load i64, ptr %gep100, align 8, !tbaa !11
...
for.end33:                                        ; preds = %for.cond23
  ...
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %gep101) #9
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit33: ; preds = %for.cond45
  ...
  %call.i.i25 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr50) #9
  ...
  store i8 32, ptr %__c.addr.i34, align 1, !tbaa !35
  ...
  %16 = load i64, ptr %gep102, align 8, !tbaa !11
...
for.end56:                                        ; preds = %for.cond45
  ...
  %call.i.i49 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr59) #9
...
!39 = !{!40, !41, i64 16}
!40 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !41, i64 8, !41, i64 16, !41, i64 24, !41, i64 32, !41, i64 40, !41, i64 48, !20, i64 56}
!41 = !{!"p1 omnipotent char", !17, i64 0}
!42 = !{!40, !41, i64 24}
!43 = !{!24, !28, i64 240}
!44 = !{!45, !7, i64 56}
!45 = !{!"_ZTSSt5ctypeIcE", !46, i64 0, !47, i64 16, !26, i64 24, !48, i64 32, !48, i64 40, !49, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!46 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!47 = !{!"p1 _ZTS15__locale_struct", !17, i64 0}
!48 = !{!"p1 int", !17, i64 0}
