...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc25
  ...
  br i1 %exitcond29.not, label %for.end27, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body15 ], [ 0, %for.cond13.preheader ]
  %sum.1 = phi i32 [ %spec.select, %for.body15 ], [ %sum.0, %for.cond13.preheader ]
