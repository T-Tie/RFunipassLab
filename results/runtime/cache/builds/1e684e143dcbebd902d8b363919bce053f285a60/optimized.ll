...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  %10 = phi i32 [ %inc53, %for.inc52 ], [ 0, %for.end41 ]
  %max.0 = phi i32 [ 0, %for.end41 ], [ %max.1, %for.inc52 ]
  %cmp43 = icmp slt i32 %10, 1000
...
for.body44:                                       ; preds = %for.cond42
  ...
  %11 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !13
  %cmp47 = icmp slt i32 %max.0, %11
...
for.inc52:                                        ; preds = %for.body44, %if.then48
  %max.1 = phi i32 [ %11, %if.then48 ], [ %max.0, %for.body44 ]
  %inc53 = add nsw i32 %10, 1
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %12 = phi i32 [ %inc81, %for.inc80 ], [ 0, %if.else58 ]
  %cmp61 = icmp slt i32 %12, 1000
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %12, %15
  %cmp69 = icmp slt i32 %14, %add68
