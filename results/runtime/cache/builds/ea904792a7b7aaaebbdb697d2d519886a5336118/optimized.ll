...
for.cond:                                         ; preds = %if.end28, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %if.end28 ], [ 0, %entry ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.end31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv13
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv13, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc25 ], [ 0, %for.end ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond12.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv13, i64 %indvars.iv8
...
for.cond:                                         ; preds = %if.end27, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %if.end27 ], [ 0, %entry ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.end30, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv13
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv13
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc24 ], [ 0, %for.end ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond12.not, label %if.end27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv13
...
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 %k, i32 2)
  %wide.trip.count13 = zext nneg i32 %smax to i64
  %wide.trip.count = zext i32 %k to i64
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.end ], [ 2, %entry ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond15.preheader, label %for.cond1.preheader
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax18 = tail call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %smax25 = tail call i32 @llvm.smax.i32(i32 %1, i32 2)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.end36
  %indvars.iv21 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next22, %for.end36 ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end39, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv15 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next16, %for.inc34 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end36, label %for.inc34

for.inc34:                                        ; preds = %for.cond20
  %arrayidx28 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv21
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %arrayidx33 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %3
...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre10 = phi i32 [ %.pre1012, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc10 ], [ 0, %while.body ]
  %0 = sext i32 %.pre10 to i64
  %cmp = icmp slt i64 %indvars.iv6, %0
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre1012 = phi i32 [ %.pre1011, %for.inc ], [ %.pre10, %for.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond ]
  %1 = sext i32 %.pre1012 to i64
  %cmp4 = icmp slt i64 %indvars.iv, %1
  br i1 %cmp4, label %for.body6, label %for.inc10

for.body6:                                        ; preds = %for.cond3
  %2 = or i64 %indvars.iv, %indvars.iv6
  %3 = and i64 %2, 4294967295
  %tobool.not = icmp eq i64 %3, 0
  br i1 %tobool.not, label %for.inc, label %if.then

if.then:                                          ; preds = %for.body6
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre1011 = phi i32 [ %.pre1012, %for.body6 ], [ %.pre9, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %.sink = phi i32 [ %dec, %for.inc17 ], [ %.pre10, %for.cond ]
