...
for.inc:                                          ; preds = %for.cond
  ...
  %2 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %add.ptr, i1 false, i1 true, i1 false)
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc13
  %indvars.iv87 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next88, %for.inc13 ]
...
for.inc13:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv87
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #10
  %6 = trunc i64 %call10 to i32
  %conv = add i32 %6, 1
  %add.ptr12 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv87
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc42
  %.pre103 = phi i32 [ %0, %for.cond16.preheader ], [ %.pre, %for.inc42 ]
  %indvars.iv94 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next95, %for.inc42 ]
  %sum.0 = phi i32 [ 0, %for.cond16.preheader ], [ %sum.1, %for.inc42 ]
  %k.0 = phi i32 [ 0, %for.cond16.preheader ], [ %k.1, %for.inc42 ]
  %7 = sext i32 %.pre103 to i64
  %cmp17 = icmp slt i64 %indvars.iv94, %7
...
for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv94
...
for.cond23:                                       ; preds = %for.cond23.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv91 = phi i64 [ %11, %for.cond23.preheader ], [ %indvars.iv.next92, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  %cmp24 = icmp slt i64 %indvars.iv91, %10
  br i1 %cmp24, label %for.inc31, label %for.end33

for.inc31:                                        ; preds = %for.cond23
  %add.ptr27 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv91
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr27) #9
  ...
  %vtable.i17 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i18 = getelementptr i8, ptr %vtable.i17, i64 -24
  %vbase.offset.i19 = load i64, ptr %vbase.offset.ptr.i18, align 8, !invariant.load !11
  %gep82 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i19
  %12 = load i64, ptr %gep82, align 8, !tbaa !12
  %cmp.not.i = icmp eq i64 %12, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.inc31
...
for.end33:                                        ; preds = %for.cond23
  %gep83 = getelementptr [41 x i8], ptr %invariant.gep, i64 %indvars.iv94
  %call.i.i24 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %gep83) #9
  %call1.i25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %gep83, i64 noundef %call.i.i24)
  %vtable.i64 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i65 = getelementptr i8, ptr %vtable.i64, i64 -24
  %vbase.offset.i66 = load i64, ptr %vbase.offset.ptr.i65, align 8, !invariant.load !11
  %add.ptr.i67 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i66
  %call.i68 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i67, i8 noundef signext 10)
  %call1.i69 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i68)
...
for.inc42:                                        ; preds = %for.body18, %for.end33
  %.pre = phi i32 [ %.pre.pre, %for.end33 ], [ %.pre103, %for.body18 ]
...
for.cond45:                                       ; preds = %for.cond45.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit53
  %14 = phi i32 [ %.pre103, %for.cond45.preheader ], [ %.pre102, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit53 ]
  %indvars.iv99 = phi i64 [ %8, %for.cond45.preheader ], [ %indvars.iv.next100, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit53 ]
  %sub46 = add nsw i32 %14, -1
  %15 = sext i32 %sub46 to i64
  %cmp47 = icmp slt i64 %indvars.iv99, %15
  br i1 %cmp47, label %for.inc54, label %for.end56

for.inc54:                                        ; preds = %for.cond45
  %add.ptr50 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv99
  %call.i.i33 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr50) #9
  %call1.i34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr50, i64 noundef %call.i.i33)
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i41)
  store i8 32, ptr %__c.addr.i41, align 1, !tbaa !36
  %vtable.i42 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i43 = getelementptr i8, ptr %vtable.i42, i64 -24
  %vbase.offset.i44 = load i64, ptr %vbase.offset.ptr.i43, align 8, !invariant.load !11
  %gep84 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i44
  %16 = load i64, ptr %gep84, align 8, !tbaa !12
  %cmp.not.i47 = icmp eq i64 %16, 0
  br i1 %cmp.not.i47, label %if.end.i51, label %if.then.i48

if.then.i48:                                      ; preds = %for.inc54
...
if.end.i51:                                       ; preds = %for.inc54
  %call2.i52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit53
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit53: ; preds = %if.then.i48, %if.end.i51
  ...
  %.pre102 = load i32, ptr %n, align 4, !tbaa !5
...
for.end56:                                        ; preds = %for.cond45
  ...
  %call.i.i55 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr59) #9
  %call1.i56 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr59, i64 noundef %call.i.i55)
  %vtable.i71 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i72 = getelementptr i8, ptr %vtable.i71, i64 -24
  %vbase.offset.i73 = load i64, ptr %vbase.offset.ptr.i72, align 8, !invariant.load !11
  %add.ptr.i74 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i73
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i74, i8 noundef signext 10)
  %call1.i75 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
  %call.i.i76 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i75)
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !23
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !40
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !43
...
if.else:                                          ; preds = %entry
  ...
  %3 = load ptr, ptr %vfn, align 8, !invariant.load !11
...
!40 = !{!41, !42, i64 16}
!41 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !42, i64 8, !42, i64 16, !42, i64 24, !42, i64 32, !42, i64 40, !42, i64 48, !21, i64 56}
!42 = !{!"p1 omnipotent char", !18, i64 0}
!43 = !{!41, !42, i64 24}
!44 = !{!25, !29, i64 240}
!45 = !{!46, !7, i64 56}
!46 = !{!"_ZTSSt5ctypeIcE", !47, i64 0, !48, i64 16, !27, i64 24, !49, i64 32, !49, i64 40, !50, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!47 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!48 = !{!"p1 _ZTS15__locale_struct", !18, i64 0}
!49 = !{!"p1 int", !18, i64 0}
!50 = !{!"p1 short", !18, i64 0}
