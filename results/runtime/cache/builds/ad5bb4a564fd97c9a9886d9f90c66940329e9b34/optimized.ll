...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %a) #7
  br label %for.cond
...
for.cond2:                                        ; preds = %for.cond, %for.inc76
  ...
  %indvars.iv2 = phi i64 [ %5, %for.inc76 ], [ 0, %for.cond ]
  %mul3 = mul nsw i32 %2, 3
  %3 = sext i32 %mul3 to i64
  %cmp4 = icmp slt i64 %indvars.iv2, %3
  br i1 %cmp4, label %for.body5, label %for.end78

for.body5:                                        ; preds = %for.cond2
  %4 = trunc nuw nsw i64 %indvars.iv2 to i32
  %rem = urem i32 %4, 3
  %cmp6 = icmp eq i32 %rem, 0
  %5 = add nuw nsw i64 %indvars.iv2, 1
  br i1 %cmp6, label %if.then, label %for.inc76

if.then:                                          ; preds = %for.body5
  %arrayidx8 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %5
  %6 = load double, ptr %arrayidx8, align 8, !tbaa !12, !invariant.load !14
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %indvars.iv2
  %7 = load double, ptr %arrayidx14, align 8, !tbaa !12, !invariant.load !14
  %mul15 = fmul double %7, 4.000000e+00
  %8 = add nuw nsw i64 %indvars.iv2, 2
  %arrayidx18 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %8
  %9 = load double, ptr %arrayidx18, align 8, !tbaa !12, !invariant.load !14
  %10 = fneg double %9
...
if.then21:                                        ; preds = %if.then
  %fneg = fneg double %6
  %call25 = call double @sqrt(double noundef %11) #8, !tbaa !5
  %add26 = fsub double %call25, %6
  %mul29 = fmul double %7, 2.000000e+00
  %div = fdiv double %add26, %mul29
  %call34 = call double @sqrt(double noundef %11) #8, !tbaa !5
  %sub = fsub double %fneg, %call34
  %div38 = fdiv double %sub, %mul29
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div38) #7
  br label %if.end
...
if.then41:                                        ; preds = %if.end
  %fneg45 = fneg double %6
  %mul48 = fmul double %7, 2.000000e+00
  %div49 = fdiv double %fneg45, %mul48
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div49) #7
  br label %if.end51
...
if.then53:                                        ; preds = %if.end51
  %fneg57 = fneg double %6
  %mul60 = fmul double %7, 2.000000e+00
...
if.then69:                                        ; preds = %if.then53
  %call70 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div67, double noundef %div67) #7
  br label %for.inc76

if.else:                                          ; preds = %if.then53
  %call71 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div61, double noundef %div67, double noundef %div61, double noundef %div67) #7
  br label %for.inc76
...
for.end78:                                        ; preds = %for.cond2
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %a) #7
