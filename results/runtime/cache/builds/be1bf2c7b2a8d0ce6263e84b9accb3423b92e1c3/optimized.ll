...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc30
  %3 = phi i32 [ %4, %for.inc30 ], [ %1, %for.cond3.preheader ]
  %i.0 = phi i32 [ %inc31, %for.inc30 ], [ 1, %for.cond3.preheader ]
  %cmp4 = icmp slt i32 %i.0, %3
  br i1 %cmp4, label %for.cond6.preheader, label %for.cond33.preheader
...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc27
  %4 = phi i32 [ %9, %for.inc27 ], [ %3, %for.cond6.preheader ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc27 ], [ 0, %for.cond6.preheader ]
  %i.1 = phi i32 [ %i.2, %for.inc27 ], [ %i.0, %for.cond6.preheader ]
  %5 = sext i32 %i.1 to i64
  %cmp7 = icmp slt i64 %indvars.iv34, %5
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv31 = phi i64 [ %5, %for.cond15.preheader ], [ %indvars.iv.next32, %for.inc23 ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body35
  %10 = phi i32 [ %.pre, %for.body35 ], [ %3, %for.cond33.preheader ]
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body35 ], [ 0, %for.cond33.preheader ]
  %11 = sext i32 %10 to i64
  %cmp34 = icmp slt i64 %indvars.iv37, %11
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %10, -1
  %12 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv37, %12
