...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv47
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc15 ], [ %indvars.iv41, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv43
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv61.in = phi i32 [ %indvars.iv61, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv61 = add i32 %indvars.iv61.in, -1
  %indvars.iv.next55 = add nsw i64 %indvars.iv54, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next55
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv57 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next58, %for.inc39 ]
  %exitcond65.not = icmp eq i64 %indvars.iv57, %wide.trip.count64
  br i1 %exitcond65.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv57
