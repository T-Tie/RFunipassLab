...
if.end:                                           ; preds = %if.else27, %if.then25
  %.sink1 = phi i32 [ 30, %if.else27 ], [ 31, %if.then25 ]
...
for.end:                                          ; preds = %for.cond7
  call fastcc void @outlined_ir_func_0(ptr %m2, i32 29, i32 %n1.0)
  br label %if.end163
...
if.end107:                                        ; preds = %if.else105, %if.then103
  %.sink = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ]
...
for.end111:                                       ; preds = %for.cond85
  call fastcc void @outlined_ir_func_0(ptr %m2, i32 28, i32 %n182.0)
  br label %if.end163
...
define internal fastcc void @outlined_ir_func_0(ptr %0, i32 %1, i32 %2) unnamed_addr #3 {
newFuncRoot:
...
if.end54:                                         ; preds = %if.else52, %if.then50
  %.sink = phi i32 [ 30, %if.else52 ], [ 31, %if.then50 ]
...
if.end163.exitStub:                               ; preds = %if.end79
  ret void
}
