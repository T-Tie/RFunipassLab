...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %smax = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %indvars.iv28, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx3)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx9)
