...
for.inc:                                          ; preds = %cond.false, %for.body4
  %min.sink1 = phi ptr [ %min, %cond.false ], [ %arrayidx8, %for.body4 ]
  %5 = load i32, ptr %min.sink1, align 4, !tbaa !5
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %8 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !9
  %sub = sub nsw i32 %8, %7
...
for.body29:                                       ; preds = %for.cond27
  ...
  %10 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !9
...
for.body34:                                       ; preds = %for.cond32
  ...
  %12 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !9
  %13 = load i32, ptr %min, align 4, !tbaa !5
  %cmp39 = icmp slt i32 %12, %13
  br i1 %cmp39, label %for.inc48, label %cond.false45

cond.false45:                                     ; preds = %for.body34
  br label %for.inc48

for.inc48:                                        ; preds = %cond.false45, %for.body34
  %min.sink = phi ptr [ %min, %cond.false45 ], [ %arrayidx38, %for.body34 ]
  %14 = load i32, ptr %min.sink, align 4, !tbaa !5
...
for.inc59:                                        ; preds = %for.cond51
  ...
  %17 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !9
  %sub58 = sub nsw i32 %17, %16
...
if.then:                                          ; preds = %for.end64
  %18 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
  br label %cleanup

if.end:                                           ; preds = %for.end64
  %19 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
...
for.end100:                                       ; preds = %for.cond66
  ...
  %add102 = add nsw i32 %19, %call
  br label %cleanup

cleanup:                                          ; preds = %for.end100, %if.then
  %retval.0 = phi i32 [ %18, %if.then ], [ %add102, %for.end100 ]
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef %result) #6
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z4xiaoi(i32 noundef %3) #8
...
for.end28:                                        ; preds = %for.cond19
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %result) #8
