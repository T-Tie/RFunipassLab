...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %b) #10
...
for.cond17:                                       ; preds = %for.inc25, %for.end
  %indvars.iv16 = phi i64 [ %3, %for.inc25 ], [ %1, %for.end ]
...
for.inc25:                                        ; preds = %for.cond17
  ...
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %a, i64 0, i64 %3
...
for.end26:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %a) #11
  ret i32 0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !24, !invariant.load !8
  ret i64 %0
}
...
!29 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !18, i64 0}
!30 = !{!"_ZTSNSt8ios_base6_WordsE", !18, i64 0, !26, i64 8}
!31 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !18, i64 0}
!32 = !{!"_ZTSSt6locale", !33, i64 0}
!33 = !{!"p1 _ZTSNSt6locale5_ImplE", !18, i64 0}
