...
for.cond5:                                        ; preds = %for.inc19, %for.end
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv11, 0
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, -1
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next12
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv11
...
for.inc19:                                        ; preds = %for.body7
  ...
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next12
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !12

for.end20.split.loop.exit:                        ; preds = %for.body7
  %6 = trunc nsw i64 %indvars.iv.next12 to i32
  br label %for.end20
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.end47 ], [ %7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %cmp23 = icmp sgt i64 %indvars.iv17, -1
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv17
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %8, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %cmp30 = icmp sgt i64 %indvars.iv14, %indvars.iv17
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %9 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv14
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv14
...
for.end47:                                        ; preds = %for.cond29
  ...
  %arrayidx55 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv17
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select9 = call i32 @llvm.smax.i32(i32 %12, i32 %sum.2)
