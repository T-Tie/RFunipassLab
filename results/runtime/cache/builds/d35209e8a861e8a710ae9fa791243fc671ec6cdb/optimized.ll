...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %num) #6
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %ans) #6
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z2jzPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %num, i32 noundef %4) #7
...
for.end28:                                        ; preds = %for.cond19
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %num) #7
