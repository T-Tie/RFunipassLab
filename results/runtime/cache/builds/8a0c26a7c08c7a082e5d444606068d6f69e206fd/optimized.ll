...
for.inc:                                          ; preds = %if.end26.thread, %if.end26, %if.else, %if.then35
  %total1.2 = phi i32 [ %add25, %if.end26.thread ], [ %add36, %if.then35 ], [ %add37, %if.else ], [ %total1.1, %if.end26 ]
  %inc = add nsw i32 %1, 1
...
for.inc85:                                        ; preds = %if.end68.thread, %if.end68, %if.else81, %if.then79
  %total2.2 = phi i32 [ %add67, %if.end68.thread ], [ %add80, %if.then79 ], [ %add82, %if.else81 ], [ %total2.1, %if.end68 ]
