...
for.end100:                                       ; preds = %for.cond66
  ...
  %add102 = add nsw i32 %18, %call
  br label %cleanup

cleanup:                                          ; preds = %for.end64, %for.end100
  %retval.0 = phi i32 [ %add102, %for.end100 ], [ %18, %for.end64 ]
