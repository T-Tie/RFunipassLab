...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 240, ptr noundef %p4) #6
...
if.then58:                                        ; preds = %if.then56
  ...
  br label %if.end67.gvnsink.split

if.else62:                                        ; preds = %if.then56
  %cmp63 = fcmp oeq double %2, 0.000000e+00
  br i1 %cmp63, label %if.end67.gvnsink.split, label %if.end67

if.end67.gvnsink.split:                           ; preds = %if.else62, %if.then58
  %.sink = phi double [ %fneg59, %if.then58 ], [ %2, %if.else62 ]
  %mul65 = fmul double 2.000000e+00, %3
  %div66 = fdiv double %.sink, %mul65
  store double %div66, ptr %d, align 8, !tbaa !9
  br label %if.end67

if.end67:                                         ; preds = %if.end67.gvnsink.split, %if.else62
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 240, ptr noundef %p4) #6
