...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) @a) #9
...
for.body:                                         ; preds = %for.cond
  %0 = load i8, ptr %p.0, align 1, !tbaa !9
  %cmp2.not = icmp eq i8 %0, 32
  %idxprom7 = sext i32 %storemerge to i64
  %1 = getelementptr inbounds [100 x i8], ptr @a, i64 0, i64 %idxprom7
...
if.then:                                          ; preds = %land.lhs.true, %for.body
  %call9 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %2)
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %lor.lhs.false, %land.lhs.true, %if.then
  %4 = phi i32 [ %storemerge, %lor.lhs.false ], [ %storemerge, %land.lhs.true ], [ %.pre, %if.then ]
...
entry:
  ...
  %vtable7.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !13
  %vbase.offset.ptr8.i = getelementptr i8, ptr %vtable7.i, i64 -24
  %vbase.offset9.i = load i64, ptr %vbase.offset.ptr8.i, align 8, !invariant.load !15
  %add.ptr10.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i
  %_M_width.i1.i = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %0 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !16
  ...
  %vtable12.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !13
  %vbase.offset.ptr13.i = getelementptr i8, ptr %vtable12.i, i64 -24
  %vbase.offset14.i = load i64, ptr %vbase.offset.ptr13.i, align 8, !invariant.load !15
  %add.ptr15.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset14.i
  %call16.i = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i) #10
  %1 = add i64 %0, -101
...
if.then19.i:                                      ; preds = %entry
  %vtable20.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !13
  %vbase.offset.ptr21.i = getelementptr i8, ptr %vtable20.i, i64 -24
  %vbase.offset22.i = load i64, ptr %vbase.offset.ptr21.i, align 8, !invariant.load !15
...
if.then28.i:                                      ; preds = %if.then19.i
  %vtable29.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !13
  %vbase.offset.ptr30.i = getelementptr i8, ptr %vtable29.i, i64 -24
  %vbase.offset31.i = load i64, ptr %vbase.offset.ptr30.i, align 8, !invariant.load !15
