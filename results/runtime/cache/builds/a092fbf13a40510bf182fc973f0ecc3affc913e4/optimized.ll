...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %an) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(400) %an, ptr noundef nonnull readonly align 16 dereferenceable(400) @__const.main.an, i64 noundef 400, i1 noundef false) #7
...
if.then:                                          ; preds = %entry
  %ldexp = call double @ldexp(double noundef 1.000000e+00, i32 %0) #8
...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv11
...
for.cond38.preheader:                             ; preds = %for.cond29
  %3 = and i64 %indvars.iv11, 4294967295
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc45
  %indvars.iv16 = phi i64 [ %3, %for.cond38.preheader ], [ %5, %for.inc45 ]
  %4 = trunc nuw i64 %indvars.iv16 to i32
...
if.end49:                                         ; preds = %for.cond38, %if.then
  %_ZSt4cout.sink21 = phi ptr [ %call3, %if.then ], [ @_ZSt4cout, %for.cond38 ]
  %vtable.i3 = load ptr, ptr %_ZSt4cout.sink21, align 8, !tbaa !16, !invariant.load !14
  %vbase.offset.ptr.i4 = getelementptr i8, ptr %vtable.i3, i64 -24
  %vbase.offset.i5 = load i64, ptr %vbase.offset.ptr.i4, align 8, !invariant.load !14
  %add.ptr.i6 = getelementptr inbounds i8, ptr %_ZSt4cout.sink21, i64 %vbase.offset.i5
  ...
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink21, i8 noundef signext %call.i)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %an) #9
