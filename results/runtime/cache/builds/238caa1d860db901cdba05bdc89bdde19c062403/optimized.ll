...
for.cond1:                                        ; preds = %for.inc, %for.body
  %a1.1 = phi i32 [ %a1.0, %for.body ], [ %a1.24, %for.inc ]
  %j.0 = phi i32 [ 1, %for.body ], [ %inc, %for.inc ]
  %a2.1 = phi i32 [ %a2.0, %for.body ], [ %a2.26, %for.inc ]
...
for.inc:                                          ; preds = %for.body4, %if.then, %land.lhs.true
  %a2.26 = phi i32 [ %a2.1, %for.body4 ], [ %a2.1, %land.lhs.true ], [ %j.0, %if.then ]
  %a1.24 = phi i32 [ %a1.1, %for.body4 ], [ %a1.1, %land.lhs.true ], [ %i.0, %if.then ]
