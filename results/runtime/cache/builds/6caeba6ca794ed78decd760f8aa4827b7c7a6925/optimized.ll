...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef align 16 %sentence) #5
...
while.end16:                                      ; preds = %while.cond2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %p) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #5
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef %sentence) #5
  ret i32 0
}
