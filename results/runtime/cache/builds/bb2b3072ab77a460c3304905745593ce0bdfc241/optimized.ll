...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load double, ptr %sum, align 8, !tbaa !9
  %2 = load double, ptr %efficient, align 8, !tbaa !9
  %div4 = fdiv double %2, %1
...
for.inc:                                          ; preds = %for.body, %if.then13, %if.else16, %if.then6
  %sample.1 = phi double [ %sample.0, %if.then13 ], [ %sample.0, %if.else16 ], [ %sample.0, %if.then6 ], [ %div4, %for.body ]
