...
for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.cond.cleanup3 ], [ 0, %entry ]
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 90000, ptr nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 90000, ptr nonnull %b) #6
  ...
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %m, ptr noundef nonnull %n)
  %0 = load i32, ptr %m, align 4, !tbaa !9
  %1 = load i32, ptr %n, align 4, !tbaa !9
  call void @_Z6stubidiiPA150_i(i32 noundef %0, i32 noundef %1, ptr noundef nonnull %a)
  ...
  call void @_Z6stubidiiPA150_i(i32 noundef %2, i32 noundef %3, ptr noundef nonnull %b)
  br label %for.cond
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 90000, ptr nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 90000, ptr nonnull %a) #6
  ret i32 0
}
