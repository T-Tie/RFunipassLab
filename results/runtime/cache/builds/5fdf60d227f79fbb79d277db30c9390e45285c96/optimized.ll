...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv13 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next14, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond.not, label %for.cond13, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [35000 x i32], ptr %a, i64 0, i64 %indvars.iv13
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !12
  %call7 = call noundef i32 @_Z4factii(i32 noundef %2, i32 noundef 2) #8
  %arrayidx9 = getelementptr inbounds nuw [35000 x i32], ptr %b, i64 0, i64 %indvars.iv13
  store i32 %call7, ptr %arrayidx9, align 4, !tbaa !5
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond2, !llvm.loop !13

for.cond13:                                       ; preds = %for.cond2, %for.body15
  %3 = phi i32 [ %.pre, %for.body15 ], [ %0, %for.cond2 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body15 ], [ 0, %for.cond2 ]
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv17, %4
  br i1 %cmp14, label %for.body15, label %for.end22

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [35000 x i32], ptr %b, i64 0, i64 %indvars.iv17
...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef nonnull %b) #8
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef nonnull %a) #8
...
for.cond:                                         ; preds = %if.else, %if.end
  %sum.0 = phi i32 [ %sum.1, %if.end ], [ 1, %if.else ]
  %i.0 = phi i32 [ %inc, %if.end ], [ %m, %if.else ]
...
if.then6:                                         ; preds = %for.body
  %div = sdiv i32 %n, %i.0
  %call = tail call noundef i32 @_Z4factii(i32 noundef %div, i32 noundef %i.0) #9
