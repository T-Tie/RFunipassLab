...
for.cond9:                                        ; preds = %for.inc24, %if.end
  ...
  %cmp10 = icmp sle i32 %add, %.lcssa
  br i1 %cmp10, label %for.body11, label %for.inc27.loopexit
...
if.then38:                                        ; preds = %land.lhs.true
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5) #7
  br label %for.inc53

if.then48:                                        ; preds = %land.lhs.true
  %call51 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5) #7
  br label %for.inc53

for.inc53:                                        ; preds = %if.then48, %for.body33, %if.then38
  %b.1 = phi i32 [ 1, %if.then38 ], [ %b.0, %for.body33 ], [ %b.0, %if.then48 ]
