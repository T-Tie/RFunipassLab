...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %str1) #5
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 16 %str1)
  unreachable
}
