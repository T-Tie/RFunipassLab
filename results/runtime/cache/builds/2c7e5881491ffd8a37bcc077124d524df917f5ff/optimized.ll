...
for.body4:                                        ; preds = %for.cond2
  %call5 = call noundef i32 @_Z1Fi(i32 noundef %2) #5
  %cmp6 = icmp slt i32 %4, %call5
  br i1 %cmp6, label %if.then, label %for.inc8

if.then:                                          ; preds = %for.body4
  %call7 = call noundef i32 @_Z1Fi(i32 noundef %2) #5
  store i32 %call7, ptr %z, align 4, !tbaa !5
  br label %for.inc8
...
for.end10:                                        ; preds = %for.cond2
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %4)
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %cmp5 = icmp sgt i32 %add4, %3
  br i1 %cmp5, label %if.then, label %for.inc

if.then:                                          ; preds = %land.lhs.true
  %call6 = call noundef i32 @_Z1Fi(i32 noundef %add) #6
  %add7 = add nsw i32 %call6, 1
  store i32 %add7, ptr %z, align 4, !tbaa !5
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %4 = load i32, ptr %z, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %z) #4
