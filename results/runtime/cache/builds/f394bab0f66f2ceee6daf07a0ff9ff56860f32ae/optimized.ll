...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %storemerge5 = phi i32 [ 65, %if.end24 ], [ %inc21.i2, %if.end35 ]
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge5, i32 noundef %6)
  %.pre9 = load i32, ptr @i, align 4, !tbaa !5
  br label %if.end35

if.end35:                                         ; preds = %if.then31, %for.body27
  %7 = phi i32 [ %.pre9, %if.then31 ], [ %storemerge5, %for.body27 ]
  %inc21.i2 = add nsw i32 %7, 1
  br label %for.cond25

for.cond39:                                       ; preds = %for.cond25, %if.end49
  %storemerge6 = phi i32 [ %inc21.i3, %if.end49 ], [ 97, %for.cond25 ]
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge6, i32 noundef %8)
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %if.end49

if.end49:                                         ; preds = %if.then45, %for.body41
  %9 = phi i32 [ %.pre, %if.then45 ], [ %storemerge6, %for.body41 ]
  %inc21.i3 = add nsw i32 %9, 1
  br label %for.cond39
