...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 28000, ptr noundef align 16 %sz) #4
  br label %for.cond

for.cond:                                         ; preds = %for.inc35, %entry
  %s.0 = phi i32 [ 0, %entry ], [ %inc34, %for.inc35 ]
  %0 = phi i32 [ %inc36, %for.inc35 ], [ 0, %entry ]
...
for.end:                                          ; preds = %for.cond1
  ...
  %2 = load i32, ptr %arrayidx8, align 4, !tbaa !8, !invariant.load !12
...
land.lhs.true:                                    ; preds = %for.end
  ...
  %3 = load i32, ptr %arrayidx12, align 4, !tbaa !8, !invariant.load !12
...
land.lhs.true14:                                  ; preds = %land.lhs.true
  ...
  %4 = load i32, ptr %arrayidx17, align 4, !tbaa !8, !invariant.load !12
...
land.lhs.true19:                                  ; preds = %land.lhs.true14
  ...
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !8, !invariant.load !12
...
land.lhs.true24:                                  ; preds = %land.lhs.true19
  ...
  %6 = load i32, ptr %arrayidx27, align 4, !tbaa !8
  %cmp28 = icmp eq i32 %6, 0
  br i1 %cmp28, label %land.lhs.true29, label %for.inc35

land.lhs.true29:                                  ; preds = %land.lhs.true24
  %7 = load i32, ptr %arrayidx7, align 4, !tbaa !8
...
for.cond41:                                       ; preds = %for.inc69, %for.body40
  ...
  %8 = phi i32 [ %inc70, %for.inc69 ], [ 0, %for.body40 ]
  %cmp42 = icmp slt i32 %8, 6
...
for.inc73:                                        ; preds = %for.cond41
  %call72 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %q.1) #5
  %inc74 = add nsw i32 %i.0, 1
  br label %for.cond38, !llvm.loop !15

for.end75:                                        ; preds = %for.cond38
  call void @llvm.lifetime.end.p0(i64 noundef 28000, ptr noundef %sz) #5
  ret i32 0
}
