...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.24, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.26, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.28, %for.inc ]
  %6 = sext i32 %5 to i64
...
for.inc:                                          ; preds = %for.body3, %land.lhs.true
  ...
  %f.28 = phi i32 [ %f.2.ph, %land.lhs.true ], [ %f.1, %for.body3 ]
  %star1.26 = phi i32 [ %star1.2.ph, %land.lhs.true ], [ %star1.1, %for.body3 ]
  %star2.24 = phi i32 [ %star2.2.ph, %land.lhs.true ], [ %star2.1, %for.body3 ]
