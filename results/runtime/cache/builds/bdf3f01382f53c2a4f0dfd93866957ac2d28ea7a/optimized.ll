...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %c) #9
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %mul24.pre-phi = phi double [ %.pre6, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre2, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre1, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi10, 0.000000e+00
...
if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi16 = phi double [ %.pre15, %if.then28 ], [ %.pre-phi10, %if.end ]
  %mul36.pre-phi = phi double [ %.pre11, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre5, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre4, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre3, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi16, 0.000000e+00
