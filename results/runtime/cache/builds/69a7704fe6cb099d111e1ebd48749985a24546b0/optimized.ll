...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %8, %for.inc ]
...
for.inc:                                          ; preds = %for.body3, %land.lhs.true
  %star1.28 = phi i32 [ %star1.2.ph, %land.lhs.true ], [ %star1.1, %for.body3 ]
  %star2.26 = phi i32 [ %star2.2.ph, %land.lhs.true ], [ %star2.1, %for.body3 ]
  %f.24 = phi i32 [ %f.2.ph, %land.lhs.true ], [ %f.1, %for.body3 ]
