...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef align 16 %zfc) #4
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef align 16 %wt) #4
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef align 16 %tar) #4
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %tag) #4
...
for.body:                                         ; preds = %for.cond
  store i32 0, ptr %tag, align 4, !tbaa !5
...
for.body13:                                       ; preds = %for.cond10
  ...
  %3 = load i8, ptr %arrayidx17, align 1, !tbaa !9
  %conv18 = sext i8 %3 to i32
  %cmp19 = icmp ne i32 %conv14, %conv18
  br i1 %cmp19, label %if.then, label %if.end

if.then:                                          ; preds = %for.body13
  store i32 1, ptr %tag, align 4, !tbaa !5
  br label %for.end
...
for.end:                                          ; preds = %if.then, %for.cond10
  %4 = load i32, ptr %tag, align 4, !tbaa !5
...
for.end37:                                        ; preds = %for.end33, %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %tag) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #6
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %tar) #6
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %wt) #6
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %zfc) #6
  ret i32 0
}
