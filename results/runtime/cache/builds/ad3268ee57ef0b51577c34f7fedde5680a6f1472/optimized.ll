...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %indvars.iv18 = phi i64 [ %indvars.iv, %for.cond3.preheader ], [ %indvars.iv.next19, %for.inc ]
  %3 = trunc nuw i64 %indvars.iv18 to i32
  %cmp4 = icmp sgt i32 %pre.0, %3
  br i1 %cmp4, label %for.body6, label %for.end

for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv18
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv22 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next23, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body17

for.body17:                                       ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv22
  ...
  %gep17 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i6
  %7 = load i64, ptr %gep17, align 8, !tbaa !9, !invariant.load !8
