...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %m) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %n) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %c) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %d) #8
...
for.end57:                                        ; preds = %for.cond47
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %d) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %c) #9
