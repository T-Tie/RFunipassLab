...
for.cond2:                                        ; preds = %for.inc24, %for.end
  %1 = phi i32 [ %add, %for.inc24 ], [ 0, %for.end ]
...
for.cond5:                                        ; preds = %for.inc13, %for.body4
  %index.0 = phi i32 [ %1, %for.body4 ], [ %index.1, %for.inc13 ]
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !12
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %6, i32 noundef %7) #5
