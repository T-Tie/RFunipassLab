...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv26 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next27, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax42 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count43 = zext nneg i32 %smax42 to i64
  %wide.trip.count36 = zext i32 %j.0 to i64
  br label %for.cond15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv26
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv38
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc37 ], [ %indvars.iv30, %for.body17 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37.not, label %for.cond15.loopexit, label %for.body21
...
for.body21:                                       ; preds = %for.cond19
  ...
  %6 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv45 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next46, %for.inc53 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count43
  br i1 %exitcond49.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv45
  %7 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !12
  %call48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7)
  %cmp49 = icmp slt i64 %indvars.iv45, %4
