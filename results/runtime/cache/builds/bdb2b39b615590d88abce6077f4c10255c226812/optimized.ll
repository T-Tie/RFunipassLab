...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 captures(none) dereferenceable(1000) %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 captures(none) dereferenceable(1000) %b) #7
...
if.then19.i:                                      ; preds = %entry
  ...
  %vtable7.i16.pre52 = load ptr, ptr @_ZSt3cin, align 8, !tbaa !5
  br i1 %tobool.not.i, label %if.then6.i15, label %if.then28.i

if.then28.i:                                      ; preds = %if.then19.i
  %vbase.offset.ptr30.i = getelementptr i8, ptr %vtable7.i16.pre52, i64 -24
...
if.then6.i15:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  %vtable7.i16 = phi ptr [ %vtable7.i16.pre, %if.then28.i ], [ %vtable7.i16.pre52, %if.then19.i ], [ %vtable12.i, %entry ]
  ...
  %_M_width.i5.i20 = getelementptr inbounds nuw i8, ptr %add.ptr10.i19, i64 16
  %4 = load i64, ptr %_M_width.i5.i20, align 8, !tbaa !9
  ...
  %6 = add i64 %4, -1001
  %or.cond.i30 = icmp ult i64 %6, -1000
  %or.cond45 = select i1 %cmp.i.i26, i1 %or.cond.i30, i1 false
  br i1 %or.cond45, label %if.then19.i31, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit43

if.then19.i31:                                    ; preds = %if.then6.i15
  %_M_streambuf.i.i32 = getelementptr inbounds nuw i8, ptr %add.ptr15.i24, i64 232
  %7 = load ptr, ptr %_M_streambuf.i.i32, align 8, !tbaa !23
  %call25.i33 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %7)
  %cmp.i6.i34 = icmp eq i32 %call25.i33, -1
  %conv.i35 = zext i1 %cmp.i6.i34 to i64
  %expval.i36 = call i64 @llvm.expect.i64(i64 %conv.i35, i64 1)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit43: ; preds = %if.then6.i15, %if.then19.i31, %if.then28.i38
...
for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit43
...
if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit43
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit43 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ], [ %.str.3..str.2, %for.end65 ]
