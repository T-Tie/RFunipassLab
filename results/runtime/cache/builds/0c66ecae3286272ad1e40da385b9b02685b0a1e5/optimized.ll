...
for.inc74.gvnsink.split:                          ; preds = %if.then, %if.then44, %if.else58
  ...
  %6 = phi i64 [ %idxprom45, %if.else58 ], [ %idxprom45, %if.then44 ], [ %idxprom19, %if.then ]
  %k.1.ph = phi i32 [ %k.0, %if.else58 ], [ %k.0, %if.then44 ], [ %inc18, %if.then ]
  %idxprom69 = sext i32 %add.sink1 to i64
  %arrayidx70 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %6, i64 %idxprom69
...
for.end76:                                        ; preds = %for.cond2
  ...
  %7 = add i32 %smax13, 1
  %wide.trip.count14 = zext i32 %7 to i64
  br label %for.cond86
...
for.body88:                                       ; preds = %for.cond86
  ...
  %8 = and i64 %sub97, 4294967295
  %smax = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv9, i64 %8
  br label %for.cond94
...
for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv6, %8
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %9 = load i8, ptr %arrayidx103, align 1, !tbaa !26
...
if.else106:                                       ; preds = %for.body96
  ...
  %10 = load i8, ptr %arrayidx110, align 1, !tbaa !26
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %10)
  br label %for.inc113
