...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %mul24.pre-phi = phi double [ %.pre10, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre6, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre5, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi14, 0.000000e+00
...
if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi20 = phi double [ %.pre19, %if.then28 ], [ %.pre-phi14, %if.end ]
  %mul36.pre-phi = phi double [ %.pre15, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre9, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre8, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre7, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi20, 0.000000e+00
