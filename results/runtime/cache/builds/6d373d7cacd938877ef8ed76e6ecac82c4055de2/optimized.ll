...
define internal void @outlined_ir_func_0(ptr nonnull %0) #9 {
newFuncRoot:
  br label %for.end33_to_outline

for.end33_to_outline:                             ; preds = %newFuncRoot
  %add.ptr36 = getelementptr inbounds [41 x i8], ptr %0, i64 -1
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr36)
