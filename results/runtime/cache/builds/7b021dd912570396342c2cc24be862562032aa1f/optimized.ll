...
for.cond17:                                       ; preds = %for.inc, %if.then9
  ...
  br i1 %cmp20, label %for.inc, label %for.inc32.loopexit
...
for.inc32.loopexit:                               ; preds = %for.cond17
  br label %for.inc32

for.inc32:                                        ; preds = %for.inc32.loopexit, %for.body, %if.end
  %len.2 = phi i32 [ %inc, %if.end ], [ %len.0, %for.body ], [ 0, %for.inc32.loopexit ]
