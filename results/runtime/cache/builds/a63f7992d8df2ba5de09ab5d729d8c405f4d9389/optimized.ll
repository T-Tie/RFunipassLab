...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %sum) #10
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %sum) #10
