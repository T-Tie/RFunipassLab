...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc19
  %indvars.iv12 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next13, %for.inc19 ]
  %exitcond.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body13

for.body13:                                       ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv12, i64 %indvars.iv12
...
for.body13.for.end22_crit_edge:                   ; preds = %for.body13
  ...
  %.pre29 = and i64 %indvars.iv12, 4294967295
  br label %for.end22
...
for.end48:                                        ; preds = %for.cond36, %for.end48.split.loop.exit
  ...
  %reass.sub7 = sub nsw i32 %i.2.lcssa, %i.1.lcssa
  %sub51 = add i32 %reass.sub7, -2
