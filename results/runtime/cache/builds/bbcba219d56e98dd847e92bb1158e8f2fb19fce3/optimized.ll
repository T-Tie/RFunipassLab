...
for.cond:                                         ; preds = %for.body, %entry
  %n.promoted9 = phi i32 [ %n.promoted, %entry ], [ %sub, %for.body ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  %cmp = icmp sgt i32 %n.promoted9, 99
...
for.body:                                         ; preds = %for.cond
  %sub = add nsw i32 %n.promoted9, -100
  store i32 %sub, ptr %n, align 4, !tbaa !5
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !9

for.cond2:                                        ; preds = %for.cond2.preheader, %for.body5
  %n.promoted11 = phi i32 [ %sub3, %for.body5 ], [ %n.promoted9, %for.cond2.preheader ]
  %a.0 = phi i32 [ %inc8, %for.body5 ], [ 0, %for.cond2.preheader ]
  %cmp4 = icmp sgt i32 %n.promoted11, 49
...
for.body5:                                        ; preds = %for.cond2
  %sub3 = add nsw i32 %n.promoted11, -50
  store i32 %sub3, ptr %n, align 4, !tbaa !5
  %inc8 = add nuw nsw i32 %a.0, 1
  br label %for.cond2, !llvm.loop !12

for.cond10:                                       ; preds = %for.cond10.preheader, %for.body13
  %n.promoted13 = phi i32 [ %sub11, %for.body13 ], [ %n.promoted11, %for.cond10.preheader ]
  %b.0 = phi i32 [ %inc16, %for.body13 ], [ 0, %for.cond10.preheader ]
  %cmp12 = icmp sgt i32 %n.promoted13, 19
...
for.body13:                                       ; preds = %for.cond10
  %sub11 = add nsw i32 %n.promoted13, -20
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body21
  %n.promoted15 = phi i32 [ %sub19, %for.body21 ], [ %n.promoted13, %for.cond18.preheader ]
  %c.0 = phi i32 [ %inc24, %for.body21 ], [ 0, %for.cond18.preheader ]
  %cmp20 = icmp sgt i32 %n.promoted15, 9
...
for.body21:                                       ; preds = %for.cond18
  %sub19 = add nsw i32 %n.promoted15, -10
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.body29
  %n.promoted17 = phi i32 [ %sub27, %for.body29 ], [ %n.promoted15, %for.cond26.preheader ]
  %d.0 = phi i32 [ %inc32, %for.body29 ], [ 0, %for.cond26.preheader ]
  %cmp28 = icmp sgt i32 %n.promoted17, 4
  br i1 %cmp28, label %for.body29, label %for.cond34.preheader

for.cond34.preheader:                             ; preds = %for.cond26
  %smin = call i32 @llvm.smin.i32(i32 %n.promoted17, i32 noundef 0)
  %0 = sub i32 %n.promoted17, %smin
  br label %for.cond34

for.body29:                                       ; preds = %for.cond26
  %sub27 = add nsw i32 %n.promoted17, -5
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.body37
  %sub3518 = phi i32 [ %sub35, %for.body37 ], [ %n.promoted17, %for.cond34.preheader ]
  %e.0 = phi i32 [ %inc40, %for.body37 ], [ 0, %for.cond34.preheader ]
  %exitcond.not = icmp eq i32 %e.0, %0
  br i1 %exitcond.not, label %for.end41, label %for.body37

for.body37:                                       ; preds = %for.cond34
  %sub35 = add nsw i32 %sub3518, -1
  store i32 %sub35, ptr %n, align 4, !tbaa !5
  %inc40 = add nuw i32 %e.0, 1
  br label %for.cond34, !llvm.loop !16

for.end41:                                        ; preds = %for.cond34
  %call42 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %i.0, i32 noundef %a.0, i32 noundef %b.0, i32 noundef %c.0, i32 noundef %d.0, i32 noundef %0) #6
