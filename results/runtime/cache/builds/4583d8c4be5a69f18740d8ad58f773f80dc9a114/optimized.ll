...
entry:
  ...
  %rem38 = srem i8 %rem3.lhs.trunc, 50
  %rem3.sext = sext i8 %rem38 to i32
  %sub4 = sub nsw i32 %rem, %rem3.sext
  %div5.lhs.trunc = trunc nsw i32 %sub4 to i16
  %div59 = sdiv i16 %div5.lhs.trunc, 50
  %div5.sext = sext i16 %div59 to i32
  %rem6 = srem i32 %0, 50
  %rem8.lhs.trunc = trunc nsw i32 %rem6 to i8
  %div1011 = sdiv i8 %rem8.lhs.trunc, 20
  ...
  %div2913 = sdiv i8 %rem27.lhs.trunc, 5
  %div29.sext = sext i8 %div2913 to i32
