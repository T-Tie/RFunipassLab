...
while.body:                                       ; preds = %while.cond
  %5 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !16
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %for.body19
  ...
  %10 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !16
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !20, !invariant.load !16
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !20, !invariant.load !16
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !22, !invariant.load !16
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !5, !invariant.load !16
  %1 = load i32, ptr %__c2, align 4, !tbaa !5, !invariant.load !16
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
