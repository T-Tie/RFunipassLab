...
for.body19:                                       ; preds = %for.cond17
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %retval.0.i.loc)
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i.loc)
  %retval.0.i.reload = load ptr, ptr %retval.0.i.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef captures(none) %retval.0.i.loc)
...
for.body38:                                       ; preds = %for.cond36
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %retval.0.i27.loc)
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i18, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i27.loc)
  %retval.0.i27.reload = load ptr, ptr %retval.0.i27.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef captures(none) %retval.0.i27.loc)
...
for.inc55.sink.split:                             ; preds = %for.end27, %for.end46
  %csum.1.ph = phi i64 [ %add51, %for.end46 ], [ 0, %for.end27 ]
  %j.2.ph.in = phi i64 [ %indvars.iv.next110, %for.end46 ], [ %indvars.iv.next113, %for.end27 ]
...
for.body65:                                       ; preds = %for.cond63
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i48, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i57.loc)
  %retval.0.i57.reload = load ptr, ptr %retval.0.i57.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef captures(none) %retval.0.i57.loc)
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !27
  br label %return
...
define internal void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %1) #6 {
newFuncRoot:
  br label %for.body19_to_outline

for.body19_to_outline:                            ; preds = %newFuncRoot
  store i8 32, ptr %0, align 1, !tbaa !27
  ...
  %2 = load i64, ptr %gep106, align 8, !tbaa !28, !invariant.load !16
...
!33 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !23, i64 0}
!34 = !{!"_ZTSNSt8ios_base6_WordsE", !23, i64 0, !30, i64 8}
!35 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !23, i64 0}
!36 = !{!"_ZTSSt6locale", !37, i64 0}
!37 = !{!"p1 _ZTSNSt6locale5_ImplE", !23, i64 0}
