...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef nonnull %words) #8
  br label %for.cond
...
if.then:                                          ; preds = %for.body4
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx13) #8
...
if.then30:                                        ; preds = %if.end
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx32) #8
...
for.body38:                                       ; preds = %for.cond36
  ...
  %call.i.i31 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx41) #8
...
for.end46:                                        ; preds = %for.cond36
  %call50 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #9
...
for.end57:                                        ; preds = %for.cond2
  ...
  %call.i.i40 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx59) #8
...
for.body65:                                       ; preds = %for.cond63
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull %retval.0.i57.loc)
  ...
  %call.i.i61 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx68) #8
...
for.end73:                                        ; preds = %for.cond63
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef nonnull %words) #8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !17, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !35, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !41, !invariant.load !14
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !42, !invariant.load !14
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) initializes((0, 1)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %2) unnamed_addr #6 {
for.body19_to_outline:
  ...
  %3 = load i64, ptr %gep106, align 8, !tbaa !44, !invariant.load !14
