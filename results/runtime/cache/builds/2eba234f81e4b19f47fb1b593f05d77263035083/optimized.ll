...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc8 ], [ 1, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv3, %1
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc28 ], [ 1, %for.end10 ]
  %6 = load i32, ptr %x2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp13.not = icmp sgt i64 %indvars.iv11, %7
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv18 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next19, %for.inc46 ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax27 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
  %wide.trip.count28 = zext nneg i32 %smax27 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv18, i64 %indvars.iv15
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  %indvars.iv36 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next37, %for.inc79 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count22
  br i1 %exitcond40.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc76
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc76 ], [ 0, %for.cond49 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond35.not, label %for.inc79, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv36, i64 %indvars.iv30
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc73
  %indvars.iv24 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next25, %for.inc73 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count28
  br i1 %exitcond29.not, label %for.inc76, label %for.inc73

for.inc73:                                        ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv36, i64 %indvars.iv24
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv24, i64 %indvars.iv30
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv46, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv46, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre51, %for.body87 ]
  %indvars.iv41 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next42, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv41, %23
  br i1 %cmp86.not, label %for.inc106, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv41, %24
  %25 = add nsw i64 %indvars.iv41, -1
  %arrayidx101 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %21, i64 %25
  %26 = load i32, ptr %arrayidx101, align 4, !tbaa !5
  %.str.3..str.2 = select i1 %cmp88.not, ptr @.str.3, ptr @.str.2
  %call95 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3..str.2, i32 noundef %26) #6
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %.pre51 = load i32, ptr %y2, align 4, !tbaa !5
