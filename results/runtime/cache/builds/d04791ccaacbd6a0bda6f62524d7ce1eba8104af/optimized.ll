...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 550, ptr nonnull %a) #9
  ...
  call void @llvm.lifetime.start.p0(i64 3300, ptr nonnull %b) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(3300) %b, i8 0, i64 3300, i1 false)
  call void @llvm.lifetime.start.p0(i64 2200, ptr nonnull %num) #9
...
if.else:                                          ; preds = %for.end65
  ...
  call void @outlined_ir_func_0(ptr %call70)
  br label %for.cond73
...
if.end91:                                         ; preds = %for.cond73, %if.then67
  call void @llvm.lifetime.end.p0(i64 2200, ptr nonnull %num) #9
  call void @llvm.lifetime.end.p0(i64 3300, ptr nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #9
  call void @llvm.lifetime.end.p0(i64 550, ptr nonnull %a) #9
  ret i32 0
}
...
if.else_to_outline:                               ; preds = %newFuncRoot
  ...
  br label %for.cond73.exitStub

for.cond73.exitStub:                              ; preds = %if.else_to_outline
  ret void
}
