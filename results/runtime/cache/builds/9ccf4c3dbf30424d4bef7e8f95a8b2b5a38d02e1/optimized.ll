...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv28 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next29, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv28, i32 1
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv32 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next33, %for.inc40 ]
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %4 = trunc nuw i64 %indvars.iv.next33 to i32
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next33
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count44
  br i1 %exitcond45.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv40, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc74 ], [ %indvars.iv35, %for.body48 ]
  %9 = icmp slt i64 %indvars.iv37, %1
  br i1 %9, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv37, i32 1
