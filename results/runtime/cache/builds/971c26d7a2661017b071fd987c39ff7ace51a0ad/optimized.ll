...
for.cond:                                         ; preds = %for.inc28, %entry
  ...
  br i1 %exitcond18.not, label %for.cond31.preheader, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv9 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next10, %for.inc25 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc69
  %indvars.iv29 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next30, %for.inc69 ]
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv24 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next25, %for.inc66 ]
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
  %smax7 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 1)
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  ...
  br i1 %exitcond14.not, label %for.cond13, label %for.inc30, !llvm.loop !19
