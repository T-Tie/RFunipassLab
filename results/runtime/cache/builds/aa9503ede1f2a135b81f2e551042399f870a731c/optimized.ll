...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 200, ptr %str) #8
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 200, ptr %str) #8
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 800, ptr %num) #8
  call void @llvm.memset.p0.i64(ptr align 16 %num, i8 0, i64 800, i1 false)
  %call = call i64 @strlen(ptr noundef %str) #9
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 800, ptr %num) #8
  ret void
}
