...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %a) #3
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %b) #3
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv6
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv13 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next14, %for.inc44 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond19.not = icmp eq i32 %j.0, %smax18
  br i1 %exitcond19.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax15 = call i32 @llvm.smax.i32(i32 %indvars.iv13, i32 0)
  %wide.trip.count16 = zext nneg i32 %smax15 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax24 = call i32 @llvm.smax.i32(i32 %m.0, i32 0)
  %wide.trip.count25 = zext nneg i32 %smax24 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv10 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next11, %for.inc41 ]
  %exitcond17.not = icmp eq i64 %indvars.iv10, %wide.trip.count16
  br i1 %exitcond17.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv10
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next11
  %6 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !12
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv20 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next21, %for.inc58 ]
  %exitcond26.not = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv20
  %7 = load i32, ptr %arrayidx51, align 4, !tbaa !5, !invariant.load !12
  %call52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7)
  %cmp54.not = icmp eq i64 %indvars.iv20, %4
