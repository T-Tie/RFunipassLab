...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv10 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next11, %for.inc27 ]
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv5 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next6, %for.inc24 ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond9.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv10, i64 %indvars.iv5
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv25 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next26, %for.inc67 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count13
  br i1 %exitcond30.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select3, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count18
  br i1 %exitcond19.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv15, i64 %indvars.iv25
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select3 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond36, !llvm.loop !17

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv20 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next21, %for.inc64 ]
...
for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv20, i64 %indvars.iv25
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc92 ], [ 2, %for.end69 ]
  %exitcond42.not = icmp eq i64 %indvars.iv36, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond96.preheader, label %for.cond76.preheader
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv31 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next32, %for.inc89 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count34
  br i1 %exitcond35.not, label %for.inc92, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv31
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv48 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next49, %for.inc117 ]
  %exitcond54.not = icmp eq i64 %indvars.iv48, %wide.trip.count41
  br i1 %exitcond54.not, label %for.end119, label %for.cond101.preheader
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv43 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next44, %for.inc114 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count46
  br i1 %exitcond47.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv43, i64 %7
