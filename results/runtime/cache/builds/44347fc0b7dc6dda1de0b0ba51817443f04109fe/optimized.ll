...
define dso_local noundef i32 @_Z2mmii(i32 noundef %n, i32 noundef %i) local_unnamed_addr #3 {
entry:
...
cleanup:                                          ; preds = %entry, %for.end
  %retval.0 = phi i32 [ %sum.0, %for.end ], [ %0, %entry ]
  ret i32 %retval.0
}
