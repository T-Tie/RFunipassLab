...
entry:
  %0 = add i32 %i, 1
  %smax = tail call i32 @llvm.smax.i32(i32 %i, i32 -1)
  %1 = add i32 %smax, 1
...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond19 = icmp eq i64 %indvars.iv, %wide.trip.count18
  br i1 %exitcond19, label %for.end20, label %for.cond1.preheader
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv14
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv36 = phi i32 [ %indvars.iv.next37, %while.cond ], [ 0, %for.cond ]
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv27
...
while.end:                                        ; preds = %while.cond
  %0 = trunc nuw nsw i64 %indvars.iv27 to i32
...
for.cond8:                                        ; preds = %while.end25, %while.end
  %j.0 = phi i32 [ %sub7, %while.end ], [ %dec, %while.end25 ]
...
while.cond11.outer:                               ; preds = %land.lhs.true, %while.cond11.preheader
  %indvars.iv30.ph = phi i64 [ %indvars.iv.next31, %land.lhs.true ], [ %1, %while.cond11.preheader ]
  %n.0.ph = phi i32 [ %spec.select, %land.lhs.true ], [ 0, %while.cond11.preheader ]
  br label %while.cond11

while.cond11:                                     ; preds = %while.cond11.outer, %while.body13
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %while.body13 ], [ %indvars.iv30.ph, %while.cond11.outer ]
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %2 = trunc nuw i64 %indvars.iv.next31 to i32
  %cmp12 = icmp slt i32 %2, %0
  br i1 %cmp12, label %while.body13, label %while.end25

while.body13:                                     ; preds = %while.cond11
  %3 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next31
  %4 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %cmp18.not = icmp slt i32 %3, %4
  br i1 %cmp18.not, label %while.cond11, label %land.lhs.true, !llvm.loop !15

land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next31
  %5 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %spec.select = tail call i32 @llvm.smax.i32(i32 %5, i32 %n.0.ph)
  br label %while.cond11.outer, !llvm.loop !15

while.end25:                                      ; preds = %while.cond11
  %add26 = add nuw nsw i32 %n.0.ph, 1
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv33 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next34, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select25, %for.body33 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond38.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv33
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select25 = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.2)
