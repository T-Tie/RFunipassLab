; ModuleID = '<stdin>'
source_filename = "/tmp/tmpgmqop26g.cpp"
...
for.inc:                                          ; preds = %for.cond
  ...
  store i32 %1, ptr @Befor, align 4, !tbaa !5
  call void @_Z6FenJiei(i32 noundef %1) #7
...
entry:
  %0 = load i32, ptr @Befor, align 4, !tbaa !5
  %cmp = icmp eq i32 %x, 1
...
if.then:                                          ; preds = %entry
  ...
  %inc = add nsw i32 %1, 1
  store i32 %inc, ptr @counter, align 4, !tbaa !5
  br label %cleanup

for.cond:                                         ; preds = %entry, %for.inc
  %i.0 = phi i32 [ %dec, %for.inc ], [ %0, %entry ]
...
if.then3:                                         ; preds = %for.body
  store i32 %i.0, ptr @Befor, align 4, !tbaa !5
  %div = sdiv i32 %x, %i.0
  tail call void @_Z6FenJiei(i32 noundef %div) #8
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then3
  store i32 %0, ptr @Befor, align 4, !tbaa !5
