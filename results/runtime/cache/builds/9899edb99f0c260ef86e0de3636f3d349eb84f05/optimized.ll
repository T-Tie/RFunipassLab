...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds [110 x i8], ptr @s, i64 0, i64 %indvars.iv.next14
...
for.cond3:                                        ; preds = %for.body, %for.inc
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc ], [ %indvars.iv, %for.body ]
...
for.inc:                                          ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv10
...
for.end:                                          ; preds = %for.cond3
  ...
  %5 = trunc nsw i64 %indvars.iv.next14 to i32
  br label %for.inc11

for.inc11:                                        ; preds = %for.body, %for.end
  %pre.1 = phi i32 [ %5, %for.end ], [ %pre.0, %for.body ]
...
for.inc21:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv16
