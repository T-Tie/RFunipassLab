...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 60000, ptr nonnull %c) #6
  call void @llvm.lifetime.start.p0(i64 600, ptr nonnull %input) #6
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #7
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.end ], [ 0, %entry ]
  %exitcond66 = icmp eq i64 %indvars.iv61, %2
  br i1 %exitcond66, label %for.cond21.preheader, label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv61
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %6
  %7 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv61, i64 %indvars.iv
  store i8 %7, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.end:                                          ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv61, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.body23
  %indvars.iv67 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next68, %for.body23 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count70
  br i1 %exitcond71.not, label %for.cond29.preheader, label %for.body23
...
for.body23:                                       ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv67
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv72 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next73, %for.inc54 ]
  %exitcond79.not = icmp eq i64 %indvars.iv72, %wide.trip.count70
  br i1 %exitcond79.not, label %for.cond57, label %for.cond32.preheader
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  ...
  %cmp33 = icmp samesign ult i64 %indvars.iv74, %8
...
for.body34:                                       ; preds = %for.cond32
  ...
  %call41 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %arrayidx36, ptr noundef nonnull dereferenceable(1) %arrayidx39) #7
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond84.not = icmp eq i64 %indvars.iv80, %wide.trip.count70
  br i1 %exitcond84.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv80
...
if.then71:                                        ; preds = %for.end69
  ...
  %call.i43 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i, i8 noundef signext 10)
...
if.else:                                          ; preds = %for.end69
  ...
  %vtable.i46 = load ptr, ptr %call74, align 8, !tbaa !18
  %vbase.offset.ptr.i47 = getelementptr i8, ptr %vtable.i46, i64 -24
  %vbase.offset.i48 = load i64, ptr %vbase.offset.ptr.i47, align 8
  %add.ptr.i49 = getelementptr inbounds i8, ptr %call74, i64 %vbase.offset.i48
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i49, i8 noundef signext 10)
  %call1.i50 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call74, i8 noundef signext %call.i)
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc89 ], [ 0, %if.else ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count70
  br i1 %exitcond89.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv85
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv85
  %call.i.i40 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx84) #6
  %call1.i41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx84, i64 noundef %call.i.i40)
  %vtable.i52 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !18
  %vbase.offset.ptr.i53 = getelementptr i8, ptr %vtable.i52, i64 -24
  %vbase.offset.i54 = load i64, ptr %vbase.offset.ptr.i53, align 8
  %add.ptr.i55 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i54
  %call.i56 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i55, i8 noundef signext 10)
  %call1.i57 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i56)
...
if.end92:                                         ; preds = %for.cond76, %if.then71
  call void @llvm.lifetime.end.p0(i64 600, ptr nonnull %input) #6
  call void @llvm.lifetime.end.p0(i64 60000, ptr nonnull %c) #6
