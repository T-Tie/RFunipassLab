...
if.else8:                                         ; preds = %if.end
  %puts5 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #5
...
if.else16:                                        ; preds = %if.end10
  %puts6 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #5
...
if.else24:                                        ; preds = %if.end18
  %puts7 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.3) #5
...
if.else32:                                        ; preds = %if.end26
  %puts8 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.4) #5
