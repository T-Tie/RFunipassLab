...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55: ; preds = %if.then6.i36, %land.lhs.true.i42, %if.then19.i47, %if.then28.i54
  ...
  %smax75 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55
  %indvars.iv85 = phi i32 [ %indvars.iv.next86, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %indvars.iv81 = phi i32 [ %indvars.iv.next82, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc30 ], [ %8, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %exitcond77.not = icmp eq i64 %indvars.iv61, %wide.trip.count76
  br i1 %exitcond77.not, label %if.then34, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv61
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc ], [ %indvars.iv61, %for.body ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 1, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv63, %indvars.iv70
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next64
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv78 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next79, %for.inc43 ]
  %exitcond84.not = icmp eq i64 %indvars.iv78, %wide.trip.count
  br i1 %exitcond84.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv78
...
for.end45:                                        ; preds = %for.cond37
  ...
  %14 = sext i32 %indvars.iv85 to i64
  %sext = shl i64 %call6, 32
  %15 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc54 ], [ %14, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv88, %15
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv88
