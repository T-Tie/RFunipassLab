...
cond.end:                                         ; preds = %if.else, %cond.true
  %min.sink1 = phi ptr [ %4, %cond.true ], [ %min, %if.else ]
...
for.body68:                                       ; preds = %for.cond65
  ...
  %10 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom71
  %11 = getelementptr inbounds [100 x i32], ptr %10, i64 0, i64 %idxprom73
...
cond.end87:                                       ; preds = %if.else75, %cond.true81
  %min.sink = phi ptr [ %11, %cond.true81 ], [ %min, %if.else75 ]
