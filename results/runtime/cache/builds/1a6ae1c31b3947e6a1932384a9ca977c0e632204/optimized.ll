...
for.end:                                          ; preds = %for.cond
  ...
  %smax37 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %2 = add nuw i32 %smax37, 1
  %wide.trip.count38 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond39 = icmp eq i64 %indvars.iv34, %wide.trip.count38
  br i1 %exitcond39, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax25 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv22, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv28 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next29, %for.inc56 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond33.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv28, %indvars.iv34
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv28
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv49, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc118 ], [ %indvars.iv44, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv46 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv46, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond43.not = icmp eq i64 %indvars.iv40, 6
  br i1 %exitcond43.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv46, i64 %indvars.iv40
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv40
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv49, i64 %indvars.iv40
...
if.else:                                          ; preds = %for.end123
  ...
  %smax59 = call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %l.0, i32 noundef 1)
  %wide.trip.count63 = zext nneg i32 %smax59 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc151 ], [ 1, %if.else ]
  %exitcond64.not = icmp eq i64 %indvars.iv55, %wide.trip.count63
  br i1 %exitcond64.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv55, i64 4
  %17 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %18 = add nsw i64 %indvars.iv55, -1
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars62.le = trunc i64 %indvars.iv55 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.0.lcssa = phi i32 [ %indvars62.le, %for.end153.split.loop.exit ], [ %smax59, %for.cond134 ]
  %sub155 = add nsw i32 %z.0.lcssa, -1
  %wide.trip.count79 = zext i32 %sub155 to i64
  %wide.trip.count74 = zext i32 %z.0.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  ...
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %wide.trip.count79
  br i1 %exitcond80.not, label %for.cond207.preheader, label %for.body157
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc201 ], [ %indvars.iv69, %for.body157 ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %wide.trip.count74
  br i1 %exitcond75.not, label %for.cond154.loopexit, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv71, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond68.not = icmp eq i64 %indvars.iv65, 6
  br i1 %exitcond68.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv71, i64 %indvars.iv65
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv65
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv76, i64 %indvars.iv65
...
for.inc220:                                       ; preds = %for.cond211
  ...
  %putchar14 = call i32 @putchar(i32 noundef %conv218) #9
