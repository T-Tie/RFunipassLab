...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12 = icmp slt i64 %indvars.iv19, %1
  br i1 %cmp12, label %for.body13, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond10
  %sext30 = shl i64 %1, 32
  %2 = ashr exact i64 %sext30, 32
  %sext31 = shl i64 %indvars.iv, 32
  %3 = ashr exact i64 %sext31, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv19
  %4 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %5 = sub nuw nsw i64 %indvars.iv19, %indvars.iv
  %arrayidx17 = getelementptr inbounds nuw [256 x i8], ptr %wt, i64 0, i64 %5
  %6 = load i8, ptr %arrayidx17, align 1, !tbaa !5
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv26 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next27, %for.body25 ]
  %cmp24 = icmp slt i64 %indvars.iv26, %2
  br i1 %cmp24, label %for.body25, label %for.end37

for.body25:                                       ; preds = %for.cond22
  %7 = sub nuw nsw i64 %indvars.iv26, %3
  %arrayidx28 = getelementptr inbounds nuw [256 x i8], ptr %tar, i64 0, i64 %7
  %8 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv26
