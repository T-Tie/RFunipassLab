...
if.else:                                          ; preds = %for.body
  ...
  %arrayidx31 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv
...
for.inc.gvnsink.split:                            ; preds = %if.then, %if.else32
  %mul43.pre-phi = phi double [ %mul, %if.then ], [ %mul27, %if.else32 ]
  %call42.sink = phi double [ %sub, %if.then ], [ %call42, %if.else32 ]
  %div44 = fdiv double %call42.sink, %mul43.pre-phi
  %arrayidx47 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv
  store double %div44, ptr %arrayidx47, align 8, !tbaa !9
  br label %for.inc

for.inc:                                          ; preds = %if.else, %for.inc.gvnsink.split
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !11

for.cond49:                                       ; preds = %for.cond, %for.inc110
  %7 = phi i32 [ %.pre, %for.inc110 ], [ %0, %for.cond ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc110 ], [ 0, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp50 = icmp slt i64 %indvars.iv2, %8
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv2
...
if.then55:                                        ; preds = %for.body51
  %arrayidx58 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv2
  %10 = load double, ptr %arrayidx58, align 8, !tbaa !9
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv2
...
if.else63:                                        ; preds = %for.body51
  ...
  %arrayidx70 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv2
...
if.then77:                                        ; preds = %if.else72
  ...
  %arrayidx84 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv2
...
if.else93:                                        ; preds = %if.else72
  %arrayidx99 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv2
