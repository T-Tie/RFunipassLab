...
if.then:                                          ; preds = %for.body
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div23) #7
  br label %for.inc
...
if.then30:                                        ; preds = %if.else
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div39) #7
  br label %for.inc
...
if.end67:                                         ; preds = %if.end, %if.then58
  %mul73.pre-phi = phi double [ %mul65, %if.end ], [ %mul60, %if.then58 ]
  %.pre-phi = phi double [ %.pre, %if.end ], [ %fneg59, %if.then58 ]
  %d.0 = phi double [ %div66, %if.end ], [ %div61, %if.then58 ]
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %d.0, double noundef %div74, double noundef %d.0, double noundef %div74) #7
  br label %for.inc
