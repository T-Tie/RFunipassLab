...
for.body15:                                       ; preds = %for.cond13
  ...
  %7 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom17
  %8 = getelementptr inbounds [100 x i32], ptr %7, i64 0, i64 %idxprom19
  %9 = load i32, ptr %8, align 4, !tbaa !5
  br i1 %cmp16, label %if.then, label %if.else

if.then:                                          ; preds = %for.body15
  %arrayidx22 = getelementptr inbounds [10 x i32], ptr %b, i64 0, i64 %idxprom17
  store i32 %9, ptr %arrayidx22, align 4, !tbaa !5
...
for.cond48:                                       ; preds = %for.inc86, %for.end47
  ...
  %12 = load i32, ptr %col, align 4, !tbaa !5
  %cmp49 = icmp slt i32 %11, %12
  store i32 0, ptr %x, align 4, !tbaa !5
...
for.cond51:                                       ; preds = %for.inc83, %for.body50
  %13 = phi i32 [ %inc84, %for.inc83 ], [ 0, %for.body50 ]
  %cmp52 = icmp slt i32 %13, %1
  br i1 %cmp52, label %for.body53, label %for.inc86

for.body53:                                       ; preds = %for.cond51
  %cmp54 = icmp eq i32 %13, 0
  %idxprom56 = sext i32 %13 to i64
  %idxprom58 = sext i32 %11 to i64
  %14 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom56
  %15 = getelementptr inbounds [100 x i32], ptr %14, i64 0, i64 %idxprom58
...
if.then55:                                        ; preds = %for.body53
  ...
  store i32 %16, ptr %arrayidx61, align 4, !tbaa !5
...
for.cond89:                                       ; preds = %for.inc110, %for.end88
  ...
  %19 = load i32, ptr %row, align 4, !tbaa !5
  %cmp90 = icmp slt i32 %18, %19
...
for.cond92:                                       ; preds = %for.inc107, %for.body91
  ...
  %21 = load i32, ptr %col, align 4, !tbaa !5
  %cmp93 = icmp slt i32 %20, %21
...
if.then100:                                       ; preds = %for.body94
  ...
  %24 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx104 = getelementptr inbounds [10 x i32], ptr %e, i64 0, i64 %idxprom97
  %25 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %24, i32 noundef %25)
  br label %for.inc107
