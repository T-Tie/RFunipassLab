...
for.body11:                                       ; preds = %for.cond8
  ...
  %8 = load float, ptr %arrayidx15, align 4, !tbaa !12, !invariant.load !14
...
if.then:                                          ; preds = %for.body11
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(7) @.str)
  br label %for.inc31
...
if.then24:                                        ; preds = %if.else
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str.1)
  br label %for.inc31

if.else27:                                        ; preds = %if.else
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str.2)
  br label %for.inc31

for.inc31:                                        ; preds = %if.then, %if.else27, %if.then24
  %call28.sink = phi ptr [ %call28, %if.else27 ], [ %call25, %if.then24 ], [ %call19, %if.then ]
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call28.sink, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
