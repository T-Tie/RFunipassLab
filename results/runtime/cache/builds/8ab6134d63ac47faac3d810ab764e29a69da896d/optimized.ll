...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %Max) #7
  store i32 0, ptr %Max, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %Max2) #7
...
for.end28:                                        ; preds = %for.cond13
  call fastcc void @outlined_ir_func_0(ptr %Max)
  call fastcc void @outlined_ir_func_0(ptr %Max2)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %Max2) #8
...
for.end28_after_outline.exitStub:
  ...
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %1)
