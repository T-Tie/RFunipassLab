...
for.cond1:                                        ; preds = %if.end21, %for.body
  %f.1 = phi i32 [ %f.0, %for.body ], [ %f.25, %if.end21 ]
  %end2.1 = phi i32 [ %end2.0, %for.body ], [ %end2.2, %if.end21 ]
  %end1.1 = phi i32 [ %end1.0, %for.body ], [ %end1.2, %if.end21 ]
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.27, %if.end21 ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.29, %if.end21 ]
...
if.end21:                                         ; preds = %for.body3, %if.then19
  %star1.29 = phi i32 [ %star1.2.ph, %if.then19 ], [ %star1.1, %for.body3 ]
  %star2.27 = phi i32 [ %star2.2.ph, %if.then19 ], [ %star2.1, %for.body3 ]
  %f.25 = phi i32 [ %f.2.ph, %if.then19 ], [ %f.1, %for.body3 ]
