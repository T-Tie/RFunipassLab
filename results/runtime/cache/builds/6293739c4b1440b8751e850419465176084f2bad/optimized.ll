...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv8 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc24 ]
  ...
  br i1 %exitcond13.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax18 = call i32 @llvm.smax.i32(i32 %number.0, i32 0)
  %wide.trip.count = zext nneg i32 %smax18 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv14 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next15, %for.body29 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond19.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv14, 0
  %spec.select = select i1 %cmp30, ptr @.str, ptr @.str.1
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv14
  %4 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %4)
