...
for.body55:                                       ; preds = %for.cond52
  ...
  %7 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv16
  %8 = load i32, ptr %7, align 4, !tbaa !5, !invariant.load !12
  br i1 %cmp57, label %if.then58, label %if.else

if.then58:                                        ; preds = %for.body55
  %call61 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %8, i32 noundef 44)
  br label %for.inc66

if.else:                                          ; preds = %for.body55
  %call64 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8)
  br label %for.inc66
