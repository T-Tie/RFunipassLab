...
for.cond3:                                        ; preds = %for.cond3.preheader, %if.end32
  %indvars.iv7 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next8, %if.end32 ]
  %ans.0 = phi i32 [ 1, %for.cond3.preheader ], [ %spec.select2, %if.end32 ]
...
if.then:                                          ; preds = %for.body8
  ...
  %spec.select1 = call i32 @llvm.smax.i32(i32 %4, i32 %temp.0)
  br label %for.inc21

for.inc21:                                        ; preds = %if.then, %for.body8
  %tIndex.1 = phi i32 [ %tIndex.0, %for.body8 ], [ %spec.select, %if.then ]
  %temp.1 = phi i32 [ %temp.0, %for.body8 ], [ %spec.select1, %if.then ]
...
if.end32:                                         ; preds = %for.end23, %if.else
  ...
  %arrayidx31 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv7
