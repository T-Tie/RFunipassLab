...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20500, ptr nonnull %a) #9
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %b) #9
  br label %for.cond
...
for.end33:                                        ; preds = %for.cond23
  ...
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %gep30)
...
for.end56:                                        ; preds = %for.cond45
  ...
  %call61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr59)
  ...
  call void @llvm.lifetime.end.p0(i64 2000, ptr nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 20500, ptr nonnull %a) #9
