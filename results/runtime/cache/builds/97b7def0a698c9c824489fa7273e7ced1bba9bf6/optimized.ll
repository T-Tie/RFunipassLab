...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 dereferenceable(41000) %word) #9
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp3 = icmp slt i64 %indvars.iv35, %7
  %idxprom77 = sext i32 %k.0 to i64
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv35
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax45 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %8 = add i32 %smax45, 1
  %wide.trip.count46 = zext i32 %8 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond47 = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv41
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv41, i64 %9
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv38, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv38, %9
...
if.then99:                                        ; preds = %for.body96
  ...
  %gep33 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i3
  %11 = load i64, ptr %gep33, align 8, !tbaa !10, !invariant.load !9
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv41, i64 %indvars.iv38
