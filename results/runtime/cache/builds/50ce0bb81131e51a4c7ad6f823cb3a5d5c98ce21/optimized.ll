...
if.then:                                          ; preds = %for.body
  ...
  %.pre10 = fmul double %.pre5, 4.000000e+00
  %.pre11 = fneg double %.pre6
  %.pre12 = fmul double %.pre10, %.pre11
  %.pre13 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre12)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi14 = phi double [ %.pre13, %if.then ], [ %5, %for.body ]
  %mul19.pre-phi = phi double [ %.pre10, %if.then ], [ %mul2, %for.body ]
  %6 = phi double [ %.pre6, %if.then ], [ %3, %for.body ]
  %7 = phi double [ %.pre5, %if.then ], [ %2, %for.body ]
  %8 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp22 = fcmp oeq double %.pre-phi14, 0.000000e+00
...
if.then23:                                        ; preds = %if.end
  ...
  %.pre7 = load double, ptr %b, align 8, !tbaa !9
  %.pre8 = load double, ptr %a, align 8, !tbaa !9
  %.pre9 = load double, ptr %c, align 8, !tbaa !9
  %.pre15 = fmul double %.pre8, 4.000000e+00
  %.pre16 = fneg double %.pre9
  %.pre18 = fmul double %.pre15, %.pre16
  %.pre19 = call double @llvm.fmuladd.f64(double %.pre7, double %.pre7, double %.pre18)
  br label %if.end28

if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi20 = phi double [ %.pre19, %if.then23 ], [ %.pre-phi14, %if.end ]
  %mul30.pre-phi = phi double [ %.pre15, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre9, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre8, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre7, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi20, 0.000000e+00
...
if.then34:                                        ; preds = %if.end28
  ...
  %div47.sink1 = select i1 %cmp35, double 0.000000e+00, double %div47
  ...
  %call55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div47.sink1, double noundef %div54, double noundef %div47.sink1, double noundef %div54)
  br label %for.inc

for.inc:                                          ; preds = %if.then34, %if.end28
