...
for.cond13:                                       ; preds = %for.inc42, %for.body12
  %2 = phi i32 [ %inc43, %for.inc42 ], [ 0, %for.body12 ]
...
if.then:                                          ; preds = %for.body15
  ...
  %4 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
...
if.else:                                          ; preds = %for.body15
  ...
  %5 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
...
for.cond48:                                       ; preds = %for.inc86, %for.end47
  %y.1 = phi i32 [ 0, %for.end47 ], [ %inc87, %for.inc86 ]
  %7 = load i32, ptr %col, align 4, !tbaa !5
  %cmp49 = icmp slt i32 %y.1, %7
...
for.cond51:                                       ; preds = %for.inc83, %for.body50
  %8 = phi i32 [ %inc84, %for.inc83 ], [ 0, %for.body50 ]
  %cmp52 = icmp slt i32 %8, %0
...
for.cond89:                                       ; preds = %for.inc110, %for.end88
  ...
  %x.2 = phi i32 [ 0, %for.end88 ], [ %inc111, %for.inc110 ]
  %12 = load i32, ptr %row, align 4, !tbaa !5
  %cmp90 = icmp slt i32 %x.2, %12
...
for.cond92:                                       ; preds = %for.inc107, %for.body91
  ...
  %y.2 = phi i32 [ 0, %for.body91 ], [ %inc108, %for.inc107 ]
  %13 = load i32, ptr %col, align 4, !tbaa !5
  %cmp93 = icmp slt i32 %y.2, %13
  br i1 %cmp93, label %for.body94, label %for.inc110

for.body94:                                       ; preds = %for.cond92
  %idxprom95 = sext i32 %x.2 to i64
