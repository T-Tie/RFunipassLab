...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv12
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv19 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next20, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond25.not = icmp eq i32 %i.2, %smax24
  br i1 %exitcond25.not, label %for.end49, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond19
  %smax21 = call i32 @llvm.smax.i32(i32 %indvars.iv19, i32 noundef 0)
  %wide.trip.count22 = zext nneg i32 %smax21 to i64
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv16 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next17, %for.inc44 ]
  %exitcond23.not = icmp eq i64 %indvars.iv16, %wide.trip.count22
  br i1 %exitcond23.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv16
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next17
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax30 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 1)
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc59 ], [ 1, %for.end49 ]
  %exitcond32.not = icmp eq i64 %indvars.iv26, %wide.trip.count31
  br i1 %exitcond32.not, label %cleanup, label %for.inc59
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv26
