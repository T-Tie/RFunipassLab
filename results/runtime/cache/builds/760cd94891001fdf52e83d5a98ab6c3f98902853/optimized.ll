...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv61 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc31 ], [ 0, %for.cond ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %indvars.iv61
  br i1 %exitcond19.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv15
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv61
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv15, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc28 ], [ 0, %for.cond17.preheader ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %indvars.iv61
  br i1 %exitcond14.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv15, i64 %indvars.iv10
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %indvars.iv61
  br i1 %exitcond39.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %indvars.iv61
  br i1 %exitcond24.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv20, i64 %indvars.iv35
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv35
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select4, %for.body57 ], [ %6, %if.then51 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %indvars.iv61
  br i1 %exitcond29.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv25, i64 %indvars.iv35
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %spec.select4 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond55, !llvm.loop !15

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc84 ], [ 0, %for.cond72.preheader ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %indvars.iv61
  br i1 %exitcond34.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv30, i64 %indvars.iv35
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %indvars.iv61
  br i1 %exitcond50.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %indvars.iv61
  br i1 %exitcond45.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv46, i64 %indvars.iv40
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv40, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv46, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %indvars.iv61
  br i1 %exitcond60.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep6 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv56
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv51 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next52, %for.inc129 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %indvars.iv61
  br i1 %exitcond55.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv51, i64 %indvars.iv56
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep7 = getelementptr [100 x i32], ptr %invariant.gep6, i64 %indvars.iv51
  store i32 %12, ptr %gep7, align 4, !tbaa !5
