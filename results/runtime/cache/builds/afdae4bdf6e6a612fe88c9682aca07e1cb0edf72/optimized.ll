...
for.end33:                                        ; preds = %for.cond23
  ...
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %gep101) #8
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit33: ; preds = %for.cond45
  ...
  %call.i.i25 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr50) #8
...
for.end56:                                        ; preds = %for.cond45
  ...
  %call.i.i49 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr59) #8
