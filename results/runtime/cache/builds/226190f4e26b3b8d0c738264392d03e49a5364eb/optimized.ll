...
for.cond33:                                       ; preds = %for.inc40, %for.end32
  %11 = load i32, ptr %i3, align 4, !tbaa !5
  %12 = load i32, ptr %jn, align 4, !tbaa !5
  %cmp34 = icmp slt i32 %11, %12
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %13)
...
for.end42:                                        ; preds = %for.cond33
  ...
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %14)
