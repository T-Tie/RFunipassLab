...
for.body4:                                        ; preds = %for.cond2
  %call5 = call noundef i32 @_Z1Fi(i32 noundef %i.1)
  %cmp6 = icmp slt i32 %z.0, %call5
  br i1 %cmp6, label %if.then, label %if.end

if.then:                                          ; preds = %for.body4
  %call7 = call noundef i32 @_Z1Fi(i32 noundef %i.1)
  br label %if.end
...
land.lhs.true:                                    ; preds = %for.body
  %call = call noundef i32 @_Z1Fi(i32 noundef %add)
  %add4 = add nsw i32 %call, 1
  %cmp5 = icmp sgt i32 %add4, %z.0
  br i1 %cmp5, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  %call6 = call noundef i32 @_Z1Fi(i32 noundef %add)
