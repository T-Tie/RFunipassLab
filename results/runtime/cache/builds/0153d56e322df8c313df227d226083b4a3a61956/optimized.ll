...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %max) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %l1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %min) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %l2) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %real) #4
...
for.body30:                                       ; preds = %for.cond28
  ...
  %11 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom38
  %12 = getelementptr inbounds [10 x i32], ptr %11, i64 0, i64 %idxprom40
...
if.end37.thread:                                  ; preds = %for.body30
  br label %for.inc50.gvnsink.split
...
for.inc50.gvnsink.split:                          ; preds = %if.end37.thread, %if.then44
  %.sink = phi i32 [ %9, %if.then44 ], [ 0, %if.end37.thread ]
  store i32 %13, ptr %min, align 4, !tbaa !5
  store i32 %.sink, ptr %l2, align 4, !tbaa !5
  br label %for.inc50
...
for.end59.thread:                                 ; preds = %for.end52
  ...
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %17, i32 noundef %18) #5
  br label %if.end63
...
if.end63:                                         ; preds = %for.end59.thread, %if.then61
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %real) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %l2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %min) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %l1) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %max) #5
