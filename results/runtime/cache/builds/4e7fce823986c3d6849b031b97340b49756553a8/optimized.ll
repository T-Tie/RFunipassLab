...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr nonnull %sum) #3
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %.pre13 = load i32, ptr %arrayidx4, align 4, !tbaa !5
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre13, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre13, %land.lhs.true ]
...
for.end63:                                        ; preds = %for.cond56
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %sum) #3
