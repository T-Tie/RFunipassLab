...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr %a) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr %n) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr %j) #5
  call void @llvm.lifetime.start.p0(i64 4000, ptr %b) #5
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 4000, i1 false)
...
for.body13:                                       ; preds = %for.cond10
  ...
  %5 = load i8, ptr %arrayidx18, align 1, !tbaa !12
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %.sink2, %12
  %cmp69 = icmp slt i32 %11, %add68
