...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv21, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre29, %for.inc ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv25 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next26, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv25
