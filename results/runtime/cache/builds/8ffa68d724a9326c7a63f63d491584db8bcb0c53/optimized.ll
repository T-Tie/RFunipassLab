...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull %s) #12
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #13
...
for.inc:                                          ; preds = %if.then, %if.else22, %if.then12
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull %s) #12
