...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 dereferenceable(1000) %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 dereferenceable(1000) %b) #8
...
land.lhs.true.i:                                  ; preds = %entry
  call fastcc void @outlined_ir_func_0(ptr %add.ptr10.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %land.lhs.true.i15, %if.then6.i8
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #9
  %conv = trunc i64 %call5 to i32
  %call7 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %b) #9
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !22, !invariant.load !8
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %2 = load i8, ptr %arrayidx28, align 1, !tbaa !22, !invariant.load !8
  switch i8 %2, label %if.end75 [
    i8 65, label %for.inc
    i8 71, label %for.inc
    i8 67, label %for.inc
    i8 84, label %for.inc
...
for.body52:                                       ; preds = %for.cond50
  ...
  %3 = load i8, ptr %arrayidx54, align 1, !tbaa !22, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv48
  %4 = load i8, ptr %arrayidx57, align 1, !tbaa !22, !invariant.load !8
  %cmp59 = icmp eq i8 %3, %4
...
for.end65:                                        ; preds = %for.cond50
  ...
  %5 = load double, ptr %w, align 8, !tbaa !27
  %cmp68 = fcmp ult double %div, %5
  %.str.3..str.2 = select i1 %cmp68, ptr @.str.3, ptr @.str.2
  br label %if.end75

if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ], [ %.str.3..str.2, %for.end65 ]
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull %b) #10
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !29, !invariant.load !8
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !32, !invariant.load !8
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !22, !invariant.load !8
...
land.lhs.true.i_to_outline:                       ; preds = %newFuncRoot
  ...
  %1 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !33, !invariant.load !8
  %2 = add i64 %1, -1001
...
if.then19.i:                                      ; preds = %land.lhs.true.i_to_outline
  ...
  %3 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !34, !invariant.load !8
...
!28 = !{!"double", !12, i64 0}
!29 = !{!30, !31, i64 16}
!30 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !31, i64 8, !31, i64 16, !31, i64 24, !31, i64 32, !31, i64 40, !31, i64 48, !20, i64 56}
!31 = !{!"p1 omnipotent char", !16, i64 0}
!32 = !{!30, !31, i64 24}
!33 = !{!10, !11, i64 16}
!34 = !{!35, !38, i64 232}
!35 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0, !36, i64 216, !12, i64 224, !37, i64 225, !38, i64 232, !39, i64 240, !40, i64 248, !41, i64 256}
!36 = !{!"p1 _ZTSSo", !16, i64 0}
!37 = !{!"bool", !12, i64 0}
!38 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !16, i64 0}
!39 = !{!"p1 _ZTSSt5ctypeIcE", !16, i64 0}
!40 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !16, i64 0}
!41 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !16, i64 0}
