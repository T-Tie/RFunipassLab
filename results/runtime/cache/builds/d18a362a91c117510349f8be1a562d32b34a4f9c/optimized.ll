...
for.cond2:                                        ; preds = %for.inc74, %for.end
  %2 = phi i32 [ %inc71.sink, %for.inc74 ], [ 0, %for.end ]
...
if.then33:                                        ; preds = %if.else
  %arrayidx35 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom10
  %call40 = call ptr @strcat(ptr noundef %arrayidx35, ptr noundef %arrayidx6) #16
  %inc41 = add nsw i32 %5, 1
...
if.then44:                                        ; preds = %if.else42
  %arrayidx46 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom10
  %call51 = call ptr @strcpy(ptr noundef %arrayidx46, ptr noundef %arrayidx6) #16
  br label %for.inc74.gvnsink.split

if.else58:                                        ; preds = %if.else42
  %arrayidx60 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom10
...
for.inc74.gvnsink.split:                          ; preds = %if.then44, %if.else58, %if.then
  %add.sink11 = phi i32 [ %conv, %if.then ], [ %add, %if.else58 ], [ %add, %if.then44 ]
  %arrayidx60.sink.sink = phi ptr [ %arrayidx20, %if.then ], [ %arrayidx60, %if.else58 ], [ %arrayidx46, %if.then44 ]
  %idxprom69 = sext i32 %add.sink11 to i64
...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  ...
  %cmp95 = icmp slt i32 %8, %conv93
  br i1 %cmp95, label %for.body96, label %for.inc116

for.body96:                                       ; preds = %for.cond94
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %8, %sub97
  %idxprom102 = sext i32 %8 to i64
  %9 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom102
  %10 = load i8, ptr %9, align 1, !tbaa !12
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %10)
...
if.else106:                                       ; preds = %for.body96
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %10)
  br label %for.inc113

for.inc113:                                       ; preds = %if.then99, %if.else106
  %inc114 = add nsw i32 %8, 1
  store i32 %inc114, ptr %j, align 4, !tbaa !5
  br label %for.cond94, !llvm.loop !14

for.inc116:                                       ; preds = %for.cond94
  %inc117 = add nsw i32 %7, 1
