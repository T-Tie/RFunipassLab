...
for.body:                                         ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x1, i32 noundef %y) #6
  br label %for.cond
...
for.cond13:                                       ; preds = %for.body15, %for.end
  ...
  %cmp14 = icmp slt i32 %2, %m2
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  br i1 %cmp14, label %for.body15, label %for.end39

for.body15:                                       ; preds = %for.cond13
  %add16 = add nsw i32 %3, 31
  store i32 %add16, ptr %x2, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x2, i32 noundef %y) #6
  br label %for.cond13

for.end39:                                        ; preds = %for.cond13
  %4 = load i32, ptr %x1, align 4, !tbaa !5
  %sub40 = sub nsw i32 %4, %3
...
if.end46:                                         ; preds = %if.else44, %if.then42
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %x2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %x1) #6
  ret void
}
...
; Function Attrs: minsize mustprogress nofree nosync nounwind optsize willreturn memory(argmem: readwrite) uwtable
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %1, i32 noundef %2) unnamed_addr #5 {
for.body_to_outline:
  %3 = load i32, ptr %0, align 4, !tbaa !5
  %cmp1 = icmp eq i32 %3, 4
  br i1 %cmp1, label %if.end.thread, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.body_to_outline
...
lor.lhs.false5:                                   ; preds = %lor.lhs.false3
  %cmp6 = icmp eq i32 %3, 11
  br i1 %cmp6, label %if.end.thread, label %if.end

if.end.thread:                                    ; preds = %for.body_to_outline, %lor.lhs.false, %lor.lhs.false3, %lor.lhs.false5
  %4 = load i32, ptr %1, align 4, !tbaa !5
  %dec = add nsw i32 %4, -1
  store i32 %dec, ptr %1, align 4, !tbaa !5
  br label %for.cond.exitStub

if.end:                                           ; preds = %lor.lhs.false5
  %cmp7 = icmp eq i32 %3, 2
  br i1 %cmp7, label %if.then8, label %for.cond.exitStub

if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %2) #8
...
for.inc.gvnsink.split:                            ; preds = %if.then8, %if.else
  %.sink = phi i32 [ 3, %if.else ], [ 2, %if.then8 ]
  %sub10 = sub nsw i32 %5, %.sink
  store i32 %sub10, ptr %1, align 4, !tbaa !5
  br label %for.cond.exitStub

for.cond.exitStub:                                ; preds = %if.end.thread, %if.end, %for.inc.gvnsink.split
  %inc = add nsw i32 %3, 1
...
attributes #5 = { minsize mustprogress nofree nosync nounwind optsize willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
