...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv3, %2
...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv14 = phi i32 [ %indvars.iv.next15, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax61 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax50 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %1 = add nuw i32 %smax50, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv21 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next22, %for.inc23 ]
  %exitcond25 = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25, label %for.cond26, label %for.cond2
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc20 ], [ 1, %for.cond13.preheader ]
  %exitcond20 = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv16
...
for.cond26:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc57 ], [ 1, %for.cond ]
  %exitcond41 = icmp eq i64 %indvars.iv36, %wide.trip.count24
  br i1 %exitcond41, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select12, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond30 = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv36
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc54 ], [ 1, %for.cond46.preheader ]
  %exitcond35 = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv31, i64 %indvars.iv36
...
for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond52 = icmp eq i64 %indvars.iv47, %wide.trip.count24
  br i1 %exitcond52, label %for.cond80.preheader, label %for.cond63
...
for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc74 ], [ 2, %for.cond60 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next43
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !15
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv42
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv58 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next59, %for.inc98 ]
  %exitcond63.not = icmp eq i64 %indvars.iv58, %wide.trip.count62
  br i1 %exitcond63.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc95 ], [ 2, %for.cond80 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count45
  br i1 %exitcond57.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next54, i64 %indvars.iv58
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !15
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv53, i64 %indvars.iv58
