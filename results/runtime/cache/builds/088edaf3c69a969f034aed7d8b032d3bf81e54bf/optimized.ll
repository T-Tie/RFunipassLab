...
for.cond33:                                       ; preds = %for.inc43, %for.body32
  %.sink11 = phi i32 [ %0, %for.body32 ], [ %dec, %for.inc43 ]
  %cmp34 = icmp sge i32 %.sink11, 1
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idxprom38 = sext i32 %.sink11 to i64
...
for.end50:                                        ; preds = %for.body35, %for.cond30
  %x2.1 = phi i32 [ 0, %for.cond30 ], [ %.sink11, %for.body35 ]
  %sub = sub nsw i32 %x2.1, %x1.1
  %sub51 = sub nsw i32 %sub, 1
  %sub52 = sub nsw i32 %.sink, %i.1
