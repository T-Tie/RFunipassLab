...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %a) #9
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %if.then19.i, %if.then28.i
  ...
  %4 = load i32, ptr %gep58, align 8, !tbaa !21
...
if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  ...
  %6 = load i32, ptr %n, align 4, !tbaa !30
  %dec = add nsw i32 %6, -1
  store i32 %dec, ptr %n, align 4, !tbaa !30
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %a) #9
  ret i32 0
}
...
!34 = !{!35, !11, i64 56}
!35 = !{!"_ZTSSt5ctypeIcE", !36, i64 0, !37, i64 16, !25, i64 24, !38, i64 32, !38, i64 40, !39, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
!36 = !{!"_ZTSNSt6locale5facetE", !17, i64 8}
!37 = !{!"p1 _ZTS15__locale_struct", !15, i64 0}
!38 = !{!"p1 int", !15, i64 0}
!39 = !{!"p1 short", !15, i64 0}
!40 = !{!11, !11, i64 0}
