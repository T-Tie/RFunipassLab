...
if.end:                                           ; preds = %if.else58, %if.then44
  %add.sink1 = phi i32 [ %add, %if.else58 ], [ %conv, %if.then44 ]
  %arrayidx60.sink = phi ptr [ %arrayidx60, %if.else58 ], [ %arrayidx46, %if.then44 ]
  %add.sink = phi i32 [ %add, %if.else58 ], [ %conv, %if.then44 ]
...
if.end72:                                         ; preds = %if.end, %if.then33
  %k.2 = phi i32 [ %inc41, %if.then33 ], [ %k.0, %if.end ]
  %j.2 = phi i32 [ 0, %if.then33 ], [ %inc71, %if.end ]
  br label %if.end73

if.end73:                                         ; preds = %if.end72, %if.then
  %k.1 = phi i32 [ %inc18, %if.then ], [ %k.2, %if.end72 ]
  %j.1 = phi i32 [ %inc30, %if.then ], [ %j.2, %if.end72 ]
  br label %for.inc74
