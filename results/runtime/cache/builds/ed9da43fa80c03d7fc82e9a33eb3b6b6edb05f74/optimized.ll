...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %a) #8
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull %c) #8
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76
  ...
  %indvars.iv151 = phi i32 [ %indvars.iv.next152, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76 ]
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp13, label %for.cond14.preheader, label %for.inc30

for.cond14.preheader:                             ; preds = %for.body
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc
  %indvars.iv139 = phi i64 [ %indvars.iv.next140, %for.inc ], [ 1, %for.cond14.preheader ]
  %indvars.iv137 = phi i64 [ %indvars.iv.next138, %for.inc ], [ %indvars.iv, %for.cond14.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv139, %wide.trip.count
  br i1 %exitcond.not, label %for.end.loopexit, label %for.body16
...
for.end:                                          ; preds = %for.end.loopexit, %for.end.split.loop.exit
  %j.0.lcssa = phi i32 [ %16, %for.end.split.loop.exit ], [ %smax, %for.end.loopexit ]
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count154 = zext i32 %indvars.iv151 to i64
  br label %for.cond37
...
for.body39:                                       ; preds = %for.cond37
  ...
  %18 = load i64, ptr %gep, align 8, !tbaa !9
...
for.end45:                                        ; preds = %for.cond37
  %call.i.i89 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #10
  ...
  %19 = sext i32 %indvars.iv156 to i64
  %sext = shl i64 %call6, 32
  %20 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv159 = phi i64 [ %indvars.iv.next160, %for.inc54 ], [ %19, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv159, %20
  br i1 %cmp49, label %for.body50, label %if.end57.loopexit
...
for.body50:                                       ; preds = %for.cond48
  ...
  store i8 %21, ptr %__c.addr.i97, align 1, !tbaa !31
  %vtable.i98 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !5
  %vbase.offset.ptr.i99 = getelementptr i8, ptr %vtable.i98, i64 -24
  %vbase.offset.i100 = load i64, ptr %vbase.offset.ptr.i99, align 8, !invariant.load !8
  %gep135 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i100
  %22 = load i64, ptr %gep135, align 8, !tbaa !9
  %cmp.not.i103 = icmp eq i64 %22, 0
  br i1 %cmp.not.i103, label %if.end.i107, label %if.then.i104

if.then.i104:                                     ; preds = %for.body50
...
if.end.i107:                                      ; preds = %for.body50
  %call2.i108 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %21)
  br label %for.inc54

for.inc54:                                        ; preds = %if.end.i107, %if.then.i104
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i97)
  %indvars.iv.next160 = add nsw i64 %indvars.iv159, 1
  br label %for.cond48, !llvm.loop !37

if.end57.loopexit:                                ; preds = %for.cond48
  br label %if.end57

if.end57:                                         ; preds = %if.end57.loopexit, %if.then34
