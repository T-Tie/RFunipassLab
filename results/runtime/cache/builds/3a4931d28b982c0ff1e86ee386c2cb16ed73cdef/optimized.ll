...
for.cond31:                                       ; preds = %for.end59, %for.end30
  %i.2 = phi i32 [ 0, %for.end30 ], [ %inc61, %for.end59 ]
...
for.cond35:                                       ; preds = %for.cond.cleanup, %for.body34
  %j.2 = phi i32 [ 0, %for.body34 ], [ %inc58, %for.cond.cleanup ]
...
for.cond39:                                       ; preds = %for.body41, %for.body38
  ...
  %k.0 = phi i32 [ 0, %for.body38 ], [ %inc51, %for.body41 ]
  %cmp40 = icmp sle i32 %k.0, %2
  %idxprom53 = sext i32 %i.2 to i64
  %idxprom55 = sext i32 %j.2 to i64
  br i1 %cmp40, label %for.body41, label %for.cond.cleanup
...
for.body41:                                       ; preds = %for.cond39
  %arrayidx43 = getelementptr inbounds [101 x [101 x i32]], ptr %a, i64 0, i64 %idxprom53
  ...
  %arrayidx49 = getelementptr inbounds [101 x i32], ptr %arrayidx47, i64 0, i64 %idxprom55
...
for.cond63:                                       ; preds = %for.end84, %for.end62
  %i.3 = phi i32 [ 0, %for.end62 ], [ %inc87, %for.end84 ]
...
for.cond67:                                       ; preds = %if.end, %for.body66
  %j.3 = phi i32 [ 0, %for.body66 ], [ %inc83, %if.end ]
...
if.then:                                          ; preds = %for.body70
  ...
  %10 = load i32, ptr %arrayidx73, align 4, !tbaa !5
  %call76 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %10) #6
  br label %if.end

if.else:                                          ; preds = %for.body70
  %arrayidx78 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom72
  ...
  %call81 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %11) #6
  br label %if.end
