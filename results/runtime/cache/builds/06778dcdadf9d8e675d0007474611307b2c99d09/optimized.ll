...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.3, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.3, %for.inc ]
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.body ], [ %end2.2, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.body ], [ %f.3, %for.inc ]
...
if.then19:                                        ; preds = %if.then, %land.lhs.true
  %star2.2 = phi i32 [ %add13, %if.then ], [ %star2.1, %land.lhs.true ]
  %star1.2 = phi i32 [ %add, %if.then ], [ %star1.1, %land.lhs.true ]
  %f.2 = phi i32 [ 1, %if.then ], [ %f.1, %land.lhs.true ]
...
for.inc:                                          ; preds = %for.body3, %if.then19
  ...
  %star2.3 = phi i32 [ %star2.2, %if.then19 ], [ %star2.1, %for.body3 ]
  %star1.3 = phi i32 [ %star1.2, %if.then19 ], [ %star1.1, %for.body3 ]
  %end2.2 = phi i32 [ %sub20, %if.then19 ], [ %end2.1, %for.body3 ]
  %f.3 = phi i32 [ %f.2, %if.then19 ], [ %f.1, %for.body3 ]
