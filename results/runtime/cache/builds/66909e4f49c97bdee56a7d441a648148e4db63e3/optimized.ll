...
entry:
  ...
  %call = tail call noundef i32 @_Z9down_casti(i32 noundef %n) #10
...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #11
...
define internal void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0) #8 {
