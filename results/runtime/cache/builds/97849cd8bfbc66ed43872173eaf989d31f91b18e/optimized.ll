...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !9, !invariant.load !17
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !18, !invariant.load !17
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !19, !invariant.load !17
