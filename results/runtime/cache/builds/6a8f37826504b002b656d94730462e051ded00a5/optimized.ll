...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %3 = load double, ptr @a, align 8, !tbaa !9, !noalias !11
  %mul5.i = fmul double %3, 4.000000e+00
  %4 = load double, ptr @c, align 8, !tbaa !9, !noalias !11
  %5 = fneg double %4
  %neg.i = fmul double %mul5.i, %5
  %6 = tail call double @llvm.fmuladd.f64(double %2, double %2, double %neg.i) #8
...
if.then8:                                         ; preds = %if.end
  %fneg9 = fneg double %2
  %call13.i = tail call double @sqrt(double noundef %6) #9, !tbaa !5, !noalias !14
  %add = fsub double %call13.i, %2
  %mul = fmul double %3, 2.000000e+00
  %div = fdiv double %add, %mul
  store double %div, ptr @x, align 16, !tbaa !9
  %call13.i3 = tail call double @sqrt(double noundef %6) #9, !tbaa !5, !noalias !17
  %sub = fsub double %fneg9, %call13.i3
...
if.then39:                                        ; preds = %if.end37
  ...
  %15 = load double, ptr @a, align 8, !tbaa !9, !noalias !20
  %mul46.i = fmul double %15, 4.000000e+00
  %16 = load double, ptr @c, align 8, !tbaa !9, !noalias !20
  %17 = load double, ptr @b, align 8, !tbaa !9, !noalias !20
  %18 = fneg double %17
  %neg49.i = fmul double %17, %18
  %19 = tail call double @llvm.fmuladd.f64(double %mul46.i, double %16, double %neg49.i) #10
  %call50.i = tail call double @sqrt(double noundef %19) #9, !tbaa !5, !noalias !20
  ...
  %22 = load double, ptr @a, align 8, !tbaa !9, !noalias !23
  %mul46.i4 = fmul double %22, 4.000000e+00
  %23 = load double, ptr @c, align 8, !tbaa !9, !noalias !23
  %24 = load double, ptr @b, align 8, !tbaa !9, !noalias !23
  %25 = fneg double %24
  %neg49.i5 = fmul double %24, %25
  %26 = tail call double @llvm.fmuladd.f64(double %mul46.i4, double %23, double %neg49.i5) #10
  %call50.i6 = tail call double @sqrt(double noundef %26) #9, !tbaa !5, !noalias !23
  %fneg66 = fneg double %call50.i6
...
!10 = !{!"double", !7, i64 0}
!11 = !{!12}
!12 = distinct !{!12, !13, !"outlined_ir_func_0.4: argument 0"}
!13 = distinct !{!13, !"outlined_ir_func_0.4"}
!14 = !{!15}
!15 = distinct !{!15, !16, !"outlined_ir_func_1: argument 0"}
!16 = distinct !{!16, !"outlined_ir_func_1"}
!17 = !{!18}
