...
for.cond:                                         ; preds = %for.end, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc9, %for.end ]
...
for.cond12:                                       ; preds = %for.end27, %for.end10
  %i.1 = phi i32 [ 1, %for.end10 ], [ %inc29, %for.end27 ]
...
for.cond15:                                       ; preds = %for.body17, %for.body14
  %j.1 = phi i32 [ 1, %for.body14 ], [ %inc26, %for.body17 ]
...
for.cond49:                                       ; preds = %for.end78, %for.end48
  %i.3 = phi i32 [ 0, %for.end48 ], [ %inc80, %for.end78 ]
...
for.cond53:                                       ; preds = %for.end75, %for.body52
  %j.3 = phi i32 [ 0, %for.body52 ], [ %inc77, %for.end75 ]
...
for.cond57:                                       ; preds = %for.body60, %for.body56
  %k.0 = phi i32 [ 0, %for.body56 ], [ %inc74, %for.body60 ]
...
for.body60:                                       ; preds = %for.cond57
  ...
  %10 = load i32, ptr %arrayidx72, align 4, !tbaa !5
...
for.cond82:                                       ; preds = %for.end105, %for.end81
  %i.4 = phi i32 [ 1, %for.end81 ], [ %inc107, %for.end105 ]
...
for.cond85:                                       ; preds = %if.end, %for.body84
  %j.4 = phi i32 [ 1, %for.body84 ], [ %inc104, %if.end ]
...
for.body87:                                       ; preds = %for.cond85
  ...
  %sub89 = sub nsw i32 %i.4, 1
  %idxprom90 = sext i32 %sub89 to i64
  %sub92 = sub nsw i32 %j.4, 1
  %idxprom93 = sext i32 %sub92 to i64
  %13 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom90
  %14 = getelementptr inbounds [100 x i32], ptr %13, i64 0, i64 %idxprom93
  %15 = load i32, ptr %14, align 4, !tbaa !5
  br i1 %cmp88, label %if.then, label %if.else

if.then:                                          ; preds = %for.body87
  %arrayidx91 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom90
  %arrayidx94 = getelementptr inbounds [100 x i32], ptr %arrayidx91, i64 0, i64 %idxprom93
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %15)
  br label %if.end

if.else:                                          ; preds = %for.body87
  %arrayidx98 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom90
  %arrayidx101 = getelementptr inbounds [100 x i32], ptr %arrayidx98, i64 0, i64 %idxprom93
  %call102 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %15)
  br label %if.end
