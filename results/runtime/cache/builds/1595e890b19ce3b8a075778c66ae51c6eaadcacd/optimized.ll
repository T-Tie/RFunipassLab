...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100000, ptr nonnull %a) #8
  br label %for.cond
...
if.then6.i:                                       ; preds = %for.body
  ...
  %1 = load i64, ptr %gep5, align 8, !tbaa !8
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 100000, ptr nonnull %a) #8
  ret i32 0
}
