...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull align 16 dereferenceable(1600) %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %b) #4
...
for.cond:                                         ; preds = %for.inc15, %entry
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc15 ], [ 0, %entry ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv48, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv48, i64 %indvars.iv
...
for.inc15:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv48
  ...
  %div = fdiv double %3, %4
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv48
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc41
  ...
  %indvars.iv51 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next52, %for.inc41 ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv51, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv51
...
if.else:                                          ; preds = %for.body21
  ...
  br i1 %cmp33, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit17, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit33

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit17: ; preds = %if.else
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i5)
  br label %for.inc41

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit33: ; preds = %if.else
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i21)
  br label %for.inc41
...
for.inc41:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit33, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit17
  %__c.addr.i.sink = phi ptr [ %__c.addr.i, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %__c.addr.i21, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit33 ], [ %__c.addr.i5, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit17 ]
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i.sink, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i23)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i.sink)
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond18, !llvm.loop !16

for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 1600, ptr noundef nonnull %a) #5
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) initializes((0, 1)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %1) unnamed_addr #3 {
if.then_to_outline:
  store i8 10, ptr %0, align 1, !tbaa !17
  %vbase.offset.i = load i64, ptr %1, align 8, !invariant.load !14
  %gep46 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %2 = load i64, ptr %gep46, align 8, !tbaa !18, !invariant.load !14
  %cmp.not.i = icmp eq i64 %2, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.then_to_outline
  %call1.i1 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit.exitStub

if.end.i:                                         ; preds = %if.then_to_outline
  %call2.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 10)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit.exitStub
