...
for.cond33:                                       ; preds = %for.inc58, %for.end
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc58 ], [ 0, %for.end ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond8.not, label %for.end60, label %for.inc58

for.inc58:                                        ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv5
  %6 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %arrayidx39 = getelementptr inbounds nuw [1000 x i32], ptr %f, i64 0, i64 %indvars.iv5
  %7 = load i32, ptr %arrayidx39, align 4, !tbaa !5
  %arrayidx41 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv5
  %8 = load i32, ptr %arrayidx41, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [1000 x i32], ptr %e, i64 0, i64 %indvars.iv5
  %9 = load i32, ptr %arrayidx44, align 4, !tbaa !5
  %reass.sub2 = sub i32 %9, %8
  %10 = mul i32 %reass.sub2, 60
  %arrayidx49 = getelementptr inbounds nuw [1000 x i32], ptr %d, i64 0, i64 %indvars.iv5
  %11 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %add50 = add nsw i32 %11, 12
  %arrayidx52 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv5
  %12 = load i32, ptr %arrayidx52, align 4, !tbaa !5
  %13 = xor i32 %12, -1
  %sub54 = add i32 %add50, %13
  %mul55 = mul nsw i32 %sub54, 3600
  %reass.sub3 = sub i32 %7, %6
  %mul = add i32 %reass.sub3, 3600
