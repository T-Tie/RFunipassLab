...
for.end:                                          ; preds = %for.cond
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc27
  %indvars.iv5 = phi i64 [ %indvars.iv, %for.cond7.preheader ], [ %indvars.iv.next6, %for.inc27 ]
  %max.1 = phi i32 [ %max.0, %for.cond7.preheader ], [ %max.2, %for.inc27 ]
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, -1
  %cmp8 = icmp sgt i64 %indvars.iv5, 0
  br i1 %cmp8, label %for.body9, label %for.inc29

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [25 x i32], ptr @a, i64 0, i64 %indvars.iv.next6
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %cmp14.not = icmp slt i32 %3, %2
  br i1 %cmp14.not, label %for.inc27, label %if.then

if.then:                                          ; preds = %for.body9
  %arrayidx16 = getelementptr inbounds nuw [25 x i32], ptr @b, i64 0, i64 %indvars.iv.next6
...
for.inc27:                                        ; preds = %if.then20, %for.body9, %if.then
  %max.2 = phi i32 [ %max.1, %for.body9 ], [ %max.1, %if.then ], [ %spec.select, %if.then20 ]
...
for.end31:                                        ; preds = %for.cond4
  ...
  %vtable.i = load ptr, ptr %call32, align 8, !tbaa !14, !invariant.load !16
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call32, i8 noundef signext %call.i1)
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !17, !invariant.load !16
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !35, !invariant.load !16
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !41, !invariant.load !16
  br label %return
