...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax55 = call i32 @llvm.smax.i32(i32 %indvars.iv18, i32 noundef 1)
  %smax44 = call i32 @llvm.smax.i32(i32 %indvars.iv18.in, i32 noundef 0)
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre6, %for.inc ], [ %1, %for.cond1 ]
