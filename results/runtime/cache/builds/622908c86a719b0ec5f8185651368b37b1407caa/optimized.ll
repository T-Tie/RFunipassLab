...
for.body4:                                        ; preds = %for.cond2
  %call5 = tail call noundef range(i32 0, -2147483648) i32 @_Z1Fi(i32 noundef %i.1) #5
  %spec.select = tail call i32 @llvm.smax.i32(i32 %z.0, i32 noundef %call5)
  %inc9 = add nuw i32 %i.1, 1
  br label %for.cond2, !llvm.loop !12

for.end10:                                        ; preds = %for.cond2
  %call11 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %z.0) #5
  ret i32 0
}
