...
for.cond13:                                       ; preds = %for.inc42, %for.body12
  %.sink11 = phi i32 [ 0, %for.body12 ], [ %inc43, %for.inc42 ]
  %5 = load i32, ptr %col, align 4, !tbaa !5
  %cmp14 = icmp slt i32 %.sink11, %5
  br i1 %cmp14, label %for.body15, label %for.inc45

for.body15:                                       ; preds = %for.cond13
  %cmp16 = icmp eq i32 %.sink11, 0
...
if.else:                                          ; preds = %for.body15
  ...
  %idxprom27 = sext i32 %.sink11 to i64
...
for.inc42.gvnsink.split:                          ; preds = %if.then, %if.then32
  %idxprom25.sink = phi i64 [ %idxprom25, %if.then32 ], [ %idxprom25, %if.then ]
...
for.cond48:                                       ; preds = %for.inc86, %for.end47
  ...
  %10 = load i32, ptr %col, align 4, !tbaa !5
  %cmp49 = icmp slt i32 %9, %10
...
for.cond51:                                       ; preds = %for.inc83, %for.body50
  %.sink = phi i32 [ 0, %for.body50 ], [ %inc84, %for.inc83 ]
  %cmp52 = icmp slt i32 %.sink, %1
  br i1 %cmp52, label %for.body53, label %for.inc86

for.body53:                                       ; preds = %for.cond51
  %cmp54 = icmp eq i32 %.sink, 0
  %idxprom67 = sext i32 %9 to i64
...
if.then55:                                        ; preds = %for.body53
  ...
  store i32 %11, ptr %arrayidx61, align 4, !tbaa !5
  br label %for.inc83.gvnsink.split

if.else64:                                        ; preds = %for.body53
  %idxprom65 = sext i32 %.sink to i64
...
for.inc83.gvnsink.split:                          ; preds = %if.then55, %if.then72
  %idxprom67.sink = phi i64 [ %idxprom67, %if.then72 ], [ %idxprom67, %if.then55 ]
