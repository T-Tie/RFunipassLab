...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv36 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next37, %for.body4 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv36
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv40 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next41, %for.body15 ]
  %Max2.0 = phi i32 [ 0, %for.cond13.preheader ], [ %Max2.1, %for.body15 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond44.not, label %for.end28, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv40
