...
if.else124:                                       ; preds = %for.body
  ...
  %neg162 = fmul double %7, %fneg80
  %13 = call double @llvm.fmuladd.f64(double %mul19, double %9, double %neg162)
  %call163 = call double @sqrt(double noundef %13) #8, !tbaa !5
...
for.inc.gvnsink.split:                            ; preds = %for.body
  %call37 = call double @sqrt(double noundef %11) #8, !tbaa !5
  %add94.sink = fsub double %call37, %7
  %mul97 = fmul double %8, 2.000000e+00
  %div98 = fdiv double %add94.sink, %mul97
  %arrayidx100 = getelementptr inbounds nuw double, ptr %vla3, i64 %indvars.iv
  store double %div98, ptr %arrayidx100, align 8, !tbaa !9
  %sub117 = fsub double %fneg80, %call37
  br label %for.inc

for.inc:                                          ; preds = %for.inc.gvnsink.split, %if.else124
  %mul129.sink = phi double [ %mul129, %if.else124 ], [ %mul97, %for.inc.gvnsink.split ]
  %fneg183.sink = phi double [ %fneg183, %if.else124 ], [ %sub117, %for.inc.gvnsink.split ]
  %vla4.sink = phi ptr [ %vla7, %if.else124 ], [ %vla4, %for.inc.gvnsink.split ]
  %div187 = fdiv double %fneg183.sink, %mul129.sink
  %arrayidx63 = getelementptr inbounds nuw double, ptr %vla4.sink, i64 %indvars.iv
  store double %div187, ptr %arrayidx63, align 8, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond, !llvm.loop !11

for.cond192:                                      ; preds = %for.cond, %for.inc244
  %14 = phi i32 [ %.pre82, %for.inc244 ], [ %5, %for.cond ]
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc244 ], [ 0, %for.cond ]
  %15 = sext i32 %14 to i64
  %cmp193 = icmp slt i64 %indvars.iv79, %15
  br i1 %cmp193, label %for.body194, label %for.end246

for.body194:                                      ; preds = %for.cond192
  %arrayidx196 = getelementptr inbounds nuw double, ptr %vla1, i64 %indvars.iv79
  %16 = load double, ptr %arrayidx196, align 8, !tbaa !9
  %arrayidx201 = getelementptr inbounds nuw double, ptr %vla, i64 %indvars.iv79
  %17 = load double, ptr %arrayidx201, align 8, !tbaa !9
  %mul202 = fmul double %17, 4.000000e+00
  %arrayidx204 = getelementptr inbounds nuw double, ptr %vla2, i64 %indvars.iv79
...
if.then208:                                       ; preds = %for.body194
  %arrayidx210 = getelementptr inbounds nuw double, ptr %vla3, i64 %indvars.iv79
  %21 = load double, ptr %arrayidx210, align 8, !tbaa !9
  %arrayidx212 = getelementptr inbounds nuw double, ptr %vla4, i64 %indvars.iv79
  %22 = load double, ptr %arrayidx212, align 8, !tbaa !9
  %call213 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %21, double noundef %22) #9
  br label %for.inc244
...
if.then228:                                       ; preds = %if.else214
  %arrayidx230 = getelementptr inbounds nuw double, ptr %vla3, i64 %indvars.iv79
  %23 = load double, ptr %arrayidx230, align 8, !tbaa !9
  %call231 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %23) #9
  br label %for.inc244

if.else232:                                       ; preds = %if.else214
  %arrayidx234 = getelementptr inbounds nuw double, ptr %vla5, i64 %indvars.iv79
  %24 = load double, ptr %arrayidx234, align 8, !tbaa !9
  %arrayidx236 = getelementptr inbounds nuw double, ptr %vla6, i64 %indvars.iv79
  %25 = load double, ptr %arrayidx236, align 8, !tbaa !9
  %arrayidx240 = getelementptr inbounds nuw double, ptr %vla7, i64 %indvars.iv79
  %26 = load double, ptr %arrayidx240, align 8, !tbaa !9
  %call241 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %24, double noundef %25, double noundef %24, double noundef %26) #9
  br label %for.inc244

for.inc244:                                       ; preds = %if.then208, %if.else232, %if.then228
  %indvars.iv.next80 = add nuw nsw i64 %indvars.iv79, 1
  %.pre82 = load i32, ptr %n, align 4, !tbaa !5
...
declare noundef i32 @printf(ptr noundef readonly captures(none), ...) #6
