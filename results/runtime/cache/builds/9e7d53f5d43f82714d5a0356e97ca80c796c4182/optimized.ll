...
for.cond1:                                        ; preds = %for.inc, %for.body
  %a2.1 = phi i32 [ %a2.0, %for.body ], [ %a2.2, %for.inc ]
  %a1.1 = phi i32 [ %a1.0, %for.body ], [ %a1.2, %for.inc ]
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %for.body4
  %a2.2 = phi i32 [ %j.0, %if.then ], [ %a2.1, %land.lhs.true ], [ %a2.1, %for.body4 ]
  %a1.2 = phi i32 [ %i.0, %if.then ], [ %a1.1, %land.lhs.true ], [ %a1.1, %for.body4 ]
...
if.end10:                                         ; preds = %if.then9, %if.end
  %b1.2 = phi i32 [ %i.0, %if.then9 ], [ %b1.1, %if.end ]
  %b2.2 = phi i32 [ %j.0, %if.then9 ], [ %b2.1, %if.end ]
  br label %for.inc
