...
for.end42:                                        ; preds = %for.cond28, %for.end42.split.loop.exit
  ...
  %smax65 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %i.140, i32 %0)
...
for.body45:                                       ; preds = %for.cond43
  ...
  %or.cond32 = or i1 %cmp54, %cmp51
  br i1 %or.cond32, label %for.end59.split.loop.exit, label %for.cond43, !llvm.loop !16
