...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) %p) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) %lenq) #6
...
while.end48:                                      ; preds = %while.cond4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %lenq) #7
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull captures(none) %p) #7
