...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc7 ], [ 0, %entry ]
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax31 = call i32 @llvm.smax.i32(i32 %0, i32 0)
  %wide.trip.count37 = zext nneg i32 %smax31 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond38.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select, %for.body15 ], [ %l1.0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select17, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv24
  ...
  %spec.select17 = call i32 @llvm.smax.i32(i32 %5, i32 %max.0)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv27 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next28, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %exitcond33.not = icmp eq i64 %indvars.iv27, %wide.trip.count37
  br i1 %exitcond33.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv27, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv27, i64 %idxprom40
  ...
  %spec.select18 = select i1 %cmp42, i32 %8, i32 %l2.1
  %spec.select19 = call i32 @llvm.smin.i32(i32 %7, i32 %min.1)
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select18, %if.end37 ]
  %min.3 = phi i32 [ %9, %if.end37.thread ], [ %spec.select19, %if.end37 ]
