...
while.cond:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %indvars.iv21 = phi i32 [ %indvars.iv.next22, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ -1, %entry ]
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %smax = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %indvars.iv21, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %while.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc ], [ 0, %while.end ]
  %exitcond.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %sentence, i64 0, i64 %indvars.iv18
