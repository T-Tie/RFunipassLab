...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec21 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
  %k.0 = phi i32 [ 1, %entry ], [ %k.1, %for.cond1 ]
  %dec = add nsw i32 %dec21, -1
  %tobool.not = icmp eq i32 %dec21, 0
...
for.cond1:                                        ; preds = %for.cond, %if.end17
  %indvars.iv23 = phi i64 [ %4, %if.end17 ], [ 0, %for.cond ]
  %k.1 = phi i32 [ %k.2, %if.end17 ], [ %k.0, %for.cond ]
  %2 = sext i32 %k.1 to i64
  %cmp2 = icmp slt i64 %indvars.iv23, %2
  br i1 %cmp2, label %for.body3, label %while.cond, !llvm.loop !13

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv23
...
if.then:                                          ; preds = %for.body3
  ...
  %add11 = add nsw i32 %5, %div19
  store i32 %add11, ptr %arrayidx10, align 4, !tbaa !5
  %rem20 = urem i32 %3, 10
  store i32 %rem20, ptr %arrayidx5, align 4, !tbaa !5
  %sub = add nsw i32 %k.1, -1
  %6 = zext i32 %sub to i64
  %cmp14 = icmp eq i64 %indvars.iv23, %6
  %inc16 = zext i1 %cmp14 to i32
  %spec.select = add nsw i32 %k.1, %inc16
  br label %if.end17

if.end17:                                         ; preds = %for.body3, %if.then
  %k.2 = phi i32 [ %spec.select, %if.then ], [ %k.1, %for.body3 ]
  br label %for.cond1, !llvm.loop !14

for.cond22:                                       ; preds = %for.cond22.preheader, %for.body24
  %indvars.iv28 = phi i64 [ %0, %for.cond22.preheader ], [ %8, %for.body24 ]
  %7 = trunc nuw i64 %indvars.iv28 to i32
  %cmp23 = icmp sgt i32 %7, 0
  br i1 %cmp23, label %for.body24, label %for.end30

for.body24:                                       ; preds = %for.cond22
  %8 = add nsw i64 %indvars.iv28, -1
  ...
  %call27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %9) #6
