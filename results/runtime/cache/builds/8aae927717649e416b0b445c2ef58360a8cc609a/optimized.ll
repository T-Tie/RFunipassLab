...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec3 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv5
...
if.then:                                          ; preds = %for.body3
  %div1 = udiv i32 %3, 10
  %arrayidx10 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next6
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !9
  %add11 = add nsw i32 %4, %div1
  store i32 %add11, ptr %arrayidx10, align 4, !tbaa !5
  %rem2 = urem i32 %3, 10
  store i32 %rem2, ptr %arrayidx5, align 4, !tbaa !5
  %sub = add nsw i32 %k.1, -1
  %5 = zext i32 %sub to i64
  %cmp14 = icmp eq i64 %indvars.iv5, %5
  %inc16 = zext i1 %cmp14 to i32
  %spec.select = add nsw i32 %k.1, %inc16
  br label %for.inc18

for.inc18:                                        ; preds = %if.then, %for.body3
  %k.2 = phi i32 [ %k.1, %for.body3 ], [ %spec.select, %if.then ]
  br label %for.cond1, !llvm.loop !14

for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv9 = phi i64 [ %0, %for.cond22.preheader ], [ %7, %for.inc28 ]
  %6 = trunc nuw i64 %indvars.iv9 to i32
  %cmp23 = icmp sgt i32 %6, 0
  br i1 %cmp23, label %for.inc28, label %for.end30

for.inc28:                                        ; preds = %for.cond22
  %7 = add nsw i64 %indvars.iv9, -1
  %arrayidx26 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %7
