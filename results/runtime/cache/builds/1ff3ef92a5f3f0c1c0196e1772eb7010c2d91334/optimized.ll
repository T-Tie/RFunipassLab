...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv19 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next20, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv19
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv38 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %indvars43 = trunc i64 %indvars.iv38 to i32
  %5 = add nsw i64 %indvars.iv38, -1
  %cmp15 = icmp sgt i32 %indvars43, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond30.not = icmp eq i64 %indvars.iv23, %5
  br i1 %exitcond30.not, label %for.cond14, label %for.body19, !llvm.loop !13

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv23
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next24
...
for.end41:                                        ; preds = %for.cond14
  %sub42 = sub i32 %0, %n.0
  %8 = sext i32 %sub42 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.inc50, %for.end41
  %9 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.end41 ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv31, %10
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv31
  %11 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %11) #6
  %indvars.iv.next32 = add nsw i64 %indvars.iv31, 1
  %.pre = load i32, ptr %w, align 4, !tbaa !5
  br label %for.cond43, !llvm.loop !15

for.end52:                                        ; preds = %for.cond43
  %arrayidx55 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %10
  %12 = load i32, ptr %arrayidx55, align 4, !tbaa !5
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12) #6
