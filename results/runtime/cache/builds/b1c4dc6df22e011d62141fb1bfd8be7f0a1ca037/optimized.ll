...
for.cond:                                         ; preds = %for.inc, %entry
  %phiofops = phi i1 [ false, %entry ], [ true, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter, i8 noundef 48, i64 noundef 40, i1 noundef false)
...
if.end:                                           ; preds = %for.body
  br i1 %phiofops, label %if.then9, label %for.inc
