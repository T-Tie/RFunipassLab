...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load float, ptr %s_good, align 4, !tbaa !9
  %3 = load float, ptr %s_all, align 4, !tbaa !9
  %div = fdiv float %2, %3
  %4 = load float, ptr %good, align 4, !tbaa !9
  %5 = load float, ptr %all, align 4, !tbaa !9
  %div5 = fdiv float %4, %5
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp14, label %if.end, label %if.else18

if.else18:                                        ; preds = %if.else
  br label %if.end

if.end:                                           ; preds = %if.else, %if.else18
  %.str.2.sink = phi ptr [ @.str.2, %if.else18 ], [ @.str.1, %if.else ]
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink)
