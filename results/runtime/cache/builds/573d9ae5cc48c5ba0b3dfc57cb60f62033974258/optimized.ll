...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  ...
  br i1 %exitcond33.not, label %for.end27, label %for.cond11
...
for.end27:                                        ; preds = %for.cond8, %for.end27.loopexit
  %indvars.iv2870 = phi i64 [ %indvars.iv28, %for.end27.loopexit ], [ %2, %for.cond8 ]
  %idxprom31.pre-phi = phi i64 [ %.pre43, %for.end27.loopexit ], [ %2, %for.cond8 ]
  %i.119 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.cond8 ]
  %y1.1 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.cond8 ]
  %cmp948 = icmp slt i64 %indvars.iv2870, %1
