...
for.cond:                                         ; preds = %for.inc17, %entry
  ...
  %exitcond42.not = icmp eq i64 %indvars.iv, 13
  br i1 %exitcond42.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc14 ], [ %indvars.iv, %for.cond ]
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond.not = icmp eq i64 %indvars.iv38, 12
  br i1 %exitcond.not, label %for.inc17, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not = icmp samesign ugt i64 %indvars.iv35, %indvars.iv38
  br i1 %cmp6.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv35
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv.next39
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc27 ], [ 1, %for.cond ]
  %exitcond46.not = icmp eq i64 %indvars.iv43, 13
  br i1 %exitcond46.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv43, i64 %indvars.iv43
  store i32 1, ptr %arrayidx26, align 4, !tbaa !5
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  br label %for.cond20, !llvm.loop !14

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond54.not = icmp eq i64 %indvars.iv51, 13
  br i1 %exitcond54.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond50.not = icmp eq i64 %indvars.iv47, %indvars.iv51
  br i1 %exitcond50.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv47, i64 %indvars.iv51
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv51, i64 %indvars.iv47
...
for.cond51:                                       ; preds = %for.cond30, %for.inc79
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc79 ], [ 1, %for.cond30 ]
  %exitcond65.not = icmp eq i64 %indvars.iv55, 13
  br i1 %exitcond65.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc76 ], [ %indvars.iv55, %for.cond51 ]
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond63.not = icmp eq i64 %indvars.iv60, 12
  br i1 %exitcond63.not, label %for.inc79, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc65 ], [ %indvars.iv55, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not = icmp samesign ugt i64 %indvars.iv57, %indvars.iv60
  br i1 %cmp60.not, label %for.end67, label %for.inc65

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv57
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv55, i64 %indvars.iv.next61
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond69.not = icmp eq i64 %indvars.iv66, 13
  br i1 %exitcond69.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv66, i64 %indvars.iv66
  store i32 1, ptr %arrayidx88, align 4, !tbaa !5
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  br label %for.cond82, !llvm.loop !20

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond77.not = icmp eq i64 %indvars.iv74, 13
  br i1 %exitcond77.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond73.not = icmp eq i64 %indvars.iv70, %indvars.iv74
  br i1 %exitcond73.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv70, i64 %indvars.iv74
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv74, i64 %indvars.iv70
...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts33 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink)
