...
if.then:                                          ; preds = %for.body
  ...
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %word)
  br label %for.inc
...
if.then9:                                         ; preds = %if.end
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %word)
  br label %for.inc

if.else:                                          ; preds = %if.end
  %call13 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, ptr noundef %word)
  store i32 %conv, ptr %s, align 4, !tbaa !5
  br label %for.inc
