...
entry:
  ...
  %rem18 = srem i8 %rem1.lhs.trunc, 50
  %rem1.sext = sext i8 %rem18 to i32
  %sub2 = sub nsw i32 %rem, %rem1.sext
  %div3.lhs.trunc = trunc nsw i32 %sub2 to i16
  %div39 = sdiv i16 %div3.lhs.trunc, 50
  %div3.sext = sext i16 %div39 to i32
  %rem410 = srem i8 %rem18, 20
  %div611 = sdiv i8 %rem18, 20
  %div6.sext = sext i8 %div611 to i32
  %rem712 = srem i8 %rem410, 10
  %rem7.sext = sext i8 %rem712 to i32
  %div913 = sdiv i8 %rem410, 10
  %div9.sext = sext i8 %div913 to i32
  store i32 %rem7.sext, ptr %n, align 4, !tbaa !5
  %rem1014 = srem i8 %rem712, 5
  %rem10.sext = sext i8 %rem1014 to i32
  %div1215 = sdiv i8 %rem712, 5
