...
if.then31:                                        ; preds = %for.body27
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %4, i32 noundef %5)
  br label %if.end35
...
for.cond39:                                       ; preds = %if.end49, %for.end38
  %6 = phi i32 [ %.pr2, %if.end49 ], [ 97, %for.end38 ]
  %cmp40 = icmp sle i32 %6, 122
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %6, i32 noundef %7)
  br label %if.end49

if.end49:                                         ; preds = %if.then45, %for.body41
  call fastcc void @outlined_ir_func_0() #6
  %.pr2 = load i32, ptr @i, align 4, !tbaa !5
  br label %for.cond39
