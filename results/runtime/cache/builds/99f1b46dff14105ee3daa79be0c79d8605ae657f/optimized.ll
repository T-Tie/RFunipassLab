...
for.cond28:                                       ; preds = %for.inc50, %for.end27
  %.sink = phi i32 [ 0, %for.end27 ], [ %inc51, %for.inc50 ]
  %cmp29 = icmp slt i32 %.sink, %1
  br i1 %cmp29, label %for.body30, label %for.end52

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i32 %.sink, 0
  %idxprom38 = sext i32 %.sink to i64
  %9 = load i32, ptr %l1, align 4, !tbaa !5
  %idxprom40 = sext i32 %9 to i64
  %10 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom38
  %11 = getelementptr inbounds [10 x i32], ptr %10, i64 0, i64 %idxprom40
  %12 = load i32, ptr %11, align 4, !tbaa !5, !invariant.load !14
  br i1 %cmp31, label %for.inc50.gvnsink.split, label %if.end37

if.end37:                                         ; preds = %for.body30
  %13 = load i32, ptr %min, align 4, !tbaa !5
  %cmp42 = icmp slt i32 %12, %13
  br i1 %cmp42, label %for.inc50.gvnsink.split, label %for.inc50

for.inc50.gvnsink.split:                          ; preds = %if.end37, %for.body30
  %.sink.sink = phi i32 [ 0, %for.body30 ], [ %.sink, %if.end37 ]
  store i32 %12, ptr %min, align 4, !tbaa !5
  store i32 %.sink.sink, ptr %l2, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.inc50.gvnsink.split, %if.end37
  %inc51 = add nsw i32 %.sink, 1
...
for.end52:                                        ; preds = %for.cond28
  ...
  br i1 %cmp53, label %for.end59.thread, label %for.inc57

for.end59.thread:                                 ; preds = %for.end52
  %16 = load i32, ptr %l2, align 4, !tbaa !5
  %17 = load i32, ptr %l1, align 4, !tbaa !5
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %16, i32 noundef %17)
  br label %if.end63
