...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv16 = phi i32 [ %indvars.iv.next17, %while.cond ], [ 0, %for.cond ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv7
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv10 = phi i64 [ %2, %while.cond11.preheader ], [ %indvars.iv.next11, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %3 = trunc nuw i64 %indvars.iv.next11 to i32
  %cmp12 = icmp slt i32 %3, %0
  br i1 %cmp12, label %while.body13, label %for.inc29

while.body13:                                     ; preds = %while.cond11
  %4 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next11
...
land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next11
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv13 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next14, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select5, %for.body33 ]
  %exitcond18.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond18.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv13
  %7 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  %spec.select5 = tail call i32 @llvm.smax.i32(i32 %7, i32 %n.2)
