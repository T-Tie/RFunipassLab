...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.body4:                                        ; preds = %for.cond2
  ...
  br i1 %cmp5, label %if.end11, label %for.cond2, !llvm.loop !10

for.end.thread:                                   ; preds = %for.cond2
  %cmp616 = icmp sgt i32 %index.0, -1
  br i1 %cmp616, label %if.then7, label %if.end11
...
if.end11:                                         ; preds = %for.body4, %for.end.thread, %if.then7
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv23 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next24, %for.body17 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end23, label %for.body17

for.body17:                                       ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [1000 x i32], ptr %result, i64 0, i64 %indvars.iv23
