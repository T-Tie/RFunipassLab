...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %n) #13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %j) #13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %k) #13
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 dereferenceable(41000) %word) #13
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(41000) %word, i8 noundef 0, i64 noundef 41000, i1 noundef false) #14
  call void @llvm.lifetime.start.p0(i64 noundef 81000, ptr noundef align 16 %newword) #13
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %newword, i8 noundef 0, i64 noundef 81000, i1 noundef false) #14
...
for.cond2:                                        ; preds = %for.inc74, %for.end
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef %arrayidx6) #15
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef %arrayidx20, ptr noundef %arrayidx6) #16
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef %arrayidx35, ptr noundef %arrayidx6) #16
  %inc41 = add nsw i32 %6, 1
...
if.then44:                                        ; preds = %if.else42
  ...
  %call51 = call ptr @strcpy(ptr noundef %arrayidx46, ptr noundef %arrayidx6) #16
  br label %for.inc74.gvnsink.split
...
if.else58:                                        ; preds = %if.else42
  ...
  %call65 = call ptr @strcat(ptr noundef %arrayidx60, ptr noundef %arrayidx6) #16
  br label %for.inc74.gvnsink.split

for.inc74.gvnsink.split:                          ; preds = %if.then, %if.then44, %if.else58
  %add.sink1 = phi i32 [ %add, %if.else58 ], [ %add, %if.then44 ], [ %conv, %if.then ]
  %arrayidx60.sink = phi ptr [ %arrayidx60, %if.else58 ], [ %arrayidx46, %if.then44 ], [ %arrayidx20, %if.then ]
  %add.sink = phi i32 [ %add, %if.else58 ], [ %add, %if.then44 ], [ %conv, %if.then ]
...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  ...
  %cmp95 = icmp slt i32 %12, %conv93
  br i1 %cmp95, label %for.body96, label %for.inc116

for.body96:                                       ; preds = %for.cond94
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %12, %sub97
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %idxprom102 = sext i32 %12 to i64
  %arrayidx103 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom102
  %13 = load i8, ptr %arrayidx103, align 1, !tbaa !12
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %13)
...
if.else106:                                       ; preds = %for.body96
  ...
  %arrayidx110 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom109
  %14 = load i8, ptr %arrayidx110, align 1, !tbaa !12
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %14)
  br label %for.inc113

for.inc113:                                       ; preds = %if.then99, %if.else106
  %inc114 = add nsw i32 %12, 1
  store i32 %inc114, ptr %j, align 4, !tbaa !5
  br label %for.cond94, !llvm.loop !14

for.inc116:                                       ; preds = %for.cond94
  %inc117 = add nsw i32 %11, 1
  store i32 %inc117, ptr %i, align 4, !tbaa !5
  br label %for.cond86, !llvm.loop !15

for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 noundef 81000, ptr noundef %newword) #16
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef %word) #16
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %k) #16
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j) #16
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #16
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #16
  ret i32 0
}
...
do.end:                                           ; preds = %entry
  ...
  %call = call noundef i64 @_ZNSt8ios_base5widthEl(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr, i64 noundef 0) #16
...
if.then6:                                         ; preds = %if.else
  ...
  %call11 = call noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr10) #16
  ...
  %call16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15) #16
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull align 4 captures(none) dereferenceable(4) %__c) #16
  ...
  %call24 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23) #16
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull align 4 captures(none) dereferenceable(4) %ref.tmp) #16
  %call26 = call noundef i32 @_ZNSt11char_traitsIcE3eofEv() #16
  store i32 %call26, ptr %ref.tmp, align 4, !tbaa !5
  %call27 = call noundef zeroext i1 @_ZNSt11char_traitsIcE11eq_int_typeERKiS2_(ptr noundef nonnull align 4 dereferenceable(4) %__c, ptr noundef nonnull align 4 dereferenceable(4) %ref.tmp) #16
  call void @llvm.lifetime.end.p0(i64 4, ptr %ref.tmp) #16
...
if.end:                                           ; preds = %if.then28, %if.then19
  call void @llvm.lifetime.end.p0(i64 4, ptr %__c) #16
  br label %if.end33
...
entry:
  ...
  %call = call noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr) #16
...
if.end:                                           ; preds = %entry
  %0 = load i8, ptr %__c.addr, align 1, !tbaa !12
...
define available_externally noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %this, ptr noundef %__pf) #7 align 2 {
entry:
...
define linkonce_odr dso_local noundef i64 @_ZNSt8ios_base5widthEl(ptr noundef nonnull align 8 dereferenceable(216) %this, i64 noundef %__wide) #9 comdat align 2 {
entry:
...
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #16
  %call2 = call noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef %call, i32 noundef %__state) #16
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %this) #9 comdat align 2 {
entry:
  %_M_width = getelementptr inbounds nuw %"class.std::ios_base", ptr %this, i32 0, i32 2
  %0 = load i64, ptr %_M_width, align 8, !tbaa !19
  ret i64 %0
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #9 align 2 {
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #16
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #9 align 2 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr align 4 %__ret) #16
  %call = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #16
  %call2 = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #16
...
if.then:                                          ; preds = %entry
  %call3 = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #16
  %call4 = call noundef i32 @_ZNSt11char_traitsIcE11to_int_typeERKc(ptr noundef nonnull align 1 dereferenceable(1) %call3) #16
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %__ret) #16
  ret i32 %1
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef zeroext i1 @_ZNSt11char_traitsIcE11eq_int_typeERKiS2_(ptr noundef nonnull align 4 dereferenceable(4) %__c1, ptr noundef nonnull align 4 dereferenceable(4) %__c2) #9 comdat align 2 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNSt11char_traitsIcE3eofEv() #9 comdat align 2 {
entry:
  ret i32 -1
}
...
define linkonce_odr dso_local noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) #11 comdat {
entry:
  %or = or i32 %__a, %__b
  ret i32 %or
}
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #9 align 2 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNSt11char_traitsIcE11to_int_typeERKc(ptr noundef nonnull align 1 dereferenceable(1) %__c) #9 comdat align 2 {
entry:
...
; Function Attrs: mustprogress uwtable
define available_externally noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %this, i8 noundef signext %__c) #7 align 2 {
entry:
...
!43 = !{!31, !35, i64 240}
!44 = !{!45, !7, i64 56}
!45 = !{!"_ZTSSt5ctypeIcE", !46, i64 0, !47, i64 16, !33, i64 24, !48, i64 32, !48, i64 40, !49, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!46 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!47 = !{!"p1 _ZTS15__locale_struct", !25, i64 0}
!48 = !{!"p1 int", !25, i64 0}
!49 = !{!"p1 short", !25, i64 0}
