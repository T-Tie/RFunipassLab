...
if.then:                                          ; preds = %entry
  %ldexp = call double @ldexp(double noundef 1.000000e+00, i32 %0) #10
...
for.cond38.preheader:                             ; preds = %for.cond29
  %3 = and i64 %indvars.iv25, 4294967295
  br label %for.cond38
...
if.end49:                                         ; preds = %for.cond38, %if.then
  ...
  %vtable.i3 = load ptr, ptr %_ZSt4cout.sink35, align 8, !tbaa !16, !invariant.load !14
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %an) #11
