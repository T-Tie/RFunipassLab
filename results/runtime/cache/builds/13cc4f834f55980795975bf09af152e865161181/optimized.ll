...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20000, ptr nonnull %word) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(20000) %word, i8 0, i64 20000, i1 false)
  call void @llvm.lifetime.start.p0(i64 4100, ptr nonnull %para) #10
...
for.end52:                                        ; preds = %for.cond43
  call void @llvm.lifetime.end.p0(i64 4100, ptr nonnull %para) #10
  call void @llvm.lifetime.end.p0(i64 20000, ptr nonnull %word) #10
