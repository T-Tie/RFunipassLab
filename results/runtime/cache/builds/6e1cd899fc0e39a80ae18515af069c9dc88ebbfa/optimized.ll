...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27:
...
for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %1 = load i8, ptr %arrayidx28, align 1, !tbaa !9, !invariant.load !8
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv31
  %2 = load i8, ptr %arrayidx54, align 1, !tbaa !9, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv31
  %3 = load i8, ptr %arrayidx57, align 1, !tbaa !9, !invariant.load !8
...
for.end65:                                        ; preds = %for.cond50
  ...
  %4 = load double, ptr %w, align 8, !tbaa !15
  %cmp68 = fcmp ult double %div, %4
  %.str.3..str.2 = select i1 %cmp68, ptr @.str.3, ptr @.str.2
  br label %if.end75

if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ], [ %.str.3..str.2, %for.end65 ]
  %call47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.1.sink) #12
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0) unnamed_addr #9 {
entry_to_outline:
  %call16.i = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #12
  br i1 %call16.i, label %land.lhs.true.i, label %if.then6.i8.exitStub

land.lhs.true.i:                                  ; preds = %entry_to_outline
  %_M_width.i4.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %1 = load i64, ptr %_M_width.i4.i, align 8, !tbaa !17, !invariant.load !8
  %2 = add i64 %1, -1001
  %or.cond.i = icmp ult i64 %2, -1000
  br i1 %or.cond.i, label %if.then19.i, label %if.then6.i8.exitStub

if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #12
  ...
  br i1 %tobool.not.i, label %if.then6.i8.exitStub, label %if.then28.i
...
if.then28.i:                                      ; preds = %if.then19.i
  ...
  br label %if.then6.i8.exitStub

if.then6.i8.exitStub:                             ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry_to_outline
  ret void
}
...
!16 = !{!"double", !10, i64 0}
!17 = !{!18, !19, i64 16}
!18 = !{!"_ZTSSt8ios_base", !19, i64 8, !19, i64 16, !20, i64 24, !21, i64 28, !21, i64 32, !22, i64 40, !24, i64 48, !10, i64 64, !25, i64 192, !26, i64 200, !27, i64 208}
!19 = !{!"long", !10, i64 0}
