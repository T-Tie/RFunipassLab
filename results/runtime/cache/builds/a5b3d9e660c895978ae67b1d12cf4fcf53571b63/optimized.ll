...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc44
  ...
  %_ZSt4cout.sink4 = phi ptr [ @_ZSt4cout, %for.cond36.preheader ], [ %call39, %for.inc44 ]
  %arrayidx32 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv9
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink4, ptr noundef nonnull %arrayidx32)
