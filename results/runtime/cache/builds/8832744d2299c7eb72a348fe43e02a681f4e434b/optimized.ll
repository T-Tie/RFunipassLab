...
for.body23:                                       ; preds = %for.cond20
  %6 = add nuw i64 %indvars.iv17, 4294967295
...
for.cond30:                                       ; preds = %for.body33, %if.end
  ...
  %9 = trunc nuw i64 %indvars.iv11 to i32
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  ...
  %11 = trunc nuw i64 %indvars.iv14 to i32
...
for.body73:                                       ; preds = %for.cond70
  %13 = add nuw i64 %indvars.iv27, 4294967295
...
for.cond85:                                       ; preds = %for.body88, %if.end78
  ...
  %16 = trunc nuw i64 %indvars.iv21 to i32
