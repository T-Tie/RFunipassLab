...
for.cond6:                                        ; preds = %for.cond, %for.inc51
  %7 = phi i32 [ %.pre12, %for.inc51 ], [ %5, %for.cond ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc51 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp7 = icmp slt i64 %indvars.iv9, %8
  br i1 %cmp7, label %for.body8, label %for.end53

for.body8:                                        ; preds = %for.cond6
  %9 = load i32, ptr %vla1, align 16, !tbaa !5
  %arrayidx11 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv9
  %10 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %mul = mul nsw i32 %10, %9
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv9
...
for.inc51:                                        ; preds = %for.body8, %if.else, %if.else47
  ...
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str.2.sink.sink)
