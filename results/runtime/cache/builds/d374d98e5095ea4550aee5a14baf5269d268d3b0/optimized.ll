...
for.inc50:                                        ; preds = %if.end37.thread, %if.end37, %land.lhs.true, %if.then44
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.28, %land.lhs.true ], [ %l2.1, %if.end37 ], [ 0, %if.end37.thread ]
  %min.3 = phi i32 [ %6, %if.then44 ], [ %min.29, %land.lhs.true ], [ %min.1, %if.end37 ], [ %5, %if.end37.thread ]
