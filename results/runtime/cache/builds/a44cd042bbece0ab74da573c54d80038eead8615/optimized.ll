...
for.cond30:                                       ; preds = %for.cond2, %for.inc53
  ...
  %7 = sext i32 %.pre20 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv17, %7
...
land.lhs.true:                                    ; preds = %for.body33
  ...
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %8)
