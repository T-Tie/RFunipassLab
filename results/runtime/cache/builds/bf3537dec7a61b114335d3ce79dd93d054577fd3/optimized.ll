...
for.cond3:                                        ; preds = %for.inc, %for.cond
  %4 = phi i32 [ %.pre66, %for.inc ], [ %2, %for.cond ]
...
for.cond16:                                       ; preds = %for.inc30, %for.end10
  ...
  %8 = phi i32 [ %5, %for.end10 ], [ %.pre60, %for.inc30 ]
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc31, %for.inc30 ]
  %cmp17 = icmp slt i32 %i.1, %8
  br i1 %cmp17, label %for.cond19, label %for.end32

for.cond19:                                       ; preds = %for.inc27, %for.cond16
  %9 = phi i32 [ %.pre65, %for.inc27 ], [ %7, %for.cond16 ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %10, i32 noundef 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc74 ], [ 0, %for.end32 ]
  %exitcond59.not = icmp eq i64 %indvars.iv52, %wide.trip.count58
  br i1 %exitcond59.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %14 = mul nsw i64 %indvars.iv52, %12
  %15 = mul nsw i64 %indvars.iv52, %13
  %invariant.gep72 = getelementptr i32, ptr %call36, i64 %14
  %16 = getelementptr i32, ptr %call2, i64 %15
  br label %for.cond40

for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv45 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next46, %for.inc71 ]
  %exitcond51.not = icmp eq i64 %indvars.iv45, %wide.trip.count50
  br i1 %exitcond51.not, label %for.inc74, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %gep73 = getelementptr i32, ptr %invariant.gep72, i64 %indvars.iv45
  store i32 0, ptr %gep73, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv45
  br label %for.cond47
...
for.inc68:                                        ; preds = %for.cond47
  ...
  store i32 %add63, ptr %gep73, align 4, !tbaa !5
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  ...
  %22 = phi i32 [ %.pre61, %for.inc98 ], [ %10, %for.cond37 ]
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %23 = phi i32 [ %.pre62, %for.inc95 ], [ %21, %for.cond77 ]
...
if.then:                                          ; preds = %for.body82
  ...
  %.pre63 = load i32, ptr %y2, align 4, !tbaa !5
  %.pre67 = add nsw i32 %.pre63, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre67, %if.then ], [ %sub, %for.body82 ]
  %26 = phi i32 [ %.pre63, %if.then ], [ %25, %for.body82 ]
