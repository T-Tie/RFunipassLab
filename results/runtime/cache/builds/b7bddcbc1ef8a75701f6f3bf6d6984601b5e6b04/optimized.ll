...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 200, ptr nonnull %str) #8
...
while.body:                                       ; preds = %while.cond
  call void @_Z8multiplyPci(ptr noundef nonnull %str, i32 noundef 2)
  %dec = add nsw i32 %0, -1
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 200, ptr nonnull %str) #8
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 800, ptr nonnull %num) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(800) %num, i8 0, i64 800, i1 false)
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 800, ptr nonnull %num) #8
  ret void
}
...
attributes #4 = { mustprogress nounwind memory(read, argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
