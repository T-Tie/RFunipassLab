...
for.cond:                                         ; preds = %for.inc35, %entry
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc35 ], [ 0, %entry ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, 1000
  br i1 %exitcond20.not, label %for.end37, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv15, i64 %indvars.iv
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv15
...
for.end37:                                        ; preds = %land.lhs.true29, %for.cond
  %wide.trip.count = and i64 %indvars.iv15, 4294967295
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond24.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond24.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv21
