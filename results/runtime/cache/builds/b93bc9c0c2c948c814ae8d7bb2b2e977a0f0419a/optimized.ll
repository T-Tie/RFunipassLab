...
for.cond:                                         ; preds = %for.inc10, %while.body
  ...
  %0 = sext i32 %.pre6 to i64
  %cmp = icmp slt i64 %indvars.iv2, %0
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %storemerge = phi i32 [ %dec, %for.inc17 ], [ %.pre6, %for.cond ]
