...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %a) #5
  call void @llvm.lifetime.start.p0(i64 100, ptr %b) #5
...
for.inc8:                                         ; preds = %for.cond2
  %call5 = call noundef i32 @_Z2ljPiii(ptr noundef %a, i32 noundef %i.1, i32 noundef %1)
...
for.end21:                                        ; preds = %for.cond11
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr %b) #5
  call void @llvm.lifetime.end.p0(i64 100, ptr %a) #5
...
define dso_local noundef i32 @_Z2ljPiii(ptr noundef %a, i32 noundef %n, i32 noundef %m) local_unnamed_addr #3 {
entry:
...
if.then10:                                        ; preds = %for.body4
  %call = call noundef i32 @_Z2ljPiii(ptr noundef %a, i32 noundef %add, i32 noundef %m)
