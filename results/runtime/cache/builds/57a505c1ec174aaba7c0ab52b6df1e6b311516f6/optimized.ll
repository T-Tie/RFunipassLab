...
if.else:                                          ; preds = %for.body26
  ...
  %arrayidx35 = getelementptr inbounds [100 x i32], ptr %arrayidx33, i64 0, i64 %idxprom30
...
for.inc41:                                        ; preds = %cond.false, %if.else, %if.then
  %min.sink1.sink = phi ptr [ %arrayidx31, %if.then ], [ %min, %cond.false ], [ %arrayidx35, %if.else ]
...
if.else75:                                        ; preds = %for.body68
  ...
  %arrayidx77 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom71
...
for.inc90:                                        ; preds = %cond.false86, %if.else75, %if.then70
  %min.sink.sink = phi ptr [ %arrayidx74, %if.then70 ], [ %min, %cond.false86 ], [ %arrayidx79, %if.else75 ]
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %16 = load i32, ptr %arrayidx157, align 4, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %17 = load i32, ptr %arrayidx178, align 4, !tbaa !5
