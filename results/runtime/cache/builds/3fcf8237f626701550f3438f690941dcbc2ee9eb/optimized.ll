...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr nonnull %ch) #7
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %while.cond9
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #7
...
while.end35:                                      ; preds = %while.body
  ...
  call void @llvm.lifetime.end.p0(i64 41000, ptr nonnull %ch) #7
