...
land.lhs.true.i15:                                ; preds = %if.then19.i, %land.lhs.true.i
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(1000) %b, i64 noundef 1000)
  br i1 %or.cond.i, label %if.then19.i20, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28

if.then19.i20:                                    ; preds = %land.lhs.true.i15
  call void @outlined_ir_func_0(ptr %add.ptr10.i)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %if.then19.i20, %if.then6.i8, %land.lhs.true.i15
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !23, !invariant.load !8
  switch i8 %3, label %if.end75 [
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %4 = load i8, ptr %arrayidx28, align 1, !tbaa !23, !invariant.load !8
...
for.body52:                                       ; preds = %for.cond50
  ...
  %5 = load i8, ptr %arrayidx54, align 1, !tbaa !23, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv48
  %6 = load i8, ptr %arrayidx57, align 1, !tbaa !23, !invariant.load !8
  %cmp59 = icmp eq i8 %5, %6
...
for.end65:                                        ; preds = %for.cond50
  ...
  %7 = load double, ptr %w, align 8, !tbaa !28
  %cmp68 = fcmp ult double %div, %7
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !30, !invariant.load !8
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !33, !invariant.load !8
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !23, !invariant.load !8
...
if.then19.i_to_outline:                           ; preds = %newFuncRoot
  ...
  %1 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !34, !invariant.load !8
...
land.lhs.true.i15.exitStub:                       ; preds = %if.then28.i, %if.then19.i_to_outline
  ret void
}
...
!29 = !{!"double", !12, i64 0}
!30 = !{!31, !32, i64 16}
!31 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !32, i64 8, !32, i64 16, !32, i64 24, !32, i64 32, !32, i64 40, !32, i64 48, !20, i64 56}
