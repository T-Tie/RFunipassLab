...
for.cond10:                                       ; preds = %for.inc43, %for.end9
  %sub.sink = phi i32 [ %sub, %for.end9 ], [ %dec, %for.inc43 ]
  %cmp11 = icmp sgt i32 %sub.sink, -1
  br i1 %cmp11, label %for.cond13.preheader, label %for.cond45.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %2 = zext nneg i32 %sub.sink to i64
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc77
  %indvars.iv15 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next16, %for.inc77 ]
  %exitcond23.not = icmp eq i64 %indvars.iv15, %wide.trip.count22
  br i1 %exitcond23.not, label %for.end79, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv15, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc74
  %indvars.iv17 = phi i64 [ %indvars.iv15, %for.cond50.preheader ], [ %indvars.iv.next18, %for.inc74 ]
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %9 = trunc nuw i64 %indvars.iv.next18 to i32
...
for.body52:                                       ; preds = %for.cond50
  ...
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next18, i32 1
