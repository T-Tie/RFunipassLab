...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1280, ptr noundef nonnull align 16 %part) #5
  br label %for.cond

for.cond:                                         ; preds = %for.inc21, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc21 ], [ 0, %entry ]
  %exitcond35.not = icmp eq i64 %indvars.iv32, 20
  br i1 %exitcond35.not, label %for.end23, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx7 = getelementptr inbounds nuw [20 x i32], ptr @_ZZ4mainE6jcount, i64 0, i64 %indvars.iv32
  br label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [20 x [16 x i32]], ptr %part, i64 0, i64 %indvars.iv32, i64 %indvars.iv
  ...
  %0 = load i32, ptr %arrayidx7, align 4, !tbaa !5, !invariant.load !9
  %inc = add nsw i32 %0, 1
...
for.end:                                          ; preds = %for.body3, %for.cond1
  ...
  %arrayidx17 = getelementptr inbounds nuw [20 x [16 x i32]], ptr %part, i64 0, i64 %indvars.iv32, i64 %idxprom16
...
for.end23:                                        ; preds = %for.end, %for.cond
  %wide.trip.count48 = and i64 %indvars.iv32, 4294967295
  br label %for.cond24

for.cond24:                                       ; preds = %for.inc67, %for.end23
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc67 ], [ 0, %for.end23 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count48
  br i1 %exitcond49.not, label %for.cond70, label %for.cond27.preheader

for.cond27.preheader:                             ; preds = %for.cond24
  %arrayidx29 = getelementptr inbounds nuw [20 x i32], ptr @_ZZ4mainE6jcount, i64 0, i64 %indvars.iv45
  %3 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !9
  %sub = add nsw i32 %3, -1
  %arrayidx58 = getelementptr inbounds nuw [20 x i32], ptr @_ZZ4mainE5group, i64 0, i64 %indvars.iv45
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc64
  %indvars.iv40 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next41, %for.inc64 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count43
  br i1 %exitcond44.not, label %for.inc67, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond27
  %arrayidx41 = getelementptr inbounds nuw [20 x [16 x i32]], ptr %part, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc61
  %indvars.iv36 = phi i64 [ 0, %for.cond32.preheader ], [ %indvars.iv.next37, %for.inc61 ]
  %exitcond39.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond39.not, label %for.inc64, label %for.body37

for.body37:                                       ; preds = %for.cond32
  %4 = load i32, ptr %arrayidx41, align 4, !tbaa !5
  %arrayidx45 = getelementptr inbounds nuw [20 x [16 x i32]], ptr %part, i64 0, i64 %indvars.iv45, i64 %indvars.iv36
...
for.cond70:                                       ; preds = %for.cond24, %for.inc77
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc77 ], [ 0, %for.cond24 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count48
  br i1 %exitcond54.not, label %for.end79, label %for.inc77

for.inc77:                                        ; preds = %for.cond70
  %arrayidx74 = getelementptr inbounds nuw [20 x i32], ptr @_ZZ4mainE5group, i64 0, i64 %indvars.iv50
  %7 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !9
  ...
  %vtable.i = load ptr, ptr %call75, align 8, !tbaa !17, !invariant.load !9
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call75, i8 noundef signext %call.i1)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br label %for.cond70, !llvm.loop !19

for.end79:                                        ; preds = %for.cond70
  call void @llvm.lifetime.end.p0(i64 noundef 1280, ptr noundef nonnull %part) #6
  ret i32 0
}
