...
if.then30:                                        ; preds = %if.end28
  ...
  %call35 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %div34) #9
...
if.then39:                                        ; preds = %if.end37
  ...
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %div43) #9
  ...
  %call50 = tail call double @sqrt(double noundef %19) #8, !tbaa !5
  ...
  %call60 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %div59) #9
  ...
  %call65 = tail call double @sqrt(double noundef %26) #8, !tbaa !5
