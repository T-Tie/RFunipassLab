...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(10000) %c, i8 noundef 0, i64 noundef 10000, i1 noundef false)
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call.i = tail call i32 @getc(ptr noundef %0) #5
...
entry:
  %0 = load ptr, ptr @stdin, align 8, !tbaa !5
  %call = tail call i32 @getc(ptr noundef %0) #5
  ret i32 %call
}
