...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %5) #9, !tbaa !5
  %add = fsub double %call5, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %sub = fsub double %fneg, %call5
  %div9 = fdiv double %sub, %mul
  %cmp10 = fcmp une double %div, %div9
  br i1 %cmp10, label %if.then11, label %if.end

if.then11:                                        ; preds = %if.then
  %call12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div9) #8
  br label %if.end
...
if.then14:                                        ; preds = %if.end
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div9) #8
  br label %if.end17

if.end17:                                         ; preds = %if.end, %if.then14, %for.body
  %cmp18 = fcmp olt double %5, 0.000000e+00
  br i1 %cmp18, label %if.end49, label %for.inc

if.end49:                                         ; preds = %if.end17
  %6 = load double, ptr %b, align 8, !tbaa !9
  %fneg20 = fneg double %6
  %7 = load double, ptr %a, align 8, !tbaa !9
  %mul21 = fmul double %7, 2.000000e+00
  %div22 = fdiv double %fneg20, %mul21
  %fneg23 = fneg double %5
  %call24 = call double @sqrt(double noundef %fneg23) #9, !tbaa !5
  %div26 = fdiv double %call24, %mul21
  %fneg29 = fneg double %call24
  %div31 = fdiv double %fneg29, %mul21
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div22) #8
  call fastcc void @outlined_ir_func_0(double %div26, ptr nofree noundef nonnull readonly captures(none) dereferenceable(7) @.str.6) #8
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %div22) #8
  call fastcc void @outlined_ir_func_0(double %div31, ptr nofree noundef nonnull readonly captures(none) dereferenceable(8) @.str.8) #8
  br label %for.inc

for.inc:                                          ; preds = %if.end17, %if.end49
...
define internal fastcc void @outlined_ir_func_0(double %0, ptr nofree noundef nonnull readonly captures(none) dereferenceable(7) %1) unnamed_addr #6 {
if.then19_to_outline:
  %cmp33 = fcmp ogt double %0, 0.000000e+00
  br i1 %cmp33, label %if.then34, label %if.end36

if.then34:                                        ; preds = %if.then19_to_outline
  %call35 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %0) #10
  br label %if.end36

if.end36:                                         ; preds = %if.then34, %if.then19_to_outline
  %cmp37 = fcmp olt double %0, 0.000000e+00
  br i1 %cmp37, label %if.then38, label %if.end40.exitStub

if.then38:                                        ; preds = %if.end36
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull readonly captures(none) dereferenceable(1) %1, double noundef %0) #10
  br label %if.end40.exitStub

if.end40.exitStub:                                ; preds = %if.then38, %if.end36
  ret void
}
