...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv11
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc15 ], [ %indvars.iv5, %for.body4 ]
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv.next19 = add nsw i64 %indvars.iv18, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next19
...
for.cond28.preheader:                             ; preds = %for.cond21
  %indvars = trunc i64 %indvars.iv.next19 to i32
  %smax26 = call i32 @llvm.smax.i32(i32 %indvars, i32 0)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv21 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next22, %for.inc39 ]
  %exitcond28.not = icmp eq i64 %indvars.iv21, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv21
...
for.end41:                                        ; preds = %for.cond28
  %arrayidx23.le = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next19
