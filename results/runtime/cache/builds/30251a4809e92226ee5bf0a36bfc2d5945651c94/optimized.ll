...
for.cond5:                                        ; preds = %for.inc23, %for.end
  %i4.0 = phi i32 [ 1, %for.end ], [ %inc24, %for.inc23 ]
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %cmp6 = icmp slt i32 %i4.0, %5
  br i1 %cmp6, label %for.body8, label %for.end25

for.body8:                                        ; preds = %for.cond5
  br label %for.cond9

for.cond9:                                        ; preds = %for.inc20, %for.body8
  %j.0 = phi i32 [ 0, %for.body8 ], [ %inc21, %for.inc20 ]
  %cmp10 = icmp slt i32 %j.0, %i4.0
  br i1 %cmp10, label %for.body12, label %for.inc23
...
for.inc23:                                        ; preds = %for.cond9
  %inc24 = add nsw i32 %i4.0, 1
  br label %for.cond5, !llvm.loop !13

for.end25:                                        ; preds = %for.cond5
  br label %for.cond27

for.cond27:                                       ; preds = %for.inc40, %for.end25
  %i26.0 = phi i32 [ 1, %for.end25 ], [ %inc41, %for.inc40 ]
  %8 = load i32, ptr %n, align 4, !tbaa !5
  %cmp28 = icmp slt i32 %i26.0, %8
...
for.body30:                                       ; preds = %for.cond27
  ...
  %cmp33 = icmp sgt i32 %9, 1
  br i1 %cmp33, label %if.then34, label %for.inc40

if.then34:                                        ; preds = %for.body30
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  %10 = load i32, ptr %arrayidx32, align 4, !tbaa !5
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call35, i32 noundef %10)
  br label %for.inc40

for.inc40:                                        ; preds = %for.body30, %if.then34
  %inc41 = add nsw i32 %i26.0, 1
