...
for.cond2:                                        ; preds = %for.inc74, %for.end
  %2 = phi i32 [ %.pr, %for.inc74 ], [ 0, %for.end ]
...
for.inc74.gvnsink.split:                          ; preds = %if.then, %if.then44, %if.else58
  %add.sink12 = phi i32 [ %add, %if.else58 ], [ %add, %if.then44 ], [ %conv, %if.then ]
...
for.body96:                                       ; preds = %for.cond94
  ...
  %8 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom109
