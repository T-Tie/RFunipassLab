...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %p) #7
  br label %while.cond
...
while.end:                                        ; preds = %while.cond
  store ptr %sentence, ptr %p, align 8, !tbaa !13
...
if.then:                                          ; preds = %while.body5
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %3)
...
while.body13:                                     ; preds = %while.cond10
  %incdec.ptr14 = getelementptr inbounds nuw i8, ptr %4, i32 1
  store ptr %incdec.ptr14, ptr %p, align 8, !tbaa !13
...
while.end16:                                      ; preds = %while.cond2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %p) #8
...
!33 = !{!34, !38, i64 240}
!34 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !24, i64 0, !35, i64 216, !7, i64 224, !36, i64 225, !37, i64 232, !38, i64 240, !39, i64 248, !40, i64 256}
!35 = !{!"p1 _ZTSSo", !15, i64 0}
!36 = !{!"bool", !7, i64 0}
