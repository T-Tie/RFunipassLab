...
while.cond.preheader:                             ; preds = %for.cond1
  %smax93 = call i32 @llvm.smax.i32(i32 %1, i32 0)
  br label %while.cond
...
for.cond14.preheader:                             ; preds = %while.cond
  %smax89 = call i32 @llvm.smax.i32(i32 %indvars.iv30, i32 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond36.not, label %for.cond45, label %for.body16
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count35
  br i1 %exitcond47.not, label %for.cond70, label %for.cond49.preheader
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond58.not = icmp eq i64 %indvars.iv53, %wide.trip.count35
  br i1 %exitcond58.not, label %for.cond104, label %for.body73
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond80.not, label %for.cond154, label %for.cond135
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc174 ], [ 0, %for.cond131 ]
