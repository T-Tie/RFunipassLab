...
for.cond9:                                        ; preds = %for.inc29, %for.body6
  %sub.sink = phi i32 [ %sub, %for.body6 ], [ %dec, %for.inc29 ]
  %cmp10 = icmp sge i32 %sub.sink, 0
  br i1 %cmp10, label %for.body11, label %for.inc31

for.body11:                                       ; preds = %for.cond9
  %idxprom12 = sext i32 %sub.sink to i64
...
for.end33:                                        ; preds = %for.cond4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %m) #4
...
for.end46:                                        ; preds = %for.cond34
  %call47 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %8)
