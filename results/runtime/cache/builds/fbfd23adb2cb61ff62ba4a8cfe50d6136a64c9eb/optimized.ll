...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %1 = add i32 %.pr7, -20
  %or.cond12 = icmp ult i32 %1, 30
  br i1 %or.cond12, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %2 = add i32 %.pr8, -10
  %or.cond13 = icmp ult i32 %2, 10
  br i1 %or.cond13, label %while.body22, label %while.end25
