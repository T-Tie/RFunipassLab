...
for.cond13.preheader:                             ; preds = %for.cond10
  ...
  %5 = trunc nuw nsw i64 %indvars.iv12 to i32
  br label %for.cond13
...
if.then:                                          ; preds = %for.body15
  %6 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
...
for.inc42.gvnsink.split:                          ; preds = %if.else, %if.then
  %storemerge40 = phi i32 [ %6, %if.then ], [ %7, %if.else ]
  store i32 %storemerge40, ptr %arrayidx30, align 4, !tbaa !5
...
for.cond51.preheader:                             ; preds = %for.cond48
  ...
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
if.else64:                                        ; preds = %for.body53
  ...
  %11 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !13
  %12 = load i32, ptr %arrayidx70, align 4, !tbaa !5, !invariant.load !13
...
for.cond89:                                       ; preds = %for.cond48, %for.inc110
  ...
  %cmp90 = icmp slt i64 %indvars.iv33, %14
