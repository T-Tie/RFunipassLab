...
for.inc41:                                        ; preds = %if.then, %if.else, %cond.true
  %min.4 = phi i32 [ %3, %if.then ], [ %4, %cond.true ], [ %min.3, %if.else ]
...
for.inc90:                                        ; preds = %if.then70, %if.else75, %cond.true81
  %min.7 = phi i32 [ %6, %if.then70 ], [ %7, %cond.true81 ], [ %min.6, %if.else75 ]
