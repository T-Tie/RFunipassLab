...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv34
...
for.cond10:                                       ; preds = %for.cond10.loopexit, %for.cond10.preheader
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.cond10.loopexit ], [ %1, %for.cond10.preheader ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond10.loopexit ], [ %3, %for.cond10.preheader ]
  %indvars.iv.next23 = add nsw i64 %indvars.iv22, -1
  %cmp11 = icmp sgt i64 %indvars.iv22, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next23
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next23
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv19 = phi i64 [ %indvars.iv17, %for.cond13.preheader ], [ %indvars.iv.next20, %for.inc31 ]
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, 1
  %cmp14 = icmp slt i64 %indvars.iv.next20, %1
  br i1 %cmp14, label %for.body15, label %for.cond10.loopexit

for.body15:                                       ; preds = %for.cond13
  %4 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %arrayidx19 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next20
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next20
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %8, %for.end35 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv25
