...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %a) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %b) #5
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %c) #5
  br label %for.cond
...
if.then32:                                        ; preds = %if.else
  %call38 = call double @sqrt(double noundef %8) #5, !tbaa !5
  %add = fsub double %call38, %4
  %mul41 = fmul double %5, 2.000000e+00
  %div42 = fdiv double %add, %mul41
  %call50 = call double @sqrt(double noundef %8) #5, !tbaa !5
...
if.else62:                                        ; preds = %if.else
  ...
  %call75 = call double @sqrt(double noundef %fneg74) #5, !tbaa !5
...
for.end108:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %a) #5
