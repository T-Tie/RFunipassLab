...
for.cond3:                                        ; preds = %for.cond3.preheader, %if.end32
  %indvars.iv62 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next63, %if.end32 ]
  %indvars.iv34 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next35, %if.end32 ]
  %smax64 = call i64 @llvm.smax.i64(i64 %indvars.iv62, i64 noundef 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body10 ], [ 0, %for.cond3 ]
  %maxIndex.0 = phi i32 [ %spec.select, %for.body10 ], [ 0, %for.cond3 ]
  %exitcond65 = icmp eq i64 %indvars.iv31, %smax64
  br i1 %exitcond65, label %for.cond.cleanup9, label %for.body10

for.cond.cleanup9:                                ; preds = %for.cond7
  %3 = sub nsw i64 %1, %indvars.iv34
  %4 = trunc nsw i64 %3 to i32
  %cmp20.not = icmp eq i32 %maxIndex.0, %4
...
for.body10:                                       ; preds = %for.cond7
  ...
  %cmp15 = icmp sgt i32 %5, %6
  %7 = trunc nuw nsw i64 %indvars.iv31 to i32
  %spec.select = select i1 %cmp15, i32 %7, i32 %maxIndex.0
...
for.cond36:                                       ; preds = %for.cond36.preheader, %if.end48
  %indvars.iv39 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next40, %if.end48 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %if.end48 ]
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv49 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next50, %for.body56 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count54
  br i1 %exitcond55.not, label %if.end80, label %for.body56
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.body69
  %indvars.iv44 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next45, %for.body69 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end75, label %for.body69
