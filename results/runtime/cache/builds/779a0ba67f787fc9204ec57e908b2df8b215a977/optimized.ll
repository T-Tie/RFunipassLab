...
for.cond14:                                       ; preds = %sw.epilog, %if.then13
  ...
  %x.1 = phi i32 [ 0, %if.then13 ], [ %x.2, %sw.epilog ]
...
for.cond30:                                       ; preds = %sw.epilog39, %if.else29
  ...
  %x.4 = phi i32 [ 0, %if.else29 ], [ %x.5, %sw.epilog39 ]
...
if.end52:                                         ; preds = %for.end42, %for.end
...
if.end52.exitStub:                                ; preds = %if.else25, %if.then22
  ret void
}
