...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select51 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select51
  ...
  %or.cond52 = or i1 %cmp12, %or.cond
  %smax61 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond52, label %for.cond14, label %for.cond30
...
NodeBlock:                                        ; preds = %NodeBlock3
  ...
  %switch.selectcmp53 = icmp eq i32 %m.0, 2
  %switch.select54 = select i1 %switch.selectcmp53, i32 29, i32 %switch.select
  br label %for.inc
...
for.inc:                                          ; preds = %NodeBlock, %LeafBlock, %LeafBlock5, %LeafBlock7, %LeafBlock11, %LeafBlock13, %sw.default
  %.sink46 = phi i32 [ 30, %sw.default ], [ 31, %LeafBlock13 ], [ 31, %LeafBlock11 ], [ 31, %LeafBlock7 ], [ 31, %LeafBlock5 ], [ 31, %LeafBlock ], [ %switch.select54, %NodeBlock ]
  %add18 = add nuw nsw i32 %.sink46, %x.1
  %inc = add i32 %m.0, 1
...
for.inc40:                                        ; preds = %NodeBlock25, %LeafBlock21, %LeafBlock29, %LeafBlock31, %LeafBlock35, %LeafBlock37, %sw.default37
  %.sink45 = phi i32 [ 30, %sw.default37 ], [ 31, %LeafBlock37 ], [ 31, %LeafBlock35 ], [ 31, %LeafBlock31 ], [ 31, %LeafBlock29 ], [ 31, %LeafBlock21 ], [ %switch.select58, %NodeBlock25 ]
  %add36 = add nuw nsw i32 %.sink45, %x.2
  %inc41 = add i32 %m.1, 1
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.1.i = select i1 %cmp21.i, ptr @.str, ptr @.str.1
  %call23.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.1.i), !noalias !13
  %call24.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call23.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !noalias !13
