...
for.cond67:                                       ; preds = %for.inc82, %for.body66
  %.sink = phi i32 [ 0, %for.body66 ], [ %inc83, %for.inc82 ]
  %19 = load i32, ptr %y2, align 4, !tbaa !5
  %sub68 = sub nsw i32 %19, 1
  %cmp69 = icmp sle i32 %.sink, %sub68
  br i1 %cmp69, label %for.body70, label %for.inc86

for.body70:                                       ; preds = %for.cond67
  %cmp71 = icmp eq i32 %.sink, 0
  %idxprom72 = sext i32 %17 to i64
  %idxprom74 = sext i32 %.sink to i64
  %20 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom72
  %21 = getelementptr inbounds [101 x i32], ptr %20, i64 0, i64 %idxprom74
...
for.inc82:                                        ; preds = %if.else, %for.body70
  ...
  %call81 = call i32 (ptr, ...) @printf(ptr noundef %.str.2.sink, i32 noundef %22)
  %inc83 = add nsw i32 %.sink, 1
