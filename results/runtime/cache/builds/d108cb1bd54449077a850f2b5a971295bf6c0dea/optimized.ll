...
entry:
  ...
  br i1 %cmp, label %for.cond.preheader, label %for.end31
...
for.cond2:                                        ; preds = %for.body5, %for.cond
  ...
  %min.0 = phi i32 [ %spec.select, %for.body5 ], [ %0, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body5

for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc25 ], [ 0, %for.end ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond7.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv3
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc24 ], [ 0, %for.end ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond7.not, label %if.end27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx21 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv3
...
for.cond15.preheader:                             ; preds = %entry
  ...
  br i1 %cmp16, label %for.cond15.preheader3, label %for.end39

for.cond15.preheader3:                            ; preds = %for.cond15.preheader
  %sub21 = add i32 %k, -1
  %smax = tail call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond15

for.cond1:                                        ; preds = %for.cond, %for.inc
  %indvars.iv5 = phi i64 [ 0, %for.cond ], [ %indvars.iv.next6, %for.inc ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count8
  br i1 %exitcond9.not, label %for.cond, label %for.inc

for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @a, i64 808), i64 0, i64 %indvars.iv5
  %1 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx10 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @a, i64 404), i64 0, i64 %indvars.iv5
  store i32 %1, ptr %arrayidx10, align 4, !tbaa !5
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  br label %for.cond1, !llvm.loop !15

for.cond15:                                       ; preds = %for.cond20, %for.cond15.preheader3
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond15, %for.inc34
  %indvars.iv = phi i64 [ 0, %for.cond15 ], [ %indvars.iv.next, %for.inc34 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond15, label %for.inc34

for.inc34:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv
  %arrayidx28 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 8
  %2 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %arrayidx33 = getelementptr inbounds nuw i8, ptr %arrayidx26, i64 4
  store i32 %2, ptr %arrayidx33, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond20, !llvm.loop !16

for.end39:                                        ; preds = %for.cond15.preheader
  ret void
}
...
while.cond:                                       ; preds = %for.end18, %entry
  ...
  %vtable = load ptr, ptr %call1, align 8, !tbaa !17
...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre7 = phi i32 [ %.pre79, %for.inc10 ], [ %.pre, %while.body ]
  %0 = phi i32 [ %2, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc10 ], [ 0, %while.body ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv3, %1
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre79 = phi i32 [ %.pre78, %for.inc ], [ %.pre7, %for.cond ]
  %2 = phi i32 [ %6, %for.inc ], [ %.pre7, %for.cond ]
...
for.body6:                                        ; preds = %for.cond3
  %4 = or i64 %indvars.iv, %indvars.iv3
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre78 = phi i32 [ %.pre79, %for.body6 ], [ %.pre6, %if.then ]
  %6 = phi i32 [ %2, %for.body6 ], [ %.pre6, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
