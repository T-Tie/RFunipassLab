...
for.end21:                                        ; preds = %for.cond11
  ...
  %call.i9 = call i32 @getc(ptr noundef %5)
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv9 = phi i64 [ %idxprom7, %for.cond2.preheader ], [ %indvars.iv.next10, %for.inc13 ]
  %indvars.iv.next10 = add nsw i64 %indvars.iv9, 1
  %cmp3 = icmp slt i64 %indvars.iv.next10, %0
  br i1 %cmp3, label %for.body4, label %for.end15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv.next10
  %1 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !18
  %2 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !18
  %cmp9.not = icmp sgt i32 %1, %2
  br i1 %cmp9.not, label %for.inc13, label %if.then10

if.then10:                                        ; preds = %for.body4
  %3 = trunc nsw i64 %indvars.iv.next10 to i32
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %3, i32 noundef %m) #8
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next10
...
for.cond20:                                       ; preds = %for.body22, %for.end15
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body22 ], [ %idxprom7, %for.end15 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ %4, %for.end15 ]
  %indvars.iv.next13 = add nsw i64 %indvars.iv12, 1
  %cmp21 = icmp slt i64 %indvars.iv.next13, %0
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next13
