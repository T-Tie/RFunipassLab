...
for.cond6:                                        ; preds = %for.cond3, %for.inc27
  ...
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc27 ], [ 0, %for.cond3 ]
  %i.1 = phi i32 [ %i.2, %for.inc27 ], [ %i.0, %for.cond3 ]
  %5 = sext i32 %i.1 to i64
  %cmp7 = icmp slt i64 %indvars.iv27, %5
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv27
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv24 = phi i64 [ %5, %for.cond15.preheader ], [ %indvars.iv.next25, %for.inc23 ]
...
for.inc23:                                        ; preds = %for.cond15
  ...
  %arrayidx20 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv.next25
  %8 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !12
  %arrayidx22 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv24
...
for.cond33:                                       ; preds = %for.cond3, %for.body35
  ...
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body35 ], [ 0, %for.cond3 ]
  %11 = sext i32 %10 to i64
  %cmp34 = icmp slt i64 %indvars.iv30, %11
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %10, -1
  %12 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv30, %12
  %spec.select = select i1 %cmp36, ptr @.str, ptr @.str.1
  %arrayidx42 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv30
