...
for.body15:                                       ; preds = %for.cond13
  call void @_Z7zerorowi(i32 noundef %4) #7
  %5 = load i32, ptr @k, align 4, !tbaa !5
  call void @_Z7zerocoli(i32 noundef %5) #7
  %6 = load i32, ptr getelementptr inbounds ([101 x i32], ptr getelementptr inbounds ([101 x [101 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 8, !tbaa !5
  ...
  call void @_Z4jiani(i32 noundef %8) #7
  br label %for.inc17
...
for.end18:                                        ; preds = %for.cond13
  ...
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
