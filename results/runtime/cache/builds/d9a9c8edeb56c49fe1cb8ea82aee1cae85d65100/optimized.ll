...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 501, ptr noundef nonnull align 16 %s) #7
  call void @llvm.lifetime.start.p0(i64 noundef 2505, ptr noundef nonnull align 16 %a) #7
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef -1)
  %1 = add i32 %smax44, 1
...
for.cond49:                                       ; preds = %land.end
  %exitcond61 = icmp eq i64 0, %wide.trip.count45
