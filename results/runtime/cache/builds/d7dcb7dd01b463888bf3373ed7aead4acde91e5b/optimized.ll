...
for.cond2:                                        ; preds = %for.inc28, %for.end
  %j.0 = phi i32 [ 0, %for.end ], [ %inc29, %for.inc28 ]
  %sub = sub nsw i32 %0, 1
...
for.cond5:                                        ; preds = %for.inc25, %for.body4
  %i.1 = phi i32 [ 0, %for.body4 ], [ %add, %for.inc25 ]
  %j.0.neg = sub i32 0, %j.0
  %sub6 = add i32 %0, -1
  %sub7 = add i32 %sub6, %j.0.neg
  %cmp8 = icmp slt i32 %i.1, %sub7
...
for.body9:                                        ; preds = %for.cond5
  ...
  %1 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !12
...
for.end30:                                        ; preds = %for.cond2
  ...
  %call33 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %3, i32 noundef %4)
