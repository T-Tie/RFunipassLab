...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  %num.1 = phi i32 [ 0, %if.end.thread ], [ %num.0, %if.then9 ], [ %num.0, %if.end ]
  %blank.1 = phi i32 [ 0, %if.end.thread ], [ %blank.0, %if.then9 ], [ %blank.0, %if.end ]
  ...
  %conv16 = sext i32 %blank.1 to i64
  %add17 = add i64 %conv16, %call15
  %conv18 = sext i32 %num.1 to i64
