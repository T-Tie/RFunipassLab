...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr nonnull %js) #5
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  ...
  br i1 %cmp8.not, label %for.cond.cleanup9, label %for.body10
...
for.inc33:                                        ; preds = %for.cond.cleanup9, %if.then21
...
for.cond54.preheader:                             ; preds = %for.end51
  %12 = load i32, ptr %js, align 16
  br label %for.cond54

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %i.2 = phi i32 [ 1, %for.body56 ], [ 0, %for.cond54.preheader ]
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.body69
  %indvars.iv45 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next46, %for.body69 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count48
  br i1 %exitcond49.not, label %for.end75, label %for.body69
...
for.end75:                                        ; preds = %for.cond66
  %arrayidx78 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %wide.trip.count48
...
if.end80:                                         ; preds = %for.cond54, %for.end75
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %js) #5
