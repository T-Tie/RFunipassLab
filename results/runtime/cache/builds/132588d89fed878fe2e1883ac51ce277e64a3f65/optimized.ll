...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull %sum) #5
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull %efficient) #5
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %efficient) #5
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %sum) #5
