...
for.body:                                         ; preds = %for.cond
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
  br i1 %or.cond4, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %n1.0 = phi i32 [ %n1.1, %for.inc ], [ 0, %for.body ]
  %j.0 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %exitcond15.not = icmp eq i32 %j.0, %smax14
  br i1 %exitcond15.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %4 = load i32, ptr %m2, align 4, !tbaa !5
  %smax16 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond30
...
if.then11:                                        ; preds = %for.body9
  %add = add nsw i32 %n1.0, 29
  br label %for.inc

if.else27:                                        ; preds = %for.body9
  br label %if.end

if.end:                                           ; preds = %for.body9, %for.body9, %for.body9, %for.body9, %for.body9, %for.body9, %for.body9, %if.else27
  %.sink3 = phi i32 [ 30, %if.else27 ], [ 31, %for.body9 ], [ 31, %for.body9 ], [ 31, %for.body9 ], [ 31, %for.body9 ], [ 31, %for.body9 ], [ 31, %for.body9 ], [ 31, %for.body9 ]
  %add28 = add nsw i32 %.sink3, %n1.0
  br label %for.inc

for.inc:                                          ; preds = %if.then11, %if.end
  %n1.1 = phi i32 [ %add, %if.then11 ], [ %add28, %if.end ]
  %inc = add nuw i32 %j.0, 1
  br label %for.cond7, !llvm.loop !9

for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  %n2.0 = phi i32 [ %n2.1, %for.inc56 ], [ 0, %for.cond30.preheader ]
  %j.1 = phi i32 [ %inc57, %for.inc56 ], [ 1, %for.cond30.preheader ]
  %exitcond17.not = icmp eq i32 %j.1, %smax16
  br i1 %exitcond17.not, label %for.end58, label %for.body32
...
for.body32:                                       ; preds = %for.cond30
  switch i32 %j.1, label %if.else52 [
    ...
    i32 5, label %if.end54
    i32 7, label %if.end54
...
if.then34:                                        ; preds = %for.body32
  %add35 = add nsw i32 %n2.0, 29
  br label %for.inc56

if.else52:                                        ; preds = %for.body32
  br label %if.end54

if.end54:                                         ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %if.else52
  %.sink2 = phi i32 [ 30, %if.else52 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add53 = add nsw i32 %.sink2, %n2.0
  br label %for.inc56

for.inc56:                                        ; preds = %if.then34, %if.end54
  %n2.1 = phi i32 [ %add35, %if.then34 ], [ %add53, %if.end54 ]
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts9 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.5.str.4) #6
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  %n182.0 = phi i32 [ %n182.1, %for.inc109 ], [ 0, %for.body ]
  %j81.0 = phi i32 [ %inc110, %for.inc109 ], [ 1, %for.body ]
  %exitcond.not = icmp eq i32 %j81.0, %smax14
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax12 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
...
for.body87:                                       ; preds = %for.cond85
  switch i32 %j81.0, label %if.else105 [
    ...
    i32 8, label %if.end107
    i32 10, label %if.end107
  ]

if.then89:                                        ; preds = %for.body87
  %add90 = add nsw i32 %n182.0, 28
  br label %for.inc109

if.else105:                                       ; preds = %for.body87
  br label %if.end107

if.end107:                                        ; preds = %for.body87, %for.body87, %for.body87, %for.body87, %for.body87, %for.body87, %if.else105
  %.sink1 = phi i32 [ 30, %if.else105 ], [ 31, %for.body87 ], [ 31, %for.body87 ], [ 31, %for.body87 ], [ 31, %for.body87 ], [ 31, %for.body87 ], [ 31, %for.body87 ]
  %add106 = add nsw i32 %.sink1, %n182.0
  br label %for.inc109

for.inc109:                                       ; preds = %if.then89, %if.end107
  %n182.1 = phi i32 [ %add90, %if.then89 ], [ %add106, %if.end107 ]
  %inc110 = add nuw i32 %j81.0, 1
  br label %for.cond85, !llvm.loop !13

for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  %n283.0 = phi i32 [ %n283.1, %for.inc138 ], [ 0, %for.cond112.preheader ]
  %j81.1 = phi i32 [ %inc139, %for.inc138 ], [ 1, %for.cond112.preheader ]
  %exitcond13.not = icmp eq i32 %j81.1, %smax12
  br i1 %exitcond13.not, label %for.end140, label %for.body114

for.body114:                                      ; preds = %for.cond112
  switch i32 %j81.1, label %if.else134 [
    i32 2, label %if.then116
    i32 1, label %if.end136
    i32 3, label %if.end136
    i32 5, label %if.end136
    i32 7, label %if.end136
    i32 8, label %if.end136
    i32 10, label %if.end136
    i32 12, label %if.end136
  ]

if.then116:                                       ; preds = %for.body114
  %add117 = add nsw i32 %n283.0, 28
  br label %for.inc138

if.else134:                                       ; preds = %for.body114
  br label %if.end136

if.end136:                                        ; preds = %for.body114, %for.body114, %for.body114, %for.body114, %for.body114, %for.body114, %for.body114, %if.else134
  %.sink = phi i32 [ 30, %if.else134 ], [ 31, %for.body114 ], [ 31, %for.body114 ], [ 31, %for.body114 ], [ 31, %for.body114 ], [ 31, %for.body114 ], [ 31, %for.body114 ], [ 31, %for.body114 ]
  %add135 = add nsw i32 %.sink, %n283.0
  br label %for.inc138

for.inc138:                                       ; preds = %if.then116, %if.end136
  %n283.1 = phi i32 [ %add117, %if.then116 ], [ %add135, %if.end136 ]
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts5 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts11 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.7.sink) #6
  br label %for.inc164
