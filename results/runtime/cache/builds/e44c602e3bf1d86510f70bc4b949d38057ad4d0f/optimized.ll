...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv19 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next20, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, 2
  br i1 %exitcond.not, label %for.end26, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %2 = trunc nuw nsw i64 %indvars.iv19 to i32
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.body7
  %indvars.iv21 = phi i64 [ %indvars.iv19, %for.cond5.preheader ], [ %indvars.iv.next22, %for.body7 ]
  %index.0 = phi i32 [ %2, %for.cond5.preheader ], [ %spec.select, %for.body7 ]
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %cmp6 = icmp slt i64 %indvars.iv.next22, %1
  br i1 %cmp6, label %for.body7, label %for.inc24

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next22
  ...
  %5 = trunc nuw nsw i64 %indvars.iv.next22 to i32
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv19
