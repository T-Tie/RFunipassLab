...
for.body5:                                        ; preds = %for.cond3
  ...
  %.pre66 = load i32, ptr %y1, align 4, !tbaa !5
  br label %for.cond3, !llvm.loop !9

for.end:                                          ; preds = %for.cond3
  %inc9 = add nuw nsw i32 %i.0, 1
  %.pre63 = load i32, ptr %x1, align 4, !tbaa !5
...
for.cond16:                                       ; preds = %for.end29, %for.end10
  %7 = phi i32 [ %6, %for.end10 ], [ %9, %for.end29 ]
  %8 = phi i32 [ %5, %for.end10 ], [ %.pre64, %for.end29 ]
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc31, %for.end29 ]
  %cmp17 = icmp slt i32 %i.1, %8
  br i1 %cmp17, label %for.cond19, label %for.end32

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %9 = phi i32 [ %.pre65, %for.body21 ], [ %7, %for.cond16 ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax41 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
  %13 = sext i32 %11 to i64
  %smax49 = call i32 @llvm.smax.i32(i32 %10, i32 noundef 0)
...
for.cond37:                                       ; preds = %for.end73, %for.end32
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.end73 ], [ 0, %for.end32 ]
  %exitcond51.not = icmp eq i64 %indvars.iv44, %wide.trip.count50
  br i1 %exitcond51.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %14 = mul nsw i64 %indvars.iv44, %12
  %15 = mul nsw i64 %indvars.iv44, %13
  %16 = getelementptr i32, ptr %call36, i64 %14
  %17 = getelementptr i32, ptr %call2, i64 %15
  br label %for.cond40

for.cond40:                                       ; preds = %for.cond40.preheader, %for.end70
  %indvars.iv37 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next38, %for.end70 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %for.end73, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %16, i64 %indvars.iv37
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv37
  br label %for.cond47

for.cond47:                                       ; preds = %for.body49, %for.body42
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body49 ], [ 0, %for.body42 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end70, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx57 = getelementptr i32, ptr %17, i64 %indvars.iv
  %18 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !15
  %19 = mul nsw i64 %indvars.iv, %12
  %gep = getelementptr i32, ptr %invariant.gep, i64 %19
  %20 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !15
...
for.cond77:                                       ; preds = %for.cond37, %for.end97
  %21 = phi i32 [ %23, %for.end97 ], [ %7, %for.cond37 ]
  %22 = phi i32 [ %.pre, %for.end97 ], [ %10, %for.cond37 ]
  %i.3 = phi i32 [ %inc99, %for.end97 ], [ 0, %for.cond37 ]
  %cmp78 = icmp slt i32 %i.3, %22
  br i1 %cmp78, label %for.cond80, label %for.end100

for.cond80:                                       ; preds = %for.cond77, %if.end94
  %23 = phi i32 [ %.pre52, %if.end94 ], [ %21, %for.cond77 ]
  %j.3 = phi i32 [ %inc96, %if.end94 ], [ 0, %for.cond77 ]
...
for.body82:                                       ; preds = %for.cond80
  ...
  %24 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !15
  %call87 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %24) #9
...
if.then:                                          ; preds = %for.body82
  ...
  %.pre55 = add nsw i32 %.pre53, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre55, %if.then ], [ %sub, %for.body82 ]
  %26 = phi i32 [ %.pre53, %if.then ], [ %25, %for.body82 ]
  %cmp91 = icmp eq i32 %j.3, %sub90.pre-phi
  br i1 %cmp91, label %if.then92, label %if.end94

if.then92:                                        ; preds = %if.end
  %putchar32 = call i32 @putchar(i32 noundef 10) #9
  %.pre52.pre = load i32, ptr %y2, align 4, !tbaa !5
  br label %if.end94

if.end94:                                         ; preds = %if.then92, %if.end
  %.pre52 = phi i32 [ %.pre52.pre, %if.then92 ], [ %26, %if.end ]
