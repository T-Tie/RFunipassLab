...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 25000, ptr nonnull %word) #7
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %l) #7
...
if.then6.i:                                       ; preds = %for.body
  ...
  %3 = load i64, ptr %gep46, align 8, !tbaa !11
...
while.cond:                                       ; preds = %while.body, %for.body4
  ...
  %7 = load i8, ptr %q.0, align 1, !tbaa !34
...
if.then33:                                        ; preds = %land.lhs.true, %if.end
  ...
  %12 = load i64, ptr %gep47, align 8, !tbaa !11
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread61
  ...
  %call.i.i2 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx26) #7
...
for.end49:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 2000, ptr nonnull %l) #7
  call void @llvm.lifetime.end.p0(i64 25000, ptr nonnull %word) #7
