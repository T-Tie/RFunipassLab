...
if.end127.sink.split45:                           ; preds = %if.end63, %lor.lhs.false83, %entry, %if.end113
  %.str.3.sink = phi ptr [ @.str.3, %if.end113 ], [ @.str.4, %entry ], [ @.str.4, %lor.lhs.false83 ], [ @.str.4, %if.end63 ]
