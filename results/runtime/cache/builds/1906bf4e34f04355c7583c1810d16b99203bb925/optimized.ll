...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv18 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next19, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv18
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv26.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv26, %for.cond17 ]
  %indvars.iv26 = add i32 %indvars.iv26.in, -1
  %cmp15 = icmp sgt i32 %indvars.iv26.in, 0
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv22 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next23, %for.inc37 ]
...
for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv22
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next23
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv30, %8
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv30
