...
for.cond23:                                       ; preds = %for.inc33, %for.end22
  %j.2 = phi i32 [ %i.1, %for.end22 ], [ %inc34, %for.inc33 ]
  %cmp24 = icmp slt i32 %j.2, %0
...
for.cond36:                                       ; preds = %for.inc46, %for.end35
  %i.2 = phi i32 [ %i.1, %for.end35 ], [ %inc47, %for.inc46 ]
  %cmp37 = icmp slt i32 %i.2, %0
...
for.body38:                                       ; preds = %for.cond36
  ...
  %4 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !13
...
for.end48:                                        ; preds = %for.body38, %for.cond36
  %sub = add i32 %i.1.neg, -2
  %sub50 = add i32 %sub, %j.2
  %sub49 = add i32 %i.1.neg, -2
  %sub51 = add i32 %sub49, %i.2
  %mul = mul nsw i32 %sub51, %sub50
  %call52 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %mul)
