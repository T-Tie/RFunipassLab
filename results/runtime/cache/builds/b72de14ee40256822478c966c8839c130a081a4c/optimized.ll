...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax11 = tail call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %smax18 = tail call i32 @llvm.smax.i32(i32 %1, i32 2)
...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre8 = phi i32 [ %.pre810, %for.inc10 ], [ %.pre, %while.body ]
  %0 = phi i32 [ %2, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc10 ], [ 0, %while.body ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv4, %1
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre810 = phi i32 [ %.pre89, %for.inc ], [ %.pre8, %for.cond ]
  %2 = phi i32 [ %6, %for.inc ], [ %.pre8, %for.cond ]
...
for.body6:                                        ; preds = %for.cond3
  %4 = or i64 %indvars.iv, %indvars.iv4
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre89 = phi i32 [ %.pre810, %for.body6 ], [ %.pre7, %if.then ]
  %6 = phi i32 [ %2, %for.body6 ], [ %.pre7, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
