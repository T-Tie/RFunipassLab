...
for.inc26:                                        ; preds = %land.lhs.true, %for.cond6.preheader, %if.else23
  %.str.2.sink = phi ptr [ @.str, %if.else23 ], [ @.str.2, %for.cond6.preheader ], [ @.str.3, %land.lhs.true ]
  %call16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2.sink, i32 noundef 0) #8
