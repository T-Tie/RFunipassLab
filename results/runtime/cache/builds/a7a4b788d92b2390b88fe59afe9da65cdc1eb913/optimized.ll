...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %j.0.sink5 = phi i32 [ %j.0, %if.then30 ], [ %add35, %for.inc44 ]
  %_ZSt4cout.sink4 = phi ptr [ @_ZSt4cout, %if.then30 ], [ %call39, %for.inc44 ]
  %j.0.sink1 = phi i32 [ %j.0, %if.then30 ], [ %add35, %for.inc44 ]
  %idxprom31 = sext i32 %j.0.sink5 to i64
  %arrayidx32 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom31
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink4, ptr noundef %arrayidx32)
