...
for.cond.preheader:                               ; preds = %entry
  %wide.trip.count7 = zext nneg i32 %k to i64
  br label %for.cond
...
for.cond15.preheader:                             ; preds = %entry
  ...
  br i1 %cmp16, label %for.cond15.preheader2, label %for.end39

for.cond15.preheader2:                            ; preds = %for.cond15.preheader
  %sub21 = add i32 %k, -1
  %smax = call i32 @llvm.smax.i32(i32 noundef %sub21, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond15

for.cond1:                                        ; preds = %for.cond, %for.inc
  %indvars.iv4 = phi i64 [ 0, %for.cond ], [ %indvars.iv.next5, %for.inc ]
  %exitcond8.not = icmp eq i64 %indvars.iv4, %wide.trip.count7
  br i1 %exitcond8.not, label %for.cond, label %for.inc

for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @a, i64 808), i64 0, i64 %indvars.iv4
  %1 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx10 = getelementptr inbounds nuw [101 x i32], ptr getelementptr inbounds nuw (i8, ptr @a, i64 404), i64 0, i64 %indvars.iv4
  store i32 %1, ptr %arrayidx10, align 4, !tbaa !5
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  br label %for.cond1, !llvm.loop !15

for.cond15:                                       ; preds = %for.cond20, %for.cond15.preheader2
  br label %for.cond20
...
for.cond:                                         ; preds = %for.inc10, %while.body
  ...
  %0 = sext i32 %.pre7 to i64
  %cmp = icmp slt i64 %indvars.iv3, %0
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %storemerge = phi i32 [ %dec, %for.inc17 ], [ %.pre7, %for.cond ]
