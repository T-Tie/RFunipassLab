...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  ...
  %add34 = add nuw nsw i32 %x.4, %.sink52
  %inc41 = add i32 %m.1, 1
  br label %for.cond30, !llvm.loop !12

for.end42:                                        ; preds = %for.cond30
  %rem43 = urem i32 %x.4, 7
  %cmp44 = icmp eq i32 %rem43, 0
  br i1 %cmp44, label %if.then45, label %if.else48

if.then45:                                        ; preds = %for.end42
  %call1.i5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 3)
  br label %for.inc53
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !15, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !34, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !40, !invariant.load !13
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !41, !invariant.load !13
