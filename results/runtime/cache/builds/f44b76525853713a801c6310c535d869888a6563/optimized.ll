...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc49
  ...
  %10 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51, i64 %indvars.iv29
...
for.end61.loopexit:                               ; preds = %for.body40
  %12 = trunc nsw i64 %indvars.iv29 to i32
  br label %for.end61

for.end61:                                        ; preds = %for.end50, %for.cond34, %for.end61.loopexit
  %x2.1 = phi i32 [ %9, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %y2.1 = phi i32 [ %12, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %13 = xor i32 %y1.1, -1
  %sub63 = add i32 %y2.1, %13
  %14 = xor i32 %x1.1, -1
  %sub66 = add i32 %x2.1, %14
