...
for.cond14:                                       ; preds = %for.cond11, %if.end33
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %if.end33 ], [ 0, %for.cond11 ]
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.body41
  %indvars.iv27 = phi i64 [ 1, %for.cond39.preheader ], [ %indvars.iv.next28, %for.body41 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end47, label %for.body41
...
for.body41:                                       ; preds = %for.cond39
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %6) #6
...
for.end47:                                        ; preds = %for.cond39
  ...
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7) #6
