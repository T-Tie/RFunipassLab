...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %or.cond44 = select i1 %call16.i21, i1 %or.cond.i25, i1 false
  br i1 %or.cond44, label %if.then19.i26, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond50.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv46
  %6 = load i8, ptr %arrayidx54, align 1, !tbaa !22
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv46
