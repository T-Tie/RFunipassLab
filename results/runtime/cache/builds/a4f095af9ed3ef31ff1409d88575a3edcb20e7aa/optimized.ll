...
for.cond2:                                        ; preds = %for.end17, %for.end
  %i.0 = phi i32 [ 0, %for.end ], [ %inc18, %for.end17 ]
  %q.0 = phi ptr [ %t, %for.end ], [ %incdec.ptr20, %for.end17 ]
  %f.0 = phi i32 [ 0, %for.end ], [ %f.1, %for.end17 ]
...
for.cond6:                                        ; preds = %if.end, %for.body4
  %p.0 = phi ptr [ %s, %for.body4 ], [ %incdec.ptr, %if.end ]
  %f.1 = phi i32 [ %f.0, %for.body4 ], [ %f.2, %if.end ]
...
for.cond23:                                       ; preds = %if.end36, %for.end21
  %j.0 = phi i32 [ 0, %for.end21 ], [ %inc37, %if.end36 ]
  %q.1 = phi ptr [ %t, %for.end21 ], [ %incdec.ptr39, %if.end36 ]
...
if.then30:                                        ; preds = %for.body26
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv24, i32 noundef %4) #7
