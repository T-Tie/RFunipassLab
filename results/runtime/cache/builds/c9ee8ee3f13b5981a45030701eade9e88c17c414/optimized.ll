...
if.else83:                                        ; preds = %lor.lhs.false
  ...
  %5 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom86
  %6 = getelementptr inbounds [100 x i32], ptr %5, i64 0, i64 %idxprom88
...
if.then97:                                        ; preds = %if.else95
  ...
  %arrayidx106 = getelementptr inbounds [100 x i32], ptr %arrayidx104, i64 0, i64 %idxprom88
