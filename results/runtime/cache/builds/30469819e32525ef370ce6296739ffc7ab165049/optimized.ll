...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 %s0) #6
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull %s1) #6
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(10000) %s1, i8 noundef 0, i64 noundef 10000, i1 noundef false) #7
  ...
  %call6 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %s1, ptr noundef nonnull dereferenceable(1) %s) #9
  br label %for.cond
...
for.end:                                          ; preds = %for.cond9
  ...
  %strlen10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s1)
  %endptr11 = getelementptr inbounds i8, ptr %s1, i64 %strlen10
  br i1 %cmp23, label %if.end, label %if.then32

if.end:                                           ; preds = %for.end
  store i16 32, ptr %endptr11, align 1
  %call30 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %s1, ptr noundef nonnull dereferenceable(1) %s0) #9
  br label %for.inc44

if.then32:                                        ; preds = %for.end
  store i16 10, ptr %endptr11, align 1
  %call39 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %s1, ptr noundef nonnull dereferenceable(1) %s0) #9
...
for.end46:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %s1) #9
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %s0) #9
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %s) #9
