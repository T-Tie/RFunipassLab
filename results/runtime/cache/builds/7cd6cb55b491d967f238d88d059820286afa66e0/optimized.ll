...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc10 ], [ 0, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax105 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %smax81 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
