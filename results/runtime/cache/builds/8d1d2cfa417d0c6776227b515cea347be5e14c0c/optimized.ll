...
for.end10:                                        ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %x2) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %y2) #5
...
for.end88:                                        ; preds = %for.cond63
  %19 = load ptr, ptr @stdin, align 8, !tbaa !21
  %call.i = call i32 @getc(ptr noundef %19)
  %20 = load ptr, ptr @stdin, align 8, !tbaa !21
  %call.i1 = call i32 @getc(ptr noundef %20)
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef nonnull %c) #5
