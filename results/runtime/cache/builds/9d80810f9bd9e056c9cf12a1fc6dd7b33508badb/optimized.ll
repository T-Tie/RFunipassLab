...
for.cond:                                         ; preds = %for.inc5, %entry
  ...
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc5 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv29, %1
  br i1 %cmp, label %for.cond1.preheader, label %for.cond8.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv29
  br label %for.cond1
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %3 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre57, %for.inc ]
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  %indvars.iv36 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next37, %for.inc25 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %2
  br i1 %exitcond41.not, label %for.end27, label %for.cond11

for.cond11:                                       ; preds = %for.cond8, %for.inc19
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc19 ], [ 0, %for.cond8 ]
  %exitcond.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond.not, label %for.inc25, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv36, i64 %indvars.iv32
...
for.end27.loopexit:                               ; preds = %for.body13
  ...
  %.pre56 = and i64 %indvars.iv36, 4294967295
  br label %for.end27

for.end27:                                        ; preds = %for.cond8, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre56, %for.end27.loopexit ], [ %2, %for.cond8 ]
  %i.127 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.cond8 ]
  %y1.0 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.cond8 ]
  %8 = sext i32 %y1.0 to i64
  %smax45 = call i32 @llvm.smax.i32(i32 %y1.0, i32 %0)
  %wide.trip.count47 = sext i32 %smax45 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body30, %for.end27
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body30 ], [ %8, %for.end27 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end42, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %indvars.iv.next43 = add nsw i64 %indvars.iv42, 1
  %arrayidx34 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %idxprom31.pre-phi, i64 %indvars.iv.next43
  %9 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !15
  %cmp35 = icmp ne i32 %9, 0
  %cmp37 = icmp sge i64 %indvars.iv.next43, %1
...
for.end42.split.loop.exit:                        ; preds = %for.body30
  %10 = trunc nsw i64 %indvars.iv42 to i32
  br label %for.end42

for.end42:                                        ; preds = %for.cond28, %for.end42.split.loop.exit
  %i.2.lcssa = phi i32 [ %10, %for.end42.split.loop.exit ], [ %smax45, %for.cond28 ]
  %smax52 = call i32 @llvm.smax.i32(i32 %i.127, i32 %0)
  %wide.trip.count54 = zext i32 %smax52 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.body45, %for.end42
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.body45 ], [ %idxprom31.pre-phi, %for.end42 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count54
  br i1 %exitcond55.not, label %for.end59, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %arrayidx50 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next50, i64 %8
  ...
  %or.cond19 = or i1 %cmp54, %cmp51
  br i1 %or.cond19, label %for.end59.split.loop.exit, label %for.cond43, !llvm.loop !17
...
for.end59:                                        ; preds = %for.cond43, %for.end59.split.loop.exit
  %i.3.lcssa = phi i32 [ %13, %for.end59.split.loop.exit ], [ %smax52, %for.cond43 ]
  %sub = sub nsw i32 %i.3.lcssa, %i.127
