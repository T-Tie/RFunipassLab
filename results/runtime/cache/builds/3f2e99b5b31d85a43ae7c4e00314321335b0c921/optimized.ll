...
for.cond:                                         ; preds = %for.inc21, %entry
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc21 ], [ 2, %entry ]
  %indvars.iv = phi i32 [ %indvars.iv.next, %for.inc21 ], [ 1, %entry ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %2 = sext i32 %1 to i64
  %cmp.not = icmp sgt i64 %indvars.iv11, %2
  br i1 %cmp.not, label %for.end22, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [20002 x i32], ptr %a, i64 0, i64 %indvars.iv11
