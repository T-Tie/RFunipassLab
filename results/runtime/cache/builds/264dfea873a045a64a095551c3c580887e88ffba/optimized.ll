...
for.body27:                                       ; preds = %for.cond25
  ...
  %3 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !13
...
for.inc65:                                        ; preds = %for.body54, %if.else60
  %.str.3.sink = phi ptr [ @.str.3, %if.else60 ], [ @.str.2, %for.body54 ]
  %call63 = call i32 (ptr, ...) @printf(ptr noundef %.str.3.sink, i32 noundef %5)
