...
LeafBlock13:                                      ; preds = %while.cond
  %SwitchLeaf14 = icmp eq i64 %0, 0
  %vbase.offset9.i.pre15 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !5
  br i1 %SwitchLeaf14, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %while.cond
...
do.end.i:                                         ; preds = %LeafBlock13
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i.pre15
...
if.then6.i:                                       ; preds = %LeafBlock.if.then6.i_crit_edge, %LeafBlock13
  %vbase.offset9.i = phi i64 [ %vbase.offset9.i.pre, %LeafBlock.if.then6.i_crit_edge ], [ %vbase.offset9.i.pre15, %LeafBlock13 ]
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv11, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.body, %while.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body ], [ 0, %while.end ]
