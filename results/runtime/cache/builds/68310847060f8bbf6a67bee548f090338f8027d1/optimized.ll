...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.end ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv25, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.end27, %for.end10
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.end27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv31, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv28, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.end27

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv31, i64 %indvars.iv28
...
for.end30:                                        ; preds = %for.cond12
  ...
  %10 = add i32 %smax, 1
  %smax41 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %smax47 = call i32 @llvm.smax.i32(i32 %8, i32 0)
...
for.cond31:                                       ; preds = %for.end59, %for.end30
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.end59 ], [ 0, %for.end30 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %for.cond63, label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.inc57
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc57 ], [ 0, %for.cond31 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %wide.trip.count42
  br i1 %exitcond43.not, label %for.end59, label %for.cond39

for.cond39:                                       ; preds = %for.cond35, %for.body41
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body41 ], [ 0, %for.cond35 ]
...
for.body41:                                       ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv34
  %11 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !13
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv34, i64 %indvars.iv38
...
for.inc57:                                        ; preds = %for.cond39
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv44, i64 %indvars.iv38
...
for.cond63:                                       ; preds = %for.cond31, %for.end84
  ...
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.end84 ], [ 0, %for.cond31 ]
  %14 = sext i32 %13 to i64
  %cmp65.not.not = icmp slt i64 %indvars.iv54, %14
...
for.cond67.preheader:                             ; preds = %for.cond63
  ...
  br i1 %cmp69.not.not.peel, label %for.body70.peel, label %for.end84

for.body70.peel:                                  ; preds = %for.cond67.preheader
  %arrayidx80.peel = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv54, i64 0
  %16 = load i32, ptr %arrayidx80.peel, align 4, !tbaa !5, !invariant.load !13
  %call81.peel = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %16) #7
  br label %for.cond67

for.cond67:                                       ; preds = %for.body70.peel, %for.body70
  %indvars.iv50 = phi i64 [ 1, %for.body70.peel ], [ %indvars.iv.next51, %for.body70 ]
  %17 = load i32, ptr %y2, align 4, !tbaa !5
  %18 = sext i32 %17 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv50, %18
  br i1 %cmp69.not.not, label %for.body70, label %for.end84

for.body70:                                       ; preds = %for.cond67
  %arrayidx80 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv54, i64 %indvars.iv50
  %19 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !13
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %19) #7
...
for.end88:                                        ; preds = %for.cond63
  %call89 = call i32 @getchar() #7
  %call90 = call i32 @getchar() #7
