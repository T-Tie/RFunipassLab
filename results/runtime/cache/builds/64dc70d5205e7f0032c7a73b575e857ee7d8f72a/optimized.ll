...
for.cond:                                         ; preds = %for.inc5, %entry
  ...
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc5 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv53, %1
  br i1 %cmp, label %for.cond1.preheader, label %for.cond8.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv53
  br label %for.cond1
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %3 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre81, %for.inc ]
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  %indvars.iv60 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next61, %for.inc25 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %2
  br i1 %exitcond65.not, label %for.end27, label %for.cond11

for.cond11:                                       ; preds = %for.cond8, %for.inc19
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc19 ], [ 0, %for.cond8 ]
  %exitcond.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond.not, label %for.inc25, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv60, i64 %indvars.iv56
...
for.end27.loopexit:                               ; preds = %for.body13
  ...
  %.pre80 = and i64 %indvars.iv60, 4294967295
  br label %for.end27

for.end27:                                        ; preds = %for.cond8, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre80, %for.end27.loopexit ], [ %2, %for.cond8 ]
  %i.151 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.cond8 ]
  %y1.0 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.cond8 ]
  %8 = sext i32 %y1.0 to i64
  %smax69 = call i32 @llvm.smax.i32(i32 %y1.0, i32 %0)
  %wide.trip.count71 = sext i32 %smax69 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body30, %for.end27
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.body30 ], [ %8, %for.end27 ]
  %exitcond72.not = icmp eq i64 %indvars.iv66, %wide.trip.count71
  br i1 %exitcond72.not, label %for.end42, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %indvars.iv.next67 = add nsw i64 %indvars.iv66, 1
  %arrayidx34 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %idxprom31.pre-phi, i64 %indvars.iv.next67
  %9 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !15
  %cmp35 = icmp ne i32 %9, 0
  %cmp37 = icmp sge i64 %indvars.iv.next67, %1
...
for.end42.split.loop.exit:                        ; preds = %for.body30
  %10 = trunc nsw i64 %indvars.iv66 to i32
  br label %for.end42

for.end42:                                        ; preds = %for.cond28, %for.end42.split.loop.exit
  %i.2.lcssa = phi i32 [ %10, %for.end42.split.loop.exit ], [ %smax69, %for.cond28 ]
  %smax76 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %i.151, i32 %0)
  %wide.trip.count78 = zext i32 %smax76 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.body45, %for.end42
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body45 ], [ %idxprom31.pre-phi, %for.end42 ]
  %exitcond79.not = icmp eq i64 %indvars.iv73, %wide.trip.count78
  br i1 %exitcond79.not, label %for.end59, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %arrayidx50 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next74, i64 %8
  %11 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !15
  %cmp51 = icmp ne i32 %11, 0
  %12 = trunc nuw i64 %indvars.iv.next74 to i32
  %cmp54 = icmp sle i32 %0, %12
  %or.cond43 = or i1 %cmp54, %cmp51
  br i1 %or.cond43, label %for.end59.split.loop.exit, label %for.cond43, !llvm.loop !17
...
for.end59:                                        ; preds = %for.cond43, %for.end59.split.loop.exit
  %i.3.lcssa = phi i32 [ %13, %for.end59.split.loop.exit ], [ %smax76, %for.cond43 ]
  %sub = sub nsw i32 %i.3.lcssa, %i.151
