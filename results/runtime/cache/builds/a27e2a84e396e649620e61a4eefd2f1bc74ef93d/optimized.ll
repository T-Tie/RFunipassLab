...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call15 = call double @sqrt(double noundef %5) #5, !tbaa !5
  %add = fsub double %call15, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call21 = call double @sqrt(double noundef %5) #5, !tbaa !5
...
if.then30:                                        ; preds = %if.else
  %call36 = call double @sqrt(double noundef %5) #5, !tbaa !5
  %add37 = fsub double %call36, %1
  %mul38 = fmul double %2, 2.000000e+00
  %div39 = fdiv double %add37, %mul38
  %call45 = call double @sqrt(double noundef %5) #5, !tbaa !5
