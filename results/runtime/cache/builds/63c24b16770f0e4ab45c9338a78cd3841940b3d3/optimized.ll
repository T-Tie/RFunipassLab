...
end3:                                             ; preds = %for.end21, %entry
  br label %for.cond

for.cond:                                         ; preds = %for.cond, %end3
  ...
  switch i32 %0, label %for.cond [
    i32 -1, label %end1
    i32 0, label %for.end21
  ]

for.end21:                                        ; preds = %for.cond
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
