...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv13, %2
  br i1 %cmp2, label %for.cond4, label %while.cond.preheader

while.cond.preheader:                             ; preds = %for.cond1
  %smax83 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv13, i64 %indvars.iv
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end176
  %indvars.iv20 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next21, %for.end176 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.end176 ]
  %p.0 = phi i32 [ 0, %while.cond.preheader ], [ %inc177, %for.end176 ]
  %exitcond84.not = icmp eq i32 %p.0, %smax83
  br i1 %exitcond84.not, label %for.inc179, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %while.cond
  %smax79 = call i32 @llvm.smax.i32(i32 %indvars.iv20, i32 noundef 0)
  %wide.trip.count25 = zext nneg i32 %smax79 to i64
  %wide.trip.count = zext i32 %indvars.iv20 to i64
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  %indvars.iv22 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next23, %for.inc42 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond45.preheader, label %for.body16

for.cond45.preheader:                             ; preds = %for.cond14
  %wide.trip.count30 = zext i32 %indvars.iv20 to i64
  br label %for.cond45

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22
  %5 = load i32, ptr %arrayidx18, align 16, !tbaa !5
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv22
...
for.cond22:                                       ; preds = %for.body25, %for.body16
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body25 ], [ 0, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv16
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc67
  %indvars.iv32 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next33, %for.inc67 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count25
  br i1 %exitcond37.not, label %for.cond70.preheader, label %for.cond49.preheader

for.cond70.preheader:                             ; preds = %for.cond45
  %wide.trip.count41 = zext i32 %indvars.iv20 to i64
  br label %for.cond70

for.cond49.preheader:                             ; preds = %for.cond45
  %arrayidx58 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv32
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  %indvars.iv27 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next28, %for.inc64 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count30
  br i1 %exitcond31.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond49
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv27
...
for.cond70:                                       ; preds = %for.cond70.preheader, %for.inc101
  %indvars.iv43 = phi i64 [ 0, %for.cond70.preheader ], [ %indvars.iv.next44, %for.inc101 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count25
  br i1 %exitcond48.not, label %for.cond104.preheader, label %for.body73

for.cond104.preheader:                            ; preds = %for.cond70
  %wide.trip.count52 = zext i32 %indvars.iv20 to i64
  br label %for.cond104

for.body73:                                       ; preds = %for.cond70
  %arrayidx76 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv43
  %10 = load i32, ptr %arrayidx76, align 4, !tbaa !5
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv43
  store i32 %10, ptr %arrayidx78, align 4, !tbaa !5
  br label %for.cond79

for.cond79:                                       ; preds = %for.body82, %for.body73
  %11 = phi i32 [ %spec.store.select11, %for.body82 ], [ %10, %for.body73 ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body82 ], [ 0, %for.body73 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count41
  br i1 %exitcond42.not, label %for.inc101, label %for.body82

for.body82:                                       ; preds = %for.cond79
  %arrayidx88 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv43
  %12 = load i32, ptr %arrayidx88, align 4, !tbaa !5
  %spec.store.select11 = call i32 @llvm.smin.i32(i32 %11, i32 %12)
  store i32 %spec.store.select11, ptr %arrayidx78, align 4
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  %indvars.iv54 = phi i64 [ 0, %for.cond104.preheader ], [ %indvars.iv.next55, %for.inc126 ]
  %exitcond59.not = icmp eq i64 %indvars.iv54, %wide.trip.count25
  br i1 %exitcond59.not, label %for.end128, label %for.cond108

for.cond108:                                      ; preds = %for.cond104, %for.inc123
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc123 ], [ 0, %for.cond104 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %wide.trip.count52
  br i1 %exitcond53.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond108
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv49
  %13 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx117 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv49
...
for.end128:                                       ; preds = %for.cond104
  ...
  %wide.trip.count63 = zext i32 %indvars.iv20 to i64
  br label %for.cond131

for.cond131:                                      ; preds = %for.inc151, %for.end128
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc151 ], [ 0, %for.end128 ]
  %exitcond70.not = icmp eq i64 %indvars.iv65, %wide.trip.count25
  br i1 %exitcond70.not, label %for.cond154.preheader, label %for.cond135

for.cond154.preheader:                            ; preds = %for.cond131
  %wide.trip.count74 = zext i32 %indvars.iv20 to i64
  br label %for.cond154

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond64.not = icmp eq i64 %indvars.iv60, %wide.trip.count63
  br i1 %exitcond64.not, label %for.inc151, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %indvars.iv.next61
  %16 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !21
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %indvars.iv60
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  %indvars.iv76 = phi i64 [ 0, %for.cond154.preheader ], [ %indvars.iv.next77, %for.inc174 ]
  %exitcond81.not = icmp eq i64 %indvars.iv76, %wide.trip.count25
  br i1 %exitcond81.not, label %for.end176, label %for.cond158

for.cond158:                                      ; preds = %for.cond154, %for.inc171
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc171 ], [ 1, %for.cond154 ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %wide.trip.count74
  br i1 %exitcond75.not, label %for.inc174, label %for.inc171

for.inc171:                                       ; preds = %for.cond158
  %indvars.iv.next72 = add nuw nsw i64 %indvars.iv71, 1
  %arrayidx166 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next72, i64 %indvars.iv76
  %17 = load i32, ptr %arrayidx166, align 4, !tbaa !5, !invariant.load !21
  %arrayidx170 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv71, i64 %indvars.iv76
