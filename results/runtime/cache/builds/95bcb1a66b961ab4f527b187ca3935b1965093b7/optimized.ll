...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %sub4.sink = phi i32 [ %sub, %for.end ], [ %dec, %for.inc19 ]
  %cmp6 = icmp sgt i32 %sub4.sink, 0
  %sub21 = sub nsw i32 %sub4.sink, 1
...
for.body7:                                        ; preds = %for.cond5
  ...
  %idxprom11 = sext i32 %sub4.sink to i64
...
for.body24:                                       ; preds = %for.cond22
  %4 = load i32, ptr %arrayidx3, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond29
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  ...
  %cmp30 = icmp sgt i32 %m.0, %sub21.sink
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %idxprom32 = sext i32 %sub21.sink to i64
