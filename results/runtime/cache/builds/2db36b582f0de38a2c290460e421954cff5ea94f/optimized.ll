...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %4) #6, !tbaa !5
  %add = fadd double %fneg, %call5
  %mul = fmul double 2.000000e+00, %2
  %div = fdiv double %add, %mul
  %call7 = call double @sqrt(double noundef %4) #6, !tbaa !5
...
if.end:                                           ; preds = %if.then11, %if.then
  ...
  br i1 %cmp13, label %if.then14, label %if.end17thread-pre-split

if.then14:                                        ; preds = %if.end
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %div9)
  br label %if.end17thread-pre-split

if.end17thread-pre-split:                         ; preds = %if.then14, %if.end
  br label %if.end17

if.end17:                                         ; preds = %if.end17thread-pre-split, %for.body
...
if.then34:                                        ; preds = %if.then19
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %div26)
  br label %if.end36
...
if.then38:                                        ; preds = %if.end36
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, double noundef %div26)
  br label %if.end40
...
if.then43:                                        ; preds = %if.end40
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %div31)
  br label %if.end45
...
if.then47:                                        ; preds = %if.end45
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.8, double noundef %div31)
  br label %for.inc
