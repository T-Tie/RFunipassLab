...
if.else:                                          ; preds = %for.body
  ...
  %call57 = call double @sqrt(double noundef %8) #10, !tbaa !5
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i1 = call i32 @getc(ptr noundef %20) #11
  %21 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i2 = call i32 @getc(ptr noundef %21) #11
...
entry:
  ...
  %call = tail call i32 @getc(ptr noundef %0) #11
  ret i32 %call
}
