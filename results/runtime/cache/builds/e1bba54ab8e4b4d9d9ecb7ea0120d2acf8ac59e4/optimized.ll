...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %30) #5
  br label %if.end136
...
for.inc148:                                       ; preds = %for.cond137
  ...
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %32) #5
...
for.inc170:                                       ; preds = %for.cond158
  ...
  %call169 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %35) #5
