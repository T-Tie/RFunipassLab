...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv45 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next46, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv45
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv52 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next53, %for.inc44 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond58.not = icmp eq i32 %m.0, %smax57
  br i1 %exitcond58.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax54 = call i32 @llvm.smax.i32(i32 %indvars.iv52, i32 noundef 0)
  %wide.trip.count55 = zext nneg i32 %smax54 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count62 = zext nneg i32 %smax57 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv49 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next50, %for.inc41 ]
  %exitcond56.not = icmp eq i64 %indvars.iv49, %wide.trip.count55
  br i1 %exitcond56.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv49
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next50
  %5 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !13
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv59 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next60, %for.inc55 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count62
  br i1 %exitcond63.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv59
  ...
  %call54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call53, ptr noundef nonnull @.str)
