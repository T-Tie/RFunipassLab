...
tailrecurse:                                      ; preds = %for.end114, %entry
  ...
  %smax50 = call i32 @llvm.smax.i32(i32 %3, i32 0)
...
for.cond.preheader:                               ; preds = %tailrecurse
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %5, i32 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  ...
  br i1 %exitcond14.not, label %for.cond31.preheader, label %for.cond2

for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count18 = and i64 %indvars.iv55, 4294967295
  br label %for.cond31
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv25 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next26, %for.inc66 ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv20 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next21, %for.inc63 ]
...
for.cond71:                                       ; preds = %for.cond75, %for.end68
  %indvars.iv37 = phi i64 [ 1, %for.end68 ], [ %indvars.iv.next38, %for.cond75 ]
  %cmp73 = icmp slt i64 %indvars.iv37, %indvars.iv.next56
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc86
  %indvars.iv31 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next32, %for.inc86 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count13
  br i1 %exitcond36.not, label %for.cond71, label %for.inc86, !llvm.loop !17

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv.next38, i64 %indvars.iv31
