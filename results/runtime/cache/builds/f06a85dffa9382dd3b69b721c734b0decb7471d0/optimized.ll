...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40500, ptr noundef nonnull dereferenceable(40500) %word) #10
  call void @llvm.lifetime.start.p0(i64 noundef 40500, ptr noundef nonnull align 16 %text) #10
...
for.cond2:                                        ; preds = %for.cond2, %for.cond2.preheader
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond2 ], [ 80, %for.cond2.preheader ]
  %arrayidx6 = getelementptr inbounds [500 x [81 x i8]], ptr %word, i64 0, i64 %idxprom3, i64 %indvars.iv36
  %4 = load i8, ptr %arrayidx6, align 1, !tbaa !24, !invariant.load !9
  %cmp7 = icmp eq i8 %4, 0
  %indvars.iv.next37 = add nsw i64 %indvars.iv36, -1
  br i1 %cmp7, label %for.cond2, label %for.cond11, !llvm.loop !25

for.cond11:                                       ; preds = %for.cond2, %for.inc25
  %5 = phi i8 [ %.pre, %for.inc25 ], [ %4, %for.cond2 ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc25 ], [ %indvars.iv36, %for.cond2 ]
  %cmp18 = icmp eq i8 %5, 32
  br i1 %cmp18, label %for.inc25, label %for.cond28

for.inc25:                                        ; preds = %for.cond11
  %arrayidx16 = getelementptr inbounds [500 x [81 x i8]], ptr %word, i64 0, i64 %idxprom3, i64 %indvars.iv39
  store i8 0, ptr %arrayidx16, align 1, !tbaa !24
  %indvars.iv.next40 = add nsw i64 %indvars.iv39, -1
  %arrayidx16.phi.trans.insert = getelementptr inbounds [500 x [81 x i8]], ptr %word, i64 0, i64 %idxprom3, i64 %indvars.iv.next40
  %.pre = load i8, ptr %arrayidx16.phi.trans.insert, align 1, !tbaa !24, !invariant.load !9
  br label %for.cond11, !llvm.loop !26

for.cond28:                                       ; preds = %for.cond11, %for.inc41
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc41 ], [ 0, %for.cond11 ]
  %exitcond48.not = icmp eq i64 %indvars.iv45, 500
  br i1 %exitcond48.not, label %for.cond44, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.inc38
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc38 ], [ 0, %for.cond28 ]
  %exitcond.not = icmp eq i64 %indvars.iv42, 81
  br i1 %exitcond.not, label %for.inc41, label %for.inc38

for.inc38:                                        ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [500 x [81 x i8]], ptr %text, i64 0, i64 %indvars.iv45, i64 %indvars.iv42
  store i8 0, ptr %arrayidx37, align 1, !tbaa !24
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  br label %for.cond31, !llvm.loop !27
...
for.body46:                                       ; preds = %for.cond44
  ...
  %call50 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx48) #12
...
if.then:                                          ; preds = %for.body46
  ...
  %call66 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx61, ptr noundef nonnull dereferenceable(1) %arrayidx48) #11
  %cmp67.not = icmp eq i64 %add, 80
  %.pre52.pre = load i32, ptr %n, align 4, !tbaa !5
  br i1 %cmp67.not, label %for.inc93, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.then
  %sub68 = add nsw i32 %.pre52.pre, -1
...
if.then70:                                        ; preds = %land.lhs.true
  ...
  store i8 32, ptr %arrayidx74, align 1, !tbaa !24
...
if.else:                                          ; preds = %for.body46
  ...
  %arrayidx80 = getelementptr inbounds [500 x [81 x i8]], ptr %text, i64 0, i64 %idxprom60, i64 %idxprom79
  %6 = load i8, ptr %arrayidx80, align 1, !tbaa !24
  %cmp82 = icmp eq i8 %6, 32
  br i1 %cmp82, label %if.then83, label %if.end89

if.then83:                                        ; preds = %if.else
  store i8 0, ptr %arrayidx80, align 1, !tbaa !24
  br label %if.end89
...
for.inc93:                                        ; preds = %if.end89, %if.then70, %land.lhs.true, %if.then
  %.pre52 = phi i32 [ %.pre5253, %if.end89 ], [ %.pre52.pre, %if.then70 ], [ %.pre52.pre, %land.lhs.true ], [ %.pre52.pre, %if.then ]
...
for.cond96:                                       ; preds = %for.cond44, %for.inc108
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc108 ], [ 0, %for.cond44 ]
  %arrayidx98 = getelementptr inbounds nuw [500 x [81 x i8]], ptr %text, i64 0, i64 %indvars.iv49
  %7 = load i8, ptr %arrayidx98, align 1, !tbaa !24
  %cmp101.not = icmp eq i8 %7, 0
  br i1 %cmp101.not, label %for.end110, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %call106 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx98)
  %call107 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call106, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  br label %for.cond96, !llvm.loop !30

for.end110:                                       ; preds = %for.cond96
  call void @llvm.lifetime.end.p0(i64 40500, ptr nonnull %text) #11
  call void @llvm.lifetime.end.p0(i64 40500, ptr nonnull %word) #11
