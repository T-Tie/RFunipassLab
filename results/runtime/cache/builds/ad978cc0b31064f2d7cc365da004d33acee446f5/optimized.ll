...
while.cond1:                                      ; preds = %while.cond1.preheader, %while.body4
  %.pr6 = phi i32 [ %0, %while.body4 ], [ %.pr5, %while.cond1.preheader ]
...
while.cond8:                                      ; preds = %while.cond8.preheader, %while.body13
  %.pr7 = phi i32 [ %1, %while.body13 ], [ %.pr6, %while.cond8.preheader ]
  %c.0 = phi i32 [ %inc14, %while.body13 ], [ 0, %while.cond8.preheader ]
  %1 = add i32 %.pr7, -20
  %or.cond20 = icmp ult i32 %1, 30
  br i1 %or.cond20, label %while.body13, label %while.cond17.preheader
...
while.cond17:                                     ; preds = %while.cond17.preheader, %while.body22
  %.pr8 = phi i32 [ %2, %while.body22 ], [ %.pr7, %while.cond17.preheader ]
  %d.0 = phi i32 [ %inc23, %while.body22 ], [ 0, %while.cond17.preheader ]
  %2 = add i32 %.pr8, -10
  %or.cond21 = icmp ult i32 %2, 10
  br i1 %or.cond21, label %while.body22, label %land.end30.preheader
...
land.end30:                                       ; preds = %land.end30.preheader, %while.body31
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr8, %land.end30.preheader ]
