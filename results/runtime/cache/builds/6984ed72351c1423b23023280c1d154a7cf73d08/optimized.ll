...
NodeBlock:                                        ; preds = %for.inc
  ...
  br i1 %Pivot, label %LeafBlock, label %LeafBlock23

LeafBlock23:                                      ; preds = %NodeBlock
  %SwitchLeaf24 = icmp eq i64 %2, 0
  br i1 %SwitchLeaf24, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i64 %2, -1
  br i1 %SwitchLeaf, label %if.else34.i, label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock23
...
if.then6.i:                                       ; preds = %LeafBlock23, %LeafBlock
