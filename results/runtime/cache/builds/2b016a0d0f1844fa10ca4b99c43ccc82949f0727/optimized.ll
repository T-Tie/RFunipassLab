...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax52 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
lor.lhs.false.thread:                             ; preds = %for.body75
  ...
  switch i32 %8, label %for.inc122.gvnsink.split [
    i32 1, label %for.inc122
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %9 = load i32, ptr %arrayidx101, align 4, !tbaa !5
...
for.inc122.gvnsink.split:                         ; preds = %lor.lhs.false.thread, %land.lhs.true
  %indvars.iv47.sink = phi i64 [ %indvars.iv47, %land.lhs.true ], [ %6, %lor.lhs.false.thread ]
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv40
  %10 = load i32, ptr %arrayidx89, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv40, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47.sink, i64 %11
