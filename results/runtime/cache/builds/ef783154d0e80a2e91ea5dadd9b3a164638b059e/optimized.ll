...
for.cond10:                                       ; preds = %for.end27, %for.end9
  %n3.0 = phi i32 [ undef, %for.end9 ], [ %n3.1, %for.end27 ]
  %n2.0 = phi i32 [ -1, %for.end9 ], [ %n2.1, %for.end27 ]
  %n1.0 = phi i32 [ -1, %for.end9 ], [ %n1.1, %for.end27 ]
  %i.1 = phi i32 [ 0, %for.end9 ], [ %inc29, %for.end27 ]
  %n4.0 = phi i32 [ undef, %for.end9 ], [ %n4.1, %for.end27 ]
