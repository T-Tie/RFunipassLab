...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %0 = phi i32 [ %.pr, %entry ], [ %sub, %while.body ]
...
while.cond1:                                      ; preds = %while.cond1.preheader, %while.body4
  %.pr3.pr = phi i32 [ %1, %while.body4 ], [ %0, %while.cond1.preheader ]
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %.pr4.pr = phi i32 [ %2, %while.body13 ], [ %.pr3.pr, %while.end7 ]
  %c.0 = phi i32 [ %inc14, %while.body13 ], [ 0, %while.end7 ]
  %2 = add i32 %.pr4.pr, -20
  %or.cond6 = icmp ult i32 %2, 30
  br i1 %or.cond6, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %.pr5.pr = phi i32 [ %3, %while.body22 ], [ %.pr4.pr, %while.end16 ]
  %d.0 = phi i32 [ %inc23, %while.body22 ], [ 0, %while.end16 ]
  %3 = add i32 %.pr5.pr, -10
  %or.cond7 = icmp ult i32 %3, 10
  br i1 %or.cond7, label %while.body22, label %while.end25
...
while.cond26:                                     ; preds = %while.body31, %while.end25
  %.pr5 = phi i32 [ %4, %while.body31 ], [ %.pr5.pr, %while.end25 ]
  %e.0 = phi i32 [ %inc32, %while.body31 ], [ 0, %while.end25 ]
  %4 = add i32 %.pr5, -5
  %or.cond8 = icmp ult i32 %4, 5
  br i1 %or.cond8, label %while.body31, label %while.cond35
...
while.cond35:                                     ; preds = %while.cond26
  %5 = add i32 %.pr5, -1
  %or.cond9 = icmp ult i32 %5, 4
  %f.0 = select i1 %or.cond9, i32 %.pr5, i32 0
