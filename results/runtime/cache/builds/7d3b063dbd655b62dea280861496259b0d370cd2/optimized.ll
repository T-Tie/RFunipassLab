...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv3 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next4, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax11 = call i32 @llvm.smax.i32(i32 %t.0, i32 noundef 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv3
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond15 = icmp eq i32 %q.0, %4
  br i1 %exitcond15, label %for.cond52.preheader, label %for.cond25
...
for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond13.not = icmp eq i64 %indvars.iv7, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv7
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next8
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv16 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next17, %for.body54 ]
  %exitcond22 = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv16, %7
  %spec.select1 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %arrayidx62 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv16
  %11 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select1, i32 noundef %11) #6
