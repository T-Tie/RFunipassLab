...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv4 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next5, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv4, 2
  br i1 %exitcond.not, label %for.end26, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body7
  %indvars.iv6 = phi i64 [ %indvars.iv4, %for.cond5.preheader ], [ %indvars.iv.next7, %for.body7 ]
  %index.0 = phi i32 [ %2, %for.cond5.preheader ], [ %spec.select, %for.body7 ]
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %cmp6 = icmp slt i64 %indvars.iv.next7, %1
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next7
  ...
  %6 = trunc nuw nsw i64 %indvars.iv.next7 to i32
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv4
  %7 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !12
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %8, i32 noundef %9) #5
