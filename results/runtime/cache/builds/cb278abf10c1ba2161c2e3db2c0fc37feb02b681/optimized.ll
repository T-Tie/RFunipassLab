...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50000, ptr nonnull %word) #5
...
for.body5:                                        ; preds = %for.cond3
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx7) #5
  ...
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #6
...
if.then:                                          ; preds = %for.body5
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  br label %for.inc40
...
for.inc40:                                        ; preds = %if.then, %if.then33
  %sum.1 = phi i64 [ %add10, %if.then ], [ 0, %if.then33 ]
...
for.end42:                                        ; preds = %for.cond3
  ...
  %call.i.i17 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx45) #5
  %call1.i18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx45, i64 noundef %call.i.i17)
  %vtable.i23 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !12
  ...
  call void @llvm.lifetime.end.p0(i64 50000, ptr nonnull %word) #5
  ret i32 0
}
