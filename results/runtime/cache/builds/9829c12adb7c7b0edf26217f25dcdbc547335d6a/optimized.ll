...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 %str) #4
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef nonnull align 16 %b) #4
  br label %while.cond
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count16 = zext nneg i32 %smax to i64
  br label %for.cond15

for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv6
  %1 = load i8, ptr %arrayidx4, align 1, !tbaa !10, !invariant.load !14
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %3 = load i8, ptr %arrayidx8, align 1, !tbaa !10, !invariant.load !14
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %4 = trunc nuw nsw i64 %indvars.iv6 to i32
  store i32 %4, ptr %arrayidx12, align 4, !tbaa !15
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc35
  %indvars.iv18 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next19, %for.inc35 ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond23.not, label %for.end37, label %for.cond18

for.cond18:                                       ; preds = %for.cond15, %for.body20
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body20 ], [ 0, %for.cond15 ]
  %sum.0 = phi i32 [ %add, %for.body20 ], [ 0, %for.cond15 ]
  %exitcond17.not = icmp eq i64 %indvars.iv12, %wide.trip.count16
  br i1 %exitcond17.not, label %for.end28, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100000 x i32], ptr %b, i64 0, i64 %indvars.iv12
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !15, !invariant.load !14
  %6 = zext i32 %5 to i64
  %cmp23.not = icmp eq i64 %indvars.iv18, %6
...
if.then30:                                        ; preds = %for.end28
  %arrayidx32 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv18
  %7 = load i8, ptr %arrayidx32, align 1, !tbaa !10, !invariant.load !14
  ...
  %8 = load i64, ptr %gep, align 8, !tbaa !19, !invariant.load !14
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef nonnull %b) #5
...
!19 = !{!20, !21, i64 16}
!20 = !{!"_ZTSSt8ios_base", !21, i64 8, !21, i64 16, !22, i64 24, !23, i64 28, !23, i64 32, !24, i64 40, !25, i64 48, !8, i64 64, !16, i64 192, !26, i64 200, !27, i64 208}
!21 = !{!"long", !8, i64 0}
