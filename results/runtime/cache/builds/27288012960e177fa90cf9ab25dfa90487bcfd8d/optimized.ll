...
for.cond:                                         ; preds = %if.end28, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc30, %if.end28 ]
...
if.then15:                                        ; preds = %for.cond.cleanup4
  br label %for.cond17

for.cond17:                                       ; preds = %for.body20, %if.then15
  %j16.0 = phi i32 [ 0, %if.then15 ], [ %inc26, %for.body20 ]
  %cmp18 = icmp slt i32 %j16.0, %k
  br i1 %cmp18, label %for.body20, label %if.end28
...
for.cond:                                         ; preds = %if.end27, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc29, %if.end27 ]
  %cmp = icmp slt i32 %i.0, %k
...
if.then14:                                        ; preds = %for.cond.cleanup3
  br label %for.cond16

for.cond16:                                       ; preds = %for.body19, %if.then14
  %j15.0 = phi i32 [ 0, %if.then14 ], [ %inc25, %for.body19 ]
  %cmp17 = icmp slt i32 %j15.0, %k
  br i1 %cmp17, label %for.body19, label %if.end27
...
for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  %i.0 = phi i32 [ 2, %entry ], [ %inc12, %for.cond.cleanup3 ]
  %cmp = icmp slt i32 %i.0, %k
...
for.cond15:                                       ; preds = %for.cond.cleanup23, %for.end13
  %j14.0 = phi i32 [ 2, %for.end13 ], [ %inc38, %for.cond.cleanup23 ]
...
for.cond20:                                       ; preds = %for.body24, %for.body18
  %i19.0 = phi i32 [ 0, %for.body18 ], [ %inc35, %for.body24 ]
...
for.cond:                                         ; preds = %for.cond.cleanup5, %while.body
  %i.0 = phi i32 [ 0, %while.body ], [ %inc11, %for.cond.cleanup5 ]
...
for.cond13:                                       ; preds = %for.body15, %for.cond.cleanup
  %2 = phi i32 [ %dec, %for.body15 ], [ %0, %for.cond.cleanup ]
  %cmp14 = icmp sgt i32 %2, 1
  br i1 %cmp14, label %for.body15, label %for.end18

for.body15:                                       ; preds = %for.cond13
  call void @_Z7zerorowi(i32 noundef %2) #9
  %3 = load i32, ptr @k, align 4, !tbaa !5
  call void @_Z7zerocoli(i32 noundef %3) #9
  ...
  call void @_Z4jiani(i32 noundef %6) #9
...
entry:
  ...
  %call2 = call noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef 1, i32 noundef 4) #9
  %call3 = call noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %call, i32 noundef %call2) #9
