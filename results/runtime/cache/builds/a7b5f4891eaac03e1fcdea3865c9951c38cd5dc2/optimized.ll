...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp.not.not, label %for.body, label %for.cond74.preheader
...
for.cond74:                                       ; preds = %for.cond74.preheader, %for.inc132
  %9 = phi i32 [ %.pre, %for.inc132 ], [ %0, %for.cond74.preheader ]
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc132 ], [ 0, %for.cond74.preheader ]
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i1 = call i32 @getc(ptr noundef %19)
  %20 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i2 = call i32 @getc(ptr noundef %20)
