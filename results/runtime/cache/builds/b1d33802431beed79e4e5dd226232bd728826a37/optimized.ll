...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %a) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %b) #11
...
for.inc25:                                        ; preds = %if.then, %if.else21, %if.then18
  %.str.2.sink = phi ptr [ @.str.2, %if.else21 ], [ @.str.1, %if.then18 ], [ @.str, %if.then ]
