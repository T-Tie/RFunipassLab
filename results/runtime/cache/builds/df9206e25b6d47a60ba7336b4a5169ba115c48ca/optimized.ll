...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef align 16 %a) #6
...
for.cond:                                         ; preds = %if.end, %entry
  %max1.0 = phi i32 [ 0, %entry ], [ %max1.1, %if.end ]
...
if.end:                                           ; preds = %if.then, %for.body
  %max1.1 = phi i32 [ %1, %if.then ], [ %max1.0, %for.body ]
...
for.cond7:                                        ; preds = %if.end20, %for.end
  %max2.0 = phi i32 [ 0, %for.end ], [ %max2.1, %if.end20 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %inc21, %if.end20 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %cmp12 = icmp sge i32 %2, %max2.0
  %conv = zext i1 %cmp12 to i32
  %sub = sub nsw i32 %max1.0, 1
...
if.end20:                                         ; preds = %if.then17, %for.body9
  %max2.1 = phi i32 [ %2, %if.then17 ], [ %max2.0, %for.body9 ]
...
for.end22:                                        ; preds = %for.cond7
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %a) #7
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !14, !invariant.load !9
