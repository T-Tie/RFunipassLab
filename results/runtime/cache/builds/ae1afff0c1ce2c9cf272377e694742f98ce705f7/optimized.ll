...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load float, ptr %y, align 4, !tbaa !9
  %3 = load float, ptr %x, align 4, !tbaa !9
  %div = fdiv float %2, %3
  %4 = load float, ptr %y1, align 4, !tbaa !9
  %5 = load float, ptr %x1, align 4, !tbaa !9
  %div3 = fdiv float %4, %5
...
if.then:                                          ; preds = %for.body
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #5
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %6 = load float, ptr %y, align 4, !tbaa !9
  %7 = load float, ptr %x, align 4, !tbaa !9
  %div7 = fdiv float %6, %7
  %8 = load float, ptr %y1, align 4, !tbaa !9
  %9 = load float, ptr %x1, align 4, !tbaa !9
  %div8 = fdiv float %8, %9
...
if.then12:                                        ; preds = %if.end
  %call13 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #5
  br label %if.end14

if.end14:                                         ; preds = %if.then12, %if.end
  %10 = load float, ptr %y, align 4, !tbaa !9
  %11 = load float, ptr %x, align 4, !tbaa !9
  %div15 = fdiv float %10, %11
  %12 = load float, ptr %y1, align 4, !tbaa !9
  %13 = load float, ptr %x1, align 4, !tbaa !9
  %div16 = fdiv float %12, %13
...
if.then25:                                        ; preds = %land.lhs.true
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.4) #5
  br label %for.inc
