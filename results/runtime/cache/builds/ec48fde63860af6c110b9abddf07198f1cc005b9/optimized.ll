...
for.end35:                                        ; preds = %for.cond23, %for.end35.split.loop.exit
  %j.2.lcssa = phi i32 [ %7, %for.end35.split.loop.exit ], [ %smax41, %for.cond23 ]
  br label %for.cond36
...
for.end48:                                        ; preds = %for.cond36, %for.end48.split.loop.exit
  %i.2.lcssa = phi i32 [ %9, %for.end48.split.loop.exit ], [ %smax41, %for.cond36 ]
  %reass.sub78 = add i32 %j.1.lcssa.neg, -2
  %sub50 = add i32 %reass.sub78, %j.2.lcssa
  %reass.sub79 = add i32 %j.1.lcssa.neg, -2
  %sub51 = add i32 %reass.sub79, %i.2.lcssa
