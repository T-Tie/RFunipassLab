...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call10 = call double @sqrt(double noundef %4) #11, !tbaa !5
  ...
  %mul15 = fmul double 4.000000e+00, %6
  ...
  %call18 = call double @sqrt(double noundef %8) #11, !tbaa !5
  %sub = fsub double %fneg13, %call18
  %mul19 = fmul double 2.000000e+00, %6
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %mul24 = fmul double 4.000000e+00, %10
...
if.then28:                                        ; preds = %if.end
  ...
  %mul30 = fmul double 2.000000e+00, %10
...
if.end34:                                         ; preds = %if.then28, %if.end
  ...
  %mul36 = fmul double 4.000000e+00, %14
...
if.then42:                                        ; preds = %if.then40
  %call47 = call double @sqrt(double noundef %17) #11, !tbaa !5
  %mul48 = fmul double 2.000000e+00, %14
  ...
  %mul52 = fmul double 4.000000e+00, %18
  ...
  %call56 = call double @sqrt(double noundef %21) #11, !tbaa !5
  %mul57 = fmul double 2.000000e+00, %18
...
if.else:                                          ; preds = %if.then40
  ...
  %mul62 = fmul double 2.000000e+00, %14
  %div63 = fdiv double %fneg61, %mul62
  %call68 = call double @sqrt(double noundef %17) #11, !tbaa !5
  ...
  %mul74 = fmul double 2.000000e+00, %23
  %div75 = fdiv double %fneg73, %mul74
  %mul76 = fmul double 4.000000e+00, %23
  ...
  %call80 = call double @sqrt(double noundef %25) #11, !tbaa !5
