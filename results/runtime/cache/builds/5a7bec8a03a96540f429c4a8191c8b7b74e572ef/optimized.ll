...
for.cond:                                         ; preds = %while.cond, %for.inc22
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc22 ], [ 2, %while.cond ]
  %count.0 = phi i32 [ %count.1, %for.inc22 ], [ 0, %while.cond ]
  %arrayidx2 = getelementptr inbounds nuw [25 x i32], ptr %n, i64 0, i64 %indvars.iv11
...
for.body9:                                        ; preds = %for.cond7
  ...
  %count.2 = add nsw i32 %inc, %count.1
