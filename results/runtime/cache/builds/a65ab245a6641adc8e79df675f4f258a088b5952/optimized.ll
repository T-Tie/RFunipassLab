...
for.inc8:                                         ; preds = %for.cond2
  %call5 = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %i.1, i32 noundef %0) #6
...
if.then10:                                        ; preds = %for.body4
  %call = call noundef i32 @_Z2ljPiii(ptr nofree noundef readonly captures(none) %a, i32 noundef %add, i32 noundef %m) #7
