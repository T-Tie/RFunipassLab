...
for.end39:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %x1) #6
  store i32 0, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %x2) #6
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, i32 noundef %m1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x1, i32 noundef %y) #8
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, i32 noundef %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x2, i32 noundef %y) #8
...
if.end46:                                         ; preds = %if.else44, %if.then42
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %x2) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %x1) #9
  ret void
}
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, i32 noundef %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2, i32 noundef %3) unnamed_addr #5 {
entry_to_outline:
  store i32 1, ptr %0, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry_to_outline
  %4 = phi i32 [ %inc, %for.inc ], [ 1, %entry_to_outline ]
...
if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %3) #10
  %tobool = icmp ne i32 %call, 0
  br i1 %tobool, label %if.end11, label %if.else
...
if.end11:                                         ; preds = %if.then8, %if.else
  ...
  %sub10 = sub nsw i32 %6, %.sink2
  store i32 %sub10, ptr %2, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %if.end, %if.end11, %if.end.thread
  %inc = add nsw i32 %4, 1
