...
for.cond13:                                       ; preds = %for.inc21, %for.body12
  ...
  br i1 %cmp14, label %for.body15, label %for.end23thread-pre-split
...
for.end23thread-pre-split:                        ; preds = %for.cond13
  %.pr = load i32, ptr %x1, align 4, !tbaa !5
  br label %for.end23

for.end23:                                        ; preds = %for.end23thread-pre-split, %if.then
  %7 = phi i32 [ %.pr, %for.end23thread-pre-split ], [ %5, %if.then ]
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %.sink = phi i32 [ %1, %for.end29 ], [ %dec49, %for.inc48 ]
  %8 = phi i32 [ %dec49, %for.inc48 ], [ %1, %for.end29 ]
...
for.cond33:                                       ; preds = %for.inc43, %for.body32
  %.sink2 = phi i32 [ %1, %for.body32 ], [ %dec, %for.inc43 ]
  %9 = phi i32 [ %dec, %for.inc43 ], [ %1, %for.body32 ]
  store i32 %.sink2, ptr %j, align 4, !tbaa !5
  %cmp34 = icmp sge i32 %9, 1
  br i1 %cmp34, label %for.body35, label %for.end44thread-pre-split
...
for.body35:                                       ; preds = %for.cond33
  ...
  %12 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !15
  %cmp40 = icmp eq i32 %12, 0
  br i1 %cmp40, label %if.then41, label %for.inc43

if.then41:                                        ; preds = %for.body35
  store i32 %10, ptr %y2, align 4, !tbaa !5
  store i32 %11, ptr %x2, align 4, !tbaa !5
  br label %for.end44
...
for.end44thread-pre-split:                        ; preds = %for.cond33
  %.pr1 = load i32, ptr %x2, align 4, !tbaa !5
  br label %for.end44

for.end44:                                        ; preds = %for.end44thread-pre-split, %if.then41
  %13 = phi i32 [ %.pr1, %for.end44thread-pre-split ], [ %11, %if.then41 ]
  %cmp45 = icmp ne i32 %13, 0
  br i1 %cmp45, label %for.end50, label %for.inc48

for.inc48:                                        ; preds = %for.end44
  %14 = load i32, ptr %i, align 4, !tbaa !5
  %dec49 = add nsw i32 %14, -1
