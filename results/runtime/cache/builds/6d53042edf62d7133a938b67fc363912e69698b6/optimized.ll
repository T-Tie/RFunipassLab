...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef nonnull %words) #6
  br label %for.cond
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc55
  %2 = phi i32 [ %.pre, %for.inc55 ], [ %0, %for.cond2.preheader ]
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %for.inc55 ], [ 0, %for.cond2.preheader ]
  %csum.0 = phi i64 [ %csum.1, %for.inc55 ], [ 0, %for.cond2.preheader ]
  %j.0 = phi i32 [ %j.2, %for.inc55 ], [ 0, %for.cond2.preheader ]
  %3 = sext i32 %2 to i64
...
for.cond17:                                       ; preds = %for.inc25, %if.then
  ...
  br i1 %cmp18.not.not, label %for.body19, label %for.inc55.sink.split.loopexit
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  ...
  %call.i.i31 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx41) #6
...
for.inc55.sink.split.loopexit:                    ; preds = %for.cond17
  br label %for.inc55.sink.split

for.inc55.sink.split:                             ; preds = %for.inc55.sink.split.loopexit, %for.end46
  %csum.1.ph = phi i64 [ %add51, %for.end46 ], [ 0, %for.inc55.sink.split.loopexit ]
  %j.2.ph.in = phi i64 [ %indvars.iv.next110, %for.end46 ], [ %indvars.iv.next113, %for.inc55.sink.split.loopexit ]
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  ...
  %call.i.i61 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx68) #6
...
for.end73:                                        ; preds = %for.cond63
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef nonnull %words) #6
