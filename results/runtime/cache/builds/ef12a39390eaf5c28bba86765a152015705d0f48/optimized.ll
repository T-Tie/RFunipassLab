...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond67.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc60 ], [ 0, %for.cond ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc57 ], [ 0, %for.cond49.preheader ]
...
for.cond65.preheader:                             ; preds = %for.end62
  %smax105 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond95.not, label %for.cond86, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.inc104 ], [ 2, %for.cond65 ]
