...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax95 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %smax71 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond57.not, label %for.cond27.preheader, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv48 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next49, %for.inc21 ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv68 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next69, %for.inc60 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv63 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next64, %for.inc57 ]
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond85.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv91 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next92, %for.inc104 ]
