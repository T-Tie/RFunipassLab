...
define dso_local noundef i32 @_Z9mycomparePKvS0_(ptr noundef %e1, ptr noundef %e2) #0 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 404, ptr %s) #7
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0(i64 404, ptr %s) #7
