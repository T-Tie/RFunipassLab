...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull %.str.1..str, ptr noundef nonnull %arrayidx)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv30 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next31, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax38 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
  %3 = call i32 @llvm.smax.i32(i32 %t.0, i32 -1)
  %4 = add i32 %3, 2
  %wide.trip.count39 = zext nneg i32 %smax38 to i64
  br label %for.cond22

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv30
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond42 = icmp eq i32 %q.0, %4
  br i1 %exitcond42, label %for.cond52.preheader, label %for.cond25

for.cond52.preheader:                             ; preds = %for.cond22
  %7 = sext i32 %t.0 to i64
  %smax47 = call i32 @llvm.smax.i32(i32 %t.0, i32 -1)
  %8 = add i32 %smax47, 1
  %wide.trip.count48 = zext i32 %8 to i64
  br label %for.cond52

for.cond25:                                       ; preds = %for.cond22, %for.cond25.backedge
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.cond25.backedge ], [ 0, %for.cond22 ]
  %exitcond40.not = icmp eq i64 %indvars.iv34, %wide.trip.count39
  br i1 %exitcond40.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv34
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next35
  %10 = load i32, ptr %arrayidx32, align 4, !tbaa !5
  %cmp33 = icmp sgt i32 %9, %10
  br i1 %cmp33, label %if.then34, label %for.cond25.backedge

for.cond25.backedge:                              ; preds = %for.body27, %if.then34
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv43 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next44, %for.body54 ]
  %exitcond49 = icmp eq i64 %indvars.iv43, %wide.trip.count48
  br i1 %exitcond49, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv43, %7
  %arrayidx58 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv43
  %11 = load i32, ptr %arrayidx58, align 4, !tbaa !5
  %.str.2..str.3 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2..str.3, i32 noundef %11)
