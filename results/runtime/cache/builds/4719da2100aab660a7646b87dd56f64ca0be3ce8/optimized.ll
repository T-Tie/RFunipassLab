...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv35 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next36, %for.inc24 ]
  ...
  br i1 %exitcond40.not, label %for.cond27.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %2 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv35
  %3 = load i32, ptr %2, align 4, !tbaa !5
  br label %for.cond5

for.cond27.preheader:                             ; preds = %for.cond2
  %4 = load i32, ptr %B, align 16
  %smax45 = call i32 @llvm.smax.i32(i32 %number.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax45 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body7 ], [ 0, %for.cond5.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv32, %indvars.iv35
  br i1 %exitcond.not, label %if.then17, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv32
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv41 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next42, %for.inc39 ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond46.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv41, 0
...
if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv41
