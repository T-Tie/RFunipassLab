...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.cond.loopexit ], [ 2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond.loopexit ], [ 1, %entry ]
  %exitcond32.not = icmp eq i64 %indvars.iv26, 14
  br i1 %exitcond32.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc14 ], [ %indvars.iv26, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv28, 13
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not.not = icmp samesign ult i64 %indvars.iv23, %indvars.iv28
  br i1 %cmp6.not.not, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv23
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv28
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc27 ], [ 1, %for.cond ]
  %exitcond36.not = icmp eq i64 %indvars.iv33, 13
  br i1 %exitcond36.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv33, i64 %indvars.iv33
  store i32 1, ptr %arrayidx26, align 4, !tbaa !8
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  br label %for.cond20, !llvm.loop !14

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond44.not = icmp eq i64 %indvars.iv41, 13
  br i1 %exitcond44.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond40.not = icmp eq i64 %indvars.iv37, %indvars.iv41
  br i1 %exitcond40.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv37, i64 %indvars.iv41
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !8
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv41, i64 %indvars.iv37
...
for.cond51:                                       ; preds = %for.cond30, %for.cond51.loopexit
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.cond51.loopexit ], [ 2, %for.cond30 ]
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.cond51.loopexit ], [ 1, %for.cond30 ]
  %exitcond57.not = icmp eq i64 %indvars.iv50, 14
  br i1 %exitcond57.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc76 ], [ %indvars.iv50, %for.cond51 ]
  %exitcond55.not = icmp eq i64 %indvars.iv52, 13
  br i1 %exitcond55.not, label %for.cond51.loopexit, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc65 ], [ %indvars.iv45, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not.not = icmp samesign ult i64 %indvars.iv47, %indvars.iv52
  br i1 %cmp60.not.not, label %for.inc65, label %for.end67

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv47
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv45, i64 %indvars.iv52
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond61.not = icmp eq i64 %indvars.iv58, 13
  br i1 %exitcond61.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv58, i64 %indvars.iv58
  store i32 1, ptr %arrayidx88, align 4, !tbaa !8
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  br label %for.cond82, !llvm.loop !20

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond69.not = icmp eq i64 %indvars.iv66, 13
  br i1 %exitcond69.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond65.not = icmp eq i64 %indvars.iv62, %indvars.iv66
  br i1 %exitcond65.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv62, i64 %indvars.iv66
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !8
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv66, i64 %indvars.iv62
...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts21 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink) #7
