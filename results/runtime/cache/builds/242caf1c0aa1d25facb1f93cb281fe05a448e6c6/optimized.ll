...
for.inc.gvnsink.split:                            ; preds = %for.body, %if.else22
  %call23.sink = phi ptr [ %call23, %if.else22 ], [ @_ZSt4cout, %for.body ]
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call23.sink, ptr noundef nonnull align 16 dereferenceable(41) %s)
  %call27 = call i64 @strlen(ptr noundef %s) #11
  br label %for.inc

for.inc:                                          ; preds = %for.inc.gvnsink.split, %if.then12
  %call27.sink = phi i64 [ %add20, %if.then12 ], [ %call27, %for.inc.gvnsink.split ]
