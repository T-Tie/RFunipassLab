...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 captures(none) dereferenceable(10000) %a) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #11
...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  ...
  %lenq.0 = phi i32 [ %4, %if.end44 ], [ %1, %while.cond4.preheader ]
...
while.body5:                                      ; preds = %while.cond4
  %idx.ext6 = zext nneg i32 %lenq.0 to i64
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv28
...
while.end19:                                      ; preds = %while.cond8, %while.cond8
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j, i32 noundef %lenq.0, ptr nofree nonnull readonly captures(none) %incdec.ptr23)
...
while.end48:                                      ; preds = %while.cond4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #12
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull captures(none) %a) #12
  ret i32 0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !26, !invariant.load !13
  ret i64 %0
}
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) initializes((0, 4)) %0, i32 noundef %1, ptr nofree nonnull readonly captures(none) %2) unnamed_addr #9 {
if.then_to_outline:
  %smax = call i32 @llvm.smax.i32(i32 noundef %1, i32 noundef 0) #14
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then_to_outline
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %if.then_to_outline ]
  %3 = trunc nuw nsw i64 %indvars.iv to i32
  store i32 %3, ptr %0, align 4, !tbaa !11
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end.exitStub, label %for.inc

for.inc:                                          ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %2, i64 %indvars.iv
  %4 = load i8, ptr %add.ptr27, align 1, !tbaa !5, !invariant.load !13
  %call28 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %4)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
!15 = distinct !{!15, !9, !10}
!16 = !{!17, !6, i64 56}
!17 = !{!"_ZTSSt5ctypeIcE", !18, i64 0, !19, i64 16, !21, i64 24, !22, i64 32, !22, i64 40, !23, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
!18 = !{!"_ZTSNSt6locale5facetE", !12, i64 8}
...
!26 = !{!27, !28, i64 16}
!27 = !{!"_ZTSSt8ios_base", !28, i64 8, !28, i64 16, !29, i64 24, !30, i64 28, !30, i64 32, !31, i64 40, !32, i64 48, !6, i64 64, !12, i64 192, !33, i64 200, !34, i64 208}
!28 = !{!"long", !6, i64 0}
!29 = !{!"_ZTSSt13_Ios_Fmtflags", !6, i64 0}
!30 = !{!"_ZTSSt12_Ios_Iostate", !6, i64 0}
!31 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !20, i64 0}
!32 = !{!"_ZTSNSt8ios_base6_WordsE", !20, i64 0, !28, i64 8}
!33 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !20, i64 0}
!34 = !{!"_ZTSSt6locale", !35, i64 0}
!35 = !{!"p1 _ZTSNSt6locale5_ImplE", !20, i64 0}
!36 = distinct !{!36, !9, !10}
