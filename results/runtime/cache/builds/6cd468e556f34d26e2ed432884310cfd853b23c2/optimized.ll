...
for.end:                                          ; preds = %for.cond
  ...
  %smax41 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %2 = add nuw i32 %smax41, 1
  %wide.trip.count42 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond43 = icmp eq i64 %indvars.iv38, %wide.trip.count42
  br i1 %exitcond43, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax29 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv26 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next27, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body19 ], [ 0, %for.cond14 ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond14 ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond25.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv20, %indvars.iv38
  %arrayidx21 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx21, align 1, !tbaa !9
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv26, i64 %indvars.iv20
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv26, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv32 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next33, %for.inc56 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond37.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv32, %indvars.iv38
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv32
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond58.not = icmp eq i64 %indvars.iv53, %wide.trip.count57
  br i1 %exitcond58.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv53, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc118 ], [ %indvars.iv48, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv50 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv50, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond47.not = icmp eq i64 %indvars.iv44, 6
  br i1 %exitcond47.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv50, i64 %indvars.iv44
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv44
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv53, i64 %indvars.iv44
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc151 ], [ 1, %if.else ]
  %phiofops = phi i32 [ %17, %for.inc151 ], [ 0, %if.else ]
  %17 = trunc nuw nsw i64 %indvars.iv59 to i32
  %exitcond66.not = icmp eq i64 %indvars.iv59, %wide.trip.count65
  br i1 %exitcond66.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv59, i64 4
...
for.body136.for.end153_crit_edge:                 ; preds = %for.body136
  %.pre = and i64 %indvars.iv59, 4294967295
  br label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136.for.end153_crit_edge
  %.pre-phi = phi i64 [ %.pre, %for.body136.for.end153_crit_edge ], [ %wide.trip.count65, %for.cond134 ]
  %phiofops.lcssa = phi i32 [ %phiofops, %for.body136.for.end153_crit_edge ], [ %smax56, %for.cond134 ]
  %wide.trip.count79 = zext i32 %phiofops.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %wide.trip.count79
  br i1 %exitcond80.not, label %for.cond207, label %for.body157

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv76, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc201 ], [ %indvars.iv71, %for.body157 ]
  %cmp160 = icmp samesign ult i64 %indvars.iv73, %.pre-phi
  br i1 %cmp160, label %for.body161, label %for.cond154.loopexit

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv73, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond70.not = icmp eq i64 %indvars.iv67, 6
  br i1 %exitcond70.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv73, i64 %indvars.iv67
  %23 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv67
  store i8 %23, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv76, i64 %indvars.iv67
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %.pre-phi
  br i1 %exitcond88.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc220 ], [ 0, %for.body209 ]
  %26 = load i32, ptr %n, align 4, !tbaa !5
  %27 = sext i32 %26 to i64
  %cmp212 = icmp slt i64 %indvars.iv81, %27
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv84, i64 %indvars.iv81
  %28 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %28 to i32
  %putchar18 = call i32 @putchar(i32 noundef %conv218) #11
