...
entry:
  ...
  %smax53 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond:                                         ; preds = %if.end72, %entry
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %if.end72 ], [ 1, %entry ]
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %smax56 = call i32 @llvm.abs.i32(i32 %10, i1 noundef false)
  %11 = add nuw i32 %smax56, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %if.end54
  %j.1 = phi i32 [ %inc56, %if.end54 ], [ 1, %for.cond43.preheader ]
...
for.cond58.preheader:                             ; preds = %for.cond43
  ...
  %smax63 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
...
if.end50:                                         ; preds = %_Z4leftPcii.exit, %for.body45
  br i1 %cmp51, label %for.cond.i4, label %if.end54

for.cond.i4:                                      ; preds = %if.end50, %for.body.i7
  %indvars.iv.i5 = phi i64 [ %indvars.iv.next.i9, %for.body.i7 ], [ %8, %if.end50 ]
  %cmp.not.i6 = icmp slt i64 %indvars.iv.i5, %9
  br i1 %cmp.not.i6, label %_Z5rightPcii.exit, label %for.body.i7

for.body.i7:                                      ; preds = %for.cond.i4
  %gep.i8 = getelementptr i8, ptr %invariant.gep, i64 %indvars.iv.i5
  %14 = load i8, ptr %gep.i8, align 1, !tbaa !5, !invariant.load !8
  ...
  br label %for.cond.i4, !llvm.loop !9
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.body60
  %indvars.iv58 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next59, %for.body60 ]
  %exitcond65 = icmp eq i64 %indvars.iv58, %wide.trip.count64
  br i1 %exitcond65, label %for.end75, label %for.body60
...
for.body60:                                       ; preds = %for.cond58
  ...
  %17 = add nuw nsw i64 %add64, %indvars.iv58
