...
entry:
  ...
  %rem37 = srem i8 %rem3.lhs.trunc, 50
  %rem3.sext = sext i8 %rem37 to i32
  %sub4 = sub nsw i32 %rem, %rem3.sext
  %div5.lhs.trunc = trunc nsw i32 %sub4 to i16
  %div58 = sdiv i16 %div5.lhs.trunc, 50
  %div5.sext = sext i16 %div58 to i32
  %rem6 = srem i32 %0, 50
  %rem8.lhs.trunc = trunc nsw i32 %rem6 to i8
  %div1010 = sdiv i8 %rem8.lhs.trunc, 20
  ...
  %div2912 = sdiv i8 %rem27.lhs.trunc, 5
  %div29.sext = sext i8 %div2912 to i32
