...
define dso_local void @_Z2f1Piii(ptr nofree noundef captures(none) %p, i32 noundef %n, i32 noundef %k) #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define dso_local void @_Z2f2Piii(ptr nofree noundef captures(none) %p, i32 noundef %n, i32 noundef %k) #0 {
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #5
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %tailrecurse
