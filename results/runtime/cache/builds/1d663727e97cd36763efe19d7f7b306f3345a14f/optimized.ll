...
while.end:                                        ; preds = %while.cond
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %str)
...
while.body:                                       ; preds = %while.cond
  ...
  %0 = load i8, ptr %sPtr.0.ptr, align 1, !tbaa !12, !invariant.load !13
...
while.cond17:                                     ; preds = %while.cond8, %while.cond17
  ...
  %2 = load i32, ptr %nPtr.2.ptr, align 4, !tbaa !5, !invariant.load !13
  %cmp18 = icmp eq i32 %2, 0
  %nPtr.2.add = add nuw nsw i64 %nPtr.2.idx, 4
  br i1 %cmp18, label %while.cond17, label %while.cond22, !llvm.loop !16
...
while.body26:                                     ; preds = %while.cond22
  ...
  %3 = load i32, ptr %nPtr.3.ptr, align 4, !tbaa !5, !invariant.load !13
  %4 = trunc i32 %3 to i8
  %conv29 = add i8 %4, 48
