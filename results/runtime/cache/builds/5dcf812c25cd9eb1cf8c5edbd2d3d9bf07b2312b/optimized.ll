...
for.cond36:                                       ; preds = %for.inc47, %for.body34
  %sub.sink7 = phi i32 [ %sub, %for.body34 ], [ %dec, %for.inc47 ]
  %cmp37 = icmp sge i32 %sub.sink7, 0
...
for.body39:                                       ; preds = %for.cond36
  ...
  %idxprom42 = sext i32 %sub.sink7 to i64
...
if.then45:                                        ; preds = %for.body39
  ...
  store i32 %sub.sink7, ptr %q, align 4, !tbaa !5
  br label %for.inc50
