...
if.then:                                          ; preds = %for.body
  ...
  %3 = load double, ptr %sum, align 8, !tbaa !9
  %div = fdiv double %2, %3
  store double %div, ptr %sample, align 8, !tbaa !9
  br label %for.inc

if.else:                                          ; preds = %for.body
  %4 = load double, ptr %efficient, align 8, !tbaa !9
  %5 = load double, ptr %sum, align 8, !tbaa !9
  %div4 = fdiv double %4, %5
  %6 = load double, ptr %sample, align 8, !tbaa !9
  %sub = fsub double %div4, %6
  %cmp5 = fcmp ogt double %sub, 5.000000e-02
  br i1 %cmp5, label %for.inc.gvnsink.split, label %if.else9

if.else9:                                         ; preds = %if.else
  %sub11 = fsub double %6, %div4
  %cmp12 = fcmp ogt double %sub11, 5.000000e-02
  br i1 %cmp12, label %for.inc.gvnsink.split, label %if.else16

if.else16:                                        ; preds = %if.else9
  br label %for.inc.gvnsink.split

for.inc.gvnsink.split:                            ; preds = %if.else9, %if.else, %if.else16
  %.str.2.sink = phi ptr [ @.str.2, %if.else16 ], [ @.str, %if.else ], [ @.str.1, %if.else9 ]
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink)
...
for.inc:                                          ; preds = %for.inc.gvnsink.split, %if.then
  %inc = add nsw i32 %0, 1
