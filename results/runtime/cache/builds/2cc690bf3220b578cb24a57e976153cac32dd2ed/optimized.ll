...
if.then55:                                        ; preds = %for.body51
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %9, double noundef %10) #8
  br label %for.inc110
...
if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %9, double noundef %13, double noundef %9, double noundef %13) #8
  br label %for.inc110
