...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax52 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc22 ], [ 0, %for.cond11.preheader ]
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc63 ], [ 0, %for.cond ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc60 ], [ 0, %for.cond48.preheader ]
...
for.cond69:                                       ; preds = %for.end65, %for.inc125
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc125 ], [ 0, %for.end65 ]
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  ...
  %exitcond46.not = icmp eq i64 %indvars.iv40, %wide.trip.count
...
lor.lhs.false.thread:                             ; preds = %for.body75
  %7 = trunc nuw nsw i64 %indvars.iv40 to i32
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 %indvars.iv40
  store i32 %8, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

for.inc122.gvnsink.split:                         ; preds = %lor.lhs.false.thread, %land.lhs.true
  %indvars.iv47.sink = phi i64 [ %indvars.iv47, %land.lhs.true ], [ %5, %lor.lhs.false.thread ]
  ...
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47.sink, i64 %10
...
for.inc32:                                        ; preds = %for.cond12
  %call29 = call noundef i32 @_Z3cuti(i32 noundef %1) #7
