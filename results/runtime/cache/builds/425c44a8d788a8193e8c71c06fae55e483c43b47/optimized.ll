...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.24, %for.inc ]
...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre19 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre19, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
  ...
  %star1.24 = phi i32 [ %star1.1, %for.body3.for.inc_crit_edge ], [ %star1.2.ph, %land.lhs.true ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub10 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub10, 1
