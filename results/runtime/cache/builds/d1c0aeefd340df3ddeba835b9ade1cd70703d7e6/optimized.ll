...
if.end107:                                        ; preds = %if.else72, %if.then77
  %.sink2 = phi double [ %fneg81, %if.then77 ], [ %11, %if.else72 ]
  %.sink = phi double [ %fneg81, %if.then77 ], [ %11, %if.else72 ]
  ...
  %12 = load double, ptr %arrayidx99, align 8, !tbaa !9, !invariant.load !11
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink, double noundef %12, double noundef %.sink2, double noundef %12)
  br label %for.inc110
