...
for.body70:                                       ; preds = %for.cond67
  ...
  %10 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom77
  %11 = getelementptr inbounds [101 x i32], ptr %10, i64 0, i64 %idxprom79
  %12 = load i32, ptr %11, align 4, !tbaa !5
  br i1 %cmp71, label %if.then, label %if.else

if.then:                                          ; preds = %for.body70
  %call76 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12)
  br label %for.inc82

if.else:                                          ; preds = %for.body70
  %call81 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %12)
  br label %for.inc82
