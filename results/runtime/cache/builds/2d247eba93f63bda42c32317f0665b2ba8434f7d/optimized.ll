...
entry:
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %conv7, i32 0)
...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  %exitcond20.not = icmp eq i64 %indvars.iv11, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end22, label %for.cond8

for.cond8:                                        ; preds = %for.cond, %for.inc
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc ], [ %indvars.iv11, %for.cond ]
...
if.then24:                                        ; preds = %if.then24.loopexit, %for.end22
  ...
  %i.09 = phi i32 [ %i.0, %if.then24.loopexit ], [ %smax18, %for.end22 ]
  %add = add nsw i32 %i.09, %conv
  %smax28 = call i32 @llvm.smax.i32(i32 %i.09, i32 %add)
  %2 = sub nsw i32 %smax28, %i.09
