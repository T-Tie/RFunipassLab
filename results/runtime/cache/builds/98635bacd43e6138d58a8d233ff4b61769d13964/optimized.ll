...
for.cond:                                         ; preds = %for.inc35, %entry
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc35 ], [ 0, %entry ]
  %exitcond13.not = icmp eq i64 %indvars.iv10, 1000
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv10, i64 %indvars.iv
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv10
...
for.end37:                                        ; preds = %land.lhs.true29, %for.cond
  %wide.trip.count = and i64 %indvars.iv10, 4294967295
  br label %for.cond38
