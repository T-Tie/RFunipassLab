...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv66 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next67, %for.inc135 ]
  %indvars.iv63 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next64, %for.inc135 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc48
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc48 ], [ 0, %for.cond13 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %indvars.iv66
  br i1 %exitcond24.not, label %for.cond51, label %for.cond19

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body21 ], [ 0, %for.cond16 ]
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv12
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv15 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next16, %for.inc45 ]
...
for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv15
...
for.cond51:                                       ; preds = %for.cond16, %for.inc86
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc86 ], [ 0, %for.cond16 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %indvars.iv66
  br i1 %exitcond39.not, label %for.end88, label %for.cond54

for.cond54:                                       ; preds = %for.cond51, %for.body56
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body56 ], [ 0, %for.cond51 ]
  %min.2 = phi i32 [ %spec.select7, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %indvars.iv66
  br i1 %exitcond29.not, label %for.cond71.preheader, label %for.body56

for.cond71.preheader:                             ; preds = %for.cond54
  br label %for.cond71

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv35
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5
  %spec.select7 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond54, !llvm.loop !16

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv30 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next31, %for.inc83 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %indvars.iv66
  br i1 %exitcond34.not, label %for.inc86, label %for.inc83

for.inc83:                                        ; preds = %for.cond71
  %arrayidx77 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv35
...
for.cond91:                                       ; preds = %for.cond95, %for.end88
  %indvars.iv45 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next46, %for.cond95 ]
  %exitcond52.not = icmp eq i64 %indvars.iv45, %indvars.iv63
  br i1 %exitcond52.not, label %for.cond113, label %for.cond95.preheader
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv40 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next41, %for.inc107 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %indvars.iv66
  br i1 %exitcond44.not, label %for.cond91, label %for.inc107, !llvm.loop !19

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv.next46, i64 %indvars.iv40
  %14 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  %indvars.iv58 = phi i64 [ 1, %for.cond91 ], [ %indvars.iv.next59, %for.cond116 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %indvars.iv66
  br i1 %exitcond62.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv53 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next54, %for.inc129 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %indvars.iv63
  br i1 %exitcond57.not, label %for.cond113, label %for.inc129, !llvm.loop !21

for.inc129:                                       ; preds = %for.cond116
  %arrayidx124 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv53, i64 %indvars.iv.next59
  %15 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv53, i64 %indvars.iv58
