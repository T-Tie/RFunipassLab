...
if.end67:                                         ; preds = %if.then64, %if.then58
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %d.3, double noundef %div74, double noundef %d.3, double noundef %div74) #7
  br label %for.inc
