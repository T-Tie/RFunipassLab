...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr %total) #9
  call void @llvm.lifetime.start.p0(i64 80000, ptr %valid) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr %t1) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr %v1) #9
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %v1) #9
  call void @llvm.lifetime.end.p0(i64 8, ptr %t1) #9
  call void @llvm.lifetime.end.p0(i64 80000, ptr %valid) #9
  call void @llvm.lifetime.end.p0(i64 80000, ptr %total) #9
  ret i32 0
}
