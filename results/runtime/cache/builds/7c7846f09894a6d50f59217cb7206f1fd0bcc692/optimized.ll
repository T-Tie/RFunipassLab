...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20000, ptr nonnull %sentence) #8
  br label %while.cond
...
do.end.i:                                         ; preds = %while.cond
  ...
  store i64 0, ptr %gep, align 8, !tbaa !8
...
if.then6.i:                                       ; preds = %while.cond
  ...
  %1 = load i64, ptr %gep7, align 8, !tbaa !8
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  ...
  br i1 %call1, label %while.cond, label %while.end, !llvm.loop !21
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 20000, ptr nonnull %sentence) #8
  ret i32 0
}
