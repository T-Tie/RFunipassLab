...
for.cond4:                                        ; preds = %for.inc16, %for.end
  ...
  %cmp5 = icmp slt i32 %i.1, %inc.lcssa
...
for.end18:                                        ; preds = %for.cond4
  %s.0.lcssa = phi i32 [ %s.0, %for.cond4 ]
  %cmp19 = icmp eq i32 %s.0.lcssa, 0
...
for.cond35:                                       ; preds = %for.inc48, %for.body25
  ...
  %cmp36 = icmp slt i32 %i.2, %inc.lcssa
...
for.end50:                                        ; preds = %for.cond35
  %n.0.lcssa = phi i32 [ %n.0, %for.cond35 ]
  %cmp51 = icmp ne i32 %n.0.lcssa, 0
  br i1 %cmp51, label %if.then52, label %for.inc58

if.then52:                                        ; preds = %for.end50
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv29, i32 noundef %n.0.lcssa) #8
  br label %for.inc58
