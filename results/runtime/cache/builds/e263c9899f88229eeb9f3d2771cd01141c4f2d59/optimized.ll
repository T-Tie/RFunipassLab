...
for.cond23:                                       ; preds = %for.inc58, %if.end22
  %indvars.iv38 = phi i32 [ %indvars.iv.next39, %for.inc58 ], [ 97, %if.end22 ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc58 ], [ 0, %if.end22 ]
  %exitcond37.not = icmp eq i64 %indvars.iv34, 26
  br i1 %exitcond37.not, label %for.end60, label %for.cond35

for.cond35:                                       ; preds = %for.cond23, %for.body37
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body37 ], [ 0, %for.cond23 ]
...
for.body37:                                       ; preds = %for.cond35
  ...
  %4 = zext i8 %3 to i32
  %cmp44 = icmp eq i32 %indvars.iv38, %4
...
if.then52:                                        ; preds = %for.end50
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %indvars.iv38, i32 noundef %n.0)
  br label %for.inc58
