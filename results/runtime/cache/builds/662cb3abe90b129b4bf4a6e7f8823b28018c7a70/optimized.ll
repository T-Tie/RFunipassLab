...
if.else62:                                        ; preds = %if.else
  ...
  br i1 %cmp84, label %cond.true, label %cond.end

cond.true:                                        ; preds = %if.else62
  %fneg87 = fneg double %9
  br label %cond.end

cond.end:                                         ; preds = %if.else62, %cond.true
  %.sink2 = phi double [ %fneg87, %cond.true ], [ %9, %if.else62 ]
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink2, double noundef %10, double noundef %.sink2, double noundef %10)
  br label %for.inc106
