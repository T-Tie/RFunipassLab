...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %s) #4
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %t) #4
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv6 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc13 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv6
...
for.cond19.preheader:                             ; preds = %for.end15
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv13 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next14, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond19.not = icmp eq i32 %i.2, %smax18
  br i1 %exitcond19.not, label %for.end49, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond19
  %smax15 = call i32 @llvm.smax.i32(i32 %indvars.iv13, i32 noundef 0)
  %wide.trip.count16 = zext nneg i32 %smax15 to i64
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv10 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next11, %for.inc44 ]
  %exitcond17.not = icmp eq i64 %indvars.iv10, %wide.trip.count16
  br i1 %exitcond17.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv10
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next11
...
for.body54:                                       ; preds = %for.cond52
  ...
  %7 = load i64, ptr %gep, align 8, !tbaa !17, !invariant.load !12
...
for.inc59:                                        ; preds = %if.end.i, %if.then.i
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv20
  %8 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !12
  ...
  br label %for.cond52, !llvm.loop !28

cleanup:                                          ; preds = %for.cond52, %for.end15
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %t) #5
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %s) #5
