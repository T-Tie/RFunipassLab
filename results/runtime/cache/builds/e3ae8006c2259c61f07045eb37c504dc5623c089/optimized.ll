...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv11 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next12, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.cond11, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %2 = trunc nuw nsw i64 %indvars.iv11 to i32
  ...
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv11
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv15
...
for.cond2:                                        ; preds = %if.end, %for.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end ], [ %0, %for.end ]
  %cmp3 = icmp slt i64 %indvars.iv18, %1
  br i1 %cmp3, label %for.body4, label %for.cond20

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv18
