...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %x1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %x2) #7
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %x) #7
...
if.end17:                                         ; preds = %if.then16, %if.end
  ...
  %call18 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %5, double noundef %6) #9
  br label %if.end42
...
if.end24:                                         ; preds = %if.then23, %if.else
  ...
  %call25 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %7) #9
  br label %if.end42
...
if.else27:                                        ; preds = %while.body
  ...
  %call32 = call double @sqrt(double noundef %fneg31) #8, !tbaa !9
...
if.end40:                                         ; preds = %if.then39, %if.end37
  ...
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %8, double noundef %9, double noundef %8, double noundef %9) #9
  br label %if.end42
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %x) #9
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %x2) #9
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %x1) #9
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %c) #9
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #9
