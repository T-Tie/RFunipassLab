...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv8, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv14, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv11, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv14, i64 %indvars.iv11
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax25 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax26 = call i32 @llvm.smax.i32(i32 %smax25, i32 noundef 0)
...
for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond28.not = icmp eq i64 %indvars.iv21, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax32 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count33 = zext nneg i32 %smax32 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv21, i64 %indvars.iv17
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv42 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next43, %for.inc83 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count27
  br i1 %exitcond46.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond41.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv42, i64 %indvars.iv35
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv29 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next30, %for.inc77 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count33
  br i1 %exitcond34.not, label %for.inc80, label %for.inc77
...
for.inc77:                                        ; preds = %for.cond58
  ...
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv29, i64 %indvars.iv35
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count27
  br i1 %exitcond51.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv47
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax25 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count27
  br i1 %exitcond63.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv59
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax25, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax25, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv52 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next53, %for.inc112 ]
  %exitcond58.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond58.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv59, i64 %indvars.iv52
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv76 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond83.not = icmp eq i64 %indvars.iv76, %wide.trip.count27
  br i1 %exitcond83.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv76
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv76, 0
  %or.cond3 = and i1 %or.cond, %cmp128
  br i1 %or.cond3, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv76
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax67 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count68 = zext nneg i32 %smax67 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond69.not = icmp eq i64 %indvars.iv64, %wide.trip.count68
  br i1 %exitcond69.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv76, i64 %indvars.iv64
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv76, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax73 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count74 = zext nneg i32 %smax73 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond75.not = icmp eq i64 %indvars.iv70, %wide.trip.count74
  br i1 %exitcond75.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv76, i64 %indvars.iv70
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv76, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv76, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar4 = call i32 @putchar(i32 noundef 10) #6
  br label %for.inc198
