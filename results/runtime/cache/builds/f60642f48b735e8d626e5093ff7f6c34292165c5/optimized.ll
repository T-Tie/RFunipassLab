...
for.cond2:                                        ; preds = %for.cond, %if.end73
  ...
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %if.end73 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %if.end73 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %if.end73 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv57, %5
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv57
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax67 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %6 = add i32 %smax67, 1
  %wide.trip.count68 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.end115, %for.end76
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.end115 ], [ 0, %for.end76 ]
  %exitcond69 = icmp eq i64 %indvars.iv63, %wide.trip.count68
  br i1 %exitcond69, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv63
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv63, i64 %7
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.body88
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %if.end112 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv60, %wide.trip.count
  br i1 %exitcond.not, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv60, %7
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv63, i64 %indvars.iv60
