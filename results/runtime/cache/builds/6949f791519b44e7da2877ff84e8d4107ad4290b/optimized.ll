...
for.cond:                                         ; preds = %for.inc, %entry
  %.sink5 = phi i32 [ 1, %entry ], [ %inc, %for.inc ]
  %cmp = icmp slt i32 %.sink5, %m1
...
for.cond13:                                       ; preds = %for.inc37, %for.end
  %.sink6 = phi i32 [ 1, %for.end ], [ %inc38, %for.inc37 ]
  %cmp14 = icmp slt i32 %.sink6, %m2
