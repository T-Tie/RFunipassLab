...
for.cond:                                         ; preds = %for.cond.cleanup18, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc28, %for.cond.cleanup18 ]
...
for.cond31:                                       ; preds = %for.cond.cleanup60, %for.end29
  %i30.0 = phi i32 [ 0, %for.end29 ], [ %inc71, %for.cond.cleanup60 ]
...
for.cond39:                                       ; preds = %if.end53, %for.body34
  %j38.0 = phi i32 [ 1, %for.body34 ], [ %inc55, %if.end53 ]
  %min35.0 = phi i32 [ %3, %for.body34 ], [ %min35.1, %if.end53 ]
...
for.cond58:                                       ; preds = %for.body61, %for.cond.cleanup41
  %j57.0 = phi i32 [ 0, %for.cond.cleanup41 ], [ %inc68, %for.body61 ]
...
for.cond:                                         ; preds = %for.cond.cleanup13, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %add, %for.cond.cleanup13 ]
  %sub = sub nsw i32 %n, 1
...
for.cond10:                                       ; preds = %for.body14, %for.body
  %j.0 = phi i32 [ 1, %for.body ], [ %add18, %for.body14 ]
