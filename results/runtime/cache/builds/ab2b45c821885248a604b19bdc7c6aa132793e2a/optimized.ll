...
if.end107:                                        ; preds = %if.else72, %if.then77
  %.sink2 = phi double [ %fneg81, %if.then77 ], [ %10, %if.else72 ]
  %.sink = phi double [ %fneg81, %if.then77 ], [ %10, %if.else72 ]
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink, double noundef %11, double noundef %.sink2, double noundef %11)
  br label %for.inc110
