...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %j.0 = phi i32 [ %spec.select, %for.body ], [ 0, %entry ]
...
for.cond9.preheader:                              ; preds = %for.cond
  ...
  br i1 %cmp10.not, label %for.end49, label %if.end30

for.body:                                         ; preds = %for.cond
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %a)
  %arrayidx3 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv
  %1 = load i32, ptr %arrayidx3, align 4, !tbaa !5, !invariant.load !9
  %2 = and i32 %1, 1
  %spec.select = add nuw nsw i32 %j.0, %2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond

if.end30:                                         ; preds = %for.cond9.preheader, %if.end30
  br label %if.end30

for.end49:                                        ; preds = %for.cond9.preheader
