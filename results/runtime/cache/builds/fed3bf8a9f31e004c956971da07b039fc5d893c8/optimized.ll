...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre10 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre10, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub1 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub1, 1
