...
for.inc:                                          ; preds = %for.cond
  ...
  call void @_Z6yinshuii(i32 noundef %2, i32 noundef 2) #7
...
if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #6
  store i32 %x, ptr %i, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then
  %0 = load i32, ptr %i, align 4, !tbaa !5
  %cmp1 = icmp sle i32 %0, %a
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %a, %0
  call void @_Z6yinshuii(i32 noundef %div, i32 noundef %0) #8
  br label %for.inc
