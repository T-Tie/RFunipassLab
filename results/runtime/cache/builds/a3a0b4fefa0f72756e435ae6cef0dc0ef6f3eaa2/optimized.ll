...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %arrayidx2, align 4, !tbaa !5, !invariant.load !12
...
if.end:                                           ; preds = %if.else16, %if.then11
  %z.0 = phi i32 [ %call15, %if.then11 ], [ %call18, %if.else16 ]
  br label %return

return:                                           ; preds = %if.end, %if.else, %if.then4
  %retval.0 = phi i32 [ 1, %if.then4 ], [ 0, %if.else ], [ %z.0, %if.end ]
  ret i32 %retval.0
}
