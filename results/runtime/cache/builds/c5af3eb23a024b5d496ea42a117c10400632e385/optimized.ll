...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %LEN) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %sz) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %js) #6
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv33 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next34, %for.inc33 ]
  %indvars.iv6 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next7, %for.inc33 ]
  %smax35 = call i64 @llvm.smax.i64(i64 %indvars.iv33, i64 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  ...
  %exitcond36 = icmp eq i64 %indvars.iv3, %smax35
  br i1 %exitcond36, label %for.end18, label %for.body10
...
for.inc60:                                        ; preds = %for.cond54
  ...
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12) #7
...
for.inc73:                                        ; preds = %for.cond66
  ...
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %13) #7
...
for.end75:                                        ; preds = %for.cond66
  ...
  %call79 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %14) #7
  br label %if.end80

if.end80:                                         ; preds = %for.cond54, %for.end75
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %js) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %sz) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %LEN) #7
  ret i32 0
}
