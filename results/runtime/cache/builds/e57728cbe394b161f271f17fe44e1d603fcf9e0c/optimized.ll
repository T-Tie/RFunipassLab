...
for.cond:                                         ; preds = %if.end17, %entry
  %j.0 = phi i32 [ 0, %entry ], [ %inc19, %if.end17 ]
...
for.cond1:                                        ; preds = %if.end, %for.body
  %k.0 = phi i32 [ %j.0, %for.body ], [ %inc, %if.end ]
  %m.0 = phi i32 [ %j.0, %for.body ], [ %m.1, %if.end ]
...
while.end:                                        ; preds = %while.cond
  %idxprom5 = sext i32 %phiofops to i64
...
for.cond31:                                       ; preds = %if.end40, %for.end30
  %j.1 = phi i32 [ 0, %for.end30 ], [ %inc42, %if.end40 ]
  %n.2 = phi i32 [ 0, %for.end30 ], [ %n.3, %if.end40 ]
