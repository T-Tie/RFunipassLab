...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %y) #5
  ret i32 %5
}
...
for.end:                                          ; preds = %for.cond
  %call2 = call noundef i32 @_Z3maxPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(400) %a, i32 noundef %1, i32 noundef 0) #6
