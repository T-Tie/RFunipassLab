...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull %dz) #5
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %1 = phi i32 [ %.pre10, %for.inc ], [ %0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  ...
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %dz) #6
...
for.inc.sink.split:                               ; preds = %if.else, %for.body3
  ...
  %putchar9 = call i32 @putchar(i32 %.sink)
  br label %for.inc
...
for.end20:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull %dz) #5
