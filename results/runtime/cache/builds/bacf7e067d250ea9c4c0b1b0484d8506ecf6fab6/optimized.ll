...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc23
  %indvars.iv18 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next19, %for.inc23 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %for.inc23 ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond26.preheader, label %for.cond5.preheader
...
for.end15:                                        ; preds = %for.body7, %for.cond5
  %j.0.lcssa.in = phi i64 [ %indvars.iv15, %for.body7 ], [ %indvars.iv18, %for.cond5 ]
  %5 = and i64 %j.0.lcssa.in, 4294967295
  %cmp16 = icmp eq i64 %5, %indvars.iv18
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc36
  %indvars.iv24 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next25, %for.inc36 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond29.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %b, i64 0, i64 %indvars.iv24
  ...
  %cmp32 = icmp slt i64 %indvars.iv24, %2
