...
for.end23:                                        ; preds = %if.then, %for.cond13
  %a.2 = phi i32 [ %i.1, %if.then ], [ %a.0, %for.cond13 ]
  %b.2 = phi i32 [ %j.1, %if.then ], [ %b.0, %for.cond13 ]
...
for.end33:                                        ; preds = %if.then29, %for.cond10
  %a.1 = phi i32 [ %a.2, %if.then29 ], [ %a.0, %for.cond10 ]
  %b.1 = phi i32 [ %b.2, %if.then29 ], [ %b.0, %for.cond10 ]
  br label %for.cond34
