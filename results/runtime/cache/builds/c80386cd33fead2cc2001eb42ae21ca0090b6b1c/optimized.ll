...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre53, %for.body3 ], [ %0, %for.cond ]
...
while.cond:                                       ; preds = %while.cond, %for.end29
  ...
  br i1 %cmp34, label %while.cond, label %while.cond36, !llvm.loop !15

while.cond36:                                     ; preds = %while.cond, %while.cond36
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %while.cond36 ], [ %idxprom30, %while.cond ]
