...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %5) #7, !tbaa !5
  %add = fsub double %call5, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call7 = call double @sqrt(double noundef %5) #7, !tbaa !5
...
if.then11:                                        ; preds = %if.then
  %call12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div9)
  br label %if.end
...
if.then14:                                        ; preds = %if.end
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div9)
  br label %if.end17
...
if.end49:                                         ; preds = %if.end17
  ...
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div22)
  call fastcc void @outlined_ir_func_0(double %div26, ptr noundef nonnull dereferenceable(7) @.str.6)
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %div22)
  call fastcc void @outlined_ir_func_0(double %div31, ptr noundef nonnull dereferenceable(8) @.str.8)
  br label %for.inc
...
define internal fastcc void @outlined_ir_func_0(double %0, ptr noundef nonnull dereferenceable(7) %1) unnamed_addr #5 {
if.then19_to_outline:
  %cmp33 = fcmp ogt double %0, 0.000000e+00
  br i1 %cmp33, label %if.then34, label %if.end36

if.then34:                                        ; preds = %if.then19_to_outline
  %call35 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %0)
  br label %if.end36
...
if.then38:                                        ; preds = %if.end36
  %call39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %1, double noundef %0)
