...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 120, ptr nonnull %b) #4
...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %2 = phi i32 [ %add, %for.inc19 ], [ 1, %for.end ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv28, 0
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %indvars.iv.next29 = add nsw i64 %indvars.iv28, -1
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next29
  %3 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv28
...
for.inc19:                                        ; preds = %for.body7
  ...
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next29
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !12

for.end20.split.loop.exit:                        ; preds = %for.body7
  %5 = trunc nsw i64 %indvars.iv28 to i32
  br label %for.end20

for.end20:                                        ; preds = %for.cond5, %for.end20.split.loop.exit
  %i.1.lcssa = phi i32 [ %5, %for.end20.split.loop.exit ], [ %smin, %for.cond5 ]
  %6 = sext i32 %i.1.lcssa to i64
  br label %for.cond22

for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.end47 ], [ %6, %for.end20 ]
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next35
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %7, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %cmp30.not = icmp slt i64 %indvars.iv31, %indvars.iv34
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %8 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv31
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv31
...
for.end47:                                        ; preds = %for.cond29
  ...
  %11 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next35
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv37 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next38, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select26, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv37
  %12 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select26 = call i32 @llvm.smax.i32(i32 %12, i32 %sum.2)
...
for.end72:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 120, ptr nonnull %b) #4
