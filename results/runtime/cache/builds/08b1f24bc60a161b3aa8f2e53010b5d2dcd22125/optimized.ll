...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 44100, ptr noundef nonnull align 16 %a) #7
...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc8 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv58, %2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv115 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next116, %for.end138 ]
  %indvars.iv112 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next113, %for.end138 ]
  %sum.0 = phi i32 [ 0, %while.cond11.preheader ], [ %add, %for.end138 ]
  %8 = trunc nuw i64 %indvars.iv115 to i32
  %cmp12 = icmp sgt i32 %8, 1
  br i1 %cmp12, label %for.cond14, label %while.end

for.cond14:                                       ; preds = %while.cond11, %for.inc49
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc49 ], [ 0, %while.cond11 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %indvars.iv115
  br i1 %exitcond73.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv69
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.body22 ], [ 0, %for.body16 ]
  %min.0 = phi i32 [ %spec.select, %for.body22 ], [ %9, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv61, %indvars.iv115
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv69, i64 %indvars.iv61
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv64 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next65, %for.inc46 ]
  %exitcond68.not = icmp eq i64 %indvars.iv64, %indvars.iv115
  br i1 %exitcond68.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv69, i64 %indvars.iv64
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %indvars.iv115
  br i1 %exitcond88.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv84
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select56, %for.body60 ], [ %12, %for.body54 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %indvars.iv115
  br i1 %exitcond78.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv74, i64 %indvars.iv84
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  %spec.select56 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next75 = add nuw nsw i64 %indvars.iv74, 1
  br label %for.cond58, !llvm.loop !17

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv79 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next80, %for.inc87 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %indvars.iv115
  br i1 %exitcond83.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv79, i64 %indvars.iv84
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv97 = phi i64 [ %indvars.iv.next98, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond101.not = icmp eq i64 %indvars.iv97, %indvars.iv115
  br i1 %exitcond101.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc111 ], [ 1, %for.cond95 ]
  %exitcond96.not = icmp eq i64 %indvars.iv89, %indvars.iv112
  br i1 %exitcond96.not, label %for.inc114, label %for.inc111

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv97, i64 %indvars.iv.next90
  %16 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv97, i64 %indvars.iv89
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond111.not = icmp eq i64 %indvars.iv107, %indvars.iv115
  br i1 %exitcond111.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.inc133 ], [ 1, %for.cond117 ]
  %exitcond106.not = icmp eq i64 %indvars.iv102, %indvars.iv112
  br i1 %exitcond106.not, label %for.inc136, label %for.inc133

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next103 = add nuw nsw i64 %indvars.iv102, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next103, i64 %indvars.iv107
  %17 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !13
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv102, i64 %indvars.iv107
...
for.end138:                                       ; preds = %for.cond117
  ...
  %indvars118 = trunc i64 %indvars.iv.next116 to i32
  store i32 %indvars118, ptr %n, align 4, !tbaa !5
...
while.end142:                                     ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 44100, ptr noundef nonnull %a) #8
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !35, !invariant.load !13
