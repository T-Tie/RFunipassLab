...
if.end63:                                         ; preds = %if.end, %lor.lhs.false40, %lor.lhs.false21
  %t.2 = phi i32 [ %t.0, %lor.lhs.false40 ], [ %t.0, %lor.lhs.false21 ], [ %t.3, %if.end ]
...
for.inc:                                          ; preds = %lor.lhs.false83, %land.lhs.true88, %land.lhs.true93, %land.lhs.true98, %if.end
  %t.4 = phi i32 [ %t.3, %if.end ], [ %t.2, %land.lhs.true98 ], [ %t.2, %land.lhs.true93 ], [ %t.2, %land.lhs.true88 ], [ %t.2, %lor.lhs.false83 ]
  %inc105 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !8

if.then107:                                       ; preds = %for.cond
  %t.1 = phi i32 [ %t.0, %for.cond ]
  %flag.1 = phi i32 [ 0, %for.cond ]
...
if.end119:                                        ; preds = %land.lhs.true78, %land.lhs.true98, %if.then115, %if.end113, %entry
  %flag.0 = phi i32 [ 0, %entry ], [ %flag.1, %if.then115 ], [ %flag.1, %if.end113 ], [ 1, %land.lhs.true98 ], [ 1, %land.lhs.true78 ]
