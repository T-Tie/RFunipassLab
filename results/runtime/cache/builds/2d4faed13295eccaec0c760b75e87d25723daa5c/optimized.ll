...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %for.inc ], [ 0, %entry ]
...
for.cond.for.inc_crit_edge:                       ; preds = %for.cond
  %.pre14 = load i32, ptr %arrayidx4, align 4, !tbaa !5
  br label %for.inc

land.lhs.true:                                    ; preds = %for.cond
  %cmp15 = icmp eq i32 %.pre, 0
  %.pre15 = load i32, ptr %arrayidx4, align 4, !tbaa !5
  %cmp19 = icmp eq i32 %.pre15, 0
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre14, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre15, %land.lhs.true ]
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc61
  %indvars.iv9 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next10, %for.inc61 ]
...
for.inc61:                                        ; preds = %for.cond56
  %arrayidx59 = getelementptr inbounds nuw [1000 x i32], ptr %sum, i64 0, i64 %indvars.iv9
  %8 = load i32, ptr %arrayidx59, align 4, !tbaa !5
  %call60 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %8) #5
