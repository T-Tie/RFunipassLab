...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %counter) #5
...
if.then34:                                        ; preds = %for.end32
  ...
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %11)
...
for.end45:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %counter) #6
