...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv23, %2
  br i1 %cmp2, label %for.cond4, label %while.cond.preheader

while.cond.preheader:                             ; preds = %for.cond1
  %smax93 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end176
  %indvars.iv30 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next31, %for.end176 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.end176 ]
  %p.0 = phi i32 [ 0, %while.cond.preheader ], [ %inc177, %for.end176 ]
  %exitcond94.not = icmp eq i32 %p.0, %smax93
  br i1 %exitcond94.not, label %for.inc179, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %while.cond
  %smax89 = call i32 @llvm.smax.i32(i32 %indvars.iv30, i32 noundef 0)
  %wide.trip.count35 = zext nneg i32 %smax89 to i64
  %wide.trip.count = zext i32 %indvars.iv30 to i64
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  %indvars.iv32 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next33, %for.inc42 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond45.preheader, label %for.body16

for.cond45.preheader:                             ; preds = %for.cond14
  br label %for.cond45

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32
  %5 = load i32, ptr %arrayidx18, align 16, !tbaa !5
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv32
...
for.cond22:                                       ; preds = %for.body25, %for.body16
  ...
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body25 ], [ 0, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv26
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc67
  %indvars.iv42 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next43, %for.inc67 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count35
  br i1 %exitcond47.not, label %for.cond70.preheader, label %for.cond49.preheader

for.cond70.preheader:                             ; preds = %for.cond45
  br label %for.cond70

for.cond49.preheader:                             ; preds = %for.cond45
  %arrayidx58 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv42
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  %indvars.iv37 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next38, %for.inc64 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond49
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %indvars.iv37
...
for.cond70:                                       ; preds = %for.cond70.preheader, %for.inc101
  %indvars.iv53 = phi i64 [ 0, %for.cond70.preheader ], [ %indvars.iv.next54, %for.inc101 ]
  %exitcond58.not = icmp eq i64 %indvars.iv53, %wide.trip.count35
  br i1 %exitcond58.not, label %for.cond104.preheader, label %for.body73

for.cond104.preheader:                            ; preds = %for.cond70
  br label %for.cond104

for.body73:                                       ; preds = %for.cond70
  %arrayidx76 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv53
  %10 = load i32, ptr %arrayidx76, align 4, !tbaa !5
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv53
  store i32 %10, ptr %arrayidx78, align 4, !tbaa !5
  br label %for.cond79

for.cond79:                                       ; preds = %for.body82, %for.body73
  %11 = phi i32 [ %spec.store.select21, %for.body82 ], [ %10, %for.body73 ]
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body82 ], [ 0, %for.body73 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond52.not, label %for.inc101, label %for.body82

for.body82:                                       ; preds = %for.cond79
  %arrayidx88 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv48, i64 %indvars.iv53
  %12 = load i32, ptr %arrayidx88, align 4, !tbaa !5
  %spec.store.select21 = call i32 @llvm.smin.i32(i32 %11, i32 %12)
  store i32 %spec.store.select21, ptr %arrayidx78, align 4
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  %indvars.iv64 = phi i64 [ 0, %for.cond104.preheader ], [ %indvars.iv.next65, %for.inc126 ]
  %exitcond69.not = icmp eq i64 %indvars.iv64, %wide.trip.count35
  br i1 %exitcond69.not, label %for.end128, label %for.cond108

for.cond108:                                      ; preds = %for.cond104, %for.inc123
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc123 ], [ 0, %for.cond104 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count
  br i1 %exitcond63.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond108
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv64, i64 %indvars.iv59
  %13 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx117 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv59
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc151 ], [ 0, %for.end128 ]
  %exitcond80.not = icmp eq i64 %indvars.iv75, %wide.trip.count35
  br i1 %exitcond80.not, label %for.cond154.preheader, label %for.cond135

for.cond154.preheader:                            ; preds = %for.cond131
  br label %for.cond154

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %wide.trip.count
  br i1 %exitcond74.not, label %for.inc151, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv75, i64 %indvars.iv.next71
  %16 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !21
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv75, i64 %indvars.iv70
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  %indvars.iv86 = phi i64 [ 0, %for.cond154.preheader ], [ %indvars.iv.next87, %for.inc174 ]
  %exitcond91.not = icmp eq i64 %indvars.iv86, %wide.trip.count35
  br i1 %exitcond91.not, label %for.end176, label %for.cond158

for.cond158:                                      ; preds = %for.cond154, %for.inc171
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc171 ], [ 1, %for.cond154 ]
  %exitcond85.not = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond85.not, label %for.inc174, label %for.inc171

for.inc171:                                       ; preds = %for.cond158
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %arrayidx166 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next82, i64 %indvars.iv86
  %17 = load i32, ptr %arrayidx166, align 4, !tbaa !5, !invariant.load !21
  %arrayidx170 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv81, i64 %indvars.iv86
