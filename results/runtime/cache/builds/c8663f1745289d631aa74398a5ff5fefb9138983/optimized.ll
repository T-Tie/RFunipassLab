...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef nonnull align 16 captures(none) dereferenceable(20000) %sentence) #10
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(20000) %sentence)
  ...
  br i1 %call1, label %while.body, label %for.end

while.body:                                       ; preds = %while.cond
  br label %while.cond, !llvm.loop !9

for.end:                                          ; preds = %while.cond
  %call11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(20000) %sentence)
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef captures(none) %sentence) #11
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  ...
  store i32 %call4, ptr %__ret, align 4, !tbaa !12
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  store i32 %call5, ptr %__ret, align 4, !tbaa !12
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %1 = load i32, ptr %__ret, align 4, !tbaa !12
...
; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) local_unnamed_addr #8 comdat {
entry:
  %and = and i32 %__a, %__b
  ret i32 %and
}
