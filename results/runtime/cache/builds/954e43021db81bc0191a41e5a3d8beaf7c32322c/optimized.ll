...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre22, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv15 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next16, %for.cond13 ]
  ...
  br i1 %exitcond21, label %for.end58, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv9 = phi i64 [ 1, %for.cond13.preheader ], [ %10, %for.inc53 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv15, i64 %indvars.iv9
...
land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv15, i64 %10
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next16, i64 %indvars.iv9
  %12 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  %cmp32 = icmp eq i32 %12, 0
  %13 = trunc nuw nsw i64 %indvars.iv9 to i32
  %spec.select = select i1 %cmp32, i32 %13, i32 %y1.1
  %spec.select1 = select i1 %cmp32, i32 %7, i32 %x1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %x1.2 = phi i32 [ %x1.1, %land.lhs.true ], [ %spec.select1, %land.lhs.true26 ]
  %14 = add nsw i64 %indvars.iv9, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv15, i64 %14
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv9
  %16 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %cmp50 = icmp eq i32 %16, 0
  %spec.select2 = select i1 %cmp50, i32 %8, i32 %x2.1
  %17 = trunc nuw nsw i64 %indvars.iv9 to i32
  %spec.select3 = select i1 %cmp50, i32 %17, i32 %y2.1
  br label %for.inc53

for.inc53:                                        ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
  %x2.2 = phi i32 [ %spec.select2, %land.lhs.true44 ], [ %x2.1, %land.lhs.true38 ], [ %x2.1, %for.body15 ]
  ...
  %y2.2 = phi i32 [ %spec.select3, %land.lhs.true44 ], [ %y2.1, %land.lhs.true38 ], [ %y2.1, %for.body15 ]
...
for.end58:                                        ; preds = %for.cond10
  ...
  %mul654 = add i32 %sub61, -1
  %sub66 = mul i32 %mul654, %add60
  %18 = shl i32 %sub61, 1
