...
if.else79:                                        ; preds = %for.body75
  ...
  br i1 %cmp80, label %for.inc122, label %lor.lhs.falsethread-pre-split

lor.lhs.falsethread-pre-split:                    ; preds = %if.else79
  br label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true, %lor.lhs.falsethread-pre-split
  %cmp81 = icmp eq i32 %j.4, 1
  br i1 %cmp81, label %for.inc122, label %if.else83
...
if.then85:                                        ; preds = %if.else83
  ...
  %5 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
...
if.then97:                                        ; preds = %if.else95
  ...
  %6 = load i32, ptr %arrayidx99, align 4, !tbaa !5, !invariant.load !9
...
if.else107:                                       ; preds = %if.else95
  ...
  %7 = load i32, ptr %arrayidx111, align 4, !tbaa !5, !invariant.load !9
...
for.inc122:                                       ; preds = %if.then85, %if.else107, %if.then97, %if.else79, %lor.lhs.false, %land.lhs.true
...
for.inc32:                                        ; preds = %for.cond12
  %call29 = call noundef i32 @_Z3cuti(i32 noundef %1) #10
