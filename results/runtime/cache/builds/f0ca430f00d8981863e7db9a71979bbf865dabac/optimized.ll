...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 dereferenceable(40) %letter) #8
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #9
  %conv5 = sext i32 %num.0 to i64
  %add = add nsw i64 %conv5, %blank.0
...
for.inc:                                          ; preds = %if.end, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end.thread
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %letter) #10
  ...
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #9
  %add17 = add i64 %call15, %blank.128
  %6 = trunc i64 %add17 to i32
  %conv20 = add i32 %6, %num.129
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !31

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #10
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %letter) #10
  ret i32 0
}
