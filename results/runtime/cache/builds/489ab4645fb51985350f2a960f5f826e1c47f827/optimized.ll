...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull align 16 dereferenceable(25000) %word) #9
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %l) #9
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread18
  ...
  %s.13.ph = phi i32 [ %s.0, %if.end35.thread18 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre20, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
  %s.13 = phi i32 [ %s.0, %if.end35 ], [ %s.13.ph, %for.inc47.sink.split ]
  %add45 = add i32 %7, 1
  %add46 = add i32 %add45, %s.13
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  br label %for.cond17, !llvm.loop !29

for.end49:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %l) #10
