...
land.lhs.true.i14:                                ; preds = %if.then6.i8
  %_M_width.i2.i15 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i2.i15, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -1001
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv32
  %6 = load i8, ptr %arrayidx54, align 1, !tbaa !22, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv32
