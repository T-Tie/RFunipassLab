...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef align 16 %k) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %n) #6
  store i32 0, ptr %n, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) %Max) #6
  store i32 0, ptr %Max, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) %Max2) #6
...
for.end28:                                        ; preds = %for.cond13
  ...
  call fastcc void @outlined_ir_func_0(i32 noundef %6)
  %7 = load i32, ptr %Max2, align 4
  call fastcc void @outlined_ir_func_0(i32 noundef %7)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %Max2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %Max) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #7
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %k) #7
  ret i32 0
}
