...
for.end:                                          ; preds = %for.cond
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call3, i8 noundef signext %call.i4)
  ...
  %vtable.i5 = load ptr, ptr %call6, align 8, !tbaa !12
  %vbase.offset.ptr.i6 = getelementptr i8, ptr %vtable.i5, i64 -24
  %vbase.offset.i7 = load i64, ptr %vbase.offset.ptr.i6, align 8, !invariant.load !14
  %add.ptr.i8 = getelementptr inbounds i8, ptr %call6, i64 %vbase.offset.i7
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i8, i8 noundef signext 10)
  %call1.i9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call6, i8 noundef signext %call.i)
