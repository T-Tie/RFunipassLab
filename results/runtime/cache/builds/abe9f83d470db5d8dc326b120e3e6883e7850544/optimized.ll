...
while.cond10:                                     ; preds = %while.body13, %if.else
  ...
  br i1 %cmp12, label %while.body13, label %if.end.loopexit
...
if.end.loopexit:                                  ; preds = %while.cond10
  %p.2.lcssa = phi ptr [ %p.2, %while.cond10 ]
  br label %if.end

if.end:                                           ; preds = %if.end.loopexit, %if.then
  %p.1 = phi ptr [ %incdec.ptr, %if.then ], [ %p.2.lcssa, %if.end.loopexit ]
