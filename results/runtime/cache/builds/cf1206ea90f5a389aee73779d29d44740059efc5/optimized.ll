...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 240, ptr noundef %p) #6
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx4 = getelementptr inbounds [3 x double], ptr %arrayidx, i64 0, i64 1
  %arrayidx7 = getelementptr inbounds [3 x double], ptr %arrayidx, i64 0, i64 2
...
if.end67:                                         ; preds = %if.end, %if.then58
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %7, double noundef %div74, double noundef %7, double noundef %div74)
...
if.end77:                                         ; preds = %if.else76, %if.end67
  br label %if.end78
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p0(i64 noundef 240, ptr noundef %p) #6
