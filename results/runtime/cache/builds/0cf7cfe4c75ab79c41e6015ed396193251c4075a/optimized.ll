...
for.cond16:                                       ; preds = %for.cond4, %for.inc42
  %.pre12 = phi i32 [ %.pre, %for.inc42 ], [ %0, %for.cond4 ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc42 ], [ 0, %for.cond4 ]
  ...
  %6 = sext i32 %.pre12 to i64
  %cmp17 = icmp slt i64 %indvars.iv9, %6
  br i1 %cmp17, label %for.body18, label %for.end44

for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv9
...
for.inc42:                                        ; preds = %for.body18, %if.then
  %.pre = phi i32 [ %.pre.pre, %if.then ], [ %.pre12, %for.body18 ]
