...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %r) #3
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %row) #4
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %col) #4
...
for.cond36:                                       ; preds = %for.inc47, %for.body34
  %sub.sink16 = phi i32 [ %sub, %for.body34 ], [ %dec, %for.inc47 ]
  %cmp37 = icmp sge i32 %sub.sink16, 0
...
for.body39:                                       ; preds = %for.cond36
  ...
  %idxprom42 = sext i32 %sub.sink16 to i64
...
if.then45:                                        ; preds = %for.body39
  store i32 %sub.sink, ptr %p, align 4, !tbaa !5
  store i32 %sub.sink16, ptr %q, align 4, !tbaa !5
  br label %for.inc50

for.inc47:                                        ; preds = %for.body39
  %dec = add nsw i32 %sub.sink16, -1
...
for.end53:                                        ; preds = %for.cond31
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %r) #4
