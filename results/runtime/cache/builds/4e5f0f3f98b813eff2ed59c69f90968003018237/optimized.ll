...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6, %for.cond1 ]
...
for.cond1.preheader:                              ; preds = %for.cond
  ...
  %3 = add i32 %2, -1
  %4 = trunc nuw i64 %indvars.iv.next6 to i32
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre9, %for.inc ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv5, i64 %indvars.iv
