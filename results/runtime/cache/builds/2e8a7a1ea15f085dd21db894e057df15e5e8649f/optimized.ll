...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select8 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select8
  ...
  %or.cond9 = or i1 %cmp12, %or.cond
  %smax12 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond9, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %x.1 = phi i32 [ %add18, %for.inc ], [ 0, %for.body ]
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond13.not = icmp eq i32 %m.0, %smax12
  br i1 %exitcond13.not, label %for.inc53, label %for.body16
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax12
