...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.end114 ], [ %2, %entry ]
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %3 = trunc nuw i64 %indvars.iv85 to i32
  %smax82 = call i32 @llvm.smax.i32(i32 %3, i32 0)
  %4 = icmp eq i64 %indvars.iv87, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv87 to i32
  %smax66 = call i32 @llvm.smax.i32(i32 %5, i32 0)
  %wide.trip.count45 = zext nneg i32 %smax66 to i64
  %wide.trip.count = and i64 %indvars.iv87, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv42 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next43, %for.inc28 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.cond31.preheader, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv42, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv37 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next38, %for.inc25 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv42, i64 %indvars.iv37
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv57 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next58, %for.inc66 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count45
  br i1 %exitcond62.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select35, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond51.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv47, i64 %indvars.iv57
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %spec.select35 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br label %for.cond34, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv52 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next53, %for.inc63 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv52, i64 %indvars.iv57
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc89 ], [ 1, %for.end68 ]
  %cmp73 = icmp slt i64 %indvars.iv69, %indvars.iv.next88
...
for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count45
  br i1 %exitcond68.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv69, i64 %indvars.iv63
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv69, i64 %indvars.iv63
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv79 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next80, %for.inc112 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count83
  br i1 %exitcond84.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond78.not = icmp eq i64 %indvars.iv72, %indvars.iv85
  br i1 %exitcond78.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv79, i64 %indvars.iv.next73
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !19
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv79, i64 %indvars.iv72
