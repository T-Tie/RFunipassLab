...
land.lhs.true14:                                  ; preds = %land.lhs.true
  ...
  %4 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !12
...
land.lhs.true19:                                  ; preds = %land.lhs.true14
  ...
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !12
...
for.cond41:                                       ; preds = %for.inc69, %for.body40
  %11 = phi i32 [ %inc70, %for.inc69 ], [ 0, %for.body40 ]
...
for.inc73:                                        ; preds = %for.cond41
  ...
  %call72 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %18) #5
