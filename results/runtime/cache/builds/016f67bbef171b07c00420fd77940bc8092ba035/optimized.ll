...
if.else:                                          ; preds = %while.body5
  ...
  store i8 32, ptr %__c.addr.i2, align 1, !tbaa !10
  %vtable.i3 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !14
  %vbase.offset.ptr.i4 = getelementptr i8, ptr %vtable.i3, i64 -24
  %vbase.offset.i5 = load i64, ptr %vbase.offset.ptr.i4, align 8, !invariant.load !16
  %gep24 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i5
  %3 = load i64, ptr %gep24, align 8, !tbaa !17
...
while.cond10:                                     ; preds = %while.cond10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14
  %p.2 = phi ptr [ %p.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit14 ], [ %incdec.ptr14, %while.cond10 ]
...
while.end16:                                      ; preds = %while.cond2
  ...
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i21)
...
!30 = !{!31, !35, i64 240}
!31 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !18, i64 0, !32, i64 216, !8, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
...
!40 = !{!"_ZTSNSt6locale5facetE", !24, i64 8}
