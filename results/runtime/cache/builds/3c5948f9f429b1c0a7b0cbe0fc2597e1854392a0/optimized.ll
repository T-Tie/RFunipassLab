...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv8 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next9, %for.inc27 ]
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv3 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next4, %for.inc24 ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond7.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv8, i64 %indvars.iv3
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv23 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next24, %for.inc67 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count11
  br i1 %exitcond28.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select1, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv13, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !14
  %spec.select1 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond36, !llvm.loop !18

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv18 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next19, %for.inc64 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count16
  br i1 %exitcond22.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv18, i64 %indvars.iv23
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc92 ], [ 2, %for.end69 ]
  %exitcond40.not = icmp eq i64 %indvars.iv34, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond96.preheader, label %for.cond76.preheader
...
for.cond76.preheader:                             ; preds = %for.cond71
  %5 = add nsw i64 %indvars.iv34, -1
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv29 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next30, %for.inc89 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count32
  br i1 %exitcond33.not, label %for.inc92, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv34, i64 %indvars.iv29
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !14
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv29
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv46 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next47, %for.inc117 ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count39
  br i1 %exitcond52.not, label %for.end119, label %for.cond101.preheader

for.cond101.preheader:                            ; preds = %for.cond96
  %7 = add nsw i64 %indvars.iv46, -1
  br label %for.cond101

for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv41 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next42, %for.inc114 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv41, i64 %indvars.iv46
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5, !invariant.load !14
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv41, i64 %7
