...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef align 16 %c) #9
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef align 16 %input) #9
