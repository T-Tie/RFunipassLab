...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 101, ptr noundef nonnull align 16 %a) #7
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 %a, i64 noundef 100)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @outlined_ir_func_0(ptr nonnull %arrayidx13)
...
for.inc24:                                        ; preds = %for.cond16
  ...
  call void @outlined_ir_func_0(ptr nonnull %arrayidx21)
...
define internal void @outlined_ir_func_0(ptr nonnull dereferenceable(1) %0) #6 {
newFuncRoot:
