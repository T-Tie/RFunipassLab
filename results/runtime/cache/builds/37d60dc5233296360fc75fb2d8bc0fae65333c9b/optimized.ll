...
if.then32:                                        ; preds = %if.else
  %call38 = call double @sqrt(double noundef %6) #7, !tbaa !5
  ...
  %call50 = call double @sqrt(double noundef %6) #7, !tbaa !5
...
cond.true:                                        ; preds = %if.else62
  ...
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg87, double noundef %10, double noundef %fneg87, double noundef %10)
  br label %for.inc106

cond.false:                                       ; preds = %if.else62
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %9, double noundef %10, double noundef %9, double noundef %10)
  br label %for.inc106
