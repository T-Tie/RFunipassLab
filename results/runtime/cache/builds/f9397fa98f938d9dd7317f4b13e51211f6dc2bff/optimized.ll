...
for.cond11:                                       ; preds = %for.end25, %for.end10
  %c1.0 = phi i32 [ undef, %for.end10 ], [ %c1.1, %for.end25 ]
  %r1.0 = phi i32 [ undef, %for.end10 ], [ %r1.1, %for.end25 ]
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc27, %for.end25 ]
...
for.cond14:                                       ; preds = %if.end, %for.body13
  %j.1 = phi i32 [ 0, %for.body13 ], [ %inc24, %if.end ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  br i1 %cmp22, label %for.end25, label %if.end
...
for.end25:                                        ; preds = %for.cond14, %for.body16
  %c1.1 = phi i32 [ %j.1, %for.body16 ], [ %c1.0, %for.cond14 ]
  %r1.1 = phi i32 [ %i.1, %for.body16 ], [ %r1.0, %for.cond14 ]
  %i.2 = phi i32 [ 9999, %for.body16 ], [ %i.1, %for.cond14 ]
...
for.cond33:                                       ; preds = %if.end43, %for.body31
  %j.2 = phi i32 [ %sub, %for.body31 ], [ %dec, %if.end43 ]
