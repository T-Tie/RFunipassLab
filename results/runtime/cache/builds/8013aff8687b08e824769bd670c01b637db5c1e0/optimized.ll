...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 500, ptr nonnull %dna1) #6
  call void @llvm.lifetime.start.p0(i64 500, ptr nonnull %dna2) #6
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  br i1 %exitcond.not, label %if.then107, label %for.body
...
for.inc:                                          ; preds = %lor.lhs.false83, %lor.lhs.false83, %lor.lhs.false83, %lor.lhs.false83, %if.then45
  %t.4 = phi i32 [ %t.0, %if.then45 ], [ %t.2, %lor.lhs.false83 ], [ %t.2, %lor.lhs.false83 ], [ %t.2, %lor.lhs.false83 ], [ %t.2, %lor.lhs.false83 ]
...
if.end113:                                        ; preds = %if.then111, %if.then107
  %5 = phi double [ %.pre, %if.then111 ], [ %4, %if.then107 ]
  %cmp114 = fcmp ugt double %div, %5
  br i1 %cmp114, label %if.end123, label %if.then115

if.then115:                                       ; preds = %if.end113
  %call116 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3)
  br label %if.end123

if.end123:                                        ; preds = %if.end63, %lor.lhs.false83, %if.end113, %if.then115
  %cmp9.not43 = icmp slt i64 %indvars.iv, %0
  br i1 %cmp9.not43, label %if.end127.sink.split, label %if.end127

if.end127.sink.split:                             ; preds = %if.end123, %entry
  %call12234 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4)
  br label %if.end127

if.end127:                                        ; preds = %if.end127.sink.split, %if.end123
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %a) #6
  call void @llvm.lifetime.end.p0(i64 500, ptr nonnull %dna2) #6
  call void @llvm.lifetime.end.p0(i64 500, ptr nonnull %dna1) #6
  ret i32 0
}
