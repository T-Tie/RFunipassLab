...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv42 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next43, %for.inc27 ]
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc24 ], [ 0, %for.cond16.preheader ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.inc27, label %for.inc24
...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc67 ], [ 0, %for.cond ]
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc64 ], [ 0, %for.cond55.preheader ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc67, label %for.inc64
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc92 ], [ 2, %for.end69 ]
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv63 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next64, %for.inc89 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond67.not, label %for.inc92, label %for.inc89
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc117 ], [ 2, %for.cond71 ]
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv75 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next76, %for.inc114 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count
  br i1 %exitcond79.not, label %for.inc117, label %for.inc114
