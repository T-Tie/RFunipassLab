...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax50 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc125 ], [ 0, %if.end68 ]
...
if.then85:                                        ; preds = %land.lhs.true
  ...
  %9 = add nsw i64 %indvars.iv38, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %9
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %10 = load i32, ptr %arrayidx101, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 %indvars.iv38
