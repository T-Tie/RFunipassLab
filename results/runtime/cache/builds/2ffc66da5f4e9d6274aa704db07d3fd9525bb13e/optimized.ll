...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 120, ptr %w) #3
  call void @llvm.lifetime.start.p0(i64 120, ptr %f) #3
...
for.end46:                                        ; preds = %for.cond34
  ...
  call void @llvm.lifetime.end.p0(i64 120, ptr %f) #3
  call void @llvm.lifetime.end.p0(i64 120, ptr %w) #3
