...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv62 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc31 ], [ 0, %for.cond ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %indvars.iv62
  br i1 %exitcond20.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv16
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv62
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv16, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv11 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next12, %for.inc28 ]
...
for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv16, i64 %indvars.iv11
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %indvars.iv62
  br i1 %exitcond40.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %indvars.iv62
  br i1 %exitcond25.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv21, i64 %indvars.iv36
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv36
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select4, %for.body57 ], [ %6, %if.then51 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %indvars.iv62
  br i1 %exitcond30.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv26, i64 %indvars.iv36
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv31 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next32, %for.inc84 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %indvars.iv62
  br i1 %exitcond35.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv31, i64 %indvars.iv36
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %indvars.iv62
  br i1 %exitcond51.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %indvars.iv62
  br i1 %exitcond46.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv47, i64 %indvars.iv41
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv41, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv47, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %indvars.iv62
  br i1 %exitcond61.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep7 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv57
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv52 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next53, %for.inc129 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %indvars.iv62
  br i1 %exitcond56.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv52, i64 %indvars.iv57
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep8 = getelementptr [100 x i32], ptr %invariant.gep7, i64 %indvars.iv52
  store i32 %12, ptr %gep8, align 4, !tbaa !5
