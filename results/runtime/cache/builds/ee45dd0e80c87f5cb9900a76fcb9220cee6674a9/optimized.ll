...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv25 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %indvars30 = trunc i64 %indvars.iv25 to i32
  %5 = add nsw i64 %indvars.iv25, -1
  %cmp15 = icmp sgt i32 %indvars30, 0
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv18, %10
