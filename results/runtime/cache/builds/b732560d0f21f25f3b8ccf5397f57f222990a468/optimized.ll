...
for.body15:                                       ; preds = %for.cond13
  ...
  %cmp18 = icmp slt i32 %2, %Max.0.lcssa
...
for.end28:                                        ; preds = %for.cond13
  %Max2.0.lcssa = phi i32 [ %Max2.0, %for.cond13 ]
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %Max.0.lcssa)
  ...
  %call31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %Max2.0.lcssa)
