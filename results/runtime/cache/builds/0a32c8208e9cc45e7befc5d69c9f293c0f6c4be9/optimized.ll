...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax61 = call i32 @llvm.smax.i32(i32 %indvars.iv24, i32 noundef 1)
  %smax50 = call i32 @llvm.smax.i32(i32 %indvars.iv24.in, i32 noundef 0)
  %0 = zext i32 %indvars.iv24 to i64
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond36.not, label %for.cond27.preheader, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv27 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next28, %for.inc21 ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv47 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next48, %for.inc62 ]
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  ...
  %min.1 = phi i32 [ %spec.select16, %for.body34 ], [ %4, %for.body29 ]
...
for.body34:                                       ; preds = %for.cond32
  ...
  %spec.select16 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv42 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next43, %for.inc59 ]
...
if.then:                                          ; preds = %for.end64
  store i32 %smax50, ptr @j, align 4, !tbaa !5
...
for.cond66.loopexit:                              ; preds = %for.cond81
  br label %for.cond66, !llvm.loop !17

for.cond66:                                       ; preds = %for.cond66.loopexit, %if.end
  %indvars.iv58 = phi i64 [ 1, %if.end ], [ %indvars.iv.next59, %for.cond66.loopexit ]
...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  %exitcond57.not = icmp eq i64 %indvars.iv53, %0
  br i1 %exitcond57.not, label %for.cond66.loopexit, label %for.inc95
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %result) #6
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  %1 = phi i32 [ %2, %for.inc10 ], [ %0, %for.cond1.preheader ]
  %storemerge3 = phi i32 [ %inc11, %for.inc10 ], [ 0, %for.cond1.preheader ]
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc
  %2 = phi i32 [ %.pre5, %for.inc ], [ %1, %for.cond4.preheader ]
  %storemerge4 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond4.preheader ]
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z4xiaoi(i32 noundef %1) #7
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc26
  %6 = phi i32 [ %.pre, %for.inc26 ], [ %0, %for.cond19.preheader ]
  %storemerge2 = phi i32 [ %inc27, %for.inc26 ], [ 0, %for.cond19.preheader ]
...
for.end28:                                        ; preds = %for.cond19
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %result) #7
