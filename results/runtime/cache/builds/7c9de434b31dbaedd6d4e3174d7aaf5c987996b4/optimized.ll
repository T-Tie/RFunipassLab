...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %m1) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr %m2) #5
...
for.cond14:                                       ; preds = %for.inc, %if.then13
  ...
  %x.1 = phi i32 [ 0, %if.then13 ], [ %x.2, %for.inc ]
...
sw.bb:                                            ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16
  %add = add nsw i32 %x.1, 31
  br label %for.inc

sw.bb17:                                          ; preds = %for.body16
  %add18 = add nsw i32 %x.1, 29
  br label %for.inc

sw.default:                                       ; preds = %for.body16
  %add19 = add nsw i32 %x.1, 30
  br label %for.inc

for.inc:                                          ; preds = %sw.bb, %sw.bb17, %sw.default
  %x.2 = phi i32 [ %add19, %sw.default ], [ %add, %sw.bb ], [ %add18, %sw.bb17 ]
...
if.then22:                                        ; preds = %for.end
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
for.cond30:                                       ; preds = %for.inc40, %if.else29
  ...
  %x.4 = phi i32 [ 0, %if.else29 ], [ %x.5, %for.inc40 ]
...
sw.bb33:                                          ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32
  %add34 = add nsw i32 %x.4, 31
  br label %for.inc40

sw.bb35:                                          ; preds = %for.body32
  %add36 = add nsw i32 %x.4, 28
  br label %for.inc40

sw.default37:                                     ; preds = %for.body32
  %add38 = add nsw i32 %x.4, 30
  br label %for.inc40

for.inc40:                                        ; preds = %sw.bb33, %sw.bb35, %sw.default37
  %x.5 = phi i32 [ %add38, %sw.default37 ], [ %add34, %sw.bb33 ], [ %add36, %sw.bb35 ]
...
if.then45:                                        ; preds = %for.end42
  %call46 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
...
if.else48:                                        ; preds = %for.end42
  %call49 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
...
for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %m2) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %m1) #5
