...
entry:
  ...
  %rem111 = srem i8 %rem1.lhs.trunc, 50
  %rem1.sext = sext i8 %rem111 to i32
  %sub2 = sub nsw i32 %rem, %rem1.sext
  %div3.lhs.trunc = trunc nsw i32 %sub2 to i16
  %div312 = sdiv i16 %div3.lhs.trunc, 50
  %div3.sext = sext i16 %div312 to i32
  %rem413 = srem i8 %rem111, 20
  %div614 = sdiv i8 %rem111, 20
  %div6.sext = sext i8 %div614 to i32
  %rem715 = srem i8 %rem413, 10
  %rem7.sext = sext i8 %rem715 to i32
  %div916 = sdiv i8 %rem413, 10
  %div9.sext = sext i8 %div916 to i32
  store i32 %rem7.sext, ptr %n, align 4, !tbaa !5
  %rem1017 = srem i8 %rem715, 5
  %rem10.sext = sext i8 %rem1017 to i32
  %div1218 = sdiv i8 %rem715, 5
  %div12.sext = sext i8 %div1218 to i32
