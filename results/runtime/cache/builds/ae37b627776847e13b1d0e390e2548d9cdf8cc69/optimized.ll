...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax106 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %smax82 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count67 = zext nneg i32 %smax82 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond68.not = icmp eq i64 %indvars.iv64, %wide.trip.count67
  br i1 %exitcond68.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count72 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv64
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv64, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond2, %for.body16
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body16 ], [ 0, %for.cond2 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count
  br i1 %exitcond63.not, label %for.inc24, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv64, i64 %indvars.iv59
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv79 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next80, %for.inc60 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count67
  br i1 %exitcond84.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv79
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select57, %for.body34 ], [ %3, %for.body29 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %wide.trip.count72
  br i1 %exitcond73.not, label %for.cond49, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv69, i64 %indvars.iv79
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select57 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  br label %for.cond32, !llvm.loop !19

for.cond49:                                       ; preds = %for.cond32, %for.body51
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.body51 ], [ 0, %for.cond32 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %wide.trip.count72
  br i1 %exitcond78.not, label %for.inc60, label %for.body51

for.body51:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv74, i64 %indvars.iv79
...
for.cond65.preheader:                             ; preds = %for.end62
  %wide.trip.count95 = zext nneg i32 %smax106 to i64
  %wide.trip.count88 = zext i32 %n.tr to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv90 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next91, %for.inc83 ]
  %exitcond96.not = icmp eq i64 %indvars.iv90, %wide.trip.count95
  br i1 %exitcond96.not, label %for.cond86.preheader, label %for.cond68.preheader

for.cond86.preheader:                             ; preds = %for.cond65
  %wide.trip.count100 = zext i32 %n.tr to i64
  br label %for.cond86
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.body70
  %indvars.iv85 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next86, %for.body70 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count88
  br i1 %exitcond89.not, label %for.inc83, label %for.body70

for.body70:                                       ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv90, i64 %indvars.iv85
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv85
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv102 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next103, %for.inc104 ]
  %exitcond108.not = icmp eq i64 %indvars.iv102, %wide.trip.count95
  br i1 %exitcond108.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv102, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.body91
  %indvars.iv97 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next98, %for.body91 ]
  %exitcond101.not = icmp eq i64 %indvars.iv97, %wide.trip.count100
  br i1 %exitcond101.not, label %for.inc104, label %for.body91

for.body91:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv97, i64 %indvars.iv102
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv97, i64 %9
