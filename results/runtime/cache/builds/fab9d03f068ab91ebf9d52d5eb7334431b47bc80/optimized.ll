...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv27 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next28, %if.end ]
  %m.0 = phi i32 [ 0, %for.cond2.preheader ], [ %m.1, %if.end ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax39 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.end43
  %indvars.iv34 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next35, %for.end43 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.end43 ]
  %exitcond40.not = icmp eq i32 %j.0, %smax39
  br i1 %exitcond40.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax36 = call i32 @llvm.smax.i32(i32 %indvars.iv34, i32 noundef 0)
  %wide.trip.count37 = zext nneg i32 %smax36 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax45 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %if.end40
  %indvars.iv31 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next32, %if.end40 ]
  %exitcond38.not = icmp eq i64 %indvars.iv31, %wide.trip.count37
  br i1 %exitcond38.not, label %for.end43, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv31
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next32
...
for.cond47:                                       ; preds = %for.cond47.preheader, %if.end57
  %indvars.iv41 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next42, %if.end57 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv41
  ...
  %cmp54.not = icmp eq i64 %indvars.iv41, %4
