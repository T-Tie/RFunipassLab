...
for.inc:                                          ; preds = %land.lhs.true, %if.then, %for.body4
  %b1.2 = phi i32 [ %b1.1, %for.body4 ], [ %i.0, %if.then ], [ %i.0, %land.lhs.true ]
  %a2.3 = phi i32 [ %a2.1, %for.body4 ], [ %j.0, %if.then ], [ %a2.1, %land.lhs.true ]
  %a1.3 = phi i32 [ %a1.1, %for.body4 ], [ %i.0, %if.then ], [ %a1.1, %land.lhs.true ]
