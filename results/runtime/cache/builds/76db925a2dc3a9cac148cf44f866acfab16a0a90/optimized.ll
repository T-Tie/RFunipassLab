...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv12.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv12, %for.cond17 ]
  %indvars.iv12 = add i32 %indvars.iv12.in, -1
  %cmp15 = icmp sgt i32 %indvars.iv12.in, 0
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv8 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next9, %for.inc37 ]
  %exitcond15.not = icmp eq i64 %indvars.iv8, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond14, label %for.body19, !llvm.loop !14
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv16, %8
