...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv36.in = phi i32 [ %indvars.iv36, %for.end100 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %indvars.iv36 = add i32 %indvars.iv36.in, -1
  %smax73 = call i32 @llvm.smax.i32(i32 %indvars.iv36, i32 noundef 1)
  %smax62 = call i32 @llvm.smax.i32(i32 %indvars.iv36.in, i32 noundef 0)
  %0 = zext i32 %indvars.iv36 to i64
  %wide.trip.count47 = zext nneg i32 %smax62 to i64
  %wide.trip.count = zext i32 %indvars.iv36.in to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count47
  br i1 %exitcond48.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv39 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next40, %for.inc21 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count
  br i1 %exitcond43.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv39
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv36.in, ptr @k, align 4, !tbaa !5
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  br label %for.cond, !llvm.loop !13

for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv59 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next60, %for.inc62 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count47
  br i1 %exitcond64.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv59
  %4 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select28, %for.body34 ], [ %4, %for.body29 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %wide.trip.count
  br i1 %exitcond53.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv49, i64 %indvars.iv59
  %5 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select28 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv54 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next55, %for.inc59 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count
  br i1 %exitcond58.not, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv54, i64 %indvars.iv59
...
for.end64:                                        ; preds = %for.cond27
  %cmp65 = icmp eq i32 %indvars.iv36.in, 2
...
for.cond66:                                       ; preds = %for.cond81, %for.cond66.preheader
  %indvars.iv70 = phi i64 [ 1, %for.cond66.preheader ], [ %indvars.iv.next71, %for.cond81 ]
  %exitcond75.not = icmp eq i64 %indvars.iv70, %wide.trip.count74
  br i1 %exitcond75.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next71
  %8 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv70
  store i32 %8, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next71
  %9 = load i32, ptr %arrayidx76, align 16, !tbaa !5
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv70
  store i32 %9, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %0
  br i1 %exitcond69.not, label %for.cond66, label %for.inc95, !llvm.loop !17

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next71, i64 %indvars.iv.next66
  %10 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv70, i64 %indvars.iv65
  store i32 %10, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.cond81, !llvm.loop !18

for.end100:                                       ; preds = %for.cond66
  store i32 %smax73, ptr @i, align 4, !tbaa !5
  %add102 = add nsw i32 %7, %accumulator.tr
  br label %tailrecurse

cleanup:                                          ; preds = %for.end64
  store i32 %smax62, ptr @j, align 4, !tbaa !5
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %storemerge8 = phi i32 [ %inc11, %for.inc10 ], [ 0, %for.cond ]
  store i32 %storemerge8, ptr @j, align 4, !tbaa !5
  %cmp2 = icmp slt i32 %storemerge8, %1
  br i1 %cmp2, label %for.cond4, label %for.inc16

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre13, %for.inc ], [ %storemerge8, %for.cond1 ]
  %3 = phi i32 [ %.pre12, %for.inc ], [ %1, %for.cond1 ]
  %storemerge9 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond1 ]
  store i32 %storemerge9, ptr @k, align 4, !tbaa !5
  %cmp5 = icmp slt i32 %storemerge9, %3
  br i1 %cmp5, label %for.inc, label %for.inc10

for.inc:                                          ; preds = %for.cond4
  %idxprom = sext i32 %2 to i64
  %idxprom7 = sext i32 %storemerge9 to i64
  ...
  %.pre13 = load i32, ptr @j, align 4, !tbaa !5
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  ...
  %storemerge7 = phi i32 [ %inc27, %for.inc26 ], [ 0, %for.cond ]
  store i32 %storemerge7, ptr @l, align 4, !tbaa !5
  %cmp20 = icmp slt i32 %storemerge7, %6
  br i1 %cmp20, label %for.inc26, label %for.end28

for.inc26:                                        ; preds = %for.cond19
  %idxprom22 = sext i32 %storemerge7 to i64
