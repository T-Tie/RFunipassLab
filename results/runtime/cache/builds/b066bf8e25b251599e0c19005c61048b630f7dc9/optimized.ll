...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 60, ptr noundef nonnull align 16 %n) #3
...
while.body2:                                      ; preds = %while.body, %if.end5
  %indvars.iv = phi i64 [ 0, %while.body ], [ %indvars.iv.next, %if.end5 ]
...
if.then:                                          ; preds = %while.body2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 60, ptr noundef nonnull %n) #4
  ret i32 0
...
for.cond:                                         ; preds = %for.cond8, %while.body2
  %indvars.iv15 = phi i64 [ %indvars.iv, %while.body2 ], [ %indvars.iv.next16, %for.cond8 ]
  %y.0 = phi i32 [ 0, %while.body2 ], [ %y.1, %for.cond8 ]
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  %cmp6 = icmp sgt i64 %indvars.iv15, 0
  br i1 %cmp6, label %for.body, label %for.end26

for.body:                                         ; preds = %for.cond
  %arrayidx12 = getelementptr inbounds [15 x i32], ptr %n, i64 0, i64 %indvars.iv.next16
