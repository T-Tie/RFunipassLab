...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef nonnull %a) #11
...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #12
...
for.inc31:                                        ; preds = %for.cond23
  ...
  call void @outlined_ir_func_2(ptr noundef nonnull dereferenceable(1) %add.ptr27)
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i)
  call void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) %__c.addr.i)
...
for.end33:                                        ; preds = %for.cond23
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %gep101)
  %12 = trunc nuw nsw i64 %indvars.iv112 to i32
...
for.inc54:                                        ; preds = %for.cond45
  ...
  call void @outlined_ir_func_2(ptr noundef nonnull dereferenceable(1) %add.ptr50)
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i34)
  call void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) %__c.addr.i34)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i34)
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %add.ptr59)
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef nonnull %a) #11
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !43, !invariant.load !11
...
define internal void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) #9 {
for.end33_after_outline.exitStub:
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #14
  %call1.i16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0, i64 noundef %call.i.i15)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) %0) #9 {
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline:
  store i8 32, ptr %0, align 1, !tbaa !43
  ...
  %1 = load i64, ptr %gep100, align 8, !tbaa !12, !invariant.load !11
  %cmp.not.i = icmp eq i64 %1, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i11

if.then.i11:                                      ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0, i64 noundef 1)
  br label %for.inc31.exitStub

if.end.i:                                         ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline
...
for.inc31.exitStub:                               ; preds = %if.end.i, %if.then.i11
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_2(ptr noundef nonnull dereferenceable(1) %0) #9 {
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #14
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0, i64 noundef %call.i.i)
  ret void
}
...
attributes #14 = { nofree nosync nounwind willreturn memory(read) }
