...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  ...
  %phiofops = mul nuw nsw i64 %indvars.iv12, %1
...
for.body19:                                       ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv24, %1
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc47 ], [ %indvars.iv12, %for.cond39.preheader ]
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select3, %for.body62 ], [ %10, %for.body55 ]
...
for.body62:                                       ; preds = %for.cond60
  %11 = mul nuw nsw i64 %indvars.iv29, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %11
  %12 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select3 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc85 ], [ %indvars.iv12, %for.cond77.preheader ]
  %exitcond38 = icmp eq i64 %indvars.iv34, %1
  br i1 %exitcond38, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv34, %1
  %gep5 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep5, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next13, %1
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  ...
  %18 = trunc nuw i64 %indvars.iv46 to i32
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %20 = mul nuw nsw i64 %indvars.iv46, %1
