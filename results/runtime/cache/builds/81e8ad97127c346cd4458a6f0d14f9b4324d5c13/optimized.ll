...
if.end38:                                         ; preds = %if.else, %if.then35
  %.sink2 = phi i32 [ 28, %if.else ], [ 29, %if.then35 ]
  %add37 = add nsw i32 %total1.2, %.sink2
  br label %if.end39
...
if.end68:                                         ; preds = %if.then66, %lor.lhs.false64
  %total2.2 = phi i32 [ %add67, %if.then66 ], [ %total2.1, %lor.lhs.false64 ]
...
if.end83:                                         ; preds = %if.else81, %if.then79
  %.sink1 = phi i32 [ 28, %if.else81 ], [ 29, %if.then79 ]
  %add82 = add nsw i32 %total2.2, %.sink1
  br label %if.end84

if.end84:                                         ; preds = %if.end83, %if.end68
  %total2.3 = phi i32 [ %add82, %if.end83 ], [ %total2.2, %if.end68 ]
  br label %for.inc85
