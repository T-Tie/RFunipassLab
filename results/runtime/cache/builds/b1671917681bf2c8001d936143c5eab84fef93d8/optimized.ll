...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  ...
  br i1 %exitcond.not, label %for.cond11.preheader, label %for.inc8
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.body13
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body13 ], [ 0, %for.cond11.preheader ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond11.preheader ]
