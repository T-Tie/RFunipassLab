...
if.then24:                                        ; preds = %for.body4, %for.body4, %for.body4, %for.body4, %if.then, %if.then, %if.then, %if.then
...
for.inc.sink.split:                               ; preds = %if.then35, %if.else, %if.then24
  %add25.sink = phi i32 [ %add25, %if.then24 ], [ %add37, %if.else ], [ %add36, %if.then35 ]
