...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %.sink24 = phi i32 [ %5, %if.then ], [ %add16, %for.inc25 ]
  %_ZSt4cout.sink23 = phi ptr [ @_ZSt4cout, %if.then ], [ %call20, %for.inc25 ]
  %.sink15 = phi i32 [ %5, %if.then ], [ %add16, %for.inc25 ]
  %idxprom12 = sext i32 %.sink24 to i64
  %arrayidx13 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom12
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink23, ptr noundef %arrayidx13)
  %add16 = add nsw i32 %.sink15, 1
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %.sink22 = phi i32 [ %6, %if.then30 ], [ %add35, %for.inc44 ]
  %_ZSt4cout.sink21 = phi ptr [ @_ZSt4cout, %if.then30 ], [ %call39, %for.inc44 ]
  %.sink14 = phi i32 [ %6, %if.then30 ], [ %add35, %for.inc44 ]
  %idxprom31 = sext i32 %.sink22 to i64
  %arrayidx32 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom31
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink21, ptr noundef %arrayidx32)
  %add35 = add nsw i32 %.sink14, 1
