...
while.cond.preheader:                             ; preds = %for.cond1
  %smax77 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
for.cond14.preheader:                             ; preds = %while.cond
  %smax73 = call i32 @llvm.smax.i32(i32 %indvars.iv14, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond20.not, label %for.cond45, label %for.body16
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count19
  br i1 %exitcond31.not, label %for.cond70, label %for.cond49.preheader
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond42.not = icmp eq i64 %indvars.iv37, %wide.trip.count19
  br i1 %exitcond42.not, label %for.cond104, label %for.body73
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond64.not, label %for.cond154, label %for.cond135
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc174 ], [ 0, %for.cond131 ]
