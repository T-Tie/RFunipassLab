...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax83 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax59 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  ...
  br i1 %exitcond45.not, label %for.cond31, label %for.cond2
...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc67 ], [ 0, %for.cond ]
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc64 ], [ 0, %for.cond55.preheader ]
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  ...
  br i1 %exitcond73.not, label %for.cond96, label %for.cond76.preheader
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc117 ], [ 2, %for.cond71 ]
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !54, !invariant.load !14
