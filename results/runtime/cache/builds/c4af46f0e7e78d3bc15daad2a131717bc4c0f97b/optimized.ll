...
for.inc:                                          ; preds = %for.cond
  %call4 = call noundef i32 @_Z3numiii(i32 noundef %1, i32 noundef %i.0, i32 noundef 2) #10
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax3 = tail call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %div = sdiv i32 %n, %0
  %call = tail call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #11
