...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  br i1 %exitcond.not, label %for.cond50.preheader, label %for.body
...
for.body:                                         ; preds = %for.cond
  ...
  switch i8 %8, label %if.end75.loopexit [
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  switch i8 %9, label %if.end75.loopexit [
    i8 65, label %for.inc
    i8 71, label %for.inc
    i8 67, label %for.inc
    i8 84, label %for.inc
...
for.cond50:                                       ; preds = %for.cond50.preheader, %for.body52
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body52 ], [ 0, %for.cond50.preheader ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond50.preheader ]
...
if.end75.loopexit:                                ; preds = %land.lhs.true, %for.body
  br label %if.end75

if.end75:                                         ; preds = %if.end75.loopexit, %for.end65, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit38
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit38 ], [ %.str.3..str.2, %for.end65 ], [ @.str.1, %if.end75.loopexit ]
