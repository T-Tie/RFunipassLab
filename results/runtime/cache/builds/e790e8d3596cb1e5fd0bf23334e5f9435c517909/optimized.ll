...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax61 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax50 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond25, label %for.cond26.preheader, label %for.cond2

for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count29 = zext i32 %indvars.iv14 to i64
  br label %for.cond26
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv16 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next17, %for.inc20 ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv36 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next37, %for.inc57 ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body31
  ...
  %exitcond30 = icmp eq i64 %indvars.iv26, %wide.trip.count29
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv31 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next32, %for.inc54 ]
  %exitcond35 = icmp eq i64 %indvars.iv31, %wide.trip.count29
...
for.cond80.preheader:                             ; preds = %for.cond60
  ...
  %wide.trip.count56 = zext i32 %n.tr to i64
  br label %for.cond80
