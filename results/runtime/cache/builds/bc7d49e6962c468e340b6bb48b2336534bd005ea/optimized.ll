...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %c) #8
...
if.then:                                          ; preds = %entry
  ...
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %c)
  %tobool = icmp ne i32 %t, 0
  br i1 %tobool, label %if.end, label %if.then3

if.then3:                                         ; preds = %if.then
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %if.end
...
if.end5:                                          ; preds = %if.end, %entry
  call void @llvm.lifetime.end.p0(i64 100, ptr %c) #8
  ret void
}
...
entry:
  ...
  store i8 %__c, ptr %__c.addr, align 1, !tbaa !8
  %vtable = load ptr, ptr %__out, align 8, !tbaa !5
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %add.ptr = getelementptr inbounds i8, ptr %__out, i64 %vbase.offset
...
if.end:                                           ; preds = %entry
  %0 = load i8, ptr %__c.addr, align 1, !tbaa !8
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !10
  ret i32 %0
}
...
!10 = !{!11, !14, i64 32}
!11 = !{!"_ZTSSt8ios_base", !12, i64 8, !12, i64 16, !13, i64 24, !14, i64 28, !14, i64 32, !15, i64 40, !17, i64 48, !9, i64 64, !18, i64 192, !19, i64 200, !20, i64 208}
!12 = !{!"long", !9, i64 0}
!13 = !{!"_ZTSSt13_Ios_Fmtflags", !9, i64 0}
!14 = !{!"_ZTSSt12_Ios_Iostate", !9, i64 0}
