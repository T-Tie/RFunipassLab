...
for.cond:                                         ; preds = %if.end28, %entry
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end28 ], [ 0, %entry ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv24
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc25 ], [ 0, %for.end ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv19
...
for.cond:                                         ; preds = %if.end27, %entry
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end27 ], [ 0, %entry ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end30, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv24
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv24
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc24 ], [ 0, %for.end ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %if.end27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv24
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.end ], [ 2, %entry ]
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.end36
  %indvars.iv32 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next33, %for.end36 ]
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  ...
  br i1 %exitcond31.not, label %for.end36, label %for.inc34
...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre18 = phi i32 [ %.pre1820, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc10 ], [ 0, %while.body ]
  %0 = sext i32 %.pre18 to i64
  %cmp = icmp slt i64 %indvars.iv14, %0
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre1820 = phi i32 [ %.pre1819, %for.inc ], [ %.pre18, %for.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond ]
  %1 = sext i32 %.pre1820 to i64
  %cmp4 = icmp slt i64 %indvars.iv, %1
  br i1 %cmp4, label %for.body6, label %for.inc10

for.body6:                                        ; preds = %for.cond3
  %2 = or i64 %indvars.iv, %indvars.iv14
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre1819 = phi i32 [ %.pre1820, %for.body6 ], [ %.pre17, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %storemerge = phi i32 [ %dec, %for.inc17 ], [ %.pre18, %for.cond ]
...
for.inc17:                                        ; preds = %for.cond13
  tail call void @_Z7zerorowi(i32 noundef %storemerge) #11
  %4 = load i32, ptr @k, align 4, !tbaa !5
  tail call void @_Z7zerocoli(i32 noundef %4) #11
  ...
  tail call void @_Z4jiani(i32 noundef %7) #11
