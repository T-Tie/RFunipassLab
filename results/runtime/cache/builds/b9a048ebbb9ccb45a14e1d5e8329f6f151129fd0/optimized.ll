...
land.lhs.true:                                    ; preds = %lor.lhs.false21, %lor.lhs.false16, %lor.lhs.false, %for.body
  ...
  %2 = load i8, ptr %arrayidx27, align 1, !tbaa !9, !invariant.load !10
...
lor.lhs.false40:                                  ; preds = %lor.lhs.false35
  %3 = load i8, ptr %arrayidx27, align 1, !tbaa !9
...
lor.lhs.false83:                                  ; preds = %land.lhs.true78, %land.lhs.true73, %land.lhs.true68, %if.end63
  ...
  %6 = load i8, ptr %arrayidx85, align 1, !tbaa !9
  %conv86 = sext i8 %6 to i32
...
if.then107:                                       ; preds = %for.cond
  ...
  %conv108 = sitofp i32 %7 to double
  %conv109 = sitofp i32 %conv to double
  %div = fdiv double %conv108, %conv109
  %8 = load double, ptr %a, align 8, !tbaa !14
  %cmp110 = fcmp ogt double %div, %8
...
if.end113:                                        ; preds = %if.then111, %if.then107
  %9 = load double, ptr %a, align 8, !tbaa !14
  %cmp114 = fcmp ole double %div, %9
...
if.end127:                                        ; preds = %if.then125, %if.end123
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %flag) #7
