...
for.cond51:                                       ; preds = %entry, %for.cond51
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.cond51 ], [ 0, %entry ]
  ...
  br i1 %exitcond38.not, label %for.end65, label %for.cond51, !llvm.loop !9
...
for.cond73:                                       ; preds = %for.end65
  ...
  %call1.i6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call70, i8 noundef signext %call.i5)
