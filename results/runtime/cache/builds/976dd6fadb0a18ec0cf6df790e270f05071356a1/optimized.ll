...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x) #6
...
for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x) #7
...
for.end_to_outline:
  ...
  br i1 %cmp21, label %if.end52.exitStub, label %if.else25

if.else25:                                        ; preds = %for.end_to_outline
  br label %if.end52.exitStub

if.end52.exitStub:                                ; preds = %if.else25, %for.end_to_outline
  %.str.1.sink = phi ptr [ @.str.1, %if.else25 ], [ @.str, %for.end_to_outline ]
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %.str.1.sink)
