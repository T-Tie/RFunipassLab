...
entry:
  ...
  %rem19 = srem i8 %rem1.lhs.trunc, 50
  %rem1.sext = sext i8 %rem19 to i32
  %sub2 = sub nsw i32 %rem, %rem1.sext
  %div3.lhs.trunc = trunc nsw i32 %sub2 to i16
  %div310 = sdiv i16 %div3.lhs.trunc, 50
  %div3.sext = sext i16 %div310 to i32
  %rem411 = srem i8 %rem19, 20
  %div612 = sdiv i8 %rem19, 20
  %div6.sext = sext i8 %div612 to i32
  %rem713 = srem i8 %rem411, 10
  %rem7.sext = sext i8 %rem713 to i32
  %div914 = sdiv i8 %rem411, 10
  %div9.sext = sext i8 %div914 to i32
  store i32 %rem7.sext, ptr %n, align 4, !tbaa !5
  %rem1015 = srem i8 %rem713, 5
  %rem10.sext = sext i8 %rem1015 to i32
  %div1216 = sdiv i8 %rem713, 5
  %div12.sext = sext i8 %div1216 to i32
