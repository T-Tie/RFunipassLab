...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv5 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv13.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv13, %for.cond17 ]
  %.in = phi i32 [ %0, %for.cond14.preheader ], [ %4, %for.cond17 ]
  %indvars.iv13 = add i32 %indvars.iv13.in, -1
  %4 = add nsw i32 %.in, -1
  %cmp15 = icmp sgt i32 %.in, 0
  br i1 %cmp15, label %for.cond17.preheader, label %for.end41

for.cond17.preheader:                             ; preds = %for.cond14
  %wide.trip.count15 = zext i32 %indvars.iv13 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv9 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next10, %for.inc37 ]
  %exitcond16.not = icmp eq i64 %indvars.iv9, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond14, label %for.body19, !llvm.loop !14

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv9
  %5 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next10
...
for.end41:                                        ; preds = %for.cond14
  %sub42 = sub i32 %0, %n.0
  %7 = sext i32 %sub42 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.inc50, %for.end41
  %8 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.end41 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc50 ], [ %7, %for.end41 ]
  %sub44 = add nsw i32 %8, -1
  %9 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv17, %9
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv17
  %10 = load i32, ptr %arrayidx48, align 4, !tbaa !5, !invariant.load !12
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %10)
...
for.end52:                                        ; preds = %for.cond43
  %arrayidx55 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %9
  %11 = load i32, ptr %arrayidx55, align 4, !tbaa !5
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11)
