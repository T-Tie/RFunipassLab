...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax23 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax24 = call i32 @llvm.smax.i32(i32 %smax23, i32 noundef 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax30 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond56.not = icmp eq i64 %indvars.iv50, %wide.trip.count
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv74 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre.pre-phi, %for.inc198 ]
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax65 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond67.not, label %if.end178.loopexit87, label %for.inc148
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax71 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
...
if.end178.loopexit87:                             ; preds = %for.cond137
  %.pre88 = add nuw nsw i64 %indvars.iv74, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit87
  %.pre.pre-phi = phi i64 [ %.pre88, %if.end178.loopexit87 ], [ %20, %for.cond158 ]
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar2 = call i32 @putchar(i32 noundef 10) #7
  br label %for.inc198
