...
entry:
  ...
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef nonnull align 4 dereferenceable(4) %x1, ptr noundef nonnull align 4 dereferenceable(4) %y1)
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call2.loc)
  call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %x1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %y1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call2.loc)
  %call2.reload = load ptr, ptr %call2.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef %call2.loc)
  br label %for.end10

for.end10:                                        ; preds = %entry
  %call11 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef nonnull align 4 dereferenceable(4) %x2, ptr noundef nonnull align 4 dereferenceable(4) %y2)
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call15.loc)
  call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %x2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %y2, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call15.loc)
  %call15.reload = load ptr, ptr %call15.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef %call15.loc)
  br label %for.end32

for.end32:                                        ; preds = %for.end10
...
for.inc68:                                        ; preds = %for.cond47
  %5 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !9
...
for.body82:                                       ; preds = %for.cond80
  ...
  %11 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !9
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11)
...
define internal void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %2) #4 {
newFuncRoot:
