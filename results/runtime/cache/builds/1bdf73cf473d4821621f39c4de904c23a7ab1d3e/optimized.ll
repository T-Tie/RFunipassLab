...
for.cond19:                                       ; preds = %for.cond16, %for.inc27
  %9 = phi i32 [ %.pre35, %for.inc27 ], [ %7, %for.cond16 ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax10 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
  %13 = sext i32 %11 to i64
  %smax18 = call i32 @llvm.smax.i32(i32 %10, i32 noundef 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  ...
  %15 = mul nsw i64 %indvars.iv13, %13
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %16, i64 %indvars.iv6
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv6
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc68, %for.body42
  %18 = phi i32 [ %add63, %for.inc68 ], [ 0, %for.body42 ]
...
for.inc68:                                        ; preds = %for.cond47
  ...
  %20 = mul nsw i64 %indvars.iv, %12
  %gep = getelementptr i32, ptr %invariant.gep, i64 %20
  %21 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !15
  %mul62 = mul nsw i32 %21, %19
  %add63 = add nsw i32 %mul62, %18
...
for.body82:                                       ; preds = %for.cond80
  ...
  %call87 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %25)
