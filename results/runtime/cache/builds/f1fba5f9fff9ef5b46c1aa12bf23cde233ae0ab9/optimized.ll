...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr nonnull %sz) #3
  call void @llvm.lifetime.start.p0(i64 10000, ptr nonnull %s) #3
...
for.end:                                          ; preds = %for.cond
  ...
  %conv49 = uitofp nneg i32 %indvars19 to double
...
land.lhs.true61:                                  ; preds = %land.lhs.true55, %if.then57
  %3 = phi double [ %2, %land.lhs.true55 ], [ %.pre, %if.then57 ]
...
if.end65:                                         ; preds = %if.end65.sink.split, %land.lhs.true61
  ...
  call void @llvm.lifetime.end.p0(i64 10000, ptr nonnull %s) #3
  call void @llvm.lifetime.end.p0(i64 10000, ptr nonnull %sz) #3
  ret i32 0
}
