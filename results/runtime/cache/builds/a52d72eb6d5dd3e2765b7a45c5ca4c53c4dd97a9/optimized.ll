...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax91 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax80 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond55, label %for.cond26, label %for.cond2
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc20 ], [ 1, %for.cond13.preheader ]
...
for.cond26:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc57 ], [ 1, %for.cond ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body31
  ...
  %exitcond60 = icmp eq i64 %indvars.iv56, %wide.trip.count
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc54 ], [ 1, %for.cond46.preheader ]
...
for.cond83:                                       ; preds = %for.cond80, %for.inc95
  ...
  %exitcond87.not = icmp eq i64 %indvars.iv83, %wide.trip.count75
