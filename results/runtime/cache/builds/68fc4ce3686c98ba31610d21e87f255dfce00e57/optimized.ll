...
for.end25:                                        ; preds = %if.then, %for.cond14
  br label %for.inc26
...
for.end45:                                        ; preds = %if.then42, %for.cond33
  br label %for.inc46

for.inc46:                                        ; preds = %for.end45
  %11 = load i32, ptr %i, align 4, !tbaa !5
  %dec47 = add nsw i32 %11, -1
  store i32 %dec47, ptr %i, align 4, !tbaa !5
  br label %for.cond29, !llvm.loop !16

for.end48:                                        ; preds = %for.cond29
  %12 = load i32, ptr %r2, align 4, !tbaa !5
  %13 = load i32, ptr %r1, align 4, !tbaa !5
  %sub49 = sub nsw i32 %12, %13
  %sub50 = sub nsw i32 %sub49, 1
  %14 = load i32, ptr %c2, align 4, !tbaa !5
  %15 = load i32, ptr %c1, align 4, !tbaa !5
  %sub51 = sub nsw i32 %14, %15
