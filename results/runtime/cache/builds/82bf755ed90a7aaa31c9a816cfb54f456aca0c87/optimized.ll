...
for.cond31:                                       ; preds = %for.inc50, %for.end30
  ...
  store i32 %sub.sink, ptr %c, align 4, !tbaa !5
...
for.cond36:                                       ; preds = %for.inc47, %for.body34
  %sub.sink1 = phi i32 [ %sub, %for.body34 ], [ %dec, %for.inc47 ]
  %8 = phi i32 [ %dec, %for.inc47 ], [ %sub, %for.body34 ]
  store i32 %sub.sink1, ptr %d, align 4, !tbaa !5
...
if.then45:                                        ; preds = %for.body39
  ...
  store i32 %10, ptr %q, align 4, !tbaa !5
  br label %for.inc50
