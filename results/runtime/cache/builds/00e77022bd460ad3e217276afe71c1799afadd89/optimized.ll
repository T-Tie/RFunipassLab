...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2004, ptr nonnull %a) #5
  call void @llvm.lifetime.start.p0(i64 2004, ptr nonnull %b) #5
...
for.cond14:                                       ; preds = %for.cond11, %for.cond14.backedge
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond14.backedge ], [ 0, %for.cond11 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  br i1 %cmp21, label %if.then22, label %for.cond14.backedge

for.cond14.backedge:                              ; preds = %for.body16, %if.then22
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.body41
  %indvars.iv28 = phi i64 [ 1, %for.cond39.preheader ], [ %indvars.iv.next29, %for.body41 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count32
  br i1 %exitcond33.not, label %for.end47, label %for.body41
...
for.end47:                                        ; preds = %for.cond39
  ...
  call void @llvm.lifetime.end.p0(i64 2004, ptr nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 2004, ptr nonnull %a) #5
