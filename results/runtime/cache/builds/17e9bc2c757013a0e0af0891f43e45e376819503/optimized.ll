...
for.end27:                                        ; preds = %for.cond14
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(10000) %a)
...
for.body17_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #8
