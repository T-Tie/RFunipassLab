...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %4 = phi i32 [ %inc37, %if.end35 ], [ 65, %if.end24 ]
...
for.cond39:                                       ; preds = %if.end49, %for.end38
  %7 = phi i32 [ %inc51, %if.end49 ], [ 97, %for.end38 ]
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %7, i32 noundef %8)
  br label %if.end49
