...
for.cond1:                                        ; preds = %for.inc10, %for.body
  ...
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc10 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv7, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %if.else, %entry
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
