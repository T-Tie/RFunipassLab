...
for.cond13:                                       ; preds = %for.inc40, %for.body12
  ...
  %3 = load i32, ptr %i.sink1, align 4, !tbaa !5
  %add = add nsw i32 %3, 1
...
for.cond50:                                       ; preds = %for.inc74, %for.body48
  ...
  %9 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add49 = add nsw i32 %9, 1
...
for.end79:                                        ; preds = %for.cond45
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12) #5
