...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call noundef i32 @_Z2fjii(i32 noundef %2, i32 noundef 2)
...
for.cond:                                         ; preds = %entry, %for.inc
  %counter.0 = phi i32 [ %counter.1, %for.inc ], [ 1, %entry ]
...
if.then3:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z2fjii(i32 noundef %div, i32 noundef %i.0)
