...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 5000, ptr %str1) #8
  call void @llvm.lifetime.start.p0(i64 5000, ptr %str2) #8
...
for.end55:                                        ; preds = %for.cond47
  call void @llvm.lifetime.end.p0(i64 5000, ptr %str2) #8
  call void @llvm.lifetime.end.p0(i64 5000, ptr %str1) #8
  ret i32 0
}
...
!16 = !{!17, !32, i64 240}
!17 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !18, i64 0, !29, i64 216, !6, i64 224, !30, i64 225, !31, i64 232, !32, i64 240, !33, i64 248, !34, i64 256}
