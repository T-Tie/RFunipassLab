...
for.cond:                                         ; preds = %if.end28, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %if.end28 ], [ 0, %entry ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv20
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  ...
  br i1 %exitcond19.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv15
...
for.cond:                                         ; preds = %if.end27, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %if.end27 ], [ 0, %entry ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end30, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv20
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv20
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc24 ], [ 0, %for.end ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %if.end27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv20
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.end ], [ 2, %entry ]
  %exitcond21.not = icmp eq i64 %indvars.iv16, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond15.preheader, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %0 = add nsw i64 %indvars.iv16, -1
  br label %for.cond1

for.cond15.preheader:                             ; preds = %for.cond
  %1 = load i32, ptr @n, align 4, !tbaa !5
  %sub21 = add i32 %k, -1
  %smax25 = call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %smax32 = call i32 @llvm.smax.i32(i32 %1, i32 2)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.end36
  %indvars.iv28 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next29, %for.end36 ]
  %exitcond34.not = icmp eq i64 %indvars.iv28, %wide.trip.count33
  br i1 %exitcond34.not, label %for.end39, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv22 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next23, %for.inc34 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end36, label %for.inc34

for.inc34:                                        ; preds = %for.cond20
  %arrayidx28 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv28
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %arrayidx33 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %3
...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre14 = phi i32 [ %.pre1416, %for.inc10 ], [ %.pre, %while.body ]
  %0 = phi i32 [ %2, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc10 ], [ 0, %while.body ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv10, %1
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre1416 = phi i32 [ %.pre1415, %for.inc ], [ %.pre14, %for.cond ]
  %2 = phi i32 [ %6, %for.inc ], [ %.pre14, %for.cond ]
...
for.body6:                                        ; preds = %for.cond3
  %4 = or i64 %indvars.iv, %indvars.iv10
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre1415 = phi i32 [ %.pre1416, %for.body6 ], [ %.pre13, %if.then ]
  %6 = phi i32 [ %2, %for.body6 ], [ %.pre13, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %storemerge = phi i32 [ %dec, %for.inc17 ], [ %0, %for.cond ]
...
for.inc17:                                        ; preds = %for.cond13
  tail call void @_Z7zerorowi(i32 noundef %storemerge) #8
  %7 = load i32, ptr @k, align 4, !tbaa !5
  tail call void @_Z7zerocoli(i32 noundef %7) #8
  ...
  tail call void @_Z4jiani(i32 noundef %10) #8
