...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull align 16 %a) #3
...
for.cond:                                         ; preds = %for.inc15, %entry
  ...
  br i1 %cmp.not.not, label %for.cond1.preheader, label %for.cond18.preheader
...
if.then:                                          ; preds = %for.body21
  ...
  %8 = load i64, ptr %gep47, align 8, !tbaa !19, !invariant.load !18
...
if.then34:                                        ; preds = %if.else
  ...
  %vbase.offset.i8 = load i64, ptr %vbase.offset.ptr.i7, align 8, !invariant.load !18
  %gep46 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i8
  %9 = load i64, ptr %gep46, align 8, !tbaa !19, !invariant.load !18
...
if.else37:                                        ; preds = %if.else
  ...
  %vbase.offset.i24 = load i64, ptr %vbase.offset.ptr.i23, align 8, !invariant.load !18
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i24
  %10 = load i64, ptr %gep, align 8, !tbaa !19, !invariant.load !18
