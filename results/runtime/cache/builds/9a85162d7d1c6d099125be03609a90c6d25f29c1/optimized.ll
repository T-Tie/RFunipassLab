...
if.then8:                                         ; preds = %if.end
  %fneg9 = fneg double %3
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call13.loc)
  call fastcc void @outlined_ir_func_2(ptr %call13.loc)
  %call13.reload = load double, ptr %call13.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call13.loc)
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call19.loc)
  call fastcc void @outlined_ir_func_2(ptr %call19.loc)
  %call19.reload = load double, ptr %call19.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call19.loc)
...
if.end37:                                         ; preds = %if.then30, %if.end28
  %13 = load double, ptr @j, align 8, !tbaa !9
  %cmp38 = fcmp olt double %13, 0.000000e+00
...
if.then39:                                        ; preds = %if.end37
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call50.loc)
  call fastcc void @outlined_ir_func_1(ptr %call50.loc)
  %call50.reload = load double, ptr %call50.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call50.loc)
  %14 = load double, ptr @a, align 8, !tbaa !9
  %mul51 = fmul double 2.000000e+00, %14
  ...
  call fastcc void @outlined_ir_func_0()
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call65.loc)
  call fastcc void @outlined_ir_func_1(ptr %call65.loc)
  %call65.reload = load double, ptr %call65.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call65.loc)
  %fneg66 = fneg double %call65.reload
  %15 = load double, ptr @a, align 8, !tbaa !9
  %mul67 = fmul double 2.000000e+00, %15
...
define available_externally noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef nonnull align 8 dereferenceable(8) %__f) local_unnamed_addr #2 align 2 {
entry:
...
if.then30_after_outline.exitStub:
  ...
  %mul33 = fmul double 2.000000e+00, %1
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0) unnamed_addr #9 {
if.then39_after_outline.exitStub:
  ...
  %4 = call double @llvm.fmuladd.f64(double %mul46, double %2, double %neg49)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr %0) unnamed_addr #9 {
if.then8_after_outline.exitStub:
  ...
  %4 = call double @llvm.fmuladd.f64(double %1, double %1, double %neg12)
