...
for.cond2:                                        ; preds = %for.end17, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %add, %for.end17 ]
...
for.cond5:                                        ; preds = %if.end, %for.body4
  %j.0 = phi i32 [ %add, %for.body4 ], [ %inc16, %if.end ]
...
for.cond21:                                       ; preds = %for.body25, %for.end20
  %j.1 = phi i32 [ %sub, %for.end20 ], [ %dec, %for.body25 ]
  ...
  br i1 %cmp24, label %for.body25, label %for.end27
...
for.cond28:                                       ; preds = %if.end38, %for.end27
  %i.2 = phi i32 [ 0, %for.end27 ], [ %inc40, %if.end38 ]
