...
for.inc.gvnsink.split:                            ; preds = %if.then36, %if.else
  %.sink = phi double [ %14, %if.else ], [ %13, %if.then36 ]
  %div47.sink1 = phi double [ %div47, %if.else ], [ 0.000000e+00, %if.then36 ]
  %call52 = call double @sqrt(double noundef %.sink) #6, !tbaa !5
  %mul53 = fmul double %10, 2.000000e+00
  %div54 = fdiv double %call52, %mul53
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div47.sink1, double noundef %div54, double noundef %div47.sink1, double noundef %div54)
  br label %for.inc
