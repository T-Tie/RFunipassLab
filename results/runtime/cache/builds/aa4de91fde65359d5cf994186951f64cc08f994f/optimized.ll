...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [2 x double]], ptr %sv, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.inc59, %for.end9
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc59 ], [ 1, %for.end9 ]
  %5 = sext i32 %4 to i64
  %cmp15 = icmp slt i64 %indvars.iv6, %5
  br i1 %cmp15, label %for.body16, label %for.end61

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [1000 x [2 x double]], ptr %sv, i64 0, i64 %indvars.iv6
  %arrayidx19 = getelementptr inbounds nuw i8, ptr %arrayidx18, i64 8
  %6 = load double, ptr %arrayidx19, align 8, !tbaa !13, !invariant.load !15
  %7 = load double, ptr %arrayidx18, align 16, !tbaa !13, !invariant.load !15
...
if.else:                                          ; preds = %for.body16
  ...
  %spec.select = select i1 %or.cond1, ptr @.str.2, ptr @.str.3
  br label %for.inc59

for.inc59:                                        ; preds = %if.else, %for.body16
  %.str.3.sink = phi ptr [ @.str.1, %for.body16 ], [ %spec.select, %if.else ]
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink) #5
