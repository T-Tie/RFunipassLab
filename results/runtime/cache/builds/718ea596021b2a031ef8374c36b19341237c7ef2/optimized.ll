...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  ...
  br i1 %exitcond115.not, label %for.inc138, label %for.cond17.preheader

for.cond17.preheader:                             ; preds = %for.cond14
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc50
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc50 ], [ %indvars.iv76, %for.cond17.preheader ]
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv83 = phi i64 [ %indvars.iv76, %for.cond39.preheader ], [ %indvars.iv.next84, %for.inc47 ]
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select67, %for.body62 ], [ %10, %for.body55 ]
...
for.body62:                                       ; preds = %for.cond60
  %11 = mul nuw nsw i64 %indvars.iv93, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %11
  %12 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select67 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next94 = add nuw nsw i64 %indvars.iv93, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv98 = phi i64 [ %indvars.iv76, %for.cond77.preheader ], [ %indvars.iv.next99, %for.inc85 ]
  %exitcond102 = icmp eq i64 %indvars.iv98, %1
  br i1 %exitcond102, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv98, %1
  %gep69 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep69, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next77, %1
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  ...
  %18 = trunc nuw i64 %indvars.iv110 to i32
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %20 = mul nuw nsw i64 %indvars.iv110, %1
