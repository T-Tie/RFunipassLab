...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr noundef nonnull dereferenceable(100) %add.ptr, i1 noundef false, i1 noundef true, i1 noundef false) #9
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc16 ], [ 1, %for.end ]
  %exitcond12 = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond12, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv9
