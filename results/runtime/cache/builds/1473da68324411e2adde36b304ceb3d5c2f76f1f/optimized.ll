...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  %j.2 = phi i32 [ 0, %for.body88 ], [ %inc114, %for.inc113 ]
  %cmp95 = icmp slt i32 %j.2, %conv93
  br i1 %cmp95, label %for.body96, label %for.inc116

for.body96:                                       ; preds = %for.cond94
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %j.2, %sub97
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %idxprom102 = sext i32 %j.2 to i64
  %arrayidx103 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom102
  %2 = load i8, ptr %arrayidx103, align 1, !tbaa !12, !invariant.load !14
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %2)
...
if.else106:                                       ; preds = %for.body96
  %idxprom109 = sext i32 %j.2 to i64
  %arrayidx110 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom109
  %3 = load i8, ptr %arrayidx110, align 1, !tbaa !12, !invariant.load !14
