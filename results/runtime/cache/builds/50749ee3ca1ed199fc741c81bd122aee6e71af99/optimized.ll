...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr nonnull %k) #4
...
for.cond10.preheader:                             ; preds = %for.cond
  %smax27 = call i32 @llvm.smax.i32(i32 %1, i32 0)
...
for.end27:                                        ; preds = %for.cond10
  ...
  call void @llvm.lifetime.end.p0(i64 10000, ptr nonnull %k) #4
