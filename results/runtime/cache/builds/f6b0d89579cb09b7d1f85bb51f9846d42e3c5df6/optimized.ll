...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call10 = call double @sqrt(double noundef %4) #9, !tbaa !5
  ...
  %call18 = call double @sqrt(double noundef %8) #9, !tbaa !5
...
if.then42:                                        ; preds = %if.then40
  ...
  %call47 = call double @sqrt(double noundef %17) #9, !tbaa !5
  ...
  %call56 = call double @sqrt(double noundef %21) #9, !tbaa !5
...
if.else:                                          ; preds = %if.then40
  ...
  %call68 = call double @sqrt(double noundef %22) #9, !tbaa !5
  ...
  %call80 = call double @sqrt(double noundef %26) #9, !tbaa !5
