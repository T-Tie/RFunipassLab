...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 1000, ptr %b) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr %w) #9
  ...
  %call5 = call i64 @strlen(ptr noundef %a) #10
  %conv = trunc i64 %call5 to i32
  %call7 = call i64 @strlen(ptr noundef %b) #10
...
if.end75:                                         ; preds = %if.end74, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %w) #9
  call void @llvm.lifetime.end.p0(i64 1000, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 1000, ptr %a) #9
  ret i32 0
}
