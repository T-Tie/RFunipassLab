...
for.body:                                         ; preds = %for.cond
  ...
  %call.i4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i3, ptr noundef nonnull align 8 dereferenceable(8) %c)
...
if.then:                                          ; preds = %for.body
  ...
  %call18 = call double @sqrt(double noundef %10) #7, !tbaa !5
  ...
  %.pre37 = load double, ptr %a, align 8, !tbaa !9
  %.pre38 = load double, ptr %c, align 8, !tbaa !9
  %.pre42 = fmul double %.pre37, 4.000000e+00
  %.pre43 = fneg double %.pre38
  %.pre44 = fmul double %.pre42, %.pre43
  %.pre45 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre44)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi46 = phi double [ %.pre45, %if.then ], [ %5, %for.body ]
  %mul24.pre-phi = phi double [ %.pre42, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre38, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre37, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi46, 0.000000e+00
...
if.then28:                                        ; preds = %if.end
  ...
  %.pre39 = load double, ptr %b, align 8, !tbaa !9
  %.pre40 = load double, ptr %a, align 8, !tbaa !9
  %.pre41 = load double, ptr %c, align 8, !tbaa !9
  %.pre47 = fmul double %.pre40, 4.000000e+00
  %.pre48 = fneg double %.pre41
  %.pre50 = fmul double %.pre47, %.pre48
  %.pre51 = call double @llvm.fmuladd.f64(double %.pre39, double %.pre39, double %.pre50)
  br label %if.end34

if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi52 = phi double [ %.pre51, %if.then28 ], [ %.pre-phi46, %if.end ]
  %mul36.pre-phi = phi double [ %.pre47, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre41, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre40, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre39, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi52, 0.000000e+00
...
if.then42:                                        ; preds = %if.then40
  ...
  %call47 = call double @sqrt(double noundef %18) #7, !tbaa !5
  ...
  %call56 = call double @sqrt(double noundef %23) #7, !tbaa !5
...
if.else:                                          ; preds = %if.then40
  ...
  %call68 = call double @sqrt(double noundef %24) #7, !tbaa !5
  ...
  %call80 = call double @sqrt(double noundef %28) #7, !tbaa !5
