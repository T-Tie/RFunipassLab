...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  %call.i = call i32 @getc(ptr noundef %0) #7
  %cmp = icmp eq i32 %call.i, 10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br i1 %cmp, label %for.end, label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond
  %call5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %arrayidx) #7
  br label %for.cond6
...
for.inc12:                                        ; preds = %for.cond6
  ...
  %call11 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %arrayidx9) #7
