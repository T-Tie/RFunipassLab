...
for.inc:                                          ; preds = %for.cond
  ...
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr %t.addr, align 4
...
for.inc68:                                        ; preds = %for.cond58
  ...
  %11 = load i8, ptr %arrayidx63, align 1, !tbaa !9, !invariant.load !10
