...
if.end18:                                         ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %sum) #7
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef align 16 %a) #9
...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3funii(i32 noundef %1, i32 noundef 1) #10
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %1, %3
  %call = call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %3) #8
