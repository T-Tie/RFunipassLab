...
for.cond34:                                       ; preds = %for.inc59, %for.end33
  ...
  %4 = phi i32 [ %dec60, %for.inc59 ], [ %sub, %for.end33 ]
  %cmp35 = icmp sge i32 %4, 0
...
for.cond38:                                       ; preds = %for.inc49, %for.body36
  %5 = phi i32 [ %dec, %for.inc49 ], [ %sub, %for.body36 ]
  %cmp39 = icmp sge i32 %5, 0
...
for.end50:                                        ; preds = %for.body40, %for.cond38
  %y2.2 = phi i32 [ %y2.0, %for.cond38 ], [ %5, %for.body40 ]
  %x2.2 = phi i32 [ %x2.0, %for.cond38 ], [ %4, %for.body40 ]
  %idxprom51 = sext i32 %4 to i64
  %arrayidx52 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51
  %idxprom53 = sext i32 %5 to i64
