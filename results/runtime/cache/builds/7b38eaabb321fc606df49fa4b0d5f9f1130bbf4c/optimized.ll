...
for.cond13:                                       ; preds = %for.inc135, %for.end12
  ...
  %3 = phi i32 [ %dec, %for.inc135 ], [ %1, %for.end12 ]
...
for.inc31:                                        ; preds = %for.body21, %if.then
  %min.1 = phi i32 [ %4, %if.then ], [ %min.0, %for.body21 ]
...
for.inc45:                                        ; preds = %for.cond34
  ...
  %5 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !13
...
for.body56:                                       ; preds = %for.cond54
  ...
  %6 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !13
  %cmp61 = icmp slt i32 %6, %min.2
...
for.inc68:                                        ; preds = %for.body56, %if.then62
  %min.3 = phi i32 [ %6, %if.then62 ], [ %min.2, %for.body56 ]
...
for.inc83:                                        ; preds = %for.cond71
  ...
  %7 = load i32, ptr %arrayidx77, align 4, !tbaa !5, !invariant.load !13
  %sub78 = sub nsw i32 %7, %min.2
...
for.end88:                                        ; preds = %for.cond51
  ...
  %8 = load i32, ptr %arrayidx90, align 8, !tbaa !5
  %add = add nsw i32 %sum.0, %8
  br label %for.cond91

for.cond91:                                       ; preds = %for.inc110, %for.end88
  %i.4 = phi i32 [ 1, %for.end88 ], [ %inc111, %for.inc110 ]
  %sub92 = sub nsw i32 %3, 1
...
for.inc107:                                       ; preds = %for.cond95
  ...
  %9 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !13
