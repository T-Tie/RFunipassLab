...
for.inc11:                                        ; preds = %for.body, %for.end
  %pre.1 = phi i32 [ %0, %for.end ], [ %pre.0, %for.body ]
  %dec = add nsw i32 %0, -1
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %4 = load i8, ptr %arrayidx19, align 1, !tbaa !9, !invariant.load !10
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %4)
