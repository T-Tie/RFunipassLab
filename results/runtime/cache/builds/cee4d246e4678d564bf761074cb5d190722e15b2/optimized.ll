...
entry:
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax46, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc12 ], [ 0, %entry ]
  %exitcond48 = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48, label %for.cond15, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv43
  %arrayidx = getelementptr inbounds nuw [501 x i8], ptr %s, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond58 = icmp eq i64 %indvars.iv54, %wide.trip.count47
  br i1 %exitcond58, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv54
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv54
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc39 ], [ %indvars.iv49, %for.body19 ]
  %4 = trunc nuw i64 %indvars.iv51 to i32
  %cmp24.not = icmp slt i32 %sub, %4
  br i1 %cmp24.not, label %for.cond15.loopexit, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv51
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond63 = icmp eq i64 %indvars.iv59, %wide.trip.count47
  br i1 %exitcond63, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv59
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.040 = phi i32 [ %8, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.040)
  %smax67 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count68 = zext nneg i32 %smax67 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond69.not = icmp eq i64 %indvars.iv64, %wide.trip.count68
  br i1 %exitcond69.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv64
