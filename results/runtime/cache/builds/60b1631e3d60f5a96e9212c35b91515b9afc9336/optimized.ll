...
for.cond8:                                        ; preds = %for.body11, %for.end
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body11 ], [ 1, %for.end ]
  %8 = sext i32 %7 to i64
  %cmp10.not.not = icmp slt i64 %indvars.iv20, %8
  br i1 %cmp10.not.not, label %for.body11, label %for.end33

for.body11:                                       ; preds = %for.cond8
  %arrayidx13 = getelementptr inbounds nuw float, ptr %vla1, i64 %indvars.iv20
  %9 = load float, ptr %arrayidx13, align 4, !tbaa !12, !invariant.load !14
  %arrayidx15 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv20
