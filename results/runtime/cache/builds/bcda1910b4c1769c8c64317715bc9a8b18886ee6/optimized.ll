...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  ...
  %call.i = call i32 @getc(ptr noundef %4) #11
...
for.end:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #11
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %call.i.i9 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr13) #11
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !41, !invariant.load !8
...
declare i64 @strlen(ptr noundef captures(none)) #8
