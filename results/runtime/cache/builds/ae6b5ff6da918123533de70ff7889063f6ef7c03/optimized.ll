...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %s_all) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %s_good) #11
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %all) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %good) #11
  br label %for.cond
...
if.then15:                                        ; preds = %if.else
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(7) @.str.1)
  br label %for.inc
...
for.inc:                                          ; preds = %if.else18, %if.then15, %if.then
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %good) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %all) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %s_good) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %s_all) #11
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(5) %0) unnamed_addr #9 {
for.inc.exitStub:
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
