...
for.cond3:                                        ; preds = %for.cond, %for.body5
  ...
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body5 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp4 = icmp slt i64 %indvars.iv10, %8
  br i1 %cmp4, label %for.body5, label %for.end27

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv10
  ...
  %.str.1.sink = select i1 %cmp9, ptr @.str, ptr %.str.1..str.2
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.1.sink)
