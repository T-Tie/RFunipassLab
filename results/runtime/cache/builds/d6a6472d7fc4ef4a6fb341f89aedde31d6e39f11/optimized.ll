...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(1200) %a, i8 noundef 0, i64 noundef 1200, i1 noundef false) #7
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc27
  ...
  br i1 %exitcond30, label %for.cond30.preheader, label %for.body4

for.cond30.preheader:                             ; preds = %for.cond2
  br label %for.cond30
...
for.body4:                                        ; preds = %for.cond2
  ...
  br i1 %cmp8, label %for.inc27, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.body4
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc24
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc24 ], [ %indvars.iv20, %for.cond9.preheader ]
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27.loopexit, label %for.body11
...
for.inc27.loopexit:                               ; preds = %for.cond9
  br label %for.inc27

for.inc27:                                        ; preds = %for.inc27.loopexit, %for.body4
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond2, !llvm.loop !13

for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc53
  %8 = phi i32 [ %.pre, %for.inc53 ], [ %0, %for.cond30.preheader ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc53 ], [ 0, %for.cond30.preheader ]
  %b.0 = phi i32 [ %b.1, %for.inc53 ], [ 0, %for.cond30.preheader ]
  %9 = sext i32 %8 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv31, %9
...
land.lhs.true:                                    ; preds = %for.body33
  ...
  %.b.0 = call i32 @llvm.umax.i32(i32 %b.0, i32 noundef 1)
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %10)
  br label %for.inc53
...
for.end55:                                        ; preds = %for.cond30
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef nonnull %a) #8
  ret i32 0
}
