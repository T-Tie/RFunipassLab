...
if.then:                                          ; preds = %for.body21
  ...
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i23, align 8, !invariant.load !14
  %gep46 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %8 = load i64, ptr %gep46, align 8, !tbaa !17, !invariant.load !14
...
if.then34:                                        ; preds = %if.else
  ...
  store i8 10, ptr %__c.addr.i5, align 1, !tbaa !16
  %vbase.offset.i8 = load i64, ptr %vbase.offset.ptr.i23, align 8, !invariant.load !14
  %gep45 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i8
  %9 = load i64, ptr %gep45, align 8, !tbaa !17, !invariant.load !14
...
if.else37:                                        ; preds = %if.else
  ...
  store i8 10, ptr %__c.addr.i21, align 1, !tbaa !16
  %vbase.offset.i24 = load i64, ptr %vbase.offset.ptr.i23, align 8, !invariant.load !14
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i24
  %10 = load i64, ptr %gep, align 8, !tbaa !17, !invariant.load !14
...
for.inc41:                                        ; preds = %if.end.i31, %if.then.i28, %if.end.i15, %if.then.i12, %if.end.i, %if.then.i
  %__c.addr.i21.sink = phi ptr [ %__c.addr.i, %if.then.i ], [ %__c.addr.i, %if.end.i ], [ %__c.addr.i5, %if.then.i12 ], [ %__c.addr.i5, %if.end.i15 ], [ %__c.addr.i21, %if.then.i28 ], [ %__c.addr.i21, %if.end.i31 ]
