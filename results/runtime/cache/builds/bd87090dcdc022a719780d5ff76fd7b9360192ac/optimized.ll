...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %if.then6.i8, %land.lhs.true.i15, %if.then19.i20, %if.then28.i27
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %6 = load i8, ptr %arrayidx28, align 1, !tbaa !31, !invariant.load !8
  switch i8 %6, label %if.end75 [
    i8 65, label %for.inc
    i8 71, label %for.inc
    i8 67, label %for.inc
    i8 84, label %for.inc
...
for.body52:                                       ; preds = %for.cond50
  ...
  %7 = load i8, ptr %arrayidx54, align 1, !tbaa !31, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv48
  %8 = load i8, ptr %arrayidx57, align 1, !tbaa !31, !invariant.load !8
  %cmp59 = icmp eq i8 %7, %8
...
for.end65:                                        ; preds = %for.cond50
  ...
  %9 = load double, ptr %w, align 8, !tbaa !36
  %cmp68 = fcmp ult double %div, %9
