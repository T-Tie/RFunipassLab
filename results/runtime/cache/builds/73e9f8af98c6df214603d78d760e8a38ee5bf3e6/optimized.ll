...
for.cond2.preheader:                              ; preds = %for.cond
  %sub = add nsw i32 %0, -1
  %smax8 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond2
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc28
  %indvars.iv6 = phi i32 [ %sub, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc28 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %inc29, %for.inc28 ]
  %exitcond9.not = icmp eq i32 %j.0, %smax8
  br i1 %exitcond9.not, label %for.end30, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc25
  %indvars.iv3 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next4, %for.inc25 ]
  %exitcond.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond.not, label %for.inc28, label %for.body9

for.body9:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv3
  %2 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %arrayidx13 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next4
