; ModuleID = '<stdin>'
source_filename = "/tmp/tmpzllffft1.cpp"
...
for.end:                                          ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %4)
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc28, %for.end
  %i4.0 = phi i32 [ 1, %for.end ], [ %inc29, %for.inc28 ]
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %cmp6 = icmp slt i32 %i4.0, %5
  br i1 %cmp6, label %for.body8, label %for.end31

for.body8:                                        ; preds = %for.cond5
  br label %for.cond9

for.cond9:                                        ; preds = %for.inc25, %for.body8
  %k.0 = phi i32 [ 0, %for.body8 ], [ %inc26, %for.inc25 ]
  %cmp10 = icmp slt i32 %k.0, %i4.0
  br i1 %cmp10, label %for.body12, label %for.inc28
...
for.body12:                                       ; preds = %for.cond9
  ...
  br i1 %cmp17, label %for.inc28, label %if.end

if.end:                                           ; preds = %for.body12
  %sub = sub nsw i32 %i4.0, 1
  %cmp18 = icmp eq i32 %k.0, %sub
  br i1 %cmp18, label %if.then19, label %for.inc25

if.then19:                                        ; preds = %if.end
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(2) @.str)
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call20, i32 noundef %6)
  br label %for.inc25

for.inc25:                                        ; preds = %if.end, %if.then19
  %inc26 = add nsw i32 %k.0, 1
  br label %for.cond9, !llvm.loop !13

for.inc28:                                        ; preds = %for.body12, %for.cond9
  %inc29 = add nsw i32 %i4.0, 1
  br label %for.cond5, !llvm.loop !14

for.end31:                                        ; preds = %for.cond5
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !15, !invariant.load !12
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !15, !invariant.load !12
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !12
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !17, !invariant.load !12
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !28, !invariant.load !12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !36, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !42, !invariant.load !12
  br label %return
