...
if.then60:                                        ; preds = %for.end58
  ...
  %puts70 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.5.str.4) #7
  br label %if.end68
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts66 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #7
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts72 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.7.sink) #7
  br label %for.inc164
