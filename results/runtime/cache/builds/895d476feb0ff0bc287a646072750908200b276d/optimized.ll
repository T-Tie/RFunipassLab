...
entry:
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call4, i8 noundef signext %call.i14)
...
sw.epilog.gvnsink.split:                          ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  %vtable.i15 = load ptr, ptr %call69, align 8, !tbaa !9
  ...
  %add.ptr.i18 = getelementptr inbounds i8, ptr %call69, i64 %vbase.offset.i17
  ...
  %call1.i19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call69, i8 noundef signext %call.i)
  ...
  %call71 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i20, i32 noundef %.sink1)
  %vtable.i21 = load ptr, ptr %call71, align 8, !tbaa !9
  %vbase.offset.ptr.i22 = getelementptr i8, ptr %vtable.i21, i64 -24
  %vbase.offset.i23 = load i64, ptr %vbase.offset.ptr.i22, align 8, !invariant.load !11
  %add.ptr.i24 = getelementptr inbounds i8, ptr %call71, i64 %vbase.offset.i23
  ...
  %call1.i26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call71, i8 noundef signext %call.i25)
  ...
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i27, i32 noundef %.sink)
  %vtable.i28 = load ptr, ptr %call73, align 8, !tbaa !9
  %vbase.offset.ptr.i29 = getelementptr i8, ptr %vtable.i28, i64 -24
  %vbase.offset.i30 = load i64, ptr %vbase.offset.ptr.i29, align 8, !invariant.load !11
  %add.ptr.i31 = getelementptr inbounds i8, ptr %call73, i64 %vbase.offset.i30
  ...
  %call1.i33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call73, i8 noundef signext %call.i32)
...
sw.epilog:                                        ; preds = %entry, %sw.epilog.gvnsink.split
...
if.then:                                          ; preds = %sw.epilog
  ...
  %vtable.i35 = load ptr, ptr %call75, align 8, !tbaa !9
  ...
  %add.ptr.i38 = getelementptr inbounds i8, ptr %call75, i64 %vbase.offset.i37
  ...
  %call1.i40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call75, i8 noundef signext %call.i39)
  ...
  %call77 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i41, i32 noundef %sub)
  br label %if.end
...
if.else:                                          ; preds = %sw.epilog
  ...
  %vtable.i49 = load ptr, ptr %call79, align 8, !tbaa !9
  %vbase.offset.ptr.i50 = getelementptr i8, ptr %vtable.i49, i64 -24
  %vbase.offset.i51 = load i64, ptr %vbase.offset.ptr.i50, align 8, !invariant.load !11
  %add.ptr.i52 = getelementptr inbounds i8, ptr %call79, i64 %vbase.offset.i51
  %call.i53 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i52, i8 noundef signext 10)
  %call1.i54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call79, i8 noundef signext %call.i53)
  ...
  %call81 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i55, i32 noundef %rem)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call81.sink64 = phi ptr [ %call81, %if.else ], [ %call77, %if.then ]
  %vtable.i56 = load ptr, ptr %call81.sink64, align 8, !tbaa !9
  %vbase.offset.ptr.i57 = getelementptr i8, ptr %vtable.i56, i64 -24
  %vbase.offset.i58 = load i64, ptr %vbase.offset.ptr.i57, align 8, !invariant.load !11
  %add.ptr.i59 = getelementptr inbounds i8, ptr %call81.sink64, i64 %vbase.offset.i58
  ...
  %call1.i61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call81.sink64, i8 noundef signext %call.i60)
