...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef align 16 %a) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef align 16 %b) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef align 16 %c) #5
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef align 16 %realpart) #5
...
if.end:                                           ; preds = %if.then85, %if.else62
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %7, double noundef %div79)
  %call97 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %7, double noundef %div79)
  br label %for.inc100
...
for.end102:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %realpart) #6
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %c) #6
