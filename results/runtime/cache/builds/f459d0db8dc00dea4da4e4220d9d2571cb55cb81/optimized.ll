...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %s_all) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %s_good) #6
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %all) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %good) #6
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %good) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %all) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %s_good) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %s_all) #6
