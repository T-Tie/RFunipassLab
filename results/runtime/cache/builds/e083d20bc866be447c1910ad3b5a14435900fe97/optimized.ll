...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %or.cond7, label %if.then, label %if.else80
...
if.then:                                          ; preds = %for.body
  ...
  %smax9 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc, %if.then
  %storemerge8 = phi i32 [ 1, %if.then ], [ %inc, %for.inc ]
  %n1.0 = phi i32 [ 0, %if.then ], [ %add, %for.inc ]
  %exitcond10.not = icmp eq i32 %storemerge8, %smax9
  br i1 %exitcond10.not, label %if.end79, label %for.body9

for.body9:                                        ; preds = %for.cond7
  switch i32 %storemerge8, label %if.else27 [
    i32 2, label %for.inc
...
for.inc109:                                       ; preds = %for.body87, %if.else105, %if.then103
  %.sink11 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ], [ 28, %for.body87 ]
  %add90 = add nuw nsw i32 %n182.0, %.sink11
