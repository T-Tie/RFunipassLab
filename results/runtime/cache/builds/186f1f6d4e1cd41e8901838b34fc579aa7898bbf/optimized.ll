...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  ...
  %exitcond15.not = icmp eq i32 %m.0, %smax14
...
for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count19 = zext nneg i32 %smax14 to i64
  br label %for.cond47
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv16 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next17, %for.inc55 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv16
