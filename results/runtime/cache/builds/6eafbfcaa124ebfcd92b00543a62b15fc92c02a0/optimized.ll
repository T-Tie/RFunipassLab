...
for.cond:                                         ; preds = %for.inc31, %entry
  ...
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc31 ], [ 0, %entry ]
  %jn.0 = phi i32 [ %jn.1, %for.inc31 ], [ 0, %entry ]
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv28, %6
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv28
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv31 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next32, %for.inc40 ]
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv31
