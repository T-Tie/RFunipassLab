...
for.body:                                         ; preds = %for.cond
  ...
  %smax25 = call i32 @llvm.smax.i32(i32 %3, i32 1)
...
for.cond7:                                        ; preds = %for.body, %for.inc
  ...
  %exitcond26.not = icmp eq i32 %j.0, %smax25
...
for.cond30.preheader:                             ; preds = %for.cond7
  ...
  %smax27 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  br label %for.cond30
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %exitcond28.not = icmp eq i32 %j.1, %smax27
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts20 = call i32 @puts(ptr nonnull dereferenceable(1) %str.5.str.4)
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %j81.0, %smax25
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %5, i32 1)
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %exitcond24.not = icmp eq i32 %j81.1, %smax23
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts16 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts22 = call i32 @puts(ptr nonnull dereferenceable(1) %str.7.sink)
  br label %for.inc164
