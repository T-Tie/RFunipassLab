...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %b) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef %c) #7
...
if.then:                                          ; preds = %for.body8
  %fneg = fneg float %2
  %call33 = call noundef float @_ZSt4sqrtf(float noundef nofpclass(nzero) %5) #8
  ...
  %call51 = call noundef float @_ZSt4sqrtf(float noundef nofpclass(nzero) %9) #8
  ...
  %call57 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %conv, double noundef %conv56) #8
  br label %if.end
...
if.then71:                                        ; preds = %if.end
  ...
  %call80 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %conv79) #8
  br label %if.end81
...
if.then95:                                        ; preds = %if.end81
  ...
  %call116 = call noundef float @_ZSt4sqrtf(float noundef %19) #8
  ...
  %call142 = call noundef float @_ZSt4sqrtf(float noundef %23) #8
  ...
  %call148 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %conv103, double noundef %conv121, double noundef %conv129, double noundef %conv147) #8
  br label %for.inc150
...
for.end152:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %c) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %b) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %a) #8
...
define linkonce_odr dso_local noundef float @_ZSt4sqrtf(float noundef %__x) local_unnamed_addr #5 comdat {
entry:
  %call = call float @sqrtf(float noundef %__x) #9, !tbaa !5
  ret float %call
}
