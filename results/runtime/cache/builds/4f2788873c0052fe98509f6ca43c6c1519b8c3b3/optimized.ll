...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr nonnull %str) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(10000) %str, i8 0, i64 10000, i1 false)
  call void @llvm.lifetime.start.p0(i64 400000, ptr nonnull %b) #5
  br label %while.cond
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 400000, ptr nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 10000, ptr nonnull %str) #5
  ret i32 0
}
