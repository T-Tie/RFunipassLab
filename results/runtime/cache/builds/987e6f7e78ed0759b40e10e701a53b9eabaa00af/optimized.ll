...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef %word) #6
...
if.else:                                          ; preds = %while.body
  %call7 = call i64 @strlen(ptr noundef %word) #8
  %add = add i64 %call7, 1
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef %word) #7
