...
if.end:                                           ; preds = %while.body
  ...
  %call.i = tail call noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull %add.ptr1.i, ptr noundef %__last.addr.0, ptr noundef %__first) #9
...
if.end:                                           ; preds = %entry
  ...
  %div1011 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div1011, %if.end ], [ %dec, %while.body ]
