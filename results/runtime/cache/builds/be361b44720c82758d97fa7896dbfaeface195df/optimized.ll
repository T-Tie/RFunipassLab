...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc74
  %indvars.iv5 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc74 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv5
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %4 = add i32 %smax19, 1
  %wide.trip.count20 = zext i32 %4 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond21 = icmp eq i64 %indvars.iv15, %wide.trip.count20
  br i1 %exitcond21, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv15
  ...
  %smax12 = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count13 = zext nneg i32 %smax12 to i64
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv15, i64 %5
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv9, %5
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv15, i64 %indvars.iv9
