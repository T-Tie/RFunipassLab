...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef align 16 %a) #4
  ...
  %call3 = call i64 @strlen(ptr noundef %a) #5
...
for.body13:                                       ; preds = %for.cond10
  ...
  %4 = load i8, ptr %arrayidx15, align 1, !tbaa !12, !invariant.load !13
...
if.end83:                                         ; preds = %for.cond60, %if.then56
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %b) #6
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef %a) #6
  ret i32 0
}
