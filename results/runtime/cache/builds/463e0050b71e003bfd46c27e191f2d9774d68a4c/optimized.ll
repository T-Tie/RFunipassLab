...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre49, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc19
  %indvars.iv29 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next30, %for.inc19 ]
  %exitcond.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body13

for.body13:                                       ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv29
...
for.body13.for.end22_crit_edge:                   ; preds = %for.body13
  ...
  %.pre50 = and i64 %indvars.iv29, 4294967295
  br label %for.end22
...
for.end22:                                        ; preds = %for.cond10, %for.body13.for.end22_crit_edge
  %idxprom26.pre-phi = phi i64 [ %.pre50, %for.body13.for.end22_crit_edge ], [ %wide.trip.count, %for.cond10 ]
  %j.1.lcssa = phi i32 [ %5, %for.body13.for.end22_crit_edge ], [ %smax, %for.cond10 ]
  %j.1.lcssa.neg = sub i32 0, %j.1.lcssa
  %smax38 = call i32 @llvm.smax.i32(i32 %j.1.lcssa, i32 %0)
  %wide.trip.count40 = zext i32 %smax38 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc33, %for.end22
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc33 ], [ %idxprom26.pre-phi, %for.end22 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end35, label %for.body25

for.body25:                                       ; preds = %for.cond23
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom26.pre-phi, i64 %indvars.iv35
...
for.end35:                                        ; preds = %for.cond23, %for.end35.split.loop.exit
  %j.2.lcssa = phi i32 [ %7, %for.end35.split.loop.exit ], [ %smax38, %for.cond23 ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc46, %for.end35
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc46 ], [ %idxprom26.pre-phi, %for.end35 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count40
  br i1 %exitcond48.not, label %for.end48, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %idxprom26.pre-phi
...
for.end48.split.loop.exit:                        ; preds = %for.body38
  %9 = trunc nuw nsw i64 %indvars.iv42 to i32
  br label %for.end48

for.end48:                                        ; preds = %for.cond36, %for.end48.split.loop.exit
  %i.2.lcssa = phi i32 [ %9, %for.end48.split.loop.exit ], [ %smax38, %for.cond36 ]
  %reass.sub = add i32 %j.1.lcssa.neg, -2
  %sub50 = add i32 %reass.sub, %j.2.lcssa
  %reass.sub24 = add i32 %j.1.lcssa.neg, -2
  %sub51 = add i32 %reass.sub24, %i.2.lcssa
