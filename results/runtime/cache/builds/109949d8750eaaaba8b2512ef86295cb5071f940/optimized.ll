...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv4 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next5, %for.body9 ]
  %max2.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select1, %for.body9 ]
  %exitcond.not = icmp eq i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv4
  ...
  %spec.select1 = select i1 %cmp15, i32 %4, i32 %max2.0
