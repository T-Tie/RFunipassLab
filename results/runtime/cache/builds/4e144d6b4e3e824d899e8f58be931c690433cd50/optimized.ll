...
for.inc:                                          ; preds = %if.then18, %if.else21
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i8, align 8, !invariant.load !12
  ...
  %call1.i5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i4)
