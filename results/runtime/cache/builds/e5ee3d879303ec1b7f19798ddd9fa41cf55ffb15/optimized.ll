...
for.cond9:                                        ; preds = %for.body4, %if.end23
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %if.end23 ], [ %indvars.iv21, %for.body4 ]
...
for.cond30:                                       ; preds = %for.cond2, %for.inc53
  %.pre35 = phi i32 [ %.pre, %for.inc53 ], [ %0, %for.cond2 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc53 ], [ 0, %for.cond2 ]
  %b.0 = phi i32 [ %b.1, %for.inc53 ], [ 0, %for.cond2 ]
  %7 = sext i32 %.pre35 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv32, %7
...
land.lhs.true:                                    ; preds = %for.body33
  ...
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %8) #8
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc53

for.inc53:                                        ; preds = %land.lhs.true, %for.body33
  %.pre = phi i32 [ %.pre35, %for.body33 ], [ %.pre.pre, %land.lhs.true ]
