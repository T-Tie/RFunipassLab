...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax97 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count68 = zext nneg i32 %smax97 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %wide.trip.count68
  br i1 %exitcond69.not, label %for.cond28.preheader, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv60 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next61, %for.inc22 ]
  %exitcond64.not = icmp eq i64 %indvars.iv60, %wide.trip.count
  br i1 %exitcond64.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv65, i64 %indvars.iv60
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv80 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next81, %for.inc63 ]
  %exitcond85.not = icmp eq i64 %indvars.iv80, %wide.trip.count68
  br i1 %exitcond85.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select58, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond74.not = icmp eq i64 %indvars.iv70, %wide.trip.count
  br i1 %exitcond74.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv70, i64 %indvars.iv80
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select58 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv75 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next76, %for.inc60 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count
  br i1 %exitcond79.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv75, i64 %indvars.iv80
...
for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv93 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next94, %for.inc125 ]
  %exitcond99.not = icmp eq i64 %indvars.iv93, %wide.trip.count68
  br i1 %exitcond99.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %5 = add nsw i64 %indvars.iv93, -1
  %6 = trunc nuw nsw i64 %indvars.iv93 to i32
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv86 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next87, %for.inc122 ]
  %exitcond92.not = icmp eq i64 %indvars.iv86, %wide.trip.count
  br i1 %exitcond92.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv86, 2
  br i1 %switch, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %for.body75
  %cmp8155 = icmp eq i64 %indvars.iv86, 1
  br i1 %cmp8155, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv93, i64 %indvars.iv86
  %7 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
  %8 = add nsw i64 %indvars.iv86, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv93, i64 %8
  store i32 %7, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.else95:                                        ; preds = %lor.lhs.false.thread
  %cmp96 = icmp eq i64 %indvars.iv86, 0
  %9 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv93, i64 %indvars.iv86
  %10 = load i32, ptr %9, align 4, !tbaa !5, !invariant.load !9
  br i1 %cmp96, label %if.then97, label %if.else107

if.then97:                                        ; preds = %if.else95
  store i32 %10, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %if.else95
  %11 = add nsw i64 %indvars.iv86, -1
  %arrayidx117 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 %11
  store i32 %10, ptr %arrayidx117, align 4, !tbaa !5
  br label %for.inc122

for.inc122:                                       ; preds = %land.lhs.true, %for.body75, %lor.lhs.false.thread, %if.then85, %if.else107, %if.then97
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  %indvars.iv13 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next14, %for.inc9 ]
...
for.cond12:                                       ; preds = %for.cond1, %for.inc26
  ...
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc26 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
...
for.cond15:                                       ; preds = %for.cond12, %for.inc23
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc23 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
