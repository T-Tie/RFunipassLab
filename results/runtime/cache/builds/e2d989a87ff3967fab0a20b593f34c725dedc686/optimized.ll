...
while.cond:                                       ; preds = %while.cond.preheader, %if.end10
  ...
  br i1 %cmp1, label %while.body, label %while.end.split.loop.exit19
...
if.then:                                          ; preds = %while.body
  ...
  %3 = load i64, ptr %gep, align 8, !tbaa !11
...
while.end.split.loop.exit19:                      ; preds = %while.cond
  %4 = trunc nsw i64 %indvars.iv to i32
  br label %while.end

while.end:                                        ; preds = %if.else.i, %while.end.split.loop.exit19
  %i.2 = phi i32 [ %4, %while.end.split.loop.exit19 ], [ %number, %if.else.i ]
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull align 16 captures(none) dereferenceable(25000) %word) #9
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %number) #9
  ret i32 0
}
