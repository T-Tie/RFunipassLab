...
for.cond2.preheader:                              ; preds = %for.cond
  %smax25 = call i64 @llvm.smax.i64(i64 %1, i64 1)
  br label %for.cond5
...
for.cond5:                                        ; preds = %for.body7, %for.cond2.preheader
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body7 ], [ 1, %for.cond2.preheader ]
  %index.0 = phi i32 [ %spec.select, %for.body7 ], [ 0, %for.cond2.preheader ]
  %exitcond26.not = icmp eq i64 %indvars.iv19, %smax25
  br i1 %exitcond26.not, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv19
...
for.cond5.1:                                      ; preds = %for.body7.1, %for.end15
  %indvars.iv19.1 = phi i64 [ %indvars.iv.next20.1, %for.body7.1 ], [ 2, %for.end15 ]
  %index.0.1 = phi i32 [ %spec.select.1, %for.body7.1 ], [ 1, %for.end15 ]
  %exitcond.not = icmp eq i64 %indvars.iv19.1, %smax
  br i1 %exitcond.not, label %for.end26, label %for.body7.1

for.body7.1:                                      ; preds = %for.cond5.1
  %arrayidx9.1 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv19.1
  ...
  %8 = trunc nuw nsw i64 %indvars.iv19.1 to i32
  %spec.select.1 = select i1 %cmp12.1, i32 %8, i32 %index.0.1
  %indvars.iv.next20.1 = add nuw nsw i64 %indvars.iv19.1, 1
  br label %for.cond5.1
...
for.end26:                                        ; preds = %for.cond5.1
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %10, i32 noundef %9)
