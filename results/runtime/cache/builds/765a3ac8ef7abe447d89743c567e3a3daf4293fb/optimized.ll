...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %w) #4
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %sub44 = sub nsw i32 %11, 1
  %cmp45 = icmp slt i32 %10, %sub44
...
for.inc50:                                        ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12) #5
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13) #5
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %w) #5
