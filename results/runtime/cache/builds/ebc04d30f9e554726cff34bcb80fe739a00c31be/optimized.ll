...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call.i.i44 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %word) #9
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !27, !invariant.load !8
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !30, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !32, !invariant.load !8
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !40, !invariant.load !8
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #7 {
if.then_after_outline.exitStub:
  ...
  %call.i55 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i54, i8 noundef signext 10)
  %call1.i56 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i55)
