...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax28 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax29 = call i32 @llvm.smax.i32(i32 %smax28, i32 noundef 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax35 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
for.cond55:                                       ; preds = %for.cond52, %for.inc80
  ...
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond61.not = icmp eq i64 %indvars.iv55, %wide.trip.count
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv79 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre.pre-phi, %for.inc198 ]
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax70 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond72.not, label %if.end178.loopexit91, label %for.inc148
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax76 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
...
if.end178.loopexit91:                             ; preds = %for.cond137
  %.pre92 = add nuw nsw i64 %indvars.iv79, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit91
  %.pre.pre-phi = phi i64 [ %.pre92, %if.end178.loopexit91 ], [ %20, %for.cond158 ]
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar7 = call i32 @putchar(i32 noundef 10) #7
  br label %for.inc198
