...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %call16.i21 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i20) #13
  %3 = add i64 %2, -257
...
if.then19.i26:                                    ; preds = %if.then6.i11
  ...
  %call24.i31 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i30) #13
...
if.then6.i50:                                     ; preds = %if.then28.i37, %if.then19.i26, %if.then6.i11
  ...
  %call16.i60 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i59) #13
  %5 = add i64 %4, -257
...
if.then19.i65:                                    ; preds = %if.then6.i50
  ...
  %call24.i70 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i69) #13
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit81: ; preds = %if.then6.i50, %if.then19.i65, %if.then28.i76
  %call6 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %a) #14
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit81
  ...
  %indvars.iv100 = phi i32 [ %indvars.iv.next101, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit81 ]
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count103 = zext i32 %indvars.iv100 to i64
  br label %for.cond37

for.inc30:                                        ; preds = %for.body, %for.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %indvars.iv.next101 = add nuw i32 %indvars.iv100, 1
