...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %c) #8
...
if.end5:                                          ; preds = %if.then, %if.then3, %entry
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %c) #9
  ret void
}
