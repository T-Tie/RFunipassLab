...
for.end:                                          ; preds = %for.cond
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %arrayidx) #8
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc12, %for.end
  %sub.sink = phi i32 [ %phiofops, %for.end ], [ %dec, %for.inc12 ]
  %cmp7 = icmp sge i32 %sub.sink, 0
  br i1 %cmp7, label %for.inc12, label %for.end13

for.inc12:                                        ; preds = %for.cond6
  %idxprom8 = sext i32 %sub.sink to i64
