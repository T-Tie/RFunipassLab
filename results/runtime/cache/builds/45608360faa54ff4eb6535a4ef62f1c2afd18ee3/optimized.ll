...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next10, %for.body4 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv9
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  ...
  br i1 %exitcond17.not, label %for.end28, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv13
