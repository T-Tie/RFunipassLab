...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv10 = phi i32 [ %indvars.iv.next11, %for.inc ], [ 0, %entry ]
  ...
  %.pre13 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
  br i1 %cmp, label %land.lhs.true, label %for.inc

land.lhs.true:                                    ; preds = %for.cond
  %cmp15 = icmp eq i32 %.pre, 0
  %cmp19 = icmp eq i32 %.pre13, 0
...
for.inc:                                          ; preds = %for.cond, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre13, %land.lhs.true ], [ %.pre13, %for.cond ]
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc61
  %indvars.iv7 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next8, %for.inc61 ]
...
for.inc61:                                        ; preds = %for.cond56
  %arrayidx59 = getelementptr inbounds nuw [1000 x i32], ptr %sum, i64 0, i64 %indvars.iv7
