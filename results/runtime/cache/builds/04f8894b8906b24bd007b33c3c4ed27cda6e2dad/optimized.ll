...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.end27
  %indvars.iv17 = phi i32 [ %sub, %for.cond2.preheader ], [ %indvars.iv.next18, %for.end27 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %inc.i8, %for.end27 ]
...
for.cond5.preheader:                              ; preds = %for.cond2
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv17, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %if.end
  %indvars.iv14 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next15, %if.end ]
