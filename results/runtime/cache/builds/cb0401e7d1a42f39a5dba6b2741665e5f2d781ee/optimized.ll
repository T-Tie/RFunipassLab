...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %land.lhs.true.i, %if.then19.i, %if.then28.i
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #13
...
if.end.thread:                                    ; preds = %while.body
  %cmp813 = icmp slt i32 %add, 80
  br i1 %cmp813, label %if.else14, label %if.then25
...
if.end19:                                         ; preds = %if.end, %if.else14
  %_ZSt4cout.sink = phi ptr [ %call15, %if.else14 ], [ @_ZSt4cout, %if.end ]
  %sum.114 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, ptr noundef nonnull align 16 dereferenceable(40) %a)
  %cmp20 = icmp eq i32 %sum.114, 80
...
if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  ...
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.114, %if.end19 ], [ 0, %if.then21 ]
  %3 = load i32, ptr %n, align 4, !tbaa !22
  %dec = add nsw i32 %3, -1
  store i32 %dec, ptr %n, align 4, !tbaa !22
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #12
  ret i32 0
}
