...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2040, ptr noundef align 16 %a) #4
...
if.end27:                                         ; preds = %if.then16, %for.body9
  br label %for.inc28

for.inc28:                                        ; preds = %if.end27
  %dec29 = add nsw i32 %6, -1
  store i32 %dec29, ptr %j, align 4, !tbaa !5
...
for.end33:                                        ; preds = %for.cond3
  ...
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc44, %for.end33
  %10 = load i32, ptr %j, align 4, !tbaa !5
  %cmp38 = icmp sle i32 %10, %sub
  br i1 %cmp38, label %for.body39, label %for.end46

for.body39:                                       ; preds = %for.cond36
  %call40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 44)
  ...
  %call43 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call40, i32 noundef %11)
  br label %for.inc44
...
for.end46:                                        ; preds = %for.cond36
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2040, ptr noundef %a) #5
  ret i32 0
}
