...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %s_all) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %s_good) #7
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %all) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %good) #7
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %good) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %all) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %s_good) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %s_all) #7
...
if.then15_to_outline:                             ; preds = %newFuncRoot
  ...
  %1 = load i64, ptr %gep32, align 8, !tbaa !25
...
!30 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !20, i64 0}
!31 = !{!"_ZTSNSt8ios_base6_WordsE", !20, i64 0, !27, i64 8}
!32 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !20, i64 0}
!33 = !{!"_ZTSSt6locale", !34, i64 0}
!34 = !{!"p1 _ZTSNSt6locale5_ImplE", !20, i64 0}
