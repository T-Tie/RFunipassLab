...
for.end:                                          ; preds = %for.cond10
  br i1 true, label %if.then21, label %for.inc35
...
for.inc31:                                        ; preds = %for.cond22
  ...
  %2 = load i8, ptr %arrayidx28, align 1, !tbaa !5, !invariant.load !8
...
for.inc35:                                        ; preds = %for.end, %for.end.thread
