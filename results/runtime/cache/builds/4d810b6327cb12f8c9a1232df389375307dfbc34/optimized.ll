...
for.inc8:                                         ; preds = %for.cond2
  ...
  %call5 = call noundef i32 @_Z2ljPiii(ptr noundef nonnull %a, i32 noundef %2, i32 noundef %0)
...
define dso_local noundef range(i32 -2147483647, -2147483648) i32 @_Z2ljPiii(ptr noundef readonly captures(none) %a, i32 noundef %n, i32 noundef %m) #3 {
entry:
  %b = alloca [25 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %b) #7
  %sub = add nsw i32 %m, -1
...
if.then10:                                        ; preds = %for.body4
  ...
  %call = tail call noundef i32 @_Z2ljPiii(ptr noundef nonnull %a, i32 noundef %4, i32 noundef %m)
