...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec5 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv7
...
if.then:                                          ; preds = %for.body3
  %div3 = udiv i32 %3, 10
  %arrayidx10 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next8
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %add11 = add nsw i32 %4, %div3
  store i32 %add11, ptr %arrayidx10, align 4, !tbaa !5
  %rem4 = urem i32 %3, 10
  store i32 %rem4, ptr %arrayidx5, align 4, !tbaa !5
  %sub = add nsw i32 %k.1, -1
  %5 = zext i32 %sub to i64
  %cmp14 = icmp eq i64 %indvars.iv7, %5
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv11 = phi i64 [ %0, %for.cond22.preheader ], [ %7, %for.inc28 ]
  %6 = trunc nuw i64 %indvars.iv11 to i32
  %cmp23 = icmp sgt i32 %6, 0
  br i1 %cmp23, label %for.inc28, label %for.end30

for.inc28:                                        ; preds = %for.cond22
  %7 = add nsw i64 %indvars.iv11, -1
