...
for.end.thread:                                   ; preds = %for.cond2
  %cmp64 = icmp sgt i32 %index.0, -1
  br i1 %cmp64, label %if.then7, label %for.inc12
...
for.inc12:                                        ; preds = %for.body4, %for.end.thread, %if.then7
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc21
  %indvars.iv11 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next12, %for.inc21 ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.end23, label %for.inc21

for.inc21:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [1000 x i32], ptr %result, i64 0, i64 %indvars.iv11
