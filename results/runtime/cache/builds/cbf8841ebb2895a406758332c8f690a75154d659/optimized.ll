...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i4) #8
...
if.then19:                                        ; preds = %if.end
  ...
  %11 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !9
...
for.end31:                                        ; preds = %for.cond5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %i4) #8
