...
if.then6.i:                                       ; preds = %for.body
  ...
  %gep1 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i
  %3 = load i64, ptr %gep1, align 8, !tbaa !11
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv3, %5
...
for.inc74:                                        ; preds = %if.then, %if.then44, %if.else58, %if.then33
  ...
  %j.1 = phi i32 [ %inc30, %if.then ], [ 0, %if.then33 ], [ %inc57, %if.else58 ], [ %inc57, %if.then44 ]
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax13 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %6 = add i32 %smax13, 1
  %wide.trip.count14 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond15 = icmp eq i64 %indvars.iv9, %wide.trip.count14
  br i1 %exitcond15, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv9
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv9, i64 %7
  br label %for.cond94
...
for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv6, %7
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv9, i64 %indvars.iv6
