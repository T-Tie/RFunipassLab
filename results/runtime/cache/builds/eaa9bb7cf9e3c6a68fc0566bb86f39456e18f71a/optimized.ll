...
entry:
  ...
  %rem12 = srem i8 %rem1.lhs.trunc, 50
  %rem1.sext = sext i8 %rem12 to i32
  %sub2 = sub nsw i32 %rem, %rem1.sext
  %div3.lhs.trunc = trunc nsw i32 %sub2 to i16
  %div33 = sdiv i16 %div3.lhs.trunc, 50
  %div3.sext = sext i16 %div33 to i32
  %rem44 = srem i8 %rem12, 20
  %div65 = sdiv i8 %rem12, 20
  %div6.sext = sext i8 %div65 to i32
  %rem76 = srem i8 %rem44, 10
  %rem7.sext = sext i8 %rem76 to i32
  %div97 = sdiv i8 %rem44, 10
  %div9.sext = sext i8 %div97 to i32
  store i32 %rem7.sext, ptr %n, align 4, !tbaa !5
  %rem108 = srem i8 %rem76, 5
  %rem10.sext = sext i8 %rem108 to i32
  %div129 = sdiv i8 %rem76, 5
