...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
...
for.cond22.preheader:                             ; preds = %for.cond10
  %sext38 = shl i64 %2, 32
  %3 = ashr exact i64 %sext38, 32
  %sext39 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext39, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv27
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %6 = sub nuw nsw i64 %indvars.iv27, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv34 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next35, %for.body25 ]
  %cmp24 = icmp slt i64 %indvars.iv34, %3
  br i1 %cmp24, label %for.body25, label %for.end37

for.body25:                                       ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv34, %4
  ...
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv34
