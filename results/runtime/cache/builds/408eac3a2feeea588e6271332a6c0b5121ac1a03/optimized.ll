...
for.cond37:                                       ; preds = %for.end73, %for.end32
  %i.2 = phi i32 [ 0, %for.end32 ], [ %inc75, %for.end73 ]
  %cmp38 = icmp slt i32 %i.2, %8
  br i1 %cmp38, label %for.body39, label %for.end76

for.body39:                                       ; preds = %for.cond37
  br label %for.cond40

for.cond40:                                       ; preds = %for.end70, %for.body39
  %j.2 = phi i32 [ 0, %for.body39 ], [ %inc72, %for.end70 ]
  %cmp41 = icmp slt i32 %j.2, %9
  br i1 %cmp41, label %for.body42, label %for.end73

for.body42:                                       ; preds = %for.cond40
  %mul43 = mul nsw i32 %i.2, %9
...
for.cond47:                                       ; preds = %for.body49, %for.body42
  %k.0 = phi i32 [ 0, %for.body42 ], [ %inc69, %for.body49 ]
...
for.body49:                                       ; preds = %for.cond47
  ...
  %mul54 = mul nsw i32 %i.2, %11
  %add55 = add nsw i32 %mul54, %k.0
  %idxprom56 = sext i32 %add55 to i64
  %arrayidx57 = getelementptr inbounds i32, ptr %call2, i64 %idxprom56
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !15
  %mul58 = mul nsw i32 %k.0, %9
  ...
  %mul62 = mul nsw i32 %12, %13
  %add63 = add nsw i32 %10, %mul62
...
for.cond77:                                       ; preds = %for.end97, %for.end76
  %i.3 = phi i32 [ 0, %for.end76 ], [ %inc99, %for.end97 ]
...
for.body82:                                       ; preds = %for.cond80
  ...
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %16) #7
