...
for.inc11:                                        ; preds = %for.body, %for.end
  %pre.1 = phi i32 [ %1, %for.end ], [ %pre.0, %for.body ]
  %dec = add nsw i32 %1, -1
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %5 = load i8, ptr %arrayidx19, align 1, !tbaa !9, !invariant.load !10
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !34, !invariant.load !10
