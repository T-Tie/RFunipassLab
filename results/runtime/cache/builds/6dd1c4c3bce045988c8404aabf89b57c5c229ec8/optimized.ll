...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1) unnamed_addr #7 {
newFuncRoot:
  call void @outlined_ir_func_0.6(ptr %0)
...
for.end33_after_outline.exitStub:                 ; preds = %newFuncRoot
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0, ptr %1) unnamed_addr #7 {
newFuncRoot:
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr %0) unnamed_addr #7 {
newFuncRoot:
  call void @outlined_ir_func_0.6(ptr %0)
  br label %for.body25_after_outline.exitStub

for.body25_after_outline.exitStub:                ; preds = %newFuncRoot
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_0.6(ptr %0) #7 {
newFuncRoot:
  br label %newFuncRoot_to_outline

newFuncRoot_to_outline:                           ; preds = %newFuncRoot
  br label %for.end33_to_outline

for.end33_to_outline:                             ; preds = %newFuncRoot_to_outline
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
  ...
  br label %newFuncRoot_after_outline.exitStub

newFuncRoot_after_outline.exitStub:               ; preds = %for.end33_to_outline
  ret void
}
