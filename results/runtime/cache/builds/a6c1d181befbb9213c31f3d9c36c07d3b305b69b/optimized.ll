...
for.body:                                         ; preds = %for.cond
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call2, i8 noundef signext %call.i2)
...
entry:
  %cond = icmp eq i32 %a, 1
  br i1 %cond, label %if.then6, label %for.cond
...
if.then3:                                         ; preds = %for.body
  tail call void @_Z6yinshuii(i32 noundef %div, i32 noundef %i.0)
  br label %for.inc
