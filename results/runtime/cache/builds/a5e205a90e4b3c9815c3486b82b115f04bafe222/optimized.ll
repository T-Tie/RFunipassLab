...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %1 = phi i32 [ %sub15, %while.body13 ], [ %.pr2, %while.end7 ]
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %2 = phi i32 [ %sub24, %while.body22 ], [ %.pr3, %while.end16 ]
  %cmp18 = icmp slt i32 %2, 20
...
while.cond26:                                     ; preds = %while.body31, %while.end25
  ...
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr4, %while.end25 ]
  %cmp27 = icmp slt i32 %3, 10
...
while.end41:                                      ; preds = %while.cond35, %while.body40, %land.end39
  %f.0 = phi i32 [ %.pr5, %while.body40 ], [ 0, %land.end39 ], [ 0, %while.cond35 ]
