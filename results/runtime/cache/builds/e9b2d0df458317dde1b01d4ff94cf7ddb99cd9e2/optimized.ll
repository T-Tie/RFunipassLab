...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 101, ptr noundef nonnull align 16 dereferenceable(101) %a) #7
...
for.end:                                          ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr %arrayidx13)
...
for.inc24:                                        ; preds = %for.cond16
  ...
  call fastcc void @outlined_ir_func_0(ptr %arrayidx21)
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 101, ptr noundef nonnull %a) #8
  ret i32 0
}
