...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv21 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next22, %for.inc24 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc24 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv27 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next28, %for.body29 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond32.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv27, 0
  %5 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv27
