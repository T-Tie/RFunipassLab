...
if.end19:                                         ; preds = %while.body13
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef %arrayidx15)
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !28, !invariant.load !12
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !36, !invariant.load !12
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !37, !invariant.load !12
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !40, !invariant.load !12
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !41, !invariant.load !12
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !42, !invariant.load !12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !43, !invariant.load !12
