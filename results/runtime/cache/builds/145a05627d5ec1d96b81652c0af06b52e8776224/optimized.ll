...
if.end:                                           ; preds = %land.lhs.true, %for.body23
  ...
  %4 = load i32, ptr %arrayidx27, align 16, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %j29) #5
  br label %for.cond30
...
for.end47:                                        ; preds = %for.cond30
  call void @llvm.lifetime.end.p0(i64 4, ptr %j29) #5
  %sub51 = sub nsw i32 %4, %minValue.0
  store i32 %sub51, ptr %arrayidx27, align 16, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %j52) #5
  br label %for.cond54
...
for.end65:                                        ; preds = %for.cond54
  call void @llvm.lifetime.end.p0(i64 4, ptr %j52) #5
  br label %for.inc66
...
if.end78:                                         ; preds = %land.lhs.true75, %for.body73
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %i83) #5
  br label %for.cond85
...
for.end102:                                       ; preds = %for.cond85
  call void @llvm.lifetime.end.p0(i64 4, ptr %i83) #5
  %sub106 = sub nsw i32 %9, %minValue79.0
  store i32 %sub106, ptr %arrayidx82, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %i107) #5
...
for.end120:                                       ; preds = %for.cond109
  call void @llvm.lifetime.end.p0(i64 4, ptr %i107) #5
  br label %for.inc121
