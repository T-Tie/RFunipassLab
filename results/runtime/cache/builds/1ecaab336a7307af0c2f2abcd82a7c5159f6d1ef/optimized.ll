...
for.cond.for.inc_crit_edge:                       ; preds = %for.cond
  %.pre35 = load i32, ptr %arrayidx4, align 4, !tbaa !5
  br label %for.inc
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre35, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre36, %land.lhs.true ]
