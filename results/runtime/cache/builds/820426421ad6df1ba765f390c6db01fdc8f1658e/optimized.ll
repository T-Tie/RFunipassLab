...
for.inc17:                                        ; preds = %for.cond13
  ...
  tail call void @_Z7zerocoli(i32 noundef %4)
  %5 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 408), align 4, !tbaa !5
  ...
  tail call void @_Z4jiani(i32 noundef %7)
