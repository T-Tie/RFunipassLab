...
if.else:                                          ; preds = %for.end65
  ...
  call fastcc void @outlined_ir_func_0(ptr nonnull %call70)
  br label %for.cond73
...
if.then81:                                        ; preds = %for.body77
  ...
  call fastcc void @outlined_ir_func_0(ptr nonnull @_ZSt4cout)
  br label %for.inc88
...
for.cond73.exitStub:
  ...
  %call.i4 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i, i8 noundef signext 10)
  %call1.i5 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %call.i4)
  %call.i.i6 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i5)
  ret void
}
