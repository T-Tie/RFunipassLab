...
for.body16:                                       ; preds = %for.cond14
  ...
  %2 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !13
...
for.inc24:                                        ; preds = %for.body16, %if.then22
  ...
  %b1.2 = phi i32 [ %j.1, %if.then22 ], [ %b1.1, %for.body16 ]
...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  ...
  %sub.sink12 = phi i32 [ %sub, %if.then35 ], [ %sub49, %for.inc48 ]
  %cmp38 = icmp sge i32 %sub.sink12, 0
...
for.body39:                                       ; preds = %for.cond37
  ...
  %idxprom42 = sext i32 %sub.sink12 to i64
...
for.inc48:                                        ; preds = %for.body39, %if.then45
  ...
  %b2.2 = phi i32 [ %sub.sink12, %if.then45 ], [ %b2.1, %for.body39 ]
  %a2.2 = phi i32 [ %sub.sink, %if.then45 ], [ %a2.1, %for.body39 ]
  %sub49 = sub nsw i32 %sub.sink12, 1
