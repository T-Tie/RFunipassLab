...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %total) #7
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %valid) #7
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %t1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %v1) #7
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %v1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %t1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %valid) #8
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %total) #8
  ret i32 0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !14
...
if.end:                                           ; preds = %entry
  ...
  %2 = load ptr, ptr %vfn, align 8, !invariant.load !42
...
if.then_to_outline:                               ; preds = %newFuncRoot
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !40
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !42
...
!36 = !{!"p1 _ZTS15__locale_struct", !20, i64 0}
!37 = !{!"p1 int", !20, i64 0}
!38 = !{!"p1 short", !20, i64 0}
!39 = !{!7, !7, i64 0}
!40 = !{!41, !41, i64 0}
