...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull %tar) #5
...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
...
for.cond22.preheader:                             ; preds = %for.cond10
  %sext26 = shl i64 %2, 32
  %3 = ashr exact i64 %sext26, 32
  %sext27 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext27, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv15
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %6 = sub nuw nsw i64 %indvars.iv15, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc31
  %indvars.iv22 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next23, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv22, %3
  br i1 %cmp24, label %for.inc31, label %for.end37

for.inc31:                                        ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv22, %4
  %arrayidx28 = getelementptr inbounds nuw [256 x i8], ptr %tar, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv22
