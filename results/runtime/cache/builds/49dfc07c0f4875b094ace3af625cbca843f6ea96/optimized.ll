...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 25000, ptr %word) #8
  call void @llvm.lifetime.start.p0(i64 2000, ptr %l) #8
...
for.end49:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 2000, ptr %l) #8
  call void @llvm.lifetime.end.p0(i64 25000, ptr %word) #8
