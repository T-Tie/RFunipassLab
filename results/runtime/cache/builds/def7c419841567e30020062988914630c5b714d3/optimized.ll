...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv30 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next31, %for.inc24 ]
  %indvars.iv25 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next26, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv30, 2
...
for.cond5:                                        ; preds = %for.body7, %for.body4
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body7 ], [ %indvars.iv25, %for.body4 ]
  %index.0 = phi i32 [ %spec.select, %for.body7 ], [ %2, %for.body4 ]
  %cmp6 = icmp slt i64 %indvars.iv27, %1
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv30
