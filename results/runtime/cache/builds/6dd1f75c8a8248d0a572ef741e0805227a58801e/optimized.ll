...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv72 to i32
...
for.cond1:                                        ; preds = %for.cond, %for.inc31
  ...
  %exitcond30.not = icmp eq i64 %indvars.iv26, %indvars.iv72
  br i1 %exitcond30.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv26
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv72
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv26, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv21 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next22, %for.inc28 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %indvars.iv72
  br i1 %exitcond25.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv26, i64 %indvars.iv21
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %indvars.iv72
  br i1 %exitcond50.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %indvars.iv72
  br i1 %exitcond35.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv31, i64 %indvars.iv46
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv46
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select15, %for.body57 ], [ %6, %if.then51 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %indvars.iv72
  br i1 %exitcond40.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv36, i64 %indvars.iv46
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !9
  %spec.select15 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond55, !llvm.loop !16

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv41 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next42, %for.inc84 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %indvars.iv72
  br i1 %exitcond45.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv41, i64 %indvars.iv46
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %indvars.iv72
  br i1 %exitcond61.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %indvars.iv72
  br i1 %exitcond56.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv57, i64 %indvars.iv51
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !9
  %11 = add nsw i64 %indvars.iv51, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv57, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %indvars.iv72
  br i1 %exitcond71.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep17 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv67
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv62 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next63, %for.inc129 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %indvars.iv72
  br i1 %exitcond66.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv62, i64 %indvars.iv67
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5, !invariant.load !9
  %gep18 = getelementptr [100 x i32], ptr %invariant.gep17, i64 %indvars.iv62
  store i32 %12, ptr %gep18, align 4, !tbaa !5
...
for.cond:                                         ; preds = %for.inc16, %entry
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc16 ], [ 0, %entry ]
  %2 = sext i32 %1 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %5 = sext i32 %4 to i64
  %cmp2 = icmp slt i64 %indvars.iv3, %5
  br i1 %cmp2, label %for.cond4, label %for.inc16

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %6 = phi i32 [ %.pre13, %for.inc ], [ %3, %for.cond1 ]
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %num, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
for.inc16:                                        ; preds = %for.cond1
  ...
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv6
  store i32 %call13, ptr %arrayidx15, align 4, !tbaa !5
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %for.cond, !llvm.loop !26

for.cond19:                                       ; preds = %for.cond, %for.inc26
  %8 = phi i32 [ %.pre12, %for.inc26 ], [ %1, %for.cond ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc26 ], [ 0, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp20 = icmp slt i64 %indvars.iv9, %9
  br i1 %cmp20, label %for.inc26, label %for.end28

for.inc26:                                        ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv9
  %10 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !9
