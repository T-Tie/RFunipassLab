...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %3 = sext i32 %2 to i64
  %cmp1 = icmp slt i64 %indvars.iv11, %3
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv68 = phi i64 [ %6, %while.cond11.preheader ], [ %indvars.iv.next69, %for.end138 ]
  ...
  %9 = trunc nuw i64 %indvars.iv68 to i32
...
for.cond58:                                       ; preds = %for.body60, %for.body54
  ...
  %min.2 = phi i32 [ %spec.select9, %for.body60 ], [ %13, %for.body54 ]
...
for.body60:                                       ; preds = %for.cond58
  ...
  %spec.select9 = call i32 @llvm.smin.i32(i32 %min.2, i32 %14)
