...
for.inc:                                          ; preds = %land.lhs.true, %for.body4, %if.then9
  %a2.3 = phi i32 [ %a2.1, %for.body4 ], [ %a2.1, %land.lhs.true ], [ %j.0, %if.then9 ]
  %a1.3 = phi i32 [ %a1.1, %for.body4 ], [ %a1.1, %land.lhs.true ], [ %i.0, %if.then9 ]
  %b1.2 = phi i32 [ %b1.1, %for.body4 ], [ %i.0, %land.lhs.true ], [ %i.0, %if.then9 ]
  %b2.2 = phi i32 [ %b2.1, %for.body4 ], [ %j.0, %land.lhs.true ], [ %j.0, %if.then9 ]
