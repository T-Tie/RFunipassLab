...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc28 ], [ 1, %for.end ]
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp6 = icmp slt i64 %indvars.iv18, %7
  br i1 %cmp6, label %for.cond9.preheader, label %for.end31

for.cond9.preheader:                              ; preds = %for.cond5
  %arrayidx14 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv18
  %8 = add nsw i64 %indvars.iv18, -1
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc25
  %indvars.iv15 = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next16, %for.inc25 ]
...
for.body12:                                       ; preds = %for.cond9
  ...
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv15
...
if.end:                                           ; preds = %for.body12
  %cmp18 = icmp eq i64 %indvars.iv15, %8
...
if.then19:                                        ; preds = %if.end
  ...
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
  br label %for.inc25
...
for.end31:                                        ; preds = %for.cond5
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !15, !invariant.load !12
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !17, !invariant.load !12
