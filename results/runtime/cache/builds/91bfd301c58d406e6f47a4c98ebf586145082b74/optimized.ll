...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv15 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next16, %for.inc28 ]
  ...
  br i1 %exitcond20.not, label %for.cond31.preheader, label %for.body12
...
for.cond14.preheader:                             ; preds = %for.body12
  %4 = trunc nuw nsw i64 %indvars.iv15 to i32
  br label %for.cond14
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv15, i64 %indvars.iv11
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv26 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next27, %for.inc52 ]
  ...
  %cmp32 = icmp sgt i64 %indvars.iv26, 0
...
for.cond37.preheader:                             ; preds = %for.body33
  %7 = trunc nsw i64 %indvars.iv.next27 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv22 = phi i64 [ %wide.trip.count, %for.cond37.preheader ], [ %indvars.iv.next23, %for.body39 ]
  ...
  %8 = trunc nuw i64 %indvars.iv22 to i32
...
for.body39:                                       ; preds = %for.cond37
  ...
  %idxprom42 = and i64 %indvars.iv.next23, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next27, i64 %idxprom42
