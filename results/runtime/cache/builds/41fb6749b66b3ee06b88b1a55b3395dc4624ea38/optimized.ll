...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull align 16 %a) #7
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv67, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv124 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next125, %for.inc135 ]
  %indvars.iv121 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next122, %for.inc135 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc135 ]
  %8 = trunc nuw i64 %indvars.iv124 to i32
  %cmp14 = icmp sgt i32 %8, 1
  br i1 %cmp14, label %for.cond16, label %for.inc139

for.cond16:                                       ; preds = %for.cond13, %for.inc48
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc48 ], [ 0, %for.cond13 ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %indvars.iv124
  br i1 %exitcond82.not, label %for.cond51, label %for.cond19

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.body21 ], [ 0, %for.cond16 ]
  %min.0 = phi i32 [ %spec.select, %for.body21 ], [ 100000, %for.cond16 ]
  %exitcond.not = icmp eq i64 %indvars.iv70, %indvars.iv124
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv78, i64 %indvars.iv70
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv73 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next74, %for.inc45 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %indvars.iv124
  br i1 %exitcond77.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv78, i64 %indvars.iv73
...
for.cond51:                                       ; preds = %for.cond16, %for.inc86
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc86 ], [ 0, %for.cond16 ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %indvars.iv124
  br i1 %exitcond97.not, label %for.end88, label %for.cond54

for.cond54:                                       ; preds = %for.cond51, %for.body56
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.body56 ], [ 0, %for.cond51 ]
  %min.2 = phi i32 [ %spec.select65, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond87.not = icmp eq i64 %indvars.iv83, %indvars.iv124
  br i1 %exitcond87.not, label %for.cond71.preheader, label %for.body56

for.cond71.preheader:                             ; preds = %for.cond54
  br label %for.cond71

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv83, i64 %indvars.iv93
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !13
  %spec.select65 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1
  br label %for.cond54, !llvm.loop !17

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv88 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next89, %for.inc83 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %indvars.iv124
  br i1 %exitcond92.not, label %for.inc86, label %for.inc83

for.inc83:                                        ; preds = %for.cond71
  %arrayidx77 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv88, i64 %indvars.iv93
...
for.cond91:                                       ; preds = %for.cond95, %for.end88
  %indvars.iv103 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next104, %for.cond95 ]
  %exitcond110.not = icmp eq i64 %indvars.iv103, %indvars.iv121
  br i1 %exitcond110.not, label %for.cond113, label %for.cond95.preheader
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv98 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next99, %for.inc107 ]
  %exitcond102.not = icmp eq i64 %indvars.iv98, %indvars.iv124
  br i1 %exitcond102.not, label %for.cond91, label %for.inc107, !llvm.loop !20

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv.next104, i64 %indvars.iv98
  %14 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !13
  %arrayidx106 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv103, i64 %indvars.iv98
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  %indvars.iv116 = phi i64 [ 1, %for.cond91 ], [ %indvars.iv.next117, %for.cond116 ]
  %exitcond120.not = icmp eq i64 %indvars.iv116, %indvars.iv124
  br i1 %exitcond120.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv111 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next112, %for.inc129 ]
  %exitcond115.not = icmp eq i64 %indvars.iv111, %indvars.iv121
  br i1 %exitcond115.not, label %for.cond113, label %for.inc129, !llvm.loop !22

for.inc129:                                       ; preds = %for.cond116
  %arrayidx124 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv111, i64 %indvars.iv.next117
  %15 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx128 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv111, i64 %indvars.iv116
