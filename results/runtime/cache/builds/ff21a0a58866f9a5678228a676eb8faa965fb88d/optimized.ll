...
define dso_local void @_Z9xiangguaniii(i32 noundef %y, i32 noundef %m1, i32 noundef %m2) #3 {
entry:
...
if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %y) #6
...
for.inc.gvnsink.split:                            ; preds = %if.then8, %if.else
  %.sink4 = phi i32 [ 3, %if.else ], [ 2, %if.then8 ]
  %2 = load i32, ptr %x1, align 4, !tbaa !5
  %sub10 = sub nsw i32 %2, %.sink4
...
if.end26:                                         ; preds = %lor.lhs.false22
  %cmp27 = icmp eq i32 %3, 2
  br i1 %cmp27, label %if.then28, label %for.inc37

if.then28:                                        ; preds = %if.end26
  %call29 = call noundef i32 @_Z7runniani(i32 noundef %y) #6
  %tobool30 = icmp ne i32 %call29, 0
  br i1 %tobool30, label %for.inc37.gvnsink.split, label %if.else33

if.else33:                                        ; preds = %if.then28
  br label %for.inc37.gvnsink.split

for.inc37.gvnsink.split:                          ; preds = %if.then28, %if.else33
  %.sink3 = phi i32 [ 3, %if.else33 ], [ 2, %if.then28 ]
  %5 = load i32, ptr %x2, align 4, !tbaa !5
  %sub34 = sub nsw i32 %5, %.sink3
  store i32 %sub34, ptr %x2, align 4, !tbaa !5
  br label %for.inc37

for.inc37:                                        ; preds = %if.end26.thread, %for.inc37.gvnsink.split, %if.end26
...
define dso_local noundef i32 @_Z7runniani(i32 noundef %y) #4 {
entry:
