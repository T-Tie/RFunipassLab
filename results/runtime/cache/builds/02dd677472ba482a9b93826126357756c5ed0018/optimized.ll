...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 302, ptr nonnull %ss) #6
  ...
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %ss) #7
...
if.end29:                                         ; preds = %if.then27, %for.end25
  call void @llvm.lifetime.end.p0(i64 302, ptr nonnull %ss) #6
  ret i32 0
}
