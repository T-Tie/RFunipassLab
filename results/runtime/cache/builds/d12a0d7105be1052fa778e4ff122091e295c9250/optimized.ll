...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 550, ptr noundef nonnull align 16 %a) #9
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %wide.trip.count47 = zext nneg i32 %smax46 to i64
  br label %for.cond51

for.cond51:                                       ; preds = %entry, %for.cond51
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.cond51 ], [ 0, %entry ]
  ...
  br i1 %exitcond53.not, label %for.end65, label %for.cond51, !llvm.loop !9
...
for.cond73:                                       ; preds = %for.end65
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max.0)
