...
entry:
  ...
  %rem3.sext = sext i8 %rem31 to i32
  ...
  %div104 = sdiv i8 %rem8.lhs.trunc, 20
  %div10.sext = sext i8 %div104 to i32
  %mul.neg = mul nsw i32 %div, -100
  %mul12.neg = mul nsw i32 %div5.sext, -50
  %mul14.neg = mul nsw i32 %div10.sext, -20
  %sub17 = add i32 %mul12.neg, %mul.neg
  %sub19 = add i32 %mul14.neg, %0
  %sub21 = add i32 %sub19, %sub17
  %rem22 = srem i32 %sub21, 10
  %sub13 = add i32 %sub19, %mul.neg
  %sub15 = add i32 %sub13, %mul12.neg
  %sub23 = sub i32 %sub15, %rem22
  %div24 = sdiv i32 %sub23, 10
  %rem25 = srem i32 %0, 10
  %rem27.lhs.trunc = trunc nsw i32 %rem25 to i8
  %div296 = sdiv i8 %rem27.lhs.trunc, 5
  %div29.sext = sext i8 %div296 to i32
  %mul36.neg = mul nsw i32 %div24, -10
  %mul38.neg = mul nsw i32 %div29.sext, -5
  %sub35 = add i32 %sub19, %mul38.neg
  %sub37 = add i32 %sub35, %sub17
  %sub39 = add i32 %sub37, %mul36.neg
  %call40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div, i32 noundef %div5.sext, i32 noundef %div10.sext, i32 noundef %div24, i32 noundef %div29.sext, i32 noundef %sub39)
