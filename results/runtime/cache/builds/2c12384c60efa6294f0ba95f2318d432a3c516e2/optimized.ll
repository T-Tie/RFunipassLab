...
while.cond:                                       ; preds = %cleanup.cont, %if.end
  %__parent.0 = phi i64 [ %div, %if.end ], [ %__parent.1, %cleanup.cont ]
  br label %while.body
...
cleanup:                                          ; preds = %if.end7, %if.then6
  %__parent.1 = phi i64 [ %__parent.0, %if.then6 ], [ %dec, %if.end7 ]
  %cleanup.dest.slot.0 = phi i32 [ 1, %if.then6 ], [ 0, %if.end7 ]
...
land.end:                                         ; preds = %land.rhs, %while.cond
  %0 = phi i1 [ false, %while.cond ], [ %call, %land.rhs ]
  br i1 %0, label %while.body, label %while.end

while.body:                                       ; preds = %land.end
  %add.ptr1 = getelementptr inbounds i32, ptr %__first, i64 %div
  %1 = load i32, ptr %add.ptr1, align 4, !tbaa !5
