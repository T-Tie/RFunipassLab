...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 500, ptr noundef nonnull align 16 %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 3006, ptr noundef nonnull align 16 %b) #7
...
for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc121
  %indvars.iv31 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next32, %for.inc121 ]
  %exitcond39.not = icmp eq i64 %indvars.iv31, %wide.trip.count38
  br i1 %exitcond39.not, label %for.end123, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv31, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc118
  %indvars.iv33 = phi i64 [ %indvars.iv31, %for.cond76.preheader ], [ %indvars.iv.next34, %for.inc118 ]
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %10 = trunc nuw i64 %indvars.iv.next34 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.inc121

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next34, i64 4
...
for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next34, i64 %indvars.iv27
  ...
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv31, i64 %indvars.iv27
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc151 ], [ 1, %if.else ]
  ...
  br i1 %exitcond47.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv40, i64 4
  %18 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %19 = add nsw i64 %indvars.iv40, -1
...
for.body136.for.end153_crit_edge:                 ; preds = %for.body136
  %.pre = and i64 %indvars.iv40, 4294967295
  br label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136.for.end153_crit_edge
  %.pre-phi = phi i64 [ %.pre, %for.body136.for.end153_crit_edge ], [ %wide.trip.count46, %for.cond134 ]
  %phiofops.lcssa = phi i32 [ %phiofops, %for.body136.for.end153_crit_edge ], [ %smax37, %for.cond134 ]
  %wide.trip.count58 = zext i32 %phiofops.lcssa to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond59.not = icmp eq i64 %indvars.iv52, %wide.trip.count58
  br i1 %exitcond59.not, label %for.cond207, label %for.cond159.preheader

for.cond159.preheader:                            ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv52, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  %indvars.iv54 = phi i64 [ %indvars.iv52, %for.cond159.preheader ], [ %indvars.iv.next55, %for.inc201 ]
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %cmp160 = icmp samesign ult i64 %indvars.iv.next55, %.pre-phi
  br i1 %cmp160, label %for.body161, label %for.inc204

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next55, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond51.not = icmp eq i64 %indvars.iv48, 6
  br i1 %exitcond51.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next55, i64 %indvars.iv48
  %23 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv48
  store i8 %23, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv52, i64 %indvars.iv48
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %.pre-phi
  br i1 %exitcond67.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc220 ], [ 0, %for.body209 ]
  %26 = load i32, ptr %n, align 4, !tbaa !5
  %27 = sext i32 %26 to i64
  %cmp212 = icmp slt i64 %indvars.iv60, %27
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv63, i64 %indvars.iv60
  %28 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %28 to i32
  %putchar1 = call i32 @putchar(i32 noundef %conv218) #10
