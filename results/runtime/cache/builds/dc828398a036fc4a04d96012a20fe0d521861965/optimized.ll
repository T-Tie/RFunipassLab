...
lor.lhs.false22:                                  ; preds = %lor.lhs.false17
  ...
  br i1 %cmp26, label %land.lhs.true, label %if.end75.loopexit
...
lor.lhs.false41:                                  ; preds = %lor.lhs.false36
  ...
  br i1 %cmp45, label %for.inc, label %if.end75.loopexit
...
for.end65:                                        ; preds = %for.cond50
  %count.0.lcssa = phi i32 [ %count.0, %for.cond50 ]
  %conv66 = sitofp i32 %count.0.lcssa to double
...
if.end75.loopexit:                                ; preds = %lor.lhs.false22, %lor.lhs.false41
  br label %if.end75

if.end75:                                         ; preds = %if.end75.loopexit, %for.end65, %entry, %if.else71
  %.str.3.sink = phi ptr [ @.str.3, %if.else71 ], [ @.str.1, %entry ], [ @.str.2, %for.end65 ], [ @.str.1, %if.end75.loopexit ]
