...
for.end:                                          ; preds = %for.cond
  ...
  %call5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %sum.0.lcssa)
...
if.then:                                          ; preds = %for.cond
  %phiofops.lcssa = phi i32 [ %phiofops, %for.cond ]
  ret i32 %phiofops.lcssa
...
for.cond9:                                        ; preds = %for.inc16, %if.else
  ...
  %cmp10 = icmp slt i32 %i.1, %j.0.lcssa
  br i1 %cmp10, label %for.inc16, label %cleanup.loopexit
...
cleanup.loopexit:                                 ; preds = %for.cond9
  %count.0.lcssa = phi i32 [ %count.0, %for.cond9 ]
  br label %cleanup

cleanup:                                          ; preds = %cleanup.loopexit, %for.end
  %retval.1 = phi i32 [ 0, %for.end ], [ %count.0.lcssa, %cleanup.loopexit ]
