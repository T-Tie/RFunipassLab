...
entry:
  ...
  %call = tail call i64 @strlen(ptr nofree noundef nonnull readonly captures(none) dereferenceable(1) %str) #12
...
while.body12:                                     ; preds = %while.cond8
  ...
  %1 = load i32, ptr %nPtr.1.ptr, align 4, !tbaa !5, !invariant.load !13
  %mul = mul nsw i32 %1, %n
  %rem = srem i32 %mul, 10
