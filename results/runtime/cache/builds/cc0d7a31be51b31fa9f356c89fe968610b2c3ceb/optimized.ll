...
for.cond:                                         ; preds = %for.inc5, %entry
  ...
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc5 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv44, %1
  br i1 %cmp, label %for.cond1.preheader, label %for.cond8.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv44
  br label %for.cond1
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %3 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre72, %for.body3 ]
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  %indvars.iv51 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next52, %for.inc25 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %2
  br i1 %exitcond56.not, label %for.end27, label %for.cond11

for.cond11:                                       ; preds = %for.cond8, %for.inc19
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc19 ], [ 0, %for.cond8 ]
  %exitcond.not = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond.not, label %for.inc25, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv51, i64 %indvars.iv47
...
for.end27.loopexit:                               ; preds = %for.body13
  %6 = trunc nuw nsw i64 %indvars.iv51 to i32
  %7 = trunc nuw nsw i64 %indvars.iv47 to i32
  %.pre71 = and i64 %indvars.iv51, 4294967295
  br label %for.end27

for.end27:                                        ; preds = %for.cond8, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre71, %for.end27.loopexit ], [ %2, %for.cond8 ]
  %i.142 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.cond8 ]
  %y1.1 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.cond8 ]
  %8 = sext i32 %y1.1 to i64
  %smax60 = call i32 @llvm.smax.i32(i32 %y1.1, i32 %0)
  %wide.trip.count62 = sext i32 %smax60 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body30, %for.end27
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.body30 ], [ %8, %for.end27 ]
  %exitcond63.not = icmp eq i64 %indvars.iv57, %wide.trip.count62
  br i1 %exitcond63.not, label %for.end42, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %indvars.iv.next58 = add nsw i64 %indvars.iv57, 1
  %arrayidx34 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %idxprom31.pre-phi, i64 %indvars.iv.next58
  %9 = load i32, ptr %arrayidx34, align 4, !tbaa !5
  %cmp35.not = icmp eq i32 %9, 0
  %cmp37.not = icmp slt i64 %indvars.iv.next58, %1
  %or.cond = and i1 %cmp37.not, %cmp35.not
  br i1 %or.cond, label %for.cond28, label %for.end42.split.loop.exit, !llvm.loop !15

for.end42.split.loop.exit:                        ; preds = %for.body30
  %10 = trunc nsw i64 %indvars.iv57 to i32
  br label %for.end42

for.end42:                                        ; preds = %for.cond28, %for.end42.split.loop.exit
  %i.2.lcssa = phi i32 [ %10, %for.end42.split.loop.exit ], [ %smax60, %for.cond28 ]
  %smax67 = call i32 @llvm.smax.i32(i32 %i.142, i32 %0)
  %wide.trip.count69 = zext i32 %smax67 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.body45, %for.end42
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.body45 ], [ %idxprom31.pre-phi, %for.end42 ]
  %exitcond70.not = icmp eq i64 %indvars.iv64, %wide.trip.count69
  br i1 %exitcond70.not, label %for.end59, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %arrayidx50 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next65, i64 %8
  %11 = load i32, ptr %arrayidx50, align 4, !tbaa !5
  %cmp51.not = icmp eq i32 %11, 0
  %12 = trunc nuw i64 %indvars.iv.next65 to i32
  %cmp54.not = icmp sgt i32 %0, %12
  %or.cond32 = and i1 %cmp54.not, %cmp51.not
  br i1 %or.cond32, label %for.cond43, label %for.end59.split.loop.exit, !llvm.loop !16
...
for.end59:                                        ; preds = %for.cond43, %for.end59.split.loop.exit
  %i.3.lcssa = phi i32 [ %13, %for.end59.split.loop.exit ], [ %smax67, %for.cond43 ]
  %sub = sub nsw i32 %i.3.lcssa, %i.142
