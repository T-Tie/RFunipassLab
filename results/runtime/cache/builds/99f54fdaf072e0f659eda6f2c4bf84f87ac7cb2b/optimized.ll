...
for.cond16:                                       ; preds = %for.cond4, %for.inc42
  %.pre13 = phi i32 [ %.pre, %for.inc42 ], [ %0, %for.cond4 ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc42 ], [ 0, %for.cond4 ]
  ...
  %cmp17 = icmp slt i64 %indvars.iv10, %6
  br i1 %cmp17, label %for.body18, label %for.end44

for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv10
...
if.then:                                          ; preds = %for.body18
  ...
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr noalias nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %i, ptr noundef nonnull align 16 dereferenceable(20500) %a)
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc42

for.inc42:                                        ; preds = %for.body18, %if.then
  %.pre = phi i32 [ %.pre.pre, %if.then ], [ %.pre13, %for.body18 ]
...
for.end44:                                        ; preds = %for.cond16
  store i32 %k.0, ptr %j, align 4, !tbaa !5
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %n, ptr noundef nonnull align 16 dereferenceable(20500) %a)
...
define internal void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr noundef nonnull align 16 dereferenceable(20500) %2) #9 {
if.then_to_outline:
  %3 = load i32, ptr %1, align 4, !tbaa !5, !invariant.load !9
  %sub = add nsw i32 %3, -1
...
for.cond23:                                       ; preds = %for.inc31, %if.then_to_outline
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc31 ], [ %4, %if.then_to_outline ]
