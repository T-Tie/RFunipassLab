...
for.end197:                                       ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 40000, ptr %temp) #7
  call void @llvm.lifetime.end.p0(i64 40000, ptr %a) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr %n0) #7
  ret i32 0
}
