...
for.cond28:                                       ; preds = %for.inc44, %for.body25
  ...
  %2 = trunc nuw i64 %indvars.iv50 to i32
  %cmp30.not = icmp slt i32 %sub, %2
  br i1 %cmp30.not, label %for.cond21.loopexit, label %for.inc44
...
for.cond73:                                       ; preds = %for.end65
  ...
  %vtable.i = load ptr, ptr %call70, align 8, !tbaa !16, !invariant.load !18
  ...
  %sub74 = sub nsw i32 %conv, %3
  %4 = sext i32 %sub74 to i64
  %cmp75 = icmp slt i64 0, %4
