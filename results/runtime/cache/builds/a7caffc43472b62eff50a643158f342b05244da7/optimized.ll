...
for.cond:                                         ; preds = %while.end19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %while.end19 ]
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load i64, ptr %gep53, align 8, !tbaa !16
...
if.then31:                                        ; preds = %for.end
  %call1.i31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  br label %if.end44

for.cond33:                                       ; preds = %while.end19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit45
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit45 ], [ 0, %while.end19 ]
...
for.body36:                                       ; preds = %for.cond33
  ...
  store i8 %8, ptr %__c.addr.i33, align 1, !tbaa !5
  %vtable.i34 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !14
  ...
  %cmp.not.i39 = icmp eq i64 %9, 0
  br i1 %cmp.not.i39, label %if.end.i43, label %if.then.i40

if.then.i40:                                      ; preds = %for.body36
...
if.end.i43:                                       ; preds = %for.body36
  %call2.i44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %8)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit45
...
for.end42:                                        ; preds = %for.cond33
  %vtable.i46 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !14
...
!16 = !{!17, !18, i64 16}
!17 = !{!"_ZTSSt8ios_base", !18, i64 8, !18, i64 16, !19, i64 24, !20, i64 28, !20, i64 32, !21, i64 40, !23, i64 48, !6, i64 64, !12, i64 192, !24, i64 200, !25, i64 208}
!18 = !{!"long", !6, i64 0}
