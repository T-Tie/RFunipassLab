...
for.cond10:                                       ; preds = %for.inc29, %for.end9
  ...
  %row.0 = phi i32 [ 0, %for.end9 ], [ %row.1.lcssa, %for.inc29 ]
...
for.inc29:                                        ; preds = %for.cond13
  %row.1.lcssa = phi i32 [ %row.1, %for.cond13 ]
  %inc30 = add nsw i32 %i.1, 1
  br label %for.cond10, !llvm.loop !14

for.end31:                                        ; preds = %for.cond10
  %row.0.lcssa = phi i32 [ %row.0, %for.cond10 ]
  br label %for.cond32

for.cond32:                                       ; preds = %for.inc56, %for.end31
  %k.2 = phi i32 [ 1, %for.end31 ], [ %inc57, %for.inc56 ]
  %line.0 = phi i32 [ 0, %for.end31 ], [ %line.1.lcssa, %for.inc56 ]
  %cmp33 = icmp slt i32 %k.2, %.lcssa
...
for.inc56:                                        ; preds = %for.cond35
  %line.1.lcssa = phi i32 [ %line.1, %for.cond35 ]
  %inc57 = add nsw i32 %k.2, 1
  br label %for.cond32, !llvm.loop !16

for.end58:                                        ; preds = %for.cond32
  %line.0.lcssa = phi i32 [ %line.0, %for.cond32 ]
  %div = sdiv i32 %line.0.lcssa, 2
  %sub59 = sub nsw i32 %div, 1
  %div60 = sdiv i32 %row.0.lcssa, 2
