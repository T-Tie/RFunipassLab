...
for.cond.backedge:                                ; preds = %for.body, %for.end52
  %indvars.iv.be = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.end52 ]
...
for.body19:                                       ; preds = %for.cond16
  ...
  br i1 %or.cond, label %if.then44, label %lor.lhs.false30

lor.lhs.false30:                                  ; preds = %for.body19
  %div35 = sdiv i32 %3, %2
  %rem42 = srem i32 %3, %2
  %cmp36 = icmp eq i32 %div35, 2
  %cmp43 = icmp eq i32 %rem42, 0
  %or.cond34 = and i1 %cmp36, %cmp43
  br i1 %or.cond34, label %if.then44, label %for.inc47

if.then44:                                        ; preds = %lor.lhs.false30, %for.body19
  %add45 = add nsw i32 %c.2, 1
  br label %for.inc47

for.inc47:                                        ; preds = %lor.lhs.false30, %if.then44
  %c.3 = phi i32 [ %add45, %if.then44 ], [ %c.2, %lor.lhs.false30 ]
