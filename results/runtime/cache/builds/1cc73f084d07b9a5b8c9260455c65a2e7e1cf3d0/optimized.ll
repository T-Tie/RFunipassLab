...
entry:
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %conv7, i32 0)
...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  br i1 %exitcond19.not, label %for.end22, label %for.cond8

for.cond8:                                        ; preds = %for.cond, %for.inc
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc ], [ 0, %for.cond ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc ], [ %indvars.iv, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond.not, label %if.then24.loopexit, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %arrayidx = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv10
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %arrayidx13 = getelementptr inbounds nuw [50 x i8], ptr %b, i64 0, i64 %indvars.iv12
...
if.then24:                                        ; preds = %if.then24.loopexit, %for.end22
  %.pre-phi = phi i64 [ %.pre, %if.then24.loopexit ], [ %wide.trip.count18, %for.end22 ]
  %i.09 = phi i32 [ %i.0, %if.then24.loopexit ], [ %smax17, %for.end22 ]
  %add = add nsw i32 %i.09, %conv
  %smax27 = call i32 @llvm.smax.i32(i32 %i.09, i32 %add)
  %2 = sub nsw i32 %smax27, %i.09
  %wide.trip.count28 = zext i32 %2 to i64
  br label %for.cond25

for.cond25:                                       ; preds = %for.inc32, %if.then24
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc32 ], [ 0, %if.then24 ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc32 ], [ %.pre-phi, %if.then24 ]
  %exitcond29.not = icmp eq i64 %indvars.iv22, %wide.trip.count28
  br i1 %exitcond29.not, label %if.end36, label %for.inc32

for.inc32:                                        ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [50 x i8], ptr %c, i64 0, i64 %indvars.iv22
  %3 = load i8, ptr %arrayidx29, align 1, !tbaa !5, !invariant.load !8
  %arrayidx31 = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv20
