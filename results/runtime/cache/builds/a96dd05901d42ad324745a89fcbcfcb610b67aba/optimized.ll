...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv18 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next19, %for.inc55 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv18
