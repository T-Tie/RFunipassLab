...
for.cond5:                                        ; preds = %for.inc, %for.body3
  %min.0 = phi i32 [ %1, %for.body3 ], [ %min.1, %for.inc ]
...
for.inc:                                          ; preds = %for.body7, %if.then
  %min.1 = phi i32 [ %2, %if.then ], [ %min.0, %for.body7 ]
...
for.cond55:                                       ; preds = %for.inc69, %if.then51
  %min.2 = phi i32 [ %5, %if.then51 ], [ %min.3, %for.inc69 ]
  %j.3 = phi i32 [ 1, %if.then51 ], [ %inc70, %for.inc69 ]
  %cmp56 = icmp slt i32 %j.3, %0
...
for.inc69:                                        ; preds = %for.body57, %if.then63
  %min.3 = phi i32 [ %6, %if.then63 ], [ %min.2, %for.body57 ]
...
for.inc84:                                        ; preds = %for.cond72
  ...
  %7 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !9
  %sub79 = sub nsw i32 %7, %min.2
...
for.inc108:                                       ; preds = %for.cond96
  ...
  %9 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !9
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %10 = load i32, ptr %arrayidx123, align 4, !tbaa !5, !invariant.load !9
