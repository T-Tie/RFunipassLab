...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv73, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv139 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next140, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv139 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %indvars.iv139
  br i1 %exitcond88.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 0
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv76 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next77, %for.inc41 ]
  %min.3 = phi i32 [ %min.2, %for.cond23.preheader ], [ %min.4, %for.inc41 ]
  %exitcond.not = icmp eq i64 %indvars.iv76, %indvars.iv139
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv76, 0
...
if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv76
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv79 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next80, %for.inc53 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %indvars.iv139
  br i1 %exitcond83.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv84, i64 %indvars.iv79
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond103.not = icmp eq i64 %indvars.iv99, %indvars.iv139
  br i1 %exitcond103.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 0, i64 %indvars.iv99
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv89 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next90, %for.inc90 ]
  %min.6 = phi i32 [ %min.5, %for.cond65.preheader ], [ %min.7, %for.inc90 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %indvars.iv139
  br i1 %exitcond93.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv89, 0
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv89, i64 %indvars.iv99
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !13
  %spec.select71 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select71, %if.else75 ]
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  br label %for.cond65, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv94 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next95, %for.inc103 ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %indvars.iv139
  br i1 %exitcond98.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond113.not = icmp eq i64 %indvars.iv109, %indvars.iv139
  br i1 %exitcond113.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond108.not = icmp eq i64 %indvars.iv104, %indvars.iv139
  br i1 %exitcond108.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv109, i64 %indvars.iv104
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv109, i64 %indvars.iv104
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond119.not = icmp eq i64 %indvars.iv114, %indvars.iv139
  br i1 %exitcond119.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv114
  %15 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
  %16 = add nsw i64 %indvars.iv114, -1
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond125.not = icmp eq i64 %indvars.iv120, %indvars.iv139
  br i1 %exitcond125.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv120
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv132 = phi i64 [ %indvars.iv.next133, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond137.not = icmp eq i64 %indvars.iv132, %indvars.iv139
  br i1 %exitcond137.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %19 = add nsw i64 %indvars.iv132, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv126 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next127, %for.inc185 ]
  %exitcond131.not = icmp eq i64 %indvars.iv126, %indvars.iv139
  br i1 %exitcond131.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv132, i64 %indvars.iv126
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !28, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !36, !invariant.load !13
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !37, !invariant.load !13
