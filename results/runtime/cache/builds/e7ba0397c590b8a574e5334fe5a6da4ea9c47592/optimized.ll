...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  ...
  %6 = sext i32 %5 to i64
  %cmp18 = icmp slt i64 %indvars.iv33, %6
...
land.lhs.true:                                    ; preds = %for.body19
  ...
  br i1 %cmp23, label %if.end35.thread41, label %if.end35.thread

if.end35.thread41:                                ; preds = %land.lhs.true
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread41
  %call24.sink = phi ptr [ %call24, %if.end35.thread41 ], [ @_ZSt4cout, %if.end35.thread ], [ @_ZSt4cout, %if.end35 ]
  %s.126.ph = phi i32 [ %s.0, %if.end35.thread41 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %s.126 = phi i32 [ %s.0, %if.end35 ], [ %s.126.ph, %for.inc47.sink.split ]
  %add45 = add i32 %7, 1
  %add46 = add i32 %add45, %s.126
