...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull %a) #6
...
for.cond4:                                        ; preds = %for.cond7, %for.cond4.preheader
  %indvars.iv36 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next37, %for.cond7 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.cond7 ]
  %exitcond45.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond45.not, label %for.cond42, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %2 = add nsw i64 %indvars.iv36, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv36
  %3 = trunc nsw i64 %indvars.iv.next37 to i32
  br label %for.cond7
...
for.cond10:                                       ; preds = %for.cond10.preheader, %if.end
  %indvars.iv38 = phi i64 [ %indvars.iv36, %for.cond10.preheader ], [ %indvars.iv.next39, %if.end ]
  %indvars.iv34 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next35, %if.end ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %if.end ]
  %cmp12 = icmp slt i64 %indvars.iv38, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv38
  %5 = load i8, ptr %arrayidx15, align 1, !tbaa !13, !invariant.load !14
  %arrayidx18 = getelementptr inbounds [1000 x i8], ptr %a, i64 0, i64 %indvars.iv34
  %6 = load i8, ptr %arrayidx18, align 1, !tbaa !13, !invariant.load !14
  %cmp20.not = icmp eq i8 %5, %6
  br i1 %cmp20.not, label %if.end, label %for.end25
...
for.end25:                                        ; preds = %for.body13, %for.cond10
  ...
  %7 = trunc nsw i64 %indvars.iv34 to i32
...
for.cond42:                                       ; preds = %for.cond4, %for.body44
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body44 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond4 ]
  %exitcond49.not = icmp eq i64 %indvars.iv46, 1000
  br i1 %exitcond49.not, label %for.end54, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv46
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc80 ], [ 0, %if.else58 ]
  %exitcond56.not = icmp eq i64 %indvars.iv50, 1000
  br i1 %exitcond56.not, label %if.end83, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv50
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.body70
  %indvars.iv52 = phi i64 [ %indvars.iv50, %for.cond67.preheader ], [ %indvars.iv.next53, %for.body70 ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %12, %11
  %13 = sext i32 %add68 to i64
  %cmp69 = icmp slt i64 %indvars.iv52, %13
  br i1 %cmp69, label %for.body70, label %for.end77

for.body70:                                       ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv52
  %14 = load i8, ptr %arrayidx72, align 1, !tbaa !13, !invariant.load !14
  %conv73 = sext i8 %14 to i32
  %putchar32 = call i32 @putchar(i32 %conv73)
