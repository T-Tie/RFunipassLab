...
for.inc42.gvnsink.split:                          ; preds = %if.else, %for.body15
  %idxprom33 = sext i32 %x.1 to i64
  %arrayidx34 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom33
  %idxprom35 = sext i32 %y.1 to i64
  %arrayidx36 = getelementptr inbounds [100 x i32], ptr %arrayidx34, i64 0, i64 %idxprom35
  %5 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  %arrayidx38 = getelementptr inbounds [10 x i32], ptr %b, i64 0, i64 %idxprom33
  store i32 %5, ptr %arrayidx38, align 4, !tbaa !5
  %arrayidx40 = getelementptr inbounds [10 x i32], ptr %c, i64 0, i64 %idxprom33
