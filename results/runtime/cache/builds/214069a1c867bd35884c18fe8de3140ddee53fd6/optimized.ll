...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax55 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count25 = zext nneg i32 %smax55 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond28, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc22 ], [ 0, %for.cond11.preheader ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv17
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc63 ], [ 0, %for.cond ]
  %exitcond42.not = icmp eq i64 %indvars.iv37, %wide.trip.count25
  br i1 %exitcond42.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select15, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv27, i64 %indvars.iv37
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %spec.select15 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond31, !llvm.loop !14

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc60 ], [ 0, %for.cond48.preheader ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv32, i64 %indvars.iv37
...
for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc125 ], [ 0, %if.end68 ]
  %exitcond57.not = icmp eq i64 %indvars.iv50, %wide.trip.count25
  br i1 %exitcond57.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %arrayidx99 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv50
  %5 = add nsw i64 %indvars.iv50, -1
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv43 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next44, %for.inc122 ]
  %exitcond49.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond49.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv43, 2
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv43
...
if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv50, i64 %indvars.iv43
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  %indvars.iv9 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next10, %for.inc9 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count12
...
for.cond12:                                       ; preds = %for.cond1, %for.inc26
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc26 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv17, %2
  br i1 %cmp13, label %for.cond15, label %for.inc32

for.cond15:                                       ; preds = %for.cond12, %for.inc23
  %3 = phi i32 [ %.pre, %for.inc23 ], [ %1, %for.cond12 ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc23 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
  %cmp16 = icmp slt i64 %indvars.iv14, %4
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv17, i64 %indvars.iv14
