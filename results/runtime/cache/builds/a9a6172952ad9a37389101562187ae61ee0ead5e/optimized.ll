...
entry:
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax33, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc12 ], [ 0, %entry ]
  %exitcond35 = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35, label %for.cond15.preheader, label %for.cond4

for.cond15.preheader:                             ; preds = %for.cond
  %wide.trip.count41 = zext i32 %sub to i64
  br label %for.cond15
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc42
  %indvars.iv36 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next37, %for.inc42 ]
  %exitcond45 = icmp eq i64 %indvars.iv36, %wide.trip.count34
  br i1 %exitcond45, label %for.cond45, label %for.cond21.preheader

for.cond21.preheader:                             ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv36
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv36
  br label %for.cond21

for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc39
  %indvars.iv38 = phi i64 [ %indvars.iv36, %for.cond21.preheader ], [ %indvars.iv.next39, %for.inc39 ]
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count41
  br i1 %exitcond42.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv.next39
...
for.cond45:                                       ; preds = %for.cond15, %for.inc66
  ...
  %5 = phi i32 [ %dec, %for.inc66 ], [ 500, %for.cond15 ]
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond50 = icmp eq i64 %indvars.iv46, %wide.trip.count34
  br i1 %exitcond50, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv46
  %6 = load i32, ptr %arrayidx55, align 4, !tbaa !5
  %cmp56 = icmp eq i32 %6, %5
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %add72 = phi i32 [ %8, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %add72)
  %smax54 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count55 = zext nneg i32 %smax54 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %wide.trip.count55
  br i1 %exitcond56.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv51
