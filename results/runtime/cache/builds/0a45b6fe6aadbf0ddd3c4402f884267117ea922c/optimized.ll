...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %j.0.sink6 = phi i32 [ %j.0, %if.then ], [ %add16, %for.inc25 ]
  %_ZSt4cout.sink5 = phi ptr [ @_ZSt4cout, %if.then ], [ %call20, %for.inc25 ]
  %idxprom12 = sext i32 %j.0.sink6 to i64
  %arrayidx13 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom12
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink5, ptr noundef %arrayidx13)
  %add16 = add nsw i32 %j.0.sink6, 1
...
for.inc55.gvnsink.split:                          ; preds = %for.cond17, %for.end46
  %j.1.ph = phi i32 [ %add35, %for.end46 ], [ %add16, %for.cond17 ]
...
for.inc55:                                        ; preds = %for.inc55.gvnsink.split, %if.end
  %j.1 = phi i32 [ %j.0, %if.end ], [ %j.1.ph, %for.inc55.gvnsink.split ]
