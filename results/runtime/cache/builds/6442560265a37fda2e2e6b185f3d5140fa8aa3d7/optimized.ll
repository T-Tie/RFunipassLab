...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr %total) #6
  call void @llvm.lifetime.start.p0(i64 80000, ptr %valid) #6
  call void @llvm.lifetime.start.p0(i64 8, ptr %t1) #6
  call void @llvm.lifetime.start.p0(i64 8, ptr %v1) #6
  call void @llvm.lifetime.start.p0(i64 80000, ptr %x) #6
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr %x) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %v1) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %t1) #6
  call void @llvm.lifetime.end.p0(i64 80000, ptr %valid) #6
  call void @llvm.lifetime.end.p0(i64 80000, ptr %total) #6
  ret i32 0
}
