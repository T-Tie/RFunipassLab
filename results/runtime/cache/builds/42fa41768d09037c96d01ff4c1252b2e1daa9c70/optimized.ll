...
entry:
  ...
  %call7 = call noundef ptr @strstr(ptr noundef %s, ptr noundef %sub) #12
...
if.then:                                          ; preds = %entry
  ...
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call14, ptr noundef %add.ptr)
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !8, !invariant.load !10
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !8, !invariant.load !10
...
; Function Attrs: mustprogress uwtable
declare void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264), i32 noundef) #4 align 2
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264)) #6 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264)) #6 align 2

; Function Attrs: mustprogress uwtable
declare noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64)) #4 align 2
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !11, !invariant.load !10
  %1 = load i32, ptr %__c2, align 4, !tbaa !11, !invariant.load !10
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64)) #6 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64)) #6 align 2
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !5, !invariant.load !10
...
; Function Attrs: inlinehint mustprogress uwtable
declare noundef nonnull align 8 dereferenceable(8) ptr @_ZSt5flushIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(ptr noundef nonnull align 8 dereferenceable(8)) #2
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !24, !invariant.load !10
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !10
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !8, !invariant.load !10
...
!26 = !{!"_ZTSNSt6locale5facetE", !12, i64 8}
!27 = !{!"p1 _ZTS15__locale_struct", !19, i64 0}
!28 = !{!"bool", !6, i64 0}
!29 = !{!"p1 int", !19, i64 0}
