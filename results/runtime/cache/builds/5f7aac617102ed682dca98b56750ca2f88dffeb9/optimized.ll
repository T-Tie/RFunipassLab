...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %1) #7
...
if.then11:                                        ; preds = %if.else5
  %call = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %i, i32 noundef %n) #7
  %add12 = add nsw i32 1, %call
  %call14 = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %fin, i32 noundef %n) #7
  %call15 = call noundef i32 @_Z3maxii(i32 noundef %add12, i32 noundef %call14) #7
  br label %return

if.else16:                                        ; preds = %if.else5
  %call18 = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %fin, i32 noundef %n) #7
  br label %return
