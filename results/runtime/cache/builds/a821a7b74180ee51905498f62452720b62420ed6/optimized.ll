...
for.inc:                                          ; preds = %for.cond
  ...
  %call = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %4)
  br label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond
  tail call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout)
  ret void
...
if.else:                                          ; preds = %tailrecurse
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 %spec.select, i32 noundef 0)
...
for.inc39:                                        ; preds = %for.cond12
  ...
  %7 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr @b, i64 0, i64 %indvars.iv
  %8 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  tail call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call1)
  br label %return
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0) unnamed_addr #5 {
for.end_after_outline.exitStub:
  %vtable.i = load ptr, ptr %0, align 8, !tbaa !40, !invariant.load !9
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %call.i1)
