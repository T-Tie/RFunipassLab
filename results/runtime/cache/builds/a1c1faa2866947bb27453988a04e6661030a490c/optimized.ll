...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %num) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(80000) %num, i8 noundef 0, i64 noundef 80000, i1 noundef false) #10
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 4 %n)
  %sqrtf = call float @sqrtf(float noundef -1.000000e+00) #11
  br label %for.cond

for.cond:                                         ; preds = %if.end73, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end73 ], [ 0, %entry ]
...
if.then:                                          ; preds = %for.body
  %call25 = call double @sqrt(double noundef %6) #12, !tbaa !5
  %add = fsub double %call25, %3
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %sub35 = fsub double %fneg, %call25
  %div37 = fdiv double %sub35, %mul
  br label %if.end73

if.else:                                          ; preds = %for.body
  %cmp41 = fcmp oeq double %3, 0.000000e+00
  %.pre57 = fmul double %2, 2.000000e+00
  %div49 = fdiv double %fneg, %.pre57
  %div49.sink = select i1 %cmp41, double 0.000000e+00, double %div49
  %neg56 = fmul double %3, %fneg
  %8 = call double @llvm.fmuladd.f64(double %mul19, double %4, double %neg56)
  %call57 = call double @sqrt(double noundef %8) #12, !tbaa !5
  %div59 = fdiv double %call57, %.pre57
  %arrayidx72 = getelementptr inbounds nuw i8, ptr %arrayidx, i64 40
  store double %div59, ptr %arrayidx72, align 8, !tbaa !9
  br label %if.end73

if.end73:                                         ; preds = %if.else, %if.then
  %div.sink = phi double [ %div49.sink, %if.else ], [ %div, %if.then ]
  %div37.sink = phi double [ %div59, %if.else ], [ %div37, %if.then ]
  store double %div.sink, ptr %7, align 8, !tbaa !9
  %9 = getelementptr inbounds nuw i8, ptr %arrayidx, i64 32
  store double %div37.sink, ptr %9, align 16, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !12

for.cond74:                                       ; preds = %for.cond, %if.end131
  %10 = phi i32 [ %.pre, %if.end131 ], [ %0, %for.cond ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %if.end131 ], [ 0, %for.cond ]
  %11 = sext i32 %10 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv53, %11
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv53
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %18, double noundef %20) #13
  br label %if.end131

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %18) #13
  br label %if.end131
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %18, double noundef %20, double noundef %18, double noundef %21) #13
  br label %if.end131

if.end131:                                        ; preds = %if.then103, %if.else111, %if.else117
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond74, !llvm.loop !15

for.end134:                                       ; preds = %for.cond74
  %call135 = call i32 @getchar() #13
  %call136 = call i32 @getchar() #13
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %num) #13
...
attributes #7 = { inlinehint mustprogress nofree nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #8 = { mustprogress nocallback nofree nounwind willreturn memory(errnomem: write) }
attributes #9 = { nofree nounwind willreturn }
attributes #10 = { nofree willreturn }
attributes #11 = { nounwind memory(write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
