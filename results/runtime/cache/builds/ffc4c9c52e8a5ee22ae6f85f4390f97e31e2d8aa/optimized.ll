...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  %s.0 = phi i32 [ 0, %entry ], [ 1, %for.inc20 ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  br i1 %cmp15, label %for.end.thread, label %for.inc

for.end.thread:                                   ; preds = %for.body10
  br label %for.inc20
...
for.end:                                          ; preds = %for.cond8
  br i1 true, label %if.then24, label %for.inc20

for.inc20:                                        ; preds = %for.end, %for.end.thread
...
if.then24:                                        ; preds = %for.end, %for.end22
  br label %for.cond25
