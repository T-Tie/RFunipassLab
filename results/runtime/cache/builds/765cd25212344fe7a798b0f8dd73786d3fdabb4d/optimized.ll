...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc51
  %7 = phi i32 [ %5, %for.cond6.preheader ], [ %.pre38, %for.inc51 ]
  %indvars.iv35 = phi i64 [ 1, %for.cond6.preheader ], [ %indvars.iv.next36, %for.inc51 ]
  %8 = sext i32 %7 to i64
...
for.body8:                                        ; preds = %for.cond6
  ...
  %10 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !12
  %mul = mul nsw i32 %10, %9
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv35
  %11 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !12
...
if.then44:                                        ; preds = %if.else
  %call1.i2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 6)
  br label %for.inc51
...
for.inc51:                                        ; preds = %if.then, %if.else47, %if.then44
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i17, align 8, !invariant.load !12
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !14, !invariant.load !12
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !25, !invariant.load !12
