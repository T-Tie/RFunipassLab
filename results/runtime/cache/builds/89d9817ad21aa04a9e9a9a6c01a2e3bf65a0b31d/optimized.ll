...
for.body30:                                       ; preds = %for.cond28
  ...
  %11 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !15
...
if.then38:                                        ; preds = %lor.lhs.false, %for.body30
  store i32 %9, ptr %y2, align 4, !tbaa !5
  br label %for.end42
...
for.body45:                                       ; preds = %for.cond43
  ...
  %14 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !15
...
if.then55:                                        ; preds = %lor.lhs.false52, %for.body45
  store i32 %13, ptr %x2, align 4, !tbaa !5
  br label %for.end59
