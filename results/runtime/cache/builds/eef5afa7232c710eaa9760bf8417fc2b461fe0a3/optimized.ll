...
for.end50:                                        ; preds = %for.cond32
  %min.1.lcssa = phi i32 [ %min.1, %for.cond32 ]
  store i32 0, ptr @k, align 4, !tbaa !5
  br label %for.cond51
...
for.inc59:                                        ; preds = %for.cond51
  ...
  %sub58 = sub nsw i32 %11, %min.1.lcssa
...
for.end100:                                       ; preds = %for.cond66
  ...
  %call = call noundef i32 @_Z4xiaoi(i32 noundef %sub67.lcssa) #6
...
for.inc10:                                        ; preds = %for.cond4
  %.lcssa = phi i32 [ %6, %for.cond4 ]
  %inc11 = add nsw i32 %.lcssa, 1
  store i32 %inc11, ptr @j, align 4, !tbaa !5
  br label %for.cond1, !llvm.loop !20

for.inc16:                                        ; preds = %for.cond1
  %.lcssa7 = phi i32 [ %3, %for.cond1 ]
  %call13 = call noundef i32 @_Z4xiaoi(i32 noundef %.lcssa7) #8
