...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull %word) #9
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc74
  %6 = phi i32 [ %.pre, %for.inc74 ], [ %0, %for.cond2.preheader ]
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc74 ], [ 0, %for.cond2.preheader ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond2.preheader ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond2.preheader ]
  %7 = sext i32 %6 to i64
  %cmp3 = icmp slt i64 %indvars.iv81, %7
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax91 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %8 = add i32 %smax91, 1
  %wide.trip.count92 = zext i32 %8 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond93 = icmp eq i64 %indvars.iv87, %wide.trip.count92
  br i1 %exitcond93, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv87
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv87, i64 %9
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv84, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv84, %9
...
if.then99:                                        ; preds = %for.body96
  ...
  %11 = load i64, ptr %gep79, align 8, !tbaa !12
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv87, i64 %indvars.iv84
  %12 = load i8, ptr %arrayidx110, align 1, !tbaa !35
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i6)
  store i8 %12, ptr %__c.addr.i6, align 1, !tbaa !35
  ...
  %13 = load i64, ptr %gep78, align 8, !tbaa !12
