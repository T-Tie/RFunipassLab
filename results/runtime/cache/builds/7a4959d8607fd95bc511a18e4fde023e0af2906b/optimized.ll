...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 300, ptr nonnull %rep) #7
  call void @llvm.lifetime.start.p0(i64 300, ptr nonnull %sub) #7
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  call void @llvm.lifetime.end.p0(i64 300, ptr nonnull %sub) #7
  call void @llvm.lifetime.end.p0(i64 300, ptr nonnull %rep) #7
