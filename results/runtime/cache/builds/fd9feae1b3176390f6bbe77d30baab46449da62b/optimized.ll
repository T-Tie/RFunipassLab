...
if.else16:                                        ; preds = %if.end10
  %puts6 = call i32 @puts(ptr nonnull dereferenceable(1) @str.4)
...
if.then20:                                        ; preds = %if.end18
  %div21 = udiv i32 %6, 10
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div21)
...
if.then28:                                        ; preds = %if.end26
  %div29 = udiv i32 %8, 5
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div29)
