...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv30 = phi i32 [ %indvars.iv.next31, %while.cond ], [ 0, %for.cond ]
  ...
  br i1 %cmp3.not, label %while.end, label %while.cond, !llvm.loop !13
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv24 = phi i64 [ %1, %while.cond11.preheader ], [ %indvars.iv.next25, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %2 = trunc nuw i64 %indvars.iv.next25 to i32
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select19 = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.2)
