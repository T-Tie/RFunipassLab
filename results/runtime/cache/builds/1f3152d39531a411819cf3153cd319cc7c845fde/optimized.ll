...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(108) %b, i8 0, i64 108, i1 false)
...
land.lhs.true:                                    ; preds = %for.body9
  ...
  br i1 %cmp19.not, label %for.inc25, label %if.then
...
for.inc25:                                        ; preds = %for.body9, %land.lhs.true, %if.then
