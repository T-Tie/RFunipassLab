...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n0) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 %temp) #6
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv74 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next75, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv74 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv74
  br i1 %exitcond23.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 0
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv11 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next12, %for.inc41 ]
  %min.3 = phi i32 [ %min.2, %for.cond23.preheader ], [ %min.4, %for.inc41 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %indvars.iv74
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv11, 0
  br i1 %cmp27, label %if.then, label %if.else

if.then:                                          ; preds = %for.body26
  %7 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !13
  br label %for.inc41

if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv11
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc53 ], [ 0, %for.cond45.preheader ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv74
  br i1 %exitcond18.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv14
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %indvars.iv74
  br i1 %exitcond38.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 0, i64 %indvars.iv34
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv24 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next25, %for.inc90 ]
  %min.6 = phi i32 [ %min.5, %for.cond65.preheader ], [ %min.7, %for.inc90 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv74
  br i1 %exitcond28.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv24, 0
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv34
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !13
  %spec.select6 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select6, %if.else75 ]
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond65, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc103 ], [ 0, %for.cond94.preheader ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv74
  br i1 %exitcond33.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv34
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %indvars.iv74
  br i1 %exitcond48.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %indvars.iv74
  br i1 %exitcond43.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv39
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv44, i64 %indvars.iv39
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %indvars.iv74
  br i1 %exitcond54.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv49
  %15 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
  %16 = add nsw i64 %indvars.iv49, -1
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %indvars.iv74
  br i1 %exitcond60.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv55
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond72.not = icmp eq i64 %indvars.iv67, %indvars.iv74
  br i1 %exitcond72.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %19 = add nsw i64 %indvars.iv67, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv61 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next62, %for.inc185 ]
  %exitcond66.not = icmp eq i64 %indvars.iv61, %indvars.iv74
  br i1 %exitcond66.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv67, i64 %indvars.iv61
  %20 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
  %21 = add nsw i64 %indvars.iv61, -1
...
for.inc195:                                       ; preds = %for.cond15
  ...
  %vtable.i = load ptr, ptr %call193, align 8, !tbaa !27, !invariant.load !13
...
for.end197:                                       ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %temp) #8
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %a) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n0) #8
  ret i32 0
}
