...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax44 = tail call i32 @llvm.smax.i32(i32 %indvars.iv18.in, i32 noundef 0)
  %wide.trip.count29 = zext nneg i32 %smax44 to i64
  %wide.trip.count = zext i32 %indvars.iv18.in to i64
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond30.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv18.in, ptr @k, align 4, !tbaa !5
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond, !llvm.loop !13

for.cond27:                                       ; preds = %for.cond, %for.inc62
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc62 ], [ 0, %for.cond ]
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  ...
  %min.1 = phi i32 [ %spec.select10, %for.body34 ], [ %3, %for.body29 ]
...
for.body34:                                       ; preds = %for.cond32
  ...
  %spec.select10 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.1)
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc59 ], [ 0, %for.cond51.preheader ]
...
for.end64:                                        ; preds = %for.cond27
  ...
  %smax55 = tail call i32 @llvm.smax.i32(i32 %indvars.iv18, i32 noundef 1)
  %6 = zext i32 %indvars.iv18 to i64
  %cmp65 = icmp eq i32 %indvars.iv18.in, 2
...
for.cond66:                                       ; preds = %for.cond81, %if.end
  %indvars.iv52 = phi i64 [ 1, %if.end ], [ %indvars.iv.next53, %for.cond81 ]
...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  %exitcond51.not = icmp eq i64 %indvars.iv47, %6
  br i1 %exitcond51.not, label %for.cond66, label %for.inc95, !llvm.loop !17
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre21, %for.inc ], [ %storemerge4, %for.cond1 ]
  %3 = phi i32 [ %.pre6, %for.inc ], [ %1, %for.cond1 ]
  %storemerge5 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond1 ]
...
for.inc:                                          ; preds = %for.cond4
  ...
  %.pre21 = load i32, ptr @j, align 4, !tbaa !5
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  ...
  %storemerge3 = phi i32 [ %inc27, %for.inc26 ], [ 0, %for.cond ]
