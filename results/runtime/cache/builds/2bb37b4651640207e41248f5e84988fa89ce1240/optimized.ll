...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp.not, label %while.cond.preheader, label %for.inc
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end24
  %5 = phi i32 [ %9, %for.end24 ], [ %3, %while.cond.preheader ]
  %i.1 = phi i32 [ %spec.select, %for.end24 ], [ 1, %while.cond.preheader ]
  %cmp2 = icmp slt i32 %i.1, %5
  br i1 %cmp2, label %for.cond3.preheader, label %for.cond29.preheader
...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  ...
  br i1 %exitcond.not, label %for.end24.loopexit, label %for.body5
...
for.end24.loopexit:                               ; preds = %for.cond3
  br label %for.end24

for.end24:                                        ; preds = %for.end24.loopexit, %for.end21
  %9 = phi i32 [ %sub, %for.end21 ], [ %5, %for.end24.loopexit ]
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc37
  %10 = phi i32 [ %.pre, %for.inc37 ], [ %5, %for.cond29.preheader ]
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc37 ], [ 0, %for.cond29.preheader ]
