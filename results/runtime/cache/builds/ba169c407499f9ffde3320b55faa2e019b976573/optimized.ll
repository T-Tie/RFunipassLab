...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 41, ptr %s) #9
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %s)
...
if.then:                                          ; preds = %for.body
  ...
  %call6 = call i64 @strlen(ptr noundef %s) #10
  br label %if.end29

if.else:                                          ; preds = %for.body
  %conv7 = sext i32 %count.0 to i64
  %call9 = call i64 @strlen(ptr noundef %s) #10
...
if.then12:                                        ; preds = %if.else
  ...
  %call17 = call i64 @strlen(ptr noundef %s) #10
...
if.else22:                                        ; preds = %if.else
  ...
  %call27 = call i64 @strlen(ptr noundef %s) #10
  br label %if.end
...
if.end29:                                         ; preds = %if.end, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 41, ptr %s) #9
  br label %for.inc
