...
for.cond2:                                        ; preds = %if.end, %for.end
  %k.0 = phi i32 [ 0, %for.end ], [ %inc12, %if.end ]
  %n.0 = phi i32 [ 0, %for.end ], [ %n.1, %if.end ]
...
for.cond14:                                       ; preds = %for.end39, %for.end13
  %e.0 = phi i32 [ %sub, %for.end13 ], [ %dec, %for.end39 ]
...
for.cond17:                                       ; preds = %if.end36, %for.body16
  %j.0 = phi i32 [ 0, %for.body16 ], [ %add, %if.end36 ]
...
for.cond43:                                       ; preds = %for.body46, %for.end41
  %t.0 = phi i32 [ %sub42, %for.end41 ], [ %inc51, %for.body46 ]
...
for.body46:                                       ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5) #5
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %6) #5
