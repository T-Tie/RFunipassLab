...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 captures(none) dereferenceable(41000) %word) #11
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(41000) %word, i8 noundef 0, i64 noundef 41000, i1 noundef false) #12
...
for.body:                                         ; preds = %for.cond
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(41000) %word)
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #13
  br label %for.cond

for.end76:                                        ; preds = %for.cond
  store i32 0, ptr %j, align 4, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  %arrayidx81 = getelementptr inbounds [81 x i8], ptr %newword, i64 0, i64 -1
  store i8 0, ptr %arrayidx81, align 1, !tbaa !9
  store i8 0, ptr %newword, align 16, !tbaa !9
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.body88

for.body88:                                       ; preds = %for.end76, %for.end115
  %call92 = call i64 @strlen(ptr noundef readonly captures(none) %newword) #14
  %conv93 = trunc i64 %call92 to i32
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.body88
  %cmp95 = icmp slt i32 0, %conv93
  br i1 %cmp95, label %for.body96, label %for.end115

for.body96:                                       ; preds = %for.cond94
  %1 = load i32, ptr %j, align 4, !tbaa !5
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %1, %sub97
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %2 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom100 = sext i32 %2 to i64
  %arrayidx101 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom100
  %idxprom102 = sext i32 %1 to i64
  %arrayidx103 = getelementptr inbounds [81 x i8], ptr %arrayidx101, i64 0, i64 %idxprom102
  %3 = load i8, ptr %arrayidx103, align 1, !tbaa !9, !invariant.load !10
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %3)
...
if.else106:                                       ; preds = %for.body96
  ...
  %idxprom107 = sext i32 %4 to i64
  %arrayidx108 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom107
  %idxprom109 = sext i32 %1 to i64
  %arrayidx110 = getelementptr inbounds [81 x i8], ptr %arrayidx108, i64 0, i64 %idxprom109
  %5 = load i8, ptr %arrayidx110, align 1, !tbaa !9, !invariant.load !10
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %5)
  br label %if.end112

if.end112:                                        ; preds = %if.else106, %if.then99
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j) #13
  br label %for.cond94
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0) unnamed_addr #10 {
for.cond.exitStub:
...
attributes #10 = { minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
