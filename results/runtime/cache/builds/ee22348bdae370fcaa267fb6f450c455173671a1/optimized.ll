...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv16.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv16, %for.cond17 ]
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv12 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next13, %for.inc37 ]
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv20, %8
