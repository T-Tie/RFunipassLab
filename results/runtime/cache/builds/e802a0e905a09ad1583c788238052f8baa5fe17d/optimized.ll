...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv6, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre14, %for.inc ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv10 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next11, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv10
...
for.inc26:                                        ; preds = %for.cond14, %for.inc26.split.loop.exit
  %i.2 = phi i32 [ 9999, %for.inc26.split.loop.exit ], [ %i.1, %for.cond14 ]
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit ], [ %r1.0, %for.cond14 ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit ], [ %c1.0, %for.cond14 ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc44
  %sub32.sink = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.cond33.preheader ]
  %cmp34 = icmp sgt i32 %sub32.sink, -1
  br i1 %cmp34, label %for.body35, label %for.inc46

for.body35:                                       ; preds = %for.cond33
  %idx.ext39 = zext nneg i32 %sub32.sink to i64
...
for.inc44:                                        ; preds = %for.body35
  %dec = add nsw i32 %sub32.sink, -1
  br label %for.cond33, !llvm.loop !16

for.inc46:                                        ; preds = %for.body35, %for.cond33
  %i.3 = phi i32 [ %sub.sink, %for.cond33 ], [ -1, %for.body35 ]
  %r2.1 = phi i32 [ %r2.0, %for.cond33 ], [ %sub.sink, %for.body35 ]
  %c2.1 = phi i32 [ %c2.0, %for.cond33 ], [ %sub32.sink, %for.body35 ]
  %dec47 = add nsw i32 %i.3, -1
