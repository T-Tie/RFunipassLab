...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 3996, ptr %a) #3
  call void @llvm.lifetime.start.p0(i64 3996, ptr %b) #3
  call void @llvm.lifetime.start.p0(i64 3996, ptr %c) #3
  call void @llvm.lifetime.start.p0(i64 3996, ptr %d) #3
  call void @llvm.lifetime.start.p0(i64 3996, ptr %e) #3
  call void @llvm.lifetime.start.p0(i64 3996, ptr %f) #3
  call void @llvm.lifetime.start.p0(i64 3996, ptr %g) #3
  br label %for.body
...
for.end43:                                        ; preds = %for.cond35
  call void @llvm.lifetime.end.p0(i64 3996, ptr %g) #3
  call void @llvm.lifetime.end.p0(i64 3996, ptr %f) #3
  call void @llvm.lifetime.end.p0(i64 3996, ptr %e) #3
  call void @llvm.lifetime.end.p0(i64 3996, ptr %d) #3
  call void @llvm.lifetime.end.p0(i64 3996, ptr %c) #3
  call void @llvm.lifetime.end.p0(i64 3996, ptr %b) #3
  call void @llvm.lifetime.end.p0(i64 3996, ptr %a) #3
  ret i32 0
}
