...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv7 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next8, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  ...
  %wide.trip.count17 = zext i32 %2 to i64
  br label %for.cond15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv7
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc40
  %indvars.iv11 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next12, %for.inc40 ]
  %exitcond23.not = icmp eq i64 %indvars.iv11, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond43.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv11
  br label %for.cond19
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc37
  %indvars.iv13 = phi i64 [ %indvars.iv11, %for.cond19.preheader ], [ %indvars.iv.next14, %for.inc37 ]
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %exitcond18.not = icmp eq i64 %indvars.iv13, %wide.trip.count17
  br i1 %exitcond18.not, label %for.inc40, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %6 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next14
...
for.body45:                                       ; preds = %for.cond43
  ...
  %cmp49 = icmp slt i64 %indvars.iv24, %5
