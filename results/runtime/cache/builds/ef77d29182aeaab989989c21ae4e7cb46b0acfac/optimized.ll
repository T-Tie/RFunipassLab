...
for.cond4.preheader:                              ; preds = %for.cond
  %1 = add i32 %j.0, -2
  %smax31 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 1)
  br label %for.cond4
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc32
  %indvars.iv28 = phi i32 [ %1, %for.cond4.preheader ], [ %indvars.iv.next29, %for.inc32 ]
  %i.1 = phi i32 [ 1, %for.cond4.preheader ], [ %inc33, %for.inc32 ]
  %exitcond32.not = icmp eq i32 %i.1, %smax31
  br i1 %exitcond32.not, label %for.cond35.preheader, label %for.cond7.preheader
...
for.cond35.preheader:                             ; preds = %for.cond4
  %smax36 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  %5 = add nuw i32 %smax36, 1
  %wide.trip.count37 = zext i32 %5 to i64
  br label %for.cond35

for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc29
  %indvars.iv = phi i64 [ 1, %for.cond7.preheader ], [ %indvars.iv.next, %for.inc29 ]
...
for.body11:                                       ; preds = %for.cond7
  ...
  %6 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx15 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next
  %7 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc43
  %indvars.iv33 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next34, %for.inc43 ]
  %exitcond38 = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38, label %for.end45, label %for.body38

for.body38:                                       ; preds = %for.cond35
  %arrayidx40 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv33
  ...
  %vtable.i = load ptr, ptr %call41, align 8, !tbaa !16, !invariant.load !12
  ...
  %9 = load i64, ptr %_M_width.i.i, align 8, !tbaa !18, !invariant.load !12
...
for.end45:                                        ; preds = %for.cond35
  ...
  %10 = load i32, ptr %arrayidx48, align 4, !tbaa !5, !invariant.load !12
  ...
  %vtable.i1 = load ptr, ptr %call49, align 8, !tbaa !16, !invariant.load !12
  ...
  %add.ptr.i4 = getelementptr inbounds i8, ptr %call49, i64 %vbase.offset.i3
  ...
  %call1.i6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call49, i8 noundef signext %call.i5)
