...
for.body26:                                       ; preds = %for.cond23
  ...
  %3 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom32
  %4 = getelementptr inbounds [100 x i32], ptr %3, i64 0, i64 %idxprom34
...
cond.end:                                         ; preds = %if.else, %cond.false
  %min.sink1 = phi ptr [ %min, %cond.false ], [ %4, %if.else ]
  %7 = load i32, ptr %min.sink1, align 4, !tbaa !5
...
for.body68:                                       ; preds = %for.cond65
  ...
  %10 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom76
  %11 = getelementptr inbounds [100 x i32], ptr %10, i64 0, i64 %idxprom78
...
cond.end87:                                       ; preds = %if.else75, %cond.false86
  %min.sink = phi ptr [ %min, %cond.false86 ], [ %11, %if.else75 ]
...
for.inc103:                                       ; preds = %for.cond94
  ...
  %16 = load i32, ptr %arrayidx101, align 4, !tbaa !5
  %sub102 = sub nsw i32 %16, %15
...
for.end108:                                       ; preds = %for.cond60
  ...
  %17 = load i32, ptr %arrayidx110, align 4, !tbaa !5
...
for.inc129:                                       ; preds = %for.cond117
  ...
  store i32 %18, ptr %arrayidx128, align 4, !tbaa !5
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %19 = load i32, ptr %arrayidx141, align 16, !tbaa !5
  ...
  store i32 %19, ptr %arrayidx145, align 16, !tbaa !5
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %20 = load i32, ptr %arrayidx157, align 4, !tbaa !5
  ...
  store i32 %20, ptr %arrayidx161, align 4, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %21 = load i32, ptr %arrayidx178, align 4, !tbaa !5
  ...
  store i32 %21, ptr %arrayidx184, align 4, !tbaa !5
