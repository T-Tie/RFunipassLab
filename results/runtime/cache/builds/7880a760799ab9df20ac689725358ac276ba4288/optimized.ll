...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 3300, ptr noundef nonnull %b) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2200, ptr noundef nonnull %num) #9
...
for.cond:                                         ; preds = %for.inc17, %entry
  ...
  br i1 %exitcond47, label %for.cond21.preheader, label %for.cond6.preheader
...
for.cond21:                                       ; preds = %for.cond21.loopexit, %for.cond21.preheader
  ...
  br i1 %exitcond58.not, label %for.cond51.preheader, label %for.body25

for.cond51.preheader:                             ; preds = %for.cond21
  br label %for.cond51
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.body55
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body55 ], [ 0, %for.cond51.preheader ]
  %max.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond51.preheader ]
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  ...
  br i1 %cmp75, label %for.body77, label %if.end91.loopexit
...
if.then81:                                        ; preds = %for.body77
  ...
  %call.i.i1 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx83) #9
  %call1.i2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx83, i64 noundef %call.i.i1)
  %vtable.i7 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !17
  %vbase.offset.ptr.i8 = getelementptr i8, ptr %vtable.i7, i64 -24
  %vbase.offset.i9 = load i64, ptr %vbase.offset.ptr.i8, align 8, !invariant.load !19
  %add.ptr.i10 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i9
  ...
  %call1.i11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
...
if.end91.loopexit:                                ; preds = %for.cond73
  br label %if.end91

if.end91:                                         ; preds = %if.end91.loopexit, %if.then67
  call void @llvm.lifetime.end.p0(i64 noundef 2200, ptr noundef nonnull %num) #9
  call void @llvm.lifetime.end.p0(i64 noundef 3300, ptr noundef nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #9
  call void @llvm.lifetime.end.p0(i64 noundef 550, ptr noundef nonnull captures(none) %a) #9
  ret i32 0
}
