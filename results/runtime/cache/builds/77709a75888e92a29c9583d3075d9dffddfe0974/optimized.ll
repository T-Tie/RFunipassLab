...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond10 = select i1 %cmp7, i1 true, i1 %or.cond
...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %storemerge8 = phi i32 [ 65, %if.end24 ], [ %inc21.i6, %if.end35 ]
  store i32 %storemerge8, ptr @i, align 4, !tbaa !5
  %cmp26 = icmp slt i32 %storemerge8, 91
  br i1 %cmp26, label %for.body27, label %for.cond39

for.body27:                                       ; preds = %for.cond25
  %idxprom28 = sext i32 %storemerge8 to i64
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge8, i32 noundef %6) #6
  %.pre12 = load i32, ptr @i, align 4, !tbaa !5
  br label %if.end35

if.end35:                                         ; preds = %if.then31, %for.body27
  %7 = phi i32 [ %.pre12, %if.then31 ], [ %storemerge8, %for.body27 ]
  %inc21.i6 = add nsw i32 %7, 1
  br label %for.cond25

for.cond39:                                       ; preds = %for.cond25, %if.end49
  %storemerge9 = phi i32 [ %inc21.i7, %if.end49 ], [ 97, %for.cond25 ]
  store i32 %storemerge9, ptr @i, align 4, !tbaa !5
  %cmp40 = icmp slt i32 %storemerge9, 123
  br i1 %cmp40, label %for.body41, label %for.end52

for.body41:                                       ; preds = %for.cond39
  %idxprom42 = sext i32 %storemerge9 to i64
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge9, i32 noundef %8) #6
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %if.end49

if.end49:                                         ; preds = %if.then45, %for.body41
  %9 = phi i32 [ %.pre, %if.then45 ], [ %storemerge9, %for.body41 ]
  %inc21.i7 = add nsw i32 %9, 1
  br label %for.cond39
