...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv75 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next76, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv75 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %indvars.iv75
  br i1 %exitcond24.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv20
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv12 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next13, %for.inc41 ]
  %min.3 = phi i32 [ %min.2, %for.cond23.preheader ], [ %min.4, %for.inc41 ]
  %exitcond.not = icmp eq i64 %indvars.iv12, %indvars.iv75
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv12, 0
...
if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv12
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv15 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next16, %for.inc53 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %indvars.iv75
  br i1 %exitcond19.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv15
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %indvars.iv75
  br i1 %exitcond39.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv35
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv25 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next26, %for.inc90 ]
  %min.6 = phi i32 [ %min.5, %for.cond65.preheader ], [ %min.7, %for.inc90 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %indvars.iv75
  br i1 %exitcond29.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv25, 0
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv35
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %spec.select7 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select7, %if.else75 ]
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond65, !llvm.loop !16

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv30 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next31, %for.inc103 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %indvars.iv75
  br i1 %exitcond34.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv35
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %indvars.iv75
  br i1 %exitcond49.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %indvars.iv75
  br i1 %exitcond44.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %indvars.iv75
  br i1 %exitcond55.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv50
  %15 = load i32, ptr %arrayidx141, align 16, !tbaa !5
  %16 = add nsw i64 %indvars.iv50, -1
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %indvars.iv75
  br i1 %exitcond61.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv56
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %indvars.iv75
  br i1 %exitcond73.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %19 = add nsw i64 %indvars.iv68, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv62 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next63, %for.inc185 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %indvars.iv75
  br i1 %exitcond67.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv68, i64 %indvars.iv62
