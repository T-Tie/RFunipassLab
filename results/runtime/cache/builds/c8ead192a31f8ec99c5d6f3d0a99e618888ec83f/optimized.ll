...
for.cond.backedge:                                ; preds = %if.end8, %if.end37
  %indvars.iv.be = phi i64 [ %indvars.iv.next, %if.end8 ], [ 0, %if.end37 ]
  br label %for.cond, !llvm.loop !9

cleanup:                                          ; preds = %for.body, %for.cond
  %wide.trip.count30 = and i64 %indvars.iv, 4294967295
  br label %for.cond11

for.cond11:                                       ; preds = %cleanup, %for.cond.cleanup17
  %indvars.iv27 = phi i64 [ 0, %cleanup ], [ %indvars.iv.next28, %for.cond.cleanup17 ]
  %numofpairs.1 = phi i32 [ 0, %cleanup ], [ %numofpairs.2, %for.cond.cleanup17 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count30
  br i1 %exitcond31.not, label %if.end37, label %for.cond15.preheader
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.body18
  %indvars.iv23 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next24, %for.body18 ]
  %numofpairs.2 = phi i32 [ %numofpairs.1, %for.cond15.preheader ], [ %spec.select, %for.body18 ]
  %exitcond26.not = icmp eq i64 %indvars.iv23, %wide.trip.count30
  br i1 %exitcond26.not, label %for.cond.cleanup17, label %for.body18
...
for.body18:                                       ; preds = %for.cond15
  %arrayidx20 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %cmp23 = icmp eq i32 %2, %mul
  %inc25 = zext i1 %cmp23 to i32
  %spec.select = add nsw i32 %numofpairs.2, %inc25
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond15, !llvm.loop !13

if.end37:                                         ; preds = %for.cond11
  ...
  %vtable.i = load ptr, ptr %call35, align 8, !tbaa !14
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call35, i8 noundef signext %call.i13)
