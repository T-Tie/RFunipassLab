...
for.body16:                                       ; preds = %for.cond14
  ...
  %2 = load i32, ptr %add.ptr21, align 4, !tbaa !5, !invariant.load !13
...
for.inc26:                                        ; preds = %for.body16, %for.cond14
...
for.cond29:                                       ; preds = %for.inc46, %for.end28
  ...
  %3 = phi i32 [ %dec47, %for.inc46 ], [ %sub, %for.end28 ]
  %cmp30 = icmp sge i32 %3, 0
...
for.inc46:                                        ; preds = %for.body35, %for.cond33
  %c2.1 = phi i32 [ %c2.0, %for.cond33 ], [ %4, %for.body35 ]
  %r2.1 = phi i32 [ %r2.0, %for.cond33 ], [ %3, %for.body35 ]
