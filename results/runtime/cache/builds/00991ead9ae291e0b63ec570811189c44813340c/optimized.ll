...
cleanup:                                          ; preds = %if.then, %for.cond.cleanup17
  %s.1 = phi i32 [ %b.0, %if.then ], [ %s.0, %for.cond.cleanup17 ]
  %r.1 = phi i32 [ %a.0, %if.then ], [ %r.0, %for.cond.cleanup17 ]
  br label %for.end26
...
cleanup48:                                        ; preds = %if.then45, %for.cond.cleanup38
  %q.1 = phi i32 [ %d.0, %if.then45 ], [ %q.0, %for.cond.cleanup38 ]
  %p.1 = phi i32 [ %c.0, %if.then45 ], [ %p.0, %for.cond.cleanup38 ]
  br label %for.end49
