...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef %a) #6
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %a, i8 noundef 0, i64 noundef 2000, i1 noundef false) #7
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx.lcssa = phi ptr [ %arrayidx, %for.cond ]
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %arrayidx.lcssa) #8
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc12, %for.end
  %j.0 = phi i32 [ %phiofops.lcssa, %for.end ], [ %dec, %for.inc12 ]
...
for.inc12:                                        ; preds = %for.cond6
  ...
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %arrayidx9) #8
  %dec = add nsw i32 %j.0, -1
  br label %for.cond6, !llvm.loop !8

for.end13:                                        ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %a) #8
  ret i32 0
}
