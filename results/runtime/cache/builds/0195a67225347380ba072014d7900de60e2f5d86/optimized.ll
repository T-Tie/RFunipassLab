...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 90000, ptr nonnull %a) #5
  call void @llvm.lifetime.start.p0(i64 90000, ptr nonnull %b) #5
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 90000, ptr nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 90000, ptr nonnull %a) #5
  ret i32 0
}
