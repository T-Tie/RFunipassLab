...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc10
  %indvars.iv11 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next12, %for.inc10 ]
...
for.inc10:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [35000 x i32], ptr %a, i64 0, i64 %indvars.iv11
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !12
  %call7 = call noundef i32 @_Z4factii(i32 noundef %2, i32 noundef 2) #9
  %arrayidx9 = getelementptr inbounds nuw [35000 x i32], ptr %b, i64 0, i64 %indvars.iv11
...
for.cond13:                                       ; preds = %for.cond2, %for.inc20
  ...
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc20 ], [ 0, %for.cond2 ]
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv15, %4
  br i1 %cmp14, label %for.inc20, label %for.end22

for.inc20:                                        ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [35000 x i32], ptr %b, i64 0, i64 %indvars.iv15
...
define dso_local noundef i32 @_Z4factii(i32 noundef %n, i32 noundef %m) #3 {
entry:
