...
for.cond38:                                       ; preds = %for.inc49, %for.body36
  %sub37.sink = phi i32 [ %sub, %for.body36 ], [ %dec, %for.inc49 ]
  %cmp39 = icmp sge i32 %sub37.sink, 0
  %idxprom51 = sext i32 %sub.sink to i64
  %idxprom53 = sext i32 %sub37.sink to i64
...
for.end61:                                        ; preds = %for.body40, %for.end50, %for.cond34
  %x2.1 = phi i32 [ 0, %for.end50 ], [ 0, %for.cond34 ], [ %sub.sink, %for.body40 ]
  %y2.1 = phi i32 [ 0, %for.end50 ], [ 0, %for.cond34 ], [ %sub37.sink, %for.body40 ]
