...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull %k) #5
...
for.cond10.preheader:                             ; preds = %for.cond
  %smax17 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [50 x [50 x i32]], ptr %k, i64 0, i64 %indvars.iv5, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc25
  %indvars.iv13 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next14, %for.inc25 ]
  %sum.0 = phi i32 [ 0, %for.cond10.preheader ], [ %sum.1, %for.inc25 ]
  %exitcond19.not = icmp eq i64 %indvars.iv13, %wide.trip.count18
  br i1 %exitcond19.not, label %for.end27, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body15 ], [ 0, %for.cond10 ]
  %sum.1 = phi i32 [ %spec.select, %for.body15 ], [ %sum.0, %for.cond10 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.inc25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [50 x [50 x i32]], ptr %k, i64 0, i64 %indvars.iv13, i64 %indvars.iv8
...
for.end27:                                        ; preds = %for.cond10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %k) #5
