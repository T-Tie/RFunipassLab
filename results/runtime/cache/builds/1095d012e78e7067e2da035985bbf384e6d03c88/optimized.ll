...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax62 = tail call i32 @llvm.smax.i32(i32 %indvars.iv36.in, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond48.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.cond27:                                       ; preds = %for.cond, %for.inc62
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc62 ], [ 0, %for.cond ]
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  ...
  %min.1 = phi i32 [ %spec.select28, %for.body34 ], [ %3, %for.body29 ]
...
for.body34:                                       ; preds = %for.cond32
  ...
  %spec.select28 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.1)
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc59 ], [ 0, %for.cond51.preheader ]
...
for.end64:                                        ; preds = %for.cond27
  ...
  %smax73 = tail call i32 @llvm.smax.i32(i32 %indvars.iv36, i32 noundef 1)
...
for.cond66:                                       ; preds = %for.cond81, %if.end
  %indvars.iv70 = phi i64 [ 1, %if.end ], [ %indvars.iv.next71, %for.cond81 ]
...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  %exitcond69.not = icmp eq i64 %indvars.iv65, %6
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre19, %for.inc ], [ %storemerge8, %for.cond1 ]
  %3 = phi i32 [ %.pre10, %for.inc ], [ %1, %for.cond1 ]
