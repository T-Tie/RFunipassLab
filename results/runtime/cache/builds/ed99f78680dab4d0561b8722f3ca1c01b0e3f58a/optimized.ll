...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv35 = phi i32 [ %indvars.iv.next36, %for.inc ], [ 1, %entry ]
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.body
  %indvars.iv32 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next33, %for.body ]
  %s.0 = phi i32 [ 0, %for.cond4.preheader ], [ %s.1, %for.body ]
  %exitcond = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond, label %for.end18, label %for.body

for.body:                                         ; preds = %for.cond4
  %arrayidx7 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv32
...
for.cond23:                                       ; preds = %for.inc58, %if.end22
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc58 ], [ 0, %if.end22 ]
  %exitcond46.not = icmp eq i64 %indvars.iv43, 26
  br i1 %exitcond46.not, label %for.end60, label %for.body25
...
for.cond35:                                       ; preds = %for.body37, %for.body25
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body37 ], [ 0, %for.body25 ]
  %n.0 = phi i32 [ %spec.select, %for.body37 ], [ 0, %for.body25 ]
  %exitcond42 = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond42, label %for.end50, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %inc46 = zext i1 undef to i32
...
if.then52:                                        ; preds = %for.end50
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef 0, i32 noundef %n.0)
  br label %for.inc58
