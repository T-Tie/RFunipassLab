...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv13 = phi i64 [ 0, %entry ], [ %indvars.iv.next14, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre17, %for.inc ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.pre-phi, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.24, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.cond1.preheader ], [ %end2.2, %for.inc ]
  %end1.1 = phi i32 [ %end1.0, %for.cond1.preheader ], [ %end1.2, %for.inc ]
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.26, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.28, %for.inc ]
  %6 = sext i32 %5 to i64
...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre18 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre18, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
  %star1.28 = phi i32 [ %star1.1, %for.body3.for.inc_crit_edge ], [ %star1.2.ph, %land.lhs.true ]
  %star2.26 = phi i32 [ %star2.1, %for.body3.for.inc_crit_edge ], [ %star2.2.ph, %land.lhs.true ]
  %f.24 = phi i32 [ %f.1, %for.body3.for.inc_crit_edge ], [ %f.2.ph, %land.lhs.true ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %star1.0.neg = sub i32 0, %star1.0
  %add26 = add i32 %sub25, %star1.0.neg
  %sub27 = add i32 %end2.0, 1
  %star2.0.neg = sub i32 0, %star2.0
