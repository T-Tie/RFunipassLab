...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv24, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv30, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv27, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv30, i64 %indvars.iv27
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax41 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax42 = call i32 @llvm.smax.i32(i32 %smax41, i32 noundef 0)
  %wide.trip.count43 = zext nneg i32 %smax42 to i64
  %wide.trip.count = zext nneg i32 %smax36 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond44.not = icmp eq i64 %indvars.iv37, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax48 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count56 = zext nneg i32 %smax36 to i64
  %wide.trip.count49 = zext nneg i32 %smax48 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv37, i64 %indvars.iv33
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv58 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next59, %for.inc83 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count43
  br i1 %exitcond62.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond57.not = icmp eq i64 %indvars.iv51, %wide.trip.count56
  br i1 %exitcond57.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv58, i64 %indvars.iv51
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv45 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next46, %for.inc77 ]
  %exitcond50.not = icmp eq i64 %indvars.iv45, %wide.trip.count49
  br i1 %exitcond50.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv45
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv45, i64 %indvars.iv51
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count43
  br i1 %exitcond67.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv63
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax41 to i64
  %arrayidx95 = getelementptr inbounds [100 x i32], ptr %d, i64 0, i64 %idxprom94
  store i32 %smax, ptr %arrayidx95, align 4, !tbaa !5
  %wide.trip.count73 = zext nneg i32 %smax36 to i64
  br label %for.cond96

for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count43
  br i1 %exitcond79.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv75
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax41, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax41, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv68 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next69, %for.inc112 ]
  %exitcond74.not = icmp eq i64 %indvars.iv68, %wide.trip.count73
  br i1 %exitcond74.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv75, i64 %indvars.iv68
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv92 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond99.not = icmp eq i64 %indvars.iv92, %wide.trip.count43
  br i1 %exitcond99.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv92
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv92, 0
  %or.cond19 = and i1 %or.cond, %cmp128
  br i1 %or.cond19, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv92
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax83 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count84 = zext nneg i32 %smax83 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond85.not = icmp eq i64 %indvars.iv80, %wide.trip.count84
  br i1 %exitcond85.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv92, i64 %indvars.iv80
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax89 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count90 = zext nneg i32 %smax89 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond91.not = icmp eq i64 %indvars.iv86, %wide.trip.count90
  br i1 %exitcond91.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv92, i64 %indvars.iv86
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv92, %14
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar20 = call i32 @putchar(i32 noundef 10) #6
  br label %for.inc198
