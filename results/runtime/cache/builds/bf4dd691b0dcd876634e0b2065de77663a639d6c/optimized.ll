...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr nonnull %word) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(41000) %word, i8 0, i64 41000, i1 false)
  call void @llvm.lifetime.start.p0(i64 81000, ptr nonnull %newword) #9
...
if.then6.i:                                       ; preds = %for.body
  ...
  %3 = load i64, ptr %gep77, align 8, !tbaa !11
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc74 ], [ 0, %for.cond ]
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #10
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx6) #9
  ...
  store i8 32, ptr %arrayidx29, align 1, !tbaa !34
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx6) #9
...
if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #9
  store i8 32, ptr %arrayidx56, align 1, !tbaa !34
  br label %for.inc74

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #9
  store i8 32, ptr %arrayidx56, align 1, !tbaa !34
  br label %for.inc74
...
for.end76:                                        ; preds = %for.cond2
  ...
  store i8 0, ptr %arrayidx81, align 1, !tbaa !34
  %idxprom84 = sext i32 %j.0 to i64
  %arrayidx85 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom77, i64 %idxprom84
  store i8 0, ptr %arrayidx85, align 1, !tbaa !34
  %smax91 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %8 = add i32 %smax91, 1
...
for.body88:                                       ; preds = %for.cond86
  ...
  %call92 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx90) #10
...
if.then99:                                        ; preds = %for.body96
  %10 = load i8, ptr %arrayidx103, align 1, !tbaa !34
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %10, ptr %__c.addr.i, align 1, !tbaa !34
  ...
  %11 = load i64, ptr %gep79, align 8, !tbaa !11
...
if.else106:                                       ; preds = %for.body96
  ...
  %12 = load i8, ptr %arrayidx110, align 1, !tbaa !34
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i6)
  store i8 %12, ptr %__c.addr.i6, align 1, !tbaa !34
  ...
  %13 = load i64, ptr %gep78, align 8, !tbaa !11
...
for.inc113:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18
  ...
  br label %for.cond94, !llvm.loop !36

for.inc116:                                       ; preds = %for.cond94
  %indvars.iv.next88 = add nuw nsw i64 %indvars.iv87, 1
  br label %for.cond86, !llvm.loop !37

for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 81000, ptr nonnull %newword) #9
  call void @llvm.lifetime.end.p0(i64 41000, ptr nonnull %word) #9
