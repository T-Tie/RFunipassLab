...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull %a) #5
  br label %for.cond
...
for.cond4:                                        ; preds = %if.end30, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %if.end30 ], [ 1, %for.end ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %cmp6 = icmp sgt i32 %3, 1
  br i1 %cmp6, label %land.lhs.true, label %for.end33
...
if.then26:                                        ; preds = %land.lhs.true
  %arrayidx28 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv8
  %5 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %5)
  br label %if.end30

if.end30:                                         ; preds = %if.then26, %land.lhs.true
