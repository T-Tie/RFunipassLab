...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %c) #3
  br label %for.cond
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %spec.select = add nsw i32 %i.0, %dec
...
for.end:                                          ; preds = %if.end, %for.cond
  %i.1 = phi i32 [ %i.0, %for.cond ], [ %i.2, %if.end ]
  %smax = call i32 @llvm.smax.i32(i32 %i.1, i32 noundef 0)
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %putchar = call i32 @putchar(i32 noundef %conv19) #5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond14, !llvm.loop !11

for.end23:                                        ; preds = %for.cond14
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %c) #5
  ret i32 0
}
