...
if.then:                                          ; preds = %for.body
  ...
  %sub35 = fsub double %.pre61, %call34
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %16, double noundef %17) #13
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %16) #13
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %16, double noundef %17, double noundef %16, double noundef %18) #13
  br label %for.inc132
...
for.end134:                                       ; preds = %for.cond74
  call fastcc void @outlined_ir_func_0() #13
  call fastcc void @outlined_ir_func_0() #13
...
for.end134_after_outline.exitStub:
  ...
  %call.i1 = call i32 @getc(ptr noundef %0) #14
  ret void
}
...
attributes #8 = { minsize mustprogress nofree norecurse nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
