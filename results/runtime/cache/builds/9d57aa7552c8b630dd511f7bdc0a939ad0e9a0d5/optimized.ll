...
entry:
  ...
  %mul4 = mul nsw i32 50, %div1
  %sub5 = sub nsw i32 %sub, %mul4
  %mul6 = mul nsw i32 20, %div3
  %sub7 = sub nsw i32 %sub5, %mul6
  %div8 = sdiv i32 %sub7, 10
  %rem9 = srem i32 %0, 10
  %div10 = sdiv i32 %rem9, 5
  %rem11 = srem i32 %0, 5
  %call12 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div, i32 noundef %div1, i32 noundef %div3, i32 noundef %div8, i32 noundef %div10, i32 noundef %rem11) #5
