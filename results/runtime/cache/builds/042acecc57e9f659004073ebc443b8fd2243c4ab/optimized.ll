...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.end ], [ 0, %for.body ]
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv4, i64 %indvars.iv
...
; Function Attrs: mustprogress nofree norecurse noreturn nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local noundef i32 @_Z7guilingi(i32 noundef %n) local_unnamed_addr #4 {
for.cond:
  %cmp = icmp sgt i32 %n, 0
  br label %tailrecurse

tailrecurse:                                      ; preds = %cleanup, %for.cond
  %n.tr = phi i32 [ %n, %for.cond ], [ %sub75, %cleanup ]
  br i1 %cmp, label %for.body, label %cleanup

for.body:                                         ; preds = %tailrecurse
  %0 = load i32, ptr @a, align 4, !tbaa !5, !invariant.load !12
  br label %for.body19

for.body19:                                       ; preds = %for.body, %for.body19
  %1 = phi i32 [ %0, %for.body ], [ %.pre, %for.body19 ]
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body19 ]
  %arrayidx23 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv
  %sub = sub nsw i32 %1, %0
  store i32 %sub, ptr %arrayidx23, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx23.phi.trans.insert = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv.next
  %.pre = load i32, ptr %arrayidx23.phi.trans.insert, align 4, !tbaa !5, !invariant.load !12
  br label %for.body19
...
entry:
  ...
  %0 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 8), align 8
  %1 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 840), align 8
...
for.cond:                                         ; preds = %for.cond10, %for.cond.preheader
  %indvars.iv3 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next4, %for.cond10 ]
...
attributes #4 = { mustprogress nofree norecurse noreturn nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
