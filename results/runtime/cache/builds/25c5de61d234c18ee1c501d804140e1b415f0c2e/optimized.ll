...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i32, ptr %add.ptr, align 4, !tbaa !5, !invariant.load !9
...
for.inc11:                                        ; preds = %for.cond4
  ...
  %5 = load i32, ptr %add.ptr8, align 4, !tbaa !5, !invariant.load !9
...
for.inc14:                                        ; preds = %for.cond5
  ...
  %5 = load i32, ptr %add.ptr10, align 4, !tbaa !5, !invariant.load !9
  %6 = load i32, ptr %m, align 4, !tbaa !5
  %sub = sub nsw i32 %5, %6
...
for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %6, i32 noundef %6) #7
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %6, i32 noundef %6) #7
...
for.inc57:                                        ; preds = %for.cond44
  ...
  %14 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !9
...
for.inc66:                                        ; preds = %for.cond14
  ...
  %call65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15) #7
