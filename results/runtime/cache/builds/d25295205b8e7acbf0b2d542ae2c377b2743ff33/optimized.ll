...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 501, ptr noundef nonnull align 16 %words) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(501) %words, i8 noundef 0, i64 noundef 501, i1 noundef false) #11
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %words) #12
  %conv = trunc i64 %call4 to i32
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp.not = icmp sgt i32 %0, %conv
  br i1 %cmp.not, label %if.end94, label %for.cond.preheader
...
for.cond:                                         ; preds = %while.cond, %for.cond.preheader
  br label %while.cond

while.cond:                                       ; preds = %for.cond, %while.body
  %indvars.iv = phi i64 [ 0, %for.cond ], [ %indvars.iv.next, %while.body ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond, label %while.body
...
if.end94:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 501, ptr noundef nonnull %words) #13
  ret i32 0
}
...
define internal fastcc void @outlined_ir_func_1(ptr noundef nonnull %0) unnamed_addr #7 {
if.end94.exitStub:
  %call70 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0)
  %call71 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call70, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
