...
for.body7:                                        ; preds = %for.cond5
  ...
  br i1 %cmp12, label %for.inc24.loopexit, label %for.inc13
...
for.cond27:                                       ; preds = %for.inc39, %for.end26
  ...
  %cmp28 = icmp slt i32 %j.2, %j.0.lcssa
...
if.then31:                                        ; preds = %for.body29
  ...
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4) #5
  br label %for.inc39
...
if.else:                                          ; preds = %for.body29
  ...
  %call37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5) #5
  br label %for.inc39
