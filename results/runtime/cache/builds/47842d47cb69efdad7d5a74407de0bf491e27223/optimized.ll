...
entry:
  ...
  br i1 %cmp, label %for.cond.preheader, label %if.end127.sink.split45
...
if.end63:                                         ; preds = %land.lhs.true, %for.body, %if.then45
  ...
  switch i8 %0, label %if.end127.sink.split45 [
...
lor.lhs.false83:                                  ; preds = %if.end63, %if.end63, %if.end63, %if.end63
  ...
  switch i8 %2, label %if.end127.sink.split45 [
    i8 65, label %for.inc
    i8 84, label %for.inc
    i8 71, label %for.inc
    i8 67, label %for.inc
...
if.end113:                                        ; preds = %if.then111, %if.then107
  ...
  br i1 %cmp114, label %if.end127, label %if.end127.sink.split45

if.end127.sink.split45:                           ; preds = %entry, %if.end63, %lor.lhs.false83, %if.end113
  %.str.3.sink = phi ptr [ @.str.3, %if.end113 ], [ @.str.4, %lor.lhs.false83 ], [ @.str.4, %if.end63 ], [ @.str.4, %entry ]
  %call116 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink)
  br label %if.end127

if.end127:                                        ; preds = %if.end127.sink.split45, %if.end113
