...
for.cond16:                                       ; preds = %if.end, %for.end15
  %sum.0 = phi i32 [ 0, %for.end15 ], [ %sum.1, %if.end ]
  %i.2 = phi i32 [ 0, %for.end15 ], [ %inc43, %if.end ]
  %k.0 = phi i32 [ 0, %for.end15 ], [ %k.1, %if.end ]
...
for.body18:                                       ; preds = %for.cond16
  ...
  %2 = load i32, ptr %add.ptr20, align 4, !tbaa !5
...
for.cond23:                                       ; preds = %for.body25, %if.then
  %j.0 = phi i32 [ %k.0, %if.then ], [ %inc32, %for.body25 ]
...
for.end33:                                        ; preds = %for.cond23
  ...
  %3 = load i32, ptr %add.ptr20, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %for.end33, %for.body18
  %sum.1 = phi i32 [ %3, %for.end33 ], [ %add21, %for.body18 ]
...
for.cond45:                                       ; preds = %for.body48, %for.end44
  %j.1 = phi i32 [ %k.0, %for.end44 ], [ %inc55, %for.body48 ]
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %sub46 = sub nsw i32 %4, 1
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !31
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !39
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !40
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !43
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !19
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !19
  br label %return
