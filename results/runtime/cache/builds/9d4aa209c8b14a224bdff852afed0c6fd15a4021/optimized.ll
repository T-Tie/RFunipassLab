...
entry:
  ...
  %smax20 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %conv7, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  br i1 %exitcond22.not, label %for.end22, label %for.cond8

for.cond8:                                        ; preds = %for.cond, %for.inc
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc ], [ 0, %for.cond ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc ], [ %indvars.iv, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond.not, label %if.then24.loopexit, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %arrayidx = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv13
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %arrayidx13 = getelementptr inbounds nuw [50 x i8], ptr %b, i64 0, i64 %indvars.iv15
...
if.then24:                                        ; preds = %if.then24.loopexit, %for.end22
  %.pre-phi = phi i64 [ %.pre, %if.then24.loopexit ], [ %wide.trip.count21, %for.end22 ]
  %i.012 = phi i32 [ %i.0, %if.then24.loopexit ], [ %smax20, %for.end22 ]
  %add = add nsw i32 %i.012, %conv
  %smax30 = call i32 @llvm.smax.i32(i32 %i.012, i32 %add)
  %2 = sub nsw i32 %smax30, %i.012
  %wide.trip.count31 = zext i32 %2 to i64
  br label %for.cond25

for.cond25:                                       ; preds = %for.inc32, %if.then24
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc32 ], [ 0, %if.then24 ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc32 ], [ %.pre-phi, %if.then24 ]
  %exitcond32.not = icmp eq i64 %indvars.iv25, %wide.trip.count31
  br i1 %exitcond32.not, label %if.end36, label %for.inc32

for.inc32:                                        ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [50 x i8], ptr %c, i64 0, i64 %indvars.iv25
  %3 = load i8, ptr %arrayidx29, align 1, !tbaa !5, !invariant.load !8
  %arrayidx31 = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv23
