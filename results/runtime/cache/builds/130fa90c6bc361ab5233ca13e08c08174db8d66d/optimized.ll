...
for.inc:                                          ; preds = %for.cond
  ...
  call void @_Z9xiangguaniii(i32 noundef %2, i32 noundef %3, i32 noundef %4) #7
  %inc = add nsw i32 %0, 1
...
entry:
  ...
  %i = alloca i32, align 4
  %i8 = alloca i8, i32 0, align 4
  %j = alloca i32, align 4
  %j9 = alloca i8, i32 0, align 4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x1) #8
  store i32 0, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x2) #8
...
if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %y) #9
...
for.inc.gvnsink.split:                            ; preds = %if.end.thread, %if.then9, %if.else
  %sub10.sink = phi i32 [ %sub10, %if.else ], [ %sub, %if.then9 ], [ %dec, %if.end.thread ]
  store i32 %sub10.sink, ptr %x1, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.inc.gvnsink.split, %if.end
  %inc = add nsw i32 %0, 1
...
for.cond13:                                       ; preds = %for.inc37, %for.end
  %2 = phi i32 [ %inc38, %for.inc37 ], [ 1, %for.end ]
...
if.end26.thread:                                  ; preds = %for.body15, %lor.lhs.false18, %lor.lhs.false20, %lor.lhs.false22
  ...
  br label %for.inc37.gvnsink.split
...
if.then28:                                        ; preds = %if.end26
  %call29 = call noundef i32 @_Z7runniani(i32 noundef %y) #9
...
for.inc37.gvnsink.split:                          ; preds = %if.end26.thread, %if.then31, %if.else33
  %sub34.sink = phi i32 [ %sub34, %if.else33 ], [ %sub32, %if.then31 ], [ %dec25, %if.end26.thread ]
  store i32 %sub34.sink, ptr %x2, align 4, !tbaa !5
  br label %for.inc37

for.inc37:                                        ; preds = %for.inc37.gvnsink.split, %if.end26
  %inc38 = add nsw i32 %2, 1
...
if.then42:                                        ; preds = %for.end39
  %call43 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #6
  br label %if.end46

if.else44:                                        ; preds = %for.end39
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #6
  br label %if.end46
...
attributes #9 = { nofree nosync willreturn }
