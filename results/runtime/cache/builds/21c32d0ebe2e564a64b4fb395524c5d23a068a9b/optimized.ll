...
for.cond13:                                       ; preds = %for.inc31, %for.body12
  %.sink = phi i32 [ %sub.sink, %for.body12 ], [ %add, %for.inc31 ]
...
for.end35:                                        ; preds = %for.cond10
  ...
  store i32 %8, ptr %dm, align 4, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.inc47, %for.end35
  ...
  %10 = load i32, ptr %dm, align 4, !tbaa !5
...
for.end49:                                        ; preds = %for.cond37
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10)
