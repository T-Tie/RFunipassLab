...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %s_all) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %s_good) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %all) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %good) #6
...
if.then15:                                        ; preds = %if.else
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %good) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %all) #6
