...
for.cond27.preheader:                             ; preds = %for.cond2
  ...
  %smax31 = call i32 @llvm.smax.i32(i32 %number.0, i32 0)
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv27 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next28, %for.inc39 ]
...
if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv27
