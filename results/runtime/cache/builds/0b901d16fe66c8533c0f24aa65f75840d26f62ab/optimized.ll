...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc25
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc25 ], [ 0, %for.cond16.preheader ]
...
for.cond31:                                       ; preds = %for.inc60, %for.end30
  ...
  br i1 %exitcond58.not, label %for.cond63.preheader, label %for.cond35.preheader

for.cond35.preheader:                             ; preds = %for.cond31
  br label %for.cond35

for.cond63.preheader:                             ; preds = %for.cond31
  br label %for.cond63

for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc57
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc57 ], [ 0, %for.cond35.preheader ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52.not, label %for.inc60, label %for.cond39.preheader

for.cond39.preheader:                             ; preds = %for.cond35
  br label %for.cond39

for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc50
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc50 ], [ 0, %for.cond39.preheader ]
  %he.0 = phi i32 [ %add, %for.inc50 ], [ 0, %for.cond39.preheader ]
...
for.cond63:                                       ; preds = %for.cond63.preheader, %for.inc86
  %13 = phi i32 [ %.pre, %for.inc86 ], [ %8, %for.cond63.preheader ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc86 ], [ 0, %for.cond63.preheader ]
...
for.end88:                                        ; preds = %for.cond63
  ...
  %call.i = call i32 @getc(ptr noundef %19)
  %20 = load ptr, ptr @stdin, align 8, !tbaa !20
