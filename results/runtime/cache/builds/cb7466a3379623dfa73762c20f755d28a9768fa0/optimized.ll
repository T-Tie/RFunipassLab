...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc110 ], [ 0, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv11, %9
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv11
  %10 = load double, ptr %arrayidx53, align 8, !tbaa !9
  %cmp54 = fcmp ogt double %10, 0.000000e+00
  %11 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv11
  %12 = load double, ptr %11, align 8, !tbaa !9
  br i1 %cmp54, label %if.then55, label %if.else63

if.then55:                                        ; preds = %for.body51
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv11
...
if.else72:                                        ; preds = %if.else63
  ...
  %14 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv11
