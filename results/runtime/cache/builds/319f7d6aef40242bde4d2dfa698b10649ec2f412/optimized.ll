...
for.cond33:                                       ; preds = %for.cond3, %for.inc50
  %.pre21 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.cond3 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc50 ], [ 0, %for.cond3 ]
...
if.then42:                                        ; preds = %if.then40
  ...
  %.pre20 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  br label %if.end44

if.end44:                                         ; preds = %if.then42, %if.then40
  %8 = phi i32 [ %.pre20, %if.then42 ], [ %6, %if.then40 ]
...
for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre21, %for.body36 ]
