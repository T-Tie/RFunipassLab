; ModuleID = '<stdin>'
source_filename = "/tmp/tmpyr6p5r3o.cpp"
...
define dso_local noundef i32 @_Z3dfsii(i32 noundef %k, i32 noundef %b) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i32 %k, 1
...
for.cond:                                         ; preds = %for.inc, %entry
  %ret.0 = phi i32 [ %conv, %entry ], [ %ret.1, %for.inc ]
...
if.then:                                          ; preds = %for.body
  %call = tail call noundef i32 @_Z3dfsii(i32 noundef %div, i32 noundef %i.0)
  %add = add nsw i32 %call, %ret.0
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then
  %ret.1 = phi i32 [ %add, %if.then ], [ %ret.0, %for.body ]
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3dfsii(i32 noundef %1, i32 noundef 2)
