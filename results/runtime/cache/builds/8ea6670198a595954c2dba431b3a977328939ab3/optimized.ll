...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv33 = phi i32 [ %indvars.iv.next34, %while.cond ], [ 0, %for.cond ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv24
...
while.end:                                        ; preds = %while.cond
  %0 = trunc nuw nsw i64 %indvars.iv24 to i32
  %sub = shl i64 %indvars.iv24, 32
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv27 = phi i64 [ %1, %while.cond11.preheader ], [ %indvars.iv.next28, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %2 = trunc nuw i64 %indvars.iv.next28 to i32
  %cmp12 = icmp slt i32 %2, %0
  br i1 %cmp12, label %while.body13, label %for.inc29

while.body13:                                     ; preds = %while.cond11
  %3 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next28
...
land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next28
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv30 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next31, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select22, %for.body33 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond35.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv30
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select22 = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.2)
