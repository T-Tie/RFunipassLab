...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv69.in = phi i64 [ %indvars.iv69, %for.end114 ], [ %2, %entry ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %indvars.iv69 = add i64 %indvars.iv69.in, -1
  %smax = tail call i64 @llvm.smax.i64(i64 %indvars.iv69, i64 noundef 1)
  %3 = trunc nuw i64 %indvars.iv62 to i32
  %smax59 = tail call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv69.in, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv69.in to i32
  %smax43 = tail call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count22 = zext nneg i32 %smax43 to i64
  %wide.trip.count = and i64 %indvars.iv69.in, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv19 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next20, %for.inc28 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond31, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv19, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc25 ], [ 0, %for.cond14.preheader ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv19, i64 %indvars.iv14
...
for.cond31:                                       ; preds = %for.cond, %for.inc66
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc66 ], [ 0, %for.cond ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count22
  br i1 %exitcond39.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select12, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond28.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv24, i64 %indvars.iv34
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5, !invariant.load !9
  %spec.select12 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond34, !llvm.loop !15

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc63 ], [ 0, %for.cond51.preheader ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond33.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv29, i64 %indvars.iv34
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc89 ], [ 1, %for.end68 ]
  %exitcond.not71 = icmp eq i64 %indvars.iv46, %smax
  br i1 %exitcond.not71, label %for.cond92.preheader, label %for.cond75
...
for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count22
  br i1 %exitcond45.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv46, i64 %indvars.iv40
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !9
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv46, i64 %indvars.iv40
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv56 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next57, %for.inc112 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count60
  br i1 %exitcond61.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %indvars.iv62
  br i1 %exitcond55.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv56, i64 %indvars.iv.next50
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !9
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv56, i64 %indvars.iv49
