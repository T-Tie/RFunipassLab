...
for.cond6:                                        ; preds = %for.cond, %for.inc51
  %7 = phi i32 [ %.pre6, %for.inc51 ], [ %5, %for.cond ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc51 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
...
for.inc51:                                        ; preds = %if.else, %for.body8, %if.else47
  ...
  %call24.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink)
  %call25.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call24.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
