...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax44 = tail call i32 @llvm.smax.i32(i32 %indvars.iv18.in, i32 0)
...
for.end64:                                        ; preds = %for.cond27
  ...
  %smax55 = tail call i32 @llvm.smax.i32(i32 %indvars.iv18, i32 1)
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre9, %for.inc ], [ %storemerge4, %for.cond1 ]
  %3 = phi i32 [ %.pre8, %for.inc ], [ %1, %for.cond1 ]
