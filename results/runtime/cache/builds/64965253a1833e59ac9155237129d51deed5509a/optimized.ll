...
for.cond:                                         ; preds = %for.inc28, %if.end
  %i.0 = phi i32 [ 0, %if.end ], [ %inc29, %for.inc28 ]
...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  %min.0 = phi i32 [ 32767, %for.body ], [ %min.1, %for.inc ]
...
for.cond31:                                       ; preds = %for.inc66, %for.end30
  %i.1 = phi i32 [ 0, %for.end30 ], [ %inc67, %for.inc66 ]
...
for.cond34:                                       ; preds = %for.inc48, %for.body33
  %j.2 = phi i32 [ 0, %for.body33 ], [ %inc49, %for.inc48 ]
  %min.2 = phi i32 [ 32767, %for.body33 ], [ %min.3, %for.inc48 ]
...
for.end50:                                        ; preds = %for.cond34
  %min.2.lcssa = phi i32 [ %min.2, %for.cond34 ]
  br label %for.cond51

for.cond51:                                       ; preds = %for.inc63, %for.end50
  %j.3 = phi i32 [ 0, %for.end50 ], [ %inc64, %for.inc63 ]
...
for.inc63:                                        ; preds = %for.cond51
  ...
  %sub58 = sub nsw i32 %3, %min.2.lcssa
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %i.2 = phi i32 [ 1, %for.end68 ], [ %inc90.lcssa, %for.inc89 ]
...
for.cond75:                                       ; preds = %for.inc86, %for.body74
  %j.4 = phi i32 [ 0, %for.body74 ], [ %inc87, %for.inc86 ]
...
for.inc89:                                        ; preds = %for.cond75
  %inc90.lcssa = phi i32 [ %inc90, %for.cond75 ]
  br label %for.cond71, !llvm.loop !18

for.end91:                                        ; preds = %for.cond71
  %sub72.lcssa = phi i32 [ %sub72, %for.cond71 ]
  br label %for.cond92

for.cond92:                                       ; preds = %for.inc112, %for.end91
  %i.3 = phi i32 [ 0, %for.end91 ], [ %inc113, %for.inc112 ]
  %cmp94 = icmp slt i32 %i.3, %sub72.lcssa
...
for.cond96:                                       ; preds = %for.inc109, %for.body95
  %j.5 = phi i32 [ 1, %for.body95 ], [ %add102, %for.inc109 ]
  %cmp98 = icmp slt i32 %j.5, %sub72.lcssa
...
for.end114:                                       ; preds = %for.cond92
  %call = call noundef i32 @_Z3calPA120_ii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(488) %matrix, i32 noundef %sub72.lcssa) #5
  %add116 = add nsw i32 %call, %4
  br label %return
...
for.inc15:                                        ; preds = %for.cond1
  %.lcssa = phi i32 [ %1, %for.cond1 ]
  %call13 = call noundef i32 @_Z3calPA120_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(57600) %a, i32 noundef %.lcssa) #7
