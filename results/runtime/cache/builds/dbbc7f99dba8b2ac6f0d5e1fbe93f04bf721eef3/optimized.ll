...
for.end33:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %gep101)
...
for.end56:                                        ; preds = %for.cond45
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %add.ptr59)
...
for.end33_after_outline.exitStub:
  call fastcc void @outlined_ir_func_0.6(ptr noundef nonnull dereferenceable(1) %0)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline:
  ...
  %1 = load i64, ptr %gep100, align 8, !tbaa !12
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.6(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #8 {
newFuncRoot_after_outline.exitStub:
