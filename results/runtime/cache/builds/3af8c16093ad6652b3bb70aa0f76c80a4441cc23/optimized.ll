...
for.end44:                                        ; preds = %for.cond15
  store i32 500, ptr %k, align 4, !tbaa !5
  br label %for.cond45
...
land.end:                                         ; preds = %land.rhs, %for.cond45
  %9 = phi i1 [ false, %for.cond45 ], [ %cmp47, %land.rhs ]
  br i1 %9, label %for.body48, label %for.end67
...
for.body76:                                       ; preds = %for.cond74
  ...
  %15 = load i32, ptr %arrayidx78, align 4, !tbaa !5
