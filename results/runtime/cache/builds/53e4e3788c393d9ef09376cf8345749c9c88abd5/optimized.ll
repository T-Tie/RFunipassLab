...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %jump) #8
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %sPtr) #8
  %call = call i64 @strlen(ptr noundef readonly captures(none) %str) #11
  %add.ptr = getelementptr inbounds nuw i8, ptr %str, i64 %call
  %add.ptr1 = getelementptr inbounds i8, ptr %add.ptr, i64 -1
  store ptr %add.ptr1, ptr %sPtr, align 8, !tbaa !12
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %nPtr) #8
...
while.body:                                       ; preds = %while.cond
  ...
  %1 = load i8, ptr %0, align 1, !tbaa !17, !invariant.load !18
...
while.body12:                                     ; preds = %while.cond8
  %4 = load i32, ptr %3, align 4, !tbaa !5, !invariant.load !18
  %mul = mul nsw i32 %4, %n
  %rem = srem i32 %mul, 10
...
while.cond17:                                     ; preds = %while.body19, %while.end15
  ...
  %7 = load i32, ptr %6, align 4, !tbaa !5, !invariant.load !18
...
while.body26:                                     ; preds = %while.cond22
  ...
  %10 = load i32, ptr %8, align 4, !tbaa !5, !invariant.load !18
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %nPtr) #8
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %sPtr) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %jump) #8
