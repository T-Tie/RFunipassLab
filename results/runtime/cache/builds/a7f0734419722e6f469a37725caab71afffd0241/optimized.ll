...
if.then15:                                        ; preds = %for.end
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j16) #6
...
for.end27:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j16) #6
  br label %for.inc29
...
for.end13:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %i) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %j14) #6
...
for.body18:                                       ; preds = %for.cond15
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i19) #6
...
for.inc37:                                        ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i19) #6
  %inc38 = add nsw i32 %3, 1
  store i32 %inc38, ptr %j14, align 4, !tbaa !5
  br label %for.cond15, !llvm.loop !21

for.end39:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %j14) #6
  ret void
}
...
for.inc17:                                        ; preds = %for.cond13
  call void @_Z7zerorowi(i32 noundef %.sink) #7
  %4 = load i32, ptr @k, align 4, !tbaa !5
  call void @_Z7zerocoli(i32 noundef %4) #7
  %5 = load i32, ptr getelementptr inbounds ([101 x i32], ptr getelementptr inbounds ([101 x [101 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 8, !tbaa !5
  ...
  call void @_Z4jiani(i32 noundef %7) #7
...
for.end18:                                        ; preds = %for.cond13
  ...
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
