...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv30 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next31, %for.inc28 ]
  ...
  br i1 %exitcond35.not, label %for.end30, label %for.body12
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv26 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next27, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv26
...
for.body39:                                       ; preds = %for.cond37
  ...
  %a2.2 = select i1 %cmp44, i32 %i.2, i32 %a2.1
  %b2.2 = select i1 %cmp44, i32 %j.2, i32 %b2.1
  %add46 = zext i1 %cmp44 to i32
  %p.6 = add nuw nsw i32 %add46, %p.5
