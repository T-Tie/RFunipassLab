...
NodeBlock11:                                      ; preds = %NodeBlock13
  ...
  %spec.select = select i1 %Pivot12, i32 1, i32 2
  br label %sw.epilog.gvnsink.split

NodeBlock9:                                       ; preds = %NodeBlock15
  %Pivot10 = icmp ne i32 %rem1, 5
  br label %sw.epilog.gvnsink.split
...
NodeBlock5:                                       ; preds = %NodeBlock7
  %Pivot6 = icmp eq i32 %rem1, 2
  br i1 %Pivot6, label %sw.epilog.gvnsink.split, label %NodeBlock3

NodeBlock3:                                       ; preds = %NodeBlock5
  %Pivot4 = icmp samesign ult i32 %rem1, 4
  %spec.select21 = select i1 %Pivot4, i32 1, i32 2
  br label %sw.epilog.gvnsink.split
...
sw.epilog.gvnsink.split:                          ; preds = %NodeBlock, %sw.epilog.gvnsink.split.fold.split, %NodeBlock3, %NodeBlock9, %NodeBlock11, %NodeBlock5, %NodeBlock13
  %.sink2 = phi i32 [ 1, %NodeBlock13 ], [ 0, %NodeBlock5 ], [ 0, %NodeBlock ], [ 1, %NodeBlock11 ], [ 1, %NodeBlock9 ], [ 0, %NodeBlock3 ], [ 0, %sw.epilog.gvnsink.split.fold.split ]
  %.sink1 = phi i32 [ 1, %NodeBlock13 ], [ 1, %NodeBlock5 ], [ 0, %NodeBlock ], [ %spec.select, %NodeBlock11 ], [ 0, %NodeBlock9 ], [ %spec.select21, %NodeBlock3 ], [ 0, %sw.epilog.gvnsink.split.fold.split ]
  %.sink.shrunk = phi i1 [ false, %NodeBlock13 ], [ false, %NodeBlock5 ], [ true, %NodeBlock ], [ %Pivot12, %NodeBlock11 ], [ %Pivot10, %NodeBlock9 ], [ %Pivot4, %NodeBlock3 ], [ false, %sw.epilog.gvnsink.split.fold.split ]
