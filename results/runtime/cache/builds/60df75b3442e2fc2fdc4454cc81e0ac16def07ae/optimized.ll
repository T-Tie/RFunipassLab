...
for.cond10:                                       ; preds = %for.cond10.loopexit, %for.cond10.preheader
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.cond10.loopexit ], [ %4, %for.cond10.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.cond10.loopexit ], [ %3, %for.cond10.preheader ]
  %indvars.iv.next28 = add nsw i64 %indvars.iv27, -1
  %cmp11 = icmp sgt i64 %indvars.iv27, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next28
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next28
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv24 = phi i64 [ %indvars.iv22, %for.cond13.preheader ], [ %indvars.iv.next25, %for.inc31 ]
  %indvars.iv.next25 = add nsw i64 %indvars.iv24, 1
  %cmp14 = icmp slt i64 %indvars.iv.next25, %4
  br i1 %cmp14, label %for.body15, label %for.cond10.loopexit

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %arrayidx19 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next25
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next25
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %9, %for.end35 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv30
