...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %l) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %m) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %y) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %z) #6
...
for.body19:                                       ; preds = %for.cond17
  ...
  %7 = load i8, ptr %arrayidx21, align 1, !tbaa !9, !invariant.load !10
  ...
  %8 = load i8, ptr %arrayidx26, align 1, !tbaa !9, !invariant.load !10
...
if.then34:                                        ; preds = %for.end32
  ...
  %11 = load i8, ptr %arrayidx37, align 2, !tbaa !9, !invariant.load !10
  %inc38 = add i8 %11, 1
...
for.inc56:                                        ; preds = %for.cond46
  ...
  %15 = load i8, ptr %arrayidx51, align 1, !tbaa !9, !invariant.load !10
...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  ...
  %18 = load i32, ptr %i.sink1, align 4, !tbaa !5
  %add75 = add nsw i32 %18, 1
  store i32 %add75, ptr %j, align 4, !tbaa !5
  %cmp77 = icmp slt i32 %add75, %17
...
for.cond89:                                       ; preds = %for.inc114, %if.then88
  %.sink2 = phi i32 [ 0, %if.then88 ], [ %inc115, %for.inc114 ]
  store i32 %.sink2, ptr %z, align 4, !tbaa !5
  %cmp90 = icmp slt i32 %.sink2, 6
  br i1 %cmp90, label %for.inc114, label %for.inc118

for.inc114:                                       ; preds = %for.cond89
  %idxprom94 = sext i32 %.sink2 to i64
  %arrayidx95 = getelementptr inbounds [6 x i8], ptr %arrayidx80, i64 0, i64 %idxprom94
  %21 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  ...
  store i8 %21, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds [6 x i8], ptr %arrayidx84, i64 0, i64 %idxprom94
  %22 = load i8, ptr %arrayidx102, align 1, !tbaa !9
  store i8 %22, ptr %arrayidx95, align 1, !tbaa !9
  %23 = load i8, ptr %arrayidx98, align 1, !tbaa !9
  store i8 %23, ptr %arrayidx102, align 1, !tbaa !9
  %inc115 = add nsw i32 %.sink2, 1
...
for.body136:                                      ; preds = %for.cond134
  ...
  %26 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %conv140 = sext i8 %26 to i32
  %sub141 = sub nsw i32 %25, 1
  ...
  %27 = load i8, ptr %arrayidx144, align 2, !tbaa !9
  %conv145 = sext i8 %27 to i32
...
for.cond154:                                      ; preds = %for.inc204, %for.end153
  ...
  %sub155 = sub nsw i32 %30, 1
  %cmp156 = icmp slt i32 %29, %sub155
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  ...
  %31 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add158 = add nsw i32 %31, 1
  store i32 %add158, ptr %j, align 4, !tbaa !5
  %cmp160 = icmp slt i32 %add158, %30
...
for.body161:                                      ; preds = %for.cond159
  ...
  %32 = load i8, ptr %arrayidx164, align 1, !tbaa !9
  %conv165 = sext i8 %32 to i32
  %idxprom166 = sext i32 %29 to i64
  ...
  %33 = load i8, ptr %arrayidx168, align 1, !tbaa !9
...
for.inc197:                                       ; preds = %for.cond172
  ...
  %34 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  ...
  store i8 %34, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds [6 x i8], ptr %arrayidx167, i64 0, i64 %idxprom177
  %35 = load i8, ptr %arrayidx185, align 1, !tbaa !9
  store i8 %35, ptr %arrayidx178, align 1, !tbaa !9
  %36 = load i8, ptr %arrayidx181, align 1, !tbaa !9
  store i8 %36, ptr %arrayidx185, align 1, !tbaa !9
...
if.end226:                                        ; preds = %for.cond207, %if.then128
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %y) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %x) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %m) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %l) #9
