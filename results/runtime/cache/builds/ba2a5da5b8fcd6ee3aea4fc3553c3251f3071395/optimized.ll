...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull align 16 dereferenceable(25000) %word) #7
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv48 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next49, %for.inc14 ]
...
for.cond17.preheader:                             ; preds = %for.cond2
  %vtable.i9 = load ptr, ptr @_ZSt4cout, align 8
  %vbase.offset.ptr.i10 = getelementptr i8, ptr %vtable.i9, i64 -24
  br label %for.cond17

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv48
  store i32 0, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv48
  br label %while.cond

while.cond:                                       ; preds = %while.body, %for.body4
  %q.0 = phi ptr [ %arrayidx8, %for.body4 ], [ %incdec.ptr, %while.body ]
  %6 = load i8, ptr %q.0, align 1, !tbaa !33, !invariant.load !9
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc47
  %.pre63 = phi i32 [ %0, %for.cond17.preheader ], [ %.pre, %for.inc47 ]
  %indvars.iv52 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next53, %for.inc47 ]
  %s.0 = phi i32 [ 0, %for.cond17.preheader ], [ %add46, %for.inc47 ]
  %7 = sext i32 %.pre63 to i64
  %cmp18 = icmp slt i64 %indvars.iv52, %7
  br i1 %cmp18, label %for.body19, label %for.end49

for.body19:                                       ; preds = %for.cond17
  %cmp20 = icmp sgt i32 %s.0, 0
  %arrayidx22 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv52
...
land.lhs.true:                                    ; preds = %for.body19
  ...
  br i1 %cmp23, label %if.end35.thread60, label %if.then33

if.end35.thread60:                                ; preds = %land.lhs.true
...
if.then33:                                        ; preds = %land.lhs.true, %if.end
  ...
  %vbase.offset.i11 = load i64, ptr %vbase.offset.ptr.i10, align 8, !invariant.load !9
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i11
  %10 = load i64, ptr %gep, align 8, !tbaa !10, !invariant.load !9
  %cmp.not.i = icmp eq i64 %10, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.then33
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i, i64 noundef 1)
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread60
  %s.145.ph = phi i32 [ %s.0, %if.end35.thread60 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
  %arrayidx26 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv52
  %call.i.i3 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx26) #8
  %call1.i4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx26, i64 noundef %call.i.i3)
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc47

for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre63, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
  %s.145 = phi i32 [ %s.0, %if.end35 ], [ %s.145.ph, %for.inc47.sink.split ]
  %add45 = add i32 %8, 1
  %add46 = add i32 %add45, %s.145
...
if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !41, !invariant.load !9
