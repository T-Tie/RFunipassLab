...
for.cond14:                                       ; preds = %if.end58, %for.end9
  ...
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %if.end58 ], [ 1, %for.end9 ]
  %5 = sext i32 %4 to i64
...
if.else:                                          ; preds = %for.body16
  ...
  %str.3.str = select i1 %or.cond20, ptr @str.3, ptr @str
  br label %if.end58

if.end58:                                         ; preds = %if.else, %for.body16
  %str.3.sink = phi ptr [ @str.4, %for.body16 ], [ %str.3.str, %if.else ]
  %puts21 = call i32 @puts(ptr nonnull dereferenceable(1) %str.3.sink)
