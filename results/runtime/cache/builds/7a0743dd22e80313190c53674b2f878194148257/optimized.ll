...
entry:
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax17, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc12 ], [ 0, %entry ]
  %exitcond19 = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19, label %for.cond15, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv14
  %arrayidx = getelementptr inbounds nuw [501 x i8], ptr %s, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond29 = icmp eq i64 %indvars.iv25, %wide.trip.count18
  br i1 %exitcond29, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv25
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv25
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc39 ], [ %indvars.iv20, %for.body19 ]
...
for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv22
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond34 = icmp eq i64 %indvars.iv30, %wide.trip.count18
  br i1 %exitcond34, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv30
...
if.then57:                                        ; preds = %for.body53
  ...
  %7 = trunc nuw nsw i64 %indvars.iv30 to i32
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.011 = phi i32 [ %8, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.011)
  %smax38 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count39 = zext nneg i32 %smax38 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count39
  br i1 %exitcond40.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv35
