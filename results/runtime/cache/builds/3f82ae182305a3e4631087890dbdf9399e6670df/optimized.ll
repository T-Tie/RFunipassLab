; ModuleID = '<stdin>'
source_filename = "/tmp/tmpv3uxzy7t.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %num) #7
...
for.inc:                                          ; preds = %for.cond
  store i32 0, ptr @varieties, align 4, !tbaa !5
  ...
  call void @_Z6factorii(i32 noundef 2, i32 noundef %1) #8
  %2 = load i32, ptr @varieties, align 4, !tbaa !5
...
define dso_local void @_Z6factorii(i32 noundef %first, i32 noundef %num) local_unnamed_addr #3 {
entry:
  %cmp = icmp eq i32 %num, 1
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %0 = load i32, ptr @varieties, align 4, !tbaa !5
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @varieties, align 4, !tbaa !5
  br label %if.end5
...
for.cond:                                         ; preds = %for.inc, %if.else
  %i.0 = phi i32 [ %first, %if.else ], [ %inc4, %for.inc ]
...
if.then3:                                         ; preds = %for.body
  ...
  call void @_Z6factorii(i32 noundef %i.0, i32 noundef %div) #9
  br label %for.inc
...
if.end5:                                          ; preds = %for.cond, %if.then
  ret void
}
