...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc16 ], [ 1, %for.end ]
  %exitcond6 = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond6, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv3
