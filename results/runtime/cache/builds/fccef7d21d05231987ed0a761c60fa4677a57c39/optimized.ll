...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv9
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc15 ], [ %indvars.iv3, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv22.in = phi i32 [ %indvars.iv22, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv22 = add i32 %indvars.iv22.in, -1
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next17
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv19 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next20, %for.inc39 ]
  %exitcond26.not = icmp eq i64 %indvars.iv19, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv19
...
for.end41:                                        ; preds = %for.cond28
  %arrayidx23.le = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next17
