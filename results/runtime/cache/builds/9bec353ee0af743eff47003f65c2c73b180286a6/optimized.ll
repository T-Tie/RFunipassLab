...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100000, ptr nonnull %a) #9
  br label %for.cond
...
if.then6.i:                                       ; preds = %for.body
  ...
  %1 = load i64, ptr %gep20, align 8, !tbaa !8
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  %4 = load ptr, ptr @stdin, align 8, !tbaa !30
...
for.end:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #9
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 100000, ptr nonnull %a) #9
  ret i32 0
}
...
!36 = !{!37, !38, i64 16}
!37 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !38, i64 8, !38, i64 16, !38, i64 24, !38, i64 32, !38, i64 40, !38, i64 48, !19, i64 56}
