...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20000, ptr %words) #6
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef %arrayidx6) #7
  %add = add i64 %conv, 1
...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %j.1 = phi i32 [ %add16, %if.then ], [ %inc26, %for.inc25 ]
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %j.3 = phi i32 [ %add35, %if.then30 ], [ %inc45, %for.inc44 ]
...
for.end46:                                        ; preds = %for.cond36
  %call50 = call i64 @strlen(ptr noundef %arrayidx6) #7
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %j.4 = phi i32 [ %add62, %for.end57 ], [ %inc72, %for.inc71 ]
...
for.end73:                                        ; preds = %for.cond63
  call void @llvm.lifetime.end.p0(i64 20000, ptr %words) #6
