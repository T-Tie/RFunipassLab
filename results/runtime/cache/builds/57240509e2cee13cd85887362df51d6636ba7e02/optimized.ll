...
for.cond10:                                       ; preds = %for.inc43, %for.end9
  %1 = phi i32 [ %dec, %for.inc43 ], [ %sub, %for.end9 ]
  %cmp11 = icmp sge i32 %1, 0
...
for.cond13:                                       ; preds = %for.inc40, %for.body12
  %.sink = phi i32 [ %1, %for.body12 ], [ %add, %for.inc40 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %2 = load i32, ptr %arrayidx17, align 8, !tbaa !15, !invariant.load !16
  %idxprom19 = sext i32 %add to i64
  %arrayidx20 = getelementptr inbounds [50 x %struct.z], ptr %a, i64 0, i64 %idxprom19
  %3 = load i32, ptr %arrayidx20, align 8, !tbaa !15, !invariant.load !16
  %cmp22 = icmp sge i32 %2, %3
  br i1 %cmp22, label %if.then, label %for.inc40

if.then:                                          ; preds = %for.body15
  %h25 = getelementptr inbounds nuw %struct.z, ptr %arrayidx17, i32 0, i32 1
  %4 = load i32, ptr %h25, align 4, !tbaa !12, !invariant.load !16
  %h28 = getelementptr inbounds nuw %struct.z, ptr %arrayidx20, i32 0, i32 1
  %5 = load i32, ptr %h28, align 4, !tbaa !12, !invariant.load !16
  %add29 = add nsw i32 %5, 1
  %cmp30 = icmp slt i32 %4, %add29
...
for.cond45:                                       ; preds = %for.inc77, %for.end44
  %i.2 = phi i32 [ 0, %for.end44 ], [ %add49, %for.inc77 ]
  %sub46 = sub nsw i32 %0, 1
  %cmp47 = icmp slt i32 %i.2, %sub46
  br i1 %cmp47, label %for.body48, label %for.end79

for.body48:                                       ; preds = %for.cond45
  %add49 = add nsw i32 %i.2, 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %j.0 = phi i32 [ %add49, %for.body48 ], [ %inc75, %for.inc74 ]
  %cmp51 = icmp slt i32 %j.0, %0
...
for.body52:                                       ; preds = %for.cond50
  ...
  %6 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  ...
  %7 = load i32, ptr %h58, align 4, !tbaa !12, !invariant.load !16
  %cmp59 = icmp slt i32 %6, %7
  br i1 %cmp59, label %if.then60, label %for.inc74

if.then60:                                        ; preds = %for.body52
  store i32 %7, ptr %h55, align 4, !tbaa !12
  store i32 %6, ptr %h58, align 4, !tbaa !12
  br label %for.inc74

for.inc74:                                        ; preds = %for.body52, %if.then60
  %inc75 = add nsw i32 %j.0, 1
...
for.end79:                                        ; preds = %for.cond45
  ...
  %8 = load i32, ptr %h81, align 4, !tbaa !12
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %8) #5
