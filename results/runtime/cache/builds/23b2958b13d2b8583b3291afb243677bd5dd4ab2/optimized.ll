...
for.cond10:                                       ; preds = %for.inc17, %for.end9
  %5 = phi i32 [ %inc18, %for.inc17 ], [ 0, %for.end9 ]
  %cmp11 = icmp slt i32 %5, 31
...
land.end:                                         ; preds = %for.cond10
  ...
  %6 = load i8, ptr %arrayidx13, align 1, !tbaa !9, !invariant.load !10
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %7 = phi i32 [ %inc29, %for.inc28 ], [ %5, %for.end19 ]
  %cmp21 = icmp slt i32 %7, 31
  %sub31 = sub nsw i32 %7, %5
