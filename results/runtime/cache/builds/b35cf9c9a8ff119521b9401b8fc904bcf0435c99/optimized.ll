...
for.body:                                         ; preds = %for.cond
  %0 = load i32, ptr @a, align 16, !tbaa !5, !invariant.load !9
  br label %for.cond2
...
for.inc25:                                        ; preds = %for.cond17
  ...
  %arrayidx24 = getelementptr inbounds [101 x i32], ptr %arrayidx22, i64 0, i64 %idxprom23
...
for.body4:                                        ; preds = %for.cond1
  ...
  %arrayidx8 = getelementptr inbounds [101 x i32], ptr %arrayidx6, i64 0, i64 %idxprom7
...
for.end13:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %i) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %j14) #7
  store i32 2, ptr %j14, align 4, !tbaa !5
  br label %for.cond15

for.cond15:                                       ; preds = %for.end36, %for.end13
  %2 = load i32, ptr @n, align 4, !tbaa !5
  %cmp16 = icmp slt i32 2, %2
...
for.end36:                                        ; preds = %for.cond20
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j14) #8
  br label %for.cond15

for.end39:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %j14) #7
  ret void
}
...
for.inc17:                                        ; preds = %for.cond13
  call void @_Z7zerorowi(i32 noundef %.sink) #9
  %2 = load i32, ptr @k, align 4, !tbaa !5
  call void @_Z7zerocoli(i32 noundef %2) #9
  ...
  call void @_Z4jiani(i32 noundef %5) #9
