...
entry:
  ...
  %j26 = alloca i8, i32 0, align 4
  %n1 = alloca i32, align 4
  %n2 = alloca i32, align 4
  %j81 = alloca i32, align 4
  %j8127 = alloca i8, i32 0, align 4
...
if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %n1) #5
  store i32 0, ptr %n1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %n2) #5
  store i32 0, ptr %n2, align 4, !tbaa !5
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc, %if.then
  %3 = phi i32 [ %inc, %for.inc ], [ 1, %if.then ]
...
for.inc:                                          ; preds = %if.else, %lor.lhs.false13, %lor.lhs.false15, %lor.lhs.false17, %lor.lhs.false19, %lor.lhs.false21, %lor.lhs.false23, %for.body9, %if.else27
  %.sink14 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %lor.lhs.false23 ], [ 31, %lor.lhs.false21 ], [ 31, %lor.lhs.false19 ], [ 31, %lor.lhs.false17 ], [ 31, %lor.lhs.false15 ], [ 31, %lor.lhs.false13 ], [ 31, %if.else ]
  %5 = load i32, ptr %n1, align 4, !tbaa !5
  %add28 = add nsw i32 %5, %.sink14
...
for.cond30:                                       ; preds = %for.inc56, %for.end
  %6 = phi i32 [ %inc57, %for.inc56 ], [ 1, %for.end ]
...
for.inc56:                                        ; preds = %if.else36, %lor.lhs.false38, %lor.lhs.false40, %lor.lhs.false42, %lor.lhs.false44, %lor.lhs.false46, %lor.lhs.false48, %for.body32, %if.else52
  %.sink12 = phi i32 [ 30, %if.else52 ], [ 29, %for.body32 ], [ 31, %lor.lhs.false48 ], [ 31, %lor.lhs.false46 ], [ 31, %lor.lhs.false44 ], [ 31, %lor.lhs.false42 ], [ 31, %lor.lhs.false40 ], [ 31, %lor.lhs.false38 ], [ 31, %if.else36 ]
  %8 = load i32, ptr %n2, align 4, !tbaa !5
  %add53 = add nsw i32 %8, %.sink12
  store i32 %add53, ptr %n2, align 4, !tbaa !5
  %inc57 = add nsw i32 %6, 1
  br label %for.cond30, !llvm.loop !12

for.end58:                                        ; preds = %for.cond30
  %9 = load i32, ptr %n1, align 4, !tbaa !5
  %10 = load i32, ptr %n2, align 4, !tbaa !5
  %cmp59 = icmp slt i32 %9, %10
...
for.inc109:                                       ; preds = %if.else91, %lor.lhs.false93, %lor.lhs.false95, %lor.lhs.false97, %lor.lhs.false99, %lor.lhs.false101, %for.body87, %if.else105
  %.sink8 = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %lor.lhs.false101 ], [ 31, %lor.lhs.false99 ], [ 31, %lor.lhs.false97 ], [ 31, %lor.lhs.false95 ], [ 31, %lor.lhs.false93 ], [ 31, %if.else91 ]
  %13 = load i32, ptr %n182, align 4, !tbaa !5
  %add106 = add nsw i32 %13, %.sink8
  store i32 %add106, ptr %n182, align 4, !tbaa !5
  %inc110 = add nsw i32 %11, 1
...
if.then157:                                       ; preds = %if.then153
  %call158 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #5
  br label %if.end162

if.else159:                                       ; preds = %if.then153
  %call160 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #5
  br label %if.end162

if.end162:                                        ; preds = %if.then157, %if.else159, %if.end151
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n283) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n182) #5
  br label %for.inc164
