...
for.end87:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %total1.0.loc)
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %total1.0.loc) #6
  %total1.0.reload = load i32, ptr %total1.0.loc, align 4
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %total1.0.loc)
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %total2.0.loc)
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %total2.0.loc) #6
  %total2.0.reload = load i32, ptr %total2.0.loc, align 4
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %total2.0.loc)
...
for.inc:                                          ; preds = %if.end26, %if.end26.thread, %if.else, %if.then35
  %total1.3 = phi i32 [ %total1.1, %if.end26 ], [ %add25, %if.end26.thread ], [ %add36, %if.then35 ], [ %add37, %if.else ]
