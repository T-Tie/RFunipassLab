...
for.end33:                                        ; preds = %for.cond23
  ...
  call void @outlined_ir_func_0(ptr %add.ptr35)
  br label %for.inc42
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @outlined_ir_func_0(ptr %add.ptr58)
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !19, !invariant.load !13
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64)) local_unnamed_addr #7 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64)) local_unnamed_addr #7 align 2
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !30, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !31, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !30, !invariant.load !13
  br label %return
...
define internal void @outlined_ir_func_0(ptr %0) #11 {
newFuncRoot:
  br label %for.end33_to_outline

for.end33_to_outline:                             ; preds = %newFuncRoot
  ...
  br label %for.end33_after_outline.exitStub

for.end33_after_outline.exitStub:                 ; preds = %for.end33_to_outline
  ret void
}
...
!30 = !{!7, !7, i64 0}
!31 = !{!32, !7, i64 56}
!32 = !{!"_ZTSSt5ctypeIcE", !33, i64 0, !34, i64 16, !35, i64 24, !36, i64 32, !36, i64 40, !37, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!33 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!34 = !{!"p1 _ZTS15__locale_struct", !25, i64 0}
!35 = !{!"bool", !7, i64 0}
!36 = !{!"p1 int", !25, i64 0}
!37 = !{!"p1 short", !25, i64 0}
