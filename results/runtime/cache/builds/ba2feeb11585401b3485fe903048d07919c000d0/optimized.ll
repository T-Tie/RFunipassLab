...
for.cond:                                         ; preds = %for.inc35, %entry
  ...
  %exitcond9.not = icmp eq i64 %indvars.iv6, 1000
  br i1 %exitcond9.not, label %for.end37, label %for.cond1
...
for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond13.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond13.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv10
