...
if.then28:                                        ; preds = %for.body4, %if.then
  ...
  br i1 %or.cond2, label %for.inc.sink.split, label %if.else

if.else:                                          ; preds = %if.then28
  br label %for.inc.sink.split

for.inc.sink.split:                               ; preds = %if.then28, %if.then, %if.then, %if.then, %if.then, %for.body4, %for.body4, %for.body4, %for.body4, %if.else
  %.sink = phi i32 [ 28, %if.else ], [ 30, %for.body4 ], [ 30, %for.body4 ], [ 30, %for.body4 ], [ 30, %for.body4 ], [ 30, %if.then ], [ 30, %if.then ], [ 30, %if.then ], [ 30, %if.then ], [ 29, %if.then28 ]
  %add373.sink = phi i32 [ %add373, %if.else ], [ %add374, %for.body4 ], [ %add374, %for.body4 ], [ %add374, %for.body4 ], [ %add374, %for.body4 ], [ %add, %if.then ], [ %add, %if.then ], [ %add, %if.then ], [ %add, %if.then ], [ %add373, %if.then28 ]
  %add37 = add nsw i32 %add373.sink, %.sink
  store i32 %add37, ptr %2, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.inc.sink.split, %for.body4, %if.then
  %add375 = phi i32 [ %add374, %for.body4 ], [ %add, %if.then ], [ %add37, %for.inc.sink.split ]
