...
for.cond:                                         ; preds = %for.inc17, %entry
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc17 ], [ 0, %entry ]
  %exitcond51 = icmp eq i64 %indvars.iv46, %wide.trip.count50
  br i1 %exitcond51, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %smax60 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv46, i64 %indvars.iv
  store i8 %3, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc17:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv46, i64 %wide.trip.count
...
for.cond21:                                       ; preds = %for.cond21.loopexit, %for.cond21.preheader
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.cond21.loopexit ], [ 0, %for.cond21.preheader ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.cond21.loopexit ], [ 1, %for.cond21.preheader ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count61
  br i1 %exitcond62.not, label %for.cond51, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv57
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv57
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc44, %for.body25
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc44 ], [ %indvars.iv52, %for.body25 ]
  %4 = trunc nuw i64 %indvars.iv54 to i32
  %cmp30.not = icmp slt i32 %sub, %4
  br i1 %cmp30.not, label %for.cond21.loopexit, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv54
...
for.cond51:                                       ; preds = %for.cond21, %for.body55
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.body55 ], [ 0, %for.cond21 ]
  %max.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond21 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count61
  br i1 %exitcond67.not, label %for.end65, label %for.body55

for.body55:                                       ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv63
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc88 ], [ 0, %if.else ]
  %7 = load i32, ptr %n, align 4, !tbaa !5
  %sub74 = sub nsw i32 %conv, %7
  %8 = sext i32 %sub74 to i64
  %cmp75 = icmp slt i64 %indvars.iv68, %8
  br i1 %cmp75, label %for.body77, label %if.end91

for.body77:                                       ; preds = %for.cond73
  %arrayidx79 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv68
...
if.then81:                                        ; preds = %for.body77
  %arrayidx83 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv68
