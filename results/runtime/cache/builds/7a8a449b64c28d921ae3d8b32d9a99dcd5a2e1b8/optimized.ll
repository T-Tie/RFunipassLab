...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %len) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %first) #8
  store i32 0, ptr %first, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #8
  %call = call i64 @strlen(ptr nofree noundef readonly captures(none) %word) #9
...
for.end:                                          ; preds = %while.end, %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %first) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %len) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %count) #8
  ret void
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %number) #8
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %number) #11
  ret i32 0
}
