...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %an) #9
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(400) %an, ptr noundef nonnull readonly align 16 dereferenceable(400) @__const.main.an, i64 noundef 400, i1 noundef false) #10
...
if.then:                                          ; preds = %entry
  %ldexp = call double @ldexp(double noundef 1.000000e+00, i32 %0) #11
...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv23 = phi i32 [ %indvars.iv.next24, %for.cond29 ], [ 100, %for.cond ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv20
...
for.cond38.preheader:                             ; preds = %for.cond29
  %3 = zext i32 %indvars.iv23 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc45
  %indvars.iv25 = phi i64 [ %3, %for.cond38.preheader ], [ %5, %for.inc45 ]
  %4 = trunc nuw i64 %indvars.iv25 to i32
...
if.end49:                                         ; preds = %for.cond38, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %an) #12
