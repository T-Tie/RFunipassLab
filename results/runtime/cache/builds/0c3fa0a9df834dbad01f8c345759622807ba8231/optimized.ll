...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax33 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax34 = call i32 @llvm.smax.i32(i32 %smax33, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax40 = call i32 @llvm.smax.i32(i32 %9, i32 0)
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv84 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax75 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond77.not, label %if.end178, label %for.inc148
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax81 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
