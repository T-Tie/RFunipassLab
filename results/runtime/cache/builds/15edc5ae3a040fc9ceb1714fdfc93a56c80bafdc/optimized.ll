...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv130 = phi i64 [ %indvars.iv.next131, %for.end114 ], [ %2, %entry ]
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %3 = trunc nuw i64 %indvars.iv128 to i32
  %smax125 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv130, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv130 to i32
  %smax109 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count88 = zext nneg i32 %smax109 to i64
  %wide.trip.count = and i64 %indvars.iv130, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv85 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next86, %for.inc28 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count88
  br i1 %exitcond89.not, label %for.cond31.preheader, label %for.cond2

for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count93 = and i64 %indvars.iv130, 4294967295
  br label %for.cond31
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv85, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv80 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next81, %for.inc25 ]
  %exitcond84.not = icmp eq i64 %indvars.iv80, %wide.trip.count
  br i1 %exitcond84.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv85, i64 %indvars.iv80
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv100 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next101, %for.inc66 ]
  %exitcond105.not = icmp eq i64 %indvars.iv100, %wide.trip.count88
  br i1 %exitcond105.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select78, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond94.not = icmp eq i64 %indvars.iv90, %wide.trip.count93
  br i1 %exitcond94.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv90, i64 %indvars.iv100
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %spec.select78 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next91 = add nuw nsw i64 %indvars.iv90, 1
  br label %for.cond34, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv95 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next96, %for.inc63 ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %wide.trip.count93
  br i1 %exitcond99.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv95, i64 %indvars.iv100
...
for.cond71:                                       ; preds = %for.cond75, %for.end68
  %indvars.iv112 = phi i64 [ 1, %for.end68 ], [ %indvars.iv.next113, %for.cond75 ]
  %cmp73 = icmp slt i64 %indvars.iv112, %indvars.iv.next131
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc86
  %indvars.iv106 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next107, %for.inc86 ]
  %exitcond111.not = icmp eq i64 %indvars.iv106, %wide.trip.count88
  br i1 %exitcond111.not, label %for.cond71, label %for.inc86, !llvm.loop !17

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv.next113, i64 %indvars.iv106
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv112, i64 %indvars.iv106
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv122 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next123, %for.inc112 ]
  %exitcond127.not = icmp eq i64 %indvars.iv122, %wide.trip.count126
  br i1 %exitcond127.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond121.not = icmp eq i64 %indvars.iv115, %indvars.iv128
  br i1 %exitcond121.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next116 = add nuw nsw i64 %indvars.iv115, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv122, i64 %indvars.iv.next116
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !19
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv122, i64 %indvars.iv115
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv20, %2
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [120 x [120 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv
