...
if.then:                                          ; preds = %land.lhs.true
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(5) @.str)
  br label %for.inc
...
if.else17:                                        ; preds = %if.else
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(7) @.str.2)
  br label %for.inc
