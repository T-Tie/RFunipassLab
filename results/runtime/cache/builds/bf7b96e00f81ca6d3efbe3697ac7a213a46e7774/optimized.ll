...
while.cond9:                                      ; preds = %while.cond9.preheader, %if.end34
  %9 = phi i32 [ %7, %while.cond9.preheader ], [ %.pre24, %if.end34 ]
  %10 = phi i32 [ %.pre, %while.cond9.preheader ], [ %12, %if.end34 ]
  %indvars.iv21 = phi i64 [ %8, %while.cond9.preheader ], [ %indvars.iv.next22, %if.end34 ]
  %num.1 = phi i32 [ %num.0, %while.cond9.preheader ], [ %num.2, %if.end34 ]
  %add = add nsw i32 %10, %num.1
  %cmp12 = icmp slt i32 %add, 81
  %11 = sext i32 %9 to i64
  %cmp17.not = icmp slt i64 %indvars.iv21, %11
  %or.cond19 = select i1 %cmp12, i1 %cmp17.not, i1 false
  br i1 %or.cond19, label %if.end19, label %while.body.loopexit

if.end19:                                         ; preds = %while.cond9
  %arrayidx15 = getelementptr inbounds [1000 x [41 x i8]], ptr %ch, i64 0, i64 %indvars.iv21
  ...
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %len, i64 0, i64 %indvars.iv.next22
  %12 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !11
  %add27 = add nsw i32 %12, %add
  %cmp28 = icmp slt i32 %add27, 80
  %13 = load i32, ptr %n, align 4
  %14 = sext i32 %13 to i64
  %cmp29 = icmp slt i64 %indvars.iv.next22, %14
...
if.else:                                          ; preds = %if.end19
  %vtable.i11 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i12 = getelementptr i8, ptr %vtable.i11, i64 -24
  %vbase.offset.i13 = load i64, ptr %vbase.offset.ptr.i12, align 8, !invariant.load !11
