...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %s) #6
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %u) #6
  br label %for.cond
...
if.end44:                                         ; preds = %if.then42, %for.end40
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %u) #6
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %s) #6
  ret i32 0
}
