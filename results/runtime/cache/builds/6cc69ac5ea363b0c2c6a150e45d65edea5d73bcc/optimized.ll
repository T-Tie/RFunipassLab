...
for.cond15.preheader:                             ; preds = %for.body9
  %smax = call i32 @llvm.smax.i32(i32 noundef %i.1, i32 %dec4)
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx42 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv16
  %13 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %13)
