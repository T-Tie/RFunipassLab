...
if.else:                                          ; preds = %for.end123
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %l.0, i32 1)
  %17 = add nsw i32 %smax44, -1
  %wide.trip.count46 = zext nneg i32 %smax44 to i64
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  ...
  %18 = trunc nuw nsw i64 %indvars.iv40 to i32
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  ...
  %cmp212 = icmp slt i64 %indvars.iv60, %28
