...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull %letter) #9
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %letter, i64 noundef 40)
...
if.then9:                                         ; preds = %if.end
  ...
  %gep30 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i3
  %5 = load i64, ptr %gep30, align 8, !tbaa !12, !invariant.load !11
...
for.inc:                                          ; preds = %if.end, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end.thread
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #11
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %letter, i64 noundef %call.i.i)
