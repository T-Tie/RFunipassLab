...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %t) #9
...
if.then.i.i:                                      ; preds = %for.end
  ...
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull align 16 dereferenceable(2000) %a, ptr noundef nonnull %add.ptr5, i64 noundef -2)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end, %if.then.i.i
  ...
  %smax = call i32 @llvm.smax.i32(i32 %num.0, i32 0)
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond9, !llvm.loop !12

for.end18:                                        ; preds = %for.cond9
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %a) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %t) #10
...
define linkonce_odr dso_local void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef %__first, ptr noundef %__last, i64 noundef %__depth_limit) #3 comdat {
entry:
...
if.then:                                          ; preds = %while.body
  ...
  tail call void @_ZSt13__heap_selectIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef %__last)
  call void @_ZSt11__sort_heapIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_RT0_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 1 dereferenceable(1) %__comp.i)
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__comp.i)
  br label %while.end

if.end:                                           ; preds = %while.body
  %div.i2 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i2
  %add.ptr2.i = getelementptr inbounds i8, ptr %__last.addr.0, i64 -4
  tail call void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef nonnull align 4 %__first, ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull align 4 %add.ptr.i, ptr noundef nonnull %add.ptr2.i)
  %call.i = tail call noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull %__last.addr.0, ptr noundef nonnull align 4 %__first) #10
  tail call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef %call.i, ptr noundef nonnull %__last.addr.0, i64 noundef %dec)
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__final_insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef %__first, ptr noundef %__last) #3 comdat {
entry:
...
while.cond.i.i:                                   ; preds = %while.body.i.i, %for.inc.i
  %__last.addr.0.i.i = phi ptr [ %__i.0.i, %for.inc.i ], [ %incdec.ptr.i.i, %while.body.i.i ]
  %incdec.ptr.i.i = getelementptr inbounds i8, ptr %__last.addr.0.i.i, i64 -4
  %1 = load i32, ptr %incdec.ptr.i.i, align 4, !tbaa !5
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt13__heap_selectIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_T0_(ptr noundef %__first, ptr noundef %__middle, ptr noundef %__last) #3 comdat {
entry:
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt11__sort_heapIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_RT0_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 1 dereferenceable(1) %__comp) #3 comdat {
entry:
  %sub.ptr.rhs.cast = ptrtoint ptr %__first to i64
  br label %while.cond
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt11__make_heapIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_RT0_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 1 dereferenceable(1) %__comp) #3 comdat {
entry:
  %sub.ptr.lhs.cast = ptrtoint ptr %__last to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %__first to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
if.end:                                           ; preds = %entry
  ...
  %div45 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %0 = phi i64 [ %div45, %if.end ], [ %dec, %while.body ]
  %add.ptr = getelementptr inbounds i32, ptr %__first, i64 %0
  %1 = load i32, ptr %add.ptr, align 4, !tbaa !5
  tail call void @_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_(ptr noundef nonnull %__first, i64 noundef %0, i64 noundef %sub.ptr.div, i32 noundef %1)
  %cmp5 = icmp eq i64 %0, 0
  %dec = add nsw i64 %0, -1
  br i1 %cmp5, label %return, label %while.body, !llvm.loop !18
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_(ptr noundef %__first, i64 noundef %__holeIndex, i64 noundef %__len, i32 noundef %__value) #3 comdat {
entry:
...
if.then9:                                         ; preds = %land.lhs.true
  ...
  %3 = load i32, ptr %add.ptr13, align 4, !tbaa !5, !invariant.load !20
...
if.end16:                                         ; preds = %if.then9, %land.lhs.true, %while.end
  ...
  %cmp.old.i = icmp sgt i64 %__holeIndex.addr.1, %__holeIndex
  br i1 %cmp.old.i, label %land.end.preheader.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit

land.end.preheader.i:                             ; preds = %if.end16
  %sub.i = add nsw i64 %__holeIndex.addr.1, -1
  %div.i = sdiv i64 %sub.i, 2
  %add.ptr.i = getelementptr inbounds i32, ptr %__first, i64 %div.i
  %4 = load i32, ptr %add.ptr.i, align 4, !tbaa !5
  %cmp.i.i = icmp sge i32 %4, %__value
  tail call void @llvm.assume(i1 %cmp.i.i)
  br label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit

_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit: ; preds = %if.end16, %land.end.preheader.i
  %add.ptr5.i = getelementptr inbounds i32, ptr %__first, i64 %__holeIndex.addr.1
  store i32 %__value, ptr %add.ptr5.i, align 4, !tbaa !5
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef %__c) #3 comdat {
entry:
...
if.then:                                          ; preds = %entry
  %cmp.i6 = icmp slt i32 %1, %2
  br i1 %cmp.i6, label %if.end16, label %if.else

if.else:                                          ; preds = %if.then
  %cmp.i7 = icmp slt i32 %0, %2
  %3 = call i32 @llvm.smax.i32(i32 %0, i32 %2)
  %spec.select = select i1 %cmp.i7, ptr %__c, ptr %__a
  br label %if.end16

if.else7:                                         ; preds = %entry
  %cmp.i8 = icmp slt i32 %0, %2
  br i1 %cmp.i8, label %if.end16, label %if.else10

if.else10:                                        ; preds = %if.else7
  %cmp.i9 = icmp slt i32 %1, %2
  %4 = call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %spec.select10 = select i1 %cmp.i9, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.then, %if.else10, %if.else, %if.else7
  %5 = phi i32 [ %0, %if.else7 ], [ %3, %if.else ], [ %4, %if.else10 ], [ %1, %if.then ]
  %__b.addr.sink.sink.sink.sroa.speculated = phi ptr [ %__a, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select10, %if.else10 ], [ %__b, %if.then ]
  %6 = load i32, ptr %__result, align 4, !tbaa !5
  store i32 %5, ptr %__result, align 4, !tbaa !5
  store i32 %6, ptr %__b.addr.sink.sink.sink.sroa.speculated, align 4, !tbaa !5
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef align 4 %__pivot) #4 comdat {
entry:
  br label %while.body
...
while.cond1:                                      ; preds = %while.cond1, %while.body
  ...
  br i1 %cmp.i, label %while.cond1, label %while.cond4.preheader, !llvm.loop !21

while.cond4.preheader:                            ; preds = %while.cond1
  br label %while.cond4

while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  %__last.addr.1 = phi ptr [ %incdec.ptr3, %while.cond4 ], [ %__last.addr.0, %while.cond4.preheader ]
  %incdec.ptr3 = getelementptr inbounds i8, ptr %__last.addr.1, i64 -4
  %2 = load i32, ptr %incdec.ptr3, align 4, !tbaa !5
  %cmp.i1 = icmp slt i32 %0, %2
  br i1 %cmp.i1, label %while.cond4, label %while.end8, !llvm.loop !22
...
if.end:                                           ; preds = %while.end8
  ...
  store i32 %1, ptr %incdec.ptr3, align 4, !tbaa !5
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt16__insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef %__first, ptr noundef %__last) #3 comdat {
entry:
...
if.then2:                                         ; preds = %for.body
  ...
  %call.i.i.i.i = tail call noundef ptr @_ZNSt20__copy_move_backwardILb1ELb1ESt26random_access_iterator_tagE13__copy_move_bIiiEEPT0_PT_S6_S4_(ptr noundef nonnull align 4 %__first, ptr noundef nonnull align 4 dereferenceable(4) %__i.0, ptr noundef nonnull %add.ptr3)
  br label %for.inc

while.cond.i:                                     ; preds = %for.body, %while.body.i
  %__last.addr.0.i = phi ptr [ %incdec.ptr.i, %while.body.i ], [ %__i.0, %for.body ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %__last.addr.0.i, i64 -4
  %2 = load i32, ptr %incdec.ptr.i, align 4, !tbaa !5
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local noundef ptr @_ZNSt20__copy_move_backwardILb1ELb1ESt26random_access_iterator_tagE13__copy_move_bIiiEEPT0_PT_S6_S4_(ptr noundef %__first, ptr noundef %__last, ptr noundef %__result) #3 comdat align 2 {
entry:
  %sub.ptr.lhs.cast = ptrtoint ptr %__last to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %__first to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
