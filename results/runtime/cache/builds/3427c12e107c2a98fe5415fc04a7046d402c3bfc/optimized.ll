...
for.cond1:                                        ; preds = %for.cond, %if.end13
  %1 = phi i32 [ %.pre, %if.end13 ], [ %0, %for.cond ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %if.end13 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %4) #7
  %5 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %5) #7
  %sub = sub nsw i32 %call5, %call6
  %spec.select = call i32 @llvm.abs.i32(i32 %sub, i1 noundef true)
  %rem12 = urem i32 %spec.select, 7
  %cmp9 = icmp eq i32 %rem12, 0
  br i1 %cmp9, label %if.then10, label %if.end13

if.then10:                                        ; preds = %for.body3
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv15
  store i32 1, ptr %arrayidx12, align 4, !tbaa !5
  br label %if.end13

if.end13:                                         ; preds = %if.then10, %for.body3
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond1, !llvm.loop !12

for.cond17:                                       ; preds = %for.cond1, %for.body19
  %6 = phi i32 [ %.pre21, %for.body19 ], [ %1, %for.cond1 ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body19 ], [ 0, %for.cond1 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv18, %7
  br i1 %cmp18, label %for.body19, label %for.end29

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv18
  %8 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !13
...
entry:
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %mon, i32 noundef 1)
  %brmerge = or i1 %cmp25, %or.cond
  br label %for.cond

for.cond:                                         ; preds = %if.end37, %entry
  %result.0 = phi i32 [ 0, %entry ], [ %result.1, %if.end37 ]
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end37 ]
  %exitcond.not = icmp eq i32 %i.0, %smax
  br i1 %exitcond.not, label %for.end, label %for.body

for.body:                                         ; preds = %for.cond
  %Pivot40 = icmp samesign ult i32 %i.0, 6
  br i1 %Pivot40, label %NodeBlock25, label %NodeBlock37

NodeBlock37:                                      ; preds = %for.body
  %Pivot38 = icmp samesign ult i32 %i.0, 10
  br i1 %Pivot38, label %NodeBlock, label %NodeBlock35

NodeBlock35:                                      ; preds = %NodeBlock37
  %Pivot36 = icmp eq i32 %i.0, 10
  br i1 %Pivot36, label %if.then, label %NodeBlock33

NodeBlock33:                                      ; preds = %NodeBlock35
  %Pivot34 = icmp samesign ult i32 %i.0, 12
  br i1 %Pivot34, label %if.then20, label %LeafBlock31

LeafBlock31:                                      ; preds = %NodeBlock33
  %SwitchLeaf32 = icmp eq i32 %i.0, 12
  br i1 %SwitchLeaf32, label %if.then, label %if.end37
...
NodeBlock25:                                      ; preds = %for.body
  %Pivot26 = icmp samesign ult i32 %i.0, 3
  br i1 %Pivot26, label %NodeBlock60, label %NodeBlock56

NodeBlock56:                                      ; preds = %NodeBlock25
  %Pivot57 = icmp slt i32 %i.0, 5
  br i1 %Pivot57, label %LeafBlock54, label %if.then

LeafBlock54:                                      ; preds = %NodeBlock56
  %SwitchLeaf55 = icmp eq i32 %i.0, 3
  br i1 %SwitchLeaf55, label %if.then, label %if.then20

NodeBlock60:                                      ; preds = %NodeBlock25
  %Pivot61 = icmp slt i32 %i.0, 2
  br i1 %Pivot61, label %LeafBlock58, label %if.then24

LeafBlock58:                                      ; preds = %NodeBlock60
  %SwitchLeaf59 = icmp eq i32 %i.0, 1
  br i1 %SwitchLeaf59, label %if.then, label %if.end37

if.then:                                          ; preds = %LeafBlock58, %NodeBlock56, %LeafBlock54, %LeafBlock, %NodeBlock35, %LeafBlock31
  %add = add nsw i32 %result.0, 31
  br label %if.end37

if.then20:                                        ; preds = %LeafBlock54, %NodeBlock, %LeafBlock, %NodeBlock33
  %add21 = add nsw i32 %result.0, 30
  br label %if.end37

if.then24:                                        ; preds = %NodeBlock60
...
if.end37:                                         ; preds = %LeafBlock58, %LeafBlock31, %if.then20, %if.then31, %if.else33, %if.then
  %result.1 = phi i32 [ %add, %if.then ], [ %add21, %if.then20 ], [ %add32, %if.then31 ], [ %add34, %if.else33 ], [ %result.0, %LeafBlock31 ], [ %result.0, %LeafBlock58 ]
