...
for.inc74.gvnsink.split:                          ; preds = %if.then44, %if.else58, %if.then
  %add.sink1.sink2 = phi i32 [ %conv, %if.then ], [ %add, %if.else58 ], [ %conv, %if.then44 ]
  %arrayidx60.sink.sink = phi ptr [ %arrayidx20, %if.then ], [ %arrayidx60, %if.else58 ], [ %arrayidx46, %if.then44 ]
  %add.sink1.sink = phi i32 [ %conv, %if.then ], [ %add, %if.else58 ], [ %conv, %if.then44 ]
  %k.1.ph = phi i32 [ %inc18, %if.then ], [ %k.0, %if.else58 ], [ %k.0, %if.then44 ]
  %idxprom69 = sext i32 %add.sink1.sink2 to i64
  %arrayidx70 = getelementptr inbounds [81 x i8], ptr %arrayidx60.sink.sink, i64 0, i64 %idxprom69
  store i8 32, ptr %arrayidx70, align 1, !tbaa !12
  %inc71 = add nsw i32 %add.sink1.sink, 1
  br label %for.inc74
...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  %j.4 = phi i32 [ 0, %for.body88 ], [ %inc114, %for.inc113 ]
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !17, !invariant.load !14
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !14
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !17, !invariant.load !14
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !14
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !30, !invariant.load !14
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !38, !invariant.load !14
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !39, !invariant.load !14
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !42, !invariant.load !14
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !43, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !44, !invariant.load !14
