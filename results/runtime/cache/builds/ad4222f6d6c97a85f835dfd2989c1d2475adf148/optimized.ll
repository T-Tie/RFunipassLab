...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull dereferenceable(100) %add.ptr, i1 false, i1 true, i1 false)
...
do.end.i:                                         ; preds = %for.body
  ...
  store i64 0, ptr %_M_width.i.i, align 8, !tbaa !9
...
if.then6.i:                                       ; preds = %for.body
  ...
  %1 = load i64, ptr %gep, align 8, !tbaa !9
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull dereferenceable(100) %add.ptr, i64 noundef %0)
...
if.else34.i:                                      ; preds = %for.body
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull dereferenceable(100) %add.ptr, i64 noundef 9223372036854775807)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
for.end:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(100000) %a) #9
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(100000) %a, i64 noundef %call.i.i)
  %5 = add nuw i64 %indvars.iv, 1
  %wide.trip.count = and i64 %5, 4294967295
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc16 ], [ 1, %for.end ]
  %exitcond22 = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond22, label %for.end18, label %for.inc16

for.inc16:                                        ; preds = %for.cond7
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv19
  %call.i.i12 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr13) #9
  %call1.i13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr13, i64 noundef %call.i.i12)
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond7, !llvm.loop !36

for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef nonnull captures(none) %a) #9
  ret i32 0
}
...
entry:
  %0 = load ptr, ptr @stdin, align 8, !tbaa !31
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !37
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !40
...
!37 = !{!38, !39, i64 16}
!38 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !39, i64 8, !39, i64 16, !39, i64 24, !39, i64 32, !39, i64 40, !39, i64 48, !20, i64 56}
