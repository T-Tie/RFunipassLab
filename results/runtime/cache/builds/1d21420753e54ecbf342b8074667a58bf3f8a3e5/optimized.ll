...
while.cond:                                       ; preds = %while.body, %entry
  %.pr7 = phi i32 [ %sub, %while.body ], [ %.pr, %entry ]
...
while.cond1:                                      ; preds = %while.body4, %while.end
  %.pr8 = phi i32 [ %0, %while.body4 ], [ %.pr7, %while.end ]
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %.pr9 = phi i32 [ %1, %while.body13 ], [ %.pr8, %while.end7 ]
  %c.0 = phi i32 [ %inc14, %while.body13 ], [ 0, %while.end7 ]
  %1 = add i32 %.pr9, -20
  %or.cond14 = icmp ult i32 %1, 30
  br i1 %or.cond14, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %.pr10 = phi i32 [ %2, %while.body22 ], [ %.pr9, %while.end16 ]
  %d.0 = phi i32 [ %inc23, %while.body22 ], [ 0, %while.end16 ]
  %2 = add i32 %.pr10, -10
  %or.cond15 = icmp ult i32 %2, 10
  br i1 %or.cond15, label %while.body22, label %while.end25
...
land.end30:                                       ; preds = %while.end25, %while.body31
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr10, %while.end25 ]
