...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit40:
...
entry_to_outline:
  ...
  %call16.i = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i) #12
  %2 = add i64 %1, -1001
  %or.cond.i = icmp ult i64 %2, -1000
  %or.cond = select i1 %call16.i, i1 %or.cond.i, i1 false
  br i1 %or.cond, label %if.then19.i, label %if.then6.i9.exitStub
...
if.then19.i:                                      ; preds = %entry_to_outline
  ...
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i) #12
...
if.then6.i9.exitStub:                             ; preds = %if.then28.i, %if.then19.i, %entry_to_outline
  ret void
}
