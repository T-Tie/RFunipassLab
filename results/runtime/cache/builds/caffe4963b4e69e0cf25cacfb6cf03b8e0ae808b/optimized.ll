...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2004, ptr nonnull %a) #4
  call void @llvm.lifetime.start.p0(i64 2004, ptr nonnull %b) #4
...
for.end47:                                        ; preds = %for.cond39
  ...
  call void @llvm.lifetime.end.p0(i64 2004, ptr nonnull %b) #4
  call void @llvm.lifetime.end.p0(i64 2004, ptr nonnull %a) #4
