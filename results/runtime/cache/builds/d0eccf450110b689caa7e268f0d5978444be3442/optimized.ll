...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %sum) #3
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %.pre15 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
  br i1 %cmp, label %land.lhs.true, label %for.cond.for.inc_crit_edge

for.cond.for.inc_crit_edge:                       ; preds = %for.cond
  %.pre18 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  br label %for.inc
...
land.lhs.true:                                    ; preds = %for.cond
  ...
  %.pre19 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  br i1 %or.cond, label %land.lhs.true20, label %for.inc

land.lhs.true20:                                  ; preds = %land.lhs.true
  %cmp23 = icmp eq i32 %.pre19, 0
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %3 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ %.pre19, %land.lhs.true20 ], [ %.pre19, %land.lhs.true ], [ %.pre18, %for.cond.for.inc_crit_edge ]
  %4 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre15, %land.lhs.true ], [ %.pre15, %for.cond.for.inc_crit_edge ]
  ...
  %reass.add4 = sub i32 %3, %0
  %reass.mul5 = mul i32 %reass.add4, 3600
  %reass.sub20 = sub i32 %reass.mul5, %4
  %add51 = add i32 %reass.sub20, 43200
...
for.end63:                                        ; preds = %for.cond56
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %sum) #4
