...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv113, %2
...
for.cond13.preheader:                             ; preds = %for.cond1
  ...
  %wide.trip.count136 = zext i32 %1 to i64
  br label %for.cond13
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv113, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv159 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next160, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond164.not = icmp eq i64 %indvars.iv159, %wide.trip.count163
  br i1 %exitcond164.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond131.not = icmp eq i64 %indvars.iv126, %wide.trip.count130
  br i1 %exitcond131.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv126
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.body24 ], [ 0, %for.body18 ]
  %min.0 = phi i32 [ %min.1, %for.body24 ], [ %6, %for.body18 ]
  %exitcond.not = icmp eq i64 %indvars.iv116, %wide.trip.count
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv126, i64 %indvars.iv116
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp34111 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp34111, i32 %min.0, i32 %8
  %indvars.iv.next117 = add nuw nsw i64 %indvars.iv116, 1
  br label %for.cond22, !llvm.loop !13

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv120 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next121, %for.inc57 ]
  %exitcond125.not = icmp eq i64 %indvars.iv120, %wide.trip.count
  br i1 %exitcond125.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv126, i64 %indvars.iv120
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv144 = phi i64 [ %indvars.iv.next145, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond148.not = icmp eq i64 %indvars.iv144, %wide.trip.count130
  br i1 %exitcond148.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv144
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv132 = phi i64 [ %indvars.iv.next133, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond137.not = icmp eq i64 %indvars.iv132, %wide.trip.count136
  br i1 %exitcond137.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv132, i64 %indvars.iv144
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp82110 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp82110, i32 %min.2, i32 %12
  %indvars.iv.next133 = add nuw nsw i64 %indvars.iv132, 1
  br label %for.cond69, !llvm.loop !16

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  %indvars.iv138 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next139, %for.inc107 ]
  %exitcond143.not = icmp eq i64 %indvars.iv138, %wide.trip.count136
  br i1 %exitcond143.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv138, i64 %indvars.iv144
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv159, i64 %indvars.iv159
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !19
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv149 = phi i64 [ %indvars.iv.next150, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond153.not = icmp eq i64 %indvars.iv149, %wide.trip.count130
  br i1 %exitcond153.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv149, i64 %indvars.iv159
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv154 = phi i64 [ %indvars.iv.next155, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond158.not = icmp eq i64 %indvars.iv154, %wide.trip.count130
  br i1 %exitcond158.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv159, i64 %indvars.iv154
