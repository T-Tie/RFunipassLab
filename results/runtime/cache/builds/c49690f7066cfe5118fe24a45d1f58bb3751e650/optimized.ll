...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1600, ptr %a) #5
...
if.then34:                                        ; preds = %if.else
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.1)
...
if.else37:                                        ; preds = %if.else
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.2)
...
for.end43:                                        ; preds = %for.cond18
  ...
  call void @llvm.lifetime.end.p0(i64 1600, ptr %a) #5
