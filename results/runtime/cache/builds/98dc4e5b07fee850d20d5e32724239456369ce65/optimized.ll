...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %word) #6
...
if.else.i:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %while.body
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx3) #7
...
if.end10:                                         ; preds = %if.else.i
  ...
  %call14 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx12) #8
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull %word) #7
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 25000, ptr noundef nonnull %word) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %number) #7
  ret i32 0
}
