...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  br i1 %exitcond33.not, label %for.end22, label %for.cond8.preheader

for.cond8.preheader:                              ; preds = %for.cond
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc ], [ 0, %for.cond8.preheader ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc ], [ %indvars.iv, %for.cond8.preheader ]
...
for.cond25:                                       ; preds = %for.inc32, %if.then24
  ...
  br i1 %exitcond43.not, label %if.end36.loopexit, label %for.inc32
