...
for.end32:
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %call2.loc)
  call void @outlined_ir_func_0(ptr nonnull %x1, ptr nonnull %y1, ptr nonnull %call2.loc)
  %call2.reload = load ptr, ptr %call2.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %call2.loc)
  %call11 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %x2, ptr noundef nonnull %y2)
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %call15.loc)
  call void @outlined_ir_func_0(ptr nonnull %x2, ptr nonnull %y2, ptr nonnull %call15.loc)
  %call15.reload = load ptr, ptr %call15.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %call15.loc)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %8 = mul nsw i64 %indvars.iv19, %6
  %9 = mul nsw i64 %indvars.iv19, %7
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %10, i64 %indvars.iv12
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15.reload, i64 %indvars.iv12
  br label %for.cond47
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %18 = phi i32 [ %.pre27, %for.inc95 ], [ %16, %for.cond77 ]
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %21 = phi i32 [ %.pre28, %if.then ], [ %20, %for.body82 ]
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre27 = phi i32 [ %21, %if.end ], [ %.pre27.pre, %if.then92 ]
...
define internal void @outlined_ir_func_0(ptr readonly captures(none) %0, ptr readonly captures(none) %1, ptr writeonly captures(none) %2) #4 {
entry_to_outline:
