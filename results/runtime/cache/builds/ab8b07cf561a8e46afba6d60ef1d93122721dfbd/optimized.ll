...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %an) #8
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call double @pow(double noundef 2.000000e+00, double noundef %conv) #8, !tbaa !5
...
if.end49:                                         ; preds = %for.end47, %if.then
  call void @llvm.lifetime.end.p0(i64 400, ptr %an) #8
