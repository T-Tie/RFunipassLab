...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 101, ptr noundef nonnull align 16 captures(none) dereferenceable(101) %a) #9
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(101) %a, i64 noundef 100)
  call void @llvm.lifetime.start.p0(i64 noundef 15000, ptr noundef %b) #10
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call2 = call i64 @strlen(ptr noundef %a) #11
...
if.end:                                           ; preds = %for.body
  ...
  %add11 = add nsw i32 %j.0, 1
  br label %for.inc

for.inc:                                          ; preds = %if.end, %if.then
  %sum.1 = phi i32 [ %add, %if.then ], [ %sum.0, %if.end ]
  %j.1 = phi i32 [ 0, %if.then ], [ %add11, %if.end ]
...
for.end:                                          ; preds = %for.cond
  ...
  %sub = sub nsw i32 %sum.0, 1
  br label %for.cond16

for.cond16:                                       ; preds = %for.inc24, %for.end
  %i.1 = phi i32 [ %sub, %for.end ], [ %dec, %for.inc24 ]
  %cmp17 = icmp sge i32 %i.1, 0
  br i1 %cmp17, label %for.inc24, label %for.end25

for.inc24:                                        ; preds = %for.cond16
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(2) @.str)
  %idxprom20 = sext i32 %i.1 to i64
  %arrayidx21 = getelementptr inbounds [100 x [150 x i8]], ptr %b, i64 0, i64 %idxprom20
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call19, ptr noundef nonnull %arrayidx21)
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 15000, ptr noundef %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 101, ptr noundef captures(none) %a) #10
  ret i32 0
}
...
entry:
  %vtable = load ptr, ptr %this, align 8, !tbaa !13, !invariant.load !8
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !13, !invariant.load !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !13, !invariant.load !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !15, !invariant.load !8
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !34, !invariant.load !8
...
; Function Attrs: mustprogress uwtable
define available_externally void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %this, i32 noundef %__state) local_unnamed_addr #2 align 2 {
entry:
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !40, !invariant.load !8
  ret i32 %0
}
...
!15 = !{!16, !31, i64 240}
!16 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !17, i64 0, !28, i64 216, !6, i64 224, !29, i64 225, !30, i64 232, !31, i64 240, !32, i64 248, !33, i64 256}
