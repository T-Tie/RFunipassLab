...
entry:
  ...
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, i32 noundef %m, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %sum) #8
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %b) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %a) #7
...
for.end12:                                        ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %a) #8
...
define internal void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, i32 noundef %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2) #6 {
if.then_to_outline:
  %.promoted = load i32, ptr %0, align 4, !tbaa !5
  %.promoted2 = load i32, ptr %2, align 1
  br label %for.cond
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %1, %inc1
  %call = tail call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %inc1) #9
  %add = add nsw i32 %call, %add4
