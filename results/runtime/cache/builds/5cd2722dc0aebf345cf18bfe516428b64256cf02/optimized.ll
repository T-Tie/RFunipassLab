...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv16
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv20
...
for.end21:                                        ; preds = %for.cond11
  ...
  %call.i14 = call i32 @getc(ptr noundef %6)
