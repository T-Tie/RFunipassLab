...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv27, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv27, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv33, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv30, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv33, i64 %indvars.iv30
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax49 = call i32 @llvm.smax.i32(i32 %8, i32 0)
...
for.cond31:                                       ; preds = %for.inc60, %for.end30
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc60 ], [ 0, %for.end30 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count50
  br i1 %exitcond51.not, label %for.cond63, label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.inc57
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc57 ], [ 0, %for.cond31 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc60, label %for.cond39

for.cond39:                                       ; preds = %for.cond35, %for.inc50
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc50 ], [ 0, %for.cond35 ]
...
for.inc50:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv36
  %11 = load i32, ptr %arrayidx45, align 4, !tbaa !5
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv36, i64 %indvars.iv40
...
for.inc57:                                        ; preds = %for.cond39
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv46, i64 %indvars.iv40
...
for.cond63:                                       ; preds = %for.cond31, %for.inc86
  ...
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc86 ], [ 0, %for.cond31 ]
  %14 = sext i32 %13 to i64
  %cmp65.not.not = icmp slt i64 %indvars.iv55, %14
  br i1 %cmp65.not.not, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond63, %for.body70
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body70 ], [ 0, %for.cond63 ]
  %15 = load i32, ptr %y2, align 4, !tbaa !5
  %16 = sext i32 %15 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv52, %16
  br i1 %cmp69.not.not, label %for.body70, label %for.inc86

for.body70:                                       ; preds = %for.cond67
  %cmp71 = icmp eq i64 %indvars.iv52, 0
  %spec.select = select i1 %cmp71, ptr @.str.1, ptr @.str.2
  %arrayidx80 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv55, i64 %indvars.iv52
  %17 = load i32, ptr %arrayidx80, align 4, !tbaa !5
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %17)
...
for.end88:                                        ; preds = %for.cond63
  %18 = load ptr, ptr @stdin, align 8, !tbaa !20
  %call.i = call i32 @getc(ptr noundef %18)
  %19 = load ptr, ptr @stdin, align 8, !tbaa !20
  %call.i19 = call i32 @getc(ptr noundef %19)
