...
for.cond5:                                        ; preds = %for.cond.cleanup11, %for.cond.cleanup
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond.cleanup11 ], [ 1, %for.cond.cleanup ]
...
for.cond9.preheader:                              ; preds = %for.cond5
  ...
  %arrayidx14.promoted = load i32, ptr %arrayidx14, align 4, !tbaa !5
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc20
  %indvars.iv13 = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next14, %for.inc20 ]
  %7 = phi i32 [ %arrayidx14.promoted, %for.cond9.preheader ], [ %9, %for.inc20 ]
...
for.inc20:                                        ; preds = %for.body12, %if.then
  %9 = phi i32 [ %7, %for.body12 ], [ 1, %if.then ]
...
for.cond27:                                       ; preds = %for.cond5, %for.inc40
  ...
  %10 = sext i32 %.pre24 to i64
  %cmp28 = icmp slt i64 %indvars.iv21, %10
