...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr %ch) #11
...
while.end35:                                      ; preds = %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 41000, ptr %ch) #11
...
!41 = !{!28, !32, i64 240}
!42 = !{!43, !7, i64 56}
!43 = !{!"_ZTSSt5ctypeIcE", !44, i64 0, !45, i64 16, !30, i64 24, !46, i64 32, !46, i64 40, !47, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!44 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!45 = !{!"p1 _ZTS15__locale_struct", !22, i64 0}
!46 = !{!"p1 int", !22, i64 0}
!47 = !{!"p1 short", !22, i64 0}
