...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv78.in = phi i32 [ %indvars.iv78, %for.end100 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub67, %for.end100 ], [ %n, %entry ]
  %indvars.iv78 = add i32 %indvars.iv78.in, -1
  %smax115 = call i32 @llvm.smax.i32(i32 %indvars.iv78, i32 noundef 1)
  %smax104 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %0 = zext i32 %indvars.iv78 to i64
  %wide.trip.count89 = zext nneg i32 %smax104 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %wide.trip.count89
  br i1 %exitcond90.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count94 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv86
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv86, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv81 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next82, %for.inc21 ]
  %exitcond85.not = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond85.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv86, i64 %indvars.iv81
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv101 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next102, %for.inc62 ]
  %exitcond106.not = icmp eq i64 %indvars.iv101, %wide.trip.count89
  br i1 %exitcond106.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv101
  %4 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select70, %for.body34 ], [ %4, %for.body29 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %wide.trip.count94
  br i1 %exitcond95.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv91, i64 %indvars.iv101
  %5 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select70 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv96 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next97, %for.inc59 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %wide.trip.count94
  br i1 %exitcond100.not, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv96, i64 %indvars.iv101
...
for.cond66:                                       ; preds = %for.cond81, %for.cond66.preheader
  %indvars.iv112 = phi i64 [ 1, %for.cond66.preheader ], [ %indvars.iv.next113, %for.cond81 ]
  %exitcond117.not = icmp eq i64 %indvars.iv112, %wide.trip.count116
  br i1 %exitcond117.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next113
  %8 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv112
  store i32 %8, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next113
  %9 = load i32, ptr %arrayidx76, align 16, !tbaa !5
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv112
  store i32 %9, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond111.not = icmp eq i64 %indvars.iv107, %0
  br i1 %exitcond111.not, label %for.cond66, label %for.inc95, !llvm.loop !17

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next113, i64 %indvars.iv.next108
  %10 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv112, i64 %indvars.iv107
...
for.end100:                                       ; preds = %for.cond66
  ...
  store i32 %smax115, ptr @i, align 4, !tbaa !5
  %add102 = add nsw i32 %7, %accumulator.tr
  br label %tailrecurse

cleanup:                                          ; preds = %for.end64
  store i32 %smax104, ptr @j, align 4, !tbaa !5
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %storemerge14 = phi i32 [ %inc11, %for.inc10 ], [ 0, %for.cond ]
  store i32 %storemerge14, ptr @j, align 4, !tbaa !5
  %cmp2 = icmp slt i32 %storemerge14, %1
  br i1 %cmp2, label %for.cond4, label %for.inc16

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre19, %for.inc ], [ %storemerge14, %for.cond1 ]
  %3 = phi i32 [ %.pre18, %for.inc ], [ %1, %for.cond1 ]
  %storemerge15 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond1 ]
  store i32 %storemerge15, ptr @k, align 4, !tbaa !5
  %cmp5 = icmp slt i32 %storemerge15, %3
  br i1 %cmp5, label %for.inc, label %for.inc10

for.inc:                                          ; preds = %for.cond4
  %idxprom = sext i32 %2 to i64
  %idxprom7 = sext i32 %storemerge15 to i64
  ...
  %.pre19 = load i32, ptr @j, align 4, !tbaa !5
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  ...
  %storemerge13 = phi i32 [ %inc27, %for.inc26 ], [ 0, %for.cond ]
  store i32 %storemerge13, ptr @l, align 4, !tbaa !5
  %cmp20 = icmp slt i32 %storemerge13, %6
  br i1 %cmp20, label %for.inc26, label %for.end28

for.inc26:                                        ; preds = %for.cond19
  %idxprom22 = sext i32 %storemerge13 to i64
