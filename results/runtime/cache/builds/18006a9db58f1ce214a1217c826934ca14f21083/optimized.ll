...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax27 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax28 = call i32 @llvm.smax.i32(i32 %smax27, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax34 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count42 = zext nneg i32 %smax22 to i64
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count59 = zext nneg i32 %smax22 to i64
  br label %for.cond96
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond60.not = icmp eq i64 %indvars.iv54, %wide.trip.count59
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax69 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax75 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
