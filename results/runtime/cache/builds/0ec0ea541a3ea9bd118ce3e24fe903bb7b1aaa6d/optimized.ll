...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv19 = phi i32 [ %indvars.iv.next20, %while.cond ], [ -1, %entry ]
  ...
  %indvars.iv.next20 = add nsw i32 %indvars.iv19, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv11 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next12, %for.inc ]
  %exitcond.not = icmp eq i64 %indvars.iv11, 100
...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv19, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond14

for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv11
  %2 = load i8, ptr %arrayidx5, align 1, !tbaa !25, !invariant.load !8
  %cmp6 = icmp eq i8 %2, 0
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  ...
  %exitcond21.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond21.not, label %for.end27, label %for.body17

for.body17:                                       ; preds = %for.cond14
  %4 = xor i64 %indvars.iv15, -1
  %5 = add nsw i64 %1, %4
  %arrayidx21 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %5
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx21) #6
  ...
  %6 = load i64, ptr %gep, align 8, !tbaa !27, !invariant.load !8
...
for.end27:                                        ; preds = %for.cond14
  %call.i.i2 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(10000) %a) #6
  %call1.i3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(10000) %a, i64 noundef %call.i.i2)
