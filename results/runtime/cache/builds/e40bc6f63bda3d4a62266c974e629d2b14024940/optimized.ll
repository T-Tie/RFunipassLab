...
if.then34:                                        ; preds = %if.end28
  ...
  br i1 %cmp35, label %if.end56, label %if.else
...
if.end56:                                         ; preds = %if.then34, %if.else
  %div47.sink = phi double [ %div47, %if.else ], [ 0.000000e+00, %if.then34 ]
  %mul50 = fmul double %10, %10
  %neg51 = fneg double %mul50
  %14 = call double @llvm.fmuladd.f64(double %mul30, double %12, double %neg51)
  %call52 = call double @sqrt(double noundef %14) #7, !tbaa !5
  %mul53 = fmul double 2.000000e+00, %11
  %div54 = fdiv double %call52, %mul53
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div47.sink, double noundef %div54, double noundef %div47.sink, double noundef %div54) #8
  br label %for.inc

for.inc:                                          ; preds = %if.end28, %if.end56
  %inc = add nsw i32 %0, 1
