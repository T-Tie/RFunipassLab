...
for.cond6:                                        ; preds = %for.inc12, %for.end
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc12 ], [ %indvars.iv, %for.end ]
  %cmp7 = icmp sgt i64 %indvars.iv11, 0
  br i1 %cmp7, label %for.inc12, label %for.end13

for.inc12:                                        ; preds = %for.cond6
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, -1
  %arrayidx9 = getelementptr inbounds nuw [100 x [20 x i8]], ptr %a, i64 0, i64 %indvars.iv.next12
