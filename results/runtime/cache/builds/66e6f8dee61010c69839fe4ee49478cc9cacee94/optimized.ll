...
for.cond3:                                        ; preds = %if.end39, %for.end
  %sum.0 = phi i32 [ 0, %for.end ], [ %sum.1, %if.end39 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %add13, %if.end39 ]
...
if.end39:                                         ; preds = %if.else, %if.then
  %sum.1 = phi i32 [ %conv11, %if.then ], [ 0, %if.else ]
...
newFuncRoot:
  br label %if.else_to_outline

if.else_to_outline:                               ; preds = %newFuncRoot
  ...
  br label %if.else_after_outline.exitStub

if.else_after_outline.exitStub:                   ; preds = %if.else_to_outline
  ret void
}
