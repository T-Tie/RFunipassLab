...
for.body54:                                       ; preds = %for.cond52
  ...
  %spec.select3 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %arrayidx62 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv18
  %11 = load i32, ptr %arrayidx62, align 4, !tbaa !5
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select3, i32 noundef %11) #6
