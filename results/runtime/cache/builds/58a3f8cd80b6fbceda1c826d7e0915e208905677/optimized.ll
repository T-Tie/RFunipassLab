...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4016016, ptr noundef nonnull %shuzu) #5
...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv16, %1
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count30 = zext i32 %3 to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre32, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv16, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv25 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next26, %for.cond13 ]
  ...
  %exitcond31 = icmp eq i64 %indvars.iv25, %wide.trip.count30
  br i1 %exitcond31, label %for.end58, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv19 = phi i64 [ 1, %for.cond13.preheader ], [ %9, %for.inc53 ]
  %x1.1 = phi i32 [ %x1.0, %for.cond13.preheader ], [ %x1.26, %for.inc53 ]
  %y1.1 = phi i32 [ %y1.0, %for.cond13.preheader ], [ %y1.28, %for.inc53 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv25, i64 %indvars.iv19
...
land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv25, i64 %9
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next26, i64 %indvars.iv19
  ...
  %12 = trunc nuw nsw i64 %indvars.iv19 to i32
  %spec.select10 = select i1 %cmp32, i32 %12, i32 %y1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %y1.2.ph = phi i32 [ %y1.1, %land.lhs.true ], [ %spec.select10, %land.lhs.true26 ]
  %13 = add nsw i64 %indvars.iv19, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv25, i64 %13
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv19
  %15 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !14
  %cmp50 = icmp eq i32 %15, 0
  %spec.select11 = select i1 %cmp50, i32 %7, i32 %x2.1
  %16 = trunc nuw nsw i64 %indvars.iv19 to i32
  %spec.select12 = select i1 %cmp50, i32 %16, i32 %y2.1
  br label %for.inc53

for.inc53:                                        ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
  %y1.28 = phi i32 [ %y1.2.ph, %land.lhs.true44 ], [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1, %for.body15 ]
  %x1.26 = phi i32 [ %x1.2.ph, %land.lhs.true44 ], [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1, %for.body15 ]
  %x2.2 = phi i32 [ %spec.select11, %land.lhs.true44 ], [ %x2.1, %land.lhs.true38 ], [ %x2.1, %for.body15 ]
  %y2.2 = phi i32 [ %spec.select12, %land.lhs.true44 ], [ %y2.1, %land.lhs.true38 ], [ %y2.1, %for.body15 ]
...
for.end58:                                        ; preds = %for.cond10
  ...
  %mul6513 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6513, %add60
  %17 = shl i32 %sub61, 1
  %reass.sub45 = sub i32 %sub66, %17
  %add71 = add i32 %reass.sub45, 2
  ...
  %vtable.i = load ptr, ptr %call72, align 8, !tbaa !16, !invariant.load !14
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4016016, ptr noundef nonnull %shuzu) #6
  ret i32 0
}
