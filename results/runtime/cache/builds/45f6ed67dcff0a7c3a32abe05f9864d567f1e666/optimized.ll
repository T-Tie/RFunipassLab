...
for.cond3.preheader:                              ; preds = %for.cond
  %smax29 = call i32 @llvm.smax.i32(i32 %3, i32 0)
  br label %for.cond3
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.cond.cleanup10
  %indvars.iv26.in = phi i32 [ %3, %for.cond3.preheader ], [ %indvars.iv26, %for.cond.cleanup10 ]
  %i2.0 = phi i32 [ 0, %for.cond3.preheader ], [ %inc31, %for.cond.cleanup10 ]
  %indvars.iv26 = add i32 %indvars.iv26.in, -1
  %exitcond30.not = icmp eq i32 %i2.0, %smax29
  br i1 %exitcond30.not, label %for.cond34, label %for.cond7.preheader
...
for.cond.cleanup10:                               ; preds = %for.cond7
  %inc31 = add nuw i32 %i2.0, 1
  br label %for.cond3, !llvm.loop !12

for.body11:                                       ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv22
  %5 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx15 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next23
  %6 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %cmp16 = icmp sgt i32 %5, %6
  br i1 %cmp16, label %if.then, label %for.cond7.backedge

for.cond7.backedge:                               ; preds = %for.body11, %if.then
...
for.cond34:                                       ; preds = %for.cond3, %for.inc59
  %7 = phi i32 [ %.pre, %for.inc59 ], [ %3, %for.cond3 ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc59 ], [ 0, %for.cond3 ]
  %8 = sext i32 %7 to i64
  %cmp35 = icmp slt i64 %indvars.iv31, %8
...
for.body37:                                       ; preds = %for.cond34
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv31
  %9 = load i32, ptr %arrayidx39, align 4, !tbaa !5
  %10 = and i32 %9, -2147483647
  %cmp40 = icmp eq i32 %10, 1
  %cmp41 = icmp eq i64 %indvars.iv31, 0
  %or.cond = and i1 %cmp41, %cmp40
  br i1 %or.cond, label %if.then42, label %if.else

if.then42:                                        ; preds = %for.body37
  %call45 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
  br label %for.inc59

if.else:                                          ; preds = %for.body37
  %cmp51 = icmp ne i64 %indvars.iv31, 0
  %or.cond1 = and i1 %cmp51, %cmp40
  br i1 %or.cond1, label %if.then52, label %for.inc59
...
if.then52:                                        ; preds = %if.else
  ...
  %11 = load i64, ptr %gep, align 8, !tbaa !17
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call56 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, i32 noundef %12)
  br label %for.inc59

for.inc59:                                        ; preds = %if.then42, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.else
