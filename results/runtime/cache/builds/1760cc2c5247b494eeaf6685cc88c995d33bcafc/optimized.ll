...
for.cond11:                                       ; preds = %if.end67, %for.end
  %l.0 = phi i32 [ 1, %for.end ], [ %l.1, %if.end67 ]
  %i.1 = phi i32 [ 1, %for.end ], [ %inc69, %if.end67 ]
...
for.cond14:                                       ; preds = %if.end40, %for.body13
  %y.0 = phi i32 [ 0, %for.body13 ], [ %y.1, %if.end40 ]
  %j.0 = phi i32 [ 0, %for.body13 ], [ %inc42, %if.end40 ]
...
for.cond17:                                       ; preds = %if.end, %for.body16
  %x.0 = phi i32 [ 0, %for.body16 ], [ %x.1, %if.end ]
  %m.0 = phi i32 [ 0, %for.body16 ], [ %inc31, %if.end ]
...
for.body19:                                       ; preds = %for.cond17
  ...
  %2 = load i8, ptr %arrayidx21, align 1, !tbaa !9
  ...
  %3 = load i8, ptr %arrayidx26, align 1, !tbaa !9
...
if.then34:                                        ; preds = %for.end32
  ...
  %4 = load i8, ptr %arrayidx37, align 2, !tbaa !9
  %inc38 = add i8 %4, 1
...
for.cond46:                                       ; preds = %for.body48, %if.then45
  %m.1 = phi i32 [ 0, %if.then45 ], [ %inc57, %for.body48 ]
...
for.body48:                                       ; preds = %for.cond46
  ...
  %5 = load i8, ptr %arrayidx51, align 1, !tbaa !9
...
for.cond71:                                       ; preds = %for.end120, %for.end70
  %i.2 = phi i32 [ 0, %for.end70 ], [ %add75, %for.end120 ]
...
for.cond76:                                       ; preds = %if.end117, %for.body74
  %j.1 = phi i32 [ %add75, %for.body74 ], [ %inc119, %if.end117 ]
...
for.cond89:                                       ; preds = %for.body91, %if.then88
  %z.0 = phi i32 [ 0, %if.then88 ], [ %inc115, %for.body91 ]
  %cmp90 = icmp slt i32 %z.0, 6
  br i1 %cmp90, label %for.body91, label %if.end117
...
for.cond134:                                      ; preds = %if.then147, %if.else
  %i.3 = phi i32 [ 1, %if.else ], [ %inc152, %if.then147 ]
  %z.1 = phi i32 [ 1, %if.else ], [ %inc148, %if.then147 ]
  %cmp135 = icmp slt i32 %i.3, %l.0
  br i1 %cmp135, label %for.body136, label %for.end153

for.body136:                                      ; preds = %for.cond134
  %idxprom137 = sext i32 %i.3 to i64
  ...
  br i1 %cmp146, label %if.then147, label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136
  br label %for.cond154

for.cond154:                                      ; preds = %for.end203, %for.end153
  %i.4 = phi i32 [ 0, %for.end153 ], [ %add158, %for.end203 ]
  %sub155 = sub nsw i32 %z.1, 1
  %cmp156 = icmp slt i32 %i.4, %sub155
...
for.cond159:                                      ; preds = %if.end200, %for.body157
  %j.2 = phi i32 [ %add158, %for.body157 ], [ %inc202, %if.end200 ]
  %cmp160 = icmp slt i32 %j.2, %z.1
...
for.cond172:                                      ; preds = %for.body174, %if.then171
  %k.0 = phi i32 [ 0, %if.then171 ], [ %inc198, %for.body174 ]
  %cmp173 = icmp slt i32 %k.0, 6
  br i1 %cmp173, label %for.body174, label %if.end200
...
for.cond207:                                      ; preds = %for.end222, %for.end206
  %i.5 = phi i32 [ 0, %for.end206 ], [ %inc224, %for.end222 ]
  %cmp208 = icmp slt i32 %i.5, %z.1
...
for.cond211:                                      ; preds = %for.body213, %for.body209
  %j.3 = phi i32 [ 0, %for.body209 ], [ %inc221, %for.body213 ]
