...
if.then:                                          ; preds = %for.body
  ...
  %call34 = call double @sqrt(double noundef %6) #12, !tbaa !5
...
if.else:                                          ; preds = %for.body
  ...
  %call57 = call double @sqrt(double noundef %7) #12, !tbaa !5
  %div59 = fdiv double %call57, %mul48
  %call67 = call double @sqrt(double noundef %7) #12, !tbaa !5
...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc132 ], [ 0, %for.cond ]
  %11 = sext i32 %10 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv5, %11
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv5
  ...
  %17 = load double, ptr %arrayidx120, align 8, !tbaa !9, !invariant.load !11
  %arrayidx123 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 32
  %18 = load double, ptr %arrayidx123, align 16, !tbaa !9, !invariant.load !11
  br i1 %cmp94, label %if.else117, label %if.then95

if.then95:                                        ; preds = %for.body77
  %cmp102 = fcmp une double %17, %18
  br i1 %cmp102, label %if.then103, label %if.else111

if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %17, double noundef %18) #13
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %17) #13
  br label %for.inc132

if.else117:                                       ; preds = %for.body77
  %arrayidx129 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 40
  %19 = load double, ptr %arrayidx129, align 8, !tbaa !9, !invariant.load !11
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %17, double noundef %18, double noundef %17, double noundef %19) #13
  br label %for.inc132
