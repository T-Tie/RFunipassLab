...
for.cond.preheader:                               ; preds = %tailrecurse
  %1 = sext i32 %c2.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv19 = phi i64 [ %1, %for.cond.preheader ], [ %indvars.iv.next20, %for.inc ]
  %cmp1 = icmp sgt i64 %indvars.iv19, 0
  br i1 %cmp1, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, -1
  %arrayidx = getelementptr inbounds [40 x i32], ptr @a, i64 0, i64 %indvars.iv.next20
...
for.inc39:                                        ; preds = %for.cond12
  ...
  %7 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !9
  %add31 = add nsw i32 %7, %div
