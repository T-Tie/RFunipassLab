...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %a) #10
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(50) %a)
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(50) %a)
  %call5 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %a) #11
  %conv = trunc i64 %call5 to i32
  br label %for.cond

for.cond:                                         ; preds = %for.inc68, %entry
  %sum.0 = phi i32 [ %conv, %entry ], [ %sum.1, %for.inc68 ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc68 ]
...
for.body:                                         ; preds = %for.cond
  %call7 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(50) %a)
  %call9 = call i64 @strlen(ptr noundef %a) #11
  %conv10 = trunc i64 %call9 to i32
  %add = add nsw i32 %conv10, %sum.0
  %add11 = add nsw i32 %add, 1
  %add12 = add nsw i32 %conv10, 1
  %cmp13 = icmp eq i32 %add11, %add12
...
for.cond15:                                       ; preds = %for.inc, %if.then
  %p.0 = phi ptr [ %a, %if.then ], [ %incdec.ptr, %for.inc ]
...
for.cond26:                                       ; preds = %for.inc33, %if.then23
  %p.1 = phi ptr [ %a, %if.then23 ], [ %incdec.ptr34, %for.inc33 ]
  %idx.ext28 = sext i32 %conv10 to i64
  %add.ptr29 = getelementptr inbounds i8, ptr %a, i64 %idx.ext28
  %cmp30 = icmp ult ptr %p.1, %add.ptr29
  br i1 %cmp30, label %for.inc33, label %if.end

for.inc33:                                        ; preds = %for.cond26
  %2 = load i8, ptr %p.1, align 1, !tbaa !9
  ...
  %incdec.ptr34 = getelementptr inbounds nuw i8, ptr %p.1, i32 1
...
for.cond40:                                       ; preds = %for.inc47, %if.then37
  %p.2 = phi ptr [ %a, %if.then37 ], [ %incdec.ptr48, %for.inc47 ]
  %idx.ext42 = sext i32 %conv10 to i64
  %add.ptr43 = getelementptr inbounds i8, ptr %a, i64 %idx.ext42
  %cmp44 = icmp ult ptr %p.2, %add.ptr43
  br i1 %cmp44, label %for.inc47, label %if.end51.thread

for.inc47:                                        ; preds = %for.cond40
  %3 = load i8, ptr %p.2, align 1, !tbaa !9
  %call46 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %3)
  %incdec.ptr48 = getelementptr inbounds nuw i8, ptr %p.2, i32 1
...
for.cond56:                                       ; preds = %for.inc63, %if.then53
  ...
  %idx.ext58 = sext i32 %conv10 to i64
  %add.ptr59 = getelementptr inbounds i8, ptr %a, i64 %idx.ext58
  %cmp60 = icmp ult ptr %p.3, %add.ptr59
  br i1 %cmp60, label %for.inc63, label %for.inc68

for.inc63:                                        ; preds = %for.cond56
  %4 = load i8, ptr %p.3, align 1, !tbaa !9
  %call62 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %4)
  %incdec.ptr64 = getelementptr inbounds nuw i8, ptr %p.3, i32 1
  br label %for.cond56, !llvm.loop !15

for.inc68:                                        ; preds = %for.cond15, %for.cond56, %if.end51.thread, %if.end51
  %sum.1 = phi i32 [ %add, %for.cond15 ], [ %add11, %if.end51 ], [ 0, %if.end51.thread ], [ %conv10, %for.cond56 ]
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !16

for.end69:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %a) #10
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !17
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !17
  %vbase.offset.ptr2 = getelementptr i8, ptr %vtable1, i64 -24
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !19
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !17
  %vbase.offset.ptr8 = getelementptr i8, ptr %vtable7, i64 -24
  %vbase.offset9 = load i64, ptr %vbase.offset.ptr8, align 8, !invariant.load !19
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !17
  %vbase.offset.ptr13 = getelementptr i8, ptr %vtable12, i64 -24
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !19
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !17
  %vbase.offset.ptr21 = getelementptr i8, ptr %vtable20, i64 -24
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !19
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !17
  %vbase.offset.ptr30 = getelementptr i8, ptr %vtable29, i64 -24
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !19
