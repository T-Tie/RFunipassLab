...
for.cond4:                                        ; preds = %for.inc31, %for.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc31 ], [ 1, %for.end ]
  %exitcond = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond, label %for.cond34, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv18
  store i32 1, ptr %arrayidx8, align 4, !tbaa !5
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %w, i64 0, i64 %indvars.iv18
  %3 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond9

for.cond9:                                        ; preds = %for.inc29, %for.body6
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc29 ], [ %indvars.iv18, %for.body6 ]
  %indvars.iv.next21 = add nsw i64 %indvars.iv20, -1
  %cmp10 = icmp sgt i64 %indvars.iv20, 0
  br i1 %cmp10, label %for.body11, label %for.inc31

for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds [30 x i32], ptr %w, i64 0, i64 %indvars.iv.next21
...
if.then:                                          ; preds = %for.body11
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %f, i64 0, i64 %indvars.iv.next21
...
for.cond34:                                       ; preds = %for.cond4, %for.body36
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body36 ], [ 1, %for.cond4 ]
  %m.0 = phi i32 [ %spec.select, %for.body36 ], [ 0, %for.cond4 ]
  %exitcond29 = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29, label %for.end46, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv25
