...
while.body2:                                      ; preds = %lor.lhs.false, %while.body
  %indvars.iv16 = phi i32 [ %indvars.iv.next17, %lor.lhs.false ], [ -1, %while.body ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %lor.lhs.false ], [ 0, %while.body ]
...
lor.lhs.false:                                    ; preds = %while.body2
  ...
  br i1 %cmp6, label %while.end38, label %while.body2, !llvm.loop !9
...
for.cond.preheader:                               ; preds = %while.end
  ...
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv16, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc33
  %indvars.iv10 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next11, %for.inc33 ]
  %count.0 = phi i32 [ 0, %for.cond.preheader ], [ %count.1, %for.inc33 ]
  %exitcond.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond.not, label %for.end35, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond
  %arrayidx18 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv10
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv12 = phi i64 [ %indvars.iv10, %for.cond14.preheader ], [ %indvars.iv.next13, %for.body16 ]
  %count.1 = phi i32 [ %count.0, %for.cond14.preheader ], [ %count.2, %for.body16 ]
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %cmp15 = icmp samesign ult i64 %indvars.iv.next13, %2
  br i1 %cmp15, label %for.body16, label %for.inc33

for.body16:                                       ; preds = %for.cond14
  %3 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !12
  %mul = shl nsw i32 %3, 1
  %arrayidx20 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv.next13
...
while.end38:                                      ; preds = %while.end, %lor.lhs.false
