...
if.then39:                                        ; preds = %if.end37
  ...
  %call50 = tail call double @sqrt(double noundef %15) #7, !tbaa !5
  ...
  %call65 = tail call double @sqrt(double noundef %20) #7, !tbaa !5
