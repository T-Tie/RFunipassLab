...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 301, ptr nonnull %a) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(301) %a, i8 0, i64 301, i1 false)
  store i8 48, ptr %a, align 16
  call void @llvm.lifetime.start.p0(i64 26, ptr nonnull %b) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(26) %b, ptr noundef nonnull align 16 dereferenceable(26) @__const.main.b, i64 26, i1 false)
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv7 = phi i32 [ %indvars.iv.next8, %for.inc ], [ 1, %entry ]
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.body
  %indvars.iv4 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next5, %for.body ]
...
for.body:                                         ; preds = %for.cond4
  %arrayidx7 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv4
...
for.cond23:                                       ; preds = %for.inc58, %if.end22
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc58 ], [ 0, %if.end22 ]
  %exitcond18.not = icmp eq i64 %indvars.iv15, 26
  br i1 %exitcond18.not, label %for.end60, label %for.body25

for.body25:                                       ; preds = %for.cond23
  store i8 97, ptr %b, align 16, !tbaa !5
  %arrayidx28 = getelementptr inbounds nuw [26 x i8], ptr %b, i64 0, i64 %indvars.iv15
  %3 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %add30 = add i8 %3, 1
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %arrayidx34 = getelementptr inbounds nuw [26 x i8], ptr %b, i64 0, i64 %indvars.iv.next16
  store i8 %add30, ptr %arrayidx34, align 1, !tbaa !5
  br label %for.cond35

for.cond35:                                       ; preds = %for.body37, %for.body25
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body37 ], [ 0, %for.body25 ]
  %n.0 = phi i32 [ %spec.select, %for.body37 ], [ 0, %for.body25 ]
  %exitcond14 = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond14, label %for.end50, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv9
...
for.end60:                                        ; preds = %for.cond23
  ...
  call void @llvm.lifetime.end.p0(i64 301, ptr nonnull %a) #5
  ret i32 0
}
