...
entry:
  ...
  %flag14 = alloca i8, i32 0, align 4
  %flag2 = alloca i32, align 4
  %flag25 = alloca i8, i32 0, align 4
...
for.body120:                                      ; preds = %for.cond118
  ...
  %29 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %cmp123 = icmp ne i32 %29, %23
...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %30 = load i32, ptr %arrayidx133, align 16, !tbaa !5
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %30)
  br label %if.end136
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  %sub140 = sub nsw i32 %23, %29
  %cmp141 = icmp slt i32 %31, %sub140
...
for.body142:                                      ; preds = %for.cond137
  ...
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %32)
  br label %for.inc148

for.inc148:                                       ; preds = %for.body142
  %inc149 = add nsw i32 %31, 1
...
for.cond158:                                      ; preds = %for.inc170, %if.then156
  ...
  %sub162 = sub nsw i32 %23, %33
  %cmp163 = icmp slt i32 %34, %sub162
...
for.body164:                                      ; preds = %for.cond158
  ...
  %35 = load i32, ptr %arrayidx168, align 4, !tbaa !5
  %call169 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %35)
  br label %for.inc170

for.inc170:                                       ; preds = %for.body164
  %inc171 = add nsw i32 %34, 1
...
for.inc198:                                       ; preds = %if.end197
  %inc199 = add nsw i32 %28, 1
  store i32 %inc199, ptr %i, align 4, !tbaa !5
