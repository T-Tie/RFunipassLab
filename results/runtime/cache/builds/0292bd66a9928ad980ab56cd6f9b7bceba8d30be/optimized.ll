...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 550, ptr %a) #7
  ...
  call void @llvm.lifetime.start.p0(i64 3300, ptr %b) #7
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 3300, i1 false)
  call void @llvm.lifetime.start.p0(i64 2200, ptr %num) #7
  call void @llvm.memset.p0.i64(ptr align 16 %num, i8 0, i64 2200, i1 false)
  br label %for.cond
...
for.end19:                                        ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 4, ptr %i20) #7
  store i32 0, ptr %i20, align 4, !tbaa !5
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc47, %for.end19
  %2 = load i32, ptr %i20, align 4, !tbaa !5
  %cmp23 = icmp slt i32 %2, %sub
  br i1 %cmp23, label %for.body25, label %for.end49

for.body25:                                       ; preds = %for.cond21
  call void @llvm.lifetime.start.p0(i64 4, ptr %j26) #7
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc44, %for.body25
  %i20.sink = phi ptr [ %i20, %for.body25 ], [ %j26, %for.inc44 ]
  %3 = load i32, ptr %i20.sink, align 4, !tbaa !5
  %add27 = add nsw i32 %3, 1
...
for.body32:                                       ; preds = %for.cond28
  ...
  %call39 = call i32 @strcmp(ptr noundef %arrayidx34, ptr noundef %arrayidx37) #8
...
for.inc63:                                        ; preds = %for.body55, %if.then59
  %max.1 = phi i32 [ %5, %if.then59 ], [ %max.0, %for.body55 ]
...
if.end91:                                         ; preds = %for.cond73, %if.then67
  call void @llvm.lifetime.end.p0(i64 2200, ptr %num) #7
  call void @llvm.lifetime.end.p0(i64 3300, ptr %b) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #7
  call void @llvm.lifetime.end.p0(i64 550, ptr %a) #7
  ret i32 0
}
