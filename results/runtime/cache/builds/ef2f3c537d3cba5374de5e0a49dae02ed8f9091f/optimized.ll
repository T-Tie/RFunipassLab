...
for.body:                                         ; preds = %for.cond
  ...
  %smax38 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
...
for.cond7:                                        ; preds = %for.body, %for.inc
  ...
  %exitcond39.not = icmp eq i32 %j.0, %smax38
  br i1 %exitcond39.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %4 = load i32, ptr %m2, align 4, !tbaa !5
  %smax40 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond30
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %exitcond41.not = icmp eq i32 %j.1, %smax40
  br i1 %exitcond41.not, label %for.end58, label %for.body32
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts33 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.5.str.4) #6
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %j81.0, %smax38
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %exitcond37.not = icmp eq i32 %j81.1, %smax36
  br i1 %exitcond37.not, label %for.end140, label %for.body114
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts35 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.7.sink) #6
  br label %for.inc164
