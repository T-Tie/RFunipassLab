...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 140000, ptr noundef nonnull align 16 %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 140000, ptr noundef nonnull align 16 %b) #8
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc10
  %indvars.iv14 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next15, %for.inc10 ]
...
for.inc10:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [35000 x i32], ptr %a, i64 0, i64 %indvars.iv14
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !12
  %call7 = call noundef i32 @_Z4factii(i32 noundef %2, i32 noundef 2) #9
  %arrayidx9 = getelementptr inbounds nuw [35000 x i32], ptr %b, i64 0, i64 %indvars.iv14
...
for.cond13:                                       ; preds = %for.cond2, %for.inc20
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc20 ], [ 0, %for.cond2 ]
  %4 = sext i32 %3 to i64
  %cmp14 = icmp slt i64 %indvars.iv18, %4
  br i1 %cmp14, label %for.inc20, label %for.end22

for.inc20:                                        ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [35000 x i32], ptr %b, i64 0, i64 %indvars.iv18
...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef nonnull %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef nonnull %a) #10
...
if.then6:                                         ; preds = %for.body
  %div = sdiv i32 %n, %i.0
  %call = tail call noundef i32 @_Z4factii(i32 noundef %div, i32 noundef %i.0) #11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !16, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !24, !invariant.load !12
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !25, !invariant.load !12
