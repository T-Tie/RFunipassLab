...
for.end:                                          ; preds = %for.cond
  ...
  %smax103 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
...
for.cond14.preheader:                             ; preds = %for.cond11
  %smax91 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  ...
  %10 = trunc nuw i64 %indvars.iv112 to i32
...
if.else:                                          ; preds = %for.end123
  ...
  %smax125 = call i32 @llvm.smax.i32(i32 %l.0, i32 1)
  %wide.trip.count129 = zext nneg i32 %smax125 to i64
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars128.le = trunc i64 %indvars.iv121 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars128.le, %for.end153.split.loop.exit ], [ %smax125, %for.cond134 ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count145 = zext i32 %sub155 to i64
  %wide.trip.count140 = zext i32 %z.1.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  ...
  %exitcond146.not = icmp eq i64 %indvars.iv142, %wide.trip.count145
  br i1 %exitcond146.not, label %for.cond207.preheader, label %for.body157

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count153 = zext i32 %z.1.lcssa to i64
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv150 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next151, %for.inc223 ]
  %exitcond154.not = icmp eq i64 %indvars.iv150, %wide.trip.count153
...
for.inc220:                                       ; preds = %for.cond211
  ...
  %putchar80 = call i32 @putchar(i32 %conv218)
