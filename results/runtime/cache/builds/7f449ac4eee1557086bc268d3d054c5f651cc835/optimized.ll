...
for.cond14:                                       ; preds = %for.inc24, %if.then
  ...
  br i1 %cmp15, label %for.body16, label %for.inc28.loopexit
...
for.inc28.loopexit:                               ; preds = %for.cond14
  %b1.2.lcssa = phi i32 [ %b1.2, %for.cond14 ]
  %a1.2.lcssa = phi i32 [ %a1.2, %for.cond14 ]
  %p.2.lcssa = phi i32 [ %p.2, %for.cond14 ]
  br label %for.inc28

for.inc28:                                        ; preds = %for.inc28.loopexit, %for.body12
  %b1.1 = phi i32 [ %b1.0, %for.body12 ], [ %b1.2.lcssa, %for.inc28.loopexit ]
  %a1.1 = phi i32 [ %a1.0, %for.body12 ], [ %a1.2.lcssa, %for.inc28.loopexit ]
  %p.1 = phi i32 [ %p.0, %for.body12 ], [ %p.2.lcssa, %for.inc28.loopexit ]
  %add29 = add nsw i32 %i.1, 1
  br label %for.cond10, !llvm.loop !14

for.end30:                                        ; preds = %for.cond10
  %b1.0.lcssa = phi i32 [ %b1.0, %for.cond10 ]
  %a1.0.lcssa = phi i32 [ %a1.0, %for.cond10 ]
...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  ...
  br i1 %cmp38, label %for.body39, label %for.inc52.loopexit
...
for.inc52.loopexit:                               ; preds = %for.cond37
  %a2.2.lcssa = phi i32 [ %a2.2, %for.cond37 ]
  %b2.2.lcssa = phi i32 [ %b2.2, %for.cond37 ]
  %p.6.lcssa = phi i32 [ %p.6, %for.cond37 ]
  br label %for.inc52

for.inc52:                                        ; preds = %for.inc52.loopexit, %for.body33
  %a2.1 = phi i32 [ %a2.0, %for.body33 ], [ %a2.2.lcssa, %for.inc52.loopexit ]
  %b2.1 = phi i32 [ %b2.0, %for.body33 ], [ %b2.2.lcssa, %for.inc52.loopexit ]
  %p.5 = phi i32 [ %p.4, %for.body33 ], [ %p.6.lcssa, %for.inc52.loopexit ]
  %dec = add nsw i32 %i.2, -1
  br label %for.cond31, !llvm.loop !16

for.end53:                                        ; preds = %for.cond31
  %a2.0.lcssa = phi i32 [ %a2.0, %for.cond31 ]
  %b2.0.lcssa = phi i32 [ %b2.0, %for.cond31 ]
  %b1.0.lcssa.neg = sub i32 0, %b1.0.lcssa
  %sub54 = add i32 %b1.0.lcssa.neg, 1
  %add55 = add i32 %sub54, %b2.0.lcssa
  %a2.0.lcssa.neg = sub i32 0, %a2.0.lcssa
  %sub56 = add i32 %a1.0.lcssa, 1
  %add57 = add i32 %sub56, %a2.0.lcssa.neg
