...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc27 ], [ 0, %tailrecurse ]
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc24 ], [ 0, %for.cond16.preheader ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.inc27, label %for.inc24
...
for.cond31:                                       ; preds = %for.cond, %for.inc70
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc70 ], [ 0, %for.cond ]
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc67 ], [ 0, %for.cond58.preheader ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond46.not, label %for.inc70, label %for.inc67
