...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  ...
  br i1 %exitcond24.not, label %for.cond31.preheader, label %for.body12
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv15 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next16, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv15
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv30 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next31, %for.inc52 ]
  ...
  %cmp32 = icmp sgt i64 %indvars.iv30, 0
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv26 = phi i64 [ %4, %for.cond37.preheader ], [ %indvars.iv.next27, %for.body39 ]
  ...
  %9 = trunc nuw i64 %indvars.iv26 to i32
  %cmp38 = icmp sgt i32 %9, 0
  br i1 %cmp38, label %for.body39, label %for.inc52

for.body39:                                       ; preds = %for.cond37
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, -1
  %indvars = trunc i64 %indvars.iv.next27 to i32
  %idxprom42 = and i64 %indvars.iv.next27, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next31, i64 %idxprom42
