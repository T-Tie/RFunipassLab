...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull %word) #12
...
for.cond2.preheader:                              ; preds = %for.cond
  %smax17 = call i64 @llvm.smax.i64(i64 %1, i64 0)
  br label %for.cond2
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc74
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc74 ], [ 0, %for.cond2.preheader ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond2.preheader ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond2.preheader ]
  %exitcond.not18 = icmp eq i64 %indvars.iv4, %smax17
  br i1 %exitcond.not18, label %for.end76, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv4
...
if.else42:                                        ; preds = %if.else
  ...
  br i1 %cmp43, label %for.inc74.gvnsink.split, label %if.else58
...
for.inc74.gvnsink.split:                          ; preds = %if.else42, %if.then
  %arrayidx20.sink = phi ptr [ %arrayidx20, %if.then ], [ %arrayidx46, %if.else42 ]
  %idxprom45.sink = phi i64 [ %idxprom19, %if.then ], [ %idxprom45, %if.else42 ]
  %k.1.ph = phi i32 [ %inc18, %if.then ], [ %k.0, %if.else42 ]
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20.sink, ptr noundef nonnull dereferenceable(1) %arrayidx6) #14
  %sext = shl i64 %call8, 32
  %idxprom55 = ashr exact i64 %sext, 32
  %arrayidx56 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom45.sink, i64 %idxprom55
  store i8 32, ptr %arrayidx56, align 1, !tbaa !26
  %inc57 = add nsw i32 %conv, 1
  br label %for.inc74

for.inc74:                                        ; preds = %for.inc74.gvnsink.split, %if.else58, %if.then33
  %k.1 = phi i32 [ %inc41, %if.then33 ], [ %k.0, %if.else58 ], [ %k.1.ph, %for.inc74.gvnsink.split ]
  %j.1 = phi i32 [ 0, %if.then33 ], [ %inc71, %if.else58 ], [ %inc57, %for.inc74.gvnsink.split ]
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %4 = add i32 %smax14, 1
  %wide.trip.count15 = zext i32 %4 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond16 = icmp eq i64 %indvars.iv10, %wide.trip.count15
  br i1 %exitcond16, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv10
  ...
  %5 = and i64 %sub97, 4294967295
  %smax = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv10, i64 %5
  br label %for.cond94
...
for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv7, %5
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %6 = load i8, ptr %arrayidx103, align 1, !tbaa !26
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %6)
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv10, i64 %indvars.iv7
  %7 = load i8, ptr %arrayidx110, align 1, !tbaa !26
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %7)
  br label %for.inc113
