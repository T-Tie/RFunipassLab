...
for.inc.sink.split:                               ; preds = %if.then6, %if.else16, %if.then13
  %vbase.offset.i14 = load i64, ptr %vbase.offset.ptr.i20, align 8, !invariant.load !11
...
for.inc:                                          ; preds = %for.inc.sink.split, %for.body
  %sample.1 = phi double [ %div, %for.body ], [ %sample.0, %for.inc.sink.split ]
