...
for.cond33:                                       ; preds = %for.inc58, %for.end
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc58 ], [ 0, %for.end ]
  %exitcond31.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond31.not, label %for.end60, label %for.inc58
...
for.inc58:                                        ; preds = %for.cond33
  ...
  %reass.sub24 = sub i32 %9, %8
  %10 = mul i32 %reass.sub24, 60
  ...
  %reass.sub26 = sub i32 %7, %6
  %mul = add i32 %reass.sub26, 3600
