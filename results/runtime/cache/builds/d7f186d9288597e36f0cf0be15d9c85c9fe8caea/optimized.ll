...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull %B) #4
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv23 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next24, %for.inc24 ]
...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax33 = call i32 @llvm.smax.i32(i32 %number.0, i32 noundef 0)
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv29 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next30, %for.inc39 ]
...
if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv29
  %4 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4)
  br label %for.inc39
