...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %str) #13
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %num) #11
  ret void
}
