...
for.body26:                                       ; preds = %for.cond23
  ...
  %min.4 = select i1 %cmp27, i32 %8, i32 %spec.select
...
for.body68:                                       ; preds = %for.cond65
  ...
  %10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %11 = load i32, ptr %10, align 4, !tbaa !5
  %spec.select1 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  %min.7 = select i1 %cmp69, i32 %11, i32 %spec.select1
