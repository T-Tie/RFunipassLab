...
if.end41:                                         ; preds = %if.else39, %if.then37
  %.sink = phi i32 [ 28, %if.else39 ], [ 29, %if.then37 ]
  %add40 = add nsw i32 %total.0, %.sink
  br label %if.end42

if.end42:                                         ; preds = %if.end41, %if.else28
  %total.3 = phi i32 [ %add40, %if.end41 ], [ %total.0, %if.else28 ]
  br label %if.end43

if.end43:                                         ; preds = %if.end42, %if.then26
  %total.2 = phi i32 [ %add27, %if.then26 ], [ %total.3, %if.end42 ]
  br label %if.end44

if.end44:                                         ; preds = %if.end43, %if.then18
  %total.1 = phi i32 [ %add, %if.then18 ], [ %total.2, %if.end43 ]
  br label %for.inc
