...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax50 = call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
...
for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count18 = zext i32 %indvars.iv3 to i64
  br label %for.cond26
...
for.cond29:                                       ; preds = %for.cond26, %for.body31
  ...
  %exitcond19 = icmp eq i64 %indvars.iv15, %wide.trip.count18
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  ...
  %exitcond24 = icmp eq i64 %indvars.iv20, %wide.trip.count18
