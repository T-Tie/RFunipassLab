...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull %a) #8
...
if.else14:                                        ; preds = %if.end.thread
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #9
  br label %if.end19
...
if.then25:                                        ; preds = %if.end, %if.end.thread
  ...
  %vbase.offset.i33 = load i64, ptr %vbase.offset.ptr.i32, align 8, !invariant.load !8
  ...
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #9
...
!35 = !{!36, !12, i64 56}
!36 = !{!"_ZTSSt5ctypeIcE", !37, i64 0, !38, i64 16, !26, i64 24, !39, i64 32, !39, i64 40, !40, i64 48, !12, i64 56, !12, i64 57, !12, i64 313, !12, i64 569}
