...
for.cond10:                                       ; preds = %for.inc23, %for.body9
  ...
  %k.0 = phi i32 [ %1, %for.body9 ], [ %inc24, %for.inc23 ]
...
for.inc52:                                        ; preds = %for.body44, %if.then48
  %max.1 = phi i32 [ %9, %if.then48 ], [ %max.0, %for.body44 ]
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %10 = phi i32 [ %inc81, %for.inc80 ], [ 0, %if.else58 ]
  %cmp61 = icmp slt i32 %10, 1000
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %10, %13
  %cmp69 = icmp slt i32 %12, %add68
