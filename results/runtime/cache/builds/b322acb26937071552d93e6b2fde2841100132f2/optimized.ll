...
for.cond23:                                       ; preds = %for.inc41, %for.body22
  %7 = phi i32 [ %inc42, %for.inc41 ], [ 0, %for.body22 ]
  %cmp24 = icmp slt i32 %7, %.sink
...
if.then:                                          ; preds = %for.body26
  %arrayidx29 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom32
...
cond.end:                                         ; preds = %if.else, %cond.false
  %cond = phi i32 [ %9, %cond.false ], [ %10, %if.else ]
...
for.cond45:                                       ; preds = %for.inc53, %for.end43
  %11 = load i32, ptr %l44, align 4, !tbaa !5
  %cmp46 = icmp slt i32 %11, %.sink
...
for.cond60:                                       ; preds = %for.inc106, %for.end58
  %14 = load i32, ptr %k59, align 4, !tbaa !5
  %cmp61 = icmp slt i32 %14, %.sink
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  %15 = phi i32 [ %inc91, %for.inc90 ], [ 0, %for.body63 ]
  %cmp66 = icmp slt i32 %15, %.sink
  br i1 %cmp66, label %for.body68, label %for.end92

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i32 %15, 0
  %idxprom78 = sext i32 %14 to i64
  br i1 %cmp69, label %if.then70, label %if.else75

if.then70:                                        ; preds = %for.body68
  %arrayidx74 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom78
...
cond.end87:                                       ; preds = %if.else75, %cond.false86
  %cond88 = phi i32 [ %17, %cond.false86 ], [ %18, %if.else75 ]
...
for.end108:                                       ; preds = %for.cond60
  ...
  %22 = load i32, ptr %arrayidx110, align 4, !tbaa !5
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %24 = load i32, ptr %i111, align 4, !tbaa !5
  %cmp113 = icmp slt i32 %24, %.sink
...
for.cond117:                                      ; preds = %for.inc129, %for.body115
  %25 = load i32, ptr %j116, align 4, !tbaa !5
  %cmp118 = icmp slt i32 %25, %.sink
...
for.inc129:                                       ; preds = %for.cond117
  ...
  store i32 %26, ptr %arrayidx128, align 4, !tbaa !5
  %inc130 = add nsw i32 %25, 1
...
for.cond136:                                      ; preds = %for.inc147, %for.end134
  %27 = load i32, ptr %i135, align 4, !tbaa !5
  %cmp137 = icmp slt i32 %27, %.sink
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %28 = load i32, ptr %arrayidx141, align 16, !tbaa !5
  %sub143 = sub nsw i32 %27, 1
  %idxprom144 = sext i32 %sub143 to i64
  %arrayidx145 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom144
  store i32 %28, ptr %arrayidx145, align 16, !tbaa !5
  %inc148 = add nsw i32 %27, 1
...
for.cond166:                                      ; preds = %for.inc188, %for.end164
  %31 = load i32, ptr %i165, align 4, !tbaa !5
  %cmp167 = icmp slt i32 %31, %.sink
...
for.cond171:                                      ; preds = %for.inc185, %for.body169
  %32 = load i32, ptr %j170, align 4, !tbaa !5
  %cmp172 = icmp slt i32 %32, %.sink
  br i1 %cmp172, label %for.inc185, label %for.inc188

for.inc185:                                       ; preds = %for.cond171
  %idxprom175 = sext i32 %31 to i64
...
for.inc195:                                       ; preds = %for.cond15
  ...
  %call193 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %34)
