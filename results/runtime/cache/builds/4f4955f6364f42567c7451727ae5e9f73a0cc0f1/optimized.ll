...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv55 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next56, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %wide.trip.count59
  br i1 %exitcond60.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv12
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp347 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp347, i32 %min.0, i32 %8
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  br label %for.cond22, !llvm.loop !13

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv16 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next17, %for.inc57 ]
  %exitcond21.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond21.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv16
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count26
  br i1 %exitcond44.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv40
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count32
  br i1 %exitcond33.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv40
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp826 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp826, i32 %min.2, i32 %12
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  ...
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count32
  br i1 %exitcond39.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv40
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv55
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count26
  br i1 %exitcond49.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv45, i64 %indvars.iv55
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count26
  br i1 %exitcond54.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv50
