...
for.inc:                                          ; preds = %cond.false, %for.body4
  %cond = phi i32 [ %4, %cond.false ], [ %3, %for.body4 ]
...
for.inc48:                                        ; preds = %cond.false45, %for.body34
  %cond47 = phi i32 [ %12, %cond.false45 ], [ %11, %for.body34 ]
