...
for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv29
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv25
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv43.in = phi i32 [ %indvars.iv43, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv43 = add i32 %indvars.iv43.in, -1
  %indvars.iv.next37 = add nsw i64 %indvars.iv36, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next37
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv39 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next40, %for.inc39 ]
  %exitcond47.not = icmp eq i64 %indvars.iv39, %wide.trip.count46
  br i1 %exitcond47.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv39
