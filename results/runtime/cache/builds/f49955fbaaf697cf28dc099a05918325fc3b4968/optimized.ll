...
for.end:                                          ; preds = %for.cond
  ...
  %smax99 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %2 = add nuw i32 %smax99, 1
  %wide.trip.count100 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond101 = icmp eq i64 %indvars.iv96, %wide.trip.count100
  br i1 %exitcond101, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax87 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.body19:                                       ; preds = %for.cond17
  ...
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv84, i64 %indvars.iv78
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv84, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv90 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next91, %for.inc56 ]
  %exitcond95.not = icmp eq i64 %indvars.iv90, %wide.trip.count
  br i1 %exitcond95.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv90, %indvars.iv96
  ...
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom59, i64 %indvars.iv90
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv106 = phi i64 [ %indvars.iv.next107, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond116.not = icmp eq i64 %indvars.iv111, %wide.trip.count115
  br i1 %exitcond116.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv111, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.inc118 ], [ %indvars.iv106, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv108 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv108, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond105.not = icmp eq i64 %indvars.iv102, 6
  br i1 %exitcond105.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv108, i64 %indvars.iv102
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv102
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv111, i64 %indvars.iv102
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.inc151 ], [ 1, %if.else ]
  %exitcond126.not = icmp eq i64 %indvars.iv117, %wide.trip.count125
  br i1 %exitcond126.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv117, i64 4
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars124.le = trunc i64 %indvars.iv117 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars124.le, %for.end153.split.loop.exit ], [ %3, %for.cond134 ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count141 = zext i32 %sub155 to i64
  %wide.trip.count136 = zext i32 %z.1.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv138 = phi i64 [ %indvars.iv.next139, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv131 = phi i64 [ %indvars.iv.next132, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond142.not = icmp eq i64 %indvars.iv138, %wide.trip.count141
  br i1 %exitcond142.not, label %for.cond207.preheader, label %for.body157

for.cond207.preheader:                            ; preds = %for.cond154
  br label %for.cond207

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv138, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv133 = phi i64 [ %indvars.iv.next134, %for.inc201 ], [ %indvars.iv131, %for.body157 ]
  %exitcond137.not = icmp eq i64 %indvars.iv133, %wide.trip.count136
  br i1 %exitcond137.not, label %for.cond154.loopexit, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv133, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv127 = phi i64 [ %indvars.iv.next128, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond130.not = icmp eq i64 %indvars.iv127, 6
  br i1 %exitcond130.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv133, i64 %indvars.iv127
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv127
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv138, i64 %indvars.iv127
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv146 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next147, %for.inc223 ]
  %exitcond150.not = icmp eq i64 %indvars.iv146, %wide.trip.count136
  br i1 %exitcond150.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv143 = phi i64 [ %indvars.iv.next144, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv143, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv146, i64 %indvars.iv143
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar76 = call i32 @putchar(i32 %conv218)
