...
define dso_local noundef range(i32 -2147483647, -2147483648) i32 @_Z2ljPiii(ptr noundef readonly captures(none) %a, i32 noundef %n, i32 noundef %m) local_unnamed_addr #3 {
entry:
  %b = alloca [25 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %b) #5
  %sub = add nsw i32 %m, -1
