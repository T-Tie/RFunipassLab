...
entry:
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef -1)
  %1 = add i32 %smax17, 1
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  ...
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.011) #10
  %smax38 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 0)
