...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 dereferenceable(40) %a) #6
...
if.else14:                                        ; preds = %if.end.thread
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #7
  br label %if.end19
...
if.then25:                                        ; preds = %if.end, %if.end.thread
  ...
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #7
