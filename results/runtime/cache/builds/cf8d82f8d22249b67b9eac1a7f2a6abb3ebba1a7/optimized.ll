...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv33.in = phi i32 [ %indvars.iv33, %for.end100 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %indvars.iv33 = add i32 %indvars.iv33.in, -1
  %smax70 = call i32 @llvm.smax.i32(i32 %indvars.iv33, i32 1)
  %smax59 = call i32 @llvm.smax.i32(i32 %indvars.iv33.in, i32 0)
  %0 = zext i32 %indvars.iv33 to i64
  %wide.trip.count44 = zext nneg i32 %smax59 to i64
  %wide.trip.count = zext i32 %indvars.iv33.in to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv36 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next37, %for.inc21 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond40.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv36
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv33.in, ptr @k, align 4, !tbaa !5
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond, !llvm.loop !13

for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv56 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next57, %for.inc62 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count44
  br i1 %exitcond61.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv56
  %4 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select25, %for.body34 ], [ %4, %for.body29 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond50.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv46, i64 %indvars.iv56
  %5 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select25 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv51 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next52, %for.inc59 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %wide.trip.count
  br i1 %exitcond55.not, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv51, i64 %indvars.iv56
...
for.end64:                                        ; preds = %for.cond27
  %cmp65 = icmp eq i32 %indvars.iv33.in, 2
  br i1 %cmp65, label %if.then, label %if.end

if.then:                                          ; preds = %for.end64
  store i32 %smax59, ptr @j, align 4, !tbaa !5
...
for.cond66:                                       ; preds = %for.cond81, %if.end
  %indvars.iv67 = phi i64 [ 1, %if.end ], [ %indvars.iv.next68, %for.cond81 ]
  %exitcond72.not = icmp eq i64 %indvars.iv67, %wide.trip.count71
  br i1 %exitcond72.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next68
  %9 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv67
  store i32 %9, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next68
  %10 = load i32, ptr %arrayidx76, align 16, !tbaa !5
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv67
  store i32 %10, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %0
  br i1 %exitcond66.not, label %for.cond66, label %for.inc95, !llvm.loop !17

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next68, i64 %indvars.iv.next63
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv67, i64 %indvars.iv62
  store i32 %11, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.cond81, !llvm.loop !18

for.end100:                                       ; preds = %for.cond66
  store i32 %smax70, ptr @i, align 4, !tbaa !5
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %storemerge7 = phi i32 [ %inc11, %for.inc10 ], [ 0, %for.cond ]
  store i32 %storemerge7, ptr @j, align 4, !tbaa !5
  %cmp2 = icmp slt i32 %storemerge7, %1
  br i1 %cmp2, label %for.cond4, label %for.inc16

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre9, %for.inc ], [ %1, %for.cond1 ]
  %storemerge8 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond1 ]
  store i32 %storemerge8, ptr @k, align 4, !tbaa !5
  %cmp5 = icmp slt i32 %storemerge8, %2
  br i1 %cmp5, label %for.inc, label %for.inc10

for.inc:                                          ; preds = %for.cond4
  %3 = load i32, ptr @j, align 4, !tbaa !5
  %idxprom = sext i32 %3 to i64
  %idxprom7 = sext i32 %storemerge8 to i64
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  ...
  %storemerge6 = phi i32 [ %inc27, %for.inc26 ], [ 0, %for.cond ]
  store i32 %storemerge6, ptr @l, align 4, !tbaa !5
  %cmp20 = icmp slt i32 %storemerge6, %7
  br i1 %cmp20, label %for.inc26, label %for.end28

for.inc26:                                        ; preds = %for.cond19
  %idxprom22 = sext i32 %storemerge6 to i64
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call24, i8 noundef signext %call.i5)
