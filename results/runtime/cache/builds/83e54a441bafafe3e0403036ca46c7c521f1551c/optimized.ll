...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull %c) #6
  ...
  %smax47 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef -1)
  %1 = add i32 %smax47, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc12 ], [ 0, %entry ]
  %exitcond49 = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49, label %for.cond15.preheader, label %for.cond4.preheader
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.cond15.loopexit
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond59 = icmp eq i64 %indvars.iv55, %wide.trip.count48
  br i1 %exitcond59, label %for.cond45.preheader, label %for.body19

for.cond45.preheader:                             ; preds = %for.cond15
  br label %for.cond45

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv55
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv55
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc39 ], [ %indvars.iv50, %for.body19 ]
  %4 = trunc nuw i64 %indvars.iv52 to i32
  %cmp24.not = icmp slt i32 %sub, %4
  br i1 %cmp24.not, label %for.cond15.loopexit, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv52
  %call32 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %arrayidx27, ptr noundef nonnull dereferenceable(1) %arrayidx30) #9
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc66
  %k.0 = phi i32 [ %dec, %for.inc66 ], [ 500, %for.cond45.preheader ]
  %z.0 = phi i32 [ %z.1, %for.inc66 ], [ 0, %for.cond45.preheader ]
...
land.end:                                         ; preds = %for.cond45
  br i1 %cmp68, label %for.cond49.preheader, label %if.else71.loopexit

for.cond49.preheader:                             ; preds = %land.end
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc63
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc63 ], [ 0, %for.cond49.preheader ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %for.cond49.preheader ]
  %exitcond64 = icmp eq i64 %indvars.iv60, %wide.trip.count48
  br i1 %exitcond64, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv60
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.041 = phi i32 [ %8, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.041)
  %smax68 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 0)
  %wide.trip.count69 = zext nneg i32 %smax68 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond70.not = icmp eq i64 %indvars.iv65, %wide.trip.count69
  br i1 %exitcond70.not, label %if.end86.loopexit, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv65
  ...
  %puts = call i32 @puts(ptr noundef nonnull dereferenceable(1) %arrayidx80) #10
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  br label %for.cond74, !llvm.loop !18

if.end86.loopexit:                                ; preds = %for.cond74
  br label %if.end86

if.end86:                                         ; preds = %if.end86.loopexit, %if.then69
