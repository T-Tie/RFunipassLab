...
for.body:                                         ; preds = %for.cond
  ...
  %.sink2 = select i1 %or.cond40, i32 29, i32 28
...
for.cond40.preheader:                             ; preds = %for.cond2
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond40
...
for.inc:                                          ; preds = %if.end, %if.then28, %if.end26.thread
  %total1.3 = phi i32 [ %add37, %if.then28 ], [ %add25, %if.end26.thread ], [ %total1.1, %if.end ]
...
for.inc85:                                        ; preds = %if.end58, %if.then70, %if.end68.thread
  %total2.3 = phi i32 [ %add82, %if.then70 ], [ %add67, %if.end68.thread ], [ %total2.1, %if.end58 ]
...
for.end87:                                        ; preds = %for.cond40
  ...
  %puts43 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
