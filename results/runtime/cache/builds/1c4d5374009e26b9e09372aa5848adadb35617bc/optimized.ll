...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.end ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv38, %1
...
for.cond12:                                       ; preds = %for.end27, %for.end10
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.end27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv44, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv41, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.end27

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv44, i64 %indvars.iv41
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax60 = call i32 @llvm.smax.i32(i32 %8, i32 0)
...
for.cond31:                                       ; preds = %for.end59, %for.end30
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.end59 ], [ 0, %for.end30 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count61
  br i1 %exitcond62.not, label %for.cond63, label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.inc57
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc57 ], [ 0, %for.cond31 ]
  %exitcond56.not = icmp eq i64 %indvars.iv51, %wide.trip.count55
  br i1 %exitcond56.not, label %for.end59, label %for.cond39

for.cond39:                                       ; preds = %for.cond35, %for.body41
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body41 ], [ 0, %for.cond35 ]
...
for.body41:                                       ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv47
  %11 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !13
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv47, i64 %indvars.iv51
...
for.inc57:                                        ; preds = %for.cond39
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv57, i64 %indvars.iv51
...
for.cond63:                                       ; preds = %for.cond31, %for.end84
  ...
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.end84 ], [ 0, %for.cond31 ]
  %14 = sext i32 %13 to i64
  %cmp65.not.not = icmp slt i64 %indvars.iv67, %14
...
if.end.peel:                                      ; preds = %for.cond67.preheader
  %arrayidx75.peel = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv67, i64 0
...
for.cond67:                                       ; preds = %if.end.peel, %if.end
  %indvars.iv63 = phi i64 [ 1, %if.end.peel ], [ %indvars.iv.next64, %if.end ]
  %17 = load i32, ptr %y2, align 4, !tbaa !5
  %18 = sext i32 %17 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv63, %18
  br i1 %cmp69.not.not, label %if.end, label %for.end84

if.end:                                           ; preds = %for.cond67
  %arrayidx80 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv67, i64 %indvars.iv63
