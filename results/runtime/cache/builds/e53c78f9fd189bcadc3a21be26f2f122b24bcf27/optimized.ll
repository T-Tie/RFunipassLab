...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call8 = call double @sqrt(double noundef %4) #5, !tbaa !5
  %add = fadd double %fneg, %call8
  %mul = fmul double 2.000000e+00, %2
  %div = fdiv double %add, %mul
  %call14 = call double @sqrt(double noundef %4) #5, !tbaa !5
...
if.then36:                                        ; preds = %if.then34
  ...
  %13 = call double @llvm.fmuladd.f64(double %mul30, double %11, double %neg40)
  %call41 = call double @sqrt(double noundef %13) #5, !tbaa !5
  %mul42 = fmul double 2.000000e+00, %10
  %div43 = fdiv double %call41, %mul42
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef 0.000000e+00, double noundef %div43, double noundef 0.000000e+00, double noundef %div43)
  br label %if.end56
...
if.else:                                          ; preds = %if.then34
  ...
  %14 = call double @llvm.fmuladd.f64(double %mul30, double %11, double %neg51)
  %call52 = call double @sqrt(double noundef %14) #5, !tbaa !5
  %div54 = fdiv double %call52, %mul46
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div47, double noundef %div54, double noundef %div47, double noundef %div54)
  br label %if.end56
