; ModuleID = '<stdin>'
source_filename = "/tmp/tmp0zwtbcoz.cpp"
...
for.cond13:                                       ; preds = %for.end26, %for.end10
  ...
  %5 = sext i32 %4 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv40, %5
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  ...
  %7 = sext i32 %6 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv37, %7
...
for.cond30:                                       ; preds = %for.cond13, %for.end73
  %i.2 = phi i32 [ %inc9.i3, %for.end73 ], [ 1, %for.cond13 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp31.not = icmp sgt i32 %i.2, %8
  br i1 %cmp31.not, label %for.end76, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc71
  %j.2 = phi i32 [ %inc72, %for.inc71 ], [ 1, %for.cond30 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp34.not = icmp sgt i32 %j.2, %9
  br i1 %cmp34.not, label %for.end73, label %for.cond40.preheader
...
for.cond40.preheader:                             ; preds = %for.cond33
  ...
  br i1 %cmp63, label %land.lhs.true, label %if.then68

land.lhs.true:                                    ; preds = %for.cond40.preheader
  %11 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp64.not = icmp eq i32 %i.2, %11
  br i1 %cmp64.not, label %for.inc71, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %call65 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc71

if.then68:                                        ; preds = %for.cond40.preheader
  %call69 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %for.inc71

for.inc71:                                        ; preds = %land.lhs.true, %if.then, %if.then68
  %inc72 = add nuw nsw i32 %j.2, 1
  br label %for.cond33, !llvm.loop !13

for.end73:                                        ; preds = %for.cond33
  %inc9.i3 = add nuw nsw i32 %i.2, 1
  br label %for.cond30
