...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000000, ptr noundef nonnull %board) #6
...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv23, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre31, %for.inc ]
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc26
  ...
  %i.1 = phi i32 [ %inc27, %for.inc26 ], [ 0, %for.cond11.preheader ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv27 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next28, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv27
  %4 = load i32, ptr %add.ptr21, align 4, !tbaa !5, !invariant.load !13
  %cmp22 = icmp eq i32 %4, 0
  br i1 %cmp22, label %for.inc26.split.loop.exit33, label %for.inc23

for.inc23:                                        ; preds = %for.body16
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond14, !llvm.loop !14

for.inc26.split.loop.exit33:                      ; preds = %for.body16
  %5 = trunc nuw nsw i64 %indvars.iv27 to i32
  br label %for.inc26

for.inc26:                                        ; preds = %for.cond14, %for.inc26.split.loop.exit33
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit33 ], [ %r1.0, %for.cond14 ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit33 ], [ %c1.0, %for.cond14 ]
  %i.2 = phi i32 [ 9999, %for.inc26.split.loop.exit33 ], [ %i.1, %for.cond14 ]
...
for.body35:                                       ; preds = %for.cond33
  ...
  %6 = load i32, ptr %add.ptr40, align 4, !tbaa !5, !invariant.load !13
...
for.end48:                                        ; preds = %for.cond29
  %7 = xor i32 %r1.0, -1
  %sub50 = add i32 %r2.0, %7
  %8 = xor i32 %c1.0, -1
  %sub52 = add i32 %c2.0, %8
  ...
  %vtable.i = load ptr, ptr %call54, align 8, !tbaa !18, !invariant.load !13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call54, i8 noundef signext %call.i1)
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !20, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !44, !invariant.load !13
  br label %return
