...
for.end35:                                        ; preds = %for.cond10
  ...
  store i32 %10, ptr %dm, align 4, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37
...
for.body39:                                       ; preds = %for.cond37
  ...
  %13 = load i32, ptr %dm, align 4, !tbaa !5
  %cmp42 = icmp sgt i32 %12, %13
  br i1 %cmp42, label %if.then43, label %if.end46

if.then43:                                        ; preds = %for.body39
  store i32 %12, ptr %dm, align 4, !tbaa !5
  br label %if.end46
...
for.end49:                                        ; preds = %for.cond37
  ...
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %14)
