...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %2 = sext i32 %1 to i64
  %cmp = icmp slt i64 %indvars.iv29, %2
  br i1 %cmp, label %for.cond1, label %for.cond10.preheader

for.cond10.preheader:                             ; preds = %for.cond
  %smax41 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [50 x [50 x i32]], ptr %k, i64 0, i64 %indvars.iv29, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc25
  %indvars.iv37 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next38, %for.inc25 ]
  %sum.0 = phi i32 [ 0, %for.cond10.preheader ], [ %sum.1, %for.inc25 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %for.end27, label %for.cond13
...
for.cond13:                                       ; preds = %for.cond10, %for.body15
  ...
  br i1 %exitcond36.not, label %for.inc25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [50 x [50 x i32]], ptr %k, i64 0, i64 %indvars.iv37, i64 %indvars.iv32
