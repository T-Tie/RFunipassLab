...
for.body:                                         ; preds = %entry, %for.inc
  %indvars.iv29 = phi i32 [ 1, %entry ], [ %indvars.iv.next30, %for.inc ]
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc41
  %indvars.iv26 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next27, %for.inc41 ]
...
for.inc41:                                        ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [999 x i32], ptr %g, i64 0, i64 %indvars.iv26
