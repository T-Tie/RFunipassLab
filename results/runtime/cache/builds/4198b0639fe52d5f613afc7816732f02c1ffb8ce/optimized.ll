...
for.inc:                                          ; preds = %for.body3, %land.lhs.true
  %f.220 = phi i32 [ %f.2.ph, %land.lhs.true ], [ %f.1, %for.body3 ]
  %star2.218 = phi i32 [ %star2.2.ph, %land.lhs.true ], [ %star2.1, %for.body3 ]
  %star1.216 = phi i32 [ %star1.2.ph, %land.lhs.true ], [ %star1.1, %for.body3 ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub22 = add i32 %star2.0.neg, 1
  %add28 = add i32 %reass.sub22, %end2.0
