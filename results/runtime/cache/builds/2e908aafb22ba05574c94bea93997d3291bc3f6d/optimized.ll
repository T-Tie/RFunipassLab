...
if.then11:                                        ; preds = %if.else5
  ...
  %call = tail call noundef i32 @_Z5afteriii(i32 noundef %6, i32 noundef %5, i32 noundef %n) #7
