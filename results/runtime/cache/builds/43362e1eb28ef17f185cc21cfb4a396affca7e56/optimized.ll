...
for.cond10:                                       ; preds = %for.end33, %for.end9
  %4 = phi i32 [ %dec, %for.end33 ], [ %sub, %for.end9 ]
...
for.cond13:                                       ; preds = %if.end, %for.body12
  %j.0 = phi i32 [ %add, %for.body12 ], [ %inc32, %if.end ]
...
for.cond37:                                       ; preds = %if.end46, %for.end35
  %dm.0 = phi i32 [ %9, %for.end35 ], [ %dm.1, %if.end46 ]
