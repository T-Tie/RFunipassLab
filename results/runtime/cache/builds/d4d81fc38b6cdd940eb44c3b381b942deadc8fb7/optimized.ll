...
for.inc24:                                        ; preds = %for.cond13, %if.then
  %j1.1 = phi i32 [ %j.1, %if.then ], [ %j1.0, %for.cond13 ]
  %i1.1 = phi i32 [ %i.1, %if.then ], [ %i1.0, %for.cond13 ]
...
for.inc42:                                        ; preds = %for.cond30, %if.then38
  %i2.1 = phi i32 [ %i.2, %if.then38 ], [ %i2.0, %for.cond30 ]
  %j2.1 = phi i32 [ %j.2, %if.then38 ], [ %j2.0, %for.cond30 ]
