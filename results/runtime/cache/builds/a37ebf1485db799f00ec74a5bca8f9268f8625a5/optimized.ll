...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %5) #5, !tbaa !5
  %add = fsub double %call5, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call7 = call double @sqrt(double noundef %5) #5, !tbaa !5
...
if.then19:                                        ; preds = %if.end17
  ...
  %call24 = call double @sqrt(double noundef %fneg23) #5, !tbaa !5
  %div26 = fdiv double %call24, %mul21
  %call28 = call double @sqrt(double noundef %fneg23) #5, !tbaa !5
