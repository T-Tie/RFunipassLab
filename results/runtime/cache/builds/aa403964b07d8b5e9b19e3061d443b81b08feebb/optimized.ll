...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  %c.0 = phi i32 [ 0, %for.end33 ], [ %c.1.lcssa, %for.inc53 ]
  %i.2 = phi i32 [ 0, %for.end33 ], [ %inc54, %for.inc53 ]
  %d.0 = phi i32 [ 0, %for.end33 ], [ %d.1.lcssa, %for.inc53 ]
  %cmp35 = icmp slt i32 %i.2, %.lcssa
...
for.inc53:                                        ; preds = %for.cond37
  %c.1.lcssa = phi i32 [ %c.1, %for.cond37 ]
  %d.1.lcssa = phi i32 [ %d.1, %for.cond37 ]
  %inc54 = add nsw i32 %i.2, 1
  br label %for.cond34, !llvm.loop !16

for.end55:                                        ; preds = %for.cond34
  %c.0.lcssa = phi i32 [ %c.0, %for.cond34 ]
  %d.0.lcssa = phi i32 [ %d.0, %for.cond34 ]
  %b.1.neg = sub i32 0, %b.1
  %sub = add i32 %b.1.neg, -1
  %sub56 = add i32 %sub, %d.0.lcssa
  %a.1.neg = sub i32 0, %a.1
  %sub57 = add i32 %a.1.neg, -1
  %sub58 = add i32 %sub57, %c.0.lcssa
