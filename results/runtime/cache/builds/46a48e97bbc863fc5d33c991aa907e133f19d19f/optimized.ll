...
entry:
  ...
  br i1 %cmp.not, label %if.then6, label %for.cond

for.cond:                                         ; preds = %entry, %for.inc
  %i.0 = phi i32 [ %inc, %for.inc ], [ %x, %entry ]
  %cmp1.not = icmp sgt i32 %i.0, %a
  br i1 %cmp1.not, label %if.end8, label %for.body
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %a, %i.0
  tail call void @_Z6yinshuii(i32 noundef %div, i32 noundef %i.0) #9
  br label %for.inc
