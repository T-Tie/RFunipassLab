...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv25 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next26, %for.body4 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv25
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  ...
  br i1 %exitcond33.not, label %for.end28, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv29
...
for.end28:                                        ; preds = %for.cond13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call29, i8 noundef signext %call.i12)
  ...
  %vtable.i13 = load ptr, ptr %call31, align 8, !tbaa !14
  %vbase.offset.ptr.i14 = getelementptr i8, ptr %vtable.i13, i64 -24
  %vbase.offset.i15 = load i64, ptr %vbase.offset.ptr.i14, align 8, !invariant.load !16
  %add.ptr.i16 = getelementptr inbounds i8, ptr %call31, i64 %vbase.offset.i15
  ...
  %call1.i17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call31, i8 noundef signext %call.i)
