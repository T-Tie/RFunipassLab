...
for.body40:                                       ; preds = %for.cond38
  br i1 %cmp55, label %for.end61, label %if.else47
...
for.end61:                                        ; preds = %for.body40, %for.cond34, %for.end50
  %x2.1 = phi i32 [ %x2.2, %for.end50 ], [ %x2.0, %for.cond34 ], [ %i.2, %for.body40 ]
  %y2.1 = phi i32 [ %y2.2, %for.end50 ], [ %y2.0, %for.cond34 ], [ %j.2, %for.body40 ]
