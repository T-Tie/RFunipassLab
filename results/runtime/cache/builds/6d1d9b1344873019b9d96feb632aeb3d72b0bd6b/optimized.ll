...
if.then34:                                        ; preds = %if.else
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i5)
...
if.else37:                                        ; preds = %if.else
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i21)
...
define internal void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) #5 {
newFuncRoot:
