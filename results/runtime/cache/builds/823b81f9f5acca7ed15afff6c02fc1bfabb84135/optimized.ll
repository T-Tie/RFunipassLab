...
for.cond:                                         ; preds = %for.end27, %entry
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.end27 ], [ 0, %entry ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv37
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body16 ], [ 0, %for.cond14.preheader ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36.not, label %for.end27, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv32
...
for.cond31:                                       ; preds = %for.cond, %for.end68
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.end68 ], [ 0, %for.cond ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count40
  br i1 %exitcond56.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv52
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select30, %for.body39 ], [ %3, %for.body33 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond46.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv52
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %spec.select30 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  br label %for.cond37, !llvm.loop !15

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body56 ], [ 0, %for.cond54.preheader ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond51.not, label %for.end68, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv52
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
  %smax18 = tail call i32 @llvm.smax.i32(i32 %sub, i32 noundef 1)
  %wide.trip.count19 = zext nneg i32 %smax18 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond1, %entry
  %indvars.iv15 = phi i64 [ 1, %entry ], [ %indvars.iv.next16, %for.cond1 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond13.preheader, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond, label %for.body3, !llvm.loop !18

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next16, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !9
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv
  store i32 %0, ptr %arrayidx9, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !19

for.cond13:                                       ; preds = %for.cond17, %for.cond13.preheader
  %indvars.iv26 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next27, %for.cond17 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count19
  br i1 %exitcond30.not, label %for.end35, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.body20
  %indvars.iv21 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next22, %for.body20 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond13, label %for.body20, !llvm.loop !20

for.body20:                                       ; preds = %for.cond17
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv.next27
  %1 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !9
  %arrayidx29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
...
for.cond1:                                        ; preds = %for.cond.cleanup7, %for.body
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond.cleanup7 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv
