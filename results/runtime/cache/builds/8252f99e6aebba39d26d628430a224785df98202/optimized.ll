...
for.cond:                                         ; preds = %for.inc28, %entry
  ...
  br i1 %exitcond42.not, label %for.cond31, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc25 ], [ 0, %for.cond14.preheader ]
...
for.cond31:                                       ; preds = %for.cond, %for.inc69
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc69 ], [ 0, %for.cond ]
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc66 ], [ 0, %for.cond54.preheader ]
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = tail call i32 @llvm.smax.i32(i32 %n, i32 0)
  %smax19 = tail call i32 @llvm.smax.i32(i32 %sub, i32 1)
