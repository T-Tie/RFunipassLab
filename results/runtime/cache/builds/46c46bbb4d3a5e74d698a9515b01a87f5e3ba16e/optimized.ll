...
for.end:                                          ; preds = %for.cond
  ...
  %smax100 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.cond14.preheader:                             ; preds = %for.cond11
  %smax88 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.inc220:                                       ; preds = %for.cond211
  ...
  %putchar77 = call i32 @putchar(i32 noundef %conv218) #9
