...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond15.not = icmp eq i64 %indvars.iv10, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond21, label %for.body4
...
for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc15 ], [ %indvars.iv4, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv6
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv23.in = phi i32 [ %indvars.iv23, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv23 = add i32 %indvars.iv23.in, -1
  %indvars.iv.next18 = add nsw i64 %indvars.iv17, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next18
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv20 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next21, %for.inc39 ]
  %exitcond27.not = icmp eq i64 %indvars.iv20, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv20
...
for.end41:                                        ; preds = %for.cond28
  %arrayidx23.le = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next18
