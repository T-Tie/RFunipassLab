...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 201, ptr noundef nonnull align 16 dereferenceable(201) %a) #8
...
for.cond:                                         ; preds = %for.inc, %entry
  %f.0 = phi i32 [ 0, %entry ], [ %f.1, %for.inc ]
...
if.then:                                          ; preds = %for.body
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %0)
  br label %for.inc
...
for.inc:                                          ; preds = %if.then, %if.then9, %if.else
  %f.1 = phi i32 [ 1, %if.then ], [ 0, %if.then9 ], [ %f.0, %if.else ]
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 201, ptr noundef %a) #10
  ret i32 0
}
