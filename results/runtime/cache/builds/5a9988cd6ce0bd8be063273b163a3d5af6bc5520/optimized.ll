...
for.cond4:                                        ; preds = %for.end28, %for.end
  %max.0 = phi i32 [ 0, %for.end ], [ %max.1, %for.end28 ]
...
for.cond7:                                        ; preds = %if.end26, %for.body6
  %4 = phi i32 [ %dec, %if.end26 ], [ %sub, %for.body6 ]
  %max.1 = phi i32 [ %max.0, %for.body6 ], [ %max.2, %if.end26 ]
...
if.end26:                                         ; preds = %if.then, %if.then24, %if.then20, %for.body9
