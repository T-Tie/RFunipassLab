...
entry:
  %call = call i64 @strlen(ptr noundef @a) #11
...
for.body:                                         ; preds = %for.cond
  %1 = load i8, ptr %p.0, align 1, !tbaa !9, !invariant.load !10
  %conv1 = sext i8 %1 to i32
  %cmp2 = icmp ne i32 %conv1, 32
  %idxprom7 = sext i32 %0 to i64
  %2 = getelementptr inbounds [100 x i8], ptr @a, i64 0, i64 %idxprom7
  %3 = load i8, ptr %2, align 1, !tbaa !9, !invariant.load !10
  br i1 %cmp2, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.body
  %arrayidx = getelementptr inbounds [100 x i8], ptr @a, i64 0, i64 %idxprom7
...
land.lhs.true:                                    ; preds = %lor.lhs.false
  ...
  %4 = load i8, ptr %add.ptr, align 1, !tbaa !9, !invariant.load !10
  %conv5 = sext i8 %4 to i32
  %cmp6 = icmp ne i32 %conv5, 32
  br i1 %cmp6, label %if.then, label %for.inc

if.then:                                          ; preds = %land.lhs.true, %for.body
  %arrayidx8 = getelementptr inbounds [100 x i8], ptr @a, i64 0, i64 %idxprom7
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %3)
  br label %for.inc
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !14, !invariant.load !10
...
entry:
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(100) @a, i64 noundef 100)
  call void @_Z2sfv()
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(100) @a)
  ret i32 0
}
...
entry:
  %vtable = load ptr, ptr %this, align 8, !tbaa !14, !invariant.load !10
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !14, !invariant.load !10
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !14, !invariant.load !10
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !16, !invariant.load !10
  ret i64 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !27, !invariant.load !10
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !35, !invariant.load !10
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !41, !invariant.load !10
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !42, !invariant.load !10
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !43, !invariant.load !10
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !46, !invariant.load !10
  ret ptr %0
}
...
!42 = !{!17, !20, i64 32}
!43 = !{!44, !45, i64 16}
!44 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !45, i64 8, !45, i64 16, !45, i64 24, !45, i64 32, !45, i64 40, !45, i64 48, !25, i64 56}
