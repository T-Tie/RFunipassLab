...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %.pre11 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
...
for.inc:                                          ; preds = %for.cond, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre11, %land.lhs.true ], [ %.pre11, %for.cond ]
