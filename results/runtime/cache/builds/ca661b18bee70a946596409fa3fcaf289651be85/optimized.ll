...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 32, ptr noundef nonnull align 16 %res) #7
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(32) %res, ptr noundef nonnull readonly align 16 dereferenceable(32) @__const.main.res, i64 noundef 32, i1 noundef false) #8
...
for.end30:                                        ; preds = %for.cond20
  ...
  %puts = call i32 @puts(ptr noundef nonnull readonly captures(none) dereferenceable(1) %res) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #9
  call void @llvm.lifetime.end.p0(i64 noundef 32, ptr noundef nonnull %res) #9
  ret i32 0
}
