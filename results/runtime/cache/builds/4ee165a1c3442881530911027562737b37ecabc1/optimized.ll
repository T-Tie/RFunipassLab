; ModuleID = '<stdin>'
source_filename = "/tmp/tmpwhxl5i_b.cpp"
...
entry:
  ...
  store i32 100, ptr %a, align 16, !tbaa !5
  ...
  %arrayidx3 = getelementptr inbounds nuw i8, ptr %a, i64 12
  ...
  %arrayidx5 = getelementptr inbounds nuw i8, ptr %a, i64 20
...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %s.0 = phi i32 [ %sub15.recomposed, %for.body ], [ %0, %entry ]
  %exitcond.not = icmp eq i64 %indvars.iv, 6
  br i1 %exitcond.not, label %for.end, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx6 = getelementptr inbounds nuw [6 x i32], ptr %a, i64 0, i64 %indvars.iv
  %1 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  %div = sdiv i32 %s.0, %1
  %mul = mul nsw i32 %div, %1
  %sub15.recomposed = srem i32 %s.0, %1
  %call18 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div)
