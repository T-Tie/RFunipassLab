...
for.cond23:                                       ; preds = %for.inc41, %for.body22
  %.sink24 = phi i32 [ 0, %for.body22 ], [ %inc42, %for.inc41 ]
  %cmp24 = icmp slt i32 %.sink24, %.sink
  br i1 %cmp24, label %for.body26, label %for.end43

for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i32 %.sink24, 0
  %idxprom28 = sext i32 %6 to i64
  %idxprom30 = sext i32 %.sink24 to i64
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  %.sink23 = phi i32 [ 0, %for.body63 ], [ %inc91, %for.inc90 ]
  %cmp66 = icmp slt i32 %.sink23, %.sink
  br i1 %cmp66, label %for.body68, label %for.end92

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i32 %.sink23, 0
  %idxprom71 = sext i32 %.sink23 to i64
