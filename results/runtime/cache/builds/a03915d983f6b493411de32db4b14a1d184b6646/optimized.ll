...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc23 ], [ 0, %entry ]
  %s.0 = phi i32 [ %s.1, %for.inc23 ], [ 0, %entry ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, 28
  br i1 %exitcond15.not, label %for.end25, label %for.cond3.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %arrayidx9 = getelementptr inbounds nuw [27 x i8], ptr @__const.main.zimu, i64 0, i64 %indvars.iv12
  br label %for.cond3
