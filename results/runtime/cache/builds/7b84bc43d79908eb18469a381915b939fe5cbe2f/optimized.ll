...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv57 = phi i32 [ %indvars.iv.next58, %for.inc18 ], [ 0, %entry ]
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc18 ], [ 0, %entry ]
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #8
  %sub = sub i64 %call4, %conv5
  %cmp.not = icmp ult i64 %sub, %indvars.iv49
...
for.inc:                                          ; preds = %for.cond6
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv49
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %1
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv49, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv49, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv54 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next55, %for.inc26 ]
  %exitcond60.not = icmp eq i64 %indvars.iv54, %wide.trip.count59
  br i1 %exitcond60.not, label %for.cond29, label %for.inc26

for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv54
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  br label %for.cond21, !llvm.loop !14

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond72.not = icmp eq i64 %indvars.iv61, %wide.trip.count59
  br i1 %exitcond72.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv61
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv61
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv63 = phi i64 [ %indvars.iv61, %for.cond32.preheader ], [ %indvars.iv.next64, %for.inc51 ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count59
  br i1 %exitcond68.not, label %for.inc54, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv63
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv63
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond78.not = icmp eq i64 %indvars.iv73, %wide.trip.count59
  br i1 %exitcond78.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv73
...
if.else:                                          ; preds = %for.end69
  ...
  %vtable.i26 = load ptr, ptr %call74, align 8, !tbaa !18
  %vbase.offset.ptr.i27 = getelementptr i8, ptr %vtable.i26, i64 -24
  %vbase.offset.i28 = load i64, ptr %vbase.offset.ptr.i27, align 8, !invariant.load !20
  %add.ptr.i29 = getelementptr inbounds i8, ptr %call74, i64 %vbase.offset.i28
  ...
  %call1.i30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call74, i8 noundef signext %call.i)
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc89 ], [ 0, %if.else ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count59
  br i1 %exitcond84.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv79
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv79
  %call.i.i20 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx84) #9
  %call1.i21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx84, i64 noundef %call.i.i20)
  %vtable.i32 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !18
  %vbase.offset.ptr.i33 = getelementptr i8, ptr %vtable.i32, i64 -24
  %vbase.offset.i34 = load i64, ptr %vbase.offset.ptr.i33, align 8, !invariant.load !20
  ...
  %call1.i37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i36)
