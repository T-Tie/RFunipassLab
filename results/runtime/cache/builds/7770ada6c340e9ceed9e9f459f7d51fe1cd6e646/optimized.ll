...
if.end28:                                         ; preds = %if.then8, %if.end
  %9 = load double, ptr @j, align 8, !tbaa !9
...
if.then39:                                        ; preds = %if.end37
  ...
  %call50 = call double @sqrt(double noundef %18) #6, !tbaa !5
  ...
  %call65 = call double @sqrt(double noundef %24) #6, !tbaa !5
