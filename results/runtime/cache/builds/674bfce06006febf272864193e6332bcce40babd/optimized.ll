...
for.body6:                                        ; preds = %for.cond3
  ...
  call void @outlined_ir_func_0(i8 %4, ptr noundef nonnull dereferenceable(1) %__c.addr.i)
  br label %for.inc
...
for.body17:                                       ; preds = %for.cond14
  ...
  call void @outlined_ir_func_0(i8 %5, ptr noundef nonnull dereferenceable(1) %__c.addr.i3)
  br label %for.inc21
...
newFuncRoot:
  br label %for.body6_to_outline

for.body6_to_outline:                             ; preds = %newFuncRoot
