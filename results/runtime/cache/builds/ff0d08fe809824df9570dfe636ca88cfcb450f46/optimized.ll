...
for.cond.i:                                       ; preds = %for.inc.i, %if.then
  %__first.addr.0.i = phi ptr [ %add.ptr, %if.then ], [ %incdec.ptr.i, %for.inc.i ]
...
while.cond.i.i:                                   ; preds = %while.body.i.i, %for.body.i
  %__last.addr.0.i.i = phi ptr [ %__first.addr.0.i, %for.body.i ], [ %__next.0.i.i, %while.body.i.i ]
...
if.else10:                                        ; preds = %if.else7
  ...
  %.17 = tail call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %__c.__b = select i1 %cmp.i4, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.else10, %if.else7, %if.else, %if.then
  %.sink = phi i32 [ %1, %if.then ], [ %., %if.else ], [ %0, %if.else7 ], [ %.17, %if.else10 ]
