...
for.cond11:                                       ; preds = %for.cond14, %for.cond11.preheader
  %l.0.in = phi i32 [ %j.0, %for.cond11.preheader ], [ %l.0, %for.cond14 ]
  %l.0 = add nsw i32 %l.0.in, -1
  %cmp12 = icmp sgt i32 %l.0.in, 0
  br i1 %cmp12, label %for.cond14, label %for.cond39.preheader

for.cond39.preheader:                             ; preds = %for.cond11
  %smax = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 1)
  %wide.trip.count31 = zext nneg i32 %smax to i64
  br label %for.cond39

for.cond14:                                       ; preds = %for.cond11, %for.inc34
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc34 ], [ 0, %for.cond11 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [501 x i32], ptr %b, i64 0, i64 %indvars.iv23
  %4 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %arrayidx20 = getelementptr inbounds nuw [501 x i32], ptr %b, i64 0, i64 %indvars.iv.next24
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc45
  %indvars.iv27 = phi i64 [ 1, %for.cond39.preheader ], [ %indvars.iv.next28, %for.inc45 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end47, label %for.inc45

for.inc45:                                        ; preds = %for.cond39
  %arrayidx43 = getelementptr inbounds nuw [501 x i32], ptr %b, i64 0, i64 %indvars.iv27
