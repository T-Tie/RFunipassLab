...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %b.0 = phi i32 [ %spec.select, %for.body ], [ 0, %entry ]
...
for.cond11.preheader:                             ; preds = %for.cond
  ...
  %call58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef undef)
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select = add nuw nsw i32 %b.0, %inc
