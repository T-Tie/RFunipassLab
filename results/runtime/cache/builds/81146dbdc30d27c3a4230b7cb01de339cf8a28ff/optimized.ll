...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  ...
  %exitcond19.not = icmp eq i32 %m.0, %smax18
...
for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count23 = zext nneg i32 %smax18 to i64
  br label %for.cond47
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv20 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next21, %for.inc55 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv20
