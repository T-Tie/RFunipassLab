...
while.cond:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %indvars.iv5 = phi i32 [ %indvars.iv.next6, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ -1, %entry ]
...
NodeBlock:                                        ; preds = %while.cond
  %Pivot = icmp slt i64 %0, 0
  br i1 %Pivot, label %LeafBlock, label %LeafBlock7

LeafBlock7:                                       ; preds = %NodeBlock
  %SwitchLeaf8 = icmp eq i64 %0, 0
  br i1 %SwitchLeaf8, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i64 %0, -1
  br i1 %SwitchLeaf, label %if.else34.i, label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock7
...
if.then6.i:                                       ; preds = %LeafBlock7, %LeafBlock
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  ...
  br i1 %call1, label %while.cond, label %for.cond.preheader, !llvm.loop !22

for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv5, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %sentence, i64 0, i64 %indvars.iv2
  %call5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx3)
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call5, ptr noundef nonnull @.str)
...
; Function Attrs: mustprogress uwtable
declare noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64)) local_unnamed_addr #2 align 2
