...
for.cond:                                         ; preds = %for.inc, %entry
  %n.promoted10 = phi i32 [ %.pre, %for.inc ], [ %0, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %1 = sext i32 %n.promoted10 to i64
...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  %2 = phi i32 [ %3, %for.inc30 ], [ %n.promoted10, %for.cond ]
...
for.cond6:                                        ; preds = %for.cond3, %for.inc27
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc27 ], [ 0, %for.cond3 ]
  %i.1 = phi i32 [ %i.2, %for.inc27 ], [ %i.0, %for.cond3 ]
  %4 = sext i32 %i.1 to i64
  %cmp7 = icmp slt i64 %indvars.iv18, %4
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv18
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv15 = phi i64 [ %4, %for.cond15.preheader ], [ %indvars.iv.next16, %for.inc23 ]
...
for.inc23:                                        ; preds = %for.cond15
  ...
  %arrayidx20 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv.next16
  %7 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !12
  %arrayidx22 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv15
...
for.cond33:                                       ; preds = %for.cond3, %for.body35
  %9 = phi i32 [ %.pre24, %for.body35 ], [ %2, %for.cond3 ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body35 ], [ 0, %for.cond3 ]
  %10 = sext i32 %9 to i64
  %cmp34 = icmp slt i64 %indvars.iv21, %10
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %9, -1
  %11 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv21, %11
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv21
