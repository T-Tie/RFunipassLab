...
while.cond:                                       ; preds = %for.cond, %while.cond
  ...
  %phiofops = phi i64 [ %indvars.iv6, %while.cond ], [ -1, %for.cond ]
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv9 = phi i64 [ %1, %while.cond11.preheader ], [ %indvars.iv.next10, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %2 = trunc nuw i64 %indvars.iv.next10 to i32
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select4 = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.2)
