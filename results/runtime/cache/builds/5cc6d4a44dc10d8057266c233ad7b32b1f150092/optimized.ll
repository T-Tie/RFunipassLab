...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre56, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv41 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next42, %for.inc28 ]
  ...
  br i1 %exitcond46.not, label %for.cond31.preheader, label %for.body12
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %indvars.iv37
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv52 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next53, %for.inc52 ]
  ...
  %cmp32 = icmp sgt i64 %indvars.iv52, 0
...
for.cond37.preheader:                             ; preds = %for.body33
  %7 = trunc nsw i64 %indvars.iv.next53 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv48 = phi i64 [ %wide.trip.count, %for.cond37.preheader ], [ %indvars.iv.next49, %for.body39 ]
  ...
  %8 = trunc nuw i64 %indvars.iv48 to i32
  %cmp38 = icmp sgt i32 %8, 0
  br i1 %cmp38, label %for.body39, label %for.inc52

for.body39:                                       ; preds = %for.cond37
  %indvars.iv.next49 = add nsw i64 %indvars.iv48, -1
  %indvars = trunc i64 %indvars.iv.next49 to i32
  %idxprom42 = and i64 %indvars.iv.next49, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next53, i64 %idxprom42
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %cmp44 = icmp eq i32 %9, 0
  %a2.3 = select i1 %cmp44, i32 %7, i32 %a2.2
