...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 5000, ptr noundef nonnull align 16 dereferenceable(5000) %str1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 5000, ptr noundef nonnull %str2) #7
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
...
entry:
  %vtable = load ptr, ptr %this, align 8, !tbaa !27, !invariant.load !8
...
!29 = !{!30, !34, i64 240}
!30 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !15, i64 0, !31, i64 216, !6, i64 224, !32, i64 225, !33, i64 232, !34, i64 240, !35, i64 248, !36, i64 256}
...
!39 = !{!"_ZTSNSt6locale5facetE", !22, i64 8}
