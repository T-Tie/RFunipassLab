...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc8 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv7, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv13, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
  %smax29 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc24 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv10, %9
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv13, i64 %indvars.iv10
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc57
  %indvars.iv26 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next27, %for.inc57 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond60, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc54
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc54 ], [ 0, %for.cond30 ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25.not, label %for.inc57, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv26, i64 %indvars.iv20
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc51
  %indvars.iv16 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next17, %for.inc51 ]
...
for.inc51:                                        ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv16
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv16, i64 %indvars.iv20
...
for.cond60:                                       ; preds = %for.cond30, %for.inc78
  ...
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc78 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp61 = icmp slt i64 %indvars.iv35, %14
  br i1 %cmp61, label %for.cond64, label %for.end80

for.cond64:                                       ; preds = %for.cond60, %for.inc75
  %15 = phi i32 [ %.pre38, %for.inc75 ], [ %12, %for.cond60 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc75 ], [ 0, %for.cond60 ]
  %16 = sext i32 %15 to i64
  %cmp65 = icmp slt i64 %indvars.iv32, %16
  br i1 %cmp65, label %for.body66, label %for.inc78

for.body66:                                       ; preds = %for.cond64
  %arrayidx70 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv35, i64 %indvars.iv32
  ...
  %cmp72.not = icmp eq i64 %indvars.iv32, %19
