...
entry:
  ...
  %call7 = call i64 @strlen(ptr noundef %b) #6
...
lor.lhs.false23:                                  ; preds = %lor.lhs.false18
  ...
  br i1 %cmp27, label %land.lhs.true, label %cleanup.loopexit
...
lor.lhs.false42:                                  ; preds = %lor.lhs.false37
  ...
  br i1 %cmp46, label %for.inc, label %cleanup.loopexit
...
for.end68:                                        ; preds = %for.cond50
  %number.0.lcssa = phi i32 [ %number.0, %for.cond50 ]
  %conv69 = sitofp i32 %number.0.lcssa to double
...
cleanup.loopexit:                                 ; preds = %lor.lhs.false42, %lor.lhs.false23
  br label %cleanup

cleanup:                                          ; preds = %cleanup.loopexit, %for.end68, %entry, %if.else76
  %.str.4.sink = phi ptr [ @.str.4, %if.else76 ], [ @.str.2, %entry ], [ @.str.3, %for.end68 ], [ @.str.2, %cleanup.loopexit ]
