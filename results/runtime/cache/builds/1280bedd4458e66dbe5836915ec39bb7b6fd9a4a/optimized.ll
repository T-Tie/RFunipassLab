...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %year) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %m1) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %m2) #8
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %m2) #8
...
for.cond13.preheader:                             ; preds = %for.cond
  %smax27 = call i32 @llvm.smax.i32(i32 %m2, i32 1)
  br label %for.cond13
