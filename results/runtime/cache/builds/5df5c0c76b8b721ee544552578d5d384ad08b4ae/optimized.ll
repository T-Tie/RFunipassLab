...
for.end:                                          ; preds = %for.cond5
  %min.0.lcssa = phi i32 [ %min.0, %for.cond5 ]
  br label %for.cond17
...
for.body39:                                       ; preds = %for.cond37
  ...
  br i1 %cmp44, label %for.inc88.loopexit5, label %for.inc47
...
if.then51:                                        ; preds = %for.cond37
  %idxprom53.lcssa = phi i64 [ %idxprom53, %for.cond37 ]
  %arrayidx54 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom53.lcssa
...
for.body57:                                       ; preds = %for.cond55
  ...
  %arrayidx61 = getelementptr inbounds [100 x i32], ptr %arrayidx59, i64 0, i64 %idxprom53.lcssa
...
for.inc88.loopexit5:                              ; preds = %for.body39
  br label %for.inc88

for.inc88:                                        ; preds = %for.inc88.loopexit5, %for.inc88.loopexit
...
for.inc16:                                        ; preds = %for.cond1
  ...
  %call13 = call noundef i32 @_Z2jzPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %num, i32 noundef %.lcssa) #7
