...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = tail call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %0) #6
...
entry:
  ...
  %0 = getelementptr inbounds [30 x i32], ptr @a, i64 0, i64 %idxprom1
...
tailrecurse.outer:                                ; preds = %if.then11, %entry
  ...
  %2 = sext i32 %i.tr.ph to i64
  br label %tailrecurse

tailrecurse:                                      ; preds = %tailrecurse.outer, %if.else5
  %indvars.iv = phi i64 [ %2, %tailrecurse.outer ], [ %indvars.iv.next, %if.else5 ]
  %3 = icmp eq i64 %indvars.iv, %sext
  %4 = getelementptr inbounds [30 x i32], ptr @a, i64 0, i64 %indvars.iv
  %5 = load i32, ptr %4, align 4, !tbaa !5, !invariant.load !12
  %cmp3.not = icmp sle i32 %5, %1
...
if.else5:                                         ; preds = %tailrecurse
  ...
  br i1 %cmp3.not, label %if.then11, label %tailrecurse
