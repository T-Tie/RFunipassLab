...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %i) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %j) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %k) #6
...
for.body:                                         ; preds = %for.cond
  ...
  %call14 = call double @sqrt(double noundef %5) #6, !tbaa !9
...
if.else26:                                        ; preds = %land.lhs.true23, %if.else
  ...
  %call34 = call double @sqrt(double noundef %6) #6, !tbaa !9
...
for.inc:                                          ; preds = %if.end38
  %inc40 = fadd double %1, 1.000000e+00
  store double %inc40, ptr %k, align 8, !tbaa !5
  br label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %k) #6
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %j) #6
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %i) #6
