...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %num, i64 0, i64 %indvars.iv19
...
for.cond13:                                       ; preds = %for.cond2, %for.body15
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body15 ], [ 0, %for.cond2 ]
  %secondmax.0 = phi i32 [ %secondmax.1, %for.body15 ], [ 0, %for.cond2 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond27.not, label %for.end31, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %num, i64 0, i64 %indvars.iv23
  %3 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %cmp18.not = icmp slt i32 %secondmax.0, %3
  %cmp22 = icmp eq i32 %3, %max.0
  %secondmax.0. = select i1 %cmp22, i32 %secondmax.0, i32 %3
  %secondmax.1 = select i1 %cmp18.not, i32 %secondmax.0., i32 %secondmax.0
