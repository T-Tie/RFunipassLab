...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 300, ptr nonnull %s) #9
  call void @llvm.lifetime.start.p0(i64 300, ptr nonnull %rep) #9
  call void @llvm.lifetime.start.p0(i64 300, ptr nonnull %sub) #9
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  call void @outlined_ir_func_0(ptr %s.sink126)
  ...
  call void @llvm.lifetime.end.p0(i64 300, ptr nonnull %sub) #9
  call void @llvm.lifetime.end.p0(i64 300, ptr nonnull %rep) #9
  call void @llvm.lifetime.end.p0(i64 300, ptr nonnull %s) #9
  ret i32 0
}
...
!30 = !{!11, !11, i64 0}
!31 = !{!32, !11, i64 56}
!32 = !{!"_ZTSSt5ctypeIcE", !33, i64 0, !34, i64 16, !25, i64 24, !35, i64 32, !35, i64 40, !36, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
!33 = !{!"_ZTSNSt6locale5facetE", !17, i64 8}
!34 = !{!"p1 _ZTS15__locale_struct", !15, i64 0}
!35 = !{!"p1 int", !15, i64 0}
!36 = !{!"p1 short", !15, i64 0}
