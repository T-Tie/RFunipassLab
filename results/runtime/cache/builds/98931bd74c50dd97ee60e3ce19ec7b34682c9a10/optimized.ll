...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %4) #6
  %5 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %5) #6
...
if.then24:                                        ; preds = %for.body
  %add34 = add nsw i32 %spec.select5, %result.0
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then, %if.then24, %if.then20
  %result.1 = phi i32 [ %add, %if.then ], [ %add21, %if.then20 ], [ %add34, %if.then24 ], [ %result.0, %for.body ]
  %inc = add nuw i32 %2, 1
