...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 301, ptr noundef align 16 %a) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %a, i8 noundef 0, i64 noundef 301, i1 noundef false) #6
  store i8 48, ptr %a, align 16
  call void @llvm.lifetime.start.p0(i64 noundef 26, ptr noundef align 16 %b) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef writeonly align 16 %b, ptr noundef readonly align 16 @__const.main.b, i64 noundef 26, i1 noundef false) #6
...
for.body37:                                       ; preds = %for.cond35
  ...
  %11 = load i8, ptr %arrayidx39, align 1, !tbaa !9
  %conv40 = sext i8 %11 to i32
  %12 = load i8, ptr %arrayidx28, align 1, !tbaa !9, !invariant.load !14
...
for.end60:                                        ; preds = %for.cond23
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 26, ptr noundef %b) #7
  call void @llvm.lifetime.end.p0(i64 noundef 301, ptr noundef %a) #7
  ret i32 0
}
