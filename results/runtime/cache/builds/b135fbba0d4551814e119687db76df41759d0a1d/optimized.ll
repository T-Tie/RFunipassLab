...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !21, !invariant.load !15
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !21, !invariant.load !15
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !15
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !23, !invariant.load !15
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !34, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !42, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !48, !invariant.load !15
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !21, !invariant.load !15
