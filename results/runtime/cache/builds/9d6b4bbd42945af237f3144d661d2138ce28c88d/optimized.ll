...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  ...
  br i1 %exitcond62.not, label %if.then61, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body15 ], [ 0, %for.cond13.preheader ]
  %max.0 = phi i32 [ %spec.select, %for.body15 ], [ 0, %for.cond13.preheader ]
  %l1.1 = phi i32 [ %spec.select41, %for.body15 ], [ %l1.0, %for.cond13.preheader ]
