...
while.body:                                       ; preds = %entry, %if.end
  %indvars.iv9 = phi i32 [ 0, %entry ], [ %indvars.iv.next10, %if.end ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv6 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next7, %for.inc ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr %d, i64 0, i64 %indvars.iv6
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %add = add nsw i32 %6, 12
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv6
  %7 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %sub38 = sub i32 %add, %7
  %mul = mul nsw i32 %sub38, 3600
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %e, i64 0, i64 %indvars.iv6
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx42 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv6
  %9 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %sub43 = sub nsw i32 %8, %9
  %mul44 = mul nsw i32 %sub43, 60
  %arrayidx47 = getelementptr inbounds nuw [1000 x i32], ptr %f, i64 0, i64 %indvars.iv6
  %10 = load i32, ptr %arrayidx47, align 4, !tbaa !5
  %arrayidx49 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv6
  %11 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %sub50 = add i32 %10, %mul
  %add45 = add i32 %sub50, %mul44
  %add51 = sub i32 %add45, %11
  %call52 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %add51) #5
