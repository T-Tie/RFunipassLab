...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp5, label %if.end7.gvnsink.split, label %if.end7

if.end7.gvnsink.split:                            ; preds = %if.else
  br label %if.end7

if.end7:                                          ; preds = %for.body, %if.end7.gvnsink.split, %if.else
  %a.1 = phi i32 [ %a.0, %if.else ], [ %1, %for.body ], [ %2, %if.end7.gvnsink.split ]
  %b.1 = phi i32 [ %b.0, %if.else ], [ %2, %for.body ], [ %1, %if.end7.gvnsink.split ]
