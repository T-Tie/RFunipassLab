; ModuleID = '<stdin>'
source_filename = "/tmp/tmpine9g275.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %sum) #10
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %efficient) #10
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %for.inc ]
  %sample.0 = phi double [ undef, %entry ], [ %sample.1, %for.inc ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp sle i32 %i.0, %0
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %sum)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %call1, ptr noundef nonnull align 8 dereferenceable(8) %efficient)
  %cmp3 = icmp eq i32 %i.0, 1
  br i1 %cmp3, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %1 = load double, ptr %efficient, align 8, !tbaa !9
  %2 = load double, ptr %sum, align 8, !tbaa !9
  %div = fdiv double %1, %2
  br label %for.inc

if.else:                                          ; preds = %for.body
  %3 = load double, ptr %efficient, align 8, !tbaa !9
  %4 = load double, ptr %sum, align 8, !tbaa !9
  %div4 = fdiv double %3, %4
  %sub = fsub double %div4, %sample.0
  %cmp5 = fcmp ogt double %sub, 5.000000e-02
  br i1 %cmp5, label %if.then6, label %if.else9

if.then6:                                         ; preds = %if.else
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(7) @.str)
...
if.else9:                                         ; preds = %if.else
  %sub11 = fsub double %sample.0, %div4
  %cmp12 = fcmp ogt double %sub11, 5.000000e-02
  br i1 %cmp12, label %if.then13, label %if.else16

if.then13:                                        ; preds = %if.else9
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str.1)
...
if.else16:                                        ; preds = %if.else9
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str.2)
...
for.inc:                                          ; preds = %if.then, %if.then13, %if.else16, %if.then6
  %sample.1 = phi double [ %div, %if.then ], [ %sample.0, %if.then13 ], [ %sample.0, %if.else16 ], [ %sample.0, %if.then6 ]
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %efficient) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %sum) #10
