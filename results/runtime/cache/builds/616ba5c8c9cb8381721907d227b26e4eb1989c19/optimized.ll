...
for.cond:                                         ; preds = %if.end28, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %if.end28 ], [ 0, %entry ]
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  ...
  br i1 %exitcond18.not, label %if.end28, label %for.inc25
...
for.cond:                                         ; preds = %if.end27, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %if.end27 ], [ 0, %entry ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count22
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  ...
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %if.end27, label %for.inc24
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end ], [ 2, %entry ]
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax24 = call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %smax31 = call i32 @llvm.smax.i32(i32 %1, i32 2)
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.end36
  %indvars.iv27 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next28, %for.end36 ]
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  ...
  br i1 %exitcond26.not, label %for.end36, label %for.inc34
