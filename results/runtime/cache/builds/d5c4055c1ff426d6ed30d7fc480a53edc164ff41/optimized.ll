...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 captures(none) dereferenceable(100000) %a) #7
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr noundef nonnull dereferenceable(100) %add.ptr, i1 noundef false, i1 noundef true, i1 noundef false) #8
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %2 = load i64, ptr %_M_width.i2.i, align 8, !tbaa !6, !invariant.load !5
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  %4 = load ptr, ptr @stdin, align 8, !tbaa !29
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc16 ], [ 1, %for.end ]
  %exitcond19 = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond19, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv16
  %call.i.i9 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr13) #9
