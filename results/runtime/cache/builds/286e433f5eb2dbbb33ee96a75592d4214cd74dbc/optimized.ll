...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %cmp8 = icmp sle i32 %sum.1, 80
  br i1 %cmp8, label %if.then9, label %if.end19

if.then9:                                         ; preds = %if.end
  br i1 %cmp5, label %if.then11, label %if.else14
...
if.end19:                                         ; preds = %if.then11, %if.else14, %if.end
...
if.end29:                                         ; preds = %if.end23.thread, %if.then25, %if.end23
  %sum.2 = phi i32 [ 0, %if.end23.thread ], [ %conv, %if.then25 ], [ %sum.1, %if.end23 ]
  %i.1 = phi i32 [ 0, %if.end23.thread ], [ 1, %if.then25 ], [ %inc, %if.end23 ]
