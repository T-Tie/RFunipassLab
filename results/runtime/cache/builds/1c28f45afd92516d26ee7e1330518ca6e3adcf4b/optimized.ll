...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef align 16 %a) #3
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef align 16 %b) #3
...
for.cond2:                                        ; preds = %if.end22, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc24, %if.end22 ]
  %k.0 = phi i32 [ 0, %for.end ], [ %k.1, %if.end22 ]
...
for.cond5:                                        ; preds = %if.end, %for.body4
  %j.0 = phi i32 [ 0, %for.body4 ], [ %inc14, %if.end ]
  %cmp6 = icmp slt i32 %j.0, %i.1
...
for.cond26:                                       ; preds = %if.end35, %for.end25
  %i.2 = phi i32 [ 0, %for.end25 ], [ %inc37, %if.end35 ]
  %cmp27 = icmp slt i32 %i.2, %k.0
...
for.body28:                                       ; preds = %for.cond26
  ...
  %call31 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4)
  %sub = sub nsw i32 %k.0, 1
  %cmp32 = icmp slt i32 %i.2, %sub
...
for.end38:                                        ; preds = %for.cond26
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef %b) #4
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef %a) #4
