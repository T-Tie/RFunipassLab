...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv61, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv61, %3
...
for.cond12:                                       ; preds = %for.end25, %for.end9
  ...
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.end25 ], [ 0, %for.end9 ]
  %18 = sext i32 %17 to i64
  %cmp13 = icmp slt i64 %indvars.iv67, %18
  br i1 %cmp13, label %for.cond15.preheader, label %for.end28

for.cond15.preheader:                             ; preds = %for.cond12
  %19 = mul nuw nsw i64 %indvars.iv67, %14
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %vla11, i64 %19
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre103, %for.inc23 ]
  %indvars.iv64 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next65, %for.inc23 ]
  %21 = sext i32 %20 to i64
  %cmp16 = icmp slt i64 %indvars.iv64, %21
  br i1 %cmp16, label %for.inc23, label %for.end25

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %arrayidx19, i64 %indvars.iv64
  %call22 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %arrayidx21)
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %.pre103 = load i32, ptr %y2, align 4, !tbaa !5
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv70
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv91 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next92, %for.inc77 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %wide.trip.count77
  br i1 %exitcond95.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %27 = mul nuw nsw i64 %indvars.iv91, %24
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %27
  %28 = mul nuw nsw i64 %indvars.iv91, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %28
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv86 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next87, %for.inc74 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %wide.trip.count
  br i1 %exitcond90.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv86
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv86
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv79 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next80, %for.inc71 ]
  %exitcond85.not = icmp eq i64 %indvars.iv79, %wide.trip.count84
  br i1 %exitcond85.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %29 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !15
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv79
  %30 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !15
  %31 = mul nuw nsw i64 %indvars.iv79, %14
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %31
  %32 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !15
...
for.cond80:                                       ; preds = %for.cond46, %for.end97
  %33 = phi i32 [ %.pre102, %for.end97 ], [ %22, %for.cond46 ]
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.end97 ], [ 0, %for.cond46 ]
  %34 = sext i32 %33 to i64
  %cmp81 = icmp slt i64 %indvars.iv99, %34
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %35 = mul nuw nsw i64 %indvars.iv99, %24
  %arrayidx84 = getelementptr inbounds nuw i32, ptr %vla29, i64 %35
  %36 = load i32, ptr %arrayidx84, align 4, !tbaa !5, !invariant.load !15
...
for.cond87:                                       ; preds = %for.body89, %for.body82
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.body89 ], [ 1, %for.body82 ]
  %37 = load i32, ptr %y2, align 4, !tbaa !5
  %38 = sext i32 %37 to i64
  %cmp88 = icmp slt i64 %indvars.iv96, %38
  br i1 %cmp88, label %for.body89, label %for.end97

for.body89:                                       ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx84, i64 %indvars.iv96
  %39 = load i32, ptr %arrayidx93, align 4, !tbaa !5, !invariant.load !15
...
for.end97:                                        ; preds = %for.cond87
  ...
  %.pre102 = load i32, ptr %x1, align 4, !tbaa !5
  br label %for.cond80
