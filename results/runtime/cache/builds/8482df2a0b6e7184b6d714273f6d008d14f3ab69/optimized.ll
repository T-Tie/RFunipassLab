...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %num) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(80000) %num, i8 noundef 0, i64 noundef 80000, i1 noundef false) #9
...
if.then:                                          ; preds = %for.body
  %call25 = call double @sqrt(double noundef %6) #10, !tbaa !5
...
if.else:                                          ; preds = %for.body
  ...
  %call57 = call double @sqrt(double noundef %7) #10, !tbaa !5
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %17, double noundef %18) #11
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %17) #11
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %17, double noundef %18, double noundef %17, double noundef %19) #11
  br label %for.inc132
...
for.end134:                                       ; preds = %for.cond74
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %num) #11
