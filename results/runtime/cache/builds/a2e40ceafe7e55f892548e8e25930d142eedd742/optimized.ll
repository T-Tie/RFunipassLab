...
for.cond:                                         ; preds = %for.end, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc13, %for.end ]
...
for.cond15:                                       ; preds = %for.end41, %for.end14
  %i.1 = phi i32 [ 0, %for.end14 ], [ %add20, %for.end41 ]
...
for.cond21:                                       ; preds = %if.end, %for.body19
  %j.1 = phi i32 [ %add20, %for.body19 ], [ %inc40, %if.end ]
  %cmp24 = icmp slt i32 %j.1, %add
...
if.end:                                           ; preds = %for.body25, %if.then
...
for.cond45:                                       ; preds = %for.end65, %for.end44
  %k.0 = phi i32 [ 500, %for.end44 ], [ %dec, %for.end65 ]
  %z.0 = phi i32 [ 0, %for.end44 ], [ %z.1, %for.end65 ]
...
for.cond49:                                       ; preds = %if.end62, %for.body48
  %i.2 = phi i32 [ 0, %for.body48 ], [ %inc64, %if.end62 ]
  %z.1 = phi i32 [ 0, %for.body48 ], [ %z.2, %if.end62 ]
...
if.end62:                                         ; preds = %for.body53, %if.then57
...
for.cond74:                                       ; preds = %for.body76, %if.else71
  %i.3 = phi i32 [ 0, %if.else71 ], [ %inc84, %for.body76 ]
  %cmp75 = icmp slt i32 %i.3, %z.0
  br i1 %cmp75, label %for.body76, label %if.end86
