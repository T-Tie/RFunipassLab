...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv5 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv5, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax20 = add nsw i32 %4, -1
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv9 = phi i64 [ %3, %for.cond13.preheader ], [ %indvars.iv.next10, %for.inc40 ]
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %5 = trunc nuw i64 %indvars.iv.next10 to i32
  %cmp14 = icmp sgt i32 %0, %5
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %6 = load i32, ptr %arrayidx17, align 8, !tbaa !15
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next10
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv17, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc74 ], [ %indvars.iv12, %for.body48 ]
  %10 = trunc nuw i64 %indvars.iv14 to i32
  %cmp51 = icmp sgt i32 %0, %10
  br i1 %cmp51, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %11 = load i32, ptr %h55, align 4, !tbaa !12
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv14, i32 1
...
for.end79:                                        ; preds = %for.cond45
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %13)
