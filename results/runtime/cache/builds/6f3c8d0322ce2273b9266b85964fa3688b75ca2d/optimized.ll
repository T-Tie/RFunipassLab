...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %if.then19.i, %if.then28.i
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %initial) #8
...
while.cond:                                       ; preds = %if.end, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %4 = load i32, ptr %n, align 4, !tbaa !30
...
while.body:                                       ; preds = %while.cond
  ...
  %6 = load i32, ptr %_M_streambuf_state.i.i.i25, align 8, !tbaa !21
...
if.then19.i31:                                    ; preds = %while.body
  ...
  %8 = load ptr, ptr %_M_streambuf.i.i32, align 8, !tbaa !22
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call.i.i54 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #8
