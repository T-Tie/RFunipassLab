...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %k) #7
  store double 1.000000e+00, ptr %k, align 8, !tbaa !5
  br label %for.cond
...
if.then:                                          ; preds = %land.lhs.true
  %call20 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %div, double noundef %div16) #7
  br label %for.inc
...
if.then24:                                        ; preds = %land.lhs.true23
  %call25 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %div16) #7
  br label %for.inc

if.else26:                                        ; preds = %for.body, %land.lhs.true23
  %div28 = fdiv double %2, %mul
  %fneg29 = fneg double %div28
  %mul32 = fmul double %2, %2
  %neg33 = fneg double %mul32
  %6 = call double @llvm.fmuladd.f64(double %mul6, double %4, double %neg33)
  %call34 = call double @sqrt(double noundef %6) #8, !tbaa !9
  %div36 = fdiv double %call34, %mul
  %call37 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg29, double noundef %div36, double noundef %fneg29, double noundef %div36) #7
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else26, %if.then24
  %inc40 = fadd double %0, 1.000000e+00
  store double %inc40, ptr %k, align 8, !tbaa !5
  br label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %k) #7
