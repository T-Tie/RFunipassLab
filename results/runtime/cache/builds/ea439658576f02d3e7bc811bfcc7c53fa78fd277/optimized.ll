...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  %lenq.0 = phi i64 [ %indvars.iv2, %if.end44 ], [ %indvars.iv, %while.cond4.preheader ]
...
for.cond:                                         ; preds = %for.inc, %while.end19
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc ], [ 0, %while.end19 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %idx.ext6
  br i1 %exitcond12.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv8
...
for.cond33:                                       ; preds = %for.inc40, %while.end19
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc40 ], [ 0, %while.end19 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %idx.ext6
  br i1 %exitcond.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %add.ptr38 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv5
