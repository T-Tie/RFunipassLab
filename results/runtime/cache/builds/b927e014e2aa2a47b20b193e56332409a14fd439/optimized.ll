...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %jn) #5
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i1) #6
...
for.cond10:                                       ; preds = %for.inc, %if.then
  %9 = phi i32 [ %dec, %for.inc ], [ %add, %if.then ]
...
for.body13:                                       ; preds = %for.cond10
  ...
  %10 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
  %sub = sub nsw i32 %9, 1
  %idxprom16 = sext i32 %sub to i64
  %arrayidx17 = getelementptr inbounds i32, ptr %vla1, i64 %idxprom16
  %11 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
...
if.then19:                                        ; preds = %for.body13
  ...
  store i32 %13, ptr %arrayidx17, align 4, !tbaa !5
...
for.end32:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i3) #6
  store i32 1, ptr %i3, align 4, !tbaa !5
  br label %for.cond33

for.cond33:                                       ; preds = %for.inc40, %for.end32
  %14 = load i32, ptr %i3, align 4, !tbaa !5
  %15 = load i32, ptr %jn, align 4, !tbaa !5
  %cmp34 = icmp slt i32 %14, %15
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %16 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !9
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %16) #6
  %inc41 = add nsw i32 %14, 1
  store i32 %inc41, ptr %i3, align 4, !tbaa !5
  br label %for.cond33, !llvm.loop !14

for.end42:                                        ; preds = %for.cond33
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i3) #6
  %idxprom43 = sext i32 %15 to i64
  %arrayidx44 = getelementptr inbounds i32, ptr %vla1, i64 %idxprom43
  %17 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !9
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %17) #6
  call void @llvm.stackrestore.p0(ptr %2)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %jn) #6
