...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [105 x [105 x i32]], ptr @a, i64 0, i64 %idxprom
  %1 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !14
...
for.body34:                                       ; preds = %for.cond31
  ...
  %9 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !14
...
for.inc67:                                        ; preds = %for.cond58
  ...
  %15 = load i32, ptr %arrayidx65, align 4, !tbaa !5, !invariant.load !14
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !14
...
for.inc:                                          ; preds = %for.cond10
  ...
  %4 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !14
