...
entry:
  ...
  %x11 = alloca i8, i32 0, align 16
  %x22 = alloca i8, i32 0, align 16
  %a = alloca [99 x double], align 16
  %b = alloca [99 x double], align 16
  %c = alloca [99 x double], align 16
  %disc3 = alloca i8, i32 0, align 16
  %realpart4 = alloca i8, i32 0, align 16
  %imagpart5 = alloca i8, i32 0, align 16
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %n) #5
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef align 4 %n)
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef %x11) #6
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef %x22) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef %disc3) #6
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef %realpart4) #6
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef %imagpart5) #6
  br label %for.cond
...
if.then32:                                        ; preds = %if.else
  ...
  %call38 = call double @sqrt(double noundef %5) #6, !tbaa !5
  %add = fadd double %fneg35, %call38
  %mul41 = fmul double 2.000000e+00, %3
  %div42 = fdiv double %add, %mul41
  %call50 = call double @sqrt(double noundef %5) #6, !tbaa !5
...
for.end108:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %imagpart5) #6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %realpart4) #6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %disc3) #6
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %x22) #6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %x11) #6
