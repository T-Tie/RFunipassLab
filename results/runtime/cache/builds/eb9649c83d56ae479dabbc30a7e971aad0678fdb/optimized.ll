...
entry:
  ...
  %call6 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(256) %a) #13
...
if.end57:                                         ; preds = %for.cond48, %if.then34
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef captures(none) %c) #14
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef captures(none) %b) #14
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef captures(none) %a) #14
  ret i32 0
}
