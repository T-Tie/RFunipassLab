...
while.end:                                        ; preds = %while.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #7
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 800, ptr nonnull %num) #7
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 800, ptr nonnull %num) #7
  ret void
}
