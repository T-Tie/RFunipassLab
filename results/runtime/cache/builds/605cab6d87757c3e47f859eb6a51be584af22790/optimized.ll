...
if.then32:                                        ; preds = %if.else
  %call38 = call double @sqrt(double noundef %7) #8, !tbaa !5
  ...
  %call50 = call double @sqrt(double noundef %8) #8, !tbaa !5
  %sub = fsub double %fneg47, %call50
  ...
  %11 = load double, ptr %arrayidx44, align 8, !tbaa !12, !invariant.load !14
  %12 = load double, ptr %arrayidx56, align 8, !tbaa !12, !invariant.load !14
  %call61 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %11, double noundef %12) #7
  br label %for.inc106

if.else62:                                        ; preds = %if.else
  %13 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %mul68 = fmul double 2.000000e+00, %13
  ...
  %mul78 = fmul double 2.000000e+00, %5
  ...
  %14 = load double, ptr %arrayidx71, align 8, !tbaa !12, !invariant.load !14
  %15 = load double, ptr %arrayidx81, align 8, !tbaa !12, !invariant.load !14
  br i1 %cmp84, label %cond.true, label %cond.false

cond.true:                                        ; preds = %if.else62
  %fneg87 = fneg double %14
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg87, double noundef %15, double noundef %fneg87, double noundef %15) #7
  br label %for.inc106

cond.false:                                       ; preds = %if.else62
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %14, double noundef %15, double noundef %14, double noundef %15) #7
  br label %for.inc106
