...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax62 = call i32 @llvm.smax.i32(i32 %indvars.iv25, i32 1)
  %smax51 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %0 = zext i32 %indvars.iv25 to i64
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond37.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count41 = zext i32 %n.tr to i64
  br label %for.cond27
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv28 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next29, %for.inc21 ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv48 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next49, %for.inc62 ]
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  ...
  %min.1 = phi i32 [ %spec.select17, %for.body34 ], [ %4, %for.body29 ]
...
for.body34:                                       ; preds = %for.cond32
  ...
  %spec.select17 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond32, !llvm.loop !15

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv43 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next44, %for.inc59 ]
...
if.then:                                          ; preds = %for.end64
  store i32 %smax51, ptr @j, align 4, !tbaa !5
...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  %exitcond58.not = icmp eq i64 %indvars.iv54, %0
