...
for.cond72.preheader:                             ; preds = %for.cond69
  %arrayidx99 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv31
