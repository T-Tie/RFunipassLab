...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %s) #11
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %rep) #11
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %sub) #11
...
if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef %sub) #13
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef %rep) #13
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef %s) #13
  ret i32 0
}
