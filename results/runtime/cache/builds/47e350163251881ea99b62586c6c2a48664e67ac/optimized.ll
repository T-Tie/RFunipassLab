...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %len) #7
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef align 16 %num) #7
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef nonnull dereferenceable(60000) %c) #7
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef align 16 %input) #7
...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %call4 = call i64 @strlen(ptr noundef %input) #8
...
for.body34:                                       ; preds = %for.cond32
  ...
  %call41 = call i32 @strcmp(ptr noundef %arrayidx36, ptr noundef %arrayidx39) #8
...
if.end92:                                         ; preds = %for.cond76, %if.then71
  call void @llvm.lifetime.end.p0(i64 noundef 600, ptr noundef %input) #9
  call void @llvm.lifetime.end.p0(i64 noundef 60000, ptr noundef %c) #9
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef %num) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %len) #9
  ret i32 0
}
