...
if.then:                                          ; preds = %for.body4
  ...
  %add16 = add nsw i32 %j.0, 1
  br label %for.cond17

for.cond17:                                       ; preds = %for.body19, %if.then
  %j.1 = phi i32 [ %add16, %if.then ], [ %inc26, %for.body19 ]
  %cmp18 = icmp sle i32 %j.1, %i.1
...
if.then30:                                        ; preds = %if.end
  ...
  %add35 = add nsw i32 %j.0, 1
  br label %for.cond36

for.cond36:                                       ; preds = %for.body38, %if.then30
  %j.3 = phi i32 [ %add35, %if.then30 ], [ %inc45, %for.body38 ]
  %cmp37 = icmp slt i32 %j.3, %i.1
...
for.inc55:                                        ; preds = %if.end, %for.end46, %for.end27
  %j.2 = phi i32 [ %j.1, %for.end27 ], [ %j.3, %for.end46 ], [ %j.0, %if.end ]
...
for.cond63:                                       ; preds = %for.body65, %for.end57
  %j.4 = phi i32 [ %add62, %for.end57 ], [ %inc72, %for.body65 ]
  %2 = load i32, ptr %n, align 4, !tbaa !5
  %cmp64 = icmp slt i32 %j.4, %2
