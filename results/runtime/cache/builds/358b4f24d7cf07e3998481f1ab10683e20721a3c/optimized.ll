...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc28 ], [ 1, %for.end ]
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp6 = icmp slt i64 %indvars.iv12, %7
  br i1 %cmp6, label %for.cond9.preheader, label %for.end31

for.cond9.preheader:                              ; preds = %for.cond5
  %arrayidx14 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv12
  %8 = add nsw i64 %indvars.iv12, -1
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc25
  %indvars.iv9 = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next10, %for.inc25 ]
  %exitcond.not = icmp eq i64 %indvars.iv9, %indvars.iv12
  br i1 %exitcond.not, label %for.inc28, label %for.body12

for.body12:                                       ; preds = %for.cond9
  %9 = load i32, ptr %arrayidx14, align 4, !tbaa !5
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv9
  %10 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %cmp17 = icmp eq i32 %9, %10
  br i1 %cmp17, label %for.inc28, label %if.end

if.end:                                           ; preds = %for.body12
  %cmp18 = icmp eq i64 %indvars.iv9, %8
