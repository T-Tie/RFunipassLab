...
for.body:                                         ; preds = %entry, %for.inc
  %indvars.iv12 = phi i32 [ 1, %entry ], [ %indvars.iv.next13, %for.inc ]
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc41
  %indvars.iv9 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next10, %for.inc41 ]
  %exitcond = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond, label %for.end43, label %for.inc41

for.inc41:                                        ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [999 x i32], ptr %g, i64 0, i64 %indvars.iv9
