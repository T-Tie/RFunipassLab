...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %8 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !13
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %idxprom18
  %9 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !13
  %cmp25 = icmp sle i32 %8, %9
...
for.cond37:                                       ; preds = %for.inc47, %for.end35
  %dm.0 = phi i32 [ %10, %for.end35 ], [ %dm.1, %for.inc47 ]
...
for.inc47:                                        ; preds = %for.body39, %if.then43
  %dm.1 = phi i32 [ %12, %if.then43 ], [ %dm.0, %for.body39 ]
