...
for.cond49.preheader:                             ; preds = %for.cond31
  ...
  %smax38 = call i32 @llvm.smax.i32(i32 %14, i32 0)
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv56, %20
...
for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre60, %for.body87 ]
