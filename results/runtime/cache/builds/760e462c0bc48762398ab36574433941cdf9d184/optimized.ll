...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %2
  %call15 = call double @sqrt(double noundef %5) #7, !tbaa !5
  %add = fadd double %fneg, %call15
  %mul = fmul double 2.000000e+00, %3
  %div = fdiv double %add, %mul
  %call21 = call double @sqrt(double noundef %5) #7, !tbaa !5
...
if.then30:                                        ; preds = %if.else
  ...
  %call36 = call double @sqrt(double noundef %5) #7, !tbaa !5
  %add37 = fadd double %fneg31, %call36
  %mul38 = fmul double 2.000000e+00, %3
  %div39 = fdiv double %add37, %mul38
  %call45 = call double @sqrt(double noundef %5) #7, !tbaa !5
