...
for.end35:                                        ; preds = %for.cond10
  %12 = load i32, ptr %d, align 16, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc47, %for.end35
  %dm.0 = phi i32 [ %12, %for.end35 ], [ %dm.1, %for.inc47 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %14 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp sgt i32 %14, %dm.0
...
for.inc47:                                        ; preds = %for.body39, %if.then43
  %dm.1 = phi i32 [ %14, %if.then43 ], [ %dm.0, %for.body39 ]
  %inc48 = add nsw i32 %13, 1
