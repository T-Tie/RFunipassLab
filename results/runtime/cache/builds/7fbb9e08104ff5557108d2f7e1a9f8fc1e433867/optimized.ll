...
for.cond3:                                        ; preds = %for.cond.cleanup17, %for.end
  %i2.0 = phi i32 [ 0, %for.end ], [ %inc49, %for.cond.cleanup17 ]
  %j.0 = phi i32 [ 0, %for.end ], [ %j.1, %for.cond.cleanup17 ]
...
for.cond15:                                       ; preds = %for.cond.cleanup23, %if.end
  %p.0 = phi i32 [ 0, %if.end ], [ %inc46, %for.cond.cleanup23 ]
...
for.cond20:                                       ; preds = %if.end41, %for.body18
  %i19.0 = phi i32 [ 0, %for.body18 ], [ %add, %if.end41 ]
...
for.cond52:                                       ; preds = %if.end65, %for.end50
  %i51.0 = phi i32 [ 0, %for.end50 ], [ %inc67, %if.end65 ]
...
for.body55:                                       ; preds = %for.cond52
  ...
  %4 = getelementptr inbounds [1000 x i32], ptr %a, i64 0, i64 %idxprom59
...
if.then58:                                        ; preds = %for.body55
  ...
  %call61 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5, i32 noundef 44)
  br label %if.end65

if.else:                                          ; preds = %for.body55
  %arrayidx63 = getelementptr inbounds [1000 x i32], ptr %a, i64 0, i64 %idxprom59
