; ModuleID = '<stdin>'
source_filename = "/tmp/tmp0c14zl0t.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #12
...
for.cond:                                         ; preds = %for.inc, %entry
  %blank.0 = phi i32 [ 0, %entry ], [ 1, %for.inc ]
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %for.inc ]
  %num.0 = phi i32 [ 0, %entry ], [ %conv20, %for.inc ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp sle i32 %i.0, %0
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(40) %letter, i8 noundef 48, i64 noundef 40, i1 noundef false)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(40) %letter)
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %letter) #13
  %conv = sext i32 %blank.0 to i64
  %add = add i64 %call4, %conv
  %conv5 = sext i32 %num.0 to i64
  %add6 = add i64 %add, %conv5
  %cmp7 = icmp ugt i64 %add6, 80
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  %num.15 = phi i32 [ 0, %if.end.thread ], [ %num.0, %if.then9 ], [ %num.0, %if.end ]
  %blank.14 = phi i32 [ 0, %if.end.thread ], [ %blank.0, %if.then9 ], [ 0, %if.end ]
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %letter)
  %call15 = call i64 @strlen(ptr noundef %letter) #13
  %conv16 = sext i32 %blank.14 to i64
  %add17 = add i64 %call15, %conv16
  %conv18 = sext i32 %num.15 to i64
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #14
  ret i32 0
}
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !12, !invariant.load !14
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !12, !invariant.load !14
  ...
  %call16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10) #14
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %call24 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10) #14
...
define available_externally noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %this, ptr noundef %__pf) local_unnamed_addr #6 align 2 {
entry:
...
entry:
  ...
  %call = call noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr) #14
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef nonnull %__s) #14
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !16, !invariant.load !14
  store i64 %__wide, ptr %_M_width, align 8, !tbaa !16
  ret i64 %0
}

; Function Attrs: mustprogress uwtable
define available_externally void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %this, i32 noundef %__state) local_unnamed_addr #6 align 2 {
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #14
  %call2 = call noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef %call, i32 noundef %__state) #14
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %this) local_unnamed_addr #8 align 2 {
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #14
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %this) local_unnamed_addr #8 align 2 {
entry:
  %_M_streambuf = getelementptr inbounds nuw %"class.std::basic_ios", ptr %this, i32 0, i32 4
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !27, !invariant.load !14
  ret ptr %0
}

; Function Attrs: mustprogress uwtable
define available_externally noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #6 align 2 {
entry:
  %call = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #14
  %call2 = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #14
...
if.then:                                          ; preds = %entry
  %call3 = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #14
  %call4 = call noundef i32 @_ZNSt11char_traitsIcE11to_int_typeERKc(ptr noundef nonnull align 1 dereferenceable(1) %call3) #14
  br label %if.end
...
define linkonce_odr dso_local noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) local_unnamed_addr #10 comdat {
entry:
  %or = or i32 %__a, %__b
  ret i32 %or
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !35, !invariant.load !14
  ret i32 %0
}

; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #8 align 2 {
entry:
  %_M_in_cur = getelementptr inbounds nuw %"class.std::basic_streambuf", ptr %this, i32 0, i32 2
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !36, !invariant.load !14
  ret ptr %0
}

; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #8 align 2 {
entry:
  %_M_in_end = getelementptr inbounds nuw %"class.std::basic_streambuf", ptr %this, i32 0, i32 3
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !39, !invariant.load !14
  ret ptr %0
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZNSt11char_traitsIcE11to_int_typeERKc(ptr noundef nonnull align 1 dereferenceable(1) %__c) local_unnamed_addr #8 comdat align 2 {
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !15, !invariant.load !14
...
; Function Attrs: mustprogress uwtable
define available_externally noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %this, i8 noundef signext %__c) local_unnamed_addr #6 align 2 {
entry:
  %_M_ctype = getelementptr inbounds nuw %"class.std::basic_ios", ptr %this, i32 0, i32 5
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !40, !invariant.load !14
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local noundef signext i8 @_ZNKSt5ctypeIcE5widenEc(ptr noundef nonnull align 8 dereferenceable(570) %this, i8 noundef signext %__c) local_unnamed_addr #6 comdat align 2 {
entry:
  %_M_widen_ok = getelementptr inbounds nuw %"class.std::ctype", ptr %this, i32 0, i32 8
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !41, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !15, !invariant.load !14
  br label %return
...
entry:
  %call = call i64 @strlen(ptr noundef %__s) #14
  ret i64 %call
}
