...
for.body3:                                        ; preds = %for.cond1
  ...
  %call6 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %6, i32 noundef %7) #5
...
if.end:                                           ; preds = %if.then, %for.body3
  %8 = load i32, ptr %result, align 4, !tbaa !5
  %rem = srem i32 %8, 7
...
define dso_local noundef i32 @_Z8DiJiTianii(i32 noundef %year, i32 noundef %mon) #3 {
entry:
  %result = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %result) #4
