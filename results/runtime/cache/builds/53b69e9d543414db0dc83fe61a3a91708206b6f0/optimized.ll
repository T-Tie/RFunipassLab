...
for.cond:                                         ; preds = %for.inc139, %entry
  ...
  %exitcond26.not = icmp eq i32 %k.0, %smax
  br i1 %exitcond26.not, label %for.end141, label %for.cond1
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  br i1 %exitcond25.not, label %for.cond13, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond1
  %5 = mul nuw nsw i64 %indvars.iv21, %1
...
for.cond13:                                       ; preds = %for.cond1
  ...
  br i1 %cmp14, label %for.body18, label %for.inc139

for.body18:                                       ; preds = %for.cond13
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22, %for.body18
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.cond22 ], [ 1, %for.body18 ]
  %exitcond31.not = icmp ne i64 %indvars.iv27, %wide.trip.count24
  call void @llvm.assume(i1 %exitcond31.not)
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond22, !llvm.loop !13

for.inc139:                                       ; preds = %for.cond13
  %call137 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
