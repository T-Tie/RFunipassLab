...
for.cond2:                                        ; preds = %for.cond, %for.inc55
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc55 ], [ 0, %for.cond ]
  %csum.0 = phi i64 [ %csum.1, %for.inc55 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc55 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv16, %3
  br i1 %cmp3, label %for.body4, label %for.end57

for.body4:                                        ; preds = %for.cond2
  %sext = shl i64 %csum.0, 32
  %conv = ashr exact i64 %sext, 32
  %arrayidx6 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv16
...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %indvars.iv.next14.sink = phi i64 [ %indvars.iv.next14, %for.inc25 ], [ %idxprom12, %if.then ]
  %call20.sink = phi ptr [ %call20, %for.inc25 ], [ @_ZSt4cout, %if.then ]
  %arrayidx22 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next14.sink
  ...
  %indvars.iv.next14 = add nsw i64 %indvars.iv.next14.sink, 1
  %cmp18.not.not = icmp slt i64 %indvars.iv.next14.sink, %indvars.iv16
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %indvars.iv.next11.sink = phi i64 [ %indvars.iv.next11, %for.inc44 ], [ %idxprom31, %if.then30 ]
  %call39.sink = phi ptr [ %call39, %for.inc44 ], [ @_ZSt4cout, %if.then30 ]
  %arrayidx41 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next11.sink
  ...
  %cmp37 = icmp slt i64 %indvars.iv.next11, %indvars.iv16
...
for.inc55.sink.split:                             ; preds = %for.end27, %for.end46
  ...
  %j.1.ph.in = phi i64 [ %indvars.iv.next11, %for.end46 ], [ %indvars.iv.next14, %for.end27 ]
  %j.1.ph = trunc i64 %j.1.ph.in to i32
...
for.inc55:                                        ; preds = %for.inc55.sink.split, %if.end
  ...
  %j.1 = phi i32 [ %j.0, %if.end ], [ %j.1.ph, %for.inc55.sink.split ]
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %indvars.iv.next21.sink = phi i64 [ %indvars.iv.next21, %for.inc71 ], [ %idxprom58, %for.end57 ]
  %call66.sink = phi ptr [ %call66, %for.inc71 ], [ @_ZSt4cout, %for.end57 ]
  %arrayidx68 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next21.sink
  ...
  %indvars.iv.next21 = add nsw i64 %indvars.iv.next21.sink, 1
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next21, %5
