...
while.cond.preheader:                             ; preds = %for.cond1
  %smax78 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end176
  %indvars.iv15 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next16, %for.end176 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.end176 ]
  %p.0 = phi i32 [ 0, %while.cond.preheader ], [ %inc177, %for.end176 ]
  %exitcond79.not = icmp eq i32 %p.0, %smax78
  br i1 %exitcond79.not, label %for.inc179, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %while.cond
  %smax74 = call i32 @llvm.smax.i32(i32 %indvars.iv15, i32 noundef 0)
  %wide.trip.count20 = zext nneg i32 %smax74 to i64
  %wide.trip.count = zext i32 %indvars.iv15 to i64
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  %indvars.iv17 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next18, %for.inc42 ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond45.preheader, label %for.body16

for.cond45.preheader:                             ; preds = %for.cond14
  br label %for.cond45

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv17
  %5 = load i32, ptr %arrayidx18, align 16, !tbaa !5, !invariant.load !13
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv17
  store i32 %5, ptr %arrayidx21, align 4, !tbaa !5
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc39, %for.body16
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc39 ], [ 0, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv17, i64 %indvars.iv11
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc67
  %indvars.iv27 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next28, %for.inc67 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count20
  br i1 %exitcond32.not, label %for.cond70.preheader, label %for.cond49.preheader

for.cond70.preheader:                             ; preds = %for.cond45
  br label %for.cond70

for.cond49.preheader:                             ; preds = %for.cond45
  %arrayidx58 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv27
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  %indvars.iv22 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next23, %for.inc64 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond26.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond49
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv27, i64 %indvars.iv22
...
for.cond70:                                       ; preds = %for.cond70.preheader, %for.inc101
  %indvars.iv38 = phi i64 [ 0, %for.cond70.preheader ], [ %indvars.iv.next39, %for.inc101 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %wide.trip.count20
  br i1 %exitcond43.not, label %for.cond104.preheader, label %for.body73

for.cond104.preheader:                            ; preds = %for.cond70
  br label %for.cond104

for.body73:                                       ; preds = %for.cond70
  %arrayidx76 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv38
  %9 = load i32, ptr %arrayidx76, align 4, !tbaa !5, !invariant.load !13
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv38
  store i32 %9, ptr %arrayidx78, align 4, !tbaa !5
  br label %for.cond79

for.cond79:                                       ; preds = %for.inc98, %for.body73
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc98 ], [ 0, %for.body73 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond37.not, label %for.inc101, label %for.body82

for.body82:                                       ; preds = %for.cond79
  %arrayidx88 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv33, i64 %indvars.iv38
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  %indvars.iv49 = phi i64 [ 0, %for.cond104.preheader ], [ %indvars.iv.next50, %for.inc126 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count20
  br i1 %exitcond54.not, label %for.end128, label %for.cond108

for.cond108:                                      ; preds = %for.cond104, %for.inc123
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc123 ], [ 0, %for.cond104 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond48.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond108
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv49, i64 %indvars.iv44
  %11 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !13
  %arrayidx117 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv44
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc151 ], [ 0, %for.end128 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count20
  br i1 %exitcond65.not, label %for.cond154.preheader, label %for.cond135

for.cond154.preheader:                            ; preds = %for.cond131
  br label %for.cond154

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count
  br i1 %exitcond59.not, label %for.inc151, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv60, i64 %indvars.iv.next56
  %14 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !13
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv60, i64 %indvars.iv55
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  %indvars.iv71 = phi i64 [ 0, %for.cond154.preheader ], [ %indvars.iv.next72, %for.inc174 ]
  %exitcond76.not = icmp eq i64 %indvars.iv71, %wide.trip.count20
  br i1 %exitcond76.not, label %for.end176, label %for.cond158

for.cond158:                                      ; preds = %for.cond154, %for.inc171
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc171 ], [ 1, %for.cond154 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %wide.trip.count
  br i1 %exitcond70.not, label %for.inc174, label %for.inc171

for.inc171:                                       ; preds = %for.cond158
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %arrayidx166 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next67, i64 %indvars.iv71
  %15 = load i32, ptr %arrayidx166, align 4, !tbaa !5, !invariant.load !13
  %arrayidx170 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv71
