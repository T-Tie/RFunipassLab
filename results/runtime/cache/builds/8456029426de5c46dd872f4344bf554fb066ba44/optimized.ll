...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %arrayidx105.sink2 = phi ptr [ %arrayidx82, %for.end102 ], [ %arrayidx116, %for.inc118 ]
  %t.0.sink1 = phi i32 [ %t.0, %for.end102 ], [ %add108, %for.inc118 ]
  %8 = load i32, ptr %arrayidx105.sink2, align 4, !tbaa !5
  %sub106 = sub nsw i32 %8, %minValue79.0
  store i32 %sub106, ptr %arrayidx105.sink2, align 4, !tbaa !5
  %add108 = add nsw i32 %t.0.sink1, 1
