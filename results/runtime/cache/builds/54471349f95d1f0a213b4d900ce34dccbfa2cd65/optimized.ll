...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr nonnull %result) #4
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc21
  %indvars.iv9 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next10, %for.inc21 ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end23, label %for.inc21

for.inc21:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [1000 x i32], ptr %result, i64 0, i64 %indvars.iv9
...
for.end23:                                        ; preds = %for.cond15
  ...
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %result) #4
  ret i32 0
}
