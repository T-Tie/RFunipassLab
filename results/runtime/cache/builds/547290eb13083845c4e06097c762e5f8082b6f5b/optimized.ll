...
for.cond:                                         ; preds = %for.inc23, %entry
  ...
  %exitcond4.not = icmp eq i32 %j.0, 28
  br i1 %exitcond4.not, label %for.end25, label %for.cond3

for.cond3:                                        ; preds = %for.cond, %for.body6
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body6 ], [ 0, %for.cond ]
  %count.1 = phi i32 [ %spec.select, %for.body6 ], [ 0, %for.cond ]
...
if.end22:                                         ; preds = %for.end
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 0, i32 noundef %count.1) #10
  br label %for.inc23
