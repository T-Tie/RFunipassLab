...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count40 = zext nneg i32 %smax34 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond41.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select, %for.body15 ], [ %l1.0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select20, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv37, i64 %indvars.iv27
  ...
  %spec.select20 = call i32 @llvm.smax.i32(i32 %5, i32 %max.0)
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond13, !llvm.loop !13

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv30 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next31, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %exitcond36.not = icmp eq i64 %indvars.iv30, %wide.trip.count40
  br i1 %exitcond36.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv30, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %7 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %idxprom40
  %8 = load i32, ptr %7, align 4, !tbaa !5
  %cmp42 = icmp slt i32 %8, %min.1
  %9 = trunc nuw nsw i64 %indvars.iv30 to i32
  %spec.select21 = select i1 %cmp42, i32 %9, i32 %l2.1
  %spec.select22 = call i32 @llvm.smin.i32(i32 %8, i32 %min.1)
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select21, %if.end37 ]
  %min.3 = phi i32 [ %10, %if.end37.thread ], [ %spec.select22, %if.end37 ]
