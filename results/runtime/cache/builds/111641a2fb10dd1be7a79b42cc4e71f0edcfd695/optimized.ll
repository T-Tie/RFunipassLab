...
while.cond1:                                      ; preds = %while.body4, %while.end
  %2 = phi i32 [ %sub6, %while.body4 ], [ %.pr6, %while.end ]
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %4 = phi i32 [ %sub15, %while.body13 ], [ %.pr7, %while.end7 ]
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %6 = phi i32 [ %sub24, %while.body22 ], [ %.pr8, %while.end16 ]
...
while.cond26:                                     ; preds = %while.body31, %while.end25
  %8 = phi i32 [ %sub33, %while.body31 ], [ %.pr9, %while.end25 ]
...
while.end41:                                      ; preds = %while.cond35, %while.cond26, %while.body40
  ...
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %10, i32 noundef %11, i32 noundef %12, i32 noundef %13, i32 noundef %14, i32 noundef %15)
