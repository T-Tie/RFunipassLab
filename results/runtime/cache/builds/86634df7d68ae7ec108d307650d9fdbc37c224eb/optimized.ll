...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %for.inc18 ], [ 0, %entry ]
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc18 ], [ 0, %entry ]
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #9
  %sub = sub i64 %call4, %conv5
  %cmp.not = icmp ult i64 %sub, %indvars.iv3
  br i1 %cmp.not, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %wide.trip.count11 = zext i32 %indvars.iv9 to i64
  br label %for.cond21
...
for.inc:                                          ; preds = %for.cond6
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv3
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %1
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv3, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv3, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv6 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next7, %for.inc26 ]
  %exitcond12.not = icmp eq i64 %indvars.iv6, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond29, label %for.inc26

for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv6
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %for.cond21, !llvm.loop !14

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond24.not = icmp eq i64 %indvars.iv13, %wide.trip.count11
  br i1 %exitcond24.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv13
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv13
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv15 = phi i64 [ %indvars.iv13, %for.cond32.preheader ], [ %indvars.iv.next16, %for.inc51 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count11
  br i1 %exitcond20.not, label %for.inc54, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv15
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv15
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count11
  br i1 %exitcond30.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv25
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc89 ], [ 0, %if.else ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count11
  br i1 %exitcond36.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv31
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv31
  call void @outlined_ir_func_0(ptr nonnull %arrayidx84)
  br label %for.inc89
...
define internal void @outlined_ir_func_0(ptr nonnull %0) #7 {
newFuncRoot:
  br label %if.then71_to_outline

if.then71_to_outline:                             ; preds = %newFuncRoot
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0)
