...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc8 ], [ 1, %entry ]
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc28 ], [ 1, %for.end10 ]
  %6 = load i32, ptr %x2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp13.not = icmp sgt i64 %indvars.iv19, %7
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax29 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count30 = zext nneg i32 %smax29 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc25
  %indvars.iv15 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next16, %for.inc25 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp16.not = icmp sgt i64 %indvars.iv15, %12
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv26 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next27, %for.inc46 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax35 = call i32 @llvm.smax.i32(i32 %14, i32 0)
...
for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv26, i64 %indvars.iv23
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  %indvars.iv44 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next45, %for.inc79 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count30
  br i1 %exitcond48.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc76
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc76 ], [ 0, %for.cond49 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %wide.trip.count42
  br i1 %exitcond43.not, label %for.inc79, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv44, i64 %indvars.iv38
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc73
  %indvars.iv32 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next33, %for.inc73 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37.not, label %for.inc76, label %for.inc73

for.inc73:                                        ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv32
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv32, i64 %indvars.iv38
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv53, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv53, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre57, %for.body87 ]
  %indvars.iv49 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next50, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv49, %23
  br i1 %cmp86.not, label %for.inc106, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv49, %24
  %25 = add nsw i64 %indvars.iv49, -1
