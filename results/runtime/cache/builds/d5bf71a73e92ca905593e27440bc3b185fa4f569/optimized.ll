...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(2000) %b, i8 noundef 0, i64 noundef 2000, i1 noundef false) #7
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %add, i32 0)
  %wide.trip.count19 = zext nneg i32 %smax18 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc12 ], [ 0, %entry ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond15.preheader, label %for.cond4

for.cond15.preheader:                             ; preds = %for.cond
  %wide.trip.count26 = zext i32 %add to i64
  br label %for.cond15
...
for.inc:                                          ; preds = %for.cond4
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv15
  %arrayidx = getelementptr inbounds nuw [501 x i8], ptr %s, i64 0, i64 %1
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv15, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count19
  br i1 %exitcond32.not, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv28
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv28
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc39 ], [ %indvars.iv21, %for.body19 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond15.loopexit, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv23
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count19
  br i1 %exitcond37.not, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv33
  %4 = load i32, ptr %arrayidx55, align 4, !tbaa !5
  %cmp56 = icmp eq i32 %4, %k.0
...
if.then57:                                        ; preds = %for.body53
  ...
  store i32 %5, ptr %arrayidx59, align 4, !tbaa !5
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.012 = phi i32 [ %6, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.012)
  %smax41 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count42 = zext nneg i32 %smax41 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %wide.trip.count42
  br i1 %exitcond43.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv38
  %7 = load i32, ptr %arrayidx78, align 4, !tbaa !5
  %idxprom79 = sext i32 %7 to i64
