...
if.end:                                           ; preds = %land.lhs.true, %for.body23
  ...
  %3 = load i32, ptr %arrayidx27, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc45, %if.end
  %t.0.sink3 = phi i32 [ %t.0, %if.end ], [ %add, %for.inc45 ]
  %minValue.0 = phi i32 [ %3, %if.end ], [ %minValue.1, %for.inc45 ]
  %add = add nsw i32 %t.0.sink3, 1
...
for.body33:                                       ; preds = %for.cond30
  ...
  %4 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !13
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %t.0.sink4 = phi i32 [ %t.0, %for.end47 ], [ %add53, %for.inc63 ]
  %add53 = add nsw i32 %t.0.sink4, 1
...
for.inc63:                                        ; preds = %for.cond54
  ...
  %5 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !13
...
if.end78:                                         ; preds = %land.lhs.true75, %for.body73
  ...
  %6 = load i32, ptr %arrayidx82, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond85

for.cond85:                                       ; preds = %for.inc100, %if.end78
  %t.0.sink = phi i32 [ %t.0, %if.end78 ], [ %add84, %for.inc100 ]
  %minValue79.0 = phi i32 [ %6, %if.end78 ], [ %minValue79.1, %for.inc100 ]
  %add84 = add nsw i32 %t.0.sink, 1
...
for.body88:                                       ; preds = %for.cond85
  ...
  %7 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %t.0.sink2 = phi i32 [ %t.0, %for.end102 ], [ %add108, %for.inc118 ]
  %add108 = add nsw i32 %t.0.sink2, 1
...
for.inc118:                                       ; preds = %for.cond109
  ...
  %8 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %9 = load i32, ptr %arrayidx129, align 4, !tbaa !5, !invariant.load !13
  %add130 = add nsw i32 %total.0, %9
