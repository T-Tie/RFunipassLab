...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond15 = or i1 %cmp6, %or.cond
  %3 = load i32, ptr %m1, align 4, !tbaa !5
  %smax25 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
  br i1 %or.cond15, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %n1.0 = phi i32 [ %add, %for.inc ], [ 0, %for.body ]
  %4 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %exitcond26.not = icmp eq i32 %4, %smax25
  br i1 %exitcond26.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %5 = load i32, ptr %m2, align 4, !tbaa !5
  %smax27 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
  br label %for.cond30
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %exitcond28.not = icmp eq i32 %6, %smax27
  br i1 %exitcond28.not, label %for.end58, label %for.body32
...
for.inc56:                                        ; preds = %for.body32, %if.else52, %if.then50
  %.sink29 = phi i32 [ 30, %if.else52 ], [ 31, %if.then50 ], [ 29, %for.body32 ]
  %add35 = add nuw nsw i32 %n2.0, %.sink29
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts20 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.5.str.4) #6
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %7, %smax25
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 1)
...
for.inc109:                                       ; preds = %for.body87, %if.else105, %if.then103
  %.sink30 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ], [ 28, %for.body87 ]
  %add90 = add nuw nsw i32 %n182.0, %.sink30
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %exitcond24.not = icmp eq i32 %9, %smax23
  br i1 %exitcond24.not, label %for.end140, label %for.body114
...
for.inc138:                                       ; preds = %for.body114, %if.else134, %if.then132
  %.sink31 = phi i32 [ 30, %if.else134 ], [ 31, %if.then132 ], [ 28, %for.body114 ]
  %add117 = add nuw nsw i32 %n283.0, %.sink31
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts16 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts17 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.sink) #6
  br label %for.inc164
