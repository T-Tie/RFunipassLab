...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv61 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next62, %for.inc33 ]
  %indvars.iv36 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next37, %for.inc33 ]
  %smax63 = call i64 @llvm.smax.i64(i64 %indvars.iv61, i64 0)
  %exitcond = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond, label %for.cond36.preheader, label %for.cond7

for.cond36.preheader:                             ; preds = %for.cond3
  %wide.trip.count44 = zext nneg i32 %smax to i64
  br label %for.cond36

for.cond7:                                        ; preds = %for.cond3, %for.body10
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body10 ], [ 0, %for.cond3 ]
  %maxIndex.0 = phi i32 [ %spec.select, %for.body10 ], [ 0, %for.cond3 ]
  %exitcond64 = icmp eq i64 %indvars.iv33, %smax63
  br i1 %exitcond64, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv33
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv41 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next42, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv41
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax55 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
  %wide.trip.count56 = zext nneg i32 %smax55 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count49 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc60
  %indvars.iv51 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next52, %for.inc60 ]
  %exitcond57.not = icmp eq i64 %indvars.iv51, %wide.trip.count56
  br i1 %exitcond57.not, label %if.end80, label %for.inc60

for.inc60:                                        ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv51
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv46 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next47, %for.inc73 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count49
  br i1 %exitcond50.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv46
