...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax43 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
  %wide.trip.count44 = zext nneg i32 %smax43 to i64
  %wide.trip.count37 = zext i32 %j.0 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv39
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc37 ], [ %indvars.iv31, %for.body17 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv33
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv46 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next47, %for.inc53 ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count44
  br i1 %exitcond50.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv46
  ...
  %cmp49 = icmp slt i64 %indvars.iv46, %4
