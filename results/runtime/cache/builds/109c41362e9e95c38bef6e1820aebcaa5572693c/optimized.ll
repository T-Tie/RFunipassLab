...
for.inc50:                                        ; preds = %for.cond39
  ...
  %6 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !15
  ...
  %7 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !15
  %mul = mul nsw i32 %6, %7
...
if.then:                                          ; preds = %for.body70
  ...
  %10 = load i32, ptr %arrayidx73, align 4, !tbaa !5, !invariant.load !15
...
if.else:                                          ; preds = %for.body70
  ...
  %11 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !15
