...
if.then:                                          ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n2) #8
  store i32 0, ptr %n2, align 4, !tbaa !5
  %3 = load i32, ptr %m1, align 4, !tbaa !5
  %smax23 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc, %if.then
  %n1.0 = phi i32 [ 0, %if.then ], [ %add28, %for.inc ]
  %4 = phi i32 [ 1, %if.then ], [ %inc, %for.inc ]
  %exitcond24.not = icmp eq i32 %4, %smax23
  br i1 %exitcond24.not, label %if.end79, label %for.body9
...
for.inc:                                          ; preds = %for.body9, %for.inc.fold.split, %if.else27
  %.sink5 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %for.inc.fold.split ]
  %add28 = add nuw nsw i32 %.sink5, %n1.0
  %inc = add nuw i32 %4, 1
  br label %for.cond7, !llvm.loop !9

if.end79:                                         ; preds = %for.cond7
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n2, i32 noundef 29, i32 %n1.0) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n2) #8
  br label %for.inc164

if.else80:                                        ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n283) #8
...
for.inc109:                                       ; preds = %for.body87, %for.inc109.fold.split, %if.else105
  %.sink2 = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %for.inc109.fold.split ]
  %add106 = add nuw nsw i32 %.sink2, %n182.0
  %inc110 = add nuw i32 %6, 1
  br label %for.cond85, !llvm.loop !12

if.end162:                                        ; preds = %for.cond85
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n283, i32 noundef 28, i32 %n182.0) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n283) #8
  br label %for.inc164
...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %0, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %1, i32 noundef %2, i32 %3) unnamed_addr #4 {
for.end_to_outline:
...
for.cond30:                                       ; preds = %for.inc56, %for.end_to_outline
  %5 = phi i32 [ %.promoted, %for.end_to_outline ], [ %add53, %for.inc56 ]
  %.sink = phi i32 [ 1, %for.end_to_outline ], [ %inc57, %for.inc56 ]
  %cmp31 = icmp slt i32 %.sink, %4
  br i1 %cmp31, label %for.body32, label %for.end58

for.body32:                                       ; preds = %for.cond30
  switch i32 %.sink, label %if.else52 [
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  %.sink2 = phi i32 [ 30, %if.else52 ], [ %2, %for.body32 ], [ 31, %for.inc56.fold.split ]
  %add53 = add nsw i32 %.sink2, %5
  store i32 %add53, ptr %1, align 4, !tbaa !5
  %inc57 = add nuw nsw i32 %.sink, 1
...
if.then60:                                        ; preds = %for.end58
  %sub = sub nsw i32 %5, %3
  tail call fastcc void @outlined_ir_func_0.3(i32 %sub) #8
  br label %if.end68
...
if.then70:                                        ; preds = %if.end68
  ...
  tail call fastcc void @outlined_ir_func_0.3(i32 %sub71) #8
...
; Function Attrs: minsize mustprogress nofree norecurse nounwind optsize uwtable
define internal fastcc void @outlined_ir_func_0.3(i32 %0) unnamed_addr #4 {
