...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax40 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16
...
for.cond19.preheader:                             ; preds = %for.cond16
  %smax37 = call i32 @llvm.smax.i32(i32 %indvars.iv35, i32 noundef 0)
  %wide.trip.count38 = zext nneg i32 %smax37 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax46 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
