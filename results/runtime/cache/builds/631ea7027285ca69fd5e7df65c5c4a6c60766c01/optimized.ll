...
for.cond1:                                        ; preds = %for.inc, %for.body
  %.sink7 = phi i32 [ 30, %for.body ], [ %dec, %for.inc ]
  %cmp2 = icmp sge i32 %.sink7, 0
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %.sink6 = phi i32 [ %.sink, %for.end19 ], [ %inc29, %for.inc28 ]
  %cmp21 = icmp slt i32 %.sink6, 31
  %sub31 = sub nsw i32 %.sink6, %.sink
