...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef i32 @_Z8DiJiTianii(i32 noundef %2, i32 noundef %3) #5
  %4 = load i32, ptr %year, align 4, !tbaa !5
  %5 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %5) #5
...
if.end:                                           ; preds = %if.then24, %land.lhs.true, %if.else33
  %.sink1 = phi i32 [ 28, %if.else33 ], [ 29, %land.lhs.true ], [ 29, %if.then24 ]
