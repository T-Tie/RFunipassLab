...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv9 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next10, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax17 = call i32 @llvm.smax.i32(i32 %t.0, i32 noundef 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv9
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond21 = icmp eq i32 %q.0, %4
  br i1 %exitcond21, label %for.cond52.preheader, label %for.cond25

for.cond52.preheader:                             ; preds = %for.cond22
  %7 = sext i32 %t.0 to i64
  %8 = add i32 %3, 1
  %wide.trip.count27 = zext i32 %8 to i64
  br label %for.cond52

for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond19.not = icmp eq i64 %indvars.iv13, %wide.trip.count18
  br i1 %exitcond19.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv13
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next14
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv22 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next23, %for.body54 ]
  %exitcond28 = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv22, %7
  %spec.select7 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %arrayidx62 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv22
  %11 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select7, i32 noundef %11) #6
