...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax39 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax40 = call i32 @llvm.smax.i32(i32 %smax39, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax46 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count54 = zext nneg i32 %smax34 to i64
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count71 = zext nneg i32 %smax34 to i64
  br label %for.cond96
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax81 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax87 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
