...
for.cond10:                                       ; preds = %for.inc19, %for.end9
  %i.1 = phi i32 [ 0, %for.end9 ], [ %inc20, %for.inc19 ]
...
for.body13:                                       ; preds = %for.cond10
  ...
  %arrayidx17 = getelementptr inbounds [100 x i32], ptr %arrayidx15, i64 0, i64 %idxprom14
...
for.end48:                                        ; preds = %for.body38, %for.cond36
  %i.2.lcssa = phi i32 [ %i.2, %for.body38 ], [ %i.2, %for.cond36 ]
  %sub = add i32 %i.1.lcssa.neg, -2
  %sub50 = add i32 %sub, %j.2.lcssa
  %sub49 = add i32 %i.1.lcssa.neg, -2
  %sub51 = add i32 %sub49, %i.2.lcssa
