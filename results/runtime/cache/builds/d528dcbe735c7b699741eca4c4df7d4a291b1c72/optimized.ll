...
if.then6.i8:                                      ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %or.cond81 = select i1 %call16.i18, i1 %or.cond.i22, i1 false
  br i1 %or.cond81, label %if.then19.i23, label %if.then6.i47
...
if.then6.i47:                                     ; preds = %if.then28.i34, %if.then19.i23, %if.then6.i8
  ...
  %or.cond82 = select i1 %call16.i57, i1 %or.cond.i61, i1 false
  br i1 %or.cond82, label %if.then19.i62, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78
  %indvars.iv104 = phi i32 [ %indvars.iv.next105, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78 ]
  %indvars.iv99 = phi i32 [ %indvars.iv.next100, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78 ]
