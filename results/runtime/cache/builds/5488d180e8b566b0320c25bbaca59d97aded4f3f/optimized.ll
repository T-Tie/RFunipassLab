...
for.cond15:                                       ; preds = %for.inc191, %for.end14
  ...
  store i32 %.sink, ptr %n, align 4, !tbaa !5
...
for.cond23:                                       ; preds = %for.inc41, %for.body22
  %9 = phi i32 [ %inc42, %for.inc41 ], [ 0, %for.body22 ]
...
for.cond45:                                       ; preds = %for.inc53, %for.end43
  %13 = load i32, ptr %l44, align 4, !tbaa !5
  %cmp46 = icmp slt i32 %13, %8
...
for.cond60:                                       ; preds = %for.inc106, %for.end58
  %16 = load i32, ptr %k59, align 4, !tbaa !5
  %cmp61 = icmp slt i32 %16, %8
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  %17 = phi i32 [ %inc91, %for.inc90 ], [ 0, %for.body63 ]
  %cmp66 = icmp slt i32 %17, %8
...
if.else75:                                        ; preds = %for.body68
  ...
  %idxprom78 = sext i32 %16 to i64
  %arrayidx79 = getelementptr inbounds [100 x i32], ptr %arrayidx77, i64 0, i64 %idxprom78
  %20 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %cmp80 = icmp sgt i32 %19, %20
...
for.end108:                                       ; preds = %for.cond60
  ...
  %25 = load i32, ptr %s, align 4, !tbaa !5
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %26 = load i32, ptr %i111, align 4, !tbaa !5
  %cmp113 = icmp slt i32 %26, %8
...
for.cond166:                                      ; preds = %for.inc188, %for.end164
  %33 = load i32, ptr %i165, align 4, !tbaa !5
  %cmp167 = icmp slt i32 %33, %8
...
for.cond171:                                      ; preds = %for.inc185, %for.body169
  %34 = load i32, ptr %j170, align 4, !tbaa !5
  %cmp172 = icmp slt i32 %34, %8
  br i1 %cmp172, label %for.inc185, label %for.inc188

for.inc185:                                       ; preds = %for.cond171
  %idxprom175 = sext i32 %33 to i64
...
for.inc195:                                       ; preds = %for.cond15
  ...
  %call193 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %36)
