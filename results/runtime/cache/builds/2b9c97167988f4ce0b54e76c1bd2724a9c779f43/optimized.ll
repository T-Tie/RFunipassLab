...
for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count25 = zext nneg i32 %smax20 to i64
  br label %for.cond47
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv22 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next23, %for.inc55 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv22
