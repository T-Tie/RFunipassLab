...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr nonnull %st) #5
...
if.else34.i:                                      ; preds = %entry, %if.else34.i
  ...
  br i1 %cmp, label %if.else34.i, label %for.cond, !llvm.loop !5

for.cond:                                         ; preds = %if.else34.i, %for.body
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body ], [ %indvars.iv, %if.else34.i ]
  %cmp4 = icmp sgt i64 %indvars.iv29, 0
  br i1 %cmp4, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %st, i64 0, i64 %indvars.iv29
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #5
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx6, i64 noundef %call.i.i)
...
for.end:                                          ; preds = %for.cond
  %call.i.i12 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %st) #5
  %call1.i13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %st, i64 noundef %call.i.i12)
  %vtable.i18 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  ...
  call void @llvm.lifetime.end.p0(i64 10000, ptr nonnull %st) #5
  ret i32 0
}
