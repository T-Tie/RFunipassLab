...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv23, %1
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv29, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv26, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv29, i64 %indvars.iv26
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax35 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax40 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax41 = call i32 @llvm.smax.i32(i32 %smax40, i32 noundef 0)
  %wide.trip.count42 = zext nneg i32 %smax41 to i64
  %wide.trip.count = zext nneg i32 %smax35 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond43.not = icmp eq i64 %indvars.iv36, %wide.trip.count42
  br i1 %exitcond43.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax47 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count55 = zext nneg i32 %smax35 to i64
  %wide.trip.count48 = zext nneg i32 %smax47 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv36, i64 %indvars.iv32
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv57 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next58, %for.inc83 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count42
  br i1 %exitcond61.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond56.not = icmp eq i64 %indvars.iv50, %wide.trip.count55
  br i1 %exitcond56.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv57, i64 %indvars.iv50
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv44 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next45, %for.inc77 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv44
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv44, i64 %indvars.iv50
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count42
  br i1 %exitcond66.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv62
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax40 to i64
  %arrayidx95 = getelementptr inbounds [100 x i32], ptr %d, i64 0, i64 %idxprom94
  store i32 %smax, ptr %arrayidx95, align 4, !tbaa !5
  %wide.trip.count72 = zext nneg i32 %smax35 to i64
  br label %for.cond96

for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %wide.trip.count42
  br i1 %exitcond78.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv74
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax40, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax40, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv67 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next68, %for.inc112 ]
  %exitcond73.not = icmp eq i64 %indvars.iv67, %wide.trip.count72
  br i1 %exitcond73.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv74, i64 %indvars.iv67
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv91 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond98.not = icmp eq i64 %indvars.iv91, %wide.trip.count42
  br i1 %exitcond98.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv91
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv91, 0
  %or.cond18 = and i1 %or.cond, %cmp128
  br i1 %or.cond18, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv91
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax82 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count83 = zext nneg i32 %smax82 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count83
  br i1 %exitcond84.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv91, i64 %indvars.iv79
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv91, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax88 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count89 = zext nneg i32 %smax88 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond90.not = icmp eq i64 %indvars.iv85, %wide.trip.count89
  br i1 %exitcond90.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv91, i64 %indvars.iv85
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv91, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv91, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar19 = call i32 @putchar(i32 noundef 10) #6
  br label %for.inc198
