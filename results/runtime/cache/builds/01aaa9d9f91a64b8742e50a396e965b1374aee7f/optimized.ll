...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %letter) #14
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  %num.112 = phi i32 [ 0, %if.end.thread ], [ %num.0, %if.then9 ], [ %num.0, %if.end ]
  %blank.111 = phi i64 [ 0, %if.end.thread ], [ 1, %if.then9 ], [ 0, %if.end ]
  ...
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #14
  %add17 = add i64 %call15, %blank.111
  %3 = trunc i64 %add17 to i32
  %conv20 = add i32 %num.112, %3
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #13
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #13
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !25, !invariant.load !9
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !32, !invariant.load !9
...
!24 = !{!7, !7, i64 0}
!25 = !{!26, !7, i64 56}
!26 = !{!"_ZTSSt5ctypeIcE", !27, i64 0, !28, i64 16, !29, i64 24, !30, i64 32, !30, i64 40, !31, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!27 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!28 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!29 = !{!"bool", !7, i64 0}
!30 = !{!"p1 int", !16, i64 0}
