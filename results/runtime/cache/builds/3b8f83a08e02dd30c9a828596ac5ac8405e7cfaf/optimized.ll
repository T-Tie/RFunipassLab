...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.end114 ], [ %2, %entry ]
  ...
  %smax59 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv64, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv64 to i32
  %smax43 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count22 = zext nneg i32 %smax43 to i64
  %wide.trip.count = and i64 %indvars.iv64, 4294967295
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  ...
  br i1 %exitcond23.not, label %for.cond31.preheader, label %for.cond2

for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count27 = and i64 %indvars.iv64, 4294967295
  br label %for.cond31
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv14 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next15, %for.inc25 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv34 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next35, %for.inc66 ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv29 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next30, %for.inc63 ]
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  ...
  %cmp73 = icmp slt i64 %indvars.iv46, %indvars.iv.next65
