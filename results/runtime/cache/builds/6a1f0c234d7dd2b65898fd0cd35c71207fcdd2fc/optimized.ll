...
for.body54:                                       ; preds = %for.cond52
  ...
  %11 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv22
  %12 = load i32, ptr %11, align 4, !tbaa !5
  %spec.select7 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select7, i32 noundef %12) #6
