...
while.cond1:                                      ; preds = %while.body4, %while.end
  %1 = phi i32 [ %sub6, %while.body4 ], [ %.pr2, %while.end ]
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %2 = phi i32 [ %sub15, %while.body13 ], [ %.pr3, %while.end7 ]
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %3 = phi i32 [ %sub24, %while.body22 ], [ %.pr4, %while.end16 ]
...
while.cond26:                                     ; preds = %while.body31, %while.end25
  %4 = phi i32 [ %sub33, %while.body31 ], [ %.pr5, %while.end25 ]
