...
for.cond2:                                        ; preds = %if.end, %for.end
  ...
  %m.0 = phi i32 [ 0, %for.end ], [ %m.1, %if.end ]
...
for.cond16:                                       ; preds = %for.end43, %for.end15
  %j.0 = phi i32 [ 0, %for.end15 ], [ %inc45, %for.end43 ]
...
for.cond19:                                       ; preds = %if.end40, %for.body18
  %i.2 = phi i32 [ 0, %for.body18 ], [ %add, %if.end40 ]
...
for.cond47:                                       ; preds = %if.end57, %for.end46
  %i.3 = phi i32 [ 0, %for.end46 ], [ %inc59, %if.end57 ]
...
for.body49:                                       ; preds = %for.cond47
  ...
  %call52 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4)
