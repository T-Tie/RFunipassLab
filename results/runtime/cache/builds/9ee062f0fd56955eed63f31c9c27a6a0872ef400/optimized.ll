...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  ...
  br i1 %exitcond26, label %while.cond.preheader, label %for.cond6.preheader
...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc12
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc12 ], [ 0, %for.cond6.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv, 39
  br i1 %exitcond.not, label %for.cond15.preheader, label %for.inc12

for.cond15.preheader:                             ; preds = %for.cond6
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc30
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc30 ], [ 0, %for.cond15.preheader ]
  %exitcond25.not = icmp eq i64 %indvars.iv22, 40
  br i1 %exitcond25.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv22
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %div = sdiv i32 %4, 10
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx21 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv.next23
...
while.cond:                                       ; preds = %while.cond.preheader, %while.cond
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %while.cond ], [ 39, %while.cond.preheader ]
  %arrayidx37 = getelementptr inbounds [40 x i32], ptr %sum, i64 0, i64 %indvars.iv27
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc45
  ...
  br i1 %cmp40, label %for.inc45, label %if.end.loopexit
...
if.end.loopexit:                                  ; preds = %for.cond39
  br label %if.end
