...
for.end33:                                        ; preds = %for.cond23
  %gep = getelementptr [41 x i8], ptr %invariant.gep, i64 %indvars.iv13
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull %gep)
...
for.end33_after_outline.exitStub:
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %0)
