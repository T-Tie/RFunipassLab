...
for.cond:                                         ; preds = %for.inc179, %entry
  ...
  br i1 %cmp.not, label %for.end181, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  ...
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc10 ], [ 0, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv77, %2
  br i1 %cmp2, label %for.cond4.preheader, label %while.cond.preheader

for.cond4.preheader:                              ; preds = %for.cond1
  br label %for.cond4

while.cond.preheader:                             ; preds = %for.cond1
  %smax147 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
for.cond14.preheader:                             ; preds = %while.cond
  %smax143 = call i32 @llvm.smax.i32(i32 %indvars.iv84, i32 noundef 0)
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  ...
  br i1 %exitcond123.not, label %for.end128, label %for.cond108.preheader

for.cond108.preheader:                            ; preds = %for.cond104
  br label %for.cond108

for.cond108:                                      ; preds = %for.cond108.preheader, %for.inc123
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc123 ], [ 0, %for.cond108.preheader ]
  %exitcond117.not = icmp eq i64 %indvars.iv113, %wide.trip.count
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond134.not, label %for.cond154.preheader, label %for.cond135.preheader
...
for.cond135:                                      ; preds = %for.cond135.preheader, %for.inc148
  %indvars.iv124 = phi i64 [ %indvars.iv.next125, %for.inc148 ], [ 1, %for.cond135.preheader ]
  %exitcond128.not = icmp eq i64 %indvars.iv124, %wide.trip.count
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  ...
  br i1 %exitcond145.not, label %for.end176, label %for.cond158.preheader

for.cond158.preheader:                            ; preds = %for.cond154
  br label %for.cond158

for.cond158:                                      ; preds = %for.cond158.preheader, %for.inc171
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %for.inc171 ], [ 1, %for.cond158.preheader ]
  %exitcond139.not = icmp eq i64 %indvars.iv135, %wide.trip.count
