...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 500, ptr nonnull %ch) #3
  br label %while.cond
...
while.cond:                                       ; preds = %if.end17, %entry
  ...
  switch i8 %conv, label %if.end17 [
    i8 10, label %for.cond.preheader
    i8 32, label %if.else9
  ]
...
if.end17:                                         ; preds = %while.cond, %if.else9
  %inc15.sink = phi i32 [ %inc15, %if.else9 ], [ 1, %while.cond ]
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 500, ptr nonnull %ch) #3
  ret i32 0
}
