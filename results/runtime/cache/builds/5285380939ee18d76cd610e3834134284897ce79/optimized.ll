...
for.body25:                                       ; preds = %for.cond22
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !13
  %idxprom30 = sext i32 %k.1 to i64
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %arrayidx18, i64 0, i64 %idxprom30
  %5 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !13
...
for.inc64:                                        ; preds = %for.cond49
  ...
  %6 = load i32, ptr %arrayidx56, align 4, !tbaa !5, !invariant.load !13
  %arrayidx58 = getelementptr inbounds [100 x i32], ptr %min1, i64 0, i64 %idxprom53
  %7 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !13
...
for.body73:                                       ; preds = %for.cond70
  ...
  %8 = load i32, ptr %arrayidx76, align 4, !tbaa !5, !invariant.load !13
