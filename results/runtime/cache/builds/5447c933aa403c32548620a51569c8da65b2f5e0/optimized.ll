...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %2 = phi i32 [ %.pre53, %for.inc ], [ %0, %for.cond1.preheader ]
...
for.end23:                                        ; preds = %for.end23.loopexit, %for.end23.split.loop.exit
  %a.2 = phi i32 [ %4, %for.end23.split.loop.exit ], [ %a.0, %for.end23.loopexit ]
  %b.2 = phi i32 [ %6, %for.end23.split.loop.exit ], [ %b.0, %for.end23.loopexit ]
