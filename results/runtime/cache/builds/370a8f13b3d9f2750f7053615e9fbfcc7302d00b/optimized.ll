...
for.cond10:                                       ; preds = %for.inc57, %for.end9
  %l2.0 = phi i32 [ undef, %for.end9 ], [ %l2.1, %for.inc57 ]
  %min.0 = phi i32 [ undef, %for.end9 ], [ %min.1, %for.inc57 ]
  %l1.0 = phi i32 [ undef, %for.end9 ], [ %l1.1, %for.inc57 ]
...
if.end37:                                         ; preds = %for.body30
  ...
  %4 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp slt i32 %4, %min.1
  br i1 %cmp42, label %land.lhs.true, label %for.inc50
...
if.end37.thread:                                  ; preds = %for.body30
  ...
  %5 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !13
  %idxprom383 = sext i32 %k.0 to i64
  %arrayidx394 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom383
  %idxprom405 = sext i32 %l1.1 to i64
  %arrayidx416 = getelementptr inbounds [10 x i32], ptr %arrayidx394, i64 0, i64 %idxprom405
  %6 = load i32, ptr %arrayidx416, align 4, !tbaa !5, !invariant.load !13
  %cmp427 = icmp slt i32 %6, %5
  br i1 %cmp427, label %for.inc50, label %for.inc50

land.lhs.true:                                    ; preds = %if.end37
  %7 = phi i32 [ %4, %if.end37 ]
  %min.29 = phi i32 [ %min.1, %if.end37 ]
  %l2.28 = phi i32 [ %l2.1, %if.end37 ]
...
for.inc50:                                        ; preds = %if.end37.thread, %if.end37, %land.lhs.true, %if.then44, %if.end37.thread
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.28, %land.lhs.true ], [ %l2.1, %if.end37 ], [ %k.0, %if.end37.thread ], [ %k.0, %if.end37.thread ]
  %min.3 = phi i32 [ %7, %if.then44 ], [ %min.29, %land.lhs.true ], [ %min.1, %if.end37 ], [ %5, %if.end37.thread ], [ %5, %if.end37.thread ]
