...
for.body25:                                       ; preds = %for.cond21
  ...
  br i1 %cmp33, label %for.inc39, label %for.inc39

for.inc39:                                        ; preds = %for.body25, %for.body25
...
for.cond74:                                       ; preds = %for.cond74
  %puts = call i32 @puts(ptr noundef nonnull dereferenceable(1) %a) #9
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv.next63, 1
  %exitcond67.not = icmp eq i64 %indvars.iv.next63, poison
  br label %for.cond74
