...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 120, ptr nonnull %num) #6
  call void @llvm.lifetime.start.p0(i64 120, ptr nonnull %count) #6
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc30
  %indvars.iv23 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next24, %for.inc30 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond33, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %arrayidx11 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv23
  %arrayidx16 = getelementptr inbounds nuw [30 x i32], ptr %count, i64 0, i64 %indvars.iv23
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc27
  %indvars.iv20 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next21, %for.inc27 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [30 x i32], ptr %num, i64 0, i64 %indvars.iv20
...
if.then:                                          ; preds = %for.body9
  ...
  %arrayidx18 = getelementptr inbounds nuw [30 x i32], ptr %count, i64 0, i64 %indvars.iv20
  %5 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %add = add nsw i32 %5, 1
  %spec.store.select = call i32 @llvm.smax.i32(i32 %4, i32 %add)
  store i32 %spec.store.select, ptr %arrayidx16, align 4
  br label %for.inc27

for.inc27:                                        ; preds = %if.then, %for.body9
...
for.cond33:                                       ; preds = %for.cond4, %for.body35
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body35 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body35 ], [ 1, %for.cond4 ]
  %exitcond32.not = icmp eq i64 %indvars.iv29, %wide.trip.count27
  br i1 %exitcond32.not, label %for.end45, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [30 x i32], ptr %count, i64 0, i64 %indvars.iv29
...
for.end45:                                        ; preds = %for.cond33
  ...
  call void @llvm.lifetime.end.p0(i64 120, ptr nonnull %count) #6
  call void @llvm.lifetime.end.p0(i64 120, ptr nonnull %num) #6
