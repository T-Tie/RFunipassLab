...
for.cond:                                         ; preds = %for.inc11, %entry
  ...
  %0 = phi i32 [ %dec, %for.inc11 ], [ %sub, %entry ]
...
for.cond3:                                        ; preds = %for.inc, %if.then
  %.sink = phi i32 [ %1, %if.then ], [ %3, %for.inc ]
...
for.cond14:                                       ; preds = %for.inc21, %for.end12
  %6 = load i32, ptr %j13, align 4, !tbaa !5
  %7 = load i32, ptr %pre, align 4, !tbaa !5
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %8 = load i8, ptr %arrayidx19, align 1, !tbaa !9
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %8)
