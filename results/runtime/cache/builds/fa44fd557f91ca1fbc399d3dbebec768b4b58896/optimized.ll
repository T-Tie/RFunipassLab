...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax45 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  ...
  %exitcond40.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond40.not, label %for.inc125, label %for.body75

for.body75:                                       ; preds = %for.cond72
  br label %NodeBlock

NodeBlock:                                        ; preds = %for.body75
  %Pivot = icmp slt i32 %6, 1
  br i1 %Pivot, label %LeafBlock, label %LeafBlock48

LeafBlock48:                                      ; preds = %NodeBlock
  %SwitchLeaf49 = icmp eq i32 %6, 1
  br i1 %SwitchLeaf49, label %for.inc122, label %lor.lhs.false.thread

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i32 %6, 0
  br i1 %SwitchLeaf, label %land.lhs.true, label %lor.lhs.false.thread

land.lhs.true:                                    ; preds = %LeafBlock
  %switch = icmp samesign ult i64 %indvars.iv34, 2
  br i1 %switch, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %LeafBlock48, %LeafBlock
  %7 = trunc nuw nsw i64 %indvars.iv34 to i32
  br label %NodeBlock54

NodeBlock54:                                      ; preds = %lor.lhs.false.thread
  %Pivot55 = icmp slt i32 %7, 1
  br i1 %Pivot55, label %LeafBlock50, label %LeafBlock52

LeafBlock52:                                      ; preds = %NodeBlock54
  %SwitchLeaf53 = icmp eq i32 %7, 1
  br i1 %SwitchLeaf53, label %for.inc122, label %if.else107

LeafBlock50:                                      ; preds = %NodeBlock54
  %SwitchLeaf51 = icmp eq i32 %7, 0
  br i1 %SwitchLeaf51, label %if.then97, label %if.else107
...
for.inc122:                                       ; preds = %LeafBlock52, %LeafBlock48, %land.lhs.true, %if.then85, %if.else107, %if.then97
