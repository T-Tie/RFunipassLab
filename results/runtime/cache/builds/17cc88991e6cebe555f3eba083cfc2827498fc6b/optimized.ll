...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc19 ], [ %idxprom2, %for.end ]
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc45 ], [ %idxprom2, %for.body24 ]
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select3 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
