...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax51 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %smax27 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond13.not, label %for.cond27.preheader, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv4 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next5, %for.inc21 ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv24 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next25, %for.inc60 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv19 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next20, %for.inc57 ]
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond41.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv47 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next48, %for.inc104 ]
