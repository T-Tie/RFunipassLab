...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 676, ptr %f1) #5
  call void @llvm.lifetime.start.p0(i64 676, ptr %f2) #5
...
for.cond2:                                        ; preds = %for.inc14, %for.body
  %i.sink8 = phi ptr [ %i, %for.body ], [ %j, %for.inc14 ]
  %0 = load i32, ptr %i.sink8, align 4, !tbaa !5
  %add = add nsw i32 %0, 1
...
for.end143:                                       ; preds = %for.cond113
  ...
  call void @llvm.lifetime.end.p0(i64 676, ptr %f2) #5
  call void @llvm.lifetime.end.p0(i64 676, ptr %f1) #5
  ret i32 0
}
