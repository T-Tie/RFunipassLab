...
if.end:                                           ; preds = %while.body
  ...
  tail call void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef nonnull align 4 %__first, ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull align 4 %add.ptr.i, ptr noundef nonnull align 4 %add.ptr2.i)
  %call.i = tail call noundef nonnull ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull align 4 %__last.addr.0, ptr noundef nonnull align 4 %__first) #11
...
while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div34, %if.end ], [ %dec, %while.body ]
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef align 4 %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef align 4 %__c) local_unnamed_addr #4 comdat {
entry:
...
define linkonce_odr dso_local noundef nonnull ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef align 4 %__pivot) local_unnamed_addr #5 comdat {
entry:
  br label %while.body
...
if.then2:                                         ; preds = %for.body
  ...
  %call.i.i.i.i = tail call noundef ptr @_ZNSt20__copy_move_backwardILb1ELb1ESt26random_access_iterator_tagE13__copy_move_bIiiEEPT0_PT_S6_S4_(ptr noundef nonnull align 4 dereferenceable(4) %__first, ptr noundef nonnull align 4 dereferenceable(4) %__i.0, ptr noundef nonnull %add.ptr3)
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %1 = load i32, ptr %incdec.ptr, align 4, !tbaa !5, !invariant.load !24
  %cmp.i = icmp slt i32 %__val.0.__val.0.__val.0.__val.0.2, %1
  br i1 %cmp.i, label %while.cond, label %while.end, !llvm.loop !25
