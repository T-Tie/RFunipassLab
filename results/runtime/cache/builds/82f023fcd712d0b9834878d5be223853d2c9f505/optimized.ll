...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %or.cond87 = select i1 %call16.i21, i1 %or.cond.i25, i1 false
  br i1 %or.cond87, label %if.then19.i26, label %if.then6.i52
...
if.then6.i52:                                     ; preds = %if.then28.i37, %if.then19.i26, %if.then6.i11
  ...
  %or.cond88 = select i1 %call16.i62, i1 %or.cond.i66, i1 false
  br i1 %or.cond88, label %if.then19.i67, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit83
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit83: ; preds = %if.then6.i52, %if.then19.i67, %if.then28.i78
  ...
  %smax99 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit83
  %indvars.iv110 = phi i32 [ %indvars.iv.next111, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit83 ]
  %indvars.iv105 = phi i32 [ %indvars.iv.next106, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit83 ]
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count108 = zext i32 %indvars.iv105 to i64
  br label %for.cond37

for.inc30:                                        ; preds = %for.body, %for.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %indvars.iv.next106 = add nuw i32 %indvars.iv105, 1
