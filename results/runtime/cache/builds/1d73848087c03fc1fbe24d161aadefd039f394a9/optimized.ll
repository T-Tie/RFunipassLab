...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 300, ptr %s) #9
  call void @llvm.lifetime.start.p0(i64 300, ptr %rep) #9
  call void @llvm.lifetime.start.p0(i64 300, ptr %sub) #9
...
if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.end.p0(i64 300, ptr %sub) #9
  call void @llvm.lifetime.end.p0(i64 300, ptr %rep) #9
  call void @llvm.lifetime.end.p0(i64 300, ptr %s) #9
  ret i32 0
}
