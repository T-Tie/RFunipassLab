...
if.then55:                                        ; preds = %for.body51
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %11, double noundef %12) #8
  br label %for.inc110
...
if.then67:                                        ; preds = %if.else63
  %call71 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %11) #8
  br label %for.inc110
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %fneg81, double noundef %14, double noundef %fneg81, double noundef %14) #8
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %arrayidx99 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv30
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %11, double noundef %14, double noundef %11, double noundef %14) #8
  br label %for.inc110
