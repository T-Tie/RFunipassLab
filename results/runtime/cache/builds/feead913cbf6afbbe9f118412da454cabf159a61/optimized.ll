...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull %ch) #8
...
if.then6.i:                                       ; preds = %for.body
  ...
  %3 = load i64, ptr %gep31, align 8, !tbaa !12
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !41, !invariant.load !11
...
!37 = !{!38, !39, i64 16}
!38 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !39, i64 8, !39, i64 16, !39, i64 24, !39, i64 32, !39, i64 40, !39, i64 48, !21, i64 56}
!39 = !{!"p1 omnipotent char", !18, i64 0}
!40 = !{!38, !39, i64 24}
!41 = !{!7, !7, i64 0}
!42 = !{!25, !29, i64 240}
!43 = !{!44, !7, i64 56}
!44 = !{!"_ZTSSt5ctypeIcE", !45, i64 0, !46, i64 16, !27, i64 24, !47, i64 32, !47, i64 40, !48, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!45 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!46 = !{!"p1 _ZTS15__locale_struct", !18, i64 0}
!47 = !{!"p1 int", !18, i64 0}
!48 = !{!"p1 short", !18, i64 0}
