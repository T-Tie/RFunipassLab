...
for.cond.i:                                       ; preds = %_Z5powerii.exit.i, %while.body
  %indvars.iv = phi i32 [ %indvars.iv.next, %_Z5powerii.exit.i ], [ 0, %while.body ]
  %j.0.i = phi i32 [ %2, %_Z5powerii.exit.i ], [ 1, %while.body ]
...
_Z5powerii.exit.i:                                ; preds = %for.cond.i.i
  ...
  br i1 %cmp.i, label %for.cond.preheader, label %for.cond.i, !llvm.loop !12

for.cond.preheader:                               ; preds = %_Z5powerii.exit.i
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv, i32 noundef 1)
  %3 = add nuw i32 %smax, 1
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %i.0 = phi i32 [ %inc, %for.inc ], [ 2, %for.cond.preheader ]
  %sum.0 = phi i32 [ %add, %for.inc ], [ 1, %for.cond.preheader ]
...
if.end:                                           ; preds = %entry
  ...
  %smax = call i32 @llvm.smax.i32(i32 noundef %h, i32 noundef %n)
  br label %for.cond
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax3 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax3 to i64
  br label %for.cond9
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  ...
  %exitcond4.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond4.not, label %cleanup, label %for.inc16
...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %b, i32 noundef 0)
