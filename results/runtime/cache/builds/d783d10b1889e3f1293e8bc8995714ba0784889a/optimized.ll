...
for.cond51:                                       ; preds = %entry, %for.cond51
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.cond51 ], [ 0, %entry ]
  %cmp66 = phi i1 [ false, %for.cond51 ], [ true, %entry ]
  %max.0 = phi i32 [ -2147483648, %for.cond51 ], [ 1, %entry ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count57
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  br i1 %exitcond63.not, label %for.end65, label %for.cond51, !llvm.loop !9
...
for.cond73:                                       ; preds = %for.end65
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %max.0)
  %vtable.i = load ptr, ptr %call70, align 8, !tbaa !12, !invariant.load !14
  ...
  %cmp75 = icmp sge i32 %1, %conv
  call void @llvm.assume(i1 %cmp75)
  br label %if.end91
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !40, !invariant.load !14
