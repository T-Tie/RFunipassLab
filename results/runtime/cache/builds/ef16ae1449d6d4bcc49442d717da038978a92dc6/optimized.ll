...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv8
  %4 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  call void @_Z8zhongshuii(i32 noundef 2, i32 noundef %4)
  ...
  %vtable.i = load ptr, ptr %call7, align 8, !tbaa !12
...
if.then3:                                         ; preds = %for.body
  tail call void @_Z8zhongshuii(i32 noundef %i.0, i32 noundef %div)
  br label %for.inc
