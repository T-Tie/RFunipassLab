...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50000, ptr noundef nonnull dereferenceable(50000) %word) #10
...
for.inc:                                          ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1000 x [50 x i8]], ptr %word, i64 0, i64 %idxprom
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPclc(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %arrayidx, i64 noundef 50, i8 noundef signext 32)
...
for.cond3:                                        ; preds = %for.inc40, %for.end
  %sum.0 = phi i32 [ 0, %for.end ], [ %sum.1, %for.inc40 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %add13, %for.inc40 ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %sub = sub nsw i32 %1, 1
  %cmp4 = icmp slt i32 %i.1, %sub
  br i1 %cmp4, label %for.body5, label %for.end42

for.body5:                                        ; preds = %for.cond3
  %idxprom6 = sext i32 %i.1 to i64
  %arrayidx7 = getelementptr inbounds [1000 x [50 x i8]], ptr %word, i64 0, i64 %idxprom6
  %call9 = call i64 @strlen(ptr noundef %arrayidx7) #11
  %add = add i64 %call9, 1
  %conv = sext i32 %sum.0 to i64
  %add10 = add i64 %conv, %add
  %conv11 = trunc i64 %add10 to i32
  %conv12 = sext i32 %conv11 to i64
  %add13 = add nsw i32 %i.1, 1
  %idxprom14 = sext i32 %add13 to i64
  %arrayidx15 = getelementptr inbounds [1000 x [50 x i8]], ptr %word, i64 0, i64 %idxprom14
  %call17 = call i64 @strlen(ptr noundef %arrayidx15) #11
  %add18 = add i64 %conv12, %call17
  %cmp19 = icmp ule i64 %add18, 80
  br i1 %cmp19, label %if.then, label %if.else

if.then:                                          ; preds = %for.body5
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx7)
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call23, ptr noundef nonnull dereferenceable(2) @.str)
  br label %for.inc40

if.else:                                          ; preds = %for.body5
  br i1 true, label %if.then33, label %for.inc40

if.then33:                                        ; preds = %if.else
  call void @outlined_ir_func_0(ptr %arrayidx7)
  br label %for.inc40

for.inc40:                                        ; preds = %if.then, %if.then33, %if.else
  %sum.1 = phi i32 [ %conv11, %if.then ], [ 0, %if.then33 ], [ poison, %if.else ]
  br label %for.cond3, !llvm.loop !12

for.end42:                                        ; preds = %for.cond3
  %idxprom44 = sext i32 %sub to i64
  %arrayidx45 = getelementptr inbounds [1000 x [50 x i8]], ptr %word, i64 0, i64 %idxprom44
  call void @outlined_ir_func_0(ptr %arrayidx45)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #12
  call void @llvm.lifetime.end.p0(i64 noundef 50000, ptr noundef %word) #12
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !13, !invariant.load !21
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !22, !invariant.load !21
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !23, !invariant.load !21
...
newFuncRoot:
  br label %if.then33_to_outline

if.then33_to_outline:                             ; preds = %newFuncRoot
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %0)
  ...
  br label %if.then33_after_outline.exitStub

if.then33_after_outline.exitStub:                 ; preds = %if.then33_to_outline
  ret void
}
...
!13 = !{!14, !7, i64 56}
!14 = !{!"_ZTSSt5ctypeIcE", !15, i64 0, !16, i64 16, !18, i64 24, !19, i64 32, !19, i64 40, !20, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!15 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!16 = !{!"p1 _ZTS15__locale_struct", !17, i64 0}
