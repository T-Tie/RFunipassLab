...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc35
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre12, %for.inc35 ]
  %indvars.iv9 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next10, %for.inc35 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv9, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv9
...
for.inc35:                                        ; preds = %for.body15, %if.else, %if.else31
  ...
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str.2.sink.sink)
