...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  %indvars.iv10 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next11, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond2
  ...
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv10
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv14
