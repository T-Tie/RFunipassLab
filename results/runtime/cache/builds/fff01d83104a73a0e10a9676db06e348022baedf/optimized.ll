...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %or.cond85 = select i1 %call16.i20, i1 %or.cond.i24, i1 false
  br i1 %or.cond85, label %if.then19.i25, label %if.then6.i51
...
if.then6.i51:                                     ; preds = %if.then28.i36, %if.then19.i25, %if.then6.i10
  ...
  %or.cond86 = select i1 %call16.i61, i1 %or.cond.i65, i1 false
  br i1 %or.cond86, label %if.then19.i66, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
  %indvars.iv108 = phi i32 [ %indvars.iv.next109, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82 ]
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count106 = and i64 %indvars.iv, 4294967295
  br label %for.cond37
