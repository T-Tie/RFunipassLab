...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %initial) #11
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry
  ...
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %initial) #12
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %word) #11
  ...
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i11
  %3 = load i64, ptr %gep, align 8, !tbaa !9
  ...
  %call16.i18 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i17) #11
  %4 = add i64 %3, -42
  %or.cond.i22 = icmp ult i64 %4, -41
  %or.cond40 = select i1 %call16.i18, i1 %or.cond.i22, i1 false
  br i1 %or.cond40, label %if.then19.i23, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit39

if.then19.i23:                                    ; preds = %while.body
  call void @outlined_ir_func_0()
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit39

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit39: ; preds = %if.then19.i23, %while.body
  %call9 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %word) #12
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %word) #11
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull captures(none) %initial) #11
...
define internal void @outlined_ir_func_0() #9 {
if.then19.i_to_outline:
  ...
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i) #11
