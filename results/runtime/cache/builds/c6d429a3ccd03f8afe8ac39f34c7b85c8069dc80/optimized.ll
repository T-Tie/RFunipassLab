...
for.inc10:                                        ; preds = %for.cond2
  ...
  %call7 = call noundef i32 @_Z4factii(i32 noundef %1, i32 noundef 2) #8
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !16, !invariant.load !12
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !18, !invariant.load !12
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !16, !invariant.load !12
