...
entry:
  ...
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %a)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) %call, ptr noundef %b)
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) %call2, ptr noundef %c)
  %call6 = call i64 @strlen(ptr noundef %a) #12
...
for.end:                                          ; preds = %if.then24, %for.cond14
  %m.4 = phi i32 [ %inc, %if.then24 ], [ %m.3, %for.cond14 ]
...
if.end29:                                         ; preds = %if.end28, %for.body
  %m.2 = phi i32 [ %m.4, %if.end28 ], [ %m.0, %for.body ]
  br label %for.inc30
...
for.end32:                                        ; preds = %if.then27, %for.cond
  %phiofops = phi i1 [ true, %for.cond ], [ false, %if.then27 ]
  %m.1 = phi i32 [ %i.0, %if.then27 ], [ %m.0, %for.cond ]
  %k.0 = phi i32 [ 1, %if.then27 ], [ 0, %for.cond ]
  br i1 %phiofops, label %if.then34, label %if.else
...
for.body39:                                       ; preds = %for.cond37
  ...
  %call42 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %4)
  br label %for.inc43
...
for.body50:                                       ; preds = %for.cond48
  ...
  %5 = load i8, ptr %arrayidx52, align 1, !tbaa !5
  %call53 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %5)
  br label %for.inc54
