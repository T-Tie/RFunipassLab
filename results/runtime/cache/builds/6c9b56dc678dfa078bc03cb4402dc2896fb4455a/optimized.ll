...
while.cond.preheader:                             ; preds = %for.cond1
  %smax73 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
for.cond14.preheader:                             ; preds = %while.cond
  %smax69 = call i32 @llvm.smax.i32(i32 %indvars.iv10, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond16.not, label %for.cond45, label %for.body16
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count15
  br i1 %exitcond27.not, label %for.cond70, label %for.cond49.preheader
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count15
  br i1 %exitcond38.not, label %for.cond104, label %for.body73
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond60.not, label %for.cond154, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc174 ], [ 0, %for.cond131 ]
...
for.cond158:                                      ; preds = %for.cond154, %for.inc171
  ...
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count
