...
if.then90:                                        ; preds = %for.end87
  %call91 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #6
  br label %for.inc95

if.else92:                                        ; preds = %for.end87
  %call93 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #6
  br label %for.inc95

for.inc95:                                        ; preds = %if.then90, %if.else92
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %total2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %total1) #6
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %3) unnamed_addr #4 {
for.body_to_outline:
  br label %for.cond2
...
for.inc.gvnsink.split:                            ; preds = %land.lhs.true, %lor.lhs.false32, %if.else
  %.sink3 = phi i32 [ 28, %if.else ], [ 29, %lor.lhs.false32 ], [ 29, %land.lhs.true ]
  %8 = load i32, ptr %2, align 4, !tbaa !5
  %add37 = add nsw i32 %8, %.sink3
