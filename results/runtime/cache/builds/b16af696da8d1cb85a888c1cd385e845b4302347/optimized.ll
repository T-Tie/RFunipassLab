...
for.inc.gvnsink.split:                            ; preds = %if.else, %lor.lhs.false32, %land.lhs.true, %lor.lhs.false22, %lor.lhs.false20, %lor.lhs.false18, %if.end
  %.sink2.sink = phi i32 [ 30, %if.end ], [ 30, %lor.lhs.false18 ], [ 30, %lor.lhs.false20 ], [ 30, %lor.lhs.false22 ], [ 28, %if.else ], [ 29, %lor.lhs.false32 ], [ 29, %land.lhs.true ]
  %5 = load i32, ptr %total1, align 4, !tbaa !5
  %add37 = add nsw i32 %5, %.sink2.sink
...
for.inc85.gvnsink.split:                          ; preds = %if.else81, %lor.lhs.false76, %land.lhs.true73, %lor.lhs.false64, %lor.lhs.false62, %lor.lhs.false60, %if.end58
  %.sink1.sink = phi i32 [ 30, %if.end58 ], [ 30, %lor.lhs.false60 ], [ 30, %lor.lhs.false62 ], [ 30, %lor.lhs.false64 ], [ 28, %if.else81 ], [ 29, %lor.lhs.false76 ], [ 29, %land.lhs.true73 ]
  %9 = load i32, ptr %total2, align 4, !tbaa !5
  %add82 = add nsw i32 %9, %.sink1.sink
  store i32 %add82, ptr %total2, align 4, !tbaa !5
  br label %for.inc85

for.inc85:                                        ; preds = %for.inc85.gvnsink.split, %if.end68
  %inc86 = add nsw i32 %.sink7, 1
