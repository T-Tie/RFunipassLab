...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.end136
  %indvars.iv99 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next100, %for.end136 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.end136 ]
  %exitcond104.not = icmp eq i64 %indvars.iv99, %wide.trip.count103
  br i1 %exitcond104.not, label %for.end140, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.end59
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.end59 ], [ 0, %for.cond13 ]
  %exitcond71.not = icmp eq i64 %indvars.iv66, %wide.trip.count70
  br i1 %exitcond71.not, label %for.cond63, label %for.body18
...
for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  ...
  %cmp3451 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp3451, i32 %min.0, i32 %8
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  br label %for.cond22, !llvm.loop !14

for.cond42:                                       ; preds = %for.cond42.preheader, %if.end56
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %if.end56 ], [ 0, %for.cond42.preheader ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count
  br i1 %exitcond65.not, label %for.end59, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv60
...
if.end56:                                         ; preds = %if.then50, %for.body44
...
for.cond63:                                       ; preds = %for.cond16, %for.end109
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.end109 ], [ 0, %for.cond16 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %wide.trip.count70
  br i1 %exitcond88.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv84
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond77.not = icmp eq i64 %indvars.iv72, %wide.trip.count
  br i1 %exitcond77.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv84
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !13
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp8250 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp8250, i32 %min.2, i32 %12
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  br label %for.cond69, !llvm.loop !17

for.cond92:                                       ; preds = %for.cond92.preheader, %if.end106
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %if.end106 ], [ 0, %for.cond92.preheader ]
  %exitcond83.not = icmp eq i64 %indvars.iv78, %wide.trip.count
  br i1 %exitcond83.not, label %for.end109, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv78, i64 %indvars.iv84
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv99, i64 %indvars.iv99
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond117

for.cond117:                                      ; preds = %for.body119, %for.end112
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.body119 ], [ 0, %for.end112 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %wide.trip.count70
  br i1 %exitcond93.not, label %for.cond127, label %for.body119

for.body119:                                      ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv89, i64 %indvars.iv99
...
for.cond127:                                      ; preds = %for.cond117, %for.body129
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.body129 ], [ 0, %for.cond117 ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %wide.trip.count70
  br i1 %exitcond98.not, label %for.end136, label %for.body129

for.body129:                                      ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv99, i64 %indvars.iv94
