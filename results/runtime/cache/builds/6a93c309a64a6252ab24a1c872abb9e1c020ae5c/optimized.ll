...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 201, ptr noundef nonnull align 16 dereferenceable(201) %a) #5
...
while.end14:                                      ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 201, ptr noundef nonnull %a) #7
  ret i32 0
}
