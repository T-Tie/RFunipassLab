...
for.cond3.preheader:                              ; preds = %for.cond
  %smax13 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc48
  %indvars.iv9 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next10, %for.inc48 ]
  %j.0 = phi i32 [ 0, %for.cond3.preheader ], [ %j.1, %for.inc48 ]
  %exitcond15.not = icmp eq i64 %indvars.iv9, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond52.preheader, label %for.body6

for.cond52.preheader:                             ; preds = %for.cond3
  %sub56 = add nsw i32 %j.0, -1
  %2 = sext i32 %sub56 to i64
  %smax20 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  br label %for.cond52

for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv9
...
if.end:                                           ; preds = %if.then, %for.body6
  ...
  %smax7 = call i32 @llvm.smax.i32(i32 %j.1, i32 noundef 0)
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc45, %if.end
  %indvars.iv5.in = phi i32 [ %indvars.iv5, %for.inc45 ], [ %j.1, %if.end ]
  %p.0 = phi i32 [ %inc46, %for.inc45 ], [ 0, %if.end ]
  %indvars.iv5 = add i32 %indvars.iv5.in, -1
  %exitcond8.not = icmp eq i32 %p.0, %smax7
  br i1 %exitcond8.not, label %for.inc48, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc42
  %indvars.iv2 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next3, %for.inc42 ]
  %exitcond.not = icmp eq i64 %indvars.iv2, %wide.trip.count
  br i1 %exitcond.not, label %for.inc45, label %for.body24

for.body24:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv2
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv.next3
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc66
  %indvars.iv16 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next17, %for.inc66 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end68, label %for.body55

for.body55:                                       ; preds = %for.cond52
  %cmp57 = icmp slt i64 %indvars.iv16, %2
  %arrayidx60 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv16
