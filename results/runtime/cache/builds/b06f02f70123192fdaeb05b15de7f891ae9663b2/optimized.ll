; ModuleID = '<stdin>'
source_filename = "/tmp/tmpko5u9bdp.cpp"
...
for.cond4:                                        ; preds = %if.end30, %for.end
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %if.end30 ], [ 1, %for.end ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp6.not.not = icmp slt i64 %indvars.iv17, %4
  br i1 %cmp6.not.not, label %for.cond8.preheader, label %for.end33
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.body11
  %indvars.iv14 = phi i64 [ 1, %for.cond8.preheader ], [ %indvars.iv.next15, %for.body11 ]
  %k.0 = phi i32 [ 0, %for.cond8.preheader ], [ %k.1, %for.body11 ]
...
for.body11:                                       ; preds = %for.cond8
  ...
  %arrayidx15 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv14
  %6 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %cmp16.not = icmp eq i32 %5, %6
  %add17 = zext i1 %cmp16.not to i32
  %k.1 = add nuw nsw i32 %k.0, %add17
...
land.lhs.true:                                    ; preds = %for.end20
  ...
  %cmp25.not = icmp eq i32 %7, %8
  br i1 %cmp25.not, label %if.end30, label %if.then26

if.then26:                                        ; preds = %land.lhs.true
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %7)
  br label %if.end30

if.end30:                                         ; preds = %if.then26, %land.lhs.true, %for.end20
