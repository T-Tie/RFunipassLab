...
for.cond19:                                       ; preds = %for.end46, %if.end18
  %i.2 = phi i32 [ 0, %if.end18 ], [ %inc48, %for.end46 ]
...
for.cond22:                                       ; preds = %if.end43, %for.body21
  %j.0 = phi i32 [ 0, %for.body21 ], [ %add, %if.end43 ]
...
for.end49:                                        ; preds = %for.cond19
  ...
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %4)
  br label %for.cond52

for.cond52:                                       ; preds = %for.body54, %for.end49
  %i.3 = phi i32 [ 1, %for.end49 ], [ %inc60, %for.body54 ]
