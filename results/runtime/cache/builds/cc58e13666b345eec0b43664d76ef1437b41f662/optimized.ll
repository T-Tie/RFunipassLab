...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull align 16 dereferenceable(1600) %a) #5
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !29, !invariant.load !14
