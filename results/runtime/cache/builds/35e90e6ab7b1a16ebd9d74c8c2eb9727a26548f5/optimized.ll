...
for.cond39:                                       ; preds = %for.inc50, %for.end38
  %.sink4 = phi i32 [ 97, %for.end38 ], [ %inc51, %for.inc50 ]
  store i32 %.sink4, ptr @i, align 4, !tbaa !5
  %cmp40 = icmp sle i32 %.sink4, 122
  br i1 %cmp40, label %for.body41, label %for.end52

for.body41:                                       ; preds = %for.cond39
  %idxprom42 = sext i32 %.sink4 to i64
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %.sink4, i32 noundef %6)
  br label %for.inc50
