...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv2, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre10, %for.inc ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv6 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next7, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv6
  %4 = load i32, ptr %add.ptr21, align 4, !tbaa !5
  %cmp22 = icmp eq i32 %4, 0
  br i1 %cmp22, label %for.inc26.split.loop.exit12, label %for.inc23

for.inc23:                                        ; preds = %for.body16
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  br label %for.cond14, !llvm.loop !13

for.inc26.split.loop.exit12:                      ; preds = %for.body16
  %5 = trunc nuw nsw i64 %indvars.iv6 to i32
  br label %for.inc26

for.inc26:                                        ; preds = %for.cond14, %for.inc26.split.loop.exit12
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit12 ], [ %c1.0, %for.cond14 ]
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit12 ], [ %r1.0, %for.cond14 ]
  %i.2 = phi i32 [ 9999, %for.inc26.split.loop.exit12 ], [ %i.1, %for.cond14 ]
