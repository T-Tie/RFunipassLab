...
define dso_local void @_Z3sumii(i32 noundef %c1, i32 noundef %c2) #0 {
entry:
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv20 = phi i64 [ %1, %for.cond.preheader ], [ %3, %for.inc ]
...
for.end:                                          ; preds = %for.cond
  %call2 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
