...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %number) #9
  ...
  call void @llvm.lifetime.start.p0(i64 25000, ptr nonnull %word) #9
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 25000, ptr nonnull %word) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %number) #9
  ret i32 0
}
...
!30 = !{!31, !6, i64 56}
!31 = !{!"_ZTSSt5ctypeIcE", !32, i64 0, !33, i64 16, !34, i64 24, !35, i64 32, !35, i64 40, !36, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
