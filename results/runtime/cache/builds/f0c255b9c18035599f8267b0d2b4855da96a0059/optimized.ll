...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %year) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %m1) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %m2) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x) #10
...
for.cond14:                                       ; preds = %for.inc, %if.then13
  ...
  br i1 %cmp15, label %for.body16, label %for.inc53
...
for.inc:                                          ; preds = %sw.bb17, %sw.default, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16
  %.sink2 = phi i32 [ 29, %sw.bb17 ], [ 30, %sw.default ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ]
  %4 = load i32, ptr %x, align 4, !tbaa !5
  %add18 = add nsw i32 %4, %.sink2
...
for.cond30:                                       ; preds = %for.inc40, %if.else29
  ...
  br i1 %cmp31, label %for.body32, label %for.inc53
...
for.inc40:                                        ; preds = %sw.bb35, %sw.default37, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32
  ...
  %add36 = add nsw i32 %5, %.sink1
  store i32 %add36, ptr %x, align 4, !tbaa !5
  %inc41 = add nsw i32 %m.1, 1
  br label %for.cond30, !llvm.loop !12

for.inc53:                                        ; preds = %for.cond14, %for.cond30
  call fastcc void @outlined_ir_func_0(ptr %x)
  %inc54 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !13

for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %x) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %m2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %m1) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %year) #11
...
if.end52.exitStub:                                ; preds = %if.then22, %if.else25
