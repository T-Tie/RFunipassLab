...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %year) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m2) #9
...
for.inc:                                          ; preds = %for.cond
  ...
  call void @_Z9xiangguaniii(i32 noundef %1, i32 noundef %2, i32 noundef %3) #10
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m2) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m1) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %year) #10
...
for.end39:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x1) #9
  store i32 0, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x2) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #9
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %i, i32 noundef %m1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x1, i32 noundef %y) #11
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j, i32 noundef %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x2, i32 noundef %y) #11
...
for.cond:                                         ; preds = %for.inc, %entry_to_outline
  %sub106 = phi i32 [ %.promoted, %entry_to_outline ], [ %sub107, %for.inc ]
...
if.end.thread:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  %dec = add nsw i32 %sub106, 30
  br label %for.inc.sink.split

if.then8:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z7runniani(i32 noundef %3) #12
...
for.inc:                                          ; preds = %for.inc.sink.split, %for.body
  %sub107 = phi i32 [ %add, %for.body ], [ %dec.sink, %for.inc.sink.split ]
...
; Function Attrs: nofree nounwind
declare noundef i32 @puts(ptr noundef readonly captures(none)) #8
...
attributes #11 = { nofree norecurse nounwind willreturn }
attributes #12 = { nofree nosync willreturn }
