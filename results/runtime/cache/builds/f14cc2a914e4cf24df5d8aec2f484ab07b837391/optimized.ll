...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %s) #9
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %rep) #9
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %sub) #9
  ...
  %call7 = call noundef ptr @strstr(ptr noundef %s, ptr noundef %sub) #10
...
if.then:                                          ; preds = %entry
  ...
  %call16 = call i64 @strlen(ptr noundef %sub) #10
...
if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef captures(none) %sub) #11
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef captures(none) %rep) #11
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef captures(none) %s) #11
  ret i32 0
}
