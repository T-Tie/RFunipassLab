...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc18
  %indvars.iv12 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next13, %for.inc18 ]
  %count.1 = phi i32 [ 0, %for.cond6.preheader ], [ %count.2, %for.inc18 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count15
  br i1 %exitcond16.not, label %for.end20, label %for.cond8.preheader

for.cond8.preheader:                              ; preds = %for.cond6
  %arrayidx14 = getelementptr inbounds nuw [15 x i32], ptr %a, i64 0, i64 %indvars.iv12
  br label %for.cond8

for.cond8:                                        ; preds = %for.cond8.preheader, %for.body10
  %indvars.iv = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next, %for.body10 ]
  %count.2 = phi i32 [ %count.1, %for.cond8.preheader ], [ %spec.select, %for.body10 ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  %spec.select = add nsw i32 %count.2, %inc
...
for.end20:                                        ; preds = %for.cond6
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %count.1)
  %vtable.i = load ptr, ptr %call21, align 8, !tbaa !13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call21, i8 noundef signext %call.i10)
