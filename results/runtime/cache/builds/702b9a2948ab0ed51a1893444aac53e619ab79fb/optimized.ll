...
define dso_local noundef i32 @_Z3maxPiii(ptr nofree noundef readonly captures(none) %a, i32 noundef %n, i32 noundef %m) #0 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 dereferenceable(400) %a) #4
...
for.end:                                          ; preds = %for.cond
  %call2 = call noundef i32 @_Z3maxPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(400) %a, i32 noundef %0, i32 noundef 0) #5
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %call2)
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %call5 = call noundef i32 @_Z3maxPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(400) %a, i32 noundef %1, i32 noundef %call2) #5
