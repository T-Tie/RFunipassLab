...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc28 ], [ 0, %entry ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.cond31.preheader, label %for.body

for.cond31.preheader:                             ; preds = %for.cond
  br label %for.cond31

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv42
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv37 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next38, %for.body16 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.inc28, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv37
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end68
  %indvars.iv57 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next58, %for.end68 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count45
  br i1 %exitcond61.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv57
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select35, %for.body39 ], [ %3, %for.body33 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond51.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv57
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %spec.select35 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv52 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next53, %for.body56 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.end68, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv57
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
  %smax21 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 1)
  %wide.trip.count22 = zext nneg i32 %smax21 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond1, %entry
  %indvars.iv18 = phi i64 [ 1, %entry ], [ %indvars.iv.next19, %for.cond1 ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond13.preheader, label %for.cond1.preheader
...
for.cond13.preheader:                             ; preds = %for.cond
  %wide.trip.count27 = zext i32 %sub to i64
  br label %for.cond13

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond, label %for.inc, !llvm.loop !15

for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next19, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !9
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv18, i64 %indvars.iv
  store i32 %0, ptr %arrayidx9, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !16

for.cond13:                                       ; preds = %for.cond17, %for.cond13.preheader
  %indvars.iv29 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next30, %for.cond17 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count22
  br i1 %exitcond33.not, label %for.end35, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  %indvars.iv24 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next25, %for.inc30 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond13, label %for.inc30

for.inc30:                                        ; preds = %for.cond17
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv.next30
  %1 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !9
  %arrayidx29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
...
if.else:                                          ; preds = %tailrecurse
  tail call void @_Z7guilingi(i32 noundef %n.tr) #10
...
for.cond:                                         ; preds = %for.end14, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc26.i4, %for.end14 ]
...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  br i1 %cmp2, label %for.cond5, label %for.end14
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv
...
for.end14:                                        ; preds = %for.cond1
  ...
  %inc26.i4 = add nuw nsw i32 %i.0, 1
  br label %for.cond
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !19, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !27, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !28, !invariant.load !9
