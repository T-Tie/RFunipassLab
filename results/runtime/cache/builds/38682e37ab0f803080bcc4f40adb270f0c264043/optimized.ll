...
if.else95:                                        ; preds = %lor.lhs.false.thread
  %idxprom985 = sext i32 %i.2 to i64
  %cmp96 = icmp eq i32 %j.4, 0
  %idxprom100 = sext i32 %j.4 to i64
  %6 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom985
  %7 = getelementptr inbounds [100 x i32], ptr %6, i64 0, i64 %idxprom100
  %8 = load i32, ptr %7, align 4, !tbaa !5
  %sub102 = sub nsw i32 %i.2, 1
  br i1 %cmp96, label %if.then97, label %for.inc122.gvnsink.split
...
for.inc122.gvnsink.split:                         ; preds = %if.else95, %if.then85
  %sub112.sink = phi i32 [ 0, %if.then85 ], [ %sub102, %if.else95 ]
  %.sink = phi i32 [ %5, %if.then85 ], [ %8, %if.else95 ]
...
cleanup:                                          ; preds = %for.end65, %for.end127
  ...
  %9 = load i32, ptr %sum.sink, align 4, !tbaa !5
