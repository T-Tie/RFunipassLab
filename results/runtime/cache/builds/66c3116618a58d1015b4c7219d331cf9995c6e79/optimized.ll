...
for.body:                                         ; preds = %for.cond
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, i32 noundef %y) #6
...
for.cond13:                                       ; preds = %for.body15, %for.end
  %1 = phi i32 [ %.pre2, %for.body15 ], [ 1, %for.end ]
  %cmp14 = icmp slt i32 %1, %m2
  br i1 %cmp14, label %for.body15, label %for.end39

for.body15:                                       ; preds = %for.cond13
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, i32 noundef %y) #6
