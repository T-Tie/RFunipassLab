; ModuleID = '<stdin>'
source_filename = "/tmp/tmpafl6exxw.cpp"
...
entry:
  %st = alloca [100 x [100 x i8]], align 16
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %st) #8
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  ...
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i8]], ptr %st, i64 0, i64 %indvars.iv
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %do.end.i, %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i, %if.else34.i
  ...
  br i1 %cmp, label %while.body, label %for.cond, !llvm.loop !20

for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.inc
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc ], [ %indvars.iv, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ]
  %cmp4 = icmp sgt i64 %indvars.iv10, 0
  br i1 %cmp4, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i8]], ptr %st, i64 0, i64 %indvars.iv10
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx6)
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call8, ptr noundef nonnull @.str)
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, -1
  br label %for.cond, !llvm.loop !23

for.end:                                          ; preds = %for.cond
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %st)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %st) #9
  ret i32 0
}
