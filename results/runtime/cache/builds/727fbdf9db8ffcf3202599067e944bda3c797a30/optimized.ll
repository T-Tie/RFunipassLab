...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %sub.sink10 = phi i32 [ %sub, %for.body31 ], [ %dec, %for.inc44 ]
  %cmp34 = icmp sge i32 %sub.sink10, 0
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idx.ext39 = sext i32 %sub.sink10 to i64
  %add.ptr40 = getelementptr inbounds i32, ptr %add.ptr38, i64 %idx.ext39
  %3 = load i32, ptr %add.ptr40, align 4, !tbaa !5, !invariant.load !13
...
for.inc46:                                        ; preds = %for.body35, %for.cond33
  %c2.1 = phi i32 [ %c2.0, %for.cond33 ], [ %sub.sink10, %for.body35 ]
