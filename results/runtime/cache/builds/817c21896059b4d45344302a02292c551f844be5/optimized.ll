...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc18 ], [ 0, %entry ]
  %exitcond16 = icmp eq i64 %indvars.iv13, %2
  br i1 %exitcond16, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %3 = trunc i64 %call4 to i32
  %4 = add i32 %3, 1
  %5 = sub i32 %4, %0
  %wide.trip.count20 = zext i32 %5 to i64
  br label %for.cond21
...
for.inc:                                          ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv13
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %6
  %7 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv13, i64 %indvars.iv
  store i8 %7, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv13, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  ...
  br i1 %exitcond21.not, label %for.cond29.preheader, label %for.inc26
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv22 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next23, %for.inc54 ]
  %exitcond29.not = icmp eq i64 %indvars.iv22, %wide.trip.count20
  br i1 %exitcond29.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv22
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv22
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv24 = phi i64 [ %indvars.iv22, %for.cond32.preheader ], [ %indvars.iv.next25, %for.inc51 ]
  %cmp33 = icmp samesign ult i64 %indvars.iv24, %8
  br i1 %cmp33, label %for.body34, label %for.inc54

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv24
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv24
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count20
  br i1 %exitcond34.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv30
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc89 ], [ 0, %if.else ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count20
  br i1 %exitcond39.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv35
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv35
