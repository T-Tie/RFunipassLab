...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %3 = phi i32 [ %.pre40, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ %.pre40, %land.lhs.true20 ], [ %.pre40, %land.lhs.true ]
  %4 = phi i32 [ %.pre36, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre36, %land.lhs.true ]
  ...
  %.neg = sub i32 0, %4
  %reass.sub37 = add i32 %.neg, 43200
  %add51 = add i32 %reass.sub37, %reass.mul26
