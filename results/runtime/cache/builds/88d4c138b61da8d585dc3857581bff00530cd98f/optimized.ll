...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv40 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %5 = add nsw i64 %indvars.iv40, -1
  %6 = trunc nuw i64 %indvars.iv40 to i32
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc50 ], [ %9, %for.end41 ]
  %sub44 = add nsw i32 %10, -1
  %11 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv31, %11
