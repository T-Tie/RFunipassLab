...
for.cond89:                                       ; preds = %for.inc114, %if.then88
  %.sink41 = phi i32 [ 0, %if.then88 ], [ %inc115, %for.inc114 ]
  store i32 %.sink41, ptr %z, align 4, !tbaa !5
  %cmp90 = icmp slt i32 %.sink41, 6
  br i1 %cmp90, label %for.inc114, label %for.inc118

for.inc114:                                       ; preds = %for.cond89
  %idxprom94 = sext i32 %.sink41 to i64
