...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr %js) #3
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %LEN)
  br label %for.cond
...
if.end80:                                         ; preds = %for.end75, %if.end63
  call void @llvm.lifetime.end.p0(i64 4000, ptr %js) #3
