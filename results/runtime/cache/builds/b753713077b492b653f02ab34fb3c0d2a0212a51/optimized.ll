...
if.then6.i:                                       ; preds = %for.body
  ...
  %gep2 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i
  %3 = load i64, ptr %gep2, align 8, !tbaa !12
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc13
  %indvars.iv6 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next7, %for.inc13 ]
...
for.inc13:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv6
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #11
  %4 = trunc i64 %call10 to i32
  %conv = add i32 %4, 1
  %add.ptr12 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv6
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc42
  %.pre22 = phi i32 [ %0, %for.cond16.preheader ], [ %.pre, %for.inc42 ]
  %indvars.iv13 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next14, %for.inc42 ]
  %sum.0 = phi i32 [ 0, %for.cond16.preheader ], [ %sum.1, %for.inc42 ]
  %k.0 = phi i32 [ 0, %for.cond16.preheader ], [ %k.1, %for.inc42 ]
  %5 = sext i32 %.pre22 to i64
  %cmp17 = icmp slt i64 %indvars.iv13, %5
...
for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv13
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv10 = phi i64 [ %9, %for.cond23.preheader ], [ %indvars.iv.next11, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv10, %8
  br i1 %cmp24, label %for.inc31, label %for.end33

for.inc31:                                        ; preds = %for.cond23
  %add.ptr27 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv10
...
for.end33:                                        ; preds = %for.cond23
  %gep3 = getelementptr [41 x i8], ptr %invariant.gep, i64 %indvars.iv13
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %gep3)
...
for.inc42:                                        ; preds = %for.body18, %for.end33
  %.pre = phi i32 [ %.pre.pre, %for.end33 ], [ %.pre22, %for.body18 ]
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc54
  %11 = phi i32 [ %.pre22, %for.cond45.preheader ], [ %.pre21, %for.inc54 ]
  %indvars.iv18 = phi i64 [ %6, %for.cond45.preheader ], [ %indvars.iv.next19, %for.inc54 ]
  %sub46 = add nsw i32 %11, -1
  %12 = sext i32 %sub46 to i64
  %cmp47 = icmp slt i64 %indvars.iv18, %12
  br i1 %cmp47, label %for.inc54, label %for.end56

for.inc54:                                        ; preds = %for.cond45
  %add.ptr50 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv18
