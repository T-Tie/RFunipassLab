; ModuleID = '<stdin>'
source_filename = "/tmp/tmppbw_quup.cpp"
...
define dso_local void @_Z1fii(i32 noundef %b, i32 noundef %a) local_unnamed_addr #0 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %if.end, %entry
  %i.0 = phi i32 [ %b, %entry ], [ %inc, %if.end ]
...
if.then:                                          ; preds = %for.body
  ...
  tail call void @_Z1fii(i32 noundef %i.0, i32 noundef %div)
  br label %if.end

if.end:                                           ; preds = %for.body, %if.then
  %cmp5 = icmp sgt i32 %i.0, %div
  %inc = add nsw i32 %i.0, 1
  br i1 %cmp5, label %cleanup, label %for.cond, !llvm.loop !9
...
while.body:                                       ; preds = %while.cond
  ...
  call void @_Z1fii(i32 noundef 2, i32 noundef %1)
