...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %sub44 = sub nsw i32 %10, 1
  %cmp45 = icmp slt i32 %9, %sub44
...
for.inc50:                                        ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11)
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12)
