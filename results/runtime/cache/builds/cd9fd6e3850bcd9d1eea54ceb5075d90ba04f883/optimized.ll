...
for.end50:                                        ; preds = %for.body40, %for.cond38
  %y2.2 = phi i32 [ %y2.0, %for.cond38 ], [ %sub37.sink, %for.body40 ]
  %x2.2 = phi i32 [ %x2.0, %for.cond38 ], [ %sub.sink, %for.body40 ]
