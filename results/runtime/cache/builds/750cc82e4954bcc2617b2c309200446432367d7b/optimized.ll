...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef align 16 %str) #8
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %str, i8 noundef 0, i64 noundef 10000, i1 noundef false) #9
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef align 16 %b) #8
  br label %while.cond
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %str) #10
  ret i32 0
}
