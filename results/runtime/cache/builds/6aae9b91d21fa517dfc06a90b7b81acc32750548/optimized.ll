...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %.pr5 = phi i32 [ %.pr, %entry ], [ %sub, %while.body ]
...
while.cond1:                                      ; preds = %while.body4, %while.end
  ...
  %.pr6 = phi i32 [ %.pr5, %while.end ], [ %0, %while.body4 ]
  %0 = add i32 %.pr6, -50
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %.pr7 = phi i32 [ %.pr6, %while.end7 ], [ %1, %while.body13 ]
  %1 = add i32 %.pr7, -20
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %.pr8 = phi i32 [ %.pr7, %while.end16 ], [ %2, %while.body22 ]
  %2 = add i32 %.pr8, -10
...
land.end30:                                       ; preds = %while.end25, %while.body31
  ...
  %3 = phi i32 [ %.pr8, %while.end25 ], [ %sub33, %while.body31 ]
