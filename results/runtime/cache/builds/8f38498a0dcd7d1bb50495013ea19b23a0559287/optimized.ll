...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc19 ], [ %idxprom2, %for.end ]
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end47 ], [ %indvars.iv20, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next23 = add nsw i64 %indvars.iv22, -1
  %cmp23 = icmp sgt i64 %indvars.iv22, 0
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next23
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %6, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %cmp30.not = icmp slt i64 %indvars.iv17, %indvars.iv22
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %7 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv17
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv17
...
for.end47:                                        ; preds = %for.cond29
  ...
  %10 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next23
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv25 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next26, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select13, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv25
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select13 = call i32 @llvm.smax.i32(i32 %11, i32 %sum.2)
