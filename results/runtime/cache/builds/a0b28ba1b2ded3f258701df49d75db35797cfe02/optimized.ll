...
if.end:                                           ; preds = %land.lhs.true
  br i1 %cmp6, label %if.then9, label %for.inc

if.then9:                                         ; preds = %land.lhs.true, %if.end
  %a2.2 = phi i32 [ %j.0, %if.end ], [ %a2.1, %land.lhs.true ]
  %a1.2 = phi i32 [ %i.0, %if.end ], [ %a1.1, %land.lhs.true ]
  br label %for.inc

for.inc:                                          ; preds = %for.body4, %if.end, %if.then9
  %a2.3 = phi i32 [ %a2.2, %if.then9 ], [ %j.0, %if.end ], [ %a2.1, %for.body4 ]
  %a1.3 = phi i32 [ %a1.2, %if.then9 ], [ %i.0, %if.end ], [ %a1.1, %for.body4 ]
  %b1.2 = phi i32 [ %i.0, %if.then9 ], [ %b1.1, %if.end ], [ %b1.1, %for.body4 ]
  %b2.2 = phi i32 [ %j.0, %if.then9 ], [ %b2.1, %if.end ], [ %b2.1, %for.body4 ]
