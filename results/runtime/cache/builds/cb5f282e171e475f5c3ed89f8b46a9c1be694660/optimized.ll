...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %b) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %c) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %d) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %e) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %f) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %sum) #3
  br label %for.cond
...
for.cond.for.inc_crit_edge:                       ; preds = %for.cond
  %.pre35 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
  %.pre39 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  br label %for.inc
...
land.lhs.true:                                    ; preds = %for.cond
  ...
  %.pre40 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %3 = phi i32 [ %.pre39, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ %.pre40, %land.lhs.true20 ], [ %.pre40, %land.lhs.true ]
