...
for.cond:                                         ; preds = %if.end11, %entry
  ...
  %f.0 = phi i32 [ %f.1, %if.end11 ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp4.not, label %if.else, label %if.end11.sink.split

if.else:                                          ; preds = %for.body
  %cmp8 = icmp eq i32 %f.0, 1
  br i1 %cmp8, label %if.end11.sink.split, label %if.end11

if.end11.sink.split:                              ; preds = %if.else, %for.body
  %f.1.ph = phi i32 [ 1, %for.body ], [ 0, %if.else ]
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %0)
  br label %if.end11

if.end11:                                         ; preds = %if.end11.sink.split, %if.else
  %f.1 = phi i32 [ %f.0, %if.else ], [ %f.1.ph, %if.end11.sink.split ]
