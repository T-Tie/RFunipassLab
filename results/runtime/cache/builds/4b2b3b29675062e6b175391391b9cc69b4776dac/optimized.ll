...
if.then31:                                        ; preds = %for.body27
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %4, i32 noundef %5) #6
  br label %for.inc36
...
for.cond39:                                       ; preds = %for.inc50, %for.end38
  %.sink11 = phi i32 [ 97, %for.end38 ], [ %inc51, %for.inc50 ]
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %7, i32 noundef %8) #6
  br label %for.inc50
