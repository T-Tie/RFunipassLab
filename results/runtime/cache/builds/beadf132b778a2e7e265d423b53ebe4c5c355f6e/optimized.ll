...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %s) #8
  store i32 0, ptr %s, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull align 16 dereferenceable(25000) %word) #8
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef align 16 %l) #8
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %q) #8
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call24, ptr noundef %arrayidx26)
  br label %if.end
...
if.end35.thread:                                  ; preds = %if.end
  store i32 0, ptr %s, align 4, !tbaa !5
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 10)
  br label %if.then37
...
if.then37:                                        ; preds = %if.end35.thread, %if.end35
  ...
  %call41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arrayidx39)
  br label %for.inc47
...
for.end49:                                        ; preds = %for.cond17
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %q) #9
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %l) #9
  call void @llvm.lifetime.end.p0(i64 noundef 25000, ptr noundef %word) #9
