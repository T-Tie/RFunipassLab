...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv25.in = phi i32 [ %indvars.iv25, %for.end100 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %smax51 = tail call i32 @llvm.smax.i32(i32 %indvars.iv25.in, i32 noundef 0)
  %wide.trip.count36 = zext nneg i32 %smax51 to i64
  %wide.trip.count = zext i32 %indvars.iv25.in to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count36
  br i1 %exitcond37.not, label %for.cond27, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv33
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv33, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc21 ], [ 0, %for.cond14.preheader ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond32.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv33, i64 %indvars.iv28
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv25.in, ptr @k, align 4, !tbaa !5
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  br label %for.cond, !llvm.loop !14

for.cond27:                                       ; preds = %for.cond, %for.inc62
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc62 ], [ 0, %for.cond ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count36
  br i1 %exitcond53.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv48
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select17, %for.body34 ], [ %3, %for.body29 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count
  br i1 %exitcond42.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv48
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !9
  %spec.select17 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.1)
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond32, !llvm.loop !15

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc59 ], [ 0, %for.cond51.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond47.not, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
...
for.end64:                                        ; preds = %for.cond27
  ...
  %smax62 = tail call i32 @llvm.smax.i32(i32 %indvars.iv25, i32 noundef 1)
  %6 = zext i32 %indvars.iv25 to i64
  %cmp65 = icmp eq i32 %indvars.iv25.in, 2
...
for.cond66:                                       ; preds = %for.cond81, %if.end
  %indvars.iv59 = phi i64 [ 1, %if.end ], [ %indvars.iv.next60, %for.cond81 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count63
  br i1 %exitcond64.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next60
  %8 = load i32, ptr %arrayidx71, align 4, !tbaa !5, !invariant.load !9
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv59
  store i32 %8, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next60
  %9 = load i32, ptr %arrayidx76, align 16, !tbaa !5, !invariant.load !9
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv59
  store i32 %9, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %6
  br i1 %exitcond58.not, label %for.cond66, label %for.inc95, !llvm.loop !18

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next60, i64 %indvars.iv.next55
  %10 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !9
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv59, i64 %indvars.iv54
  store i32 %10, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.cond81, !llvm.loop !19

for.end100:                                       ; preds = %for.cond66
  store i32 %smax62, ptr @i, align 4, !tbaa !5
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %2 = phi i32 [ %.pre14, %for.inc ], [ %storemerge3, %for.cond1 ]
  %3 = phi i32 [ %.pre5, %for.inc ], [ %1, %for.cond1 ]
  %storemerge4 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond1 ]
  store i32 %storemerge4, ptr @k, align 4, !tbaa !5
  %cmp5 = icmp slt i32 %storemerge4, %3
...
for.inc:                                          ; preds = %for.cond4
  ...
  %.pre14 = load i32, ptr @j, align 4, !tbaa !5
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  ...
  %cmp20 = icmp slt i32 %storemerge2, %6
