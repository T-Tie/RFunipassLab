...
if.then8:                                         ; preds = %if.end
  ...
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %7) #12
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %8) #12
...
if.then30:                                        ; preds = %if.end28
  ...
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div34) #12
...
if.then39:                                        ; preds = %if.end37
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div43) #12
  ...
  %call50 = call double @sqrt(double noundef %18) #11, !tbaa !5
  %mul51 = fmul double 2.000000e+00, %15
  %div52 = fdiv double %call50, %mul51
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div52) #12
  ...
  %call60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div59) #12
  ...
  %call65 = call double @sqrt(double noundef %24) #11, !tbaa !5
  %fneg66 = fneg double %call65
  %mul67 = fmul double 2.000000e+00, %21
  %div68 = fdiv double %fneg66, %mul67
  %call69 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div68) #12
