...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond21, label %for.body4
...
for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc15 ], [ %indvars.iv9, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv11
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv.next23 = add nsw i64 %indvars.iv22, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next23
