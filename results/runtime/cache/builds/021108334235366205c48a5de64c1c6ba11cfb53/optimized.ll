...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) @s) #8
...
for.cond14.preheader:                             ; preds = %for.cond
  %smax = call i32 @llvm.smax.i32(i32 %pre.0, i32 noundef 0) #9
...
for.inc:                                          ; preds = %for.cond3
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i) #9
  call fastcc void @outlined_ir_func_0(i8 %4, ptr noundef nonnull dereferenceable(1) %__c.addr.i)
...
for.inc21:                                        ; preds = %for.cond14
  ...
  call fastcc void @outlined_ir_func_0(i8 %5, ptr noundef nonnull dereferenceable(1) %__c.addr.i3)
...
define internal fastcc void @outlined_ir_func_0(i8 %0, ptr noundef nonnull dereferenceable(1) %1) unnamed_addr #7 {
for.body6_to_outline:
  ...
  %2 = load i64, ptr %gep, align 8, !tbaa !25
...
attributes #7 = { minsize mustprogress optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!24 = !{}
!25 = !{!26, !27, i64 16}
!26 = !{!"_ZTSSt8ios_base", !27, i64 8, !27, i64 16, !28, i64 24, !29, i64 28, !29, i64 32, !30, i64 40, !31, i64 48, !6, i64 64, !16, i64 192, !32, i64 200, !33, i64 208}
!27 = !{!"long", !6, i64 0}
!28 = !{!"_ZTSSt13_Ios_Fmtflags", !6, i64 0}
!29 = !{!"_ZTSSt12_Ios_Iostate", !6, i64 0}
!30 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !18, i64 0}
!31 = !{!"_ZTSNSt8ios_base6_WordsE", !18, i64 0, !27, i64 8}
