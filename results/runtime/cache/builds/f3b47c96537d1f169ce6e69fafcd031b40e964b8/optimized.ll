...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.end47 ], [ %indvars.iv7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next10 = add nsw i64 %indvars.iv9, -1
  %cmp23 = icmp sgt i64 %indvars.iv9, 0
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next10
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv4 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next5, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %cmp30.not = icmp slt i64 %indvars.iv4, %indvars.iv9
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv4
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv4
  ...
  %spec.select1 = call i32 @llvm.smax.i32(i32 %7, i32 %sum.0)
  br label %for.inc45
...
for.end47:                                        ; preds = %for.cond29
  ...
  %8 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next10
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv12 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next13, %for.body62 ]
...
for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv12
  %9 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select2 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
