...
for.cond13:                                       ; preds = %for.inc38, %for.end9
  ...
  store i32 %sub12.sink, ptr %j, align 4, !tbaa !5
...
for.cond16:                                       ; preds = %for.inc35, %for.body15
  %j.sink = phi ptr [ %j, %for.body15 ], [ %p, %for.inc35 ]
  %1 = load i32, ptr %j.sink, align 4, !tbaa !5
  %add = add nsw i32 %1, 1
...
for.body18:                                       ; preds = %for.cond16
  ...
  %3 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !13
...
for.body42:                                       ; preds = %for.cond40
  ...
  %7 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !13
  %cmp45 = icmp sgt i32 %7, %max.0
...
for.inc50:                                        ; preds = %for.body42, %if.then46
  %max.1 = phi i32 [ %7, %if.then46 ], [ %max.0, %for.body42 ]
