...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc23
  %indvars.iv8 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc23 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %for.inc23 ]
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond26.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv8
  br label %for.cond5

for.cond26.preheader:                             ; preds = %for.cond2
  %sub = add nsw i32 %k.0, -1
  %2 = sext i32 %sub to i64
  %smax18 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax18 to i64
  br label %for.cond26

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc13
  %indvars.iv5 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next6, %for.inc13 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %indvars.iv8
  br i1 %exitcond.not, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
for.end15:                                        ; preds = %for.body7, %for.cond5
  %j.0.lcssa.in = phi i64 [ %indvars.iv5, %for.body7 ], [ %indvars.iv8, %for.cond5 ]
  %5 = and i64 %j.0.lcssa.in, 4294967295
  %cmp16 = icmp eq i64 %5, %indvars.iv8
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc36
  %indvars.iv14 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next15, %for.inc36 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond19.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %b, i64 0, i64 %indvars.iv14
  ...
  %cmp32 = icmp slt i64 %indvars.iv14, %2
