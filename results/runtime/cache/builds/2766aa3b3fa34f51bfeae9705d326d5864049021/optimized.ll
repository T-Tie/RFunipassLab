...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %c)
...
if.then_to_outline:                               ; preds = %newFuncRoot
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
  ...
  br label %if.end20.exitStub

if.end20.exitStub:                                ; preds = %if.then_to_outline
  ret void
}
