...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %a) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr %b) #11
...
for.end27:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %b) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr %a) #11
...
if.then_to_outline:                               ; preds = %newFuncRoot
  ...
  br label %if.end24.exitStub

if.end24.exitStub:                                ; preds = %if.then_to_outline
  ret void
}
