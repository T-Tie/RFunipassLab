...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv66 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next67, %for.inc33 ]
  %indvars.iv35 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next36, %for.inc33 ]
  %smax68 = call i64 @llvm.smax.i64(i64 %indvars.iv66, i64 noundef 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  ...
  %exitcond69 = icmp eq i64 %indvars.iv32, %smax68
  br i1 %exitcond69, label %for.end18, label %for.body10
