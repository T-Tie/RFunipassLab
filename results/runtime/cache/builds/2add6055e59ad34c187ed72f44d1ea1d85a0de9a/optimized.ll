...
for.body35:                                       ; preds = %for.cond33
  ...
  %12 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv17
  %13 = load i32, ptr %12, align 4, !tbaa !5
  %spec.select = select i1 %cmp36, ptr @.str, ptr @.str.1
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %13) #8
