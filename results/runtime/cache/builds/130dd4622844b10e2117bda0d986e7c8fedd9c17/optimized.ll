...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 %num) #6
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef nonnull align 16 %c) #6
...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  br i1 %cmp.not, label %for.cond21.preheader, label %for.cond6.preheader
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  ...
  br i1 %exitcond70.not, label %for.cond29.preheader, label %for.inc26
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc54 ], [ 0, %for.cond29.preheader ]
  %exitcond82.not = icmp eq i64 %indvars.iv71, %wide.trip.count69
  br i1 %exitcond82.not, label %for.cond57.preheader, label %for.cond32.preheader

for.cond57.preheader:                             ; preds = %for.cond29
  br label %for.cond57
...
for.cond57:                                       ; preds = %for.cond57.preheader, %for.body59
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.body59 ], [ 0, %for.cond57.preheader ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond57.preheader ]
...
if.else:                                          ; preds = %for.end69
  ...
  %vtable.i8 = load ptr, ptr %call74, align 8, !tbaa !18
  %vbase.offset.ptr.i9 = getelementptr i8, ptr %vtable.i8, i64 -24
  %vbase.offset.i10 = load i64, ptr %vbase.offset.ptr.i9, align 8, !invariant.load !20
  %add.ptr.i11 = getelementptr inbounds i8, ptr %call74, i64 %vbase.offset.i10
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i11, i8 noundef signext 10)
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call74, i8 noundef signext %call.i)
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  ...
  br i1 %exitcond94.not, label %if.end92.loopexit, label %for.body78
...
if.then82:                                        ; preds = %for.body78
  ...
  %vtable.i14 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !18
  %vbase.offset.ptr.i15 = getelementptr i8, ptr %vtable.i14, i64 -24
  %vbase.offset.i16 = load i64, ptr %vbase.offset.ptr.i15, align 8, !invariant.load !20
...
if.end92.loopexit:                                ; preds = %for.cond76
  br label %if.end92

if.end92:                                         ; preds = %if.end92.loopexit, %if.then71
  call void @llvm.lifetime.end.p0(i64 noundef 600, ptr noundef nonnull %input) #8
  call void @llvm.lifetime.end.p0(i64 noundef 60000, ptr noundef nonnull %c) #8
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %num) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %len) #8
  ret i32 0
}
