...
for.body87:                                       ; preds = %for.cond85
  ...
  %24 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom97
  %25 = getelementptr inbounds [100 x i32], ptr %24, i64 0, i64 %idxprom100
  %26 = load i32, ptr %25, align 4, !tbaa !5
  br i1 %cmp88, label %if.then, label %if.else

if.then:                                          ; preds = %for.body87
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %26)
  br label %for.inc103

if.else:                                          ; preds = %for.body87
  %call102 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %26)
  br label %for.inc103
