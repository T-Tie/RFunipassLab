...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %w) #11
  ...
  %call7 = call i64 @strlen(ptr noundef %b) #12
  %conv8 = trunc i64 %call7 to i32
  %cmp = icmp ne i32 %conv, %conv8
  br i1 %cmp, label %if.end75, label %if.else
...
lor.lhs.false22:                                  ; preds = %lor.lhs.false17
  ...
  br i1 %cmp26, label %land.lhs.true, label %if.end75
...
land.lhs.true:                                    ; preds = %lor.lhs.false22, %lor.lhs.false17, %lor.lhs.false, %for.body
  ...
  %1 = load i8, ptr %arrayidx28, align 1, !tbaa !5, !invariant.load !8
...
lor.lhs.false41:                                  ; preds = %lor.lhs.false36
  ...
  %conv44 = sext i8 %2 to i32
  %cmp45 = icmp eq i32 %conv44, 84
  br i1 %cmp45, label %for.inc, label %if.end75
...
for.body52:                                       ; preds = %for.cond50
  ...
  %3 = load i8, ptr %arrayidx54, align 1, !tbaa !5, !invariant.load !8
  %conv55 = sext i8 %3 to i32
  %arrayidx57 = getelementptr inbounds [1000 x i8], ptr %b, i64 0, i64 %idxprom53
  %4 = load i8, ptr %arrayidx57, align 1, !tbaa !5, !invariant.load !8
  %conv58 = sext i8 %4 to i32
...
for.end65:                                        ; preds = %for.cond50
  ...
  %5 = load double, ptr %w, align 8, !tbaa !13
  %cmp68 = fcmp oge double %div, %5
  br i1 %cmp68, label %if.end75, label %if.else71

if.else71:                                        ; preds = %for.end65
  br label %if.end75

if.end75:                                         ; preds = %for.end65, %lor.lhs.false41, %lor.lhs.false22, %entry, %if.else71
  %.str.3.sink = phi ptr [ @.str.3, %if.else71 ], [ @.str.1, %entry ], [ @.str.1, %lor.lhs.false22 ], [ @.str.1, %lor.lhs.false41 ], [ @.str.2, %for.end65 ]
  %call72 = call i32 (ptr, ...) @printf(ptr noundef %.str.3.sink) #13
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %w) #13
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef captures(none) %b) #13
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef captures(none) %a) #13
  ret i32 0
}
...
declare void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264), i32 noundef) local_unnamed_addr #8 align 2
...
; Function Attrs: mustprogress uwtable
declare noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64)) local_unnamed_addr #8 align 2
