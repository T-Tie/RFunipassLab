...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.cond.loopexit ], [ 2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond.loopexit ], [ 1, %entry ]
  %exitcond62.not = icmp eq i64 %indvars.iv56, 14
  br i1 %exitcond62.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc14 ], [ %indvars.iv56, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv58, 13
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not.not = icmp samesign ult i64 %indvars.iv53, %indvars.iv58
  br i1 %cmp6.not.not, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv53
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv58
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc27 ], [ 1, %for.cond ]
  %exitcond66.not = icmp eq i64 %indvars.iv63, 13
  br i1 %exitcond66.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv63, i64 %indvars.iv63
  store i32 1, ptr %arrayidx26, align 4, !tbaa !8
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  br label %for.cond20, !llvm.loop !15

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond74.not = icmp eq i64 %indvars.iv71, 13
  br i1 %exitcond74.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond70.not = icmp eq i64 %indvars.iv67, %indvars.iv71
  br i1 %exitcond70.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv67, i64 %indvars.iv71
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !8
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv71, i64 %indvars.iv67
...
for.cond51:                                       ; preds = %for.cond30, %for.cond51.loopexit
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.cond51.loopexit ], [ 2, %for.cond30 ]
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.cond51.loopexit ], [ 1, %for.cond30 ]
  %exitcond87.not = icmp eq i64 %indvars.iv80, 14
  br i1 %exitcond87.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc76 ], [ %indvars.iv80, %for.cond51 ]
  %exitcond85.not = icmp eq i64 %indvars.iv82, 13
  br i1 %exitcond85.not, label %for.cond51.loopexit, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc65 ], [ %indvars.iv75, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not.not = icmp samesign ult i64 %indvars.iv77, %indvars.iv82
  br i1 %cmp60.not.not, label %for.inc65, label %for.end67

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv77
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv75, i64 %indvars.iv82
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond91.not = icmp eq i64 %indvars.iv88, 13
  br i1 %exitcond91.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv88, i64 %indvars.iv88
  store i32 1, ptr %arrayidx88, align 4, !tbaa !8
  %indvars.iv.next89 = add nuw nsw i64 %indvars.iv88, 1
  br label %for.cond82, !llvm.loop !21

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond99.not = icmp eq i64 %indvars.iv96, 13
  br i1 %exitcond99.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond95.not = icmp eq i64 %indvars.iv92, %indvars.iv96
  br i1 %exitcond95.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv92, i64 %indvars.iv96
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !8
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv96, i64 %indvars.iv92
...
for.body115:                                      ; preds = %for.cond113
  ...
  %arrayidx123 = getelementptr inbounds [13 x [13 x i32]], ptr %f1.f2, i64 0, i64 %idxprom130, i64 %idxprom132
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %arrayidx123) #8
  %inc142 = add nuw nsw i32 %i.6, 1
  br label %for.cond113, !llvm.loop !24

for.end143:                                       ; preds = %for.cond113
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %mon2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %mon1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %year) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #8
  call void @llvm.lifetime.end.p0(i64 noundef 676, ptr noundef nonnull %f2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 676, ptr noundef nonnull %f1) #8
  ret i32 0
}
...
if.then119_to_outline:
  ...
  %puts1 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.str) #8
  ret void
}
