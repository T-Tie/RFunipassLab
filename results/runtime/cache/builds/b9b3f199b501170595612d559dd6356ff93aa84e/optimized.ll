...
if.then8:                                         ; preds = %if.end
  ...
  call fastcc void @outlined_ir_func_1(ptr %call13.loc)
  ...
  call fastcc void @outlined_ir_func_1(ptr %call19.loc)
...
if.then39:                                        ; preds = %if.end37
  ...
  call fastcc void @outlined_ir_func_0(ptr %call50.loc)
  ...
  call fastcc void @outlined_ir_func_0(ptr %call65.loc)
...
if.end72:                                         ; preds = %if.then39, %if.end37
  br label %for.inc
...
newFuncRoot:
  br label %if.then39_to_outline

if.then39_to_outline:                             ; preds = %newFuncRoot
  ...
  br label %if.then39_after_outline.exitStub

if.then39_after_outline.exitStub:                 ; preds = %if.then39_to_outline
  store double %call50, ptr %0, align 8
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0) unnamed_addr #10 {
newFuncRoot:
  br label %if.then8_to_outline

if.then8_to_outline:                              ; preds = %newFuncRoot
  ...
  br label %if.then8_after_outline.exitStub

if.then8_after_outline.exitStub:                  ; preds = %if.then8_to_outline
