...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr %str) #6
  call void @llvm.memset.p0.i64(ptr align 16 %str, i8 0, i64 10000, i1 false)
  call void @llvm.lifetime.start.p0(i64 400000, ptr %b) #6
  br label %while.cond
...
if.end25:                                         ; preds = %if.else, %if.then24
  %s.0 = phi i32 [ 0, %if.then24 ], [ 1, %if.else ]
...
if.then30:                                        ; preds = %for.end28
  ...
  %call33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %3)
  br label %if.end34
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 400000, ptr %b) #6
  call void @llvm.lifetime.end.p0(i64 10000, ptr %str) #6
  ret i32 0
}
...
!21 = !{!22, !23, i64 16}
!22 = !{!"_ZTSSt8ios_base", !23, i64 8, !23, i64 16, !24, i64 24, !25, i64 28, !25, i64 32, !26, i64 40, !27, i64 48, !6, i64 64, !12, i64 192, !28, i64 200, !29, i64 208}
!23 = !{!"long", !6, i64 0}
!24 = !{!"_ZTSSt13_Ios_Fmtflags", !6, i64 0}
!25 = !{!"_ZTSSt12_Ios_Iostate", !6, i64 0}
!26 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !18, i64 0}
!27 = !{!"_ZTSNSt8ios_base6_WordsE", !18, i64 0, !23, i64 8}
!28 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !18, i64 0}
