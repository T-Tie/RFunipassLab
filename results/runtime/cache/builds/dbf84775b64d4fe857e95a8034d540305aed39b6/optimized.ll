...
for.body45:                                       ; preds = %for.cond43
  ...
  %9 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !12
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %9) #5
  %sub = sub nsw i32 %j.0, 1
  %cmp49 = icmp slt i32 %8, %sub
