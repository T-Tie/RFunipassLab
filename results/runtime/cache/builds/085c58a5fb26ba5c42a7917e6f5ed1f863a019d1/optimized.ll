...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50000, ptr noundef nonnull dereferenceable(50000) %word) #6
...
for.end42:                                        ; preds = %for.cond3
  ...
  %vbase.offset.i13 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !12
  %add.ptr.i14 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i13
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i14, i8 noundef signext 10)
  %call1.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !14, !invariant.load !12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !32, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !38, !invariant.load !12
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !39, !invariant.load !12
