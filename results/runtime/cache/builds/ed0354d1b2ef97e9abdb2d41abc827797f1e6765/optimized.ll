...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv26 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next27, %for.inc24 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc24 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax36 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax36 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body7 ], [ 0, %for.cond5.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv23, %indvars.iv26
  br i1 %exitcond.not, label %if.then17, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv23
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv32 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next33, %for.inc39 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond37.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv32, 0
...
if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv32
