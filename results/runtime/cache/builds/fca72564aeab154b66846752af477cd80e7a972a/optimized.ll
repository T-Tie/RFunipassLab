...
for.cond:                                         ; preds = %for.inc143, %entry
  ...
  br i1 %cmp, label %for.cond1.preheader, label %for.end145

for.cond1.preheader:                              ; preds = %for.cond
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  %1 = phi i32 [ %4, %for.inc10 ], [ %0, %for.cond1.preheader ]
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc10 ], [ 0, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc
  %4 = phi i32 [ %.pre, %for.inc ], [ %1, %for.cond4.preheader ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  ...
  br i1 %exitcond111.not, label %for.inc143, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.cond13
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc60
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc60 ], [ 0, %for.cond16.preheader ]
  %exitcond78.not = icmp eq i64 %indvars.iv73, %wide.trip.count77
  br i1 %exitcond78.not, label %for.cond63.preheader, label %for.body18

for.cond63.preheader:                             ; preds = %for.cond16
  br label %for.cond63
...
for.cond63:                                       ; preds = %for.cond63.preheader, %for.inc110
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc110 ], [ 0, %for.cond63.preheader ]
...
for.cond117:                                      ; preds = %for.inc124, %for.end112
  ...
  br i1 %exitcond100.not, label %for.cond127.preheader, label %for.inc124

for.cond127.preheader:                            ; preds = %for.cond117
...
for.cond127:                                      ; preds = %for.cond127.preheader, %for.inc134
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.inc134 ], [ 0, %for.cond127.preheader ]
