...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %words) #4
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(100) %words, i64 noundef 100)
...
if.then:                                          ; preds = %for.cond
  %switch = icmp eq i32 %j.0, 1
  br i1 %switch, label %for.inc, label %if.end16

if.end16:                                         ; preds = %if.then, %for.cond
  %j.4 = phi i32 [ 0, %for.cond ], [ 1, %if.then ]
...
for.inc:                                          ; preds = %if.then, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %j.2 = phi i32 [ %j.4, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 1, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !21

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull captures(none) %words) #5
  ret i32 0
}
