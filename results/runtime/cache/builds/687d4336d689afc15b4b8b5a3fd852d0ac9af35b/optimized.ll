...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1584, ptr noundef %m) #5
...
if.else63:                                        ; preds = %for.body51
  ...
  %12 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
...
if.else72:                                        ; preds = %if.else63
  ...
  %15 = load double, ptr %14, align 8, !tbaa !9, !invariant.load !11
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %15, double noundef %fneg81, double noundef %15)
  br label %for.inc110
...
if.else93:                                        ; preds = %if.else72
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %10, double noundef %15, double noundef %10, double noundef %15)
  br label %for.inc110
