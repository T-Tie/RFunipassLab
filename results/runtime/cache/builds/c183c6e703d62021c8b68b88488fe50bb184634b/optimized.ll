...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv29, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv25 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next26, %for.inc25 ]
...
for.end27:                                        ; preds = %for.cond14
  call void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(10000) %a)
...
for.body17_after_outline.exitStub:
