...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %a) #7
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  br label %while.cond

while.cond:                                       ; preds = %while.cond12, %entry
  %k.0 = phi i32 [ 0, %entry ], [ %inc74, %while.cond12 ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %cmp = icmp slt i32 %k.0, %0
  br i1 %cmp, label %for.cond, label %while.end75

for.cond:                                         ; preds = %while.cond, %for.inc9
  %1 = phi i32 [ %3, %for.inc9 ], [ %0, %while.cond ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc9 ], [ 0, %while.cond ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv7, %2
  br i1 %cmp1, label %for.cond2, label %while.cond12
...
for.cond2:                                        ; preds = %for.cond, %for.inc
  ...
  br i1 %cmp3, label %for.inc, label %for.inc9

for.inc:                                          ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv7, i64 %indvars.iv
...
define dso_local noundef i32 @_Z6changePA100_ii(ptr nofree readnone captures(none) %a, i32 %n) local_unnamed_addr #3 {
entry:
  unreachable
}
