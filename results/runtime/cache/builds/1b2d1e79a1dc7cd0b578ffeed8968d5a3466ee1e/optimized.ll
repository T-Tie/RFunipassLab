...
for.cond:                                         ; preds = %for.inc31, %entry
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc31 ], [ 0, %entry ]
  %jn.0 = phi i32 [ %jn.1, %for.inc31 ], [ 0, %entry ]
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv19, %6
  br i1 %cmp, label %for.body, label %for.cond33.preheader

for.cond33.preheader:                             ; preds = %for.cond
  %smax = call i32 @llvm.smax.i32(i32 %jn.0, i32 1)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond33

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv19
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv22 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next23, %for.inc40 ]
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv22
