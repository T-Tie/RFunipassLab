...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv103.in = phi i64 [ %indvars.iv103, %for.end114 ], [ %2, %entry ]
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %indvars.iv103 = add i64 %indvars.iv103.in, -1
  %smax = tail call i64 @llvm.smax.i64(i64 %indvars.iv103, i64 noundef 1)
  %3 = trunc nuw i64 %indvars.iv96 to i32
  %smax93 = tail call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv103.in, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv103.in to i32
  %smax77 = tail call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count56 = zext nneg i32 %smax77 to i64
  %wide.trip.count = and i64 %indvars.iv103.in, 4294967295
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  ...
  br i1 %exitcond57.not, label %for.cond31, label %for.cond2
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc25 ], [ 0, %for.cond14.preheader ]
...
for.cond31:                                       ; preds = %for.cond, %for.inc66
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc66 ], [ 0, %for.cond ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc63 ], [ 0, %for.cond51.preheader ]
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  ...
  %exitcond.not105 = icmp eq i64 %indvars.iv80, %smax
  br i1 %exitcond.not105, label %for.cond92.preheader, label %for.cond75
