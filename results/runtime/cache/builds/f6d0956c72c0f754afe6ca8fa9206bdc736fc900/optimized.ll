...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv9, %2
...
define dso_local noundef i32 @_Z6hanshui(i32 noundef %n) #3 {
entry:
  %0 = add i32 %n, 1
  br label %tailrecurse

tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv37 = phi i32 [ %indvars.iv.next38, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax84 = call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax73 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %1 = add nuw i32 %smax73, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv44 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next45, %for.inc23 ]
  %exitcond48 = icmp eq i64 %indvars.iv44, %wide.trip.count47
  br i1 %exitcond48, label %for.cond26.preheader, label %for.cond2
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv39 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next40, %for.inc20 ]
  %exitcond43 = icmp eq i64 %indvars.iv39, %wide.trip.count
  br i1 %exitcond43, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv39
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv59 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next60, %for.inc57 ]
  %exitcond64 = icmp eq i64 %indvars.iv59, %wide.trip.count47
  br i1 %exitcond64, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select35, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond53 = icmp eq i64 %indvars.iv49, %wide.trip.count
  br i1 %exitcond53, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv49, i64 %indvars.iv59
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv54 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next55, %for.inc54 ]
  %exitcond58 = icmp eq i64 %indvars.iv54, %wide.trip.count
  br i1 %exitcond58, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv54, i64 %indvars.iv59
...
for.end59:                                        ; preds = %for.cond26
  ...
  %wide.trip.count68 = zext i32 %n.tr to i64
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond75 = icmp eq i64 %indvars.iv70, %wide.trip.count47
  br i1 %exitcond75, label %for.cond80.preheader, label %for.cond63
...
for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc74 ], [ 2, %for.cond60 ]
  %exitcond69.not = icmp eq i64 %indvars.iv65, %wide.trip.count68
  br i1 %exitcond69.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv70, i64 %indvars.iv.next66
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !15
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv70, i64 %indvars.iv65
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv81 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next82, %for.inc98 ]
  %exitcond86.not = icmp eq i64 %indvars.iv81, %wide.trip.count85
  br i1 %exitcond86.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc95 ], [ 2, %for.cond80 ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %wide.trip.count68
  br i1 %exitcond80.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next77, i64 %indvars.iv81
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !15
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv76, i64 %indvars.iv81
