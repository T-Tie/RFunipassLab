...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv20 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next21, %for.inc11 ]
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv28.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv28, %for.cond17 ]
  %indvars.iv28 = add i32 %indvars.iv28.in, -1
  %cmp15 = icmp sgt i32 %indvars.iv28.in, 0
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv24 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next25, %for.inc37 ]
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc50 ], [ %6, %for.end41 ]
