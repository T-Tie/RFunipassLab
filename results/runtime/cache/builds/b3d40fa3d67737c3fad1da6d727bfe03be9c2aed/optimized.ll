...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  %call.i = call noundef float @sqrtf(float noundef nofpclass(nan inf nzero sub) %conv) #7, !tbaa !5
...
if.then:                                          ; preds = %for.body6
  ...
  %div = sdiv i32 %2, %j.0
  call void @_Z1fii(i32 noundef %div, i32 noundef %j.0) #7
...
if.then3:                                         ; preds = %while.body
  ...
  tail call void @_Z1fii(i32 noundef %div, i32 noundef %y.addr.0) #8
  br label %if.end4
