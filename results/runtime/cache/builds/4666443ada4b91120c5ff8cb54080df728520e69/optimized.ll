...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %1) unnamed_addr #6 {
for.body19_to_outline:
  ...
  %2 = load i64, ptr %gep106, align 8, !tbaa !28
