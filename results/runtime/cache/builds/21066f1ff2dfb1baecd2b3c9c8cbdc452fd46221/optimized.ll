...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %w) #9
...
if.else:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %k) #11
...
for.end65:                                        ; preds = %for.cond50
  ...
  %conv66 = sitofp i32 %8 to double
  %conv67 = sitofp i32 %conv to double
  %div = fdiv double %conv66, %conv67
  %9 = load double, ptr %w, align 8, !tbaa !14
  %cmp68 = fcmp oge double %div, %9
...
if.end75:                                         ; preds = %if.end74, %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %count) #11
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %w) #11
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef captures(none) %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef captures(none) %a) #11
  ret i32 0
}
