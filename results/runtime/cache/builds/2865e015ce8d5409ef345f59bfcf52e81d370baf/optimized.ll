...
while.cond1:                                      ; preds = %while.body4, %while.end
  ...
  %or.cond21 = and i1 %cmp2, %cmp3
  br i1 %or.cond21, label %while.body4, label %while.end7
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %or.cond20 = and i1 %cmp9, %cmp11
  br i1 %or.cond20, label %while.body13, label %while.end16
...
while.cond35:                                     ; preds = %land.end30
  %.lcssa24 = phi i32 [ %4, %land.end30 ]
  %e.0.lcssa22 = phi i32 [ %e.0, %land.end30 ]
  %cmp36 = icmp sgt i32 %.lcssa24, 0
...
while.end41:                                      ; preds = %while.end41.loopexit, %while.cond35, %land.end39.thread
  %e.023 = phi i32 [ %e.0.lcssa22, %land.end39.thread ], [ %e.0.lcssa22, %while.cond35 ], [ %e.0.lcssa, %while.end41.loopexit ]
  %f.0 = phi i32 [ 0, %land.end39.thread ], [ %.lcssa24, %while.cond35 ], [ 0, %while.end41.loopexit ]
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %a.0.lcssa, i32 noundef %b.0.lcssa, i32 noundef %c.0.lcssa, i32 noundef %d.0.lcssa, i32 noundef %e.023, i32 noundef %f.0) #5
