...
for.cond:                                         ; preds = %for.inc17, %entry
  %0 = phi i32 [ %inc18, %for.inc17 ], [ 1, %entry ]
...
for.cond2:                                        ; preds = %for.inc14, %for.body
  ...
  %1 = load i32, ptr %i.sink1, align 4, !tbaa !5
  %add = add nsw i32 %1, 1
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %7 = phi i32 [ %inc80, %for.inc79 ], [ 1, %for.end50 ]
  %cmp52 = icmp sle i32 %7, 12
...
for.cond55:                                       ; preds = %for.inc76, %for.body53
  ...
  %8 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add54 = add nsw i32 %8, 1
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  ...
  %k.1 = phi i32 [ %7, %for.body57 ], [ %inc66, %for.inc65 ]
  %cmp60 = icmp sle i32 %k.1, %8
...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %10 = phi i32 [ %inc90, %for.inc89 ], [ 1, %for.end81 ]
  %cmp83 = icmp sle i32 %10, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %idxprom85 = sext i32 %10 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %11 = phi i32 [ %inc111, %for.inc110 ], [ 1, %for.end91 ]
  %cmp93 = icmp sle i32 %11, 12
...
for.body115:                                      ; preds = %for.cond113
  ...
  %16 = load i32, ptr %year, align 4, !tbaa !5
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %16) #7
...
if.else129:                                       ; preds = %for.body115
  %20 = load i32, ptr %mon1, align 4, !tbaa !5
  %idxprom130 = sext i32 %20 to i64
  %arrayidx131 = getelementptr inbounds [13 x [13 x i32]], ptr %f1, i64 0, i64 %idxprom130
  %21 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom132 = sext i32 %21 to i64
  %arrayidx133 = getelementptr inbounds [13 x i32], ptr %arrayidx131, i64 0, i64 %idxprom132
  %22 = load i32, ptr %arrayidx133, align 4, !tbaa !5
  %cmp134 = icmp eq i32 %22, 1
