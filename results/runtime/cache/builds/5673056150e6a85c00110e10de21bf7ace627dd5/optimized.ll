...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  ...
  br i1 %exitcond59.not, label %for.cond49.preheader, label %for.cond35.preheader
...
for.cond49.preheader:                             ; preds = %for.cond31
  ...
  %smax63 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
  %wide.trip.count64 = zext nneg i32 %smax63 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc43
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc43 ], [ 0, %for.cond35.preheader ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  ...
  br i1 %exitcond76.not, label %for.cond82.preheader, label %for.cond53.preheader

for.cond53.preheader:                             ; preds = %for.cond49
  br label %for.cond53

for.cond82.preheader:                             ; preds = %for.cond49
  br label %for.cond82

for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc76
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc76 ], [ 0, %for.cond53.preheader ]
...
for.cond82:                                       ; preds = %for.cond82.preheader, %for.inc106
  %18 = phi i32 [ %22, %for.inc106 ], [ %10, %for.cond82.preheader ]
  %19 = phi i32 [ %.pre, %for.inc106 ], [ %9, %for.cond82.preheader ]
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc106 ], [ 1, %for.cond82.preheader ]
