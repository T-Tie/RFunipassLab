...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv29
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv19 = phi i64 [ %1, %for.cond10.preheader ], [ %indvars.iv.next20, %for.cond13 ]
  %indvars.iv13 = phi i64 [ %2, %for.cond10.preheader ], [ %indvars.iv.next14, %for.cond13 ]
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, -1
  %indvars.iv.next14 = add nsw i64 %indvars.iv13, -1
  %cmp11 = icmp sgt i64 %indvars.iv19, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next20
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next20
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv15 = phi i64 [ %indvars.iv13, %for.cond13.preheader ], [ %indvars.iv.next16, %for.inc31 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx19 = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv15
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv15
