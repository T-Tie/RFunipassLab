...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull dereferenceable(41000) %word) #13
...
for.cond2:                                        ; preds = %for.inc74, %for.end
  %k.0 = phi i32 [ 0, %for.end ], [ %k.1, %for.inc74 ]
  %j.0 = phi i32 [ 0, %for.end ], [ %j.1, %for.inc74 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %inc75, %for.inc74 ]
...
if.end:                                           ; preds = %if.else58, %if.then44
  ...
  %arrayidx68 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom67
  %idxprom69 = sext i32 %add to i64
  %arrayidx70 = getelementptr inbounds [81 x i8], ptr %arrayidx68, i64 0, i64 %idxprom69
  store i8 32, ptr %arrayidx70, align 1, !tbaa !12
  %inc71 = add nsw i32 %add, 1
  br label %for.inc74

for.inc74:                                        ; preds = %if.then, %if.end, %if.then33
  %k.1 = phi i32 [ %inc18, %if.then ], [ %inc41, %if.then33 ], [ %k.0, %if.end ]
  %j.1 = phi i32 [ %inc30, %if.then ], [ 0, %if.then33 ], [ %inc71, %if.end ]
...
for.cond86:                                       ; preds = %for.inc116, %for.end76
  %i.2 = phi i32 [ 0, %for.end76 ], [ %inc117, %for.inc116 ]
...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  %j.3 = phi i32 [ 0, %for.body88 ], [ %inc114, %for.inc113 ]
  %cmp95 = icmp slt i32 %j.3, %conv93
  br i1 %cmp95, label %for.body96, label %for.inc116

for.body96:                                       ; preds = %for.cond94
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %j.3, %sub97
  %idxprom109 = sext i32 %j.3 to i64
  %2 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom109
  %3 = load i8, ptr %2, align 1, !tbaa !12, !invariant.load !14
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %arrayidx103 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom109
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !17, !invariant.load !14
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !17, !invariant.load !14
  ...
  %call16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10) #16
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %call24 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10) #16
...
declare noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8), ptr noundef) #7 align 2
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !19, !invariant.load !14
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264)) #9 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264)) #9 align 2
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !5, !invariant.load !14
  %1 = load i32, ptr %__c2, align 4, !tbaa !5, !invariant.load !14
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264)) #9 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64)) #9 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64)) #9 align 2
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !12, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !30, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !12, !invariant.load !14
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !17, !invariant.load !14
...
!33 = !{!"p1 _ZTS15__locale_struct", !25, i64 0}
!34 = !{!"bool", !7, i64 0}
!35 = !{!"p1 int", !25, i64 0}
