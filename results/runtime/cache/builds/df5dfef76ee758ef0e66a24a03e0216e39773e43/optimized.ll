...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond20.not, label %for.end33, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv11 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next12, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv15, i64 %indvars.iv11
...
for.body40:                                       ; preds = %for.cond38
  ...
  %10 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !13
...
for.end50:                                        ; preds = %for.body40, %for.cond38
  ...
  %11 = load i32, ptr %arrayidx54, align 4, !tbaa !5, !invariant.load !13
