...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec30 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
  %k.0 = phi i32 [ 1, %entry ], [ %k.1, %for.cond1 ]
  %dec = add nsw i32 %dec30, -1
  %tobool.not = icmp eq i32 %dec30, 0
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv32
...
if.then:                                          ; preds = %for.body3
  %div28 = udiv i32 %3, 10
  %arrayidx10 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next33
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %add11 = add nsw i32 %4, %div28
  store i32 %add11, ptr %arrayidx10, align 4, !tbaa !5
  %rem29 = urem i32 %3, 10
  store i32 %rem29, ptr %arrayidx5, align 4, !tbaa !5
  %sub = add nsw i32 %k.1, -1
  %5 = zext i32 %sub to i64
  %cmp14 = icmp eq i64 %indvars.iv32, %5
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv36 = phi i64 [ %0, %for.cond22.preheader ], [ %7, %for.inc28 ]
...
for.inc28:                                        ; preds = %for.cond22
  ...
  %call27 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8) #6
