...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv33, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  ...
  %exitcond62.not = icmp eq i64 %indvars.iv36, %wide.trip.count61
  br i1 %exitcond62.not, label %for.inc136, label %for.cond20

for.cond20:                                       ; preds = %for.cond15, %for.inc66
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc66 ], [ 0, %for.cond15 ]
...
if.end:                                           ; preds = %for.body23
  %arrayidx27 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44
  %8 = load i32, ptr %arrayidx27, align 16, !tbaa !5
  br label %for.cond30

for.cond30:                                       ; preds = %for.body33, %if.end
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body33 ], [ %indvars.iv36, %if.end ]
  %minValue.0 = phi i32 [ %spec.select, %for.body33 ], [ %8, %if.end ]
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %9 = trunc nuw i64 %indvars.iv.next39 to i32
  %cmp31 = icmp sgt i32 %1, %9
  br i1 %cmp31, label %for.body33, label %for.end47

for.body33:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv.next39
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc63 ], [ %indvars.iv36, %for.end47 ]
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %11 = trunc nuw i64 %indvars.iv.next42 to i32
  %cmp55 = icmp sgt i32 %1, %11
  br i1 %cmp55, label %for.inc63, label %for.inc66

for.inc63:                                        ; preds = %for.cond54
  %arrayidx61 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv.next42
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc121 ], [ 0, %for.cond20 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count
  br i1 %exitcond58.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw i64 %indvars.iv54, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond30 = icmp samesign ult i64 %14, %indvars.iv36
  br i1 %or.cond30, label %for.inc121, label %if.end78

if.end78:                                         ; preds = %for.body73
  %arrayidx82 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv54
  %15 = load i32, ptr %arrayidx82, align 4, !tbaa !5
  br label %for.cond85

for.cond85:                                       ; preds = %for.body88, %if.end78
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body88 ], [ %indvars.iv36, %if.end78 ]
  %minValue79.0 = phi i32 [ %spec.select31, %for.body88 ], [ %15, %if.end78 ]
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %16 = trunc nuw i64 %indvars.iv.next49 to i32
  %cmp86 = icmp sgt i32 %1, %16
  br i1 %cmp86, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next49, i64 %indvars.iv54
  %17 = load i32, ptr %arrayidx92, align 4, !tbaa !5
  %spec.select31 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc118 ], [ %indvars.iv36, %for.end102 ]
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %18 = trunc nuw i64 %indvars.iv.next52 to i32
  %cmp110 = icmp sgt i32 %1, %18
  br i1 %cmp110, label %for.inc118, label %for.inc121

for.inc118:                                       ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next52, i64 %indvars.iv54
...
for.inc136:                                       ; preds = %for.cond15
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call134, i8 noundef signext %call.i22)
