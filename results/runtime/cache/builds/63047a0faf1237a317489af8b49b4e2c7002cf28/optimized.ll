...
for.inc:                                          ; preds = %for.body
  ...
  %.neg = sub i32 0, %5
  %reass.add = add i32 %add, %neg
  %reass.mul = mul i32 %reass.add, 3600
  %reass.add2 = add i32 %neg1, %2
  %reass.mul3 = mul i32 %reass.add2, 60
  %sub = add i32 %.neg, %3
  %sub28 = add i32 %sub, %reass.mul
  %sub31 = add i32 %sub28, %reass.mul3
