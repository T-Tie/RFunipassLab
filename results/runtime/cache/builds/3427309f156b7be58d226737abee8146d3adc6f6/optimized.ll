...
entry:
  ...
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef align 4 %x)
  ...
  %rem4 = srem i32 %rem2, 20
  %div5 = sdiv i32 %rem4, 10
  %rem6 = srem i32 %rem4, 10
  %div7 = sdiv i32 %rem6, 5
  %rem8 = srem i32 %rem6, 5
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div, i32 noundef %div1, i32 noundef %div3, i32 noundef %div5, i32 noundef %div7, i32 noundef %rem8) #5
  %call10 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %a)
