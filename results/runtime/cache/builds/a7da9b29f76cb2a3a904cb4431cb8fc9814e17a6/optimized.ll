...
tailrecurse:                                      ; preds = %if.else, %entry
  ...
  %smax49 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc24 ], [ 0, %for.cond16.preheader ]
...
for.cond31:                                       ; preds = %for.cond, %for.inc70
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc70 ], [ 0, %for.cond ]
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc67 ], [ 0, %for.cond58.preheader ]
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !25, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !43, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !49, !invariant.load !15
  br label %return
