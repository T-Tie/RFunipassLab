...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %a) #6
  ...
  %smax55 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %if.end72, %entry
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %if.end72 ], [ 1, %entry ]
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %smax58 = call i32 @llvm.abs.i32(i32 %10, i1 false)
  %11 = add nuw i32 %smax58, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %if.end54
  %j.1 = phi i32 [ %inc.i8, %if.end54 ], [ 1, %for.cond43.preheader ]
...
for.cond58.preheader:                             ; preds = %for.cond43
  ...
  %smax65 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
...
for.inc.i5:                                       ; preds = %for.cond.i2
  ...
  %14 = load i8, ptr %gep.i6, align 1, !tbaa !5, !invariant.load !8
...
if.end54:                                         ; preds = %_Z5rightPcii.exit, %if.end50
  %inc.i8 = add nuw i32 %j.1, 1
  br label %for.cond43

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body60
  %indvars.iv60 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next61, %for.body60 ]
  %exitcond67 = icmp eq i64 %indvars.iv60, %wide.trip.count66
  br i1 %exitcond67, label %for.end75, label %for.body60
