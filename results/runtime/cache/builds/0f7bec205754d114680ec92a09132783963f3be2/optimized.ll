...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %num) #6
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc12
  %indvars.iv12 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next13, %for.inc12 ]
  %ans.0 = phi i32 [ 0, %for.cond.preheader ], [ %ans.1, %for.inc12 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count15
  br i1 %exitcond16.not, label %for.end14, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [16 x i32], ptr %num, i64 0, i64 %indvars.iv12
  br label %for.cond4
...
for.body7:                                        ; preds = %for.cond4
  ...
  %spec.select = add nsw i32 %add, %ans.1
...
do.cond:                                          ; preds = %if.else, %for.end14
  ...
  br i1 %cmp22.not, label %do.end, label %do.body, !llvm.loop !13

do.end:                                           ; preds = %do.body, %do.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #6
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %num) #6
  ret i32 0
}
