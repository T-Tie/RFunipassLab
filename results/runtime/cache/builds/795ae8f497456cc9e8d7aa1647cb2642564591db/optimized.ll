...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax43 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc40
  %indvars.iv39 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next40, %for.inc40 ]
  %indvars.iv31 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next32, %for.inc40 ]
...
for.cond19:                                       ; preds = %for.body21, %for.body17
  ...
  %5 = getelementptr inbounds [500 x i32], ptr %b, i64 0, i64 %idxprom34
  %6 = load i32, ptr %5, align 4, !tbaa !5
  br i1 %exitcond38.not, label %for.inc40, label %for.body21
...
for.body21:                                       ; preds = %for.cond19
  ...
  %spec.select = select i1 %cmp26, i32 %8, i32 %m.0
...
for.cond43:                                       ; preds = %for.cond15, %for.inc53
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc53 ], [ 0, %for.cond15 ]
...
for.body45:                                       ; preds = %for.cond43
  ...
  br i1 %cmp46.not, label %for.inc53, label %if.then47
...
for.inc53:                                        ; preds = %for.body45, %if.then47
