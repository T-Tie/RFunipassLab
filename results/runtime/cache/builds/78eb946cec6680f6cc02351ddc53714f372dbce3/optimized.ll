...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %0 = phi i32 [ %.pre, %entry ], [ %5, %for.cond.loopexit ]
  %indvars.iv26 = phi i64 [ 0, %entry ], [ %indvars.iv.next27, %for.cond.loopexit ]
  %star1.0 = phi i32 [ undef, %entry ], [ %star1.1, %for.cond.loopexit ]
  %star2.0 = phi i32 [ undef, %entry ], [ %star2.1, %for.cond.loopexit ]
  %end1.0 = phi i32 [ undef, %entry ], [ %end1.1, %for.cond.loopexit ]
  %end2.0 = phi i32 [ undef, %entry ], [ %end2.1, %for.cond.loopexit ]
  %f.0 = phi i32 [ -1, %entry ], [ %f.1, %for.cond.loopexit ]
  %1 = sext i32 %0 to i64
