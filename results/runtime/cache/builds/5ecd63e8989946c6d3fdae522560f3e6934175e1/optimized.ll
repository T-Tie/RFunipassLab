...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv44, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv44, %3
...
for.cond12:                                       ; preds = %for.inc26, %for.end9
  ...
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc26 ], [ 0, %for.end9 ]
  %18 = sext i32 %17 to i64
  %cmp13 = icmp slt i64 %indvars.iv50, %18
  br i1 %cmp13, label %for.cond15.preheader, label %for.end28

for.cond15.preheader:                             ; preds = %for.cond12
  %19 = mul nuw nsw i64 %indvars.iv50, %14
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %vla11, i64 %19
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre86, %for.inc23 ]
  %indvars.iv47 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next48, %for.inc23 ]
  %21 = sext i32 %20 to i64
  %cmp16 = icmp slt i64 %indvars.iv47, %21
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %arrayidx19, i64 %indvars.iv47
  %call22 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %arrayidx21)
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %.pre86 = load i32, ptr %y2, align 4, !tbaa !5
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv53
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv74 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next75, %for.inc77 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %wide.trip.count60
  br i1 %exitcond78.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %27 = mul nuw nsw i64 %indvars.iv74, %24
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %27
  %28 = mul nuw nsw i64 %indvars.iv74, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %28
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv69 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next70, %for.inc74 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %wide.trip.count
  br i1 %exitcond73.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv69
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv69
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv62 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next63, %for.inc71 ]
  %exitcond68.not = icmp eq i64 %indvars.iv62, %wide.trip.count67
  br i1 %exitcond68.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %29 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !17
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv62
  %30 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !17
  %31 = mul nuw nsw i64 %indvars.iv62, %14
...
for.cond80:                                       ; preds = %for.cond46, %for.inc99
  %33 = phi i32 [ %.pre85, %for.inc99 ], [ %22, %for.cond46 ]
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc99 ], [ 0, %for.cond46 ]
  %34 = sext i32 %33 to i64
  %cmp81 = icmp slt i64 %indvars.iv82, %34
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %35 = mul nuw nsw i64 %indvars.iv82, %24
...
for.cond87:                                       ; preds = %for.inc95, %for.body82
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc95 ], [ 1, %for.body82 ]
  %37 = load i32, ptr %y2, align 4, !tbaa !5
  %38 = sext i32 %37 to i64
  %cmp88 = icmp slt i64 %indvars.iv79, %38
  br i1 %cmp88, label %for.inc95, label %for.inc99

for.inc95:                                        ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx84, i64 %indvars.iv79
...
for.inc99:                                        ; preds = %for.cond87
  ...
  %.pre85 = load i32, ptr %x1, align 4, !tbaa !5
