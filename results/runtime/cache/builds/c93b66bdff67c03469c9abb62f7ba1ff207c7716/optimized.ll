...
for.body:                                         ; preds = %for.cond
  ...
  %smax7 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
...
for.cond14:                                       ; preds = %for.body, %for.inc
  ...
  %exitcond8.not = icmp eq i32 %m.0, %smax7
  br i1 %exitcond8.not, label %for.inc53, label %for.body16
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax7
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %spec.select6 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call49 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %spec.select6)
