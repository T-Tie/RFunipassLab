...
if.end:                                           ; preds = %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true16, %land.lhs.true, %while.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr %d, i64 0, i64 %indvars.iv28
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %add = add nsw i32 %6, 12
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv28
  %7 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %sub38 = sub i32 %add, %7
  %mul = mul nsw i32 %sub38, 3600
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %e, i64 0, i64 %indvars.iv28
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx42 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv28
  %9 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %sub43 = sub nsw i32 %8, %9
  %mul44 = mul nsw i32 %sub43, 60
  %arrayidx47 = getelementptr inbounds nuw [1000 x i32], ptr %f, i64 0, i64 %indvars.iv28
  %10 = load i32, ptr %arrayidx47, align 4, !tbaa !5
  %arrayidx49 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv28
