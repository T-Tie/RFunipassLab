...
for.cond2:                                        ; preds = %for.cond, %for.inc55
  %.pre20 = phi i32 [ %.pre, %for.inc55 ], [ %0, %for.cond ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc55 ], [ 0, %for.cond ]
  %csum.0 = phi i64 [ %csum.1, %for.inc55 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.2, %for.inc55 ], [ 0, %for.cond ]
  %2 = sext i32 %.pre20 to i64
  %cmp3 = icmp slt i64 %indvars.iv13, %2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv13
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc25
  %indvars.iv10 = phi i64 [ %4, %for.cond17.preheader ], [ %indvars.iv.next11, %for.inc25 ]
  %_ZSt4cout.sink2 = phi ptr [ @_ZSt4cout, %for.cond17.preheader ], [ %call20, %for.inc25 ]
  %arrayidx13 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv10
  ...
  %cmp18.not.not = icmp slt i64 %indvars.iv10, %indvars.iv13
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc44
  %indvars.iv7 = phi i64 [ %5, %for.cond36.preheader ], [ %indvars.iv.next8, %for.inc44 ]
  %_ZSt4cout.sink1 = phi ptr [ @_ZSt4cout, %for.cond36.preheader ], [ %call39, %for.inc44 ]
  %arrayidx32 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv7
  ...
  %cmp37 = icmp slt i64 %indvars.iv.next8, %indvars.iv13
...
for.inc55.gvnsink.split:                          ; preds = %for.cond17, %for.end46
  ...
  %j.5.in = phi i64 [ %indvars.iv.next8, %for.end46 ], [ %indvars.iv.next11, %for.cond17 ]
  %j.5 = trunc i64 %j.5.in to i32
...
for.inc55:                                        ; preds = %for.inc55.gvnsink.split, %if.end
  %.pre = phi i32 [ %.pre.pre, %for.inc55.gvnsink.split ], [ %.pre20, %if.end ]
...
for.cond63:                                       ; preds = %for.cond63.preheader, %for.inc71
  %indvars.iv17 = phi i64 [ %3, %for.cond63.preheader ], [ %indvars.iv.next18, %for.inc71 ]
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %for.cond63.preheader ], [ %call66, %for.inc71 ]
  %arrayidx59 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv17
  ...
  %7 = sext i32 %6 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next18, %7
