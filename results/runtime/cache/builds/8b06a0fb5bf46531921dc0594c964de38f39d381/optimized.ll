...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %s_all) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %s_good) #4
  ...
  %call.i2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 4 dereferenceable(4) %s_good)
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %all) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %good) #4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %all)
  %call.i4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i3, ptr noundef nonnull align 4 dereferenceable(4) %good)
...
if.then:                                          ; preds = %for.body
  ...
  %vtable.i25 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !11
...
if.then15:                                        ; preds = %if.else
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 6)
...
if.else18:                                        ; preds = %if.else
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 4)
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i12)
  store i8 10, ptr %__c.addr.i12, align 1, !tbaa !13
  ...
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i15
  %6 = load i64, ptr %gep, align 8, !tbaa !14
  %cmp.not.i18 = icmp eq i64 %6, 0
  br i1 %cmp.not.i18, label %if.end.i22, label %if.then.i19

if.then.i19:                                      ; preds = %if.else18
...
if.end.i22:                                       ; preds = %if.else18
  %call2.i23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 10)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit24
...
for.inc:                                          ; preds = %if.then, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit24, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !25

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %good) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %all) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %s_good) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %s_all) #4
