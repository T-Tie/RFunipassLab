...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %s) #10
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %q) #10
...
for.body4:                                        ; preds = %for.cond2
  ...
  store ptr %arrayidx8, ptr %q, align 8, !tbaa !12
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  store ptr %incdec.ptr, ptr %q, align 8, !tbaa !12
...
for.inc47:                                        ; preds = %if.end35, %if.then37
  %phiofops = phi i32 [ %add31, %if.end35 ], [ %10, %if.then37 ]
  %add46 = add nsw i32 %phiofops, 1
  store i32 %add46, ptr %s, align 4, !tbaa !5
...
for.end49:                                        ; preds = %for.cond17
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %q) #11
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %s) #11
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !20
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !20
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !20
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !20
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !20
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !20
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !20
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !16
...
entry:
  ...
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !16
  %add.ptr = getelementptr inbounds i8, ptr %__out, i64 %vbase.offset
  %call = call noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr) #11
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !32
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !40
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !41
  ret ptr %0
}
...
!22 = !{!23, !24, i64 16}
!23 = !{!"_ZTSSt8ios_base", !24, i64 8, !24, i64 16, !25, i64 24, !26, i64 28, !26, i64 32, !27, i64 40, !28, i64 48, !7, i64 64, !6, i64 192, !29, i64 200, !30, i64 208}
!24 = !{!"long", !7, i64 0}
!25 = !{!"_ZTSSt13_Ios_Fmtflags", !7, i64 0}
!26 = !{!"_ZTSSt12_Ios_Iostate", !7, i64 0}
!27 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !14, i64 0}
!28 = !{!"_ZTSNSt8ios_base6_WordsE", !14, i64 0, !24, i64 8}
!29 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !14, i64 0}
!30 = !{!"_ZTSSt6locale", !31, i64 0}
!31 = !{!"p1 _ZTSNSt6locale5_ImplE", !14, i64 0}
!32 = !{!33, !36, i64 232}
!33 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !23, i64 0, !34, i64 216, !7, i64 224, !35, i64 225, !36, i64 232, !37, i64 240, !38, i64 248, !39, i64 256}
!34 = !{!"p1 _ZTSSo", !14, i64 0}
!35 = !{!"bool", !7, i64 0}
!36 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !14, i64 0}
!37 = !{!"p1 _ZTSSt5ctypeIcE", !14, i64 0}
!38 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !14, i64 0}
!39 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !14, i64 0}
!40 = !{!23, !26, i64 32}
!41 = !{!42, !13, i64 16}
!42 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !13, i64 8, !13, i64 16, !13, i64 24, !13, i64 32, !13, i64 40, !13, i64 48, !30, i64 56}
!43 = !{!42, !13, i64 24}
