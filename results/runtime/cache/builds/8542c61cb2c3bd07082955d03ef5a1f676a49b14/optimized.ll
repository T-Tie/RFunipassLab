...
if.then:                                          ; preds = %for.body10
  ...
  %call31 = call ptr @strcat(ptr noundef %arrayidx12, ptr noundef %arrayidx16) #9
  br label %for.inc40
...
for.inc50:                                        ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, ptr noundef %arrayidx47) #9
