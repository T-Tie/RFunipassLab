...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %wide.trip.count75 = zext nneg i32 %smax104 to i64
...
for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv100 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next101, %for.inc125 ]
  %exitcond106.not = icmp eq i64 %indvars.iv100, %wide.trip.count75
...
for.cond72.preheader:                             ; preds = %for.cond69
  ...
  %arrayidx99 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv100
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv93
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  %indvars.iv40 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next41, %for.inc9 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count43
...
for.cond12:                                       ; preds = %for.cond1, %for.inc26
  ...
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc26 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv48, %2
  br i1 %cmp13, label %for.cond15, label %for.inc32

for.cond15:                                       ; preds = %for.cond12, %for.inc23
  %3 = phi i32 [ %.pre, %for.inc23 ], [ %1, %for.cond12 ]
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc23 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
  %cmp16 = icmp slt i64 %indvars.iv45, %4
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv48, i64 %indvars.iv45
