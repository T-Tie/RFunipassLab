...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %js) #5
...
for.cond3:                                        ; preds = %for.cond3.preheader, %if.end32
  %indvars.iv36 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next37, %if.end32 ]
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv36
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv33 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next34, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv33, %3
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv51 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next52, %for.body56 ]
  %exitcond57.not = icmp eq i64 %indvars.iv51, %wide.trip.count56
  br i1 %exitcond57.not, label %if.end80, label %for.body56
