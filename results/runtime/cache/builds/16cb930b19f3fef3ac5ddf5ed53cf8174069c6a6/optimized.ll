...
for.body70:                                       ; preds = %for.cond67
  ...
  %idxprom74 = sext i32 %j.3 to i64
  %10 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom72
  %11 = getelementptr inbounds [101 x i32], ptr %10, i64 0, i64 %idxprom74
  %12 = load i32, ptr %11, align 4, !tbaa !5
  br i1 %cmp71, label %if.then, label %if.else

if.then:                                          ; preds = %for.body70
  %call76 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12) #6
  br label %for.inc82
