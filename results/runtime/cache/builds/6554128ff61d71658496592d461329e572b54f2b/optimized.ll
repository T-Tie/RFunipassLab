...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call10 = call double @sqrt(double noundef %4) #7, !tbaa !5
  ...
  %call18 = call double @sqrt(double noundef %8) #7, !tbaa !5
...
if.then42:                                        ; preds = %if.then40
  ...
  %call47 = call double @sqrt(double noundef %17) #7, !tbaa !5
  ...
  %call56 = call double @sqrt(double noundef %21) #7, !tbaa !5
  ...
  %call60 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc
...
if.else:                                          ; preds = %if.then40
  ...
  %call68 = call double @sqrt(double noundef %22) #7, !tbaa !5
  ...
  %call80 = call double @sqrt(double noundef %26) #7, !tbaa !5
...
for.inc:                                          ; preds = %if.end34, %if.else, %if.then42
