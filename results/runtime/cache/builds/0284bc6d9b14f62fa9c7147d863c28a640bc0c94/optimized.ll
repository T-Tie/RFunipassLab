...
if.else26:                                        ; preds = %if.else19
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i22.loc)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef %retval.0.i22.loc)
...
if.then21_to_outline:
  ...
  %2 = load i64, ptr %gep50, align 8, !tbaa !16, !invariant.load !11
