...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv18, %1
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre34, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv27 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next28, %for.cond13 ]
  ...
  %exitcond33 = icmp eq i64 %indvars.iv27, %wide.trip.count32
  br i1 %exitcond33, label %for.end58, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv21 = phi i64 [ 1, %for.cond13.preheader ], [ %9, %for.inc53 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv27, i64 %indvars.iv21
  %8 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp eq i32 %8, 0
  %9 = add nuw nsw i64 %indvars.iv21, 1
  br i1 %cmp20, label %land.lhs.true, label %for.inc53

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv27, i64 %9
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next28, i64 %indvars.iv21
  %11 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  %cmp32 = icmp eq i32 %11, 0
  %spec.select = select i1 %cmp32, i32 %7, i32 %x1.1
  %12 = trunc nuw nsw i64 %indvars.iv21 to i32
  %spec.select12 = select i1 %cmp32, i32 %12, i32 %y1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %y1.2 = phi i32 [ %y1.1, %land.lhs.true ], [ %spec.select12, %land.lhs.true26 ]
  %13 = add nsw i64 %indvars.iv21, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv27, i64 %13
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv21
  %15 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %cmp50 = icmp eq i32 %15, 0
  %spec.select13 = select i1 %cmp50, i32 %7, i32 %x2.1
  %16 = trunc nuw nsw i64 %indvars.iv21 to i32
  %spec.select14 = select i1 %cmp50, i32 %16, i32 %y2.1
  br label %for.inc53
...
for.inc53:                                        ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
  ...
  %x2.2 = phi i32 [ %spec.select13, %land.lhs.true44 ], [ %x2.1, %land.lhs.true38 ], [ %x2.1, %for.body15 ]
  %y2.2 = phi i32 [ %spec.select14, %land.lhs.true44 ], [ %y2.1, %land.lhs.true38 ], [ %y2.1, %for.body15 ]
...
for.end58:                                        ; preds = %for.cond10
  ...
  %mul6515 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6515, %add60
  %17 = shl i32 %sub61, 1
  %reass.sub16 = sub i32 %sub66, %17
  %add71 = add i32 %reass.sub16, 2
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call72, i8 noundef signext %call.i9)
