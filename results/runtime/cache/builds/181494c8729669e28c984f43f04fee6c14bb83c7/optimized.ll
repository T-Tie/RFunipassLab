...
for.cond4:                                        ; preds = %for.inc39, %for.end
  ...
  %w.0 = phi i32 [ undef, %for.end ], [ %w.1.lcssa, %for.inc39 ]
...
for.end25:                                        ; preds = %for.body13, %for.cond10
  %j.1.lcssa = phi i32 [ %j.1, %for.body13 ], [ %j.1, %for.cond10 ]
...
for.end54:                                        ; preds = %for.cond42
  %max.0.lcssa = phi i32 [ %max.0, %for.cond42 ]
  %cmp55 = icmp eq i32 %max.0.lcssa, 1
...
if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %max.0.lcssa) #9
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc80, %if.else58
  %i.3 = phi i32 [ 0, %if.else58 ], [ %inc81, %for.inc80 ]
  %cmp61 = icmp slt i32 %i.3, 1000
  br i1 %cmp61, label %for.body62, label %if.end83.loopexit
...
for.body62:                                       ; preds = %for.cond60
  ...
  %cmp65 = icmp eq i32 %5, %max.0.lcssa
