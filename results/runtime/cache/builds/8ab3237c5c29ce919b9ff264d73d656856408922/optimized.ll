...
for.inc31:                                        ; preds = %for.body, %for.cond10
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11) #6
...
for.end42:                                        ; preds = %for.cond33
  ...
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12) #6
