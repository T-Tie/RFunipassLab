...
if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %y) #7
...
if.end12:                                         ; preds = %if.then9, %if.else, %if.end.thread, %if.end
...
for.cond13:                                       ; preds = %if.end36, %for.end
  %x2.0 = phi i32 [ 0, %for.end ], [ %x2.2, %if.end36 ]
  %j.0 = phi i32 [ 1, %for.end ], [ %inc38, %if.end36 ]
...
if.then28:                                        ; preds = %if.end26
  %call29 = call noundef i32 @_Z7runniani(i32 noundef %y) #7
...
if.end36:                                         ; preds = %if.then31, %if.else33, %if.end26.thread, %if.end26
