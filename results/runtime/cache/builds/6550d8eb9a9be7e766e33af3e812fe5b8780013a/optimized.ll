...
if.then6.i9:                                      ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %or.cond80 = select i1 %call16.i19, i1 %or.cond.i23, i1 false
  br i1 %or.cond80, label %if.then19.i24, label %if.then6.i48
...
if.then6.i48:                                     ; preds = %if.then28.i35, %if.then19.i24, %if.then6.i9
  ...
  %or.cond81 = select i1 %call16.i58, i1 %or.cond.i62, i1 false
  br i1 %or.cond81, label %if.then19.i63, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79
...
if.then19.i63:                                    ; preds = %if.then6.i48
  ...
  %expval.i72 = call i64 @llvm.expect.i64(i64 %conv.i71, i64 1)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79: ; preds = %if.then6.i48, %if.then19.i63, %if.then28.i74
  ...
  %smax92 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79
  %indvars.iv103 = phi i32 [ %indvars.iv.next104, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79 ]
  %indvars.iv98 = phi i32 [ %indvars.iv.next99, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79 ]
  %exitcond94.not = icmp eq i64 %indvars.iv, %wide.trip.count93
  br i1 %exitcond94.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc ], [ 1, %for.body ]
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc ], [ %indvars.iv, %for.body ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv86
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %10 = trunc nuw nsw i64 %indvars.iv86 to i32
  br label %for.end
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count101 = zext i32 %indvars.iv98 to i64
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv95 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next96, %for.inc43 ]
  %exitcond102.not = icmp eq i64 %indvars.iv95, %wide.trip.count101
  br i1 %exitcond102.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv95
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv103 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv106 = phi i64 [ %indvars.iv.next107, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv106, %13
