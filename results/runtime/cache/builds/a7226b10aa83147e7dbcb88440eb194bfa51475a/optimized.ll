...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax16 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc ], [ %1, %if.then9 ]
