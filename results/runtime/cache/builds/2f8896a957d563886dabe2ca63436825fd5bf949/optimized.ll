...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z3sumi(i32 noundef %1) #9
...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax99 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %smax75 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count60 = zext nneg i32 %smax75 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv57
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv52 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next53, %for.inc21 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv57, i64 %indvars.iv52
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv72 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next73, %for.inc60 ]
  %exitcond77.not = icmp eq i64 %indvars.iv72, %wide.trip.count60
  br i1 %exitcond77.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv72
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select50, %for.body34 ], [ %3, %for.body29 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv72
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !14
  %spec.select50 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  br label %for.cond32, !llvm.loop !18

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv67 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next68, %for.inc57 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count
  br i1 %exitcond71.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv67, i64 %indvars.iv72
...
for.cond65.preheader:                             ; preds = %for.end62
  %wide.trip.count88 = zext nneg i32 %smax99 to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv83 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next84, %for.inc83 ]
  %exitcond89.not = icmp eq i64 %indvars.iv83, %wide.trip.count88
  br i1 %exitcond89.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv78 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next79, %for.inc80 ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %wide.trip.count
  br i1 %exitcond82.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv83, i64 %indvars.iv78
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !14
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv78
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv95 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next96, %for.inc104 ]
  %exitcond101.not = icmp eq i64 %indvars.iv95, %wide.trip.count88
  br i1 %exitcond101.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv95, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv90 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next91, %for.inc101 ]
  %exitcond94.not = icmp eq i64 %indvars.iv90, %wide.trip.count
  br i1 %exitcond94.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv90, i64 %indvars.iv95
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5, !invariant.load !14
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv90, i64 %9
