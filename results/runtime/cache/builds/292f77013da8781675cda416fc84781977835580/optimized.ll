...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv41.in = phi i32 [ %indvars.iv41, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv41 = add i32 %indvars.iv41.in, -1
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next35
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax43 = call i32 @llvm.smax.i32(i32 %indvars.iv41, i32 noundef 0)
  %wide.trip.count44 = zext nneg i32 %smax43 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv37 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next38, %for.inc39 ]
  %exitcond45.not = icmp eq i64 %indvars.iv37, %wide.trip.count44
  br i1 %exitcond45.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv37
