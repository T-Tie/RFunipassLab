...
for.body35:                                       ; preds = %for.cond33
  ...
  %8 = getelementptr inbounds i32, ptr %call1, i64 %idxprom38
...
if.then37:                                        ; preds = %for.body35
  ...
  %call40 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %9)
  br label %if.end44

if.else:                                          ; preds = %for.body35
  %arrayidx42 = getelementptr inbounds i32, ptr %call1, i64 %idxprom38
