...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1600, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 800, ptr %b) #9
...
if.end:                                           ; preds = %if.else37, %if.then34
  br label %if.end40

if.end40:                                         ; preds = %if.then, %if.end
  br label %for.inc41
...
for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 800, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 1600, ptr %a) #9
...
if.then_to_outline:                               ; preds = %newFuncRoot
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
...
if.end40.exitStub:                                ; preds = %if.then_to_outline
  ret void
}
