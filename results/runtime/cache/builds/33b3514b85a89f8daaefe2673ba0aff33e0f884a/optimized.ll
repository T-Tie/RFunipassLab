...
define dso_local noundef i32 @_Z3calPA120_ii(ptr noundef captures(none) %matrix, i32 noundef %n) #0 {
entry:
...
tailrecurse:                                      ; preds = %for.end114, %entry
  ...
  %smax117 = call i32 @llvm.smax.i32(i32 %3, i32 0)
...
for.cond.preheader:                               ; preds = %tailrecurse
  ...
  %smax101 = call i32 @llvm.smax.i32(i32 %5, i32 0)
...
for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count85 = and i64 %indvars.iv122, 4294967295
  br label %for.cond31
