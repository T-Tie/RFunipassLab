...
for.body77:                                       ; preds = %for.cond74
  ...
  %12 = load double, ptr %arrayidx80, align 8, !tbaa !9
  %13 = load double, ptr %arrayidx79, align 16, !tbaa !9
  %mul88 = fmul double %13, 4.000000e+00
  %arrayidx91 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 16
  %14 = load double, ptr %arrayidx91, align 16, !tbaa !9
  %15 = fneg double %14
  ...
  %17 = load double, ptr %arrayidx120, align 8, !tbaa !9
  %arrayidx123 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 32
  %18 = load double, ptr %arrayidx123, align 16, !tbaa !9
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %17, double noundef %18) #12
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %17) #12
  br label %for.inc132

if.else117:                                       ; preds = %for.body77
  %arrayidx129 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 40
  %19 = load double, ptr %arrayidx129, align 8, !tbaa !9
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %17, double noundef %18, double noundef %17, double noundef %19) #12
  br label %for.inc132
...
for.end134:                                       ; preds = %for.cond74
  %call135 = call i32 @getchar() #12
  %call136 = call i32 @getchar() #12
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %num) #12
