...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z3sumi(i32 noundef %1) #7
...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax37 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count22 = zext nneg i32 %smax37 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond27, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv19
  %0 = load i32, ptr %arrayidx, align 16, !tbaa !5, !invariant.load !15
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc21 ], [ 0, %for.cond14.preheader ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv14
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc60 ], [ 0, %for.cond ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count22
  br i1 %exitcond39.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv34
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !15
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select12, %for.body34 ], [ %3, %for.body29 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond28.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv34
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !15
  %spec.select12 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond32, !llvm.loop !20

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc57 ], [ 0, %for.cond49.preheader ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond33.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv29, i64 %indvars.iv34
  %5 = load i32, ptr %arrayidx55, align 4, !tbaa !5, !invariant.load !15
...
for.cond65.preheader:                             ; preds = %for.end62
  %smax61 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %wide.trip.count50 = zext nneg i32 %smax61 to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv45 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next46, %for.inc83 ]
  %exitcond51.not = icmp eq i64 %indvars.iv45, %wide.trip.count50
  br i1 %exitcond51.not, label %for.cond86, label %for.cond68.preheader

for.cond68.preheader:                             ; preds = %for.cond65
  %7 = add nsw i64 %indvars.iv45, -1
  br label %for.cond68

for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv40 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next41, %for.inc80 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond44.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !15
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv40
...
for.inc83:                                        ; preds = %for.cond68
  ...
  br label %for.cond65, !llvm.loop !24

for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc104 ], [ 2, %for.cond65 ]
  %exitcond63.not = icmp eq i64 %indvars.iv57, %wide.trip.count50
  br i1 %exitcond63.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv57, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv52 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next53, %for.inc101 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv57
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5, !invariant.load !15
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %9
