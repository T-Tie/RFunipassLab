...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc13
  %indvars.iv8 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next9, %for.inc13 ]
...
for.inc13:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv8
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #11
  %4 = trunc i64 %call10 to i32
  %conv = add i32 %4, 1
  %add.ptr12 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv8
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc42
  %.pre24 = phi i32 [ %0, %for.cond16.preheader ], [ %.pre, %for.inc42 ]
  %indvars.iv15 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next16, %for.inc42 ]
  %sum.0 = phi i32 [ 0, %for.cond16.preheader ], [ %sum.1, %for.inc42 ]
  %k.0 = phi i32 [ 0, %for.cond16.preheader ], [ %k.1, %for.inc42 ]
  %5 = sext i32 %.pre24 to i64
  %cmp17 = icmp slt i64 %indvars.iv15, %5
...
for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv15
...
for.cond23.preheader:                             ; preds = %for.body18
  %8 = add nsw i64 %indvars.iv15, -1
  %9 = zext nneg i32 %k.0 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv12 = phi i64 [ %9, %for.cond23.preheader ], [ %indvars.iv.next13, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv12, %8
  br i1 %cmp24, label %for.inc31, label %for.end33

for.inc31:                                        ; preds = %for.cond23
  %add.ptr27 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv12
...
for.end33:                                        ; preds = %for.cond23
  %gep = getelementptr [41 x i8], ptr %invariant.gep, i64 %indvars.iv15
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %gep)
  ...
  %10 = trunc nuw nsw i64 %indvars.iv15 to i32
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc42

for.inc42:                                        ; preds = %for.body18, %for.end33
  %.pre = phi i32 [ %.pre.pre, %for.end33 ], [ %.pre24, %for.body18 ]
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc54
  %11 = phi i32 [ %.pre24, %for.cond45.preheader ], [ %.pre23, %for.inc54 ]
  %indvars.iv20 = phi i64 [ %6, %for.cond45.preheader ], [ %indvars.iv.next21, %for.inc54 ]
  %sub46 = add nsw i32 %11, -1
  %12 = sext i32 %sub46 to i64
  %cmp47 = icmp slt i64 %indvars.iv20, %12
  br i1 %cmp47, label %for.inc54, label %for.end56

for.inc54:                                        ; preds = %for.cond45
  %add.ptr50 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv20
