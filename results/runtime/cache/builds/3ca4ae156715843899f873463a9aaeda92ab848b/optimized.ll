...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z7guilingi(i32 noundef %1) #11
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv37
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %indvars.iv32 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next33, %for.body19 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36.not, label %for.end26, label %for.body19

for.body19:                                       ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv32
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end69
  %indvars.iv52 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next53, %for.end69 ]
  %exitcond57.not = icmp eq i64 %indvars.iv52, %wide.trip.count40
  br i1 %exitcond57.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv52
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select30, %for.body42 ], [ %3, %for.body34 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv52
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !12
  %spec.select30 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  br label %for.cond39

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body61
  %indvars.iv47 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next48, %for.body61 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count45
  br i1 %exitcond51.not, label %for.end69, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv52
...
if.else:                                          ; preds = %for.end72
  tail call void @_Z8xiaojiani(i32 noundef %n.tr) #12
