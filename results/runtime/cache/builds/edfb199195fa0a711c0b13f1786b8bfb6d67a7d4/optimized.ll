...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55: ; preds = %if.then6.i36, %land.lhs.true.i42, %if.then19.i47, %if.then28.i54
  ...
  %smax85 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55
  %indvars.iv96 = phi i32 [ %indvars.iv.next97, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %exitcond87.not = icmp eq i64 %indvars.iv, %wide.trip.count86
  br i1 %exitcond87.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc ], [ 1, %for.body ]
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv79, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next78
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !22, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv79
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count94 = and i64 %indvars.iv, 4294967295
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv88 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next89, %for.inc43 ]
  %exitcond95.not = icmp eq i64 %indvars.iv88, %wide.trip.count94
  br i1 %exitcond95.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv88
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv96 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv99, %13
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv99
