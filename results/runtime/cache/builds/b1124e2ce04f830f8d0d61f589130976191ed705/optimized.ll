...
entry:
  %__c.addr.i21.sink.ce.loc57 = alloca ptr, align 8
  %__c.addr.i21.sink.ce.loc55 = alloca ptr, align 8
  %__c.addr.i21.sink.ce.loc = alloca ptr, align 8
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull align 16 %a) #6
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %b) #6
...
if.then:                                          ; preds = %for.body21
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %__c.addr.i21.sink.ce.loc)
  call void @outlined_ir_func_0(ptr %__c.addr.i, ptr %__c.addr.i21.sink.ce.loc)
  %__c.addr.i21.sink.ce.reload = load ptr, ptr %__c.addr.i21.sink.ce.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %__c.addr.i21.sink.ce.loc)
  br label %for.inc41
...
if.then34:                                        ; preds = %if.else
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %__c.addr.i21.sink.ce.loc55)
  call void @outlined_ir_func_0(ptr %__c.addr.i5, ptr %__c.addr.i21.sink.ce.loc55)
  %__c.addr.i21.sink.ce.reload56 = load ptr, ptr %__c.addr.i21.sink.ce.loc55, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %__c.addr.i21.sink.ce.loc55)
  br label %for.inc41
...
if.else37:                                        ; preds = %if.else
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %__c.addr.i21.sink.ce.loc57)
  call void @outlined_ir_func_0(ptr %__c.addr.i21, ptr %__c.addr.i21.sink.ce.loc57)
  %__c.addr.i21.sink.ce.reload58 = load ptr, ptr %__c.addr.i21.sink.ce.loc57, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %__c.addr.i21.sink.ce.loc57)
  br label %for.inc41

for.inc41:                                        ; preds = %if.else37, %if.then34, %if.then
  %__c.addr.i21.sink = phi ptr [ %__c.addr.i21.sink.ce.reload, %if.then ], [ %__c.addr.i21.sink.ce.reload56, %if.then34 ], [ %__c.addr.i21.sink.ce.reload58, %if.else37 ]
...
for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 noundef 1600, ptr noundef nonnull %a) #7
...
define internal void @outlined_ir_func_0(ptr %0, ptr %1) #5 {
newFuncRoot:
  br label %if.then_to_outline

if.then_to_outline:                               ; preds = %newFuncRoot
  store i8 10, ptr %0, align 1, !tbaa !27
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !28
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !30
  %gep47 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %2 = load i64, ptr %gep47, align 8, !tbaa !31, !invariant.load !30
...
for.inc41.split:                                  ; preds = %if.then.i, %if.end.i
  %__c.addr.i21.sink.ce = phi ptr [ %0, %if.then.i ], [ %0, %if.end.i ]
  br label %for.inc41.exitStub

for.inc41.exitStub:                               ; preds = %for.inc41.split
  store ptr %__c.addr.i21.sink.ce, ptr %1, align 8
  ret void
}
