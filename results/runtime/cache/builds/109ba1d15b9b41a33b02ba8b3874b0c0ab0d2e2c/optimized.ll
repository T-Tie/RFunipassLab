...
while.cond:                                       ; preds = %while.cond.backedge, %entry
  %count.0 = phi i32 [ 0, %entry ], [ %count.0.be, %while.cond.backedge ]
...
while.body:                                       ; preds = %while.cond
  ...
  %call.i.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
...
if.then:                                          ; preds = %while.body
  ...
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #6
...
if.then12:                                        ; preds = %if.else
  ...
  %call.i.i4 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i43, ptr noundef nonnull %word, i64 noundef %call.i.i4)
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #6
  %conv18 = trunc i64 %call17 to i32
  br label %while.cond.backedge

while.cond.backedge:                              ; preds = %if.then12, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit28, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.then
  %count.0.be = phi i32 [ %conv, %if.then ], [ %conv18, %if.then12 ], [ 0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %conv10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit28 ]
...
if.then21:                                        ; preds = %if.else19
  ...
  %3 = load i64, ptr %gep50, align 8, !tbaa !15
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call.i.i7 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull %word, i64 noundef %call.i.i7)
  %vtable.i44 = load ptr, ptr %retval.0.i, align 8, !tbaa !9
  %vbase.offset.ptr.i45 = getelementptr i8, ptr %vtable.i44, i64 -24
  %vbase.offset.i46 = load i64, ptr %vbase.offset.ptr.i45, align 8
  %add.ptr.i47 = getelementptr inbounds i8, ptr %retval.0.i, i64 %vbase.offset.i46
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i47, i8 noundef signext 10)
  %call1.i48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, i8 noundef signext %call.i)
...
if.else26:                                        ; preds = %if.else19
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i16)
  store i8 32, ptr %__c.addr.i16, align 1, !tbaa !14
  ...
  %cmp.not.i22 = icmp eq i64 %4, 0
  br i1 %cmp.not.i22, label %if.end.i26, label %if.then.i23

if.then.i23:                                      ; preds = %if.else26
  %call1.i24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i16, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit28

if.end.i26:                                       ; preds = %if.else26
  %call2.i27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit28

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit28: ; preds = %if.then.i23, %if.end.i26
  %retval.0.i25 = phi ptr [ %call1.i24, %if.then.i23 ], [ @_ZSt4cout, %if.end.i26 ]
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i16)
  %call.i.i29 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #5
  %call1.i30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i25, ptr noundef nonnull %word, i64 noundef %call.i.i29)
  br label %while.cond.backedge

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %word) #5
