...
if.then15:                                        ; preds = %if.else
  ...
  %5 = load i64, ptr %gep32, align 8, !tbaa !15
...
if.else18:                                        ; preds = %if.else
  ...
  store i8 10, ptr %__c.addr.i11, align 1, !tbaa !14
  %vtable.i12 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !11
  %vbase.offset.ptr.i13 = getelementptr i8, ptr %vtable.i12, i64 -24
  %vbase.offset.i14 = load i64, ptr %vbase.offset.ptr.i13, align 8, !invariant.load !13
