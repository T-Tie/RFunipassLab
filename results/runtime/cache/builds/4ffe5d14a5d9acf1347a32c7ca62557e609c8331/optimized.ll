...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end, %if.then.i.i
  ...
  %call7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4) #10
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %6) #10
