...
for.cond33:                                       ; preds = %for.inc43, %for.body32
  %.sink18 = phi i32 [ %1, %for.body32 ], [ %dec, %for.inc43 ]
  %cmp34 = icmp sge i32 %.sink18, 1
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idxprom38 = sext i32 %.sink18 to i64
  %arrayidx39 = getelementptr inbounds [1000 x i32], ptr %arrayidx37, i64 0, i64 %idxprom38
  %8 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !15
  %cmp40 = icmp eq i32 %8, 0
  br i1 %cmp40, label %for.end44.thread, label %for.inc43

for.end44.thread:                                 ; preds = %for.body35
  store i32 %.sink, ptr %y2, align 4, !tbaa !5
  store i32 %.sink18, ptr %x2, align 4, !tbaa !5
  br label %for.end50

for.inc43:                                        ; preds = %for.body35
  %dec = add nsw i32 %.sink18, -1
...
for.end50:                                        ; preds = %for.end44.thread, %for.cond30
