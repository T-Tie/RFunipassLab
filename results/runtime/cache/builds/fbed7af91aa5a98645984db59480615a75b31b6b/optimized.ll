...
for.cond16:                                       ; preds = %for.inc35, %for.body15
  ...
  %3 = load i32, ptr %j.sink, align 4, !tbaa !5
  %add = add nsw i32 %3, 1
  store i32 %add, ptr %p, align 4, !tbaa !5
  %cmp17 = icmp slt i32 %add, %2
...
for.body42:                                       ; preds = %for.cond40
  ...
  %11 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !13
  %cmp45 = icmp sgt i32 %11, %10
...
for.end52:                                        ; preds = %for.cond40
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10) #5
