...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre25, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv10 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next11, %for.inc28 ]
  ...
  br i1 %exitcond15.not, label %for.cond31.preheader, label %for.body12
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv6 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next7, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv10, i64 %indvars.iv6
  %6 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %cmp21 = icmp eq i32 %6, 0
  %7 = trunc nuw nsw i64 %indvars.iv6 to i32
  %b1.3 = select i1 %cmp21, i32 %7, i32 %b1.2
  %a1.3 = select i1 %cmp21, i32 %5, i32 %a1.2
  %add23 = zext i1 %cmp21 to i32
  %p.3 = add nuw nsw i32 %p.2, %add23
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv21 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next22, %for.inc52 ]
  %a2.0 = phi i32 [ undef, %for.cond31.preheader ], [ %a2.1, %for.inc52 ]
  %b2.0 = phi i32 [ undef, %for.cond31.preheader ], [ %b2.1, %for.inc52 ]
  %p.4 = phi i32 [ 0, %for.cond31.preheader ], [ %p.5, %for.inc52 ]
  %indvars.iv.next22 = add nsw i64 %indvars.iv21, -1
  %cmp32 = icmp sgt i64 %indvars.iv21, 0
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv17 = phi i64 [ %4, %for.cond37.preheader ], [ %indvars.iv.next18, %for.body39 ]
  %a2.2 = phi i32 [ %a2.0, %for.cond37.preheader ], [ %a2.3, %for.body39 ]
  %b2.2 = phi i32 [ %b2.0, %for.cond37.preheader ], [ %b2.3, %for.body39 ]
  %p.6 = phi i32 [ 0, %for.cond37.preheader ], [ %p.7, %for.body39 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %indvars = trunc i64 %indvars.iv.next18 to i32
  %idxprom42 = and i64 %indvars.iv.next18, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next22, i64 %idxprom42
  %10 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %cmp44 = icmp eq i32 %10, 0
  %a2.3 = select i1 %cmp44, i32 %8, i32 %a2.2
  %b2.3 = select i1 %cmp44, i32 %indvars, i32 %b2.2
  %add46 = zext i1 %cmp44 to i32
  %p.7 = add nuw nsw i32 %p.6, %add46
...
for.end53:                                        ; preds = %for.cond31
  %reass.sub1 = sub i32 %b2.0, %b1.0
  %add55 = add i32 %reass.sub1, 1
