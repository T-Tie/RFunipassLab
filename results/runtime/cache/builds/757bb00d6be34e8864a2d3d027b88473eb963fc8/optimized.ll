...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 8, ptr %c) #9
...
for.inc:                                          ; preds = %land.lhs.true, %if.else, %if.else17
  ...
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %.str.2.sink.sink)
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %c) #9
