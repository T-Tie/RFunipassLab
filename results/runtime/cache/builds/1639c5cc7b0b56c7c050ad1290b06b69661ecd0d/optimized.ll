...
for.end14:                                        ; preds = %for.cond1
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n) #9
...
if.end:                                           ; preds = %cond.false, %if.else, %if.then
  %min.4 = phi i32 [ %9, %if.then ], [ %min.3, %cond.false ], [ %10, %if.else ]
...
if.end89:                                         ; preds = %cond.false86, %if.else75, %if.then70
  %min.7 = phi i32 [ %14, %if.then70 ], [ %min.6, %cond.false86 ], [ %15, %if.else75 ]
...
for.inc103:                                       ; preds = %for.cond94
  ...
  %16 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !12
  %sub102 = sub nsw i32 %16, %min.6
...
for.cond112:                                      ; preds = %for.end131, %for.end108
  %18 = load i32, ptr %i111, align 4, !tbaa !5
  %cmp113 = icmp slt i32 %18, %7
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %19 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  ...
  store i32 %19, ptr %arrayidx128, align 4, !tbaa !5
...
for.cond151:                                      ; preds = %for.body154, %for.end149
  %22 = load i32, ptr %i150, align 4, !tbaa !5
  %cmp152 = icmp slt i32 %22, %7
  br i1 %cmp152, label %for.body154, label %for.end164

for.body154:                                      ; preds = %for.cond151
  %idxprom156 = sext i32 %22 to i64
  %arrayidx157 = getelementptr inbounds [100 x i32], ptr %temp, i64 0, i64 %idxprom156
  %23 = load i32, ptr %arrayidx157, align 4, !tbaa !5
  %sub159 = sub nsw i32 %22, 1
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %24 = load i32, ptr %arrayidx178, align 4, !tbaa !5
  ...
  store i32 %24, ptr %arrayidx184, align 4, !tbaa !5
...
for.end192:                                       ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n) #9
