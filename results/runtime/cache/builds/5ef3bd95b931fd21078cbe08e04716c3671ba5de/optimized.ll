...
for.cond:                                         ; preds = %for.inc17, %entry
  %.sink = phi i32 [ 1, %entry ], [ %add, %for.inc17 ]
...
for.cond2:                                        ; preds = %for.inc14, %for.body
  %add.sink = phi i32 [ %add, %for.body ], [ %inc15, %for.inc14 ]
  store i32 %add.sink, ptr %j, align 4, !tbaa !5
  %cmp3 = icmp sle i32 %add.sink, 12
...
for.cond5:                                        ; preds = %for.inc, %for.body4
  ...
  %sub = sub nsw i32 %add.sink, 1
  %cmp6 = icmp sle i32 %0, %sub
...
if.then:                                          ; preds = %for.end
  ...
  %idxprom12 = sext i32 %add.sink to i64
...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  %.sink13 = phi i32 [ 1, %for.end19 ], [ %inc28, %for.inc27 ]
  store i32 %.sink13, ptr %i, align 4, !tbaa !5
  %cmp21 = icmp sle i32 %.sink13, 12
  br i1 %cmp21, label %for.inc27, label %for.end29

for.inc27:                                        ; preds = %for.cond20
  %idxprom23 = sext i32 %.sink13 to i64
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %.sink14 = phi i32 [ 1, %for.end29 ], [ %inc49, %for.inc48 ]
  store i32 %.sink14, ptr %i, align 4, !tbaa !5
  %cmp31 = icmp sle i32 %.sink14, 12
...
for.cond33:                                       ; preds = %for.inc45, %for.body32
  ...
  %sub34 = sub nsw i32 %.sink14, 1
  %cmp35 = icmp sle i32 %3, %sub34
...
for.inc45:                                        ; preds = %for.cond33
  ...
  %idxprom39 = sext i32 %.sink14 to i64
...
for.inc76:                                        ; preds = %for.end67, %if.then70
  %inc77 = add nsw i32 %add54.sink, 1
...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %.sink16 = phi i32 [ 1, %for.end81 ], [ %inc90, %for.inc89 ]
  store i32 %.sink16, ptr %i, align 4, !tbaa !5
  %cmp83 = icmp sle i32 %.sink16, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %idxprom85 = sext i32 %.sink16 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %.sink17 = phi i32 [ 1, %for.end91 ], [ %inc111, %for.inc110 ]
  store i32 %.sink17, ptr %i, align 4, !tbaa !5
  %cmp93 = icmp sle i32 %.sink17, 12
...
for.body115:                                      ; preds = %for.cond113
  ...
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %12) #7
  %cmp118 = icmp eq i32 %call117, 1
  %13 = load i32, ptr %mon1, align 4, !tbaa !5
  %14 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom120 = sext i32 %13 to i64
  %idxprom122 = sext i32 %14 to i64
...
if.then119:                                       ; preds = %for.body115
  ...
  %15 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %cmp124 = icmp eq i32 %15, 1
...
if.else129:                                       ; preds = %for.body115
  ...
  %16 = load i32, ptr %arrayidx133, align 4, !tbaa !5
  %cmp134 = icmp eq i32 %16, 1
