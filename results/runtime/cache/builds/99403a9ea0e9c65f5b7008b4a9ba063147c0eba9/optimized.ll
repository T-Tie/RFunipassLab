...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax38 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond24.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc60 ], [ 0, %for.cond ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count23
  br i1 %exitcond40.not, label %for.end62, label %for.body29
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select13, %for.body34 ], [ %3, %for.body29 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.cond49.preheader, label %for.body34
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc57 ], [ 0, %for.cond49.preheader ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv30, i64 %indvars.iv35
...
for.cond65.preheader:                             ; preds = %for.end62
  %smax62 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %wide.trip.count51 = zext nneg i32 %smax62 to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv46 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next47, %for.inc83 ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count51
  br i1 %exitcond52.not, label %for.cond86, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv41 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next42, %for.inc80 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond45.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv46, i64 %indvars.iv41
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv41
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc104 ], [ 2, %for.cond65 ]
  %exitcond64.not = icmp eq i64 %indvars.iv58, %wide.trip.count51
  br i1 %exitcond64.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv58, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv53 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next54, %for.inc101 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count
  br i1 %exitcond57.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv53, i64 %indvars.iv58
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv53, i64 %9
