...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select40 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select40
  ...
  %or.cond41 = or i1 %cmp12, %or.cond
  %smax44 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond41, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %x.1 = phi i32 [ %add18, %for.inc ], [ 0, %for.body ]
  %5 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond45.not = icmp eq i32 %5, %smax44
  br i1 %exitcond45.not, label %for.inc53, label %for.body16
...
for.inc:                                          ; preds = %sw.bb17, %sw.default, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16
  %.sink8 = phi i32 [ 29, %sw.bb17 ], [ 30, %sw.default ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ]
  %add18 = add nuw nsw i32 %.sink8, %x.1
  %inc = add i32 %5, 1
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %6, %smax44
  br i1 %exitcond.not, label %for.inc53, label %for.body32

for.body32:                                       ; preds = %for.cond30
  switch i32 %6, label %sw.default37 [
...
for.inc40:                                        ; preds = %sw.bb35, %sw.default37, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32
  %.sink6 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add36 = add nuw nsw i32 %.sink6, %x.2
  %inc41 = add i32 %6, 1
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %spec.select43 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call49 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %spec.select43)
