...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %total) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %valid) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %t1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %v1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %x) #6
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %x) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %v1) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %t1) #7
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %valid) #7
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %total) #7
  ret i32 0
}
