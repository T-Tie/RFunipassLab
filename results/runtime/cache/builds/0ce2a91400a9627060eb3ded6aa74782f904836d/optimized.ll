...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv36 = phi i32 [ %indvars.iv.next37, %for.inc ], [ 0, %entry ]
...
land.lhs.true:                                    ; preds = %for.cond
  ...
  %.pre39 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
  %cmp19 = icmp eq i32 %.pre39, 0
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre38, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre39, %land.lhs.true ]
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc61
  %indvars.iv33 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next34, %for.inc61 ]
...
for.inc61:                                        ; preds = %for.cond56
  %arrayidx59 = getelementptr inbounds nuw [1000 x i32], ptr %sum, i64 0, i64 %indvars.iv33
