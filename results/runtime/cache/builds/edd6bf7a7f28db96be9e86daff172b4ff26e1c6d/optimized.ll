...
for.end87:                                        ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %i, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %total1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year) #7
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %m, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %total2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year) #7
  ...
  %puts5 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.str) #7
...
for.inc.sink.split:                               ; preds = %if.then35, %if.else, %if.end26.thread
  %.sink = phi i32 [ 28, %if.else ], [ 29, %if.then35 ], [ 30, %if.end26.thread ]
  %add373.sink = phi i32 [ %add373, %if.else ], [ %add373, %if.then35 ], [ %add376, %if.end26.thread ]
...
for.end.exitStub:                                 ; preds = %for.cond2
  %smax = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1) #8
