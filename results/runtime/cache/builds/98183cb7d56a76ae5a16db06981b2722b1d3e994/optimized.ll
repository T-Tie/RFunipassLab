...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull %word) #6
...
if.then12:                                        ; preds = %if.else
  ...
  %call.i.i1 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
...
if.then21:                                        ; preds = %if.else19
  ...
  %call.i.i4 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
  ...
  %vtable.i41 = load ptr, ptr %retval.0.i.reload, align 8, !tbaa !9, !invariant.load !11
...
if.else26:                                        ; preds = %if.else19
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i13)
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %retval.0.i22.loc)
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i13, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i22.loc)
  %retval.0.i22.reload = load ptr, ptr %retval.0.i22.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef captures(none) %retval.0.i22.loc)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i13)
  %call.i.i26 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
...
if.then21_to_outline:
  store i8 32, ptr %0, align 1, !tbaa !15
  ...
  %2 = load i64, ptr %gep50, align 8, !tbaa !16
  %cmp.not.i = icmp eq i64 %2, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.then21_to_outline
  %call1.i3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0, i64 noundef 1)
...
if.then21_after_outline.exitStub:                 ; preds = %if.end.i, %if.then.i
