...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax5 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax5 to i64
  br label %for.cond9
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  ...
  %exitcond6.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond6.not, label %cleanup, label %for.inc16
