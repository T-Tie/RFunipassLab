...
for.cond:                                         ; preds = %for.inc11, %entry
  %a2.0 = phi i32 [ 0, %entry ], [ %a2.1.lcssa, %for.inc11 ]
  %a1.0 = phi i32 [ 0, %entry ], [ %a1.1.lcssa, %for.inc11 ]
  %i.0 = phi i32 [ 1, %entry ], [ %inc12, %for.inc11 ]
  %b1.0 = phi i32 [ 0, %entry ], [ %b1.1.lcssa, %for.inc11 ]
  %b2.0 = phi i32 [ 0, %entry ], [ %b2.1.lcssa, %for.inc11 ]
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %a2.1 = phi i32 [ %a2.0, %for.body ], [ %a2.23, %for.inc ]
  %a1.1 = phi i32 [ %a1.0, %for.body ], [ %a1.25, %for.inc ]
...
for.inc11:                                        ; preds = %for.cond1
  %a2.1.lcssa = phi i32 [ %a2.1, %for.cond1 ]
  %a1.1.lcssa = phi i32 [ %a1.1, %for.cond1 ]
  %b1.1.lcssa = phi i32 [ %b1.1, %for.cond1 ]
  %b2.1.lcssa = phi i32 [ %b2.1, %for.cond1 ]
  %inc12 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !12

for.end13:                                        ; preds = %for.cond
  %a2.0.lcssa = phi i32 [ %a2.0, %for.cond ]
  %a1.0.lcssa = phi i32 [ %a1.0, %for.cond ]
  %b1.0.lcssa = phi i32 [ %b1.0, %for.cond ]
  %b2.0.lcssa = phi i32 [ %b2.0, %for.cond ]
  %a1.0.lcssa.neg = sub i32 0, %a1.0.lcssa
  %sub = add i32 %a1.0.lcssa.neg, -1
  %sub14 = add i32 %sub, %b1.0.lcssa
  %a2.0.lcssa.neg = sub i32 0, %a2.0.lcssa
  %sub15 = add i32 %a2.0.lcssa.neg, -1
  %sub16 = add i32 %sub15, %b2.0.lcssa
