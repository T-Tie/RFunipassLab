...
if.then8:                                         ; preds = %land.lhs.true6
  %div = sdiv i32 %m, %j.0
  %call = tail call noundef i32 @_Z6devideiii(i32 noundef %div, i32 noundef %sub, i32 noundef %j.0) #5
...
return:                                           ; preds = %while.cond, %land.lhs.true, %if.else
  %retval.0 = phi i32 [ 0, %if.else ], [ %spec.select, %land.lhs.true ], [ %sum.0, %while.cond ]
  ret i32 %retval.0
}
...
for.inc:                                          ; preds = %for.cond2
  %call5 = call noundef i32 @_Z6devideiii(i32 noundef %1, i32 noundef %X.0, i32 noundef 1) #7
...
for.inc8:                                         ; preds = %for.cond2
  ...
  %vtable.i = load ptr, ptr %call6, align 8, !tbaa !13, !invariant.load !15
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call6, i8 noundef signext %call.i1)
