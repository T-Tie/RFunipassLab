...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc28 ], [ 0, %entry ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count34
  br i1 %exitcond35.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv31
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv31, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body16 ], [ 0, %for.cond14.preheader ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.inc28, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv31, i64 %indvars.iv26
...
for.cond31:                                       ; preds = %for.cond, %for.end68
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.end68 ], [ 0, %for.cond ]
  %exitcond50.not = icmp eq i64 %indvars.iv46, %wide.trip.count34
  br i1 %exitcond50.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv46
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select24, %for.body39 ], [ %3, %for.body33 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond40.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv46
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select24 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body56 ], [ 0, %for.cond54.preheader ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond45.not, label %for.end68, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv46
  %5 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !12
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = tail call i32 @llvm.smax.i32(i32 %n, i32 0)
  %smax11 = tail call i32 @llvm.smax.i32(i32 %sub, i32 1)
  %wide.trip.count12 = zext nneg i32 %smax11 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond1, %entry
  %indvars.iv8 = phi i64 [ 1, %entry ], [ %indvars.iv.next9, %for.cond1 ]
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond13.preheader, label %for.cond1.preheader
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next9, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
  store i32 %0, ptr %arrayidx9, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !16

for.cond13:                                       ; preds = %for.cond17, %for.cond13.preheader
  %indvars.iv19 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next20, %for.cond17 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count12
  br i1 %exitcond23.not, label %for.end35, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  %indvars.iv14 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next15, %for.inc30 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond13, label %for.inc30

for.inc30:                                        ; preds = %for.cond17
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv.next20
  %1 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %arrayidx29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv19
...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.end ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
