...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 208, ptr noundef align 16 %b) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %b, i8 noundef 0, i64 noundef 208, i1 noundef false) #6
...
for.inc.gvnsink.split:                            ; preds = %if.else35, %if.then29
  %sub.sink = phi i32 [ %sub, %if.then29 ], [ %add, %if.else35 ]
  %idxprom33 = sext i32 %sub.sink to i64
  %arrayidx34 = getelementptr inbounds [52 x i32], ptr %b, i64 0, i64 %idxprom33
  %1 = load i32, ptr %arrayidx34, align 4, !tbaa !8
  %inc = add nsw i32 %1, 1
  store i32 %inc, ptr %arrayidx34, align 4, !tbaa !8
  br label %for.inc

for.inc:                                          ; preds = %for.inc.gvnsink.split, %if.else, %land.lhs.true, %lor.lhs.false13
...
if.then55:                                        ; preds = %for.end53
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str.1) #7
  br label %if.end89
...
if.then64:                                        ; preds = %for.body60
  ...
  %call68 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %add65, i32 noundef %3) #7
  br label %for.inc70
...
if.then79:                                        ; preds = %for.body75
  ...
  %call84 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %sub81, i32 noundef %4) #7
  br label %for.inc86
...
if.end89:                                         ; preds = %for.cond73, %if.then55
  call void @llvm.lifetime.end.p0(i64 noundef 208, ptr noundef %b) #7
