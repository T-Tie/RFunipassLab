...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr nonnull %js) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %LEN)
  br label %for.cond
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax53 = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
...
if.end80:                                         ; preds = %for.cond54, %for.end75
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %js) #4
