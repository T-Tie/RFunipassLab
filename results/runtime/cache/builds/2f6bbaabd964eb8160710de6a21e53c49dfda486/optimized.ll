...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc8 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc28 ], [ 0, %for.end10 ]
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %6, i32 0)
  %wide.trip.count47 = zext nneg i32 %smax46 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc25 ], [ 0, %for.cond12 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv34, %9
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv37, i64 %indvars.iv34
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv43 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next44, %for.inc46 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %smax53 = call i32 @llvm.smax.i32(i32 %4, i32 0)
  %wide.trip.count54 = zext nneg i32 %smax53 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv43, i64 %indvars.iv40
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc83
  %indvars.iv62 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next63, %for.inc83 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count47
  br i1 %exitcond66.not, label %for.cond86, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc80
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc80 ], [ 0, %for.cond49 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond61.not, label %for.inc83, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv62, i64 %indvars.iv56
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc77
  %indvars.iv49 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next50, %for.inc77 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count54
  br i1 %exitcond55.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond57
  %10 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv49
  %11 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv49, i64 %indvars.iv56
...
for.cond86:                                       ; preds = %for.cond49, %for.inc109
  ...
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc109 ], [ 0, %for.cond49 ]
  %15 = sext i32 %14 to i64
  %cmp88.not.not = icmp slt i64 %indvars.iv70, %15
  br i1 %cmp88.not.not, label %for.cond90, label %for.end111

for.cond90:                                       ; preds = %for.cond86, %for.body93
  %16 = phi i32 [ %.pre73, %for.body93 ], [ %13, %for.cond86 ]
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.body93 ], [ 0, %for.cond86 ]
  %17 = sext i32 %16 to i64
  %cmp92.not.not = icmp slt i64 %indvars.iv67, %17
  br i1 %cmp92.not.not, label %for.body93, label %for.inc109

for.body93:                                       ; preds = %for.cond90
  %sub91 = add nsw i32 %16, -1
  %18 = sext i32 %sub91 to i64
  %cmp95 = icmp slt i64 %indvars.iv67, %18
  %spec.select = select i1 %cmp95, ptr @.str.2, ptr @.str.3
  %arrayidx104 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv70, i64 %indvars.iv67
