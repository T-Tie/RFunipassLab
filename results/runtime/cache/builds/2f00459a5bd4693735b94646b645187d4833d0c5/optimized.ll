...
for.end:                                          ; preds = %for.cond
  ...
  %smax128 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %2 = add nuw i32 %smax128, 1
  %wide.trip.count129 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv125 = phi i64 [ %indvars.iv.next126, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond130 = icmp eq i64 %indvars.iv125, %wide.trip.count129
  br i1 %exitcond130, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax116 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.cond71.preheader:                             ; preds = %for.cond11
  ...
  %smax143 = add nsw i32 %3, -1
  %wide.trip.count144 = zext nneg i32 %smax143 to i64
  br label %for.cond71

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv113 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next114, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond118.not = icmp eq i64 %indvars.iv113, %wide.trip.count117
  br i1 %exitcond118.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.body19 ], [ 0, %for.cond14 ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond14 ]
  %exitcond112.not = icmp eq i64 %indvars.iv107, %wide.trip.count
  br i1 %exitcond112.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv107, %indvars.iv125
  %arrayidx21 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx21, align 1, !tbaa !9
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv113, i64 %indvars.iv107
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv113, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv119 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next120, %for.inc56 ]
  %exitcond124.not = icmp eq i64 %indvars.iv119, %wide.trip.count
  br i1 %exitcond124.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv119, %indvars.iv125
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom59, i64 %indvars.iv119
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv140 = phi i64 [ %indvars.iv.next141, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv135 = phi i64 [ %indvars.iv.next136, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond145.not = icmp eq i64 %indvars.iv140, %wide.trip.count144
  br i1 %exitcond145.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv140, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv137 = phi i64 [ %indvars.iv.next138, %for.inc118 ], [ %indvars.iv135, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv137 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv137, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv131 = phi i64 [ %indvars.iv.next132, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond134.not = icmp eq i64 %indvars.iv131, 6
  br i1 %exitcond134.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv137, i64 %indvars.iv131
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv131
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv140, i64 %indvars.iv131
...
if.else:                                          ; preds = %for.end123
  ...
  %smax150 = call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %l.0, i32 noundef 1)
  %wide.trip.count154 = zext nneg i32 %smax150 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv146 = phi i64 [ %indvars.iv.next147, %for.inc151 ], [ 1, %if.else ]
  %exitcond155.not = icmp eq i64 %indvars.iv146, %wide.trip.count154
  br i1 %exitcond155.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv146, i64 4
  %17 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %18 = add nsw i64 %indvars.iv146, -1
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars153.le = trunc i64 %indvars.iv146 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.0.lcssa = phi i32 [ %indvars153.le, %for.end153.split.loop.exit ], [ %smax150, %for.cond134 ]
  %sub155 = add nsw i32 %z.0.lcssa, -1
  %wide.trip.count170 = zext i32 %sub155 to i64
  %wide.trip.count165 = zext i32 %z.0.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv167 = phi i64 [ %indvars.iv.next168, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv160 = phi i64 [ %indvars.iv.next161, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond171.not = icmp eq i64 %indvars.iv167, %wide.trip.count170
  br i1 %exitcond171.not, label %for.cond207.preheader, label %for.body157

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count178 = zext i32 %z.0.lcssa to i64
  br label %for.cond207

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv167, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv162 = phi i64 [ %indvars.iv.next163, %for.inc201 ], [ %indvars.iv160, %for.body157 ]
  %exitcond166.not = icmp eq i64 %indvars.iv162, %wide.trip.count165
  br i1 %exitcond166.not, label %for.cond154.loopexit, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv162, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv156 = phi i64 [ %indvars.iv.next157, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond159.not = icmp eq i64 %indvars.iv156, 6
  br i1 %exitcond159.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv162, i64 %indvars.iv156
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv156
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv167, i64 %indvars.iv156
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv175 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next176, %for.inc223 ]
  %exitcond179.not = icmp eq i64 %indvars.iv175, %wide.trip.count178
  br i1 %exitcond179.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv172 = phi i64 [ %indvars.iv.next173, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv172, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv175, i64 %indvars.iv172
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar105 = call i32 @putchar(i32 noundef %conv218) #10
