...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre70, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv60 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next61, %for.inc27 ]
...
for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc21 ], [ 1, %for.cond10 ]
...
for.end29.loopexit:                               ; preds = %for.body15
  ...
  %8 = trunc nuw nsw i64 %indvars.iv56 to i32
  %9 = xor i32 %8, -1
  br label %for.end29

for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.151 = phi i32 [ %7, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %9, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %10 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc48 ], [ %10, %for.end29 ]
  %11 = trunc nuw i64 %indvars.iv67 to i32
