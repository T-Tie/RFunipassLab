...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc110 ], [ 0, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv12, %9
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv12
  %10 = load double, ptr %arrayidx53, align 8, !tbaa !9
  %cmp54 = fcmp ogt double %10, 0.000000e+00
  %11 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv12
  %12 = load double, ptr %11, align 8, !tbaa !9
  br i1 %cmp54, label %if.then55, label %if.else63

if.then55:                                        ; preds = %for.body51
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv12
...
if.else72:                                        ; preds = %if.else63
  ...
  %14 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv12
  %15 = load double, ptr %14, align 8, !tbaa !9
  %fneg81 = fneg double %12
  %.sink1 = select i1 %cmp76, double %fneg81, double %12
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %.sink1, double noundef %15, double noundef %.sink1, double noundef %15) #8
  br label %for.inc110
