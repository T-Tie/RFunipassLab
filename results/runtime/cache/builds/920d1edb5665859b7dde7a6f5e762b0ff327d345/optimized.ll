...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv64 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next65, %for.inc135 ]
  %indvars.iv61 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next62, %for.inc135 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc48
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc48 ], [ 0, %for.cond13 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %indvars.iv64
  br i1 %exitcond22.not, label %for.cond51, label %for.cond19

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body21 ], [ 0, %for.cond16 ]
  %min.0 = phi i32 [ %spec.select, %for.body21 ], [ 100000, %for.cond16 ]
  %exitcond.not = icmp eq i64 %indvars.iv10, %indvars.iv64
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv10
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc45 ], [ 0, %for.cond34.preheader ]
...
for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv13
...
for.cond51:                                       ; preds = %for.cond16, %for.inc86
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc86 ], [ 0, %for.cond16 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %indvars.iv64
  br i1 %exitcond37.not, label %for.end88, label %for.cond54

for.cond54:                                       ; preds = %for.cond51, %for.body56
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body56 ], [ 0, %for.cond51 ]
  %min.2 = phi i32 [ %spec.select5, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %indvars.iv64
  br i1 %exitcond27.not, label %for.cond71.preheader, label %for.body56

for.cond71.preheader:                             ; preds = %for.cond54
  br label %for.cond71

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv33
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5
  %spec.select5 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond54, !llvm.loop !16

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc83 ], [ 0, %for.cond71.preheader ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %indvars.iv64
  br i1 %exitcond32.not, label %for.inc86, label %for.inc83

for.inc83:                                        ; preds = %for.cond71
  %arrayidx77 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv33
...
for.cond91:                                       ; preds = %for.cond95, %for.end88
  %indvars.iv43 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next44, %for.cond95 ]
  %exitcond50.not = icmp eq i64 %indvars.iv43, %indvars.iv61
  br i1 %exitcond50.not, label %for.cond113, label %for.cond95.preheader
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv38 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next39, %for.inc107 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %indvars.iv64
  br i1 %exitcond42.not, label %for.cond91, label %for.inc107, !llvm.loop !19

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv.next44, i64 %indvars.iv38
  %14 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv38
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  %indvars.iv56 = phi i64 [ 1, %for.cond91 ], [ %indvars.iv.next57, %for.cond116 ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %indvars.iv64
  br i1 %exitcond60.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv51 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next52, %for.inc129 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %indvars.iv61
  br i1 %exitcond55.not, label %for.cond113, label %for.inc129, !llvm.loop !21

for.inc129:                                       ; preds = %for.cond116
  %arrayidx124 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv51, i64 %indvars.iv.next57
  %15 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv51, i64 %indvars.iv56
