...
for.end:                                          ; preds = %for.cond
  %max1.0.lcssa = phi i32 [ %max1.0, %for.cond ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %sub = sub nsw i32 %max1.0.lcssa, 1
...
for.end22:                                        ; preds = %for.cond7
  %max2.0.lcssa = phi i32 [ %max2.0, %for.cond7 ]
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max1.0.lcssa)
  ...
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max2.0.lcssa)
