...
entry:
  %call = call i64 @strlen(ptr nofree noundef readonly captures(none) %word) #12
...
while.end.thread:                                 ; preds = %while.cond
  %call164 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %if.end19
...
if.end10:                                         ; preds = %if.end
  ...
  %call14 = call i64 @strlen(ptr noundef %arrayidx12) #13
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %number) #14
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull align 16 captures(none) dereferenceable(25000) %word) #15
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 25000, ptr noundef %word) #15
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %number) #15
  ret i32 0
}
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) local_unnamed_addr #9 comdat align 2 {
entry:
  %call = call i64 @strlen(ptr noundef %__s) #15
  ret i64 %call
}
...
attributes #6 = { inlinehint mustprogress nofree nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!13 = distinct !{!13, !6, !7}
!14 = !{!15, !16, i64 16}
!15 = !{!"_ZTSSt8ios_base", !16, i64 8, !16, i64 16, !17, i64 24, !18, i64 28, !18, i64 32, !19, i64 40, !21, i64 48, !11, i64 64, !10, i64 192, !22, i64 200, !23, i64 208}
!16 = !{!"long", !11, i64 0}
...
!25 = !{!26, !11, i64 56}
!26 = !{!"_ZTSSt5ctypeIcE", !27, i64 0, !28, i64 16, !29, i64 24, !30, i64 32, !30, i64 40, !31, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
!27 = !{!"_ZTSNSt6locale5facetE", !10, i64 8}
!28 = !{!"p1 _ZTS15__locale_struct", !20, i64 0}
!29 = !{!"bool", !11, i64 0}
!30 = !{!"p1 int", !20, i64 0}
!31 = !{!"p1 short", !20, i64 0}
!32 = !{!11, !11, i64 0}
!33 = !{!34, !34, i64 0}
