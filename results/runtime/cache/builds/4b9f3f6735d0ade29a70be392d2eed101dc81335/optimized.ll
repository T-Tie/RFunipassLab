...
for.inc:                                          ; preds = %sw.bb, %sw.bb17, %sw.default
  %.sink1 = phi i32 [ 29, %sw.bb17 ], [ 31, %sw.bb ], [ 30, %sw.default ]
...
for.inc40:                                        ; preds = %sw.bb33, %sw.bb35, %sw.default37
  %.sink = phi i32 [ 28, %sw.bb35 ], [ 31, %sw.bb33 ], [ 30, %sw.default37 ]
...
for.inc53:                                        ; preds = %if.else25, %if.then22, %if.else48, %if.then45
  %.str.1.sink = phi ptr [ @.str.1, %if.else48 ], [ @.str, %if.then45 ], [ @.str.1, %if.else25 ], [ @.str, %if.then22 ]
