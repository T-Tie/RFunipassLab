...
for.end87:                                        ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 4, ptr %total1) #4
  store i32 0, ptr %total1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %total2) #4
  ...
  call fastcc void @outlined_ir_func_0(ptr %i, ptr %month1, ptr %total1, ptr %year)
  call fastcc void @outlined_ir_func_0(ptr %m, ptr %month2, ptr %total2, ptr %year)
...
for.inc95:                                        ; preds = %if.then90, %if.else92
  call void @llvm.lifetime.end.p0(i64 4, ptr %total2) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %total1) #4
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1, ptr %2, ptr %3) unnamed_addr #3 {
for.body_to_outline:
...
if.then35:                                        ; preds = %lor.lhs.false32, %land.lhs.true
  ...
  %add36 = add nsw i32 %9, 29
  store i32 %add36, ptr %2, align 4, !tbaa !5
  br label %for.inc

if.else:                                          ; preds = %lor.lhs.false32
  %10 = load i32, ptr %2, align 4, !tbaa !5
  %add37 = add nsw i32 %10, 28
