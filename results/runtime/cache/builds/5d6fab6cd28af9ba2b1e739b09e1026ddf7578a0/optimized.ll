...
for.body7:                                        ; preds = %for.cond5
  ...
  br i1 %cmp12, label %for.inc24.loopexit, label %for.cond5, !llvm.loop !12
...
for.inc24.loopexit:                               ; preds = %for.body7
  br label %for.inc24

for.inc24:                                        ; preds = %for.inc24.loopexit, %if.then17
  %j.1 = phi i32 [ %add, %if.then17 ], [ %j.0, %for.inc24.loopexit ]
