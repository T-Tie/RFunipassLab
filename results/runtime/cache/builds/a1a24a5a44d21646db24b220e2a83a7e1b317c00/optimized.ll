...
define dso_local noundef i32 @_Z3dayii(i32 noundef %y, i32 noundef %m) #0 {
entry:
  ret i32 0
}
...
for.cond4:                                        ; preds = %for.cond, %for.body6
  %2 = phi i32 [ %.pre, %for.body6 ], [ %0, %for.cond ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body6 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp5 = icmp slt i64 %indvars.iv16, %3
  br i1 %cmp5, label %for.body6, label %for.end14

for.body6:                                        ; preds = %for.cond4
  %puts14 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #8
