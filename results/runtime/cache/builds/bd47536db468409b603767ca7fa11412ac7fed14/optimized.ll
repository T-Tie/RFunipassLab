...
for.inc:                                          ; preds = %if.end, %for.body
  %.str.3.sink.sink = phi ptr [ @.str.1, %for.body ], [ %spec.select, %if.end ]
  %s.1 = phi i32 [ %conv, %for.body ], [ %spec.select1, %if.end ]
  %call13 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink.sink, ptr noundef nonnull %word)
