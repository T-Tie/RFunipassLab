...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec6 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
  %k.0 = phi i32 [ 1, %entry ], [ %k.1, %for.cond1 ]
  %dec = add nsw i32 %dec6, -1
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv8 = phi i64 [ %indvars.iv.next9.pre-phi, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv8
...
for.body3.for.inc18_crit_edge:                    ; preds = %for.body3
  %.pre = add nuw nsw i64 %indvars.iv8, 1
  br label %for.inc18

if.then:                                          ; preds = %for.body3
  %div4 = udiv i32 %3, 10
  %4 = add nuw nsw i64 %indvars.iv8, 1
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv13 = phi i64 [ %0, %for.cond22.preheader ], [ %8, %for.inc28 ]
  %7 = trunc nuw i64 %indvars.iv13 to i32
