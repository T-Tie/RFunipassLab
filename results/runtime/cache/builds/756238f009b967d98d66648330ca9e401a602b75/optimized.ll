...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 15000, ptr noundef nonnull %b) #10
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %sum.0 = phi i32 [ %sum.1, %for.inc ], [ 0, %entry ]
  %j.0 = phi i32 [ %j.1, %for.inc ], [ 0, %entry ]
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #11
  %cmp = icmp ugt i64 %call2, %indvars.iv
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i8], ptr %a, i64 0, i64 %indvars.iv
...
if.end:                                           ; preds = %for.body
  ...
  %arrayidx10 = getelementptr inbounds [100 x [150 x i8]], ptr %b, i64 0, i64 %idxprom7, i64 %idxprom9
...
for.end:                                          ; preds = %for.cond
  ...
  %1 = zext i32 %sum.0 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.inc24, %for.end
  %indvars.iv16 = phi i64 [ %3, %for.inc24 ], [ %1, %for.end ]
  %2 = trunc nuw i64 %indvars.iv16 to i32
...
for.inc24:                                        ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds nuw [100 x [150 x i8]], ptr %b, i64 0, i64 %3
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 15000, ptr noundef nonnull %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 101, ptr noundef nonnull %a) #10
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !13, !invariant.load !8
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !22, !invariant.load !8
...
!13 = !{!14, !6, i64 56}
!14 = !{!"_ZTSSt5ctypeIcE", !15, i64 0, !17, i64 16, !19, i64 24, !20, i64 32, !20, i64 40, !21, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
