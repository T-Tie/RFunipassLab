...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %s_all) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %s_good) #5
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %all) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %good) #5
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %good) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %all) #5
