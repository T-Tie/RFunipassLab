...
for.inc45:                                        ; preds = %for.cond38
  ...
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %9)
