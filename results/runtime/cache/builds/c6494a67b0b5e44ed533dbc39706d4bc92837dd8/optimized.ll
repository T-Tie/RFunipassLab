...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef align 16 %a) #9
...
for.inc:                                          ; preds = %for.cond
  ...
  %3 = load i8, ptr %add.ptr27, align 1, !tbaa !5
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %3)
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %5 = load i8, ptr %add.ptr38, align 1, !tbaa !5
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %5)
...
while.end48:                                      ; preds = %while.cond4
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %a) #10
  ret i32 0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !28
  ret i64 %0
}
...
!16 = distinct !{!16, !9, !10}
!17 = !{!18, !6, i64 56}
!18 = !{!"_ZTSSt5ctypeIcE", !19, i64 0, !20, i64 16, !22, i64 24, !23, i64 32, !23, i64 40, !24, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
!19 = !{!"_ZTSNSt6locale5facetE", !12, i64 8}
...
!33 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !21, i64 0}
!34 = !{!"_ZTSNSt8ios_base6_WordsE", !21, i64 0, !30, i64 8}
!35 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !21, i64 0}
