...
for.cond:                                         ; preds = %for.body, %if.then
  ...
  %s.0 = phi i32 [ 1, %if.then ], [ %mul, %for.body ]
...
for.cond3:                                        ; preds = %for.end32, %if.else
  %i.1 = phi i32 [ 1, %if.else ], [ %inc34, %for.end32 ]
...
for.cond6:                                        ; preds = %for.body8, %for.body5
  %j.0 = phi i32 [ 0, %for.body5 ], [ %inc13, %for.body8 ]
...
for.cond15:                                       ; preds = %for.body17, %for.end14
  %j.1 = phi i32 [ 0, %for.end14 ], [ %add, %for.body17 ]
...
for.cond39:                                       ; preds = %for.body41, %while.end
  %j.2 = phi i32 [ %i.2, %while.end ], [ %dec46, %for.body41 ]
