...
for.body:                                         ; preds = %for.cond
  ...
  %mul9 = fmul double 4.000000e+00, %3
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %2
  %call15 = call double @sqrt(double noundef %5) #8, !tbaa !5
  %add = fadd double %fneg, %call15
  %mul = fmul double 2.000000e+00, %3
  %div = fdiv double %add, %mul
  %call21 = call double @sqrt(double noundef %5) #8, !tbaa !5
  %sub = fsub double %fneg, %call21
  %div23 = fdiv double %sub, %mul
  %call24 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %div, double noundef %div23) #7
  br label %for.inc
...
if.then30:                                        ; preds = %if.else
  %fneg31 = fneg double %2
  %call36 = call double @sqrt(double noundef %5) #8, !tbaa !5
  %add37 = fadd double %fneg31, %call36
  %mul38 = fmul double 2.000000e+00, %3
  %div39 = fdiv double %add37, %mul38
  %call45 = call double @sqrt(double noundef %5) #8, !tbaa !5
  %sub46 = fsub double %fneg31, %call45
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %div39) #7
  br label %for.inc
...
if.then56:                                        ; preds = %if.else50
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %d) #7
  %cmp57 = fcmp une double %2, 0.000000e+00
  br i1 %cmp57, label %if.then58, label %if.end67

if.then58:                                        ; preds = %if.then56
  %fneg59 = fneg double %2
  br label %if.end67

if.end67:                                         ; preds = %if.then58, %if.then56
  %.sink = phi double [ %fneg59, %if.then58 ], [ %2, %if.then56 ]
  %mul65 = fmul double 2.000000e+00, %3
  %div66 = fdiv double %.sink, %mul65
  store double %div66, ptr %d, align 8, !tbaa !9
  %mul70 = fmul double %2, %2
  %neg71 = fneg double %mul70
  %6 = call double @llvm.fmuladd.f64(double %mul9, double %4, double %neg71)
  %call72 = call double @sqrt(double noundef %6) #8, !tbaa !5
  %mul73 = fmul double 2.000000e+00, %3
  %div74 = fdiv double %call72, %mul73
  %7 = load double, ptr %d, align 8, !tbaa !9
  %call75 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %7, double noundef %div74, double noundef %7, double noundef %div74) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %d) #7
  br label %for.inc
