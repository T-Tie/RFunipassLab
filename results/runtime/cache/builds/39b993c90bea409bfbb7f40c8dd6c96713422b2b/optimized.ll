...
for.body:                                         ; preds = %for.cond
  ...
  %call.i7 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %c)
  %call.i8 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i7, ptr noundef nonnull align 8 dereferenceable(8) %d)
  %3 = load double, ptr %d, align 8, !tbaa !5
  %4 = load double, ptr %c, align 8, !tbaa !5
  %div5 = fdiv double %3, %4
  %sub6 = fsub double %div, %div5
  %cmp7 = fcmp ugt double %sub6, 5.000000e-02
  %sub8 = fsub double %div5, %div
  %cmp9 = fcmp ugt double %sub8, 5.000000e-02
...
if.then14:                                        ; preds = %if.else
  %call1.i11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 5)
  br label %if.end20

if.else17:                                        ; preds = %if.else
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 6)
  br label %if.end20

if.end20:                                         ; preds = %if.then14, %if.else17, %if.then
  %vtable.i19 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !11
