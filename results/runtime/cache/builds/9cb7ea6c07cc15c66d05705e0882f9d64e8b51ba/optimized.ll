...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull dereferenceable(41000) %word) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(41000) %word, i8 noundef 0, i64 noundef 41000, i1 noundef false) #11
  call void @llvm.lifetime.start.p0(i64 noundef 81000, ptr noundef nonnull align 16 %newword) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(81000) %newword, i8 noundef 0, i64 noundef 81000, i1 noundef false) #11
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  %6 = phi i32 [ %.pre, %for.inc74 ], [ %0, %for.cond ]
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp3 = icmp slt i64 %indvars.iv79, %7
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv79
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #12
...
if.then:                                          ; preds = %for.body4
  ...
  store i8 32, ptr %arrayidx29, align 1, !tbaa !33
...
if.then44:                                        ; preds = %if.else42
  ...
  store i8 32, ptr %arrayidx56, align 1, !tbaa !33
  br label %for.inc74
...
for.end76:                                        ; preds = %for.cond2
  ...
  store i8 0, ptr %arrayidx81, align 1, !tbaa !33
  %idxprom84 = sext i32 %j.0 to i64
  %arrayidx85 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom77, i64 %idxprom84
  store i8 0, ptr %arrayidx85, align 1, !tbaa !33
  %smax89 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %8 = add i32 %smax89, 1
  %wide.trip.count90 = zext i32 %8 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond91 = icmp eq i64 %indvars.iv85, %wide.trip.count90
  br i1 %exitcond91, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv85
  %call92 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx90) #12
  %conv93 = trunc i64 %call92 to i32
  %sub97 = add i64 %call92, 4294967295
  %vtable.i7 = load ptr, ptr @_ZSt4cout, align 8
  %vbase.offset.ptr.i8 = getelementptr i8, ptr %vtable.i7, i64 -24
  %9 = and i64 %sub97, 4294967295
  %smax = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv85, i64 %9
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv82, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv82, %9
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %10 = load i8, ptr %arrayidx103, align 1, !tbaa !33, !invariant.load !9
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i)
  store i8 %10, ptr %__c.addr.i, align 1, !tbaa !33
  %vbase.offset.i3 = load i64, ptr %vbase.offset.ptr.i8, align 8, !invariant.load !9
  %gep77 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i3
  %11 = load i64, ptr %gep77, align 8, !tbaa !10, !invariant.load !9
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %vtable.i19 = load ptr, ptr %retval.0.i, align 8, !tbaa !35, !invariant.load !9
  %vbase.offset.ptr.i20 = getelementptr i8, ptr %vtable.i19, i64 -24
  %vbase.offset.i21 = load i64, ptr %vbase.offset.ptr.i20, align 8, !invariant.load !9
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv85, i64 %indvars.iv82
  %12 = load i8, ptr %arrayidx110, align 1, !tbaa !33, !invariant.load !9
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i6)
  store i8 %12, ptr %__c.addr.i6, align 1, !tbaa !33
  %vbase.offset.i9 = load i64, ptr %vbase.offset.ptr.i8, align 8, !invariant.load !9
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i9
  %13 = load i64, ptr %gep, align 8, !tbaa !10, !invariant.load !9
  %cmp.not.i12 = icmp eq i64 %13, 0
...
if.end.i16:                                       ; preds = %if.else106
  %call2.i17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %12)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !39, !invariant.load !9
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !42, !invariant.load !9
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !33, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !43, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !44, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !33, !invariant.load !9
  br label %return
...
!39 = !{!40, !41, i64 16}
!40 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !41, i64 8, !41, i64 16, !41, i64 24, !41, i64 32, !41, i64 40, !41, i64 48, !19, i64 56}
!41 = !{!"p1 omnipotent char", !16, i64 0}
!42 = !{!40, !41, i64 24}
!43 = !{!23, !27, i64 240}
!44 = !{!45, !7, i64 56}
!45 = !{!"_ZTSSt5ctypeIcE", !46, i64 0, !47, i64 16, !25, i64 24, !48, i64 32, !48, i64 40, !49, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!46 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!47 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!48 = !{!"p1 int", !16, i64 0}
!49 = !{!"p1 short", !16, i64 0}
