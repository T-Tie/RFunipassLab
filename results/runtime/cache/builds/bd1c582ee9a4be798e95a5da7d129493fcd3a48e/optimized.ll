...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre24, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv9 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next10, %for.inc28 ]
  ...
  br i1 %exitcond14.not, label %for.cond31.preheader, label %for.body12
...
for.cond14.preheader:                             ; preds = %for.body12
  %4 = trunc nuw nsw i64 %indvars.iv9 to i32
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv5 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next6, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv9, i64 %indvars.iv5
  %5 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %cmp21 = icmp eq i32 %5, 0
  %6 = trunc nuw nsw i64 %indvars.iv5 to i32
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv20 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next21, %for.inc52 ]
  ...
  %cmp32 = icmp sgt i64 %indvars.iv20, 0
...
for.cond37.preheader:                             ; preds = %for.body33
  %7 = trunc nsw i64 %indvars.iv.next21 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv16 = phi i64 [ %wide.trip.count, %for.cond37.preheader ], [ %indvars.iv.next17, %for.body39 ]
  ...
  %8 = trunc nuw i64 %indvars.iv16 to i32
  %cmp38 = icmp sgt i32 %8, 0
  br i1 %cmp38, label %for.body39, label %for.inc52

for.body39:                                       ; preds = %for.cond37
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, -1
  %indvars = trunc i64 %indvars.iv.next17 to i32
  %idxprom42 = and i64 %indvars.iv.next17, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next21, i64 %idxprom42
