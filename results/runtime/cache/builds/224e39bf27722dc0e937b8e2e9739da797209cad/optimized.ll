...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000000, ptr noundef nonnull align 16 %board) #7
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre30, %for.inc ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv26 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next27, %for.inc23 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  br i1 %cmp22, label %for.inc26.split.loop.exit32, label %for.inc23

for.inc23:                                        ; preds = %for.body16
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond14, !llvm.loop !14

for.inc26.split.loop.exit32:                      ; preds = %for.body16
  %5 = trunc nuw nsw i64 %indvars.iv26 to i32
  br label %for.inc26

for.inc26:                                        ; preds = %for.cond14, %for.inc26.split.loop.exit32
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit32 ], [ %r1.0, %for.cond14 ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit32 ], [ %c1.0, %for.cond14 ]
  %i.2 = phi i32 [ 9999, %for.inc26.split.loop.exit32 ], [ %i.1, %for.cond14 ]
...
for.end48:                                        ; preds = %for.cond29
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000000, ptr noundef nonnull %board) #8
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !26, !invariant.load !13
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !27, !invariant.load !13
