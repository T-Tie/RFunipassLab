...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef %a) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %a, i8 noundef 0, i64 noundef 40000, i1 noundef false) #6
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef align 16 %b) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %b, i8 noundef 0, i64 noundef 40000, i1 noundef false) #6
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef align 16 %c) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %c, i8 noundef 0, i64 noundef 40000, i1 noundef false) #6
...
for.body93:                                       ; preds = %for.cond90
  ...
  %23 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %idxprom96
  %24 = getelementptr inbounds [100 x i32], ptr %23, i64 0, i64 %idxprom98
  %25 = load i32, ptr %24, align 4, !tbaa !5, !invariant.load !17
  br i1 %cmp95, label %if.then, label %if.else

if.then:                                          ; preds = %for.body93
  %call100 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %25) #7
  br label %for.inc106

if.else:                                          ; preds = %for.body93
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %25) #7
  br label %for.inc106
...
for.end111:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef %c) #7
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef %b) #7
