...
land.lhs.true.i:                                  ; preds = %for.body
  ...
  %2 = load i64, ptr %_M_width.i2.i, align 8, !tbaa !21, !invariant.load !9
  %3 = add i64 %2, -42
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #8
...
for.inc:                                          ; preds = %for.inc.gvnsink.split, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %s) #7
