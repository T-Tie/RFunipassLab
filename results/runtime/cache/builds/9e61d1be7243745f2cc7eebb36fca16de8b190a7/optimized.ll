...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 60000, ptr nonnull %c) #7
  call void @llvm.lifetime.start.p0(i64 600, ptr nonnull %input) #7
...
if.then82:                                        ; preds = %for.body78
  ...
  %call.i.i2 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx84) #7
...
if.end92:                                         ; preds = %for.cond76, %if.then71
  call void @llvm.lifetime.end.p0(i64 600, ptr nonnull %input) #7
  call void @llvm.lifetime.end.p0(i64 60000, ptr nonnull %c) #7
