...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %1 = add i32 %.pr3, -20
  %or.cond8 = icmp ult i32 %1, 30
  br i1 %or.cond8, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %2 = add i32 %.pr4, -10
  %or.cond9 = icmp ult i32 %2, 10
  br i1 %or.cond9, label %while.body22, label %while.end25
