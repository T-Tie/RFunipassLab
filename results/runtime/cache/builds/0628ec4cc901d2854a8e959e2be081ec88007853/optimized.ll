...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count61 = zext i32 %3 to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre67, %for.inc ], [ %0, %for.cond ]
...
for.end29.loopexit:                               ; preds = %for.body15
  ...
  %8 = trunc nuw nsw i64 %indvars.iv53 to i32
  %9 = xor i32 %8, -1
  br label %for.end29

for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.148 = phi i32 [ %7, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %9, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %10 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc48 ], [ %10, %for.end29 ]
