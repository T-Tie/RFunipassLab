...
cond.end:                                         ; preds = %cond.false, %cond.true
  %.sink2 = phi double [ %9, %cond.false ], [ %fneg87, %cond.true ]
  %.sink1 = phi double [ %10, %cond.false ], [ %10, %cond.true ]
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink2, double noundef %.sink1, double noundef %.sink2, double noundef %.sink1)
  br label %for.inc106
