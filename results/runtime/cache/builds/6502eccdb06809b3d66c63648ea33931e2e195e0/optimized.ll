...
for.cond2:                                        ; preds = %for.inc14, %for.body
  %phiofops16 = phi i32 [ %.sink, %for.body ], [ %add.sink, %for.inc14 ]
...
for.cond5:                                        ; preds = %for.inc, %for.body4
  ...
  %cmp6 = icmp sle i32 %k.0, %phiofops16
...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  %.sink9 = phi i32 [ 1, %for.end19 ], [ %inc28, %for.inc27 ]
  %cmp21 = icmp sle i32 %.sink9, 12
  br i1 %cmp21, label %for.inc27, label %for.end29

for.inc27:                                        ; preds = %for.cond20
  %idxprom23 = sext i32 %.sink9 to i64
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %phiofops15 = phi i32 [ 0, %for.end29 ], [ %.sink10, %for.inc48 ]
  %.sink10 = phi i32 [ 1, %for.end29 ], [ %inc49, %for.inc48 ]
  %cmp31 = icmp sle i32 %.sink10, 12
...
for.cond33:                                       ; preds = %for.inc45, %for.body32
  ...
  %cmp35 = icmp sle i32 %j.0, %phiofops15
...
for.inc45:                                        ; preds = %for.cond33
  ...
  %idxprom39 = sext i32 %.sink10 to i64
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %.sink11 = phi i32 [ 1, %for.end50 ], [ %add54, %for.inc79 ]
  %cmp52 = icmp sle i32 %.sink11, 12
  br i1 %cmp52, label %for.body53, label %for.end81

for.body53:                                       ; preds = %for.cond51
  %add54 = add nsw i32 %.sink11, 1
  br label %for.cond55

for.cond55:                                       ; preds = %for.inc76, %for.body53
  %phiofops14 = phi i32 [ %.sink11, %for.body53 ], [ %add54.sink, %for.inc76 ]
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  %k.1 = phi i32 [ %.sink11, %for.body57 ], [ %inc66, %for.inc65 ]
  %sum.1 = phi i32 [ 0, %for.body57 ], [ %add64, %for.inc65 ]
  %cmp60 = icmp sle i32 %k.1, %phiofops14
...
if.then70:                                        ; preds = %for.end67
  %idxprom71 = sext i32 %.sink11 to i64
...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %.sink12 = phi i32 [ 1, %for.end81 ], [ %inc90, %for.inc89 ]
  %cmp83 = icmp sle i32 %.sink12, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %idxprom85 = sext i32 %.sink12 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %phiofops = phi i32 [ 0, %for.end91 ], [ %.sink13, %for.inc110 ]
  %.sink13 = phi i32 [ 1, %for.end91 ], [ %inc111, %for.inc110 ]
  %cmp93 = icmp sle i32 %.sink13, 12
...
for.cond95:                                       ; preds = %for.inc107, %for.body94
  ...
  %cmp97 = icmp sle i32 %j.1, %phiofops
...
for.inc107:                                       ; preds = %for.cond95
  ...
  %idxprom101 = sext i32 %.sink13 to i64
