...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv36 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next37, %for.inc14 ]
  %exitcond.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond.not, label %for.cond17, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv36
  store i32 0, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv36
  br label %while.cond
...
while.cond:                                       ; preds = %while.body, %for.body4
  ...
  %7 = load i8, ptr %q.0, align 1, !tbaa !35, !invariant.load !11
...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  %8 = phi i32 [ %.pre, %for.inc47 ], [ %0, %for.cond2 ]
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc47 ], [ 0, %for.cond2 ]
  %s.0 = phi i32 [ %add46, %for.inc47 ], [ 0, %for.cond2 ]
  %9 = sext i32 %8 to i64
  %cmp18 = icmp slt i64 %indvars.iv40, %9
  br i1 %cmp18, label %for.body19, label %for.end49

for.body19:                                       ; preds = %for.cond17
  %cmp20 = icmp sgt i32 %s.0, 0
  %arrayidx22 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv40
...
land.lhs.true:                                    ; preds = %for.body19
  ...
  br i1 %cmp23, label %if.end35.thread51, label %if.end35.thread

if.end35.thread51:                                ; preds = %land.lhs.true
...
if.end35.thread:                                  ; preds = %land.lhs.true, %if.end
  ...
  %gep34 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i19
  %11 = load i64, ptr %gep34, align 8, !tbaa !12
  %cmp.not.i = icmp eq i64 %11, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.end35.thread
...
if.end.i:                                         ; preds = %if.end35.thread
...
for.inc47.sink.split:                             ; preds = %if.end35, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end35.thread51
  %phiofops.ph = phi i32 [ %add, %if.end35.thread51 ], [ %10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %10, %if.end35 ]
  %arrayidx26 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv40
  %call.i.i11 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx26) #8
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx26, i64 noundef %call.i.i11)
  br label %for.inc47
