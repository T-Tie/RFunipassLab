...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %word) #9
...
while.body:                                       ; preds = %while.cond
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef nonnull align 16 dereferenceable(50) %word)
  %1 = load i32, ptr %count, align 4, !tbaa !5
  %cmp = icmp eq i32 %1, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(50) %word)
  br label %if.end31.gvnsink.split

if.else:                                          ; preds = %while.body
  %call7 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #11
  %add = add i64 %call7, 1
...
if.then12:                                        ; preds = %if.else
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call13, ptr noundef nonnull align 16 dereferenceable(50) %word)
  br label %if.end31.gvnsink.split
...
if.then21:                                        ; preds = %if.else19
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext 32)
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call22, ptr noundef nonnull align 16 dereferenceable(50) %word)
...
if.else26:                                        ; preds = %if.else19
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext 32)
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call27, ptr noundef nonnull align 16 dereferenceable(50) %word)
  br label %if.end31

if.end31.gvnsink.split:                           ; preds = %if.then, %if.then12
  %call17 = call i64 @strlen(ptr noundef %word) #11
  %conv18 = trunc i64 %call17 to i32
  store i32 %conv18, ptr %count, align 4, !tbaa !5
  br label %if.end31

if.end31:                                         ; preds = %if.end31.gvnsink.split, %if.else26, %if.then21
  br label %while.cond, !llvm.loop !9

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %count) #10
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %word) #10
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !16
  ret i32 %0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !41
  ret i64 %0
}
