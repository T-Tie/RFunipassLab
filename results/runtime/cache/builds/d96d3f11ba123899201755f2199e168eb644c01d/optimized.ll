...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr nonnull %b) #8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %w) #8
...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %3 = add i64 %2, -1001
  %or.cond.i25 = icmp ult i64 %3, -1000
  %or.cond59 = select i1 %call16.i21, i1 %or.cond.i25, i1 false
  br i1 %or.cond59, label %if.then19.i26, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42: ; preds = %if.then6.i11, %if.then19.i26, %if.then28.i37
...
for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load i8, ptr %arrayidx, align 1, !tbaa !21
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %5 = load i8, ptr %arrayidx28, align 1, !tbaa !21
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count
  br i1 %exitcond65.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv61
  %6 = load i8, ptr %arrayidx54, align 1, !tbaa !21
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv61
  %7 = load i8, ptr %arrayidx57, align 1, !tbaa !21
  %cmp59 = icmp eq i8 %6, %7
  %inc61 = zext i1 %cmp59 to i32
  %spec.select = add nuw nsw i32 %inc61, %count.0
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  br label %for.cond50, !llvm.loop !25
...
for.end65:                                        ; preds = %for.cond50
  ...
  %8 = load double, ptr %w, align 8, !tbaa !26
  %cmp68 = fcmp ult double %div, %8
  %.str.3..str.2 = select i1 %cmp68, ptr @.str.3, ptr @.str.2
  br label %if.end75

if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ], [ %.str.3..str.2, %for.end65 ]
  %call47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.1.sink)
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %w) #8
  call void @llvm.lifetime.end.p0(i64 1000, ptr nonnull %b) #8
