...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  %indvars.iv29 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next30, %for.inc28 ]
  ...
  br i1 %exitcond34.not, label %for.cond31.preheader, label %for.body12
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv25 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next26, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv25
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc52
  %indvars.iv40 = phi i64 [ %1, %for.cond31.preheader ], [ %indvars.iv.next41, %for.inc52 ]
...
for.cond37.preheader:                             ; preds = %for.body33
  %7 = trunc nsw i64 %indvars.iv.next41 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv36 = phi i64 [ %wide.trip.count, %for.cond37.preheader ], [ %indvars.iv.next37, %for.body39 ]
  ...
  %8 = trunc nuw i64 %indvars.iv36 to i32
  %cmp38 = icmp sgt i32 %8, 0
  br i1 %cmp38, label %for.body39, label %for.inc52

for.body39:                                       ; preds = %for.cond37
  %indvars.iv.next37 = add nsw i64 %indvars.iv36, -1
  %indvars = trunc i64 %indvars.iv.next37 to i32
  %idxprom42 = and i64 %indvars.iv.next37, 4294967295
  %arrayidx43 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next41, i64 %idxprom42
