...
for.inc36:                                        ; preds = %if.then27, %if.else32
  %.sink28 = phi i32 [ %10, %if.else32 ], [ %1, %if.then27 ]
  %sub33 = sub nsw i32 %4, %.sink28
...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  %.sink13 = phi i32 [ 0, %for.end41 ], [ %inc53, %for.inc52 ]
  %cmp43 = icmp slt i32 %.sink13, 1000
  %11 = load i32, ptr %max, align 4, !tbaa !5
  br i1 %cmp43, label %for.body44, label %for.end54

for.body44:                                       ; preds = %for.cond42
  %idxprom45 = sext i32 %.sink13 to i64
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %.sink14 = phi i32 [ 0, %if.else58 ], [ %inc81, %for.inc80 ]
  %cmp61 = icmp slt i32 %.sink14, 1000
  br i1 %cmp61, label %for.body62, label %if.end83

for.body62:                                       ; preds = %for.cond60
  %idxprom63 = sext i32 %.sink14 to i64
