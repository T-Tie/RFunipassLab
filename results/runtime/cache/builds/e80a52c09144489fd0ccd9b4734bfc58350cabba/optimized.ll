...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 302, ptr noundef nonnull align 16 %ss) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(302) %ss, i8 noundef 0, i64 noundef 302, i1 noundef false) #8
  store i8 48, ptr %ss, align 16
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 16 %ss)
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %ss) #9
...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc23 ], [ 0, %entry ]
  %s.0 = phi i32 [ %s.1, %for.inc23 ], [ 0, %entry ]
  %exitcond18.not = icmp eq i64 %indvars.iv15, 28
  br i1 %exitcond18.not, label %for.end25, label %for.cond3.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %arrayidx9 = getelementptr inbounds nuw [27 x i8], ptr @__const.main.zimu, i64 0, i64 %indvars.iv15
  br label %for.cond3
...
if.end22:                                         ; preds = %for.cond.cleanup5
  ...
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %conv16, i32 noundef %count.1) #10
  br label %for.inc23
...
if.then27:                                        ; preds = %for.end25
  %call28 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2) #10
  br label %if.end29

if.end29:                                         ; preds = %if.then27, %for.end25
  call void @llvm.lifetime.end.p0(i64 noundef 302, ptr noundef nonnull %ss) #10
  ret i32 0
}
