...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax45 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond17.not, label %for.cond28, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc22 ], [ 0, %for.cond11.preheader ]
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc63 ], [ 0, %for.cond ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc60 ], [ 0, %for.cond48.preheader ]
...
for.cond69:                                       ; preds = %for.end65, %for.inc125
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc125 ], [ 0, %for.end65 ]
