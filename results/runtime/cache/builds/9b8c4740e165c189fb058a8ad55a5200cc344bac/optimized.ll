...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef align 16 %b) #7
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef %c) #7
  ...
  %call8 = call i64 @strlen(ptr noundef %b) #8
  %conv9 = trunc i64 %call8 to i32
  %call11 = call i64 @strlen(ptr noundef %c) #8
...
for.cond26:                                       ; preds = %if.end40, %if.then25
  ...
  %3 = load i32, ptr %j, align 4, !tbaa !13
...
for.cond43:                                       ; preds = %if.end54, %if.then42
  %6 = load i32, ptr %j, align 4, !tbaa !13
...
if.end50.thread:                                  ; preds = %for.body45
  ...
  call void @_Z4leftPcii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(256) %a, i32 noundef %conv, i32 noundef %add49) #9
  br label %if.end54

if.end50:                                         ; preds = %for.body45
  br i1 %phiofops4, label %if.then52, label %if.end54

if.then52:                                        ; preds = %if.end50
  call void @_Z5rightPcii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(256) %a, i32 noundef %conv, i32 noundef %0) #9
  br label %if.end54
...
for.cond58:                                       ; preds = %for.body60, %for.end57
  %7 = load i32, ptr %j, align 4, !tbaa !13
...
for.body60:                                       ; preds = %for.cond58
  ...
  %8 = load i8, ptr %arrayidx63, align 1, !tbaa !5, !invariant.load !8
  %add64 = add nsw i32 %0, %7
...
for.end75:                                        ; preds = %for.cond58, %for.cond
  %call77 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef nonnull align 16 dereferenceable(256) %a) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %j) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %i) #9
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %c) #9
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef captures(none) %a) #9
  ret i32 0
}
