...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond20 = icmp eq i64 %indvars.iv, %wide.trip.count19
  br i1 %exitcond20, label %for.end20, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv15 = phi i64 [ %indvars.iv, %for.cond1.preheader ], [ %indvars.iv.next16, %for.body3 ]
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv15
