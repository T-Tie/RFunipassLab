...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %k) #8
...
for.inc:                                          ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv19 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next20, %for.body4 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv19
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !12
  %spec.select = call i32 @llvm.smax.i32(i32 %2, i32 %Max.0)
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond2, !llvm.loop !13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %indvars.iv23 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next24, %for.body15 ]
  %Max2.0 = phi i32 [ 0, %for.cond13.preheader ], [ %Max2.1, %for.body15 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond27.not, label %for.end28, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw [100 x i32], ptr %k, i64 0, i64 %indvars.iv23
  %3 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !12
  %cmp18 = icmp slt i32 %3, %Max.0
  %4 = call i32 @llvm.smax.i32(i32 %3, i32 %Max2.0)
  %Max2.1 = select i1 %cmp18, i32 %4, i32 %Max2.0
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond13, !llvm.loop !14

for.end28:                                        ; preds = %for.cond13
  call fastcc void @outlined_ir_func_0(i32 noundef %Max.0)
  call fastcc void @outlined_ir_func_0(i32 noundef %Max2.0)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #9
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %k) #9
  ret i32 0
}
...
define internal fastcc void @outlined_ir_func_0(i32 noundef %0) unnamed_addr #6 {
for.end28_after_outline.exitStub:
  %call29 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %0)
  %call30 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call29, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
