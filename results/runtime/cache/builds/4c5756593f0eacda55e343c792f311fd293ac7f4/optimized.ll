...
if.then15:                                        ; preds = %if.end
  ...
  %.pre13 = load i32, ptr %m2, align 4, !tbaa !5
  br label %if.end20
...
if.end20:                                         ; preds = %if.else, %if.then18, %if.then15
  %8 = phi i32 [ %5, %if.else ], [ %3, %if.then18 ], [ %.pre13, %if.then15 ]
  %9 = phi i32 [ %3, %if.else ], [ %5, %if.then18 ], [ %.pre, %if.then15 ]
  %10 = sext i32 %9 to i64
  %smax = call i32 @llvm.smax.i32(i32 %9, i32 %8)
  %wide.trip.count = sext i32 %smax to i64
  br label %for.cond21

for.cond21:                                       ; preds = %for.body23, %if.end20
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body23 ], [ %10, %if.end20 ]
  %d.0 = phi i32 [ %add, %for.body23 ], [ 0, %if.end20 ]
