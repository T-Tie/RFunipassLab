...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv21 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next22, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv21
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  ...
  %indvars45 = trunc i64 %indvars.iv40 to i32
  %5 = add nsw i64 %indvars.iv40, -1
  %cmp15 = icmp sgt i32 %indvars45, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond32.not = icmp eq i64 %indvars.iv25, %5
  br i1 %exitcond32.not, label %for.cond14, label %for.body19, !llvm.loop !14

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv25
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next26
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv33, %10
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv33
