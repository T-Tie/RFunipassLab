...
for.end32:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %call2.loc) #9
  ...
  %call36 = call noalias ptr @malloc(i64 noundef %mul35) #10
  %2 = load i32, ptr %x2, align 4
  %3 = load i32, ptr %y1, align 4
  %4 = sext i32 %1 to i64
  %smax = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
  %smax48 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  %5 = sext i32 %3 to i64
  %smax56 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc74 ], [ 0, %for.end32 ]
  %exitcond58.not = icmp eq i64 %indvars.iv51, %wide.trip.count57
  br i1 %exitcond58.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %6 = mul nsw i64 %indvars.iv51, %4
  %7 = mul nsw i64 %indvars.iv51, %5
  %8 = getelementptr i32, ptr %call36, i64 %6
  %9 = getelementptr i32, ptr %call2.reload, i64 %7
  br label %for.cond40

for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv44 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next45, %for.inc71 ]
  %exitcond50.not = icmp eq i64 %indvars.iv44, %wide.trip.count49
  br i1 %exitcond50.not, label %for.inc74, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %8, i64 %indvars.iv44
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15.reload, i64 %indvars.iv44
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc68, %for.body42
  %10 = phi i32 [ %add63, %for.inc68 ], [ 0, %for.body42 ]
...
for.inc68:                                        ; preds = %for.cond47
  %arrayidx57 = getelementptr i32, ptr %9, i64 %indvars.iv
  %11 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !9
  %12 = mul nsw i64 %indvars.iv, %4
  %gep = getelementptr i32, ptr %invariant.gep, i64 %12
  %13 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !9
  %mul62 = mul nsw i32 %13, %11
  %add63 = add nsw i32 %mul62, %10
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  %14 = phi i32 [ %16, %for.inc98 ], [ %1, %for.cond37 ]
  %15 = phi i32 [ %.pre, %for.inc98 ], [ %0, %for.cond37 ]
  %i.3 = phi i32 [ %inc99, %for.inc98 ], [ 0, %for.cond37 ]
  %cmp78 = icmp slt i32 %i.3, %15
  br i1 %cmp78, label %for.cond80, label %for.end100

for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %16 = phi i32 [ %.pre59, %for.inc95 ], [ %14, %for.cond77 ]
  %j.3 = phi i32 [ %inc96, %for.inc95 ], [ 0, %for.cond77 ]
  %cmp81 = icmp slt i32 %j.3, %16
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %16, %i.3
  %add84 = add nsw i32 %mul83, %j.3
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %17 = load i32, ptr %arrayidx86, align 4, !tbaa !5
  %call87 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %17) #11
...
if.then:                                          ; preds = %for.body82
  %putchar = call i32 @putchar(i32 noundef 32) #11
  %.pre60 = load i32, ptr %y2, align 4, !tbaa !5
  %.pre62 = add nsw i32 %.pre60, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre62, %if.then ], [ %sub, %for.body82 ]
  %19 = phi i32 [ %.pre60, %if.then ], [ %18, %for.body82 ]
  %cmp91 = icmp eq i32 %j.3, %sub90.pre-phi
  br i1 %cmp91, label %if.then92, label %for.inc95

if.then92:                                        ; preds = %if.end
  %putchar39 = call i32 @putchar(i32 noundef 10) #11
  %.pre59.pre = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.inc95

for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre59 = phi i32 [ %19, %if.end ], [ %.pre59.pre, %if.then92 ]
...
for.end100:                                       ; preds = %for.cond77
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %y2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %y1) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %x2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %x1) #11
  ret i32 0
}
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %2) unnamed_addr #7 {
entry_to_outline:
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1)
