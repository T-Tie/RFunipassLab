...
define dso_local noundef i32 @_Z2jzPA100_ii(ptr nofree noundef captures(none) %a, i32 noundef %k) #0 {
entry:
...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv100 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc31 ], [ 0, %for.cond ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %indvars.iv100
  br i1 %exitcond58.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv54
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv100
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv54, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv49 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next50, %for.inc28 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %indvars.iv100
  br i1 %exitcond53.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv54, i64 %indvars.iv49
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %indvars.iv100
  br i1 %exitcond78.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %indvars.iv100
  br i1 %exitcond63.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv59, i64 %indvars.iv74
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv74
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select43, %for.body57 ], [ %6, %if.then51 ]
  %exitcond68.not = icmp eq i64 %indvars.iv64, %indvars.iv100
  br i1 %exitcond68.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv64, i64 %indvars.iv74
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %spec.select43 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  br label %for.cond55, !llvm.loop !15

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv69 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next70, %for.inc84 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %indvars.iv100
  br i1 %exitcond73.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv69, i64 %indvars.iv74
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %indvars.iv100
  br i1 %exitcond89.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %indvars.iv100
  br i1 %exitcond84.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv85, i64 %indvars.iv79
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv79, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv85, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %indvars.iv100
  br i1 %exitcond99.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep45 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv95
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv90 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next91, %for.inc129 ]
  %exitcond94.not = icmp eq i64 %indvars.iv90, %indvars.iv100
  br i1 %exitcond94.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv90, i64 %indvars.iv95
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep46 = getelementptr [100 x i32], ptr %invariant.gep45, i64 %indvars.iv90
  store i32 %12, ptr %gep46, align 4, !tbaa !5
...
for.cond4:                                        ; preds = %for.cond1, %for.inc
  %4 = phi i32 [ %.pre22, %for.inc ], [ %2, %for.cond1 ]
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  %6 = phi i32 [ %.pre21, %for.inc26 ], [ %0, %for.cond ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc26 ], [ 0, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp20 = icmp slt i64 %indvars.iv18, %7
...
for.inc26:                                        ; preds = %for.cond19
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call24, i8 noundef signext %call.i9)
