...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count39 = zext nneg i32 %smax33 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond40.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select, %for.body15 ], [ %l1.0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select19, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv36, i64 %indvars.iv26
  ...
  %spec.select19 = call i32 @llvm.smax.i32(i32 %5, i32 %max.0)
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond13, !llvm.loop !13

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv29 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next30, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %exitcond35.not = icmp eq i64 %indvars.iv29, %wide.trip.count39
  br i1 %exitcond35.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv29, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %idxprom40
  %7 = load i32, ptr %arrayidx41, align 4, !tbaa !5
  %cmp42 = icmp slt i32 %7, %min.1
  %8 = trunc nuw nsw i64 %indvars.iv29 to i32
  %spec.select20 = select i1 %cmp42, i32 %8, i32 %l2.1
  %spec.select21 = call i32 @llvm.smin.i32(i32 %7, i32 %min.1)
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select20, %if.end37 ]
  %min.3 = phi i32 [ %9, %if.end37.thread ], [ %spec.select21, %if.end37 ]
