...
if.end50:                                         ; preds = %if.then47, %for.body45
  br i1 %phiofops2, label %if.then52, label %if.end54

if.then52:                                        ; preds = %if.end50
  call void @_Z5rightPcii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(256) %a, i32 noundef %conv, i32 noundef %i.0) #8
  br label %if.end54
