...
while.cond:                                       ; preds = %while.body, %for.end35
  ...
  %4 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !15
...
for.cond39:                                       ; preds = %for.inc45, %while.end
  %.sink = phi i32 [ %i.2, %while.end ], [ %dec46, %for.inc45 ]
...
for.inc45:                                        ; preds = %for.cond39
  ...
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %5)
