...
land.lhs.true.i15:                                ; preds = %while.body
  ...
  %3 = load i64, ptr %_M_width.i4.i16, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -42
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %while.body, %land.lhs.true.i15, %if.then19.i20, %if.then28.i27
