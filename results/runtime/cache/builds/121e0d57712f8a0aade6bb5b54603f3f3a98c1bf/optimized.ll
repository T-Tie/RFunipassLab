...
for.cond:                                         ; preds = %if.end, %entry.split
  %m.0 = phi i32 [ 0, %entry.split ], [ %inc, %if.end ]
  %i.0 = phi i32 [ 1, %entry.split ], [ %inc34, %if.end ]
...
for.cond35:                                       ; preds = %for.body37, %for.end
  %i.1 = phi i32 [ 1, %for.end ], [ %inc42, %for.body37 ]
...
for.body37:                                       ; preds = %for.cond35
  ...
  %call40 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %6) #5
