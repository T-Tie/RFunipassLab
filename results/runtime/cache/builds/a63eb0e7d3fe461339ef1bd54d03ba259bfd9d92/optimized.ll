...
for.cond:                                         ; preds = %if.end25, %entry
  %indvars.iv41 = phi i32 [ %indvars.iv.next42, %if.end25 ], [ %conv, %entry ]
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.body14
  %indvars.iv27 = phi i64 [ %indvars.iv, %for.cond12.preheader ], [ %indvars.iv.next28, %for.body14 ]
  %k.2 = phi i32 [ 1, %for.cond12.preheader ], [ %spec.select, %for.body14 ]
  %cmp13 = icmp slt i64 %indvars.iv27, %3
  br i1 %cmp13, label %for.body14, label %for.end

for.body14:                                       ; preds = %for.cond12
  %4 = sub nuw nsw i64 %indvars.iv27, %indvars.iv
  %arrayidx16 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx16, align 1, !tbaa !5, !invariant.load !8
  %arrayidx19 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv27
...
for.cond31.preheader:                             ; preds = %for.end
  %wide.trip.count39 = and i64 %indvars.iv, 4294967295
  br label %for.cond31
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  ...
  br i1 %exitcond40.not, label %for.end40, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv33
  %7 = load i8, ptr %arrayidx35, align 1, !tbaa !5, !invariant.load !8
  %conv36 = sext i8 %7 to i32
  %putchar24 = call i32 @putchar(i32 noundef %conv36) #8
...
for.end40:                                        ; preds = %for.cond31
  ...
  %8 = sext i32 %indvars.iv41 to i64
  %sext47 = shl i64 %call6, 32
  %9 = ashr exact i64 %sext47, 32
  br label %for.cond44

for.cond44:                                       ; preds = %for.body46, %for.end40
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body46 ], [ %8, %for.end40 ]
  %cmp45 = icmp slt i64 %indvars.iv44, %9
  br i1 %cmp45, label %for.body46, label %if.end56

for.body46:                                       ; preds = %for.cond44
  %arrayidx48 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv44
