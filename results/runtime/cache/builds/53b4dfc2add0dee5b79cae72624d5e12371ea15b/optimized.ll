...
if.else75:                                        ; preds = %for.body68
  ...
  %spec.select10 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select10, %if.else75 ]
