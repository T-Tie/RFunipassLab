...
for.cond:                                         ; preds = %if.else, %entry
  %s.0 = phi i32 [ 0, %entry ], [ %inc34, %if.else ]
...
for.cond38:                                       ; preds = %for.end71, %for.end37
  %i.1 = phi i32 [ 0, %for.end37 ], [ %inc74, %for.end71 ]
...
for.cond41:                                       ; preds = %for.body43, %for.body40
  %j.1 = phi i32 [ 0, %for.body40 ], [ %inc70, %for.body43 ]
  %q.1 = phi i32 [ 0, %for.body40 ], [ %sub, %for.body43 ]
