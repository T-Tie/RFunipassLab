...
define dso_local void @_Z5rightPcii(ptr noundef %a, i32 noundef %l, i32 noundef %t) local_unnamed_addr #0 {
entry:
  br label %for.cond
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local void @_Z4leftPcii(ptr noundef %a, i32 noundef %l, i32 noundef %t) local_unnamed_addr #0 {
entry:
  br label %for.cond
...
if.end:                                           ; preds = %if.else15, %if.then14
  %s.1 = phi i32 [ 0, %if.then14 ], [ -1, %if.else15 ]
  %r.1 = phi i32 [ 0, %if.then14 ], [ %sub16, %if.else15 ]
  br label %if.end17

if.end17:                                         ; preds = %if.end, %if.then
  %phiofops = phi i1 [ false, %if.end ], [ true, %if.then ]
  %s.0 = phi i32 [ 1, %if.then ], [ %s.1, %if.end ]
  %r.0 = phi i32 [ %sub, %if.then ], [ %r.1, %if.end ]
  br label %for.cond
...
if.then47:                                        ; preds = %for.body45
  ...
  call void @_Z4leftPcii(ptr noundef %a, i32 noundef %conv, i32 noundef %add49)
  br label %if.end50
...
if.then52:                                        ; preds = %if.end50
  call void @_Z5rightPcii(ptr noundef %a, i32 noundef %conv, i32 noundef %i.0)
  br label %if.end54
