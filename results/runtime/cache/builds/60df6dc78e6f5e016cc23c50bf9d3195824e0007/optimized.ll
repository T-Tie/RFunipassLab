...
if.then:                                          ; preds = %for.body93
  ...
  %call100 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %12)
  br label %for.inc106
...
if.else:                                          ; preds = %for.body93
  ...
  %13 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %13)
  br label %for.inc106
