...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 300, ptr %s) #11
  call void @llvm.lifetime.start.p0(i64 300, ptr %rep) #11
  call void @llvm.lifetime.start.p0(i64 300, ptr %sub) #11
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %s)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) %call, ptr noundef %sub)
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) %call2, ptr noundef %rep)
...
if.then:                                          ; preds = %entry
  ...
  %call12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %s)
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call12, ptr noundef %rep)
...
if.else:                                          ; preds = %entry
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %s)
...
if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.end.p0(i64 300, ptr %sub) #11
  call void @llvm.lifetime.end.p0(i64 300, ptr %rep) #11
  call void @llvm.lifetime.end.p0(i64 300, ptr %s) #11
  ret i32 0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !12
  store i64 %__wide, ptr %_M_width, align 8, !tbaa !12
  ret i64 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !23
  ret ptr %0
}
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !10
  %1 = load i32, ptr %__c2, align 4, !tbaa !10
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !32
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !35
  ret ptr %0
}
...
!11 = !{!"int", !6, i64 0}
!12 = !{!13, !14, i64 16}
!13 = !{!"_ZTSSt8ios_base", !14, i64 8, !14, i64 16, !15, i64 24, !16, i64 28, !16, i64 32, !17, i64 40, !19, i64 48, !6, i64 64, !11, i64 192, !20, i64 200, !21, i64 208}
!14 = !{!"long", !6, i64 0}
...
!23 = !{!24, !27, i64 232}
!24 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !13, i64 0, !25, i64 216, !6, i64 224, !26, i64 225, !27, i64 232, !28, i64 240, !29, i64 248, !30, i64 256}
!25 = !{!"p1 _ZTSSo", !18, i64 0}
!26 = !{!"bool", !6, i64 0}
!27 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !18, i64 0}
!28 = !{!"p1 _ZTSSt5ctypeIcE", !18, i64 0}
!29 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !18, i64 0}
!30 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !18, i64 0}
!31 = !{!13, !16, i64 32}
!32 = !{!33, !34, i64 16}
!33 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !34, i64 8, !34, i64 16, !34, i64 24, !34, i64 32, !34, i64 40, !34, i64 48, !21, i64 56}
!34 = !{!"p1 omnipotent char", !18, i64 0}
!35 = !{!33, !34, i64 24}
!36 = !{!24, !28, i64 240}
!37 = !{!38, !6, i64 56}
!38 = !{!"_ZTSSt5ctypeIcE", !39, i64 0, !40, i64 16, !26, i64 24, !41, i64 32, !41, i64 40, !42, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
!39 = !{!"_ZTSNSt6locale5facetE", !11, i64 8}
!40 = !{!"p1 _ZTS15__locale_struct", !18, i64 0}
!41 = !{!"p1 int", !18, i64 0}
!42 = !{!"p1 short", !18, i64 0}
