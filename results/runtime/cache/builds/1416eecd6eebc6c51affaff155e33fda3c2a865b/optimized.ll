...
if.then:                                          ; preds = %entry
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str.1) #12
  br label %if.end75
...
land.lhs.true:                                    ; preds = %lor.lhs.false22, %lor.lhs.false17, %lor.lhs.false, %for.body
  ...
  %2 = load i8, ptr %arrayidx28, align 1, !tbaa !9, !invariant.load !10
...
for.body52:                                       ; preds = %for.cond50
  ...
  %5 = load i8, ptr %arrayidx54, align 1, !tbaa !9, !invariant.load !10
  %conv55 = sext i8 %5 to i32
  %arrayidx57 = getelementptr inbounds [1000 x i8], ptr %b, i64 0, i64 %idxprom53
  %6 = load i8, ptr %arrayidx57, align 1, !tbaa !9, !invariant.load !10
...
for.end65:                                        ; preds = %for.cond50
  ...
  %9 = load double, ptr %w, align 8, !tbaa !15
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !17, !invariant.load !10
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !17, !invariant.load !10
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !19, !invariant.load !10
