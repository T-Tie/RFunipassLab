...
while.end:                                        ; preds = %while.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #8
...
while.body:                                       ; preds = %while.cond
  ...
  %0 = load i8, ptr %sPtr.0.ptr, align 1, !tbaa !14
...
while.cond17:                                     ; preds = %while.cond8, %while.cond17
  ...
  br i1 %cmp18, label %while.cond17, label %while.cond22, !llvm.loop !17
...
while.body26:                                     ; preds = %while.cond22
  ...
  store i8 %conv29, ptr %sPtr.1, align 1, !tbaa !14
  br label %while.cond22, !llvm.loop !18

while.end31:                                      ; preds = %while.cond22
  store i8 0, ptr %sPtr.1, align 1, !tbaa !14
