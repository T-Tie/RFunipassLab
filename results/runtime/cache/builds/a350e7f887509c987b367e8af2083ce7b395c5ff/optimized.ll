...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv12 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next13, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv12
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv31 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %indvars36 = trunc i64 %indvars.iv31 to i32
  %5 = add nsw i64 %indvars.iv31, -1
  %cmp15 = icmp sgt i32 %indvars36, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond23.not = icmp eq i64 %indvars.iv16, %5
  br i1 %exitcond23.not, label %for.cond14, label %for.body19, !llvm.loop !13

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv16
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next17
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv24, %10
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv24
