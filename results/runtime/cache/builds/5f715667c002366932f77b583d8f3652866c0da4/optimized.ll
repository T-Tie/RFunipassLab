...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv37, %1
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv43, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv40, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv43, i64 %indvars.iv40
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax49 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax54 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax55 = call i32 @llvm.smax.i32(i32 %smax54, i32 0)
...
for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond57.not = icmp eq i64 %indvars.iv50, %wide.trip.count56
  br i1 %exitcond57.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax61 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count62 = zext nneg i32 %smax61 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv50, i64 %indvars.iv46
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv71 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next72, %for.inc83 ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %wide.trip.count56
  br i1 %exitcond75.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond70.not = icmp eq i64 %indvars.iv64, %wide.trip.count
  br i1 %exitcond70.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv71, i64 %indvars.iv64
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv58 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next59, %for.inc77 ]
...
for.inc77:                                        ; preds = %for.cond58
  ...
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv71, i64 %indvars.iv58
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv58, i64 %indvars.iv64
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %wide.trip.count56
  br i1 %exitcond80.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv76
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax54 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond92.not = icmp eq i64 %indvars.iv88, %wide.trip.count56
  br i1 %exitcond92.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv88
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax54, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax54, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv81 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next82, %for.inc112 ]
  %exitcond87.not = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond87.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv88, i64 %indvars.iv81
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv105 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre.pre-phi, %for.inc198 ]
  %exitcond112.not = icmp eq i64 %indvars.iv105, %wide.trip.count56
  br i1 %exitcond112.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv105
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv105, 0
  %or.cond32 = and i1 %or.cond, %cmp128
  br i1 %or.cond32, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv105
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax96 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
  %wide.trip.count97 = zext nneg i32 %smax96 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond98.not = icmp eq i64 %indvars.iv93, %wide.trip.count97
  br i1 %exitcond98.not, label %if.end178.loopexit115, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv105, i64 %indvars.iv93
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv105, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax102 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
  %wide.trip.count103 = zext nneg i32 %smax102 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond104.not = icmp eq i64 %indvars.iv99, %wide.trip.count103
  br i1 %exitcond104.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv105, i64 %indvars.iv99
...
if.end178.loopexit115:                            ; preds = %for.cond137
  %.pre116 = add nuw nsw i64 %indvars.iv105, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit115
  %.pre.pre-phi = phi i64 [ %.pre116, %if.end178.loopexit115 ], [ %20, %for.cond158 ]
  %cmp180.not = icmp eq i64 %indvars.iv105, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv105, 2
