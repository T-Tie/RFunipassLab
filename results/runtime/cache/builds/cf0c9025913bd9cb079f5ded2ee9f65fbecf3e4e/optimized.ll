...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc56
  ...
  br i1 %exitcond86.not, label %for.cond59, label %for.cond22.preheader
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc53
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc53 ], [ 0, %for.cond42.preheader ]
...
for.cond59:                                       ; preds = %for.cond18, %for.inc99
  %indvars.iv97 = phi i64 [ %indvars.iv.next98, %for.inc99 ], [ 0, %for.cond18 ]
...
for.cond85:                                       ; preds = %for.cond85.preheader, %for.inc96
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %for.inc96 ], [ 0, %for.cond85.preheader ]
...
for.inc166:                                       ; preds = %for.cond15
  ...
  %call165 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call164, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
