...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax31 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax36 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax37 = call i32 @llvm.smax.i32(i32 %smax36, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax43 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count51 = zext nneg i32 %smax31 to i64
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count68 = zext nneg i32 %smax31 to i64
  br label %for.cond96
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax78 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax84 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
