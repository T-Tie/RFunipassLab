...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 301, ptr %str) #3
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %str)
  br label %for.cond
...
if.end:                                           ; preds = %if.then18, %land.lhs.true13, %if.else
  %a.2 = phi i32 [ %inc19, %if.then18 ], [ %a.0, %land.lhs.true13 ], [ %a.0, %if.else ]
  br label %if.end20

if.end20:                                         ; preds = %if.end, %if.then
  %a.1 = phi i32 [ %inc, %if.then ], [ %a.2, %if.end ]
  br label %for.inc
...
if.end83:                                         ; preds = %for.end82, %if.then23
  call void @llvm.lifetime.end.p0(i64 301, ptr %str) #3
  ret i32 0
}
