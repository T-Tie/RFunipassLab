...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20, ptr noundef nonnull align 16 %sz) #5
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %sz1) #5
...
while.cond:                                       ; preds = %if.end, %entry
  ...
  %a.0 = phi i32 [ 1, %entry ], [ %a.1, %if.end ]
  %cmp.not = icmp eq i32 %a.0, 0
  br i1 %cmp.not, label %for.cond18.preheader, label %for.cond

for.cond18.preheader:                             ; preds = %while.cond
  %sub19 = add nsw i32 %m.0, -1
  %smax = call i32 @llvm.smax.i32(i32 %sub19, i32 noundef 0)
...
if.then:                                          ; preds = %for.end
  ...
  %arrayidx16 = getelementptr inbounds [100 x i32], ptr %sz1, i64 0, i64 %idxprom15
  store i32 %sub14, ptr %arrayidx16, align 4, !tbaa !8
  %add17 = add nsw i32 %m.0, 1
  br label %if.end

if.end:                                           ; preds = %for.end, %if.then
  %m.1 = phi i32 [ %add17, %if.then ], [ %m.0, %for.end ]
  %a.1 = phi i32 [ %a.0, %if.then ], [ 0, %for.end ]
  br label %while.cond, !llvm.loop !12

for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc25
  %indvars.iv11 = phi i64 [ 0, %for.cond18.preheader ], [ %indvars.iv.next12, %for.inc25 ]
  %exitcond14.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond14.not, label %for.end27, label %for.inc25
...
for.inc25:                                        ; preds = %for.cond18
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %7) #6
...
for.end27:                                        ; preds = %for.cond18
  ...
  %call31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8) #6
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %sz1) #6
  call void @llvm.lifetime.end.p0(i64 noundef 20, ptr noundef nonnull %sz) #6
  ret i32 0
}
