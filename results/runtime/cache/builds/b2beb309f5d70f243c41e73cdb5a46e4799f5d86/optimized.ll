...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call8 = call double @sqrt(double noundef %5) #5, !tbaa !5
  %add = fsub double %call8, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call14 = call double @sqrt(double noundef %5) #5, !tbaa !5
  ...
  %.pre8 = load double, ptr %a, align 8, !tbaa !9
  %.pre9 = load double, ptr %c, align 8, !tbaa !9
  %.pre13 = fmul double %.pre8, 4.000000e+00
  %.pre14 = fneg double %.pre9
  %.pre15 = fmul double %.pre13, %.pre14
  %.pre16 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre15)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi17 = phi double [ %.pre16, %if.then ], [ %5, %for.body ]
  %mul19.pre-phi = phi double [ %.pre13, %if.then ], [ %mul2, %for.body ]
  %6 = phi double [ %.pre9, %if.then ], [ %3, %for.body ]
  %7 = phi double [ %.pre8, %if.then ], [ %2, %for.body ]
  %8 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp22 = fcmp oeq double %.pre-phi17, 0.000000e+00
...
if.then23:                                        ; preds = %if.end
  ...
  %.pre10 = load double, ptr %b, align 8, !tbaa !9
  %.pre11 = load double, ptr %a, align 8, !tbaa !9
  %.pre12 = load double, ptr %c, align 8, !tbaa !9
  %.pre18 = fmul double %.pre11, 4.000000e+00
  %.pre19 = fneg double %.pre12
  %.pre21 = fmul double %.pre18, %.pre19
  %.pre22 = call double @llvm.fmuladd.f64(double %.pre10, double %.pre10, double %.pre21)
  br label %if.end28

if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi23 = phi double [ %.pre22, %if.then23 ], [ %.pre-phi17, %if.end ]
  %mul30.pre-phi = phi double [ %.pre18, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre12, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre11, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre10, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi23, 0.000000e+00
...
if.then36:                                        ; preds = %if.then34
  ...
  %call41 = call double @sqrt(double noundef %13) #5, !tbaa !5
  %mul42 = fmul double %10, 2.000000e+00
  %div43 = fdiv double %call41, %mul42
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef 0.000000e+00, double noundef %div43, double noundef 0.000000e+00, double noundef %div43)
  br label %for.inc

if.else:                                          ; preds = %if.then34
  %mul46 = fmul double %10, 2.000000e+00
  %div47 = fdiv double %12, %mul46
  %neg51 = fmul double %11, %12
  %14 = call double @llvm.fmuladd.f64(double %mul30.pre-phi, double %9, double %neg51)
  %call52 = call double @sqrt(double noundef %14) #5, !tbaa !5
  %div54 = fdiv double %call52, %mul46
  %call55 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div47, double noundef %div54, double noundef %div47, double noundef %div54)
  br label %for.inc
