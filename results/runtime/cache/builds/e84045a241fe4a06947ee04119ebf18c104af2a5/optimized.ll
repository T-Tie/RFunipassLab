...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  %call.i = call noundef float @sqrtf(float noundef %conv) #6, !tbaa !5
...
if.then:                                          ; preds = %for.body6
  ...
  call void @_Z1fii(i32 noundef %div, i32 noundef %j.0)
...
for.end:                                          ; preds = %for.cond2
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call8, i8 noundef signext %call.i7)
...
while.cond:                                       ; preds = %while.cond.preheader, %if.end4
  %y.addr.0 = phi i32 [ %inc5, %if.end4 ], [ %y, %while.cond.preheader ]
...
if.then3:                                         ; preds = %while.body
  tail call void @_Z1fii(i32 noundef %div, i32 noundef %y.addr.0)
  br label %if.end4
