...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %land.lhs.true.i, %if.then19.i, %if.then28.i
  ...
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %initial) #11
...
while.body:                                       ; preds = %while.cond
  ...
  %call16.i13 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i12) #10
...
land.lhs.true.i14:                                ; preds = %while.body
  %_M_width.i4.i15 = getelementptr inbounds nuw i8, ptr %add.ptr10.i12, i64 16
  %3 = load i64, ptr %_M_width.i4.i15, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -42
...
if.then19.i19:                                    ; preds = %land.lhs.true.i14
  %call24.i20 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i12) #10
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27: ; preds = %while.body, %land.lhs.true.i14, %if.then19.i19, %if.then28.i26
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #11
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull captures(none) %initial) #10
