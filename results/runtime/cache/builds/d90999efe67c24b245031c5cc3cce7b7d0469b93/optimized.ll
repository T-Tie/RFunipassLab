...
if.end19:                                         ; preds = %if.else14, %if.end
  %sum.158 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  %sum.2 = phi i32 [ 0, %if.end23.thread ], [ %conv, %if.then25 ], [ %sum.158, %if.end19 ]
