...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  ...
  %sub36.sink = phi i32 [ %sub, %if.then35 ], [ %sub49, %for.inc48 ]
  %cmp38 = icmp sge i32 %sub36.sink, 0
...
for.body39:                                       ; preds = %for.cond37
  ...
  %idxprom42 = sext i32 %sub36.sink to i64
...
for.inc48:                                        ; preds = %for.body39, %if.then45
  ...
  %b2.2 = phi i32 [ %sub36.sink, %if.then45 ], [ %b2.1, %for.body39 ]
  %p.6 = phi i32 [ %add46, %if.then45 ], [ %p.5, %for.body39 ]
  %sub49 = sub nsw i32 %sub36.sink, 1
