...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next10, %for.inc24 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc24 ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond27.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %2 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv9
...
for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv15 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next16, %for.inc39 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond20.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv15, 0
  br i1 %cmp30, label %if.then31, label %if.else

if.then31:                                        ; preds = %for.body29
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4) #6
  br label %for.inc39

if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv15
  %6 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %6) #6
  br label %for.inc39
