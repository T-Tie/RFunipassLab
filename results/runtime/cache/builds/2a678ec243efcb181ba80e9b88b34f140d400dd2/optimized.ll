...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1600, ptr %a) #6
...
for.inc41:                                        ; preds = %if.then, %if.else37, %if.then34
  %.str.2.sink = phi ptr [ @.str.2, %if.else37 ], [ @.str.1, %if.then34 ], [ @.str, %if.then ]
...
for.end43:                                        ; preds = %for.cond18
  ...
  call void @llvm.lifetime.end.p0(i64 1600, ptr %a) #6
