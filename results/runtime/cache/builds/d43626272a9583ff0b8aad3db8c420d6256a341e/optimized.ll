...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %total) #7
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %valid) #7
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %t1) #7
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %v1) #7
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %v1) #7
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %t1) #7
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %valid) #7
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %total) #7
  ret i32 0
}
