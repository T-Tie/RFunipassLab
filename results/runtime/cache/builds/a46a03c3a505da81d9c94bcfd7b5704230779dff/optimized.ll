...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 550, ptr noundef nonnull align 16 dereferenceable(550) %a) #10
...
if.then:                                          ; preds = %for.body32
  ...
  %2 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !10
...
for.body55:                                       ; preds = %for.cond51
  ...
  %3 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !10
...
for.body77:                                       ; preds = %for.cond73
  ...
  %5 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !10
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !19, !invariant.load !10
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !19, !invariant.load !10
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !45, !invariant.load !10
  ret i32 %0
}
