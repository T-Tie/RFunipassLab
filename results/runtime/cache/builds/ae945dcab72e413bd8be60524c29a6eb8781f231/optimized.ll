...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv9, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre17, %for.inc ]
...
for.inc26:                                        ; preds = %for.inc26.loopexit, %for.inc26.split.loop.exit19
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit19 ], [ %r1.0, %for.inc26.loopexit ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit19 ], [ %c1.0, %for.inc26.loopexit ]
  %i.2 = phi i32 [ 10000, %for.inc26.split.loop.exit19 ], [ %6, %for.inc26.loopexit ]
