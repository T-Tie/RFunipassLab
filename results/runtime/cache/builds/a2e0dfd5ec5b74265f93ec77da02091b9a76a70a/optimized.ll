...
entry:
  ...
  %smax9 = call i32 @llvm.smax.i32(i32 %x, i32 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [150 x i32], ptr %z, i64 %indvars.iv6, i64 %indvars.iv
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 90000, ptr noundef nonnull align 16 dereferenceable(90000) %a) #5
  call void @llvm.lifetime.start.p0(i64 noundef 90000, ptr noundef nonnull align 16 dereferenceable(90000) %b) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %p) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %q) #5
...
for.cond:                                         ; preds = %for.end28, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.end28 ], [ 0, %entry ]
  %4 = load i32, ptr %m, align 4, !tbaa !8
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv19, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !8
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv16, %7
...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.body8
  ...
  %z.0 = phi i32 [ 0, %for.cond6.preheader ], [ %add, %for.body8 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body8

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !8, !invariant.load !12
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv16
  %10 = load i32, ptr %arrayidx14, align 4, !tbaa !8, !invariant.load !12
...
for.end:                                          ; preds = %for.cond6
  ...
  %cmp15 = icmp slt i64 %indvars.iv16, %11
  br i1 %cmp15, label %for.inc26, label %if.else

if.else:                                          ; preds = %for.end
  %12 = zext i32 %sub to i64
  %cmp18 = icmp eq i64 %indvars.iv16, %12
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv19, %14
...
for.inc26:                                        ; preds = %land.lhs.true, %for.end, %if.else23
  ...
  %call16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2.sink, i32 noundef %z.0)
...
for.end31:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %q) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %p) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m) #6
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef nonnull %a) #6
  ret i32 0
}
