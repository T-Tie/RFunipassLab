...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc28 ], [ 0, %entry ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv9
...
for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv4
...
for.cond31:                                       ; preds = %for.cond, %for.inc69
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc69 ], [ 0, %for.cond ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count12
  br i1 %exitcond28.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv24
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select2, %for.body39 ], [ %3, %for.body33 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv24
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select2 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc66 ], [ 0, %for.cond54.preheader ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.inc69, label %for.inc66

for.inc66:                                        ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv24
