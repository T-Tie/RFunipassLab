...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 160, ptr noundef nonnull align 16 %sum) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(160) %sum, ptr noundef nonnull readonly align 16 dereferenceable(160) @__const.main.sum, i64 noundef 160, i1 noundef false) #6
...
for.end:                                          ; preds = %for.cond
  %conv.i = zext i32 %s.0 to i64
  %call.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertImEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i64 noundef %conv.i)
  br label %if.end

for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %i.1 = phi i32 [ %inc34, %for.inc33 ], [ 1, %for.cond3.preheader ]
  %exitcond20 = icmp eq i32 %i.1, %2
  br i1 %exitcond20, label %while.cond, label %for.cond6
...
for.cond15:                                       ; preds = %for.cond6, %for.inc30
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc30 ], [ 0, %for.cond6 ]
  %exitcond19.not = icmp eq i64 %indvars.iv16, 40
  br i1 %exitcond19.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv16
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %div = sdiv i32 %4, 10
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx21 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv.next17
...
while.cond:                                       ; preds = %for.cond3, %while.cond
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %while.cond ], [ 39, %for.cond3 ]
  %arrayidx37 = getelementptr inbounds [40 x i32], ptr %sum, i64 0, i64 %indvars.iv21
  ...
  br i1 %cmp38, label %while.cond, label %for.cond39.preheader, !llvm.loop !16

for.cond39.preheader:                             ; preds = %while.cond
  %7 = trunc nsw i64 %indvars.iv21 to i32
  br label %for.cond39

for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc45
  %8 = phi i32 [ %dec46, %for.inc45 ], [ %7, %for.cond39.preheader ]
  %cmp40 = icmp sgt i32 %8, -1
  br i1 %cmp40, label %for.inc45, label %if.end

for.inc45:                                        ; preds = %for.cond39
  %idxprom42 = zext nneg i32 %8 to i64
  %arrayidx43 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %idxprom42
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
  %dec46 = add nsw i32 %8, -1
  br label %for.cond39, !llvm.loop !17

if.end:                                           ; preds = %for.cond39, %for.end
  call void @llvm.lifetime.end.p0(i64 noundef 160, ptr noundef nonnull %sum) #7
