...
entry:
  ...
  %smax24 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %1 = add nuw i32 %smax24, 1
  %wide.trip.count25 = zext i32 %1 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc73 ], [ 1, %entry ]
  %exitcond26 = icmp eq i64 %indvars.iv19, %wide.trip.count25
  br i1 %exitcond26, label %for.end75, label %for.body
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select9, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext39 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext39, 32
  ...
  %spec.select9 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  %invariant.gep = getelementptr i8, ptr %a, i64 -1
  %invariant.gep13 = getelementptr inbounds nuw i8, ptr %a, i64 1
  %add49 = add i64 %indvars.iv19, %call8
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %sext37 = shl i64 %add49, 32
  %7 = ashr exact i64 %sext37, 32
  %sext = shl i64 %call6, 32
  %8 = ashr exact i64 %sext, 32
  %gep = getelementptr i8, ptr %invariant.gep, i64 %8
  %9 = and i64 %indvars.iv19, 4294967295
  %gep14 = getelementptr i8, ptr %invariant.gep13, i64 %8
  %10 = sub i32 %conv12, %conv9
  %smax27 = call i32 @llvm.abs.i32(i32 %10, i1 noundef false)
  %11 = add nuw i32 %smax27, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond28 = icmp eq i32 %j.1, %11
  br i1 %exitcond28, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv19, 4294967294
  %smax34 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
  %12 = add nuw i32 %smax34, 1
...
if.end50:                                         ; preds = %_Z4leftPcii.exit, %for.body45
  br i1 %s.0, label %for.cond.i2, label %for.inc55

for.cond.i2:                                      ; preds = %for.inc.i5, %if.end50
...
_Z5rightPcii.exit:                                ; preds = %for.cond.i2
  store i8 0, ptr %gep14, align 1, !tbaa !5
  br label %for.inc55
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv29 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next30, %for.inc68 ]
  %exitcond36 = icmp eq i64 %indvars.iv29, %wide.trip.count35
  br i1 %exitcond36, label %for.end75, label %for.inc68

for.inc68:                                        ; preds = %for.cond58
  %15 = add nsw i64 %indvars.iv29, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx63, align 1, !tbaa !5, !invariant.load !8
  %17 = add i64 %add64, %indvars.iv29
  %sext38 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext38, 32
