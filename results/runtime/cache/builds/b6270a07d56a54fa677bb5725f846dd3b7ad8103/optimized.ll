...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %4) #7
  %5 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %5) #7
...
for.body19:                                       ; preds = %for.cond17
  ...
  %puts4 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #7
