...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc11
  %indvars.iv10 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next11, %for.inc11 ]
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc14
  %indvars.iv11 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next12, %for.inc14 ]
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %a) #5
