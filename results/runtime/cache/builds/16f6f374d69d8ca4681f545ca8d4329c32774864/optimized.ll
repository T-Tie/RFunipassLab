...
while.body:                                       ; preds = %land.end
  ...
  %call4 = call i64 @strlen(ptr noundef %a) #10
...
if.end19:                                         ; preds = %if.then11, %if.else14
  %sum.14 = phi i32 [ %add, %if.then11 ], [ %add7, %if.else14 ]
  %cmp20 = icmp eq i32 %sum.14, 80
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  %sum.2 = phi i32 [ 0, %if.end23.thread ], [ %conv, %if.then25 ], [ %sum.14, %if.end19 ]
...
while.end:                                        ; preds = %while.cond, %land.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef captures(none) %a) #11
  ret i32 0
}
