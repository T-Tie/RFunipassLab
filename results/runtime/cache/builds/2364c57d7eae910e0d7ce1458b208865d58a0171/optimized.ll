...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv11 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next12, %for.inc25 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond15.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv11
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc69
  %indvars.iv31 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next32, %for.inc69 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count19
  br i1 %exitcond35.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv31
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select9, %for.body39 ], [ %3, %for.body33 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv31
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select9 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv26 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next27, %for.inc66 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.inc69, label %for.inc66

for.inc66:                                        ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv31
...
for.cond13:                                       ; preds = %for.cond17, %for.cond13.preheader
  %indvars.iv16 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next17, %for.cond17 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count9
  br i1 %exitcond20.not, label %for.end35, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  %indvars.iv11 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next12, %for.inc30 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond13, label %for.inc30, !llvm.loop !19

for.inc30:                                        ; preds = %for.cond17
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv.next17
  %1 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %arrayidx29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv16
...
for.cond1:                                        ; preds = %for.inc12, %for.body
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc12 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
