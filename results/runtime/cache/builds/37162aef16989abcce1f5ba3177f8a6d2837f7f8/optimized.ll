...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) @s) #5
...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %pre.0 = phi i32 [ %pre.1, %if.end ], [ %conv, %entry ]
...
for.cond14.preheader:                             ; preds = %for.cond
  %smax = tail call i32 @llvm.smax.i32(i32 %pre.0, i32 noundef 0) #6
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp2, label %for.cond3, label %if.end

for.cond3:                                        ; preds = %for.body, %for.body6
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body6 ], [ %indvars.iv, %for.body ]
  %3 = trunc nuw i64 %indvars.iv13 to i32
...
for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv13
  %4 = load i8, ptr %arrayidx8, align 1, !tbaa !5, !invariant.load !8
  %call9 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %4)
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond3, !llvm.loop !9

if.end:                                           ; preds = %for.cond.cleanup5, %for.body
  %pre.1 = phi i32 [ %indvars, %for.cond.cleanup5 ], [ %pre.0, %for.body ]
  br label %for.cond, !llvm.loop !12

for.cond14:                                       ; preds = %for.cond14.preheader, %for.body17
  %indvars.iv17 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next18, %for.body17 ]
  %exitcond.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body17

for.body17:                                       ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv17
  %5 = load i8, ptr %arrayidx19, align 1, !tbaa !5, !invariant.load !8
  %call20 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %5)
...
attributes #5 = { nofree nosync nounwind willreturn memory(read) }
attributes #6 = { nofree }
