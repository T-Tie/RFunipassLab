...
if.then:                                          ; preds = %while.body
  ...
  %.pre4 = load double, ptr %a, align 8, !tbaa !5
  %.pre7 = fdiv double %.pre, %.pre4
  %.pre8 = fsub double %.pre7, %div
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %sub10.pre-phi = phi double [ %.pre8, %if.then ], [ %sub, %while.body ]
...
if.then12:                                        ; preds = %if.end
  ...
  %.pre5 = load double, ptr %b, align 8, !tbaa !5
  %.pre6 = load double, ptr %a, align 8, !tbaa !5
  %.pre9 = fdiv double %.pre5, %.pre6
  %.pre10 = fsub double %.pre9, %div
  br label %if.end15

if.end15:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi double [ %.pre10, %if.then12 ], [ %sub10.pre-phi, %if.end ]
