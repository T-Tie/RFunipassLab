...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %j.0.sink4 = phi i32 [ %j.0, %if.then ], [ %add16, %for.inc25 ]
  %_ZSt4cout.sink3 = phi ptr [ @_ZSt4cout, %if.then ], [ %call20, %for.inc25 ]
  %idxprom12 = sext i32 %j.0.sink4 to i64
  %arrayidx13 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom12
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink3, ptr noundef %arrayidx13)
  %add16 = add nsw i32 %j.0.sink4, 1
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  ...
  %idxprom31 = sext i32 %j.0.sink2 to i64
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  ...
  %idxprom58 = sext i32 %j.0.sink to i64
