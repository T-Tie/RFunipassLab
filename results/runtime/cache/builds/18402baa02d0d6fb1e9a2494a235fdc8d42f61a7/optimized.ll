...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv8 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  ...
  %wide.trip.count18 = zext i32 %j.0 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond26.not = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv20
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc37 ], [ %indvars.iv12, %for.body17 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv14
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv27 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next28, %for.inc53 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count25
  br i1 %exitcond31.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv27
  ...
  %cmp49 = icmp slt i64 %indvars.iv27, %4
