...
@switch.table._Z4mtodiii.1 = private unnamed_addr constant [11 x i32] [i32 0, i32 31, i32 59, i32 90, i32 120, i32 151, i32 181, i32 212, i32 243, i32 273, i32 304], align 4
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  %switch.tableidx = add i32 %mm1, -1
  %1 = icmp ult i32 %switch.tableidx, 11
  br i1 %1, label %switch.lookup, label %sw.epilog

switch.lookup:                                    ; preds = %if.then
  %2 = zext nneg i32 %switch.tableidx to i64
  %switch.gep = getelementptr inbounds nuw [11 x i32], ptr @switch.table._Z4mtodiii, i64 0, i64 %2
  %switch.load = load i32, ptr %switch.gep, align 4
  br label %sw.epilog

sw.epilog:                                        ; preds = %if.then, %switch.lookup
  %dd1.0 = phi i32 [ %switch.load, %switch.lookup ], [ 335, %if.then ]
...
if.else:                                          ; preds = %lor.lhs.false
  %switch.tableidx6 = add i32 %mm1, -1
  %3 = icmp ult i32 %switch.tableidx6, 11
  br i1 %3, label %switch.lookup5, label %sw.epilog40

switch.lookup5:                                   ; preds = %if.else
  %4 = zext nneg i32 %switch.tableidx6 to i64
  %switch.gep7 = getelementptr inbounds nuw [11 x i32], ptr @switch.table._Z4mtodiii.1, i64 0, i64 %4
  %switch.load8 = load i32, ptr %switch.gep7, align 4
  br label %sw.epilog40

sw.epilog40:                                      ; preds = %if.else, %switch.lookup5
  %dd1.2 = phi i32 [ %switch.load8, %switch.lookup5 ], [ 334, %if.else ]
...
if.end:                                           ; preds = %sw.epilog40, %sw.epilog, %sw.bb42, %sw.bb43, %sw.bb44, %sw.bb45, %sw.bb46, %sw.bb47, %sw.bb48, %sw.bb49, %sw.bb50, %sw.bb51, %sw.default52, %sw.bb16, %sw.bb17, %sw.bb18, %sw.bb19, %sw.bb20, %sw.bb21, %sw.bb22, %sw.bb23, %sw.bb24, %sw.bb25, %sw.default26
  %dd2.0 = phi i32 [ 335, %sw.default26 ], [ 31, %sw.bb16 ], [ 60, %sw.bb17 ], [ 91, %sw.bb18 ], [ 121, %sw.bb19 ], [ 152, %sw.bb20 ], [ 182, %sw.bb21 ], [ 213, %sw.bb22 ], [ 244, %sw.bb23 ], [ 274, %sw.bb24 ], [ 305, %sw.bb25 ], [ 334, %sw.default52 ], [ 31, %sw.bb42 ], [ 59, %sw.bb43 ], [ 90, %sw.bb44 ], [ 120, %sw.bb45 ], [ 151, %sw.bb46 ], [ 181, %sw.bb47 ], [ 212, %sw.bb48 ], [ 243, %sw.bb49 ], [ 273, %sw.bb50 ], [ 304, %sw.bb51 ], [ 0, %sw.epilog ], [ 0, %sw.epilog40 ]
  %dd1.1 = phi i32 [ %dd1.0, %sw.default26 ], [ %dd1.0, %sw.bb16 ], [ %dd1.0, %sw.bb17 ], [ %dd1.0, %sw.bb18 ], [ %dd1.0, %sw.bb19 ], [ %dd1.0, %sw.bb20 ], [ %dd1.0, %sw.bb21 ], [ %dd1.0, %sw.bb22 ], [ %dd1.0, %sw.bb23 ], [ %dd1.0, %sw.bb24 ], [ %dd1.0, %sw.bb25 ], [ %dd1.2, %sw.default52 ], [ %dd1.2, %sw.bb42 ], [ %dd1.2, %sw.bb43 ], [ %dd1.2, %sw.bb44 ], [ %dd1.2, %sw.bb45 ], [ %dd1.2, %sw.bb46 ], [ %dd1.2, %sw.bb47 ], [ %dd1.2, %sw.bb48 ], [ %dd1.2, %sw.bb49 ], [ %dd1.2, %sw.bb50 ], [ %dd1.2, %sw.bb51 ], [ %dd1.0, %sw.epilog ], [ %dd1.2, %sw.epilog40 ]
  %sub = sub nsw i32 %dd2.0, %dd1.1
  ret i32 %sub
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 804, ptr nonnull %ans) #5
...
for.body:                                         ; preds = %for.cond
  ...
  %rem19 = srem i16 %rem.lhs.trunc, 7
  %cmp5 = icmp eq i16 %rem19, 0
...
for.cond8:                                        ; preds = %for.cond, %for.inc21
  %6 = phi i32 [ %.pre, %for.inc21 ], [ %0, %for.cond ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc21 ], [ 1, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp9.not = icmp sgt i64 %indvars.iv21, %7
  br i1 %cmp9.not, label %for.end23, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %arrayidx12 = getelementptr inbounds nuw [201 x i32], ptr %ans, i64 0, i64 %indvars.iv21
...
if.else17:                                        ; preds = %for.body10
  %call1.i8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 2)
  br label %for.inc21

for.inc21:                                        ; preds = %if.then14, %if.else17
...
for.end23:                                        ; preds = %for.cond8
  call void @llvm.lifetime.end.p0(i64 804, ptr nonnull %ans) #5
