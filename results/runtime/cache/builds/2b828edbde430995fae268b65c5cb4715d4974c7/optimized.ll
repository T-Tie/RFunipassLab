...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %b) #4
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.inc25, %for.end9
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc25 ], [ 0, %for.end9 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp12 = icmp slt i64 %indvars.iv29, %5
  br i1 %cmp12, label %for.cond14, label %for.cond28

for.cond14:                                       ; preds = %for.cond11, %for.inc22
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc22 ], [ 0, %for.cond11 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp15 = icmp slt i64 %indvars.iv26, %7
  br i1 %cmp15, label %for.inc22, label %for.inc25

for.inc22:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv29, i64 %indvars.iv26
...
for.cond28:                                       ; preds = %for.cond11, %for.cond64.preheader
  %i.2 = phi i32 [ %inc98, %for.cond64.preheader ], [ 0, %for.cond11 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp29 = icmp slt i32 %i.2, %8
  br i1 %cmp29, label %for.cond31, label %for.end99

for.cond31:                                       ; preds = %for.cond28, %for.cond34.preheader
  %j.2 = phi i32 [ %inc62, %for.cond34.preheader ], [ 0, %for.cond28 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %9, -1
  %cmp32 = icmp slt i32 %j.2, %sub
  br i1 %cmp32, label %for.cond34.preheader, label %for.cond64.preheader

for.cond64.preheader:                             ; preds = %for.cond31
  %call96 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 undef)
  %inc98 = add nuw nsw i32 %i.2, 1
  br label %for.cond28, !llvm.loop !15

for.cond34.preheader:                             ; preds = %for.cond31
  %call60 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 undef)
  %inc62 = add nuw nsw i32 %j.2, 1
...
for.end99:                                        ; preds = %for.cond28
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef nonnull %a) #5
  ret i32 0
}
