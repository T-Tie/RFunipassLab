...
while.cond:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %arrayidx, i1 noundef false, i1 noundef true, i1 noundef false) #8
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv26, i32 noundef 0)
...
for.end:                                          ; preds = %for.cond
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx9) #9
