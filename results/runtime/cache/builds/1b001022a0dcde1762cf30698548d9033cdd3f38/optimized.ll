...
for.cond13.preheader:                             ; preds = %for.cond
  %smax10 = call i32 @llvm.smax.i32(i32 noundef %m2, i32 noundef 1) #9
  br label %for.cond13
...
for.inc:                                          ; preds = %for.body, %if.end.thread, %if.then8
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc37
  ...
  %exitcond11.not = icmp eq i32 %j.0, %smax10
  br i1 %exitcond11.not, label %for.end39, label %for.body15
...
if.then28:                                        ; preds = %for.body15
  ...
  %spec.select8.neg = select i1 %tobool30.not, i32 -3, i32 -2
  %sub34 = add nsw i32 %spec.select8.neg, %add16
  br label %for.inc37

for.inc37:                                        ; preds = %for.body15, %if.end26.thread, %if.then28
