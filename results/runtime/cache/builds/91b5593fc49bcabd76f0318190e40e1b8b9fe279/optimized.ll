...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef align 16 %len) #9
...
for.body:                                         ; preds = %for.cond
  ...
  %call5 = call i64 @strlen(ptr noundef %arrayidx) #11
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %num) #10
  store i32 0, ptr %num, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %cnt) #10
...
while.cond9:                                      ; preds = %if.end34, %if.end
  ...
  %5 = load i32, ptr %cnt, align 4, !tbaa !5
...
if.end19:                                         ; preds = %while.body13
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arrayidx15)
  %inc24 = add nsw i32 %5, 1
  store i32 %inc24, ptr %cnt, align 4, !tbaa !5
...
while.end:                                        ; preds = %if.then18, %while.cond9
  br label %while.cond, !llvm.loop !14

while.end35:                                      ; preds = %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %cnt) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %num) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %len) #10
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef %ch) #10
...
do.end:                                           ; preds = %do.cond
  %vtable = load ptr, ptr %__in, align 8, !tbaa !15
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !15
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !15
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !15
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !15
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !15
