...
for.inc122.gvnsink.split:                         ; preds = %if.then85, %if.else107
  %arrayidx109.sink = phi ptr [ %arrayidx109, %if.else107 ], [ @a, %if.then85 ]
  %sub112.sink = phi i32 [ %sub102, %if.else107 ], [ 0, %if.then85 ]
  %idxprom110 = sext i32 %j.4 to i64
  %arrayidx111 = getelementptr inbounds [100 x i32], ptr %arrayidx109.sink, i64 0, i64 %idxprom110
  %6 = load i32, ptr %arrayidx111, align 4, !tbaa !5, !invariant.load !9
  ...
  store i32 %6, ptr %arrayidx117, align 4, !tbaa !5
  br label %for.inc122
...
cleanup:                                          ; preds = %for.end65, %for.end127
  ...
  %7 = load i32, ptr %sum.sink, align 4, !tbaa !5
