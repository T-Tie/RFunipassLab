...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %or.cond4 = or i1 %cmp36, %or.cond
  %.sink = select i1 %or.cond4, i32 29, i32 28
...
NodeBlock25:                                      ; preds = %for.body5
  %Pivot26 = icmp slt i32 %j.0, 6
  br i1 %Pivot26, label %NodeBlock11, label %NodeBlock23

NodeBlock23:                                      ; preds = %NodeBlock25
  %Pivot24 = icmp slt i32 %j.0, 10
  br i1 %Pivot24, label %NodeBlock15, label %NodeBlock21

NodeBlock21:                                      ; preds = %NodeBlock23
  %Pivot22 = icmp slt i32 %j.0, 11
  br i1 %Pivot22, label %if.then18, label %NodeBlock19

NodeBlock19:                                      ; preds = %NodeBlock21
  %Pivot20 = icmp slt i32 %j.0, 12
  br i1 %Pivot20, label %if.then26, label %LeafBlock17

LeafBlock17:                                      ; preds = %NodeBlock19
  %SwitchLeaf18 = icmp eq i32 %j.0, 12
  br i1 %SwitchLeaf18, label %if.then18, label %for.inc

NodeBlock15:                                      ; preds = %NodeBlock23
  %Pivot16 = icmp slt i32 %j.0, 7
  br i1 %Pivot16, label %if.then26, label %NodeBlock13

NodeBlock13:                                      ; preds = %NodeBlock15
  %Pivot14 = icmp slt i32 %j.0, 9
  br i1 %Pivot14, label %if.then18, label %if.then26

NodeBlock11:                                      ; preds = %NodeBlock25
  %Pivot12 = icmp slt i32 %j.0, 3
  br i1 %Pivot12, label %NodeBlock, label %NodeBlock9

NodeBlock9:                                       ; preds = %NodeBlock11
  %Pivot10 = icmp slt i32 %j.0, 4
  br i1 %Pivot10, label %if.then18, label %NodeBlock7

NodeBlock7:                                       ; preds = %NodeBlock9
  %Pivot8 = icmp slt i32 %j.0, 5
  br i1 %Pivot8, label %if.then26, label %if.then18

NodeBlock:                                        ; preds = %NodeBlock11
  %Pivot = icmp slt i32 %j.0, 2
  br i1 %Pivot, label %LeafBlock, label %if.then30

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i32 %j.0, 1
  br i1 %SwitchLeaf, label %if.then18, label %for.inc

if.then18:                                        ; preds = %NodeBlock21, %LeafBlock17, %NodeBlock13, %NodeBlock9, %NodeBlock7, %LeafBlock
  %add = add nsw i32 %total.0, 31
  br label %for.inc

if.then26:                                        ; preds = %NodeBlock19, %NodeBlock15, %NodeBlock13, %NodeBlock7
  %add27 = add nsw i32 %total.0, 30
  br label %for.inc

if.then30:                                        ; preds = %NodeBlock
  %add40 = add nsw i32 %.sink, %total.0
  br label %for.inc

for.inc:                                          ; preds = %LeafBlock17, %LeafBlock, %if.then18, %if.then30, %if.then26
  %total.1 = phi i32 [ %add, %if.then18 ], [ %add27, %if.then26 ], [ %add40, %if.then30 ], [ %total.0, %LeafBlock ], [ %total.0, %LeafBlock17 ]
  %inc = add i32 %j.0, 1
