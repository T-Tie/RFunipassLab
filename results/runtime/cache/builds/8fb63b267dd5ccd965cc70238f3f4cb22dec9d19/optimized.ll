...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %.sink = phi i32 [ %9, %for.end57 ], [ %10, %for.inc71 ]
  %add62 = add nsw i32 %.sink, 1
  store i32 %add62, ptr %j, align 4, !tbaa !5
  %10 = load i32, ptr %j, align 4, !tbaa !5
  %11 = load i32, ptr %n, align 4, !tbaa !5
  %cmp64 = icmp slt i32 %10, %11
