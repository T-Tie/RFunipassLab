...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef %a) #6
...
if.then:                                          ; preds = %for.body5
  ...
  %add16 = add nsw i32 %2, 2
  %idxprom17 = sext i32 %add16 to i64
  %arrayidx18 = getelementptr inbounds [100 x double], ptr %a, i64 0, i64 %idxprom17
  %6 = load double, ptr %arrayidx18, align 8, !tbaa !12
  %mul19 = fmul double %mul15, %6
...
if.then21:                                        ; preds = %if.then
  %fneg = fneg double %4
  %call25 = call double @sqrt(double noundef %7) #6, !tbaa !5
  %add26 = fadd double %fneg, %call25
  %mul29 = fmul double 2.000000e+00, %5
  %div = fdiv double %add26, %mul29
  %call34 = call double @sqrt(double noundef %7) #6, !tbaa !5
  %sub = fsub double %fneg, %call34
  %div38 = fdiv double %sub, %mul29
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %div, double noundef %div38)
  br label %if.end

if.end:                                           ; preds = %if.then21, %if.then
  %cmp40 = fcmp oeq double %7, 0.000000e+00
  br i1 %cmp40, label %if.then41, label %if.end51

if.then41:                                        ; preds = %if.end
  %8 = load double, ptr %arrayidx8, align 8, !tbaa !12
  %fneg45 = fneg double %8
  %9 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %mul48 = fmul double 2.000000e+00, %9
  %div49 = fdiv double %fneg45, %mul48
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %div49)
  br label %if.end51

if.end51:                                         ; preds = %if.then41, %if.end
  %cmp52 = fcmp olt double %7, 0.000000e+00
  br i1 %cmp52, label %if.then53, label %if.end73

if.then53:                                        ; preds = %if.end51
  %10 = load double, ptr %arrayidx8, align 8, !tbaa !12
  %fneg57 = fneg double %10
  %11 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %mul60 = fmul double 2.000000e+00, %11
  %div61 = fdiv double %fneg57, %mul60
  %fneg62 = fneg double %7
  %call63 = call double @sqrt(double noundef %fneg62) #6, !tbaa !5
...
if.then69:                                        ; preds = %if.then53
  %call70 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div67, double noundef %div67)
  br label %if.end72

if.else:                                          ; preds = %if.then53
  %call71 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %div61, double noundef %div67, double noundef %div61, double noundef %div67)
  br label %if.end72
...
if.else74:                                        ; preds = %for.body5
  br label %for.inc76

if.end75:                                         ; preds = %if.end73
  br label %for.inc76

for.inc76:                                        ; preds = %if.end75, %if.else74
  %inc77 = add nsw i32 %2, 1
  store i32 %inc77, ptr %k, align 4, !tbaa !5
  br label %for.cond2, !llvm.loop !14

for.end78:                                        ; preds = %for.cond2
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %a) #6
