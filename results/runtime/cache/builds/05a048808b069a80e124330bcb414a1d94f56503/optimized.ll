...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select47 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select47
  ...
  %or.cond48 = or i1 %cmp12, %or.cond
  %smax49 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond48, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %x.1 = phi i32 [ %add, %for.inc ], [ 0, %for.body ]
  %exitcond50.not = icmp eq i32 %m.0, %smax49
  br i1 %exitcond50.not, label %for.inc53, label %NodeBlock19
...
NodeBlock:                                        ; preds = %NodeBlock3
  ...
  %switch.selectcmp52 = icmp eq i32 %m.0, 2
  %switch.select53 = select i1 %switch.selectcmp52, i32 29, i32 %switch.select
  br label %for.inc
...
for.inc:                                          ; preds = %LeafBlock, %LeafBlock5, %LeafBlock7, %LeafBlock11, %LeafBlock13, %NodeBlock, %sw.default
  %.sink = phi i32 [ 30, %sw.default ], [ %switch.select53, %NodeBlock ], [ 31, %LeafBlock13 ], [ 31, %LeafBlock11 ], [ 31, %LeafBlock7 ], [ 31, %LeafBlock5 ], [ 31, %LeafBlock ]
  %add = add nsw i32 %.sink, %x.1
  %inc = add i32 %m.0, 1
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax49
...
NodeBlock25:                                      ; preds = %NodeBlock27
  %switch.selectcmp54 = icmp eq i32 %m.1, 3
  %switch.select55 = select i1 %switch.selectcmp54, i32 31, i32 30
  %switch.selectcmp56 = icmp eq i32 %m.1, 2
  %switch.select57 = select i1 %switch.selectcmp56, i32 28, i32 %switch.select55
  br label %for.inc40
...
for.inc40:                                        ; preds = %LeafBlock21, %LeafBlock29, %LeafBlock31, %LeafBlock35, %LeafBlock37, %NodeBlock25, %sw.default37
  %.sink51 = phi i32 [ 30, %sw.default37 ], [ %switch.select57, %NodeBlock25 ], [ 31, %LeafBlock37 ], [ 31, %LeafBlock35 ], [ 31, %LeafBlock31 ], [ 31, %LeafBlock29 ], [ 31, %LeafBlock21 ]
  %add34 = add nsw i32 %.sink51, %x.4
  %inc41 = add i32 %m.1, 1
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.158 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str..str.158)
