...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv12 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next13, %for.inc39 ]
...
if.then31:                                        ; preds = %for.body29
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %2) #6
  br label %for.inc39
