...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre64, %for.body3 ], [ %0, %for.cond ]
...
for.cond47:                                       ; preds = %for.cond50, %for.cond47.preheader
  ...
  %x2.0 = phi i32 [ undef, %for.cond47.preheader ], [ %x2.1.ph, %for.cond50 ]
  %y2.0 = phi i32 [ undef, %for.cond47.preheader ], [ %y2.1.ph, %for.cond50 ]
...
for.cond50.preheader:                             ; preds = %for.cond47
  ...
  br label %for.cond50.outer

for.cond50.outer:                                 ; preds = %land.lhs.true72, %for.cond50.preheader
  %indvars.iv52.ph = phi i64 [ %14, %land.lhs.true72 ], [ 0, %for.cond50.preheader ]
  %x2.1.ph = phi i32 [ %spec.select34, %land.lhs.true72 ], [ %x2.0, %for.cond50.preheader ]
  %y2.1.ph = phi i32 [ %spec.select35, %land.lhs.true72 ], [ %y2.0, %for.cond50.preheader ]
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.backedge, %for.cond50.outer
  %indvars.iv52 = phi i64 [ %indvars.iv52.ph, %for.cond50.outer ], [ %14, %for.cond50.backedge ]
...
for.body52:                                       ; preds = %for.cond50
  ...
  br i1 %cmp57, label %land.lhs.true58, label %for.cond50.backedge

for.cond50.backedge:                              ; preds = %for.body52, %land.lhs.true58, %land.lhs.true64
...
land.lhs.true58:                                  ; preds = %for.body52
  ...
  br i1 %cmp63, label %land.lhs.true64, label %for.cond50.backedge
...
land.lhs.true64:                                  ; preds = %land.lhs.true58
  ...
  br i1 %cmp71, label %land.lhs.true72, label %for.cond50.backedge
...
land.lhs.true72:                                  ; preds = %land.lhs.true64
  ...
  %spec.select34 = select i1 %cmp78, i32 %12, i32 %x2.1.ph
  %18 = trunc nuw nsw i64 %indvars.iv52 to i32
  %spec.select35 = select i1 %cmp78, i32 %18, i32 %y2.1.ph
  br label %for.cond50.outer, !llvm.loop !16
