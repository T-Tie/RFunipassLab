...
if.then30:                                        ; preds = %if.else
  %call15.i7 = call double @sqrt(double noundef %5) #8, !tbaa !5, !noalias !16
  %add.i8 = fsub double %call15.i7, %1
  %mul.i9 = fmul double %2, 2.000000e+00
  %div.i10 = fdiv double %add.i8, %mul.i9
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div.i10) #7
  br label %for.inc
