...
for.cond4:                                        ; preds = %if.end15, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc17, %if.end15 ]
  %s.0 = phi i32 [ 0, %for.end ], [ %s.1, %if.end15 ]
...
for.cond23:                                       ; preds = %if.end57, %if.end22
  %j.0 = phi i32 [ 0, %if.end22 ], [ %add32, %if.end57 ]
...
for.cond35:                                       ; preds = %if.end47, %for.body25
  %n.0 = phi i32 [ 0, %for.body25 ], [ %n.1, %if.end47 ]
  %i.2 = phi i32 [ 0, %for.body25 ], [ %inc49, %if.end47 ]
...
if.then52:                                        ; preds = %for.end50
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv29, i32 noundef %n.0) #8
  br label %if.end57
