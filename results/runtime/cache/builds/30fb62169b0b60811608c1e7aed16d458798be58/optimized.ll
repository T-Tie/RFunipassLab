...
if.then30:                                        ; preds = %if.else
  %call15.i8 = call double @sqrt(double noundef %5) #7, !tbaa !5, !noalias !15
  %add.i9 = fsub double %call15.i8, %1
  %mul.i10 = fmul double %2, 2.000000e+00
  %div.i11 = fdiv double %add.i9, %mul.i10
  %call21.i12 = call double @sqrt(double noundef %5) #7, !tbaa !5, !noalias !15
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div.i11)
  br label %for.inc
...
if.then56:                                        ; preds = %if.else50
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div66, double noundef %div74, double noundef %div66, double noundef %div74)
  br label %for.inc
