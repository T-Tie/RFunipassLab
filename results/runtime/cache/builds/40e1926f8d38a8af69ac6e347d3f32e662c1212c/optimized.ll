...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %b) #8
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %c) #8
  br label %for.cond
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %4) #9, !tbaa !5
  %add = fadd double %fneg, %call5
  %mul = fmul double 2.000000e+00, %2
  %div = fdiv double %add, %mul
  %call7 = call double @sqrt(double noundef %4) #9, !tbaa !5
...
if.then11:                                        ; preds = %if.then
  %call12 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %div, double noundef %div9) #8
  br label %if.end
...
if.then14:                                        ; preds = %if.end
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %div9) #8
  br label %if.end17
...
if.end49:                                         ; preds = %if.end17
  ...
  %call28 = call double @sqrt(double noundef %fneg23) #9, !tbaa !5
  %fneg29 = fneg double %call28
  %div31 = fdiv double %fneg29, %mul21
  %call32 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div22) #8
  ...
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, double noundef %div22) #8
...
if.then34:                                        ; preds = %if.then19_to_outline
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %0) #10
  br label %if.end36
...
if.then38:                                        ; preds = %if.end36
  %call39 = call i32 (ptr, ...) @printf(ptr noundef readonly captures(none) %1, double noundef %0) #10
