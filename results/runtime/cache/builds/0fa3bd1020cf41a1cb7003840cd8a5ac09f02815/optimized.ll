...
for.end9:                                         ; preds = %for.cond
  ...
  %1 = load double, ptr %arrayidx11, align 8, !tbaa !13
  %2 = load double, ptr %sv, align 16, !tbaa !13
  %div = fdiv double %1, %2
  br label %for.cond14

for.cond14:                                       ; preds = %if.end58, %for.end9
  %i.1 = phi i32 [ 1, %for.end9 ], [ %inc60, %if.end58 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %4 = load double, ptr %arrayidx19, align 8, !tbaa !13
  %5 = load double, ptr %arrayidx18, align 16, !tbaa !13
...
if.end58:                                         ; preds = %land.lhs.true44, %land.lhs.true, %if.else56
  ...
  %call57 = call i32 (ptr, ...) @printf(ptr noundef %.str.3.sink) #5
