...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %u) #5
  br label %for.cond
...
for.cond2:                                        ; preds = %for.end17, %for.end
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.end17 ], [ 0, %for.end ]
  ...
  br i1 %exitcond17, label %for.cond23, label %for.cond6.preheader
...
for.cond23:                                       ; preds = %for.cond2, %if.end36
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end36 ], [ 0, %for.cond2 ]
  %q.1 = phi ptr [ %incdec.ptr39, %if.end36 ], [ @__const.main.t, %for.cond2 ]
...
if.end44:                                         ; preds = %if.then42, %for.end40
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %u) #5
