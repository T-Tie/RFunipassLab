...
for.cond16:                                       ; preds = %for.cond4, %for.inc42
  %.pre24 = phi i32 [ %.pre, %for.inc42 ], [ %0, %for.cond4 ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc42 ], [ 0, %for.cond4 ]
...
for.end33:                                        ; preds = %for.cond23
  %add.ptr35 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv15
