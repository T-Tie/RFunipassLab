...
while.cond:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %indvars.iv7 = phi i32 [ %indvars.iv.next8, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ -1, %entry ]
...
if.then6.i:                                       ; preds = %while.cond
  ...
  %1 = load i64, ptr %gep2, align 8, !tbaa !9
...
for.cond:                                         ; preds = %for.inc, %while.end
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc ], [ 0, %while.end ]
  %exitcond.not = icmp eq i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %sentence, i64 0, i64 %indvars.iv4
