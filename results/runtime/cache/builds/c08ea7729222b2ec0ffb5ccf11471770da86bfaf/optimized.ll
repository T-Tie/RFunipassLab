...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax45 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count16 = zext nneg i32 %smax45 to i64
...
for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv41 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next42, %for.inc125 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count16
  br i1 %exitcond47.not, label %for.end127, label %for.cond72.preheader
...
for.body75:                                       ; preds = %for.cond72
  switch i32 %6, label %lor.lhs.false [
...
lor.lhs.false:                                    ; preds = %for.body75
  %cmp81 = icmp eq i64 %indvars.iv34, 1
  br i1 %cmp81, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %land.lhs.true
  %7 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv34
  %8 = load i32, ptr %7, align 4, !tbaa !5
  %9 = add nsw i64 %indvars.iv34, -1
...
if.else95:                                        ; preds = %lor.lhs.false
  %10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv34
  %11 = load i32, ptr %10, align 4, !tbaa !5
  %cmp96 = icmp eq i64 %indvars.iv34, 0
...
for.inc122:                                       ; preds = %land.lhs.true, %for.body75, %if.then85, %if.else107, %if.then97, %lor.lhs.false
