...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre49, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv33, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv42 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next43, %for.cond13 ]
  ...
  %exitcond48 = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48, label %for.end58, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %6 = add nsw i64 %indvars.iv42, -1
  %7 = trunc nuw nsw i64 %indvars.iv42 to i32
  %8 = trunc nuw nsw i64 %indvars.iv42 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv36 = phi i64 [ 1, %for.cond13.preheader ], [ %10, %for.inc53 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv42, i64 %indvars.iv36
  %9 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp eq i32 %9, 0
  %10 = add nuw nsw i64 %indvars.iv36, 1
  br i1 %cmp20, label %land.lhs.true, label %for.inc53

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv42, i64 %10
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next43, i64 %indvars.iv36
  ...
  %spec.select27 = select i1 %cmp32, i32 %13, i32 %y1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %y1.2 = phi i32 [ %y1.1, %land.lhs.true ], [ %spec.select27, %land.lhs.true26 ]
  %14 = add nsw i64 %indvars.iv36, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv42, i64 %14
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv36
  %16 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %cmp50 = icmp eq i32 %16, 0
  %spec.select28 = select i1 %cmp50, i32 %8, i32 %x2.1
  %17 = trunc nuw nsw i64 %indvars.iv36 to i32
  %spec.select29 = select i1 %cmp50, i32 %17, i32 %y2.1
  br label %for.inc53
...
for.inc53:                                        ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
  ...
  %x2.2 = phi i32 [ %spec.select28, %land.lhs.true44 ], [ %x2.1, %land.lhs.true38 ], [ %x2.1, %for.body15 ]
  %y2.2 = phi i32 [ %spec.select29, %land.lhs.true44 ], [ %y2.1, %land.lhs.true38 ], [ %y2.1, %for.body15 ]
...
for.end58:                                        ; preds = %for.cond10
  ...
  %mul6530 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6530, %add60
  %18 = shl i32 %sub61, 1
  %reass.sub31 = sub i32 %sub66, %18
  %add71 = add i32 %reass.sub31, 2
