...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %.pre37 = load i32, ptr %arrayidx4, align 4, !tbaa !5, !invariant.load !9
...
land.lhs.true:                                    ; preds = %for.cond
  ...
  %cmp19 = icmp eq i32 %.pre37, 0
  %or.cond = select i1 %cmp15, i1 %cmp19, i1 false
  %.pre41 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  br i1 %or.cond, label %land.lhs.true20, label %for.inc

land.lhs.true20:                                  ; preds = %land.lhs.true
  %cmp23 = icmp eq i32 %.pre41, 0
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %3 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ %.pre41, %land.lhs.true20 ], [ %.pre41, %land.lhs.true ], [ %.pre40, %for.cond.for.inc_crit_edge ]
  %4 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre37, %land.lhs.true ], [ %.pre37, %for.cond.for.inc_crit_edge ]
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc61
  %indvars.iv31 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next32, %for.inc61 ]
...
for.inc61:                                        ; preds = %for.cond56
  %arrayidx59 = getelementptr inbounds nuw [1000 x i32], ptr %sum, i64 0, i64 %indvars.iv31
