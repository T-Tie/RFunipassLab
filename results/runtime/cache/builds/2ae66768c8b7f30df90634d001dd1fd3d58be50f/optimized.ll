...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %0) unnamed_addr #4 {
while.end_after_outline.exitStub:
  ...
  %vtable.i = load ptr, ptr %call8, align 8, !tbaa !13, !invariant.load !12
