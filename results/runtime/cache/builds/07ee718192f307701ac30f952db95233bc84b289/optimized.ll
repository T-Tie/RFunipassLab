...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4000, ptr %sum) #3
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc55, %for.inc ]
...
if.else:                                          ; preds = %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true16, %land.lhs.true, %for.cond
...
for.cond56:                                       ; preds = %for.inc61, %for.end
  ...
  %cmp57 = icmp slt i32 %i.1, %m.0
  br i1 %cmp57, label %for.body, label %for.end63
...
for.body:                                         ; preds = %for.cond56
  ...
  %call60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11)
  br label %for.inc61
...
for.end63:                                        ; preds = %for.cond56
  call void @llvm.lifetime.end.p0(i64 4000, ptr %sum) #3
