...
entry:
  ...
  %i3 = alloca i8, i32 0, align 4
  %a = alloca [1000 x [100 x i8]], align 16
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %j) #9
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 captures(none) dereferenceable(100000) %a) #9
  br label %for.cond
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %1 = load i32, ptr %j, align 4, !tbaa !8
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef captures(none) %a) #10
