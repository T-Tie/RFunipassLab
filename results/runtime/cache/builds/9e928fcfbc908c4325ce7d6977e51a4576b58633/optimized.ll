...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc31
  %indvars.iv14 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next15, %for.inc31 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc28
  ...
  %cmp8.not.not = icmp sgt i64 %indvars.iv, %indvars.iv14
...
for.cond36:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %for.end33
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 1, %for.end33 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.end46, label %for.inc44
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %arrayidx42 = getelementptr inbounds nuw [510 x i32], ptr %a, i64 0, i64 %indvars.iv18
