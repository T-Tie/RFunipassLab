...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp.not.not, label %for.inc, label %for.end
...
for.inc:                                          ; preds = %for.cond
  ...
  %arrayidx4 = getelementptr inbounds nuw float, ptr %vla1, i64 %indvars.iv
...
for.cond8:                                        ; preds = %for.body11, %for.end
  %7 = phi i32 [ %.pre, %for.body11 ], [ %3, %for.end ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body11 ], [ 1, %for.end ]
  %8 = sext i32 %7 to i64
  %cmp10.not.not = icmp slt i64 %indvars.iv10, %8
  br i1 %cmp10.not.not, label %for.body11, label %for.end33

for.body11:                                       ; preds = %for.cond8
  %arrayidx13 = getelementptr inbounds nuw float, ptr %vla1, i64 %indvars.iv10
  %9 = load float, ptr %arrayidx13, align 4, !tbaa !12, !invariant.load !14
  %arrayidx15 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv10
  %10 = load float, ptr %arrayidx15, align 4, !tbaa !12, !invariant.load !14
  ...
  %.str.1..str.2 = select i1 %cmp23, ptr @.str.1, ptr @.str.2
  %.str.sink = select i1 %cmp18, ptr @.str, ptr %.str.1..str.2
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.sink)
