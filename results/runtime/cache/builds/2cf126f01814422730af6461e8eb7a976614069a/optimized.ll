...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  ...
  %lenq.0 = phi i64 [ %indvars.iv28, %if.end44 ], [ %indvars.iv, %while.cond4.preheader ]
...
for.cond:                                         ; preds = %while.end19, %for.inc
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc ], [ 0, %while.end19 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %idx.ext6
  br i1 %exitcond38.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv34
...
for.cond33:                                       ; preds = %while.end19, %for.inc40
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc40 ], [ 0, %while.end19 ]
  %exitcond.not = icmp eq i64 %indvars.iv31, %idx.ext6
  br i1 %exitcond.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %add.ptr38 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv31
