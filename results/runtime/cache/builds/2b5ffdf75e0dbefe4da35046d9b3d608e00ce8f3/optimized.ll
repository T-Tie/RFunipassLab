...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %cmp76.not.not = icmp slt i64 %indvars.iv5, %10
...
for.body77:                                       ; preds = %for.cond74
  ...
  %16 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 24
  %17 = load double, ptr %16, align 8, !tbaa !9
  %18 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 32
  %19 = load double, ptr %18, align 16, !tbaa !9
  br i1 %cmp94, label %if.else117, label %if.then95

if.then95:                                        ; preds = %for.body77
  %cmp102 = fcmp une double %17, %19
  br i1 %cmp102, label %if.then103, label %if.else111

if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %17, double noundef %19) #12
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %20 = load double, ptr %arrayidx129, align 8, !tbaa !9
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %17, double noundef %19, double noundef %17, double noundef %20) #12
  br label %for.inc132
