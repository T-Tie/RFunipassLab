...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.6(ptr noundef nonnull align 8 dereferenceable(264) %0, i32 %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %2) unnamed_addr #5 {
sw.epilog.sink.split_after_outline.exitStub:
  %vtable.i224 = load ptr, ptr %0, align 8, !tbaa !18
  %vbase.offset.ptr.i225 = getelementptr i8, ptr %vtable.i224, i64 -24
  %vbase.offset.i226 = load i64, ptr %vbase.offset.ptr.i225, align 8, !invariant.load !20
