...
for.body19:                                       ; preds = %for.cond17
  ...
  %4 = load i64, ptr %gep106, align 8, !tbaa !14, !invariant.load !13
...
if.then30:                                        ; preds = %if.end
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx32) #6
...
for.body38:                                       ; preds = %for.cond36
  ...
  %5 = load i64, ptr %gep, align 8, !tbaa !14, !invariant.load !13
...
for.end57:                                        ; preds = %for.cond2
  ...
  %call.i.i40 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx59) #6
...
for.body65:                                       ; preds = %for.cond63
  ...
  %8 = load i64, ptr %gep107, align 8, !tbaa !14, !invariant.load !13
