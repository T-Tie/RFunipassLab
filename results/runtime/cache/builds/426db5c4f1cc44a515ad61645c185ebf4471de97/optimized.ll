...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc19 ], [ %idxprom2, %for.end ]
  %indvars21 = trunc i64 %indvars.iv12 to i32
  %cmp6 = icmp sgt i32 %indvars21, 0
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %indvars.iv.next13 = add nsw i64 %indvars.iv12, -1
  %idxprom9 = and i64 %indvars.iv.next13, 4294967295
  %arrayidx10 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %idxprom9
  %2 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %idxprom11 = and i64 %indvars.iv12, 2147483647
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.end47 ], [ %indvars.iv12, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next15 = add nsw i64 %indvars.iv14, -1
  %cmp23 = icmp sgt i64 %indvars.iv14, 0
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next15
  br label %for.cond29
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  ...
  %cmp30.not = icmp slt i64 %indvars.iv9, %indvars.iv14
...
land.lhs.true:                                    ; preds = %for.body31
  ...
  %spec.select5 = add nsw i32 %inc43, %p.1
  br label %for.inc45
...
for.end47:                                        ; preds = %for.cond29
  ...
  %arrayidx55 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next15
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv17 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next18, %for.body62 ]
...
for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv17
  %9 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select7 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
