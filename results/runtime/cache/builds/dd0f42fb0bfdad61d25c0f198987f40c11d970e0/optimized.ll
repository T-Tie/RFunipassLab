...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %m) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(100) %m, i8 0, i64 100, i1 false)
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %i) #5
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %d) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(100) %d, i8 0, i64 100, i1 false)
...
for.inc:                                          ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %idxprom
...
for.cond10:                                       ; preds = %for.cond10.loopexit, %for.cond10.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond10.loopexit ], [ %4, %for.cond10.preheader ]
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.cond10.loopexit ], [ %3, %for.cond10.preheader ]
  %indvars.iv.next18 = add nsw i64 %indvars.iv17, -1
  %cmp11 = icmp sgt i64 %indvars.iv17, 0
  br i1 %cmp11, label %for.body12, label %for.end35

for.body12:                                       ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next18
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next18
  br label %for.cond13

for.cond13:                                       ; preds = %for.inc31, %for.body12
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc31 ], [ %indvars.iv12, %for.body12 ]
  %indvars.iv.next15 = add nsw i64 %indvars.iv14, 1
  %cmp14 = icmp slt i64 %indvars.iv.next15, %4
  br i1 %cmp14, label %for.body15, label %for.cond10.loopexit

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %arrayidx19 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next15
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next15
  %8 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %cmp25.not = icmp sgt i32 %7, %8
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %9, %for.end35 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv20
  %10 = load i32, ptr %arrayidx41, align 4, !tbaa !5
  %spec.select = call i32 @llvm.smax.i32(i32 %10, i32 %dm.0)
...
for.end49:                                        ; preds = %for.cond37
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %d) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %i) #5
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %m) #5
