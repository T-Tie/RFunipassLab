...
for.cond4:                                        ; preds = %for.cond7, %for.cond4.preheader
  %indvars.iv6 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next7, %for.cond7 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.cond7 ]
  %exitcond17.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond17.not, label %for.cond42, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %2 = add nsw i64 %indvars.iv6, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv6
  %3 = trunc nsw i64 %indvars.iv.next7 to i32
  br label %for.cond7
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv10 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next11, %for.inc23 ]
  %indvars.iv8 = phi i64 [ %indvars.iv6, %for.cond10.preheader ], [ %indvars.iv.next9, %for.inc23 ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %for.inc23 ]
  %cmp12 = icmp slt i64 %indvars.iv8, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv8
...
for.cond42:                                       ; preds = %for.cond4, %for.body44
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body44 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond4 ]
  %exitcond21.not = icmp eq i64 %indvars.iv18, 1000
  br i1 %exitcond21.not, label %for.end54, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv18
...
if.then56:                                        ; preds = %for.end54
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2) #9
  br label %if.end83

if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %max.0) #9
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc80, %if.else58
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc80 ], [ 0, %if.else58 ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, 1000
  br i1 %exitcond28.not, label %if.end83, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv22
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc75
  %indvars.iv24 = phi i64 [ %indvars.iv22, %for.cond67.preheader ], [ %indvars.iv.next25, %for.inc75 ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %12, %11
  %13 = sext i32 %add68 to i64
  %cmp69 = icmp slt i64 %indvars.iv24, %13
  br i1 %cmp69, label %for.inc75, label %for.end77

for.inc75:                                        ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv24
  %14 = load i8, ptr %arrayidx72, align 1, !tbaa !13
  %conv73 = sext i8 %14 to i32
  %putchar4 = call i32 @putchar(i32 noundef %conv73) #9
