...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef %a) #6
...
for.cond4:                                        ; preds = %for.inc39, %for.end
  ...
  %i.0 = phi i32 [ 0, %for.end ], [ %add, %for.inc39 ]
...
for.cond10:                                       ; preds = %for.inc23, %for.body9
  ...
  %k.0 = phi i32 [ %i.0, %for.body9 ], [ %inc24, %for.inc23 ]
  %j.1 = phi i32 [ %j.0, %for.body9 ], [ %inc22, %for.inc23 ]
  %add11 = add nsw i32 %i.0, %1
...
for.body13:                                       ; preds = %for.cond10
  ...
  %2 = load i8, ptr %arrayidx15, align 1, !tbaa !12, !invariant.load !13
  ...
  %3 = load i8, ptr %arrayidx18, align 1, !tbaa !12, !invariant.load !13
...
if.then27:                                        ; preds = %for.end25
  ...
  %4 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !13
...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  ...
  %5 = phi i32 [ %inc53, %for.inc52 ], [ 0, %for.end41 ]
  %cmp43 = icmp slt i32 %5, 1000
...
for.body44:                                       ; preds = %for.cond42
  ...
  %6 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !13
  %cmp47 = icmp slt i32 %max.0, %6
...
for.inc52:                                        ; preds = %for.body44, %if.then48
  %max.1 = phi i32 [ %6, %if.then48 ], [ %max.0, %for.body44 ]
  %inc53 = add nsw i32 %5, 1
...
if.then56:                                        ; preds = %for.end54
  %call57 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #8
  br label %if.end83

if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %max.0) #8
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc80, %if.else58
  %7 = phi i32 [ %inc81, %for.inc80 ], [ 0, %if.else58 ]
  %cmp61 = icmp slt i32 %7, 1000
  br i1 %cmp61, label %for.body62, label %if.end83

for.body62:                                       ; preds = %for.cond60
  %idxprom63 = sext i32 %7 to i64
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  %j.3 = phi i32 [ %7, %if.then66 ], [ %inc76, %for.inc75 ]
  %9 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %7, %9
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %10 = load i8, ptr %arrayidx72, align 1, !tbaa !12
  %conv73 = sext i8 %10 to i32
  %call74 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %conv73) #8
  %inc76 = add nsw i32 %j.3, 1
  br label %for.cond67, !llvm.loop !18

for.end77:                                        ; preds = %for.cond67
  %call78 = call i32 (ptr, ...) @printf(ptr noundef @.str.5) #8
  br label %for.inc80

for.inc80:                                        ; preds = %for.body62, %for.end77
  %inc81 = add nsw i32 %7, 1
