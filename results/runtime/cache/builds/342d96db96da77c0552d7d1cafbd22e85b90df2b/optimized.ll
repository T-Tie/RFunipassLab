...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %exitcond25 = icmp eq i32 %i.0, %1
  br i1 %exitcond25, label %for.end, label %for.inc
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  ...
  br i1 %exitcond21, label %while.cond, label %for.cond6
...
for.cond15:                                       ; preds = %for.cond6, %for.inc30
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc30 ], [ 0, %for.cond6 ]
  %exitcond20.not = icmp eq i64 %indvars.iv17, 40
  br i1 %exitcond20.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv17
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !12
  %div = sdiv i32 %4, 10
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %arrayidx21 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv.next18
  %5 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %add22 = add nsw i32 %5, %div
...
while.cond:                                       ; preds = %for.cond3, %while.cond
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %while.cond ], [ 39, %for.cond3 ]
  %arrayidx37 = getelementptr inbounds [40 x i32], ptr %sum, i64 0, i64 %indvars.iv22
...
for.cond39.preheader:                             ; preds = %while.cond
  %7 = trunc nsw i64 %indvars.iv22 to i32
  br label %for.cond39
