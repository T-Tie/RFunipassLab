...
for.end15:                                        ; preds = %for.cond5
  br i1 true, label %if.then17, label %for.inc24
...
for.inc24:                                        ; preds = %for.end15, %if.then17, %for.end15.thread
  %j.1 = phi i32 [ %j.0, %for.end15.thread ], [ %add, %if.then17 ], [ poison, %for.end15 ]
