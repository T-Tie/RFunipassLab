...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax104 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.cond72.preheader:                             ; preds = %for.cond69
  %5 = add nsw i64 %indvars.iv99, -1
  %6 = trunc nuw nsw i64 %indvars.iv99 to i32
  br label %for.cond72
...
lor.lhs.false.thread:                             ; preds = %for.body75
  %7 = trunc nuw nsw i64 %indvars.iv92 to i32
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %8 = load i32, ptr %arrayidx101, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %5, i64 %indvars.iv92
  store i32 %8, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

for.inc122.gvnsink.split:                         ; preds = %lor.lhs.false.thread, %land.lhs.true
  %indvars.iv99.sink = phi i64 [ %indvars.iv99, %land.lhs.true ], [ %5, %lor.lhs.false.thread ]
  ...
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv99.sink, i64 %10
