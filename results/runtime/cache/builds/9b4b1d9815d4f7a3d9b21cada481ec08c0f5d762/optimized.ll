...
for.cond45:                                       ; preds = %for.inc77, %for.end44
  %i.3 = phi i32 [ 0, %for.end44 ], [ %add49, %for.inc77 ]
  %sub46 = sub nsw i32 %.lcssa, 1
...
for.cond50:                                       ; preds = %for.inc74, %for.body48
  %j.1 = phi i32 [ %add49, %for.body48 ], [ %inc75, %for.inc74 ]
  %cmp51 = icmp slt i32 %j.1, %.lcssa
