...
if.then8:                                         ; preds = %if.end
  %fneg9 = fneg double %2
  %call13.i = tail call double @sqrt(double noundef %6) #10, !tbaa !5, !noalias !11
  ...
  %call23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %7) #11
  ...
  %call26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %8) #11
...
if.then30:                                        ; preds = %if.end28
  ...
  tail call fastcc void @outlined_ir_func_0.6() #11
...
if.then39:                                        ; preds = %if.end37
  ...
  %11 = load double, ptr @a, align 8, !tbaa !9, !noalias !14
  %mul46.i = fmul double %11, 4.000000e+00
  %12 = load double, ptr @c, align 8, !tbaa !9, !noalias !14
  %13 = load double, ptr @b, align 8, !tbaa !9, !noalias !14
  %14 = fneg double %13
  %neg49.i = fmul double %13, %14
  %15 = tail call double @llvm.fmuladd.f64(double %mul46.i, double %12, double %neg49.i) #12
  %call50.i = tail call double @sqrt(double noundef %15) #10, !tbaa !5, !noalias !14
  %mul51 = fmul double %11, 2.000000e+00
  %div52 = fdiv double %call50.i, %mul51
  %call53 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %div52) #11
  ...
  tail call fastcc void @outlined_ir_func_0.6() #11
  %16 = load double, ptr @a, align 8, !tbaa !9, !noalias !17
  %mul46.i5 = fmul double %16, 4.000000e+00
  %17 = load double, ptr @c, align 8, !tbaa !9, !noalias !17
  %18 = load double, ptr @b, align 8, !tbaa !9, !noalias !17
  %19 = fneg double %18
  %neg49.i6 = fmul double %18, %19
  %20 = tail call double @llvm.fmuladd.f64(double %mul46.i5, double %17, double %neg49.i6) #12
  %call50.i7 = tail call double @sqrt(double noundef %20) #10, !tbaa !5, !noalias !17
  %fneg66 = fneg double %call50.i7
  %mul67 = fmul double %16, 2.000000e+00
  %div68 = fdiv double %fneg66, %mul67
  %call69 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %div68) #11
...
define internal fastcc void @outlined_ir_func_0.6() unnamed_addr #8 {
if.then30_after_outline.exitStub:
  ...
  %call35 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %div34) #13
  ret void
}
...
attributes #10 = { nofree nounwind willreturn memory(write) }
