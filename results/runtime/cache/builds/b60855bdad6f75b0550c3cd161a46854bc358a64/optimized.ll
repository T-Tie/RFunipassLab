...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv3, %1
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv9, %5
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %6, i32 0)
  %wide.trip.count19 = zext nneg i32 %smax18 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc25 ], [ 0, %for.cond12 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv6, %9
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv9, i64 %indvars.iv6
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv15 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next16, %for.inc46 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %smax25 = call i32 @llvm.smax.i32(i32 %4, i32 0)
...
for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv15, i64 %indvars.iv12
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc83
  %indvars.iv34 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next35, %for.inc83 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count19
  br i1 %exitcond38.not, label %for.cond86, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc80
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc80 ], [ 0, %for.cond49 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count32
  br i1 %exitcond33.not, label %for.inc83, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv34, i64 %indvars.iv28
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc77
  %indvars.iv21 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next22, %for.inc77 ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count26
  br i1 %exitcond27.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond57
  %10 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv21
  %11 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv21, i64 %indvars.iv28
...
for.cond86:                                       ; preds = %for.cond49, %for.inc109
  ...
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc109 ], [ 0, %for.cond49 ]
  %15 = sext i32 %14 to i64
  %cmp88.not.not = icmp slt i64 %indvars.iv42, %15
  br i1 %cmp88.not.not, label %for.cond90, label %for.end111

for.cond90:                                       ; preds = %for.cond86, %for.body93
  %16 = phi i32 [ %.pre45, %for.body93 ], [ %13, %for.cond86 ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.body93 ], [ 0, %for.cond86 ]
  %17 = sext i32 %16 to i64
  %cmp92.not.not = icmp slt i64 %indvars.iv39, %17
  br i1 %cmp92.not.not, label %for.body93, label %for.inc109

for.body93:                                       ; preds = %for.cond90
  %sub91 = add nsw i32 %16, -1
  %18 = sext i32 %sub91 to i64
  %cmp95 = icmp slt i64 %indvars.iv39, %18
  %19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv42, i64 %indvars.iv39
  ...
  %.pre45 = load i32, ptr %y2, align 4, !tbaa !5
