...
for.inc:                                          ; preds = %for.cond3
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i) #8
...
define internal fastcc void @outlined_ir_func_0(i8 %0, ptr noundef nonnull dereferenceable(1) %1) unnamed_addr #6 {
