...
while.cond:                                       ; preds = %if.end29, %entry
  ...
  %or.cond8 = select i1 %call16.i, i1 %or.cond.i, i1 false
  br i1 %or.cond8, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
