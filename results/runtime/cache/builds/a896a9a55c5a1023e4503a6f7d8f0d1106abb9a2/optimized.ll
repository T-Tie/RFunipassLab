...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %mul19.pre-phi = phi double [ %.pre18, %if.then ], [ %mul2, %for.body ]
  %6 = phi double [ %.pre14, %if.then ], [ %3, %for.body ]
  %7 = phi double [ %.pre13, %if.then ], [ %2, %for.body ]
  %8 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp22 = fcmp oeq double %.pre-phi22, 0.000000e+00
...
if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi28 = phi double [ %.pre27, %if.then23 ], [ %.pre-phi22, %if.end ]
  %mul30.pre-phi = phi double [ %.pre23, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre17, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre16, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre15, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi28, 0.000000e+00
