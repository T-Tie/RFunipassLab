...
entry:
  ...
  %call7 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %b) #6
...
for.end68:                                        ; No predecessors!
  unreachable

if.else76:                                        ; No predecessors!
  unreachable

cleanup:                                          ; preds = %land.lhs.true, %for.cond, %entry
  %call77 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2) #7
