...
for.cond1.preheader:                              ; preds = %for.cond
  %7 = mul nuw nsw i64 %indvars.iv17, %3
...
for.end28:                                        ; preds = %for.cond12
  ...
  %vla29 = alloca i32, i64 %23, align 16
  %smax = call i32 @llvm.smax.i32(i32 %15, i32 0)
  %smax32 = call i32 @llvm.smax.i32(i32 %20, i32 0)
  %wide.trip.count33 = zext nneg i32 %smax32 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc43, %for.end28
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc43 ], [ 0, %for.end28 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count33
  br i1 %exitcond34.not, label %for.cond46.preheader, label %for.cond33.preheader

for.cond46.preheader:                             ; preds = %for.cond30
  %smax39 = call i32 @llvm.smax.i32(i32 %16, i32 0)
...
for.cond33.preheader:                             ; preds = %for.cond30
  %24 = mul nuw nsw i64 %indvars.iv29, %22
  %arrayidx37 = getelementptr inbounds nuw i32, ptr %vla29, i64 %24
  br label %for.cond33

for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv26 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next27, %for.inc40 ]
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv26
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv47 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next48, %for.inc77 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count33
  br i1 %exitcond51.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %25 = mul nuw nsw i64 %indvars.iv47, %22
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %25
  %26 = mul nuw nsw i64 %indvars.iv47, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %26
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv42 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next43, %for.inc74 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv42
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv42
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv35 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next36, %for.inc71 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count40
  br i1 %exitcond41.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %27 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !15
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv35
  %28 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !15
  %29 = mul nuw nsw i64 %indvars.iv35, %13
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %29
  %30 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !15
  %mul = mul nsw i32 %30, %28
...
for.cond80:                                       ; preds = %for.cond46, %for.end97
  %31 = phi i32 [ %.pre58, %for.end97 ], [ %20, %for.cond46 ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.end97 ], [ 0, %for.cond46 ]
  %cmp81 = icmp sgt i32 %31, 0
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %call86 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef undef)
  %32 = mul nuw nsw i64 %indvars.iv55, %22
  %arrayidx91 = getelementptr inbounds nuw i32, ptr %vla29, i64 %32
  br label %for.cond87

for.cond87:                                       ; preds = %for.body89, %for.body82
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body89 ], [ 1, %for.body82 ]
  %33 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp88 = icmp sgt i32 %33, 1
  br i1 %cmp88, label %for.body89, label %for.end97

for.body89:                                       ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx91, i64 %indvars.iv52
  %34 = load i32, ptr %arrayidx93, align 4, !tbaa !5, !invariant.load !15
  %call94 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %34)
...
for.end97:                                        ; preds = %for.cond87
  ...
  %.pre58 = load i32, ptr %x1, align 4, !tbaa !5
  br label %for.cond80
