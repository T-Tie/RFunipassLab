...
land.lhs.true.i:                                  ; preds = %entry
  call void @outlined_ir_func_0.4(ptr %add.ptr10.i)
...
land.lhs.true.i15_to_outline:                     ; preds = %newFuncRoot
  ...
  call void @outlined_ir_func_0.4(ptr %1)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0) unnamed_addr #6 {
newFuncRoot:
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline: ; preds = %newFuncRoot
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(300) %0) #9
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_0.4(ptr %0) #6 {
newFuncRoot:
...
land.lhs.true.i_to_outline:                       ; preds = %newFuncRoot
  ...
  %1 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !23, !invariant.load !8
  %2 = add i64 %1, -301
...
if.then19.i:                                      ; preds = %land.lhs.true.i_to_outline
  ...
  %3 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !24, !invariant.load !8
...
!23 = !{!10, !11, i64 16}
!24 = !{!25, !28, i64 232}
!25 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0, !26, i64 216, !12, i64 224, !27, i64 225, !28, i64 232, !29, i64 240, !30, i64 248, !31, i64 256}
