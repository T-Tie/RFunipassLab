...
if.then6.i:                                       ; preds = %for.body
  ...
  %3 = load i64, ptr %gep53, align 8, !tbaa !12
...
if.then:                                          ; preds = %for.body4
  ...
  store i8 32, ptr %arrayidx29, align 1, !tbaa !26
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax65 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %6 = add i32 %smax65, 1
...
if.then99:                                        ; preds = %for.body96
  %8 = load i8, ptr %arrayidx103, align 1, !tbaa !26
...
if.else106:                                       ; preds = %for.body96
  ...
  %9 = load i8, ptr %arrayidx110, align 1, !tbaa !26
