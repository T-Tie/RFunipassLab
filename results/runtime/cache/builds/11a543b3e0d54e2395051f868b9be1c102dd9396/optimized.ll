...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !15, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !23, !invariant.load !11
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !24, !invariant.load !11
...
!17 = !{!"_ZTSNSt6locale5facetE", !10, i64 8}
