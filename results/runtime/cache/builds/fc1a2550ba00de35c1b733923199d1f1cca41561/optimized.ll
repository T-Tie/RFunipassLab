...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc28 ], [ 0, %entry ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count31
  br i1 %exitcond32.not, label %for.cond31.preheader, label %for.body

for.cond31.preheader:                             ; preds = %for.cond
  br label %for.cond31

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv28
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv23 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next24, %for.inc25 ]
...
for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv28, i64 %indvars.iv23
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc69
  %indvars.iv43 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next44, %for.inc69 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count31
  br i1 %exitcond47.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv43
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select21, %for.body39 ], [ %3, %for.body33 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond37.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv33, i64 %indvars.iv43
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select21 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv38 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next39, %for.inc66 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count
  br i1 %exitcond42.not, label %for.inc69, label %for.inc66

for.inc66:                                        ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv43
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = call i32 @llvm.smax.i32(i32 %n, i32 0)
  %smax13 = call i32 @llvm.smax.i32(i32 %sub, i32 1)
  %wide.trip.count14 = zext nneg i32 %smax13 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond1, %entry
  %indvars.iv10 = phi i64 [ 1, %entry ], [ %indvars.iv.next11, %for.cond1 ]
  %exitcond15.not = icmp eq i64 %indvars.iv10, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond13.preheader, label %for.cond1.preheader
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next11, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
  store i32 %0, ptr %arrayidx9, align 4, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !18

for.cond13:                                       ; preds = %for.cond17, %for.cond13.preheader
  %indvars.iv21 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next22, %for.cond17 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count14
  br i1 %exitcond25.not, label %for.end35, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  %indvars.iv16 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next17, %for.inc30 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond13, label %for.inc30, !llvm.loop !19

for.inc30:                                        ; preds = %for.cond17
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv.next22
  %1 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %arrayidx29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv21
...
for.cond1:                                        ; preds = %for.inc12, %for.body
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc12 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc17:                                        ; preds = %for.cond1
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call15, i8 noundef signext %call.i7)
