...
for.cond7:                                        ; preds = %for.inc, %if.then
  %.sink7 = phi i32 [ 1, %if.then ], [ %inc, %for.inc ]
  %2 = phi i32 [ %inc, %for.inc ], [ 1, %if.then ]
  %n1.0 = phi i32 [ 0, %if.then ], [ %add28, %for.inc ]
  store i32 %.sink7, ptr %j, align 4, !tbaa !5
...
for.inc:                                          ; preds = %if.else, %lor.lhs.false13, %lor.lhs.false15, %lor.lhs.false17, %lor.lhs.false19, %lor.lhs.false21, %lor.lhs.false23, %for.body9, %if.else27
  %.sink2 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %lor.lhs.false23 ], [ 31, %lor.lhs.false21 ], [ 31, %lor.lhs.false19 ], [ 31, %lor.lhs.false17 ], [ 31, %lor.lhs.false15 ], [ 31, %lor.lhs.false13 ], [ 31, %if.else ]
  %add28 = add nsw i32 %n1.0, %.sink2
  %inc = add nsw i32 %2, 1
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2, i32 noundef %3, i32 %4, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %5) unnamed_addr #3 {
for.end_to_outline:
  br label %for.cond30
...
for.cond30:                                       ; preds = %for.inc56, %for.end_to_outline
  ...
  %7 = load i32, ptr %1, align 4, !tbaa !5, !invariant.load !14
...
if.end79.exitStub:                                ; preds = %if.else76, %if.then74, %if.end68
  ret void
}
