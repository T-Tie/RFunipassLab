...
land.lhs.true.i:                                  ; preds = %entry
  ...
  br i1 %or.cond.i, label %if.then19.i20, label %land.lhs.true.i15
...
if.then19.i20:                                    ; preds = %land.lhs.true.i
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(240) %add.ptr10.i)
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(1000) %b, i64 noundef 1000)
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(240) %add.ptr10.i)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %land.lhs.true.i15, %if.then19.i20, %if.then6.i8
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond37.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv33
  %5 = load i8, ptr %arrayidx54, align 1, !tbaa !23, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv33
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(240) %0) unnamed_addr #7 {
if.then19.i_to_outline:
  %_M_streambuf.i.i = getelementptr inbounds nuw i8, ptr %0, i64 232
  %1 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !30, !invariant.load !8
  %call25.i = tail call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %1)
