...
for.cond13:                                       ; preds = %for.inc135, %for.end12
  ...
  %c.0 = phi i32 [ %.lcssa, %for.end12 ], [ %dec, %for.inc135 ]
...
for.end33:                                        ; preds = %for.cond19
  %min.0.lcssa = phi i32 [ %min.0, %for.cond19 ]
  br label %for.cond34
...
for.end70:                                        ; preds = %for.cond54
  %min.2.lcssa = phi i32 [ %min.2, %for.cond54 ]
  br label %for.cond71
...
for.inc83:                                        ; preds = %for.cond71
  ...
  %sub78 = sub nsw i32 %6, %min.2.lcssa
...
for.cond91:                                       ; preds = %for.inc110, %for.end88
  %i.4 = phi i32 [ 1, %for.end88 ], [ %inc111.lcssa, %for.inc110 ]
...
for.inc110:                                       ; preds = %for.cond95
  %inc111.lcssa = phi i32 [ %inc111, %for.cond95 ]
  br label %for.cond91, !llvm.loop !20

for.end112:                                       ; preds = %for.cond91
  %sub92.lcssa = phi i32 [ %sub92, %for.cond91 ]
  br label %for.cond113

for.cond113:                                      ; preds = %for.inc132, %for.end112
  %j.5 = phi i32 [ 1, %for.end112 ], [ %inc133.lcssa, %for.inc132 ]
...
for.cond116:                                      ; preds = %for.inc129, %for.body115
  ...
  %cmp118 = icmp slt i32 %i.5, %sub92.lcssa
...
for.inc132:                                       ; preds = %for.cond116
  %inc133.lcssa = phi i32 [ %inc133, %for.cond116 ]
...
for.inc139:                                       ; preds = %for.cond13
  %sum.0.lcssa = phi i32 [ %sum.0, %for.cond13 ]
  %call137 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %sum.0.lcssa)
