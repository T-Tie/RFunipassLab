...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv33 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next34, %for.inc27 ]
  %exitcond38 = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc21 ], [ 1, %for.cond10 ]
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.123 = phi i32 [ %7, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %9, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %10 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc48 ], [ %10, %for.end29 ]
  %11 = trunc nuw i64 %indvars.iv40 to i32
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv40, i64 %idxprom38
  %13 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !13
