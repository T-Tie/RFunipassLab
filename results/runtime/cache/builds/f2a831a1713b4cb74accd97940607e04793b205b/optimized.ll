...
if.else:                                          ; preds = %land.lhs.true
  ...
  %spec.select16 = add nsw i32 %a.0, %inc19
  br label %for.inc

for.inc:                                          ; preds = %if.else, %for.body, %if.then
  %a.1 = phi i32 [ %inc, %if.then ], [ %a.0, %for.body ], [ %spec.select16, %if.else ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv18
...
if.then46:                                        ; preds = %for.end44
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %2, i32 noundef %t.1)
  br label %for.inc51
...
for.cond54:                                       ; preds = %for.cond26, %for.inc80
  ...
  %exitcond24.not = icmp eq i32 %4, 123
  br i1 %exitcond24.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select15, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv21
...
for.body62:                                       ; preds = %for.cond57
  ...
  %spec.select15 = add nuw nsw i32 %l.1, %inc68
...
if.then74:                                        ; preds = %for.end72
  %call78 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %4, i32 noundef %l.1)
  br label %for.inc80
