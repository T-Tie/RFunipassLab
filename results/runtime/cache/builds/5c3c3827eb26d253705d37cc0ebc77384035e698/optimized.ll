...
land.lhs.true.i15:                                ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i
  ...
  %5 = add i64 %4, -1001
  %or.cond.i19 = icmp ult i64 %5, -1000
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %8 = load i8, ptr %arrayidx28, align 1, !tbaa !31, !invariant.load !8
...
for.body52:                                       ; preds = %for.cond50
  ...
  %9 = load i8, ptr %arrayidx54, align 1, !tbaa !31, !invariant.load !8
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv48
  %10 = load i8, ptr %arrayidx57, align 1, !tbaa !31, !invariant.load !8
  %cmp59 = icmp eq i8 %9, %10
...
for.end65:                                        ; preds = %for.cond50
  ...
  %11 = load double, ptr %w, align 8, !tbaa !36
  %cmp68 = fcmp ult double %div, %11
