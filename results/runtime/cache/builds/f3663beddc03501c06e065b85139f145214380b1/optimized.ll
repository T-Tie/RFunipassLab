...
if.then95:                                        ; preds = %for.body77
  ...
  %11 = load double, ptr %arrayidx98, align 8, !tbaa !9, !invariant.load !11
  %arrayidx101 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %12 = load double, ptr %arrayidx101, align 16, !tbaa !9, !invariant.load !11
...
if.else117:                                       ; preds = %for.body77
  ...
  %13 = load double, ptr %arrayidx120, align 8, !tbaa !9, !invariant.load !11
  %arrayidx123 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %14 = load double, ptr %arrayidx123, align 16, !tbaa !9, !invariant.load !11
...
declare i32 @getchar() local_unnamed_addr #8
