...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #13
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 81000, ptr noundef nonnull align 16 %newword) #13
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(81000) %newword, i8 noundef 0, i64 noundef 81000, i1 noundef false) #14
...
if.then6.i:                                       ; preds = %for.body
  ...
  %call16.i = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #15
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #15
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv50, %5
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv50
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #16
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx6) #15
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx6) #15
...
if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #15
  br label %if.end

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #15
  br label %if.end

if.end:                                           ; preds = %if.else58, %if.then44
  %idxprom69 = sext i32 %add to i64
  %arrayidx70 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom45, i64 %idxprom69
  store i8 32, ptr %arrayidx70, align 1, !tbaa !24
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax60 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %6 = add i32 %smax60, 1
  %wide.trip.count61 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond62 = icmp eq i64 %indvars.iv56, %wide.trip.count61
  br i1 %exitcond62, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv56
  %call92 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx90) #16
  %conv93 = trunc i64 %call92 to i32
  %sub97 = add i64 %call92, 4294967295
  %7 = and i64 %sub97, 4294967295
  %smax = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv56, i64 %7
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv53, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv53, %7
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv56, i64 %indvars.iv53
...
for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 noundef 81000, ptr noundef nonnull %newword) #15
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef nonnull %word) #15
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #15
  ret i32 0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !24, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !24, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !35, !invariant.load !9
...
!28 = !{!29, !7, i64 56}
!29 = !{!"_ZTSSt5ctypeIcE", !30, i64 0, !31, i64 16, !32, i64 24, !33, i64 32, !33, i64 40, !34, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!30 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!31 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!32 = !{!"bool", !7, i64 0}
!33 = !{!"p1 int", !16, i64 0}
!34 = !{!"p1 short", !16, i64 0}
!35 = !{!36, !36, i64 0}
