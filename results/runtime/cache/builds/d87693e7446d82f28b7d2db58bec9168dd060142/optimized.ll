...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %a) #11
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(256) %a, i8 noundef 0, i64 noundef 256, i1 noundef false) #12
  ...
  br i1 %or.cond, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
...
if.then19.i:                                      ; preds = %entry
  ...
  br i1 %tobool.not.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82, label %if.then28.i
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82: ; preds = %if.then28.i, %if.then19.i, %entry
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(256) %b)
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(256) %c)
  ...
  %2 = load i8, ptr %b, align 16
  %smax = call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %conv9, i32 noundef 1)
  %smax117 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
  %indvars.iv128 = phi i32 [ %indvars.iv.next129, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82 ]
  %exitcond119.not = icmp eq i64 %indvars.iv, %wide.trip.count118
  br i1 %exitcond119.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.inc ], [ 1, %for.body ]
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv111, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next110
  %4 = load i8, ptr %arrayidx18, align 1, !tbaa !22
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv111
  %5 = load i8, ptr %arrayidx21, align 1, !tbaa !22
...
for.end:                                          ; preds = %for.cond14, %for.end.split.loop.exit
  %j.0.lcssa = phi i32 [ %6, %for.end.split.loop.exit ], [ %smax, %for.cond14 ]
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count126 = and i64 %indvars.iv, 4294967295
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv120 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next121, %for.inc43 ]
  %exitcond127.not = icmp eq i64 %indvars.iv120, %wide.trip.count126
  br i1 %exitcond127.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv120
  %7 = load i8, ptr %arrayidx41, align 1, !tbaa !22
  %call42 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %7)
...
for.end45:                                        ; preds = %for.cond37
  ...
  %8 = sext i32 %indvars.iv128 to i64
  %sext = shl i64 %call6, 32
  %9 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv131 = phi i64 [ %indvars.iv.next132, %for.inc54 ], [ %8, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv131, %9
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv131
  %10 = load i8, ptr %arrayidx52, align 1, !tbaa !22
...
if.end57:                                         ; preds = %for.cond48, %if.then34
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %a) #13
  ret i32 0
}
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(256) %0) unnamed_addr #10 {
if.then6.i10_to_outline:
  ...
  %1 = load i64, ptr %_M_width.i1.i15, align 8, !tbaa !9
  tail call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(256) %0, i64 noundef 256)
  ...
  %call16.i20 = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i19) #13
  %2 = add i64 %1, -257
  %or.cond.i24 = icmp ult i64 %2, -256
  %or.cond105 = select i1 %call16.i20, i1 %or.cond.i24, i1 false
  br i1 %or.cond105, label %if.then19.i25, label %if.then6.i51.exitStub

if.then19.i25:                                    ; preds = %if.then6.i10_to_outline
  ...
  %call24.i30 = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i29) #13
  %call25.i31 = tail call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %call24.i30)
  %cmp.i.i32 = icmp eq i32 %call25.i31, -1
  %conv.i33 = zext i1 %cmp.i.i32 to i64
  %expval.i34 = tail call i64 @llvm.expect.i64(i64 noundef %conv.i33, i64 noundef 1)
  %tobool.not.i35 = icmp eq i64 %expval.i34, 0
  br i1 %tobool.not.i35, label %if.then6.i51.exitStub, label %if.then28.i36
...
if.then28.i36:                                    ; preds = %if.then19.i25
  ...
  tail call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr32.i40, i32 noundef 2)
  br label %if.then6.i51.exitStub

if.then6.i51.exitStub:                            ; preds = %if.then28.i36, %if.then19.i25, %if.then6.i10_to_outline
  ret void
}
