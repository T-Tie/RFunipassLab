...
for.cond:                                         ; preds = %for.end12, %entry
  %k.0 = phi i32 [ 0, %entry ], [ %inc11.i2, %for.end12 ]
...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.end ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.end12:                                        ; preds = %for.cond1
  ...
  %inc11.i2 = add nuw nsw i32 %k.0, 1
  br label %for.cond
...
for.cond:                                         ; preds = %for.end26, %tailrecurse
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.end26 ], [ 0, %tailrecurse ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %wide.trip.count36
  br i1 %exitcond37.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv33
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv33, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body19 ], [ 0, %for.cond16.preheader ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond32.not, label %for.end26, label %for.body19

for.body19:                                       ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv33, i64 %indvars.iv28
...
for.cond31:                                       ; preds = %for.cond, %for.end69
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.end69 ], [ 0, %for.cond ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count36
  br i1 %exitcond53.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv48
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select26, %for.body42 ], [ %3, %for.body34 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %wide.trip.count
  br i1 %exitcond42.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv38, i64 %indvars.iv48
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !12
  %spec.select26 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond39

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body61
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.body61 ], [ 0, %for.cond58.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond47.not, label %for.end69, label %for.body61

for.body61:                                       ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
