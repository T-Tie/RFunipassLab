...
for.cond4:                                        ; preds = %for.cond7, %for.cond4.preheader
  %indvars.iv49 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next50, %for.cond7 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.cond7 ]
  %exitcond58.not = icmp eq i64 %indvars.iv49, %wide.trip.count
  br i1 %exitcond58.not, label %for.cond42, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %2 = add nsw i64 %indvars.iv49, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv49
  %3 = trunc nsw i64 %indvars.iv.next50 to i32
  br label %for.cond7
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv51 = phi i64 [ %indvars.iv49, %for.cond10.preheader ], [ %indvars.iv.next52, %for.inc23 ]
  %indvars.iv47 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next48, %for.inc23 ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %for.inc23 ]
  %cmp12 = icmp slt i64 %indvars.iv51, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv51
  %5 = load i8, ptr %arrayidx15, align 1, !tbaa !13, !invariant.load !14
  %arrayidx18 = getelementptr inbounds [1000 x i8], ptr %a, i64 0, i64 %indvars.iv47
...
for.end25:                                        ; preds = %for.body13, %for.cond10
  ...
  %7 = trunc nsw i64 %indvars.iv47 to i32
...
for.cond42:                                       ; preds = %for.cond4, %for.body44
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.body44 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond4 ]
  %exitcond62.not = icmp eq i64 %indvars.iv59, 1000
  br i1 %exitcond62.not, label %for.end54, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv59
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc80 ], [ 0, %if.else58 ]
  %exitcond69.not = icmp eq i64 %indvars.iv63, 1000
  br i1 %exitcond69.not, label %if.end83, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv63
...
for.cond67.preheader:                             ; preds = %for.body62
  %11 = trunc nuw nsw i64 %indvars.iv63 to i32
  br label %for.cond67

for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc75
  %indvars.iv65 = phi i64 [ %indvars.iv63, %for.cond67.preheader ], [ %indvars.iv.next66, %for.inc75 ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %12, %11
  %13 = sext i32 %add68 to i64
  %cmp69 = icmp slt i64 %indvars.iv65, %13
  br i1 %cmp69, label %for.inc75, label %for.end77

for.inc75:                                        ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv65
  %14 = load i8, ptr %arrayidx72, align 1, !tbaa !13
  %conv73 = sext i8 %14 to i32
  %putchar45 = call i32 @putchar(i32 noundef %conv73) #7
