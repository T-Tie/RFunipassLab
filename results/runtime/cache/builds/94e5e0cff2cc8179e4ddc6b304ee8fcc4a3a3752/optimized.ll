...
if.then:                                          ; preds = %for.body15
  %arrayidx18 = getelementptr inbounds [8 x [8 x i32]], ptr %a, i64 0, i64 %idxprom20
...
if.then41:                                        ; preds = %for.body39
  %arrayidx44 = getelementptr inbounds [8 x i32], ptr %a, i64 0, i64 %idxprom48
...
if.then65:                                        ; preds = %land.lhs.true63
  %call66 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %i.1, i32 noundef %r.1) #5
...
if.end78:                                         ; preds = %if.then76, %for.end74
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %a) #5
  ret i32 0
}
