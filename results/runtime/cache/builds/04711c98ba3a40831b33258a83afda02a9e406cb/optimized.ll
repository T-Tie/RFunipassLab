...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %a) #6
...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %max1.0 = phi i32 [ %spec.select, %for.body ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %2, i32 %max1.0)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv17 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next18, %for.body9 ]
  %max2.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select14, %for.body9 ]
  %exitcond.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv17
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !9
  %cmp15 = icmp slt i32 %3, %max1.0
  %4 = call i32 @llvm.smax.i32(i32 %3, i32 %max2.0)
  %spec.select14 = select i1 %cmp15, i32 %4, i32 %max2.0
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  br label %for.cond7, !llvm.loop !13

for.end22:                                        ; preds = %for.cond7
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max1.0)
  %vtable.i = load ptr, ptr %call23, align 8, !tbaa !14, !invariant.load !9
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call23, i8 noundef signext %call.i1)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max2.0)
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef nonnull %a) #7
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !16, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !40, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !14, !invariant.load !9
