...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef range(i32 -2147483648, 2147483647) i32 @_Z5qufeni(i32 noundef %1) #11
  %2 = call i32 @llvm.smax.i32(i32 noundef %call2, i32 noundef 1)
  %smax = add nuw nsw i32 %2, 1
  br label %for.cond
...
for.inc:                                          ; preds = %for.cond
  %call4 = call noundef i32 @_Z3numiii(i32 noundef %1, i32 noundef %i.0, i32 noundef 2) #11
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax23 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  ...
  %exitcond24.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond24.not, label %cleanup, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %div = sdiv i32 %n, %0
  %call = tail call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !18, !invariant.load !16
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !26, !invariant.load !16
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !27, !invariant.load !16
