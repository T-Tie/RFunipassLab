...
if.then:                                          ; preds = %for.body
  ...
  %.pre5 = load float, ptr %x, align 4, !tbaa !9
  %.pre6 = load float, ptr %y1, align 4, !tbaa !9
  %.pre7 = load float, ptr %x1, align 4, !tbaa !9
  %.pre12 = fdiv float %.pre, %.pre5
  %.pre13 = fdiv float %.pre6, %.pre7
  %.pre14 = fsub float %.pre12, %.pre13
  %.pre15 = fpext float %.pre14 to double
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %conv10.pre-phi = phi double [ %.pre15, %if.then ], [ %conv, %for.body ]
  %sub9.pre-phi = phi float [ %.pre14, %if.then ], [ %sub4, %for.body ]
  %cmp11 = fcmp olt double %conv10.pre-phi, -5.000000e-02
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end
  %puts3 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #6
  %.pre8 = load float, ptr %y, align 4, !tbaa !9
  %.pre9 = load float, ptr %x, align 4, !tbaa !9
  %.pre10 = load float, ptr %y1, align 4, !tbaa !9
  %.pre11 = load float, ptr %x1, align 4, !tbaa !9
  %.pre16 = fdiv float %.pre8, %.pre9
  %.pre17 = fdiv float %.pre10, %.pre11
  %.pre18 = fsub float %.pre16, %.pre17
  br label %if.end14

if.end14:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi float [ %.pre18, %if.then12 ], [ %sub9.pre-phi, %if.end ]
...
if.then25:                                        ; preds = %if.end14
  %puts4 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #6
  br label %for.inc
