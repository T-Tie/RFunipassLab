...
for.inc43:                                        ; preds = %for.cond37
  ...
  call void @outlined_ir_func_0(i8 %17, ptr %__c.addr.i)
...
for.inc54:                                        ; preds = %for.cond48
  ...
  %20 = load i8, ptr %arrayidx52, align 1, !tbaa !30
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i97)
  call void @outlined_ir_func_0(i8 %20, ptr %__c.addr.i97)
...
define internal void @outlined_ir_func_0(i8 %0, ptr %1) #8 {
for.body39_to_outline:
  ...
  %2 = load i64, ptr %gep, align 8, !tbaa !8
