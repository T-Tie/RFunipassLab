...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %t) #10
...
if.then.i.i:                                      ; preds = %for.end
  ...
  %3 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %sub.ptr.div.i.i, i1 true)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end, %if.then.i.i
  ...
  %call7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4) #11
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %6) #11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond9, !llvm.loop !12

for.end18:                                        ; preds = %for.cond9
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull captures(none) %a) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %t) #11
...
if.end:                                           ; preds = %while.body
  ...
  %div.i1 = lshr i64 %sub.ptr.sub, 3
  %add.ptr.i = getelementptr inbounds nuw i32, ptr %__first, i64 %div.i1
  ...
  %call.i = tail call noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef nonnull align 4 %add.ptr1.i, ptr noundef nonnull %__last.addr.0, ptr noundef nonnull align 4 %__first) #11
...
for.inc.i:                                        ; preds = %for.cond.i
  tail call void @_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_(ptr noundef nonnull align 4 %__i.0.i)
...
if.end:                                           ; preds = %entry
  ...
  %div56 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div56, %if.end ], [ %dec, %while.body ]
  ...
  br i1 %cmp5, label %return, label %while.body, !llvm.loop !17
...
entry:
  %__value.addr.i = alloca i32, align 4
...
while.cond:                                       ; preds = %while.body, %entry
  %__holeIndex.addr.0 = phi i64 [ %__holeIndex, %entry ], [ %spec.select, %while.body ]
  %cmp = icmp slt i64 %__holeIndex.addr.0, %div
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %add = shl i64 %__holeIndex.addr.0, 1
  %mul = add i64 %add, 2
...
if.then9:                                         ; preds = %land.lhs.true
  %add10 = shl nsw i64 %__holeIndex.addr.0, 1
...
if.end16:                                         ; preds = %if.then9, %land.lhs.true, %while.end
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %__value.addr.i)
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.body.i, %if.end16
  %__value.addr.sink.i = phi ptr [ %__value.addr.i, %if.end16 ], [ %add.ptr2.i, %while.body.i ]
  %__value.sink.i = phi i32 [ %__value, %if.end16 ], [ %4, %while.body.i ]
  %__holeIndex.sink.i = phi i64 [ %__holeIndex.addr.1, %if.end16 ], [ %div.i, %while.body.i ]
  store i32 %__value.sink.i, ptr %__value.addr.sink.i, align 4, !tbaa !5
  %sub.i = add nsw i64 %__holeIndex.sink.i, -1
  %div.i = sdiv i64 %sub.i, 2
  %cmp.i1 = icmp sgt i64 %__holeIndex.sink.i, %__holeIndex
  %__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i = load i32, ptr %__value.addr.i, align 4, !tbaa !5
  br i1 %cmp.i1, label %land.end.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit
...
land.end.i:                                       ; preds = %while.cond.i
  ...
  %cmp.i.i = icmp slt i32 %4, %__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i
...
while.body.i:                                     ; preds = %land.end.i
  %add.ptr2.i = getelementptr inbounds i32, ptr %__first, i64 %__holeIndex.sink.i
...
_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit: ; preds = %while.cond.i, %land.end.i
  %add.ptr5.i = getelementptr inbounds i32, ptr %__first, i64 %__holeIndex.sink.i
  store i32 %__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i, ptr %add.ptr5.i, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %__value.addr.i)
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef %__c) local_unnamed_addr #4 comdat {
entry:
...
if.then:                                          ; preds = %entry
  ...
  br i1 %cmp.i1, label %if.end16, label %if.else

if.else:                                          ; preds = %if.then
  %cmp.i2 = icmp slt i32 %0, %2
  %3 = tail call i32 @llvm.smax.i32(i32 %0, i32 %2)
  %spec.select = select i1 %cmp.i2, ptr %__c, ptr %__a
  br label %if.end16

if.else7:                                         ; preds = %entry
  %cmp.i3 = icmp slt i32 %0, %2
  br i1 %cmp.i3, label %if.end16, label %if.else10

if.else10:                                        ; preds = %if.else7
  %cmp.i4 = icmp slt i32 %1, %2
  %4 = tail call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %spec.select5 = select i1 %cmp.i4, ptr %__c, ptr %__b
  br label %if.end16

if.end16:                                         ; preds = %if.then, %if.else10, %if.else, %if.else7
  %5 = phi i32 [ %0, %if.else7 ], [ %3, %if.else ], [ %4, %if.else10 ], [ %1, %if.then ]
  %__b.sink = phi ptr [ %__a, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select5, %if.else10 ], [ %__b, %if.then ]
  %6 = load i32, ptr %__result, align 4, !tbaa !5
  store i32 %5, ptr %__result, align 4, !tbaa !5
  store i32 %6, ptr %__b.sink, align 4, !tbaa !5
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef align 4 %__pivot) local_unnamed_addr #5 comdat {
entry:
  br label %while.body
...
while.cond1:                                      ; preds = %while.cond1, %while.body
  ...
  br i1 %cmp.i, label %while.cond1, label %while.cond4.preheader, !llvm.loop !20

while.cond4.preheader:                            ; preds = %while.cond1
  br label %while.cond4

while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  %__last.addr.0.sink = phi ptr [ %incdec.ptr3, %while.cond4 ], [ %__last.addr.0, %while.cond4.preheader ]
  %incdec.ptr3 = getelementptr inbounds i8, ptr %__last.addr.0.sink, i64 -4
  %2 = load i32, ptr %incdec.ptr3, align 4, !tbaa !5
  %cmp.i1 = icmp slt i32 %0, %2
  br i1 %cmp.i1, label %while.cond4, label %while.end8, !llvm.loop !21
...
if.else:                                          ; preds = %for.body
  tail call void @_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_(ptr noundef nonnull align 4 %__i.0)
  br label %for.inc
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_(ptr noundef align 4 %__last) local_unnamed_addr #4 comdat {
entry:
  %__val = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %__val)
  %.pre = load i32, ptr %__last, align 4, !tbaa !5
  br label %while.cond

while.cond:                                       ; preds = %while.cond, %entry
  %0 = phi i32 [ %.pre, %entry ], [ %1, %while.cond ]
  %__last.sink1 = phi ptr [ %__last, %entry ], [ %incdec.ptr, %while.cond ]
  %__val.sink = phi ptr [ %__val, %entry ], [ %__last.sink1, %while.cond ]
  store i32 %0, ptr %__val.sink, align 4, !tbaa !5
  %incdec.ptr = getelementptr inbounds i8, ptr %__last.sink1, i64 -4
  %__val.0.__val.0.__val.0.__val.0.2 = load i32, ptr %__val, align 4, !tbaa !5
  %1 = load i32, ptr %incdec.ptr, align 4, !tbaa !5
  %cmp.i = icmp slt i32 %__val.0.__val.0.__val.0.__val.0.2, %1
  br i1 %cmp.i, label %while.cond, label %while.end, !llvm.loop !24

while.end:                                        ; preds = %while.cond
  store i32 %__val.0.__val.0.__val.0.__val.0.2, ptr %__last.sink1, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %__val)
  ret void
}
