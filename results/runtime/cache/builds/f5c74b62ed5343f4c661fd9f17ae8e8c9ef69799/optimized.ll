...
for.end32:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #5
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #5
  ...
  %smax16 = call i32 @llvm.smax.i32(i32 %3, i32 0)
  %9 = sext i32 %6 to i64
  %smax24 = call i32 @llvm.smax.i32(i32 %2, i32 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc74 ], [ 0, %for.end32 ]
  %exitcond26.not = icmp eq i64 %indvars.iv19, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %10 = mul nsw i64 %indvars.iv19, %8
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv12 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next13, %for.inc71 ]
  %exitcond18.not = icmp eq i64 %indvars.iv12, %wide.trip.count17
  br i1 %exitcond18.not, label %for.inc74, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %12, i64 %indvars.iv12
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %7, i64 %indvars.iv12
  br label %for.cond47
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  ...
  %storemerge1 = phi i32 [ %inc99, %for.inc98 ], [ 0, %for.cond37 ]
  %cmp78 = icmp slt i32 %storemerge1, %18
  br i1 %cmp78, label %for.cond80, label %for.end100

for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %19 = phi i32 [ %.pre27, %for.inc95 ], [ %17, %for.cond77 ]
  %storemerge2 = phi i32 [ %inc96, %for.inc95 ], [ 0, %for.cond77 ]
  %cmp81 = icmp slt i32 %storemerge2, %19
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %19, %storemerge1
  %add84 = add nsw i32 %mul83, %storemerge2
  ...
  %cmp88 = icmp slt i32 %storemerge2, %sub
  br i1 %cmp88, label %if.then, label %if.end

if.then:                                          ; preds = %for.body82
  %putchar = call i32 @putchar(i32 32)
  %.pre28 = load i32, ptr %y2, align 4, !tbaa !5
  %.pre30 = add nsw i32 %.pre28, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre30, %if.then ], [ %sub, %for.body82 ]
  %22 = phi i32 [ %.pre28, %if.then ], [ %21, %for.body82 ]
  %cmp91 = icmp eq i32 %storemerge2, %sub90.pre-phi
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre27 = phi i32 [ %22, %if.end ], [ %.pre27.pre, %if.then92 ]
  %inc96 = add nuw nsw i32 %storemerge2, 1
  br label %for.cond80, !llvm.loop !15

for.inc98:                                        ; preds = %for.cond80
  %inc99 = add nuw nsw i32 %storemerge1, 1
  %.pre = load i32, ptr %x1, align 4, !tbaa !5
  br label %for.cond77, !llvm.loop !16

for.end100:                                       ; preds = %for.cond77
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %j) #8
