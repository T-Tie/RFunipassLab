...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  ...
  br i1 %cmp, label %for.inc, label %while.body
...
NodeBlock:                                        ; preds = %for.inc
  ...
  br i1 %Pivot, label %LeafBlock, label %LeafBlock8

LeafBlock8:                                       ; preds = %NodeBlock
  %SwitchLeaf9 = icmp eq i64 %2, 0
  br i1 %SwitchLeaf9, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i64 %2, -1
  br i1 %SwitchLeaf, label %if.else34.i, label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock8
...
if.then6.i:                                       ; preds = %LeafBlock8, %LeafBlock
...
while.cond9:                                      ; preds = %while.cond9.preheader, %if.end34
  %7 = phi i32 [ %5, %while.cond9.preheader ], [ %.pre6, %if.end34 ]
  %8 = phi i32 [ %.pre, %while.cond9.preheader ], [ %10, %if.end34 ]
  %indvars.iv3 = phi i64 [ %6, %while.cond9.preheader ], [ %indvars.iv.next4, %if.end34 ]
  %num.1 = phi i32 [ %num.0, %while.cond9.preheader ], [ %num.2, %if.end34 ]
  %add = add nsw i32 %8, %num.1
  %cmp12 = icmp slt i32 %add, 81
  %9 = sext i32 %7 to i64
  %cmp17.not = icmp slt i64 %indvars.iv3, %9
  %or.cond1 = select i1 %cmp12, i1 %cmp17.not, i1 false
  br i1 %or.cond1, label %if.end19, label %while.body.loopexit

if.end19:                                         ; preds = %while.cond9
  %arrayidx15 = getelementptr inbounds [1000 x [41 x i8]], ptr %ch, i64 0, i64 %indvars.iv3
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx15)
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, 1
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %len, i64 0, i64 %indvars.iv.next4
  %10 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %add27 = add nsw i32 %10, %add
  %cmp28 = icmp slt i32 %add27, 80
  %11 = load i32, ptr %n, align 4
  %12 = sext i32 %11 to i64
  %cmp29 = icmp slt i64 %indvars.iv.next4, %12
