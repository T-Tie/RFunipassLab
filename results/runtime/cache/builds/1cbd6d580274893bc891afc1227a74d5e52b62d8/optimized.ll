...
for.cond:                                         ; preds = %for.end192, %entry
  ...
  %z.0 = phi i32 [ 0, %entry ], [ %inc13.i10, %for.end192 ]
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.end ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv79, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.end190
  %indvars.iv147 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next148, %for.end190 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.end190 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.end190 ]
  %6 = trunc nuw i64 %indvars.iv147 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19.preheader, label %for.end192

for.cond19.preheader:                             ; preds = %for.cond15
  %exitcond.peel.not = icmp eq i64 %indvars.iv147, 0
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.end55
  %indvars.iv91 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next92, %for.end55 ]
  %min.2 = phi i32 [ %min.1, %for.cond19.preheader ], [ %min.3.lcssa, %for.end55 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %indvars.iv147
  br i1 %exitcond95.not, label %for.cond60.preheader, label %for.cond23.preheader

for.cond60.preheader:                             ; preds = %for.cond19
  %exitcond100.peel.not = icmp eq i64 %indvars.iv147, 0
  br label %for.cond60
...
if.end.peel:                                      ; preds = %for.cond23.preheader
  %arrayidx31.peel = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv91, i64 0
  %7 = load i32, ptr %arrayidx31.peel, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond23

for.cond23:                                       ; preds = %if.end.peel, %if.end
  %indvars.iv82 = phi i64 [ 1, %if.end.peel ], [ %indvars.iv.next83, %if.end ]
  %min.3 = phi i32 [ %7, %if.end.peel ], [ %spec.select, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv82, %indvars.iv147
...
if.end:                                           ; preds = %for.cond23
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv91, i64 %indvars.iv82
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv86 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next87, %for.inc53 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %indvars.iv147
  br i1 %exitcond90.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv91, i64 %indvars.iv86
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.end105
  %indvars.iv107 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next108, %for.end105 ]
  %min.5 = phi i32 [ %min.2, %for.cond60.preheader ], [ %min.6.lcssa, %for.end105 ]
  %exitcond111.not = icmp eq i64 %indvars.iv107, %indvars.iv147
  br i1 %exitcond111.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  br i1 %exitcond100.peel.not, label %for.cond94.preheader, label %if.end89.peel

if.end89.peel:                                    ; preds = %for.cond65.preheader
  %arrayidx74.peel = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 0, i64 %indvars.iv107
  %10 = load i32, ptr %arrayidx74.peel, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond65

for.cond65:                                       ; preds = %if.end89.peel, %if.end89
  %indvars.iv96 = phi i64 [ 1, %if.end89.peel ], [ %indvars.iv.next97, %if.end89 ]
  %min.6 = phi i32 [ %10, %if.end89.peel ], [ %spec.select77, %if.end89 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %indvars.iv147
  br i1 %exitcond100.not, label %for.cond94.preheader, label %if.end89
...
if.end89:                                         ; preds = %for.cond65
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv96, i64 %indvars.iv107
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !12
  %spec.select77 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  %indvars.iv.next97 = add nuw nsw i64 %indvars.iv96, 1
  br label %for.cond65, !llvm.loop !16

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv102 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next103, %for.inc103 ]
  %exitcond106.not = icmp eq i64 %indvars.iv102, %indvars.iv147
  br i1 %exitcond106.not, label %for.end105, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv102, i64 %indvars.iv107
...
for.cond112:                                      ; preds = %for.end131, %for.end108
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.end131 ], [ 0, %for.end108 ]
  %exitcond121.not = icmp eq i64 %indvars.iv117, %indvars.iv147
  br i1 %exitcond121.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond116.not = icmp eq i64 %indvars.iv112, %indvars.iv147
  br i1 %exitcond116.not, label %for.end131, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv117, i64 %indvars.iv112
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !12
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv117, i64 %indvars.iv112
...
for.cond136:                                      ; preds = %for.cond112, %for.body139
  %indvars.iv122 = phi i64 [ %indvars.iv.next123, %for.body139 ], [ 2, %for.cond112 ]
  %exitcond127.not = icmp eq i64 %indvars.iv122, %indvars.iv147
  br i1 %exitcond127.not, label %for.cond151, label %for.body139

for.body139:                                      ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv122
  %15 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !12
  %16 = add nsw i64 %indvars.iv122, -1
...
for.cond151:                                      ; preds = %for.cond136, %for.body154
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.body154 ], [ 2, %for.cond136 ]
  %exitcond133.not = icmp eq i64 %indvars.iv128, %indvars.iv147
  br i1 %exitcond133.not, label %for.cond166, label %for.body154

for.body154:                                      ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv128
  %17 = load i32, ptr %arrayidx157, align 4, !tbaa !5, !invariant.load !12
  %18 = add nsw i64 %indvars.iv128, -1
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv140 = phi i64 [ %indvars.iv.next141, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond145.not = icmp eq i64 %indvars.iv140, %indvars.iv147
  br i1 %exitcond145.not, label %for.end190, label %for.cond171.preheader
...
for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv134 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next135, %for.inc185 ]
  %exitcond139.not = icmp eq i64 %indvars.iv134, %indvars.iv147
  br i1 %exitcond139.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv140, i64 %indvars.iv134
  %20 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !12
  %21 = add nsw i64 %indvars.iv134, -1
...
for.end192:                                       ; preds = %for.cond15
  ...
  %inc13.i10 = add nuw nsw i32 %z.0, 1
  br label %for.cond
