...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40000, ptr %num) #6
  call void @llvm.lifetime.start.p0(i64 60000, ptr %c) #6
  call void @llvm.lifetime.start.p0(i64 600, ptr %input) #6
...
if.end92:                                         ; preds = %for.cond76, %if.then71
  call void @llvm.lifetime.end.p0(i64 600, ptr %input) #6
  call void @llvm.lifetime.end.p0(i64 60000, ptr %c) #6
  call void @llvm.lifetime.end.p0(i64 40000, ptr %num) #6
