...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 3006, ptr nonnull %b) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(3006) %b, i8 0, i64 3006, i1 false)
...
for.end:                                          ; preds = %for.cond
  ...
  %smax102 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
...
for.cond14.preheader:                             ; preds = %for.cond11
  %smax90 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.body48
  %indvars.iv93 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next94, %for.body48 ]
  %exitcond98.not = icmp eq i64 %indvars.iv93, %wide.trip.count
  br i1 %exitcond98.not, label %for.end58, label %for.body48
...
for.cond89:                                       ; preds = %for.body78, %for.body91
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.body91 ], [ 0, %for.body78 ]
  %exitcond108.not = icmp eq i64 %indvars.iv105, 6
  br i1 %exitcond108.not, label %for.inc118, label %for.body91
...
if.else:                                          ; preds = %for.end123
  ...
  %smax124 = call i32 @llvm.smax.i32(i32 %l.0, i32 1)
  %wide.trip.count128 = zext nneg i32 %smax124 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %if.then147, %if.else
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %if.then147 ], [ 1, %if.else ]
...
for.body136:                                      ; preds = %for.cond134
  ...
  br i1 %cmp146, label %if.then147, label %for.end153.split.loop.exit
...
for.cond172:                                      ; preds = %for.body161, %for.body174
  %indvars.iv130 = phi i64 [ %indvars.iv.next131, %for.body174 ], [ 0, %for.body161 ]
  %exitcond133.not = icmp eq i64 %indvars.iv130, 6
  br i1 %exitcond133.not, label %for.inc201, label %for.body174
...
for.cond211:                                      ; preds = %for.body213, %for.body209
  %indvars.iv146 = phi i64 [ %indvars.iv.next147, %for.body213 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv146, %26
  br i1 %cmp212, label %for.body213, label %for.inc223
...
for.body213:                                      ; preds = %for.cond211
  ...
  %putchar79 = call i32 @putchar(i32 %conv218)
...
if.end226:                                        ; preds = %for.cond207, %if.then128
  ...
  call void @llvm.lifetime.end.p0(i64 3006, ptr nonnull %b) #8
