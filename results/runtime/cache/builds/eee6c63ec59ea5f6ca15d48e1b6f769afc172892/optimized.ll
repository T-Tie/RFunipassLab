...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv6 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc24 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc24 ]
  %exitcond11.not = icmp eq i64 %indvars.iv6, %wide.trip.count10
  br i1 %exitcond11.not, label %for.cond27.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv6
  br label %for.cond5

for.cond27.preheader:                             ; preds = %for.cond2
  %smax16 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax16 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.body7 ], [ 0, %for.cond5.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv3, %indvars.iv6
  br i1 %exitcond.not, label %if.then17, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv3
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv12 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next13, %for.body29 ]
  %exitcond17.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond17.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv12, 0
  %spec.select = select i1 %cmp30, ptr @.str, ptr @.str.1
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv12
  %5 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %5)
