...
if.end19:                                         ; preds = %if.end, %if.else14
  %sum.146 = phi i32 [ %add7, %if.else14 ], [ %add6, %if.end ]
  %call15.sink = phi ptr [ %call15, %if.else14 ], [ @_ZSt4cout, %if.end ]
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call15.sink, ptr noundef nonnull align 16 dereferenceable(40) %a)
  %cmp20 = icmp eq i32 %sum.146, 80
...
if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.146, %if.end19 ], [ 0, %if.then21 ]
