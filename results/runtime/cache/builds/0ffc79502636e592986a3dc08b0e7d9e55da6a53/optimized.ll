...
for.body13:                                       ; preds = %for.cond10
  ...
  %6 = load i8, ptr %arrayidx15, align 1, !tbaa !12, !invariant.load !13
...
for.inc36:                                        ; preds = %if.then27, %if.else32
  %.sink = phi i32 [ %11, %if.else32 ], [ %2, %if.then27 ]
  %sub33 = sub nsw i32 %5, %.sink
...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  %12 = phi i32 [ %inc53, %for.inc52 ], [ 0, %for.end41 ]
  %cmp43 = icmp slt i32 %12, 1000
...
for.body44:                                       ; preds = %for.cond42
  ...
  %14 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !13
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %15 = phi i32 [ %inc81, %for.inc80 ], [ 0, %if.else58 ]
  %cmp61 = icmp slt i32 %15, 1000
