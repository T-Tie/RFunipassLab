...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 5000, ptr noundef nonnull %str2) #6
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax39 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc ], [ %0, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv28, %4
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv34 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next35, %for.inc44 ]
  %exitcond41.not = icmp eq i64 %indvars.iv34, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %7 = add nsw i64 %indvars.iv34, %1
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %7
  %8 = load i8, ptr %arrayidx41, align 1, !tbaa !5, !invariant.load !8
...
for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond46.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv42
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !5, !invariant.load !8
