...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef %initial) #12
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef %word) #12
  ...
  %call9 = call i64 @strlen(ptr noundef %word) #13
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef %word) #12
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %initial) #12
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) #12
