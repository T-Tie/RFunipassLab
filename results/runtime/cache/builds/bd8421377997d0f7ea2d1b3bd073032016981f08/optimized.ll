...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 captures(none) dereferenceable(300) %sub) #7
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_after_outline.exitStub:
  %call.i.i = tail call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(300) %0) #10
