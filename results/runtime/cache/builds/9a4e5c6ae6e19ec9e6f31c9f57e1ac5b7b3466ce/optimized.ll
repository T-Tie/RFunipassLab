...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre38, %for.body3 ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond37.not, label %for.end33, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv32 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %if.else
  %indvars.iv28 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next29, %if.else ]
  %exitcond.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv28
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %cmp20 = icmp eq i32 %5, 0
  br i1 %cmp20, label %for.end23.split.loop.exit40, label %if.else

if.else:                                          ; preds = %for.body15
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  br label %for.cond13, !llvm.loop !14

for.end23.split.loop.exit40:                      ; preds = %for.body15
  %6 = trunc nuw nsw i64 %indvars.iv28 to i32
  br label %for.end23

for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit40
  %x1.2 = phi i32 [ %4, %for.end23.split.loop.exit40 ], [ %x1.0, %for.cond13 ]
  %y1.2 = phi i32 [ %6, %for.end23.split.loop.exit40 ], [ %y1.0, %for.cond13 ]
...
for.cond38:                                       ; preds = %for.cond38.preheader, %if.else47
  %j.2 = phi i32 [ %dec, %if.else47 ], [ %sub, %for.cond38.preheader ]
...
for.body40:                                       ; preds = %for.cond38
  ...
  br i1 %cmp45, label %for.end50, label %if.else47
...
for.end50:                                        ; preds = %for.cond38, %for.body40
  %j.2.lcssa = phi i32 [ -1, %for.cond38 ], [ %j.2, %for.body40 ]
  %x2.2 = phi i32 [ %x2.0, %for.cond38 ], [ %i.2, %for.body40 ]
  %y2.2 = phi i32 [ %y2.0, %for.cond38 ], [ %j.2, %for.body40 ]
  ...
  br i1 %cmp55, label %for.end61, label %for.cond34, !llvm.loop !17
