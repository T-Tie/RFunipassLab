...
for.body25:                                       ; preds = %for.cond22
  ...
  %11 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !13
...
for.inc64:                                        ; preds = %for.cond49
  ...
  %14 = load i32, ptr %arrayidx56, align 4, !tbaa !5, !invariant.load !13
  %arrayidx58 = getelementptr inbounds [100 x i32], ptr %min1, i64 0, i64 %idxprom53
  %15 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !13
...
for.body73:                                       ; preds = %for.cond70
  ...
  %17 = load i32, ptr %arrayidx76, align 4, !tbaa !5, !invariant.load !13
...
for.body82:                                       ; preds = %for.cond79
  ...
  %20 = load i32, ptr %arrayidx88, align 4, !tbaa !5, !invariant.load !13
...
for.inc123:                                       ; preds = %for.cond108
  ...
  %23 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !13
  %arrayidx117 = getelementptr inbounds [100 x i32], ptr %min2, i64 0, i64 %idxprom114
  %24 = load i32, ptr %arrayidx117, align 4, !tbaa !5, !invariant.load !13
...
for.inc148:                                       ; preds = %for.cond135
  ...
  %29 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !13
...
for.inc171:                                       ; preds = %for.cond158
  ...
  %32 = load i32, ptr %arrayidx166, align 4, !tbaa !5, !invariant.load !13
...
for.inc179:                                       ; preds = %while.cond
  ...
  %call178 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %33) #5
