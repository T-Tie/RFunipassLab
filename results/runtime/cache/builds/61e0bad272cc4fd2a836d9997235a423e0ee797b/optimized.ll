...
for.cond40:                                       ; preds = %for.inc71, %for.body39
  ...
  %cmp41 = icmp slt i32 %j.2, %11
  br i1 %cmp41, label %for.body42, label %for.inc74

for.body42:                                       ; preds = %for.cond40
  %mul43 = mul nsw i32 %i.2, %11
...
for.cond47:                                       ; preds = %for.inc68, %for.body42
  ...
  %cmp48 = icmp slt i32 %k.0, %12
  br i1 %cmp48, label %for.inc68, label %for.inc71

for.inc68:                                        ; preds = %for.cond47
  %13 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !15
  %14 = load i32, ptr %y1, align 4, !tbaa !5
  %mul54 = mul nsw i32 %i.2, %14
  %add55 = add nsw i32 %mul54, %k.0
  %idxprom56 = sext i32 %add55 to i64
  %arrayidx57 = getelementptr inbounds i32, ptr %call2, i64 %idxprom56
  %15 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !15
  %mul58 = mul nsw i32 %k.0, %11
  %add59 = add nsw i32 %mul58, %j.2
  %idxprom60 = sext i32 %add59 to i64
  %arrayidx61 = getelementptr inbounds i32, ptr %call15, i64 %idxprom60
  %16 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !15
  %mul62 = mul nsw i32 %15, %16
  %add63 = add nsw i32 %13, %mul62
...
for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %i.3, %18
  %add84 = add nsw i32 %mul83, %j.3
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %19 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !15
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %19)
