...
for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %.sink, i32 noundef %.sink) #6
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %.sink, i32 noundef %.sink) #6
...
for.inc57:                                        ; preds = %for.cond44
  ...
  %13 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !17
...
for.inc66:                                        ; preds = %for.cond14
  ...
  %call65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %14)
