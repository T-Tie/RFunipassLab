...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef align 16 %str) #3
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef align 16 %b) #3
  br label %while.cond
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef %b) #4
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %str) #4
  ret i32 0
}
