...
if.else:                                          ; preds = %for.body15
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv13
...
for.inc42.gvnsink.split:                          ; preds = %if.else, %if.then
  %storemerge44 = phi i32 [ %6, %if.then ], [ %7, %if.else ]
  store i32 %storemerge44, ptr %arrayidx30, align 4, !tbaa !5
...
for.cond51.preheader:                             ; preds = %for.cond48
  ...
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv28
...
if.else64:                                        ; preds = %for.body53
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv28
