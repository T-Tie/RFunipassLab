...
for.cond89:                                       ; preds = %for.inc114, %if.then88
  %.sink1 = phi i32 [ 0, %if.then88 ], [ %inc115, %for.inc114 ]
  %21 = phi i32 [ %inc115, %for.inc114 ], [ 0, %if.then88 ]
  store i32 %.sink1, ptr %z, align 4, !tbaa !5
  %cmp90 = icmp slt i32 %21, 6
  br i1 %cmp90, label %for.inc114, label %for.inc118

for.inc114:                                       ; preds = %for.cond89
  %22 = load i32, ptr %z, align 4, !tbaa !5
  %idxprom94 = sext i32 %22 to i64
  %arrayidx95 = getelementptr inbounds [6 x i8], ptr %arrayidx80, i64 0, i64 %idxprom94
  %23 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  ...
  store i8 %23, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds [6 x i8], ptr %arrayidx84, i64 0, i64 %idxprom94
  %24 = load i8, ptr %arrayidx102, align 1, !tbaa !9
  store i8 %24, ptr %arrayidx95, align 1, !tbaa !9
  %25 = load i8, ptr %arrayidx98, align 1, !tbaa !9
  store i8 %25, ptr %arrayidx102, align 1, !tbaa !9
  %inc115 = add nsw i32 %22, 1
...
for.end123:                                       ; preds = %for.cond71
  %26 = load i8, ptr %arrayidx8, align 4, !tbaa !9
  %conv126 = sext i8 %26 to i32
...
for.body136:                                      ; preds = %for.cond134
  ...
  %28 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %conv140 = sext i8 %28 to i32
  %sub141 = sub nsw i32 %27, 1
  ...
  %29 = load i8, ptr %arrayidx144, align 2, !tbaa !9
  %conv145 = sext i8 %29 to i32
...
for.cond154:                                      ; preds = %for.inc204, %for.end153
  ...
  %32 = load i32, ptr %z, align 4, !tbaa !5
  %sub155 = sub nsw i32 %32, 1
  %cmp156 = icmp slt i32 %31, %sub155
...
for.body161:                                      ; preds = %for.cond159
  ...
  %34 = load i8, ptr %arrayidx164, align 1, !tbaa !9
  %conv165 = sext i8 %34 to i32
  %idxprom166 = sext i32 %31 to i64
  ...
  %35 = load i8, ptr %arrayidx168, align 1, !tbaa !9
  %conv169 = sext i8 %35 to i32
...
for.cond172:                                      ; preds = %for.inc197, %if.then171
  ...
  %36 = phi i32 [ %inc198, %for.inc197 ], [ 0, %if.then171 ]
  store i32 %.sink, ptr %k, align 4, !tbaa !5
  %cmp173 = icmp slt i32 %36, 6
...
for.inc197:                                       ; preds = %for.cond172
  ...
  %38 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  ...
  store i8 %38, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds [6 x i8], ptr %arrayidx167, i64 0, i64 %idxprom177
  %39 = load i8, ptr %arrayidx185, align 1, !tbaa !9
  store i8 %39, ptr %arrayidx178, align 1, !tbaa !9
  %40 = load i8, ptr %arrayidx181, align 1, !tbaa !9
  store i8 %40, ptr %arrayidx185, align 1, !tbaa !9
  %inc198 = add nsw i32 %37, 1
  br label %for.cond172, !llvm.loop !21

for.inc201:                                       ; preds = %for.body161, %for.cond172
  %inc202 = add nsw i32 %33, 1
