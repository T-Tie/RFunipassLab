...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax105 = call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.inc122.gvnsink.split:                         ; preds = %if.else107, %if.then85
  %indvars.iv100.sink = phi i64 [ %indvars.iv100, %if.then85 ], [ %6, %if.else107 ]
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv100, i64 %indvars.iv93
  %10 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
  %11 = add nsw i64 %indvars.iv93, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv100.sink, i64 %11
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  %indvars.iv16 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next17, %for.inc9 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count19
...
for.cond12:                                       ; preds = %for.cond1, %for.inc26
  ...
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc26 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv24, %2
  br i1 %cmp13, label %for.cond15, label %for.inc32

for.cond15:                                       ; preds = %for.cond12, %for.inc23
  %3 = phi i32 [ %.pre, %for.inc23 ], [ %1, %for.cond12 ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc23 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
  %cmp16 = icmp slt i64 %indvars.iv21, %4
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv21
