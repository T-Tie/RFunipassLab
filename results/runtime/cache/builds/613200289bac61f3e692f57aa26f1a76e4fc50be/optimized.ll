...
for.cond:                                         ; preds = %for.inc5, %entry
  ...
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc5 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv21, %1
  br i1 %cmp, label %for.cond1.preheader, label %for.cond8.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv21
  br label %for.cond1
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %3 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre44, %for.inc ]
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  %indvars.iv28 = phi i64 [ 0, %for.cond8.preheader ], [ %indvars.iv.next29, %for.inc25 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %2
  br i1 %exitcond33.not, label %for.end27.loopexit45, label %for.cond11

for.cond11:                                       ; preds = %for.cond8, %for.inc19
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc19 ], [ 0, %for.cond8 ]
  %exitcond.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond.not, label %for.inc25, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv24
...
for.end27.loopexit:                               ; preds = %for.body13
  ...
  %.pre43 = and i64 %indvars.iv28, 4294967295
  br label %for.end27

for.end27.loopexit45:                             ; preds = %for.cond8
  br label %for.end27

for.end27:                                        ; preds = %for.end27.loopexit45, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre43, %for.end27.loopexit ], [ %2, %for.end27.loopexit45 ]
  %i.119 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.end27.loopexit45 ]
  %y1.1 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.end27.loopexit45 ]
  %cmp948 = icmp slt i64 %indvars.iv28, %1
  %8 = sext i32 %y1.1 to i64
  %smax37 = call i32 @llvm.smax.i32(i32 %y1.1, i32 %0)
  %wide.trip.count39 = sext i32 %smax37 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.body30, %for.end27
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body30 ], [ %8, %for.end27 ]
  %exitcond40.not = icmp eq i64 %indvars.iv34, %wide.trip.count39
  br i1 %exitcond40.not, label %for.end42, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %indvars.iv.next35 = add nsw i64 %indvars.iv34, 1
  %arrayidx34 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %idxprom31.pre-phi, i64 %indvars.iv.next35
  %9 = load i32, ptr %arrayidx34, align 4, !tbaa !5
  %cmp35 = icmp ne i32 %9, 0
  %cmp37 = icmp sge i64 %indvars.iv.next35, %1
...
for.end42.split.loop.exit:                        ; preds = %for.body30
  %10 = trunc nsw i64 %indvars.iv34 to i32
  br label %for.end42

for.end42:                                        ; preds = %for.cond28, %for.end42.split.loop.exit
  %i.2.lcssa = phi i32 [ %10, %for.end42.split.loop.exit ], [ %smax37, %for.cond28 ]
  br label %for.cond43

for.cond43:                                       ; preds = %for.body45, %for.end42
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.body45 ], [ %idxprom31.pre-phi, %for.end42 ]
  %phiofops = phi i1 [ true, %for.body45 ], [ %cmp948, %for.end42 ]
  br i1 %phiofops, label %for.body45, label %for.end59

for.body45:                                       ; preds = %for.cond43
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %arrayidx50 = getelementptr inbounds [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv.next42, i64 %8
  %11 = load i32, ptr %arrayidx50, align 4, !tbaa !5
  %cmp51 = icmp ne i32 %11, 0
  %12 = trunc nuw i64 %indvars.iv.next42 to i32
  %cmp54 = icmp sle i32 %0, %12
  %or.cond7 = or i1 %cmp54, %cmp51
  br i1 %or.cond7, label %for.end59, label %for.cond43, !llvm.loop !16

for.end59:                                        ; preds = %for.body45, %for.cond43
  %13 = trunc nuw nsw i64 %indvars.iv41 to i32
  %sub = sub nsw i32 %13, %i.119
