...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax35 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count41 = zext nneg i32 %smax35 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond42.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body15 ], [ 0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select21, %for.body15 ], [ %l1.0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv28
  ...
  %spec.select21 = select i1 %cmp20, i32 %6, i32 %l1.1
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv31 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next32, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %exitcond37.not = icmp eq i64 %indvars.iv31, %wide.trip.count41
  br i1 %exitcond37.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv31, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %idxprom40
  %7 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp slt i32 %7, %min.1
  %spec.select22 = call i32 @llvm.smin.i32(i32 %7, i32 %min.1)
  %8 = trunc nuw nsw i64 %indvars.iv31 to i32
  %spec.select23 = select i1 %cmp42, i32 %8, i32 %l2.1
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %min.3 = phi i32 [ %9, %if.end37.thread ], [ %spec.select22, %if.end37 ]
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select23, %if.end37 ]
