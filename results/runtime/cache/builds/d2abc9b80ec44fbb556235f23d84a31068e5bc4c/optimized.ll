...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv14 = phi i32 [ %indvars.iv.next15, %while.cond ], [ 0, %for.cond ]
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv8 = phi i64 [ %1, %while.cond11.preheader ], [ %indvars.iv.next9, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %2 = trunc nuw i64 %indvars.iv.next9 to i32
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select3 = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.2)
