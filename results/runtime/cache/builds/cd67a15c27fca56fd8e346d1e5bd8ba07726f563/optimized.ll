...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %p) #12
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = getelementptr inbounds [100 x i8], ptr @a, i64 0, i64 %idxprom
...
land.lhs.true:                                    ; preds = %lor.lhs.false
  ...
  %5 = load i8, ptr %add.ptr, align 1, !tbaa !12
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef align 8 %p) #12
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !45
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !47
  ret ptr %0
}
...
!18 = !{}
!19 = !{!20, !21, i64 16}
!20 = !{!"_ZTSSt8ios_base", !21, i64 8, !21, i64 16, !22, i64 24, !23, i64 28, !23, i64 32, !24, i64 40, !25, i64 48, !8, i64 64, !11, i64 192, !26, i64 200, !27, i64 208}
!21 = !{!"long", !8, i64 0}
...
!44 = !{!20, !23, i64 32}
!45 = !{!46, !6, i64 16}
!46 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !27, i64 56}
!47 = !{!46, !6, i64 24}
