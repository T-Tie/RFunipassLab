...
for.cond4:                                        ; preds = %for.inc29, %for.end
  %max.0 = phi i32 [ 0, %for.end ], [ %max.1.lcssa, %for.inc29 ]
  %3 = load i32, ptr @i, align 4, !tbaa !5
  %cmp5 = icmp slt i32 %3, %.lcssa
...
for.inc29:                                        ; preds = %for.cond7
  %max.1.lcssa = phi i32 [ %max.1, %for.cond7 ]
  %inc30 = add nsw i32 %3, 1
  store i32 %inc30, ptr @i, align 4, !tbaa !5
  br label %for.cond4, !llvm.loop !13

for.end31:                                        ; preds = %for.cond4
  %max.0.lcssa = phi i32 [ %max.0, %for.cond4 ]
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max.0.lcssa)
