...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100000, ptr nonnull %a) #7
  br label %for.cond
...
for.end:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #7
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %call.i.i9 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr13) #7
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 100000, ptr nonnull %a) #7
  ret i32 0
}
