...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc29 ], [ 0, %entry ]
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  ...
  br i1 %exitcond19.not, label %for.inc29, label %for.inc25
...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc28 ], [ 0, %entry ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  ...
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.inc28, label %for.inc24
...
for.cond:                                         ; preds = %for.inc11, %entry
  ...
  br i1 %exitcond20.not, label %for.cond15.preheader, label %for.cond1.preheader
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax24 = tail call i32 @llvm.smax.i32(i32 noundef %sub21, i32 noundef 0)
  %smax31 = tail call i32 @llvm.smax.i32(i32 %1, i32 noundef 2)
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc37
  %indvars.iv27 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next28, %for.inc37 ]
  %exitcond33.not = icmp eq i64 %indvars.iv27, %wide.trip.count32
  br i1 %exitcond33.not, label %for.end39, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv21 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next22, %for.inc34 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.inc37, label %for.inc34

for.inc34:                                        ; preds = %for.cond20
  %arrayidx28 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv27
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %arrayidx33 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %3
