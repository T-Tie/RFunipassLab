...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  ...
  br i1 %exitcond12.not, label %for.cond31, label %for.body
...
for.cond31:                                       ; preds = %for.cond, %for.inc70
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc70 ], [ 0, %for.cond ]
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc67 ], [ 0, %for.cond58.preheader ]
