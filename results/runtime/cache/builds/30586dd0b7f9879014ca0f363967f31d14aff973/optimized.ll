...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %j) #4
  store i32 0, ptr %j, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %temp) #4
...
while.end:                                        ; preds = %while.cond
  ...
  %vtable.i = load ptr, ptr %call8, align 8, !tbaa !12, !invariant.load !14
  ...
  %vtable.i3 = load ptr, ptr %call10, align 8, !tbaa !12, !invariant.load !14
  ...
  %add.ptr.i6 = getelementptr inbounds i8, ptr %call10, i64 %vbase.offset.i5
  ...
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call10, i8 noundef signext %call.i)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %temp) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %j) #5
