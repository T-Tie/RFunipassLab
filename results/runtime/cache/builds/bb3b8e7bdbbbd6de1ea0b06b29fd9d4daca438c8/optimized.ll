...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %11, i32 noundef 0)
  %15 = sext i32 %13 to i64
  %smax51 = call i32 @llvm.smax.i32(i32 %10, i32 noundef 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc74 ], [ 0, %for.end32 ]
  %exitcond53.not = icmp eq i64 %indvars.iv46, %wide.trip.count52
  br i1 %exitcond53.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv46, %14
  %17 = mul nsw i64 %indvars.iv46, %15
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv39 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next40, %for.inc71 ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc74, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv39
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv39
  br label %for.cond47
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %25 = phi i32 [ %.pre54, %for.inc95 ], [ %23, %for.cond77 ]
...
if.then:                                          ; preds = %for.body82
  ...
  %.pre57 = add nsw i32 %.pre55, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre57, %if.then ], [ %sub, %for.body82 ]
  %28 = phi i32 [ %.pre55, %if.then ], [ %27, %for.body82 ]
  %cmp91 = icmp eq i32 %j.3, %sub90.pre-phi
  br i1 %cmp91, label %if.then92, label %for.inc95

if.then92:                                        ; preds = %if.end
  %putchar34 = call i32 @putchar(i32 noundef 10) #8
  %.pre54.pre = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.inc95

for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre54 = phi i32 [ %28, %if.end ], [ %.pre54.pre, %if.then92 ]
