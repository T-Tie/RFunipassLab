...
if.end16:                                         ; preds = %if.else7, %if.then, %if.else10, %if.else, %if.else13, %if.else5
  %.sink31 = phi i32 [ %1, %if.else13 ], [ %0, %if.else5 ], [ %2, %if.else ], [ %2, %if.else10 ], [ %1, %if.then ], [ %0, %if.else7 ]
  %__b.sink = phi ptr [ %__b, %if.else13 ], [ %__a, %if.else5 ], [ %__c, %if.else ], [ %__c, %if.else10 ], [ %__b, %if.then ], [ %__a, %if.else7 ]
  %.sink = phi i32 [ %3, %if.else13 ], [ %3, %if.else5 ], [ %3, %if.else ], [ %3, %if.else10 ], [ %3, %if.then ], [ %3, %if.else7 ]
  store i32 %.sink31, ptr %__result, align 4, !tbaa !5
