...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc24 ], [ 1, %for.cond13 ]
...
for.inc70:                                        ; preds = %for.cond40.preheader, %if.else
  %_ZSt4cout.sink = phi ptr [ %call64, %if.else ], [ @_ZSt4cout, %for.cond40.preheader ]
  %call63 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink, i32 noundef 0)
  %inc71 = add nuw nsw i32 %j.2, 1
