...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %p, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc29
  %indvars.iv10 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next11, %for.inc29 ]
  %row.0 = phi i32 [ 0, %for.cond10.preheader ], [ %row.1, %for.inc29 ]
  %exitcond16.not = icmp eq i64 %indvars.iv10, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond32.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc26
  %indvars.iv6 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next7, %for.inc26 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %p, i64 0, i64 %indvars.iv10, i64 %indvars.iv6
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp eq i32 %5, 0
  br i1 %cmp20, label %land.lhs.true, label %for.inc26

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds [100 x [100 x i32]], ptr %p, i64 0, i64 %4, i64 %indvars.iv6
  %6 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %cmp25 = icmp eq i32 %6, 0
  %add = zext i1 %cmp25 to i32
  %spec.select = add nsw i32 %add, %row.1
  br label %for.inc26
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc56
  %indvars.iv23 = phi i64 [ 1, %for.cond32.preheader ], [ %indvars.iv.next24, %for.inc56 ]
  %line.0 = phi i32 [ 0, %for.cond32.preheader ], [ %line.1, %for.inc56 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count15
  br i1 %exitcond28.not, label %for.end58, label %for.cond35.preheader
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc53
  %indvars.iv17 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next18, %for.inc53 ]
  %line.1 = phi i32 [ %line.0, %for.cond35.preheader ], [ %line.2, %for.inc53 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond22.not, label %for.inc56, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %p, i64 0, i64 %indvars.iv17, i64 %indvars.iv23
...
land.lhs.true43:                                  ; preds = %for.body37
  %arrayidx48 = getelementptr inbounds [100 x [100 x i32]], ptr %p, i64 0, i64 %indvars.iv17, i64 %7
  %9 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %cmp49 = icmp eq i32 %9, 0
  %add51 = zext i1 %cmp49 to i32
  %spec.select1 = add nsw i32 %add51, %line.1
  br label %for.inc53

for.inc53:                                        ; preds = %land.lhs.true43, %for.body37
  %line.2 = phi i32 [ %line.1, %for.body37 ], [ %spec.select1, %land.lhs.true43 ]
