...
for.cond8:                                        ; preds = %for.cond, %for.inc
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc ], [ %indvars.iv10, %for.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %if.then24.loopexit, label %for.body10

for.body10:                                       ; preds = %for.cond8
  %arrayidx = getelementptr inbounds nuw [300 x i8], ptr %a, i64 0, i64 %indvars.iv12
...
if.then24:                                        ; preds = %if.then24.loopexit, %for.end22
  ...
  %i.08 = phi i32 [ %i.0, %if.then24.loopexit ], [ %smax17, %for.end22 ]
  %add = add nsw i32 %i.08, %conv
  %smax27 = call i32 @llvm.smax.i32(i32 %i.08, i32 %add)
  %2 = sub nsw i32 %smax27, %i.08
