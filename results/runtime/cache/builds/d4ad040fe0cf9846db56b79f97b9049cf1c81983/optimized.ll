...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc25
  ...
  %indvars.iv27 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next28, %for.inc25 ]
  %8 = sext i32 %7 to i64
  %cmp4 = icmp slt i64 %indvars.iv27, %8
  br i1 %cmp4, label %for.body5, label %for.end27

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv27
