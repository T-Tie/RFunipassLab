...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv108 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next109, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond113.not = icmp eq i64 %indvars.iv108, %wide.trip.count112
  br i1 %exitcond113.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond80.not = icmp eq i64 %indvars.iv75, %wide.trip.count79
  br i1 %exitcond80.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv75
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv75, i64 %indvars.iv65
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp3460 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp3460, i32 %min.0, i32 %8
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  br label %for.cond22, !llvm.loop !14

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv69 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next70, %for.inc57 ]
  %exitcond74.not = icmp eq i64 %indvars.iv69, %wide.trip.count
  br i1 %exitcond74.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv75, i64 %indvars.iv69
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond97.not = icmp eq i64 %indvars.iv93, %wide.trip.count79
  br i1 %exitcond97.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv93
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond86.not = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond86.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv81, i64 %indvars.iv93
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !13
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp8259 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp8259, i32 %min.2, i32 %12
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  br label %for.cond69, !llvm.loop !17

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  %indvars.iv87 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next88, %for.inc107 ]
  %exitcond92.not = icmp eq i64 %indvars.iv87, %wide.trip.count
  br i1 %exitcond92.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv87, i64 %indvars.iv93
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv108, i64 %indvars.iv108
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond102.not = icmp eq i64 %indvars.iv98, %wide.trip.count79
  br i1 %exitcond102.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv98, i64 %indvars.iv108
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond107.not = icmp eq i64 %indvars.iv103, %wide.trip.count79
  br i1 %exitcond107.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv108, i64 %indvars.iv103
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !24, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !32, !invariant.load !13
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !33, !invariant.load !13
