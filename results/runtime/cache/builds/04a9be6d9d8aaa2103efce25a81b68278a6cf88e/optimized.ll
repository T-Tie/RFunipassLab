...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 550, ptr noundef nonnull %a) #9
...
for.cond21:                                       ; preds = %for.cond21.loopexit, %for.cond21.preheader
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.cond21.loopexit ], [ 0, %for.cond21.preheader ]
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.cond21.loopexit ], [ 1, %for.cond21.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond51, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv42
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv42
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc44, %for.body25
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc44 ], [ %indvars.iv37, %for.body25 ]
  %4 = trunc nuw i64 %indvars.iv39 to i32
  %cmp30.not = icmp slt i32 %sub, %4
  br i1 %cmp30.not, label %for.cond21.loopexit, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv39
...
if.then:                                          ; preds = %for.body32
  %5 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !10
...
for.body55:                                       ; preds = %for.cond51
  ...
  %6 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !10
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  ...
  %cmp75 = icmp slt i64 %indvars.iv53, %8
...
for.body77:                                       ; preds = %for.cond73
  ...
  %9 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !10
...
if.end91:                                         ; preds = %for.cond73, %if.then67
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 550, ptr noundef nonnull %a) #11
  ret i32 0
}
