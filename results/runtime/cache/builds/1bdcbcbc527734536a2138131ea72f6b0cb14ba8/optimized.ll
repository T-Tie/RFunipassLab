...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv20, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre28, %for.inc ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv24 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next25, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv24
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc44
  %6 = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.cond33.preheader ]
  %cmp34 = icmp sgt i32 %6, -1
  br i1 %cmp34, label %for.body35, label %for.inc46

for.body35:                                       ; preds = %for.cond33
  %idx.ext39 = zext nneg i32 %6 to i64
...
for.inc46:                                        ; preds = %for.body35, %for.cond33
  ...
  %c2.1 = phi i32 [ %c2.0, %for.cond33 ], [ %6, %for.body35 ]
...
for.end48:                                        ; preds = %for.cond29
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call54, i8 noundef signext %call.i14)
