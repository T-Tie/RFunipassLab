...
land.lhs.true.i16:                                ; preds = %if.then6.i10
  ...
  %3 = add i64 %2, -301
  %or.cond.i20 = icmp ult i64 %3, -300
...
land.lhs.true.i43:                                ; preds = %if.then6.i37
  ...
  %5 = add i64 %4, -301
  %or.cond.i47 = icmp ult i64 %5, -300
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then6.i37, %land.lhs.true.i43, %if.then19.i48, %if.then28.i55
  %call7 = call noundef ptr @strstr(ptr noundef nonnull dereferenceable(1) %s, ptr noundef nonnull dereferenceable(1) %sub) #11
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
  ...
  %call16 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %sub) #11
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
