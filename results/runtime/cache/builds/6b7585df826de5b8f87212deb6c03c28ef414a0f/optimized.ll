...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond23, label %for.cond15, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond33 = icmp eq i64 %indvars.iv29, %wide.trip.count22
  br i1 %exitcond33, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv29
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv29
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc39 ], [ %indvars.iv24, %for.body19 ]
...
for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv26
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond38 = icmp eq i64 %indvars.iv34, %wide.trip.count22
  br i1 %exitcond38, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv34
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.015 = phi i32 [ %8, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.015)
  %smax42 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 0)
  %wide.trip.count43 = zext nneg i32 %smax42 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond44.not = icmp eq i64 %indvars.iv39, %wide.trip.count43
  br i1 %exitcond44.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv39
