...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %b) #5
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %c) #5
  ...
  %smax29 = call i32 @llvm.smax.i32(i32 %conv7, i32 0)
...
if.end36:                                         ; preds = %for.cond25, %for.end22
  ...
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %b) #5
