...
NodeBlock1:                                       ; preds = %NodeBlock3
  ...
  %spec.select21 = select i1 %Pivot2, i32 1, i32 2
  br label %sw.epilog.gvnsink.split

NodeBlock:                                        ; preds = %NodeBlock5
  switch i32 %rem1, label %sw.epilog [
    i32 1, label %sw.epilog.gvnsink.split
    i32 0, label %sw.epilog.gvnsink.split.fold.split
  ]

sw.epilog.gvnsink.split.fold.split:               ; preds = %NodeBlock
  br label %sw.epilog.gvnsink.split

sw.epilog.gvnsink.split:                          ; preds = %NodeBlock, %sw.epilog.gvnsink.split.fold.split, %NodeBlock1, %NodeBlock7, %NodeBlock9, %NodeBlock3, %NodeBlock11
  %.sink18 = phi i32 [ 1, %NodeBlock11 ], [ 0, %NodeBlock3 ], [ 0, %NodeBlock ], [ 1, %NodeBlock9 ], [ 1, %NodeBlock7 ], [ 0, %NodeBlock1 ], [ 0, %sw.epilog.gvnsink.split.fold.split ]
  %.sink17 = phi i32 [ 1, %NodeBlock11 ], [ 1, %NodeBlock3 ], [ 0, %NodeBlock ], [ %spec.select, %NodeBlock9 ], [ 0, %NodeBlock7 ], [ %spec.select21, %NodeBlock1 ], [ 0, %sw.epilog.gvnsink.split.fold.split ]
  %.sink.shrunk = phi i1 [ false, %NodeBlock11 ], [ false, %NodeBlock3 ], [ true, %NodeBlock ], [ %Pivot10, %NodeBlock9 ], [ %Pivot8, %NodeBlock7 ], [ %Pivot2, %NodeBlock1 ], [ false, %sw.epilog.gvnsink.split.fold.split ]
...
sw.epilog:                                        ; preds = %NodeBlock, %sw.epilog.gvnsink.split
