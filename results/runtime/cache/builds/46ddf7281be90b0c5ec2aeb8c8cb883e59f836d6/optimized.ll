...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end22
  %indvars.iv24 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next25, %if.end22 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %if.end22 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count28
  br i1 %exitcond29.not, label %for.cond26.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv24
  br label %for.cond5
...
for.cond5:                                        ; preds = %for.cond5.preheader, %if.end
  %indvars.iv21 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next22, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv21, %indvars.iv24
  br i1 %exitcond.not, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv21
  ...
  br i1 %cmp12, label %for.end15, label %if.end

if.end:                                           ; preds = %for.body7
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond5, !llvm.loop !13

for.end15:                                        ; preds = %for.cond5, %for.body7
  %j.0.lcssa.in = phi i64 [ %indvars.iv24, %for.cond5 ], [ %indvars.iv21, %for.body7 ]
  %5 = and i64 %j.0.lcssa.in, 4294967295
  %cmp16 = icmp eq i64 %5, %indvars.iv24
...
if.end22:                                         ; preds = %if.then17, %for.end15
  %k.1 = phi i32 [ %add, %if.then17 ], [ %k.0, %for.end15 ]
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond2, !llvm.loop !14

for.cond26:                                       ; preds = %for.cond26.preheader, %if.end35
  %indvars.iv30 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next31, %if.end35 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond35.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %b, i64 0, i64 %indvars.iv30
  ...
  %cmp32 = icmp slt i64 %indvars.iv30, %2
...
if.end35:                                         ; preds = %if.then33, %for.body28
