...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %5)
  %6 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %6)
...
for.inc.gvnsink.split:                            ; preds = %if.then24, %land.lhs.true, %if.else, %lor.lhs.false14, %lor.lhs.false16, %lor.lhs.false18, %for.body, %lor.lhs.false, %lor.lhs.false3, %lor.lhs.false5, %lor.lhs.false7, %lor.lhs.false9, %lor.lhs.false11, %if.else33
  %.sink4 = phi i32 [ 28, %if.else33 ], [ 31, %lor.lhs.false11 ], [ 31, %lor.lhs.false9 ], [ 31, %lor.lhs.false7 ], [ 31, %lor.lhs.false5 ], [ 31, %lor.lhs.false3 ], [ 31, %lor.lhs.false ], [ 31, %for.body ], [ 30, %lor.lhs.false18 ], [ 30, %lor.lhs.false16 ], [ 30, %lor.lhs.false14 ], [ 30, %if.else ], [ 29, %land.lhs.true ], [ 29, %if.then24 ]
  %1 = load i32, ptr %result, align 4, !tbaa !5
  %add34 = add nsw i32 %1, %.sink4
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %result) #4
  ret i32 %add38
}
