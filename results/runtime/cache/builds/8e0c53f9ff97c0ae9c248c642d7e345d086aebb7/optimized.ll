...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %11 = phi i32 [ %inc90, %for.inc89 ], [ 1, %for.end81 ]
  %cmp83 = icmp sle i32 %11, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %idxprom85 = sext i32 %11 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %12 = phi i32 [ %inc111, %for.inc110 ], [ 1, %for.end91 ]
  %cmp93 = icmp sle i32 %12, 12
...
for.body115:                                      ; preds = %for.cond113
  ...
  %17 = load i32, ptr %year, align 4, !tbaa !5
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %17)
  %cmp118 = icmp eq i32 %call117, 1
  %18 = load i32, ptr %mon1, align 4, !tbaa !5
  %19 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom120 = sext i32 %18 to i64
  %idxprom122 = sext i32 %19 to i64
...
if.then119:                                       ; preds = %for.body115
  ...
  %20 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %cmp124 = icmp eq i32 %20, 1
