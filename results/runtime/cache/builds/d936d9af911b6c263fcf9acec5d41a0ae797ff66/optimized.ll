...
for.cond2:                                        ; preds = %for.cond, %for.inc76
  ...
  %indvars.iv31 = phi i64 [ %5, %for.inc76 ], [ 0, %for.cond ]
  %mul3 = mul nsw i32 %2, 3
  %3 = sext i32 %mul3 to i64
  %cmp4 = icmp slt i64 %indvars.iv31, %3
...
for.body5:                                        ; preds = %for.cond2
  ...
  %5 = add nuw nsw i64 %indvars.iv31, 1
...
if.then:                                          ; preds = %for.body5
  ...
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %indvars.iv31
  %7 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %mul15 = fmul double %7, 4.000000e+00
  %8 = add nuw nsw i64 %indvars.iv31, 2
