...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax26 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond12.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc60 ], [ 0, %for.cond ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc57 ], [ 0, %for.cond49.preheader ]
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond40.not, label %for.cond86, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc104 ], [ 2, %for.cond65 ]
