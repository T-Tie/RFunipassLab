...
while.cond8:                                      ; preds = %while.body17, %while.body5
  ...
  %Pivot = icmp slt i8 %3, 32
  br i1 %Pivot, label %LeafBlock, label %LeafBlock42

LeafBlock42:                                      ; preds = %while.cond8
  %SwitchLeaf43 = icmp eq i8 %3, 32
  br i1 %SwitchLeaf43, label %while.end19, label %while.body17

LeafBlock:                                        ; preds = %while.cond8
  %SwitchLeaf = icmp eq i8 %3, 0
  br i1 %SwitchLeaf, label %while.end19, label %while.body17

while.body17:                                     ; preds = %LeafBlock42, %LeafBlock
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %while.cond8, !llvm.loop !14

while.end19:                                      ; preds = %LeafBlock42, %LeafBlock
...
for.cond:                                         ; preds = %while.end19, %for.body
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body ], [ 0, %while.end19 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %idx.ext6
  br i1 %exitcond40.not, label %for.end, label %for.body
...
for.body:                                         ; preds = %for.cond
  ...
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %5)
...
for.cond33:                                       ; preds = %while.end19, %for.body36
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body36 ], [ 0, %while.end19 ]
...
for.body36:                                       ; preds = %for.cond33
  ...
  %7 = load i8, ptr %add.ptr38, align 1, !tbaa !5, !invariant.load !13
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %7)
...
while.end48:                                      ; preds = %while.cond4
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull captures(none) %a) #6
  ret i32 0
}
