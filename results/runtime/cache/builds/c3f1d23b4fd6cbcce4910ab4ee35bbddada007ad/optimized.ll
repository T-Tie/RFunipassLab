...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 500, ptr noundef nonnull align 16 %ch) #3
  br label %while.body
...
for.body:                                         ; preds = %for.cond
  ...
  store i8 %1, ptr %__c.addr.i, align 1, !tbaa !5
  ...
  %2 = load i64, ptr %gep, align 8, !tbaa !12, !invariant.load !8
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 500, ptr noundef nonnull %ch) #4
  ret i32 0
}
