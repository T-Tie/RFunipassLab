...
for.cond17:                                       ; preds = %for.inc25, %if.then15
  ...
  br i1 %cmp18, label %for.inc25, label %for.inc29
...
for.inc29:                                        ; preds = %for.end, %for.cond17
...
for.cond16:                                       ; preds = %for.inc24, %if.then14
  ...
  br i1 %cmp17, label %for.inc24, label %for.inc28
...
for.inc28:                                        ; preds = %for.end, %for.cond16
...
for.inc34:                                        ; preds = %for.cond20
  ...
  %2 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
...
for.cond13:                                       ; preds = %for.inc17, %for.end12
  %.sink = phi i32 [ %0, %for.end12 ], [ %dec, %for.inc17 ]
...
for.inc17:                                        ; preds = %for.cond13
  call void @_Z7zerorowi(i32 noundef %2) #8
  %3 = load i32, ptr @k, align 4, !tbaa !5
  call void @_Z7zerocoli(i32 noundef %3) #8
  ...
  call void @_Z4jiani(i32 noundef %6) #8
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !22, !invariant.load !9
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !9
...
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #8
  %call2 = call noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef 1, i32 noundef 4) #8
  %call3 = call noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %call, i32 noundef %call2) #8
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !28, !invariant.load !9
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !39, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !47, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !53, !invariant.load !9
  br label %return
