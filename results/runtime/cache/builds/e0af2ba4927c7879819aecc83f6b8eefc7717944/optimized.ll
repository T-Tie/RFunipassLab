...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 140000, ptr nonnull %a) #7
  call void @llvm.lifetime.start.p0(i64 140000, ptr nonnull %b) #7
...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 140000, ptr nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 140000, ptr nonnull %a) #7
