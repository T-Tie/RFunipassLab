...
for.body8:                                        ; preds = %for.cond6
  ...
  br i1 %cmp23, label %for.inc51, label %if.else

if.else:                                          ; preds = %for.body8
  %sub34 = sub nsw i32 %mul15, %mul
  %conv35 = sitofp i32 %sub34 to double
  %cmp43 = fcmp ogt double %conv35, %mul22
  br i1 %cmp43, label %for.inc51, label %if.else47

if.else47:                                        ; preds = %if.else
  br label %for.inc51

for.inc51:                                        ; preds = %for.body8, %if.else, %if.else47
  %.str.2.sink.sink = phi ptr [ @.str, %for.body8 ], [ @.str.2, %if.else47 ], [ @.str.1, %if.else ]
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %.str.2.sink.sink)
