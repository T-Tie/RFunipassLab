...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 dereferenceable(41000) %word) #10
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp3 = icmp slt i64 %indvars.iv45, %7
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv45
...
if.end:                                           ; preds = %if.else58, %if.then44
  ...
  store i8 32, ptr %arrayidx70, align 1, !tbaa !35
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax55 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %8 = add i32 %smax55, 1
  %wide.trip.count56 = zext i32 %8 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond57 = icmp eq i64 %indvars.iv51, %wide.trip.count56
  br i1 %exitcond57, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv51
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv51, i64 %9
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv48, %9
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %10 = load i8, ptr %arrayidx103, align 1, !tbaa !35
  ...
  %vbase.offset.i11 = load i64, ptr %vbase.offset.ptr.i10, align 8, !invariant.load !11
  %gep43 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i11
  %11 = load i64, ptr %gep43, align 8, !tbaa !12
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %vtable.i27 = load ptr, ptr %retval.0.i, align 8, !tbaa !9
  %vbase.offset.ptr.i28 = getelementptr i8, ptr %vtable.i27, i64 -24
  %vbase.offset.i29 = load i64, ptr %vbase.offset.ptr.i28, align 8, !invariant.load !11
  %add.ptr.i30 = getelementptr inbounds i8, ptr %retval.0.i, i64 %vbase.offset.i29
  ...
  %call1.i32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, i8 noundef signext %call.i31)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i32)
  br label %for.inc113

if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv51, i64 %indvars.iv48
  %12 = load i8, ptr %arrayidx110, align 1, !tbaa !35
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i14)
  store i8 %12, ptr %__c.addr.i14, align 1, !tbaa !35
  %vtable.i15 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i16 = getelementptr i8, ptr %vtable.i15, i64 -24
  %vbase.offset.i17 = load i64, ptr %vbase.offset.ptr.i16, align 8, !invariant.load !11
  %gep42 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i17
  %13 = load i64, ptr %gep42, align 8, !tbaa !12
  %cmp.not.i20 = icmp eq i64 %13, 0
  br i1 %cmp.not.i20, label %if.end.i24, label %if.then.i21

if.then.i21:                                      ; preds = %if.else106
...
if.end.i24:                                       ; preds = %if.else106
  %call2.i25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %12)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit26
...
for.inc113:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit26
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !39
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !42
...
!39 = !{!40, !41, i64 16}
!40 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !41, i64 8, !41, i64 16, !41, i64 24, !41, i64 32, !41, i64 40, !41, i64 48, !21, i64 56}
!41 = !{!"p1 omnipotent char", !18, i64 0}
!42 = !{!40, !41, i64 24}
!43 = !{!25, !29, i64 240}
!44 = !{!45, !7, i64 56}
!45 = !{!"_ZTSSt5ctypeIcE", !46, i64 0, !47, i64 16, !27, i64 24, !48, i64 32, !48, i64 40, !49, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
