...
for.body30:                                       ; preds = %for.cond28
  ...
  %6 = load i32, ptr %5, align 4, !tbaa !5, !invariant.load !14
  br i1 %cmp31, label %for.inc50, label %if.end37

if.end37:                                         ; preds = %for.body30
  %l2.2 = phi i32 [ %l2.1, %for.body30 ]
  %min.2 = phi i32 [ %min.1, %for.body30 ]
  %cmp42 = icmp slt i32 %6, %min.2
...
for.inc50:                                        ; preds = %for.body30, %if.end37, %land.lhs.true, %if.then44
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.2, %land.lhs.true ], [ %l2.2, %if.end37 ], [ 0, %for.body30 ]
  %min.3 = phi i32 [ %6, %if.then44 ], [ %min.2, %land.lhs.true ], [ %min.2, %if.end37 ], [ %6, %for.body30 ]
