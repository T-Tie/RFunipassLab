...
for.cond:                                         ; preds = %for.inc11, %entry
  ...
  %indvars = trunc i64 %indvars.iv.next6 to i32
  %3 = trunc nuw i64 %indvars.iv5 to i32
...
for.body:                                         ; preds = %for.cond
  %idxprom = and i64 %indvars.iv.next6, 4294967295
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  ...
  %cmp4 = icmp slt i64 %indvars.iv.next3, %5
