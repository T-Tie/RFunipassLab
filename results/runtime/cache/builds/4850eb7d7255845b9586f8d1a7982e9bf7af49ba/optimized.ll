...
for.end38:                                        ; preds = %for.cond29
  ...
  %6 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !12
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !17, !invariant.load !12
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !16, !invariant.load !12
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !17, !invariant.load !12
