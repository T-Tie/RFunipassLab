...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit39: ; preds = %if.then6.i8
...
entry_to_outline:                                 ; preds = %newFuncRoot
  ...
  br i1 %or.cond, label %if.then19.i, label %if.then6.i8.exitStub
...
if.then6.i8.exitStub:                             ; preds = %if.then28.i, %if.then19.i, %entry_to_outline
  ret void
}
