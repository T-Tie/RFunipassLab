...
for.inc50:                                        ; preds = %for.body30, %if.end37, %if.then44
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.1, %if.end37 ], [ 0, %for.body30 ]
  %min.3 = phi i32 [ %6, %if.then44 ], [ %min.1, %if.end37 ], [ %6, %for.body30 ]
