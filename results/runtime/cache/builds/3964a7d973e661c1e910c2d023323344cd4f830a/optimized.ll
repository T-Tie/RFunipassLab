...
while.cond9:                                      ; preds = %while.cond9.preheader, %if.end34
  %7 = phi i32 [ %5, %while.cond9.preheader ], [ %.pre7, %if.end34 ]
  %8 = phi i32 [ %.pre, %while.cond9.preheader ], [ %10, %if.end34 ]
  %indvars.iv4 = phi i64 [ %6, %while.cond9.preheader ], [ %indvars.iv.next5, %if.end34 ]
  %num.1 = phi i32 [ %num.0, %while.cond9.preheader ], [ %num.2, %if.end34 ]
  %add = add nsw i32 %num.1, %8
  %cmp12 = icmp slt i32 %add, 81
  %9 = sext i32 %7 to i64
  %cmp17.not = icmp slt i64 %indvars.iv4, %9
...
if.end19:                                         ; preds = %while.cond9
  %arrayidx15 = getelementptr inbounds [1000 x [41 x i8]], ptr %ch, i64 0, i64 %indvars.iv4
  ...
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %len, i64 0, i64 %indvars.iv.next5
  %10 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %add27 = add nsw i32 %10, %add
  %cmp28 = icmp slt i32 %add27, 80
  %11 = load i32, ptr %n, align 4
  %12 = sext i32 %11 to i64
  %cmp29 = icmp slt i64 %indvars.iv.next5, %12
