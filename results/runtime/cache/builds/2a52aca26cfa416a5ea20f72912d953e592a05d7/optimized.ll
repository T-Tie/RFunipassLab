...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc29 ], [ 0, %entry ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.end31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv8
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  ...
  br i1 %exitcond7.not, label %for.inc29, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv3
...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc28 ], [ 0, %entry ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.end30, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv8
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv8
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  ...
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond7.not, label %for.inc28, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv3, i64 %indvars.iv8
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax11 = tail call i32 @llvm.smax.i32(i32 noundef %sub21, i32 noundef 0)
  %smax18 = tail call i32 @llvm.smax.i32(i32 %1, i32 noundef 2)
