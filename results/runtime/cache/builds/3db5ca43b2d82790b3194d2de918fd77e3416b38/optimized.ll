...
for.end:                                          ; preds = %for.cond1
  ...
  %5 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !12
...
land.lhs.true29:                                  ; preds = %land.lhs.true24
  %10 = load i32, ptr %arrayidx7, align 4, !tbaa !5, !invariant.load !12
...
for.cond41:                                       ; preds = %for.inc69, %for.body40
  ...
  %14 = phi i32 [ %inc70, %for.inc69 ], [ 0, %for.body40 ]
  store i32 %.sink2, ptr %j, align 4, !tbaa !5
  %cmp42 = icmp slt i32 %14, 6
...
for.inc73:                                        ; preds = %for.cond41
  ...
  %call72 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %22)
  store i32 0, ptr %q, align 4, !tbaa !5
  %inc74 = add nsw i32 %12, 1
