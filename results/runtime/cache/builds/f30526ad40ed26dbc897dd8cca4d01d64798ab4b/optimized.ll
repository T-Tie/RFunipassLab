...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %m, %i.0
  %call = tail call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %i.0) #7
...
if.then10:                                        ; preds = %for.body7
  ...
  %call12 = tail call noundef i32 @_Z3funii(i32 noundef %div11, i32 noundef %i.1) #7
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %b) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %a) #8
...
for.inc10:                                        ; preds = %for.cond3
  ...
  %5 = load i32, ptr %arrayidx7, align 4, !tbaa !9, !invariant.load !14
...
!15 = distinct !{!15, !6, !7}
!16 = !{!17, !11, i64 56}
!17 = !{!"_ZTSSt5ctypeIcE", !18, i64 0, !19, i64 16, !21, i64 24, !22, i64 32, !22, i64 40, !23, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
