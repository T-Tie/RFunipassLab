...
for.inc56:                                        ; preds = %for.cond46
  ...
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom59, i64 %indvars.iv27
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  ...
  %phiofops = phi i32 [ %indvars59, %for.inc151 ], [ 0, %if.else ]
  %indvars59 = trunc i64 %indvars.iv52 to i32
...
for.body136.for.end153_crit_edge:                 ; preds = %for.body136
  %.pre = and i64 %indvars.iv52, 4294967295
  br label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136.for.end153_crit_edge
  %.pre-phi = phi i64 [ %.pre, %for.body136.for.end153_crit_edge ], [ %wide.trip.count60, %for.cond134 ]
  %phiofops.lcssa = phi i32 [ %phiofops, %for.body136.for.end153_crit_edge ], [ %smax49, %for.cond134 ]
  %wide.trip.count72 = zext i32 %phiofops.lcssa to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond73.not = icmp eq i64 %indvars.iv66, %wide.trip.count72
  br i1 %exitcond73.not, label %for.cond207, label %for.cond159.preheader
...
for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  ...
  %cmp160 = icmp samesign ult i64 %indvars.iv.next69, %.pre-phi
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond81.not = icmp eq i64 %indvars.iv77, %.pre-phi
  br i1 %exitcond81.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv74, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv77, i64 %indvars.iv74
