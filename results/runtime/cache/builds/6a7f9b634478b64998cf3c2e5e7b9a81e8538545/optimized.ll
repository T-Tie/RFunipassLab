...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax28 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count13 = zext nneg i32 %smax28 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond27, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv10
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc21 ], [ 0, %for.cond14.preheader ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond9.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv5
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc60 ], [ 0, %for.cond ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count13
  br i1 %exitcond30.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv25
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select3, %for.body34 ], [ %3, %for.body29 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv25
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select3 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond32, !llvm.loop !17

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc57 ], [ 0, %for.cond49.preheader ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv25
...
for.cond65.preheader:                             ; preds = %for.end62
  %smax52 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %wide.trip.count41 = zext nneg i32 %smax52 to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv36 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next37, %for.inc83 ]
  %exitcond42.not = icmp eq i64 %indvars.iv36, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond86, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv31 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next32, %for.inc80 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv36, i64 %indvars.iv31
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv31
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc104 ], [ 2, %for.cond65 ]
  %exitcond54.not = icmp eq i64 %indvars.iv48, %wide.trip.count41
  br i1 %exitcond54.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv48, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv43 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next44, %for.inc101 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond47.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43, i64 %9
