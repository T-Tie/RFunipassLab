...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 5000, ptr %str1) #5
  call void @llvm.lifetime.start.p0(i64 5000, ptr %str2) #5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %str1, i64 noundef 5000)
...
if.then9:                                         ; preds = %if.end
  %sub = add i32 %conv, -1
  %i.0.neg = sub i32 0, %i.0
  %sub10 = add i32 %sub, %i.0.neg
  ...
  %sub13.neg = sub i32 0, %sub13
  %sub16 = add i32 %sub, %sub13.neg
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %j.0 = phi i32 [ %sub16, %if.then9 ], [ %inc30, %for.inc ]
...
for.inc:                                          ; preds = %for.cond17
  ...
  %add22 = add i32 %conv.neg, 1
  %add23 = add i32 %add22, %sub13
  %add24 = add i32 %add23, %add
  %sub25 = add i32 %add24, %j.0
...
for.inc44:                                        ; preds = %for.cond35
  %len.0.neg = sub i32 0, %len.0
  %sub38 = add i32 %len.0.neg, %conv
...
for.end55:                                        ; preds = %for.cond47
  call void @llvm.lifetime.end.p0(i64 5000, ptr %str2) #5
  call void @llvm.lifetime.end.p0(i64 5000, ptr %str1) #5
  ret i32 0
}
