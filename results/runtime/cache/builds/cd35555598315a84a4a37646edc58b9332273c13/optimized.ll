...
for.body:                                         ; preds = %for.cond
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
...
for.cond30.preheader:                             ; preds = %for.cond7
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond30
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts31 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.3.str.2) #7
  br label %if.end68
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts29 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #7
  br label %if.end151
