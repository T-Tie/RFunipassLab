...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 200, ptr noundef nonnull captures(none) %str) #13
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %num) #14
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(800) %num, i8 noundef 0, i64 noundef 800, i1 noundef false) #15
  %call = tail call i64 @strlen(ptr nofree noundef nonnull readonly dereferenceable(1) %str) #16
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %num) #13
  ret void
}
...
attributes #16 = { nosync nounwind willreturn memory(read) }
