...
for.cond3:                                        ; preds = %for.cond, %for.inc40
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc40 ], [ 0, %for.cond ]
  %sum.0 = phi i64 [ %sum.1, %for.inc40 ], [ 0, %for.cond ]
  %sub = add nsw i32 %2, -1
  %3 = sext i32 %sub to i64
  %cmp4 = icmp slt i64 %indvars.iv17, %3
  br i1 %cmp4, label %for.body5, label %for.end42

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv17
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx7) #11
  %sext = shl i64 %sum.0, 32
  %conv = ashr exact i64 %sext, 32
  %add = add nsw i64 %conv, 1
  %add10 = add i64 %add, %call9
  %sext15 = shl i64 %add10, 32
  %conv12 = ashr exact i64 %sext15, 32
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %arrayidx15 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv.next18
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #11
  %add18 = add i64 %conv12, %call17
  %cmp19 = icmp ult i64 %add18, 81
  br i1 %cmp19, label %if.then, label %if.end

if.then:                                          ; preds = %for.body5
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %arrayidx7)
...
if.end:                                           ; preds = %for.body5
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx7)
  br label %for.inc40
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50000, ptr noundef nonnull %word) #12
  ret i32 0
}
...
if.then33_after_outline.exitStub:
  %call37 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %0)
