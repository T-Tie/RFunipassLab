...
for.cond2:                                        ; preds = %for.inc11, %for.body
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc11 ], [ 1, %for.body ]
  %exitcond15 = icmp eq i64 %indvars.iv11, %1
  br i1 %exitcond15, label %for.cond14.preheader, label %for.cond5.preheader
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  %indvars.iv48 = phi i64 [ 3, %for.cond14.preheader ], [ %indvars.iv.next49, %for.cond14.loopexit ]
  %indvars.iv16 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next17, %for.cond14.loopexit ]
  ...
  br i1 %exitcond55.not, label %for.inc138, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.inc50
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc50 ], [ %indvars.iv16, %for.cond14 ]
  %exitcond32 = icmp eq i64 %indvars.iv28, %1
  br i1 %exitcond32, label %for.cond53.preheader, label %for.body19

for.cond53.preheader:                             ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv16, %1
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  br label %for.cond53

for.body19:                                       ; preds = %for.cond17
  %7 = mul nuw nsw i64 %indvars.iv28, %1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla, i64 %7
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv16
  %8 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  br label %for.cond24

for.cond24:                                       ; preds = %for.body26, %for.body19
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body26 ], [ %indvars.iv16, %for.body19 ]
  %min.0 = phi i32 [ %spec.select, %for.body26 ], [ %8, %for.body19 ]
  %exitcond22 = icmp eq i64 %indvars.iv18, %1
  br i1 %exitcond22, label %for.cond39.preheader, label %for.body26

for.cond39.preheader:                             ; preds = %for.cond24
  br label %for.cond39

for.body26:                                       ; preds = %for.cond24
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv18
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv23 = phi i64 [ %indvars.iv16, %for.cond39.preheader ], [ %indvars.iv.next24, %for.inc47 ]
  %exitcond27 = icmp eq i64 %indvars.iv23, %1
  br i1 %exitcond27, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv23
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc88
  %indvars.iv43 = phi i64 [ %indvars.iv16, %for.cond53.preheader ], [ %indvars.iv.next44, %for.inc88 ]
  %exitcond47 = icmp eq i64 %indvars.iv43, %1
  br i1 %exitcond47, label %for.end90, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv43
  %11 = load i32, ptr %arrayidx59, align 4, !tbaa !5
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv43
  br label %for.cond60

for.cond60:                                       ; preds = %for.body62, %for.body55
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body62 ], [ %indvars.iv16, %for.body55 ]
  %min.2 = phi i32 [ %spec.select7, %for.body62 ], [ %11, %for.body55 ]
  %exitcond37 = icmp eq i64 %indvars.iv33, %1
  br i1 %exitcond37, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %12 = mul nuw nsw i64 %indvars.iv33, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %12
  %13 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select7 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv38 = phi i64 [ %indvars.iv16, %for.cond77.preheader ], [ %indvars.iv.next39, %for.inc85 ]
  %exitcond42 = icmp eq i64 %indvars.iv38, %1
  br i1 %exitcond42, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %14 = mul nuw nsw i64 %indvars.iv38, %1
  %gep9 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %14
  %15 = load i32, ptr %gep9, align 4, !tbaa !5
  %sub84 = sub nsw i32 %15, %min.2
  store i32 %sub84, ptr %gep9, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %16 = mul nuw nsw i64 %indvars.iv.next17, %1
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla, i64 %16
  %arrayidx96 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv.next17
  %17 = load i32, ptr %arrayidx96, align 4, !tbaa !5
  %arrayidx101 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv16
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc130 ], [ %indvars.iv48, %for.end90 ]
  %19 = trunc nuw i64 %indvars.iv50 to i32
  %cmp110.not = icmp slt i32 %0, %19
  br i1 %cmp110.not, label %for.cond14.loopexit, label %for.inc130

for.inc130:                                       ; preds = %for.cond109
  %arrayidx115 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv50
  %20 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx120 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv50
  store i32 %20, ptr %arrayidx120, align 4, !tbaa !5
  %21 = mul nuw nsw i64 %indvars.iv50, %1
  %arrayidx122 = getelementptr inbounds nuw i32, ptr %vla, i64 %21
  %arrayidx124 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv16
  %22 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv.next17
