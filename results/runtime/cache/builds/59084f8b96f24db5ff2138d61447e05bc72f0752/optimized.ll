...
for.end:                                          ; preds = %for.cond
  ...
  %vtable.i = load ptr, ptr %call5, align 8, !tbaa !12
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax19 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  ...
  br i1 %exitcond20.not, label %cleanup.loopexit, label %for.inc16
...
cleanup.loopexit:                                 ; preds = %for.cond9
  br label %cleanup

cleanup:                                          ; preds = %cleanup.loopexit, %for.end
  %retval.1 = phi i32 [ 0, %for.end ], [ %count.0, %cleanup.loopexit ]
