...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv18, %2
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv75 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next76, %for.end138 ]
  %indvars.iv72 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next73, %for.end138 ]
  %sum.0 = phi i32 [ 0, %while.cond11.preheader ], [ %add, %for.end138 ]
  %8 = trunc nuw i64 %indvars.iv75 to i32
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc46 ], [ 0, %for.cond35.preheader ]
...
for.cond58:                                       ; preds = %for.body60, %for.body54
  ...
  %min.2 = phi i32 [ %spec.select16, %for.body60 ], [ %12, %for.body54 ]
...
for.body60:                                       ; preds = %for.cond58
  ...
  %spec.select16 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  br label %for.cond58, !llvm.loop !17

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc87 ], [ 0, %for.cond75.preheader ]
...
while.end:                                        ; preds = %while.cond11
  ...
  %vtable.i = load ptr, ptr %call139, align 8, !tbaa !25, !invariant.load !13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call139, i8 noundef signext %call.i1)
