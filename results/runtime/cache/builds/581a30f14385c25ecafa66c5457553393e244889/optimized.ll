...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 dereferenceable(2000) %a) #8
...
if.end16:                                         ; preds = %if.then9, %if.else13, %if.then12, %if.then2, %if.else5, %if.then4
  %.sink23 = phi i32 [ %1, %if.else13 ], [ %2, %if.then12 ], [ %0, %if.then9 ], [ %0, %if.else5 ], [ %2, %if.then4 ], [ %1, %if.then2 ]
  ...
  store i32 %.sink23, ptr %__result, align 4, !tbaa !5
