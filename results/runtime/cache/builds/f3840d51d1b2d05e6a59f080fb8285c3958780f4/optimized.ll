...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %2 = phi i32 [ %.pre54, %for.body3 ], [ %0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  ...
  br i1 %exitcond40.not, label %for.end33, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv35 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %if.end
  %indvars.iv31 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next32, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv35, i64 %indvars.iv31
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %cmp20 = icmp eq i32 %5, 0
  br i1 %cmp20, label %for.end23.split.loop.exit56, label %if.end

if.end:                                           ; preds = %for.body15
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  br label %for.cond13, !llvm.loop !14

for.end23.split.loop.exit56:                      ; preds = %for.body15
  %6 = trunc nuw nsw i64 %indvars.iv31 to i32
  br label %for.end23

for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit56
  %a.2 = phi i32 [ %4, %for.end23.split.loop.exit56 ], [ %a.0, %for.cond13 ]
  %b.2 = phi i32 [ %6, %for.end23.split.loop.exit56 ], [ %b.0, %for.cond13 ]
...
for.cond34:                                       ; preds = %for.end52, %for.end33
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.end52 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.end52 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.end52 ], [ 0, %for.end33 ]
  %exitcond53.not = icmp eq i64 %indvars.iv47, %wide.trip.count39
  br i1 %exitcond53.not, label %for.end55, label %for.cond37.preheader
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  ...
  br i1 %exitcond46.not, label %for.end52, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv47, i64 %indvars.iv41
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv47, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv41, %11
  %or.cond26 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond26, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv41 to i32
  %d.2 = select i1 %or.cond26, i32 %12, i32 %d.1
