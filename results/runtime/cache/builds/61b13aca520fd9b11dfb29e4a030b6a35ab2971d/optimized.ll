...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %b) #5
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %c) #5
...
for.cond16:                                       ; preds = %for.cond13, %for.body18
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body18 ], [ 0, %for.cond13 ]
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.body38
  %indvars.iv42 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next43, %for.body38 ]
...
for.cond60:                                       ; preds = %for.cond30, %for.cond.cleanup
  ...
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.cond.cleanup ], [ 0, %for.cond30 ]
...
for.end80:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %b) #5
