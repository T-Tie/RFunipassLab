...
for.body32:                                       ; preds = %for.cond28
  ...
  %call39 = call i32 @strcmp(ptr noundef readonly captures(none) %arrayidx34, ptr noundef readonly captures(none) %arrayidx37) #11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !19, !invariant.load !10
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !27, !invariant.load !10
