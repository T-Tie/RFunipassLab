...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr nonnull %word) #11
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(41000) %word, i8 0, i64 41000, i1 false)
  call void @llvm.lifetime.start.p0(i64 81000, ptr nonnull %newword) #11
...
if.then6.i:                                       ; preds = %for.body
  ...
  %gep53 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i
  %3 = load i64, ptr %gep53, align 8, !tbaa !11
...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv55, %5
  %idxprom77 = sext i32 %k.0 to i64
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv55
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx6) #11
  ...
  store i8 32, ptr %arrayidx29, align 1, !tbaa !25
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx6) #11
...
if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #11
  store i8 32, ptr %arrayidx56, align 1, !tbaa !25
  br label %for.inc74

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #11
  store i8 32, ptr %arrayidx56, align 1, !tbaa !25
  br label %for.inc74
...
for.end76:                                        ; preds = %for.cond2
  ...
  store i8 0, ptr %arrayidx81, align 1, !tbaa !25
  %idxprom84 = sext i32 %j.0 to i64
  %arrayidx85 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom77, i64 %idxprom84
  store i8 0, ptr %arrayidx85, align 1, !tbaa !25
  %smax65 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %6 = add i32 %smax65, 1
  %wide.trip.count66 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond67 = icmp eq i64 %indvars.iv61, %wide.trip.count66
  br i1 %exitcond67, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv61
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv61, i64 %7
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv58, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv58, %7
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %8 = load i8, ptr %arrayidx103, align 1, !tbaa !25
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv61, i64 %indvars.iv58
  %9 = load i8, ptr %arrayidx110, align 1, !tbaa !25
...
for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 81000, ptr nonnull %newword) #11
  call void @llvm.lifetime.end.p0(i64 41000, ptr nonnull %word) #11
