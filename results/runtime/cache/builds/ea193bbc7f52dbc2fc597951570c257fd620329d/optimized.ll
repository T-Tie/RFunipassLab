...
for.cond:                                         ; preds = %if.end, %entry
  %indvars.iv31 = phi i32 [ %indvars.iv.next32, %if.end ], [ 1, %entry ]
  ...
  %cmp = icmp eq i8 %0, 10
  br i1 %cmp, label %for.cond4.preheader, label %if.end
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.body
  %indvars.iv28 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next29, %for.body ]
...
for.body:                                         ; preds = %for.cond4
  %arrayidx7 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv28
...
if.then20:                                        ; preds = %for.end18
  %call21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1) #7
  br label %if.end22

if.end22:                                         ; preds = %if.then20, %for.end18
  br label %for.cond23

for.cond23:                                       ; preds = %if.end57, %if.end22
  %indvars.iv43 = phi i32 [ %indvars.iv.next44, %if.end57 ], [ 97, %if.end22 ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %if.end57 ], [ 0, %if.end22 ]
  %exitcond42.not = icmp eq i64 %indvars.iv39, 26
  br i1 %exitcond42.not, label %for.end60, label %for.cond35

for.cond35:                                       ; preds = %for.cond23, %for.body37
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body37 ], [ 0, %for.cond23 ]
  %n.0 = phi i32 [ %spec.select, %for.body37 ], [ 0, %for.cond23 ]
  %exitcond38 = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond38, label %for.end50, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv33
  %3 = load i8, ptr %arrayidx39, align 1, !tbaa !5, !invariant.load !11
  %4 = zext i8 %3 to i32
  %cmp44 = icmp eq i32 %indvars.iv43, %4
...
if.then52:                                        ; preds = %for.end50
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %indvars.iv43, i32 noundef %n.0) #7
  br label %if.end57
