...
for.end27:                                        ; preds = %for.cond21
  %j.1.lcssa = phi i32 [ %j.1, %for.cond21 ]
  %arrayidx23.lcssa = phi ptr [ %arrayidx23, %for.cond21 ]
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc39, %for.end27
  %i.2 = phi i32 [ 0, %for.end27 ], [ %inc40, %for.inc39 ]
  %cmp29 = icmp slt i32 %i.2, %j.1.lcssa
...
for.end41:                                        ; preds = %for.cond28
  %5 = load i32, ptr %arrayidx23.lcssa, align 4, !tbaa !5
