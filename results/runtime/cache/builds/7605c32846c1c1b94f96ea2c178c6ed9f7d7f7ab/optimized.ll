...
land.lhs.true.i15:                                ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i
  ...
  %5 = add i64 %4, -257
  %or.cond.i19 = icmp ult i64 %5, -256
...
land.lhs.true.i43:                                ; preds = %if.then28.i27, %if.then19.i20, %land.lhs.true.i15
  ...
  %8 = add i64 %7, -257
  %or.cond.i47 = icmp ult i64 %8, -256
...
for.body:                                         ; preds = %for.cond
  ...
  %11 = load i8, ptr %arrayidx, align 1, !tbaa !31, !invariant.load !8
  %cmp13 = icmp eq i8 %11, %10
...
for.body16:                                       ; preds = %for.cond14
  ...
  %12 = load i8, ptr %arrayidx18, align 1, !tbaa !31, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv114
  %13 = load i8, ptr %arrayidx21, align 1, !tbaa !31, !invariant.load !8
  %cmp23.not = icmp eq i8 %12, %13
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %14 = trunc nuw nsw i64 %indvars.iv114 to i32
  br label %for.end

for.end:                                          ; preds = %for.cond14, %for.end.split.loop.exit
  %j.0.lcssa = phi i32 [ %14, %for.end.split.loop.exit ], [ %smax, %for.cond14 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %15 = load i8, ptr %arrayidx41, align 1, !tbaa !31, !invariant.load !8
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i)
  store i8 %15, ptr %__c.addr.i, align 1, !tbaa !31
  ...
  %16 = load i64, ptr %gep, align 8, !tbaa !22, !invariant.load !8
...
for.body50:                                       ; preds = %for.cond48
  ...
  %20 = load i64, ptr %gep110, align 8, !tbaa !22, !invariant.load !8
  %cmp.not.i83 = icmp eq i64 %20, 0
...
if.end.i87:                                       ; preds = %for.body50
  %call2.i88 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %19)
  br label %for.inc54
