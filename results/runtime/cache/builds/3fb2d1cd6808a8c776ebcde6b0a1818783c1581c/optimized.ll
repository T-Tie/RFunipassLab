...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv8
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc15 ], [ %indvars.iv2, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv4, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv4
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv21.in = phi i32 [ %indvars.iv21, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv21 = add i32 %indvars.iv21.in, -1
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next16
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax23 = call i32 @llvm.smax.i32(i32 %indvars.iv21, i32 0)
  %wide.trip.count24 = zext nneg i32 %smax23 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv18 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next19, %for.inc39 ]
  %exitcond25.not = icmp eq i64 %indvars.iv18, %wide.trip.count24
  br i1 %exitcond25.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv18
...
for.end41:                                        ; preds = %for.cond28
  %arrayidx23.le = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next16
  %6 = load i32, ptr %arrayidx23.le, align 4, !tbaa !5
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6)
