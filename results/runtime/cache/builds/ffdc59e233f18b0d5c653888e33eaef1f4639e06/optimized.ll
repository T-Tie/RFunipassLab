...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef nonnull align 16 dereferenceable(20000) %sentence) #7
  %vtable7.i.pre = load ptr, ptr @_ZSt3cin, align 8, !tbaa !5
  %vbase.offset.ptr8.i.phi.trans.insert = getelementptr i8, ptr %vtable7.i.pre, i64 -24
  %vbase.offset9.i.pre = load i64, ptr %vbase.offset.ptr8.i.phi.trans.insert, align 8, !invariant.load !8
  br label %while.cond

while.cond:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %vbase.offset9.i = phi i64 [ %vbase.offset, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ %vbase.offset9.i.pre, %entry ]
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(20000) %sentence, i64 noundef 20000)
  ...
  %2 = add i64 %0, -20001
  %or.cond.i = icmp ult i64 %2, -20000
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %if.then19.i, %if.then28.i
  %vtable = phi ptr [ %vtable12.i, %while.cond ], [ %vtable.pre11, %if.then19.i ], [ %vtable.pre, %if.then28.i ]
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
  %gep8 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 32), i64 %vbase.offset
  %4 = load i32, ptr %gep8, align 8, !tbaa !22
  %and.i.i.i = and i32 %4, 5
  %cmp.i.not.i = icmp eq i32 %and.i.i.i, 0
  br i1 %cmp.i.not.i, label %while.cond, label %for.end, !llvm.loop !31

for.end:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(20000) %sentence) #8
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(20000) %sentence, i64 noundef %call.i.i)
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef nonnull %sentence) #8
  ret i32 0
}
...
!34 = !{!35, !36, i64 16}
!35 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !36, i64 8, !36, i64 16, !36, i64 24, !36, i64 32, !36, i64 40, !36, i64 48, !20, i64 56}
