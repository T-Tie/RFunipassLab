...
for.cond4:                                        ; preds = %for.end28, %for.end
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.end28 ], [ 1, %for.end ]
  %max.0 = phi i32 [ %max.1, %for.end28 ], [ 0, %for.end ]
...
for.cond7:                                        ; preds = %for.cond7.preheader, %if.end26
  %indvars.iv6 = phi i64 [ %indvars.iv, %for.cond7.preheader ], [ %indvars.iv.next7, %if.end26 ]
  %max.1 = phi i32 [ %max.0, %for.cond7.preheader ], [ %max.2, %if.end26 ]
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, -1
  %cmp8 = icmp sgt i64 %indvars.iv6, 0
  br i1 %cmp8, label %for.body9, label %for.end28

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [25 x i32], ptr @a, i64 0, i64 %indvars.iv.next7
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %cmp14.not = icmp slt i32 %3, %2
  br i1 %cmp14.not, label %if.end26, label %if.then

if.then:                                          ; preds = %for.body9
  %arrayidx16 = getelementptr inbounds nuw [25 x i32], ptr @b, i64 0, i64 %indvars.iv.next7
...
if.end26:                                         ; preds = %if.then20, %if.then, %for.body9
