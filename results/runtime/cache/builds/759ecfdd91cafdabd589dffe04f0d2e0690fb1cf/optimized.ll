...
for.inc:                                          ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1000 x [45 x i8]], ptr %str, i64 0, i64 %idxprom
...
for.cond3:                                        ; preds = %for.inc42, %for.end
  %sum.0 = phi i32 [ 0, %for.end ], [ %sum.1, %for.inc42 ]
  %i2.0 = phi i32 [ 1, %for.end ], [ %inc43, %for.inc42 ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %cmp4 = icmp sle i32 %i2.0, %1
  br i1 %cmp4, label %for.body6, label %for.end44
...
if.then:                                          ; preds = %for.body6
  ...
  %call15 = call i64 @strlen(ptr noundef %arrayidx9) #10
  %conv16 = trunc i64 %call15 to i32
  br label %for.inc42

if.else:                                          ; preds = %for.body6
  %conv17 = sext i32 %sum.0 to i64
  %arrayidx19 = getelementptr inbounds [1000 x [45 x i8]], ptr %str, i64 0, i64 %idxprom8
  %call21 = call i64 @strlen(ptr noundef %arrayidx19) #10
  %add22 = add i64 %conv17, %call21
  %add23 = add i64 %add22, 1
  %cmp24 = icmp ule i64 %add23, 80
...
if.then25:                                        ; preds = %if.else
  ...
  %call30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call26, ptr noundef %arrayidx19)
  %call34 = call i64 @strlen(ptr noundef %arrayidx19) #10
  %add35 = add i64 %call34, 1
  %add37 = add i64 %conv17, %add35
...
for.end44:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 45000, ptr noundef %str) #11
  ret i32 0
}
