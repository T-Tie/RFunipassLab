...
for.body120:                                      ; preds = %for.cond118
  ...
  %13 = load i32, ptr %arrayidx122, align 4, !tbaa !5, !invariant.load !17
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  %15 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %sub140 = sub nsw i32 %m.0, %15
