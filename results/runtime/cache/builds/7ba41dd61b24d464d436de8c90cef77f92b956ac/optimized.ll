...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  ...
  br i1 %exitcond92.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.body19 ], [ 0, %for.cond14 ]
...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  ...
  %10 = icmp slt i64 %indvars.iv111, %sext
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond108.not = icmp eq i64 %indvars.iv105, 6
  br i1 %exitcond108.not, label %for.inc118, label %for.inc114
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  ...
  br i1 %exitcond129.not, label %for.end153, label %for.body136
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %.pre = add nuw i64 %indvars.iv120, 4294967295
  %.pre158 = and i64 %.pre, 4294967295
  %.pre159 = and i64 %indvars.iv120, 4294967295
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %wide.trip.count139.pre-phi = phi i64 [ %.pre159, %for.end153.split.loop.exit ], [ %wide.trip.count128, %for.cond134 ]
  %wide.trip.count144.pre-phi = phi i64 [ %.pre158, %for.end153.split.loop.exit ], [ %wide.trip.count118, %for.cond134 ]
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  ...
  %exitcond145.not = icmp eq i64 %indvars.iv141, %wide.trip.count144.pre-phi
  br i1 %exitcond145.not, label %for.cond207, label %for.body157
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  ...
  %exitcond140.not = icmp eq i64 %indvars.iv136, %wide.trip.count139.pre-phi
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv130 = phi i64 [ %indvars.iv.next131, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond133.not = icmp eq i64 %indvars.iv130, 6
  br i1 %exitcond133.not, label %for.inc201, label %for.inc197
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv149 = phi i64 [ %indvars.iv.next150, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond153.not = icmp eq i64 %indvars.iv149, %wide.trip.count139.pre-phi
  br i1 %exitcond153.not, label %if.end226, label %for.body209
