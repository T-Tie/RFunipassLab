...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %exitcond.not, label %for.cond1.preheader, label %for.inc
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc14
  %1 = phi i32 [ %.pre, %for.inc14 ], [ %0, %for.cond1.preheader ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc14 ], [ 0, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv14, %2
  br i1 %cmp2, label %for.body3, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.body19
  %6 = phi i32 [ %.pre20, %for.body19 ], [ %1, %for.cond17.preheader ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body19 ], [ 0, %for.cond17.preheader ]
  %7 = sext i32 %6 to i64
