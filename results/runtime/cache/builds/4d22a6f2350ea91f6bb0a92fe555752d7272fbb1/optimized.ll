...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %max) #6
...
for.cond7:                                        ; preds = %for.inc27, %for.body6
  ...
  %4 = phi i32 [ %dec, %for.inc27 ], [ %sub, %for.body6 ]
...
for.end31:                                        ; preds = %for.cond4
  ...
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %11)
