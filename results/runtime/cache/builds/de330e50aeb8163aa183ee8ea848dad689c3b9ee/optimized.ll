...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond15.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc60 ], [ 0, %for.cond ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc57 ], [ 0, %for.cond49.preheader ]
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond43.not, label %for.cond86, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc104 ], [ 2, %for.cond65 ]
