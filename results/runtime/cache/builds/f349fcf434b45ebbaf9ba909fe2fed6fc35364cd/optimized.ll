...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.24, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.26, %for.inc ]
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.body ], [ %f.28, %for.inc ]
...
for.inc:                                          ; preds = %for.body3, %if.then19
  %f.28 = phi i32 [ %f.2.ph, %if.then19 ], [ %f.1, %for.body3 ]
  %star1.26 = phi i32 [ %star1.2.ph, %if.then19 ], [ %star1.1, %for.body3 ]
  %star2.24 = phi i32 [ %star2.2.ph, %if.then19 ], [ %star2.1, %for.body3 ]
