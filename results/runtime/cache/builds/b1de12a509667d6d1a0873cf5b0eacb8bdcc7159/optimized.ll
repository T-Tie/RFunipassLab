...
for.cond10:                                       ; preds = %for.inc27, %for.end9
  ...
  %cmp11 = icmp sle i32 %i.1, %.lcssa
  br i1 %cmp11, label %for.body12, label %for.end29.loopexit12
...
for.cond13:                                       ; preds = %for.inc21, %for.body12
  ...
  %cmp14 = icmp sle i32 %j.1, %.lcssa
  br i1 %cmp14, label %for.body15, label %for.inc27
...
for.end29.loopexit:                               ; preds = %for.body15
  %i.1.lcssa17 = phi i32 [ %i.1, %for.body15 ]
  %j.1.lcssa16 = phi i32 [ %j.1, %for.body15 ]
  br label %for.end29

for.end29.loopexit12:                             ; preds = %for.cond10
  %i.1.lcssa = phi i32 [ %i.1, %for.cond10 ]
  br label %for.end29

for.end29:                                        ; preds = %for.end29.loopexit12, %for.end29.loopexit
  %i.118 = phi i32 [ %i.1.lcssa17, %for.end29.loopexit ], [ %i.1.lcssa, %for.end29.loopexit12 ]
  %x1.1 = phi i32 [ %j.1.lcssa16, %for.end29.loopexit ], [ 0, %for.end29.loopexit12 ]
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %i.2 = phi i32 [ %.lcssa, %for.end29 ], [ %dec49, %for.inc48 ]
  %cmp31 = icmp sge i32 %i.2, 1
  br i1 %cmp31, label %for.body32, label %for.end50.loopexit11

for.body32:                                       ; preds = %for.cond30
  br label %for.cond33

for.cond33:                                       ; preds = %for.inc43, %for.body32
  %j.2 = phi i32 [ %.lcssa, %for.body32 ], [ %dec, %for.inc43 ]
...
for.end50.loopexit:                               ; preds = %for.body35
  %i.2.lcssa14 = phi i32 [ %i.2, %for.body35 ]
  %j.2.lcssa13 = phi i32 [ %j.2, %for.body35 ]
  br label %for.end50

for.end50.loopexit11:                             ; preds = %for.cond30
  %i.2.lcssa = phi i32 [ %i.2, %for.cond30 ]
  br label %for.end50

for.end50:                                        ; preds = %for.end50.loopexit11, %for.end50.loopexit
  %i.215 = phi i32 [ %i.2.lcssa14, %for.end50.loopexit ], [ %i.2.lcssa, %for.end50.loopexit11 ]
  %x2.1 = phi i32 [ %j.2.lcssa13, %for.end50.loopexit ], [ 0, %for.end50.loopexit11 ]
  %x1.1.neg = sub i32 0, %x1.1
  %sub = add i32 %x1.1.neg, -1
  %sub51 = add i32 %sub, %x2.1
  %y1.1.neg = sub i32 0, %i.118
  %sub52 = add i32 %y1.1.neg, -1
  %sub53 = add i32 %sub52, %i.215
  %mul = mul nsw i32 %sub53, %sub51
