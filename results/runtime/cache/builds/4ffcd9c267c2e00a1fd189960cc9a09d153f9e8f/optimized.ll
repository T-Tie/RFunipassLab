...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 500, ptr nonnull %dna1) #5
  call void @llvm.lifetime.start.p0(i64 500, ptr nonnull %dna2) #5
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %t.0 = phi i32 [ 0, %for.cond.preheader ], [ %t.3, %for.inc ]
...
if.end63:                                         ; preds = %land.lhs.true, %for.body, %if.then45
  %t.1 = phi i32 [ %spec.select, %if.then45 ], [ %t.0, %for.body ], [ %t.0, %land.lhs.true ]
  switch i8 %0, label %if.end119 [
...
for.inc:                                          ; preds = %lor.lhs.false83, %lor.lhs.false83, %lor.lhs.false83, %lor.lhs.false83, %if.then45
  %t.3 = phi i32 [ %spec.select, %if.then45 ], [ %t.1, %lor.lhs.false83 ], [ %t.1, %lor.lhs.false83 ], [ %t.1, %lor.lhs.false83 ], [ %t.1, %lor.lhs.false83 ]
...
if.end119:                                        ; preds = %lor.lhs.false83, %if.end63, %if.then115, %if.end113
  br i1 true, label %if.end123, label %if.then121

if.then121:                                       ; preds = %if.end119
  store i8 poison, ptr null, align 1
  br i1 poison, label %if.end127, label %if.end127.sink.split

if.end123:                                        ; preds = %if.end119
  br i1 %exitcond.not.not, label %if.end127, label %if.end127.sink.split

if.end127.sink.split:                             ; preds = %if.end123, %if.then121, %entry
  %call12237 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4)
  br label %if.end127

if.end127:                                        ; preds = %if.end127.sink.split, %if.then121, %if.end123
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %a) #5
  call void @llvm.lifetime.end.p0(i64 500, ptr nonnull %dna2) #5
  call void @llvm.lifetime.end.p0(i64 500, ptr nonnull %dna1) #5
  ret i32 0
}
