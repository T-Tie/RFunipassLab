...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %k) #4
...
for.cond2:                                        ; preds = %for.end15, %for.end
  %2 = phi i32 [ %.pr, %for.end15 ], [ 0, %for.end ]
...
for.cond5:                                        ; preds = %if.end, %for.body4
  %index.0 = phi i32 [ %2, %for.body4 ], [ %index.1, %if.end ]
...
if.end:                                           ; preds = %if.then, %for.body7
  %index.1 = phi i32 [ %3, %if.then ], [ %index.0, %for.body7 ]
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #5
  br label %for.cond5
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %9, i32 noundef %10)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %k) #5
