...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc29
  %indvars.iv26 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next27, %for.inc29 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc27
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc27 ], [ %1, %for.cond3 ]
  %indvars.iv.next23 = add nsw i64 %indvars.iv22, -1
  %cmp8 = icmp sgt i64 %indvars.iv.next23, %indvars.iv26
  br i1 %cmp8, label %for.body10, label %for.inc29

for.body10:                                       ; preds = %for.cond7
  %2 = add nsw i64 %indvars.iv22, -2
  %arrayidx13 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %2
  %3 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %arrayidx15 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %indvars.iv.next23
...
for.cond33:                                       ; preds = %for.cond3, %for.inc50
  %.pre34 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.cond3 ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc50 ], [ 0, %for.cond3 ]
  %cnt.0 = phi i32 [ %cnt.1, %for.inc50 ], [ 0, %for.cond3 ]
  %5 = sext i32 %.pre34 to i64
  %cmp34 = icmp slt i64 %indvars.iv30, %5
  br i1 %cmp34, label %for.body36, label %for.end52

for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw [500 x i32], ptr %num, i64 0, i64 %indvars.iv30
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %.pre33 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  br label %if.end44

if.end44:                                         ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.then40
  %9 = phi i32 [ %.pre33, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %6, %if.then40 ]
  %call47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %9)
  %inc48 = add nsw i32 %cnt.0, 1
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre34, %for.body36 ]
  %cnt.1 = phi i32 [ %inc48, %if.end44 ], [ %cnt.0, %for.body36 ]
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond33, !llvm.loop !29

for.end52:                                        ; preds = %for.cond33
  %vtable.i14 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !15
  %vbase.offset.ptr.i15 = getelementptr i8, ptr %vtable.i14, i64 -24
  %vbase.offset.i16 = load i64, ptr %vbase.offset.ptr.i15, align 8, !invariant.load !17
  ...
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i19)
