...
for.inc.gvnsink.split:                            ; preds = %land.lhs.true, %lor.lhs.false32, %lor.lhs.false22, %lor.lhs.false20, %lor.lhs.false18, %if.end, %if.else
  %.sink20 = phi i32 [ 28, %if.else ], [ 30, %if.end ], [ 30, %lor.lhs.false18 ], [ 30, %lor.lhs.false20 ], [ 30, %lor.lhs.false22 ], [ 29, %lor.lhs.false32 ], [ 29, %land.lhs.true ]
  %6 = load i32, ptr %total1, align 4, !tbaa !5
  %add37 = add nsw i32 %6, %.sink20
...
for.cond40:                                       ; preds = %for.inc85, %for.end
  %7 = phi i32 [ %inc86, %for.inc85 ], [ 1, %for.end ]
  %8 = load i32, ptr %month2, align 4, !tbaa !5
  %cmp41 = icmp slt i32 %7, %8
...
for.inc85.gvnsink.split:                          ; preds = %land.lhs.true73, %lor.lhs.false76, %lor.lhs.false64, %lor.lhs.false62, %lor.lhs.false60, %if.end58, %if.else81
  %.sink19 = phi i32 [ 28, %if.else81 ], [ 30, %if.end58 ], [ 30, %lor.lhs.false60 ], [ 30, %lor.lhs.false62 ], [ 30, %lor.lhs.false64 ], [ 29, %lor.lhs.false76 ], [ 29, %land.lhs.true73 ]
  %11 = load i32, ptr %total2, align 4, !tbaa !5
  %add82 = add nsw i32 %11, %.sink19
  store i32 %add82, ptr %total2, align 4, !tbaa !5
  br label %for.inc85

for.inc85:                                        ; preds = %for.inc85.gvnsink.split, %if.end68
  %inc86 = add nsw i32 %7, 1
  br label %for.cond40, !llvm.loop !12

for.end87:                                        ; preds = %for.cond40
  %12 = load i32, ptr %total1, align 4, !tbaa !5
