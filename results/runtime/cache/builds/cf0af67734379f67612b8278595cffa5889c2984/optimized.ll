...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %5 = add i32 %smax17, 1
...
for.body88:                                       ; preds = %for.cond86
  ...
  %smax10 = call i32 @llvm.smax.i32(i32 %conv93, i32 0)
...
for.body96:                                       ; preds = %for.cond94
  ...
  %7 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv13, i64 %indvars.iv7
