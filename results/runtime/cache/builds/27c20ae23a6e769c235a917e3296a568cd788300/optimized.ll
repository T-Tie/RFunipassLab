...
for.cond2:                                        ; preds = %for.inc19, %for.end
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc19 ], [ 0, %for.end ]
  ...
  %exitcond14 = icmp eq i64 %indvars.iv11, 52
  br i1 %exitcond14, label %for.cond23.preheader, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond2
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv11
  br label %for.cond6
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc38
  %indvars.iv15 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next16, %for.inc38 ]
  ...
  br i1 %exitcond18, label %for.end40, label %for.body26

for.body26:                                       ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv15
