...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %p) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %q) #5
...
for.cond:                                         ; preds = %for.end28, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc30, %for.end28 ]
...
for.cond3:                                        ; preds = %if.end25, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc27, %if.end25 ]
...
for.cond6:                                        ; preds = %for.body8, %for.body5
  %k.0 = phi i32 [ 0, %for.body5 ], [ %inc, %for.body8 ]
...
for.body8:                                        ; preds = %for.cond6
  ...
  %7 = load i32, ptr %arrayidx10, align 4, !tbaa !9
  ...
  %8 = load i32, ptr %arrayidx14, align 4, !tbaa !9
  %mul = mul nsw i32 %7, %8
...
if.end25:                                         ; preds = %land.lhs.true, %for.end, %if.else23
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef %.str.sink, i32 noundef %z.0) #6
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %p) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %m) #6
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef captures(none) %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef captures(none) %a) #6
  ret i32 0
}
