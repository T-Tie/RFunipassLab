...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %year) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m1) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m2) #10
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select14 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select14
  ...
  br i1 %or.cond15, label %for.cond14, label %for.cond30
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  %x.2.lcssa.sink = phi i32 [ %x.1, %for.cond14 ], [ %x.2, %for.cond30 ]
  %rem43 = urem i32 %x.2.lcssa.sink, 7
  %cmp44 = icmp eq i32 %rem43, 0
  %.str..str.118 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.118)
...
for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m1) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %year) #11
