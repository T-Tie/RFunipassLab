...
if.then:                                          ; preds = %for.body
  %call10 = call double @sqrt(double noundef %5) #6, !tbaa !5
  ...
  %call18 = call double @sqrt(double noundef %10) #6, !tbaa !5
...
if.then42:                                        ; preds = %if.then40
  ...
  %call47 = call double @sqrt(double noundef %18) #6, !tbaa !5
  ...
  %call56 = call double @sqrt(double noundef %23) #6, !tbaa !5
...
if.else:                                          ; preds = %if.then40
  ...
  %call68 = call double @sqrt(double noundef %24) #6, !tbaa !5
  ...
  %call80 = call double @sqrt(double noundef %28) #6, !tbaa !5
