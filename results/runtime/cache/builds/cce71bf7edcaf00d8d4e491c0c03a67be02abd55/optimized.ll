...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) @a) #5
...
entry:
  ...
  %0 = load i64, ptr %_M_width.i17.i, align 8, !tbaa !12
...
if.then19.i:                                      ; preds = %entry
  ...
  br i1 %cmp.i18.i, label %if.then28.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, !prof !35
