...
for.cond1:                                        ; preds = %for.cond, %for.inc
  ...
  %a2.1 = phi i32 [ %a2.3, %for.inc ], [ %a2.0, %for.cond ]
  %a1.1 = phi i32 [ %a1.3, %for.inc ], [ %a1.0, %for.cond ]
...
land.lhs.true:                                    ; preds = %for.body4
  ...
  %spec.select2 = select i1 %cmp7, i32 %i.0, i32 %a1.1
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %for.body4
  %b1.2 = phi i32 [ %b1.1, %for.body4 ], [ %i.0, %land.lhs.true ]
  %a2.3 = phi i32 [ %a2.1, %for.body4 ], [ %spec.select, %land.lhs.true ]
  %a1.3 = phi i32 [ %a1.1, %for.body4 ], [ %spec.select2, %land.lhs.true ]
...
for.end13:                                        ; preds = %for.cond
  ...
  %sub15 = xor i32 %a2.0, -1
  %sub16 = add i32 %b2.0, %sub15
