...
for.cond9:                                        ; preds = %for.inc29, %for.body6
  %1 = phi i32 [ %dec, %for.inc29 ], [ %sub, %for.body6 ]
  %cmp10 = icmp sge i32 %1, 0
...
for.inc44:                                        ; preds = %for.body36, %if.then40
  %m.1 = phi i32 [ %6, %if.then40 ], [ %m.0, %for.body36 ]
  %inc45 = add nsw i32 %i.2, 1
  br label %for.cond34, !llvm.loop !15

for.end46:                                        ; preds = %for.cond34
  %call47 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %m.0) #5
