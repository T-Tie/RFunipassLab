...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef nonnull %c) #6
  br label %for.cond
...
for.cond6:                                        ; preds = %for.cond, %for.inc106
  ...
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc106 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp7 = icmp slt i64 %indvars.iv42, %3
  br i1 %cmp7, label %for.body8, label %for.end108

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [99 x double], ptr %b, i64 0, i64 %indvars.iv42
  %4 = load double, ptr %arrayidx10, align 8, !tbaa !12, !invariant.load !14
  %arrayidx14 = getelementptr inbounds nuw [99 x double], ptr %a, i64 0, i64 %indvars.iv42
  %5 = load double, ptr %arrayidx14, align 8, !tbaa !12, !invariant.load !14
  %mul15 = fmul double %5, 4.000000e+00
  %arrayidx17 = getelementptr inbounds nuw [99 x double], ptr %c, i64 0, i64 %indvars.iv42
  %6 = load double, ptr %arrayidx17, align 8, !tbaa !12, !invariant.load !14
  %7 = fneg double %6
...
if.then:                                          ; preds = %for.body8
  ...
  %call28 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div)
  br label %for.inc106
...
if.then32:                                        ; preds = %if.else
  %call38 = call double @sqrt(double noundef %8) #6, !tbaa !5
  %add = fsub double %call38, %4
  %mul41 = fmul double %5, 2.000000e+00
  %div42 = fdiv double %add, %mul41
  %call50 = call double @sqrt(double noundef %8) #6, !tbaa !5
  %sub = fsub double %fneg35, %call50
  %div54 = fdiv double %sub, %mul41
  %call61 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div42, double noundef %div54)
  br label %for.inc106
...
cond.true:                                        ; preds = %if.else62
  ...
  %call95 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %fneg87, double noundef %div79, double noundef %fneg87, double noundef %div79)
  br label %for.inc106

cond.false:                                       ; preds = %if.else62
  %call104 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div69, double noundef %div79, double noundef %div69, double noundef %div79)
  br label %for.inc106
...
for.end108:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef nonnull %c) #6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef nonnull %a) #6
