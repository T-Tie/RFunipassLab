...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %letter) #7
...
for.inc:                                          ; preds = %if.end, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end.thread
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #7
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %letter) #7
  ret i32 0
}
