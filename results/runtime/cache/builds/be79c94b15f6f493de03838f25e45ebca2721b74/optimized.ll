...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond10 = or i1 %cmp34, %or.cond
  %.sink2 = select i1 %or.cond10, i32 29, i32 28
...
for.cond40.preheader:                             ; preds = %for.cond2
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond40
...
for.inc:                                          ; preds = %if.end, %if.end26.thread, %if.then28
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc85
  ...
  br i1 %exitcond15.not, label %for.end87, label %for.body42
...
for.inc85:                                        ; preds = %if.end58, %if.end68.thread, %if.then70
...
for.end87:                                        ; preds = %for.cond40
  ...
  %puts13 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
