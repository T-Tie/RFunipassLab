...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc8 ], [ 0, %while.body ]
  %3 = sext i32 %2 to i64
  %cmp1 = icmp slt i64 %indvars.iv22, %3
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv79 = phi i64 [ %6, %while.cond11.preheader ], [ %indvars.iv.next80, %for.end138 ]
  %indvars.iv76 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next77, %for.end138 ]
...
for.cond14:                                       ; preds = %while.cond11, %for.inc49
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc49 ], [ 0, %while.cond11 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %indvars.iv79
  br i1 %exitcond37.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv33
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv33, i64 %indvars.iv25
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv28 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next29, %for.inc46 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %indvars.iv79
  br i1 %exitcond32.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv33, i64 %indvars.iv28
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %indvars.iv79
  br i1 %exitcond52.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv48
  %13 = load i32, ptr %arrayidx57, align 4, !tbaa !5
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select20, %for.body60 ], [ %13, %for.body54 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %indvars.iv79
  br i1 %exitcond42.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv48
  %14 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select20 = call i32 @llvm.smin.i32(i32 %min.2, i32 %14)
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond58, !llvm.loop !16

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv43 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next44, %for.inc87 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %indvars.iv79
  br i1 %exitcond47.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv48
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %indvars.iv79
  br i1 %exitcond65.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc111 ], [ 1, %for.cond95 ]
  %exitcond60.not = icmp eq i64 %indvars.iv53, %indvars.iv76
  br i1 %exitcond60.not, label %for.inc114, label %for.inc111

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv61, i64 %indvars.iv.next54
  %17 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !19
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv61, i64 %indvars.iv53
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %indvars.iv79
  br i1 %exitcond75.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc133 ], [ 1, %for.cond117 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %indvars.iv76
  br i1 %exitcond70.not, label %for.inc136, label %for.inc133

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next67, i64 %indvars.iv71
  %18 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !19
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv71
...
for.end138:                                       ; preds = %for.cond117
  ...
  %indvars82 = trunc i64 %indvars.iv.next80 to i32
  store i32 %indvars82, ptr %n, align 4, !tbaa !5
