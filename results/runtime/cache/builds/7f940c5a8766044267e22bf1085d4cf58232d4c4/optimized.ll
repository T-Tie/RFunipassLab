...
for.body13:                                       ; preds = %for.cond10
  ...
  %3 = load i8, ptr %arrayidx15, align 1, !tbaa !12, !invariant.load !13
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %.sink5 = phi i32 [ 0, %if.else58 ], [ %inc81, %for.inc80 ]
  %cmp61 = icmp slt i32 %.sink5, 1000
  br i1 %cmp61, label %for.body62, label %if.end83

for.body62:                                       ; preds = %for.cond60
  %idxprom63 = sext i32 %.sink5 to i64
  %arrayidx64 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom63
  %9 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
