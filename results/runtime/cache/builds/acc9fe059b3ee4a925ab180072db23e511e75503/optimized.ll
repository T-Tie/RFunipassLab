...
tailrecurse.outer:                                ; preds = %if.then11, %entry
  %accumulator.tr.ph = phi i32 [ %cond.i, %if.then11 ], [ -2147483648, %entry ]
...
if.then:                                          ; preds = %tailrecurse
  ...
  %accumulator.ret.tr = tail call noundef i32 @llvm.smax.i32(i32 %., i32 %accumulator.tr.ph)
...
if.then11:                                        ; preds = %if.else5
  ...
  %add = add nsw i32 %5, 1
  %call = tail call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %5, i32 noundef %n)
  %add12 = add nuw nsw i32 %call, 1
  %cond.i = tail call noundef i32 @llvm.smax.i32(i32 %add12, i32 %accumulator.tr.ph)
  br label %tailrecurse.outer
