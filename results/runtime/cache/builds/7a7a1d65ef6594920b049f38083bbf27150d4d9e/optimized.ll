...
for.cond3:                                        ; preds = %for.cond3.preheader, %if.end32
  %indvars.iv38 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next39, %if.end32 ]
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv38
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv35 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next36, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv35, %3
  br i1 %cmp8.not, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv35
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv43 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next44, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count46
  br i1 %exitcond47.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv43
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax57 = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
  %wide.trip.count58 = zext nneg i32 %smax57 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count51 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv53 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next54, %for.body56 ]
  %exitcond59.not = icmp eq i64 %indvars.iv53, %wide.trip.count58
  br i1 %exitcond59.not, label %if.end80, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv53
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv48 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next49, %for.inc73 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count51
  br i1 %exitcond52.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv48
