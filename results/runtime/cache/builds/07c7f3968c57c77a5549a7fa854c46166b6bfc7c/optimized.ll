...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %year) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m1) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %m2) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x) #11
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select12 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select12
  ...
  %or.cond13 = or i1 %cmp12, %or.cond
  %x.promoted16 = load i32, ptr %x, align 4
  %smax19 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond13, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %add1917 = phi i32 [ %add, %for.inc ], [ %x.promoted16, %for.body ]
...
for.inc:                                          ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %sw.bb17, %sw.default
  ...
  %add = add nsw i32 %add1917, %.sink
  %inc = add i32 %m.0, 1
  br label %for.cond14, !llvm.loop !9

for.cond30:                                       ; preds = %for.body, %for.inc40
  %add3814 = phi i32 [ %add34, %for.inc40 ], [ %x.promoted16, %for.body ]
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  ...
  %add34 = add nsw i32 %add3814, %.sink21
  %inc41 = add i32 %m.1, 1
  br label %for.cond30, !llvm.loop !12

for.inc53:                                        ; preds = %for.cond30, %for.cond14
  %add1917.lcssa.sink = phi i32 [ %add1917, %for.cond14 ], [ %add3814, %for.cond30 ]
  store i32 %add1917.lcssa.sink, ptr %x, align 4
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x)
  %inc54 = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !13

for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m2) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %m1) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %year) #12
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0) unnamed_addr #9 {
for.end_to_outline:
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %rem20 = srem i32 %1, 7
  %cmp21 = icmp eq i32 %rem20, 0
  %.str..str.1 = select i1 %cmp21, ptr @.str, ptr @.str.1
  %call23 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.1)
  %call24 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call23, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
