...
if.end22:                                         ; preds = %for.end
  ...
  %6 = load i8, ptr %arrayidx15, align 1, !tbaa !9, !invariant.load !13
  %conv16 = sext i8 %6 to i32
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv16, i32 noundef %4)
  store i32 0, ptr %count, align 4, !tbaa !5
  br label %for.inc23
