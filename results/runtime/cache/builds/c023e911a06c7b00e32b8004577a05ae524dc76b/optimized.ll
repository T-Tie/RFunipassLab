...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv40, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc27
  %indvars.iv47 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next48, %for.inc27 ]
  ...
  br i1 %exitcond52.not, label %for.end30, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond11
  %4 = trunc nuw nsw i64 %indvars.iv47 to i32
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc24
  %indvars.iv43 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next44, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body18

for.body18:                                       ; preds = %for.cond15
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv47, i64 %indvars.iv43
