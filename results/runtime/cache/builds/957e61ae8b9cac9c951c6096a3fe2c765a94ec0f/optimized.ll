...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4016016, ptr nonnull %shuzu) #5
...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %4 = phi i32 [ %.pre58, %for.body3 ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  ...
  %x1.0 = phi i32 [ undef, %for.cond10.preheader ], [ %x1.1.ph, %for.cond13 ]
  %y1.0 = phi i32 [ undef, %for.cond10.preheader ], [ %y1.1.ph, %for.cond13 ]
  %x2.0 = phi i32 [ undef, %for.cond10.preheader ], [ %x2.1.ph.ph, %for.cond13 ]
  %y2.0 = phi i32 [ undef, %for.cond10.preheader ], [ %y2.1.ph.ph, %for.cond13 ]
...
for.cond13.outer.outer:                           ; preds = %for.cond13.preheader, %land.lhs.true44
  %indvars.iv45.ph.ph = phi i64 [ 1, %for.cond13.preheader ], [ %10, %land.lhs.true44 ]
  %x1.1.ph.ph = phi i32 [ %x1.0, %for.cond13.preheader ], [ %x1.2.ph, %land.lhs.true44 ]
  %y1.1.ph.ph = phi i32 [ %y1.0, %for.cond13.preheader ], [ %y1.2.ph, %land.lhs.true44 ]
  %x2.1.ph.ph = phi i32 [ %x2.0, %for.cond13.preheader ], [ %spec.select31, %land.lhs.true44 ]
  %y2.1.ph.ph = phi i32 [ %y2.0, %for.cond13.preheader ], [ %spec.select32, %land.lhs.true44 ]
  br label %for.cond13.outer

for.cond13.outer:                                 ; preds = %for.cond13.outer.outer, %land.lhs.true38
  %indvars.iv45.ph = phi i64 [ %10, %land.lhs.true38 ], [ %indvars.iv45.ph.ph, %for.cond13.outer.outer ]
  %x1.1.ph = phi i32 [ %x1.2.ph, %land.lhs.true38 ], [ %x1.1.ph.ph, %for.cond13.outer.outer ]
  %y1.1.ph = phi i32 [ %y1.2.ph, %land.lhs.true38 ], [ %y1.1.ph.ph, %for.cond13.outer.outer ]
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.outer, %for.body15
  %indvars.iv45 = phi i64 [ %10, %for.body15 ], [ %indvars.iv45.ph, %for.cond13.outer ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %10 = add nuw nsw i64 %indvars.iv45, 1
  br i1 %cmp20, label %land.lhs.true, label %for.cond13, !llvm.loop !14

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv51, i64 %10
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  ...
  %spec.select = select i1 %cmp32, i32 %7, i32 %x1.1.ph
  %13 = trunc nuw nsw i64 %indvars.iv45 to i32
  %spec.select30 = select i1 %cmp32, i32 %13, i32 %y1.1.ph
  br label %land.lhs.true38

land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  %x1.2.ph = phi i32 [ %spec.select, %land.lhs.true26 ], [ %x1.1.ph, %land.lhs.true ]
  %y1.2.ph = phi i32 [ %spec.select30, %land.lhs.true26 ], [ %y1.1.ph, %land.lhs.true ]
  %14 = add nsw i64 %indvars.iv45, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv51, i64 %14
  %15 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %cmp43 = icmp eq i32 %15, 0
  br i1 %cmp43, label %land.lhs.true44, label %for.cond13.outer, !llvm.loop !14
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  ...
  %spec.select31 = select i1 %cmp50, i32 %8, i32 %x2.1.ph.ph
  %17 = trunc nuw nsw i64 %indvars.iv45 to i32
  %spec.select32 = select i1 %cmp50, i32 %17, i32 %y2.1.ph.ph
...
for.end58:                                        ; preds = %for.cond10
  ...
  %mul6529 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6529, %add60
  %18 = shl i32 %sub61, 1
  %reass.sub40 = sub i32 %sub66, %18
  %add71 = add i32 %reass.sub40, 2
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call72, i8 noundef signext %call.i33)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #5
  call void @llvm.lifetime.end.p0(i64 4016016, ptr nonnull %shuzu) #5
  ret i32 0
}
