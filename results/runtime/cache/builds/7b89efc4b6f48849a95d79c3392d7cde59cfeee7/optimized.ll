...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond7 = or i1 %cmp34, %or.cond
  %.sink2 = select i1 %or.cond7, i32 29, i32 28
...
for.cond40.preheader:                             ; preds = %for.cond2
  ...
  %smax11 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 1)
  br label %for.cond40
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc85
  ...
  br i1 %exitcond12.not, label %for.end87, label %for.body42
...
for.end87:                                        ; preds = %for.cond40
  ...
  %puts10 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
