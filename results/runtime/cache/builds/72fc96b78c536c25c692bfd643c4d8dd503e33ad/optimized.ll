...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc8 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv60 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next61, %for.end138 ]
  %indvars.iv57 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next58, %for.end138 ]
  %sum.0 = phi i32 [ 0, %while.cond11.preheader ], [ %add, %for.end138 ]
  %8 = trunc nuw i64 %indvars.iv60 to i32
  %cmp12 = icmp sgt i32 %8, 1
  br i1 %cmp12, label %for.cond14, label %while.end

for.cond14:                                       ; preds = %while.cond11, %for.inc49
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc49 ], [ 0, %while.cond11 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv60
  br i1 %exitcond18.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv14
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body22 ], [ 0, %for.body16 ]
  %min.0 = phi i32 [ %spec.select, %for.body22 ], [ %9, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %indvars.iv60
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv6
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv9 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next10, %for.inc46 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %indvars.iv60
  br i1 %exitcond13.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv60
  br i1 %exitcond33.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv29
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select1, %for.body60 ], [ %12, %for.body54 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv60
  br i1 %exitcond23.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select1 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond58, !llvm.loop !16

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv24 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next25, %for.inc87 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv60
  br i1 %exitcond28.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %indvars.iv60
  br i1 %exitcond46.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc111 ], [ 1, %for.cond95 ]
  %exitcond41.not = icmp eq i64 %indvars.iv34, %indvars.iv57
  br i1 %exitcond41.not, label %for.inc114, label %for.inc111

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %indvars.iv.next35
  %16 = load i32, ptr %arrayidx106, align 4, !tbaa !5
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %indvars.iv34
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %indvars.iv60
  br i1 %exitcond56.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc133 ], [ 1, %for.cond117 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %indvars.iv57
  br i1 %exitcond51.not, label %for.inc136, label %for.inc133

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next48, i64 %indvars.iv52
  %17 = load i32, ptr %arrayidx128, align 4, !tbaa !5
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv52
...
for.end138:                                       ; preds = %for.cond117
  ...
  store i32 %indvars63, ptr %n, align 4, !tbaa !5
