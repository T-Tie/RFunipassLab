...
if.then:                                          ; preds = %for.body
  ...
  %call11 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %div) #9
  ...
  %call18 = call double @sqrt(double noundef %10) #10, !tbaa !5
  %sub = fsub double %fneg13, %call18
  %mul19 = fmul double %7, 2.000000e+00
  %div20 = fdiv double %sub, %mul19
  %call21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div20) #9
  ...
  %.pre13 = load double, ptr %a, align 8, !tbaa !9
  %.pre14 = load double, ptr %c, align 8, !tbaa !9
  %.pre18 = fmul double %.pre13, 4.000000e+00
  %.pre19 = fneg double %.pre14
  %.pre20 = fmul double %.pre18, %.pre19
  %.pre21 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre20)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi22 = phi double [ %.pre21, %if.then ], [ %5, %for.body ]
  %mul24.pre-phi = phi double [ %.pre18, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre14, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre13, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi22, 0.000000e+00
...
if.then28:                                        ; preds = %if.end
  ...
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div31) #9
  ...
  %.pre15 = load double, ptr %b, align 8, !tbaa !9
  %.pre16 = load double, ptr %a, align 8, !tbaa !9
  %.pre17 = load double, ptr %c, align 8, !tbaa !9
  %.pre23 = fmul double %.pre16, 4.000000e+00
  %.pre24 = fneg double %.pre17
  %.pre26 = fmul double %.pre23, %.pre24
  %.pre27 = call double @llvm.fmuladd.f64(double %.pre15, double %.pre15, double %.pre26)
  br label %if.end34

if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi28 = phi double [ %.pre27, %if.then28 ], [ %.pre-phi22, %if.end ]
  %mul36.pre-phi = phi double [ %.pre23, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre17, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre16, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre15, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi28, 0.000000e+00
...
if.then42:                                        ; preds = %if.then40
  %call47 = call double @sqrt(double noundef %18) #10, !tbaa !5
  %mul48 = fmul double %15, 2.000000e+00
  %div49 = fdiv double %call47, %mul48
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div49) #9
  ...
  %call56 = call double @sqrt(double noundef %23) #10, !tbaa !5
  %mul57 = fmul double %19, 2.000000e+00
  %div58 = fdiv double %call56, %mul57
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div58) #9
  br label %if.end85

if.else:                                          ; preds = %if.then40
  %mul62 = fmul double %15, 2.000000e+00
  %div63 = fdiv double %17, %mul62
  %call68 = call double @sqrt(double noundef %18) #10, !tbaa !5
  %div70 = fdiv double %call68, %mul62
  %call71 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %div63, double noundef %div70) #9
  ...
  %call80 = call double @sqrt(double noundef %27) #10, !tbaa !5
  %div82 = fdiv double %call80, %mul74
  %call83 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %div75, double noundef %div82) #9
  br label %if.end85
