...
for.body:                                         ; preds = %for.cond
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(50) %a)
...
for.cond6:                                        ; preds = %for.inc, %if.then
  ...
  br i1 %cmp7, label %for.inc, label %for.inc43

for.inc:                                          ; preds = %for.cond6
  %idx.ext = sext i32 %j.0 to i64
  %add.ptr = getelementptr inbounds i8, ptr %a, i64 %idx.ext
  %1 = load i8, ptr %add.ptr, align 1, !tbaa !9
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %1)
...
if.else:                                          ; preds = %for.body
  ...
  %cmp13 = icmp sle i32 %add12, 80
  br i1 %cmp13, label %if.then14, label %if.else29

if.then14:                                        ; preds = %if.else
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc24, %if.then14
  %j16.0 = phi i32 [ 0, %if.then14 ], [ %inc25, %for.inc24 ]
  %cmp18 = icmp slt i32 %j16.0, %conv
  br i1 %cmp18, label %for.inc24, label %for.end26

for.inc24:                                        ; preds = %for.cond17
  %idx.ext21 = sext i32 %j16.0 to i64
  %add.ptr22 = getelementptr inbounds i8, ptr %a, i64 %idx.ext21
  %2 = load i8, ptr %add.ptr22, align 1, !tbaa !9
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %2)
  %inc25 = add nsw i32 %j16.0, 1
  br label %for.cond17, !llvm.loop !13

for.end26:                                        ; preds = %for.cond17
  %add27 = add nsw i32 %conv, 1
  %add28 = add nsw i32 %num.0, %add27
  br label %for.inc43

if.else29:                                        ; preds = %if.else
  %call30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.cond32

for.cond32:                                       ; preds = %for.inc39, %if.else29
  %j31.0 = phi i32 [ 0, %if.else29 ], [ %inc40, %for.inc39 ]
  %cmp33 = icmp slt i32 %j31.0, %conv
  br i1 %cmp33, label %for.inc39, label %for.inc43

for.inc39:                                        ; preds = %for.cond32
  %idx.ext36 = sext i32 %j31.0 to i64
  %add.ptr37 = getelementptr inbounds i8, ptr %a, i64 %idx.ext36
  %3 = load i8, ptr %add.ptr37, align 1, !tbaa !9
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %3)
  %inc40 = add nsw i32 %j31.0, 1
  br label %for.cond32, !llvm.loop !14

for.inc43:                                        ; preds = %for.cond6, %for.cond32, %for.end26
  %num.1 = phi i32 [ %conv, %for.cond6 ], [ %add28, %for.end26 ], [ %conv, %for.cond32 ]
