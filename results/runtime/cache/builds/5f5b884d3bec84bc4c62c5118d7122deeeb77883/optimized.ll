...
entry:
  ...
  %call1.peel = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %LEN)
  %0 = load i32, ptr %LEN, align 4, !tbaa !5
  %cmp.peel = icmp sgt i32 %0, 0
  br i1 %cmp.peel, label %for.cond, label %if.end80
...
for.cond:                                         ; preds = %entry, %for.cond
  ...
  br i1 %cmp, label %for.cond, label %if.end80, !llvm.loop !9

if.end80:                                         ; preds = %for.cond, %entry
