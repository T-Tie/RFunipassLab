...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %m1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %m2) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %total) #4
...
for.inc.gvnsink.split:                            ; preds = %if.else39, %lor.lhs.false34, %land.lhs.true, %if.else, %lor.lhs.false20, %lor.lhs.false22, %lor.lhs.false24, %for.body5, %lor.lhs.false, %lor.lhs.false8, %lor.lhs.false10, %lor.lhs.false12, %lor.lhs.false14, %lor.lhs.false16
  ...
  %add40 = add nsw i32 %8, %.sink1.sink
...
if.then47:                                        ; preds = %for.end
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #5
  br label %for.inc52

if.else49:                                        ; preds = %for.end
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #5
  br label %for.inc52
...
for.end54:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %total) #5
