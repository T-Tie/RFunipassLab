...
for.cond:                                         ; preds = %for.inc11, %entry
  ...
  %cmp = icmp sgt i64 %indvars.iv5, 0
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds [110 x i8], ptr @s, i64 0, i64 %indvars.iv.next6
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %indvars.iv2 = phi i64 [ %indvars.iv, %for.cond3.preheader ], [ %indvars.iv.next3, %for.inc ]
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, 1
  %cmp4 = icmp slt i64 %indvars.iv.next3, %4
  br i1 %cmp4, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds [110 x i8], ptr @s, i64 0, i64 %indvars.iv.next3
  %5 = load i8, ptr %arrayidx8, align 1, !tbaa !5, !invariant.load !8
...
for.inc11:                                        ; preds = %for.body, %for.end
  %pre.1 = phi i32 [ %6, %for.end ], [ %pre.0, %for.body ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  br label %for.cond, !llvm.loop !12

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv8 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next9, %for.inc21 ]
...
for.inc21:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv8
