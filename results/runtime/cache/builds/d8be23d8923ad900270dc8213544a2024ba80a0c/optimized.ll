...
while.cond:                                       ; preds = %while.body, %entry
  %.pr5 = phi i32 [ %sub, %while.body ], [ %.pr, %entry ]
  %a.0 = phi i32 [ %inc, %while.body ], [ 0, %entry ]
  %cmp = icmp sgt i32 %.pr5, 99
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %inc = add nuw nsw i32 %a.0, 1
  %sub = add nsw i32 %.pr5, -100
...
while.cond1:                                      ; preds = %while.body4, %while.end
  %.pr6 = phi i32 [ %0, %while.body4 ], [ %.pr5, %while.end ]
  %b.0 = phi i32 [ %inc5, %while.body4 ], [ 0, %while.end ]
  %0 = add i32 %.pr6, -50
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %.pr7 = phi i32 [ %1, %while.body13 ], [ %.pr6, %while.end7 ]
  %c.0 = phi i32 [ %inc14, %while.body13 ], [ 0, %while.end7 ]
  %1 = add i32 %.pr7, -20
  %or.cond16 = icmp ult i32 %1, 30
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %.pr8 = phi i32 [ %2, %while.body22 ], [ %.pr7, %while.end16 ]
  %d.0 = phi i32 [ %inc23, %while.body22 ], [ 0, %while.end16 ]
  %2 = add i32 %.pr8, -10
  %or.cond17 = icmp ult i32 %2, 10
  br i1 %or.cond17, label %while.body22, label %while.end25
...
land.end30:                                       ; preds = %while.end25, %while.body31
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr8, %while.end25 ]
  %e.0 = phi i32 [ %inc32, %while.body31 ], [ 0, %while.end25 ]
...
while.end41:                                      ; preds = %land.end30
  %spec.select = call i32 @llvm.smax.i32(i32 %3, i32 0)
  %call42 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %a.0, i32 noundef %b.0, i32 noundef %c.0, i32 noundef %d.0, i32 noundef %e.0, i32 noundef %spec.select) #6
