...
cond.end:                                         ; preds = %if.else, %cond.false
  %min.sink1 = phi ptr [ %min, %cond.false ], [ %arrayidx35, %if.else ]
  br label %for.inc41

for.inc41:                                        ; preds = %if.then, %cond.end
  %min.sink1.sink = phi ptr [ %min.sink1, %cond.end ], [ %arrayidx29, %if.then ]
  %5 = load i32, ptr %min.sink1.sink, align 4, !tbaa !5
...
cond.end87:                                       ; preds = %if.else75, %cond.false86
  %min.sink = phi ptr [ %min, %cond.false86 ], [ %arrayidx79, %if.else75 ]
  br label %for.inc90

for.inc90:                                        ; preds = %if.then70, %cond.end87
  %min.sink.sink = phi ptr [ %min.sink, %cond.end87 ], [ %arrayidx74, %if.then70 ]
  %10 = load i32, ptr %min.sink.sink, align 4, !tbaa !5
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %16 = load i32, ptr %arrayidx157, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %16, ptr %arrayidx161, align 4, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %17 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %17, ptr %arrayidx184, align 4, !tbaa !5
