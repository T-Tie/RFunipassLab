...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc47
  %indvars.iv9 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next10, %for.inc47 ]
  %exitcond19.not = icmp eq i64 %indvars.iv9, %wide.trip.count18
  br i1 %exitcond19.not, label %for.cond51, label %for.cond28.preheader

for.cond28.preheader:                             ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv9
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv9
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc44
  %indvars.iv11 = phi i64 [ %indvars.iv9, %for.cond28.preheader ], [ %indvars.iv.next12, %for.inc44 ]
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.inc47, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next12
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  ...
  %cmp75 = icmp slt i64 %indvars.iv25, %7
