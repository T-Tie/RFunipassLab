...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv4 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next5, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  ...
  %wide.trip.count14 = zext i32 %j.0 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv16
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc37 ], [ %indvars.iv8, %for.body17 ]
  %exitcond15.not = icmp eq i64 %indvars.iv10, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond15.loopexit, label %for.body21
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv23 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next24, %for.inc53 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count21
  br i1 %exitcond27.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv23
  ...
  %cmp49 = icmp slt i64 %indvars.iv23, %4
