...
for.end:                                          ; preds = %for.cond
  ...
  br i1 %cmp22, label %if.then23, label %for.cond26.preheader
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc51
  %i.1 = phi i32 [ %inc52, %for.inc51 ], [ 65, %for.cond26.preheader ]
  %exitcond.not = icmp eq i32 %i.1, 91
  br i1 %exitcond.not, label %for.cond54.preheader, label %for.cond29.preheader

for.cond29.preheader:                             ; preds = %for.cond26
  br label %for.cond29

for.cond54.preheader:                             ; preds = %for.cond26
  br label %for.cond54

for.cond29:                                       ; preds = %for.cond29.preheader, %for.body34
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body34 ], [ 0, %for.cond29.preheader ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond29.preheader ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv29
  %2 = load i8, ptr %arrayidx31, align 1, !tbaa !5
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc80
  %i.2 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.cond54.preheader ]
  %exitcond35.not = icmp eq i32 %i.2, 123
  br i1 %exitcond35.not, label %if.end83.loopexit, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond54
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.body62
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body62 ], [ 0, %for.cond57.preheader ]
  %l.1 = phi i32 [ %spec.select26, %for.body62 ], [ 0, %for.cond57.preheader ]
...
if.end83.loopexit:                                ; preds = %for.cond54
  br label %if.end83

if.end83:                                         ; preds = %if.end83.loopexit, %if.then23
