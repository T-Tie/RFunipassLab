...
for.cond4:                                        ; preds = %if.end25, %for.end
  %j.0 = phi i32 [ 1, %for.end ], [ %j.1, %if.end25 ]
  %i.1 = phi i32 [ 1, %for.end ], [ %inc27, %if.end25 ]
...
for.cond7:                                        ; preds = %if.end, %for.body6
  %m.1 = phi i32 [ 0, %for.body6 ], [ %m.2, %if.end ]
  %k.0 = phi i32 [ 0, %for.body6 ], [ %inc16, %if.end ]
...
for.cond29:                                       ; preds = %for.body31, %for.end28
  %i.2 = phi i32 [ 0, %for.end28 ], [ %inc37, %for.body31 ]
