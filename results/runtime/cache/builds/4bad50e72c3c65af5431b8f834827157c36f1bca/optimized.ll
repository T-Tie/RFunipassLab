...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef align 16 %str) #7
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %str, i8 noundef 0, i64 noundef 10000, i1 noundef false) #8
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef align 16 %b) #7
  br label %while.cond
...
if.then30:                                        ; preds = %for.end28
  ...
  %8 = load i8, ptr %arrayidx32, align 1, !tbaa !9, !invariant.load !13
  %call33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %8)
  br label %if.end34
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %k) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #9
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %str) #9
  ret i32 0
}
