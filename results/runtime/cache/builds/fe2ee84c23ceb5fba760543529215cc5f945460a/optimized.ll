...
for.cond2:                                        ; preds = %for.inc28, %for.end
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc28 ], [ 1, %for.end ]
  %ans.0 = phi i32 [ 1, %for.inc28 ], [ 0, %for.end ]
...
if.then:                                          ; preds = %for.body9
  ...
  %spec.select.i = add nuw nsw i32 %6, 1
  store i32 %spec.select.i, ptr %arrayidx6, align 4, !tbaa !5
  br label %for.inc22
