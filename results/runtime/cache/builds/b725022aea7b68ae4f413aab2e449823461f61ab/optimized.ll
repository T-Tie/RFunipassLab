...
for.cond:                                         ; preds = %if.end13, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc15, %if.end13 ]
  %counter.0 = phi i32 [ 0, %entry ], [ %counter.1, %if.end13 ]
...
for.cond17:                                       ; preds = %if.end42, %for.end16
  %i.1 = phi i32 [ 0, %for.end16 ], [ %inc44, %if.end42 ]
  %counter.2 = phi i32 [ %counter.0, %for.end16 ], [ %counter.3, %if.end42 ]
...
for.cond20:                                       ; preds = %if.end29, %for.body19
  %j.1 = phi i32 [ 0, %for.body19 ], [ %inc31, %if.end29 ]
...
if.then34:                                        ; preds = %for.end32
  ...
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %6)
...
if.end42:                                         ; preds = %if.then34, %if.then39, %for.end32
  %counter.3 = phi i32 [ %counter.2, %for.end32 ], [ %dec, %if.then39 ], [ %dec, %if.then34 ]
