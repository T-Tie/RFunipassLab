...
for.cond14:                                       ; preds = %for.body, %for.inc
  ...
  %exitcond11.not = icmp eq i32 %5, %smax10
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %6, %smax10
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.112 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.112)
