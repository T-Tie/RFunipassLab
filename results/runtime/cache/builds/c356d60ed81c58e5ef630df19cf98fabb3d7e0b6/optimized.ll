...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call2 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEEcvbEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i)
...
if.end.thread:                                    ; preds = %while.body
  %cmp810 = icmp slt i32 %add, 80
  br i1 %cmp810, label %if.else14, label %if.then25
...
if.end19:                                         ; preds = %if.end, %if.else14
  ...
  %sum.111 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
...
if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  ...
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.111, %if.end19 ], [ 0, %if.then21 ]
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #9
  ret i32 0
}
