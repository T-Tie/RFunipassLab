...
if.then:                                          ; preds = %while.body
  ...
  %call5 = call i64 @strlen(ptr noundef %word) #10
  %conv = trunc i64 %call5 to i32
  br label %if.end31

if.else:                                          ; preds = %while.body
  %call7 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #10
  %add = add i64 %call7, 1
...
if.then12:                                        ; preds = %if.else
  ...
  %call17 = call i64 @strlen(ptr noundef %word) #10
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %word) #11
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !16, !invariant.load !14
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !27, !invariant.load !14
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !41, !invariant.load !14
  ret i64 %0
}
