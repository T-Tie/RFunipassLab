...
entry:
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %add, i32 0)
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond48.not, label %for.cond15.preheader, label %for.cond4

for.cond15.preheader:                             ; preds = %for.cond
  %wide.trip.count54 = zext i32 %add to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %wide.trip.count47
  br i1 %exitcond60.not, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv56
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv56
  br label %for.cond21
...
for.cond21:                                       ; preds = %for.inc39, %for.body19
  ...
  br i1 %exitcond55.not, label %for.cond15.loopexit, label %for.body25
...
if.then:                                          ; preds = %for.body25
  %3 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !10
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count47
  br i1 %exitcond65.not, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv61
  %4 = load i32, ptr %arrayidx55, align 4, !tbaa !5, !invariant.load !10
...
if.then57:                                        ; preds = %for.body53
  ...
  %5 = trunc nuw nsw i64 %indvars.iv61 to i32
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.040 = phi i32 [ %6, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.040)
  %smax69 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count70 = zext nneg i32 %smax69 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond71.not = icmp eq i64 %indvars.iv66, %wide.trip.count70
  br i1 %exitcond71.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv66
  %7 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !10
