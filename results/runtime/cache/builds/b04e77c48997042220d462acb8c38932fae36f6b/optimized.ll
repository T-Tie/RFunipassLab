...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr %a) #10
  call void @llvm.lifetime.start.p0(i64 1000, ptr %b) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %w) #10
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %w)
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %b)
...
lor.lhs.false22:                                  ; preds = %lor.lhs.false17
  ...
  br i1 %cmp26, label %land.lhs.true, label %if.then46
...
land.lhs.true:                                    ; preds = %lor.lhs.false22, %lor.lhs.false17, %lor.lhs.false, %for.body
  ...
  %conv29 = sext i8 %1 to i32
  %cmp30 = icmp eq i32 %conv29, 65
  br i1 %cmp30, label %if.end, label %lor.lhs.false31

lor.lhs.false31:                                  ; preds = %land.lhs.true
  %cmp35 = icmp eq i32 %conv29, 71
  br i1 %cmp35, label %if.end, label %lor.lhs.false36

lor.lhs.false36:                                  ; preds = %lor.lhs.false31
  %cmp40 = icmp eq i32 %conv29, 67
  br i1 %cmp40, label %if.end, label %lor.lhs.false41

lor.lhs.false41:                                  ; preds = %lor.lhs.false36
  %cmp45 = icmp eq i32 %conv29, 84
  br i1 %cmp45, label %if.end, label %if.then46

if.then46:                                        ; preds = %lor.lhs.false41, %lor.lhs.false22
  %call47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  br label %for.end

if.end:                                           ; preds = %lor.lhs.false41, %lor.lhs.false36, %lor.lhs.false31, %land.lhs.true
  br label %for.inc
...
for.end:                                          ; preds = %if.then46, %for.cond
  %phiofops = phi i1 [ true, %for.cond ], [ false, %if.then46 ]
  %k.0 = phi i32 [ 1, %if.then46 ], [ 0, %for.cond ]
  br i1 %phiofops, label %if.then49, label %if.end74

if.then49:                                        ; preds = %for.end
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc63, %if.then49
  %j.0 = phi i32 [ 0, %if.then49 ], [ %inc64, %for.inc63 ]
  %count.0 = phi i32 [ 0, %if.then49 ], [ %count.1, %for.inc63 ]
...
if.end75:                                         ; preds = %if.end74, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %w) #10
  call void @llvm.lifetime.end.p0(i64 1000, ptr %b) #10
  call void @llvm.lifetime.end.p0(i64 1000, ptr %a) #10
  ret i32 0
}
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !16
  %1 = load i32, ptr %__c2, align 4, !tbaa !16
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
!17 = !{!"int", !6, i64 0}
!18 = !{!19, !20, i64 16}
!19 = !{!"_ZTSSt8ios_base", !20, i64 8, !20, i64 16, !21, i64 24, !22, i64 28, !22, i64 32, !23, i64 40, !25, i64 48, !6, i64 64, !17, i64 192, !26, i64 200, !27, i64 208}
!20 = !{!"long", !6, i64 0}
...
!29 = !{!30, !33, i64 232}
!30 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !19, i64 0, !31, i64 216, !6, i64 224, !32, i64 225, !33, i64 232, !34, i64 240, !35, i64 248, !36, i64 256}
