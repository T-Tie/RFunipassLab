...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax15 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
  %wide.trip.count16 = zext nneg i32 %smax15 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv6
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv3, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next4 = add nsw i64 %indvars.iv3, 1
  %7 = trunc nsw i64 %indvars.iv3 to i32
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv3
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv10 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next11, %for.inc44 ]
  %exitcond17.not = icmp eq i64 %indvars.iv10, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv10, %2
  ...
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv10
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv18
