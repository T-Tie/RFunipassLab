...
while.cond:                                       ; preds = %while.body, %for.body4
  ...
  %1 = load i8, ptr %q.0, align 1, !tbaa !12, !invariant.load !13
...
if.end35:                                         ; preds = %if.end
  %s.1 = phi i32 [ %s.0, %if.end ]
  %cmp36 = icmp eq i32 %s.1, 0
  br i1 %cmp36, label %if.then37, label %for.inc47

if.then37:                                        ; preds = %if.end35.thread, %if.end35
  %s.15 = phi i32 [ 0, %if.end35.thread ], [ %s.1, %if.end35 ]
...
for.inc47:                                        ; preds = %if.end35, %if.then37
  %s.14 = phi i32 [ %s.15, %if.then37 ], [ %s.1, %if.end35 ]
  %add45 = add nsw i32 %s.14, %5
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !30, !invariant.load !13
  ret ptr %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !38, !invariant.load !13
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !39, !invariant.load !13
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !42, !invariant.load !13
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !12, !invariant.load !13
