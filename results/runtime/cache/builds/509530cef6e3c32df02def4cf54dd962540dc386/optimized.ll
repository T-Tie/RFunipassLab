...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull align 16 dereferenceable(1600) %a) #9
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(5) %0) unnamed_addr #8 {
for.inc41.exitStub:
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
