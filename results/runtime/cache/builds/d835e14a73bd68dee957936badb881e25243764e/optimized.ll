...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %judge) #6
  br label %for.cond
...
for.end90:                                        ; preds = %for.cond34
  ...
  %20 = load i32, ptr %arrayidx92, align 4, !tbaa !5
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %26 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %sub124 = sub nsw i32 %25, 1
...
for.end136:                                       ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %judge) #6
