...
entry:
  ...
  call fastcc void @outlined_ir_func_0(ptr nonnull %call4, ptr null, i32 -1)
...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %call71.loc)
  call fastcc void @outlined_ir_func_0.6(ptr nonnull %call69, i32 %.sink282, ptr nonnull %call71.loc)
  %call71.reload = load ptr, ptr %call71.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %call71.loc)
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %call73.loc)
  call fastcc void @outlined_ir_func_0.6(ptr %call71.reload, i32 %.sink, ptr nonnull %call73.loc)
  %call73.reload = load ptr, ptr %call73.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %call73.loc)
  call fastcc void @outlined_ir_func_0(ptr %call73.reload, ptr null, i32 -1)
  br label %sw.epilog
...
if.then:                                          ; preds = %sw.epilog
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %call.i.i251.loc)
  call fastcc void @outlined_ir_func_0(ptr nonnull %call75, ptr nonnull %call.i.i251.loc, i32 0)
  %call.i.i251.reload = load ptr, ptr %call.i.i251.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %call.i.i251.loc)
...
if.else:                                          ; preds = %sw.epilog
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr nonnull %call81.loc)
  call fastcc void @outlined_ir_func_0.6(ptr nonnull %call79, i32 %rem, ptr nonnull %call81.loc)
  %call81.reload = load ptr, ptr %call81.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr nonnull %call81.loc)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call81.sink287 = phi ptr [ %call81.reload, %if.else ], [ %call77, %if.then ]
  call fastcc void @outlined_ir_func_0(ptr %call81.sink287, ptr null, i32 -1)
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr writeonly captures(none) %1, i32 %2) unnamed_addr #4 {
entry_after_outline.exitStub:
  ...
  %call.i35 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i, i8 noundef signext 10)
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %call.i35)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_0.6(ptr %0, i32 %1, ptr writeonly captures(none) initializes((0, 8)) %2) unnamed_addr #4 {
sw.epilog.sink.split_after_outline.exitStub:
  ...
  %call.i228 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i227, i8 noundef signext 10)
  %call1.i229 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %call.i228)
  %call.i.i230 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i229)
  %call71 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i230, i32 noundef %1)
