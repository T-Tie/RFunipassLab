...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef nonnull align 16 dereferenceable(600) %input) #8
...
if.else:                                          ; preds = %for.end69
  ...
  call fastcc void @outlined_ir_func_0(ptr %call74)
...
if.then82:                                        ; preds = %for.body78
  ...
  %call.i.i3 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx84) #10
...
if.then71_to_outline:                             ; preds = %newFuncRoot
  ...
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %call.i6)
  ...
  br label %if.then71_after_outline.exitStub

if.then71_after_outline.exitStub:                 ; preds = %if.then71_to_outline
  ret void
}
