...
for.cond2:                                        ; preds = %for.inc19, %for.end
  %0 = load ptr, ptr %q, align 8, !tbaa !12
  %1 = load i8, ptr %0, align 1, !tbaa !15, !invariant.load !16
...
for.cond6:                                        ; preds = %for.inc16, %for.body4
  ...
  %3 = load i8, ptr %2, align 1, !tbaa !15, !invariant.load !16
...
if.then:                                          ; preds = %for.body9
  ...
  %5 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !16
...
for.inc19:                                        ; preds = %for.cond6
  ...
  %incdec.ptr20 = getelementptr inbounds nuw i8, ptr %0, i32 1
...
for.cond23:                                       ; preds = %for.inc38, %for.end21
  %7 = load ptr, ptr %q, align 8, !tbaa !12
  %8 = load i8, ptr %7, align 1, !tbaa !15, !invariant.load !16
...
for.body26:                                       ; preds = %for.cond23
  ...
  %10 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !16
  %cmp29 = icmp ne i32 %10, 0
  br i1 %cmp29, label %if.then30, label %for.inc38

if.then30:                                        ; preds = %for.body26
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv24, i32 noundef %10) #7
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #7
  br label %for.inc38

for.inc38:                                        ; preds = %for.body26, %if.then30
  %inc37 = add nsw i32 %9, 1
  store i32 %inc37, ptr %j, align 4, !tbaa !5
  %incdec.ptr39 = getelementptr inbounds nuw i8, ptr %7, i32 1
