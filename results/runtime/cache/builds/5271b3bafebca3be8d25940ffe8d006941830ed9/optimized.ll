...
for.inc8:                                         ; preds = %for.cond2
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %i.1, i32 noundef %0) #7
