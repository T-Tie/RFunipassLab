...
for.cond13:                                       ; preds = %for.inc135, %for.end12
  ...
  store i32 %.sink, ptr %c, align 4, !tbaa !5
...
for.end88:                                        ; preds = %for.cond51
  ...
  %22 = load i32, ptr %arrayidx90, align 8, !tbaa !5
...
for.cond91:                                       ; preds = %for.inc110, %for.end88
  ...
  %sub92 = sub nsw i32 %8, 1
  %cmp93 = icmp slt i32 %24, %sub92
...
for.inc139:                                       ; preds = %for.cond13
  ...
  %call137 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %30)
