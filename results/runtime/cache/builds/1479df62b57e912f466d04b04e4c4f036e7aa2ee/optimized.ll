...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %l) #8
...
LeafBlock40:                                      ; preds = %for.body
  %SwitchLeaf41 = icmp eq i64 %2, 0
  %vbase.offset9.i.pre44 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !9
  br i1 %SwitchLeaf41, label %do.end.i, label %if.then6.i
...
do.end.i:                                         ; preds = %LeafBlock40
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i.pre44
...
if.then6.i:                                       ; preds = %LeafBlock.if.then6.i_crit_edge, %LeafBlock40
  %vbase.offset9.i = phi i64 [ %vbase.offset9.i.pre, %LeafBlock.if.then6.i_crit_edge ], [ %vbase.offset9.i.pre44, %LeafBlock40 ]
...
for.cond2:                                        ; preds = %for.cond2.preheader, %while.end
  %indvars.iv26 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next27, %while.end ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond.not, label %for.cond17, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv26
  store i32 0, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv26
  br label %while.cond

while.cond:                                       ; preds = %while.body, %for.body4
  %q.0 = phi ptr [ %arrayidx8, %for.body4 ], [ %incdec.ptr, %while.body ]
  %4 = load i8, ptr %q.0, align 1, !tbaa !24, !invariant.load !9
...
for.cond17:                                       ; preds = %for.cond2, %if.end42
  %.pre42 = phi i32 [ %.pre, %if.end42 ], [ %0, %for.cond2 ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %if.end42 ], [ 0, %for.cond2 ]
  %s.0 = phi i32 [ %add46, %if.end42 ], [ 0, %for.cond2 ]
  %5 = sext i32 %.pre42 to i64
  %cmp18 = icmp slt i64 %indvars.iv30, %5
  br i1 %cmp18, label %for.body19, label %for.end49

for.body19:                                       ; preds = %for.cond17
  %cmp20 = icmp sgt i32 %s.0, 0
  %arrayidx22 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv30
  %6 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !9
  %add = add nsw i32 %6, %s.0
  br i1 %cmp20, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %for.body19
  %cmp23 = icmp slt i32 %add, 81
  br i1 %cmp23, label %if.end35.thread38, label %if.end35.thread

if.end35.thread38:                                ; preds = %land.lhs.true
...
if.end:                                           ; preds = %for.body19
  ...
  br i1 %7, label %if.end35.thread, label %if.end35

if.end35.thread:                                  ; preds = %land.lhs.true, %if.end
...
if.end42.sink.split:                              ; preds = %if.end35, %if.end35.thread, %if.end35.thread38
  %call24.sink = phi ptr [ %call24, %if.end35.thread38 ], [ @_ZSt4cout, %if.end35.thread ], [ @_ZSt4cout, %if.end35 ]
  %s.123.ph = phi i32 [ %s.0, %if.end35.thread38 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
  %arrayidx26 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv30
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call24.sink, ptr noundef nonnull %arrayidx26)
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end42

if.end42:                                         ; preds = %if.end42.sink.split, %if.end35
  %.pre = phi i32 [ %.pre42, %if.end35 ], [ %.pre.pre, %if.end42.sink.split ]
  %s.123 = phi i32 [ %s.0, %if.end35 ], [ %s.123.ph, %if.end42.sink.split ]
  %add45 = add i32 %6, 1
  %add46 = add i32 %add45, %s.123
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond17, !llvm.loop !27

for.end49:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %l) #9
  call void @llvm.lifetime.end.p0(i64 noundef 25000, ptr noundef nonnull %word) #9
