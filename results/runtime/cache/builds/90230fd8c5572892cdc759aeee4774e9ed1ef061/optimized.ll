...
if.then:                                          ; preds = %for.body
  ...
  %sub35 = fsub double %.pre63, %call34
...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc132 ], [ 0, %for.cond ]
  %10 = sext i32 %9 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv60, %10
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv60
  %arrayidx80 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 8
  %11 = load double, ptr %arrayidx80, align 8, !tbaa !9, !invariant.load !11
  %12 = load double, ptr %arrayidx79, align 16, !tbaa !9, !invariant.load !11
  %mul88 = fmul double %12, 4.000000e+00
  %arrayidx91 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 16
  %13 = load double, ptr %arrayidx91, align 16, !tbaa !9, !invariant.load !11
  %14 = fneg double %13
  ...
  %16 = load double, ptr %arrayidx120, align 8, !tbaa !9, !invariant.load !11
  %arrayidx123 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 32
  %17 = load double, ptr %arrayidx123, align 16, !tbaa !9, !invariant.load !11
...
if.else117:                                       ; preds = %for.body77
  ...
  %18 = load double, ptr %arrayidx129, align 8, !tbaa !9, !invariant.load !11
...
newFuncRoot:
  br label %for.end134_to_outline

for.end134_to_outline:                            ; preds = %newFuncRoot
  %0 = load ptr, ptr @stdin, align 8, !tbaa !16
  %call.i3 = call i32 @getc(ptr noundef %0)
  br label %for.end134_after_outline.exitStub

for.end134_after_outline.exitStub:                ; preds = %for.end134_to_outline
  ret void
}
...
attributes #7 = { mustprogress nocallback nofree nounwind willreturn memory(errnomem: write) }
