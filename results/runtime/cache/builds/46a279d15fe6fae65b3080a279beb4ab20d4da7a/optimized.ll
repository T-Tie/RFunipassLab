...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr %word) #11
  call void @llvm.memset.p0.i64(ptr align 16 %word, i8 0, i64 41000, i1 false)
  call void @llvm.lifetime.start.p0(i64 81000, ptr %newword) #11
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef %arrayidx6) #12
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef %arrayidx20, ptr noundef %arrayidx6) #11
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef %arrayidx35, ptr noundef %arrayidx6) #11
...
if.then44:                                        ; preds = %if.else42
  ...
  %call51 = call ptr @strcpy(ptr noundef %arrayidx46, ptr noundef %arrayidx6) #11
  br label %for.inc74.gvnsink.split

if.else58:                                        ; preds = %if.else42
  %idxprom59 = sext i32 %k.0 to i64
  %arrayidx60 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom59
  %call65 = call ptr @strcat(ptr noundef %arrayidx60, ptr noundef %arrayidx6) #11
  br label %for.inc74.gvnsink.split
...
for.body88:                                       ; preds = %for.cond86
  ...
  %call92 = call i64 @strlen(ptr noundef %arrayidx90) #12
...
for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 81000, ptr %newword) #11
  call void @llvm.lifetime.end.p0(i64 41000, ptr %word) #11
