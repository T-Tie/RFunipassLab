...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef align 16 %c) #5
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %e) #5
...
for.end22:                                        ; preds = %for.cond
  %.pr4 = load i32, ptr %s, align 4, !tbaa !5
  %cmp23 = icmp eq i32 %.pr4, 0
...
for.inc32:                                        ; preds = %for.cond25
  ...
  %7 = load i8, ptr %arrayidx29, align 1, !tbaa !9, !invariant.load !10
...
if.end36:                                         ; preds = %for.cond25, %for.end22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %e) #7
