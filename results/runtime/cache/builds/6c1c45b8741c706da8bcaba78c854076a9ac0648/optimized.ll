...
if.then:                                          ; preds = %for.body15
  ...
  %4 = load i32, ptr %h25, align 4, !tbaa !12
  %h28 = getelementptr inbounds nuw %struct.z, ptr %arrayidx20, i32 0, i32 1
  %5 = load i32, ptr %h28, align 4, !tbaa !12
...
for.body52:                                       ; preds = %for.cond50
  ...
  %6 = load i32, ptr %h55, align 4, !tbaa !12
  ...
  %7 = load i32, ptr %h58, align 4, !tbaa !12
...
for.end79:                                        ; preds = %for.cond45
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %8)
