...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  ...
  %n.promoted8 = phi i32 [ %n.promoted7, %for.inc30 ], [ %1, %for.cond ]
  %i.0 = phi i32 [ %inc31, %for.inc30 ], [ 1, %for.cond ]
  %cmp4 = icmp slt i32 %i.0, %n.promoted8
  br i1 %cmp4, label %for.cond6, label %for.cond33

for.cond6:                                        ; preds = %for.cond3, %for.inc27
  %4 = phi i32 [ %9, %for.inc27 ], [ %3, %for.cond3 ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc27 ], [ 0, %for.cond3 ]
  %n.promoted7 = phi i32 [ %n.promoted6, %for.inc27 ], [ %n.promoted8, %for.cond3 ]
  %dec4 = phi i32 [ %dec3, %for.inc27 ], [ %n.promoted8, %for.cond3 ]
  %i.1 = phi i32 [ %i.2, %for.inc27 ], [ %i.0, %for.cond3 ]
  %5 = sext i32 %i.1 to i64
  %cmp7 = icmp slt i64 %indvars.iv13, %5
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv13
...
for.cond15.preheader:                             ; preds = %for.body9
  %smax = call i32 @llvm.smax.i32(i32 %i.1, i32 %dec4)
  %wide.trip.count = sext i32 %smax to i64
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv10 = phi i64 [ %5, %for.cond15.preheader ], [ %indvars.iv.next11, %for.inc23 ]
...
for.inc23:                                        ; preds = %for.cond15
  ...
  %arrayidx20 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv.next11
  %8 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !12
  %arrayidx22 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv10
...
for.inc27:                                        ; preds = %for.body9, %for.end25
  ...
  %n.promoted6 = phi i32 [ %dec, %for.end25 ], [ %n.promoted7, %for.body9 ]
  %dec3 = phi i32 [ %dec, %for.end25 ], [ %dec4, %for.body9 ]
...
for.cond33:                                       ; preds = %for.cond3, %for.body35
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body35 ], [ 0, %for.cond3 ]
  %11 = sext i32 %10 to i64
  %cmp34 = icmp slt i64 %indvars.iv16, %11
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %10, -1
  %12 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv16, %12
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv16
