...
for.cond38:                                       ; preds = %for.inc45, %for.end35
  %4 = phi i32 [ %dec46, %for.inc45 ], [ %sub37, %for.end35 ]
  %cmp39 = icmp sge i32 %4, 0
...
for.inc45:                                        ; preds = %for.cond38
  ...
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %5)
  %dec46 = add nsw i32 %4, -1
