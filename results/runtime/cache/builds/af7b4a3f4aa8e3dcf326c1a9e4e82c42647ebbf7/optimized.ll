...
for.inc24:                                        ; preds = %for.body15, %for.cond13
...
for.cond27:                                       ; preds = %for.inc42, %for.end26
  ...
  %.sink = phi i32 [ %0, %for.end26 ], [ %dec43, %for.inc42 ]
...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %.sink1 = phi i32 [ %0, %for.body29 ], [ %dec, %for.inc40 ]
  %cmp31 = icmp sge i32 %.sink1, 1
...
for.body32:                                       ; preds = %for.cond30
  ...
  %idxprom35 = sext i32 %.sink1 to i64
...
for.inc42:                                        ; preds = %for.body32, %for.cond30
  %i2.1 = phi i32 [ %i2.0, %for.cond30 ], [ %.sink, %for.body32 ]
