; ModuleID = '<stdin>'
source_filename = "/tmp/tmpq2gu8jw7.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %b) #9
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %c) #10
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %d) #10
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %c)
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %call3, ptr noundef nonnull align 8 dereferenceable(8) %d)
  %3 = load double, ptr %d, align 8, !tbaa !5
  %4 = load double, ptr %c, align 8, !tbaa !5
  %div5 = fdiv double %3, %4
  %sub6 = fsub double %div, %div5
  %cmp7 = fcmp ole double %sub6, 5.000000e-02
  br i1 %cmp7, label %land.lhs.true, label %if.else

land.lhs.true:                                    ; preds = %for.body
  %sub8 = fsub double %div5, %div
  %cmp9 = fcmp ole double %sub8, 5.000000e-02
  br i1 %cmp9, label %if.then, label %if.else

if.then:                                          ; preds = %land.lhs.true
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str)
  br label %for.inc

if.else:                                          ; preds = %land.lhs.true, %for.body
  %cmp13 = fcmp ogt double %sub6, 5.000000e-02
  br i1 %cmp13, label %if.then14, label %if.else17

if.then14:                                        ; preds = %if.else
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str.1)
  br label %for.inc

if.else17:                                        ; preds = %if.else
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(7) @.str.2)
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else17, %if.then14
  %call18.sink = phi ptr [ %call18, %if.else17 ], [ %call15, %if.then14 ], [ %call10, %if.then ]
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call18.sink, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %d) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %c) #10
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %a) #10
  ret i32 0
}
...
define available_externally noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef nonnull align 8 dereferenceable(8) %__f) local_unnamed_addr #3 align 2 {
entry:
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !17, !invariant.load !16
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !28, !invariant.load !16
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !36, !invariant.load !16
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !42, !invariant.load !16
  br label %return
