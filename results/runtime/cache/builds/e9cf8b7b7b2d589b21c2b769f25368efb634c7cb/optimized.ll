...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %i.1 = phi i32 [ %inc.i1, %for.body4 ], [ 0, %for.cond2.preheader ]
...
for.body4:                                        ; preds = %for.cond2
  %call5 = tail call noundef i32 @_Z1Fi(i32 noundef %i.1) #6
  %spec.select = tail call i32 @llvm.smax.i32(i32 %z.0, i32 %call5)
  %inc.i1 = add nuw i32 %i.1, 1
  br label %for.cond2
...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %z.0 = phi i32 [ %z.1, %if.end ], [ 1, %entry ]
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call = tail call noundef i32 @_Z1Fi(i32 noundef %4) #7
  %cmp5.not = icmp slt i32 %call, %z.0
