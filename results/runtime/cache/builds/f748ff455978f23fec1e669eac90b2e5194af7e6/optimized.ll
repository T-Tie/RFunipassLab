...
for.cond25:                                       ; preds = %for.inc36, %if.end24
  %6 = phi i32 [ 65, %if.end24 ], [ %inc37, %for.inc36 ]
  store i32 %6, ptr @i, align 4, !tbaa !5
  %cmp26 = icmp slt i32 %6, 91
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %6, i32 noundef %7)
  %.pre6 = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc36

for.inc36:                                        ; preds = %for.body27, %if.then31
  %8 = phi i32 [ %6, %for.body27 ], [ %.pre6, %if.then31 ]
  %inc37 = add nsw i32 %8, 1
  br label %for.cond25, !llvm.loop !13

for.cond39:                                       ; preds = %for.cond25, %for.inc50
  %9 = phi i32 [ %inc51, %for.inc50 ], [ 97, %for.cond25 ]
  store i32 %9, ptr @i, align 4, !tbaa !5
  %cmp40 = icmp slt i32 %9, 123
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %9, i32 noundef %10)
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.body41, %if.then45
  %11 = phi i32 [ %9, %for.body41 ], [ %.pre, %if.then45 ]
