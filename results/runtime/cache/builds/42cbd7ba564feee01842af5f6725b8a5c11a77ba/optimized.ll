...
if.then6.i16:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %call16.i26 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i25) #10
  %3 = add i64 %2, -1001
  %or.cond.i30 = icmp ult i64 %3, -1000
  %or.cond49 = select i1 %call16.i26, i1 %or.cond.i30, i1 false
  br i1 %or.cond49, label %if.then19.i31, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit47
...
if.then19.i31:                                    ; preds = %if.then6.i16
  ...
  %call24.i36 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i35) #10
  ...
  %expval.i40 = call i64 @llvm.expect.i64(i64 noundef %conv.i39, i64 noundef 1)
  %tobool.not.i41 = icmp eq i64 %expval.i40, 0
  br i1 %tobool.not.i41, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit47, label %if.then28.i42
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit47: ; preds = %if.then6.i16, %if.then19.i31, %if.then28.i42
...
for.cond.preheader:                               ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit47
...
for.cond50:                                       ; preds = %for.cond, %for.body52
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.body52 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %spec.select, %for.body52 ], [ 0, %for.cond ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %wide.trip.count
  br i1 %exitcond55.not, label %for.end65, label %for.body52

for.body52:                                       ; preds = %for.cond50
  %arrayidx54 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv51
  %6 = load i8, ptr %arrayidx54, align 1, !tbaa !22
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv51
...
if.end75:                                         ; preds = %if.else71, %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit47
  %.str.3.sink.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit47 ], [ @.str.3, %if.else71 ], [ @.str.2, %for.end65 ], [ @.str.1, %for.body ], [ @.str.1, %land.lhs.true ]
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink.sink) #10
