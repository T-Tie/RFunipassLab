...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv29, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv35 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next36, %for.inc56 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond40.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv35, %indvars.iv41
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv35
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %wide.trip.count60
  br i1 %exitcond61.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv56, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc118 ], [ %indvars.iv51, %for.body74 ]
  %10 = icmp slt i64 %indvars.iv53, %sext
  br i1 %10, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv53, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond50.not = icmp eq i64 %indvars.iv47, 6
  br i1 %exitcond50.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv53, i64 %indvars.iv47
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv47
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv56, i64 %indvars.iv47
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc151 ], [ 1, %if.else ]
  %phiofops = phi i64 [ %indvars.iv62, %for.inc151 ], [ 0, %if.else ]
  %exitcond69.not = icmp eq i64 %indvars.iv62, %wide.trip.count68
  br i1 %exitcond69.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv62, i64 4
...
for.body136.for.end153_crit_edge:                 ; preds = %for.body136
  %.pre = and i64 %indvars.iv62, 4294967295
  %.pre101 = and i64 %phiofops, 4294967295
  br label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136.for.end153_crit_edge
  %wide.trip.count82.pre-phi = phi i64 [ %.pre101, %for.body136.for.end153_crit_edge ], [ %wide.trip.count60, %for.cond134 ]
  %.pre-phi = phi i64 [ %.pre, %for.body136.for.end153_crit_edge ], [ %wide.trip.count68, %for.cond134 ]
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %wide.trip.count82.pre-phi
  br i1 %exitcond83.not, label %for.cond207, label %for.body157

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv79, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc201 ], [ %indvars.iv74, %for.body157 ]
  %cmp160 = icmp samesign ult i64 %indvars.iv76, %.pre-phi
  br i1 %cmp160, label %for.body161, label %for.cond154.loopexit

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv76, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond73.not = icmp eq i64 %indvars.iv70, 6
  br i1 %exitcond73.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv76, i64 %indvars.iv70
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv70
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv79, i64 %indvars.iv70
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond91.not = icmp eq i64 %indvars.iv87, %.pre-phi
  br i1 %exitcond91.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv84, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv87, i64 %indvars.iv84
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar21 = call i32 @putchar(i32 %conv218)
