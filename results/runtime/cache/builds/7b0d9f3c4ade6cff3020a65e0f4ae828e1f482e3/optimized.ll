...
for.cond28:                                       ; preds = %for.inc50, %for.end27
  ...
  %4 = phi i32 [ %inc51, %for.inc50 ], [ 0, %for.end27 ]
...
if.end37.thread:                                  ; preds = %for.body30
  ...
  %6 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !13
  %idxprom3825 = sext i32 %4 to i64
  %arrayidx3926 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom3825
  %idxprom4027 = sext i32 %l1.1 to i64
  %arrayidx4128 = getelementptr inbounds [10 x i32], ptr %arrayidx3926, i64 0, i64 %idxprom4027
  %7 = load i32, ptr %arrayidx4128, align 4, !tbaa !5, !invariant.load !13
  %cmp4229 = icmp slt i32 %7, %6
  br i1 %cmp4229, label %for.inc50, label %for.inc50

if.then44:                                        ; preds = %if.end37
  br label %for.inc50

for.inc50:                                        ; preds = %if.end37.thread, %if.end37.thread, %if.end37, %if.then44
  %min.3 = phi i32 [ %5, %if.then44 ], [ %min.1, %if.end37 ], [ %6, %if.end37.thread ], [ %6, %if.end37.thread ]
  %l2.3 = phi i32 [ %4, %if.then44 ], [ %l2.1, %if.end37 ], [ 0, %if.end37.thread ], [ 0, %if.end37.thread ]
  %inc51 = add nsw i32 %4, 1
...
for.end59.thread:                                 ; preds = %for.end52
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %l2.1, i32 noundef %l1.1) #5
  br label %if.end63
