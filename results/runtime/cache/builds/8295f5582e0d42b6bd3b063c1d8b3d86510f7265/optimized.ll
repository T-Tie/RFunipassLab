...
for.body13:                                       ; preds = %for.cond11
  ...
  %2 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !13
  %cmp18 = icmp eq i32 %2, 0
  br i1 %cmp18, label %for.end27, label %for.inc19
...
for.end27:                                        ; preds = %for.body13, %for.cond8
  %y1.0 = phi i32 [ undef, %for.cond8 ], [ %j.1, %for.body13 ]
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc40, %for.end27
  %i.2 = phi i32 [ %y1.0, %for.end27 ], [ %add, %for.inc40 ]
...
for.body30:                                       ; preds = %for.cond28
  ...
  %3 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !13
...
lor.lhs.false:                                    ; preds = %for.body30
  ...
  br i1 %cmp37, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %lor.lhs.false
  br label %for.cond28, !llvm.loop !16

for.end42:                                        ; preds = %for.body30, %lor.lhs.false, %for.cond28
  br label %for.cond43

for.cond43:                                       ; preds = %for.inc57, %for.end42
  %phiofops = phi i1 [ %cmp9, %for.end42 ], [ true, %for.inc57 ]
  %i.3 = phi i32 [ %i.1, %for.end42 ], [ %add46, %for.inc57 ]
...
for.body45:                                       ; preds = %for.cond43
  ...
  %idxprom49 = sext i32 %y1.0 to i64
  %arrayidx50 = getelementptr inbounds [1000 x i32], ptr %arrayidx48, i64 0, i64 %idxprom49
  %4 = load i32, ptr %arrayidx50, align 4, !tbaa !5, !invariant.load !13
