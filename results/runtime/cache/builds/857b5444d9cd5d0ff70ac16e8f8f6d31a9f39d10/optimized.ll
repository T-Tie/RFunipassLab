...
for.end33:                                        ; preds = %for.cond23
  ...
  call void @outlined_ir_func_0(ptr nonnull %add.ptr35)
  br label %for.inc42
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @outlined_ir_func_0(ptr nonnull %add.ptr58)
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !30
...
define internal void @outlined_ir_func_0(ptr nonnull %0) #11 {
newFuncRoot:
