...
for.cond11:                                       ; preds = %for.cond11.loopexit, %for.cond11.preheader
  %l.0.in = phi i32 [ %j.0, %for.cond11.preheader ], [ %l.0, %for.cond11.loopexit ]
  %l.0 = add nsw i32 %l.0.in, -1
  %cmp12 = icmp sgt i32 %l.0.in, 0
  br i1 %cmp12, label %for.cond14.preheader, label %for.cond39.preheader
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc34
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc34 ], [ 0, %for.cond14.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond.not, label %for.cond11.loopexit, label %for.body16
