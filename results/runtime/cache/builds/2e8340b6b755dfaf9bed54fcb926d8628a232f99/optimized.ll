...
if.end17:                                         ; preds = %if.then16, %if.end
  ...
  %call18 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %x1.0, double noundef %x2.0) #9
  br label %if.end42
...
if.end24:                                         ; preds = %if.then23, %if.else
  ...
  %call25 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %x1.1) #9
  br label %if.end42
...
if.end40:                                         ; preds = %if.then39, %if.end37
  ...
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %x1.2, double noundef %x.0, double noundef %x1.2, double noundef %x.0) #9
  br label %if.end42
