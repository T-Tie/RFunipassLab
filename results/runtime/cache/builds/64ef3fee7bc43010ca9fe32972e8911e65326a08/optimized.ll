...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %m2) #7
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %3, i32 1)
...
for.cond7:                                        ; preds = %for.body, %for.inc
  ...
  %exitcond35.not = icmp eq i32 %j.0, %smax34
  br i1 %exitcond35.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %4 = load i32, ptr %m2, align 4, !tbaa !5
  %smax36 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  br label %for.cond30
...
for.inc:                                          ; preds = %for.body9, %for.inc.fold.split, %if.else27
  %.sink3 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %for.inc.fold.split ]
  %add28 = add nuw nsw i32 %.sink3, %n1.0
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %exitcond37.not = icmp eq i32 %j.1, %smax36
  br i1 %exitcond37.not, label %for.end58, label %for.body32
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  %.sink2 = phi i32 [ 30, %if.else52 ], [ 29, %for.body32 ], [ 31, %for.inc56.fold.split ]
  %add53 = add nuw nsw i32 %.sink2, %n2.0
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts31 = call i32 @puts(ptr nonnull dereferenceable(1) %str.3.str.2)
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %j81.0, %smax34
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax32 = call i32 @llvm.smax.i32(i32 %5, i32 1)
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %exitcond33.not = icmp eq i32 %j81.1, %smax32
  br i1 %exitcond33.not, label %for.end140, label %for.body114
...
for.inc138:                                       ; preds = %for.body114, %for.inc138.fold.split, %if.else134
  %.sink = phi i32 [ 30, %if.else134 ], [ 28, %for.body114 ], [ 31, %for.inc138.fold.split ]
  %add135 = add nuw nsw i32 %.sink, %n283.0
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts29 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
  br label %if.end151
...
for.inc164.gvnsink.split:                         ; preds = %if.then153, %if.then70
  %sub154.sink = phi i32 [ %sub154, %if.then153 ], [ %sub71, %if.then70 ]
  %rem155 = urem i32 %sub154.sink, 7
  %cmp156 = icmp eq i32 %rem155, 0
  %spec.select28 = select i1 %cmp156, ptr @.str.2, ptr @.str.3
  %call160 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select28) #7
  br label %for.inc164
