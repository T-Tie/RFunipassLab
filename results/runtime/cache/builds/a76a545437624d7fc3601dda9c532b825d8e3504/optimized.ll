...
for.cond4:                                        ; preds = %if.end25, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %if.end25 ], [ 1, %for.end ]
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.body31
  %indvars.iv27 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next28, %for.body31 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end38, label %for.body31
