...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %16, double noundef %17) #11
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %16) #11
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %16, double noundef %17, double noundef %16, double noundef %18) #11
  br label %for.inc132
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i1 = call i32 @getc(ptr noundef %19) #11
  %20 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i2 = call i32 @getc(ptr noundef %20) #11
