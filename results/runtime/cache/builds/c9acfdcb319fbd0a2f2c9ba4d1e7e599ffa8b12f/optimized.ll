...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv51, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv108 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next109, %for.inc135 ]
  %indvars.iv105 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next106, %for.inc135 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc48
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc48 ], [ 0, %for.cond13 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %indvars.iv108
  br i1 %exitcond66.not, label %for.cond51, label %for.cond19

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.body21 ], [ 0, %for.cond16 ]
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv54
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv57 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next58, %for.inc45 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %indvars.iv108
  br i1 %exitcond61.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv57
...
for.cond51:                                       ; preds = %for.cond16, %for.inc86
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc86 ], [ 0, %for.cond16 ]
  %exitcond81.not = icmp eq i64 %indvars.iv77, %indvars.iv108
  br i1 %exitcond81.not, label %for.end88, label %for.cond54

for.cond54:                                       ; preds = %for.cond51, %for.body56
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.body56 ], [ 0, %for.cond51 ]
  %min.2 = phi i32 [ %spec.select49, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %indvars.iv108
  br i1 %exitcond71.not, label %for.cond71.preheader, label %for.body56

for.cond71.preheader:                             ; preds = %for.cond54
  br label %for.cond71

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv67, i64 %indvars.iv77
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5
  %spec.select49 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  br label %for.cond54, !llvm.loop !16

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv72 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next73, %for.inc83 ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %indvars.iv108
  br i1 %exitcond76.not, label %for.inc86, label %for.inc83

for.inc83:                                        ; preds = %for.cond71
  %arrayidx77 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv77
...
for.cond91:                                       ; preds = %for.cond95, %for.end88
  %indvars.iv87 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next88, %for.cond95 ]
  %exitcond94.not = icmp eq i64 %indvars.iv87, %indvars.iv105
  br i1 %exitcond94.not, label %for.cond113, label %for.cond95.preheader
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv82 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next83, %for.inc107 ]
  %exitcond86.not = icmp eq i64 %indvars.iv82, %indvars.iv108
  br i1 %exitcond86.not, label %for.cond91, label %for.inc107, !llvm.loop !19

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv.next88, i64 %indvars.iv82
  %14 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv87, i64 %indvars.iv82
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  %indvars.iv100 = phi i64 [ 1, %for.cond91 ], [ %indvars.iv.next101, %for.cond116 ]
  %exitcond104.not = icmp eq i64 %indvars.iv100, %indvars.iv108
  br i1 %exitcond104.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv95 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next96, %for.inc129 ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %indvars.iv105
  br i1 %exitcond99.not, label %for.cond113, label %for.inc129, !llvm.loop !21

for.inc129:                                       ; preds = %for.cond116
  %arrayidx124 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv95, i64 %indvars.iv.next101
  %15 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv95, i64 %indvars.iv100
...
for.inc139:                                       ; preds = %for.cond13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call137, i8 noundef signext %call.i34)
