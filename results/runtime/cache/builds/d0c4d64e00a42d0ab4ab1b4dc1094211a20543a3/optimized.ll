...
for.cond2:                                        ; preds = %for.inc19, %for.end
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc19 ], [ 0, %for.end ]
  ...
  %exitcond7 = icmp eq i64 %indvars.iv4, 52
  br i1 %exitcond7, label %for.cond23.preheader, label %for.cond6.preheader

for.cond23.preheader:                             ; preds = %for.cond2
  br label %for.cond23

for.cond6.preheader:                              ; preds = %for.cond2
  %arrayidx14 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv4
  br label %for.cond6
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc38
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc38 ], [ 0, %for.cond23.preheader ]
  ...
  %exitcond11 = icmp eq i64 %indvars.iv8, 52
  br i1 %exitcond11, label %for.end40, label %for.body26

for.body26:                                       ; preds = %for.cond23
  %arrayidx28 = getelementptr inbounds nuw [100 x i32], ptr %u, i64 0, i64 %indvars.iv8
