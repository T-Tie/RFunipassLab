...
if.then39:                                        ; preds = %for.body37
  ...
  %arrayidx41 = getelementptr inbounds [500 x i32], ptr %a, i64 0, i64 %idxprom40
  %4 = load i32, ptr %arrayidx41, align 4, !tbaa !5
  %call42 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %4)
...
if.else:                                          ; preds = %for.body37
  ...
  %arrayidx45 = getelementptr inbounds [500 x i32], ptr %a, i64 0, i64 %idxprom44
