...
entry:
  ...
  %smax14 = tail call i32 @llvm.smax.i32(i32 noundef %x, i32 noundef 0) #6
  %wide.trip.count15 = zext nneg i32 %smax14 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond.cleanup3 ], [ 0, %entry ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.end9, label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [150 x i32], ptr %z, i64 %indvars.iv11, i64 %indvars.iv
...
for.cond3:                                        ; preds = %for.cond, %if.end25
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %if.end25 ], [ 0, %for.cond ]
...
land.lhs.true:                                    ; preds = %if.else
  ...
  br i1 %cmp20, label %if.end25, label %if.else23

if.else23:                                        ; preds = %land.lhs.true, %if.else
  br label %if.end25

if.end25:                                         ; preds = %land.lhs.true, %for.end, %if.else23
  %.str.3.sink = phi ptr [ @.str, %if.else23 ], [ @.str.2, %for.end ], [ @.str.3, %land.lhs.true ]
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink, i32 noundef %z.0) #8
