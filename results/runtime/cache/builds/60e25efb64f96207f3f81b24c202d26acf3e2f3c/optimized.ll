...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv31 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next32, %for.inc14 ]
...
for.cond17.preheader:                             ; preds = %for.cond2
  %vtable.i8 = load ptr, ptr @_ZSt4cout, align 8
  %vbase.offset.ptr.i9 = getelementptr i8, ptr %vtable.i8, i64 -24
  br label %for.cond17

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv31
  store i32 0, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv31
  br label %while.cond
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc47
  %.pre46 = phi i32 [ %0, %for.cond17.preheader ], [ %.pre, %for.inc47 ]
  %indvars.iv35 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next36, %for.inc47 ]
  %s.0 = phi i32 [ 0, %for.cond17.preheader ], [ %add46, %for.inc47 ]
  %7 = sext i32 %.pre46 to i64
  %cmp18 = icmp slt i64 %indvars.iv35, %7
  br i1 %cmp18, label %for.body19, label %for.end49

for.body19:                                       ; preds = %for.cond17
  %cmp20 = icmp sgt i32 %s.0, 0
  %arrayidx22 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv35
...
land.lhs.true:                                    ; preds = %for.body19
  ...
  br i1 %cmp23, label %if.end35.thread43, label %if.then33

if.end35.thread43:                                ; preds = %land.lhs.true
...
if.then33:                                        ; preds = %land.lhs.true, %if.end
  ...
  %vbase.offset.i10 = load i64, ptr %vbase.offset.ptr.i9, align 8, !invariant.load !9
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread43
  %s.128.ph = phi i32 [ %s.0, %if.end35.thread43 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
  %arrayidx26 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv35
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre46, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
  %s.128 = phi i32 [ %s.0, %if.end35 ], [ %s.128.ph, %for.inc47.sink.split ]
  %add45 = add i32 %8, 1
  %add46 = add i32 %add45, %s.128
