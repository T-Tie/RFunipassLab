...
for.cond4:                                        ; preds = %for.cond7, %for.cond4.preheader
  %indvars.iv56 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next57, %for.cond7 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.cond7 ]
  %exitcond65.not = icmp eq i64 %indvars.iv56, %wide.trip.count
  br i1 %exitcond65.not, label %for.cond42, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %indvars.iv.next57 = add nuw nsw i64 %indvars.iv56, 1
  %2 = add nsw i64 %indvars.iv56, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv56
  %3 = trunc nsw i64 %indvars.iv.next57 to i32
  br label %for.cond7
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv58 = phi i64 [ %indvars.iv56, %for.cond10.preheader ], [ %indvars.iv.next59, %for.inc23 ]
  %indvars.iv54 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next55, %for.inc23 ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %for.inc23 ]
  %cmp12 = icmp slt i64 %indvars.iv58, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv58
  %5 = load i8, ptr %arrayidx15, align 1, !tbaa !13
  %arrayidx18 = getelementptr inbounds [1000 x i8], ptr %a, i64 0, i64 %indvars.iv54
...
for.end25:                                        ; preds = %for.body13, %for.cond10
  ...
  %7 = trunc nsw i64 %indvars.iv54 to i32
...
for.inc36:                                        ; preds = %for.end25, %if.then27
  %.sink = phi i32 [ %0, %if.then27 ], [ %w.2, %for.end25 ]
  %sub33 = add i32 %7, 1
  %inc37 = sub i32 %sub33, %.sink
  br label %for.cond7, !llvm.loop !16

for.cond42:                                       ; preds = %for.cond4, %for.body44
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.body44 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond4 ]
  %exitcond69.not = icmp eq i64 %indvars.iv66, 1000
  br i1 %exitcond69.not, label %for.end54, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv66
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc80 ], [ 0, %if.else58 ]
  %exitcond76.not = icmp eq i64 %indvars.iv70, 1000
  br i1 %exitcond76.not, label %if.end83, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv70
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc75
  %indvars.iv72 = phi i64 [ %indvars.iv70, %for.cond67.preheader ], [ %indvars.iv.next73, %for.inc75 ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %12, %11
  %13 = sext i32 %add68 to i64
  %cmp69 = icmp slt i64 %indvars.iv72, %13
  br i1 %cmp69, label %for.inc75, label %for.end77

for.inc75:                                        ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv72
  %14 = load i8, ptr %arrayidx72, align 1, !tbaa !13
  %conv73 = sext i8 %14 to i32
  %putchar52 = call i32 @putchar(i32 noundef %conv73) #10
