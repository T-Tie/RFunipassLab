...
if.then6.i8:                                      ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %call16.i18 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i17) #12
  %3 = add i64 %2, -257
  %or.cond.i22 = icmp ult i64 %3, -256
  %or.cond85 = select i1 %call16.i18, i1 %or.cond.i22, i1 false
  br i1 %or.cond85, label %if.then19.i23, label %if.then6.i47
...
if.then19.i23:                                    ; preds = %if.then6.i8
  ...
  %call24.i28 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i27) #12
...
if.then6.i47:                                     ; preds = %if.then28.i34, %if.then19.i23, %if.then6.i8
  ...
  %call16.i57 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i56) #12
  %5 = add i64 %4, -257
  %or.cond.i61 = icmp ult i64 %5, -256
  %or.cond86 = select i1 %call16.i57, i1 %or.cond.i61, i1 false
  br i1 %or.cond86, label %if.then19.i62, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78
...
if.then19.i62:                                    ; preds = %if.then6.i47
  ...
  %call24.i67 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i66) #12
  ...
  %expval.i71 = call i64 @llvm.expect.i64(i64 %conv.i70, i64 1)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78: ; preds = %if.then6.i47, %if.then19.i62, %if.then28.i73
  ...
  %smax97 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %wide.trip.count98 = zext nneg i32 %smax97 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78
  %indvars.iv108 = phi i32 [ %indvars.iv.next109, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78 ]
  %indvars.iv103 = phi i32 [ %indvars.iv.next104, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78 ]
  %exitcond99.not = icmp eq i64 %indvars.iv, %wide.trip.count98
  br i1 %exitcond99.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc ], [ 1, %for.body ]
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv91, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next90 = add nuw nsw i64 %indvars.iv89, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next90
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !22
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv91
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %10 = trunc nuw nsw i64 %indvars.iv91 to i32
  br label %for.end
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count106 = zext i32 %indvars.iv103 to i64
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv100 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next101, %for.inc43 ]
  %exitcond107.not = icmp eq i64 %indvars.iv100, %wide.trip.count106
  br i1 %exitcond107.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv100
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv108 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv111, %13
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv111
