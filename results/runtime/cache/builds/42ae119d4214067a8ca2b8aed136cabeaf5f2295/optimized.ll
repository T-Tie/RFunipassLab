...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
  br i1 %call16.i16, label %land.lhs.true.i17, label %if.then6.i38

land.lhs.true.i17:                                ; preds = %if.then6.i11
  %_M_width.i4.i18 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i4.i18, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
...
if.then19.i22:                                    ; preds = %land.lhs.true.i17
  %call24.i23 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
if.then6.i38:                                     ; preds = %if.then28.i29, %if.then19.i22, %land.lhs.true.i17, %if.then6.i11
  ...
  %call16.i43 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
land.lhs.true.i44:                                ; preds = %if.then6.i38
  %_M_width.i4.i45 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i4.i45, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
...
if.then19.i49:                                    ; preds = %land.lhs.true.i44
  %call24.i50 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
  ...
  %expval.i54 = call i64 @llvm.expect.i64(i64 %conv.i53, i64 1)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57: ; preds = %if.then6.i38, %land.lhs.true.i44, %if.then19.i49, %if.then28.i56
  ...
  %smax77 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %wide.trip.count78 = zext nneg i32 %smax77 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57
  %indvars.iv87 = phi i32 [ %indvars.iv.next88, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %indvars.iv83 = phi i32 [ %indvars.iv.next84, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc30 ], [ %8, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %exitcond79.not = icmp eq i64 %indvars.iv63, %wide.trip.count78
  br i1 %exitcond79.not, label %if.then34, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv63
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.inc ], [ %indvars.iv63, %for.body ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 1, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv65, %indvars.iv72
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next66
...
for.inc30:                                        ; preds = %for.body, %for.end
  ...
  %indvars.iv.next84 = add nuw i32 %indvars.iv83, 1
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv80 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next81, %for.inc43 ]
  %exitcond86.not = icmp eq i64 %indvars.iv80, %wide.trip.count
  br i1 %exitcond86.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv80
...
for.end45:                                        ; preds = %for.cond37
  ...
  %14 = sext i32 %indvars.iv87 to i64
  %sext = shl i64 %call6, 32
  %15 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.inc54 ], [ %14, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv90, %15
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv90
