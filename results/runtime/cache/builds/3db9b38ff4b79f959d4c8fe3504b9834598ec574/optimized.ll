...
if.then:                                          ; preds = %for.body
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(6) @.str)
  br label %if.end
...
if.then_to_outline:                               ; preds = %newFuncRoot
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
