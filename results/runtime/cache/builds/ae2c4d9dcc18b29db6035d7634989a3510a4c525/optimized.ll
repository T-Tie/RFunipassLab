...
for.cond27:                                       ; preds = %for.inc42, %for.end26
  ...
  %3 = phi i32 [ %dec43, %for.inc42 ], [ %0, %for.end26 ]
  %cmp28 = icmp sge i32 %3, 1
...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %4 = phi i32 [ %dec, %for.inc40 ], [ %0, %for.body29 ]
  %cmp31 = icmp sge i32 %4, 1
...
for.inc42:                                        ; preds = %for.body32, %for.cond30
  %j2.1 = phi i32 [ %j2.0, %for.cond30 ], [ %4, %for.body32 ]
  %i2.1 = phi i32 [ %i2.0, %for.cond30 ], [ %3, %for.body32 ]
  %dec43 = add nsw i32 %3, -1
