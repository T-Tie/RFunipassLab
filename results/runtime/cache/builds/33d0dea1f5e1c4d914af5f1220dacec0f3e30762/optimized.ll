...
while.cond.loopexit:                              ; preds = %for.cond1
  br label %while.cond, !llvm.loop !9

while.cond:                                       ; preds = %while.cond.loopexit, %entry
  %dec19 = phi i32 [ %n.promoted, %entry ], [ %dec, %while.cond.loopexit ]
  %k.0 = phi i32 [ 1, %entry ], [ %k.1, %while.cond.loopexit ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc18
  %indvars.iv21 = phi i64 [ %4, %for.inc18 ], [ 0, %for.cond1.preheader ]
  %k.1 = phi i32 [ %k.2, %for.inc18 ], [ %k.0, %for.cond1.preheader ]
  %2 = sext i32 %k.1 to i64
  %cmp2 = icmp slt i64 %indvars.iv21, %2
  br i1 %cmp2, label %for.body3, label %while.cond.loopexit
