...
for.end15:                                        ; preds = %for.body7, %for.cond5
  %j.0.lcssa.in = phi i64 [ %indvars.iv8, %for.body7 ], [ %indvars.iv11, %for.cond5 ]
  %5 = and i64 %j.0.lcssa.in, 4294967295
  %cmp16 = icmp eq i64 %5, %indvars.iv11
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc36
  %indvars.iv17 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next18, %for.inc36 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond22.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %b, i64 0, i64 %indvars.iv17
  ...
  %cmp32 = icmp slt i64 %indvars.iv17, %2
