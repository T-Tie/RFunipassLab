...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %a1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %a2) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %b1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %b2) #4
...
land.lhs.true:                                    ; preds = %for.body4
  ...
  br i1 %cmp7, label %if.then, label %if.then9

if.then:                                          ; preds = %land.lhs.true
  store i32 %0, ptr %a1, align 4, !tbaa !5
  store i32 %2, ptr %a2, align 4, !tbaa !5
  br label %if.then9

if.then9:                                         ; preds = %if.then, %land.lhs.true
  store i32 %0, ptr %b1, align 4, !tbaa !5
  store i32 %2, ptr %b2, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %if.then9, %for.body4
  %inc = add nsw i32 %2, 1
...
for.end13:                                        ; preds = %for.cond
  %6 = load i32, ptr %b1, align 4, !tbaa !5
  %7 = load i32, ptr %a1, align 4, !tbaa !5
  %sub = sub nsw i32 %6, %7
  %sub14 = sub nsw i32 %sub, 1
  %8 = load i32, ptr %b2, align 4, !tbaa !5
  %9 = load i32, ptr %a2, align 4, !tbaa !5
  %sub15 = sub nsw i32 %8, %9
  %sub16 = sub nsw i32 %sub15, 1
  %mul = mul nsw i32 %sub14, %sub16
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %mul) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %b2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %b1) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %a2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %a1) #5
