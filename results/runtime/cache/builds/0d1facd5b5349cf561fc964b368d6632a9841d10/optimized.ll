...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc50
  %.pre35 = phi i32 [ %0, %for.cond33.preheader ], [ %.pre, %for.inc50 ]
  %indvars.iv32 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next33, %for.inc50 ]
...
for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre35, %for.body36 ]
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !42, !invariant.load !12
...
!28 = !{!29, !33, i64 240}
!29 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !17, i64 0, !30, i64 216, !7, i64 224, !31, i64 225, !32, i64 232, !33, i64 240, !34, i64 248, !35, i64 256}
