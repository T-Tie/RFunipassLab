...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 dereferenceable(80000) %total) #9
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 dereferenceable(80000) %valid) #9
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %t1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %v1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %x) #9
  ...
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %t1)
...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %arrayidx)
  ...
  %3 = load double, ptr %arrayidx5, align 8, !tbaa !5, !invariant.load !11
  %4 = load double, ptr %arrayidx, align 8, !tbaa !5, !invariant.load !11
  %div11 = fdiv double %3, %4
  %arrayidx13 = getelementptr inbounds [10000 x double], ptr %x, i64 0, i64 %idxprom
  store double %div11, ptr %arrayidx13, align 8, !tbaa !5
  %5 = load double, ptr %arrayidx13, align 8, !tbaa !5, !invariant.load !11
  %sub16 = fsub double %div, %5
  %cmp17 = fcmp ogt double %sub16, 5.000000e-02
  br i1 %cmp17, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str)
...
if.end:                                           ; preds = %if.then, %for.body
  %sub22 = fsub double %5, %div
  %cmp23 = fcmp ogt double %sub22, 5.000000e-02
  br i1 %cmp23, label %if.then24, label %if.end27

if.then24:                                        ; preds = %if.end
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(7) @.str.1)
...
if.then45:                                        ; preds = %land.lhs.true40, %land.lhs.true
  %call46 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str.2)
...
for.inc:                                          ; preds = %lor.lhs.false, %land.lhs.true40, %if.then45
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !12

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #10
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %x) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %v1) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %t1) #10
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %valid) #10
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %total) #10
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !15, !invariant.load !11
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !15, !invariant.load !11
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !11
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !17, !invariant.load !11
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !28, !invariant.load !11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !36, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !42, !invariant.load !11
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !15, !invariant.load !11
