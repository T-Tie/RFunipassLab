...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %n.addr.sink = phi ptr [ %n.addr, %for.end ], [ %i, %for.inc13 ]
  %0 = load i32, ptr %n.addr.sink, align 4, !tbaa !5
  %add = add nsw i32 %0, 1
...
if.then10:                                        ; preds = %for.body4
  %call = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %add, i32 noundef %m) #9
...
for.cond20:                                       ; preds = %for.inc30, %for.end15
  %t.0 = phi i32 [ %3, %for.end15 ], [ %t.1, %for.inc30 ]
  %n.addr.sink1 = phi ptr [ %n.addr, %for.end15 ], [ %i, %for.inc30 ]
  %4 = load i32, ptr %n.addr.sink1, align 4, !tbaa !5
  %add19 = add nsw i32 %4, 1
  store i32 %add19, ptr %i, align 4, !tbaa !5
...
for.inc30:                                        ; preds = %for.body22, %if.then26
  %t.1 = phi i32 [ %5, %if.then26 ], [ %t.0, %for.body22 ]
