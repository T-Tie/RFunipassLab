...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #7
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #8
...
if.end.thread:                                    ; preds = %while.body
  %cmp841 = icmp slt i32 %add, 80
  br i1 %cmp841, label %if.else14, label %if.then25
...
if.else14:                                        ; preds = %if.end.thread
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #8
  br label %if.end19

if.end19:                                         ; preds = %if.end, %if.else14
  %call4.sink = phi i64 [ %call.i.i10, %if.else14 ], [ %call4, %if.end ]
  %sum.142 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %a, i64 noundef %call4.sink)
  %cmp20 = icmp eq i32 %sum.142, 80
  br i1 %cmp20, label %if.then21, label %if.end29

if.then21:                                        ; preds = %if.end19
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i32)
  br label %if.end29

if.then25:                                        ; preds = %if.end, %if.end.thread
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i32)
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #8
  %call1.i19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %a, i64 noundef %call.i.i18)
  br label %if.end29

if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  %i.2 = phi i32 [ 1, %if.then25 ], [ %inc, %if.end19 ], [ 0, %if.then21 ]
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.142, %if.end19 ], [ 0, %if.then21 ]
  %5 = load i32, ptr %n, align 4, !tbaa !31
  %dec = add nsw i32 %5, -1
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #8
  ret i32 0
}
...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #6 {
if.then21_after_outline.exitStub:
  %vbase.offset.i26 = load i64, ptr %0, align 8, !invariant.load !8
  %add.ptr.i27 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i26
  %call.i28 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i27, i8 noundef signext 10)
  %call1.i29 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i28)
  %call.i.i30 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i29)
  ret void
}
