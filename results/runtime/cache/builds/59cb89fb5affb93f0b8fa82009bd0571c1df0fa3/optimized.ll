...
while.cond.i.i:                                   ; preds = %while.body.i.i, %for.body.i
  %__next.0.i.i = phi ptr [ %__i.0.i, %for.body.i ], [ %incdec.ptr.i.i, %while.body.i.i ]
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %cmp.i3 = icmp sgt i64 %__holeIndex.addr.0.i, %__holeIndex
  br i1 %cmp.i3, label %land.end.i, label %_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit
...
entry:
  ...
  store ptr %__b, ptr %__b.addr, align 8, !tbaa !22
  store ptr %__c, ptr %__c.addr, align 8, !tbaa !22
...
if.else:                                          ; preds = %if.then
  ...
  %spec.select = select i1 %cmp.i7, ptr %__c.addr, ptr %__a.addr
  br label %if.end16
...
if.else10:                                        ; preds = %if.else7
  ...
  %spec.select10 = select i1 %cmp.i9, ptr %__c.addr, ptr %__b.addr
  br label %if.end16

if.end16:                                         ; preds = %if.else10, %if.else, %if.else7, %if.then
  %__b.addr.sink.sink.sink = phi ptr [ %__b.addr, %if.then ], [ %__a.addr, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select10, %if.else10 ]
  %3 = load ptr, ptr %__b.addr.sink.sink.sink, align 8, !tbaa !22
  %4 = load i32, ptr %__result, align 4, !tbaa !5, !invariant.load !12
  %5 = load i32, ptr %3, align 4, !tbaa !5, !invariant.load !12
...
while.cond1:                                      ; preds = %while.cond1, %while.body
  ...
  br i1 %cmp.i, label %while.cond1, label %while.cond4.preheader, !llvm.loop !25
...
while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  ...
  br i1 %cmp.i1, label %while.cond4, label %while.end8, !llvm.loop !26
