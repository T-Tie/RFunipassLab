...
land.lhs.true.i16:                                ; preds = %if.then6.i10
  ...
  %2 = load i64, ptr %_M_width.i4.i17, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
...
if.then19.i21:                                    ; preds = %land.lhs.true.i16
  %call24.i22 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
if.then6.i37:                                     ; preds = %if.then28.i28, %if.then19.i21, %land.lhs.true.i16, %if.then6.i10
  ...
  %call16.i42 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
land.lhs.true.i43:                                ; preds = %if.then6.i37
  %_M_width.i4.i44 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %4 = load i64, ptr %_M_width.i4.i44, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
...
if.then19.i48:                                    ; preds = %land.lhs.true.i43
  %call24.i49 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then6.i37, %land.lhs.true.i43, %if.then19.i48, %if.then28.i55
  ...
  %smax70 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
  %indvars.iv81 = phi i32 [ %indvars.iv.next82, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %indvars.iv76 = phi i32 [ %indvars.iv.next77, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %exitcond72.not = icmp eq i64 %indvars.iv, %wide.trip.count71
  br i1 %exitcond72.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc ], [ 1, %for.body ]
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv64, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next63
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !22, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv64
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %10 = trunc nuw nsw i64 %indvars.iv64 to i32
  br label %for.end
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count79 = zext i32 %indvars.iv76 to i64
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv73 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next74, %for.inc43 ]
  %exitcond80.not = icmp eq i64 %indvars.iv73, %wide.trip.count79
  br i1 %exitcond80.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv73
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv81 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv84, %13
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv84
