...
entry:
  %0 = add i32 %i, 1
  %smax = call i32 @llvm.smax.i32(i32 noundef %i, i32 noundef -1)
  %1 = add i32 %smax, 1
...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond8 = icmp eq i64 %indvars.iv, %wide.trip.count7
  br i1 %exitcond8, label %for.end20, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv3 = phi i64 [ %indvars.iv, %for.cond1.preheader ], [ %indvars.iv.next4, %for.body3 ]
  %m.0 = phi i32 [ %2, %for.cond1.preheader ], [ %spec.select, %for.body3 ]
  %exitcond = icmp eq i64 %indvars.iv3, %wide.trip.count
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv3
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %while.cond ], [ 0, %for.cond ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %while.cond ], [ 0, %for.cond ]
  %phiofops = phi i64 [ %indvars.iv11, %while.cond ], [ -1, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv11
...
while.end:                                        ; preds = %while.cond
  %0 = trunc nuw nsw i64 %indvars.iv11 to i32
...
for.cond8:                                        ; preds = %for.inc29, %while.end
  %1 = phi i32 [ %dec, %for.inc29 ], [ %sub7, %while.end ]
  %2 = zext i32 %1 to i64
...
while.cond11.preheader:                           ; preds = %for.cond8
  %arrayidx15 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %2
  br label %while.cond11

while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv14 = phi i64 [ %2, %while.cond11.preheader ], [ %indvars.iv.next15, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %3 = trunc nuw i64 %indvars.iv.next15 to i32
  %cmp12 = icmp slt i32 %3, %0
  br i1 %cmp12, label %while.body13, label %for.inc29

while.body13:                                     ; preds = %while.cond11
  %4 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next15
  %5 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %cmp18.not = icmp slt i32 %4, %5
  br i1 %cmp18.not, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next15
  %6 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %spec.select = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.0)
  br label %if.end
...
for.inc29:                                        ; preds = %while.cond11
  ...
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %2
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv17 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next18, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select9, %for.body33 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond22.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv17
  %7 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select9 = tail call i32 @llvm.smax.i32(i32 %7, i32 %n.2)
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  br label %for.cond31, !llvm.loop !17

for.end43:                                        ; preds = %for.cond31
  %call44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %n.2) #5
  ret i32 0
}
