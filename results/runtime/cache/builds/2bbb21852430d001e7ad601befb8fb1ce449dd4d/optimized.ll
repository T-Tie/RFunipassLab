...
for.cond3:                                        ; preds = %for.cond, %for.inc40
  ...
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc40 ], [ 0, %for.cond ]
  %sum.0 = phi i64 [ %sum.1, %for.inc40 ], [ 0, %for.cond ]
  %sub = add nsw i32 %2, -1
  %3 = sext i32 %sub to i64
  %cmp4 = icmp slt i64 %indvars.iv13, %3
  br i1 %cmp4, label %for.body5, label %for.end42

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv13
  ...
  %sext11 = shl i64 %add10, 32
  %conv12 = ashr exact i64 %sext11, 32
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %arrayidx15 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv.next14
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull %arrayidx45)
