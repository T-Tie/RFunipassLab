...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %temp) #7
...
while.end:                                        ; preds = %while.cond
  call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %i)
  call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %j)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %temp) #8
...
define internal void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %0) #6 {
newFuncRoot:
