...
for.end10:                                        ; preds = %for.cond2
  ...
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
...
for.cond:                                         ; preds = %for.inc, %entry
  %x.sink = phi i32 [ %x, %entry ], [ %0, %for.inc ]
...
land.lhs.true:                                    ; preds = %for.body
  %call = call noundef i32 @_Z1Fi(i32 noundef %0) #6
  %add4 = add nsw i32 %call, 1
  %4 = load i32, ptr %z, align 4, !tbaa !5
  %cmp5 = icmp sgt i32 %add4, %4
  br i1 %cmp5, label %if.then, label %for.inc

if.then:                                          ; preds = %land.lhs.true
  %call6 = call noundef i32 @_Z1Fi(i32 noundef %0) #6
