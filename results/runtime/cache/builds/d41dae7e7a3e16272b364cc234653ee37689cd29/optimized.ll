...
for.cond4:                                        ; preds = %for.cond7, %for.cond4.preheader
  %indvars.iv11 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next12, %for.cond7 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.cond7 ]
  %exitcond22.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond22.not, label %for.cond42, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %2 = add nsw i64 %indvars.iv11, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv11
  %3 = trunc nsw i64 %indvars.iv.next12 to i32
  br label %for.cond7
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv15 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next16, %for.inc23 ]
  %indvars.iv13 = phi i64 [ %indvars.iv11, %for.cond10.preheader ], [ %indvars.iv.next14, %for.inc23 ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %for.inc23 ]
  %cmp12 = icmp slt i64 %indvars.iv13, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv13
  %5 = load i8, ptr %arrayidx15, align 1, !tbaa !13
  %arrayidx18 = getelementptr inbounds [1000 x i8], ptr %a, i64 0, i64 %indvars.iv15
...
for.end25:                                        ; preds = %for.body13, %for.cond10
  ...
  %7 = trunc nsw i64 %indvars.iv15 to i32
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %putchar9 = call i32 @putchar(i32 %conv73)
