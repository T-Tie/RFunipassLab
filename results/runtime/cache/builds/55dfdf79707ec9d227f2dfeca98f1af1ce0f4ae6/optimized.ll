...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %b) #6
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %c) #6
  br label %for.cond
...
if.then32:                                        ; preds = %if.else
  ...
  %fneg47 = fneg double %4
  %sub = fsub double %fneg47, %call38
...
for.end108:                                       ; preds = %for.cond6
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %c) #6
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %a) #6
