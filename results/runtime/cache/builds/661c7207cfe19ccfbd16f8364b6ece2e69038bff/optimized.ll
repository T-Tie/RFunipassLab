...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre32 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre32, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
  %f.221 = phi i32 [ %f.1, %for.body3.for.inc_crit_edge ], [ %f.2.ph, %land.lhs.true ]
  %star2.219 = phi i32 [ %star2.1, %for.body3.for.inc_crit_edge ], [ %star2.2.ph, %land.lhs.true ]
  %star1.217 = phi i32 [ %star1.1, %for.body3.for.inc_crit_edge ], [ %star1.2.ph, %land.lhs.true ]
