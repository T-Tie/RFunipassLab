...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20500, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 2000, ptr %b) #9
  br label %for.cond
...
for.inc:                                          ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %add.ptr)
...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef %add.ptr8) #10
...
for.end33:                                        ; preds = %for.cond23
  ...
  %4 = load i32, ptr %add.ptr20, align 4, !tbaa !5
  br label %for.inc42

for.inc42:                                        ; preds = %for.body18, %for.end33
  %k.1 = phi i32 [ %i.2, %for.end33 ], [ %k.0, %for.body18 ]
  %sum.1 = phi i32 [ %4, %for.end33 ], [ %add21, %for.body18 ]
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 2000, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 20500, ptr %a) #9
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  call void @llvm.lifetime.start.p0(i64 4, ptr %__c) #9
