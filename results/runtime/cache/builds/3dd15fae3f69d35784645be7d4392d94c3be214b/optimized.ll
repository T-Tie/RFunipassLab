...
for.cond:                                         ; preds = %for.inc23, %entry
  ...
  %exitcond12.not = icmp eq i32 %j.0, 28
  br i1 %exitcond12.not, label %for.end25, label %for.cond3
...
if.end22:                                         ; preds = %for.end
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef 0, i32 noundef %count.1)
  br label %for.inc23
