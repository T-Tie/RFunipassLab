...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond72.not, label %if.end178.loopexit89, label %for.inc148
...
if.end178.loopexit89:                             ; preds = %for.cond137
  %.pre90 = add nuw nsw i64 %indvars.iv79, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit89
  %.pre.pre-phi = phi i64 [ %.pre90, %if.end178.loopexit89 ], [ %20, %for.cond158 ]
