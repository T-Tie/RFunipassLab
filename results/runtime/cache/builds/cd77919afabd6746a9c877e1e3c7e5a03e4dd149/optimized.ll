...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 101, ptr noundef nonnull align 16 captures(none) dereferenceable(101) %a) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 15000, ptr noundef nonnull %b) #8
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx13)
  %1 = zext i32 %sum.0 to i64
  br label %for.cond16

for.cond16:                                       ; preds = %for.inc24, %for.end
  %indvars.iv20 = phi i64 [ %3, %for.inc24 ], [ %1, %for.end ]
  %2 = trunc nuw i64 %indvars.iv20 to i32
...
for.inc24:                                        ; preds = %for.cond16
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx21)
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 15000, ptr noundef nonnull %b) #8
  call void @llvm.lifetime.end.p0(i64 noundef 101, ptr noundef nonnull captures(none) %a) #8
  ret i32 0
}
...
for.end_after_outline.exitStub:
...
!14 = !{}
!15 = !{!16, !6, i64 56}
!16 = !{!"_ZTSSt5ctypeIcE", !17, i64 0, !19, i64 16, !21, i64 24, !22, i64 32, !22, i64 40, !23, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
