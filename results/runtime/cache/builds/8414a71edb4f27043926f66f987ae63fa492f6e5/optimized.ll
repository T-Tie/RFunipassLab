...
for.inc68:                                        ; preds = %for.cond47
  ...
  %6 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !9
  %mul62 = mul nsw i32 %5, %6
  %add63 = add nsw i32 %3, %mul62
...
for.cond80:                                       ; preds = %for.inc95, %for.body79
  ...
  %cmp81 = icmp slt i32 %j.3, %8
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %i.3, %8
  %add84 = add nsw i32 %mul83, %j.3
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %9 = load i32, ptr %arrayidx86, align 4, !tbaa !5
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %9) #8
...
for.end100:                                       ; preds = %for.cond77
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %y2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %y1) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %x2) #8
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %x1) #8
  ret i32 0
}
...
attributes #9 = { nofree nounwind willreturn allocsize(0) }
