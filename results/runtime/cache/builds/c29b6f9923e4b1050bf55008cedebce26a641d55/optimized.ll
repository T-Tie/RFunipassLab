...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 dereferenceable(80000) %total) #4
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 dereferenceable(80000) %valid) #4
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %t1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %v1) #4
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %v1) #5
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %t1) #5
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %valid) #5
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %total) #5
  ret i32 0
}
