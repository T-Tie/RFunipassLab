...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax16 = call i32 @llvm.smax.i32(i32 %11, i32 noundef 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv19, %14
  %17 = mul nsw i64 %indvars.iv19, %15
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv12
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv12
  br label %for.cond47
...
for.inc68:                                        ; preds = %for.cond47
  ...
  %20 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !15
  %21 = mul nsw i64 %indvars.iv, %14
  %gep = getelementptr i32, ptr %invariant.gep, i64 %21
  %22 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !15
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  %23 = phi i32 [ %25, %for.inc98 ], [ %11, %for.cond37 ]
  %24 = phi i32 [ %.pre, %for.inc98 ], [ %10, %for.cond37 ]
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %25 = phi i32 [ %.pre27, %for.inc95 ], [ %23, %for.cond77 ]
...
for.body82:                                       ; preds = %for.cond80
  ...
  %26 = load i32, ptr %arrayidx86, align 4, !tbaa !5
...
if.then:                                          ; preds = %for.body82
  %putchar = call i32 @putchar(i32 noundef 32) #8
