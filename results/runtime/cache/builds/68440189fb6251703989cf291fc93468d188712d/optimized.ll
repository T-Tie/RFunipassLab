...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count18 = zext nneg i32 %smax17 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv8
...
if.then9:                                         ; preds = %if.end
  ...
  %invariant.op3.reass = sub i32 %invariant.op, %conv
  %6 = sext i32 %sub19 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv5, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, 1
  %7 = trunc nsw i64 %indvars.iv5 to i32
  %sub25.reass = add i32 %invariant.op3.reass, %7
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv5
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv12 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next13, %for.inc44 ]
  %exitcond19.not = icmp eq i64 %indvars.iv12, %wide.trip.count18
  br i1 %exitcond19.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv12, %2
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv12
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  br label %for.cond35, !llvm.loop !12

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv20
