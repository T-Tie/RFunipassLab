...
for.cond2:                                        ; preds = %for.inc11, %for.body
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc11 ], [ 1, %for.body ]
  %exitcond9 = icmp eq i64 %indvars.iv5, %1
  br i1 %exitcond9, label %for.cond14.preheader, label %for.cond5.preheader

for.cond14.preheader:                             ; preds = %for.cond2
  %4 = add i32 %0, 2
  %wide.trip.count48 = zext i32 %4 to i64
  br label %for.cond14

for.cond5.preheader:                              ; preds = %for.cond2
  %5 = mul nuw nsw i64 %indvars.iv5, %1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  %indvars.iv42 = phi i64 [ 3, %for.cond14.preheader ], [ %indvars.iv.next43, %for.cond14.loopexit ]
  %indvars.iv10 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next11, %for.cond14.loopexit ]
  ...
  br i1 %exitcond49.not, label %for.inc138, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.inc50
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc50 ], [ %indvars.iv10, %for.cond14 ]
  %exitcond26 = icmp eq i64 %indvars.iv22, %1
  br i1 %exitcond26, label %for.cond53.preheader, label %for.body19

for.cond53.preheader:                             ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv10, %1
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  br label %for.cond53

for.body19:                                       ; preds = %for.cond17
  %7 = mul nuw nsw i64 %indvars.iv22, %1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla, i64 %7
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv10
  %8 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond24

for.cond24:                                       ; preds = %for.body26, %for.body19
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body26 ], [ %indvars.iv10, %for.body19 ]
  %min.0 = phi i32 [ %spec.select, %for.body26 ], [ %8, %for.body19 ]
  %exitcond16 = icmp eq i64 %indvars.iv12, %1
  br i1 %exitcond16, label %for.cond39.preheader, label %for.body26

for.cond39.preheader:                             ; preds = %for.cond24
  br label %for.cond39

for.body26:                                       ; preds = %for.cond24
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv12
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv17 = phi i64 [ %indvars.iv10, %for.cond39.preheader ], [ %indvars.iv.next18, %for.inc47 ]
  %exitcond21 = icmp eq i64 %indvars.iv17, %1
  br i1 %exitcond21, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv17
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc88
  %indvars.iv37 = phi i64 [ %indvars.iv10, %for.cond53.preheader ], [ %indvars.iv.next38, %for.inc88 ]
  %exitcond41 = icmp eq i64 %indvars.iv37, %1
  br i1 %exitcond41, label %for.end90, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv37
  %11 = load i32, ptr %arrayidx59, align 4, !tbaa !5, !invariant.load !14
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv37
  br label %for.cond60

for.cond60:                                       ; preds = %for.body62, %for.body55
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body62 ], [ %indvars.iv10, %for.body55 ]
  %min.2 = phi i32 [ %spec.select1, %for.body62 ], [ %11, %for.body55 ]
  %exitcond31 = icmp eq i64 %indvars.iv27, %1
  br i1 %exitcond31, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %12 = mul nuw nsw i64 %indvars.iv27, %1
...
for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv32 = phi i64 [ %indvars.iv10, %for.cond77.preheader ], [ %indvars.iv.next33, %for.inc85 ]
  %exitcond36 = icmp eq i64 %indvars.iv32, %1
  br i1 %exitcond36, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %14 = mul nuw nsw i64 %indvars.iv32, %1
  %gep3 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %14
  %15 = load i32, ptr %gep3, align 4, !tbaa !5, !invariant.load !14
  %sub84 = sub nsw i32 %15, %min.2
  store i32 %sub84, ptr %gep3, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %16 = mul nuw nsw i64 %indvars.iv.next11, %1
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla, i64 %16
  %arrayidx96 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv.next11
  %17 = load i32, ptr %arrayidx96, align 4, !tbaa !5, !invariant.load !14
  %arrayidx101 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv10
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc130 ], [ %indvars.iv42, %for.end90 ]
  %19 = trunc nuw i64 %indvars.iv44 to i32
  %cmp110.not = icmp slt i32 %0, %19
  br i1 %cmp110.not, label %for.cond14.loopexit, label %for.inc130

for.inc130:                                       ; preds = %for.cond109
  %arrayidx115 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv44
  %20 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !14
  %arrayidx120 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv44
  store i32 %20, ptr %arrayidx120, align 4, !tbaa !5
  %21 = mul nuw nsw i64 %indvars.iv44, %1
  %arrayidx122 = getelementptr inbounds nuw i32, ptr %vla, i64 %21
  %arrayidx124 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv10
  %22 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !14
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv.next11
