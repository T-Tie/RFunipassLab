...
for.cond:                                         ; preds = %if.end35, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end35 ]
  %2 = load i32, ptr %n, align 4, !tbaa !5
  %cmp.not.not = icmp slt i32 %i.0, %2
  br i1 %cmp.not.not, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %x) #6
...
if.then12:                                        ; preds = %if.then
  %call13 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2) #6
  br label %if.end35
...
if.then16:                                        ; preds = %if.else
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3) #6
  br label %if.end35

if.else18:                                        ; preds = %if.else
  %call19 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4) #6
  br label %if.end35
...
if.then24:                                        ; preds = %if.else21
  %puts9 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #6
  br label %if.end35
...
if.then29:                                        ; preds = %if.else26
  %puts8 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #6
  br label %if.end35
...
if.end35:                                         ; preds = %if.then24, %if.else31, %if.then29, %if.then12, %if.else18, %if.then16
