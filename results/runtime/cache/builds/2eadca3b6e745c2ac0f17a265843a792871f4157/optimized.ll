...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv63 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next64, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count67
  br i1 %exitcond68.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv20
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp3415 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp3415, i32 %min.0, i32 %8
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond22, !llvm.loop !13

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv24 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next25, %for.inc57 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond29.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv24
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count34
  br i1 %exitcond52.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv48
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv36, i64 %indvars.iv48
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp8214 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp8214, i32 %min.2, i32 %12
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond69, !llvm.loop !16

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  %indvars.iv42 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next43, %for.inc107 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count40
  br i1 %exitcond47.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %indvars.iv48
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv63
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !19
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count34
  br i1 %exitcond57.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv53, i64 %indvars.iv63
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count34
  br i1 %exitcond62.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv58
