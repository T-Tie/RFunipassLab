...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 dereferenceable(100000) %a) #10
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull %add.ptr)
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef %a) #11
  ret i32 0
}
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !9, !invariant.load !12
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !9, !invariant.load !12
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !9, !invariant.load !12
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !12
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) #11
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !19, !invariant.load !12
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !29, !invariant.load !12
  ret ptr %0
}
...
if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !9, !invariant.load !12
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !13, !invariant.load !12
  %1 = load i32, ptr %__c2, align 4, !tbaa !13, !invariant.load !12
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !37, !invariant.load !12
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !38, !invariant.load !12
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !41, !invariant.load !12
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !42, !invariant.load !12
