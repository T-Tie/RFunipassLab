...
for.end32:
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %1, i32 0)
  %7 = sext i32 %4 to i64
  %smax28 = call i32 @llvm.smax.i32(i32 %0, i32 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc74 ], [ 0, %for.end32 ]
  %exitcond30.not = icmp eq i64 %indvars.iv23, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %8 = mul nsw i64 %indvars.iv23, %6
  %9 = mul nsw i64 %indvars.iv23, %7
  %invariant.gep35 = getelementptr i32, ptr %call36, i64 %8
  %10 = getelementptr i32, ptr %3, i64 %9
  br label %for.cond40

for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv16 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next17, %for.inc71 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %for.inc74, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %gep36 = getelementptr i32, ptr %invariant.gep35, i64 %indvars.iv16
  store i32 0, ptr %gep36, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %5, i64 %indvars.iv16
  br label %for.cond47
...
for.inc68:                                        ; preds = %for.cond47
  ...
  store i32 %add63, ptr %gep36, align 4, !tbaa !5
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  ...
  %storemerge5 = phi i32 [ %inc99, %for.inc98 ], [ 0, %for.cond37 ]
  %cmp78 = icmp slt i32 %storemerge5, %16
  br i1 %cmp78, label %for.cond80, label %for.end100

for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %17 = phi i32 [ %.pre31, %for.inc95 ], [ %15, %for.cond77 ]
  %storemerge6 = phi i32 [ %inc96, %for.inc95 ], [ 0, %for.cond77 ]
  %cmp81 = icmp slt i32 %storemerge6, %17
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %17, %storemerge5
  %add84 = add nsw i32 %mul83, %storemerge6
  ...
  %cmp88 = icmp slt i32 %storemerge6, %sub
  br i1 %cmp88, label %if.then, label %if.end

if.then:                                          ; preds = %for.body82
  %putchar = call i32 @putchar(i32 32)
  %.pre32 = load i32, ptr %y2, align 4, !tbaa !5
  %.pre34 = add nsw i32 %.pre32, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre34, %if.then ], [ %sub, %for.body82 ]
  %20 = phi i32 [ %.pre32, %if.then ], [ %19, %for.body82 ]
  %cmp91 = icmp eq i32 %storemerge6, %sub90.pre-phi
  br i1 %cmp91, label %if.then92, label %for.inc95

if.then92:                                        ; preds = %if.end
  %putchar7 = call i32 @putchar(i32 10)
  %.pre31.pre = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.inc95

for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre31 = phi i32 [ %20, %if.end ], [ %.pre31.pre, %if.then92 ]
  %inc96 = add nuw nsw i32 %storemerge6, 1
  br label %for.cond80, !llvm.loop !15

for.inc98:                                        ; preds = %for.cond80
  %inc99 = add nuw nsw i32 %storemerge5, 1
...
for.cond3:                                        ; preds = %for.cond, %for.inc
  %9 = phi i32 [ %.pre3, %for.inc ], [ %7, %for.cond ]
  %storemerge2 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond ]
  store i32 %storemerge2, ptr %4, align 4, !tbaa !5
  %cmp4 = icmp slt i32 %storemerge2, %9
