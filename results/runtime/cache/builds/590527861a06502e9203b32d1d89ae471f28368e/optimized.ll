...
entry:
  ...
  %smax61 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef -1)
  %1 = add i32 %smax61, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond63, label %for.cond15, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv58
  %arrayidx = getelementptr inbounds nuw [501 x i8], ptr %s, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond73 = icmp eq i64 %indvars.iv69, %wide.trip.count62
  br i1 %exitcond73, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv69
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv69
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc39 ], [ %indvars.iv64, %for.body19 ]
  %4 = trunc nuw i64 %indvars.iv66 to i32
  %cmp24.not = icmp slt i32 %sub, %4
  br i1 %cmp24.not, label %for.cond15.loopexit, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv66
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond78 = icmp eq i64 %indvars.iv74, %wide.trip.count62
  br i1 %exitcond78, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv74
...
if.then57:                                        ; preds = %for.body53
  ...
  %8 = trunc nuw nsw i64 %indvars.iv74 to i32
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  ...
  %smax82 = call i32 @llvm.smax.i32(i32 %z.0, i32 noundef 0)
  %wide.trip.count83 = zext nneg i32 %smax82 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count83
  br i1 %exitcond84.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv79
