...
for.cond14.preheader:                             ; preds = %for.cond11
  %smax29 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc121
  %indvars.iv48 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next49, %for.inc121 ]
  %exitcond56.not = icmp eq i64 %indvars.iv48, %wide.trip.count55
  br i1 %exitcond56.not, label %for.end123, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv48, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc118
  %indvars.iv50 = phi i64 [ %indvars.iv48, %for.cond76.preheader ], [ %indvars.iv.next51, %for.inc118 ]
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %10 = trunc nuw i64 %indvars.iv.next51 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.inc121

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next51, i64 4
...
for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next51, i64 %indvars.iv44
  ...
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv48, i64 %indvars.iv44
...
if.else:                                          ; preds = %for.end123
  ...
  %smax61 = call i32 @llvm.smax.i32(i32 %l.0, i32 1)
  %wide.trip.count65 = zext nneg i32 %smax61 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc151 ], [ 1, %if.else ]
  %exitcond66.not = icmp eq i64 %indvars.iv57, %wide.trip.count65
  br i1 %exitcond66.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv57, i64 4
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars64.le = trunc i64 %indvars.iv57 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.0.lcssa = phi i32 [ %indvars64.le, %for.end153.split.loop.exit ], [ %smax61, %for.cond134 ]
  %sub155 = add nsw i32 %z.0.lcssa, -1
  %wide.trip.count79 = zext i32 %sub155 to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond80.not = icmp eq i64 %indvars.iv71, %wide.trip.count79
  br i1 %exitcond80.not, label %for.cond207.preheader, label %for.cond159.preheader

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count87 = zext i32 %z.0.lcssa to i64
  br label %for.cond207

for.cond159.preheader:                            ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv71, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  %indvars.iv73 = phi i64 [ %indvars.iv71, %for.cond159.preheader ], [ %indvars.iv.next74, %for.inc201 ]
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count79
  br i1 %exitcond77.not, label %for.inc204, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next74, i64 5
...
for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next74, i64 %indvars.iv67
  ...
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv71, i64 %indvars.iv67
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv84 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next85, %for.inc223 ]
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  ...
  %cmp212 = icmp slt i64 %indvars.iv81, %26
...
for.inc220:                                       ; preds = %for.cond211
  ...
  %putchar18 = call i32 @putchar(i32 %conv218)
