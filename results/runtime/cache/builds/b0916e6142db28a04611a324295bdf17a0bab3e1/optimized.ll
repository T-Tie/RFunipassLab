...
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %m1, i32 noundef 1) #10
  br label %for.cond
...
for.cond13.preheader:                             ; preds = %for.cond
  %smax27 = tail call i32 @llvm.smax.i32(i32 noundef %m2, i32 noundef 1) #10
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc37
  ...
  %exitcond28.not = icmp eq i32 %j.0, %smax27
  br i1 %exitcond28.not, label %for.end39, label %for.body15
...
define dso_local noundef range(i32 0, 2) i32 @_Z7runniani(i32 noundef %y) #4 {
entry:
  %0 = and i32 %y, 3
  %cmp = icmp eq i32 %0, 0
  %rem1 = srem i32 %y, 100
