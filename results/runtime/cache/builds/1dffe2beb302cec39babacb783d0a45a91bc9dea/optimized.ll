...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %y) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %m1) #6
...
if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n2) #6
...
for.cond7:                                        ; preds = %for.inc, %if.then
  %.sink5 = phi i32 [ 1, %if.then ], [ %inc, %for.inc ]
  %n1.0 = phi i32 [ 0, %if.then ], [ %add28, %for.inc ]
  store i32 %.sink5, ptr %j, align 4, !tbaa !5
  %2 = load i32, ptr %m1, align 4, !tbaa !5
  %cmp8 = icmp slt i32 %.sink5, %2
  br i1 %cmp8, label %for.body9, label %if.end79

for.body9:                                        ; preds = %for.cond7
  %cmp10 = icmp eq i32 %.sink5, 2
  br i1 %cmp10, label %for.inc, label %if.else

if.else:                                          ; preds = %for.body9
  %cmp12 = icmp eq i32 %.sink5, 1
  br i1 %cmp12, label %for.inc, label %lor.lhs.false13

lor.lhs.false13:                                  ; preds = %if.else
  %cmp14 = icmp eq i32 %.sink5, 3
  br i1 %cmp14, label %for.inc, label %lor.lhs.false15

lor.lhs.false15:                                  ; preds = %lor.lhs.false13
  %cmp16 = icmp eq i32 %.sink5, 5
  br i1 %cmp16, label %for.inc, label %lor.lhs.false17

lor.lhs.false17:                                  ; preds = %lor.lhs.false15
  %cmp18 = icmp eq i32 %.sink5, 7
  br i1 %cmp18, label %for.inc, label %lor.lhs.false19

lor.lhs.false19:                                  ; preds = %lor.lhs.false17
  %cmp20 = icmp eq i32 %.sink5, 8
  br i1 %cmp20, label %for.inc, label %lor.lhs.false21

lor.lhs.false21:                                  ; preds = %lor.lhs.false19
  %cmp22 = icmp eq i32 %.sink5, 10
  br i1 %cmp22, label %for.inc, label %lor.lhs.false23

lor.lhs.false23:                                  ; preds = %lor.lhs.false21
  %cmp24 = icmp eq i32 %.sink5, 12
  br i1 %cmp24, label %for.inc, label %if.else27

if.else27:                                        ; preds = %lor.lhs.false23
  br label %for.inc

for.inc:                                          ; preds = %if.else, %lor.lhs.false13, %lor.lhs.false15, %lor.lhs.false17, %lor.lhs.false19, %lor.lhs.false21, %lor.lhs.false23, %for.body9, %if.else27
  %.sink1 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %lor.lhs.false23 ], [ 31, %lor.lhs.false21 ], [ 31, %lor.lhs.false19 ], [ 31, %lor.lhs.false17 ], [ 31, %lor.lhs.false15 ], [ 31, %lor.lhs.false13 ], [ 31, %if.else ]
  %add28 = add nsw i32 %n1.0, %.sink1
  %inc = add nsw i32 %.sink5, 1
  br label %for.cond7, !llvm.loop !9

if.end79:                                         ; preds = %for.cond7
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n2, i32 noundef 29, i32 %n1.0, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %M) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %M) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %n2) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %j) #6
  br label %for.inc164

if.else80:                                        ; preds = %lor.lhs.false
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j81) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n283) #6
...
for.cond85:                                       ; preds = %for.inc109, %if.else80
  %.sink4 = phi i32 [ 1, %if.else80 ], [ %inc110, %for.inc109 ]
  %n182.0 = phi i32 [ 0, %if.else80 ], [ %add106, %for.inc109 ]
  store i32 %.sink4, ptr %j81, align 4, !tbaa !5
  %3 = load i32, ptr %m1, align 4, !tbaa !5
  %cmp86 = icmp slt i32 %.sink4, %3
  br i1 %cmp86, label %for.body87, label %if.end162

for.body87:                                       ; preds = %for.cond85
  %cmp88 = icmp eq i32 %.sink4, 2
  br i1 %cmp88, label %for.inc109, label %if.else91

if.else91:                                        ; preds = %for.body87
  %cmp92 = icmp eq i32 %.sink4, 1
  br i1 %cmp92, label %for.inc109, label %lor.lhs.false93

lor.lhs.false93:                                  ; preds = %if.else91
  %cmp94 = icmp eq i32 %.sink4, 3
  br i1 %cmp94, label %for.inc109, label %lor.lhs.false95

lor.lhs.false95:                                  ; preds = %lor.lhs.false93
  %cmp96 = icmp eq i32 %.sink4, 5
  br i1 %cmp96, label %for.inc109, label %lor.lhs.false97

lor.lhs.false97:                                  ; preds = %lor.lhs.false95
  %cmp98 = icmp eq i32 %.sink4, 7
  br i1 %cmp98, label %for.inc109, label %lor.lhs.false99

lor.lhs.false99:                                  ; preds = %lor.lhs.false97
  %cmp100 = icmp eq i32 %.sink4, 8
  br i1 %cmp100, label %for.inc109, label %lor.lhs.false101

lor.lhs.false101:                                 ; preds = %lor.lhs.false99
  %cmp102 = icmp eq i32 %.sink4, 10
  br i1 %cmp102, label %for.inc109, label %if.else105

if.else105:                                       ; preds = %lor.lhs.false101
  br label %for.inc109

for.inc109:                                       ; preds = %if.else91, %lor.lhs.false93, %lor.lhs.false95, %lor.lhs.false97, %lor.lhs.false99, %lor.lhs.false101, %for.body87, %if.else105
  %.sink = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %lor.lhs.false101 ], [ 31, %lor.lhs.false99 ], [ 31, %lor.lhs.false97 ], [ 31, %lor.lhs.false95 ], [ 31, %lor.lhs.false93 ], [ 31, %if.else91 ]
  %add106 = add nsw i32 %n182.0, %.sink
  %inc110 = add nsw i32 %.sink4, 1
  br label %for.cond85, !llvm.loop !12

if.end162:                                        ; preds = %for.cond85
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j81, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n283, i32 noundef 28, i32 %n182.0, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %M84) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %M84) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %n283) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %j81) #6
  br label %for.inc164
...
for.inc164:                                       ; preds = %if.end79, %if.end162
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %y) #6
...
if.then63:                                        ; preds = %if.then60
  %call64 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #7
  br label %if.end68

if.else65:                                        ; preds = %if.then60
  %call66 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #7
  br label %if.end68
...
if.then74:                                        ; preds = %if.then70
  %call75 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #7
  br label %if.end79.exitStub

if.else76:                                        ; preds = %if.then70
  %call77 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #7
  br label %if.end79.exitStub
