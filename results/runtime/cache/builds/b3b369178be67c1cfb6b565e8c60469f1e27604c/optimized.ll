...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre66, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  ...
  %.pre66 = load i32, ptr %n, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond62.not, label %for.end33, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv57 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv53 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next54, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv53, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv53
...
for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit
  ...
  %7 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !14
...
for.cond34:                                       ; preds = %for.inc59, %for.end33
  %9 = phi i32 [ %dec60, %for.inc59 ], [ %sub, %for.end33 ]
  %cmp35 = icmp sgt i32 %9, -1
  br i1 %cmp35, label %for.cond38.preheader, label %for.end61

for.cond38.preheader:                             ; preds = %for.cond34
  %idxprom51 = zext nneg i32 %9 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc49
  %indvars.iv63 = phi i64 [ %8, %for.cond38.preheader ], [ %indvars.iv.next64, %for.inc49 ]
  %cmp39 = icmp sgt i64 %indvars.iv63, -1
  %10 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51, i64 %indvars.iv63
...
for.body40:                                       ; preds = %for.cond38
  br i1 %cmp55, label %for.end61.loopexit, label %for.inc49
...
for.inc59:                                        ; preds = %for.end50
  %dec60 = add nsw i32 %9, -1
  br label %for.cond34, !llvm.loop !17

for.end61.loopexit:                               ; preds = %for.body40
  %12 = trunc nsw i64 %indvars.iv63 to i32
  br label %for.end61

for.end61:                                        ; preds = %for.end50, %for.cond34, %for.end61.loopexit
  %x2.0 = phi i32 [ %9, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %y2.0 = phi i32 [ %12, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %13 = xor i32 %y1.1, -1
  %sub63 = add i32 %y2.0, %13
  %14 = xor i32 %x1.1, -1
  %sub66 = add i32 %x2.0, %14
  %mul = mul nsw i32 %sub63, %sub66
  %call67 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %mul) #6
