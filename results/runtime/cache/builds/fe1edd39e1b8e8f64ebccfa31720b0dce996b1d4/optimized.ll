...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax50 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %smax26 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count11 = zext nneg i32 %smax26 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count16 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv8
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv3 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next4, %for.inc21 ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond7.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv3
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv23 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next24, %for.inc60 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count11
  br i1 %exitcond28.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv23
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select1, %for.body34 ], [ %3, %for.body29 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv13, i64 %indvars.iv23
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv18 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next19, %for.inc57 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count16
  br i1 %exitcond22.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv18, i64 %indvars.iv23
...
for.cond65.preheader:                             ; preds = %for.end62
  %wide.trip.count39 = zext nneg i32 %smax50 to i64
  %wide.trip.count32 = zext i32 %n.tr to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv34 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next35, %for.inc83 ]
  %exitcond40.not = icmp eq i64 %indvars.iv34, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond86.preheader, label %for.cond68.preheader

for.cond86.preheader:                             ; preds = %for.cond65
  %wide.trip.count44 = zext i32 %n.tr to i64
  br label %for.cond86

for.cond68.preheader:                             ; preds = %for.cond65
  %7 = add nsw i64 %indvars.iv34, -1
  br label %for.cond68

for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv29 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next30, %for.inc80 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count32
  br i1 %exitcond33.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv34, i64 %indvars.iv29
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv29
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv46 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next47, %for.inc104 ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count39
  br i1 %exitcond52.not, label %for.end106, label %for.cond89.preheader
...
for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv41 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next42, %for.inc101 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %indvars.iv46
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv41, i64 %9
