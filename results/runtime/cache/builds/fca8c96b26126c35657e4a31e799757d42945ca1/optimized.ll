...
for.cond37:                                       ; preds = %for.inc51, %for.body33
  %min34.0 = phi i32 [ %7, %for.body33 ], [ %min34.1, %for.inc51 ]
  %8 = load i32, ptr %j, align 4, !tbaa !5
  %cmp38 = icmp slt i32 %8, %n
...
for.inc51:                                        ; preds = %for.body39, %if.then45
  %min34.1 = phi i32 [ %9, %if.then45 ], [ %min34.0, %for.body39 ]
...
for.body56:                                       ; preds = %for.cond54
  ...
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !12
  %sub61 = sub nsw i32 %11, %min34.0
...
; Function Attrs: mustprogress nofree nosync nounwind uwtable
define dso_local void @_Z1fi(i32 noundef %n) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i32 %n, 1
...
for.inc17:                                        ; preds = %for.cond1
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #9
  call void @_Z1fi(i32 noundef %2) #9
