...
for.inc74.gvnsink.split:                          ; preds = %if.then44, %if.else58, %if.then
  %add.sink12 = phi i32 [ %conv, %if.then ], [ %add, %if.else58 ], [ %add, %if.then44 ]
  %arrayidx60.sink.sink = phi ptr [ %arrayidx20, %if.then ], [ %arrayidx60, %if.else58 ], [ %arrayidx46, %if.then44 ]
  %idxprom69 = sext i32 %add.sink12 to i64
  ...
  %inc71 = add nsw i32 %add.sink12, 1
  br label %for.inc74
...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  ...
  %cmp95 = icmp slt i32 %7, %conv93
  br i1 %cmp95, label %for.body96, label %for.inc116

for.body96:                                       ; preds = %for.cond94
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %7, %sub97
  %idxprom102 = sext i32 %7 to i64
  %8 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom102
  %9 = load i8, ptr %8, align 1, !tbaa !12
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %9)
