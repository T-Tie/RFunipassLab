...
for.end49:                                        ; preds = %for.cond37
  %dm.0.lcssa = phi i32 [ %dm.0, %for.cond37 ]
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %dm.0.lcssa) #7
