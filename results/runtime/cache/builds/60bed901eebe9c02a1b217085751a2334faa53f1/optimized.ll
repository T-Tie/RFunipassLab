...
LeafBlock11:                                      ; preds = %NodeBlock13
  ...
  br i1 %SwitchLeaf12, label %lor.lhs.false, label %if.then44

LeafBlock9:                                       ; preds = %NodeBlock13
  %SwitchLeaf10 = icmp eq i8 %0, 71
  br i1 %SwitchLeaf10, label %lor.lhs.false, label %if.then44
...
LeafBlock7:                                       ; preds = %NodeBlock
  ...
  br i1 %SwitchLeaf8, label %lor.lhs.false, label %if.then44

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i8 %0, 65
  br i1 %SwitchLeaf, label %lor.lhs.false, label %if.then44

lor.lhs.false:                                    ; preds = %LeafBlock11, %LeafBlock9, %LeafBlock7, %LeafBlock
  br label %NodeBlock29

NodeBlock29:                                      ; preds = %lor.lhs.false
  %Pivot30 = icmp slt i8 %1, 71
  br i1 %Pivot30, label %NodeBlock21, label %NodeBlock27

NodeBlock27:                                      ; preds = %NodeBlock29
  %Pivot28 = icmp slt i8 %1, 84
  br i1 %Pivot28, label %LeafBlock23, label %LeafBlock25

LeafBlock25:                                      ; preds = %NodeBlock27
  %SwitchLeaf26 = icmp eq i8 %1, 84
  br i1 %SwitchLeaf26, label %for.inc, label %if.then44

LeafBlock23:                                      ; preds = %NodeBlock27
  %SwitchLeaf24 = icmp eq i8 %1, 71
  br i1 %SwitchLeaf24, label %for.inc, label %if.then44

NodeBlock21:                                      ; preds = %NodeBlock29
  %Pivot22 = icmp slt i8 %1, 67
  br i1 %Pivot22, label %LeafBlock17, label %LeafBlock19

LeafBlock19:                                      ; preds = %NodeBlock21
  %SwitchLeaf20 = icmp eq i8 %1, 67
  br i1 %SwitchLeaf20, label %for.inc, label %if.then44

LeafBlock17:                                      ; preds = %NodeBlock21
  %SwitchLeaf18 = icmp eq i8 %1, 65
  br i1 %SwitchLeaf18, label %for.inc, label %if.then44

if.then44:                                        ; preds = %LeafBlock25, %LeafBlock23, %LeafBlock19, %LeafBlock17, %LeafBlock11, %LeafBlock9, %LeafBlock7, %LeafBlock
  %inc45 = add nsw i32 %p.0, 1
  br label %for.inc

for.inc:                                          ; preds = %LeafBlock25, %LeafBlock23, %LeafBlock19, %LeafBlock17, %if.then44
  %p.1 = phi i32 [ %inc45, %if.then44 ], [ %p.0, %LeafBlock17 ], [ %p.0, %LeafBlock19 ], [ %p.0, %LeafBlock23 ], [ %p.0, %LeafBlock25 ]
