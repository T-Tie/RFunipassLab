...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv
...
for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv6
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc69
  %indvars.iv26 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next27, %for.inc69 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count14
  br i1 %exitcond30.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv26
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select4, %for.body39 ], [ %3, %for.body33 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv26
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select4 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond37, !llvm.loop !14

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv21 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next22, %for.inc66 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.inc69, label %for.inc66

for.inc66:                                        ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
  %smax5 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 1)
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  ...
  br i1 %exitcond12.not, label %for.cond13, label %for.inc30, !llvm.loop !19
