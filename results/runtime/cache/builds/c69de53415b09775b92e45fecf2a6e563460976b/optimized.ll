...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %t) #4
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %t, ptr align 16 @__const.main.t, i64 400, i1 false)
  call void @llvm.lifetime.start.p0(i64 400, ptr %u) #4
  br label %for.cond
...
if.end44:                                         ; preds = %if.then42, %for.end40
  call void @llvm.lifetime.end.p0(i64 400, ptr %u) #4
  call void @llvm.lifetime.end.p0(i64 400, ptr %t) #4
