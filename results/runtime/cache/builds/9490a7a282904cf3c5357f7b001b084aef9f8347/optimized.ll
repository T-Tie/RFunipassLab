...
if.then9:                                         ; preds = %if.else
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i4)
  store i8 32, ptr %__c.addr.i4, align 1, !tbaa !5
  %vtable.i5 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !8
  %vbase.offset.ptr.i6 = getelementptr i8, ptr %vtable.i5, i64 -24
  %vbase.offset.i7 = load i64, ptr %vbase.offset.ptr.i6, align 8
  %gep17 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i7
  %2 = load i64, ptr %gep17, align 8, !tbaa !10
  %cmp.not.i10 = icmp eq i64 %2, 0
  br i1 %cmp.not.i10, label %if.end.i14, label %if.then.i11

if.then.i11:                                      ; preds = %if.then9
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i4, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit16

if.end.i14:                                       ; preds = %if.then9
  %call2.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit16

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit16: ; preds = %if.then.i11, %if.end.i14
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i4)
  br label %for.inc

for.inc:                                          ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit16, %if.else
  %f.1 = phi i32 [ 1, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit16 ], [ 0, %if.else ]
