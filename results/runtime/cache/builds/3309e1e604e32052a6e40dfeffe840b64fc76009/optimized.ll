...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %b) #6
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc25
  %7 = phi i32 [ %.pre, %for.inc25 ], [ %3, %for.cond3.preheader ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc25 ], [ 1, %for.cond3.preheader ]
  %8 = sext i32 %7 to i64
