...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  br i1 %cmp, label %for.cond1.preheader, label %for.cond11.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %2 = phi i32 [ %.pre31, %for.inc ], [ %0, %for.cond1.preheader ]
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc24
  ...
  br i1 %exitcond.not, label %for.inc27.loopexit, label %for.body18
...
for.inc27.loopexit:                               ; preds = %for.cond15
  br label %for.inc27

for.inc27:                                        ; preds = %for.inc27.loopexit, %for.inc27.split.loop.exit
  %r.1 = phi i32 [ %4, %for.inc27.split.loop.exit ], [ %r.0, %for.inc27.loopexit ]
  %s.1 = phi i32 [ %6, %for.inc27.split.loop.exit ], [ %s.0, %for.inc27.loopexit ]
