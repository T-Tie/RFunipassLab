...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv10, %9
...
for.body51:                                       ; preds = %for.cond49
  ...
  %11 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv10
...
if.else72:                                        ; preds = %if.else63
  ...
  %14 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv10
