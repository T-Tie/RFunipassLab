...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %or.cond84 = select i1 %call16.i20, i1 %or.cond.i24, i1 false
  br i1 %or.cond84, label %if.then19.i25, label %if.then6.i51
...
if.then6.i51:                                     ; preds = %if.then28.i36, %if.then19.i25, %if.then6.i10
  ...
  %or.cond85 = select i1 %call16.i61, i1 %or.cond.i65, i1 false
  br i1 %or.cond85, label %if.then19.i66, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
  store i8 0, ptr %call7, align 1, !tbaa !21
