...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 302, ptr nonnull %ss) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(302) %ss, i8 0, i64 302, i1 false)
  store i8 48, ptr %ss, align 16
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %ss)
...
for.body6:                                        ; preds = %for.cond3
  ...
  %spec.select = add nuw nsw i32 %add, %count.1
...
if.end29:                                         ; preds = %if.then27, %for.end25
  call void @llvm.lifetime.end.p0(i64 302, ptr nonnull %ss) #8
  ret i32 0
}
