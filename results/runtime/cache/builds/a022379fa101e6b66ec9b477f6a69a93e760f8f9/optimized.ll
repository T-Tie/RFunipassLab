...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc132 ], [ 0, %for.cond ]
  %10 = sext i32 %9 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv61, %10
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv61
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i58 = call i32 @getc(ptr noundef %19)
  %20 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i59 = call i32 @getc(ptr noundef %20)
