...
for.cond:                                         ; preds = %for.inc17, %entry
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc17 ], [ 0, %entry ]
  %exitcond15 = icmp eq i64 %indvars.iv10, %wide.trip.count14
  br i1 %exitcond15, label %for.cond21.preheader, label %for.cond6
...
for.inc:                                          ; preds = %for.cond6
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv10
  %arrayidx = getelementptr inbounds nuw [550 x i8], ptr %a, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv10, i64 %indvars.iv
  store i8 %3, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc17:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv10, i64 %wide.trip.count
...
for.cond21:                                       ; preds = %for.cond21.loopexit, %for.cond21.preheader
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.cond21.loopexit ], [ 0, %for.cond21.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond21.loopexit ], [ 1, %for.cond21.preheader ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond51, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv21
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv21
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc44, %for.body25
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc44 ], [ %indvars.iv16, %for.body25 ]
  %4 = trunc nuw i64 %indvars.iv18 to i32
  %cmp30.not = icmp slt i32 %sub, %4
  br i1 %cmp30.not, label %for.cond21.loopexit, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv18
  %call39 = call i32 @strcmp(ptr noundef nonnull readonly captures(none) dereferenceable(1) %arrayidx34, ptr noundef nonnull readonly captures(none) dereferenceable(1) %arrayidx37) #9
...
for.cond51:                                       ; preds = %for.cond21, %for.body55
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body55 ], [ 0, %for.cond21 ]
  %max.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond21 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count25
  br i1 %exitcond31.not, label %for.end65, label %for.body55

for.body55:                                       ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv27
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc88 ], [ 0, %if.else ]
  %7 = load i32, ptr %n, align 4, !tbaa !5
  %sub74 = sub nsw i32 %conv, %7
  %8 = sext i32 %sub74 to i64
  %cmp75 = icmp slt i64 %indvars.iv32, %8
  br i1 %cmp75, label %for.body77, label %if.end91

for.body77:                                       ; preds = %for.cond73
  %arrayidx79 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv32
...
if.then81:                                        ; preds = %for.body77
  %arrayidx83 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv32
