...
for.end:                                          ; preds = %for.cond
  ...
  %smax100 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %2 = add nuw i32 %smax100, 1
  %wide.trip.count101 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv97 = phi i64 [ %indvars.iv.next98, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond102 = icmp eq i64 %indvars.iv97, %wide.trip.count101
  br i1 %exitcond102, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax88 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv85, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv91 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next92, %for.inc56 ]
  %exitcond96.not = icmp eq i64 %indvars.iv91, %wide.trip.count
  br i1 %exitcond96.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv91, %indvars.iv97
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv91
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond117.not = icmp eq i64 %indvars.iv112, %wide.trip.count116
  br i1 %exitcond117.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv112, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.inc118 ], [ %indvars.iv107, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv109 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv109, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond106.not = icmp eq i64 %indvars.iv103, 6
  br i1 %exitcond106.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv109, i64 %indvars.iv103
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv103
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv112, i64 %indvars.iv103
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc151 ], [ 1, %if.else ]
  %exitcond127.not = icmp eq i64 %indvars.iv118, %wide.trip.count126
  br i1 %exitcond127.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv118, i64 4
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars125.le = trunc i64 %indvars.iv118 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars125.le, %for.end153.split.loop.exit ], [ %3, %for.cond134 ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count142 = zext i32 %sub155 to i64
  %wide.trip.count137 = zext i32 %z.1.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv139 = phi i64 [ %indvars.iv.next140, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv132 = phi i64 [ %indvars.iv.next133, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond143.not = icmp eq i64 %indvars.iv139, %wide.trip.count142
  br i1 %exitcond143.not, label %for.cond207.preheader, label %for.body157

for.cond207.preheader:                            ; preds = %for.cond154
  br label %for.cond207

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv139, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %for.inc201 ], [ %indvars.iv132, %for.body157 ]
  %exitcond138.not = icmp eq i64 %indvars.iv134, %wide.trip.count137
  br i1 %exitcond138.not, label %for.cond154.loopexit, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv134, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond131.not = icmp eq i64 %indvars.iv128, 6
  br i1 %exitcond131.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv134, i64 %indvars.iv128
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv128
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv139, i64 %indvars.iv128
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv147 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next148, %for.inc223 ]
  %exitcond151.not = icmp eq i64 %indvars.iv147, %wide.trip.count137
  br i1 %exitcond151.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv144 = phi i64 [ %indvars.iv.next145, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv144, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv147, i64 %indvars.iv144
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar77 = call i32 @putchar(i32 %conv218)
