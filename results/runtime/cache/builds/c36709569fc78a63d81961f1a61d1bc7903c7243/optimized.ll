...
for.cond2:                                        ; preds = %for.inc11, %for.body
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc11 ], [ 1, %for.body ]
  %exitcond83 = icmp eq i64 %indvars.iv79, %1
  br i1 %exitcond83, label %for.cond14.preheader, label %for.cond5.preheader

for.cond14.preheader:                             ; preds = %for.cond2
  %4 = add i32 %0, 2
  %wide.trip.count122 = zext i32 %4 to i64
  br label %for.cond14

for.cond5.preheader:                              ; preds = %for.cond2
  %5 = mul nuw nsw i64 %indvars.iv79, %1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  ...
  %indvars.iv116 = phi i64 [ 3, %for.cond14.preheader ], [ %indvars.iv.next117, %for.cond14.loopexit ]
  %indvars.iv84 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next85, %for.cond14.loopexit ]
  %number.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add97, %for.cond14.loopexit ]
  %exitcond123.not = icmp eq i64 %indvars.iv116, %wide.trip.count122
  br i1 %exitcond123.not, label %for.inc138, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.inc50
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc50 ], [ %indvars.iv84, %for.cond14 ]
  %exitcond100 = icmp eq i64 %indvars.iv96, %1
  br i1 %exitcond100, label %for.cond53.preheader, label %for.body19
...
for.body19:                                       ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv96, %1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv84
  %7 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond24

for.cond24:                                       ; preds = %for.body26, %for.body19
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.body26 ], [ %indvars.iv84, %for.body19 ]
  %min.0 = phi i32 [ %spec.select, %for.body26 ], [ %7, %for.body19 ]
  %exitcond90 = icmp eq i64 %indvars.iv86, %1
  br i1 %exitcond90, label %for.cond39.preheader, label %for.body26

for.cond39.preheader:                             ; preds = %for.cond24
  br label %for.cond39

for.body26:                                       ; preds = %for.cond24
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv86
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv91 = phi i64 [ %indvars.iv84, %for.cond39.preheader ], [ %indvars.iv.next92, %for.inc47 ]
  %exitcond95 = icmp eq i64 %indvars.iv91, %1
  br i1 %exitcond95, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv91
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc88
  %indvars.iv111 = phi i64 [ %indvars.iv84, %for.cond53.preheader ], [ %indvars.iv.next112, %for.inc88 ]
  %exitcond115 = icmp eq i64 %indvars.iv111, %1
  br i1 %exitcond115, label %for.end90, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv111
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.body62 ], [ %indvars.iv84, %for.body55 ]
  %min.2 = phi i32 [ %spec.select75, %for.body62 ], [ %10, %for.body55 ]
  %exitcond105 = icmp eq i64 %indvars.iv101, %1
  br i1 %exitcond105, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %11 = mul nuw nsw i64 %indvars.iv101, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %11
  %12 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !14
  %spec.select75 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1
  br label %for.cond60, !llvm.loop !18

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv106 = phi i64 [ %indvars.iv84, %for.cond77.preheader ], [ %indvars.iv.next107, %for.inc85 ]
  %exitcond110 = icmp eq i64 %indvars.iv106, %1
  br i1 %exitcond110, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv106, %1
  %gep77 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep77, align 4, !tbaa !5, !invariant.load !14
  %sub84 = sub nsw i32 %14, %min.2
  store i32 %sub84, ptr %gep77, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next85, %1
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla, i64 %15
  %arrayidx96 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv.next85
  %16 = load i32, ptr %arrayidx96, align 4, !tbaa !5, !invariant.load !14
  %arrayidx101 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv84
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc130 ], [ %indvars.iv116, %for.end90 ]
  %18 = trunc nuw i64 %indvars.iv118 to i32
  %cmp110.not = icmp slt i32 %0, %18
  br i1 %cmp110.not, label %for.cond14.loopexit, label %for.inc130

for.inc130:                                       ; preds = %for.cond109
  %arrayidx115 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv118
  %19 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !14
  %arrayidx120 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv118
  store i32 %19, ptr %arrayidx120, align 4, !tbaa !5
  %20 = mul nuw nsw i64 %indvars.iv118, %1
  %arrayidx122 = getelementptr inbounds nuw i32, ptr %vla, i64 %20
  %arrayidx124 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv84
  %21 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !14
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv.next85
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !23, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !31, !invariant.load !14
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !32, !invariant.load !14
