...
for.cond14:                                       ; preds = %for.cond11, %for.body16
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.body16 ], [ 0, %for.cond11 ]
...
for.cond38:                                       ; preds = %for.body40, %for.body33
  %11 = phi i32 [ %add, %for.body40 ], [ 0, %for.body33 ]
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.body40 ], [ 0, %for.body33 ]
  %exitcond.not = icmp eq i64 %indvars.iv45, %wide.trip.count
  br i1 %exitcond.not, label %for.inc60, label %for.body40
...
for.body71:                                       ; preds = %for.cond69
  ...
  %19 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %call76 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %19)
  %20 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = add nsw i32 %20, -1
  %21 = sext i32 %sub to i64
  %cmp77 = icmp slt i64 %indvars.iv60, %21
...
if.end:                                           ; preds = %if.then, %for.body71
  ...
  %22 = phi i32 [ %.pre67, %if.then ], [ %20, %for.body71 ]
  %23 = zext i32 %sub79.pre-phi to i64
  %cmp80 = icmp eq i64 %indvars.iv60, %23
...
for.inc84:                                        ; preds = %if.end, %if.then81
  %.pre66 = phi i32 [ %22, %if.end ], [ %.pre66.pre, %if.then81 ]
