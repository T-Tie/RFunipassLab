...
if.end17:                                         ; preds = %if.else15, %if.else, %if.then
  %phiofops1 = phi i1 [ false, %if.else ], [ true, %if.else15 ], [ false, %if.then ]
...
for.cond:                                         ; preds = %for.inc73, %if.end17
  ...
  br i1 %cmp18, label %for.body, label %for.end75.loopexit2
...
for.end:                                          ; preds = %for.cond26
  %d.0.lcssa = phi i32 [ %d.0, %for.cond26 ]
  %cmp41 = icmp eq i32 %d.0.lcssa, 0
...
if.then47:                                        ; preds = %for.body45
  %add49 = add nsw i32 %i.0.lcssa3, %conv9
...
if.end50:                                         ; preds = %if.then47, %for.body45
  br i1 %phiofops1, label %if.then52, label %for.inc55

if.then52:                                        ; preds = %if.end50
  call void @_Z5rightPcii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(256) %a, i32 noundef %conv, i32 noundef %i.0.lcssa3) #8
  br label %for.inc55

for.inc55:                                        ; preds = %if.end50, %if.then52
...
for.cond58:                                       ; preds = %for.inc68, %for.end57
  ...
  br i1 %cmp59, label %for.inc68, label %for.end75.loopexit
...
for.inc68:                                        ; preds = %for.cond58
  ...
  %4 = load i8, ptr %arrayidx63, align 1, !tbaa !5
  %add64 = add i32 %i.0.lcssa3, -2
  %sub65 = add i32 %add64, %j.2
...
for.end75.loopexit2:                              ; preds = %for.cond
  br label %for.end75

for.end75:                                        ; preds = %for.end75.loopexit2, %for.end75.loopexit
