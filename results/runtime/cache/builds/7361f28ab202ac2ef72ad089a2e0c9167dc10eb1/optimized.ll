...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef %b) #7
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef %a) #7
...
if.then6:                                         ; preds = %for.body
  %div = sdiv i32 %n, %i.0
  %call = call noundef i32 @_Z4factii(i32 noundef %div, i32 noundef %i.0) #8
