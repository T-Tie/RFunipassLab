...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0, ptr nofree readonly captures(none) %1) unnamed_addr #8 {
for.end33_after_outline.exitStub:
  %call.i.i13 = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #13
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) initializes((0, 1)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %1) unnamed_addr #8 {
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #8 {
for.body25_after_outline.exitStub:
  %call.i.i = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #13
