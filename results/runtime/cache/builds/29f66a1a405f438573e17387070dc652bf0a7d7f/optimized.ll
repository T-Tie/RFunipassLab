...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv58.in = phi i64 [ %indvars.iv58, %for.end114 ], [ %2, %entry ]
  ...
  %indvars.iv58 = add i64 %indvars.iv58.in, -1
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv58, i64 1)
  %3 = trunc nuw i64 %indvars.iv51 to i32
  %smax48 = tail call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
...
for.cond.preheader:                               ; preds = %tailrecurse
  ...
  %smax32 = tail call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
...
for.cond31:                                       ; preds = %for.cond, %for.inc66
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc66 ], [ 0, %for.cond ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc63 ], [ 0, %for.cond51.preheader ]
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  ...
  %exitcond.not60 = icmp eq i64 %indvars.iv35, %smax
  br i1 %exitcond.not60, label %for.cond92.preheader, label %for.cond75
