...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv5 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next6, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  ...
  %wide.trip.count15 = zext i32 %2 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc40
  %indvars.iv9 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next10, %for.inc40 ]
  %exitcond21.not = icmp eq i64 %indvars.iv9, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond43.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv9
  br label %for.cond19
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc37
  %indvars.iv11 = phi i64 [ %indvars.iv9, %for.cond19.preheader ], [ %indvars.iv.next12, %for.inc37 ]
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.inc40, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %6 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next12
  %7 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv22 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next23, %for.inc53 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count20
  br i1 %exitcond26.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv22
  %8 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !12
  %call48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8)
  %cmp49 = icmp slt i64 %indvars.iv22, %5
  br i1 %cmp49, label %if.then50, label %for.inc53

if.then50:                                        ; preds = %for.body45
  %putchar = call i32 @putchar(i32 noundef 44) #5
  br label %for.inc53
