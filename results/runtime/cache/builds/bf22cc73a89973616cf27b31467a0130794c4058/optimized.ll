...
if.then22:                                        ; preds = %for.end
  %call23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1) #6
  br label %if.end24
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge2, i32 noundef %6) #6
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge3, i32 noundef %8) #6
