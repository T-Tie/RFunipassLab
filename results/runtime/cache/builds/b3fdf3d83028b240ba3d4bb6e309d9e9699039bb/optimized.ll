...
for.end:                                          ; preds = %for.cond
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx13)
...
for.inc24:                                        ; preds = %for.cond16
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %arrayidx21)
...
define internal void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) #6 {
for.end_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #11
