...
for.cond:                                         ; preds = %for.inc15, %entry
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc15 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv11, i64 %indvars.iv
...
for.inc15:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv11
  ...
  %div = fdiv double %3, %4
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv11
  store double %div, ptr %arrayidx14, align 8, !tbaa !12
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  br label %for.cond, !llvm.loop !14

for.cond18:                                       ; preds = %for.cond18.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %5 = phi i32 [ %0, %for.cond18.preheader ], [ %.pre, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  %indvars.iv14 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next15, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv14, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv14
...
for.inc41:                                        ; preds = %for.body21, %if.else, %if.else37
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(5) %.str.2.sink.sink) #6
  ...
  %8 = load i64, ptr %gep, align 8, !tbaa !19
  %cmp.not.i = icmp eq i64 %8, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.inc41
