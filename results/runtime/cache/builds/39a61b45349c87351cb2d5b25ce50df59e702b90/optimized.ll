...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv16 = phi i32 [ %indvars.iv.next17, %while.cond ], [ -1, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.cond ], [ 0, %entry ]
  %phiofops3 = phi i64 [ %indvars.iv, %while.cond ], [ -1, %entry ]
...
for.cond.preheader:                               ; preds = %while.cond
  %sext = shl i64 %phiofops3, 32
  %idxprom2 = ashr exact i64 %sext, 32
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv7 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next8, %for.inc ]
  %indvars.iv5 = phi i64 [ -1, %for.cond.preheader ], [ %indvars.iv.next6, %for.inc ]
  %exitcond.not = icmp eq i64 %indvars.iv7, 100
  br i1 %exitcond.not, label %for.cond14.preheader, label %for.body

for.cond14.preheader:                             ; preds = %for.cond
  %sext19 = shl i64 %indvars.iv, 32
  %0 = ashr exact i64 %sext19, 32
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv16, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond14

for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv7
  %1 = load i8, ptr %arrayidx5, align 1, !tbaa !12, !invariant.load !8
  %cmp6 = icmp eq i8 %1, 0
  br i1 %cmp6, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %arrayidx12 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv5
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv12 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next13, %for.inc25 ]
  %exitcond18.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond18.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %2 = xor i64 %indvars.iv12, -1
  %3 = add nsw i64 %0, %2
  %arrayidx21 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %3
