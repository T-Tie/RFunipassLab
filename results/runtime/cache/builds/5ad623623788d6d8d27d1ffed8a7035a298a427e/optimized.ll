...
if.end.thread:                                    ; preds = %while.body
  %cmp87 = icmp slt i32 %add, 80
  br i1 %cmp87, label %if.else14, label %if.then25
...
if.end19:                                         ; preds = %if.end, %if.else14
  ...
  %sum.18 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  ...
  %sum.2 = phi i32 [ 0, %if.end23.thread ], [ %conv, %if.then25 ], [ %sum.18, %if.end19 ]
