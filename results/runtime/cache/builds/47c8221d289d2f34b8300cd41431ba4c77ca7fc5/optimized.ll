...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2400, ptr noundef nonnull align 16 %a) #4
...
for.end:                                          ; preds = %for.cond1
  ...
  br i1 %cmp7, label %for.cond12.preheader, label %for.inc9
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.inc42
  %indvars.iv26 = phi i64 [ 0, %for.cond12.preheader ], [ %indvars.iv.next27, %for.inc42 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond31.not, label %for.cond45, label %for.inc42

for.inc42:                                        ; preds = %for.cond12
...
for.cond45:                                       ; preds = %for.cond12, %for.inc51
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc51 ], [ 0, %for.cond12 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond37.not, label %for.end53, label %for.inc51
...
for.inc51:                                        ; preds = %for.cond45
  ...
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %7) #5
...
for.end53:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2400, ptr noundef nonnull %a) #5
  ret i32 0
}
