...
for.end9:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i2) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j2) #4
  store i32 1, ptr %i, align 4, !tbaa !5
  br label %for.cond10
...
for.cond27:                                       ; preds = %for.inc42, %for.end26
  ...
  %7 = phi i32 [ %dec43, %for.inc42 ], [ %1, %for.end26 ]
  store i32 %.sink, ptr %i, align 4, !tbaa !5
  %cmp28 = icmp sge i32 %7, 1
...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %.sink1 = phi i32 [ %1, %for.body29 ], [ %dec, %for.inc40 ]
  %8 = phi i32 [ %dec, %for.inc40 ], [ %1, %for.body29 ]
...
for.body32:                                       ; preds = %for.cond30
  ...
  %11 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !15
  %cmp37 = icmp eq i32 %11, 0
  br i1 %cmp37, label %if.then38, label %for.inc40

if.then38:                                        ; preds = %for.body32
  store i32 %9, ptr %i2, align 4, !tbaa !5
  store i32 %10, ptr %j2, align 4, !tbaa !5
  br label %for.inc42
...
for.inc42:                                        ; preds = %for.cond30, %if.then38
  ...
  %dec43 = add nsw i32 %12, -1
  br label %for.cond27, !llvm.loop !17

for.end44:                                        ; preds = %for.cond27
  %13 = load i32, ptr %j2, align 4, !tbaa !5
  %14 = load i32, ptr %j1, align 4, !tbaa !5
  %sub = sub nsw i32 %13, %14
  %sub45 = sub nsw i32 %sub, 1
  %15 = load i32, ptr %i1, align 4, !tbaa !5
  %16 = load i32, ptr %i2, align 4, !tbaa !5
  %sub46 = sub nsw i32 %15, %16
  %sub47 = sub nsw i32 %sub46, 1
  %mul = mul nsw i32 %sub45, %sub47
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %mul)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j2) #4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j1) #4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i2) #4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i1) #4
