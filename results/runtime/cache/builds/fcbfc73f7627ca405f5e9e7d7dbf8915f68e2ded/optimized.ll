...
tailrecurse:                                      ; preds = %if.else, %entry
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  ...
  br i1 %exitcond43.not, label %for.cond31.preheader, label %for.body
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv34 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next35, %for.inc24 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc70
  %indvars.iv54 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next55, %for.inc70 ]
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv49 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next50, %for.inc67 ]
