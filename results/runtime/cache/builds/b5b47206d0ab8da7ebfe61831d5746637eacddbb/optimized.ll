...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %or.cond49, label %for.cond14.preheader, label %for.cond30.preheader
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc
  %x.1 = phi i32 [ %add, %for.inc ], [ 0, %for.cond14.preheader ]
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.cond14.preheader ]
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc40
  %x.4 = phi i32 [ %add34, %for.inc40 ], [ 0, %for.cond30.preheader ]
  %m.1 = phi i32 [ %inc41, %for.inc40 ], [ %a.1, %for.cond30.preheader ]
