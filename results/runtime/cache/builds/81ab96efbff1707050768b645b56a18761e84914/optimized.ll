...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv7 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next8, %for.inc24 ]
  %number.0 = phi i32 [ 0, %for.cond2.preheader ], [ %number.1, %for.inc24 ]
  %exitcond12.not = icmp eq i64 %indvars.iv7, %wide.trip.count11
  br i1 %exitcond12.not, label %for.cond27.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv7
  br label %for.cond5

for.cond27.preheader:                             ; preds = %for.cond2
  %smax17 = call i32 @llvm.smax.i32(i32 %number.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax17 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  br i1 %cmp12, label %for.inc24, label %for.cond5, !llvm.loop !13

if.then17:                                        ; preds = %for.cond5
  %idxprom20 = sext i32 %number.0 to i64
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv13 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next14, %for.body29 ]
  %exitcond18.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond18.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv13, 0
  %spec.select = select i1 %cmp30, ptr @.str, ptr @.str.1
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv13
  %4 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %4) #6
