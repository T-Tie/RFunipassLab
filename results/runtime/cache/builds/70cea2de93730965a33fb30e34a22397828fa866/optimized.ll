...
entry:
  ...
  %smax9 = call i32 @llvm.smax.i32(i32 noundef %x, i32 noundef 0) #6
...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  br i1 %exitcond11.not, label %for.end9, label %for.cond1.preheader
...
for.cond:                                         ; preds = %for.inc29, %entry
  ...
  br i1 %cmp, label %for.cond3.preheader, label %for.end31

for.cond3.preheader:                              ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc26
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc26 ], [ 0, %for.cond3.preheader ]
