...
for.cond2:                                        ; preds = %if.end, %for.end
  %Max.0 = phi i32 [ 0, %for.end ], [ %Max.1, %if.end ]
  %i.1 = phi i32 [ 0, %for.end ], [ %inc11, %if.end ]
...
for.cond13:                                       ; preds = %if.end25, %for.end12
  %i.2 = phi i32 [ 0, %for.end12 ], [ %inc27, %if.end25 ]
  %Max2.0 = phi i32 [ 0, %for.end12 ], [ %Max2.1, %if.end25 ]
