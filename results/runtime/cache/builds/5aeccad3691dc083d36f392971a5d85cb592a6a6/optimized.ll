...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull %b) #7
...
for.cond64:                                       ; preds = %for.cond64.preheader, %for.inc75
  %15 = phi i32 [ %12, %for.cond64.preheader ], [ %.pre64, %for.inc75 ]
  %indvars.iv58 = phi i64 [ 0, %for.cond64.preheader ], [ %indvars.iv.next59, %for.inc75 ]
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !21, !invariant.load !15
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !32, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !40, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !46, !invariant.load !15
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !47, !invariant.load !15
...
!34 = !{!"p1 _ZTSSo", !27, i64 0}
!35 = !{!"bool", !7, i64 0}
!36 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !27, i64 0}
!37 = !{!"p1 _ZTSSt5ctypeIcE", !27, i64 0}
!38 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !27, i64 0}
!39 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !27, i64 0}
!40 = !{!41, !7, i64 56}
...
!43 = !{!"p1 _ZTS15__locale_struct", !27, i64 0}
!44 = !{!"p1 int", !27, i64 0}
!45 = !{!"p1 short", !27, i64 0}
!46 = !{!7, !7, i64 0}
!47 = !{!48, !48, i64 0}
