...
if.then31:                                        ; preds = %if.then28
  ...
  %sub32 = sub nsw i32 %6, 2
  store i32 %sub32, ptr %x2, align 4, !tbaa !5
  br label %if.end35

if.else33:                                        ; preds = %if.then28
  %7 = load i32, ptr %x2, align 4, !tbaa !5
  %sub34 = sub nsw i32 %7, 3
