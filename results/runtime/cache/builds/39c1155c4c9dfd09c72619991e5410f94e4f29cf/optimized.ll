...
for.cond20:                                       ; preds = %for.inc32, %for.body16
  %min.0 = phi i32 [ %4, %for.body16 ], [ %min.1, %for.inc32 ]
...
for.body22:                                       ; preds = %for.cond20
  ...
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !13
...
for.inc46:                                        ; preds = %for.cond35
  ...
  %6 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
...
for.body54:                                       ; preds = %for.cond52
  ...
  %7 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.inc72, %for.body54
  %min.2 = phi i32 [ %7, %for.body54 ], [ %min.3, %for.inc72 ]
...
for.inc87:                                        ; preds = %for.cond75
  ...
  %9 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !13
...
for.inc111:                                       ; preds = %for.cond98
  ...
  %11 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
...
for.inc133:                                       ; preds = %for.cond120
  ...
  %12 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !13
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !26, !invariant.load !13
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !28, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !46, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !52, !invariant.load !13
  br label %return
