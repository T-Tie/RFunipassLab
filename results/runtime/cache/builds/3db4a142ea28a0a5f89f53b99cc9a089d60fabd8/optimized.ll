...
for.cond:                                         ; preds = %if.else, %entry
  %indvars.iv33 = phi i32 [ %indvars.iv.next34, %if.else ], [ 0, %entry ]
  ...
  br i1 %cmp, label %land.lhs.true, label %for.cond.if.else_crit_edge
...
if.else:                                          ; preds = %for.cond.if.else_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre35, %for.cond.if.else_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre36, %land.lhs.true ]
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.body
  %indvars.iv30 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next31, %for.body ]
