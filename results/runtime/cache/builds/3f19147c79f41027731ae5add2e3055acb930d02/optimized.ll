...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv14 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next15, %for.inc33 ]
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv14
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv11 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next12, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv11, %3
  br i1 %cmp8.not, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv11
  ...
  %6 = trunc nuw nsw i64 %indvars.iv11 to i32
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv19 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next20, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count22
  br i1 %exitcond23.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv19
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax33 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
  %wide.trip.count34 = zext nneg i32 %smax33 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count27 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc60
  %indvars.iv29 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next30, %for.inc60 ]
  %exitcond35.not = icmp eq i64 %indvars.iv29, %wide.trip.count34
  br i1 %exitcond35.not, label %if.end80, label %for.inc60

for.inc60:                                        ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv29
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv24 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next25, %for.inc73 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv24
