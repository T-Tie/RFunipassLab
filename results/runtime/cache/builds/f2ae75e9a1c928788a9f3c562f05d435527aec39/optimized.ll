...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %max) #9
...
if.else:                                          ; preds = %for.end69
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %15)
...
if.end92:                                         ; preds = %for.cond76, %if.then71
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %max) #11
