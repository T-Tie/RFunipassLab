...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12 = icmp slt i64 %indvars.iv25, %2
  br i1 %cmp12, label %for.body13, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond10
  %sext36 = shl i64 %2, 32
  %3 = ashr exact i64 %sext36, 32
  %sext37 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext37, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv25
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %6 = sub nuw nsw i64 %indvars.iv25, %indvars.iv
  ...
  br i1 %cmp19.not, label %for.cond10, label %if.end34, !llvm.loop !9

for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv32 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next33, %for.body25 ]
  %cmp24 = icmp slt i64 %indvars.iv32, %3
  br i1 %cmp24, label %for.body25, label %for.end37

for.body25:                                       ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv32, %4
  ...
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv32
