...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc106
  %2 = phi i32 [ %.pre, %for.inc106 ], [ %0, %for.cond6.preheader ]
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc106 ], [ 0, %for.cond6.preheader ]
  %3 = sext i32 %2 to i64
