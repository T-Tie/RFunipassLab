...
for.cond:                                         ; preds = %for.inc26, %entry
  %indvars.iv37 = phi i32 [ %indvars.iv.next38, %for.inc26 ], [ %conv, %entry ]
  %indvars.iv32 = phi i32 [ %indvars.iv.next33, %for.inc26 ], [ 0, %entry ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc38
  %indvars.iv29 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next30, %for.inc38 ]
...
for.inc38:                                        ; preds = %for.cond31
  ...
  %putchar20 = call i32 @putchar(i32 noundef %conv36) #7
...
for.cond44:                                       ; preds = %for.inc51, %for.end40
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc51 ], [ %8, %for.end40 ]
