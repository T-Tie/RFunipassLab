...
for.body15:                                       ; preds = %for.cond13
  ...
  br i1 %cmp20, label %for.inc24.split.loop.exit25, label %for.inc21

for.inc21:                                        ; preds = %for.body15
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  br label %for.cond13, !llvm.loop !14

for.inc24.split.loop.exit25:                      ; preds = %for.body15
  %9 = trunc nuw nsw i64 %indvars.iv9 to i32
  br label %for.inc24

for.inc24:                                        ; preds = %for.cond13, %for.inc24.split.loop.exit25
  %i1.1 = phi i32 [ %6, %for.inc24.split.loop.exit25 ], [ %i1.0, %for.cond13 ]
  %j1.1 = phi i32 [ %9, %for.inc24.split.loop.exit25 ], [ %j1.0, %for.cond13 ]
