...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv14.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv14, %for.cond17 ]
  %indvars.iv14 = add i32 %indvars.iv14.in, -1
  %cmp15 = icmp sgt i32 %indvars.iv14.in, 0
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv10 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next11, %for.inc37 ]
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv18, %8
