...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef align 16 %str) #6
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %str, i8 noundef 0, i64 noundef 10000, i1 noundef false) #7
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef align 16 %b) #6
  br label %while.cond
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %1 = load i8, ptr %arrayidx8, align 1, !tbaa !5, !invariant.load !11
...
if.then:                                          ; preds = %land.lhs.true
  ...
  store i32 %i.0, ptr %arrayidx12, align 4, !tbaa !12
...
for.body20:                                       ; preds = %for.cond18
  ...
  %2 = load i32, ptr %arrayidx22, align 4, !tbaa !12, !invariant.load !11
...
if.then30:                                        ; preds = %for.end28
  ...
  %3 = load i8, ptr %arrayidx32, align 1, !tbaa !5, !invariant.load !11
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef %b) #8
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %str) #8
  ret i32 0
}
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !20, !invariant.load !11
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !22, !invariant.load !11
  ret i64 %0
}
...
!22 = !{!23, !24, i64 16}
!23 = !{!"_ZTSSt8ios_base", !24, i64 8, !24, i64 16, !25, i64 24, !26, i64 28, !26, i64 32, !27, i64 40, !28, i64 48, !6, i64 64, !13, i64 192, !29, i64 200, !30, i64 208}
!24 = !{!"long", !6, i64 0}
!25 = !{!"_ZTSSt13_Ios_Fmtflags", !6, i64 0}
!26 = !{!"_ZTSSt12_Ios_Iostate", !6, i64 0}
!27 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !19, i64 0}
!28 = !{!"_ZTSNSt8ios_base6_WordsE", !19, i64 0, !24, i64 8}
!29 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !19, i64 0}
!30 = !{!"_ZTSSt6locale", !31, i64 0}
!31 = !{!"p1 _ZTSNSt6locale5_ImplE", !19, i64 0}
