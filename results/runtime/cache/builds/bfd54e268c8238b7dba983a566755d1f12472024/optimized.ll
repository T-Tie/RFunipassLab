...
NodeBlock9:                                       ; preds = %NodeBlock15
  ...
  br i1 %Pivot10, label %sw.bb33, label %sw.bb26
...
NodeBlock5:                                       ; preds = %NodeBlock7
  ...
  br i1 %Pivot6, label %sw.bb54, label %NodeBlock3

NodeBlock3:                                       ; preds = %NodeBlock5
  %Pivot4 = icmp slt i32 %rem1, 4
  br i1 %Pivot4, label %sw.bb47, label %sw.bb40

NodeBlock:                                        ; preds = %NodeBlock7
  %Pivot = icmp slt i32 %rem1, 1
  br i1 %Pivot, label %LeafBlock, label %sw.bb61

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i32 %rem1, 0
  br i1 %SwitchLeaf, label %sw.bb68, label %sw.epilog
...
sw.bb54:                                          ; preds = %NodeBlock5
  br label %sw.epilog.gvnsink.split

sw.bb61:                                          ; preds = %NodeBlock
  br label %sw.epilog.gvnsink.split

sw.bb68:                                          ; preds = %LeafBlock
  br label %sw.epilog.gvnsink.split

sw.epilog.gvnsink.split:                          ; preds = %NodeBlock11, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  %.sink2 = phi i32 [ 0, %sw.bb68 ], [ 0, %sw.bb61 ], [ 0, %sw.bb54 ], [ 0, %sw.bb47 ], [ 0, %sw.bb40 ], [ 1, %sw.bb33 ], [ 1, %sw.bb26 ], [ 1, %sw.bb19 ], [ 1, %sw.bb12 ], [ 1, %NodeBlock11 ]
  %.sink1 = phi i32 [ 0, %sw.bb68 ], [ 0, %sw.bb61 ], [ 1, %sw.bb54 ], [ 1, %sw.bb47 ], [ 2, %sw.bb40 ], [ 0, %sw.bb33 ], [ 0, %sw.bb26 ], [ 1, %sw.bb19 ], [ 1, %sw.bb12 ], [ 2, %NodeBlock11 ]
  %.sink = phi i32 [ 0, %sw.bb68 ], [ 1, %sw.bb61 ], [ 0, %sw.bb54 ], [ 1, %sw.bb47 ], [ 0, %sw.bb40 ], [ 0, %sw.bb33 ], [ 1, %sw.bb26 ], [ 0, %sw.bb19 ], [ 1, %sw.bb12 ], [ 0, %NodeBlock11 ]
