...
if.else.i:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %while.body
  ...
  br i1 %exitcond.not, label %while.end.loopexit, label %if.end10
...
while.end:                                        ; preds = %while.end.loopexit, %while.end.split.loop.exit28
  %i.2 = phi i32 [ %4, %while.end.split.loop.exit28 ], [ %number, %while.end.loopexit ]
