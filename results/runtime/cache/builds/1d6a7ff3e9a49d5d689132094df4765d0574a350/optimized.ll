...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %csum) #6
...
for.end73:                                        ; preds = %for.cond63
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %csum) #7
