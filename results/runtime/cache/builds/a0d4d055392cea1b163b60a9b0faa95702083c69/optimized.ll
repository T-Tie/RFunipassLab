...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 %array) #4
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax45 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count53 = zext nneg i32 %smax45 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %array, i64 0, i64 %indvars.iv35, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc52
  %indvars.iv48 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next49, %for.inc52 ]
  %indvars52 = trunc i64 %indvars.iv48 to i32
  %exitcond54.not = icmp eq i64 %indvars.iv48, %wide.trip.count53
  br i1 %exitcond54.not, label %for.end54, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.body15 ], [ 0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %array, i64 0, i64 %indvars.iv48, i64 %indvars.iv38
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !13
  %idxprom22 = sext i32 %m.0 to i64
  %arrayidx23 = getelementptr inbounds [100 x [100 x i32]], ptr %array, i64 0, i64 %indvars.iv48, i64 %idxprom22
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv41 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next42, %for.body30 ]
  %min.0 = phi i32 [ %indvars52, %for.cond28.preheader ], [ %spec.select27, %for.body30 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count53
  br i1 %exitcond47.not, label %for.end44, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx34 = getelementptr inbounds [100 x [100 x i32]], ptr %array, i64 0, i64 %indvars.iv41, i64 %idxprom33
  %8 = load i32, ptr %arrayidx34, align 4, !tbaa !5, !invariant.load !13
  ...
  %9 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !13
  %cmp39 = icmp slt i32 %8, %9
  %10 = trunc nuw nsw i64 %indvars.iv41 to i32
  %spec.select27 = select i1 %cmp39, i32 %10, i32 %min.0
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  br label %for.cond28, !llvm.loop !15

for.end44:                                        ; preds = %for.cond28
  %11 = zext i32 %min.0 to i64
  %cmp45 = icmp eq i64 %indvars.iv48, %11
  br i1 %cmp45, label %if.then46, label %for.inc52

if.then46:                                        ; preds = %for.end44
  %call47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %indvars52, i32 noundef %m.0)
...
for.end54:                                        ; preds = %for.cond10, %if.then46
  ...
  %sum.032 = phi i32 [ %indvars52, %if.then46 ], [ %smax45, %for.cond10 ]
...
if.end58:                                         ; preds = %if.then56, %for.end54
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %array) #5
  ret i32 0
}
