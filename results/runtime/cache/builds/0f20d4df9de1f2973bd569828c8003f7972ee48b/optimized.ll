...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 90000, ptr %a) #4
  call void @llvm.lifetime.start.p0(i64 90000, ptr %b) #4
  ...
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str.1, ptr noundef %m, ptr noundef %n)
  %0 = load i32, ptr %m, align 4, !tbaa !9
  %1 = load i32, ptr %n, align 4, !tbaa !9
  call void @_Z6stubidiiPA150_i(i32 noundef %0, i32 noundef %1, ptr noundef %a)
  ...
  call void @_Z6stubidiiPA150_i(i32 noundef %2, i32 noundef %3, ptr noundef %b)
  br label %for.cond
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 90000, ptr %b) #4
  call void @llvm.lifetime.end.p0(i64 90000, ptr %a) #4
  ret i32 0
}
