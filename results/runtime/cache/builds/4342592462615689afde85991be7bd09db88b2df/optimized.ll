...
for.cond6:                                        ; preds = %for.cond, %if.end105
  %2 = phi i32 [ %.pre, %if.end105 ], [ %0, %for.cond ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %if.end105 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp7 = icmp slt i64 %indvars.iv36, %3
  br i1 %cmp7, label %for.body8, label %for.end108

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [99 x double], ptr %b, i64 0, i64 %indvars.iv36
  %4 = load double, ptr %arrayidx10, align 8, !tbaa !12, !invariant.load !14
  %arrayidx14 = getelementptr inbounds nuw [99 x double], ptr %a, i64 0, i64 %indvars.iv36
  %5 = load double, ptr %arrayidx14, align 8, !tbaa !12, !invariant.load !14
  %mul15 = fmul double %5, 4.000000e+00
  %arrayidx17 = getelementptr inbounds nuw [99 x double], ptr %c, i64 0, i64 %indvars.iv36
...
if.end105:                                        ; preds = %if.then32, %cond.false, %cond.true, %if.then
