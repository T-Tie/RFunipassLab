...
if.then:                                          ; preds = %for.body
  ...
  %call16 = call double @sqrt(double noundef %6) #7, !tbaa !5
...
for.end112:                                       ; preds = %for.cond49
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef nonnull %x) #7
  call void @llvm.lifetime.end.p0(i64 noundef 1584, ptr noundef nonnull %m) #7
  ret i32 0
}
