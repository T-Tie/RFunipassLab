...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select = select i1 %cmp5, i32 %1, i32 %b.0
  %spec.select3 = select i1 %cmp5, i32 %2, i32 %a.0
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select3
  ...
  %smax5 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
...
for.cond14:                                       ; preds = %for.body, %for.inc
  ...
  %exitcond6.not = icmp eq i32 %m.0, %smax5
  br i1 %exitcond6.not, label %for.inc53, label %for.body16
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax5
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.17 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.17)
