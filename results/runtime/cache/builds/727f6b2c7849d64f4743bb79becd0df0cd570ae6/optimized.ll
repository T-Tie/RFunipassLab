...
for.cond10:                                       ; preds = %for.cond, %for.inc17
  ...
  br i1 %exitcond18.not, label %for.end19, label %land.end
...
for.end19:                                        ; preds = %for.cond10, %for.end19.split.loop.exit24
  %i.1.lcssa = phi i32 [ %4, %for.end19.split.loop.exit24 ], [ 31, %for.cond10 ]
