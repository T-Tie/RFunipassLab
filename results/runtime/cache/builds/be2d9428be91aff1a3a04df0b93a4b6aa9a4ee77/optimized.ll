...
for.cond1:                                        ; preds = %for.inc10, %for.body
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc10 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc27 ], [ 0, %tailrecurse ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count55
  br i1 %exitcond56.not, label %for.cond31.preheader, label %for.body
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv52
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv47
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc70
  %indvars.iv67 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next68, %for.inc70 ]
  %exitcond72.not = icmp eq i64 %indvars.iv67, %wide.trip.count55
  br i1 %exitcond72.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv67
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select45, %for.body42 ], [ %3, %for.body34 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv57, i64 %indvars.iv67
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %spec.select45 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  br label %for.cond39, !llvm.loop !17

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv62 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next63, %for.inc67 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count60
  br i1 %exitcond66.not, label %for.inc70, label %for.inc67

for.inc67:                                        ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv67
...
for.cond:                                         ; preds = %for.cond10, %entry
  %indvars.iv8 = phi i64 [ 1, %entry ], [ %indvars.iv.next9, %for.cond10 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.end27, label %for.body

for.body:                                         ; preds = %for.cond
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %arrayidx = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv.next9
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %arrayidx2 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv8
  store i32 %0, ptr %arrayidx2, align 4, !tbaa !5
  %arrayidx5 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next9
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv8
...
for.inc:                                          ; preds = %for.cond10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx20 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next9, i64 %indvars.iv.next
  %2 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %arrayidx24 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
