...
for.body13:                                       ; preds = %for.cond10
  ...
  %3 = load i8, ptr %arrayidx15, align 1, !tbaa !12
...
for.inc52:                                        ; preds = %for.body44, %if.then48
  %max.1 = phi i32 [ %8, %if.then48 ], [ %max.0, %for.body44 ]
  %inc53 = add nsw i32 %.sink7, 1
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %.sink8, %11
  %cmp69 = icmp slt i32 %10, %add68
