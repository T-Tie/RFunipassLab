...
for.inc42:                                        ; preds = %for.cond21
  store i32 %add20, ptr %i, align 4, !tbaa !5
...
if.else71:                                        ; preds = %land.end, %for.end67
  %11 = phi i32 [ %.pr, %for.end67 ], [ %.pr, %land.end ]
