...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv59 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next60, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count63
  br i1 %exitcond64.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv26
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv16
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp3411 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp3411, i32 %min.0, i32 %8
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond22, !llvm.loop !13

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv20 = phi i64 [ 0, %for.cond42.preheader ], [ %indvars.iv.next21, %for.inc57 ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond25.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv20
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count30
  br i1 %exitcond48.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv44
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count36
  br i1 %exitcond37.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv44
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp8210 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp8210, i32 %min.2, i32 %12
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  br label %for.cond69, !llvm.loop !16

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  %indvars.iv38 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next39, %for.inc107 ]
  %exitcond43.not = icmp eq i64 %indvars.iv38, %wide.trip.count36
  br i1 %exitcond43.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv38, i64 %indvars.iv44
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv59
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %wide.trip.count30
  br i1 %exitcond53.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv49, i64 %indvars.iv59
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count30
  br i1 %exitcond58.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv54
