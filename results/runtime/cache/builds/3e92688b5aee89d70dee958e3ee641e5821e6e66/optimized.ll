...
for.end33:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull %gep30)
...
for.end56:                                        ; preds = %for.cond45
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull %add.ptr59)
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull %0) unnamed_addr #9 {
for.end33_after_outline.exitStub:
  %call38 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0)
