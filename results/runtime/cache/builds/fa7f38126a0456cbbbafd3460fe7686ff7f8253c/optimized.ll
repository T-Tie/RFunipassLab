...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond = icmp eq i64 %indvars.iv3, %2
...
for.inc:                                          ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv3
...
for.body78:                                       ; preds = %for.cond76
  ...
  %11 = load i32, ptr %arrayidx80, align 4, !tbaa !5
  %cmp81 = icmp eq i32 %11, %max.0
