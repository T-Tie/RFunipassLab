...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %word) #8
...
for.cond:                                         ; preds = %if.end19, %entry
  ...
  %i.0 = phi i32 [ 0, %entry ], [ %3, %if.end19 ]
...
if.then:                                          ; preds = %while.body
  %call2 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
...
if.end:                                           ; preds = %while.body, %if.then
  ...
  %call5 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx3)
...
if.end10:                                         ; preds = %if.end
  ...
  %call14 = tail call i64 @strlen(ptr nofree noundef nonnull dereferenceable(1) %arrayidx12) #9
  %conv15 = trunc i64 %call14 to i32
  br label %while.cond, !llvm.loop !5

while.end:                                        ; preds = %if.end
  %call16 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.end

if.end19:                                         ; preds = %while.cond
  %3 = trunc nsw i64 %indvars.iv to i32
  %call162 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %number) #10
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %number) #11
  ret i32 0
}
