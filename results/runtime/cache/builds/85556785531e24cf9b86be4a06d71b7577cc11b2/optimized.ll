...
for.cond16:                                       ; preds = %for.inc35, %for.body15
  %.sink = phi i32 [ %2, %for.body15 ], [ %add, %for.inc35 ]
...
land.lhs.true:                                    ; preds = %for.body18
  ...
  %add28 = add nsw i32 %6, 1
  %cmp29 = icmp slt i32 %5, %add28
...
for.inc50:                                        ; preds = %for.body42, %if.then46
  %max.1 = phi i32 [ %8, %if.then46 ], [ %max.0, %for.body42 ]
