...
for.inc7:                                         ; preds = %for.cond1
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %j) #5
...
for.inc:                                          ; preds = %for.cond6
  ...
  %11 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !13
  ...
  %12 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !13
...
for.inc26:                                        ; preds = %for.end, %land.lhs.true, %if.else23
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef %.str.sink.sink, i32 noundef %14) #6
...
for.end31:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %z) #6
