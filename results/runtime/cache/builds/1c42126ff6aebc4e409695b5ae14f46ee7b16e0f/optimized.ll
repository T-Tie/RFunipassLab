...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax51 = call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax40 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond15, label %for.cond26.preheader, label %for.cond2

for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count19 = zext i32 %indvars.iv4 to i64
  br label %for.cond26
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv6 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next7, %for.inc20 ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv26 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next27, %for.inc57 ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body31
  ...
  %exitcond20 = icmp eq i64 %indvars.iv16, %wide.trip.count19
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv21 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next22, %for.inc54 ]
  %exitcond25 = icmp eq i64 %indvars.iv21, %wide.trip.count19
