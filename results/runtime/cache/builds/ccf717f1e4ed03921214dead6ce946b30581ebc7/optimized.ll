...
for.cond30:                                       ; preds = %for.cond13, %for.end72
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.end72 ], [ 1, %for.cond13 ]
...
for.cond33:                                       ; preds = %for.cond30, %for.inc70
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc70 ], [ 1, %for.cond30 ]
  %10 = load i32, ptr %y2, align 4, !tbaa !5
  %11 = sext i32 %10 to i64
  %cmp34.not = icmp sgt i64 %indvars.iv45, %11
  br i1 %cmp34.not, label %for.end72, label %for.body35
...
for.cond40:                                       ; preds = %for.body42, %for.body35
  ...
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body42 ], [ 1, %for.body35 ]
...
for.end57:                                        ; preds = %for.cond40
  %cmp58 = icmp eq i64 %indvars.iv45, 1
...
for.inc70:                                        ; preds = %for.end57, %if.else
  %call63 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %14)
