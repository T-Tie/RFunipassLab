...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc23
  %indvars.iv23 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next24, %for.inc23 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %for.inc23 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond26.preheader, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc13
  %indvars.iv20 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next21, %for.inc13 ]
  %exitcond.not = icmp eq i64 %indvars.iv20, %indvars.iv23
  br i1 %exitcond.not, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv20
...
for.end15:                                        ; preds = %for.body7, %for.cond5
  %j.0.lcssa.in = phi i64 [ %indvars.iv20, %for.body7 ], [ %indvars.iv23, %for.cond5 ]
  %5 = and i64 %j.0.lcssa.in, 4294967295
  %cmp16 = icmp eq i64 %5, %indvars.iv23
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc36
  %indvars.iv29 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next30, %for.inc36 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond34.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %b, i64 0, i64 %indvars.iv29
  ...
  %cmp32 = icmp slt i64 %indvars.iv29, %2
