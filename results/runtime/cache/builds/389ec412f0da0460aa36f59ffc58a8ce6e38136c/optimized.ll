...
for.cond14:                                       ; preds = %if.end58, %for.end9
  ...
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %if.end58 ], [ 1, %for.end9 ]
  %5 = sext i32 %4 to i64
  %cmp15 = icmp slt i64 %indvars.iv12, %5
  br i1 %cmp15, label %for.body16, label %for.end61

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [1000 x [2 x double]], ptr %sv, i64 0, i64 %indvars.iv12
  %arrayidx19 = getelementptr inbounds nuw i8, ptr %arrayidx18, i64 8
  %6 = load double, ptr %arrayidx19, align 8, !tbaa !9
  %7 = load double, ptr %arrayidx18, align 16, !tbaa !9
...
if.else:                                          ; preds = %for.body16
  ...
  %or.cond9 = and i1 %cmp43, %cmp53
  %spec.select = select i1 %or.cond9, ptr @.str.2, ptr @.str.3
  br label %if.end58
