...
for.cond:                                         ; preds = %if.end20, %entry
  ...
  %a.0 = phi i32 [ %a.1, %if.end20 ], [ 0, %entry ]
...
if.end20:                                         ; preds = %if.else, %for.body, %if.then
  %a.1 = phi i32 [ %inc, %if.then ], [ %a.0, %for.body ], [ %spec.select28, %if.else ]
...
for.cond26:                                       ; preds = %for.end, %if.end50
  %i.1 = phi i32 [ %inc52, %if.end50 ], [ 65, %for.end ]
...
if.then46:                                        ; preds = %for.end44
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %i.1, i32 noundef %t.1) #5
  br label %if.end50
...
for.cond54:                                       ; preds = %for.cond26, %if.end79
  %i.2 = phi i32 [ %inc81, %if.end79 ], [ 97, %for.cond26 ]
  %exitcond36.not = icmp eq i32 %i.2, 123
...
for.cond57:                                       ; preds = %for.cond54, %for.body62
  ...
  %l.1 = phi i32 [ %spec.select27, %for.body62 ], [ 0, %for.cond54 ]
...
for.body62:                                       ; preds = %for.cond57
  ...
  %spec.select27 = add nuw nsw i32 %l.1, %inc68
...
if.then74:                                        ; preds = %for.end72
  %call78 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %i.2, i32 noundef %l.1) #5
  br label %if.end79

if.end79:                                         ; preds = %if.then74, %for.end72
