...
for.inc41:                                        ; preds = %for.body26, %if.else, %cond.true
  %min.4 = phi i32 [ %5, %cond.true ], [ %min.3, %if.else ], [ %5, %for.body26 ]
...
for.body68:                                       ; preds = %for.cond65
  ...
  %7 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom76
  %8 = getelementptr inbounds [100 x i32], ptr %7, i64 0, i64 %idxprom78
...
for.inc90:                                        ; preds = %for.body68, %if.else75, %cond.true81
  %min.7 = phi i32 [ %9, %cond.true81 ], [ %min.6, %if.else75 ], [ %9, %for.body68 ]
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %12 = load i32, ptr %arrayidx124, align 4, !tbaa !5
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %13 = load i32, ptr %arrayidx141, align 16, !tbaa !5
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %14 = load i32, ptr %arrayidx157, align 4, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %15 = load i32, ptr %arrayidx178, align 4, !tbaa !5
