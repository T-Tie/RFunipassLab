...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  ...
  %n.promoted7 = phi i32 [ %n.promoted6, %for.inc30 ], [ %1, %for.cond ]
...
for.cond6:                                        ; preds = %for.cond3, %for.inc27
  ...
  %cmp7 = icmp slt i64 %indvars.iv12, %5
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv9 = phi i64 [ %5, %for.cond15.preheader ], [ %indvars.iv.next10, %for.inc23 ]
...
for.cond33:                                       ; preds = %for.cond3, %for.body35
  ...
  %cmp34 = icmp slt i64 %indvars.iv15, %11
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %10, -1
  %12 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv15, %12
  %13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv15
