...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %a) #6
...
for.inc:                                          ; preds = %for.cond
  ...
  %call4 = call noundef i32 @_Z1fii(i32 noundef 1, i32 noundef %2) #7
...
for.cond7:                                        ; preds = %for.cond, %for.inc14
  ...
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc14 ], [ 1, %for.cond ]
  %4 = sext i32 %3 to i64
  %cmp8.not = icmp sgt i64 %indvars.iv10, %4
  br i1 %cmp8.not, label %for.end16, label %for.inc14

for.inc14:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %result, i64 0, i64 %indvars.iv10
  %5 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !9
  ...
  %vtable.i = load ptr, ptr %call12, align 8, !tbaa !13, !invariant.load !9
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call12, i8 noundef signext %call.i1)
...
if.then:                                          ; preds = %for.body
  ...
  %div = sdiv i32 %y, %i.0
  %call3 = tail call noundef i32 @_Z1fii(i32 noundef %i.0, i32 noundef %div) #7
  br label %for.inc
