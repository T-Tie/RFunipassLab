...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 200, ptr noundef nonnull align 16 dereferenceable(200) %str) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(200) %str, i8 noundef 0, i64 noundef 200, i1 noundef false) #9
...
while.end:                                        ; preds = %while.cond
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(200) %str) #10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 200, ptr noundef nonnull %str) #10
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %num) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(800) %num, i8 noundef 0, i64 noundef 800, i1 noundef false) #9
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %str) #11
