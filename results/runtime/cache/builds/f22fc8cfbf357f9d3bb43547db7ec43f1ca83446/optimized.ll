...
for.cond13:                                       ; preds = %for.inc135, %for.end12
  %.sink = phi i32 [ %3, %for.end12 ], [ %dec, %for.inc135 ]
...
for.inc83:                                        ; preds = %for.cond71
  ...
  %18 = load i32, ptr %arrayidx77, align 4, !tbaa !5
  %19 = load i32, ptr %min, align 4, !tbaa !5
  %sub78 = sub nsw i32 %18, %19
...
for.end88:                                        ; preds = %for.cond51
  ...
  %20 = load i32, ptr %arrayidx90, align 8, !tbaa !5
...
for.cond91:                                       ; preds = %for.inc110, %for.end88
  ...
  %sub92 = sub nsw i32 %.sink, 1
  %cmp93 = icmp slt i32 %22, %sub92
...
for.inc139:                                       ; preds = %for.cond13
  ...
  %call137 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %28)
