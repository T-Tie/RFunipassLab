...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef %ans) #7
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !28, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !30, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !48, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !54, !invariant.load !9
  br label %return
