...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax92 = call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond56, label %for.cond26.preheader, label %for.cond2

for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count60 = zext i32 %indvars.iv45 to i64
  br label %for.cond26
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv47 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next48, %for.inc20 ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv67 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next68, %for.inc57 ]
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv62 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next63, %for.inc54 ]
  %exitcond66 = icmp eq i64 %indvars.iv62, %wide.trip.count60
