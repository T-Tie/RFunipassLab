...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  %9 = phi i32 [ %inc53, %for.inc52 ], [ 0, %for.end41 ]
  %max.0 = phi i32 [ 0, %for.end41 ], [ %max.1, %for.inc52 ]
  %cmp43 = icmp slt i32 %9, 1000
...
if.end83:                                         ; preds = %for.cond60, %if.then56
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef %a) #7
  ret i32 0
}
