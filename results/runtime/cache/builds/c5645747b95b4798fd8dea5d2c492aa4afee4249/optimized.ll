...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %s) #9
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %rep) #9
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %sub) #9
