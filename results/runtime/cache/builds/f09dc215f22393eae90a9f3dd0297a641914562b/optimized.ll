...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  ...
  %7 = sext i32 %6 to i64
  %cmp17.not = icmp sgt i64 %indvars.iv35, %7
...
for.cond30:                                       ; preds = %for.cond13, %for.end68
  %i.2 = phi i32 [ %inc9.i4, %for.end68 ], [ 1, %for.cond13 ]
...
for.cond33:                                       ; preds = %for.cond30, %for.inc66
  %j.2 = phi i32 [ %inc67, %for.inc66 ], [ 1, %for.cond30 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp34.not = icmp sgt i32 %j.2, %9
  br i1 %cmp34.not, label %for.end68, label %for.cond40.preheader
...
for.cond40.preheader:                             ; preds = %for.cond33
  ...
  %cmp63 = icmp eq i32 %j.2, %10
  br i1 %cmp63, label %if.then, label %if.else

if.then:                                          ; preds = %for.cond40.preheader
  %call64 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc66

if.else:                                          ; preds = %for.cond40.preheader
  %call65 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %for.inc66

for.inc66:                                        ; preds = %if.then, %if.else
  %inc67 = add nuw nsw i32 %j.2, 1
  br label %for.cond33, !llvm.loop !13

for.end68:                                        ; preds = %for.cond33
  %inc9.i4 = add nuw nsw i32 %i.2, 1
  br label %for.cond30
