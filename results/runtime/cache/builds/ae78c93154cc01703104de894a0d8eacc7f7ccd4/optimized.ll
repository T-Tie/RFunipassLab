...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre80, %for.body17 ]
  %indvars.iv41 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next42, %for.body17 ]
...
for.end28:                                        ; preds = %for.cond12
  ...
  %smax53 = call i32 @llvm.smax.i32(i32 %22, i32 0)
...
for.cond46.preheader:                             ; preds = %for.cond30
  %smax60 = call i32 @llvm.smax.i32(i32 %17, i32 0)
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body35
  %indvars.iv47 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next48, %for.body35 ]
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  ...
  br i1 %exitcond62.not, label %for.inc74, label %for.body54
...
for.cond80:                                       ; preds = %for.cond46, %for.end97
  %33 = phi i32 [ %.pre79, %for.end97 ], [ %22, %for.cond46 ]
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.end97 ], [ 0, %for.cond46 ]
...
for.cond87:                                       ; preds = %for.body89, %for.body82
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body89 ], [ 1, %for.body82 ]
