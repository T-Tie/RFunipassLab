...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then6.i, %land.lhs.true.i, %if.then19.i, %if.then28.i
  ...
  br i1 %cmp5, label %for.cond6, label %if.else

for.cond6:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %for.inc
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count25
  br i1 %exitcond32.not, label %for.inc43, label %for.inc

for.inc:                                          ; preds = %for.cond6
  %add.ptr = getelementptr inbounds nuw i8, ptr %a, i64 %indvars.iv27
  %3 = load i8, ptr %add.ptr, align 1, !tbaa !21, !invariant.load !9
...
for.cond17:                                       ; preds = %for.inc24, %if.then14
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc24 ], [ 0, %if.then14 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond17
  %add.ptr22 = getelementptr inbounds nuw i8, ptr %a, i64 %indvars.iv21
  %4 = load i8, ptr %add.ptr22, align 1, !tbaa !21, !invariant.load !9
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %4)
...
if.else29:                                        ; preds = %if.else
  %call30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.cond32
...
for.cond32:                                       ; preds = %for.inc39, %if.else29
  ...
  br i1 %exitcond.not, label %for.inc43, label %for.inc39

for.inc39:                                        ; preds = %for.cond32
  %add.ptr37 = getelementptr inbounds nuw i8, ptr %a, i64 %indvars.iv
  %5 = load i8, ptr %add.ptr37, align 1, !tbaa !21, !invariant.load !9
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %5)
