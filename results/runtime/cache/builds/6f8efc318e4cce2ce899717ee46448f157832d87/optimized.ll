...
for.inc:                                          ; preds = %for.cond
  ...
  call void @_Z9xiangguaniii(i32 noundef %2, i32 noundef %3, i32 noundef %4)
  %inc = add nsw i32 %0, 1
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x1) #7
  store i32 0, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x2) #7
  store i32 0, ptr %x2, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %.sink8 = phi i32 [ 1, %entry ], [ %inc, %for.inc ]
  %cmp = icmp slt i32 %.sink8, %m1
...
if.end.thread:                                    ; preds = %for.body, %lor.lhs.false, %lor.lhs.false3, %lor.lhs.false5
  ...
  store i32 %dec, ptr %x1, align 4, !tbaa !5
  br label %for.inc

if.end:                                           ; preds = %lor.lhs.false5
  %cmp7 = icmp eq i32 %.sink8, 2
...
if.end11:                                         ; preds = %if.then8, %if.else
  %.sink1 = phi i32 [ 3, %if.else ], [ 2, %if.then8 ]
  %sub10 = sub nsw i32 %add, %.sink1
  store i32 %sub10, ptr %x1, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %if.end, %if.end11, %if.end.thread
  %inc = add nsw i32 %.sink8, 1
...
if.end26.thread:                                  ; preds = %for.body15, %lor.lhs.false18, %lor.lhs.false20, %lor.lhs.false22
  ...
  store i32 %dec25, ptr %x2, align 4, !tbaa !5
  br label %for.inc37

if.end26:                                         ; preds = %lor.lhs.false22
  %cmp27 = icmp eq i32 %.sink9, 2
  br i1 %cmp27, label %if.then28, label %for.inc37

if.then28:                                        ; preds = %if.end26
  %call29 = call noundef i32 @_Z7runniani(i32 noundef %y) #8
  %tobool30 = icmp ne i32 %call29, 0
  br i1 %tobool30, label %if.end35, label %if.else33

if.else33:                                        ; preds = %if.then28
  br label %if.end35

if.end35:                                         ; preds = %if.then28, %if.else33
  %.sink = phi i32 [ 3, %if.else33 ], [ 2, %if.then28 ]
  %sub34 = sub nsw i32 %add16, %.sink
  store i32 %sub34, ptr %x2, align 4, !tbaa !5
  br label %for.inc37

for.inc37:                                        ; preds = %if.end26, %if.end35, %if.end26.thread
  %inc38 = add nsw i32 %.sink9, 1
  br label %for.cond13, !llvm.loop !13

for.end39:                                        ; preds = %for.cond13
  %2 = load i32, ptr %x1, align 4, !tbaa !5
  %sub40 = sub nsw i32 %2, %1
