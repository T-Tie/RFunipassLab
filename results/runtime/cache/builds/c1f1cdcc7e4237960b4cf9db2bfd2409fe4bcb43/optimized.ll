...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %m) #4
...
for.end87:                                        ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %total1) #5
  store i32 0, ptr %total1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %total2) #5
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month1, ptr nofree noundef nonnull align 4 dereferenceable(4) %total1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year) #5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %m, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month2, ptr nofree noundef nonnull align 4 dereferenceable(4) %total2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year) #5
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %total2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %total1) #5
  %inc96 = add nuw nsw i32 %j.0, 1
  br label %for.cond, !llvm.loop !9

for.end97:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %m) #5
...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) initializes((0, 4)) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %3) unnamed_addr #3 {
for.body_to_outline:
  br label %for.cond2

for.cond2:                                        ; preds = %for.inc, %for.body_to_outline
  %storemerge = phi i32 [ 1, %for.body_to_outline ], [ %inc, %for.inc ]
  store i32 %storemerge, ptr %0, align 4, !tbaa !5
  %4 = load i32, ptr %1, align 4, !tbaa !5
  %cmp3 = icmp slt i32 %storemerge, %4
  br i1 %cmp3, label %for.body4, label %for.end.exitStub

for.body4:                                        ; preds = %for.cond2
  switch i32 %storemerge, label %if.end [
    i32 1, label %if.then
    i32 3, label %if.then
    i32 5, label %if.then
    i32 7, label %if.then
...
if.end:                                           ; preds = %for.body4, %if.then
  %6 = phi i32 [ %.pr, %if.then ], [ %storemerge, %for.body4 ]
  switch i32 %6, label %if.end26 [
    i32 4, label %if.then24
    i32 6, label %if.then24
    i32 9, label %if.then24
    i32 11, label %if.then24
  ]

if.then24:                                        ; preds = %if.end, %if.end, %if.end, %if.end
  %7 = load i32, ptr %2, align 4, !tbaa !5
  %add25 = add nsw i32 %7, 30
  store i32 %add25, ptr %2, align 4, !tbaa !5
  %.pr1 = load i32, ptr %0, align 4, !tbaa !5
  br label %if.end26

if.end26:                                         ; preds = %if.end, %if.then24
  %8 = phi i32 [ %.pr1, %if.then24 ], [ %6, %if.end ]
...
if.then28:                                        ; preds = %if.end26
  ...
  %rem30 = srem i32 %9, 100
  %cmp31 = icmp ne i32 %rem30, 0
  %or.cond = and i1 %cmp29, %cmp31
  %rem33 = srem i32 %9, 400
  %cmp34 = icmp eq i32 %rem33, 0
  %or.cond4 = or i1 %cmp34, %or.cond
  %.sink2 = select i1 %or.cond4, i32 29, i32 28
  %11 = load i32, ptr %2, align 4, !tbaa !5
  %add37 = add nsw i32 %.sink2, %11
  store i32 %add37, ptr %2, align 4, !tbaa !5
  %.pre = load i32, ptr %0, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %if.then28, %if.end26
  %12 = phi i32 [ %.pre, %if.then28 ], [ %8, %if.end26 ]
