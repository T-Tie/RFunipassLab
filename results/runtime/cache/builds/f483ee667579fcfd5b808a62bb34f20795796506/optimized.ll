...
if.end37:                                         ; preds = %for.body30
  %arrayidx39 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom383
  %arrayidx41 = getelementptr inbounds [10 x i32], ptr %arrayidx39, i64 0, i64 %idxprom35
...
if.end37.thread:                                  ; preds = %for.body30
  ...
  %arrayidx416 = getelementptr inbounds [10 x i32], ptr %arrayidx394, i64 0, i64 %idxprom35
...
for.inc50:                                        ; preds = %if.end37.thread, %if.end37, %if.then44, %if.end37.thread
  ...
  %min.3 = phi i32 [ %4, %if.then44 ], [ %min.1, %if.end37 ], [ %5, %if.end37.thread ], [ %5, %if.end37.thread ]
