...
for.cond13.preheader:                             ; preds = %for.cond
  %smax6 = call i32 @llvm.smax.i32(i32 %m2, i32 1)
  br label %for.cond13
...
if.then8:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z7runniani(i32 noundef %y) #10
...
if.then28:                                        ; preds = %for.body15
  %call29 = tail call noundef i32 @_Z7runniani(i32 noundef %y) #10
