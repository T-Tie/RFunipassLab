...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax53 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %smax29 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count14 = zext nneg i32 %smax29 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count19 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv11
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv6 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next7, %for.inc21 ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond10.not, label %for.inc24, label %for.inc21
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv26 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next27, %for.inc60 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count14
  br i1 %exitcond31.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv26
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select4, %for.body34 ], [ %3, %for.body29 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv26
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv21 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next22, %for.inc57 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond25.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv37 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next38, %for.inc83 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv32 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next33, %for.inc80 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv32
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv32
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv49 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next50, %for.inc104 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count42
  br i1 %exitcond55.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv49, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv44 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next45, %for.inc101 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count47
  br i1 %exitcond48.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv49
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %9
