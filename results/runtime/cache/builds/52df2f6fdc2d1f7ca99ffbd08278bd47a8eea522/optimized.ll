...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond17, label %for.cond15.preheader, label %for.cond4
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc42
  %indvars.iv18 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next19, %for.inc42 ]
  %exitcond27 = icmp eq i64 %indvars.iv18, %wide.trip.count16
  br i1 %exitcond27, label %for.cond45, label %for.cond21.preheader

for.cond21.preheader:                             ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv18
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv18
  br label %for.cond21

for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc39
  %indvars.iv20 = phi i64 [ %indvars.iv18, %for.cond21.preheader ], [ %indvars.iv.next21, %for.inc39 ]
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv.next21
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.09 = phi i32 [ %7, %if.else71.loopexit ], [ 2, %for.end67 ]
