...
for.cond:                                         ; preds = %for.inc, %entry
  %n.promoted6 = phi i32 [ %.pre, %for.inc ], [ %0, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %1 = sext i32 %n.promoted6 to i64
...
for.cond3:                                        ; preds = %for.cond, %for.inc30
  %2 = phi i32 [ %3, %for.inc30 ], [ %n.promoted6, %for.cond ]
  %n.promoted9 = phi i32 [ %n.promoted8, %for.inc30 ], [ %n.promoted6, %for.cond ]
  %i.0 = phi i32 [ %inc31, %for.inc30 ], [ 1, %for.cond ]
  %cmp4 = icmp slt i32 %i.0, %n.promoted9
  br i1 %cmp4, label %for.cond6, label %for.cond33

for.cond6:                                        ; preds = %for.cond3, %for.inc27
  %3 = phi i32 [ %8, %for.inc27 ], [ %2, %for.cond3 ]
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc27 ], [ 0, %for.cond3 ]
  %n.promoted8 = phi i32 [ %n.promoted7, %for.inc27 ], [ %n.promoted9, %for.cond3 ]
  %dec5 = phi i32 [ %dec4, %for.inc27 ], [ %n.promoted9, %for.cond3 ]
  %i.1 = phi i32 [ %i.2, %for.inc27 ], [ %i.0, %for.cond3 ]
  %4 = sext i32 %i.1 to i64
  %cmp7 = icmp slt i64 %indvars.iv14, %4
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv14
...
for.cond15.preheader:                             ; preds = %for.body9
  %smax = call i32 @llvm.smax.i32(i32 noundef %i.1, i32 %dec5)
  %wide.trip.count = sext i32 %smax to i64
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %indvars.iv11 = phi i64 [ %4, %for.cond15.preheader ], [ %indvars.iv.next12, %for.inc23 ]
...
for.inc23:                                        ; preds = %for.cond15
  ...
  %arrayidx20 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv.next12
  %7 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds i32, ptr %call1, i64 %indvars.iv11
...
for.inc27:                                        ; preds = %for.body9, %for.end25
  ...
  %n.promoted7 = phi i32 [ %dec, %for.end25 ], [ %n.promoted8, %for.body9 ]
  %dec4 = phi i32 [ %dec, %for.end25 ], [ %dec5, %for.body9 ]
...
for.cond33:                                       ; preds = %for.cond3, %for.body35
  %9 = phi i32 [ %.pre20, %for.body35 ], [ %2, %for.cond3 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body35 ], [ 0, %for.cond3 ]
  %10 = sext i32 %9 to i64
  %cmp34 = icmp slt i64 %indvars.iv17, %10
  br i1 %cmp34, label %for.body35, label %for.end47

for.body35:                                       ; preds = %for.cond33
  %sub = add nsw i32 %9, -1
  %11 = zext i32 %sub to i64
  %cmp36 = icmp eq i64 %indvars.iv17, %11
  %spec.select = select i1 %cmp36, ptr @.str, ptr @.str.1
  %arrayidx42 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv17
  %12 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %12) #8
