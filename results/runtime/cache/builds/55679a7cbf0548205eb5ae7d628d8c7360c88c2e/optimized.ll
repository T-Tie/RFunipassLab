...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %6 = phi i32 [ 65, %if.end24 ], [ %inc21.i2, %if.end35 ]
...
if.end35:                                         ; preds = %if.then31, %for.body27
  %8 = phi i32 [ %.pre9, %if.then31 ], [ %6, %for.body27 ]
  %inc21.i2 = add nsw i32 %8, 1
  br label %for.cond25

for.cond39:                                       ; preds = %for.cond25, %if.end49
  %9 = phi i32 [ %inc21.i3, %if.end49 ], [ 97, %for.cond25 ]
...
for.body41:                                       ; preds = %for.cond39
  ...
  %10 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !10
...
if.end49:                                         ; preds = %if.then45, %for.body41
  %11 = phi i32 [ %.pre, %if.then45 ], [ %9, %for.body41 ]
  %inc21.i3 = add nsw i32 %11, 1
  br label %for.cond39
