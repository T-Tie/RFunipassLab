...
for.body:                                         ; preds = %entry, %for.inc
  %indvars.iv10 = phi i32 [ 1, %entry ], [ %indvars.iv.next11, %for.inc ]
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc41
  %indvars.iv7 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next8, %for.inc41 ]
  %exitcond = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond, label %for.end43, label %for.inc41

for.inc41:                                        ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [999 x i32], ptr %g, i64 0, i64 %indvars.iv7
  %7 = load i32, ptr %arrayidx39, align 4, !tbaa !5
  %call40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %7) #5
