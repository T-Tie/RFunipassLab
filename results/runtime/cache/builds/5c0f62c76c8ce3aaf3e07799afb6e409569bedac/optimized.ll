...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %8 = sext i32 %7 to i64
  %cmp50 = icmp slt i64 %indvars.iv11, %8
...
if.then55:                                        ; preds = %for.body51
  %arrayidx58 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv11
...
if.else63:                                        ; preds = %for.body51
  ...
  %arrayidx70 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv11
...
if.then77:                                        ; preds = %if.else72
  ...
  %arrayidx84 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv11
...
if.else93:                                        ; preds = %if.else72
  %arrayidx99 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv11
