...
for.cond3.preheader:                              ; preds = %for.cond
  %smax39 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.cond52.preheader:                             ; preds = %for.cond3
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
if.end:                                           ; preds = %if.then, %for.body6
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %j.1, i32 noundef 0)
  br label %for.cond15
...
for.cond20.preheader:                             ; preds = %for.cond15
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv31, i32 noundef 0)
