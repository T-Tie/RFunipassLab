...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %max1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %max2) #6
...
for.body9:                                        ; preds = %for.cond7
  ...
  %6 = load i32, ptr %max2, align 4, !tbaa !5
  %cmp12 = icmp sge i32 %5, %6
  %conv = zext i1 %cmp12 to i32
  %7 = load i32, ptr %max1, align 4, !tbaa !5
  %sub = sub nsw i32 %7, 1
  %cmp15 = icmp sle i32 %5, %sub
...
if.then17:                                        ; preds = %for.body9
  store i32 %5, ptr %max2, align 4, !tbaa !5
  br label %if.end20
...
for.end22:                                        ; preds = %for.cond7
  %8 = load i32, ptr %max1, align 4, !tbaa !5
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %8)
  ...
  %9 = load i32, ptr %max2, align 4, !tbaa !5
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %max2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %max1) #7
