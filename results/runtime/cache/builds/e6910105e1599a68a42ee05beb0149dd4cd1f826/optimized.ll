...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %1 = add i32 %.pr3, -20
  %or.cond18 = icmp ult i32 %1, 30
  br i1 %or.cond18, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %2 = add i32 %.pr4, -10
  %or.cond19 = icmp ult i32 %2, 10
  br i1 %or.cond19, label %while.body22, label %while.end25
...
while.cond35:                                     ; preds = %land.end30
  ...
  %f.0 = select i1 %or.cond, i32 %.pr5, i32 0
