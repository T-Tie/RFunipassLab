...
for.cond10:                                       ; preds = %for.cond10.loopexit, %for.cond10.preheader
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.cond10.loopexit ], [ %4, %for.cond10.preheader ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.cond10.loopexit ], [ %3, %for.cond10.preheader ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv10 = phi i64 [ %indvars.iv8, %for.cond13.preheader ], [ %indvars.iv.next11, %for.inc31 ]
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, 1
  %cmp14 = icmp slt i64 %indvars.iv.next11, %4
  br i1 %cmp14, label %for.body15, label %for.cond10.loopexit

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !14
  %arrayidx19 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next11
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next11
