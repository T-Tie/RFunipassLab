...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  ...
  %indvars.iv16 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next17, %for.inc24 ]
...
for.cond5:                                        ; preds = %for.body7, %for.body4
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body7 ], [ %indvars.iv16, %for.body4 ]
  %index.0 = phi i32 [ %spec.select, %for.body7 ], [ %2, %for.body4 ]
  %cmp6 = icmp slt i64 %indvars.iv18, %1
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv18
...
for.inc24:                                        ; preds = %for.cond5
  ...
  %arrayidx19 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv21
