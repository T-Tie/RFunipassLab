...
for.cond26:                                       ; preds = %for.inc51, %if.else25
  %1 = phi i32 [ %inc52, %for.inc51 ], [ 65, %if.else25 ]
  %cmp27 = icmp sle i32 %1, 90
...
for.cond54:                                       ; preds = %for.inc80, %for.end53
  %3 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.end53 ]
  %cmp55 = icmp sle i32 %3, 122
