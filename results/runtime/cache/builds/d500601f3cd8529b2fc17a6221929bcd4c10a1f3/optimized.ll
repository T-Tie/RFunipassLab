...
for.inc:                                          ; preds = %for.inc.gvnsink.split, %for.body, %land.lhs.true13, %if.else
  %a.1 = phi i32 [ %inc19, %for.inc.gvnsink.split ], [ %a.0, %land.lhs.true13 ], [ %a.0, %if.else ], [ %a.0, %for.body ]
...
for.cond26:                                       ; preds = %for.inc51, %if.else25
  %2 = phi i32 [ %inc52, %for.inc51 ], [ 65, %if.else25 ]
  %cmp27 = icmp sle i32 %2, 90
...
for.cond29:                                       ; preds = %for.inc42, %for.body28
  ...
  %3 = load i8, ptr %arrayidx31, align 1, !tbaa !5, !invariant.load !8
  %conv32 = sext i8 %3 to i32
  %cmp33 = icmp ne i32 %conv32, 0
  br i1 %cmp33, label %for.body34, label %for.end44

for.body34:                                       ; preds = %for.cond29
  %4 = load i8, ptr %arrayidx31, align 1, !tbaa !5, !invariant.load !8
...
if.then46:                                        ; preds = %for.end44
  %conv47 = trunc i32 %2 to i8
  %conv48 = sext i8 %conv47 to i32
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv48, i32 noundef %t.1) #5
  br label %for.inc51

for.inc51:                                        ; preds = %for.end44, %if.then46
  %inc52 = add nsw i32 %2, 1
...
for.cond54:                                       ; preds = %for.inc80, %for.end53
  %l.0 = phi i32 [ 0, %for.end53 ], [ %l.3, %for.inc80 ]
  %5 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.end53 ]
  %cmp55 = icmp sle i32 %5, 122
...
if.then74:                                        ; preds = %for.end72
  ...
  %call78 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv77, i32 noundef %l.1) #5
  br label %for.inc80

for.inc80:                                        ; preds = %for.end72, %if.then74
  %l.3 = phi i32 [ 0, %if.then74 ], [ %l.1, %for.end72 ]
  %inc81 = add nsw i32 %5, 1
