...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  br i1 %exitcond8.not, label %for.end9, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv4, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax76 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax52 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv34 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next35, %for.inc27 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count37
  br i1 %exitcond38.not, label %for.cond31.preheader, label %for.cond2
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv34, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv29 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next30, %for.inc24 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond33.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv34, i64 %indvars.iv29
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv49 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next50, %for.inc67 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count37
  br i1 %exitcond54.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select27, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count
  br i1 %exitcond43.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv39, i64 %indvars.iv49
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select27 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  br label %for.cond36, !llvm.loop !20

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv44 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next45, %for.inc64 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond48.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv44, i64 %indvars.iv49
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count65 = zext nneg i32 %smax76 to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc92 ], [ 2, %for.end69 ]
  %exitcond66.not = icmp eq i64 %indvars.iv60, %wide.trip.count65
  br i1 %exitcond66.not, label %for.cond96.preheader, label %for.cond76.preheader
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv55 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next56, %for.inc89 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count
  br i1 %exitcond59.not, label %for.inc92, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv60, i64 %indvars.iv55
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv55
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv72 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next73, %for.inc117 ]
  %exitcond78.not = icmp eq i64 %indvars.iv72, %wide.trip.count65
  br i1 %exitcond78.not, label %for.end119, label %for.cond101.preheader

for.cond101.preheader:                            ; preds = %for.cond96
  %7 = add nsw i64 %indvars.iv72, -1
  br label %for.cond101

for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv67 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next68, %for.inc114 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count
  br i1 %exitcond71.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv67, i64 %indvars.iv72
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv67, i64 %7
...
for.inc9:                                         ; preds = %for.cond1
  ...
  %call.i3 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i, i8 noundef signext 10)
  %call1.i4 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i3)
  %call.i.i5 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i4)
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !54
