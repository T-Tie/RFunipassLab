...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc27
  %indvars.iv21 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next22, %for.inc27 ]
  %exitcond31 = icmp eq i64 %indvars.iv21, %wide.trip.count30
  br i1 %exitcond31, label %for.cond30, label %for.body4
...
for.cond9:                                        ; preds = %for.body4, %for.cond9.backedge
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.cond9.backedge ], [ %indvars.iv21, %for.body4 ]
...
for.body11:                                       ; preds = %for.cond9
  ...
  br i1 %cmp18, label %if.then19, label %for.cond9.backedge

for.cond9.backedge:                               ; preds = %for.body11, %if.then19
...
for.cond30:                                       ; preds = %for.cond2, %for.inc53
  %8 = phi i32 [ %.pre, %for.inc53 ], [ %0, %for.cond2 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc53 ], [ 0, %for.cond2 ]
  %b.0 = phi i32 [ %b.1, %for.inc53 ], [ 0, %for.cond2 ]
  %9 = sext i32 %8 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv32, %9
  br i1 %cmp32.not.not, label %for.body33, label %for.end55

for.body33:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv32
  %10 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %cmp36 = icmp ne i32 %10, 0
  %cmp37 = icmp eq i32 %b.0, 0
  %or.cond = select i1 %cmp36, i1 %cmp37, i1 false
  br i1 %or.cond, label %for.inc53.sink.split, label %if.end42

if.end42:                                         ; preds = %for.body33
  %cmp47 = icmp ne i32 %b.0, 0
  %or.cond1 = select i1 %cmp36, i1 %cmp47, i1 false
  br i1 %or.cond1, label %for.inc53.sink.split, label %for.inc53

for.inc53.sink.split:                             ; preds = %if.end42, %for.body33
  %.str.1.sink = phi ptr [ @.str, %for.body33 ], [ @.str.1, %if.end42 ]
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.1.sink, i32 noundef %10)
  br label %for.inc53

for.inc53:                                        ; preds = %for.inc53.sink.split, %if.end42
  %b.1 = phi i32 [ %b.0, %if.end42 ], [ 1, %for.inc53.sink.split ]
