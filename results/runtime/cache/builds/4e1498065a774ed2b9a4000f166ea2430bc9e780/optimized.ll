...
for.end13:                                        ; preds = %for.cond2
  %sub = sub nsw i32 %1, 1
  store i32 %sub, ptr %e, align 4, !tbaa !5
  br label %for.cond14
...
for.body46:                                       ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12)
  br label %for.inc50
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13)
