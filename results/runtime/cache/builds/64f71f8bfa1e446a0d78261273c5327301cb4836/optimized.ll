...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %m, %i.0
  %call = tail call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %i.0) #5
...
if.then10:                                        ; preds = %for.body7
  ...
  %call12 = tail call noundef i32 @_Z3funii(i32 noundef %div11, i32 noundef %i.1) #5
...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3funii(i32 noundef %2, i32 noundef 1) #7
...
for.cond3:                                        ; preds = %for.cond, %for.inc10
  ...
  %4 = sext i32 %3 to i64
  %cmp4 = icmp slt i64 %indvars.iv4, %4
  br i1 %cmp4, label %for.inc10, label %for.end12

for.inc10:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv4
