...
for.inc82:                                        ; preds = %if.else, %for.body70
  ...
  %10 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !15
  %call81 = call i32 (ptr, ...) @printf(ptr noundef %.str.2.sink, i32 noundef %10) #6
