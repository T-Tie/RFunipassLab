...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %2
  %call25 = call double @sqrt(double noundef %4) #11, !tbaa !5
  ...
  %call34 = call double @sqrt(double noundef %4) #11, !tbaa !5
...
if.end:                                           ; preds = %if.else46, %if.then42
  ...
  %call57 = call double @sqrt(double noundef %5) #11, !tbaa !5
  ...
  %call67 = call double @sqrt(double noundef %5) #11, !tbaa !5
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %11, double noundef %12)
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %11)
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %13, double noundef %14, double noundef %13, double noundef %15)
  br label %for.inc132
...
entry:
  ...
  %call = call double @sqrt(double noundef %conv) #11, !tbaa !5
  ret double %call
}
