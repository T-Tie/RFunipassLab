...
for.cond6:                                        ; preds = %for.cond, %for.inc51
  %7 = phi i32 [ %.pre11, %for.inc51 ], [ %5, %for.cond ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc51 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp7 = icmp slt i64 %indvars.iv8, %8
  br i1 %cmp7, label %for.body8, label %for.end53

for.body8:                                        ; preds = %for.cond6
  %9 = load i32, ptr %vla1, align 16, !tbaa !5
  %arrayidx11 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv8
  %10 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %mul = mul nsw i32 %10, %9
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv8
