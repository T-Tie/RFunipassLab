...
if.then:                                          ; preds = %for.body
  ...
  %call11 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %div) #8
  ...
  %call21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div20) #8
...
if.then28:                                        ; preds = %if.end
  ...
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div31) #8
...
if.then42:                                        ; preds = %if.then40
  ...
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div49) #8
  ...
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div58) #8
...
if.else:                                          ; preds = %if.then40
  ...
  %call71 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %div63, double noundef %div70) #8
  ...
  %call83 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %div75, double noundef %div82) #8
  br label %for.inc.sink.split
