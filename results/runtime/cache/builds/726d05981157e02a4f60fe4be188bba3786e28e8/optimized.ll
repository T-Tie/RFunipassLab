...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts2 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink) #9
...
for.end143:                                       ; preds = %for.cond113
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 676, ptr noundef nonnull %f2) #9
  call void @llvm.lifetime.end.p0(i64 noundef 676, ptr noundef nonnull %f1) #9
  ret i32 0
}
