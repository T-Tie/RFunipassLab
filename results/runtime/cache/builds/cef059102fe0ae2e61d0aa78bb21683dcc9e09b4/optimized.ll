...
if.then32:                                        ; preds = %for.body30
  ...
  %4 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !13
  br label %if.end37

if.end37:                                         ; preds = %if.then32, %for.body30
  %l2.2 = phi i32 [ 0, %if.then32 ], [ %l2.1, %for.body30 ]
  %min.2 = phi i32 [ %4, %if.then32 ], [ %min.1, %for.body30 ]
...
for.inc50:                                        ; preds = %if.end37, %land.lhs.true, %if.then44
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.2, %land.lhs.true ], [ %l2.2, %if.end37 ]
  %min.3 = phi i32 [ %5, %if.then44 ], [ %min.2, %land.lhs.true ], [ %min.2, %if.end37 ]
...
if.end63:                                         ; preds = %for.end59.thread, %if.then61, %for.end59
