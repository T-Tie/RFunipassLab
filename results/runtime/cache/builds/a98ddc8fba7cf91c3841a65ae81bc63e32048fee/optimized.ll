...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 captures(none) dereferenceable(10000) %a) #7
...
for.body:                                         ; preds = %for.cond
  ...
  call void @outlined_ir_func_0(i8 %5, ptr noundef nonnull dereferenceable(1) %__c.addr.i)
  br label %for.inc
...
for.body36:                                       ; preds = %for.cond33
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i3)
  call void @outlined_ir_func_0(i8 %7, ptr noundef nonnull dereferenceable(1) %__c.addr.i3)
  br label %for.inc40

for.inc40:                                        ; preds = %for.body36
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i3)
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  br label %for.cond33, !llvm.loop !15

for.end42:                                        ; preds = %for.cond33
  %vtable.i16 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !16
  %vbase.offset.ptr.i17 = getelementptr i8, ptr %vtable.i16, i64 -24
  %vbase.offset.i18 = load i64, ptr %vbase.offset.ptr.i17, align 8, !invariant.load !18
...
while.end48:                                      ; preds = %while.cond4
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull captures(none) %a) #8
  ret i32 0
}
...
define internal void @outlined_ir_func_0(i8 %0, ptr noundef nonnull dereferenceable(1) %1) #6 {
newFuncRoot:
...
for.body_to_outline:                              ; preds = %newFuncRoot
  ...
  %2 = load i64, ptr %gep53, align 8, !tbaa !28, !invariant.load !18
  %cmp.not.i = icmp eq i64 %2, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.body_to_outline
...
if.end.i:                                         ; preds = %for.body_to_outline
...
!19 = distinct !{!19, !9, !10}
!20 = !{!21, !6, i64 56}
!21 = !{!"_ZTSSt5ctypeIcE", !22, i64 0, !23, i64 16, !25, i64 24, !26, i64 32, !26, i64 40, !27, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
!22 = !{!"_ZTSNSt6locale5facetE", !12, i64 8}
...
!28 = !{!29, !30, i64 16}
!29 = !{!"_ZTSSt8ios_base", !30, i64 8, !30, i64 16, !31, i64 24, !32, i64 28, !32, i64 32, !33, i64 40, !34, i64 48, !6, i64 64, !12, i64 192, !35, i64 200, !36, i64 208}
!30 = !{!"long", !6, i64 0}
!31 = !{!"_ZTSSt13_Ios_Fmtflags", !6, i64 0}
!32 = !{!"_ZTSSt12_Ios_Iostate", !6, i64 0}
!33 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !24, i64 0}
!34 = !{!"_ZTSNSt8ios_base6_WordsE", !24, i64 0, !30, i64 8}
!35 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !24, i64 0}
!36 = !{!"_ZTSSt6locale", !37, i64 0}
!37 = !{!"p1 _ZTSNSt6locale5_ImplE", !24, i64 0}
