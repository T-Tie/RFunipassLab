...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.cond:                                         ; preds = %for.cond.cleanup18, %tailrecurse
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.cond.cleanup18 ], [ 0, %tailrecurse ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv32
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv32, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body19 ], [ 0, %for.cond16.preheader ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.cond.cleanup18, label %for.body19
...
for.body19:                                       ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv32, i64 %indvars.iv27
...
for.cond31:                                       ; preds = %for.cond, %for.cond.cleanup60
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond.cleanup60 ], [ 0, %for.cond ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count35
  br i1 %exitcond52.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv47
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select25, %for.body42 ], [ %3, %for.body34 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv37, i64 %indvars.iv47
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !14
  %spec.select25 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  br label %for.cond39, !llvm.loop !18

for.cond58:                                       ; preds = %for.cond58.preheader, %for.body61
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body61 ], [ 0, %for.cond58.preheader ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond46.not, label %for.cond.cleanup60, label %for.body61
...
for.body61:                                       ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv47
...
for.cond:                                         ; preds = %for.cond10, %entry
  %indvars.iv15 = phi i64 [ 1, %entry ], [ %indvars.iv.next16, %for.cond10 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count18
  br i1 %exitcond19.not, label %for.end27, label %for.body

for.body:                                         ; preds = %for.cond
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %arrayidx = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv.next16
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !14
  %arrayidx2 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv15
  store i32 %0, ptr %arrayidx2, align 4, !tbaa !5
  %arrayidx5 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next16
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !14
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv15
...
for.cond10:                                       ; preds = %for.body14, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond, label %for.body14, !llvm.loop !21

for.body14:                                       ; preds = %for.cond10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx20 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next16, i64 %indvars.iv.next
  %2 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !14
  %arrayidx24 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv
