...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %.sink3 = phi i32 [ 30, %for.body ], [ %dec, %for.inc ]
  %cmp2 = icmp sge i32 %.sink3, 0
  br i1 %cmp2, label %for.inc, label %for.inc8

for.inc:                                          ; preds = %for.cond1
  %idxprom = sext i32 %.sink3 to i64
...
land.end:                                         ; preds = %for.cond10
  ...
  %2 = load i8, ptr %arrayidx13, align 1, !tbaa !9, !invariant.load !10
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %.sink2 = phi i32 [ %.sink, %for.end19 ], [ %inc29, %for.inc28 ]
  %cmp21 = icmp slt i32 %.sink2, 31
  %sub31 = sub nsw i32 %.sink2, %.sink
