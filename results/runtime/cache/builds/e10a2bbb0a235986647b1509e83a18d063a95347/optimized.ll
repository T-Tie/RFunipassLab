...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %s_all) #10
  call void @llvm.lifetime.start.p0(i64 4, ptr %s_good) #10
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %all) #10
  call void @llvm.lifetime.start.p0(i64 4, ptr %good) #10
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %good) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %all) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %s_good) #10
  call void @llvm.lifetime.end.p0(i64 4, ptr %s_all) #10
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !42
  ret i64 %0
}
...
if.then15_to_outline:                             ; preds = %newFuncRoot
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
...
if.end.exitStub:                                  ; preds = %if.then15_to_outline
  ret void
}
