...
for.body13:                                       ; preds = %for.cond11
  ...
  %1 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !13
...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %i.1 = phi i32 [ %add, %for.end ], [ %inc14, %for.inc13 ]
...
for.body4:                                        ; preds = %for.cond2
  ...
  %0 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !13
  %idxprom7 = sext i32 %n to i64
  %arrayidx8 = getelementptr inbounds i32, ptr %a, i64 %idxprom7
  %1 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !13
...
for.end15:                                        ; preds = %for.cond2
  ...
  %2 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc30, %for.end15
  %i.2 = phi i32 [ %add, %for.end15 ], [ %inc31, %for.inc30 ]
