...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv18 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next19, %for.inc13 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv18
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv25 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next26, %for.inc44 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond31.not = icmp eq i32 %m.0, %smax30
  br i1 %exitcond31.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax27 = call i32 @llvm.smax.i32(i32 %indvars.iv25, i32 0)
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv22 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next23, %for.inc41 ]
  %exitcond29.not = icmp eq i64 %indvars.iv22, %wide.trip.count28
  br i1 %exitcond29.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv22
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next23
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv32 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next33, %for.inc55 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv32
