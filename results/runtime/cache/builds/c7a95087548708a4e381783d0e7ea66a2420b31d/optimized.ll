...
entry:
  ...
  %smax = call i32 @llvm.smax.i32(i32 %conv9, i32 noundef 1)
  %smax49 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %1 = add nuw i32 %smax49, 1
  %wide.trip.count50 = zext i32 %1 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc73 ], [ 1, %entry ]
  %exitcond51 = icmp eq i64 %indvars.iv44, %wide.trip.count50
  br i1 %exitcond51, label %for.end75, label %for.body
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select34, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext64 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext64, 32
  ...
  %spec.select34 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %invariant.gep38 = getelementptr i8, ptr %a, i64 -1
  %cmp51 = icmp slt i32 %conv9, %conv12
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  %8 = and i64 %indvars.iv44, 4294967295
  %gep = getelementptr i8, ptr %invariant.gep, i64 %7
  %add49 = add i64 %indvars.iv44, %call8
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %sext62 = shl i64 %add49, 32
  %9 = ashr exact i64 %sext62, 32
  %gep39 = getelementptr i8, ptr %invariant.gep38, i64 %7
  %10 = sub i32 %conv12, %conv9
  %smax52 = call i32 @llvm.abs.i32(i32 %10, i1 noundef false)
  %11 = add nuw i32 %smax52, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond53 = icmp eq i32 %j.1, %11
  br i1 %exitcond53, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv44, 4294967294
  %smax59 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
  %12 = add nuw i32 %smax59, 1
  %wide.trip.count60 = zext i32 %12 to i64
  br label %for.cond58
...
for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep38, i64 %indvars.iv.i
...
_Z4leftPcii.exit:                                 ; preds = %for.cond.i
  store i8 0, ptr %gep39, align 1, !tbaa !5
  br label %for.inc55

if.end50:                                         ; preds = %for.body45
  br i1 %cmp51, label %for.cond.i25, label %for.inc55

for.cond.i25:                                     ; preds = %if.end50, %for.inc.i28
  %indvars.iv.i26 = phi i64 [ %indvars.iv.next.i30, %for.inc.i28 ], [ %7, %if.end50 ]
  %cmp.not.i27 = icmp slt i64 %indvars.iv.i26, %8
  br i1 %cmp.not.i27, label %_Z5rightPcii.exit, label %for.inc.i28

for.inc.i28:                                      ; preds = %for.cond.i25
  %gep.i29 = getelementptr i8, ptr %invariant.gep38, i64 %indvars.iv.i26
  %14 = load i8, ptr %gep.i29, align 1, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i8, ptr %a, i64 %indvars.iv.i26
  store i8 %14, ptr %arrayidx2.i, align 1, !tbaa !5
  %indvars.iv.next.i30 = add nsw i64 %indvars.iv.i26, -1
  br label %for.cond.i25, !llvm.loop !8

_Z5rightPcii.exit:                                ; preds = %for.cond.i25
  store i8 0, ptr %gep, align 1, !tbaa !5
  br label %for.inc55

for.inc55:                                        ; preds = %if.end50, %_Z5rightPcii.exit, %_Z4leftPcii.exit
  %inc56 = add nuw i32 %j.1, 1
  br label %for.cond43, !llvm.loop !13

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv54 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next55, %for.inc68 ]
  %exitcond61 = icmp eq i64 %indvars.iv54, %wide.trip.count60
  br i1 %exitcond61, label %for.end75, label %for.inc68
...
for.inc68:                                        ; preds = %for.cond58
  ...
  %17 = add i64 %add64, %indvars.iv54
  %sext63 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext63, 32
