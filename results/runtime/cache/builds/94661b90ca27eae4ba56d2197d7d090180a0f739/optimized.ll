...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 captures(none) dereferenceable(41000) %word) #13
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(41000) %word, i8 noundef 0, i64 noundef 41000, i1 noundef false) #14
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  ...
  br i1 %cmp, label %if.then6.i, label %for.cond2

if.then6.i:                                       ; preds = %for.cond
  %vbase.offset9.i = load i64, ptr %vbase.offset.ptr8.i, align 8, !invariant.load !9
  %add.ptr10.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(41000) %word, i64 noundef 41000)
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %2 = add i64 %1, -41001
  %or.cond.i = icmp ult i64 %2, -41000
...
for.cond2:                                        ; preds = %for.cond, %if.end73
  %3 = phi i32 [ %.pre, %if.end73 ], [ %0, %for.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end73 ], [ 0, %for.cond ]
...
for.body4:                                        ; preds = %for.cond2
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #16
...
if.then:                                          ; preds = %for.body4
  ...
  %arrayidx23 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx23) #15
...
if.then33:                                        ; preds = %if.else
  ...
  %arrayidx38 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx38) #15
...
if.else42:                                        ; preds = %if.else
  ...
  %arrayidx49 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv
  br i1 %cmp43, label %if.then44, label %if.else58

if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx49) #15
  br label %if.end73.gvnsink.split

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx49) #15
  br label %if.end73.gvnsink.split

if.end73.gvnsink.split:                           ; preds = %if.then, %if.then44, %if.else58
  %idxprom67.pre-phi = phi i64 [ %idxprom19, %if.then ], [ %idxprom10, %if.then44 ], [ %idxprom10, %if.else58 ]
  %k.2 = phi i32 [ %inc18, %if.then ], [ %k.0, %if.then44 ], [ %k.0, %if.else58 ]
  %add66.sink = phi i32 [ %conv, %if.then ], [ %add, %if.then44 ], [ %add, %if.else58 ]
  %idxprom69 = sext i32 %add66.sink to i64
  %arrayidx70 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom67.pre-phi, i64 %idxprom69
  store i8 32, ptr %arrayidx70, align 1, !tbaa !21
  %inc71 = add nsw i32 %add66.sink, 1
  br label %if.end73

if.end73:                                         ; preds = %if.end73.gvnsink.split, %if.then33
  %j.1 = phi i32 [ %inc71, %if.end73.gvnsink.split ], [ 0, %if.then33 ]
  %k.1 = phi i32 [ %k.2, %if.end73.gvnsink.split ], [ %inc41, %if.then33 ]
...
for.end76:                                        ; preds = %for.cond2
  ...
  %cmp87 = icmp slt i32 %k.0, 0
  call void @llvm.assume(i1 %cmp87)
