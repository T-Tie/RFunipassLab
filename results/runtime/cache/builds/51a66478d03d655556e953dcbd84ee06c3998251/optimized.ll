...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv69 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next70, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv69 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv69
  br i1 %exitcond18.not, label %for.cond60, label %for.cond23

for.cond23:                                       ; preds = %for.cond19, %for.body26
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body26 ], [ 0, %for.cond19 ]
  %min.3 = phi i32 [ %min.4, %for.body26 ], [ %min.2, %for.cond19 ]
  %exitcond.not = icmp eq i64 %indvars.iv6, %indvars.iv69
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv6, 0
  %7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv6
  %8 = load i32, ptr %7, align 4, !tbaa !5, !invariant.load !13
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv9 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next10, %for.inc53 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %indvars.iv69
  br i1 %exitcond13.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv69
  br i1 %exitcond33.not, label %for.end108, label %for.cond65

for.cond65:                                       ; preds = %for.cond60, %for.body68
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body68 ], [ 0, %for.cond60 ]
  %min.6 = phi i32 [ %min.7, %for.body68 ], [ %min.5, %for.cond60 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv69
  br i1 %exitcond23.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv19, 0
  %11 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %12 = load i32, ptr %11, align 4, !tbaa !5, !invariant.load !13
  %13 = call i32 @llvm.smin.i32(i32 %min.6, i32 %12)
  %min.7 = select i1 %cmp69, i32 %12, i32 %13
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond65, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv24 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next25, %for.inc103 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv69
  br i1 %exitcond28.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
  %14 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !13
  %sub102 = sub nsw i32 %14, %min.6
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %indvars.iv69
  br i1 %exitcond43.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %indvars.iv69
  br i1 %exitcond38.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv34
  %16 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv39, i64 %indvars.iv34
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %indvars.iv69
  br i1 %exitcond49.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv44
  %17 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond55.not = icmp eq i64 %indvars.iv50, %indvars.iv69
  br i1 %exitcond55.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv50
  %19 = load i32, ptr %arrayidx157, align 4, !tbaa !5, !invariant.load !13
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %indvars.iv69
  br i1 %exitcond67.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %21 = add nsw i64 %indvars.iv62, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv56 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next57, %for.inc185 ]
  %exitcond61.not = icmp eq i64 %indvars.iv56, %indvars.iv69
  br i1 %exitcond61.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv62, i64 %indvars.iv56
  %22 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
  %23 = add nsw i64 %indvars.iv56, -1
