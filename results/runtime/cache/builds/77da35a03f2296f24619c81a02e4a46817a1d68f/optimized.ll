...
for.inc47:                                        ; preds = %for.cond39
  ...
  %8 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !13
...
for.end90:                                        ; preds = %for.cond53
  ...
  %18 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !13
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %19 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !13
  ...
  %21 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !23, !invariant.load !13
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !25, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !43, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !49, !invariant.load !13
  br label %return
