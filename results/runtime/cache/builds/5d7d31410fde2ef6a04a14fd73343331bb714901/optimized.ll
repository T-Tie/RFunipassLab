...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5, %for.cond1 ]
...
for.cond1.preheader:                              ; preds = %for.cond
  ...
  %3 = add i32 %2, -1
  %4 = trunc nuw i64 %indvars.iv.next5 to i32
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre8, %for.inc ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv4, i64 %indvars.iv
...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre9 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre9, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
