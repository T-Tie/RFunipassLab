...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.end ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %4 = phi i32 [ %.pre57, %for.body3 ], [ %0, %for.cond ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %if.end52
  %indvars.iv44 = phi i64 [ 1, %for.cond13.preheader ], [ %9, %if.end52 ]
  %x1.1 = phi i32 [ %x1.0, %for.cond13.preheader ], [ %x1.231, %if.end52 ]
  %y1.1 = phi i32 [ %y1.0, %for.cond13.preheader ], [ %y1.233, %if.end52 ]
  %x2.1 = phi i32 [ %x2.0, %for.cond13.preheader ], [ %x2.2, %if.end52 ]
  %y2.1 = phi i32 [ %y2.0, %for.cond13.preheader ], [ %y2.2, %if.end52 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  br i1 %cmp20, label %land.lhs.true, label %if.end52
...
if.end52:                                         ; preds = %for.body15, %land.lhs.true44, %land.lhs.true38
...
for.end58:                                        ; preds = %for.cond10
  ...
  %17 = shl i32 %sub61, 1
  %reass.sub84 = sub i32 %sub66, %17
  %add71 = add i32 %reass.sub84, 2
