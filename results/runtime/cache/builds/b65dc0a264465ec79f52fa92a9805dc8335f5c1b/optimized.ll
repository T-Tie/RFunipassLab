...
for.end:                                          ; preds = %for.cond
  %arrayidx.le = getelementptr inbounds [100 x [100 x i8]], ptr %c, i64 0, i64 %idxprom
  store i8 0, ptr %arrayidx2, align 1, !tbaa !5
  %cmp20 = icmp sgt i32 %j.0, 0
  br i1 %cmp20, label %for.cond19, label %for.end27

for.cond19:                                       ; preds = %for.end, %for.cond19
  %call25 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %arrayidx.le) #5
