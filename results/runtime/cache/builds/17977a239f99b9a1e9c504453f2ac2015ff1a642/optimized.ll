...
for.cond5:                                        ; preds = %for.inc19, %for.end
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv9, 0
  %indvars.iv.next10 = add nsw i64 %indvars.iv9, -1
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next10
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv9
...
for.inc19:                                        ; preds = %for.body7
  ...
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next10
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !13

for.end20.split.loop.exit:                        ; preds = %for.body7
  %6 = trunc nsw i64 %indvars.iv.next10 to i32
  br label %for.end20
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end47 ], [ %7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %cmp23 = icmp sgt i64 %indvars.iv15, -1
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv15
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv12 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next13, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %cmp30 = icmp sgt i64 %indvars.iv12, %indvars.iv15
...
land.lhs.true:                                    ; preds = %for.body31
  ...
  %spec.select5 = call i32 @llvm.smax.i32(i32 %10, i32 %sum.0)
  br label %for.inc45

for.inc45:                                        ; preds = %land.lhs.true, %for.body31
  %p.2 = phi i32 [ %p.1, %for.body31 ], [ %spec.select, %land.lhs.true ]
  %sum.1 = phi i32 [ %sum.0, %for.body31 ], [ %spec.select5, %land.lhs.true ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  %spec.select6 = select i1 %cmp48, i32 1, i32 %add53
  %arrayidx55 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv15
  store i32 %spec.select6, ptr %arrayidx55, align 4, !tbaa !5
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv18 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next19, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select7, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv18
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select7 = call i32 @llvm.smax.i32(i32 %11, i32 %sum.2)
