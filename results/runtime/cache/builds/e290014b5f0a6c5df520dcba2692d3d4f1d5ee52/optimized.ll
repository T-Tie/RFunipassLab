...
if.then:                                          ; preds = %for.body87
  ...
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %24)
  br label %if.end
...
if.else:                                          ; preds = %for.body87
  ...
  %sub99 = sub nsw i32 %22, 1
  %idxprom100 = sext i32 %sub99 to i64
  %arrayidx101 = getelementptr inbounds [100 x i32], ptr %arrayidx98, i64 0, i64 %idxprom100
  %25 = load i32, ptr %arrayidx101, align 4, !tbaa !5
  %call102 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %25)
  br label %if.end
