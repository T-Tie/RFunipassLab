...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr %num) #8
  call void @llvm.memset.p0.i64(ptr align 16 %num, i8 0, i64 80000, i1 false)
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %n)
  %call1 = call noundef double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 noundef -1)
  br label %for.cond
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %2
  %call25 = call double @sqrt(double noundef %4) #8, !tbaa !5
  ...
  %call34 = call double @sqrt(double noundef %4) #8, !tbaa !5
...
if.end:                                           ; preds = %if.else46, %if.then42
  ...
  %call57 = call double @sqrt(double noundef %5) #8, !tbaa !5
  ...
  %call67 = call double @sqrt(double noundef %5) #8, !tbaa !5
...
for.end134:                                       ; preds = %for.cond74
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr %num) #8
...
entry:
  ...
  %call = call double @sqrt(double noundef %conv) #8, !tbaa !5
  ret double %call
}
...
define available_externally i32 @getchar() local_unnamed_addr #7 {
entry:
