...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef nonnull align 16 dereferenceable(600) %input) #7
...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc18 ], [ 0, %entry ]
  %exitcond10 = icmp eq i64 %indvars.iv7, %2
  br i1 %exitcond10, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %3 = trunc i64 %call4 to i32
  %4 = add i32 %3, 1
  %5 = sub i32 %4, %0
  %wide.trip.count14 = zext i32 %5 to i64
  br label %for.cond21
...
for.inc:                                          ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv7
  ...
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv7, i64 %indvars.iv
  store i8 %7, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !11

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv7, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv11 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next12, %for.inc26 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond29.preheader, label %for.inc26
...
for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv11
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv16 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next17, %for.inc54 ]
  %exitcond23.not = icmp eq i64 %indvars.iv16, %wide.trip.count14
  br i1 %exitcond23.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv16
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv16
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv18 = phi i64 [ %indvars.iv16, %for.cond32.preheader ], [ %indvars.iv.next19, %for.inc51 ]
  %cmp33 = icmp samesign ult i64 %indvars.iv18, %8
  br i1 %cmp33, label %for.body34, label %for.inc54

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv18
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv18
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count14
  br i1 %exitcond28.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv24
  %11 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !10
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc89 ], [ 0, %if.else ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count14
  br i1 %exitcond33.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv29
  %12 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !10
  %cmp81 = icmp eq i32 %12, %max.0
  br i1 %cmp81, label %if.then82, label %for.inc89

if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv29
