...
for.cond52.preheader:                             ; preds = %for.cond36
  ...
  %wide.trip.count115 = zext nneg i32 %smax95 to i64
...
for.cond55:                                       ; preds = %for.cond52, %for.inc80
  ...
  %exitcond116.not = icmp eq i64 %indvars.iv110, %wide.trip.count115
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count132 = zext nneg i32 %smax95 to i64
  br label %for.cond96
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond133.not = icmp eq i64 %indvars.iv127, %wide.trip.count132
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond144.not, label %if.end178, label %for.inc148
