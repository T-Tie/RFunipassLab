...
for.inc73:                                        ; preds = %for.cond57
  ...
  %17 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  ...
  %18 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  ...
  %19 = load i32, ptr %arrayidx72, align 4, !tbaa !5, !invariant.load !17
...
for.body87:                                       ; preds = %for.cond85
  ...
  %26 = load i32, ptr %25, align 4, !tbaa !5, !invariant.load !17
  br i1 %cmp88, label %if.then, label %if.else

if.then:                                          ; preds = %for.body87
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %26) #5
  br label %for.inc103

if.else:                                          ; preds = %for.body87
  %call102 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %26) #5
  br label %for.inc103
