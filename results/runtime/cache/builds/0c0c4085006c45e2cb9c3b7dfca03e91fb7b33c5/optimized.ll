...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 201, ptr nonnull %a) #7
...
if.then:                                          ; preds = %while.body
  ...
  call void @outlined_ir_func_0(i8 %0, ptr %__c.addr.i)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit13: ; preds = %if.else
...
while.end14:                                      ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 201, ptr nonnull %a) #7
  ret i32 0
}
