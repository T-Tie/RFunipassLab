...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  %sub.sink1 = phi i32 [ %sub, %if.then35 ], [ %sub49, %for.inc48 ]
...
for.end53:                                        ; preds = %for.cond31
  ...
  %18 = load i32, ptr %b1, align 4, !tbaa !5
  %sub54 = sub nsw i32 %17, %18
  %add55 = add nsw i32 %sub54, 1
  %19 = load i32, ptr %a1, align 4, !tbaa !5
  %20 = load i32, ptr %a2, align 4, !tbaa !5
  %sub56 = sub nsw i32 %19, %20
