...
for.end:                                          ; preds = %for.cond
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEj(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %2)
  br label %if.end
...
for.cond6:                                        ; preds = %for.inc12, %for.body5
  %.sink6 = phi i32 [ 0, %for.body5 ], [ %inc13, %for.inc12 ]
  %cmp7 = icmp slt i32 %.sink6, 39
  br i1 %cmp7, label %for.inc12, label %for.end14

for.inc12:                                        ; preds = %for.cond6
  %idxprom = sext i32 %.sink6 to i64
...
for.cond39:                                       ; preds = %for.inc45, %while.end
  %.sink = phi i32 [ %7, %while.end ], [ %dec46, %for.inc45 ]
  %cmp40 = icmp sge i32 %.sink, 0
  br i1 %cmp40, label %for.inc45, label %if.end

for.inc45:                                        ; preds = %for.cond39
  %idxprom42 = sext i32 %.sink to i64
...
define available_externally noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEj(ptr noundef nonnull align 8 dereferenceable(8) %this, i32 noundef %__n) local_unnamed_addr #4 align 2 {
entry:
