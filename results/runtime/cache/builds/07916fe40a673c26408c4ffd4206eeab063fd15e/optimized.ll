...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(4000) %b, i8 0, i64 4000, i1 false)
...
for.cond10:                                       ; preds = %for.cond10.preheader, %if.else
  %indvars.iv42 = phi i64 [ %indvars.iv40, %for.cond10.preheader ], [ %indvars.iv.next43, %if.else ]
  %indvars.iv38 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next39, %if.else ]
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.body70
  %indvars.iv56 = phi i64 [ %indvars.iv54, %for.cond67.preheader ], [ %indvars.iv.next57, %for.body70 ]
