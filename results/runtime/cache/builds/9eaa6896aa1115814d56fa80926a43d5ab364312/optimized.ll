...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  ...
  br i1 %exitcond13.not, label %for.cond31.preheader, label %for.body
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc70
  %indvars.iv24 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next25, %for.inc70 ]
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv19 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next20, %for.inc67 ]
