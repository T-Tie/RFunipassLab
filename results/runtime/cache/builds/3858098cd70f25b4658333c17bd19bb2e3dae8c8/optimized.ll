...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !13
...
if.end:                                           ; preds = %entry
  ...
  %2 = load ptr, ptr %vfn, align 8, !invariant.load !40
...
if.end_after_outline.exitStub:
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !38
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !40
