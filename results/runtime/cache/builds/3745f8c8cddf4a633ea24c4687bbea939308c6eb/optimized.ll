...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc29
  %indvars.iv25 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next26, %for.inc29 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc27
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc27 ], [ %1, %for.cond3 ]
  %indvars.iv.next22 = add nsw i64 %indvars.iv21, -1
  %cmp8 = icmp sgt i64 %indvars.iv.next22, %indvars.iv25
  br i1 %cmp8, label %for.body10, label %for.inc29

for.body10:                                       ; preds = %for.cond7
  %2 = add nsw i64 %indvars.iv21, -2
  ...
  %arrayidx15 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %indvars.iv.next22
...
for.cond33:                                       ; preds = %for.cond3, %for.inc50
  %.pre32 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.cond3 ]
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc50 ], [ 0, %for.cond3 ]
  %cnt.0 = phi i32 [ %cnt.1, %for.inc50 ], [ 0, %for.cond3 ]
  %5 = sext i32 %.pre32 to i64
  %cmp34 = icmp slt i64 %indvars.iv29, %5
  br i1 %cmp34, label %for.body36, label %for.end52

for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw [500 x i32], ptr %num, i64 0, i64 %indvars.iv29
...
for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre32, %for.body36 ]
