...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv60.in = phi i64 [ %indvars.iv60, %for.end114 ], [ %2, %entry ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.end114 ], [ %2, %entry ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %indvars.iv60 = add i64 %indvars.iv60.in, -1
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv60, i64 noundef 1)
  %3 = trunc nuw i64 %indvars.iv53 to i32
  %smax50 = tail call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv55, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv55 to i32
  %smax34 = tail call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count13 = zext nneg i32 %smax34 to i64
  %wide.trip.count = and i64 %indvars.iv55, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv10 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next11, %for.inc28 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond31, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv10, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc25 ], [ 0, %for.cond14.preheader ]
...
for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv10, i64 %indvars.iv5
...
for.cond31:                                       ; preds = %for.cond, %for.inc66
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc66 ], [ 0, %for.cond ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count13
  br i1 %exitcond30.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select3, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv15, i64 %indvars.iv25
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %spec.select3 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond34, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc63 ], [ 0, %for.cond51.preheader ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv20, i64 %indvars.iv25
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc89 ], [ 1, %for.end68 ]
  %exitcond.not62 = icmp eq i64 %indvars.iv37, %smax
  br i1 %exitcond.not62, label %for.cond92.preheader, label %for.cond75
...
for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count13
  br i1 %exitcond36.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv37, i64 %indvars.iv31
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv37, i64 %indvars.iv31
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv47 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next48, %for.inc112 ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond46.not = icmp eq i64 %indvars.iv40, %indvars.iv53
  br i1 %exitcond46.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv47, i64 %indvars.iv.next41
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv47, i64 %indvars.iv40
