...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %p) #10
...
if.then:                                          ; preds = %land.lhs.true, %for.body
  ...
  %5 = load i8, ptr %arrayidx8, align 1, !tbaa !12
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %5)
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef align 8 %p) #10
  ret void
}
