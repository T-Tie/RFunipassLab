...
for.end30:                                        ; preds = %for.cond12
  %.lcssa = phi i32 [ %2, %for.cond12 ]
  %4 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp31 = icmp slt i32 %4, %.lcssa
...
if.end:                                           ; preds = %for.end30, %if.else
  %M.0 = phi i32 [ %4, %if.else ], [ %.lcssa, %for.end30 ]
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %cmp141, label %for.inc148, label %if.end178.loopexit
...
for.cond158:                                      ; preds = %for.inc170, %if.then156
  ...
  br i1 %cmp163, label %for.inc170, label %if.end178.loopexit16
...
if.end178.loopexit:                               ; preds = %for.cond137
  br label %if.end178

if.end178.loopexit16:                             ; preds = %for.cond158
  br label %if.end178

if.end178:                                        ; preds = %if.end178.loopexit16, %if.end178.loopexit
