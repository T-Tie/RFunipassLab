...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000000, ptr noundef align 16 %sz) #4
...
if.else:                                          ; preds = %land.lhs.true62, %for.end58
  %call73 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef 0) #5
  br label %if.end74

if.end74:                                         ; preds = %if.else, %if.then66
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4000000, ptr noundef %sz) #5
  ret i32 0
}
