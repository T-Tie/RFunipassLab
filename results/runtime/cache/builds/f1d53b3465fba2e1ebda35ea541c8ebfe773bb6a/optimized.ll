...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %0) #8
...
define dso_local noundef i32 @_Z5afteriii(i32 noundef %i, i32 noundef %fin, i32 noundef %n) #3 {
entry:
  %cmp = icmp eq i32 %i, %n
  ...
  %3 = load i32, ptr %2, align 4, !tbaa !5, !invariant.load !12
...
if.then11:                                        ; preds = %if.else5
  %call = call noundef i32 @_Z5afteriii(i32 noundef %add17, i32 noundef %i, i32 noundef %n) #8
  %add12 = add nsw i32 1, %call
  %call14 = call noundef i32 @_Z5afteriii(i32 noundef %add17, i32 noundef %fin, i32 noundef %n) #8
  %call15 = call noundef i32 @_Z3maxii(i32 noundef %add12, i32 noundef %call14) #8
  br label %return

if.else16:                                        ; preds = %if.else5
  %call18 = call noundef i32 @_Z5afteriii(i32 noundef %add17, i32 noundef %fin, i32 noundef %n) #8
  br label %return
...
define linkonce_odr dso_local noundef i32 @_Z3maxii(i32 noundef %a, i32 noundef %b) #6 comdat {
entry:
...
cond.end:                                         ; preds = %entry, %cond.false
  %b.addr.sink = phi ptr [ %b.addr, %cond.false ], [ %a.addr, %entry ]
  %0 = load i32, ptr %b.addr.sink, align 4, !tbaa !5
  ret i32 %0
}
