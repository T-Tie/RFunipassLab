...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %call1 = call i64 @strlen(ptr noundef @a) #6
...
if.end:                                           ; preds = %for.body, %if.then, %land.lhs.true12, %lor.lhs.false
...
if.then22:                                        ; preds = %for.end
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1) #7
  br label %if.end24
...
if.then31:                                        ; preds = %for.body27
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %5, i32 noundef %6) #7
  br label %if.end35
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %8, i32 noundef %9) #7
  br label %if.end49
...
attributes #5 = { minsize mustprogress nofree norecurse nosync nounwind optsize willreturn uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
