...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc135 ], [ %0, %entry ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc31 ], [ 0, %for.cond ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %indvars.iv63
  br i1 %exitcond21.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv17
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv17, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv12 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next13, %for.inc28 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %indvars.iv63
  br i1 %exitcond16.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv17, i64 %indvars.iv12
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %indvars.iv63
  br i1 %exitcond41.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %indvars.iv63
  br i1 %exitcond26.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv22, i64 %indvars.iv37
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv37
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select6, %for.body57 ], [ %6, %if.then51 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %indvars.iv63
  br i1 %exitcond31.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv27, i64 %indvars.iv37
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv32 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next33, %for.inc84 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %indvars.iv63
  br i1 %exitcond36.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv32, i64 %indvars.iv37
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %indvars.iv63
  br i1 %exitcond52.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %indvars.iv63
  br i1 %exitcond47.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv48, i64 %indvars.iv42
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv42, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv48, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %indvars.iv63
  br i1 %exitcond62.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep8 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv58
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv53 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next54, %for.inc129 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %indvars.iv63
  br i1 %exitcond57.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv53, i64 %indvars.iv58
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep9 = getelementptr [100 x i32], ptr %invariant.gep8, i64 %indvars.iv53
  store i32 %12, ptr %gep9, align 4, !tbaa !5
