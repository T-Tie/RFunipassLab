...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50000, ptr noundef nonnull align 16 dereferenceable(50000) %word) #9
...
for.body5:                                        ; preds = %for.cond3
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull %arrayidx7) #10
  %add = add i64 %call9, 1
...
for.inc40:                                        ; preds = %if.then, %if.end
  %sum.1 = phi i32 [ %conv11, %if.then ], [ 0, %if.end ]
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !13, !invariant.load !15
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !13, !invariant.load !15
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !15
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !16, !invariant.load !15
  ret i32 %0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !35, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !41, !invariant.load !15
  br label %return
