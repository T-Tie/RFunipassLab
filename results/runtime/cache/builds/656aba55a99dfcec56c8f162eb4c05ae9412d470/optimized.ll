...
if.then:                                          ; preds = %for.end
  %call16 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %z.0)
  br label %for.inc26
...
if.then21:                                        ; preds = %land.lhs.true
  %call22 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %z.0)
  br label %for.inc26

if.else23:                                        ; preds = %land.lhs.true, %if.else
  %call24 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %z.0)
  br label %for.inc26
