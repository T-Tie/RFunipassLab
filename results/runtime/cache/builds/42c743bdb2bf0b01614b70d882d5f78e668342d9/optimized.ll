...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv31 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next32, %for.inc44 ]
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax45 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 1)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc59 ], [ 1, %for.end49 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47.not, label %cleanup, label %for.inc59
