...
for.cond:                                         ; preds = %for.cond.preheader, %if.end
  %indvars.iv13 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next14, %if.end ]
...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv21, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body17
  ...
  br i1 %exitcond23.not, label %for.end27, label %for.body17
