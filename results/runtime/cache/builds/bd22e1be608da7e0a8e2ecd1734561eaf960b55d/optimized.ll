...
for.cond:                                         ; preds = %if.end30, %entry
  %5 = phi i32 [ %.pre, %if.end30 ], [ %3, %entry ]
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end30 ], [ 0, %entry ]
  %jn.0 = phi i32 [ %jn.1, %if.end30 ], [ 0, %entry ]
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv24, %6
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv24
...
for.cond10:                                       ; preds = %if.end, %if.then
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end ], [ %9, %if.then ]
  %10 = trunc nuw i64 %indvars.iv to i32
  %cmp11 = icmp sgt i32 %10, 1
  br i1 %cmp11, label %for.body13, label %if.end30

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv
  %11 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
...
if.end30:                                         ; preds = %for.cond10, %for.body
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body36
  %indvars.iv27 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next28, %for.body36 ]
  %exitcond.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond.not, label %for.end42, label %for.body36

for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv27
  %13 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !9
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %13) #7
...
for.end42:                                        ; preds = %for.cond33
  ...
  %14 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !9
  %call45 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %14) #7
