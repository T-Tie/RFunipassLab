...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv36 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next37, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv36, i32 1
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv40 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next41, %for.inc40 ]
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %4 = trunc nuw i64 %indvars.iv.next41 to i32
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next41
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc77
  %indvars.iv43 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next44, %for.inc77 ]
  %exitcond51.not = icmp eq i64 %indvars.iv43, %wide.trip.count50
  br i1 %exitcond51.not, label %for.end79, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv43, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc74
  %indvars.iv45 = phi i64 [ %indvars.iv43, %for.cond50.preheader ], [ %indvars.iv.next46, %for.inc74 ]
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %9 = trunc nuw i64 %indvars.iv.next46 to i32
...
for.body52:                                       ; preds = %for.cond50
  ...
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next46, i32 1
