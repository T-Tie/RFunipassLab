...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef %m) #4
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %m, i8 noundef 0, i64 noundef 100, i1 noundef false) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #4
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef align 16 %d) #4
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %d, i8 noundef 0, i64 noundef 100, i1 noundef false) #5
...
for.cond10:                                       ; preds = %for.inc34, %for.end9
  %4 = phi i32 [ %dec, %for.inc34 ], [ %sub, %for.end9 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %7 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !13
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %10 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !13
  %cmp25 = icmp sle i32 %9, %10
  br i1 %cmp25, label %if.then, label %for.inc31

if.then:                                          ; preds = %land.lhs.true
  %add28 = add nsw i32 %10, 1
...
for.end35:                                        ; preds = %for.cond10
  %11 = load i32, ptr %d, align 16, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc47, %for.end35
  %dm.0 = phi i32 [ %11, %for.end35 ], [ %dm.1, %for.inc47 ]
  %12 = load i32, ptr %i, align 4, !tbaa !5
  %cmp38 = icmp slt i32 %12, %1
...
for.body39:                                       ; preds = %for.cond37
  ...
  %13 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp sgt i32 %13, %dm.0
...
for.inc47:                                        ; preds = %for.body39, %if.then43
  %dm.1 = phi i32 [ %13, %if.then43 ], [ %dm.0, %for.body39 ]
  %inc48 = add nsw i32 %12, 1
  store i32 %inc48, ptr %i, align 4, !tbaa !5
  br label %for.cond37, !llvm.loop !16

for.end49:                                        ; preds = %for.cond37
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %dm.0)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %d) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #6
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %m) #6
