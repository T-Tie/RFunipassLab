...
if.then85:                                        ; preds = %land.lhs.true
  br label %for.inc122.gvnsink.split
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %6, i64 %indvars.iv38
...
for.inc122.gvnsink.split:                         ; preds = %if.else107, %if.then85
  %indvars.iv45.sink = phi i64 [ %indvars.iv45, %if.then85 ], [ %6, %if.else107 ]
  ...
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45.sink, i64 %11
