...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc8 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv19, %2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv
...
while.cond11:                                     ; preds = %for.cond, %for.end138
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.end138 ], [ %2, %for.cond ]
...
for.cond14.preheader:                             ; preds = %while.cond11
  %6 = trunc nsw i64 %indvars.iv69 to i32
  %smax66 = call i32 @llvm.smax.i32(i32 %6, i32 0)
  %wide.trip.count33 = zext nneg i32 %smax66 to i64
  %wide.trip.count = and i64 %indvars.iv69, 4294967295
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc49
  %indvars.iv30 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next31, %for.inc49 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33
  br i1 %exitcond34.not, label %for.cond52.preheader, label %for.body16

for.cond52.preheader:                             ; preds = %for.cond14
  %wide.trip.count38 = and i64 %indvars.iv69, 4294967295
  br label %for.cond52

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv30
  %7 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body22 ], [ 0, %for.body16 ]
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv22
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv25 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next26, %for.inc46 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv25
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc90
  %indvars.iv45 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next46, %for.inc90 ]
  %exitcond50.not = icmp eq i64 %indvars.iv45, %wide.trip.count33
  br i1 %exitcond50.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv45
  %10 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select15, %for.body60 ], [ %10, %for.body54 ]
...
for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv35, i64 %indvars.iv45
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  %spec.select15 = call i32 @llvm.smin.i32(i32 %min.2, i32 %11)
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  ...
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count38
  br i1 %exitcond44.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv40, i64 %indvars.iv45
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond59.not = icmp eq i64 %indvars.iv54, %wide.trip.count33
  br i1 %exitcond59.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc111 ], [ 1, %for.cond95 ]
  %cmp100 = icmp slt i64 %indvars.iv51, %indvars.iv.next70
  br i1 %cmp100, label %for.inc111, label %for.inc114

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv.next52
  %14 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv51
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count33
  br i1 %exitcond68.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc133 ], [ 1, %for.cond117 ]
  %cmp122 = icmp slt i64 %indvars.iv60, %indvars.iv.next70
  br i1 %cmp122, label %for.inc133, label %for.inc136

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next61, i64 %indvars.iv63
  %15 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !13
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv60, i64 %indvars.iv63
...
for.end138:                                       ; preds = %for.cond117
  ...
  %16 = trunc nsw i64 %indvars.iv.next70 to i32
