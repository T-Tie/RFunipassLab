...
if.then39:                                        ; preds = %if.end37
  ...
  %call50 = tail call double @sqrt(double noundef %19) #5, !tbaa !5
  ...
  %call65 = tail call double @sqrt(double noundef %26) #5, !tbaa !5
