...
for.end87:                                        ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %total1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year) #5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %m, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %total2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year) #5
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %3) unnamed_addr #3 {
for.body_to_outline:
  br label %for.cond2

for.cond2:                                        ; preds = %for.inc, %for.body_to_outline
  %.sink = phi i32 [ 1, %for.body_to_outline ], [ %inc, %for.inc ]
  %4 = phi i32 [ %inc, %for.inc ], [ 1, %for.body_to_outline ]
  store i32 %.sink, ptr %0, align 4, !tbaa !5
  %5 = load i32, ptr %1, align 4, !tbaa !5, !invariant.load !12
...
if.end26.thread:                                  ; preds = %if.end, %lor.lhs.false18, %lor.lhs.false20, %lor.lhs.false22
  br label %for.inc.gvnsink.split5
...
if.then28:                                        ; preds = %if.end26
  %7 = load i32, ptr %3, align 4, !tbaa !5, !invariant.load !12
  %rem = srem i32 %7, 4
...
for.inc.gvnsink.split:                            ; preds = %land.lhs.true, %lor.lhs.false32, %if.else
  %.sink1 = phi i32 [ 28, %if.else ], [ 29, %lor.lhs.false32 ], [ 29, %land.lhs.true ]
  br label %for.inc.gvnsink.split5

for.inc.gvnsink.split5:                           ; preds = %if.end26.thread, %for.inc.gvnsink.split
  %.sink1.sink = phi i32 [ %.sink1, %for.inc.gvnsink.split ], [ 30, %if.end26.thread ]
  %8 = load i32, ptr %2, align 4, !tbaa !5
  %add37 = add nsw i32 %8, %.sink1.sink
  store i32 %add37, ptr %2, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.inc.gvnsink.split5, %if.end26
  %inc = add nsw i32 %4, 1
