...
if.then42:                                        ; preds = %if.then40
  ...
  %.pre14 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  br label %if.end44

if.end44:                                         ; preds = %if.then42, %if.then40
  %8 = phi i32 [ %.pre14, %if.then42 ], [ %6, %if.then40 ]
...
for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre15, %for.body36 ]
