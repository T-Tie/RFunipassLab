...
for.cond67.preheader:                             ; preds = %for.cond63
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv30
  br label %for.cond67

for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc82
  %indvars.iv27 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next28, %for.inc82 ]
...
if.then:                                          ; preds = %for.body70
  %17 = load i32, ptr %arrayidx73, align 4, !tbaa !5, !invariant.load !15
