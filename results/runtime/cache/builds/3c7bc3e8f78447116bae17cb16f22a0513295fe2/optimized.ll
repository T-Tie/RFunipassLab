...
for.cond14:                                       ; preds = %sw.epilog, %if.then13
  %m.0 = phi i32 [ %a.1, %if.then13 ], [ %inc, %sw.epilog ]
  %x.1 = phi i32 [ 0, %if.then13 ], [ %add18, %sw.epilog ]
...
sw.epilog:                                        ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %sw.default, %sw.bb17
...
for.end:                                          ; preds = %for.cond14
  ...
  br i1 %cmp21, label %if.end52, label %if.else25
...
for.cond30:                                       ; preds = %sw.epilog39, %if.else29
  %m.1 = phi i32 [ %a.1, %if.else29 ], [ %inc41, %sw.epilog39 ]
  %x.4 = phi i32 [ 0, %if.else29 ], [ %add36, %sw.epilog39 ]
...
for.body32:                                       ; preds = %for.cond30
  switch i32 %m.1, label %sw.default37 [
    ...
    i32 3, label %sw.epilog39
    i32 5, label %sw.epilog39
    i32 7, label %sw.epilog39
    i32 8, label %sw.epilog39
    i32 10, label %sw.epilog39
    i32 12, label %sw.epilog39
    i32 2, label %sw.bb35
  ]
...
sw.epilog39:                                      ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.default37, %sw.bb35
...
for.end42:                                        ; preds = %for.cond30
  ...
  br i1 %cmp44, label %if.end52, label %if.else48

if.else48:                                        ; preds = %for.end42
  br label %if.end52

if.end52:                                         ; preds = %for.end42, %for.end, %if.else48, %if.else25
