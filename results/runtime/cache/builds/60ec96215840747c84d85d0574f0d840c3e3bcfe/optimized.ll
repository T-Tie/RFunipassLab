...
for.end15:                                        ; preds = %for.cond2
  %len.0.lcssa = phi i32 [ %len.0, %for.cond2 ]
  %cmp16 = icmp eq i32 %len.0.lcssa, 0
...
for.cond22:                                       ; preds = %for.inc44, %for.body21
  ...
  %sub23 = add i32 %len.0.lcssa, -1
  %i.2.neg = sub i32 0, %i.2
  %sub24 = add i32 %sub23, %i.2.neg
...
for.cond52:                                       ; preds = %for.inc59, %for.end49
  ...
  %cmp53 = icmp slt i32 %i.3, %len.0.lcssa
  br i1 %cmp53, label %for.inc59, label %cleanup.loopexit
