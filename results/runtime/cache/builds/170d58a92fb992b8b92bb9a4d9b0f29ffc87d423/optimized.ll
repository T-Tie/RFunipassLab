...
for.inc48:                                        ; preds = %for.cond15
  call fastcc void @outlined_ir_func_0(ptr %i2)
  br label %for.cond3
...
for.cond52:                                       ; preds = %for.inc66, %for.end50
  %9 = load i32, ptr %i51, align 4, !tbaa !5
  %10 = load i32, ptr %j, align 4, !tbaa !5
  %cmp53 = icmp slt i32 %9, %10
  br i1 %cmp53, label %for.body55, label %for.end68

for.body55:                                       ; preds = %for.cond52
  %sub56 = sub nsw i32 %10, 1
  %cmp57 = icmp slt i32 %9, %sub56
...
if.then58:                                        ; preds = %for.body55
  ...
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !9
  %call61 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11, i32 noundef 44)
  br label %for.inc66
...
if.else:                                          ; preds = %for.body55
  ...
  %12 = load i32, ptr %arrayidx63, align 4, !tbaa !5, !invariant.load !9
  %call64 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12)
  br label %for.inc66

for.inc66:                                        ; preds = %if.then58, %if.else
  call fastcc void @outlined_ir_func_0(ptr %i51)
  br label %for.cond52
