...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc27 ], [ 0, %tailrecurse ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv10
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv5
...
for.cond31:                                       ; preds = %for.cond, %for.inc70
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc70 ], [ 0, %for.cond ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count13
  br i1 %exitcond30.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv25
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select3, %for.body42 ], [ %3, %for.body34 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv15, i64 %indvars.iv25
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %spec.select3 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond39, !llvm.loop !17

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc67 ], [ 0, %for.cond58.preheader ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.inc70, label %for.inc67

for.inc67:                                        ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv25
