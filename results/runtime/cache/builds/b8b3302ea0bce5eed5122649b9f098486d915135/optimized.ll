...
for.cond43.preheader:                             ; preds = %for.cond8
  %smax21 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %2 = add i32 %smax21, 1
...
for.body10:                                       ; preds = %for.cond8
  ...
  %arrayidx16 = getelementptr inbounds nuw [500 x [40 x i8]], ptr %word, i64 0, i64 %indvars.iv13
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.body45
  %indvars.iv17 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next18, %for.body45 ]
  %exitcond23 = icmp eq i64 %indvars.iv17, %wide.trip.count22
  br i1 %exitcond23, label %for.end52, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [50 x [82 x i8]], ptr %para, i64 0, i64 %indvars.iv17
