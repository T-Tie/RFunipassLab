...
for.cond:                                         ; preds = %for.inc23, %entry
  %j.0 = phi i32 [ 0, %entry ], [ %inc24, %for.inc23 ]
  %s.0 = phi i32 [ 0, %entry ], [ %s.1, %for.inc23 ]
  %cmp = icmp sle i32 %j.0, 27
...
for.cond3:                                        ; preds = %for.inc, %for.body
  ...
  %count.1 = phi i32 [ 0, %for.body ], [ %count.2, %for.inc ]
...
for.end:                                          ; preds = %for.cond3
  %count.1.lcssa = phi i32 [ %count.1, %for.cond3 ]
  %cmp12 = icmp ne i32 %count.1.lcssa, 0
...
if.end22:                                         ; preds = %for.end
  ...
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv16, i32 noundef %count.1.lcssa) #10
  br label %for.inc23
...
for.end25:                                        ; preds = %for.cond
  ...
  %cmp26 = icmp eq i32 %s.0.lcssa, 28
