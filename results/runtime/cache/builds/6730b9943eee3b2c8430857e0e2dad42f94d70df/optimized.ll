...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv128 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc31 ], [ 0, %for.cond ]
  %exitcond86.not = icmp eq i64 %indvars.iv82, %indvars.iv128
  br i1 %exitcond86.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv82
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv128
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv82, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv77 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next78, %for.inc28 ]
  %exitcond81.not = icmp eq i64 %indvars.iv77, %indvars.iv128
  br i1 %exitcond81.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv82, i64 %indvars.iv77
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond106.not = icmp eq i64 %indvars.iv102, %indvars.iv128
  br i1 %exitcond106.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond91.not = icmp eq i64 %indvars.iv87, %indvars.iv128
  br i1 %exitcond91.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv87, i64 %indvars.iv102
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv102
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select71, %for.body57 ], [ %6, %if.then51 ]
  %exitcond96.not = icmp eq i64 %indvars.iv92, %indvars.iv128
  br i1 %exitcond96.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv92, i64 %indvars.iv102
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !9
  %spec.select71 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1
  br label %for.cond55, !llvm.loop !16

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv97 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next98, %for.inc84 ]
  %exitcond101.not = icmp eq i64 %indvars.iv97, %indvars.iv128
  br i1 %exitcond101.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv97, i64 %indvars.iv102
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond117.not = icmp eq i64 %indvars.iv113, %indvars.iv128
  br i1 %exitcond117.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond112.not = icmp eq i64 %indvars.iv107, %indvars.iv128
  br i1 %exitcond112.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv113, i64 %indvars.iv107
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !9
  %11 = add nsw i64 %indvars.iv107, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv113, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond127.not = icmp eq i64 %indvars.iv123, %indvars.iv128
  br i1 %exitcond127.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep73 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv123
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv118 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next119, %for.inc129 ]
  %exitcond122.not = icmp eq i64 %indvars.iv118, %indvars.iv128
  br i1 %exitcond122.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv118, i64 %indvars.iv123
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5, !invariant.load !9
  %gep74 = getelementptr [100 x i32], ptr %invariant.gep73, i64 %indvars.iv118
  store i32 %12, ptr %gep74, align 4, !tbaa !5
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 captures(none) dereferenceable(40000) %num) #8
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %ans) #8
...
for.cond:                                         ; preds = %for.inc16, %entry
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc16 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %num, i64 0, i64 %indvars.iv14, i64 %indvars.iv
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z2jzPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %num, i32 noundef %2) #9
  %arrayidx15 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv17
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc26 ], [ 0, %for.cond ]
  %7 = sext i32 %6 to i64
  %cmp20 = icmp slt i64 %indvars.iv20, %7
  br i1 %cmp20, label %for.inc26, label %for.end28

for.inc26:                                        ; preds = %for.cond19
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %ans, i64 0, i64 %indvars.iv20
...
for.end28:                                        ; preds = %for.cond19
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull captures(none) %num) #9
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !37, !invariant.load !9
