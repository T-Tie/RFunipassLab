...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z8DiJiTianii(i32 noundef %2, i32 noundef %3) #7
  %4 = load i32, ptr %m2, align 4, !tbaa !5
  %call3 = call noundef i32 @_Z8DiJiTianii(i32 noundef %2, i32 noundef %4) #7
...
if.then:                                          ; preds = %for.body
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #8
  br label %for.inc

if.else:                                          ; preds = %for.body
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #8
  br label %for.inc
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %result) #6
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %result) #6
  ret i32 %2
}
