...
for.cond6:                                        ; preds = %for.cond, %for.inc
  ...
  %1 = phi i32 [ %div, %for.inc ], [ 0, %for.cond ]
...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %for.cond29 ], [ 100, %for.cond ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv22
...
for.cond38.preheader:                             ; preds = %for.cond29
  %4 = zext i32 %indvars.iv25 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc45
  %indvars.iv27 = phi i64 [ %4, %for.cond38.preheader ], [ %6, %for.inc45 ]
...
for.inc45:                                        ; preds = %for.cond38
  ...
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %an, i64 0, i64 %6
