...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %x1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %x2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %x) #6
...
if.then7:                                         ; preds = %if.then
  ...
  store double %div12, ptr %x2, align 8, !tbaa !5
...
if.end17:                                         ; preds = %if.then16, %if.end
  %5 = load double, ptr %x1, align 8, !tbaa !5
  %6 = load double, ptr %x2, align 8, !tbaa !5
  %call18 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %5, double noundef %6)
  br label %if.end42

if.else:                                          ; preds = %if.then
  %mul20 = fmul double 2.000000e+00, %2
  %div21 = fdiv double %fneg, %mul20
  store double %div21, ptr %x1, align 8, !tbaa !5
...
if.end24:                                         ; preds = %if.then23, %if.else
  %7 = load double, ptr %x1, align 8, !tbaa !5
  %call25 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %7)
  br label %if.end42
...
if.else27:                                        ; preds = %while.body
  ...
  store double %div34, ptr %x, align 8, !tbaa !5
...
if.then39:                                        ; preds = %if.end37
  store double 0.000000e+00, ptr %x, align 8, !tbaa !5
  br label %if.end40

if.end40:                                         ; preds = %if.then39, %if.end37
  %8 = load double, ptr %x1, align 8, !tbaa !5
  %9 = load double, ptr %x, align 8, !tbaa !5
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %8, double noundef %9, double noundef %8, double noundef %9)
  br label %if.end42
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %x) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %x2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %x1) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %c) #7
