...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv20 = phi i64 [ %1, %for.cond.preheader ], [ %indvars.iv.next21, %for.inc ]
  %cmp1 = icmp sgt i64 %indvars.iv20, 0
  br i1 %cmp1, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond
  %indvars.iv.next21 = add nsw i64 %indvars.iv20, -1
  %arrayidx = getelementptr inbounds [40 x i32], ptr @a, i64 0, i64 %indvars.iv.next21
