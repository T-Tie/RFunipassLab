...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax15 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv3
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv10 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next11, %for.inc44 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond16.not = icmp eq i32 %m.0, %smax15
  br i1 %exitcond16.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax12 = call i32 @llvm.smax.i32(i32 %indvars.iv10, i32 0)
  %wide.trip.count13 = zext nneg i32 %smax12 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count20 = zext nneg i32 %smax15 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv7 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next8, %for.inc41 ]
  %exitcond14.not = icmp eq i64 %indvars.iv7, %wide.trip.count13
  br i1 %exitcond14.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv7
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next8
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv17 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next18, %for.inc55 ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count20
  br i1 %exitcond21.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv17
