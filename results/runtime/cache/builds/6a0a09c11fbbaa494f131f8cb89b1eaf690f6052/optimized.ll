...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond28.not, label %for.end33, label %for.cond13.preheader
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv19
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp eq i32 %5, 0
  br i1 %cmp20, label %for.end23.split.loop.exit32, label %for.inc21

for.inc21:                                        ; preds = %for.body15
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond13, !llvm.loop !13

for.end23.split.loop.exit32:                      ; preds = %for.body15
  %6 = trunc nuw nsw i64 %indvars.iv19 to i32
  br label %for.end23

for.end23:                                        ; preds = %for.cond13, %for.end23.split.loop.exit32
  %y1.2 = phi i32 [ %6, %for.end23.split.loop.exit32 ], [ %y1.0, %for.cond13 ]
  %x1.2 = phi i32 [ %4, %for.end23.split.loop.exit32 ], [ %x1.0, %for.cond13 ]
...
for.end50:                                        ; preds = %for.cond38, %for.body40
  %.lcssa = phi i32 [ -1, %for.cond38 ], [ %9, %for.body40 ]
  %y2.2 = phi i32 [ %y2.0, %for.cond38 ], [ %9, %for.body40 ]
  %x2.2 = phi i32 [ %x2.0, %for.cond38 ], [ %8, %for.body40 ]
  %idxprom53 = sext i32 %.lcssa to i64
...
for.end61:                                        ; preds = %for.end50, %for.cond34
  ...
  %add = xor i32 %y1.1, -1
  %sub63 = add i32 %y2.1, %add
  %add65 = xor i32 %x1.1, -1
  %sub66 = add i32 %x2.1, %add65
  %mul = mul nsw i32 %sub66, %sub63
