...
while.body:                                       ; preds = %while.cond
  ...
  %or.cond18 = select i1 %cmp3.not, i1 true, i1 %cmp4.not
  br i1 %or.cond18, label %if.end, label %if.then
...
if.end19:                                         ; preds = %if.then18, %if.end14
  ...
  %or.cond16 = and i1 %cmp20, %cmp22
  br i1 %or.cond16, label %if.then23, label %if.end29
