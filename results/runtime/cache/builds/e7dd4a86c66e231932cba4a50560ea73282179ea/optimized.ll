...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv21, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv27, %5
...
for.cond16:                                       ; preds = %for.cond12, %for.inc25
  ...
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv24, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv27, i64 %indvars.iv24
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax38 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax39 = call i32 @llvm.smax.i32(i32 %smax38, i32 0)
  %wide.trip.count40 = zext nneg i32 %smax39 to i64
  %wide.trip.count = zext nneg i32 %smax33 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond41.not = icmp eq i64 %indvars.iv34, %wide.trip.count40
  br i1 %exitcond41.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax45 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv34, i64 %indvars.iv30
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv55 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next56, %for.inc83 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count40
  br i1 %exitcond59.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond54.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond54.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv55, i64 %indvars.iv48
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv42 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next43, %for.inc77 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count46
  br i1 %exitcond47.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv42
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv42, i64 %indvars.iv48
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond64.not = icmp eq i64 %indvars.iv60, %wide.trip.count40
  br i1 %exitcond64.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv60
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax38 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count40
  br i1 %exitcond76.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv72
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax38, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax38, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv65 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next66, %for.inc112 ]
  %exitcond71.not = icmp eq i64 %indvars.iv65, %wide.trip.count
  br i1 %exitcond71.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv72, i64 %indvars.iv65
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv89 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre.pre-phi, %for.inc198 ]
  %exitcond96.not = icmp eq i64 %indvars.iv89, %wide.trip.count40
  br i1 %exitcond96.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv89
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv89, 0
  %or.cond16 = and i1 %or.cond, %cmp128
  br i1 %or.cond16, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv89
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax80 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
  %wide.trip.count81 = zext nneg i32 %smax80 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond82.not = icmp eq i64 %indvars.iv77, %wide.trip.count81
  br i1 %exitcond82.not, label %if.end178.loopexit99, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv89, i64 %indvars.iv77
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv89, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax86 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
  %wide.trip.count87 = zext nneg i32 %smax86 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond88.not = icmp eq i64 %indvars.iv83, %wide.trip.count87
  br i1 %exitcond88.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv89, i64 %indvars.iv83
...
if.end178.loopexit99:                             ; preds = %for.cond137
  %.pre100 = add nuw nsw i64 %indvars.iv89, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit99
  %.pre.pre-phi = phi i64 [ %.pre100, %if.end178.loopexit99 ], [ %20, %for.cond158 ]
  %cmp180.not = icmp eq i64 %indvars.iv89, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv89, 2
