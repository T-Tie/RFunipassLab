...
if.then15:                                        ; preds = %for.end13
  ...
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) %add.ptr16, i32 noundef %n, i32 noundef %sub17) #5
  br label %if.end18
...
if.then18:                                        ; preds = %for.end16
  ...
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) %add.ptr19, i32 noundef %n, i32 noundef %sub20) #5
  br label %if.end21
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #4
...
for.cond14:                                       ; preds = %for.inc63, %for.end12
  ...
  %6 = phi i32 [ %dec, %for.inc63 ], [ %3, %for.end12 ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %7, i32 noundef %7) #6
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %7, i32 noundef %7) #6
...
for.inc34:                                        ; preds = %for.cond22
  ...
  %12 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !17
...
for.cond40:                                       ; preds = %for.inc60, %for.end39
  ...
  %sub41 = sub nsw i32 %7, 1
  %cmp42 = icmp slt i32 %13, %sub41
...
for.inc57:                                        ; preds = %for.cond44
  ...
  %15 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !17
...
for.inc66:                                        ; preds = %for.cond14
  ...
  %call65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %16)
  %inc67 = add nsw i32 %0, 1
  store i32 %inc67, ptr %i, align 4, !tbaa !5
  br label %for.cond, !llvm.loop !23

for.end68:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %h) #6
