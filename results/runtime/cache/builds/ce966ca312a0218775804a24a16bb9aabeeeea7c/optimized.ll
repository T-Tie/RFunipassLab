...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull dereferenceable(41000) %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %b) #9
...
for.cond10:                                       ; preds = %for.cond, %for.inc44
  %4 = phi i32 [ %.pre, %for.inc44 ], [ %0, %for.cond ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc44 ], [ 0, %for.cond ]
  %num.0 = phi i32 [ %add43, %for.inc44 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp11 = icmp slt i64 %indvars.iv23, %5
  br i1 %cmp11, label %for.body12, label %for.end46

for.body12:                                       ; preds = %for.cond10
  %arrayidx14 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv23
  %6 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !9
  %add = add nsw i32 %6, %num.0
  %cmp17 = icmp eq i32 %num.0, 0
  br i1 %cmp17, label %if.end, label %if.end.thread

if.end:                                           ; preds = %for.body12
  %arrayidx19 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %a, i64 0, i64 %indvars.iv23
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx19)
  %cmp22 = icmp slt i32 %add, 81
  br i1 %cmp22, label %for.inc44, label %if.then34

if.end.thread:                                    ; preds = %for.body12
  %cmp2226 = icmp slt i32 %add, 81
  br i1 %cmp2226, label %if.then26, label %if.then34
...
for.inc44.sink.split:                             ; preds = %if.then34, %if.then26
  %call27.sink = phi ptr [ %call27, %if.then26 ], [ @_ZSt4cout, %if.then34 ]
  %num.1.ph = phi i32 [ %add, %if.then26 ], [ %6, %if.then34 ]
  %arrayidx29 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %a, i64 0, i64 %indvars.iv23
  %call31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call27.sink, ptr noundef nonnull %arrayidx29)
  br label %for.inc44
