...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %.sink3 = phi i32 [ 1, %for.end29 ], [ %inc49, %for.inc48 ]
  store i32 %.sink3, ptr %i, align 4, !tbaa !5
  %cmp31 = icmp sle i32 %.sink3, 12
...
for.cond33:                                       ; preds = %for.inc45, %for.body32
  ...
  %sub34 = sub nsw i32 %.sink3, 1
  %cmp35 = icmp sle i32 %4, %sub34
...
for.inc45:                                        ; preds = %for.cond33
  ...
  %idxprom39 = sext i32 %.sink3 to i64
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %.sink4 = phi i32 [ 1, %for.end50 ], [ %inc80, %for.inc79 ]
  store i32 %.sink4, ptr %i, align 4, !tbaa !5
  %cmp52 = icmp sle i32 %.sink4, 12
...
for.cond55:                                       ; preds = %for.inc76, %for.body53
  ...
  %6 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add54 = add nsw i32 %6, 1
...
if.then70:                                        ; preds = %for.end67
  %idxprom71 = sext i32 %.sink4 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %.sink6 = phi i32 [ 1, %for.end91 ], [ %inc111, %for.inc110 ]
  store i32 %.sink6, ptr %i, align 4, !tbaa !5
  %cmp93 = icmp sle i32 %.sink6, 12
...
for.body115:                                      ; preds = %for.cond113
  ...
  %14 = load i32, ptr %year, align 4, !tbaa !5
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %14)
  %cmp118 = icmp eq i32 %call117, 1
  %15 = load i32, ptr %mon1, align 4, !tbaa !5
  %16 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom120 = sext i32 %15 to i64
  %idxprom122 = sext i32 %16 to i64
...
if.then119:                                       ; preds = %for.body115
  ...
  %17 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %cmp124 = icmp eq i32 %17, 1
...
if.else129:                                       ; preds = %for.body115
  ...
  %18 = load i32, ptr %arrayidx133, align 4, !tbaa !5
  %cmp134 = icmp eq i32 %18, 1
