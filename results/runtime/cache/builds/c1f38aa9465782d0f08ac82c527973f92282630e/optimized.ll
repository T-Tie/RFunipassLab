...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef nonnull %c) #7
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef nonnull %input) #7
