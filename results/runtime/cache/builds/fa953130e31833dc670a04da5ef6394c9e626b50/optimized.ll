...
for.inc8:                                         ; preds = %for.cond2
  %call5 = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %i.1, i32 noundef %.lcssa) #7
...
for.end21:                                        ; preds = %for.cond11
  %t.0.lcssa = phi i32 [ %t.0, %for.cond11 ]
  %call22 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %t.0.lcssa) #7
...
for.end32:                                        ; preds = %for.cond20
  %t.0.lcssa = phi i32 [ %t.0, %for.cond20 ]
  %add33 = add nsw i32 %t.0.lcssa, 1
  br label %cleanup
