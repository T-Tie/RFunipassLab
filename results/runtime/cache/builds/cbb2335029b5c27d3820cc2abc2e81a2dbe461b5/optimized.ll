...
if.then37:                                        ; preds = %if.end35.thread, %if.end35
  %s.1 = phi i32 [ 0, %if.end35.thread ], [ %s.0, %if.end35 ]
...
for.inc47:                                        ; preds = %if.end35, %if.then37
  %s.2 = phi i32 [ %s.1, %if.then37 ], [ %s.0, %if.end35 ]
  %add45 = add i32 %s.2, 1
  %add46 = add i32 %add45, %5
...
do.end:                                           ; preds = %entry
  ...
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !13
...
if.then6:                                         ; preds = %if.else
  ...
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !13
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !13
...
if.then28:                                        ; preds = %if.then19
  ...
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !13
