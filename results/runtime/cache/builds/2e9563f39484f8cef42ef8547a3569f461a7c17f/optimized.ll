...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax94 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %smax70 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv67 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next68, %for.inc60 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv62 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next63, %for.inc57 ]
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond84.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv90 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next91, %for.inc104 ]
