...
while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %while.body ], [ 0, %entry ]
...
for.cond:                                         ; preds = %for.cond.preheader, %if.end
  %indvars.iv21 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next22, %if.end ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv21
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %3 = trunc nuw nsw i64 %indvars.iv21 to i32
...
for.cond15:                                       ; preds = %for.cond15.preheader, %if.end34
  %indvars.iv33 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next34, %if.end34 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count
  br i1 %exitcond38.not, label %for.end37, label %for.cond18

for.cond18:                                       ; preds = %for.cond15, %for.body20
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body20 ], [ 0, %for.cond15 ]
  %sum.0 = phi i32 [ %add, %for.body20 ], [ 0, %for.cond15 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end28, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100000 x i32], ptr %b, i64 0, i64 %indvars.iv27
  %4 = load i32, ptr %arrayidx22, align 4, !tbaa !12, !invariant.load !11
  %5 = zext i32 %4 to i64
  %cmp23.not = icmp eq i64 %indvars.iv33, %5
  %spec.select = zext i1 %cmp23.not to i32
  %add = add nuw nsw i32 %spec.select, %sum.0
...
if.then30:                                        ; preds = %for.end28
  %arrayidx32 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv33
