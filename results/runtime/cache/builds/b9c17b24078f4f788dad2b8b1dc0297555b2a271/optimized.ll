...
if.then6.i9:                                      ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %call16.i19 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i18) #10
  %3 = add i64 %2, -1001
...
if.then19.i24:                                    ; preds = %if.then6.i9
  ...
  %call24.i29 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i28) #10
...
if.end75:                                         ; preds = %land.lhs.true, %for.body, %for.end65, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit40, %if.else71
  ...
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink) #10
