...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc48
  %indvars.iv15 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next16, %for.inc48 ]
  %j.0 = phi i32 [ 0, %for.cond3.preheader ], [ %j.1, %for.inc48 ]
  %exitcond21.not = icmp eq i64 %indvars.iv15, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond52.preheader, label %for.body6

for.cond52.preheader:                             ; preds = %for.cond3
  %sub56 = add nsw i32 %j.0, -1
  %2 = sext i32 %sub56 to i64
  %smax26 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond52

for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv15
...
if.end:                                           ; preds = %if.then, %for.body6
  ...
  %smax13 = call i32 @llvm.smax.i32(i32 %j.1, i32 0)
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc45, %if.end
  %indvars.iv11.in = phi i32 [ %indvars.iv11, %for.inc45 ], [ %j.1, %if.end ]
  %p.0 = phi i32 [ %inc46, %for.inc45 ], [ 0, %if.end ]
  %indvars.iv11 = add i32 %indvars.iv11.in, -1
  %exitcond14.not = icmp eq i32 %p.0, %smax13
  br i1 %exitcond14.not, label %for.inc48, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond15
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv11, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc42
  %indvars.iv8 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next9, %for.inc42 ]
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond.not, label %for.inc45, label %for.body24

for.body24:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv8
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv.next9
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc66
  %indvars.iv22 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next23, %for.inc66 ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end68, label %for.body55

for.body55:                                       ; preds = %for.cond52
  %cmp57 = icmp slt i64 %indvars.iv22, %2
  %arrayidx60 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv22
