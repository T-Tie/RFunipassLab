...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call noundef i32 @_Z8DiJiTianii(i32 noundef %2, i32 noundef %4) #6
  %sub = sub nsw i32 %call2, %call3
  %5 = call i32 @llvm.abs.i32(i32 %sub, i1 noundef true)
  %rem = srem i32 %5, 7
...
for.inc.gvnsink.split:                            ; preds = %if.else33, %land.lhs.true, %if.then24, %if.else, %lor.lhs.false14, %lor.lhs.false16, %lor.lhs.false18, %for.body, %lor.lhs.false, %lor.lhs.false3, %lor.lhs.false5, %lor.lhs.false7, %lor.lhs.false9, %lor.lhs.false11
  ...
  %0 = load i32, ptr %result, align 4, !tbaa !5
  %add34 = add nsw i32 %0, %.sink1.sink
