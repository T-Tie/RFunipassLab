...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 5000, ptr noundef nonnull align 16 dereferenceable(5000) %str1) #6
...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count20 = zext nneg i32 %smax19 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv10
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc ], [ %1, %if.then9 ]
...
for.inc:                                          ; preds = %for.cond17
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv7
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv14 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next15, %for.inc44 ]
  %exitcond21.not = icmp eq i64 %indvars.iv14, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv14, %2
  ...
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv14
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond26.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv22
