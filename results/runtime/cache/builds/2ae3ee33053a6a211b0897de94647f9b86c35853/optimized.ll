...
for.cond:                                         ; preds = %for.inc23, %entry
  ...
  %exitcond21.not = icmp eq i64 %indvars.iv18, 28
  br i1 %exitcond21.not, label %for.end25, label %for.cond3.preheader

for.cond3.preheader:                              ; preds = %for.cond
  %arrayidx9 = getelementptr inbounds nuw [27 x i8], ptr @__const.main.zimu, i64 0, i64 %indvars.iv18
  br label %for.cond3
