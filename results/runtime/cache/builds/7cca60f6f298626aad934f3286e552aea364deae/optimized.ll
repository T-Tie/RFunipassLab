...
for.cond172:                                      ; preds = %for.inc197, %if.then171
  %34 = phi i32 [ %inc198, %for.inc197 ], [ 0, %if.then171 ]
  %cmp173 = icmp slt i32 %34, 6
...
for.inc197:                                       ; preds = %for.cond172
  ...
  %35 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  ...
  store i8 %35, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds [6 x i8], ptr %arrayidx167, i64 0, i64 %idxprom177
  %36 = load i8, ptr %arrayidx185, align 1, !tbaa !9
  store i8 %36, ptr %arrayidx178, align 1, !tbaa !9
  %37 = load i8, ptr %arrayidx181, align 1, !tbaa !9
  store i8 %37, ptr %arrayidx185, align 1, !tbaa !9
  %inc198 = add nsw i32 %34, 1
  br label %for.cond172, !llvm.loop !21

for.inc201:                                       ; preds = %for.body161, %for.cond172
  %inc202 = add nsw i32 %31, 1
