...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc77
  %indvars.iv9 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next10, %for.inc77 ]
  %exitcond17.not = icmp eq i64 %indvars.iv9, %wide.trip.count16
  br i1 %exitcond17.not, label %for.end79, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv9, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc74
  %indvars.iv11 = phi i64 [ %indvars.iv9, %for.cond50.preheader ], [ %indvars.iv.next12, %for.inc74 ]
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %9 = trunc nuw i64 %indvars.iv.next12 to i32
  %cmp51 = icmp sgt i32 %0, %9
  br i1 %cmp51, label %for.body52, label %for.inc77

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next12, i32 1
