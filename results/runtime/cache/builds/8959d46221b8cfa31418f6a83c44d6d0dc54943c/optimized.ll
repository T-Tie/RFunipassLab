...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %count) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(80000) %count, i8 0, i64 80000, i1 false)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx5 = getelementptr inbounds [20000 x i32], ptr %count, i64 0, i64 %idxprom4
...
for.inc.sink.split:                               ; preds = %for.body, %if.then13
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %2)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %count) #5
