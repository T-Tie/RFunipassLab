...
for.end13:                                        ; preds = %for.cond2
  %n.0.lcssa = phi i32 [ %n.0, %for.cond2 ]
...
for.end41:                                        ; preds = %for.cond14
  %sub42 = sub nsw i32 %.lcssa, %n.0.lcssa
  br label %for.cond43
...
for.end52:                                        ; preds = %for.cond43
  %sub44.lcssa = phi i32 [ %sub44, %for.cond43 ]
  %idxprom54 = sext i32 %sub44.lcssa to i64
