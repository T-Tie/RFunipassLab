...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %word) #7
...
while.cond:                                       ; preds = %while.cond.preheader, %if.end10
  ...
  br i1 %cmp1, label %while.body, label %while.end.split.loop.exit24
...
if.then:                                          ; preds = %while.body
  ...
  %3 = load i64, ptr %gep, align 8, !tbaa !9, !invariant.load !8
...
if.end10:                                         ; preds = %if.else.i
  ...
  %call14 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx12) #9
  %conv15 = trunc i64 %call14 to i32
  br label %while.cond, !llvm.loop !21

while.end.split.loop.exit24:                      ; preds = %while.cond
  %4 = trunc nsw i64 %indvars.iv to i32
  br label %while.end

while.end:                                        ; preds = %if.else.i, %while.end.split.loop.exit24
  %i.2 = phi i32 [ %4, %while.end.split.loop.exit24 ], [ %number, %if.else.i ]
  ...
  br i1 %cmp17.not, label %for.cond, label %for.end, !llvm.loop !24
...
entry:
  ...
  store i32 0, ptr %number, align 4, !tbaa !25
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull %word) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(25000) %word, i8 noundef 0, i64 noundef 25000, i1 noundef false)
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %1 = load i32, ptr %number, align 4, !tbaa !25
  %2 = sext i32 %1 to i64
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %number) #8
  ret i32 0
}
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !43, !invariant.load !8
...
!29 = !{!30, !34, i64 240}
!30 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0, !31, i64 216, !6, i64 224, !32, i64 225, !33, i64 232, !34, i64 240, !35, i64 248, !36, i64 256}
