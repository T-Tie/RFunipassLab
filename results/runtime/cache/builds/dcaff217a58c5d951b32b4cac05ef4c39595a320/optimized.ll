...
for.inc86:                                        ; preds = %for.cond75
  ...
  %5 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !9
...
for.inc109:                                       ; preds = %for.cond96
  ...
  %6 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !9
...
for.end114:                                       ; preds = %for.cond92
  %call = call noundef i32 @_Z3calPA120_ii(ptr nofree noundef captures(none) %matrix, i32 noundef %sub72) #4
...
for.end17:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 57600, ptr noundef %a) #6
