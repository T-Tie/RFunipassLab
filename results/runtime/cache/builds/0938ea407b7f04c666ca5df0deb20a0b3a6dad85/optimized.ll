...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef nonnull %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull %b) #8
...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #9
...
for.body25:                                       ; preds = %for.cond23
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr27) #8
...
for.end33:                                        ; preds = %for.cond23
  ...
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %gep87) #8
...
for.body48:                                       ; preds = %for.cond45
  ...
  %call.i.i22 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr50) #8
...
for.end56:                                        ; preds = %for.cond45
  ...
  %call.i.i44 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr59) #8
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %b) #8
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef nonnull %a) #8
