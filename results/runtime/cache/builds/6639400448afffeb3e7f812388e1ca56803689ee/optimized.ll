...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %an) #8
...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv16
...
for.cond38:                                       ; preds = %for.cond29, %for.inc45
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc45 ], [ %indvars.iv16, %for.cond29 ]
  %cmp39 = icmp sgt i64 %indvars.iv19, 0
  br i1 %cmp39, label %for.inc45, label %if.end49

for.inc45:                                        ; preds = %for.cond38
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, -1
  %arrayidx43 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv.next20
...
if.end49:                                         ; preds = %for.cond38, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %an) #8
