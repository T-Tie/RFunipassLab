...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %smax27 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.end.thread:                                   ; preds = %for.cond2
  %cmp617 = icmp sgt i32 %index.0, -1
  br i1 %cmp617, label %if.then7, label %for.inc12
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc21
  %indvars.iv24 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next25, %for.inc21 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count28
  br i1 %exitcond29.not, label %for.end23, label %for.inc21

for.inc21:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [1000 x i32], ptr %result, i64 0, i64 %indvars.iv24
