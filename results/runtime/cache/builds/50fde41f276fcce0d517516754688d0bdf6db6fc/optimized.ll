...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %number) #5
...
land.lhs.true:                                    ; preds = %lor.lhs.false23, %lor.lhs.false18, %lor.lhs.false, %for.body
  ...
  %3 = load i8, ptr %arrayidx29, align 1, !tbaa !9, !invariant.load !10
  %conv30 = sext i8 %3 to i32
...
for.cond50:                                       ; preds = %for.inc66, %for.end
  ...
  %idxprom51 = sext i32 %5 to i64
  %arrayidx52 = getelementptr inbounds [501 x i8], ptr %a, i64 0, i64 %idxprom51
  %6 = load i8, ptr %arrayidx52, align 1, !tbaa !9, !invariant.load !10
...
for.body55:                                       ; preds = %for.cond50
  ...
  %7 = load i8, ptr %arrayidx60, align 1, !tbaa !9, !invariant.load !10
  %conv61 = sext i8 %7 to i32
...
for.end68:                                        ; preds = %for.cond50
  ...
  %conv69 = sitofp i32 %9 to double
  %conv72 = uitofp i64 %call5 to double
  %10 = load double, ptr %percent, align 8, !tbaa !15
  %mul = fmul double %conv72, %10
