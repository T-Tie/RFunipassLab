...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax61 = call i32 @llvm.smax.i32(i32 %indvars.iv24, i32 1)
...
for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count40 = zext i32 %n.tr to i64
  br label %for.cond27
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %result) #6
