...
for.cond8:                                        ; preds = %for.inc31, %for.end
  ...
  %8 = sext i32 %7 to i64
  %cmp10.not.not = icmp slt i64 %indvars.iv9, %8
  br i1 %cmp10.not.not, label %for.body11, label %for.end33

for.body11:                                       ; preds = %for.cond8
  %arrayidx13 = getelementptr inbounds nuw float, ptr %vla1, i64 %indvars.iv9
  %9 = load float, ptr %arrayidx13, align 4, !tbaa !12
  %arrayidx15 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv9
...
for.inc31:                                        ; preds = %for.body11, %if.else, %if.else27
  ...
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str.2.sink.sink)
