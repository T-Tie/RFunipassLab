...
entry:
  ...
  %mm2 = alloca i8, i32 0, align 4
  %mm1 = alloca i8, i32 0, align 4
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %dm) #4
...
for.cond13:                                       ; preds = %for.inc31, %for.body12
  %.sink = phi i32 [ %5, %for.body12 ], [ %6, %for.inc31 ]
...
for.end35:                                        ; preds = %for.cond10
  ...
  store i32 %11, ptr %dm, align 4, !tbaa !5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37
...
for.end49:                                        ; preds = %for.cond37
  %15 = load i32, ptr %dm, align 4, !tbaa !5
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %15)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %dm) #6
