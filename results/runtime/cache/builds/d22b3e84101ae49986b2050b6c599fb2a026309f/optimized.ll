...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41, ptr nonnull %word) #6
...
if.then:                                          ; preds = %for.body
  ...
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
...
if.else:                                          ; preds = %for.body
  ...
  %call12 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 41, ptr nonnull %word) #6
