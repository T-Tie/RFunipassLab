...
while.cond:                                       ; preds = %if.end29, %entry
  ...
  %or.cond13 = select i1 %call16.i, i1 %or.cond.i, i1 false
  br i1 %or.cond13, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #11
...
if.end19:                                         ; preds = %if.end, %if.else14
  ...
  %sum.13 = phi i32 [ %add7, %if.else14 ], [ %add6, %if.end ]
