...
if.else:                                          ; preds = %for.body26
  ...
  br i1 %cmp36, label %cond.true, label %for.inc41

cond.true:                                        ; preds = %if.else
  br label %for.inc41

for.inc41:                                        ; preds = %cond.true, %if.else, %if.then
  %min.sink1.sink = phi ptr [ %arrayidx29, %if.then ], [ %arrayidx35, %cond.true ], [ %min, %if.else ]
...
if.else75:                                        ; preds = %for.body68
  ...
  br i1 %cmp80, label %cond.true81, label %for.inc90

cond.true81:                                      ; preds = %if.else75
  br label %for.inc90

for.inc90:                                        ; preds = %cond.true81, %if.else75, %if.then70
  %min.sink.sink = phi ptr [ %arrayidx74, %if.then70 ], [ %arrayidx79, %cond.true81 ], [ %min, %if.else75 ]
