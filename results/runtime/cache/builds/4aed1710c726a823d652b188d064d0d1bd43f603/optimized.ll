...
entry:
  ...
  %call = tail call noundef i32 @_Z9down_casti(i32 noundef %n) #7
...
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #8
...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax53 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax29 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv11 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next12, %for.inc27 ]
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv11, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc24 ], [ 0, %for.cond16.preheader ]
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv11, i64 %indvars.iv6
...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc67 ], [ 0, %for.cond ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count14
  br i1 %exitcond31.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select4, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv16, i64 %indvars.iv26
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !14
  %spec.select4 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond36, !llvm.loop !20

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc64 ], [ 0, %for.cond55.preheader ]
...
for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count42 = zext nneg i32 %smax53 to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc92 ], [ 2, %for.end69 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %for.cond96, label %for.cond76.preheader
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv32 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next33, %for.inc89 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36.not, label %for.inc92, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv37, i64 %indvars.iv32
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !14
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv32
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc117 ], [ 2, %for.cond71 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count42
  br i1 %exitcond55.not, label %for.end119, label %for.cond101.preheader
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv44 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next45, %for.inc114 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond48.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv44, i64 %indvars.iv49
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5, !invariant.load !14
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv44, i64 %7
...
for.cond:                                         ; preds = %for.inc9, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc9 ], [ 0, %entry ]
