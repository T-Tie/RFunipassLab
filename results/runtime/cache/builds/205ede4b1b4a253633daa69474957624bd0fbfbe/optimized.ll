...
if.else.i:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %while.body
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %arrayidx3) #9
...
if.end10:                                         ; preds = %if.else.i
  ...
  %call14 = call i64 @strlen(ptr nofree noundef nonnull dereferenceable(1) %arrayidx12) #10
...
entry:
  ...
  %call.i = call i32 @getc(ptr noundef %0) #12
