...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %3, %cond.true ], [ %min.0, %cond.false ]
  br label %for.inc
...
cond.end46:                                       ; preds = %cond.false45, %cond.true40
  %cond47 = phi i32 [ %9, %cond.true40 ], [ %min.1, %cond.false45 ]
  br label %for.inc48
...
for.body21:                                       ; preds = %for.cond19
  ...
  call fastcc void @outlined_ir_func_0(ptr @l)
  br label %for.cond19
...
newFuncRoot:
  br label %for.end61_to_outline

for.end61_to_outline:                             ; preds = %newFuncRoot
  br label %for.inc62

for.inc62:                                        ; preds = %for.end61_to_outline
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %inc63 = add nsw i32 %1, 1
  store i32 %inc63, ptr %0, align 4, !tbaa !5
  br label %for.cond27.exitStub, !llvm.loop !46

for.cond27.exitStub:                              ; preds = %for.inc62
  ret void
}
