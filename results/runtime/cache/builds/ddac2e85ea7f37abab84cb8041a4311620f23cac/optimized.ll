...
for.cond72:                                       ; preds = %for.inc122, %for.body71
  %.sink33 = phi i32 [ 0, %for.body71 ], [ %inc123, %for.inc122 ]
  %cmp74 = icmp slt i32 %.sink33, %t
...
if.else95:                                        ; preds = %lor.lhs.false.thread
  %cmp96 = icmp eq i32 %.sink33, 0
  %idxprom98 = sext i32 %.sink to i64
