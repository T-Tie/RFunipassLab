...
entry:
  ...
  %phiofops2 = icmp slt i32 %conv9, %conv12
  %0 = load i8, ptr %b, align 16
  %smax = call i32 @llvm.smax.i32(i32 %conv9, i32 1)
  %smax26 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %1 = add nuw i32 %smax26, 1
  %wide.trip.count27 = zext i32 %1 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc73 ], [ 1, %entry ]
  %exitcond28 = icmp eq i64 %indvars.iv21, %wide.trip.count27
  br i1 %exitcond28, label %for.end75, label %for.body

for.body:                                         ; preds = %for.cond
  %2 = add nsw i64 %indvars.iv21, -1
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select11, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext41 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext41, 32
  ...
  %spec.select11 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %invariant.gep15 = getelementptr i8, ptr %a, i64 -1
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  %8 = and i64 %indvars.iv21, 4294967295
  %gep = getelementptr i8, ptr %invariant.gep, i64 %7
  %add49 = add i64 %indvars.iv21, %call8
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %sext39 = shl i64 %add49, 32
  %9 = ashr exact i64 %sext39, 32
  %gep16 = getelementptr i8, ptr %invariant.gep15, i64 %7
  %10 = sub i32 %conv12, %conv9
  %smax29 = call i32 @llvm.abs.i32(i32 %10, i1 false)
  %11 = add nuw i32 %smax29, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond30 = icmp eq i32 %j.1, %11
  br i1 %exitcond30, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv21, 4294967294
  %smax36 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %12 = add nuw i32 %smax36, 1
...
for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep15, i64 %indvars.iv.i
...
_Z4leftPcii.exit:                                 ; preds = %for.cond.i
  store i8 0, ptr %gep16, align 1, !tbaa !5
  br label %for.inc55

if.end50:                                         ; preds = %for.body45
  br i1 %phiofops2, label %for.cond.i4, label %for.inc55

for.cond.i4:                                      ; preds = %if.end50, %for.inc.i7
  %indvars.iv.i5 = phi i64 [ %indvars.iv.next.i9, %for.inc.i7 ], [ %7, %if.end50 ]
  %cmp.not.i6 = icmp slt i64 %indvars.iv.i5, %8
  br i1 %cmp.not.i6, label %_Z5rightPcii.exit, label %for.inc.i7

for.inc.i7:                                       ; preds = %for.cond.i4
  %gep.i8 = getelementptr i8, ptr %invariant.gep15, i64 %indvars.iv.i5
  %14 = load i8, ptr %gep.i8, align 1, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i8, ptr %a, i64 %indvars.iv.i5
  store i8 %14, ptr %arrayidx2.i, align 1, !tbaa !5
  %indvars.iv.next.i9 = add nsw i64 %indvars.iv.i5, -1
  br label %for.cond.i4, !llvm.loop !8

_Z5rightPcii.exit:                                ; preds = %for.cond.i4
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv31 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next32, %for.inc68 ]
  %exitcond38 = icmp eq i64 %indvars.iv31, %wide.trip.count37
  br i1 %exitcond38, label %for.end75, label %for.inc68

for.inc68:                                        ; preds = %for.cond58
  %15 = add nsw i64 %indvars.iv31, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx63, align 1, !tbaa !5
  %17 = add i64 %add64, %indvars.iv31
  %sext40 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext40, 32
