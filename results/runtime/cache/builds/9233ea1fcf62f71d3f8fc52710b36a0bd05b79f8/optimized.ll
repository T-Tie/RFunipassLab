...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) @s) #7
...
for.cond14.preheader:                             ; preds = %for.cond
  %smax = call i32 @llvm.smax.i32(i32 %pre.0, i32 noundef 0) #8
...
for.body6:                                        ; preds = %for.cond3
  ...
  %5 = load i64, ptr %gep, align 8, !tbaa !11
...
for.body17:                                       ; preds = %for.cond14
  ...
  %vtable.i4 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !8
  %vbase.offset.ptr.i5 = getelementptr i8, ptr %vtable.i4, i64 -24
  %vbase.offset.i6 = load i64, ptr %vbase.offset.ptr.i5, align 8, !invariant.load !10
  %gep26 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i6
  %7 = load i64, ptr %gep26, align 8, !tbaa !11
