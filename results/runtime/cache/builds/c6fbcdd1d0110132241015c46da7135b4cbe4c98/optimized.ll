...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc19 ], [ %idxprom2, %for.end ]
  %2 = phi i32 [ %sub8, %for.inc19 ], [ %sub, %for.end ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %idxprom11 = zext nneg i32 %2 to i64
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.end47 ], [ %indvars.iv30, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, -1
  %cmp23 = icmp sgt i64 %indvars.iv32, 0
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next33
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %6, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %cmp30.not = icmp slt i64 %indvars.iv27, %indvars.iv32
...
for.end47:                                        ; preds = %for.cond29
  ...
  %spec.select22 = select i1 %cmp48, i32 1, i32 %add53
  %arrayidx55 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next33
  store i32 %spec.select22, ptr %arrayidx55, align 4, !tbaa !5
  br label %for.cond22, !llvm.loop !14

for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv35 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next36, %for.body62 ]
...
for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv35
  %10 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select23 = call i32 @llvm.smax.i32(i32 %10, i32 %sum.2)
