...
if.then:                                          ; preds = %entry
  %div8 = udiv i32 %0, 100
  %call1 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div8)
...
if.then4:                                         ; preds = %if.end
  %div59 = udiv i32 %2, 50
  %call6 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div59)
...
if.then12:                                        ; preds = %if.end10
  ...
  %call14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div1310)
...
if.then20:                                        ; preds = %if.end18
  ...
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div2111)
...
if.then28:                                        ; preds = %if.end26
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div2912)
