...
if.then6.i9:                                      ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i14 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
if.then19.i20:                                    ; preds = %land.lhs.true.i15
  %call24.i21 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
if.then6.i36:                                     ; preds = %if.then28.i27, %if.then19.i20, %land.lhs.true.i15, %if.then6.i9
  ...
  %call16.i41 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
if.then19.i47:                                    ; preds = %land.lhs.true.i42
  %call24.i48 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55: ; preds = %if.then6.i36, %land.lhs.true.i42, %if.then19.i47, %if.then28.i54
  ...
  %smax84 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %wide.trip.count85 = zext nneg i32 %smax84 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %if.end29, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55
  %indvars.iv95 = phi i32 [ %indvars.iv.next96, %if.end29 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %indvars.iv90 = phi i32 [ %indvars.iv.next91, %if.end29 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end29 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit55 ]
...
for.cond14:                                       ; preds = %for.body, %if.end
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %if.end ], [ 1, %for.body ]
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %if.end ], [ %indvars.iv, %for.body ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  br i1 %cmp23.not, label %if.end, label %for.end.split.loop.exit
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv87 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next88, %for.body39 ]
  %exitcond94.not = icmp eq i64 %indvars.iv87, %wide.trip.count93
  br i1 %exitcond94.not, label %for.end45, label %for.body39
...
for.cond48:                                       ; preds = %for.body50, %for.end45
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.body50 ], [ %12, %for.end45 ]
