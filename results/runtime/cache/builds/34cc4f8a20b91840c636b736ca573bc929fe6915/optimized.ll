...
for.inc36:                                        ; preds = %if.then27, %if.else32
  %.sink22 = phi i32 [ %10, %if.else32 ], [ %1, %if.then27 ]
  %sub33 = sub nsw i32 %4, %.sink22
...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  %.sink20 = phi i32 [ 0, %for.end41 ], [ %inc53, %for.inc52 ]
  %cmp43 = icmp slt i32 %.sink20, 1000
  %11 = load i32, ptr %max, align 4, !tbaa !5
  br i1 %cmp43, label %for.body44, label %for.end54

for.body44:                                       ; preds = %for.cond42
  %idxprom45 = sext i32 %.sink20 to i64
  %arrayidx46 = getelementptr inbounds [1000 x i32], ptr %b, i64 0, i64 %idxprom45
  %12 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !13
...
if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %11)
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc80, %if.else58
  %.sink21 = phi i32 [ 0, %if.else58 ], [ %inc81, %for.inc80 ]
  %cmp61 = icmp slt i32 %.sink21, 1000
  br i1 %cmp61, label %for.body62, label %if.end83

for.body62:                                       ; preds = %for.cond60
  %idxprom63 = sext i32 %.sink21 to i64
