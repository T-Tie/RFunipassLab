...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef align 16 %h) #6
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef align 16 %len) #6
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %ans) #7
  store i32 1, ptr %ans, align 4, !tbaa !5
...
for.body5:                                        ; preds = %for.cond3
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %temp) #7
  store i32 -1, ptr %temp, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %tIndex) #7
  store i32 -1, ptr %tIndex, align 4, !tbaa !5
...
for.body8:                                        ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %h, i64 0, i64 %idxprom26
...
if.then:                                          ; preds = %for.body8
  ...
  %7 = load i32, ptr %temp, align 4, !tbaa !5
  %cmp16 = icmp sgt i32 %6, %7
  br i1 %cmp16, label %if.then17, label %for.inc21

if.then17:                                        ; preds = %if.then
  store i32 %6, ptr %temp, align 4, !tbaa !5
  store i32 %3, ptr %tIndex, align 4, !tbaa !5
  br label %for.inc21
...
if.else:                                          ; preds = %for.end23
  %9 = load i32, ptr %tIndex, align 4, !tbaa !5
  %idxprom28 = sext i32 %9 to i64
  %arrayidx29 = getelementptr inbounds [25 x i32], ptr %len, i64 0, i64 %idxprom28
  %10 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !13
  %add = add nsw i32 %10, 1
  br label %if.end32

if.end32:                                         ; preds = %for.end23, %if.else
  %add.sink = phi i32 [ %add, %if.else ], [ 1, %for.end23 ]
  %arrayidx31 = getelementptr inbounds [25 x i32], ptr %len, i64 0, i64 %idxprom26
  store i32 %add.sink, ptr %arrayidx31, align 4, !tbaa !5
  %11 = load i32, ptr %ans, align 4, !tbaa !5
  %cmp35 = icmp sgt i32 %add.sink, %11
  br i1 %cmp35, label %if.then36, label %for.inc40

if.then36:                                        ; preds = %if.end32
  store i32 %add.sink, ptr %ans, align 4, !tbaa !5
  br label %for.inc40

for.inc40:                                        ; preds = %if.end32, %if.then36
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %tIndex) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %temp) #7
  %inc41 = add nsw i32 %2, 1
  store i32 %inc41, ptr %i, align 4, !tbaa !5
  br label %for.cond3, !llvm.loop !14

for.end42:                                        ; preds = %for.cond3
  %12 = load i32, ptr %ans, align 4, !tbaa !5
  %call43 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %12)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %ans) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #7
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %len) #7
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %h) #7
