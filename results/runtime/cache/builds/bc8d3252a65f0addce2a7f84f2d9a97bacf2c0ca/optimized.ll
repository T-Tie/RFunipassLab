...
if.then:                                          ; preds = %for.body, %land.lhs.true
  ...
  %4 = load i64, ptr %gep, align 8, !tbaa !12
...
entry:
  ...
  %0 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !12
  ...
  %1 = load i32, ptr %_M_streambuf_state.i.i.i, align 8, !tbaa !26
...
if.then19.i:                                      ; preds = %entry
  ...
  %3 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !27
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !26
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !42
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !45
...
!26 = !{!13, !16, i64 32}
!27 = !{!28, !31, i64 232}
!28 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !13, i64 0, !29, i64 216, !7, i64 224, !30, i64 225, !31, i64 232, !32, i64 240, !33, i64 248, !34, i64 256}
...
!35 = !{!28, !32, i64 240}
!36 = !{!37, !7, i64 56}
!37 = !{!"_ZTSSt5ctypeIcE", !38, i64 0, !39, i64 16, !30, i64 24, !40, i64 32, !40, i64 40, !41, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!38 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!39 = !{!"p1 _ZTS15__locale_struct", !18, i64 0}
!40 = !{!"p1 int", !18, i64 0}
!41 = !{!"p1 short", !18, i64 0}
!42 = !{!43, !44, i64 16}
!43 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !44, i64 8, !44, i64 16, !44, i64 24, !44, i64 32, !44, i64 40, !44, i64 48, !21, i64 56}
!44 = !{!"p1 omnipotent char", !18, i64 0}
!45 = !{!43, !44, i64 24}
