...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %wide.trip.count14 = zext nneg i32 %smax44 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond28.preheader, label %for.cond1

for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count19 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv6 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next7, %for.inc22 ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond10.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv6
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv26 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next27, %for.inc63 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count14
  br i1 %exitcond31.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select4, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv26
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %spec.select4 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond31, !llvm.loop !14

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv21 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next22, %for.inc60 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond25.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv26
...
if.end68:                                         ; preds = %for.end65
  ...
  %wide.trip.count37 = zext i32 %t.tr to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc125 ], [ 0, %if.end68 ]
  %exitcond46.not = icmp eq i64 %indvars.iv39, %wide.trip.count14
  br i1 %exitcond46.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %arrayidx99 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv39
  %6 = add nsw i64 %indvars.iv39, -1
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv32 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next33, %for.inc122 ]
  %exitcond38.not = icmp eq i64 %indvars.iv32, %wide.trip.count37
  br i1 %exitcond38.not, label %for.inc125, label %for.body75

for.body75:                                       ; preds = %for.cond72
  switch i32 %7, label %lor.lhs.false [
    i32 0, label %land.lhs.true
    i32 1, label %for.inc122
  ]

land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv32, 2
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv32
  %9 = load i32, ptr %arrayidx89, align 4, !tbaa !5
  %10 = add nsw i64 %indvars.iv32, -1
...
if.else107:                                       ; preds = %lor.lhs.false
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv39, i64 %indvars.iv32
...
for.inc122:                                       ; preds = %land.lhs.true, %lor.lhs.false, %for.body75, %if.then85, %if.else107, %if.then97
