...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef align 16 %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef align 16 %t) #6
...
for.body4:                                        ; preds = %for.cond2
  ...
  %4 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !9
  %rem = srem i32 %4, 2
...
for.cond22:                                       ; preds = %if.end43, %for.body21
  ...
  %sub24 = sub nsw i32 %sub, %7
  %cmp25 = icmp slt i32 %6, %sub24
...
for.body26:                                       ; preds = %for.cond22
  ...
  %8 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %add = add nsw i32 %6, 1
  %idxprom29 = sext i32 %add to i64
  %arrayidx30 = getelementptr inbounds [500 x i32], ptr %t, i64 0, i64 %idxprom29
  %9 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !9
...
for.end49:                                        ; preds = %for.cond19
  %12 = load i32, ptr %t, align 16, !tbaa !5
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %12)
  store i32 1, ptr %i, align 4, !tbaa !5
  br label %for.cond52

for.cond52:                                       ; preds = %for.body54, %for.end49
  %13 = load i32, ptr %i, align 4, !tbaa !5
  %cmp53 = icmp slt i32 %13, %len.0
...
for.body54:                                       ; preds = %for.cond52
  ...
  %15 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !9
  %call58 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call55, i32 noundef %15)
  call fastcc void @outlined_ir_func_0(ptr %i)
  br label %for.cond52
...
cleanup:                                          ; preds = %for.cond52, %for.end15
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %t) #7
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %s) #7
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !11, !invariant.load !9
  ...
  %call = call noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr) #7
...
if.end:                                           ; preds = %entry
  %0 = load i8, ptr %__c.addr, align 1, !tbaa !10
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !13, !invariant.load !9
  ret i64 %0
}
