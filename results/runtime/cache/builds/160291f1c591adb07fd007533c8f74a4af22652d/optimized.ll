...
if.else:                                          ; preds = %for.body26
  ...
  %idxprom34 = sext i32 %.sink22 to i64
...
cond.end:                                         ; preds = %if.else, %cond.false
  %cond = phi i32 [ %8, %cond.false ], [ %9, %if.else ]
...
if.else75:                                        ; preds = %for.body68
  ...
  %idxprom76 = sext i32 %.sink21 to i64
...
cond.end87:                                       ; preds = %if.else75, %cond.false86
  %cond88 = phi i32 [ %15, %cond.false86 ], [ %16, %if.else75 ]
