...
for.cond:                                         ; preds = %if.end94, %entry
  %j.0 = phi i32 [ 0, %entry ], [ %inc96, %if.end94 ]
...
if.end39:                                         ; preds = %if.then35, %if.else, %if.end26.thread, %if.end26
  %total1.3 = phi i32 [ %total1.2, %if.end26 ], [ %add25, %if.end26.thread ], [ %add36, %if.then35 ], [ %add37, %if.else ]
...
for.cond40:                                       ; preds = %if.end84, %for.end
  %m.0 = phi i32 [ 1, %for.end ], [ %inc86, %if.end84 ]
  %total2.0 = phi i32 [ 0, %for.end ], [ %total2.3, %if.end84 ]
...
if.end84:                                         ; preds = %if.then79, %if.else81, %if.end68.thread, %if.end68
  %total2.3 = phi i32 [ %total2.2, %if.end68 ], [ %add67, %if.end68.thread ], [ %add80, %if.then79 ], [ %add82, %if.else81 ]
