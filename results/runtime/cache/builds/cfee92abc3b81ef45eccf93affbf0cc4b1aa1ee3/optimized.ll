...
for.cond2:                                        ; preds = %for.inc11, %for.body
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc11 ], [ 1, %for.body ]
  %exitcond24 = icmp eq i64 %indvars.iv20, %1
  br i1 %exitcond24, label %for.cond14.preheader, label %for.cond5.preheader
...
for.cond5.preheader:                              ; preds = %for.cond2
  %5 = mul nuw nsw i64 %indvars.iv20, %1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  ...
  %indvars.iv57 = phi i64 [ 3, %for.cond14.preheader ], [ %indvars.iv.next58, %for.cond14.loopexit ]
  %indvars.iv25 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next26, %for.cond14.loopexit ]
  ...
  br i1 %exitcond64.not, label %for.inc138, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.inc50
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc50 ], [ %indvars.iv25, %for.cond14 ]
  %exitcond41 = icmp eq i64 %indvars.iv37, %1
  br i1 %exitcond41, label %for.cond53.preheader, label %for.body19
...
for.body19:                                       ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv37, %1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv25
  %7 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  br label %for.cond24

for.cond24:                                       ; preds = %for.body26, %for.body19
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body26 ], [ %indvars.iv25, %for.body19 ]
  %min.0 = phi i32 [ %spec.select, %for.body26 ], [ %7, %for.body19 ]
  %exitcond31 = icmp eq i64 %indvars.iv27, %1
  br i1 %exitcond31, label %for.cond39.preheader, label %for.body26

for.cond39.preheader:                             ; preds = %for.cond24
  br label %for.cond39

for.body26:                                       ; preds = %for.cond24
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv27
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv32 = phi i64 [ %indvars.iv25, %for.cond39.preheader ], [ %indvars.iv.next33, %for.inc47 ]
  %exitcond36 = icmp eq i64 %indvars.iv32, %1
  br i1 %exitcond36, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv32
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc88
  %indvars.iv52 = phi i64 [ %indvars.iv25, %for.cond53.preheader ], [ %indvars.iv.next53, %for.inc88 ]
  %exitcond56 = icmp eq i64 %indvars.iv52, %1
  br i1 %exitcond56, label %for.end90, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv52
  %10 = load i32, ptr %arrayidx59, align 4, !tbaa !5
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv52
  br label %for.cond60

for.cond60:                                       ; preds = %for.body62, %for.body55
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body62 ], [ %indvars.iv25, %for.body55 ]
  %min.2 = phi i32 [ %spec.select16, %for.body62 ], [ %10, %for.body55 ]
  %exitcond46 = icmp eq i64 %indvars.iv42, %1
  br i1 %exitcond46, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %11 = mul nuw nsw i64 %indvars.iv42, %1
...
for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv47 = phi i64 [ %indvars.iv25, %for.cond77.preheader ], [ %indvars.iv.next48, %for.inc85 ]
  %exitcond51 = icmp eq i64 %indvars.iv47, %1
  br i1 %exitcond51, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv47, %1
  %gep18 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep18, align 4, !tbaa !5
  %sub84 = sub nsw i32 %14, %min.2
  store i32 %sub84, ptr %gep18, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next26, %1
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla, i64 %15
  %arrayidx96 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv.next26
  %16 = load i32, ptr %arrayidx96, align 4, !tbaa !5, !invariant.load !20
  %arrayidx101 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv25
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc130 ], [ %indvars.iv57, %for.end90 ]
...
for.inc130:                                       ; preds = %for.cond109
  %arrayidx115 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv59
  %19 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx120 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv59
  store i32 %19, ptr %arrayidx120, align 4, !tbaa !5
  %20 = mul nuw nsw i64 %indvars.iv59, %1
  %arrayidx122 = getelementptr inbounds nuw i32, ptr %vla, i64 %20
  %arrayidx124 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv25
  %21 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv.next26
