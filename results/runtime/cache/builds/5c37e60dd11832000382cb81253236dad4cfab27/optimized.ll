...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.cond.loopexit ], [ 2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond.loopexit ], [ 1, %entry ]
  %exitcond18.not = icmp eq i64 %indvars.iv12, 14
  br i1 %exitcond18.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc14 ], [ %indvars.iv12, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv14, 13
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not.not = icmp samesign ult i64 %indvars.iv9, %indvars.iv14
  br i1 %cmp6.not.not, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv9
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv14
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc27 ], [ 1, %for.cond ]
  %exitcond22.not = icmp eq i64 %indvars.iv19, 13
  br i1 %exitcond22.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv19, i64 %indvars.iv19
  store i32 1, ptr %arrayidx26, align 4, !tbaa !8
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond20, !llvm.loop !14

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond30.not = icmp eq i64 %indvars.iv27, 13
  br i1 %exitcond30.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond26.not = icmp eq i64 %indvars.iv23, %indvars.iv27
  br i1 %exitcond26.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv23, i64 %indvars.iv27
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !8
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv27, i64 %indvars.iv23
...
for.cond51:                                       ; preds = %for.cond30, %for.cond51.loopexit
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond51.loopexit ], [ 2, %for.cond30 ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond51.loopexit ], [ 1, %for.cond30 ]
  %exitcond43.not = icmp eq i64 %indvars.iv36, 14
  br i1 %exitcond43.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc76 ], [ %indvars.iv36, %for.cond51 ]
  %exitcond41.not = icmp eq i64 %indvars.iv38, 13
  br i1 %exitcond41.not, label %for.cond51.loopexit, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc65 ], [ %indvars.iv31, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not.not = icmp samesign ult i64 %indvars.iv33, %indvars.iv38
  br i1 %cmp60.not.not, label %for.inc65, label %for.end67

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv33
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv31, i64 %indvars.iv38
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond47.not = icmp eq i64 %indvars.iv44, 13
  br i1 %exitcond47.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv44, i64 %indvars.iv44
  store i32 1, ptr %arrayidx88, align 4, !tbaa !8
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  br label %for.cond82, !llvm.loop !20

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond55.not = icmp eq i64 %indvars.iv52, 13
  br i1 %exitcond55.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond51.not = icmp eq i64 %indvars.iv48, %indvars.iv52
  br i1 %exitcond51.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv48, i64 %indvars.iv52
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !8
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv52, i64 %indvars.iv48
...
for.cond113:                                      ; preds = %for.inc141, %for.end112
  %i.0 = phi i32 [ 1, %for.end112 ], [ %inc142, %for.inc141 ]
...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts7 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink) #7
