...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %b) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %c) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %d) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %e) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %f) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef %g) #4
...
for.inc41:                                        ; preds = %for.cond35
  ...
  %11 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !9
  %call40 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11) #5
  %inc42 = add nsw i32 %9, 1
  store i32 %inc42, ptr %i, align 4, !tbaa !5
  br label %for.cond35, !llvm.loop !13

for.end43:                                        ; preds = %for.cond35
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %g) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %f) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %e) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %d) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %c) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef %a) #5
