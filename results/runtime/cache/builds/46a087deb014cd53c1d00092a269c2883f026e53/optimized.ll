...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.25, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.27, %for.inc ]
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.body ], [ %end2.2, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.body ], [ %f.29, %for.inc ]
...
for.inc:                                          ; preds = %if.then19, %for.body3
  %f.29 = phi i32 [ %f.2.ph, %if.then19 ], [ %f.1, %for.body3 ]
  %star1.27 = phi i32 [ %star1.2.ph, %if.then19 ], [ %star1.1, %for.body3 ]
  %star2.25 = phi i32 [ %star2.2.ph, %if.then19 ], [ %star2.1, %for.body3 ]
