...
for.end44:                                        ; preds = %for.cond29
  %t.1.lcssa = phi i32 [ %t.1, %for.cond29 ]
  %cmp45 = icmp ne i32 %t.1.lcssa, 0
...
if.then46:                                        ; preds = %for.end44
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv48, i32 noundef %t.1.lcssa) #5
  br label %for.inc51
...
for.cond54:                                       ; preds = %for.inc80, %for.end53
  ...
  br i1 %cmp55, label %for.body56, label %if.end83.loopexit
...
for.end72:                                        ; preds = %for.cond57
  %l.1.lcssa = phi i32 [ %l.1, %for.cond57 ]
  %cmp73 = icmp ne i32 %l.1.lcssa, 0
...
if.then74:                                        ; preds = %for.end72
  ...
  %call78 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv77, i32 noundef %l.1.lcssa) #5
  br label %for.inc80
