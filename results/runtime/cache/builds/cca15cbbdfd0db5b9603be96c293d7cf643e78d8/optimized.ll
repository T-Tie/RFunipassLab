...
for.cond23:                                       ; preds = %for.inc41, %for.body22
  ...
  %3 = phi i32 [ %inc42, %for.inc41 ], [ 0, %for.body22 ]
  %cmp24 = icmp slt i32 %3, %n.0
...
for.inc41:                                        ; preds = %cond.false, %if.else, %if.then
  %min.4 = phi i32 [ %4, %if.then ], [ %min.3, %cond.false ], [ %5, %if.else ]
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  ...
  %7 = phi i32 [ %inc91, %for.inc90 ], [ 0, %for.body63 ]
  %cmp66 = icmp slt i32 %7, %n.0
  br i1 %cmp66, label %for.body68, label %for.end92

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i32 %7, 0
...
for.inc90:                                        ; preds = %cond.false86, %if.else75, %if.then70
  %min.7 = phi i32 [ %8, %if.then70 ], [ %min.6, %cond.false86 ], [ %9, %if.else75 ]
  %inc91 = add nsw i32 %7, 1
