...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef nonnull align 16 %b) #8
...
if.then6.i11:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %call16.i21 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i20) #9
  %3 = add i64 %2, -1001
...
if.then19.i26:                                    ; preds = %if.then6.i11
  ...
  %call24.i31 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i30) #9
