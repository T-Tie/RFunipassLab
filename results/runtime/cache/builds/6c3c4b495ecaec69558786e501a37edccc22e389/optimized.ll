...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %1 = phi i32 [ %dec, %for.inc19 ], [ %sub, %for.end ]
  %cmp6 = icmp sgt i32 %1, 0
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %sub8 = sub nsw i32 %1, 1
...
for.inc45:                                        ; preds = %for.body31, %land.lhs.true, %if.then40
  ...
  %sum.1 = phi i32 [ %9, %if.then40 ], [ %sum.0, %land.lhs.true ], [ %sum.0, %for.body31 ]
...
for.cond60:                                       ; preds = %for.inc70, %for.end59
  %i.1 = phi i32 [ 0, %for.end59 ], [ %inc71, %for.inc70 ]
  %sum.2 = phi i32 [ 0, %for.end59 ], [ %sum.3, %for.inc70 ]
  %cmp61 = icmp slt i32 %i.1, %0
...
for.inc70:                                        ; preds = %for.body62, %if.then66
  %sum.3 = phi i32 [ %10, %if.then66 ], [ %sum.2, %for.body62 ]
  %inc71 = add nsw i32 %i.1, 1
  br label %for.cond60, !llvm.loop !16

for.end72:                                        ; preds = %for.cond60
  %call73 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %sum.2) #5
