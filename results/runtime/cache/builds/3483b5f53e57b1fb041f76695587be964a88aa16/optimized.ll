...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %initial) #8
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %word) #8
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit43: ; preds = %if.then19.i31, %while.body
  %call9 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %word) #9
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %word) #8
  br label %while.cond, !llvm.loop !24

while.end:                                        ; preds = %while.cond
  call fastcc void @outlined_ir_func_0()
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull captures(none) %initial) #8
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %0) unnamed_addr #6 {
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(40) %0) unnamed_addr #6 {
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly align 16 dereferenceable(40) %0) #10
