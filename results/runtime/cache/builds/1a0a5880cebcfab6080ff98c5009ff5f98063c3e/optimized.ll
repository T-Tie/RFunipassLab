...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %sum) #11
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %efficient) #11
  br label %for.cond
...
for.inc:                                          ; preds = %for.body, %if.else16, %if.then13, %if.then6
  %sample.1 = phi double [ %sample.0, %if.then6 ], [ %sample.0, %if.then13 ], [ %sample.0, %if.else16 ], [ %div, %for.body ]
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %efficient) #11
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %sum) #11
...
for.inc.exitStub:
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
