...
if.end18:                                         ; preds = %if.else, %if.then
  call fastcc void @outlined_ir_func_0(ptr %i, i32 %m, ptr %sum)
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %b) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef align 16 %a) #8
...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3funii(i32 noundef %1, i32 noundef 1) #9
...
define internal fastcc void @outlined_ir_func_0(ptr %0, i32 %1, ptr %2) unnamed_addr #7 {
if.then_to_outline:
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %if.then_to_outline
  ...
  br i1 %cmp1, label %for.body, label %if.end18.exitStub
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %1, %3
  %call = call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %3) #11
