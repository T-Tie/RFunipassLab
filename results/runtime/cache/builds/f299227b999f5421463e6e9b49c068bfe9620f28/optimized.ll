...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv29 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next30, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv29, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax44 = add nsw i32 %3, -1
  %wide.trip.count45 = zext nneg i32 %smax44 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv33 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next34, %for.inc40 ]
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  %4 = trunc nuw i64 %indvars.iv.next34 to i32
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next34
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count45
  br i1 %exitcond46.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv41, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc74 ], [ %indvars.iv36, %for.body48 ]
  %9 = icmp slt i64 %indvars.iv38, %1
  br i1 %9, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv38, i32 1
