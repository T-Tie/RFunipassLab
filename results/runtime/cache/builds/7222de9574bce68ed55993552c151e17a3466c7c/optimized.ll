...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEj(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %s.0.lcssa)
  br label %if.end
...
while.end:                                        ; preds = %while.cond
  %i.2.lcssa = phi i32 [ %i.2, %while.cond ]
  br label %for.cond39

for.cond39:                                       ; preds = %for.inc45, %while.end
  %j.2 = phi i32 [ %i.2.lcssa, %while.end ], [ %dec46, %for.inc45 ]
