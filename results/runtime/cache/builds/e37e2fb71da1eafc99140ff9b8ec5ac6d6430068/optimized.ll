...
if.then6.i:                                       ; preds = %for.body
  ...
  %gep5 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i
  %3 = load i64, ptr %gep5, align 8, !tbaa !12
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread19
  ...
  %s.13.ph = phi i32 [ %s.0, %if.end35.thread19 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre21, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
