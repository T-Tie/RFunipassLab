...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef %a) #11
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef %b) #11
  br label %for.cond
...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef %add.ptr8) #12
...
for.end56:                                        ; preds = %for.cond45
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef %a) #11
...
define internal fastcc void @outlined_ir_func_0(ptr nonnull %0) unnamed_addr #9 {
