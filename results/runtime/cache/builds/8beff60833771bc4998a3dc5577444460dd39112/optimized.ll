...
for.cond:                                         ; preds = %for.end27, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc29, %for.end27 ]
...
for.cond31:                                       ; preds = %for.end68, %for.end30
  %i.1 = phi i32 [ 0, %for.end30 ], [ %inc70, %for.end68 ]
...
for.cond37:                                       ; preds = %if.end50, %for.body33
  %j.2 = phi i32 [ 1, %for.body33 ], [ %inc52, %if.end50 ]
  %min34.0 = phi i32 [ %3, %for.body33 ], [ %min34.1, %if.end50 ]
...
for.cond54:                                       ; preds = %for.body56, %for.end53
  %j.3 = phi i32 [ 0, %for.end53 ], [ %inc67, %for.body56 ]
...
for.cond:                                         ; preds = %for.end, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc11, %for.end ]
  %sub = sub nsw i32 %n, 1
...
for.cond13:                                       ; preds = %for.end32, %for.end12
  %i.1 = phi i32 [ 1, %for.end12 ], [ %inc34, %for.end32 ]
...
for.cond17:                                       ; preds = %for.body20, %for.body16
  %j.1 = phi i32 [ 0, %for.body16 ], [ %inc31, %for.body20 ]
...
for.body20:                                       ; preds = %for.cond17
  ...
  %idxprom24 = sext i32 %inc34 to i64
...
if.else:                                          ; preds = %entry
  call void @_Z7guilingi(i32 noundef %n) #8
...
for.cond1:                                        ; preds = %for.cond.cleanup7, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc13, %for.cond.cleanup7 ]
...
for.cond.cleanup3:                                ; preds = %for.cond1
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %2)
