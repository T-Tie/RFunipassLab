...
land.lhs.true:                                    ; preds = %for.body75
  ...
  br i1 %cmp77, label %for.inc122, label %lor.lhs.false.thread

if.else79:                                        ; preds = %for.body75
  %cmp80 = icmp eq i32 %i.2, 1
  br i1 %cmp80, label %for.inc122, label %lor.lhs.false
...
lor.lhs.false.thread:                             ; preds = %land.lhs.true
  ...
  br i1 %cmp814, label %for.inc122, label %if.then85

if.then85:                                        ; preds = %lor.lhs.false.thread
...
for.inc122.gvnsink.split:                         ; preds = %if.then85, %if.else107
  %sub112.sink = phi i32 [ %sub112, %if.else107 ], [ 0, %if.then85 ]
