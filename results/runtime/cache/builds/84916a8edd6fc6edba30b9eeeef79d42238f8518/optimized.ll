...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %sub.sink7 = phi i32 [ %sub, %for.body31 ], [ %dec, %for.inc44 ]
  %cmp34 = icmp sge i32 %sub.sink7, 0
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idx.ext39 = sext i32 %sub.sink7 to i64
...
if.then42:                                        ; preds = %for.body35
  ...
  store i32 %sub.sink7, ptr %c2, align 4, !tbaa !5
