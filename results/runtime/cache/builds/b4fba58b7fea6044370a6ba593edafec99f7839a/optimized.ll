...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %h) #4
...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc7 ], [ 0, %entry ]
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax58 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count64 = zext nneg i32 %smax58 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv48, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond65.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.body15 ], [ 0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select44, %for.body15 ], [ %l1.0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv61, i64 %indvars.iv51
  ...
  %spec.select44 = select i1 %cmp20, i32 %6, i32 %l1.1
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv54 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next55, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %exitcond60.not = icmp eq i64 %indvars.iv54, %wide.trip.count64
  br i1 %exitcond60.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv54, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %idxprom40
  %7 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp slt i32 %7, %min.1
  %spec.select45 = call i32 @llvm.smin.i32(i32 %7, i32 %min.1)
  %8 = trunc nuw nsw i64 %indvars.iv54 to i32
  %spec.select46 = select i1 %cmp42, i32 %8, i32 %l2.1
  br label %for.inc50

if.end37.thread:                                  ; preds = %for.body30
  %9 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !13
  br label %for.inc50

for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %min.3 = phi i32 [ %9, %if.end37.thread ], [ %spec.select45, %if.end37 ]
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select46, %if.end37 ]
...
for.end52:                                        ; preds = %for.cond28
  ...
  br i1 %cmp53, label %for.end59, label %for.cond10, !llvm.loop !16
...
if.end63:                                         ; preds = %for.end59, %if.then61
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %d) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %h) #5
