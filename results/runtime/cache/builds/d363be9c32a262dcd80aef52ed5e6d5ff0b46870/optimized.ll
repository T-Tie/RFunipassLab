...
if.then:                                          ; preds = %while.body
  ...
  %.pre5 = load double, ptr %a, align 8, !tbaa !5
  %.pre8 = fdiv double %.pre, %.pre5
  %.pre9 = fsub double %.pre8, %div
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %sub10.pre-phi = phi double [ %.pre9, %if.then ], [ %sub, %while.body ]
...
if.then12:                                        ; preds = %if.end
  ...
  %.pre6 = load double, ptr %b, align 8, !tbaa !5
  %.pre7 = load double, ptr %a, align 8, !tbaa !5
  %.pre10 = fdiv double %.pre6, %.pre7
  %.pre11 = fsub double %.pre10, %div
  br label %if.end15

if.end15:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi double [ %.pre11, %if.then12 ], [ %sub10.pre-phi, %if.end ]
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #11
