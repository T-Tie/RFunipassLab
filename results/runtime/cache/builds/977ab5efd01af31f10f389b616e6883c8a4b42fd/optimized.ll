...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2040, ptr nonnull %a) #4
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc31
  %indvars.iv19 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next20, %for.inc31 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.cond7.backedge
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond7.backedge ], [ %1, %for.cond3 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %cmp8.not.not = icmp sgt i64 %indvars.iv, %indvars.iv19
...
for.body9:                                        ; preds = %for.cond7
  ...
  br i1 %cmp15, label %if.then16, label %for.cond7.backedge

for.cond7.backedge:                               ; preds = %for.body9, %if.then16
...
for.cond36:                                       ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %for.end33
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 1, %for.end33 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond27.not, label %for.end46, label %for.body39
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %arrayidx42 = getelementptr inbounds nuw [510 x i32], ptr %a, i64 0, i64 %indvars.iv23
...
for.end46:                                        ; preds = %for.cond36
  ...
  call void @llvm.lifetime.end.p0(i64 2040, ptr nonnull %a) #4
  ret i32 0
}
