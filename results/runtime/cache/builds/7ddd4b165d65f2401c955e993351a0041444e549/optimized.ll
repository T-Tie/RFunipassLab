...
if.then19.i:                                      ; preds = %entry
  call void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %add.ptr15.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry
  call void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(40) %initial)
...
if.then19.i31:                                    ; preds = %while.body
  call void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %add.ptr15.i24)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(41) %word)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(240) %0) #8 {
newFuncRoot:
...
if.then19.i_to_outline:                           ; preds = %newFuncRoot
  ...
  %1 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !35, !invariant.load !8
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_2(ptr noundef nonnull align 16 dereferenceable(40) %0) #8 {
newFuncRoot:
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit_to_outline: ; preds = %newFuncRoot
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %0) #12
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %0, i64 noundef %call.i.i)
...
!34 = !{!12, !12, i64 0}
!35 = !{!36, !38, i64 232}
!36 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0, !37, i64 216, !12, i64 224, !31, i64 225, !38, i64 232, !39, i64 240, !40, i64 248, !41, i64 256}
!37 = !{!"p1 _ZTSSo", !16, i64 0}
