...
define dso_local void @_Z5rightPcii(ptr nofree noundef captures(none) %a, i32 noundef %l, i32 noundef %t) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @_Z4leftPcii(ptr nofree noundef captures(none) %a, i32 noundef %l, i32 noundef %t) local_unnamed_addr #0 {
entry:
  %invariant.gep = getelementptr i8, ptr %a, i64 -1
...
entry:
  ...
  %smax27 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %1 = add nuw i32 %smax27, 1
  %wide.trip.count28 = zext i32 %1 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc73 ], [ 1, %entry ]
  %exitcond29 = icmp eq i64 %indvars.iv22, %wide.trip.count28
  br i1 %exitcond29, label %for.end75, label %for.body
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select12, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext42 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext42, 32
  ...
  %spec.select12 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %invariant.gep16 = getelementptr i8, ptr %a, i64 -1
  %cmp51 = icmp slt i32 %conv9, %conv12
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  %8 = and i64 %indvars.iv22, 4294967295
  %gep = getelementptr i8, ptr %invariant.gep, i64 %7
  %add49 = add i64 %indvars.iv22, %call8
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %sext40 = shl i64 %add49, 32
  %9 = ashr exact i64 %sext40, 32
  %gep17 = getelementptr i8, ptr %invariant.gep16, i64 %7
  %10 = sub i32 %conv12, %conv9
  %smax30 = call i32 @llvm.abs.i32(i32 %10, i1 noundef false)
  %11 = add nuw i32 %smax30, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond31 = icmp eq i32 %j.1, %11
  br i1 %exitcond31, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv22, 4294967294
  %smax37 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
  %12 = add nuw i32 %smax37, 1
  %wide.trip.count38 = zext i32 %12 to i64
  br label %for.cond58
...
for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep16, i64 %indvars.iv.i
...
_Z4leftPcii.exit:                                 ; preds = %for.cond.i
  store i8 0, ptr %gep17, align 1, !tbaa !5
  br label %for.inc55
...
for.cond.i3:                                      ; preds = %if.end50, %for.inc.i6
  %indvars.iv.i4 = phi i64 [ %indvars.iv.next.i8, %for.inc.i6 ], [ %7, %if.end50 ]
  %cmp.not.i5 = icmp slt i64 %indvars.iv.i4, %8
  br i1 %cmp.not.i5, label %_Z5rightPcii.exit, label %for.inc.i6

for.inc.i6:                                       ; preds = %for.cond.i3
  %gep.i7 = getelementptr i8, ptr %invariant.gep16, i64 %indvars.iv.i4
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv32 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next33, %for.inc68 ]
  %exitcond39 = icmp eq i64 %indvars.iv32, %wide.trip.count38
  br i1 %exitcond39, label %for.end75, label %for.inc68

for.inc68:                                        ; preds = %for.cond58
  %15 = add nsw i64 %indvars.iv32, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx63, align 1, !tbaa !5
  %17 = add i64 %add64, %indvars.iv32
  %sext41 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext41, 32
