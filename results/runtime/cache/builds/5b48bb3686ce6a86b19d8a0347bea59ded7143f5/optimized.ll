...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv2
...
for.end:                                          ; preds = %for.body4, %for.cond2
  %j.0.lcssa.in = phi i64 [ %indvars.iv, %for.body4 ], [ %indvars.iv2, %for.cond2 ]
  %4 = and i64 %j.0.lcssa.in, 4294967295
  %cmp10 = icmp eq i64 %indvars.iv2, %4
...
for.cond17:                                       ; preds = %for.cond, %for.inc43
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc43 ], [ 0, %for.cond ]
  %counter.2 = phi i32 [ %counter.3, %for.inc43 ], [ %counter.0, %for.cond ]
  %6 = sext i32 %5 to i64
  %cmp18 = icmp slt i64 %indvars.iv9, %6
  br i1 %cmp18, label %for.cond20.preheader, label %for.end45

for.cond20.preheader:                             ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv9
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc30
  %indvars.iv5 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next6, %for.inc30 ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, %indvars.iv9
  br i1 %exitcond8.not, label %for.end32, label %for.body22

for.body22:                                       ; preds = %for.cond20
  %7 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %arrayidx26 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
for.end32:                                        ; preds = %for.body22, %for.cond20
  %j.1.lcssa.in = phi i64 [ %indvars.iv5, %for.body22 ], [ %indvars.iv9, %for.cond20 ]
  %9 = and i64 %j.1.lcssa.in, 4294967295
  %cmp33 = icmp eq i64 %indvars.iv9, %9
