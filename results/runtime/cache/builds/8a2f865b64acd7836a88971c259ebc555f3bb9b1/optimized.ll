...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.body5 ], [ 0, %for.cond3.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %idxprom6
  br i1 %exitcond.not, label %for.end24, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv5
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv8 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next9, %for.inc19 ]
...
for.inc19:                                        ; preds = %for.cond11
  ...
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next9
...
for.cond29:                                       ; preds = %while.cond, %for.inc37
  ...
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc37 ], [ 0, %while.cond ]
  %sub30 = add nsw i32 %10, -1
  %11 = sext i32 %sub30 to i64
  %cmp31 = icmp slt i64 %indvars.iv13, %11
  br i1 %cmp31, label %for.inc37, label %for.end39

for.inc37:                                        ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv13
