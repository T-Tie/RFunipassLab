...
for.cond11:                                       ; preds = %for.inc37, %for.end
  %2 = phi i32 [ %dec, %for.inc37 ], [ %sub, %for.end ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !9
...
for.inc45:                                        ; preds = %for.cond39
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5) #5
...
for.end47:                                        ; preds = %for.cond39
  ...
  %6 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %6) #5
