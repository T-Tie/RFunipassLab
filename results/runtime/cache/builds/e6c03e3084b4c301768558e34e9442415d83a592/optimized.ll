...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv3, %9
...
for.body51:                                       ; preds = %for.cond49
  ...
  %10 = load double, ptr %arrayidx53, align 8, !tbaa !9, !invariant.load !14
...
if.then55:                                        ; preds = %for.body51
  ...
  %11 = load double, ptr %arrayidx58, align 8, !tbaa !9
...
if.else63:                                        ; preds = %for.body51
  ...
  %13 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv3
  %14 = load double, ptr %13, align 8, !tbaa !9
  br i1 %cmp66, label %if.then67, label %if.else72

if.then67:                                        ; preds = %if.else63
  %call71 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %14)
  br label %for.inc110

if.else72:                                        ; preds = %if.else63
  %cmp76 = fcmp oeq double %14, 0.000000e+00
  %15 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv3
  %16 = load double, ptr %15, align 8, !tbaa !9, !invariant.load !14
  br i1 %cmp76, label %if.then77, label %if.else93

if.then77:                                        ; preds = %if.else72
  %fneg81 = fneg double %14
  %call92 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %fneg81, double noundef %16, double noundef %fneg81, double noundef %16)
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %14, double noundef %16, double noundef %14, double noundef %16)
  br label %for.inc110
