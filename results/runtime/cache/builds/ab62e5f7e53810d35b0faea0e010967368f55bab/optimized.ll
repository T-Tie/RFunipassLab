...
define dso_local void @_Z2f1Piii(ptr noundef %p, i32 noundef %n, i32 noundef %k) #0 {
entry:
...
; Function Attrs: mustprogress uwtable
define dso_local void @_Z2f2Piii(ptr noundef %p, i32 noundef %n, i32 noundef %k) #0 {
entry:
  %0 = load i32, ptr %p, align 4, !tbaa !5
  br label %for.cond
