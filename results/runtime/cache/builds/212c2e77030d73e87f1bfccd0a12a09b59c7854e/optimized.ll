...
for.body52:                                       ; preds = %for.cond50
  ...
  %13 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  ...
  %14 = load i32, ptr %h58, align 4, !tbaa !12, !invariant.load !16
  %cmp59 = icmp slt i32 %13, %14
  br i1 %cmp59, label %if.then60, label %for.inc74

if.then60:                                        ; preds = %for.body52
  store i32 %14, ptr %h55, align 4, !tbaa !12
  store i32 %13, ptr %h58, align 4, !tbaa !12
  br label %for.inc74
...
for.end79:                                        ; preds = %for.cond45
  ...
  %15 = load i32, ptr %h81, align 4, !tbaa !12
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15)
