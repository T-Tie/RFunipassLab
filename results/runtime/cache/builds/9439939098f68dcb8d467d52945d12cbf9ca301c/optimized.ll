...
for.cond.preheader:                               ; preds = %tailrecurse
  ...
  %smax32 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
...
for.cond71:                                       ; preds = %for.cond75, %for.end68
  %indvars.iv35 = phi i64 [ 1, %for.end68 ], [ %indvars.iv.next36, %for.cond75 ]
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc86
  %indvars.iv29 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next30, %for.inc86 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count11
  br i1 %exitcond34.not, label %for.cond71, label %for.inc86, !llvm.loop !18

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv.next36, i64 %indvars.iv29
