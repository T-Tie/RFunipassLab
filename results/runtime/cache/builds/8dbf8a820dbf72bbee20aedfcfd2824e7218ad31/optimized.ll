...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp.not, label %for.cond9.preheader, label %for.body
...
for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds nuw [100 x i32], ptr %b, i64 0, i64 %indvars.iv
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call14, ptr noundef nonnull @.str, i64 noundef 1)
