...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %5) #6, !tbaa !5
  %add = fsub double %call5, %1
  %mul = fmul double %2, 2.000000e+00
  %div = fdiv double %add, %mul
  %call7 = call double @sqrt(double noundef %5) #6, !tbaa !5
...
if.then19:                                        ; preds = %if.end17
  ...
  %call24 = call double @sqrt(double noundef %fneg23) #6, !tbaa !5
  %div26 = fdiv double %call24, %mul21
  %call28 = call double @sqrt(double noundef %fneg23) #6, !tbaa !5
...
if.then34:                                        ; preds = %if.then19
  %call35 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div26)
  br label %if.end36
...
if.then38:                                        ; preds = %if.end36
  %call39 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %div26)
  br label %if.end40
...
if.then43:                                        ; preds = %if.end40
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div31)
  br label %if.end45
...
if.then47:                                        ; preds = %if.end45
  %call48 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, double noundef %div31)
  br label %for.inc
