...
for.end:                                          ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %5)
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %i4) #8
  store i32 1, ptr %i4, align 4, !tbaa !5
  br label %for.cond5

for.cond5:                                        ; preds = %for.end27, %for.end
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %cmp6 = icmp slt i32 1, %6
  br i1 %cmp6, label %for.body8, label %for.end31

for.body8:                                        ; preds = %for.cond5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %k) #8
  store i32 0, ptr %k, align 4, !tbaa !5
  br label %for.cond9

for.cond9:                                        ; preds = %if.end24, %for.body8
  %7 = load i32, ptr %i4, align 4, !tbaa !5
  %cmp10 = icmp slt i32 0, %7
...
for.body12:                                       ; preds = %for.cond9
  ...
  %10 = load i32, ptr %arrayidx16, align 4, !tbaa !5, !invariant.load !9
  %cmp17 = icmp eq i32 %8, %10
  br i1 %cmp17, label %for.end27, label %if.end

if.end:                                           ; preds = %for.body12
  %sub = sub nsw i32 %7, 1
  %cmp18 = icmp eq i32 %9, %sub
  br i1 %cmp18, label %if.then19, label %if.end24

if.then19:                                        ; preds = %if.end
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str)
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call20, i32 noundef %8)
  br label %if.end24
...
for.end27:                                        ; preds = %for.cond9, %for.body12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %k) #8
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i4) #8
  br label %for.cond5

for.end31:                                        ; preds = %for.cond5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %i4) #8
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
