...
define dso_local void @_Z2f1Piii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) %p, i32 noundef %n, i32 noundef %k) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select = tail call i32 @llvm.smin.i32(i32 %1, i32 %m.0)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc11
  %indvars.iv8 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next9, %for.inc11 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond12.not, label %for.end13, label %for.inc11

for.inc11:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw i32, ptr %p.tr, i64 %indvars.iv8
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @_Z2f2Piii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(4) %p, i32 noundef %n, i32 noundef %k) #0 {
entry:
  %smax = call i32 @llvm.smax.i32(i32 %n, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %tailrecurse
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc14
  %indvars.iv9 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next10, %for.inc14 ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond14.not, label %for.end16, label %for.inc14

for.inc14:                                        ; preds = %for.cond5
  %add.ptr10.idx = mul nuw nsw i64 %indvars.iv9, 400
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %p.tr, i64 %add.ptr10.idx
  %2 = load i32, ptr %add.ptr10, align 4, !tbaa !5
  %sub = sub nsw i32 %2, %m.0
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc63
  %indvars.iv50 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next51, %for.inc63 ]
  %indvars.iv47 = phi i64 [ %4, %for.cond14.preheader ], [ %indvars.iv.next48, %for.inc63 ]
  %h.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.inc63 ]
  %8 = trunc nuw i64 %indvars.iv50 to i32
  %cmp15 = icmp sgt i32 %8, 1
  br i1 %cmp15, label %for.body16, label %for.inc66

for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %8, i32 noundef %8) #6
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %8, i32 noundef %8) #6
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body16
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc37 ], [ 0, %for.body16 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %indvars.iv50
  br i1 %exitcond36.not, label %for.cond40, label %for.cond22

for.cond22:                                       ; preds = %for.cond19, %for.inc34
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc34 ], [ 1, %for.cond19 ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %indvars.iv47
  br i1 %exitcond.not, label %for.inc37, label %for.inc34

for.inc34:                                        ; preds = %for.cond22
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv.next27
  %10 = load i32, ptr %arrayidx29, align 4, !tbaa !5
  %arrayidx33 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv26
...
for.cond40:                                       ; preds = %for.cond19, %for.inc60
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc60 ], [ 0, %for.cond19 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %indvars.iv47
  br i1 %exitcond46.not, label %for.inc63, label %for.cond44

for.cond44:                                       ; preds = %for.cond40, %for.inc57
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc57 ], [ 1, %for.cond40 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %indvars.iv47
  br i1 %exitcond41.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond44
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next38, i64 %indvars.iv42
  %11 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !19
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv37, i64 %indvars.iv42
