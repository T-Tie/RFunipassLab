...
if.then38:                                        ; preds = %land.lhs.true
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %8)
  br label %for.inc53
...
if.then48:                                        ; preds = %land.lhs.true46
  %call51 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %8)
  br label %for.inc53

for.inc53:                                        ; preds = %if.end42, %land.lhs.true46, %if.then48, %if.then38
  %b.1 = phi i32 [ 1, %if.then38 ], [ %b.0, %if.then48 ], [ 0, %land.lhs.true46 ], [ %b.0, %if.end42 ]
