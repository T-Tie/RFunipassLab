...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2505, ptr nonnull %a) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(2505) %a, i8 0, i64 2505, i1 false)
  ...
  %smax38 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax38, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc12 ], [ 0, %entry ]
  %exitcond40 = icmp eq i64 %indvars.iv35, %wide.trip.count39
  br i1 %exitcond40, label %for.cond15, label %for.cond4
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv35, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond50 = icmp eq i64 %indvars.iv46, %wide.trip.count39
  br i1 %exitcond50, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv46
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv46
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc39 ], [ %indvars.iv41, %for.body19 ]
  %4 = trunc nuw i64 %indvars.iv43 to i32
  %cmp24.not = icmp slt i32 %sub, %4
  br i1 %cmp24.not, label %for.cond15.loopexit, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv43
...
for.cond45:                                       ; preds = %for.cond15, %for.inc66
  ...
  %cmp46 = icmp ne i32 %k.0, 0
  %cmp47 = icmp eq i32 %z.0, 0
  %6 = select i1 %cmp46, i1 %cmp47, i1 false
  br i1 %6, label %for.cond49, label %for.end67

for.cond49:                                       ; preds = %for.cond45, %for.inc63
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc63 ], [ 0, %for.cond45 ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %for.cond45 ]
  %exitcond55 = icmp eq i64 %indvars.iv51, %wide.trip.count39
  br i1 %exitcond55, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv51
  %7 = load i32, ptr %arrayidx55, align 4, !tbaa !5
  %cmp56 = icmp eq i32 %7, %k.0
...
if.then57:                                        ; preds = %for.body53
  ...
  store i32 %8, ptr %arrayidx59, align 4, !tbaa !5
...
for.end67:                                        ; preds = %for.cond45
  br i1 %cmp47, label %if.then69, label %if.else71

if.then69:                                        ; preds = %for.end67
  %call70 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2)
  br label %if.end86

if.else71:                                        ; preds = %for.end67
  %add72 = add nsw i32 %k.0, 2
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %add72)
  %smax60 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count61 = zext nneg i32 %smax60 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.body76, %if.else71
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.body76 ], [ 0, %if.else71 ]
  %exitcond62.not = icmp eq i64 %indvars.iv56, %wide.trip.count61
  br i1 %exitcond62.not, label %if.end86, label %for.body76

for.body76:                                       ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv56
...
if.end86:                                         ; preds = %for.cond74, %if.then69
  ...
  call void @llvm.lifetime.end.p0(i64 2505, ptr nonnull %a) #8
