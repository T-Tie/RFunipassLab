...
for.cond10:                                       ; preds = %for.cond, %for.inc17
  ...
  br i1 %exitcond18.not, label %for.end19, label %land.rhs
...
for.end19.split.loop.exit24:                      ; preds = %land.rhs
...
for.cond20:                                       ; preds = %for.body22, %for.end19
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body22 ], [ %5, %for.end19 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, 31
  br i1 %exitcond23.not, label %for.end30, label %for.body22
