...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %b) #4
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %x) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %y) #4
...
if.else26:                                        ; preds = %if.else21
  ...
  br i1 %cmp28, label %for.inc, label %if.else31

if.else31:                                        ; preds = %if.else26
  br label %for.inc

for.inc:                                          ; preds = %if.else26, %if.else21, %if.else, %if.then, %if.else18, %if.else31
  %.str.7.sink = phi ptr [ @.str.7, %if.else31 ], [ @.str.4, %if.else18 ], [ @.str.2, %if.then ], [ @.str.3, %if.else ], [ @.str.5, %if.else21 ], [ @.str.6, %if.else26 ]
  %call32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.7.sink)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %y) #4
