...
for.cond5:                                        ; preds = %for.inc, %for.body4
  %k.0 = phi i32 [ %2, %for.body4 ], [ %inc, %for.inc ]
...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  %5 = phi i32 [ %inc28, %for.inc27 ], [ 1, %for.end19 ]
  %cmp21 = icmp sle i32 %5, 12
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %7 = phi i32 [ %inc49, %for.inc48 ], [ 1, %for.end29 ]
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %11 = phi i32 [ %inc80, %for.inc79 ], [ 1, %for.end50 ]
  %cmp52 = icmp sle i32 %11, 12
...
for.cond55:                                       ; preds = %for.inc76, %for.body53
  ...
  %12 = load i32, ptr %i.sink, align 4, !tbaa !5
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  %k.1 = phi i32 [ %13, %for.body57 ], [ %inc66, %for.inc65 ]
  %sum.1 = phi i32 [ 0, %for.body57 ], [ %add64, %for.inc65 ]
  %cmp60 = icmp sle i32 %k.1, %12
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %18 = phi i32 [ %inc111, %for.inc110 ], [ 1, %for.end91 ]
  %cmp93 = icmp sle i32 %18, 12
...
for.cond95:                                       ; preds = %for.inc107, %for.body94
  ...
  %sub96 = sub nsw i32 %20, 1
  %cmp97 = icmp sle i32 %19, %sub96
