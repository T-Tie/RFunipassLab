...
entry:
  ...
  %smax15 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax15, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc12 ], [ 0, %entry ]
  %exitcond17 = icmp eq i64 %indvars.iv12, %wide.trip.count16
  br i1 %exitcond17, label %for.cond15, label %for.cond4
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv12, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond27 = icmp eq i64 %indvars.iv23, %wide.trip.count16
  br i1 %exitcond27, label %for.cond45, label %for.body19

for.body19:                                       ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv23
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv23
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc39, %for.body19
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc39 ], [ %indvars.iv18, %for.body19 ]
  %4 = trunc nuw i64 %indvars.iv20 to i32
  %cmp24.not = icmp slt i32 %sub, %4
  br i1 %cmp24.not, label %for.cond15.loopexit, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv20
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond32 = icmp eq i64 %indvars.iv28, %wide.trip.count16
  br i1 %exitcond32, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv28
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.09 = phi i32 [ %8, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.09)
  %smax36 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count37 = zext nneg i32 %smax36 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv33
