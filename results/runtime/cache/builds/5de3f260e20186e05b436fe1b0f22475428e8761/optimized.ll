...
define dso_local void @_Z2f1Piii(ptr noundef captures(none) %p, i32 noundef %n, i32 noundef %k) local_unnamed_addr #0 {
entry:
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc11
  %indvars.iv18 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next19, %for.inc11 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.end13, label %for.inc11

for.inc11:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw i32, ptr %p.tr, i64 %indvars.iv18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @_Z2f2Piii(ptr noundef captures(none) %p, i32 noundef %n, i32 noundef %k) local_unnamed_addr #0 {
entry:
  %smax = call i32 @llvm.smax.i32(i32 %n, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %tailrecurse
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc14
  %indvars.iv19 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next20, %for.inc14 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond24.not, label %for.end16, label %for.inc14

for.inc14:                                        ; preds = %for.cond5
  %add.ptr10.idx = mul nuw nsw i64 %indvars.iv19, 400
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc63
  %indvars.iv60 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next61, %for.inc63 ]
  %indvars.iv57 = phi i64 [ %4, %for.cond14.preheader ], [ %indvars.iv.next58, %for.inc63 ]
...
for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr noundef nonnull %a, i32 noundef %8, i32 noundef %8)
  call void @_Z2f2Piii(ptr noundef nonnull %a, i32 noundef %8, i32 noundef %8)
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body16
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc37 ], [ 0, %for.body16 ]
...
for.cond22:                                       ; preds = %for.cond19, %for.inc34
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc34 ], [ 1, %for.cond19 ]
...
for.cond40:                                       ; preds = %for.cond19, %for.inc60
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc60 ], [ 0, %for.cond19 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %indvars.iv57
  br i1 %exitcond56.not, label %for.inc63, label %for.cond44

for.cond44:                                       ; preds = %for.cond40, %for.inc57
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc57 ], [ 1, %for.cond40 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %indvars.iv57
  br i1 %exitcond51.not, label %for.inc60, label %for.inc57
