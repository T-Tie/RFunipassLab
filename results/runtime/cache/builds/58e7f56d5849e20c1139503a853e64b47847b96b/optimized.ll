...
for.cond:                                         ; preds = %for.inc139, %entry
  ...
  br i1 %cmp, label %for.cond1.preheader, label %for.end141
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  ...
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc10 ], [ 0, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv68, %2
  br i1 %cmp2, label %for.cond4.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  ...
  br i1 %cmp14, label %for.cond16.preheader, label %for.inc139

for.cond16.preheader:                             ; preds = %for.cond13
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc48
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc48 ], [ 0, %for.cond16.preheader ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %indvars.iv125
  br i1 %exitcond83.not, label %for.cond51.preheader, label %for.cond19.preheader
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.body21
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.body21 ], [ 0, %for.cond19.preheader ]
  %min.0 = phi i32 [ %spec.select, %for.body21 ], [ 100000, %for.cond19.preheader ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc86
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc86 ], [ 0, %for.cond51.preheader ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %indvars.iv125
  br i1 %exitcond98.not, label %for.end88, label %for.cond54.preheader

for.cond54.preheader:                             ; preds = %for.cond51
  br label %for.cond54

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.body56 ], [ 0, %for.cond54.preheader ]
  %min.2 = phi i32 [ %spec.select66, %for.body56 ], [ 100000, %for.cond54.preheader ]
...
for.cond91.loopexit:                              ; preds = %for.cond95
  br label %for.cond91, !llvm.loop !19

for.cond91:                                       ; preds = %for.cond91.loopexit, %for.end88
  %indvars.iv104 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next105, %for.cond91.loopexit ]
  %exitcond111.not = icmp eq i64 %indvars.iv104, %indvars.iv122
  br i1 %exitcond111.not, label %for.cond113.preheader, label %for.cond95.preheader

for.cond113.preheader:                            ; preds = %for.cond91
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  ...
  br i1 %exitcond103.not, label %for.cond91.loopexit, label %for.inc107
...
for.cond113.loopexit:                             ; preds = %for.cond116
  br label %for.cond113, !llvm.loop !21

for.cond113:                                      ; preds = %for.cond113.preheader, %for.cond113.loopexit
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.cond113.loopexit ], [ 1, %for.cond113.preheader ]
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  ...
  br i1 %exitcond116.not, label %for.cond113.loopexit, label %for.inc129
