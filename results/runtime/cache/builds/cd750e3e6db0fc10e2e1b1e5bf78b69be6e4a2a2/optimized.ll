...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv32, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond44.not, label %for.end33, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv35 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next36, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv39, i64 %indvars.iv35
...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc53 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.inc53 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.inc53 ], [ 0, %for.end33 ]
  %exitcond55.not = icmp eq i64 %indvars.iv51, %wide.trip.count43
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv45 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next46, %for.body39 ]
  %c.1 = phi i32 [ %c.0, %for.cond37.preheader ], [ %c.2, %for.body39 ]
  %d.1 = phi i32 [ %d.0, %for.cond37.preheader ], [ %d.2, %for.body39 ]
  %exitcond50.not = icmp eq i64 %indvars.iv45, %wide.trip.count
  br i1 %exitcond50.not, label %for.inc53, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv51, i64 %indvars.iv45
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !13
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv51, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv45, %11
  %or.cond30 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond30, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv45 to i32
  %d.2 = select i1 %or.cond30, i32 %12, i32 %d.1
