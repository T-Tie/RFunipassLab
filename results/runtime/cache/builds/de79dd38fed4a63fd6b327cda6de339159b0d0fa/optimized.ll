...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv24 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next25, %for.inc24 ]
  ...
  br i1 %exitcond29.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax34 = call i32 @llvm.smax.i32(i32 %number.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax34 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv30 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next31, %for.inc39 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond35.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv30, 0
...
if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv30
