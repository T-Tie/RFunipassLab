...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %sub32.sink = phi i32 [ %sub, %for.body31 ], [ %dec, %for.inc44 ]
  %cmp34 = icmp sge i32 %sub32.sink, 0
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idx.ext39 = sext i32 %sub32.sink to i64
...
for.end48:                                        ; preds = %for.cond29
  %r1.0.neg = sub i32 0, %r1.0
  %sub49 = add i32 %r1.0.neg, -1
  %sub50 = add i32 %sub49, %r2.0
  %c1.0.neg = sub i32 0, %c1.0
  %sub51 = add i32 %c1.0.neg, -1
  %sub52 = add i32 %sub51, %c2.0
