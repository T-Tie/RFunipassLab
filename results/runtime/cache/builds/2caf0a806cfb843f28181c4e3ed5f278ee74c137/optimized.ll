...
for.body82:                                       ; preds = %for.cond80
  ...
  %call86 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %31) #6
  br label %for.cond87
...
for.inc95:                                        ; preds = %for.cond87
  ...
  %call94 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %33) #6
