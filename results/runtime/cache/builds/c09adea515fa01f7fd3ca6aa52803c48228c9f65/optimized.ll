...
for.cond38:                                       ; preds = %for.inc49, %for.body36
  %sub.sink9 = phi i32 [ %sub, %for.body36 ], [ %dec, %for.inc49 ]
  %cmp39 = icmp sge i32 %sub.sink9, 0
  %idxprom51 = sext i32 %sub.sink to i64
  %idxprom53 = sext i32 %sub.sink9 to i64
...
for.end50.thread:                                 ; preds = %for.body40
  ...
  store i32 %sub.sink9, ptr %y2, align 4, !tbaa !5
  br label %for.end61
