...
for.cond4.loopexit:                               ; preds = %for.cond7
  br label %for.cond4, !llvm.loop !12

for.cond4:                                        ; preds = %for.cond4.loopexit, %for.cond4.preheader
  %indvars.iv40 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next41, %for.cond4.loopexit ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.cond4.loopexit ]
  %exitcond49.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond49.not, label %for.cond42.preheader, label %for.body6

for.cond42.preheader:                             ; preds = %for.cond4
  br label %for.cond42
...
for.cond7:                                        ; preds = %for.inc36, %for.body6
  ...
  br i1 %cmp8, label %for.cond10.preheader, label %for.cond4.loopexit
...
for.cond42:                                       ; preds = %for.cond42.preheader, %for.body44
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body44 ], [ 0, %for.cond42.preheader ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond42.preheader ]
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  ...
  br i1 %exitcond60.not, label %if.end83.loopexit, label %for.body62
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %putchar36 = call i32 @putchar(i32 noundef %conv73) #10
...
if.end83.loopexit:                                ; preds = %for.cond60
  br label %if.end83

if.end83:                                         ; preds = %if.end83.loopexit, %if.then56
