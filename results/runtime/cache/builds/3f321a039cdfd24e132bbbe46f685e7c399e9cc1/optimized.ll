...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv12 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next13, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax28 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count29 = zext nneg i32 %smax28 to i64
  %wide.trip.count22 = zext i32 %j.0 to i64
  br label %for.cond15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv12
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond30.not = icmp eq i64 %indvars.iv24, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv24
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc37 ], [ %indvars.iv16, %for.body17 ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv18
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv31 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next32, %for.inc53 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count29
  br i1 %exitcond35.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv31
  ...
  %cmp49 = icmp slt i64 %indvars.iv31, %4
