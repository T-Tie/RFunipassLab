...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond90.not, label %for.cond45, label %for.body16
...
for.cond22:                                       ; preds = %for.inc39, %for.body16
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc39 ], [ 0, %for.body16 ]
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond101.not = icmp eq i64 %indvars.iv96, %wide.trip.count89
  br i1 %exitcond101.not, label %for.cond70, label %for.cond49.preheader
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond112.not = icmp eq i64 %indvars.iv107, %wide.trip.count89
  br i1 %exitcond112.not, label %for.cond104, label %for.body73
...
for.cond79:                                       ; preds = %for.inc98, %for.body73
  %indvars.iv102 = phi i64 [ %indvars.iv.next103, %for.inc98 ], [ 0, %for.body73 ]
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond134.not, label %for.cond154, label %for.cond135
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv140 = phi i64 [ %indvars.iv.next141, %for.inc174 ], [ 0, %for.cond131 ]
