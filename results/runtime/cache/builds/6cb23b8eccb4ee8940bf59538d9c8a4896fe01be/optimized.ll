...
for.cond4:                                        ; preds = %for.cond7, %for.cond4.preheader
  ...
  br i1 %exitcond25.not, label %for.cond42, label %for.body6
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  ...
  %indvars.iv14 = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv.next15, %for.inc23 ]
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %putchar12 = call i32 @putchar(i32 noundef %conv73) #7
