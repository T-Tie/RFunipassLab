...
for.inc42.gvnsink.split:                          ; preds = %if.else, %for.body15
  %arrayidx34 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom25
  %arrayidx36 = getelementptr inbounds [100 x i32], ptr %arrayidx34, i64 0, i64 %idxprom27
...
for.inc83.gvnsink.split:                          ; preds = %if.else64, %for.body53
  %arrayidx74 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom65
  %arrayidx76 = getelementptr inbounds [100 x i32], ptr %arrayidx74, i64 0, i64 %idxprom67
