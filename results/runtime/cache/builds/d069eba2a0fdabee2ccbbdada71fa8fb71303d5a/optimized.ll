...
for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc27 ], [ 0, %tailrecurse ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv9
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc24 ], [ 0, %for.cond16.preheader ]
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv4
...
for.cond31:                                       ; preds = %for.cond, %for.inc70
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc70 ], [ 0, %for.cond ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count12
  br i1 %exitcond29.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv24
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select2, %for.body42 ], [ %3, %for.body34 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv24
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %spec.select2 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  br label %for.cond39, !llvm.loop !17

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc67 ], [ 0, %for.cond58.preheader ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.inc70, label %for.inc67

for.inc67:                                        ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv24
