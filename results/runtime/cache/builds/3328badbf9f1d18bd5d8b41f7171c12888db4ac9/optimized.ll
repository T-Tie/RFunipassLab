...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv27.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv27, %for.cond17 ]
  %e.0.in = phi i32 [ %0, %for.cond14.preheader ], [ %e.0, %for.cond17 ]
  %indvars.iv27 = add i32 %indvars.iv27.in, -1
  %e.0 = add nsw i32 %e.0.in, -1
  %cmp15 = icmp sgt i32 %e.0.in, 0
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv23 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next24, %for.inc37 ]
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv31, %8
...
for.inc50:                                        ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %9) #6
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %10) #6
