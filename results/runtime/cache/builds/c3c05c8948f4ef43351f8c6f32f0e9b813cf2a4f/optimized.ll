...
entry:
  ...
  %sqrtf = call float @sqrtf(float noundef -1.000000e+00) #10
  br label %for.cond
...
if.then:                                          ; preds = %for.body
  ...
  %call34 = call double @sqrt(double noundef %6) #11, !tbaa !5
...
if.else:                                          ; preds = %for.body
  ...
  %call67 = call double @sqrt(double noundef %8) #11, !tbaa !5
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i1 = call i32 @getc(ptr noundef %19) #12
  %20 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i2 = call i32 @getc(ptr noundef %20) #12
...
attributes #10 = { nounwind memory(write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
