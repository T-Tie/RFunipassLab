...
entry:
  ...
  %vtable.i30 = load ptr, ptr @_ZSt4cout, align 8
  %vbase.offset.ptr.i31 = getelementptr i8, ptr %vtable.i30, i64 -24
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %count.0 = phi i64 [ 0, %entry ], [ %count.1, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull %s) #9
  %vbase.offset9.i = load i64, ptr %vbase.offset.ptr8.i, align 8, !invariant.load !9
  %add.ptr10.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(41) %s, i64 noundef 41)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %cmp2 = icmp eq i32 %i.0, 1
  br i1 %cmp2, label %if.then, label %if.else

if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #9
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(41) %s, i64 noundef %call.i.i)
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #10
  br label %for.inc
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #10
  %add = add nsw i64 %conv7, 1
  %add10 = add i64 %call9, %add
...
if.then12:                                        ; preds = %if.else
  ...
  store i8 32, ptr %__c.addr.i, align 1, !tbaa !30
  %vbase.offset.i8 = load i64, ptr %vbase.offset.ptr.i31, align 8, !invariant.load !9
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i8
  %5 = load i64, ptr %gep, align 8, !tbaa !21, !invariant.load !9
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  %retval.0.i = phi ptr [ %call1.i11, %if.then.i ], [ @_ZSt4cout, %if.end.i ]
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i)
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #9
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull align 16 dereferenceable(41) %s, i64 noundef %call.i.i13)
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #10
  %add20 = add i64 %call17, %add
  br label %for.inc

if.else22:                                        ; preds = %if.else
  %vbase.offset.i32 = load i64, ptr %vbase.offset.ptr.i31, align 8, !invariant.load !9
  %add.ptr.i33 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i32
  %call.i34 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i33, i8 noundef signext 10)
  ...
  %call.i.i22 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #9
  %call1.i23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i36, ptr noundef nonnull align 16 dereferenceable(41) %s, i64 noundef %call.i.i22)
  %call27 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #10
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else22, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %count.1 = phi i64 [ %call6, %if.then ], [ %add20, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %call27, %if.else22 ]
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull %s) #9
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !10, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !34, !invariant.load !9
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !37, !invariant.load !9
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !30, !invariant.load !9
  %conv.i = zext i8 %2 to i32
  br label %if.end

if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !38, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !40, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !41, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !30, !invariant.load !9
  br label %return
...
!34 = !{!35, !36, i64 16}
!35 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !36, i64 8, !36, i64 16, !36, i64 24, !36, i64 32, !36, i64 40, !36, i64 48, !19, i64 56}
...
!40 = !{!23, !27, i64 240}
!41 = !{!42, !7, i64 56}
!42 = !{!"_ZTSSt5ctypeIcE", !43, i64 0, !44, i64 16, !25, i64 24, !45, i64 32, !45, i64 40, !46, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
