...
for.cond14:                                       ; preds = %if.end58, %for.end9
  ...
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %if.end58 ], [ 1, %for.end9 ]
  %5 = sext i32 %4 to i64
  %cmp15 = icmp slt i64 %indvars.iv28, %5
  br i1 %cmp15, label %for.body16, label %for.end61

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [1000 x [2 x double]], ptr %sv, i64 0, i64 %indvars.iv28
...
if.else:                                          ; preds = %for.body16
  ...
  %or.cond23 = and i1 %cmp43, %cmp53
  %str.3.str = select i1 %or.cond23, ptr @str.3, ptr @str
  br label %if.end58

if.end58:                                         ; preds = %if.else, %for.body16
  %str.3.sink = phi ptr [ @str.4, %for.body16 ], [ %str.3.str, %if.else ]
  %puts24 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.3.sink) #6
