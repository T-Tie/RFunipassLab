...
if.then.i.i:                                      ; preds = %for.cond.cleanup
  ...
  %1 = call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %sub.ptr.div.i.i, i1 true)
...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.cond.cleanup, %if.then.i.i
  %2 = load i32, ptr %a, align 16, !tbaa !5
  %call7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %2)
