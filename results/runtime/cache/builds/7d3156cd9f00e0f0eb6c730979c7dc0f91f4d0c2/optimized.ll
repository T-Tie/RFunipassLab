...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %4, %cond.true ], [ %min.3, %cond.false ]
  br label %if.end

if.end:                                           ; preds = %cond.end, %if.then
  %min.4 = phi i32 [ %3, %if.then ], [ %cond, %cond.end ]
  br label %for.inc41
...
cond.end87:                                       ; preds = %cond.false86, %cond.true81
  %cond88 = phi i32 [ %7, %cond.true81 ], [ %min.6, %cond.false86 ]
  br label %if.end89

if.end89:                                         ; preds = %cond.end87, %if.then70
  %min.7 = phi i32 [ %6, %if.then70 ], [ %cond88, %cond.end87 ]
  br label %for.inc90
