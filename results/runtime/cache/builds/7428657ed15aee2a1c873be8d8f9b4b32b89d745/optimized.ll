...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count25 = zext i32 %3 to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre27, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv11, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv20 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next21, %for.cond13 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv20, i64 %indvars.iv14
  %9 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp eq i32 %9, 0
  %10 = add nuw nsw i64 %indvars.iv14, 1
  br i1 %cmp20, label %land.lhs.true, label %for.inc53

land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv20, i64 %10
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  %arrayidx31 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv.next21, i64 %indvars.iv14
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %14 = add nsw i64 %indvars.iv14, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv20, i64 %14
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  %arrayidx49 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %6, i64 %indvars.iv14
  %16 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %cmp50 = icmp eq i32 %16, 0
  %spec.select8 = select i1 %cmp50, i32 %8, i32 %x2.1
  %17 = trunc nuw nsw i64 %indvars.iv14 to i32
...
for.end58:                                        ; preds = %for.cond10
  %sub59 = sub i32 %x2.0, %x1.0
  %add60 = add i32 %sub59, 1
  %reass.sub = sub i32 %y2.0, %y1.0
  %add62 = add i32 %reass.sub, 1
  %mul = mul nsw i32 %add62, %add60
  %sub63.neg = add i32 %y1.0, 2147483646
  %18 = add i32 %sub59, %y2.0
  %reass.add.neg = sub i32 %sub63.neg, %18
