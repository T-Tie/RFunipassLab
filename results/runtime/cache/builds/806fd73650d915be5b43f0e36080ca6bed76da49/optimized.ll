...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit17: ; preds = %if.then34
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i5)
  br label %for.inc41
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit33: ; preds = %if.else37
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i21)
  br label %for.inc41
