...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1000, ptr noundef align 16 %a) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %flag) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef align 16 %b) #6
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %b, i8 noundef 0, i64 noundef 4000, i1 noundef false) #7
...
for.body13:                                       ; preds = %for.cond10
  ...
  %4 = load i8, ptr %arrayidx15, align 1, !tbaa !12
  ...
  %7 = load i32, ptr %flag, align 4, !tbaa !5
  br i1 %cmp20, label %if.then, label %for.inc23

if.then:                                          ; preds = %for.body13
  store i32 %7, ptr %w, align 4, !tbaa !5
  store i32 0, ptr %flag, align 4, !tbaa !5
  br label %for.end25
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %18 = load i8, ptr %arrayidx72, align 1, !tbaa !12
  %conv73 = sext i8 %18 to i32
  %call74 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %conv73) #9
  %inc76 = add nsw i32 %16, 1
  store i32 %inc76, ptr %j, align 4, !tbaa !5
  br label %for.cond67, !llvm.loop !18

for.end77:                                        ; preds = %for.cond67
  %call78 = call i32 (ptr, ...) @printf(ptr noundef @.str.5) #9
  br label %for.inc80

for.inc80:                                        ; preds = %for.body62, %for.end77
  %inc81 = add nsw i32 %.sink10, 1
  br label %for.cond60, !llvm.loop !19

if.end83:                                         ; preds = %for.cond60, %if.then56
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %max) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %w) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %flag) #9
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef %a) #9
  ret i32 0
}
