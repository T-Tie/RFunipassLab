...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %sum) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr %efficient) #9
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 8, ptr %efficient) #9
  call void @llvm.lifetime.end.p0(i64 8, ptr %sum) #9
