...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  ...
  %lenq.0 = phi i64 [ %indvars.iv30, %if.end44 ], [ %indvars.iv, %while.cond4.preheader ]
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv30
...
for.cond:                                         ; preds = %while.end19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %while.end19 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %idx.ext6
  br i1 %exitcond40.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv36
  ...
  %gep28 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %6 = load i64, ptr %gep28, align 8, !tbaa !17
...
for.cond33:                                       ; preds = %while.end19, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18 ], [ 0, %while.end19 ]
  %exitcond.not = icmp eq i64 %indvars.iv33, %idx.ext6
  br i1 %exitcond.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %add.ptr38 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv33
  ...
  %vtable.i7 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !15
  %vbase.offset.ptr.i8 = getelementptr i8, ptr %vtable.i7, i64 -24
  %vbase.offset.i9 = load i64, ptr %vbase.offset.ptr.i8, align 8, !invariant.load !13
...
for.end42:                                        ; preds = %for.cond33
  %vtable.i19 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !15
...
if.end44:                                         ; preds = %for.end, %if.then31, %for.end42
  %len.1 = phi i32 [ %inc20, %if.then31 ], [ %inc20, %for.end ], [ %4, %for.end42 ]
