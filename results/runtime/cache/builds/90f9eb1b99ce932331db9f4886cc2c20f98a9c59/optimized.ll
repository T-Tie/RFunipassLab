...
for.cond:                                         ; preds = %entry, %if.end
  %i.0 = phi i32 [ %inc, %if.end ], [ 2, %entry ]
  %sum.0 = phi i32 [ %sum.1, %if.end ], [ 1, %entry ]
...
for.cond4:                                        ; preds = %entry, %if.end14
  %i.1 = phi i32 [ %inc16, %if.end14 ], [ %n, %entry ]
  %sum.3 = phi i32 [ %sum.4, %if.end14 ], [ 1, %entry ]
...
for.cond3:                                        ; preds = %for.cond, %for.body5
  %3 = phi i32 [ %.pre, %for.body5 ], [ %0, %for.cond ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.body5 ], [ 0, %for.cond ]
  %4 = sext i32 %3 to i64
