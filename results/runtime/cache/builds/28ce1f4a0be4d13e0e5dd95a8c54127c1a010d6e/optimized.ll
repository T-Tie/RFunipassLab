...
for.cond6:                                        ; preds = %for.cond, %for.inc100
  %2 = phi i32 [ %.pre, %for.inc100 ], [ %0, %for.cond ]
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc100 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp7 = icmp slt i64 %indvars.iv39, %3
  br i1 %cmp7, label %for.body8, label %for.end102

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv39
  %4 = load double, ptr %arrayidx10, align 8, !tbaa !12, !invariant.load !14
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %a, i64 0, i64 %indvars.iv39
  %5 = load double, ptr %arrayidx14, align 8, !tbaa !12, !invariant.load !14
  %mul15 = fmul double %5, 4.000000e+00
  %arrayidx17 = getelementptr inbounds nuw [100 x double], ptr %c, i64 0, i64 %indvars.iv39
  ...
  %cmp23 = fcmp ugt double %9, 0x3EB0C6F7A0B5ED8D
  br i1 %cmp23, label %if.else, label %if.then
...
if.else:                                          ; preds = %for.body8
  %cmp31 = fcmp ogt double %8, 0x3EB0C6F7A0B5ED8D
...
if.else62:                                        ; preds = %if.else
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div69, double noundef %div79)
  %call97 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %div69, double noundef %div79)
  br label %for.inc100

for.inc100:                                       ; preds = %if.then, %if.else62, %if.then32
