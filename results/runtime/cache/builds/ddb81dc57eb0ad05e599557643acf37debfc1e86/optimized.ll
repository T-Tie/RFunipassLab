...
for.cond:                                         ; preds = %for.inc15, %entry
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc15 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv2, i64 %indvars.iv
...
for.inc15:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv2
  ...
  %div = fdiv double %3, %4
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv2
  store double %div, ptr %arrayidx14, align 8, !tbaa !12
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  br label %for.cond, !llvm.loop !15

for.cond18:                                       ; preds = %for.cond18.preheader, %for.body21
  %5 = phi i32 [ %0, %for.cond18.preheader ], [ %.pre, %for.body21 ]
  %indvars.iv5 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next6, %for.body21 ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv5, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv5
  ...
  %.str.1..str.2 = select i1 %cmp33, ptr @.str.1, ptr @.str.2
  %.str.sink = select i1 %cmp26, ptr @.str, ptr %.str.1..str.2
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.sink)
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) %call27, i8 noundef signext 10)
