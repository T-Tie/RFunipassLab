...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv66, %1
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax76 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc45
  %indvars.iv72 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next73, %for.inc45 ]
  %exitcond78.not = icmp eq i64 %indvars.iv72, %wide.trip.count77
  br i1 %exitcond78.not, label %for.cond48.preheader, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx30 = getelementptr inbounds nuw [10 x i32], ptr %b, i64 0, i64 %indvars.iv72
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv72
  %arrayidx40 = getelementptr inbounds nuw [10 x i32], ptr %c, i64 0, i64 %indvars.iv72
  %5 = trunc nuw nsw i64 %indvars.iv72 to i32
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc42
  %indvars.iv69 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next70, %for.inc42 ]
  %exitcond.not = icmp eq i64 %indvars.iv69, %wide.trip.count
  br i1 %exitcond.not, label %for.inc45, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %cmp16 = icmp eq i64 %indvars.iv69, 0
...
if.else:                                          ; preds = %for.body15
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv69
...
for.inc42.gvnsink.split:                          ; preds = %if.else, %if.then
  %storemerge100 = phi i32 [ %6, %if.then ], [ %7, %if.else ]
  store i32 %storemerge100, ptr %arrayidx30, align 4, !tbaa !5
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc86
  %indvars.iv84 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next85, %for.inc86 ]
  %exitcond89.not = icmp eq i64 %indvars.iv84, %wide.trip.count88
  br i1 %exitcond89.not, label %for.cond89, label %for.cond51.preheader

for.cond51.preheader:                             ; preds = %for.cond48
  %arrayidx70 = getelementptr inbounds nuw [10 x i32], ptr %d, i64 0, i64 %indvars.iv84
  %arrayidx59 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv84
  %arrayidx80 = getelementptr inbounds nuw [10 x i32], ptr %e, i64 0, i64 %indvars.iv84
  %9 = trunc nuw nsw i64 %indvars.iv84 to i32
  br label %for.cond51

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc83
  %indvars.iv79 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next80, %for.inc83 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %wide.trip.count77
  br i1 %exitcond83.not, label %for.inc86, label %for.body53

for.body53:                                       ; preds = %for.cond51
  %cmp54 = icmp eq i64 %indvars.iv79, 0
...
if.else64:                                        ; preds = %for.body53
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv79, i64 %indvars.iv84
...
for.cond89:                                       ; preds = %for.cond48, %for.inc110
  %.pre9697 = phi i32 [ %.pre9698, %for.inc110 ], [ %2, %for.cond48 ]
  %13 = phi i32 [ %16, %for.inc110 ], [ %2, %for.cond48 ]
  %14 = phi i32 [ %.pre, %for.inc110 ], [ %0, %for.cond48 ]
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc110 ], [ 0, %for.cond48 ]
  %i.0 = phi i32 [ %i.1, %for.inc110 ], [ 0, %for.cond48 ]
  %15 = sext i32 %14 to i64
  %cmp90 = icmp slt i64 %indvars.iv93, %15
  br i1 %cmp90, label %for.cond92.preheader, label %for.end112

for.cond92.preheader:                             ; preds = %for.cond89
  %arrayidx96 = getelementptr inbounds nuw [10 x i32], ptr %b, i64 0, i64 %indvars.iv93
  %arrayidx102 = getelementptr inbounds nuw [10 x i32], ptr %c, i64 0, i64 %indvars.iv93
  br label %for.cond92

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  %.pre9698 = phi i32 [ %.pre9697, %for.cond92.preheader ], [ %.pre96, %for.inc107 ]
  %16 = phi i32 [ %13, %for.cond92.preheader ], [ %.pre96, %for.inc107 ]
  %indvars.iv90 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next91, %for.inc107 ]
  %i.1 = phi i32 [ %i.0, %for.cond92.preheader ], [ %i.2, %for.inc107 ]
  %17 = sext i32 %16 to i64
  %cmp93 = icmp slt i64 %indvars.iv90, %17
  br i1 %cmp93, label %for.body94, label %for.inc110

for.body94:                                       ; preds = %for.cond92
  %18 = load i32, ptr %arrayidx96, align 4, !tbaa !5
  %arrayidx98 = getelementptr inbounds nuw [10 x i32], ptr %d, i64 0, i64 %indvars.iv90
...
if.then100:                                       ; preds = %for.body94
  ...
  %arrayidx104 = getelementptr inbounds nuw [10 x i32], ptr %e, i64 0, i64 %indvars.iv90
  %21 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %call105 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %20, i32 noundef %21) #6
  %.pre96.pre = load i32, ptr %col, align 4, !tbaa !5
  br label %for.inc107

for.inc107:                                       ; preds = %for.body94, %if.then100
  %.pre96 = phi i32 [ %.pre96.pre, %if.then100 ], [ %.pre9698, %for.body94 ]
