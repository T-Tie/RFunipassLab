...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv6, i32 1
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv10 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next11, %for.inc40 ]
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %4 = trunc nuw i64 %indvars.iv.next11 to i32
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next11
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv18, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc74 ], [ %indvars.iv13, %for.body48 ]
  %9 = icmp slt i64 %indvars.iv15, %1
  br i1 %9, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv15, i32 1
