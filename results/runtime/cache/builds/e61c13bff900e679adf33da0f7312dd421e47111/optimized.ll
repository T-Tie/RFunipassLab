...
entry:
  ...
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef align 4 %n, ptr noundef align 4 %a, ptr noundef align 4 %b, ptr noundef align 4 %t)
...
if.else6:                                         ; preds = %land.lhs.true, %for.body
...
land.lhs.true8:                                   ; preds = %if.else6
  ...
  %cmp9 = icmp sgt i32 %3, %6
  br i1 %cmp9, label %for.inc, label %if.else11

if.else11:                                        ; preds = %land.lhs.true8, %if.else6
  %7 = load i32, ptr %b, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true8, %if.then5, %if.else11
  %.sink = phi i32 [ %7, %if.else11 ], [ %4, %if.then5 ], [ %3, %land.lhs.true8 ]
...
for.end:                                          ; preds = %for.cond
  ...
  %call14 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %8)
  %9 = load i32, ptr %b, align 4, !tbaa !5
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %9)
