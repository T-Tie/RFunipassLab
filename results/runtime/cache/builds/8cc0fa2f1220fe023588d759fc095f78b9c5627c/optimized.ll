...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next10, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv9, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  %3 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %smax22 = add nsw i32 %3, -1
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv13 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next14, %for.inc40 ]
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  %4 = trunc nuw i64 %indvars.iv.next14 to i32
  %cmp14 = icmp sgt i32 %0, %4
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 8, !tbaa !15, !invariant.load !16
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next14
  %6 = load i32, ptr %arrayidx20, align 8, !tbaa !15, !invariant.load !16
  %cmp22.not = icmp slt i32 %5, %6
  br i1 %cmp22.not, label %for.inc40, label %if.then

if.then:                                          ; preds = %for.body15
  %7 = load i32, ptr %h25, align 4, !tbaa !12, !invariant.load !16
  %h28 = getelementptr inbounds nuw i8, ptr %arrayidx20, i64 4
  %8 = load i32, ptr %h28, align 4, !tbaa !12, !invariant.load !16
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc77
  %indvars.iv16 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next17, %for.inc77 ]
  %exitcond24.not = icmp eq i64 %indvars.iv16, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end79, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv16, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc74
  %indvars.iv18 = phi i64 [ %indvars.iv16, %for.cond50.preheader ], [ %indvars.iv.next19, %for.inc74 ]
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %9 = trunc nuw i64 %indvars.iv.next19 to i32
  %cmp51 = icmp sgt i32 %0, %9
  br i1 %cmp51, label %for.body52, label %for.inc77

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next19, i32 1
  %11 = load i32, ptr %h58, align 4, !tbaa !12, !invariant.load !16
...
for.end79:                                        ; preds = %for.cond45
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %12) #6
