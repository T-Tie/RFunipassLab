...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %k) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %j) #9
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %num) #9
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %num, i8 noundef 0, i64 noundef 80000, i1 noundef false) #10
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef align 4 %n)
  %call1 = call noundef double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 noundef -1) #11
...
for.body:                                         ; preds = %for.cond
  ...
  %mul19 = fmul double 4.000000e+00, %2
  %mul20 = fmul double %mul19, %4
  %neg = fneg double %mul20
  %5 = call double @llvm.fmuladd.f64(double %3, double %3, double %neg)
  %cmp21 = fcmp oge double %5, 0.000000e+00
  br i1 %cmp21, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %fneg = fneg double %3
  %call25 = call double @sqrt(double noundef %5) #12, !tbaa !5
  ...
  %call34 = call double @sqrt(double noundef %5) #12, !tbaa !5
...
if.else46:                                        ; preds = %if.else
  ...
  %mul48 = fmul double 2.000000e+00, %2
...
if.end:                                           ; preds = %if.else, %if.else46
  ...
  %mul55 = fmul double %3, %3
  %neg56 = fneg double %mul55
  %6 = call double @llvm.fmuladd.f64(double %mul19, double %4, double %neg56)
  %call57 = call double @sqrt(double noundef %6) #12, !tbaa !5
  %mul58 = fmul double 2.000000e+00, %2
  ...
  %call67 = call double @sqrt(double noundef %6) #12, !tbaa !5
...
for.cond74:                                       ; preds = %for.inc132, %for.end
  ...
  %sub75 = sub nsw i32 %8, 1
  %cmp76 = icmp sle i32 %7, %sub75
  br i1 %cmp76, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %idxprom78 = sext i32 %7 to i64
  ...
  %9 = load double, ptr %arrayidx80, align 8, !tbaa !9
  %10 = load double, ptr %arrayidx79, align 16, !tbaa !9
  %mul88 = fmul double 4.000000e+00, %10
  %arrayidx91 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 2
  %11 = load double, ptr %arrayidx91, align 16, !tbaa !9
  %mul92 = fmul double %mul88, %11
  %neg93 = fneg double %mul92
  %12 = call double @llvm.fmuladd.f64(double %9, double %9, double %neg93)
  %cmp94 = fcmp oge double %12, 0.000000e+00
  %13 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 3
  %14 = load double, ptr %13, align 8, !tbaa !9
  %15 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %16 = load double, ptr %15, align 16, !tbaa !9
  br i1 %cmp94, label %if.then95, label %if.else117

if.then95:                                        ; preds = %for.body77
  %arrayidx98 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 3
  %arrayidx101 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %cmp102 = fcmp une double %14, %16
  br i1 %cmp102, label %if.then103, label %if.else111

if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %14, double noundef %16) #11
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %14) #11
  br label %for.inc132

if.else117:                                       ; preds = %for.body77
  %arrayidx120 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 3
  %arrayidx123 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %arrayidx129 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 5
  %17 = load double, ptr %arrayidx129, align 8, !tbaa !9
  %call130 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %14, double noundef %16, double noundef %14, double noundef %17) #11
  br label %for.inc132

for.inc132:                                       ; preds = %if.else117, %if.else111, %if.then103
  %inc133 = add nsw i32 %7, 1
  store i32 %inc133, ptr %j, align 4, !tbaa !5
  br label %for.cond74, !llvm.loop !14

for.end134:                                       ; preds = %for.cond74
  %call135 = call i32 @getchar() #11
  %call136 = call i32 @getchar() #11
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %num) #11
...
entry:
  ...
  %call = call double @sqrt(double noundef %conv) #12, !tbaa !5
  ret double %call
}
...
attributes #8 = { inlinehint mustprogress nofree nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #9 = { nofree nounwind }
attributes #10 = { nofree }
attributes #11 = { nounwind }
attributes #12 = { nounwind memory(write) }
