...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100000, ptr %a) #8
  br label %for.cond
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 100000, ptr %a) #8
  ret i32 0
}
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  call void @llvm.lifetime.start.p0(i64 4, ptr %__c) #8
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %ref.tmp) #8
  %call26 = call noundef i32 @_ZNSt11char_traitsIcE3eofEv() #8
  store i32 %call26, ptr %ref.tmp, align 4, !tbaa !12
  %call27 = call noundef zeroext i1 @_ZNSt11char_traitsIcE11eq_int_typeERKiS2_(ptr noundef nonnull align 4 dereferenceable(4) %__c, ptr noundef nonnull align 4 dereferenceable(4) %ref.tmp) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr %ref.tmp) #8
...
if.end:                                           ; preds = %if.then28, %if.then19
  call void @llvm.lifetime.end.p0(i64 4, ptr %__c) #8
  br label %if.end38
