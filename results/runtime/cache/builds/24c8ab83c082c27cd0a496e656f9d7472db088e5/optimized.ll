...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %or.cond11, label %if.then, label %if.else80

if.then:                                          ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n2) #7
  store i32 0, ptr %n2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %M) #7
  %3 = load i32, ptr %m1, align 4, !tbaa !5
  %smax13 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc, %if.then
  %storemerge12 = phi i32 [ 1, %if.then ], [ %inc, %for.inc ]
  %n1.0 = phi i32 [ 0, %if.then ], [ %add, %for.inc ]
  %exitcond14.not = icmp eq i32 %storemerge12, %smax13
  br i1 %exitcond14.not, label %if.end79, label %for.body9

for.body9:                                        ; preds = %for.cond7
  switch i32 %storemerge12, label %if.else27 [
    i32 2, label %for.inc
...
for.inc:                                          ; preds = %for.body9, %if.else27, %if.then25
  ...
  %inc = add nuw i32 %storemerge12, 1
  br label %for.cond7, !llvm.loop !9

if.end79:                                         ; preds = %for.cond7
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n2, i32 noundef 29, i32 %n1.0, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %M) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %M) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %j) #7
  br label %for.inc164

if.else80:                                        ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j81) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n283) #7
  store i32 0, ptr %n283, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %M84) #7
...
for.inc109:                                       ; preds = %for.body87, %if.else105, %if.then103
  %.sink15 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ], [ 28, %for.body87 ]
  %add90 = add nuw nsw i32 %n182.0, %.sink15
  %inc110 = add nuw i32 %storemerge, 1
  br label %for.cond85, !llvm.loop !12

if.end162:                                        ; preds = %for.cond85
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j81, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n283, i32 noundef 28, i32 %n182.0, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %M84) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %M84) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n283) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %j81) #7
  br label %for.inc164
...
for.cond30:                                       ; preds = %for.inc56, %for.end_to_outline
  %7 = phi i32 [ %.promoted, %for.end_to_outline ], [ %add35, %for.inc56 ]
...
for.inc56:                                        ; preds = %for.body32, %if.else52, %if.then50
  %.sink = phi i32 [ 30, %if.else52 ], [ 31, %if.then50 ], [ %3, %for.body32 ]
  %add35 = add nsw i32 %7, %.sink
...
for.end58:                                        ; preds = %for.cond30
  %smax = call i32 @llvm.smax.i32(i32 %6, i32 noundef 1) #8
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts1 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.str) #7
  br label %if.end68
...
if.then70:                                        ; preds = %if.end68
  ...
  %puts3 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.4.str.3) #7
