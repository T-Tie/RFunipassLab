...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax47 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
  %smax53 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc24 ], [ 0, %for.cond13 ]
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv37, i64 %indvars.iv34
...
for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv50, i64 %indvars.iv44
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc51
  %indvars.iv40 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next41, %for.inc51 ]
...
for.inc51:                                        ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv40
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !15
  %arrayidx46 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv40, i64 %indvars.iv44
...
for.cond60:                                       ; preds = %for.cond30, %for.inc78
  ...
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc78 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp61 = icmp slt i64 %indvars.iv59, %14
  br i1 %cmp61, label %for.cond64, label %for.end80

for.cond64:                                       ; preds = %for.cond60, %for.inc75
  %15 = phi i32 [ %.pre62, %for.inc75 ], [ %12, %for.cond60 ]
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc75 ], [ 0, %for.cond60 ]
  %16 = sext i32 %15 to i64
  %cmp65 = icmp slt i64 %indvars.iv56, %16
  br i1 %cmp65, label %for.body66, label %for.inc78

for.body66:                                       ; preds = %for.cond64
  %arrayidx70 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv59, i64 %indvars.iv56
  ...
  %cmp72.not = icmp eq i64 %indvars.iv56, %19
