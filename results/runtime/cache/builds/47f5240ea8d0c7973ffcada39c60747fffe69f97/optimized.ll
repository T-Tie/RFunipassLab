...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc13
  %indvars.iv91 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next92, %for.inc13 ]
  %exitcond.not = icmp eq i64 %indvars.iv91, %wide.trip.count
...
for.inc13:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv91
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #10
  %6 = trunc i64 %call10 to i32
  %conv = add i32 %6, 1
  %add.ptr12 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv91
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc42
  %.pre107 = phi i32 [ %0, %for.cond16.preheader ], [ %.pre, %for.inc42 ]
  %indvars.iv98 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next99, %for.inc42 ]
  %sum.0 = phi i32 [ 0, %for.cond16.preheader ], [ %sum.1, %for.inc42 ]
  %k.0 = phi i32 [ 0, %for.cond16.preheader ], [ %k.1, %for.inc42 ]
  %7 = sext i32 %.pre107 to i64
  %cmp17 = icmp slt i64 %indvars.iv98, %7
...
for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv98
...
for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv95 = phi i64 [ %11, %for.cond23.preheader ], [ %indvars.iv.next96, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv95, %10
  br i1 %cmp24, label %for.body25, label %for.end33

for.body25:                                       ; preds = %for.cond23
  %add.ptr27 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv95
  ...
  store i8 32, ptr %__c.addr.i, align 1, !tbaa !34
  ...
  %12 = load i64, ptr %gep, align 8, !tbaa !10, !invariant.load !9
...
for.inc31:                                        ; preds = %if.end.i, %if.then.i
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i)
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1
  br label %for.cond23, !llvm.loop !35

for.end33:                                        ; preds = %for.cond23
  %gep87 = getelementptr [41 x i8], ptr %invariant.gep, i64 %indvars.iv98
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %gep87) #9
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %gep87, i64 noundef %call.i.i13)
  %vbase.offset.i55 = load i64, ptr %vbase.offset.ptr.i54, align 8, !invariant.load !9
...
for.inc42:                                        ; preds = %for.body18, %for.end33
  %.pre = phi i32 [ %.pre.pre, %for.end33 ], [ %.pre107, %for.body18 ]
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc54
  %14 = phi i32 [ %.pre107, %for.cond45.preheader ], [ %.pre106, %for.inc54 ]
  %indvars.iv103 = phi i64 [ %8, %for.cond45.preheader ], [ %indvars.iv.next104, %for.inc54 ]
  %sub46 = add nsw i32 %14, -1
  %15 = sext i32 %sub46 to i64
  %cmp47 = icmp slt i64 %indvars.iv103, %15
  br i1 %cmp47, label %for.body48, label %for.end56

for.body48:                                       ; preds = %for.cond45
  %add.ptr50 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv103
  %call.i.i22 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr50) #9
  %call1.i23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr50, i64 noundef %call.i.i22)
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i30)
  store i8 32, ptr %__c.addr.i30, align 1, !tbaa !34
  %vbase.offset.i33 = load i64, ptr %vbase.offset.ptr.i32, align 8, !invariant.load !9
  %gep88 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i33
  %16 = load i64, ptr %gep88, align 8, !tbaa !10, !invariant.load !9
  %cmp.not.i36 = icmp eq i64 %16, 0
  br i1 %cmp.not.i36, label %if.end.i40, label %if.then.i37

if.then.i37:                                      ; preds = %for.body48
  %call1.i38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i30, i64 noundef 1)
  br label %for.inc54

if.end.i40:                                       ; preds = %for.body48
  %call2.i41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %for.inc54

for.inc54:                                        ; preds = %if.end.i40, %if.then.i37
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i30)
  %indvars.iv.next104 = add nuw nsw i64 %indvars.iv103, 1
  %.pre106 = load i32, ptr %n, align 4, !tbaa !5
...
for.end56:                                        ; preds = %for.cond45
  ...
  %call.i.i44 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr59) #9
  %call1.i45 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %add.ptr59, i64 noundef %call.i.i44)
  %vbase.offset.i62 = load i64, ptr %vbase.offset.ptr.i32, align 8, !invariant.load !9
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !21, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !38, !invariant.load !9
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !41, !invariant.load !9
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !34, !invariant.load !9
  %conv.i = zext i8 %2 to i32
  br label %if.end

if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !42, !invariant.load !9
  %vfn = getelementptr inbounds nuw i8, ptr %vtable, i64 72
  %3 = load ptr, ptr %vfn, align 8, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !44, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !34, !invariant.load !9
  br label %return
...
!38 = !{!39, !40, i64 16}
!39 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !40, i64 8, !40, i64 16, !40, i64 24, !40, i64 32, !40, i64 40, !40, i64 48, !19, i64 56}
...
!44 = !{!23, !27, i64 240}
!45 = !{!46, !7, i64 56}
!46 = !{!"_ZTSSt5ctypeIcE", !47, i64 0, !48, i64 16, !25, i64 24, !49, i64 32, !49, i64 40, !50, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
