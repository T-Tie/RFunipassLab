...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 dereferenceable(41000) %ch) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %len) #7
...
for.inc:                                          ; preds = %if.else34.i, %if.then28.i, %if.then19.i, %land.lhs.true.i, %if.then6.i, %do.end.i
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx) #8
...
while.body.loopexit:                              ; preds = %while.cond9
  %6 = trunc nsw i64 %indvars.iv18 to i32
...
while.cond9:                                      ; preds = %while.cond9.preheader, %if.end34
  %9 = phi i32 [ %7, %while.cond9.preheader ], [ %.pre21, %if.end34 ]
  %10 = phi i32 [ %.pre, %while.cond9.preheader ], [ %12, %if.end34 ]
  %indvars.iv18 = phi i64 [ %8, %while.cond9.preheader ], [ %indvars.iv.next19, %if.end34 ]
  %num.1 = phi i32 [ %num.0, %while.cond9.preheader ], [ %num.2, %if.end34 ]
  %add = add nsw i32 %num.1, %10
  %cmp12 = icmp slt i32 %add, 81
  %11 = sext i32 %9 to i64
  %cmp17.not = icmp slt i64 %indvars.iv18, %11
  %or.cond16 = select i1 %cmp12, i1 %cmp17.not, i1 false
  br i1 %or.cond16, label %if.end19, label %while.body.loopexit

if.end19:                                         ; preds = %while.cond9
  %arrayidx15 = getelementptr inbounds [1000 x [41 x i8]], ptr %ch, i64 0, i64 %indvars.iv18
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #9
  ...
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %len, i64 0, i64 %indvars.iv.next19
  %12 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %add27 = add nsw i32 %12, %add
  %cmp28 = icmp slt i32 %add27, 80
  %13 = load i32, ptr %n, align 4
  %14 = sext i32 %13 to i64
  %cmp29 = icmp slt i64 %indvars.iv.next19, %14
...
if.end34:                                         ; preds = %if.else, %if.then30
  ...
  %.pre21 = load i32, ptr %n, align 4
  br label %while.cond9, !llvm.loop !34

while.end35:                                      ; preds = %while.body
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %len) #9
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef nonnull %ch) #9
