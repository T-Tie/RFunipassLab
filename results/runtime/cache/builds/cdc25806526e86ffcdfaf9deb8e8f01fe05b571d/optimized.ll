...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %result) #6
...
for.body6:                                        ; preds = %for.cond4
  ...
  call void @outlined_ir_func_0(ptr @k)
  br label %for.cond4
...
for.body21:                                       ; preds = %for.cond19
  ...
  call void @outlined_ir_func_0(ptr @l)
  br label %for.cond19

for.end28:                                        ; preds = %for.cond19
  call void @llvm.lifetime.end.p0(i64 400, ptr %result) #6
...
for.inc:                                          ; preds = %for.body6_to_outline
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %inc = add nsw i32 %1, 1
  store i32 %inc, ptr %0, align 4, !tbaa !5
  br label %for.cond4.exitStub, !llvm.loop !20

for.cond4.exitStub:                               ; preds = %for.inc
  ret void
}
