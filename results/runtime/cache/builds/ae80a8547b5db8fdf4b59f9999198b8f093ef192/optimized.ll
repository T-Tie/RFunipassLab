...
for.cond14:                                       ; preds = %for.inc40, %for.end13
  %2 = phi i32 [ %dec, %for.inc40 ], [ %sub, %for.end13 ]
  %cmp15 = icmp sge i32 %2, 0
...
for.inc50:                                        ; preds = %for.cond43
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %6) #5
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %7) #5
