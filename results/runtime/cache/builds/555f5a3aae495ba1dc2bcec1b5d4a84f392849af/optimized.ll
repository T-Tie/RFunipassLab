...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = tail call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %0) #8
...
define dso_local noundef range(i32 0, -2147483648) i32 @_Z5afteriii(i32 noundef %i, i32 noundef %fin, i32 noundef %n) local_unnamed_addr #3 {
entry:
...
if.then:                                          ; preds = %tailrecurse
  ...
  %2 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !12
  %3 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %cmp3.not = icmp sle i32 %2, %3
  %spec.select = zext i1 %cmp3.not to i32
  %accumulator.ret.tr = tail call noundef range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %spec.select, i32 noundef %accumulator.tr.ph)
  ret i32 %accumulator.ret.tr

if.else5:                                         ; preds = %tailrecurse
  %arrayidx7 = getelementptr inbounds [30 x i32], ptr @a, i64 0, i64 %indvars.iv
  %4 = load i32, ptr %arrayidx7, align 4, !tbaa !5, !invariant.load !12
  %5 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %cmp10.not = icmp sgt i32 %4, %5
  br i1 %cmp10.not, label %if.else16, label %if.then11

if.then11:                                        ; preds = %if.else5
  %6 = trunc nsw i64 %indvars.iv to i32
  %add = add nsw i32 %6, 1
  %call = tail call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %6, i32 noundef %n) #9
  %add12 = add nuw nsw i32 %call, 1
  %spec.select.i = tail call noundef i32 @llvm.smax.i32(i32 %add12, i32 noundef %accumulator.tr.ph)
  br label %tailrecurse.outer
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !13, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !21, !invariant.load !12
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !22, !invariant.load !12
...
attributes #3 = { mustprogress nofree nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
