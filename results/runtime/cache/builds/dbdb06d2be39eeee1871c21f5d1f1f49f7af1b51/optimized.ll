...
for.cond7:                                        ; preds = %for.inc36, %for.body6
  ...
  %2 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add = add nsw i32 %2, 1
...
for.cond10:                                       ; preds = %for.inc23, %for.body9
  %k.0 = phi i32 [ %0, %for.body9 ], [ %inc24, %for.inc23 ]
...
for.body13:                                       ; preds = %for.cond10
  ...
  %5 = load i8, ptr %arrayidx18, align 1, !tbaa !12, !invariant.load !13
...
if.then27:                                        ; preds = %for.end25
  ...
  %inc30 = add nsw i32 %6, 1
  store i32 %inc30, ptr %arrayidx29, align 4, !tbaa !5
  br label %for.inc36

for.inc36:                                        ; preds = %for.end25, %if.then27
  %w.2.sink = phi i32 [ %1, %if.then27 ], [ %w.2, %for.end25 ]
  %sub33 = sub nsw i32 %3, %w.2.sink
...
for.inc52:                                        ; preds = %for.body44, %if.then48
  %max.1 = phi i32 [ %7, %if.then48 ], [ %max.0, %for.body44 ]
  %inc53 = add nsw i32 %.sink1, 1
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %10, %.sink2
  %cmp69 = icmp slt i32 %9, %add68
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %11 = load i8, ptr %arrayidx72, align 1, !tbaa !12
  %conv73 = sext i8 %11 to i32
  %call74 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %conv73) #9
  %inc76 = add nsw i32 %9, 1
