...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %exitcond8 = icmp eq i64 %indvars.iv5, %2
...
for.inc:                                          ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  ...
  br i1 %exitcond13.not, label %for.cond29.preheader, label %for.inc26
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv14 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next15, %for.inc54 ]
  %exitcond21.not = icmp eq i64 %indvars.iv14, %wide.trip.count12
  br i1 %exitcond21.not, label %for.cond57, label %for.cond32.preheader
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  ...
  %cmp33 = icmp samesign ult i64 %indvars.iv16, %8
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count12
  br i1 %exitcond26.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv22
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc89 ], [ 0, %if.else ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count12
  br i1 %exitcond31.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv27
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv27
