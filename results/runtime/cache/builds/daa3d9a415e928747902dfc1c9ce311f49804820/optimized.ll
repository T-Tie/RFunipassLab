...
entry:
  ...
  %n6 = alloca i8, i32 0, align 4
  %n1 = alloca i8, i32 0, align 4
  %m = alloca i32, align 4
  %m7 = alloca i8, i32 0, align 4
  %m2 = alloca i8, i32 0, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %j8 = alloca i8, i32 0, align 4
  %j3 = alloca i8, i32 0, align 4
  %l = alloca i32, align 4
  %l9 = alloca i8, i32 0, align 4
  %l4 = alloca i8, i32 0, align 4
  %k = alloca i32, align 4
  %s = alloca i32, align 4
  %s10 = alloca i8, i32 0, align 4
  %s5 = alloca i8, i32 0, align 4
...
for.inc8:                                         ; preds = %for.cond2
  %call5 = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %2, i32 noundef %3) #6
...
for.end21:                                        ; preds = %for.cond11
  ...
  %call22 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %7)
...
define dso_local noundef i32 @_Z2ljPiii(ptr nofree noundef readonly captures(none) %a, i32 noundef %n, i32 noundef %m) #3 {
entry:
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %t = alloca i32, align 4
  %p = alloca i32, align 4
  %p3 = alloca i8, i32 0, align 4
  %p1 = alloca i8, i32 0, align 4
  %b = alloca [25 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %t) #5
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef %b) #5
  %sub = sub nsw i32 %m, 1
