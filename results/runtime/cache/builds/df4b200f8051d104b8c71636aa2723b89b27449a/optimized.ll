...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc19 ], [ %2, %for.end ]
  %i.1 = phi i32 [ %sub8, %for.inc19 ], [ %sub4, %for.end ]
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.end47 ], [ %indvars.iv8, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, -1
  %cmp23 = icmp sgt i64 %indvars.iv10, 0
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next11
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc45 ], [ %2, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %6, %for.body24 ]
  %cmp30.not = icmp slt i64 %indvars.iv5, %indvars.iv10
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %7 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv5
  %8 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !12
  %cmp36.not = icmp slt i32 %7, %8
  br i1 %cmp36.not, label %for.inc45, label %land.lhs.true

land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv5
  %9 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !12
  %cmp39.not = icmp sge i32 %9, %sum.0
  %inc43 = zext i1 %cmp39.not to i32
  %spec.select = add nsw i32 %p.1, %inc43
  %spec.select1 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.0)
  br label %for.inc45
...
for.end47:                                        ; preds = %for.cond29
  ...
  %arrayidx55 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next11
...
for.body62:                                       ; preds = %for.cond60
  ...
  %10 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select3 = call i32 @llvm.smax.i32(i32 %10, i32 %sum.2)
