...
for.end:                                          ; preds = %for.cond
  ...
  %smin = call range(i32 -2147483648, 1) i32 @llvm.smin.i32(i32 %sub, i32 noundef 0)
  %2 = add i32 %smin, -1
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv5, 0
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, -1
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next6
  %3 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv5
  %4 = load i32, ptr %arrayidx12, align 4, !tbaa !5, !invariant.load !12
  %cmp13.not = icmp slt i32 %3, %4
  br i1 %cmp13.not, label %for.end20.split.loop.exit, label %for.inc19

for.inc19:                                        ; preds = %for.body7
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv5
  %5 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !12
  %add = add nsw i32 %5, 1
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next6
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !13

for.end20.split.loop.exit:                        ; preds = %for.body7
  %6 = trunc nsw i64 %indvars.iv.next6 to i32
  br label %for.end20

for.end20:                                        ; preds = %for.cond5, %for.end20.split.loop.exit
  %sub21.lcssa = phi i32 [ %6, %for.end20.split.loop.exit ], [ %2, %for.cond5 ]
  %7 = sext i32 %sub21.lcssa to i64
  br label %for.cond22

for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.end47 ], [ %7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %cmp23 = icmp sgt i64 %indvars.iv11, -1
...
for.body24:                                       ; preds = %for.cond22
  %8 = load i32, ptr %arrayidx3, align 4, !tbaa !5, !invariant.load !12
  %arrayidx33 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv11
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %8, %for.body24 ]
  %cmp30 = icmp sgt i64 %indvars.iv8, %indvars.iv11
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %9 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv8
  %11 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !12
  %cmp39.not = icmp sge i32 %11, %sum.0
  %inc43 = zext i1 %cmp39.not to i32
  %spec.select = add nsw i32 %p.1, %inc43
  %spec.select1 = call i32 @llvm.smax.i32(i32 %11, i32 %sum.0)
  br label %for.inc45

for.inc45:                                        ; preds = %land.lhs.true, %for.body31
  %p.2 = phi i32 [ %p.1, %for.body31 ], [ %spec.select, %land.lhs.true ]
  %sum.1 = phi i32 [ %sum.0, %for.body31 ], [ %spec.select1, %land.lhs.true ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  %spec.select2 = select i1 %cmp48, i32 1, i32 %add53
  %arrayidx55 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv11
  store i32 %spec.select2, ptr %arrayidx55, align 4, !tbaa !5
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv14 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next15, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select3, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv14
  %12 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select3 = call i32 @llvm.smax.i32(i32 %12, i32 %sum.2)
