...
while.cond4:                                      ; preds = %while.body6, %while.end
  ...
  %call5 = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops15_Iter_less_iterclIPiS3_EEbT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %__comp, ptr noundef %__pivot, ptr noundef %__last.addr.1)
...
if.end:                                           ; preds = %while.end8
  call void @_ZSt9iter_swapIPiS0_EvT_T0_(ptr noundef %__first.addr.1, ptr noundef %__last.addr.1)
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %call = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops14_Val_less_iterclIiPiEEbRT_T0_(ptr noundef nonnull align 1 dereferenceable(1) %__comp, ptr noundef nonnull align 4 dereferenceable(4) %__val, ptr noundef %__next.0)
  br i1 %call, label %while.body, label %while.end
