...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  %indvars.iv33 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next34, %for.inc131 ]
  %indvars.iv10 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next11, %for.inc131 ]
  %total.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add130, %for.inc131 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38.not, label %for.inc136, label %for.cond20

for.cond20:                                       ; preds = %for.cond15, %for.inc66
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc66 ], [ 0, %for.cond15 ]
  %exitcond.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond.not, label %for.cond70, label %for.body23

for.body23:                                       ; preds = %for.cond20
  %6 = add nuw i64 %indvars.iv18, 4294967295
  %7 = and i64 %6, 4294967295
  %or.cond = icmp samesign ult i64 %7, %indvars.iv33
  br i1 %or.cond, label %for.inc66, label %if.end

if.end:                                           ; preds = %for.body23
  %arrayidx27 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv18
  %8 = load i32, ptr %arrayidx27, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond30

for.cond30:                                       ; preds = %for.body33, %if.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body33 ], [ %indvars.iv10, %if.end ]
  %minValue.0 = phi i32 [ %spec.select, %for.body33 ], [ %8, %if.end ]
  %9 = trunc nuw i64 %indvars.iv12 to i32
  %cmp31 = icmp sgt i32 %1, %9
  br i1 %cmp31, label %for.body33, label %for.end47

for.body33:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv12
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc63 ], [ %indvars.iv10, %for.end47 ]
  %11 = trunc nuw i64 %indvars.iv15 to i32
  %cmp55 = icmp sgt i32 %1, %11
  br i1 %cmp55, label %for.inc63, label %for.inc66

for.inc63:                                        ; preds = %for.cond54
  %arrayidx61 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv15
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc121 ], [ 0, %for.cond20 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond32.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw i64 %indvars.iv28, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond4 = icmp samesign ult i64 %14, %indvars.iv33
  br i1 %or.cond4, label %for.inc121, label %if.end78

if.end78:                                         ; preds = %for.body73
  %arrayidx82 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv28
  %15 = load i32, ptr %arrayidx82, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond85

for.cond85:                                       ; preds = %for.body88, %if.end78
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body88 ], [ %indvars.iv10, %if.end78 ]
  %minValue79.0 = phi i32 [ %spec.select5, %for.body88 ], [ %15, %if.end78 ]
  %16 = trunc nuw i64 %indvars.iv22 to i32
  %cmp86 = icmp sgt i32 %1, %16
  br i1 %cmp86, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv28
  %17 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
  %spec.select5 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc118 ], [ %indvars.iv10, %for.end102 ]
  %18 = trunc nuw i64 %indvars.iv25 to i32
  %cmp110 = icmp sgt i32 %1, %18
  br i1 %cmp110, label %for.inc118, label %for.inc121

for.inc118:                                       ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv28
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %arrayidx129 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next34, i64 %indvars.iv.next34
