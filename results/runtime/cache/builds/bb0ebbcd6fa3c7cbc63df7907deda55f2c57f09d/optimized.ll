...
entry:
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %conv7, i32 0)
...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  %exitcond21.not = icmp eq i64 %indvars.iv, %wide.trip.count20
  br i1 %exitcond21.not, label %for.end22, label %for.cond8

for.cond8:                                        ; preds = %for.cond, %for.inc
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc ], [ 0, %for.cond ]
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc ], [ %indvars.iv, %for.cond ]
...
for.body10:                                       ; preds = %for.cond8
  ...
  %arrayidx13 = getelementptr inbounds nuw [50 x i8], ptr %b, i64 0, i64 %indvars.iv14
...
if.then24:                                        ; preds = %if.then24.loopexit, %for.end22
  ...
  %i.011 = phi i32 [ %i.0, %if.then24.loopexit ], [ %smax19, %for.end22 ]
  %add = add nsw i32 %i.011, %conv
  %smax29 = call i32 @llvm.smax.i32(i32 %i.011, i32 %add)
  %2 = sub nsw i32 %smax29, %i.011
