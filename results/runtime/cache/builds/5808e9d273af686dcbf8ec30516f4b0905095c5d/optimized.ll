...
for.body:                                         ; preds = %for.cond
  ...
  %8 = load i8, ptr %arrayidx, align 1, !tbaa !30
...
land.lhs.true:                                    ; preds = %for.body, %for.body, %for.body, %for.body
  ...
  %9 = load i8, ptr %arrayidx28, align 1, !tbaa !30
...
for.body52:                                       ; preds = %for.cond50
  ...
  %10 = load i8, ptr %arrayidx54, align 1, !tbaa !30
  %arrayidx57 = getelementptr inbounds nuw [1000 x i8], ptr %b, i64 0, i64 %indvars.iv59
  %11 = load i8, ptr %arrayidx57, align 1, !tbaa !30
...
for.end65:                                        ; preds = %for.cond50
  ...
  %12 = load double, ptr %w, align 8, !tbaa !35
  %cmp68 = fcmp ult double %div, %12
  %.str.3..str.2 = select i1 %cmp68, ptr @.str.3, ptr @.str.2
  br label %if.end75

if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit38
  %.str.1.sink = phi ptr [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit38 ], [ @.str.1, %land.lhs.true ], [ @.str.1, %for.body ], [ %.str.3..str.2, %for.end65 ]
