...
if.then:                                          ; preds = %while.body
  ...
  %.pre1 = load double, ptr %a, align 8, !tbaa !5
  %.pre4 = fdiv double %.pre, %.pre1
  %.pre5 = fsub double %.pre4, %div
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %sub10.pre-phi = phi double [ %.pre5, %if.then ], [ %sub, %while.body ]
...
if.then12:                                        ; preds = %if.end
  ...
  %.pre2 = load double, ptr %b, align 8, !tbaa !5
  %.pre3 = load double, ptr %a, align 8, !tbaa !5
  %.pre6 = fdiv double %.pre2, %.pre3
  %.pre7 = fsub double %.pre6, %div
  br label %if.end15

if.end15:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi double [ %.pre7, %if.then12 ], [ %sub10.pre-phi, %if.end ]
