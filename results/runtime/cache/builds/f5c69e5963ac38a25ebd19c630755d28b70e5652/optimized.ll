...
for.cond36:                                       ; preds = %for.inc44, %for.end33
  ...
  br i1 %exitcond14.not, label %for.end46, label %for.body39
...
for.body39:                                       ; preds = %for.cond36
  ...
  %9 = load i64, ptr %gep, align 8, !tbaa !16, !invariant.load !12
...
for.inc44:                                        ; preds = %if.end.i, %if.then.i
  ...
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !12
