...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond24.not, label %for.end33, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv15 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next16, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv15
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc49
  %indvars.iv25 = phi i64 [ %8, %for.cond38.preheader ], [ %indvars.iv.next26, %for.inc49 ]
  %cmp39 = icmp sgt i64 %indvars.iv25, -1
  %9 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51, i64 %indvars.iv25
...
for.end61.loopexit:                               ; preds = %for.body40
  %11 = trunc nsw i64 %indvars.iv25 to i32
  br label %for.end61
