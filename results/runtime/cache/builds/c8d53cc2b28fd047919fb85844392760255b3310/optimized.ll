...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call = call noundef i32 @_Z5powerii(i32 noundef 2, i32 noundef %j.0) #11
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %div = sdiv i32 %n, %0
  %sub = sub nsw i32 %g, 1
  %call = call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #12
...
define dso_local noundef i32 @_Z5powerii(i32 noundef %a, i32 noundef %b) local_unnamed_addr #7 {
entry:
  br label %for.cond
