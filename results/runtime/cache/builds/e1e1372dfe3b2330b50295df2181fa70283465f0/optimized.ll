...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %b) #3
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %c) #3
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %d) #3
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %e) #3
...
for.inc7:                                         ; preds = %for.cond1
  ...
  store i32 %inc8, ptr %x, align 4, !tbaa !5
...
for.cond13:                                       ; preds = %for.inc42, %for.body12
  %5 = phi i32 [ %inc43, %for.inc42 ], [ 0, %for.body12 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %idxprom25 = sext i32 %4 to i64
  br i1 %cmp16, label %if.then, label %if.else

if.then:                                          ; preds = %for.body15
  %arrayidx18 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom25
  %7 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds [10 x i32], ptr %b, i64 0, i64 %idxprom25
...
for.inc42.gvnsink.split:                          ; preds = %if.then, %if.then32
  %arrayidx40 = getelementptr inbounds [10 x i32], ptr %c, i64 0, i64 %idxprom25
...
for.inc45:                                        ; preds = %for.cond13
  %inc46 = add nsw i32 %4, 1
  store i32 %inc46, ptr %x, align 4, !tbaa !5
...
for.cond51:                                       ; preds = %for.inc83, %for.body50
  %12 = phi i32 [ %inc84, %for.inc83 ], [ 0, %for.body50 ]
  %cmp52 = icmp slt i32 %12, %1
...
if.then55:                                        ; preds = %for.body53
  %arrayidx59 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom67
  %13 = load i32, ptr %arrayidx59, align 4, !tbaa !5
  %arrayidx61 = getelementptr inbounds [10 x i32], ptr %d, i64 0, i64 %idxprom67
  store i32 %13, ptr %arrayidx61, align 4, !tbaa !5
...
if.else64:                                        ; preds = %for.body53
  ...
  %15 = load i32, ptr %arrayidx70, align 4, !tbaa !5
  %cmp71 = icmp slt i32 %14, %15
  br i1 %cmp71, label %if.then72, label %for.inc83

if.then72:                                        ; preds = %if.else64
  store i32 %14, ptr %arrayidx70, align 4, !tbaa !5
  br label %for.inc83.gvnsink.split

for.inc83.gvnsink.split:                          ; preds = %if.then55, %if.then72
  %arrayidx80 = getelementptr inbounds [10 x i32], ptr %e, i64 0, i64 %idxprom67
  store i32 %10, ptr %arrayidx80, align 4, !tbaa !5
  br label %for.inc83
...
for.inc86:                                        ; preds = %for.cond51
  %inc87 = add nsw i32 %10, 1
  store i32 %inc87, ptr %y, align 4, !tbaa !5
...
for.cond89:                                       ; preds = %for.inc110, %for.end88
  ...
  %17 = load i32, ptr %row, align 4, !tbaa !5
  %cmp90 = icmp slt i32 %16, %17
...
if.then100:                                       ; preds = %for.body94
  ...
  %23 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %22, i32 noundef %23)
  br label %for.inc107

for.inc107:                                       ; preds = %for.body94, %if.then100
  %inc108 = add nsw i32 %18, 1
  store i32 %inc108, ptr %y, align 4, !tbaa !5
  br label %for.cond92, !llvm.loop !17

for.inc110:                                       ; preds = %for.cond92
  %inc111 = add nsw i32 %16, 1
  store i32 %inc111, ptr %x, align 4, !tbaa !5
  br label %for.cond89, !llvm.loop !18

for.end112:                                       ; preds = %for.cond89
  %24 = load i32, ptr %i, align 4, !tbaa !5
  %cmp113 = icmp eq i32 %24, 0
...
if.end116:                                        ; preds = %if.then114, %for.end112
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %e) #4
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %d) #4
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %c) #4
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef %b) #4
