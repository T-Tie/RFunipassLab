...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv12 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next13, %for.inc13 ]
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv19 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next20, %for.inc44 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond25.not = icmp eq i32 %j.0, %smax24
  br i1 %exitcond25.not, label %for.cond47.preheader, label %for.cond19.preheader
...
for.cond47.preheader:                             ; preds = %for.cond16
  ...
  %smax30 = call i32 @llvm.smax.i32(i32 %m.0, i32 0)
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv16 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next17, %for.inc41 ]
  %exitcond23.not = icmp eq i64 %indvars.iv16, %wide.trip.count22
  br i1 %exitcond23.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv16
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next17
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv26 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next27, %for.inc58 ]
  %exitcond32.not = icmp eq i64 %indvars.iv26, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv26
  ...
  %cmp54.not = icmp eq i64 %indvars.iv26, %4
