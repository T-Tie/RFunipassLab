...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call8 = call double @sqrt(double noundef %4) #8, !tbaa !5
  ...
  %call17 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div16) #7
  br label %for.inc
...
if.then23:                                        ; preds = %if.else
  %call29 = call double @sqrt(double noundef %4) #8, !tbaa !5
  %add30 = fsub double %call29, %1
  %mul31 = fmul double %2, 2.000000e+00
  %div32 = fdiv double %add30, %mul31
  %call33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div32) #7
  br label %for.inc
...
if.else34:                                        ; preds = %if.else
  ...
  %5 = call double @llvm.fmuladd.f64(double %fneg35, double %1, double %mul3)
  %call42 = call double @sqrt(double noundef %5) #8, !tbaa !5
  %div44 = fdiv double %call42, %mul36
  %6 = call double @llvm.fabs.f64(double %div37)
  %cmp45 = fcmp olt double %6, 1.000000e-05
  %p.0 = select i1 %cmp45, double 0.000000e+00, double %div37
  %call47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %p.0, double noundef %div44, double noundef %p.0, double noundef %div44) #7
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else34, %if.then23
