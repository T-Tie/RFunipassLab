...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count15 = zext nneg i32 %smax14 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv5
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv2, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next3 = add nsw i64 %indvars.iv2, 1
  %7 = trunc nsw i64 %indvars.iv2 to i32
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv2
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv9 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next10, %for.inc44 ]
  %exitcond16.not = icmp eq i64 %indvars.iv9, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv9, %2
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv9
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  br label %for.cond35, !llvm.loop !12

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv17
