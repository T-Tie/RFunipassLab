...
for.cond4:                                        ; preds = %for.cond, %for.body6
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body6 ], [ 0, %for.cond ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.end13, label %for.body6
...
for.cond5:                                        ; preds = %for.cond, %for.body7
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body7 ], [ 0, %for.cond ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond24.not, label %for.end16, label %for.body7
...
for.cond14.loopexit:                              ; preds = %for.cond40
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  %indvars.iv61 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next62, %for.cond14.loopexit ]
  %indvars.iv58 = phi i64 [ %4, %for.cond14.preheader ], [ %indvars.iv.next59, %for.cond14.loopexit ]
  %h.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.cond14.loopexit ]
...
for.cond22:                                       ; preds = %for.cond19, %for.body24
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body24 ], [ 1, %for.cond19 ]
  %exitcond.not = icmp eq i64 %indvars.iv37, %indvars.iv58
  br i1 %exitcond.not, label %for.inc37, label %for.body24
...
for.cond40:                                       ; preds = %for.cond19, %for.inc60
  ...
  br i1 %exitcond57.not, label %for.cond14.loopexit, label %for.cond44

for.cond44:                                       ; preds = %for.cond40, %for.body47
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body47 ], [ 1, %for.cond40 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %indvars.iv58
  br i1 %exitcond52.not, label %for.inc60, label %for.body47
