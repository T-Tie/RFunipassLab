...
land.lhs.true:                                    ; preds = %for.body
  ...
  br i1 %cmp4, label %for.inc.gvnsink.split, label %if.else

if.else:                                          ; preds = %land.lhs.true, %for.body
  %cmp6 = icmp sgt i32 %2, %4
  br i1 %cmp6, label %for.inc.gvnsink.split, label %for.inc

for.inc.gvnsink.split:                            ; preds = %if.else, %land.lhs.true
  %phiofops1 = phi i32 [ %4, %land.lhs.true ], [ %2, %if.else ]
  %phiofops = phi i32 [ %2, %land.lhs.true ], [ %4, %if.else ]
  store i32 %phiofops1, ptr %a, align 4, !tbaa !5
...
for.end:                                          ; preds = %for.cond
  ...
  %call10 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %5, i32 noundef %6) #5
