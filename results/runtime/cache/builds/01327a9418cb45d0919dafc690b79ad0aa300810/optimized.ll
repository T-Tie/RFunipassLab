...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  br i1 %exitcond14, label %for.end, label %for.inc
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  ...
  %exitcond10 = icmp eq i32 %i.1, %2
  br i1 %exitcond10, label %while.cond, label %for.cond6
...
for.inc12:                                        ; preds = %for.cond6
  ...
  %3 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !12
...
for.cond15:                                       ; preds = %for.cond6, %for.inc30
  ...
  br i1 %exitcond9.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv6
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !12
  %div = sdiv i32 %4, 10
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx21 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv.next7
...
while.cond:                                       ; preds = %for.cond3, %while.cond
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %while.cond ], [ 39, %for.cond3 ]
  %arrayidx37 = getelementptr inbounds [40 x i32], ptr %sum, i64 0, i64 %indvars.iv11
  %6 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !12
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc45
  %.sink = phi i32 [ %dec46, %for.inc45 ], [ %7, %for.cond39.preheader ]
  %cmp40 = icmp sgt i32 %.sink, -1
...
for.inc45:                                        ; preds = %for.cond39
  ...
  %8 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !12
