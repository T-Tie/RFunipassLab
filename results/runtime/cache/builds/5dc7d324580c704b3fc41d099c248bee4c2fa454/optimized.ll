...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc8 ], [ 1, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv14, %1
  br i1 %cmp.not, label %for.end10, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %2 = add nsw i64 %indvars.iv14, -1
  br label %for.cond1
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc25
  %indvars.iv18 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next19, %for.inc25 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp16.not = icmp sgt i64 %indvars.iv18, %12
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv29 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next30, %for.inc46 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count33
  br i1 %exitcond34.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax38 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
  %wide.trip.count39 = zext nneg i32 %smax38 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv29, i64 %indvars.iv26
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  %indvars.iv47 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next48, %for.inc79 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count33
  br i1 %exitcond51.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc76
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc76 ], [ 0, %for.cond49 ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond46.not, label %for.inc79, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv47, i64 %indvars.iv41
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc73
  %indvars.iv35 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next36, %for.inc73 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count39
  br i1 %exitcond40.not, label %for.inc76, label %for.inc73

for.inc73:                                        ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv35
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv35, i64 %indvars.iv41
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv57, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv57, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre62, %for.body87 ]
  %indvars.iv52 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next53, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv52, %23
  br i1 %cmp86.not, label %for.inc106, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv52, %24
  %25 = add nsw i64 %indvars.iv52, -1
