...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv22 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next23, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv22
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv41 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %indvars46 = trunc i64 %indvars.iv41 to i32
  %5 = add nsw i64 %indvars.iv41, -1
  %cmp15 = icmp sgt i32 %indvars46, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond33.not = icmp eq i64 %indvars.iv26, %5
  br i1 %exitcond33.not, label %for.cond14, label %for.body19, !llvm.loop !14

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv26
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next27
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv34, %10
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv34
  %11 = load i32, ptr %arrayidx48, align 4, !tbaa !5, !invariant.load !12
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %11)
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12)
