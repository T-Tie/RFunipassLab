...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end59
  %indvars.iv40 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next41, %for.end59 ]
  br label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.cond39.preheader
  %indvars.iv37 = phi i64 [ 0, %for.cond31 ], [ %indvars.iv.next38, %for.cond39.preheader ]
...
for.cond39.preheader:                             ; preds = %for.cond35
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv40, i64 %indvars.iv37
...
for.cond67.preheader:                             ; preds = %for.cond63
  ...
  %cmp69.not.not.peel = icmp sgt i32 %9, 0
  br i1 %cmp69.not.not.peel, label %for.body70.peel, label %for.end84

for.body70.peel:                                  ; preds = %for.cond67.preheader
  %arrayidx80.peel = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv34, i64 0
  %10 = load i32, ptr %arrayidx80.peel, align 4, !tbaa !5, !invariant.load !14
  %call81.peel = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %10) #8
  br label %for.cond67

for.cond67:                                       ; preds = %for.body70.peel, %for.body70
  %indvars.iv30 = phi i64 [ 1, %for.body70.peel ], [ %indvars.iv.next31, %for.body70 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv30, %12
  br i1 %cmp69.not.not, label %for.body70, label %for.end84

for.body70:                                       ; preds = %for.cond67
  %arrayidx80 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv34, i64 %indvars.iv30
  %13 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !14
