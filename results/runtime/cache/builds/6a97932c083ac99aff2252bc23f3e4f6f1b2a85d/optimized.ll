...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc7 ], [ 0, %entry ]
...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax62 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv20 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next21, %for.inc27 ]
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv15 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next16, %for.inc24 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv20, i64 %indvars.iv15
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv35 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next36, %for.inc67 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count23
  br i1 %exitcond40.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select13, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv25, i64 %indvars.iv35
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select13 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond36, !llvm.loop !17

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv30 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next31, %for.inc64 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv30, i64 %indvars.iv35
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count51 = zext nneg i32 %smax62 to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc92 ], [ 2, %for.end69 ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count51
  br i1 %exitcond52.not, label %for.cond96.preheader, label %for.cond76.preheader

for.cond96.preheader:                             ; preds = %for.cond71
  br label %for.cond96

for.cond76.preheader:                             ; preds = %for.cond71
  %5 = add nsw i64 %indvars.iv46, -1
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv41 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next42, %for.inc89 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond45.not, label %for.inc92, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv46, i64 %indvars.iv41
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv41
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv58 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next59, %for.inc117 ]
  %exitcond64.not = icmp eq i64 %indvars.iv58, %wide.trip.count51
  br i1 %exitcond64.not, label %for.end119, label %for.cond101.preheader
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv53 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next54, %for.inc114 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count
  br i1 %exitcond57.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv53, i64 %indvars.iv58
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv53, i64 %7
...
for.cond:                                         ; preds = %for.inc9, %entry
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc9 ], [ 0, %entry ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count6
  br i1 %exitcond7.not, label %for.end11, label %for.cond1
