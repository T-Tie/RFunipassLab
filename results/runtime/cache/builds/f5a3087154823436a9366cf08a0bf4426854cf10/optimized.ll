...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv17 = phi i32 [ %indvars.iv.next18, %while.cond ], [ -1, %entry ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv9 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next10, %for.inc ]
  %exitcond.not = icmp eq i64 %indvars.iv9, 100
...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %0 = ashr exact i64 %sext20, 32
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv17, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond14

for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv9
  %1 = load i8, ptr %arrayidx5, align 1, !tbaa !12
  %cmp6 = icmp eq i8 %1, 0
  br i1 %cmp6, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %2 = add nsw i64 %indvars.iv9, -1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  ...
  %exitcond19.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond19.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %3 = xor i64 %indvars.iv13, -1
  %4 = add nsw i64 %0, %3
