...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %sub.sink9 = phi i32 [ %sub, %for.body31 ], [ %dec, %for.inc44 ]
  %cmp34 = icmp sge i32 %sub.sink9, 0
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idx.ext39 = sext i32 %sub.sink9 to i64
...
if.then42:                                        ; preds = %for.body35
  ...
  store i32 %sub.sink9, ptr %c2, align 4, !tbaa !5
  store i32 -1, ptr %i, align 4, !tbaa !5
  br label %for.inc46

for.inc44:                                        ; preds = %for.body35
  %dec = add nsw i32 %sub.sink9, -1
