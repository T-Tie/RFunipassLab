...
if.then:                                          ; preds = %for.body
  ...
  %sub35 = fsub double %.pre61, %call25
...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %cmp76.not.not = icmp slt i64 %indvars.iv58, %11
...
entry:
  ...
  %call = tail call i32 @getc(ptr noundef %0) #12
  ret i32 %call
}
...
; Function Attrs: nofree nounwind
declare noundef i32 @getc(ptr noundef captures(none)) #6
...
for.end134_to_outline:                            ; preds = %newFuncRoot
  %0 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i1 = call i32 @getc(ptr noundef %0) #12
