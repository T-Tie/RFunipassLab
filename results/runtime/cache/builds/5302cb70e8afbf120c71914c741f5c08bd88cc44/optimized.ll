...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count38 = zext i32 %narrow to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre44, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv34 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next35, %for.inc27 ]
  %exitcond39 = icmp eq i64 %indvars.iv34, %wide.trip.count38
  br i1 %exitcond39, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc21 ], [ 1, %for.cond10 ]
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.124 = phi i32 [ %6, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %8, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %9 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc48 ], [ %9, %for.end29 ]
  %10 = trunc nuw i64 %indvars.iv41 to i32
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %idxprom38
