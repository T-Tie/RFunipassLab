...
entry:
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call4, ptr nofree noundef writeonly null, i32 noundef -1)
...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call73, ptr nofree noundef writeonly null, i32 noundef -1)
  br label %sw.epilog
...
if.then:                                          ; preds = %sw.epilog
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call75, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call.i.i251.loc, i32 noundef 0)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call81.sink287, ptr nofree noundef writeonly null, i32 noundef -1)
