...
for.cond1:                                        ; preds = %for.inc7, %for.end
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc7 ], [ 0, %for.end ]
  %0 = load i32, ptr %k, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp2 = icmp slt i64 %indvars.iv37, %1
  br i1 %cmp2, label %for.inc7, label %for.end9

for.inc7:                                         ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv37
...
for.cond13:                                       ; preds = %for.inc38, %for.end9
  %2 = phi i32 [ %dec, %for.inc38 ], [ %sub12, %for.end9 ]
...
for.cond16.preheader:                             ; preds = %for.cond13
  ...
  %arrayidx22 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %3
  %arrayidx25 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %3
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc35
  %indvars.iv40 = phi i64 [ %3, %for.cond16.preheader ], [ %indvars.iv.next41, %for.inc35 ]
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %4 = trunc nuw i64 %indvars.iv.next41 to i32
  %cmp17 = icmp sgt i32 %0, %4
  br i1 %cmp17, label %for.body18, label %for.inc38

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next41
  %5 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %6 = load i32, ptr %arrayidx22, align 4, !tbaa !5
  %cmp23.not = icmp sgt i32 %5, %6
...
land.lhs.true:                                    ; preds = %for.body18
  ...
  %arrayidx27 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next41
  %8 = load i32, ptr %arrayidx27, align 4, !tbaa !5
  %add28 = add nsw i32 %8, 1
  %spec.store.select = call i32 @llvm.smax.i32(i32 %7, i32 %add28)
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.body42
  %indvars.iv43 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next44, %for.body42 ]
  %max.0 = phi i32 [ 0, %for.cond40.preheader ], [ %spec.select, %for.body42 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond47.not, label %for.end52, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx44 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv43
...
for.end52:                                        ; preds = %for.cond40
  %call53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %max.0) #6
