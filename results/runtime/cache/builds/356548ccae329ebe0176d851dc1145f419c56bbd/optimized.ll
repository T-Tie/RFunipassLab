...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %add.ptr, i1 false, i1 true, i1 false)
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc16 ], [ 1, %for.end ]
  %exitcond9 = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond9, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv6
