...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv36, %1
...
for.cond12:                                       ; preds = %for.end27, %for.end10
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.end27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv42, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv39, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.end27

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv42, i64 %indvars.iv39
...
for.end30:                                        ; preds = %for.cond12
  ...
  %10 = add i32 %smax, 1
  %smax52 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %smax58 = call i32 @llvm.smax.i32(i32 %8, i32 0)
...
for.cond31:                                       ; preds = %for.end59, %for.end30
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.end59 ], [ 0, %for.end30 ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %wide.trip.count59
  br i1 %exitcond60.not, label %for.cond63, label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.inc57
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc57 ], [ 0, %for.cond31 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54.not, label %for.end59, label %for.cond39

for.cond39:                                       ; preds = %for.cond35, %for.body41
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.body41 ], [ 0, %for.cond35 ]
...
for.body41:                                       ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv45
  %11 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !13
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv45, i64 %indvars.iv49
...
for.inc57:                                        ; preds = %for.cond39
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv55, i64 %indvars.iv49
...
for.cond63:                                       ; preds = %for.cond31, %for.end84
  ...
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.end84 ], [ 0, %for.cond31 ]
  %14 = sext i32 %13 to i64
  %cmp65.not.not = icmp slt i64 %indvars.iv65, %14
...
if.end.peel:                                      ; preds = %for.cond67.preheader
  %16 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 0
  %17 = load i32, ptr %16, align 4, !tbaa !5, !invariant.load !13
  %call76.peel = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %17)
  br label %for.cond67
...
for.cond67:                                       ; preds = %if.end.peel, %if.end
  ...
  %cmp69.not.not = icmp slt i64 %indvars.iv61, %19
  br i1 %cmp69.not.not, label %if.end, label %for.end84

if.end:                                           ; preds = %for.cond67
  %20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv65, i64 %indvars.iv61
  %21 = load i32, ptr %20, align 4, !tbaa !5, !invariant.load !13
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %21)
