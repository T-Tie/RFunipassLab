...
for.body33:                                       ; preds = %for.cond30
  ...
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !12
  %cmp36 = icmp ne i32 %4, 0
...
if.then38:                                        ; preds = %land.lhs.true
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4) #7
  br label %for.inc53

if.then48:                                        ; preds = %land.lhs.true
  %call51 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %4) #7
  br label %for.inc53

for.inc53:                                        ; preds = %for.body33, %if.then48, %if.then38
  %b.1 = phi i32 [ 1, %if.then38 ], [ %b.0, %if.then48 ], [ %b.0, %for.body33 ]
