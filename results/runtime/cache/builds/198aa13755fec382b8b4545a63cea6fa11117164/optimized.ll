...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  ...
  %lenq.0 = phi i64 [ %indvars.iv10, %if.end44 ], [ %indvars.iv, %while.cond4.preheader ]
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv10
...
for.cond:                                         ; preds = %while.end19, %for.inc
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc ], [ 0, %while.end19 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %idx.ext6
  br i1 %exitcond20.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv16
...
for.cond33:                                       ; preds = %while.end19, %for.inc40
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc40 ], [ 0, %while.end19 ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %idx.ext6
  br i1 %exitcond.not, label %for.end42, label %for.inc40

for.inc40:                                        ; preds = %for.cond33
  %add.ptr38 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv13
