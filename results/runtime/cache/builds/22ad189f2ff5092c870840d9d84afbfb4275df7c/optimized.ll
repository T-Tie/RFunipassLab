...
for.cond1:                                        ; preds = %for.cond, %for.inc14
  ...
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc14 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %rem11 = urem i32 %spec.select, 7
  %cmp9 = icmp eq i32 %rem11, 0
  br i1 %cmp9, label %if.then10, label %for.inc14

if.then10:                                        ; preds = %for.body3
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv14
...
for.cond17:                                       ; preds = %for.cond1, %for.body19
  %6 = phi i32 [ %.pre20, %for.body19 ], [ %1, %for.cond1 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body19 ], [ 0, %for.cond1 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv17, %7
  br i1 %cmp18, label %for.body19, label %for.end29

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv17
  ...
  %puts12 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #7
...
define dso_local noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %year, i32 noundef %mon) #3 {
entry:
  ...
  %spec.select21 = select i1 %1, i32 29, i32 28
  br label %for.cond
...
if.then24:                                        ; preds = %for.body
  %add34 = add nsw i32 %spec.select21, %result.0
  br label %for.inc
