...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv9, %1
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv15, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv12, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv15, i64 %indvars.iv12
...
for.end30:                                        ; preds = %for.cond12
  ...
  %10 = add i32 %smax, 1
  %smax25 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %smax31 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 0)
...
for.cond31:                                       ; preds = %for.inc60, %for.end30
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc60 ], [ 0, %for.end30 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count32
  br i1 %exitcond33.not, label %for.cond63, label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.inc57
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc57 ], [ 0, %for.cond31 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.inc60, label %for.cond39

for.cond39:                                       ; preds = %for.cond35, %for.inc50
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc50 ], [ 0, %for.cond35 ]
...
for.inc50:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv18
  %11 = load i32, ptr %arrayidx45, align 4, !tbaa !5
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv18, i64 %indvars.iv22
...
for.inc57:                                        ; preds = %for.cond39
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv28, i64 %indvars.iv22
...
for.cond63:                                       ; preds = %for.cond31, %for.inc86
  ...
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc86 ], [ 0, %for.cond31 ]
  %14 = sext i32 %13 to i64
  %cmp65.not.not = icmp slt i64 %indvars.iv37, %14
  br i1 %cmp65.not.not, label %for.cond67.preheader, label %for.end88

for.cond67.preheader:                             ; preds = %for.cond63
  %arrayidx75 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv37, i64 0
  br label %for.cond67

for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc82
  %indvars.iv34 = phi i64 [ 0, %for.cond67.preheader ], [ %indvars.iv.next35, %for.inc82 ]
  %15 = load i32, ptr %y2, align 4, !tbaa !5
  %16 = sext i32 %15 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv34, %16
  br i1 %cmp69.not.not, label %for.body70, label %for.inc86

for.body70:                                       ; preds = %for.cond67
  %cmp71 = icmp eq i64 %indvars.iv34, 0
...
if.else:                                          ; preds = %for.body70
  %arrayidx80 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv37, i64 %indvars.iv34
