...
for.inc:                                          ; preds = %for.cond
  ...
  call void @_Z6factorii(i32 noundef 2, i32 noundef %2) #8
  %3 = load i32, ptr @varieties, align 4, !tbaa !5
...
if.else:                                          ; preds = %entry
  store i32 %first, ptr %i, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.else
  %1 = load i32, ptr %i, align 4, !tbaa !5
  %cmp1 = icmp sle i32 %1, %num
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %num, %1
  call void @_Z6factorii(i32 noundef %1, i32 noundef %div) #9
  br label %for.inc
