...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %storemerge4 = phi i32 [ 65, %if.end24 ], [ %inc37, %if.end35 ]
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge4, i32 noundef %6) #6
...
for.cond39:                                       ; preds = %for.cond25, %if.end49
  %storemerge5 = phi i32 [ %inc51, %if.end49 ], [ 97, %for.cond25 ]
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge5, i32 noundef %8) #6
