...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 120, ptr noundef nonnull align 16 %num) #5
  call void @llvm.lifetime.start.p0(i64 noundef 120, ptr noundef nonnull align 16 %count) #5
...
for.end45:                                        ; preds = %for.cond33
  ...
  %vtable.i = load ptr, ptr %call46, align 8, !tbaa !16, !invariant.load !12
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call46, i8 noundef signext %call.i1)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  call void @llvm.lifetime.end.p0(i64 noundef 120, ptr noundef nonnull %count) #6
  call void @llvm.lifetime.end.p0(i64 noundef 120, ptr noundef nonnull %num) #6
