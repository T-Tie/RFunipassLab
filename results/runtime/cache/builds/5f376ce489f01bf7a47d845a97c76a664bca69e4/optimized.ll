...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp4.not, label %if.else, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %for.body
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp8, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit13, label %for.inc
...
if.then_to_outline:
  ...
  %2 = load i64, ptr %gep, align 8, !tbaa !39
