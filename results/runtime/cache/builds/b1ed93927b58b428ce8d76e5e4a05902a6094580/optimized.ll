...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %a) #9
...
for.body:                                         ; preds = %for.cond
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(41) %a)
...
for.cond6:                                        ; preds = %for.inc, %if.then
  ...
  br i1 %cmp7, label %for.inc, label %for.inc23
...
if.then12:                                        ; preds = %if.else
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call13, ptr noundef %a)
  br label %for.inc23
...
if.else18:                                        ; preds = %if.else
  ...
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call19, ptr noundef %a)
  br label %for.inc23

for.inc23:                                        ; preds = %for.cond6, %if.else18, %if.then12
  %sum.1 = phi i32 [ %conv, %for.cond6 ], [ %add10, %if.then12 ], [ %conv, %if.else18 ]
  %inc24 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !13

for.end25:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %a) #11
