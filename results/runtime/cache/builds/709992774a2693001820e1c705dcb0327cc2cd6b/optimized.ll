...
for.cond1:                                        ; preds = %for.cond, %for.body3
  %4 = phi i32 [ %.pre65, %for.body3 ], [ %0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv48, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv55 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next56, %for.inc27 ]
  %exitcond60 = icmp eq i64 %indvars.iv55, %wide.trip.count59
  br i1 %exitcond60, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc21 ], [ 1, %for.cond10 ]
  %exitcond = icmp eq i64 %indvars.iv51, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv55, i64 %indvars.iv51
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.146 = phi i32 [ %7, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %9, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %10 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc48 ], [ %10, %for.end29 ]
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %idxprom38
