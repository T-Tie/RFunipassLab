...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %i.1 = phi i32 [ %sub4, %for.end ], [ %dec, %for.inc19 ]
...
for.body24:                                       ; preds = %for.cond22
  %idxprom26 = sext i32 %sub4 to i64
  %arrayidx27 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %idxprom26
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  ...
  %m.0 = phi i32 [ %sub4, %for.body24 ], [ %dec46, %for.inc45 ]
