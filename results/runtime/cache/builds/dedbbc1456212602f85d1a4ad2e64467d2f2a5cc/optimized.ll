...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr %a) #9
  call void @llvm.lifetime.start.p0(i64 10000, ptr %b) #9
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %b, i64 noundef 10000)
  br label %for.cond
...
for.end26:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 10000, ptr %b) #9
  call void @llvm.lifetime.end.p0(i64 10000, ptr %a) #9
  ret i32 0
}
