...
for.cond:                                         ; preds = %for.body, %while.body
  %i.0 = phi i32 [ 2, %while.body ], [ %inc, %for.body ]
...
for.end:                                          ; preds = %for.cond
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call5, i8 noundef signext %call.i4)
...
_Z5powerii.exit:                                  ; preds = %for.cond.i
  ...
  br i1 %cmp, label %if.then, label %for.cond, !llvm.loop !16
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax19 = tail call i32 @llvm.smax.i32(i32 %j.0, i32 0)
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.body11
  ...
  br i1 %exitcond20.not, label %cleanup, label %for.body11
