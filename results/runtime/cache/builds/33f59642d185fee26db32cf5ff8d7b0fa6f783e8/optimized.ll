...
if.then39:                                        ; preds = %if.end37
  ...
  %mul46.i6 = fmul double %22, 4.000000e+00
  %23 = load double, ptr @c, align 8, !tbaa !9, !noalias !17
  %24 = load double, ptr @b, align 8, !tbaa !9, !noalias !17
  %25 = fneg double %24
  %neg49.i7 = fmul double %24, %25
  %26 = tail call double @llvm.fmuladd.f64(double %mul46.i6, double %23, double %neg49.i7) #9
  %call50.i8 = tail call double @sqrt(double noundef %26) #7, !tbaa !5, !noalias !17
  %fneg66 = fneg double %call50.i8
