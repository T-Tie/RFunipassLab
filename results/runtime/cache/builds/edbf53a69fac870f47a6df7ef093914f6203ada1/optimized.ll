...
for.end19:                                        ; preds = %for.cond10, %for.end19.split.loop.exit10
  %.lcssa2 = phi i32 [ %5, %for.end19.split.loop.exit10 ], [ 31, %for.cond10 ]
  %6 = zext nneg i32 %.lcssa2 to i64
  %7 = sext i32 %.lcssa2 to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc28, %for.end19
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc28 ], [ %6, %for.end19 ]
...
for.inc28:                                        ; preds = %for.cond20
  ...
  %9 = sub nuw nsw i64 %indvars.iv5, %7
