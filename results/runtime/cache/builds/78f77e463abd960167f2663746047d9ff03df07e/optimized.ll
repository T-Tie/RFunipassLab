...
for.end:                                          ; preds = %for.cond
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %wide.trip.count19 = zext nneg i32 %smax18 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond29.preheader, label %for.cond7.preheader
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv11 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next12, %for.body9 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv11
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv21 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next22, %for.inc36 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end38, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv21
