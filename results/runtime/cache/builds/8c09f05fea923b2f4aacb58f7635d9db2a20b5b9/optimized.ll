...
for.body4:                                        ; preds = %for.cond2
  ...
  br i1 %cmp5, label %for.inc12.loopexit, label %for.inc
...
for.end.thread:                                   ; preds = %for.cond2
  ...
  %cmp62 = icmp eq i32 %j.0.lcssa, %index.0
...
for.inc12:                                        ; preds = %for.inc12.loopexit, %if.then7, %for.end.thread
  %index.1 = phi i32 [ %inc10, %if.then7 ], [ %index.0, %for.end.thread ], [ %index.0, %for.inc12.loopexit ]
...
for.cond15:                                       ; preds = %for.inc21, %for.end14
  ...
  %sub = sub nsw i32 %index.0.lcssa, 1
...
for.end23:                                        ; preds = %for.cond15
  %sub.lcssa = phi i32 [ %sub, %for.cond15 ]
