...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1584, ptr nonnull %m) #6
  call void @llvm.lifetime.start.p0(i64 792, ptr nonnull %x) #6
...
if.then:                                          ; preds = %for.body
  ...
  %fneg13 = fneg double %2
  %sub = fsub double %fneg13, %call9
  br label %for.inc.sink.split

if.else:                                          ; preds = %for.body
  %cmp24 = fcmp oeq double %6, 0.000000e+00
  %fneg26 = fneg double %2
  %div28 = fdiv double %fneg26, %mul
  store double %div28, ptr %arrayidx12, align 8, !tbaa !9
...
for.inc.sink.split:                               ; preds = %if.else32, %if.then
  %call42.sink = phi double [ %call42, %if.else32 ], [ %sub, %if.then ]
  %div44 = fdiv double %call42.sink, %mul
  %arrayidx21 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv
  store double %div44, ptr %arrayidx21, align 8, !tbaa !9
  br label %for.inc
...
for.end112:                                       ; preds = %for.cond49
  ...
  call void @llvm.lifetime.end.p0(i64 792, ptr nonnull %x) #6
  call void @llvm.lifetime.end.p0(i64 1584, ptr nonnull %m) #6
  ret i32 0
}
