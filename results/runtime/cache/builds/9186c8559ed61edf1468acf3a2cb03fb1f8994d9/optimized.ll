...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x2) #6
...
for.body:                                         ; preds = %for.cond
  call fastcc void @outlined_ir_func_0(ptr %x1, ptr %i, i32 %y)
  br label %for.cond
...
for.body15:                                       ; preds = %for.cond13
  call fastcc void @outlined_ir_func_0(ptr %x2, ptr %j, i32 %y)
  br label %for.cond13
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1, i32 %2) unnamed_addr #5 {
for.body_to_outline:
...
if.then:                                          ; preds = %lor.lhs.false5, %lor.lhs.false3, %lor.lhs.false, %for.body_to_outline
  %dec = add nsw i32 %add, -1
  store i32 %dec, ptr %0, align 4, !tbaa !5
  br label %if.end
...
if.then8:                                         ; preds = %if.end
  %call = call noundef i32 @_Z7runniani(i32 noundef %2) #7
...
if.end11:                                         ; preds = %if.then8, %if.else
  ...
  %sub10 = sub nsw i32 %6, %.sink1
  store i32 %sub10, ptr %0, align 4, !tbaa !5
  br label %for.cond.exitStub

for.cond.exitStub:                                ; preds = %if.end11, %if.end
