...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %a) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %b) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %c) #9
...
land.lhs.true.i:                                  ; preds = %entry
  call void @outlined_ir_func_0.2(ptr %add.ptr10.i)
  br label %land.lhs.true.i15

land.lhs.true.i15:                                ; preds = %land.lhs.true.i
  call fastcc void @outlined_ir_func_0(ptr %b, ptr %add.ptr10.i)
...
land.lhs.true.i43:                                ; preds = %land.lhs.true.i15
  call fastcc void @outlined_ir_func_0(ptr %c, ptr %add.ptr10.i)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %land.lhs.true.i43, %if.then6.i36
  ...
  %smax120 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
  %indvars.iv131 = phi i32 [ %indvars.iv.next132, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %indvars.iv126 = phi i32 [ %indvars.iv.next127, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %exitcond122.not = icmp eq i64 %indvars.iv, %wide.trip.count121
  br i1 %exitcond122.not, label %if.then34, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !22, !invariant.load !8
  %cmp13 = icmp eq i8 %2, %1
  br i1 %cmp13, label %for.cond14, label %for.inc30

for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc ], [ 1, %for.body ]
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv114, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next113 = add nuw nsw i64 %indvars.iv112, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next113
  %3 = load i8, ptr %arrayidx18, align 1, !tbaa !22, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv114
  %4 = load i8, ptr %arrayidx21, align 1, !tbaa !22, !invariant.load !8
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %5 = trunc nuw nsw i64 %indvars.iv114 to i32
  br label %for.end

for.end:                                          ; preds = %for.cond14, %for.end.split.loop.exit
  %j.0.lcssa = phi i32 [ %5, %for.end.split.loop.exit ], [ %smax, %for.cond14 ]
...
for.cond37.preheader:                             ; preds = %for.end
  ...
  %wide.trip.count129 = zext i32 %indvars.iv126 to i64
  br label %for.cond37

for.inc30:                                        ; preds = %for.body, %for.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %indvars.iv.next127 = add nuw i32 %indvars.iv126, 1
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv123 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next124, %for.inc43 ]
  %exitcond130.not = icmp eq i64 %indvars.iv123, %wide.trip.count129
  br i1 %exitcond130.not, label %for.end45, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv123
  %6 = load i8, ptr %arrayidx41, align 1, !tbaa !22, !invariant.load !8
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %6, ptr %__c.addr.i, align 1, !tbaa !22
  ...
  %7 = load i64, ptr %gep, align 8, !tbaa !27, !invariant.load !8
...
for.end45:                                        ; preds = %for.cond37
  %call.i.i69 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(256) %c) #11
  ...
  %8 = sext i32 %indvars.iv131 to i64
  %sext = shl i64 %call6, 32
  %9 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %for.inc54 ], [ %8, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv134, %9
  br i1 %cmp49, label %for.body50, label %if.end57

for.body50:                                       ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv134
  %10 = load i8, ptr %arrayidx52, align 1, !tbaa !22, !invariant.load !8
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i77)
  store i8 %10, ptr %__c.addr.i77, align 1, !tbaa !22
  %vbase.offset.i80 = load i64, ptr %vbase.offset.ptr.i79, align 8, !invariant.load !8
  %gep110 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i80
  %11 = load i64, ptr %gep110, align 8, !tbaa !27, !invariant.load !8
  %cmp.not.i83 = icmp eq i64 %11, 0
...
if.end.i87:                                       ; preds = %for.body50
  %call2.i88 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %10)
  br label %for.inc54

for.inc54:                                        ; preds = %if.end.i87, %if.then.i84
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i77)
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1) unnamed_addr #8 {
newFuncRoot:
  br label %land.lhs.true.i15_to_outline

land.lhs.true.i15_to_outline:                     ; preds = %newFuncRoot
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(256) %0, i64 noundef 256)
  call void @outlined_ir_func_0.2(ptr %1)
  br label %land.lhs.true.i43.exitStub

land.lhs.true.i43.exitStub:                       ; preds = %land.lhs.true.i15_to_outline
  ret void
}

; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_0.2(ptr %0) #8 {
newFuncRoot:
  br label %land.lhs.true.i_to_outline

land.lhs.true.i_to_outline:                       ; preds = %newFuncRoot
  %_M_width.i1.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %1 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !27, !invariant.load !8
  %2 = add i64 %1, -257
  %or.cond.i = icmp ult i64 %2, -256
  br i1 %or.cond.i, label %if.then19.i, label %land.lhs.true.i15.exitStub

if.then19.i:                                      ; preds = %land.lhs.true.i_to_outline
  %_M_streambuf.i.i = getelementptr inbounds nuw i8, ptr %0, i64 232
  %3 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !30, !invariant.load !8
  ...
  br i1 %tobool.not.i, label %land.lhs.true.i15.exitStub, label %if.then28.i
...
if.then28.i:                                      ; preds = %if.then19.i
  ...
  br label %land.lhs.true.i15.exitStub

land.lhs.true.i15.exitStub:                       ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i_to_outline
  ret void
}
...
!30 = !{!31, !34, i64 232}
!31 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0, !32, i64 216, !12, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
!32 = !{!"p1 _ZTSSo", !16, i64 0}
!33 = !{!"bool", !12, i64 0}
!34 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !16, i64 0}
!35 = !{!"p1 _ZTSSt5ctypeIcE", !16, i64 0}
!36 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !16, i64 0}
!37 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !16, i64 0}
