...
for.body26:                                       ; preds = %for.cond22
  ...
  %8 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !12
  %add = add nsw i32 %7, 1
  %idxprom29 = sext i32 %add to i64
  %arrayidx30 = getelementptr inbounds [500 x i32], ptr %t, i64 0, i64 %idxprom29
  %9 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
...
for.end49:                                        ; preds = %for.cond19
  %11 = load i32, ptr %t, align 16, !tbaa !5
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %11)
  store i32 1, ptr %i, align 4, !tbaa !5
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %12 = load i32, ptr %i, align 4, !tbaa !5
  %cmp53 = icmp slt i32 %12, %5
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %13 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !12
  %call58 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call55, i32 noundef %13)
  %inc60 = add nsw i32 %12, 1
