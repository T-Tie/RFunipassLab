...
for.cond33.preheader:                             ; preds = %land.lhs.true29, %for.cond
  br label %for.cond33
...
land.lhs.true29:                                  ; preds = %land.lhs.true25
  ...
  br i1 %cmp32, label %for.cond33.preheader, label %for.inc

for.inc:                                          ; preds = %for.body, %land.lhs.true, %land.lhs.true17, %land.lhs.true21, %land.lhs.true25, %land.lhs.true29
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.cond33:                                       ; preds = %for.cond33.preheader, %if.end60
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %if.end60 ], [ 1, %for.cond33.preheader ]
...
land.lhs.true47:                                  ; preds = %land.lhs.true43
  ...
  br i1 %cmp50, label %land.lhs.true51, label %if.end60
...
land.lhs.true55:                                  ; preds = %land.lhs.true51
  ...
  br i1 %cmp58, label %for.end83, label %if.end60

if.end60:                                         ; preds = %for.body35, %land.lhs.true55, %land.lhs.true51, %land.lhs.true47, %land.lhs.true43
  %12 = phi i32 [ 0, %land.lhs.true55 ], [ 0, %land.lhs.true51 ], [ 0, %land.lhs.true47 ], [ 0, %land.lhs.true43 ], [ %7, %for.body35 ]
  %arrayidx62 = getelementptr inbounds nuw [100 x i32], ptr %c, i64 0, i64 %indvars.iv32
