...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp24, label %if.end48, label %if.else32
...
if.end48.sink.split:                              ; preds = %if.then, %if.else32
...
for.cond49:                                       ; preds = %for.cond, %if.end109
  %8 = phi i32 [ %.pre, %if.end109 ], [ %0, %for.cond ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %if.end109 ], [ 0, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv23, %9
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv23
  %10 = load double, ptr %arrayidx53, align 8, !tbaa !9, !invariant.load !14
  %cmp54 = fcmp ogt double %10, 0.000000e+00
  %11 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv23
...
if.then55:                                        ; preds = %for.body51
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv23
...
if.else72:                                        ; preds = %if.else63
  ...
  %14 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv23
