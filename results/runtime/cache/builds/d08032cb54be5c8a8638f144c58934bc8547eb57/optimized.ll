; ModuleID = '<stdin>'
source_filename = "/tmp/tmp8v1urbp5.cpp"
...
entry:
  ...
  %arrayidx5 = getelementptr inbounds nuw i8, ptr %a, i64 8
  ...
  %arrayidx8 = getelementptr inbounds nuw i8, ptr %a, i64 12
  store i32 %div7.sext, ptr %arrayidx8, align 4, !tbaa !5
  ...
  store i32 %div10.sext, ptr %arrayidx11, align 16, !tbaa !5
  %rem1211 = srem i8 %rem99, 5
  %rem12.sext = sext i8 %rem1211 to i32
  store i32 %rem12.sext, ptr %n, align 4, !tbaa !5
  %arrayidx14 = getelementptr inbounds nuw i8, ptr %a, i64 20
  store i32 %rem12.sext, ptr %arrayidx14, align 4, !tbaa !5
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx15 = getelementptr inbounds nuw [6 x i32], ptr %a, i64 0, i64 %indvars.iv
