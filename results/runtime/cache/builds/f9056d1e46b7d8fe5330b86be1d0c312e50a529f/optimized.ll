...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv11 = phi i32 [ %indvars.iv.next12, %for.inc18 ], [ 0, %entry ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc18 ], [ 0, %entry ]
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #9
  %sub = sub i64 %call4, %conv5
  %cmp.not = icmp ult i64 %sub, %indvars.iv5
...
for.inc:                                          ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv5, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv5, i64 %conv5
  store i8 0, ptr %arrayidx16, align 1, !tbaa !9
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %indvars.iv.next12 = add nuw i32 %indvars.iv11, 1
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  ...
  br i1 %exitcond14.not, label %for.cond29, label %for.inc26
...
for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond26.not = icmp eq i64 %indvars.iv15, %wide.trip.count13
  br i1 %exitcond26.not, label %for.cond57, label %for.cond32.preheader
...
for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  ...
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count13
  br i1 %exitcond22.not, label %for.inc54, label %for.body34
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count13
  br i1 %exitcond32.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv27
...
if.then71:                                        ; preds = %for.end69
  call void @outlined_ir_func_0(ptr nonnull @.str)
  br label %if.end92
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc89 ], [ 0, %if.else ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count13
  br i1 %exitcond38.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv33
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv33
...
if.end92.exitStub:
  %call72 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
