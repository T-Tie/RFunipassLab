...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %zfc) #6
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %wt) #6
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %tar) #6
...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12.not = icmp slt i64 %indvars.iv22, %2
  br i1 %cmp12.not, label %for.body13, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond10
  %sext33 = shl i64 %2, 32
  %3 = ashr exact i64 %sext33, 32
  %sext34 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext34, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv22
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %6 = sub nuw nsw i64 %indvars.iv22, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv29 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next30, %for.body25 ]
  %cmp24 = icmp slt i64 %indvars.iv29, %3
  br i1 %cmp24, label %for.body25, label %for.end37

for.body25:                                       ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv29, %4
  %arrayidx28 = getelementptr inbounds nuw [256 x i8], ptr %tar, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv29
...
for.end37:                                        ; preds = %for.cond, %for.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %tar) #6
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %wt) #6
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %zfc) #6
  ret i32 0
}
