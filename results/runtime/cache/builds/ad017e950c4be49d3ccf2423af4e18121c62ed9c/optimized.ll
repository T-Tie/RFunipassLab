...
entry:
  ...
  %1 = add i32 %smax, 1
  %wide.trip.count6 = zext i32 %1 to i64
  %wide.trip.count = zext i32 %0 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc18 ], [ 0, %entry ]
  %exitcond7 = icmp eq i64 %indvars.iv, %wide.trip.count6
  br i1 %exitcond7, label %for.end20, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv2 = phi i64 [ %indvars.iv, %for.cond1.preheader ], [ %indvars.iv.next3, %for.body3 ]
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv2
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv15 = phi i32 [ %indvars.iv.next16, %while.cond ], [ 0, %for.cond ]
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv6
...
while.end:                                        ; preds = %while.cond
  %0 = trunc nuw nsw i64 %indvars.iv6 to i32
  %sub = shl i64 %indvars.iv6, 32
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv9 = phi i64 [ %2, %while.cond11.preheader ], [ %indvars.iv.next10, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %3 = trunc nuw i64 %indvars.iv.next10 to i32
  %cmp12 = icmp slt i32 %3, %0
  br i1 %cmp12, label %while.body13, label %for.inc29

while.body13:                                     ; preds = %while.cond11
  %4 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next10
...
land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next10
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv12 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next13, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select4, %for.body33 ]
  %exitcond17.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond17.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv12
  %7 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select4 = tail call i32 @llvm.smax.i32(i32 %7, i32 %n.2)
