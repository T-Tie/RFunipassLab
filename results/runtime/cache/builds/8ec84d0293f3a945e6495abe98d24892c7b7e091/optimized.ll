...
for.cond:                                         ; preds = %for.inc17, %entry
  ...
  %0 = phi i32 [ %add, %for.inc17 ], [ 1, %entry ]
...
for.cond2:                                        ; preds = %for.inc14, %for.body
  ...
  %2 = phi i32 [ %inc15, %for.inc14 ], [ %add, %for.body ]
  store i32 %add.sink, ptr %j, align 4, !tbaa !5
  %cmp3 = icmp sle i32 %2, 12
...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  ...
  %8 = phi i32 [ %inc28, %for.inc27 ], [ 1, %for.end19 ]
  store i32 %.sink1, ptr %i, align 4, !tbaa !5
  %cmp21 = icmp sle i32 %8, 12
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  ...
  %10 = phi i32 [ %inc49, %for.inc48 ], [ 1, %for.end29 ]
  store i32 %.sink2, ptr %i, align 4, !tbaa !5
  %cmp31 = icmp sle i32 %10, 12
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  ...
  %24 = phi i32 [ %inc111, %for.inc110 ], [ 1, %for.end91 ]
  store i32 %.sink5, ptr %i, align 4, !tbaa !5
  %cmp93 = icmp sle i32 %24, 12
...
for.cond95:                                       ; preds = %for.inc107, %for.body94
  ...
  %sub96 = sub nsw i32 %26, 1
  %cmp97 = icmp sle i32 %25, %sub96
...
if.else129:                                       ; preds = %for.body115
  %34 = load i32, ptr %mon1, align 4, !tbaa !5
  %idxprom130 = sext i32 %34 to i64
  %arrayidx131 = getelementptr inbounds [13 x [13 x i32]], ptr %f1, i64 0, i64 %idxprom130
  %35 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom132 = sext i32 %35 to i64
  %arrayidx133 = getelementptr inbounds [13 x i32], ptr %arrayidx131, i64 0, i64 %idxprom132
  %36 = load i32, ptr %arrayidx133, align 4, !tbaa !5
