...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !12, !invariant.load !11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !30, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !36, !invariant.load !11
  br label %return
