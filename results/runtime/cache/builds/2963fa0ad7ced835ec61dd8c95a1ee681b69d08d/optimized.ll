...
for.cond4:                                        ; preds = %for.inc31, %for.end
  ...
  br i1 %exitcond, label %for.cond34.preheader, label %for.body6

for.cond34.preheader:                             ; preds = %for.cond4
  br label %for.cond34
...
for.cond9:                                        ; preds = %for.inc29, %for.body6
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc29 ], [ %indvars.iv20, %for.body6 ]
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body36 ], [ 1, %for.cond34.preheader ]
  %m.0 = phi i32 [ %spec.select, %for.body36 ], [ 0, %for.cond34.preheader ]
