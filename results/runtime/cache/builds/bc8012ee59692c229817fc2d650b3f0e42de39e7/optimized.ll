...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull %a) #5
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv48 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next49, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv48, i32 1
...
for.cond10:                                       ; preds = %for.inc43, %for.end9
  %2 = phi i32 [ %dec, %for.inc43 ], [ %sub, %for.end9 ]
...
for.cond13.preheader:                             ; preds = %for.cond10
  ...
  %arrayidx17 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %3
  %h25 = getelementptr inbounds nuw i8, ptr %arrayidx17, i64 4
  br label %for.cond13

for.cond45.preheader:                             ; preds = %for.cond10
  %4 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %smax63 = add nsw i32 %4, -1
  %wide.trip.count64 = zext nneg i32 %smax63 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv52 = phi i64 [ %3, %for.cond13.preheader ], [ %indvars.iv.next53, %for.inc40 ]
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %5 = trunc nuw i64 %indvars.iv.next53 to i32
  %cmp14 = icmp sgt i32 %0, %5
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %6 = load i32, ptr %arrayidx17, align 8, !tbaa !15
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next53
  %7 = load i32, ptr %arrayidx20, align 8, !tbaa !15
  %cmp22.not = icmp slt i32 %6, %7
  br i1 %cmp22.not, label %for.inc40, label %if.then

if.then:                                          ; preds = %for.body15
  %8 = load i32, ptr %h25, align 4, !tbaa !12
  %h28 = getelementptr inbounds nuw i8, ptr %arrayidx20, i64 4
  %9 = load i32, ptr %h28, align 4, !tbaa !12
  %cmp30.not = icmp sgt i32 %8, %9
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count64
  br i1 %exitcond65.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv60, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc74 ], [ %indvars.iv55, %for.body48 ]
  %10 = trunc nuw i64 %indvars.iv57 to i32
  %cmp51 = icmp sgt i32 %0, %10
  br i1 %cmp51, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %11 = load i32, ptr %h55, align 4, !tbaa !12
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv57, i32 1
  %12 = load i32, ptr %h58, align 4, !tbaa !12
  %cmp59 = icmp slt i32 %11, %12
  br i1 %cmp59, label %if.then60, label %for.inc74

if.then60:                                        ; preds = %for.body52
  store i32 %12, ptr %h55, align 4, !tbaa !12
  store i32 %11, ptr %h58, align 4, !tbaa !12
  br label %for.inc74
...
for.end79:                                        ; preds = %for.cond45
  ...
  %13 = load i32, ptr %h81, align 4, !tbaa !12
  %call82 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %13) #6
