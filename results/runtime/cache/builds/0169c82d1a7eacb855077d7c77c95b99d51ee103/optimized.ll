...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %mon1) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr %mon2) #4
...
for.end29:                                        ; preds = %for.cond17
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon2) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon1) #4
