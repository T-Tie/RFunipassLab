...
if.end:                                           ; preds = %if.else27, %if.then25
  %.sink4 = phi i32 [ 30, %if.else27 ], [ 31, %if.then25 ]
  br label %if.end29

if.end29:                                         ; preds = %if.end, %if.then11
  %.sink4.sink = phi i32 [ %.sink4, %if.end ], [ 29, %if.then11 ]
...
if.end107:                                        ; preds = %if.else105, %if.then103
  %.sink2 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ]
  br label %if.end108

if.end108:                                        ; preds = %if.end107, %if.then89
  %.sink2.sink = phi i32 [ %.sink2, %if.end107 ], [ 28, %if.then89 ]
...
if.end54:                                         ; preds = %if.else52, %if.then50
  %.sink3 = phi i32 [ 30, %if.else52 ], [ 31, %if.then50 ]
  br label %if.end55

if.end55:                                         ; preds = %if.end54, %if.then34
  %.sink3.sink = phi i32 [ %.sink3, %if.end54 ], [ %1, %if.then34 ]
