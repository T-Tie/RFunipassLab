...
for.cond15:                                       ; preds = %for.inc40, %for.end14
  %v.0 = phi i32 [ 0, %for.end14 ], [ %add18, %for.inc40 ]
  %cmp16 = icmp slt i32 %v.0, %j.0.lcssa
  br i1 %cmp16, label %for.body17, label %for.end42

for.body17:                                       ; preds = %for.cond15
  %add18 = add nsw i32 %v.0, 1
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %k.0 = phi i32 [ %add18, %for.body17 ], [ %inc38, %for.inc37 ]
  %cmp20 = icmp slt i32 %k.0, %j.0.lcssa
...
for.cond43:                                       ; preds = %for.inc53, %for.end42
  %v.1 = phi i32 [ 0, %for.end42 ], [ %inc54, %for.inc53 ]
  %cmp44 = icmp slt i32 %v.1, %j.0.lcssa
  br i1 %cmp44, label %for.body45, label %for.end55

for.body45:                                       ; preds = %for.cond43
  %idxprom46 = sext i32 %v.1 to i64
  %arrayidx47 = getelementptr inbounds [500 x i32], ptr %b, i64 0, i64 %idxprom46
  %4 = load i32, ptr %arrayidx47, align 4, !tbaa !5
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4) #5
  %sub = sub nsw i32 %j.0.lcssa, 1
  %cmp49 = icmp slt i32 %v.1, %sub
  br i1 %cmp49, label %if.then50, label %for.inc53

if.then50:                                        ; preds = %for.body45
  %call51 = call i32 (ptr, ...) @printf(ptr noundef @.str.1) #5
  br label %for.inc53

for.inc53:                                        ; preds = %for.body45, %if.then50
  %inc54 = add nsw i32 %v.1, 1
