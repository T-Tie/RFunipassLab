...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10000, ptr %sz) #3
  call void @llvm.lifetime.start.p0(i64 10000, ptr %s) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %n) #3
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %n, ptr noundef %sz, ptr noundef %s)
  br label %for.cond
...
if.end65:                                         ; preds = %if.then63, %land.lhs.true61, %if.end59
  ...
  call void @llvm.lifetime.end.p0(i64 10000, ptr %s) #3
  call void @llvm.lifetime.end.p0(i64 10000, ptr %sz) #3
  ret i32 0
}
