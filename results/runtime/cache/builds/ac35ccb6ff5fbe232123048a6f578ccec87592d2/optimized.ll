...
while.cond11:                                     ; preds = %for.end138, %for.end10
  %3 = phi i32 [ %dec, %for.end138 ], [ %.lcssa, %for.end10 ]
...
for.end34:                                        ; preds = %for.cond20
  %min.0.lcssa = phi i32 [ %min.0, %for.cond20 ]
  br label %for.cond35
...
for.end74:                                        ; preds = %for.cond58
  %min.2.lcssa = phi i32 [ %min.2, %for.cond58 ]
  br label %for.cond75
...
for.inc87:                                        ; preds = %for.cond75
  ...
  %sub82 = sub nsw i32 %9, %min.2.lcssa
...
while.end:                                        ; preds = %while.cond11
  %sum.0.lcssa = phi i32 [ %sum.0, %while.cond11 ]
