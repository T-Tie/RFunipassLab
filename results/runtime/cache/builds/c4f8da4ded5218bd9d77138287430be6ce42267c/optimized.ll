...
for.inc7:                                         ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv4
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc35
  %indvars.iv7 = phi i64 [ %2, %for.cond16.preheader ], [ %indvars.iv.next8, %for.inc35 ]
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %3 = trunc nuw i64 %indvars.iv.next8 to i32
  %cmp17 = icmp sgt i32 %0, %3
  br i1 %cmp17, label %for.body18, label %for.inc38

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next8
...
land.lhs.true:                                    ; preds = %for.body18
  ...
  %arrayidx27 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next8
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.body42
  %indvars.iv10 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next11, %for.body42 ]
  %max.0 = phi i32 [ 0, %for.cond40.preheader ], [ %spec.select, %for.body42 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond14.not, label %for.end52, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx44 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv10
