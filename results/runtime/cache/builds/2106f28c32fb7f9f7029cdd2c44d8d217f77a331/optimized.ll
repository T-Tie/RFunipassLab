...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax13 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %13 = mul nsw i64 %indvars.iv16, %11
  %14 = mul nsw i64 %indvars.iv16, %12
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %15, i64 %indvars.iv9
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  %20 = phi i32 [ %22, %for.inc98 ], [ %9, %for.cond37 ]
  %21 = phi i32 [ %.pre, %for.inc98 ], [ %8, %for.cond37 ]
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %22 = phi i32 [ %.pre24, %for.inc95 ], [ %20, %for.cond77 ]
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %25 = phi i32 [ %.pre25, %if.then ], [ %24, %for.body82 ]
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre24 = phi i32 [ %25, %if.end ], [ %.pre24.pre, %if.then92 ]
