...
define dso_local void @_Z8multiplyPci(ptr nofree noundef captures(none) %str, i32 noundef %n) local_unnamed_addr #4 {
entry:
...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %num) #8
  ret void
}
