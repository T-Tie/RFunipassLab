...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %for.inc ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ %.pre11, %for.cond.for.inc_crit_edge ], [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre12, %land.lhs.true ]
  ...
  %reass.sub4 = sub i32 %7, %4
  %add51 = add i32 %reass.sub4, 43200
