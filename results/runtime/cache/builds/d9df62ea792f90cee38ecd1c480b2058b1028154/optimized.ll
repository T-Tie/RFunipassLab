...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc138
  %indvars.iv64 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next65, %for.inc138 ]
  %sum.0 = phi i32 [ 0, %for.cond13.preheader ], [ %add, %for.inc138 ]
  %exitcond69.not = icmp eq i64 %indvars.iv64, %wide.trip.count68
  br i1 %exitcond69.not, label %for.inc143, label %for.cond16

for.cond16:                                       ; preds = %for.cond13, %for.inc60
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc60 ], [ 0, %for.cond13 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond63, label %for.body18

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31
  %6 = load i32, ptr %arrayidx20, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond22

for.cond22:                                       ; preds = %for.body24, %for.body18
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body24 ], [ 0, %for.body18 ]
...
for.body24:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv21
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
  %8 = call i32 @llvm.smin.i32(i32 %7, i32 %min.0)
  %cmp3416 = icmp slt i32 %7, 0
  %min.1 = select i1 %cmp3416, i32 %min.0, i32 %8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond22, !llvm.loop !14

for.cond42:                                       ; preds = %for.cond42.preheader, %for.inc57
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc57 ], [ 0, %for.cond42.preheader ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond30.not, label %for.inc60, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx48 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv31, i64 %indvars.iv25
...
for.cond63:                                       ; preds = %for.cond16, %for.inc110
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc110 ], [ 0, %for.cond16 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %wide.trip.count35
  br i1 %exitcond53.not, label %for.end112, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %arrayidx68 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv49
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond69

for.cond69:                                       ; preds = %for.body71, %for.body65
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body71 ], [ 0, %for.body65 ]
  %min.2 = phi i32 [ %min.3, %for.body71 ], [ %10, %for.body65 ]
  %exitcond42.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond42.not, label %for.cond92.preheader, label %for.body71

for.cond92.preheader:                             ; preds = %for.cond69
  br label %for.cond92

for.body71:                                       ; preds = %for.cond69
  %arrayidx75 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv37, i64 %indvars.iv49
  %11 = load i32, ptr %arrayidx75, align 4, !tbaa !5, !invariant.load !13
  %12 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %cmp8215 = icmp slt i32 %11, 0
  %min.3 = select i1 %cmp8215, i32 %min.2, i32 %12
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  br label %for.cond69, !llvm.loop !17

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc107 ], [ 0, %for.cond92.preheader ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond48.not, label %for.inc110, label %for.body94

for.body94:                                       ; preds = %for.cond92
  %arrayidx98 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv49
...
for.end112:                                       ; preds = %for.cond63
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv64, i64 %indvars.iv64
  %14 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond117

for.cond117:                                      ; preds = %for.inc124, %for.end112
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc124 ], [ 0, %for.end112 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count35
  br i1 %exitcond58.not, label %for.cond127, label %for.inc124

for.inc124:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv64
...
for.cond127:                                      ; preds = %for.cond117, %for.inc134
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc134 ], [ 0, %for.cond117 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count35
  br i1 %exitcond63.not, label %for.inc138, label %for.inc134

for.inc134:                                       ; preds = %for.cond127
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv64, i64 %indvars.iv59
