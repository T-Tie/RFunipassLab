...
for.cond14:                                       ; preds = %for.inc, %if.then13
  %.sink8 = phi i32 [ %5, %if.then13 ], [ %inc, %for.inc ]
  %6 = load i32, ptr %b, align 4, !tbaa !5
  %cmp15 = icmp slt i32 %.sink8, %6
  br i1 %cmp15, label %for.body16, label %for.end

for.body16:                                       ; preds = %for.cond14
  switch i32 %.sink8, label %sw.default [
    i32 1, label %for.inc
    i32 3, label %for.inc
    i32 5, label %for.inc
    i32 7, label %for.inc
...
for.inc:                                          ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %sw.bb17, %sw.default
  %.sink11 = phi i32 [ 29, %sw.bb17 ], [ 30, %sw.default ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ], [ 31, %for.body16 ]
  %7 = load i32, ptr %x, align 4, !tbaa !5
  %add18 = add nsw i32 %7, %.sink11
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  %.sink7 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %11 = load i32, ptr %x, align 4, !tbaa !5
  %add36 = add nsw i32 %11, %.sink7
