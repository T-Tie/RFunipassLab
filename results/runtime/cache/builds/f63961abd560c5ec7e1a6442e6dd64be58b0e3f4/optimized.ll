...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n) #12
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef nonnull align 16 captures(none) dereferenceable(20500) %a) #13
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef %b) #13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %i) #13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j) #13
...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef nonnull %add.ptr8) #14
...
for.inc42:                                        ; preds = %for.body18, %if.then
  ...
  %sum.1 = phi i32 [ %6, %if.then ], [ %add21, %for.body18 ]
...
for.end44:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %j) #13
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef captures(none) %a) #13
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !17
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr noundef nonnull align 16 dereferenceable(20500) %2) unnamed_addr #11 {
if.then_to_outline:
  br label %for.cond23
