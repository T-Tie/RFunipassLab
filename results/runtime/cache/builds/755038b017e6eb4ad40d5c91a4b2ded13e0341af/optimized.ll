...
for.cond10:                                       ; preds = %for.inc56, %for.end9
  %x2.0 = phi i32 [ undef, %for.end9 ], [ %x2.1.lcssa, %for.inc56 ]
  %y1.0 = phi i32 [ undef, %for.end9 ], [ %y1.1.lcssa, %for.inc56 ]
  %x1.0 = phi i32 [ undef, %for.end9 ], [ %x1.1.lcssa, %for.inc56 ]
  %i.1 = phi i32 [ 1, %for.end9 ], [ %inc57, %for.inc56 ]
  %y2.0 = phi i32 [ undef, %for.end9 ], [ %y2.1.lcssa, %for.inc56 ]
...
for.inc56:                                        ; preds = %for.cond13
  %x2.1.lcssa = phi i32 [ %x2.1, %for.cond13 ]
  %y1.1.lcssa = phi i32 [ %y1.1, %for.cond13 ]
  %x1.1.lcssa = phi i32 [ %x1.1, %for.cond13 ]
  %y2.1.lcssa = phi i32 [ %y2.1, %for.cond13 ]
  %inc57 = add nsw i32 %i.1, 1
  br label %for.cond10, !llvm.loop !14

for.end58:                                        ; preds = %for.cond10
  %x2.0.lcssa = phi i32 [ %x2.0, %for.cond10 ]
  %y2.0.lcssa = phi i32 [ %y2.0, %for.cond10 ]
  %y1.0.neg.lcssa = phi i32 [ %y1.0.neg, %for.cond10 ]
  %x1.0.neg.lcssa = phi i32 [ %x1.0.neg, %for.cond10 ]
  %sub59 = add i32 %x2.0.lcssa, 1
  %add60 = add i32 %sub59, %x1.0.neg.lcssa
  %sub61 = add i32 %y1.0.neg.lcssa, 1
  %add62 = add i32 %sub61, %y2.0.lcssa
  %mul = mul nsw i32 %add62, %add60
  %add68 = add i32 %x2.0.lcssa, 2
  %sub63 = add i32 %add68, %y1.0.neg.lcssa
  %add64 = add i32 %sub63, %x1.0.neg.lcssa
  %reass.add = add i32 %add64, %y2.0.lcssa
