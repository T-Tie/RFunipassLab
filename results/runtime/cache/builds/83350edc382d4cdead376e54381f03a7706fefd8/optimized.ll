...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond21.not = icmp eq i64 %indvars.iv16, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv16
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc15 ], [ %indvars.iv10, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv12
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv30.in = phi i32 [ %indvars.iv30, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv30 = add i32 %indvars.iv30.in, -1
  %indvars.iv.next24 = add nsw i64 %indvars.iv23, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next24
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv26 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next27, %for.inc39 ]
  %exitcond34.not = icmp eq i64 %indvars.iv26, %wide.trip.count33
  br i1 %exitcond34.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv26
