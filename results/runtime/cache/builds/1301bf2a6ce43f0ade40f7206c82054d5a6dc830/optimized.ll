...
if.then20:                                        ; preds = %if.end18
  %div21 = sdiv i32 %6, 10
  %call22 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div21)
...
if.then28:                                        ; preds = %if.end26
  %div29 = sdiv i32 %8, 5
  %call30 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %div29)
...
if.end34:                                         ; preds = %if.else32, %if.then28
  ...
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %10)
