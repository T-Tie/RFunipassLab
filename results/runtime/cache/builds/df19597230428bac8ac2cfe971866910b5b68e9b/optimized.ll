...
for.cond3.preheader:                              ; preds = %for.cond
  %smax38 = call i32 @llvm.smax.i32(i32 %0, i32 0)
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc48
  %indvars.iv34 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next35, %for.inc48 ]
...
for.cond52.preheader:                             ; preds = %for.cond3
  ...
  %smax45 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
...
if.end:                                           ; preds = %if.then, %for.body6
  ...
  %smax32 = call i32 @llvm.smax.i32(i32 %j.1, i32 0)
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc45, %if.end
  %indvars.iv30.in = phi i32 [ %indvars.iv30, %for.inc45 ], [ %j.1, %if.end ]
  %p.0 = phi i32 [ %inc46, %for.inc45 ], [ 0, %if.end ]
  %indvars.iv30 = add i32 %indvars.iv30.in, -1
  %exitcond33.not = icmp eq i32 %p.0, %smax32
  br i1 %exitcond33.not, label %for.inc48, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond15
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv30, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc42
  %indvars.iv27 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next28, %for.inc42 ]
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc66
  %indvars.iv41 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next42, %for.inc66 ]
