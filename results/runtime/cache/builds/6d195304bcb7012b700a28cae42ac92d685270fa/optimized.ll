...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc10 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
while.cond.preheader:                             ; preds = %for.cond1
  %smax119 = call i32 @llvm.smax.i32(i32 %1, i32 0)
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end176
  %indvars.iv56 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next57, %for.end176 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.end176 ]
  %p.0 = phi i32 [ 0, %while.cond.preheader ], [ %inc177, %for.end176 ]
  %exitcond120.not = icmp eq i32 %p.0, %smax119
  br i1 %exitcond120.not, label %for.inc179, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %while.cond
  %smax115 = call i32 @llvm.smax.i32(i32 %indvars.iv56, i32 0)
  %wide.trip.count61 = zext nneg i32 %smax115 to i64
  %wide.trip.count = zext i32 %indvars.iv56 to i64
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  %indvars.iv58 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next59, %for.inc42 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count61
  br i1 %exitcond62.not, label %for.cond45.preheader, label %for.body16

for.cond45.preheader:                             ; preds = %for.cond14
  br label %for.cond45

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv58
  %5 = load i32, ptr %arrayidx18, align 16, !tbaa !5
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv58
...
for.cond22:                                       ; preds = %for.body25, %for.body16
  ...
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body25 ], [ 0, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv58, i64 %indvars.iv52
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc67
  %indvars.iv68 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next69, %for.inc67 ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %wide.trip.count61
  br i1 %exitcond73.not, label %for.cond70.preheader, label %for.cond49.preheader

for.cond70.preheader:                             ; preds = %for.cond45
  br label %for.cond70

for.cond49.preheader:                             ; preds = %for.cond45
  %arrayidx58 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv68
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  %indvars.iv63 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next64, %for.inc64 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond67.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond49
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv68, i64 %indvars.iv63
...
for.cond70:                                       ; preds = %for.cond70.preheader, %for.inc101
  %indvars.iv79 = phi i64 [ 0, %for.cond70.preheader ], [ %indvars.iv.next80, %for.inc101 ]
  %exitcond84.not = icmp eq i64 %indvars.iv79, %wide.trip.count61
  br i1 %exitcond84.not, label %for.cond104.preheader, label %for.body73

for.cond104.preheader:                            ; preds = %for.cond70
  br label %for.cond104

for.body73:                                       ; preds = %for.cond70
  %arrayidx76 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv79
  %10 = load i32, ptr %arrayidx76, align 4, !tbaa !5
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv79
  store i32 %10, ptr %arrayidx78, align 4, !tbaa !5
  br label %for.cond79

for.cond79:                                       ; preds = %for.body82, %for.body73
  %11 = phi i32 [ %spec.store.select47, %for.body82 ], [ %10, %for.body73 ]
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.body82 ], [ 0, %for.body73 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %wide.trip.count
  br i1 %exitcond78.not, label %for.inc101, label %for.body82

for.body82:                                       ; preds = %for.cond79
  %arrayidx88 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv74, i64 %indvars.iv79
  %12 = load i32, ptr %arrayidx88, align 4, !tbaa !5
  %spec.store.select47 = call i32 @llvm.smin.i32(i32 %11, i32 %12)
  store i32 %spec.store.select47, ptr %arrayidx78, align 4
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  %indvars.iv90 = phi i64 [ 0, %for.cond104.preheader ], [ %indvars.iv.next91, %for.inc126 ]
  %exitcond95.not = icmp eq i64 %indvars.iv90, %wide.trip.count61
  br i1 %exitcond95.not, label %for.end128, label %for.cond108

for.cond108:                                      ; preds = %for.cond104, %for.inc123
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc123 ], [ 0, %for.cond104 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count
  br i1 %exitcond89.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond108
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv90, i64 %indvars.iv85
  %13 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx117 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv85
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.inc151 ], [ 0, %for.end128 ]
  %exitcond106.not = icmp eq i64 %indvars.iv101, %wide.trip.count61
  br i1 %exitcond106.not, label %for.cond154.preheader, label %for.cond135

for.cond154.preheader:                            ; preds = %for.cond131
  br label %for.cond154

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %wide.trip.count
  br i1 %exitcond100.not, label %for.inc151, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next97 = add nuw nsw i64 %indvars.iv96, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv101, i64 %indvars.iv.next97
  %16 = load i32, ptr %arrayidx143, align 4, !tbaa !5, !invariant.load !21
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv101, i64 %indvars.iv96
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  %indvars.iv112 = phi i64 [ 0, %for.cond154.preheader ], [ %indvars.iv.next113, %for.inc174 ]
  %exitcond117.not = icmp eq i64 %indvars.iv112, %wide.trip.count61
  br i1 %exitcond117.not, label %for.end176, label %for.cond158

for.cond158:                                      ; preds = %for.cond154, %for.inc171
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc171 ], [ 1, %for.cond154 ]
  %exitcond111.not = icmp eq i64 %indvars.iv107, %wide.trip.count
  br i1 %exitcond111.not, label %for.inc174, label %for.inc171

for.inc171:                                       ; preds = %for.cond158
  %indvars.iv.next108 = add nuw nsw i64 %indvars.iv107, 1
  %arrayidx166 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next108, i64 %indvars.iv112
  %17 = load i32, ptr %arrayidx166, align 4, !tbaa !5, !invariant.load !21
  %arrayidx170 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv107, i64 %indvars.iv112
