...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = tail call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %0) #7
...
if.then:                                          ; preds = %tailrecurse
  ...
  %2 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !14
  %3 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !14
...
if.else5:                                         ; preds = %tailrecurse
  ...
  %5 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !14
...
if.then11:                                        ; preds = %if.else5
  ...
  %add = add nsw i32 %6, 1
  %call = tail call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %6, i32 noundef %n) #8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !15, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !33, !invariant.load !14
