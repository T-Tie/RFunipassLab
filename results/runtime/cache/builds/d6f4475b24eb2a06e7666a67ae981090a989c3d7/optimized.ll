...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 500, ptr noundef nonnull align 16 %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 3006, ptr noundef nonnull align 16 %b) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(3006) %b, i8 noundef 0, i64 noundef 3006, i1 noundef false) #9
  ...
  %call3 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
...
for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond26 = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax12 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.cond71.preheader:                             ; preds = %for.cond11
  ...
  %smax39 = add nsw i32 %3, -1
  %wide.trip.count40 = zext nneg i32 %smax39 to i64
  br label %for.cond71

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv9 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next10, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond14.not = icmp eq i64 %indvars.iv9, %wide.trip.count13
  br i1 %exitcond14.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.body19 ], [ 0, %for.cond14 ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond14 ]
  %exitcond8.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond8.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv3, %indvars.iv21
  %arrayidx21 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx21, align 1, !tbaa !9
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv9, i64 %indvars.iv3
  %6 = load i8, ptr %arrayidx26, align 1, !tbaa !9
  %cmp28.not = icmp ne i8 %5, %6
  %inc29 = zext i1 %cmp28.not to i32
  %spec.select = add nuw nsw i32 %inc29, %x.0
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv9, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv15 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next16, %for.inc56 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond20.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv15, %indvars.iv21
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom59, i64 %indvars.iv15
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv36, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc118 ], [ %indvars.iv31, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv33 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv33, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond30.not = icmp eq i64 %indvars.iv27, 6
  br i1 %exitcond30.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv33, i64 %indvars.iv27
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv27
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv36, i64 %indvars.iv27
...
if.then128:                                       ; preds = %for.end123
  %call129 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2) #11
  br label %if.end226

if.else:                                          ; preds = %for.end123
  %conv126 = sext i8 %16 to i32
  %call133 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %conv126) #11
  %wide.trip.count48 = zext nneg i32 %3 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc151 ], [ 1, %if.else ]
  %phiofops = phi i32 [ %17, %for.inc151 ], [ 0, %if.else ]
  %17 = trunc nuw nsw i64 %indvars.iv42 to i32
  %exitcond49.not = icmp eq i64 %indvars.iv42, %wide.trip.count48
  br i1 %exitcond49.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv42, i64 4
  %18 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %19 = add nsw i64 %indvars.iv42, -1
  %arrayidx144 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %19, i64 4
  %20 = load i8, ptr %arrayidx144, align 2, !tbaa !9
  %cmp146 = icmp eq i8 %18, %20
  br i1 %cmp146, label %for.inc151, label %for.body136.for.end153_crit_edge

for.body136.for.end153_crit_edge:                 ; preds = %for.body136
  %.pre = and i64 %indvars.iv42, 4294967295
  br label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136.for.end153_crit_edge
  %.pre-phi = phi i64 [ %.pre, %for.body136.for.end153_crit_edge ], [ %wide.trip.count48, %for.cond134 ]
  %phiofops.lcssa = phi i32 [ %phiofops, %for.body136.for.end153_crit_edge ], [ %smax39, %for.cond134 ]
  %wide.trip.count62 = zext i32 %phiofops.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count62
  br i1 %exitcond63.not, label %for.cond207, label %for.body157

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv59, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc201 ], [ %indvars.iv54, %for.body157 ]
  %cmp160 = icmp samesign ult i64 %indvars.iv56, %.pre-phi
  br i1 %cmp160, label %for.body161, label %for.cond154.loopexit

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv56, i64 5
  %21 = load i8, ptr %arrayidx164, align 1, !tbaa !9
  %22 = load i8, ptr %arrayidx168, align 1, !tbaa !9
  %cmp170 = icmp slt i8 %21, %22
  br i1 %cmp170, label %for.cond172, label %for.inc201

for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond53.not = icmp eq i64 %indvars.iv50, 6
  br i1 %exitcond53.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv56, i64 %indvars.iv50
  %23 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv50
  store i8 %23, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv59, i64 %indvars.iv50
  %24 = load i8, ptr %arrayidx185, align 1, !tbaa !9
  store i8 %24, ptr %arrayidx178, align 1, !tbaa !9
  %25 = load i8, ptr %arrayidx181, align 1, !tbaa !9
  store i8 %25, ptr %arrayidx185, align 1, !tbaa !9
...
for.cond207:                                      ; preds = %for.cond154, %for.inc223
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc223 ], [ 0, %for.cond154 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %.pre-phi
  br i1 %exitcond71.not, label %if.end226, label %for.body209

for.body209:                                      ; preds = %for.cond207
  %putchar = call i32 @putchar(i32 noundef 10) #11
  br label %for.cond211

for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc220 ], [ 0, %for.body209 ]
  %26 = load i32, ptr %n, align 4, !tbaa !5
  %27 = sext i32 %26 to i64
  %cmp212 = icmp slt i64 %indvars.iv64, %27
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv67, i64 %indvars.iv64
  %28 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %28 to i32
  %putchar1 = call i32 @putchar(i32 noundef %conv218) #11
...
if.end226:                                        ; preds = %for.cond207, %if.then128
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 3006, ptr noundef nonnull %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 500, ptr noundef nonnull %a) #11
  ret i32 0
}
