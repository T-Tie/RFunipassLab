...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) @a) #11
...
if.then:                                          ; preds = %for.body, %land.lhs.true
  ...
  %call9 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %3)
  %.pre4 = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %lor.lhs.false, %land.lhs.true, %if.then
  %4 = phi i32 [ %storemerge, %lor.lhs.false ], [ %storemerge, %land.lhs.true ], [ %.pre4, %if.then ]
...
entry:
  ...
  %vtable7.i = load ptr, ptr @_ZSt3cin, align 8, !tbaa !14, !invariant.load !10
  ...
  %call16.i = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %0 = load i64, ptr %_M_width.i4.i, align 8, !tbaa !16, !invariant.load !10
  %1 = add i64 %0, -101
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #12
