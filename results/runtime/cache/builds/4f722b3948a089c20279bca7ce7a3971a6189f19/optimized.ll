...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr nonnull %word) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(41000) %word, i8 0, i64 41000, i1 false)
  call void @llvm.lifetime.start.p0(i64 81000, ptr nonnull %newword) #10
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx6) #10
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx6) #10
...
if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #10
  store i8 32, ptr %arrayidx56, align 1, !tbaa !34
  br label %for.inc74

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #10
  store i8 32, ptr %arrayidx56, align 1, !tbaa !34
  br label %for.inc74
...
for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 81000, ptr nonnull %newword) #10
  call void @llvm.lifetime.end.p0(i64 41000, ptr nonnull %word) #10
