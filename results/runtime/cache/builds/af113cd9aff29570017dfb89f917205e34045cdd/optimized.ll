...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull %ch) #7
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %cmp, label %for.body, label %while.body.preheader
...
while.body:                                       ; preds = %while.body.preheader, %while.body.loopexit
  %7 = phi i32 [ %9, %while.body.loopexit ], [ %0, %while.body.preheader ]
  %num.0 = phi i32 [ %num.1, %while.body.loopexit ], [ 0, %while.body.preheader ]
  %cnt.0 = phi i32 [ %6, %while.body.loopexit ], [ 0, %while.body.preheader ]
