...
for.body:                                         ; preds = %for.cond
  ...
  %call.i5 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 8 dereferenceable(8) %b)
  %call.i6 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i5, ptr noundef nonnull align 8 dereferenceable(8) %c)
...
if.then:                                          ; preds = %for.body
  ...
  %call1.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i14)
  ...
  %.pre31 = load double, ptr %a, align 8, !tbaa !9
  %.pre32 = load double, ptr %c, align 8, !tbaa !9
  %.pre36 = fmul double %.pre31, 4.000000e+00
  %.pre37 = fneg double %.pre32
  %.pre38 = fmul double %.pre36, %.pre37
  %.pre39 = call double @llvm.fmuladd.f64(double %.pre, double %.pre, double %.pre38)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %.pre-phi40 = phi double [ %.pre39, %if.then ], [ %5, %for.body ]
  %mul24.pre-phi = phi double [ %.pre36, %if.then ], [ %mul4, %for.body ]
  %11 = phi double [ %.pre32, %if.then ], [ %3, %for.body ]
  %12 = phi double [ %.pre31, %if.then ], [ %2, %for.body ]
  %13 = phi double [ %.pre, %if.then ], [ %1, %for.body ]
  %cmp27 = fcmp oeq double %.pre-phi40, 0.000000e+00
...
if.then28:                                        ; preds = %if.end
  ...
  %vtable.i17 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !11
  %vbase.offset.ptr.i18 = getelementptr i8, ptr %vtable.i17, i64 -24
  %vbase.offset.i19 = load i64, ptr %vbase.offset.ptr.i18, align 8, !invariant.load !13
  %add.ptr.i20 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i19
  ...
  %call1.i22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i21)
  ...
  %.pre33 = load double, ptr %b, align 8, !tbaa !9
  %.pre34 = load double, ptr %a, align 8, !tbaa !9
  %.pre35 = load double, ptr %c, align 8, !tbaa !9
  %.pre41 = fmul double %.pre34, 4.000000e+00
  %.pre42 = fneg double %.pre35
  %.pre44 = fmul double %.pre41, %.pre42
  %.pre45 = call double @llvm.fmuladd.f64(double %.pre33, double %.pre33, double %.pre44)
  br label %if.end34

if.end34:                                         ; preds = %if.then28, %if.end
  %.pre-phi46 = phi double [ %.pre45, %if.then28 ], [ %.pre-phi40, %if.end ]
  %mul36.pre-phi = phi double [ %.pre41, %if.then28 ], [ %mul24.pre-phi, %if.end ]
  %14 = phi double [ %.pre35, %if.then28 ], [ %11, %if.end ]
  %15 = phi double [ %.pre34, %if.then28 ], [ %12, %if.end ]
  %16 = phi double [ %.pre33, %if.then28 ], [ %13, %if.end ]
  %cmp39 = fcmp olt double %.pre-phi46, 0.000000e+00
...
if.then42:                                        ; preds = %if.then40
  ...
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 1)
...
if.else:                                          ; preds = %if.then40
  ...
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 1)
...
if.end85:                                         ; preds = %if.else, %if.then42
  ...
  %vbase.offset.i26 = load i64, ptr %vbase.offset.ptr.i25, align 8, !invariant.load !13
