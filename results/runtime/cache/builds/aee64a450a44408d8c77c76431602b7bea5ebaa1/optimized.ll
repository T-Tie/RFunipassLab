...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %a) #10
...
if.then.i.i:                                      ; preds = %for.end
  ...
  call void @_ZSt16__introsort_loopIPilN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_T1_(ptr noundef nonnull %a, ptr noundef nonnull %add.ptr5, i64 noundef %mul.i.i)
  call void @_ZSt22__final_insertion_sortIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_T0_(ptr noundef nonnull %a, ptr noundef nonnull %add.ptr5)
...
for.end18:                                        ; preds = %for.cond9
  call void @llvm.lifetime.end.p0(i64 2000, ptr nonnull %a) #10
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef %__result, ptr noundef %__a, ptr noundef %__b, ptr noundef %__c) #4 comdat {
entry:
...
define linkonce_odr dso_local noundef ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef %__pivot) #5 comdat {
entry:
  br label %while.body
