...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv2 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next3, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax18 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count19 = zext nneg i32 %smax18 to i64
  %wide.trip.count12 = zext i32 %j.0 to i64
  br label %for.cond15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv2
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv14
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc37 ], [ %indvars.iv6, %for.body17 ]
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.cond15.loopexit, label %for.body21
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv21 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next22, %for.inc53 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond25.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv21
  ...
  %cmp49 = icmp slt i64 %indvars.iv21, %4
