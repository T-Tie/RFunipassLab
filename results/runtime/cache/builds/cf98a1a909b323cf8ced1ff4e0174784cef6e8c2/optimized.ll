...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 90000, ptr noundef nonnull align 16 dereferenceable(90000) %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 90000, ptr noundef nonnull align 16 dereferenceable(90000) %b) #4
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef %a) #5
  ret i32 0
}
