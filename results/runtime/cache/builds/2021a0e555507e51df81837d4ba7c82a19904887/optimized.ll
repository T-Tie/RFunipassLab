...
for.cond13:                                       ; preds = %for.end136, %for.end12
  %temp.0 = phi i32 [ 1, %for.end12 ], [ %inc137, %for.end136 ]
  %sum.0 = phi i32 [ 0, %for.end12 ], [ %add, %for.end136 ]
  %l.0 = phi i32 [ 0, %for.end12 ], [ %inc139, %for.end136 ]
  %sub = sub nsw i32 %1, 1
...
for.cond16:                                       ; preds = %for.end59, %for.body15
  %i.1 = phi i32 [ 0, %for.body15 ], [ %inc61, %for.end59 ]
...
for.cond22:                                       ; preds = %if.end, %for.body18
  %j.1 = phi i32 [ 0, %for.body18 ], [ %inc40, %if.end ]
  %min.0 = phi i32 [ %3, %for.body18 ], [ %min.1, %if.end ]
...
for.cond42:                                       ; preds = %if.end56, %for.end41
  %j.2 = phi i32 [ 0, %for.end41 ], [ %inc58, %if.end56 ]
...
for.cond63:                                       ; preds = %for.end109, %for.end62
  %j.3 = phi i32 [ 0, %for.end62 ], [ %inc111, %for.end109 ]
...
for.cond69:                                       ; preds = %if.end88, %for.body65
  %i.2 = phi i32 [ 0, %for.body65 ], [ %inc90, %if.end88 ]
  %min.2 = phi i32 [ %6, %for.body65 ], [ %min.3, %if.end88 ]
...
for.body71:                                       ; preds = %for.cond69
  ...
  br i1 %cmp76, label %land.lhs.true77, label %if.end88
...
if.end88:                                         ; preds = %if.then83, %land.lhs.true77, %for.body71
...
for.cond92:                                       ; preds = %if.end106, %for.end91
  %i.3 = phi i32 [ 0, %for.end91 ], [ %inc108, %if.end106 ]
...
for.cond117:                                      ; preds = %for.body119, %for.end112
  %i.4 = phi i32 [ 0, %for.end112 ], [ %inc125, %for.body119 ]
...
for.cond127:                                      ; preds = %for.body129, %for.end126
  %j.4 = phi i32 [ 0, %for.end126 ], [ %inc135, %for.body129 ]
...
entry:
  ...
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !25
