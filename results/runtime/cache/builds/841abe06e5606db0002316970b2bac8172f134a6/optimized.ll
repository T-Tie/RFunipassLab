...
for.body:                                         ; preds = %for.cond
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br i1 %or.cond9, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %n1.0 = phi i32 [ %add28, %for.inc ], [ 0, %for.body ]
  %4 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %exitcond43.not = icmp eq i32 %4, %smax42
  br i1 %exitcond43.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %5 = load i32, ptr %m2, align 4, !tbaa !5
  %smax44 = call i32 @llvm.smax.i32(i32 %5, i32 1)
  br label %for.cond30
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %exitcond45.not = icmp eq i32 %6, %smax44
  br i1 %exitcond45.not, label %for.end58, label %for.body32
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts37 = call i32 @puts(ptr nonnull dereferenceable(1) %str.5.str.4)
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %7, %smax42
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax40 = call i32 @llvm.smax.i32(i32 %8, i32 1)
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %exitcond41.not = icmp eq i32 %9, %smax40
  br i1 %exitcond41.not, label %for.end140, label %for.body114
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts33 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts34 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink)
  br label %for.inc164
