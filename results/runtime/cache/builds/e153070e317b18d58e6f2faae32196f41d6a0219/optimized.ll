...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body5 ], [ 0, %for.cond3.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv17, %idxprom6
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv20 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next21, %for.inc19 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond11
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next21
  %8 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv20
...
for.cond29:                                       ; preds = %while.cond, %for.inc37
  ...
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc37 ], [ 0, %while.cond ]
  %sub30 = add nsw i32 %10, -1
  %11 = sext i32 %sub30 to i64
  %cmp31 = icmp slt i64 %indvars.iv25, %11
  br i1 %cmp31, label %for.inc37, label %for.end39

for.inc37:                                        ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv25
