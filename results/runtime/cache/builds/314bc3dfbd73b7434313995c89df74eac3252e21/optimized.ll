...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 550, ptr noundef align 16 %a) #7
...
for.inc17:                                        ; preds = %for.cond6
  %idxprom13.lcssa = phi i64 [ %idxprom13, %for.cond6 ]
  %idxprom15.lcssa = phi i64 [ %idxprom15, %for.cond6 ]
  %arrayidx14 = getelementptr inbounds [550 x [6 x i8]], ptr %b, i64 0, i64 %idxprom13.lcssa
  %arrayidx16 = getelementptr inbounds [6 x i8], ptr %arrayidx14, i64 0, i64 %idxprom15.lcssa
  store i8 0, ptr %arrayidx16, align 1, !tbaa !9
  %inc18 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !13

for.end19:                                        ; preds = %for.cond
  %sub.lcssa = phi i32 [ %sub, %for.cond ]
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc47, %for.end19
  %i20.0 = phi i32 [ 0, %for.end19 ], [ %add27, %for.inc47 ]
  %cmp23 = icmp slt i32 %i20.0, %sub.lcssa
...
for.cond28:                                       ; preds = %for.inc44, %for.body25
  ...
  %cmp30 = icmp sle i32 %j26.0, %sub.lcssa
...
for.cond51:                                       ; preds = %for.inc63, %for.end49
  ...
  %cmp53 = icmp slt i32 %i50.0, %sub.lcssa
...
for.end65:                                        ; preds = %for.cond51
  %max.0.lcssa = phi i32 [ %max.0, %for.cond51 ]
  %cmp66 = icmp eq i32 %max.0.lcssa, 0
...
if.else:                                          ; preds = %for.end65
  %add69 = add nsw i32 %max.0.lcssa, 1
...
for.body77:                                       ; preds = %for.cond73
  ...
  %cmp80 = icmp eq i32 %5, %max.0.lcssa
