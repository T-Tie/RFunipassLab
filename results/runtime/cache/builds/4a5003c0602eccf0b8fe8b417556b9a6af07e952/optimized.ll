...
for.cond:                                         ; preds = %if.end, %while.end
  ...
  %i.0 = phi i32 [ 0, %while.end ], [ %inc14, %if.end ]
...
for.cond15:                                       ; preds = %if.end34, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc36, %if.end34 ]
...
for.cond18:                                       ; preds = %if.end25, %for.body17
  %k.0 = phi i32 [ 0, %for.body17 ], [ %inc27, %if.end25 ]
...
!21 = !{}
!22 = !{!23, !24, i64 16}
!23 = !{!"_ZTSSt8ios_base", !24, i64 8, !24, i64 16, !25, i64 24, !26, i64 28, !26, i64 32, !27, i64 40, !28, i64 48, !6, i64 64, !12, i64 192, !29, i64 200, !30, i64 208}
!24 = !{!"long", !6, i64 0}
