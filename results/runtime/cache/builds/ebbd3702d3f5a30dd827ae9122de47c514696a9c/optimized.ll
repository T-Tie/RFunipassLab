...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z7guilingi(i32 noundef %3) #10
...
for.end29:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i30) #9
...
for.body34:                                       ; preds = %for.cond31
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %min35) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j38) #9
...
for.end56:                                        ; preds = %for.cond39
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j38) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j57) #9
...
for.inc70:                                        ; preds = %for.cond58
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j57) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %min35) #9
  %inc71 = add nsw i32 %8, 1
  store i32 %inc71, ptr %i30, align 4, !tbaa !5
  br label %for.cond31, !llvm.loop !19

for.end72:                                        ; preds = %for.cond31
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %i30) #9
...
if.else:                                          ; preds = %for.end72
  call void @_Z8xiaojiani(i32 noundef %n) #11
...
define dso_local void @_Z8xiaojiani(i32 noundef %n) #7 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #9
