...
if.then:                                          ; preds = %for.body
  ...
  %smax10 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br label %for.cond7
...
if.end79:                                         ; preds = %for.cond7
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n2, i32 noundef 29, i32 %n1.0, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %M)
...
for.inc109:                                       ; preds = %for.body87, %if.else105, %if.then103
  ...
  %add90 = add nuw nsw i32 %n182.0, %.sink12
  %inc110 = add nuw i32 %storemerge, 1
  br label %for.cond85, !llvm.loop !12

if.end162:                                        ; preds = %for.cond85
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j81, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n283, i32 noundef 28, i32 %n182.0, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %M84)
