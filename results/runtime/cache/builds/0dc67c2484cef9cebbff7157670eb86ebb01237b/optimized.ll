...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #10
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %blank) #10
...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %letter) #11
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  ...
  %call15 = call i64 @strlen(ptr noundef %letter) #11
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %blank) #12
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #12
  ret i32 0
}
