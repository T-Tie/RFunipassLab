...
entry:
  ...
  %smax9 = tail call i32 @llvm.smax.i32(i32 %x, i32 0)
...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc29 ], [ 0, %entry ]
  %4 = load i32, ptr %m, align 4, !tbaa !9
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv18, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !9
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv15, %7
...
for.inc:                                          ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !9, !invariant.load !13
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv15
  %10 = load i32, ptr %arrayidx14, align 4, !tbaa !9, !invariant.load !13
...
for.end:                                          ; preds = %for.cond6
  ...
  %cmp15 = icmp slt i64 %indvars.iv15, %11
  br i1 %cmp15, label %for.inc26, label %if.else

if.else:                                          ; preds = %for.end
  %12 = zext i32 %sub to i64
  %cmp18 = icmp eq i64 %indvars.iv15, %12
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv18, %14
