...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 160, ptr nonnull %sum) #6
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  ...
  %exitcond23 = icmp eq i32 %i.1, %2
  br i1 %exitcond23, label %while.cond, label %for.cond6
...
for.cond15:                                       ; preds = %for.cond6, %for.inc30
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc30 ], [ 0, %for.cond6 ]
  %exitcond22.not = icmp eq i64 %indvars.iv19, 40
  br i1 %exitcond22.not, label %for.inc33, label %for.inc30

for.inc30:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv19
  %4 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %div = sdiv i32 %4, 10
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %arrayidx21 = getelementptr inbounds nuw [40 x i32], ptr %sum, i64 0, i64 %indvars.iv.next20
...
while.cond:                                       ; preds = %for.cond3, %while.cond
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %while.cond ], [ 39, %for.cond3 ]
  %arrayidx37 = getelementptr inbounds [40 x i32], ptr %sum, i64 0, i64 %indvars.iv24
...
if.end:                                           ; preds = %for.cond39, %for.end
  call void @llvm.lifetime.end.p0(i64 160, ptr nonnull %sum) #6
