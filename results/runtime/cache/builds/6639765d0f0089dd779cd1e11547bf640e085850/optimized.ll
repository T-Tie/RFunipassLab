...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57
  %indvars.iv103 = phi i32 [ %indvars.iv.next104, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %indvars.iv99 = phi i32 [ %indvars.iv.next100, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc30 ], [ %8, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit57 ]
  %exitcond95.not = icmp eq i64 %indvars.iv79, %wide.trip.count94
  br i1 %exitcond95.not, label %if.then34, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv79
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc ], [ %indvars.iv79, %for.body ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 1, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv81, %indvars.iv88
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next82
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  ...
  %exitcond102.not = icmp eq i64 %indvars.iv96, %wide.trip.count
  br i1 %exitcond102.not, label %for.end45, label %for.inc43
...
for.end45:                                        ; preds = %for.cond37
  ...
  %14 = sext i32 %indvars.iv103 to i64
  %sext = shl i64 %call6, 32
  %15 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv106 = phi i64 [ %indvars.iv.next107, %for.inc54 ], [ %14, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv106, %15
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv106
