...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2040, ptr noundef nonnull align 16 %a) #6
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc31
  %indvars.iv21 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next22, %for.inc31 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc28
  ...
  %cmp8.not.not = icmp sgt i64 %indvars.iv, %indvars.iv21
...
for.cond36:                                       ; preds = %for.inc44, %for.end33
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc44 ], [ 1, %for.end33 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.end46, label %for.inc44
...
for.inc44:                                        ; preds = %for.cond36
  ...
  %arrayidx42 = getelementptr inbounds nuw [510 x i32], ptr %a, i64 0, i64 %indvars.iv25
...
for.end46:                                        ; preds = %for.cond36
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2040, ptr noundef nonnull %a) #7
  ret i32 0
}
