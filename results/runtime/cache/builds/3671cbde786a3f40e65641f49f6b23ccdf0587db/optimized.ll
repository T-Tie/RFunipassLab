...
if.then38:                                        ; preds = %for.body32
  store i32 %7, ptr %i2, align 4, !tbaa !5
  store i32 %8, ptr %j2, align 4, !tbaa !5
  br label %for.end41
...
for.end41:                                        ; preds = %if.then38, %for.cond30
  br label %for.inc42

for.inc42:                                        ; preds = %for.end41
  %dec43 = add nsw i32 %7, -1
  store i32 %dec43, ptr %i, align 4, !tbaa !5
  br label %for.cond27, !llvm.loop !16

for.end44:                                        ; preds = %for.cond27
  %10 = load i32, ptr %j2, align 4, !tbaa !5
  %11 = load i32, ptr %j1, align 4, !tbaa !5
  %sub = sub nsw i32 %10, %11
  %sub45 = sub nsw i32 %sub, 1
  %12 = load i32, ptr %i1, align 4, !tbaa !5
  %13 = load i32, ptr %i2, align 4, !tbaa !5
  %sub46 = sub nsw i32 %12, %13
