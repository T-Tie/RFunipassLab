...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !15, !invariant.load !12
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !15, !invariant.load !12
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !17, !invariant.load !12
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !5, !invariant.load !12
  %1 = load i32, ptr %__c2, align 4, !tbaa !5, !invariant.load !12
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
