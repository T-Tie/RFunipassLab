...
for.cond35:                                       ; preds = %for.inc44, %for.end34
  ...
  %cmp36 = icmp slt i32 %6, %7
  br i1 %cmp36, label %for.inc44, label %for.end46

for.inc44:                                        ; preds = %for.cond35
  %sub38 = sub nsw i32 %conv, %7
  %add39 = add nsw i32 %sub38, %6
  ...
  store i8 %8, ptr %arrayidx43, align 1, !tbaa !9
  %inc45 = add nsw i32 %6, 1
...
for.cond47:                                       ; preds = %for.inc53, %for.end46
  ...
  %cmp48 = icmp slt i32 %9, %conv
  br i1 %cmp48, label %for.inc53, label %for.end55

for.inc53:                                        ; preds = %for.cond47
  %idxprom50 = sext i32 %9 to i64
  %arrayidx51 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %idxprom50
  %10 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %10)
  %inc54 = add nsw i32 %9, 1
