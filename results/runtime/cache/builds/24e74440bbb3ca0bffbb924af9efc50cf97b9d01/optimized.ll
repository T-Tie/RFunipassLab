...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 676, ptr noundef %f2) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %mon1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %mon2) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 %f1, i8 noundef 0, i64 noundef 676, i1 noundef false) #8
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %f2, i8 noundef 0, i64 noundef 676, i1 noundef false) #8
  br label %for.cond

for.cond:                                         ; preds = %for.inc17, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc18, %for.inc17 ]
...
for.cond2:                                        ; preds = %for.inc14, %for.body
  %i.0.sink = phi i32 [ %i.0, %for.body ], [ %add, %for.inc14 ]
...
for.cond5:                                        ; preds = %for.inc, %for.body4
  ...
  %cmp6 = icmp sle i32 %k.0, %i.0.sink
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %i.3 = phi i32 [ 1, %for.end50 ], [ %inc80, %for.inc79 ]
...
for.cond55:                                       ; preds = %for.inc76, %for.body53
  %i.3.sink = phi i32 [ %i.3, %for.body53 ], [ %add54, %for.inc76 ]
  %add54 = add nsw i32 %i.3.sink, 1
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  ...
  %cmp60 = icmp sle i32 %k.1, %i.3.sink
...
for.inc141:                                       ; preds = %for.body115, %if.else129
  ...
  %arrayidx131 = getelementptr inbounds [13 x [13 x i32]], ptr %f1.sink, i64 0, i64 %idxprom130
  ...
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %arrayidx133) #9
  %inc142 = add nsw i32 %i.6, 1
  br label %for.cond113, !llvm.loop !23

for.end143:                                       ; preds = %for.cond113
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon2) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon1) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %year) #9
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #9
  call void @llvm.lifetime.end.p0(i64 676, ptr %f2) #9
  call void @llvm.lifetime.end.p0(i64 676, ptr %f1) #9
  ret i32 0
}
...
define internal fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %0) unnamed_addr #6 {
if.then119_to_outline:
  %1 = load i32, ptr %0, align 4, !tbaa !5, !invariant.load !24
  %cmp124 = icmp eq i32 %1, 1
  br i1 %cmp124, label %if.then125, label %if.else

if.then125:                                       ; preds = %if.then119_to_outline
  %call126 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #10
  br label %if.end140.exitStub

if.else:                                          ; preds = %if.then119_to_outline
  %call127 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #10
  br label %if.end140.exitStub

if.end140.exitStub:                               ; preds = %if.then125, %if.else
  ret void
}
