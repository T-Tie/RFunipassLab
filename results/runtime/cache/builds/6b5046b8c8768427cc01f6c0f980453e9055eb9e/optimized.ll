...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv127 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next128, %for.inc135 ]
  %indvars.iv124 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next125, %for.inc135 ]
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv76 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next77, %for.inc45 ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %indvars.iv127
  br i1 %exitcond80.not, label %for.inc48, label %for.inc45
...
for.cond54:                                       ; preds = %for.cond51, %for.body56
  ...
  %min.2 = phi i32 [ %spec.select68, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %indvars.iv127
  br i1 %exitcond90.not, label %for.cond71.preheader, label %for.body56
...
for.body56:                                       ; preds = %for.cond54
  ...
  %spec.select68 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next87 = add nuw nsw i64 %indvars.iv86, 1
  br label %for.cond54, !llvm.loop !17

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv91 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next92, %for.inc83 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %indvars.iv127
  br i1 %exitcond95.not, label %for.inc86, label %for.inc83
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv101 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next102, %for.inc107 ]
  %exitcond105.not = icmp eq i64 %indvars.iv101, %indvars.iv127
  br i1 %exitcond105.not, label %for.cond91, label %for.inc107, !llvm.loop !20
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  ...
  br i1 %exitcond123.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv114 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next115, %for.inc129 ]
  %exitcond118.not = icmp eq i64 %indvars.iv114, %indvars.iv124
  br i1 %exitcond118.not, label %for.cond113, label %for.inc129, !llvm.loop !22
