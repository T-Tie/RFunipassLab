...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.body5 ], [ 0, %for.cond3.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv3, %idxprom6
  br i1 %exitcond.not, label %for.end24, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv3
...
for.cond11.preheader:                             ; preds = %for.body5
  %sub = add nsw i32 %5, -1
  %wide.trip.count9 = zext i32 %sub to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv6 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next7, %for.inc19 ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, %wide.trip.count9
  br i1 %exitcond10.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond11
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next7
  %8 = load i32, ptr %arrayidx16, align 4, !tbaa !5, !invariant.load !12
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv6
...
for.cond29:                                       ; preds = %while.cond, %for.inc37
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc37 ], [ 0, %while.cond ]
  %sub30 = add nsw i32 %10, -1
  %11 = sext i32 %sub30 to i64
  %cmp31 = icmp slt i64 %indvars.iv11, %11
  br i1 %cmp31, label %for.inc37, label %for.end39

for.inc37:                                        ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv11
