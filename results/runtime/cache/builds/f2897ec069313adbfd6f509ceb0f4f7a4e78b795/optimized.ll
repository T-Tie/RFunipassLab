...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 60000, ptr %c) #7
  call void @llvm.lifetime.start.p0(i64 600, ptr %input) #7
...
if.end92:                                         ; preds = %if.then71, %for.end91
  call void @llvm.lifetime.end.p0(i64 600, ptr %input) #7
  call void @llvm.lifetime.end.p0(i64 60000, ptr %c) #7
