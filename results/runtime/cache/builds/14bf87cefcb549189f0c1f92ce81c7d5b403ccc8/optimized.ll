...
for.cond14:                                       ; preds = %for.inc, %if.then13
  ...
  br i1 %cmp15, label %NodeBlock29, label %for.end

NodeBlock29:                                      ; preds = %for.cond14
  %Pivot30 = icmp slt i32 %m.0, 5
  br i1 %Pivot30, label %NodeBlock13, label %NodeBlock27

NodeBlock27:                                      ; preds = %NodeBlock29
  %Pivot28 = icmp slt i32 %m.0, 10
  br i1 %Pivot28, label %NodeBlock19, label %NodeBlock25

NodeBlock25:                                      ; preds = %NodeBlock27
  %Pivot26 = icmp slt i32 %m.0, 12
  br i1 %Pivot26, label %LeafBlock21, label %LeafBlock23

LeafBlock23:                                      ; preds = %NodeBlock25
  %SwitchLeaf24 = icmp eq i32 %m.0, 12
  br i1 %SwitchLeaf24, label %for.inc, label %sw.default

LeafBlock21:                                      ; preds = %NodeBlock25
  %SwitchLeaf22 = icmp eq i32 %m.0, 10
  br i1 %SwitchLeaf22, label %for.inc, label %sw.default

NodeBlock19:                                      ; preds = %NodeBlock27
  %Pivot20 = icmp slt i32 %m.0, 7
  br i1 %Pivot20, label %LeafBlock15, label %LeafBlock17

LeafBlock17:                                      ; preds = %NodeBlock19
  %SwitchLeaf18 = icmp sle i32 %m.0, 8
  br i1 %SwitchLeaf18, label %for.inc, label %sw.default

LeafBlock15:                                      ; preds = %NodeBlock19
  %SwitchLeaf16 = icmp eq i32 %m.0, 5
  br i1 %SwitchLeaf16, label %for.inc, label %sw.default

NodeBlock13:                                      ; preds = %NodeBlock29
  %Pivot14 = icmp slt i32 %m.0, 2
  br i1 %Pivot14, label %LeafBlock, label %NodeBlock

NodeBlock:                                        ; preds = %NodeBlock13
  %Pivot = icmp slt i32 %m.0, 3
  br i1 %Pivot, label %for.inc, label %LeafBlock11

LeafBlock11:                                      ; preds = %NodeBlock
  %SwitchLeaf12 = icmp eq i32 %m.0, 3
  br i1 %SwitchLeaf12, label %for.inc, label %sw.default

LeafBlock:                                        ; preds = %NodeBlock13
  %SwitchLeaf = icmp eq i32 %m.0, 1
  br i1 %SwitchLeaf, label %for.inc, label %sw.default

sw.default:                                       ; preds = %LeafBlock23, %LeafBlock21, %LeafBlock17, %LeafBlock15, %LeafBlock11, %LeafBlock
  br label %for.inc

for.inc:                                          ; preds = %NodeBlock, %LeafBlock23, %LeafBlock21, %LeafBlock17, %LeafBlock15, %LeafBlock11, %LeafBlock, %sw.default
  %.sink4 = phi i32 [ 30, %sw.default ], [ 31, %LeafBlock ], [ 31, %LeafBlock11 ], [ 31, %LeafBlock15 ], [ 31, %LeafBlock17 ], [ 31, %LeafBlock21 ], [ 31, %LeafBlock23 ], [ 29, %NodeBlock ]
  %add18 = add nsw i32 %x.1, %.sink4
...
for.cond30:                                       ; preds = %for.inc40, %if.else29
  ...
  br i1 %cmp31, label %NodeBlock53, label %for.end42

NodeBlock53:                                      ; preds = %for.cond30
  %Pivot54 = icmp slt i32 %m.1, 5
  br i1 %Pivot54, label %NodeBlock37, label %NodeBlock51

NodeBlock51:                                      ; preds = %NodeBlock53
  %Pivot52 = icmp slt i32 %m.1, 10
  br i1 %Pivot52, label %NodeBlock43, label %NodeBlock49

NodeBlock49:                                      ; preds = %NodeBlock51
  %Pivot50 = icmp slt i32 %m.1, 12
  br i1 %Pivot50, label %LeafBlock45, label %LeafBlock47

LeafBlock47:                                      ; preds = %NodeBlock49
  %SwitchLeaf48 = icmp eq i32 %m.1, 12
  br i1 %SwitchLeaf48, label %for.inc40, label %sw.default37

LeafBlock45:                                      ; preds = %NodeBlock49
  %SwitchLeaf46 = icmp eq i32 %m.1, 10
  br i1 %SwitchLeaf46, label %for.inc40, label %sw.default37

NodeBlock43:                                      ; preds = %NodeBlock51
  %Pivot44 = icmp slt i32 %m.1, 7
  br i1 %Pivot44, label %LeafBlock39, label %LeafBlock41

LeafBlock41:                                      ; preds = %NodeBlock43
  %SwitchLeaf42 = icmp sle i32 %m.1, 8
  br i1 %SwitchLeaf42, label %for.inc40, label %sw.default37

LeafBlock39:                                      ; preds = %NodeBlock43
  %SwitchLeaf40 = icmp eq i32 %m.1, 5
  br i1 %SwitchLeaf40, label %for.inc40, label %sw.default37

NodeBlock37:                                      ; preds = %NodeBlock53
  %Pivot38 = icmp slt i32 %m.1, 2
  br i1 %Pivot38, label %LeafBlock31, label %NodeBlock35

NodeBlock35:                                      ; preds = %NodeBlock37
  %Pivot36 = icmp slt i32 %m.1, 3
  br i1 %Pivot36, label %for.inc40, label %LeafBlock33

LeafBlock33:                                      ; preds = %NodeBlock35
  %SwitchLeaf34 = icmp eq i32 %m.1, 3
  br i1 %SwitchLeaf34, label %for.inc40, label %sw.default37

LeafBlock31:                                      ; preds = %NodeBlock37
  %SwitchLeaf32 = icmp eq i32 %m.1, 1
  br i1 %SwitchLeaf32, label %for.inc40, label %sw.default37

sw.default37:                                     ; preds = %LeafBlock47, %LeafBlock45, %LeafBlock41, %LeafBlock39, %LeafBlock33, %LeafBlock31
  br label %for.inc40

for.inc40:                                        ; preds = %NodeBlock35, %LeafBlock47, %LeafBlock45, %LeafBlock41, %LeafBlock39, %LeafBlock33, %LeafBlock31, %sw.default37
  %.sink = phi i32 [ 30, %sw.default37 ], [ 31, %LeafBlock31 ], [ 31, %LeafBlock33 ], [ 31, %LeafBlock39 ], [ 31, %LeafBlock41 ], [ 31, %LeafBlock45 ], [ 31, %LeafBlock47 ], [ 28, %NodeBlock35 ]
