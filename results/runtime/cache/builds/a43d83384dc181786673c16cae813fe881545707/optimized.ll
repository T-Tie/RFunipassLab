...
for.cond1:                                        ; preds = %for.inc, %for.body
  %a2.1 = phi i32 [ %a2.0, %for.body ], [ %a2.3, %for.inc ]
  %a1.1 = phi i32 [ %a1.0, %for.body ], [ %a1.3, %for.inc ]
...
for.inc:                                          ; preds = %land.lhs.true, %if.end, %for.body4
  %a2.3 = phi i32 [ %a2.1, %for.body4 ], [ %j.0, %if.end ], [ %a2.1, %land.lhs.true ]
  %a1.3 = phi i32 [ %a1.1, %for.body4 ], [ %i.0, %if.end ], [ %a1.1, %land.lhs.true ]
  %b1.2 = phi i32 [ %b1.1, %for.body4 ], [ %i.0, %if.end ], [ %i.0, %land.lhs.true ]
  %b2.2 = phi i32 [ %b2.1, %for.body4 ], [ %j.0, %if.end ], [ %j.0, %land.lhs.true ]
...
for.end13:                                        ; preds = %for.cond
  %a1.0.neg = sub i32 0, %a1.0
  %sub = add i32 %a1.0.neg, -1
  %sub14 = add i32 %sub, %b1.0
  %a2.0.neg = sub i32 0, %a2.0
  %sub15 = add i32 %a2.0.neg, -1
  %sub16 = add i32 %sub15, %b2.0
