...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %s) #8
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %rep) #8
  call void @llvm.lifetime.start.p0(i64 noundef 300, ptr noundef nonnull align 16 dereferenceable(300) %sub) #8
...
land.lhs.true.i15:                                ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i
  call fastcc void @outlined_ir_func_0(ptr %sub, ptr %add.ptr10.i)
...
land.lhs.true.i43:                                ; preds = %land.lhs.true.i15
  call fastcc void @outlined_ir_func_0(ptr %rep, ptr %add.ptr10.i)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
  ...
  call fastcc void @outlined_ir_func_1(ptr %s)
  call fastcc void @outlined_ir_func_1(ptr %rep)
...
if.end:                                           ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  %call.i.i78 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.sink99) #10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %sub) #10
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %rep) #10
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %s) #10
  ret i32 0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !32, !invariant.load !8
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !35, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !36, !invariant.load !8
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !37, !invariant.load !8
...
land.lhs.true.i15_to_outline:                     ; preds = %newFuncRoot
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(300) %0, i64 noundef 300)
  ...
  %3 = add i64 %2, -301
  %or.cond.i19 = icmp ult i64 %3, -300
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0) unnamed_addr #7 {
newFuncRoot:
