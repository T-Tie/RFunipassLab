...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %a) #10
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %b) #10
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull %c) #10
...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  br i1 %or.cond105, label %if.then19.i25, label %if.then6.i51
...
if.then6.i51:                                     ; preds = %if.then28.i36, %if.then19.i25, %if.then6.i10
  ...
  %call16.i61 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i60) #12
  %5 = add i64 %4, -257
  %or.cond.i65 = icmp ult i64 %5, -256
  %or.cond106 = select i1 %call16.i61, i1 %or.cond.i65, i1 false
  br i1 %or.cond106, label %if.then19.i66, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit82
...
if.then19.i66:                                    ; preds = %if.then6.i51
  ...
  %call24.i71 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i70) #12
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %10 = trunc nuw nsw i64 %indvars.iv111 to i32
  br label %for.end
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv128 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv131 = phi i64 [ %indvars.iv.next132, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv131, %13
