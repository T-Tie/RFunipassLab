...
for.body5:                                        ; preds = %for.cond3
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %r) #7
...
for.cond15:                                       ; preds = %for.body18, %if.then
...
for.body18:                                       ; preds = %for.cond15
  ...
  %10 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !12
  %idxprom21 = sext i32 %8 to i64
  %arrayidx22 = getelementptr inbounds i32, ptr %call1, i64 %idxprom21
  store i32 %10, ptr %arrayidx22, align 4, !tbaa !5
...
if.end:                                           ; preds = %for.end25, %for.body9
  call fastcc void @outlined_ir_func_0(ptr %r)
  br label %for.cond6
...
for.cond33:                                       ; preds = %if.end44, %for.end32
...
for.body35:                                       ; preds = %for.cond33
  ...
  br i1 %cmp36, label %if.end44, label %if.else

if.else:                                          ; preds = %for.body35
  br label %if.end44

if.end44:                                         ; preds = %for.body35, %if.else
  %.str.1.sink = phi ptr [ @.str.1, %if.else ], [ @.str, %for.body35 ]
  %idxprom41 = sext i32 %12 to i64
  %arrayidx42 = getelementptr inbounds i32, ptr %call1, i64 %idxprom41
  %14 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !12
  %call43 = call i32 (ptr, ...) @printf(ptr noundef %.str.1.sink, i32 noundef %14)
...
for.cond15.exitStub:
  ...
  store i32 %inc24, ptr %0, align 4, !tbaa !5
  ret void
}
