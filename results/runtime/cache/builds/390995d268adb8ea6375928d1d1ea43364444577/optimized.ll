...
do.end.i:                                         ; preds = %for.body
  ...
  %vbase.offset3.i = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !8
...
if.then6.i:                                       ; preds = %for.body
  ...
  %1 = load i64, ptr %gep6, align 8, !tbaa !9
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc16 ], [ 1, %for.end ]
  %exitcond11 = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond11, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv8
