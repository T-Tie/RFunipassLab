...
for.cond:                                         ; preds = %if.end20, %entry
  %sample.0 = phi double [ undef, %entry ], [ %sample.1, %if.end20 ]
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end20 ]
...
if.else9:                                         ; preds = %if.else
  %sub11 = fsub double %sample.0, %div
...
if.end20:                                         ; preds = %if.then6, %if.else16, %if.then13, %if.then
