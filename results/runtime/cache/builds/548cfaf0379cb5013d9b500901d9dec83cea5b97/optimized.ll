...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv15 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next16, %for.inc44 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond21.not = icmp eq i32 %j.0, %smax20
  br i1 %exitcond21.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax17 = call i32 @llvm.smax.i32(i32 %indvars.iv15, i32 noundef 0)
  %wide.trip.count18 = zext nneg i32 %smax17 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax26 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv12 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next13, %for.inc41 ]
  %exitcond19.not = icmp eq i64 %indvars.iv12, %wide.trip.count18
  br i1 %exitcond19.not, label %for.inc44, label %for.body23
...
for.body23:                                       ; preds = %for.cond19
  ...
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next13
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv22 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next23, %for.inc58 ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv22
  ...
  %cmp54.not = icmp eq i64 %indvars.iv22, %4
