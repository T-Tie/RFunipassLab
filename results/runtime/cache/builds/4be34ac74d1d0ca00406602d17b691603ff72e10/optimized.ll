...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 160, ptr %sum) #5
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %sum, ptr align 16 @__const.main.sum, i64 160, i1 false)
...
for.cond39:                                       ; preds = %for.inc45, %while.end
  %j.2 = phi i32 [ %i.2, %while.end ], [ %dec46, %for.inc45 ]
  %cmp40 = icmp sge i32 %j.2, 0
...
if.end:                                           ; preds = %for.end47, %for.end
  call void @llvm.lifetime.end.p0(i64 160, ptr %sum) #5
