...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre12, %for.inc ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre13 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre13, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub4 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub4, 1
