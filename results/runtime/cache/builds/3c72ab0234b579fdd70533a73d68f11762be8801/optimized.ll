...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %b) #9
...
for.end:                                          ; preds = %for.cond
  ...
  %call6.1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %arrayidx5.1)
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body21
  ...
  %indvars.iv20 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next21, %for.body21 ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv20, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv20
  %7 = load double, ptr %arrayidx23, align 8, !tbaa !9, !invariant.load !11
  ...
  %.str.1.sink = select i1 %cmp26, ptr @.str, ptr %.str.1..str.2
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.1.sink)
...
for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 1600, ptr noundef nonnull %a) #10
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !12, !invariant.load !11
  ret i64 %0
}
