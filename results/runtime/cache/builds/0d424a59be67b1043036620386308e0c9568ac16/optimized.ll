...
for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv14, i64 %indvars.iv11
...
for.end30:                                        ; preds = %for.cond12
  ...
  %10 = add i32 %smax, 1
  %smax24 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %smax30 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 0)
...
for.cond31:                                       ; preds = %for.inc60, %for.end30
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc60 ], [ 0, %for.end30 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.cond63, label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.inc57
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc57 ], [ 0, %for.cond31 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.inc60, label %for.cond39

for.cond39:                                       ; preds = %for.cond35, %for.inc50
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc50 ], [ 0, %for.cond35 ]
...
for.inc50:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv27, i64 %indvars.iv17
  %11 = load i32, ptr %arrayidx45, align 4, !tbaa !5
  %arrayidx49 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv17, i64 %indvars.iv21
...
for.inc57:                                        ; preds = %for.cond39
  %arrayidx56 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv27, i64 %indvars.iv21
...
for.cond63:                                       ; preds = %for.cond31, %for.inc86
  ...
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc86 ], [ 0, %for.cond31 ]
  %14 = sext i32 %13 to i64
  %cmp65.not.not = icmp slt i64 %indvars.iv36, %14
  br i1 %cmp65.not.not, label %for.cond67, label %for.end88

for.cond67:                                       ; preds = %for.cond63, %for.body70
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body70 ], [ 0, %for.cond63 ]
  %15 = load i32, ptr %y2, align 4, !tbaa !5
  %16 = sext i32 %15 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv33, %16
  br i1 %cmp69.not.not, label %for.body70, label %for.inc86

for.body70:                                       ; preds = %for.cond67
  %cmp71 = icmp eq i64 %indvars.iv33, 0
  %spec.select = select i1 %cmp71, ptr @.str.1, ptr @.str.2
  %arrayidx80 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv36, i64 %indvars.iv33
