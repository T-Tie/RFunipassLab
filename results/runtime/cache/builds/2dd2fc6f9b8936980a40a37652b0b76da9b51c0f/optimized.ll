...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc18
  %indvars.iv9 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next10, %for.inc18 ]
  %exitcond18.not = icmp eq i64 %indvars.iv9, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond21, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc15
  %indvars.iv11 = phi i64 [ %indvars.iv9, %for.cond5.preheader ], [ %indvars.iv.next12, %for.inc15 ]
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond.not, label %for.inc18, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next12
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv26 = phi i32 [ %indvars.iv.next27, %for.cond21 ], [ %2, %for.cond2 ]
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax28 = call i32 @llvm.smax.i32(i32 %indvars.iv26, i32 noundef 0)
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  ...
  br i1 %exitcond30.not, label %for.end41, label %for.body30
...
for.end41:                                        ; preds = %for.cond28
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5) #6
