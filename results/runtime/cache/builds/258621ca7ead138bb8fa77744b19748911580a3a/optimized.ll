...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax99 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax104 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax105 = call i32 @llvm.smax.i32(i32 %smax104, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax111 = call i32 @llvm.smax.i32(i32 %9, i32 0)
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax146 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax152 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
