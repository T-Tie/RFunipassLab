...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.end ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv7, i64 %indvars.iv
