...
if.end113:                                        ; preds = %if.then111, %if.then107
  %8 = load double, ptr %a, align 8, !tbaa !13
  %cmp114 = fcmp ole double %div, %8
