...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv4
...
for.cond19.preheader:                             ; preds = %for.end15
  ...
  %smax16 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv11 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next12, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond17.not = icmp eq i32 %i.2, %smax16
  br i1 %exitcond17.not, label %for.end49, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond19
  %smax13 = call i32 @llvm.smax.i32(i32 %indvars.iv11, i32 0)
  %wide.trip.count14 = zext nneg i32 %smax13 to i64
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv8 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next9, %for.inc44 ]
  %exitcond15.not = icmp eq i64 %indvars.iv8, %wide.trip.count14
  br i1 %exitcond15.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv8
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next9
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %len.0, i32 1)
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc59 ], [ 1, %for.end49 ]
  %exitcond24.not = icmp eq i64 %indvars.iv18, %wide.trip.count23
  br i1 %exitcond24.not, label %cleanup, label %for.inc59
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv18
