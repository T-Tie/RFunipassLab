...
for.end:                                          ; preds = %for.cond1
  %s.0.lcssa = phi i32 [ %s.0, %for.cond1 ]
  br label %for.cond11
...
for.end47:                                        ; preds = %for.cond31
  %s.2.lcssa = phi i32 [ %s.2, %for.cond31 ]
  br label %for.cond48
...
for.inc32:                                        ; preds = %for.cond12
  %.lcssa = phi i32 [ %1, %for.cond12 ]
  %call29 = call noundef i32 @_Z3cuti(i32 noundef %.lcssa) #8
