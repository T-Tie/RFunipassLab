...
while.cond:                                       ; preds = %while.body, %for.end
  %i.0 = phi i32 [ 0, %for.end ], [ %inc4, %while.body ]
...
while.cond11:                                     ; preds = %if.end, %for.body10
  %.sink = phi i32 [ %1, %for.body10 ], [ %add, %if.end ]
  %n.0 = phi i32 [ 0, %for.body10 ], [ %n.1, %if.end ]
  %add = add nsw i32 %.sink, 1
  %cmp12 = icmp slt i32 %add, %i.0
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %while.body13
  %n.1 = phi i32 [ %5, %if.then ], [ %n.0, %land.lhs.true ], [ %n.0, %while.body13 ]
...
for.cond31:                                       ; preds = %for.inc41, %for.end30
  %j.0 = phi i32 [ 0, %for.end30 ], [ %inc42, %for.inc41 ]
...
for.inc41:                                        ; preds = %for.body33, %if.then37
  %n.3 = phi i32 [ %6, %if.then37 ], [ %n.2, %for.body33 ]
  %inc42 = add nsw i32 %j.0, 1
  br label %for.cond31, !llvm.loop !18

for.end43:                                        ; preds = %for.cond31
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %n.2) #5
  ret i32 0
}
