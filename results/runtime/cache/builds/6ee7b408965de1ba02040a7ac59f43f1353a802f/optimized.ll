...
while.cond.preheader:                             ; preds = %for.cond1
  %smax75 = call i32 @llvm.smax.i32(i32 %1, i32 0)
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond.preheader, %for.end176
  %indvars.iv12 = phi i32 [ %1, %while.cond.preheader ], [ %indvars.iv.next13, %for.end176 ]
  %sum.0 = phi i32 [ 0, %while.cond.preheader ], [ %add, %for.end176 ]
  %p.0 = phi i32 [ 0, %while.cond.preheader ], [ %inc177, %for.end176 ]
  %exitcond76.not = icmp eq i32 %p.0, %smax75
  br i1 %exitcond76.not, label %for.inc179, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %while.cond
  %smax71 = call i32 @llvm.smax.i32(i32 %indvars.iv12, i32 0)
  %wide.trip.count17 = zext nneg i32 %smax71 to i64
  %wide.trip.count = zext i32 %indvars.iv12 to i64
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  %indvars.iv14 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next15, %for.inc42 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond45.preheader, label %for.body16

for.cond45.preheader:                             ; preds = %for.cond14
  %wide.trip.count22 = zext i32 %indvars.iv12 to i64
  br label %for.cond45
...
for.body16:                                       ; preds = %for.cond14
  ...
  %arrayidx21 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv14
...
for.cond22:                                       ; preds = %for.body25, %for.body16
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body25 ], [ 0, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond22
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv8
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc67
  %indvars.iv24 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next25, %for.inc67 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count17
  br i1 %exitcond29.not, label %for.cond70.preheader, label %for.cond49.preheader

for.cond70.preheader:                             ; preds = %for.cond45
  %wide.trip.count33 = zext i32 %indvars.iv12 to i64
  br label %for.cond70

for.cond49.preheader:                             ; preds = %for.cond45
  %arrayidx58 = getelementptr inbounds nuw [100 x i32], ptr %min1, i64 0, i64 %indvars.iv24
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  %indvars.iv19 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next20, %for.inc64 ]
...
for.inc64:                                        ; preds = %for.cond49
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv19
...
for.cond70:                                       ; preds = %for.cond70.preheader, %for.inc101
  %indvars.iv35 = phi i64 [ 0, %for.cond70.preheader ], [ %indvars.iv.next36, %for.inc101 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count17
  br i1 %exitcond40.not, label %for.cond104.preheader, label %for.body73

for.cond104.preheader:                            ; preds = %for.cond70
  %wide.trip.count44 = zext i32 %indvars.iv12 to i64
  br label %for.cond104

for.body73:                                       ; preds = %for.cond70
  %arrayidx76 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv35
  %10 = load i32, ptr %arrayidx76, align 4, !tbaa !5
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv35
  store i32 %10, ptr %arrayidx78, align 4, !tbaa !5
  br label %for.cond79

for.cond79:                                       ; preds = %for.body82, %for.body73
  %11 = phi i32 [ %spec.store.select3, %for.body82 ], [ %10, %for.body73 ]
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body82 ], [ 0, %for.body73 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count33
  br i1 %exitcond34.not, label %for.inc101, label %for.body82

for.body82:                                       ; preds = %for.cond79
  %arrayidx88 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv35
  %12 = load i32, ptr %arrayidx88, align 4, !tbaa !5
  %spec.store.select3 = call i32 @llvm.smin.i32(i32 %11, i32 %12)
  store i32 %spec.store.select3, ptr %arrayidx78, align 4
...
for.cond104:                                      ; preds = %for.cond104.preheader, %for.inc126
  %indvars.iv46 = phi i64 [ 0, %for.cond104.preheader ], [ %indvars.iv.next47, %for.inc126 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count17
  br i1 %exitcond51.not, label %for.end128, label %for.cond108

for.cond108:                                      ; preds = %for.cond104, %for.inc123
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc123 ], [ 0, %for.cond104 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count44
  br i1 %exitcond45.not, label %for.inc126, label %for.inc123

for.inc123:                                       ; preds = %for.cond108
  %arrayidx115 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv41
  %13 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx117 = getelementptr inbounds nuw [100 x i32], ptr %min2, i64 0, i64 %indvars.iv41
...
for.end128:                                       ; preds = %for.cond104
  ...
  %wide.trip.count55 = zext i32 %indvars.iv12 to i64
  br label %for.cond131

for.cond131:                                      ; preds = %for.inc151, %for.end128
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc151 ], [ 0, %for.end128 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count17
  br i1 %exitcond62.not, label %for.cond154.preheader, label %for.cond135

for.cond154.preheader:                            ; preds = %for.cond131
  %wide.trip.count66 = zext i32 %indvars.iv12 to i64
  br label %for.cond154

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count55
  br i1 %exitcond56.not, label %for.inc151, label %for.inc148

for.inc148:                                       ; preds = %for.cond135
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %arrayidx143 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv.next53
  %16 = load i32, ptr %arrayidx143, align 4, !tbaa !5
  %arrayidx147 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv52
...
for.cond154:                                      ; preds = %for.cond154.preheader, %for.inc174
  %indvars.iv68 = phi i64 [ 0, %for.cond154.preheader ], [ %indvars.iv.next69, %for.inc174 ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %wide.trip.count17
  br i1 %exitcond73.not, label %for.end176, label %for.cond158

for.cond158:                                      ; preds = %for.cond154, %for.inc171
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc171 ], [ 1, %for.cond154 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count66
  br i1 %exitcond67.not, label %for.inc174, label %for.inc171

for.inc171:                                       ; preds = %for.cond158
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %arrayidx166 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next64, i64 %indvars.iv68
  %17 = load i32, ptr %arrayidx166, align 4, !tbaa !5
  %arrayidx170 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv68
