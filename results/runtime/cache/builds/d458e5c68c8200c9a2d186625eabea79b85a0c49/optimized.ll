...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv152 = phi i64 [ %indvars.iv.next153, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv152, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv152, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv158 = phi i64 [ %indvars.iv.next159, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv158, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv155 = phi i64 [ %indvars.iv.next156, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv155, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv158, i64 %indvars.iv155
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax164 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax169 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax170 = call i32 @llvm.smax.i32(i32 %smax169, i32 noundef 0)
  %wide.trip.count171 = zext nneg i32 %smax170 to i64
  %wide.trip.count = zext nneg i32 %smax164 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv165 = phi i64 [ %indvars.iv.next166, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond172.not = icmp eq i64 %indvars.iv165, %wide.trip.count171
  br i1 %exitcond172.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax176 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count184 = zext nneg i32 %smax164 to i64
  %wide.trip.count177 = zext nneg i32 %smax176 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv161 = phi i64 [ %indvars.iv.next162, %for.inc46 ], [ 0, %for.cond36 ]
  %exitcond.not = icmp eq i64 %indvars.iv161, %wide.trip.count
  br i1 %exitcond.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv165, i64 %indvars.iv161
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv186 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next187, %for.inc83 ]
  %exitcond190.not = icmp eq i64 %indvars.iv186, %wide.trip.count171
  br i1 %exitcond190.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv179 = phi i64 [ %indvars.iv.next180, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond185.not = icmp eq i64 %indvars.iv179, %wide.trip.count184
  br i1 %exitcond185.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv186, i64 %indvars.iv179
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv173 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next174, %for.inc77 ]
  %exitcond178.not = icmp eq i64 %indvars.iv173, %wide.trip.count177
  br i1 %exitcond178.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv186, i64 %indvars.iv173
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv173, i64 %indvars.iv179
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv191 = phi i64 [ %indvars.iv.next192, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond195.not = icmp eq i64 %indvars.iv191, %wide.trip.count171
  br i1 %exitcond195.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv191
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next192 = add nuw nsw i64 %indvars.iv191, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax169 to i64
  %arrayidx95 = getelementptr inbounds [100 x i32], ptr %d, i64 0, i64 %idxprom94
  store i32 %smax, ptr %arrayidx95, align 4, !tbaa !5
  %wide.trip.count201 = zext nneg i32 %smax164 to i64
  br label %for.cond96

for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv203 = phi i64 [ %indvars.iv.next204, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond207.not = icmp eq i64 %indvars.iv203, %wide.trip.count171
  br i1 %exitcond207.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv203
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax169, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax169, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv196 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next197, %for.inc112 ]
  %exitcond202.not = icmp eq i64 %indvars.iv196, %wide.trip.count201
  br i1 %exitcond202.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv203, i64 %indvars.iv196
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv220 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond227.not = icmp eq i64 %indvars.iv220, %wide.trip.count171
  br i1 %exitcond227.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv220
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv220, 0
  %or.cond147 = and i1 %or.cond, %cmp128
  br i1 %or.cond147, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv220
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax211 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count212 = zext nneg i32 %smax211 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv208 = phi i64 [ %indvars.iv.next209, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond213.not = icmp eq i64 %indvars.iv208, %wide.trip.count212
  br i1 %exitcond213.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv220, i64 %indvars.iv208
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv220, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax217 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count218 = zext nneg i32 %smax217 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv214 = phi i64 [ %indvars.iv.next215, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond219.not = icmp eq i64 %indvars.iv214, %wide.trip.count218
  br i1 %exitcond219.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv220, i64 %indvars.iv214
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv220, %14
  %.pre = add nuw nsw i64 %indvars.iv220, 1
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv220, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar148 = call i32 @putchar(i32 noundef 10) #7
  br label %for.inc198
