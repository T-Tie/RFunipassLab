...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax50 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax39 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  ...
  br i1 %exitcond14, label %for.cond26, label %for.cond2
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc20 ], [ 1, %for.cond13.preheader ]
...
for.cond26:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc57 ], [ 1, %for.cond ]
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc54 ], [ 1, %for.cond46.preheader ]
