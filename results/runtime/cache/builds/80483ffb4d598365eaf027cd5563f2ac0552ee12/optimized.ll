...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax37 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
  %wide.trip.count38 = zext nneg i32 %smax37 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv28
...
if.then9:                                         ; preds = %if.end
  ...
  %invariant.op45 = add i32 %add, %5
  %add24.reass.reass = sub i32 %invariant.op45, %conv
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv25, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next26 = add nsw i64 %indvars.iv25, 1
  %7 = trunc nsw i64 %indvars.iv25 to i32
  %sub25 = add i32 %add24.reass.reass, %7
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv25
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv32 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next33, %for.inc44 ]
  %exitcond39.not = icmp eq i64 %indvars.iv32, %wide.trip.count38
  br i1 %exitcond39.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv32, %2
  ...
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv32
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond44.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv40
