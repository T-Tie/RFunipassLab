...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 16000, ptr nonnull %sv) #4
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [2 x double]], ptr %sv, i64 0, i64 %indvars.iv21, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.inc59, %for.end9
  ...
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc59 ], [ 1, %for.end9 ]
  %5 = sext i32 %4 to i64
  %cmp15 = icmp slt i64 %indvars.iv24, %5
  br i1 %cmp15, label %for.body16, label %for.end61

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [1000 x [2 x double]], ptr %sv, i64 0, i64 %indvars.iv24
...
if.else:                                          ; preds = %for.body16
  ...
  %or.cond17 = and i1 %cmp43, %cmp53
  %str.1.str = select i1 %or.cond17, ptr @str.1, ptr @str
  br label %for.inc59

for.inc59:                                        ; preds = %if.else, %for.body16
  %str.2.sink = phi ptr [ @str.2, %for.body16 ], [ %str.1.str, %if.else ]
  %puts19 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond14, !llvm.loop !15

for.end61:                                        ; preds = %for.cond14
  call void @llvm.lifetime.end.p0(i64 16000, ptr nonnull %sv) #4
