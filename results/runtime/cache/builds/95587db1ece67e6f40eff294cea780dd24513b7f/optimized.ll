...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax53 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count24 = zext nneg i32 %smax53 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond28.preheader, label %for.cond1

for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count29 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv16 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next17, %for.inc22 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv16
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv36 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next37, %for.inc63 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count24
  br i1 %exitcond41.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select14, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv36
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select14 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv31 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next32, %for.inc60 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count29
  br i1 %exitcond35.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv31, i64 %indvars.iv36
...
for.cond69.preheader:                             ; preds = %for.end65
  %wide.trip.count47 = zext i32 %t.tr to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv49 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next50, %for.inc125 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count24
  br i1 %exitcond55.not, label %for.end127, label %for.cond72.preheader
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv42 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next43, %for.inc122 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv42, 2
  br i1 %switch, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %for.body75
  %cmp8111 = icmp eq i64 %indvars.iv42, 1
  br i1 %cmp8111, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv49, i64 %indvars.iv42
  %7 = load i32, ptr %arrayidx89, align 4, !tbaa !5
  %8 = add nsw i64 %indvars.iv42, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv49, i64 %8
  store i32 %7, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.else95:                                        ; preds = %lor.lhs.false.thread
  %cmp96 = icmp eq i64 %indvars.iv42, 0
  %9 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv49, i64 %indvars.iv42
