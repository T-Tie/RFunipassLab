...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv48 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next49, %for.inc13 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv48
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv55 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next56, %for.inc44 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond61.not = icmp eq i32 %j.0, %smax60
  br i1 %exitcond61.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax57 = call i32 @llvm.smax.i32(i32 %indvars.iv55, i32 noundef 0)
  %wide.trip.count58 = zext nneg i32 %smax57 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax66 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
  %wide.trip.count67 = zext nneg i32 %smax66 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv52 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next53, %for.inc41 ]
  %exitcond59.not = icmp eq i64 %indvars.iv52, %wide.trip.count58
  br i1 %exitcond59.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv52
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next53
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv62 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next63, %for.inc58 ]
  %exitcond68.not = icmp eq i64 %indvars.iv62, %wide.trip.count67
  br i1 %exitcond68.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv62
  ...
  %cmp54.not = icmp eq i64 %indvars.iv62, %4
