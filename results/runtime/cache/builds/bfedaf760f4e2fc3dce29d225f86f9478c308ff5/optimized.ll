...
for.body51:                                       ; preds = %for.cond49
  ...
  %10 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv6
...
if.else72:                                        ; preds = %if.else63
  ...
  %.sink2 = select i1 %cmp76, double %fneg81, double %11
  %arrayidx99 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv6
  %13 = load double, ptr %arrayidx99, align 8, !tbaa !9
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %.sink2, double noundef %13, double noundef %.sink2, double noundef %13)
  br label %for.inc110

for.inc110:                                       ; preds = %if.then55, %if.else72, %if.then67
