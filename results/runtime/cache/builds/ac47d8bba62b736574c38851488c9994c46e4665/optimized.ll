...
for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond13.not = icmp eq i64 %indvars.iv6, %5
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc50 ], [ %9, %for.end41 ]
  %sub44 = add nsw i32 %10, -1
  %11 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv14, %11
