...
if.then8:                                         ; preds = %if.end
  ...
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %7) #9
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %8) #9
...
if.then39:                                        ; preds = %if.end37
  ...
  %call50 = call double @sqrt(double noundef %14) #8, !tbaa !5
  ...
  %mul61 = fmul double %15, 4.000000e+00
  ...
  %call65 = call double @sqrt(double noundef %18) #8, !tbaa !5
  %fneg66 = fneg double %call65
  %mul67 = fmul double %15, 2.000000e+00
...
if.then30_after_outline.exitStub:
  ...
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div34) #10
  ret void
}
