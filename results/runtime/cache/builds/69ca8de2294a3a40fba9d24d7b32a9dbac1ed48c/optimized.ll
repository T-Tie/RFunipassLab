...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv7, %9
...
for.body51:                                       ; preds = %for.cond49
  ...
  %11 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv7
  %12 = load double, ptr %11, align 8, !tbaa !9, !invariant.load !14
  br i1 %cmp54, label %if.then55, label %if.else63

if.then55:                                        ; preds = %for.body51
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv7
  %13 = load double, ptr %arrayidx61, align 8, !tbaa !9, !invariant.load !14
  %call62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %12, double noundef %13)
  br label %for.inc110
...
if.else72:                                        ; preds = %if.else63
  ...
  %14 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv7
  %15 = load double, ptr %14, align 8, !tbaa !9, !invariant.load !14
  br i1 %cmp76, label %if.then77, label %if.else93

if.then77:                                        ; preds = %if.else72
  %fneg81 = fneg double %12
  %call92 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %fneg81, double noundef %15, double noundef %fneg81, double noundef %15)
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %12, double noundef %15, double noundef %12, double noundef %15)
  br label %for.inc110
