...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv8
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv15 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next16, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond21.not = icmp eq i32 %i.2, %smax20
  br i1 %exitcond21.not, label %for.end49, label %for.cond22.preheader
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv12 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next13, %for.inc44 ]
  %exitcond19.not = icmp eq i64 %indvars.iv12, %wide.trip.count18
  br i1 %exitcond19.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv12
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next13
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 1)
  %wide.trip.count27 = zext nneg i32 %smax26 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc59 ], [ 1, %for.end49 ]
  %exitcond28.not = icmp eq i64 %indvars.iv22, %wide.trip.count27
  br i1 %exitcond28.not, label %cleanup, label %for.inc59
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv22
