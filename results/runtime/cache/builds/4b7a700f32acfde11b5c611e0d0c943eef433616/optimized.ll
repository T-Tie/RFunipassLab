...
for.cond:                                         ; preds = %if.end27, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %if.end27 ]
...
if.then:                                          ; preds = %for.body
  ...
  %.pre6 = load float, ptr %x, align 4, !tbaa !9
  %.pre7 = load float, ptr %y1, align 4, !tbaa !9
  %.pre8 = load float, ptr %x1, align 4, !tbaa !9
  %.pre13 = fdiv float %.pre, %.pre6
  %.pre14 = fdiv float %.pre7, %.pre8
  %.pre15 = fsub float %.pre13, %.pre14
  %.pre16 = fpext float %.pre15 to double
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %conv10.pre-phi = phi double [ %.pre16, %if.then ], [ %conv, %for.body ]
  %sub9.pre-phi = phi float [ %.pre15, %if.then ], [ %sub4, %for.body ]
  %cmp11 = fcmp olt double %conv10.pre-phi, -5.000000e-02
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end
  %puts4 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #6
  %.pre9 = load float, ptr %y, align 4, !tbaa !9
  %.pre10 = load float, ptr %x, align 4, !tbaa !9
  %.pre11 = load float, ptr %y1, align 4, !tbaa !9
  %.pre12 = load float, ptr %x1, align 4, !tbaa !9
  %.pre17 = fdiv float %.pre9, %.pre10
  %.pre18 = fdiv float %.pre11, %.pre12
  %.pre19 = fsub float %.pre17, %.pre18
  br label %if.end14

if.end14:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi float [ %.pre19, %if.then12 ], [ %sub9.pre-phi, %if.end ]
...
if.then25:                                        ; preds = %if.end14
  %puts5 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #6
  br label %if.end27
