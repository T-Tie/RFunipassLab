...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc8 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv17, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc27
  %indvars.iv24 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next25, %for.inc27 ]
  ...
  br i1 %exitcond29.not, label %for.end30, label %for.cond15.preheader
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc24
  %indvars.iv20 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next21, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body18

for.body18:                                       ; preds = %for.cond15
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv24, i64 %indvars.iv20
...
for.inc27.split.loop.exit:                        ; preds = %for.body18
  %6 = trunc nuw nsw i64 %indvars.iv20 to i32
  br label %for.inc27
...
for.inc50:                                        ; preds = %for.body39, %for.cond36
  %p.1 = phi i32 [ %p.0, %for.cond36 ], [ %7, %for.body39 ]
  %q.1 = phi i32 [ %q.0, %for.cond36 ], [ %8, %for.body39 ]
