...
for.cond4:                                        ; preds = %for.inc31, %for.end
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc31 ], [ 1, %for.end ]
  %exitcond = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond, label %for.cond34, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv6
  store i32 1, ptr %arrayidx8, align 4, !tbaa !5
  %arrayidx15 = getelementptr inbounds nuw [30 x i32], ptr %w, i64 0, i64 %indvars.iv6
  %3 = load i32, ptr %arrayidx15, align 4, !tbaa !5
  br label %for.cond9

for.cond9:                                        ; preds = %for.inc29, %for.body6
  %4 = phi i32 [ %7, %for.inc29 ], [ 1, %for.body6 ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc29 ], [ %indvars.iv6, %for.body6 ]
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, -1
  %cmp10 = icmp sgt i64 %indvars.iv8, 0
  br i1 %cmp10, label %for.body11, label %for.inc31

for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds nuw [30 x i32], ptr %w, i64 0, i64 %indvars.iv.next9
  %5 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %cmp16.not = icmp slt i32 %5, %3
  br i1 %cmp16.not, label %for.inc29, label %if.then

if.then:                                          ; preds = %for.body11
  %arrayidx18 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv.next9
...
for.cond34:                                       ; preds = %for.cond4, %for.body36
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body36 ], [ 1, %for.cond4 ]
  %m.0 = phi i32 [ %spec.select, %for.body36 ], [ 0, %for.cond4 ]
  %exitcond17 = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond17, label %for.end46, label %for.body36

for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [30 x i32], ptr %f, i64 0, i64 %indvars.iv13
