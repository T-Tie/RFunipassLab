...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  ...
  br i1 %exitcond59.not, label %for.end27.loopexit90, label %for.cond11.preheader

for.cond11.preheader:                             ; preds = %for.cond8
  br label %for.cond11

for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc19 ], [ 0, %for.cond11.preheader ]
...
for.end27.loopexit90:                             ; preds = %for.cond8
  br label %for.end27

for.end27:                                        ; preds = %for.end27.loopexit90, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre74, %for.end27.loopexit ], [ %2, %for.end27.loopexit90 ]
  %i.145 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.end27.loopexit90 ]
  %y1.1 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.end27.loopexit90 ]
...
for.cond28:                                       ; preds = %for.body30, %for.end27
  ...
  br i1 %exitcond66.not, label %for.end42.loopexit, label %for.body30
...
for.end42.loopexit:                               ; preds = %for.cond28
  br label %for.end42

for.end42:                                        ; preds = %for.end42.loopexit, %for.end42.split.loop.exit
  %i.2.lcssa = phi i32 [ %10, %for.end42.split.loop.exit ], [ %smax63, %for.end42.loopexit ]
...
for.cond43:                                       ; preds = %for.body45, %for.end42
  ...
  br i1 %exitcond73.not, label %for.end59.loopexit, label %for.body45
...
for.end59.loopexit:                               ; preds = %for.cond43
  br label %for.end59

for.end59:                                        ; preds = %for.end59.loopexit, %for.end59.split.loop.exit
  %i.3.lcssa = phi i32 [ %13, %for.end59.split.loop.exit ], [ %smax70, %for.end59.loopexit ]
