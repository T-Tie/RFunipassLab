...
land.lhs.true.i14:                                ; preds = %if.then6.i8
  ...
  %3 = add i64 %2, -301
  %or.cond.i18 = icmp ult i64 %3, -300
...
land.lhs.true.i41:                                ; preds = %if.then6.i35
  ...
  %5 = add i64 %4, -301
  %or.cond.i45 = icmp ult i64 %5, -300
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54: ; preds = %if.then6.i35, %land.lhs.true.i41, %if.then19.i46, %if.then28.i53
  %call7 = call noundef ptr @strstr(ptr noundef nonnull dereferenceable(1) %s, ptr noundef nonnull dereferenceable(1) %sub) #13
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54
  ...
  %call16 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %sub) #13
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %sub) #12
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %rep) #12
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull %s) #12
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !23, !invariant.load !8
...
!22 = !{!12, !12, i64 0}
!23 = !{!24, !12, i64 56}
!24 = !{!"_ZTSSt5ctypeIcE", !25, i64 0, !26, i64 16, !27, i64 24, !28, i64 32, !28, i64 40, !29, i64 48, !12, i64 56, !12, i64 57, !12, i64 313, !12, i64 569}
!25 = !{!"_ZTSNSt6locale5facetE", !18, i64 8}
!26 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!27 = !{!"bool", !12, i64 0}
!28 = !{!"p1 int", !16, i64 0}
!29 = !{!"p1 short", !16, i64 0}
