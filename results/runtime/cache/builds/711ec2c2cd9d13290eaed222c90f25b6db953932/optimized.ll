...
entry:
  %invariant.gep = getelementptr i8, ptr %a, i64 -1
  %invariant.gep10 = getelementptr i8, ptr %a, i64 -2
  %0 = sext i32 %t to i64
  %1 = sext i32 %l to i64
  br label %for.cond
...
for.inc:                                          ; preds = %for.cond
  %gep = getelementptr i8, ptr %invariant.gep, i64 %indvars.iv
  %2 = load i8, ptr %gep, align 1, !tbaa !5, !invariant.load !8
  %gep11 = getelementptr i8, ptr %invariant.gep10, i64 %indvars.iv
  store i8 %2, ptr %gep11, align 1, !tbaa !5
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
...
entry:
  ...
  %smax55 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %1 = add nuw i32 %smax55, 1
  %wide.trip.count56 = zext i32 %1 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc73 ], [ 1, %entry ]
  %exitcond57 = icmp eq i64 %indvars.iv50, %wide.trip.count56
  br i1 %exitcond57, label %for.end75, label %for.body
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select40, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext70 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext70, 32
  ...
  %spec.select40 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  %invariant.gep = getelementptr i8, ptr %a, i64 -1
  %invariant.gep44 = getelementptr inbounds nuw i8, ptr %a, i64 1
  %add49 = add i64 %indvars.iv50, %call8
  %invariant.gep10.i = getelementptr i8, ptr %a, i64 -2
  %sext68 = shl i64 %add49, 32
  %7 = ashr exact i64 %sext68, 32
  %sext = shl i64 %call6, 32
  %8 = ashr exact i64 %sext, 32
  %gep = getelementptr i8, ptr %invariant.gep, i64 %8
  %cmp51 = icmp slt i32 %conv9, %conv12
  %9 = and i64 %indvars.iv50, 4294967295
  %gep45 = getelementptr i8, ptr %invariant.gep44, i64 %8
  %10 = sub i32 %conv12, %conv9
  %smax58 = call i32 @llvm.abs.i32(i32 %10, i1 noundef false)
  %11 = add nuw i32 %smax58, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond59 = icmp eq i32 %j.1, %11
  br i1 %exitcond59, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv50, 4294967294
  %smax65 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
  %12 = add nuw i32 %smax65, 1
  %wide.trip.count66 = zext i32 %12 to i64
  br label %for.cond58
...
for.inc.i:                                        ; preds = %for.cond.i
  ...
  %gep11.i = getelementptr i8, ptr %invariant.gep10.i, i64 %indvars.iv.i
  store i8 %13, ptr %gep11.i, align 1, !tbaa !5
...
if.end50:                                         ; preds = %_Z4leftPcii.exit, %for.body45
  br i1 %cmp51, label %for.cond.i5, label %for.inc55

for.cond.i5:                                      ; preds = %if.end50, %for.inc.i8
  %indvars.iv.i6 = phi i64 [ %indvars.iv.next.i10, %for.inc.i8 ], [ %8, %if.end50 ]
  %cmp.not.i7 = icmp slt i64 %indvars.iv.i6, %9
  br i1 %cmp.not.i7, label %_Z5rightPcii.exit, label %for.inc.i8

for.inc.i8:                                       ; preds = %for.cond.i5
  %gep.i9 = getelementptr i8, ptr %invariant.gep, i64 %indvars.iv.i6
  %14 = load i8, ptr %gep.i9, align 1, !tbaa !5, !invariant.load !8
  %arrayidx2.i = getelementptr inbounds i8, ptr %a, i64 %indvars.iv.i6
  store i8 %14, ptr %arrayidx2.i, align 1, !tbaa !5
  %indvars.iv.next.i10 = add nsw i64 %indvars.iv.i6, -1
  br label %for.cond.i5, !llvm.loop !9

_Z5rightPcii.exit:                                ; preds = %for.cond.i5
  store i8 0, ptr %gep45, align 1, !tbaa !5
  br label %for.inc55
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv60 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next61, %for.inc68 ]
  %exitcond67 = icmp eq i64 %indvars.iv60, %wide.trip.count66
  br i1 %exitcond67, label %for.end75, label %for.inc68

for.inc68:                                        ; preds = %for.cond58
  %15 = add nsw i64 %indvars.iv60, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx63, align 1, !tbaa !5, !invariant.load !8
  %17 = add i64 %add64, %indvars.iv60
  %sext69 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext69, 32
