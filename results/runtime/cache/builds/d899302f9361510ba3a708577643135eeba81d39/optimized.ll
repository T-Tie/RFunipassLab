...
for.cond:
  ...
  br i1 %cmp, label %for.body4, label %for.end24
...
for.end24:                                        ; preds = %for.cond
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 undef)
