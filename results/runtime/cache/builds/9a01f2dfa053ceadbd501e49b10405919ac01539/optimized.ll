...
for.cond14:                                       ; preds = %for.inc63, %for.end12
  ...
  %3 = phi i32 [ %dec, %for.inc63 ], [ %1, %for.end12 ]
  %cmp15 = icmp sgt i32 %3, 1
  br i1 %cmp15, label %for.body16, label %for.inc66

for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %3, i32 noundef %3) #7
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %3, i32 noundef %3) #7
...
for.inc34:                                        ; preds = %for.cond22
  ...
  %5 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !9
...
for.inc57:                                        ; preds = %for.cond44
  ...
  %6 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !9
