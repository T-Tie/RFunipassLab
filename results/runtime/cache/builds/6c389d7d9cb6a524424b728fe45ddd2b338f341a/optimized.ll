...
for.end:                                          ; preds = %for.cond
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %wide.trip.count29 = zext nneg i32 %smax28 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond30.not = icmp eq i64 %indvars.iv24, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond29.preheader, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv21 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next22, %for.body9 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv21
...
for.cond29:                                       ; preds = %for.cond29.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv31 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next32, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv31
  ...
  %vtable.i = load ptr, ptr %call34, align 8, !tbaa !15
  ...
  %7 = load i64, ptr %_M_width.i.i, align 8, !tbaa !18
  %cmp.not.i = icmp eq i64 %7, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %for.inc36
...
for.end38:                                        ; preds = %for.cond29
  ...
  %vtable.i11 = load ptr, ptr %call42, align 8, !tbaa !15
  %vbase.offset.ptr.i12 = getelementptr i8, ptr %vtable.i11, i64 -24
  %vbase.offset.i13 = load i64, ptr %vbase.offset.ptr.i12, align 8, !invariant.load !17
  %add.ptr.i14 = getelementptr inbounds i8, ptr %call42, i64 %vbase.offset.i13
  %call.i15 = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i14, i8 noundef signext 10)
  %call1.i16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call42, i8 noundef signext %call.i15)
...
!30 = !{!31, !35, i64 240}
!31 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !19, i64 0, !32, i64 216, !7, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
!32 = !{!"p1 _ZTSSo", !24, i64 0}
!33 = !{!"bool", !7, i64 0}
!34 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !24, i64 0}
!35 = !{!"p1 _ZTSSt5ctypeIcE", !24, i64 0}
!36 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !24, i64 0}
!37 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !24, i64 0}
!38 = !{!39, !7, i64 56}
...
!41 = !{!"p1 _ZTS15__locale_struct", !24, i64 0}
!42 = !{!"p1 int", !24, i64 0}
!43 = !{!"p1 short", !24, i64 0}
