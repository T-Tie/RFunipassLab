...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 %sentence) #5
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.body ], [ 0, %entry ]
  %call = tail call i32 @getchar() #5
...
while.end16:                                      ; preds = %while.cond2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull %sentence) #6
  ret i32 0
}
