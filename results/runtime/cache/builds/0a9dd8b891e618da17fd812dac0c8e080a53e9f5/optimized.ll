...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count32
  br i1 %exitcond33.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv28
  br label %for.cond5

for.cond5:                                        ; preds = %if.end, %for.body4
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end ], [ %indvars.iv22, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv24
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv.next36 = add nsw i64 %indvars.iv35, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next36
  %4 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !13
...
for.cond28.preheader:                             ; preds = %for.cond21
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %indvars, i32 noundef 0)
  %wide.trip.count45 = zext nneg i32 %smax44 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %if.end38
  %indvars.iv38 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next39, %if.end38 ]
  %exitcond46.not = icmp eq i64 %indvars.iv38, %wide.trip.count45
  br i1 %exitcond46.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv38
  %5 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !13
...
if.end38:                                         ; preds = %if.then34, %for.body30
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond28, !llvm.loop !16

for.end41:                                        ; preds = %for.cond28
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4) #6
