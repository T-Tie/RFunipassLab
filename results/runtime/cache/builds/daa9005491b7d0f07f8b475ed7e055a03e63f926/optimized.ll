...
for.inc26:                                        ; preds = %for.inc26.loopexit, %for.inc26.split.loop.exit33
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit33 ], [ %r1.0, %for.inc26.loopexit ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit33 ], [ %c1.0, %for.inc26.loopexit ]
  %i.2 = phi i32 [ 10000, %for.inc26.split.loop.exit33 ], [ %6, %for.inc26.loopexit ]
