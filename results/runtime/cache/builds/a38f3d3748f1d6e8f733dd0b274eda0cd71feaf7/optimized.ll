...
for.cond27:                                       ; preds = %for.inc42, %for.end26
  ...
  %i.2 = phi i32 [ %0, %for.end26 ], [ %dec43, %for.inc42 ]
...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %j.2 = phi i32 [ %0, %for.body29 ], [ %dec, %for.inc40 ]
...
for.body32:                                       ; preds = %for.cond30
  ...
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !13
...
for.end44:                                        ; preds = %for.cond27
  %j1.0.neg = sub i32 0, %j1.0
  %sub = add i32 %j1.0.neg, -1
  %sub45 = add i32 %sub, %j2.0
  %i2.0.neg = sub i32 0, %i2.0
  %sub46 = add i32 %i1.0, -1
