...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %cash) #5
...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  call fastcc void @outlined_ir_func_0(ptr %call73, ptr null, i32 -1)
  br label %sw.epilog
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %cash) #5
  ret i32 0
}
