...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %.sink14 = phi i32 [ %j.0, %if.then ], [ %add16, %for.inc25 ]
  %add16 = add nsw i32 %.sink14, 1
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %.sink13 = phi i32 [ %j.0, %if.then30 ], [ %add35, %for.inc44 ]
  %add35 = add nsw i32 %.sink13, 1
...
for.inc55.gvnsink.split:                          ; preds = %for.cond17, %for.end46
  %j.2 = phi i32 [ %add35, %for.end46 ], [ %add16, %for.cond17 ]
  %csum.2 = phi i32 [ %conv52, %for.end46 ], [ 0, %for.cond17 ]
...
for.inc55:                                        ; preds = %for.inc55.gvnsink.split, %if.end
  %j.1 = phi i32 [ %j.2, %for.inc55.gvnsink.split ], [ %j.0, %if.end ]
  %csum.1 = phi i32 [ %csum.2, %for.inc55.gvnsink.split ], [ %conv10, %if.end ]
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !16, !invariant.load !27
  ret i64 %0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !28, !invariant.load !27
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !35, !invariant.load !27
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !36, !invariant.load !27
...
!31 = !{!"p1 _ZTS15__locale_struct", !22, i64 0}
!32 = !{!"bool", !7, i64 0}
!33 = !{!"p1 int", !22, i64 0}
!34 = !{!"p1 short", !22, i64 0}
!35 = !{!7, !7, i64 0}
!36 = !{!37, !37, i64 0}
