...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv28 = phi i64 [ 0, %entry ], [ %indvars.iv.next29, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre32, %for.inc ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.pre-phi, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.218, %for.inc ]
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.220, %for.inc ]
  %end1.1 = phi i32 [ %end1.0, %for.cond1.preheader ], [ %end1.2, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.cond1.preheader ], [ %end2.2, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.222, %for.inc ]
  %6 = sext i32 %5 to i64
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  ...
  %f.222 = phi i32 [ %f.1, %for.body3.for.inc_crit_edge ], [ %f.2.ph, %land.lhs.true ]
  %star2.220 = phi i32 [ %star2.1, %for.body3.for.inc_crit_edge ], [ %star2.2.ph, %land.lhs.true ]
  %star1.218 = phi i32 [ %star1.1, %for.body3.for.inc_crit_edge ], [ %star1.2.ph, %land.lhs.true ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub = add i32 %star1.0.neg, 1
  %add26 = add i32 %reass.sub, %end1.0
  %star2.0.neg = sub i32 0, %star2.0
  %reass.sub24 = add i32 %star2.0.neg, 1
  %add28 = add i32 %reass.sub24, %end2.0
