...
for.cond53.preheader:                             ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv14, %1
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  br label %for.cond53

for.body19:                                       ; preds = %for.cond17
  %7 = mul nuw nsw i64 %indvars.iv26, %1
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv21 = phi i64 [ %indvars.iv14, %for.cond39.preheader ], [ %indvars.iv.next22, %for.inc47 ]
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select5, %for.body62 ], [ %11, %for.body55 ]
...
for.body62:                                       ; preds = %for.cond60
  %12 = mul nuw nsw i64 %indvars.iv31, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %12
  %13 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select5 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv36 = phi i64 [ %indvars.iv14, %for.cond77.preheader ], [ %indvars.iv.next37, %for.inc85 ]
  %exitcond40 = icmp eq i64 %indvars.iv36, %1
  br i1 %exitcond40, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %14 = mul nuw nsw i64 %indvars.iv36, %1
  %gep7 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %14
  %15 = load i32, ptr %gep7, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %16 = mul nuw nsw i64 %indvars.iv.next15, %1
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  ...
  %19 = trunc nuw i64 %indvars.iv48 to i32
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %21 = mul nuw nsw i64 %indvars.iv48, %1
