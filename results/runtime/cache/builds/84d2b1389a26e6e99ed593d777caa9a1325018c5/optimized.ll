...
for.end61:                                        ; preds = %for.body40, %for.end50, %for.cond34
  %x2.1 = phi i32 [ %x2.0, %for.cond34 ], [ %x2.2, %for.end50 ], [ %i.2, %for.body40 ]
  %y2.1 = phi i32 [ %y2.0, %for.cond34 ], [ %y2.2, %for.end50 ], [ %j.2, %for.body40 ]
  %.neg = sub i32 0, %y1.1
  %add = add i32 %y2.1, -1
  %sub63 = add i32 %add, %.neg
  %.neg1 = sub i32 0, %x1.1
  %add65 = add i32 %x2.1, -1
  %sub66 = add i32 %add65, %.neg1
