...
for.cond13.preheader:                             ; preds = %for.cond
  %smax9 = call i32 @llvm.smax.i32(i32 noundef %m2, i32 noundef 1) #9
  br label %for.cond13
...
if.then8:                                         ; preds = %for.body
  %call = tail call noundef i32 @_Z7runniani(i32 noundef %y) #5
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc37
  ...
  br i1 %exitcond10.not, label %for.end39, label %for.body15
...
if.then28:                                        ; preds = %for.body15
  %call29 = tail call noundef i32 @_Z7runniani(i32 noundef %y) #5
  %tobool30.not = icmp eq i32 %call29, 0
  %spec.select7.neg = select i1 %tobool30.not, i32 -3, i32 -2
  %sub34 = add nsw i32 %spec.select7.neg, %add16
  br label %for.inc37
