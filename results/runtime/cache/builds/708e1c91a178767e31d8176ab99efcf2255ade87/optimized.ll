...
for.cond:                                         ; preds = %for.inc, %if.then
  ...
  %1 = phi i32 [ %dec, %for.inc ], [ %sub, %if.then ]
...
if.end:                                           ; preds = %if.then10, %if.else
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i11) #7
  store i32 0, ptr %i11, align 4, !tbaa !5
  br label %for.cond12

for.cond12:                                       ; preds = %for.inc39, %if.end
  %6 = load i32, ptr %i11, align 4, !tbaa !5
  %7 = load i32, ptr %c2.addr, align 4, !tbaa !5
