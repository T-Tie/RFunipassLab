...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc19 ], [ %2, %for.end ]
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc45 ], [ %2, %for.body24 ]
...
land.lhs.true:                                    ; preds = %for.body31
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %9, i32 %sum.0)
...
for.end47:                                        ; preds = %for.cond29
  ...
  %10 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next36
  store i32 %add53.sink, ptr %10, align 4, !tbaa !5
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select28 = call i32 @llvm.smax.i32(i32 %11, i32 %sum.2)
