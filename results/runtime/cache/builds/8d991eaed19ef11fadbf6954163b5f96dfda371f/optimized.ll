...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv46, %1
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count62 = zext nneg i32 %smax56 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond63.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.body15 ], [ 0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select42, %for.body15 ], [ %l1.0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv49
  ...
  %spec.select42 = select i1 %cmp20, i32 %6, i32 %l1.1
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv52 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next53, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %exitcond58.not = icmp eq i64 %indvars.iv52, %wide.trip.count62
  br i1 %exitcond58.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv52, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv52, i64 %idxprom40
  %7 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp slt i32 %7, %min.1
  %spec.select43 = call i32 @llvm.smin.i32(i32 %7, i32 %min.1)
  %8 = trunc nuw nsw i64 %indvars.iv52 to i32
  %spec.select44 = select i1 %cmp42, i32 %8, i32 %l2.1
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %min.3 = phi i32 [ %9, %if.end37.thread ], [ %spec.select43, %if.end37 ]
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select44, %if.end37 ]
