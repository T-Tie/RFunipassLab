...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv69, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv135 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next136, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv135 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond84.not = icmp eq i64 %indvars.iv80, %indvars.iv135
  br i1 %exitcond84.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx31 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv80, i64 0
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv72 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next73, %for.inc41 ]
  %min.3 = phi i32 [ %min.2, %for.cond23.preheader ], [ %min.4, %for.inc41 ]
  %exitcond.not = icmp eq i64 %indvars.iv72, %indvars.iv135
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv72, 0
...
if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv80, i64 %indvars.iv72
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv75 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next76, %for.inc53 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %indvars.iv135
  br i1 %exitcond79.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv80, i64 %indvars.iv75
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %indvars.iv135
  br i1 %exitcond99.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 0, i64 %indvars.iv95
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv85 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next86, %for.inc90 ]
  %min.6 = phi i32 [ %min.5, %for.cond65.preheader ], [ %min.7, %for.inc90 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %indvars.iv135
  br i1 %exitcond89.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv85, 0
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv85, i64 %indvars.iv95
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !13
  %spec.select67 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select67, %if.else75 ]
  %indvars.iv.next86 = add nuw nsw i64 %indvars.iv85, 1
  br label %for.cond65, !llvm.loop !17

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv90 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next91, %for.inc103 ]
  %exitcond94.not = icmp eq i64 %indvars.iv90, %indvars.iv135
  br i1 %exitcond94.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv90, i64 %indvars.iv95
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond109.not = icmp eq i64 %indvars.iv105, %indvars.iv135
  br i1 %exitcond109.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond104.not = icmp eq i64 %indvars.iv100, %indvars.iv135
  br i1 %exitcond104.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv105, i64 %indvars.iv100
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv105, i64 %indvars.iv100
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv110 = phi i64 [ %indvars.iv.next111, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond115.not = icmp eq i64 %indvars.iv110, %indvars.iv135
  br i1 %exitcond115.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv110
  %15 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
  %16 = add nsw i64 %indvars.iv110, -1
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv116 = phi i64 [ %indvars.iv.next117, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond121.not = icmp eq i64 %indvars.iv116, %indvars.iv135
  br i1 %exitcond121.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv116
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond133.not = icmp eq i64 %indvars.iv128, %indvars.iv135
  br i1 %exitcond133.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %19 = add nsw i64 %indvars.iv128, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv122 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next123, %for.inc185 ]
  %exitcond127.not = icmp eq i64 %indvars.iv122, %indvars.iv135
  br i1 %exitcond127.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv128, i64 %indvars.iv122
  %20 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
  %21 = add nsw i64 %indvars.iv122, -1
