...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc10
  ...
  br i1 %exitcond.not, label %for.cond13.preheader, label %for.inc10
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %3 = phi i32 [ %.pre, %for.inc20 ], [ %0, %for.cond13.preheader ]
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc20 ], [ 0, %for.cond13.preheader ]
  %4 = sext i32 %3 to i64
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %i.0 = phi i32 [ %inc, %for.inc ], [ %m, %for.cond.preheader ]
...
cleanup:                                          ; preds = %cleanup.loopexit, %if.else, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 1, %if.else ], [ %sum.0, %cleanup.loopexit ]
  ret i32 %retval.0
}
