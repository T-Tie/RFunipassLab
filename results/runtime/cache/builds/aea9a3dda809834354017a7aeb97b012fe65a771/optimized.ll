...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc45
  ...
  br i1 %exitcond20.not, label %for.cond48, label %for.cond13.preheader
...
for.cond13.preheader:                             ; preds = %for.cond10
  ...
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 0
  %.sink = trunc i64 %indvars.iv14 to i32
  br label %for.cond13
...
for.inc42.sink.split:                             ; preds = %if.else, %if.then
  %.sink43 = phi i32 [ %5, %if.then ], [ %6, %if.else ]
  store i32 %.sink43, ptr %arrayidx30, align 4, !tbaa !5
...
for.cond48:                                       ; preds = %for.cond10, %for.inc86
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc86 ], [ 0, %for.cond10 ]
...
for.cond51.preheader:                             ; preds = %for.cond48
  ...
  %arrayidx59 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 0, i64 %indvars.iv26
  %.sink44 = trunc i64 %indvars.iv26 to i32
  br label %for.cond51
...
for.inc83.sink.split:                             ; preds = %if.else64, %if.then55
  %.sink45 = phi i32 [ %8, %if.then55 ], [ %9, %if.else64 ]
  store i32 %.sink45, ptr %arrayidx70, align 4, !tbaa !5
  store i32 %.sink44, ptr %arrayidx80, align 4, !tbaa !5
  br label %for.inc83
...
for.cond89:                                       ; preds = %for.cond48, %for.inc110
  ...
  %cmp90 = icmp slt i64 %indvars.iv35, %12
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc107
  ...
  %13 = sext i32 %.pre3840 to i64
  %cmp93 = icmp slt i64 %indvars.iv32, %13
