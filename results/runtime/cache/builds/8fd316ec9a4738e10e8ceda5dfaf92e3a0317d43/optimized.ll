...
for.body:                                         ; preds = %for.cond
  ...
  %5 = load double, ptr %arrayidx, align 8, !tbaa !9, !invariant.load !11
  %cmp6 = fcmp ogt double %5, 0.000000e+00
  %fneg26 = fneg double %1
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %call9 = call double @sqrt(double noundef %5) #7, !tbaa !5
  ...
  %call16 = call double @sqrt(double noundef %5) #7, !tbaa !5
...
if.else:                                          ; preds = %for.body
  ...
  %mul27 = fmul double 2.000000e+00, %2
  %div28 = fdiv double %fneg26, %mul27
  %6 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom
  store double %div28, ptr %6, align 8, !tbaa !9
...
for.inc.gvnsink.split:                            ; preds = %if.then, %if.else32
  %div44.sink = phi double [ %div44, %if.else32 ], [ %div18, %if.then ]
  ...
  store double %div44.sink, ptr %arrayidx47, align 8, !tbaa !9
  br label %for.inc
...
for.body51:                                       ; preds = %for.cond49
  ...
  %8 = load double, ptr %arrayidx53, align 8, !tbaa !9, !invariant.load !11
  %cmp54 = fcmp ogt double %8, 0.000000e+00
  %9 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
  %10 = load double, ptr %9, align 8, !tbaa !9, !invariant.load !11
...
if.then55:                                        ; preds = %for.body51
  ...
  %11 = load double, ptr %arrayidx61, align 8, !tbaa !9, !invariant.load !11
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %10, double noundef %11) #8
  br label %for.inc110
...
if.then67:                                        ; preds = %if.else63
  %call71 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %10) #8
  br label %for.inc110

if.else72:                                        ; preds = %if.else63
  %cmp76 = fcmp oeq double %10, 0.000000e+00
  %12 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 1
  %13 = getelementptr inbounds [99 x double], ptr %12, i64 0, i64 %idxprom52
...
if.then77:                                        ; preds = %if.else72
  %fneg81 = fneg double %10
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %14, double noundef %fneg81, double noundef %14) #8
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %10, double noundef %14, double noundef %10, double noundef %14) #8
  br label %for.inc110
