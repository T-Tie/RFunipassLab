...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax105 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond76.not, label %for.cond28.preheader, label %for.cond1

for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count80 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv67 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next68, %for.inc22 ]
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv87 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next88, %for.inc63 ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv82 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next83, %for.inc60 ]
  %exitcond86.not = icmp eq i64 %indvars.iv82, %wide.trip.count80
...
if.end68:                                         ; preds = %for.end65
  ...
  %wide.trip.count98 = zext i32 %t.tr to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %for.inc125 ], [ 0, %if.end68 ]
...
for.cond72.preheader:                             ; preds = %for.cond69
  %6 = add nsw i64 %indvars.iv100, -1
  %7 = trunc nuw nsw i64 %indvars.iv100 to i32
  br label %for.cond72

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv93 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next94, %for.inc122 ]
  %exitcond99.not = icmp eq i64 %indvars.iv93, %wide.trip.count98
...
if.then85:                                        ; preds = %land.lhs.true
  ...
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv100, i64 %10
...
if.then97:                                        ; preds = %lor.lhs.false.thread
  ...
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %6, i64 %indvars.iv93
  store i32 %11, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv100, i64 %indvars.iv93
