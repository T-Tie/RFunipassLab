...
for.end:                                          ; preds = %for.cond
  ...
  %smin = call range(i32 -2147483648, 1) i32 @llvm.smin.i32(i32 noundef %sub, i32 noundef 0)
  %2 = add i32 %smin, -1
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc19, %for.end
  %3 = phi i32 [ %add, %for.inc19 ], [ 1, %for.end ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv52, 0
  %indvars.iv.next53 = add nsw i64 %indvars.iv52, -1
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next53
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv52
...
for.inc19:                                        ; preds = %for.body7
  ...
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next53
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !12

for.end20.split.loop.exit:                        ; preds = %for.body7
  %6 = trunc nsw i64 %indvars.iv.next53 to i32
  br label %for.end20
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.end47 ], [ %7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %cmp23 = icmp sgt i64 %indvars.iv58, -1
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv58
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %8, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %cmp30 = icmp sgt i64 %indvars.iv55, %indvars.iv58
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %9 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv55
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv55
  %11 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %cmp39.not = icmp sge i32 %11, %sum.0
  %spec.select = call i32 @llvm.smax.i32(i32 %11, i32 %sum.0)
  %inc43 = zext i1 %cmp39.not to i32
  %spec.select48 = add nsw i32 %p.1, %inc43
  br label %for.inc45

for.inc45:                                        ; preds = %land.lhs.true, %for.body31
  %sum.1 = phi i32 [ %sum.0, %for.body31 ], [ %spec.select, %land.lhs.true ]
  %p.2 = phi i32 [ %p.1, %for.body31 ], [ %spec.select48, %land.lhs.true ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  %spec.select49 = select i1 %cmp48, i32 1, i32 %add53
  %arrayidx55 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv58
  store i32 %spec.select49, ptr %arrayidx55, align 4, !tbaa !5
  %indvars.iv.next59 = add nsw i64 %indvars.iv58, -1
  br label %for.cond22, !llvm.loop !14

for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv61 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next62, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select50, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv61, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv61
  %12 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select50 = call i32 @llvm.smax.i32(i32 %12, i32 %sum.2)
