...
for.end:                                          ; preds = %for.cond
  ...
  %smax15 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %wide.trip.count16 = zext nneg i32 %smax15 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond17.not = icmp eq i64 %indvars.iv11, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond29.preheader, label %for.cond7.preheader
...
for.cond29.preheader:                             ; preds = %for.cond4
  ...
  %smax21 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv8
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv18 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next19, %for.inc36 ]
  %exitcond23.not = icmp eq i64 %indvars.iv18, %wide.trip.count22
  br i1 %exitcond23.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv18
