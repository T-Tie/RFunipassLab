...
for.cond22.preheader:                             ; preds = %for.cond19
  %smax35 = call i32 @llvm.smax.i32(i32 %indvars.iv33, i32 noundef 0)
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 1)
...
for.cond52:                                       ; preds = %for.inc59, %for.end49
  ...
  br i1 %exitcond46.not, label %cleanup, label %for.body54
