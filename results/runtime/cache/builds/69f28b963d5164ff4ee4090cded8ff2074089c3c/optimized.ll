...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select1 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select1
  ...
  %or.cond2 = or i1 %cmp12, %or.cond
  %smax3 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond2, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %x.1 = phi i32 [ %add, %for.inc ], [ 0, %for.body ]
  %exitcond4.not = icmp eq i32 %m.0, %smax3
  br i1 %exitcond4.not, label %for.inc53, label %for.body16
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax3
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  %.sink5 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add34 = add nuw nsw i32 %x.4, %.sink5
  %inc41 = add i32 %m.1, 1
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %.str..str.16 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(3) %.str..str.16)
