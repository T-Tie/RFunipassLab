; ModuleID = '<stdin>'
source_filename = "/tmp/tmp41yojisy.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %n) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %sum) #11
  store i32 0, ptr %sum, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #11
...
while.cond:                                       ; preds = %if.end29, %entry
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(40) %a)
  ...
  br i1 %call2, label %land.end, label %while.end
...
while.body:                                       ; preds = %land.end
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #12
  %conv = trunc i64 %call4 to i32
  %cmp5 = icmp eq i32 %inc, 1
...
if.end:                                           ; preds = %while.body
  ...
  %cmp8 = icmp sle i32 %add, 80
  br i1 %cmp8, label %if.then11, label %if.then25

if.end.thread:                                    ; preds = %while.body
  %add7 = add nsw i32 %add, 1
  store i32 %add7, ptr %sum, align 4, !tbaa !5
  %cmp83 = icmp sle i32 %add7, 80
  br i1 %cmp83, label %if.else14, label %if.then25

if.then11:                                        ; preds = %if.end
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %a)
  br label %if.end19

if.else14:                                        ; preds = %if.end.thread
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(2) @.str)
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call15, ptr noundef nonnull align 16 dereferenceable(40) %a)
  br label %if.end19

if.end19:                                         ; preds = %if.then11, %if.else14
  %3 = phi i32 [ %add7, %if.else14 ], [ %add, %if.then11 ]
  %cmp20 = icmp eq i32 %3, 80
  br i1 %cmp20, label %if.end23.thread, label %if.end23
...
if.end23:                                         ; preds = %if.end19
  %.pr.pr = load i32, ptr %sum, align 4, !tbaa !5
  %cmp24 = icmp sgt i32 %.pr.pr, 80
  br i1 %cmp24, label %if.then25, label %if.end29

if.then25:                                        ; preds = %if.end.thread, %if.end, %if.end23
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %a)
  store i32 %conv, ptr %sum, align 4, !tbaa !5
  store i32 1, ptr %i, align 4, !tbaa !5
  br label %if.end29

if.end29:                                         ; preds = %if.end23.thread, %if.then25, %if.end23
...
while.end:                                        ; preds = %while.cond, %land.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %sum) #13
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %n) #13
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #13
  ret i32 0
}
...
do.end:                                           ; preds = %entry
  ...
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !11
...
if.then6:                                         ; preds = %if.else
  ...
  %vbase.offset9 = load i64, ptr %vbase.offset.ptr8, align 8, !invariant.load !11
  ...
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !11
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !11
...
if.then28:                                        ; preds = %if.then19
  ...
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !11
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !26
  %conv = zext i8 %0 to i32
  ret i32 %conv
}

; Function Attrs: mustprogress uwtable
declare noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4failEv(ptr noundef nonnull align 8 dereferenceable(264)) local_unnamed_addr #4 align 2

; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) local_unnamed_addr #9 comdat {
entry:
  %and = and i32 %__a, %__b
  ret i32 %and
}
...
!30 = !{!"p1 _ZTS15__locale_struct", !21, i64 0}
!31 = !{!"bool", !7, i64 0}
!32 = !{!"p1 int", !21, i64 0}
!33 = !{!"p1 short", !21, i64 0}
