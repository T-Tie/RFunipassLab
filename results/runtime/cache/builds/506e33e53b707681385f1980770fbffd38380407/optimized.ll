...
for.inc:                                          ; preds = %if.else, %lor.lhs.false13, %lor.lhs.false15, %lor.lhs.false17, %lor.lhs.false19, %lor.lhs.false21, %lor.lhs.false23, %for.body9, %if.else27
  %.sink28 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %lor.lhs.false23 ], [ 31, %lor.lhs.false21 ], [ 31, %lor.lhs.false19 ], [ 31, %lor.lhs.false17 ], [ 31, %lor.lhs.false15 ], [ 31, %lor.lhs.false13 ], [ 31, %if.else ]
  %add28 = add nsw i32 %n1.0, %.sink28
...
for.inc56:                                        ; preds = %if.else36, %lor.lhs.false38, %lor.lhs.false40, %lor.lhs.false42, %lor.lhs.false44, %lor.lhs.false46, %lor.lhs.false48, %for.body32, %if.else52
  %.sink27 = phi i32 [ 30, %if.else52 ], [ 29, %for.body32 ], [ 31, %lor.lhs.false48 ], [ 31, %lor.lhs.false46 ], [ 31, %lor.lhs.false44 ], [ 31, %lor.lhs.false42 ], [ 31, %lor.lhs.false40 ], [ 31, %lor.lhs.false38 ], [ 31, %if.else36 ]
  %add53 = add nsw i32 %n2.0, %.sink27
...
for.inc109:                                       ; preds = %if.else91, %lor.lhs.false93, %lor.lhs.false95, %lor.lhs.false97, %lor.lhs.false99, %lor.lhs.false101, %for.body87, %if.else105
  %.sink26 = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %lor.lhs.false101 ], [ 31, %lor.lhs.false99 ], [ 31, %lor.lhs.false97 ], [ 31, %lor.lhs.false95 ], [ 31, %lor.lhs.false93 ], [ 31, %if.else91 ]
  %add106 = add nsw i32 %n182.0, %.sink26
...
for.inc138:                                       ; preds = %if.else118, %lor.lhs.false120, %lor.lhs.false122, %lor.lhs.false124, %lor.lhs.false126, %lor.lhs.false128, %lor.lhs.false130, %for.body114, %if.else134
  %.sink25 = phi i32 [ 30, %if.else134 ], [ 28, %for.body114 ], [ 31, %lor.lhs.false130 ], [ 31, %lor.lhs.false128 ], [ 31, %lor.lhs.false126 ], [ 31, %lor.lhs.false124 ], [ 31, %lor.lhs.false122 ], [ 31, %lor.lhs.false120 ], [ 31, %if.else118 ]
  %add135 = add nsw i32 %n283.0, %.sink25
...
for.inc164.gvnsink.split:                         ; preds = %if.then74, %if.else76, %if.then157, %if.else159
  %.str.3.sink = phi ptr [ @.str.3, %if.else159 ], [ @.str.2, %if.then157 ], [ @.str.3, %if.else76 ], [ @.str.2, %if.then74 ]
  %call160 = call i32 (ptr, ...) @printf(ptr noundef %.str.3.sink)
  br label %for.inc164
