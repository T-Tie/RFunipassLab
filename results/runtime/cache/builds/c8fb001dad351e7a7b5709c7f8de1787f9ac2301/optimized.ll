...
if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi22 = phi double [ %.pre21, %if.then23 ], [ %.pre-phi16, %if.end ]
  %mul30.pre-phi = phi double [ %.pre17, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre11, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre10, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre9, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi22, 0.000000e+00
