...
for.cond:                                         ; preds = %for.inc17, %entry
  ...
  %exitcond21.not = icmp eq i64 %indvars.iv, 13
  br i1 %exitcond21.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc14 ], [ %indvars.iv, %for.cond ]
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond.not = icmp eq i64 %indvars.iv17, 12
  br i1 %exitcond.not, label %for.inc17, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not = icmp samesign ugt i64 %indvars.iv14, %indvars.iv17
  br i1 %cmp6.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv14
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv.next18
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc27 ], [ 1, %for.cond ]
  %exitcond25.not = icmp eq i64 %indvars.iv22, 13
  br i1 %exitcond25.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv22, i64 %indvars.iv22
  store i32 1, ptr %arrayidx26, align 4, !tbaa !5
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  br label %for.cond20, !llvm.loop !15

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond33.not = icmp eq i64 %indvars.iv30, 13
  br i1 %exitcond33.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond29.not = icmp eq i64 %indvars.iv26, %indvars.iv30
  br i1 %exitcond29.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv26, i64 %indvars.iv30
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv30, i64 %indvars.iv26
...
for.cond51:                                       ; preds = %for.cond30, %for.inc79
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc79 ], [ 1, %for.cond30 ]
  %exitcond44.not = icmp eq i64 %indvars.iv34, 13
  br i1 %exitcond44.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc76 ], [ %indvars.iv34, %for.cond51 ]
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond42.not = icmp eq i64 %indvars.iv39, 12
  br i1 %exitcond42.not, label %for.inc79, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc65 ], [ %indvars.iv34, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not = icmp samesign ugt i64 %indvars.iv36, %indvars.iv39
  br i1 %cmp60.not, label %for.end67, label %for.inc65

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv36
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv34, i64 %indvars.iv.next40
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond48.not = icmp eq i64 %indvars.iv45, 13
  br i1 %exitcond48.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv45, i64 %indvars.iv45
  store i32 1, ptr %arrayidx88, align 4, !tbaa !5
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  br label %for.cond82, !llvm.loop !21

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond56.not = icmp eq i64 %indvars.iv53, 13
  br i1 %exitcond56.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond52.not = icmp eq i64 %indvars.iv49, %indvars.iv53
  br i1 %exitcond52.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv49, i64 %indvars.iv53
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv53, i64 %indvars.iv49
...
for.body115:                                      ; preds = %for.cond113
  ...
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %arrayidx133) #8
...
if.then119_to_outline:
  %1 = load i32, ptr %0, align 4, !tbaa !5, !invariant.load !9
  %cmp124 = icmp eq i32 %1, 1
  %str.2.str = select i1 %cmp124, ptr @str.2, ptr @str
  %puts = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.str) #8
  ret void
}
