...
for.inc114:                                       ; preds = %for.cond89
  ...
  store i8 %9, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds [6 x i8], ptr %arrayidx84, i64 0, i64 %idxprom94
  %10 = load i8, ptr %arrayidx102, align 1, !tbaa !9
  store i8 %10, ptr %arrayidx95, align 1, !tbaa !9
  %11 = load i8, ptr %arrayidx98, align 1, !tbaa !9
  store i8 %11, ptr %arrayidx102, align 1, !tbaa !9
  %inc115 = add nsw i32 %8, 1
...
for.end123:                                       ; preds = %for.cond71
  %12 = load i8, ptr %arrayidx8, align 4, !tbaa !9
  %conv126 = sext i8 %12 to i32
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %phiofops = phi i32 [ 0, %if.else ], [ %i.3, %for.inc151 ]
  %i.3 = phi i32 [ 1, %if.else ], [ %inc148, %for.inc151 ]
...
for.body136:                                      ; preds = %for.cond134
  ...
  %13 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %conv140 = sext i8 %13 to i32
  ...
  %14 = load i8, ptr %arrayidx144, align 2, !tbaa !9
  %conv145 = sext i8 %14 to i32
...
for.body161:                                      ; preds = %for.cond159
  ...
  %15 = load i8, ptr %arrayidx164, align 1, !tbaa !9
  %conv165 = sext i8 %15 to i32
  ...
  %16 = load i8, ptr %arrayidx168, align 1, !tbaa !9
  %conv169 = sext i8 %16 to i32
...
for.inc197:                                       ; preds = %for.cond172
  ...
  store i8 %18, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds [6 x i8], ptr %arrayidx167, i64 0, i64 %idxprom177
  %19 = load i8, ptr %arrayidx185, align 1, !tbaa !9
  store i8 %19, ptr %arrayidx178, align 1, !tbaa !9
  %20 = load i8, ptr %arrayidx181, align 1, !tbaa !9
  store i8 %20, ptr %arrayidx185, align 1, !tbaa !9
  %inc198 = add nsw i32 %17, 1
...
for.inc220:                                       ; preds = %for.cond211
  ...
  %22 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %22 to i32
