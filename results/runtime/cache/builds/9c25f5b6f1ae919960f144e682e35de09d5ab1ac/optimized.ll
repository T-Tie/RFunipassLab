...
define dso_local void @_Z2f1Piii(ptr nofree noundef captures(none) %p, i32 noundef %n, i32 noundef %k) local_unnamed_addr #0 {
entry:
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc11
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc11 ], [ 0, %for.cond4.preheader ]
  %exitcond6.not = icmp eq i64 %indvars.iv2, %wide.trip.count
  br i1 %exitcond6.not, label %for.end13, label %for.inc11

for.inc11:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw i32, ptr %p.tr, i64 %indvars.iv2
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define dso_local void @_Z2f2Piii(ptr nofree noundef captures(none) %p, i32 noundef %n, i32 noundef %k) local_unnamed_addr #0 {
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #6
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %tailrecurse
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc14
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc14 ], [ 0, %for.cond5.preheader ]
  %exitcond8.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond8.not, label %for.end16, label %for.inc14

for.inc14:                                        ; preds = %for.cond5
  %add.ptr10.idx = mul nuw nsw i64 %indvars.iv3, 400
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc63
  %indvars.iv29 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next30, %for.inc63 ]
  %indvars.iv26 = phi i64 [ %4, %for.cond14.preheader ], [ %indvars.iv.next27, %for.inc63 ]
  %h.0 = phi i32 [ 0, %for.cond14.preheader ], [ %add, %for.inc63 ]
  %8 = trunc nuw i64 %indvars.iv29 to i32
...
for.cond19:                                       ; preds = %for.inc37, %for.body16
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc37 ], [ 0, %for.body16 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %indvars.iv29
  br i1 %exitcond15.not, label %for.cond40, label %for.cond22

for.cond22:                                       ; preds = %for.cond19, %for.inc34
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc34 ], [ 1, %for.cond19 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %indvars.iv26
  br i1 %exitcond.not, label %for.inc37, label %for.inc34

for.inc34:                                        ; preds = %for.cond22
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv11, i64 %indvars.iv.next6
  %10 = load i32, ptr %arrayidx29, align 4, !tbaa !5
  %arrayidx33 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv11, i64 %indvars.iv5
...
for.cond40:                                       ; preds = %for.cond19, %for.inc60
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc60 ], [ 0, %for.cond19 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %indvars.iv26
  br i1 %exitcond25.not, label %for.inc63, label %for.cond44

for.cond44:                                       ; preds = %for.cond40, %for.inc57
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc57 ], [ 1, %for.cond40 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %indvars.iv26
  br i1 %exitcond20.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond44
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next17, i64 %indvars.iv21
  %11 = load i32, ptr %arrayidx52, align 4, !tbaa !5
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv21
