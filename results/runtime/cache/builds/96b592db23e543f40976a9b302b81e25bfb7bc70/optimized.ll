...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc45 ], [ %idxprom2, %for.body24 ]
...
land.lhs.true:                                    ; preds = %for.body31
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %8, i32 %sum.0)
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select9 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
