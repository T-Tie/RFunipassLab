...
if.then:                                          ; preds = %for.body21
  ...
  call void @outlined_ir_func_0(ptr %__c.addr.i, ptr %vbase.offset.ptr.i23)
...
if.then34:                                        ; preds = %if.else
  ...
  call void @outlined_ir_func_0(ptr %__c.addr.i5, ptr %vbase.offset.ptr.i23)
...
if.else37:                                        ; preds = %if.else
  ...
  call void @outlined_ir_func_0(ptr %__c.addr.i21, ptr %vbase.offset.ptr.i23)
...
define internal void @outlined_ir_func_0(ptr %0, ptr %1) #3 {
newFuncRoot:
