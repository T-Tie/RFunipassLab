...
for.cond2:                                        ; preds = %for.body5, %for.end
  %a.0 = phi i32 [ 0, %for.end ], [ %inc8, %for.body5 ]
...
for.cond10:                                       ; preds = %for.body13, %for.end9
  %b.0 = phi i32 [ 0, %for.end9 ], [ %inc16, %for.body13 ]
...
for.cond18:                                       ; preds = %for.body21, %for.end17
  %c.0 = phi i32 [ 0, %for.end17 ], [ %inc24, %for.body21 ]
...
for.cond26:                                       ; preds = %for.body29, %for.end25
  %d.0 = phi i32 [ 0, %for.end25 ], [ %inc32, %for.body29 ]
...
for.cond34:                                       ; preds = %for.body37, %for.end33
  %e.0 = phi i32 [ 0, %for.end33 ], [ %inc40, %for.body37 ]
...
for.end41:                                        ; preds = %for.cond34
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %i.0, i32 noundef %a.0, i32 noundef %b.0, i32 noundef %c.0, i32 noundef %d.0, i32 noundef %e.0) #5
