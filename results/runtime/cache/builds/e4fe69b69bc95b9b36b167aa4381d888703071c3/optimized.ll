...
while.body:                                       ; preds = %while.cond
  call void @_Z8multiplyPci(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(200) %str, i32 noundef 2) #10
  %dec = add nsw i32 %0, -1
...
define dso_local void @_Z8multiplyPci(ptr nofree noundef nonnull captures(none) dereferenceable(1) %str, i32 noundef %n) #4 {
entry:
  %num = alloca [200 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %num) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(800) %num, i8 noundef 0, i64 noundef 800, i1 noundef false)
  %call = tail call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %str) #11
...
while.body:                                       ; preds = %while.cond
  ...
  %0 = load i8, ptr %sPtr.0.ptr, align 1, !tbaa !15
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !20
