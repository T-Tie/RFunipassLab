...
for.cond45:                                       ; preds = %for.inc66, %for.end44
  %.sink = phi i32 [ 500, %for.end44 ], [ %dec, %for.inc66 ]
  %cmp46 = icmp sgt i32 %.sink, 0
...
if.else71:                                        ; preds = %land.end, %for.end67
  %10 = phi i32 [ %.pr, %for.end67 ], [ %.pr, %land.end ]
  %add72 = add nsw i32 %.sink, 2
