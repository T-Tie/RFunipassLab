...
for.inc16:                                        ; preds = %for.cond9
  ...
  %0 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !15
  %div = sdiv i32 %n, %0
  %sub = sub nsw i32 %g, 1
  %call = call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #10
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !17, !invariant.load !15
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !20, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !38, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !44, !invariant.load !15
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !17, !invariant.load !15
