...
for.cond:                                         ; preds = %for.inc17, %entry
  ...
  %exitcond77.not = icmp eq i64 %indvars.iv, 13
  br i1 %exitcond77.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc14 ], [ %indvars.iv, %for.cond ]
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %exitcond.not = icmp eq i64 %indvars.iv73, 12
  br i1 %exitcond.not, label %for.inc17, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not = icmp samesign ugt i64 %indvars.iv70, %indvars.iv73
  br i1 %cmp6.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv70
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv.next74
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc27 ], [ 1, %for.cond ]
  %exitcond81.not = icmp eq i64 %indvars.iv78, 13
  br i1 %exitcond81.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv78, i64 %indvars.iv78
  store i32 1, ptr %arrayidx26, align 4, !tbaa !5
  %indvars.iv.next79 = add nuw nsw i64 %indvars.iv78, 1
  br label %for.cond20, !llvm.loop !15

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv86 = phi i64 [ %indvars.iv.next87, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond89.not = icmp eq i64 %indvars.iv86, 13
  br i1 %exitcond89.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond85.not = icmp eq i64 %indvars.iv82, %indvars.iv86
  br i1 %exitcond85.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv82, i64 %indvars.iv86
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv86, i64 %indvars.iv82
...
for.cond51:                                       ; preds = %for.cond30, %for.inc79
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.inc79 ], [ 1, %for.cond30 ]
  %exitcond100.not = icmp eq i64 %indvars.iv90, 13
  br i1 %exitcond100.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc76 ], [ %indvars.iv90, %for.cond51 ]
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1
  %exitcond98.not = icmp eq i64 %indvars.iv95, 12
  br i1 %exitcond98.not, label %for.inc79, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %for.inc65 ], [ %indvars.iv90, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not = icmp samesign ugt i64 %indvars.iv92, %indvars.iv95
  br i1 %cmp60.not, label %for.end67, label %for.inc65

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv92
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv90, i64 %indvars.iv.next96
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond104.not = icmp eq i64 %indvars.iv101, 13
  br i1 %exitcond104.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv101, i64 %indvars.iv101
...
for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond112.not = icmp eq i64 %indvars.iv109, 13
  br i1 %exitcond112.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond108.not = icmp eq i64 %indvars.iv105, %indvars.iv109
  br i1 %exitcond108.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv105, i64 %indvars.iv109
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv109, i64 %indvars.iv105
...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts68 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink) #7
