...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %y) #6
...
if.then:                                          ; preds = %for.body
  ...
  %.pre3 = load float, ptr %x, align 4, !tbaa !9
  %.pre4 = load float, ptr %y1, align 4, !tbaa !9
  %.pre5 = load float, ptr %x1, align 4, !tbaa !9
  %.pre10 = fdiv float %.pre, %.pre3
  %.pre11 = fdiv float %.pre4, %.pre5
  %.pre12 = fsub float %.pre10, %.pre11
  %.pre13 = fpext float %.pre12 to double
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %conv10.pre-phi = phi double [ %.pre13, %if.then ], [ %conv, %for.body ]
  %sub9.pre-phi = phi float [ %.pre12, %if.then ], [ %sub4, %for.body ]
  %cmp11 = fcmp olt double %conv10.pre-phi, -5.000000e-02
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end
  %puts1 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #7
  %.pre6 = load float, ptr %y, align 4, !tbaa !9
  %.pre7 = load float, ptr %x, align 4, !tbaa !9
  %.pre8 = load float, ptr %y1, align 4, !tbaa !9
  %.pre9 = load float, ptr %x1, align 4, !tbaa !9
  %.pre14 = fdiv float %.pre6, %.pre7
  %.pre15 = fdiv float %.pre8, %.pre9
  %.pre16 = fsub float %.pre14, %.pre15
  br label %if.end14

if.end14:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi float [ %.pre16, %if.then12 ], [ %sub9.pre-phi, %if.end ]
...
if.then25:                                        ; preds = %if.end14
  %puts2 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #7
  br label %for.inc
