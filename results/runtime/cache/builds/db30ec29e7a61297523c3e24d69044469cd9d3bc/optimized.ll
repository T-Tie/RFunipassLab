...
if.then19.i:                                      ; preds = %entry
  call void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(36) %add.ptr15.i)
...
if.then19.i31:                                    ; preds = %while.body
  call void @outlined_ir_func_1(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(36) %add.ptr15.i24)
...
if.then19.i_to_outline:                           ; preds = %newFuncRoot
  ...
  %1 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !35
