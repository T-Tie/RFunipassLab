...
for.cond3:                                        ; preds = %for.cond, %for.body5
  %7 = phi i32 [ %.pre, %for.body5 ], [ %3, %for.cond ]
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.body5 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp4 = icmp slt i64 %indvars.iv7, %8
  br i1 %cmp4, label %for.body5, label %for.end27

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv7
  %9 = load float, ptr %arrayidx7, align 4, !tbaa !9, !invariant.load !14
  ...
  %.str.sink = select i1 %cmp9, ptr @.str, ptr %.str.1..str.2
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.sink)
...
for.end27:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %a) #11
