...
while.cond7:                                      ; preds = %while.cond1, %while.body9
  %.pr46 = phi i32 [ %sub10, %while.body9 ], [ %.pr45, %while.cond1 ]
  %c.0 = phi i32 [ %inc11, %while.body9 ], [ 0, %while.cond1 ]
  %cmp8 = icmp sgt i32 %.pr46, 19
  br i1 %cmp8, label %while.body9, label %while.cond13

while.body9:                                      ; preds = %while.cond7
  %sub10 = add nsw i32 %.pr46, -20
...
while.cond25thread-pre-split:                     ; preds = %while.cond19
  %smin = call i32 @llvm.smin.i32(i32 %.pr48, i32 0)
  %0 = sub i32 %.pr48, %smin
  br label %while.cond25

while.cond25:                                     ; preds = %while.cond25thread-pre-split, %while.body27
  %1 = phi i32 [ %.pr48, %while.cond25thread-pre-split ], [ %sub28, %while.body27 ]
...
while.end30:                                      ; preds = %while.cond25
  ...
  %vtable.i17 = load ptr, ptr %call33, align 8, !tbaa !17
  ...
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i20, i8 noundef signext 10)
  %call1.i21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call33, i8 noundef signext %call.i)
  ...
  %call35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i22, i32 noundef %c.0)
  %vtable.i23 = load ptr, ptr %call35, align 8, !tbaa !17
  %vbase.offset.ptr.i24 = getelementptr i8, ptr %vtable.i23, i64 -24
  %vbase.offset.i25 = load i64, ptr %vbase.offset.ptr.i24, align 8
  %add.ptr.i26 = getelementptr inbounds i8, ptr %call35, i64 %vbase.offset.i25
  ...
  %call1.i28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call35, i8 noundef signext %call.i27)
  ...
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i29, i32 noundef %d.0)
  %vtable.i30 = load ptr, ptr %call37, align 8, !tbaa !17
  %vbase.offset.ptr.i31 = getelementptr i8, ptr %vtable.i30, i64 -24
  %vbase.offset.i32 = load i64, ptr %vbase.offset.ptr.i31, align 8
  %add.ptr.i33 = getelementptr inbounds i8, ptr %call37, i64 %vbase.offset.i32
  ...
  %call1.i35 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call37, i8 noundef signext %call.i34)
  ...
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i36, i32 noundef %e.0)
  %vtable.i37 = load ptr, ptr %call39, align 8, !tbaa !17
  %vbase.offset.ptr.i38 = getelementptr i8, ptr %vtable.i37, i64 -24
  %vbase.offset.i39 = load i64, ptr %vbase.offset.ptr.i38, align 8
  %add.ptr.i40 = getelementptr inbounds i8, ptr %call39, i64 %vbase.offset.i39
  ...
  %call1.i42 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call39, i8 noundef signext %call.i41)
  ...
  %call41 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i43, i32 noundef %0)
