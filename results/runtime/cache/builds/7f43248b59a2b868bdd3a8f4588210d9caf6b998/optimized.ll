...
for.cond1:                                        ; preds = %for.inc7, %for.end
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc7 ], [ 0, %for.end ]
  %0 = load i32, ptr %k, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp2 = icmp slt i64 %indvars.iv11, %1
  br i1 %cmp2, label %for.inc7, label %for.end9

for.inc7:                                         ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv11
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc35
  %indvars.iv14 = phi i64 [ %3, %for.cond16.preheader ], [ %indvars.iv.next15, %for.inc35 ]
...
for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next15
...
land.lhs.true:                                    ; preds = %for.body18
  ...
  %arrayidx27 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next15
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.body42
  %indvars.iv17 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next18, %for.body42 ]
  %max.0 = phi i32 [ 0, %for.cond40.preheader ], [ %spec.select, %for.body42 ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21.not, label %for.end52, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx44 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv17
