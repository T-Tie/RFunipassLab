...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv14 = phi i64 [ 0, %entry ], [ %indvars.iv.next15, %for.cond1 ]
...
for.cond1.preheader:                              ; preds = %for.cond
  ...
  %3 = add i32 %2, -1
  %4 = trunc nuw i64 %indvars.iv.next15 to i32
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre18, %for.inc ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.pre-phi, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.25, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.cond1.preheader ], [ %end2.2, %for.inc ]
  %end1.1 = phi i32 [ %end1.0, %for.cond1.preheader ], [ %end1.2, %for.inc ]
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.27, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.29, %for.inc ]
  %6 = sext i32 %5 to i64
...
for.inc:                                          ; preds = %for.body3, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %8, %land.lhs.true ], [ %8, %for.body3 ]
  %star1.29 = phi i32 [ %star1.2.ph, %land.lhs.true ], [ %star1.1, %for.body3 ]
  %star2.27 = phi i32 [ %star2.2.ph, %land.lhs.true ], [ %star2.1, %for.body3 ]
  %f.25 = phi i32 [ %f.2.ph, %land.lhs.true ], [ %f.1, %for.body3 ]
