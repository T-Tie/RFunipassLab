...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef nonnull dereferenceable(60000) %c) #9
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef nonnull align 16 dereferenceable(600) %input) #9
...
entry:
  %vtable = load ptr, ptr %this, align 8, !tbaa !20, !invariant.load !10
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !20, !invariant.load !10
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !20, !invariant.load !10
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !10
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !22, !invariant.load !10
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !40, !invariant.load !10
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !46, !invariant.load !10
  ret i32 %0
}
