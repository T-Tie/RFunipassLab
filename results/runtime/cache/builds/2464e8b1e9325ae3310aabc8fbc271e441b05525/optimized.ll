...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv31 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next32, %if.end ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv31
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.end46
  %indvars.iv38 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next39, %for.end46 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc.i4, %for.end46 ]
  %exitcond44.not = icmp eq i32 %i.2, %smax43
  br i1 %exitcond44.not, label %for.end49, label %for.cond22.preheader
...
for.cond22:                                       ; preds = %for.cond22.preheader, %if.end43
  %indvars.iv35 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next36, %if.end43 ]
  %exitcond42.not = icmp eq i64 %indvars.iv35, %wide.trip.count41
  br i1 %exitcond42.not, label %for.end46, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv35
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next36
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax49 = call i32 @llvm.smax.i32(i32 %len.0, i32 1)
  %wide.trip.count50 = zext nneg i32 %smax49 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.body54, %for.end49
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.body54 ], [ 1, %for.end49 ]
  %exitcond51.not = icmp eq i64 %indvars.iv45, %wide.trip.count50
  br i1 %exitcond51.not, label %cleanup, label %for.body54
...
for.body54:                                       ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv45
