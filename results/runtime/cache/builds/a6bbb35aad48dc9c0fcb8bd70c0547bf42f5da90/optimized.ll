...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %an) #7
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %an, ptr align 16 @__const.main.an, i64 400, i1 false)
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call double @pow(double noundef 2.000000e+00, double noundef %conv) #7, !tbaa !5
...
if.end49:                                         ; preds = %for.end47, %if.then
  call void @llvm.lifetime.end.p0(i64 400, ptr %an) #7
