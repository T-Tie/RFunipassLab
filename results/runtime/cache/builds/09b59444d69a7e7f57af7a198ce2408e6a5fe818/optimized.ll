...
if.then85:                                        ; preds = %lor.lhs.false
  ...
  %arrayidx94 = getelementptr inbounds [100 x i32], ptr %5, i64 0, i64 %idxprom93
  store i32 %7, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.else95:                                        ; preds = %lor.lhs.false.thread
  %idxprom865 = sext i32 %i.2 to i64
  %idxprom886 = sext i32 %j.4 to i64
  %8 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom865
  %9 = getelementptr inbounds [100 x i32], ptr %8, i64 0, i64 %idxprom886
...
if.then97:                                        ; preds = %if.else95
  ...
  %arrayidx106 = getelementptr inbounds [100 x i32], ptr %arrayidx104, i64 0, i64 %idxprom886
