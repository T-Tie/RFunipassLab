...
if.else62:                                        ; preds = %if.else
  ...
  %10 = select i1 %cmp84, double 0.000000e+00, double %div69
  %call92 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %10, double noundef %div79)
  %call97 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, double noundef %10, double noundef %div79)
  br label %for.inc100
