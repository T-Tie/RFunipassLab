...
while.end:                                        ; preds = %while.cond
  %indvars39.le = trunc i64 %indvars.iv27 to i32
  ...
  %sub7 = add nsw i32 %indvars39.le, -2
  br label %for.cond8
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv30 = phi i64 [ %0, %while.cond11.preheader ], [ %indvars.iv.next31, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %1 = trunc nuw i64 %indvars.iv.next31 to i32
  %cmp12 = icmp slt i32 %1, %indvars39.le
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select25 = tail call i32 @llvm.smax.i32(i32 %5, i32 %n.2)
