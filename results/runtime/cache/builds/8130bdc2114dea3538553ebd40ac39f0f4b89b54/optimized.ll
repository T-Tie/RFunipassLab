...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !29, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !37, !invariant.load !13
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !43, !invariant.load !13
