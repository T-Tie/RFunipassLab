...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %d) #7
...
for.inc:                                          ; preds = %if.then, %if.else17, %if.then14
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %d) #7
