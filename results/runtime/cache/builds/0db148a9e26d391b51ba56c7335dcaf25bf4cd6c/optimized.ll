...
if.then:                                          ; preds = %for.body
  ...
  %call15.i = call double @sqrt(double noundef %5) #9, !tbaa !5, !noalias !11
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div.i, double noundef %div23.i) #8
  br label %for.inc
...
if.then30:                                        ; preds = %if.else
  %call15.i9 = call double @sqrt(double noundef %5) #9, !tbaa !5, !noalias !15
  %add.i10 = fsub double %call15.i9, %1
  %mul.i11 = fmul double %2, 2.000000e+00
  %div.i12 = fdiv double %add.i10, %mul.i11
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div.i12) #8
  br label %for.inc
...
if.then56:                                        ; preds = %if.else50
  ...
  %call72 = call double @sqrt(double noundef %6) #10, !tbaa !5
...
attributes #9 = { nofree nounwind willreturn memory(write) }
