...
for.end:                                          ; preds = %for.cond
  ...
  %sub = sub nsw i32 %5, 1
  store i32 %sub, ptr %l, align 4, !tbaa !5
  br label %for.cond11
...
for.inc37:                                        ; preds = %for.end36
  %dec = add nsw i32 %6, -1
  store i32 %dec, ptr %l, align 4, !tbaa !5
...
for.body41:                                       ; preds = %for.cond39
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11)
  br label %for.inc45
...
for.end47:                                        ; preds = %for.cond39
  ...
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12)
