...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc29 ], [ 0, %entry ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv32
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv32, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.end, %for.inc25
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc25 ], [ 0, %for.end ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.inc29, label %for.inc25

for.inc25:                                        ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv32, i64 %indvars.iv27
...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc28 ], [ 0, %entry ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end30, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv32
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv, i64 %indvars.iv32
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc24 ], [ 0, %for.end ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.inc28, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv27, i64 %indvars.iv32
...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc11 ], [ 2, %entry ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond15.preheader, label %for.cond1.preheader
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax29 = call i32 @llvm.smax.i32(i32 noundef %sub21, i32 noundef 0)
  %smax36 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 2)
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc37
  %indvars.iv32 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next33, %for.inc37 ]
  %exitcond38.not = icmp eq i64 %indvars.iv32, %wide.trip.count37
  br i1 %exitcond38.not, label %for.end39, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  %indvars.iv26 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next27, %for.inc34 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.inc37, label %for.inc34

for.inc34:                                        ; preds = %for.cond20
  %arrayidx28 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv32
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %arrayidx33 = getelementptr inbounds [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %3
...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre24 = phi i32 [ %.pre2426, %for.inc10 ], [ %.pre, %while.body ]
  %0 = phi i32 [ %2, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc10 ], [ 0, %while.body ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv20, %1
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre2426 = phi i32 [ %.pre2425, %for.inc ], [ %.pre24, %for.cond ]
  %2 = phi i32 [ %6, %for.inc ], [ %.pre24, %for.cond ]
...
for.body6:                                        ; preds = %for.cond3
  %4 = or i64 %indvars.iv, %indvars.iv20
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre2425 = phi i32 [ %.pre2426, %for.body6 ], [ %.pre23, %if.then ]
  %6 = phi i32 [ %2, %for.body6 ], [ %.pre23, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %.sink = phi i32 [ %dec, %for.inc17 ], [ %0, %for.cond ]
...
for.inc17:                                        ; preds = %for.cond13
  tail call void @_Z7zerorowi(i32 noundef %.sink) #6
  %7 = load i32, ptr @k, align 4, !tbaa !5
  tail call void @_Z7zerocoli(i32 noundef %7) #6
  %8 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 408), align 8, !tbaa !5
  ...
  tail call void @_Z4jiani(i32 noundef %10) #6
...
for.end18:                                        ; preds = %for.cond13
  ...
  %call19 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %12)
