...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 captures(none) dereferenceable(40000) %a, i8 noundef 0, i64 noundef 40000, i1 noundef false) #8
...
while.cond:                                       ; preds = %while.end, %entry
  %1 = phi i32 [ %dec, %while.end ], [ %0, %entry ]
  %dec = add nsw i32 %1, -1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc7
  ...
  %indvars.iv3 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next4, %for.inc7 ]
  %3 = sext i32 %2 to i64
  %cmp = icmp slt i64 %indvars.iv3, %3
  br i1 %cmp, label %for.cond1, label %while.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre6, %for.inc ], [ %2, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
while.cond10:                                     ; preds = %for.cond, %while.body12
  ...
  %sub.sink.in = phi i32 [ %sub.sink, %while.body12 ], [ %2, %for.cond ]
  %sub.sink = add nsw i32 %sub.sink.in, -1
  %tobool11.not = icmp eq i32 %sub.sink, 0
  br i1 %tobool11.not, label %while.end, label %while.body12

while.body12:                                     ; preds = %while.cond10
  call void @_Z2m1iPA100_i(i32 noundef %sub.sink.in, ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
  call void @_Z2m2iPA100_i(i32 noundef %sub.sink.in, ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
  %6 = load i32, ptr %arrayidx16, align 4, !tbaa !5
  %add17 = add nsw i32 %6, %sum.0
  call void @_Z4dealiPA100_i(i32 noundef %sub.sink.in, ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #9
...
for.cond:                                         ; preds = %if.end28, %entry.split
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end28 ], [ 0, %entry.split ]
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  br i1 %tobool16.not, label %if.end28, label %if.end

if.end:                                           ; preds = %for.body4
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond18:                                       ; preds = %for.end, %for.inc25
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc25 ], [ 0, %for.end ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond17.not, label %if.end28, label %for.inc25

for.inc25:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv18, i64 %indvars.iv13
...
if.end:                                           ; preds = %for.body4
  %arrayidx8 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv, i64 %indvars.iv18
  %1 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !15
  %spec.select = tail call i32 @llvm.smin.i32(i32 %1, i32 %min.0)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.inc25:                                        ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv13, i64 %indvars.iv18
  %2 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !15
  %sub = sub nsw i32 %2, %min.0
  store i32 %sub, ptr %arrayidx24, align 4, !tbaa !5
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
...
for.cond.preheader:                               ; preds = %entry
  %sub = add nsw i32 %n, -1
  %0 = call i32 @llvm.umax.i32(i32 %sub, i32 1)
  %wide.trip.count = zext nneg i32 %0 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.end
  %indvars.iv7 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next8, %for.end ]
  br label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv7, i64 %indvars.iv.next
