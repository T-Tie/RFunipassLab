...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #13
  br label %for.inc
...
if.then12:                                        ; preds = %if.else
  ...
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #13
...
if.else22:                                        ; preds = %if.else
  ...
  %call27 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #13
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else22, %if.then12
  %count.1 = phi i64 [ %call6, %if.then ], [ %add20, %if.then12 ], [ %call27, %if.else22 ]
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %s) #12
