...
for.cond10:                                       ; preds = %for.inc, %if.then
  %7 = phi i32 [ %dec, %for.inc ], [ %add, %if.then ]
...
for.body13:                                       ; preds = %for.cond10
  ...
  %8 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
  %sub = sub nsw i32 %7, 1
  %idxprom16 = sext i32 %sub to i64
  %arrayidx17 = getelementptr inbounds i32, ptr %vla1, i64 %idxprom16
  %9 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12) #6
...
for.end42:                                        ; preds = %for.cond33
  ...
  %13 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !9
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13) #6
