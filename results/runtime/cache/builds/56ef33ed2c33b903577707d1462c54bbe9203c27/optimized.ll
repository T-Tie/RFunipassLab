...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %Pivot, label %LeafBlock, label %LeafBlock47

LeafBlock47:                                      ; preds = %for.body
  %SwitchLeaf48 = icmp eq i64 %2, 0
  %vbase.offset9.i.pre52 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !9
  br i1 %SwitchLeaf48, label %do.end.i, label %if.then6.i
...
do.end.i:                                         ; preds = %LeafBlock47
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i.pre52
...
if.then6.i:                                       ; preds = %LeafBlock.if.then6.i_crit_edge, %LeafBlock47
  %vbase.offset9.i = phi i64 [ %vbase.offset9.i.pre, %LeafBlock.if.then6.i_crit_edge ], [ %vbase.offset9.i.pre52, %LeafBlock47 ]
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.body6
  %indvars.iv28 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next29, %for.body6 ]
...
for.body6:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv28
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #11
  %4 = trunc i64 %call10 to i32
  %conv = add i32 %4, 1
  %add.ptr12 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv28
...
for.cond16:                                       ; preds = %for.cond16.preheader, %if.end
  %.pre44 = phi i32 [ %0, %for.cond16.preheader ], [ %.pre, %if.end ]
  %indvars.iv35 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next36, %if.end ]
  %sum.0 = phi i32 [ 0, %for.cond16.preheader ], [ %sum.1, %if.end ]
  %k.0 = phi i32 [ 0, %for.cond16.preheader ], [ %k.1, %if.end ]
  %5 = sext i32 %.pre44 to i64
  %cmp17 = icmp slt i64 %indvars.iv35, %5
...
for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv35
  %7 = load i32, ptr %add.ptr20, align 4, !tbaa !5, !invariant.load !9
  %add21 = add nsw i32 %7, %sum.0
  %cmp22 = icmp sgt i32 %add21, 81
  br i1 %cmp22, label %for.cond23.preheader, label %if.end

for.cond23.preheader:                             ; preds = %for.body18
  %8 = add nsw i64 %indvars.iv35, -1
  %9 = zext nneg i32 %k.0 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.body25
  %indvars.iv32 = phi i64 [ %9, %for.cond23.preheader ], [ %indvars.iv.next33, %for.body25 ]
  %cmp24 = icmp slt i64 %indvars.iv32, %8
  br i1 %cmp24, label %for.body25, label %for.end33

for.body25:                                       ; preds = %for.cond23
  %add.ptr27 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv32
...
for.end33:                                        ; preds = %for.cond23
  %gep = getelementptr [41 x i8], ptr %invariant.gep, i64 %indvars.iv35
  ...
  %10 = trunc nuw nsw i64 %indvars.iv35 to i32
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %for.end33, %for.body18
  %.pre = phi i32 [ %.pre.pre, %for.end33 ], [ %.pre44, %for.body18 ]
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.body48
  %11 = phi i32 [ %.pre44, %for.cond45.preheader ], [ %.pre43, %for.body48 ]
  %indvars.iv40 = phi i64 [ %6, %for.cond45.preheader ], [ %indvars.iv.next41, %for.body48 ]
  %sub46 = add nsw i32 %11, -1
  %12 = sext i32 %sub46 to i64
  %cmp47 = icmp slt i64 %indvars.iv40, %12
  br i1 %cmp47, label %for.body48, label %for.end56

for.body48:                                       ; preds = %for.cond45
  %add.ptr50 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv40
