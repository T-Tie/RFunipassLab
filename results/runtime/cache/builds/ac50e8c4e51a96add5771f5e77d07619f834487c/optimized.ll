...
; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_Z3numiii(i32 noundef %n, i32 noundef %g, i32 noundef %h) #3 {
entry:
...
define dso_local noundef i32 @_Z5powerii(i32 noundef %a, i32 noundef %b) #5 {
entry:
  br label %for.cond
