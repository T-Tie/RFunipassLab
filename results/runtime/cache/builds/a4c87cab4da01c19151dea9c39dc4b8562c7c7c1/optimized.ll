...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre21, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc19
  %indvars.iv5 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next6, %for.inc19 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body13

for.body13:                                       ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv5, i64 %indvars.iv5
...
for.body13.for.end22_crit_edge:                   ; preds = %for.body13
  %5 = trunc nuw nsw i64 %indvars.iv5 to i32
  %.pre22 = and i64 %indvars.iv5, 4294967295
  br label %for.end22
...
for.end22:                                        ; preds = %for.cond10, %for.body13.for.end22_crit_edge
  %idxprom26.pre-phi = phi i64 [ %.pre22, %for.body13.for.end22_crit_edge ], [ %wide.trip.count, %for.cond10 ]
  %i.1.lcssa = phi i32 [ %5, %for.body13.for.end22_crit_edge ], [ %smax, %for.cond10 ]
  %smax12 = call i32 @llvm.smax.i32(i32 %i.1.lcssa, i32 %0)
  %wide.trip.count14 = zext i32 %smax12 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc33, %for.end22
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc33 ], [ %idxprom26.pre-phi, %for.end22 ]
  %exitcond15.not = icmp eq i64 %indvars.iv9, %wide.trip.count14
  br i1 %exitcond15.not, label %for.end35, label %for.body25

for.body25:                                       ; preds = %for.cond23
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom26.pre-phi, i64 %indvars.iv9
...
for.end35.split.loop.exit:                        ; preds = %for.body25
  %7 = trunc nuw nsw i64 %indvars.iv9 to i32
  br label %for.end35

for.end35:                                        ; preds = %for.cond23, %for.end35.split.loop.exit
  %j.2.lcssa = phi i32 [ %7, %for.end35.split.loop.exit ], [ %smax12, %for.cond23 ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc46, %for.end35
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc46 ], [ %idxprom26.pre-phi, %for.end35 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count14
  br i1 %exitcond20.not, label %for.end48, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %idxprom26.pre-phi
...
for.end48:                                        ; preds = %for.cond36, %for.end48.split.loop.exit
  %i.2.lcssa = phi i32 [ %9, %for.end48.split.loop.exit ], [ %smax12, %for.cond36 ]
  %sub = sub nuw i32 -2, %i.1.lcssa
  %sub50 = add i32 %j.2.lcssa, %sub
  %sub51 = add i32 %i.2.lcssa, %sub
