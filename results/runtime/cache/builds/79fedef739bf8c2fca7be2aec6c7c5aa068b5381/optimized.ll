...
for.cond57:                                       ; preds = %for.inc70, %for.body56
  ...
  %12 = load i8, ptr %arrayidx59, align 1, !tbaa !9, !invariant.load !13
  %conv60 = sext i8 %12 to i32
  %cmp61 = icmp ne i32 %conv60, 0
  br i1 %cmp61, label %for.body62, label %for.end72

for.body62:                                       ; preds = %for.cond57
  %cmp66 = icmp eq i32 %conv60, %10
...
if.end83:                                         ; preds = %for.end82, %if.then23
