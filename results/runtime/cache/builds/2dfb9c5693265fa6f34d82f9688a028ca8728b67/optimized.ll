...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 301, ptr nonnull %str) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %str)
  br label %for.cond

for.cond:                                         ; preds = %for.body, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %entry ]
  %a.0 = phi i32 [ %spec.select27, %for.body ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  %1 = and i8 %0, -33
  %2 = add i8 %1, -65
  %narrow = icmp ult i8 %2, 26
  %inc19.sink = zext i1 %narrow to i32
  %spec.select27 = add nuw nsw i32 %a.0, %inc19.sink
...
for.cond57:                                       ; preds = %for.cond54, %for.body62
  ...
  %4 = load i8, ptr %arrayidx59, align 1, !tbaa !5
  %cmp61.not = icmp eq i8 %4, 0
...
if.end83:                                         ; preds = %for.cond54, %if.then23
  call void @llvm.lifetime.end.p0(i64 301, ptr nonnull %str) #4
  ret i32 0
}
