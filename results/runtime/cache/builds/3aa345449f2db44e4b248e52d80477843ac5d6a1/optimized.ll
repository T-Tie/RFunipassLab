...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %percent) #5
  call void @llvm.lifetime.start.p0(i64 501, ptr nonnull %a) #5
  call void @llvm.lifetime.start.p0(i64 501, ptr nonnull %b) #5
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %percent)
...
for.cond50:                                       ; preds = %for.cond, %for.body55
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body55 ], [ 0, %for.cond ]
  %number.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond ]
  %arrayidx52 = getelementptr inbounds nuw [501 x i8], ptr %a, i64 0, i64 %indvars.iv16
...
for.body55:                                       ; preds = %for.cond50
  %arrayidx60 = getelementptr inbounds nuw [501 x i8], ptr %b, i64 0, i64 %indvars.iv16
...
cleanup:                                          ; preds = %for.cond, %land.lhs.true, %for.end68, %entry
  %.str.3.sink = phi ptr [ @.str.2, %entry ], [ %.str.3..str.4, %for.end68 ], [ @.str.2, %land.lhs.true ], [ @.str.2, %for.cond ]
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %percent) #5
  ret i32 0
}
