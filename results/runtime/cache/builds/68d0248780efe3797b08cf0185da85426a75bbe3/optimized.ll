...
for.inc129:                                       ; preds = %for.cond117
  ...
  %16 = load i32, ptr %arrayidx124, align 4, !tbaa !5
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %17 = load i32, ptr %arrayidx141, align 16, !tbaa !5
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %18 = load i32, ptr %arrayidx157, align 4, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %19 = load i32, ptr %arrayidx178, align 4, !tbaa !5
...
for.end197:                                       ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 40000, ptr %temp) #6
  call void @llvm.lifetime.end.p0(i64 40000, ptr %a) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n0) #6
