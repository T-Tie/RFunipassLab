...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %i) #12
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %blank) #12
  store i32 0, ptr %blank, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %num) #12
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i32, ptr %blank, align 4, !tbaa !5
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  ...
  %4 = load i32, ptr %blank, align 4, !tbaa !5
  ...
  store i32 %conv20, ptr %num, align 4, !tbaa !5
  store i32 1, ptr %blank, align 4, !tbaa !5
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr %i, align 4, !tbaa !5
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %num) #14
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %blank) #14
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i) #14
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr align 4 %__ret) #14
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %__ret) #14
  ret i32 %1
}
