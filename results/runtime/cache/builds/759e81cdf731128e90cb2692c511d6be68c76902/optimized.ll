...
for.cond1:                                        ; preds = %for.inc, %for.body
  %0 = phi i32 [ %inc, %for.inc ], [ 0, %for.body ]
...
for.end:                                          ; preds = %for.cond1
  ...
  %1 = load i32, ptr %arrayidx8, align 4, !tbaa !8
...
for.cond41:                                       ; preds = %for.inc69, %for.body40
  ...
  %7 = phi i32 [ %inc70, %for.inc69 ], [ 0, %for.body40 ]
  %cmp42 = icmp slt i32 %7, 6
