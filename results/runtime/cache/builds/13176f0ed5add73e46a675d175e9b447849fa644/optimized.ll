...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40804, ptr nonnull %a) #7
  br label %for.cond
...
for.end10:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 40804, ptr nonnull %b) #7
  br label %for.cond12
...
for.end30:                                        ; preds = %for.cond12
  call void @llvm.lifetime.start.p0(i64 40804, ptr nonnull %c) #7
...
for.end88:                                        ; preds = %for.cond63
  ...
  call void @llvm.lifetime.end.p0(i64 40804, ptr nonnull %c) #7
  call void @llvm.lifetime.end.p0(i64 40804, ptr nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %y2) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %x2) #7
  call void @llvm.lifetime.end.p0(i64 40804, ptr nonnull %a) #7
