...
entry:
  %call = call i64 @strlen(ptr nofree noundef readonly %word) #7
...
if.end19:                                         ; preds = %while.cond
  %call168 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
