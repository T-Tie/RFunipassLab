...
for.cond:                                         ; preds = %for.inc32, %entry
  %count.0 = phi i32 [ 0, %entry ], [ %count.2, %for.inc32 ]
  %n.0 = phi i32 [ 0, %entry ], [ %inc33, %for.inc32 ]
...
if.end.thread:                                    ; preds = %for.cond
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %a, i8 noundef 0, i64 noundef 64, i1 noundef false)
  br label %for.cond11.preheader

for.cond11.preheader:                             ; preds = %for.cond, %if.end.thread
  %n.120 = phi i32 [ 0, %if.end.thread ], [ %n.0, %for.cond ]
  %count.119 = phi i32 [ 0, %if.end.thread ], [ %count.0, %for.cond ]
  %1 = and i32 %0, 1
  %cmp13 = icmp eq i32 %1, 0
  %div = ashr exact i32 %0, 1
  %mul = shl nsw i32 %0, 1
  %smax = call i32 @llvm.smax.i32(i32 %n.120, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.cond11.preheader, %for.body
  %indvars.iv = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next, %for.body ]
  %count.2 = phi i32 [ %count.119, %for.cond11.preheader ], [ %spec.select13, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.inc32, label %for.body

for.body:                                         ; preds = %for.cond11
  %arrayidx16 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv
  %2 = load i32, ptr %arrayidx16, align 4, !tbaa !5, !invariant.load !9
  %cmp19 = icmp eq i32 %2, %div
  %narrow = select i1 %cmp13, i1 %cmp19, i1 false
  %spec.select = zext i1 %narrow to i32
  %count.3 = add nsw i32 %count.2, %spec.select
  %cmp27 = icmp eq i32 %2, %mul
