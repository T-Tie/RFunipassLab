...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %ans) #6
...
for.body5:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %tIndex) #6
...
for.inc40:                                        ; preds = %if.end32, %if.then36
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %tIndex) #6
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %ans) #6
