...
if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi24 = phi double [ %.pre23, %if.then23 ], [ %.pre-phi18, %if.end ]
  %mul30.pre-phi = phi double [ %.pre19, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre13, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre12, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre11, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi24, 0.000000e+00
