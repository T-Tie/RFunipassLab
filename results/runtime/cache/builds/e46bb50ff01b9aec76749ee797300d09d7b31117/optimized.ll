...
for.cond1:                                        ; preds = %for.cond, %for.inc
  ...
  %a1.1 = phi i32 [ %a1.24, %for.inc ], [ %a1.0, %for.cond ]
  %a2.1 = phi i32 [ %a2.26, %for.inc ], [ %a2.0, %for.cond ]
...
land.lhs.true:                                    ; preds = %for.body4
  ...
  %spec.select8 = select i1 %cmp7, i32 %i.0, i32 %a1.1
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %for.body4
  %a2.26 = phi i32 [ %a2.1, %for.body4 ], [ %spec.select, %land.lhs.true ]
  %a1.24 = phi i32 [ %a1.1, %for.body4 ], [ %spec.select8, %land.lhs.true ]
