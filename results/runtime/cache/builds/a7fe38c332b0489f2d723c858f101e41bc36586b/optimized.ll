...
for.cond:                                         ; preds = %if.end11, %entry
  %blank.0 = phi i32 [ 0, %entry ], [ 1, %if.end11 ]
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end11 ]
  %num.0 = phi i32 [ 0, %entry ], [ %conv20, %if.end11 ]
...
if.end11:                                         ; preds = %if.end.thread, %if.then9, %if.end
  %num.15 = phi i32 [ 0, %if.end.thread ], [ %num.1, %if.then9 ], [ %num.1, %if.end ]
  %blank.14 = phi i32 [ 0, %if.end.thread ], [ %blank.1, %if.then9 ], [ %blank.1, %if.end ]
