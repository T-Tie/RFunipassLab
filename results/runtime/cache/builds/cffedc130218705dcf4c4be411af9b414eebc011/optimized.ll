...
if.end56:                                         ; preds = %if.then34, %if.else
  %div47.sink2 = phi double [ %div47, %if.else ], [ 0.000000e+00, %if.then34 ]
  ...
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div47.sink2, double noundef %div54, double noundef %div47.sink2, double noundef %div54)
  br label %for.inc
