...
for.cond5:                                        ; preds = %for.inc19, %for.end
  ...
  %indvars22 = trunc i64 %indvars.iv13 to i32
  %cmp6 = icmp sgt i32 %indvars22, 0
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %indvars.iv.next14 = add nsw i64 %indvars.iv13, -1
  %idxprom9 = and i64 %indvars.iv.next14, 4294967295
  ...
  %idxprom11 = and i64 %indvars.iv13, 2147483647
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end47 ], [ %indvars.iv13, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  %cmp23 = icmp sgt i64 %indvars.iv15, 0
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next16
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv10 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next11, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %cmp30.not = icmp slt i64 %indvars.iv10, %indvars.iv15
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv10
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv10
...
for.end47:                                        ; preds = %for.cond29
  ...
  %8 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next16
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select8 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
