...
if.end:                                           ; preds = %for.end30, %if.else
  %phiofops6 = phi i32 [ %2, %for.end30 ], [ %4, %if.else ]
  %x1.sink = phi ptr [ %x1, %if.else ], [ %x2, %for.end30 ]
  %5 = load i32, ptr %y1, align 4, !tbaa !5
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp32 = icmp slt i32 %5, %6
...
if.end35:                                         ; preds = %if.end, %if.else34
  %phiofops = phi i32 [ %6, %if.end ], [ %5, %if.else34 ]
  %y1.sink = phi ptr [ %y1, %if.else34 ], [ %y2, %if.end ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %if.end35
  %i.2 = phi i32 [ 0, %if.end35 ], [ %inc50, %for.inc49 ]
  %cmp37 = icmp slt i32 %i.2, %phiofops6
...
for.cond39:                                       ; preds = %for.inc46, %for.body38
  ...
  %cmp40 = icmp slt i32 %j.2, %phiofops
...
for.cond52:                                       ; preds = %for.inc83, %for.end51
  ...
  %cmp53 = icmp slt i32 %i.3, %phiofops6
...
for.cond55:                                       ; preds = %for.inc80, %for.body54
  ...
  %cmp56 = icmp slt i32 %j.3, %phiofops
...
for.inc77:                                        ; preds = %for.cond58
  ...
  %7 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  ...
  %8 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  ...
  %9 = load i32, ptr %arrayidx72, align 4, !tbaa !5, !invariant.load !17
  %mul = mul nsw i32 %8, %9
...
for.cond86:                                       ; preds = %for.inc91, %for.end85
  ...
  %cmp87 = icmp slt i32 %i.4, %phiofops6
...
for.cond99:                                       ; preds = %for.inc112, %for.body98
  ...
  %cmp100 = icmp slt i32 %j.4, %phiofops
...
for.body101:                                      ; preds = %for.cond99
  ...
  %10 = load i32, ptr %arrayidx105, align 4, !tbaa !5, !invariant.load !17
  %cmp106 = icmp eq i32 %10, 0
...
if.then107:                                       ; preds = %for.body101
  ...
  %11 = load i32, ptr %arrayidx109, align 4, !tbaa !5
...
for.cond118:                                      ; preds = %for.inc198, %for.end117
  ...
  %cmp119 = icmp slt i32 %i.6, %phiofops6
...
for.body120:                                      ; preds = %for.cond118
  ...
  %12 = load i32, ptr %arrayidx122, align 4, !tbaa !5, !invariant.load !17
  %cmp123 = icmp ne i32 %12, %phiofops
  br i1 %cmp123, label %if.then124, label %if.else151

if.then124:                                       ; preds = %for.body120
  %cmp125 = icmp eq i32 %phiofops6, 100
  br i1 %cmp125, label %land.lhs.true, label %if.else131

land.lhs.true:                                    ; preds = %if.then124
  %cmp126 = icmp eq i32 %phiofops, 100
...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %13 = load i32, ptr %arrayidx133, align 16, !tbaa !5
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %13)
  br label %if.end136
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  %sub140 = sub nsw i32 %phiofops, %14
...
for.inc148:                                       ; preds = %for.cond137
  ...
  %15 = load i32, ptr %arrayidx146, align 4, !tbaa !5
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %15)
...
if.else151:                                       ; preds = %for.body120
  ...
  %16 = load i32, ptr %arrayidx154, align 4, !tbaa !5
  %cmp155 = icmp ne i32 %16, %phiofops
  br i1 %cmp155, label %if.then156, label %if.else173
...
for.cond158:                                      ; preds = %for.inc170, %if.then156
  ...
  %sub162 = sub nsw i32 %phiofops, %16
  %cmp163 = icmp slt i32 %j.6, %sub162
  br i1 %cmp163, label %for.inc170, label %if.end174
...
for.inc170:                                       ; preds = %for.cond158
  ...
  %17 = load i32, ptr %arrayidx168, align 4, !tbaa !5
  %call169 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %17)
  %inc171 = add nsw i32 %j.6, 1
  br label %for.cond158, !llvm.loop !25

if.else173:                                       ; preds = %if.else151
  br label %for.end200

if.end174:                                        ; preds = %for.cond158
  br i1 false, label %for.end200, label %if.end178

if.end178:                                        ; preds = %if.end174, %for.cond137
  %sub179 = sub nsw i32 %phiofops6, 1
...
land.lhs.true181:                                 ; preds = %if.end178
  ...
  %18 = load i32, ptr %arrayidx184, align 4, !tbaa !5
  %cmp185 = icmp ne i32 %18, %phiofops
  br i1 %cmp185, label %if.then195, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true181
  br i1 true, label %land.lhs.true190, label %for.inc198

land.lhs.true190:                                 ; preds = %lor.lhs.false
  ...
  %19 = load i32, ptr %arrayidx193, align 4, !tbaa !5
  %cmp194 = icmp ne i32 %19, %phiofops
...
for.inc198:                                       ; preds = %if.end178, %lor.lhs.false, %land.lhs.true190, %if.then195
  %inc199 = add nsw i32 %i.6, 1
  br label %for.cond118, !llvm.loop !26

for.end200:                                       ; preds = %if.end174, %if.else173, %for.cond118
