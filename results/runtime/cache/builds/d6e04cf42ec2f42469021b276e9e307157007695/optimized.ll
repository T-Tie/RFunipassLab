...
for.end:                                          ; preds = %for.cond
  %y.1.lcssa = phi i32 [ %y.1, %for.cond ]
  ret i32 %y.1.lcssa
}
...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3maxPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(400) %a, i32 noundef %.lcssa, i32 noundef 0)
