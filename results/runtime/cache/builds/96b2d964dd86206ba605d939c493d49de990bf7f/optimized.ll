...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %a) #7
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv6
...
while.end19:                                      ; preds = %while.cond8, %while.cond8
  ...
  call fastcc void @outlined_ir_func_0(i32 noundef %lenq.0, ptr nofree nonnull readonly captures(none) %incdec.ptr23)
...
define internal fastcc void @outlined_ir_func_0(i32 noundef %0, ptr nofree nonnull readonly captures(none) %1) unnamed_addr #5 {
if.then_to_outline:
  %smax = call i32 @llvm.smax.i32(i32 noundef %0, i32 noundef 0) #9
...
for.inc:                                          ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %1, i64 %indvars.iv
  %2 = load i8, ptr %add.ptr27, align 1, !tbaa !5, !invariant.load !13
  %call28 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %2)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
