...
while.cond:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  %indvars.iv6 = phi i32 [ %indvars.iv.next7, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit ], [ -1, %entry ]
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv6, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %while.end
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc ], [ 0, %while.end ]
  %exitcond.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %sentence, i64 0, i64 %indvars.iv3
