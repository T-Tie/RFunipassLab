...
sw.epilog.gvnsink.split:                          ; preds = %LeafBlock, %NodeBlock, %NodeBlock3, %NodeBlock1, %NodeBlock7, %NodeBlock11, %NodeBlock9, %sw.bb47, %sw.bb33, %sw.bb12
  %.sink18 = phi i32 [ 1, %sw.bb12 ], [ 1, %sw.bb33 ], [ 0, %sw.bb47 ], [ 1, %NodeBlock9 ], [ 1, %NodeBlock11 ], [ 1, %NodeBlock7 ], [ 0, %NodeBlock1 ], [ 0, %NodeBlock3 ], [ 0, %NodeBlock ], [ 0, %LeafBlock ]
  %.sink17 = phi i32 [ 1, %sw.bb12 ], [ 0, %sw.bb33 ], [ 1, %sw.bb47 ], [ 2, %NodeBlock9 ], [ 1, %NodeBlock11 ], [ 0, %NodeBlock7 ], [ 2, %NodeBlock1 ], [ 1, %NodeBlock3 ], [ 0, %NodeBlock ], [ 0, %LeafBlock ]
  ...
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %.sink18)
  ...
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call7, i32 noundef %.sink17)
