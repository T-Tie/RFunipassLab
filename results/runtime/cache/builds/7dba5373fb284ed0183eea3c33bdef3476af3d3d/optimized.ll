...
if.end:                                           ; preds = %if.then, %land.lhs.true, %lor.lhs.false
  %4 = phi i32 [ %.pre, %if.then ], [ %storemerge, %land.lhs.true ], [ %storemerge, %lor.lhs.false ]
...
entry:
  ...
  %call16.i = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #8
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %0 = load i64, ptr %_M_width.i5.i, align 8, !tbaa !16, !invariant.load !10
  %1 = add i64 %0, -101
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #8
