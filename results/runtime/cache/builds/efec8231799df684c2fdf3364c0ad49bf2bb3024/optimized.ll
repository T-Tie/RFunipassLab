...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond148.not, label %if.end178.loopexit165, label %for.inc148
...
if.end178.loopexit165:                            ; preds = %for.cond137
  %.pre166 = add nuw nsw i64 %indvars.iv155, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit165
  %.pre.pre-phi = phi i64 [ %.pre166, %if.end178.loopexit165 ], [ %20, %for.cond158 ]
