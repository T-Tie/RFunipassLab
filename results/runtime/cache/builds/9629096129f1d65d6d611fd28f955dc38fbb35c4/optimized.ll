...
for.cond:                                         ; preds = %for.body, %entry
  %i.0 = phi i32 [ %l, %entry ], [ %dec, %for.body ]
...
for.cond:                                         ; preds = %for.body, %entry
  %i.0 = phi i32 [ %t, %entry ], [ %inc, %for.body ]
...
for.cond:                                         ; preds = %if.end72, %if.end17
  %i.0 = phi i32 [ 1, %if.end17 ], [ %inc74, %if.end72 ]
...
for.cond26:                                       ; preds = %if.end40, %if.then25
  ...
  %j.0 = phi i32 [ 1, %if.then25 ], [ %inc, %if.end40 ]
...
if.then52:                                        ; preds = %if.end50
  call void @_Z5rightPcii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(256) %a, i32 noundef %conv, i32 noundef %i.0) #7
  br label %if.end54
...
for.cond58:                                       ; preds = %for.body60, %for.end57
  %j.2 = phi i32 [ 1, %for.end57 ], [ %inc69, %for.body60 ]
