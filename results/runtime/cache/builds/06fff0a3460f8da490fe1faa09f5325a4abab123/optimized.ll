...
if.then8:                                         ; preds = %if.end
  ...
  call fastcc void @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call13.loc) #11
  ...
  call fastcc void @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call19.loc) #11
...
if.then39:                                        ; preds = %if.end37
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call50.loc) #11
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call65.loc) #11
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #10 {
if.then39_after_outline.exitStub:
  ...
  %4 = call double @llvm.fmuladd.f64(double %mul46, double %2, double %neg49) #13
...
; Function Attrs: minsize mustprogress norecurse nounwind optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #10 {
if.then8_after_outline.exitStub:
  ...
  %4 = call double @llvm.fmuladd.f64(double %1, double %1, double %neg12) #13
...
attributes #10 = { minsize mustprogress norecurse nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
