...
for.inc:                                          ; preds = %for.cond4
  %2 = add nuw nsw i64 %indvars.iv, %indvars.iv15
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc42
  %indvars.iv21 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next22, %for.inc42 ]
  %exitcond30.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond30.not, label %for.cond45, label %for.cond21.preheader

for.cond21.preheader:                             ; preds = %for.cond15
  %arrayidx27 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv21
  %arrayidx35 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv21
  br label %for.cond21

for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc39
  %indvars.iv23 = phi i64 [ %indvars.iv21, %for.cond21.preheader ], [ %indvars.iv.next24, %for.inc39 ]
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv.next24
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc63 ], [ 0, %land.end ]
  %z.1 = phi i32 [ %z.2, %for.inc63 ], [ 0, %land.end ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count19
  br i1 %exitcond35.not, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv31
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.012 = phi i32 [ %7, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %k.012)
  %smax39 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
  %wide.trip.count40 = zext nneg i32 %smax39 to i64
  br label %for.cond74

for.cond74:                                       ; preds = %for.inc83, %if.else71
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc83 ], [ 0, %if.else71 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count40
  br i1 %exitcond41.not, label %if.end86, label %for.inc83

for.inc83:                                        ; preds = %for.cond74
  %arrayidx78 = getelementptr inbounds nuw [500 x i32], ptr %c, i64 0, i64 %indvars.iv36
