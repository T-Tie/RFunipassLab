...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc48
  %indvars.iv38 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next39, %for.inc48 ]
  %j.0 = phi i32 [ 0, %for.cond3.preheader ], [ %j.1, %for.inc48 ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond52.preheader, label %for.body6

for.cond52.preheader:                             ; preds = %for.cond3
  %sub56 = add nsw i32 %j.0, -1
  %2 = sext i32 %sub56 to i64
  %smax49 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
  %wide.trip.count50 = zext nneg i32 %smax49 to i64
  br label %for.cond52

for.body6:                                        ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv38
...
if.then:                                          ; preds = %for.body6
  ...
  %inc.i4 = add nsw i32 %j.0, 1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body6
  %j.1 = phi i32 [ %inc.i4, %if.then ], [ %j.0, %for.body6 ]
  %smax36 = call i32 @llvm.smax.i32(i32 %j.1, i32 0)
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc45, %if.end
  %indvars.iv34.in = phi i32 [ %indvars.iv34, %for.inc45 ], [ %j.1, %if.end ]
  %p.0 = phi i32 [ %inc46, %for.inc45 ], [ 0, %if.end ]
  %indvars.iv34 = add i32 %indvars.iv34.in, -1
  %exitcond37.not = icmp eq i32 %p.0, %smax36
  br i1 %exitcond37.not, label %for.inc48, label %for.cond20.preheader

for.cond20.preheader:                             ; preds = %for.cond15
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv34, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc42
  %indvars.iv31 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next32, %for.inc42 ]
  %exitcond.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond.not, label %for.inc45, label %for.body24

for.body24:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv31
  %5 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv.next32
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc66
  %indvars.iv45 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next46, %for.inc66 ]
  %exitcond51.not = icmp eq i64 %indvars.iv45, %wide.trip.count50
  br i1 %exitcond51.not, label %for.end68, label %for.body55

for.body55:                                       ; preds = %for.cond52
  %cmp57 = icmp slt i64 %indvars.iv45, %2
  %arrayidx60 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv45
