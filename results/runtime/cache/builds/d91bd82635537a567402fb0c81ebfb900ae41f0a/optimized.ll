...
for.cond29:                                       ; preds = %for.inc42, %for.body28
  ...
  %5 = load i8, ptr %arrayidx31, align 1, !tbaa !9, !invariant.load !13
...
if.then46:                                        ; preds = %for.end44
  ...
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv48, i32 noundef %7)
  br label %for.inc51
...
for.cond54:                                       ; preds = %for.inc80, %for.end53
  %.sink7 = phi i32 [ 97, %for.end53 ], [ %inc81, %for.inc80 ]
  %cmp55 = icmp sle i32 %.sink7, 122
...
if.then74:                                        ; preds = %for.end72
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef %w75) #4
  %conv76 = trunc i32 %.sink7 to i8
  %conv77 = sext i8 %conv76 to i32
  %call78 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv77, i32 noundef %11)
  store i32 0, ptr %l, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef %w75) #4
  br label %for.inc80

for.inc80:                                        ; preds = %for.end72, %if.then74
  %inc81 = add nsw i32 %.sink7, 1
