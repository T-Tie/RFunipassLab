...
for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !9
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv5, %7
...
for.inc:                                          ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !9, !invariant.load !13
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv5
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv8, %14
