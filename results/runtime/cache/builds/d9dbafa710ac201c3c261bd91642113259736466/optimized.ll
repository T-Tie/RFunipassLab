...
for.end:                                          ; preds = %for.cond
  ...
  %vtable.i = load ptr, ptr %call5, align 8, !tbaa !12, !invariant.load !14
...
_Z5powerii.exit:                                  ; preds = %for.cond.i
  ...
  br i1 %cmp, label %if.then, label %for.cond, !llvm.loop !17
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax14 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %0 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !14
  %div = sdiv i32 %n, %0
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !20, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !38, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !44, !invariant.load !14
  br label %return
