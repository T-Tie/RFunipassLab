...
for.cond:                                         ; preds = %for.inc135, %entry
  ...
  %0 = phi i32 [ %dec, %for.inc135 ], [ %k, %entry ]
  store i32 %k.sink, ptr %b, align 4, !tbaa !5
...
for.body39:                                       ; preds = %for.cond37
  ...
  br i1 %cmp44, label %for.end49.thread, label %for.inc47

for.end49.thread:                                 ; preds = %for.body39
  br label %for.inc88
...
for.inc84:                                        ; preds = %for.cond72
  ...
  %18 = load i32, ptr %arrayidx78, align 4, !tbaa !5
  %19 = load i32, ptr %min, align 4, !tbaa !5
  %sub79 = sub nsw i32 %18, %19
  store i32 %sub79, ptr %arrayidx78, align 4, !tbaa !5
  %inc85 = add nsw i32 %17, 1
  store i32 %inc85, ptr %j, align 4, !tbaa !5
  br label %for.cond72, !llvm.loop !16

for.inc88:                                        ; preds = %for.end49.thread, %for.cond72
  %inc89 = add nsw i32 %10, 1
...
for.end90:                                        ; preds = %for.cond34
  ...
  %21 = load i32, ptr %arrayidx92, align 4, !tbaa !5
...
for.end136:                                       ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %b) #7
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z2jzPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %num, i32 noundef %3) #8
