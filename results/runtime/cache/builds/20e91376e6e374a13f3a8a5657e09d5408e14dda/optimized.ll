...
if.else72:                                        ; preds = %if.else63
  ...
  %13 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 1
  %14 = getelementptr inbounds [99 x double], ptr %13, i64 0, i64 %idxprom52
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %15, double noundef %fneg81, double noundef %15) #8
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %11, double noundef %15, double noundef %11, double noundef %15) #8
  br label %for.inc110
