...
while.body:                                       ; preds = %while.cond
  %call.i2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %a)
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i2, ptr noundef nonnull align 8 dereferenceable(8) %b)
...
if.then:                                          ; preds = %while.body
  ...
  %.pre28 = load double, ptr %a, align 8, !tbaa !5
  %.pre31 = fdiv double %.pre, %.pre28
  %.pre32 = fsub double %.pre31, %div
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %sub10.pre-phi = phi double [ %.pre32, %if.then ], [ %sub, %while.body ]
...
if.then12:                                        ; preds = %if.end
  ...
  %.pre29 = load double, ptr %b, align 8, !tbaa !5
  %.pre30 = load double, ptr %a, align 8, !tbaa !5
  %.pre33 = fdiv double %.pre29, %.pre30
  %.pre34 = fsub double %.pre33, %div
  br label %if.end15

if.end15:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi double [ %.pre34, %if.then12 ], [ %sub10.pre-phi, %if.end ]
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #7
