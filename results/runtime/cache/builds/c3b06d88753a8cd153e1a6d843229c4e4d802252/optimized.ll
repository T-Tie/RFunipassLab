...
for.inc26:                                        ; preds = %for.cond14, %if.then
  %c1.1 = phi i32 [ %j.1, %if.then ], [ %c1.0, %for.cond14 ]
  %r1.1 = phi i32 [ %i.1, %if.then ], [ %r1.0, %for.cond14 ]
  %i.2 = phi i32 [ 9999, %if.then ], [ %i.1, %for.cond14 ]
...
for.inc46:                                        ; preds = %for.cond33, %if.then42
  %r2.1 = phi i32 [ %i.3, %if.then42 ], [ %r2.0, %for.cond33 ]
  %i.4 = phi i32 [ -1, %if.then42 ], [ %i.3, %for.cond33 ]
  %c2.1 = phi i32 [ %j.2, %if.then42 ], [ %c2.0, %for.cond33 ]
