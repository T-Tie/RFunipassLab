...
lor.lhs.false23:                                  ; preds = %lor.lhs.false21
  ...
  br i1 %cmp24, label %if.end, label %if.else27

if.else27:                                        ; preds = %lor.lhs.false23
  br label %if.end

if.end:                                           ; preds = %if.else, %lor.lhs.false13, %lor.lhs.false15, %lor.lhs.false17, %lor.lhs.false19, %lor.lhs.false21, %lor.lhs.false23, %if.else27
  %.sink3 = phi i32 [ 30, %if.else27 ], [ 31, %lor.lhs.false23 ], [ 31, %lor.lhs.false21 ], [ 31, %lor.lhs.false19 ], [ 31, %lor.lhs.false17 ], [ 31, %lor.lhs.false15 ], [ 31, %lor.lhs.false13 ], [ 31, %if.else ]
  br label %for.inc

for.inc:                                          ; preds = %if.then11, %if.end
  %.sink3.sink = phi i32 [ %.sink3, %if.end ], [ 29, %if.then11 ]
  %add28 = add nsw i32 %n1.0, %.sink3.sink
  %inc = add nsw i32 %j.0, 1
  br label %for.cond7, !llvm.loop !9

for.end:                                          ; preds = %for.cond7
  call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, i32 noundef 29, i32 %n1.0)
  br label %for.inc164
...
if.else91:                                        ; preds = %for.body87
  ...
  br i1 %cmp92, label %if.end107, label %lor.lhs.false93

lor.lhs.false93:                                  ; preds = %if.else91
  %cmp94 = icmp eq i32 %j81.0, 3
  br i1 %cmp94, label %if.end107, label %lor.lhs.false95

lor.lhs.false95:                                  ; preds = %lor.lhs.false93
  %cmp96 = icmp eq i32 %j81.0, 5
  br i1 %cmp96, label %if.end107, label %lor.lhs.false97

lor.lhs.false97:                                  ; preds = %lor.lhs.false95
  %cmp98 = icmp eq i32 %j81.0, 7
  br i1 %cmp98, label %if.end107, label %lor.lhs.false99

lor.lhs.false99:                                  ; preds = %lor.lhs.false97
  %cmp100 = icmp eq i32 %j81.0, 8
  br i1 %cmp100, label %if.end107, label %lor.lhs.false101

lor.lhs.false101:                                 ; preds = %lor.lhs.false99
  %cmp102 = icmp eq i32 %j81.0, 10
  br i1 %cmp102, label %if.end107, label %if.else105

if.else105:                                       ; preds = %lor.lhs.false101
  br label %if.end107

if.end107:                                        ; preds = %if.else91, %lor.lhs.false93, %lor.lhs.false95, %lor.lhs.false97, %lor.lhs.false99, %lor.lhs.false101, %if.else105
  %.sink1 = phi i32 [ 30, %if.else105 ], [ 31, %lor.lhs.false101 ], [ 31, %lor.lhs.false99 ], [ 31, %lor.lhs.false97 ], [ 31, %lor.lhs.false95 ], [ 31, %lor.lhs.false93 ], [ 31, %if.else91 ]
  br label %for.inc109

for.inc109:                                       ; preds = %if.then89, %if.end107
  %.sink1.sink = phi i32 [ %.sink1, %if.end107 ], [ 28, %if.then89 ]
  %add106 = add nsw i32 %n182.0, %.sink1.sink
  %inc110 = add nsw i32 %j81.0, 1
  br label %for.cond85, !llvm.loop !12

for.end111:                                       ; preds = %for.cond85
  call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, i32 noundef 28, i32 %n182.0)
  br label %for.inc164
...
define internal void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %0, i32 noundef %1, i32 %2) #3 {
newFuncRoot:
...
if.else36:                                        ; preds = %for.body32
  ...
  br i1 %cmp37, label %if.end54, label %lor.lhs.false38

lor.lhs.false38:                                  ; preds = %if.else36
  %cmp39 = icmp eq i32 %j.1, 3
  br i1 %cmp39, label %if.end54, label %lor.lhs.false40

lor.lhs.false40:                                  ; preds = %lor.lhs.false38
  %cmp41 = icmp eq i32 %j.1, 5
  br i1 %cmp41, label %if.end54, label %lor.lhs.false42

lor.lhs.false42:                                  ; preds = %lor.lhs.false40
  %cmp43 = icmp eq i32 %j.1, 7
  br i1 %cmp43, label %if.end54, label %lor.lhs.false44

lor.lhs.false44:                                  ; preds = %lor.lhs.false42
  %cmp45 = icmp eq i32 %j.1, 8
  br i1 %cmp45, label %if.end54, label %lor.lhs.false46

lor.lhs.false46:                                  ; preds = %lor.lhs.false44
  %cmp47 = icmp eq i32 %j.1, 10
  br i1 %cmp47, label %if.end54, label %lor.lhs.false48

lor.lhs.false48:                                  ; preds = %lor.lhs.false46
  %cmp49 = icmp eq i32 %j.1, 12
  br i1 %cmp49, label %if.end54, label %if.else52

if.else52:                                        ; preds = %lor.lhs.false48
  br label %if.end54

if.end54:                                         ; preds = %if.else36, %lor.lhs.false38, %lor.lhs.false40, %lor.lhs.false42, %lor.lhs.false44, %lor.lhs.false46, %lor.lhs.false48, %if.else52
  %.sink2 = phi i32 [ 30, %if.else52 ], [ 31, %lor.lhs.false48 ], [ 31, %lor.lhs.false46 ], [ 31, %lor.lhs.false44 ], [ 31, %lor.lhs.false42 ], [ 31, %lor.lhs.false40 ], [ 31, %lor.lhs.false38 ], [ 31, %if.else36 ]
  br label %for.inc56

for.inc56:                                        ; preds = %if.then34, %if.end54
  %.sink2.sink = phi i32 [ %.sink2, %if.end54 ], [ %1, %if.then34 ]
  %add53 = add nsw i32 %n2.0, %.sink2.sink
