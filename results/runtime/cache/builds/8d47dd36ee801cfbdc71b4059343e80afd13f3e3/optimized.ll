...
while.cond1:                                      ; preds = %while.cond1.preheader, %while.body4
  ...
  %.pr2 = phi i32 [ %0, %while.body4 ], [ %.pr1, %while.cond1.preheader ]
  %0 = add i32 %.pr2, -50
  %or.cond13 = icmp ult i32 %0, 50
  br i1 %or.cond13, label %while.body4, label %while.cond8.preheader
...
while.cond8:                                      ; preds = %while.cond8.preheader, %while.body13
  ...
  %.pr3 = phi i32 [ %1, %while.body13 ], [ %.pr2, %while.cond8.preheader ]
  %1 = add i32 %.pr3, -20
  %or.cond12 = icmp ult i32 %1, 30
  br i1 %or.cond12, label %while.body13, label %while.cond17.preheader
...
while.cond17:                                     ; preds = %while.cond17.preheader, %while.body22
  ...
  %.pr4 = phi i32 [ %2, %while.body22 ], [ %.pr3, %while.cond17.preheader ]
  %2 = add i32 %.pr4, -10
  %or.cond = icmp ult i32 %2, 10
  br i1 %or.cond, label %while.body22, label %land.end30.preheader
...
land.end30:                                       ; preds = %land.end30.preheader, %while.body31
  ...
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr4, %land.end30.preheader ]
