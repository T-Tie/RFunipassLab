...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %.sink10 = phi i32 [ %0, %for.body29 ], [ %dec, %for.inc40 ]
  %cmp31 = icmp sge i32 %.sink10, 1
...
for.body32:                                       ; preds = %for.cond30
  ...
  %idxprom35 = sext i32 %.sink10 to i64
...
for.inc40:                                        ; preds = %for.body32
  %dec = add nsw i32 %.sink10, -1
  br label %for.cond30, !llvm.loop !16

for.inc42:                                        ; preds = %for.body32, %for.cond30
  %j2.1 = phi i32 [ %j2.0, %for.cond30 ], [ %.sink10, %for.body32 ]
