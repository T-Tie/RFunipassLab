...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %k) #11
...
for.inc74.gvnsink.split:                          ; preds = %if.then, %if.end
  %add.sink6 = phi i32 [ %add, %if.end ], [ %conv, %if.then ]
  %arrayidx68.sink = phi ptr [ %arrayidx68, %if.end ], [ %arrayidx20, %if.then ]
  %idxprom69 = sext i32 %add.sink6 to i64
...
for.cond94:                                       ; preds = %for.inc113, %for.body88
  ...
  %cmp95 = icmp slt i32 %6, %conv93
  br i1 %cmp95, label %for.body96, label %for.inc116

for.body96:                                       ; preds = %for.cond94
  %sub97 = sub nsw i32 %conv93, 1
  %cmp98 = icmp eq i32 %6, %sub97
  %idxprom102 = sext i32 %6 to i64
  %7 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom102
  %8 = load i8, ptr %7, align 1, !tbaa !12, !invariant.load !14
...
if.else106:                                       ; preds = %for.body96
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %8)
  br label %for.inc113

for.inc113:                                       ; preds = %if.then99, %if.else106
  %inc114 = add nsw i32 %6, 1
  store i32 %inc114, ptr %j, align 4, !tbaa !5
  br label %for.cond94, !llvm.loop !15

for.inc116:                                       ; preds = %for.cond94
  %inc117 = add nsw i32 %5, 1
...
for.end118:                                       ; preds = %for.cond86
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %k) #14
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j) #14
