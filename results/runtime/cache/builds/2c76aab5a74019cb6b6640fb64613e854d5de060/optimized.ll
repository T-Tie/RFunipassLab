...
while.cond:                                       ; preds = %while.body, %entry
  %.pr1 = phi i32 [ %sub, %while.body ], [ %.pr, %entry ]
...
while.cond1:                                      ; preds = %while.body4, %while.end
  %.pr2 = phi i32 [ %0, %while.body4 ], [ %.pr1, %while.end ]
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %.pr3 = phi i32 [ %1, %while.body13 ], [ %.pr2, %while.end7 ]
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %.pr4 = phi i32 [ %2, %while.body22 ], [ %.pr3, %while.end16 ]
...
land.end30:                                       ; preds = %while.body31, %while.end25
