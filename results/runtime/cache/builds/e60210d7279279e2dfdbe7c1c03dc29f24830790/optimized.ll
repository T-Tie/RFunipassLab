...
entry:
  ...
  %smax8 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax8, 1
...
for.cond:                                         ; preds = %for.inc17, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc17 ], [ 0, %entry ]
  %exitcond10 = icmp eq i64 %indvars.iv5, %wide.trip.count9
  br i1 %exitcond10, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %smax19 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
...
for.inc:                                          ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv5, i64 %indvars.iv
  store i8 %3, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !11

for.inc17:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv5, i64 %wide.trip.count
...
for.cond21:                                       ; preds = %for.cond21.loopexit, %for.cond21.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond21.loopexit ], [ 0, %for.cond21.preheader ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond21.loopexit ], [ 1, %for.cond21.preheader ]
  %exitcond21.not = icmp eq i64 %indvars.iv16, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond51, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv16
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv16
  br label %for.cond28

for.cond28:                                       ; preds = %for.inc44, %for.body25
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc44 ], [ %indvars.iv11, %for.body25 ]
  %4 = trunc nuw i64 %indvars.iv13 to i32
  %cmp30.not = icmp slt i32 %sub, %4
  br i1 %cmp30.not, label %for.cond21.loopexit, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv13
...
for.cond51:                                       ; preds = %for.cond21, %for.body55
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body55 ], [ 0, %for.cond21 ]
  %max.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond21 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count20
  br i1 %exitcond26.not, label %for.end65, label %for.body55

for.body55:                                       ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv22
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc88 ], [ 0, %if.else ]
  %7 = load i32, ptr %n, align 4, !tbaa !5
  %sub74 = sub nsw i32 %conv, %7
  %8 = sext i32 %sub74 to i64
  %cmp75 = icmp slt i64 %indvars.iv27, %8
  br i1 %cmp75, label %for.body77, label %if.end91

for.body77:                                       ; preds = %for.cond73
  %arrayidx79 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv27
...
if.then81:                                        ; preds = %for.body77
  %arrayidx83 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv27
