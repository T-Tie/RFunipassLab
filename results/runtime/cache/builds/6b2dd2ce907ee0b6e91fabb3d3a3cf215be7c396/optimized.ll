...
for.body25:                                       ; preds = %for.cond23
  ...
  %8 = load i8, ptr %arrayidx28, align 1, !tbaa !9
...
for.body37:                                       ; preds = %for.cond35
  ...
  %10 = load i8, ptr %arrayidx39, align 1, !tbaa !9
...
if.then52:                                        ; preds = %for.end50
  %14 = load i8, ptr %arrayidx28, align 1, !tbaa !9
  %conv55 = sext i8 %14 to i32
  %call56 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %conv55, i32 noundef %13) #8
  br label %for.inc58
