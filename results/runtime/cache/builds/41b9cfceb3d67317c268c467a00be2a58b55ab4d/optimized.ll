...
while.end:                                        ; preds = %while.cond
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %14)
  %15 = load i32, ptr %b, align 4, !tbaa !5
  %call31 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %15)
