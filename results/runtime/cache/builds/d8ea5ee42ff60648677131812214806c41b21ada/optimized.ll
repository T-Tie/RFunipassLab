...
while.end:                                        ; preds = %while.cond
  ...
  %sub7 = sub nsw i32 %2, 2
  br label %for.cond8

for.cond8:                                        ; preds = %for.inc29, %while.end
  %sub7.sink = phi i32 [ %sub7, %while.end ], [ %dec, %for.inc29 ]
  %3 = phi i32 [ %dec, %for.inc29 ], [ %sub7, %while.end ]
  store i32 %sub7.sink, ptr %j, align 4, !tbaa !5
...
for.end43:                                        ; preds = %for.cond31
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %14)
