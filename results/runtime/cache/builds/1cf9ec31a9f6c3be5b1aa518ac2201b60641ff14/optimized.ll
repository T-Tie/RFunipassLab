...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax71 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax47 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count32 = zext nneg i32 %smax47 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.end26
  %indvars.iv29 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next30, %for.end26 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count32
  br i1 %exitcond33.not, label %for.cond31, label %for.cond2
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv29, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc24 ], [ 0, %for.cond16.preheader ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond28.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv29, i64 %indvars.iv24
...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc67 ], [ 0, %for.cond ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count32
  br i1 %exitcond49.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select22, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %wide.trip.count
  br i1 %exitcond38.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv34, i64 %indvars.iv44
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select22 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  br label %for.cond36

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc64 ], [ 0, %for.cond55.preheader ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count
  br i1 %exitcond43.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv39, i64 %indvars.iv44
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count60 = zext nneg i32 %smax71 to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.end91, %for.end69
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.end91 ], [ 2, %for.end69 ]
  %exitcond61.not = icmp eq i64 %indvars.iv55, %wide.trip.count60
  br i1 %exitcond61.not, label %for.cond96, label %for.cond76.preheader
...
for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv50 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next51, %for.inc89 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count
  br i1 %exitcond54.not, label %for.end91, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv55, i64 %indvars.iv50
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv50
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc117 ], [ 2, %for.cond71 ]
  %exitcond73.not = icmp eq i64 %indvars.iv67, %wide.trip.count60
  br i1 %exitcond73.not, label %for.end119, label %for.cond101.preheader
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv62 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next63, %for.inc114 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv62, i64 %indvars.iv67
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv62, i64 %7
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.end ], [ 0, %entry ]
  %exitcond9.not = icmp eq i64 %indvars.iv5, %wide.trip.count8
  br i1 %exitcond9.not, label %for.end11, label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv5, i64 %indvars.iv
