...
for.cond:                                         ; preds = %for.inc195, %entry
  ...
  %min.0 = phi i32 [ undef, %entry ], [ %min.1.lcssa, %for.inc195 ]
...
for.cond15:                                       ; preds = %for.inc191, %for.end14
  %n.0 = phi i32 [ %.lcssa, %for.end14 ], [ %dec, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.end14 ], [ %min.5.lcssa, %for.inc191 ]
...
for.cond19:                                       ; preds = %for.inc56, %for.body18
  ...
  %min.2 = phi i32 [ %min.1, %for.body18 ], [ %min.3.lcssa, %for.inc56 ]
...
for.inc41:                                        ; preds = %if.then, %if.else, %cond.false
...
for.end43:                                        ; preds = %for.cond23
  %min.3.lcssa = phi i32 [ %min.3, %for.cond23 ]
  br label %for.cond45
...
for.end58:                                        ; preds = %for.cond19
  %min.2.lcssa = phi i32 [ %min.2, %for.cond19 ]
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc106, %for.end58
  %k59.0 = phi i32 [ 0, %for.end58 ], [ %inc107, %for.inc106 ]
  %min.5 = phi i32 [ %min.2.lcssa, %for.end58 ], [ %min.6.lcssa, %for.inc106 ]
...
if.then70:                                        ; preds = %for.body68
  ...
  %6 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  br label %for.inc90
...
if.else75:                                        ; preds = %for.body68
  ...
  %7 = load i32, ptr %arrayidx79, align 4, !tbaa !5
...
for.inc90:                                        ; preds = %if.then70, %if.else75, %cond.false86
...
for.end92:                                        ; preds = %for.cond65
  %min.6.lcssa = phi i32 [ %min.6, %for.cond65 ]
  br label %for.cond94
...
for.inc103:                                       ; preds = %for.cond94
  ...
  %sub102 = sub nsw i32 %8, %min.6.lcssa
...
for.end108:                                       ; preds = %for.cond60
  %min.5.lcssa = phi i32 [ %min.5, %for.cond60 ]
...
for.inc195:                                       ; preds = %for.cond15
  %min.1.lcssa = phi i32 [ %min.1, %for.cond15 ]
  %s.0.lcssa = phi i32 [ %s.0, %for.cond15 ]
  %call193 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %s.0.lcssa)
