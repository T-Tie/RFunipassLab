...
for.cond53.preheader:                             ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv75, %1
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  br label %for.cond53

for.body19:                                       ; preds = %for.cond17
  %7 = mul nuw nsw i64 %indvars.iv87, %1
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv82 = phi i64 [ %indvars.iv75, %for.cond39.preheader ], [ %indvars.iv.next83, %for.inc47 ]
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select66, %for.body62 ], [ %11, %for.body55 ]
...
for.body62:                                       ; preds = %for.cond60
  %12 = mul nuw nsw i64 %indvars.iv92, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %12
  %13 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !14
  %spec.select66 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1
  br label %for.cond60, !llvm.loop !18

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv97 = phi i64 [ %indvars.iv75, %for.cond77.preheader ], [ %indvars.iv.next98, %for.inc85 ]
  %exitcond101 = icmp eq i64 %indvars.iv97, %1
  br i1 %exitcond101, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %14 = mul nuw nsw i64 %indvars.iv97, %1
  %gep68 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %14
  %15 = load i32, ptr %gep68, align 4, !tbaa !5, !invariant.load !14
...
for.end90:                                        ; preds = %for.cond53
  ...
  %16 = mul nuw nsw i64 %indvars.iv.next76, %1
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  ...
  %19 = trunc nuw i64 %indvars.iv109 to i32
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %21 = mul nuw nsw i64 %indvars.iv109, %1
