...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv5
...
for.end:                                          ; preds = %for.body4, %for.cond2
  %j.0.lcssa.in = phi i64 [ %indvars.iv, %for.body4 ], [ %indvars.iv5, %for.cond2 ]
  %4 = and i64 %j.0.lcssa.in, 4294967295
  %cmp10 = icmp eq i64 %indvars.iv5, %4
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc43
  ...
  %indvars.iv12 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next13, %for.inc43 ]
  %counter.2 = phi i32 [ %counter.0, %for.cond17.preheader ], [ %counter.3, %for.inc43 ]
  %6 = sext i32 %5 to i64
  %cmp18 = icmp slt i64 %indvars.iv12, %6
  br i1 %cmp18, label %for.cond20.preheader, label %for.end45

for.cond20.preheader:                             ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv12
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc30
  %indvars.iv8 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next9, %for.inc30 ]
  %exitcond11.not = icmp eq i64 %indvars.iv8, %indvars.iv12
  br i1 %exitcond11.not, label %for.end32, label %for.body22

for.body22:                                       ; preds = %for.cond20
  %7 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !9
  %arrayidx26 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
for.end32:                                        ; preds = %for.body22, %for.cond20
  %j.1.lcssa.in = phi i64 [ %indvars.iv8, %for.body22 ], [ %indvars.iv12, %for.cond20 ]
  %9 = and i64 %j.1.lcssa.in, 4294967295
  %cmp33 = icmp eq i64 %indvars.iv12, %9
