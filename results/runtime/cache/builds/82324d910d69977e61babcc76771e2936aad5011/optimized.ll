...
if.then6.i9:                                      ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i14 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
if.then19.i20:                                    ; preds = %land.lhs.true.i15
  %call24.i21 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #11
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28: ; preds = %if.then6.i9, %land.lhs.true.i15, %if.then19.i20, %if.then28.i27
  %call5 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %a) #12
  %conv = trunc i64 %call5 to i32
  %call7 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %b) #12
