...
define dso_local void @_Z2f1Piii(ptr noundef %p, i32 noundef %n, i32 noundef %k) local_unnamed_addr #0 {
entry:
...
if.then15:                                        ; preds = %for.end13
  ...
  call void @_Z2f1Piii(ptr noundef %add.ptr16, i32 noundef %n, i32 noundef %sub17)
  br label %if.end18
...
; Function Attrs: mustprogress uwtable
define dso_local void @_Z2f2Piii(ptr noundef %p, i32 noundef %n, i32 noundef %k) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr %p, align 4, !tbaa !5
  br label %for.cond
...
if.then18:                                        ; preds = %for.end16
  ...
  call void @_Z2f2Piii(ptr noundef %add.ptr19, i32 noundef %n, i32 noundef %sub20)
  br label %if.end21
...
for.cond14:                                       ; preds = %for.inc63, %for.end12
  ...
  %.sink = phi i32 [ %1, %for.end12 ], [ %dec, %for.inc63 ]
  %cmp15 = icmp sgt i32 %.sink, 1
  br i1 %cmp15, label %for.body16, label %for.inc66

for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr noundef %a, i32 noundef %.sink, i32 noundef %.sink)
  call void @_Z2f2Piii(ptr noundef %a, i32 noundef %.sink, i32 noundef %.sink)
