...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv23 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next24, %if.end ]
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.end46
  %indvars.iv30 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next31, %for.end46 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc.i12, %for.end46 ]
...
for.cond22:                                       ; preds = %for.cond22.preheader, %if.end43
  %indvars.iv27 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next28, %if.end43 ]
  %exitcond34.not = icmp eq i64 %indvars.iv27, %wide.trip.count33
  br i1 %exitcond34.not, label %for.end46, label %for.body26
...
for.cond52:                                       ; preds = %for.body54, %for.end49
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body54 ], [ 1, %for.end49 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count42
  br i1 %exitcond43.not, label %cleanup, label %for.body54
