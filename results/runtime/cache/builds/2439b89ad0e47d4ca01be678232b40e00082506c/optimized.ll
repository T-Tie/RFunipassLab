...
LeafBlock21:                                      ; preds = %NodeBlock
  %SwitchLeaf22 = icmp eq i64 %2, 0
  br i1 %SwitchLeaf22, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i64 %2, -1
  br i1 %SwitchLeaf, label %if.else34.i, label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock21
...
if.then6.i:                                       ; preds = %LeafBlock21, %LeafBlock
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc74
  %indvars.iv4 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next5, %for.inc74 ]
...
for.inc74.gvnsink.split:                          ; preds = %if.then44, %if.else58, %if.then
  ...
  %arrayidx60.sink.sink = phi ptr [ %arrayidx20, %if.then ], [ %arrayidx46, %if.else58 ], [ %arrayidx46, %if.then44 ]
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %4 = add i32 %smax18, 1
  %wide.trip.count19 = zext i32 %4 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond20 = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv14
  ...
  %smax11 = call i32 @llvm.smax.i32(i32 %conv93, i32 noundef 0)
  %wide.trip.count12 = zext nneg i32 %smax11 to i64
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond13.not = icmp eq i64 %indvars.iv8, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv8, %5
  %6 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv14, i64 %indvars.iv8
  ...
  br i1 %cmp98, label %if.then99, label %for.inc113
...
for.inc113:                                       ; preds = %for.body96, %if.then99
