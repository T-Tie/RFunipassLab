...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %v) #4
...
for.cond19:                                       ; preds = %for.inc37, %for.body17
  ...
  %7 = load i32, ptr %v.sink, align 4, !tbaa !5
  %add18 = add nsw i32 %7, 1
  store i32 %add18, ptr %k, align 4, !tbaa !5
  %cmp20 = icmp slt i32 %add18, %6
...
for.body45:                                       ; preds = %for.cond43
  ...
  %13 = load i32, ptr %arrayidx47, align 4, !tbaa !5, !invariant.load !12
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13) #5
  %sub = sub nsw i32 %6, 1
  %cmp49 = icmp slt i32 %12, %sub
...
for.end55:                                        ; preds = %for.cond43
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %v) #5
