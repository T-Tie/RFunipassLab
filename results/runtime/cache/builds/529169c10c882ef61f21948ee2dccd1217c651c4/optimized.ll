...
for.cond1:                                        ; preds = %for.inc10, %for.body
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc10 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %if.else, %entry
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count19 = zext nneg i32 %smax34 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc27 ], [ 0, %tailrecurse ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond31.preheader, label %for.body

for.cond31.preheader:                             ; preds = %for.cond
  br label %for.cond31

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv16
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv11 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next12, %for.inc24 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond15.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv16, i64 %indvars.iv11
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc70
  %indvars.iv31 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next32, %for.inc70 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count19
  br i1 %exitcond36.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv31
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select9, %for.body42 ], [ %3, %for.body34 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv21, i64 %indvars.iv31
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %spec.select9 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond39, !llvm.loop !17

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv26 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next27, %for.inc67 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.inc70, label %for.inc67

for.inc67:                                        ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv26, i64 %indvars.iv31
...
for.cond:                                         ; preds = %for.cond10, %entry
  %indvars.iv3 = phi i64 [ 1, %entry ], [ %indvars.iv.next4, %for.cond10 ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count6
  br i1 %exitcond7.not, label %for.end27, label %for.body

for.body:                                         ; preds = %for.cond
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1
  %arrayidx = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv.next4
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %arrayidx2 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv3
  store i32 %0, ptr %arrayidx2, align 4, !tbaa !5
  %arrayidx5 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next4
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv3
...
for.cond10:                                       ; preds = %for.inc, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond, label %for.inc, !llvm.loop !20

for.inc:                                          ; preds = %for.cond10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx20 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next4, i64 %indvars.iv.next
  %2 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %arrayidx24 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
