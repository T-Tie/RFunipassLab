...
for.cond2:                                        ; preds = %for.cond, %for.inc55
  %.pre17 = phi i32 [ %.pre, %for.inc55 ], [ %0, %for.cond ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc55 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.2, %for.inc55 ], [ 0, %for.cond ]
  %csum.0 = phi i64 [ %csum.1, %for.inc55 ], [ 0, %for.cond ]
  %2 = sext i32 %.pre17 to i64
  %cmp3 = icmp slt i64 %indvars.iv10, %2
  br i1 %cmp3, label %for.body4, label %for.end57

for.body4:                                        ; preds = %for.cond2
  %sext = shl i64 %csum.0, 32
  %conv = ashr exact i64 %sext, 32
  %arrayidx6 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv10
...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %indvars.iv.next8.sink = phi i64 [ %indvars.iv.next8, %for.inc25 ], [ %idxprom12, %if.then ]
  %call20.sink = phi ptr [ %call20, %for.inc25 ], [ @_ZSt4cout, %if.then ]
  %arrayidx22 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next8.sink
  ...
  %indvars.iv.next8 = add nsw i64 %indvars.iv.next8.sink, 1
  %cmp18.not.not = icmp slt i64 %indvars.iv.next8.sink, %indvars.iv10
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %indvars.iv.next5.sink = phi i64 [ %indvars.iv.next5, %for.inc44 ], [ %idxprom31, %if.then30 ]
  %call39.sink = phi ptr [ %call39, %for.inc44 ], [ @_ZSt4cout, %if.then30 ]
  %arrayidx41 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next5.sink
  ...
  %indvars.iv.next5 = add nsw i64 %indvars.iv.next5.sink, 1
  %cmp37 = icmp slt i64 %indvars.iv.next5, %indvars.iv10
...
for.inc55.gvnsink.split:                          ; preds = %for.cond17, %for.end46
  %j.2.ph.in = phi i64 [ %indvars.iv.next5, %for.end46 ], [ %indvars.iv.next8, %for.cond17 ]
...
for.inc55:                                        ; preds = %for.inc55.gvnsink.split, %if.end
  %.pre = phi i32 [ %.pre17, %if.end ], [ %.pre.pre, %for.inc55.gvnsink.split ]
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %indvars.iv.next15.sink = phi i64 [ %indvars.iv.next15, %for.inc71 ], [ %idxprom58, %for.end57 ]
  %call66.sink = phi ptr [ %call66, %for.inc71 ], [ @_ZSt4cout, %for.end57 ]
  %arrayidx68 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next15.sink
  ...
  %indvars.iv.next15 = add nsw i64 %indvars.iv.next15.sink, 1
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next15, %4
