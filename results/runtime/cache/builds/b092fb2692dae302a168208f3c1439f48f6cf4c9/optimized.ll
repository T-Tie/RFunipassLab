...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv26
...
while.end19:                                      ; preds = %while.cond8, %while.cond8
  ...
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, i32 %lenq.0, ptr nonnull %incdec.ptr23)
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) initializes((0, 4)) %0, i32 %1, ptr readonly captures(none) %2) unnamed_addr #5 {
if.then_to_outline:
...
for.inc:                                          ; preds = %for.cond
  ...
  %call28 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %4)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
