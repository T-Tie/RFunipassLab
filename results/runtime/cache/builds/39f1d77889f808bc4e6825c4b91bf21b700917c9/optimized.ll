...
for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count20 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.cond69.preheader:                             ; preds = %for.end65
  %wide.trip.count38 = zext i32 %t.tr to i64
  br label %for.cond69
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv40, i64 %indvars.iv33
...
for.inc122:                                       ; preds = %land.lhs.true, %for.body75, %if.then85, %if.else107, %if.then97, %lor.lhs.false.thread
