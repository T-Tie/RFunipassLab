...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc28 ], [ 1, %for.end10 ]
  %6 = load i32, ptr %x2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp13.not = icmp sgt i64 %indvars.iv41, %7
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax51 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count52 = zext nneg i32 %smax51 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc25
  %indvars.iv37 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next38, %for.inc25 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv48 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next49, %for.inc46 ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count52
  br i1 %exitcond53.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax57 = call i32 @llvm.smax.i32(i32 %14, i32 0)
  %wide.trip.count58 = zext nneg i32 %smax57 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv48, i64 %indvars.iv45
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  %indvars.iv66 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next67, %for.inc79 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %wide.trip.count52
  br i1 %exitcond70.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc76
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc76 ], [ 0, %for.cond49 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count
  br i1 %exitcond65.not, label %for.inc79, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv66, i64 %indvars.iv60
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc73
  %indvars.iv54 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next55, %for.inc73 ]
  %exitcond59.not = icmp eq i64 %indvars.iv54, %wide.trip.count58
  br i1 %exitcond59.not, label %for.inc76, label %for.inc73

for.inc73:                                        ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv54
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv54, i64 %indvars.iv60
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv75 = phi i64 [ %indvars.iv.next76, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv75, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv75, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre79, %for.body87 ]
  %indvars.iv71 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next72, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv71, %23
  br i1 %cmp86.not, label %for.inc106, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv71, %24
  %spec.select = select i1 %cmp88.not, ptr @.str.3, ptr @.str.2
  %25 = add nsw i64 %indvars.iv71, -1
  ...
  %.pre79 = load i32, ptr %y2, align 4, !tbaa !5
