...
entry:
  ...
  %smax7 = call i32 @llvm.smax.i32(i32 %x, i32 0)
...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  br i1 %exitcond9.not, label %for.end9, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [150 x i32], ptr %z, i64 %indvars.iv4, i64 %indvars.iv
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 90000, ptr noundef nonnull align 16 captures(none) dereferenceable(90000) %a) #5
  call void @llvm.lifetime.start.p0(i64 noundef 90000, ptr noundef nonnull align 16 captures(none) dereferenceable(90000) %b) #5
...
for.cond:                                         ; preds = %for.inc29, %entry
  ...
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv10, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !9
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv7, %7
...
for.inc:                                          ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !9, !invariant.load !13
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv7
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv10, %14
...
for.inc26:                                        ; preds = %for.end, %land.lhs.true, %if.else23
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.sink.sink, i32 noundef %z.0)
...
for.end31:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef nonnull captures(none) %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 90000, ptr noundef nonnull captures(none) %a) #6
  ret i32 0
}
