...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !28, !invariant.load !12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !29, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !28, !invariant.load !12
  br label %return
