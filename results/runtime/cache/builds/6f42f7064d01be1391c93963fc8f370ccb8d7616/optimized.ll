...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %8 = sext i32 %7 to i64
  %cmp50 = icmp slt i64 %indvars.iv5, %8
...
for.body51:                                       ; preds = %for.cond49
  ...
  %10 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv5
...
if.else72:                                        ; preds = %if.else63
  ...
  %13 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv5
