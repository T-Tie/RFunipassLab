...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 45000, ptr noundef nonnull dereferenceable(45000) %str) #7
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc42
  %6 = phi i32 [ %.pre, %for.inc42 ], [ %0, %for.cond3.preheader ]
  %sum.0 = phi i32 [ %sum.1, %for.inc42 ], [ 0, %for.cond3.preheader ]
  %i2.0 = phi i32 [ %inc43, %for.inc42 ], [ 1, %for.cond3.preheader ]
  %cmp4.not = icmp sgt i32 %i2.0, %6
...
if.then:                                          ; preds = %for.body6
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx9) #8
  ...
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx9) #9
...
if.else:                                          ; preds = %for.body6
  ...
  %call21 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx19) #9
...
if.then25:                                        ; preds = %if.else
  ...
  %call.i.i9 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx19) #8
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx19, i64 noundef %call.i.i9)
  %call34 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx19) #9
...
if.else39:                                        ; preds = %if.else
  %vbase.offset.i17 = load i64, ptr %vbase.offset.ptr.i16, align 8, !invariant.load !9
...
for.end44:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 45000, ptr noundef nonnull %str) #8
  ret i32 0
}
