...
for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc25 ], [ 0, %for.cond12 ]
...
for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv32, i64 %indvars.iv29
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end59
  %indvars.iv45 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next46, %for.end59 ]
  br label %for.cond35

for.cond35:                                       ; preds = %for.cond31, %for.cond39.preheader
  %indvars.iv42 = phi i64 [ 0, %for.cond31 ], [ %indvars.iv.next43, %for.cond39.preheader ]
...
for.cond63:                                       ; preds = %for.end30, %for.end84
  ...
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.end84 ], [ 0, %for.end30 ]
...
if.end.peel:                                      ; preds = %for.cond67.preheader
  %call76.peel = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 undef) #7
  br label %for.cond67

for.cond67:                                       ; preds = %if.end.peel, %if.end
  %indvars.iv35 = phi i64 [ 1, %if.end.peel ], [ %indvars.iv.next36, %if.end ]
  %10 = load i32, ptr %y2, align 4, !tbaa !5
  %11 = sext i32 %10 to i64
  %cmp69.not.not = icmp slt i64 %indvars.iv35, %11
  br i1 %cmp69.not.not, label %if.end, label %for.end84

if.end:                                           ; preds = %for.cond67
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 undef) #7
