; ModuleID = '<stdin>'
source_filename = "/tmp/tmp9067vsb1.cpp"
...
define dso_local void @_Z1fi(i32 noundef %t) local_unnamed_addr #0 {
entry:
  %c = alloca [100 x i8], align 16
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 dereferenceable(100) %c) #8
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef nonnull align 16 dereferenceable(100) %c)
  %cmp = icmp ne i32 %call, -1
  br i1 %cmp, label %if.then, label %if.end5

if.then:                                          ; preds = %entry
  call void @_Z1fi(i32 noundef 0)
  %call2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(100) %c)
  %tobool = icmp ne i32 %t, 0
  br i1 %tobool, label %if.end5, label %if.then3

if.then3:                                         ; preds = %if.then
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext 32)
  br label %if.end5

if.end5:                                          ; preds = %if.then, %if.then3, %entry
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %c) #9
  ret void
}
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) #9
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !11, !invariant.load !8
  ret i32 %0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !23, !invariant.load !8
  ret i64 %0
}
...
!11 = !{!12, !15, i64 32}
!12 = !{!"_ZTSSt8ios_base", !13, i64 8, !13, i64 16, !14, i64 24, !15, i64 28, !15, i64 32, !16, i64 40, !18, i64 48, !10, i64 64, !19, i64 192, !20, i64 200, !21, i64 208}
!13 = !{!"long", !10, i64 0}
!14 = !{!"_ZTSSt13_Ios_Fmtflags", !10, i64 0}
!15 = !{!"_ZTSSt12_Ios_Iostate", !10, i64 0}
