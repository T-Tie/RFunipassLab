...
for.cond30:                                       ; preds = %for.inc40, %if.else29
  ...
  br i1 %cmp31, label %NodeBlock52, label %for.end42

NodeBlock52:                                      ; preds = %for.cond30
  %Pivot53 = icmp slt i32 %m.1, 5
  br i1 %Pivot53, label %NodeBlock36, label %NodeBlock50

NodeBlock50:                                      ; preds = %NodeBlock52
  %Pivot51 = icmp slt i32 %m.1, 10
  br i1 %Pivot51, label %NodeBlock42, label %NodeBlock48

NodeBlock48:                                      ; preds = %NodeBlock50
  %Pivot49 = icmp slt i32 %m.1, 12
  br i1 %Pivot49, label %LeafBlock44, label %LeafBlock46

LeafBlock46:                                      ; preds = %NodeBlock48
  %SwitchLeaf47 = icmp eq i32 %m.1, 12
  br i1 %SwitchLeaf47, label %for.inc40, label %sw.default37

LeafBlock44:                                      ; preds = %NodeBlock48
  %SwitchLeaf45 = icmp eq i32 %m.1, 10
  br i1 %SwitchLeaf45, label %for.inc40, label %sw.default37

NodeBlock42:                                      ; preds = %NodeBlock50
  %Pivot43 = icmp slt i32 %m.1, 7
  br i1 %Pivot43, label %LeafBlock38, label %LeafBlock40

LeafBlock40:                                      ; preds = %NodeBlock42
  %SwitchLeaf41 = icmp sle i32 %m.1, 8
  br i1 %SwitchLeaf41, label %for.inc40, label %sw.default37

LeafBlock38:                                      ; preds = %NodeBlock42
  %SwitchLeaf39 = icmp eq i32 %m.1, 5
  br i1 %SwitchLeaf39, label %for.inc40, label %sw.default37

NodeBlock36:                                      ; preds = %NodeBlock52
  %Pivot37 = icmp slt i32 %m.1, 2
  br i1 %Pivot37, label %LeafBlock30, label %NodeBlock34

NodeBlock34:                                      ; preds = %NodeBlock36
  %Pivot35 = icmp slt i32 %m.1, 3
  br i1 %Pivot35, label %for.inc40, label %LeafBlock32

LeafBlock32:                                      ; preds = %NodeBlock34
  %SwitchLeaf33 = icmp eq i32 %m.1, 3
  br i1 %SwitchLeaf33, label %for.inc40, label %sw.default37

LeafBlock30:                                      ; preds = %NodeBlock36
  %SwitchLeaf31 = icmp eq i32 %m.1, 1
  br i1 %SwitchLeaf31, label %for.inc40, label %sw.default37

sw.default37:                                     ; preds = %LeafBlock46, %LeafBlock44, %LeafBlock40, %LeafBlock38, %LeafBlock32, %LeafBlock30
  br label %for.inc40

for.inc40:                                        ; preds = %NodeBlock34, %LeafBlock46, %LeafBlock44, %LeafBlock40, %LeafBlock38, %LeafBlock32, %LeafBlock30, %sw.default37
  %.sink = phi i32 [ 30, %sw.default37 ], [ 31, %LeafBlock30 ], [ 31, %LeafBlock32 ], [ 31, %LeafBlock38 ], [ 31, %LeafBlock40 ], [ 31, %LeafBlock44 ], [ 31, %LeafBlock46 ], [ 28, %NodeBlock34 ]
