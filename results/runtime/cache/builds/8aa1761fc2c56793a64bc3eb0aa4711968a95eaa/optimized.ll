...
for.cond12:                                       ; preds = %for.end27, %for.end10
  ...
  %sub13 = sub nsw i32 %7, 1
  %cmp14 = icmp sle i32 %6, %sub13
...
for.cond31:                                       ; preds = %for.end59, %for.end30
  ...
  %sub32 = sub nsw i32 %12, 1
  %cmp33 = icmp sle i32 %14, %sub32
...
for.cond35:                                       ; preds = %for.inc57, %for.body34
  ...
  %sub36 = sub nsw i32 %13, 1
  %cmp37 = icmp sle i32 %15, %sub36
...
for.body41:                                       ; preds = %for.cond39
  ...
  %19 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !13
  ...
  %21 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !13
...
for.cond63:                                       ; preds = %for.end84, %for.end62
  ...
  %sub64 = sub nsw i32 %25, 1
  %cmp65 = icmp sle i32 %24, %sub64
...
for.cond67:                                       ; preds = %if.end, %for.body66
  %26 = phi i32 [ %.pr, %if.end ], [ 0, %for.body66 ]
  %27 = load i32, ptr %y2, align 4, !tbaa !5
  %sub68 = sub nsw i32 %27, 1
  %cmp69 = icmp sle i32 %26, %sub68
...
if.end:                                           ; preds = %for.body70, %if.else
  ...
  %29 = load i32, ptr %arrayidx80, align 4, !tbaa !5, !invariant.load !13
  %call81 = call i32 (ptr, ...) @printf(ptr noundef %.str.2.sink, i32 noundef %29)
