...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv5, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc24
  %indvars.iv12 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next13, %for.inc24 ]
  ...
  br i1 %exitcond17, label %for.cond27.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv8 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next9, %for.inc21 ]
  %exitcond = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond, label %for.inc24, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv12, i64 %indvars.iv8
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc42
  %indvars.iv19 = phi i64 [ %7, %for.cond27.preheader ], [ %indvars.iv.next20, %for.inc42 ]
  %i2.0 = phi i32 [ undef, %for.cond27.preheader ], [ %i2.1, %for.inc42 ]
  %j2.0 = phi i32 [ undef, %for.cond27.preheader ], [ %j2.1, %for.inc42 ]
  %10 = trunc nuw i64 %indvars.iv19 to i32
  %cmp28 = icmp sgt i32 %10, 0
  br i1 %cmp28, label %for.cond30, label %for.end44

for.cond30:                                       ; preds = %for.cond27, %for.inc40
  %.sink1 = phi i32 [ %dec, %for.inc40 ], [ %0, %for.cond27 ]
  %cmp31 = icmp sgt i32 %.sink1, 0
  br i1 %cmp31, label %for.body32, label %for.inc42

for.body32:                                       ; preds = %for.cond30
  %idxprom35 = zext nneg i32 %.sink1 to i64
  %arrayidx36 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv19, i64 %idxprom35
