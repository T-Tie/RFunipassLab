...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %cash) #6
  ...
  call void @outlined_ir_func_0(ptr %call4, ptr null, i32 -1)
...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  %vbase.offset.i233 = load i64, ptr %vbase.offset.ptr.i232, align 8
  ...
  call void @outlined_ir_func_0(ptr %call73, ptr null, i32 -1)
  br label %sw.epilog
...
if.then:                                          ; preds = %sw.epilog
  ...
  call void @outlined_ir_func_0(ptr %call75, ptr %call.i.i251.loc, i32 0)
...
if.else:                                          ; preds = %sw.epilog
  ...
  %vbase.offset.i261 = load i64, ptr %vbase.offset.ptr.i260, align 8
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @outlined_ir_func_0(ptr %call81.sink287, ptr null, i32 -1)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %cash) #6
  ret i32 0
}
...
define internal void @outlined_ir_func_0(ptr %0, ptr %1, i32 %2) #5 {
newFuncRoot:
