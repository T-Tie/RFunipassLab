...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 %array) #5
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax44 = call range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx23 = getelementptr inbounds [100 x [100 x i32]], ptr %array, i64 0, i64 %indvars.iv47, i64 %idxprom33
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.body30
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body30 ], [ 0, %for.cond28.preheader ]
  %min.0 = phi i32 [ %spec.select26, %for.body30 ], [ %indvars49, %for.cond28.preheader ]
  %exitcond46.not = icmp eq i64 %indvars.iv40, %wide.trip.count52
  %8 = zext i32 %min.0 to i64
...
for.body30:                                       ; preds = %for.cond28
  ...
  %arrayidx38 = getelementptr inbounds [100 x [100 x i32]], ptr %array, i64 0, i64 %8, i64 %idxprom33
  %10 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %cmp39 = icmp slt i32 %9, %10
  %11 = trunc nuw nsw i64 %indvars.iv40 to i32
  %spec.select26 = select i1 %cmp39, i32 %11, i32 %min.0
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  br label %for.cond28, !llvm.loop !14

for.end44:                                        ; preds = %for.cond28
  %cmp45 = icmp eq i64 %indvars.iv47, %8
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br i1 %cmp45, label %if.then46, label %for.cond10, !llvm.loop !15

if.then46:                                        ; preds = %for.end44
  %call47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %indvars49, i32 noundef %m.0) #6
...
if.then56:                                        ; preds = %for.end54
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3) #6
  br label %if.end58
...
if.end58:                                         ; preds = %if.then56, %for.end54
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %array) #6
  ret i32 0
}
