...
if.then:                                          ; preds = %while.body5
  ...
  %2 = load i64, ptr %gep, align 8, !tbaa !15, !invariant.load !14
...
if.else:                                          ; preds = %while.body5
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i1)
  store i8 32, ptr %__c.addr.i1, align 1, !tbaa !10
  %vbase.offset.i4 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !14
  %gep29 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i4
  %3 = load i64, ptr %gep29, align 8, !tbaa !15, !invariant.load !14
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit13: ; preds = %if.then.i8, %if.end.i11
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i1)
...
while.cond10:                                     ; preds = %while.cond10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit13
  ...
  br i1 %cmp12, label %while.cond10, label %if.end, !llvm.loop !26
...
while.end16:                                      ; preds = %while.cond2
  %vbase.offset.i17 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !14
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !28, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !10, !invariant.load !14
  br label %return
...
!28 = !{!29, !33, i64 240}
!29 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !16, i64 0, !30, i64 216, !8, i64 224, !31, i64 225, !32, i64 232, !33, i64 240, !34, i64 248, !35, i64 256}
