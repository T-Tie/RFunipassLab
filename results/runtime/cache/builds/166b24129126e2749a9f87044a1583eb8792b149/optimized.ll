...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull %a) #9
...
if.else14:                                        ; preds = %if.end.thread
  ...
  %call.i.i10 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
  br label %if.end19
...
if.then25:                                        ; preds = %if.end, %if.end.thread
  call void @outlined_ir_func_0()
  %call.i.i18 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %a) #10
  ret i32 0
}
