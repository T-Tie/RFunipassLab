...
if.then50:                                        ; preds = %for.body44
  %sub55 = sub nsw i32 %5, %min.0.lcssa
...
if.then100:                                       ; preds = %for.body94
  %sub105 = sub nsw i32 %8, %min.2.lcssa
