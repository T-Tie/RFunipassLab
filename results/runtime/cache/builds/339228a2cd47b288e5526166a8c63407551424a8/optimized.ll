...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv130 = phi i64 [ %indvars.iv.next131, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv130, %2
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv130, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv196 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next197, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv196 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv141 = phi i64 [ %indvars.iv.next142, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond145.not = icmp eq i64 %indvars.iv141, %indvars.iv196
  br i1 %exitcond145.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv141
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv133 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next134, %for.inc41 ]
  %min.3 = phi i32 [ %min.2, %for.cond23.preheader ], [ %min.4, %for.inc41 ]
  %exitcond.not = icmp eq i64 %indvars.iv133, %indvars.iv196
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv133, 0
...
if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv141, i64 %indvars.iv133
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv136 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next137, %for.inc53 ]
  %exitcond140.not = icmp eq i64 %indvars.iv136, %indvars.iv196
  br i1 %exitcond140.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv141, i64 %indvars.iv136
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv156 = phi i64 [ %indvars.iv.next157, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond160.not = icmp eq i64 %indvars.iv156, %indvars.iv196
  br i1 %exitcond160.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv156
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv146 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next147, %for.inc90 ]
  %min.6 = phi i32 [ %min.5, %for.cond65.preheader ], [ %min.7, %for.inc90 ]
  %exitcond150.not = icmp eq i64 %indvars.iv146, %indvars.iv196
  br i1 %exitcond150.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv146, 0
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv146, i64 %indvars.iv156
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %spec.select128 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select128, %if.else75 ]
  %indvars.iv.next147 = add nuw nsw i64 %indvars.iv146, 1
  br label %for.cond65, !llvm.loop !16

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv151 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next152, %for.inc103 ]
  %exitcond155.not = icmp eq i64 %indvars.iv151, %indvars.iv196
  br i1 %exitcond155.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv151, i64 %indvars.iv156
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv166 = phi i64 [ %indvars.iv.next167, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond170.not = icmp eq i64 %indvars.iv166, %indvars.iv196
  br i1 %exitcond170.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv161 = phi i64 [ %indvars.iv.next162, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond165.not = icmp eq i64 %indvars.iv161, %indvars.iv196
  br i1 %exitcond165.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv166, i64 %indvars.iv161
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv166, i64 %indvars.iv161
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv171 = phi i64 [ %indvars.iv.next172, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond176.not = icmp eq i64 %indvars.iv171, %indvars.iv196
  br i1 %exitcond176.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv171
  %15 = load i32, ptr %arrayidx141, align 16, !tbaa !5
  %16 = add nsw i64 %indvars.iv171, -1
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv177 = phi i64 [ %indvars.iv.next178, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond182.not = icmp eq i64 %indvars.iv177, %indvars.iv196
  br i1 %exitcond182.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv177
  %17 = load i32, ptr %arrayidx157, align 4, !tbaa !5
  %18 = add nsw i64 %indvars.iv177, -1
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv189 = phi i64 [ %indvars.iv.next190, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond194.not = icmp eq i64 %indvars.iv189, %indvars.iv196
  br i1 %exitcond194.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %19 = add nsw i64 %indvars.iv189, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv183 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next184, %for.inc185 ]
  %exitcond188.not = icmp eq i64 %indvars.iv183, %indvars.iv196
  br i1 %exitcond188.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv189, i64 %indvars.iv183
  %20 = load i32, ptr %arrayidx178, align 4, !tbaa !5
  %21 = add nsw i64 %indvars.iv183, -1
