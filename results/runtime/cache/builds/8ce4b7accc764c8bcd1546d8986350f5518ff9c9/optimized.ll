...
for.cond2.preheader:                              ; preds = %for.cond
  %smax60 = call i64 @llvm.smax.i64(i64 %1, i64 noundef 0)
  br label %for.cond2
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %Pivot, label %LeafBlock, label %LeafBlock58

LeafBlock58:                                      ; preds = %for.body
  %SwitchLeaf59 = icmp eq i64 %2, 0
  %vbase.offset9.i.pre61 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !9
  br i1 %SwitchLeaf59, label %do.end.i, label %if.then6.i
...
do.end.i:                                         ; preds = %LeafBlock58
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i.pre61
...
if.then6.i:                                       ; preds = %LeafBlock.if.then6.i_crit_edge, %LeafBlock58
  %vbase.offset9.i = phi i64 [ %vbase.offset9.i.pre, %LeafBlock.if.then6.i_crit_edge ], [ %vbase.offset9.i.pre61, %LeafBlock58 ]
...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end73
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %if.end73 ], [ 0, %for.cond2.preheader ]
  %j.0 = phi i32 [ %j.1, %if.end73 ], [ 0, %for.cond2.preheader ]
  %k.0 = phi i32 [ %k.1, %if.end73 ], [ 0, %for.cond2.preheader ]
  %idxprom77 = sext i32 %k.0 to i64
  %exitcond.not63 = icmp eq i64 %indvars.iv45, %smax60
  br i1 %exitcond.not63, label %for.end76, label %for.body4
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax55 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %4 = add i32 %smax55, 1
  %wide.trip.count56 = zext i32 %4 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.end115, %for.end76
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.end115 ], [ 0, %for.end76 ]
...
for.cond94:                                       ; preds = %if.end112, %for.body88
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %if.end112 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond.not, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv48, %5
  %6 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv51, i64 %indvars.iv48
  %7 = load i8, ptr %6, align 1, !tbaa !24, !invariant.load !9
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %7)
