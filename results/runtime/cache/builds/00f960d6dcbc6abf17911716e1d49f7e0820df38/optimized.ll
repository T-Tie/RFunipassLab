...
for.cond:                                         ; preds = %if.end, %entry
  %p.0 = phi ptr [ @a, %entry ], [ %incdec.ptr, %if.end ]
...
if.then:                                          ; preds = %land.lhs.true, %for.body
  %arrayidx8 = getelementptr inbounds [100 x i8], ptr @a, i64 0, i64 %idxprom
...
; Function Attrs: mustprogress uwtable
define available_externally noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #0 align 2 {
entry:
