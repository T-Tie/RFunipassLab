...
entry:
  ...
  %0 = mul i64 %call, 4294967296
  %sext = add i64 %0, -4294967296
  %1 = ashr exact i64 %sext, 32
  br label %for.cond

for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc11 ], [ %call, %entry ]
...
for.body:                                         ; preds = %for.cond
  %idxprom = and i64 %indvars.iv.next5, 4294967295
...
for.cond3.preheader:                              ; preds = %for.body
  %4 = sext i32 %pre.0 to i64
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %indvars.iv1 = phi i64 [ %indvars.iv, %for.cond3.preheader ], [ %indvars.iv.next2, %for.inc ]
  %indvars.iv.next2 = add nsw i64 %indvars.iv1, 1
  %cmp4 = icmp slt i64 %indvars.iv.next2, %4
  br i1 %cmp4, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds [110 x i8], ptr @s, i64 0, i64 %indvars.iv.next2
  %5 = load i8, ptr %arrayidx8, align 1, !tbaa !5
  %call9 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %5)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv7 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next8, %for.inc21 ]
...
for.inc21:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv7
  %6 = load i8, ptr %arrayidx19, align 1, !tbaa !5
  %call20 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %6)
