...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %if.then19.i, %if.then28.i
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %initial) #9
...
while.body:                                       ; preds = %while.cond
  ...
  %vbase.offset9.i17 = load i64, ptr %vbase.offset.ptr8.i16, align 8, !invariant.load !8
  ...
  %vbase.offset14.i22 = load i64, ptr %vbase.offset.ptr13.i21, align 8, !invariant.load !8
  ...
  %6 = load i32, ptr %_M_streambuf_state.i.i.i24, align 8, !tbaa !22
  %cmp.i.i25 = icmp eq i32 %6, 0
  %7 = add i64 %5, -42
  %or.cond.i29 = icmp ult i64 %7, -41
  %or.cond73 = select i1 %cmp.i.i25, i1 %or.cond.i29, i1 false
  br i1 %or.cond73, label %if.then19.i30, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42

if.then19.i30:                                    ; preds = %while.body
  %_M_streambuf.i.i31 = getelementptr inbounds nuw i8, ptr %add.ptr15.i23, i64 232
  %8 = load ptr, ptr %_M_streambuf.i.i31, align 8, !tbaa !23
  %call25.i32 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %8)
  %cmp.i6.i33 = icmp eq i32 %call25.i32, -1
  %conv.i34 = zext i1 %cmp.i6.i33 to i64
  %expval.i35 = call i64 @llvm.expect.i64(i64 %conv.i34, i64 1)
  %tobool.not.i36 = icmp eq i64 %expval.i35, 0
  br i1 %tobool.not.i36, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42, label %if.then28.i37

if.then28.i37:                                    ; preds = %if.then19.i30
  ...
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42: ; preds = %while.body, %if.then19.i30, %if.then28.i37
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42
  %vtable.i60 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !5
  %vbase.offset.ptr.i61 = getelementptr i8, ptr %vtable.i60, i64 -24
  %vbase.offset.i62 = load i64, ptr %vbase.offset.ptr.i61, align 8, !invariant.load !8
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit42
  %call1.i51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %count.1 = phi i32 [ %conv10, %if.then ], [ %add, %if.else ]
  %mark.1 = phi i32 [ %t.0, %if.then ], [ %mark.0, %if.else ]
  %call.i.i53 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %word) #9
  %call1.i54 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(41) %word, i64 noundef %call.i.i53)
...
while.end:                                        ; preds = %while.cond
  ...
  %vbase.offset.i69 = load i64, ptr %vbase.offset.ptr.i68, align 8, !invariant.load !8
