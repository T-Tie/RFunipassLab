...
if.end19:                                         ; preds = %if.then11, %if.else14
  ...
  %1 = phi i32 [ %add7, %if.else14 ], [ %add, %if.then11 ]
  %cmp20 = icmp eq i32 %1, 80
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  %i.1 = phi i32 [ 0, %if.end23.thread ], [ 1, %if.then25 ], [ %inc, %if.end19 ]
  %sum.2 = phi i32 [ 0, %if.end23.thread ], [ %conv, %if.then25 ], [ %sum.1, %if.end19 ]
...
while.end:                                        ; preds = %while.cond, %land.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef captures(none) %a) #13
  ret i32 0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !26, !invariant.load !8
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !27, !invariant.load !8
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !26, !invariant.load !8
  br label %return
