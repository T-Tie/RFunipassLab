...
land.lhs.true:                                    ; preds = %for.body
  ...
  br i1 %or.cond10, label %if.then, label %for.inc
...
for.cond25:                                       ; preds = %for.inc36, %if.end24
  %storemerge8 = phi i32 [ 65, %if.end24 ], [ %inc37, %for.inc36 ]
...
for.inc36:                                        ; preds = %for.body27, %if.then31
  %7 = phi i32 [ %storemerge8, %for.body27 ], [ %.pre12, %if.then31 ]
  %inc37 = add nsw i32 %7, 1
  br label %for.cond25, !llvm.loop !13

for.cond39:                                       ; preds = %for.cond25, %for.inc50
  %storemerge9 = phi i32 [ %inc51, %for.inc50 ], [ 97, %for.cond25 ]
...
for.inc50:                                        ; preds = %for.body41, %if.then45
  %9 = phi i32 [ %storemerge9, %for.body41 ], [ %.pre, %if.then45 ]
