...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 16000, ptr noundef align 16 %sv) #5
...
for.end9:                                         ; preds = %for.cond
  ...
  %5 = load double, ptr %sv, align 16, !tbaa !9
  %div = fdiv double %4, %5
...
for.body16:                                       ; preds = %for.cond14
  ...
  %8 = load double, ptr %arrayidx19, align 8, !tbaa !9, !invariant.load !11
  %9 = load double, ptr %arrayidx18, align 16, !tbaa !9, !invariant.load !11
  %div23 = fdiv double %8, %9
...
if.end58:                                         ; preds = %land.lhs.true44, %land.lhs.true, %if.else56
  ...
  %call57 = call i32 (ptr, ...) @printf(ptr noundef %.str.3.sink) #6
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #6
  br label %for.cond14

for.end61:                                        ; preds = %for.cond14
  call void @llvm.lifetime.end.p0(i64 noundef 16000, ptr noundef %sv) #6
