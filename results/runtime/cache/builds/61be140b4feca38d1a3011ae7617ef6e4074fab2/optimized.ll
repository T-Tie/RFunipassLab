...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %if.then19.i, %if.then28.i
  %vtable = phi ptr [ %vtable12.i, %while.cond ], [ %vtable.pre47, %if.then19.i ], [ %vtable.pre, %if.then28.i ]
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8
  %gep46 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 32), i64 %vbase.offset
  %4 = load i32, ptr %gep46, align 8, !tbaa !21
  %and.i.i.i = and i32 %4, 5
  %cmp.i.not.i = icmp eq i32 %and.i.i.i, 0
  %5 = load i32, ptr %n, align 4
  %cmp = icmp sgt i32 %5, 0
  %6 = select i1 %cmp.i.not.i, i1 %cmp, i1 false
...
while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %add = add i32 %sum.0, %add7
  %sum.1 = add i32 %add, %conv
  %cmp8 = icmp slt i32 %sum.1, 81
  br i1 %cmp8, label %if.then9, label %if.then25

if.then9:                                         ; preds = %while.body
  br i1 %cmp5, label %if.else14, label %if.end19
...
if.else14:                                        ; preds = %if.then9
  ...
  %call.i.i16 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #5
  br label %if.end19

if.end19:                                         ; preds = %if.then9, %if.else14
  %call4.sink = phi i64 [ %call.i.i16, %if.else14 ], [ %call4, %if.then9 ]
...
if.then21:                                        ; preds = %if.end19
  %vtable.i29 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !5
...
if.then25:                                        ; preds = %while.body
  %vtable.i36 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !5
  ...
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i39, i8 noundef signext 10)
  %call1.i40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
  ...
  %call.i.i23 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #5
  %call1.i24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %a, i64 noundef %call.i.i23)
  br label %if.end29

if.end29:                                         ; preds = %if.end19, %if.then21, %if.then25
  %i.2 = phi i32 [ 1, %if.then25 ], [ %inc, %if.end19 ], [ 0, %if.then21 ]
  %sum.3 = phi i32 [ %conv, %if.then25 ], [ %sum.1, %if.end19 ], [ 0, %if.then21 ]
  %7 = load i32, ptr %n, align 4, !tbaa !31
  %dec = add nsw i32 %7, -1
