...
for.inc16:                                        ; preds = %for.cond1
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call14, i8 noundef signext %call.i7)
...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax84 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %smax60 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count45 = zext nneg i32 %smax60 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv42
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv37 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next38, %for.inc21 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv42, i64 %indvars.iv37
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv57 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next58, %for.inc60 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count45
  br i1 %exitcond62.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv57
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select35, %for.body34 ], [ %3, %for.body29 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond51.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv57
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select35 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br label %for.cond32, !llvm.loop !20

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv52 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next53, %for.inc57 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv57
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv68 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next69, %for.inc83 ]
  %exitcond74.not = icmp eq i64 %indvars.iv68, %wide.trip.count73
  br i1 %exitcond74.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv63 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next64, %for.inc80 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond67.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv68, i64 %indvars.iv63
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv63
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv80 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next81, %for.inc104 ]
  %exitcond86.not = icmp eq i64 %indvars.iv80, %wide.trip.count73
  br i1 %exitcond86.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv80, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv75 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next76, %for.inc101 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count
  br i1 %exitcond79.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv75, i64 %indvars.iv80
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv75, i64 %9
