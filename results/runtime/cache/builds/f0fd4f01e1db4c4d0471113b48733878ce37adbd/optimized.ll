...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax45 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
  %wide.trip.count15 = zext nneg i32 %smax45 to i64
...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond16.not, label %for.cond28, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc22 ], [ 0, %for.cond11.preheader ]
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc63 ], [ 0, %for.cond ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc60 ], [ 0, %for.cond48.preheader ]
...
for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc125 ], [ 0, %if.end68 ]
  %exitcond47.not = icmp eq i64 %indvars.iv40, %wide.trip.count15
