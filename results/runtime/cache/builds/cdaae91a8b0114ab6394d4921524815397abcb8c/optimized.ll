...
for.end20:                                        ; preds = %for.body7, %for.cond5
  ...
  %sub21 = sub nsw i32 %7, 1
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc57, %for.end20
  %sub21.sink = phi i32 [ %sub21, %for.end20 ], [ %dec58, %for.inc57 ]
  %8 = phi i32 [ %dec58, %for.inc57 ], [ %sub21, %for.end20 ]
  store i32 %sub21.sink, ptr %j, align 4, !tbaa !5
  %cmp23 = icmp sge i32 %8, 0
...
for.end72:                                        ; preds = %for.cond60
  ...
  %call73 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %22)
