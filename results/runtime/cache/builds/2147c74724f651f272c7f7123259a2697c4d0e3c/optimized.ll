...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %2 = phi i32 [ %.pre52, %for.inc ], [ %0, %for.cond1.preheader ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc19
  %indvars.iv32 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next33, %for.inc19 ]
  %exitcond.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond.not, label %for.end22.loopexit, label %for.body13
...
for.end22.loopexit:                               ; preds = %for.cond10
  br label %for.end22

for.end22:                                        ; preds = %for.end22.loopexit, %for.body13.for.end22_crit_edge
  %idxprom26.pre-phi = phi i64 [ %.pre53, %for.body13.for.end22_crit_edge ], [ %wide.trip.count, %for.end22.loopexit ]
  %j.1.lcssa = phi i32 [ %5, %for.body13.for.end22_crit_edge ], [ %smax, %for.end22.loopexit ]
...
for.cond23:                                       ; preds = %for.inc33, %for.end22
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc33 ], [ %idxprom26.pre-phi, %for.end22 ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.end35.loopexit, label %for.body25
...
for.end35.loopexit:                               ; preds = %for.cond23
  br label %for.end35

for.end35:                                        ; preds = %for.end35.loopexit, %for.end35.split.loop.exit
  %j.2.lcssa = phi i32 [ %7, %for.end35.split.loop.exit ], [ %smax41, %for.end35.loopexit ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc46, %for.end35
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc46 ], [ %idxprom26.pre-phi, %for.end35 ]
  %exitcond51.not = icmp eq i64 %indvars.iv45, %wide.trip.count43
  br i1 %exitcond51.not, label %for.end48.loopexit, label %for.body38
...
for.end48.loopexit:                               ; preds = %for.cond36
  br label %for.end48

for.end48:                                        ; preds = %for.end48.loopexit, %for.end48.split.loop.exit
  %i.2.lcssa = phi i32 [ %9, %for.end48.split.loop.exit ], [ %smax41, %for.end48.loopexit ]
  %reass.sub = sub nsw i32 %j.2.lcssa, %j.1.lcssa
  %sub50 = add i32 %reass.sub, -2
  %reass.sub27 = sub nsw i32 %i.2.lcssa, %j.1.lcssa
  %sub51 = add i32 %reass.sub27, -2
