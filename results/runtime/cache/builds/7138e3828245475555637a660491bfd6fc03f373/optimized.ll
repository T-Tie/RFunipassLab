...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 5000, ptr noundef nonnull align 16 captures(none) dereferenceable(5000) %str1) #7
...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc32 ], [ 0, %entry ]
  %indvars.iv = phi i32 [ %indvars.iv.next, %for.inc32 ], [ %conv, %entry ]
  %len.0 = phi i32 [ %len.1, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax28 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count29 = zext nneg i32 %smax28 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv19
...
if.then9:                                         ; preds = %if.end
  ...
  %5 = trunc nuw nsw i64 %indvars.iv19 to i32
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv16, %6
...
for.cond47:                                       ; preds = %for.cond35, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %for.cond35 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond35.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv31
