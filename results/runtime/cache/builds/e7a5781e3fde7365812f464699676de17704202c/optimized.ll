...
for.end61:                                        ; preds = %for.body40, %for.end50, %for.cond34
  %y2.0 = phi i32 [ 0, %for.end50 ], [ 0, %for.cond34 ], [ %sub37.sink, %for.body40 ]
  %x2.0 = phi i32 [ 0, %for.end50 ], [ 0, %for.cond34 ], [ %sub.sink, %for.body40 ]
  %.neg = sub i32 0, %y1.1
  %add = add i32 %y2.0, -1
  %sub63 = add i32 %add, %.neg
  %.neg3 = sub i32 0, %x1.1
  %add65 = add i32 %x2.0, -1
  %sub66 = add i32 %add65, %.neg3
