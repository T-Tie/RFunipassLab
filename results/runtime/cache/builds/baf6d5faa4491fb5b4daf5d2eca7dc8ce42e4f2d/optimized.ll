...
for.inc74.gvnsink.split:                          ; preds = %if.then, %if.then44, %if.else58
  %k.0.sink = phi i32 [ %k.0, %if.else58 ], [ %k.0, %if.then44 ], [ %inc18, %if.then ]
  %add66.sink1 = phi i32 [ %add, %if.else58 ], [ %conv, %if.then44 ], [ %conv, %if.then ]
  %idxprom67 = sext i32 %k.0.sink to i64
  ...
  %inc71 = add nsw i32 %add66.sink1, 1
  br label %for.inc74

for.inc74:                                        ; preds = %for.inc74.gvnsink.split, %if.then33
  %k.1 = phi i32 [ %inc41, %if.then33 ], [ %k.0.sink, %for.inc74.gvnsink.split ]
