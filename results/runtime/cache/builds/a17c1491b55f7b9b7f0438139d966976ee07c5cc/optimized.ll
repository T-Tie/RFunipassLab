...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(2000) %a, i8 noundef 0, i64 noundef 2000, i1 noundef false) #5
  br label %for.cond
...
for.cond6:                                        ; preds = %for.inc12, %for.end
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc12 ], [ %indvars.iv, %for.end ]
  %cmp7 = icmp sgt i64 %indvars.iv5, 0
  br i1 %cmp7, label %for.inc12, label %for.end13

for.inc12:                                        ; preds = %for.cond6
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, -1
  %arrayidx9 = getelementptr inbounds nuw [100 x [20 x i8]], ptr %a, i64 0, i64 %indvars.iv.next6
