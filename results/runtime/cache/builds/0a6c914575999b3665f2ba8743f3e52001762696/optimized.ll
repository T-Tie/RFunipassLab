...
for.cond:                                         ; preds = %for.inc, %entry
  %count.0 = phi i64 [ 0, %entry ], [ %call27.sink, %for.inc ]
...
if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #11
  br label %for.inc
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #11
...
if.then12:                                        ; preds = %if.else
  ...
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #11
...
if.else22:                                        ; preds = %if.else
  ...
  %call27 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #11
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else22, %if.then12
  %call27.sink = phi i64 [ %call27, %if.else22 ], [ %add20, %if.then12 ], [ %call6, %if.then ]
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %s) #10
