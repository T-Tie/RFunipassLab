...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #9
...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  br i1 %exitcond12.not, label %for.end9, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax119 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax95 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count80 = zext nneg i32 %smax95 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  %indvars.iv77 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next78, %for.inc27 ]
  %exitcond81.not = icmp eq i64 %indvars.iv77, %wide.trip.count80
  br i1 %exitcond81.not, label %for.cond31.preheader, label %for.cond2

for.cond31.preheader:                             ; preds = %for.cond
  %wide.trip.count85 = zext i32 %n.tr to i64
  br label %for.cond31
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv77, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv72 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next73, %for.inc24 ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count
  br i1 %exitcond76.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv77, i64 %indvars.iv72
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv92 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next93, %for.inc67 ]
  %exitcond97.not = icmp eq i64 %indvars.iv92, %wide.trip.count80
  br i1 %exitcond97.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select70, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond86.not = icmp eq i64 %indvars.iv82, %wide.trip.count85
  br i1 %exitcond86.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv82, i64 %indvars.iv92
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %spec.select70 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next83 = add nuw nsw i64 %indvars.iv82, 1
  br label %for.cond36, !llvm.loop !17

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv87 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next88, %for.inc64 ]
  %exitcond91.not = icmp eq i64 %indvars.iv87, %wide.trip.count85
  br i1 %exitcond91.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv87, i64 %indvars.iv92
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count108 = zext nneg i32 %smax119 to i64
  %wide.trip.count101 = zext i32 %n.tr to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.inc92, %for.end69
  %indvars.iv103 = phi i64 [ %indvars.iv.next104, %for.inc92 ], [ 2, %for.end69 ]
  %exitcond109.not = icmp eq i64 %indvars.iv103, %wide.trip.count108
  br i1 %exitcond109.not, label %for.cond96.preheader, label %for.cond76.preheader

for.cond96.preheader:                             ; preds = %for.cond71
  %wide.trip.count113 = zext i32 %n.tr to i64
  br label %for.cond96

for.cond76.preheader:                             ; preds = %for.cond71
  %5 = add nsw i64 %indvars.iv103, -1
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv98 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next99, %for.inc89 ]
  %exitcond102.not = icmp eq i64 %indvars.iv98, %wide.trip.count101
  br i1 %exitcond102.not, label %for.inc92, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv103, i64 %indvars.iv98
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv98
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv115 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next116, %for.inc117 ]
  %exitcond121.not = icmp eq i64 %indvars.iv115, %wide.trip.count108
  br i1 %exitcond121.not, label %for.end119, label %for.cond101.preheader

for.cond101.preheader:                            ; preds = %for.cond96
  %7 = add nsw i64 %indvars.iv115, -1
  br label %for.cond101

for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv110 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next111, %for.inc114 ]
  %exitcond114.not = icmp eq i64 %indvars.iv110, %wide.trip.count113
  br i1 %exitcond114.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv110, i64 %indvars.iv115
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv110, i64 %7
...
for.cond:                                         ; preds = %for.inc9, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc9 ], [ 0, %entry ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, %wide.trip.count11
  br i1 %exitcond12.not, label %for.end11, label %for.cond1
