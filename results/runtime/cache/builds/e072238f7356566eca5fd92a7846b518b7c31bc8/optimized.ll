...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %1 = phi i32 [ %dec, %for.inc ], [ 30, %for.body ]
...
for.cond10:                                       ; preds = %for.inc17, %for.end9
  %3 = phi i32 [ %inc18, %for.inc17 ], [ 0, %for.end9 ]
  %cmp11 = icmp slt i32 %3, 31
...
for.cond20:                                       ; preds = %for.inc28, %for.end19
  %5 = phi i32 [ %inc29, %for.inc28 ], [ %3, %for.end19 ]
  %cmp21 = icmp slt i32 %5, 31
