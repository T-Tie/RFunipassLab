...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec22 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv24 = phi i64 [ %indvars.iv.next25.pre-phi, %for.inc18 ], [ 0, %for.cond ]
  %k.1 = phi i32 [ %k.2, %for.inc18 ], [ %k.0, %for.cond ]
  %2 = sext i32 %k.1 to i64
  %cmp2 = icmp slt i64 %indvars.iv24, %2
  br i1 %cmp2, label %for.body3, label %while.cond, !llvm.loop !13

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv24
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv29 = phi i64 [ %0, %for.cond22.preheader ], [ %8, %for.inc28 ]
  %7 = trunc nuw i64 %indvars.iv29 to i32
