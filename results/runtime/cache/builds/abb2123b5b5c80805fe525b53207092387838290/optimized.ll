...
if.end:                                           ; preds = %for.end30, %if.else
  %phiofops5 = phi i32 [ %4, %if.else ], [ %2, %for.end30 ]
...
for.cond52:                                       ; preds = %for.inc83, %for.end51
  ...
  %cmp53 = icmp slt i32 %i.3, %phiofops5
...
for.cond86:                                       ; preds = %for.inc91, %for.end85
  ...
  %cmp87 = icmp slt i32 %i.4, %phiofops5
...
for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %phiofops5 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  ...
  %cmp97 = icmp slt i32 %i.5, %phiofops5
...
for.cond118:                                      ; preds = %for.inc198, %for.end117
  ...
  %cmp119 = icmp slt i32 %i.6, %phiofops5
...
if.then124:                                       ; preds = %for.body120
  %cmp125 = icmp eq i32 %phiofops5, 100
...
for.inc148:                                       ; preds = %for.cond137
  ...
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %15) #5
