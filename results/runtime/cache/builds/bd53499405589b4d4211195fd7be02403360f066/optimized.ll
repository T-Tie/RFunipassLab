...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1584, ptr noundef align 16 %m) #6
  call void @llvm.lifetime.start.p0(i64 noundef 792, ptr noundef align 16 %x) #6
...
for.body:                                         ; preds = %for.cond
  ...
  %fneg26 = fneg double %1
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %call9 = call double @sqrt(double noundef %4) #7, !tbaa !5
  %add = fadd double %fneg26, %call9
  ...
  %call16 = call double @sqrt(double noundef %4) #7, !tbaa !5
...
if.else32:                                        ; preds = %if.else
  %mul34 = fmul double 2.000000e+00, %2
  %div35 = fdiv double %fneg26, %mul34
...
for.inc:                                          ; preds = %if.else, %if.then, %if.else32
  ...
  %mul43 = fmul double 2.000000e+00, %2
  %div44 = fdiv double %call42.sink.sink, %mul43
  %arrayidx45 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 %.sink.sink
...
for.body51:                                       ; preds = %for.cond49
  ...
  %6 = load double, ptr %arrayidx53, align 8, !tbaa !9
  %cmp54 = fcmp ogt double %6, 0.000000e+00
  %7 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
...
if.then55:                                        ; preds = %for.body51
  ...
  %9 = load double, ptr %arrayidx61, align 8, !tbaa !9
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %8, double noundef %9) #8
  br label %for.inc110

if.else63:                                        ; preds = %for.body51
  %cmp66 = fcmp oeq double %6, 0.000000e+00
  %10 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
  br i1 %cmp66, label %if.then67, label %if.else72

if.then67:                                        ; preds = %if.else63
  %arrayidx70 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
  %call71 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %8) #8
  br label %for.inc110

if.else72:                                        ; preds = %if.else63
  %arrayidx75 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
  %cmp76 = fcmp oeq double %8, 0.000000e+00
  %11 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 1
  %12 = getelementptr inbounds [99 x double], ptr %11, i64 0, i64 %idxprom52
  %13 = load double, ptr %12, align 8, !tbaa !9
  br i1 %cmp76, label %if.then77, label %if.else93

if.then77:                                        ; preds = %if.else72
  %fneg81 = fneg double %8
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %13, double noundef %fneg81, double noundef %13) #8
  br label %for.inc110
...
if.else93:                                        ; preds = %if.else72
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %8, double noundef %13, double noundef %8, double noundef %13) #8
  br label %for.inc110
...
for.end112:                                       ; preds = %for.cond49
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %x) #8
  call void @llvm.lifetime.end.p0(i64 noundef 1584, ptr noundef %m) #8
  ret i32 0
}
