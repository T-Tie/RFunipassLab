...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2000, ptr nonnull %num) #6
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc29
  %indvars.iv22 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next23, %for.inc29 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc27
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc27 ], [ %1, %for.cond3 ]
  %indvars.iv.next19 = add nsw i64 %indvars.iv18, -1
  %cmp8 = icmp sgt i64 %indvars.iv.next19, %indvars.iv22
  br i1 %cmp8, label %for.body10, label %for.inc29

for.body10:                                       ; preds = %for.cond7
  %2 = add nsw i64 %indvars.iv18, -2
  %arrayidx13 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %2
  %3 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %arrayidx15 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %indvars.iv.next19
...
for.cond33:                                       ; preds = %for.cond3, %for.inc50
  %.pre30 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.cond3 ]
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc50 ], [ 0, %for.cond3 ]
  %cnt.0 = phi i32 [ %cnt.1, %for.inc50 ], [ 0, %for.cond3 ]
  %5 = sext i32 %.pre30 to i64
  %cmp34 = icmp slt i64 %indvars.iv26, %5
  br i1 %cmp34, label %for.body36, label %for.end52

for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw [500 x i32], ptr %num, i64 0, i64 %indvars.iv26
...
if.then42:                                        ; preds = %if.then40
  ...
  %.pre29 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  br label %if.end44

if.end44:                                         ; preds = %if.then42, %if.then40
  %8 = phi i32 [ %.pre29, %if.then42 ], [ %6, %if.then40 ]
...
for.inc50:                                        ; preds = %for.body36, %if.end44
  %.pre = phi i32 [ %.pre.pre, %if.end44 ], [ %.pre30, %for.body36 ]
...
for.end52:                                        ; preds = %for.cond33
  ...
  call void @llvm.lifetime.end.p0(i64 2000, ptr nonnull %num) #6
