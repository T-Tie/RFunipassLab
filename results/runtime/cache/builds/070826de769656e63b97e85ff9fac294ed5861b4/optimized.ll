...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 101, ptr noundef nonnull align 16 captures(none) dereferenceable(101) %a) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 15000, ptr noundef nonnull %b) #7
  br label %for.cond
...
for.inc24:                                        ; preds = %for.cond16
  ...
  %call.i.i3 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx21) #7
  %call1.i4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx21, i64 noundef %call.i.i3)
  br label %for.cond16, !llvm.loop !12

for.end25:                                        ; preds = %for.cond16
  %vtable.i = load ptr, ptr @_ZSt4cout, align 8, !tbaa !13, !invariant.load !8
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 15000, ptr noundef nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 noundef 101, ptr noundef nonnull captures(none) %a) #7
  ret i32 0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !40, !invariant.load !8
