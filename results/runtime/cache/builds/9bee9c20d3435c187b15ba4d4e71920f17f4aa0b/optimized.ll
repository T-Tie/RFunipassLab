...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv27 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next28, %for.inc14 ]
  %exitcond.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond.not, label %for.cond17, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv27
  store i32 0, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv27
  br label %while.cond
...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  %.pre41 = phi i32 [ %.pre, %for.inc47 ], [ %0, %for.cond2 ]
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc47 ], [ 0, %for.cond2 ]
  %s.0 = phi i32 [ %add46, %for.inc47 ], [ 0, %for.cond2 ]
  %5 = sext i32 %.pre41 to i64
  %cmp18 = icmp slt i64 %indvars.iv31, %5
  br i1 %cmp18, label %for.body19, label %for.end49

for.body19:                                       ; preds = %for.cond17
  %cmp20 = icmp sgt i32 %s.0, 0
  %arrayidx22 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv31
...
land.lhs.true:                                    ; preds = %for.body19
  ...
  br i1 %cmp23, label %if.end35.thread39, label %if.end35.thread

if.end35.thread39:                                ; preds = %land.lhs.true
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread39
  %call24.sink = phi ptr [ %call24, %if.end35.thread39 ], [ @_ZSt4cout, %if.end35.thread ], [ @_ZSt4cout, %if.end35 ]
  %s.124.ph = phi i32 [ %s.0, %if.end35.thread39 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
  %arrayidx26 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv31
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre41, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
  %s.124 = phi i32 [ %s.0, %if.end35 ], [ %s.124.ph, %for.inc47.sink.split ]
  %add45 = add i32 %6, 1
  %add46 = add i32 %add45, %s.124
