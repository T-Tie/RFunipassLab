...
if.then:                                          ; preds = %while.body
  %1 = load i8, ptr %p.0, align 1, !tbaa !5, !invariant.load !8
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %1)
...
while.cond8:                                      ; preds = %while.body11, %if.else
  ...
  %2 = load i8, ptr %p.2, align 1, !tbaa !5, !invariant.load !8
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !40, !invariant.load !8
  ret i64 %0
}
