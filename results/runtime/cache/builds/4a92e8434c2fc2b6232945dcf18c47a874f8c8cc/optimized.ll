...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc23 ], [ 0, %entry ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv67, %1
...
for.cond26.preheader:                             ; preds = %for.cond
  ...
  %smax77 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv67, i64 %indvars.iv
  ...
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv67, i64 %indvars.iv
  store i32 %5, ptr %arrayidx14, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv67, i64 %indvars.iv
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc53
  %indvars.iv73 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next74, %for.inc53 ]
  %exitcond79.not = icmp eq i64 %indvars.iv73, %wide.trip.count78
  br i1 %exitcond79.not, label %for.cond56.preheader, label %for.cond29
...
for.cond29:                                       ; preds = %for.cond26, %for.inc50
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc50 ], [ 0, %for.cond26 ]
  %exitcond.not = icmp eq i64 %indvars.iv70, %wide.trip.count
  br i1 %exitcond.not, label %for.inc53, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv73, i64 %indvars.iv70
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %indvars.iv.next71 = add nuw nsw i64 %indvars.iv70, 1
  %arrayidx39 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv73, i64 %indvars.iv.next71
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc78
  %indvars.iv86 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next87, %for.inc78 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %wide.trip.count78
  br i1 %exitcond90.not, label %for.cond81, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %arrayidx69 = getelementptr inbounds [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv86, i64 %idxprom68
  %arrayidx73 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv86
  br label %for.cond59

for.cond59:                                       ; preds = %for.cond59.preheader, %for.inc75
  %indvars.iv80 = phi i64 [ 0, %for.cond59.preheader ], [ %indvars.iv.next81, %for.inc75 ]
  %exitcond85.not = icmp eq i64 %indvars.iv80, %wide.trip.count
  br i1 %exitcond85.not, label %for.inc78, label %for.body61

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv86, i64 %indvars.iv80
  %8 = load i32, ptr %arrayidx65, align 4, !tbaa !5
  %9 = load i32, ptr %arrayidx69, align 4, !tbaa !5
  %cmp70 = icmp eq i32 %8, %9
  br i1 %cmp70, label %if.then71, label %for.inc75

if.then71:                                        ; preds = %for.body61
  %10 = trunc nuw nsw i64 %indvars.iv80 to i32
...
for.cond81:                                       ; preds = %for.cond56, %for.inc111
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc111 ], [ 0, %for.cond56 ]
  %exitcond101.not = icmp eq i64 %indvars.iv96, %wide.trip.count
  br i1 %exitcond101.not, label %for.cond114.preheader, label %for.cond84
...
for.cond84:                                       ; preds = %for.cond81, %for.body86
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.body86 ], [ 0, %for.cond81 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %wide.trip.count78
  br i1 %exitcond95.not, label %for.inc111, label %for.body86

for.body86:                                       ; preds = %for.cond84
  %arrayidx90 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv91, i64 %indvars.iv96
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  %arrayidx95 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv.next92, i64 %indvars.iv96
  %12 = load i32, ptr %arrayidx95, align 4, !tbaa !5
...
for.cond114:                                      ; preds = %for.cond114.preheader, %for.inc137
  %indvars.iv107 = phi i64 [ 0, %for.cond114.preheader ], [ %indvars.iv.next108, %for.inc137 ]
  %exitcond111.not = icmp eq i64 %indvars.iv107, %wide.trip.count
  br i1 %exitcond111.not, label %for.cond140, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %arrayidx128 = getelementptr inbounds [8 x [8 x i32]], ptr %bj, i64 0, i64 %idxprom125, i64 %indvars.iv107
  %arrayidx132 = getelementptr inbounds nuw [8 x i32], ptr %hd, i64 0, i64 %indvars.iv107
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc134
  %indvars.iv102 = phi i64 [ 0, %for.cond117.preheader ], [ %indvars.iv.next103, %for.inc134 ]
  %exitcond106.not = icmp eq i64 %indvars.iv102, %wide.trip.count78
  br i1 %exitcond106.not, label %for.inc137, label %for.body119

for.body119:                                      ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv102, i64 %indvars.iv107
  %13 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %14 = load i32, ptr %arrayidx128, align 4, !tbaa !5
  %cmp129 = icmp eq i32 %13, %14
  br i1 %cmp129, label %if.then130, label %for.inc134

if.then130:                                       ; preds = %for.body119
  %15 = trunc nuw nsw i64 %indvars.iv102 to i32
...
for.cond140:                                      ; preds = %for.cond114, %for.inc150
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.inc150 ], [ 0, %for.cond114 ]
  %exitcond116.not = icmp eq i64 %indvars.iv112, %wide.trip.count78
  br i1 %exitcond116.not, label %for.end152, label %for.body142

for.body142:                                      ; preds = %for.cond140
  %arrayidx144 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv112
  %16 = load i32, ptr %arrayidx144, align 4, !tbaa !5
  %idxprom145 = sext i32 %16 to i64
  %arrayidx146 = getelementptr inbounds [8 x i32], ptr %hd, i64 0, i64 %idxprom145
  %17 = load i32, ptr %arrayidx146, align 4, !tbaa !5
  %18 = zext i32 %17 to i64
  %cmp147 = icmp eq i64 %indvars.iv112, %18
  br i1 %cmp147, label %if.then148, label %for.inc150

if.then148:                                       ; preds = %for.body142
  %19 = trunc nuw nsw i64 %indvars.iv112 to i32
