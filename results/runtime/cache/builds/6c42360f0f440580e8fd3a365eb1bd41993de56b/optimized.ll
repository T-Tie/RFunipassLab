...
for.cond40.preheader:                             ; preds = %for.cond2
  ...
  %smax10 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
  br label %for.cond40
...
if.then28:                                        ; preds = %if.end
  br i1 %or.cond6, label %if.then35, label %if.else
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc85
  ...
  %exitcond11.not = icmp eq i32 %6, %smax10
...
if.then70:                                        ; preds = %if.end58
  br i1 %or.cond6, label %if.then79, label %if.else81
