...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc31
  %indvars.iv8 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next9, %for.inc31 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc28
  ...
  %cmp8.not.not = icmp sgt i64 %indvars.iv, %indvars.iv8
...
for.cond36:                                       ; preds = %for.inc44, %for.end33
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc44 ], [ 1, %for.end33 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond16.not, label %for.end46, label %for.inc44
...
for.inc44:                                        ; preds = %for.cond36
  ...
  %arrayidx42 = getelementptr inbounds nuw [510 x i32], ptr %a, i64 0, i64 %indvars.iv12
