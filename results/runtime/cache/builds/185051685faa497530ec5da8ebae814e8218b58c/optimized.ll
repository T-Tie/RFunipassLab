...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv12, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc27
  %indvars.iv19 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next20, %for.inc27 ]
  ...
  br i1 %exitcond24.not, label %for.end30, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond11
  %4 = trunc nuw nsw i64 %indvars.iv19 to i32
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc24
  %indvars.iv15 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next16, %for.inc24 ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body18

for.body18:                                       ; preds = %for.cond15
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv19, i64 %indvars.iv15
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !5
  %cmp23 = icmp eq i32 %5, 0
  br i1 %cmp23, label %for.inc27.split.loop.exit27, label %for.inc24

for.inc24:                                        ; preds = %for.body18
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond15, !llvm.loop !13

for.inc27.split.loop.exit27:                      ; preds = %for.body18
  %6 = trunc nuw nsw i64 %indvars.iv15 to i32
  br label %for.inc27

for.inc27:                                        ; preds = %for.cond15, %for.inc27.split.loop.exit27
  %s.1 = phi i32 [ %6, %for.inc27.split.loop.exit27 ], [ %s.0, %for.cond15 ]
  %r.1 = phi i32 [ %4, %for.inc27.split.loop.exit27 ], [ %r.0, %for.cond15 ]
...
for.cond31:                                       ; preds = %for.inc50, %for.end30
  ...
  %7 = phi i32 [ %sub, %for.end30 ], [ %dec51, %for.inc50 ]
  %cmp32 = icmp sgt i32 %7, -1
  br i1 %cmp32, label %for.cond36.preheader, label %for.end53

for.cond36.preheader:                             ; preds = %for.cond31
  %idxprom40 = zext nneg i32 %7 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc47
  %8 = phi i32 [ %dec, %for.inc47 ], [ %sub, %for.cond36.preheader ]
...
for.inc50:                                        ; preds = %for.cond36, %for.body39
  %q.1 = phi i32 [ %8, %for.body39 ], [ %q.0, %for.cond36 ]
  %p.1 = phi i32 [ %7, %for.body39 ], [ %p.0, %for.cond36 ]
  %dec51 = add nsw i32 %7, -1
  br label %for.cond31, !llvm.loop !16

for.end53:                                        ; preds = %for.cond31
  %10 = xor i32 %p.0, -1
  %sub55 = add i32 %r.0, %10
  %sub56 = xor i32 %s.0, -1
  %sub57 = add i32 %q.0, %sub56
