...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  br i1 %cmp, label %for.cond3.preheader, label %for.end10

for.cond3.preheader:                              ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %j.0 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond3.preheader ]
...
for.cond16:                                       ; preds = %for.inc30, %for.end10
  ...
  br i1 %cmp17, label %for.cond19.preheader, label %for.end32

for.cond19.preheader:                             ; preds = %for.cond16
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc27
  %j.1 = phi i32 [ %inc28, %for.inc27 ], [ 0, %for.cond19.preheader ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax48 = call i32 @llvm.smax.i32(i32 %11, i32 noundef 0)
  %15 = sext i32 %13 to i64
  %smax56 = call i32 @llvm.smax.i32(i32 %10, i32 noundef 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  ...
  br i1 %exitcond58.not, label %for.cond77.preheader, label %for.cond40.preheader

for.cond77.preheader:                             ; preds = %for.cond37
  br label %for.cond77

for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv51, %14
  %17 = mul nsw i64 %indvars.iv51, %15
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv44
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv44
  br label %for.cond47
...
for.inc68:                                        ; preds = %for.cond47
  ...
  %23 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !15
...
for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc98
  %24 = phi i32 [ %26, %for.inc98 ], [ %11, %for.cond77.preheader ]
  %25 = phi i32 [ %.pre, %for.inc98 ], [ %10, %for.cond77.preheader ]
  %i.3 = phi i32 [ %inc99, %for.inc98 ], [ 0, %for.cond77.preheader ]
  %cmp78 = icmp slt i32 %i.3, %25
  br i1 %cmp78, label %for.cond80.preheader, label %for.end100

for.cond80.preheader:                             ; preds = %for.cond77
  br label %for.cond80

for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc95
  %26 = phi i32 [ %.pre59, %for.inc95 ], [ %24, %for.cond80.preheader ]
  %j.3 = phi i32 [ %inc96, %for.inc95 ], [ 0, %for.cond80.preheader ]
