...
if.else29:                                        ; preds = %lor.lhs.false
  ...
  store i32 %12, ptr %m, align 4, !tbaa !5
  br label %for.cond30
...
sw.bb33:                                          ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32
  ...
  %add34 = add nsw i32 %15, 31
  store i32 %add34, ptr %x, align 4, !tbaa !5
  br label %sw.epilog39

sw.bb35:                                          ; preds = %for.body32
  %16 = load i32, ptr %x, align 4, !tbaa !5
  %add36 = add nsw i32 %16, 28
  store i32 %add36, ptr %x, align 4, !tbaa !5
  br label %sw.epilog39

sw.default37:                                     ; preds = %for.body32
  %17 = load i32, ptr %x, align 4, !tbaa !5
  %add38 = add nsw i32 %17, 30
  store i32 %add38, ptr %x, align 4, !tbaa !5
  br label %sw.epilog39

sw.epilog39:                                      ; preds = %sw.default37, %sw.bb35, %sw.bb33
  br label %for.inc40

for.inc40:                                        ; preds = %sw.epilog39
  %inc41 = add nsw i32 %13, 1
