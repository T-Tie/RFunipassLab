...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %2 = phi i32 [ %.pre39, %for.inc ], [ %0, %for.cond1.preheader ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  ...
  br i1 %exitcond.not, label %for.end23.loopexit, label %for.body15
...
for.end23.loopexit:                               ; preds = %for.cond13
  br label %for.end23

for.end23:                                        ; preds = %for.end23.loopexit, %for.end23.split.loop.exit
  %x1.2 = phi i32 [ %4, %for.end23.split.loop.exit ], [ %x1.0, %for.end23.loopexit ]
  %y1.2 = phi i32 [ %6, %for.end23.split.loop.exit ], [ %y1.0, %for.end23.loopexit ]
