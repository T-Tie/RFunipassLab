...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 captures(none) dereferenceable(40000) %words) #12
...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  ...
  br i1 %cmp, label %if.then6.i, label %for.end14

if.then6.i:                                       ; preds = %for.cond
  %vbase.offset9.i = load i64, ptr %vbase.offset.ptr8.i, align 8, !invariant.load !9
  %add.ptr10.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(40000) %words, i64 noundef 40000)
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %2 = add i64 %1, -40001
  %or.cond.i = icmp ult i64 %2, -40000
...
for.end14:                                        ; preds = %for.cond
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %words)
  br label %for.cond20

for.cond20:                                       ; preds = %if.then, %for.end14
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.then ], [ 1, %for.end14 ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %cmp21 = icmp sgt i32 %3, 1
  br i1 %cmp21, label %if.then, label %for.end53

if.then:                                          ; preds = %for.cond20
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  %arrayidx31 = getelementptr inbounds nuw [1000 x [40 x i8]], ptr %words, i64 0, i64 %indvars.iv
  %call33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call29, ptr noundef nonnull %arrayidx31)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond20

for.end53:                                        ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull captures(none) %words) #12
