...
if.then:                                          ; preds = %for.body
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(6) @.str)
  br label %if.end
...
lor.lhs.false:                                    ; preds = %if.end27
  ...
  %or.cond2 = and i1 %cmp39, %cmp44
  br i1 %or.cond2, label %if.then45, label %for.inc
...
if.end.exitStub:
  %call18 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %0)
