...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %p) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %lenq) #9
...
for.inc:                                          ; preds = %for.cond
  ...
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %9)
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %12)
...
while.end48:                                      ; preds = %while.cond4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %lenq) #10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %p) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %len) #10
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef captures(none) %a) #10
  ret i32 0
}
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !21
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !16
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !46
  ret i64 %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !47
  ret i32 %0
}
...
!25 = !{!"_ZTSSt8ios_base", !26, i64 8, !26, i64 16, !27, i64 24, !28, i64 28, !28, i64 32, !29, i64 40, !30, i64 48, !8, i64 64, !11, i64 192, !31, i64 200, !32, i64 208}
!26 = !{!"long", !8, i64 0}
