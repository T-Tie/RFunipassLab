...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax127 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %smax103 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count88 = zext nneg i32 %smax103 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count88
  br i1 %exitcond89.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count93 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv85
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv80 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next81, %for.inc21 ]
  %exitcond84.not = icmp eq i64 %indvars.iv80, %wide.trip.count
  br i1 %exitcond84.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv85, i64 %indvars.iv80
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv100 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next101, %for.inc60 ]
  %exitcond105.not = icmp eq i64 %indvars.iv100, %wide.trip.count88
  br i1 %exitcond105.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv100
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select78, %for.body34 ], [ %3, %for.body29 ]
  %exitcond94.not = icmp eq i64 %indvars.iv90, %wide.trip.count93
  br i1 %exitcond94.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv90, i64 %indvars.iv100
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv95 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next96, %for.inc57 ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %wide.trip.count93
  br i1 %exitcond99.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv95, i64 %indvars.iv100
...
for.cond65.preheader:                             ; preds = %for.end62
  %wide.trip.count116 = zext nneg i32 %smax127 to i64
  %wide.trip.count109 = zext i32 %n.tr to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv111 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next112, %for.inc83 ]
  %exitcond117.not = icmp eq i64 %indvars.iv111, %wide.trip.count116
  br i1 %exitcond117.not, label %for.cond86.preheader, label %for.cond68.preheader

for.cond86.preheader:                             ; preds = %for.cond65
  %wide.trip.count121 = zext i32 %n.tr to i64
  br label %for.cond86

for.cond68.preheader:                             ; preds = %for.cond65
  %7 = add nsw i64 %indvars.iv111, -1
  br label %for.cond68

for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv106 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next107, %for.inc80 ]
  %exitcond110.not = icmp eq i64 %indvars.iv106, %wide.trip.count109
  br i1 %exitcond110.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv111, i64 %indvars.iv106
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv106
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv123 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next124, %for.inc104 ]
  %exitcond129.not = icmp eq i64 %indvars.iv123, %wide.trip.count116
  br i1 %exitcond129.not, label %for.end106, label %for.cond89.preheader
...
for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv118 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next119, %for.inc101 ]
  %exitcond122.not = icmp eq i64 %indvars.iv118, %wide.trip.count121
  br i1 %exitcond122.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv118, i64 %indvars.iv123
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv118, i64 %9
