...
for.end53:                                        ; preds = %for.cond37
  %min34.0.lcssa = phi i32 [ %min34.0, %for.cond37 ]
  br label %for.cond54
...
for.inc66:                                        ; preds = %for.cond54
  ...
  %sub61 = sub nsw i32 %5, %min34.0.lcssa
...
for.cond:                                         ; preds = %for.inc10, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc11.lcssa, %for.inc10 ]
  %sub = sub nsw i32 %n, 1
...
for.inc10:                                        ; preds = %for.cond1
  %inc11.lcssa = phi i32 [ %inc11, %for.cond1 ]
...
for.cond13:                                       ; preds = %for.inc33, %for.end12
  %i.1 = phi i32 [ 1, %for.end12 ], [ %inc34.lcssa, %for.inc33 ]
  %cmp15 = icmp slt i32 %i.1, %sub.lcssa
...
for.cond17:                                       ; preds = %for.inc30, %for.body16
  ...
  %cmp19 = icmp slt i32 %j.1, %sub.lcssa
...
for.inc33:                                        ; preds = %for.cond17
  %inc34.lcssa = phi i32 [ %inc34, %for.cond17 ]
...
for.inc17:                                        ; preds = %for.cond1
  ...
  call void @_Z1fi(i32 noundef %.lcssa) #9
