...
for.cond:                                         ; preds = %for.end, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc9.i, %for.end ]
...
for.cond16:                                       ; preds = %for.end29, %for.end10
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc9.i4, %for.end29 ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax49 = call i32 @llvm.smax.i32(i32 %11, i32 noundef 0)
...
for.cond37:                                       ; preds = %for.end73, %for.end32
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.end73 ], [ 0, %for.end32 ]
...
for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv52, %14
  %17 = mul nsw i64 %indvars.iv52, %15
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  ...
  br i1 %exitcond51.not, label %for.end73, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv45
...
for.inc68:                                        ; preds = %for.cond47
  ...
  %22 = load i32, ptr %gep, align 4, !tbaa !5, !invariant.load !13
  %mul62 = mul nsw i32 %22, %20
...
for.cond77:                                       ; preds = %for.cond37, %for.end97
  %23 = phi i32 [ %25, %for.end97 ], [ %11, %for.cond37 ]
  %24 = phi i32 [ %.pre, %for.end97 ], [ %10, %for.cond37 ]
  %i.3 = phi i32 [ %inc9.i6, %for.end97 ], [ 0, %for.cond37 ]
  %cmp78 = icmp slt i32 %i.3, %24
  br i1 %cmp78, label %for.cond80, label %for.end100

for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %25 = phi i32 [ %.pre60, %for.inc95 ], [ %23, %for.cond77 ]
  %j.3 = phi i32 [ %inc96, %for.inc95 ], [ 0, %for.cond77 ]
  %cmp81 = icmp slt i32 %j.3, %25
  br i1 %cmp81, label %for.body82, label %for.end97

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %25, %i.3
  ...
  %call87 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %26)
...
if.then:                                          ; preds = %for.body82
  ...
  %.pre63 = add nsw i32 %.pre61, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre63, %if.then ], [ %sub, %for.body82 ]
  %28 = phi i32 [ %.pre61, %if.then ], [ %27, %for.body82 ]
  %cmp91 = icmp eq i32 %j.3, %sub90.pre-phi
  br i1 %cmp91, label %if.then92, label %for.inc95

if.then92:                                        ; preds = %if.end
  %putchar40 = call i32 @putchar(i32 noundef 10) #9
  %.pre60.pre = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.inc95

for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre60 = phi i32 [ %28, %if.end ], [ %.pre60.pre, %if.then92 ]
  %inc96 = add nuw nsw i32 %j.3, 1
  br label %for.cond80, !llvm.loop !16

for.end97:                                        ; preds = %for.cond80
  %inc9.i6 = add nuw nsw i32 %i.3, 1
