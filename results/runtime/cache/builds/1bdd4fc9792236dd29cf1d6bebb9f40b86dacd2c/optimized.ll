...
for.cond:                                         ; preds = %for.end133, %entry
  %k.0 = phi i32 [ 0, %entry ], [ %inc.i23, %for.end133 ]
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.end ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv32, %2
...
for.body8:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv32, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  %indvars.iv58 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next59, %for.inc131 ]
  %indvars.iv35 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next36, %for.inc131 ]
  %total.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add130, %for.inc131 ]
  %exitcond63.not = icmp eq i64 %indvars.iv58, %wide.trip.count62
  br i1 %exitcond63.not, label %for.end133, label %for.cond20

for.cond20:                                       ; preds = %for.cond15, %for.inc66
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc66 ], [ 0, %for.cond15 ]
  %exitcond.not = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond.not, label %for.cond70, label %for.body23

for.body23:                                       ; preds = %for.cond20
  %6 = add nuw nsw i64 %indvars.iv43, 4294967295
  %7 = and i64 %6, 4294967295
  %or.cond = icmp samesign ult i64 %7, %indvars.iv58
  br i1 %or.cond, label %for.inc66, label %if.end

if.end:                                           ; preds = %for.body23
  %arrayidx27 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43
  %8 = load i32, ptr %arrayidx27, align 16, !tbaa !5
  br label %for.cond30

for.cond30:                                       ; preds = %for.body33, %if.end
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body33 ], [ %indvars.iv35, %if.end ]
  %minValue.0 = phi i32 [ %spec.select, %for.body33 ], [ %8, %if.end ]
  %9 = icmp slt i64 %indvars.iv37, %2
  br i1 %9, label %for.body33, label %for.end47

for.body33:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv37
...
for.cond54:                                       ; preds = %for.body57, %for.end47
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body57 ], [ %indvars.iv35, %for.end47 ]
  %11 = icmp slt i64 %indvars.iv40, %2
  br i1 %11, label %for.body57, label %for.inc66

for.body57:                                       ; preds = %for.cond54
  %arrayidx61 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv40
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc121 ], [ 0, %for.cond20 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count
  br i1 %exitcond57.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw nsw i64 %indvars.iv53, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond29 = icmp samesign ult i64 %14, %indvars.iv58
  br i1 %or.cond29, label %for.inc121, label %if.end78

if.end78:                                         ; preds = %for.body73
  %arrayidx82 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv53
  %15 = load i32, ptr %arrayidx82, align 4, !tbaa !5
  br label %for.cond85

for.cond85:                                       ; preds = %for.body88, %if.end78
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body88 ], [ %indvars.iv35, %if.end78 ]
  %minValue79.0 = phi i32 [ %spec.select30, %for.body88 ], [ %15, %if.end78 ]
  %16 = icmp slt i64 %indvars.iv47, %2
  br i1 %16, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv53
  %17 = load i32, ptr %arrayidx92, align 4, !tbaa !5
  %spec.select30 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.body112, %for.end102
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body112 ], [ %indvars.iv35, %for.end102 ]
  %18 = icmp slt i64 %indvars.iv50, %2
  br i1 %18, label %for.body112, label %for.inc121

for.body112:                                      ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv53
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %arrayidx129 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next59, i64 %indvars.iv.next59
