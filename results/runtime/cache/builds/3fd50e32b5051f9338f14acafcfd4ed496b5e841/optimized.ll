...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %mon1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %mon2) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %year) #4
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %result) #4
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef align 16 %sz) #4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = load i32, ptr %mon1, align 4, !tbaa !5
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %5) #5
  %6 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %6) #5
  %sub = sub nsw i32 %call5, %call6
  store i32 %sub, ptr %result, align 4, !tbaa !5
  %cmp7 = icmp slt i32 %sub, 0
  br i1 %cmp7, label %if.then, label %if.end

if.then:                                          ; preds = %for.body3
  %sub8 = sub nsw i32 0, %sub
  store i32 %sub8, ptr %result, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body3
  %7 = load i32, ptr %result, align 4, !tbaa !5
  %rem = srem i32 %7, 7
...
for.end29:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %sz) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %result) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %year) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %mon2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %mon1) #5
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %.sink, %mon
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %cmp1 = icmp eq i32 %.sink, 1
  br i1 %cmp1, label %for.inc, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.body
  %cmp2 = icmp eq i32 %.sink, 3
  br i1 %cmp2, label %for.inc, label %lor.lhs.false3

lor.lhs.false3:                                   ; preds = %lor.lhs.false
  %cmp4 = icmp eq i32 %.sink, 5
  br i1 %cmp4, label %for.inc, label %lor.lhs.false5

lor.lhs.false5:                                   ; preds = %lor.lhs.false3
  %cmp6 = icmp eq i32 %.sink, 7
  br i1 %cmp6, label %for.inc, label %lor.lhs.false7

lor.lhs.false7:                                   ; preds = %lor.lhs.false5
  %cmp8 = icmp eq i32 %.sink, 8
  br i1 %cmp8, label %for.inc, label %lor.lhs.false9

lor.lhs.false9:                                   ; preds = %lor.lhs.false7
  %cmp10 = icmp eq i32 %.sink, 10
  br i1 %cmp10, label %for.inc, label %lor.lhs.false11

lor.lhs.false11:                                  ; preds = %lor.lhs.false9
  %cmp12 = icmp eq i32 %.sink, 12
  br i1 %cmp12, label %for.inc, label %if.else

if.else:                                          ; preds = %lor.lhs.false11
  %cmp13 = icmp eq i32 %.sink, 4
  br i1 %cmp13, label %for.inc, label %lor.lhs.false14

lor.lhs.false14:                                  ; preds = %if.else
  %cmp15 = icmp eq i32 %.sink, 6
  br i1 %cmp15, label %for.inc, label %lor.lhs.false16

lor.lhs.false16:                                  ; preds = %lor.lhs.false14
  %cmp17 = icmp eq i32 %.sink, 9
  br i1 %cmp17, label %for.inc, label %lor.lhs.false18

lor.lhs.false18:                                  ; preds = %lor.lhs.false16
  %cmp19 = icmp eq i32 %.sink, 11
  br i1 %cmp19, label %for.inc, label %if.else22

if.else22:                                        ; preds = %lor.lhs.false18
  %cmp23 = icmp eq i32 %.sink, 2
  br i1 %cmp23, label %if.then24, label %for.inc

if.then24:                                        ; preds = %if.else22
  %rem = srem i32 %year, 400
  %cmp25 = icmp eq i32 %rem, 0
  br i1 %cmp25, label %for.inc, label %lor.lhs.false26

lor.lhs.false26:                                  ; preds = %if.then24
  %rem27 = srem i32 %year, 4
  %cmp28 = icmp eq i32 %rem27, 0
  br i1 %cmp28, label %land.lhs.true, label %for.inc

land.lhs.true:                                    ; preds = %lor.lhs.false26
  %rem29 = srem i32 %year, 100
  %cmp30 = icmp ne i32 %rem29, 0
  br i1 %cmp30, label %for.inc, label %for.inc

for.inc:                                          ; preds = %lor.lhs.false11, %lor.lhs.false9, %lor.lhs.false7, %lor.lhs.false5, %lor.lhs.false3, %lor.lhs.false, %for.body, %lor.lhs.false18, %lor.lhs.false16, %lor.lhs.false14, %if.else, %if.then24, %land.lhs.true, %land.lhs.true, %lor.lhs.false26, %if.else22
