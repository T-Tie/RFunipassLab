...
for.end49:                                        ; preds = %for.cond19
  ...
  %call51 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %5)
  br label %for.cond52
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %6 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !12
  %call58 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call55, i32 noundef %6)
