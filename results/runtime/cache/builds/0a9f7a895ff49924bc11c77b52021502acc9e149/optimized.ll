...
while.cond:                                       ; preds = %if.end29, %entry
  %sum.0 = phi i32 [ 0, %entry ], [ %sum.2, %if.end29 ]
  %i.0 = phi i32 [ 0, %entry ], [ %i.1, %if.end29 ]
...
if.end19:                                         ; preds = %if.then11, %if.else14
  %sum.1 = phi i32 [ %add, %if.then11 ], [ %add7, %if.else14 ]
  %cmp20 = icmp eq i32 %sum.1, 80
  br i1 %cmp20, label %if.end23.thread, label %if.end29
...
if.then25:                                        ; preds = %if.end.thread, %if.end
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  %sum.2 = phi i32 [ 0, %if.end23.thread ], [ %sum.1, %if.end19 ], [ %conv, %if.then25 ]
  %i.1 = phi i32 [ 0, %if.end23.thread ], [ %inc, %if.end19 ], [ 1, %if.then25 ]
...
do.end:                                           ; preds = %entry
  ...
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !8
...
if.then6:                                         ; preds = %if.else
  ...
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !8
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !8
...
if.then28:                                        ; preds = %if.then19
  ...
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !8
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !9
  %1 = load i32, ptr %__c2, align 4, !tbaa !9
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
!26 = !{!11, !11, i64 0}
!27 = !{!28, !11, i64 56}
!28 = !{!"_ZTSSt5ctypeIcE", !29, i64 0, !30, i64 16, !31, i64 24, !32, i64 32, !32, i64 40, !33, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
