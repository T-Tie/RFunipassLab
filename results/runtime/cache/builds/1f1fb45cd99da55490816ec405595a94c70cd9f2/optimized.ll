...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull %c) #4
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(10000) %c, i8 noundef 0, i64 noundef 10000, i1 noundef false) #5
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call.i = tail call i32 @getc(ptr noundef %0) #4
...
for.inc26:                                        ; preds = %for.cond19
  ...
  %call25 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef nonnull %arrayidx23) #4
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  br label %for.cond19, !llvm.loop !14

for.end27:                                        ; preds = %for.cond19
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %c) #4
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %c) #4
  ret i32 0
}
