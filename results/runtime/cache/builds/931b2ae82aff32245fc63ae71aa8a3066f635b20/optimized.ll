...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv21 = phi i32 [ %indvars.iv.next22, %while.cond ], [ -1, %entry ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %exitcond.not = icmp eq i64 %indvars.iv13, 100
...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %0 = ashr exact i64 %sext24, 32
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv21, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond14

for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv13
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv17 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next18, %for.inc25 ]
  %exitcond23.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond23.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %3 = xor i64 %indvars.iv17, -1
  %4 = add nsw i64 %3, %0
