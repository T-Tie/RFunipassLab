...
while.cond10.preheader:                           ; preds = %while.cond
  %smax29 = call i32 @llvm.smax.i32(i32 %t.0, i32 noundef 0)
  %2 = add nuw i32 %smax29, 1
...
while.cond10:                                     ; preds = %while.cond10.preheader, %while.end34
  %indvars.iv26.in = phi i32 [ %t.0, %while.cond10.preheader ], [ %indvars.iv26, %while.end34 ]
  %s.0 = phi i32 [ 1, %while.cond10.preheader ], [ %inc35, %while.end34 ]
  %indvars.iv26 = add i32 %indvars.iv26.in, -1
  %exitcond30 = icmp eq i32 %s.0, %2
  br i1 %exitcond30, label %while.cond37.preheader, label %while.cond13.preheader
...
while.cond37.preheader:                           ; preds = %while.cond10
  ...
  %wide.trip.count34 = zext nneg i32 %smax29 to i64
  br label %while.cond37

while.cond13:                                     ; preds = %while.cond13.preheader, %if.end32
  %indvars.iv22 = phi i64 [ 0, %while.cond13.preheader ], [ %indvars.iv.next23, %if.end32 ]
...
while.body15:                                     ; preds = %while.cond13
  %arrayidx17 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv22
  %6 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx19 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next23
...
while.cond37:                                     ; preds = %while.cond37.preheader, %if.end47
  %indvars.iv31 = phi i64 [ 0, %while.cond37.preheader ], [ %indvars.iv.next32, %if.end47 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count34
  br i1 %exitcond35.not, label %while.end49, label %while.body39

while.body39:                                     ; preds = %while.cond37
  %cmp40 = icmp eq i64 %indvars.iv31, 0
...
if.else:                                          ; preds = %while.body39
  %arrayidx45 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv31
