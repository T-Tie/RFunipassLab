...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc40
  %2 = phi i32 [ %0, %for.cond3.preheader ], [ %.pre, %for.inc40 ]
  %indvars.iv30 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next31, %for.inc40 ]
  %sum.0 = phi i64 [ 0, %for.cond3.preheader ], [ %sum.1, %for.inc40 ]
  %sub = add nsw i32 %2, -1
  %3 = sext i32 %sub to i64
  %cmp4 = icmp slt i64 %indvars.iv30, %3
  br i1 %cmp4, label %for.body5, label %for.end42

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv30
  ...
  %sext28 = shl i64 %add10, 32
  %conv12 = ashr exact i64 %sext28, 32
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %arrayidx15 = getelementptr inbounds nuw [1000 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv.next31
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #9
  %add18 = add i64 %conv12, %call17
  %cmp19 = icmp ult i64 %add18, 81
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx7, i64 noundef %call9)
  br i1 %cmp19, label %if.then, label %if.end

if.then:                                          ; preds = %for.body5
  %call1.i2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  br label %for.inc40
...
for.end42:                                        ; preds = %for.cond3
  ...
  %call.i.i5 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx45) #8
  %call1.i6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx45, i64 noundef %call.i.i5)
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #8
  call void @llvm.lifetime.end.p0(i64 noundef 50000, ptr noundef nonnull %word) #8
  ret i32 0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !13, !invariant.load !31
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !32, !invariant.load !31
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !38, !invariant.load !31
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !39, !invariant.load !31
  %vfn = getelementptr inbounds nuw i8, ptr %vtable, i64 48
  %2 = load ptr, ptr %vfn, align 8, !invariant.load !31
...
if.end_after_outline.exitStub:
  %vbase.offset.i = load i64, ptr %0, align 8, !invariant.load !31
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i
  %call.i8 = tail call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i, i8 noundef signext 10)
  %call1.i9 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i8)
  %call.i.i10 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i9)
  ret void
}
...
!31 = !{}
!32 = !{!33, !7, i64 56}
!33 = !{!"_ZTSSt5ctypeIcE", !34, i64 0, !35, i64 16, !26, i64 24, !36, i64 32, !36, i64 40, !37, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
