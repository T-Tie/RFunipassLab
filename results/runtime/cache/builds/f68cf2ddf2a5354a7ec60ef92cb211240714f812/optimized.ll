...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv10 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next11, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv10
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv18.in = phi i32 [ %0, %for.cond14.preheader ], [ %indvars.iv18, %for.cond17 ]
  %indvars.iv18 = add i32 %indvars.iv18.in, -1
  %cmp15 = icmp sgt i32 %indvars.iv18.in, 0
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc37
  %indvars.iv14 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next15, %for.inc37 ]
  %exitcond21.not = icmp eq i64 %indvars.iv14, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond14, label %for.body19, !llvm.loop !14

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv14
  %4 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next15
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc50 ], [ %6, %for.end41 ]
  %sub44 = add nsw i32 %7, -1
  %8 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv22, %8
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv22
