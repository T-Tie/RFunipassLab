...
if.end:                                           ; preds = %for.end30, %if.else
  %phiofops1 = phi i32 [ %8, %if.else ], [ %5, %for.end30 ]
...
if.end35:                                         ; preds = %if.end, %if.else34
  %phiofops = phi i32 [ %9, %if.else34 ], [ %10, %if.end ]
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %if.end35
  %11 = load i32, ptr %i, align 4, !tbaa !5
  %cmp37 = icmp slt i32 %11, %phiofops1
...
for.cond39:                                       ; preds = %for.inc46, %for.body38
  ...
  %cmp40 = icmp slt i32 %12, %phiofops
...
for.cond52:                                       ; preds = %for.inc83, %for.end51
  ...
  %cmp53 = icmp slt i32 %13, %phiofops1
...
for.cond55:                                       ; preds = %for.inc80, %for.body54
  ...
  %cmp56 = icmp slt i32 %14, %phiofops
...
for.inc77:                                        ; preds = %for.cond58
  ...
  %16 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  ...
  %17 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  ...
  %18 = load i32, ptr %arrayidx72, align 4, !tbaa !5, !invariant.load !17
...
for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %phiofops1 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  ...
  %cmp97 = icmp slt i32 %20, %phiofops1
...
for.cond118:                                      ; preds = %for.inc198, %for.end117
  ...
  %cmp119 = icmp slt i32 %.sink, %phiofops1
...
for.body120:                                      ; preds = %for.cond118
  ...
  %24 = load i32, ptr %arrayidx122, align 4, !tbaa !5, !invariant.load !17
  %cmp123 = icmp ne i32 %24, %phiofops
  br i1 %cmp123, label %if.then124, label %if.else151

if.then124:                                       ; preds = %for.body120
  %cmp125 = icmp eq i32 %phiofops1, 100
...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %25 = load i32, ptr %arrayidx133, align 16, !tbaa !5
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %25) #5
  br label %if.end136
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  %27 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %sub140 = sub nsw i32 %phiofops, %27
  %cmp141 = icmp slt i32 %26, %sub140
...
for.inc148:                                       ; preds = %for.cond137
  ...
  %idxprom145 = sext i32 %26 to i64
  %arrayidx146 = getelementptr inbounds [100 x i32], ptr %arrayidx144, i64 0, i64 %idxprom145
  %28 = load i32, ptr %arrayidx146, align 4, !tbaa !5
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %28) #5
  %inc149 = add nsw i32 %26, 1
...
if.else151:                                       ; preds = %for.body120
  ...
  %29 = load i32, ptr %arrayidx154, align 4, !tbaa !5
  %cmp155 = icmp ne i32 %29, %phiofops
...
for.cond158:                                      ; preds = %for.inc170, %if.then156
  ...
  %sub162 = sub nsw i32 %phiofops, %29
  %cmp163 = icmp slt i32 %30, %sub162
...
land.lhs.true181:                                 ; preds = %if.end178
  ...
  %32 = load i32, ptr %arrayidx184, align 4, !tbaa !5
  %cmp185 = icmp ne i32 %32, %phiofops
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  ...
  %33 = load i32, ptr %arrayidx193, align 4, !tbaa !5
  %cmp194 = icmp ne i32 %33, %phiofops
