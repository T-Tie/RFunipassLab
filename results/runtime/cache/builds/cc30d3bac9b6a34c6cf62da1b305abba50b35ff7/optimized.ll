...
entry.split:                                      ; preds = %entry
  ...
  %arrayidx3 = getelementptr inbounds nuw i8, ptr %s, i64 5
...
for.cond:                                         ; preds = %for.inc29, %entry.split
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc29 ], [ 1, %entry.split ]
...
for.body10:                                       ; preds = %for.cond7
  ...
  %arrayidx19 = getelementptr inbounds nuw [5 x i8], ptr %s, i64 %indvars.iv7, i64 %indvars.iv
...
for.end:                                          ; preds = %for.cond7
  ...
  br i1 %cmp23, label %for.inc29, label %cleanup.thread

cleanup.thread:                                   ; preds = %for.end
  %idxprom25 = and i64 %indvars.iv7, 4294967295
  br label %cleanup.cont

for.inc29:                                        ; preds = %for.cond, %for.end
...
cleanup.cont:                                     ; preds = %for.end31, %cleanup.thread
  %idxprom32.sink = phi i64 [ %idxprom32, %for.end31 ], [ %idxprom25, %cleanup.thread ]
  %arrayidx33 = getelementptr inbounds [200 x i32], ptr @num, i64 0, i64 %idxprom32.sink
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !12, !invariant.load !8
  %inc27.i2 = add nsw i32 %5, 1
  store i32 %inc27.i2, ptr %arrayidx33, align 4, !tbaa !12
  ret void
}
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc17
  %j.0 = phi i32 [ %inc27.i.i2, %for.inc17 ], [ 1, %for.cond.preheader ]
...
for.cond5.preheader:                              ; preds = %for.cond
  ...
  br i1 %cmp6, label %for.cond5.preheader.split, label %for.inc17
...
for.cond5:                                        ; preds = %for.cond5.preheader.split, %for.cond5
  %indvars.iv21 = phi i64 [ 0, %for.cond5.preheader.split ], [ %indvars.iv.next22, %for.cond5 ]
  %2 = add nuw nsw i64 %indvars.iv21, %idxprom12.le
  %arrayidx11 = getelementptr inbounds nuw [500 x i8], ptr %c, i64 0, i64 %2
  %3 = load i8, ptr %arrayidx11, align 1, !tbaa !5, !invariant.load !8
  %arrayidx15 = getelementptr inbounds nuw [200 x [5 x i8]], ptr %s, i64 0, i64 %idxprom12.le, i64 %indvars.iv21
...
for.inc17:                                        ; preds = %for.cond5.preheader
  ...
  %inc27.i.i2 = add nuw nsw i32 %j.0, 1
  br label %for.cond
...
for.cond42:                                       ; preds = %for.inc67, %if.else
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc67 ], [ 1, %if.else ]
  %4 = load i32, ptr @n, align 4, !tbaa !12
  %sub43 = sub nsw i32 %0, %4
  %5 = sext i32 %sub43 to i64
  %cmp45.not = icmp sgt i64 %indvars.iv18, %5
  br i1 %cmp45.not, label %if.end70, label %for.body47

for.body47:                                       ; preds = %for.cond42
  %arrayidx49 = getelementptr inbounds nuw [200 x i32], ptr @num, i64 0, i64 %indvars.iv18
  %6 = load i32, ptr %arrayidx49, align 4, !tbaa !12, !invariant.load !8
  %cmp50 = icmp eq i32 %6, 0
  br i1 %cmp50, label %for.cond53, label %for.inc67

for.cond53:                                       ; preds = %for.body47, %for.inc62
  %7 = phi i32 [ %.pre, %for.inc62 ], [ %4, %for.body47 ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc62 ], [ 0, %for.body47 ]
  %8 = sext i32 %7 to i64
  %cmp54 = icmp slt i64 %indvars.iv15, %8
  br i1 %cmp54, label %for.inc62, label %for.inc67

for.inc62:                                        ; preds = %for.cond53
  %arrayidx60 = getelementptr inbounds nuw [200 x [5 x i8]], ptr %s, i64 0, i64 %indvars.iv18, i64 %indvars.iv15
  %9 = load i8, ptr %arrayidx60, align 1, !tbaa !5, !invariant.load !8
  %call61 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %9)
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %.pre = load i32, ptr @n, align 4, !tbaa !12
  br label %for.cond53, !llvm.loop !14

for.inc67:                                        ; preds = %for.cond53, %for.body47
