...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20000, ptr %words) #9
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef %arrayidx6) #10
...
for.body19:                                       ; preds = %for.cond17
  ...
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call20, ptr noundef %arrayidx22)
  br label %for.inc25
...
for.end27:                                        ; preds = %for.cond17
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc55
...
if.then30:                                        ; preds = %if.end
  ...
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arrayidx32)
  br label %for.cond36
...
for.body38:                                       ; preds = %for.cond36
  ...
  %call43 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call39, ptr noundef %arrayidx41)
  br label %for.inc44
...
for.end46:                                        ; preds = %for.cond36
  %call50 = call i64 @strlen(ptr noundef %arrayidx6) #10
...
for.inc55:                                        ; preds = %if.end54, %for.end46, %for.end27
  %j.2 = phi i32 [ %add16, %for.end27 ], [ %add35, %for.end46 ], [ %j.0, %if.end54 ]
  %csum.1 = phi i32 [ 0, %for.end27 ], [ %conv52, %for.end46 ], [ %conv10, %if.end54 ]
...
for.end57:                                        ; preds = %for.cond2
  ...
  %call61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arrayidx59)
  br label %for.cond63
...
for.body65:                                       ; preds = %for.cond63
  ...
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call66, ptr noundef %arrayidx68)
  br label %for.inc71
...
for.end73:                                        ; preds = %for.cond63
  call void @llvm.lifetime.end.p0(i64 20000, ptr %words) #9
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !30
  ret i64 %0
}
...
!33 = !{!"p1 _ZTSSo", !25, i64 0}
!34 = !{!"bool", !7, i64 0}
!35 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !25, i64 0}
!36 = !{!"p1 _ZTSSt5ctypeIcE", !25, i64 0}
!37 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !25, i64 0}
!38 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !25, i64 0}
!39 = !{!40, !7, i64 56}
...
!42 = !{!"p1 _ZTS15__locale_struct", !25, i64 0}
!43 = !{!"p1 int", !25, i64 0}
!44 = !{!"p1 short", !25, i64 0}
