...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv2 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next3, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv2, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax17 = add nsw i32 %3, -1
  %wide.trip.count18 = zext nneg i32 %smax17 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv6 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next7, %for.inc40 ]
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %4 = trunc nuw i64 %indvars.iv.next7 to i32
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next7
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv14, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc74 ], [ %indvars.iv9, %for.body48 ]
...
for.body52:                                       ; preds = %for.cond50
  ...
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv11, i32 1
