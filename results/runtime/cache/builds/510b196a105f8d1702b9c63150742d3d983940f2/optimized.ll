...
entry:
  ...
  %smax47 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax47, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond49, label %for.cond15, label %for.cond4
...
for.cond15:                                       ; preds = %for.cond, %for.cond15.loopexit
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.cond15.loopexit ], [ 0, %for.cond ]
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.cond15.loopexit ], [ 1, %for.cond ]
  %exitcond59 = icmp eq i64 %indvars.iv55, %wide.trip.count48
  br i1 %exitcond59, label %for.cond45, label %for.body19
...
land.end:                                         ; preds = %for.cond45
  br i1 %cmp68, label %for.cond49, label %if.else71.loopexit

for.cond49:                                       ; preds = %land.end, %for.inc63
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc63 ], [ 0, %land.end ]
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  ...
  %smax68 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
...
for.cond74:                                       ; preds = %for.inc83, %if.else71
  ...
  br i1 %exitcond70.not, label %if.end86, label %for.inc83
