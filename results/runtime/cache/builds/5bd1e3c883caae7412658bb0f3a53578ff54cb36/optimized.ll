...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 500, ptr noundef nonnull align 16 %ch) #6
  br label %while.body
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 500, ptr noundef nonnull %ch) #7
  ret i32 0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !13, !invariant.load !8
  ret i64 %0
}
