...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv15 = phi i64 [ %3, %for.cond10.preheader ], [ %indvars.iv.next16, %for.cond13 ]
  %indvars.iv9 = phi i64 [ %2, %for.cond10.preheader ], [ %indvars.iv.next10, %for.cond13 ]
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  %indvars.iv.next10 = add nsw i64 %indvars.iv9, -1
  %cmp11 = icmp sgt i64 %indvars.iv15, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next16
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next16
  br label %for.cond13
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx19 = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv11
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv11
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %9, %for.end35 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count
  br i1 %exitcond22.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv18
