...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv7 = phi i64 [ %idxprom7, %for.cond2.preheader ], [ %indvars.iv.next8, %for.inc13 ]
  %indvars.iv.next8 = add nsw i64 %indvars.iv7, 1
  %cmp3 = icmp slt i64 %indvars.iv.next8, %0
  br i1 %cmp3, label %for.body4, label %for.cond20

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv.next8
...
for.cond20:                                       ; preds = %for.cond2, %for.body22
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body22 ], [ %idxprom7, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ undef, %for.cond2 ]
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, 1
  %cmp21 = icmp slt i64 %indvars.iv.next11, %0
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next11
