...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull %a) #4
...
while.body:                                       ; preds = %while.cond
  ...
  %1 = load i32, ptr %n, align 4, !tbaa !22
  %2 = zext i32 %1 to i64
  %cmp = icmp eq i64 %indvars.iv.next, %2
  br i1 %cmp, label %while.end, label %while.cond, !llvm.loop !23

while.end:                                        ; preds = %while.body, %while.cond
  %3 = load i32, ptr %a, align 16, !tbaa !22
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %3)
  br label %while.cond7

while.cond7:                                      ; preds = %if.end25, %while.end
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %if.end25 ], [ 1, %while.end ]
  %4 = load i32, ptr %n, align 4, !tbaa !22
  %5 = sext i32 %4 to i64
  %cmp8 = icmp slt i64 %indvars.iv18, %5
  br i1 %cmp8, label %for.cond.preheader, label %while.end27

for.cond.preheader:                               ; preds = %while.cond7
  %arrayidx12 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv18
  %6 = load i32, ptr %arrayidx12, align 4, !tbaa !22, !invariant.load !8
  br label %for.cond

for.cond:                                         ; preds = %for.body, %for.cond.preheader
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body ], [ 0, %for.cond.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %indvars.iv18
  br i1 %exitcond.not, label %if.then20, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx14 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv15
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !22, !invariant.load !8
  %cmp15 = icmp eq i32 %6, %7
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br i1 %cmp15, label %if.end25, label %for.cond, !llvm.loop !26
...
if.end25:                                         ; preds = %for.body, %if.then20
  ...
  br label %while.cond7, !llvm.loop !27

while.end27:                                      ; preds = %while.cond7
  %call1.i2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 1)
