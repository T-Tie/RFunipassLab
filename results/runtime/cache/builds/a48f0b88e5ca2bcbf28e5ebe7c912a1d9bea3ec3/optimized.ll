...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull %label) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #10
  call void @llvm.lifetime.start.p0(i64 noundef 50000, ptr noundef nonnull dereferenceable(50000) %str) #10
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(50000) %str, i8 noundef 0, i64 noundef 50000, i1 noundef false) #11
...
while.cond:                                       ; preds = %while.cond.preheader, %while.end
  %k.0 = phi i32 [ %sub, %while.end ], [ 0, %while.cond.preheader ]
...
while.cond4:                                      ; preds = %while.cond4.preheader, %while.body6
  %indvars.iv16 = phi i64 [ %4, %while.cond4.preheader ], [ %indvars.iv.next17, %while.body6 ]
...
while.body6:                                      ; preds = %while.cond4
  ...
  %arrayidx9 = getelementptr inbounds [1000 x [50 x i8]], ptr %str, i64 0, i64 %indvars.iv.next17
  %call11 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx9) #13
...
for.cond17:                                       ; preds = %while.cond, %for.inc32
  %8 = phi i32 [ %.pre, %for.inc32 ], [ %0, %while.cond ]
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc32 ], [ 1, %while.cond ]
  %str.pn = phi ptr [ %p.0, %for.inc32 ], [ %str, %while.cond ]
  %p.0 = getelementptr inbounds nuw i8, ptr %str.pn, i64 50
  %9 = sext i32 %8 to i64
  %cmp19.not.not = icmp slt i64 %indvars.iv19, %9
  br i1 %cmp19.not.not, label %for.body20, label %for.end34

for.body20:                                       ; preds = %for.cond17
  %arrayidx22 = getelementptr inbounds nuw [1000 x i32], ptr %label, i64 0, i64 %indvars.iv19
  %10 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !9
  %cmp23.not = icmp eq i32 %10, 1
  %call30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %p.0)
  br i1 %cmp23.not, label %if.else, label %if.then

if.then:                                          ; preds = %for.body20
  %call27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call30, ptr noundef nonnull @.str)
  br label %for.inc32
...
for.end34:                                        ; preds = %for.cond17
  %idxprom35 = and i64 %indvars.iv19, 4294967295
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50000, ptr noundef nonnull %str) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %label) #12
  ret i32 0
}
