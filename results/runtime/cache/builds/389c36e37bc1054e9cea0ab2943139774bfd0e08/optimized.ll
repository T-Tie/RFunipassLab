...
for.end:                                          ; preds = %for.cond
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %wide.trip.count43 = zext nneg i32 %smax42 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.cond29.preheader, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv38
...
for.cond29.preheader:                             ; preds = %for.cond4
  ...
  %smax48 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %wide.trip.count49 = zext nneg i32 %smax48 to i64
  br label %for.cond29

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv35 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next36, %for.body9 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv35
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv45 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next46, %for.inc36 ]
  %exitcond50.not = icmp eq i64 %indvars.iv45, %wide.trip.count49
  br i1 %exitcond50.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv45
