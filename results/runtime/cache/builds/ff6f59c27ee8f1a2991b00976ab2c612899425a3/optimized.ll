...
if.else26:                                        ; preds = %if.else19
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i13, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i22.loc)
...
if.then21_to_outline:
  store i8 32, ptr %0, align 1, !tbaa !40
  ...
  %2 = load i64, ptr %gep50, align 8, !tbaa !41, !invariant.load !11
