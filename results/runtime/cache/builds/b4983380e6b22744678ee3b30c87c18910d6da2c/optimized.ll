...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %b, i64 0, i64 %indvars.iv30, i64 %indvars.iv27
...
for.cond60:                                       ; preds = %for.cond13, %for.end78
  %i.3 = phi i32 [ %inc9.i3, %for.end78 ], [ 1, %for.cond13 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp61.not = icmp sgt i32 %i.3, %8
  br i1 %cmp61.not, label %for.end82, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %call66 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 undef)
  br label %for.cond67

for.cond67:                                       ; preds = %for.body69, %for.body62
  %j.3 = phi i32 [ 2, %for.body62 ], [ %inc9.i2, %for.body69 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp68.not = icmp sgt i32 %j.3, %9
  br i1 %cmp68.not, label %for.end78, label %for.body69

for.body69:                                       ; preds = %for.cond67
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  %call75 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call70, i32 undef)
  %inc9.i2 = add nuw nsw i32 %j.3, 1
  br label %for.cond67

for.end78:                                        ; preds = %for.cond67
  %call79 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %inc9.i3 = add nuw nsw i32 %i.3, 1
  br label %for.cond60
