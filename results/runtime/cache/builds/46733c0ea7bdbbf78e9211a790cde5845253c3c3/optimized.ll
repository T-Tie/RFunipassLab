...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %m1) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %m2) #6
...
for.inc53:                                        ; preds = %for.end, %for.end42
  %inc54 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !13

for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %x) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %m2) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %m1) #6
