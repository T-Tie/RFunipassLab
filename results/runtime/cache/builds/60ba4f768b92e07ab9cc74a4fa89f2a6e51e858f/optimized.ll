...
if.end49:                                         ; preds = %if.end17
  ...
  call void @outlined_ir_func_0(double %div26, ptr noundef nonnull dereferenceable(7) @.str.6)
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %div22)
  call void @outlined_ir_func_0(double %div31, ptr noundef nonnull dereferenceable(8) @.str.8)
  br label %for.inc
...
define internal void @outlined_ir_func_0(double %0, ptr noundef nonnull dereferenceable(7) %1) #5 {
