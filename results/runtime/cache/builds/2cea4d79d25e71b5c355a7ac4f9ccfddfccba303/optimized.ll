...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %h) #5
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %len) #5
...
for.cond3:                                        ; preds = %if.end32, %for.end
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %if.end32 ], [ 1, %for.end ]
  %ans.0 = phi i32 [ %spec.select20, %if.end32 ], [ 1, %for.end ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.end42, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond3
  %arrayidx12 = getelementptr inbounds nuw [25 x i32], ptr %h, i64 0, i64 %indvars.iv26
  %2 = load i32, ptr %arrayidx12, align 4, !tbaa !5
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc21
  %indvars.iv23 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next24, %for.inc21 ]
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [25 x i32], ptr %h, i64 0, i64 %indvars.iv23
  %3 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %cmp13.not = icmp slt i32 %3, %2
  br i1 %cmp13.not, label %for.inc21, label %if.then

if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv23
...
if.end32:                                         ; preds = %for.end23, %if.else
  ...
  %7 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv26
...
for.end42:                                        ; preds = %for.cond3
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call43, i8 noundef signext %call.i21)
  %call.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %len) #5
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %h) #5
