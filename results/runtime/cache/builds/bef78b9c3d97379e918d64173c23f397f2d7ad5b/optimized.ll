...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %3 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre39, %for.inc ]
...
for.cond8:                                        ; preds = %for.cond8.preheader, %for.inc25
  ...
  br i1 %exitcond28.not, label %for.end27.loopexit40, label %for.cond11
...
for.end27.loopexit:                               ; preds = %for.body13
  ...
  %.pre38 = and i64 %indvars.iv23, 4294967295
  br label %for.end27

for.end27.loopexit40:                             ; preds = %for.cond8
  br label %for.end27

for.end27:                                        ; preds = %for.end27.loopexit40, %for.end27.loopexit
  %idxprom31.pre-phi = phi i64 [ %.pre38, %for.end27.loopexit ], [ %2, %for.end27.loopexit40 ]
  %i.114 = phi i32 [ %6, %for.end27.loopexit ], [ %smax, %for.end27.loopexit40 ]
  %y1.0 = phi i32 [ %7, %for.end27.loopexit ], [ undef, %for.end27.loopexit40 ]
  %cmp943 = icmp slt i64 %indvars.iv23, %1
  %8 = sext i32 %y1.0 to i64
  %smax32 = call i32 @llvm.smax.i32(i32 %y1.0, i32 %0)
...
for.cond43:                                       ; preds = %for.body45, %for.end42
  ...
  %phiofops = phi i1 [ true, %for.body45 ], [ %cmp943, %for.end42 ]
...
for.body45:                                       ; preds = %for.cond43
  ...
  br i1 %or.cond2, label %for.end59, label %for.cond43, !llvm.loop !16

for.end59:                                        ; preds = %for.body45, %for.cond43
  %13 = trunc nuw nsw i64 %indvars.iv36 to i32
  %sub = sub nsw i32 %13, %i.114
