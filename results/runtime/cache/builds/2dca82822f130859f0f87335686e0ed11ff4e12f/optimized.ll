...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %s_all) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %s_good) #6
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %all) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %good) #6
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %good) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %all) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_good) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_all) #6
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) initializes((0, 1)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %1) unnamed_addr #4 {
if.then15_to_outline:
  store i8 10, ptr %0, align 1, !tbaa !15
  %vbase.offset.i = load i64, ptr %1, align 8, !invariant.load !11
  %gep31 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %2 = load i64, ptr %gep31, align 8, !tbaa !16, !invariant.load !11
