...
for.cond:                                         ; preds = %for.inc, %entry
  %n.promoted11 = phi i32 [ %n.promoted, %entry ], [ %sub, %for.inc ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ]
  %cmp = icmp sgt i32 %n.promoted11, 99
...
for.inc15:                                        ; preds = %for.cond10
  %sub11 = add nsw i32 %n.promoted15, -20
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc23
  %n.promoted17 = phi i32 [ %sub19, %for.inc23 ], [ %n.promoted15, %for.cond18.preheader ]
  %c.0 = phi i32 [ %inc24, %for.inc23 ], [ 0, %for.cond18.preheader ]
  %cmp20 = icmp sgt i32 %n.promoted17, 9
...
for.inc23:                                        ; preds = %for.cond18
  %sub19 = add nsw i32 %n.promoted17, -10
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc31
  %n.promoted19 = phi i32 [ %sub27, %for.inc31 ], [ %n.promoted17, %for.cond26.preheader ]
  %d.0 = phi i32 [ %inc32, %for.inc31 ], [ 0, %for.cond26.preheader ]
  %cmp28 = icmp sgt i32 %n.promoted19, 4
  br i1 %cmp28, label %for.inc31, label %for.cond34.preheader

for.cond34.preheader:                             ; preds = %for.cond26
  %smin = call i32 @llvm.smin.i32(i32 %n.promoted19, i32 noundef 0)
  %0 = sub i32 %n.promoted19, %smin
  br label %for.cond34

for.inc31:                                        ; preds = %for.cond26
  %sub27 = add nsw i32 %n.promoted19, -5
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc39
  %sub3520 = phi i32 [ %sub35, %for.inc39 ], [ %n.promoted19, %for.cond34.preheader ]
