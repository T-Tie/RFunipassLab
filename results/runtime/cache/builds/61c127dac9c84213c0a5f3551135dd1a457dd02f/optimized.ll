...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv14
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc15 ], [ %indvars.iv8, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv10
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv28.in = phi i32 [ %indvars.iv28, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv28 = add i32 %indvars.iv28.in, -1
  %indvars.iv.next22 = add nsw i64 %indvars.iv21, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next22
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv24 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next25, %for.inc39 ]
  %exitcond32.not = icmp eq i64 %indvars.iv24, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv24
