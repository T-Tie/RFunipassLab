...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000000, ptr noundef nonnull %a) #6
...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count39 = zext i32 %narrow to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre45, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv35 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next36, %for.inc27 ]
  %exitcond40 = icmp eq i64 %indvars.iv35, %wide.trip.count39
  br i1 %exitcond40, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc21 ], [ 1, %for.cond10 ]
  %exitcond = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv35, i64 %indvars.iv31
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.126 = phi i32 [ %6, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc48 ], [ %9, %for.end29 ]
  %10 = trunc nuw i64 %indvars.iv42 to i32
  %cmp31 = icmp sgt i32 %10, 0
  br i1 %cmp31, label %for.cond33, label %for.end50

for.cond33:                                       ; preds = %for.cond30, %for.inc43
  %j.2 = phi i32 [ %dec, %for.inc43 ], [ %0, %for.cond30 ]
  %cmp34 = icmp sgt i32 %j.2, 0
  br i1 %cmp34, label %for.body35, label %for.inc48

for.body35:                                       ; preds = %for.cond33
  %idxprom38 = zext nneg i32 %j.2 to i64
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv42, i64 %idxprom38
...
for.end50:                                        ; preds = %for.cond30, %for.body35
  ...
  %call54 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %mul) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4000000, ptr noundef nonnull %a) #7
