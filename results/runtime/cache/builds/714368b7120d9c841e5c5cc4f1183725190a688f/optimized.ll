...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i4) #7
...
for.inc28:                                        ; preds = %for.body12, %for.cond9
  ...
  store i32 %inc29, ptr %i4, align 4, !tbaa !5
  br label %for.cond5, !llvm.loop !14

for.end31:                                        ; preds = %for.cond5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i4) #7
