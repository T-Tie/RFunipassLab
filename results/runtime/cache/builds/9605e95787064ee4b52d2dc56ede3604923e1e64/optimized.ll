...
if.then:                                          ; preds = %for.body4
  ...
  %idxprom28 = ashr exact i64 %sext1, 32
...
for.inc74:                                        ; preds = %if.then, %if.then44, %if.else58, %if.then33
  ...
  %j.1 = phi i32 [ %inc30, %if.then ], [ 0, %if.then33 ], [ %inc71, %if.else58 ], [ %inc57, %if.then44 ]
...
for.body96:                                       ; preds = %for.cond94
  ...
  %8 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv9, i64 %indvars.iv6
