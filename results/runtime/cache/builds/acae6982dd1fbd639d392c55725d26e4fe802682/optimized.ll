...
for.cond:                                         ; preds = %for.inc10, %while.body
  %.pre9 = phi i32 [ %.pre911, %for.inc10 ], [ %.pre, %while.body ]
  %0 = phi i32 [ %2, %for.inc10 ], [ %.pre, %while.body ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc10 ], [ 0, %while.body ]
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv5, %1
  br i1 %cmp, label %for.cond3, label %for.cond13

for.cond3:                                        ; preds = %for.cond, %for.inc
  %.pre911 = phi i32 [ %.pre910, %for.inc ], [ %.pre9, %for.cond ]
  %2 = phi i32 [ %6, %for.inc ], [ %.pre9, %for.cond ]
...
for.body6:                                        ; preds = %for.cond3
  %4 = or i64 %indvars.iv, %indvars.iv5
...
for.inc:                                          ; preds = %for.body6, %if.then
  %.pre910 = phi i32 [ %.pre911, %for.body6 ], [ %.pre8, %if.then ]
  %6 = phi i32 [ %2, %for.body6 ], [ %.pre8, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
