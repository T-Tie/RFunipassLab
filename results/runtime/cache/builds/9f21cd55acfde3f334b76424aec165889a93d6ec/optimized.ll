...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv13 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next14, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax29 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
  %wide.trip.count30 = zext nneg i32 %smax29 to i64
  %wide.trip.count23 = zext i32 %j.0 to i64
  br label %for.cond15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv13
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond31.not = icmp eq i64 %indvars.iv25, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv25
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc37 ], [ %indvars.iv17, %for.body17 ]
  %exitcond24.not = icmp eq i64 %indvars.iv19, %wide.trip.count23
  br i1 %exitcond24.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv19
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv32 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next33, %for.inc53 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count30
  br i1 %exitcond36.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv32
  ...
  %cmp49 = icmp slt i64 %indvars.iv32, %4
