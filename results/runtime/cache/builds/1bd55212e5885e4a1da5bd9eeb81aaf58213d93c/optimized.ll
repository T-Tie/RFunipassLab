...
if.end28:                                         ; preds = %if.then23, %if.end
  %.pre-phi21 = phi double [ %.pre20, %if.then23 ], [ %.pre-phi15, %if.end ]
  %mul30.pre-phi = phi double [ %.pre16, %if.then23 ], [ %mul19.pre-phi, %if.end ]
  %9 = phi double [ %.pre10, %if.then23 ], [ %6, %if.end ]
  %10 = phi double [ %.pre9, %if.then23 ], [ %7, %if.end ]
  %11 = phi double [ %.pre8, %if.then23 ], [ %8, %if.end ]
  %cmp33 = fcmp olt double %.pre-phi21, 0.000000e+00
