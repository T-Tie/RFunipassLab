...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %a) #11
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %b) #11
...
for.inc:                                          ; preds = %for.cond
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERf(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %a)
...
for.body5:                                        ; preds = %for.cond3
  ...
  %7 = load float, ptr %arrayidx7, align 4, !tbaa !9, !invariant.load !14
...
if.then:                                          ; preds = %for.body5
  %call10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(7) @.str)
  br label %for.inc25
...
if.then18:                                        ; preds = %if.else
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str.1)
  br label %for.inc25

if.else21:                                        ; preds = %if.else
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str.2)
  br label %for.inc25

for.inc25:                                        ; preds = %if.then, %if.else21, %if.then18
  %call22.sink = phi ptr [ %call22, %if.else21 ], [ %call19, %if.then18 ], [ %call10, %if.then ]
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call22.sink, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %inc26 = add nsw i32 %j.0, 1
  br label %for.cond3, !llvm.loop !15

for.end27:                                        ; preds = %for.cond3
  call void @llvm.stackrestore.p0(ptr %2)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %a) #11
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !16, !invariant.load !14
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !16, !invariant.load !14
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !14
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !18, !invariant.load !14
  ret i32 %0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !37, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !43, !invariant.load !14
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !16, !invariant.load !14
