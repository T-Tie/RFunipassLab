...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc8 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv8, %2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv8, i64 %indvars.iv
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv65 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next66, %for.end138 ]
  %indvars.iv62 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next63, %for.end138 ]
...
for.cond14:                                       ; preds = %while.cond11, %for.inc49
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc49 ], [ 0, %while.cond11 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv65
  br i1 %exitcond23.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv19
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body22 ], [ 0, %for.body16 ]
  %min.0 = phi i32 [ %spec.select, %for.body22 ], [ %9, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv11, %indvars.iv65
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv11
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv14 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next15, %for.inc46 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv65
  br i1 %exitcond18.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv14
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %indvars.iv65
  br i1 %exitcond38.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv34
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select6, %for.body60 ], [ %12, %for.body54 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv65
  br i1 %exitcond28.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv34
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %spec.select6 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond58, !llvm.loop !16

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv29 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next30, %for.inc87 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv65
  br i1 %exitcond33.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv34
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %indvars.iv65
  br i1 %exitcond51.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc111 ], [ 1, %for.cond95 ]
  %exitcond46.not = icmp eq i64 %indvars.iv39, %indvars.iv62
  br i1 %exitcond46.not, label %for.inc114, label %for.inc111

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next40
  %16 = load i32, ptr %arrayidx106, align 4, !tbaa !5
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv39
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %indvars.iv65
  br i1 %exitcond61.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc133 ], [ 1, %for.cond117 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %indvars.iv62
  br i1 %exitcond56.not, label %for.inc136, label %for.inc133

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next53, i64 %indvars.iv57
  %17 = load i32, ptr %arrayidx128, align 4, !tbaa !5
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv52, i64 %indvars.iv57
...
for.end138:                                       ; preds = %for.cond117
  ...
  %indvars68 = trunc i64 %indvars.iv.next66 to i32
  store i32 %indvars68, ptr %n, align 4, !tbaa !5
