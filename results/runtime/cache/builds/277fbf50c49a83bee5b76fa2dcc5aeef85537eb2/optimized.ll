...
while.body:                                       ; preds = %entry, %if.end
  %indvars.iv6 = phi i32 [ 0, %entry ], [ %indvars.iv.next7, %if.end ]
...
for.inc:                                          ; preds = %for.cond
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr %d, i64 0, i64 %indvars.iv3
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %add = add nsw i32 %6, 12
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv3
  %7 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %.neg = sub i32 0, %7
  %sub38 = add i32 %add, %.neg
  %mul = mul nsw i32 %sub38, 3600
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %e, i64 0, i64 %indvars.iv3
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx42 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv3
  %9 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %sub43 = sub nsw i32 %8, %9
  %mul44 = mul nsw i32 %sub43, 60
  %arrayidx47 = getelementptr inbounds nuw [1000 x i32], ptr %f, i64 0, i64 %indvars.iv3
  %10 = load i32, ptr %arrayidx47, align 4, !tbaa !5
  %arrayidx49 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv3
  %11 = load i32, ptr %arrayidx49, align 4, !tbaa !5
  %sub50 = add i32 %10, %mul
  %add45 = add i32 %sub50, %mul44
  %.neg8 = sub i32 0, %11
  %add51 = add i32 %add45, %.neg8
