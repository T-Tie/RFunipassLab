...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %land.lhs.true.i, %if.then19.i, %if.then28.i
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %initial) #7
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call.i.i44 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %word) #7
