...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv10 = phi i32 [ %indvars.iv.next11, %while.cond ], [ -1, %entry ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %exitcond.not = icmp eq i64 %indvars.iv2, 100
  br i1 %exitcond.not, label %for.cond14.preheader, label %for.body

for.cond14.preheader:                             ; preds = %for.cond
  %sext13 = shl i64 %indvars.iv, 32
  %0 = ashr exact i64 %sext13, 32
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv10, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond14

for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv2
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  ...
  %exitcond12.not = icmp eq i64 %indvars.iv6, %wide.trip.count
  br i1 %exitcond12.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %3 = xor i64 %indvars.iv6, -1
  %4 = add nsw i64 %0, %3
