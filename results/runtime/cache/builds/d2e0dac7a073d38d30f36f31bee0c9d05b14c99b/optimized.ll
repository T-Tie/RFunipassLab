...
for.cond25:                                       ; preds = %if.end35, %if.end24
  %storemerge3 = phi i32 [ 65, %if.end24 ], [ %inc37.i, %if.end35 ]
...
if.end35:                                         ; preds = %if.then31, %for.body27
  %7 = phi i32 [ %.pre7, %if.then31 ], [ %storemerge3, %for.body27 ]
  %inc37.i = add nsw i32 %7, 1
  br label %for.cond25

for.cond39:                                       ; preds = %for.cond25, %if.end49
  %storemerge4 = phi i32 [ %inc37.i1, %if.end49 ], [ 97, %for.cond25 ]
...
if.end49:                                         ; preds = %if.then45, %for.body41
  %9 = phi i32 [ %.pre, %if.then45 ], [ %storemerge4, %for.body41 ]
  %inc37.i1 = add nsw i32 %9, 1
  br label %for.cond39
