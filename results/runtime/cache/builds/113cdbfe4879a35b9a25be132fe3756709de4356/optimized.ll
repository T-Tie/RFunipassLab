...
for.end:                                          ; preds = %for.cond
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call5, i8 noundef signext %call.i2)
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax10 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
  %wide.trip.count = zext nneg i32 %smax10 to i64
  br label %for.cond9
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  ...
  %exitcond11.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond11.not, label %cleanup, label %for.inc16
