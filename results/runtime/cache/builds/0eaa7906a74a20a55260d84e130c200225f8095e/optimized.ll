...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count50 = zext i32 %narrow to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre56, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv46 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next47, %for.inc27 ]
  %exitcond51 = icmp eq i64 %indvars.iv46, %wide.trip.count50
  br i1 %exitcond51, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc21 ], [ 1, %for.cond10 ]
  %exitcond = icmp eq i64 %indvars.iv42, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv42
...
for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.136 = phi i32 [ %6, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %8, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %9 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc48 ], [ %9, %for.end29 ]
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv53, i64 %idxprom38
