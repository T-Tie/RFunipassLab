...
for.end9:                                         ; preds = %for.cond2
  %a.0.lcssa = phi i32 [ %a.0, %for.cond2 ]
  br label %for.cond10
...
for.end17:                                        ; preds = %for.cond10
  %b.0.lcssa = phi i32 [ %b.0, %for.cond10 ]
  br label %for.cond18
...
for.end25:                                        ; preds = %for.cond18
  %c.0.lcssa = phi i32 [ %c.0, %for.cond18 ]
  br label %for.cond26
...
for.end41:                                        ; preds = %for.cond34
  %e.0.lcssa = phi i32 [ %e.0, %for.cond34 ]
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %i.0.lcssa, i32 noundef %a.0.lcssa, i32 noundef %b.0.lcssa, i32 noundef %c.0.lcssa, i32 noundef %d.0.lcssa, i32 noundef %e.0.lcssa) #5
