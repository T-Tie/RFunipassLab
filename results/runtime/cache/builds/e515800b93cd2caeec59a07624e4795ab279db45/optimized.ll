...
land.lhs.true.i18:                                ; preds = %if.then6.i12
  ...
  %2 = load i64, ptr %_M_width.i4.i19, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -301
...
land.lhs.true.i45:                                ; preds = %if.then6.i39
  ...
  %4 = load i64, ptr %_M_width.i4.i46, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -301
  %or.cond.i49 = icmp ult i64 %5, -300
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit58: ; preds = %if.then6.i39, %land.lhs.true.i45, %if.then19.i50, %if.then28.i57
  %call7 = call noundef ptr @strstr(ptr noundef nonnull align 16 dereferenceable(300) %s, ptr noundef nonnull dereferenceable(1) %sub) #13
  %tobool.not = icmp eq ptr %call7, null
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit58
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull captures(none) %sub) #12
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull captures(none) %rep) #12
  call void @llvm.lifetime.end.p0(i64 noundef 300, ptr noundef nonnull captures(none) %s) #12
  ret i32 0
}
