...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 101, ptr noundef nonnull align 16 dereferenceable(101) %a) #9
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 101, ptr noundef %a) #10
  ret i32 0
}
