...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit28:
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 %add.ptr10.i)
...
entry_to_outline:
  %call16.i = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #11
  br i1 %call16.i, label %land.lhs.true.i, label %if.then6.i9.exitStub

land.lhs.true.i:                                  ; preds = %entry_to_outline
  %_M_width.i2.i = getelementptr inbounds nuw i8, ptr %0, i64 16
  %1 = load i64, ptr %_M_width.i2.i, align 8, !tbaa !17, !invariant.load !8
  %2 = add i64 %1, -1001
  %or.cond.i = icmp ult i64 %2, -1000
  br i1 %or.cond.i, label %if.then19.i, label %if.then6.i9.exitStub

if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %0) #11
