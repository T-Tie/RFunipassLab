...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc11 ], [ %2, %entry ]
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  ...
  %cmp4 = icmp slt i64 %indvars.iv.next2, %5
...
for.inc:                                          ; preds = %for.cond3
  ...
  %call9 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %6)
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %call20 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %7)
