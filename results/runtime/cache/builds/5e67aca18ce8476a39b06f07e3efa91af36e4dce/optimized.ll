...
for.cond6:                                        ; preds = %for.inc16, %for.body4
  ...
  %5 = load i8, ptr %4, align 1, !tbaa !15, !invariant.load !16
...
if.then:                                          ; preds = %for.body9
  ...
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !5, !invariant.load !16
...
for.inc19:                                        ; preds = %for.cond6
  ...
  %incdec.ptr20 = getelementptr inbounds nuw i8, ptr %2, i32 1
...
for.cond23:                                       ; preds = %for.inc38, %for.end21
  %9 = load ptr, ptr %q, align 8, !tbaa !12
  %10 = load i8, ptr %9, align 1, !tbaa !15, !invariant.load !16
...
for.body26:                                       ; preds = %for.cond23
  ...
  %12 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !16
  %cmp29 = icmp ne i32 %12, 0
  br i1 %cmp29, label %if.then30, label %for.inc38

if.then30:                                        ; preds = %for.body26
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv24, i32 noundef %12)
...
for.inc38:                                        ; preds = %for.body26, %if.then30
  ...
  %incdec.ptr39 = getelementptr inbounds nuw i8, ptr %9, i32 1
