...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv8
...
while.end:                                        ; preds = %while.cond
  %indvars20.le = trunc i64 %indvars.iv8 to i32
  %sub = shl i64 %indvars.iv8, 32
  ...
  %sub7 = add nsw i32 %indvars20.le, -2
  br label %for.cond8
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv11 = phi i64 [ %0, %while.cond11.preheader ], [ %indvars.iv.next12, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %1 = trunc nuw i64 %indvars.iv.next12 to i32
  %cmp12 = icmp slt i32 %1, %indvars20.le
  br i1 %cmp12, label %while.body13, label %for.inc29

while.body13:                                     ; preds = %while.cond11
  %2 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next12
...
land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next12
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv14 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next15, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select6, %for.body33 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond19.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv14
  %5 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  %spec.select6 = tail call i32 @llvm.smax.i32(i32 %5, i32 %n.2)
