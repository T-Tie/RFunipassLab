...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %montho) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %montht) #7
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %montht) #7
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %montho) #7
