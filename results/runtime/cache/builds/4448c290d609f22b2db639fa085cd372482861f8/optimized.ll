...
if.then21:                                        ; preds = %if.then
  %fneg = fneg double %2
  %call25 = call double @sqrt(double noundef %5) #7, !tbaa !5
  %add26 = fadd double %fneg, %call25
  %mul29 = fmul double 2.000000e+00, %3
  %div = fdiv double %add26, %mul29
  %call34 = call double @sqrt(double noundef %5) #7, !tbaa !5
...
if.then53:                                        ; preds = %if.end51
  ...
  %call63 = call double @sqrt(double noundef %fneg62) #7, !tbaa !5
