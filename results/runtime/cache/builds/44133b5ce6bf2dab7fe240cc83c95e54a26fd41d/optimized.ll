...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 3300, ptr %c) #7
  call void @llvm.memset.p0.i64(ptr align 16 %c, i8 0, i64 3300, i1 false)
...
for.cond21:                                       ; preds = %for.inc47, %for.end19
  %i20.0 = phi i32 [ 0, %for.end19 ], [ %inc48, %for.inc47 ]
...
for.cond28:                                       ; preds = %for.inc44, %for.body25
  %i20.0.sink = phi i32 [ %i20.0, %for.body25 ], [ %add27, %for.inc44 ]
  %add27 = add nsw i32 %i20.0.sink, 1
...
if.end91:                                         ; preds = %for.cond73, %if.then67
  ...
  call void @llvm.lifetime.end.p0(i64 3300, ptr %c) #7
