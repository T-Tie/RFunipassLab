...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv22, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre30, %for.body4 ]
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.end25
  %i.1 = phi i32 [ %i.2, %for.end25 ], [ 0, %for.cond11.preheader ]
  %r1.0 = phi i32 [ %r1.1, %for.end25 ], [ undef, %for.cond11.preheader ]
  %c1.0 = phi i32 [ %c1.1, %for.end25 ], [ undef, %for.cond11.preheader ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %if.end
  %indvars.iv26 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next27, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond.not, label %for.end25.loopexit, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv26
  %4 = load i32, ptr %add.ptr21, align 4, !tbaa !5, !invariant.load !13
  %cmp22 = icmp eq i32 %4, 0
  br i1 %cmp22, label %for.end25.split.loop.exit32, label %if.end

if.end:                                           ; preds = %for.body16
  %indvars.iv.next27 = add nuw nsw i64 %indvars.iv26, 1
  br label %for.cond14, !llvm.loop !14

for.end25.split.loop.exit32:                      ; preds = %for.body16
  %5 = trunc nuw nsw i64 %indvars.iv26 to i32
  br label %for.end25

for.end25.loopexit:                               ; preds = %for.cond14
  %6 = add nsw i32 %i.1, 1
  br label %for.end25

for.end25:                                        ; preds = %for.end25.loopexit, %for.end25.split.loop.exit32
  %i.2 = phi i32 [ 10000, %for.end25.split.loop.exit32 ], [ %6, %for.end25.loopexit ]
  %r1.1 = phi i32 [ %i.1, %for.end25.split.loop.exit32 ], [ %r1.0, %for.end25.loopexit ]
  %c1.1 = phi i32 [ %5, %for.end25.split.loop.exit32 ], [ %c1.0, %for.end25.loopexit ]
...
for.cond29:                                       ; preds = %for.end45, %for.end28
  %i.3 = phi i32 [ %sub, %for.end28 ], [ %dec47, %for.end45 ]
  %r2.0 = phi i32 [ undef, %for.end28 ], [ %r2.1, %for.end45 ]
  %c2.0 = phi i32 [ undef, %for.end28 ], [ %c2.1, %for.end45 ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %if.end43
  %j.2 = phi i32 [ %dec, %if.end43 ], [ %sub, %for.cond33.preheader ]
...
for.body35:                                       ; preds = %for.cond33
  ...
  %7 = load i32, ptr %add.ptr40, align 4, !tbaa !5, !invariant.load !13
  %cmp41 = icmp eq i32 %7, 0
  br i1 %cmp41, label %for.end45, label %if.end43

if.end43:                                         ; preds = %for.body35
  %dec = add nsw i32 %j.2, -1
  br label %for.cond33, !llvm.loop !16

for.end45:                                        ; preds = %for.cond33, %for.body35
  %i.4 = phi i32 [ -1, %for.body35 ], [ %i.3, %for.cond33 ]
  %r2.1 = phi i32 [ %i.3, %for.body35 ], [ %r2.0, %for.cond33 ]
  %c2.1 = phi i32 [ %j.2, %for.body35 ], [ %c2.0, %for.cond33 ]
