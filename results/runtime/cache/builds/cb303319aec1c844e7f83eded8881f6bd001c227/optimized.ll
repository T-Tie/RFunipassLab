...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef range(i32 0, 2147483647) i32 @_Z5qufeni(i32 noundef %1) #10
  %2 = call i32 @llvm.umax.i32(i32 noundef %call2, i32 noundef 1)
  %umax = add nuw nsw i32 %2, 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %while.body
  %i.0 = phi i32 [ 2, %while.body ], [ %inc, %for.inc ]
  %sum.0 = phi i32 [ 1, %while.body ], [ %add, %for.inc ]
  %exitcond = icmp eq i32 %i.0, %umax
