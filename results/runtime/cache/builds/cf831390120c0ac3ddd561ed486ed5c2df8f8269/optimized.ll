...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %3 = phi i32 [ %add, %for.inc19 ], [ 1, %for.end ]
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc19 ], [ %idxprom2, %for.end ]
  %cmp6 = icmp sgt i64 %indvars.iv4, 0
  %indvars.iv.next5 = add nsw i64 %indvars.iv4, -1
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next5
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
  %arrayidx12 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv4
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.end47 ], [ %7, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %cmp23 = icmp sgt i64 %indvars.iv10, -1
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds nuw [30 x i32], ptr %a, i64 0, i64 %indvars.iv10
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv7 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next8, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %cmp30 = icmp sgt i64 %indvars.iv7, %indvars.iv10
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %8 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv7
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv7
  ...
  %spec.select1 = call i32 @llvm.smax.i32(i32 %10, i32 %sum.0)
  br label %for.inc45
...
for.end47:                                        ; preds = %for.cond29
  ...
  %11 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv10
  store i32 %add53.sink, ptr %11, align 4, !tbaa !5
  %indvars.iv.next11 = add nsw i64 %indvars.iv10, -1
  br label %for.cond22, !llvm.loop !15

for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv13 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next14, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select2, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv13
  %12 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select2 = call i32 @llvm.smax.i32(i32 %12, i32 %sum.2)
