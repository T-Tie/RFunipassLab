...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40000, ptr %num) #10
  call void @llvm.lifetime.start.p0(i64 60000, ptr %c) #10
  call void @llvm.lifetime.start.p0(i64 600, ptr %input) #10
...
for.cond:                                         ; preds = %for.inc18, %entry
  ...
  %call4 = call i64 @strlen(ptr noundef %input) #11
...
for.body34:                                       ; preds = %for.cond32
  ...
  %call41 = call i32 @strcmp(ptr noundef %arrayidx36, ptr noundef %arrayidx39) #11
...
if.end92:                                         ; preds = %if.then71, %for.end91
  call void @llvm.lifetime.end.p0(i64 600, ptr %input) #10
  call void @llvm.lifetime.end.p0(i64 60000, ptr %c) #10
  call void @llvm.lifetime.end.p0(i64 40000, ptr %num) #10
...
if.then71_to_outline:                             ; preds = %newFuncRoot
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
