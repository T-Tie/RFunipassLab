...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 captures(none) dereferenceable(100000) %a) #11
  br label %for.cond
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef captures(none) %a) #12
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @getc(ptr noundef %0) #12
  ret i32 %call
}
