...
for.cond:                                         ; preds = %if.end30, %entry
  %i1.0 = phi i32 [ 0, %entry ], [ %inc, %if.end30 ]
  %jn.0 = phi i32 [ 0, %entry ], [ %jn.1, %if.end30 ]
...
for.cond10:                                       ; preds = %if.end, %if.then
  %i2.0 = phi i32 [ %add, %if.then ], [ %dec, %if.end ]
...
for.cond33:                                       ; preds = %for.body36, %for.end32
  %i3.0 = phi i32 [ 1, %for.end32 ], [ %inc41, %for.body36 ]
  %cmp34 = icmp slt i32 %i3.0, %jn.0
  br i1 %cmp34, label %for.body36, label %for.end42
...
for.body36:                                       ; preds = %for.cond33
  ...
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %9)
...
for.end42:                                        ; preds = %for.cond33
  ...
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10)
