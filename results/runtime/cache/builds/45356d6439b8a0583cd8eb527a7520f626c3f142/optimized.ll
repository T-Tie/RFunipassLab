...
if.then:                                          ; preds = %for.body
  %call10 = call double @sqrt(double noundef %5) #9, !tbaa !5
  ...
  %call18 = call double @sqrt(double noundef %10) #9, !tbaa !5
...
if.then42:                                        ; preds = %if.then40
  %call47 = call double @sqrt(double noundef %18) #9, !tbaa !5
  ...
  %call56 = call double @sqrt(double noundef %23) #9, !tbaa !5
...
if.else:                                          ; preds = %if.then40
  ...
  %call68 = call double @sqrt(double noundef %18) #9, !tbaa !5
  ...
  %call80 = call double @sqrt(double noundef %27) #9, !tbaa !5
