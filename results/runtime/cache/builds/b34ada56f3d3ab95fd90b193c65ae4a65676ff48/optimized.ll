...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 25000, ptr %word) #10
  call void @llvm.lifetime.start.p0(i64 2000, ptr %l) #10
...
if.end35:                                         ; preds = %if.then33, %if.end
  %s.1 = phi i32 [ 0, %if.then33 ], [ %s.0, %if.end ]
...
for.end49:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 2000, ptr %l) #10
  call void @llvm.lifetime.end.p0(i64 25000, ptr %word) #10
