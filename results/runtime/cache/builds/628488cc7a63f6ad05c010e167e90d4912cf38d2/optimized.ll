...
for.cond5:                                        ; preds = %if.then, %for.end
  %i.1 = phi i32 [ %sub, %for.end ], [ %dec, %if.then ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  br i1 %cmp13, label %if.then, label %for.end20
...
for.cond22:                                       ; preds = %if.end56, %for.end20
  %j.0 = phi i32 [ %sub21, %for.end20 ], [ %dec58, %if.end56 ]
  %p.0 = phi i32 [ 0, %for.end20 ], [ %p.1, %if.end56 ]
...
for.cond29:                                       ; preds = %if.end44, %for.body24
  %m.0 = phi i32 [ %sub, %for.body24 ], [ %dec46, %if.end44 ]
  %sum.0 = phi i32 [ %4, %for.body24 ], [ %sum.1, %if.end44 ]
  %p.1 = phi i32 [ %p.0, %for.body24 ], [ %p.2, %if.end44 ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  br i1 %cmp48, label %if.end56, label %if.else52

if.else52:                                        ; preds = %for.end47
  %add53 = add nsw i32 %sum.0, 1
  br label %if.end56

if.end56:                                         ; preds = %for.end47, %if.else52
...
for.cond60:                                       ; preds = %if.end69, %for.end59
  %i.2 = phi i32 [ 0, %for.end59 ], [ %inc71, %if.end69 ]
  %sum.2 = phi i32 [ 0, %for.end59 ], [ %sum.3, %if.end69 ]
