...
for.cond50:                                       ; preds = %for.inc74, %for.body48
  ...
  %10 = load i32, ptr %i.sink, align 4, !tbaa !5
  %add49 = add nsw i32 %10, 1
...
for.body52:                                       ; preds = %for.cond50
  ...
  %11 = load i32, ptr %h55, align 4, !tbaa !12, !invariant.load !16
  ...
  %12 = load i32, ptr %h58, align 4, !tbaa !12, !invariant.load !16
...
for.end79:                                        ; preds = %for.cond45
  ...
  %call82 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %13)
