...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc135 ], [ %0, %entry ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc31 ], [ 0, %for.cond ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %indvars.iv64
  br i1 %exitcond22.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv18
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv64
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv13 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next14, %for.inc28 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %indvars.iv64
  br i1 %exitcond17.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv18, i64 %indvars.iv13
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %indvars.iv64
  br i1 %exitcond42.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %indvars.iv64
  br i1 %exitcond27.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv23, i64 %indvars.iv38
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv38
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select6, %for.body57 ], [ %6, %if.then51 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %indvars.iv64
  br i1 %exitcond32.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv28, i64 %indvars.iv38
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %spec.select6 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  br label %for.cond55, !llvm.loop !15

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv33 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next34, %for.inc84 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %indvars.iv64
  br i1 %exitcond37.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv33, i64 %indvars.iv38
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %indvars.iv64
  br i1 %exitcond53.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %indvars.iv64
  br i1 %exitcond48.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv49, i64 %indvars.iv43
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv43, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv49, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond63.not = icmp eq i64 %indvars.iv59, %indvars.iv64
  br i1 %exitcond63.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep9 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv59
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv54 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next55, %for.inc129 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %indvars.iv64
  br i1 %exitcond58.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv54, i64 %indvars.iv59
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep10 = getelementptr [100 x i32], ptr %invariant.gep9, i64 %indvars.iv54
  store i32 %12, ptr %gep10, align 4, !tbaa !5
