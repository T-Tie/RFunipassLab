...
for.body:                                         ; preds = %for.cond
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br i1 %or.cond10, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %n1.0 = phi i32 [ %add28, %for.inc ], [ 0, %for.body ]
  %4 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %exitcond23.not = icmp eq i32 %4, %smax22
  br i1 %exitcond23.not, label %for.end, label %for.body9
...
for.inc:                                          ; preds = %for.body9, %for.inc.fold.split, %if.else27
  %.sink6 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %for.inc.fold.split ]
  %add28 = add nuw nsw i32 %.sink6, %n1.0
  %inc = add nuw i32 %4, 1
  br label %for.cond7, !llvm.loop !9

for.end:                                          ; preds = %for.cond7
  call void @outlined_ir_func_0(ptr nonnull %m2, i32 29, i32 %n1.0)
  br label %for.inc164

for.cond85:                                       ; preds = %for.body, %for.inc109
  %n182.0 = phi i32 [ %add106, %for.inc109 ], [ 0, %for.body ]
  %5 = phi i32 [ %inc110, %for.inc109 ], [ 1, %for.body ]
  %exitcond.not = icmp eq i32 %5, %smax22
  br i1 %exitcond.not, label %for.end111, label %for.body87

for.body87:                                       ; preds = %for.cond85
  switch i32 %5, label %if.else105 [
...
for.inc109:                                       ; preds = %for.body87, %for.inc109.fold.split, %if.else105
  %.sink4 = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %for.inc109.fold.split ]
  %add106 = add nuw nsw i32 %.sink4, %n182.0
  %inc110 = add nuw i32 %5, 1
  br label %for.cond85, !llvm.loop !12

for.end111:                                       ; preds = %for.cond85
  call void @outlined_ir_func_0(ptr nonnull %m2, i32 28, i32 %n182.0)
  br label %for.inc164
...
define internal void @outlined_ir_func_0(ptr readonly captures(none) %0, i32 %1, i32 %2) #3 {
for.end_to_outline:
...
for.cond30:                                       ; preds = %for.inc56, %for.end_to_outline
  ...
  %4 = phi i32 [ 1, %for.end_to_outline ], [ %inc57, %for.inc56 ]
  %cmp31 = icmp slt i32 %4, %3
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  %.sink5 = phi i32 [ 30, %if.else52 ], [ %1, %for.body32 ], [ 31, %for.inc56.fold.split ]
  %add53 = add nsw i32 %.sink5, %n2.0
  %inc57 = add nuw nsw i32 %4, 1
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts7 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.2.str)
  br label %if.end68
...
if.then70:                                        ; preds = %if.end68
  ...
  %puts8 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.4.str.3)
