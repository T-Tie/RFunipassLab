...
for.end15:                                        ; preds = %if.then, %for.cond5
...
if.end23:                                         ; preds = %if.then17, %for.end15
  br label %for.inc24
...
if.then31:                                        ; preds = %for.body29
  ...
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12)
  br label %if.end38
...
if.else:                                          ; preds = %for.body29
  ...
  %call37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %13)
  br label %if.end38
