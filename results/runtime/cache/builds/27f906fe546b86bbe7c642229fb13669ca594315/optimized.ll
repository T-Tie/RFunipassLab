...
for.cond49:                                       ; preds = %for.cond, %for.inc110
  ...
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc110 ], [ 0, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp50 = icmp slt i64 %indvars.iv21, %9
  br i1 %cmp50, label %for.body51, label %for.end112

for.body51:                                       ; preds = %for.cond49
  %arrayidx53 = getelementptr inbounds nuw [99 x double], ptr %x, i64 0, i64 %indvars.iv21
...
if.then55:                                        ; preds = %for.body51
  %arrayidx58 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv21
  %11 = load double, ptr %arrayidx58, align 8, !tbaa !9, !invariant.load !14
  %arrayidx61 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv21
...
if.else63:                                        ; preds = %for.body51
  ...
  %13 = getelementptr inbounds nuw [99 x double], ptr %m, i64 0, i64 %indvars.iv21
...
if.else72:                                        ; preds = %if.else63
  ...
  %15 = getelementptr inbounds nuw [99 x double], ptr %arrayidx45, i64 0, i64 %indvars.iv21
