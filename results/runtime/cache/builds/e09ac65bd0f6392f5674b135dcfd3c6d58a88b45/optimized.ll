...
entry:
  %call = tail call i64 @strlen(ptr nofree noundef nonnull readonly captures(none) dereferenceable(1) %word) #7
...
while.end.thread:                                 ; preds = %while.cond
  ...
  %call165 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
