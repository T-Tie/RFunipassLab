...
if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %a) #8
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax19 = call i32 @llvm.smax.i32(i32 %j.0, i32 0)
...
cleanup:                                          ; preds = %for.cond9, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %a) #8
  br label %return
