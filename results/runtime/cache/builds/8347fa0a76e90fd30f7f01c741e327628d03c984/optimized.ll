...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax52 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count22 = zext nneg i32 %smax52 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond28.preheader, label %for.cond1

for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count27 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv14 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next15, %for.inc22 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond18.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv14
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv34 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next35, %for.inc63 ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count22
  br i1 %exitcond39.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select12, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv34
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select12 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv29 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next30, %for.inc60 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count27
  br i1 %exitcond33.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv29, i64 %indvars.iv34
...
if.end68:                                         ; preds = %for.end65
  ...
  %wide.trip.count45 = zext i32 %t.tr to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc125 ], [ 0, %if.end68 ]
  %exitcond54.not = icmp eq i64 %indvars.iv47, %wide.trip.count22
  br i1 %exitcond54.not, label %for.end127, label %for.cond72.preheader
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv40 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next41, %for.inc122 ]
  %exitcond46.not = icmp eq i64 %indvars.iv40, %wide.trip.count45
  br i1 %exitcond46.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv40, 2
  br i1 %switch, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %for.body75
  %8 = trunc nuw nsw i64 %indvars.iv40 to i32
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv40
  %9 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
  %10 = add nsw i64 %indvars.iv40, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %10
  store i32 %9, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.then97:                                        ; preds = %lor.lhs.false.thread
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv40
  %11 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !9
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %6, i64 %indvars.iv40
  store i32 %11, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv47, i64 %indvars.iv40
  %12 = load i32, ptr %arrayidx111, align 4, !tbaa !5, !invariant.load !9
  %13 = add nsw i64 %indvars.iv40, -1
