...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1200, ptr noundef nonnull align 16 %b) #5
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc23
  %indvars.iv26 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next27, %for.inc23 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %for.inc23 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond26.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv26
  br label %for.cond5

for.cond26.preheader:                             ; preds = %for.cond2
  %sub = add nsw i32 %k.0, -1
  %2 = sext i32 %sub to i64
  %smax36 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax36 to i64
  br label %for.cond26

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc13
  %indvars.iv23 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next24, %for.inc13 ]
  %exitcond.not = icmp eq i64 %indvars.iv23, %indvars.iv26
  br i1 %exitcond.not, label %for.end15, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv23
...
for.end15:                                        ; preds = %for.body7, %for.cond5
  %j.0.lcssa.in = phi i64 [ %indvars.iv23, %for.body7 ], [ %indvars.iv26, %for.cond5 ]
  %5 = and i64 %j.0.lcssa.in, 4294967295
  %cmp16 = icmp eq i64 %5, %indvars.iv26
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc36
  %indvars.iv32 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next33, %for.inc36 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond37.not, label %for.end38, label %for.body28

for.body28:                                       ; preds = %for.cond26
  %arrayidx30 = getelementptr inbounds nuw [300 x i32], ptr %b, i64 0, i64 %indvars.iv32
  ...
  %cmp32 = icmp slt i64 %indvars.iv32, %2
...
for.end38:                                        ; preds = %for.cond26
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 noundef 1200, ptr noundef nonnull %a) #6
