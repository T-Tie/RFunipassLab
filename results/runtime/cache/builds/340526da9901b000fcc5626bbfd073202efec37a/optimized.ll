...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull %num) #7
...
if.else:                                          ; preds = %for.body
  ...
  %div69 = fdiv double %call67, %.pre56
...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc132 ], [ 0, %for.cond ]
  %10 = sext i32 %9 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv52, %10
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv52
  ...
  %17 = load double, ptr %16, align 8, !tbaa !9, !invariant.load !11
  %18 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 32
  %19 = load double, ptr %18, align 16, !tbaa !9, !invariant.load !11
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %17, double noundef %19)
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %20 = load double, ptr %arrayidx129, align 8, !tbaa !9, !invariant.load !11
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %17, double noundef %19, double noundef %17, double noundef %20)
  br label %for.inc132
