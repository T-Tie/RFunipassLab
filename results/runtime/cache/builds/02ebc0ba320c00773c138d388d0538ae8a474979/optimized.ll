...
for.inc:                                          ; preds = %for.cond
  ...
  %call.i1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx4)
...
for.cond8:                                        ; preds = %for.inc31, %for.end
  %7 = phi i32 [ %.pre, %for.inc31 ], [ %3, %for.end ]
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc31 ], [ 1, %for.end ]
  %8 = sext i32 %7 to i64
  %cmp10.not.not = icmp slt i64 %indvars.iv35, %8
  br i1 %cmp10.not.not, label %for.body11, label %for.end33

for.body11:                                       ; preds = %for.cond8
  %arrayidx13 = getelementptr inbounds nuw float, ptr %vla1, i64 %indvars.iv35
  %9 = load float, ptr %arrayidx13, align 4, !tbaa !12, !invariant.load !14
  %arrayidx15 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv35
