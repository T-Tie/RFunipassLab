...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(10000) %str, i8 noundef 0, i64 noundef 10000, i1 noundef false) #8
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %str) #9
  ret i32 0
}
