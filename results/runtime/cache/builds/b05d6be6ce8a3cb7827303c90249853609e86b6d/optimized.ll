...
for.inc26:                                        ; preds = %for.cond14, %for.inc26.split.loop.exit34
  %i.2 = phi i32 [ 9999, %for.inc26.split.loop.exit34 ], [ %i.1, %for.cond14 ]
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit34 ], [ %r1.0, %for.cond14 ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit34 ], [ %c1.0, %for.cond14 ]
