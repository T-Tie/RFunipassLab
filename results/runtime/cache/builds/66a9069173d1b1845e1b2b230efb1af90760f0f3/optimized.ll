...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv59.in = phi i64 [ %indvars.iv59, %for.end114 ], [ %2, %entry ]
  ...
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv59, i64 1)
  %3 = trunc nuw i64 %indvars.iv52 to i32
  %smax49 = tail call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
...
for.cond.preheader:                               ; preds = %tailrecurse
  ...
  %smax33 = tail call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  ...
  br i1 %exitcond13.not, label %for.cond31, label %for.cond2
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc25 ], [ 0, %for.cond14.preheader ]
...
for.cond31:                                       ; preds = %for.cond, %for.inc66
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc66 ], [ 0, %for.cond ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc63 ], [ 0, %for.cond51.preheader ]
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc89 ], [ 1, %for.end68 ]
  %exitcond.not61 = icmp eq i64 %indvars.iv36, %smax
  br i1 %exitcond.not61, label %for.cond92.preheader, label %for.cond75
...
for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count12
  br i1 %exitcond35.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv36, i64 %indvars.iv30
...
for.end17:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 57600, ptr noundef nonnull align 16 captures(none) dereferenceable(57600) %a) #8
