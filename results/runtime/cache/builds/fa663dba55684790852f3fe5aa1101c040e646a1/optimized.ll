...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef align 16 %b) #9
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef align 16 %b, i64 noundef 10000)
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %arrayidx14)
...
!23 = !{}
!24 = !{!25, !26, i64 16}
!25 = !{!"_ZTSSt8ios_base", !26, i64 8, !26, i64 16, !27, i64 24, !28, i64 28, !28, i64 32, !29, i64 40, !30, i64 48, !6, i64 64, !15, i64 192, !31, i64 200, !32, i64 208}
!26 = !{!"long", !6, i64 0}
