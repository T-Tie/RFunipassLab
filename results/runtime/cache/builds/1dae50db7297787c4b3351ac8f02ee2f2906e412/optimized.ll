...
while.cond:                                       ; preds = %for.cond, %while.cond
  ...
  %phiofops = phi i64 [ %indvars.iv9, %while.cond ], [ -1, %for.cond ]
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv12 = phi i64 [ %2, %while.cond11.preheader ], [ %indvars.iv.next13, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %3 = trunc nuw i64 %indvars.iv.next13 to i32
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select7 = tail call i32 @llvm.smax.i32(i32 %7, i32 %n.2)
