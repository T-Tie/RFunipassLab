...
for.body:                                         ; preds = %for.cond
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, i32 noundef %y) #6
...
for.cond13:                                       ; preds = %for.body15, %for.end
  %1 = phi i32 [ %.pre8, %for.body15 ], [ 1, %for.end ]
  %cmp14 = icmp slt i32 %1, %m2
  br i1 %cmp14, label %for.body15, label %for.end39

for.body15:                                       ; preds = %for.cond13
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, i32 noundef %y) #6
  %.pre8 = load i32, ptr %j, align 4, !tbaa !5
  br label %for.cond13

for.end39:                                        ; preds = %for.cond13
  %2 = load i32, ptr %x1, align 4, !tbaa !5
  %3 = load i32, ptr %x2, align 4, !tbaa !5
  %sub40 = sub nsw i32 %2, %3
...
for.body_to_outline:
  ...
  store i32 %add, ptr %0, align 4, !tbaa !5
  %4 = load i32, ptr %1, align 4, !tbaa !5
  switch i32 %4, label %for.cond.exitStub [
    i32 4, label %for.cond.exitStub.sink.split
    i32 6, label %for.cond.exitStub.sink.split
    i32 9, label %for.cond.exitStub.sink.split
    i32 11, label %for.cond.exitStub.sink.split
    i32 2, label %if.then8
  ]

if.then8:                                         ; preds = %for.body_to_outline
  %call = tail call noundef i32 @_Z7runniani(i32 noundef %2) #9
  %tobool.not = icmp eq i32 %call, 0
  %. = select i1 %tobool.not, i32 28, i32 29
  br label %for.cond.exitStub.sink.split

for.cond.exitStub.sink.split:                     ; preds = %if.then8, %for.body_to_outline, %for.body_to_outline, %for.body_to_outline, %for.body_to_outline
  %.sink = phi i32 [ 30, %for.body_to_outline ], [ 30, %for.body_to_outline ], [ 30, %for.body_to_outline ], [ 30, %for.body_to_outline ], [ %., %if.then8 ]
  %sub = add nsw i32 %3, %.sink
  store i32 %sub, ptr %0, align 4, !tbaa !5
  br label %for.cond.exitStub

for.cond.exitStub:                                ; preds = %for.cond.exitStub.sink.split, %for.body_to_outline
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %1, align 4, !tbaa !5
  ret void
}
