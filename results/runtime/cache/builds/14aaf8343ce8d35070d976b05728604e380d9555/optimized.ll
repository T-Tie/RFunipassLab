...
for.cond7:                                        ; preds = %for.inc36, %for.body6
  %i.1.sink = phi i32 [ %i.1, %for.body6 ], [ %j.2, %for.inc36 ]
...
for.cond10:                                       ; preds = %for.inc23, %for.body9
  %j.1 = phi i32 [ %add, %for.body9 ], [ %inc22, %for.inc23 ]
...
if.then27:                                        ; preds = %for.end25
  ...
  %sub31 = sub nsw i32 %j.1, %0
  br label %for.inc36

if.else32:                                        ; preds = %for.end25
  %sub33 = sub nsw i32 %j.1, %w.2
  br label %for.inc36

for.inc36:                                        ; preds = %if.then27, %if.else32
  %j.2 = phi i32 [ %sub31, %if.then27 ], [ %sub33, %if.else32 ]
