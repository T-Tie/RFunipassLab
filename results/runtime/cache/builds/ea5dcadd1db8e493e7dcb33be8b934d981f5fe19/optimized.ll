...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv30 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next31, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond.not, label %for.end9, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv30, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax45 = add nsw i32 %3, -1
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.backedge, %for.cond13.preheader
  %indvars.iv34 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next35, %for.cond13.backedge ]
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %4 = trunc nuw i64 %indvars.iv.next35 to i32
  %cmp14 = icmp sgt i32 %0, %4
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 8, !tbaa !15
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next35
  %6 = load i32, ptr %arrayidx20, align 8, !tbaa !15
  %cmp22.not = icmp slt i32 %5, %6
  br i1 %cmp22.not, label %for.cond13.backedge, label %if.then

for.cond13.backedge:                              ; preds = %for.body15, %if.then31, %if.then
...
if.then:                                          ; preds = %for.body15
  ...
  br i1 %cmp30.not, label %for.cond13.backedge, label %if.then31
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count46
  br i1 %exitcond47.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv42, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc74 ], [ %indvars.iv37, %for.body48 ]
...
for.body52:                                       ; preds = %for.cond50
  ...
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv39, i32 1
