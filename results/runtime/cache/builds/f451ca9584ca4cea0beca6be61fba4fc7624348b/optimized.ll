...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax50 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count20 = zext nneg i32 %smax50 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond28.preheader, label %for.cond1

for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count25 = zext i32 %t.tr to i64
  br label %for.cond28
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv17, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv12 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next13, %for.inc22 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond16.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv17, i64 %indvars.iv12
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv32 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next33, %for.inc63 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count20
  br i1 %exitcond37.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select10, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv32
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %spec.select10 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  br label %for.cond31, !llvm.loop !15

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv27 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next28, %for.inc60 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count25
  br i1 %exitcond31.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv27, i64 %indvars.iv32
...
for.cond69.preheader:                             ; preds = %for.end65
  %wide.trip.count43 = zext i32 %t.tr to i64
  br label %for.cond69

for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv45 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next46, %for.inc125 ]
  %exitcond52.not = icmp eq i64 %indvars.iv45, %wide.trip.count20
  br i1 %exitcond52.not, label %for.end127, label %for.cond72.preheader
...
for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv38 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next39, %for.inc122 ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv38, 2
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %indvars.iv38
  %7 = load i32, ptr %arrayidx89, align 4, !tbaa !5, !invariant.load !9
  %8 = add nsw i64 %indvars.iv38, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %8
  store i32 %7, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.then97:                                        ; preds = %lor.lhs.false.thread
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %indvars.iv38
  %9 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !9
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %4, i64 %indvars.iv38
  store i32 %9, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv45, i64 %indvars.iv38
  %10 = load i32, ptr %arrayidx111, align 4, !tbaa !5, !invariant.load !9
