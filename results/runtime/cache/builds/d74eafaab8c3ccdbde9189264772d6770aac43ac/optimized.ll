...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  ...
  %indvars.iv14 = phi i64 [ %2, %for.cond10.preheader ], [ %indvars.iv.next15, %for.cond13 ]
  %indvars.iv.next21 = add nsw i64 %indvars.iv20, -1
  %indvars.iv.next15 = add nsw i64 %indvars.iv14, -1
  %cmp11 = icmp sgt i64 %indvars.iv20, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next21
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next21
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv16 = phi i64 [ %indvars.iv14, %for.cond13.preheader ], [ %indvars.iv.next17, %for.inc31 ]
  %3 = trunc nuw i64 %indvars.iv16 to i32
  %cmp14 = icmp sgt i32 %0, %3
  br i1 %cmp14, label %for.body15, label %for.cond10, !llvm.loop !13

for.body15:                                       ; preds = %for.cond13
  %4 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !14
  %arrayidx19 = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv16
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !14
  %cmp20.not = icmp slt i32 %4, %5
  br i1 %cmp20.not, label %for.inc31, label %land.lhs.true

land.lhs.true:                                    ; preds = %for.body15
  %6 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !14
  %arrayidx24 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv16
  %7 = load i32, ptr %arrayidx24, align 4, !tbaa !5, !invariant.load !14
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %8, %for.end35 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond27.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv23
  %9 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !14
