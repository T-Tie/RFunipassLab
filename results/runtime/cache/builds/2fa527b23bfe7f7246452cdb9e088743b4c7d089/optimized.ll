...
if.end31.gvnsink.split:                           ; preds = %while.body, %if.then12
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call13.sink, ptr noundef nonnull align 16 dereferenceable(50) %word)
