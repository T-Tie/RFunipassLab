...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef nonnull %add.ptr8) #12
...
for.body18:                                       ; preds = %for.cond16
  ...
  %5 = load i32, ptr %add.ptr20, align 4, !tbaa !5, !invariant.load !13
  %add21 = add nsw i32 %sum.0, %5
...
for.inc42:                                        ; preds = %for.body18, %if.then
  %sum.1 = phi i32 [ %5, %if.then ], [ %add21, %for.body18 ]
  %k.1 = phi i32 [ %3, %if.then ], [ %k.0, %for.body18 ]
...
for.end44:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef captures(none) %a) #11
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !15, !invariant.load !13
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !15, !invariant.load !13
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !17, !invariant.load !13
...
for.cond23:                                       ; preds = %for.inc31, %if.then_to_outline
  ...
  %4 = load i32, ptr %1, align 4, !tbaa !5, !invariant.load !13
  %sub = sub nsw i32 %4, 1
  %cmp24 = icmp slt i32 %3, %sub
  br i1 %cmp24, label %for.inc31, label %if.then_after_outline.exitStub

for.inc31:                                        ; preds = %for.cond23
  %idx.ext26 = sext i32 %3 to i64
  %add.ptr27 = getelementptr inbounds [41 x i8], ptr %2, i64 %idx.ext26
  ...
  store i32 %inc32, ptr %0, align 4, !tbaa !5
