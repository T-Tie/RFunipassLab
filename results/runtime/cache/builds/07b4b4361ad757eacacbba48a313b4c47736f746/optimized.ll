...
for.end47:                                        ; preds = %for.cond29
  ...
  %spec.select27 = select i1 %cmp48, i32 1, i32 %add53
  %arrayidx55 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next36
  store i32 %spec.select27, ptr %arrayidx55, align 4, !tbaa !5
...
for.body62:                                       ; preds = %for.cond60
  ...
  %8 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select28 = call i32 @llvm.smax.i32(i32 %8, i32 %sum.2)
