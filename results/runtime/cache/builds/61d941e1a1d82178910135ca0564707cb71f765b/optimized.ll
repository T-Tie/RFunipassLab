...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %cmp76.not.not = icmp slt i64 %indvars.iv10, %10
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %16, double noundef %17) #12
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %16) #12
  br label %for.inc132
...
if.else117:                                       ; preds = %for.body77
  ...
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %16, double noundef %17, double noundef %16, double noundef %18) #12
  br label %for.inc132
