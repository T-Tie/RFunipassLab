...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %0, i32 0)
  %wide.trip.count49 = zext nneg i32 %smax43 to i64
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond50.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body15 ], [ 0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select29, %for.body15 ], [ %l1.0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv36
  ...
  %spec.select29 = select i1 %cmp20, i32 %6, i32 %l1.1
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond13, !llvm.loop !14

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv39 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next40, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.3, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.3, %for.inc50 ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count49
  br i1 %exitcond45.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv39, 0
  %7 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %idxprom40
...
if.end37:                                         ; preds = %for.body30
  ...
  %spec.select30 = call i32 @llvm.smin.i32(i32 %8, i32 %min.1)
  %9 = trunc nuw nsw i64 %indvars.iv39 to i32
  %spec.select31 = select i1 %cmp42, i32 %9, i32 %l2.1
  br label %for.inc50

for.inc50:                                        ; preds = %if.end37, %for.body30
  %min.3 = phi i32 [ %8, %for.body30 ], [ %spec.select30, %if.end37 ]
  %l2.3 = phi i32 [ 0, %for.body30 ], [ %spec.select31, %if.end37 ]
