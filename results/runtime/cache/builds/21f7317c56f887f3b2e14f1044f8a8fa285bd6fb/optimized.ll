...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread22
  ...
  %phiofops.ph = phi i32 [ %add, %if.end35.thread22 ], [ %7, %if.end35.thread ], [ %7, %if.end35 ]
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre25, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
