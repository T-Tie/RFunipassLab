...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr %ch) #9
  call void @llvm.lifetime.start.p0(i64 4000, ptr %len) #9
...
while.end35:                                      ; preds = %while.body
  call void @llvm.lifetime.end.p0(i64 4000, ptr %len) #9
  call void @llvm.lifetime.end.p0(i64 41000, ptr %ch) #9
