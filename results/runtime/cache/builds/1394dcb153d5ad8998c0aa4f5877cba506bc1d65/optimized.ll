...
if.else95:                                        ; preds = %lor.lhs.false.thread
  %idxprom8621 = sext i32 %i.2 to i64
  %cmp96 = icmp eq i32 %j.4, 0
  %idxprom100 = sext i32 %j.4 to i64
  %6 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom8621
...
cleanup:                                          ; preds = %for.end65, %for.end127
  %sum.0 = phi i32 [ %add128, %for.end127 ], [ %4, %for.end65 ]
  ret i32 %sum.0
}
