...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef align 16 %min1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef align 16 %min2) #4
...
for.cond14:                                       ; preds = %for.end41, %while.body
  %m.0 = phi i32 [ 0, %while.body ], [ %inc43, %for.end41 ]
...
for.cond22:                                       ; preds = %if.end, %for.body16
  %k.1 = phi i32 [ 0, %for.body16 ], [ %inc40, %if.end ]
...
for.cond45:                                       ; preds = %for.end66, %for.end44
  %z.0 = phi i32 [ 0, %for.end44 ], [ %inc68, %for.end66 ]
...
for.cond49:                                       ; preds = %for.body52, %for.body48
  %x.0 = phi i32 [ 0, %for.body48 ], [ %inc65, %for.body52 ]
...
for.cond70:                                       ; preds = %for.end100, %for.end69
  %m.1 = phi i32 [ 0, %for.end69 ], [ %inc102, %for.end100 ]
...
for.cond79:                                       ; preds = %if.end97, %for.body73
  %k.2 = phi i32 [ 0, %for.body73 ], [ %inc99, %if.end97 ]
...
for.cond104:                                      ; preds = %for.end125, %for.end103
  %z.1 = phi i32 [ 0, %for.end103 ], [ %inc127, %for.end125 ]
...
for.cond108:                                      ; preds = %for.body111, %for.body107
  %x.1 = phi i32 [ 0, %for.body107 ], [ %inc124, %for.body111 ]
...
for.end128:                                       ; preds = %for.cond104
  ...
  %add = add nsw i32 %sum.0, %13
  br label %for.cond131

for.cond131:                                      ; preds = %for.end150, %for.end128
  %z.2 = phi i32 [ 0, %for.end128 ], [ %inc152, %for.end150 ]
...
for.cond135:                                      ; preds = %for.body138, %for.body134
  %m.2 = phi i32 [ 1, %for.body134 ], [ %add141, %for.body138 ]
...
for.cond154:                                      ; preds = %for.end173, %for.end153
  %z.3 = phi i32 [ 0, %for.end153 ], [ %inc175, %for.end173 ]
...
for.cond158:                                      ; preds = %for.body161, %for.body157
  %m.3 = phi i32 [ 1, %for.body157 ], [ %add162, %for.body161 ]
...
while.end:                                        ; preds = %while.cond
  %call178 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %sum.0) #5
  %inc180 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !26

for.end181:                                       ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %min2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %min1) #5
