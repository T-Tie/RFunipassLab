...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull %a) #10
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull %b) #10
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull align 16 %c) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %x1) #10
  store i32 1, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %x2) #10
  store i32 1, ptr %x2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %y1) #10
  store i32 1, ptr %y1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %y2) #10
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  ...
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv36, %5
...
for.cond30.preheader:                             ; preds = %for.cond13
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %7, i32 noundef 0)
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv36, i64 %indvars.iv33
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc57
  %indvars.iv49 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next50, %for.inc57 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54.not, label %for.cond60, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc54
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc54 ], [ 0, %for.cond30 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48.not, label %for.inc57, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv49, i64 %indvars.iv43
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc51
  %indvars.iv39 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next40, %for.inc51 ]
...
for.inc51:                                        ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv49, i64 %indvars.iv39
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !15
  %arrayidx46 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv39, i64 %indvars.iv43
...
for.cond60:                                       ; preds = %for.cond30, %for.inc78
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc78 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp61 = icmp slt i64 %indvars.iv58, %14
  br i1 %cmp61, label %for.cond64, label %for.end80

for.cond64:                                       ; preds = %for.cond60, %for.inc75
  %15 = phi i32 [ %.pre61, %for.inc75 ], [ %12, %for.cond60 ]
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc75 ], [ 0, %for.cond60 ]
  %16 = sext i32 %15 to i64
  %cmp65 = icmp slt i64 %indvars.iv55, %16
  br i1 %cmp65, label %for.body66, label %for.inc78

for.body66:                                       ; preds = %for.cond64
  %arrayidx70 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv58, i64 %indvars.iv55
  ...
  %cmp72.not = icmp eq i64 %indvars.iv55, %19
...
for.end80:                                        ; preds = %for.cond60
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %y2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %y1) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %x2) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %x1) #11
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef nonnull %c) #11
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef nonnull %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef nonnull %a) #11
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !21, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !29, !invariant.load !15
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !30, !invariant.load !15
