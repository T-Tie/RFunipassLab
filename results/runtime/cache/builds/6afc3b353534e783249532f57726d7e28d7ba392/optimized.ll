...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc8 ], [ 1, %entry ]
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax60 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count61 = zext nneg i32 %smax60 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc25
  %indvars.iv46 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next47, %for.inc25 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp16.not = icmp sgt i64 %indvars.iv46, %12
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv57 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next58, %for.inc46 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count61
  br i1 %exitcond62.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax66 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
  %wide.trip.count67 = zext nneg i32 %smax66 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv57, i64 %indvars.iv54
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  %indvars.iv75 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next76, %for.inc79 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count61
  br i1 %exitcond79.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc76
  %indvars.iv69 = phi i64 [ %indvars.iv.next70, %for.inc76 ], [ 0, %for.cond49 ]
  %exitcond74.not = icmp eq i64 %indvars.iv69, %wide.trip.count
  br i1 %exitcond74.not, label %for.inc79, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv75, i64 %indvars.iv69
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc73
  %indvars.iv63 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next64, %for.inc73 ]
  %exitcond68.not = icmp eq i64 %indvars.iv63, %wide.trip.count67
  br i1 %exitcond68.not, label %for.inc76, label %for.inc73

for.inc73:                                        ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv75, i64 %indvars.iv63
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv63, i64 %indvars.iv69
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv85, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv85, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre90, %for.body87 ]
  %indvars.iv80 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next81, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv80, %23
  br i1 %cmp86.not, label %for.inc106, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv80, %24
  ...
  %.pre90 = load i32, ptr %y2, align 4, !tbaa !5
