...
for.end.thread:                                   ; preds = %for.cond2
  %cmp615 = icmp sgt i32 %index.0, -1
  br i1 %cmp615, label %if.then7, label %for.inc12
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc21
  %indvars.iv22 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next23, %for.inc21 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.end23, label %for.inc21

for.inc21:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [1000 x i32], ptr %result, i64 0, i64 %indvars.iv22
