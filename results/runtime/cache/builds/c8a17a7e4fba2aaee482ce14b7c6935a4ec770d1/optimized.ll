...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !13, !invariant.load !15
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !13, !invariant.load !15
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !16, !invariant.load !15
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !8, !invariant.load !15
  %1 = load i32, ptr %__c2, align 4, !tbaa !8, !invariant.load !15
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
