...
for.cond:                                         ; preds = %for.inc180, %entry
  %k.0 = phi i32 [ 0, %entry ], [ %inc181, %for.inc180 ]
...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.end ], [ 0, %for.body ]
  %cmp2 = icmp sgt i32 %1, 0
  br i1 %cmp2, label %for.cond4.preheader, label %for.inc180

for.cond4.preheader:                              ; preds = %for.cond1
  %add.ptr = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv22
  br label %for.cond4

for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc
  %2 = phi i32 [ %1, %for.cond4.preheader ], [ %.pre, %for.inc ]
...
for.inc180:                                       ; preds = %for.cond1
  %call178 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
