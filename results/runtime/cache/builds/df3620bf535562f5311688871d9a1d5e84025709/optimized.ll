...
for.cond54:                                       ; preds = %for.inc80, %for.end53
  %9 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.end53 ]
  %cmp55 = icmp sle i32 %9, 122
...
for.cond57:                                       ; preds = %for.inc70, %for.body56
  ...
  %11 = load i8, ptr %arrayidx59, align 1, !tbaa !9, !invariant.load !13
