...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 404, ptr noundef nonnull align 16 %s) #5
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 404, ptr noundef nonnull %s) #6
