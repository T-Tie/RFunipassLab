...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv29 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next30, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  ...
  %wide.trip.count39 = zext i32 %j.0 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv41
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc37 ], [ %indvars.iv33, %for.body17 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv35
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv48 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next49, %for.inc53 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count46
  br i1 %exitcond52.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv48
  ...
  %cmp49 = icmp slt i64 %indvars.iv48, %4
