...
for.end.thread:                                   ; preds = %for.cond2
  %cmp613 = icmp sgt i32 %index.0, -1
  br i1 %cmp613, label %if.then7, label %for.inc12
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc21
  %indvars.iv20 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next21, %for.inc21 ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25.not, label %for.end23, label %for.inc21

for.inc21:                                        ; preds = %for.cond15
  %arrayidx19 = getelementptr inbounds nuw [1000 x i32], ptr %result, i64 0, i64 %indvars.iv20
