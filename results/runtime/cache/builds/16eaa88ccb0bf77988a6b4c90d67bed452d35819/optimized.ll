...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %x1) #5
  store i32 0, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %x2) #5
  store i32 0, ptr %x2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %y1) #5
  store i32 0, ptr %y1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 4, ptr %y2) #5
  store i32 0, ptr %y2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call2.loc)
  call void @outlined_ir_func_0(ptr %x1, ptr %y1, ptr %call2.loc)
  %call2.reload = load ptr, ptr %call2.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call2.loc)
  br label %for.end10

for.end10:                                        ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call15.loc)
  call void @outlined_ir_func_0(ptr %x2, ptr %y2, ptr %call15.loc)
  %call15.reload = load ptr, ptr %call15.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call15.loc)
  br label %for.end32
...
for.inc68:                                        ; preds = %for.cond47
  ...
  %mul50 = mul nsw i32 %i.2, %5
  %add51 = add nsw i32 %mul50, %j.2
  %idxprom52 = sext i32 %add51 to i64
  %arrayidx53 = getelementptr inbounds i32, ptr %call36, i64 %idxprom52
  %6 = load i32, ptr %arrayidx53, align 4, !tbaa !5
  %7 = load i32, ptr %y1, align 4, !tbaa !5
  %mul54 = mul nsw i32 %i.2, %7
  ...
  %mul62 = mul nsw i32 %8, %9
  %add63 = add nsw i32 %6, %mul62
  store i32 %add63, ptr %arrayidx53, align 4, !tbaa !5
...
for.cond80:                                       ; preds = %for.inc95, %for.body79
  ...
  %cmp81 = icmp slt i32 %j.3, %11
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %i.3, %11
  %add84 = add nsw i32 %mul83, %j.3
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %12 = load i32, ptr %arrayidx86, align 4, !tbaa !5
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12)
...
for.end100:                                       ; preds = %for.cond77
  call void @llvm.lifetime.end.p0(i64 4, ptr %y2) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %y1) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %x2) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %x1) #5
  ret i32 0
}
...
define internal void @outlined_ir_func_0(ptr %0, ptr %1, ptr %2) #4 {
newFuncRoot:
  br label %entry_to_outline

entry_to_outline:                                 ; preds = %newFuncRoot
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %0, ptr noundef %1)
