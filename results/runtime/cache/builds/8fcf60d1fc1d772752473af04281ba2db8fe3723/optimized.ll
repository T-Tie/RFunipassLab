...
land.end:                                         ; preds = %for.cond10
  ...
  br i1 %cmp15, label %for.inc17, label %for.end19.split.loop.exit27

for.inc17:                                        ; preds = %land.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond10, !llvm.loop !15

for.end19.split.loop.exit27:                      ; preds = %land.end
  %4 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end19

for.end19:                                        ; preds = %for.cond10, %for.end19.split.loop.exit27
  %i.1.lcssa = phi i32 [ %4, %for.end19.split.loop.exit27 ], [ 31, %for.cond10 ]
  %5 = zext nneg i32 %i.1.lcssa to i64
  %6 = sext i32 %i.1.lcssa to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc28, %for.end19
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc28 ], [ %5, %for.end19 ]
...
for.inc28:                                        ; preds = %for.cond20
  ...
  %8 = sub nuw nsw i64 %indvars.iv22, %6
