...
if.end:                                           ; preds = %for.end61
  %7 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
  br label %for.cond64
...
for.body68:                                       ; preds = %for.cond64
  ...
  %9 = load i32, ptr %arrayidx75, align 16, !tbaa !5
...
for.inc96:                                        ; preds = %for.cond81
  ...
  %10 = load i32, ptr %arrayidx91, align 4, !tbaa !5
...
for.end101:                                       ; preds = %for.cond64
  ...
  %add104 = add nsw i32 %7, %call103
  br label %return

return:                                           ; preds = %for.end101, %if.then
  %retval.0 = phi i32 [ %6, %if.then ], [ %add104, %for.end101 ]
  ret i32 %retval.0
}
