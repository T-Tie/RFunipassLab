...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv9.in = phi i32 [ %indvars.iv9, %for.end100 ], [ %n, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub67, %for.end100 ], [ %n, %entry ]
  %indvars.iv9 = add i32 %indvars.iv9.in, -1
  %smax46 = call i32 @llvm.smax.i32(i32 %indvars.iv9, i32 1)
  %smax35 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %0 = zext i32 %indvars.iv9 to i64
  %wide.trip.count20 = zext nneg i32 %smax35 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond21.not = icmp eq i64 %indvars.iv17, %wide.trip.count20
  br i1 %exitcond21.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count25 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv17
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv12 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next13, %for.inc21 ]
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count
  br i1 %exitcond16.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv17, i64 %indvars.iv12
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc62
  %indvars.iv32 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next33, %for.inc62 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count20
  br i1 %exitcond37.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv32
  %4 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select1, %for.body34 ], [ %4, %for.body29 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv32
  %5 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select1 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv27 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next28, %for.inc59 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count25
  br i1 %exitcond31.not, label %for.inc62, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv27, i64 %indvars.iv32
...
if.then:                                          ; preds = %for.end64
  store i32 %smax35, ptr @j, align 4, !tbaa !5
...
for.cond66:                                       ; preds = %for.cond81, %if.end
  %indvars.iv43 = phi i64 [ 1, %if.end ], [ %indvars.iv.next44, %for.cond81 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next44
  %8 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv43
  store i32 %8, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next44
  %9 = load i32, ptr %arrayidx76, align 16, !tbaa !5
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43
  store i32 %9, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond42.not = icmp eq i64 %indvars.iv38, %0
  br i1 %exitcond42.not, label %for.cond66, label %for.inc95, !llvm.loop !17

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next44, i64 %indvars.iv.next39
  %10 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv43, i64 %indvars.iv38
...
for.end100:                                       ; preds = %for.cond66
  ...
  store i32 %smax46, ptr @i, align 4, !tbaa !5
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %result) #7
...
for.end28:                                        ; preds = %for.cond19
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %result) #7
