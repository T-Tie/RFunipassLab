...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.cond21, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv31
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc15 ], [ %indvars.iv25, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv27
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv45.in = phi i32 [ %indvars.iv45, %for.cond21 ], [ %0, %for.cond2 ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv45 = add i32 %indvars.iv45.in, -1
  %indvars.iv.next39 = add nsw i64 %indvars.iv38, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next39
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax47 = call i32 @llvm.smax.i32(i32 %indvars.iv45, i32 noundef 0)
  %wide.trip.count48 = zext nneg i32 %smax47 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv41 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next42, %for.inc39 ]
  %exitcond49.not = icmp eq i64 %indvars.iv41, %wide.trip.count48
  br i1 %exitcond49.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv41
