...
for.inc.gvnsink.split:                            ; preds = %land.lhs.true, %lor.lhs.false34, %if.else, %lor.lhs.false20, %lor.lhs.false22, %lor.lhs.false24, %for.body5, %lor.lhs.false, %lor.lhs.false8, %lor.lhs.false10, %lor.lhs.false12, %lor.lhs.false14, %lor.lhs.false16, %if.else39
  %.sink8 = phi i32 [ 28, %if.else39 ], [ 31, %lor.lhs.false16 ], [ 31, %lor.lhs.false14 ], [ 31, %lor.lhs.false12 ], [ 31, %lor.lhs.false10 ], [ 31, %lor.lhs.false8 ], [ 31, %lor.lhs.false ], [ 31, %for.body5 ], [ 30, %lor.lhs.false24 ], [ 30, %lor.lhs.false22 ], [ 30, %lor.lhs.false20 ], [ 30, %if.else ], [ 29, %lor.lhs.false34 ], [ 29, %land.lhs.true ]
  %add40 = add nsw i32 %total.0, %.sink8
  br label %for.inc
