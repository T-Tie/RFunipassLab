...
for.inc.i:                                        ; preds = %for.cond.i
  tail call void @_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_(ptr noundef nonnull %__i.0.i)
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i = load i32, ptr %__value.addr.i, align 4, !tbaa !5
...
land.end.i:                                       ; preds = %while.cond.i
  ...
  %cmp.i.i = icmp slt i32 %4, %__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i
...
_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit: ; preds = %while.cond.i, %land.end.i
  ...
  store i32 %__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i, ptr %add.ptr5.i, align 4, !tbaa !5
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_(ptr noundef %__last) local_unnamed_addr #4 comdat {
entry:
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %__val.0.__val.0.2 = load i32, ptr %__val, align 4, !tbaa !5
  %1 = load i32, ptr %incdec.ptr, align 4, !tbaa !5
  %cmp.i = icmp slt i32 %__val.0.__val.0.2, %1
  br i1 %cmp.i, label %while.cond, label %while.end, !llvm.loop !24

while.end:                                        ; preds = %while.cond
  store i32 %__val.0.__val.0.2, ptr %__last.sink1, align 4, !tbaa !5
