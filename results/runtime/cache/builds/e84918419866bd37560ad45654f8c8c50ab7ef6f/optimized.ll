...
for.cond2.preheader:                              ; preds = %for.cond
  %sub = add nsw i32 %0, -1
  %smax25 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond2
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.end27
  %indvars.iv23 = phi i32 [ %sub, %for.cond2.preheader ], [ %indvars.iv.next24, %for.end27 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %inc.i6, %for.end27 ]
  %exitcond26.not = icmp eq i32 %j.0, %smax25
  br i1 %exitcond26.not, label %for.end30, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv23, i32 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %if.end
  %indvars.iv20 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next21, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond.not, label %for.end27, label %for.body9

for.body9:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv20
  %2 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %arrayidx13 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next21
