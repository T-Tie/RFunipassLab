...
if.then81:                                        ; preds = %for.body77
  ...
  %call.i.i1 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx83) #10
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !21, !invariant.load !10
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !39, !invariant.load !10
