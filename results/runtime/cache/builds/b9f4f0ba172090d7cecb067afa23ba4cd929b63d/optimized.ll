...
if.end:                                           ; preds = %while.body, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %4 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre24, %land.lhs.true ], [ %.pre24, %while.body ]
