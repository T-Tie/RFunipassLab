...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv4 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next5, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv4, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax19 = add nsw i32 %3, -1
  %wide.trip.count20 = zext nneg i32 %smax19 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv8 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next9, %for.inc40 ]
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %4 = trunc nuw i64 %indvars.iv.next9 to i32
  %cmp14 = icmp sgt i32 %0, %4
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 8, !tbaa !15
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next9
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond21.not = icmp eq i64 %indvars.iv16, %wide.trip.count20
  br i1 %exitcond21.not, label %for.end79, label %for.body48
...
for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc74 ], [ %indvars.iv11, %for.body48 ]
  %9 = icmp slt i64 %indvars.iv13, %1
  br i1 %9, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv13, i32 1
