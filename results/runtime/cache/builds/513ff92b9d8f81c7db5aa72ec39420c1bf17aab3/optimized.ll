...
for.cond:                                         ; preds = %for.inc23, %entry
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc23 ], [ 0, %entry ]
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp = icmp slt i64 %indvars.iv70, %1
...
for.cond26.preheader:                             ; preds = %for.cond
  ...
  %smax80 = call i32 @llvm.smax.i32(i32 %0, i32 0)
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv70, i64 %indvars.iv
  ...
  %arrayidx14 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv70, i64 %indvars.iv
  store i32 %5, ptr %arrayidx14, align 4, !tbaa !5
  %arrayidx22 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv70, i64 %indvars.iv
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc53
  %indvars.iv76 = phi i64 [ 0, %for.cond26.preheader ], [ %indvars.iv.next77, %for.inc53 ]
  %exitcond82.not = icmp eq i64 %indvars.iv76, %wide.trip.count81
  br i1 %exitcond82.not, label %for.cond56.preheader, label %for.cond29

for.cond56.preheader:                             ; preds = %for.cond26
  %sub = add nsw i32 %2, -1
  %idxprom68 = sext i32 %sub to i64
  %wide.trip.count87 = zext nneg i32 %smax to i64
  br label %for.cond56

for.cond29:                                       ; preds = %for.cond26, %for.cond29.backedge
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.cond29.backedge ], [ 0, %for.cond26 ]
  %exitcond.not = icmp eq i64 %indvars.iv73, %wide.trip.count
  br i1 %exitcond.not, label %for.inc53, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv76, i64 %indvars.iv73
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %arrayidx39 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv76, i64 %indvars.iv.next74
  %7 = load i32, ptr %arrayidx39, align 4, !tbaa !5
  %cmp40 = icmp sgt i32 %6, %7
  br i1 %cmp40, label %if.then, label %for.cond29.backedge

for.cond29.backedge:                              ; preds = %for.body31, %if.then
...
for.cond56:                                       ; preds = %for.cond56.preheader, %for.inc78
  %indvars.iv89 = phi i64 [ 0, %for.cond56.preheader ], [ %indvars.iv.next90, %for.inc78 ]
  %exitcond93.not = icmp eq i64 %indvars.iv89, %wide.trip.count81
  br i1 %exitcond93.not, label %for.cond81.preheader, label %for.cond59.preheader

for.cond59.preheader:                             ; preds = %for.cond56
  %arrayidx69 = getelementptr inbounds [8 x [8 x i32]], ptr %sz, i64 0, i64 %indvars.iv89, i64 %idxprom68
  %arrayidx73 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv89
  br label %for.cond59
...
for.cond59:                                       ; preds = %for.cond59.preheader, %for.inc75
  %indvars.iv83 = phi i64 [ 0, %for.cond59.preheader ], [ %indvars.iv.next84, %for.inc75 ]
  %exitcond88.not = icmp eq i64 %indvars.iv83, %wide.trip.count87
  br i1 %exitcond88.not, label %for.inc78, label %for.body61

for.body61:                                       ; preds = %for.cond59
  %arrayidx65 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv89, i64 %indvars.iv83
...
for.cond81:                                       ; preds = %for.cond81.preheader, %for.inc111
  %indvars.iv99 = phi i64 [ 0, %for.cond81.preheader ], [ %indvars.iv.next100, %for.inc111 ]
  %exitcond104.not = icmp eq i64 %indvars.iv99, %wide.trip.count103
  br i1 %exitcond104.not, label %for.cond114.preheader, label %for.cond84
...
for.cond84:                                       ; preds = %for.cond81, %for.body86
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.body86 ], [ 0, %for.cond81 ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %wide.trip.count81
  br i1 %exitcond98.not, label %for.inc111, label %for.body86

for.body86:                                       ; preds = %for.cond84
  %arrayidx90 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
  %11 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next95 = add nuw nsw i64 %indvars.iv94, 1
  %arrayidx95 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %bj, i64 0, i64 %indvars.iv.next95, i64 %indvars.iv99
...
for.cond114:                                      ; preds = %for.cond114.preheader, %for.inc137
  %indvars.iv110 = phi i64 [ 0, %for.cond114.preheader ], [ %indvars.iv.next111, %for.inc137 ]
  %exitcond114.not = icmp eq i64 %indvars.iv110, %wide.trip.count103
  br i1 %exitcond114.not, label %for.cond140, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %arrayidx128 = getelementptr inbounds [8 x [8 x i32]], ptr %bj, i64 0, i64 %idxprom125, i64 %indvars.iv110
  %arrayidx132 = getelementptr inbounds nuw [8 x i32], ptr %hd, i64 0, i64 %indvars.iv110
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc134
  %indvars.iv105 = phi i64 [ 0, %for.cond117.preheader ], [ %indvars.iv.next106, %for.inc134 ]
  %exitcond109.not = icmp eq i64 %indvars.iv105, %wide.trip.count81
  br i1 %exitcond109.not, label %for.inc137, label %for.body119

for.body119:                                      ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [8 x [8 x i32]], ptr %td, i64 0, i64 %indvars.iv105, i64 %indvars.iv110
...
if.then130:                                       ; preds = %for.body119
  %15 = trunc nuw nsw i64 %indvars.iv105 to i32
...
for.cond140:                                      ; preds = %for.cond114, %for.inc150
  %indvars.iv115 = phi i64 [ %indvars.iv.next116, %for.inc150 ], [ 0, %for.cond114 ]
  %exitcond119.not = icmp eq i64 %indvars.iv115, %wide.trip.count81
  br i1 %exitcond119.not, label %for.end152, label %for.body142

for.body142:                                      ; preds = %for.cond140
  %arrayidx144 = getelementptr inbounds nuw [8 x i32], ptr %zd, i64 0, i64 %indvars.iv115
  ...
  %cmp147 = icmp eq i64 %indvars.iv115, %18
