...
define dso_local void @_Z5rightPcii(ptr nofree noundef nonnull captures(none) %a, i32 noundef %l, i32 noundef %t) #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @_Z4leftPcii(ptr nofree noundef nonnull captures(none) %a, i32 noundef %l, i32 noundef %t) #0 {
entry:
  %invariant.gep = getelementptr i8, ptr %a, i64 -1
...
entry:
  ...
  %smax38 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
  %1 = add nuw i32 %smax38, 1
  %wide.trip.count39 = zext i32 %1 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc73 ], [ 1, %entry ]
  %exitcond40 = icmp eq i64 %indvars.iv33, %wide.trip.count39
  br i1 %exitcond40, label %for.end75, label %for.body
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select23, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext53 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext53, 32
  ...
  %spec.select23 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %invariant.gep27 = getelementptr i8, ptr %a, i64 -1
  %cmp51 = icmp slt i32 %conv9, %conv12
  %sext = shl i64 %call6, 32
  %7 = ashr exact i64 %sext, 32
  %8 = and i64 %indvars.iv33, 4294967295
  %gep = getelementptr i8, ptr %invariant.gep, i64 %7
  %add49 = add i64 %indvars.iv33, %call8
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %sext51 = shl i64 %add49, 32
  %9 = ashr exact i64 %sext51, 32
  %gep28 = getelementptr i8, ptr %invariant.gep27, i64 %7
  %10 = sub i32 %conv12, %conv9
  %smax41 = call i32 @llvm.abs.i32(i32 %10, i1 false)
  %11 = add nuw i32 %smax41, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond42 = icmp eq i32 %j.1, %11
  br i1 %exitcond42, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv33, 4294967294
  %smax48 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %12 = add nuw i32 %smax48, 1
  %wide.trip.count49 = zext i32 %12 to i64
  br label %for.cond58
...
for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep27, i64 %indvars.iv.i
...
_Z4leftPcii.exit:                                 ; preds = %for.cond.i
  store i8 0, ptr %gep28, align 1, !tbaa !5
  br label %for.inc55

if.end50:                                         ; preds = %for.body45
  br i1 %cmp51, label %for.cond.i14, label %for.inc55

for.cond.i14:                                     ; preds = %if.end50, %for.inc.i17
  %indvars.iv.i15 = phi i64 [ %indvars.iv.next.i19, %for.inc.i17 ], [ %7, %if.end50 ]
  %cmp.not.i16 = icmp slt i64 %indvars.iv.i15, %8
  br i1 %cmp.not.i16, label %_Z5rightPcii.exit, label %for.inc.i17

for.inc.i17:                                      ; preds = %for.cond.i14
  %gep.i18 = getelementptr i8, ptr %invariant.gep27, i64 %indvars.iv.i15
  %14 = load i8, ptr %gep.i18, align 1, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i8, ptr %a, i64 %indvars.iv.i15
  store i8 %14, ptr %arrayidx2.i, align 1, !tbaa !5
  %indvars.iv.next.i19 = add nsw i64 %indvars.iv.i15, -1
  br label %for.cond.i14, !llvm.loop !8

_Z5rightPcii.exit:                                ; preds = %for.cond.i14
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv43 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next44, %for.inc68 ]
  %exitcond50 = icmp eq i64 %indvars.iv43, %wide.trip.count49
  br i1 %exitcond50, label %for.end75, label %for.inc68
...
for.inc68:                                        ; preds = %for.cond58
  ...
  %17 = add i64 %add64, %indvars.iv43
  %sext52 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext52, 32
