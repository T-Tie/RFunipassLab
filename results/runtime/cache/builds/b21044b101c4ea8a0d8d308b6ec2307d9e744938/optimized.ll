...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv61.in = phi i64 [ %indvars.iv61, %for.end114 ], [ %2, %entry ]
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.end114 ], [ %2, %entry ]
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %indvars.iv61 = add i64 %indvars.iv61.in, -1
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv61, i64 1)
  %3 = trunc nuw i64 %indvars.iv54 to i32
  %smax51 = tail call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv56, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv56 to i32
  %smax35 = tail call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count14 = zext nneg i32 %smax35 to i64
  %wide.trip.count = and i64 %indvars.iv56, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv11 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next12, %for.inc28 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.cond31, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv11, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  ...
  br i1 %exitcond10.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv11, i64 %indvars.iv6
...
for.cond31:                                       ; preds = %for.cond, %for.inc66
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc66 ], [ 0, %for.cond ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count14
  br i1 %exitcond31.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select4, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv16, i64 %indvars.iv26
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %spec.select4 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond34, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc63 ], [ 0, %for.cond51.preheader ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv21, i64 %indvars.iv26
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc89 ], [ 1, %for.end68 ]
  %exitcond.not63 = icmp eq i64 %indvars.iv38, %smax
  br i1 %exitcond.not63, label %for.cond92.preheader, label %for.cond75
...
for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, %wide.trip.count14
  br i1 %exitcond37.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv38, i64 %indvars.iv32
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv38, i64 %indvars.iv32
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv48 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next49, %for.inc112 ]
  %exitcond53.not = icmp eq i64 %indvars.iv48, %wide.trip.count52
  br i1 %exitcond53.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond47.not = icmp eq i64 %indvars.iv41, %indvars.iv54
  br i1 %exitcond47.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv48, i64 %indvars.iv.next42
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv48, i64 %indvars.iv41
