...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc12 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx10 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc191
  %indvars.iv71 = phi i64 [ %3, %for.cond15.preheader ], [ %indvars.iv.next72, %for.inc191 ]
  %min.1 = phi i32 [ %min.0, %for.cond15.preheader ], [ %min.5, %for.inc191 ]
  %s.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add, %for.inc191 ]
  %6 = trunc nuw i64 %indvars.iv71 to i32
  %cmp16 = icmp sgt i32 %6, 1
  br i1 %cmp16, label %for.cond19, label %for.inc195

for.cond19:                                       ; preds = %for.cond15, %for.inc56
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc56 ], [ 0, %for.cond15 ]
  %min.2 = phi i32 [ %min.3, %for.inc56 ], [ %min.1, %for.cond15 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %indvars.iv71
  br i1 %exitcond20.not, label %for.cond60, label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %for.cond19
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc41
  %indvars.iv8 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next9, %for.inc41 ]
  %min.3 = phi i32 [ %min.2, %for.cond23.preheader ], [ %min.4, %for.inc41 ]
  %exitcond.not = icmp eq i64 %indvars.iv8, %indvars.iv71
...
for.body26:                                       ; preds = %for.cond23
  %cmp27 = icmp eq i64 %indvars.iv8, 0
...
if.else:                                          ; preds = %for.body26
  %arrayidx35 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv8
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc53
  %indvars.iv11 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next12, %for.inc53 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %indvars.iv71
  br i1 %exitcond15.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond45
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv11
...
for.cond60:                                       ; preds = %for.cond19, %for.inc106
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc106 ], [ 0, %for.cond19 ]
  %min.5 = phi i32 [ %min.6, %for.inc106 ], [ %min.2, %for.cond19 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %indvars.iv71
  br i1 %exitcond35.not, label %for.end108, label %for.cond65.preheader

for.cond65.preheader:                             ; preds = %for.cond60
  %arrayidx74 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv31
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc90
  %indvars.iv21 = phi i64 [ 0, %for.cond65.preheader ], [ %indvars.iv.next22, %for.inc90 ]
  %min.6 = phi i32 [ %min.5, %for.cond65.preheader ], [ %min.7, %for.inc90 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %indvars.iv71
  br i1 %exitcond25.not, label %for.cond94.preheader, label %for.body68

for.cond94.preheader:                             ; preds = %for.cond65
  br label %for.cond94

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i64 %indvars.iv21, 0
...
if.else75:                                        ; preds = %for.body68
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv31
  %11 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %spec.select3 = call i32 @llvm.smin.i32(i32 %min.6, i32 %11)
  br label %for.inc90

for.inc90:                                        ; preds = %if.else75, %if.then70
  %min.7 = phi i32 [ %10, %if.then70 ], [ %spec.select3, %if.else75 ]
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond65, !llvm.loop !16

for.cond94:                                       ; preds = %for.cond94.preheader, %for.inc103
  %indvars.iv26 = phi i64 [ 0, %for.cond94.preheader ], [ %indvars.iv.next27, %for.inc103 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %indvars.iv71
  br i1 %exitcond30.not, label %for.inc106, label %for.inc103

for.inc103:                                       ; preds = %for.cond94
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv31
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc132 ], [ 0, %for.end108 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %indvars.iv71
  br i1 %exitcond45.not, label %for.cond136, label %for.cond117

for.cond117:                                      ; preds = %for.cond112, %for.inc129
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc129 ], [ 0, %for.cond112 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %indvars.iv71
  br i1 %exitcond40.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx124 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv41, i64 %indvars.iv36
  %14 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv41, i64 %indvars.iv36
...
for.cond136:                                      ; preds = %for.cond112, %for.inc147
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc147 ], [ 2, %for.cond112 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %indvars.iv71
  br i1 %exitcond51.not, label %for.cond151, label %for.inc147

for.inc147:                                       ; preds = %for.cond136
  %arrayidx141 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv46
...
for.cond151:                                      ; preds = %for.cond136, %for.inc162
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc162 ], [ 2, %for.cond136 ]
  %exitcond57.not = icmp eq i64 %indvars.iv52, %indvars.iv71
  br i1 %exitcond57.not, label %for.cond166, label %for.inc162

for.inc162:                                       ; preds = %for.cond151
  %arrayidx157 = getelementptr inbounds nuw [100 x i32], ptr %temp, i64 0, i64 %indvars.iv52
...
for.cond166:                                      ; preds = %for.cond151, %for.inc188
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc188 ], [ 2, %for.cond151 ]
  %exitcond69.not = icmp eq i64 %indvars.iv64, %indvars.iv71
  br i1 %exitcond69.not, label %for.inc191, label %for.cond171.preheader

for.cond171.preheader:                            ; preds = %for.cond166
  %19 = add nsw i64 %indvars.iv64, -1
  br label %for.cond171

for.cond171:                                      ; preds = %for.cond171.preheader, %for.inc185
  %indvars.iv58 = phi i64 [ 2, %for.cond171.preheader ], [ %indvars.iv.next59, %for.inc185 ]
  %exitcond63.not = icmp eq i64 %indvars.iv58, %indvars.iv71
  br i1 %exitcond63.not, label %for.inc188, label %for.inc185

for.inc185:                                       ; preds = %for.cond171
  %arrayidx178 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %temp, i64 0, i64 %indvars.iv64, i64 %indvars.iv58
