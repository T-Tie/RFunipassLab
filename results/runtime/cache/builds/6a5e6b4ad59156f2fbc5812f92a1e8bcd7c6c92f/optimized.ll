...
for.cond2:                                        ; preds = %for.cond, %for.end15
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.end15 ], [ 0, %for.cond ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end15 ], [ 1, %for.cond ]
