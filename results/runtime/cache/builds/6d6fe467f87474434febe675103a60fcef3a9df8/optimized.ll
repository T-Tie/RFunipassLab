...
while.end21:                                      ; preds = %while.cond17
  %nPtr.2.lcssa = phi ptr [ %nPtr.2, %while.cond17 ]
  br label %while.cond22

while.cond22:                                     ; preds = %while.body26, %while.end21
  %sPtr.1 = phi ptr [ %str, %while.end21 ], [ %incdec.ptr30, %while.body26 ]
  %nPtr.3 = phi ptr [ %nPtr.2.lcssa, %while.end21 ], [ %incdec.ptr27, %while.body26 ]
...
while.end31:                                      ; preds = %while.cond22
  %sPtr.1.lcssa = phi ptr [ %sPtr.1, %while.cond22 ]
  store i8 0, ptr %sPtr.1.lcssa, align 1, !tbaa !12
