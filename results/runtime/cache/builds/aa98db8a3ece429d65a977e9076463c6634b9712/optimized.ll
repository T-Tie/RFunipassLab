...
for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.cond.cleanup3 ], [ 0, %entry ]
  %1 = sext i32 %0 to i64
...
for.cond1:                                        ; preds = %for.cond, %for.body4
  %2 = phi i32 [ %.pre32, %for.body4 ], [ %0, %for.cond ]
...
for.body4:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv19, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %cleanup
  %indvars.iv26 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next27, %cleanup ]
  ...
  br i1 %exitcond31.not, label %for.end30, label %for.cond15.preheader

for.cond15.preheader:                             ; preds = %for.cond11
  %4 = trunc nuw nsw i64 %indvars.iv26 to i32
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %if.else
  %indvars.iv22 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next23, %if.else ]
  %exitcond.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond.not, label %cleanup, label %for.body18

for.body18:                                       ; preds = %for.cond15
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %sz, i64 0, i64 %indvars.iv26, i64 %indvars.iv22
  %5 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !13
  %cmp23 = icmp eq i32 %5, 0
  br i1 %cmp23, label %cleanup.split.loop.exit, label %if.else
...
cleanup:                                          ; preds = %for.cond15, %cleanup.split.loop.exit
  ...
  %s.1 = phi i32 [ %6, %cleanup.split.loop.exit ], [ %s.0, %for.cond15 ]
...
for.cond31:                                       ; preds = %cleanup48, %for.end30
  %p.0 = phi i32 [ undef, %for.end30 ], [ %p.1, %cleanup48 ]
  %q.0 = phi i32 [ undef, %for.end30 ], [ %q.1, %cleanup48 ]
  %c.0 = phi i32 [ %sub, %for.end30 ], [ %dec51, %cleanup48 ]
...
for.cond36:                                       ; preds = %for.cond36.preheader, %if.else46
  %d.0 = phi i32 [ %dec, %if.else46 ], [ %sub, %for.cond36.preheader ]
...
for.body39:                                       ; preds = %for.cond36
  ...
  br i1 %cmp44, label %cleanup48, label %if.else46

if.else46:                                        ; preds = %for.body39
  %dec = add nsw i32 %d.0, -1
  br label %for.cond36, !llvm.loop !16

cleanup48:                                        ; preds = %for.body39, %for.cond36
...
for.end53:                                        ; preds = %for.cond31
  ...
  %call58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %mul) #6
