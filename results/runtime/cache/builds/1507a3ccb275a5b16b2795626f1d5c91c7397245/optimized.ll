...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %h) #7
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %len) #7
...
for.cond3:                                        ; preds = %if.end32, %for.end
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %if.end32 ], [ 1, %for.end ]
  %ans.0 = phi i32 [ %spec.select22, %if.end32 ], [ 1, %for.end ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end42, label %for.cond6.preheader

for.cond6.preheader:                              ; preds = %for.cond3
  %arrayidx12 = getelementptr inbounds nuw [25 x i32], ptr %h, i64 0, i64 %indvars.iv27
  %2 = load i32, ptr %arrayidx12, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond6

for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc21
  %indvars.iv24 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next25, %for.inc21 ]
  %temp.0 = phi i32 [ -1, %for.cond6.preheader ], [ %temp.1, %for.inc21 ]
  %tIndex.0 = phi i32 [ -1, %for.cond6.preheader ], [ %tIndex.1, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv24, %indvars.iv27
  br i1 %exitcond.not, label %for.end23, label %for.body8

for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [25 x i32], ptr %h, i64 0, i64 %indvars.iv24
...
if.then:                                          ; preds = %for.body8
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv24
  ...
  %spec.select21 = select i1 %cmp16, i32 %5, i32 %tIndex.0
  br label %for.inc21

for.inc21:                                        ; preds = %if.then, %for.body8
  %temp.1 = phi i32 [ %temp.0, %for.body8 ], [ %spec.select, %if.then ]
  %tIndex.1 = phi i32 [ %tIndex.0, %for.body8 ], [ %spec.select21, %if.then ]
...
if.end32:                                         ; preds = %for.end23, %if.else
  ...
  %7 = getelementptr inbounds nuw [25 x i32], ptr %len, i64 0, i64 %indvars.iv27
  store i32 %add.sink, ptr %7, align 4, !tbaa !5
  %spec.select22 = call i32 @llvm.smax.i32(i32 %add.sink, i32 %ans.0)
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %len) #8
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %h) #8
