...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 dereferenceable(100) %a) #5
...
if.then10:                                        ; preds = %for.body4
  ...
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %4, i32 noundef %m) #7
