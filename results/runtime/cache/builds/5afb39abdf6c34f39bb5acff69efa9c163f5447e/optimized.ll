...
for.cond17:                                       ; preds = %for.inc25, %for.end
  %indvars.iv.next11.sink = phi i64 [ %indvars.iv.next11, %for.inc25 ], [ %idxprom13, %for.end ]
  %call20.sink = phi ptr [ %call20, %for.inc25 ], [ @_ZSt4cout, %for.end ]
  %arrayidx22 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %indvars.iv.next11.sink
  ...
  %cmp18 = icmp sgt i64 %indvars.iv.next11.sink, 0
