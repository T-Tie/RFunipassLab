...
entry:
  %call = tail call i64 @strlen(ptr nofree noundef nonnull readonly dereferenceable(1) %word) #10
...
while.end.thread:                                 ; preds = %while.cond
  ...
  %call1610 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
if.end10:                                         ; preds = %if.end
  ...
  %call14 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx12) #11
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !14, !invariant.load !25
  ret i64 %0
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !33, !invariant.load !25
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !34, !invariant.load !25
...
!28 = !{!"_ZTSNSt6locale5facetE", !10, i64 8}
