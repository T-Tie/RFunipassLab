...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond26.not, label %for.end33, label %for.cond13.preheader
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv17
...
for.cond34:                                       ; preds = %for.inc59, %for.end33
  ...
  %cmp35 = icmp sgt i32 %sub.sink, -1
  br i1 %cmp35, label %for.cond38.preheader, label %for.end61

for.cond38.preheader:                             ; preds = %for.cond34
  %idxprom51 = zext nneg i32 %sub.sink to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc49
  %indvars.iv27 = phi i64 [ %8, %for.cond38.preheader ], [ %indvars.iv.next28, %for.inc49 ]
  %cmp39 = icmp sgt i64 %indvars.iv27, -1
  %9 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51, i64 %indvars.iv27
...
for.inc59:                                        ; preds = %for.end50
  %dec60 = add nsw i32 %sub.sink, -1
  br label %for.cond34, !llvm.loop !17

for.end61.loopexit:                               ; preds = %for.body40
  %11 = trunc nsw i64 %indvars.iv27 to i32
  br label %for.end61

for.end61:                                        ; preds = %for.end50, %for.cond34, %for.end61.loopexit
  %x2.0 = phi i32 [ %sub.sink, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %y2.0 = phi i32 [ %11, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %12 = xor i32 %y1.1, -1
  %sub63 = add i32 %y2.0, %12
  %13 = xor i32 %x1.1, -1
  %sub66 = add i32 %x2.0, %13
