...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc28 ], [ 1, %for.end ]
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp6 = icmp slt i64 %indvars.iv8, %7
  br i1 %cmp6, label %for.cond9.preheader, label %for.end31

for.cond9.preheader:                              ; preds = %for.cond5
  %arrayidx14 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv8
  %8 = add nsw i64 %indvars.iv8, -1
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc25
  %indvars.iv5 = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next6, %for.inc25 ]
...
for.body12:                                       ; preds = %for.cond9
  ...
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv5
...
if.end:                                           ; preds = %for.body12
  %cmp18 = icmp eq i64 %indvars.iv5, %8
