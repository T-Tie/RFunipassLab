...
for.cond37:                                       ; preds = %for.inc47, %for.end35
  %dm.0 = phi i32 [ %8, %for.end35 ], [ %dm.1, %for.inc47 ]
...
for.body39:                                       ; preds = %for.cond37
  ...
  %10 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !13
  %cmp42 = icmp sgt i32 %10, %dm.0
...
for.inc47:                                        ; preds = %for.body39, %if.then43
  %dm.1 = phi i32 [ %10, %if.then43 ], [ %dm.0, %for.body39 ]
