...
if.end:                                           ; preds = %land.lhs.true, %for.body23
  ...
  %9 = load i32, ptr %arrayidx27, align 16, !tbaa !5, !invariant.load !9
  %add = add nsw i32 %t.0, 1
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc45, %if.end
  %j29.0 = phi i32 [ %add, %if.end ], [ %inc46, %for.inc45 ]
  %minValue.0 = phi i32 [ %9, %if.end ], [ %minValue.1, %for.inc45 ]
  %cmp31 = icmp slt i32 %j29.0, %8
...
for.body33:                                       ; preds = %for.cond30
  ...
  %cmp38 = icmp slt i32 %10, %minValue.0
...
for.body57:                                       ; preds = %for.cond54
  ...
  %13 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !9
  %sub62 = sub nsw i32 %13, %minValue.0
  store i32 %sub62, ptr %arrayidx61, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr %j52)
  br label %for.cond54

for.end65:                                        ; preds = %for.cond54
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j52) #8
  br label %for.inc66
...
for.cond85:                                       ; preds = %for.inc100, %if.end78
  ...
  %minValue79.0 = phi i32 [ %15, %if.end78 ], [ %minValue79.1, %for.inc100 ]
  %cmp86 = icmp slt i32 %i83.0, %14
...
for.body88:                                       ; preds = %for.cond85
  ...
  %16 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !9
  %cmp93 = icmp slt i32 %16, %minValue79.0
...
for.inc100:                                       ; preds = %for.body88, %if.then94
  %minValue79.1 = phi i32 [ %16, %if.then94 ], [ %minValue79.0, %for.body88 ]
...
for.body112:                                      ; preds = %for.cond109
  ...
  call fastcc void @outlined_ir_func_0(ptr %i107)
  br label %for.cond109

for.end120:                                       ; preds = %for.cond109
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i107) #8
  br label %for.inc121
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !17, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !19, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !37, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !43, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !17, !invariant.load !9
