...
for.cond4:                                        ; preds = %for.body6, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc12, %for.body6 ]
...
for.cond5:                                        ; preds = %for.body7, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc15, %for.body7 ]
...
for.cond4:                                        ; preds = %for.body6, %for.body3
  %t.0 = phi i32 [ 0, %for.body3 ], [ %inc, %for.body6 ]
...
for.cond14:                                       ; preds = %for.end62, %for.end12
  %j.1 = phi i32 [ %1, %for.end12 ], [ %dec, %for.end62 ]
  %h.0 = phi i32 [ 0, %for.end12 ], [ %add, %for.end62 ]
  %cmp15 = icmp sgt i32 %j.1, 1
  br i1 %cmp15, label %for.body16, label %for.end64

for.body16:                                       ; preds = %for.cond14
  call void @_Z2f1Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %j.1, i32 noundef %j.1) #7
  call void @_Z2f2Piii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %j.1, i32 noundef %j.1) #7
...
for.cond19:                                       ; preds = %for.end36, %for.body16
  %t.1 = phi i32 [ 0, %for.body16 ], [ %inc38, %for.end36 ]
...
for.cond22:                                       ; preds = %for.body24, %for.body21
  %m.0 = phi i32 [ 1, %for.body21 ], [ %add27, %for.body24 ]
...
for.cond40:                                       ; preds = %for.end59, %for.end39
  %t.2 = phi i32 [ 0, %for.end39 ], [ %inc61, %for.end59 ]
...
for.cond44:                                       ; preds = %for.body47, %for.body43
  %m.1 = phi i32 [ 1, %for.body43 ], [ %add48, %for.body47 ]
...
for.end64:                                        ; preds = %for.cond14
  %call65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %h.0) #7
