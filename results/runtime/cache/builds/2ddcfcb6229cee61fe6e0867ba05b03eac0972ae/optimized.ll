...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr nonnull %num) #7
...
if.else:                                          ; preds = %for.body
  ...
  %call57 = call double @sqrt(double noundef %8) #7, !tbaa !5
  ...
  %call67 = call double @sqrt(double noundef %8) #7, !tbaa !5
...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %cmp76.not.not = icmp slt i64 %indvars.iv56, %10
...
for.end134:                                       ; preds = %for.cond74
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr nonnull %num) #7
