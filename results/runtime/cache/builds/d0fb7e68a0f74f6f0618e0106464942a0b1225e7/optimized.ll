...
if.then99:                                        ; preds = %for.body96
  %8 = load i8, ptr %arrayidx103, align 1, !tbaa !34
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %8, ptr %__c.addr.i, align 1, !tbaa !34
  ...
  %9 = load i64, ptr %gep79, align 8, !tbaa !11
...
if.else106:                                       ; preds = %for.body96
  ...
  %10 = load i8, ptr %arrayidx110, align 1, !tbaa !34
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i6)
  store i8 %10, ptr %__c.addr.i6, align 1, !tbaa !34
  ...
  %11 = load i64, ptr %gep78, align 8, !tbaa !11
...
!42 = !{!24, !28, i64 240}
!43 = !{!44, !7, i64 56}
!44 = !{!"_ZTSSt5ctypeIcE", !45, i64 0, !46, i64 16, !26, i64 24, !47, i64 32, !47, i64 40, !48, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
