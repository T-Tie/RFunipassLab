...
for.cond:                                         ; preds = %for.body, %entry
  %count.0 = phi i32 [ 0, %entry ], [ %spec.select11, %for.body ]
  %i.0 = phi i32 [ %min, %entry ], [ %inc, %for.body ]
...
for.body:                                         ; preds = %for.cond
  ...
  %add4 = select i1 %cmp2, i32 %count.0, i32 0
  %spec.select11 = add nsw i32 %spec.select, %add4
