...
for.body:                                         ; preds = %for.cond
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br i1 %or.cond2, label %for.cond7, label %for.cond85
...
for.cond7:                                        ; preds = %for.body, %for.inc
  ...
  br i1 %exitcond15.not, label %for.end, label %for.body9
...
for.inc:                                          ; preds = %for.body9, %for.inc.fold.split, %if.else27
  %.sink1 = phi i32 [ 30, %if.else27 ], [ 29, %for.body9 ], [ 31, %for.inc.fold.split ]
  %add28 = add nuw nsw i32 %.sink1, %n1.0
...
for.inc109:                                       ; preds = %for.body87, %for.inc109.fold.split, %if.else105
  %.sink = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %for.inc109.fold.split ]
  %add106 = add nuw nsw i32 %.sink, %n182.0
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  %.sink = phi i32 [ 30, %if.else52 ], [ %1, %for.body32 ], [ 31, %for.inc56.fold.split ]
  %add53 = add nsw i32 %.sink, %n2.0
...
if.end163.exitStub:                               ; preds = %if.then70, %if.end68
  ret void
}
