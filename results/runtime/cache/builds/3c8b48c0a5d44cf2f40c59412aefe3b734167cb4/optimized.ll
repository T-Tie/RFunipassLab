...
for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond38 = icmp eq i64 %indvars.iv33, %wide.trip.count37
  br i1 %exitcond38, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax24 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.body19:                                       ; preds = %for.cond17
  ...
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv21, i64 %indvars.iv15
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv21, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv27 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next28, %for.inc56 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond32.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv27, %indvars.iv33
  ...
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv27
...
for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc121
  %indvars.iv43 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next44, %for.inc121 ]
  %exitcond51.not = icmp eq i64 %indvars.iv43, %wide.trip.count50
  br i1 %exitcond51.not, label %for.end123, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv43, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc118
  %indvars.iv45 = phi i64 [ %indvars.iv43, %for.cond76.preheader ], [ %indvars.iv.next46, %for.inc118 ]
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  %10 = trunc nuw i64 %indvars.iv.next46 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.inc121

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next46, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond42.not = icmp eq i64 %indvars.iv39, 6
  br i1 %exitcond42.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next46, i64 %indvars.iv39
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv39
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv43, i64 %indvars.iv39
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc151 ], [ 1, %if.else ]
  %exitcond61.not = icmp eq i64 %indvars.iv52, %wide.trip.count60
  br i1 %exitcond61.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv52, i64 4
  %17 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %18 = add nsw i64 %indvars.iv52, -1
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars59.le = trunc i64 %indvars.iv52 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars59.le, %for.end153.split.loop.exit ], [ %3, %for.cond134 ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count74 = zext i32 %sub155 to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond75.not = icmp eq i64 %indvars.iv66, %wide.trip.count74
  br i1 %exitcond75.not, label %for.cond207.preheader, label %for.cond159.preheader

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count82 = zext i32 %z.1.lcssa to i64
  br label %for.cond207

for.cond159.preheader:                            ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv66, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  %indvars.iv68 = phi i64 [ %indvars.iv66, %for.cond159.preheader ], [ %indvars.iv.next69, %for.inc201 ]
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %exitcond72.not = icmp eq i64 %indvars.iv68, %wide.trip.count74
  br i1 %exitcond72.not, label %for.inc204, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next69, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond65.not = icmp eq i64 %indvars.iv62, 6
  br i1 %exitcond65.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next69, i64 %indvars.iv62
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv62
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv66, i64 %indvars.iv62
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv79 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next80, %for.inc223 ]
  %exitcond83.not = icmp eq i64 %indvars.iv79, %wide.trip.count82
  br i1 %exitcond83.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv76, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv79, i64 %indvars.iv76
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar13 = call i32 @putchar(i32 noundef %conv218) #10
