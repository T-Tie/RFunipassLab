...
entry:
  ...
  store i32 %k, ptr %b, align 4, !tbaa !5
  br label %for.cond
...
for.body36:                                       ; preds = %for.cond34
  store i32 0, ptr %judge, align 4, !tbaa !5
  store i32 1, ptr %j, align 4, !tbaa !5
  br label %for.cond37
...
if.then45:                                        ; preds = %for.body39
  store i32 1, ptr %judge, align 4, !tbaa !5
  br label %for.end49
...
for.end49:                                        ; preds = %if.then45, %for.cond37
  %12 = load i32, ptr %judge, align 4, !tbaa !5
  %cmp50 = icmp eq i32 %12, 0
  br i1 %cmp50, label %if.then51, label %if.end87
