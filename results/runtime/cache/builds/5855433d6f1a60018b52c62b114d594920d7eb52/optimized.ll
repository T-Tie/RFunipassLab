...
for.body:                                         ; preds = %for.cond
  ...
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %c)
  %call.i4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i3, ptr noundef nonnull align 8 dereferenceable(8) %d)
...
for.inc:                                          ; preds = %for.body, %if.else, %if.else17
  %.str.2.sink.sink = phi ptr [ @.str.2, %if.else17 ], [ @.str.1, %if.else ], [ @.str, %for.body ]
