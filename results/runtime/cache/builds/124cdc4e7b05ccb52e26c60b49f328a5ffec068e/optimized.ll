...
for.cond10:                                       ; preds = %for.inc24, %for.end9
  %j1.0 = phi i32 [ undef, %for.end9 ], [ %j1.1, %for.inc24 ]
  %i1.0 = phi i32 [ undef, %for.end9 ], [ %i1.1, %for.inc24 ]
  %i.1 = phi i32 [ 1, %for.end9 ], [ %inc25, %for.inc24 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  br i1 %cmp20, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.body15
  %inc22 = add nsw i32 %j.1, 1
  br label %for.cond13, !llvm.loop !13

for.inc24:                                        ; preds = %for.cond13, %for.body15
  %j1.1 = phi i32 [ %j1.0, %for.cond13 ], [ %j.1, %for.body15 ]
  %i1.1 = phi i32 [ %i1.0, %for.cond13 ], [ %i.1, %for.body15 ]
  %inc25 = add nsw i32 %i.1, 1
  br label %for.cond10, !llvm.loop !14

for.end26:                                        ; preds = %for.cond10
  %j1.0.lcssa = phi i32 [ %j1.0, %for.cond10 ]
  %i1.0.lcssa = phi i32 [ %i1.0, %for.cond10 ]
  br label %for.cond27

for.cond27:                                       ; preds = %for.inc42, %for.end26
  %i2.0 = phi i32 [ undef, %for.end26 ], [ %i2.1, %for.inc42 ]
  %i.2 = phi i32 [ %.lcssa, %for.end26 ], [ %dec43, %for.inc42 ]
  %j2.0 = phi i32 [ undef, %for.end26 ], [ %j2.1, %for.inc42 ]
...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %j.2 = phi i32 [ %.lcssa, %for.body29 ], [ %dec, %for.inc40 ]
...
for.inc42:                                        ; preds = %for.cond30, %for.body32
  %i2.1 = phi i32 [ %i2.0, %for.cond30 ], [ %i.2, %for.body32 ]
...
for.end44:                                        ; preds = %for.cond27
  %i2.0.lcssa = phi i32 [ %i2.0, %for.cond27 ]
  %j2.0.lcssa = phi i32 [ %j2.0, %for.cond27 ]
  %j1.0.lcssa.neg = sub i32 0, %j1.0.lcssa
  %sub = add i32 %j1.0.lcssa.neg, -1
  %sub45 = add i32 %sub, %j2.0.lcssa
  %i2.0.lcssa.neg = sub i32 0, %i2.0.lcssa
  %sub46 = add i32 %i1.0.lcssa, -1
  %sub47 = add i32 %sub46, %i2.0.lcssa.neg
