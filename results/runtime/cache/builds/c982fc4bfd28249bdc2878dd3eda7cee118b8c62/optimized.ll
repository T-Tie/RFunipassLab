...
for.end20:                                        ; preds = %for.cond
  %1 = load float, ptr %a, align 16, !tbaa !9
  %conv = fpext float %1 to double
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %conv)
  %arrayidx27 = getelementptr inbounds nuw i8, ptr %a, i64 4
  %2 = load float, ptr %arrayidx27, align 4
  %cmp28 = fcmp une float %2, 0x3FB99999A0000000
  br label %for.cond23

for.cond23:                                       ; preds = %if.end34, %for.end20
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %if.end34 ], [ 1, %for.end20 ]
...
if.then29:                                        ; preds = %for.body25
  %arrayidx31 = getelementptr inbounds nuw [1000 x float], ptr %a, i64 0, i64 %indvars.iv12
  %4 = load float, ptr %arrayidx31, align 4, !tbaa !9, !invariant.load !11
  %conv32 = fpext float %4 to double
  %call33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %conv32)
  br label %if.end34

if.end34:                                         ; preds = %if.then29, %for.body25
