...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %b) #9
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %c) #10
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %d) #10
...
for.inc:                                          ; preds = %if.then, %if.else17, %if.then14
  %.str.2.sink = phi ptr [ @.str.2, %if.else17 ], [ @.str.1, %if.then14 ], [ @.str, %if.then ]
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %.str.2.sink)
