...
if.then6.i47:                                     ; preds = %if.then28.i34, %if.then19.i23, %if.then6.i8
  ...
  %call16.i57 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i56) #10
  %5 = add i64 %4, -301
...
if.then19.i62:                                    ; preds = %if.then6.i47
  ...
  %call24.i67 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i66) #10
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit78: ; preds = %if.then6.i47, %if.then19.i62, %if.then28.i73
  %call7 = call noundef ptr @strstr(ptr noundef nonnull align 16 dereferenceable(300) %s, ptr noundef nonnull dereferenceable(1) %sub) #11
