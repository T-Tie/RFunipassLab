...
if.else:                                          ; preds = %for.end123
  ...
  %smax46 = call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %l.0, i32 noundef 1)
  %17 = add nsw i32 %smax46, -1
  %wide.trip.count48 = zext nneg i32 %smax46 to i64
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  ...
  %cmp212 = icmp slt i64 %indvars.iv64, %28
