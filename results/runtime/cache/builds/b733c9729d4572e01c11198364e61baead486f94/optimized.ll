...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %a) #4
...
while.end48:                                      ; preds = %while.cond4
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %a) #5
  ret i32 0
}
