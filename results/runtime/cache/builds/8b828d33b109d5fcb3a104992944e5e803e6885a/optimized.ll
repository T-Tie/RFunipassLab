...
for.end:                                          ; preds = %for.cond
  ...
  %smax102 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  %2 = add nuw i32 %smax102, 1
  %wide.trip.count103 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond104 = icmp eq i64 %indvars.iv99, %wide.trip.count103
  br i1 %exitcond104, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax90 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.cond71.preheader:                             ; preds = %for.cond11
  ...
  %smax117 = add nsw i32 %3, -1
  %wide.trip.count118 = zext nneg i32 %smax117 to i64
  br label %for.cond71

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv87 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next88, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond92.not = icmp eq i64 %indvars.iv87, %wide.trip.count91
  br i1 %exitcond92.not, label %for.end43, label %for.cond17.preheader

for.cond17.preheader:                             ; preds = %for.cond14
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.body19
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.body19 ], [ 0, %for.cond17.preheader ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond17.preheader ]
  %exitcond86.not = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond86.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv81, %indvars.iv99
  %arrayidx21 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx21, align 1, !tbaa !9
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv87, i64 %indvars.iv81
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv87, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv93 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next94, %for.inc56 ]
  %exitcond98.not = icmp eq i64 %indvars.iv93, %wide.trip.count
  br i1 %exitcond98.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv93, %indvars.iv99
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv93
...
for.cond71:                                       ; preds = %for.cond71.loopexit, %for.cond71.preheader
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.cond71.loopexit ], [ 0, %for.cond71.preheader ]
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.cond71.loopexit ], [ 1, %for.cond71.preheader ]
  %exitcond119.not = icmp eq i64 %indvars.iv114, %wide.trip.count118
  br i1 %exitcond119.not, label %for.end123, label %for.body74

for.body74:                                       ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv114, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc118, %for.body74
  %indvars.iv111 = phi i64 [ %indvars.iv.next112, %for.inc118 ], [ %indvars.iv109, %for.body74 ]
  %10 = trunc nuw i64 %indvars.iv111 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.cond71.loopexit

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv111, i64 4
  %11 = load i8, ptr %arrayidx81, align 2, !tbaa !9
  %12 = load i8, ptr %arrayidx85, align 2, !tbaa !9
  %cmp87 = icmp sgt i8 %11, %12
  br i1 %cmp87, label %for.cond89.preheader, label %for.inc118

for.cond89.preheader:                             ; preds = %for.body78
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc114
  %indvars.iv105 = phi i64 [ %indvars.iv.next106, %for.inc114 ], [ 0, %for.cond89.preheader ]
  %exitcond108.not = icmp eq i64 %indvars.iv105, 6
  br i1 %exitcond108.not, label %for.inc118.loopexit, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv111, i64 %indvars.iv105
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv105
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv114, i64 %indvars.iv105
...
for.inc118.loopexit:                              ; preds = %for.cond89
  br label %for.inc118

for.inc118:                                       ; preds = %for.inc118.loopexit, %for.body78
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.inc151 ], [ 1, %if.else ]
  %exitcond129.not = icmp eq i64 %indvars.iv120, %wide.trip.count128
  br i1 %exitcond129.not, label %for.end153.loopexit, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv120, i64 4
  %17 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %18 = add nsw i64 %indvars.iv120, -1
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars127.le = trunc i64 %indvars.iv120 to i32
  br label %for.end153

for.end153.loopexit:                              ; preds = %for.cond134
  br label %for.end153

for.end153:                                       ; preds = %for.end153.loopexit, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars127.le, %for.end153.split.loop.exit ], [ %3, %for.end153.loopexit ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count144 = zext i32 %sub155 to i64
  %wide.trip.count139 = zext i32 %z.1.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  %indvars.iv141 = phi i64 [ %indvars.iv.next142, %for.cond154.loopexit ], [ 0, %for.end153 ]
  %indvars.iv134 = phi i64 [ %indvars.iv.next135, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond145.not = icmp eq i64 %indvars.iv141, %wide.trip.count144
  br i1 %exitcond145.not, label %for.cond207.preheader, label %for.body157

for.cond207.preheader:                            ; preds = %for.cond154
  br label %for.cond207

for.body157:                                      ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv141, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv136 = phi i64 [ %indvars.iv.next137, %for.inc201 ], [ %indvars.iv134, %for.body157 ]
  %exitcond140.not = icmp eq i64 %indvars.iv136, %wide.trip.count139
  br i1 %exitcond140.not, label %for.cond154.loopexit, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv136, i64 5
  %20 = load i8, ptr %arrayidx164, align 1, !tbaa !9
  %21 = load i8, ptr %arrayidx168, align 1, !tbaa !9
  %cmp170 = icmp slt i8 %20, %21
  br i1 %cmp170, label %for.cond172.preheader, label %for.inc201

for.cond172.preheader:                            ; preds = %for.body161
  br label %for.cond172

for.cond172:                                      ; preds = %for.cond172.preheader, %for.inc197
  %indvars.iv130 = phi i64 [ %indvars.iv.next131, %for.inc197 ], [ 0, %for.cond172.preheader ]
  %exitcond133.not = icmp eq i64 %indvars.iv130, 6
  br i1 %exitcond133.not, label %for.inc201.loopexit, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv136, i64 %indvars.iv130
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv130
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv141, i64 %indvars.iv130
...
for.inc201.loopexit:                              ; preds = %for.cond172
  br label %for.inc201

for.inc201:                                       ; preds = %for.inc201.loopexit, %for.body161
  %indvars.iv.next137 = add nuw nsw i64 %indvars.iv136, 1
  br label %for.cond159, !llvm.loop !23

for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv149 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next150, %for.inc223 ]
  %exitcond153.not = icmp eq i64 %indvars.iv149, %wide.trip.count139
  br i1 %exitcond153.not, label %if.end226.loopexit, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv146 = phi i64 [ %indvars.iv.next147, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv146, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv149, i64 %indvars.iv146
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar79 = call i32 @putchar(i32 noundef %conv218) #10
...
if.end226.loopexit:                               ; preds = %for.cond207
  br label %if.end226

if.end226:                                        ; preds = %if.end226.loopexit, %if.then128
