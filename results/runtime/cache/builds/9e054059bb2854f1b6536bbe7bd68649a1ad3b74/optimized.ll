...
for.cond:                                         ; preds = %for.end, %entry
  %0 = phi i32 [ %1, %for.end ], [ %.pre, %entry ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.end ], [ 0, %entry ]
  %cmp = icmp sgt i32 %0, 0
  br i1 %cmp, label %for.cond1, label %for.end143
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [111 x [111 x i32]], ptr @A, i64 0, i64 %indvars.iv15, i64 %indvars.iv
...
for.end143:                                       ; preds = %for.cond
  %call144 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 0)
  %call145 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call144, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
