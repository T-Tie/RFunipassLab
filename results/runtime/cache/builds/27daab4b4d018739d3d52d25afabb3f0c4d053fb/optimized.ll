...
for.cond21.preheader:                             ; preds = %for.cond
  %wide.trip.count70 = and i64 %indvars.iv60, 4294967295
  br label %for.cond21
...
if.then71_after_outline.exitStub:
  ...
  %call1.i7 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %call.i6)
