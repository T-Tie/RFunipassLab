...
for.inc51:                                        ; preds = %if.then, %if.else47, %if.then44
  %.str.2.sink = phi ptr [ @.str.2, %if.else47 ], [ @.str.1, %if.then44 ], [ @.str, %if.then ]
  %call48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %.str.2.sink)
