...
tailrecurse:                                      ; preds = %for.cond.cleanup14, %entry
  %c1.tr = phi i32 [ %c1, %entry ], [ %add42, %for.cond.cleanup14 ]
  %c2.tr = phi i32 [ %c2, %entry ], [ %spec.select, %for.cond.cleanup14 ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.body
  %indvars.iv22 = phi i64 [ %1, %for.cond.preheader ], [ %3, %for.body ]
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i19)
...
for.cond12:                                       ; preds = %for.body15, %if.else
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body15 ], [ 0, %if.else ]
...
if.then:                                          ; preds = %entry
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call1, i8 noundef signext %call.i4)
  %call.i.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i)
  br label %return
