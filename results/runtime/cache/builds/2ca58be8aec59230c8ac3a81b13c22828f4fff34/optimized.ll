...
entry:
  ...
  %cmp24 = icmp eq i8 %1, %2
  br i1 %cmp18, label %for.cond, label %for.end75

for.cond:                                         ; preds = %entry, %if.end72
  %i.0 = phi i32 [ %inc.i13, %if.end72 ], [ 1, %entry ]
  br i1 %cmp24, label %for.cond43.preheader, label %if.end72

for.cond43.preheader:                             ; preds = %for.cond
  %invariant.gep = getelementptr inbounds nuw i8, ptr %a, i64 1
  %invariant.gep24 = getelementptr i8, ptr %a, i64 -1
  %3 = and i64 %call6, 2147483647
  %4 = zext nneg i32 %i.0 to i64
  %gep = getelementptr i8, ptr %invariant.gep, i64 %3
  %add49 = add nsw i32 %i.0, %conv9
  %invariant.gep1.i = getelementptr i8, ptr %a, i64 -2
  %5 = sext i32 %add49 to i64
  %gep25 = getelementptr i8, ptr %invariant.gep24, i64 %3
...
for.cond58.preheader:                             ; preds = %for.cond43.preheader
  %cmp59 = icmp slt i32 %conv9, 1
  call void @llvm.assume(i1 noundef %cmp59)
  br label %for.end75

for.cond.i:                                       ; preds = %for.inc.i, %for.cond43
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.i ], [ %5, %for.cond43 ]
  %cmp.not.i = icmp sgt i64 %indvars.iv.i, %3
  br i1 %cmp.not.i, label %_Z4leftPcii.exit, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond.i
  %gep.i = getelementptr i8, ptr %invariant.gep24, i64 %indvars.iv.i
  %6 = load i8, ptr %gep.i, align 1, !tbaa !5
  %gep2.i = getelementptr i8, ptr %invariant.gep1.i, i64 %indvars.iv.i
  store i8 %6, ptr %gep2.i, align 1, !tbaa !5
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1
  br label %for.cond.i, !llvm.loop !11

_Z4leftPcii.exit:                                 ; preds = %for.cond.i
  store i8 0, ptr %gep25, align 1, !tbaa !5
  br label %if.end54

if.end50:                                         ; preds = %for.cond43
  br i1 %s.0, label %for.cond.i5, label %if.end54

for.cond.i5:                                      ; preds = %for.inc.i8, %if.end50
  %indvars.iv.i6 = phi i64 [ %indvars.iv.next.i10, %for.inc.i8 ], [ %3, %if.end50 ]
  %cmp.not.i7 = icmp slt i64 %indvars.iv.i6, %4
  br i1 %cmp.not.i7, label %_Z5rightPcii.exit, label %for.inc.i8

for.inc.i8:                                       ; preds = %for.cond.i5
  %gep.i9 = getelementptr i8, ptr %invariant.gep24, i64 %indvars.iv.i6
  %7 = load i8, ptr %gep.i9, align 1, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i8, ptr %a, i64 %indvars.iv.i6
  store i8 %7, ptr %arrayidx2.i, align 1, !tbaa !5
  %indvars.iv.next.i10 = add nsw i64 %indvars.iv.i6, -1
  br label %for.cond.i5, !llvm.loop !8
