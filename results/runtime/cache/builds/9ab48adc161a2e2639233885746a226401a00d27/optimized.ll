...
for.cond:                                         ; preds = %for.inc31, %entry
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc31 ], [ 0, %entry ]
  %jn.0 = phi i32 [ %jn.1, %for.inc31 ], [ 0, %entry ]
  %6 = sext i32 %5 to i64
  %cmp = icmp slt i64 %indvars.iv20, %6
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv20
...
for.body13:                                       ; preds = %for.cond10
  ...
  %arrayidx17 = getelementptr i8, ptr %arrayidx15, i64 -4
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.body36
  %indvars.iv23 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next24, %for.body36 ]
...
for.cond.cleanup35:                               ; preds = %for.cond33
  ...
  %call45 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %13)
  call void @llvm.stackrestore.p0(ptr %2)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %n) #6
  ret i32 0

for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv23
