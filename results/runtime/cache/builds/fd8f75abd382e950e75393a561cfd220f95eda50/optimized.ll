...
for.end:                                          ; preds = %for.cond
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %wide.trip.count15 = zext nneg i32 %smax14 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond16.not = icmp eq i64 %indvars.iv10, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond29.preheader, label %for.cond7.preheader
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv7
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv17 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next18, %for.inc36 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv17
