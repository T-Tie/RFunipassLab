...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv59, %1
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count70 = zext i32 %narrow to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond, %for.inc
  %3 = phi i32 [ %.pre76, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv66 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next67, %for.inc27 ]
  %exitcond71 = icmp eq i64 %indvars.iv66, %wide.trip.count70
  br i1 %exitcond71, label %for.end29, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.inc21
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc21 ], [ 1, %for.cond10 ]
  %exitcond = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv66, i64 %indvars.iv62
...
for.end29.loopexit:                               ; preds = %for.body15
  %6 = trunc nuw nsw i64 %indvars.iv66 to i32
  %7 = trunc nuw nsw i64 %indvars.iv62 to i32
  %8 = xor i32 %7, -1
  br label %for.end29

for.end29:                                        ; preds = %for.cond10, %for.end29.loopexit
  %i.157 = phi i32 [ %6, %for.end29.loopexit ], [ %narrow, %for.cond10 ]
  %x1.1 = phi i32 [ %8, %for.end29.loopexit ], [ -1, %for.cond10 ]
  %9 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc48 ], [ %9, %for.end29 ]
  %10 = trunc nuw i64 %indvars.iv73 to i32
...
for.body35:                                       ; preds = %for.cond33
  ...
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv73, i64 %idxprom38
