...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %b, i8 noundef 0, i64 noundef 400, i1 noundef false) #6
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef align 16 %c) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %c, i8 noundef 0, i64 noundef 400, i1 noundef false) #6
...
for.cond18:                                       ; preds = %for.inc29, %for.body17
  ...
  %2 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %idxprom32
...
for.body20:                                       ; preds = %for.cond18
  ...
  %arrayidx24 = getelementptr inbounds [100 x i32], ptr %b, i64 0, i64 %idxprom32
  %cmp25 = icmp slt i32 %4, %3
...
for.inc47:                                        ; preds = %for.cond41
  ...
  %call46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %6) #7
...
for.end49:                                        ; preds = %for.cond41
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 400, ptr noundef %c) #7
