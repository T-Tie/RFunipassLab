...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  %indvars.iv34 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next35, %for.inc131 ]
  %indvars.iv11 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next12, %for.inc131 ]
  %total.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add130, %for.inc131 ]
  %exitcond39.not = icmp eq i64 %indvars.iv34, %wide.trip.count38
  br i1 %exitcond39.not, label %for.inc136, label %for.cond20

for.cond20:                                       ; preds = %for.cond15, %for.inc66
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc66 ], [ 0, %for.cond15 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond.not, label %for.cond70, label %for.body23

for.body23:                                       ; preds = %for.cond20
  %6 = add nuw nsw i64 %indvars.iv19, 4294967295
  %7 = and i64 %6, 4294967295
  %or.cond = icmp samesign ult i64 %7, %indvars.iv34
  br i1 %or.cond, label %for.inc66, label %if.end

if.end:                                           ; preds = %for.body23
  %arrayidx27 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19
  %8 = load i32, ptr %arrayidx27, align 16, !tbaa !5, !invariant.load !13
  br label %for.cond30

for.cond30:                                       ; preds = %for.body33, %if.end
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body33 ], [ %indvars.iv11, %if.end ]
  %minValue.0 = phi i32 [ %spec.select, %for.body33 ], [ %8, %if.end ]
  %9 = icmp slt i64 %indvars.iv13, %2
  br i1 %9, label %for.body33, label %for.end47

for.body33:                                       ; preds = %for.cond30
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv13
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc63 ], [ %indvars.iv11, %for.end47 ]
  %11 = icmp slt i64 %indvars.iv16, %2
  br i1 %11, label %for.inc63, label %for.inc66

for.inc63:                                        ; preds = %for.cond54
  %arrayidx61 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv16
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc121 ], [ 0, %for.cond20 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond33.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw nsw i64 %indvars.iv29, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond5 = icmp samesign ult i64 %14, %indvars.iv34
  br i1 %or.cond5, label %for.inc121, label %if.end78

if.end78:                                         ; preds = %for.body73
  %arrayidx82 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv29
  %15 = load i32, ptr %arrayidx82, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond85

for.cond85:                                       ; preds = %for.body88, %if.end78
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body88 ], [ %indvars.iv11, %if.end78 ]
  %minValue79.0 = phi i32 [ %spec.select6, %for.body88 ], [ %15, %if.end78 ]
  %16 = icmp slt i64 %indvars.iv23, %2
  br i1 %16, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %arrayidx92 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv23, i64 %indvars.iv29
  %17 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
  %spec.select6 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc118 ], [ %indvars.iv11, %for.end102 ]
  %18 = icmp slt i64 %indvars.iv26, %2
  br i1 %18, label %for.inc118, label %for.inc121

for.inc118:                                       ; preds = %for.cond109
  %arrayidx116 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv29
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %arrayidx129 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next35, i64 %indvars.iv.next35
...
for.inc136:                                       ; preds = %for.cond15
  ...
  %vtable.i = load ptr, ptr %call134, align 8, !tbaa !21, !invariant.load !13
