...
for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv11 = phi i32 [ %indvars.iv.next12, %for.inc ], [ 1, %entry ]
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.body
  %indvars.iv8 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next9, %for.body ]
...
for.body:                                         ; preds = %for.cond4
  %arrayidx7 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv8
...
for.cond23:                                       ; preds = %for.inc58, %if.end22
  %indvars.iv23 = phi i32 [ %indvars.iv.next24, %for.inc58 ], [ 97, %if.end22 ]
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc58 ], [ 0, %if.end22 ]
  %exitcond22.not = icmp eq i64 %indvars.iv19, 26
  br i1 %exitcond22.not, label %for.end60, label %for.cond35

for.cond35:                                       ; preds = %for.cond23, %for.body37
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body37 ], [ 0, %for.cond23 ]
  %n.0 = phi i32 [ %spec.select, %for.body37 ], [ 0, %for.cond23 ]
  %exitcond18 = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond18, label %for.end50, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [301 x i8], ptr %a, i64 0, i64 %indvars.iv13
  %3 = load i8, ptr %arrayidx39, align 1, !tbaa !5, !invariant.load !11
  %4 = zext i8 %3 to i32
  %cmp44 = icmp eq i32 %indvars.iv23, %4
...
for.end50:                                        ; preds = %for.cond35
  %indvars.iv.next24 = add nuw nsw i32 %indvars.iv23, 1
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  %cmp51.not = icmp eq i32 %n.0, 0
  br i1 %cmp51.not, label %for.inc58, label %if.then52

if.then52:                                        ; preds = %for.end50
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %indvars.iv23, i32 noundef %n.0)
  br label %for.inc58
