...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv21, i32 1
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv25 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next26, %for.inc40 ]
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %4 = trunc nuw i64 %indvars.iv.next26 to i32
  %cmp14 = icmp sgt i32 %0, %4
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %5 = load i32, ptr %arrayidx17, align 8, !tbaa !15
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next26
...
for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc77
  %indvars.iv28 = phi i64 [ 0, %for.cond45.preheader ], [ %indvars.iv.next29, %for.inc77 ]
  %exitcond36.not = icmp eq i64 %indvars.iv28, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end79, label %for.cond50.preheader

for.cond50.preheader:                             ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv28, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.cond50.preheader, %for.inc74
  %indvars.iv30 = phi i64 [ %indvars.iv28, %for.cond50.preheader ], [ %indvars.iv.next31, %for.inc74 ]
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %9 = trunc nuw i64 %indvars.iv.next31 to i32
  %cmp51 = icmp sgt i32 %0, %9
  br i1 %cmp51, label %for.body52, label %for.inc77

for.body52:                                       ; preds = %for.cond50
  %10 = load i32, ptr %h55, align 4, !tbaa !12
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next31, i32 1
