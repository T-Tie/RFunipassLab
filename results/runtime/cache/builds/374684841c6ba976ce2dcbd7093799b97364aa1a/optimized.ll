...
for.cond1:                                        ; preds = %for.cond, %for.inc
  ...
  %.sink2 = phi i32 [ %dec, %for.inc ], [ 30, %for.cond ]
...
for.end19:                                        ; preds = %for.cond10, %for.end19.split.loop.exit10
  %.sink.lcssa = phi i32 [ %4, %for.end19.split.loop.exit10 ], [ 31, %for.cond10 ]
  %5 = zext nneg i32 %.sink.lcssa to i64
  %6 = sext i32 %.sink.lcssa to i64
  br label %for.cond20
...
for.end30:                                        ; preds = %for.cond20
  %sub31 = sub nsw i32 31, %.sink.lcssa
