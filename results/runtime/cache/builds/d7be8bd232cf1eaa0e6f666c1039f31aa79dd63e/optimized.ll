...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %xu1) #7
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %xu2) #7
  br label %for.cond
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %1
  %call5 = call double @sqrt(double noundef %4) #7, !tbaa !5
  %add = fadd double %fneg, %call5
  %mul = fmul double 2.000000e+00, %2
  %div = fdiv double %add, %mul
  %call7 = call double @sqrt(double noundef %4) #7, !tbaa !5
...
if.then11:                                        ; preds = %if.then
  %call12 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %div, double noundef %div9)
  br label %if.end
...
if.then14:                                        ; preds = %if.end
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %div9)
  br label %if.end17
...
if.end49:                                         ; preds = %if.end17
  ...
  %call24 = call double @sqrt(double noundef %fneg23) #7, !tbaa !5
  %div26 = fdiv double %call24, %mul21
  store double %div26, ptr %xu1, align 8, !tbaa !9
  %call28 = call double @sqrt(double noundef %fneg23) #7, !tbaa !5
  %fneg29 = fneg double %call28
  %div31 = fdiv double %fneg29, %mul21
  store double %div31, ptr %xu2, align 8, !tbaa !9
  %call32 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div22)
  call fastcc void @outlined_ir_func_0(ptr %xu1, ptr @.str.6)
  %call41 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, double noundef %div22)
  call fastcc void @outlined_ir_func_0(ptr %xu2, ptr @.str.8)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %xu2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %xu1) #7
...
if.then19_to_outline:
  ...
  %cmp33 = fcmp ogt double %2, 0.000000e+00
  br i1 %cmp33, label %if.then34, label %if.end36

if.then34:                                        ; preds = %if.then19_to_outline
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %2)
  %.pr = load double, ptr %0, align 8, !tbaa !9
  br label %if.end36

if.end36:                                         ; preds = %if.then34, %if.then19_to_outline
  %3 = phi double [ %.pr, %if.then34 ], [ %2, %if.then19_to_outline ]
  %cmp37 = fcmp olt double %3, 0.000000e+00
  br i1 %cmp37, label %if.then38, label %if.end40.exitStub

if.then38:                                        ; preds = %if.end36
  %call39 = call i32 (ptr, ...) @printf(ptr noundef %1, double noundef %3)
