...
for.end21:                                        ; preds = %for.cond11
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %t.0) #7
  %4 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i = call i32 @getc(ptr noundef %4) #7
  %5 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i1 = call i32 @getc(ptr noundef %5) #7
  %6 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i2 = call i32 @getc(ptr noundef %6) #7
