...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %b) #7
...
for.inc25:                                        ; preds = %if.else, %for.body5, %if.else21
  ...
  %call22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %.str.2.sink)
