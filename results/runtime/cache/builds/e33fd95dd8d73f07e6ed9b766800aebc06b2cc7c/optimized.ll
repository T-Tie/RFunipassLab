...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv87, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv87, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv93, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv90, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv93, i64 %indvars.iv90
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax99 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax104 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax105 = call i32 @llvm.smax.i32(i32 %smax104, i32 noundef 0)
  %wide.trip.count106 = zext nneg i32 %smax105 to i64
  %wide.trip.count = zext nneg i32 %smax99 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv100 = phi i64 [ %indvars.iv.next101, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond107.not = icmp eq i64 %indvars.iv100, %wide.trip.count106
  br i1 %exitcond107.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax111 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count112 = zext nneg i32 %smax111 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv100, i64 %indvars.iv96
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv121 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next122, %for.inc83 ]
  %exitcond125.not = icmp eq i64 %indvars.iv121, %wide.trip.count106
  br i1 %exitcond125.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond120.not = icmp eq i64 %indvars.iv114, %wide.trip.count
  br i1 %exitcond120.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv121, i64 %indvars.iv114
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv108 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next109, %for.inc77 ]
  %exitcond113.not = icmp eq i64 %indvars.iv108, %wide.trip.count112
  br i1 %exitcond113.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv121, i64 %indvars.iv108
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv108, i64 %indvars.iv114
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond130.not = icmp eq i64 %indvars.iv126, %wide.trip.count106
  br i1 %exitcond130.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv126
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next127 = add nuw nsw i64 %indvars.iv126, 1
  br label %for.cond86, !llvm.loop !21

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax104 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv138 = phi i64 [ %indvars.iv.next139, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond142.not = icmp eq i64 %indvars.iv138, %wide.trip.count106
  br i1 %exitcond142.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv138
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax104, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax104, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv131 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next132, %for.inc112 ]
  %exitcond137.not = icmp eq i64 %indvars.iv131, %wide.trip.count
  br i1 %exitcond137.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv138, i64 %indvars.iv131
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv155 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre.pre-phi, %for.inc198 ]
  %exitcond162.not = icmp eq i64 %indvars.iv155, %wide.trip.count106
  br i1 %exitcond162.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv155
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv155, 0
  %or.cond82 = and i1 %or.cond, %cmp128
  br i1 %or.cond82, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv155
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax146 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count147 = zext nneg i32 %smax146 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv143 = phi i64 [ %indvars.iv.next144, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond148.not = icmp eq i64 %indvars.iv143, %wide.trip.count147
  br i1 %exitcond148.not, label %if.end178.loopexit166, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv155, i64 %indvars.iv143
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax152 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count153 = zext nneg i32 %smax152 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv149 = phi i64 [ %indvars.iv.next150, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond154.not = icmp eq i64 %indvars.iv149, %wide.trip.count153
  br i1 %exitcond154.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv155, i64 %indvars.iv149
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv155, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar83 = call i32 @putchar(i32 noundef 10) #6
  br label %for.inc198
