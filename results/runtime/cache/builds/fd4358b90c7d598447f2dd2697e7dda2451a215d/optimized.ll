...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax15 = tail call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  ...
  %exitcond16.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond16.not, label %cleanup, label %for.inc16
