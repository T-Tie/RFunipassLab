...
if.then:                                          ; preds = %for.body
  ...
  %call6 = call i64 @strlen(ptr noundef %s) #12
  %conv = trunc i64 %call6 to i32
  br label %if.end29

if.else:                                          ; preds = %for.body
  %conv7 = sext i32 %count.0 to i64
  %call9 = call i64 @strlen(ptr noundef %s) #12
...
if.then12:                                        ; preds = %if.else
  ...
  %call17 = call i64 @strlen(ptr noundef %s) #12
...
if.else22:                                        ; preds = %if.else
  ...
  %call27 = call i64 @strlen(ptr noundef %s) #12
  br label %if.end
...
if.end29:                                         ; preds = %if.end, %if.then
  %count.1 = phi i32 [ %conv, %if.then ], [ %conv28, %if.end ]
