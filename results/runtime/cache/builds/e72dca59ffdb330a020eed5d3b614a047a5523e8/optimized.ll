...
while.body:                                       ; preds = %while.cond
  ...
  %call16.i16 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i15) #12
...
land.lhs.true.i17:                                ; preds = %while.body
  %_M_width.i4.i18 = getelementptr inbounds nuw i8, ptr %add.ptr10.i15, i64 16
  %3 = load i64, ptr %_M_width.i4.i18, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -42
  %or.cond.i21 = icmp ult i64 %4, -41
...
if.then19.i22:                                    ; preds = %land.lhs.true.i17
  %call24.i23 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i15) #12
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit30: ; preds = %while.body, %land.lhs.true.i17, %if.then19.i22, %if.then28.i29
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %word) #12
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull captures(none) %initial) #12
