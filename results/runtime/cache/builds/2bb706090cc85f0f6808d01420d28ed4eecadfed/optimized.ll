...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 140000, ptr noundef align 16 %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 140000, ptr noundef align 16 %b) #7
...
for.cond2:                                        ; preds = %for.body4, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc11, %for.body4 ]
...
for.cond13:                                       ; preds = %for.body15, %for.end12
  %i.2 = phi i32 [ 0, %for.end12 ], [ %inc21, %for.body15 ]
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %cmp14 = icmp slt i32 %i.2, %3
...
for.body15:                                       ; preds = %for.cond13
  ...
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %4)
...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef %b) #9
  call void @llvm.lifetime.end.p0(i64 noundef 140000, ptr noundef %a) #9
...
for.cond:                                         ; preds = %if.end, %if.else3
  %sum.0 = phi i32 [ 1, %if.else3 ], [ %sum.1, %if.end ]
  %i.0 = phi i32 [ %m, %if.else3 ], [ %inc, %if.end ]
...
if.then6:                                         ; preds = %for.body
  %div = sdiv i32 %n, %i.0
  %call = call noundef i32 @_Z4factii(i32 noundef %div, i32 noundef %i.0) #10
