...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %r1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %c1) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %r2) #6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %c2) #6
...
for.cond29:                                       ; preds = %for.inc46, %for.end28
  ...
  %8 = phi i32 [ %dec47, %for.inc46 ], [ %sub, %for.end28 ]
  store i32 %sub.sink, ptr %i, align 4, !tbaa !5
  %cmp30 = icmp sge i32 %8, 0
...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %sub.sink1 = phi i32 [ %sub, %for.body31 ], [ %dec, %for.inc44 ]
  %9 = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.body31 ]
  store i32 %sub.sink1, ptr %j, align 4, !tbaa !5
  %cmp34 = icmp sge i32 %9, 0
  br i1 %cmp34, label %for.body35, label %for.inc46

for.body35:                                       ; preds = %for.cond33
  %10 = load i32, ptr %i, align 4, !tbaa !5
  %mul36 = mul nsw i32 %10, 500
  ...
  %12 = load i32, ptr %add.ptr40, align 4, !tbaa !5, !invariant.load !15
  %cmp41 = icmp eq i32 %12, 0
  br i1 %cmp41, label %if.then42, label %for.inc44

if.then42:                                        ; preds = %for.body35
  store i32 %10, ptr %r2, align 4, !tbaa !5
  store i32 %11, ptr %c2, align 4, !tbaa !5
...
for.inc46:                                        ; preds = %for.cond33, %if.then42
  ...
  %dec47 = add nsw i32 %13, -1
  br label %for.cond29, !llvm.loop !17

for.end48:                                        ; preds = %for.cond29
  %14 = load i32, ptr %r2, align 4, !tbaa !5
  %15 = load i32, ptr %r1, align 4, !tbaa !5
  %sub49 = sub nsw i32 %14, %15
  %sub50 = sub nsw i32 %sub49, 1
  %16 = load i32, ptr %c2, align 4, !tbaa !5
  %17 = load i32, ptr %c1, align 4, !tbaa !5
  %sub51 = sub nsw i32 %16, %17
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %c2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %r2) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %c1) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %r1) #7
