...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 140000, ptr noundef nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 noundef 140000, ptr noundef nonnull %b) #6
...
if.then6:                                         ; preds = %for.body
  %div = sdiv i32 %n, %i.0
  %call = tail call noundef i32 @_Z4factii(i32 noundef %div, i32 noundef %i.0) #8
