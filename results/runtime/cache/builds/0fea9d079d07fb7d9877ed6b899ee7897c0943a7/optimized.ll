...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 captures(none) dereferenceable(100) %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef nonnull align 16 %b) #7
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  %indvars.iv15 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next16, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond2
  %2 = trunc nuw nsw i64 %indvars.iv15 to i32
  %call5 = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %2, i32 noundef %0)
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv15
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv19
...
for.end21:                                        ; preds = %for.cond11
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %t.0) #8
  %4 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i = call i32 @getc(ptr noundef %4) #8
  %5 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i1 = call i32 @getc(ptr noundef %5) #8
  %6 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i2 = call i32 @getc(ptr noundef %6) #8
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef nonnull %b) #8
...
define dso_local noundef range(i32 -2147483647, -2147483648) i32 @_Z2ljPiii(ptr nofree noundef readonly captures(none) %a, i32 noundef %n, i32 noundef %m) #3 {
entry:
  %b = alloca [25 x i32], align 16
...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc13 ], [ %0, %for.end ]
  %cmp3 = icmp slt i64 %indvars.iv23, %1
  br i1 %cmp3, label %for.body4, label %for.end15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx6, align 4, !tbaa !5, !invariant.load !18
  %3 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !18
  %cmp9.not = icmp sgt i32 %2, %3
  br i1 %cmp9.not, label %for.inc13, label %if.then10

if.then10:                                        ; preds = %for.body4
  %4 = trunc nsw i64 %indvars.iv23 to i32
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %4, i32 noundef %m)
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv23
...
for.end15:                                        ; preds = %for.cond2
  %arrayidx18 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %0
  %5 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.end15
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body22 ], [ %0, %for.end15 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ %5, %for.end15 ]
  %cmp21 = icmp slt i64 %indvars.iv26, %1
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv26
  %6 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %spec.select = tail call i32 @llvm.smax.i32(i32 %t.0, i32 %6)
...
entry:
  ...
  %call = tail call i32 @getc(ptr noundef %0) #8
  ret i32 %call
}
...
; Function Attrs: nofree nounwind
declare noundef i32 @getc(ptr noundef captures(none)) #4
