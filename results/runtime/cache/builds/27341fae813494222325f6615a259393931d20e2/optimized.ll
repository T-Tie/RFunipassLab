...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_good) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_all) #10
...
declare noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERf(ptr noundef nonnull align 8 dereferenceable(16), ptr noundef nonnull align 4 dereferenceable(4)) #3 align 2
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !26, !invariant.load !22
  ret i64 %0
}
