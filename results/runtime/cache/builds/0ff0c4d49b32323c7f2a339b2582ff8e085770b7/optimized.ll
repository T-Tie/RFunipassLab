; ModuleID = '<stdin>'
source_filename = "/tmp/tmpi9ynetr0.cpp"
...
for.cond1:                                        ; preds = %for.cond, %for.inc29
  %i.0 = phi i32 [ %inc30, %for.inc29 ], [ 0, %for.cond ]
...
for.body4:                                        ; preds = %for.cond1
  %call5 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %x)
  %1 = load i32, ptr %x, align 4, !tbaa !5
  %2 = zext i32 %1 to i64
  %arrayidx12 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %2
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc15, %for.body4
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc15 ], [ 10, %for.body4 ]
  %exitcond13.not = icmp eq i64 %indvars.iv10, 100
  br i1 %exitcond13.not, label %for.cond.cleanup8, label %for.body9
...
for.cond.cleanup8:                                ; preds = %for.cond6
  ...
  br i1 %cmp20, label %if.then21, label %for.inc29

for.body9:                                        ; preds = %for.cond6
  %cmp10 = icmp eq i64 %indvars.iv10, %2
...
if.then21:                                        ; preds = %for.cond.cleanup8
  %cmp22.not = icmp eq i32 %i.0, 0
  br i1 %cmp22.not, label %for.inc29.sink.split, label %if.then23
...
if.then23:                                        ; preds = %if.then21
  ...
  br label %for.inc29.sink.split

for.inc29.sink.split:                             ; preds = %if.then21, %if.then23
  %.sink = phi i32 [ %5, %if.then23 ], [ %1, %if.then21 ]
  %call26 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %.sink)
  br label %for.inc29

for.inc29:                                        ; preds = %for.inc29.sink.split, %for.cond.cleanup8
