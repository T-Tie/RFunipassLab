...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  %.pre64 = phi i32 [ %.pre, %for.inc47 ], [ %0, %for.cond2 ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc47 ], [ 0, %for.cond2 ]
  %s.0 = phi i32 [ %add46, %for.inc47 ], [ 0, %for.cond2 ]
  %8 = sext i32 %.pre64 to i64
  %cmp18 = icmp slt i64 %indvars.iv53, %8
...
if.then33:                                        ; preds = %land.lhs.true, %if.end
  ...
  %11 = load i64, ptr %gep47, align 8, !tbaa !12
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread61
  ...
  %call.i.i2 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx26) #9
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre64, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
