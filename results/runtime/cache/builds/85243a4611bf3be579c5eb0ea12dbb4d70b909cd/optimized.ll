...
if.then:                                          ; preds = %for.body
  ...
  %call18 = call double @sqrt(double noundef %9) #8, !tbaa !5
...
if.then42:                                        ; preds = %if.then40
  ...
  %call56 = call double @sqrt(double noundef %22) #8, !tbaa !5
...
if.else:                                          ; preds = %if.then40
  ...
  %mul66 = fmul double %14, %14
  %neg67 = fneg double %mul66
  %23 = call double @llvm.fmuladd.f64(double %mul36, double %16, double %neg67)
  %call68 = call double @sqrt(double noundef %23) #8, !tbaa !5
  ...
  %mul74 = fmul double 2.000000e+00, %25
  %div75 = fdiv double %fneg73, %mul74
  %mul76 = fmul double 4.000000e+00, %25
  %26 = load double, ptr %c, align 8, !tbaa !9
  %mul78 = fmul double %24, %24
