...
for.cond1:                                        ; preds = %for.body3, %for.end
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.body3 ], [ 0, %for.end ]
  %0 = load i32, ptr %k, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp2 = icmp slt i64 %indvars.iv17, %1
  br i1 %cmp2, label %for.body3, label %for.end9

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv17
...
for.cond13:                                       ; preds = %for.end37, %for.end9
  %j.0 = phi i32 [ %sub12, %for.end9 ], [ %dec, %for.end37 ]
...
for.cond16:                                       ; preds = %for.cond16.preheader, %if.end
  %indvars.iv20 = phi i64 [ %2, %for.cond16.preheader ], [ %indvars.iv.next21, %if.end ]
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %3 = trunc nuw i64 %indvars.iv.next21 to i32
  %cmp17 = icmp sgt i32 %0, %3
  br i1 %cmp17, label %for.body18, label %for.end37

for.body18:                                       ; preds = %for.cond16
  %arrayidx20 = getelementptr inbounds nuw [25 x i32], ptr %a, i64 0, i64 %indvars.iv.next21
  ...
  br i1 %cmp23.not, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %for.body18
  %6 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !13
  %arrayidx27 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next21
...
if.end:                                           ; preds = %land.lhs.true, %for.body18
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.body42
  %indvars.iv23 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next24, %for.body42 ]
  %max.0 = phi i32 [ 0, %for.cond40.preheader ], [ %spec.select, %for.body42 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond27.not, label %for.end52, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %arrayidx44 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv23
