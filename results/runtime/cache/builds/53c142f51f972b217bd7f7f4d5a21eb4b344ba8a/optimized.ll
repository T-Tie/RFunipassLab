...
for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond.cleanup3 ], [ 0, %entry ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count12
  br i1 %exitcond13.not, label %for.end9, label %for.cond1
...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax84 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax60 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count45 = zext nneg i32 %smax60 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.cond.cleanup18
  %indvars.iv42 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next43, %for.cond.cleanup18 ]
  %exitcond46.not = icmp eq i64 %indvars.iv42, %wide.trip.count45
  br i1 %exitcond46.not, label %for.cond31, label %for.cond2
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv42, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.body19
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.body19 ], [ 0, %for.cond16.preheader ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond41.not, label %for.cond.cleanup18, label %for.body19
...
for.body19:                                       ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv42, i64 %indvars.iv37
...
for.cond31:                                       ; preds = %for.cond, %for.cond.cleanup57
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.cond.cleanup57 ], [ 0, %for.cond ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count45
  br i1 %exitcond62.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select35, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond51.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv47, i64 %indvars.iv57
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !14
  %spec.select35 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  br label %for.cond36, !llvm.loop !18

for.cond55:                                       ; preds = %for.cond55.preheader, %for.body58
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.body58 ], [ 0, %for.cond55.preheader ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
  br i1 %exitcond56.not, label %for.cond.cleanup57, label %for.body58
...
for.body58:                                       ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv52, i64 %indvars.iv57
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count73 = zext nneg i32 %smax84 to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.cond.cleanup78, %for.end69
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.cond.cleanup78 ], [ 2, %for.end69 ]
  %exitcond74.not = icmp eq i64 %indvars.iv68, %wide.trip.count73
  br i1 %exitcond74.not, label %for.cond96, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond71
  %5 = add nsw i64 %indvars.iv68, -1
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.body79
  %indvars.iv63 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next64, %for.body79 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond67.not, label %for.cond.cleanup78, label %for.body79
...
for.body79:                                       ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv68, i64 %indvars.iv63
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !14
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv63
  store i32 %6, ptr %arrayidx88, align 4, !tbaa !5
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  br label %for.cond76, !llvm.loop !22

for.cond96:                                       ; preds = %for.cond71, %for.cond.cleanup103
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.cond.cleanup103 ], [ 2, %for.cond71 ]
  %exitcond86.not = icmp eq i64 %indvars.iv80, %wide.trip.count73
  br i1 %exitcond86.not, label %for.end119, label %for.cond101.preheader

for.cond101.preheader:                            ; preds = %for.cond96
  %7 = add nsw i64 %indvars.iv80, -1
  br label %for.cond101

for.cond101:                                      ; preds = %for.cond101.preheader, %for.body104
  %indvars.iv75 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next76, %for.body104 ]
  %exitcond79.not = icmp eq i64 %indvars.iv75, %wide.trip.count
  br i1 %exitcond79.not, label %for.cond.cleanup103, label %for.body104
...
for.body104:                                      ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv75, i64 %indvars.iv80
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5, !invariant.load !14
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv75, i64 %7
