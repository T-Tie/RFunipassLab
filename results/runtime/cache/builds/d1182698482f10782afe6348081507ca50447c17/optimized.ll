...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %efficient) #10
  br label %for.cond
...
if.end19:                                         ; preds = %if.then6, %if.end
  br label %if.end20

if.end20:                                         ; preds = %if.end19, %if.then
  %sample.1 = phi double [ %div, %if.then ], [ %sample.0, %if.end19 ]
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 8, ptr %efficient) #10
...
newFuncRoot:
  br label %if.then6_to_outline

if.then6_to_outline:                              ; preds = %newFuncRoot
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
  ...
  br label %if.end19.exitStub

if.end19.exitStub:                                ; preds = %if.then6_to_outline
  ret void
}
