...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 100, ptr noundef align 16 %b) #4
  br label %for.cond
...
for.cond1:                                        ; preds = %for.inc7, %for.end
  %i.0 = phi i32 [ 0, %for.end ], [ %inc8, %for.inc7 ]
...
for.cond16:                                       ; preds = %for.inc35, %for.body15
  %j.0.sink = phi i32 [ %j.0, %for.body15 ], [ %add, %for.inc35 ]
...
for.body18:                                       ; preds = %for.cond16
  ...
  %1 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !13
  %idxprom21 = sext i32 %j.0 to i64
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %a, i64 0, i64 %idxprom21
  %2 = load i32, ptr %arrayidx22, align 4, !tbaa !5, !invariant.load !13
  %cmp23 = icmp sle i32 %1, %2
...
land.lhs.true:                                    ; preds = %for.body18
  ...
  %4 = load i32, ptr %arrayidx27, align 4, !tbaa !5, !invariant.load !13
  %add28 = add nsw i32 %4, 1
  %cmp29 = icmp slt i32 %3, %add28
  br i1 %cmp29, label %if.then, label %for.inc35

if.then:                                          ; preds = %land.lhs.true
  %5 = load i32, ptr %arrayidx27, align 4, !tbaa !5
  %add32 = add nsw i32 %5, 1
  store i32 %add32, ptr %arrayidx25, align 4, !tbaa !5
  br label %for.inc35
...
for.cond40:                                       ; preds = %for.inc50, %for.end39
  %q.0 = phi i32 [ 0, %for.end39 ], [ %inc51, %for.inc50 ]
  %max.0 = phi i32 [ 0, %for.end39 ], [ %max.1, %for.inc50 ]
  %cmp41 = icmp slt i32 %q.0, %0
...
for.body42:                                       ; preds = %for.cond40
  ...
  %6 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !13
  %cmp45 = icmp sgt i32 %6, %max.0
...
for.inc50:                                        ; preds = %for.body42, %if.then46
  %max.1 = phi i32 [ %6, %if.then46 ], [ %max.0, %for.body42 ]
  %inc51 = add nsw i32 %q.0, 1
  br label %for.cond40, !llvm.loop !16

for.end52:                                        ; preds = %for.cond40
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %max.0) #5
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 100, ptr noundef %a) #5
