...
entry:
  ...
  %0 = load i32, ptr getelementptr inbounds nuw (i8, ptr @arr, i64 404), align 4
  %1 = add i32 %n, -1
  %2 = mul i32 %0, %1
  %call1 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %2)
...
tailrecurse:                                      ; preds = %for.cond, %entry
  %n.tr = phi i32 [ %n, %entry ], [ %sub120, %for.cond ]
...
for.body4.preheader:                              ; preds = %for.cond
  %0 = load i32, ptr @arr, align 16, !tbaa !5, !invariant.load !12
  br label %for.body4
...
attributes #4 = { mustprogress nofree norecurse nosync nounwind memory(read, argmem: none, inaccessiblemem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
