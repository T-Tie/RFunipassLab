...
for.cond15:                                       ; preds = %for.inc191, %for.end14
  ...
  %3 = phi i32 [ %dec, %for.inc191 ], [ %1, %for.end14 ]
...
for.cond23:                                       ; preds = %for.inc41, %for.body22
  ...
  %4 = phi i32 [ %inc42, %for.inc41 ], [ 0, %for.body22 ]
  %cmp24 = icmp slt i32 %4, %3
...
if.else:                                          ; preds = %for.body26
  ...
  %6 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !13
  %cmp36 = icmp sgt i32 %min.3, %6
  br i1 %cmp36, label %for.inc41, label %cond.false

cond.false:                                       ; preds = %if.else
  br label %for.inc41

for.inc41:                                        ; preds = %cond.false, %if.else, %if.then
  %min.4 = phi i32 [ %5, %if.then ], [ %min.3, %cond.false ], [ %6, %if.else ]
...
for.inc53:                                        ; preds = %for.cond45
  ...
  %7 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !13
  %sub = sub nsw i32 %7, %min.3
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  ...
  %8 = phi i32 [ %inc91, %for.inc90 ], [ 0, %for.body63 ]
  %cmp66 = icmp slt i32 %8, %3
  br i1 %cmp66, label %for.body68, label %for.end92

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i32 %8, 0
...
if.then70:                                        ; preds = %for.body68
  ...
  %9 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !13
  br label %for.inc90

if.else75:                                        ; preds = %for.body68
  %idxprom76 = sext i32 %8 to i64
  %arrayidx77 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom76
  %idxprom78 = sext i32 %k59.0 to i64
  %arrayidx79 = getelementptr inbounds [100 x i32], ptr %arrayidx77, i64 0, i64 %idxprom78
  %10 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !13
  %cmp80 = icmp sgt i32 %min.6, %10
  br i1 %cmp80, label %for.inc90, label %cond.false86

cond.false86:                                     ; preds = %if.else75
  br label %for.inc90

for.inc90:                                        ; preds = %cond.false86, %if.else75, %if.then70
  %min.7 = phi i32 [ %9, %if.then70 ], [ %min.6, %cond.false86 ], [ %10, %if.else75 ]
...
for.inc103:                                       ; preds = %for.cond94
  ...
  %11 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !13
  %sub102 = sub nsw i32 %11, %min.6
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %13 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %13, ptr %arrayidx128, align 4, !tbaa !5
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %14 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
  ...
  store i32 %14, ptr %arrayidx145, align 16, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %16 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %16, ptr %arrayidx184, align 4, !tbaa !5
