...
if.then:                                          ; preds = %for.body
  ...
  %sub35 = fsub double %fneg47, %call25
...
if.else:                                          ; preds = %for.body
  ...
  %call57 = call double @sqrt(double noundef %7) #11, !tbaa !5
...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc132 ], [ 0, %for.cond ]
  %11 = sext i32 %10 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv11, %11
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv11
  ...
  %20 = load double, ptr %19, align 16, !tbaa !9
...
if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %18, double noundef %20) #12
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %18) #12
  br label %for.inc132

if.else117:                                       ; preds = %for.body77
  %arrayidx129 = getelementptr inbounds nuw i8, ptr %arrayidx79, i64 40
  %21 = load double, ptr %arrayidx129, align 8, !tbaa !9
  %call130 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %18, double noundef %20, double noundef %18, double noundef %21) #12
  br label %for.inc132
