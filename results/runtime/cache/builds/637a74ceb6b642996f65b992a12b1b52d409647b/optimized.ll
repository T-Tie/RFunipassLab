...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %b) #5
...
if.then19:                                        ; preds = %for.end17
  ...
  %9 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
...
for.end38:                                        ; preds = %for.cond29
  ...
  %13 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !12
  %call42 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %13)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %b) #6
