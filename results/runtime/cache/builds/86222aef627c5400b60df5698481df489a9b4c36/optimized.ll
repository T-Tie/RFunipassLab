...
if.then8:                                         ; preds = %if.end
  ...
  %call13.i4 = tail call double @sqrt(double noundef %6) #8, !tbaa !5, !noalias !14
  %sub = fsub double %fneg9, %call13.i4
...
if.then39:                                        ; preds = %if.end37
  ...
  %call50.i7 = tail call double @sqrt(double noundef %26) #8, !tbaa !5, !noalias !20
