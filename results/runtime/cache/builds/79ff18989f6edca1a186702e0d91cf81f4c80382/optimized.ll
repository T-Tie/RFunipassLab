...
for.cond10.preheader:                             ; preds = %for.cond
  %smax18 = call i32 @llvm.smax.i32(i32 %1, i32 0)
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [50 x [50 x i32]], ptr %k, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc25
  %indvars.iv14 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next15, %for.inc25 ]
  %sum.0 = phi i32 [ 0, %for.cond10.preheader ], [ %sum.1, %for.inc25 ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end27, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body15 ], [ 0, %for.cond10 ]
  %sum.1 = phi i32 [ %spec.select, %for.body15 ], [ %sum.0, %for.cond10 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc25, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [50 x [50 x i32]], ptr %k, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
