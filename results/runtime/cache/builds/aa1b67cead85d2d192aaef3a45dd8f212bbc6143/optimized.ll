...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc67 ], [ 0, %for.cond ]
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc64 ], [ 0, %for.cond55.preheader ]
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  ...
  br i1 %exitcond41.not, label %for.cond96, label %for.cond76.preheader
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc117 ], [ 2, %for.cond71 ]
