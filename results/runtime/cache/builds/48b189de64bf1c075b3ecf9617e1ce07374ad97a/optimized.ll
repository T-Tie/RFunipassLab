...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %add.ptr, i1 noundef false, i1 noundef true, i1 noundef false) #11
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc16 ], [ 1, %for.end ]
  %exitcond10 = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond10, label %for.end18, label %for.inc16
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef nonnull %a) #12
  ret i32 0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !24, !invariant.load !5
