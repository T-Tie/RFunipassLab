...
for.cond47.preheader:                             ; preds = %for.cond16
  ...
  %smax45 = call i32 @llvm.smax.i32(i32 %m.0, i32 0)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv31 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next32, %for.inc41 ]
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv41 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next42, %for.inc58 ]
