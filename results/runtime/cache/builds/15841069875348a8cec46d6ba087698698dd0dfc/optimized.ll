...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv11 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next12, %for.inc24 ]
  %number.0 = phi i32 [ 0, %for.cond2.preheader ], [ %number.1, %for.inc24 ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax21 = call i32 @llvm.smax.i32(i32 %number.0, i32 0)
  %wide.trip.count = zext nneg i32 %smax21 to i64
  br label %for.cond27

for.cond5:                                        ; preds = %for.body7, %for.cond5.preheader
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body7 ], [ 0, %for.cond5.preheader ]
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv8
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv17 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next18, %for.body29 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond22.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv17, 0
  %spec.select = select i1 %cmp30, ptr @.str, ptr @.str.1
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv17
