...
for.cond17:                                       ; preds = %for.inc, %if.then9
  ...
  br i1 %cmp20.not, label %for.inc32.loopexit, label %for.inc
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  ...
  br i1 %exitcond44.not, label %for.cond47.preheader, label %for.inc44
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc53
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc53 ], [ 0, %for.cond47.preheader ]
