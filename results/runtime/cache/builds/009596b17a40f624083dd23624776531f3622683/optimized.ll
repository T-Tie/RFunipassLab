...
for.cond2:                                        ; preds = %for.cond, %if.end73
  ...
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %if.end73 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %if.end73 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %if.end73 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv58, %5
  %idxprom77 = sext i32 %k.0 to i64
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv58
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax68 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %6 = add i32 %smax68, 1
  %wide.trip.count69 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.end115, %for.end76
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.end115 ], [ 0, %for.end76 ]
  %exitcond70 = icmp eq i64 %indvars.iv64, %wide.trip.count69
  br i1 %exitcond70, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv64
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv64, i64 %7
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.body88
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %if.end112 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv61, %wide.trip.count
  br i1 %exitcond.not, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv61, %7
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv64, i64 %indvars.iv61
