...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre42, %for.inc ], [ %0, %for.cond ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  ...
  br i1 %exitcond41.not, label %for.end30, label %for.body12
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.body16
  %indvars.iv32 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next33, %for.body16 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv36, i64 %indvars.iv32
