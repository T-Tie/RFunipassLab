...
for.cond:                                         ; preds = %outlined_ir_func_0.exit, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc54, %outlined_ir_func_0.exit ]
  %a.0 = phi i32 [ undef, %entry ], [ %a.1, %outlined_ir_func_0.exit ]
  %b.0 = phi i32 [ undef, %entry ], [ %b.1, %outlined_ir_func_0.exit ]
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select43 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select43
  ...
  %or.cond44 = or i1 %cmp12, %or.cond
  %smax45 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond44, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %x.1 = phi i32 [ %add, %for.inc ], [ 0, %for.body ]
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond46.not = icmp eq i32 %m.0, %smax45
  br i1 %exitcond46.not, label %for.inc53, label %for.body16
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax45
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  %.sink47 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add34 = add nuw nsw i32 %.sink47, %x.4
  %inc41 = add i32 %m.1, 1
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %rem20.i = urem i32 %x.4.lcssa.sink, 7
  %cmp21.i = icmp eq i32 %rem20.i, 0
  br i1 %cmp21.i, label %if.then22.i, label %if.else25.i

if.then22.i:                                      ; preds = %for.inc53
  %call1.i.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 3)
  br label %outlined_ir_func_0.exit

if.else25.i:                                      ; preds = %for.inc53
  %call1.i2.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 2)
  br label %outlined_ir_func_0.exit

outlined_ir_func_0.exit:                          ; preds = %if.then22.i, %if.else25.i
  %vbase.offset.i15 = load i64, ptr %vbase.offset.ptr.i27, align 8, !invariant.load !13
