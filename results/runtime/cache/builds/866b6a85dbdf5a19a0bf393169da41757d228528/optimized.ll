...
if.then:                                          ; preds = %for.body70
  ...
  %call76 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %17) #7
  br label %for.inc82
...
if.else:                                          ; preds = %for.body70
  ...
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %18) #7
  br label %for.inc82
...
for.end88:                                        ; preds = %for.cond63
  ...
  %call.i = call i32 @getc(ptr noundef %19) #7
  %20 = load ptr, ptr @stdin, align 8, !tbaa !20
  %call.i1 = call i32 @getc(ptr noundef %20) #7
