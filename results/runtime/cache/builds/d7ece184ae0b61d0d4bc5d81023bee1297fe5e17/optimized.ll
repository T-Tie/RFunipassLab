...
for.end:                                          ; preds = %for.cond
  ...
  %smax67 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %2 = add nuw i32 %smax67, 1
  %wide.trip.count68 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond69 = icmp eq i64 %indvars.iv64, %wide.trip.count68
  br i1 %exitcond69, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax55 = call i32 @llvm.smax.i32(i32 %l.0, i32 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv52 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next53, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond57.not = icmp eq i64 %indvars.iv52, %wide.trip.count56
  br i1 %exitcond57.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body19 ], [ 0, %for.cond14 ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond14 ]
  %exitcond51.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond51.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv46, %indvars.iv64
  %arrayidx21 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx21, align 1, !tbaa !9
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv52, i64 %indvars.iv46
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv52, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv58 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next59, %for.inc56 ]
  %exitcond63.not = icmp eq i64 %indvars.iv58, %wide.trip.count
  br i1 %exitcond63.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv58, %indvars.iv64
  %arrayidx51 = getelementptr inbounds nuw [500 x i8], ptr %a, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv58
...
for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc121
  %indvars.iv74 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next75, %for.inc121 ]
  %exitcond82.not = icmp eq i64 %indvars.iv74, %wide.trip.count81
  br i1 %exitcond82.not, label %for.end123, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv74, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc118
  %indvars.iv76 = phi i64 [ %indvars.iv74, %for.cond76.preheader ], [ %indvars.iv.next77, %for.inc118 ]
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %10 = trunc nuw i64 %indvars.iv.next77 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.inc121

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next77, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond73.not = icmp eq i64 %indvars.iv70, 6
  br i1 %exitcond73.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next77, i64 %indvars.iv70
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv70
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv74, i64 %indvars.iv70
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc151 ], [ 1, %if.else ]
  %exitcond92.not = icmp eq i64 %indvars.iv83, %wide.trip.count91
  br i1 %exitcond92.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv83, i64 4
  %17 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %18 = add nsw i64 %indvars.iv83, -1
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars90.le = trunc i64 %indvars.iv83 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.0.lcssa = phi i32 [ %indvars90.le, %for.end153.split.loop.exit ], [ %3, %for.cond134 ]
  %sub155 = add nsw i32 %z.0.lcssa, -1
  %wide.trip.count105 = zext i32 %sub155 to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv97 = phi i64 [ %indvars.iv.next98, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond106.not = icmp eq i64 %indvars.iv97, %wide.trip.count105
  br i1 %exitcond106.not, label %for.cond207.preheader, label %for.cond159.preheader

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count113 = zext i32 %z.0.lcssa to i64
  br label %for.cond207

for.cond159.preheader:                            ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv97, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  %indvars.iv99 = phi i64 [ %indvars.iv97, %for.cond159.preheader ], [ %indvars.iv.next100, %for.inc201 ]
  %indvars.iv.next100 = add nuw nsw i64 %indvars.iv99, 1
  %exitcond103.not = icmp eq i64 %indvars.iv99, %wide.trip.count105
  br i1 %exitcond103.not, label %for.inc204, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next100, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv93 = phi i64 [ %indvars.iv.next94, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond96.not = icmp eq i64 %indvars.iv93, 6
  br i1 %exitcond96.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next100, i64 %indvars.iv93
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv93
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv97, i64 %indvars.iv93
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv110 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next111, %for.inc223 ]
  %exitcond114.not = icmp eq i64 %indvars.iv110, %wide.trip.count113
  br i1 %exitcond114.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv107, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv110, i64 %indvars.iv107
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar44 = call i32 @putchar(i32 %conv218)
