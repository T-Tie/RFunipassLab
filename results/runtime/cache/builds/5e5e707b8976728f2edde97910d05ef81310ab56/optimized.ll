...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %csum) #9
  store i32 0, ptr %csum, align 4, !tbaa !5
...
for.body4:                                        ; preds = %for.cond2
  %4 = load i32, ptr %csum, align 4, !tbaa !5
  ...
  store i32 %conv10, ptr %csum, align 4, !tbaa !5
...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %.sink2 = phi i32 [ %5, %if.then ], [ %add16, %for.inc25 ]
  %add16 = add nsw i32 %.sink2, 1
  store i32 %add16, ptr %j, align 4, !tbaa !5
  %cmp18 = icmp sle i32 %add16, %2
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %.sink1 = phi i32 [ %6, %if.then30 ], [ %add35, %for.inc44 ]
  %add35 = add nsw i32 %.sink1, 1
  store i32 %add35, ptr %j, align 4, !tbaa !5
  %cmp37 = icmp slt i32 %add35, %2
...
for.end46:                                        ; preds = %for.cond36
  ...
  store i32 %conv52, ptr %csum, align 4, !tbaa !5
  br label %for.inc55.gvnsink.split
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %.sink = phi i32 [ %7, %for.end57 ], [ %add62, %for.inc71 ]
  %add62 = add nsw i32 %.sink, 1
  %8 = load i32, ptr %n, align 4, !tbaa !5
  %cmp64 = icmp slt i32 %add62, %8
...
for.end73:                                        ; preds = %for.cond63
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %csum) #10
