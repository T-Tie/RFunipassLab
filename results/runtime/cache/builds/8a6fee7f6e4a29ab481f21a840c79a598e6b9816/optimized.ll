...
for.cond3:                                        ; preds = %for.cond3.preheader, %if.end32
  %indvars.iv52 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next53, %if.end32 ]
  %indvars.iv27 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next28, %if.end32 ]
  %smax54 = call i64 @llvm.smax.i64(i64 %indvars.iv52, i64 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body10 ], [ 0, %for.cond3 ]
  %maxIndex.0 = phi i32 [ %spec.select, %for.body10 ], [ 0, %for.cond3 ]
  %exitcond55 = icmp eq i64 %indvars.iv24, %smax54
  br i1 %exitcond55, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv24
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv32 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next33, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count35
  br i1 %exitcond36.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv32
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax46 = call i32 @llvm.smax.i32(i32 %k.0, i32 0)
  %wide.trip.count47 = zext nneg i32 %smax46 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count40 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.body56
  %indvars.iv42 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next43, %for.body56 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, %wide.trip.count47
  br i1 %exitcond48.not, label %if.end80, label %for.body56

for.body56:                                       ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv42
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv37 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next38, %for.inc73 ]
  %exitcond41.not = icmp eq i64 %indvars.iv37, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv37
