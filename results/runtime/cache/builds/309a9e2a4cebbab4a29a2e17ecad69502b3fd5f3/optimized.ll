...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  %indvars.iv20 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next21, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond2
  ...
  %call5 = call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(100) %a, i32 noundef %2, i32 noundef %0) #6
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv20
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond28.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv24
...
for.end21:                                        ; preds = %for.cond11
  ...
  %call.i6 = call i32 @getc(ptr noundef %5)
  %6 = load ptr, ptr @stdin, align 8, !tbaa !15
  %call.i7 = call i32 @getc(ptr noundef %6)
...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc13 ], [ %0, %for.end ]
  %cmp3 = icmp slt i64 %indvars.iv15, %1
  br i1 %cmp3, label %for.body4, label %for.cond20

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv15
...
if.then10:                                        ; preds = %for.body4
  %4 = trunc nsw i64 %indvars.iv15 to i32
  %call = tail call noundef i32 @_Z2ljPiii(ptr nofree noundef nonnull readonly captures(none) %a, i32 noundef %4, i32 noundef %m) #8
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv15
...
for.cond20:                                       ; preds = %for.cond2, %for.body22
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body22 ], [ %0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ undef, %for.cond2 ]
  %cmp21 = icmp slt i64 %indvars.iv18, %1
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv18
