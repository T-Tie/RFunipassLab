...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.end ], [ 1, %entry ]
...
for.cond12:                                       ; preds = %for.end27, %for.end10
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.end27 ], [ 1, %for.end10 ]
  %6 = load i32, ptr %x2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp13.not = icmp sgt i64 %indvars.iv42, %7
...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax52 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count53 = zext nneg i32 %smax52 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond31

for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv38 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next39, %for.body17 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp16.not = icmp sgt i64 %indvars.iv38, %12
  br i1 %cmp16.not, label %for.end27, label %for.body17
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.end45
  %indvars.iv49 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next50, %for.end45 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count53
  br i1 %exitcond54.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax58 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
  %wide.trip.count59 = zext nneg i32 %smax58 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond31, %for.body38
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.body38 ], [ 0, %for.cond31 ]
  %exitcond.not = icmp eq i64 %indvars.iv46, %wide.trip.count
  br i1 %exitcond.not, label %for.end45, label %for.body38

for.body38:                                       ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv49, i64 %indvars.iv46
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.end78
  %indvars.iv67 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next68, %for.end78 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %wide.trip.count53
  br i1 %exitcond71.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.end75
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.end75 ], [ 0, %for.cond49 ]
  %exitcond66.not = icmp eq i64 %indvars.iv61, %wide.trip.count
  br i1 %exitcond66.not, label %for.end78, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv67, i64 %indvars.iv61
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.body60
  %indvars.iv55 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next56, %for.body60 ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %wide.trip.count59
  br i1 %exitcond60.not, label %for.end75, label %for.body60

for.body60:                                       ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv67, i64 %indvars.iv55
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv55, i64 %indvars.iv61
...
for.cond82:                                       ; preds = %for.cond49, %for.end105
  %18 = phi i32 [ %22, %for.end105 ], [ %10, %for.cond49 ]
  %19 = phi i32 [ %.pre, %for.end105 ], [ %9, %for.cond49 ]
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.end105 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv76, %20
...
for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre80, %for.body87 ]
  %indvars.iv72 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next73, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv72, %23
  br i1 %cmp86.not, label %for.end105, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv72, %24
  %25 = add nsw i64 %indvars.iv72, -1
  %26 = getelementptr inbounds [100 x [100 x i32]], ptr %c, i64 0, i64 %21, i64 %25
  %27 = load i32, ptr %26, align 4, !tbaa !5, !invariant.load !17
  %.str.3..str.2 = select i1 %cmp88.not, ptr @.str.3, ptr @.str.2
  %call102 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3..str.2, i32 noundef %27) #6
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv72, 1
  %.pre80 = load i32, ptr %y2, align 4, !tbaa !5
  br label %for.cond85, !llvm.loop !21

for.end105:                                       ; preds = %for.cond85
