...
for.inc55:                                        ; preds = %for.cond47
  ...
  %4 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !12
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !17, !invariant.load !12
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !19, !invariant.load !12
  ret i32 %0
}
