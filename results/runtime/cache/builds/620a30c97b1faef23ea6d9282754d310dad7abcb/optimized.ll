...
for.cond43.preheader:                             ; preds = %for.cond8
  %smax26 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef -1)
  %2 = add i32 %smax26, 1
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc50
  ...
  br i1 %exitcond28, label %for.end52, label %for.inc50
...
declare ptr @strcat(ptr noalias noundef returned, ptr noalias noundef readonly captures(none)) #4
