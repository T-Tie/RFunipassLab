...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  ...
  %lenq.0 = phi i64 [ %indvars.iv27, %if.end44 ], [ %indvars.iv, %while.cond4.preheader ]
...
for.cond:                                         ; preds = %while.end19, %for.inc
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc ], [ 0, %while.end19 ]
  %exitcond37.not = icmp eq i64 %indvars.iv33, %idx.ext6
  br i1 %exitcond37.not, label %for.end, label %for.body

for.body:                                         ; preds = %for.cond
  %add.ptr27 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv33
  ...
  %gep25 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %6 = load i64, ptr %gep25, align 8, !tbaa !15, !invariant.load !13
...
for.cond33:                                       ; preds = %while.end19, %for.inc40
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc40 ], [ 0, %while.end19 ]
  %exitcond.not = icmp eq i64 %indvars.iv30, %idx.ext6
  br i1 %exitcond.not, label %for.end42, label %for.body36

for.body36:                                       ; preds = %for.cond33
  %add.ptr38 = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv30
