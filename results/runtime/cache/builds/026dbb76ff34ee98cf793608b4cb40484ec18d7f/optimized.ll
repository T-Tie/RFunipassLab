...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc28
  ...
  br i1 %exitcond37.not, label %for.cond31.preheader, label %for.body12
...
for.cond31.outer:                                 ; preds = %for.cond37, %for.cond31.preheader
  %indvars.iv42.ph = phi i64 [ %4, %for.cond31.preheader ], [ %indvars.iv.next43, %for.cond37 ]
  %a2.0.ph = phi i32 [ undef, %for.cond31.preheader ], [ %a2.1, %for.cond37 ]
  %b2.0.ph = phi i32 [ undef, %for.cond31.preheader ], [ %b2.1, %for.cond37 ]
  %p.4.ph = phi i32 [ 0, %for.cond31.preheader ], [ %p.5, %for.cond37 ]
  %cmp34 = icmp eq i32 %p.4.ph, 0
  br label %for.cond31

for.cond31:                                       ; preds = %for.cond31.outer, %for.body33
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.body33 ], [ %indvars.iv42.ph, %for.cond31.outer ]
  %8 = trunc nuw i64 %indvars.iv42 to i32
  %cmp32 = icmp sgt i32 %8, 0
  br i1 %cmp32, label %for.body33, label %for.end53

for.body33:                                       ; preds = %for.cond31
  %indvars.iv.next43 = add nsw i64 %indvars.iv42, -1
  br i1 %cmp34, label %for.cond37.preheader, label %for.cond31, !llvm.loop !15

for.cond37.preheader:                             ; preds = %for.body33
  %indvars44.le = trunc i64 %indvars.iv.next43 to i32
  %idxprom40 = and i64 %indvars.iv.next43, 4294967295
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv39 = phi i64 [ %4, %for.cond37.preheader ], [ %indvars.iv.next40, %for.body39 ]
  %a2.1 = phi i32 [ %a2.0.ph, %for.cond37.preheader ], [ %a2.2, %for.body39 ]
  %b2.1 = phi i32 [ %b2.0.ph, %for.cond37.preheader ], [ %b2.2, %for.body39 ]
  %p.5 = phi i32 [ 0, %for.cond37.preheader ], [ %p.6, %for.body39 ]
  %9 = trunc nuw i64 %indvars.iv39 to i32
  %cmp38 = icmp sgt i32 %9, 0
  br i1 %cmp38, label %for.body39, label %for.cond31.outer, !llvm.loop !15

for.body39:                                       ; preds = %for.cond37
  %indvars.iv.next40 = add nsw i64 %indvars.iv39, -1
  %indvars = trunc i64 %indvars.iv.next40 to i32
  %idxprom42 = and i64 %indvars.iv.next40, 4294967295
  ...
  %a2.2 = select i1 %cmp44, i32 %indvars44.le, i32 %a2.1
...
for.end53:                                        ; preds = %for.cond31
  %reass.sub = sub i32 %b2.0.ph, %b1.0
  %add55 = add i32 %reass.sub, 1
  %sub56 = add i32 %a1.0, 1
  %add57 = sub i32 %sub56, %a2.0.ph
