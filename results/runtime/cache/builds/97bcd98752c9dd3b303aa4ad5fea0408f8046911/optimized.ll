...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv28 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next29, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax36 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv28
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond40 = icmp eq i32 %q.0, %4
  br i1 %exitcond40, label %for.cond52.preheader, label %for.cond25

for.cond52.preheader:                             ; preds = %for.cond22
  %7 = sext i32 %t.0 to i64
  %smax45 = call i32 @llvm.smax.i32(i32 %t.0, i32 -1)
  %8 = add i32 %smax45, 1
  %wide.trip.count46 = zext i32 %8 to i64
  br label %for.cond52

for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond38.not = icmp eq i64 %indvars.iv32, %wide.trip.count37
  br i1 %exitcond38.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv32
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next33
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv41 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next42, %for.body54 ]
  %exitcond47 = icmp eq i64 %indvars.iv41, %wide.trip.count46
  br i1 %exitcond47, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv41, %7
  %arrayidx58 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv41
