...
if.end19:                                         ; preds = %if.end, %if.else14
  %3 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !9, !invariant.load !11
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !11
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !9, !invariant.load !11
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !15, !invariant.load !11
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !5, !invariant.load !11
  %1 = load i32, ptr %__c2, align 4, !tbaa !5, !invariant.load !11
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
