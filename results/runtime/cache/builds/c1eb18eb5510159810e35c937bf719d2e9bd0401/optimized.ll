...
if.then55:                                        ; preds = %for.body51
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %10, double noundef %11) #8
  br label %for.inc110
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %fneg81, double noundef %13, double noundef %fneg81, double noundef %13) #8
  br label %for.inc110
...
if.else93:                                        ; preds = %if.else72
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %12, double noundef %14, double noundef %12, double noundef %14) #8
  br label %for.inc110
