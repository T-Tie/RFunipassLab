...
for.cond69:                                       ; preds = %for.inc125, %if.end68
  %6 = phi i32 [ %inc126, %for.inc125 ], [ 0, %if.end68 ]
  %cmp70 = icmp slt i32 %6, %t
...
lor.lhs.false.thread:                             ; preds = %if.else79
  %cmp8120 = icmp eq i32 %7, 1
  br i1 %cmp8120, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %lor.lhs.false
  %idxprom88 = sext i32 %7 to i64
...
if.then97:                                        ; preds = %if.else95
  ...
  %9 = load i32, ptr %arrayidx99, align 4, !tbaa !5, !invariant.load !9
  %sub102 = sub nsw i32 %6, 1
