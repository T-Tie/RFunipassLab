...
entry:
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 %mon, i32 1)
  %1 = or i1 %cmp25, %or.cond
  %spec.select5 = select i1 %1, i32 29, i32 28
  br label %for.cond
...
for.inc.gvnsink.split:                            ; preds = %if.then24, %for.body, %for.body, %for.body, %for.body, %for.body, %for.body, %for.body, %for.inc.gvnsink.split.fold.split
  %.sink1.sink = phi i32 [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 30, %for.inc.gvnsink.split.fold.split ], [ %spec.select5, %if.then24 ]
