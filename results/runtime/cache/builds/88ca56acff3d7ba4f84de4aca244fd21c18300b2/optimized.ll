...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 301, ptr noundef nonnull align 16 %str) #4
...
if.else:                                          ; preds = %land.lhs.true
  ...
  %spec.select7 = add nsw i32 %a.0, %inc19
  br label %for.inc

for.inc:                                          ; preds = %if.else, %for.body, %if.then
  %a.1 = phi i32 [ %inc, %if.then ], [ %a.0, %for.body ], [ %spec.select7, %if.else ]
...
if.then23:                                        ; preds = %for.end
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1) #5
  br label %if.end83

for.cond26:                                       ; preds = %for.end, %for.inc51
  %2 = phi i32 [ %inc52, %for.inc51 ], [ 65, %for.end ]
  %exitcond.not = icmp eq i32 %2, 91
  br i1 %exitcond.not, label %for.cond54, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv9
  %3 = load i8, ptr %arrayidx31, align 1, !tbaa !5, !invariant.load !11
  %cmp33.not = icmp eq i8 %3, 0
  br i1 %cmp33.not, label %for.end44, label %for.body34

for.body34:                                       ; preds = %for.cond29
  %conv32 = sext i8 %3 to i32
  %cmp38 = icmp eq i32 %2, %conv32
...
if.then46:                                        ; preds = %for.end44
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %2, i32 noundef %t.1) #5
  br label %for.inc51

for.inc51:                                        ; preds = %for.end44, %if.then46
  %inc52 = add nuw nsw i32 %2, 1
  br label %for.cond26, !llvm.loop !13

for.cond54:                                       ; preds = %for.cond26, %for.inc80
  %4 = phi i32 [ %inc81, %for.inc80 ], [ 97, %for.cond26 ]
  %exitcond15.not = icmp eq i32 %4, 123
  br i1 %exitcond15.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select6, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv12
  %5 = load i8, ptr %arrayidx59, align 1, !tbaa !5, !invariant.load !11
  %cmp61.not = icmp eq i8 %5, 0
  br i1 %cmp61.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond57
  %conv60 = sext i8 %5 to i32
  %cmp66 = icmp eq i32 %4, %conv60
  %inc68 = zext i1 %cmp66 to i32
  %spec.select6 = add nuw nsw i32 %l.1, %inc68
...
if.then74:                                        ; preds = %for.end72
  %call78 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %4, i32 noundef %l.1) #5
  br label %for.inc80

for.inc80:                                        ; preds = %for.end72, %if.then74
  %inc81 = add nuw nsw i32 %4, 1
  br label %for.cond54, !llvm.loop !15

if.end83:                                         ; preds = %for.cond54, %if.then23
  call void @llvm.lifetime.end.p0(i64 noundef 301, ptr noundef nonnull %str) #5
  ret i32 0
}
