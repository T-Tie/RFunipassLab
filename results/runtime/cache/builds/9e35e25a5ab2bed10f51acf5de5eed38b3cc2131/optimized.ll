...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  ...
  %exitcond43.not = icmp eq i32 %j.0, %smax42
  br i1 %exitcond43.not, label %for.cond47.preheader, label %for.cond19.preheader
...
for.cond47.preheader:                             ; preds = %for.cond16
  ...
  %smax48 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
...
for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv34
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next35
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv44 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next45, %for.inc58 ]
  %exitcond50.not = icmp eq i64 %indvars.iv44, %wide.trip.count49
  br i1 %exitcond50.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv44
  ...
  %cmp54.not = icmp eq i64 %indvars.iv44, %4
