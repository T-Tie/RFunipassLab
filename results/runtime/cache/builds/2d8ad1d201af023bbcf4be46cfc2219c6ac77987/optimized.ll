...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 5000, ptr nonnull %str1) #7
  call void @llvm.lifetime.start.p0(i64 5000, ptr nonnull %str2) #7
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
...
for.end55:                                        ; preds = %for.cond47
  call void @llvm.lifetime.end.p0(i64 5000, ptr nonnull %str2) #7
  call void @llvm.lifetime.end.p0(i64 5000, ptr nonnull %str1) #7
  ret i32 0
}
