...
entry:
  ...
  %mul1 = mul i64 %conv, 4
  %call2 = call noalias ptr @malloc(i64 noundef %mul1) #5
...
for.end10:                                        ; preds = %for.cond
  ...
  %call15 = call noalias ptr @malloc(i64 noundef %mul14) #5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond16
...
for.end32:                                        ; preds = %for.cond16
  ...
  %call36 = call noalias ptr @malloc(i64 noundef %mul35) #5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond37
...
for.cond40:                                       ; preds = %for.inc71, %for.body39
  ...
  %cmp41 = icmp slt i32 %16, %17
  br i1 %cmp41, label %for.body42, label %for.end73

for.body42:                                       ; preds = %for.cond40
  %mul43 = mul nsw i32 %14, %17
  %add44 = add nsw i32 %mul43, %16
...
for.cond77:                                       ; preds = %for.inc98, %for.end76
  ...
  %26 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp78 = icmp slt i32 %25, %26
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %sub90 = sub nsw i32 %31, 1
  %cmp91 = icmp eq i32 %27, %sub90
