...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef align 16 %array) #4
...
if.then46:                                        ; preds = %for.end44
  %call47 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %i.1, i32 noundef %m.0) #5
  br label %for.end54
...
if.then56:                                        ; preds = %for.end54
  %call57 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #5
  br label %if.end58
...
if.end58:                                         ; preds = %if.then56, %for.end54
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef %array) #5
  ret i32 0
}
