...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv20 = phi i64 [ %indvars.iv.next21.pre-phi, %for.inc18 ], [ 0, %for.cond ]
