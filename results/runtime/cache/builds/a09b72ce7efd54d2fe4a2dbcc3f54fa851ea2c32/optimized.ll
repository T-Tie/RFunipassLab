...
for.end23:                                        ; preds = %if.then, %for.cond13
  %x1.2 = phi i32 [ %j.1, %if.then ], [ %x1.0, %for.cond13 ]
...
for.end29:                                        ; preds = %if.then25, %for.cond10
  %x1.1 = phi i32 [ %x1.2, %if.then25 ], [ %x1.0, %for.cond10 ]
...
for.end44:                                        ; preds = %if.then41, %for.cond33
  %x2.2 = phi i32 [ %j.2, %if.then41 ], [ %x2.0, %for.cond33 ]
...
for.end50:                                        ; preds = %if.then46, %for.cond30
  %x2.1 = phi i32 [ %x2.2, %if.then46 ], [ %x2.0, %for.cond30 ]
