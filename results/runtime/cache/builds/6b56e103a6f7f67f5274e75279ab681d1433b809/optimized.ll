...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 %str) #5
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(10000) %str, i8 noundef 0, i64 noundef 10000, i1 noundef false) #6
  call void @llvm.lifetime.start.p0(i64 noundef 400000, ptr noundef nonnull align 16 %b) #5
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv28 = phi i32 [ %indvars.iv.next29, %while.body ], [ 0, %entry ]
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %3 = trunc nuw nsw i64 %indvars.iv24 to i32
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc35
  %indvars.iv36 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next37, %for.inc35 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count
  br i1 %exitcond41.not, label %for.end37, label %for.cond18

for.cond18:                                       ; preds = %for.cond15, %for.body20
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body20 ], [ 0, %for.cond15 ]
  %sum.0 = phi i32 [ %add, %for.body20 ], [ 0, %for.cond15 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end28, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100000 x i32], ptr %b, i64 0, i64 %indvars.iv30
  %4 = load i32, ptr %arrayidx22, align 4, !tbaa !11
  %5 = zext i32 %4 to i64
  %cmp23.not = icmp eq i64 %indvars.iv36, %5
...
if.then30:                                        ; preds = %for.end28
  %arrayidx32 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv36
...
for.end37:                                        ; preds = %for.cond15
  call void @llvm.lifetime.end.p0(i64 noundef 400000, ptr noundef nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %str) #7
  ret i32 0
}
