...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  ...
  br i1 %cmp14.not.not, label %for.cond16.preheader, label %for.cond31.preheader
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc25
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc25 ], [ 0, %for.cond16.preheader ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  ...
  br i1 %exitcond58.not, label %for.cond49.preheader, label %for.cond35.preheader

for.cond35.preheader:                             ; preds = %for.cond31
  br label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %smax63 = call i32 @llvm.smax.i32(i32 %4, i32 noundef 0)
  %wide.trip.count64 = zext nneg i32 %smax63 to i64
  br label %for.cond49

for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc43
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc43 ], [ 0, %for.cond35.preheader ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc83
  ...
  br i1 %exitcond76.not, label %for.cond86.preheader, label %for.cond53.preheader

for.cond53.preheader:                             ; preds = %for.cond49
  br label %for.cond53

for.cond86.preheader:                             ; preds = %for.cond49
  br label %for.cond86

for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc80
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc80 ], [ 0, %for.cond53.preheader ]
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc109
  %13 = phi i32 [ %16, %for.inc109 ], [ %7, %for.cond86.preheader ]
  %14 = phi i32 [ %.pre, %for.inc109 ], [ %6, %for.cond86.preheader ]
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc109 ], [ 0, %for.cond86.preheader ]
  %15 = sext i32 %14 to i64
  %cmp88.not.not = icmp slt i64 %indvars.iv80, %15
  br i1 %cmp88.not.not, label %for.cond90.preheader, label %for.end111

for.cond90.preheader:                             ; preds = %for.cond86
  br label %for.cond90

for.cond90:                                       ; preds = %for.cond90.preheader, %for.body93
  %16 = phi i32 [ %.pre83, %for.body93 ], [ %13, %for.cond90.preheader ]
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.body93 ], [ 0, %for.cond90.preheader ]
