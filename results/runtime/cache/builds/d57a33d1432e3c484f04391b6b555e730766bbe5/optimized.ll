...
for.cond67:                                       ; preds = %for.inc82, %for.body66
  %17 = phi i32 [ %.pr, %for.inc82 ], [ 0, %for.body66 ]
...
for.body70:                                       ; preds = %for.cond67
  ...
  %idxprom72 = sext i32 %15 to i64
  %idxprom74 = sext i32 %17 to i64
  %19 = getelementptr inbounds [101 x [101 x i32]], ptr %c, i64 0, i64 %idxprom72
  %20 = getelementptr inbounds [101 x i32], ptr %19, i64 0, i64 %idxprom74
...
for.inc82:                                        ; preds = %for.body70, %if.else
  ...
  %call81 = call i32 (ptr, ...) @printf(ptr noundef %.str.2.sink, i32 noundef %21)
