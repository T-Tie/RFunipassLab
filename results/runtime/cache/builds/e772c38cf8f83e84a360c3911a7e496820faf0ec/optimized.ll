...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %s_all) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %s_good) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %all) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %good) #7
  br label %for.cond
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.else
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit23: ; preds = %if.else
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i11)
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %good) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %all) #7
...
if.then15_to_outline:
  ...
  %1 = load i64, ptr %gep32, align 8, !tbaa !26
...
!31 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !21, i64 0}
!32 = !{!"_ZTSNSt8ios_base6_WordsE", !21, i64 0, !28, i64 8}
!33 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !21, i64 0}
!34 = !{!"_ZTSSt6locale", !35, i64 0}
!35 = !{!"p1 _ZTSNSt6locale5_ImplE", !21, i64 0}
