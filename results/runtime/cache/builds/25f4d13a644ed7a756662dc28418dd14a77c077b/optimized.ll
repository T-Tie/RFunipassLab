...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %wide.trip.count14 = zext nneg i32 %smax43 to i64
...
for.cond69:                                       ; preds = %for.cond69.preheader, %for.inc125
  %indvars.iv39 = phi i64 [ 0, %for.cond69.preheader ], [ %indvars.iv.next40, %for.inc125 ]
  %exitcond45.not = icmp eq i64 %indvars.iv39, %wide.trip.count14
  br i1 %exitcond45.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %5 = add nsw i64 %indvars.iv39, -1
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  %indvars.iv3 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next4, %for.inc9 ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, %wide.trip.count6
  br i1 %exitcond7.not, label %for.cond12, label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count6
...
for.cond12:                                       ; preds = %for.cond1, %for.inc26
  ...
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc26 ], [ 0, %for.cond1 ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv11, %2
  br i1 %cmp13, label %for.cond15, label %for.inc32

for.cond15:                                       ; preds = %for.cond12, %for.inc23
  %3 = phi i32 [ %.pre, %for.inc23 ], [ %1, %for.cond12 ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc23 ], [ 0, %for.cond12 ]
  %4 = sext i32 %3 to i64
  %cmp16 = icmp slt i64 %indvars.iv8, %4
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv11, i64 %indvars.iv8
