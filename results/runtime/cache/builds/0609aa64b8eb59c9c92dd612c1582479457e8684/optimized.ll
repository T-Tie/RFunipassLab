...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  store i32 %.sink, ptr %t, align 4, !tbaa !5
...
for.cond16:                                       ; preds = %for.inc35, %for.body15
  %.sink1 = phi i32 [ %5, %for.body15 ], [ %6, %for.inc35 ]
  %add = add nsw i32 %.sink1, 1
  store i32 %add, ptr %p, align 4, !tbaa !5
  %6 = load i32, ptr %p, align 4, !tbaa !5
  %cmp17 = icmp slt i32 %6, %3
...
for.end52:                                        ; preds = %for.cond40
  ...
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %14)
