...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %a) #7
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %b) #7
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %c) #7
...
for.end80:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %c) #7
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %a) #7
  ret i32 0
}
