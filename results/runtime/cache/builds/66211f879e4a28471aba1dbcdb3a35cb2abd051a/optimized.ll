...
entry:
  ...
  %call = call noundef i32 @_Z9down_casti(i32 noundef %n) #12
...
for.end9:                                         ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %i) #11
  ret void
}
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j) #11
...
if.end14:                                         ; preds = %if.then9, %for.body5
  %min.1 = phi i32 [ %3, %if.then9 ], [ %min.0, %for.body5 ]
...
for.body34:                                       ; preds = %for.cond31
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j35) #11
  store i32 0, ptr %j35, align 4, !tbaa !5
  br label %for.cond36

for.cond36:                                       ; preds = %if.end50, %for.body34
  %min.2 = phi i32 [ 65535, %for.body34 ], [ %min.3, %if.end50 ]
  %6 = load i32, ptr %j35, align 4, !tbaa !5
  %cmp37 = icmp slt i32 %6, %n
...
if.end50:                                         ; preds = %if.then45, %for.body39
  %min.3 = phi i32 [ %7, %if.then45 ], [ %min.2, %for.body39 ]
  call fastcc void @outlined_ir_func_0(ptr %j35)
  br label %for.cond36

for.end53:                                        ; preds = %for.cond36
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j35) #11
  br label %for.cond55
...
for.inc64:                                        ; preds = %for.cond55
  ...
  %8 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
  %sub63 = sub nsw i32 %8, %min.2
...
for.end69:                                        ; preds = %for.cond31
  %9 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @arr, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i70) #11
  store i32 2, ptr %i70, align 4, !tbaa !5
  br label %for.cond71

for.cond71:                                       ; preds = %for.end91, %for.end69
  %10 = load i32, ptr %i70, align 4, !tbaa !5
  %cmp72 = icmp slt i32 %10, %n
...
for.inc89:                                        ; preds = %for.cond76
  ...
  %11 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !12
  %sub84 = sub nsw i32 %10, 1
  ...
  store i32 %11, ptr %arrayidx88, align 4, !tbaa !5
  %inc90 = add nsw i32 %j75.0, 1
  br label %for.cond76, !llvm.loop !16

for.end91:                                        ; preds = %for.cond76
  call fastcc void @outlined_ir_func_0(ptr %i70)
  br label %for.cond71

for.end94:                                        ; preds = %for.cond71
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i70) #11
  br label %for.cond96
...
for.inc114:                                       ; preds = %for.cond101
  ...
  %12 = load i32, ptr %arrayidx108, align 4, !tbaa !5, !invariant.load !12
  ...
  store i32 %12, ptr %arrayidx113, align 4, !tbaa !5
...
for.end119:                                       ; preds = %for.cond96
  ...
  %call = call noundef i32 @_Z9down_casti(i32 noundef %sub120) #13
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !19, !invariant.load !12
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %j) #11
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond1
...
for.body4:                                        ; preds = %for.cond1
  ...
  %call = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %3)
...
for.end:                                          ; preds = %for.cond1
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %j) #11
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !19, !invariant.load !12
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !12
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !21, !invariant.load !12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !39, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !45, !invariant.load !12
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !19, !invariant.load !12
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !46, !invariant.load !12
  ret i32 %0
}
...
define internal fastcc void @outlined_ir_func_0(ptr %0) unnamed_addr #10 {
for.cond.exitStub:
