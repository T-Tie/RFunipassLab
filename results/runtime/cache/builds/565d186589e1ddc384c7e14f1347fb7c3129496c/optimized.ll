...
for.cond14:                                       ; preds = %for.cond11, %for.inc34
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc34 ], [ 0, %for.cond11 ]
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [501 x i32], ptr %b, i64 0, i64 %indvars.iv10
  %5 = load i32, ptr %arrayidx18, align 4, !tbaa !5
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx20 = getelementptr inbounds nuw [501 x i32], ptr %b, i64 0, i64 %indvars.iv.next11
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc45
  %indvars.iv14 = phi i64 [ 1, %for.cond39.preheader ], [ %indvars.iv.next15, %for.inc45 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, %wide.trip.count18
  br i1 %exitcond19.not, label %for.end47, label %for.inc45

for.inc45:                                        ; preds = %for.cond39
  %arrayidx43 = getelementptr inbounds nuw [501 x i32], ptr %b, i64 0, i64 %indvars.iv14
