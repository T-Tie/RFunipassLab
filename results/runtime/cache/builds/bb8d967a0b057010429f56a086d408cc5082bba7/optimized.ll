...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z3sumi(i32 noundef %3) #7
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom
  %1 = load i32, ptr %arrayidx, align 16, !tbaa !5, !invariant.load !14
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx8 = getelementptr inbounds [100 x i32], ptr %arrayidx, i64 0, i64 %idxprom7
  %3 = load i32, ptr %arrayidx8, align 4, !tbaa !5, !invariant.load !14
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %7 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !14
  %sub = sub nsw i32 %7, %6
...
for.body34:                                       ; preds = %for.cond32
  ...
  %11 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !14
...
for.inc57:                                        ; preds = %for.cond49
  ...
  %15 = load i32, ptr %arrayidx55, align 4, !tbaa !5, !invariant.load !14
...
for.inc80:                                        ; preds = %for.cond68
  ...
  %19 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !14
...
for.inc101:                                       ; preds = %for.cond89
  ...
  %22 = load i32, ptr %arrayidx95, align 4, !tbaa !5, !invariant.load !14
