...
for.cond:                                         ; preds = %for.inc17, %entry
  ...
  %exitcond24.not = icmp eq i64 %indvars.iv, 13
  br i1 %exitcond24.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc14 ], [ %indvars.iv, %for.cond ]
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  %exitcond.not = icmp eq i64 %indvars.iv20, 12
...
for.cond5:                                        ; preds = %for.cond2, %for.inc
  ...
  %cmp6.not = icmp samesign ugt i64 %indvars.iv17, %indvars.iv20
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv.next21
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc27 ], [ 1, %for.cond ]
  %exitcond28.not = icmp eq i64 %indvars.iv25, 13
  br i1 %exitcond28.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv25, i64 %indvars.iv25
  store i32 1, ptr %arrayidx26, align 4, !tbaa !5
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond20, !llvm.loop !15

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond36.not = icmp eq i64 %indvars.iv33, 13
  br i1 %exitcond36.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc45 ], [ 1, %for.cond30 ]
...
for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv29, i64 %indvars.iv33
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv33, i64 %indvars.iv29
...
for.cond51:                                       ; preds = %for.cond30, %for.inc79
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc79 ], [ 1, %for.cond30 ]
  %exitcond47.not = icmp eq i64 %indvars.iv37, 13
  br i1 %exitcond47.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc76 ], [ %indvars.iv37, %for.cond51 ]
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %exitcond45.not = icmp eq i64 %indvars.iv42, 12
  br i1 %exitcond45.not, label %for.inc79, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc65 ], [ %indvars.iv37, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not = icmp samesign ugt i64 %indvars.iv39, %indvars.iv42
  br i1 %cmp60.not, label %for.end67, label %for.inc65

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv39
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv37, i64 %indvars.iv.next43
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond51.not = icmp eq i64 %indvars.iv48, 13
  br i1 %exitcond51.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv48, i64 %indvars.iv48
  store i32 1, ptr %arrayidx88, align 4, !tbaa !5
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  br label %for.cond82, !llvm.loop !21

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond59.not = icmp eq i64 %indvars.iv56, 13
  br i1 %exitcond59.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond55.not = icmp eq i64 %indvars.iv52, %indvars.iv56
  br i1 %exitcond55.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv52, i64 %indvars.iv56
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv56, i64 %indvars.iv52
