...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull dereferenceable(41000) %word) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(41000) %word, i8 noundef 0, i64 noundef 41000, i1 noundef false) #10
  call void @llvm.lifetime.start.p0(i64 noundef 81000, ptr noundef nonnull align 16 %newword) #9
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(81000) %newword, i8 noundef 0, i64 noundef 81000, i1 noundef false) #10
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #11
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx6) #12
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx6) #12
...
if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #12
  store i8 32, ptr %arrayidx56, align 1, !tbaa !33
  br label %for.inc74

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #12
  store i8 32, ptr %arrayidx56, align 1, !tbaa !33
  br label %for.inc74
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax89 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %8 = add i32 %smax89, 1
...
for.body88:                                       ; preds = %for.cond86
  ...
  %call92 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx90) #11
...
if.else106:                                       ; preds = %for.body96
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i6)
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18: ; preds = %if.then.i13, %if.end.i16
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i6)
  br label %for.inc113
...
for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 noundef 81000, ptr noundef nonnull %newword) #12
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef nonnull %word) #12
