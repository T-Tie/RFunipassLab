...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %zfc) #5
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %wt) #5
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %tar) #5
...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
...
for.cond22.preheader:                             ; preds = %for.cond10
  %sext19 = shl i64 %2, 32
  %3 = ashr exact i64 %sext19, 32
  %sext20 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext20, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv8
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %6 = sub nuw nsw i64 %indvars.iv8, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc31
  %indvars.iv15 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next16, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv15, %3
  br i1 %cmp24, label %for.inc31, label %for.end37

for.inc31:                                        ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv15, %4
  %arrayidx28 = getelementptr inbounds nuw [256 x i8], ptr %tar, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv15
...
for.end37:                                        ; preds = %for.cond, %for.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %tar) #5
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %wt) #5
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %zfc) #5
  ret i32 0
}
