...
for.cond:                                         ; preds = %if.end, %entry
  %0 = phi i32 [ %dec, %if.end ], [ %.pr, %entry ]
  %i.0 = phi i32 [ %i.1, %if.end ], [ 0, %entry ]
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.end30
  %indvars.iv19 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next20, %for.end30 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond.not, label %for.end33, label %for.cond7

for.cond7:                                        ; preds = %for.cond3, %if.end27
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end27 ], [ %1, %for.cond3 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %cmp8.not.not = icmp sgt i64 %indvars.iv, %indvars.iv19
  br i1 %cmp8.not.not, label %for.body9, label %for.end30
...
for.cond36:                                       ; preds = %for.body39, %for.end33
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body39 ], [ 1, %for.end33 ]
