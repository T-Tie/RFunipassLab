...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre89, %for.inc23 ]
  %indvars.iv50 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next51, %for.inc23 ]
...
for.end28:                                        ; preds = %for.cond12
  ...
  %smax62 = call i32 @llvm.smax.i32(i32 %22, i32 0)
  %wide.trip.count63 = zext nneg i32 %smax62 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc43, %for.end28
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc43 ], [ 0, %for.end28 ]
...
for.cond46.preheader:                             ; preds = %for.cond30
  %smax69 = call i32 @llvm.smax.i32(i32 %17, i32 0)
  %wide.trip.count75 = zext nneg i32 %smax to i64
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv56 = phi i64 [ 0, %for.cond33.preheader ], [ %indvars.iv.next57, %for.inc40 ]
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv77 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next78, %for.inc77 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv72 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next73, %for.inc74 ]
  %exitcond76.not = icmp eq i64 %indvars.iv72, %wide.trip.count75
  br i1 %exitcond76.not, label %for.inc77, label %for.cond52.preheader
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv65 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next66, %for.inc71 ]
  %exitcond71.not = icmp eq i64 %indvars.iv65, %wide.trip.count70
  br i1 %exitcond71.not, label %for.inc74, label %for.inc71
