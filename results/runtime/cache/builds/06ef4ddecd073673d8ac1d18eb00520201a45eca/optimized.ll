...
for.end68:                                        ; preds = %for.cond31
  ...
  %6 = load i32, ptr %arrayidx70, align 4, !tbaa !5
...
for.end114:                                       ; preds = %for.cond92
  %call = call noundef i32 @_Z3calPA120_ii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(488) %matrix, i32 noundef %sub72) #6
  %add116 = add nsw i32 %call, %6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %i) #5
  br label %return
...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z3calPA120_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(57600) %a, i32 noundef %3) #7
