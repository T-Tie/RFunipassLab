...
if.end19:                                         ; preds = %if.then11, %if.else14
  %4 = phi i32 [ %add, %if.then11 ], [ %.pr, %if.else14 ]
  %cmp20 = icmp eq i32 %4, 80
...
; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZStanSt12_Ios_IostateS_(i32 noundef %__a, i32 noundef %__b) #9 comdat {
entry:
  %and = and i32 %__a, %__b
  ret i32 %and
}
