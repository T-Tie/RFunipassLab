...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc8
  %indvars.iv18 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next19, %for.inc8 ]
...
for.inc8:                                         ; preds = %for.cond2
  ...
  %arrayidx7 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv18
  store i32 %call5, ptr %arrayidx7, align 4, !tbaa !5
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  br label %for.cond2, !llvm.loop !12

for.cond11:                                       ; preds = %for.cond2, %for.body13
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body13 ], [ 0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body13 ], [ 0, %for.cond2 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count
  br i1 %exitcond26.not, label %for.end21, label %for.body13

for.body13:                                       ; preds = %for.cond11
  %arrayidx15 = getelementptr inbounds nuw [25 x i32], ptr %b, i64 0, i64 %indvars.iv22
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv16 = phi i64 [ %idxprom7, %for.cond2.preheader ], [ %indvars.iv.next17, %for.inc13 ]
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, 1
  %cmp3 = icmp slt i64 %indvars.iv.next17, %0
  br i1 %cmp3, label %for.body4, label %for.cond20

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv.next17
...
if.then10:                                        ; preds = %for.body4
  ...
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next17
...
for.cond20:                                       ; preds = %for.cond2, %for.body22
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body22 ], [ %idxprom7, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ undef, %for.cond2 ]
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, 1
  %cmp21 = icmp slt i64 %indvars.iv.next20, %0
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv.next20
