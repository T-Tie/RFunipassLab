...
if.end:                                           ; preds = %for.end30, %if.else
  %M.0 = phi i32 [ %4, %if.else ], [ %2, %for.end30 ]
...
if.end35:                                         ; preds = %if.end, %if.else34
  %m.0 = phi i32 [ %5, %if.else34 ], [ %6, %if.end ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.end48, %if.end35
  %i.2 = phi i32 [ 0, %if.end35 ], [ %inc50, %for.end48 ]
  %cmp37 = icmp slt i32 %i.2, %M.0
...
for.cond39:                                       ; preds = %for.body41, %for.body38
  %j.2 = phi i32 [ 0, %for.body38 ], [ %inc47, %for.body41 ]
  %cmp40 = icmp slt i32 %j.2, %m.0
...
for.cond52:                                       ; preds = %for.end82, %for.end51
  %i.3 = phi i32 [ 0, %for.end51 ], [ %inc84, %for.end82 ]
  %cmp53 = icmp slt i32 %i.3, %M.0
  br i1 %cmp53, label %for.body54, label %for.end85

for.body54:                                       ; preds = %for.cond52
  br label %for.cond55

for.cond55:                                       ; preds = %for.end79, %for.body54
  %j.3 = phi i32 [ 0, %for.body54 ], [ %inc81, %for.end79 ]
  %cmp56 = icmp slt i32 %j.3, %m.0
  br i1 %cmp56, label %for.body57, label %for.end82

for.body57:                                       ; preds = %for.cond55
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body57
  %t.0 = phi i32 [ 0, %for.body57 ], [ %inc78, %for.body60 ]
...
for.cond86:                                       ; preds = %for.body88, %for.end85
  %i.4 = phi i32 [ 0, %for.end85 ], [ %inc92, %for.body88 ]
  %cmp87 = icmp slt i32 %i.4, %M.0
...
for.end93:                                        ; preds = %for.cond86
  ...
  store i32 %m.0, ptr %arrayidx95, align 4, !tbaa !5
  br label %for.cond96

for.cond96:                                       ; preds = %for.end114, %for.end93
  %i.5 = phi i32 [ 0, %for.end93 ], [ %inc116, %for.end114 ]
  %cmp97 = icmp slt i32 %i.5, %M.0
  br i1 %cmp97, label %for.body98, label %for.end117

for.body98:                                       ; preds = %for.cond96
  br label %for.cond99

for.cond99:                                       ; preds = %if.end111, %for.body98
  %j.4 = phi i32 [ 0, %for.body98 ], [ %inc113, %if.end111 ]
  %cmp100 = icmp slt i32 %j.4, %m.0
  br i1 %cmp100, label %for.body101, label %for.end114
...
for.body101:                                      ; preds = %for.cond99
  ...
  %10 = load i32, ptr %arrayidx105, align 4, !tbaa !5
...
for.cond118:                                      ; preds = %if.end197, %for.end117
  %i.6 = phi i32 [ 0, %for.end117 ], [ %inc199, %if.end197 ]
  %cmp119 = icmp slt i32 %i.6, %M.0
...
for.body120:                                      ; preds = %for.cond118
  ...
  %12 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %cmp123 = icmp ne i32 %12, %m.0
...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %13) #5
  br label %if.end136
...
for.cond137:                                      ; preds = %for.body142, %if.end136
  %j.5 = phi i32 [ 1, %if.end136 ], [ %inc149, %for.body142 ]
  %sub140 = sub nsw i32 %m.0, %12
  %cmp141 = icmp slt i32 %j.5, %sub140
  br i1 %cmp141, label %for.body142, label %if.end178
...
for.body142:                                      ; preds = %for.cond137
  ...
  %14 = load i32, ptr %arrayidx146, align 4, !tbaa !5
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %14) #5
...
if.else151:                                       ; preds = %for.body120
  ...
  %15 = load i32, ptr %arrayidx154, align 4, !tbaa !5
  %cmp155 = icmp ne i32 %15, %m.0
...
for.cond158:                                      ; preds = %for.body164, %if.then156
  %j.6 = phi i32 [ 1, %if.then156 ], [ %inc171, %for.body164 ]
  %sub162 = sub nsw i32 %m.0, %15
...
for.body164:                                      ; preds = %for.cond158
  ...
  %16 = load i32, ptr %arrayidx168, align 4, !tbaa !5
  %call169 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %16) #5
  %inc171 = add nsw i32 %j.6, 1
  br label %for.cond158, !llvm.loop !24

if.end178:                                        ; preds = %for.cond158, %for.cond137
  %sub179 = sub nsw i32 %M.0, 1
  %cmp180 = icmp ne i32 %i.6, %sub179
  br i1 %cmp180, label %land.lhs.true181, label %if.end197
...
land.lhs.true181:                                 ; preds = %if.end178
  ...
  %17 = load i32, ptr %arrayidx184, align 4, !tbaa !5
  %cmp185 = icmp ne i32 %17, %m.0
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  ...
  %18 = load i32, ptr %arrayidx193, align 4, !tbaa !5
  %cmp194 = icmp ne i32 %18, %m.0
...
if.end197:                                        ; preds = %if.then195, %land.lhs.true190, %if.end178
