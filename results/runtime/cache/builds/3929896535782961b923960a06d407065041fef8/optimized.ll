...
entry:
  ...
  %smax50 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc73 ], [ 1, %entry ]
  %exitcond52 = icmp eq i64 %indvars.iv45, %wide.trip.count51
  br i1 %exitcond52, label %for.end75, label %for.body

for.body:                                         ; preds = %for.cond
  %2 = add nsw i64 %indvars.iv45, -1
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select35, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext65 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext65, 32
  ...
  %spec.select35 = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  %invariant.gep = getelementptr i8, ptr %a, i64 -1
  %invariant.gep39 = getelementptr inbounds nuw i8, ptr %a, i64 1
  %add49 = add i64 %indvars.iv45, %call8
  %invariant.gep4.i = getelementptr i8, ptr %a, i64 -2
  %sext63 = shl i64 %add49, 32
  %7 = ashr exact i64 %sext63, 32
  %sext = shl i64 %call6, 32
  %8 = ashr exact i64 %sext, 32
  %gep = getelementptr i8, ptr %invariant.gep, i64 %8
  %cmp51 = icmp slt i32 %conv9, %conv12
  %9 = and i64 %indvars.iv45, 4294967295
  %gep40 = getelementptr i8, ptr %invariant.gep39, i64 %8
  %10 = sub i32 %conv12, %conv9
  %smax53 = call i32 @llvm.abs.i32(i32 %10, i1 false)
  %11 = add nuw i32 %smax53, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond54 = icmp eq i32 %j.1, %11
  br i1 %exitcond54, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv45, 4294967294
  %smax60 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %12 = add nuw i32 %smax60, 1
...
_Z5rightPcii.exit:                                ; preds = %for.cond.i2
  store i8 0, ptr %gep40, align 1, !tbaa !5
  br label %for.inc55
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc68
  %indvars.iv55 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next56, %for.inc68 ]
  %exitcond62 = icmp eq i64 %indvars.iv55, %wide.trip.count61
  br i1 %exitcond62, label %for.end75, label %for.inc68

for.inc68:                                        ; preds = %for.cond58
  %15 = add nsw i64 %indvars.iv55, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx63, align 1, !tbaa !5, !invariant.load !8
  %17 = add i64 %add64, %indvars.iv55
  %sext64 = shl i64 %17, 32
  %idxprom66 = ashr exact i64 %sext64, 32
