...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv2, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv2, %3
...
for.cond12:                                       ; preds = %for.inc26, %for.end9
  ...
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc26 ], [ 0, %for.end9 ]
  %18 = sext i32 %17 to i64
  %cmp13 = icmp slt i64 %indvars.iv8, %18
  br i1 %cmp13, label %for.cond15.preheader, label %for.end28

for.cond15.preheader:                             ; preds = %for.cond12
  %19 = mul nuw nsw i64 %indvars.iv8, %14
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %vla11, i64 %19
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %20 = phi i32 [ %16, %for.cond15.preheader ], [ %.pre44, %for.inc23 ]
  %indvars.iv5 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next6, %for.inc23 ]
  %21 = sext i32 %20 to i64
  %cmp16 = icmp slt i64 %indvars.iv5, %21
  br i1 %cmp16, label %for.inc23, label %for.inc26

for.inc23:                                        ; preds = %for.cond15
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %arrayidx19, i64 %indvars.iv5
  %call22 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %arrayidx21)
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %.pre44 = load i32, ptr %y2, align 4, !tbaa !5
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv11
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv32 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next33, %for.inc77 ]
  %exitcond36.not = icmp eq i64 %indvars.iv32, %wide.trip.count18
  br i1 %exitcond36.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %27 = mul nuw nsw i64 %indvars.iv32, %24
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %27
  %28 = mul nuw nsw i64 %indvars.iv32, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %28
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv27 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next28, %for.inc74 ]
  %exitcond31.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv27
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv27
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv20 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next21, %for.inc71 ]
  %exitcond26.not = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %29 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !17
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv20
  %30 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !17
  %31 = mul nuw nsw i64 %indvars.iv20, %14
...
for.cond80:                                       ; preds = %for.cond46, %for.inc99
  %33 = phi i32 [ %.pre43, %for.inc99 ], [ %22, %for.cond46 ]
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc99 ], [ 0, %for.cond46 ]
  %34 = sext i32 %33 to i64
  %cmp81 = icmp slt i64 %indvars.iv40, %34
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %35 = mul nuw nsw i64 %indvars.iv40, %24
...
for.cond87:                                       ; preds = %for.inc95, %for.body82
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc95 ], [ 1, %for.body82 ]
  %37 = load i32, ptr %y2, align 4, !tbaa !5
  %38 = sext i32 %37 to i64
  %cmp88 = icmp slt i64 %indvars.iv37, %38
  br i1 %cmp88, label %for.inc95, label %for.inc99

for.inc95:                                        ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx84, i64 %indvars.iv37
...
for.inc99:                                        ; preds = %for.cond87
  ...
  %.pre43 = load i32, ptr %x1, align 4, !tbaa !5
