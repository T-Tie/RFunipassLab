...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %sz) #5
...
for.cond1:                                        ; preds = %for.cond, %for.inc14
  ...
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc14 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %4) #6
  %5 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %3, i32 noundef %5) #6
  %sub = sub nsw i32 %call5, %call6
  %spec.select = call i32 @llvm.abs.i32(i32 %sub, i1 true)
  %rem3 = urem i32 %spec.select, 7
  %cmp9 = icmp eq i32 %rem3, 0
  br i1 %cmp9, label %if.then10, label %for.inc14

if.then10:                                        ; preds = %for.body3
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv6
...
for.cond17:                                       ; preds = %for.cond1, %for.body19
  %6 = phi i32 [ %.pre12, %for.body19 ], [ %1, %for.cond1 ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body19 ], [ 0, %for.cond1 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv9, %7
  br i1 %cmp18, label %for.body19, label %for.end29

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv9
  ...
  %puts4 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %.pre12 = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond17, !llvm.loop !14

for.end29:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %sz) #6
...
entry:
  ...
  %smax = call i32 @llvm.smax.i32(i32 %mon, i32 1)
  %1 = or i1 %cmp25, %or.cond
  %spec.select6 = select i1 %1, i32 29, i32 28
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  switch i32 %i.0, label %for.inc [
    i32 1, label %for.inc.gvnsink.split
    i32 3, label %for.inc.gvnsink.split
    i32 5, label %for.inc.gvnsink.split
    i32 7, label %for.inc.gvnsink.split
    i32 8, label %for.inc.gvnsink.split
    i32 10, label %for.inc.gvnsink.split
    i32 12, label %for.inc.gvnsink.split
    i32 4, label %for.inc.gvnsink.split.fold.split
    i32 6, label %for.inc.gvnsink.split.fold.split
    i32 9, label %for.inc.gvnsink.split.fold.split
    i32 11, label %for.inc.gvnsink.split.fold.split
...
for.inc.gvnsink.split.fold.split:                 ; preds = %for.body, %for.body, %for.body, %for.body
  br label %for.inc.gvnsink.split

for.inc.gvnsink.split:                            ; preds = %if.then24, %for.body, %for.body, %for.body, %for.body, %for.body, %for.body, %for.body, %for.inc.gvnsink.split.fold.split
  %.sink1 = phi i32 [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 30, %for.inc.gvnsink.split.fold.split ], [ %spec.select6, %if.then24 ]
  %add34 = add nsw i32 %.sink1, %result.0
  br label %for.inc

for.inc:                                          ; preds = %for.body, %for.inc.gvnsink.split
  %result.1 = phi i32 [ %add34, %for.inc.gvnsink.split ], [ %result.0, %for.body ]
