...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 160, ptr nonnull %sum) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(160) %sum, ptr noundef nonnull align 16 dereferenceable(160) @__const.main.sum, i64 160, i1 false)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %s.0 = phi i32 [ %mul, %for.body ], [ 1, %for.cond.preheader ]
...
for.cond6:                                        ; preds = %for.cond3, %for.body8
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body8 ], [ 0, %for.cond3 ]
  %exitcond.not = icmp eq i64 %indvars.iv, 39
  br i1 %exitcond.not, label %for.cond15, label %for.body8
...
for.cond15:                                       ; preds = %for.cond6, %for.body17
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.body17 ], [ 0, %for.cond6 ]
  %exitcond25.not = icmp eq i64 %indvars.iv22, 40
  br i1 %exitcond25.not, label %for.inc33, label %for.body17
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.body41
  %j.2 = phi i32 [ %dec46, %for.body41 ], [ %7, %for.cond39.preheader ]
  %cmp40 = icmp sgt i32 %j.2, -1
  br i1 %cmp40, label %for.body41, label %if.end
...
if.end:                                           ; preds = %for.cond39, %for.end
  call void @llvm.lifetime.end.p0(i64 160, ptr nonnull %sum) #5
