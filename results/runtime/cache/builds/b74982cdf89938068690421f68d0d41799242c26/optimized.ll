...
for.cond13:                                       ; preds = %for.cond10, %for.body15
  ...
  %l1.1 = phi i32 [ %spec.select20, %for.body15 ], [ %l1.0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %spec.select20 = select i1 %cmp20, i32 %6, i32 %l1.1
...
if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv30, i64 %idxprom40
  ...
  %spec.select22 = select i1 %cmp42, i32 %8, i32 %l2.1
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  ...
  %l2.3 = phi i32 [ 0, %if.end37.thread ], [ %spec.select22, %if.end37 ]
