...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc47
  %7 = phi i32 [ %0, %for.cond17.preheader ], [ %.pre, %for.inc47 ]
  ...
  %8 = sext i32 %7 to i64
  %cmp18 = icmp slt i64 %indvars.iv52, %8
...
if.then33:                                        ; preds = %land.lhs.true, %if.end
  ...
  %11 = load i64, ptr %gep, align 8, !tbaa !10, !invariant.load !9
