...
if.then:                                          ; preds = %lor.lhs.false, %land.lhs.true
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n1) #5
  store i32 0, ptr %n1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n2) #5
...
for.inc:                                          ; preds = %for.body9, %if.else, %lor.lhs.false13, %lor.lhs.false15, %lor.lhs.false17, %lor.lhs.false19, %lor.lhs.false21, %lor.lhs.false23, %if.else27
  %.sink2.sink = phi i32 [ 29, %for.body9 ], [ 30, %if.else27 ], [ 31, %lor.lhs.false23 ], [ 31, %lor.lhs.false21 ], [ 31, %lor.lhs.false19 ], [ 31, %lor.lhs.false17 ], [ 31, %lor.lhs.false15 ], [ 31, %lor.lhs.false13 ], [ 31, %if.else ]
  %3 = load i32, ptr %n1, align 4, !tbaa !5
  %add28 = add nsw i32 %3, %.sink2.sink
  store i32 %add28, ptr %n1, align 4, !tbaa !5
  %inc = add nsw i32 %.sink3, 1
  br label %for.cond7, !llvm.loop !9

if.end79:                                         ; preds = %for.cond7
  %4 = load i32, ptr %n1, align 4
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n2, i32 noundef 29, i32 %4, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %M)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %M) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %n2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %n1) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %j) #5
  br label %for.inc164

if.else80:                                        ; preds = %lor.lhs.false
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %j81) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n182) #5
  store i32 0, ptr %n182, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n283) #5
  store i32 0, ptr %n283, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %M84) #5
  store i32 0, ptr %M84, align 4, !tbaa !5
  br label %for.cond85

for.cond85:                                       ; preds = %for.inc109, %if.else80
  %.sink = phi i32 [ 1, %if.else80 ], [ %inc110, %for.inc109 ]
  store i32 %.sink, ptr %j81, align 4, !tbaa !5
  %5 = load i32, ptr %m1, align 4, !tbaa !5
  %cmp86 = icmp slt i32 %.sink, %5
...
for.inc109:                                       ; preds = %for.body87, %if.else91, %lor.lhs.false93, %lor.lhs.false95, %lor.lhs.false97, %lor.lhs.false99, %lor.lhs.false101, %if.else105
  ...
  %6 = load i32, ptr %n182, align 4, !tbaa !5
  %add106 = add nsw i32 %6, %.sink1.sink
...
if.end162:                                        ; preds = %for.cond85
  %7 = load i32, ptr %n182, align 4
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %j81, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n283, i32 noundef 28, i32 %7, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %M84)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %M84) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %n283) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %n182) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef captures(none) %j81) #5
  br label %for.inc164
...
for.inc56:                                        ; preds = %for.body32, %if.else36, %lor.lhs.false38, %lor.lhs.false40, %lor.lhs.false42, %lor.lhs.false44, %lor.lhs.false46, %lor.lhs.false48, %if.else52
  %.sink1.sink = phi i32 [ %3, %for.body32 ], [ 30, %if.else52 ], [ 31, %lor.lhs.false48 ], [ 31, %lor.lhs.false46 ], [ 31, %lor.lhs.false44 ], [ 31, %lor.lhs.false42 ], [ 31, %lor.lhs.false40 ], [ 31, %lor.lhs.false38 ], [ 31, %if.else36 ]
  %7 = load i32, ptr %2, align 4, !tbaa !5
  %add53 = add nsw i32 %7, %.sink1.sink
