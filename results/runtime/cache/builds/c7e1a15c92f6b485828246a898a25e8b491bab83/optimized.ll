; ModuleID = '<stdin>'
source_filename = "/tmp/tmp57u5njyf.cpp"
...
for.cond2:                                        ; preds = %for.cond2.loopexit, %for.cond2.preheader
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.cond2.loopexit ], [ 0, %for.cond2.preheader ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.cond2.loopexit ], [ 1, %for.cond2.preheader ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond27, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv42
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc21, %for.body4
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc21 ], [ %indvars.iv36, %for.body4 ]
...
for.body7:                                        ; preds = %for.cond5
  ...
  %arrayidx11 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv38
...
for.cond27:                                       ; preds = %for.cond2, %for.inc38
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc38 ], [ 0, %for.cond2 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count46
  br i1 %exitcond52.not, label %for.cond42.preheader, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv48
...
if.then33:                                        ; preds = %for.body29
  ...
  %.pre = and i64 %indvars.iv48, 4294967295
  br label %for.cond42.preheader

for.cond42.preheader:                             ; preds = %for.cond27, %if.then33
  %indvars.iv53.ph = phi i64 [ %.pre, %if.then33 ], [ %wide.trip.count46, %for.cond27 ]
  br label %for.cond42
...
for.cond42:                                       ; preds = %for.cond42.backedge, %for.cond42.preheader
  %indvars.iv53 = phi i64 [ %indvars.iv53.ph, %for.cond42.preheader ], [ %indvars.iv.next54, %for.cond42.backedge ]
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %9 = load i32, ptr %n, align 4, !tbaa !5
  %10 = sext i32 %9 to i64
  %cmp43 = icmp slt i64 %indvars.iv.next54, %10
  br i1 %cmp43, label %for.body44, label %for.end57

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next54
  %11 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %12 = and i32 %11, -2147483647
  %cmp48 = icmp eq i32 %12, 1
  br i1 %cmp48, label %if.then49, label %for.cond42.backedge

for.cond42.backedge:                              ; preds = %for.body44, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
...
if.then49:                                        ; preds = %for.body44
  ...
  %13 = load i64, ptr %gep, align 8, !tbaa !19
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call53 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, i32 noundef %14)
