...
entry:
  ...
  %call.i4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 8 dereferenceable(8) %b)
...
while.body:                                       ; preds = %while.cond
  %call.i5 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %a)
  %call.i6 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i5, ptr noundef nonnull align 8 dereferenceable(8) %b)
...
if.then:                                          ; preds = %while.body
  ...
  %.pre = load double, ptr %b, align 8, !tbaa !5
  %.pre31 = load double, ptr %a, align 8, !tbaa !5
  %.pre34 = fdiv double %.pre, %.pre31
  %.pre35 = fsub double %.pre34, %div
  br label %if.end

if.end:                                           ; preds = %if.then, %while.body
  %sub10.pre-phi = phi double [ %.pre35, %if.then ], [ %sub, %while.body ]
  %cmp11 = fcmp olt double %sub10.pre-phi, -5.000000e-02
  br i1 %cmp11, label %if.then12, label %if.end15

if.then12:                                        ; preds = %if.end
  %call1.i9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 5)
  ...
  %.pre32 = load double, ptr %b, align 8, !tbaa !5
  %.pre33 = load double, ptr %a, align 8, !tbaa !5
  %.pre36 = fdiv double %.pre32, %.pre33
  %.pre37 = fsub double %.pre36, %div
  br label %if.end15

if.end15:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi double [ %.pre37, %if.then12 ], [ %sub10.pre-phi, %if.end ]
  %5 = call double @llvm.fabs.f64(double %sub17.pre-phi)
  %or.cond = fcmp ugt double %5, 5.000000e-02
  br i1 %or.cond, label %if.end25, label %if.then22

if.then22:                                        ; preds = %if.end15
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 4)
