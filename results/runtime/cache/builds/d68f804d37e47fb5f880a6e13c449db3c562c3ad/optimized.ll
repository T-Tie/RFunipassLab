...
for.cond3:                                        ; preds = %if.end, %for.body
  %i.0 = phi i32 [ 0, %for.body ], [ %inc, %if.end ]
  %count.1 = phi i32 [ 0, %for.body ], [ %count.2, %if.end ]
...
if.then20:                                        ; preds = %for.cond.cleanup5
  %add21 = add nsw i32 %s.0, 1
  br label %for.inc23

if.end22:                                         ; preds = %for.cond.cleanup5
  ...
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv16, i32 noundef %count.1) #10
  br label %for.inc23
