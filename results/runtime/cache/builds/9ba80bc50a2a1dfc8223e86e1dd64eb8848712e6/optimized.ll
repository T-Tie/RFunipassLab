...
for.cond10:                                       ; preds = %if.end, %for.end9
  %i.1 = phi i32 [ 0, %for.end9 ], [ %inc21, %if.end ]
  %j.1 = phi i32 [ 0, %for.end9 ], [ %inc20, %if.end ]
...
for.body13:                                       ; preds = %for.cond10
  ...
  br i1 %cmp18, label %for.end22, label %if.end
...
for.end22:                                        ; preds = %for.cond10, %for.body13
  br label %for.cond23

for.cond23:                                       ; preds = %if.end32, %for.end22
  %j.2 = phi i32 [ %j.1, %for.end22 ], [ %inc34, %if.end32 ]
...
for.body25:                                       ; preds = %for.cond23
  ...
  br i1 %cmp30, label %for.end35, label %if.end32

if.end32:                                         ; preds = %for.body25
  %inc34 = add nsw i32 %j.2, 1
  br label %for.cond23, !llvm.loop !14

for.end35:                                        ; preds = %for.cond23, %for.body25
  br label %for.cond36

for.cond36:                                       ; preds = %if.end45, %for.end35
  %i.2 = phi i32 [ %i.1, %for.end35 ], [ %inc47, %if.end45 ]
...
for.body38:                                       ; preds = %for.cond36
  ...
  br i1 %cmp43, label %for.end48, label %if.end45

if.end45:                                         ; preds = %for.body38
  %inc47 = add nsw i32 %i.2, 1
  br label %for.cond36, !llvm.loop !15

for.end48:                                        ; preds = %for.cond36, %for.body38
  %sub = sub nsw i32 %j.2, %j.1
  %sub49 = sub nsw i32 %i.2, %i.1
