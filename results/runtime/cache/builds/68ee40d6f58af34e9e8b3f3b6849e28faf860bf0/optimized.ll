...
if.then8:                                         ; preds = %if.end
  ...
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %7) #13
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %8) #13
...
if.then30:                                        ; preds = %if.end28
  ...
  call void @outlined_ir_func_0() #13
...
if.end37:                                         ; preds = %if.then30, %if.end28
  %10 = load double, ptr @j, align 8, !tbaa !9
...
if.then39:                                        ; preds = %if.end37
  ...
  %mul46 = fmul double 4.000000e+00, %11
  %12 = load double, ptr @c, align 8, !tbaa !9
  %13 = load double, ptr @b, align 8, !tbaa !9
  %mul48 = fmul double %13, %13
  %neg49 = fneg double %mul48
  %14 = call double @llvm.fmuladd.f64(double %mul46, double %12, double %neg49)
  %call50 = call double @sqrt(double noundef %14) #12, !tbaa !5
  %mul51 = fmul double 2.000000e+00, %11
  %div52 = fdiv double %call50, %mul51
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div52) #13
  ...
  %mul61 = fmul double 4.000000e+00, %15
  %16 = load double, ptr @c, align 8, !tbaa !9
  %17 = load double, ptr @b, align 8, !tbaa !9
  %mul63 = fmul double %17, %17
  %neg64 = fneg double %mul63
  %18 = call double @llvm.fmuladd.f64(double %mul61, double %16, double %neg64)
  %call65 = call double @sqrt(double noundef %18) #12, !tbaa !5
  %fneg66 = fneg double %call65
  %mul67 = fmul double 2.000000e+00, %15
  %div68 = fdiv double %fneg66, %mul67
  %call69 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div68) #13
...
define internal void @outlined_ir_func_0() #11 {
newFuncRoot:
  br label %if.then30_to_outline

if.then30_to_outline:                             ; preds = %newFuncRoot
  ...
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div34) #15
  br label %if.then30_after_outline.exitStub

if.then30_after_outline.exitStub:                 ; preds = %if.then30_to_outline
  ret void
}
...
attributes #11 = { minsize mustprogress nofree norecurse nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
