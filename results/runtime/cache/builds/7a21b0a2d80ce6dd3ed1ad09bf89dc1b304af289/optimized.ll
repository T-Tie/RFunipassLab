...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv17 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next18, %for.inc24 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %for.inc24 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond27.preheader, label %for.cond5.preheader
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv23 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next24, %for.body29 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count
  br i1 %exitcond28.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv23, 0
  %spec.select = select i1 %cmp30, ptr @.str, ptr @.str.1
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv23
