...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.end47 ], [ %indvars.iv9, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, -1
  %cmp23 = icmp sgt i64 %indvars.iv11, 0
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next12
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc45 ], [ %idxprom2, %for.body24 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc45 ], [ %5, %for.body24 ]
  %p.1 = phi i32 [ %p.2, %for.inc45 ], [ %p.0, %for.body24 ]
  %cmp30.not = icmp slt i64 %indvars.iv6, %indvars.iv11
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %6 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv6
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv6
...
for.end47:                                        ; preds = %for.cond29
  ...
  %9 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next12
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select4 = call i32 @llvm.smax.i32(i32 %10, i32 %sum.2)
