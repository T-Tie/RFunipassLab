...
for.inc35:                                        ; preds = %if.then, %if.else31, %if.then28
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i20, align 8, !invariant.load !11
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !16, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !41, !invariant.load !11
  br label %return
