...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef align 16 %b) #9
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef align 16 %c) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x1) #9
  store i32 1, ptr %x1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %x2) #9
  store i32 1, ptr %x2, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %y1) #9
  store i32 1, ptr %y1, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %y2) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %r) #9
...
for.body62:                                       ; preds = %for.cond60
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j63) #10
...
for.body66:                                       ; preds = %for.cond64
  ...
  %call71 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %20)
...
for.inc78:                                        ; preds = %for.cond64
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j63) #10
...
for.end80:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %r) #10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %y2) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %y1) #10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef %c) #10
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef %a) #10
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  ...
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !22
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !23
  ret i32 %0
}
