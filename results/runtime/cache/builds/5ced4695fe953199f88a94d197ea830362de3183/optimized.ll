...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef %word) #4
...
if.then:                                          ; preds = %for.body
  %call4 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %word)
  %call6 = call i64 @strlen(ptr noundef %word) #5
...
if.else:                                          ; preds = %for.body
  ...
  %call12 = call i64 @strlen(ptr noundef %word) #5
  %add13 = add i64 %conv10, 1
...
if.else18:                                        ; preds = %if.else
  %call20 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, ptr noundef %word)
  %call23 = call i64 @strlen(ptr noundef %word) #5
  %add25 = add i64 %add13, %call23
