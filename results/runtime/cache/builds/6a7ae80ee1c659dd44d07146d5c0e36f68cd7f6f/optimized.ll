...
for.cond1:                                        ; preds = %if.end13, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc15, %if.end13 ]
...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %2, i32 noundef %3) #5
  %4 = load i32, ptr %year, align 4, !tbaa !5
  %5 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef range(i32 -2147483647, -2147483648) i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %5) #5
...
for.cond17:                                       ; preds = %if.end26, %for.end16
  %i.2 = phi i32 [ 0, %for.end16 ], [ %inc28, %if.end26 ]
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %cmp18 = icmp slt i32 %i.2, %6
...
if.end37:                                         ; preds = %if.then20, %if.then31, %if.else33, %if.else22, %if.then
  %result.1 = phi i32 [ %add, %if.then ], [ %add21, %if.then20 ], [ %result.0, %if.else22 ], [ %add32, %if.then31 ], [ %add34, %if.else33 ]
  %inc = add nsw i32 %i.0, 1
