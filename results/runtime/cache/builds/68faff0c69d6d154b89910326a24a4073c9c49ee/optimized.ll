...
if.end67:                                         ; preds = %if.end, %if.then58
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %d.0, double noundef %div74, double noundef %d.0, double noundef %div74)
  br label %for.inc
