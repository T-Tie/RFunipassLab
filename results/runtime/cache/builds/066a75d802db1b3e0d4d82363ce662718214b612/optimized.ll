...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %11, i32 0)
  %15 = sext i32 %13 to i64
  %smax27 = call i32 @llvm.smax.i32(i32 %10, i32 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %16 = mul nsw i64 %indvars.iv22, %14
  %17 = mul nsw i64 %indvars.iv22, %15
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %18, i64 %indvars.iv15
  store i32 0, ptr %arrayidx46, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv15
  br label %for.cond47
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %25 = phi i32 [ %.pre30, %for.inc95 ], [ %23, %for.cond77 ]
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %28 = phi i32 [ %.pre31, %if.then ], [ %27, %for.body82 ]
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre30 = phi i32 [ %28, %if.end ], [ %.pre30.pre, %if.then92 ]
