...
for.cond3:                                        ; preds = %for.body5, %for.cond3.preheader
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body5 ], [ 0, %for.cond3.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %idxprom6
  br i1 %exitcond.not, label %for.end24, label %for.body5

for.body5:                                        ; preds = %for.cond3
  %arrayidx9 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv19
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc19
  %indvars.iv22 = phi i64 [ %idxprom6, %for.cond11.preheader ], [ %indvars.iv.next23, %for.inc19 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond11
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %arrayidx16 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv.next23
  %8 = load i32, ptr %arrayidx16, align 4, !tbaa !5, !invariant.load !13
  %arrayidx18 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv22
...
for.cond29:                                       ; preds = %while.cond, %for.inc37
  ...
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc37 ], [ 0, %while.cond ]
  %sub30 = add nsw i32 %10, -1
  %11 = sext i32 %sub30 to i64
  %cmp31 = icmp slt i64 %indvars.iv27, %11
  br i1 %cmp31, label %for.inc37, label %for.end39

for.inc37:                                        ; preds = %for.cond29
  %arrayidx34 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv27
...
for.end39:                                        ; preds = %for.cond29
  ...
  %vtable.i = load ptr, ptr %call43, align 8, !tbaa !17
  ...
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call43, i8 noundef signext %call.i13)
