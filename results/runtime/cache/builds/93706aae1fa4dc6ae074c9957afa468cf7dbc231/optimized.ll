...
for.end58:                                        ; preds = %for.cond10
  ...
  %reass.sub = add i32 %x1.0.neg, 1
  %add60 = add i32 %reass.sub, %x2.0
  %sub61 = sub nsw i32 %y2.0, %y1.0
  %mul6539 = add i32 %sub61, -1
  %sub66 = mul i32 %mul6539, %add60
  %18 = shl i32 %sub61, 1
  %.neg = sub i32 0, %18
  %reass.sub40 = add i32 %.neg, 2
  %add71 = add i32 %reass.sub40, %sub66
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !18, !invariant.load !14
