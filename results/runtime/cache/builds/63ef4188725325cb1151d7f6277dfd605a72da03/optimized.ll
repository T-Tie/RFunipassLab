...
for.cond33:                                       ; preds = %for.inc44, %for.body31
  %3 = phi i32 [ %dec, %for.inc44 ], [ %sub, %for.body31 ]
  %cmp34 = icmp sge i32 %3, 0
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idx.ext39 = sext i32 %3 to i64
  %add.ptr40 = getelementptr inbounds i32, ptr %add.ptr38, i64 %idx.ext39
  %4 = load i32, ptr %add.ptr40, align 4, !tbaa !5
  %cmp41 = icmp eq i32 %4, 0
...
for.inc46:                                        ; preds = %for.body35, %for.cond33
  ...
  %c2.1 = phi i32 [ %c2.0, %for.cond33 ], [ %3, %for.body35 ]
