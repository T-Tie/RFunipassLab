...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %3 = phi i32 [ %sub15, %while.body13 ], [ %.pr2, %while.end7 ]
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %5 = phi i32 [ %sub24, %while.body22 ], [ %.pr3, %while.end16 ]
...
while.cond26:                                     ; preds = %while.body31, %while.end25
  ...
  %7 = phi i32 [ %sub33, %while.body31 ], [ %.pr4, %while.end25 ]
...
while.body40:                                     ; preds = %land.end39
  store i32 %.pr5, ptr %f, align 4, !tbaa !5
...
while.end41:                                      ; preds = %while.cond35, %while.body40, %land.end39
  ...
  %14 = load i32, ptr %f, align 4, !tbaa !5
  %call42 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %9, i32 noundef %10, i32 noundef %11, i32 noundef %12, i32 noundef %13, i32 noundef %14)
