...
entry:
  ...
  %call = tail call i64 @strlen(ptr nofree noundef nonnull readonly dereferenceable(1) %word) #8
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !29, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !30, !invariant.load !8
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !38, !invariant.load !8
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !44, !invariant.load !8
...
!29 = !{!10, !13, i64 32}
!30 = !{!31, !35, i64 240}
!31 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !10, i64 0, !32, i64 216, !6, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
