...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax38 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count39 = zext nneg i32 %smax38 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv29
...
if.then9:                                         ; preds = %if.end
  ...
  %conv.neg = sub i32 0, %conv
  %6 = sext i32 %sub19 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv26, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, 1
  %7 = trunc nsw i64 %indvars.iv26 to i32
  %invariant.op = add i32 %5, %conv.neg
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv26
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv33 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next34, %for.inc44 ]
  %exitcond40.not = icmp eq i64 %indvars.iv33, %wide.trip.count39
  br i1 %exitcond40.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv33, %2
  ...
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv33
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next34 = add nuw nsw i64 %indvars.iv33, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond45.not = icmp eq i64 %indvars.iv41, %wide.trip.count
  br i1 %exitcond45.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv41
