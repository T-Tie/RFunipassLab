...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 240, ptr noundef nonnull %s) #3
...
for.cond4:                                        ; preds = %for.inc, %for.body
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc ], [ %indvars.iv, %for.body ]
  %indvars.iv.next16 = add nsw i64 %indvars.iv15, -1
  %cmp5 = icmp sgt i64 %indvars.iv15, 0
  br i1 %cmp5, label %for.body7, label %for.end

for.body7:                                        ; preds = %for.cond4
  %arrayidx9 = getelementptr inbounds nuw [60 x i32], ptr %s, i64 0, i64 %indvars.iv.next16
...
if.then:                                          ; preds = %for.body7
  %5 = add nuw nsw i64 %indvars.iv15, 29
...
if.then20:                                        ; preds = %if.then
  %add24 = add nuw nsw i32 %6, 1
  store i32 %add24, ptr %arrayidx3, align 4, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.body7, %if.then20, %if.then
...
for.end39:                                        ; preds = %for.cond
  %call40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 1)
  call void @llvm.lifetime.end.p0(i64 noundef 240, ptr noundef nonnull %s) #4
