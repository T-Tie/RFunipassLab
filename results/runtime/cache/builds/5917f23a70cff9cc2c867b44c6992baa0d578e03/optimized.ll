...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax71 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %wide.trip.count56 = zext nneg i32 %smax71 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %wide.trip.count56
  br i1 %exitcond57.not, label %for.cond27, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv53
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc21 ], [ 0, %for.cond14.preheader ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count
  br i1 %exitcond52.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv53, i64 %indvars.iv48
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc60 ], [ 0, %for.cond ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %wide.trip.count56
  br i1 %exitcond73.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv68
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !14
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select46, %for.body34 ], [ %3, %for.body29 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count
  br i1 %exitcond62.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv58, i64 %indvars.iv68
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !14
  %spec.select46 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  br label %for.cond32, !llvm.loop !18

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc57 ], [ 0, %for.cond49.preheader ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond67.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv63, i64 %indvars.iv68
...
for.cond65.preheader:                             ; preds = %for.end62
  %smax95 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 2)
  %wide.trip.count84 = zext nneg i32 %smax95 to i64
  br label %for.cond65

for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv79 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next80, %for.inc83 ]
  %exitcond85.not = icmp eq i64 %indvars.iv79, %wide.trip.count84
  br i1 %exitcond85.not, label %for.cond86, label %for.cond68.preheader
...
for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv74 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next75, %for.inc80 ]
  %exitcond78.not = icmp eq i64 %indvars.iv74, %wide.trip.count
  br i1 %exitcond78.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv79, i64 %indvars.iv74
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !14
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv74
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc104 ], [ 2, %for.cond65 ]
  %exitcond97.not = icmp eq i64 %indvars.iv91, %wide.trip.count84
  br i1 %exitcond97.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv91, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv86 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next87, %for.inc101 ]
  %exitcond90.not = icmp eq i64 %indvars.iv86, %wide.trip.count
  br i1 %exitcond90.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv86, i64 %indvars.iv91
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5, !invariant.load !14
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv86, i64 %9
