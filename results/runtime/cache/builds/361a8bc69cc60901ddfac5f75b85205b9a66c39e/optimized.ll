...
for.cond1:                                        ; preds = %for.cond, %for.inc14
  ...
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc14 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %rem14 = urem i32 %spec.select, 7
  %cmp9 = icmp eq i32 %rem14, 0
  br i1 %cmp9, label %if.then10, label %for.inc14

if.then10:                                        ; preds = %for.body3
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv17
...
for.cond17:                                       ; preds = %for.cond1, %for.body19
  %6 = phi i32 [ %.pre23, %for.body19 ], [ %1, %for.cond1 ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body19 ], [ 0, %for.cond1 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv20, %7
  br i1 %cmp18, label %for.body19, label %for.end29

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv20
  ...
  %puts15 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #7
