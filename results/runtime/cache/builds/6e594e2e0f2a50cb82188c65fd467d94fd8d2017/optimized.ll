...
while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %while.body ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv5
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %3 = trunc nuw nsw i64 %indvars.iv5 to i32
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc35
  %indvars.iv17 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next18, %for.inc35 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond22.not, label %for.end37, label %for.cond18

for.cond18:                                       ; preds = %for.cond15, %for.body20
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body20 ], [ 0, %for.cond15 ]
  %sum.0 = phi i32 [ %add, %for.body20 ], [ 0, %for.cond15 ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.end28, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100000 x i32], ptr %b, i64 0, i64 %indvars.iv11
  %4 = load i32, ptr %arrayidx22, align 4, !tbaa !11
  %5 = zext i32 %4 to i64
  %cmp23.not = icmp eq i64 %indvars.iv17, %5
...
if.then30:                                        ; preds = %for.end28
  %arrayidx32 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv17
