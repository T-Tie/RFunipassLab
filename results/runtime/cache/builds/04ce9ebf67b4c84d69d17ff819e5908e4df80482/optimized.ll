...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %.sink5 = phi i32 [ 1, %for.end29 ], [ %inc49, %for.inc48 ]
  store i32 %.sink5, ptr %i, align 4, !tbaa !5
  %cmp31 = icmp sle i32 %.sink5, 12
...
for.inc45:                                        ; preds = %for.cond33
  ...
  %idxprom39 = sext i32 %.sink5 to i64
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %.sink6 = phi i32 [ 1, %for.end50 ], [ %inc80, %for.inc79 ]
  store i32 %.sink6, ptr %i, align 4, !tbaa !5
  %cmp52 = icmp sle i32 %.sink6, 12
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  %k.1 = phi i32 [ %.sink6, %for.body57 ], [ %inc66, %for.inc65 ]
...
if.then70:                                        ; preds = %for.end67
  %idxprom71 = sext i32 %.sink6 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %.sink8 = phi i32 [ 1, %for.end91 ], [ %inc111, %for.inc110 ]
  store i32 %.sink8, ptr %i, align 4, !tbaa !5
  %cmp93 = icmp sle i32 %.sink8, 12
...
for.inc107:                                       ; preds = %for.cond95
  ...
  %idxprom101 = sext i32 %.sink8 to i64
...
for.body115:                                      ; preds = %for.cond113
  ...
  %call117 = call noundef i32 @_Z6is_runi(i32 noundef %10) #7
