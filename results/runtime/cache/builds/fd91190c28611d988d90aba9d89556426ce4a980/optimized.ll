...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !16, !invariant.load !13
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !18, !invariant.load !13
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !36, !invariant.load !13
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !42, !invariant.load !13
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !16, !invariant.load !13
