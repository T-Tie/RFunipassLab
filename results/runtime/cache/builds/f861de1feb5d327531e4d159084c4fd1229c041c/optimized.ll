...
for.end32:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #8
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %x1, ptr noundef nonnull align 4 dereferenceable(4) %y1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %a)
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %x2, ptr noundef nonnull align 4 dereferenceable(4) %y2, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %b)
  ...
  %smax19 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  %7 = sext i32 %4 to i64
...
for.cond40.preheader:                             ; preds = %for.cond37
  %8 = mul nsw i64 %indvars.iv22, %6
  %9 = mul nsw i64 %indvars.iv22, %7
  %invariant.gep34 = getelementptr i32, ptr %call36, i64 %8
...
for.body42:                                       ; preds = %for.cond40
  %gep35 = getelementptr i32, ptr %invariant.gep34, i64 %indvars.iv15
  store i32 0, ptr %gep35, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %5, i64 %indvars.iv15
  br label %for.cond47
...
for.inc68:                                        ; preds = %for.cond47
  ...
  store i32 %add63, ptr %gep35, align 4, !tbaa !5
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  ...
  %cmp78 = icmp slt i32 %storemerge4, %16
  br i1 %cmp78, label %for.cond80, label %for.end100

for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %17 = phi i32 [ %.pre30, %for.inc95 ], [ %15, %for.cond77 ]
  %storemerge5 = phi i32 [ %inc96, %for.inc95 ], [ 0, %for.cond77 ]
  %cmp81 = icmp slt i32 %storemerge5, %17
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %17, %storemerge4
  %add84 = add nsw i32 %mul83, %storemerge5
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %18 = load i32, ptr %arrayidx86, align 4, !tbaa !5, !invariant.load !9
  %call87 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %18) #10
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %2) unnamed_addr #5 {
entry_to_outline:
...
for.cond:                                         ; preds = %for.inc8, %entry_to_outline
  %5 = phi i32 [ %4, %entry_to_outline ], [ %7, %for.inc8 ]
  %6 = phi i32 [ %3, %entry_to_outline ], [ %.pre, %for.inc8 ]
...
for.cond3:                                        ; preds = %for.cond, %for.inc
  %7 = phi i32 [ %.pre3, %for.inc ], [ %5, %for.cond ]
  %storemerge2 = phi i32 [ %inc, %for.inc ], [ 0, %for.cond ]
  %cmp4 = icmp slt i32 %storemerge2, %7
  br i1 %cmp4, label %for.inc, label %for.inc8

for.inc:                                          ; preds = %for.cond3
  %mul6 = mul nsw i32 %7, %storemerge
  %add = add nsw i32 %mul6, %storemerge2
  ...
  %.pre3 = load i32, ptr %1, align 4, !tbaa !5
