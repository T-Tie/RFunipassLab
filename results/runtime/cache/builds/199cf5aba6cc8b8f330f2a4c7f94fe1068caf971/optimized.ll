...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %s) #6
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %t) #6
...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv30 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next31, %if.end ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv30
...
for.cond19.preheader:                             ; preds = %for.end15
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.end46
  %indvars.iv37 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next38, %for.end46 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc.i3, %for.end46 ]
  %exitcond43.not = icmp eq i32 %i.2, %smax42
  br i1 %exitcond43.not, label %for.end49, label %for.cond22.preheader
...
for.cond22:                                       ; preds = %for.cond22.preheader, %if.end43
  %indvars.iv34 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next35, %if.end43 ]
  %exitcond41.not = icmp eq i64 %indvars.iv34, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end46, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv34
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !9
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next35
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax48 = call i32 @llvm.smax.i32(i32 %len.0, i32 1)
  %wide.trip.count49 = zext nneg i32 %smax48 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.body54, %for.end49
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body54 ], [ 1, %for.end49 ]
  %exitcond50.not = icmp eq i64 %indvars.iv44, %wide.trip.count49
  br i1 %exitcond50.not, label %cleanup, label %for.body54
...
for.body54:                                       ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv44
...
cleanup:                                          ; preds = %for.cond52, %for.end15
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %t) #7
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %s) #7
