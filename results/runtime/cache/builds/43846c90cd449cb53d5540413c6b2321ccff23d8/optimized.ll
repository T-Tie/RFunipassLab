...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc19
  %indvars.iv14 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next15, %for.inc19 ]
  %exitcond.not = icmp eq i64 %indvars.iv14, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body13

for.body13:                                       ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv14
...
for.body13.for.end22_crit_edge:                   ; preds = %for.body13
  ...
  %.pre31 = and i64 %indvars.iv14, 4294967295
  br label %for.end22
...
for.end22:                                        ; preds = %for.cond10, %for.body13.for.end22_crit_edge
  ...
  %smax21 = call i32 @llvm.smax.i32(i32 %j.1.lcssa, i32 %0)
  %wide.trip.count23 = zext i32 %smax21 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc33, %for.end22
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc33 ], [ %idxprom26.pre-phi, %for.end22 ]
  %exitcond24.not = icmp eq i64 %indvars.iv18, %wide.trip.count23
  br i1 %exitcond24.not, label %for.end35, label %for.body25

for.body25:                                       ; preds = %for.cond23
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom26.pre-phi, i64 %indvars.iv18
...
for.end35:                                        ; preds = %for.cond23, %for.end35.split.loop.exit
  %j.2.lcssa = phi i32 [ %7, %for.end35.split.loop.exit ], [ %smax21, %for.cond23 ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc46, %for.end35
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc46 ], [ %idxprom26.pre-phi, %for.end35 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count23
  br i1 %exitcond29.not, label %for.end48, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %idxprom26.pre-phi
...
for.end48:                                        ; preds = %for.cond36, %for.end48.split.loop.exit
  %i.2.lcssa = phi i32 [ %9, %for.end48.split.loop.exit ], [ %smax21, %for.cond36 ]
  %sub = sub nuw i32 -2, %j.1.lcssa
