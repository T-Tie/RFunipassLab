...
for.end:                                          ; preds = %for.cond
  ...
  %smax30 = call i32 @llvm.smax.i32(i32 %0, i32 1)
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %if.end25, %for.end
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %if.end25 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %if.end25 ], [ 1, %for.end ]
...
for.end17:                                        ; preds = %for.cond7
  ...
  br i1 %cmp18.not.not, label %if.then19, label %if.end25
...
for.cond29:                                       ; preds = %for.cond29.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv33 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next34, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
...
for.end38:                                        ; preds = %for.cond29
  ...
  %call1.i21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call42, i8 noundef signext %call.i20)
