...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.cond.loopexit ], [ 2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond.loopexit ], [ 1, %entry ]
  %exitcond25.not = icmp eq i64 %indvars.iv19, 14
  br i1 %exitcond25.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc14 ], [ %indvars.iv19, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv21, 13
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not.not = icmp samesign ult i64 %indvars.iv16, %indvars.iv21
  br i1 %cmp6.not.not, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv16
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv21
...
for.cond51:                                       ; preds = %for.cond30, %for.cond51.loopexit
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.cond51.loopexit ], [ 2, %for.cond30 ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.cond51.loopexit ], [ 1, %for.cond30 ]
  %exitcond50.not = icmp eq i64 %indvars.iv43, 14
  br i1 %exitcond50.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc76 ], [ %indvars.iv43, %for.cond51 ]
  %exitcond48.not = icmp eq i64 %indvars.iv45, 13
  br i1 %exitcond48.not, label %for.cond51.loopexit, label %for.cond58
...
for.cond58:                                       ; preds = %for.cond55, %for.inc65
  ...
  %cmp60.not.not = icmp samesign ult i64 %indvars.iv40, %indvars.iv45
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv38, i64 %indvars.iv45
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond54.not = icmp eq i64 %indvars.iv51, 13
  br i1 %exitcond54.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv51, i64 %indvars.iv51
  store i32 1, ptr %arrayidx88, align 4, !tbaa !8
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  br label %for.cond82, !llvm.loop !20

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond62.not = icmp eq i64 %indvars.iv59, 13
  br i1 %exitcond62.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond58.not = icmp eq i64 %indvars.iv55, %indvars.iv59
  br i1 %exitcond58.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv55, i64 %indvars.iv59
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !8
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv59, i64 %indvars.iv55
...
for.body115:                                      ; preds = %for.cond113
  ...
  %spec.select15 = select i1 %cmp134, ptr @.str.2, ptr @.str.3
  %call138 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select15)
