...
for.end58:                                        ; preds = %for.cond10
  ...
  %y1.0.lcssa = phi i32 [ %y1.0, %for.cond10 ]
  %x1.0.lcssa = phi i32 [ %x1.0, %for.cond10 ]
  %y2.0.lcssa = phi i32 [ %y2.0, %for.cond10 ]
  %sub59 = sub nsw i32 %x2.0.lcssa, %x1.0.lcssa
  %add60 = add nsw i32 %sub59, 1
  %sub61 = sub nsw i32 %y2.0.lcssa, %y1.0.lcssa
  %add62 = add nsw i32 %sub61, 1
  %mul65.neg = mul i32 %add60, -2
  %reass.add = add i32 %add60, -2
  %reass.mul = mul i32 %reass.add, %add62
