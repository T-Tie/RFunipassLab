...
for.cond:                                         ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit, %entry
  ...
  br i1 %cmp, label %if.then6.i, label %for.end76
...
for.end76:                                        ; preds = %for.cond
  %arrayidx81 = getelementptr inbounds i8, ptr %newword, i64 -1
  store i8 0, ptr %arrayidx81, align 1, !tbaa !23
  store i8 0, ptr %newword, align 16, !tbaa !23
  %call92 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %newword) #12
  %3 = and i64 %call92, 4294967295
  %cmp98.le = icmp eq i64 %3, 1
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.end76
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 0)
  br i1 %cmp98.le, label %if.then99, label %if.end112

if.then99:                                        ; preds = %for.cond94
...
if.end112:                                        ; preds = %for.cond94, %if.then99
  br label %for.cond94
}
