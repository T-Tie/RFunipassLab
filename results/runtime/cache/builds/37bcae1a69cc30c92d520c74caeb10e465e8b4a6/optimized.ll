...
for.cond6:                                        ; preds = %for.inc12, %for.body5
  %1 = phi i32 [ %inc13, %for.inc12 ], [ 0, %for.body5 ]
  %cmp7 = icmp slt i32 %1, 39
...
for.cond15:                                       ; preds = %for.inc30, %for.end14
  %3 = phi i32 [ %add, %for.inc30 ], [ 0, %for.end14 ]
  %cmp16 = icmp sle i32 %3, 39
...
for.cond39:                                       ; preds = %for.inc45, %while.end
  %7 = phi i32 [ %dec46, %for.inc45 ], [ %i.2, %while.end ]
  %cmp40 = icmp sge i32 %7, 0
...
if.end:                                           ; preds = %for.cond39, %for.end
  call void @llvm.lifetime.end.p0(i64 noundef 160, ptr noundef %sum) #6
