...
entry:
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax34, 1
...
for.cond:                                         ; preds = %for.inc17, %entry
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc17 ], [ 0, %entry ]
  %exitcond36 = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %smax45 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  %wide.trip.count46 = zext nneg i32 %smax45 to i64
  %wide.trip.count42 = zext i32 %sub to i64
  br label %for.cond21
...
for.inc:                                          ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv31, i64 %indvars.iv
  store i8 %3, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc17:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv31, i64 %wide.trip.count
  store i8 0, ptr %arrayidx16, align 1, !tbaa !9
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  br label %for.cond, !llvm.loop !13

for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc47
  %indvars.iv37 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next38, %for.inc47 ]
  %exitcond47.not = icmp eq i64 %indvars.iv37, %wide.trip.count46
  br i1 %exitcond47.not, label %for.cond51, label %for.cond28.preheader

for.cond28.preheader:                             ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv37
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv37
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc44
  %indvars.iv39 = phi i64 [ %indvars.iv37, %for.cond28.preheader ], [ %indvars.iv.next40, %for.inc44 ]
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond43.not = icmp eq i64 %indvars.iv39, %wide.trip.count42
  br i1 %exitcond43.not, label %for.inc47, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next40
...
for.cond51:                                       ; preds = %for.cond21, %for.body55
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.body55 ], [ 0, %for.cond21 ]
  %max.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond21 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %wide.trip.count46
  br i1 %exitcond52.not, label %for.end65, label %for.body55

for.body55:                                       ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv48
...
if.else:                                          ; preds = %for.end65
  ...
  %call1.i19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call70, i8 noundef signext %call.i18)
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc88 ], [ 0, %if.else ]
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %sub74 = sub nsw i32 %conv, %6
  %7 = sext i32 %sub74 to i64
  %cmp75 = icmp slt i64 %indvars.iv53, %7
  br i1 %cmp75, label %for.body77, label %if.end91

for.body77:                                       ; preds = %for.cond73
  %arrayidx79 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv53
  %8 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %cmp80 = icmp eq i32 %8, %max.0
  br i1 %cmp80, label %if.then81, label %for.inc88

if.then81:                                        ; preds = %for.body77
  %arrayidx83 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv53
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx83) #10
  %call1.i16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx83, i64 noundef %call.i.i15)
  %vtable.i21 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !17
  %vbase.offset.ptr.i22 = getelementptr i8, ptr %vtable.i21, i64 -24
  %vbase.offset.i23 = load i64, ptr %vbase.offset.ptr.i22, align 8, !invariant.load !19
  %add.ptr.i24 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i23
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i24, i8 noundef signext 10)
  %call1.i25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
