...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax43 = tail call i32 @llvm.smax.i32(i32 %t.tr, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond14.not, label %for.cond28, label %for.cond1
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc22 ], [ 0, %for.cond11.preheader ]
...
for.cond28:                                       ; preds = %for.cond, %for.inc63
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc63 ], [ 0, %for.cond ]
...
for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc60 ], [ 0, %for.cond48.preheader ]
