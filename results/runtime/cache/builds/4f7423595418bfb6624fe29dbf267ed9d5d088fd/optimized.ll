...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond94.not98 = and i1 %cmp2, %cmp4.not
  %rem5 = srem i32 %1, 400
  %cmp6 = icmp eq i32 %rem5, 0
  %or.cond95 = or i1 %cmp6, %or.cond94.not98
  %3 = load i32, ptr %m1, align 4, !tbaa !5
  %smax101 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br i1 %or.cond95, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %j.0 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %n1.0 = phi i32 [ %add, %for.inc ], [ 0, %for.body ]
  %exitcond102.not = icmp eq i32 %j.0, %smax101
  br i1 %exitcond102.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %4 = load i32, ptr %m2, align 4, !tbaa !5
  %smax103 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  br label %for.cond30

for.body9:                                        ; preds = %for.cond7
  switch i32 %j.0, label %switch.early.test [
    i32 2, label %for.inc
    i32 12, label %if.then25
  ]

switch.early.test:                                ; preds = %for.body9
  %5 = and i32 %j.0, 2147483645
...
if.then25:                                        ; preds = %for.body9, %switch.early.test, %switch.early.test, %switch.early.test
  br label %for.inc

for.inc:                                          ; preds = %switch.early.test, %for.body9, %if.then25
  %.sink = phi i32 [ 31, %if.then25 ], [ 29, %for.body9 ], [ 30, %switch.early.test ]
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %exitcond104.not = icmp eq i32 %j.1, %smax103
  br i1 %exitcond104.not, label %for.end58, label %for.body32

for.body32:                                       ; preds = %for.cond30
  switch i32 %j.1, label %switch.early.test96 [
    i32 2, label %for.inc56
    i32 12, label %if.then50
  ]

switch.early.test96:                              ; preds = %for.body32
  %6 = and i32 %j.1, 2147483645
  switch i32 %6, label %for.inc56 [
    i32 8, label %if.then50
    i32 5, label %if.then50
    i32 1, label %if.then50
  ]

if.then50:                                        ; preds = %for.body32, %switch.early.test96, %switch.early.test96, %switch.early.test96
  br label %for.inc56

for.inc56:                                        ; preds = %switch.early.test96, %for.body32, %if.then50
  %.sink105 = phi i32 [ 31, %if.then50 ], [ 29, %for.body32 ], [ 30, %switch.early.test96 ]
  %add35 = add nuw nsw i32 %n2.0, %.sink105
...
if.then60:                                        ; preds = %for.end58
  ...
  %str.5.str.4 = select i1 %cmp62, ptr @str.7, ptr @str.6
  %puts91 = call i32 @puts(ptr nonnull dereferenceable(1) %str.5.str.4)
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %j81.0, %smax101
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax99 = call i32 @llvm.smax.i32(i32 %7, i32 1)
...
if.else91:                                        ; preds = %for.body87
  %8 = and i32 %j81.0, 2147483645
  switch i32 %8, label %if.else105 [
    i32 8, label %for.inc109
    i32 5, label %for.inc109
    i32 1, label %for.inc109
  ]

if.else105:                                       ; preds = %if.else91
  br label %for.inc109

for.inc109:                                       ; preds = %if.else91, %if.else91, %if.else91, %for.body87, %if.else105
  %.sink106 = phi i32 [ 30, %if.else105 ], [ 28, %for.body87 ], [ 31, %if.else91 ], [ 31, %if.else91 ], [ 31, %if.else91 ]
  %add90 = add nuw nsw i32 %n182.0, %.sink106
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %exitcond100.not = icmp eq i32 %j81.1, %smax99
  br i1 %exitcond100.not, label %for.end140, label %for.body114

for.body114:                                      ; preds = %for.cond112
  switch i32 %j81.1, label %switch.early.test97 [
    i32 2, label %for.inc138
    i32 12, label %if.then132
  ]

switch.early.test97:                              ; preds = %for.body114
  %9 = and i32 %j81.1, 2147483645
  switch i32 %9, label %for.inc138 [
    i32 8, label %if.then132
    i32 5, label %if.then132
    i32 1, label %if.then132
  ]

if.then132:                                       ; preds = %for.body114, %switch.early.test97, %switch.early.test97, %switch.early.test97
  br label %for.inc138

for.inc138:                                       ; preds = %switch.early.test97, %for.body114, %if.then132
  %.sink107 = phi i32 [ 31, %if.then132 ], [ 28, %for.body114 ], [ 30, %switch.early.test97 ]
  %add117 = add nuw nsw i32 %n283.0, %.sink107
...
if.then142:                                       ; preds = %for.end140
  ...
  %str.1.str = select i1 %cmp145, ptr @str.7, ptr @str.6
  %puts87 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
  br label %if.end151
