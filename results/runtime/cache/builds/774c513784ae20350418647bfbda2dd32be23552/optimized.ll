...
for.body53:                                       ; preds = %for.cond51
  ...
  %16 = load i32, ptr %15, align 4, !tbaa !5, !invariant.load !13
...
for.body94:                                       ; preds = %for.cond92
  ...
  %22 = load i32, ptr %arrayidx96, align 4, !tbaa !5, !invariant.load !13
  %idxprom97 = sext i32 %20 to i64
  %arrayidx98 = getelementptr inbounds [10 x i32], ptr %d, i64 0, i64 %idxprom97
  %23 = load i32, ptr %arrayidx98, align 4, !tbaa !5, !invariant.load !13
...
if.then100:                                       ; preds = %for.body94
  ...
  %24 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !13
  %arrayidx104 = getelementptr inbounds [10 x i32], ptr %e, i64 0, i64 %idxprom97
  %25 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !13
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %24, i32 noundef %25) #5
  br label %for.inc107
