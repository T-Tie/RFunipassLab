...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc8 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv5, %2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
...
while.cond11:                                     ; preds = %for.cond, %for.end138
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.end138 ], [ %2, %for.cond ]
...
for.cond14.preheader:                             ; preds = %while.cond11
  %6 = trunc nsw i64 %indvars.iv55 to i32
  %smax52 = call i32 @llvm.smax.i32(i32 %6, i32 noundef 0)
  %wide.trip.count19 = zext nneg i32 %smax52 to i64
  %wide.trip.count = and i64 %indvars.iv55, 4294967295
  br label %for.cond14

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc49
  %indvars.iv16 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next17, %for.inc49 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond52.preheader, label %for.body16

for.cond52.preheader:                             ; preds = %for.cond14
  br label %for.cond52

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv16
  %7 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body22 ], [ 0, %for.body16 ]
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv8
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv11 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next12, %for.inc46 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count
  br i1 %exitcond15.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv11
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc90
  %indvars.iv31 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next32, %for.inc90 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count19
  br i1 %exitcond36.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv31
  %10 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select1, %for.body60 ], [ %10, %for.body54 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv31
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  %spec.select1 = call i32 @llvm.smin.i32(i32 %min.2, i32 %11)
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  br label %for.cond58, !llvm.loop !17

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv26 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next27, %for.inc87 ]
  %exitcond30.not = icmp eq i64 %indvars.iv26, %wide.trip.count
  br i1 %exitcond30.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv26, i64 %indvars.iv31
  %12 = load i32, ptr %arrayidx81, align 4, !tbaa !5, !invariant.load !13
...
for.end92:                                        ; preds = %for.cond52
  %13 = load i32, ptr %arrayidx94, align 8, !tbaa !5
  %indvars.iv.next56 = add nsw i64 %indvars.iv55, -1
  br label %for.cond95

for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count19
  br i1 %exitcond45.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc111 ], [ 1, %for.cond95 ]
  %cmp100 = icmp slt i64 %indvars.iv37, %indvars.iv.next56
  br i1 %cmp100, label %for.inc111, label %for.inc114

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next38 = add nuw nsw i64 %indvars.iv37, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv40, i64 %indvars.iv.next38
  %14 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv40, i64 %indvars.iv37
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond54.not = icmp eq i64 %indvars.iv49, %wide.trip.count19
  br i1 %exitcond54.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc133 ], [ 1, %for.cond117 ]
  %cmp122 = icmp slt i64 %indvars.iv46, %indvars.iv.next56
  br i1 %cmp122, label %for.inc133, label %for.inc136

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next47, i64 %indvars.iv49
  %15 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !13
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv46, i64 %indvars.iv49
...
for.end138:                                       ; preds = %for.cond117
  ...
  %16 = trunc nsw i64 %indvars.iv.next56 to i32
