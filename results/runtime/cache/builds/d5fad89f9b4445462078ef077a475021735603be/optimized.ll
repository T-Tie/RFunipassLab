...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv10, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.end9

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv10, %3
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx39 = getelementptr inbounds nuw i32, ptr %arrayidx37, i64 %indvars.iv19
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc77
  %indvars.iv40 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next41, %for.inc77 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count26
  br i1 %exitcond44.not, label %for.cond80, label %for.cond49.preheader

for.cond49.preheader:                             ; preds = %for.cond46
  %27 = mul nuw nsw i64 %indvars.iv40, %24
  %arrayidx56 = getelementptr inbounds nuw i32, ptr %vla29, i64 %27
  %28 = mul nuw nsw i64 %indvars.iv40, %3
  %arrayidx60 = getelementptr inbounds nuw i32, ptr %vla, i64 %28
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc74
  %indvars.iv35 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next36, %for.inc74 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond39.not, label %for.inc77, label %for.cond52.preheader

for.cond52.preheader:                             ; preds = %for.cond49
  %arrayidx58 = getelementptr inbounds nuw i32, ptr %arrayidx56, i64 %indvars.iv35
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla11, i64 %indvars.iv35
  br label %for.cond52

for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc71
  %indvars.iv28 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next29, %for.inc71 ]
  %exitcond34.not = icmp eq i64 %indvars.iv28, %wide.trip.count33
  br i1 %exitcond34.not, label %for.inc74, label %for.inc71

for.inc71:                                        ; preds = %for.cond52
  %29 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !17
  %arrayidx62 = getelementptr inbounds nuw i32, ptr %arrayidx60, i64 %indvars.iv28
  %30 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !17
  %31 = mul nuw nsw i64 %indvars.iv28, %14
...
for.cond80:                                       ; preds = %for.cond46, %for.inc99
  %33 = phi i32 [ %.pre51, %for.inc99 ], [ %22, %for.cond46 ]
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc99 ], [ 0, %for.cond46 ]
  %34 = sext i32 %33 to i64
  %cmp81 = icmp slt i64 %indvars.iv48, %34
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %35 = mul nuw nsw i64 %indvars.iv48, %24
...
for.cond87:                                       ; preds = %for.inc95, %for.body82
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc95 ], [ 1, %for.body82 ]
  %37 = load i32, ptr %y2, align 4, !tbaa !5
  %38 = sext i32 %37 to i64
  %cmp88 = icmp slt i64 %indvars.iv45, %38
  br i1 %cmp88, label %for.inc95, label %for.inc99

for.inc95:                                        ; preds = %for.cond87
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %arrayidx84, i64 %indvars.iv45
...
for.inc99:                                        ; preds = %for.cond87
  ...
  %.pre51 = load i32, ptr %x1, align 4, !tbaa !5
