...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000000, ptr noundef nonnull %s) #5
  %.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.cond1, %entry
  %0 = phi i32 [ %.pre, %entry ], [ %5, %for.cond1 ]
  %indvars.iv27 = phi i64 [ 0, %entry ], [ %indvars.iv.next28, %for.cond1 ]
...
for.cond1.preheader:                              ; preds = %for.cond
  ...
  %3 = add i32 %2, -1
  %4 = trunc nuw i64 %indvars.iv.next28 to i32
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %if.end21
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre31, %if.end21 ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %8, %if.end21 ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.217, %if.end21 ]
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.219, %if.end21 ]
  %end1.1 = phi i32 [ %end1.0, %for.cond1.preheader ], [ %end1.2, %if.end21 ]
  %end2.1 = phi i32 [ %end2.0, %for.cond1.preheader ], [ %end2.2, %if.end21 ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.221, %if.end21 ]
  %6 = sext i32 %5 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !12
...
if.end21:                                         ; preds = %for.body3, %land.lhs.true
  %f.221 = phi i32 [ %f.2.ph, %land.lhs.true ], [ %f.1, %for.body3 ]
  %star2.219 = phi i32 [ %star2.2.ph, %land.lhs.true ], [ %star2.1, %for.body3 ]
  %star1.217 = phi i32 [ %star1.2.ph, %land.lhs.true ], [ %star1.1, %for.body3 ]
  %end1.2 = phi i32 [ %3, %land.lhs.true ], [ %end1.1, %for.body3 ]
  %end2.2 = phi i32 [ %11, %land.lhs.true ], [ %end2.1, %for.body3 ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub40 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub40, 1
  %mul = mul nsw i32 %add28, %add26
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %mul) #5
