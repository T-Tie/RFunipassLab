...
entry:
  ...
  %n25 = alloca i8, i32 0, align 4
  %k = alloca i32, align 4
  %l = alloca i32, align 4
  %l26 = alloca i8, i32 0, align 4
  %l44 = alloca i32, align 4
  %k59 = alloca i32, align 4
  %l64 = alloca i32, align 4
  %l6427 = alloca i8, i32 0, align 4
...
for.body26:                                       ; preds = %for.cond23
  ...
  br i1 %cmp27, label %if.then, label %cond.end

if.then:                                          ; preds = %for.body26
  store i32 %11, ptr %min, align 4, !tbaa !5
  br label %for.inc41

cond.end:                                         ; preds = %for.body26
  br label %for.inc41
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  %16 = phi i32 [ %inc91, %for.inc90 ], [ 0, %for.body63 ]
...
for.body68:                                       ; preds = %for.cond65
  ...
  %17 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom71
  %18 = getelementptr inbounds [100 x i32], ptr %17, i64 0, i64 %idxprom73
  %19 = load i32, ptr %18, align 4, !tbaa !5
  br i1 %cmp69, label %if.then70, label %cond.end87

if.then70:                                        ; preds = %for.body68
  store i32 %19, ptr %min, align 4, !tbaa !5
  br label %for.inc90

cond.end87:                                       ; preds = %for.body68
  br label %for.inc90
