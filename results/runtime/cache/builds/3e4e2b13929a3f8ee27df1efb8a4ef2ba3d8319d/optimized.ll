...
for.end52:                                        ; preds = %for.cond40
  %max.0.lcssa = phi i32 [ %max.0, %for.cond40 ]
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %max.0.lcssa) #5
