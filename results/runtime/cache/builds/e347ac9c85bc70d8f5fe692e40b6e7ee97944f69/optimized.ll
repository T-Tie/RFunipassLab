...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef align 16 %a) #6
...
for.cond1:                                        ; preds = %for.end, %for.body
  %i.0 = phi i32 [ 0, %for.body ], [ %inc11, %for.end ]
...
for.cond13:                                       ; preds = %for.end134, %for.end12
  %sum.0 = phi i32 [ 0, %for.end12 ], [ %add, %for.end134 ]
  %c.0 = phi i32 [ %1, %for.end12 ], [ %dec, %for.end134 ]
  %cmp14 = icmp sgt i32 %c.0, 1
  br i1 %cmp14, label %for.body15, label %for.end136

for.body15:                                       ; preds = %for.cond13
  br label %for.cond16

for.cond16:                                       ; preds = %for.end47, %for.body15
  %i.1 = phi i32 [ 0, %for.body15 ], [ %inc49, %for.end47 ]
...
for.cond19:                                       ; preds = %if.end, %for.body18
  %j.1 = phi i32 [ 0, %for.body18 ], [ %inc32, %if.end ]
  %min.0 = phi i32 [ 100000, %for.body18 ], [ %min.1, %if.end ]
...
for.cond34:                                       ; preds = %for.body36, %for.end33
  %j.2 = phi i32 [ 0, %for.end33 ], [ %inc46, %for.body36 ]
...
for.cond51:                                       ; preds = %for.end85, %for.end50
  %j.3 = phi i32 [ 0, %for.end50 ], [ %inc87, %for.end85 ]
...
for.cond54:                                       ; preds = %if.end67, %for.body53
  %i.2 = phi i32 [ 0, %for.body53 ], [ %inc69, %if.end67 ]
  %min.2 = phi i32 [ 100000, %for.body53 ], [ %min.3, %if.end67 ]
...
if.end67:                                         ; preds = %if.then62, %for.body56
...
for.cond71:                                       ; preds = %for.body73, %for.end70
  %i.3 = phi i32 [ 0, %for.end70 ], [ %inc84, %for.body73 ]
...
for.body73:                                       ; preds = %for.cond71
  ...
  %6 = load i32, ptr %arrayidx77, align 4, !tbaa !5
...
for.cond91:                                       ; preds = %for.end109, %for.end88
  %i.4 = phi i32 [ 1, %for.end88 ], [ %inc111, %for.end109 ]
...
for.cond95:                                       ; preds = %for.body97, %for.body94
  %j.4 = phi i32 [ 0, %for.body94 ], [ %inc108, %for.body97 ]
...
for.cond113:                                      ; preds = %for.end131, %for.end112
  %j.5 = phi i32 [ 1, %for.end112 ], [ %inc133, %for.end131 ]
  %cmp114 = icmp slt i32 %j.5, %c.0
  br i1 %cmp114, label %for.body115, label %for.end134

for.body115:                                      ; preds = %for.cond113
  br label %for.cond116

for.cond116:                                      ; preds = %for.body119, %for.body115
  %i.5 = phi i32 [ 0, %for.body115 ], [ %inc130, %for.body119 ]
...
for.body119:                                      ; preds = %for.cond116
  ...
  %9 = load i32, ptr %arrayidx124, align 4, !tbaa !5
...
for.end141:                                       ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef %a) #7
  ret i32 0
}
