...
for.body55:                                       ; preds = %for.cond50
  ...
  %spec.select = add nuw nsw i32 %inc64, %number.0
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  %arrayidx52.phi.trans.insert = getelementptr inbounds nuw [501 x i8], ptr %a, i64 0, i64 %indvars.iv.next17
