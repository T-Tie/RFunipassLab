...
for.cond52:                                       ; preds = %for.inc71, %for.body51
  ...
  %cmp53 = icmp slt i32 %k.0, %17
  br i1 %cmp53, label %for.inc71, label %for.inc74

for.inc71:                                        ; preds = %for.cond52
  %idxprom55 = sext i32 %29 to i64
  %31 = mul nsw i64 %idxprom55, %24
  %arrayidx56 = getelementptr inbounds i32, ptr %vla29, i64 %31
  ...
  %33 = mul nsw i64 %idxprom55, %3
  %arrayidx60 = getelementptr inbounds i32, ptr %vla, i64 %33
  %idxprom61 = sext i32 %k.0 to i64
  %arrayidx62 = getelementptr inbounds i32, ptr %arrayidx60, i64 %idxprom61
  %34 = load i32, ptr %arrayidx62, align 4, !tbaa !5
  %35 = mul nsw i64 %idxprom61, %14
  %arrayidx64 = getelementptr inbounds i32, ptr %vla11, i64 %35
  %arrayidx66 = getelementptr inbounds i32, ptr %arrayidx64, i64 %idxprom57
  %36 = load i32, ptr %arrayidx66, align 4, !tbaa !5
  %mul = mul nsw i32 %36, %34
...
for.cond80:                                       ; preds = %for.end97, %for.end79
  ...
  %38 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp81 = icmp slt i32 %37, %38
  br i1 %cmp81, label %for.body82, label %for.end101

for.body82:                                       ; preds = %for.cond80
  %idxprom83 = sext i32 %37 to i64
  %39 = mul nsw i64 %idxprom83, %24
  %arrayidx84 = getelementptr inbounds i32, ptr %vla29, i64 %39
  %40 = load i32, ptr %arrayidx84, align 4, !tbaa !5
  %call86 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %40)
...
for.body89:                                       ; preds = %for.cond87
  ...
  %43 = load i32, ptr %arrayidx93, align 4, !tbaa !5, !invariant.load !18
  %call94 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %43)
