...
land.lhs.true.i16:                                ; preds = %if.then6.i10
  %_M_width.i1.i17 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 16
  %2 = load i64, ptr %_M_width.i1.i17, align 8, !tbaa !9, !invariant.load !8
  %3 = add i64 %2, -257
...
if.then19.i21:                                    ; preds = %land.lhs.true.i16
  ...
  %expval.i26 = call i64 @llvm.expect.i64(i64 %conv.i25, i64 1)
...
land.lhs.true.i43:                                ; preds = %if.then6.i37
  ...
  %4 = load i64, ptr %_M_width.i1.i44, align 8, !tbaa !9, !invariant.load !8
  %5 = add i64 %4, -257
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then6.i37, %land.lhs.true.i43, %if.then19.i48, %if.then28.i55
  ...
  %smax67 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56
  %indvars.iv78 = phi i32 [ %indvars.iv.next79, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %indvars.iv73 = phi i32 [ %indvars.iv.next74, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56 ]
  %exitcond69.not = icmp eq i64 %indvars.iv, %wide.trip.count68
  br i1 %exitcond69.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc ], [ 1, %for.body ]
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv61, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next60
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !22, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv61
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count76 = zext i32 %indvars.iv73 to i64
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv70 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next71, %for.inc43 ]
  %exitcond77.not = icmp eq i64 %indvars.iv70, %wide.trip.count76
  br i1 %exitcond77.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv70
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv78 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv81, %13
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv81
