...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 %sentence) #8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.body ], [ 0, %entry ]
  %0 = load ptr, ptr @stdin, align 8, !tbaa !5
  %call.i = tail call i32 @getc(ptr noundef %0) #8
...
while.end16:                                      ; preds = %while.cond2
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull %sentence) #10
  ret i32 0
}
...
entry:
  %0 = load ptr, ptr @stdin, align 8, !tbaa !5
  %call = tail call i32 @getc(ptr noundef %0) #10
  ret i32 %call
}
