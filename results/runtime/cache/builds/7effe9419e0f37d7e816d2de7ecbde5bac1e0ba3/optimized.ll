...
if.then14:                                        ; preds = %lor.lhs.false, %land.lhs.true
  %add15 = add nsw i32 %diff.0, 29
  br label %for.inc

if.else:                                          ; preds = %lor.lhs.false
  %add16 = add nsw i32 %diff.0, 28
  br label %for.inc

for.inc:                                          ; preds = %for.body5, %sw.bb, %sw.bb6, %if.else, %if.then14
  %diff.1 = phi i32 [ %diff.0, %for.body5 ], [ %add, %sw.bb ], [ %add7, %sw.bb6 ], [ %add15, %if.then14 ], [ %add16, %if.else ]
...
if.then20:                                        ; preds = %for.end
  %call21 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #5
  br label %for.inc25

if.else22:                                        ; preds = %for.end
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #5
  br label %for.inc25
