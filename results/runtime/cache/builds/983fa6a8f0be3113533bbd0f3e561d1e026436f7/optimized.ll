...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef %k) #5
  br label %for.cond
...
for.cond10:                                       ; preds = %for.end24, %for.end9
  %i.1 = phi i32 [ 0, %for.end9 ], [ %inc26, %for.end24 ]
  %sum.0 = phi i32 [ 0, %for.end9 ], [ %sum.1, %for.end24 ]
...
for.cond13:                                       ; preds = %if.end, %for.body12
  %j.1 = phi i32 [ 0, %for.body12 ], [ %inc23, %if.end ]
  %sum.1 = phi i32 [ %sum.0, %for.body12 ], [ %sum.2, %if.end ]
...
for.end27:                                        ; preds = %for.cond10
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %mul) #5
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %k) #5
