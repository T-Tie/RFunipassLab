...
for.cond20:                                       ; preds = %for.inc66, %for.body18
  ...
  %cmp21 = icmp slt i32 %i19.0, %.lcssa
...
for.cond30:                                       ; preds = %for.inc45, %if.end
  ...
  %cmp31 = icmp slt i32 %j29.0, %.lcssa
...
for.end47:                                        ; preds = %for.cond30
  %minValue.0.lcssa = phi i32 [ %minValue.0, %for.cond30 ]
  %sub51 = sub nsw i32 %3, %minValue.0.lcssa
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  ...
  %cmp55 = icmp slt i32 %j52.0, %.lcssa
...
for.inc63:                                        ; preds = %for.cond54
  ...
  %sub62 = sub nsw i32 %5, %minValue.0.lcssa
...
for.inc66:                                        ; preds = %for.inc66.loopexit, %land.lhs.true
...
for.cond70:                                       ; preds = %for.inc121, %for.end68
  ...
  %cmp71 = icmp slt i32 %j69.0, %.lcssa
...
for.cond85:                                       ; preds = %for.inc100, %if.end78
  ...
  %cmp86 = icmp slt i32 %i83.0, %.lcssa
...
for.end102:                                       ; preds = %for.cond85
  %minValue79.0.lcssa = phi i32 [ %minValue79.0, %for.cond85 ]
  %sub106 = sub nsw i32 %6, %minValue79.0.lcssa
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  ...
  %cmp110 = icmp slt i32 %i107.0, %.lcssa
...
for.inc118:                                       ; preds = %for.cond109
  ...
  %sub117 = sub nsw i32 %8, %minValue79.0.lcssa
...
for.inc121:                                       ; preds = %for.inc121.loopexit, %land.lhs.true75
...
for.inc136:                                       ; preds = %for.cond15
  %total.0.lcssa = phi i32 [ %total.0, %for.cond15 ]
