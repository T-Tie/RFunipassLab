...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv15 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next16, %for.body9 ]
  %max2.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select12, %for.body9 ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv15
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %cmp15 = icmp slt i32 %3, %max1.0
  %4 = call i32 @llvm.smax.i32(i32 %3, i32 %max2.0)
  %spec.select12 = select i1 %cmp15, i32 %4, i32 %max2.0
...
for.end22:                                        ; preds = %for.cond7
  ...
  %vtable.i = load ptr, ptr %call23, align 8, !tbaa !13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call23, i8 noundef signext %call.i7)
