...
for.cond3:                                        ; preds = %if.end39, %for.end
  %ans.0 = phi i32 [ 1, %for.end ], [ %ans.1, %if.end39 ]
  %i.1 = phi i32 [ 1, %for.end ], [ %inc41, %if.end39 ]
...
for.cond6:                                        ; preds = %if.end20, %for.body5
  %temp.0 = phi i32 [ -1, %for.body5 ], [ %temp.1, %if.end20 ]
  %j.0 = phi i32 [ 0, %for.body5 ], [ %inc22, %if.end20 ]
  %tIndex.0 = phi i32 [ -1, %for.body5 ], [ %tIndex.1, %if.end20 ]
...
if.end20:                                         ; preds = %if.then, %if.then17, %for.body8
...
if.then25:                                        ; preds = %for.end23
  %arrayidx27 = getelementptr inbounds [25 x i32], ptr %len, i64 0, i64 %idxprom26
