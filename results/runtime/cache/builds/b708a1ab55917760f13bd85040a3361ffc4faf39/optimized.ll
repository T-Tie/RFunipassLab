...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) @a) #6
...
if.then:                                          ; preds = %for.body, %land.lhs.true
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull %__c.addr.i) #7
...
attributes #6 = { nofree nosync nounwind willreturn memory(read) }
attributes #7 = { nofree }
