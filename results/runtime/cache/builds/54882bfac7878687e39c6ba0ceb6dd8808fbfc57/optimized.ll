...
for.cond:                                         ; preds = %if.end31, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc33, %if.end31 ]
  %len.0 = phi i32 [ 0, %entry ], [ %len.2, %if.end31 ]
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp4, label %if.end, label %if.end31
...
for.cond17:                                       ; preds = %for.body21, %if.then9
  %j.0 = phi i32 [ %sub16, %if.then9 ], [ %add22, %for.body21 ]
  %sub19 = sub nsw i32 %sub, %add
  %cmp20 = icmp sle i32 %j.0, %sub19
  br i1 %cmp20, label %for.body21, label %if.end31
...
if.end31:                                         ; preds = %for.body, %for.cond17, %if.end
...
for.cond35:                                       ; preds = %for.body37, %for.end34
  %i.1 = phi i32 [ 0, %for.end34 ], [ %inc45, %for.body37 ]
...
for.cond47:                                       ; preds = %for.body49, %for.end46
  %i.2 = phi i32 [ 0, %for.end46 ], [ %inc54, %for.body49 ]
