...
for.cond1:                                        ; preds = %for.inc10, %for.body
  ...
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc10 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv9, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %if.else, %entry
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %wide.trip.count28 = zext nneg i32 %smax43 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc27, %tailrecurse
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc27 ], [ 0, %tailrecurse ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.cond31.preheader, label %for.body

for.cond31.preheader:                             ; preds = %for.cond
  br label %for.cond31

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv25
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx9 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv25, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv20 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next21, %for.inc24 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond24.not, label %for.inc27, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv25, i64 %indvars.iv20
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc70
  %indvars.iv40 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next41, %for.inc70 ]
  %exitcond45.not = icmp eq i64 %indvars.iv40, %wide.trip.count28
  br i1 %exitcond45.not, label %for.end72, label %for.body34

for.body34:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv40
  %3 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  br label %for.cond39

for.cond39:                                       ; preds = %for.body42, %for.body34
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body42 ], [ 1, %for.body34 ]
  %min35.0 = phi i32 [ %spec.select18, %for.body42 ], [ %3, %for.body34 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.cond58.preheader, label %for.body42

for.cond58.preheader:                             ; preds = %for.cond39
  br label %for.cond58

for.body42:                                       ; preds = %for.cond39
  %arrayidx46 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv30, i64 %indvars.iv40
  %4 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %spec.select18 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min35.0)
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond39, !llvm.loop !20

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc67
  %indvars.iv35 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next36, %for.inc67 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %wide.trip.count
  br i1 %exitcond39.not, label %for.inc70, label %for.inc67

for.inc67:                                        ; preds = %for.cond58
  %arrayidx65 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv35, i64 %indvars.iv40
...
if.else:                                          ; preds = %for.end72
  tail call void @_Z8xiaojiani(i32 noundef %n.tr) #9
...
for.cond:                                         ; preds = %for.cond10, %entry
  %indvars.iv4 = phi i64 [ 1, %entry ], [ %indvars.iv.next5, %for.cond10 ]
  %exitcond8.not = icmp eq i64 %indvars.iv4, %wide.trip.count7
  br i1 %exitcond8.not, label %for.end27, label %for.body

for.body:                                         ; preds = %for.cond
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %arrayidx = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv.next5
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %arrayidx2 = getelementptr inbounds nuw [105 x i32], ptr @a, i64 0, i64 %indvars.iv4
  store i32 %0, ptr %arrayidx2, align 4, !tbaa !5
  %arrayidx5 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next5
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv4
...
for.inc:                                          ; preds = %for.cond10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx20 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv.next5, i64 %indvars.iv.next
  %2 = load i32, ptr %arrayidx20, align 4, !tbaa !5
  %arrayidx24 = getelementptr inbounds nuw [105 x [105 x i32]], ptr @a, i64 0, i64 %indvars.iv4, i64 %indvars.iv
