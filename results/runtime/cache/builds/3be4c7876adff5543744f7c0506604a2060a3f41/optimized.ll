...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv29 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next30, %for.inc14 ]
  %exitcond.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond.not, label %for.cond17, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv29
  store i32 0, ptr %arrayidx6, align 4, !tbaa !5
  %arrayidx8 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv29
  br label %while.cond
...
while.cond:                                       ; preds = %while.body, %for.body4
  ...
  %5 = load i8, ptr %q.0, align 1, !tbaa !26, !invariant.load !11
...
for.cond17:                                       ; preds = %for.cond2, %for.inc47
  ...
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc47 ], [ 0, %for.cond2 ]
  %s.0 = phi i32 [ %add46, %for.inc47 ], [ 0, %for.cond2 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv33, %7
  br i1 %cmp18, label %for.body19, label %for.end49

for.body19:                                       ; preds = %for.cond17
  %cmp20 = icmp sgt i32 %s.0, 0
  %arrayidx22 = getelementptr inbounds nuw [500 x i32], ptr %l, i64 0, i64 %indvars.iv33
...
land.lhs.true:                                    ; preds = %for.body19
  ...
  br i1 %cmp23, label %if.end35.thread44, label %if.end35.thread

if.end35.thread44:                                ; preds = %land.lhs.true
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread44
  %call24.sink = phi ptr [ %call24, %if.end35.thread44 ], [ @_ZSt4cout, %if.end35.thread ], [ @_ZSt4cout, %if.end35 ]
  %phiofops.ph = phi i32 [ %add, %if.end35.thread44 ], [ %8, %if.end35.thread ], [ %8, %if.end35 ]
  %arrayidx26 = getelementptr inbounds nuw [500 x [50 x i8]], ptr %word, i64 0, i64 %indvars.iv33
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %phiofops = phi i32 [ %add, %if.end35 ], [ %phiofops.ph, %for.inc47.sink.split ]
