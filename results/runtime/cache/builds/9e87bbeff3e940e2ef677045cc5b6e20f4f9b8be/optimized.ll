...
while.end:                                        ; preds = %while.cond
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call8, i8 noundef signext %call.i3)
  ...
  %vtable.i4 = load ptr, ptr %call10, align 8, !tbaa !12
  %vbase.offset.ptr.i5 = getelementptr i8, ptr %vtable.i4, i64 -24
  %vbase.offset.i6 = load i64, ptr %vbase.offset.ptr.i5, align 8
  %add.ptr.i7 = getelementptr inbounds i8, ptr %call10, i64 %vbase.offset.i6
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i7, i8 noundef signext 10)
  %call1.i8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call10, i8 noundef signext %call.i)
