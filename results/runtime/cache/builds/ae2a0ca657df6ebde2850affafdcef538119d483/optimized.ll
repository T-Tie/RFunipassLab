...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12 = icmp slt i64 %indvars.iv10, %2
...
for.cond22.preheader:                             ; preds = %for.cond10
  ...
  %4 = ashr exact i64 %sext22, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv10
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %6 = sub nuw nsw i64 %indvars.iv10, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc31
  %indvars.iv17 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next18, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv17, %3
  br i1 %cmp24, label %for.inc31, label %for.end37

for.inc31:                                        ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv17, %4
