...
if.then6.i9:                                      ; preds = %if.then28.i, %if.then19.i, %entry
  ...
  %call16.i19 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i18) #12
  %3 = add i64 %2, -257
  %or.cond.i23 = icmp ult i64 %3, -256
  %or.cond83 = select i1 %call16.i19, i1 %or.cond.i23, i1 false
  br i1 %or.cond83, label %if.then19.i24, label %if.then6.i48
...
if.then19.i24:                                    ; preds = %if.then6.i9
  ...
  %call24.i29 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i28) #12
  ...
  %expval.i33 = call i64 @llvm.expect.i64(i64 noundef %conv.i32, i64 noundef 1)
  %tobool.not.i34 = icmp eq i64 %expval.i33, 0
  br i1 %tobool.not.i34, label %if.then6.i48, label %if.then28.i35
...
if.then6.i48:                                     ; preds = %if.then28.i35, %if.then19.i24, %if.then6.i9
  %vtable7.i49 = load ptr, ptr @_ZSt3cin, align 8, !tbaa !5
  ...
  %4 = load i64, ptr %_M_width.i1.i53, align 8, !tbaa !9
  ...
  %call16.i58 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i57) #12
  %5 = add i64 %4, -257
  %or.cond.i62 = icmp ult i64 %5, -256
  %or.cond84 = select i1 %call16.i58, i1 %or.cond.i62, i1 false
  br i1 %or.cond84, label %if.then19.i63, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79

if.then19.i63:                                    ; preds = %if.then6.i48
  %vtable20.i64 = load ptr, ptr @_ZSt3cin, align 8, !tbaa !5
  %vbase.offset.ptr21.i65 = getelementptr i8, ptr %vtable20.i64, i64 -24
  %vbase.offset22.i66 = load i64, ptr %vbase.offset.ptr21.i65, align 8, !invariant.load !8
  %add.ptr23.i67 = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset22.i66
  %call24.i68 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i67) #12
  %call25.i69 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %call24.i68)
  %cmp.i.i70 = icmp eq i32 %call25.i69, -1
  %conv.i71 = zext i1 %cmp.i.i70 to i64
  %expval.i72 = call i64 @llvm.expect.i64(i64 noundef %conv.i71, i64 noundef 1)
  %tobool.not.i73 = icmp eq i64 %expval.i72, 0
  br i1 %tobool.not.i73, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79, label %if.then28.i74

if.then28.i74:                                    ; preds = %if.then19.i63
  %vtable29.i75 = load ptr, ptr @_ZSt3cin, align 8, !tbaa !5
  %vbase.offset.ptr30.i76 = getelementptr i8, ptr %vtable29.i75, i64 -24
  %vbase.offset31.i77 = load i64, ptr %vbase.offset.ptr30.i76, align 8, !invariant.load !8
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79: ; preds = %if.then6.i48, %if.then19.i63, %if.then28.i74
  ...
  %smax95 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
  %wide.trip.count96 = zext nneg i32 %smax95 to i64
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79
  %indvars.iv106 = phi i32 [ %indvars.iv.next107, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79 ]
  %indvars.iv101 = phi i32 [ %indvars.iv.next102, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit79 ]
  %exitcond97.not = icmp eq i64 %indvars.iv, %wide.trip.count96
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc ], [ 1, %for.body ]
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv89, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next88 = add nuw nsw i64 %indvars.iv87, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next88
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !22
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv89
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %10 = trunc nuw nsw i64 %indvars.iv89 to i32
  br label %for.end
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count104 = zext i32 %indvars.iv101 to i64
  br label %for.cond37
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv98 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next99, %for.inc43 ]
  %exitcond105.not = icmp eq i64 %indvars.iv98, %wide.trip.count104
  br i1 %exitcond105.not, label %for.end45, label %for.inc43
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv106 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv109 = phi i64 [ %indvars.iv.next110, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv109, %13
