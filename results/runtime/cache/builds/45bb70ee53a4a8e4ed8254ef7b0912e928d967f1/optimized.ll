...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %total) #4
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %valid) #4
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %t1) #4
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %v1) #4
