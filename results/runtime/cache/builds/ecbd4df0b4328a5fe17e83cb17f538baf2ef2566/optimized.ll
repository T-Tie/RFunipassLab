...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12 = icmp slt i64 %indvars.iv9, %1
  br i1 %cmp12, label %for.body13, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond10
  %sext20 = shl i64 %1, 32
  %2 = ashr exact i64 %sext20, 32
  %sext21 = shl i64 %indvars.iv, 32
  %3 = ashr exact i64 %sext21, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv9
  %4 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %5 = sub nuw nsw i64 %indvars.iv9, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc31
  %indvars.iv16 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next17, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv16, %2
  br i1 %cmp24, label %for.inc31, label %for.end37

for.inc31:                                        ; preds = %for.cond22
  %7 = sub nuw nsw i64 %indvars.iv16, %3
  %arrayidx28 = getelementptr inbounds nuw [256 x i8], ptr %tar, i64 0, i64 %7
  %8 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv16
