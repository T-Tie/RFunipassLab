...
for.cond6:                                        ; preds = %for.body, %for.end
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body ], [ %indvars.iv, %for.end ]
  %cmp7 = icmp sgt i64 %indvars.iv12, 0
  br i1 %cmp7, label %for.body, label %for.end13

for.body:                                         ; preds = %for.cond6
  %indvars.iv.next13 = add nsw i64 %indvars.iv12, -1
  %arrayidx9 = getelementptr inbounds nuw [100 x [20 x i8]], ptr %a, i64 0, i64 %indvars.iv.next13
