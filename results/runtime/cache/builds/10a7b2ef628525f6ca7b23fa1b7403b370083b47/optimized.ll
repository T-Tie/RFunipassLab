...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv45 = phi i32 [ %indvars.iv.next46, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax92 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax81 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %1 = add nuw i32 %smax81, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv52 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next53, %for.inc23 ]
  %exitcond56 = icmp eq i64 %indvars.iv52, %wide.trip.count55
  br i1 %exitcond56, label %for.cond26, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc20 ], [ 1, %for.cond13.preheader ]
  %exitcond51 = icmp eq i64 %indvars.iv47, %wide.trip.count
  br i1 %exitcond51, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv47
...
for.cond26:                                       ; preds = %for.cond, %for.inc57
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc57 ], [ 1, %for.cond ]
  %exitcond72 = icmp eq i64 %indvars.iv67, %wide.trip.count55
  br i1 %exitcond72, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select43, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond61 = icmp eq i64 %indvars.iv57, %wide.trip.count
  br i1 %exitcond61, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv57, i64 %indvars.iv67
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !14
  %spec.select43 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  br label %for.cond29, !llvm.loop !18

for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc54 ], [ 1, %for.cond46.preheader ]
  %exitcond66 = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv67
...
for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond83 = icmp eq i64 %indvars.iv78, %wide.trip.count55
  br i1 %exitcond83, label %for.cond80.preheader, label %for.cond63
...
for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc74 ], [ 2, %for.cond60 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count76
  br i1 %exitcond77.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next74 = add nuw nsw i64 %indvars.iv73, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv78, i64 %indvars.iv.next74
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !14
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv78, i64 %indvars.iv73
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv89 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next90, %for.inc98 ]
  %exitcond94.not = icmp eq i64 %indvars.iv89, %wide.trip.count93
  br i1 %exitcond94.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc95 ], [ 2, %for.cond80 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %wide.trip.count76
  br i1 %exitcond88.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next85, i64 %indvars.iv89
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !14
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv84, i64 %indvars.iv89
