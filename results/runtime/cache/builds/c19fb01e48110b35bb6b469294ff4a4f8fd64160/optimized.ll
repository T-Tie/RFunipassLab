...
for.cond1:                                        ; preds = %for.inc18, %for.end
  %k.1 = phi i32 [ %k.0, %for.end ], [ %k.2, %for.inc18 ]
  %i.1 = phi i32 [ 0, %for.end ], [ %inc19, %for.inc18 ]
...
for.inc18:                                        ; preds = %for.body3, %if.then15, %if.then
  %k.2 = phi i32 [ %inc16, %if.then15 ], [ %k.1, %if.then ], [ %k.1, %for.body3 ]
