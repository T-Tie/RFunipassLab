...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef %a) #13
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef %b) #13
  br label %for.cond
...
for.inc13:                                        ; preds = %for.cond4
  ...
  %call10 = call i64 @strlen(ptr noundef %add.ptr8) #14
...
for.inc31:                                        ; preds = %for.cond23
  ...
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef %add.ptr27)
...
for.end33:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0(ptr %add.ptr35)
  br label %for.inc42
...
for.inc54:                                        ; preds = %for.cond45
  ...
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef %add.ptr50)
...
for.end56:                                        ; preds = %for.cond45
  ...
  call fastcc void @outlined_ir_func_0(ptr %add.ptr58)
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef %b) #13
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef %a) #13
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) #13
...
define internal fastcc void @outlined_ir_func_0(ptr %0) unnamed_addr #11 {
for.end33_after_outline.exitStub:
  %add.ptr36 = getelementptr inbounds [41 x i8], ptr %0, i64 -1
...
attributes #11 = { minsize mustprogress norecurse optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
