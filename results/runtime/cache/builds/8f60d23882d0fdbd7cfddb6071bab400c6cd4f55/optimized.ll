...
for.cond43.preheader:                             ; preds = %for.cond8
  %smax11 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef -1)
  %2 = add i32 %smax11, 1
  %wide.trip.count12 = zext i32 %2 to i64
  br label %for.cond43
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc50
  %indvars.iv7 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next8, %for.inc50 ]
  %exitcond13 = icmp eq i64 %indvars.iv7, %wide.trip.count12
  br i1 %exitcond13, label %for.end52, label %for.inc50

for.inc50:                                        ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [50 x [82 x i8]], ptr %para, i64 0, i64 %indvars.iv7
