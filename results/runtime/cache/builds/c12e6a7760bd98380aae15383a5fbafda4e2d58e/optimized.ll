...
while.body:                                       ; preds = %while.cond
  call void @_Z8multiplyPci(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(200) %str, i32 noundef 2) #9
  %dec = add nsw i32 %0, -1
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull align 16 %num) #9
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %str) #10
