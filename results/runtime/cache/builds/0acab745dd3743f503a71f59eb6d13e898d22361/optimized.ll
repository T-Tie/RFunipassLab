...
if.then55:                                        ; preds = %for.body51
  ...
  %8 = load double, ptr %arrayidx58, align 8, !tbaa !9
...
if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %11, double noundef %14, double noundef %11, double noundef %14)
  br label %for.inc110
