...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc13 ], [ %0, %for.end ]
  %cmp3 = icmp slt i64 %indvars.iv5, %1
  br i1 %cmp3, label %for.body4, label %for.end15

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv5
...
if.then10:                                        ; preds = %for.body4
  ...
  %arrayidx12 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv5
...
for.cond20:                                       ; preds = %for.body22, %for.end15
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body22 ], [ %0, %for.end15 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ %5, %for.end15 ]
  %cmp21 = icmp slt i64 %indvars.iv8, %1
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv8
