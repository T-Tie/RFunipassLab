...
@bo = dso_local global i32 0, align 4
@ctt = dso_local global [10000 x i32] zeroinitializer, align 16
...
entry:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(40000) @ctt, i8 0, i64 40000, i1 false)
  store i32 0, ptr @bo, align 4, !tbaa !5
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) @a) #5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %0 = phi i32 [ %4, %for.inc ], [ 0, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %exitcond.not = icmp eq i64 %indvars.iv, %call1
...
land.lhs.true:                                    ; preds = %for.body
  %cmp7 = icmp samesign ult i8 %1, 91
  %2 = add nsw i8 %1, -97
  %or.cond = icmp ult i8 %2, 26
  %or.cond4 = select i1 %cmp7, i1 true, i1 %or.cond
  br i1 %or.cond4, label %if.then, label %for.inc

if.then:                                          ; preds = %land.lhs.true
  %idxprom19 = zext nneg i8 %1 to i64
...
for.inc:                                          ; preds = %land.lhs.true, %for.body, %if.then
  %4 = phi i32 [ %0, %land.lhs.true ], [ %0, %for.body ], [ 1, %if.then ]
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond
  %5 = trunc nuw nsw i64 %call1 to i32
...
for.cond25:                                       ; preds = %for.inc36, %if.end24
  %storemerge2 = phi i32 [ 65, %if.end24 ], [ %inc37, %for.inc36 ]
  store i32 %storemerge2, ptr @i, align 4, !tbaa !5
  %cmp26 = icmp slt i32 %storemerge2, 91
  br i1 %cmp26, label %for.body27, label %for.cond39

for.body27:                                       ; preds = %for.cond25
  %idxprom28 = sext i32 %storemerge2 to i64
...
if.then31:                                        ; preds = %for.body27
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge2, i32 noundef %6)
  %.pre6 = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc36

for.inc36:                                        ; preds = %for.body27, %if.then31
  %7 = phi i32 [ %storemerge2, %for.body27 ], [ %.pre6, %if.then31 ]
  %inc37 = add nsw i32 %7, 1
  br label %for.cond25, !llvm.loop !13

for.cond39:                                       ; preds = %for.cond25, %for.inc50
  %storemerge3 = phi i32 [ %inc51, %for.inc50 ], [ 97, %for.cond25 ]
  store i32 %storemerge3, ptr @i, align 4, !tbaa !5
  %cmp40 = icmp slt i32 %storemerge3, 123
  br i1 %cmp40, label %for.body41, label %for.end52

for.body41:                                       ; preds = %for.cond39
  %idxprom42 = sext i32 %storemerge3 to i64
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %storemerge3, i32 noundef %8)
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.body41, %if.then45
  %9 = phi i32 [ %storemerge3, %for.body41 ], [ %.pre, %if.then45 ]
