...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %s_all) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %s_good) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %all) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %good) #7
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %good) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %all) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %s_good) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %s_all) #7
