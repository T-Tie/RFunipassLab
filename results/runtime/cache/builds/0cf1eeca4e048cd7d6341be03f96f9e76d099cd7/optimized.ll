...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select2 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select2
  ...
  %or.cond3 = or i1 %cmp12, %or.cond
  %smax6 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond3, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %x.1 = phi i32 [ %add18, %for.inc ], [ 0, %for.body ]
  %exitcond7.not = icmp eq i32 %m.0, %smax6
  br i1 %exitcond7.not, label %for.inc53, label %for.body16
...
for.cond30:                                       ; preds = %for.body, %for.inc40
  ...
  %exitcond.not = icmp eq i32 %m.1, %smax6
...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  %spec.select5 = select i1 %cmp44, ptr @.str, ptr @.str.1
  %call49 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %spec.select5)
