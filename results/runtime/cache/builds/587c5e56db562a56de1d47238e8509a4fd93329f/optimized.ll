...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv11 = phi i32 [ %indvars.iv.next12, %while.cond ], [ -1, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.cond ], [ 0, %entry ]
  %phiofops1 = phi i64 [ %indvars.iv, %while.cond ], [ -1, %entry ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv7 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next8, %for.inc25 ]
  %exitcond13.not = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond13.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %3 = xor i64 %indvars.iv7, -1
  %4 = add nsw i64 %3, %0
