...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv27
...
while.end19:                                      ; preds = %while.cond8, %while.cond8
  ...
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, i32 %lenq.0, ptr nonnull %incdec.ptr23)
...
define internal void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) initializes((0, 4)) %0, i32 %1, ptr readonly captures(none) %2) #5 {
if.then_to_outline:
