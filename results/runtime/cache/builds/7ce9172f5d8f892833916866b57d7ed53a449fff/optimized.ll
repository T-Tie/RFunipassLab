...
for.end:                                          ; preds = %for.cond12
  %k.2.lcssa = phi i32 [ %k.2, %for.cond12 ]
  %add.lcssa = phi i32 [ %add, %for.cond12 ]
  %tobool = icmp ne i32 %k.2.lcssa, 0
...
if.then30:                                        ; preds = %for.end
  %i.0.lcssa2 = phi i32 [ %i.0, %for.end ]
  %add.lcssa.lcssa = phi i32 [ %add.lcssa, %for.end ]
  br label %for.cond31

for.cond31:                                       ; preds = %for.inc38, %if.then30
  %i.1 = phi i32 [ 0, %if.then30 ], [ %inc39, %for.inc38 ]
  %cmp32 = icmp slt i32 %i.1, %i.0.lcssa2
...
for.cond44:                                       ; preds = %for.inc51, %for.end40
  %i.2 = phi i32 [ %add.lcssa.lcssa, %for.end40 ], [ %inc52, %for.inc51 ]
  %cmp45 = icmp slt i32 %i.2, %conv7
  br i1 %cmp45, label %for.inc51, label %if.end56.loopexit
...
if.end56:                                         ; preds = %if.end56.loopexit, %if.else
