...
newFuncRoot:
  br label %for.body17_to_outline

for.body17_to_outline:                            ; preds = %newFuncRoot
  ...
  br label %for.body17_after_outline.exitStub

for.body17_after_outline.exitStub:                ; preds = %for.body17_to_outline
  ret void
}
