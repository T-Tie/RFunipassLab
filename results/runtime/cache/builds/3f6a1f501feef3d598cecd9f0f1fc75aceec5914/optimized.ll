...
if.then:                                          ; preds = %for.body5
  ...
  %4 = load double, ptr %arrayidx8, align 8, !tbaa !12, !invariant.load !14
  ...
  %6 = load double, ptr %arrayidx18, align 8, !tbaa !12, !invariant.load !14
...
if.then21:                                        ; preds = %if.then
  %fneg = fneg double %4
  %call25 = call double @sqrt(double noundef %7) #8, !tbaa !5
  %add26 = fadd double %fneg, %call25
  %mul29 = fmul double 2.000000e+00, %5
  %div = fdiv double %add26, %mul29
  %call34 = call double @sqrt(double noundef %7) #8, !tbaa !5
...
if.then41:                                        ; preds = %if.end
  %fneg45 = fneg double %4
  %mul48 = fmul double 2.000000e+00, %5
...
if.then53:                                        ; preds = %if.end51
  %fneg57 = fneg double %4
  %mul60 = fmul double 2.000000e+00, %5
