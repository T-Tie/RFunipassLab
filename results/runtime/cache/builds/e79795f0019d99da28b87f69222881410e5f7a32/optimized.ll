...
if.else:                                          ; preds = %for.end123
  ...
  %smax124 = call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %l.0, i32 noundef 1)
  %wide.trip.count128 = zext nneg i32 %smax124 to i64
...
for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars127.le, %for.end153.split.loop.exit ], [ %smax124, %for.cond134 ]
...
for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count152 = zext i32 %z.1.lcssa to i64
