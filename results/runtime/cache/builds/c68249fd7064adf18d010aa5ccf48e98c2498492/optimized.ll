...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50000, ptr nonnull %word) #6
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 50000, ptr nonnull %word) #6
  ret i32 0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !15
