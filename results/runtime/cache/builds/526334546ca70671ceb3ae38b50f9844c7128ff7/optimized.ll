...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %1 = sext i32 %sub38 to i64
  %smax22 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
  %wide.trip.count23 = zext nneg i32 %smax22 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv14
...
if.then9:                                         ; preds = %if.end
  %3 = trunc nuw nsw i64 %indvars.iv14 to i32
  %sub10 = sub i32 %sub, %3
  %idxprom11 = sext i32 %sub10 to i64
  %arrayidx12 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %idxprom11
  store i8 32, ptr %arrayidx12, align 1, !tbaa !5
  %add = sub i32 %3, %len.0
  %sub19 = sub i32 %sub, %add
  %invariant.op = add i32 %add, %3
  %add24.reass = sub i32 %invariant.op, %conv
  %4 = sext i32 %sub19 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc ], [ %0, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv11, %4
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next12 = add nsw i64 %indvars.iv11, 1
  %5 = trunc nsw i64 %indvars.iv11 to i32
  %sub25 = add i32 %add24.reass, %5
  %idxprom26 = sext i32 %sub25 to i64
  %arrayidx27 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %idxprom26
  %6 = load i8, ptr %arrayidx27, align 1, !tbaa !5, !invariant.load !8
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv11
  store i8 %6, ptr %arrayidx29, align 1, !tbaa !5
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv17 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next18, %for.inc44 ]
  %exitcond24.not = icmp eq i64 %indvars.iv17, %wide.trip.count23
  br i1 %exitcond24.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %7 = add nsw i64 %indvars.iv17, %1
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %7
  %8 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv17
  store i8 %8, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv25
  %9 = load i8, ptr %arrayidx51, align 1, !tbaa !5
  %call52 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %9)
