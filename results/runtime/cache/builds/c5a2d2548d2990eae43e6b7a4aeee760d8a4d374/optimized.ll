...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc12
  %indvars.iv6 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc12 ]
...
for.cond15.preheader:                             ; preds = %for.cond2
  ...
  %wide.trip.count16 = zext i32 %j.0 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond24.not = icmp eq i64 %indvars.iv18, %wide.trip.count23
  br i1 %exitcond24.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv18
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc37 ], [ %indvars.iv10, %for.body17 ]
  %exitcond17.not = icmp eq i64 %indvars.iv12, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv12
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv25 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next26, %for.inc53 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count23
  br i1 %exitcond29.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv25
  ...
  %cmp49 = icmp slt i64 %indvars.iv25, %4
