...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef nonnull dereferenceable(60000) %c) #8
  call void @llvm.lifetime.start.p0(i64 noundef 600, ptr noundef nonnull %input) #8
...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv49 = phi i32 [ %indvars.iv.next50, %for.inc18 ], [ 0, %entry ]
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc18 ], [ 0, %entry ]
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #9
  %sub = sub i64 %call4, %conv5
  %cmp.not = icmp ult i64 %sub, %indvars.iv41
...
for.inc:                                          ; preds = %for.cond6
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv41
  ...
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv41, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !11

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv41, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv46 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next47, %for.inc26 ]
  %exitcond52.not = icmp eq i64 %indvars.iv46, %wide.trip.count51
  br i1 %exitcond52.not, label %for.cond29, label %for.inc26

for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv46
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  br label %for.cond21, !llvm.loop !15

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond64.not = icmp eq i64 %indvars.iv53, %wide.trip.count51
  br i1 %exitcond64.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv53
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv53
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv55 = phi i64 [ %indvars.iv53, %for.cond32.preheader ], [ %indvars.iv.next56, %for.inc51 ]
  %exitcond60.not = icmp eq i64 %indvars.iv55, %wide.trip.count51
  br i1 %exitcond60.not, label %for.inc54, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv55
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv55
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond70.not = icmp eq i64 %indvars.iv65, %wide.trip.count51
  br i1 %exitcond70.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv65
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc89 ], [ 0, %if.else ]
  %exitcond76.not = icmp eq i64 %indvars.iv71, %wide.trip.count51
  br i1 %exitcond76.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv71
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv71
...
define internal void @outlined_ir_func_0(ptr nonnull %0) #6 {
if.end92.exitStub:
