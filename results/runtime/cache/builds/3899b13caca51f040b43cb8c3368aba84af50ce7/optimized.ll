...
for.cond72:                                       ; preds = %for.inc122, %for.body71
  ...
  br i1 %cmp74, label %for.body75, label %for.end124
...
if.else79:                                        ; preds = %land.lhs.true, %for.body75
  %cmp80 = icmp eq i32 %16, 1
  br i1 %cmp80, label %if.then82, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.else79
  %cmp81 = icmp eq i32 %17, 1
  br i1 %cmp81, label %if.then82, label %if.else83

if.then82:                                        ; preds = %lor.lhs.false, %if.else79
  br label %for.inc122
...
if.end118:                                        ; preds = %if.else107, %if.then97
  br label %if.end119

if.end119:                                        ; preds = %if.end118, %if.then85
  br label %if.end120
...
for.inc122:                                       ; preds = %if.end121, %if.then82, %if.then78
