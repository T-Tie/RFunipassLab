...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %s_all) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %s_good) #7
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %all) #7
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %good) #7
  %vtable.i12 = load ptr, ptr @_ZSt4cout, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %vbase.offset.i26 = load i64, ptr %vbase.offset.ptr.i13, align 8, !invariant.load !11
...
if.else:                                          ; preds = %for.body
  ...
  br i1 %cmp14, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit23

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.else
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i13)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i)
  br label %for.inc

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit23: ; preds = %if.else
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i11)
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i11, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i13)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i11)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %good) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %all) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_good) #7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %s_all) #7
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) initializes((0, 1)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %1) unnamed_addr #5 {
if.then15_to_outline:
  store i8 10, ptr %0, align 1, !tbaa !39
  %vbase.offset.i = load i64, ptr %1, align 8, !invariant.load !11
  %gep32 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %2 = load i64, ptr %gep32, align 8, !tbaa !42, !invariant.load !11
  %cmp.not.i = icmp eq i64 %2, 0
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.then15_to_outline
  %call1.i7 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %0, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit.exitStub

if.end.i:                                         ; preds = %if.then15_to_outline
