...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 400, ptr noundef nonnull align 16 %an) #8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(400) %an, ptr noundef nonnull readonly align 16 dereferenceable(400) @__const.main.an, i64 noundef 400, i1 noundef false) #9
...
if.then:                                          ; preds = %entry
  %ldexp = call double @ldexp(double 1.000000e+00, i32 %0)
...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv21 = phi i32 [ %indvars.iv.next22, %for.cond29 ], [ 100, %for.cond ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv18
...
for.cond38.preheader:                             ; preds = %for.cond29
  %3 = zext i32 %indvars.iv21 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc45
  %indvars.iv23 = phi i64 [ %3, %for.cond38.preheader ], [ %5, %for.inc45 ]
...
for.inc45:                                        ; preds = %for.cond38
  ...
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %6)
  br label %for.cond38, !llvm.loop !14

if.end49:                                         ; preds = %for.cond38, %if.then
  %_ZSt4cout.sink27 = phi ptr [ %call3, %if.then ], [ @_ZSt4cout, %for.cond38 ]
  %vtable.i10 = load ptr, ptr %_ZSt4cout.sink27, align 8, !tbaa !15
  %vbase.offset.ptr.i11 = getelementptr i8, ptr %vtable.i10, i64 -24
  %vbase.offset.i12 = load i64, ptr %vbase.offset.ptr.i11, align 8, !invariant.load !17
  %add.ptr.i13 = getelementptr inbounds i8, ptr %_ZSt4cout.sink27, i64 %vbase.offset.i12
  ...
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink27, i8 noundef signext %call.i)
