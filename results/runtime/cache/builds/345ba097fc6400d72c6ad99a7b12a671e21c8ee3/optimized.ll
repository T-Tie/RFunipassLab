...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr %m) #4
  call void @llvm.memset.p0.i64(ptr align 16 %m, i8 0, i64 100, i1 false)
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #4
  call void @llvm.lifetime.start.p0(i64 100, ptr %d) #4
  call void @llvm.memset.p0.i64(ptr align 16 %d, i8 0, i64 100, i1 false)
...
for.end49:                                        ; preds = %for.cond37
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr %d) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #4
  call void @llvm.lifetime.end.p0(i64 100, ptr %m) #4
