...
if.then:                                          ; preds = %entry
  %div4 = udiv i32 %0, 100
  %call1 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div4) #6
...
if.then4:                                         ; preds = %if.end
  %div55 = udiv i32 %2, 50
  %call6 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div55) #6
...
if.else8:                                         ; preds = %if.end
  %puts9 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #6
...
if.then12:                                        ; preds = %if.end10
  %div136 = udiv i32 %4, 20
  %call14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div136) #6
...
if.else16:                                        ; preds = %if.end10
  %puts10 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #6
...
if.then20:                                        ; preds = %if.end18
  %div217 = udiv i32 %6, 10
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div217) #6
...
if.else24:                                        ; preds = %if.end18
  %puts11 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.3) #6
...
if.then28:                                        ; preds = %if.end26
  %div298 = udiv i32 %8, 5
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div298) #6
...
if.else32:                                        ; preds = %if.end26
  %puts12 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.4) #6
