...
for.inc77:                                        ; preds = %for.cond58
  ...
  %9 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  ...
  %10 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  ...
  %11 = load i32, ptr %arrayidx72, align 4, !tbaa !5, !invariant.load !17
...
for.body101:                                      ; preds = %for.cond99
  ...
  %12 = load i32, ptr %arrayidx105, align 4, !tbaa !5, !invariant.load !17
...
for.body120:                                      ; preds = %for.cond118
  ...
  %14 = load i32, ptr %arrayidx122, align 4, !tbaa !5, !invariant.load !17
...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15)
  br label %if.end136
...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  %16 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %sub140 = sub nsw i32 %8, %16
...
for.inc148:                                       ; preds = %for.cond137
  ...
  %call147 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %17)
...
for.inc170:                                       ; preds = %for.cond158
  ...
  %19 = load i32, ptr %arrayidx168, align 4, !tbaa !5
  %call169 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %19)
...
land.lhs.true181:                                 ; preds = %if.end178
  ...
  %20 = load i32, ptr %arrayidx184, align 4, !tbaa !5
  %cmp185 = icmp ne i32 %20, %8
...
land.lhs.true190:                                 ; preds = %lor.lhs.false
  ...
  %21 = load i32, ptr %arrayidx193, align 4, !tbaa !5
  %cmp194 = icmp ne i32 %21, %8
