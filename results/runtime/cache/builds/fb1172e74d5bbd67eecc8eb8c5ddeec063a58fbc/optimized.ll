...
entry:
  %__c.addr.i9 = alloca i8, align 1
  %__c.addr.i = alloca i8, align 1
  %sentence = alloca [50 x i8], align 16
  call void @llvm.lifetime.start.p0(i64 50, ptr nonnull %sentence) #5
  br label %while.cond
...
if.else:                                          ; preds = %while.body5
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i9)
  store i8 32, ptr %__c.addr.i9, align 1, !tbaa !10
  ...
  %gep29 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i12
  %3 = load i64, ptr %gep29, align 8, !tbaa !16
  %cmp.not.i15 = icmp eq i64 %3, 0
  br i1 %cmp.not.i15, label %if.end.i19, label %if.then.i16

if.then.i16:                                      ; preds = %if.else
  %call1.i17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i9, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit21

if.end.i19:                                       ; preds = %if.else
  %call2.i20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit21

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit21: ; preds = %if.then.i16, %if.end.i19
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i9)
  br label %while.cond10

while.cond10:                                     ; preds = %while.cond10, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit21
  %p.2 = phi ptr [ %p.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit21 ], [ %incdec.ptr14, %while.cond10 ]
  %4 = load i8, ptr %p.2, align 1, !tbaa !10
  %cmp12 = icmp eq i8 %4, 32
  %incdec.ptr14 = getelementptr inbounds nuw i8, ptr %p.2, i64 1
  br i1 %cmp12, label %while.cond10, label %if.end, !llvm.loop !27
...
while.end16:                                      ; preds = %while.cond2
  %vtable.i23 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !14
  ...
  call void @llvm.lifetime.end.p0(i64 50, ptr nonnull %sentence) #5
  ret i32 0
}
