...
for.body15:                                       ; preds = %for.cond13
  ...
  %3 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom25
  %4 = getelementptr inbounds [100 x i32], ptr %3, i64 0, i64 %idxprom27
...
for.inc42.gvnsink.split:                          ; preds = %if.else, %for.body15
  %arrayidx38 = getelementptr inbounds [10 x i32], ptr %b, i64 0, i64 %idxprom25
  store i32 %5, ptr %arrayidx38, align 4, !tbaa !5
...
for.body53:                                       ; preds = %for.cond51
  ...
  %8 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom65
  %9 = getelementptr inbounds [100 x i32], ptr %8, i64 0, i64 %idxprom67
  %10 = load i32, ptr %9, align 4, !tbaa !5, !invariant.load !13
...
if.else64:                                        ; preds = %for.body53
  ...
  %11 = load i32, ptr %arrayidx70, align 4, !tbaa !5, !invariant.load !13
...
for.inc83.gvnsink.split:                          ; preds = %if.else64, %for.body53
  %arrayidx78 = getelementptr inbounds [10 x i32], ptr %d, i64 0, i64 %idxprom67
