...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull align 16 %num) #8
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc29
  %indvars.iv31 = phi i64 [ 0, %for.cond3.preheader ], [ %indvars.iv.next32, %for.inc29 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.inc27
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc27 ], [ %1, %for.cond3 ]
  %indvars.iv.next28 = add nsw i64 %indvars.iv27, -1
  %cmp8 = icmp sgt i64 %indvars.iv.next28, %indvars.iv31
  br i1 %cmp8, label %for.body10, label %for.inc29

for.body10:                                       ; preds = %for.cond7
  %2 = add nsw i64 %indvars.iv27, -2
  ...
  %arrayidx15 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %indvars.iv.next28
...
for.cond33:                                       ; preds = %for.cond3, %for.inc50
  ...
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc50 ], [ 0, %for.cond3 ]
  %cnt.0 = phi i32 [ %cnt.1, %for.inc50 ], [ 0, %for.cond3 ]
  %5 = sext i32 %.pre38 to i64
  %cmp34 = icmp slt i64 %indvars.iv35, %5
  br i1 %cmp34, label %for.body36, label %for.end52

for.body36:                                       ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw [500 x i32], ptr %num, i64 0, i64 %indvars.iv35
...
for.end52:                                        ; preds = %for.cond33
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %num) #9
