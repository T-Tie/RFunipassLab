...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %num) #6
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 dereferenceable(50) %word) #6
...
while.body:                                       ; preds = %while.cond
  ...
  %call.i.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #7
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(50) %word, i64 noundef %call.i.i)
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #8
...
if.then12:                                        ; preds = %if.else
  %vbase.offset.i36 = load i64, ptr %vbase.offset.ptr.i15, align 8, !invariant.load !9
  ...
  %call.i.i1 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #7
  %call1.i2 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i40, ptr noundef nonnull align 16 dereferenceable(50) %word, i64 noundef %call.i.i1)
  %call17 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #8
...
if.then21:                                        ; preds = %if.else19
  ...
  store i8 32, ptr %__c.addr.i, align 1, !tbaa !10
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i15, align 8, !invariant.load !9
  %gep50 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %3 = load i64, ptr %gep50, align 8, !tbaa !11, !invariant.load !9
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call.i.i4 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #7
  %call1.i5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull align 16 dereferenceable(50) %word, i64 noundef %call.i.i4)
  %vtable.i41 = load ptr, ptr %retval.0.i, align 8, !tbaa !22, !invariant.load !9
  %vbase.offset.ptr.i42 = getelementptr i8, ptr %vtable.i41, i64 -24
  %vbase.offset.i43 = load i64, ptr %vbase.offset.ptr.i42, align 8, !invariant.load !9
...
if.else26:                                        ; preds = %if.else19
  ...
  store i8 32, ptr %__c.addr.i13, align 1, !tbaa !10
  %vbase.offset.i16 = load i64, ptr %vbase.offset.ptr.i15, align 8, !invariant.load !9
  %gep = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i16
  %4 = load i64, ptr %gep, align 8, !tbaa !11, !invariant.load !9
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit25: ; preds = %if.then.i20, %if.end.i23
  ...
  %call.i.i26 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #7
  %call1.i27 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i22, ptr noundef nonnull align 16 dereferenceable(50) %word, i64 noundef %call.i.i26)
  br label %if.end31
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull %word) #7
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !35, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !10, !invariant.load !9
  br label %return
...
!27 = !{!28, !32, i64 240}
!28 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !12, i64 0, !29, i64 216, !7, i64 224, !30, i64 225, !31, i64 232, !32, i64 240, !33, i64 248, !34, i64 256}
!29 = !{!"p1 _ZTSSo", !17, i64 0}
!30 = !{!"bool", !7, i64 0}
!31 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !17, i64 0}
!32 = !{!"p1 _ZTSSt5ctypeIcE", !17, i64 0}
!33 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!34 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!35 = !{!36, !7, i64 56}
