...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv21 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next22, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %sub, i32 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv21
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv28 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next29, %for.inc44 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond34.not = icmp eq i32 %j.0, %smax33
  br i1 %exitcond34.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax30 = call i32 @llvm.smax.i32(i32 %indvars.iv28, i32 0)
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax39 = call i32 @llvm.smax.i32(i32 %m.0, i32 0)
  %wide.trip.count40 = zext nneg i32 %smax39 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv25 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next26, %for.inc41 ]
  %exitcond32.not = icmp eq i64 %indvars.iv25, %wide.trip.count31
  br i1 %exitcond32.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv25
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next26
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv35 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next36, %for.inc58 ]
  %exitcond41.not = icmp eq i64 %indvars.iv35, %wide.trip.count40
  br i1 %exitcond41.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv35
  ...
  %cmp54.not = icmp eq i64 %indvars.iv35, %4
