...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc7 ], [ 0, %entry ]
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %smax69 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 0)
  %wide.trip.count75 = zext nneg i32 %smax69 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv59, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end52, %for.cond10.preheader
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.end52 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond76.not, label %if.then61, label %for.cond13

for.cond13:                                       ; preds = %for.cond10, %for.body15
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.body15 ], [ 0, %for.cond10 ]
  %max.0 = phi i32 [ %spec.select, %for.body15 ], [ 0, %for.cond10 ]
  %l1.1 = phi i32 [ %spec.select55, %for.body15 ], [ %l1.0, %for.cond10 ]
...
for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv72, i64 %indvars.iv62
  %5 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %cmp20 = icmp sgt i32 %5, %max.0
  %spec.select = call i32 @llvm.smax.i32(i32 %5, i32 %max.0)
  %6 = trunc nuw nsw i64 %indvars.iv62 to i32
  %spec.select55 = select i1 %cmp20, i32 %6, i32 %l1.1
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  br label %for.cond13, !llvm.loop !13

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc50
  %indvars.iv65 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next66, %for.inc50 ]
  %min.1 = phi i32 [ %min.0, %for.cond28.preheader ], [ %min.2, %for.inc50 ]
  %l2.1 = phi i32 [ %l2.0, %for.cond28.preheader ], [ %l2.2, %for.inc50 ]
  %exitcond71.not = icmp eq i64 %indvars.iv65, %wide.trip.count75
  br i1 %exitcond71.not, label %for.end52, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %cmp31 = icmp eq i64 %indvars.iv65, 0
  br i1 %cmp31, label %if.end37.thread, label %if.end37

if.end37:                                         ; preds = %for.body30
  %arrayidx41 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %indvars.iv65, i64 %idxprom40
  %7 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !14
  %cmp42 = icmp slt i32 %7, %min.1
  %spec.select56 = call i32 @llvm.smin.i32(i32 %7, i32 %min.1)
  %8 = trunc nuw nsw i64 %indvars.iv65 to i32
  %spec.select57 = select i1 %cmp42, i32 %8, i32 %l2.1
  br label %for.inc50
...
for.inc50:                                        ; preds = %if.end37, %if.end37.thread
  %min.2 = phi i32 [ %9, %if.end37.thread ], [ %spec.select56, %if.end37 ]
  %l2.2 = phi i32 [ 0, %if.end37.thread ], [ %spec.select57, %if.end37 ]
