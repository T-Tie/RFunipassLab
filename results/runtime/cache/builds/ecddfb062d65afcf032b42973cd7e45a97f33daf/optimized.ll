...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x) #7
...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select10 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select10
  ...
  %or.cond11 = or i1 %cmp12, %or.cond
  %x.promoted14 = load i32, ptr %x, align 1
  %smax17 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond11, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %add1915 = phi i32 [ %add, %for.inc ], [ %x.promoted14, %for.body ]
  %m.0 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond18.not = icmp eq i32 %m.0, %smax17
  br i1 %exitcond18.not, label %for.inc53, label %for.body16
...
for.inc:                                          ; preds = %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %for.body16, %sw.bb17, %sw.default
  ...
  %add = add nsw i32 %.sink, %add1915
  %inc = add i32 %m.0, 1
  br label %for.cond14, !llvm.loop !9

for.cond30:                                       ; preds = %for.body, %for.inc40
  %add3812 = phi i32 [ %add34, %for.inc40 ], [ %x.promoted14, %for.body ]
  %m.1 = phi i32 [ %inc41, %for.inc40 ], [ %a.1, %for.body ]
  %exitcond.not = icmp eq i32 %m.1, %smax17
...
for.inc40:                                        ; preds = %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %for.body32, %sw.bb35, %sw.default37
  %.sink19 = phi i32 [ 28, %sw.bb35 ], [ 30, %sw.default37 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ], [ 31, %for.body32 ]
  %add34 = add nsw i32 %.sink19, %add3812
  %inc41 = add i32 %m.1, 1
  br label %for.cond30, !llvm.loop !12

for.inc53:                                        ; preds = %for.cond30, %for.cond14
  %add1915.lcssa.sink = phi i32 [ %add1915, %for.cond14 ], [ %add3812, %for.cond30 ]
  store i32 %add1915.lcssa.sink, ptr %x, align 1
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %x)
  %inc54 = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !13

for.end55:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %x) #8
...
define internal void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0) #5 {
for.end_to_outline:
  %1 = load i32, ptr %0, align 4, !tbaa !5
  %rem20 = srem i32 %1, 7
  %cmp21 = icmp eq i32 %rem20, 0
  %.str..str.1 = select i1 %cmp21, ptr @.str, ptr @.str.1
  %call23 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str..str.1)
