...
if.end37:                                         ; preds = %if.then32, %for.body30
  %l2.2 = phi i32 [ %k.0, %if.then32 ], [ %l2.1, %for.body30 ]
  %min.2 = phi i32 [ %6, %if.then32 ], [ %min.1, %for.body30 ]
...
if.end49:                                         ; preds = %if.then44, %land.lhs.true, %if.end37
  ...
  %min.3 = phi i32 [ %6, %if.then44 ], [ %min.2, %land.lhs.true ], [ %min.2, %if.end37 ]
  br label %for.inc50
