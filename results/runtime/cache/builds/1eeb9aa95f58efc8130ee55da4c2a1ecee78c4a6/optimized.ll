...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %b) #6
  call void @llvm.lifetime.start.p0(i64 49284, ptr nonnull %c) #6
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv2, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv8, %5
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc24 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %y2, align 4, !tbaa !5
  %9 = sext i32 %8 to i64
  %cmp17 = icmp slt i64 %indvars.iv5, %9
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv8, i64 %indvars.iv5
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc57
  %indvars.iv21 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next22, %for.inc57 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond60, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc54
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc54 ], [ 0, %for.cond30 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.inc57, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv21, i64 %indvars.iv15
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc51
  %indvars.iv11 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next12, %for.inc51 ]
...
for.inc51:                                        ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv11
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv11, i64 %indvars.iv15
...
for.cond60:                                       ; preds = %for.cond30, %for.inc78
  ...
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc78 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp61 = icmp slt i64 %indvars.iv30, %14
  br i1 %cmp61, label %for.cond64, label %for.end80

for.cond64:                                       ; preds = %for.cond60, %for.inc75
  %15 = phi i32 [ %.pre33, %for.inc75 ], [ %12, %for.cond60 ]
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc75 ], [ 0, %for.cond60 ]
  %16 = sext i32 %15 to i64
  %cmp65 = icmp slt i64 %indvars.iv27, %16
  br i1 %cmp65, label %for.body66, label %for.inc78

for.body66:                                       ; preds = %for.cond64
  %arrayidx70 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv30, i64 %indvars.iv27
  ...
  %cmp72.not = icmp eq i64 %indvars.iv27, %19
  br i1 %cmp72.not, label %if.else, label %if.then

if.then:                                          ; preds = %for.body66
  %call73 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str)
  br label %for.inc75
...
for.end80:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %c) #6
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 49284, ptr nonnull %a) #6
  ret i32 0
}
