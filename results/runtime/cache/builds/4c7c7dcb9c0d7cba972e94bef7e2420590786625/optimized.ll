...
for.cond:                                         ; preds = %for.inc15, %entry
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc15 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv16, i64 %indvars.iv
...
for.inc15:                                        ; preds = %for.cond1
  %arrayidx8 = getelementptr inbounds nuw [100 x [2 x double]], ptr %a, i64 0, i64 %indvars.iv16
  ...
  %div = fdiv double %3, %4
  %arrayidx14 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv16
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc41
  ...
  %indvars.iv19 = phi i64 [ 1, %for.cond18.preheader ], [ %indvars.iv.next20, %for.inc41 ]
  %6 = sext i32 %5 to i64
  %cmp20.not.not = icmp slt i64 %indvars.iv19, %6
  br i1 %cmp20.not.not, label %for.body21, label %for.end43

for.body21:                                       ; preds = %for.cond18
  %arrayidx23 = getelementptr inbounds nuw [100 x double], ptr %b, i64 0, i64 %indvars.iv19
...
for.inc41:                                        ; preds = %for.body21, %if.else, %if.else37
  ...
  %call38 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str.2.sink.sink)
