...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12 = icmp slt i64 %indvars.iv21, %2
  br i1 %cmp12, label %for.body13, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond10
  %sext32 = shl i64 %2, 32
  %3 = ashr exact i64 %sext32, 32
  %sext33 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext33, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv21
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %6 = sub nuw nsw i64 %indvars.iv21, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc31
  %indvars.iv28 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next29, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv28, %3
  br i1 %cmp24, label %for.inc31, label %for.end37

for.inc31:                                        ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv28, %4
  %arrayidx28 = getelementptr inbounds nuw [256 x i8], ptr %tar, i64 0, i64 %8
  %9 = load i8, ptr %arrayidx28, align 1, !tbaa !5
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv28
