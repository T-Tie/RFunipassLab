...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef %words) #10
  br label %for.cond
...
for.cond2:                                        ; preds = %for.inc55, %for.end
  ...
  %j.0 = phi i32 [ 0, %for.end ], [ %j.1, %for.inc55 ]
...
for.body4:                                        ; preds = %for.cond2
  ...
  %call8 = call i64 @strlen(ptr noundef %arrayidx6) #11
...
if.then:                                          ; preds = %for.body4
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx13)
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc25, %if.then
  %.sink2 = phi i32 [ %j.0, %if.then ], [ %add16, %for.inc25 ]
  %add16 = add nsw i32 %.sink2, 1
...
for.inc25:                                        ; preds = %for.cond17
  ...
  %idxprom21 = sext i32 %add16 to i64
  %arrayidx22 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom21
...
for.end27:                                        ; preds = %for.cond17
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc55
...
if.then30:                                        ; preds = %if.end
  ...
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx32)
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc44, %if.then30
  %.sink1 = phi i32 [ %j.0, %if.then30 ], [ %add35, %for.inc44 ]
  %add35 = add nsw i32 %.sink1, 1
...
for.inc44:                                        ; preds = %for.cond36
  ...
  %idxprom40 = sext i32 %add35 to i64
  %arrayidx41 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom40
  %call43 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call39, ptr noundef nonnull %arrayidx41)
  br label %for.cond36, !llvm.loop !13

for.end46:                                        ; preds = %for.cond36
  %call50 = call i64 @strlen(ptr noundef %arrayidx6) #11
...
for.inc55:                                        ; preds = %if.end, %for.end46, %for.end27
  %j.1 = phi i32 [ %add16, %for.end27 ], [ %add35, %for.end46 ], [ %j.0, %if.end ]
  %csum.1 = phi i32 [ 0, %for.end27 ], [ %conv52, %for.end46 ], [ %conv10, %if.end ]
...
for.end57:                                        ; preds = %for.cond2
  ...
  %call61 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %arrayidx59)
  br label %for.cond63

for.cond63:                                       ; preds = %for.inc71, %for.end57
  %.sink = phi i32 [ %j.0, %for.end57 ], [ %add62, %for.inc71 ]
  %add62 = add nsw i32 %.sink, 1
...
for.inc71:                                        ; preds = %for.cond63
  ...
  %idxprom67 = sext i32 %add62 to i64
  %arrayidx68 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom67
  %call70 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call66, ptr noundef nonnull %arrayidx68)
  br label %for.cond63, !llvm.loop !15

for.end73:                                        ; preds = %for.cond63
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef %words) #10
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !16, !invariant.load !18
...
if.else:                                          ; preds = %entry
  %call = call noundef i64 @_ZNSt11char_traitsIcE6lengthEPKc(ptr noundef %__s) #10
...
entry:
  ...
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !18
  %add.ptr = getelementptr inbounds i8, ptr %__out, i64 %vbase.offset
  %call = call noundef i64 @_ZNKSt8ios_base5widthEv(ptr noundef nonnull align 8 dereferenceable(216) %add.ptr) #10
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !16, !invariant.load !18
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !18
...
entry:
  ...
  %call2 = call noundef i32 @_ZStorSt12_Ios_IostateS_(i32 noundef %call, i32 noundef %__state) #10
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !20, !invariant.load !18
  ret i32 %0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !31, !invariant.load !18
  ret i64 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !32, !invariant.load !18
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !40, !invariant.load !18
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !19, !invariant.load !18
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !16, !invariant.load !18
...
!31 = !{!21, !22, i64 16}
!32 = !{!33, !37, i64 240}
!33 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !21, i64 0, !34, i64 216, !7, i64 224, !35, i64 225, !36, i64 232, !37, i64 240, !38, i64 248, !39, i64 256}
!34 = !{!"p1 _ZTSSo", !26, i64 0}
!35 = !{!"bool", !7, i64 0}
!36 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !26, i64 0}
!37 = !{!"p1 _ZTSSt5ctypeIcE", !26, i64 0}
!38 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !26, i64 0}
!39 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !26, i64 0}
!40 = !{!41, !7, i64 56}
...
!43 = !{!"p1 _ZTS15__locale_struct", !26, i64 0}
!44 = !{!"p1 int", !26, i64 0}
!45 = !{!"p1 short", !26, i64 0}
