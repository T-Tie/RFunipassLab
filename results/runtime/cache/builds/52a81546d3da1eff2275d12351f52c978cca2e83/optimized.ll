...
_Z5qufeni.exit:                                   ; preds = %_Z5powerii.exit.i
  %3 = call i32 @llvm.smax.i32(i32 %phiofops.i, i32 1)
...
if.end:                                           ; preds = %entry
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 %h, i32 %n)
  br label %for.cond
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax14 = tail call i32 @llvm.smax.i32(i32 %j.0, i32 0)
...
cleanup:                                          ; preds = %for.cond9, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %a) #8
  br label %return
...
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 %b, i32 0)
