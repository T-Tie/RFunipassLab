...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %m, %i.0
  %call = tail call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %i.0) #6
...
if.then10:                                        ; preds = %for.body7
  ...
  %call12 = tail call noundef i32 @_Z3funii(i32 noundef %div11, i32 noundef %i.1) #6
...
for.inc10:                                        ; preds = %for.cond3
  ...
  %vtable.i = load ptr, ptr %call8, align 8, !tbaa !15, !invariant.load !14
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !15, !invariant.load !14
...
!17 = distinct !{!17, !6, !7}
!18 = !{!19, !11, i64 56}
!19 = !{!"_ZTSSt5ctypeIcE", !20, i64 0, !21, i64 16, !23, i64 24, !24, i64 32, !24, i64 40, !25, i64 48, !11, i64 56, !11, i64 57, !11, i64 313, !11, i64 569}
!20 = !{!"_ZTSNSt6locale5facetE", !10, i64 8}
