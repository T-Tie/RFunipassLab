...
entry:
  ...
  call fastcc void @outlined_ir_func_0(ptr %call4, ptr null, i32 -1)
...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call71.loc)
  call void @outlined_ir_func_0.6(ptr %call69, i32 %.sink277, ptr %call71.loc)
  %call71.reload = load ptr, ptr %call71.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call71.loc)
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call73.loc)
  call void @outlined_ir_func_0.6(ptr %call71.reload, i32 %.sink, ptr %call73.loc)
  %call73.reload = load ptr, ptr %call73.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call73.loc)
...
if.then:                                          ; preds = %sw.epilog
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call.i.i251.loc)
  call fastcc void @outlined_ir_func_0(ptr %call75, ptr %call.i.i251.loc, i32 0)
  %call.i.i251.reload = load ptr, ptr %call.i.i251.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call.i.i251.loc)
...
if.else:                                          ; preds = %sw.epilog
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %call81.loc)
  call void @outlined_ir_func_0.6(ptr %call79, i32 %rem, ptr %call81.loc)
  %call81.reload = load ptr, ptr %call81.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %call81.loc)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call81.sink282 = phi ptr [ %call81.reload, %if.else ], [ %call77, %if.then ]
  call fastcc void @outlined_ir_func_0(ptr %call81.sink282, ptr null, i32 -1)
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1, i32 %2) unnamed_addr #4 {
newFuncRoot:
  br label %entry_to_outline

entry_to_outline:                                 ; preds = %newFuncRoot
  %vtable.i = load ptr, ptr %0, align 8, !tbaa !9, !invariant.load !11
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal void @outlined_ir_func_0.6(ptr %0, i32 %1, ptr %2) #4 {
newFuncRoot:
  br label %sw.epilog.sink.split_to_outline

sw.epilog.sink.split_to_outline:                  ; preds = %newFuncRoot
  %vtable.i224 = load ptr, ptr %0, align 8, !tbaa !9, !invariant.load !11
  ...
  br label %sw.epilog.sink.split_after_outline.exitStub

sw.epilog.sink.split_after_outline.exitStub:      ; preds = %sw.epilog.sink.split_to_outline
