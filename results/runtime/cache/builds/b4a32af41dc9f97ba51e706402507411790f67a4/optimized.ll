...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv6 = phi i64 [ 0, %entry ], [ %indvars.iv.next7, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre10, %for.inc ]
  ...
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.3, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.3, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.3, %for.inc ]
  %6 = sext i32 %5 to i64
  %cmp2 = icmp slt i64 %indvars.iv, %6
  br i1 %cmp2, label %for.body3, label %for.cond, !llvm.loop !9

for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre11 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
land.lhs.true:                                    ; preds = %for.body3
  ...
  %star2.2 = select i1 %cmp12, i32 %9, i32 %star2.1
  %star1.2 = select i1 %cmp12, i32 %4, i32 %star1.1
  %f.2 = select i1 %cmp12, i32 1, i32 %f.1
  %10 = trunc i64 %indvars.iv to i32
  %11 = add i32 %10, -1
  br label %for.inc

for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre11, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
  ...
  %star2.3 = phi i32 [ %star2.1, %for.body3.for.inc_crit_edge ], [ %star2.2, %land.lhs.true ]
  %star1.3 = phi i32 [ %star1.1, %for.body3.for.inc_crit_edge ], [ %star1.2, %land.lhs.true ]
  %f.3 = phi i32 [ %f.1, %for.body3.for.inc_crit_edge ], [ %f.2, %land.lhs.true ]
  %.pre10 = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond1, !llvm.loop !12

for.end24:                                        ; preds = %for.cond
  %sub25 = add i32 %end1.0, 1
  %add26 = sub i32 %sub25, %star1.0
  %sub27 = add i32 %end2.0, 1
  %add28 = sub i32 %sub27, %star2.0
