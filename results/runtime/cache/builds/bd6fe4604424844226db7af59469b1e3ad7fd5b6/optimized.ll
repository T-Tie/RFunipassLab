...
for.cond2:                                        ; preds = %for.inc24, %for.end
  %.sink = phi i32 [ 0, %for.end ], [ %add, %for.inc24 ]
  %cmp3 = icmp slt i32 %.sink, 2
  br i1 %cmp3, label %for.body4, label %for.end26

for.body4:                                        ; preds = %for.cond2
  store i32 %.sink, ptr %index, align 4, !tbaa !5
...
for.cond5:                                        ; preds = %for.inc13, %for.body4
  ...
  %4 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 %idxprom16
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %8, i32 noundef %9)
