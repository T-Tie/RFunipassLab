...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %.sink15 = phi i32 [ %1, %for.body29 ], [ %dec, %for.inc40 ]
  %cmp31 = icmp sge i32 %.sink15, 1
...
for.body32:                                       ; preds = %for.cond30
  ...
  %idxprom35 = sext i32 %.sink15 to i64
  %arrayidx36 = getelementptr inbounds [100 x i32], ptr %arrayidx34, i64 0, i64 %idxprom35
  %7 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !15
...
if.then38:                                        ; preds = %for.body32
  ...
  store i32 %.sink15, ptr %j2, align 4, !tbaa !5
  br label %for.inc42

for.inc40:                                        ; preds = %for.body32
  %dec = add nsw i32 %.sink15, -1
