...
for.cond38:                                       ; preds = %for.inc49, %for.body36
  ...
  %12 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51
  %13 = getelementptr inbounds [100 x i32], ptr %12, i64 0, i64 %idxprom53
  %14 = load i32, ptr %13, align 4, !tbaa !5, !invariant.load !13
  %cmp55 = icmp eq i32 %14, 0
