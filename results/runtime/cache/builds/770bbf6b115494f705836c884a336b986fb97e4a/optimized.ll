...
for.cond15:                                       ; preds = %for.inc35, %for.end
  ...
  %cmp16 = icmp slt i32 %i.1, %m.0.lcssa
...
for.cond18:                                       ; preds = %for.inc26, %for.body17
  ...
  %cmp19 = icmp slt i32 %k.0, %j.0.lcssa
...
for.end28:                                        ; preds = %for.cond18
  %sum.0.lcssa = phi i32 [ %sum.0, %for.cond18 ]
  %cmp29 = icmp eq i32 %sum.0.lcssa, 0
