...
for.cond13.preheader:                             ; preds = %for.cond
  %smax13 = call i32 @llvm.smax.i32(i32 %m2, i32 1)
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc37
  ...
  %exitcond14.not = icmp eq i32 %1, %smax13
  br i1 %exitcond14.not, label %for.end39, label %for.body15
...
if.then28:                                        ; preds = %for.body15
  ...
  %spec.select11.neg = select i1 %tobool30.not, i32 -3, i32 -2
  %sub34 = add nsw i32 %spec.select11.neg, %add16
  br label %for.inc37
