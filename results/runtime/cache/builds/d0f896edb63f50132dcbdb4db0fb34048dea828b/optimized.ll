...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54: ; preds = %if.then6.i35, %land.lhs.true.i41, %if.then19.i46, %if.then28.i53
  ...
  %smax68 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc30, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54
  %indvars.iv79 = phi i32 [ %indvars.iv.next80, %for.inc30 ], [ %conv9, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54 ]
  %indvars.iv74 = phi i32 [ %indvars.iv.next75, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc30 ], [ 0, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit54 ]
  %exitcond70.not = icmp eq i64 %indvars.iv, %wide.trip.count69
  br i1 %exitcond70.not, label %if.then34, label %for.body
...
for.cond14:                                       ; preds = %for.body, %for.inc
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc ], [ 1, %for.body ]
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc ], [ %indvars.iv, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %arrayidx18 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv.next61
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !22, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv62
...
for.cond37.preheader:                             ; preds = %for.end
  %wide.trip.count77 = zext i32 %indvars.iv74 to i64
  br label %for.cond37

for.inc30:                                        ; preds = %for.body, %for.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %indvars.iv.next75 = add nuw i32 %indvars.iv74, 1
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  %indvars.iv71 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next72, %for.inc43 ]
  %exitcond78.not = icmp eq i64 %indvars.iv71, %wide.trip.count77
  br i1 %exitcond78.not, label %for.end45, label %for.inc43

for.inc43:                                        ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [256 x i8], ptr %a, i64 0, i64 %indvars.iv71
...
for.end45:                                        ; preds = %for.cond37
  ...
  %12 = sext i32 %indvars.iv79 to i64
  %sext = shl i64 %call6, 32
  %13 = ashr exact i64 %sext, 32
  br label %for.cond48

for.cond48:                                       ; preds = %for.inc54, %for.end45
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.inc54 ], [ %12, %for.end45 ]
  %cmp49 = icmp slt i64 %indvars.iv82, %13
  br i1 %cmp49, label %for.inc54, label %if.end57

for.inc54:                                        ; preds = %for.cond48
  %arrayidx52 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %indvars.iv82
