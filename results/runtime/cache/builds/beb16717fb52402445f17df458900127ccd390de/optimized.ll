...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv65 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next66, %for.inc33 ]
  %indvars.iv35 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next36, %for.inc33 ]
  %smax67 = call i64 @llvm.smax.i64(i64 %indvars.iv65, i64 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  ...
  %exitcond68 = icmp eq i64 %indvars.iv32, %smax67
  br i1 %exitcond68, label %for.end18, label %for.body10
