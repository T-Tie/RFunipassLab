...
land.end:                                         ; preds = %land.rhs, %while.cond8
  %7 = phi i1 [ false, %while.cond8 ], [ %cmp16, %land.rhs ]
  br i1 %7, label %while.body17, label %while.end19
...
while.end19:                                      ; preds = %land.end
  %8 = load i32, ptr %len, align 4, !tbaa !10
  %add = add nsw i32 %8, %5
...
for.cond:                                         ; preds = %for.inc, %if.then
  ...
  %sub = sub nsw i32 %3, 1
  %cmp25 = icmp sle i32 %9, %sub
  br i1 %cmp25, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %idx.ext26 = sext i32 %9 to i64
  %add.ptr27 = getelementptr inbounds i8, ptr %incdec.ptr23, i64 %idx.ext26
  %10 = load i8, ptr %add.ptr27, align 1, !tbaa !12
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %10)
  br label %for.inc
...
for.cond33:                                       ; preds = %for.inc40, %if.else
  ...
  %cmp35 = icmp sle i32 %12, %sub34
  br i1 %cmp35, label %for.body36, label %for.end42

for.body36:                                       ; preds = %for.cond33
  %idx.ext37 = sext i32 %12 to i64
  %add.ptr38 = getelementptr inbounds i8, ptr %incdec.ptr23, i64 %idx.ext37
  %13 = load i8, ptr %add.ptr38, align 1, !tbaa !12
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %13)
  br label %for.inc40
