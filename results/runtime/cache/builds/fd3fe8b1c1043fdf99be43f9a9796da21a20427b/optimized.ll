...
for.inc:                                          ; preds = %lor.lhs.false, %land.lhs.true12, %if.then
...
for.cond39:                                       ; preds = %for.inc50, %for.end38
  %8 = phi i32 [ %inc51, %for.inc50 ], [ 97, %for.end38 ]
  %cmp40 = icmp sle i32 %8, 122
...
if.then45:                                        ; preds = %for.body41
  %call48 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %9, i32 noundef %10)
  br label %for.inc50
