...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76: ; preds = %if.then6.i48, %if.then19.i64, %if.then28.i71
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #12
...
for.cond37:                                       ; preds = %for.cond37.preheader, %for.inc43
  ...
  br i1 %exitcond155.not, label %for.end45, label %for.inc43
...
for.inc43:                                        ; preds = %for.cond37
  ...
  call void @outlined_ir_func_0(i8 %17, ptr noundef nonnull dereferenceable(1) %__c.addr.i)
...
for.end45:                                        ; preds = %for.cond37
  %call.i.i89 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #12
...
for.inc54:                                        ; preds = %for.cond48
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i97)
  call void @outlined_ir_func_0(i8 %20, ptr noundef nonnull dereferenceable(1) %__c.addr.i97)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i97)
...
define internal void @outlined_ir_func_0(i8 %0, ptr noundef nonnull dereferenceable(1) %1) #9 {
for.body39_to_outline:
...
if.then.i:                                        ; preds = %for.body39_to_outline
  %call1.i87 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(1) %1, i64 noundef 1)
