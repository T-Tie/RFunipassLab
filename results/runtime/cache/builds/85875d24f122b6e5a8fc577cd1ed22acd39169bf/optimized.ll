...
if.end16:                                         ; preds = %if.else10, %if.else7, %if.else, %if.then, %if.else13, %if.else5
  %.sink39 = phi i32 [ %1, %if.else13 ], [ %0, %if.else5 ], [ %1, %if.then ], [ %2, %if.else ], [ %0, %if.else7 ], [ %2, %if.else10 ]
  %__b.sink = phi ptr [ %__b, %if.else13 ], [ %__a, %if.else5 ], [ %__b, %if.then ], [ %__c, %if.else ], [ %__a, %if.else7 ], [ %__c, %if.else10 ]
  %.sink = phi i32 [ %3, %if.else13 ], [ %3, %if.else5 ], [ %3, %if.then ], [ %3, %if.else ], [ %3, %if.else7 ], [ %3, %if.else10 ]
  store i32 %.sink39, ptr %__result, align 4, !tbaa !5
