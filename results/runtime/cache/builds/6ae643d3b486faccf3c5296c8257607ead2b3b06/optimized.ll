...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre31, %for.inc ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %8, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.217, %for.inc ]
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.219, %for.inc ]
  %end1.1 = phi i32 [ %end1.0, %for.cond1.preheader ], [ %end1.2, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.cond1.preheader ], [ %end2.2, %for.inc ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.221, %for.inc ]
  %6 = sext i32 %5 to i64
...
for.end24:                                        ; preds = %for.cond
  %reass.sub34 = sub i32 %end1.0, %star1.0
  %add26 = add i32 %reass.sub34, 1
  %reass.sub35 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub35, 1
