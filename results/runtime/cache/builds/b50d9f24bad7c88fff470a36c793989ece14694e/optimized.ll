...
for.inc45:                                        ; preds = %for.cond39
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %7)
...
for.end47:                                        ; preds = %for.cond39
  ...
  %8 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %call50 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8)
