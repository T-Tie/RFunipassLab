...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv19 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next20, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv19
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %3 = trunc nuw nsw i64 %indvars.iv19 to i32
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc35
  %indvars.iv31 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next32, %for.inc35 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count
  br i1 %exitcond36.not, label %for.end37, label %for.cond18

for.cond18:                                       ; preds = %for.cond15, %for.body20
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body20 ], [ 0, %for.cond15 ]
  %sum.0 = phi i32 [ %add, %for.body20 ], [ 0, %for.cond15 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end28, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx22 = getelementptr inbounds nuw [100000 x i32], ptr %b, i64 0, i64 %indvars.iv25
  %4 = load i32, ptr %arrayidx22, align 4, !tbaa !12, !invariant.load !11
  %5 = zext i32 %4 to i64
  %cmp23.not = icmp eq i64 %indvars.iv31, %5
...
if.then30:                                        ; preds = %for.end28
  %arrayidx32 = getelementptr inbounds nuw [10000 x i8], ptr %str, i64 0, i64 %indvars.iv31
