...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %a) #10
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %lenq) #10
  store i32 0, ptr %lenq, align 4, !tbaa !5
  ...
  store ptr %a, ptr %p, align 8, !tbaa !9
  br label %while.cond
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %0 = load i8, ptr %add.ptr, align 1, !tbaa !12
...
while.end:                                        ; preds = %while.cond
  store i32 %i.0, ptr %lenq, align 4, !tbaa !5
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  ...
  %4 = load i8, ptr %add.ptr10, align 1, !tbaa !12, !invariant.load !16
...
if.end44:                                         ; preds = %for.end, %if.then31, %for.end42
  ...
  %6 = load i32, ptr %lenq, align 4, !tbaa !5
  %7 = load ptr, ptr %p, align 8, !tbaa !9
  %idx.ext45 = sext i32 %6 to i64
  %add.ptr46 = getelementptr inbounds i8, ptr %7, i64 %idx.ext45
  store ptr %add.ptr46, ptr %p, align 8, !tbaa !9
  %incdec.ptr47 = getelementptr inbounds nuw i8, ptr %add.ptr46, i32 1
  store ptr %incdec.ptr47, ptr %p, align 8, !tbaa !9
  store i32 %i.1, ptr %lenq, align 4, !tbaa !5
  br label %while.cond4, !llvm.loop !18

while.end48:                                      ; preds = %while.cond4
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %lenq) #11
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %p) #11
...
entry:
  %vtable = load ptr, ptr %this, align 8, !tbaa !19, !invariant.load !16
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !19, !invariant.load !16
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !16
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !19, !invariant.load !16
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !16
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !21, !invariant.load !16
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !12, !invariant.load !16
  br label %return
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !44, !invariant.load !16
  ret i64 %0
}
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !45, !invariant.load !16
  ret i32 %0
}
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1, ptr %2) unnamed_addr #9 {
if.then_to_outline:
...
for.inc:                                          ; preds = %for.cond
  ...
  %6 = load i8, ptr %add.ptr27, align 1, !tbaa !12, !invariant.load !16
  %call28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %6)
  %7 = load i32, ptr %0, align 4, !tbaa !5
  %inc29 = add nsw i32 %7, 1
  store i32 %inc29, ptr %0, align 4, !tbaa !5
...
!21 = !{!22, !35, i64 240}
!22 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !23, i64 0, !32, i64 216, !7, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
...
!27 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !11, i64 0}
!28 = !{!"_ZTSNSt8ios_base6_WordsE", !11, i64 0, !24, i64 8}
!29 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !11, i64 0}
!30 = !{!"_ZTSSt6locale", !31, i64 0}
!31 = !{!"p1 _ZTSNSt6locale5_ImplE", !11, i64 0}
