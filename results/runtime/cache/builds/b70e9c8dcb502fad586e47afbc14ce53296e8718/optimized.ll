...
for.end21:                                        ; preds = %if.then, %for.cond11
  %phiofops = phi i1 [ false, %for.cond11 ], [ true, %if.then ]
  %y1.2 = phi i32 [ %j.1, %if.then ], [ %y1.0, %for.cond11 ]
  %x1.2 = phi i32 [ %i.1, %if.then ], [ %x1.0, %for.cond11 ]
  %f.1 = phi i32 [ 1, %if.then ], [ 0, %for.cond11 ]
  br i1 %phiofops, label %if.then23, label %if.end24
...
for.end27:                                        ; preds = %if.then23, %for.cond8
  %y1.1 = phi i32 [ %y1.2, %if.then23 ], [ %y1.0, %for.cond8 ]
  %x1.1 = phi i32 [ %x1.2, %if.then23 ], [ %x1.0, %for.cond8 ]
  br label %for.cond28
