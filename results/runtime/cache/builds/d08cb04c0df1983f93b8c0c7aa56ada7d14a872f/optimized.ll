...
for.end32:
  ...
  %smax48 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %7 = sext i32 %5 to i64
  %smax56 = call i32 @llvm.smax.i32(i32 %2, i32 noundef 0)
...
for.cond40.preheader:                             ; preds = %for.cond37
  %8 = mul nsw i64 %indvars.iv51, %6
  %9 = mul nsw i64 %indvars.iv51, %7
...
for.body42:                                       ; preds = %for.cond40
  %arrayidx46 = getelementptr i32, ptr %10, i64 %indvars.iv44
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %18 = phi i32 [ %.pre59, %for.inc95 ], [ %16, %for.cond77 ]
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 4 dereferenceable(4) %0, ptr noundef nonnull align 4 dereferenceable(4) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %2) unnamed_addr #6 {
entry_to_outline:
  ...
  %call2 = call noalias ptr @malloc(i64 noundef %mul1) #9
  br label %for.cond
