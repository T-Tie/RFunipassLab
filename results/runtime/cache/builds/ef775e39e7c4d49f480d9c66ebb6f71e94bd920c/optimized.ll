...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %letter) #6
...
for.cond:                                         ; preds = %if.end11, %entry
  ...
  %tobool.not = phi i1 [ true, %entry ], [ false, %if.end11 ]
  %blank.0 = phi i64 [ 0, %entry ], [ 1, %if.end11 ]
...
for.body:                                         ; preds = %for.cond
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(40) %letter, i8 48, i64 40, i1 false)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %if.then19.i, %if.then28.i
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #7
...
if.then9:                                         ; preds = %if.end
  ...
  %vtable.i5 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !9
  %vbase.offset.ptr.i6 = getelementptr i8, ptr %vtable.i5, i64 -24
  %vbase.offset.i7 = load i64, ptr %vbase.offset.ptr.i6, align 8
  %gep29 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i7
  %5 = load i64, ptr %gep29, align 8, !tbaa !11
...
if.end11:                                         ; preds = %if.end.thread, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %if.end
  %num.128 = phi i32 [ 0, %if.end.thread ], [ %num.0, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ %num.0, %if.end ]
  %blank.127 = phi i32 [ 0, %if.end.thread ], [ 1, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ], [ 0, %if.end ]
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #6
  %call1.i10 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %letter, i64 noundef %call.i.i)
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #7
  %6 = trunc i64 %call15 to i32
  %7 = add i32 %blank.127, %num.128
  %conv20 = add i32 %7, %6
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %letter) #6
  ret i32 0
}
