...
for.cond10:                                       ; preds = %for.body13, %for.cond10.preheader
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body13 ], [ %indvars.iv, %for.cond10.preheader ]
  %cmp12 = icmp slt i64 %indvars.iv29, %2
  br i1 %cmp12, label %for.body13, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond10
  %sext40 = shl i64 %2, 32
  %3 = ashr exact i64 %sext40, 32
  %sext41 = shl i64 %indvars.iv, 32
  %4 = ashr exact i64 %sext41, 32
  br label %for.cond22

for.body13:                                       ; preds = %for.cond10
  %arrayidx = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv29
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !8
  %6 = sub nuw nsw i64 %indvars.iv29, %indvars.iv
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.body25
  %indvars.iv36 = phi i64 [ %indvars.iv, %for.cond22.preheader ], [ %indvars.iv.next37, %for.body25 ]
  %cmp24 = icmp slt i64 %indvars.iv36, %3
  br i1 %cmp24, label %for.body25, label %for.end37

for.body25:                                       ; preds = %for.cond22
  %8 = sub nuw nsw i64 %indvars.iv36, %4
  ...
  %arrayidx30 = getelementptr inbounds nuw [256 x i8], ptr %zfc, i64 0, i64 %indvars.iv36
