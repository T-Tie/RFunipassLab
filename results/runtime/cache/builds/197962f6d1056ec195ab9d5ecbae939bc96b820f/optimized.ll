...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1600, ptr %a) #8
  call void @llvm.lifetime.start.p0(i64 800, ptr %b) #8
...
for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 800, ptr %b) #8
  call void @llvm.lifetime.end.p0(i64 1600, ptr %a) #8
