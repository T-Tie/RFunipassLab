...
for.end:                                          ; preds = %for.cond6
  %dig.0.lcssa = phi i32 [ %dig.0, %for.cond6 ]
  %carry.0.lcssa = phi i32 [ %carry.0, %for.cond6 ]
  %arrayidx.lcssa = phi ptr [ %arrayidx, %for.cond6 ]
  %tobool19 = icmp ne i32 %carry.0.lcssa, 0
  br i1 %tobool19, label %if.then20, label %for.inc26

if.then20:                                        ; preds = %for.end
  store i32 %carry.0.lcssa, ptr %arrayidx.lcssa, align 4, !tbaa !5
  %add23 = add nsw i32 %dig.0.lcssa, 1
...
for.end35:                                        ; preds = %for.cond29
  %st.0.lcssa = phi i32 [ %st.0, %for.cond29 ]
  %sub37 = sub nsw i32 %st.0.lcssa, 1
  br label %for.cond38
