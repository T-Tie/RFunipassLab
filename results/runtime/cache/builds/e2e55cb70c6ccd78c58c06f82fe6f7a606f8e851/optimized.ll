...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %or.cond25 = or i1 %cmp36, %or.cond
  %spec.select = select i1 %or.cond25, i32 29, i32 28
...
for.inc.gvnsink.split.fold.split:                 ; preds = %for.body5, %for.body5, %for.body5, %for.body5
  br label %for.inc.gvnsink.split

for.inc.gvnsink.split:                            ; preds = %if.then30, %for.body5, %for.body5, %for.body5, %for.body5, %for.body5, %for.body5, %for.body5, %for.inc.gvnsink.split.fold.split
  %.sink4.sink = phi i32 [ 31, %for.body5 ], [ 31, %for.body5 ], [ 31, %for.body5 ], [ 31, %for.body5 ], [ 31, %for.body5 ], [ 31, %for.body5 ], [ 31, %for.body5 ], [ 30, %for.inc.gvnsink.split.fold.split ], [ %spec.select, %if.then30 ]
  %add40 = add nsw i32 %.sink4.sink, %total.0
  br label %for.inc

for.inc:                                          ; preds = %for.body5, %for.inc.gvnsink.split
  %total.1 = phi i32 [ %add40, %for.inc.gvnsink.split ], [ %total.0, %for.body5 ]
  %inc = add i32 %6, 1
...
for.end:                                          ; preds = %for.cond3
  ...
  %puts26 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #5
