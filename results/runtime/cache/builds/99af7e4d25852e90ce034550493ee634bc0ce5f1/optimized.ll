...
for.cond2:                                        ; preds = %for.inc14, %for.body
  %1 = phi i32 [ %inc15, %for.inc14 ], [ %add, %for.body ]
...
for.cond20:                                       ; preds = %for.inc27, %for.end19
  %3 = phi i32 [ %inc28, %for.inc27 ], [ 1, %for.end19 ]
  %cmp21 = icmp sle i32 %3, 12
...
for.cond30:                                       ; preds = %for.inc48, %for.end29
  %4 = phi i32 [ %inc49, %for.inc48 ], [ 1, %for.end29 ]
  %cmp31 = icmp sle i32 %4, 12
...
for.cond33:                                       ; preds = %for.inc45, %for.body32
  %j.0 = phi i32 [ 1, %for.body32 ], [ %inc46, %for.inc45 ]
  %sub34 = sub nsw i32 %4, 1
  %cmp35 = icmp sle i32 %j.0, %sub34
...
for.cond51:                                       ; preds = %for.inc79, %for.end50
  %6 = phi i32 [ %add54, %for.inc79 ], [ 1, %for.end50 ]
  %cmp52 = icmp sle i32 %6, 12
...
for.cond55:                                       ; preds = %for.inc76, %for.body53
  %7 = phi i32 [ %inc77, %for.inc76 ], [ %add54, %for.body53 ]
  %cmp56 = icmp sle i32 %7, 12
...
for.cond58:                                       ; preds = %for.inc65, %for.body57
  %k.1 = phi i32 [ %6, %for.body57 ], [ %inc66, %for.inc65 ]
  %sum.1 = phi i32 [ 0, %for.body57 ], [ %add64, %for.inc65 ]
  %sub59 = sub nsw i32 %7, 1
...
for.cond82:                                       ; preds = %for.inc89, %for.end81
  %9 = phi i32 [ %inc90, %for.inc89 ], [ 1, %for.end81 ]
  %cmp83 = icmp sle i32 %9, 12
  br i1 %cmp83, label %for.inc89, label %for.end91

for.inc89:                                        ; preds = %for.cond82
  %idxprom85 = sext i32 %9 to i64
...
for.cond92:                                       ; preds = %for.inc110, %for.end91
  %10 = phi i32 [ %inc111, %for.inc110 ], [ 1, %for.end91 ]
  %cmp93 = icmp sle i32 %10, 12
...
for.cond95:                                       ; preds = %for.inc107, %for.body94
  %j.1 = phi i32 [ 1, %for.body94 ], [ %inc108, %for.inc107 ]
  %sub96 = sub nsw i32 %10, 1
  %cmp97 = icmp sle i32 %j.1, %sub96
  br i1 %cmp97, label %for.inc107, label %for.inc110

for.inc107:                                       ; preds = %for.cond95
  %idxprom99 = sext i32 %j.1 to i64
  %arrayidx100 = getelementptr inbounds [13 x [13 x i32]], ptr %f2, i64 0, i64 %idxprom99
  %idxprom101 = sext i32 %10 to i64
...
if.else129:                                       ; preds = %for.body115
  %17 = load i32, ptr %mon1, align 4, !tbaa !5
  %idxprom130 = sext i32 %17 to i64
  %arrayidx131 = getelementptr inbounds [13 x [13 x i32]], ptr %f1, i64 0, i64 %idxprom130
  %18 = load i32, ptr %mon2, align 4, !tbaa !5
  %idxprom132 = sext i32 %18 to i64
  %arrayidx133 = getelementptr inbounds [13 x i32], ptr %arrayidx131, i64 0, i64 %idxprom132
  %19 = load i32, ptr %arrayidx133, align 4, !tbaa !5
  %cmp134 = icmp eq i32 %19, 1
