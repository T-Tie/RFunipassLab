...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond12 = select i1 %cmp7, i1 true, i1 %or.cond
  br i1 %or.cond12, label %if.then, label %for.inc
...
if.then45:                                        ; preds = %for.body41
  %call48 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %.sink8, i32 noundef %8) #6
  %.pre = load i32, ptr @i, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.body41, %if.then45
  %9 = phi i32 [ %.sink8, %for.body41 ], [ %.pre, %if.then45 ]
