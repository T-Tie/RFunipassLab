...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 1600, ptr noundef nonnull dereferenceable(1600) %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef align 16 %b) #9
...
for.end:                                          ; preds = %for.cond1
  ...
  %5 = load double, ptr %arrayidx9, align 8, !tbaa !9, !invariant.load !11
  %6 = load double, ptr %arrayidx8, align 16, !tbaa !9, !invariant.load !11
  %div = fdiv double %5, %6
...
for.cond18:                                       ; preds = %if.end40, %for.end17
  ...
  %sub19 = sub nsw i32 %8, 1
  %cmp20 = icmp sle i32 %7, %sub19
...
for.body21:                                       ; preds = %for.cond18
  ...
  %9 = load double, ptr %arrayidx23, align 8, !tbaa !9, !invariant.load !11
  %10 = load double, ptr %b, align 16, !tbaa !9
  %sub25 = fsub double %9, %10
...
for.end43:                                        ; preds = %for.cond18
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 1600, ptr noundef %a) #10
...
entry:
  ...
  %vtable = load ptr, ptr %__out, align 8, !tbaa !13, !invariant.load !11
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !15, !invariant.load !11
  ret i32 %0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !26, !invariant.load !11
  ret i64 %0
}
