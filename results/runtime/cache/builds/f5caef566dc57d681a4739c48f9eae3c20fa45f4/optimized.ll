...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %month1) #3
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %month2) #3
...
for.cond40.preheader:                             ; preds = %for.cond2
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  br label %for.cond40
...
if.then28:                                        ; preds = %if.end
  br i1 %or.cond13, label %if.then35, label %if.else
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc85
  ...
  br i1 %exitcond18.not, label %for.end87, label %for.body42

for.body42:                                       ; preds = %for.cond40
  switch i32 %m.0, label %if.end58 [
...
if.end58:                                         ; preds = %for.body42, %if.then56
  ...
  switch i32 %m.0, label %for.inc85 [
...
if.then70:                                        ; preds = %if.end58
  br i1 %or.cond13, label %if.then79, label %if.else81
...
for.inc85:                                        ; preds = %if.end58, %if.end68.thread, %if.else81, %if.then79
  %total2.3 = phi i32 [ %add67, %if.end68.thread ], [ %add80, %if.then79 ], [ %add82, %if.else81 ], [ %total2.1, %if.end58 ]
...
for.end97:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %month2) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %month1) #5
