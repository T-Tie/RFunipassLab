...
for.body:                                         ; preds = %for.cond
  ...
  %spec.select59 = select i1 %cmp5, i32 %1, i32 %b.0
  %a.1 = select i1 %cmp4, i32 %1, i32 %spec.select
  %b.1 = select i1 %cmp4, i32 %2, i32 %spec.select59
  ...
  %or.cond60 = or i1 %cmp12, %or.cond
  %smax69 = call i32 @llvm.smax.i32(i32 %a.1, i32 %b.1)
  br i1 %or.cond60, label %for.cond14, label %for.cond30

for.cond14:                                       ; preds = %for.body, %for.inc
  %x.1 = phi i32 [ %add18, %for.inc ], [ 0, %for.body ]
  %5 = phi i32 [ %inc, %for.inc ], [ %a.1, %for.body ]
  %exitcond70.not = icmp eq i32 %5, %smax69
  br i1 %exitcond70.not, label %for.inc53, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %Pivot27 = icmp slt i32 %5, 5
  br i1 %Pivot27, label %NodeBlock10, label %NodeBlock24

NodeBlock24:                                      ; preds = %for.body16
  %Pivot25 = icmp samesign ult i32 %5, 10
  br i1 %Pivot25, label %NodeBlock16, label %NodeBlock22

NodeBlock22:                                      ; preds = %NodeBlock24
  %Pivot23 = icmp samesign ult i32 %5, 12
  br i1 %Pivot23, label %LeafBlock18, label %LeafBlock20

LeafBlock20:                                      ; preds = %NodeBlock22
  %SwitchLeaf21 = icmp eq i32 %5, 12
  br i1 %SwitchLeaf21, label %for.inc, label %sw.default

LeafBlock18:                                      ; preds = %NodeBlock22
  %SwitchLeaf19 = icmp eq i32 %5, 10
  br i1 %SwitchLeaf19, label %for.inc, label %sw.default

NodeBlock16:                                      ; preds = %NodeBlock24
  %Pivot17 = icmp samesign ult i32 %5, 7
  br i1 %Pivot17, label %LeafBlock12, label %LeafBlock14

LeafBlock14:                                      ; preds = %NodeBlock16
  %SwitchLeaf15.not = icmp eq i32 %5, 9
  br i1 %SwitchLeaf15.not, label %sw.default, label %for.inc

LeafBlock12:                                      ; preds = %NodeBlock16
  %SwitchLeaf13 = icmp eq i32 %5, 5
  br i1 %SwitchLeaf13, label %for.inc, label %sw.default

NodeBlock10:                                      ; preds = %for.body16
  %Pivot11 = icmp slt i32 %5, 2
...
sw.default:                                       ; preds = %LeafBlock20, %LeafBlock18, %LeafBlock14, %LeafBlock12, %LeafBlock
  br label %for.inc

for.inc:                                          ; preds = %NodeBlock, %LeafBlock20, %LeafBlock18, %LeafBlock14, %LeafBlock12, %LeafBlock, %sw.default
  %.sink2 = phi i32 [ 30, %sw.default ], [ 31, %LeafBlock ], [ 31, %LeafBlock12 ], [ 31, %LeafBlock14 ], [ 31, %LeafBlock18 ], [ 31, %LeafBlock20 ], [ %switch.select62, %NodeBlock ]
  %add18 = add nuw nsw i32 %.sink2, %x.1
  %inc = add i32 %5, 1
  br label %for.cond14, !llvm.loop !9

for.cond30:                                       ; preds = %for.body, %for.inc40
  %x.2 = phi i32 [ %add36, %for.inc40 ], [ 0, %for.body ]
  %6 = phi i32 [ %inc41, %for.inc40 ], [ %a.1, %for.body ]
  %exitcond.not = icmp eq i32 %6, %smax69
  br i1 %exitcond.not, label %for.inc53, label %for.body32

for.body32:                                       ; preds = %for.cond30
  %Pivot51 = icmp slt i32 %6, 5
  br i1 %Pivot51, label %NodeBlock34, label %NodeBlock48

NodeBlock48:                                      ; preds = %for.body32
  %Pivot49 = icmp samesign ult i32 %6, 10
  br i1 %Pivot49, label %NodeBlock40, label %NodeBlock46

NodeBlock46:                                      ; preds = %NodeBlock48
  %Pivot47 = icmp samesign ult i32 %6, 12
  br i1 %Pivot47, label %LeafBlock42, label %LeafBlock44

LeafBlock44:                                      ; preds = %NodeBlock46
  %SwitchLeaf45 = icmp eq i32 %6, 12
  br i1 %SwitchLeaf45, label %for.inc40, label %sw.default37

LeafBlock42:                                      ; preds = %NodeBlock46
  %SwitchLeaf43 = icmp eq i32 %6, 10
  br i1 %SwitchLeaf43, label %for.inc40, label %sw.default37

NodeBlock40:                                      ; preds = %NodeBlock48
  %Pivot41 = icmp samesign ult i32 %6, 7
  br i1 %Pivot41, label %LeafBlock36, label %LeafBlock38

LeafBlock38:                                      ; preds = %NodeBlock40
  %SwitchLeaf39.not = icmp eq i32 %6, 9
  br i1 %SwitchLeaf39.not, label %sw.default37, label %for.inc40

LeafBlock36:                                      ; preds = %NodeBlock40
  %SwitchLeaf37 = icmp eq i32 %6, 5
  br i1 %SwitchLeaf37, label %for.inc40, label %sw.default37

NodeBlock34:                                      ; preds = %for.body32
  %Pivot35 = icmp slt i32 %6, 2
  br i1 %Pivot35, label %LeafBlock28, label %NodeBlock32
...
LeafBlock28:                                      ; preds = %NodeBlock34
  %SwitchLeaf29 = icmp eq i32 %6, 1
  br i1 %SwitchLeaf29, label %for.inc40, label %sw.default37

sw.default37:                                     ; preds = %LeafBlock44, %LeafBlock42, %LeafBlock38, %LeafBlock36, %LeafBlock28
  br label %for.inc40

for.inc40:                                        ; preds = %NodeBlock32, %LeafBlock44, %LeafBlock42, %LeafBlock38, %LeafBlock36, %LeafBlock28, %sw.default37
  %.sink1 = phi i32 [ 30, %sw.default37 ], [ 31, %LeafBlock28 ], [ 31, %LeafBlock36 ], [ 31, %LeafBlock38 ], [ 31, %LeafBlock42 ], [ 31, %LeafBlock44 ], [ %switch.select66, %NodeBlock32 ]
  %add36 = add nuw nsw i32 %.sink1, %x.2
  %inc41 = add i32 %6, 1
  br label %for.cond30, !llvm.loop !12

for.inc53:                                        ; preds = %for.cond30, %for.cond14
  %x.3 = phi i32 [ %x.1, %for.cond14 ], [ %x.2, %for.cond30 ]
  %rem20.i = srem i32 %x.3, 7
  %cmp21.i = icmp eq i32 %rem20.i, 0
  %spec.select.i = select i1 %cmp21.i, ptr @.str, ptr @.str.1
  %call26.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %spec.select.i), !noalias !13
  %call27.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call26.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !noalias !13
