...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2505, ptr %a) #5
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 2505, i1 false)
  call void @llvm.lifetime.start.p0(i64 4, ptr %n) #5
  call void @llvm.lifetime.start.p0(i64 2000, ptr %b) #5
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 2000, i1 false)
  call void @llvm.lifetime.start.p0(i64 2000, ptr %c) #5
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %n)
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str.1, ptr noundef %s)
  %call3 = call i64 @strlen(ptr noundef %s) #6
...
for.body25:                                       ; preds = %for.cond21
  ...
  %call32 = call i32 @strcmp(ptr noundef %arrayidx27, ptr noundef %arrayidx30) #6
...
land.end:                                         ; preds = %land.rhs, %for.cond45
  %3 = phi i1 [ false, %for.cond45 ], [ %cmp47, %land.rhs ]
  br i1 %3, label %for.body48, label %for.end67
...
if.else61:                                        ; preds = %for.body53
  br label %if.end62

if.end62:                                         ; preds = %if.else61, %if.then57
  %z.2 = phi i32 [ %add60, %if.then57 ], [ %z.1, %if.else61 ]
  br label %for.inc63
...
for.body76:                                       ; preds = %for.cond74
  ...
  %5 = load i32, ptr %arrayidx78, align 4, !tbaa !5
...
if.end86:                                         ; preds = %for.end85, %if.then69
  call void @llvm.lifetime.end.p0(i64 2000, ptr %c) #5
  call void @llvm.lifetime.end.p0(i64 2000, ptr %b) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #5
  call void @llvm.lifetime.end.p0(i64 2505, ptr %a) #5
