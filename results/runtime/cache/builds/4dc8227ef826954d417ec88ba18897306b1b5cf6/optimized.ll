...
for.cond18:                                       ; preds = %for.cond10, %for.body21
  %.pr10 = phi i32 [ %sub19, %for.body21 ], [ %.pr9, %for.cond10 ]
  %c.0 = phi i32 [ %inc24, %for.body21 ], [ 0, %for.cond10 ]
  %cmp20 = icmp sgt i32 %.pr10, 9
  br i1 %cmp20, label %for.body21, label %for.cond26

for.body21:                                       ; preds = %for.cond18
  %sub19 = add nsw i32 %.pr10, -10
...
for.cond26:                                       ; preds = %for.cond18, %for.body29
  %.pr11 = phi i32 [ %sub27, %for.body29 ], [ %.pr10, %for.cond18 ]
  %d.0 = phi i32 [ %inc32, %for.body29 ], [ 0, %for.cond18 ]
  %cmp28 = icmp sgt i32 %.pr11, 4
  br i1 %cmp28, label %for.body29, label %for.cond34thread-pre-split

for.body29:                                       ; preds = %for.cond26
  %sub27 = add nsw i32 %.pr11, -5
...
for.cond34thread-pre-split:                       ; preds = %for.cond26
  %smin = call i32 @llvm.smin.i32(i32 %.pr11, i32 0)
  %0 = sub i32 %.pr11, %smin
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34thread-pre-split, %for.body37
  %1 = phi i32 [ %.pr11, %for.cond34thread-pre-split ], [ %sub35, %for.body37 ]
  %e.0 = phi i32 [ 0, %for.cond34thread-pre-split ], [ %inc40, %for.body37 ]
