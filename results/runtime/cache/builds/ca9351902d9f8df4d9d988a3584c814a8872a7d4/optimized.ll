...
for.cond6:                                        ; preds = %for.cond, %for.body8
  %7 = phi i32 [ %.pre21, %for.body8 ], [ %5, %for.cond ]
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.body8 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp7 = icmp slt i64 %indvars.iv18, %8
  br i1 %cmp7, label %for.body8, label %for.end53

for.body8:                                        ; preds = %for.cond6
  %9 = load i32, ptr %vla1, align 16, !tbaa !5
  %arrayidx11 = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv18
  %10 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !12
  %mul = mul nsw i32 %10, %9
  %arrayidx13 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv18
  ...
  %.str.1.sink = select i1 %cmp23, ptr @.str, ptr %.str.1..str.2
  %call45 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.1.sink)
