...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %cmp76.not.not = icmp slt i64 %indvars.iv60, %11
...
for.end134:                                       ; preds = %for.cond74
  ...
  %call.i3 = call i32 @getc(ptr noundef %20)
  %21 = load ptr, ptr @stdin, align 8, !tbaa !16
  %call.i4 = call i32 @getc(ptr noundef %21)
