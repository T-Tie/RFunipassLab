...
for.cond16:                                       ; preds = %for.cond12, %for.inc25
  ...
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv14, %7
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax28 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax29 = call i32 @llvm.smax.i32(i32 %smax28, i32 0)
  %wide.trip.count30 = zext nneg i32 %smax29 to i64
  %wide.trip.count = zext nneg i32 %smax23 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond31.not = icmp eq i64 %indvars.iv24, %wide.trip.count30
  br i1 %exitcond31.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax35 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count43 = zext nneg i32 %smax23 to i64
  %wide.trip.count36 = zext nneg i32 %smax35 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv24, i64 %indvars.iv20
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv45 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next46, %for.inc83 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count30
  br i1 %exitcond49.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond44.not = icmp eq i64 %indvars.iv38, %wide.trip.count43
  br i1 %exitcond44.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv45, i64 %indvars.iv38
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv32 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next33, %for.inc77 ]
...
for.inc77:                                        ; preds = %for.cond58
  ...
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv45, i64 %indvars.iv32
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv32, i64 %indvars.iv38
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count30
  br i1 %exitcond54.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv50
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax28 to i64
  %arrayidx95 = getelementptr inbounds [100 x i32], ptr %d, i64 0, i64 %idxprom94
  store i32 %smax, ptr %arrayidx95, align 4, !tbaa !5
  %wide.trip.count60 = zext nneg i32 %smax23 to i64
  br label %for.cond96

for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count30
  br i1 %exitcond66.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv62
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax28, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax28, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv55 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next56, %for.inc112 ]
  %exitcond61.not = icmp eq i64 %indvars.iv55, %wide.trip.count60
  br i1 %exitcond61.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv62, i64 %indvars.iv55
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv79 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond86.not = icmp eq i64 %indvars.iv79, %wide.trip.count30
  br i1 %exitcond86.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv79
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv79, 0
  %or.cond6 = and i1 %or.cond, %cmp128
  br i1 %or.cond6, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv79
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax70 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
  %wide.trip.count71 = zext nneg i32 %smax70 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond72.not = icmp eq i64 %indvars.iv67, %wide.trip.count71
  br i1 %exitcond72.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv79, i64 %indvars.iv67
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv79, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax76 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
  %wide.trip.count77 = zext nneg i32 %smax76 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond78.not = icmp eq i64 %indvars.iv73, %wide.trip.count77
  br i1 %exitcond78.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv79, i64 %indvars.iv73
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv79, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv79, 2
