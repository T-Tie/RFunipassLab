...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv59 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next60, %for.inc33 ]
  %exitcond = icmp eq i64 %indvars.iv59, %wide.trip.count
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv59
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv56 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next57, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv56, %3
  br i1 %cmp8.not, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv56
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv64 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next65, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond68.not = icmp eq i64 %indvars.iv64, %wide.trip.count67
  br i1 %exitcond68.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv64
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax78 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
  %wide.trip.count79 = zext nneg i32 %smax78 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count72 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc60
  %indvars.iv74 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next75, %for.inc60 ]
  %exitcond80.not = icmp eq i64 %indvars.iv74, %wide.trip.count79
  br i1 %exitcond80.not, label %if.end80, label %for.inc60

for.inc60:                                        ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv74
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv69 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next70, %for.inc73 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %wide.trip.count72
  br i1 %exitcond73.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv69
