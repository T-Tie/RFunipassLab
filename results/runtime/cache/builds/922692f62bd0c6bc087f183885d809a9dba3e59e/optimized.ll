...
if.then32:                                        ; preds = %if.else
  %call38 = call double @sqrt(double noundef %8) #7, !tbaa !5
  %add = fsub double %call38, %4
  %mul41 = fmul double %5, 2.000000e+00
  %div42 = fdiv double %add, %mul41
  %call50 = call double @sqrt(double noundef %8) #7, !tbaa !5
...
if.else62:                                        ; preds = %if.else
  ...
  %call75 = call double @sqrt(double noundef %fneg74) #7, !tbaa !5
