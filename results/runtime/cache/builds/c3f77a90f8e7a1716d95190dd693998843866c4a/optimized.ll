...
for.body:                                         ; preds = %for.cond
  ...
  %smax17 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
  br i1 %or.cond5, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %n1.0 = phi i32 [ %add28, %for.inc ], [ 0, %for.body ]
  %j.0 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %exitcond18.not = icmp eq i32 %j.0, %smax17
  br i1 %exitcond18.not, label %for.end, label %for.body9
...
for.end:                                          ; preds = %for.cond7
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, i32 noundef 29, i32 %n1.0) #7
  br label %for.inc164
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %exitcond.not = icmp eq i32 %j81.0, %smax17
...
for.end111:                                       ; preds = %for.cond85
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, i32 noundef 28, i32 %n182.0) #7
  br label %for.inc164
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  %.sink3.sink = phi i32 [ %1, %for.body32 ], [ 30, %if.else52 ], [ 31, %for.inc56.fold.split ]
  %add53 = add nsw i32 %.sink3.sink, %n2.0
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts7 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.str) #7
  br label %if.end68
...
if.then70:                                        ; preds = %if.end68
  ...
  %puts8 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.4.str.3) #7
