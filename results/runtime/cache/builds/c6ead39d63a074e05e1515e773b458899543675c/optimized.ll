...
if.then:                                          ; preds = %for.body
  %call20 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %div, double noundef %div16)
  br label %for.inc

if.else:                                          ; preds = %for.body
  %tobool = fcmp une double %div16, 0.000000e+00
  %or.cond14 = and i1 %tobool, %cmp18
  br i1 %or.cond14, label %if.then24, label %if.else26

if.then24:                                        ; preds = %if.else
  %call25 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div16)
  br label %for.inc

if.else26:                                        ; preds = %if.else
  %fneg29 = fdiv double %fneg9, %mul
  %neg33 = fmul double %1, %fneg9
  %6 = call double @llvm.fmuladd.f64(double %mul6, double %3, double %neg33)
  %call34 = call double @sqrt(double noundef %6) #6, !tbaa !5
  %div36 = fdiv double %call34, %mul
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %fneg29, double noundef %div36, double noundef %fneg29, double noundef %div36)
  br label %for.inc
