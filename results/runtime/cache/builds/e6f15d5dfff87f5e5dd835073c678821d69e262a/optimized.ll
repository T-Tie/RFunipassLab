...
if.end16:                                         ; preds = %if.then9, %land.lhs.true, %while.end
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull align 4 %__value.addr.i)
...
_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit: ; preds = %while.cond.i, %land.end.i
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull align 4 %__value.addr.i)
  ret void
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull align 4 %__val)
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull align 4 %__val)
  ret void
}
