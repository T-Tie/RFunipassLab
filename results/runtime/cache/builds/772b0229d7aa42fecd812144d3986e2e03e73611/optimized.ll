...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %n) #11
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef nonnull align 16 captures(none) dereferenceable(20500) %a) #12
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull %b) #12
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %i) #12
...
for.end44:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %j) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %i) #12
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %b) #12
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef nonnull captures(none) %a) #12
...
for.inc31:                                        ; preds = %for.cond23
  ...
  %call29 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr27)
