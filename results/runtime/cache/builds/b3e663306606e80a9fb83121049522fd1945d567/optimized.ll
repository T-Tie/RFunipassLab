...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv5, %2
...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv15 = phi i32 [ %indvars.iv.next16, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax62 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax51 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %1 = add nuw i32 %smax51, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv22 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next23, %for.inc23 ]
  %exitcond26 = icmp eq i64 %indvars.iv22, %wide.trip.count25
  br i1 %exitcond26, label %for.cond26.preheader, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv17 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next18, %for.inc20 ]
  %exitcond21 = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond21, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv22, i64 %indvars.iv17
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv37 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next38, %for.inc57 ]
  %exitcond42 = icmp eq i64 %indvars.iv37, %wide.trip.count25
  br i1 %exitcond42, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select13, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond31 = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond31, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv27, i64 %indvars.iv37
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select13 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond29, !llvm.loop !17

for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv32 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next33, %for.inc54 ]
  %exitcond36 = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond36, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv32, i64 %indvars.iv37
...
for.end59:                                        ; preds = %for.cond26
  ...
  %wide.trip.count46 = zext i32 %n.tr to i64
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond53 = icmp eq i64 %indvars.iv48, %wide.trip.count25
  br i1 %exitcond53, label %for.cond80.preheader, label %for.cond63
...
for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc74 ], [ 2, %for.cond60 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %wide.trip.count46
  br i1 %exitcond47.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv48, i64 %indvars.iv.next44
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !20
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv48, i64 %indvars.iv43
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv59 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next60, %for.inc98 ]
  %exitcond64.not = icmp eq i64 %indvars.iv59, %wide.trip.count63
  br i1 %exitcond64.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc95 ], [ 2, %for.cond80 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %wide.trip.count46
  br i1 %exitcond58.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next55, i64 %indvars.iv59
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !20
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv54, i64 %indvars.iv59
