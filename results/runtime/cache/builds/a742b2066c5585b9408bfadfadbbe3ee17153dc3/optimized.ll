...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv10, i64 %indvars.iv
...
for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv16, i64 %indvars.iv13
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax27 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax28 = call i32 @llvm.smax.i32(i32 %smax27, i32 noundef 0)
  %wide.trip.count29 = zext nneg i32 %smax28 to i64
  %wide.trip.count = zext nneg i32 %smax22 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond30.not = icmp eq i64 %indvars.iv23, %wide.trip.count29
  br i1 %exitcond30.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax34 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count35 = zext nneg i32 %smax34 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv23, i64 %indvars.iv19
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv44 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next45, %for.inc83 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count29
  br i1 %exitcond48.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv37 = phi i64 [ %indvars.iv.next38, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond43.not = icmp eq i64 %indvars.iv37, %wide.trip.count
  br i1 %exitcond43.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv44, i64 %indvars.iv37
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv31 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next32, %for.inc77 ]
  %exitcond36.not = icmp eq i64 %indvars.iv31, %wide.trip.count35
  br i1 %exitcond36.not, label %for.inc80, label %for.inc77
...
for.inc77:                                        ; preds = %for.cond58
  ...
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv31, i64 %indvars.iv37
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %wide.trip.count29
  br i1 %exitcond53.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv49
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  br label %for.cond86, !llvm.loop !21

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax27 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count29
  br i1 %exitcond65.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv61
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax27, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax27, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv54 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next55, %for.inc112 ]
  %exitcond60.not = icmp eq i64 %indvars.iv54, %wide.trip.count
  br i1 %exitcond60.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv61, i64 %indvars.iv54
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv78 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond85.not = icmp eq i64 %indvars.iv78, %wide.trip.count29
  br i1 %exitcond85.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv78
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv78, 0
  %or.cond5 = and i1 %or.cond, %cmp128
  br i1 %or.cond5, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv78
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax69 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count70 = zext nneg i32 %smax69 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond71.not = icmp eq i64 %indvars.iv66, %wide.trip.count70
  br i1 %exitcond71.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv78, i64 %indvars.iv66
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv78, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax75 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count76 = zext nneg i32 %smax75 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond77.not = icmp eq i64 %indvars.iv72, %wide.trip.count76
  br i1 %exitcond77.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv78, i64 %indvars.iv72
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv78, %14
  %.pre = add nuw nsw i64 %indvars.iv78, 1
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv78, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar6 = call i32 @putchar(i32 noundef 10) #6
  br label %for.inc198
