...
for.cond.backedge:                                ; preds = %if.else8, %for.end34
  %indvars.iv.be = phi i64 [ %indvars.iv.next, %if.else8 ], [ 0, %for.end34 ]
...
for.cond15.preheader:                             ; preds = %for.end
  %wide.trip.count24 = and i64 %indvars.iv, 4294967295
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc32
  %indvars.iv21 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next22, %for.inc32 ]
  %sum.1 = phi i32 [ 0, %for.cond15.preheader ], [ %sum.2, %for.inc32 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.end34, label %for.cond18.preheader
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.body20
  %indvars.iv17 = phi i64 [ 0, %for.cond18.preheader ], [ %indvars.iv.next18, %for.body20 ]
  %sum.2 = phi i32 [ %sum.1, %for.cond18.preheader ], [ %spec.select, %for.body20 ]
  %exitcond20.not = icmp eq i64 %indvars.iv17, %wide.trip.count24
  br i1 %exitcond20.not, label %for.inc32, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %arrayidx24 = getelementptr inbounds nuw [16 x i32], ptr %a, i64 0, i64 %indvars.iv17
  %3 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %mul = shl nsw i32 %3, 1
  %cmp25 = icmp eq i32 %2, %mul
  %inc27 = zext i1 %cmp25 to i32
  %spec.select = add nsw i32 %sum.2, %inc27
