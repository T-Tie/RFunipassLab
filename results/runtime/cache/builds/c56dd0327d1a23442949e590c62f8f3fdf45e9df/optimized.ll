...
if.end:                                           ; preds = %entry
  ...
  %div23 = lshr i64 %sub, 1
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %0 = phi i64 [ %div23, %if.end ], [ %dec, %while.body ]
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt25__unguarded_linear_insertIPiN9__gnu_cxx5__ops14_Val_less_iterEEvT_T0_(ptr noundef %__last) local_unnamed_addr #3 comdat {
entry:
