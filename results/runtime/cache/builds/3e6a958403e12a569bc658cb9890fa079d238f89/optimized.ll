...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %add.ptr, i1 noundef false, i1 noundef true, i1 noundef false) #10
  %Pivot = icmp slt i64 %0, 0
  br i1 %Pivot, label %LeafBlock, label %LeafBlock11

LeafBlock11:                                      ; preds = %for.body
  %SwitchLeaf12 = icmp eq i64 %0, 0
  %vbase.offset9.i.pre13 = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !5
  br i1 %SwitchLeaf12, label %do.end.i, label %if.then6.i
...
LeafBlock.if.then6.i_crit_edge:                   ; preds = %LeafBlock
  %vbase.offset9.i.pre = load i64, ptr %vbase.offset.ptr.i, align 8, !invariant.load !5
  br label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock11
  %add.ptr.i = getelementptr inbounds i8, ptr @_ZSt3cin, i64 %vbase.offset9.i.pre13
...
if.then6.i:                                       ; preds = %LeafBlock.if.then6.i_crit_edge, %LeafBlock11
  %vbase.offset9.i = phi i64 [ %vbase.offset9.i.pre, %LeafBlock.if.then6.i_crit_edge ], [ %vbase.offset9.i.pre13, %LeafBlock11 ]
...
land.lhs.true.i:                                  ; preds = %if.then6.i
  ...
  %1 = load i64, ptr %_M_width.i5.i, align 8, !tbaa !6, !invariant.load !5
...
for.end:                                          ; preds = %for.cond, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
for.cond7:                                        ; preds = %for.body9, %for.end
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.body9 ], [ 1, %for.end ]
  %exitcond10 = icmp eq i64 %indvars.iv7, %wide.trip.count
  br i1 %exitcond10, label %for.end18, label %for.body9
...
for.body9:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv7
