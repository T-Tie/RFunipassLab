...
if.end:                                           ; preds = %if.then, %while.body
  call void @outlined_ir_func_0(i32 noundef 0)
...
for.end21_to_outline:
  %rem23 = srem i32 %0, 7
  %cmp24 = icmp eq i32 %rem23, 0
  %.str..str.1 = select i1 %cmp24, ptr @.str, ptr @.str.1
  %call26 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %.str..str.1)
