...
for.cond4:                                        ; preds = %for.inc31, %for.end
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc31 ], [ 1, %for.end ]
...
for.cond9:                                        ; preds = %for.inc29, %for.body6
  ...
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc29 ], [ %indvars.iv19, %for.body6 ]
...
for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds [30 x i32], ptr %w, i64 0, i64 %indvars.iv.next22
  %5 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %cmp16.not = icmp slt i32 %5, %3
  br i1 %cmp16.not, label %for.inc29, label %if.then

if.then:                                          ; preds = %for.body11
  %arrayidx18 = getelementptr inbounds [30 x i32], ptr %f, i64 0, i64 %indvars.iv.next22
