...
for.end:                                          ; preds = %for.cond
  ...
  br i1 %cmp50, label %if.end59.thread, label %land.lhs.true55
...
land.lhs.true61:                                  ; preds = %land.lhs.true55, %if.then57
...
if.end65:                                         ; preds = %if.end59.thread, %if.then63, %land.lhs.true61
