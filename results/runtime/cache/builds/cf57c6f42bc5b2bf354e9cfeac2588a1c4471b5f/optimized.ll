...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef %b) #3
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef %c) #3
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef align 16 %d) #3
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef %e) #3
...
if.then:                                          ; preds = %for.body15
  ...
  %3 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  %arrayidx22 = getelementptr inbounds [10 x i32], ptr %b, i64 0, i64 %idxprom25
  store i32 %3, ptr %arrayidx22, align 4, !tbaa !5
  %arrayidx24 = getelementptr inbounds [10 x i32], ptr %c, i64 0, i64 %idxprom25
...
for.inc42:                                        ; preds = %if.then, %if.then32, %if.else
...
if.then55:                                        ; preds = %for.body53
  ...
  %7 = load i32, ptr %arrayidx59, align 4, !tbaa !5, !invariant.load !13
  %arrayidx61 = getelementptr inbounds [10 x i32], ptr %d, i64 0, i64 %idxprom67
  store i32 %7, ptr %arrayidx61, align 4, !tbaa !5
  %arrayidx63 = getelementptr inbounds [10 x i32], ptr %e, i64 0, i64 %idxprom67
...
if.else64:                                        ; preds = %for.body53
  ...
  %8 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !13
  %arrayidx70 = getelementptr inbounds [10 x i32], ptr %d, i64 0, i64 %idxprom67
  %9 = load i32, ptr %arrayidx70, align 4, !tbaa !5, !invariant.load !13
...
for.inc83:                                        ; preds = %if.then55, %if.then72, %if.else64
...
if.then100:                                       ; preds = %for.body94
  ...
  %15 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !13
  %call105 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %14, i32 noundef %15)
  br label %for.inc107
