...
for.cond:                                         ; preds = %for.inc8, %while.body
  ...
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc8 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv4, %2
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv4, i64 %indvars.iv
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv61 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next62, %for.end138 ]
  %indvars.iv58 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next59, %for.end138 ]
...
for.cond14:                                       ; preds = %while.cond11, %for.inc49
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc49 ], [ 0, %while.cond11 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %indvars.iv61
  br i1 %exitcond19.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv15
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.body22 ], [ 0, %for.body16 ]
  %min.0 = phi i32 [ %spec.select, %for.body22 ], [ %9, %for.body16 ]
  %exitcond.not = icmp eq i64 %indvars.iv7, %indvars.iv61
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv15, i64 %indvars.iv7
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc46
  %indvars.iv10 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next11, %for.inc46 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %indvars.iv61
  br i1 %exitcond14.not, label %for.inc49, label %for.inc46

for.inc46:                                        ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv15, i64 %indvars.iv10
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %indvars.iv61
  br i1 %exitcond34.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv30
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select2, %for.body60 ], [ %12, %for.body54 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %indvars.iv61
  br i1 %exitcond24.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv20, i64 %indvars.iv30
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  %spec.select2 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br label %for.cond58, !llvm.loop !17

for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc87
  %indvars.iv25 = phi i64 [ 0, %for.cond75.preheader ], [ %indvars.iv.next26, %for.inc87 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %indvars.iv61
  br i1 %exitcond29.not, label %for.inc90, label %for.inc87

for.inc87:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv30
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond47.not = icmp eq i64 %indvars.iv43, %indvars.iv61
  br i1 %exitcond47.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc111 ], [ 1, %for.cond95 ]
  %exitcond42.not = icmp eq i64 %indvars.iv35, %indvars.iv58
  br i1 %exitcond42.not, label %for.inc114, label %for.inc111

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv.next36
  %16 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv43, i64 %indvars.iv35
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond57.not = icmp eq i64 %indvars.iv53, %indvars.iv61
  br i1 %exitcond57.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc133 ], [ 1, %for.cond117 ]
  %exitcond52.not = icmp eq i64 %indvars.iv48, %indvars.iv58
  br i1 %exitcond52.not, label %for.inc136, label %for.inc133

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next49, i64 %indvars.iv53
  %17 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !13
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv48, i64 %indvars.iv53
...
for.end138:                                       ; preds = %for.cond117
  ...
  %indvars64 = trunc i64 %indvars.iv.next62 to i32
  store i32 %indvars64, ptr %n, align 4, !tbaa !5
