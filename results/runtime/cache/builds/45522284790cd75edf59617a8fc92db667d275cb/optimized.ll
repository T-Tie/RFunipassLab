...
for.inc:                                          ; preds = %if.then11, %if.else27, %if.then25
  %.sink8 = phi i32 [ 30, %if.else27 ], [ 31, %if.then25 ], [ 29, %if.then11 ]
  %add28 = add nsw i32 %n1.0, %.sink8
  %inc = add nsw i32 %2, 1
...
for.inc56:                                        ; preds = %if.then34, %if.else52, %if.then50
  %.sink7 = phi i32 [ 30, %if.else52 ], [ 31, %if.then50 ], [ 29, %if.then34 ]
  %add53 = add nsw i32 %n2.0, %.sink7
...
for.inc109:                                       ; preds = %if.then89, %if.else105, %if.then103
  %.sink6 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ], [ 28, %if.then89 ]
  %add106 = add nsw i32 %n182.0, %.sink6
...
for.inc138:                                       ; preds = %if.then116, %if.else134, %if.then132
  %.sink = phi i32 [ 30, %if.else134 ], [ 31, %if.then132 ], [ 28, %if.then116 ]
