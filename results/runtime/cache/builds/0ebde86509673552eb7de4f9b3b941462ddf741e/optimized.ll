...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 140000, ptr nonnull %a) #6
  call void @llvm.lifetime.start.p0(i64 140000, ptr nonnull %b) #6
...
for.cond13:                                       ; preds = %for.cond2, %for.body15
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body15 ], [ 0, %for.cond2 ]
  %4 = sext i32 %3 to i64
...
for.body15:                                       ; preds = %for.cond13
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call18, i8 noundef signext %call.i10)
...
for.end22:                                        ; preds = %for.cond13
  call void @llvm.lifetime.end.p0(i64 140000, ptr nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 140000, ptr nonnull %a) #6
