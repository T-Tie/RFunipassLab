...
for.body35:                                       ; preds = %for.cond33
  ...
  %14 = getelementptr inbounds i32, ptr %call1, i64 %idxprom38
  %15 = load i32, ptr %14, align 4, !tbaa !5, !invariant.load !12
  br i1 %cmp36, label %if.then37, label %if.else

if.then37:                                        ; preds = %for.body35
  %call40 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %15) #7
  br label %for.inc45

if.else:                                          ; preds = %for.body35
  %call43 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15) #7
  br label %for.inc45
