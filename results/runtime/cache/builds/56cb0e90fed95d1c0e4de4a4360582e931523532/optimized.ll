...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv45 = phi i64 [ 1, %for.cond13.preheader ], [ %10, %for.inc53 ]
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  ...
  %spec.select36 = select i1 %cmp32, i32 %13, i32 %y1.1
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  ...
  %spec.select37 = select i1 %cmp50, i32 %8, i32 %x2.1
  %17 = trunc nuw nsw i64 %indvars.iv45 to i32
  %spec.select38 = select i1 %cmp50, i32 %17, i32 %y2.1
  br label %for.inc53
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !18, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !36, !invariant.load !14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !42, !invariant.load !14
  br label %return
