...
for.cond7:                                        ; preds = %for.cond3, %if.end
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end ], [ %1, %for.cond3 ]
...
for.body10:                                       ; preds = %for.cond7
  ...
  %3 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !13
  %arrayidx15 = getelementptr inbounds [500 x i32], ptr %num, i64 0, i64 %indvars.iv.next25
  %4 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !13
...
for.cond33:                                       ; preds = %for.cond3, %if.end49
  %.pre35 = phi i32 [ %.pre, %if.end49 ], [ %0, %for.cond3 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %if.end49 ], [ 0, %for.cond3 ]
  %cnt.0 = phi i32 [ %cnt.1, %if.end49 ], [ 0, %for.cond3 ]
...
for.body36:                                       ; preds = %for.cond33
  ...
  %6 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !13
