...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv75 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next76, %for.inc135 ]
  %indvars.iv72 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next73, %for.inc135 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc48
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc48 ], [ 0, %for.cond13 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv75
  br i1 %exitcond33.not, label %for.cond51, label %for.cond19

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body21 ], [ 0, %for.cond16 ]
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv21
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc45 ], [ 0, %for.cond34.preheader ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv75
  br i1 %exitcond28.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv29, i64 %indvars.iv24
...
for.cond51:                                       ; preds = %for.cond16, %for.inc86
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc86 ], [ 0, %for.cond16 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %indvars.iv75
  br i1 %exitcond48.not, label %for.end88, label %for.cond54

for.cond54:                                       ; preds = %for.cond51, %for.body56
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.body56 ], [ 0, %for.cond51 ]
  %min.2 = phi i32 [ %spec.select16, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %indvars.iv75
  br i1 %exitcond38.not, label %for.cond71.preheader, label %for.body56

for.cond71.preheader:                             ; preds = %for.cond54
  br label %for.cond71

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv34, i64 %indvars.iv44
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !13
  %spec.select16 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next35 = add nuw nsw i64 %indvars.iv34, 1
  br label %for.cond54, !llvm.loop !17

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc83 ], [ 0, %for.cond71.preheader ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %indvars.iv75
  br i1 %exitcond43.not, label %for.inc86, label %for.inc83

for.inc83:                                        ; preds = %for.cond71
  %arrayidx77 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv44
...
for.cond91:                                       ; preds = %for.cond95, %for.end88
  %indvars.iv54 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next55, %for.cond95 ]
  %exitcond61.not = icmp eq i64 %indvars.iv54, %indvars.iv72
  br i1 %exitcond61.not, label %for.cond113, label %for.cond95.preheader
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv49 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next50, %for.inc107 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %indvars.iv75
  br i1 %exitcond53.not, label %for.cond91, label %for.inc107, !llvm.loop !20

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv.next55, i64 %indvars.iv49
  %14 = load i32, ptr %arrayidx102, align 4, !tbaa !5, !invariant.load !13
  %arrayidx106 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv49
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  %indvars.iv67 = phi i64 [ 1, %for.cond91 ], [ %indvars.iv.next68, %for.cond116 ]
  %exitcond71.not = icmp eq i64 %indvars.iv67, %indvars.iv75
  br i1 %exitcond71.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv62 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next63, %for.inc129 ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %indvars.iv72
  br i1 %exitcond66.not, label %for.cond113, label %for.inc129, !llvm.loop !22

for.inc129:                                       ; preds = %for.cond116
  %arrayidx124 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv.next68
  %15 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx128 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv62, i64 %indvars.iv67
...
for.inc139:                                       ; preds = %for.cond13
  ...
  %vtable.i = load ptr, ptr %call137, align 8, !tbaa !25, !invariant.load !13
