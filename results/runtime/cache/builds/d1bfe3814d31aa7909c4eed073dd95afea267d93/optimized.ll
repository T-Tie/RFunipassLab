...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 550, ptr noundef nonnull align 16 captures(none) dereferenceable(550) %a) #11
  ...
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #12
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %conv = trunc i64 %call4 to i32
  %cmp53 = icmp sge i32 %0, %conv
  call void @llvm.assume(i1 noundef %cmp53)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 550, ptr noundef nonnull %a) #13
  ret i32 0
}
