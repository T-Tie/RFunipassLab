...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef range(i32 -2147483648, 2147483647) i32 @_Z5qufeni(i32 noundef %1) #8
...
for.inc:                                          ; preds = %for.cond
  %call4 = call noundef i32 @_Z3numiii(i32 noundef %1, i32 noundef %i.0, i32 noundef 2) #8
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %div = sdiv i32 %n, %0
  %call = tail call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #9
