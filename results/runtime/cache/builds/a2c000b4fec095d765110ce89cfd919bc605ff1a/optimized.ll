...
define dso_local noundef i32 @_Z3calPA120_ii(ptr noundef %matrix, i32 noundef %n) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i32 %n, 1
...
for.end114:                                       ; preds = %for.cond92
  %call = call noundef i32 @_Z3calPA120_ii(ptr noundef %matrix, i32 noundef %sub72)
  %add116 = add nsw i32 %4, %call
  br label %return

return:                                           ; preds = %for.end114, %if.then
  %retval.0 = phi i32 [ 0, %if.then ], [ %add116, %for.end114 ]
  ret i32 %retval.0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 57600, ptr %a) #4
...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z3calPA120_ii(ptr noundef %a, i32 noundef %1)
...
for.end17:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 57600, ptr %a) #4
