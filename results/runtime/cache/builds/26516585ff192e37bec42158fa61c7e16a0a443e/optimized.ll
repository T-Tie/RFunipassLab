...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv62 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next63, %for.end138 ]
  %indvars.iv59 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next60, %for.end138 ]
...
for.cond14:                                       ; preds = %while.cond11, %for.inc49
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc49 ], [ 0, %while.cond11 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %indvars.iv62
  br i1 %exitcond20.not, label %for.cond52, label %for.body16
...
for.cond52:                                       ; preds = %for.cond14, %for.inc90
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc90 ], [ 0, %for.cond14 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %indvars.iv62
  br i1 %exitcond35.not, label %for.end92, label %for.body54
...
for.cond58:                                       ; preds = %for.body60, %for.body54
  ...
  %min.2 = phi i32 [ %spec.select3, %for.body60 ], [ %12, %for.body54 ]
...
for.cond95:                                       ; preds = %for.inc114, %for.end92
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc114 ], [ 0, %for.end92 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %indvars.iv62
  br i1 %exitcond48.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.inc111
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc111 ], [ 1, %for.cond95 ]
  %exitcond43.not = icmp eq i64 %indvars.iv36, %indvars.iv59
  br i1 %exitcond43.not, label %for.inc114, label %for.inc111

for.inc111:                                       ; preds = %for.cond98
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv.next37
  %16 = load i32, ptr %arrayidx106, align 4, !tbaa !5
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv44, i64 %indvars.iv36
...
for.cond117:                                      ; preds = %for.cond95, %for.inc136
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc136 ], [ 0, %for.cond95 ]
  %exitcond58.not = icmp eq i64 %indvars.iv54, %indvars.iv62
  br i1 %exitcond58.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.inc133
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc133 ], [ 1, %for.cond117 ]
  %exitcond53.not = icmp eq i64 %indvars.iv49, %indvars.iv59
  br i1 %exitcond53.not, label %for.inc136, label %for.inc133

for.inc133:                                       ; preds = %for.cond120
  %indvars.iv.next50 = add nuw nsw i64 %indvars.iv49, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next50, i64 %indvars.iv54
  %17 = load i32, ptr %arrayidx128, align 4, !tbaa !5
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv49, i64 %indvars.iv54
...
for.end138:                                       ; preds = %for.cond117
  ...
  %indvars65 = trunc i64 %indvars.iv.next63 to i32
  store i32 %indvars65, ptr %n, align 4, !tbaa !5
