...
entry:
  ...
  call fastcc void @outlined_ir_func_0(ptr %x1, ptr %y1, ptr %call2.loc)
...
for.end10:                                        ; preds = %entry
  ...
  call fastcc void @outlined_ir_func_0(ptr %x2, ptr %y2, ptr %call15.loc)
...
for.end32:                                        ; preds = %for.end10
  ...
  %7 = sext i32 %5 to i64
  %smax56 = call i32 @llvm.smax.i32(i32 %2, i32 0)
...
entry_to_outline:                                 ; preds = %newFuncRoot
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %0, ptr noundef nonnull %1)
