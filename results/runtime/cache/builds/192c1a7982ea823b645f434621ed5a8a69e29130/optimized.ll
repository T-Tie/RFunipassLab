...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %if.then19.i, %if.then28.i
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #11
...
if.end.thread:                                    ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc
...
for.inc:                                          ; preds = %if.end, %if.then9, %if.end.thread
  ...
  %conv16 = phi i64 [ 0, %if.end.thread ], [ %blank.0, %if.then9 ], [ 0, %if.end ]
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %letter)
  %call15 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %letter) #11
  %conv18 = zext i32 %num.1 to i64
  %add17 = add nuw nsw i64 %conv16, %conv18
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %letter) #10
  ret i32 0
}
