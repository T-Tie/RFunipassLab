...
while.body:                                       ; preds = %for.end, %while.end
  %num.0 = phi i32 [ 0, %for.end ], [ %num.1.lcssa, %while.end ]
  %cnt.0 = phi i32 [ 0, %for.end ], [ %cnt.1.lcssa, %while.end ]
...
while.end:                                        ; preds = %while.body13, %while.cond9
  %num.1.lcssa = phi i32 [ %num.1, %while.body13 ], [ %num.1, %while.cond9 ]
  %cnt.1.lcssa = phi i32 [ %cnt.1, %while.body13 ], [ %cnt.1, %while.cond9 ]
