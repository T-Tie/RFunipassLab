...
for.cond:                                         ; preds = %if.end17, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end17 ], [ 0, %entry ]
  %exitcond16 = icmp eq i64 %indvars.iv, %wide.trip.count15
  br i1 %exitcond16, label %for.end20, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %indvars.iv11 = phi i64 [ %indvars.iv, %for.cond1.preheader ], [ %indvars.iv.next12, %for.body3 ]
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv11
...
if.end17:                                         ; preds = %if.then8, %for.end
...
while.cond:                                       ; preds = %for.cond, %while.cond
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %while.cond ], [ 0, %for.cond ]
  %arrayidx2 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv21
...
while.end:                                        ; preds = %while.cond
  %indvars33.le = trunc i64 %indvars.iv21 to i32
  %sub = shl i64 %indvars.iv21, 32
  ...
  %sub7 = add nsw i32 %indvars33.le, -2
  br label %for.cond8
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv24 = phi i64 [ %0, %while.cond11.preheader ], [ %indvars.iv.next25, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %1 = trunc nuw i64 %indvars.iv.next25 to i32
  %cmp12 = icmp slt i32 %1, %indvars33.le
  br i1 %cmp12, label %while.body13, label %while.end25

while.body13:                                     ; preds = %while.cond11
  %2 = load i32, ptr %arrayidx15, align 4, !tbaa !5, !invariant.load !9
  %arrayidx17 = getelementptr inbounds nuw [1000 x i32], ptr @H, i64 0, i64 %indvars.iv.next25
...
land.lhs.true:                                    ; preds = %while.body13
  %arrayidx20 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv.next25
  %4 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !9
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv27 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next28, %for.body33 ]
  %n.2 = phi i32 [ 0, %for.cond31.preheader ], [ %spec.select19, %for.body33 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond32.not, label %for.end43, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx35 = getelementptr inbounds nuw [1000 x i32], ptr @D, i64 0, i64 %indvars.iv27
  %5 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !9
  %spec.select19 = tail call i32 @llvm.smax.i32(i32 %5, i32 %n.2)
