...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr noundef nonnull dereferenceable(100) %add.ptr, i1 noundef false, i1 noundef true, i1 noundef false) #10
  br label %NodeBlock

NodeBlock:                                        ; preds = %for.body
  %Pivot = icmp slt i64 %0, 0
  br i1 %Pivot, label %LeafBlock, label %LeafBlock6

LeafBlock6:                                       ; preds = %NodeBlock
  %SwitchLeaf7 = icmp eq i64 %0, 0
  br i1 %SwitchLeaf7, label %do.end.i, label %if.then6.i

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i64 %0, -1
  br i1 %SwitchLeaf, label %if.else34.i, label %if.then6.i

do.end.i:                                         ; preds = %LeafBlock6
...
if.then6.i:                                       ; preds = %LeafBlock6, %LeafBlock
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc16 ], [ 1, %for.end ]
  %exitcond5 = icmp eq i64 %indvars.iv2, %wide.trip.count
  br i1 %exitcond5, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv2
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef nonnull %a) #11
  ret i32 0
}
