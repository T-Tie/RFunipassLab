...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %x.0 = phi i64 [ %indvars.iv, %if.end ], [ 0, %entry ]
...
if.end:                                           ; preds = %land.lhs.true29, %land.lhs.true25, %land.lhs.true21, %land.lhs.true17, %land.lhs.true, %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond, %land.lhs.true29
  %x.1 = phi i64 [ %indvars.iv, %land.lhs.true29 ], [ %x.0, %for.cond ]
  %wide.trip.count = and i64 %x.1, 4294967295
  br label %for.cond33

for.cond33:                                       ; preds = %for.body35, %for.end
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body35 ], [ 0, %for.end ]
  %exitcond31.not = icmp eq i64 %indvars.iv28, %wide.trip.count
  br i1 %exitcond31.not, label %for.end60, label %for.body35

for.body35:                                       ; preds = %for.cond33
  %arrayidx37 = getelementptr inbounds nuw [1000 x i32], ptr %c, i64 0, i64 %indvars.iv28
  %6 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !9
  %arrayidx39 = getelementptr inbounds nuw [1000 x i32], ptr %f, i64 0, i64 %indvars.iv28
  %7 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !9
  %arrayidx41 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv28
  %8 = load i32, ptr %arrayidx41, align 4, !tbaa !5, !invariant.load !9
  %arrayidx44 = getelementptr inbounds nuw [1000 x i32], ptr %e, i64 0, i64 %indvars.iv28
  %9 = load i32, ptr %arrayidx44, align 4, !tbaa !5, !invariant.load !9
  %reass.sub25 = sub i32 %9, %8
  %10 = mul i32 %reass.sub25, 60
  %arrayidx49 = getelementptr inbounds nuw [1000 x i32], ptr %d, i64 0, i64 %indvars.iv28
  %11 = load i32, ptr %arrayidx49, align 4, !tbaa !5, !invariant.load !9
  %add50 = add nsw i32 %11, 12
  %arrayidx52 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv28
  %12 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !9
  %13 = xor i32 %12, -1
  %sub54 = add i32 %add50, %13
  %mul55 = mul nsw i32 %sub54, 3600
  %reass.sub34 = sub i32 %7, %6
  %mul = add i32 %reass.sub34, 3600
  %add47 = add i32 %mul, %10
  %add56 = add nsw i32 %add47, %mul55
  %call57 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %add56) #5
