...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv19 = phi i32 [ %indvars.iv.next20, %for.inc18 ], [ 0, %entry ]
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc18 ], [ 0, %entry ]
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #8
  %sub = sub i64 %call4, %conv5
  %cmp.not = icmp ult i64 %sub, %indvars.iv11
...
for.inc:                                          ; preds = %for.cond6
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv11
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %1
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv11, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv11, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv16 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next17, %for.inc26 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond29, label %for.inc26

for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv16
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond21, !llvm.loop !14

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond34.not = icmp eq i64 %indvars.iv23, %wide.trip.count21
  br i1 %exitcond34.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv23
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv23
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv25 = phi i64 [ %indvars.iv23, %for.cond32.preheader ], [ %indvars.iv.next26, %for.inc51 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count21
  br i1 %exitcond30.not, label %for.inc54, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv25
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv25
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count21
  br i1 %exitcond40.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv35
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc89 ], [ 0, %if.else ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count21
  br i1 %exitcond46.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv41
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv41
