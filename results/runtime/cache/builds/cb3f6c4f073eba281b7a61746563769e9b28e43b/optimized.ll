...
for.inc36:                                        ; preds = %if.then27, %if.else32
  %.sink25 = phi i32 [ %11, %if.else32 ], [ %1, %if.then27 ]
  %sub33 = sub nsw i32 %9, %.sink25
...
for.body44:                                       ; preds = %for.cond42
  ...
  %13 = load i32, ptr %arrayidx46, align 4, !tbaa !5
  %cmp47 = icmp slt i32 %12, %13
...
if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %12)
  br label %for.cond60
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %.sink10, %16
  %cmp69 = icmp slt i32 %15, %add68
