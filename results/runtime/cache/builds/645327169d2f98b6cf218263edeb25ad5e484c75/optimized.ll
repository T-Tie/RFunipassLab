...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20000, ptr noundef nonnull dereferenceable(20000) %sentence) #8
  br label %while.cond
...
while.end:                                        ; preds = %while.cond
  %phiofops.lcssa = phi i32 [ %phiofops, %while.cond ]
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %while.end
  %i.1 = phi i32 [ 0, %while.end ], [ %inc7, %for.inc ]
  %cmp = icmp slt i32 %i.1, %phiofops.lcssa
...
for.end:                                          ; preds = %for.cond
  %idxprom8.lcssa = phi i64 [ %idxprom8, %for.cond ]
  %arrayidx9 = getelementptr inbounds [1000 x [20 x i8]], ptr %sentence, i64 0, i64 %idxprom8.lcssa
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 20000, ptr noundef %sentence) #9
  ret i32 0
}
