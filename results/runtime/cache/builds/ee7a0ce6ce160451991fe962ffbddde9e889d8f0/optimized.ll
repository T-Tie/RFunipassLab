...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i2) #8
...
for.end31:                                        ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i2) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %cnt) #8
  store i32 0, ptr %cnt, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i32) #8
...
if.end44:                                         ; preds = %if.then42, %if.then40
  ...
  %call47 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %10)
...
for.end52:                                        ; preds = %for.cond33
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i32) #8
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %cnt) #8
