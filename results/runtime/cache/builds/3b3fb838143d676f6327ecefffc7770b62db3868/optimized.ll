...
if.then56:                                        ; preds = %if.else50
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %div66, double noundef %div74, double noundef %div66, double noundef %div74) #8
  br label %for.inc
