...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 302, ptr noundef align 16 %ss) #5
  call void @llvm.memset.p0.i64(ptr noundef writeonly align 16 %ss, i8 noundef 0, i64 noundef 302, i1 noundef false) #6
...
if.end22:                                         ; preds = %for.end
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 0, i32 noundef %count.1)
  br label %for.inc23
...
if.end29:                                         ; preds = %if.then27, %for.end25
  call void @llvm.lifetime.end.p0(i64 noundef 302, ptr noundef %ss) #8
  ret i32 0
}
