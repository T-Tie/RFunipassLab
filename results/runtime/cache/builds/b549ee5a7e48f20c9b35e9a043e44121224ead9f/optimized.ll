...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.body17
  %indvars.iv43 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next44, %for.body17 ]
  %11 = load i32, ptr %y2, align 4, !tbaa !5
  %12 = sext i32 %11 to i64
  %cmp16.not = icmp sgt i64 %indvars.iv43, %12
  br i1 %cmp16.not, label %for.inc28, label %for.body17
...
for.cond35:                                       ; preds = %for.cond31, %for.body38
  %indvars.iv51 = phi i64 [ %indvars.iv.next52, %for.body38 ], [ 0, %for.cond31 ]
  %exitcond.not = icmp eq i64 %indvars.iv51, %wide.trip.count
  br i1 %exitcond.not, label %for.inc46, label %for.body38
...
for.cond57:                                       ; preds = %for.cond57.preheader, %for.body60
  %indvars.iv60 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next61, %for.body60 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count64
  br i1 %exitcond65.not, label %for.inc76, label %for.body60
