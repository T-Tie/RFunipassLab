...
for.body33:                                       ; preds = %for.cond30
  ...
  %5 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !13
  %cmp38 = icmp slt i32 %5, %minValue.0
...
for.inc45:                                        ; preds = %for.body33, %if.then39
  %minValue.1 = phi i32 [ %5, %if.then39 ], [ %minValue.0, %for.body33 ]
...
for.inc63:                                        ; preds = %for.cond54
  ...
  %6 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !13
  %sub62 = sub nsw i32 %6, %minValue.0
...
for.cond85:                                       ; preds = %for.inc100, %if.end78
  %minValue79.0 = phi i32 [ %8, %if.end78 ], [ %minValue79.1, %for.inc100 ]
...
for.body88:                                       ; preds = %for.cond85
  ...
  %9 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
  %cmp93 = icmp slt i32 %9, %minValue79.0
...
for.inc100:                                       ; preds = %for.body88, %if.then94
  %minValue79.1 = phi i32 [ %9, %if.then94 ], [ %minValue79.0, %for.body88 ]
  %inc101 = add nsw i32 %i83.0, 1
  br label %for.cond85, !llvm.loop !17

for.end102:                                       ; preds = %for.cond85
  %sub106 = sub nsw i32 %8, %minValue79.0
...
for.inc118:                                       ; preds = %for.cond109
  ...
  %10 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
  %sub117 = sub nsw i32 %10, %minValue79.0
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %11 = load i32, ptr %arrayidx129, align 4, !tbaa !5, !invariant.load !13
  %add130 = add nsw i32 %total.0, %11
