...
if.then:                                          ; preds = %for.body
  ...
  %call15.i = call double @sqrt(double noundef %5) #6, !tbaa !5, !noalias !11
  %add.i = fsub double %call15.i, %1
  %mul.i = fmul double %2, 2.000000e+00
  %div.i = fdiv double %add.i, %mul.i
  %call21.i = call double @sqrt(double noundef %5) #6, !tbaa !5, !noalias !11
...
if.then30:                                        ; preds = %if.else
  %call15.i6 = call double @sqrt(double noundef %5) #6, !tbaa !5, !noalias !16
  %add.i7 = fsub double %call15.i6, %1
  %mul.i8 = fmul double %2, 2.000000e+00
  %div.i9 = fdiv double %add.i7, %mul.i8
  %call21.i10 = call double @sqrt(double noundef %5) #6, !tbaa !5, !noalias !16
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %div.i9)
  br label %for.inc
