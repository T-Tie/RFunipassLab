...
for.cond5.preheader:                              ; preds = %for.cond2
  %2 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv8
  %3 = load i32, ptr %2, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond5

for.cond27.preheader:                             ; preds = %for.cond2
  %4 = load i32, ptr %B, align 16
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc39
  %indvars.iv14 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next15, %for.inc39 ]
...
if.then31:                                        ; preds = %for.body29
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4)
  br label %for.inc39

if.else:                                          ; preds = %for.body29
  %arrayidx36 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv14
  %6 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !12
