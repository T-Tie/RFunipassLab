...
land.end:                                         ; preds = %for.cond45
  ...
  br i1 %cmp47, label %for.body48, label %if.else71.loopexit
...
if.else71.loopexit:                               ; preds = %land.end
  %k.0.lcssa4 = phi i32 [ %k.0, %land.end ]
  %z.0.lcssa2 = phi i32 [ %z.0, %land.end ]
  br label %if.else71

if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %k.05 = phi i32 [ %k.0.lcssa4, %if.else71.loopexit ], [ %k.0.lcssa, %for.end67 ]
  %z.03 = phi i32 [ %z.0.lcssa2, %if.else71.loopexit ], [ %z.0.lcssa, %for.end67 ]
  %add72 = add nsw i32 %k.05, 2
