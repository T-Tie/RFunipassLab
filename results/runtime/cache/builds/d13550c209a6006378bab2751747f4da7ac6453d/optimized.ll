...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %word) #5
...
while.body:                                       ; preds = %while.cond
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 16 dereferenceable(50) %word)
  %cmp = icmp eq i32 %count.0, 0
  %call.i.i = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #6
...
if.then12:                                        ; preds = %if.else
  ...
  %call.i.i1 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #6
...
if.then21:                                        ; preds = %if.else19
  ...
  %3 = load i64, ptr %gep47, align 8, !tbaa !11, !invariant.load !9
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  ...
  %call.i.i4 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #6
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit25: ; preds = %if.then.i20, %if.end.i23
  ...
  %call.i.i26 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(50) %word) #6
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef nonnull align 16 captures(none) dereferenceable(50) %word) #6
