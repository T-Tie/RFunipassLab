...
for.cond10:                                       ; preds = %for.inc, %if.then
  ...
  store i32 %add.sink, ptr %i2, align 4, !tbaa !5
  %cmp11 = icmp sgt i32 %9, 1
  br i1 %cmp11, label %for.body13, label %for.end

for.body13:                                       ; preds = %for.cond10
  %10 = load i32, ptr %i2, align 4, !tbaa !5
  ...
  %12 = load i32, ptr %arrayidx17, align 4, !tbaa !5, !invariant.load !9
...
for.cond33:                                       ; preds = %for.inc40, %for.end32
  %13 = load i32, ptr %i3, align 4, !tbaa !5
  %14 = load i32, ptr %jn, align 4, !tbaa !5
  %cmp34 = icmp slt i32 %13, %14
...
for.inc40:                                        ; preds = %for.cond33
  ...
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15)
...
for.end42:                                        ; preds = %for.cond33
  ...
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %16)
