...
entry:
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
...
for.cond58.preheader:                             ; preds = %for.cond43
  ...
  %smax36 = call i32 @llvm.smax.i32(i32 %conv12, i32 noundef 0)
...
for.inc68:                                        ; preds = %for.cond58
  ...
  %17 = add nuw nsw i64 %add64, %indvars.iv31
