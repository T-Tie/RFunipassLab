...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %a) #9
  br label %for.cond
...
for.end10:                                        ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %x2) #9
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %y2) #9
  %call11 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %x2, ptr noundef nonnull %y2)
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %b) #9
  br label %for.cond12
...
for.end30:                                        ; preds = %for.cond12
  call void @llvm.lifetime.start.p0(i64 noundef 40804, ptr noundef nonnull %c) #9
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %smax = call i32 @llvm.smax.i32(i32 %4, i32 noundef -1)
  %10 = add i32 %smax, 1
  %smax50 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
if.then:                                          ; preds = %for.body70
  ...
  %call76 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %17) #9
  br label %for.inc82
...
if.else:                                          ; preds = %for.body70
  ...
  %call81 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %18) #9
  br label %for.inc82
...
for.end88:                                        ; preds = %for.cond63
  call void @outlined_ir_func_0() #9
  call void @outlined_ir_func_0() #9
  call void @llvm.lifetime.end.p0(i64 noundef 40804, ptr noundef nonnull %c) #9
...
entry:
  ...
  %call = tail call i32 @getc(ptr noundef %0) #9
  ret i32 %call
}
...
for.end88_after_outline.exitStub:
  %0 = load ptr, ptr @stdin, align 8, !tbaa !20
  %call.i = call i32 @getc(ptr noundef %0) #5
  ret void
}
