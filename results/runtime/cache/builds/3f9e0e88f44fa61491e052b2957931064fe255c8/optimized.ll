...
for.end18:                                        ; preds = %for.cond7
  %maxIndex.0.lcssa = phi i32 [ %maxIndex.0, %for.cond7 ]
  %sub.lcssa = phi i32 [ %sub, %for.cond7 ]
  %cmp20 = icmp ne i32 %maxIndex.0.lcssa, %sub.lcssa
  br i1 %cmp20, label %if.then21, label %for.inc33

if.then21:                                        ; preds = %for.end18
  %idxprom22 = sext i32 %maxIndex.0.lcssa to i64
  %arrayidx23 = getelementptr inbounds [1000 x i32], ptr %sz, i64 0, i64 %idxprom22
  %3 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  %idxprom25 = sext i32 %sub.lcssa to i64
...
for.end51:                                        ; preds = %for.cond36
  %k.0.lcssa = phi i32 [ %k.0, %for.cond36 ]
  %cmp52 = icmp slt i32 %k.0.lcssa, 2
...
for.cond54:                                       ; preds = %for.inc60, %if.then53
  ...
  %cmp55 = icmp slt i32 %i.2, %k.0.lcssa
...
if.end63:                                         ; preds = %for.cond54
  %cmp64 = icmp sgt i32 %k.0.lcssa, 1
...
for.end75:                                        ; preds = %for.cond66
  %sub67.lcssa = phi i32 [ %sub67, %for.cond66 ]
  %idxprom77 = sext i32 %sub67.lcssa to i64
