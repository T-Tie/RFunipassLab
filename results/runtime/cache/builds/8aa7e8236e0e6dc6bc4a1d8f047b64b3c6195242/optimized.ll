...
if.end:                                           ; preds = %entry, %if.then
  %a.sink = phi ptr [ %arrayidx1, %if.then ], [ %a, %entry ]
  %1 = load i32, ptr %a.sink, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.end
  %y.0 = phi i32 [ %1, %if.end ], [ %y.1, %for.inc ]
...
for.inc:                                          ; preds = %if.end7, %if.then11, %for.body
  %y.1 = phi i32 [ %y.0, %for.body ], [ %2, %if.then11 ], [ %y.0, %if.end7 ]
...
for.end:                                          ; preds = %for.cond
  ...
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %call2) #6
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %call5 = call noundef i32 @_Z3maxPiii(ptr nofree noundef nonnull readonly align 16 captures(none) dereferenceable(400) %a, i32 noundef %1, i32 noundef %call2) #6
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %call5) #6
