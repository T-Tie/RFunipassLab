...
for.cond40.preheader:                             ; preds = %for.cond2
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  br label %for.cond40
...
if.then28:                                        ; preds = %if.end
  br i1 %or.cond40, label %if.then35, label %if.else
...
for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc85
  ...
  %exitcond45.not = icmp eq i32 %m.0, %smax44
  br i1 %exitcond45.not, label %for.end87, label %for.body42
...
if.then70:                                        ; preds = %if.end58
  br i1 %or.cond40, label %if.then79, label %if.else81
...
for.end87:                                        ; preds = %for.cond40
  ...
  %puts43 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
