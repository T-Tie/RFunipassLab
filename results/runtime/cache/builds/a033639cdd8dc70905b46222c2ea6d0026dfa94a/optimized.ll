...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !16, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !34, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !40, !invariant.load !15
  br label %return
