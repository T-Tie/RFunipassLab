...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %t) #12
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %count) #12
  %call5 = call i64 @strlen(ptr noundef %initial) #13
  %conv = trunc i64 %call5 to i32
  store i32 %conv, ptr %count, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %mark) #12
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %mark) #12
