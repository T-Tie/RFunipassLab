...
for.cond37:                                       ; preds = %for.inc48, %if.then35
  %sub.sink17 = phi i32 [ %sub, %if.then35 ], [ %sub49, %for.inc48 ]
  %cmp38 = icmp sge i32 %sub.sink17, 0
