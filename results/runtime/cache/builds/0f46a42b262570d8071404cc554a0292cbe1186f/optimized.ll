...
if.then55:                                        ; preds = %for.body51
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %10, double noundef %11)
  br label %for.inc110
...
if.then67:                                        ; preds = %if.else63
  %call71 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %10)
  br label %for.inc110
...
if.then77:                                        ; preds = %if.else72
  ...
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %14, double noundef %fneg81, double noundef %14)
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %10, double noundef %14, double noundef %10, double noundef %14)
  br label %for.inc110
