...
for.cond2:                                        ; preds = %for.inc13, %for.end
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc13 ], [ %0, %for.end ]
  %cmp3 = icmp slt i64 %indvars.iv25, %1
  br i1 %cmp3, label %for.body4, label %for.cond20

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv25
...
for.cond20:                                       ; preds = %for.cond2, %for.body22
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.body22 ], [ %0, %for.cond2 ]
  %t.0 = phi i32 [ %spec.select, %for.body22 ], [ undef, %for.cond2 ]
  %cmp21 = icmp slt i64 %indvars.iv28, %1
  br i1 %cmp21, label %for.body22, label %for.end32

for.body22:                                       ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds [25 x i32], ptr %b, i64 0, i64 %indvars.iv28
