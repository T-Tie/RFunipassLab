...
define dso_local noundef i32 @_Z9mycomparePKvS0_(ptr nofree noundef readonly captures(none) %e1, ptr nofree noundef readonly captures(none) %e2) #0 {
entry:
  %0 = load i32, ptr %e2, align 4, !tbaa !5, !invariant.load !9
  %1 = load i32, ptr %e1, align 4, !tbaa !5, !invariant.load !9
  %sub = sub nsw i32 %0, %1
  ret i32 %sub
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 404, ptr noundef nonnull align 16 %s) #6
...
for.inc:                                          ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x i32], ptr %s, i64 0, i64 %indvars.iv
  %call1 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond
  call void @qsort(ptr noundef nonnull %s, i64 noundef %1, i64 noundef 4, ptr noundef nonnull @_Z9mycomparePKvS0_)
  ...
  %vtable.i = load ptr, ptr %call3, align 8, !tbaa !13, !invariant.load !9
  ...
  %arrayidx5 = getelementptr inbounds nuw i8, ptr %s, i64 4
  %3 = load i32, ptr %arrayidx5, align 4, !tbaa !5
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i, i32 noundef %3)
  %vtable.i3 = load ptr, ptr %call6, align 8, !tbaa !13, !invariant.load !9
  %vbase.offset.ptr.i4 = getelementptr i8, ptr %vtable.i3, i64 -24
  %vbase.offset.i5 = load i64, ptr %vbase.offset.ptr.i4, align 8, !invariant.load !9
  %add.ptr.i6 = getelementptr inbounds i8, ptr %call6, i64 %vbase.offset.i5
  ...
  %call1.i7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call6, i8 noundef signext %call.i)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 404, ptr noundef nonnull %s) #7
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !15, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !33, !invariant.load !9
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !13, !invariant.load !9
