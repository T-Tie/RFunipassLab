...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull align 16 dereferenceable(41000) %ch) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %len) #8
...
while.body.loopexit:                              ; preds = %while.cond9
  %6 = trunc nsw i64 %indvars.iv32 to i32
...
while.cond9:                                      ; preds = %while.cond9.preheader, %if.end34
  %9 = phi i32 [ %7, %while.cond9.preheader ], [ %.pre35, %if.end34 ]
  %10 = phi i32 [ %.pre, %while.cond9.preheader ], [ %12, %if.end34 ]
  %indvars.iv32 = phi i64 [ %8, %while.cond9.preheader ], [ %indvars.iv.next33, %if.end34 ]
  %num.1 = phi i32 [ %num.0, %while.cond9.preheader ], [ %num.2, %if.end34 ]
  %add = add nsw i32 %10, %num.1
  %cmp12 = icmp slt i32 %add, 81
  %11 = sext i32 %9 to i64
  %cmp17.not = icmp slt i64 %indvars.iv32, %11
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %while.cond9
  %arrayidx15 = getelementptr inbounds [1000 x [41 x i8]], ptr %ch, i64 0, i64 %indvars.iv32
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx15) #10
  ...
  %arrayidx26 = getelementptr inbounds [1000 x i32], ptr %len, i64 0, i64 %indvars.iv.next33
  %12 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !9
  %add27 = add nsw i32 %12, %add
  %cmp28 = icmp slt i32 %add27, 80
  %13 = load i32, ptr %n, align 4
  %14 = sext i32 %13 to i64
  %cmp29 = icmp slt i64 %indvars.iv.next33, %14
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !35, !invariant.load !9
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !38, !invariant.load !9
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !39, !invariant.load !9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !42, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !39, !invariant.load !9
  br label %return
...
!35 = !{!36, !37, i64 16}
!36 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !37, i64 8, !37, i64 16, !37, i64 24, !37, i64 32, !37, i64 40, !37, i64 48, !19, i64 56}
...
!42 = !{!23, !27, i64 240}
!43 = !{!44, !7, i64 56}
!44 = !{!"_ZTSSt5ctypeIcE", !45, i64 0, !46, i64 16, !25, i64 24, !47, i64 32, !47, i64 40, !48, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!45 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!46 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!47 = !{!"p1 int", !16, i64 0}
!48 = !{!"p1 short", !16, i64 0}
