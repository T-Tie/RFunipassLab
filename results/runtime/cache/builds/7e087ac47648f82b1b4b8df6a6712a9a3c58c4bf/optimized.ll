...
entry:
  ...
  %carry5 = alloca i8, i32 0, align 4
  %dig = alloca i32, align 4
  %i = alloca i32, align 4
  %st = alloca i32, align 4
  %i36 = alloca i32, align 4
  %i366 = alloca i8, i32 0, align 4
...
for.cond38:                                       ; preds = %for.inc45, %for.end35
  %7 = phi i32 [ %dec46, %for.inc45 ], [ %sub37, %for.end35 ]
  %cmp39 = icmp sge i32 %7, 0
...
for.inc45:                                        ; preds = %for.cond38
  ...
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %8)
  %dec46 = add nsw i32 %7, -1
