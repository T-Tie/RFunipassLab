...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %.sink15 = phi i32 [ %j.0, %if.then ], [ %add16, %for.inc25 ]
  %_ZSt4cout.sink14 = phi ptr [ @_ZSt4cout, %if.then ], [ %call20, %for.inc25 ]
  %idxprom12 = sext i32 %.sink15 to i64
  %arrayidx13 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom12
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink14, ptr noundef %arrayidx13)
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  ...
  %_ZSt4cout.sink12 = phi ptr [ @_ZSt4cout, %if.then30 ], [ %call39, %for.inc44 ]
  %idxprom31 = sext i32 %.sink13 to i64
  %arrayidx32 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom31
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink12, ptr noundef %arrayidx32)
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %.sink11 = phi i32 [ %j.0, %for.end57 ], [ %add62, %for.inc71 ]
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %for.end57 ], [ %call66, %for.inc71 ]
  %idxprom58 = sext i32 %.sink11 to i64
