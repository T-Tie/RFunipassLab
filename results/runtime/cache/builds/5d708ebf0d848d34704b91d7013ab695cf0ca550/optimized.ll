...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  switch i8 %0, label %cleanup.loopexit [
    i8 0, label %for.cond50.preheader
...
land.lhs.true:                                    ; preds = %for.cond, %for.cond, %for.cond, %for.cond
  ...
  switch i8 %1, label %cleanup.loopexit [
    i8 65, label %for.inc
    i8 84, label %for.inc
    i8 67, label %for.inc
    i8 71, label %for.inc
...
for.cond50:                                       ; preds = %for.cond50.preheader, %for.body55
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body55 ], [ 0, %for.cond50.preheader ]
  %number.0 = phi i32 [ %spec.select, %for.body55 ], [ 0, %for.cond50.preheader ]
...
cleanup:                                          ; preds = %cleanup.loopexit, %for.end68, %entry
  %.str.3.sink = phi ptr [ @.str.2, %entry ], [ %.str.3..str.4, %for.end68 ], [ @.str.2, %cleanup.loopexit ]
