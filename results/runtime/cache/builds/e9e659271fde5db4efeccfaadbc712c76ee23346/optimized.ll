...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  ...
  %.sink12 = phi i32 [ 0, %for.end41 ], [ %inc53, %for.inc52 ]
  %cmp43 = icmp slt i32 %.sink12, 1000
  br i1 %cmp43, label %for.body44, label %for.end54

for.body44:                                       ; preds = %for.cond42
  %idxprom45 = sext i32 %.sink12 to i64
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %.sink13 = phi i32 [ 0, %if.else58 ], [ %inc81, %for.inc80 ]
  %cmp61 = icmp slt i32 %.sink13, 1000
  br i1 %cmp61, label %for.body62, label %if.end83

for.body62:                                       ; preds = %for.cond60
  %idxprom63 = sext i32 %.sink13 to i64
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  %j.3 = phi i32 [ %.sink13, %if.then66 ], [ %inc76, %for.inc75 ]
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %.sink13, %6
