...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef i32 @_Z5qufeni(i32 noundef %1) #11
  %2 = call i32 @llvm.smax.i32(i32 %call2, i32 1)
  %smax = add nuw nsw i32 %2, 1
  br label %for.cond

for.cond:                                         ; preds = %for.body, %while.body
  %i.0 = phi i32 [ 2, %while.body ], [ %inc.i, %for.body ]
  %sum.0 = phi i32 [ 1, %while.body ], [ %add, %for.body ]
...
for.cond:                                         ; preds = %if.end5, %if.end
  %i.0 = phi i32 [ %h, %if.end ], [ %inc.i, %if.end5 ]
...
for.cond9:                                        ; preds = %for.cond9.preheader, %for.body11
  ...
  br i1 %exitcond15.not, label %cleanup, label %for.body11

for.body11:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !12
  %div = sdiv i32 %n, %0
...
cleanup:                                          ; preds = %for.cond9, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %a) #9
  br label %return
...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %k.0 = phi i32 [ 1, %entry ], [ %inc.i, %for.body ]
  %exitcond = icmp eq i32 %k.0, %0
  br i1 %exitcond, label %for.end, label %for.body

for.body:                                         ; preds = %for.cond
  %mul = mul nsw i32 %sum.0, %a
  %inc.i = add nuw i32 %k.0, 1
  br label %for.cond
