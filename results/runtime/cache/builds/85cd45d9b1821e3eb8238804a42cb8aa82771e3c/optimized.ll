...
if.end68:                                         ; preds = %for.end65
  %15 = load i32, ptr getelementptr inbounds ([100 x i32], ptr getelementptr inbounds ([100 x [100 x i32]], ptr @a, i64 0, i64 1), i64 0, i64 1), align 4, !tbaa !5
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc125, %if.end68
  %16 = phi i32 [ %inc126, %for.inc125 ], [ 0, %if.end68 ]
  %cmp70 = icmp slt i32 %16, %t
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %cmp81 = icmp eq i32 %17, 1
  br i1 %cmp81, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %if.else79
  %cmp812 = icmp eq i32 %17, 1
  br i1 %cmp812, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %lor.lhs.false
  %idxprom86 = sext i32 %16 to i64
  %arrayidx87 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom86
  %idxprom88 = sext i32 %17 to i64
  %arrayidx89 = getelementptr inbounds [100 x i32], ptr %arrayidx87, i64 0, i64 %idxprom88
  %18 = load i32, ptr %arrayidx89, align 4, !tbaa !5
  %sub92 = sub nsw i32 %17, 1
  %idxprom93 = sext i32 %sub92 to i64
  %arrayidx94 = getelementptr inbounds [100 x i32], ptr %arrayidx87, i64 0, i64 %idxprom93
...
for.inc32:                                        ; preds = %for.cond12
  %call29 = call noundef i32 @_Z3cuti(i32 noundef %5) #9
