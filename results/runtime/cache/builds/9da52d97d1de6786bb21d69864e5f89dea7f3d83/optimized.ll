...
while.cond.preheader:                             ; preds = %for.cond1
  %smax75 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
for.cond14.preheader:                             ; preds = %while.cond
  %smax71 = call i32 @llvm.smax.i32(i32 %indvars.iv12, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond18.not, label %for.cond45, label %for.body16
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond29.not = icmp eq i64 %indvars.iv24, %wide.trip.count17
  br i1 %exitcond29.not, label %for.cond70, label %for.cond49.preheader
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc64
  ...
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count17
  br i1 %exitcond40.not, label %for.cond104, label %for.body73
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond62.not, label %for.cond154, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %wide.trip.count
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc174 ], [ 0, %for.cond131 ]
