...
for.body3:                                        ; preds = %for.cond1
  ...
  %call5 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %5) #5
  %6 = load i32, ptr %mon2, align 4, !tbaa !5
  %call6 = call noundef i32 @_Z8DiJiTianii(i32 noundef %4, i32 noundef %6) #5
...
for.end29:                                        ; preds = %for.cond17
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %result) #6
...
for.inc:                                          ; preds = %lor.lhs.false26, %land.lhs.true, %lor.lhs.false11, %lor.lhs.false9, %lor.lhs.false7, %lor.lhs.false5, %lor.lhs.false3, %lor.lhs.false, %for.body, %lor.lhs.false18, %lor.lhs.false16, %lor.lhs.false14, %if.else, %if.then24, %land.lhs.true, %if.else22
