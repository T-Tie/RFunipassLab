...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv2 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next3, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax14 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv9 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next10, %for.inc44 ]
  %j.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond15.not = icmp eq i32 %j.0, %smax14
  br i1 %exitcond15.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax11 = call i32 @llvm.smax.i32(i32 %indvars.iv9, i32 noundef 0)
  %wide.trip.count12 = zext nneg i32 %smax11 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %4 = zext i32 %sub to i64
  %smax20 = call i32 @llvm.smax.i32(i32 %m.0, i32 noundef 0)
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv6 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next7, %for.inc41 ]
  %exitcond13.not = icmp eq i64 %indvars.iv6, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv6
  %5 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next7
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc58
  %indvars.iv16 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next17, %for.inc58 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %for.end60, label %for.body49

for.body49:                                       ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv16
  ...
  %cmp54.not = icmp eq i64 %indvars.iv16, %4
