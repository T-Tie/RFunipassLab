...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc19
  %indvars.iv8 = phi i64 [ 0, %for.cond10.preheader ], [ %indvars.iv.next9, %for.inc19 ]
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond.not, label %for.end22, label %for.body13

for.body13:                                       ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv8, i64 %indvars.iv8
...
for.body13.for.end22_crit_edge:                   ; preds = %for.body13
  ...
  %.pre29 = and i64 %indvars.iv8, 4294967295
  br label %for.end22
...
for.end22:                                        ; preds = %for.cond10, %for.body13.for.end22_crit_edge
  %idxprom26.pre-phi = phi i64 [ %.pre29, %for.body13.for.end22_crit_edge ], [ %wide.trip.count, %for.cond10 ]
  %j.1.lcssa = phi i32 [ %5, %for.body13.for.end22_crit_edge ], [ %smax, %for.cond10 ]
  %smax17 = call i32 @llvm.smax.i32(i32 %j.1.lcssa, i32 %0)
  %wide.trip.count19 = zext i32 %smax17 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc33, %for.end22
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc33 ], [ %idxprom26.pre-phi, %for.end22 ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end35, label %for.body25

for.body25:                                       ; preds = %for.cond23
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom26.pre-phi, i64 %indvars.iv14
...
for.end35:                                        ; preds = %for.cond23, %for.end35.split.loop.exit
  %j.2.lcssa = phi i32 [ %7, %for.end35.split.loop.exit ], [ %smax17, %for.cond23 ]
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc46, %for.end35
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc46 ], [ %idxprom26.pre-phi, %for.end35 ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond27.not, label %for.end48, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv21, i64 %idxprom26.pre-phi
...
for.end48.split.loop.exit:                        ; preds = %for.body38
  %9 = trunc nuw nsw i64 %indvars.iv21 to i32
  br label %for.end48

for.end48:                                        ; preds = %for.cond36, %for.end48.split.loop.exit
  %i.2.lcssa = phi i32 [ %9, %for.end48.split.loop.exit ], [ %smax17, %for.cond36 ]
  %reass.sub = sub nsw i32 %j.2.lcssa, %j.1.lcssa
  %sub50 = add i32 %reass.sub, -2
  %reass.sub3 = sub nsw i32 %i.2.lcssa, %j.1.lcssa
  %sub51 = add i32 %reass.sub3, -2
