...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %a.0 = phi i32 [ 0, %entry ], [ %a.1, %if.end ]
...
for.cond5.preheader:                              ; preds = %for.cond
  ...
  br i1 %cmp6, label %for.cond8, label %for.end33
...
for.cond8:                                        ; preds = %for.cond5.preheader, %if.end27
  %3 = phi i32 [ %5, %if.end27 ], [ undef, %for.cond5.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end27 ], [ 0, %for.cond5.preheader ]
...
if.end27:                                         ; preds = %if.then16, %for.cond8
  %5 = phi i32 [ %3, %if.then16 ], [ %4, %for.cond8 ]
  br label %for.cond8

for.end33:                                        ; preds = %for.cond5.preheader
