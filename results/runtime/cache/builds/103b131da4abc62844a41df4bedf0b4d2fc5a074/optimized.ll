...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %carry) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %dig) #8
...
for.end28:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %st) #10
...
for.end35:                                        ; preds = %for.cond29
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i36) #10
  %sub37 = sub nsw i32 %6, 1
  br label %for.cond38

for.cond38:                                       ; preds = %for.inc45, %for.end35
  %sub37.sink = phi i32 [ %sub37, %for.end35 ], [ %dec46, %for.inc45 ]
  %8 = phi i32 [ %dec46, %for.inc45 ], [ %sub37, %for.end35 ]
  store i32 %sub37.sink, ptr %i36, align 4, !tbaa !5
  %cmp39 = icmp sge i32 %8, 0
  br i1 %cmp39, label %for.inc45, label %for.end47

for.inc45:                                        ; preds = %for.cond38
  %9 = load i32, ptr %i36, align 4, !tbaa !5
  ...
  %call44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %10)
  %dec46 = add nsw i32 %9, -1
  br label %for.cond38, !llvm.loop !15

for.end47:                                        ; preds = %for.cond38
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i36) #10
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %st) #10
  br label %if.end49

if.end49:                                         ; preds = %for.end47, %if.then
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %dig) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %carry) #10
