...
lor.lhs.false.thread:                             ; preds = %for.body75
  %cmp812 = icmp eq i64 %indvars.iv33, 1
  br i1 %cmp812, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %land.lhs.true
  %6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv40, i64 %indvars.iv33
  %7 = load i32, ptr %6, align 4, !tbaa !5, !invariant.load !9
  %8 = add nsw i64 %indvars.iv33, -1
...
if.else95:                                        ; preds = %lor.lhs.false.thread
  %9 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv40, i64 %indvars.iv33
  %10 = load i32, ptr %9, align 4, !tbaa !5, !invariant.load !9
  %cmp96 = icmp eq i64 %indvars.iv33, 0
