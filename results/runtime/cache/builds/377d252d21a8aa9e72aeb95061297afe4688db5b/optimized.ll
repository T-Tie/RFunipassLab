...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !9, !invariant.load !10
...
for.inc:                                          ; preds = %for.cond3
  ...
  %3 = load i8, ptr %arrayidx8, align 1, !tbaa !9, !invariant.load !10
...
for.cond14:                                       ; preds = %for.inc21, %for.end12
  %4 = load i32, ptr %j13, align 4, !tbaa !5
  %5 = load i32, ptr %pre, align 4, !tbaa !5
...
for.inc21:                                        ; preds = %for.cond14
  ...
  %6 = load i8, ptr %arrayidx19, align 1, !tbaa !9, !invariant.load !10
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %6)
  %inc22 = add nsw i32 %4, 1
  store i32 %inc22, ptr %j13, align 4, !tbaa !5
  br label %for.cond14, !llvm.loop !15

for.end23:                                        ; preds = %for.cond14
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef align 4 %j13) #5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %pre) #5
  ret void
}
