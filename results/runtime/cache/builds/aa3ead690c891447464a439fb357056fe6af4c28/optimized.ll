...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc29 ], [ 0, %entry ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond.cleanup, label %for.body
...
for.cond17:                                       ; preds = %for.cond.cleanup4, %for.body20
  ...
  br i1 %exitcond20.not, label %for.inc29, label %for.body20
...
for.inc29:                                        ; preds = %for.cond17, %for.cond.cleanup4
...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc28 ], [ 0, %entry ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count24
  br i1 %exitcond25.not, label %for.cond.cleanup, label %for.body
...
for.cond16:                                       ; preds = %for.cond.cleanup3, %for.body19
  ...
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc28, label %for.body19
...
for.inc28:                                        ; preds = %for.cond16, %for.cond.cleanup3
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
...
for.cond:                                         ; preds = %for.cond.cleanup3, %entry
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.cond.cleanup3 ], [ 2, %entry ]
...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax25 = tail call i32 @llvm.smax.i32(i32 %sub21, i32 0)
  %smax32 = tail call i32 @llvm.smax.i32(i32 %1, i32 2)
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.cond.cleanup23
  %indvars.iv28 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next29, %for.cond.cleanup23 ]
  %exitcond34.not = icmp eq i64 %indvars.iv28, %wide.trip.count33
  br i1 %exitcond34.not, label %for.cond.cleanup17, label %for.cond20.preheader
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.body24
  %indvars.iv22 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next23, %for.body24 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond.cleanup23, label %for.body24
...
while.cond:                                       ; preds = %for.end18, %entry
  ...
  %0 = load i32, ptr %_M_streambuf_state.i.i.i, align 8, !tbaa !23
...
for.cond:                                         ; preds = %for.cond.cleanup5, %while.body
  %.pre14 = phi i32 [ %.pre1416, %for.cond.cleanup5 ], [ %.pre, %while.body ]
  %1 = phi i32 [ %3, %for.cond.cleanup5 ], [ %.pre, %while.body ]
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.cond.cleanup5 ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
...
for.cond3:                                        ; preds = %for.cond, %for.inc
  ...
  %3 = phi i32 [ %7, %for.inc ], [ %.pre14, %for.cond ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond ]
  %4 = sext i32 %3 to i64
  %cmp4 = icmp slt i64 %indvars.iv, %4
...
for.body6:                                        ; preds = %for.cond3
  %5 = or i64 %indvars.iv, %indvars.iv10
...
for.inc:                                          ; preds = %for.body6, %if.then
  ...
  %7 = phi i32 [ %3, %for.body6 ], [ %.pre13, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond3, !llvm.loop !35

for.cond13:                                       ; preds = %for.cond, %for.body15
  %storemerge = phi i32 [ %dec, %for.body15 ], [ %1, %for.cond ]
...
for.body15:                                       ; preds = %for.cond13
  tail call void @_Z7zerorowi(i32 noundef %storemerge)
  %8 = load i32, ptr @k, align 4, !tbaa !5
  tail call void @_Z7zerocoli(i32 noundef %8)
  ...
  tail call void @_Z4jiani(i32 noundef %11)
  %12 = load i32, ptr @k, align 4, !tbaa !5
  %dec = add nsw i32 %12, -1
  br label %for.cond13, !llvm.loop !36
...
for.end18:                                        ; preds = %for.cond13
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call19, i8 noundef signext %call.i8)
