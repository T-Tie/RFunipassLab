...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %sub.sink = phi i32 [ %sub, %for.end ], [ %dec, %for.inc19 ]
  %cmp6 = icmp sgt i32 %sub.sink, 0
  %sub21 = sub nsw i32 %sub.sink, 1
...
for.cond22:                                       ; preds = %for.inc57, %for.end20
  %sub21.sink = phi i32 [ %sub21, %for.end20 ], [ %dec58, %for.inc57 ]
  %cmp23 = icmp sge i32 %sub21.sink, 0
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  ...
  %cmp30 = icmp sgt i32 %6, %sub21.sink
  %idxprom54 = sext i32 %sub21.sink to i64
  br i1 %cmp30, label %for.body31, label %for.end47

for.body31:                                       ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %idxprom54
...
land.lhs.true:                                    ; preds = %for.body31
  ...
  %cmp39 = icmp sge i32 %9, %10
  br i1 %cmp39, label %if.then40, label %for.inc45

if.then40:                                        ; preds = %land.lhs.true
  store i32 %9, ptr %sum, align 4, !tbaa !5
...
for.inc57:                                        ; preds = %for.end47, %if.else52
  ...
  %dec58 = add nsw i32 %sub21.sink, -1
