...
while.cond:                                       ; preds = %while.body, %entry
  %.pr9 = phi i32 [ %sub, %while.body ], [ %.pr, %entry ]
...
while.cond1:                                      ; preds = %while.body4, %while.end
  %.pr10 = phi i32 [ %0, %while.body4 ], [ %.pr9, %while.end ]
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  %.pr11 = phi i32 [ %1, %while.body13 ], [ %.pr10, %while.end7 ]
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  %.pr12 = phi i32 [ %2, %while.body22 ], [ %.pr11, %while.end16 ]
...
land.end30:                                       ; preds = %while.end25, %while.body31
  %3 = phi i32 [ %sub33, %while.body31 ], [ %.pr12, %while.end25 ]
