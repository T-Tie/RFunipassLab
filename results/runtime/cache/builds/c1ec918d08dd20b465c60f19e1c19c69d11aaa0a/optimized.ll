...
for.cond:                                         ; preds = %for.inc135, %entry
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %for.inc135 ], [ %0, %entry ]
  %sum.0 = phi i32 [ %add, %for.inc135 ], [ 0, %entry ]
  %1 = trunc nuw i64 %indvars.iv60 to i32
  %cmp = icmp sgt i32 %1, 1
  br i1 %cmp, label %for.cond1, label %for.end136

for.cond1:                                        ; preds = %for.cond, %for.inc31
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc31 ], [ 0, %for.cond ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv60
  br i1 %exitcond18.not, label %for.cond34, label %for.body3

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv14
...
for.cond5:                                        ; preds = %for.body7, %for.body3
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv60
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc28
  %indvars.iv9 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next10, %for.inc28 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %indvars.iv60
  br i1 %exitcond13.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond17
  %arrayidx23 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond34:                                       ; preds = %for.cond1, %for.inc88
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc88 ], [ 0, %for.cond1 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %indvars.iv60
  br i1 %exitcond38.not, label %for.end90, label %for.cond37

for.cond37:                                       ; preds = %for.cond34, %for.body39
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body39 ], [ 1, %for.cond34 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv60
  br i1 %exitcond23.not, label %if.then51, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv19, i64 %indvars.iv34
...
if.then51:                                        ; preds = %for.cond37
  %arrayidx54 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv34
  %6 = load i32, ptr %arrayidx54, align 4, !tbaa !5
  br label %for.cond55

for.cond55:                                       ; preds = %for.body57, %if.then51
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.body57 ], [ 1, %if.then51 ]
  %min.2 = phi i32 [ %spec.select3, %for.body57 ], [ %6, %if.then51 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv60
  br i1 %exitcond28.not, label %for.cond72.preheader, label %for.body57

for.cond72.preheader:                             ; preds = %for.cond55
  br label %for.cond72

for.body57:                                       ; preds = %for.cond55
  %arrayidx61 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv24, i64 %indvars.iv34
  %7 = load i32, ptr %arrayidx61, align 4, !tbaa !5
  %spec.select3 = tail call i32 @llvm.smin.i32(i32 %7, i32 %min.2)
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  br label %for.cond55, !llvm.loop !15

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc84
  %indvars.iv29 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next30, %for.inc84 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv60
  br i1 %exitcond33.not, label %for.inc88, label %for.inc84

for.inc84:                                        ; preds = %for.cond72
  %arrayidx78 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv29, i64 %indvars.iv34
...
for.cond93:                                       ; preds = %for.inc111, %for.end90
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc111 ], [ 0, %for.end90 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %indvars.iv60
  br i1 %exitcond49.not, label %for.cond114, label %for.cond96

for.cond96:                                       ; preds = %for.cond93, %for.inc108
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc108 ], [ 2, %for.cond93 ]
  %exitcond44.not = icmp eq i64 %indvars.iv39, %indvars.iv60
  br i1 %exitcond44.not, label %for.inc111, label %for.inc108

for.inc108:                                       ; preds = %for.cond96
  %arrayidx102 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv45, i64 %indvars.iv39
  %10 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %11 = add nsw i64 %indvars.iv39, -1
  %arrayidx107 = getelementptr inbounds [100 x i32], ptr %a, i64 %indvars.iv45, i64 %11
...
for.cond114:                                      ; preds = %for.cond93, %for.inc132
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc132 ], [ 0, %for.cond93 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %indvars.iv60
  br i1 %exitcond59.not, label %for.inc135, label %for.cond117.preheader

for.cond117.preheader:                            ; preds = %for.cond114
  %invariant.gep5 = getelementptr [100 x i32], ptr %invariant.gep, i64 0, i64 %indvars.iv55
  br label %for.cond117

for.cond117:                                      ; preds = %for.cond117.preheader, %for.inc129
  %indvars.iv50 = phi i64 [ 2, %for.cond117.preheader ], [ %indvars.iv.next51, %for.inc129 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %indvars.iv60
  br i1 %exitcond54.not, label %for.inc132, label %for.inc129

for.inc129:                                       ; preds = %for.cond117
  %arrayidx123 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 %indvars.iv50, i64 %indvars.iv55
  %12 = load i32, ptr %arrayidx123, align 4, !tbaa !5
  %gep6 = getelementptr [100 x i32], ptr %invariant.gep5, i64 %indvars.iv50
  store i32 %12, ptr %gep6, align 4, !tbaa !5
...
for.cond:                                         ; preds = %for.inc16, %entry
  ...
  %2 = sext i32 %1 to i64
  %cmp = icmp slt i64 %indvars.iv5, %2
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %5 = sext i32 %4 to i64
  %cmp2 = icmp slt i64 %indvars.iv2, %5
  br i1 %cmp2, label %for.cond4, label %for.inc16

for.cond4:                                        ; preds = %for.cond1, %for.inc
  %6 = phi i32 [ %.pre12, %for.inc ], [ %3, %for.cond1 ]
...
for.cond19:                                       ; preds = %for.cond, %for.inc26
  %8 = phi i32 [ %.pre11, %for.inc26 ], [ %1, %for.cond ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc26 ], [ 0, %for.cond ]
  %9 = sext i32 %8 to i64
  %cmp20 = icmp slt i64 %indvars.iv8, %9
