...
for.cond1:                                        ; preds = %for.inc, %for.body
  %f.1 = phi i32 [ %f.0, %for.body ], [ %f.26, %for.inc ]
  %end2.1 = phi i32 [ %end2.0, %for.body ], [ %end2.2, %for.inc ]
  %end1.1 = phi i32 [ %end1.0, %for.body ], [ %end1.2, %for.inc ]
  %star2.1 = phi i32 [ %star2.0, %for.body ], [ %star2.28, %for.inc ]
  %star1.1 = phi i32 [ %star1.0, %for.body ], [ %star1.210, %for.inc ]
...
for.inc:                                          ; preds = %if.then19, %for.body3
  %star1.210 = phi i32 [ %star1.2.ph, %if.then19 ], [ %star1.1, %for.body3 ]
  %star2.28 = phi i32 [ %star2.2.ph, %if.then19 ], [ %star2.1, %for.body3 ]
  %f.26 = phi i32 [ %f.2.ph, %if.then19 ], [ %f.1, %for.body3 ]
