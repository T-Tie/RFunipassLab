...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 676, ptr %f1) #6
  call void @llvm.lifetime.start.p0(i64 676, ptr %f2) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %n) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %year) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %mon1) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %mon2) #6
  call void @llvm.memset.p0.i64(ptr align 16 %f1, i8 0, i64 676, i1 false)
  call void @llvm.memset.p0.i64(ptr align 16 %f2, i8 0, i64 676, i1 false)
  br label %for.cond
...
for.inc141:                                       ; preds = %if.then119, %if.else129
  %f1.sink = phi ptr [ %f1, %if.else129 ], [ %f2, %if.then119 ]
  ...
  call fastcc void @outlined_ir_func_0(ptr %arrayidx133)
  %inc142 = add nsw i32 %i.6, 1
  br label %for.cond113, !llvm.loop !23

for.end143:                                       ; preds = %for.cond113
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon2) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %mon1) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %year) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #6
  call void @llvm.lifetime.end.p0(i64 676, ptr %f2) #6
  call void @llvm.lifetime.end.p0(i64 676, ptr %f1) #6
  ret i32 0
}
