...
for.end76:                                        ; preds = %for.cond2
  ...
  %4 = add i32 %smax13, 1
  %wide.trip.count14 = zext i32 %4 to i64
  br label %for.cond86
...
for.body88:                                       ; preds = %for.cond86
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv9, i64 %5
  br label %for.cond94
...
for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv6, %5
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %6 = load i8, ptr %arrayidx103, align 1, !tbaa !24, !invariant.load !9
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %6)
...
if.else106:                                       ; preds = %for.body96
  ...
  %7 = load i8, ptr %arrayidx110, align 1, !tbaa !24, !invariant.load !9
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %7)
  br label %for.inc113
