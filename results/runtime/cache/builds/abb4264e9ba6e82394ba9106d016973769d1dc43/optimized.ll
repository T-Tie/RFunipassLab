...
_ZSt4sortIPiEvT_S1_.exit:                         ; preds = %for.end, %if.then.i.i
  ...
  %call7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %3) #10
...
for.inc16:                                        ; preds = %for.cond9
  ...
  %call15 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5) #10
...
for.inc.i:                                        ; preds = %for.cond.i
  %0 = load i32, ptr %__first.addr.0.i, align 4, !tbaa !5
...
if.end:                                           ; preds = %entry
  ...
  %add.ptr = getelementptr inbounds nuw i32, ptr %__first, i64 %div45
  %cmp5 = icmp samesign ult i64 %sub, 2
  br label %while.body

while.body:                                       ; preds = %while.body, %if.end
  %0 = load i32, ptr %add.ptr, align 4, !tbaa !5
  tail call void @_ZSt13__adjust_heapIPiliN9__gnu_cxx5__ops15_Iter_less_iterEEvT_T0_S5_T1_T2_(ptr noundef nonnull dereferenceable(4) %__first, i64 noundef %div45, i64 noundef %sub.ptr.div, i32 noundef %0)
...
while.cond4:                                      ; preds = %while.cond4.preheader, %while.cond4
  ...
  %cmp.i3 = icmp slt i32 %0, %2
  br i1 %cmp.i3, label %while.cond4, label %while.end8, !llvm.loop !23
