...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 %c) #4
...
for.end27:                                        ; preds = %for.cond19
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %c) #6
  ret i32 0
}
