...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 301, ptr nonnull %a) #6
  ...
  call void @llvm.lifetime.start.p0(i64 26, ptr nonnull %b) #6
...
for.end18:                                        ; preds = %for.cond4
  ...
  br i1 %cmp19, label %if.then20, label %for.cond23.preheader

if.then20:                                        ; preds = %for.end18
  %call21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1)
  br label %for.cond23.preheader

for.cond23.preheader:                             ; preds = %if.then20, %for.end18
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.backedge, %for.cond23.preheader
  %indvars.iv34 = phi i64 [ 0, %for.cond23.preheader ], [ %indvars.iv.next35, %for.cond23.backedge ]
...
for.end50:                                        ; preds = %for.cond35
  ...
  br i1 %cmp51.not, label %for.cond23.backedge, label %if.then52

for.cond23.backedge:                              ; preds = %for.end50, %if.then52
  br label %for.cond23, !llvm.loop !13

if.then52:                                        ; preds = %for.end50
  %conv55 = sext i8 %3 to i32
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %conv55, i32 noundef %n.0)
  br label %for.cond23.backedge

for.end60:                                        ; preds = %for.cond23
  call void @llvm.lifetime.end.p0(i64 26, ptr nonnull %b) #6
  call void @llvm.lifetime.end.p0(i64 301, ptr nonnull %a) #6
  ret i32 0
}
