...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50, ptr noundef align 16 %sentence) #7
  br label %while.cond
...
while.body5:                                      ; preds = %while.cond2
  ...
  %1 = load i8, ptr %p.0, align 1, !tbaa !5, !invariant.load !11
  br i1 %cmp7, label %if.then, label %if.else

if.then:                                          ; preds = %while.body5
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %1)
  %incdec.ptr = getelementptr inbounds nuw i8, ptr %p.0, i32 1
  br label %if.end

if.else:                                          ; preds = %while.body5
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %1)
  br label %while.cond10

while.cond10:                                     ; preds = %while.body13, %if.else
  %p.2 = phi ptr [ %p.0, %if.else ], [ %incdec.ptr14, %while.body13 ]
  %2 = load i8, ptr %p.2, align 1, !tbaa !5
  %conv11 = sext i8 %2 to i32
  %cmp12 = icmp eq i32 %conv11, 32
  br i1 %cmp12, label %while.body13, label %if.end
...
if.end:                                           ; preds = %while.cond10, %if.then
  %p.1 = phi ptr [ %incdec.ptr, %if.then ], [ %p.2, %while.cond10 ]
  br label %while.cond2, !llvm.loop !13

while.end16:                                      ; preds = %while.cond2
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  call void @llvm.lifetime.end.p0(i64 noundef 50, ptr noundef %sentence) #8
  ret i32 0
}
...
; Function Attrs: inlinehint mustprogress uwtable
define available_externally noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) %__out, i8 noundef signext %__c) local_unnamed_addr #2 {
entry:
  %__c.addr = alloca i8, align 1
  store i8 %__c, ptr %__c.addr, align 1, !tbaa !5
  %vtable = load ptr, ptr %__out, align 8, !tbaa !17, !invariant.load !11
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !17, !invariant.load !11
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !11
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !19, !invariant.load !11
  ret i64 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !30, !invariant.load !11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !38, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !5, !invariant.load !11
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !17, !invariant.load !11
...
!24 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !16, i64 0}
!25 = !{!"_ZTSNSt8ios_base6_WordsE", !16, i64 0, !21, i64 8}
!26 = !{!"int", !6, i64 0}
!27 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !16, i64 0}
!28 = !{!"_ZTSSt6locale", !29, i64 0}
!29 = !{!"p1 _ZTSNSt6locale5_ImplE", !16, i64 0}
!30 = !{!31, !35, i64 240}
...
!38 = !{!39, !6, i64 56}
!39 = !{!"_ZTSSt5ctypeIcE", !40, i64 0, !41, i64 16, !33, i64 24, !42, i64 32, !42, i64 40, !43, i64 48, !6, i64 56, !6, i64 57, !6, i64 313, !6, i64 569}
!40 = !{!"_ZTSNSt6locale5facetE", !26, i64 8}
