...
for.end30:                                        ; preds = %for.cond12
  ...
  %spec.select = call i32 @llvm.smax.i32(i32 %8, i32 %4)
  ...
  %smax104 = call i32 @llvm.smax.i32(i32 %spec.select, i32 noundef 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax110 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
for.cond55:                                       ; preds = %for.cond52, %for.inc80
  ...
  %exitcond119.not = icmp eq i64 %indvars.iv113, %wide.trip.count
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv107 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next108, %for.inc77 ]
  %exitcond112.not = icmp eq i64 %indvars.iv107, %wide.trip.count111
  br i1 %exitcond112.not, label %for.inc80, label %for.inc77
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv125 = phi i64 [ %indvars.iv.next126, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond129.not = icmp eq i64 %indvars.iv125, %wide.trip.count105
  br i1 %exitcond129.not, label %for.end93, label %for.inc91
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond136.not = icmp eq i64 %indvars.iv130, %wide.trip.count
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv154 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax145 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count146 = zext nneg i32 %smax145 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv142 = phi i64 [ %indvars.iv.next143, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond147.not = icmp eq i64 %indvars.iv142, %wide.trip.count146
  br i1 %exitcond147.not, label %if.end178, label %for.inc148
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax151 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count152 = zext nneg i32 %smax151 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv148 = phi i64 [ %indvars.iv.next149, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond153.not = icmp eq i64 %indvars.iv148, %wide.trip.count152
  br i1 %exitcond153.not, label %if.end178, label %for.inc170
