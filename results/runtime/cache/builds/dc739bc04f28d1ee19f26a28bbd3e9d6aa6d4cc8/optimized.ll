...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #8
...
while.cond:                                       ; preds = %if.end29, %entry
  ...
  %0 = load i64, ptr %gep, align 8, !tbaa !9
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(40) %a, i64 noundef 40)
  ...
  %or.cond40 = select i1 %cmp.i.i, i1 %or.cond.i, i1 false
  br i1 %or.cond40, label %if.then19.i, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %while.cond, %if.then19.i, %if.then28.i
  %vtable = phi ptr [ %vtable12.i, %while.cond ], [ %vtable.pre42, %if.then19.i ], [ %vtable.pre, %if.then28.i ]
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
  %gep41 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 32), i64 %vbase.offset
  %4 = load i32, ptr %gep41, align 8, !tbaa !22
  %and.i.i.i = and i32 %4, 5
  %cmp.i.not.i = icmp eq i32 %and.i.i.i, 0
  %5 = load i32, ptr %n, align 4
  %cmp = icmp sgt i32 %5, 0
  %or.cond = select i1 %cmp.i.not.i, i1 %cmp, i1 false
  br i1 %or.cond, label %while.body, label %while.end

while.body:                                       ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  %inc = add nsw i32 %i.0, 1
  %call4 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #9
...
if.end19:                                         ; preds = %if.end, %if.else14
  %sum.1 = phi i32 [ %add, %if.end ], [ %add7, %if.else14 ]
  %call.i.i11 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #10
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %a, i64 noundef %call.i.i11)
...
if.end23.thread:                                  ; preds = %if.end19
  ...
  %vbase.offset.i27 = load i64, ptr %vbase.offset.ptr.i26, align 8, !invariant.load !8
...
if.then25:                                        ; preds = %if.end.thread, %if.end
  ...
  %vbase.offset.i34 = load i64, ptr %vbase.offset.ptr.i33, align 8, !invariant.load !8
  %add.ptr.i35 = getelementptr inbounds i8, ptr @_ZSt4cout, i64 %vbase.offset.i34
  %call.i = call noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr.i35, i8 noundef signext 10)
  %call1.i36 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %call.i)
  ...
  %call.i.i19 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(40) %a) #10
  %call1.i20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(40) %a, i64 noundef %call.i.i19)
  br label %if.end29
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  ...
  %6 = load i32, ptr %n, align 4, !tbaa !31
  %dec = add nsw i32 %6, -1
  store i32 %dec, ptr %n, align 4, !tbaa !31
...
while.end:                                        ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull align 16 captures(none) dereferenceable(40) %a) #10
  ret i32 0
}
