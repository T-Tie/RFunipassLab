...
for.cond16:                                       ; preds = %for.cond4, %for.inc42
  %.pre16 = phi i32 [ %.pre, %for.inc42 ], [ %0, %for.cond4 ]
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc42 ], [ 0, %for.cond4 ]
  ...
  %6 = sext i32 %.pre16 to i64
  %cmp17 = icmp slt i64 %indvars.iv13, %6
...
for.inc42:                                        ; preds = %for.body18, %if.then
  %.pre = phi i32 [ %.pre.pre, %if.then ], [ %.pre16, %for.body18 ]
...
for.end44:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %j) #11
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %1, ptr readnone captures(none) %2) unnamed_addr #9 {
if.then_to_outline:
  %3 = load i32, ptr %1, align 4, !tbaa !5, !invariant.load !11
  %sub = add nsw i32 %3, -1
  %.promoted = load i32, ptr %0, align 4, !tbaa !5
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc31, %if.then_to_outline
  %4 = phi i32 [ %inc32, %for.inc31 ], [ %.promoted, %if.then_to_outline ]
  %cmp24 = icmp slt i32 %4, %sub
  %call29 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef undef)
...
if.then_after_outline.exitStub:                   ; preds = %for.cond23
  %call39 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call29, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret void
}
