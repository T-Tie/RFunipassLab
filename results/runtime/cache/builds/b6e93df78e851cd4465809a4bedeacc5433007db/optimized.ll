...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %.pr9 = phi i32 [ %.pr, %entry ], [ %sub, %while.body ]
  %cmp = icmp sgt i32 %.pr9, 99
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %inc = add nuw nsw i32 %a.0, 1
  %sub = add nsw i32 %.pr9, -100
...
while.cond1:                                      ; preds = %while.body4, %while.end
  ...
  %.pr10 = phi i32 [ %.pr9, %while.end ], [ %0, %while.body4 ]
  %0 = add i32 %.pr10, -50
...
while.cond8:                                      ; preds = %while.body13, %while.end7
  ...
  %.pr11 = phi i32 [ %.pr10, %while.end7 ], [ %1, %while.body13 ]
  %1 = add i32 %.pr11, -20
  %or.cond37 = icmp ult i32 %1, 30
  br i1 %or.cond37, label %while.body13, label %while.end16
...
while.cond17:                                     ; preds = %while.body22, %while.end16
  ...
  %.pr12 = phi i32 [ %.pr11, %while.end16 ], [ %2, %while.body22 ]
  %2 = add i32 %.pr12, -10
  %or.cond38 = icmp ult i32 %2, 10
  br i1 %or.cond38, label %while.body22, label %while.end25
...
land.end30:                                       ; preds = %while.end25, %while.body31
  ...
  %3 = phi i32 [ %.pr12, %while.end25 ], [ %sub33, %while.body31 ]
