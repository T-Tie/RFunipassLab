...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %i.0 = phi i32 [ 0, %entry ], [ %inc10, %if.end ]
  %num.0 = phi i32 [ 0, %entry ], [ %num.1, %if.end ]
...
for.end:                                          ; preds = %for.cond
  %sub = sub nsw i32 %num.0, 1
  br label %for.cond11

for.cond11:                                       ; preds = %for.end36, %for.end
  %l.0 = phi i32 [ %sub, %for.end ], [ %dec, %for.end36 ]
...
for.cond14:                                       ; preds = %if.end33, %for.body13
  %j.2 = phi i32 [ 0, %for.body13 ], [ %add, %if.end33 ]
  %cmp15 = icmp slt i32 %j.2, %num.0
...
for.cond39:                                       ; preds = %for.body41, %for.end38
  %j.3 = phi i32 [ 1, %for.end38 ], [ %inc46, %for.body41 ]
  %cmp40 = icmp slt i32 %j.3, %num.0
...
for.body41:                                       ; preds = %for.cond39
  ...
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %4)
...
for.end47:                                        ; preds = %for.cond39
  ...
  %call50 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5)
