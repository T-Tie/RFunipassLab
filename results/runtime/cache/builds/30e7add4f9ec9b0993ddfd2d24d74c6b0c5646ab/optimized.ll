...
if.then:                                          ; preds = %for.body
  ...
  %.pre14 = fdiv float %.pre, %.pre7
  %.pre15 = fdiv float %.pre8, %.pre9
  %.pre16 = fsub float %.pre14, %.pre15
  %.pre17 = fpext float %.pre16 to double
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %conv10.pre-phi = phi double [ %.pre17, %if.then ], [ %conv, %for.body ]
  %sub9.pre-phi = phi float [ %.pre16, %if.then ], [ %sub4, %for.body ]
  %cmp11 = fcmp olt double %conv10.pre-phi, -5.000000e-02
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end
  %puts5 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #6
  %.pre10 = load float, ptr %y, align 4, !tbaa !9
  %.pre11 = load float, ptr %x, align 4, !tbaa !9
  %.pre12 = load float, ptr %y1, align 4, !tbaa !9
  %.pre13 = load float, ptr %x1, align 4, !tbaa !9
  %.pre18 = fdiv float %.pre10, %.pre11
  %.pre19 = fdiv float %.pre12, %.pre13
  %.pre20 = fsub float %.pre18, %.pre19
  br label %if.end14

if.end14:                                         ; preds = %if.then12, %if.end
  %sub17.pre-phi = phi float [ %.pre20, %if.then12 ], [ %sub9.pre-phi, %if.end ]
...
if.then25:                                        ; preds = %if.end14
  %puts6 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #6
  br label %for.inc
