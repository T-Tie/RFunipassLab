...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %m1) #5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull %m2) #5
  ...
  %or.cond35 = or i1 %cmp6, %or.cond
  %3 = load i32, ptr %m2, align 4, !tbaa !5
  %smax62 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br i1 %or.cond35, label %for.cond30, label %for.cond112

for.cond30:                                       ; preds = %for.body, %for.inc56
  %n2.0 = phi i32 [ %add53, %for.inc56 ], [ 0, %for.body ]
  %4 = phi i32 [ %inc57, %for.inc56 ], [ 1, %for.body ]
  %exitcond63.not = icmp eq i32 %4, %smax62
  br i1 %exitcond63.not, label %for.end58, label %for.body32

for.body32:                                       ; preds = %for.cond30
  switch i32 %4, label %if.else52 [
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  ...
  %inc57 = add nuw i32 %4, 1
  br label %for.cond30, !llvm.loop !9

for.end58:                                        ; preds = %for.cond30
  %cmp59.not = icmp eq i32 %n2.0, 0
  br i1 %cmp59.not, label %for.inc164, label %if.then60

if.then60:                                        ; preds = %for.end58
  %rem6133 = urem i32 %n2.0, 7
  %cmp62 = icmp eq i32 %rem6133, 0
  %str.3.str.2 = select i1 %cmp62, ptr @str.3, ptr @str.2
  br label %for.inc164.sink.split

for.cond112:                                      ; preds = %for.body, %for.inc138
  %n283.0 = phi i32 [ %add135, %for.inc138 ], [ 0, %for.body ]
  %5 = phi i32 [ %inc139, %for.inc138 ], [ 1, %for.body ]
  %exitcond.not = icmp eq i32 %5, %smax62
  br i1 %exitcond.not, label %for.end140, label %for.body114

for.body114:                                      ; preds = %for.cond112
  switch i32 %5, label %if.else134 [
...
for.inc138:                                       ; preds = %for.body114, %for.inc138.fold.split, %if.else134
  ...
  %inc139 = add nuw i32 %5, 1
  br label %for.cond112, !llvm.loop !12

for.end140:                                       ; preds = %for.cond112
  %cmp141.not = icmp eq i32 %n283.0, 0
  br i1 %cmp141.not, label %for.inc164, label %if.then142

if.then142:                                       ; preds = %for.end140
  %rem14434 = urem i32 %n283.0, 7
  %cmp145 = icmp eq i32 %rem14434, 0
  %str.1.str = select i1 %cmp145, ptr @str.1, ptr @str
  br label %for.inc164.sink.split

for.inc164.sink.split:                            ; preds = %if.then142, %if.then60
  %str.1.sink = phi ptr [ %str.3.str.2, %if.then60 ], [ %str.1.str, %if.then142 ]
  %puts59 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.sink)
  br label %for.inc164

for.inc164:                                       ; preds = %for.inc164.sink.split, %for.end140, %for.end58
