...
if.else107:                                       ; preds = %if.else95
  ...
  %8 = load i32, ptr %arrayidx111, align 4, !tbaa !5, !invariant.load !9
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !25, !invariant.load !9
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !25, !invariant.load !9
