...
for.cond19:                                       ; preds = %if.end36, %for.body17
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %if.end36 ], [ %indvars.iv30, %for.body17 ]
...
for.cond43:                                       ; preds = %for.cond43.preheader, %if.end52
  %indvars.iv45 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next46, %if.end52 ]
