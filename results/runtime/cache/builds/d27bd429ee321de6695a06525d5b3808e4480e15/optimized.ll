...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre33, %for.inc ]
...
for.body16:                                       ; preds = %for.cond14
  ...
  br i1 %cmp22, label %for.inc26.split.loop.exit35, label %for.inc23

for.inc23:                                        ; preds = %for.body16
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  br label %for.cond14, !llvm.loop !13

for.inc26.split.loop.exit35:                      ; preds = %for.body16
  %5 = trunc nuw nsw i64 %indvars.iv29 to i32
  br label %for.inc26

for.inc26:                                        ; preds = %for.cond14, %for.inc26.split.loop.exit35
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit35 ], [ %r1.0, %for.cond14 ]
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit35 ], [ %c1.0, %for.cond14 ]
  %i.2 = phi i32 [ 9999, %for.inc26.split.loop.exit35 ], [ %i.1, %for.cond14 ]
...
for.body35:                                       ; preds = %for.cond33
  ...
  %6 = load i32, ptr %add.ptr40, align 4, !tbaa !5
