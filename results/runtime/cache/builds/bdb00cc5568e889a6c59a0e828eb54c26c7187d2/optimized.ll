...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
  %wide.trip.count19 = zext nneg i32 %smax18 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv9
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv6, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next7 = add nsw i64 %indvars.iv6, 1
  %7 = trunc nsw i64 %indvars.iv6 to i32
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv6
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv13 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next14, %for.inc44 ]
  %exitcond20.not = icmp eq i64 %indvars.iv13, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv13, %2
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv13
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next14 = add nuw nsw i64 %indvars.iv13, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond25.not = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond25.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv21
