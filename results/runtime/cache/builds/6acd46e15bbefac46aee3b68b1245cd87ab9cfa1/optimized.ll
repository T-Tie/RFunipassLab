...
entry.split:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %a) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %b) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %c) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %d) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %e) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %f) #4
  call void @llvm.lifetime.start.p0(i64 noundef 3996, ptr noundef nonnull %g) #4
  br label %for.cond

for.cond:                                         ; preds = %if.end, %entry.split
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end ], [ 1, %entry.split ]
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.body37
  %indvars.iv25 = phi i64 [ 1, %for.cond35.preheader ], [ %indvars.iv.next26, %for.body37 ]
  %exitcond = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond, label %for.end43, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %arrayidx39 = getelementptr inbounds nuw [999 x i32], ptr %g, i64 0, i64 %indvars.iv25
  %6 = load i32, ptr %arrayidx39, align 4, !tbaa !5, !invariant.load !9
  %call40 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %6) #5
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond35, !llvm.loop !13

for.end43:                                        ; preds = %for.cond35
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %g) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %f) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %e) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %d) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %c) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %b) #5
  call void @llvm.lifetime.end.p0(i64 noundef 3996, ptr noundef nonnull %a) #5
  ret i32 0
}
