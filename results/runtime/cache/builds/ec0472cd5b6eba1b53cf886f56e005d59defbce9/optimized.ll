...
if.end37.thread:                                  ; preds = %for.body30
  ...
  %6 = load i32, ptr %arrayidx416, align 4, !tbaa !5
...
for.inc50:                                        ; preds = %if.end37.thread, %if.end37, %if.then44, %if.end37.thread
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.1, %if.end37 ], [ 0, %if.end37.thread ], [ 0, %if.end37.thread ]
  %min.3 = phi i32 [ %7, %if.then44 ], [ %min.1, %if.end37 ], [ %5, %if.end37.thread ], [ %5, %if.end37.thread ]
