...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax104 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
  %wide.trip.count74 = zext nneg i32 %smax104 to i64
  %wide.trip.count = zext i32 %t.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %tailrecurse
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.inc25 ], [ 0, %tailrecurse ]
  %exitcond75.not = icmp eq i64 %indvars.iv71, %wide.trip.count74
  br i1 %exitcond75.not, label %for.cond28.preheader, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv71, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond11.preheader, %for.inc22
  %indvars.iv66 = phi i64 [ 0, %for.cond11.preheader ], [ %indvars.iv.next67, %for.inc22 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %wide.trip.count
  br i1 %exitcond70.not, label %for.inc25, label %for.inc22

for.inc22:                                        ; preds = %for.cond11
  %arrayidx17 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv71, i64 %indvars.iv66
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  %indvars.iv86 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next87, %for.inc63 ]
  %exitcond91.not = icmp eq i64 %indvars.iv86, %wide.trip.count74
  br i1 %exitcond91.not, label %for.end65, label %for.cond31

for.cond31:                                       ; preds = %for.cond28, %for.body33
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %for.body33 ], [ 0, %for.cond28 ]
  %s.2 = phi i32 [ %spec.select64, %for.body33 ], [ 9999, %for.cond28 ]
  %exitcond80.not = icmp eq i64 %indvars.iv76, %wide.trip.count
  br i1 %exitcond80.not, label %for.cond48.preheader, label %for.body33

for.cond48.preheader:                             ; preds = %for.cond31
  br label %for.cond48

for.body33:                                       ; preds = %for.cond31
  %arrayidx37 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv76, i64 %indvars.iv86
  %2 = load i32, ptr %arrayidx37, align 4, !tbaa !5
  %spec.select64 = tail call i32 @llvm.smin.i32(i32 %2, i32 %s.2)
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  br label %for.cond31, !llvm.loop !14

for.cond48:                                       ; preds = %for.cond48.preheader, %for.inc60
  %indvars.iv81 = phi i64 [ 0, %for.cond48.preheader ], [ %indvars.iv.next82, %for.inc60 ]
  %exitcond85.not = icmp eq i64 %indvars.iv81, %wide.trip.count
  br i1 %exitcond85.not, label %for.inc63, label %for.inc60

for.inc60:                                        ; preds = %for.cond48
  %arrayidx54 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv81, i64 %indvars.iv86
...
for.cond69:                                       ; preds = %for.inc125, %if.end68
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc125 ], [ 0, %if.end68 ]
  %exitcond106.not = icmp eq i64 %indvars.iv99, %wide.trip.count74
  br i1 %exitcond106.not, label %for.end127, label %for.cond72.preheader

for.cond72.preheader:                             ; preds = %for.cond69
  %6 = add nsw i64 %indvars.iv99, -1
  %7 = trunc nuw nsw i64 %indvars.iv99 to i32
  br label %for.cond72

for.cond72:                                       ; preds = %for.cond72.preheader, %for.inc122
  %indvars.iv92 = phi i64 [ 0, %for.cond72.preheader ], [ %indvars.iv.next93, %for.inc122 ]
  %exitcond98.not = icmp eq i64 %indvars.iv92, %wide.trip.count
  br i1 %exitcond98.not, label %for.inc125, label %for.body75
...
land.lhs.true:                                    ; preds = %for.body75
  %switch = icmp samesign ult i64 %indvars.iv92, 2
  br i1 %switch, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %for.body75
  %8 = trunc nuw nsw i64 %indvars.iv92 to i32
...
if.then85:                                        ; preds = %land.lhs.true
  %arrayidx89 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv99, i64 %indvars.iv92
  %9 = load i32, ptr %arrayidx89, align 4, !tbaa !5
  %10 = add nsw i64 %indvars.iv92, -1
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv99, i64 %10
  store i32 %9, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.then97:                                        ; preds = %lor.lhs.false.thread
  %arrayidx101 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv99, i64 %indvars.iv92
  %11 = load i32, ptr %arrayidx101, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %6, i64 %indvars.iv92
  store i32 %11, ptr %arrayidx106, align 4, !tbaa !5
  br label %for.inc122

if.else107:                                       ; preds = %lor.lhs.false.thread
  %arrayidx111 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv99, i64 %indvars.iv92
  %12 = load i32, ptr %arrayidx111, align 4, !tbaa !5
  %13 = add nsw i64 %indvars.iv92, -1
