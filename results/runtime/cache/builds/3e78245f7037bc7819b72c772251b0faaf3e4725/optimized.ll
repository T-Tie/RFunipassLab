...
entry:
  ...
  %smax11 = call i32 @llvm.smax.i32(i32 noundef %x, i32 noundef 0) #6
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [150 x i32], ptr %z, i64 %indvars.iv8, i64 %indvars.iv
...
for.cond:                                         ; preds = %for.inc29, %entry
  ...
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv24, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !9
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv21, %7
...
for.inc:                                          ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !9
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv21
...
for.end:                                          ; preds = %for.cond6
  ...
  %cmp15 = icmp slt i64 %indvars.iv21, %11
  br i1 %cmp15, label %for.inc26, label %if.else

if.else:                                          ; preds = %for.end
  %12 = zext i32 %sub to i64
  %cmp18 = icmp eq i64 %indvars.iv21, %12
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv24, %14
...
for.inc26:                                        ; preds = %for.end, %land.lhs.true, %if.else23
  ...
  %call24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.sink.sink, i32 noundef %z.0) #8
