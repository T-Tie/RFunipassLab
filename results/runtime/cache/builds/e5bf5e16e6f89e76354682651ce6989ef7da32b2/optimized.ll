...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 28000, ptr nonnull %sz) #3
  br label %for.cond

for.cond:                                         ; preds = %for.inc35, %entry
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc35 ], [ 0, %entry ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, 1000
  br i1 %exitcond31.not, label %for.end37, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv26, i64 %indvars.iv
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond1, !llvm.loop !5

for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv26
...
for.cond38:                                       ; preds = %for.cond41.preheader, %for.end37
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.cond41.preheader ], [ 0, %for.end37 ]
  %exitcond35.not = icmp eq i64 %indvars.iv32, %wide.trip.count
  br i1 %exitcond35.not, label %for.end75, label %for.cond41.preheader

for.cond41.preheader:                             ; preds = %for.cond38
  %arrayidx45 = getelementptr inbounds nuw [1000 x [7 x i32]], ptr %sz, i64 0, i64 %indvars.iv32
  ...
  %reass.add39 = add i32 %9, %neg38
  %reass.mul40 = mul i32 %reass.add39, 3600
  %12 = add i32 %.neg37, 43200
  %13 = add i32 %12, %11
  %14 = add i32 %13, %reass.mul40
  %15 = add i32 %14, %reass.mul
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %15)
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  br label %for.cond38, !llvm.loop !13

for.end75:                                        ; preds = %for.cond38
  call void @llvm.lifetime.end.p0(i64 28000, ptr nonnull %sz) #3
  ret i32 0
}
