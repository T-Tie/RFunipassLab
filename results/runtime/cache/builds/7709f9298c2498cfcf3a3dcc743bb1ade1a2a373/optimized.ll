...
for.cond:                                         ; preds = %for.end27, %if.end
  %i.0 = phi i32 [ 0, %if.end ], [ %inc29, %for.end27 ]
...
for.cond2:                                        ; preds = %if.end13, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %if.end13 ]
  %min.0 = phi i32 [ 32767, %for.body ], [ %min.1, %if.end13 ]
...
if.end13:                                         ; preds = %if.then8, %for.body4
...
for.cond14:                                       ; preds = %for.body16, %for.end
  %j.1 = phi i32 [ 0, %for.end ], [ %inc26, %for.body16 ]
...
for.cond31:                                       ; preds = %for.end65, %for.end30
  %i.1 = phi i32 [ 0, %for.end30 ], [ %inc67, %for.end65 ]
...
for.cond34:                                       ; preds = %if.end47, %for.body33
  %j.2 = phi i32 [ 0, %for.body33 ], [ %inc49, %if.end47 ]
  %min.2 = phi i32 [ 32767, %for.body33 ], [ %min.3, %if.end47 ]
  %cmp35 = icmp slt i32 %j.2, %n
  br i1 %cmp35, label %for.body36, label %for.end50

for.body36:                                       ; preds = %for.cond34
  %idxprom37 = sext i32 %j.2 to i64
...
if.end47:                                         ; preds = %if.then42, %for.body36
  %min.3 = phi i32 [ %2, %if.then42 ], [ %min.2, %for.body36 ]
  %inc49 = add nsw i32 %j.2, 1
  br label %for.cond34, !llvm.loop !14

for.end50:                                        ; preds = %for.cond34
  br label %for.cond51

for.cond51:                                       ; preds = %for.body53, %for.end50
  %j.3 = phi i32 [ 0, %for.end50 ], [ %inc64, %for.body53 ]
  %cmp52 = icmp slt i32 %j.3, %n
...
for.end68:                                        ; preds = %for.cond31
  ...
  %4 = load i32, ptr %arrayidx70, align 4, !tbaa !5
  br label %for.cond71

for.cond71:                                       ; preds = %for.end88, %for.end68
  %i.2 = phi i32 [ 1, %for.end68 ], [ %inc90, %for.end88 ]
...
for.cond75:                                       ; preds = %for.body77, %for.body74
  %j.4 = phi i32 [ 0, %for.body74 ], [ %inc87, %for.body77 ]
  %cmp76 = icmp slt i32 %j.4, %n
  %inc90 = add nsw i32 %i.2, 1
  br i1 %cmp76, label %for.body77, label %for.end88

for.body77:                                       ; preds = %for.cond75
  %idxprom78 = sext i32 %inc90 to i64
  %arrayidx79 = getelementptr inbounds [120 x i32], ptr %matrix, i64 %idxprom78
  %idxprom80 = sext i32 %j.4 to i64
  %arrayidx81 = getelementptr inbounds [120 x i32], ptr %arrayidx79, i64 0, i64 %idxprom80
  %5 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %idxprom82 = sext i32 %i.2 to i64
  ...
  store i32 %5, ptr %arrayidx85, align 4, !tbaa !5
  %inc87 = add nsw i32 %j.4, 1
...
for.cond92:                                       ; preds = %for.end111, %for.end91
  %i.3 = phi i32 [ 0, %for.end91 ], [ %inc113, %for.end111 ]
  %cmp94 = icmp slt i32 %i.3, %sub72
  br i1 %cmp94, label %for.body95, label %for.end114

for.body95:                                       ; preds = %for.cond92
  br label %for.cond96

for.cond96:                                       ; preds = %for.body99, %for.body95
  %j.5 = phi i32 [ 1, %for.body95 ], [ %add102, %for.body99 ]
  %cmp98 = icmp slt i32 %j.5, %sub72
  br i1 %cmp98, label %for.body99, label %for.end111

for.body99:                                       ; preds = %for.cond96
  %idxprom100 = sext i32 %i.3 to i64
  %arrayidx101 = getelementptr inbounds [120 x i32], ptr %matrix, i64 %idxprom100
  %add102 = add nsw i32 %j.5, 1
  %idxprom103 = sext i32 %add102 to i64
  %arrayidx104 = getelementptr inbounds [120 x i32], ptr %arrayidx101, i64 0, i64 %idxprom103
  %6 = load i32, ptr %arrayidx104, align 4, !tbaa !5
  %idxprom107 = sext i32 %j.5 to i64
  %arrayidx108 = getelementptr inbounds [120 x i32], ptr %arrayidx101, i64 0, i64 %idxprom107
  store i32 %6, ptr %arrayidx108, align 4, !tbaa !5
  br label %for.cond96, !llvm.loop !19

for.end111:                                       ; preds = %for.cond96
  %inc113 = add nsw i32 %i.3, 1
  br label %for.cond92, !llvm.loop !20

for.end114:                                       ; preds = %for.cond92
  %call = call noundef i32 @_Z3calPA120_ii(ptr nofree noundef nonnull align 4 captures(none) dereferenceable(488) %matrix, i32 noundef %sub72) #4
  %add116 = add nsw i32 %4, %call
  br label %return

return:                                           ; preds = %entry, %for.end114
  %retval.0 = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  ret i32 %retval.0
}
...
for.cond1:                                        ; preds = %for.end, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc11, %for.end ]
...
for.cond4:                                        ; preds = %for.body6, %for.body3
  %k.0 = phi i32 [ 0, %for.body3 ], [ %inc, %for.body6 ]
