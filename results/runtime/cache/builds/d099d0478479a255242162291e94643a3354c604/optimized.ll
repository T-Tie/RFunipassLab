...
entry:
  ...
  %smax5 = call i32 @llvm.smax.i32(i32 noundef %x, i32 noundef 0) #5
...
for.cond:                                         ; preds = %for.inc29, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc29 ], [ 0, %entry ]
  %4 = load i32, ptr %m, align 4, !tbaa !9
  %5 = sext i32 %4 to i64
  %cmp = icmp slt i64 %indvars.iv6, %5
  br i1 %cmp, label %for.cond3, label %for.end31

for.cond3:                                        ; preds = %for.cond, %for.inc26
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc26 ], [ 0, %for.cond ]
  %6 = load i32, ptr %p, align 4, !tbaa !9
  %7 = sext i32 %6 to i64
  %cmp4 = icmp slt i64 %indvars.iv3, %7
...
for.inc:                                          ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %a, i64 0, i64 %indvars.iv6, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx10, align 4, !tbaa !9
  %arrayidx14 = getelementptr inbounds nuw [150 x [150 x i32]], ptr %b, i64 0, i64 %indvars.iv, i64 %indvars.iv3
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %cmp20 = icmp slt i64 %indvars.iv6, %14
