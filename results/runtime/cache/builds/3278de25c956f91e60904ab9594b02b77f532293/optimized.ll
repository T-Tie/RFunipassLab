...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 201, ptr noundef nonnull align 16 captures(none) dereferenceable(201) %a) #9
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp4.not, label %if.else, label %for.inc.sink.split
...
for.inc.sink.split:                               ; preds = %if.else, %for.body
  %.sink = phi i8 [ %0, %for.body ], [ 32, %if.else ]
  %f.1.ph = phi i32 [ 1, %for.body ], [ 0, %if.else ]
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %.sink)
  br label %for.inc

for.inc:                                          ; preds = %for.inc.sink.split, %if.else
  %f.1 = phi i32 [ %f.0, %if.else ], [ %f.1.ph, %for.inc.sink.split ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 201, ptr noundef nonnull captures(none) %a) #11
  ret i32 0
}
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !12, !invariant.load !8
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load ptr, ptr %this, align 8, !tbaa !21, !invariant.load !8
...
!23 = !{!24, !25, i64 16}
!24 = !{!"_ZTSSt8ios_base", !25, i64 8, !25, i64 16, !26, i64 24, !27, i64 28, !27, i64 32, !28, i64 40, !29, i64 48, !6, i64 64, !15, i64 192, !30, i64 200, !31, i64 208}
!25 = !{!"long", !6, i64 0}
!26 = !{!"_ZTSSt13_Ios_Fmtflags", !6, i64 0}
!27 = !{!"_ZTSSt12_Ios_Iostate", !6, i64 0}
!28 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !17, i64 0}
!29 = !{!"_ZTSNSt8ios_base6_WordsE", !17, i64 0, !25, i64 8}
!30 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !17, i64 0}
!31 = !{!"_ZTSSt6locale", !32, i64 0}
!32 = !{!"p1 _ZTSNSt6locale5_ImplE", !17, i64 0}
