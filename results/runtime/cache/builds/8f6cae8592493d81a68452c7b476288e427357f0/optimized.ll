...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax29 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
for.cond49.preheader:                             ; preds = %for.cond31
  ...
  %smax35 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv54, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv54, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre59, %for.body87 ]
