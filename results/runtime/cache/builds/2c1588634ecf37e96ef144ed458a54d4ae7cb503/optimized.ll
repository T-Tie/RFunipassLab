...
for.cond:                                         ; preds = %if.end86, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %inc, %if.end86 ]
...
if.end34:                                         ; preds = %if.then28, %if.end
  ...
  br i1 %cmp39, label %if.then40, label %if.end86
...
if.end86.sink.split:                              ; preds = %if.else, %if.then42
  %call60 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %if.end86

if.end86:                                         ; preds = %if.end86.sink.split, %if.end34
