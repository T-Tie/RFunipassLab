...
for.cond1:                                        ; preds = %for.inc, %for.body
  %.sink3 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ]
  %cmp2 = icmp slt i32 %.sink3, 6
...
for.inc:                                          ; preds = %for.cond1
  ...
  %idxprom4 = sext i32 %.sink3 to i64
...
for.cond41:                                       ; preds = %for.inc69, %for.body40
  ...
  %.sink4 = phi i32 [ 0, %for.body40 ], [ %inc70, %for.inc69 ]
  %cmp42 = icmp slt i32 %.sink4, 6
