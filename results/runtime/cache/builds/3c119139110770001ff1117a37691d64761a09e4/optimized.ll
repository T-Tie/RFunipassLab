...
for.cond:                                         ; preds = %for.inc28, %entry
  ...
  br i1 %exitcond47.not, label %for.cond31.preheader, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv38 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next39, %for.inc25 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc69
  %indvars.iv58 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next59, %for.inc69 ]
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv53 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next54, %for.inc66 ]
...
for.cond.loopexit:                                ; preds = %for.cond1
  br label %for.cond, !llvm.loop !17

for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv19 = phi i64 [ 1, %entry ], [ %indvars.iv.next20, %for.cond.loopexit ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.inc
...
for.cond13:                                       ; preds = %for.cond13.loopexit, %for.cond13.preheader
  %indvars.iv30 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next31, %for.cond13.loopexit ]
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  ...
  br i1 %exitcond29.not, label %for.cond13.loopexit, label %for.inc30
...
for.cond1:                                        ; preds = %for.inc12, %for.body
  ...
  br i1 %cmp2, label %for.cond5.preheader, label %for.inc17

for.cond5.preheader:                              ; preds = %for.cond1
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc
  %3 = phi i32 [ %.pre, %for.inc ], [ %1, %for.cond5.preheader ]
...
for.inc17:                                        ; preds = %for.cond1
  call void @_Z1fi(i32 noundef %1) #7
