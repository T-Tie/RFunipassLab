...
for.inc10:                                        ; preds = %for.cond2
  ...
  %call7 = call noundef i32 @_Z4factii(i32 noundef %3, i32 noundef 2) #8
...
for.inc20:                                        ; preds = %for.cond13
  ...
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %6)
...
if.else3:                                         ; preds = %if.else
  store i32 %m, ptr %i, align 4, !tbaa !5
  br label %for.cond
...
if.then6:                                         ; preds = %for.body
  ...
  %div = sdiv i32 %n, %0
  %call = call noundef i32 @_Z4factii(i32 noundef %div, i32 noundef %0) #10
...
cleanup:                                          ; preds = %if.else, %entry, %for.end
  %.sink = phi i32 [ %2, %for.end ], [ 0, %entry ], [ 1, %if.else ]
