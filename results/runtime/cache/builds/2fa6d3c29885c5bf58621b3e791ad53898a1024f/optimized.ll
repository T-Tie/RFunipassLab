...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  %call2 = call noundef i32 @_Z5afteriii(i32 noundef 1, i32 noundef 0, i32 noundef %0)
...
if.then11:                                        ; preds = %if.else5
  %add = add nsw i32 %i, 1
  %call = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %i, i32 noundef %n)
  %add12 = add nsw i32 1, %call
  %call14 = call noundef i32 @_Z5afteriii(i32 noundef %add, i32 noundef %fin, i32 noundef %n)
  %call15 = call noundef i32 @_Z3maxii(i32 noundef %add12, i32 noundef %call14)
  br label %if.end

if.else16:                                        ; preds = %if.else5
  %add17 = add nsw i32 %i, 1
  %call18 = call noundef i32 @_Z5afteriii(i32 noundef %add17, i32 noundef %fin, i32 noundef %n)
  br label %if.end
...
define linkonce_odr dso_local noundef i32 @_Z3maxii(i32 noundef %a, i32 noundef %b) local_unnamed_addr #4 comdat {
entry:
