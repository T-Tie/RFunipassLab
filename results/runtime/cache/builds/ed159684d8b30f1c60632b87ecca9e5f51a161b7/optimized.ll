...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 50000, ptr %word) #7
...
for.body5:                                        ; preds = %for.cond3
  ...
  %call9 = call i64 @strlen(ptr noundef %arrayidx7) #8
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 50000, ptr %word) #7
  ret i32 0
}
...
if.then33_after_outline.exitStub:
  %call37 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
