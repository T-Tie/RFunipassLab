...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %a) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(256) %a, i8 noundef 0, i64 noundef 256, i1 noundef false) #9
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %b) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(256) %b, i8 noundef 0, i64 noundef 256, i1 noundef false) #9
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 dereferenceable(256) %c) #8
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(256) %c, i8 noundef 0, i64 noundef 256, i1 noundef false) #9
...
land.lhs.true.i15:                                ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i
  ...
  br i1 %or.cond.i, label %if.then19.i20, label %land.lhs.true.i43

if.then19.i20:                                    ; preds = %land.lhs.true.i15
  %_M_streambuf.i.i21 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 232
  %4 = load ptr, ptr %_M_streambuf.i.i21, align 8, !tbaa !23, !invariant.load !8
  %call25.i22 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %4)
...
land.lhs.true.i43:                                ; preds = %if.then28.i27, %if.then19.i20, %land.lhs.true.i15
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(256) %c, i64 noundef 256)
  br i1 %or.cond.i, label %if.then19.i48, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56

if.then19.i48:                                    ; preds = %land.lhs.true.i43
  %_M_streambuf.i.i49 = getelementptr inbounds nuw i8, ptr %add.ptr10.i, i64 232
  %5 = load ptr, ptr %_M_streambuf.i.i49, align 8, !tbaa !23, !invariant.load !8
  %call25.i50 = call noundef i32 @_ZNSt15basic_streambufIcSt11char_traitsIcEE5sgetcEv(ptr noundef nonnull align 8 dereferenceable(64) %5)
  %cmp.i2.i51 = icmp eq i32 %call25.i50, -1
  %conv.i52 = zext i1 %cmp.i2.i51 to i64
  %expval.i53 = call i64 @llvm.expect.i64(i64 %conv.i52, i64 1)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then6.i36, %land.lhs.true.i43, %if.then19.i48, %if.then28.i55
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #10
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = load i8, ptr %arrayidx, align 1, !tbaa !31, !invariant.load !8
...
for.body16:                                       ; preds = %for.cond14
  ...
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !31, !invariant.load !8
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv114
  %9 = load i8, ptr %arrayidx21, align 1, !tbaa !31, !invariant.load !8
...
for.end.split.loop.exit:                          ; preds = %for.body16
  %10 = trunc nuw nsw i64 %indvars.iv114 to i32
  br label %for.end
...
for.body39:                                       ; preds = %for.cond37
  ...
  %11 = load i8, ptr %arrayidx41, align 1, !tbaa !31, !invariant.load !8
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %11, ptr %__c.addr.i, align 1, !tbaa !31
  ...
  %12 = load i64, ptr %gep, align 8, !tbaa !22, !invariant.load !8
...
for.body50:                                       ; preds = %for.cond48
  ...
  %16 = load i64, ptr %gep110, align 8, !tbaa !22, !invariant.load !8
  %cmp.not.i83 = icmp eq i64 %16, 0
...
if.end.i87:                                       ; preds = %for.body50
  %call2.i88 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %15)
  br label %for.inc54
...
if.end57:                                         ; preds = %for.cond48, %if.then34
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %a) #10
  ret i32 0
}
