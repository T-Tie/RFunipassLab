...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv31 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next32, %for.inc33 ]
  %indvars.iv6 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next7, %for.inc33 ]
  %smax33 = call i64 @llvm.smax.i64(i64 %indvars.iv31, i64 noundef 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.body10 ], [ 0, %for.cond3 ]
  %maxIndex.0 = phi i32 [ %spec.select, %for.body10 ], [ 0, %for.cond3 ]
  %exitcond34 = icmp eq i64 %indvars.iv3, %smax33
  br i1 %exitcond34, label %for.end18, label %for.body10
