...
for.cond38.preheader:                             ; preds = %for.cond34
  %idxprom51 = zext nneg i32 %i.2 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc49
  %indvars.iv29 = phi i64 [ %8, %for.cond38.preheader ], [ %indvars.iv.next30, %for.inc49 ]
  %cmp39 = icmp sgt i64 %indvars.iv29, -1
  %9 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51, i64 %indvars.iv29
...
for.end61.loopexit:                               ; preds = %for.body40
  %11 = trunc nsw i64 %indvars.iv29 to i32
  br label %for.end61

for.end61:                                        ; preds = %for.end50, %for.cond34, %for.end61.loopexit
  %x2.1 = phi i32 [ %i.2, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %y2.1 = phi i32 [ %11, %for.end61.loopexit ], [ 0, %for.cond34 ], [ 0, %for.end50 ]
  %12 = xor i32 %y1.1, -1
  %sub63 = add i32 %y2.1, %12
  %13 = xor i32 %x1.1, -1
  %sub66 = add i32 %x2.1, %13
