...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %initial) #7
...
if.then19.i:                                      ; preds = %entry
  call fastcc void @outlined_ir_func_1(ptr %add.ptr15.i)
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %if.then19.i, %entry
  call fastcc void @outlined_ir_func_2(ptr %initial)
...
while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 41, ptr nonnull %word) #7
...
if.then19.i31:                                    ; preds = %while.body
  call fastcc void @outlined_ir_func_1(ptr %add.ptr15.i24)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call fastcc void @outlined_ir_func_2(ptr %word)
  %inc = add nuw nsw i32 %t.0, 1
  call void @llvm.lifetime.end.p0(i64 41, ptr nonnull %word) #7
  br label %while.cond, !llvm.loop !23

while.end:                                        ; preds = %while.cond
  call fastcc void @outlined_ir_func_0()
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %initial) #7
...
if.then19.i_to_outline:                           ; preds = %newFuncRoot
  ...
  %1 = load ptr, ptr %_M_streambuf.i.i, align 8, !tbaa !26
...
!26 = !{!27, !30, i64 232}
!27 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !9, i64 0, !28, i64 216, !11, i64 224, !29, i64 225, !30, i64 232, !31, i64 240, !32, i64 248, !33, i64 256}
!28 = !{!"p1 _ZTSSo", !15, i64 0}
!29 = !{!"bool", !11, i64 0}
!30 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !15, i64 0}
!31 = !{!"p1 _ZTSSt5ctypeIcE", !15, i64 0}
!32 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !15, i64 0}
!33 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !15, i64 0}
