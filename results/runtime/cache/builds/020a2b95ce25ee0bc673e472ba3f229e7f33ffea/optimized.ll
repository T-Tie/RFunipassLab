...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax33 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax38 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax39 = call i32 @llvm.smax.i32(i32 %smax38, i32 noundef 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax45 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax80 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax86 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar17 = call i32 @putchar(i32 noundef 10) #7
  br label %for.inc198
