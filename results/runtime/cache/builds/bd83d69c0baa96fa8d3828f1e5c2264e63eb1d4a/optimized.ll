...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 50000, ptr noundef nonnull align 16 dereferenceable(50000) %word) #10
...
for.body5:                                        ; preds = %for.cond3
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull %arrayidx7) #11
  %add = add i64 %call9, 1
...
if.end:                                           ; preds = %for.body5
  call void @outlined_ir_func_0(ptr noundef nonnull %arrayidx7)
  br label %for.inc40
...
for.end42:                                        ; preds = %for.cond3
  ...
  call void @outlined_ir_func_0(ptr nonnull %arrayidx45)
