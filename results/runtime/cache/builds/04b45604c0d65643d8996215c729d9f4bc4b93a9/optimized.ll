...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv26 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next27, %if.end ]
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.end46
  %indvars.iv33 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next34, %for.end46 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.end46 ]
...
for.cond22:                                       ; preds = %for.cond22.preheader, %if.end43
  %indvars.iv30 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next31, %if.end43 ]
  %exitcond37.not = icmp eq i64 %indvars.iv30, %wide.trip.count36
  br i1 %exitcond37.not, label %for.end46, label %for.body26
...
for.cond52:                                       ; preds = %for.body54, %for.end49
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.body54 ], [ 1, %for.end49 ]
