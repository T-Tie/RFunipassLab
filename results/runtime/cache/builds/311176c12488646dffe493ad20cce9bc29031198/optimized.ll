...
entry:
  ...
  %rem1 = srem i32 %rem, 50
  %sub2 = sub nsw i32 %rem, %rem1
  %div3 = sdiv i32 %sub2, 50
  store i32 %rem1, ptr %n, align 4, !tbaa !5
  %rem4 = srem i32 %rem1, 20
  %sub5 = sub nsw i32 %rem1, %rem4
  %div6 = sdiv i32 %sub5, 20
  store i32 %rem4, ptr %n, align 4, !tbaa !5
  %rem7 = srem i32 %rem4, 10
  %sub8 = sub nsw i32 %rem4, %rem7
  %div9 = sdiv i32 %sub8, 10
  store i32 %rem7, ptr %n, align 4, !tbaa !5
  %rem10 = srem i32 %rem7, 5
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div3)
  ...
  %call17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div6)
  ...
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div9)
  ...
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %div12)
  ...
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %rem10)
