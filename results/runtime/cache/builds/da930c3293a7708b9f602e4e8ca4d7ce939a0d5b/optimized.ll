...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv11 = phi i64 [ 0, %entry ], [ %indvars.iv.next12, %for.cond1 ]
...
for.cond1.preheader:                              ; preds = %for.cond
  ...
  %3 = add i32 %2, -1
  %4 = trunc nuw i64 %indvars.iv.next12 to i32
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre15, %for.inc ]
...
for.body3.for.inc_crit_edge:                      ; preds = %for.body3
  %.pre16 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc
...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  %indvars.iv.next.pre-phi = phi i64 [ %.pre16, %for.body3.for.inc_crit_edge ], [ %8, %land.lhs.true ]
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub7 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub7, 1
