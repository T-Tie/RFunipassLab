...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(300) %0) unnamed_addr #7 {
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_after_outline.exitStub:
  %call.i.i = tail call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(300) %0) #12
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(300) %0, i64 noundef %call.i.i)
  ret void
}
