...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond56.not, label %for.cond27, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv52
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv52, i64 %indvars.iv47
...
for.cond27:                                       ; preds = %for.cond, %for.inc60
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc60 ], [ 0, %for.cond ]
  %exitcond72.not = icmp eq i64 %indvars.iv67, %wide.trip.count55
  br i1 %exitcond72.not, label %for.end62, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv67
  %3 = load i32, ptr %arrayidx31, align 4, !tbaa !5, !invariant.load !15
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.body34 ], [ 0, %for.body29 ]
  %min.2 = phi i32 [ %spec.select45, %for.body34 ], [ %3, %for.body29 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count
  br i1 %exitcond61.not, label %for.cond49.preheader, label %for.body34

for.cond49.preheader:                             ; preds = %for.cond32
  br label %for.cond49

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv57, i64 %indvars.iv67
  %4 = load i32, ptr %arrayidx38, align 4, !tbaa !5, !invariant.load !15
  %spec.select45 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  br label %for.cond32, !llvm.loop !20

for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc57 ], [ 0, %for.cond49.preheader ]
  %exitcond66.not = icmp eq i64 %indvars.iv62, %wide.trip.count
  br i1 %exitcond66.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv67
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  %indvars.iv78 = phi i64 [ 2, %for.cond65.preheader ], [ %indvars.iv.next79, %for.inc83 ]
  %exitcond84.not = icmp eq i64 %indvars.iv78, %wide.trip.count83
  br i1 %exitcond84.not, label %for.cond86, label %for.cond68.preheader

for.cond68.preheader:                             ; preds = %for.cond65
  %7 = add nsw i64 %indvars.iv78, -1
  br label %for.cond68

for.cond68:                                       ; preds = %for.cond68.preheader, %for.inc80
  %indvars.iv73 = phi i64 [ 0, %for.cond68.preheader ], [ %indvars.iv.next74, %for.inc80 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count
  br i1 %exitcond77.not, label %for.inc83, label %for.inc80

for.inc80:                                        ; preds = %for.cond68
  %arrayidx74 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv78, i64 %indvars.iv73
  %8 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !15
  %arrayidx79 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %7, i64 %indvars.iv73
...
for.cond86:                                       ; preds = %for.cond65, %for.inc104
  %indvars.iv90 = phi i64 [ %indvars.iv.next91, %for.inc104 ], [ 2, %for.cond65 ]
  %exitcond96.not = icmp eq i64 %indvars.iv90, %wide.trip.count83
  br i1 %exitcond96.not, label %for.end106, label %for.cond89.preheader

for.cond89.preheader:                             ; preds = %for.cond86
  %9 = add nsw i64 %indvars.iv90, -1
  br label %for.cond89

for.cond89:                                       ; preds = %for.cond89.preheader, %for.inc101
  %indvars.iv85 = phi i64 [ 0, %for.cond89.preheader ], [ %indvars.iv.next86, %for.inc101 ]
  %exitcond89.not = icmp eq i64 %indvars.iv85, %wide.trip.count
  br i1 %exitcond89.not, label %for.inc104, label %for.inc101

for.inc101:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv85, i64 %indvars.iv90
  %10 = load i32, ptr %arrayidx95, align 4, !tbaa !5, !invariant.load !15
  %arrayidx100 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv85, i64 %9
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !27, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !45, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !51, !invariant.load !15
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !13, !invariant.load !15
