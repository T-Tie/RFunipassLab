...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef align 4 %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef align 4 %__c) #3 comdat {
entry:
...
if.else10:                                        ; preds = %if.else7
  ...
  %spec.select17 = select i1 %cmp.i9, ptr %__c.addr, ptr %__b.addr
  br label %if.end16

if.end16:                                         ; preds = %if.else10, %if.else, %if.else7, %if.then
  %__b.addr.sink.sink.sink = phi ptr [ %__b.addr, %if.then ], [ %__a.addr, %if.else7 ], [ %spec.select, %if.else ], [ %spec.select17, %if.else10 ]
...
define linkonce_odr dso_local noundef nonnull ptr @_ZSt21__unguarded_partitionIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_S4_T0_(ptr noundef %__first, ptr noundef %__last, ptr noundef align 4 %__pivot) #4 comdat {
entry:
