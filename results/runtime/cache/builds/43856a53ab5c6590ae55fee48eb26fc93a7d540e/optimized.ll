...
while.cond1:                                      ; preds = %while.body4, %while.end
  %.pr2 = phi i32 [ %sub6, %while.body4 ], [ %.pr1, %while.end ]
  %1 = phi i32 [ %sub6, %while.body4 ], [ %.pr1, %while.end ]
...
while.end41:                                      ; preds = %while.cond35, %while.body40, %land.end39
  %f.0 = phi i32 [ %5, %while.body40 ], [ 0, %land.end39 ], [ 0, %while.cond35 ]
