...
for.body:                                         ; preds = %for.cond
  ...
  %1 = load double, ptr %arrayidx, align 16, !tbaa !9
  %2 = load double, ptr %arrayidx5, align 8, !tbaa !9
  %3 = load double, ptr %arrayidx8, align 16, !tbaa !9
  %mul19 = fmul double 4.000000e+00, %1
...
if.then:                                          ; preds = %for.body
  %fneg = fneg double %2
  %call25 = call double @sqrt(double noundef %4) #12, !tbaa !5
  ...
  %call34 = call double @sqrt(double noundef %4) #12, !tbaa !5
...
if.else46:                                        ; preds = %if.else
  ...
  %mul48 = fmul double 2.000000e+00, %1
  %div49 = fdiv double %fneg47, %mul48
  br label %if.end

if.end:                                           ; preds = %if.else46, %if.then42
  %div49.sink = phi double [ %div49, %if.else46 ], [ 0.000000e+00, %if.then42 ]
  ...
  %call57 = call double @sqrt(double noundef %5) #12, !tbaa !5
  %mul58 = fmul double 2.000000e+00, %1
  ...
  %call67 = call double @sqrt(double noundef %5) #12, !tbaa !5
...
for.body77:                                       ; preds = %for.cond74
  ...
  %7 = load double, ptr %arrayidx80, align 8, !tbaa !9
  %8 = load double, ptr %arrayidx79, align 16, !tbaa !9
  %mul88 = fmul double 4.000000e+00, %8
  %arrayidx91 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 2
  %9 = load double, ptr %arrayidx91, align 16, !tbaa !9
...
if.then95:                                        ; preds = %for.body77
  ...
  %11 = load double, ptr %arrayidx98, align 8, !tbaa !9
  %arrayidx101 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %12 = load double, ptr %arrayidx101, align 16, !tbaa !9
  %cmp102 = fcmp une double %11, %12
  br i1 %cmp102, label %if.then103, label %if.else111

if.then103:                                       ; preds = %if.then95
  %call110 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %11, double noundef %12) #11
  br label %for.inc132

if.else111:                                       ; preds = %if.then95
  %call115 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %11) #11
  br label %for.inc132

if.else117:                                       ; preds = %for.body77
  %arrayidx120 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 3
  %13 = load double, ptr %arrayidx120, align 8, !tbaa !9
  %arrayidx123 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 4
  %14 = load double, ptr %arrayidx123, align 16, !tbaa !9
  %arrayidx129 = getelementptr inbounds [100 x double], ptr %arrayidx79, i64 0, i64 5
  %15 = load double, ptr %arrayidx129, align 8, !tbaa !9
  %call130 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %13, double noundef %14, double noundef %13, double noundef %15) #11
  br label %for.inc132
