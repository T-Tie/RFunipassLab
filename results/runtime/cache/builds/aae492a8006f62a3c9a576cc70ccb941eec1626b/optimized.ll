...
for.body25:                                       ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_2(ptr %add.ptr27)
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  call fastcc void @outlined_ir_func_1(ptr %__c.addr.i, ptr %vbase.offset.ptr.i7)
  br label %for.inc31
...
for.end33:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0(ptr %gep87, ptr %vbase.offset.ptr.i54)
  %12 = trunc nuw nsw i64 %indvars.iv98 to i32
...
for.end56:                                        ; preds = %for.cond45
  ...
  call fastcc void @outlined_ir_func_0(ptr %add.ptr59, ptr %vbase.offset.ptr.i32)
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !37, !invariant.load !9
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !40, !invariant.load !9
...
if.then:                                          ; preds = %entry
  %2 = load i8, ptr %0, align 1, !tbaa !41, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !41, !invariant.load !9
  br label %return
...
for.end33_to_outline:                             ; preds = %newFuncRoot
  %call.i.i13 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #10
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0, i64 noundef %call.i.i13)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr %0, ptr %1) unnamed_addr #8 {
newFuncRoot:
  br label %for.body25_to_outline

for.body25_to_outline:                            ; preds = %newFuncRoot
  store i8 32, ptr %0, align 1, !tbaa !41
...
if.then.i:                                        ; preds = %for.body25_to_outline
  %call1.i11 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %0, i64 noundef 1)
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr %0) unnamed_addr #8 {
newFuncRoot:
  br label %for.body25_to_outline
...
for.body25_to_outline:                            ; preds = %newFuncRoot
  ...
  br label %for.body25_after_outline.exitStub

for.body25_after_outline.exitStub:                ; preds = %for.body25_to_outline
  ret void
}
...
!37 = !{!38, !39, i64 16}
!38 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !39, i64 8, !39, i64 16, !39, i64 24, !39, i64 32, !39, i64 40, !39, i64 48, !19, i64 56}
