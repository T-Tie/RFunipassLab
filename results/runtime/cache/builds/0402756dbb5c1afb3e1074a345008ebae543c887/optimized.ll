...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 captures(none) dereferenceable(100000) %a) #10
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %idx.ext = sext i32 %.sink to i64
  %add.ptr = getelementptr inbounds [100 x i8], ptr %a, i64 %idx.ext
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull dereferenceable(100) %add.ptr)
...
for.end:                                          ; preds = %for.body, %for.cond
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull align 16 dereferenceable(100000) %a)
  store i32 1, ptr %j, align 4, !tbaa !8
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc16, %for.end
  %0 = load i32, ptr %j, align 4, !tbaa !8
  %cmp8 = icmp sle i32 %0, %.sink
  br i1 %cmp8, label %for.inc16, label %for.end18
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %idx.ext12 = sext i32 %0 to i64
  %add.ptr13 = getelementptr inbounds [100 x i8], ptr %a, i64 %idx.ext12
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call10, ptr noundef nonnull %add.ptr13)
  %inc17 = add nsw i32 %0, 1
  store i32 %inc17, ptr %j, align 4, !tbaa !8
  br label %for.cond7, !llvm.loop !12

for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 100000, ptr noundef captures(none) %a) #11
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %j) #11
  ret i32 0
}
...
do.end:                                           ; preds = %entry
  %vtable = load ptr, ptr %__in, align 8, !tbaa !13
  ...
  %vtable1 = load ptr, ptr %__in, align 8, !tbaa !13
  %vbase.offset.ptr2 = getelementptr i8, ptr %vtable1, i64 -24
  %vbase.offset3 = load i64, ptr %vbase.offset.ptr2, align 8, !invariant.load !15
...
if.then6:                                         ; preds = %if.else
  %vtable7 = load ptr, ptr %__in, align 8, !tbaa !13
  %vbase.offset.ptr8 = getelementptr i8, ptr %vtable7, i64 -24
  %vbase.offset9 = load i64, ptr %vbase.offset.ptr8, align 8, !invariant.load !15
  ...
  %vtable12 = load ptr, ptr %__in, align 8, !tbaa !13
  %vbase.offset.ptr13 = getelementptr i8, ptr %vtable12, i64 -24
  %vbase.offset14 = load i64, ptr %vbase.offset.ptr13, align 8, !invariant.load !15
...
if.then19:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %vtable20 = load ptr, ptr %__in, align 8, !tbaa !13
  %vbase.offset.ptr21 = getelementptr i8, ptr %vtable20, i64 -24
  %vbase.offset22 = load i64, ptr %vbase.offset.ptr21, align 8, !invariant.load !15
  ...
  store i32 %call25, ptr %__c, align 4, !tbaa !8
  ...
  store i32 %call26, ptr %ref.tmp, align 4, !tbaa !8
...
if.then28:                                        ; preds = %if.then19
  %vtable29 = load ptr, ptr %__in, align 8, !tbaa !13
  %vbase.offset.ptr30 = getelementptr i8, ptr %vtable29, i64 -24
  %vbase.offset31 = load i64, ptr %vbase.offset.ptr30, align 8, !invariant.load !15
...
; Function Attrs: inlinehint mustprogress uwtable
define available_externally i32 @getchar() local_unnamed_addr #2 {
entry:
...
; Function Attrs: inlinehint mustprogress uwtable
define available_externally noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %__out, ptr noundef %__s) local_unnamed_addr #2 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %this) local_unnamed_addr #5 align 2 {
entry:
  %call = call noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) #11
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %this) local_unnamed_addr #5 align 2 {
entry:
  %_M_streambuf = getelementptr inbounds nuw %"class.std::basic_ios", ptr %this, i32 0, i32 4
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !29
  ret ptr %0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr align 4 %__ret) #11
  %call = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #11
  %call2 = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #11
...
if.then:                                          ; preds = %entry
  %call3 = call noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) #11
  %call4 = call noundef i32 @_ZNSt11char_traitsIcE11to_int_typeERKc(ptr noundef nonnull align 1 dereferenceable(1) %call3) #11
  store i32 %call4, ptr %__ret, align 4, !tbaa !8
  br label %if.end

if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !13
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 9
  %0 = load ptr, ptr %vfn, align 8, !invariant.load !15
  %call5 = call noundef i32 %0(ptr noundef nonnull align 8 dereferenceable(64) %this)
  store i32 %call5, ptr %__ret, align 4, !tbaa !8
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %1 = load i32, ptr %__ret, align 4, !tbaa !8
...
entry:
  %0 = load i32, ptr %__c1, align 4, !tbaa !8
  %1 = load i32, ptr %__c2, align 4, !tbaa !8
  %cmp = icmp eq i32 %0, %1
  ret i1 %cmp
}
...
; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264) %this) local_unnamed_addr #5 align 2 {
entry:
  %_M_streambuf_state = getelementptr inbounds nuw %"class.std::ios_base", ptr %this, i32 0, i32 5
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !37
  ret i32 %0
}

; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #5 align 2 {
entry:
  %_M_in_cur = getelementptr inbounds nuw %"class.std::basic_streambuf", ptr %this, i32 0, i32 2
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !38
  ret ptr %0
}

; Function Attrs: mustprogress nounwind uwtable
define available_externally noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64) %this) local_unnamed_addr #5 align 2 {
entry:
  %_M_in_end = getelementptr inbounds nuw %"class.std::basic_streambuf", ptr %this, i32 0, i32 3
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !41
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !42
...
!19 = !{!20, !21, i64 16}
!20 = !{!"_ZTSSt8ios_base", !21, i64 8, !21, i64 16, !22, i64 24, !23, i64 28, !23, i64 32, !24, i64 40, !25, i64 48, !10, i64 64, !9, i64 192, !26, i64 200, !27, i64 208}
!21 = !{!"long", !10, i64 0}
!22 = !{!"_ZTSSt13_Ios_Fmtflags", !10, i64 0}
!23 = !{!"_ZTSSt12_Ios_Iostate", !10, i64 0}
!24 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !18, i64 0}
!25 = !{!"_ZTSNSt8ios_base6_WordsE", !18, i64 0, !21, i64 8}
!26 = !{!"p1 _ZTSNSt8ios_base6_WordsE", !18, i64 0}
!27 = !{!"_ZTSSt6locale", !28, i64 0}
!28 = !{!"p1 _ZTSNSt6locale5_ImplE", !18, i64 0}
!29 = !{!30, !33, i64 232}
!30 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !20, i64 0, !31, i64 216, !10, i64 224, !32, i64 225, !33, i64 232, !34, i64 240, !35, i64 248, !36, i64 256}
!31 = !{!"p1 _ZTSSo", !18, i64 0}
!32 = !{!"bool", !10, i64 0}
!33 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !18, i64 0}
!34 = !{!"p1 _ZTSSt5ctypeIcE", !18, i64 0}
!35 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !18, i64 0}
!36 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !18, i64 0}
!37 = !{!20, !23, i64 32}
!38 = !{!39, !40, i64 16}
!39 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !40, i64 8, !40, i64 16, !40, i64 24, !40, i64 32, !40, i64 40, !40, i64 48, !27, i64 56}
