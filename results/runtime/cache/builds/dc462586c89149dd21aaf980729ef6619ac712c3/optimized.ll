...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc29
  ...
  br i1 %exitcond.not, label %for.cond33.preheader, label %for.cond7.preheader
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc27
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc27 ], [ %1, %for.cond7.preheader ]
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc50
  %.pre36 = phi i32 [ %.pre, %for.inc50 ], [ %0, %for.cond33.preheader ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc50 ], [ 0, %for.cond33.preheader ]
  %cnt.0 = phi i32 [ %cnt.1, %for.inc50 ], [ 0, %for.cond33.preheader ]
