...
if.else:                                          ; preds = %for.end123
  ...
  %wide.trip.count50 = zext nneg i32 %smax46 to i64
  br label %for.cond134

for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc151 ], [ 1, %if.else ]
  %exitcond51.not = icmp eq i64 %indvars.iv42, %wide.trip.count50
  br i1 %exitcond51.not, label %for.end153, label %for.body136
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars49.le = trunc i64 %indvars.iv42 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars49.le, %for.end153.split.loop.exit ], [ %smax46, %for.cond134 ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count66 = zext i32 %sub155 to i64
  %wide.trip.count61 = zext i32 %z.1.lcssa to i64
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  ...
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.cond154.loopexit ], [ 1, %for.end153 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %wide.trip.count66
  br i1 %exitcond67.not, label %for.cond207.preheader, label %for.body157

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count74 = zext i32 %z.1.lcssa to i64
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc201 ], [ %indvars.iv56, %for.body157 ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %wide.trip.count61
  br i1 %exitcond62.not, label %for.cond154.loopexit, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv58, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond55.not = icmp eq i64 %indvars.iv52, 6
  br i1 %exitcond55.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv58, i64 %indvars.iv52
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv52
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv63, i64 %indvars.iv52
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv71 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next72, %for.inc223 ]
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  ...
  %cmp212 = icmp slt i64 %indvars.iv68, %26
