...
while.cond4:                                      ; preds = %while.cond4.preheader, %if.end44
  %lenq.0 = phi i32 [ %5, %if.end44 ], [ %1, %while.cond4.preheader ]
...
while.cond8:                                      ; preds = %while.body17, %while.body5
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %while.body17 ], [ 0, %while.body5 ]
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %incdec.ptr, i64 %indvars.iv2
...
while.end19:                                      ; preds = %while.cond8, %while.cond8
  ...
  %smax.i = call i32 @llvm.smax.i32(i32 %lenq.0, i32 0)
  %wide.trip.count.i = zext nneg i32 %smax.i to i64
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc.i, %while.end19
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.i ], [ 0, %while.end19 ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %outlined_ir_func_0.exit, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond.i
  %add.ptr27.i = getelementptr inbounds nuw i8, ptr %incdec.ptr23, i64 %indvars.iv.i
  %4 = load i8, ptr %add.ptr27.i, align 1, !tbaa !5, !invariant.load !13, !noalias !15
  %call28.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %4), !noalias !15
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond.i, !llvm.loop !18

outlined_ir_func_0.exit:                          ; preds = %for.cond.i
  %5 = trunc nuw nsw i64 %indvars.iv2 to i32
  %add = add nsw i32 %len.0, %5
  %inc20 = add nsw i32 %add, 1
  %cmp24 = icmp slt i32 %add, 80
  br i1 %cmp24, label %for.end, label %for.end42

for.end:                                          ; preds = %outlined_ir_func_0.exit
...
for.end42:                                        ; preds = %outlined_ir_func_0.exit
...
if.end44:                                         ; preds = %for.end, %if.then31, %for.end42
  %len.1 = phi i32 [ %5, %for.end42 ], [ %inc20, %if.then31 ], [ %inc20, %for.end ]
