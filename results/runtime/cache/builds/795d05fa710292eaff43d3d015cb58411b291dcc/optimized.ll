...
for.inc:                                          ; preds = %for.cond
  ...
  %7 = load float, ptr %arrayidx5, align 4, !tbaa !9, !invariant.load !11
  %8 = load float, ptr %arrayidx, align 4, !tbaa !9, !invariant.load !11
  %div = fdiv float %7, %8
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre26, %for.body15 ]
  %indvars.iv23 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next24, %for.body15 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv23, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv23
  %11 = load float, ptr %arrayidx17, align 4, !tbaa !9, !invariant.load !11
  ...
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.sink)
