...
for.cond2:                                        ; preds = %for.inc23, %for.end
  %k.0 = phi i32 [ 0, %for.end ], [ %k.1, %for.inc23 ]
...
for.cond5:                                        ; preds = %for.inc13, %for.body4
  %j.0 = phi i32 [ 0, %for.body4 ], [ %inc14, %for.inc13 ]
...
if.then17:                                        ; preds = %for.end15
  ...
  %3 = load i32, ptr %arrayidx19, align 4, !tbaa !5, !invariant.load !12
...
for.cond26:                                       ; preds = %for.inc36, %for.end25
  %i.2 = phi i32 [ 0, %for.end25 ], [ %inc37, %for.inc36 ]
...
for.body28:                                       ; preds = %for.cond26
  ...
  %4 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !12
