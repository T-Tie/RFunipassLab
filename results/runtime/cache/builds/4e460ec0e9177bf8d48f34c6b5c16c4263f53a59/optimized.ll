...
for.inc:                                          ; preds = %for.cond
  ...
  %call5 = call i64 @strlen(ptr noundef %arrayidx) #13
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %num) #12
  store i32 0, ptr %num, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %cnt) #12
...
while.end35:                                      ; preds = %while.body
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %cnt) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %num) #12
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef %len) #12
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef %ch) #12
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !28
...
!32 = !{!"p1 _ZTS15__locale_struct", !23, i64 0}
!33 = !{!"bool", !7, i64 0}
!34 = !{!"p1 int", !23, i64 0}
!35 = !{!"p1 short", !23, i64 0}
