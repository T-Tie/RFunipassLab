...
if.end63:                                         ; preds = %land.lhs.true, %for.body, %if.then45
  ...
  switch i8 %0, label %if.end127.sink.split.loopexit [
...
lor.lhs.false83:                                  ; preds = %if.end63, %if.end63, %if.end63, %if.end63
  ...
  switch i8 %2, label %if.end127.sink.split.loopexit [
    i8 65, label %for.inc
    i8 84, label %for.inc
    i8 71, label %for.inc
    i8 67, label %for.inc
...
if.end127.sink.split.loopexit:                    ; preds = %if.end63, %lor.lhs.false83
  br label %if.end127.sink.split

if.end127.sink.split:                             ; preds = %if.end127.sink.split.loopexit, %entry
