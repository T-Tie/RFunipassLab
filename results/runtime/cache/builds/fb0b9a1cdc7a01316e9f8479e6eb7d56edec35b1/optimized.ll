...
for.inc:                                          ; preds = %for.body3.for.inc_crit_edge, %land.lhs.true
  ...
  %f.28 = phi i32 [ %f.1, %for.body3.for.inc_crit_edge ], [ %f.2.ph, %land.lhs.true ]
  %star1.26 = phi i32 [ %star1.1, %for.body3.for.inc_crit_edge ], [ %star1.2.ph, %land.lhs.true ]
  %star2.24 = phi i32 [ %star2.1, %for.body3.for.inc_crit_edge ], [ %star2.2.ph, %land.lhs.true ]
