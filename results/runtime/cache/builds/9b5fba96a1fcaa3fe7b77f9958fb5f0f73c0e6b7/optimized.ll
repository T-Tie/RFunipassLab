...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull %a) #7
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull align 16 %b) #7
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull align 16 %c) #7
...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc8 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv28, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv34, %5
...
for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc24 ], [ 0, %for.cond13 ]
...
for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv34, i64 %indvars.iv31
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc57
  %indvars.iv47 = phi i64 [ 0, %for.cond30.preheader ], [ %indvars.iv.next48, %for.inc57 ]
  %exitcond52.not = icmp eq i64 %indvars.iv47, %wide.trip.count51
  br i1 %exitcond52.not, label %for.cond60, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc54
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc54 ], [ 0, %for.cond30 ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count45
  br i1 %exitcond46.not, label %for.inc57, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond33
  %arrayidx50 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv47, i64 %indvars.iv41
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc51
  %indvars.iv37 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next38, %for.inc51 ]
...
for.inc51:                                        ; preds = %for.cond36
  %arrayidx42 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv37
  %10 = load i32, ptr %arrayidx42, align 4, !tbaa !5
  %arrayidx46 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %b, i64 0, i64 %indvars.iv37, i64 %indvars.iv41
...
for.cond60:                                       ; preds = %for.cond30, %for.inc78
  ...
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc78 ], [ 0, %for.cond30 ]
  %14 = sext i32 %13 to i64
  %cmp61 = icmp slt i64 %indvars.iv56, %14
  br i1 %cmp61, label %for.cond64, label %for.end80

for.cond64:                                       ; preds = %for.cond60, %for.inc75
  %15 = phi i32 [ %.pre59, %for.inc75 ], [ %12, %for.cond60 ]
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc75 ], [ 0, %for.cond60 ]
  %16 = sext i32 %15 to i64
  %cmp65 = icmp slt i64 %indvars.iv53, %16
  br i1 %cmp65, label %for.body66, label %for.inc78

for.body66:                                       ; preds = %for.cond64
  %arrayidx70 = getelementptr inbounds nuw [111 x [111 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv53
  ...
  %cmp72.not = icmp eq i64 %indvars.iv53, %19
...
for.end80:                                        ; preds = %for.cond60
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef nonnull %c) #8
  call void @llvm.lifetime.end.p0(i64 noundef 49284, ptr noundef nonnull %b) #8
...
!34 = !{!35, !39, i64 240}
!35 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !24, i64 0, !36, i64 216, !7, i64 224, !37, i64 225, !38, i64 232, !39, i64 240, !40, i64 248, !41, i64 256}
!36 = !{!"p1 _ZTSSo", !29, i64 0}
!37 = !{!"bool", !7, i64 0}
!38 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !29, i64 0}
!39 = !{!"p1 _ZTSSt5ctypeIcE", !29, i64 0}
!40 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !29, i64 0}
!41 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !29, i64 0}
!42 = !{!43, !7, i64 56}
...
!45 = !{!"p1 _ZTS15__locale_struct", !29, i64 0}
!46 = !{!"p1 int", !29, i64 0}
!47 = !{!"p1 short", !29, i64 0}
!48 = !{!7, !7, i64 0}
