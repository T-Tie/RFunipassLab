...
for.cond:                                         ; preds = %for.inc25, %tailrecurse
  ...
  br i1 %exitcond76.not, label %for.cond28.preheader, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %s.0 = phi i32 [ %spec.select, %for.body3 ], [ 9999, %for.cond1.preheader ]
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc63
  ...
  br i1 %exitcond92.not, label %for.end65, label %for.cond31.preheader

for.cond31.preheader:                             ; preds = %for.cond28
  br label %for.cond31

for.cond31:                                       ; preds = %for.cond31.preheader, %for.body33
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.body33 ], [ 0, %for.cond31.preheader ]
  %s.2 = phi i32 [ %spec.select65, %for.body33 ], [ 9999, %for.cond31.preheader ]
...
for.inc122.gvnsink.split:                         ; preds = %if.else107, %if.then85
  %indvars.iv100.sink = phi i64 [ %indvars.iv100, %if.then85 ], [ %5, %if.else107 ]
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc9
  ...
  br i1 %exitcond18.not, label %for.cond12.preheader, label %for.cond4.preheader

for.cond12.preheader:                             ; preds = %for.cond1
  br label %for.cond12
...
for.cond12:                                       ; preds = %for.cond12.preheader, %for.inc26
  %1 = phi i32 [ %3, %for.inc26 ], [ %0, %for.cond12.preheader ]
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc26 ], [ 0, %for.cond12.preheader ]
  %2 = sext i32 %1 to i64
  %cmp13 = icmp slt i64 %indvars.iv22, %2
  br i1 %cmp13, label %for.cond15.preheader, label %for.inc32

for.cond15.preheader:                             ; preds = %for.cond12
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc23
  %3 = phi i32 [ %.pre, %for.inc23 ], [ %1, %for.cond15.preheader ]
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc23 ], [ 0, %for.cond15.preheader ]
  %4 = sext i32 %3 to i64
