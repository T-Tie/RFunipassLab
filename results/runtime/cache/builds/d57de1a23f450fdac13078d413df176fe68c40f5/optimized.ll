...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv8 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  ...
  %cmp15 = icmp sgt i32 %indvars32, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond19.not = icmp eq i64 %indvars.iv12, %5
  br i1 %exitcond19.not, label %for.cond14, label %for.body19, !llvm.loop !13

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv12
  %6 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next13
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv20, %10
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv20
