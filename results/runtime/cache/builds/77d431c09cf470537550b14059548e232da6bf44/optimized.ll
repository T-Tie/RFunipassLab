...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 %b) #5
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi7getlineEPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 %b, i64 noundef 10000)
  %call2 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %b) #6
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %arrayidx14)
  %1 = zext i32 %j.0 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc25, %for.end
  %indvars.iv3 = phi i64 [ %3, %for.inc25 ], [ %1, %for.end ]
...
for.end26:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef nonnull %b) #7
