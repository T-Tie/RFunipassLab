...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv22, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv22, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv28, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv25, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv28, i64 %indvars.iv25
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax34 = call i32 @llvm.smax.i32(i32 %smax, i32 noundef 0)
  %smax39 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax40 = call i32 @llvm.smax.i32(i32 %smax39, i32 noundef 0)
...
for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond42.not = icmp eq i64 %indvars.iv35, %wide.trip.count41
  br i1 %exitcond42.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax46 = call i32 @llvm.smax.i32(i32 %9, i32 noundef 0)
  %wide.trip.count47 = zext nneg i32 %smax46 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv35, i64 %indvars.iv31
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv56 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next57, %for.inc83 ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %wide.trip.count41
  br i1 %exitcond60.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond55.not = icmp eq i64 %indvars.iv49, %wide.trip.count
  br i1 %exitcond55.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv56, i64 %indvars.iv49
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv43 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next44, %for.inc77 ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !17
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv56, i64 %indvars.iv43
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5, !invariant.load !17
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv43, i64 %indvars.iv49
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond65.not = icmp eq i64 %indvars.iv61, %wide.trip.count41
  br i1 %exitcond65.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv61
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  br label %for.cond86, !llvm.loop !21

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax39 to i64
...
for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %wide.trip.count41
  br i1 %exitcond77.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv73
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax39, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax39, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv66 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next67, %for.inc112 ]
  %exitcond72.not = icmp eq i64 %indvars.iv66, %wide.trip.count
  br i1 %exitcond72.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv73, i64 %indvars.iv66
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv90 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond97.not = icmp eq i64 %indvars.iv90, %wide.trip.count41
  br i1 %exitcond97.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv90
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv90, 0
  %or.cond17 = and i1 %or.cond, %cmp128
  br i1 %or.cond17, label %if.then129, label %if.else131
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv90
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax81 = call i32 @llvm.smax.i32(i32 %sub140, i32 noundef 1)
  %wide.trip.count82 = zext nneg i32 %smax81 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond83.not = icmp eq i64 %indvars.iv78, %wide.trip.count82
  br i1 %exitcond83.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv90, i64 %indvars.iv78
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv90, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax87 = call i32 @llvm.smax.i32(i32 %sub162, i32 noundef 1)
  %wide.trip.count88 = zext nneg i32 %smax87 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond89.not = icmp eq i64 %indvars.iv84, %wide.trip.count88
  br i1 %exitcond89.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv90, i64 %indvars.iv84
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv90, %14
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv90, 2
...
if.then195:                                       ; preds = %land.lhs.true190, %land.lhs.true181
  %putchar18 = call i32 @putchar(i32 noundef 10) #7
  br label %for.inc198
