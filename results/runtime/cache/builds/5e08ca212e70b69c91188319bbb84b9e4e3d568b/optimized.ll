...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call noundef range(i32 0, 2147483647) i32 @_Z5qufeni(i32 noundef %1) #11
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call noundef i32 @_Z3numiii(i32 noundef %2, i32 noundef %i.0, i32 noundef 2) #10
...
for.cond:                                         ; preds = %if.end, %entry
  %j.0 = phi i32 [ 1, %entry ], [ %inc, %if.end ]
  %call = call noundef i32 @_Z5powerii(i32 noundef 2, i32 noundef %j.0) #12
...
if.end:                                           ; preds = %land.lhs.true, %entry
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %a) #9
  br label %for.cond
...
for.cond9:                                        ; preds = %for.body11, %if.else
  %i.1 = phi i32 [ 0, %if.else ], [ %inc17, %for.body11 ]
  %count.0 = phi i32 [ 0, %if.else ], [ %add, %for.body11 ]
...
for.body11:                                       ; preds = %for.cond9
  ...
  %div = sdiv i32 %n, %0
  %sub = sub nsw i32 %g, 1
  %call = call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #13
...
cleanup:                                          ; preds = %for.cond9, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef %a) #9
  br label %return
...
define dso_local noundef i32 @_Z5powerii(i32 noundef %a, i32 noundef %b) #7 {
entry:
  br label %for.cond
...
attributes #4 = { mustprogress nofree nosync nounwind memory(none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
