...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc24 ], [ 0, %for.cond16.preheader ]
...
for.cond31:                                       ; preds = %for.cond, %for.inc67
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc67 ], [ 0, %for.cond ]
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc64 ], [ 0, %for.cond55.preheader ]
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  ...
  br i1 %exitcond42.not, label %for.cond96, label %for.cond76.preheader
...
for.cond96:                                       ; preds = %for.cond71, %for.inc117
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc117 ], [ 2, %for.cond71 ]
