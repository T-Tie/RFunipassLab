...
for.cond38:                                       ; preds = %for.inc49, %for.body36
  %sub.sink10 = phi i32 [ %sub, %for.body36 ], [ %dec, %for.inc49 ]
  %cmp39 = icmp sge i32 %sub.sink10, 0
  %idxprom51 = sext i32 %sub.sink to i64
  %idxprom53 = sext i32 %sub.sink10 to i64
...
for.end61:                                        ; preds = %for.body40, %for.end50, %for.cond34
  %y2.1 = phi i32 [ %y2.2, %for.end50 ], [ %y2.0, %for.cond34 ], [ %sub.sink10, %for.body40 ]
  %x2.1 = phi i32 [ %x2.2, %for.end50 ], [ %x2.0, %for.cond34 ], [ %sub.sink, %for.body40 ]
