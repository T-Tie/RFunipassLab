...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 501, ptr noundef nonnull align 16 %f) #4
  call void @llvm.lifetime.start.p0(i64 noundef 501, ptr noundef nonnull align 16 %t) #4
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %n) #4
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull align 8 %n, ptr noundef nonnull align 16 %f, ptr noundef nonnull align 16 %t)
  unreachable
}
