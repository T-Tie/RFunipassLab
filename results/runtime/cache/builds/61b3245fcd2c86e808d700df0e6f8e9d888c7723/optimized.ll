...
while.body:                                       ; preds = %while.body, %if.end
  %__parent.0 = phi i64 [ %div45, %if.end ], [ %dec, %while.body ]
...
while.cond.i:                                     ; preds = %while.body.i, %if.end16
  ...
  %__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i = load i32, ptr %__value.addr.i, align 4, !tbaa !5
...
land.end.i:                                       ; preds = %while.cond.i
  ...
  %cmp.i.i = icmp slt i32 %4, %__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i
...
_ZSt11__push_heapIPiliN9__gnu_cxx5__ops14_Iter_less_valEEvT_T0_S5_T1_RT2_.exit: ; preds = %while.cond.i, %land.end.i
  ...
  store i32 %__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.i.0.__value.addr.0.__value.addr.0..pre.i, ptr %add.ptr5.i, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %__value.addr.i)
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZSt22__move_median_to_firstIPiN9__gnu_cxx5__ops15_Iter_less_iterEEvT_S4_S4_S4_T0_(ptr noundef align 4 %__result, ptr noundef align 4 %__a, ptr noundef align 4 %__b, ptr noundef align 4 %__c) local_unnamed_addr #3 comdat {
entry:
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.2 = load i32, ptr %__val, align 4, !tbaa !5
  %1 = load i32, ptr %incdec.ptr, align 4, !tbaa !5, !invariant.load !24
  %cmp.i = icmp slt i32 %__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.2, %1
  br i1 %cmp.i, label %while.cond, label %while.end, !llvm.loop !25

while.end:                                        ; preds = %while.cond
  store i32 %__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.__val.0.2, ptr %__last.sink1, align 4, !tbaa !5
