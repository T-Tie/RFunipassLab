...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc11 ], [ %2, %entry ]
...
for.body:                                         ; preds = %for.cond
  %idxprom = and i64 %indvars.iv.next25, 4294967295
...
for.cond3:                                        ; preds = %for.cond3.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %indvars.iv21 = phi i64 [ %indvars.iv, %for.cond3.preheader ], [ %indvars.iv.next22, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  %indvars.iv.next22 = add nsw i64 %indvars.iv21, 1
  %cmp4 = icmp slt i64 %indvars.iv.next22, %5
  br i1 %cmp4, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond3
  %arrayidx8 = getelementptr inbounds [110 x i8], ptr @s, i64 0, i64 %indvars.iv.next22
  ...
  %7 = load i64, ptr %gep, align 8, !tbaa !11
...
for.end:                                          ; preds = %for.cond3
  %call1.i4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 1)
  br label %for.inc11
...
for.cond14:                                       ; preds = %for.cond14.preheader, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18
  %indvars.iv27 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next28, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18 ]
...
for.inc21:                                        ; preds = %for.cond14
  %arrayidx19 = getelementptr inbounds nuw [110 x i8], ptr @s, i64 0, i64 %indvars.iv27
  %8 = load i8, ptr %arrayidx19, align 1, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i6)
  store i8 %8, ptr %__c.addr.i6, align 1, !tbaa !5
  %vtable.i7 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !8
  %vbase.offset.ptr.i8 = getelementptr i8, ptr %vtable.i7, i64 -24
  %vbase.offset.i9 = load i64, ptr %vbase.offset.ptr.i8, align 8, !invariant.load !10
  %gep20 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i9
  %9 = load i64, ptr %gep20, align 8, !tbaa !11
  %cmp.not.i12 = icmp eq i64 %9, 0
  br i1 %cmp.not.i12, label %if.end.i16, label %if.then.i13

if.then.i13:                                      ; preds = %for.inc21
...
if.end.i16:                                       ; preds = %for.inc21
  %call2.i17 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %8)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit18
...
!28 = !{!12, !15, i64 32}
!29 = !{!30, !34, i64 240}
!30 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !12, i64 0, !31, i64 216, !6, i64 224, !32, i64 225, !33, i64 232, !34, i64 240, !35, i64 248, !36, i64 256}
!31 = !{!"p1 _ZTSSo", !17, i64 0}
!32 = !{!"bool", !6, i64 0}
!33 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !17, i64 0}
!34 = !{!"p1 _ZTSSt5ctypeIcE", !17, i64 0}
!35 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!36 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!37 = !{!38, !6, i64 56}
