...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %b) #8
...
for.end:                                          ; preds = %for.cond
  ...
  %smax24 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %wide.trip.count25 = zext nneg i32 %smax24 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond26.not = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond29.preheader, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv20
...
for.cond29.preheader:                             ; preds = %for.cond4
  ...
  %smax30 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv17
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv27 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next28, %for.inc36 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv27
...
for.end38:                                        ; preds = %for.cond29
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %b) #9
