...
for.end12:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z6hanshui(i32 noundef %1)
...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv56 = phi i32 [ %indvars.iv.next57, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax103 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax92 = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %1 = add nuw i32 %smax92, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv63 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next64, %for.inc23 ]
  %exitcond67 = icmp eq i64 %indvars.iv63, %wide.trip.count66
  br i1 %exitcond67, label %for.cond26.preheader, label %for.cond2

for.cond26.preheader:                             ; preds = %for.cond
  %wide.trip.count71 = zext i32 %indvars.iv56 to i64
  br label %for.cond26
...
for.cond2:                                        ; preds = %for.cond, %for.body4
  ...
  br i1 %exitcond, label %for.cond13, label %for.body4
...
for.cond13:                                       ; preds = %for.cond2, %for.body15
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.body15 ], [ 1, %for.cond2 ]
  %exitcond62 = icmp eq i64 %indvars.iv58, %wide.trip.count
  br i1 %exitcond62, label %for.inc23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv63, i64 %indvars.iv58
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv78 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next79, %for.inc57 ]
  %exitcond83 = icmp eq i64 %indvars.iv78, %wide.trip.count66
  br i1 %exitcond83, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select54, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond72 = icmp eq i64 %indvars.iv68, %wide.trip.count71
  br i1 %exitcond72, label %for.cond46, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv68, i64 %indvars.iv78
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select54 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  br label %for.cond29, !llvm.loop !19

for.cond46:                                       ; preds = %for.cond29, %for.body48
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body48 ], [ 1, %for.cond29 ]
  %exitcond77 = icmp eq i64 %indvars.iv73, %wide.trip.count71
  br i1 %exitcond77, label %for.inc57, label %for.body48

for.body48:                                       ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv73, i64 %indvars.iv78
...
for.end59:                                        ; preds = %for.cond26
  ...
  %wide.trip.count87 = zext i32 %n.tr to i64
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond94 = icmp eq i64 %indvars.iv89, %wide.trip.count66
  br i1 %exitcond94, label %for.cond80.preheader, label %for.cond63

for.cond80.preheader:                             ; preds = %for.cond60
  %wide.trip.count104 = zext nneg i32 %smax103 to i64
  %wide.trip.count98 = zext i32 %n.tr to i64
  br label %for.cond80

for.cond63:                                       ; preds = %for.cond60, %for.body65
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %for.body65 ], [ 2, %for.cond60 ]
  %exitcond88.not = icmp eq i64 %indvars.iv84, %wide.trip.count87
  br i1 %exitcond88.not, label %for.inc77, label %for.body65

for.body65:                                       ; preds = %for.cond63
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv89, i64 %indvars.iv.next85
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv89, i64 %indvars.iv84
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv100 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next101, %for.inc98 ]
  %exitcond105.not = icmp eq i64 %indvars.iv100, %wide.trip.count104
  br i1 %exitcond105.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.body85
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.body85 ], [ 2, %for.cond80 ]
  %exitcond99.not = icmp eq i64 %indvars.iv95, %wide.trip.count98
  br i1 %exitcond99.not, label %for.inc98, label %for.body85

for.body85:                                       ; preds = %for.cond83
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next96, i64 %indvars.iv100
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv95, i64 %indvars.iv100
