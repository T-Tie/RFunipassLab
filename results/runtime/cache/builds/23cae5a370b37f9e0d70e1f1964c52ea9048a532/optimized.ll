...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z1fii(i32 noundef %1, i32 noundef 2) #7
  ...
  %vtable.i = load ptr, ptr %call3, align 8, !tbaa !9, !invariant.load !11
...
if.then:                                          ; preds = %for.body
  %div = sdiv i32 %n, %j.0
  %call2 = tail call noundef i32 @_Z1fii(i32 noundef %div, i32 noundef %j.0) #7
