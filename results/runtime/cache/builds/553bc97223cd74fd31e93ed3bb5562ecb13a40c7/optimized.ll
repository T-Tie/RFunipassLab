...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.inc8 ], [ 0, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv6, %1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv6, i64 %indvars.iv
...
for.cond12:                                       ; preds = %for.inc28, %for.end10
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc28 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14.not.not = icmp slt i64 %indvars.iv12, %5
  br i1 %cmp14.not.not, label %for.cond16, label %for.end30

for.cond16:                                       ; preds = %for.cond12, %for.inc25
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc25 ], [ 0, %for.cond12 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp18.not.not = icmp slt i64 %indvars.iv9, %7
  br i1 %cmp18.not.not, label %for.inc25, label %for.inc28

for.inc25:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv12, i64 %indvars.iv9
...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax18 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax23 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax24 = call i32 @llvm.smax.i32(i32 %smax23, i32 0)
  %wide.trip.count25 = zext nneg i32 %smax24 to i64
  %wide.trip.count = zext nneg i32 %smax18 to i64
  br label %for.cond36

for.cond36:                                       ; preds = %for.inc49, %for.end30
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc49 ], [ 0, %for.end30 ]
  %exitcond26.not = icmp eq i64 %indvars.iv19, %wide.trip.count25
  br i1 %exitcond26.not, label %for.cond52.preheader, label %for.cond39

for.cond52.preheader:                             ; preds = %for.cond36
  %smax30 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count38 = zext nneg i32 %smax18 to i64
  %wide.trip.count31 = zext nneg i32 %smax30 to i64
  br label %for.cond52

for.cond39:                                       ; preds = %for.cond36, %for.inc46
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc46 ], [ 0, %for.cond36 ]
...
for.inc46:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv19, i64 %indvars.iv15
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.inc83
  %indvars.iv40 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next41, %for.inc83 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count25
  br i1 %exitcond44.not, label %for.cond86, label %for.cond55

for.cond55:                                       ; preds = %for.cond52, %for.inc80
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc80 ], [ 0, %for.cond52 ]
  %exitcond39.not = icmp eq i64 %indvars.iv33, %wide.trip.count38
  br i1 %exitcond39.not, label %for.inc83, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv40, i64 %indvars.iv33
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc77
  %indvars.iv27 = phi i64 [ 0, %for.cond58.preheader ], [ %indvars.iv.next28, %for.inc77 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, %wide.trip.count31
  br i1 %exitcond32.not, label %for.inc80, label %for.inc77

for.inc77:                                        ; preds = %for.cond58
  %11 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv40, i64 %indvars.iv27
  %12 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv27, i64 %indvars.iv33
...
for.cond86:                                       ; preds = %for.cond52, %for.inc91
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc91 ], [ 0, %for.cond52 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count25
  br i1 %exitcond49.not, label %for.end93, label %for.inc91

for.inc91:                                        ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv45
  store i32 0, ptr %arrayidx90, align 4, !tbaa !5
  %indvars.iv.next46 = add nuw nsw i64 %indvars.iv45, 1
  br label %for.cond86, !llvm.loop !20

for.end93:                                        ; preds = %for.cond86
  %idxprom94 = sext i32 %smax23 to i64
  %arrayidx95 = getelementptr inbounds [100 x i32], ptr %d, i64 0, i64 %idxprom94
  store i32 %smax, ptr %arrayidx95, align 4, !tbaa !5
  %wide.trip.count55 = zext nneg i32 %smax18 to i64
  br label %for.cond96

for.cond96:                                       ; preds = %for.inc115, %for.end93
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc115 ], [ 0, %for.end93 ]
  %exitcond61.not = icmp eq i64 %indvars.iv57, %wide.trip.count25
  br i1 %exitcond61.not, label %for.cond118.preheader, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %for.cond96
  %arrayidx109 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv57
  br label %for.cond99

for.cond118.preheader:                            ; preds = %for.cond96
  %cmp125 = icmp eq i32 %smax23, 100
  %cmp126 = icmp eq i32 %smax, 100
  %or.cond = select i1 %cmp125, i1 %cmp126, i1 false
  %sub179 = add nsw i32 %smax23, -1
  %14 = zext i32 %sub179 to i64
  br label %for.cond118

for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  %indvars.iv50 = phi i64 [ 0, %for.cond99.preheader ], [ %indvars.iv.next51, %for.inc112 ]
  %exitcond56.not = icmp eq i64 %indvars.iv50, %wide.trip.count55
  br i1 %exitcond56.not, label %for.inc115, label %for.body101

for.body101:                                      ; preds = %for.cond99
  %arrayidx105 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv57, i64 %indvars.iv50
...
for.cond118:                                      ; preds = %for.cond118.preheader, %for.inc198
  %indvars.iv74 = phi i64 [ 0, %for.cond118.preheader ], [ %.pre, %for.inc198 ]
  %exitcond81.not = icmp eq i64 %indvars.iv74, %wide.trip.count25
  br i1 %exitcond81.not, label %for.end200, label %for.body120

for.body120:                                      ; preds = %for.cond118
  %arrayidx122 = getelementptr inbounds nuw [100 x i32], ptr %d, i64 0, i64 %indvars.iv74
...
if.then124:                                       ; preds = %for.body120
  %cmp128 = icmp eq i64 %indvars.iv74, 0
...
if.else131:                                       ; preds = %if.then124
  %arrayidx133 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv74
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax65 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
  %wide.trip.count66 = zext nneg i32 %smax65 to i64
  br label %for.cond137

for.cond137:                                      ; preds = %for.inc148, %if.end136
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.inc148 ], [ 1, %if.end136 ]
  %exitcond67.not = icmp eq i64 %indvars.iv62, %wide.trip.count66
  br i1 %exitcond67.not, label %if.end178, label %for.inc148

for.inc148:                                       ; preds = %for.cond137
  %arrayidx146 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv74, i64 %indvars.iv62
...
if.else151:                                       ; preds = %for.body120
  %20 = add nuw nsw i64 %indvars.iv74, 1
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax71 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
  %wide.trip.count72 = zext nneg i32 %smax71 to i64
  br label %for.cond158

for.cond158:                                      ; preds = %for.inc170, %if.then156
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc170 ], [ 1, %if.then156 ]
  %exitcond73.not = icmp eq i64 %indvars.iv68, %wide.trip.count72
  br i1 %exitcond73.not, label %if.end178, label %for.inc170

for.inc170:                                       ; preds = %for.cond158
  %arrayidx168 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv74, i64 %indvars.iv68
...
if.end178:                                        ; preds = %for.cond137, %for.cond158
  %cmp180.not = icmp eq i64 %indvars.iv74, %14
  %.pre = add nuw nsw i64 %indvars.iv74, 1
...
land.lhs.true190:                                 ; preds = %land.lhs.true181
  %24 = add nuw nsw i64 %indvars.iv74, 2
