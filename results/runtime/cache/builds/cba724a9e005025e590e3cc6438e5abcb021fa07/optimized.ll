...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv10.in = phi i32 [ %indvars.iv10, %for.end100 ], [ %n, %entry ]
  ...
  %smax47 = call i32 @llvm.smax.i32(i32 %indvars.iv10, i32 1)
  %smax36 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
  %0 = zext i32 %indvars.iv10 to i64
  %wide.trip.count21 = zext nneg i32 %smax36 to i64
  %wide.trip.count = zext i32 %n.tr to i64
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %tailrecurse
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc24 ], [ 0, %tailrecurse ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count26 = zext i32 %n.tr to i64
  br label %for.cond27

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv18
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv13 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next14, %for.inc21 ]
  %exitcond17.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond17.not, label %for.inc24, label %for.inc21

for.inc21:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv18, i64 %indvars.iv13
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.end61
  %indvars.iv33 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next34, %for.end61 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count21
  br i1 %exitcond38.not, label %for.end64, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %arrayidx31 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv33
  %4 = load i32, ptr %arrayidx31, align 4, !tbaa !5
  br label %for.cond32

for.cond32:                                       ; preds = %for.body34, %for.body29
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.body34 ], [ 1, %for.body29 ]
  %min.1 = phi i32 [ %spec.select2, %for.body34 ], [ %4, %for.body29 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count26
  br i1 %exitcond27.not, label %for.cond51.preheader, label %for.body34

for.cond51.preheader:                             ; preds = %for.cond32
  br label %for.cond51

for.body34:                                       ; preds = %for.cond32
  %arrayidx38 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv23, i64 %indvars.iv33
  %5 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select2 = tail call i32 @llvm.smin.i32(i32 %5, i32 %min.1)
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv28 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next29, %for.inc59 ]
  %exitcond32.not = icmp eq i64 %indvars.iv28, %wide.trip.count26
  br i1 %exitcond32.not, label %for.end61, label %for.inc59

for.inc59:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv28, i64 %indvars.iv33
...
for.cond66:                                       ; preds = %for.cond81, %for.cond66.preheader
  %indvars.iv44 = phi i64 [ 1, %for.cond66.preheader ], [ %indvars.iv.next45, %for.cond81 ]
  %exitcond49.not = icmp eq i64 %indvars.iv44, %wide.trip.count48
  br i1 %exitcond49.not, label %for.end100, label %for.body69

for.body69:                                       ; preds = %for.cond66
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %arrayidx71 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv.next45
  %8 = load i32, ptr %arrayidx71, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv44
  store i32 %8, ptr %arrayidx73, align 4, !tbaa !5
  %arrayidx76 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next45
  %9 = load i32, ptr %arrayidx76, align 16, !tbaa !5
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44
  store i32 %9, ptr %arrayidx79, align 16, !tbaa !5
  br label %for.cond81

for.cond81:                                       ; preds = %for.inc95, %for.body69
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc95 ], [ 1, %for.body69 ]
  %exitcond43.not = icmp eq i64 %indvars.iv39, %0
  br i1 %exitcond43.not, label %for.cond66, label %for.inc95

for.inc95:                                        ; preds = %for.cond81
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %arrayidx90 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv.next45, i64 %indvars.iv.next40
  %10 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv44, i64 %indvars.iv39
...
for.end100:                                       ; preds = %for.cond66
  ...
  store i32 %smax47, ptr @i, align 4, !tbaa !5
  %add102 = add nsw i32 %7, %accumulator.tr
  br label %tailrecurse

cleanup:                                          ; preds = %for.end64
  store i32 %smax36, ptr @j, align 4, !tbaa !5
...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %storemerge3 = phi i32 [ %inc63.i, %for.end ], [ 0, %for.cond ]
...
for.cond19:                                       ; preds = %for.cond, %for.body21
  %7 = phi i32 [ %.pre, %for.body21 ], [ %0, %for.cond ]
  %storemerge2 = phi i32 [ %inc63.i1, %for.body21 ], [ 0, %for.cond ]
