...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc19 ], [ %idxprom2, %for.end ]
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.end47 ], [ %indvars.iv14, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next17 = add nsw i64 %indvars.iv16, -1
  %cmp23 = icmp sgt i64 %indvars.iv16, 0
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next17
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv11 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next12, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %cmp30.not = icmp slt i64 %indvars.iv11, %indvars.iv16
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv11
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv11
  ...
  %spec.select7 = call i32 @llvm.smax.i32(i32 %7, i32 %sum.0)
  br label %for.inc45

for.inc45:                                        ; preds = %land.lhs.true, %for.body31
  %p.2 = phi i32 [ %p.1, %for.body31 ], [ %spec.select, %land.lhs.true ]
  %sum.1 = phi i32 [ %sum.0, %for.body31 ], [ %spec.select7, %land.lhs.true ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  %spec.select8 = select i1 %cmp48, i32 1, i32 %add53
  %arrayidx55 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next17
  store i32 %spec.select8, ptr %arrayidx55, align 4, !tbaa !5
  br label %for.cond22, !llvm.loop !15

for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv19 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next20, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select9, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv19
  %8 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select9 = call i32 @llvm.smax.i32(i32 %8, i32 %sum.2)
