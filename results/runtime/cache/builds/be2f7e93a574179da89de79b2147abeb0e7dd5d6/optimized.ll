...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 44100, ptr %a) #5
...
while.cond11:                                     ; preds = %for.end138, %for.end10
  ...
  %4 = phi i32 [ %dec, %for.end138 ], [ %2, %for.end10 ]
...
for.cond20:                                       ; preds = %for.inc32, %for.body16
  %min.0 = phi i32 [ %6, %for.body16 ], [ %min.1, %for.inc32 ]
  %j.1 = phi i32 [ 0, %for.body16 ], [ %inc33, %for.inc32 ]
  %cmp21 = icmp slt i32 %j.1, %5
...
for.inc32:                                        ; preds = %for.body22, %if.then
  %min.1 = phi i32 [ %7, %if.then ], [ %min.0, %for.body22 ]
...
for.cond58:                                       ; preds = %for.inc72, %for.body54
  %min.2 = phi i32 [ %9, %for.body54 ], [ %min.3, %for.inc72 ]
  %i.2 = phi i32 [ 0, %for.body54 ], [ %inc73, %for.inc72 ]
  %cmp59 = icmp slt i32 %i.2, %5
...
for.inc72:                                        ; preds = %for.body60, %if.then66
  %min.3 = phi i32 [ %10, %if.then66 ], [ %min.2, %for.body60 ]
...
for.inc133:                                       ; preds = %for.cond120
  ...
  store i32 %14, ptr %arrayidx132, align 4, !tbaa !5
...
while.end142:                                     ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 44100, ptr %a) #5
