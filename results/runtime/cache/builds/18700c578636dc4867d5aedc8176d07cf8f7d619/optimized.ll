...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 25000, ptr noundef nonnull align 16 %word) #8
...
if.then6.i:                                       ; preds = %for.body
  ...
  %gep24 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i
  %3 = load i64, ptr %gep24, align 8, !tbaa !12
...
for.inc47.sink.split:                             ; preds = %if.end35, %if.end35.thread, %if.end35.thread38
  ...
  %s.122.ph = phi i32 [ %s.0, %if.end35.thread38 ], [ 0, %if.end35.thread ], [ 0, %if.end35 ]
...
for.inc47:                                        ; preds = %for.inc47.sink.split, %if.end35
  %.pre = phi i32 [ %.pre40, %if.end35 ], [ %.pre.pre, %for.inc47.sink.split ]
  %s.122 = phi i32 [ %s.0, %if.end35 ], [ %s.122.ph, %for.inc47.sink.split ]
  %add45 = add i32 %7, 1
  %add46 = add i32 %add45, %s.122
