...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 captures(none) dereferenceable(40000) %a) #10
  br label %for.cond
...
for.cond1:                                        ; preds = %for.cond, %for.inc13
  ...
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc13 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not.not = icmp slt i64 %indvars.iv2, %2
...
for.inc:                                          ; preds = %for.cond5
  %arrayidx11 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv2, i64 %indvars.iv
...
for.end15:                                        ; preds = %for.cond1
  ...
  call void @_Z11SubtractionPA100_ii(ptr nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %a, i32 noundef %1) #10
...
for.cond:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40000, ptr noundef nonnull align 16 dereferenceable(40000) %mtuta) #9
  call void @_Z11SubtractionPA100_ii(ptr noalias nofree noundef nonnull align 16 captures(none) dereferenceable(40000) %mtuta, i32 noundef %sub) #11
  call void @llvm.lifetime.end.p0(i64 noundef 40000, ptr noundef nonnull %mtuta) #9
  br label %if.end122
