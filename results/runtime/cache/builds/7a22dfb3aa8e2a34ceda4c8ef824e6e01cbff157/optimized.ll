...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv3, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc135
  %indvars.iv60 = phi i64 [ %5, %for.cond13.preheader ], [ %indvars.iv.next61, %for.inc135 ]
  %indvars.iv57 = phi i64 [ %4, %for.cond13.preheader ], [ %indvars.iv.next58, %for.inc135 ]
...
for.cond16:                                       ; preds = %for.cond13, %for.inc48
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc48 ], [ 0, %for.cond13 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %indvars.iv60
  br i1 %exitcond18.not, label %for.cond51, label %for.cond19

for.cond19:                                       ; preds = %for.cond16, %for.body21
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body21 ], [ 0, %for.cond16 ]
...
for.body21:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv6
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc45
  %indvars.iv9 = phi i64 [ 0, %for.cond34.preheader ], [ %indvars.iv.next10, %for.inc45 ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %indvars.iv60
  br i1 %exitcond13.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond51:                                       ; preds = %for.cond16, %for.inc86
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc86 ], [ 0, %for.cond16 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %indvars.iv60
  br i1 %exitcond33.not, label %for.end88, label %for.cond54

for.cond54:                                       ; preds = %for.cond51, %for.body56
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body56 ], [ 0, %for.cond51 ]
  %min.2 = phi i32 [ %spec.select1, %for.body56 ], [ 100000, %for.cond51 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %indvars.iv60
  br i1 %exitcond23.not, label %for.cond71.preheader, label %for.body56

for.cond71.preheader:                             ; preds = %for.cond54
  br label %for.cond71

for.body56:                                       ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %11 = load i32, ptr %arrayidx60, align 4, !tbaa !5
  %spec.select1 = call i32 @llvm.smin.i32(i32 %11, i32 %min.2)
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond54, !llvm.loop !16

for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc83
  %indvars.iv24 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next25, %for.inc83 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %indvars.iv60
  br i1 %exitcond28.not, label %for.inc86, label %for.inc83

for.inc83:                                        ; preds = %for.cond71
  %arrayidx77 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
...
for.cond91:                                       ; preds = %for.cond95, %for.end88
  %indvars.iv39 = phi i64 [ 1, %for.end88 ], [ %indvars.iv.next40, %for.cond95 ]
  %exitcond46.not = icmp eq i64 %indvars.iv39, %indvars.iv57
  br i1 %exitcond46.not, label %for.cond113, label %for.cond95.preheader
...
for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv34 = phi i64 [ 0, %for.cond95.preheader ], [ %indvars.iv.next35, %for.inc107 ]
  %exitcond38.not = icmp eq i64 %indvars.iv34, %indvars.iv60
  br i1 %exitcond38.not, label %for.cond91, label %for.inc107, !llvm.loop !19

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv.next40, i64 %indvars.iv34
  %14 = load i32, ptr %arrayidx102, align 4, !tbaa !5
  %arrayidx106 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv39, i64 %indvars.iv34
...
for.cond113:                                      ; preds = %for.cond116, %for.cond91
  %indvars.iv52 = phi i64 [ 1, %for.cond91 ], [ %indvars.iv.next53, %for.cond116 ]
  %exitcond56.not = icmp eq i64 %indvars.iv52, %indvars.iv60
  br i1 %exitcond56.not, label %for.inc135, label %for.cond116.preheader
...
for.cond116:                                      ; preds = %for.cond116.preheader, %for.inc129
  %indvars.iv47 = phi i64 [ 0, %for.cond116.preheader ], [ %indvars.iv.next48, %for.inc129 ]
  %exitcond51.not = icmp eq i64 %indvars.iv47, %indvars.iv57
  br i1 %exitcond51.not, label %for.cond113, label %for.inc129, !llvm.loop !21

for.inc129:                                       ; preds = %for.cond116
  %arrayidx124 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv.next53
  %15 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx128 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %a, i64 0, i64 %indvars.iv47, i64 %indvars.iv52
