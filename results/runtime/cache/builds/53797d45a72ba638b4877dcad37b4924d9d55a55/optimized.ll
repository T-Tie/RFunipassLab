...
for.cond:                                         ; preds = %if.end46, %entry
  %b.0 = phi i32 [ 0, %entry ], [ %inc6, %if.end46 ]
  %a.0 = phi i32 [ 0, %entry ], [ %a.1, %if.end46 ]
  %i.0 = phi i32 [ 0, %entry ], [ %inc47, %if.end46 ]
  %p.0 = phi i32 [ 0, %entry ], [ %p.1, %if.end46 ]
...
if.end46:                                         ; preds = %if.then44, %land.lhs.true39, %land.lhs.true34, %land.lhs.true29, %lor.lhs.false
  ...
  %inc47 = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !8

for.end:                                          ; preds = %for.cond
  %conv48 = sitofp i32 %a.0 to double
  %conv49 = sitofp i32 %b.0 to double
