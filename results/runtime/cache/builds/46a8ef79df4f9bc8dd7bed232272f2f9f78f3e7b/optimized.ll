...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr %a) #10
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 256, i1 false)
  call void @llvm.lifetime.start.p0(i64 256, ptr %b) #10
  call void @llvm.memset.p0.i64(ptr align 16 %b, i8 0, i64 256, i1 false)
  call void @llvm.lifetime.start.p0(i64 256, ptr %c) #10
  ...
  %call6 = call i64 @strlen(ptr noundef %a) #11
  %conv = trunc i64 %call6 to i32
  %call8 = call i64 @strlen(ptr noundef %b) #11
...
if.end57:                                         ; preds = %for.end56, %if.then34
  call void @llvm.lifetime.end.p0(i64 256, ptr %c) #10
  call void @llvm.lifetime.end.p0(i64 256, ptr %b) #10
  call void @llvm.lifetime.end.p0(i64 256, ptr %a) #10
  ret i32 0
}
