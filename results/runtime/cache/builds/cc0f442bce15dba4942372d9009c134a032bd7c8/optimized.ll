...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc18
  %indvars.iv8 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc18 ]
  %exitcond17.not = icmp eq i64 %indvars.iv8, %wide.trip.count16
  br i1 %exitcond17.not, label %for.cond21, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc15
  %indvars.iv10 = phi i64 [ %indvars.iv8, %for.cond5.preheader ], [ %indvars.iv.next11, %for.inc15 ]
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond.not, label %for.inc18, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next11
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv25 = phi i32 [ %indvars.iv.next26, %for.cond21 ], [ %2, %for.cond2 ]
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.cond21 ], [ %1, %for.cond2 ]
  %indvars.iv.next20 = add nsw i64 %indvars.iv19, -1
  %arrayidx23 = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next20
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax27 = call i32 @llvm.smax.i32(i32 %indvars.iv25, i32 noundef 0)
  %wide.trip.count28 = zext nneg i32 %smax27 to i64
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  %indvars.iv22 = phi i64 [ 0, %for.cond28.preheader ], [ %indvars.iv.next23, %for.inc39 ]
  %exitcond29.not = icmp eq i64 %indvars.iv22, %wide.trip.count28
  br i1 %exitcond29.not, label %for.end41, label %for.body30

for.body30:                                       ; preds = %for.cond28
  %arrayidx32 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv22
...
for.end41:                                        ; preds = %for.cond28
  %call44 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5)
