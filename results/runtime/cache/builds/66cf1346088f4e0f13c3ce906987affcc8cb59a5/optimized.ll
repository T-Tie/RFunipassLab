...
for.cond:                                         ; preds = %for.inc31, %entry
  ...
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc31 ], [ 0, %entry ]
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv34
...
for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc40
  %indvars.iv37 = phi i64 [ 1, %for.cond33.preheader ], [ %indvars.iv.next38, %for.inc40 ]
...
for.inc40:                                        ; preds = %for.cond33
  %arrayidx38 = getelementptr inbounds nuw i32, ptr %vla1, i64 %indvars.iv37
