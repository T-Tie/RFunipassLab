...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %maxIndex) #3
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %k2) #4
...
for.cond.cleanup:                                 ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %k2) #4
  br label %for.end35

for.body5:                                        ; preds = %for.cond3
  store i32 0, ptr %maxIndex, align 4, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i6) #4
...
for.cond.cleanup9:                                ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i6) #4
  br label %for.end18
...
for.body56:                                       ; preds = %for.cond54
  ...
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %15)
  br label %for.inc60
...
if.end63:                                         ; preds = %for.end62, %for.end51
...
for.body69:                                       ; preds = %for.cond66
  ...
  %call72 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %17)
  br label %for.inc73
...
for.end75:                                        ; preds = %for.cond66
  ...
  %call79 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %18)
  br label %if.end80
...
if.end80:                                         ; preds = %for.end75, %if.end63
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %maxIndex) #4
  ret i32 0
}
