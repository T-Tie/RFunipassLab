...
for.end59:                                        ; preds = %for.cond26
  %4 = load i32, ptr getelementptr inbounds ([101 x i32], ptr getelementptr inbounds ([101 x [101 x i32]], ptr @a, i64 0, i64 2), i64 0, i64 2), align 8, !tbaa !5
  br label %for.cond60
...
for.end100:                                       ; preds = %for.cond80
  ...
  %call = call noundef i32 @_Z6hanshui(i32 noundef %sub101)
