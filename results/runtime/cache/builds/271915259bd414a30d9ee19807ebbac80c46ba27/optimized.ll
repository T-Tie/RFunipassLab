...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end73
  %indvars.iv21 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next22, %if.end73 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %inc71.sink, %if.end73 ]
  %k.0 = phi i32 [ 0, %for.cond2.preheader ], [ %k.1, %if.end73 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv21
...
if.then:                                          ; preds = %for.body4
  ...
  store i8 32, ptr %arrayidx29, align 1, !tbaa !23
...
if.end:                                           ; preds = %if.else58, %if.then44
  ...
  %arrayidx70 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom77, i64 %idxprom69
  store i8 32, ptr %arrayidx70, align 1, !tbaa !23
  %inc71 = add nsw i32 %add, 1
  br label %if.end73

if.end73:                                         ; preds = %if.then33, %if.end, %if.then
  %k.1 = phi i32 [ %inc18, %if.then ], [ %inc41, %if.then33 ], [ %k.0, %if.end ]
  %inc71.sink = phi i32 [ %inc30, %if.then ], [ 0, %if.then33 ], [ %inc71, %if.end ]
...
for.cond86:                                       ; preds = %for.end115, %for.end76
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.end115 ], [ 0, %for.end76 ]
  %exitcond37 = icmp eq i64 %indvars.iv31, %wide.trip.count36
  br i1 %exitcond37, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv31
  %call92 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %arrayidx90) #14
  %conv93 = trunc i64 %call92 to i32
  %sub97 = add i64 %call92, 4294967295
  %5 = and i64 %sub97, 4294967295
  %smax28 = call i32 @llvm.smax.i32(i32 %conv93, i32 0)
  %wide.trip.count29 = zext nneg i32 %smax28 to i64
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv31, i64 %5
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.body88
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %if.end112 ], [ 0, %for.body88 ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv25, %5
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %6 = load i8, ptr %arrayidx103, align 1, !tbaa !23, !invariant.load !11
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv31, i64 %indvars.iv25
  %7 = load i8, ptr %arrayidx110, align 1, !tbaa !23, !invariant.load !11
