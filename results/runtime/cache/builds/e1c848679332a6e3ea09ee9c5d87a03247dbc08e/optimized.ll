; ModuleID = '<stdin>'
source_filename = "/tmp/tmpxro59ik2.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %n) #4
  %arrayidx = getelementptr inbounds nuw i8, ptr %n, i64 4
  br label %while.cond
...
for.cond:                                         ; preds = %while.cond, %for.inc22
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc22 ], [ 2, %while.cond ]
  %count.0 = phi i32 [ %count.1, %for.inc22 ], [ 0, %while.cond ]
  %arrayidx2 = getelementptr inbounds nuw [25 x i32], ptr %n, i64 0, i64 %indvars.iv12
  ...
  br i1 %cmp6.not, label %for.end24, label %for.cond7.preheader
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv = phi i64 [ 1, %for.cond7.preheader ], [ %indvars.iv.next, %for.body9 ]
  %count.1 = phi i32 [ %count.0, %for.cond7.preheader ], [ %count.2, %for.body9 ]
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv12
  br i1 %exitcond.not, label %for.inc22, label %for.body9

for.body9:                                        ; preds = %for.cond7
  %arrayidx13 = getelementptr inbounds nuw [25 x i32], ptr %n, i64 0, i64 %indvars.iv
  %2 = load i32, ptr %arrayidx13, align 4, !tbaa !5
  %mul = shl nsw i32 %2, 1
  %cmp14 = icmp eq i32 %1, %mul
  %cmp20 = icmp eq i32 %mul17, %2
  %or.cond = select i1 %cmp14, i1 true, i1 %cmp20
  %inc = zext i1 %or.cond to i32
  %count.2 = add nsw i32 %count.1, %inc
...
for.end24:                                        ; preds = %for.cond
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %count.0)
  %vtable.i = load ptr, ptr %call25, align 8, !tbaa !13
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %n) #4
  ret i32 0
}
