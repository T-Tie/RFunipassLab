...
for.end:                                          ; preds = %for.body4, %for.cond2
  %j.0.lcssa = phi i32 [ %j.0, %for.body4 ], [ %j.0, %for.cond2 ]
  %cmp10 = icmp eq i32 %i.0, %j.0.lcssa
...
for.end16:                                        ; preds = %for.cond
  %counter.0.lcssa = phi i32 [ %counter.0, %for.cond ]
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc43, %for.end16
  %i.1 = phi i32 [ 0, %for.end16 ], [ %inc44, %for.inc43 ]
  %counter.2 = phi i32 [ %counter.0.lcssa, %for.end16 ], [ %counter.3, %for.inc43 ]
...
for.end32:                                        ; preds = %for.body22, %for.cond20
  %j.1.lcssa = phi i32 [ %j.1, %for.body22 ], [ %j.1, %for.cond20 ]
  %cmp33 = icmp eq i32 %i.1, %j.1.lcssa
