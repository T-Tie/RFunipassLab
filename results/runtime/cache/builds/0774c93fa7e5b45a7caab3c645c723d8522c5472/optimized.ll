...
for.end:                                          ; preds = %for.cond
  ...
  %smax27 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
...
for.cond4:                                        ; preds = %for.inc26, %for.end
  ...
  br i1 %exitcond29.not, label %for.cond29.preheader, label %for.cond7.preheader
...
for.cond7:                                        ; preds = %for.cond7.preheader, %for.body9
  %indvars.iv20 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next21, %for.body9 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv20
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv30 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next31, %for.inc36 ]
  %exitcond35.not = icmp eq i64 %indvars.iv30, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv30
