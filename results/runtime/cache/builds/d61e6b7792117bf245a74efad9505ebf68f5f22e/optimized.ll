...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv7 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next8, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax15 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv7
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond19 = icmp eq i32 %q.0, %4
  br i1 %exitcond19, label %for.cond52.preheader, label %for.cond25

for.cond52.preheader:                             ; preds = %for.cond22
  %7 = sext i32 %t.0 to i64
  %8 = add i32 %3, 1
  %wide.trip.count25 = zext i32 %8 to i64
  br label %for.cond52

for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond17.not = icmp eq i64 %indvars.iv11, %wide.trip.count16
  br i1 %exitcond17.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv11
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next12
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv20 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next21, %for.body54 ]
  %exitcond26 = icmp eq i64 %indvars.iv20, %wide.trip.count25
  br i1 %exitcond26, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv20, %7
  %spec.select5 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %arrayidx62 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv20
  %11 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select5, i32 noundef %11)
