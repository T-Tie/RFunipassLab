...
land.lhs.true:                                    ; preds = %for.body33
  ...
  %spec.select = select i1 %cmp37, ptr @.str, ptr @.str.1
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select, i32 noundef %9)
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc53

for.inc53:                                        ; preds = %for.body33, %land.lhs.true
  %.pre = phi i32 [ %.pre.pre, %land.lhs.true ], [ %.pre18, %for.body33 ]
  %b.1 = phi i32 [ 1, %land.lhs.true ], [ %b.0, %for.body33 ]
