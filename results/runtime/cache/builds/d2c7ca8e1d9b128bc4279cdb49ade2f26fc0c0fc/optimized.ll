...
for.cond7:                                        ; preds = %if.end20, %for.end
  ...
  %6 = load i32, ptr %max1, align 4, !tbaa !5
...
for.body9:                                        ; preds = %for.cond7
  ...
  %7 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !9
  %8 = load i32, ptr %max2, align 4, !tbaa !5
  %cmp12 = icmp sge i32 %7, %8
  %conv = zext i1 %cmp12 to i32
  %sub = sub nsw i32 %6, 1
  %cmp15 = icmp sle i32 %7, %sub
...
if.then17:                                        ; preds = %for.body9
  ...
  store i32 %9, ptr %max2, align 4, !tbaa !5
  br label %if.end20
...
for.end22:                                        ; preds = %for.cond7
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %6)
  ...
  %call25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
