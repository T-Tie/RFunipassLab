...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv8 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv8, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax23 = add nsw i32 %4, -1
  %wide.trip.count24 = zext nneg i32 %smax23 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv12 = phi i64 [ %3, %for.cond13.preheader ], [ %indvars.iv.next13, %for.inc40 ]
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %5 = trunc nuw i64 %indvars.iv.next13 to i32
  %cmp14 = icmp sgt i32 %0, %5
  br i1 %cmp14, label %for.body15, label %for.inc43

for.body15:                                       ; preds = %for.cond13
  %6 = load i32, ptr %arrayidx17, align 8, !tbaa !15
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next13
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond25.not = icmp eq i64 %indvars.iv20, %wide.trip.count24
  br i1 %exitcond25.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv20, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc74 ], [ %indvars.iv15, %for.body48 ]
...
for.body52:                                       ; preds = %for.cond50
  ...
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv17, i32 1
