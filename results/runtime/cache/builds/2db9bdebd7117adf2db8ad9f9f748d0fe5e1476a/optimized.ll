...
for.cond31.preheader:                             ; preds = %for.cond12
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %6, i32 0)
...
for.cond49.preheader:                             ; preds = %for.cond31
  %smax33 = call i32 @llvm.smax.i32(i32 %4, i32 0)
...
for.body93:                                       ; preds = %for.cond90
  ...
  %19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv50, i64 %indvars.iv47
