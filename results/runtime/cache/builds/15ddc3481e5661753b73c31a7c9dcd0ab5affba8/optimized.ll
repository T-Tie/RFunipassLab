...
for.cond15.preheader:                             ; preds = %for.cond2
  %smax21 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count22 = zext nneg i32 %smax21 to i64
  %wide.trip.count15 = zext i32 %j.0 to i64
  br label %for.cond15
...
for.cond15:                                       ; preds = %for.cond15.loopexit, %for.cond15.preheader
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond15.loopexit ], [ 0, %for.cond15.preheader ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.cond15.loopexit ], [ 1, %for.cond15.preheader ]
  %exitcond23.not = icmp eq i64 %indvars.iv17, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond43.preheader, label %for.body17
...
for.body17:                                       ; preds = %for.cond15
  %arrayidx23 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv17
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc37, %for.body17
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc37 ], [ %indvars.iv9, %for.body17 ]
  %exitcond16.not = icmp eq i64 %indvars.iv11, %wide.trip.count15
  br i1 %exitcond16.not, label %for.cond15.loopexit, label %for.body21

for.body21:                                       ; preds = %for.cond19
  %5 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !12
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv11
...
for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc53
  %indvars.iv24 = phi i64 [ 0, %for.cond43.preheader ], [ %indvars.iv.next25, %for.inc53 ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count22
  br i1 %exitcond28.not, label %for.end55, label %for.body45

for.body45:                                       ; preds = %for.cond43
  %arrayidx47 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv24
  ...
  %cmp49 = icmp slt i64 %indvars.iv24, %4
