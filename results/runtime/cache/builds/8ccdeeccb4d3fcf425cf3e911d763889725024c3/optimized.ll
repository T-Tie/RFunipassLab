...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc19 ], [ %idxprom2, %for.end ]
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.end47 ], [ %indvars.iv10, %for.end20 ]
  %p.0 = phi i32 [ %p.1, %for.end47 ], [ 0, %for.end20 ]
  %indvars.iv.next13 = add nsw i64 %indvars.iv12, -1
  %cmp23 = icmp sgt i64 %indvars.iv12, 0
...
for.body24:                                       ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next13
  br label %for.cond29
...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  ...
  %cmp30.not = icmp slt i64 %indvars.iv7, %indvars.iv12
...
for.end47:                                        ; preds = %for.cond29
  ...
  %arrayidx55 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next13
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select5 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
