...
for.body115:                                      ; preds = %for.cond113
  ...
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %arrayidx123) #9
...
if.then119_to_outline:
  ...
  %puts1 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.str) #9
  ret void
}
