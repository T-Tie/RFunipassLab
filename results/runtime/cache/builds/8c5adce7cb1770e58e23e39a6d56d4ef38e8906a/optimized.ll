...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2004, ptr %a) #3
  call void @llvm.lifetime.start.p0(i64 2004, ptr %b) #3
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef @.str, ptr noundef %n)
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %j.0 = phi i32 [ 0, %entry ], [ %j.1, %for.inc ]
  %num.0 = phi i32 [ 0, %entry ], [ %num.1, %for.inc ]
...
for.end47:                                        ; preds = %for.cond39
  ...
  call void @llvm.lifetime.end.p0(i64 2004, ptr %b) #3
  call void @llvm.lifetime.end.p0(i64 2004, ptr %a) #3
