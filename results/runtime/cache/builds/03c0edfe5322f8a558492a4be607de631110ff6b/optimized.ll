...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 49284, ptr noundef nonnull %b) #5
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  ...
  br i1 %cmp14, label %for.cond16.preheader, label %for.cond30.preheader
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc24 ], [ 0, %for.cond16.preheader ]
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc57
  ...
  br i1 %exitcond57.not, label %for.cond60.preheader, label %for.cond33.preheader

for.cond33.preheader:                             ; preds = %for.cond30
  br label %for.cond33

for.cond60.preheader:                             ; preds = %for.cond30
  br label %for.cond60

for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc54
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc54 ], [ 0, %for.cond33.preheader ]
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.inc78
  %12 = phi i32 [ %15, %for.inc78 ], [ %7, %for.cond60.preheader ]
  %13 = phi i32 [ %.pre, %for.inc78 ], [ %6, %for.cond60.preheader ]
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc78 ], [ 0, %for.cond60.preheader ]
...
for.cond64:                                       ; preds = %for.cond64.preheader, %for.inc75
  %15 = phi i32 [ %.pre64, %for.inc75 ], [ %12, %for.cond64.preheader ]
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.inc75 ], [ 0, %for.cond64.preheader ]
