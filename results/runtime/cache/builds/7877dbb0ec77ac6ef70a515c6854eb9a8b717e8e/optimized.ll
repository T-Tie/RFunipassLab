...
for.cond2:                                        ; preds = %for.inc11, %for.body
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc11 ], [ 1, %for.body ]
  %exitcond13 = icmp eq i64 %indvars.iv9, %1
  br i1 %exitcond13, label %for.cond14.preheader, label %for.cond5.preheader

for.cond14.preheader:                             ; preds = %for.cond2
  %4 = add i32 %0, 2
  %wide.trip.count52 = zext i32 %4 to i64
  br label %for.cond14

for.cond5.preheader:                              ; preds = %for.cond2
  %5 = mul nuw nsw i64 %indvars.iv9, %1
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  %phiofops58 = phi i64 [ %1, %for.cond14.preheader ], [ %15, %for.cond14.loopexit ]
  %indvars.iv46 = phi i64 [ 3, %for.cond14.preheader ], [ %indvars.iv.next47, %for.cond14.loopexit ]
  %indvars.iv14 = phi i64 [ 1, %for.cond14.preheader ], [ %indvars.iv.next15, %for.cond14.loopexit ]
  ...
  br i1 %exitcond53.not, label %for.inc138, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.inc50
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc50 ], [ %indvars.iv14, %for.cond14 ]
  %exitcond30 = icmp eq i64 %indvars.iv26, %1
  br i1 %exitcond30, label %for.cond53.preheader, label %for.body19

for.cond53.preheader:                             ; preds = %for.cond17
  %arrayidx57 = getelementptr inbounds nuw i32, ptr %vla, i64 %phiofops58
  br label %for.cond53

for.body19:                                       ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv26, %1
  %arrayidx21 = getelementptr inbounds nuw i32, ptr %vla, i64 %6
  %arrayidx23 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv14
  %7 = load i32, ptr %arrayidx23, align 4, !tbaa !5
  br label %for.cond24

for.cond24:                                       ; preds = %for.body26, %for.body19
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body26 ], [ %indvars.iv14, %for.body19 ]
  %min.0 = phi i32 [ %spec.select, %for.body26 ], [ %7, %for.body19 ]
  %exitcond20 = icmp eq i64 %indvars.iv16, %1
  br i1 %exitcond20, label %for.cond39.preheader, label %for.body26

for.cond39.preheader:                             ; preds = %for.cond24
  br label %for.cond39

for.body26:                                       ; preds = %for.cond24
  %arrayidx30 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv16
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc47 ], [ %indvars.iv14, %for.cond39.preheader ]
  %exitcond25 = icmp eq i64 %indvars.iv21, %1
  br i1 %exitcond25, label %for.inc50, label %for.inc47

for.inc47:                                        ; preds = %for.cond39
  %arrayidx45 = getelementptr inbounds nuw i32, ptr %arrayidx21, i64 %indvars.iv21
...
for.cond53:                                       ; preds = %for.cond53.preheader, %for.inc88
  %indvars.iv41 = phi i64 [ %indvars.iv14, %for.cond53.preheader ], [ %indvars.iv.next42, %for.inc88 ]
  %exitcond45 = icmp eq i64 %indvars.iv41, %1
  br i1 %exitcond45, label %for.end90, label %for.body55

for.body55:                                       ; preds = %for.cond53
  %arrayidx59 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv41
  %10 = load i32, ptr %arrayidx59, align 4, !tbaa !5
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %indvars.iv41
  br label %for.cond60

for.cond60:                                       ; preds = %for.body62, %for.body55
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.body62 ], [ %indvars.iv14, %for.body55 ]
  %min.2 = phi i32 [ %spec.select5, %for.body62 ], [ %10, %for.body55 ]
  %exitcond35 = icmp eq i64 %indvars.iv31, %1
  br i1 %exitcond35, label %for.cond77.preheader, label %for.body62

for.cond77.preheader:                             ; preds = %for.cond60
  br label %for.cond77

for.body62:                                       ; preds = %for.cond60
  %11 = mul nuw nsw i64 %indvars.iv31, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %11
  %12 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select5 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc85 ], [ %indvars.iv14, %for.cond77.preheader ]
  %exitcond40 = icmp eq i64 %indvars.iv36, %1
  br i1 %exitcond40, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv36, %1
  %gep7 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep7, align 4, !tbaa !5
  %sub84 = sub nsw i32 %14, %min.2
  store i32 %sub84, ptr %gep7, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next15, %1
  %arrayidx93 = getelementptr inbounds nuw i32, ptr %vla, i64 %15
  %arrayidx96 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv.next15
  %16 = load i32, ptr %arrayidx96, align 4, !tbaa !5
  %arrayidx101 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv14
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.inc130 ], [ %indvars.iv46, %for.end90 ]
  %18 = trunc nuw i64 %indvars.iv48 to i32
  %cmp110.not = icmp slt i32 %0, %18
  br i1 %cmp110.not, label %for.cond14.loopexit, label %for.inc130

for.inc130:                                       ; preds = %for.cond109
  %arrayidx115 = getelementptr inbounds nuw i32, ptr %arrayidx57, i64 %indvars.iv48
  %19 = load i32, ptr %arrayidx115, align 4, !tbaa !5
  %arrayidx120 = getelementptr inbounds nuw i32, ptr %arrayidx93, i64 %indvars.iv48
  store i32 %19, ptr %arrayidx120, align 4, !tbaa !5
  %20 = mul nuw nsw i64 %indvars.iv48, %1
  %arrayidx122 = getelementptr inbounds nuw i32, ptr %vla, i64 %20
  %arrayidx124 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv14
  %21 = load i32, ptr %arrayidx124, align 4, !tbaa !5
  %arrayidx129 = getelementptr inbounds nuw i32, ptr %arrayidx122, i64 %indvars.iv.next15
