...
if.else:                                          ; preds = %for.body26
  ...
  %5 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !13
  %cmp36 = icmp sgt i32 %4, %5
...
cond.end:                                         ; preds = %if.else, %cond.true
  %min.sink1 = phi ptr [ %arrayidx35, %cond.true ], [ %min, %if.else ]
  %6 = load i32, ptr %min.sink1, align 4, !tbaa !5
  store i32 %6, ptr %min, align 4, !tbaa !5
  br label %for.inc41
...
if.else75:                                        ; preds = %for.body68
  ...
  %cmp80 = icmp sgt i32 %10, %11
  br i1 %cmp80, label %cond.true81, label %cond.end87

cond.true81:                                      ; preds = %if.else75
  br label %cond.end87

cond.end87:                                       ; preds = %if.else75, %cond.true81
  %min.sink = phi ptr [ %arrayidx79, %cond.true81 ], [ %min, %if.else75 ]
  %12 = load i32, ptr %min.sink, align 4, !tbaa !5
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %18 = load i32, ptr %arrayidx157, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %18, ptr %arrayidx161, align 4, !tbaa !5
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %19 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %19, ptr %arrayidx184, align 4, !tbaa !5
