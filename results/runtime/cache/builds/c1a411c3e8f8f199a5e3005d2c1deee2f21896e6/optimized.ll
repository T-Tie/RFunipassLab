...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.end27
  %indvars.iv16 = phi i32 [ %sub, %for.cond2.preheader ], [ %indvars.iv.next17, %for.end27 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %inc29, %for.end27 ]
  %exitcond19.not = icmp eq i32 %j.0, %smax18
  br i1 %exitcond19.not, label %for.end30, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %if.end
  %indvars.iv13 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next14, %if.end ]
  %exitcond.not = icmp eq i64 %indvars.iv13, %wide.trip.count
  br i1 %exitcond.not, label %for.end27, label %for.body9
...
for.body9:                                        ; preds = %for.cond5
  ...
  %arrayidx13 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next14
...
for.end30:                                        ; preds = %for.cond2
  ...
  %call33 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4, i32 noundef %5) #6
