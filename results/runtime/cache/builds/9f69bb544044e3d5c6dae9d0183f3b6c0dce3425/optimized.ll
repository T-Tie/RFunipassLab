...
entry:
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %word) #9
...
if.else.i:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %while.body
  ...
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %arrayidx3) #10
...
if.end10:                                         ; preds = %if.else.i
  ...
  %call14 = call i64 @strlen(ptr nofree noundef nonnull dereferenceable(1) %arrayidx12) #11
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %number) #12
  ...
  %call.i = call i32 @getc(ptr noundef %0) #13
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 25000, ptr noundef nonnull %word) #13
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %number) #13
  ret i32 0
}
...
entry:
  %0 = load ptr, ptr @stdin, align 8, !tbaa !28
  %call = tail call i32 @getc(ptr noundef %0) #13
  ret i32 %call
}
...
declare noundef i32 @getc(ptr noundef captures(none)) #7
...
attributes #10 = { nofree nosync nounwind memory(read) }
...
!31 = !{!12, !15, i64 32}
!32 = !{!33, !37, i64 240}
!33 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !12, i64 0, !34, i64 216, !6, i64 224, !35, i64 225, !36, i64 232, !37, i64 240, !38, i64 248, !39, i64 256}
!34 = !{!"p1 _ZTSSo", !17, i64 0}
!35 = !{!"bool", !6, i64 0}
!36 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !17, i64 0}
!37 = !{!"p1 _ZTSSt5ctypeIcE", !17, i64 0}
!38 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!39 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !17, i64 0}
!40 = !{!41, !6, i64 56}
