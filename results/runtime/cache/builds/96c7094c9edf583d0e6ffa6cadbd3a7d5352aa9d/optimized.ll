...
for.end87:                                        ; preds = %for.cond
  ...
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %total1.0.loc) #5
  %total1.0.reload = load i32, ptr %total1.0.loc, align 4
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef %total1.0.loc)
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 4 dereferenceable(4) %total2.0.loc)
  call fastcc void @outlined_ir_func_0(ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %month2, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %year, ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %total2.0.loc) #5
  %total2.0.reload = load i32, ptr %total2.0.loc, align 4
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef %total2.0.loc)
