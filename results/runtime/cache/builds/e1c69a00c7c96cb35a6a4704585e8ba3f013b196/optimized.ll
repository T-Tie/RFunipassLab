...
tailrecurse:                                      ; preds = %for.end106, %entry
  ...
  %smax52 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %smax28 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond14.not, label %for.cond27.preheader, label %for.body

for.cond27.preheader:                             ; preds = %for.cond
  %wide.trip.count18 = zext i32 %n.tr to i64
  br label %for.cond27
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.inc60
  %indvars.iv25 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next26, %for.inc60 ]
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc57
  %indvars.iv20 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next21, %for.inc57 ]
...
for.cond65:                                       ; preds = %for.cond65.preheader, %for.inc83
  ...
  br i1 %exitcond42.not, label %for.cond86.preheader, label %for.cond68.preheader
...
for.cond86:                                       ; preds = %for.cond86.preheader, %for.inc104
  %indvars.iv48 = phi i64 [ 2, %for.cond86.preheader ], [ %indvars.iv.next49, %for.inc104 ]
