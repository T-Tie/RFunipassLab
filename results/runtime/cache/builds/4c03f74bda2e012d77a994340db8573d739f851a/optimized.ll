...
for.cond2:                                        ; preds = %for.inc, %for.body
  ...
  %call3 = call noundef float @_ZSt4sqrtf(float noundef %conv)
...
entry:
  %call = call float @sqrtf(float noundef %__x) #8, !tbaa !5
  ret float %call
}
...
if.then3:                                         ; preds = %while.body
  ...
  call void @_Z1fii(i32 noundef %div, i32 noundef %y.addr.0)
  br label %if.end4
