...
entry:
  ...
  %0 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !15
  ...
  %call16.i = tail call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr15.i)
  %1 = add i64 %0, -101
...
if.then19.i:                                      ; preds = %entry
  ...
  %call24.i = tail call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr23.i)
