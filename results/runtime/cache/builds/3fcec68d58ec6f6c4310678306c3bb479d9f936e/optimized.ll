...
entry:
  ...
  %__c.addr.i17 = alloca i8, align 1
  %__c.addr.i = alloca i8, align 1
  %n = alloca i32, align 4
  %a = alloca [100 x [2 x double]], align 16
  %b = alloca [100 x double], align 16
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %n) #3
  call void @llvm.lifetime.start.p0(i64 1600, ptr nonnull %a) #3
  call void @llvm.lifetime.start.p0(i64 800, ptr nonnull %b) #3
  %call = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %n)
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.end ], [ 0, %entry ]
...
if.then34:                                        ; preds = %if.else
  %call1.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 5)
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i17)
  store i8 10, ptr %__c.addr.i17, align 1, !tbaa !15
  %vtable.i18 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !16
  %vbase.offset.ptr.i19 = getelementptr i8, ptr %vtable.i18, i64 -24
  %vbase.offset.i20 = load i64, ptr %vbase.offset.ptr.i19, align 8
  %gep46 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i20
  %9 = load i64, ptr %gep46, align 8, !tbaa !18
  %cmp.not.i23 = icmp eq i64 %9, 0
  br i1 %cmp.not.i23, label %if.end.i27, label %if.then.i24

if.then.i24:                                      ; preds = %if.then34
  %call1.i25 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull %__c.addr.i17, i64 noundef 1)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit29

if.end.i27:                                       ; preds = %if.then34
  %call2.i28 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 10)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit29

_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit29: ; preds = %if.then.i24, %if.end.i27
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i17)
  br label %for.inc41

if.else37:                                        ; preds = %if.else
  %call1.i31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 4)
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i33)
  store i8 10, ptr %__c.addr.i33, align 1, !tbaa !15
  %vtable.i34 = load ptr, ptr @_ZSt4cout, align 8, !tbaa !16
  ...
  %cmp.not.i39 = icmp eq i64 %10, 0
  br i1 %cmp.not.i39, label %if.end.i43, label %if.then.i40

if.then.i40:                                      ; preds = %if.else37
...
if.end.i43:                                       ; preds = %if.else37
  %call2.i44 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 10)
  br label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit45
...
for.inc41:                                        ; preds = %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit45, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit29
...
for.end43:                                        ; preds = %for.cond18
  ...
  call void @llvm.lifetime.end.p0(i64 1600, ptr nonnull %a) #3
