...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc18 ], [ 0, %entry ]
  %exitcond68 = icmp eq i64 %indvars.iv63, %2
  br i1 %exitcond68, label %for.cond21.preheader, label %for.cond6

for.cond21.preheader:                             ; preds = %for.cond
  %3 = trunc i64 %call4 to i32
  %4 = add i32 %3, 1
  %5 = sub i32 %4, %0
  %wide.trip.count72 = zext i32 %5 to i64
  br label %for.cond21
...
for.inc:                                          ; preds = %for.cond6
  %6 = add nuw nsw i64 %indvars.iv, %indvars.iv63
  %arrayidx = getelementptr inbounds nuw [600 x i8], ptr %input, i64 0, i64 %6
  %7 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv63, i64 %indvars.iv
  store i8 %7, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv63, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv69 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next70, %for.inc26 ]
  %exitcond73.not = icmp eq i64 %indvars.iv69, %wide.trip.count72
  br i1 %exitcond73.not, label %for.cond29.preheader, label %for.inc26
...
for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv69
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc54
  %indvars.iv74 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next75, %for.inc54 ]
  %exitcond81.not = icmp eq i64 %indvars.iv74, %wide.trip.count72
  br i1 %exitcond81.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv74
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv74
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv76 = phi i64 [ %indvars.iv74, %for.cond32.preheader ], [ %indvars.iv.next77, %for.inc51 ]
  %cmp33 = icmp samesign ult i64 %indvars.iv76, %8
  br i1 %cmp33, label %for.body34, label %for.inc54

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv76
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv76
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond86.not = icmp eq i64 %indvars.iv82, %wide.trip.count72
  br i1 %exitcond86.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv82
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv87 = phi i64 [ %indvars.iv.next88, %for.inc89 ], [ 0, %if.else ]
  %exitcond91.not = icmp eq i64 %indvars.iv87, %wide.trip.count72
  br i1 %exitcond91.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv87
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv87
