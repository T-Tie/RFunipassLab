; ModuleID = '<stdin>'
source_filename = "/tmp/tmpjy7zi_d6.cpp"
...
for.cond2:                                        ; preds = %for.cond, %for.inc9
  %2 = phi i32 [ %.pre, %for.inc9 ], [ %0, %for.cond ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc9 ], [ 0, %for.cond ]
  %3 = sext i32 %2 to i64
  %cmp3 = icmp slt i64 %indvars.iv2, %3
  br i1 %cmp3, label %for.inc9, label %for.end11

for.inc9:                                         ; preds = %for.cond2
  store i32 0, ptr @sum, align 4, !tbaa !5
  %arrayidx6 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv2
  %4 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  call void @_Z8zhongshuii(i32 noundef 2, i32 noundef %4) #7
  %5 = load i32, ptr @sum, align 4, !tbaa !5
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %5)
...
define dso_local void @_Z8zhongshuii(i32 noundef %qian, i32 noundef %a) local_unnamed_addr #3 {
entry:
  %cmp = icmp eq i32 %a, 1
...
for.cond:                                         ; preds = %entry, %for.inc
  %i.0 = phi i32 [ %inc, %for.inc ], [ %qian, %entry ]
  %cmp1.not = icmp sgt i32 %i.0, %a
  br i1 %cmp1.not, label %cleanup.cont, label %for.body
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %a, %i.0
  tail call void @_Z8zhongshuii(i32 noundef %i.0, i32 noundef %div) #8
  br label %for.inc
