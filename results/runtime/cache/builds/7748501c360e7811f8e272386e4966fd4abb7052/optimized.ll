...
for.cond:                                         ; preds = %for.inc, %entry
  %n.promoted9 = phi i32 [ %n.promoted, %entry ], [ %sub, %for.inc ]
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %n.promoted11 = phi i32 [ %sub3, %for.inc7 ], [ %n.promoted9, %for.cond2.preheader ]
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc15
  %n.promoted13 = phi i32 [ %sub11, %for.inc15 ], [ %n.promoted11, %for.cond10.preheader ]
...
for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc23
  %n.promoted15 = phi i32 [ %sub19, %for.inc23 ], [ %n.promoted13, %for.cond18.preheader ]
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc31
  %n.promoted17 = phi i32 [ %sub27, %for.inc31 ], [ %n.promoted15, %for.cond26.preheader ]
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.inc39
  %sub3518 = phi i32 [ %sub35, %for.inc39 ], [ %n.promoted17, %for.cond34.preheader ]
