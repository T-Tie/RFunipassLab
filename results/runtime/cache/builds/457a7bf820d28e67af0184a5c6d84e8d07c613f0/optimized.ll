...
for.cond:                                         ; preds = %for.inc28, %entry
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc28 ], [ 0, %entry ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond31, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv14
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc25 ], [ 0, %for.cond14.preheader ]
  %exitcond13.not = icmp eq i64 %indvars.iv9, %wide.trip.count
  br i1 %exitcond13.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv14, i64 %indvars.iv9
...
for.cond31:                                       ; preds = %for.cond, %for.inc69
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc69 ], [ 0, %for.cond ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count17
  br i1 %exitcond33.not, label %for.end71, label %for.body33

for.body33:                                       ; preds = %for.cond31
  %arrayidx36 = getelementptr inbounds nuw [101 x i32], ptr @a, i64 0, i64 %indvars.iv29
  %3 = load i32, ptr %arrayidx36, align 4, !tbaa !5, !invariant.load !9
  br label %for.cond37

for.cond37:                                       ; preds = %for.body39, %for.body33
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.body39 ], [ 1, %for.body33 ]
  %min34.0 = phi i32 [ %spec.select7, %for.body39 ], [ %3, %for.body33 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.cond54.preheader, label %for.body39

for.cond54.preheader:                             ; preds = %for.cond37
  br label %for.cond54

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv19, i64 %indvars.iv29
  %4 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !9
  %spec.select7 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min34.0)
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1
  br label %for.cond37, !llvm.loop !15

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc66 ], [ 0, %for.cond54.preheader ]
  %exitcond28.not = icmp eq i64 %indvars.iv24, %wide.trip.count
  br i1 %exitcond28.not, label %for.inc69, label %for.inc66

for.inc66:                                        ; preds = %for.cond54
  %arrayidx60 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv24, i64 %indvars.iv29
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
  %smax7 = tail call i32 @llvm.smax.i32(i32 %sub, i32 noundef 1)
...
for.cond13.preheader:                             ; preds = %for.cond
  %wide.trip.count13 = zext i32 %sub to i64
  br label %for.cond13
...
for.cond13:                                       ; preds = %for.cond17, %for.cond13.preheader
  %indvars.iv15 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next16, %for.cond17 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count8
  br i1 %exitcond19.not, label %for.end35, label %for.cond17.preheader
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc30
  %indvars.iv10 = phi i64 [ 0, %for.cond17.preheader ], [ %indvars.iv.next11, %for.inc30 ]
  %exitcond14.not = icmp eq i64 %indvars.iv10, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond13, label %for.inc30, !llvm.loop !20

for.inc30:                                        ; preds = %for.cond17
  %arrayidx25 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv.next16
  %1 = load i32, ptr %arrayidx25, align 4, !tbaa !5, !invariant.load !9
  %arrayidx29 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv10, i64 %indvars.iv15
...
for.cond1:                                        ; preds = %for.inc12, %for.body
  ...
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc12 ], [ 0, %for.body ]
  %2 = sext i32 %1 to i64
