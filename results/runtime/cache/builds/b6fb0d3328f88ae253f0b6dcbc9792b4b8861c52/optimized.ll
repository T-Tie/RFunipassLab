...
for.cond35:                                       ; preds = %for.cond31, %for.cond.cleanup
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond.cleanup ], [ 0, %for.cond31 ]
...
for.cond39:                                       ; preds = %for.cond35, %for.body41
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.body41 ], [ 0, %for.cond35 ]
...
for.cond63:                                       ; preds = %for.cond31, %for.end84
  ...
  %indvars.iv62 = phi i64 [ %indvars.iv.next63, %for.end84 ], [ 0, %for.cond31 ]
...
for.cond67.preheader:                             ; preds = %for.cond63
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr %c, i64 0, i64 %indvars.iv62
  br label %for.cond67
...
for.end88:                                        ; preds = %for.cond63
  ...
  %call.i32 = call i32 @getc(ptr noundef %20)
