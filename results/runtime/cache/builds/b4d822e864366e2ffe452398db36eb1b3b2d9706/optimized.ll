...
if.end17:                                         ; preds = %if.end17.gvnsink.split, %if.else9
  %i.1 = phi i32 [ %inc15, %if.end17.gvnsink.split ], [ %i.0, %if.else9 ]
...
for.cond:                                         ; preds = %for.inc, %while.end
  %i.2 = phi i32 [ 0, %while.end ], [ %inc22, %for.inc ]
  %cmp18 = icmp slt i32 %i.2, %i.0
...
for.inc:                                          ; preds = %for.cond
  ...
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %2)
