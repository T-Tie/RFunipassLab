...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  br i1 %cmp1.not, label %if.end18.loopexit, label %for.body
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc15
  %i.1 = phi i32 [ %inc16, %for.inc15 ], [ %n, %for.cond4.preheader ]
  %sum.3 = phi i32 [ %sum.4, %for.inc15 ], [ 1, %for.cond4.preheader ]
  %mul5 = mul nsw i32 %i.1, %i.1
  %cmp6.not = icmp sgt i32 %mul5, %m
  br i1 %cmp6.not, label %if.end18.loopexit23, label %for.body7
...
if.end18.loopexit23:                              ; preds = %for.cond4
  br label %if.end18

if.end18:                                         ; preds = %if.end18.loopexit23, %if.end18.loopexit
  %sum.2 = phi i32 [ %sum.0, %if.end18.loopexit ], [ %sum.3, %if.end18.loopexit23 ]
  ret i32 %sum.2
}
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc10
  %3 = phi i32 [ %.pre, %for.inc10 ], [ %0, %for.cond3.preheader ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc10 ], [ 0, %for.cond3.preheader ]
  %4 = sext i32 %3 to i64
