...
for.body27:                                       ; preds = %for.cond25
  ...
  %8 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %add30 = add nsw i32 %7, 1
  %idxprom31 = sext i32 %add30 to i64
  %arrayidx32 = getelementptr inbounds [500 x i32], ptr %js, i64 0, i64 %idxprom31
  %9 = load i32, ptr %arrayidx32, align 4, !tbaa !5, !invariant.load !12
...
for.body54:                                       ; preds = %for.cond52
  ...
  %11 = getelementptr inbounds [500 x i32], ptr %js, i64 0, i64 %idxprom57
  %12 = load i32, ptr %11, align 4, !tbaa !5, !invariant.load !12
  br i1 %cmp55, label %if.then56, label %if.else60

if.then56:                                        ; preds = %for.body54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %12) #5
  br label %for.inc65

if.else60:                                        ; preds = %for.body54
  %call63 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %12) #5
  br label %for.inc65

for.inc65:                                        ; preds = %if.then56, %if.else60
