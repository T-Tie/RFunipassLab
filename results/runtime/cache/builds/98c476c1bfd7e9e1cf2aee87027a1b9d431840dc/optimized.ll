...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre22, %for.body15 ]
  %indvars.iv19 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next20, %for.body15 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv19, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv19
  ...
  %.str.1.sink = select i1 %cmp19, ptr @.str, ptr %.str.1..str.2
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.1.sink)
