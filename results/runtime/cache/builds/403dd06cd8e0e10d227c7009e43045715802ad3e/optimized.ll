...
for.cond15:                                       ; preds = %for.inc191, %for.end14
  ...
  %.sink = phi i32 [ %1, %for.end14 ], [ %dec, %for.inc191 ]
...
if.then:                                          ; preds = %for.body26
  ...
  %3 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !13
  br label %for.inc41
...
if.else:                                          ; preds = %for.body26
  ...
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !13
...
for.inc53:                                        ; preds = %for.cond45
  ...
  %5 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !13
...
if.then70:                                        ; preds = %for.body68
  ...
  %6 = load i32, ptr %arrayidx74, align 4, !tbaa !5, !invariant.load !13
  br label %for.inc90
...
if.else75:                                        ; preds = %for.body68
  ...
  %7 = load i32, ptr %arrayidx79, align 4, !tbaa !5, !invariant.load !13
  %cmp80 = icmp sgt i32 %min.6, %7
...
for.inc90:                                        ; preds = %cond.false86, %if.else75, %if.then70
  %min.7 = phi i32 [ %6, %if.then70 ], [ %min.6, %cond.false86 ], [ %7, %if.else75 ]
...
for.inc103:                                       ; preds = %for.cond94
  ...
  %8 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !13
  %sub102 = sub nsw i32 %8, %min.6
...
for.end108:                                       ; preds = %for.cond60
  ...
  %9 = load i32, ptr %arrayidx110, align 4, !tbaa !5
  %add = add nsw i32 %s.0, %9
  br label %for.cond112

for.cond112:                                      ; preds = %for.inc132, %for.end108
  %i111.0 = phi i32 [ 0, %for.end108 ], [ %inc133, %for.inc132 ]
  %cmp113 = icmp slt i32 %i111.0, %.sink
...
for.cond117:                                      ; preds = %for.inc129, %for.body115
  ...
  %cmp118 = icmp slt i32 %j116.0, %.sink
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %10 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
...
for.cond136:                                      ; preds = %for.inc147, %for.end134
  ...
  %cmp137 = icmp slt i32 %i135.0, %.sink
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %11 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
...
for.cond151:                                      ; preds = %for.inc162, %for.end149
  ...
  %cmp152 = icmp slt i32 %i150.0, %.sink
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %12 = load i32, ptr %arrayidx157, align 4, !tbaa !5, !invariant.load !13
...
for.cond166:                                      ; preds = %for.inc188, %for.end164
  ...
  %cmp167 = icmp slt i32 %i165.0, %.sink
...
for.cond171:                                      ; preds = %for.inc185, %for.body169
  ...
  %cmp172 = icmp slt i32 %j170.0, %.sink
...
for.inc185:                                       ; preds = %for.cond171
  ...
  %13 = load i32, ptr %arrayidx178, align 4, !tbaa !5, !invariant.load !13
