...
while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv12 = phi i32 [ %indvars.iv.next13, %while.cond ], [ -1, %entry ]
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %exitcond.not = icmp eq i64 %indvars.iv4, 100
...
for.cond14.preheader:                             ; preds = %for.cond
  ...
  %0 = ashr exact i64 %sext15, 32
  %smax = call i32 @llvm.smax.i32(i32 %indvars.iv12, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax to i64
  br label %for.cond14

for.body:                                         ; preds = %for.cond
  %arrayidx5 = getelementptr inbounds [100 x [100 x i8]], ptr %a, i64 0, i64 %idxprom2, i64 %indvars.iv4
  %1 = load i8, ptr %arrayidx5, align 1, !tbaa !12
  %cmp6 = icmp eq i8 %1, 0
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv8 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next9, %for.inc25 ]
  %exitcond14.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond14.not, label %for.end27, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %3 = xor i64 %indvars.iv8, -1
  %4 = add nsw i64 %0, %3
