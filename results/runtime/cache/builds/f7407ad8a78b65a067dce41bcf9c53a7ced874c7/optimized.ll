...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %a) #7
  store double 0.000000e+00, ptr %a, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %b) #7
  store double 0.000000e+00, ptr %b, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %c) #7
...
if.then7:                                         ; preds = %if.then
  ...
  %call18 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %x1.0, double noundef %x2.0) #9
  br label %if.end42
...
if.else:                                          ; preds = %if.then
  ...
  %call25 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %x1.1) #9
  br label %if.end42
...
if.else27:                                        ; preds = %while.body
  ...
  %call41 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %x1.2, double noundef %x.0, double noundef %x1.2, double noundef %x.0) #9
  br label %if.end42
