; ModuleID = '<stdin>'
source_filename = "/tmp/tmpbphoepur.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 10100, ptr nonnull %word) #5
  br label %while.cond

while.cond:                                       ; preds = %while.cond, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.cond ], [ 0, %entry ]
  %arrayidx = getelementptr inbounds nuw [100 x [101 x i8]], ptr %word, i64 0, i64 %indvars.iv
  ...
  br i1 %cmp.i.not.i, label %while.cond, label %while.end, !llvm.loop !21

while.end:                                        ; preds = %while.cond
  %1 = trunc nuw nsw i64 %indvars.iv to i32
  %sub = add nsw i32 %1, -1
  %idxprom2 = sext i32 %sub to i64
  %arrayidx3 = getelementptr inbounds [100 x [101 x i8]], ptr %word, i64 0, i64 %idxprom2
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx3) #6
  %sub9 = add i64 %call8, -1
  %arrayidx10 = getelementptr inbounds [100 x [101 x i8]], ptr %word, i64 0, i64 %idxprom2, i64 %sub9
  store i8 0, ptr %arrayidx10, align 1, !tbaa !24
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %while.end
  %i.0 = phi i32 [ %sub, %while.end ], [ %dec, %for.inc ]
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 10100, ptr nonnull %word) #5
  ret i32 0

for.body:                                         ; preds = %for.cond
  %idxprom12 = zext nneg i32 %i.0 to i64
  %arrayidx13 = getelementptr inbounds nuw [100 x [101 x i8]], ptr %word, i64 0, i64 %idxprom12
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx13) #5
