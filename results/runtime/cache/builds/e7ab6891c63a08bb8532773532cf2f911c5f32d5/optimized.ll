...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %n) #14
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 81000, ptr noundef nonnull align 16 %newword) #14
  call void @llvm.memset.p0.i64(ptr noundef nonnull writeonly align 16 dereferenceable(81000) %newword, i8 noundef 0, i64 noundef 81000, i1 noundef false) #15
...
if.then6.i:                                       ; preds = %for.body
  ...
  %call16.i = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #16
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #16
...
for.cond2:                                        ; preds = %for.cond, %if.end73
  %4 = phi i32 [ %.pre, %if.end73 ], [ %0, %for.cond ]
  %indvars.iv60 = phi i64 [ %indvars.iv.next61, %if.end73 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %if.end73 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %if.end73 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv60, %5
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv60
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx6) #17
...
if.then:                                          ; preds = %for.body4
  ...
  %call25 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx20, ptr noundef nonnull dereferenceable(1) %arrayidx6) #16
  ...
  store i8 32, ptr %arrayidx29, align 1, !tbaa !21
...
if.then33:                                        ; preds = %if.else
  ...
  %call40 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx35, ptr noundef nonnull dereferenceable(1) %arrayidx6) #16
...
if.then44:                                        ; preds = %if.else42
  %call51 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #16
  store i8 32, ptr %arrayidx56, align 1, !tbaa !21
  br label %if.end73

if.else58:                                        ; preds = %if.else42
  %call65 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %arrayidx46, ptr noundef nonnull dereferenceable(1) %arrayidx6) #16
  store i8 32, ptr %arrayidx56, align 1, !tbaa !21
  br label %if.end73
...
for.end76:                                        ; preds = %for.cond2
  ...
  store i8 0, ptr %arrayidx81, align 1, !tbaa !21
  %idxprom84 = sext i32 %j.0 to i64
  %arrayidx85 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom77, i64 %idxprom84
  store i8 0, ptr %arrayidx85, align 1, !tbaa !21
  %smax70 = call i32 @llvm.smax.i32(i32 noundef %k.0, i32 noundef -1)
  %6 = add i32 %smax70, 1
  %wide.trip.count71 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.end115, %for.end76
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.end115 ], [ 0, %for.end76 ]
  %exitcond72 = icmp eq i64 %indvars.iv66, %wide.trip.count71
  br i1 %exitcond72, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv66
  %call92 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx90) #17
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv66, i64 %7
  br label %for.cond94

for.cond94:                                       ; preds = %if.end112, %for.body88
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %if.end112 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv63, %wide.trip.count
  br i1 %exitcond.not, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv63, %7
  br i1 %cmp98, label %if.then99, label %if.else106

if.then99:                                        ; preds = %for.body96
  %8 = load i8, ptr %arrayidx103, align 1, !tbaa !21, !invariant.load !9
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv66, i64 %indvars.iv63
  %9 = load i8, ptr %arrayidx110, align 1, !tbaa !21, !invariant.load !9
...
for.end118:                                       ; preds = %for.cond86
  call void @llvm.lifetime.end.p0(i64 noundef 81000, ptr noundef nonnull %newword) #16
  call void @llvm.lifetime.end.p0(i64 noundef 41000, ptr noundef nonnull %word) #16
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %n) #16
  ret i32 0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !21, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !22, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !21, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !29, !invariant.load !9
...
attributes #14 = { nofree nounwind willreturn }
...
!21 = !{!7, !7, i64 0}
!22 = !{!23, !7, i64 56}
!23 = !{!"_ZTSSt5ctypeIcE", !24, i64 0, !25, i64 16, !26, i64 24, !27, i64 32, !27, i64 40, !28, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!24 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!25 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!26 = !{!"bool", !7, i64 0}
!27 = !{!"p1 int", !16, i64 0}
