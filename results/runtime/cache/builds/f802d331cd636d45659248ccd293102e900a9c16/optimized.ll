...
for.inc74.gvnsink.split:                          ; preds = %if.then, %if.then44, %if.else58
  ...
  %add.sink13 = phi i32 [ %add, %if.else58 ], [ %add, %if.then44 ], [ %conv, %if.then ]
  ...
  %idxprom69 = sext i32 %add.sink13 to i64
...
for.body88:                                       ; preds = %for.cond86
  ...
  %call92 = call i64 @strlen(ptr noundef readonly captures(none) %arrayidx90) #15
...
if.then99:                                        ; preds = %for.body96
  ...
  %1 = load i8, ptr %arrayidx103, align 1, !tbaa !12, !invariant.load !14
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %1)
...
if.else106:                                       ; preds = %for.body96
  ...
  %2 = load i8, ptr %arrayidx110, align 1, !tbaa !12, !invariant.load !14
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %2)
  br label %for.inc113
...
; Function Attrs: mustprogress nounwind uwtable
declare noundef i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(ptr noundef nonnull align 8 dereferenceable(264)) local_unnamed_addr #9 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE4gptrEv(ptr noundef nonnull align 8 dereferenceable(64)) local_unnamed_addr #9 align 2

; Function Attrs: mustprogress nounwind uwtable
declare noundef ptr @_ZNKSt15basic_streambufIcSt11char_traitsIcEE5egptrEv(ptr noundef nonnull align 8 dereferenceable(64)) local_unnamed_addr #9 align 2
...
; Function Attrs: mustprogress uwtable
declare noundef signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(ptr noundef nonnull align 8 dereferenceable(264), i8 noundef signext) local_unnamed_addr #7 align 2
