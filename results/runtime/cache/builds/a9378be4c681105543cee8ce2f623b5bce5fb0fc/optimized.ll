...
for.inc31:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_2(ptr noundef nonnull %add.ptr27)
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i)
  call fastcc void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) %__c.addr.i)
...
for.end33:                                        ; preds = %for.cond23
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef %gep101)
...
for.inc54:                                        ; preds = %for.cond45
  ...
  call fastcc void @outlined_ir_func_2(ptr noundef nonnull %add.ptr50)
  call void @llvm.lifetime.start.p0(i64 noundef 1, ptr noundef nonnull captures(none) dereferenceable(1) %__c.addr.i34)
  call fastcc void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) %__c.addr.i34)
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #8 {
for.end33_after_outline.exitStub:
  %call.i.i15 = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #12
...
; Function Attrs: minsize mustprogress norecurse optsize uwtable
define internal fastcc void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(1) %0) unnamed_addr #8 {
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_to_outline:
  store i8 32, ptr %0, align 1, !tbaa !39
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit_after_outline.exitStub:
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %0) #12
...
attributes #12 = { nofree nosync nounwind willreturn memory(read) }
