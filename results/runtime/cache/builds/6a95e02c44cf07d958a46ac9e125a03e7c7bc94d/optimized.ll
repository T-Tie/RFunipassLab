...
for.cond28.preheader:                             ; preds = %for.cond21
  %indvars = trunc i64 %indvars.iv.next33 to i32
  %smax40 = call i32 @llvm.smax.i32(i32 %indvars, i32 noundef 0)
...
for.end41:                                        ; preds = %for.cond28
  %arrayidx23.le = getelementptr inbounds [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next33
