...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc27
  %indvars.iv6 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc27 ]
  %exitcond16 = icmp eq i64 %indvars.iv6, %wide.trip.count15
  br i1 %exitcond16, label %for.cond30, label %for.body4

for.body4:                                        ; preds = %for.cond2
  %4 = add nsw i64 %indvars.iv6, -1
...
for.cond9:                                        ; preds = %for.body4, %for.inc24
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc24 ], [ %indvars.iv6, %for.body4 ]
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %exitcond.not = icmp eq i64 %indvars.iv8, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body11

for.body11:                                       ; preds = %for.cond9
  %arrayidx14 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv8
...
for.cond30:                                       ; preds = %for.cond2, %for.inc53
  %.pre20 = phi i32 [ %.pre, %for.inc53 ], [ %0, %for.cond2 ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc53 ], [ 0, %for.cond2 ]
  %b.0 = phi i32 [ %b.1, %for.inc53 ], [ 0, %for.cond2 ]
  %8 = sext i32 %.pre20 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv17, %8
  br i1 %cmp32.not.not, label %for.body33, label %for.end55

for.body33:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv17
...
land.lhs.true:                                    ; preds = %for.body33
  ...
  %call51 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %9) #8
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc53

for.inc53:                                        ; preds = %land.lhs.true, %for.body33
  %.pre = phi i32 [ %.pre20, %for.body33 ], [ %.pre.pre, %land.lhs.true ]
  %b.1 = phi i32 [ %b.0, %for.body33 ], [ 1, %land.lhs.true ]
