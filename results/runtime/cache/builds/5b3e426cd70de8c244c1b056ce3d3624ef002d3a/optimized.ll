...
cleanup:                                          ; preds = %if.end7, %if.then6
  %phiofops = phi i1 [ true, %if.end7 ], [ false, %if.then6 ]
  %__parent.1 = phi i64 [ 0, %if.then6 ], [ %dec, %if.end7 ]
  %cleanup.dest.slot.0 = phi i32 [ 1, %if.then6 ], [ 0, %if.end7 ]
  br i1 %phiofops, label %cleanup.cont, label %cleanup8
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %__value.sink = phi i32 [ %__value, %entry ], [ %1, %while.body ]
