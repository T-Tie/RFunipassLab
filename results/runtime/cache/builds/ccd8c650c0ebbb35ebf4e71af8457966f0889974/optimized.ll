...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.body7
  ...
  %cmp6 = icmp slt i64 %indvars.iv.next10, %1
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next10
  %5 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %cmp12 = icmp sgt i32 %5, %4
  %6 = trunc nuw nsw i64 %indvars.iv.next10 to i32
