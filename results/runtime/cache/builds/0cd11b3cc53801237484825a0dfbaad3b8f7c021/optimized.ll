...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %max) #5
...
if.then24:                                        ; preds = %if.then20
  store i32 %add, ptr %max, align 4, !tbaa !5
  br label %if.end
...
if.end26:                                         ; preds = %if.end25, %for.body9
  br label %for.inc27
...
for.end31:                                        ; preds = %for.cond4
  ...
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %10)
