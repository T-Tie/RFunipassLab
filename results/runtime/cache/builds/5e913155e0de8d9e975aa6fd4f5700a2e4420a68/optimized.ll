...
for.cond:                                         ; preds = %for.cond1, %entry
  ...
  %indvars.iv16 = phi i64 [ 0, %entry ], [ %indvars.iv.next17, %for.cond1 ]
...
for.cond1.preheader:                              ; preds = %for.cond
  ...
  %2 = trunc nuw i64 %indvars.iv.next17 to i32
  %3 = trunc i64 %indvars.iv16 to i32
  %4 = add i32 %3, -1
  br label %for.cond1

for.cond1:                                        ; preds = %for.cond1.preheader, %for.body3
  %5 = phi i32 [ %0, %for.cond1.preheader ], [ %.pre20, %for.body3 ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body3 ]
  %star1.1 = phi i32 [ %star1.0, %for.cond1.preheader ], [ %star1.2, %for.body3 ]
  %star2.1 = phi i32 [ %star2.0, %for.cond1.preheader ], [ %star2.2, %for.body3 ]
  %end1.1 = phi i32 [ %end1.0, %for.cond1.preheader ], [ %end1.2, %for.body3 ]
  %end2.1 = phi i32 [ %end2.0, %for.cond1.preheader ], [ %end2.2, %for.body3 ]
  %f.1 = phi i32 [ %f.0, %for.cond1.preheader ], [ %f.2, %for.body3 ]
  %6 = sext i32 %5 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %star1.2 = select i1 %or.cond, i32 %2, i32 %star1.1
  %8 = trunc nuw i64 %indvars.iv.next to i32
  %star2.2 = select i1 %or.cond, i32 %8, i32 %star2.1
  %f.2 = select i1 %or.cond, i32 1, i32 %f.1
  %end1.2 = select i1 %cmp11, i32 %4, i32 %end1.1
  %9 = trunc i64 %indvars.iv to i32
  %10 = add i32 %9, -1
  %end2.2 = select i1 %cmp11, i32 %10, i32 %end2.1
...
for.end24:                                        ; preds = %for.cond
  ...
  %reass.sub13 = sub i32 %end2.0, %star2.0
  %add28 = add i32 %reass.sub13, 1
