...
for.inc106:                                       ; preds = %for.body93, %if.else
  ...
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !17
  %call105 = call i32 (ptr, ...) @printf(ptr noundef %.str.3.sink, i32 noundef %12) #7
