...
for.inc:                                          ; preds = %for.cond
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERf(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
  ...
  %6 = load float, ptr %arrayidx5, align 4, !tbaa !9, !invariant.load !11
  %7 = load float, ptr %arrayidx, align 4, !tbaa !9, !invariant.load !11
  %div = fdiv float %6, %7
...
for.body15:                                       ; preds = %for.cond13
  ...
  %9 = load float, ptr %arrayidx17, align 4, !tbaa !9, !invariant.load !11
...
if.then:                                          ; preds = %for.body15
  %call20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(7) @.str)
  br label %for.inc35
...
if.then28:                                        ; preds = %if.else
  %call29 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str.1)
  br label %for.inc35

if.else31:                                        ; preds = %if.else
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str.2)
  br label %for.inc35

for.inc35:                                        ; preds = %if.then, %if.else31, %if.then28
  %call32.sink = phi ptr [ %call32, %if.else31 ], [ %call29, %if.then28 ], [ %call20, %if.then ]
  %call33 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call32.sink, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !16, !invariant.load !11
...
entry:
  %vtable = load ptr, ptr %__os, align 8, !tbaa !16, !invariant.load !11
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !11
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !18, !invariant.load !11
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !29, !invariant.load !11
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !37, !invariant.load !11
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !43, !invariant.load !11
  br label %return

if.end:                                           ; preds = %entry
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !16, !invariant.load !11
