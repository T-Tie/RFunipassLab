...
if.then6.i:                                       ; preds = %for.inc
  ...
  %gep16 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt3cin, i64 16), i64 %vbase.offset9.i
  %3 = load i64, ptr %gep16, align 8, !tbaa !12
...
while.cond9:                                      ; preds = %while.cond9.preheader, %if.end34
  %7 = phi i32 [ %5, %while.cond9.preheader ], [ %.pre21, %if.end34 ]
  %8 = phi i32 [ %.pre, %while.cond9.preheader ], [ %10, %if.end34 ]
  %indvars.iv18 = phi i64 [ %6, %while.cond9.preheader ], [ %indvars.iv.next19, %if.end34 ]
  %num.1 = phi i32 [ %num.0, %while.cond9.preheader ], [ %num.2, %if.end34 ]
  %add = add nsw i32 %8, %num.1
  %cmp12 = icmp slt i32 %add, 81
  %9 = sext i32 %7 to i64
  %cmp17.not = icmp slt i64 %indvars.iv18, %9
...
if.end19:                                         ; preds = %while.cond9
  ...
  %cmp29 = icmp slt i64 %indvars.iv.next19, %12
