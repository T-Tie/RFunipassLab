...
for.end23:                                        ; preds = %if.then, %for.cond13
  %x1.2 = phi i32 [ %j.1, %if.then ], [ 0, %for.cond13 ]
  %y1.2 = phi i32 [ %i.1, %if.then ], [ %y1.0, %for.cond13 ]
...
for.end29:                                        ; preds = %if.then25, %for.cond10
  %x1.1 = phi i32 [ %x1.2, %if.then25 ], [ 0, %for.cond10 ]
  %y1.1 = phi i32 [ %y1.2, %if.then25 ], [ %y1.0, %for.cond10 ]
  br label %for.cond30
...
for.end44:                                        ; preds = %if.then41, %for.cond33
  %phiofops = phi i1 [ false, %for.cond33 ], [ true, %if.then41 ]
  %x2.2 = phi i32 [ %j.2, %if.then41 ], [ 0, %for.cond33 ]
  %y2.2 = phi i32 [ %i.2, %if.then41 ], [ %y2.0, %for.cond33 ]
  br i1 %phiofops, label %if.then46, label %if.end47
...
for.end50:                                        ; preds = %if.then46, %for.cond30
  %x2.1 = phi i32 [ %x2.2, %if.then46 ], [ 0, %for.cond30 ]
  %y2.1 = phi i32 [ %y2.2, %if.then46 ], [ %y2.0, %for.cond30 ]
