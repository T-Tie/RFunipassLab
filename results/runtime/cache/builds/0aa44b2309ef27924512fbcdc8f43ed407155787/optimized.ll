...
for.end:                                          ; preds = %for.cond2
  ...
  br i1 %tobool.not, label %for.inc29, label %for.cond17.preheader

for.cond17.preheader:                             ; preds = %for.end
  br label %for.cond17

for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc25
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc25 ], [ 0, %for.cond17.preheader ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc29.loopexit, label %for.inc25
...
for.end:                                          ; preds = %for.cond1
  %tobool.not = icmp eq i32 %min.0, 0
  br i1 %tobool.not, label %for.inc28, label %for.cond16.preheader

for.cond16.preheader:                             ; preds = %for.end
  br label %for.cond16

for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc24 ], [ 0, %for.cond16.preheader ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc28.loopexit, label %for.inc24
...
for.cond:                                         ; preds = %for.inc10, %while.body
  ...
  br i1 %cmp, label %for.cond3.preheader, label %for.cond13.preheader
...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc
  %.pre1315 = phi i32 [ %.pre1314, %for.inc ], [ %.pre13, %for.cond3.preheader ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc17
  %storemerge = phi i32 [ %dec, %for.inc17 ], [ %.pre13, %for.cond13.preheader ]
