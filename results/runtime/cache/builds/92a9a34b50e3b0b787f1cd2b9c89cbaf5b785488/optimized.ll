...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc47
  %indvars.iv10 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next11, %for.inc47 ]
  %exitcond20.not = icmp eq i64 %indvars.iv10, %wide.trip.count19
  br i1 %exitcond20.not, label %for.cond51, label %for.cond28.preheader

for.cond28.preheader:                             ; preds = %for.cond21
  %arrayidx34 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv10
  %arrayidx42 = getelementptr inbounds nuw [550 x i32], ptr %num, i64 0, i64 %indvars.iv10
  br label %for.cond28

for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc44
  %indvars.iv12 = phi i64 [ %indvars.iv10, %for.cond28.preheader ], [ %indvars.iv.next13, %for.inc44 ]
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond16.not = icmp eq i64 %indvars.iv12, %wide.trip.count15
  br i1 %exitcond16.not, label %for.inc47, label %for.body32

for.body32:                                       ; preds = %for.cond28
  %arrayidx37 = getelementptr inbounds nuw [550 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next13
...
for.cond73:                                       ; preds = %for.inc88, %if.else
  ...
  %cmp75 = icmp slt i64 %indvars.iv26, %7
