...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit76: ; preds = %if.then6.i48, %if.then19.i64, %if.then28.i71
  %call6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %a) #9
  %conv = trunc i64 %call6 to i32
  %call8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %b) #10
  %conv9 = trunc i64 %call8 to i32
  %12 = load i8, ptr %b, align 16
  %smax = call i32 @llvm.smax.i32(i32 %conv9, i32 1)
  %smax145 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.body:                                         ; preds = %for.cond
  ...
  %13 = load i8, ptr %arrayidx, align 1, !tbaa !30
...
for.body16:                                       ; preds = %for.cond14
  ...
  %14 = load i8, ptr %arrayidx18, align 1, !tbaa !30
  %arrayidx21 = getelementptr inbounds nuw [256 x i8], ptr %b, i64 0, i64 %indvars.iv139
  %15 = load i8, ptr %arrayidx21, align 1, !tbaa !30
...
for.body39:                                       ; preds = %for.cond37
  ...
  %17 = load i8, ptr %arrayidx41, align 1, !tbaa !30
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i)
  store i8 %17, ptr %__c.addr.i, align 1, !tbaa !30
...
for.end45:                                        ; preds = %for.cond37
  %call.i.i89 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %c) #9
...
for.body50:                                       ; preds = %for.cond48
  ...
  %21 = load i8, ptr %arrayidx52, align 1, !tbaa !30
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %__c.addr.i97)
  store i8 %21, ptr %__c.addr.i97, align 1, !tbaa !30
  ...
  %22 = load i64, ptr %gep135, align 8, !tbaa !8
...
if.end57:                                         ; preds = %for.cond48, %if.then34
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %c) #9
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %a) #9
  ret i32 0
}
