...
entry:
  %call = call i64 @strlen(ptr noundef readonly %word) #8
  %conv = trunc i64 %call to i32
  br label %for.cond

for.cond:                                         ; preds = %if.end19, %entry
  %len.0 = phi i32 [ %conv, %entry ], [ %len.1.lcssa, %if.end19 ]
  %i.0 = phi i32 [ 0, %entry ], [ %i.1.lcssa, %if.end19 ]
...
if.end10:                                         ; preds = %if.end
  ...
  %call14 = call i64 @strlen(ptr nofree noundef %arrayidx12) #9
...
if.end19:                                         ; preds = %while.cond
  %len.1.lcssa = phi i32 [ %len.1, %while.cond ]
...
for.end:                                          ; preds = %for.cond
  ...
  call void @_Z12compose_wordPA25_ci(ptr noundef nonnull align 16 dereferenceable(25000) %word, i32 noundef %.lcssa)
