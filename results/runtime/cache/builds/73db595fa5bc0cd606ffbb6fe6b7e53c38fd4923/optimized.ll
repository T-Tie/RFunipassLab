...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv17 = phi i32 [ %indvars.iv.next18, %for.inc18 ], [ 0, %entry ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc18 ], [ 0, %entry ]
  %call4 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %input) #9
  %sub = sub i64 %call4, %conv5
  %cmp.not = icmp ult i64 %sub, %indvars.iv9
...
for.inc:                                          ; preds = %for.cond6
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv9
  ...
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv9, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !11

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv9, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv14 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next15, %for.inc26 ]
...
for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv14
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  br label %for.cond21, !llvm.loop !15

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond32.not = icmp eq i64 %indvars.iv21, %wide.trip.count19
  br i1 %exitcond32.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv21
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv21
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv23 = phi i64 [ %indvars.iv21, %for.cond32.preheader ], [ %indvars.iv.next24, %for.inc51 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count19
  br i1 %exitcond28.not, label %for.inc54, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv23
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv23
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond38.not = icmp eq i64 %indvars.iv33, %wide.trip.count19
  br i1 %exitcond38.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv33
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc89 ], [ 0, %if.else ]
  %exitcond44.not = icmp eq i64 %indvars.iv39, %wide.trip.count19
  br i1 %exitcond44.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv39
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv39
