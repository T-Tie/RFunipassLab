...
for.cond10:                                       ; preds = %for.cond13, %for.cond10.preheader
  %indvars.iv26 = phi i64 [ %3, %for.cond10.preheader ], [ %indvars.iv.next27, %for.cond13 ]
  %indvars.iv20 = phi i64 [ %2, %for.cond10.preheader ], [ %indvars.iv.next21, %for.cond13 ]
  %indvars.iv.next27 = add nsw i64 %indvars.iv26, -1
  %indvars.iv.next21 = add nsw i64 %indvars.iv20, -1
  %cmp11 = icmp sgt i64 %indvars.iv26, 0
  br i1 %cmp11, label %for.cond13.preheader, label %for.end35

for.cond13.preheader:                             ; preds = %for.cond10
  %arrayidx17 = getelementptr inbounds [25 x i32], ptr %m, i64 0, i64 %indvars.iv.next27
  %arrayidx22 = getelementptr inbounds [25 x i32], ptr %d, i64 0, i64 %indvars.iv.next27
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc31
  %indvars.iv22 = phi i64 [ %indvars.iv20, %for.cond13.preheader ], [ %indvars.iv.next23, %for.inc31 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx19 = getelementptr inbounds nuw [25 x i32], ptr %m, i64 0, i64 %indvars.iv22
...
land.lhs.true:                                    ; preds = %for.body15
  ...
  %arrayidx24 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv22
...
for.cond37:                                       ; preds = %for.body39, %for.end35
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.body39 ], [ 0, %for.end35 ]
  %dm.0 = phi i32 [ %spec.select, %for.body39 ], [ %9, %for.end35 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond33.not, label %for.end49, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds nuw [25 x i32], ptr %d, i64 0, i64 %indvars.iv29
