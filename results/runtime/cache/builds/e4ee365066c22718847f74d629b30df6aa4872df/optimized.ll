...
for.cond118:                                      ; preds = %for.inc198, %for.end117
  %12 = phi i32 [ %inc199, %for.inc198 ], [ 0, %for.end117 ]
  %cmp119 = icmp slt i32 %12, %M.0
  br i1 %cmp119, label %for.body120, label %for.end200

for.body120:                                      ; preds = %for.cond118
  %idxprom121 = sext i32 %12 to i64
  %arrayidx122 = getelementptr inbounds [100 x i32], ptr %d, i64 0, i64 %idxprom121
  %13 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %cmp123 = icmp ne i32 %13, %m.0
...
if.else131:                                       ; preds = %land.lhs.true127, %land.lhs.true, %if.then124
  ...
  %14 = load i32, ptr %arrayidx133, align 16, !tbaa !5
  %call135 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %14) #5
  br label %if.end136
