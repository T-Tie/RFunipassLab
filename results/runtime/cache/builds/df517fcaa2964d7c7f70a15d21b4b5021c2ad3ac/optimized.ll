...
sw.epilog.sink.split:                             ; preds = %entry, %sw.bb12, %sw.bb19, %sw.bb26, %sw.bb33, %sw.bb40, %sw.bb47, %sw.bb54, %sw.bb61, %sw.bb68
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call73, ptr nofree noundef writeonly null, i32 noundef -1)
  br label %sw.epilog
...
if.then:                                          ; preds = %sw.epilog
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull %call.i.i251.loc)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call81.sink282, ptr nofree noundef writeonly null, i32 noundef -1)
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0, ptr noalias nofree noundef writeonly align 8 captures(none) %1, i32 noundef %2) unnamed_addr #5 {
