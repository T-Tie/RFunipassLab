...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %num) #3
...
for.end17:                                        ; preds = %for.cond
  %4 = load i32, ptr %num, align 16, !tbaa !5
  %call19 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i32 noundef %4)
  br label %for.cond20
...
for.cond20:                                       ; preds = %for.inc32, %for.end17
  ...
  %6 = sext i32 %5 to i64
  %cmp21 = icmp slt i64 %indvars.iv17, %6
...
if.then26:                                        ; preds = %for.body22
  ...
  %call30 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %7)
  br label %for.inc32
...
for.end34:                                        ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull %num) #4
