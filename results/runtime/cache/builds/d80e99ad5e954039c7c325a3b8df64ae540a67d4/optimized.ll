...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv27 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next28, %for.inc19 ]
...
for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond37.not = icmp eq i64 %indvars.iv31, %wide.trip.count36
  br i1 %exitcond37.not, label %for.inc49, label %for.body27
...
for.body54:                                       ; preds = %for.cond52
  ...
  %spec.select25 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %arrayidx62 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv40
  %11 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !12
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %spec.select25, i32 noundef %11)
