...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 301, ptr nonnull %str) #3
...
if.else:                                          ; preds = %land.lhs.true
  ...
  %spec.select25 = add nsw i32 %inc19, %a.0
  br label %for.inc

for.inc:                                          ; preds = %if.else, %for.body, %if.then
  %a.1 = phi i32 [ %inc, %if.then ], [ %a.0, %for.body ], [ %spec.select25, %if.else ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv27
...
for.cond54:                                       ; preds = %for.cond26, %for.inc80
  ...
  %exitcond33.not = icmp eq i32 %i.2, 123
  br i1 %exitcond33.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select24, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv30
...
for.body62:                                       ; preds = %for.cond57
  ...
  %spec.select24 = add nuw nsw i32 %inc68, %l.1
...
if.end83:                                         ; preds = %for.cond54, %if.then23
  call void @llvm.lifetime.end.p0(i64 301, ptr nonnull %str) #3
  ret i32 0
}
