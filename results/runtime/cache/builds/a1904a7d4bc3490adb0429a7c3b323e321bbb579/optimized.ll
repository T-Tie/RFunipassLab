...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax16 = call i32 @llvm.smax.i32(i32 %len.0, i32 0)
  %wide.trip.count17 = zext nneg i32 %smax16 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv7
...
if.then9:                                         ; preds = %if.end
  %3 = trunc nuw nsw i64 %indvars.iv7 to i32
  %sub10 = sub i32 %sub, %3
  %idxprom11 = sext i32 %sub10 to i64
  %arrayidx12 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %idxprom11
  store i8 32, ptr %arrayidx12, align 1, !tbaa !5
  %sub14 = sub nsw i32 %3, %inc
  %add.neg = xor i32 %sub14, -1
  %sub19 = add i32 %sub, %add.neg
  %4 = trunc i64 %indvars.iv7 to i32
  %5 = add i32 %4, 1
  %invariant.op3 = add i32 %5, %sub14
  %add24.reass = sub i32 %invariant.op3, %conv
  %6 = sext i32 %sub19 to i64
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc ], [ %0, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv4, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %7 = trunc nsw i64 %indvars.iv4 to i32
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv4
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv11 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next12, %for.inc44 ]
  %exitcond18.not = icmp eq i64 %indvars.iv11, %wide.trip.count17
  br i1 %exitcond18.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv11, %1
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv11
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  br label %for.cond35, !llvm.loop !12

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond23.not = icmp eq i64 %indvars.iv19, %wide.trip.count
  br i1 %exitcond23.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv19
