...
for.cond:                                         ; preds = %for.inc8, %entry
  %indvars.iv77 = phi i64 [ %indvars.iv.next78, %for.inc8 ], [ 1, %entry ]
  %0 = load i32, ptr %x1, align 4, !tbaa !5
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv77, %1
  br i1 %cmp.not, label %for.end10, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %2 = add nsw i64 %indvars.iv77, -1
  br label %for.cond1
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc46
  %indvars.iv92 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next93, %for.inc46 ]
  %exitcond97.not = icmp eq i64 %indvars.iv92, %wide.trip.count96
  br i1 %exitcond97.not, label %for.cond49.preheader, label %for.cond35

for.cond49.preheader:                             ; preds = %for.cond31
  %14 = load i32, ptr %y1, align 4
  %smax101 = call i32 @llvm.smax.i32(i32 %14, i32 noundef 0)
...
for.cond35:                                       ; preds = %for.cond31, %for.inc43
  %indvars.iv89 = phi i64 [ %indvars.iv.next90, %for.inc43 ], [ 0, %for.cond31 ]
...
for.inc43:                                        ; preds = %for.cond35
  %arrayidx42 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv92, i64 %indvars.iv89
...
for.cond49:                                       ; preds = %for.cond49.preheader, %for.inc79
  %indvars.iv110 = phi i64 [ 0, %for.cond49.preheader ], [ %indvars.iv.next111, %for.inc79 ]
  %exitcond114.not = icmp eq i64 %indvars.iv110, %wide.trip.count96
  br i1 %exitcond114.not, label %for.cond82, label %for.cond53

for.cond53:                                       ; preds = %for.cond49, %for.inc76
  %indvars.iv104 = phi i64 [ %indvars.iv.next105, %for.inc76 ], [ 0, %for.cond49 ]
  %exitcond109.not = icmp eq i64 %indvars.iv104, %wide.trip.count108
  br i1 %exitcond109.not, label %for.inc79, label %for.cond57.preheader

for.cond57.preheader:                             ; preds = %for.cond53
  %arrayidx72 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %c, i64 0, i64 %indvars.iv110, i64 %indvars.iv104
  br label %for.cond57

for.cond57:                                       ; preds = %for.cond57.preheader, %for.inc73
  %indvars.iv98 = phi i64 [ 0, %for.cond57.preheader ], [ %indvars.iv.next99, %for.inc73 ]
  %exitcond103.not = icmp eq i64 %indvars.iv98, %wide.trip.count102
  br i1 %exitcond103.not, label %for.inc76, label %for.inc73

for.inc73:                                        ; preds = %for.cond57
  %arrayidx64 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv110, i64 %indvars.iv98
  %15 = load i32, ptr %arrayidx64, align 4, !tbaa !5
  %arrayidx68 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv98, i64 %indvars.iv104
  %16 = load i32, ptr %arrayidx68, align 4, !tbaa !5
  %mul = mul nsw i32 %16, %15
  %17 = load i32, ptr %arrayidx72, align 4, !tbaa !5
...
for.cond82:                                       ; preds = %for.cond49, %for.inc106
  ...
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %for.inc106 ], [ 1, %for.cond49 ]
  %20 = sext i32 %19 to i64
  %cmp83.not = icmp sgt i64 %indvars.iv119, %20
  br i1 %cmp83.not, label %for.end108, label %for.cond85.preheader

for.cond85.preheader:                             ; preds = %for.cond82
  %21 = add nsw i64 %indvars.iv119, -1
  br label %for.cond85

for.cond85:                                       ; preds = %for.cond85.preheader, %for.body87
  %22 = phi i32 [ %18, %for.cond85.preheader ], [ %.pre123, %for.body87 ]
  %indvars.iv115 = phi i64 [ 1, %for.cond85.preheader ], [ %indvars.iv.next116, %for.body87 ]
  %23 = sext i32 %22 to i64
  %cmp86.not = icmp sgt i64 %indvars.iv115, %23
  br i1 %cmp86.not, label %for.inc106, label %for.body87

for.body87:                                       ; preds = %for.cond85
  %24 = zext i32 %22 to i64
  %cmp88.not = icmp eq i64 %indvars.iv115, %24
  %25 = add nsw i64 %indvars.iv115, -1
  ...
  %call95 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3..str.2, i32 noundef %27) #6
  %indvars.iv.next116 = add nuw nsw i64 %indvars.iv115, 1
  %.pre123 = load i32, ptr %y2, align 4, !tbaa !5
