...
if.end.thread:                                    ; preds = %while.body
  ...
  %cmp84 = icmp sle i32 %add7, 80
  br i1 %cmp84, label %if.else14, label %if.then25
...
if.end19:                                         ; preds = %if.else14, %if.end
  %add7.sink69 = phi i32 [ %add7, %if.else14 ], [ %add, %if.end ]
  ...
  %cmp20 = icmp eq i32 %add7.sink69, 80
...
if.end29:                                         ; preds = %if.end19, %if.end23.thread, %if.then25
  ...
  %sum.1 = phi i32 [ 0, %if.end23.thread ], [ %conv, %if.then25 ], [ %add7.sink69, %if.end19 ]
