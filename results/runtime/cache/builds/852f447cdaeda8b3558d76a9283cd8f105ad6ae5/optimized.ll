...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc39
  %indvars.iv3 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next4, %for.inc39 ]
  %w.0 = phi i32 [ undef, %for.cond4.preheader ], [ %w.1, %for.inc39 ]
  %exitcond14.not = icmp eq i64 %indvars.iv3, %wide.trip.count
  br i1 %exitcond14.not, label %for.cond42, label %for.cond7.preheader

for.cond7.preheader:                              ; preds = %for.cond4
  %2 = add nsw i64 %indvars.iv3, %1
  %arrayidx29 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv3
  %3 = trunc nuw nsw i64 %indvars.iv3 to i32
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.inc36
  %i.1.sink = phi i32 [ %j.2, %for.inc36 ], [ %3, %for.cond7.preheader ]
  %w.1 = phi i32 [ %w.2, %for.inc36 ], [ %w.0, %for.cond7.preheader ]
  %add = add nsw i32 %i.1.sink, 1
  %cmp8 = icmp slt i32 %add, %conv
  br i1 %cmp8, label %for.cond10.preheader, label %for.inc39

for.cond10.preheader:                             ; preds = %for.cond7
  %4 = sext i32 %i.1.sink to i64
  br label %for.cond10

for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc23
  %indvars.iv7.in = phi i64 [ %4, %for.cond10.preheader ], [ %indvars.iv7, %for.inc23 ]
  %indvars.iv5 = phi i64 [ %indvars.iv3, %for.cond10.preheader ], [ %indvars.iv.next6, %for.inc23 ]
  %flag.0 = phi i32 [ 0, %for.cond10.preheader ], [ %inc21, %for.inc23 ]
  %indvars.iv7 = add nsw i64 %indvars.iv7.in, 1
  %cmp12 = icmp slt i64 %indvars.iv5, %2
  br i1 %cmp12, label %for.body13, label %for.end25

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv5
  %5 = load i8, ptr %arrayidx15, align 1, !tbaa !12
  %arrayidx18 = getelementptr inbounds [1000 x i8], ptr %a, i64 0, i64 %indvars.iv7
  %6 = load i8, ptr %arrayidx18, align 1, !tbaa !12
...
for.cond42:                                       ; preds = %for.cond4, %for.body44
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.body44 ], [ 0, %for.cond4 ]
  %max.0 = phi i32 [ %spec.select, %for.body44 ], [ 0, %for.cond4 ]
  %exitcond18.not = icmp eq i64 %indvars.iv15, 1000
  br i1 %exitcond18.not, label %for.end54, label %for.body44

for.body44:                                       ; preds = %for.cond42
  %arrayidx46 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv15
...
for.cond60:                                       ; preds = %for.inc80, %if.else58
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc80 ], [ 0, %if.else58 ]
  %exitcond25.not = icmp eq i64 %indvars.iv19, 1000
  br i1 %exitcond25.not, label %if.end83, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [1000 x i32], ptr %b, i64 0, i64 %indvars.iv19
...
for.cond67:                                       ; preds = %for.cond67.preheader, %for.inc75
  %indvars.iv21 = phi i64 [ %indvars.iv19, %for.cond67.preheader ], [ %indvars.iv.next22, %for.inc75 ]
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %add68 = add nsw i32 %12, %11
  %13 = sext i32 %add68 to i64
  %cmp69 = icmp slt i64 %indvars.iv21, %13
  br i1 %cmp69, label %for.inc75, label %for.end77

for.inc75:                                        ; preds = %for.cond67
  %arrayidx72 = getelementptr inbounds nuw [1000 x i8], ptr %a, i64 0, i64 %indvars.iv21
  %14 = load i8, ptr %arrayidx72, align 1, !tbaa !12
  %conv73 = sext i8 %14 to i32
  %putchar1 = call i32 @putchar(i32 noundef %conv73) #9
