...
for.cond6:                                        ; preds = %for.inc, %for.body
  %2 = phi i32 [ %div, %for.inc ], [ 0, %for.body ]
  %3 = load i32, ptr %dig, align 4, !tbaa !5
...
for.cond29:                                       ; preds = %for.inc34, %for.end28
  %5 = load i32, ptr %st, align 4, !tbaa !5
...
for.inc45:                                        ; preds = %for.cond38
  ...
  %dec46 = add nsw i32 %sub37.sink, -1
