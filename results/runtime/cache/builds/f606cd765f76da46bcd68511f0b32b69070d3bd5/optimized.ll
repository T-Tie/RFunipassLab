...
for.cond1:                                        ; preds = %for.cond, %for.inc14
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc14 ], [ 0, %for.cond ]
  %2 = sext i32 %1 to i64
...
for.body3:                                        ; preds = %for.cond1
  ...
  %rem15 = urem i32 %spec.select, 7
  %cmp9 = icmp eq i32 %rem15, 0
  br i1 %cmp9, label %if.then10, label %for.inc14

if.then10:                                        ; preds = %for.body3
  %arrayidx12 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv18
...
for.cond17:                                       ; preds = %for.cond1, %for.body19
  %6 = phi i32 [ %.pre24, %for.body19 ], [ %1, %for.cond1 ]
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body19 ], [ 0, %for.cond1 ]
  %7 = sext i32 %6 to i64
  %cmp18 = icmp slt i64 %indvars.iv21, %7
  br i1 %cmp18, label %for.body19, label %for.end29

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [200 x i32], ptr %sz, i64 0, i64 %indvars.iv21
  %8 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %cmp22 = icmp eq i32 %8, 1
  %str.1.str = select i1 %cmp22, ptr @str.1, ptr @str
  %puts16 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #8
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %.pre24 = load i32, ptr %n, align 4, !tbaa !5
  br label %for.cond17, !llvm.loop !13

for.end29:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef nonnull %sz) #8
...
entry:
  ...
  %spec.select7 = select i1 %1, i32 29, i32 28
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %result.0 = phi i32 [ 0, %entry ], [ %result.1, %for.inc ]
  %2 = phi i32 [ 1, %entry ], [ %inc, %for.inc ]
  %exitcond.not = icmp eq i32 %2, %smax
...
for.inc.gvnsink.split:                            ; preds = %if.then24, %for.body, %for.body, %for.body, %for.body, %for.body, %for.body, %for.body, %for.inc.gvnsink.split.fold.split
  %.sink1.sink = phi i32 [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 31, %for.body ], [ 30, %for.inc.gvnsink.split.fold.split ], [ %spec.select7, %if.then24 ]
  %add34 = add nsw i32 %.sink1.sink, %result.0
  br label %for.inc
