...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv54 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next55, %for.inc13 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv54
...
for.cond19.preheader:                             ; preds = %for.end15
  ...
  %smax66 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond19

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv61 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next62, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond67.not = icmp eq i32 %i.2, %smax66
  br i1 %exitcond67.not, label %for.end49, label %for.cond22.preheader

for.cond22.preheader:                             ; preds = %for.cond19
  %smax63 = call i32 @llvm.smax.i32(i32 %indvars.iv61, i32 noundef 0)
  %wide.trip.count64 = zext nneg i32 %smax63 to i64
  br label %for.cond22

for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv58 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next59, %for.inc44 ]
  %exitcond65.not = icmp eq i64 %indvars.iv58, %wide.trip.count64
  br i1 %exitcond65.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv58
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next59
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax72 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 1)
  %wide.trip.count73 = zext nneg i32 %smax72 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc59 ], [ 1, %for.end49 ]
  %exitcond74.not = icmp eq i64 %indvars.iv68, %wide.trip.count73
  br i1 %exitcond74.not, label %cleanup, label %for.inc59
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv68
