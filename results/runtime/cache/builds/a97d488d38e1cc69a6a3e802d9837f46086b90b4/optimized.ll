...
entry:
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(1000) %a)
  br label %if.then6.i10

if.then6.i10:                                     ; preds = %entry
  call void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(1000) %b)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41: ; preds = %if.then6.i10
...
NodeBlock57:                                      ; preds = %for.body
  %Pivot58 = icmp slt i8 %0, 71
  br i1 %Pivot58, label %NodeBlock, label %NodeBlock55

NodeBlock55:                                      ; preds = %NodeBlock57
  %Pivot56 = icmp slt i8 %0, 84
  br i1 %Pivot56, label %LeafBlock51, label %LeafBlock53

LeafBlock53:                                      ; preds = %NodeBlock55
  %SwitchLeaf54 = icmp eq i8 %0, 84
  br i1 %SwitchLeaf54, label %land.lhs.true, label %if.end75

LeafBlock51:                                      ; preds = %NodeBlock55
  %SwitchLeaf52 = icmp eq i8 %0, 71
  br i1 %SwitchLeaf52, label %land.lhs.true, label %if.end75

NodeBlock:                                        ; preds = %NodeBlock57
  %Pivot = icmp slt i8 %0, 67
  br i1 %Pivot, label %LeafBlock, label %LeafBlock49

LeafBlock49:                                      ; preds = %NodeBlock
  %SwitchLeaf50 = icmp eq i8 %0, 67
  br i1 %SwitchLeaf50, label %land.lhs.true, label %if.end75

LeafBlock:                                        ; preds = %NodeBlock
  %SwitchLeaf = icmp eq i8 %0, 65
  br i1 %SwitchLeaf, label %land.lhs.true, label %if.end75

land.lhs.true:                                    ; preds = %LeafBlock53, %LeafBlock51, %LeafBlock49, %LeafBlock
...
NodeBlock71:                                      ; preds = %land.lhs.true
  %Pivot72 = icmp slt i8 %1, 71
  br i1 %Pivot72, label %NodeBlock63, label %NodeBlock69

NodeBlock69:                                      ; preds = %NodeBlock71
  %Pivot70 = icmp slt i8 %1, 84
  br i1 %Pivot70, label %LeafBlock65, label %LeafBlock67

LeafBlock67:                                      ; preds = %NodeBlock69
  %SwitchLeaf68 = icmp eq i8 %1, 84
  br i1 %SwitchLeaf68, label %for.inc, label %if.end75

LeafBlock65:                                      ; preds = %NodeBlock69
  %SwitchLeaf66 = icmp eq i8 %1, 71
  br i1 %SwitchLeaf66, label %for.inc, label %if.end75

NodeBlock63:                                      ; preds = %NodeBlock71
  %Pivot64 = icmp slt i8 %1, 67
  br i1 %Pivot64, label %LeafBlock59, label %LeafBlock61

LeafBlock61:                                      ; preds = %NodeBlock63
  %SwitchLeaf62 = icmp eq i8 %1, 67
  br i1 %SwitchLeaf62, label %for.inc, label %if.end75

LeafBlock59:                                      ; preds = %NodeBlock63
  %SwitchLeaf60 = icmp eq i8 %1, 65
  br i1 %SwitchLeaf60, label %for.inc, label %if.end75

for.inc:                                          ; preds = %LeafBlock67, %LeafBlock65, %LeafBlock61, %LeafBlock59
...
if.end75:                                         ; preds = %LeafBlock67, %LeafBlock65, %LeafBlock61, %LeafBlock59, %LeafBlock53, %LeafBlock51, %LeafBlock49, %LeafBlock, %for.end65, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41, %if.else71
  %.str.3.sink = phi ptr [ @.str.3, %if.else71 ], [ @.str.1, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41 ], [ @.str.2, %for.end65 ], [ @.str.1, %LeafBlock ], [ @.str.1, %LeafBlock49 ], [ @.str.1, %LeafBlock51 ], [ @.str.1, %LeafBlock53 ], [ @.str.1, %LeafBlock59 ], [ @.str.1, %LeafBlock61 ], [ @.str.1, %LeafBlock65 ], [ @.str.1, %LeafBlock67 ]
  %call72 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.3.sink) #12
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull %w) #12
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull captures(none) %b) #12
  call void @llvm.lifetime.end.p0(i64 noundef 1000, ptr noundef nonnull captures(none) %a) #12
  ret i32 0
}
...
define internal void @outlined_ir_func_0(ptr noundef nonnull align 16 dereferenceable(1000) %0) #9 {
newFuncRoot:
...
entry_to_outline:                                 ; preds = %newFuncRoot
  ...
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 16 dereferenceable(1000) %0, i64 noundef 1000)
