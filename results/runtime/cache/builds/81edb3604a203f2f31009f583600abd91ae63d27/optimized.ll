...
for.cond:                                         ; preds = %for.inc21, %entry
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc21 ], [ 2, %entry ]
  %indvars.iv = phi i32 [ %indvars.iv.next, %for.inc21 ], [ 1, %entry ]
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %2 = sext i32 %1 to i64
  %cmp.not = icmp sgt i64 %indvars.iv9, %2
  br i1 %cmp.not, label %for.end22, label %for.body

for.body:                                         ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw [20002 x i32], ptr %a, i64 0, i64 %indvars.iv9
...
for.cond6:                                        ; preds = %for.inc, %for.body
  ...
  %5 = phi i32 [ %4, %for.body ], [ %dec, %for.inc ]
...
for.body8:                                        ; preds = %for.cond6
  ...
  %idxprom11 = zext nneg i32 %5 to i64
...
for.end:                                          ; preds = %for.body8, %for.cond6
  ...
  %8 = zext i32 %k.0.lcssa to i64
  %cmp15 = icmp eq i64 %3, %8
  br i1 %cmp15, label %if.then16, label %for.inc21

if.then16:                                        ; preds = %for.end
  %9 = load i32, ptr %arrayidx4, align 4, !tbaa !5
  %call19 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %9) #7
  br label %for.inc21
