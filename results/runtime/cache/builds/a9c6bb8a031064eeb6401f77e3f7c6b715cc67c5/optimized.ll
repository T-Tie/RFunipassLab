...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #8
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc27
  ...
  br i1 %exitcond56.not, label %for.cond31.preheader, label %for.cond2.preheader
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %min.0 = phi i32 [ %spec.select, %for.body5 ], [ 65535, %for.cond2.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv, %wide.trip.count
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  ...
  br i1 %exitcond72.not, label %for.end69, label %for.cond36.preheader

for.cond36.preheader:                             ; preds = %for.cond31
  br label %for.cond36

for.cond36:                                       ; preds = %for.cond36.preheader, %for.body39
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.body39 ], [ 0, %for.cond36.preheader ]
  %min.2 = phi i32 [ %spec.select45, %for.body39 ], [ 65535, %for.cond36.preheader ]
...
for.cond:                                         ; preds = %for.inc9, %entry
  ...
  br i1 %exitcond14.not, label %for.end11, label %for.cond1.preheader
