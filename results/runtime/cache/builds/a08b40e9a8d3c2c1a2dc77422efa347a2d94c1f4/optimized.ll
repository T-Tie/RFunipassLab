...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv23 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %indvars28 = trunc i64 %indvars.iv23 to i32
  %5 = add nsw i64 %indvars.iv23, -1
  %cmp15 = icmp sgt i32 %indvars28, 0
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc50 ], [ %8, %for.end41 ]
  %sub44 = add nsw i32 %9, -1
  %10 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv16, %10
