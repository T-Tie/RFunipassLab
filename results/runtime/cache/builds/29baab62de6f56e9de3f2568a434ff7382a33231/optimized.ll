...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc11
  %indvars.iv6 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next7, %for.inc11 ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv6
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv29 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %5 = add nsw i64 %indvars.iv29, -1
  %6 = trunc nuw i64 %indvars.iv29 to i32
  %cmp15 = icmp sgt i32 %6, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %for.inc37
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc37 ], [ 0, %for.cond14 ]
  %exitcond17.not = icmp eq i64 %indvars.iv10, %5
  br i1 %exitcond17.not, label %for.cond14, label %for.body19, !llvm.loop !13

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv10
  %7 = load i32, ptr %arrayidx21, align 4, !tbaa !5
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next11
...
for.cond43:                                       ; preds = %for.inc50, %for.end41
  ...
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc50 ], [ %9, %for.end41 ]
  %sub44 = add nsw i32 %10, -1
  %11 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv18, %11
  br i1 %cmp45, label %for.inc50, label %for.end52

for.inc50:                                        ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv18
  %12 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %12)
...
for.end52:                                        ; preds = %for.cond43
  ...
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %13)
