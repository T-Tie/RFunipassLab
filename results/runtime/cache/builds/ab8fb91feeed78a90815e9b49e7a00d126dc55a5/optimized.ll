...
define dso_local noundef range(i32 0, 2) i32 @_Z6is_runi(i32 noundef %x) #0 {
entry:
  %rem = srem i32 %x, 100
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 676, ptr nonnull %f1) #7
  call void @llvm.lifetime.start.p0(i64 676, ptr nonnull %f2) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %n) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %year) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %mon1) #7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %mon2) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(676) %f1, i8 0, i64 676, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(676) %f2, i8 0, i64 676, i1 false)
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  ...
  br i1 %exitcond65.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc14 ], [ %indvars.iv59, %for.cond ]
...
for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc ], [ %indvars.iv, %for.cond2 ]
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc27 ], [ 1, %for.cond ]
  %exitcond69.not = icmp eq i64 %indvars.iv66, 13
  br i1 %exitcond69.not, label %for.cond30, label %for.inc27
...
for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond77.not = icmp eq i64 %indvars.iv74, 13
  br i1 %exitcond77.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc45 ], [ 1, %for.cond30 ]
...
for.cond51:                                       ; preds = %for.cond30, %for.cond51.loopexit
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.cond51.loopexit ], [ 2, %for.cond30 ]
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.cond51.loopexit ], [ 1, %for.cond30 ]
  %exitcond90.not = icmp eq i64 %indvars.iv83, 14
  br i1 %exitcond90.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc76 ], [ %indvars.iv83, %for.cond51 ]
  %exitcond88.not = icmp eq i64 %indvars.iv85, 13
  br i1 %exitcond88.not, label %for.cond51.loopexit, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc65 ], [ %indvars.iv78, %for.cond55 ]
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond94.not = icmp eq i64 %indvars.iv91, 13
  br i1 %exitcond94.not, label %for.cond92, label %for.inc89
...
for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond102.not = icmp eq i64 %indvars.iv99, 13
  br i1 %exitcond102.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc107 ], [ 1, %for.cond92 ]
...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts54 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink)
