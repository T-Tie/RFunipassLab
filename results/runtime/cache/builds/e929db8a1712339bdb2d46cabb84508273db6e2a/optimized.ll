...
for.inc71:                                        ; preds = %for.cond52
  ...
  %33 = load i32, ptr %arrayidx58, align 4, !tbaa !5, !invariant.load !17
  ...
  %35 = load i32, ptr %arrayidx62, align 4, !tbaa !5, !invariant.load !17
  ...
  %37 = load i32, ptr %arrayidx66, align 4, !tbaa !5, !invariant.load !17
...
for.body82:                                       ; preds = %for.cond80
  ...
  %41 = load i32, ptr %arrayidx84, align 4, !tbaa !5, !invariant.load !17
  %call86 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %41) #6
...
for.inc95:                                        ; preds = %for.cond87
  ...
  %44 = load i32, ptr %arrayidx93, align 4, !tbaa !5, !invariant.load !17
  %call94 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %44) #6
  %inc96 = add nsw i32 %42, 1
  store i32 %inc96, ptr %j, align 4, !tbaa !5
  br label %for.cond87, !llvm.loop !21

for.inc99:                                        ; preds = %for.cond87
  %call98 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #6
