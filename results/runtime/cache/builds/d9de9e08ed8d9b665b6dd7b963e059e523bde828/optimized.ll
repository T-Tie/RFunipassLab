...
land.lhs.true26:                                  ; preds = %land.lhs.true
  ...
  %spec.select3 = select i1 %cmp32, i32 %12, i32 %y1.1
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  ...
  %spec.select4 = select i1 %cmp50, i32 %7, i32 %x2.1
  %16 = trunc nuw nsw i64 %indvars.iv12 to i32
  %spec.select5 = select i1 %cmp50, i32 %16, i32 %y2.1
  br label %for.inc53
