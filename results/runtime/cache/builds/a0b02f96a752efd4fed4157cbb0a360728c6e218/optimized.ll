...
for.cond6:                                        ; preds = %for.cond6.preheader, %for.inc19
  %indvars.iv26 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next27, %for.inc19 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax34 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv26
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc49
  ...
  %exitcond38 = icmp eq i32 %q.0, %4
  br i1 %exitcond38, label %for.cond52.preheader, label %for.cond25
...
for.cond25:                                       ; preds = %for.cond22, %for.inc46
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc46 ], [ 0, %for.cond22 ]
  %exitcond36.not = icmp eq i64 %indvars.iv30, %wide.trip.count35
  br i1 %exitcond36.not, label %for.inc49, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv30
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next31
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv39 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next40, %for.body54 ]
  %exitcond45 = icmp eq i64 %indvars.iv39, %wide.trip.count44
  br i1 %exitcond45, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv39, %7
  %11 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv39
  %12 = load i32, ptr %11, align 4, !tbaa !5, !invariant.load !12
  %.str.2..str.3 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %call59 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2..str.3, i32 noundef %12)
