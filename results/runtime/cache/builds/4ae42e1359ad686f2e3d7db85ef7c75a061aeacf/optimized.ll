...
for.inc61:                                        ; preds = %for.cond56
  ...
  %call60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %15) #5
