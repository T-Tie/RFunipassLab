...
for.cond72:                                       ; preds = %for.inc122, %for.body71
  %.sink18 = phi i32 [ 0, %for.body71 ], [ %inc123, %for.inc122 ]
  store i32 %.sink18, ptr %j, align 4, !tbaa !5
  %cmp74 = icmp slt i32 %.sink18, %t
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %cmp81 = icmp eq i32 %.sink18, 1
  br i1 %cmp81, label %for.inc122, label %if.then85

lor.lhs.false.thread:                             ; preds = %if.else79
  %cmp8114 = icmp eq i32 %.sink18, 1
  br i1 %cmp8114, label %for.inc122, label %if.else95

if.then85:                                        ; preds = %lor.lhs.false
  %idxprom88 = sext i32 %.sink18 to i64
  %15 = getelementptr inbounds [100 x i32], ptr @a, i64 0, i64 %idxprom88
  %16 = load i32, ptr %15, align 4, !tbaa !5
  %sub92 = sub nsw i32 %.sink18, 1
  %idxprom93 = sext i32 %sub92 to i64
  %arrayidx94 = getelementptr inbounds [100 x i32], ptr @a, i64 0, i64 %idxprom93
  store i32 %16, ptr %arrayidx94, align 4, !tbaa !5
  br label %for.inc122

if.else95:                                        ; preds = %lor.lhs.false.thread
  %idxprom8615 = sext i32 %.sink to i64
  %idxprom8816 = sext i32 %.sink18 to i64
  %17 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %idxprom8615
  %18 = getelementptr inbounds [100 x i32], ptr %17, i64 0, i64 %idxprom8816
  %19 = load i32, ptr %18, align 4, !tbaa !5
  %cmp96 = icmp eq i32 %.sink18, 0
...
if.then97:                                        ; preds = %if.else95
  ...
  %arrayidx106 = getelementptr inbounds [100 x i32], ptr %arrayidx104, i64 0, i64 %idxprom8816
