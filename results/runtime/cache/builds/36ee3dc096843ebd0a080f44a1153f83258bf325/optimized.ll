...
for.cond:                                         ; preds = %for.inc32, %entry
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc32 ], [ 0, %entry ]
...
for.cond35.preheader:                             ; preds = %for.cond
  ...
  %smax41 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 0)
  %wide.trip.count42 = zext nneg i32 %smax41 to i64
  br label %for.cond35

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [5000 x i8], ptr %str1, i64 0, i64 %indvars.iv32
...
for.cond17:                                       ; preds = %for.inc, %if.then9
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc ], [ %1, %if.then9 ]
  %cmp20.not = icmp sgt i64 %indvars.iv29, %6
  br i1 %cmp20.not, label %for.inc32, label %for.inc

for.inc:                                          ; preds = %for.cond17
  %indvars.iv.next30 = add nsw i64 %indvars.iv29, 1
  %7 = trunc nsw i64 %indvars.iv29 to i32
  ...
  %arrayidx29 = getelementptr inbounds [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv29
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.inc44
  %indvars.iv36 = phi i64 [ 0, %for.cond35.preheader ], [ %indvars.iv.next37, %for.inc44 ]
  %exitcond43.not = icmp eq i64 %indvars.iv36, %wide.trip.count42
  br i1 %exitcond43.not, label %for.cond47, label %for.inc44

for.inc44:                                        ; preds = %for.cond35
  %9 = add nsw i64 %indvars.iv36, %2
  %arrayidx41 = getelementptr inbounds [5000 x i8], ptr %str1, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx41, align 1, !tbaa !5
  %arrayidx43 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv36
  store i8 %10, ptr %arrayidx43, align 1, !tbaa !5
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond35, !llvm.loop !13

for.cond47:                                       ; preds = %for.cond35, %for.inc53
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc53 ], [ 0, %for.cond35 ]
  %exitcond48.not = icmp eq i64 %indvars.iv44, %wide.trip.count
  br i1 %exitcond48.not, label %for.end55, label %for.inc53

for.inc53:                                        ; preds = %for.cond47
  %arrayidx51 = getelementptr inbounds nuw [5000 x i8], ptr %str2, i64 0, i64 %indvars.iv44
