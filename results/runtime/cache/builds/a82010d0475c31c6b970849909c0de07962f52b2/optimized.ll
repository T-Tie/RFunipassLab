...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc53
  %indvars.iv44 = phi i64 [ 1, %for.cond13.preheader ], [ %10, %for.inc53 ]
...
land.lhs.true:                                    ; preds = %for.body15
  %arrayidx24 = getelementptr inbounds nuw [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv50, i64 %10
...
land.lhs.true26:                                  ; preds = %land.lhs.true
  ...
  %spec.select35 = select i1 %cmp32, i32 %13, i32 %y1.1
...
land.lhs.true38:                                  ; preds = %land.lhs.true26, %land.lhs.true
  ...
  %14 = add nsw i64 %indvars.iv44, -1
  %arrayidx42 = getelementptr inbounds [1002 x [1002 x i32]], ptr %shuzu, i64 0, i64 %indvars.iv50, i64 %14
...
land.lhs.true44:                                  ; preds = %land.lhs.true38
  ...
  %spec.select36 = select i1 %cmp50, i32 %8, i32 %x2.1
  %17 = trunc nuw nsw i64 %indvars.iv44 to i32
  %spec.select37 = select i1 %cmp50, i32 %17, i32 %y2.1
  br label %for.inc53
...
for.end58:                                        ; preds = %for.cond10
  ...
  %18 = shl i32 %sub61, 1
  %reass.sub39 = sub i32 %sub66, %18
  %add71 = add i32 %reass.sub39, 2
