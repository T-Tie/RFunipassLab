...
while.end:                                        ; preds = %while.cond
  call void @outlined_ir_func_0(ptr nonnull %i)
  call void @outlined_ir_func_0(ptr nonnull %j)
...
define internal void @outlined_ir_func_0(ptr readonly captures(none) %0) #5 {
