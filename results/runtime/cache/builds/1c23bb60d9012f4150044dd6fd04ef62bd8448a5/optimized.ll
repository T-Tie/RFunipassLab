...
for.inc:                                          ; preds = %if.then11, %if.else27, %if.then25
  %.sink3 = phi i32 [ 30, %if.else27 ], [ 31, %if.then25 ], [ 29, %if.then11 ]
...
for.inc56:                                        ; preds = %if.then34, %if.else52, %if.then50
  %.sink2 = phi i32 [ 30, %if.else52 ], [ 31, %if.then50 ], [ 29, %if.then34 ]
...
for.inc109:                                       ; preds = %if.then89, %if.else105, %if.then103
  %.sink1 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ], [ 28, %if.then89 ]
