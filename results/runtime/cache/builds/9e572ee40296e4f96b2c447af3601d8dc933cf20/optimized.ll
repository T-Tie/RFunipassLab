...
for.cond3:                                        ; preds = %for.cond, %for.inc
  %4 = phi i32 [ %.pre35, %for.inc ], [ %2, %for.cond ]
...
for.inc:                                          ; preds = %for.cond3
  ...
  %.pre35 = load i32, ptr %y1, align 4, !tbaa !5
...
for.cond16:                                       ; preds = %for.inc30, %for.end10
  ...
  %8 = phi i32 [ %5, %for.end10 ], [ %.pre29, %for.inc30 ]
...
for.cond19:                                       ; preds = %for.cond16, %for.inc27
  %9 = phi i32 [ %.pre34, %for.inc27 ], [ %7, %for.cond16 ]
...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax26 = call i32 @llvm.smax.i32(i32 %10, i32 0)
...
for.cond37:                                       ; preds = %for.inc74, %for.end32
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc74 ], [ 0, %for.end32 ]
  %exitcond28.not = icmp eq i64 %indvars.iv21, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond77, label %for.cond40.preheader

for.cond40.preheader:                             ; preds = %for.cond37
  %14 = mul nsw i64 %indvars.iv21, %12
  %15 = mul nsw i64 %indvars.iv21, %13
  %invariant.gep41 = getelementptr i32, ptr %call36, i64 %14
  %16 = getelementptr i32, ptr %call2, i64 %15
  br label %for.cond40

for.cond40:                                       ; preds = %for.cond40.preheader, %for.inc71
  %indvars.iv14 = phi i64 [ 0, %for.cond40.preheader ], [ %indvars.iv.next15, %for.inc71 ]
  %exitcond20.not = icmp eq i64 %indvars.iv14, %wide.trip.count19
  br i1 %exitcond20.not, label %for.inc74, label %for.body42

for.body42:                                       ; preds = %for.cond40
  %gep42 = getelementptr i32, ptr %invariant.gep41, i64 %indvars.iv14
  store i32 0, ptr %gep42, align 4, !tbaa !5
  %invariant.gep = getelementptr i32, ptr %call15, i64 %indvars.iv14
  br label %for.cond47
...
for.inc68:                                        ; preds = %for.cond47
  ...
  store i32 %add63, ptr %gep42, align 4, !tbaa !5
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  ...
  %22 = phi i32 [ %.pre30, %for.inc98 ], [ %10, %for.cond37 ]
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %23 = phi i32 [ %.pre31, %for.inc95 ], [ %21, %for.cond77 ]
...
if.then:                                          ; preds = %for.body82
  ...
  %.pre36 = add nsw i32 %.pre32, -1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body82
  %sub90.pre-phi = phi i32 [ %.pre36, %if.then ], [ %sub, %for.body82 ]
  %26 = phi i32 [ %.pre32, %if.then ], [ %25, %for.body82 ]
