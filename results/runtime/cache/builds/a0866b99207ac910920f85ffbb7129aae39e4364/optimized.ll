...
for.end30:                                        ; preds = %for.cond12
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %smax, i32 0)
  %smax25 = call i32 @llvm.smax.i32(i32 %4, i32 %8)
  %smax26 = call i32 @llvm.smax.i32(i32 %smax25, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond36
  %smax32 = call i32 @llvm.smax.i32(i32 %9, i32 0)
  %wide.trip.count40 = zext nneg i32 %smax20 to i64
...
for.end93:                                        ; preds = %for.cond86
  ...
  %wide.trip.count57 = zext nneg i32 %smax20 to i64
  br label %for.cond96
...
for.cond99:                                       ; preds = %for.cond99.preheader, %for.inc112
  ...
  %exitcond58.not = icmp eq i64 %indvars.iv52, %wide.trip.count57
...
if.end136:                                        ; preds = %if.else131, %if.then129
  ...
  %smax67 = call i32 @llvm.smax.i32(i32 %sub140, i32 1)
...
if.then156:                                       ; preds = %if.else151
  ...
  %smax73 = call i32 @llvm.smax.i32(i32 %sub162, i32 1)
