...
for.end9:                                         ; preds = %for.cond
  ...
  %3 = load double, ptr %arrayidx11, align 8, !tbaa !13
  %4 = load double, ptr %sv, align 16, !tbaa !13
  %div = fdiv double %3, %4
...
for.body16:                                       ; preds = %for.cond14
  ...
  %7 = load double, ptr %arrayidx19, align 8, !tbaa !13, !invariant.load !15
  %8 = load double, ptr %arrayidx18, align 16, !tbaa !13, !invariant.load !15
