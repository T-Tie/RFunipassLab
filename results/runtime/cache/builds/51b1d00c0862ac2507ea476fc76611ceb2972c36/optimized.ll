...
for.cond:                                         ; preds = %for.inc18, %entry
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %for.inc18 ], [ 0, %entry ]
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc18 ], [ 0, %entry ]
...
for.inc:                                          ; preds = %for.cond6
  ...
  %arrayidx12 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv12, i64 %indvars.iv
  store i8 %2, ptr %arrayidx12, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond6, !llvm.loop !10

for.inc18:                                        ; preds = %for.cond6
  %arrayidx16 = getelementptr inbounds [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv12, i64 %conv5
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc26
  %indvars.iv17 = phi i64 [ 0, %for.cond21.preheader ], [ %indvars.iv.next18, %for.inc26 ]
  %exitcond23.not = icmp eq i64 %indvars.iv17, %wide.trip.count22
  br i1 %exitcond23.not, label %for.cond29, label %for.inc26

for.inc26:                                        ; preds = %for.cond21
  %arrayidx25 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv17
  store i32 1, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  br label %for.cond21, !llvm.loop !14

for.cond29:                                       ; preds = %for.cond21, %for.inc54
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.inc54 ], [ 0, %for.cond21 ]
  %exitcond35.not = icmp eq i64 %indvars.iv24, %wide.trip.count22
  br i1 %exitcond35.not, label %for.cond57, label %for.cond32.preheader

for.cond32.preheader:                             ; preds = %for.cond29
  %arrayidx36 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv24
  %arrayidx44 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv24
  br label %for.cond32

for.cond32:                                       ; preds = %for.cond32.preheader, %for.inc51
  %indvars.iv26 = phi i64 [ %indvars.iv24, %for.cond32.preheader ], [ %indvars.iv.next27, %for.inc51 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, %wide.trip.count22
  br i1 %exitcond31.not, label %for.inc54, label %for.body34

for.body34:                                       ; preds = %for.cond32
  %arrayidx39 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv26
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx50 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv26
...
for.cond57:                                       ; preds = %for.cond29, %for.body59
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body59 ], [ 0, %for.cond29 ]
  %max.0 = phi i32 [ %spec.select, %for.body59 ], [ 0, %for.cond29 ]
  %exitcond41.not = icmp eq i64 %indvars.iv36, %wide.trip.count22
  br i1 %exitcond41.not, label %for.end69, label %for.body59

for.body59:                                       ; preds = %for.cond57
  %arrayidx61 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv36
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc89 ], [ 0, %if.else ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, %wide.trip.count22
  br i1 %exitcond47.not, label %if.end92, label %for.body78

for.body78:                                       ; preds = %for.cond76
  %arrayidx80 = getelementptr inbounds nuw [10000 x i32], ptr %num, i64 0, i64 %indvars.iv42
...
if.then82:                                        ; preds = %for.body78
  %arrayidx84 = getelementptr inbounds nuw [10000 x [6 x i8]], ptr %c, i64 0, i64 %indvars.iv42
