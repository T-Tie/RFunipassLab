...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !19, !invariant.load !12
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !37, !invariant.load !12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !43, !invariant.load !12
  br label %return
