...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv40, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc24
  %indvars.iv47 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next48, %for.inc24 ]
  ...
  br i1 %exitcond52, label %for.cond27.preheader, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv43 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next44, %for.inc21 ]
  %exitcond = icmp eq i64 %indvars.iv43, %wide.trip.count
  br i1 %exitcond, label %for.inc24, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv47, i64 %indvars.iv43
...
for.body32:                                       ; preds = %for.cond30
  ...
  %arrayidx36 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %s, i64 0, i64 %indvars.iv54, i64 %idxprom35
