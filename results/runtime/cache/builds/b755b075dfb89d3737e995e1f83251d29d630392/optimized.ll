...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond9 = or i1 %cmp6, %or.cond
  br i1 %or.cond9, label %if.then, label %if.else80
...
for.cond7:                                        ; preds = %for.inc, %if.then
  %storemerge10 = phi i32 [ 1, %if.then ], [ %inc, %for.inc ]
  %n1.0 = phi i32 [ 0, %if.then ], [ %add, %for.inc ]
  %exitcond12.not = icmp eq i32 %storemerge10, %smax11
  br i1 %exitcond12.not, label %if.end79, label %for.body9

for.body9:                                        ; preds = %for.cond7
  switch i32 %storemerge10, label %if.else27 [
    i32 2, label %for.inc
...
for.inc:                                          ; preds = %for.body9, %if.else27, %if.then25
  ...
  %inc = add nuw i32 %storemerge10, 1
  br label %for.cond7, !llvm.loop !9

if.end79:                                         ; preds = %for.cond7
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n2, i32 noundef 29, i32 %n1.0, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %M)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %M) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n2) #6
...
if.else80:                                        ; preds = %for.body
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %M84) #6
...
for.inc109:                                       ; preds = %for.body87, %if.else105, %if.then103
  %.sink13 = phi i32 [ 30, %if.else105 ], [ 31, %if.then103 ], [ 28, %for.body87 ]
  %add90 = add nuw nsw i32 %.sink13, %n182.0
  %inc110 = add nuw i32 %storemerge, 1
  br label %for.cond85, !llvm.loop !12

if.end162:                                        ; preds = %for.cond85
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %j81, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %m2, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %n283, i32 noundef 28, i32 %n182.0, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %M84)
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %M84) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %n283) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull captures(none) %j81) #6
  br label %for.inc164
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts4 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.2.str)
  br label %if.end68
...
if.then70:                                        ; preds = %if.end68
  ...
  %puts6 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.4.str.3)
