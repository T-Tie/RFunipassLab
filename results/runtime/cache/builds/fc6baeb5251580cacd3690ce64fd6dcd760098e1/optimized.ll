...
for.cond29:                                       ; preds = %for.inc45, %for.body24
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc45 ], [ %idxprom2, %for.body24 ]
...
for.end47:                                        ; preds = %for.cond29
  ...
  %9 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next36
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select28 = call i32 @llvm.smax.i32(i32 %10, i32 %sum.2)
