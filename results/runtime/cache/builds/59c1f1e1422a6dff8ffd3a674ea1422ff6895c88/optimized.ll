...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %letter) #12
...
for.body:                                         ; preds = %for.cond
  call void @llvm.memset.p0.i64(ptr align 16 %letter, i8 48, i64 40, i1 false)
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef %letter)
...
if.end:                                           ; preds = %if.then, %for.body
  %blank.1 = phi i32 [ 0, %if.then ], [ %blank.0, %for.body ]
  %num.1 = phi i32 [ 0, %if.then ], [ %num.0, %for.body ]
...
if.end11:                                         ; preds = %if.then9, %if.end
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %letter)
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr %letter) #12
  ret i32 0
}
...
if.end:                                           ; preds = %entry
  %0 = load i8, ptr %__c.addr, align 1, !tbaa !14
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !14
...
!39 = !{!27, !31, i64 240}
!40 = !{!41, !7, i64 56}
!41 = !{!"_ZTSSt5ctypeIcE", !42, i64 0, !43, i64 16, !29, i64 24, !44, i64 32, !44, i64 40, !45, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!42 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!43 = !{!"p1 _ZTS15__locale_struct", !21, i64 0}
!44 = !{!"p1 int", !21, i64 0}
!45 = !{!"p1 short", !21, i64 0}
