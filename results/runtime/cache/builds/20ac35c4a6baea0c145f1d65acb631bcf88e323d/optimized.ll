...
for.cond4:                                        ; preds = %for.inc29, %for.end
  ...
  %max.0 = phi i32 [ %max.1.ph, %for.inc29 ], [ 0, %for.end ]
...
for.cond7.preheader:                              ; preds = %for.cond4
  ...
  br label %for.cond7.outer

for.cond7.outer:                                  ; preds = %if.then20, %for.cond7.preheader
  %indvars.iv8.ph = phi i64 [ %indvars.iv.next9, %if.then20 ], [ %indvars.iv, %for.cond7.preheader ]
  %max.1.ph = phi i32 [ %spec.select, %if.then20 ], [ %max.0, %for.cond7.preheader ]
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.backedge, %for.cond7.outer
  %indvars.iv8 = phi i64 [ %indvars.iv8.ph, %for.cond7.outer ], [ %indvars.iv.next9, %for.cond7.backedge ]
  %indvars.iv.next9 = add nsw i64 %indvars.iv8, -1
  %cmp8 = icmp sgt i64 %indvars.iv8, 0
  br i1 %cmp8, label %for.body9, label %for.inc29

for.body9:                                        ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds nuw [25 x i32], ptr @a, i64 0, i64 %indvars.iv.next9
  %3 = load i32, ptr %arrayidx11, align 4, !tbaa !5
  %cmp14.not = icmp slt i32 %3, %2
  br i1 %cmp14.not, label %for.cond7.backedge, label %if.then

for.cond7.backedge:                               ; preds = %for.body9, %if.then
  br label %for.cond7, !llvm.loop !12

if.then:                                          ; preds = %for.body9
  %arrayidx16 = getelementptr inbounds nuw [25 x i32], ptr @b, i64 0, i64 %indvars.iv.next9
  ...
  br i1 %cmp19.not, label %for.cond7.backedge, label %if.then20

if.then20:                                        ; preds = %if.then
  store i32 %add, ptr %arrayidx18, align 4, !tbaa !5
  %spec.select = tail call i32 @llvm.smax.i32(i32 %add, i32 %max.1.ph)
  br label %for.cond7.outer, !llvm.loop !12
...
for.end31:                                        ; preds = %for.cond4
  ...
  %call1.i = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call32, i8 noundef signext %call.i7)
