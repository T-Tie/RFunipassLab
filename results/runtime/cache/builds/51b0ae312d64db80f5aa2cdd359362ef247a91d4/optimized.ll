...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 40, ptr noundef nonnull %initial) #12
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %entry, %land.lhs.true.i, %if.then19.i, %if.then28.i
  ...
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %initial) #13
  %conv = trunc i64 %call5 to i32
  %vtable7.i9 = load ptr, ptr @_ZSt3cin, align 8
...
while.cond:                                       ; preds = %if.end, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %cmp.not = icmp sgt i32 %t.0, %2
  br i1 %cmp.not, label %while.end, label %while.body

while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull %word) #12
  ...
  %call16.i13 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i12) #12
...
land.lhs.true.i14:                                ; preds = %while.body
  %_M_width.i1.i15 = getelementptr inbounds nuw i8, ptr %add.ptr10.i12, i64 16
  %3 = load i64, ptr %_M_width.i1.i15, align 8, !tbaa !9, !invariant.load !8
  %4 = add i64 %3, -42
  %or.cond.i18 = icmp ult i64 %4, -41
...
if.then19.i19:                                    ; preds = %land.lhs.true.i14
  %call24.i20 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i12) #12
  ...
  br i1 %tobool.not.i25, label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27, label %if.then28.i26

if.then28.i26:                                    ; preds = %if.then19.i19
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i12, i32 noundef 2)
  br label %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27

_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit27: ; preds = %while.body, %land.lhs.true.i14, %if.then19.i19, %if.then28.i26
  %call9 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %word) #13
...
if.end:                                           ; preds = %if.else, %if.then
  %call16.sink = phi ptr [ %call16, %if.else ], [ @_ZSt4cout, %if.then ]
  %count.1 = phi i32 [ %add, %if.else ], [ %conv10, %if.then ]
  %mark.1 = phi i32 [ %mark.0, %if.else ], [ %t.0, %if.then ]
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %call16.sink, ptr noundef nonnull align 16 dereferenceable(41) %word)
  %inc = add nuw nsw i32 %t.0, 1
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull %word) #12
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 40, ptr noundef nonnull %initial) #12
...
!26 = !{!12, !12, i64 0}
!27 = !{!28, !12, i64 56}
!28 = !{!"_ZTSSt5ctypeIcE", !29, i64 0, !30, i64 16, !31, i64 24, !32, i64 32, !32, i64 40, !33, i64 48, !12, i64 56, !12, i64 57, !12, i64 313, !12, i64 569}
!29 = !{!"_ZTSNSt6locale5facetE", !18, i64 8}
