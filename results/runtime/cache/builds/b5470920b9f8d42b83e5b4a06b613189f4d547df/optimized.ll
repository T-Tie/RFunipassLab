...
for.cond:                                         ; preds = %for.end, %while.body
  %1 = phi i32 [ %6, %for.end ], [ %0, %while.body ]
  %indvars.iv52 = phi i64 [ %indvars.iv.next53, %for.end ], [ 0, %while.body ]
  %2 = sext i32 %1 to i64
  %cmp1 = icmp slt i64 %indvars.iv52, %2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv52, i64 %indvars.iv
...
while.cond11:                                     ; preds = %while.cond11.preheader, %for.end138
  %indvars.iv109 = phi i64 [ %5, %while.cond11.preheader ], [ %indvars.iv.next110, %for.end138 ]
  %indvars.iv106 = phi i64 [ %4, %while.cond11.preheader ], [ %indvars.iv.next107, %for.end138 ]
...
for.cond14:                                       ; preds = %while.cond11, %for.end48
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.end48 ], [ 0, %while.cond11 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %indvars.iv109
  br i1 %exitcond67.not, label %for.cond52, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %arrayidx18 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv63
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond20

for.cond20:                                       ; preds = %for.body22, %for.body16
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.body22 ], [ 0, %for.body16 ]
...
for.body22:                                       ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv55
...
for.cond35:                                       ; preds = %for.cond35.preheader, %for.body37
  %indvars.iv58 = phi i64 [ %indvars.iv.next59, %for.body37 ], [ 0, %for.cond35.preheader ]
  %exitcond62.not = icmp eq i64 %indvars.iv58, %indvars.iv109
  br i1 %exitcond62.not, label %for.end48, label %for.body37

for.body37:                                       ; preds = %for.cond35
  %arrayidx41 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv58
...
for.cond52:                                       ; preds = %for.cond14, %for.end89
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.end89 ], [ 0, %for.cond14 ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %indvars.iv109
  br i1 %exitcond82.not, label %for.end92, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %arrayidx57 = getelementptr inbounds nuw [105 x i32], ptr %a, i64 0, i64 %indvars.iv78
  %12 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !13
  br label %for.cond58

for.cond58:                                       ; preds = %for.body60, %for.body54
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.body60 ], [ 0, %for.body54 ]
  %min.2 = phi i32 [ %spec.select50, %for.body60 ], [ %12, %for.body54 ]
  %exitcond72.not = icmp eq i64 %indvars.iv68, %indvars.iv109
  br i1 %exitcond72.not, label %for.cond75.preheader, label %for.body60

for.cond75.preheader:                             ; preds = %for.cond58
  br label %for.cond75

for.body60:                                       ; preds = %for.cond58
  %arrayidx64 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv68, i64 %indvars.iv78
  %13 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  %spec.select50 = call i32 @llvm.smin.i32(i32 %min.2, i32 %13)
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  br label %for.cond58, !llvm.loop !17

for.cond75:                                       ; preds = %for.cond75.preheader, %for.body77
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.body77 ], [ 0, %for.cond75.preheader ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %indvars.iv109
  br i1 %exitcond77.not, label %for.end89, label %for.body77

for.body77:                                       ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv73, i64 %indvars.iv78
...
for.cond95:                                       ; preds = %for.end113, %for.end92
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.end113 ], [ 0, %for.end92 ]
  %exitcond95.not = icmp eq i64 %indvars.iv91, %indvars.iv109
  br i1 %exitcond95.not, label %for.cond117, label %for.cond98

for.cond98:                                       ; preds = %for.cond95, %for.body101
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.body101 ], [ 1, %for.cond95 ]
  %exitcond90.not = icmp eq i64 %indvars.iv83, %indvars.iv106
  br i1 %exitcond90.not, label %for.end113, label %for.body101

for.body101:                                      ; preds = %for.cond98
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1
  %arrayidx106 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv91, i64 %indvars.iv.next84
  %16 = load i32, ptr %arrayidx106, align 4, !tbaa !5, !invariant.load !13
  %arrayidx110 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv91, i64 %indvars.iv83
...
for.cond117:                                      ; preds = %for.cond95, %for.end135
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.end135 ], [ 0, %for.cond95 ]
  %exitcond105.not = icmp eq i64 %indvars.iv101, %indvars.iv109
  br i1 %exitcond105.not, label %for.end138, label %for.cond120

for.cond120:                                      ; preds = %for.cond117, %for.body123
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.body123 ], [ 1, %for.cond117 ]
  %exitcond100.not = icmp eq i64 %indvars.iv96, %indvars.iv106
  br i1 %exitcond100.not, label %for.end135, label %for.body123

for.body123:                                      ; preds = %for.cond120
  %indvars.iv.next97 = add nuw nsw i64 %indvars.iv96, 1
  %arrayidx128 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv.next97, i64 %indvars.iv101
  %17 = load i32, ptr %arrayidx128, align 4, !tbaa !5, !invariant.load !13
  %arrayidx132 = getelementptr inbounds nuw [105 x [105 x i32]], ptr %a, i64 0, i64 %indvars.iv96, i64 %indvars.iv101
