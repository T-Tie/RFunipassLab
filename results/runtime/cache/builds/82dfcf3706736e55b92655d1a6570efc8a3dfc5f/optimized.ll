...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %s, i64 0, i64 %indvars.iv2
...
for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc47
  %indvars.iv9 = phi i32 [ %sub, %for.cond19.preheader ], [ %indvars.iv.next10, %for.inc47 ]
  %i.2 = phi i32 [ 0, %for.cond19.preheader ], [ %inc48, %for.inc47 ]
  %exitcond15.not = icmp eq i32 %i.2, %smax14
  br i1 %exitcond15.not, label %for.end49, label %for.cond22.preheader
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc44
  %indvars.iv6 = phi i64 [ 0, %for.cond22.preheader ], [ %indvars.iv.next7, %for.inc44 ]
  %exitcond13.not = icmp eq i64 %indvars.iv6, %wide.trip.count12
  br i1 %exitcond13.not, label %for.inc47, label %for.body26

for.body26:                                       ; preds = %for.cond22
  %arrayidx28 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv6
  %4 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx30 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv.next7
...
for.end49:                                        ; preds = %for.cond19
  ...
  %smax20 = call i32 @llvm.smax.i32(i32 %len.0, i32 noundef 1)
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  br label %for.cond52

for.cond52:                                       ; preds = %for.inc59, %for.end49
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc59 ], [ 1, %for.end49 ]
  %exitcond22.not = icmp eq i64 %indvars.iv16, %wide.trip.count21
  br i1 %exitcond22.not, label %cleanup, label %for.inc59
...
for.inc59:                                        ; preds = %for.cond52
  ...
  %arrayidx57 = getelementptr inbounds nuw [500 x i32], ptr %t, i64 0, i64 %indvars.iv16
