...
for.end87:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 4 dereferenceable(4) %total1.0.loc)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 4 dereferenceable(4) %total1.0.loc)
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 4 dereferenceable(4) %total2.0.loc)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 4 dereferenceable(4) %total2.0.loc)
...
if.then28:                                        ; preds = %if.end
  br i1 %or.cond3, label %if.then35, label %if.else
...
for.inc:                                          ; preds = %if.end, %if.end26.thread, %if.else, %if.then35
  %total1.3 = phi i32 [ %add25, %if.end26.thread ], [ %add36, %if.then35 ], [ %add37, %if.else ], [ %total1.1, %if.end ]
