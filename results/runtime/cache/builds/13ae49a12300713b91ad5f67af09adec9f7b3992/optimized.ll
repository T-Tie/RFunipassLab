...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  ...
  %10 = icmp slt i64 %indvars.iv33, %sext
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  ...
  %phiofops = phi i64 [ %indvars.iv42, %for.inc151 ], [ 0, %if.else ]
...
for.body136.for.end153_crit_edge:                 ; preds = %for.body136
  ...
  %.pre81 = and i64 %phiofops, 4294967295
  br label %for.end153
...
for.end153:                                       ; preds = %for.cond134, %for.body136.for.end153_crit_edge
  %wide.trip.count62.pre-phi = phi i64 [ %.pre81, %for.body136.for.end153_crit_edge ], [ %wide.trip.count40, %for.cond134 ]
...
for.cond154:                                      ; preds = %for.cond154.loopexit, %for.end153
  ...
  %exitcond63.not = icmp eq i64 %indvars.iv59, %wide.trip.count62.pre-phi
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  ...
  %cmp212 = icmp slt i64 %indvars.iv64, %26
