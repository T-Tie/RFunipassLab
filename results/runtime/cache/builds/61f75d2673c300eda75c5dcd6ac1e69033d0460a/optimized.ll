...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv22
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
  br label %for.cond2

for.cond2:                                        ; preds = %for.inc, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv, %indvars.iv22
...
for.end:                                          ; preds = %for.body4, %for.cond2
  %j.0.lcssa.in = phi i64 [ %indvars.iv, %for.body4 ], [ %indvars.iv22, %for.cond2 ]
  %4 = and i64 %j.0.lcssa.in, 4294967295
  %cmp10 = icmp eq i64 %indvars.iv22, %4
...
for.cond17:                                       ; preds = %for.cond17.preheader, %for.inc43
  %5 = phi i32 [ %.pre, %for.inc43 ], [ %0, %for.cond17.preheader ]
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc43 ], [ 0, %for.cond17.preheader ]
  %counter.2 = phi i32 [ %counter.3, %for.inc43 ], [ %counter.0, %for.cond17.preheader ]
  %6 = sext i32 %5 to i64
  %cmp18 = icmp slt i64 %indvars.iv29, %6
  br i1 %cmp18, label %for.cond20.preheader, label %for.end45

for.cond20.preheader:                             ; preds = %for.cond17
  %arrayidx24 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv29
  br label %for.cond20

for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc30
  %indvars.iv25 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next26, %for.inc30 ]
  %exitcond28.not = icmp eq i64 %indvars.iv25, %indvars.iv29
  br i1 %exitcond28.not, label %for.end32, label %for.body22

for.body22:                                       ; preds = %for.cond20
  %7 = load i32, ptr %arrayidx24, align 4, !tbaa !5
  %arrayidx26 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv25
...
for.end32:                                        ; preds = %for.body22, %for.cond20
  %j.1.lcssa.in = phi i64 [ %indvars.iv25, %for.body22 ], [ %indvars.iv29, %for.cond20 ]
  %9 = and i64 %j.1.lcssa.in, 4294967295
  %cmp33 = icmp eq i64 %indvars.iv29, %9
