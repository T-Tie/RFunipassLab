...
for.cond2.preheader:                              ; preds = %for.cond
  %add.ptr.idx = mul nuw nsw i64 %indvars.iv12, 2000
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc
  %2 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre20, %for.inc ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc23
  %indvars.iv16 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next17, %for.inc23 ]
  %exitcond.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26.loopexit, label %for.body16

for.body16:                                       ; preds = %for.cond14
  %add.ptr21 = getelementptr inbounds nuw i32, ptr %add.ptr19, i64 %indvars.iv16
  %4 = load i32, ptr %add.ptr21, align 4, !tbaa !5
  %cmp22 = icmp eq i32 %4, 0
  br i1 %cmp22, label %for.inc26.split.loop.exit22, label %for.inc23

for.inc23:                                        ; preds = %for.body16
  %indvars.iv.next17 = add nuw nsw i64 %indvars.iv16, 1
  br label %for.cond14, !llvm.loop !13

for.inc26.split.loop.exit22:                      ; preds = %for.body16
...
for.inc26:                                        ; preds = %for.inc26.loopexit, %for.inc26.split.loop.exit22
  %c1.1 = phi i32 [ %5, %for.inc26.split.loop.exit22 ], [ %c1.0, %for.inc26.loopexit ]
  %r1.1 = phi i32 [ %i.1, %for.inc26.split.loop.exit22 ], [ %r1.0, %for.inc26.loopexit ]
  %i.2 = phi i32 [ 10000, %for.inc26.split.loop.exit22 ], [ %6, %for.inc26.loopexit ]
...
for.inc46:                                        ; preds = %for.cond33, %for.body35
  %c2.1 = phi i32 [ %7, %for.body35 ], [ %c2.0, %for.cond33 ]
  %r2.1 = phi i32 [ %sub.sink, %for.body35 ], [ %r2.0, %for.cond33 ]
  %i.3 = phi i32 [ -1, %for.body35 ], [ %sub.sink, %for.cond33 ]
  %dec47 = add nsw i32 %i.3, -1
  br label %for.cond29, !llvm.loop !16

for.end48:                                        ; preds = %for.cond29
  %sub49 = xor i32 %r1.0, -1
  %sub50 = add i32 %r2.0, %sub49
  %sub51 = xor i32 %c1.0, -1
  %sub52 = add i32 %c2.0, %sub51
