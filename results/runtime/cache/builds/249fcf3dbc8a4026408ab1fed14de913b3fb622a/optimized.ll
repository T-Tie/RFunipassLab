...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80008, ptr %a) #4
  call void @llvm.memset.p0.i64(ptr align 16 %a, i8 0, i64 80008, i1 false)
...
for.end22:                                        ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 80008, ptr %a) #4
  ret i32 0
}
