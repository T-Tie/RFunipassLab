...
for.end:                                          ; preds = %for.cond
  ...
  %2 = add nuw i32 %smax117, 1
  %wide.trip.count118 = zext i32 %2 to i64
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc68, %for.end
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %for.inc68 ], [ 1, %for.end ]
  %l.0 = phi i32 [ %l.1, %for.inc68 ], [ 1, %for.end ]
  %exitcond119 = icmp eq i64 %indvars.iv114, %wide.trip.count118
  br i1 %exitcond119, label %for.cond71.preheader, label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond11
  %smax105 = call i32 @llvm.smax.i32(i32 %l.0, i32 noundef 0)
...
for.cond71.preheader:                             ; preds = %for.cond11
  ...
  %smax130 = add nsw i32 %3, -1
  %wide.trip.count131 = zext nneg i32 %smax130 to i64
  br label %for.cond71

for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc41
  %indvars.iv102 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next103, %for.inc41 ]
  %y.0 = phi i32 [ 0, %for.cond14.preheader ], [ %y.1, %for.inc41 ]
  %exitcond107.not = icmp eq i64 %indvars.iv102, %wide.trip.count106
  br i1 %exitcond107.not, label %for.end43, label %for.cond17

for.cond17:                                       ; preds = %for.cond14, %for.body19
  %indvars.iv96 = phi i64 [ %indvars.iv.next97, %for.body19 ], [ 0, %for.cond14 ]
  %x.0 = phi i32 [ %spec.select, %for.body19 ], [ 0, %for.cond14 ]
  %exitcond101.not = icmp eq i64 %indvars.iv96, %wide.trip.count
  br i1 %exitcond101.not, label %for.end32, label %for.body19

for.body19:                                       ; preds = %for.cond17
  %4 = add nuw nsw i64 %indvars.iv96, %indvars.iv114
  ...
  %arrayidx26 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv102, i64 %indvars.iv96
...
if.then34:                                        ; preds = %for.end32
  %arrayidx37 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv102, i64 4
...
for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc56
  %indvars.iv108 = phi i64 [ 0, %for.cond46.preheader ], [ %indvars.iv.next109, %for.inc56 ]
  %exitcond113.not = icmp eq i64 %indvars.iv108, %wide.trip.count
  br i1 %exitcond113.not, label %for.end58, label %for.inc56

for.inc56:                                        ; preds = %for.cond46
  %8 = add nuw nsw i64 %indvars.iv108, %indvars.iv114
  ...
  %arrayidx55 = getelementptr inbounds [501 x [6 x i8]], ptr %b, i64 0, i64 %idxprom52, i64 %indvars.iv108
...
for.cond71:                                       ; preds = %for.cond71.preheader, %for.inc121
  %indvars.iv124 = phi i64 [ 0, %for.cond71.preheader ], [ %indvars.iv.next125, %for.inc121 ]
  %exitcond132.not = icmp eq i64 %indvars.iv124, %wide.trip.count131
  br i1 %exitcond132.not, label %for.end123, label %for.cond76.preheader

for.cond76.preheader:                             ; preds = %for.cond71
  %arrayidx85 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv124, i64 4
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc118
  %indvars.iv126 = phi i64 [ %indvars.iv124, %for.cond76.preheader ], [ %indvars.iv.next127, %for.inc118 ]
  %indvars.iv.next127 = add nuw nsw i64 %indvars.iv126, 1
  %10 = trunc nuw i64 %indvars.iv.next127 to i32
  %cmp77 = icmp sgt i32 %l.0, %10
  br i1 %cmp77, label %for.body78, label %for.inc121

for.body78:                                       ; preds = %for.cond76
  %arrayidx81 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next127, i64 4
...
for.cond89:                                       ; preds = %for.body78, %for.inc114
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %for.inc114 ], [ 0, %for.body78 ]
  %exitcond123.not = icmp eq i64 %indvars.iv120, 6
  br i1 %exitcond123.not, label %for.inc118, label %for.inc114

for.inc114:                                       ; preds = %for.cond89
  %arrayidx95 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next127, i64 %indvars.iv120
  %13 = load i8, ptr %arrayidx95, align 1, !tbaa !9
  %arrayidx98 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv120
  store i8 %13, ptr %arrayidx98, align 1, !tbaa !9
  %arrayidx102 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv124, i64 %indvars.iv120
...
for.cond134:                                      ; preds = %for.inc151, %if.else
  %indvars.iv133 = phi i64 [ %indvars.iv.next134, %for.inc151 ], [ 1, %if.else ]
  %exitcond142.not = icmp eq i64 %indvars.iv133, %wide.trip.count141
  br i1 %exitcond142.not, label %for.end153, label %for.body136

for.body136:                                      ; preds = %for.cond134
  %arrayidx139 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv133, i64 4
  %17 = load i8, ptr %arrayidx139, align 2, !tbaa !9
  %18 = add nsw i64 %indvars.iv133, -1
...
for.end153.split.loop.exit:                       ; preds = %for.body136
  %indvars140.le = trunc i64 %indvars.iv133 to i32
  br label %for.end153

for.end153:                                       ; preds = %for.cond134, %for.end153.split.loop.exit
  %z.1.lcssa = phi i32 [ %indvars140.le, %for.end153.split.loop.exit ], [ %3, %for.cond134 ]
  %sub155 = add nsw i32 %z.1.lcssa, -1
  %wide.trip.count155 = zext i32 %sub155 to i64
  br label %for.cond154

for.cond154:                                      ; preds = %for.inc204, %for.end153
  %indvars.iv147 = phi i64 [ %indvars.iv.next148, %for.inc204 ], [ 0, %for.end153 ]
  %exitcond156.not = icmp eq i64 %indvars.iv147, %wide.trip.count155
  br i1 %exitcond156.not, label %for.cond207.preheader, label %for.cond159.preheader

for.cond207.preheader:                            ; preds = %for.cond154
  %wide.trip.count163 = zext i32 %z.1.lcssa to i64
  br label %for.cond207

for.cond159.preheader:                            ; preds = %for.cond154
  %arrayidx168 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv147, i64 5
  br label %for.cond159

for.cond159:                                      ; preds = %for.cond159.preheader, %for.inc201
  %indvars.iv149 = phi i64 [ %indvars.iv147, %for.cond159.preheader ], [ %indvars.iv.next150, %for.inc201 ]
  %indvars.iv.next150 = add nuw nsw i64 %indvars.iv149, 1
  %exitcond153.not = icmp eq i64 %indvars.iv149, %wide.trip.count155
  br i1 %exitcond153.not, label %for.inc204, label %for.body161

for.body161:                                      ; preds = %for.cond159
  %arrayidx164 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next150, i64 5
...
for.cond172:                                      ; preds = %for.body161, %for.inc197
  %indvars.iv143 = phi i64 [ %indvars.iv.next144, %for.inc197 ], [ 0, %for.body161 ]
  %exitcond146.not = icmp eq i64 %indvars.iv143, 6
  br i1 %exitcond146.not, label %for.inc201, label %for.inc197

for.inc197:                                       ; preds = %for.cond172
  %arrayidx178 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv.next150, i64 %indvars.iv143
  %22 = load i8, ptr %arrayidx178, align 1, !tbaa !9
  %arrayidx181 = getelementptr inbounds nuw [6 x i8], ptr %arrayidx96, i64 0, i64 %indvars.iv143
  store i8 %22, ptr %arrayidx181, align 1, !tbaa !9
  %arrayidx185 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv147, i64 %indvars.iv143
...
for.cond207:                                      ; preds = %for.cond207.preheader, %for.inc223
  %indvars.iv160 = phi i64 [ 0, %for.cond207.preheader ], [ %indvars.iv.next161, %for.inc223 ]
  %exitcond164.not = icmp eq i64 %indvars.iv160, %wide.trip.count163
  br i1 %exitcond164.not, label %if.end226, label %for.body209
...
for.cond211:                                      ; preds = %for.inc220, %for.body209
  %indvars.iv157 = phi i64 [ %indvars.iv.next158, %for.inc220 ], [ 0, %for.body209 ]
  %25 = load i32, ptr %n, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp212 = icmp slt i64 %indvars.iv157, %26
  br i1 %cmp212, label %for.inc220, label %for.inc223

for.inc220:                                       ; preds = %for.cond211
  %arrayidx217 = getelementptr inbounds nuw [501 x [6 x i8]], ptr %b, i64 0, i64 %indvars.iv160, i64 %indvars.iv157
  %27 = load i8, ptr %arrayidx217, align 1, !tbaa !9
  %conv218 = sext i8 %27 to i32
  %putchar94 = call i32 @putchar(i32 noundef %conv218) #9
