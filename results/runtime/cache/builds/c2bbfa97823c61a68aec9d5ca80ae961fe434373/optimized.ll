...
entry:
  %div23.loc = alloca double, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef %x1) #7
...
if.then:                                          ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 -1, ptr %div23.loc)
  call fastcc void @outlined_ir_func_0(ptr %b, ptr %a, ptr %c, ptr %x1, ptr %div23.loc, i32 0)
  %div23.reload = load double, ptr %div23.loc, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %div23.loc)
  %5 = load double, ptr %x1, align 8, !tbaa !9
  %call24 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %5, double noundef %div23.reload)
  br label %for.inc
...
if.then30:                                        ; preds = %if.else
  call fastcc void @outlined_ir_func_0(ptr %b, ptr %a, ptr %c, ptr %x1, ptr null, i32 -1)
  %6 = load double, ptr %x1, align 8, !tbaa !9
  %call49 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %6)
  br label %for.inc
...
if.else62:                                        ; preds = %if.then56
  %cmp63 = fcmp oeq double %1, 0.000000e+00
...
if.end67:                                         ; preds = %if.else62, %if.then64, %if.then58
  %d.3 = phi double [ %div61, %if.then58 ], [ %div66, %if.then64 ], [ %d.0, %if.else62 ]
  %mul70 = fmul double %1, %1
  %neg71 = fneg double %mul70
  %7 = call double @llvm.fmuladd.f64(double %mul9, double %3, double %neg71)
  %call72 = call double @sqrt(double noundef %7) #7, !tbaa !5
...
define internal fastcc void @outlined_ir_func_0(ptr %0, ptr %1, ptr %2, ptr %3, ptr %4, i32 %5) unnamed_addr #5 {
if.then_after_outline.exitStub:
  %6 = load double, ptr %0, align 8, !tbaa !9
  %fneg = fneg double %6
  ...
  %9 = call double @llvm.fmuladd.f64(double %6, double %6, double %neg14)
  %call15 = call double @sqrt(double noundef %9) #7, !tbaa !5
  %add = fadd double %fneg, %call15
  %mul = fmul double 2.000000e+00, %7
  %div = fdiv double %add, %mul
  store double %div, ptr %3, align 8, !tbaa !9
  %10 = load double, ptr %0, align 8, !tbaa !9
  %fneg16 = fneg double %10
  %11 = load double, ptr %1, align 8, !tbaa !9
  %mul18 = fmul double 4.000000e+00, %11
  %12 = load double, ptr %2, align 8, !tbaa !9
  %mul19 = fmul double %mul18, %12
  %neg20 = fneg double %mul19
  %13 = call double @llvm.fmuladd.f64(double %10, double %10, double %neg20)
  %call21 = call double @sqrt(double noundef %13) #7, !tbaa !5
  %sub = fsub double %fneg16, %call21
  %mul22 = fmul double 2.000000e+00, %11
  %div23 = fdiv double %sub, %mul22
  %cond = icmp eq i32 %5, 0
  br i1 %cond, label %output_block_0_0, label %final_block_0

output_block_0_0:                                 ; preds = %if.then_after_outline.exitStub
  store double %div23, ptr %4, align 8
  br label %final_block_0

final_block_0:                                    ; preds = %if.then_after_outline.exitStub, %output_block_0_0
  ret void
}
