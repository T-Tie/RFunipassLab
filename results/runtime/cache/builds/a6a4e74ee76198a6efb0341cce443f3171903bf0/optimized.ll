...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 100000, ptr nonnull %a) #5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %entry ]
  %exitcond.not = icmp eq i64 %indvars.iv, 1000
  br i1 %exitcond.not, label %for.end, label %if.else34.i
...
for.end:                                          ; preds = %if.else34.i, %for.cond
...
for.cond7:                                        ; preds = %for.body9, %for.end
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.body9 ], [ 1, %for.end ]
  %exitcond23 = icmp eq i64 %indvars.iv20, %wide.trip.count
  br i1 %exitcond23, label %for.end18, label %for.body9
...
for.body9:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv20
  %call.i.i12 = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr13) #5
...
for.end18:                                        ; preds = %for.cond7
  call void @llvm.lifetime.end.p0(i64 100000, ptr nonnull %a) #5
  ret i32 0
}
