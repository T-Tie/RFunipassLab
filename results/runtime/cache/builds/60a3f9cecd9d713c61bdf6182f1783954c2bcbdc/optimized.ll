...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  %i.sink2 = phi ptr [ %i, %for.body74 ], [ %j, %for.inc118 ]
  %10 = load i32, ptr %i.sink2, align 4, !tbaa !5
...
for.cond89:                                       ; preds = %for.inc114, %if.then88
  %.sink3 = phi i32 [ 0, %if.then88 ], [ %inc115, %for.inc114 ]
  %cmp90 = icmp slt i32 %.sink3, 6
  br i1 %cmp90, label %for.inc114, label %for.inc118

for.inc114:                                       ; preds = %for.cond89
  %idxprom94 = sext i32 %.sink3 to i64
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  ...
  %cmp160 = icmp slt i32 %add158, %z.0
