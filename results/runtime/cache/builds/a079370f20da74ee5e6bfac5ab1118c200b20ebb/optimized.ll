...
for.cond6:                                        ; preds = %for.inc16, %for.body4
  ...
  %2 = load i8, ptr %p.0, align 1, !tbaa !12, !invariant.load !13
...
for.cond23:                                       ; preds = %for.inc38, %for.end21
  ...
  %4 = load i8, ptr %q.1, align 1, !tbaa !12, !invariant.load !13
...
if.then30:                                        ; preds = %for.body26
  %6 = load i8, ptr %q.1, align 1, !tbaa !12, !invariant.load !13
  %conv31 = sext i8 %6 to i32
  %7 = load i32, ptr %arrayidx28, align 4, !tbaa !5, !invariant.load !13
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %conv31, i32 noundef %7) #6
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.2) #6
  br label %for.inc38
...
if.then42:                                        ; preds = %for.end40
  %call43 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #6
  br label %if.end44
