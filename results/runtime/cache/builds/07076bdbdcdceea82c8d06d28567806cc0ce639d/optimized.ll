...
for.cond2:                                        ; preds = %for.cond, %for.inc55
  ...
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc55 ], [ 0, %for.cond ]
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv29
...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %indvars.iv.next27.sink = phi i64 [ %indvars.iv.next27, %for.inc25 ], [ %idxprom12, %if.then ]
  %call20.sink = phi ptr [ %call20, %for.inc25 ], [ @_ZSt4cout, %if.then ]
  %arrayidx22 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next27.sink
  ...
  %cmp18.not.not = icmp slt i64 %indvars.iv.next27.sink, %indvars.iv29
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %indvars.iv.next24.sink = phi i64 [ %indvars.iv.next24, %for.inc44 ], [ %idxprom31, %if.then30 ]
  %call39.sink = phi ptr [ %call39, %for.inc44 ], [ @_ZSt4cout, %if.then30 ]
  %arrayidx41 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next24.sink
  ...
  %indvars.iv.next24 = add nsw i64 %indvars.iv.next24.sink, 1
  %cmp37 = icmp slt i64 %indvars.iv.next24, %indvars.iv29
...
for.inc55.sink.split:                             ; preds = %for.cond17, %for.end46
  ...
  %j.2.ph.in = phi i64 [ %indvars.iv.next24, %for.end46 ], [ %indvars.iv.next27, %for.cond17 ]
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %indvars.iv.next34.sink = phi i64 [ %indvars.iv.next34, %for.inc71 ], [ %idxprom58, %for.end57 ]
  %call66.sink = phi ptr [ %call66, %for.inc71 ], [ @_ZSt4cout, %for.end57 ]
  %arrayidx68 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next34.sink
  ...
  %indvars.iv.next34 = add nsw i64 %indvars.iv.next34.sink, 1
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next34, %5
