...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv6 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next7, %for.inc33 ]
...
for.cond7.preheader:                              ; preds = %for.cond3
  %3 = sub nsw i64 %1, %indvars.iv6
  br label %for.cond7

for.cond7:                                        ; preds = %for.cond7.preheader, %for.body10
  %indvars.iv3 = phi i64 [ 0, %for.cond7.preheader ], [ %indvars.iv.next4, %for.body10 ]
  %maxIndex.0 = phi i32 [ 0, %for.cond7.preheader ], [ %spec.select, %for.body10 ]
  %cmp8.not = icmp sgt i64 %indvars.iv3, %3
  br i1 %cmp8.not, label %for.end18, label %for.body10

for.body10:                                       ; preds = %for.cond7
  %arrayidx12 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv3
...
for.cond36:                                       ; preds = %for.cond36.preheader, %for.inc49
  %indvars.iv11 = phi i64 [ 0, %for.cond36.preheader ], [ %indvars.iv.next12, %for.inc49 ]
  %k.0 = phi i32 [ 0, %for.cond36.preheader ], [ %k.1, %for.inc49 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, %wide.trip.count14
  br i1 %exitcond15.not, label %for.end51, label %for.body38

for.body38:                                       ; preds = %for.cond36
  %arrayidx40 = getelementptr inbounds nuw [1000 x i32], ptr %sz, i64 0, i64 %indvars.iv11
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax25 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
  %wide.trip.count26 = zext nneg i32 %smax25 to i64
  br label %for.cond54

for.cond66.preheader:                             ; preds = %for.end51
  %sub67 = add nsw i32 %k.0, -1
  %wide.trip.count19 = zext nneg i32 %sub67 to i64
  br label %for.cond66

for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc60
  %indvars.iv21 = phi i64 [ 0, %for.cond54.preheader ], [ %indvars.iv.next22, %for.inc60 ]
  %exitcond27.not = icmp eq i64 %indvars.iv21, %wide.trip.count26
  br i1 %exitcond27.not, label %if.end80, label %for.inc60

for.inc60:                                        ; preds = %for.cond54
  %arrayidx58 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv21
...
for.cond66:                                       ; preds = %for.cond66.preheader, %for.inc73
  %indvars.iv16 = phi i64 [ 0, %for.cond66.preheader ], [ %indvars.iv.next17, %for.inc73 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end75, label %for.inc73

for.inc73:                                        ; preds = %for.cond66
  %arrayidx71 = getelementptr inbounds nuw [1000 x i32], ptr %js, i64 0, i64 %indvars.iv16
