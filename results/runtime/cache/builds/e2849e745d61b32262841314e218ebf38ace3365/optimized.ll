...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !21, !invariant.load !15
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !39, !invariant.load !15
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !45, !invariant.load !15
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !46, !invariant.load !15
