...
for.cond.i.i:                                     ; preds = %for.body.i.i, %for.cond.i
  %sum.0.i.i = phi i32 [ 1, %for.cond.i ], [ %mul.i.i, %for.body.i.i ]
  %k.0.i.i = phi i32 [ 1, %for.cond.i ], [ %inc.i.i, %for.body.i.i ]
  %exitcond.i.i = icmp eq i32 %k.0.i.i, %2
  br i1 %exitcond.i.i, label %_Z5powerii.exit.i, label %for.body.i.i
...
_Z5qufeni.exit:                                   ; preds = %_Z5powerii.exit.i
  %3 = call i32 @llvm.smax.i32(i32 %phiofops.i, i32 noundef 1)
  %smax = add nuw nsw i32 %3, 1
  br label %for.cond

for.cond:                                         ; preds = %for.body, %_Z5qufeni.exit
  %i.0 = phi i32 [ 2, %_Z5qufeni.exit ], [ %inc, %for.body ]
  %sum.0 = phi i32 [ 1, %_Z5qufeni.exit ], [ %add, %for.body ]
...
for.cond.i:                                       ; preds = %for.body.i, %for.cond
  %sum.0.i = phi i32 [ 1, %for.cond ], [ %mul.i, %for.body.i ]
  %k.0.i = phi i32 [ 1, %for.cond ], [ %inc.i, %for.body.i ]
  %exitcond.i = icmp eq i32 %k.0.i, %0
  br i1 %exitcond.i, label %_Z5powerii.exit, label %for.body.i
...
for.cond:                                         ; preds = %if.end5, %if.end
  %i.0 = phi i32 [ %h, %if.end ], [ %inc6, %if.end5 ]
  %j.0 = phi i32 [ 0, %if.end ], [ %j.1, %if.end5 ]
...
for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax17 = tail call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax17 to i64
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.body11
  %indvars.iv = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next, %for.body11 ]
  %count.0 = phi i32 [ 0, %for.cond9.preheader ], [ %add, %for.body11 ]
  %exitcond18.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond18.not, label %cleanup, label %for.body11
...
for.cond:                                         ; preds = %for.body, %entry
  %sum.0 = phi i32 [ 1, %entry ], [ %mul, %for.body ]
  %k.0 = phi i32 [ 1, %entry ], [ %inc, %for.body ]
