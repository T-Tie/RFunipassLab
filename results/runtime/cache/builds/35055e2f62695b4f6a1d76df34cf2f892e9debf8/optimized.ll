...
for.cond1:                                        ; preds = %for.cond, %for.inc
  %2 = phi i32 [ %.pre73, %for.inc ], [ %0, %for.cond ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv47, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv54 = phi i64 [ %indvars.iv.next55, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond59.not, label %for.end33, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  %4 = trunc nuw nsw i64 %indvars.iv54 to i32
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv50 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next51, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv50, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv54, i64 %indvars.iv50
...
for.cond34:                                       ; preds = %for.inc53, %for.end33
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc53 ], [ 0, %for.end33 ]
  %c.0 = phi i32 [ %c.1, %for.inc53 ], [ 0, %for.end33 ]
  %d.0 = phi i32 [ %d.1, %for.inc53 ], [ 0, %for.end33 ]
  %exitcond72.not = icmp eq i64 %indvars.iv66, %wide.trip.count58
  br i1 %exitcond72.not, label %for.end55, label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.cond34
  %8 = trunc nuw nsw i64 %indvars.iv66 to i32
  br label %for.cond37

for.cond37:                                       ; preds = %for.cond37.preheader, %for.body39
  %indvars.iv60 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next61, %for.body39 ]
  ...
  br i1 %exitcond65.not, label %for.inc53, label %for.body39

for.body39:                                       ; preds = %for.cond37
  %arrayidx43 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %s, i64 0, i64 %indvars.iv66, i64 %indvars.iv60
  %9 = load i32, ptr %arrayidx43, align 4, !tbaa !5
  %cmp44 = icmp eq i32 %9, 0
  %10 = zext i32 %c.1 to i64
  %cmp45 = icmp samesign uge i64 %indvars.iv66, %10
  %or.cond = select i1 %cmp44, i1 %cmp45, i1 false
  %11 = zext i32 %d.1 to i64
  %cmp47 = icmp samesign uge i64 %indvars.iv60, %11
  %or.cond45 = select i1 %or.cond, i1 %cmp47, i1 false
  %c.2 = select i1 %or.cond45, i32 %8, i32 %c.1
  %12 = trunc nuw nsw i64 %indvars.iv60 to i32
  %d.2 = select i1 %or.cond45, i32 %12, i32 %d.1
