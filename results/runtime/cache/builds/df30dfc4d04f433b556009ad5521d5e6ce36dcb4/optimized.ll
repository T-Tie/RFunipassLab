...
for.cond5:                                        ; preds = %for.inc19, %for.end
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.inc19 ], [ %idxprom2, %for.end ]
  %indvars42 = trunc i64 %indvars.iv33 to i32
  %cmp6 = icmp sgt i32 %indvars42, 0
  br i1 %cmp6, label %for.body7, label %for.end20

for.body7:                                        ; preds = %for.cond5
  %indvars.iv.next34 = add nsw i64 %indvars.iv33, -1
  %idxprom9 = and i64 %indvars.iv.next34, 4294967295
  ...
  %idxprom11 = and i64 %indvars.iv33, 2147483647
...
for.cond22:                                       ; preds = %for.end47, %for.end20
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %for.end47 ], [ %indvars.iv33, %for.end20 ]
...
for.cond29.preheader:                             ; preds = %for.cond22
  %arrayidx33 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv.next36
  br label %for.cond29

for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc45
  %indvars.iv30 = phi i64 [ %idxprom2, %for.cond29.preheader ], [ %indvars.iv.next31, %for.inc45 ]
  %sum.0 = phi i32 [ 1, %for.cond29.preheader ], [ %sum.1, %for.inc45 ]
  %p.1 = phi i32 [ %p.0, %for.cond29.preheader ], [ %p.2, %for.inc45 ]
  %cmp30.not = icmp slt i64 %indvars.iv30, %indvars.iv35
  br i1 %cmp30.not, label %for.end47, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %5 = load i32, ptr %arrayidx33, align 4, !tbaa !5, !invariant.load !12
  %arrayidx35 = getelementptr inbounds [30 x i32], ptr %a, i64 0, i64 %indvars.iv30
...
land.lhs.true:                                    ; preds = %for.body31
  %arrayidx38 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv30
...
for.end47:                                        ; preds = %for.cond29
  ...
  %8 = getelementptr inbounds [30 x i32], ptr %b, i64 0, i64 %indvars.iv.next36
...
for.cond60:                                       ; preds = %for.cond60.preheader, %for.body62
  %indvars.iv38 = phi i64 [ 0, %for.cond60.preheader ], [ %indvars.iv.next39, %for.body62 ]
  %sum.2 = phi i32 [ 0, %for.cond60.preheader ], [ %spec.select28, %for.body62 ]
  %exitcond.not = icmp eq i64 %indvars.iv38, %wide.trip.count
  br i1 %exitcond.not, label %for.end72, label %for.body62

for.body62:                                       ; preds = %for.cond60
  %arrayidx64 = getelementptr inbounds nuw [30 x i32], ptr %b, i64 0, i64 %indvars.iv38
  %9 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !12
  %spec.select28 = call i32 @llvm.smax.i32(i32 %9, i32 %sum.2)
