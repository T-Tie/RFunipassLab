...
if.then:                                          ; preds = %while.body5
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %0)
  %incdec.ptr = getelementptr inbounds nuw i8, ptr %p.0, i32 1
  br label %if.end

if.else:                                          ; preds = %while.body5
  %call9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %0)
...
!24 = !{!"p1 _ZTSNSt8ios_base14_Callback_listE", !15, i64 0}
!25 = !{!"_ZTSNSt8ios_base6_WordsE", !15, i64 0, !21, i64 8}
!26 = !{!"int", !6, i64 0}
