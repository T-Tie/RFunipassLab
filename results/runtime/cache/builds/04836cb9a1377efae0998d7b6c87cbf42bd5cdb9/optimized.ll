...
while.end31:                                      ; preds = %while.cond22
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %nPtr) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef %sPtr) #10
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %jump) #10
  call void @llvm.lifetime.end.p0(i64 noundef 800, ptr noundef %num) #10
  ret void
}
