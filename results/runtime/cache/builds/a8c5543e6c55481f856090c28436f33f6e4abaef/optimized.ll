...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  %indvars.iv27 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next28, %for.body4 ]
  %exitcond.not = icmp eq i64 %indvars.iv27, %wide.trip.count
  br i1 %exitcond.not, label %for.end9, label %for.body4
...
for.cond10:                                       ; preds = %for.end42, %for.end9
  %i.2 = phi i32 [ %sub, %for.end9 ], [ %dec, %for.end42 ]
...
for.cond13:                                       ; preds = %for.cond13.preheader, %if.end39
  %indvars.iv31 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next32, %if.end39 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  br i1 %cmp22.not, label %if.end39, label %if.then
...
if.end39:                                         ; preds = %if.then, %if.then31, %for.body15
...
for.cond50:                                       ; preds = %if.end73, %for.body48
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %if.end73 ], [ %indvars.iv34, %for.body48 ]
  %9 = icmp slt i64 %indvars.iv36, %1
...
if.end73:                                         ; preds = %if.then60, %for.body52
