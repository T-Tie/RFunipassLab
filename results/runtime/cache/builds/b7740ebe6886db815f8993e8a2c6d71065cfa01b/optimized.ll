...
while.body:                                       ; preds = %while.cond
  ...
  %or.cond16 = select i1 %cmp3.not, i1 true, i1 %cmp4.not
...
if.end19:                                         ; preds = %if.then18, %if.end14
  ...
  %or.cond14 = and i1 %cmp20, %cmp22
  br i1 %or.cond14, label %if.then23, label %if.end24
...
while.end:                                        ; preds = %while.cond
  ...
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11)
  %12 = load i32, ptr %b, align 4, !tbaa !5
  %call31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12)
