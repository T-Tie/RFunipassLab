...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc27
  %indvars.iv8 = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next9, %for.inc27 ]
  %exitcond18 = icmp eq i64 %indvars.iv8, %wide.trip.count17
  br i1 %exitcond18, label %for.cond30, label %for.body4
...
for.cond9:                                        ; preds = %for.body4, %for.inc24
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc24 ], [ %indvars.iv8, %for.body4 ]
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  %exitcond.not = icmp eq i64 %indvars.iv10, %wide.trip.count
  br i1 %exitcond.not, label %for.inc27, label %for.body11

for.body11:                                       ; preds = %for.cond9
  %arrayidx14 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv10
...
for.cond30:                                       ; preds = %for.cond2, %for.inc53
  ...
  %indvars.iv19 = phi i64 [ %indvars.iv.next20, %for.inc53 ], [ 0, %for.cond2 ]
  %b.0 = phi i32 [ %b.1, %for.inc53 ], [ 0, %for.cond2 ]
  %8 = sext i32 %7 to i64
  %cmp32.not.not = icmp slt i64 %indvars.iv19, %8
  br i1 %cmp32.not.not, label %for.body33, label %for.end55

for.body33:                                       ; preds = %for.cond30
  %arrayidx35 = getelementptr inbounds nuw [300 x i32], ptr %a, i64 0, i64 %indvars.iv19
