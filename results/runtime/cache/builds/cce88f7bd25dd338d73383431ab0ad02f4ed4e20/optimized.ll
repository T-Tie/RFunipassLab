...
for.cond71:                                       ; preds = %for.inc121, %for.end70
  %i.2 = phi i32 [ 0, %for.end70 ], [ %inc122, %for.inc121 ]
...
for.cond76:                                       ; preds = %for.inc118, %for.body74
  %i.2.sink = phi i32 [ %i.2, %for.body74 ], [ %add75, %for.inc118 ]
  %add75 = add nsw i32 %i.2.sink, 1
...
for.cond154:                                      ; preds = %for.inc204, %for.end153
  %i.4 = phi i32 [ 0, %for.end153 ], [ %inc205, %for.inc204 ]
...
for.cond159:                                      ; preds = %for.inc201, %for.body157
  %i.4.sink = phi i32 [ %i.4, %for.body157 ], [ %add158, %for.inc201 ]
  %add158 = add nsw i32 %i.4.sink, 1
  %cmp160 = icmp slt i32 %add158, %i.3
