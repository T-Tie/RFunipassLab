...
for.cond17:                                       ; preds = %for.end, %for.inc25
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc25 ], [ 0, %for.end ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc29, label %for.inc25
...
for.cond16:                                       ; preds = %for.end, %for.inc24
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc24 ], [ 0, %for.end ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.inc28, label %for.inc24
...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.inc11 ], [ 2, %entry ]
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc37
  %indvars.iv28 = phi i64 [ 2, %for.cond15.preheader ], [ %indvars.iv.next29, %for.inc37 ]
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc34
  ...
  br i1 %exitcond27.not, label %for.inc37, label %for.inc34
...
for.body6:                                        ; preds = %for.cond3
  %5 = or i64 %indvars.iv, %indvars.iv9
...
for.inc:                                          ; preds = %for.body6, %if.then
  ...
  %7 = phi i32 [ %3, %for.body6 ], [ %.pre12, %if.then ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.cond13:                                       ; preds = %for.cond, %for.inc17
  %storemerge = phi i32 [ %dec, %for.inc17 ], [ %1, %for.cond ]
...
for.inc17:                                        ; preds = %for.cond13
  ...
  %9 = load i32, ptr getelementptr inbounds nuw (i8, ptr @a, i64 408), align 4, !tbaa !5
...
!38 = !{!39, !43, i64 240}
!39 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !24, i64 0, !40, i64 216, !7, i64 224, !41, i64 225, !42, i64 232, !43, i64 240, !44, i64 248, !45, i64 256}
!40 = !{!"p1 _ZTSSo", !29, i64 0}
!41 = !{!"bool", !7, i64 0}
!42 = !{!"p1 _ZTSSt15basic_streambufIcSt11char_traitsIcEE", !29, i64 0}
!43 = !{!"p1 _ZTSSt5ctypeIcE", !29, i64 0}
!44 = !{!"p1 _ZTSSt7num_putIcSt19ostreambuf_iteratorIcSt11char_traitsIcEEE", !29, i64 0}
!45 = !{!"p1 _ZTSSt7num_getIcSt19istreambuf_iteratorIcSt11char_traitsIcEEE", !29, i64 0}
!46 = !{!47, !7, i64 56}
...
!49 = !{!"p1 _ZTS15__locale_struct", !29, i64 0}
!50 = !{!"p1 int", !29, i64 0}
!51 = !{!"p1 short", !29, i64 0}
!52 = !{!7, !7, i64 0}
