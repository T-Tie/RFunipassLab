...
entry:
  ...
  %smax24 = call i32 @llvm.smax.i32(i32 %sub, i32 -1)
  %1 = add i32 %smax24, 1
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond26, label %for.cond15.preheader, label %for.cond4

for.cond15.preheader:                             ; preds = %for.cond
  %wide.trip.count32 = zext i32 %sub to i64
  br label %for.cond15
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv21, i64 %indvars.iv
...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc42
  %indvars.iv27 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next28, %for.inc42 ]
  %exitcond36 = icmp eq i64 %indvars.iv27, %wide.trip.count25
  br i1 %exitcond36, label %for.cond45, label %for.cond21.preheader
...
for.cond21:                                       ; preds = %for.cond21.preheader, %for.inc39
  %indvars.iv29 = phi i64 [ %indvars.iv27, %for.cond21.preheader ], [ %indvars.iv.next30, %for.inc39 ]
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count32
  br i1 %exitcond33.not, label %for.inc42, label %for.body25

for.body25:                                       ; preds = %for.cond21
  %arrayidx30 = getelementptr inbounds nuw [501 x [5 x i8]], ptr %a, i64 0, i64 %indvars.iv.next30
...
if.then:                                          ; preds = %for.body25
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5, !invariant.load !10
...
for.cond45:                                       ; preds = %for.cond15, %for.inc66
  ...
  %.sink = phi i32 [ %dec, %for.inc66 ], [ 500, %for.cond15 ]
  %cmp46.not = icmp eq i32 %.sink, 0
...
for.cond49:                                       ; preds = %land.end, %for.inc63
  ...
  %exitcond41 = icmp eq i64 %indvars.iv37, %wide.trip.count25
  br i1 %exitcond41, label %for.inc66, label %for.body53

for.body53:                                       ; preds = %for.cond49
  %arrayidx55 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv37
  %5 = load i32, ptr %arrayidx55, align 4, !tbaa !5, !invariant.load !10
  %cmp56 = icmp eq i32 %5, %.sink
...
if.else71:                                        ; preds = %if.else71.loopexit, %for.end67
  %.sink16 = phi i32 [ %7, %if.else71.loopexit ], [ 2, %for.end67 ]
  %call73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %.sink16)
  %smax45 = call i32 @llvm.smax.i32(i32 %z.0, i32 0)
...
for.inc83:                                        ; preds = %for.cond74
  ...
  %8 = load i32, ptr %arrayidx78, align 4, !tbaa !5, !invariant.load !10
