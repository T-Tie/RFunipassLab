...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 101, ptr nonnull %a) #7
  ...
  call void @llvm.lifetime.start.p0(i64 15000, ptr nonnull %b) #7
  br label %for.cond
...
for.end25:                                        ; preds = %for.cond16
  ...
  call void @llvm.lifetime.end.p0(i64 15000, ptr nonnull %b) #7
  call void @llvm.lifetime.end.p0(i64 101, ptr nonnull %a) #7
  ret i32 0
}
