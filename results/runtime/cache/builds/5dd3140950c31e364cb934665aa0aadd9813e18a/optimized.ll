...
while.cond:                                       ; preds = %for.end20, %entry
  %k.0 = phi i32 [ 1, %entry ], [ %k.1.lcssa, %for.end20 ]
...
for.end20:                                        ; preds = %for.cond1
  %k.1.lcssa = phi i32 [ %k.1, %for.cond1 ]
  br label %while.cond, !llvm.loop !13

while.end:                                        ; preds = %while.cond
  %k.0.lcssa = phi i32 [ %k.0, %while.cond ]
  %sub21 = sub nsw i32 %k.0.lcssa, 1
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc28, %while.end
  %i.2 = phi i32 [ %sub21, %while.end ], [ %dec29, %for.inc28 ]
