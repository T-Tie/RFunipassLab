...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 256, ptr noundef nonnull align 16 %a) #7
...
for.inc68:                                        ; preds = %for.cond58
  ...
  %17 = add nuw nsw i64 %add64, %indvars.iv29
...
for.end75:                                        ; preds = %for.cond, %for.cond58
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef nonnull %a) #9
  ret i32 0
}
