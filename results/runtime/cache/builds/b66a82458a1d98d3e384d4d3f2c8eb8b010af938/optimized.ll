...
for.cond2:                                        ; preds = %for.cond, %for.inc74
  ...
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc74 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %for.inc74 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %for.inc74 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv12, %5
  %idxprom77 = sext i32 %k.0 to i64
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv12
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %6 = add i32 %smax22, 1
  %wide.trip.count23 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.inc116, %for.end76
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc116 ], [ 0, %for.end76 ]
  %exitcond24 = icmp eq i64 %indvars.iv18, %wide.trip.count23
  br i1 %exitcond24, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv18
  ...
  %arrayidx103 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv18, i64 %7
  br label %for.cond94

for.cond94:                                       ; preds = %for.inc113, %for.body88
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc113 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond.not, label %for.inc116, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv15, %7
...
if.else106:                                       ; preds = %for.body96
  %arrayidx110 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv18, i64 %indvars.iv15
