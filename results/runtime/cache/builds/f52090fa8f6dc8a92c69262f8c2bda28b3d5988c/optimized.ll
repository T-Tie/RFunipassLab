...
if.end:                                           ; preds = %if.then, %for.body6
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %p) #4
...
for.body18:                                       ; preds = %for.cond15
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i19) #4
...
for.cond.cleanup23:                               ; preds = %for.cond20
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i19) #4
  br label %for.end44
...
for.end44:                                        ; preds = %for.cond.cleanup23
  br label %for.inc45
...
for.end47:                                        ; preds = %for.cond.cleanup17
  br label %for.inc48
...
for.end50:                                        ; preds = %for.cond.cleanup5
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i51) #4
...
for.cond.cleanup54:                               ; preds = %for.cond52
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %i51) #4
  br label %for.end68
...
if.else:                                          ; preds = %for.body55
  ...
  %call64 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13)
  br label %if.end65
...
for.end68:                                        ; preds = %for.cond.cleanup54
