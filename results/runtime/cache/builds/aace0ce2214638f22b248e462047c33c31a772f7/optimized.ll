...
for.body19:                                       ; preds = %for.cond17
  ...
  %11 = load i32, ptr %arrayidx23, align 4, !tbaa !5, !invariant.load !13
...
for.body26:                                       ; preds = %for.cond24
  ...
  %13 = load i32, ptr %arrayidx30, align 4, !tbaa !5, !invariant.load !13
...
for.inc47:                                        ; preds = %for.cond39
  ...
  %17 = load i32, ptr %arrayidx45, align 4, !tbaa !5, !invariant.load !13
...
for.body55:                                       ; preds = %for.cond53
  ...
  %20 = load i32, ptr %arrayidx59, align 4, !tbaa !5, !invariant.load !13
...
for.body62:                                       ; preds = %for.cond60
  ...
  %23 = load i32, ptr %arrayidx66, align 4, !tbaa !5, !invariant.load !13
...
for.inc85:                                        ; preds = %for.cond77
  ...
  %28 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !13
...
for.end90:                                        ; preds = %for.cond53
  ...
  %arrayidx99 = getelementptr inbounds i32, ptr %vla, i64 %19
  %arrayidx101 = getelementptr inbounds i32, ptr %arrayidx99, i64 %idxprom98
  %32 = load i32, ptr %arrayidx101, align 4, !tbaa !5, !invariant.load !13
  store i32 %32, ptr %arrayidx96, align 4, !tbaa !5
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %34 = load i32, ptr %arrayidx115, align 4, !tbaa !5, !invariant.load !13
  %arrayidx120 = getelementptr inbounds i32, ptr %arrayidx93, i64 %idxprom114
  store i32 %34, ptr %arrayidx120, align 4, !tbaa !5
  %35 = mul nsw i64 %idxprom114, %2
  %arrayidx122 = getelementptr inbounds i32, ptr %vla, i64 %35
  %arrayidx124 = getelementptr inbounds i32, ptr %arrayidx122, i64 %idxprom98
  %36 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  %arrayidx129 = getelementptr inbounds i32, ptr %arrayidx122, i64 %idxprom92
  store i32 %36, ptr %arrayidx129, align 4, !tbaa !5
...
for.inc138:                                       ; preds = %for.cond14
  %37 = load i32, ptr %number, align 4, !tbaa !5
  %call136 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %37)
