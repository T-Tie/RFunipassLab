...
for.cond:                                         ; preds = %for.cond, %entry
  ...
  br i1 %cmp, label %for.cond, label %for.end26

for.end26:                                        ; preds = %for.cond
  %1 = getelementptr inbounds [100 x i32], ptr %a, i64 0, i64 1
  %2 = load i32, ptr %1, align 4, !tbaa !5
  %arrayidx19.1 = getelementptr inbounds nuw i8, ptr %a, i64 4
  store i32 %2, ptr %arrayidx19.1, align 4, !tbaa !5
  %3 = load i32, ptr %a, align 16, !tbaa !5
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %3, i32 noundef %2) #5
