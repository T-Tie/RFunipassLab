...
for.cond.preheader:                               ; preds = %tailrecurse
  %smax = tail call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond31.preheader:                             ; preds = %for.cond
  br i1 %cmp32, label %for.cond31.preheader38, label %for.end68

for.cond31.preheader38:                           ; preds = %for.cond31.preheader
  br label %for.cond31
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc25 ], [ 0, %for.cond14.preheader ]
...
for.cond31:                                       ; preds = %for.cond51, %for.cond31.preheader38
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv23 = phi i64 [ 0, %for.cond31 ], [ %indvars.iv.next24, %for.body36 ]
...
for.body36:                                       ; preds = %for.cond34
  %arrayidx38 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %spec.select8 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond34, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc63 ], [ 0, %for.cond51.preheader ]
  %exitcond36.not = icmp eq i64 %indvars.iv30, %wide.trip.count21
  br i1 %exitcond36.not, label %for.cond31, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx55 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv30
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 57600, ptr noundef nonnull align 16 captures(none) dereferenceable(57600) %a) #7
