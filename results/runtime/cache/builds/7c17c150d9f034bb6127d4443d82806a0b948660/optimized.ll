...
for.cond1:                                        ; preds = %for.cond, %if.end10
  %1 = phi i32 [ %.pre17, %if.end10 ], [ %0, %for.cond ]
  %j.0 = phi i32 [ %inc, %if.end10 ], [ 1, %for.cond ]
  %a1.1 = phi i32 [ %a1.212, %if.end10 ], [ %a1.0, %for.cond ]
  %a2.1 = phi i32 [ %a2.214, %if.end10 ], [ %a2.0, %for.cond ]
...
land.lhs.true:                                    ; preds = %for.body4
  ...
  %spec.select16 = select i1 %cmp7, i32 %i.0, i32 %a1.1
  br label %if.end10

if.end10:                                         ; preds = %land.lhs.true, %for.body4
  %a2.214 = phi i32 [ %a2.1, %for.body4 ], [ %spec.select, %land.lhs.true ]
  %a1.212 = phi i32 [ %a1.1, %for.body4 ], [ %spec.select16, %land.lhs.true ]
