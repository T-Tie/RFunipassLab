...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.cond.loopexit ], [ 2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond.loopexit ], [ 1, %entry ]
  %exitcond65.not = icmp eq i64 %indvars.iv59, 14
  br i1 %exitcond65.not, label %for.cond20.preheader, label %for.cond2.preheader
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc14
  %indvars.iv61 = phi i64 [ %indvars.iv.next62, %for.inc14 ], [ %indvars.iv59, %for.cond2.preheader ]
  %exitcond.not = icmp eq i64 %indvars.iv61, 13
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  br label %for.cond5

for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc ], [ %indvars.iv, %for.cond5.preheader ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond5.preheader ]
  %cmp6.not.not = icmp samesign ult i64 %indvars.iv56, %indvars.iv61
  br i1 %cmp6.not.not, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv56
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv61
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc27
  %indvars.iv66 = phi i64 [ %indvars.iv.next67, %for.inc27 ], [ 1, %for.cond20.preheader ]
  %exitcond69.not = icmp eq i64 %indvars.iv66, 13
  br i1 %exitcond69.not, label %for.cond30.preheader, label %for.inc27

for.cond30.preheader:                             ; preds = %for.cond20
  br label %for.cond30

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv66, i64 %indvars.iv66
  store i32 1, ptr %arrayidx26, align 4, !tbaa !8
  %indvars.iv.next67 = add nuw nsw i64 %indvars.iv66, 1
  br label %for.cond20, !llvm.loop !14

for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc48
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %for.inc48 ], [ 1, %for.cond30.preheader ]
  %exitcond77.not = icmp eq i64 %indvars.iv74, 13
  br i1 %exitcond77.not, label %for.cond51.preheader, label %for.cond33.preheader

for.cond33.preheader:                             ; preds = %for.cond30
  br label %for.cond33

for.cond51.preheader:                             ; preds = %for.cond30
  br label %for.cond51

for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc45
  %indvars.iv70 = phi i64 [ %indvars.iv.next71, %for.inc45 ], [ 1, %for.cond33.preheader ]
  %exitcond73.not = icmp eq i64 %indvars.iv70, %indvars.iv74
  br i1 %exitcond73.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv70, i64 %indvars.iv74
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !8
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv74, i64 %indvars.iv70
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.cond51.loopexit
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.cond51.loopexit ], [ 2, %for.cond51.preheader ]
  %indvars.iv78 = phi i64 [ %indvars.iv.next79, %for.cond51.loopexit ], [ 1, %for.cond51.preheader ]
  %exitcond90.not = icmp eq i64 %indvars.iv83, 14
  br i1 %exitcond90.not, label %for.cond82.preheader, label %for.cond55.preheader

for.cond55.preheader:                             ; preds = %for.cond51
  br label %for.cond55

for.cond82.preheader:                             ; preds = %for.cond51
  br label %for.cond82

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc76
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %for.inc76 ], [ %indvars.iv83, %for.cond55.preheader ]
  %exitcond88.not = icmp eq i64 %indvars.iv85, 13
  br i1 %exitcond88.not, label %for.cond51.loopexit, label %for.cond58.preheader

for.cond58.preheader:                             ; preds = %for.cond55
  br label %for.cond58

for.cond58:                                       ; preds = %for.cond58.preheader, %for.inc65
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc65 ], [ %indvars.iv78, %for.cond58.preheader ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond58.preheader ]
  %cmp60.not.not = icmp samesign ult i64 %indvars.iv80, %indvars.iv85
  br i1 %cmp60.not.not, label %for.inc65, label %for.end67

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv80
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv78, i64 %indvars.iv85
...
for.cond82:                                       ; preds = %for.cond82.preheader, %for.inc89
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.inc89 ], [ 1, %for.cond82.preheader ]
  %exitcond94.not = icmp eq i64 %indvars.iv91, 13
  br i1 %exitcond94.not, label %for.cond92.preheader, label %for.inc89

for.cond92.preheader:                             ; preds = %for.cond82
  br label %for.cond92

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv91, i64 %indvars.iv91
  store i32 1, ptr %arrayidx88, align 4, !tbaa !8
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  br label %for.cond82, !llvm.loop !20

for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc110
  %indvars.iv99 = phi i64 [ %indvars.iv.next100, %for.inc110 ], [ 1, %for.cond92.preheader ]
  %exitcond102.not = icmp eq i64 %indvars.iv99, 13
  br i1 %exitcond102.not, label %for.end112, label %for.cond95.preheader

for.cond95.preheader:                             ; preds = %for.cond92
  br label %for.cond95

for.cond95:                                       ; preds = %for.cond95.preheader, %for.inc107
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc107 ], [ 1, %for.cond95.preheader ]
  %exitcond98.not = icmp eq i64 %indvars.iv95, %indvars.iv99
  br i1 %exitcond98.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv95, i64 %indvars.iv99
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !8
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv99, i64 %indvars.iv95
...
for.inc141:                                       ; preds = %if.else129, %if.then119
  ...
  %puts54 = call i32 @puts(ptr nonnull dereferenceable(1) %str.2.sink) #7
