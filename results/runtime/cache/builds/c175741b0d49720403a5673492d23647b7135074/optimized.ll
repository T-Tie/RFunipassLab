...
for.end30:                                        ; preds = %for.cond11
  %s.0.lcssa = phi i32 [ %s.0, %for.cond11 ]
  %r.0.lcssa = phi i32 [ %r.0, %for.cond11 ]
...
for.end53:                                        ; preds = %for.cond31
  %q.0.lcssa = phi i32 [ %q.0, %for.cond31 ]
  %p.0.lcssa = phi i32 [ %p.0, %for.cond31 ]
  %p.0.lcssa.neg = sub i32 0, %p.0.lcssa
  %sub54 = add i32 %r.0.lcssa, -1
  %sub55 = add i32 %sub54, %p.0.lcssa.neg
  %s.0.lcssa.neg = sub i32 0, %s.0.lcssa
  %sub56 = add i32 %s.0.lcssa.neg, -1
  %sub57 = add i32 %sub56, %q.0.lcssa
