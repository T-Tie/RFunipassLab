...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %k) #6
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %Max2) #6
...
for.end28:                                        ; preds = %for.cond13
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %Max2) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %Max) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %n) #6
  call void @llvm.lifetime.end.p0(i64 400, ptr %k) #6
  ret i32 0
}
