...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %a) #8
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %b) #8
...
for.inc:                                          ; preds = %for.cond
  %call.i = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull align 4 dereferenceable(4) %a)
  %call.i3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIfEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 4 dereferenceable(4) %b)
  %5 = load float, ptr %b, align 4, !tbaa !9
  %6 = load float, ptr %a, align 4, !tbaa !9
  %div = fdiv float %5, %6
...
for.cond3:                                        ; preds = %for.cond, %for.inc25
  %7 = phi i32 [ %.pre, %for.inc25 ], [ %3, %for.cond ]
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc25 ], [ 1, %for.cond ]
  %8 = sext i32 %7 to i64
  %cmp4 = icmp slt i64 %indvars.iv9, %8
  br i1 %cmp4, label %for.body5, label %for.end27

for.body5:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw float, ptr %vla, i64 %indvars.iv9
  %9 = load float, ptr %arrayidx7, align 4, !tbaa !9
  %10 = load float, ptr %vla, align 16, !tbaa !9
  %sub = fsub float %9, %10
  %conv = fpext float %sub to double
  %cmp9 = fcmp ogt double %conv, 5.000000e-02
  br i1 %cmp9, label %for.inc25, label %if.else

if.else:                                          ; preds = %for.body5
  %sub15 = fsub float %10, %9
  %conv16 = fpext float %sub15 to double
  %cmp17 = fcmp ogt double %conv16, 5.000000e-02
  br i1 %cmp17, label %for.inc25, label %if.else21

if.else21:                                        ; preds = %if.else
  br label %for.inc25

for.inc25:                                        ; preds = %for.body5, %if.else, %if.else21
  %.str.2.sink.sink = phi ptr [ @.str, %for.body5 ], [ @.str.2, %if.else21 ], [ @.str.1, %if.else ]
  %call.i.i = call noundef i64 @strlen(ptr noundef nonnull dereferenceable(5) %.str.2.sink.sink) #8
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink.sink, i64 noundef %call.i.i)
...
for.end27:                                        ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %b) #8
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !18
