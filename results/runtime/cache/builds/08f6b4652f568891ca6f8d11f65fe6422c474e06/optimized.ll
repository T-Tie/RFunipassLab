...
tailrecurse:                                      ; preds = %for.end127, %entry
  ...
  %smax43 = call i32 @llvm.smax.i32(i32 %t.tr, i32 0)
...
for.cond28.preheader:                             ; preds = %for.cond
  %wide.trip.count18 = zext i32 %t.tr to i64
  br label %for.cond28
...
if.end68:                                         ; preds = %for.end65
  %wide.trip.count36 = zext i32 %t.tr to i64
  br label %for.cond69
...
for.inc122.gvnsink.split:                         ; preds = %lor.lhs.false.thread, %land.lhs.true
  %indvars.iv38.sink = phi i64 [ %indvars.iv38, %land.lhs.true ], [ %5, %lor.lhs.false.thread ]
  ...
  %arrayidx94 = getelementptr inbounds [100 x [100 x i32]], ptr @a, i64 0, i64 %indvars.iv38.sink, i64 %10
