...
while.body:                                       ; preds = %entry, %if.end17
  ...
  switch i32 %conv3, label %if.end17.gvnsink.split [
...
if.else9:                                         ; preds = %while.body
  ...
  %cmp13.not = icmp eq i8 %0, 32
  br i1 %cmp13.not, label %if.end17, label %if.end17.gvnsink.split

if.end17.gvnsink.split:                           ; preds = %while.body, %if.else9
...
for.inc:                                          ; preds = %for.cond
  ...
  %1 = load i8, ptr %arrayidx20, align 1, !tbaa !5, !invariant.load !11
