...
for.cond30:                                       ; preds = %for.inc40, %for.body29
  %.sink9 = phi i32 [ %1, %for.body29 ], [ %dec, %for.inc40 ]
  %cmp31 = icmp sge i32 %.sink9, 1
...
for.body32:                                       ; preds = %for.cond30
  ...
  %idxprom35 = sext i32 %.sink9 to i64
...
if.then38:                                        ; preds = %for.body32
  ...
  store i32 %.sink9, ptr %j2, align 4, !tbaa !5
  br label %for.inc42

for.inc40:                                        ; preds = %for.body32
  %dec = add nsw i32 %.sink9, -1
