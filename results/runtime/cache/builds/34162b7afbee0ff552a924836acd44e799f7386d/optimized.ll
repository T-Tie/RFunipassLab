...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv31 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next32, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv31, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax46 = add nsw i32 %3, -1
  %wide.trip.count47 = zext nneg i32 %smax46 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv35 = phi i64 [ %2, %for.cond13.preheader ], [ %indvars.iv.next36, %for.inc40 ]
  %indvars.iv.next36 = add nuw nsw i64 %indvars.iv35, 1
  %4 = trunc nuw i64 %indvars.iv.next36 to i32
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next36
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv43 = phi i64 [ %indvars.iv.next44, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond48.not = icmp eq i64 %indvars.iv43, %wide.trip.count47
  br i1 %exitcond48.not, label %for.end79, label %for.body48
...
for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.inc74 ], [ %indvars.iv38, %for.body48 ]
  %9 = trunc nuw i64 %indvars.iv40 to i32
...
for.body52:                                       ; preds = %for.cond50
  ...
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv40, i32 1
