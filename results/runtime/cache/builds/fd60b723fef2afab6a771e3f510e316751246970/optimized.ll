...
for.cond17:                                       ; preds = %for.inc25, %if.then
  %j.1 = phi i32 [ %j.0, %if.then ], [ %add16, %for.inc25 ]
  %_ZSt4cout.sink2 = phi ptr [ @_ZSt4cout, %if.then ], [ %call20, %for.inc25 ]
  %idxprom12 = sext i32 %j.1 to i64
  %arrayidx13 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom12
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink2, ptr noundef nonnull %arrayidx13)
  %add16 = add nsw i32 %j.1, 1
...
for.cond36:                                       ; preds = %for.inc44, %if.then30
  %j.3 = phi i32 [ %j.0, %if.then30 ], [ %add35, %for.inc44 ]
  %_ZSt4cout.sink1 = phi ptr [ @_ZSt4cout, %if.then30 ], [ %call39, %for.inc44 ]
  %idxprom31 = sext i32 %j.3 to i64
  %arrayidx32 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %idxprom31
  %call34 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink1, ptr noundef nonnull %arrayidx32)
  %add35 = add nsw i32 %j.3, 1
...
for.inc55.gvnsink.split:                          ; preds = %for.cond17, %for.end46
  %j.5 = phi i32 [ %add35, %for.end46 ], [ %add16, %for.cond17 ]
...
for.inc55:                                        ; preds = %for.inc55.gvnsink.split, %if.end
  %j.2 = phi i32 [ %j.5, %for.inc55.gvnsink.split ], [ %j.0, %if.end ]
...
for.cond63:                                       ; preds = %for.inc71, %for.end57
  %j.4 = phi i32 [ %j.0, %for.end57 ], [ %add62, %for.inc71 ]
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %for.end57 ], [ %call66, %for.inc71 ]
  %idxprom58 = sext i32 %j.4 to i64
