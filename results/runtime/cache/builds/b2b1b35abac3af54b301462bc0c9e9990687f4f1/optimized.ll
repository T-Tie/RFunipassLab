...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond22.not, label %for.cond45, label %for.body16
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, %wide.trip.count21
  br i1 %exitcond33.not, label %for.cond70, label %for.cond49.preheader
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv39 = phi i64 [ %indvars.iv.next40, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond44.not = icmp eq i64 %indvars.iv39, %wide.trip.count21
  br i1 %exitcond44.not, label %for.cond104, label %for.body73
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond66.not, label %for.cond154, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv56 = phi i64 [ %indvars.iv.next57, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond60.not = icmp eq i64 %indvars.iv56, %wide.trip.count
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv72 = phi i64 [ %indvars.iv.next73, %for.inc174 ], [ 0, %for.cond131 ]
