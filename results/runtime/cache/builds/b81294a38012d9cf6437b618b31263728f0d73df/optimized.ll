...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %money) #9
  ...
  %div92 = sdiv i8 %div9.lhs.trunc, 5
  %div9.sext = sext i8 %div92 to i32
  ...
  %call15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call14, i32 noundef %div1.sext)
  ...
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call20, i32 noundef %div9.sext)
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %money) #10
  ret i32 0
}
