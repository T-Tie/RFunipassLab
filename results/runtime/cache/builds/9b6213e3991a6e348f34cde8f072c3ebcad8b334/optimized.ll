...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end23
  %indvars.iv23 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next24, %if.end23 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.1, %if.end23 ]
  %exitcond28.not = icmp eq i64 %indvars.iv23, %wide.trip.count27
  br i1 %exitcond28.not, label %for.cond27.preheader, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv23
  %2 = load i32, ptr %arrayidx11, align 4, !tbaa !5, !invariant.load !12
  br label %for.cond5

for.cond27.preheader:                             ; preds = %for.cond2
  %smax33 = call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %A, i64 0, i64 %indvars.iv20
  %3 = load i32, ptr %arrayidx9, align 4, !tbaa !5, !invariant.load !12
  %cmp12 = icmp eq i32 %3, %2
  %indvars.iv.next21 = add nuw nsw i64 %indvars.iv20, 1
  br i1 %cmp12, label %if.end23, label %for.cond5, !llvm.loop !13

if.then17:                                        ; preds = %for.cond5
  %idxprom20 = sext i32 %j.0 to i64
  %arrayidx21 = getelementptr inbounds [20000 x i32], ptr %B, i64 0, i64 %idxprom20
  store i32 %2, ptr %arrayidx21, align 4, !tbaa !5
  %add = add nsw i32 %j.0, 1
  br label %if.end23

if.end23:                                         ; preds = %for.body7, %if.then17
  %j.1 = phi i32 [ %add, %if.then17 ], [ %j.0, %for.body7 ]
  %indvars.iv.next24 = add nuw nsw i64 %indvars.iv23, 1
  br label %for.cond2, !llvm.loop !14

for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv29 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next30, %for.body29 ]
  %exitcond34.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond34.not, label %for.end41, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %cmp30 = icmp eq i64 %indvars.iv29, 0
  %4 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv29
  %5 = load i32, ptr %4, align 4, !tbaa !5, !invariant.load !12
  %.str..str.1 = select i1 %cmp30, ptr @.str, ptr @.str.1
  %call37 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %5) #6
