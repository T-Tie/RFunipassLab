...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr %total) #10
  call void @llvm.lifetime.start.p0(i64 80000, ptr %valid) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %t1) #10
  call void @llvm.lifetime.start.p0(i64 8, ptr %v1) #10
  call void @llvm.lifetime.start.p0(i64 80000, ptr %x) #10
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr %x) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %v1) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %t1) #10
  call void @llvm.lifetime.end.p0(i64 80000, ptr %valid) #10
  call void @llvm.lifetime.end.p0(i64 80000, ptr %total) #10
  ret i32 0
}
...
if.then_to_outline:                               ; preds = %newFuncRoot
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef %0)
