...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %an) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(400) %an, ptr noundef nonnull align 16 dereferenceable(400) @__const.main.an, i64 400, i1 false)
...
for.cond38:                                       ; preds = %for.cond38.preheader, %for.body41
  %indvars.iv30 = phi i64 [ %3, %for.cond38.preheader ], [ %5, %for.body41 ]
  %4 = trunc nuw i64 %indvars.iv30 to i32
  %cmp39 = icmp sgt i32 %4, 0
  br i1 %cmp39, label %for.body41, label %if.end49
...
if.end49:                                         ; preds = %for.cond38, %if.then
  ...
  %vtable.i18 = load ptr, ptr %_ZSt4cout.sink35, align 8, !tbaa !15
  %vbase.offset.ptr.i19 = getelementptr i8, ptr %vtable.i18, i64 -24
  %vbase.offset.i20 = load i64, ptr %vbase.offset.ptr.i19, align 8
  %add.ptr.i21 = getelementptr inbounds i8, ptr %_ZSt4cout.sink35, i64 %vbase.offset.i20
  ...
  %call1.i22 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %_ZSt4cout.sink35, i8 noundef signext %call.i)
  ...
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %an) #6
