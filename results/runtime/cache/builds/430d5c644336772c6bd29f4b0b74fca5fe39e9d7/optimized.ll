...
if.then8:                                         ; preds = %if.end
  %fneg9 = fneg double %3
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call13.loc)
  call fastcc void @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call13.loc) #9
  %call13.reload = load double, ptr %call13.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call13.loc)
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call19.loc)
  call fastcc void @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call19.loc) #9
  %call19.reload = load double, ptr %call19.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call19.loc)
  %sub = fsub double %fneg14, %call19.reload
  %9 = load double, ptr @a, align 8, !tbaa !9
  %mul20 = fmul double 2.000000e+00, %9
  ...
  %call23 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %10) #9
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %11) #9
...
if.then30:                                        ; preds = %if.end28
  ...
  %mul33 = fmul double 2.000000e+00, %14
  %div34 = fdiv double %fneg32, %mul33
  %call35 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div34) #9
...
if.then39:                                        ; preds = %if.end37
  ...
  %mul42 = fmul double 2.000000e+00, %17
  %div43 = fdiv double %fneg41, %mul42
  %call44 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div43) #9
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call50.loc)
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call50.loc) #9
  %call50.reload = load double, ptr %call50.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call50.loc)
  %18 = load double, ptr @a, align 8, !tbaa !9
  %mul51 = fmul double 2.000000e+00, %18
  %div52 = fdiv double %call50.reload, %mul51
  %call53 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div52) #9
  ...
  %call60 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div59) #9
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call65.loc)
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call65.loc) #9
  %call65.reload = load double, ptr %call65.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull align 8 dereferenceable(8) %call65.loc)
  ...
  %call69 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %div68) #9
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #8 {
if.then39_after_outline.exitStub:
  %1 = load double, ptr @a, align 8, !tbaa !9
  %mul46 = fmul double 4.000000e+00, %1
  %2 = load double, ptr @c, align 8, !tbaa !9
  %3 = load double, ptr @b, align 8, !tbaa !9
  %mul48 = fmul double %3, %3
  %neg49 = fneg double %mul48
  %4 = call double @llvm.fmuladd.f64(double %mul46, double %2, double %neg49) #10
  %call50 = call double @sqrt(double noundef %4) #11, !tbaa !5
  store double %call50, ptr %0, align 8
  ret void
}

; Function Attrs: minsize mustprogress nofree norecurse nounwind optsize willreturn uwtable
define internal fastcc void @outlined_ir_func_1(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %0) unnamed_addr #8 {
if.then8_after_outline.exitStub:
  %1 = load double, ptr @b, align 8, !tbaa !9
  %2 = load double, ptr @a, align 8, !tbaa !9
  %mul10 = fmul double 4.000000e+00, %2
  %3 = load double, ptr @c, align 8, !tbaa !9
  %mul11 = fmul double %mul10, %3
  %neg12 = fneg double %mul11
  %4 = call double @llvm.fmuladd.f64(double %1, double %1, double %neg12) #10
  %call13 = call double @sqrt(double noundef %4) #11, !tbaa !5
...
attributes #8 = { minsize mustprogress nofree norecurse nounwind optsize willreturn uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
