...
if.then6.i10:                                     ; preds = %if.then28.i, %if.then19.i, %land.lhs.true.i, %entry
  ...
  %call16.i15 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
if.then19.i21:                                    ; preds = %land.lhs.true.i16
  %call24.i22 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
if.then6.i37:                                     ; preds = %if.then28.i28, %if.then19.i21, %land.lhs.true.i16, %if.then6.i10
  ...
  %call16.i42 = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
if.then19.i48:                                    ; preds = %land.lhs.true.i43
  %call24.i49 = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #13
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit56: ; preds = %if.then6.i37, %land.lhs.true.i43, %if.then19.i48, %if.then28.i55
  ...
  %call8 = call i64 @strlen(ptr noundef nonnull readonly captures(none) dereferenceable(1) %b) #14
  %conv9 = trunc i64 %call8 to i32
  %6 = load i8, ptr %b, align 16
  %smax = call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %conv9, i32 noundef 1)
  %smax67 = call i32 @llvm.smax.i32(i32 %conv, i32 noundef 0)
