...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc26
  ...
  %exitcond34.not = icmp eq i32 %j.0, %smax
  br i1 %exitcond34.not, label %for.cond29.preheader, label %for.cond5
...
for.cond5:                                        ; preds = %for.cond2, %for.cond5.backedge
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.cond5.backedge ], [ 0, %for.cond2 ]
  %exitcond.not = icmp eq i64 %indvars.iv29, %wide.trip.count
  br i1 %exitcond.not, label %for.inc26, label %for.body7

for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv29
  %3 = load i32, ptr %arrayidx9, align 4, !tbaa !5
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  %arrayidx11 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next30
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc40
  %indvars.iv35 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next36, %for.inc40 ]
  %exitcond39.not = icmp eq i64 %indvars.iv35, %2
  br i1 %exitcond39.not, label %for.cond44.preheader, label %for.body31

for.body31:                                       ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv35
...
for.cond44.preheader:                             ; preds = %for.cond29, %if.then35
  %indvars.iv40.ph = phi i64 [ %.pre, %if.then35 ], [ %2, %for.cond29 ]
  br label %for.cond44
...
for.cond44:                                       ; preds = %for.cond44.backedge, %for.cond44.preheader
  %indvars.iv40 = phi i64 [ %indvars.iv40.ph, %for.cond44.preheader ], [ %indvars.iv.next41, %for.cond44.backedge ]
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  %7 = load i32, ptr %n, align 4, !tbaa !5
  %8 = sext i32 %7 to i64
  %cmp45 = icmp slt i64 %indvars.iv.next41, %8
  br i1 %cmp45, label %for.body46, label %for.end58

for.body46:                                       ; preds = %for.cond44
  %arrayidx48 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv.next41
  %9 = load i32, ptr %arrayidx48, align 4, !tbaa !5
  %10 = and i32 %9, 1
  %cmp50.not = icmp eq i32 %10, 0
  br i1 %cmp50.not, label %for.cond44.backedge, label %if.then51

for.cond44.backedge:                              ; preds = %for.body46, %if.then51
