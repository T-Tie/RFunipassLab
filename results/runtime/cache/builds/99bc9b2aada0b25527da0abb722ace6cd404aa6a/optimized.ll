...
if.then44:                                        ; preds = %if.else42
  ...
  %arrayidx56 = getelementptr inbounds [81 x i8], ptr %arrayidx46, i64 0, i64 %idxprom55
...
if.else58:                                        ; preds = %if.else42
  ...
  %arrayidx70 = getelementptr inbounds [81 x i8], ptr %arrayidx60, i64 0, i64 %idxprom69
  store i8 32, ptr %arrayidx70, align 1, !tbaa !12
  %inc71 = add nsw i32 %add, 1
  br label %if.end73

if.end73:                                         ; preds = %if.then33, %if.else58, %if.then44, %if.then
  %k.1 = phi i32 [ %inc18, %if.then ], [ %inc41, %if.then33 ], [ %k.0, %if.else58 ], [ %k.0, %if.then44 ]
  %j.1 = phi i32 [ %inc30, %if.then ], [ 0, %if.then33 ], [ %inc57, %if.then44 ], [ %inc71, %if.else58 ]
...
for.body96:                                       ; preds = %for.cond94
  ...
  %2 = getelementptr inbounds [81 x i8], ptr %arrayidx90, i64 0, i64 %idxprom102
...
if.then99:                                        ; preds = %for.body96
  ...
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %3)
...
if.else106:                                       ; preds = %for.body96
  ...
  %call111 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, i8 noundef signext %3)
  br label %if.end112
