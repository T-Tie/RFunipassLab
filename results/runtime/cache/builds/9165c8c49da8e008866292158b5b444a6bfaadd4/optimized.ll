...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 240, ptr %p) #6
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %arrayidx, i8 undef, i64 24, i1 false)
...
if.then:                                          ; preds = %for.body
  ...
  %call21 = call double @sqrt(double noundef %4) #6, !tbaa !5
...
if.then30:                                        ; preds = %if.else
  ...
  %call36 = call double @sqrt(double noundef %4) #6, !tbaa !5
  %add37 = fadd double %fneg31, %call36
  %mul38 = fmul double 2.000000e+00, %2
  %div39 = fdiv double %add37, %mul38
  %call45 = call double @sqrt(double noundef %4) #6, !tbaa !5
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 240, ptr %p) #6
