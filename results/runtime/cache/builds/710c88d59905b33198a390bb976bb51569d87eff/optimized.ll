...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %for.end114 ], [ %2, %entry ]
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.end114 ], [ %1, %entry ]
  %accumulator.tr = phi i32 [ %add116, %for.end114 ], [ 0, %entry ]
  %3 = trunc nuw i64 %indvars.iv63 to i32
  %smax60 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv65, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv65 to i32
  %smax44 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count23 = zext nneg i32 %smax44 to i64
  %wide.trip.count = and i64 %indvars.iv65, 4294967295
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  %indvars.iv20 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next21, %for.inc28 ]
  %exitcond24.not = icmp eq i64 %indvars.iv20, %wide.trip.count23
  br i1 %exitcond24.not, label %for.cond31.preheader, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv20, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv15 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next16, %for.inc25 ]
  %exitcond19.not = icmp eq i64 %indvars.iv15, %wide.trip.count
  br i1 %exitcond19.not, label %for.inc28, label %for.inc25

for.inc25:                                        ; preds = %for.cond14
  %arrayidx20 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv20, i64 %indvars.iv15
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv35 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next36, %for.inc66 ]
  %exitcond40.not = icmp eq i64 %indvars.iv35, %wide.trip.count23
  br i1 %exitcond40.not, label %for.end68, label %for.cond34

for.cond34:                                       ; preds = %for.cond31, %for.body36
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.body36 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select13, %for.body36 ], [ 32767, %for.cond31 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count
  br i1 %exitcond29.not, label %for.cond51.preheader, label %for.body36

for.cond51.preheader:                             ; preds = %for.cond34
  br label %for.cond51

for.body36:                                       ; preds = %for.cond34
  %arrayidx40 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv25, i64 %indvars.iv35
  %8 = load i32, ptr %arrayidx40, align 4, !tbaa !5
  %spec.select13 = tail call i32 @llvm.smin.i32(i32 %8, i32 %min.2)
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  br label %for.cond34, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv30 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next31, %for.inc63 ]
  %exitcond34.not = icmp eq i64 %indvars.iv30, %wide.trip.count
  br i1 %exitcond34.not, label %for.inc66, label %for.inc63

for.inc63:                                        ; preds = %for.cond51
  %arrayidx57 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv30, i64 %indvars.iv35
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.inc89 ], [ 1, %for.end68 ]
  %cmp73 = icmp slt i64 %indvars.iv47, %indvars.iv.next66
...
for.cond75:                                       ; preds = %for.cond71, %for.inc86
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.inc86 ], [ 0, %for.cond71 ]
  %exitcond46.not = icmp eq i64 %indvars.iv41, %wide.trip.count23
  br i1 %exitcond46.not, label %for.inc89, label %for.inc86

for.inc86:                                        ; preds = %for.cond75
  %arrayidx81 = getelementptr inbounds nuw [120 x i32], ptr %invariant.gep, i64 %indvars.iv47, i64 %indvars.iv41
  %11 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %arrayidx85 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv47, i64 %indvars.iv41
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  %indvars.iv57 = phi i64 [ 0, %for.cond92.preheader ], [ %indvars.iv.next58, %for.inc112 ]
  %exitcond62.not = icmp eq i64 %indvars.iv57, %wide.trip.count61
  br i1 %exitcond62.not, label %for.end114, label %for.cond96

for.cond96:                                       ; preds = %for.cond92, %for.inc109
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc109 ], [ 1, %for.cond92 ]
  %exitcond56.not = icmp eq i64 %indvars.iv50, %indvars.iv63
  br i1 %exitcond56.not, label %for.inc112, label %for.inc109

for.inc109:                                       ; preds = %for.cond96
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %arrayidx104 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv57, i64 %indvars.iv.next51
  %12 = load i32, ptr %arrayidx104, align 4, !tbaa !5, !invariant.load !19
  %arrayidx108 = getelementptr inbounds nuw [120 x i32], ptr %matrix, i64 %indvars.iv57, i64 %indvars.iv50
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [120 x [120 x i32]], ptr %a, i64 0, i64 %indvars.iv5, i64 %indvars.iv
