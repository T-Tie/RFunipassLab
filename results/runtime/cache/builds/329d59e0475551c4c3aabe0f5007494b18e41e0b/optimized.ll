...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %7 = sext i32 %6 to i64
  %cmp = icmp slt i64 %indvars.iv25, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.cond10

for.cond1.preheader:                              ; preds = %for.cond
  %8 = mul nuw nsw i64 %indvars.iv25, %3
...
for.cond10:                                       ; preds = %for.cond, %for.inc50
  %.pre39 = phi i32 [ %.pre, %for.inc50 ], [ %6, %for.cond ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc50 ], [ 0, %for.cond ]
  %count.0 = phi i32 [ %count.1, %for.inc50 ], [ 0, %for.cond ]
  %x.0 = phi i32 [ %x.1, %for.inc50 ], [ 0, %for.cond ]
  %11 = sext i32 %.pre39 to i64
  %cmp11 = icmp slt i64 %indvars.iv36, %11
  br i1 %cmp11, label %for.cond13.preheader, label %for.end52

for.cond13.preheader:                             ; preds = %for.cond10
  %12 = load i32, ptr %n, align 4, !tbaa !5
  %13 = mul nuw nsw i64 %indvars.iv36, %3
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.body15
  ...
  %a.0 = phi i32 [ %14, %for.cond13.preheader ], [ %spec.select, %for.body15 ]
  %b.0 = phi i32 [ 0, %for.cond13.preheader ], [ %spec.select22, %for.body15 ]
...
for.cond27.preheader:                             ; preds = %for.cond13
  %idxprom30 = zext nneg i32 %a.0 to i64
  %15 = mul nuw nsw i64 %idxprom30, %3
  %arrayidx31 = getelementptr inbounds nuw i32, ptr %vla, i64 %15
  %idxprom32 = zext nneg i32 %b.0 to i64
  %arrayidx33 = getelementptr inbounds nuw i32, ptr %arrayidx31, i64 %idxprom32
  %invariant.gep = getelementptr inbounds nuw i32, ptr %vla, i64 %idxprom32
  %wide.trip.count34 = zext i32 %.pre39 to i64
  br label %for.cond27

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw i32, ptr %arrayidx17, i64 %indvars.iv28
  %16 = load i32, ptr %arrayidx19, align 4, !tbaa !5
  %17 = load i32, ptr %arrayidx17, align 4, !tbaa !5
  %cmp23 = icmp sgt i32 %16, %17
  %spec.select = select i1 %cmp23, i32 %14, i32 %a.0
  %18 = trunc nuw nsw i64 %indvars.iv28 to i32
  %spec.select22 = select i1 %cmp23, i32 %18, i32 %b.0
  %indvars.iv.next29 = add nuw nsw i64 %indvars.iv28, 1
  br label %for.cond13, !llvm.loop !13

for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv31 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next32, %for.body29 ]
  %count.1 = phi i32 [ %count.0, %for.cond27.preheader ], [ %spec.select23, %for.body29 ]
  %exitcond35.not = icmp eq i64 %indvars.iv31, %wide.trip.count34
  br i1 %exitcond35.not, label %for.end44, label %for.body29

for.body29:                                       ; preds = %for.cond27
  %19 = load i32, ptr %arrayidx33, align 4, !tbaa !5
  %20 = mul nuw nsw i64 %indvars.iv31, %3
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %20
  %21 = load i32, ptr %gep, align 4, !tbaa !5
  %cmp38 = icmp sgt i32 %19, %21
  %inc40 = zext i1 %cmp38 to i32
  %spec.select23 = add nsw i32 %count.1, %inc40
...
if.then46:                                        ; preds = %for.end44
  %call47 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %a.0, i32 noundef %b.0)
  %inc48 = add nsw i32 %x.0, 1
  %.pre.pre = load i32, ptr %m, align 4, !tbaa !5
  br label %for.inc50

for.inc50:                                        ; preds = %for.end44, %if.then46
  %.pre = phi i32 [ %.pre.pre, %if.then46 ], [ %.pre39, %for.end44 ]
