...
land.lhs.true:                                    ; preds = %for.body
  ...
  %or.cond7 = select i1 %cmp8, i1 true, i1 %or.cond
  %inc19 = zext i1 %or.cond7 to i32
  %spec.select8 = add nsw i32 %a.0, %inc19
  br label %for.inc

for.inc:                                          ; preds = %land.lhs.true, %for.body
  %a.1 = phi i32 [ %a.0, %for.body ], [ %spec.select8, %land.lhs.true ]
...
for.cond29:                                       ; preds = %for.cond26, %for.body34
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.body34 ], [ 0, %for.cond26 ]
  %t.1 = phi i32 [ %spec.select, %for.body34 ], [ 0, %for.cond26 ]
  %arrayidx31 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv10
  %3 = load i8, ptr %arrayidx31, align 1, !tbaa !5
...
for.cond54:                                       ; preds = %for.cond26, %for.inc80
  ...
  %exitcond16.not = icmp eq i32 %4, 123
  br i1 %exitcond16.not, label %if.end83, label %for.cond57

for.cond57:                                       ; preds = %for.cond54, %for.body62
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.body62 ], [ 0, %for.cond54 ]
  %l.1 = phi i32 [ %spec.select6, %for.body62 ], [ 0, %for.cond54 ]
  %arrayidx59 = getelementptr inbounds nuw [301 x i8], ptr %str, i64 0, i64 %indvars.iv13
