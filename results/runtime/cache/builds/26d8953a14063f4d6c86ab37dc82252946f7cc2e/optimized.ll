...
if.end:                                           ; preds = %land.lhs.true, %for.body23
  ...
  %4 = load i32, ptr %arrayidx27, align 16, !tbaa !5, !invariant.load !13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %j29) #7
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc45, %if.end
  %minValue.0 = phi i32 [ %4, %if.end ], [ %minValue.1, %for.inc45 ]
  %t.sink2 = phi ptr [ %t, %if.end ], [ %j29, %for.inc45 ]
  %5 = load i32, ptr %t.sink2, align 4, !tbaa !5
  %add = add nsw i32 %5, 1
  store i32 %add, ptr %j29, align 4, !tbaa !5
  %cmp31 = icmp slt i32 %add, %1
...
for.body33:                                       ; preds = %for.cond30
  ...
  %6 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !13
  %cmp38 = icmp slt i32 %6, %minValue.0
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %t.sink3 = phi ptr [ %t, %for.end47 ], [ %j52, %for.inc63 ]
  %7 = load i32, ptr %t.sink3, align 4, !tbaa !5
  %add53 = add nsw i32 %7, 1
  store i32 %add53, ptr %j52, align 4, !tbaa !5
  %cmp55 = icmp slt i32 %add53, %1
  br i1 %cmp55, label %for.inc63, label %for.end65

for.inc63:                                        ; preds = %for.cond54
  %idxprom60 = sext i32 %add53 to i64
  %arrayidx61 = getelementptr inbounds [100 x i32], ptr %arrayidx27, i64 0, i64 %idxprom60
  %8 = load i32, ptr %arrayidx61, align 4, !tbaa !5, !invariant.load !13
  %sub62 = sub nsw i32 %8, %minValue.0
...
if.end78:                                         ; preds = %land.lhs.true75, %for.body73
  ...
  %9 = load i32, ptr %arrayidx82, align 4, !tbaa !5, !invariant.load !13
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef %i83) #7
  br label %for.cond85

for.cond85:                                       ; preds = %for.inc100, %if.end78
  %minValue79.0 = phi i32 [ %9, %if.end78 ], [ %minValue79.1, %for.inc100 ]
  %t.sink = phi ptr [ %t, %if.end78 ], [ %i83, %for.inc100 ]
  %10 = load i32, ptr %t.sink, align 4, !tbaa !5
  %add84 = add nsw i32 %10, 1
  store i32 %add84, ptr %i83, align 4, !tbaa !5
  %cmp86 = icmp slt i32 %add84, %1
  br i1 %cmp86, label %for.body88, label %for.end102

for.body88:                                       ; preds = %for.cond85
  %idxprom89 = sext i32 %add84 to i64
  ...
  %11 = load i32, ptr %arrayidx92, align 4, !tbaa !5, !invariant.load !13
...
for.end102:                                       ; preds = %for.cond85
  ...
  %sub106 = sub nsw i32 %9, %minValue79.0
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %t.sink1 = phi ptr [ %t, %for.end102 ], [ %i107, %for.inc118 ]
  %12 = load i32, ptr %t.sink1, align 4, !tbaa !5
  %add108 = add nsw i32 %12, 1
  store i32 %add108, ptr %i107, align 4, !tbaa !5
  %cmp110 = icmp slt i32 %add108, %1
...
for.inc118:                                       ; preds = %for.cond109
  ...
  %13 = load i32, ptr %arrayidx116, align 4, !tbaa !5, !invariant.load !13
...
for.inc131:                                       ; preds = %for.cond70
  ...
  %14 = load i32, ptr %arrayidx129, align 4, !tbaa !5, !invariant.load !13
  %add130 = add nsw i32 %total.0, %14
