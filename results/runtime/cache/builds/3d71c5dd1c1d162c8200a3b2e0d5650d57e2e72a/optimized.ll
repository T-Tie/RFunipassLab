...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 100000, ptr noundef nonnull align 16 dereferenceable(100000) %a) #7
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i64 @llvm.objectsize.i64.p0(ptr nonnull %add.ptr, i1 noundef false, i1 noundef true, i1 noundef false) #8
...
for.cond7:                                        ; preds = %for.inc16, %for.end
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc16 ], [ 1, %for.end ]
  %exitcond24 = icmp eq i64 %indvars.iv21, %wide.trip.count
  br i1 %exitcond24, label %for.end18, label %for.inc16
...
for.inc16:                                        ; preds = %for.cond7
  ...
  %add.ptr13 = getelementptr inbounds nuw [100 x i8], ptr %a, i64 %indvars.iv21
...
if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !40, !invariant.load !5
