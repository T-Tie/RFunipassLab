...
if.then:                                          ; preds = %for.body
  ...
  %fneg16 = fneg double %1
  %sub = fsub double %fneg16, %call15
...
if.end67:                                         ; preds = %if.then64, %if.then58
  ...
  %d.2 = phi double [ %div66, %if.then64 ], [ %div61, %if.then58 ]
  ...
  %call75 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %d.2, double noundef %div74, double noundef %d.2, double noundef %div74)
  br label %if.end79
