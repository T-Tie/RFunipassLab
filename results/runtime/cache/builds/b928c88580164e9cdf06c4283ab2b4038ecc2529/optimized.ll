...
if.then:                                          ; preds = %for.body4
  ...
  store i32 %inc12, ptr %m, align 4, !tbaa !5
  br label %for.inc13
...
for.body49:                                       ; preds = %for.cond47
  ...
  %11 = load i32, ptr %arrayidx51, align 4, !tbaa !5, !invariant.load !12
  %call52 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %11) #5
  %cmp54 = icmp ne i32 %10, %sub
