...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc55
  %.pre104 = phi i32 [ %0, %for.cond2.preheader ], [ %.pre, %for.inc55 ]
  %indvars.iv97 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next98, %for.inc55 ]
  %csum.0 = phi i64 [ 0, %for.cond2.preheader ], [ %csum.1, %for.inc55 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %j.2, %for.inc55 ]
  %2 = sext i32 %.pre104 to i64
  %cmp3 = icmp slt i64 %indvars.iv97, %2
  br i1 %cmp3, label %for.body4, label %for.end57

for.body4:                                        ; preds = %for.cond2
  %sext = shl i64 %csum.0, 32
  %conv = ashr exact i64 %sext, 32
  %arrayidx6 = getelementptr inbounds nuw [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv97
...
for.cond17:                                       ; preds = %for.body19, %if.then
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.body19 ], [ %idxprom12, %if.then ]
  %indvars.iv.next95 = add nsw i64 %indvars.iv94, 1
  %cmp18.not.not = icmp slt i64 %indvars.iv94, %indvars.iv97
...
for.body19:                                       ; preds = %for.cond17
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i.loc)
  %retval.0.i.reload = load ptr, ptr %retval.0.i.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull %retval.0.i.loc)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i)
  %arrayidx22 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next95
...
for.cond36:                                       ; preds = %for.body38, %if.then30
  %indvars.iv91 = phi i64 [ %indvars.iv.next92, %for.body38 ], [ %idxprom31, %if.then30 ]
  %indvars.iv.next92 = add nsw i64 %indvars.iv91, 1
  %cmp37 = icmp slt i64 %indvars.iv.next92, %indvars.iv97
...
for.body38:                                       ; preds = %for.cond36
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i18, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i20, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i27.loc)
  %retval.0.i27.reload = load ptr, ptr %retval.0.i27.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull %retval.0.i27.loc)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i18)
  %arrayidx41 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next92
...
for.inc55.sink.split:                             ; preds = %for.cond17, %for.end46
  ...
  %j.2.ph.in = phi i64 [ %indvars.iv.next92, %for.end46 ], [ %indvars.iv.next95, %for.cond17 ]
...
for.inc55:                                        ; preds = %for.inc55.sink.split, %if.end
  %.pre = phi i32 [ %.pre104, %if.end ], [ %.pre.pre, %for.inc55.sink.split ]
...
for.cond63:                                       ; preds = %for.body65, %for.end57
  %indvars.iv101 = phi i64 [ %indvars.iv.next102, %for.body65 ], [ %idxprom58, %for.end57 ]
  %indvars.iv.next102 = add nsw i64 %indvars.iv101, 1
  %3 = load i32, ptr %n, align 4, !tbaa !5
  %4 = sext i32 %3 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next102, %4
...
for.body65:                                       ; preds = %for.cond63
  ...
  call void @llvm.lifetime.start.p0(i64 noundef -1, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %retval.0.i57.loc)
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) %__c.addr.i48, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %vbase.offset.ptr.i50, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %retval.0.i57.loc)
  %retval.0.i57.reload = load ptr, ptr %retval.0.i57.loc, align 8
  call void @llvm.lifetime.end.p0(i64 noundef -1, ptr noundef nonnull captures(none) %retval.0.i57.loc)
  call void @llvm.lifetime.end.p0(i64 noundef 1, ptr noundef nonnull captures(none) %__c.addr.i48)
  %arrayidx68 = getelementptr inbounds [1000 x [20 x i8]], ptr %words, i64 0, i64 %indvars.iv.next102
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(1) initializes((0, 1)) %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %1, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %2) unnamed_addr #5 {
for.body19_to_outline:
  store i8 32, ptr %0, align 1, !tbaa !17
  %vbase.offset.i = load i64, ptr %1, align 8, !invariant.load !14
  %gep88 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i
  %3 = load i64, ptr %gep88, align 8, !tbaa !18, !invariant.load !14
