...
if.then8:                                         ; preds = %if.end
  %fneg9 = fneg double %2
  %call13.i = tail call double @sqrt(double noundef %6) #6, !tbaa !5, !noalias !11
  %add = fsub double %call13.i, %2
  %mul = fmul double %3, 2.000000e+00
  %div = fdiv double %add, %mul
  store double %div, ptr @x, align 16, !tbaa !9
  %call13.i3 = tail call double @sqrt(double noundef %6) #6, !tbaa !5, !noalias !14
...
if.then39:                                        ; preds = %if.end37
  ...
  %15 = load double, ptr @a, align 8, !tbaa !9, !noalias !17
  %mul46.i = fmul double %15, 4.000000e+00
  %16 = load double, ptr @c, align 8, !tbaa !9, !noalias !17
  %17 = load double, ptr @b, align 8, !tbaa !9, !noalias !17
  %18 = fneg double %17
  %neg49.i = fmul double %17, %18
  %19 = tail call double @llvm.fmuladd.f64(double %mul46.i, double %16, double %neg49.i) #7
  %call50.i = tail call double @sqrt(double noundef %19) #6, !tbaa !5, !noalias !17
  ...
  %22 = load double, ptr @a, align 8, !tbaa !9, !noalias !20
  %mul46.i4 = fmul double %22, 4.000000e+00
  %23 = load double, ptr @c, align 8, !tbaa !9, !noalias !20
  %24 = load double, ptr @b, align 8, !tbaa !9, !noalias !20
  %25 = fneg double %24
  %neg49.i5 = fmul double %24, %25
  %26 = tail call double @llvm.fmuladd.f64(double %mul46.i4, double %23, double %neg49.i5) #7
  %call50.i6 = tail call double @sqrt(double noundef %26) #6, !tbaa !5, !noalias !20
