...
for.cond:                                         ; preds = %for.cond.loopexit, %entry
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.cond.loopexit ], [ 2, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.cond.loopexit ], [ 1, %entry ]
  %exitcond29.not = icmp eq i64 %indvars.iv23, 14
  br i1 %exitcond29.not, label %for.cond20, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc14
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.inc14 ], [ %indvars.iv23, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv25, 13
  br i1 %exitcond.not, label %for.cond.loopexit, label %for.cond5

for.cond5:                                        ; preds = %for.cond2, %for.inc
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc ], [ %indvars.iv, %for.cond2 ]
  %sum.0 = phi i32 [ %add8, %for.inc ], [ 0, %for.cond2 ]
  %cmp6.not.not = icmp samesign ult i64 %indvars.iv20, %indvars.iv25
  br i1 %cmp6.not.not, label %for.inc, label %for.end

for.inc:                                          ; preds = %for.cond5
  %arrayidx = getelementptr inbounds nuw [13 x i32], ptr @_ZL1a, i64 0, i64 %indvars.iv20
...
if.then:                                          ; preds = %for.end
  %arrayidx13 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv, i64 %indvars.iv25
...
for.cond20:                                       ; preds = %for.cond, %for.inc27
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc27 ], [ 1, %for.cond ]
  %exitcond33.not = icmp eq i64 %indvars.iv30, 13
  br i1 %exitcond33.not, label %for.cond30, label %for.inc27

for.inc27:                                        ; preds = %for.cond20
  %arrayidx26 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv30, i64 %indvars.iv30
  store i32 1, ptr %arrayidx26, align 4, !tbaa !8
  %indvars.iv.next31 = add nuw nsw i64 %indvars.iv30, 1
  br label %for.cond20, !llvm.loop !14

for.cond30:                                       ; preds = %for.cond20, %for.inc48
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc48 ], [ 1, %for.cond20 ]
  %exitcond41.not = icmp eq i64 %indvars.iv38, 13
  br i1 %exitcond41.not, label %for.cond51, label %for.cond33

for.cond33:                                       ; preds = %for.cond30, %for.inc45
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc45 ], [ 1, %for.cond30 ]
  %exitcond37.not = icmp eq i64 %indvars.iv34, %indvars.iv38
  br i1 %exitcond37.not, label %for.inc48, label %for.inc45

for.inc45:                                        ; preds = %for.cond33
  %arrayidx40 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv34, i64 %indvars.iv38
  %1 = load i32, ptr %arrayidx40, align 4, !tbaa !8
  %arrayidx44 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f1, i64 0, i64 %indvars.iv38, i64 %indvars.iv34
...
for.cond51:                                       ; preds = %for.cond30, %for.cond51.loopexit
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %for.cond51.loopexit ], [ 2, %for.cond30 ]
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.cond51.loopexit ], [ 1, %for.cond30 ]
  %exitcond54.not = icmp eq i64 %indvars.iv47, 14
  br i1 %exitcond54.not, label %for.cond82, label %for.cond55

for.cond55:                                       ; preds = %for.cond51, %for.inc76
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.inc76 ], [ %indvars.iv47, %for.cond51 ]
  %exitcond52.not = icmp eq i64 %indvars.iv49, 13
  br i1 %exitcond52.not, label %for.cond51.loopexit, label %for.cond58

for.cond58:                                       ; preds = %for.cond55, %for.inc65
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.inc65 ], [ %indvars.iv42, %for.cond55 ]
  %sum.1 = phi i32 [ %add64, %for.inc65 ], [ 0, %for.cond55 ]
  %cmp60.not.not = icmp samesign ult i64 %indvars.iv44, %indvars.iv49
  br i1 %cmp60.not.not, label %for.inc65, label %for.end67

for.inc65:                                        ; preds = %for.cond58
  %arrayidx63 = getelementptr inbounds nuw [13 x i32], ptr @_ZL1b, i64 0, i64 %indvars.iv44
...
if.then70:                                        ; preds = %for.end67
  %arrayidx74 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv42, i64 %indvars.iv49
...
for.cond82:                                       ; preds = %for.cond51, %for.inc89
  %indvars.iv55 = phi i64 [ %indvars.iv.next56, %for.inc89 ], [ 1, %for.cond51 ]
  %exitcond58.not = icmp eq i64 %indvars.iv55, 13
  br i1 %exitcond58.not, label %for.cond92, label %for.inc89

for.inc89:                                        ; preds = %for.cond82
  %arrayidx88 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv55, i64 %indvars.iv55
  store i32 1, ptr %arrayidx88, align 4, !tbaa !8
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  br label %for.cond82, !llvm.loop !20

for.cond92:                                       ; preds = %for.cond82, %for.inc110
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc110 ], [ 1, %for.cond82 ]
  %exitcond66.not = icmp eq i64 %indvars.iv63, 13
  br i1 %exitcond66.not, label %for.end112, label %for.cond95

for.cond95:                                       ; preds = %for.cond92, %for.inc107
  %indvars.iv59 = phi i64 [ %indvars.iv.next60, %for.inc107 ], [ 1, %for.cond92 ]
  %exitcond62.not = icmp eq i64 %indvars.iv59, %indvars.iv63
  br i1 %exitcond62.not, label %for.inc110, label %for.inc107

for.inc107:                                       ; preds = %for.cond95
  %arrayidx102 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv59, i64 %indvars.iv63
  %3 = load i32, ptr %arrayidx102, align 4, !tbaa !8
  %arrayidx106 = getelementptr inbounds nuw [13 x [13 x i32]], ptr %f2, i64 0, i64 %indvars.iv63, i64 %indvars.iv59
...
for.body115:                                      ; preds = %for.cond113
  ...
  %arrayidx133 = getelementptr inbounds [13 x [13 x i32]], ptr %spec.select, i64 0, i64 %idxprom130, i64 %idxprom132
  %8 = load i32, ptr %arrayidx133, align 4, !tbaa !8, !invariant.load !23
