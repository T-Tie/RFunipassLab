...
for.cond.for.inc_crit_edge:                       ; preds = %for.cond
  %.pre39 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  br label %for.inc
...
land.lhs.true:                                    ; preds = %for.cond
  ...
  %.pre40 = load i32, ptr %arrayidx6, align 4, !tbaa !5
  br i1 %or.cond, label %land.lhs.true20, label %for.inc

land.lhs.true20:                                  ; preds = %land.lhs.true
  %cmp23 = icmp eq i32 %.pre40, 0
...
for.inc:                                          ; preds = %for.cond.for.inc_crit_edge, %land.lhs.true28, %land.lhs.true24, %land.lhs.true20, %land.lhs.true
  %3 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ %.pre40, %land.lhs.true20 ], [ %.pre40, %land.lhs.true ], [ %.pre39, %for.cond.for.inc_crit_edge ]
  %4 = phi i32 [ 0, %land.lhs.true28 ], [ 0, %land.lhs.true24 ], [ 0, %land.lhs.true20 ], [ %.pre36, %land.lhs.true ], [ %.pre36, %for.cond.for.inc_crit_edge ]
  %indvars.iv.next = add nuw i64 %indvars.iv, 1
  %5 = load i32, ptr %arrayidx8, align 4, !tbaa !5
  %6 = load i32, ptr %arrayidx10, align 4, !tbaa !5
  %reass.add = sub i32 %5, %.pre
  %reass.mul = mul i32 %reass.add, 60
  %reass.add25 = sub i32 %3, %0
  %reass.mul26 = mul i32 %reass.add25, 3600
  %reass.sub37 = sub i32 %6, %4
  %add51 = add i32 %reass.sub37, 43200
