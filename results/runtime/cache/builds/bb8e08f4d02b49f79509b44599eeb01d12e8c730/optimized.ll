...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax53 = tail call i32 @llvm.smax.i32(i32 %indvars.iv27.in, i32 noundef 0)
...
for.cond:                                         ; preds = %for.inc24, %tailrecurse
  ...
  br i1 %exitcond39.not, label %for.cond27, label %for.body
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc21
  %indvars.iv30 = phi i64 [ %indvars.iv.next31, %for.inc21 ], [ 0, %for.cond14.preheader ]
...
for.cond27:                                       ; preds = %for.cond, %for.inc62
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc62 ], [ 0, %for.cond ]
...
for.cond32:                                       ; preds = %for.body34, %for.body29
  ...
  %min.1 = phi i32 [ %spec.select19, %for.body34 ], [ %3, %for.body29 ]
...
for.body34:                                       ; preds = %for.cond32
  ...
  %spec.select19 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.1)
  %indvars.iv.next41 = add nuw nsw i64 %indvars.iv40, 1
  br label %for.cond32, !llvm.loop !14

for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc59
  %indvars.iv45 = phi i64 [ %indvars.iv.next46, %for.inc59 ], [ 0, %for.cond51.preheader ]
...
for.end64:                                        ; preds = %for.cond27
  ...
  %smax64 = tail call i32 @llvm.smax.i32(i32 %indvars.iv27, i32 noundef 1)
  %6 = zext i32 %indvars.iv27 to i64
...
for.cond81:                                       ; preds = %for.inc95, %for.body69
  ...
  %exitcond60.not = icmp eq i64 %indvars.iv56, %6
  br i1 %exitcond60.not, label %for.cond66, label %for.inc95, !llvm.loop !17
