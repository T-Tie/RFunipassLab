...
if.then9:                                         ; preds = %if.then8
  %sub = sub nsw i32 %x1.1, 2
  br label %for.inc

if.else:                                          ; preds = %if.then8
  %sub10 = sub nsw i32 %x1.1, 3
  br label %for.inc

for.inc:                                          ; preds = %if.end, %if.end.thread, %if.else, %if.then9
  %x1.2 = phi i32 [ %x1.1, %if.end ], [ %dec, %if.end.thread ], [ %sub, %if.then9 ], [ %sub10, %if.else ]
  %inc = add nsw i32 %i.0, 1
...
if.then31:                                        ; preds = %if.then28
  %sub32 = sub nsw i32 %x2.1, 2
  br label %for.inc37

if.else33:                                        ; preds = %if.then28
  %sub34 = sub nsw i32 %x2.1, 3
  br label %for.inc37

for.inc37:                                        ; preds = %if.end26, %if.end26.thread, %if.else33, %if.then31
  %x2.2 = phi i32 [ %x2.1, %if.end26 ], [ %dec25, %if.end26.thread ], [ %sub32, %if.then31 ], [ %sub34, %if.else33 ]
