...
for.cond10:                                       ; preds = %for.cond, %for.inc17
  ...
  %exitcond13.not = icmp eq i64 %indvars.iv, 31
  br i1 %exitcond13.not, label %for.end19, label %land.end
...
land.end:                                         ; preds = %for.cond10
  ...
  br i1 %cmp15, label %for.inc17, label %for.end19.split.loop.exit19

for.inc17:                                        ; preds = %land.end
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond10, !llvm.loop !15

for.end19.split.loop.exit19:                      ; preds = %land.end
  %4 = trunc nuw nsw i64 %indvars.iv to i32
  br label %for.end19

for.end19:                                        ; preds = %for.cond10, %for.end19.split.loop.exit19
  %i.1.lcssa = phi i32 [ %4, %for.end19.split.loop.exit19 ], [ 31, %for.cond10 ]
  %5 = zext nneg i32 %i.1.lcssa to i64
  %6 = sext i32 %i.1.lcssa to i64
  br label %for.cond20

for.cond20:                                       ; preds = %for.inc28, %for.end19
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc28 ], [ %5, %for.end19 ]
  %exitcond18.not = icmp eq i64 %indvars.iv14, 31
  br i1 %exitcond18.not, label %for.end30, label %for.inc28

for.inc28:                                        ; preds = %for.cond20
  %arrayidx24 = getelementptr inbounds nuw [32 x i8], ptr %res, i64 0, i64 %indvars.iv14
  %7 = load i8, ptr %arrayidx24, align 1, !tbaa !9, !invariant.load !10
  %8 = sub nuw nsw i64 %indvars.iv14, %6
