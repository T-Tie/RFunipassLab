...
for.cond27.preheader:                             ; preds = %for.cond2
  %smax19 = call i32 @llvm.smax.i32(i32 %number.0, i32 0)
...
for.cond27:                                       ; preds = %for.cond27.preheader, %for.body29
  %indvars.iv15 = phi i64 [ 0, %for.cond27.preheader ], [ %indvars.iv.next16, %for.body29 ]
...
for.body29:                                       ; preds = %for.cond27
  ...
  %5 = getelementptr inbounds nuw [20000 x i32], ptr %B, i64 0, i64 %indvars.iv15
  %6 = load i32, ptr %5, align 4, !tbaa !5, !invariant.load !12
  %.str..str.1 = select i1 %cmp30, ptr @.str, ptr @.str.1
  %call34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %6)
