...
if.end107:                                        ; preds = %if.else72, %if.then77
  %.sink5 = phi double [ %fneg81, %if.then77 ], [ %9, %if.else72 ]
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %.sink5, double noundef %12, double noundef %.sink5, double noundef %12) #8
  br label %for.inc110
