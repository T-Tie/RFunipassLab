...
for.cond:                                         ; preds = %for.inc28, %entry
  ...
  br i1 %exitcond15.not, label %for.cond31, label %for.body
...
for.cond31:                                       ; preds = %for.cond, %for.inc69
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.inc69 ], [ 0, %for.cond ]
...
for.cond54:                                       ; preds = %for.cond54.preheader, %for.inc66
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.inc66 ], [ 0, %for.cond54.preheader ]
...
entry:
  %sub = add nsw i32 %n, -1
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0)
  %smax5 = tail call i32 @llvm.smax.i32(i32 %sub, i32 noundef 1)
