...
for.end32:                                        ; preds = %for.cond19
  ...
  br i1 %cmp33.not, label %for.cond16, label %for.end38, !llvm.loop !14

for.end38:                                        ; preds = %for.end32, %for.cond16
  %q.1 = phi i32 [ %q.2, %for.end32 ], [ 0, %for.cond16 ]
...
for.end55:                                        ; preds = %for.cond42
  ...
  br i1 %cmp56.not, label %for.cond39, label %for.end61, !llvm.loop !16

for.end61:                                        ; preds = %for.end55, %for.cond39
  %m.1 = phi i32 [ %m.2, %for.end55 ], [ 0, %for.cond39 ]
