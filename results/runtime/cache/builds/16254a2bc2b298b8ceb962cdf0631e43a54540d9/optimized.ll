...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr nonnull %a) #9
  call void @llvm.lifetime.start.p0(i64 1000, ptr nonnull %b) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %w) #9
  %call = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %w)
  call fastcc void @outlined_ir_func_0(ptr %a)
  br label %if.then6.i10

if.then6.i10:                                     ; preds = %entry
  call fastcc void @outlined_ir_func_0(ptr %b)
...
if.end75:                                         ; preds = %for.end65, %for.body, %land.lhs.true, %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit41
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %w) #9
  call void @llvm.lifetime.end.p0(i64 1000, ptr nonnull %b) #9
  call void @llvm.lifetime.end.p0(i64 1000, ptr nonnull %a) #9
  ret i32 0
}
...
entry_to_outline:                                 ; preds = %newFuncRoot
  ...
  %1 = load i64, ptr %_M_width.i1.i, align 8, !tbaa !16
  call void @_ZSt17__istream_extractRSiPcl(ptr noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, ptr noundef nonnull %0, i64 noundef 1000)
