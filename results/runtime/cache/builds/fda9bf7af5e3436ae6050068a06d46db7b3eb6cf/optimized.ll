...
tailrecurse:                                      ; preds = %for.end114, %entry
  %indvars.iv122 = phi i64 [ %indvars.iv.next123, %for.end114 ], [ %2, %entry ]
  ...
  %smax117 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %4 = icmp eq i64 %indvars.iv122, 1
  br i1 %4, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %5 = trunc nsw i64 %indvars.iv122 to i32
  %smax101 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 0)
  %wide.trip.count80 = zext nneg i32 %smax101 to i64
  %wide.trip.count = and i64 %indvars.iv122, 4294967295
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc28
  ...
  br i1 %exitcond81.not, label %for.cond31.preheader, label %for.cond2.preheader
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  %min.0 = phi i32 [ %spec.select, %for.body4 ], [ 32767, %for.cond2.preheader ]
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc25
  %indvars.iv72 = phi i64 [ 0, %for.cond14.preheader ], [ %indvars.iv.next73, %for.inc25 ]
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc66
  %indvars.iv92 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next93, %for.inc66 ]
  %exitcond97.not = icmp eq i64 %indvars.iv92, %wide.trip.count80
  br i1 %exitcond97.not, label %for.end68, label %for.cond34.preheader

for.cond34.preheader:                             ; preds = %for.cond31
  br label %for.cond34

for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %indvars.iv82 = phi i64 [ %indvars.iv.next83, %for.body36 ], [ 0, %for.cond34.preheader ]
  %min.2 = phi i32 [ %spec.select70, %for.body36 ], [ 32767, %for.cond34.preheader ]
...
for.cond51:                                       ; preds = %for.cond51.preheader, %for.inc63
  %indvars.iv87 = phi i64 [ 0, %for.cond51.preheader ], [ %indvars.iv.next88, %for.inc63 ]
...
for.cond71:                                       ; preds = %for.inc89, %for.end68
  ...
  %cmp73 = icmp slt i64 %indvars.iv104, %indvars.iv.next123
...
for.cond75:                                       ; preds = %for.cond75.preheader, %for.inc86
  %indvars.iv98 = phi i64 [ %indvars.iv.next99, %for.inc86 ], [ 0, %for.cond75.preheader ]
...
for.cond92:                                       ; preds = %for.cond92.preheader, %for.inc112
  ...
  br i1 %exitcond119.not, label %for.end114, label %for.cond96.preheader

for.cond96.preheader:                             ; preds = %for.cond92
  br label %for.cond96

for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc109
  %indvars.iv107 = phi i64 [ %indvars.iv.next108, %for.inc109 ], [ 1, %for.cond96.preheader ]
...
for.cond:                                         ; preds = %for.inc15, %entry
  ...
  br i1 %cmp.not, label %for.end17, label %for.cond1.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  ...
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc10 ], [ 0, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
