...
for.cond17:                                       ; preds = %for.body19, %if.then
  %j.0.sink7 = phi i32 [ %j.0, %if.then ], [ %add16, %for.body19 ]
  %_ZSt4cout.sink6 = phi ptr [ @_ZSt4cout, %if.then ], [ %call20, %for.body19 ]
  ...
  br i1 %cmp18, label %for.body19, label %for.inc55.gvnsink.split
...
for.cond36:                                       ; preds = %for.body38, %if.then30
  %j.0.sink4 = phi i32 [ %j.0, %if.then30 ], [ %add35, %for.body38 ]
  %_ZSt4cout.sink3 = phi ptr [ @_ZSt4cout, %if.then30 ], [ %call39, %for.body38 ]
...
for.cond63:                                       ; preds = %for.body65, %for.end57
  %j.0.sink1 = phi i32 [ %j.0, %for.end57 ], [ %add62, %for.body65 ]
  %_ZSt4cout.sink = phi ptr [ @_ZSt4cout, %for.end57 ], [ %call66, %for.body65 ]
