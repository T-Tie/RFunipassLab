...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 20500, ptr noundef nonnull %a) #13
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef nonnull %b) #13
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc13
  %indvars.iv29 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next30, %for.inc13 ]
...
for.inc13:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv29
  %call10 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr8) #14
  %4 = trunc i64 %call10 to i32
  %conv = add i32 %4, 1
  %add.ptr12 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv29
  store i32 %conv, ptr %add.ptr12, align 4, !tbaa !5
  %indvars.iv.next30 = add nuw nsw i64 %indvars.iv29, 1
  br label %for.cond4, !llvm.loop !24

for.cond16:                                       ; preds = %for.cond4, %for.inc42
  %.pre45 = phi i32 [ %.pre, %for.inc42 ], [ %0, %for.cond4 ]
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.inc42 ], [ 0, %for.cond4 ]
  %sum.0 = phi i32 [ %sum.1, %for.inc42 ], [ 0, %for.cond4 ]
  %k.0 = phi i32 [ %k.1, %for.inc42 ], [ 0, %for.cond4 ]
  %5 = sext i32 %.pre45 to i64
  %cmp17 = icmp slt i64 %indvars.iv36, %5
  br i1 %cmp17, label %for.body18, label %for.cond45.preheader

for.cond45.preheader:                             ; preds = %for.cond16
  %6 = zext nneg i32 %k.0 to i64
  br label %for.cond45

for.body18:                                       ; preds = %for.cond16
  %add.ptr20 = getelementptr inbounds nuw i32, ptr %b, i64 %indvars.iv36
  %7 = load i32, ptr %add.ptr20, align 4, !tbaa !5, !invariant.load !9
...
for.cond23.preheader:                             ; preds = %for.body18
  ...
  %9 = zext nneg i32 %k.0 to i64
  br label %for.cond23

for.cond23:                                       ; preds = %for.cond23.preheader, %for.inc31
  %indvars.iv33 = phi i64 [ %9, %for.cond23.preheader ], [ %indvars.iv.next34, %for.inc31 ]
  %cmp24 = icmp slt i64 %indvars.iv33, %8
  br i1 %cmp24, label %for.inc31, label %for.end33

for.inc31:                                        ; preds = %for.cond23
  %add.ptr27 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv33
...
for.end33:                                        ; preds = %for.cond23
  %add.ptr35 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv36
  call fastcc void @outlined_ir_func_0(ptr nonnull %add.ptr35)
  %10 = trunc nuw nsw i64 %indvars.iv36 to i32
  %.pre.pre = load i32, ptr %n, align 4, !tbaa !5
  br label %for.inc42

for.inc42:                                        ; preds = %for.body18, %for.end33
  %.pre = phi i32 [ %.pre.pre, %for.end33 ], [ %.pre45, %for.body18 ]
  %sum.1 = phi i32 [ %7, %for.end33 ], [ %add21, %for.body18 ]
  %k.1 = phi i32 [ %10, %for.end33 ], [ %k.0, %for.body18 ]
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  br label %for.cond16, !llvm.loop !26

for.cond45:                                       ; preds = %for.cond45.preheader, %for.inc54
  %11 = phi i32 [ %.pre45, %for.cond45.preheader ], [ %.pre44, %for.inc54 ]
  %indvars.iv41 = phi i64 [ %6, %for.cond45.preheader ], [ %indvars.iv.next42, %for.inc54 ]
  %sub46 = add nsw i32 %11, -1
  %12 = sext i32 %sub46 to i64
  %cmp47 = icmp slt i64 %indvars.iv41, %12
  br i1 %cmp47, label %for.inc54, label %for.end56

for.inc54:                                        ; preds = %for.cond45
  %add.ptr50 = getelementptr inbounds nuw [41 x i8], ptr %a, i64 %indvars.iv41
...
for.end56:                                        ; preds = %for.cond45
  %idx.ext57 = sext i32 %11 to i64
  %add.ptr58 = getelementptr inbounds [41 x i8], ptr %a, i64 %idx.ext57
  call fastcc void @outlined_ir_func_0(ptr nonnull %add.ptr58)
  call void @llvm.lifetime.end.p0(i64 noundef 2000, ptr noundef nonnull %b) #13
  call void @llvm.lifetime.end.p0(i64 noundef 20500, ptr noundef nonnull %a) #13
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !28, !invariant.load !9
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !29, !invariant.load !9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !28, !invariant.load !9
  br label %return

if.end:                                           ; preds = %entry
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %this)
  %vtable = load ptr, ptr %this, align 8, !tbaa !36, !invariant.load !9
...
define internal fastcc void @outlined_ir_func_0(ptr nonnull %0) unnamed_addr #11 {
for.end33_after_outline.exitStub:
  %add.ptr36 = getelementptr inbounds i8, ptr %0, i64 -41
  %call38 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull %add.ptr36)
...
!28 = !{!7, !7, i64 0}
!29 = !{!30, !7, i64 56}
!30 = !{!"_ZTSSt5ctypeIcE", !31, i64 0, !32, i64 16, !33, i64 24, !34, i64 32, !34, i64 40, !35, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!31 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!32 = !{!"p1 _ZTS15__locale_struct", !16, i64 0}
!33 = !{!"bool", !7, i64 0}
!34 = !{!"p1 int", !16, i64 0}
