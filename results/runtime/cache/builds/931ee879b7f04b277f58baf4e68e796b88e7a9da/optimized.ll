...
for.cond:                                         ; preds = %for.inc, %entry
  %count.0 = phi i64 [ 0, %entry ], [ %call27.sink.sink, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 41, ptr noundef nonnull align 16 captures(none) dereferenceable(41) %s) #9
  ...
  %3 = load i32, ptr %_M_streambuf_state.i.i.i, align 8, !tbaa !23
  %cmp.i.i = icmp eq i32 %3, 0
  %4 = add i64 %2, -42
  %or.cond.i = icmp ult i64 %4, -41
...
_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit: ; preds = %for.body, %if.then19.i, %if.then28.i
...
if.else:                                          ; preds = %_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_.exit
  ...
  %call9 = call i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #10
...
if.then12:                                        ; preds = %if.else
  ...
  %gep38 = getelementptr i8, ptr getelementptr inbounds nuw (i8, ptr @_ZSt4cout, i64 16), i64 %vbase.offset.i9
  %6 = load i64, ptr %gep38, align 8, !tbaa !12
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit: ; preds = %if.then.i, %if.end.i
  %retval.0.i = phi ptr [ %call1.i12, %if.then.i ], [ @_ZSt4cout, %if.end.i ]
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %__c.addr.i)
  %call.i.i14 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #9
  %call1.i15 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %retval.0.i, ptr noundef nonnull align 16 dereferenceable(41) %s, i64 noundef %call.i.i14)
...
if.else22:                                        ; preds = %if.else
  ...
  %vbase.offset.i33 = load i64, ptr %vbase.offset.ptr.i32, align 8, !invariant.load !11
  ...
  %call.i.i23 = call noundef i64 @strlen(ptr noundef nonnull align 16 dereferenceable(41) %s) #9
  %call1.i24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %call.i.i37, ptr noundef nonnull align 16 dereferenceable(41) %s, i64 noundef %call.i.i23)
...
for.inc:                                          ; preds = %if.then, %if.else22, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit
  %call27.sink.sink = phi i64 [ %call6, %if.then ], [ %call27, %if.else22 ], [ %add20, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit ]
  call void @llvm.lifetime.end.p0(i64 noundef 41, ptr noundef nonnull captures(none) %s) #9
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur.i, align 8, !tbaa !36
  %_M_in_end.i = getelementptr inbounds nuw i8, ptr %this, i64 24
  %1 = load ptr, ptr %_M_in_end.i, align 8, !tbaa !39
...
!36 = !{!37, !38, i64 16}
!37 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !38, i64 8, !38, i64 16, !38, i64 24, !38, i64 32, !38, i64 40, !38, i64 48, !21, i64 56}
!38 = !{!"p1 omnipotent char", !18, i64 0}
!39 = !{!37, !38, i64 24}
!40 = !{!25, !29, i64 240}
!41 = !{!42, !7, i64 56}
!42 = !{!"_ZTSSt5ctypeIcE", !43, i64 0, !44, i64 16, !27, i64 24, !45, i64 32, !45, i64 40, !46, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!43 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!44 = !{!"p1 _ZTS15__locale_struct", !18, i64 0}
!45 = !{!"p1 int", !18, i64 0}
