...
entry:
  ...
  %call = call noundef i32 @_Z9down_casti(i32 noundef %n)
...
; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_Z9down_casti(i32 noundef %n) local_unnamed_addr #3 {
entry:
  %cmp = icmp eq i32 %n, 1
...
for.end53:                                        ; preds = %for.cond.cleanup38
  br label %for.cond55
...
for.end69:                                        ; preds = %for.cond.cleanup33
...
for.end91:                                        ; preds = %for.cond.cleanup78
  br label %for.inc92
...
for.end94:                                        ; preds = %for.cond.cleanup73
  br label %for.cond96
...
for.end116:                                       ; preds = %for.cond.cleanup103
  br label %for.inc117
...
for.end119:                                       ; preds = %for.cond.cleanup98
  %sub120 = sub nsw i32 %n, 1
  %call = call noundef i32 @_Z9down_casti(i32 noundef %sub120)
