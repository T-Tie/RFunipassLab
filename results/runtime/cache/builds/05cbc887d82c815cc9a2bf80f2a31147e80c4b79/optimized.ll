...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 41000, ptr nonnull %ch) #9
  call void @llvm.lifetime.start.p0(i64 4000, ptr nonnull %len) #9
...
for.inc:                                          ; preds = %if.else34.i, %if.then28.i, %if.then19.i, %land.lhs.true.i, %if.then6.i, %do.end.i
  %call5 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx) #10
...
while.end35:                                      ; preds = %while.body
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %len) #9
  call void @llvm.lifetime.end.p0(i64 41000, ptr nonnull %ch) #9
