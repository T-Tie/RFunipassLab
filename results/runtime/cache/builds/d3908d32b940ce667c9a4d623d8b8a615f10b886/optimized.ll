...
for.cond74:                                       ; preds = %for.cond, %for.inc132
  ...
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.inc132 ], [ 0, %for.cond ]
  %10 = sext i32 %9 to i64
  %cmp76.not.not = icmp slt i64 %indvars.iv4, %10
  br i1 %cmp76.not.not, label %for.body77, label %for.end134

for.body77:                                       ; preds = %for.cond74
  %arrayidx79 = getelementptr inbounds nuw [100 x [100 x double]], ptr %num, i64 0, i64 %indvars.iv4
