...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv39 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next40, %for.inc33 ]
  %indvars.iv11 = phi i64 [ 1, %for.cond3.preheader ], [ %indvars.iv.next12, %for.inc33 ]
  %smax41 = call i64 @llvm.smax.i64(i64 %indvars.iv39, i64 noundef 0)
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.body10 ], [ 0, %for.cond3 ]
  %maxIndex.0 = phi i32 [ %spec.select, %for.body10 ], [ 0, %for.cond3 ]
  %exitcond42 = icmp eq i64 %indvars.iv8, %smax41
  br i1 %exitcond42, label %for.end18, label %for.body10
...
for.cond54.preheader:                             ; preds = %for.end51
  %smax30 = call i32 @llvm.smax.i32(i32 %k.0, i32 noundef 0)
