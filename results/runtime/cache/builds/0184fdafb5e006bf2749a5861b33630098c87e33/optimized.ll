...
if.then:                                          ; preds = %for.body5
  ...
  %2 = load double, ptr %arrayidx8, align 8, !tbaa !12
...
if.then21:                                        ; preds = %if.then
  %fneg = fneg double %2
  %call25 = call double @sqrt(double noundef %5) #6, !tbaa !5
  %add26 = fadd double %fneg, %call25
  %mul29 = fmul double %3, 2.000000e+00
...
if.then53:                                        ; preds = %if.end51
  ...
  %fneg57 = fneg double %8
  %9 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %mul60 = fmul double %9, 2.000000e+00
