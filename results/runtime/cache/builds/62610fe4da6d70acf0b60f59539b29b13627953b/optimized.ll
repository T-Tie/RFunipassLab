...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc28
  %indvars.iv7 = phi i32 [ %sub, %for.cond2.preheader ], [ %indvars.iv.next8, %for.inc28 ]
  %j.0 = phi i32 [ 0, %for.cond2.preheader ], [ %inc29, %for.inc28 ]
  %exitcond10.not = icmp eq i32 %j.0, %smax9
  br i1 %exitcond10.not, label %for.end30, label %for.cond5.preheader
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc25
  %indvars.iv4 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next5, %for.inc25 ]
...
for.body9:                                        ; preds = %for.cond5
  ...
  %arrayidx13 = getelementptr inbounds nuw [100 x i32], ptr %a, i64 0, i64 %indvars.iv.next5
