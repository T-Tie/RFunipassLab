...
for.body24:                                       ; preds = %for.cond20
  ...
  %2 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !12
...
if.then58:                                        ; preds = %for.body55
  ...
  %4 = load i32, ptr %arrayidx60, align 4, !tbaa !5, !invariant.load !12
  %call61 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %4, i32 noundef 44) #5
  br label %for.inc66
...
if.else:                                          ; preds = %for.body55
  ...
  %5 = load i32, ptr %arrayidx63, align 4, !tbaa !5, !invariant.load !12
