...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %sum) #8
  store i32 1, ptr %sum, align 4, !tbaa !5
  %cmp = icmp eq i32 %n, 1
  %.n = select i1 %cmp, i32 2, i32 %n
  store i32 %.n, ptr %i, align 4, !tbaa !5
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i, i32 noundef %m, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %sum) #9
  %0 = load i32, ptr %sum, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) %sum) #8
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %b) #10
  call void @llvm.lifetime.start.p0(i64 noundef 4000, ptr noundef nonnull align 16 %a) #10
...
for.inc:                                          ; preds = %for.cond
  ...
  %call2 = call noundef i32 @_Z3funii(i32 noundef %2, i32 noundef 1) #11
...
for.cond3:                                        ; preds = %for.cond, %for.inc10
  ...
  %4 = sext i32 %3 to i64
  %cmp4 = icmp slt i64 %indvars.iv7, %4
  br i1 %cmp4, label %for.inc10, label %for.end12

for.inc10:                                        ; preds = %for.cond3
  %arrayidx7 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv7
...
for.end12:                                        ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 4000, ptr noundef nonnull %a) #9
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %b) #9
...
define internal fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %0, i32 noundef %1, ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %2) unnamed_addr #7 {
if.then_to_outline:
...
if.then3:                                         ; preds = %for.body
  %div = sdiv i32 %1, %inc1
  %call = tail call noundef i32 @_Z3funii(i32 noundef %div, i32 noundef %inc1) #13
...
attributes #7 = { minsize mustprogress nofree nosync nounwind optsize memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
