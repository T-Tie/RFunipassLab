...
for.end:                                          ; preds = %for.cond
  ...
  %smax12 = call i32 @llvm.smax.i32(i32 %0, i32 noundef 1)
  %wide.trip.count13 = zext nneg i32 %smax12 to i64
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc26, %for.end
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc26 ], [ 1, %for.end ]
  %j.0 = phi i32 [ %j.1, %for.inc26 ], [ 1, %for.end ]
  %exitcond14.not = icmp eq i64 %indvars.iv8, %wide.trip.count13
  br i1 %exitcond14.not, label %for.cond29.preheader, label %for.cond7.preheader
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv5
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.inc36
  %indvars.iv15 = phi i64 [ 0, %for.cond29.preheader ], [ %indvars.iv.next16, %for.inc36 ]
  %exitcond20.not = icmp eq i64 %indvars.iv15, %wide.trip.count19
  br i1 %exitcond20.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond29
  %arrayidx33 = getelementptr inbounds nuw [20000 x i32], ptr %b, i64 0, i64 %indvars.iv15
