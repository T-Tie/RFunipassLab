...
for.cond33:                                       ; preds = %for.inc43, %for.body32
  %.sink13 = phi i32 [ %1, %for.body32 ], [ %dec, %for.inc43 ]
  %cmp34 = icmp sge i32 %.sink13, 1
...
for.body35:                                       ; preds = %for.cond33
  ...
  %idxprom38 = sext i32 %.sink13 to i64
...
for.end44.thread:                                 ; preds = %for.body35
  ...
  store i32 %.sink13, ptr %x2, align 4, !tbaa !5
  br label %for.end50

for.inc43:                                        ; preds = %for.body35
  %dec = add nsw i32 %.sink13, -1
