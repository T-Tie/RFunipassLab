...
entry:
  ...
  %call = tail call i64 @strlen(ptr nofree noundef nonnull readonly dereferenceable(1) %str) #13
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state.i, align 8, !tbaa !20, !invariant.load !14
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !31, !invariant.load !14
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !39, !invariant.load !14
