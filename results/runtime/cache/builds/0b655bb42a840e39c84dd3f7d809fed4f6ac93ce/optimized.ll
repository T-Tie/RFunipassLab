...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc10 ], [ 1, %for.cond ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv20, %2
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv20, i64 %indvars.iv
...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv80 = phi i32 [ %indvars.iv.next81, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax127 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax116 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %1 = add nuw i32 %smax116, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv87 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next88, %for.inc23 ]
  %exitcond91 = icmp eq i64 %indvars.iv87, %wide.trip.count90
  br i1 %exitcond91, label %for.cond26.preheader, label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv87, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv82 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next83, %for.inc20 ]
  %exitcond86 = icmp eq i64 %indvars.iv82, %wide.trip.count
  br i1 %exitcond86, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv87, i64 %indvars.iv82
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv102 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next103, %for.inc57 ]
  %exitcond107 = icmp eq i64 %indvars.iv102, %wide.trip.count90
  br i1 %exitcond107, label %for.end59, label %for.cond29

for.cond29:                                       ; preds = %for.cond26, %for.body31
  %indvars.iv92 = phi i64 [ %indvars.iv.next93, %for.body31 ], [ 1, %for.cond26 ]
  %min.2 = phi i32 [ %spec.select78, %for.body31 ], [ 10000, %for.cond26 ]
  %exitcond96 = icmp eq i64 %indvars.iv92, %wide.trip.count95
  br i1 %exitcond96, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv92, i64 %indvars.iv102
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select78 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1
  br label %for.cond29, !llvm.loop !17

for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv97 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next98, %for.inc54 ]
  %exitcond101 = icmp eq i64 %indvars.iv97, %wide.trip.count95
  br i1 %exitcond101, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv97, i64 %indvars.iv102
...
for.end59:                                        ; preds = %for.cond26
  ...
  %wide.trip.count111 = zext i32 %n.tr to i64
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv113 = phi i64 [ %indvars.iv.next114, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond118 = icmp eq i64 %indvars.iv113, %wide.trip.count90
  br i1 %exitcond118, label %for.cond80.preheader, label %for.cond63

for.cond80.preheader:                             ; preds = %for.cond60
  %wide.trip.count128 = zext nneg i32 %smax127 to i64
  %wide.trip.count122 = zext i32 %n.tr to i64
  br label %for.cond80

for.cond63:                                       ; preds = %for.cond60, %for.inc74
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %for.inc74 ], [ 2, %for.cond60 ]
  %exitcond112.not = icmp eq i64 %indvars.iv108, %wide.trip.count111
  br i1 %exitcond112.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next109 = add nuw nsw i64 %indvars.iv108, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv113, i64 %indvars.iv.next109
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5, !invariant.load !20
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv113, i64 %indvars.iv108
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv124 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next125, %for.inc98 ]
  %exitcond129.not = icmp eq i64 %indvars.iv124, %wide.trip.count128
  br i1 %exitcond129.not, label %for.end100, label %for.cond83

for.cond83:                                       ; preds = %for.cond80, %for.inc95
  %indvars.iv119 = phi i64 [ %indvars.iv.next120, %for.inc95 ], [ 2, %for.cond80 ]
  %exitcond123.not = icmp eq i64 %indvars.iv119, %wide.trip.count122
  br i1 %exitcond123.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next120 = add nuw nsw i64 %indvars.iv119, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next120, i64 %indvars.iv124
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5, !invariant.load !20
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv119, i64 %indvars.iv124
