...
for.end32:
  ...
  %smax10 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 0)
  %7 = sext i32 %5 to i64
...
for.body82:                                       ; preds = %for.cond80
  ...
  %call87 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %18)
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %20 = phi i32 [ %.pre22, %if.then ], [ %19, %for.body82 ]
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre21 = phi i32 [ %20, %if.end ], [ %.pre21.pre, %if.then92 ]
