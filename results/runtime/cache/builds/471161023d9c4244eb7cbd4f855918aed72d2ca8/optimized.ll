...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %line) #4
...
land.lhs.true43:                                  ; preds = %for.body37
  ...
  %12 = load i32, ptr %arrayidx48, align 4, !tbaa !5, !invariant.load !13
...
for.end58:                                        ; preds = %for.cond32
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef %line) #5
