...
if.then33:                                        ; preds = %for.body5
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull %arrayidx7)
  br label %for.inc40
...
for.end42:                                        ; preds = %for.cond3
  ...
  call fastcc void @outlined_ir_func_0(ptr noundef nonnull %arrayidx45)
