...
for.end:                                          ; preds = %for.body4, %for.cond2
  %j.0.lcssa.in = phi i64 [ %indvars.iv, %for.body4 ], [ %indvars.iv24, %for.cond2 ]
...
for.cond17:                                       ; preds = %for.cond, %for.inc43
  ...
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc43 ], [ 0, %for.cond ]
...
for.cond20:                                       ; preds = %for.cond20.preheader, %for.inc30
  %indvars.iv27 = phi i64 [ 0, %for.cond20.preheader ], [ %indvars.iv.next28, %for.inc30 ]
...
for.end32:                                        ; preds = %for.body22, %for.cond20
  %j.1.lcssa.in = phi i64 [ %indvars.iv27, %for.body22 ], [ %indvars.iv31, %for.cond20 ]
