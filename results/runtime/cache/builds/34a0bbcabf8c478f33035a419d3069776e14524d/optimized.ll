...
if.then34:                                        ; preds = %if.end28
  %fneg35 = fneg double %10
  %mul36 = fmul double 2.000000e+00, %11
  %div37 = fdiv double %fneg35, %mul36
  %mul40 = fmul double %10, %10
  %neg41 = fneg double %mul40
  %14 = call double @llvm.fmuladd.f64(double %mul30, double %12, double %neg41)
  %call42 = call double @sqrt(double noundef %14) #7, !tbaa !5
  %div44 = fdiv double %call42, %mul36
  %call45 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div37, double noundef %div44) #8
  %call46 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, double noundef %div37, double noundef %div44) #8
  br label %for.inc
