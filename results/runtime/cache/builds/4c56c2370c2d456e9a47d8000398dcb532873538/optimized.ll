...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 501, ptr noundef %s) #5
  call void @llvm.lifetime.start.p0(i64 noundef 2505, ptr noundef %a) #5
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 2000, ptr noundef %c) #5
