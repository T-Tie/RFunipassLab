...
for.end:                                          ; preds = %for.cond
  br i1 true, label %if.then107, label %if.end119
...
if.end119:                                        ; preds = %for.end, %for.end.thread, %if.then115, %if.end113, %entry
  %phiofops = phi i1 [ false, %entry ], [ poison, %for.end ], [ false, %if.end113 ], [ false, %if.then115 ], [ true, %for.end.thread ]
  %flag.0 = phi i32 [ 1, %for.end.thread ], [ 0, %if.then115 ], [ 0, %if.end113 ], [ poison, %for.end ], [ 0, %entry ]
