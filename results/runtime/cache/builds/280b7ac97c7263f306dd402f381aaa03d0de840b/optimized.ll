...
for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc10
  %1 = phi i32 [ %3, %for.inc10 ], [ %0, %for.cond1.preheader ]
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc10 ], [ 1, %for.cond1.preheader ]
  %2 = sext i32 %1 to i64
  %cmp2.not = icmp sgt i64 %indvars.iv8, %2
  br i1 %cmp2.not, label %for.inc16, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond1
  br label %for.cond4

for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc
  %3 = phi i32 [ %.pre, %for.inc ], [ %1, %for.cond4.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 1, %for.cond4.preheader ]
  %4 = sext i32 %3 to i64
...
tailrecurse:                                      ; preds = %for.end100, %entry
  %indvars.iv55 = phi i32 [ %indvars.iv.next56, %for.end100 ], [ %0, %entry ]
  %accumulator.tr = phi i32 [ %add102, %for.end100 ], [ 0, %entry ]
  %n.tr = phi i32 [ %sub101, %for.end100 ], [ %n, %entry ]
  %smax102 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 1)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %cleanup, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax91 = call i32 @llvm.smax.i32(i32 %n.tr, i32 noundef 0)
  %1 = add nuw i32 %smax91, 1
...
for.cond:                                         ; preds = %for.cond.preheader, %for.inc23
  %indvars.iv62 = phi i64 [ 1, %for.cond.preheader ], [ %indvars.iv.next63, %for.inc23 ]
  %exitcond66 = icmp eq i64 %indvars.iv62, %wide.trip.count65
  br i1 %exitcond66, label %for.cond26.preheader, label %for.cond2.preheader
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  %min.0 = phi i32 [ %spec.select, %for.body4 ], [ 10000, %for.cond2.preheader ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc20
  %indvars.iv57 = phi i64 [ 1, %for.cond13.preheader ], [ %indvars.iv.next58, %for.inc20 ]
  %exitcond61 = icmp eq i64 %indvars.iv57, %wide.trip.count
  br i1 %exitcond61, label %for.inc23, label %for.inc20

for.inc20:                                        ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv62, i64 %indvars.iv57
...
for.cond26:                                       ; preds = %for.cond26.preheader, %for.inc57
  %indvars.iv77 = phi i64 [ 1, %for.cond26.preheader ], [ %indvars.iv.next78, %for.inc57 ]
  %exitcond82 = icmp eq i64 %indvars.iv77, %wide.trip.count65
  br i1 %exitcond82, label %for.end59, label %for.cond29.preheader
...
for.cond29:                                       ; preds = %for.cond29.preheader, %for.body31
  ...
  %min.2 = phi i32 [ %spec.select53, %for.body31 ], [ 10000, %for.cond29.preheader ]
  %exitcond71 = icmp eq i64 %indvars.iv67, %wide.trip.count
  br i1 %exitcond71, label %for.cond46.preheader, label %for.body31

for.cond46.preheader:                             ; preds = %for.cond29
  br label %for.cond46

for.body31:                                       ; preds = %for.cond29
  %arrayidx35 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv67, i64 %indvars.iv77
  %4 = load i32, ptr %arrayidx35, align 4, !tbaa !5
  %spec.select53 = tail call i32 @llvm.smin.i32(i32 %4, i32 %min.2)
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  br label %for.cond29, !llvm.loop !20

for.cond46:                                       ; preds = %for.cond46.preheader, %for.inc54
  %indvars.iv72 = phi i64 [ 1, %for.cond46.preheader ], [ %indvars.iv.next73, %for.inc54 ]
  %exitcond76 = icmp eq i64 %indvars.iv72, %wide.trip.count
  br i1 %exitcond76, label %for.inc57, label %for.inc54

for.inc54:                                        ; preds = %for.cond46
  %arrayidx52 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv72, i64 %indvars.iv77
...
for.cond60:                                       ; preds = %for.inc77, %for.end59
  %indvars.iv88 = phi i64 [ %indvars.iv.next89, %for.inc77 ], [ 1, %for.end59 ]
  %exitcond93 = icmp eq i64 %indvars.iv88, %wide.trip.count65
  br i1 %exitcond93, label %for.cond80.preheader, label %for.cond63.preheader
...
for.cond63:                                       ; preds = %for.cond63.preheader, %for.inc74
  %indvars.iv83 = phi i64 [ %indvars.iv.next84, %for.inc74 ], [ 2, %for.cond63.preheader ]
  %exitcond87.not = icmp eq i64 %indvars.iv83, %wide.trip.count86
  br i1 %exitcond87.not, label %for.inc77, label %for.inc74

for.inc74:                                        ; preds = %for.cond63
  %indvars.iv.next84 = add nuw nsw i64 %indvars.iv83, 1
  %arrayidx69 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv88, i64 %indvars.iv.next84
  %7 = load i32, ptr %arrayidx69, align 4, !tbaa !5
  %arrayidx73 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv88, i64 %indvars.iv83
...
for.cond80:                                       ; preds = %for.cond80.preheader, %for.inc98
  %indvars.iv99 = phi i64 [ 1, %for.cond80.preheader ], [ %indvars.iv.next100, %for.inc98 ]
  %exitcond104.not = icmp eq i64 %indvars.iv99, %wide.trip.count103
  br i1 %exitcond104.not, label %for.end100, label %for.cond83.preheader

for.cond83.preheader:                             ; preds = %for.cond80
  br label %for.cond83

for.cond83:                                       ; preds = %for.cond83.preheader, %for.inc95
  %indvars.iv94 = phi i64 [ %indvars.iv.next95, %for.inc95 ], [ 2, %for.cond83.preheader ]
  %exitcond98.not = icmp eq i64 %indvars.iv94, %wide.trip.count86
  br i1 %exitcond98.not, label %for.inc98, label %for.inc95

for.inc95:                                        ; preds = %for.cond83
  %indvars.iv.next95 = add nuw nsw i64 %indvars.iv94, 1
  %arrayidx90 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv.next95, i64 %indvars.iv99
  %8 = load i32, ptr %arrayidx90, align 4, !tbaa !5
  %arrayidx94 = getelementptr inbounds nuw [101 x [101 x i32]], ptr @a, i64 0, i64 %indvars.iv94, i64 %indvars.iv99
