...
for.body13:                                       ; preds = %for.cond10
  ...
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !12, !invariant.load !13
...
if.then:                                          ; preds = %for.body13
  ...
  store i32 %9, ptr %w, align 4, !tbaa !5
  store i32 0, ptr %flag, align 4, !tbaa !5
  br label %for.end25
...
for.end25:                                        ; preds = %if.then, %for.cond10
  %11 = load i32, ptr %flag, align 4, !tbaa !5
...
for.cond42:                                       ; preds = %for.inc52, %for.end41
  ...
  %17 = phi i32 [ %inc53, %for.inc52 ], [ 0, %for.end41 ]
  store i32 %.sink1, ptr %i, align 4, !tbaa !5
  %cmp43 = icmp slt i32 %17, 1000
...
for.body44:                                       ; preds = %for.cond42
  ...
  %20 = load i32, ptr %arrayidx46, align 4, !tbaa !5, !invariant.load !13
  %cmp47 = icmp slt i32 %18, %20
...
if.else58:                                        ; preds = %for.end54
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %21)
  br label %for.cond60

for.cond60:                                       ; preds = %for.inc80, %if.else58
  %.sink2 = phi i32 [ 0, %if.else58 ], [ %inc81, %for.inc80 ]
  %22 = phi i32 [ %inc81, %for.inc80 ], [ 0, %if.else58 ]
  store i32 %.sink2, ptr %i, align 4, !tbaa !5
  %cmp61 = icmp slt i32 %22, 1000
...
for.body62:                                       ; preds = %for.cond60
  ...
  %24 = load i32, ptr %arrayidx64, align 4, !tbaa !5, !invariant.load !13
  %cmp65 = icmp eq i32 %24, %21
...
for.cond67:                                       ; preds = %for.inc75, %if.then66
  ...
  %add68 = add nsw i32 %23, %26
  %cmp69 = icmp slt i32 %25, %add68
...
for.inc75:                                        ; preds = %for.cond67
  ...
  %27 = load i8, ptr %arrayidx72, align 1, !tbaa !12
