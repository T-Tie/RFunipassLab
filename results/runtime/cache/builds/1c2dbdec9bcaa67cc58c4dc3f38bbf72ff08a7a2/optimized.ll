...
for.end100:                                       ; preds = %for.cond66
  %call = call noundef i32 @_Z4xiaoi(i32 noundef %sub67)
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 400, ptr %result) #5
...
for.inc16:                                        ; preds = %for.cond1
  %call13 = call noundef i32 @_Z4xiaoi(i32 noundef %3)
...
for.end28:                                        ; preds = %for.cond19
  call void @llvm.lifetime.end.p0(i64 400, ptr %result) #5
