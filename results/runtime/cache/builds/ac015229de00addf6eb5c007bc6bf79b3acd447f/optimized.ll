...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4000000, ptr noundef align 16 %s) #3
...
for.cond10:                                       ; preds = %if.end30, %for.end9
  %a.0 = phi i32 [ 0, %for.end9 ], [ %a.2, %if.end30 ]
  %b.0 = phi i32 [ 0, %for.end9 ], [ %b.2, %if.end30 ]
...
for.cond13:                                       ; preds = %if.end, %for.body12
  %j.1 = phi i32 [ 0, %for.body12 ], [ %inc22, %if.end ]
...
for.end23:                                        ; preds = %for.cond13, %for.body15
  %a.2 = phi i32 [ %i.1, %for.body15 ], [ %a.0, %for.cond13 ]
  %b.2 = phi i32 [ %j.1, %for.body15 ], [ %b.0, %for.cond13 ]
...
for.cond34:                                       ; preds = %for.end52, %for.end33
  %c.0 = phi i32 [ 0, %for.end33 ], [ %c.1, %for.end52 ]
  %i.2 = phi i32 [ 0, %for.end33 ], [ %inc54, %for.end52 ]
  %d.0 = phi i32 [ 0, %for.end33 ], [ %d.1, %for.end52 ]
...
for.cond37:                                       ; preds = %if.end49, %for.body36
  %c.1 = phi i32 [ %c.0, %for.body36 ], [ %c.2, %if.end49 ]
  %j.2 = phi i32 [ 0, %for.body36 ], [ %inc51, %if.end49 ]
  %d.1 = phi i32 [ %d.0, %for.body36 ], [ %d.2, %if.end49 ]
