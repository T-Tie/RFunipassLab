...
for.body:                                         ; preds = %for.cond
  ...
  %or.cond77 = or i1 %cmp6, %or.cond
  %3 = load i32, ptr %m1, align 4, !tbaa !5
  %smax110 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
  br i1 %or.cond77, label %for.cond7, label %for.cond85

for.cond7:                                        ; preds = %for.body, %for.inc
  %n1.0 = phi i32 [ %add28, %for.inc ], [ 0, %for.body ]
  %4 = phi i32 [ %inc, %for.inc ], [ 1, %for.body ]
  %exitcond111.not = icmp eq i32 %4, %smax110
  br i1 %exitcond111.not, label %for.cond30.preheader, label %for.body9

for.cond30.preheader:                             ; preds = %for.cond7
  %5 = load i32, ptr %m2, align 4, !tbaa !5
  %smax112 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
  br label %for.cond30
...
for.inc:                                          ; preds = %for.body9, %for.inc.fold.split, %if.else27
  %.sink15.sink = phi i32 [ 29, %for.body9 ], [ 30, %if.else27 ], [ 31, %for.inc.fold.split ]
  %add28 = add nuw nsw i32 %.sink15.sink, %n1.0
  %inc = add nuw i32 %4, 1
...
for.cond30:                                       ; preds = %for.cond30.preheader, %for.inc56
  ...
  %6 = phi i32 [ %inc57, %for.inc56 ], [ 1, %for.cond30.preheader ]
  %exitcond113.not = icmp eq i32 %6, %smax112
  br i1 %exitcond113.not, label %for.end58, label %for.body32
...
for.inc56:                                        ; preds = %for.body32, %for.inc56.fold.split, %if.else52
  %.sink14.sink = phi i32 [ 29, %for.body32 ], [ 30, %if.else52 ], [ 31, %for.inc56.fold.split ]
  %add53 = add nuw nsw i32 %.sink14.sink, %n2.0
  %inc57 = add nuw i32 %6, 1
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts105 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.5.str.4) #6
  br label %if.end68
...
for.cond85:                                       ; preds = %for.body, %for.inc109
  ...
  %7 = phi i32 [ %inc110, %for.inc109 ], [ 1, %for.body ]
  %exitcond.not = icmp eq i32 %7, %smax110
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax108 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 1)
  br label %for.cond112

for.body87:                                       ; preds = %for.cond85
  switch i32 %7, label %if.else105 [
...
for.inc109:                                       ; preds = %for.body87, %for.inc109.fold.split, %if.else105
  %.sink13.sink = phi i32 [ 28, %for.body87 ], [ 30, %if.else105 ], [ 31, %for.inc109.fold.split ]
  %add106 = add nuw nsw i32 %.sink13.sink, %n182.0
  %inc110 = add nuw i32 %7, 1
...
for.cond112:                                      ; preds = %for.cond112.preheader, %for.inc138
  ...
  %9 = phi i32 [ %inc139, %for.inc138 ], [ 1, %for.cond112.preheader ]
  %exitcond109.not = icmp eq i32 %9, %smax108
  br i1 %exitcond109.not, label %for.end140, label %for.body114
...
for.inc138:                                       ; preds = %for.body114, %for.inc138.fold.split, %if.else134
  %.sink12.sink = phi i32 [ 28, %for.body114 ], [ 30, %if.else134 ], [ 31, %for.inc138.fold.split ]
  %add135 = add nuw nsw i32 %.sink12.sink, %n283.0
  %inc139 = add nuw i32 %9, 1
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts101 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts102 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.sink) #6
  br label %for.inc164

for.inc164:                                       ; preds = %for.inc164.sink.split, %if.end151, %if.end68
