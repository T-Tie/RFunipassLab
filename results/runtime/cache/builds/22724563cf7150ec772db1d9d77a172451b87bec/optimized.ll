...
for.body:                                         ; preds = %for.cond
  ...
  %.str.1..str = select i1 %cmp1, ptr @.str.1, ptr @.str
  %call5 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull %.str.1..str, ptr noundef nonnull %arrayidx)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !9

for.cond6:                                        ; preds = %for.cond6.preheader, %if.end18
  %indvars.iv27 = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next28, %if.end18 ]
  %t.0 = phi i32 [ -1, %for.cond6.preheader ], [ %t.1, %if.end18 ]
...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax35 = call i32 @llvm.smax.i32(i32 %t.0, i32 noundef 0)
...
for.body8:                                        ; preds = %for.cond6
  %arrayidx10 = getelementptr inbounds nuw [500 x i32], ptr %sz, i64 0, i64 %indvars.iv27
  %5 = load i32, ptr %arrayidx10, align 4, !tbaa !5, !invariant.load !12
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.end48
  %q.0 = phi i32 [ %inc50, %for.end48 ], [ 1, %for.cond22.preheader ]
  %exitcond39 = icmp eq i32 %q.0, %4
  br i1 %exitcond39, label %for.cond52.preheader, label %for.cond25
...
for.cond25:                                       ; preds = %for.cond22, %if.end45
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %if.end45 ], [ 0, %for.cond22 ]
  %exitcond37.not = icmp eq i64 %indvars.iv31, %wide.trip.count36
  br i1 %exitcond37.not, label %for.end48, label %for.body27

for.body27:                                       ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv31
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next32 = add nuw nsw i64 %indvars.iv31, 1
  %arrayidx32 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv.next32
...
for.cond52:                                       ; preds = %for.cond52.preheader, %for.body54
  %indvars.iv40 = phi i64 [ 0, %for.cond52.preheader ], [ %indvars.iv.next41, %for.body54 ]
  %exitcond46 = icmp eq i64 %indvars.iv40, %wide.trip.count45
  br i1 %exitcond46, label %for.end67, label %for.body54

for.body54:                                       ; preds = %for.cond52
  %cmp55 = icmp slt i64 %indvars.iv40, %7
  %11 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv40
  %12 = load i32, ptr %11, align 4, !tbaa !5, !invariant.load !12
  %.str.2..str.3 = select i1 %cmp55, ptr @.str.2, ptr @.str.3
  %call63 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str.2..str.3, i32 noundef %12) #6
