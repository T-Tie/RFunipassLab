...
for.inc:                                          ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv25, i64 %indvars.iv
...
for.cond13:                                       ; preds = %for.inc27, %for.end10
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc27 ], [ 0, %for.end10 ]
  %4 = load i32, ptr %x2, align 4, !tbaa !5
  %5 = sext i32 %4 to i64
  %cmp14 = icmp slt i64 %indvars.iv31, %5
  br i1 %cmp14, label %for.cond16, label %for.cond60

for.cond16:                                       ; preds = %for.cond13, %for.inc24
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc24 ], [ 0, %for.cond13 ]
  %6 = load i32, ptr %y2, align 4, !tbaa !5
  %7 = sext i32 %6 to i64
  %cmp17 = icmp slt i64 %indvars.iv28, %7
  br i1 %cmp17, label %for.inc24, label %for.inc27

for.inc24:                                        ; preds = %for.cond16
  %arrayidx22 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %b, i64 0, i64 %indvars.iv31, i64 %indvars.iv28
...
for.cond60:                                       ; preds = %for.cond13, %for.end75
  %m.3 = phi i32 [ %inc9.i3, %for.end75 ], [ 0, %for.cond13 ]
  %8 = load i32, ptr %x1, align 4, !tbaa !5
  %cmp61 = icmp slt i32 %m.3, %8
  br i1 %cmp61, label %for.cond63, label %for.end79

for.cond63:                                       ; preds = %for.cond60, %if.end
  %n.3 = phi i32 [ %inc9.i2, %if.end ], [ 0, %for.cond60 ]
  %9 = load i32, ptr %y2, align 4, !tbaa !5
  %cmp64 = icmp slt i32 %n.3, %9
...
for.body65:                                       ; preds = %for.cond63
  ...
  %cmp71 = icmp slt i32 %n.3, %sub
  br i1 %cmp71, label %if.then, label %if.end

if.then:                                          ; preds = %for.body65
  %call72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext 32)
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body65
  %inc9.i2 = add nuw nsw i32 %n.3, 1
  br label %for.cond63

for.end75:                                        ; preds = %for.cond63
  %call76 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %inc9.i3 = add nuw nsw i32 %m.3, 1
  br label %for.cond60
