...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %k2) #5
...
if.end32:                                         ; preds = %if.then21, %for.end18
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %k2) #5
  br label %for.cond3

for.end35:                                        ; preds = %for.cond3
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %k2) #5
  store i32 0, ptr %i, align 4, !tbaa !5
  br label %for.cond36
...
for.body56:                                       ; preds = %for.cond54
  ...
  %call59 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %10)
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #5
  br label %for.cond54
...
for.inc73:                                        ; preds = %for.cond66
  ...
  %call72 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12)
  %inc74 = add nsw i32 %11, 1
...
for.end75:                                        ; preds = %for.cond66
  ...
  %call79 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %13)
  br label %if.end80
