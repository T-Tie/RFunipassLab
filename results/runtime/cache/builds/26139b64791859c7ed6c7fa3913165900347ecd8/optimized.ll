...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc35
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre6, %for.inc35 ]
  %indvars.iv3 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next4, %for.inc35 ]
  %10 = sext i32 %9 to i64
  %cmp14.not = icmp sgt i64 %indvars.iv3, %10
  br i1 %cmp14.not, label %for.end37, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx17 = getelementptr inbounds nuw float, ptr %vla2, i64 %indvars.iv3
...
for.inc35:                                        ; preds = %if.else, %for.body15, %if.else31
  %.str.2.sink = phi ptr [ @.str.2, %if.else31 ], [ @.str, %for.body15 ], [ @.str.1, %if.else ]
  %call20.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink)
  %call21.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEPFRSoS_E(ptr noundef nonnull align 8 dereferenceable(8) %call20.i, ptr noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
