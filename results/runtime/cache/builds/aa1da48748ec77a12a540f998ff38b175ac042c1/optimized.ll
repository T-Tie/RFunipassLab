...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv26 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next27, %for.inc67 ]
...
for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv21 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next22, %for.inc64 ]
...
for.cond71:                                       ; preds = %for.inc92, %for.end69
  ...
  br i1 %exitcond43.not, label %for.cond96.preheader, label %for.cond76.preheader
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv49 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next50, %for.inc117 ]
