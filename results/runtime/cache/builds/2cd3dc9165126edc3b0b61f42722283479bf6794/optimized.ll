...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc35
  %9 = phi i32 [ %5, %for.cond13.preheader ], [ %.pre5, %for.inc35 ]
  %indvars.iv2 = phi i64 [ 2, %for.cond13.preheader ], [ %indvars.iv.next3, %for.inc35 ]
...
for.inc35:                                        ; preds = %for.body15, %if.else, %if.else31
  ...
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) %.str.2.sink.sink)
