...
entry:
  ...
  %div39 = sdiv i8 %div3.lhs.trunc, 20
  ...
  %div1010 = sdiv i8 %div10.lhs.trunc, 5
  %div10.sext = sext i8 %div1010 to i32
  %rem11 = srem i32 %0, 5
  %call12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div, i32 noundef %div1.sext, i32 noundef %div3.sext, i32 noundef %div8, i32 noundef %div10.sext, i32 noundef %rem11)
