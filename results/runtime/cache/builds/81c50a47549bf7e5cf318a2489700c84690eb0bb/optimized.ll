...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80000, ptr %total) #5
  call void @llvm.lifetime.start.p0(i64 80000, ptr %valid) #5
  call void @llvm.lifetime.start.p0(i64 8, ptr %t1) #5
  call void @llvm.lifetime.start.p0(i64 8, ptr %v1) #5
  call void @llvm.lifetime.start.p0(i64 80000, ptr %x) #5
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 80000, ptr %x) #5
  call void @llvm.lifetime.end.p0(i64 8, ptr %v1) #5
  call void @llvm.lifetime.end.p0(i64 8, ptr %t1) #5
  call void @llvm.lifetime.end.p0(i64 80000, ptr %valid) #5
  call void @llvm.lifetime.end.p0(i64 80000, ptr %total) #5
  ret i32 0
}
