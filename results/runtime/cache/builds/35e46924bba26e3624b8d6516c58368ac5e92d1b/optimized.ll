...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %a) #9
  call void @llvm.lifetime.start.p0(i64 noundef 10000, ptr noundef nonnull align 16 dereferenceable(10000) %b) #9
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call2 = call i64 @strlen(ptr noundef %b) #10
...
for.cond17:                                       ; preds = %for.inc25, %for.end
  %i.1 = phi i32 [ %sub, %for.end ], [ %dec, %for.inc25 ]
  %cmp18 = icmp sge i32 %i.1, 0
...
for.end26:                                        ; preds = %for.cond17
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %b) #11
  call void @llvm.lifetime.end.p0(i64 noundef 10000, ptr noundef %a) #11
  ret i32 0
}
...
entry:
  ...
  %0 = load i64, ptr %_M_width, align 8, !tbaa !41, !invariant.load !8
  ret i64 %0
}
