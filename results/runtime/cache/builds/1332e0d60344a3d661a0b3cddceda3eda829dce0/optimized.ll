...
for.inc:                                          ; preds = %if.then, %if.else32, %if.then25
  %call42.sink = phi double [ %call42, %if.else32 ], [ %fneg26, %if.then25 ], [ %sub, %if.then ]
  %.sink = phi i64 [ 1, %if.else32 ], [ 0, %if.then25 ], [ 1, %if.then ]
...
if.then55:                                        ; preds = %for.body51
  ...
  %7 = load double, ptr %arrayidx58, align 8, !tbaa !9
  ...
  %8 = load double, ptr %arrayidx61, align 8, !tbaa !9
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %7, double noundef %8)
  br label %for.inc110
...
if.then67:                                        ; preds = %if.else63
  ...
  %9 = load double, ptr %arrayidx70, align 8, !tbaa !9
...
if.else72:                                        ; preds = %if.else63
  ...
  %10 = load double, ptr %arrayidx75, align 8, !tbaa !9
...
if.then77:                                        ; preds = %if.else72
  ...
  %11 = load double, ptr %arrayidx84, align 8, !tbaa !9
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %11, double noundef %fneg81, double noundef %11)
  br label %for.inc110
...
if.else93:                                        ; preds = %if.else72
  ...
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %10, double noundef %12, double noundef %10, double noundef %12)
  br label %for.inc110
...
for.end112:                                       ; preds = %for.cond49
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 792, ptr noundef %x) #7
  call void @llvm.lifetime.end.p0(i64 noundef 1584, ptr noundef %m) #7
  ret i32 0
}
