...
for.cond:
  ...
  %cmp = icmp eq i32 %0, -1
  br i1 %cmp, label %for.end33, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond
  %arrayidx4 = getelementptr inbounds nuw i8, ptr %a, i64 4
  %call5 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx4)
  unreachable

for.end33:                                        ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 60, ptr noundef nonnull %a) #5
  ret i32 0
}
