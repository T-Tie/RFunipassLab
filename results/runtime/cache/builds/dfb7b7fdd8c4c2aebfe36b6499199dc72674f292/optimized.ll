...
for.cond6:                                        ; preds = %for.inc12, %for.body5
  %4 = phi i32 [ %inc13, %for.inc12 ], [ 0, %for.body5 ]
  %cmp7 = icmp slt i32 %4, 39
...
for.inc12:                                        ; preds = %for.cond6
  ...
  %5 = load i32, ptr %arrayidx, align 4, !tbaa !5, !invariant.load !12
...
for.cond15:                                       ; preds = %for.inc30, %for.end14
  %6 = phi i32 [ %add, %for.inc30 ], [ 0, %for.end14 ]
  %cmp16 = icmp sle i32 %6, 39
...
for.inc30:                                        ; preds = %for.cond15
  ...
  %8 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %add22 = add nsw i32 %div, %8
...
while.cond:                                       ; preds = %while.body, %for.end35
  ...
  %10 = load i32, ptr %arrayidx37, align 4, !tbaa !5, !invariant.load !12
...
for.cond39:                                       ; preds = %for.inc45, %while.end
  %11 = phi i32 [ %dec46, %for.inc45 ], [ %9, %while.end ]
  %cmp40 = icmp sge i32 %11, 0
...
for.inc45:                                        ; preds = %for.cond39
  ...
  %12 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !12
