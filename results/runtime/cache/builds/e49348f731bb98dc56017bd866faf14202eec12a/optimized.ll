...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc7
  %indvars.iv13 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next14, %for.inc7 ]
...
for.inc7:                                         ; preds = %for.cond2
  %h = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv13, i32 1
...
for.cond45.preheader:                             ; preds = %for.cond10
  ...
  %smax28 = add nsw i32 %4, -1
  %wide.trip.count29 = zext nneg i32 %smax28 to i64
  br label %for.cond45

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc40
  %indvars.iv17 = phi i64 [ %3, %for.cond13.preheader ], [ %indvars.iv.next18, %for.inc40 ]
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx20 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv.next18
...
for.cond45:                                       ; preds = %for.cond45.loopexit, %for.cond45.preheader
  %indvars.iv25 = phi i64 [ %indvars.iv.next26, %for.cond45.loopexit ], [ 0, %for.cond45.preheader ]
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.cond45.loopexit ], [ 1, %for.cond45.preheader ]
  %exitcond30.not = icmp eq i64 %indvars.iv25, %wide.trip.count29
  br i1 %exitcond30.not, label %for.end79, label %for.body48

for.body48:                                       ; preds = %for.cond45
  %h55 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv25, i32 1
  br label %for.cond50

for.cond50:                                       ; preds = %for.inc74, %for.body48
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc74 ], [ %indvars.iv20, %for.body48 ]
  %10 = trunc nuw i64 %indvars.iv22 to i32
  %cmp51 = icmp sgt i32 %0, %10
  br i1 %cmp51, label %for.body52, label %for.cond45.loopexit

for.body52:                                       ; preds = %for.cond50
  %11 = load i32, ptr %h55, align 4, !tbaa !12
  %h58 = getelementptr inbounds nuw [50 x %struct.z], ptr %a, i64 0, i64 %indvars.iv22, i32 1
