...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 800, ptr noundef nonnull %a) #6
  br label %for.cond
...
if.then21:                                        ; preds = %if.then
  %fneg = fneg double %6
  %call25 = call double @sqrt(double noundef %11) #6, !tbaa !5
  %add26 = fsub double %call25, %6
  %mul29 = fmul double %7, 2.000000e+00
  %div = fdiv double %add26, %mul29
  %call34 = call double @sqrt(double noundef %11) #6, !tbaa !5
