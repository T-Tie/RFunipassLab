...
for.inc:                                          ; preds = %if.else6, %land.lhs.true8, %if.then5, %if.then10
...
for.end:                                          ; preds = %for.cond
  ...
  %call14 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %7) #5
  %8 = load i32, ptr %b, align 4, !tbaa !5
  %call15 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %8) #5
