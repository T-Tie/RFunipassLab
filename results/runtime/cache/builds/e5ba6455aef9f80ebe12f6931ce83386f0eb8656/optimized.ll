...
entry:
  %smax = call i32 @llvm.smax.i32(i32 noundef %n, i32 noundef 0) #6
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc11
  %indvars.iv16 = phi i64 [ 0, %for.cond4.preheader ], [ %indvars.iv.next17, %for.inc11 ]
  %exitcond20.not = icmp eq i64 %indvars.iv16, %wide.trip.count
  br i1 %exitcond20.not, label %for.end13, label %for.inc11

for.inc11:                                        ; preds = %for.cond4
  %add.ptr8 = getelementptr inbounds nuw i32, ptr %p.tr, i64 %indvars.iv16
...
for.cond5:                                        ; preds = %for.cond5.preheader, %for.inc14
  %indvars.iv17 = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next18, %for.inc14 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, %wide.trip.count
  br i1 %exitcond22.not, label %for.end16, label %for.inc14

for.inc14:                                        ; preds = %for.cond5
  %add.ptr10.idx = mul nuw nsw i64 %indvars.iv17, 400
...
for.cond1:                                        ; preds = %for.cond, %for.inc10
  ...
  %2 = sext i32 %1 to i64
  %cmp2 = icmp slt i64 %indvars.iv54, %2
...
for.inc:                                          ; preds = %for.cond4
  %arrayidx8 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv54, i64 %indvars.iv
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc63
  %indvars.iv81 = phi i64 [ %5, %for.cond14.preheader ], [ %indvars.iv.next82, %for.inc63 ]
  %indvars.iv78 = phi i64 [ %4, %for.cond14.preheader ], [ %indvars.iv.next79, %for.inc63 ]
...
for.cond19:                                       ; preds = %for.inc37, %for.body16
  %indvars.iv63 = phi i64 [ %indvars.iv.next64, %for.inc37 ], [ 0, %for.body16 ]
  %exitcond67.not = icmp eq i64 %indvars.iv63, %indvars.iv81
  br i1 %exitcond67.not, label %for.cond40, label %for.cond22

for.cond22:                                       ; preds = %for.cond19, %for.inc34
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc34 ], [ 1, %for.cond19 ]
  %exitcond.not = icmp eq i64 %indvars.iv57, %indvars.iv78
  br i1 %exitcond.not, label %for.inc37, label %for.inc34

for.inc34:                                        ; preds = %for.cond22
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %arrayidx29 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next58
  %10 = load i32, ptr %arrayidx29, align 4, !tbaa !5, !invariant.load !17
  %arrayidx33 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv63, i64 %indvars.iv57
...
for.cond40:                                       ; preds = %for.cond19, %for.inc60
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %for.inc60 ], [ 0, %for.cond19 ]
  %exitcond77.not = icmp eq i64 %indvars.iv73, %indvars.iv78
  br i1 %exitcond77.not, label %for.inc63, label %for.cond44

for.cond44:                                       ; preds = %for.cond40, %for.inc57
  %indvars.iv68 = phi i64 [ %indvars.iv.next69, %for.inc57 ], [ 1, %for.cond40 ]
  %exitcond72.not = icmp eq i64 %indvars.iv68, %indvars.iv78
  br i1 %exitcond72.not, label %for.inc60, label %for.inc57

for.inc57:                                        ; preds = %for.cond44
  %indvars.iv.next69 = add nuw nsw i64 %indvars.iv68, 1
  %arrayidx52 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv.next69, i64 %indvars.iv73
  %11 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !17
  %arrayidx56 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv68, i64 %indvars.iv73
