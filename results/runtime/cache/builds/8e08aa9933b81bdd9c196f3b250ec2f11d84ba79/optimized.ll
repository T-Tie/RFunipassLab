...
if.then31:                                        ; preds = %for.body29
  %5 = load i32, ptr %B, align 16, !tbaa !5, !invariant.load !12
  %call34 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5) #5
  br label %for.inc39
...
if.else:                                          ; preds = %for.body29
  ...
  %call37 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %6) #5
  br label %for.inc39
