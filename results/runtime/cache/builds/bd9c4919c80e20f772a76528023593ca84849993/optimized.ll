...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef align 4 %y2) #6
...
for.cond49:                                       ; preds = %for.inc74, %for.body48
  ...
  %cmp50 = icmp slt i32 %26, %22
  br i1 %cmp50, label %for.inc74, label %for.inc77

for.inc74:                                        ; preds = %for.cond49
...
for.end97:                                        ; preds = %for.cond87
  %call98 = call i32 (ptr, ...) @printf(ptr noundef @.str.3) #7
  call fastcc void @outlined_ir_func_0(ptr noalias nofree noundef nonnull align 4 captures(none) dereferenceable(4) %i) #7
  br label %for.cond80
