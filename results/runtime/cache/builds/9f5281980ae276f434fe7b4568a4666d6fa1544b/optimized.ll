...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 320, ptr noundef nonnull align 16 %a) #3
  call void @llvm.lifetime.start.p0(i64 noundef 320, ptr noundef nonnull align 16 %b) #3
  call void @llvm.lifetime.start.p0(i64 noundef 320, ptr noundef nonnull align 16 %c) #3
  call void @llvm.lifetime.start.p0(i64 noundef 320, ptr noundef nonnull align 16 %d) #3
  call void @llvm.lifetime.start.p0(i64 noundef 320, ptr noundef nonnull align 16 %e) #3
  call void @llvm.lifetime.start.p0(i64 noundef 320, ptr noundef nonnull align 16 %f) #3
  br label %for.cond
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %cmp20 = icmp eq i32 %.pre25, 0
  %or.cond = select i1 %cmp16, i1 %cmp20, i1 false
  br i1 %or.cond, label %land.lhs.true21, label %for.inc
...
for.inc:                                          ; preds = %for.body, %land.lhs.true29, %land.lhs.true25, %land.lhs.true21, %land.lhs.true
  %4 = phi i32 [ 0, %land.lhs.true29 ], [ 0, %land.lhs.true25 ], [ 0, %land.lhs.true21 ], [ %.pre25, %land.lhs.true ], [ %.pre25, %for.body ]
...
for.end:                                          ; preds = %land.lhs.true29, %for.cond
  call void @llvm.lifetime.end.p0(i64 noundef 320, ptr noundef nonnull align 16 %f) #4
  call void @llvm.lifetime.end.p0(i64 noundef 320, ptr noundef nonnull align 16 %e) #4
  call void @llvm.lifetime.end.p0(i64 noundef 320, ptr noundef nonnull align 16 %d) #4
  call void @llvm.lifetime.end.p0(i64 noundef 320, ptr noundef nonnull align 16 %c) #4
  call void @llvm.lifetime.end.p0(i64 noundef 320, ptr noundef nonnull align 16 %b) #4
  call void @llvm.lifetime.end.p0(i64 noundef 320, ptr noundef nonnull align 16 %a) #4
  ret i32 0
}
