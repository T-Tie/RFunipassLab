...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 %j) #6
...
while.end:                                        ; preds = %while.cond
  call void @outlined_ir_func_0(ptr %i)
  call void @outlined_ir_func_0(ptr %j)
...
newFuncRoot:
  br label %while.end_to_outline

while.end_to_outline:                             ; preds = %newFuncRoot
  ...
  br label %while.end_after_outline.exitStub

while.end_after_outline.exitStub:                 ; preds = %while.end_to_outline
  ret void
}
