...
for.cond10:                                       ; preds = %for.end23, %for.cond10.preheader
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.end23 ], [ 0, %for.cond10.preheader ]
  ...
  br i1 %exitcond14.not, label %for.end33, label %for.cond13.preheader
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv5 = phi i64 [ 0, %for.cond13.preheader ], [ %indvars.iv.next6, %for.inc21 ]
  %exitcond.not = icmp eq i64 %indvars.iv5, %wide.trip.count
  br i1 %exitcond.not, label %for.end23, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [100 x [100 x i32]], ptr %a, i64 0, i64 %indvars.iv9, i64 %indvars.iv5
