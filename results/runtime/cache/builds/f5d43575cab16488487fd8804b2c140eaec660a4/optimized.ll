...
for.cond.i:                                       ; preds = %_Z5powerii.exit.i, %while.body
  %phiofops.i = phi i32 [ 0, %while.body ], [ %j.0.i, %_Z5powerii.exit.i ]
  %j.0.i = phi i32 [ 1, %while.body ], [ %2, %_Z5powerii.exit.i ]
  %2 = add nuw i32 %j.0.i, 1
  br label %for.cond.i.i

for.cond.i.i:                                     ; preds = %for.inc.i.i, %for.cond.i
  %sum.0.i.i = phi i32 [ 1, %for.cond.i ], [ %mul.i.i, %for.inc.i.i ]
  %k.0.i.i = phi i32 [ 1, %for.cond.i ], [ %inc.i.i, %for.inc.i.i ]
  %exitcond.i.i = icmp eq i32 %k.0.i.i, %2
  br i1 %exitcond.i.i, label %_Z5powerii.exit.i, label %for.inc.i.i

for.inc.i.i:                                      ; preds = %for.cond.i.i
  %mul.i.i = shl nsw i32 %sum.0.i.i, 1
  %inc.i.i = add nuw i32 %k.0.i.i, 1
  br label %for.cond.i.i, !llvm.loop !9

_Z5powerii.exit.i:                                ; preds = %for.cond.i.i
  %cmp.i = icmp sgt i32 %sum.0.i.i, %1
  br i1 %cmp.i, label %_Z5qufeni.exit, label %for.cond.i, !llvm.loop !12

_Z5qufeni.exit:                                   ; preds = %_Z5powerii.exit.i
  %3 = call i32 @llvm.smax.i32(i32 noundef %phiofops.i, i32 noundef 1)
  %smax = add nuw nsw i32 %3, 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %_Z5qufeni.exit
  %i.0 = phi i32 [ 2, %_Z5qufeni.exit ], [ %inc, %for.inc ]
  %sum.0 = phi i32 [ 1, %_Z5qufeni.exit ], [ %add, %for.inc ]
  %exitcond = icmp eq i32 %i.0, %smax
  br i1 %exitcond, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.cond
  %call4 = call noundef i32 @_Z3numiii(i32 noundef %1, i32 noundef %i.0, i32 noundef 2) #9
...
for.end:                                          ; preds = %for.cond
  ...
  %vtable.i = load ptr, ptr %call5, align 8, !tbaa !14, !invariant.load !16
  ...
  %call1.i = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call5, i8 noundef signext %call.i1)
...
define dso_local noundef range(i32 -2147483648, 2147483647) i32 @_Z5qufeni(i32 noundef %n) local_unnamed_addr #3 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %_Z5powerii.exit, %entry
  %phiofops = phi i32 [ 0, %entry ], [ %j.0, %_Z5powerii.exit ]
  %j.0 = phi i32 [ 1, %entry ], [ %0, %_Z5powerii.exit ]
  %0 = add nuw i32 %j.0, 1
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc.i, %for.cond
  %sum.0.i = phi i32 [ 1, %for.cond ], [ %mul.i, %for.inc.i ]
  %k.0.i = phi i32 [ 1, %for.cond ], [ %inc.i, %for.inc.i ]
  %exitcond.i = icmp eq i32 %k.0.i, %0
  br i1 %exitcond.i, label %_Z5powerii.exit, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond.i
  %mul.i = shl nsw i32 %sum.0.i, 1
  %inc.i = add nuw i32 %k.0.i, 1
  br label %for.cond.i, !llvm.loop !9

_Z5powerii.exit:                                  ; preds = %for.cond.i
  %cmp = icmp sgt i32 %sum.0.i, %n
  br i1 %cmp, label %if.then, label %for.cond, !llvm.loop !12

if.then:                                          ; preds = %_Z5powerii.exit
  ret i32 %phiofops
}

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none) uwtable
define dso_local noundef i32 @_Z3numiii(i32 noundef %n, i32 noundef %g, i32 noundef %h) local_unnamed_addr #4 {
entry:
...
if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef nonnull align 16 %a) #8
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %h, i32 noundef %n)
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  br i1 %cmp7, label %cleanup, label %for.cond9.preheader

for.cond9.preheader:                              ; preds = %for.end
  %sub = add nsw i32 %g, -1
  %smax14 = tail call i32 @llvm.smax.i32(i32 %j.0, i32 noundef 0)
  %wide.trip.count = zext nneg i32 %smax14 to i64
  br label %for.cond9

for.cond9:                                        ; preds = %for.cond9.preheader, %for.inc16
  %indvars.iv = phi i64 [ 0, %for.cond9.preheader ], [ %indvars.iv.next, %for.inc16 ]
  %count.0 = phi i32 [ 0, %for.cond9.preheader ], [ %add, %for.inc16 ]
  %exitcond15.not = icmp eq i64 %indvars.iv, %wide.trip.count
  br i1 %exitcond15.not, label %cleanup, label %for.inc16

for.inc16:                                        ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx13, align 4, !tbaa !5, !invariant.load !16
  %div = sdiv i32 %n, %0
  %call = tail call noundef i32 @_Z3numiii(i32 noundef %div, i32 noundef %sub, i32 noundef %0) #10
...
cleanup:                                          ; preds = %for.cond9, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 80000, ptr noundef nonnull align 16 %a) #8
  br label %return
...
entry:
  %smax = tail call i32 @llvm.smax.i32(i32 noundef %b, i32 noundef 0)
...
entry:
  ...
  %0 = load ptr, ptr %_M_ctype, align 8, !tbaa !20, !invariant.load !16
...
entry:
  ...
  %0 = load i8, ptr %_M_widen_ok, align 8, !tbaa !38, !invariant.load !16
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !44, !invariant.load !16
  br label %return
