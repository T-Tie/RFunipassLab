...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 41000, ptr noundef nonnull dereferenceable(41000) %word) #12
...
if.then6.i:                                       ; preds = %for.body
  ...
  %call16.i = call noundef zeroext i1 @_ZNKSt9basic_iosIcSt11char_traitsIcEE4goodEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #14
...
if.then19.i:                                      ; preds = %land.lhs.true.i
  %call24.i = call noundef ptr @_ZNKSt9basic_iosIcSt11char_traitsIcEE5rdbufEv(ptr noundef nonnull align 8 dereferenceable(264) %add.ptr10.i) #14
...
for.cond2:                                        ; preds = %for.cond, %if.end73
  ...
  %indvars.iv47 = phi i64 [ %indvars.iv.next48, %if.end73 ], [ 0, %for.cond ]
  %j.0 = phi i32 [ %j.1, %if.end73 ], [ 0, %for.cond ]
  %k.0 = phi i32 [ %k.1, %if.end73 ], [ 0, %for.cond ]
  %5 = sext i32 %4 to i64
  %cmp3 = icmp slt i64 %indvars.iv47, %5
  br i1 %cmp3, label %for.body4, label %for.end76

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [1000 x [41 x i8]], ptr %word, i64 0, i64 %indvars.iv47
...
if.else42:                                        ; preds = %if.else
  ...
  %arrayidx56 = getelementptr inbounds [1000 x [81 x i8]], ptr %newword, i64 0, i64 %idxprom10, i64 %idxprom55
...
for.end76:                                        ; preds = %for.cond2
  ...
  %smax57 = call i32 @llvm.smax.i32(i32 %k.0, i32 -1)
  %6 = add i32 %smax57, 1
  %wide.trip.count58 = zext i32 %6 to i64
  br label %for.cond86

for.cond86:                                       ; preds = %for.end115, %for.end76
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.end115 ], [ 0, %for.end76 ]
  %exitcond59 = icmp eq i64 %indvars.iv53, %wide.trip.count58
  br i1 %exitcond59, label %for.end118, label %for.body88

for.body88:                                       ; preds = %for.cond86
  %arrayidx90 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv53
...
for.cond94:                                       ; preds = %if.end112, %for.body88
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %if.end112 ], [ 0, %for.body88 ]
  %exitcond.not = icmp eq i64 %indvars.iv50, %wide.trip.count
  br i1 %exitcond.not, label %for.end115, label %for.body96

for.body96:                                       ; preds = %for.cond94
  %cmp98 = icmp eq i64 %indvars.iv50, %7
  %8 = getelementptr inbounds nuw [1000 x [81 x i8]], ptr %newword, i64 0, i64 %indvars.iv53, i64 %indvars.iv50
  %9 = load i8, ptr %8, align 1, !tbaa !21, !invariant.load !9
  %call104 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %9)
  br i1 %cmp98, label %if.then99, label %if.end112
...
if.end112:                                        ; preds = %for.body96, %if.then99
