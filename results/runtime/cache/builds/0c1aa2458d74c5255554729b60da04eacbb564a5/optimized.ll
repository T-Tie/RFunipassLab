...
if.then:                                          ; preds = %entry
  %div6 = udiv i32 %0, 100
  %call1 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div6)
...
if.then4:                                         ; preds = %if.end
  %div57 = udiv i32 %2, 50
  %call6 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div57)
...
if.else8:                                         ; preds = %if.end
  %puts11 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #5
  %.pr2 = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end10

if.end10:                                         ; preds = %if.else8, %if.then4
  %4 = phi i32 [ %.pr2, %if.else8 ], [ %rem7, %if.then4 ]
  %cmp11 = icmp sgt i32 %4, 19
  br i1 %cmp11, label %if.then12, label %if.else16

if.then12:                                        ; preds = %if.end10
  %div138 = udiv i32 %4, 20
  %call14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div138)
...
if.else16:                                        ; preds = %if.end10
  %puts12 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #5
  %.pr3 = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end18

if.end18:                                         ; preds = %if.else16, %if.then12
  %6 = phi i32 [ %.pr3, %if.else16 ], [ %rem15, %if.then12 ]
  %cmp19 = icmp sgt i32 %6, 9
  br i1 %cmp19, label %if.then20, label %if.else24

if.then20:                                        ; preds = %if.end18
  %div219 = udiv i32 %6, 10
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div219)
...
if.else24:                                        ; preds = %if.end18
  %puts13 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.3) #5
  %.pr4 = load i32, ptr %n, align 4, !tbaa !5
  br label %if.end26

if.end26:                                         ; preds = %if.else24, %if.then20
  %8 = phi i32 [ %.pr4, %if.else24 ], [ %rem23, %if.then20 ]
  %cmp27 = icmp sgt i32 %8, 4
  br i1 %cmp27, label %if.then28, label %if.else32

if.then28:                                        ; preds = %if.end26
  %div2910 = udiv i32 %8, 5
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div2910)
...
if.else32:                                        ; preds = %if.end26
  %puts14 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.4) #5
