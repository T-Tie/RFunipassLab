...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1600, ptr nonnull %r) #4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i10 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSi10_M_extractIdEERSiRT_(ptr noundef nonnull align 8 dereferenceable(16) %call.i, ptr noundef nonnull align 8 dereferenceable(8) %arrayidx5)
...
for.cond.cleanup10:                               ; preds = %for.cond8
  call void @llvm.lifetime.end.p0(i64 1600, ptr nonnull %r) #4
...
for.body11:                                       ; preds = %for.cond8
  ...
  %5 = load double, ptr %arrayidx13, align 16, !tbaa !12
  %div = fdiv double %4, %5
...
if.then39:                                        ; preds = %if.else
  %call1.i12 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 5)
  br label %if.end43

if.else41:                                        ; preds = %if.else
  %call1.i14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 4)
  br label %if.end43
