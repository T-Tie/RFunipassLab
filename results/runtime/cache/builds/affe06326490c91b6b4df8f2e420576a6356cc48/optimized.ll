...
for.inc68:                                        ; preds = %for.cond47
  ...
  %mul54 = mul nsw i32 %14, %21
  %add55 = add nsw i32 %mul54, %18
  %idxprom56 = sext i32 %add55 to i64
  %arrayidx57 = getelementptr inbounds i32, ptr %call2, i64 %idxprom56
  %22 = load i32, ptr %arrayidx57, align 4, !tbaa !5, !invariant.load !15
  %mul58 = mul nsw i32 %18, %17
  ...
  %mul62 = mul nsw i32 %22, %23
  %add63 = add nsw i32 %20, %mul62
...
for.cond80:                                       ; preds = %for.inc95, %for.body79
  ...
  %cmp81 = icmp slt i32 %26, %27
  br i1 %cmp81, label %for.body82, label %for.inc98

for.body82:                                       ; preds = %for.cond80
  %mul83 = mul nsw i32 %24, %27
  %add84 = add nsw i32 %mul83, %26
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i32, ptr %call36, i64 %idxprom85
  %28 = load i32, ptr %arrayidx86, align 4, !tbaa !5
  %call87 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %28)
  %29 = load i32, ptr %y2, align 4, !tbaa !5
  %sub = sub nsw i32 %29, 1
  %cmp88 = icmp slt i32 %26, %sub
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %sub90 = sub nsw i32 %30, 1
  %cmp91 = icmp eq i32 %26, %sub90
