...
if.then:                                          ; preds = %entry
  ...
  call void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %call1)
  br label %return
...
define internal void @outlined_ir_func_0(ptr noundef nonnull align 8 dereferenceable(264) %0) #6 {
