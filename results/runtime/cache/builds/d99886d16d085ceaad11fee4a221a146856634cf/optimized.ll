...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80024, ptr noundef nonnull align 16 %a) #3
...
for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv25 = phi i64 [ %idxprom10, %for.cond13.preheader ], [ %indvars.iv.next26, %for.inc21 ]
...
for.end44:                                        ; preds = %for.cond32
  call void @llvm.lifetime.end.p0(i64 noundef 80024, ptr noundef nonnull %a) #5
