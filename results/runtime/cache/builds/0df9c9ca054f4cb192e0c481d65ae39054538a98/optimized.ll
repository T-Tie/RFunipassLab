...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.inc7 ], [ 1, %entry ]
  %1 = sext i32 %0 to i64
  %cmp.not = icmp sgt i64 %indvars.iv50, %1
...
for.cond10.preheader:                             ; preds = %for.cond
  ...
  %wide.trip.count61 = zext i32 %narrow to i64
  %wide.trip.count = zext i32 %2 to i64
  br label %for.cond10

for.cond1:                                        ; preds = %for.cond1.preheader, %for.inc
  %3 = phi i32 [ %.pre67, %for.inc ], [ %0, %for.cond1.preheader ]
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv50, i64 %indvars.iv
  %call6 = call i32 (ptr, ...) @__isoc23_scanf(ptr noundef nonnull @.str, ptr noundef nonnull %arrayidx5)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.pre67 = load i32, ptr %n, align 4, !tbaa !5
...
for.cond10:                                       ; preds = %for.cond10.preheader, %for.inc27
  %indvars.iv57 = phi i64 [ 1, %for.cond10.preheader ], [ %indvars.iv.next58, %for.inc27 ]
  %exitcond62 = icmp eq i64 %indvars.iv57, %wide.trip.count61
  br i1 %exitcond62, label %for.end29.loopexit77, label %for.cond13.preheader

for.cond13.preheader:                             ; preds = %for.cond10
  br label %for.cond13

for.cond13:                                       ; preds = %for.cond13.preheader, %for.inc21
  %indvars.iv53 = phi i64 [ %indvars.iv.next54, %for.inc21 ], [ 1, %for.cond13.preheader ]
  %exitcond = icmp eq i64 %indvars.iv53, %wide.trip.count
  br i1 %exitcond, label %for.inc27, label %for.body15

for.body15:                                       ; preds = %for.cond13
  %arrayidx19 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv57, i64 %indvars.iv53
...
for.end29.loopexit77:                             ; preds = %for.cond10
  br label %for.end29

for.end29:                                        ; preds = %for.end29.loopexit77, %for.end29.loopexit
  %i.148 = phi i32 [ %6, %for.end29.loopexit ], [ %narrow, %for.end29.loopexit77 ]
  %x1.1 = phi i32 [ %8, %for.end29.loopexit ], [ -1, %for.end29.loopexit77 ]
  %9 = zext i32 %0 to i64
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc48, %for.end29
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %for.inc48 ], [ %9, %for.end29 ]
  %10 = trunc nuw i64 %indvars.iv64 to i32
  %cmp31 = icmp sgt i32 %10, 0
  br i1 %cmp31, label %for.cond33.preheader, label %for.end50.loopexit76

for.cond33.preheader:                             ; preds = %for.cond30
  br label %for.cond33

for.cond33:                                       ; preds = %for.cond33.preheader, %for.inc43
  %j.2 = phi i32 [ %dec, %for.inc43 ], [ %0, %for.cond33.preheader ]
  %cmp34 = icmp sgt i32 %j.2, 0
  br i1 %cmp34, label %for.body35, label %for.inc48

for.body35:                                       ; preds = %for.cond33
  %idxprom38 = zext nneg i32 %j.2 to i64
  %arrayidx39 = getelementptr inbounds nuw [1000 x [1000 x i32]], ptr %a, i64 0, i64 %indvars.iv64, i64 %idxprom38
  %11 = load i32, ptr %arrayidx39, align 4, !tbaa !5
  %cmp40 = icmp eq i32 %11, 0
  br i1 %cmp40, label %for.end50.loopexit, label %for.inc43
...
for.end50.loopexit:                               ; preds = %for.body35
  br label %for.end50

for.end50.loopexit76:                             ; preds = %for.cond30
  br label %for.end50

for.end50:                                        ; preds = %for.end50.loopexit76, %for.end50.loopexit
  %x2.1 = phi i32 [ %j.2, %for.end50.loopexit ], [ 0, %for.end50.loopexit76 ]
