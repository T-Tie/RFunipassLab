...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  ...
  %phiofops = mul nuw nsw i64 %indvars.iv10, %1
...
for.body19:                                       ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv22, %1
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc47 ], [ %indvars.iv10, %for.cond39.preheader ]
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select1, %for.body62 ], [ %10, %for.body55 ]
...
for.body62:                                       ; preds = %for.cond60
  %11 = mul nuw nsw i64 %indvars.iv27, %1
  %gep = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %11
  %12 = load i32, ptr %gep, align 4, !tbaa !5
  %spec.select1 = call i32 @llvm.smin.i32(i32 %12, i32 %min.2)
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond60, !llvm.loop !17

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc85 ], [ %indvars.iv10, %for.cond77.preheader ]
  %exitcond36 = icmp eq i64 %indvars.iv32, %1
  br i1 %exitcond36, label %for.inc88, label %for.inc85

for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv32, %1
  %gep3 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep3, align 4, !tbaa !5
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next11, %1
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  ...
  %18 = trunc nuw i64 %indvars.iv44 to i32
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %20 = mul nuw nsw i64 %indvars.iv44, %1
