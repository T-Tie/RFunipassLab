...
for.body19:                                       ; preds = %for.cond17
  %6 = mul nuw nsw i64 %indvars.iv28, %1
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select7, %for.body62 ], [ %10, %for.body55 ]
...
for.inc85:                                        ; preds = %for.cond77
  %13 = mul nuw nsw i64 %indvars.iv38, %1
  %gep9 = getelementptr inbounds nuw i32, ptr %invariant.gep, i64 %13
  %14 = load i32, ptr %gep9, align 4, !tbaa !5, !invariant.load !14
...
for.end90:                                        ; preds = %for.cond53
  ...
  %15 = mul nuw nsw i64 %indvars.iv.next17, %1
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  ...
  %18 = trunc nuw i64 %indvars.iv50 to i32
...
for.inc130:                                       ; preds = %for.cond109
  ...
  %20 = mul nuw nsw i64 %indvars.iv50, %1
