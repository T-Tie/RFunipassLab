...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  %indvars.iv20 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next21, %if.end ]
  %n.0 = phi i32 [ 0, %for.cond2.preheader ], [ %n.1, %if.end ]
...
for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv20
...
for.cond14:                                       ; preds = %for.cond17, %for.cond14.preheader
  %indvars.iv44 = phi i64 [ %2, %for.cond14.preheader ], [ %5, %for.cond17 ]
  %5 = add nsw i64 %indvars.iv44, -1
  %6 = trunc nuw i64 %indvars.iv44 to i32
  %cmp15 = icmp sgt i32 %6, 0
  br i1 %cmp15, label %for.cond17, label %for.end41

for.cond17:                                       ; preds = %for.cond14, %if.end36
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %if.end36 ], [ 0, %for.cond14 ]
  %exitcond31.not = icmp eq i64 %indvars.iv24, %5
  br i1 %exitcond31.not, label %for.cond14, label %for.body19, !llvm.loop !14

for.body19:                                       ; preds = %for.cond17
  %arrayidx21 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv24
  %7 = load i32, ptr %arrayidx21, align 4, !tbaa !5, !invariant.load !12
  %indvars.iv.next25 = add nuw nsw i64 %indvars.iv24, 1
  %arrayidx23 = getelementptr inbounds nuw [10000 x i32], ptr %a, i64 0, i64 %indvars.iv.next25
...
for.end41:                                        ; preds = %for.cond14
  %sub42 = sub i32 %0, %n.0
  %9 = sext i32 %sub42 to i64
  br label %for.cond43

for.cond43:                                       ; preds = %for.body46, %for.end41
  %10 = phi i32 [ %.pre, %for.body46 ], [ %0, %for.end41 ]
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.body46 ], [ %9, %for.end41 ]
  %sub44 = add nsw i32 %10, -1
  %11 = sext i32 %sub44 to i64
  %cmp45 = icmp slt i64 %indvars.iv32, %11
  br i1 %cmp45, label %for.body46, label %for.end52

for.body46:                                       ; preds = %for.cond43
  %arrayidx48 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %indvars.iv32
  %12 = load i32, ptr %arrayidx48, align 4, !tbaa !5, !invariant.load !12
  %call49 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %12) #6
  %indvars.iv.next33 = add nsw i64 %indvars.iv32, 1
  %.pre = load i32, ptr %w, align 4, !tbaa !5
  br label %for.cond43, !llvm.loop !16

for.end52:                                        ; preds = %for.cond43
  %arrayidx55 = getelementptr inbounds [10000 x i32], ptr %a, i64 0, i64 %11
  %13 = load i32, ptr %arrayidx55, align 4, !tbaa !5
  %call56 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %13) #6
  call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull %w) #6
