...
if.then4:                                         ; preds = %if.end
  %div55 = udiv i32 %2, 50
  %call6 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div55)
...
if.else8:                                         ; preds = %if.end
  %puts9 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.1) #5
...
if.then12:                                        ; preds = %if.end10
  ...
  %call14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div136)
...
if.else16:                                        ; preds = %if.end10
  %puts10 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.2) #5
...
if.then20:                                        ; preds = %if.end18
  ...
  %call22 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div217)
...
if.else24:                                        ; preds = %if.end18
  %puts11 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.3) #5
...
if.then28:                                        ; preds = %if.end26
  %div298 = udiv i32 %8, 5
  %call30 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %div298)
...
if.else32:                                        ; preds = %if.end26
  %puts12 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @str.4) #5
