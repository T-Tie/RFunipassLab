...
for.end32:                                        ; preds = %for.cond16
  ...
  %smax22 = call i32 @llvm.smax.i32(i32 %7, i32 0)
  %13 = sext i32 %11 to i64
  %smax30 = call i32 @llvm.smax.i32(i32 %10, i32 0)
...
for.inc68:                                        ; preds = %for.cond47
  ...
  store i32 %add63, ptr %gep46, align 4, !tbaa !5
...
for.cond77:                                       ; preds = %for.cond37, %for.inc98
  ...
  %22 = phi i32 [ %.pre34, %for.inc98 ], [ %10, %for.cond37 ]
...
for.cond80:                                       ; preds = %for.cond77, %for.inc95
  %23 = phi i32 [ %.pre35, %for.inc95 ], [ %21, %for.cond77 ]
...
if.end:                                           ; preds = %if.then, %for.body82
  ...
  %26 = phi i32 [ %.pre36, %if.then ], [ %25, %for.body82 ]
...
for.inc95:                                        ; preds = %if.end, %if.then92
  %.pre35 = phi i32 [ %26, %if.end ], [ %.pre35.pre, %if.then92 ]
