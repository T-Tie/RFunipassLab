...
for.body:                                         ; preds = %for.cond
  ...
  %smax75 = call i32 @llvm.smax.i32(i32 %3, i32 1)
  br i1 %or.cond65, label %for.cond7, label %for.cond85
...
for.cond30.preheader:                             ; preds = %for.cond7
  ...
  %smax77 = call i32 @llvm.smax.i32(i32 %4, i32 1)
  br label %for.cond30
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts70 = call i32 @puts(ptr nonnull dereferenceable(1) %str.5.str.4)
  br label %if.end68
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax73 = call i32 @llvm.smax.i32(i32 %5, i32 1)
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts66 = call i32 @puts(ptr nonnull dereferenceable(1) %str.1.str)
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts72 = call i32 @puts(ptr nonnull dereferenceable(1) %str.7.sink)
  br label %for.inc164
