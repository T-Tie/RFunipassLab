...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 60000, ptr noundef align 16 %c) #6
...
for.cond21:                                       ; preds = %for.inc26, %for.end20
  ...
  %cmp22 = icmp slt i32 %i.1, %n.0.lcssa
...
for.cond29:                                       ; preds = %for.inc54, %for.end28
  ...
  %cmp30 = icmp slt i32 %i.2, %n.0.lcssa
...
for.cond32:                                       ; preds = %for.inc51, %for.body31
  ...
  %cmp33 = icmp slt i32 %j.1, %n.0.lcssa
...
for.cond57:                                       ; preds = %for.inc67, %for.end56
  ...
  %cmp58 = icmp slt i32 %i.3, %n.0.lcssa
...
for.end69:                                        ; preds = %for.cond57
  %max.0.lcssa = phi i32 [ %max.0, %for.cond57 ]
  %cmp70 = icmp eq i32 %max.0.lcssa, 1
...
if.else:                                          ; preds = %for.end69
  %call74 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %max.0.lcssa)
...
for.cond76:                                       ; preds = %for.inc89, %if.else
  ...
  %cmp77 = icmp slt i32 %i.4, %n.0.lcssa
  br i1 %cmp77, label %for.body78, label %if.end92.loopexit
...
for.body78:                                       ; preds = %for.cond76
  ...
  %cmp81 = icmp eq i32 %5, %max.0.lcssa
