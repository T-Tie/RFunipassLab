...
for.cond10:                                       ; preds = %if.end56, %for.end9
  %l2.0 = phi i32 [ undef, %for.end9 ], [ %l2.1, %if.end56 ]
  %min.0 = phi i32 [ undef, %for.end9 ], [ %min.1, %if.end56 ]
  %l1.0 = phi i32 [ undef, %for.end9 ], [ %l1.1, %if.end56 ]
  %i.1 = phi i32 [ 0, %for.end9 ], [ %inc58, %if.end56 ]
...
for.cond13:                                       ; preds = %if.end, %for.body12
  %l1.1 = phi i32 [ %l1.0, %for.body12 ], [ %l1.2, %if.end ]
  %max.0 = phi i32 [ 0, %for.body12 ], [ %max.1, %if.end ]
  %j.1 = phi i32 [ 0, %for.body12 ], [ %inc26, %if.end ]
...
for.cond28:                                       ; preds = %if.end49, %for.end27
  %l2.1 = phi i32 [ %l2.0, %for.end27 ], [ %l2.3, %if.end49 ]
  %min.1 = phi i32 [ %min.0, %for.end27 ], [ %min.3, %if.end49 ]
  %k.0 = phi i32 [ 0, %for.end27 ], [ %inc51, %if.end49 ]
...
for.body30:                                       ; preds = %for.cond28
  ...
  %4 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom38
  %5 = getelementptr inbounds [10 x i32], ptr %4, i64 0, i64 %idxprom40
...
if.end37.thread:                                  ; preds = %for.body30
  ...
  %arrayidx3910 = getelementptr inbounds [10 x [10 x i32]], ptr %a, i64 0, i64 %idxprom38
  %idxprom4011 = sext i32 %l1.1 to i64
  %arrayidx4112 = getelementptr inbounds [10 x i32], ptr %arrayidx3910, i64 0, i64 %idxprom4011
  %cmp4213 = icmp slt i32 %6, %7
  br i1 %cmp4213, label %if.end49, label %if.end49

land.lhs.true:                                    ; preds = %if.end37
  %8 = phi i32 [ %6, %if.end37 ]
  %min.215 = phi i32 [ %min.1, %if.end37 ]
  %l2.214 = phi i32 [ %l2.1, %if.end37 ]
  br label %if.then44

if.then44:                                        ; preds = %land.lhs.true
  br label %if.end49

if.end49:                                         ; preds = %if.end37.thread, %if.end37.thread, %if.then44, %if.end37
  %l2.3 = phi i32 [ %k.0, %if.then44 ], [ %l2.1, %if.end37 ], [ 0, %if.end37.thread ], [ 0, %if.end37.thread ]
  %min.3 = phi i32 [ %8, %if.then44 ], [ %min.1, %if.end37 ], [ %7, %if.end37.thread ], [ %7, %if.end37.thread ]
  %inc51 = add nsw i32 %k.0, 1
  br label %for.cond28, !llvm.loop !14

for.end52:                                        ; preds = %for.cond28
  %cmp53 = icmp eq i32 %max.0, %min.1
  br i1 %cmp53, label %for.end59, label %if.end56
...
for.end59:                                        ; preds = %for.end52
  %call55 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %l2.1, i32 noundef %l1.1)
  br label %if.end63
