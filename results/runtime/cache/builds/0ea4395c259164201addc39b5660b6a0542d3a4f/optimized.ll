...
define dso_local void @_Z5rightPcii(ptr noundef captures(none) %a, i32 noundef %l, i32 noundef %t) local_unnamed_addr #0 {
entry:
  %0 = sext i32 %l to i64
  %1 = sext i32 %t to i64
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %2 = getelementptr i8, ptr %a, i64 %indvars.iv
...
for.end:                                          ; preds = %for.cond
  %4 = getelementptr i8, ptr %a, i64 %0
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @_Z4leftPcii(ptr noundef captures(none) %a, i32 noundef %l, i32 noundef %t) local_unnamed_addr #0 {
entry:
  %0 = sext i32 %t to i64
  %1 = sext i32 %l to i64
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr i8, ptr %2, i64 -1
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %arrayidx3 = getelementptr i8, ptr %2, i64 -2
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx6 = getelementptr i8, ptr %4, i64 -1
...
entry:
  ...
  %smax51 = call i32 @llvm.smax.i32(i32 %conv, i32 0)
...
for.cond:                                         ; preds = %for.inc73, %entry
  %indvars.iv46 = phi i64 [ %indvars.iv.next47, %for.inc73 ], [ 1, %entry ]
  %exitcond53 = icmp eq i64 %indvars.iv46, %wide.trip.count52
  br i1 %exitcond53, label %for.end75, label %for.body

for.body:                                         ; preds = %for.cond
  %2 = add nsw i64 %indvars.iv46, -1
...
for.cond26:                                       ; preds = %for.body, %for.body29
  ...
  %d.0 = phi i32 [ %spec.select, %for.body29 ], [ 0, %for.body ]
...
for.body29:                                       ; preds = %for.cond26
  ...
  %sext66 = shl i64 %4, 32
  %idxprom31 = ashr exact i64 %sext66, 32
  ...
  %spec.select = select i1 %cmp38.not, i32 %d.0, i32 1
...
for.cond43.preheader:                             ; preds = %for.end
  ...
  %invariant.gep40 = getelementptr inbounds nuw i8, ptr %a, i64 1
  %add49 = add i64 %indvars.iv46, %call8
  %sext64 = shl i64 %add49, 32
  %7 = ashr exact i64 %sext64, 32
  %sext = shl i64 %call6, 32
  %8 = ashr exact i64 %sext, 32
  %gep = getelementptr i8, ptr %invariant.gep, i64 %8
  %9 = and i64 %indvars.iv46, 4294967295
  %gep41 = getelementptr i8, ptr %invariant.gep40, i64 %8
  %10 = sub i32 %conv12, %conv9
  %smax54 = call i32 @llvm.abs.i32(i32 %10, i1 false)
  %11 = add nuw i32 %smax54, 1
  br label %for.cond43

for.cond43:                                       ; preds = %for.cond43.preheader, %for.inc55
  %j.1 = phi i32 [ %inc56, %for.inc55 ], [ 1, %for.cond43.preheader ]
  %exitcond55 = icmp eq i32 %j.1, %11
  br i1 %exitcond55, label %for.cond58.preheader, label %for.body45

for.cond58.preheader:                             ; preds = %for.cond43
  %add64 = add nuw i64 %indvars.iv46, 4294967294
  %smax61 = call i32 @llvm.smax.i32(i32 %conv12, i32 0)
  %12 = add nuw i32 %smax61, 1
...
for.cond.i:                                       ; preds = %for.body45, %for.body.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body.i ], [ %7, %for.body45 ]
  %cmp.not.i = icmp sgt i64 %indvars.iv.i, %8
  br i1 %cmp.not.i, label %_Z4leftPcii.exit, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i
  %13 = getelementptr i8, ptr %a, i64 %indvars.iv.i
  %arrayidx.i = getelementptr i8, ptr %13, i64 -1
  %14 = load i8, ptr %arrayidx.i, align 1, !tbaa !5
  %arrayidx3.i = getelementptr i8, ptr %13, i64 -2
  store i8 %14, ptr %arrayidx3.i, align 1, !tbaa !5
...
if.end50:                                         ; preds = %_Z4leftPcii.exit, %for.body45
  br i1 %cmp51, label %for.cond.i31, label %for.inc55

for.cond.i31:                                     ; preds = %if.end50, %for.body.i34
  %indvars.iv.i32 = phi i64 [ %indvars.iv.next.i36, %for.body.i34 ], [ %8, %if.end50 ]
  %cmp.not.i33 = icmp slt i64 %indvars.iv.i32, %9
  br i1 %cmp.not.i33, label %_Z5rightPcii.exit, label %for.body.i34

for.body.i34:                                     ; preds = %for.cond.i31
  %15 = getelementptr i8, ptr %a, i64 %indvars.iv.i32
  %arrayidx.i35 = getelementptr i8, ptr %15, i64 -1
  %16 = load i8, ptr %arrayidx.i35, align 1, !tbaa !5
  store i8 %16, ptr %15, align 1, !tbaa !5
  %indvars.iv.next.i36 = add nsw i64 %indvars.iv.i32, -1
  br label %for.cond.i31, !llvm.loop !8

_Z5rightPcii.exit:                                ; preds = %for.cond.i31
  store i8 0, ptr %gep41, align 1, !tbaa !5
  br label %for.inc55
...
for.cond58:                                       ; preds = %for.cond58.preheader, %for.body60
  %indvars.iv56 = phi i64 [ 1, %for.cond58.preheader ], [ %indvars.iv.next57, %for.body60 ]
  %exitcond63 = icmp eq i64 %indvars.iv56, %wide.trip.count62
  br i1 %exitcond63, label %for.end75, label %for.body60

for.body60:                                       ; preds = %for.cond58
  %17 = add nsw i64 %indvars.iv56, -1
  %arrayidx63 = getelementptr inbounds [256 x i8], ptr %c, i64 0, i64 %17
  %18 = load i8, ptr %arrayidx63, align 1, !tbaa !5
  %19 = add i64 %add64, %indvars.iv56
  %sext65 = shl i64 %19, 32
  %idxprom66 = ashr exact i64 %sext65, 32
  %arrayidx67 = getelementptr inbounds [256 x i8], ptr %a, i64 0, i64 %idxprom66
  store i8 %18, ptr %arrayidx67, align 1, !tbaa !5
