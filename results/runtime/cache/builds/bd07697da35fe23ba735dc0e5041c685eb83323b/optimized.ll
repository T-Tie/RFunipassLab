...
for.cond15:                                       ; preds = %for.cond15.preheader, %for.inc131
  %indvars.iv75 = phi i64 [ 0, %for.cond15.preheader ], [ %indvars.iv.next76, %for.inc131 ]
  %indvars.iv52 = phi i64 [ 1, %for.cond15.preheader ], [ %indvars.iv.next53, %for.inc131 ]
  %total.0 = phi i32 [ 0, %for.cond15.preheader ], [ %add130, %for.inc131 ]
  %exitcond80.not = icmp eq i64 %indvars.iv75, %wide.trip.count79
  br i1 %exitcond80.not, label %for.inc136, label %for.cond20
...
for.cond54:                                       ; preds = %for.inc63, %for.end47
  %indvars.iv57 = phi i64 [ %indvars.iv.next58, %for.inc63 ], [ %indvars.iv52, %for.end47 ]
...
for.cond70:                                       ; preds = %for.cond20, %for.inc121
  ...
  br i1 %exitcond74.not, label %for.inc131, label %for.body73

for.body73:                                       ; preds = %for.cond70
  %13 = add nuw nsw i64 %indvars.iv70, 4294967295
  %14 = and i64 %13, 4294967295
  %or.cond46 = icmp samesign ult i64 %14, %indvars.iv75
...
for.cond85:                                       ; preds = %for.body88, %if.end78
  ...
  %minValue79.0 = phi i32 [ %spec.select47, %for.body88 ], [ %15, %if.end78 ]
  %16 = icmp slt i64 %indvars.iv64, %2
...
for.body88:                                       ; preds = %for.cond85
  ...
  %spec.select47 = call i32 @llvm.smin.i32(i32 %17, i32 %minValue79.0)
...
for.cond109:                                      ; preds = %for.inc118, %for.end102
  %indvars.iv67 = phi i64 [ %indvars.iv.next68, %for.inc118 ], [ %indvars.iv52, %for.end102 ]
  %18 = icmp slt i64 %indvars.iv67, %2
