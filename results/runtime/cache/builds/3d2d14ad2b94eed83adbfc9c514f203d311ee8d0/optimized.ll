; ModuleID = '<stdin>'
source_filename = "/tmp/tmpj55ma901.cpp"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %a) #10
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %b) #10
...
while.cond:                                       ; preds = %if.end25, %entry
  %2 = phi i32 [ %dec, %if.end25 ], [ %.pr, %entry ]
  %cmp = icmp sgt i32 %2, 1
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(280) @_ZSt3cin, ptr noundef nonnull align 8 dereferenceable(8) %a)
  %call4 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERd(ptr noundef nonnull align 8 dereferenceable(16) %call3, ptr noundef nonnull align 8 dereferenceable(8) %b)
  %3 = load double, ptr %b, align 8, !tbaa !5
  %4 = load double, ptr %a, align 8, !tbaa !5
  %div5 = fdiv double %3, %4
  %sub = fsub double %div5, %div
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %sub10 = fsub double %div9, %div
  %cmp11 = fcmp olt double %sub10, -5.000000e-02
  br i1 %cmp11, label %if.then12, label %if.end15

if.then12:                                        ; preds = %if.end
  %call13 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(6) @.str.1)
...
if.end15:                                         ; preds = %if.then12, %if.end
  %7 = load double, ptr %b, align 8, !tbaa !5
  %8 = load double, ptr %a, align 8, !tbaa !5
  %div16 = fdiv double %7, %8
  %sub17 = fsub double %div16, %div
  %cmp18 = fcmp oge double %sub17, -5.000000e-02
  br i1 %cmp18, label %land.lhs.true, label %if.end25

land.lhs.true:                                    ; preds = %if.end15
  %cmp21 = fcmp ole double %sub17, 5.000000e-02
  br i1 %cmp21, label %if.then22, label %if.end25

if.then22:                                        ; preds = %land.lhs.true
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(272) @_ZSt4cout, ptr noundef nonnull dereferenceable(5) @.str.2)
...
while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %b) #10
  call void @llvm.lifetime.end.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %a) #10
