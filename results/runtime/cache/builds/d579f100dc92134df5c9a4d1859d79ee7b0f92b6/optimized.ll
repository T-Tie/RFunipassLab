...
for.cond137:                                      ; preds = %for.inc148, %if.end136
  ...
  br i1 %exitcond144.not, label %if.end178.loopexit163, label %for.inc148
...
if.end178.loopexit163:                            ; preds = %for.cond137
  %.pre164 = add nuw nsw i64 %indvars.iv151, 1
  br label %if.end178

if.end178:                                        ; preds = %for.cond158, %if.end178.loopexit163
  %.pre.pre-phi = phi i64 [ %.pre164, %if.end178.loopexit163 ], [ %20, %for.cond158 ]
