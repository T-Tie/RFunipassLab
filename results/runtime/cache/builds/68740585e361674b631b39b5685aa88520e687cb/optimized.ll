...
while.cond.preheader:                             ; preds = %for.cond1
  %smax146 = call i32 @llvm.smax.i32(i32 %1, i32 noundef 0)
  br label %while.cond
...
for.cond14.preheader:                             ; preds = %while.cond
  %smax142 = call i32 @llvm.smax.i32(i32 %indvars.iv83, i32 noundef 0)
...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.inc42
  ...
  br i1 %exitcond89.not, label %for.cond45, label %for.body16
...
for.cond45:                                       ; preds = %for.cond14, %for.inc67
  %indvars.iv95 = phi i64 [ %indvars.iv.next96, %for.inc67 ], [ 0, %for.cond14 ]
  %exitcond100.not = icmp eq i64 %indvars.iv95, %wide.trip.count88
  br i1 %exitcond100.not, label %for.cond70, label %for.cond49.preheader
...
for.cond70:                                       ; preds = %for.cond45, %for.inc101
  %indvars.iv106 = phi i64 [ %indvars.iv.next107, %for.inc101 ], [ 0, %for.cond45 ]
  %exitcond111.not = icmp eq i64 %indvars.iv106, %wide.trip.count88
  br i1 %exitcond111.not, label %for.cond104, label %for.body73
...
for.cond79:                                       ; preds = %for.inc98, %for.body73
  ...
  %exitcond105.not = icmp eq i64 %indvars.iv101, %wide.trip.count
...
for.cond104:                                      ; preds = %for.cond70, %for.inc126
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %for.inc126 ], [ 0, %for.cond70 ]
...
for.cond108:                                      ; preds = %for.cond104, %for.inc123
  ...
  %exitcond116.not = icmp eq i64 %indvars.iv112, %wide.trip.count
...
for.cond131:                                      ; preds = %for.inc151, %for.end128
  ...
  br i1 %exitcond133.not, label %for.cond154, label %for.cond135

for.cond135:                                      ; preds = %for.cond131, %for.inc148
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %for.inc148 ], [ 1, %for.cond131 ]
  %exitcond127.not = icmp eq i64 %indvars.iv123, %wide.trip.count
...
for.cond154:                                      ; preds = %for.cond131, %for.inc174
  %indvars.iv139 = phi i64 [ %indvars.iv.next140, %for.inc174 ], [ 0, %for.cond131 ]
...
for.cond158:                                      ; preds = %for.cond154, %for.inc171
  ...
  %exitcond138.not = icmp eq i64 %indvars.iv134, %wide.trip.count
