...
for.cond:                                         ; preds = %for.inc30, %entry
  %m.0 = phi i32 [ undef, %entry ], [ %m.2, %for.inc30 ]
...
if.end57:                                         ; preds = %for.cond48, %if.then34
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %c) #14
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %b) #14
  call void @llvm.lifetime.end.p0(i64 noundef 256, ptr noundef %a) #14
  ret i32 0
}
...
if.then:                                          ; preds = %entry
  %vtable = load ptr, ptr %__out, align 8, !tbaa !15, !invariant.load !8
  %vbase.offset.ptr = getelementptr i8, ptr %vtable, i64 -24
  %vbase.offset = load i64, ptr %vbase.offset.ptr, align 8, !invariant.load !8
...
entry:
  ...
  %0 = load ptr, ptr %_M_streambuf, align 8, !tbaa !30, !invariant.load !8
  ret ptr %0
}
...
if.else:                                          ; preds = %entry
  %vtable = load ptr, ptr %this, align 8, !tbaa !15, !invariant.load !8
...
entry:
  ...
  %0 = load i32, ptr %_M_streambuf_state, align 8, !tbaa !38, !invariant.load !8
  ret i32 %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_cur, align 8, !tbaa !39, !invariant.load !8
  ret ptr %0
}
...
entry:
  ...
  %0 = load ptr, ptr %_M_in_end, align 8, !tbaa !42, !invariant.load !8
  ret ptr %0
}
...
entry:
  %0 = load i8, ptr %__c, align 1, !tbaa !5, !invariant.load !8
...
!30 = !{!31, !34, i64 232}
!31 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !20, i64 0, !32, i64 216, !6, i64 224, !33, i64 225, !34, i64 232, !35, i64 240, !36, i64 248, !37, i64 256}
