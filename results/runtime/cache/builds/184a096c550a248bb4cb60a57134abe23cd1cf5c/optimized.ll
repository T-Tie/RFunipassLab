...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc13
  %indvars.iv11 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next12, %for.inc13 ]
...
for.cond16.preheader:                             ; preds = %for.cond2
  ...
  %smax23 = call i32 @llvm.smax.i32(i32 %sub, i32 noundef 0)
  br label %for.cond16

for.body4:                                        ; preds = %for.cond2
  %arrayidx6 = getelementptr inbounds nuw [500 x i32], ptr %a, i64 0, i64 %indvars.iv11
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc44
  %indvars.iv18 = phi i32 [ %sub, %for.cond16.preheader ], [ %indvars.iv.next19, %for.inc44 ]
  %m.0 = phi i32 [ 0, %for.cond16.preheader ], [ %inc45, %for.inc44 ]
  %exitcond24.not = icmp eq i32 %m.0, %smax23
  br i1 %exitcond24.not, label %for.cond47.preheader, label %for.cond19.preheader

for.cond19.preheader:                             ; preds = %for.cond16
  %smax20 = call i32 @llvm.smax.i32(i32 %indvars.iv18, i32 noundef 0)
  %wide.trip.count21 = zext nneg i32 %smax20 to i64
  br label %for.cond19

for.cond47.preheader:                             ; preds = %for.cond16
  %wide.trip.count28 = zext nneg i32 %smax23 to i64
  br label %for.cond47

for.cond19:                                       ; preds = %for.cond19.preheader, %for.inc41
  %indvars.iv15 = phi i64 [ 0, %for.cond19.preheader ], [ %indvars.iv.next16, %for.inc41 ]
  %exitcond22.not = icmp eq i64 %indvars.iv15, %wide.trip.count21
  br i1 %exitcond22.not, label %for.inc44, label %for.body23

for.body23:                                       ; preds = %for.cond19
  %arrayidx25 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv15
  %4 = load i32, ptr %arrayidx25, align 4, !tbaa !5
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %arrayidx27 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv.next16
...
for.cond47:                                       ; preds = %for.cond47.preheader, %for.inc55
  %indvars.iv25 = phi i64 [ 0, %for.cond47.preheader ], [ %indvars.iv.next26, %for.inc55 ]
  %exitcond29.not = icmp eq i64 %indvars.iv25, %wide.trip.count28
  br i1 %exitcond29.not, label %for.end57, label %for.inc55

for.inc55:                                        ; preds = %for.cond47
  %arrayidx52 = getelementptr inbounds nuw [500 x i32], ptr %b, i64 0, i64 %indvars.iv25
