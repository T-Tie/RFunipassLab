; ModuleID = '<stdin>'
source_filename = "/tmp/tmpg8v5jrbe.cpp"
...
for.cond:                                         ; preds = %for.inc21, %entry
  %n.0 = phi i32 [ 1, %entry ], [ %inc22, %for.inc21 ]
  %exitcond23 = icmp eq i32 %n.0, %1
  br i1 %exitcond23, label %for.cond24, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx4 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %indvars.iv
...
for.cond5:                                        ; preds = %for.cond1, %for.cond5.backedge
  %indvars.iv18 = phi i64 [ %indvars.iv18.be, %for.cond5.backedge ], [ 0, %for.cond1 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, 1000
  br i1 %exitcond22.not, label %for.inc21, label %for.body7
...
for.cond5.backedge:                               ; preds = %for.body7.for.inc18_crit_edge, %if.then
  %indvars.iv18.be = phi i64 [ %.pre, %for.body7.for.inc18_crit_edge ], [ %4, %if.then ]
  br label %for.cond5, !llvm.loop !12

if.then:                                          ; preds = %for.body7
  %rem = urem i32 %3, 10
  store i32 %rem, ptr %arrayidx9, align 4, !tbaa !5
  %4 = add nuw nsw i64 %indvars.iv18, 1
  %arrayidx16 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %4
...
for.inc21:                                        ; preds = %for.cond5
  %inc22 = add nuw i32 %n.0, 1
  br label %for.cond, !llvm.loop !13

for.cond24:                                       ; preds = %for.cond, %for.inc32
  %i.2 = phi i32 [ %dec, %for.inc32 ], [ 999, %for.cond ]
  %cmp25 = icmp sgt i32 %i.2, -1
  br i1 %cmp25, label %for.body26, label %for.cond34.preheader

for.cond34.preheader:                             ; preds = %for.body26, %for.cond24
  %i.3.ph = phi i32 [ %i.2, %for.body26 ], [ 0, %for.cond24 ]
  br label %for.cond34

for.body26:                                       ; preds = %for.cond24
  %idxprom27 = zext nneg i32 %i.2 to i64
  %arrayidx28 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %idxprom27
  %6 = load i32, ptr %arrayidx28, align 4, !tbaa !5
  %cmp29.not = icmp eq i32 %6, 0
  br i1 %cmp29.not, label %for.inc32, label %for.cond34.preheader
...
for.cond34:                                       ; preds = %for.cond34.preheader, %for.body36
  %i.3 = phi i32 [ %dec41, %for.body36 ], [ %i.3.ph, %for.cond34.preheader ]
  %cmp35 = icmp sgt i32 %i.3, -1
  br i1 %cmp35, label %for.body36, label %for.end42

for.body36:                                       ; preds = %for.cond34
  %idxprom37 = zext nneg i32 %i.3 to i64
  %arrayidx38 = getelementptr inbounds nuw [1000 x i32], ptr %a, i64 0, i64 %idxprom37
  %7 = load i32, ptr %arrayidx38, align 4, !tbaa !5
  %call39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %7)
  %dec41 = add nsw i32 %i.3, -1
