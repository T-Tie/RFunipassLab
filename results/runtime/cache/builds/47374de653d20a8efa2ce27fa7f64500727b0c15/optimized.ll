...
tailrecurse:                                      ; preds = %for.end100, %entry
  ...
  %smax46 = call i32 @llvm.smax.i32(i32 %indvars.iv9, i32 noundef 1)
  %smax35 = call i32 @llvm.smax.i32(i32 %indvars.iv9.in, i32 noundef 0)
  %0 = zext i32 %indvars.iv9 to i64
  %wide.trip.count20 = zext nneg i32 %smax35 to i64
  %wide.trip.count = zext i32 %indvars.iv9.in to i64
  br label %for.cond
...
for.inc24:                                        ; preds = %for.cond14
  store i32 %indvars.iv9.in, ptr @k, align 4, !tbaa !5
...
for.end64:                                        ; preds = %for.cond27
  %cmp65 = icmp eq i32 %indvars.iv9.in, 2
