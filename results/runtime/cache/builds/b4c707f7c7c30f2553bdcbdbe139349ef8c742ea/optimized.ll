...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load double, ptr %arrayidx, align 8, !tbaa !9, !invariant.load !11
...
if.else:                                          ; preds = %for.body
  ...
  %7 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom
...
for.body51:                                       ; preds = %for.cond49
  ...
  %10 = load double, ptr %arrayidx53, align 8, !tbaa !9, !invariant.load !11
  %cmp54 = fcmp ogt double %10, 0.000000e+00
  %11 = getelementptr inbounds [99 x double], ptr %m, i64 0, i64 %idxprom52
...
if.then55:                                        ; preds = %for.body51
  ...
  %call62 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %12, double noundef %13) #8
  br label %for.inc110

if.else63:                                        ; preds = %for.body51
  %14 = load double, ptr %arrayidx53, align 8, !tbaa !9
  %cmp66 = fcmp oeq double %14, 0.000000e+00
  br i1 %cmp66, label %if.then67, label %if.else72

if.then67:                                        ; preds = %if.else63
  %call71 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, double noundef %12) #8
  br label %for.inc110

if.else72:                                        ; preds = %if.else63
  %cmp76 = fcmp oeq double %12, 0.000000e+00
  %15 = load double, ptr %11, align 8, !tbaa !9, !invariant.load !11
  %16 = getelementptr inbounds [2 x [99 x double]], ptr %m, i64 0, i64 1
  %17 = getelementptr inbounds [99 x double], ptr %16, i64 0, i64 %idxprom52
...
if.then77:                                        ; preds = %if.else72
  %fneg81 = fneg double %15
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg81, double noundef %18, double noundef %fneg81, double noundef %18) #8
  br label %for.inc110

if.else93:                                        ; preds = %if.else72
  %call106 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %15, double noundef %18, double noundef %15, double noundef %18) #8
  br label %for.inc110

for.inc110:                                       ; preds = %if.then55, %if.then77, %if.else93, %if.then67
  %inc111 = add nsw i32 %8, 1
