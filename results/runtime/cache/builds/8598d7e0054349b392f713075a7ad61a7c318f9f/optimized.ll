...
for.cond38:                                       ; preds = %for.inc49, %for.body36
  %sub.sink7 = phi i32 [ %sub, %for.body36 ], [ %dec, %for.inc49 ]
  %cmp39 = icmp sge i32 %sub.sink7, 0
  %idxprom51 = sext i32 %sub.sink to i64
  %idxprom53 = sext i32 %sub.sink7 to i64
  %10 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom51
  %11 = getelementptr inbounds [100 x i32], ptr %10, i64 0, i64 %idxprom53
...
for.body40:                                       ; preds = %for.cond38
  br i1 %cmp55, label %for.end50.thread, label %for.inc49

for.end50.thread:                                 ; preds = %for.body40
  store i32 %sub.sink, ptr %x2, align 4, !tbaa !5
  store i32 %sub.sink7, ptr %y2, align 4, !tbaa !5
  br label %for.end61
