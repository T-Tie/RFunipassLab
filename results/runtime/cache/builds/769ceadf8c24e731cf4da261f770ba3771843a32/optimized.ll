...
tailrecurse:                                      ; preds = %for.end119, %entry
  ...
  %smax87 = call i32 @llvm.smax.i32(i32 %n.tr, i32 2)
  %cmp = icmp eq i32 %n.tr, 1
  br i1 %cmp, label %return, label %for.cond.preheader

for.cond.preheader:                               ; preds = %tailrecurse
  %smax63 = call i32 @llvm.smax.i32(i32 %n.tr, i32 0)
...
for.cond:                                         ; preds = %for.cond.preheader, %for.end26
  %indvars.iv45 = phi i64 [ 0, %for.cond.preheader ], [ %indvars.iv.next46, %for.end26 ]
  %exitcond49.not = icmp eq i64 %indvars.iv45, %wide.trip.count48
  br i1 %exitcond49.not, label %for.cond31.preheader, label %for.cond2
...
for.body5:                                        ; preds = %for.cond2
  %arrayidx7 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv45, i64 %indvars.iv
...
for.cond16:                                       ; preds = %for.cond16.preheader, %for.inc24
  %indvars.iv40 = phi i64 [ 0, %for.cond16.preheader ], [ %indvars.iv.next41, %for.inc24 ]
  %exitcond44.not = icmp eq i64 %indvars.iv40, %wide.trip.count
  br i1 %exitcond44.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond16
  %arrayidx23 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv45, i64 %indvars.iv40
...
for.cond31:                                       ; preds = %for.cond31.preheader, %for.inc67
  %indvars.iv60 = phi i64 [ 0, %for.cond31.preheader ], [ %indvars.iv.next61, %for.inc67 ]
  %exitcond65.not = icmp eq i64 %indvars.iv60, %wide.trip.count48
  br i1 %exitcond65.not, label %for.end69, label %for.cond36

for.cond36:                                       ; preds = %for.cond31, %for.body39
  %indvars.iv50 = phi i64 [ %indvars.iv.next51, %for.body39 ], [ 0, %for.cond31 ]
  %min.2 = phi i32 [ %spec.select38, %for.body39 ], [ 65535, %for.cond31 ]
  %exitcond54.not = icmp eq i64 %indvars.iv50, %wide.trip.count53
  br i1 %exitcond54.not, label %for.cond55.preheader, label %for.body39

for.cond55.preheader:                             ; preds = %for.cond36
  br label %for.cond55

for.body39:                                       ; preds = %for.cond36
  %arrayidx43 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv50, i64 %indvars.iv60
  %2 = load i32, ptr %arrayidx43, align 4, !tbaa !5, !invariant.load !12
  %spec.select38 = tail call i32 @llvm.smin.i32(i32 %2, i32 %min.2)
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  br label %for.cond36

for.cond55:                                       ; preds = %for.cond55.preheader, %for.inc64
  %indvars.iv55 = phi i64 [ 0, %for.cond55.preheader ], [ %indvars.iv.next56, %for.inc64 ]
  %exitcond59.not = icmp eq i64 %indvars.iv55, %wide.trip.count53
  br i1 %exitcond59.not, label %for.inc67, label %for.inc64

for.inc64:                                        ; preds = %for.cond55
  %arrayidx62 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv55, i64 %indvars.iv60
...
for.end69:                                        ; preds = %for.cond31
  ...
  %wide.trip.count76 = zext nneg i32 %smax87 to i64
  %wide.trip.count69 = zext i32 %n.tr to i64
  br label %for.cond71

for.cond71:                                       ; preds = %for.end91, %for.end69
  %indvars.iv71 = phi i64 [ %indvars.iv.next72, %for.end91 ], [ 2, %for.end69 ]
  %exitcond77.not = icmp eq i64 %indvars.iv71, %wide.trip.count76
  br i1 %exitcond77.not, label %for.cond96.preheader, label %for.cond76.preheader

for.cond96.preheader:                             ; preds = %for.cond71
  %wide.trip.count81 = zext i32 %n.tr to i64
  br label %for.cond96

for.cond76.preheader:                             ; preds = %for.cond71
  %5 = add nsw i64 %indvars.iv71, -1
  br label %for.cond76

for.cond76:                                       ; preds = %for.cond76.preheader, %for.inc89
  %indvars.iv66 = phi i64 [ 0, %for.cond76.preheader ], [ %indvars.iv.next67, %for.inc89 ]
  %exitcond70.not = icmp eq i64 %indvars.iv66, %wide.trip.count69
  br i1 %exitcond70.not, label %for.end91, label %for.inc89

for.inc89:                                        ; preds = %for.cond76
  %arrayidx83 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv71, i64 %indvars.iv66
  %6 = load i32, ptr %arrayidx83, align 4, !tbaa !5, !invariant.load !12
  %arrayidx88 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %5, i64 %indvars.iv66
...
for.cond96:                                       ; preds = %for.cond96.preheader, %for.inc117
  %indvars.iv83 = phi i64 [ 2, %for.cond96.preheader ], [ %indvars.iv.next84, %for.inc117 ]
  %exitcond89.not = icmp eq i64 %indvars.iv83, %wide.trip.count76
  br i1 %exitcond89.not, label %for.end119, label %for.cond101.preheader
...
for.cond101:                                      ; preds = %for.cond101.preheader, %for.inc114
  %indvars.iv78 = phi i64 [ 0, %for.cond101.preheader ], [ %indvars.iv.next79, %for.inc114 ]
  %exitcond82.not = icmp eq i64 %indvars.iv78, %wide.trip.count81
  br i1 %exitcond82.not, label %for.inc117, label %for.inc114

for.inc114:                                       ; preds = %for.cond101
  %arrayidx108 = getelementptr inbounds nuw [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv78, i64 %indvars.iv83
  %8 = load i32, ptr %arrayidx108, align 4, !tbaa !5, !invariant.load !12
  %arrayidx113 = getelementptr inbounds [100 x [100 x i32]], ptr @arr, i64 0, i64 %indvars.iv78, i64 %7
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end ], [ 0, %entry ]
