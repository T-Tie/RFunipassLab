...
for.cond:                                         ; preds = %if.then47, %if.end
  %i.0 = phi i32 [ 0, %if.end ], [ %inc, %if.then47 ]
...
lor.lhs.false32:                                  ; preds = %land.lhs.true
  ...
  br i1 %cmp36, label %if.then47, label %lor.lhs.false37
...
if.then47:                                        ; preds = %lor.lhs.false42, %lor.lhs.false37, %lor.lhs.false32, %land.lhs.true
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !8

if.else:                                          ; preds = %lor.lhs.false42, %lor.lhs.false23
...
for.cond50:                                       ; preds = %if.end65, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc67, %if.end65 ]
  %number.0 = phi i32 [ 0, %for.end ], [ %number.1, %if.end65 ]
...
if.end65:                                         ; preds = %if.then63, %for.body55
...
cleanup:                                          ; preds = %if.then74, %if.else76, %if.else, %if.then
