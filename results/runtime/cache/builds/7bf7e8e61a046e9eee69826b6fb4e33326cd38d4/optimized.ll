...
for.cond22:                                       ; preds = %for.inc28, %while.end
  ...
  %10 = phi i32 [ %dec29, %for.inc28 ], [ %sub21, %while.end ]
  store i32 %sub21.sink, ptr %i, align 4, !tbaa !5
  %cmp23 = icmp sge i32 %10, 0
...
for.inc28:                                        ; preds = %for.cond22
  ...
  %12 = load i32, ptr %arrayidx26, align 4, !tbaa !5, !invariant.load !14
  %call27 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %12)
  %dec29 = add nsw i32 %11, -1
