...
for.inc53:                                        ; preds = %for.cond30, %for.cond14
  ...
  call fastcc void @outlined_ir_func_0(i32 %x.4.lcssa.sink)
...
if.else25:                                        ; preds = %for.end_to_outline
  %call1.i2 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 2)
  br label %for.inc53.exitStub
