...
for.inc23:                                        ; preds = %for.cond15
  ...
  %6 = load i32, ptr %arrayidx20, align 4, !tbaa !5, !invariant.load !12
...
for.body35:                                       ; preds = %for.cond33
  ...
  br i1 %cmp36, label %for.inc45, label %if.else

if.else:                                          ; preds = %for.body35
  br label %for.inc45

for.inc45:                                        ; preds = %for.body35, %if.else
  ...
  %8 = load i32, ptr %arrayidx42, align 4, !tbaa !5, !invariant.load !12
