...
for.cond15.preheader:                             ; preds = %for.cond
  ...
  %sub21 = add i32 %k, -1
  %smax25 = tail call i32 @llvm.smax.i32(i32 noundef %sub21, i32 noundef 0)
  %smax32 = tail call i32 @llvm.smax.i32(i32 %1, i32 noundef 2)
...
for.inc17:                                        ; preds = %for.cond13
  ...
  tail call void @_Z7zerocoli(i32 noundef %8) #7
  ...
  tail call void @_Z4jiani(i32 noundef %11) #7
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !46
  br label %return
...
!39 = !{!40, !7, i64 56}
!40 = !{!"_ZTSSt5ctypeIcE", !41, i64 0, !42, i64 16, !43, i64 24, !44, i64 32, !44, i64 40, !45, i64 48, !7, i64 56, !7, i64 57, !7, i64 313, !7, i64 569}
!41 = !{!"_ZTSNSt6locale5facetE", !6, i64 8}
!42 = !{!"p1 _ZTS15__locale_struct", !30, i64 0}
!43 = !{!"bool", !7, i64 0}
!44 = !{!"p1 int", !30, i64 0}
!45 = !{!"p1 short", !30, i64 0}
!46 = !{!7, !7, i64 0}
