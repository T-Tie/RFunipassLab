...
for.body:                                         ; preds = %for.cond
  ...
  %smax42 = call i32 @llvm.smax.i32(i32 %3, i32 noundef 1)
...
for.cond30.preheader:                             ; preds = %for.cond7
  ...
  %smax44 = call i32 @llvm.smax.i32(i32 %5, i32 noundef 1)
  br label %for.cond30
...
if.then60:                                        ; preds = %for.end58
  ...
  %puts37 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.5.str.4) #6
  br label %if.end68
...
for.cond112.preheader:                            ; preds = %for.cond85
  ...
  %smax40 = call i32 @llvm.smax.i32(i32 %8, i32 noundef 1)
...
if.then142:                                       ; preds = %for.end140
  ...
  %puts33 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.1.str) #6
  br label %if.end151
...
for.inc164.sink.split:                            ; preds = %if.then153, %if.then70
  ...
  %puts34 = call i32 @puts(ptr noundef nonnull dereferenceable(1) %str.2.sink) #6
  br label %for.inc164
