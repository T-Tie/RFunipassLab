...
for.cond5.preheader:                              ; preds = %for.cond2
  %arrayidx11 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv27
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx9 = getelementptr inbounds nuw [20000 x i32], ptr %a, i64 0, i64 %indvars.iv.next30
...
for.cond21:                                       ; preds = %for.cond2, %for.cond21
  %indvars.iv44 = phi i32 [ %indvars.iv.next45, %for.cond21 ], [ %2, %for.cond2 ]
...
for.cond28.preheader:                             ; preds = %for.cond21
  %smax46 = call i32 @llvm.smax.i32(i32 %indvars.iv44, i32 noundef 0)
...
for.cond28:                                       ; preds = %for.cond28.preheader, %for.inc39
  ...
  br i1 %exitcond48.not, label %for.end41, label %for.body30
