...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %s_all) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr %s_good) #5
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %all) #5
  call void @llvm.lifetime.start.p0(i64 4, ptr %good) #5
  br label %for.cond
...
if.end:                                           ; preds = %if.else18, %if.then15
  %.str.2.sink = phi ptr [ @.str.2, %if.else18 ], [ @.str.1, %if.then15 ]
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %good) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %all) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %s_good) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr %s_all) #5
