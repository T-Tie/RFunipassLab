...
for.cond1:                                        ; preds = %for.cond, %for.end
  ...
  %storemerge4 = phi i32 [ %inc.i1, %for.end ], [ 0, %for.cond ]
...
for.cond4:                                        ; preds = %for.cond1, %for.body6
  %2 = phi i32 [ %.pre6, %for.body6 ], [ %1, %for.cond1 ]
  %storemerge5 = phi i32 [ %inc.i, %for.body6 ], [ 0, %for.cond1 ]
...
for.cond19:                                       ; preds = %for.cond, %for.body21
  ...
  %storemerge3 = phi i32 [ %inc.i2, %for.body21 ], [ 0, %for.cond ]
  store i32 %storemerge3, ptr @l, align 4, !tbaa !5
  %cmp20 = icmp slt i32 %storemerge3, %7
