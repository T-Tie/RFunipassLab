...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.inc24
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc24 ], [ 0, %for.cond2.preheader ]
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc24 ], [ 1, %for.cond2.preheader ]
...
for.end26:                                        ; preds = %for.cond2
  ...
  %call29 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %9, i32 noundef %10) #5
