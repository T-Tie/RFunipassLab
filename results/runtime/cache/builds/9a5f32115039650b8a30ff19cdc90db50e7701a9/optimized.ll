...
for.cond29:                                       ; preds = %for.cond, %for.cond29
  %indvars.iv20 = phi i32 [ %indvars.iv.next21, %for.cond29 ], [ 100, %for.cond ]
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.cond29 ], [ 100, %for.cond ]
  %arrayidx31 = getelementptr inbounds [100 x i32], ptr %an, i64 0, i64 %indvars.iv17
...
for.cond38.preheader:                             ; preds = %for.cond29
  %3 = zext i32 %indvars.iv20 to i64
  br label %for.cond38

for.cond38:                                       ; preds = %for.cond38.preheader, %for.inc45
  %indvars.iv22 = phi i64 [ %3, %for.cond38.preheader ], [ %5, %for.inc45 ]
