...
while.cond:                                       ; preds = %for.cond1, %entry
  %dec20 = phi i32 [ %n.promoted, %entry ], [ %dec, %for.cond1 ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc18
  %indvars.iv22 = phi i64 [ %indvars.iv.next23.pre-phi, %for.inc18 ], [ 0, %for.cond ]
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [100 x i32], ptr @a, i64 0, i64 %indvars.iv22
  %3 = load i32, ptr %arrayidx5, align 4, !tbaa !5, !invariant.load !9
  %cmp6 = icmp sgt i32 %3, 9
  %4 = add nuw nsw i64 %indvars.iv22, 1
...
for.cond22:                                       ; preds = %for.cond22.preheader, %for.inc28
  %indvars.iv27 = phi i64 [ %0, %for.cond22.preheader ], [ %8, %for.inc28 ]
