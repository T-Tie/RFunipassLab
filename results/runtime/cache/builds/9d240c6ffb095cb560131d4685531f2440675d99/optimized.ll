...
entry:
  ...
  %x12 = alloca i8, i32 0, align 16
  %x23 = alloca i8, i32 0, align 16
  %a = alloca [99 x double], align 16
  %b = alloca [99 x double], align 16
  %c = alloca [99 x double], align 16
  %disc4 = alloca i8, i32 0, align 16
  %realpart5 = alloca i8, i32 0, align 16
  %imagpart6 = alloca i8, i32 0, align 16
...
if.then32:                                        ; preds = %if.else
  ...
  %call50 = call double @sqrt(double noundef %7) #8, !tbaa !5
...
cond.true:                                        ; preds = %if.else62
  ...
  %call95 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %fneg87, double noundef %div79, double noundef %fneg87, double noundef %div79) #7
  br label %for.inc106

cond.false:                                       ; preds = %if.else62
  %call104 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %div69, double noundef %div79, double noundef %div69, double noundef %div79) #7
  br label %for.inc106
