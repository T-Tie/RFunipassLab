...
for.cond3:                                        ; preds = %for.cond3.preheader, %for.inc33
  %indvars.iv62 = phi i64 [ %1, %for.cond3.preheader ], [ %indvars.iv.next63, %for.inc33 ]
...
for.cond7:                                        ; preds = %for.cond3, %for.body10
  ...
  %exitcond65 = icmp eq i64 %indvars.iv32, %smax64
  br i1 %exitcond65, label %for.end18, label %for.body10
