...
while.end:                                        ; preds = %while.cond
  %indvars23.le = trunc i64 %indvars.iv11 to i32
  %sub = shl i64 %indvars.iv11, 32
  ...
  %sub7 = add nsw i32 %indvars23.le, -2
  br label %for.cond8

for.cond8:                                        ; preds = %for.inc29, %while.end
  %0 = phi i32 [ %dec, %for.inc29 ], [ %sub7, %while.end ]
  %1 = zext i32 %0 to i64
...
for.cond31.preheader:                             ; preds = %for.cond8
  %wide.trip.count = and i64 %indvars.iv11, 4294967295
  br label %for.cond31
...
while.cond11:                                     ; preds = %while.cond11.preheader, %if.end
  %indvars.iv14 = phi i64 [ %1, %while.cond11.preheader ], [ %indvars.iv.next15, %if.end ]
  %n.0 = phi i32 [ 0, %while.cond11.preheader ], [ %n.1, %if.end ]
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %2 = trunc nuw i64 %indvars.iv.next15 to i32
  %cmp12 = icmp slt i32 %2, %indvars23.le
...
for.body33:                                       ; preds = %for.cond31
  ...
  %spec.select9 = tail call i32 @llvm.smax.i32(i32 %6, i32 %n.2)
