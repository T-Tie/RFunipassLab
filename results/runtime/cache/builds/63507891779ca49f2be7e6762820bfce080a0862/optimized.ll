...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %total) #9
  call void @llvm.lifetime.start.p0(i64 noundef 80000, ptr noundef align 16 %valid) #9
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %t1) #9
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef align 8 %v1) #9
