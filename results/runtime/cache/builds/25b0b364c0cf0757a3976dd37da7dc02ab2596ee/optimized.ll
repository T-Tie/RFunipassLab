...
for.cond14:                                       ; preds = %for.cond14.preheader, %for.cond14.loopexit
  ...
  br i1 %exitcond117.not, label %for.inc138, label %for.cond17
...
for.cond24:                                       ; preds = %for.body26, %for.body19
  ...
  br i1 %exitcond84, label %for.cond39.preheader, label %for.body26
...
for.cond39:                                       ; preds = %for.cond39.preheader, %for.inc47
  %indvars.iv85 = phi i64 [ %indvars.iv78, %for.cond39.preheader ], [ %indvars.iv.next86, %for.inc47 ]
  %exitcond89 = icmp eq i64 %indvars.iv85, %1
  br i1 %exitcond89, label %for.inc50, label %for.inc47
...
for.cond60:                                       ; preds = %for.body62, %for.body55
  ...
  %min.2 = phi i32 [ %spec.select69, %for.body62 ], [ %11, %for.body55 ]
  %exitcond99 = icmp eq i64 %indvars.iv95, %1
  br i1 %exitcond99, label %for.cond77.preheader, label %for.body62
...
for.body62:                                       ; preds = %for.cond60
  ...
  %spec.select69 = call i32 @llvm.smin.i32(i32 %13, i32 %min.2)
  %indvars.iv.next96 = add nuw nsw i64 %indvars.iv95, 1
  br label %for.cond60, !llvm.loop !18

for.cond77:                                       ; preds = %for.cond77.preheader, %for.inc85
  %indvars.iv100 = phi i64 [ %indvars.iv78, %for.cond77.preheader ], [ %indvars.iv.next101, %for.inc85 ]
  %exitcond104 = icmp eq i64 %indvars.iv100, %1
  br i1 %exitcond104, label %for.inc88, label %for.inc85
...
for.inc85:                                        ; preds = %for.cond77
  ...
  %15 = load i32, ptr %gep71, align 4, !tbaa !5, !invariant.load !14
...
for.cond109:                                      ; preds = %for.inc130, %for.end90
  %indvars.iv112 = phi i64 [ %indvars.iv.next113, %for.inc130 ], [ %indvars.iv110, %for.end90 ]
