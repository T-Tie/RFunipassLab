...
for.cond15:                                       ; preds = %for.inc191, %for.end14
  %6 = phi i32 [ %dec, %for.inc191 ], [ %3, %for.end14 ]
...
for.cond23:                                       ; preds = %for.inc41, %for.body22
  %8 = phi i32 [ %inc42, %for.inc41 ], [ 0, %for.body22 ]
...
for.body26:                                       ; preds = %for.cond23
  ...
  %9 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom28
  %10 = getelementptr inbounds [100 x i32], ptr %9, i64 0, i64 %idxprom30
...
cond.end:                                         ; preds = %if.else, %cond.false
  %min.sink1 = phi ptr [ %min, %cond.false ], [ %10, %if.else ]
  %13 = load i32, ptr %min.sink1, align 4, !tbaa !5
  store i32 %13, ptr %min, align 4, !tbaa !5
  br label %for.inc41

for.inc41:                                        ; preds = %if.then, %cond.end
...
for.cond45:                                       ; preds = %for.inc53, %for.end43
  %14 = load i32, ptr %l44, align 4, !tbaa !5
  %cmp46 = icmp slt i32 %14, %6
  br i1 %cmp46, label %for.inc53, label %for.inc56

for.inc53:                                        ; preds = %for.cond45
  %15 = load i32, ptr %min, align 4, !tbaa !5
  ...
  %16 = load i32, ptr %arrayidx52, align 4, !tbaa !5, !invariant.load !13
...
for.cond65:                                       ; preds = %for.inc90, %for.body63
  %18 = phi i32 [ %inc91, %for.inc90 ], [ 0, %for.body63 ]
  %cmp66 = icmp slt i32 %18, %6
  br i1 %cmp66, label %for.body68, label %for.end92

for.body68:                                       ; preds = %for.cond65
  %cmp69 = icmp eq i32 %18, 0
  %idxprom71 = sext i32 %18 to i64
  %idxprom73 = sext i32 %17 to i64
  %19 = getelementptr inbounds [100 x [100 x i32]], ptr %a, i64 0, i64 %idxprom71
  %20 = getelementptr inbounds [100 x i32], ptr %19, i64 0, i64 %idxprom73
  %21 = load i32, ptr %20, align 4, !tbaa !5, !invariant.load !13
  br i1 %cmp69, label %if.then70, label %if.else75

if.then70:                                        ; preds = %for.body68
  store i32 %21, ptr %min, align 4, !tbaa !5
  br label %for.inc90

if.else75:                                        ; preds = %for.body68
  %22 = load i32, ptr %min, align 4, !tbaa !5
  %cmp80 = icmp sgt i32 %22, %21
  br i1 %cmp80, label %cond.end87, label %cond.false86

cond.false86:                                     ; preds = %if.else75
  br label %cond.end87

cond.end87:                                       ; preds = %if.else75, %cond.false86
  %min.sink = phi ptr [ %min, %cond.false86 ], [ %20, %if.else75 ]
  %23 = load i32, ptr %min.sink, align 4, !tbaa !5
  store i32 %23, ptr %min, align 4, !tbaa !5
  br label %for.inc90

for.inc90:                                        ; preds = %if.then70, %cond.end87
...
for.cond112:                                      ; preds = %for.inc132, %for.end108
  %29 = load i32, ptr %i111, align 4, !tbaa !5
  %cmp113 = icmp slt i32 %29, %6
...
for.cond117:                                      ; preds = %for.inc129, %for.body115
  %30 = load i32, ptr %j116, align 4, !tbaa !5
  %cmp118 = icmp slt i32 %30, %6
...
for.inc129:                                       ; preds = %for.cond117
  ...
  %idxprom123 = sext i32 %30 to i64
  %arrayidx124 = getelementptr inbounds [100 x i32], ptr %arrayidx122, i64 0, i64 %idxprom123
  %31 = load i32, ptr %arrayidx124, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %31, ptr %arrayidx128, align 4, !tbaa !5
  %inc130 = add nsw i32 %30, 1
...
for.cond136:                                      ; preds = %for.inc147, %for.end134
  %32 = load i32, ptr %i135, align 4, !tbaa !5
  %cmp137 = icmp slt i32 %32, %6
...
for.inc147:                                       ; preds = %for.cond136
  ...
  %33 = load i32, ptr %arrayidx141, align 16, !tbaa !5, !invariant.load !13
  %sub143 = sub nsw i32 %32, 1
...
for.inc162:                                       ; preds = %for.cond151
  ...
  %35 = load i32, ptr %arrayidx157, align 4, !tbaa !5, !invariant.load !13
  ...
  store i32 %35, ptr %arrayidx161, align 4, !tbaa !5
  %inc163 = add nsw i32 %34, 1
...
for.cond166:                                      ; preds = %for.inc188, %for.end164
  %36 = load i32, ptr %i165, align 4, !tbaa !5
  %cmp167 = icmp slt i32 %36, %6
...
for.cond171:                                      ; preds = %for.inc185, %for.body169
  %37 = load i32, ptr %j170, align 4, !tbaa !5
  %cmp172 = icmp slt i32 %37, %6
  br i1 %cmp172, label %for.inc185, label %for.inc188

for.inc185:                                       ; preds = %for.cond171
  %idxprom175 = sext i32 %36 to i64
...
for.inc195:                                       ; preds = %for.cond15
  ...
  %call193 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %39)
