...
for.cond6:                                        ; preds = %for.cond3, %if.end
  ...
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %if.end ], [ 0, %for.cond3 ]
...
for.cond15.preheader:                             ; preds = %for.body9
  %smax = call i32 @llvm.smax.i32(i32 %i.1, i32 %4)
  %wide.trip.count = sext i32 %smax to i64
  br label %for.cond15

for.cond15:                                       ; preds = %for.cond15.preheader, %for.body18
  %indvars.iv26 = phi i64 [ %5, %for.cond15.preheader ], [ %indvars.iv.next27, %for.body18 ]
...
for.body35:                                       ; preds = %for.cond33
  ...
  %13 = getelementptr inbounds nuw i32, ptr %call1, i64 %indvars.iv32
  %14 = load i32, ptr %13, align 4, !tbaa !5, !invariant.load !12
  %.str..str.1 = select i1 %cmp36, ptr @.str, ptr @.str.1
  %call43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) %.str..str.1, i32 noundef %14)
