...
for.cond22.preheader:                             ; preds = %for.cond6
  %smax12 = call i32 @llvm.smax.i32(i32 %t.0, i32 0)
...
for.cond52.preheader:                             ; preds = %for.cond22
  ...
  %smax21 = call i32 @llvm.smax.i32(i32 %t.0, i32 -1)
  %8 = add i32 %smax21, 1
...
for.body54:                                       ; preds = %for.cond52
  ...
  %11 = getelementptr inbounds nuw [500 x i32], ptr %js, i64 0, i64 %indvars.iv17
