; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/gesummv/gesummv.linked.bc'
...
entry:
  ...
  store i32 1300, ptr %n, align 4, !tbaa !5
  ...
  %call = call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8)
  store ptr %call, ptr %A, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 8, ptr %B) #8
  %call1 = call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8)
  store ptr %call1, ptr %B, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 8, ptr %tmp) #8
  %call2 = call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8)
  store ptr %call2, ptr %tmp, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 8, ptr %x) #8
  %call3 = call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8)
  store ptr %call3, ptr %x, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 8, ptr %y) #8
  %call4 = call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8)
  store ptr %call4, ptr %y, align 8, !tbaa !9
  %0 = load i32, ptr %n, align 4, !tbaa !5
  %1 = load ptr, ptr %A, align 8, !tbaa !9
  %arraydecay = getelementptr inbounds [1300 x [1300 x double]], ptr %1, i64 0, i64 0
  %2 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay5 = getelementptr inbounds [1300 x [1300 x double]], ptr %2, i64 0, i64 0
  %3 = load ptr, ptr %x, align 8, !tbaa !9
  %arraydecay6 = getelementptr inbounds [1300 x double], ptr %3, i64 0, i64 0
  call void @init_array(i32 noundef %0, ptr noundef %alpha, ptr noundef %beta, ptr noundef %arraydecay, ptr noundef %arraydecay5, ptr noundef %arraydecay6)
  call void (...) @polybench_timer_start()
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = load double, ptr %alpha, align 8, !tbaa !12
  %6 = load double, ptr %beta, align 8, !tbaa !12
  %7 = load ptr, ptr %A, align 8, !tbaa !9
  %arraydecay7 = getelementptr inbounds [1300 x [1300 x double]], ptr %7, i64 0, i64 0
  %8 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay8 = getelementptr inbounds [1300 x [1300 x double]], ptr %8, i64 0, i64 0
  %9 = load ptr, ptr %tmp, align 8, !tbaa !9
  %arraydecay9 = getelementptr inbounds [1300 x double], ptr %9, i64 0, i64 0
  %10 = load ptr, ptr %x, align 8, !tbaa !9
  %arraydecay10 = getelementptr inbounds [1300 x double], ptr %10, i64 0, i64 0
  %11 = load ptr, ptr %y, align 8, !tbaa !9
  %arraydecay11 = getelementptr inbounds [1300 x double], ptr %11, i64 0, i64 0
  call void @kernel_gesummv(i32 noundef %4, double noundef %5, double noundef %6, ptr noundef %arraydecay7, ptr noundef %arraydecay8, ptr noundef %arraydecay9, ptr noundef %arraydecay10, ptr noundef %arraydecay11)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call12 = call i32 @strcmp(ptr noundef %14, ptr noundef @.str.5) #11
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arraydecay13 = getelementptr inbounds [1300 x double], ptr %16, i64 0, i64 0
  call void @print_array(i32 noundef %15, ptr noundef %arraydecay13)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %17 = load ptr, ptr %A, align 8, !tbaa !9
  call void @free(ptr noundef %17) #8
  %18 = load ptr, ptr %B, align 8, !tbaa !9
  call void @free(ptr noundef %18) #8
  %19 = load ptr, ptr %tmp, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define internal void @init_array(i32 noundef %n, ptr noundef %alpha, ptr noundef %beta, ptr noundef %A, ptr noundef %B, ptr noundef %x) #0 {
entry:
...
for.body5:                                        ; preds = %for.cond2
  ...
  %arrayidx11 = getelementptr inbounds [1300 x double], ptr %15, i64 %idxprom10
  %17 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom12 = sext i32 %17 to i64
  %arrayidx13 = getelementptr inbounds [1300 x double], ptr %arrayidx11, i64 0, i64 %idxprom12
  store double %div9, ptr %arrayidx13, align 8, !tbaa !12
  ...
  %arrayidx21 = getelementptr inbounds [1300 x double], ptr %22, i64 %idxprom20
  %24 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom22 = sext i32 %24 to i64
  %arrayidx23 = getelementptr inbounds [1300 x double], ptr %arrayidx21, i64 0, i64 %idxprom22
  store double %div19, ptr %arrayidx23, align 8, !tbaa !12
  br label %for.inc
...
; Function Attrs: nounwind uwtable
define internal void @kernel_gesummv(i32 noundef %n, double noundef %alpha, double noundef %beta, ptr noundef %A, ptr noundef %B, ptr noundef %tmp, ptr noundef %x, ptr noundef %y) #0 {
entry:
  %n.addr = alloca i32, align 4
...
for.body:                                         ; preds = %for.cond
  %2 = load ptr, ptr %tmp.addr, align 8, !tbaa !9
  ...
  store double 0.000000e+00, ptr %arrayidx2, align 8, !tbaa !12
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond3
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx7 = getelementptr inbounds [1300 x double], ptr %8, i64 %idxprom6
  %10 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom8 = sext i32 %10 to i64
  %arrayidx9 = getelementptr inbounds [1300 x double], ptr %arrayidx7, i64 0, i64 %idxprom8
  ...
  %14 = load double, ptr %arrayidx11, align 8, !tbaa !12
  %15 = load ptr, ptr %tmp.addr, align 8, !tbaa !9
  %16 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom12 = sext i32 %16 to i64
  %arrayidx13 = getelementptr inbounds double, ptr %15, i64 %idxprom12
  %17 = load double, ptr %arrayidx13, align 8, !tbaa !12
  %18 = call double @llvm.fmuladd.f64(double %11, double %14, double %17)
  %19 = load ptr, ptr %tmp.addr, align 8, !tbaa !9
  %20 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom14 = sext i32 %20 to i64
  %arrayidx15 = getelementptr inbounds double, ptr %19, i64 %idxprom14
  store double %18, ptr %arrayidx15, align 8, !tbaa !12
  %21 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %22 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom16 = sext i32 %22 to i64
  %arrayidx17 = getelementptr inbounds [1300 x double], ptr %21, i64 %idxprom16
  %23 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom18 = sext i32 %23 to i64
  %arrayidx19 = getelementptr inbounds [1300 x double], ptr %arrayidx17, i64 0, i64 %idxprom18
  %24 = load double, ptr %arrayidx19, align 8, !tbaa !12
  %25 = load ptr, ptr %x.addr, align 8, !tbaa !9
  %26 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom20 = sext i32 %26 to i64
  %arrayidx21 = getelementptr inbounds double, ptr %25, i64 %idxprom20
  %27 = load double, ptr %arrayidx21, align 8, !tbaa !12
  ...
  %30 = load double, ptr %arrayidx23, align 8, !tbaa !12
  %31 = call double @llvm.fmuladd.f64(double %24, double %27, double %30)
  %32 = load ptr, ptr %y.addr, align 8, !tbaa !9
  %33 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom24 = sext i32 %33 to i64
  %arrayidx25 = getelementptr inbounds double, ptr %32, i64 %idxprom24
  store double %31, ptr %arrayidx25, align 8, !tbaa !12
  br label %for.inc
...
for.end:                                          ; preds = %for.cond3
  %35 = load double, ptr %alpha.addr, align 8, !tbaa !12
  %36 = load ptr, ptr %tmp.addr, align 8, !tbaa !9
  %37 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom26 = sext i32 %37 to i64
  %arrayidx27 = getelementptr inbounds double, ptr %36, i64 %idxprom26
  %38 = load double, ptr %arrayidx27, align 8, !tbaa !12
  %39 = load double, ptr %beta.addr, align 8, !tbaa !12
  %40 = load ptr, ptr %y.addr, align 8, !tbaa !9
  %41 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom28 = sext i32 %41 to i64
  %arrayidx29 = getelementptr inbounds double, ptr %40, i64 %idxprom28
  %42 = load double, ptr %arrayidx29, align 8, !tbaa !12
  %mul30 = fmul double %39, %42
  %43 = call double @llvm.fmuladd.f64(double %35, double %38, double %mul30)
  %44 = load ptr, ptr %y.addr, align 8, !tbaa !9
  ...
  store double %43, ptr %arrayidx32, align 8, !tbaa !12
  br label %for.inc33
