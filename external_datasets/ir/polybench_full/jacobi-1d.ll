; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/jacobi-1d/jacobi-1d.linked.bc'
...
entry:
  ...
  %arraydecay2 = getelementptr inbounds [2000 x double], ptr %2, i64 0, i64 0
  ...
  %arraydecay3 = getelementptr inbounds [2000 x double], ptr %5, i64 0, i64 0
  %6 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay4 = getelementptr inbounds [2000 x double], ptr %6, i64 0, i64 0
  call void @kernel_jacobi_1d(i32 noundef %3, i32 noundef %4, ptr noundef %arraydecay3, ptr noundef %arraydecay4)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arraydecay6 = getelementptr inbounds [2000 x double], ptr %11, i64 0, i64 0
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds double, ptr %7, i64 %idxprom5
  %9 = load double, ptr %arrayidx6, align 8, !tbaa !12
  %add = fadd double %6, %9
  ...
  store double %mul, ptr %arrayidx12, align 8, !tbaa !12
  br label %for.inc
...
for.body16:                                       ; preds = %for.cond13
  ...
  %20 = load double, ptr %arrayidx19, align 8, !tbaa !12
  %21 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %22 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom20 = sext i32 %22 to i64
  %arrayidx21 = getelementptr inbounds double, ptr %21, i64 %idxprom20
  ...
  %arrayidx25 = getelementptr inbounds double, ptr %24, i64 %idxprom24
  ...
  store double %mul27, ptr %arrayidx29, align 8, !tbaa !12
  br label %for.inc30
...
for.inc33:                                        ; preds = %for.end32
  ...
  store i32 %inc34, ptr %t, align 4, !tbaa !5
