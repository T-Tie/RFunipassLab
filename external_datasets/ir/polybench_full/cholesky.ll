; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/cholesky/cholesky.linked.bc'
...
entry:
  ...
  call void @kernel_cholesky(i32 noundef %2, ptr noundef %arraydecay1)
...
; Function Attrs: nounwind uwtable
define internal void @kernel_cholesky(i32 noundef %n, ptr noundef %A) #0 {
entry:
  %n.addr = alloca i32, align 4
  %A.addr = alloca ptr, align 8
  %i = alloca i32, align 4
...
for.cond28:                                       ; preds = %for.inc44, %for.end27
...
for.body30:                                       ; preds = %for.cond28
  ...
  %arrayidx32 = getelementptr inbounds [2000 x double], ptr %31, i64 %idxprom31
  ...
  %34 = load double, ptr %arrayidx34, align 8, !tbaa !12
  %35 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %36 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom35 = sext i32 %36 to i64
  %arrayidx36 = getelementptr inbounds [2000 x double], ptr %35, i64 %idxprom35
  %37 = load i32, ptr %k, align 4, !tbaa !5
  %idxprom37 = sext i32 %37 to i64
  %arrayidx38 = getelementptr inbounds [2000 x double], ptr %arrayidx36, i64 0, i64 %idxprom37
  %38 = load double, ptr %arrayidx38, align 8, !tbaa !12
  %39 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %40 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom39 = sext i32 %40 to i64
  %arrayidx40 = getelementptr inbounds [2000 x double], ptr %39, i64 %idxprom39
  %41 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom41 = sext i32 %41 to i64
  %arrayidx42 = getelementptr inbounds [2000 x double], ptr %arrayidx40, i64 0, i64 %idxprom41
  %42 = load double, ptr %arrayidx42, align 8, !tbaa !12
  %neg43 = fneg double %34
  %43 = call double @llvm.fmuladd.f64(double %neg43, double %38, double %42)
  store double %43, ptr %arrayidx42, align 8, !tbaa !12
  br label %for.inc44

for.inc44:                                        ; preds = %for.body30
  %44 = load i32, ptr %k, align 4, !tbaa !5
  %inc45 = add nsw i32 %44, 1
  store i32 %inc45, ptr %k, align 4, !tbaa !5
  br label %for.cond28, !llvm.loop !43
...
for.end46:                                        ; preds = %for.cond28
  ...
  %arrayidx48 = getelementptr inbounds [2000 x double], ptr %45, i64 %idxprom47
  %47 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom49 = sext i32 %47 to i64
  %arrayidx50 = getelementptr inbounds [2000 x double], ptr %arrayidx48, i64 0, i64 %idxprom49
  %48 = load double, ptr %arrayidx50, align 8, !tbaa !12
  %call = call double @sqrt(double noundef %48) #8, !tbaa !5
  %49 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %50 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom51 = sext i32 %50 to i64
  %arrayidx52 = getelementptr inbounds [2000 x double], ptr %49, i64 %idxprom51
  %51 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom53 = sext i32 %51 to i64
  %arrayidx54 = getelementptr inbounds [2000 x double], ptr %arrayidx52, i64 0, i64 %idxprom53
  store double %call, ptr %arrayidx54, align 8, !tbaa !12
  br label %for.inc55
