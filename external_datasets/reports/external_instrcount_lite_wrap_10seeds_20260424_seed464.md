...
- Generated at: 2026-04-24 16:24:59
- Mode: instrcount
...
```json
{
  ...
  "primary_metrics": {
    "count": 25,
    "mean_norm": 0.7816600717038787,
    "median_norm": 0.8808188749878718,
    "improved": 13,
    "tied": 1,
    "worsened": 11,
    "invalid": 7,
    ...
    "per_program": {
      "/root/exp/RFunipassLab/external_datasets/ir/cbench/consumer_jpeg_c.ll": {
        "ratio": Infinity,
        "raw_value": Infinity,
        "status": "opt timed out after 60.0s for pipeline='module(elim-avail-extern),module(globalopt),module(iroutliner),module(attributor),module(scc-oz-module-inliner),module(scc-oz-module-inliner),function(newgvn),module(scc-oz-module-inliner)', target_triple=x86_64-unknown-linux-gnu, cmd=/root/opt/rv64gc_llvm_21/bin/opt -S -passes=module(elim-avail-extern),module(globalopt),module(iroutliner),module(attributor),module(scc-oz-module-inliner),module(scc-oz-module-inliner),function(newgvn),module(scc-oz-module-inliner) --mtriple=x86_64-unknown-linux-gnu",
        "variance_pct": 0.0
      },
    ...
    "objective": 0.8476600717038787
  },
  "fixed_baselines": {
    "none": {
      "count": 25,
      "mean_ratio": Infinity,
      "median_ratio": 0.38591896472038206,
      "improved": 18,
      "tied": 0,
      "worsened": 7
    },
    ...
    "o3": {
      "count": 25,
      "mean_ratio": Infinity,
      "median_ratio": 0.7299270072992701,
      "improved": 18,
      "tied": 0,
      "worsened": 7
    }
...
```json
{
  ...
  "primary_metrics": {
    "count": 10,
    "mean_norm": 0.8693363436819252,
    "median_norm": 0.9629060157601383,
    "improved": 6,
    "tied": 1,
    "worsened": 3,
    "invalid": 3,
    ...
    "objective": 0.9143363436819253
  },
  "fixed_baselines": {
    "none": {
      "count": 10,
      "mean_ratio": Infinity,
      "median_ratio": 0.389020662652557,
      "improved": 7,
      "tied": 0,
      "worsened": 3
    },
    "oz": {
      "count": 10,
      "mean_ratio": Infinity,
      "median_ratio": 0.9752030078800692,
      "improved": 6,
      "tied": 1,
      "worsened": 3
    },
    "o3": {
      "count": 10,
      "mean_ratio": Infinity,
      "median_ratio": 0.8156952132855747,
      "improved": 7,
      "tied": 0,
      "worsened": 3
    }
  ...
  "per_program": [
    {
      ...
      "oz": 27748.0,
      "o3": 37087.0,
      "universal_status": "opt timed out after 60.0s for pipeline='module(elim-avail-extern),module(globalopt),module(iroutliner),module(attributor),module(scc-oz-module-inliner),module(scc-oz-module-inliner),function(newgvn),module(scc-oz-module-inliner)', target_triple=x86_64-unknown-linux-gnu, cmd=/root/opt/rv64gc_llvm_21/bin/opt -S -passes=module(elim-avail-extern),module(globalopt),module(iroutliner),module(attributor),module(scc-oz-module-inliner),module(scc-oz-module-inliner),function(newgvn),module(scc-oz-module-inliner) --mtriple=x86_64-unknown-linux-gnu",
      "none_status": "ok",
      "oz_status": "ok",
      "o3_status": "ok",
    ...
    },
    {
      ...
      "oz_status": "ok",
      "o3_status": "ok",
      "ratio_vs_none": 0.38591896472038206,
      "ratio_vs_oz": 0.9629060157601383,
      "ratio_vs_o3": 0.8156952132855747
    },
    {
      "suite": "cbench",
    ...
    },
    {
      ...
      "oz_status": "ok",
      "o3_status": "ok",
      "ratio_vs_none": 0.392122360584732,
      "ratio_vs_oz": 0.7987317342156052,
      "ratio_vs_o3": 0.5105745505816003
    }
  ],
  "failures": [
    {
      ...
      "name": "consumer_jpeg_c",
      "pipeline": "universal",
      "error": "opt timed out after 60.0s for pipeline='module(elim-avail-extern),module(globalopt),module(iroutliner),module(attributor),module(scc-oz-module-inliner),module(scc-oz-module-inliner),function(newgvn),module(scc-oz-module-inliner)', target_triple=x86_64-unknown-linux-gnu, cmd=/root/opt/rv64gc_llvm_21/bin/opt -S -passes=module(elim-avail-extern),module(globalopt),module(iroutliner),module(attributor),module(scc-oz-module-inliner),module(scc-oz-module-inliner),function(newgvn),module(scc-oz-module-inliner) --mtriple=x86_64-unknown-linux-gnu"
    },
    {
      "suite": "cbench",
      "name": "bzip2e",
...
```json
{
  ...
  "primary_metrics": {
    "count": 10,
    "mean_norm": 0.6860845197456265,
    "median_norm": 0.6151406508549366,
    "improved": 7,
    "tied": 0,
    "worsened": 3,
    "invalid": 0,
    ...
    "objective": 0.7310845197456265
  },
  "fixed_baselines": {
    "none": {
      "count": 10,
      "mean_ratio": 0.22672431845887314,
      "median_ratio": 0.21915970348376485,
      "improved": 10,
      "tied": 0,
      "worsened": 0
    },
    "oz": {
      "count": 10,
      "mean_ratio": 0.6860845197456265,
      "median_ratio": 0.6151406508549366,
      "improved": 7,
      "tied": 0,
      "worsened": 3
    },
    "o3": {
      "count": 10,
      "mean_ratio": 0.44754868677247917,
      "median_ratio": 0.3818370227975851,
      "improved": 10,
      "tied": 0,
      "worsened": 0
    }
...
```json
{
  ...
  "primary_metrics": {
    "count": 5,
    "mean_norm": 1.1236816874400768,
    "median_norm": 1.1236816874400768,
    "improved": 0,
    "tied": 0,
    "worsened": 5,
    "invalid": 4,
  ...
  "per_program": [
    ...
    },
    {
      ...
      "oz_status": "ok",
      "o3_status": "ok",
      "ratio_vs_none": 0.39001663893510813,
      "ratio_vs_oz": 1.1236816874400768,
      "ratio_vs_o3": 0.07624747901893175
    },
    {
      "suite": "csmith",
      "name": "trainprogram4",
