...
- Generated at: 2026-04-22 13:27:54
- Mode: instrcount
...
```text
module(elim-avail-extern),module(iroutliner),module(globalopt),module(attributor),function(gvn-hoist),function(newgvn),function(dse),module(attributor),module(scc-oz-module-inliner),function(gvn-hoist),module(attributor),function(gvn-sink),function(newgvn),module(attributor),module(scc-oz-module-inliner)
```
...
```json
{
  ...
  "primary_metrics": {
    "count": 25,
    "mean_norm": 0.6164324694096749,
    "median_norm": 0.5255102040816326,
    "improved": 11,
    "tied": 1,
    "worsened": 13,
    "invalid": 10,
    ...
    "per_program": {
      "/root/exp/RFunipassLab/external_datasets/ir/cbench/consumer_jpeg_c.ll": {
        "ratio": Infinity,
        "raw_value": Infinity,
        "status": "opt timed out after 60.0s for pipeline='module(elim-avail-extern),module(iroutliner),module(globalopt),module(attributor),function(gvn-hoist),function(newgvn),function(dse),module(attributor),module(scc-oz-module-inliner),function(gvn-hoist),module(attributor),function(gvn-sink),function(newgvn),module(attributor),module(scc-oz-module-inliner)', target_triple=x86_64-unknown-linux-gnu, cmd=/root/opt/rv64gc_llvm_21/bin/opt -S -passes=module(elim-avail-extern),module(iroutliner),module(globalopt),module(attributor),function(gvn-hoist),function(newgvn),function(dse),module(attributor),module(scc-oz-module-inliner),function(gvn-hoist),module(attributor),function(gvn-sink),function(newgvn),module(attributor),module(scc-oz-module-inliner) --mtriple=x86_64-unknown-linux-gnu",
        "variance_pct": 0.0
      },
    ...
    "objective": 0.6944324694096748
  },
  "fixed_baselines": {
    "none": {
      "count": 25,
      "mean_ratio": Infinity,
      "median_ratio": 0.38251218191662156,
      "improved": 15,
      "tied": 0,
      "worsened": 10
    },
    "oz": {
      "count": 25,
      "mean_ratio": Infinity,
      "median_ratio": 1.075221238938053,
      "improved": 11,
      "tied": 1,
      "worsened": 13
    },
    "o3": {
      "count": 25,
      "mean_ratio": Infinity,
      "median_ratio": 0.7262773722627737,
      "improved": 15,
      "tied": 0,
      "worsened": 10
    }
...
```json
{
  ...
  "primary_metrics": {
    "count": 10,
    "mean_norm": 0.7875275211922145,
    "median_norm": 0.8770781637717122,
    "improved": 3,
    "tied": 1,
    "worsened": 6,
    "invalid": 6,
  ...
  "per_program": [
    ...
    },
    {
      ...
      "oz_status": "ok",
      "o3_status": "ok",
      "ratio_vs_none": 0.38251218191662156,
      "ratio_vs_oz": 0.7791563275434243,
      "ratio_vs_o3": 0.4980613323933733
    }
  ],
  "failures": [
    {
...
```json
{
  ...
  "primary_metrics": {
    ...
    "objective": 0.6544459410834559
  },
  "fixed_baselines": {
    "none": {
      "count": 10,
      "mean_ratio": 0.20037216304275224,
  ...
  "per_program": [
    ...
    },
    {
      ...
      "oz_status": "ok",
      "o3_status": "ok",
      "ratio_vs_none": 0.35893648449039883,
      "ratio_vs_oz": 1.075221238938053,
      "ratio_vs_o3": 0.7210682492581603
    },
    {
      "suite": "polybench",
      "name": "nussinov",
    ...
    },
    {
      ...
      "oz_status": "ok",
      "o3_status": "ok",
      "ratio_vs_none": 0.37265917602996257,
      "ratio_vs_oz": 1.0815217391304348,
      "ratio_vs_o3": 0.7262773722627737
    }
  ],
  "failures": []
}
