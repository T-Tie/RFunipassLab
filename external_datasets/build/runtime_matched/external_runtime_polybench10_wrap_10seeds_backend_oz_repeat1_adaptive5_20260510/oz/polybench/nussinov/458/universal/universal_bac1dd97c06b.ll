...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 2500, i32 noundef 1) #11
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 6250000, i32 noundef 4) #11
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.inc16.i
  ...
  %exitcond20.not.i = icmp eq i64 %indvars.iv17.i, 2500
  br i1 %exitcond20.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.inc13.i
  %indvars.iv13.i = phi i64 [ %indvars.iv.next14.i, %for.inc13.i ], [ 0, %for.cond1.i ]
  %exitcond16.not.i = icmp eq i64 %indvars.iv13.i, 2500
  br i1 %exitcond16.not.i, label %for.inc16.i, label %for.inc13.i

for.inc13.i:                                      ; preds = %for.cond5.i
  %arrayidx12.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv17.i, i64 %indvars.iv13.i
...
for.cond1.i8:                                     ; preds = %for.cond150.i, %for.cond1.preheader.i
  ...
  %exitcond.not.i9 = icmp eq i64 %indvars.iv145.i, 2499
...
if.then.i:                                        ; preds = %for.cond1.i8
  ...
  %arrayidx12.i10 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv143.i, i64 %indvars.iv145.i
...
if.then65.i:                                      ; preds = %if.then62.i
  ...
  %spec.select136.i = tail call i32 @llvm.smax.i32(i32 %7, i32 %add85.i)
...
for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  ...
  %cmp151.i = icmp slt i64 %indvars.iv.i11, %indvars.iv145.i
  br i1 %cmp151.i, label %for.body153.i, label %for.cond1.i8, !llvm.loop !24

for.body153.i:                                    ; preds = %for.cond150.i
  %indvars.iv.next.i12 = add nuw nsw i64 %indvars.iv.i11, 1
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv143.i, i64 %indvars.iv.next.i12
  %12 = load i32, ptr %arrayidx161.i, align 4, !tbaa !20, !invariant.load !9
  %gep141.i = getelementptr [2500 x i32], ptr %invariant.gep140.i, i64 %indvars.iv.i11
  %13 = load i32, ptr %gep141.i, align 4, !tbaa !20, !invariant.load !9
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef readonly captures(none) %call1) #11
  br label %if.end
...
define internal fastcc void @print_array(ptr nofree noundef readonly captures(none) %table) unnamed_addr #7 {
entry:
...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv11 = phi i32 [ %indvars.iv.next12, %for.inc11 ], [ 2500, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc11 ], [ 0, %entry ]
  %t.0 = phi i32 [ %3, %for.inc11 ], [ 0, %entry ]
  %exitcond15.not = icmp eq i64 %indvars.iv, 2500
  br i1 %exitcond15.not, label %for.end13, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc ], [ %indvars.iv, %for.cond ]
  %t.1 = phi i32 [ %inc, %for.inc ], [ %t.0, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv9, 2500
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds nuw [2500 x i32], ptr %table, i64 %indvars.iv, i64 %indvars.iv9
