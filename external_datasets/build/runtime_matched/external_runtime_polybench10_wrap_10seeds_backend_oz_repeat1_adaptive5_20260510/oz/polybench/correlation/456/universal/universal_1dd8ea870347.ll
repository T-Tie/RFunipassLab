...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1680000, i32 noundef 8) #12
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #12
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #12
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #12
  br label %for.cond.i
...
for.cond.i2:                                      ; preds = %for.inc12.i, %init_array.exit
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.inc12.i ], [ 0, %init_array.exit ]
  %exitcond14.not.i = icmp eq i64 %indvars.iv11.i, 1200
  br i1 %exitcond14.not.i, label %for.cond15.i, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i2
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv11.i
...
for.inc.i6:                                       ; preds = %for.cond1.i3
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i4, i64 %indvars.iv11.i
...
for.cond15.i:                                     ; preds = %for.cond.i2, %for.inc55.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.inc55.i ], [ 0, %for.cond.i2 ]
  %exitcond22.not.i = icmp eq i64 %indvars.iv19.i, 1200
  br i1 %exitcond22.not.i, label %for.cond58.i, label %for.body17.i

for.body17.i:                                     ; preds = %for.cond15.i
  %arrayidx19.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv19.i
  %arrayidx28.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv19.i
...
for.cond20.i:                                     ; preds = %for.inc38.i, %for.body17.i
  %indvars.iv15.i = phi i64 [ %indvars.iv.next16.i, %for.inc38.i ], [ 0, %for.body17.i ]
  %exitcond18.not.i = icmp eq i64 %indvars.iv15.i, 1400
  br i1 %exitcond18.not.i, label %for.inc55.i, label %for.inc38.i

for.inc38.i:                                      ; preds = %for.cond20.i
  %arrayidx26.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv15.i, i64 %indvars.iv19.i
  %5 = load double, ptr %arrayidx26.i, align 8, !tbaa !5, !invariant.load !9
  %sub.i = fsub double %5, %4
  %6 = tail call double @llvm.fmuladd.f64(double %sub.i, double %sub.i, double noundef 0.000000e+00) #15
...
for.cond58.i:                                     ; preds = %for.cond15.i, %for.inc82.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %for.inc82.i ], [ 0, %for.cond15.i ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv27.i, 1400
  br i1 %exitcond30.not.i, label %for.cond85.i, label %for.cond61.i

for.cond61.i:                                     ; preds = %for.cond58.i, %for.inc79.i
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %for.inc79.i ], [ 0, %for.cond58.i ]
  %exitcond26.not.i = icmp eq i64 %indvars.iv23.i, 1200
  br i1 %exitcond26.not.i, label %for.inc82.i, label %for.inc79.i

for.inc79.i:                                      ; preds = %for.cond61.i
  %arrayidx65.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv23.i
  %7 = load double, ptr %arrayidx65.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx69.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv27.i, i64 %indvars.iv23.i
  ...
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv23.i
...
for.cond85.i:                                     ; preds = %for.cond58.i, %for.inc131.i
  %indvars.iv35.i = phi i64 [ %indvars.iv.next36.i, %for.inc131.i ], [ 0, %for.cond58.i ]
  %exitcond42.not.i = icmp eq i64 %indvars.iv35.i, 1199
  br i1 %exitcond42.not.i, label %kernel_correlation.exit, label %for.cond94.i

for.cond94.i:                                     ; preds = %for.cond101.i, %for.cond85.i
  %indvars.iv.next38.sink.i = phi i64 [ %indvars.iv35.i, %for.cond85.i ], [ %indvars.iv.next38.i, %for.cond101.i ]
  %.lcssa.sink.i = phi double [ 1.000000e+00, %for.cond85.i ], [ %10, %for.cond101.i ]
  %arrayidx127.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv.next38.sink.i, i64 %indvars.iv35.i
  store double %.lcssa.sink.i, ptr %arrayidx127.i, align 8, !tbaa !5
  %indvars.iv.next38.i = add nuw nsw i64 %indvars.iv.next38.sink.i, 1
  %exitcond40.not.i = icmp eq i64 %indvars.iv.next38.sink.i, 1199
  br i1 %exitcond40.not.i, label %for.inc131.i, label %for.body96.i

for.body96.i:                                     ; preds = %for.cond94.i
  %arrayidx100.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv35.i, i64 %indvars.iv.next38.i
...
for.cond101.i:                                    ; preds = %for.inc117.i, %for.body96.i
  %indvars.iv31.i = phi i64 [ %indvars.iv.next32.i, %for.inc117.i ], [ 0, %for.body96.i ]
  %10 = phi double [ %13, %for.inc117.i ], [ 0.000000e+00, %for.body96.i ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv31.i, 1400
  br i1 %exitcond34.not.i, label %for.cond94.i, label %for.inc117.i, !llvm.loop !26

for.inc117.i:                                     ; preds = %for.cond101.i
  %arrayidx107.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv31.i, i64 %indvars.iv35.i
  %11 = load double, ptr %arrayidx107.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx111.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv31.i, i64 %indvars.iv.next38.i
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1200, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(11520000) %call1) #12
  br label %if.end
