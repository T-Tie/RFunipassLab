...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1680000, i32 noundef 8) #15
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #15
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #15
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #15
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.inc7.i ], [ 0, %entry ]
  %exitcond14.not.i = icmp eq i64 %indvars.iv11.i, 1400
  br i1 %exitcond14.not.i, label %init_array.exit, label %for.cond1.preheader.i

for.cond1.preheader.i:                            ; preds = %for.cond.i
  %0 = trunc nuw nsw i64 %indvars.iv11.i to i32
...
for.inc.i:                                        ; preds = %for.cond1.i
  %1 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv11.i
  %2 = trunc nuw nsw i64 %1 to i32
  %conv.i = uitofp nneg i32 %2 to double
  %div.i = fdiv double %conv.i, 1.200000e+03
  %add.i = fadd double %div.i, %conv4.i
  %arrayidx6.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv11.i, i64 %indvars.iv.i
  store double %add.i, ptr %arrayidx6.i, align 8, !tbaa !5, !noalias !17
...
for.cond.i5:                                      ; preds = %for.inc12.i, %init_array.exit
  %indvars.iv88.i = phi i64 [ %indvars.iv.next89.i, %for.inc12.i ], [ 0, %init_array.exit ]
...
for.inc.i9:                                       ; preds = %for.cond1.i6
  ...
  %3 = load double, ptr %arrayidx7.i, align 8, !tbaa !5, !invariant.load !23
...
for.body17.i:                                     ; preds = %for.cond15.i
  ...
  %4 = load double, ptr %arrayidx28.i, align 8, !tbaa !5, !invariant.load !23
  br label %for.cond20.i

for.cond20.i:                                     ; preds = %for.inc38.i, %for.body17.i
  %indvars.iv92.i = phi i64 [ %indvars.iv.next93.i, %for.inc38.i ], [ 0, %for.body17.i ]
  %exitcond95.not.i = icmp eq i64 %indvars.iv92.i, 1400
  br i1 %exitcond95.not.i, label %for.end40.i, label %for.inc38.i
...
for.inc38.i:                                      ; preds = %for.cond20.i
  ...
  %5 = load double, ptr %arrayidx26.i, align 8, !tbaa !5, !invariant.load !23
  %sub.i = fsub double %5, %4
  %6 = tail call double @llvm.fmuladd.f64(double %sub.i, double %sub.i, double noundef 0.000000e+00) #23
  store double %6, ptr %arrayidx19.i, align 8, !tbaa !5
  %indvars.iv.next93.i = add nuw nsw i64 %indvars.iv92.i, 1
  br label %for.cond20.i, !llvm.loop !26

for.end40.i:                                      ; preds = %for.cond20.i
  store double 1.000000e+00, ptr %arrayidx19.i, align 8, !tbaa !5
  %indvars.iv.next97.i = add nuw nsw i64 %indvars.iv96.i, 1
  br label %for.cond15.i, !llvm.loop !27

for.cond58.i:                                     ; preds = %for.cond15.i, %for.inc82.i
  %indvars.iv104.i = phi i64 [ %indvars.iv.next105.i, %for.inc82.i ], [ 0, %for.cond15.i ]
...
for.inc79.i:                                      ; preds = %for.cond61.i
  ...
  br label %for.cond61.i, !llvm.loop !28

for.inc82.i:                                      ; preds = %for.cond61.i
  %indvars.iv.next105.i = add nuw nsw i64 %indvars.iv104.i, 1
  br label %for.cond58.i, !llvm.loop !29

for.cond85.i:                                     ; preds = %for.cond58.i, %for.inc131.i
  %indvars.iv112.i = phi i64 [ %indvars.iv.next113.i, %for.inc131.i ], [ 0, %for.cond58.i ]
...
for.cond94.i:                                     ; preds = %for.cond101.i, %for.cond85.i
  ...
  br i1 %exitcond117.not.i, label %for.inc131.i, label %for.body96.i
...
for.cond101.i:                                    ; preds = %for.inc117.i, %for.body96.i
  %indvars.iv108.i = phi i64 [ %indvars.iv.next109.i, %for.inc117.i ], [ 0, %for.body96.i ]
  %exitcond111.not.i = icmp eq i64 %indvars.iv108.i, 1400
  br i1 %exitcond111.not.i, label %for.cond94.i, label %for.inc117.i, !llvm.loop !30
...
for.inc117.i:                                     ; preds = %for.cond101.i
  ...
  %10 = load double, ptr %arrayidx107.i, align 8, !tbaa !5, !invariant.load !23
  %arrayidx111.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv108.i, i64 %indvars.iv.next115.i
  %11 = load double, ptr %arrayidx111.i, align 8, !tbaa !5, !invariant.load !23
  %12 = tail call double @llvm.fmuladd.f64(double %10, double %11, double noundef 0.000000e+00) #19
  store double %12, ptr %arrayidx100.i, align 8, !tbaa !5
  %indvars.iv.next109.i = add nuw nsw i64 %indvars.iv108.i, 1
  br label %for.cond101.i, !llvm.loop !31

for.inc131.i:                                     ; preds = %for.cond94.i
  %indvars.iv.next113.i = add nuw nsw i64 %indvars.iv112.i, 1
  br label %for.cond85.i, !llvm.loop !32
...
kernel_correlation.exit:                          ; preds = %for.cond85.i
  ...
  %call.i18 = tail call fastcc double @rtclock() #15
...
land.lhs.true:                                    ; preds = %kernel_correlation.exit
  %13 = load ptr, ptr %argv, align 8, !tbaa !33, !invariant.load !23
  %strcmpload = load i8, ptr %13, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1200, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(11520000) %call1) #24
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_correlation.exit
  tail call void @free(ptr noundef %call) #24
  tail call void @free(ptr noundef nonnull align 8 dereferenceable(11520000) %call1) #24
...
define internal fastcc void @print_array(i32 noundef %m, ptr nofree noundef readonly captures(none) %corr) unnamed_addr #12 {
entry:
...
!17 = !{!18}
!18 = distinct !{!18, !19, !"init_array: %float_n"}
