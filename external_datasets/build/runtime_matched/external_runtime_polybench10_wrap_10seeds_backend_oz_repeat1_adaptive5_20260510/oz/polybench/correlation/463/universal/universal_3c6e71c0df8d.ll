...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %float_n) #15
  ...
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %float_n, ptr nofree noundef nonnull writeonly captures(none) %call) #16
...
entry:
  store double 1.400000e+03, ptr %float_n, align 8, !tbaa !11
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.end ], [ 0, %entry ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, 1400
  br i1 %exitcond8.not, label %for.end9, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %0 = trunc nuw nsw i64 %indvars.iv5 to i32
  %conv4 = uitofp nneg i32 %0 to double
  br label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  %1 = mul nuw nsw i64 %indvars.iv, %indvars.iv5
  %2 = trunc nuw nsw i64 %1 to i32
  %conv = uitofp nneg i32 %2 to double
  %div = fdiv double %conv, 1.200000e+03
  %add = fadd double %div, %conv4
  %arrayidx6 = getelementptr inbounds nuw [1200 x double], ptr %data, i64 %indvars.iv5, i64 %indvars.iv
  store double %add, ptr %arrayidx6, align 8, !tbaa !11
