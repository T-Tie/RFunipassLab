...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1680000, i32 noundef 8) #11
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #11
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #11
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #11
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv17.i = phi i64 [ %indvars.iv.next18.i, %for.inc7.i ], [ 0, %entry ]
  %exitcond20.not.i = icmp eq i64 %indvars.iv17.i, 1400
...
for.inc.i:                                        ; preds = %for.cond1.i
  %1 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv17.i
  %2 = trunc nuw nsw i64 %1 to i32
  %conv.i = uitofp nneg i32 %2 to double
  %div.i = fdiv double %conv.i, 1.200000e+03
  %add.i = fadd double %div.i, %conv4.i
  %arrayidx6.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv17.i, i64 %indvars.iv.i
...
for.cond.i7:                                      ; preds = %for.inc12.i, %init_array.exit
  %indvars.iv77.i = phi i64 [ %indvars.iv.next78.i, %for.inc12.i ], [ 0, %init_array.exit ]
  %exitcond80.not.i = icmp eq i64 %indvars.iv77.i, 1200
  br i1 %exitcond80.not.i, label %for.cond15.i, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i7
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv77.i
  br label %for.cond1.i8

for.cond1.i8:                                     ; preds = %for.inc.i11, %for.body.i
  %indvars.iv.i9 = phi i64 [ %indvars.iv.next.i13, %for.inc.i11 ], [ 0, %for.body.i ]
  %exitcond.not.i10 = icmp eq i64 %indvars.iv.i9, 1400
  br i1 %exitcond.not.i10, label %for.inc12.i, label %for.inc.i11

for.inc.i11:                                      ; preds = %for.cond1.i8
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i9, i64 %indvars.iv77.i
  %3 = load double, ptr %arrayidx7.i, align 8, !tbaa !5, !invariant.load !9
  %add.i12 = fadd double %3, 0.000000e+00
  store double %add.i12, ptr %arrayidx.i, align 8, !tbaa !5
  %indvars.iv.next.i13 = add nuw nsw i64 %indvars.iv.i9, 1
  br label %for.cond1.i8, !llvm.loop !23

for.inc12.i:                                      ; preds = %for.cond1.i8
  store double 0.000000e+00, ptr %arrayidx.i, align 8, !tbaa !5
  %indvars.iv.next78.i = add nuw nsw i64 %indvars.iv77.i, 1
  br label %for.cond.i7, !llvm.loop !24

for.cond15.i:                                     ; preds = %for.cond.i7, %for.end40.i
  %indvars.iv85.i = phi i64 [ %indvars.iv.next86.i, %for.end40.i ], [ 0, %for.cond.i7 ]
  %exitcond88.not.i = icmp eq i64 %indvars.iv85.i, 1200
  br i1 %exitcond88.not.i, label %for.cond58.i, label %for.body17.i

for.body17.i:                                     ; preds = %for.cond15.i
  %arrayidx19.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv85.i
  %arrayidx28.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv85.i
...
for.cond20.i:                                     ; preds = %for.inc38.i, %for.body17.i
  %indvars.iv81.i = phi i64 [ %indvars.iv.next82.i, %for.inc38.i ], [ 0, %for.body17.i ]
  %exitcond84.not.i = icmp eq i64 %indvars.iv81.i, 1400
  br i1 %exitcond84.not.i, label %for.end40.i, label %for.inc38.i

for.inc38.i:                                      ; preds = %for.cond20.i
  %arrayidx26.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv81.i, i64 %indvars.iv85.i
  %5 = load double, ptr %arrayidx26.i, align 8, !tbaa !5, !invariant.load !9
  %sub.i = fsub double %5, %4
  %6 = tail call double @llvm.fmuladd.f64(double %sub.i, double %sub.i, double noundef 0.000000e+00) #14
...
for.cond58.i:                                     ; preds = %for.cond15.i, %for.inc82.i
  %indvars.iv93.i = phi i64 [ %indvars.iv.next94.i, %for.inc82.i ], [ 0, %for.cond15.i ]
  %exitcond96.not.i = icmp eq i64 %indvars.iv93.i, 1400
  br i1 %exitcond96.not.i, label %for.cond85.i, label %for.cond61.i

for.cond61.i:                                     ; preds = %for.cond58.i, %for.inc79.i
  %indvars.iv89.i = phi i64 [ %indvars.iv.next90.i, %for.inc79.i ], [ 0, %for.cond58.i ]
  %exitcond92.not.i = icmp eq i64 %indvars.iv89.i, 1200
  br i1 %exitcond92.not.i, label %for.inc82.i, label %for.inc79.i

for.inc79.i:                                      ; preds = %for.cond61.i
  %arrayidx65.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv89.i
  %7 = load double, ptr %arrayidx65.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx69.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv93.i, i64 %indvars.iv89.i
  %8 = load double, ptr %arrayidx69.i, align 8, !tbaa !5, !invariant.load !9
  %sub70.i = fsub double %8, %7
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv89.i
...
for.cond85.i:                                     ; preds = %for.cond58.i, %for.inc131.i
  %indvars.iv101.i = phi i64 [ %indvars.iv.next102.i, %for.inc131.i ], [ 0, %for.cond58.i ]
  %exitcond104.not.i = icmp eq i64 %indvars.iv101.i, 1199
  br i1 %exitcond104.not.i, label %kernel_correlation.exit, label %for.cond94.i

for.cond94.i:                                     ; preds = %for.cond101.i, %for.cond85.i
  %indvars.iv = phi i64 [ %indvars.iv101.i, %for.cond85.i ], [ %indvars.iv.next, %for.cond101.i ]
  %.sink.i = phi double [ 1.000000e+00, %for.cond85.i ], [ 0.000000e+00, %for.cond101.i ]
  %arrayidx92.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv, i64 %indvars.iv101.i
  store double %.sink.i, ptr %arrayidx92.i, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv, 1199
  br i1 %exitcond.not, label %for.inc131.i, label %for.body96.i

for.body96.i:                                     ; preds = %for.cond94.i
  %arrayidx100.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv101.i, i64 %indvars.iv.next
...
for.cond101.i:                                    ; preds = %for.inc117.i, %for.body96.i
  %indvars.iv97.i = phi i64 [ %indvars.iv.next98.i, %for.inc117.i ], [ 0, %for.body96.i ]
  %exitcond100.not.i = icmp eq i64 %indvars.iv97.i, 1400
  br i1 %exitcond100.not.i, label %for.cond94.i, label %for.inc117.i, !llvm.loop !29

for.inc117.i:                                     ; preds = %for.cond101.i
  %arrayidx107.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv97.i, i64 %indvars.iv101.i
  %10 = load double, ptr %arrayidx107.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx111.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv97.i, i64 %indvars.iv.next
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(11520000) %call1) #11
  br label %if.end
...
define internal fastcc void @print_array(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(11520000) %corr) unnamed_addr #7 {
entry:
...
for.inc:                                          ; preds = %for.body4, %if.then
  %4 = load ptr, ptr @stderr, align 8, !tbaa !34
  ...
  %call9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.5.10, double noundef %5) #15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end12:                                        ; preds = %for.cond
  ...
  %call13 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3.8) #15
