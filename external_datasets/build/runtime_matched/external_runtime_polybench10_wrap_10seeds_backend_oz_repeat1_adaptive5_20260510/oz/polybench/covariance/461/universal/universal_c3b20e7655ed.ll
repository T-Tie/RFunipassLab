...
for.inc.i:                                        ; preds = %for.cond2.i
  ...
  store double %div.i, ptr %arrayidx9.i, align 8, !tbaa !5, !noalias !17
...
for.cond1.i:                                      ; preds = %for.inc.i8, %for.body.i
  %indvars.iv.i6 = phi i64 [ %indvars.iv.next.i9, %for.inc.i8 ], [ 0, %for.body.i ]
  %exitcond.not.i7 = icmp eq i64 %indvars.iv.i6, 1400
  br i1 %exitcond.not.i7, label %for.inc12.i, label %for.inc.i8

for.inc.i8:                                       ; preds = %for.cond1.i
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i6, i64 %indvars.iv37.i
  %2 = load double, ptr %arrayidx7.i, align 8, !tbaa !5, !invariant.load !22
...
for.inc12.i:                                      ; preds = %for.cond1.i
  ...
  br label %for.cond.i5, !llvm.loop !24

for.cond15.i:                                     ; preds = %for.cond.i5, %for.inc30.i
  %indvars.iv45.i = phi i64 [ %indvars.iv.next46.i, %for.inc30.i ], [ 0, %for.cond.i5 ]
...
for.inc58.i:                                      ; preds = %for.cond43.i
  ...
  %5 = load double, ptr %arrayidx49.i, align 8, !tbaa !5, !invariant.load !22
  %arrayidx53.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv49.i, i64 %indvars.iv55.i
  %6 = load double, ptr %arrayidx53.i, align 8, !tbaa !5, !invariant.load !22
  %7 = tail call double @llvm.fmuladd.f64(double %5, double %6, double noundef 0.000000e+00) #22
  store double %7, ptr %arrayidx42.i, align 8, !tbaa !5
  %indvars.iv.next50.i = add nuw nsw i64 %indvars.iv49.i, 1
  br label %for.cond43.i, !llvm.loop !27
...
for.inc75.i:                                      ; preds = %for.cond43.i
  ...
  br label %for.cond36.i, !llvm.loop !28
...
land.lhs.true:                                    ; preds = %kernel_covariance.exit
  %8 = load ptr, ptr %argv, align 8, !tbaa !29, !invariant.load !22
  %strcmpload = load i8, ptr %8, align 1, !invariant.load !22
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef readonly captures(none) %call1) #23
  br label %if.end
...
define internal fastcc void @print_array(ptr nofree noundef readonly captures(none) %cov) unnamed_addr #12 {
entry:
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %5 = load double, ptr %arrayidx8, align 8, !tbaa !5, !invariant.load !22
