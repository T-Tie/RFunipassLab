...
for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv3.i = phi i64 [ %indvars.iv.next4.i, %for.end.i ], [ 0, %entry ]
  %exitcond6.not.i = icmp eq i64 %indvars.iv3.i, 1400
  br i1 %exitcond6.not.i, label %init_array.exit, label %for.cond2.i
...
for.inc.i:                                        ; preds = %for.cond2.i
  ...
  %arrayidx9.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv3.i, i64 %indvars.iv.i
...
for.cond.i2:                                      ; preds = %for.inc12.i, %init_array.exit
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc12.i ], [ 0, %init_array.exit ]
  %exitcond10.not.i = icmp eq i64 %indvars.iv7.i, 1200
  br i1 %exitcond10.not.i, label %for.cond15.i, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i2
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv7.i
...
for.inc.i5:                                       ; preds = %for.cond1.i
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i3, i64 %indvars.iv7.i
...
for.cond15.i:                                     ; preds = %for.cond.i2, %for.inc30.i
  %indvars.iv15.i = phi i64 [ %indvars.iv.next16.i, %for.inc30.i ], [ 0, %for.cond.i2 ]
  %exitcond18.not.i = icmp eq i64 %indvars.iv15.i, 1400
  br i1 %exitcond18.not.i, label %for.cond33.i, label %for.cond18.i

for.cond18.i:                                     ; preds = %for.cond15.i, %for.inc27.i
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.inc27.i ], [ 0, %for.cond15.i ]
  %exitcond14.not.i = icmp eq i64 %indvars.iv11.i, 1200
  br i1 %exitcond14.not.i, label %for.inc30.i, label %for.inc27.i

for.inc27.i:                                      ; preds = %for.cond18.i
  %arrayidx22.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv11.i
  %3 = load double, ptr %arrayidx22.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx26.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv15.i, i64 %indvars.iv11.i
...
for.cond33.i:                                     ; preds = %for.cond15.i, %for.end77.i
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %for.end77.i ], [ 0, %for.cond15.i ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv23.i, 1200
  br i1 %exitcond30.not.i, label %kernel_covariance.exit, label %for.cond36.i

for.cond36.i:                                     ; preds = %for.cond33.i, %for.inc75.i
  %indvars.iv25.i = phi i64 [ %indvars.iv.next26.i, %for.inc75.i ], [ %indvars.iv23.i, %for.cond33.i ]
  %exitcond28.not.i = icmp eq i64 %indvars.iv25.i, 1200
  br i1 %exitcond28.not.i, label %for.end77.i, label %for.body38.i

for.body38.i:                                     ; preds = %for.cond36.i
  %arrayidx42.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv23.i, i64 %indvars.iv25.i
...
for.cond43.i:                                     ; preds = %for.inc58.i, %for.body38.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.inc58.i ], [ 0, %for.body38.i ]
  %5 = phi double [ %8, %for.inc58.i ], [ 0.000000e+00, %for.body38.i ]
  %exitcond22.not.i = icmp eq i64 %indvars.iv19.i, 1400
  br i1 %exitcond22.not.i, label %for.inc75.i, label %for.inc58.i

for.inc58.i:                                      ; preds = %for.cond43.i
  %arrayidx49.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv19.i, i64 %indvars.iv23.i
  %6 = load double, ptr %arrayidx49.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx53.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv19.i, i64 %indvars.iv25.i
  %7 = load double, ptr %arrayidx53.i, align 8, !tbaa !5, !invariant.load !9
...
for.inc75.i:                                      ; preds = %for.cond43.i
  ...
  %arrayidx74.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv25.i, i64 %indvars.iv23.i
...
land.lhs.true:                                    ; preds = %kernel_covariance.exit
  ...
  %strcmpload = load i8, ptr %9, align 1, !invariant.load !9
...
define internal fastcc void @print_array(ptr nofree noundef nonnull readonly captures(none) %cov) unnamed_addr #8 {
entry:
  ...
  %1 = zext i32 1200 to i64
  %smax = call i32 @llvm.smax.i32(i32 1200, i32 0)
  %wide.trip.count8 = zext nneg i32 %smax to i64
  %wide.trip.count = zext i32 1200 to i64
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %for.end ], [ 0, %entry ]
  %exitcond9.not = icmp eq i64 %indvars.iv4, %wide.trip.count8
  br i1 %exitcond9.not, label %for.end12, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond
  %2 = mul i64 %indvars.iv4, %1
  br label %for.cond2
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds nuw [1200 x double], ptr %cov, i64 %indvars.iv4, i64 %indvars.iv
