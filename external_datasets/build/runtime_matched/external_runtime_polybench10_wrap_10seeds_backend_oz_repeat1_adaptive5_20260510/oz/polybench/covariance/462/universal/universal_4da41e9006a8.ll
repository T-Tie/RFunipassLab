...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %float_n) #18
  ...
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %float_n, ptr nofree noundef writeonly captures(none) %call) #19
  unreachable
}
...
for.body:                                         ; preds = %entry, %for.end
  ...
  %conv6 = uitofp nneg i32 %0 to double
  br label %for.cond2
...
for.inc:                                          ; preds = %for.cond2
  ...
  %conv7 = uitofp nneg i32 %1 to double
  %mul = fmul double %conv6, %conv7
  %div = fdiv double %mul, 1.200000e+03
  %arrayidx9 = getelementptr inbounds nuw [1200 x double], ptr %data, i64 %indvars.iv7, i64 %indvars.iv
