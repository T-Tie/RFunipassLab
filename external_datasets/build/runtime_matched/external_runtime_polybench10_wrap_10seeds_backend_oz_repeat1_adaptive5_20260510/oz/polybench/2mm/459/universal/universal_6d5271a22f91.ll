...
entry:
  ...
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 880000, i32 noundef 8) #13
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 990000, i32 noundef 8) #13
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1080000, i32 noundef 8) #13
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 960000, i32 noundef 8) #13
  br label %for.cond.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  store double %div.i, ptr %arrayidx6.i, align 8, !tbaa !5, !noalias !16
...
for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv51.i = phi i64 [ %indvars.iv.next52.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond55.not.i = icmp eq i64 %indvars.iv51.i, 900
  br i1 %exitcond55.not.i, label %for.inc31.i, label %for.inc28.i
...
for.inc28.i:                                      ; preds = %for.cond14.i
  ...
  store double %div23.i, ptr %arrayidx27.i, align 8, !tbaa !5, !noalias !16
  br label %for.cond14.i, !llvm.loop !23

for.inc31.i:                                      ; preds = %for.cond14.i
  %indvars.iv.next57.i = add nuw nsw i64 %indvars.iv56.i, 1
  br label %for.cond10.i, !llvm.loop !24
...
for.cond38.i:                                     ; preds = %for.cond34.i, %for.inc53.i
  %indvars.iv60.i = phi i64 [ %indvars.iv.next61.i, %for.inc53.i ], [ 0, %for.cond34.i ]
  %exitcond66.not.i = icmp eq i64 %indvars.iv60.i, 1200
  br i1 %exitcond66.not.i, label %for.inc56.i, label %for.inc53.i
...
for.inc53.i:                                      ; preds = %for.cond38.i
  ...
  store double %div48.i, ptr %arrayidx52.i, align 8, !tbaa !5, !noalias !16
  %indvars.iv.next61.i = add nuw nsw i64 %indvars.iv60.i, 1
  br label %for.cond38.i, !llvm.loop !25

for.inc56.i:                                      ; preds = %for.cond38.i
  %indvars.iv.next68.i = add nuw nsw i64 %indvars.iv67.i, 1
  br label %for.cond34.i, !llvm.loop !26
...
for.cond63.i:                                     ; preds = %for.cond59.i, %for.inc77.i
  %indvars.iv71.i = phi i64 [ %indvars.iv.next72.i, %for.inc77.i ], [ 0, %for.cond59.i ]
  %exitcond76.not.i = icmp eq i64 %indvars.iv71.i, 1200
  br i1 %exitcond76.not.i, label %for.end79.i, label %for.inc77.i
...
for.inc77.i:                                      ; preds = %for.cond63.i
  ...
  store double %div72.i, ptr %arrayidx76.i, align 8, !tbaa !5, !noalias !16
  %indvars.iv.next72.i = add nuw nsw i64 %indvars.iv71.i, 1
  br label %for.cond63.i, !llvm.loop !27
...
for.cond.i3:                                      ; preds = %for.inc25.i, %init_array.exit
  %indvars.iv31.i = phi i64 [ %indvars.iv.next32.i, %for.inc25.i ], [ 0, %init_array.exit ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv31.i, 800
  br i1 %exitcond34.not.i, label %for.cond28.i, label %for.cond1.i4

for.cond1.i4:                                     ; preds = %for.cond.i3, %for.inc22.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %for.inc22.i ], [ 0, %for.cond.i3 ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv27.i, 900
  br i1 %exitcond30.not.i, label %for.inc25.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i4
...
for.cond6.i:                                      ; preds = %for.inc.i7, %for.body3.i
  ...
  %exitcond.not.i6 = icmp eq i64 %indvars.iv.i5, 1100
  br i1 %exitcond.not.i6, label %for.inc22.i, label %for.inc.i7

for.inc.i7:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [1100 x double], ptr %call1, i64 %indvars.iv31.i, i64 %indvars.iv.i5
  %12 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %mul.i = fmul double %12, 1.500000e+00
  %arrayidx16.i = getelementptr inbounds nuw [900 x double], ptr %call2, i64 %indvars.iv.i5, i64 %indvars.iv27.i
  %13 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !9
  %14 = tail call double @llvm.fmuladd.f64(double %mul.i, double %13, double 0.000000e+00) #16
  store double %14, ptr %arrayidx5.i, align 8, !tbaa !5
...
for.inc22.i:                                      ; preds = %for.cond6.i
  ...
  br label %for.cond1.i4, !llvm.loop !29

for.inc25.i:                                      ; preds = %for.cond1.i4
  %indvars.iv.next32.i = add nuw nsw i64 %indvars.iv31.i, 1
  br label %for.cond.i3, !llvm.loop !30

for.cond28.i:                                     ; preds = %for.cond.i3, %for.end60.i
  %indvars.iv43.i = phi i64 [ %indvars.iv.next44.i, %for.end60.i ], [ 0, %for.cond.i3 ]
...
for.cond31.i:                                     ; preds = %for.cond28.i, %for.inc58.i
  %indvars.iv39.i = phi i64 [ %indvars.iv.next40.i, %for.inc58.i ], [ 0, %for.cond28.i ]
...
for.body33.i:                                     ; preds = %for.cond31.i
  ...
  %15 = load double, ptr %arrayidx37.i, align 8, !tbaa !5, !invariant.load !9
  %mul38.i = fmul double %15, 1.200000e+00
  store double %mul38.i, ptr %arrayidx37.i, align 8, !tbaa !5
  br label %for.cond39.i

for.cond39.i:                                     ; preds = %for.inc55.i, %for.body33.i
  %indvars.iv35.i = phi i64 [ %indvars.iv.next36.i, %for.inc55.i ], [ 0, %for.body33.i ]
  %exitcond38.not.i = icmp eq i64 %indvars.iv35.i, 900
  br i1 %exitcond38.not.i, label %for.inc58.i, label %for.inc55.i

for.inc55.i:                                      ; preds = %for.cond39.i
  %arrayidx45.i = getelementptr inbounds nuw [900 x double], ptr %call, i64 %indvars.iv43.i, i64 %indvars.iv35.i
  %16 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx49.i = getelementptr inbounds nuw [1200 x double], ptr %call3, i64 %indvars.iv35.i, i64 %indvars.iv39.i
  %17 = load double, ptr %arrayidx49.i, align 8, !tbaa !5, !invariant.load !9
  %18 = tail call double @llvm.fmuladd.f64(double %16, double %17, double %mul38.i) #16
  store double %18, ptr %arrayidx37.i, align 8, !tbaa !5
...
land.lhs.true:                                    ; preds = %kernel_2mm.exit
  %19 = load ptr, ptr %argv, align 8, !tbaa !33, !invariant.load !9
  %strcmpload = load i8, ptr %19, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 800, i32 noundef 1200, ptr nofree noundef readonly captures(none) %call4) #13
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nl, ptr nofree noundef readonly captures(none) %D) unnamed_addr #8 {
entry:
