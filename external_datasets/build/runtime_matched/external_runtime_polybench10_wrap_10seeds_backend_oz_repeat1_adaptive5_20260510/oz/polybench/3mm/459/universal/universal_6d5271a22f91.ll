...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  br label %for.cond1.i, !llvm.loop !16
...
for.inc34.i:                                      ; preds = %for.cond15.i
  ...
  br label %for.cond11.i, !llvm.loop !20
...
for.inc56.i:                                      ; preds = %for.cond41.i
  ...
  br label %for.cond41.i, !llvm.loop !21

for.inc59.i:                                      ; preds = %for.cond41.i
  %indvars.iv.next65.i = add nuw nsw i64 %indvars.iv64.i, 1
  br label %for.cond37.i, !llvm.loop !22
...
for.inc82.i:                                      ; preds = %for.cond66.i
  ...
  br label %for.cond66.i, !llvm.loop !23
...
for.cond.i3:                                      ; preds = %for.inc24.i, %init_array.exit
  %indvars.iv45.i = phi i64 [ %indvars.iv.next46.i, %for.inc24.i ], [ 0, %init_array.exit ]
  %exitcond48.not.i = icmp eq i64 %indvars.iv45.i, 800
  br i1 %exitcond48.not.i, label %for.cond27.i, label %for.cond1.i4

for.cond1.i4:                                     ; preds = %for.cond.i3, %for.inc21.i
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %for.inc21.i ], [ 0, %for.cond.i3 ]
...
for.cond6.i:                                      ; preds = %for.inc.i7, %for.body3.i
  ...
  br i1 %exitcond.not.i6, label %for.inc21.i, label %for.inc.i7

for.inc.i7:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv45.i, i64 %indvars.iv.i5
  %13 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx16.i = getelementptr inbounds nuw [900 x double], ptr %call2, i64 %indvars.iv.i5, i64 %indvars.iv41.i
  %14 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !9
  %15 = tail call double @llvm.fmuladd.f64(double %13, double %14, double 0.000000e+00) #16
...
for.inc21.i:                                      ; preds = %for.cond6.i
  ...
  br label %for.cond1.i4, !llvm.loop !25

for.inc24.i:                                      ; preds = %for.cond1.i4
  %indvars.iv.next46.i = add nuw nsw i64 %indvars.iv45.i, 1
  br label %for.cond.i3, !llvm.loop !26

for.cond27.i:                                     ; preds = %for.cond.i3, %for.inc58.i
  %indvars.iv57.i = phi i64 [ %indvars.iv.next58.i, %for.inc58.i ], [ 0, %for.cond.i3 ]
...
for.body32.i:                                     ; preds = %for.cond30.i
  ...
  br label %for.cond37.i9

for.cond37.i9:                                    ; preds = %for.inc52.i, %for.body32.i
...
for.inc52.i:                                      ; preds = %for.cond37.i9
  %arrayidx43.i = getelementptr inbounds nuw [1200 x double], ptr %call4, i64 %indvars.iv57.i, i64 %indvars.iv49.i
  %16 = load double, ptr %arrayidx43.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx47.i = getelementptr inbounds nuw [1100 x double], ptr %call5, i64 %indvars.iv49.i, i64 %indvars.iv53.i
  %17 = load double, ptr %arrayidx47.i, align 8, !tbaa !5, !invariant.load !9
  %18 = tail call double @llvm.fmuladd.f64(double %16, double %17, double 0.000000e+00) #16
  store double %18, ptr %arrayidx36.i, align 8, !tbaa !5
  %indvars.iv.next50.i = add nuw nsw i64 %indvars.iv49.i, 1
  br label %for.cond37.i9, !llvm.loop !27

for.inc55.i:                                      ; preds = %for.cond37.i9
...
for.inc86.i:                                      ; preds = %for.cond71.i
  ...
  %arrayidx81.i10 = getelementptr inbounds nuw [1100 x double], ptr %call3, i64 %indvars.iv61.i, i64 %indvars.iv65.i
  %20 = load double, ptr %arrayidx81.i10, align 8, !tbaa !5, !invariant.load !9
  %21 = tail call double @llvm.fmuladd.f64(double %19, double %20, double 0.000000e+00) #16
...
land.lhs.true:                                    ; preds = %kernel_3mm.exit
  %22 = load ptr, ptr %argv, align 8, !tbaa !32, !invariant.load !9
  %strcmpload = load i8, ptr %22, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 800, i32 noundef 1100, ptr nofree noundef readonly captures(none) %call6) #13
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nl, ptr nofree noundef readonly captures(none) %G) unnamed_addr #8 {
entry:
