...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #14
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #14
...
for.body:                                         ; preds = %entry, %for.end
  %indvars.iv15 = phi i64 [ 0, %entry ], [ %indvars.iv.next16, %for.end ]
  %0 = trunc nuw nsw i64 %indvars.iv15 to i32
...
for.inc:                                          ; preds = %for.cond1
  ...
  %3 = tail call double @llvm.fmuladd.f64(double %conv, double %conv4, double noundef 2.000000e+00) #17
  %div = fdiv double %3, 1.300000e+03
  %arrayidx7 = getelementptr inbounds nuw [1300 x double], ptr %A, i64 %indvars.iv15, i64 %indvars.iv
  store double %div, ptr %arrayidx7, align 8, !tbaa !11
  %4 = add i32 %1, 3
  %conv10 = uitofp nneg i32 %4 to double
  %5 = tail call double @llvm.fmuladd.f64(double %conv, double %conv10, double noundef 3.000000e+00) #17
  %div12 = fdiv double %5, 1.300000e+03
  %arrayidx16 = getelementptr inbounds nuw [1300 x double], ptr %B, i64 %indvars.iv15, i64 %indvars.iv
