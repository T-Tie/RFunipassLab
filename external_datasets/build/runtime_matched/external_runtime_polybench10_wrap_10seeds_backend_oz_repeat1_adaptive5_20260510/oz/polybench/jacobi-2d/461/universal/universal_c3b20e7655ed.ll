...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #20
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %B) unnamed_addr #11 {
entry:
  br label %for.body
...
for.inc:                                          ; preds = %for.cond1
  ...
  %3 = tail call double @llvm.fmuladd.f64(double %conv, double %conv4, double noundef 2.000000e+00) #21
  ...
  %5 = tail call double @llvm.fmuladd.f64(double %conv, double %conv10, double noundef 3.000000e+00) #21
