...
for.body.i:                                       ; preds = %for.cond1.i, %entry
  br label %for.cond1.i

for.cond1.i:                                      ; preds = %for.body3.i, %for.body.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body3.i ], [ 0, %for.body.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, 1300
  br i1 %exitcond.not.i, label %for.body.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx7.i = getelementptr inbounds nuw [1300 x double], ptr %call, i64 0, i64 %indvars.iv.i
  store double 0x3F5934C67F9B2CE6, ptr %arrayidx7.i, align 8, !tbaa !11
  %arrayidx16.i = getelementptr inbounds nuw [1300 x double], ptr %call1, i64 0, i64 %indvars.iv.i
  store double 0x3F62E794DFB461AD, ptr %arrayidx16.i, align 8, !tbaa !11
