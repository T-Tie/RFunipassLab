; ModuleID = '/root/exp/RFunipassLab/external_datasets/ir/polybench/jacobi-2d.ll'
...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #16
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %B) unnamed_addr #12 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end ], [ 0, %entry ]
  %0 = trunc nuw nsw i64 %indvars.iv13 to i32
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = add i32 %1, 2
  %conv4 = uitofp nneg i32 %2 to double
  %3 = tail call double @llvm.fmuladd.f64(double %conv, double %conv4, double noundef 2.000000e+00) #22
  %div = fdiv double %3, 1.300000e+03
  %arrayidx7 = getelementptr inbounds nuw [1300 x double], ptr %A, i64 %indvars.iv13, i64 %indvars.iv
  store double %div, ptr %arrayidx7, align 8, !tbaa !11
  %4 = trunc i64 %indvars.iv to i32
  %5 = add i32 %4, 3
  %conv10 = uitofp nneg i32 %5 to double
  %6 = tail call double @llvm.fmuladd.f64(double %conv, double %conv10, double noundef 3.000000e+00) #22
  %div12 = fdiv double %6, 1.300000e+03
  %arrayidx16 = getelementptr inbounds nuw [1300 x double], ptr %B, i64 %indvars.iv13, i64 %indvars.iv
...
attributes #21 = { nofree noreturn nounwind }
