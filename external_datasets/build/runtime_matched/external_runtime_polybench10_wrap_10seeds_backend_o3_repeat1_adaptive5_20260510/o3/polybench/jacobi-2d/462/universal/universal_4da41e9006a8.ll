...
for.body:                                         ; preds = %entry, %for.end
  %indvars.iv13 = phi i64 [ 0, %entry ], [ %indvars.iv.next14, %for.end ]
...
for.inc:                                          ; preds = %for.cond1
  ...
  %3 = tail call double @llvm.fmuladd.f64(double %conv, double %conv4, double noundef 2.000000e+00) #19
  ...
  %4 = add i32 %1, 3
  %conv10 = uitofp nneg i32 %4 to double
  %5 = tail call double @llvm.fmuladd.f64(double %conv, double %conv10, double noundef 3.000000e+00) #19
  %div12 = fdiv double %5, 1.300000e+03
