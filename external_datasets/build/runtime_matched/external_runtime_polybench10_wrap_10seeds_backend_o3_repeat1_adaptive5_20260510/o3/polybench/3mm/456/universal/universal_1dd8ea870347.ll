...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 720000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 800000, i32 noundef 8) #14
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 900000, i32 noundef 8) #14
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 990000, i32 noundef 8) #14
  %call4 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1080000, i32 noundef 8) #14
  %call5 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1320000, i32 noundef 8) #14
  %call6 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 880000, i32 noundef 8) #14
  br label %for.cond.i
...
for.cond62.i:                                     ; preds = %for.cond37.i, %for.end84.i
  ...
  br i1 %exitcond45.not.i, label %init_array.exit, label %for.cond66.i
