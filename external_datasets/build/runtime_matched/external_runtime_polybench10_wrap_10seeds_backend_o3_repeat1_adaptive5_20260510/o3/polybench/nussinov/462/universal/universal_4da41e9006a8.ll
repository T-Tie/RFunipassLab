...
for.cond.i3:                                      ; preds = %for.inc195.i, %init_array.exit
  %indvars.iv116.i = phi i64 [ %indvars.iv.next117.i, %for.inc195.i ], [ 2499, %init_array.exit ]
  %indvars.iv.i4 = phi i64 [ %indvars.iv.next.i9, %for.inc195.i ], [ 2500, %init_array.exit ]
  %cmp.i = icmp sgt i64 %indvars.iv116.i, -1
  br i1 %cmp.i, label %for.body.i, label %kernel_nussinov.exit

for.body.i:                                       ; preds = %for.cond.i3
  %1 = add nuw nsw i64 %indvars.iv116.i, 1
  %arrayidx77.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv116.i
  br label %for.cond1.i5

for.cond1.i5:                                     ; preds = %for.inc192.i, %for.body.i
  %indvars.iv112.i = phi i64 [ %indvars.iv.next113.i, %for.inc192.i ], [ %indvars.iv.i4, %for.body.i ]
  %exitcond.not.i6 = icmp eq i64 %indvars.iv112.i, 2500
  br i1 %exitcond.not.i6, label %for.inc195.i, label %if.then29.i

if.then29.i:                                      ; preds = %for.cond1.i5
  %2 = add nsw i64 %indvars.iv112.i, -1
  %arrayidx7.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv116.i, i64 %indvars.iv112.i
  %3 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20, !invariant.load !9
  %arrayidx12.i7 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv116.i, i64 %2
  %4 = load i32, ptr %arrayidx12.i7, align 4, !tbaa !20, !invariant.load !9
  %spec.select.i = tail call i32 @llvm.smax.i32(i32 %3, i32 %4)
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %1, i64 %indvars.iv112.i
  %5 = load i32, ptr %arrayidx38.i, align 4, !tbaa !20, !invariant.load !9
  %spec.select105.i = tail call i32 @llvm.smax.i32(i32 %spec.select.i, i32 %5)
  store i32 %spec.select105.i, ptr %arrayidx7.i, align 4, !tbaa !20
  %cmp64.i = icmp slt i64 %indvars.iv116.i, %2
  %arrayidx75.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %1, i64 %2
  %6 = load i32, ptr %arrayidx75.i, align 4, !tbaa !20, !invariant.load !9
  br i1 %cmp64.i, label %if.then65.i, label %if.end148.i

if.then65.i:                                      ; preds = %if.then29.i
  %7 = load i8, ptr %arrayidx77.i, align 1, !tbaa !18, !invariant.load !9
  %conv.i8 = sext i8 %7 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv112.i
  %8 = load i8, ptr %arrayidx79.i, align 1, !tbaa !18, !invariant.load !9
  %conv80.i = sext i8 %8 to i32
  %add81.i = add nsw i32 %conv80.i, %conv.i8
...
for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  %storemerge120.i = phi i32 [ %spec.select106.i, %if.end148.i ], [ %spec.select108.i, %for.body153.i ]
  %indvars.iv109.i = phi i64 [ %indvars.iv.i4, %if.end148.i ], [ %indvars.iv.next110.i, %for.body153.i ]
  store i32 %storemerge120.i, ptr %arrayidx7.i, align 4, !tbaa !20
  %cmp151.i = icmp samesign ult i64 %indvars.iv109.i, %indvars.iv112.i
  br i1 %cmp151.i, label %for.body153.i, label %for.inc192.i

for.body153.i:                                    ; preds = %for.cond150.i
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv116.i, i64 %indvars.iv109.i
  ...
  %spec.select108.i = tail call i32 @llvm.smax.i32(i32 %storemerge120.i, i32 %add167.i)
...
for.inc195.i:                                     ; preds = %for.cond1.i5
  ...
  %indvars.iv.next.i9 = add nsw i64 %indvars.iv.i4, -1
  br label %for.cond.i3, !llvm.loop !26

kernel_nussinov.exit:                             ; preds = %for.cond.i3
...
land.lhs.true:                                    ; preds = %kernel_nussinov.exit
  ...
  %strcmpload = load i8, ptr %11, align 1, !invariant.load !9
