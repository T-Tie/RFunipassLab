...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #16
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #16
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call1) #18
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %A, ptr nofree noundef nonnull writeonly captures(none) %B) unnamed_addr #8 {
entry:
  br label %for.body
...
for.cond1:                                        ; preds = %for.inc19, %for.body
  %indvars.iv3 = phi i64 [ %indvars.iv.next4, %for.inc19 ], [ 0, %for.body ]
  %exitcond7.not = icmp eq i64 %indvars.iv3, 120
  br i1 %exitcond7.not, label %for.body, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond1
  %0 = add nuw nsw i64 %indvars.iv3, 120
  br label %for.cond4
...
for.cond4:                                        ; preds = %for.cond4.preheader, %for.inc
  ...
  br i1 %exitcond.not, label %for.inc19, label %for.inc

for.inc:                                          ; preds = %for.cond4
  %1 = sub nuw nsw i64 %0, %indvars.iv
  %2 = trunc i64 %1 to i32
  %3 = mul i32 %2, 10
  %mul = uitofp nneg i32 %3 to double
  %div = fdiv double %mul, 1.200000e+02
  %arrayidx12 = getelementptr inbounds nuw [120 x [120 x double]], ptr %B, i64 0, i64 %indvars.iv3, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !11
  %arrayidx18 = getelementptr inbounds nuw [120 x [120 x double]], ptr %A, i64 0, i64 %indvars.iv3, i64 %indvars.iv
  store double %div, ptr %arrayidx18, align 8, !tbaa !11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond4, !llvm.loop !15

for.inc19:                                        ; preds = %for.cond4
