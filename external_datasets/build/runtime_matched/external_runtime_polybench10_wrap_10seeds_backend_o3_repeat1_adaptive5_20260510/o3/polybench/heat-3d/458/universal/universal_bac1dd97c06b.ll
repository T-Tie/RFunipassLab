...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #16
  unreachable
}
...
for.body:                                         ; preds = %entry, %for.end21
  %indvars.iv19 = phi i64 [ 0, %entry ], [ %indvars.iv.next20, %for.end21 ]
  %0 = trunc i64 %indvars.iv19 to i32
  %1 = add i32 %0, 120
  br label %for.cond1

for.cond1:                                        ; preds = %for.inc19, %for.body
  %indvars.iv15 = phi i64 [ %indvars.iv.next16, %for.inc19 ], [ 0, %for.body ]
  %exitcond18.not = icmp eq i64 %indvars.iv15, 120
  br i1 %exitcond18.not, label %for.end21, label %for.cond4.preheader
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx12 = getelementptr inbounds nuw [120 x [120 x double]], ptr %B, i64 %indvars.iv19, i64 %indvars.iv15, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !11
  %arrayidx18 = getelementptr inbounds nuw [120 x [120 x double]], ptr %A, i64 %indvars.iv19, i64 %indvars.iv15, i64 %indvars.iv
