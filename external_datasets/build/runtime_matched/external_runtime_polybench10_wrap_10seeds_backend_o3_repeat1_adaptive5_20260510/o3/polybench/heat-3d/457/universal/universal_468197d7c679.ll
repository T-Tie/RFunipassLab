...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #14
...
for.body3:                                        ; preds = %for.cond4, %for.body
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc, %for.body3
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.body3 ]
  %exitcond.not = icmp eq i64 %indvars.iv, 120
  br i1 %exitcond.not, label %for.body3, label %for.inc

for.inc:                                          ; preds = %for.cond4
  %0 = trunc i64 %indvars.iv to i32
  %1 = sub i32 120, %0
  %2 = mul i32 %1, 10
  %mul = uitofp nneg i32 %2 to double
  %div = fdiv double %mul, 1.200000e+02
  %arrayidx12 = getelementptr inbounds nuw [120 x double], ptr %B, i64 0, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !11
  %arrayidx18 = getelementptr inbounds nuw [120 x double], ptr %A, i64 0, i64 %indvars.iv
