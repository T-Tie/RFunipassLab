...
for.cond1:                                        ; preds = %for.end, %for.body
  ...
  %exitcond9.not = icmp eq i64 %indvars.iv5, 120
  br i1 %exitcond9.not, label %for.body, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond1
  %0 = add nuw nsw i64 %indvars.iv5, 120
  br label %for.cond4
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx12 = getelementptr inbounds nuw [120 x [120 x double]], ptr %B, i64 0, i64 %indvars.iv5, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !11
  %arrayidx18 = getelementptr inbounds nuw [120 x [120 x double]], ptr %A, i64 0, i64 %indvars.iv5, i64 %indvars.iv
