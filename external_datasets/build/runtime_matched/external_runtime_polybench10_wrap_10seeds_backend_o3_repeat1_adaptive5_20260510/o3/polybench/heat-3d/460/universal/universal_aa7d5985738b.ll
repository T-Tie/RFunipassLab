...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #16
...
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %B) unnamed_addr #8 {
entry:
  br label %for.body

for.body:                                         ; preds = %entry, %for.end21
  %indvars.iv9 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.end21 ]
  %0 = trunc i64 %indvars.iv9 to i32
  %1 = add i32 %0, 120
  br label %for.cond1

for.cond1:                                        ; preds = %for.inc19, %for.body
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc19 ], [ 0, %for.body ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, 120
  br i1 %exitcond8.not, label %for.end21, label %for.cond4.preheader
...
for.inc:                                          ; preds = %for.cond4
  ...
  %add7 = sub i32 %reass.sub, %3
  %conv = sitofp i32 %add7 to double
  %mul = fmul double %conv, 1.000000e+01
  %div = fdiv double %mul, 1.200000e+02
  %arrayidx12 = getelementptr inbounds nuw [120 x [120 x double]], ptr %B, i64 %indvars.iv9, i64 %indvars.iv5, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !11
  %arrayidx18 = getelementptr inbounds nuw [120 x [120 x double]], ptr %A, i64 %indvars.iv9, i64 %indvars.iv5, i64 %indvars.iv
