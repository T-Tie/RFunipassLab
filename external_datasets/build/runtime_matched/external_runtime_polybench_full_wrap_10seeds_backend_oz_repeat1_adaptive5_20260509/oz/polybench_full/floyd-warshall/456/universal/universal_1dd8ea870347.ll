...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 7840000, i32 noundef 4) #16
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call) #18
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %path) unnamed_addr #8 {
entry:
  br label %for.body
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx5 = getelementptr inbounds nuw [2800 x i32], ptr %path, i64 0, i64 %indvars.iv
  ...
  %spec.select = select i1 %or.cond1, i32 999, i32 1
