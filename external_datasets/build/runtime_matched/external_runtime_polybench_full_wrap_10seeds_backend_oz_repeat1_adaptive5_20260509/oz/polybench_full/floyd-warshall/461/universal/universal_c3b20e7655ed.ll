...
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %path) unnamed_addr #11 {
entry:
  br label %for.body
...
for.body3:                                        ; preds = %for.cond1
  ...
  store i32 %spec.select, ptr %arrayidx5, align 4, !tbaa !17
