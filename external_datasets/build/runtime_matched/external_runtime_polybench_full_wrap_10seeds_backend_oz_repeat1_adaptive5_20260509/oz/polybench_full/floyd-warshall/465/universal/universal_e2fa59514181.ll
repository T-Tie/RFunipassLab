...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 7840000, i32 noundef 4) #16
...
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %path) unnamed_addr #12 {
entry:
  br label %for.body
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [2800 x i32], ptr %path, i64 %indvars.iv18, i64 %indvars.iv
  ...
  %or.cond14 = or i1 %cmp15, %or.cond
  %spec.select = select i1 %or.cond14, i32 999, i32 %add
  store i32 %spec.select, ptr %arrayidx5, align 4, !tbaa !15
