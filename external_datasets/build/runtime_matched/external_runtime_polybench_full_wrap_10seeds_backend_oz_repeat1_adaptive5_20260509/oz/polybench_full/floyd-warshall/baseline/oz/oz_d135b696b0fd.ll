...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 7840000, i32 noundef 4)
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc20.i, %entry
  %indvars.iv21.i = phi i64 [ %indvars.iv.next22.i, %for.inc20.i ], [ 0, %entry ]
  %exitcond24.not.i = icmp eq i64 %indvars.iv21.i, 2800
  br i1 %exitcond24.not.i, label %init_array.exit, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i, %for.body3.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body3.i ], [ 0, %for.cond.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, 2800
  br i1 %exitcond.not.i, label %for.inc20.i, label %for.body3.i
...
for.body3.i:                                      ; preds = %for.cond1.i
  ...
  %arrayidx5.i = getelementptr inbounds nuw [2800 x i32], ptr %call, i64 %indvars.iv21.i, i64 %indvars.iv.i
  %2 = add nuw nsw i64 %indvars.iv.i, %indvars.iv21.i
  %3 = trunc nuw nsw i64 %2 to i32
  %rem7.i = urem i32 %3, 13
  %cmp8.i = icmp eq i32 %rem7.i, 0
  %rem10.i = urem i32 %3, 7
  %cmp11.i = icmp eq i32 %rem10.i, 0
  %or.cond.i = or i1 %cmp8.i, %cmp11.i
  %rem14.i = urem i32 %3, 11
  %cmp15.i = icmp eq i32 %rem14.i, 0
  %or.cond17.i = or i1 %cmp15.i, %or.cond.i
  %spec.select.i = select i1 %or.cond17.i, i32 999, i32 %add.i
  store i32 %spec.select.i, ptr %arrayidx5.i, align 4, !tbaa !17
...
for.cond.i6:                                      ; preds = %for.inc38.i, %init_array.exit
  %indvars.iv31.i = phi i64 [ %indvars.iv.next32.i, %for.inc38.i ], [ 0, %init_array.exit ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv31.i, 2800
  br i1 %exitcond34.not.i, label %kernel_floyd_warshall.exit, label %for.cond1.i7

for.cond1.i7:                                     ; preds = %for.cond.i6, %for.inc35.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %for.inc35.i ], [ 0, %for.cond.i6 ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv27.i, 2800
  br i1 %exitcond30.not.i, label %for.inc38.i, label %for.cond4.preheader.i

for.cond4.preheader.i:                            ; preds = %for.cond1.i7
  %arrayidx12.i = getelementptr inbounds nuw [2800 x i32], ptr %call, i64 %indvars.iv27.i, i64 %indvars.iv31.i
  br label %for.cond4.i

for.cond4.i:                                      ; preds = %for.body6.i, %for.cond4.preheader.i
  %indvars.iv.i8 = phi i64 [ 0, %for.cond4.preheader.i ], [ %indvars.iv.next.i11, %for.body6.i ]
  %exitcond.not.i9 = icmp eq i64 %indvars.iv.i8, 2800
  br i1 %exitcond.not.i9, label %for.inc35.i, label %for.body6.i

for.body6.i:                                      ; preds = %for.cond4.i
  %arrayidx8.i = getelementptr inbounds nuw [2800 x i32], ptr %call, i64 %indvars.iv27.i, i64 %indvars.iv.i8
  %4 = load i32, ptr %arrayidx8.i, align 4, !tbaa !17
  %5 = load i32, ptr %arrayidx12.i, align 4, !tbaa !17
  %arrayidx16.i = getelementptr inbounds nuw [2800 x i32], ptr %call, i64 %indvars.iv31.i, i64 %indvars.iv.i8
  %6 = load i32, ptr %arrayidx16.i, align 4, !tbaa !17
  %add.i10 = add nsw i32 %6, %5
  %.add.i = tail call i32 @llvm.smin.i32(i32 %4, i32 %add.i10)
  store i32 %.add.i, ptr %arrayidx8.i, align 4, !tbaa !17
  %indvars.iv.next.i11 = add nuw nsw i64 %indvars.iv.i8, 1
  br label %for.cond4.i, !llvm.loop !22

for.inc35.i:                                      ; preds = %for.cond4.i
  %indvars.iv.next28.i = add nuw nsw i64 %indvars.iv27.i, 1
  br label %for.cond1.i7, !llvm.loop !23

for.inc38.i:                                      ; preds = %for.cond1.i7
  %indvars.iv.next32.i = add nuw nsw i64 %indvars.iv31.i, 1
  br label %for.cond.i6, !llvm.loop !24

kernel_floyd_warshall.exit:                       ; preds = %for.cond.i6
...
land.lhs.true:                                    ; preds = %kernel_floyd_warshall.exit
  %7 = load ptr, ptr %argv, align 8, !tbaa !25
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_floyd_warshall.exit
...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  %exitcond15.not = icmp eq i64 %indvars.iv11, 2800
...
for.cond2:                                        ; preds = %for.cond2.preheader, %if.end
  ...
  %exitcond.not = icmp eq i64 %indvars.iv, 2800
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %arrayidx8 = getelementptr inbounds nuw [2800 x i32], ptr %path, i64 %indvars.iv11, i64 %indvars.iv
