...
entry:
  ...
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #13
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call4, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call3) #16
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %r, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %p) unnamed_addr #8 {
entry:
  store double 0.000000e+00, ptr %p, align 8, !tbaa !11
  br label %for.body5

for.body5:                                        ; preds = %entry, %for.end26
  %indvars.iv18 = phi i64 [ 0, %entry ], [ %indvars.iv.next19, %for.end26 ]
...
for.body15:                                       ; preds = %for.cond12
  ...
  %0 = mul nuw nsw i64 %indvars.iv.next, %indvars.iv18
  %1 = trunc nuw i64 %0 to i32
  %rem16 = urem i32 %1, 2100
  %conv17 = uitofp nneg i32 %rem16 to double
  %div19 = fdiv double %conv17, 2.100000e+03
  %arrayidx23 = getelementptr inbounds nuw [1900 x double], ptr %A, i64 %indvars.iv18, i64 %indvars.iv
