...
entry:
  ...
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1900, i32 noundef 8) #15
  ...
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #15
...
for.body5:                                        ; preds = %for.cond, %for.end26
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end26 ], [ 0, %for.cond ]
  store double 0.000000e+00, ptr %r, align 8, !tbaa !11
  br label %for.cond12

for.cond12:                                       ; preds = %for.inc24, %for.body5
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc24 ], [ 0, %for.body5 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, 1900
  br i1 %exitcond12.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond12
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %1 = mul nuw nsw i64 %indvars.iv.next9, %indvars.iv13
  %2 = trunc nuw i64 %1 to i32
  %rem16 = urem i32 %2, 2100
  %conv17 = uitofp nneg i32 %rem16 to double
  %div19 = fdiv double %conv17, 2.100000e+03
  %arrayidx23 = getelementptr inbounds nuw [1900 x double], ptr %A, i64 %indvars.iv13, i64 %indvars.iv8
