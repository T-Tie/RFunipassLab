; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/bicg/bicg.linked.bc'
...
entry:
  ...
  %call1 = call ptr @polybench_alloc_data(i64 noundef 1900, i32 noundef 8)
  ...
  store ptr %call3, ptr %p, align 8, !tbaa !9
  call void @llvm.lifetime.start.p0(i64 8, ptr %r) #8
  %call4 = call ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8)
  store ptr %call4, ptr %r, align 8, !tbaa !9
  %0 = load i32, ptr %m, align 4, !tbaa !5
  %1 = load i32, ptr %n, align 4, !tbaa !5
  %2 = load ptr, ptr %A, align 8, !tbaa !9
  %arraydecay = getelementptr inbounds [2100 x [1900 x double]], ptr %2, i64 0, i64 0
  %3 = load ptr, ptr %r, align 8, !tbaa !9
  %arraydecay5 = getelementptr inbounds [2100 x double], ptr %3, i64 0, i64 0
  %4 = load ptr, ptr %p, align 8, !tbaa !9
  %arraydecay6 = getelementptr inbounds [1900 x double], ptr %4, i64 0, i64 0
  call void @init_array(i32 noundef %0, i32 noundef %1, ptr noundef %arraydecay, ptr noundef %arraydecay5, ptr noundef %arraydecay6)
  call void (...) @polybench_timer_start()
  %5 = load i32, ptr %m, align 4, !tbaa !5
  %6 = load i32, ptr %n, align 4, !tbaa !5
  %7 = load ptr, ptr %A, align 8, !tbaa !9
  %arraydecay7 = getelementptr inbounds [2100 x [1900 x double]], ptr %7, i64 0, i64 0
  %8 = load ptr, ptr %s, align 8, !tbaa !9
  %arraydecay8 = getelementptr inbounds [1900 x double], ptr %8, i64 0, i64 0
  %9 = load ptr, ptr %q, align 8, !tbaa !9
  %arraydecay9 = getelementptr inbounds [2100 x double], ptr %9, i64 0, i64 0
  %10 = load ptr, ptr %p, align 8, !tbaa !9
  %arraydecay10 = getelementptr inbounds [1900 x double], ptr %10, i64 0, i64 0
  %11 = load ptr, ptr %r, align 8, !tbaa !9
  %arraydecay11 = getelementptr inbounds [2100 x double], ptr %11, i64 0, i64 0
  call void @kernel_bicg(i32 noundef %5, i32 noundef %6, ptr noundef %arraydecay7, ptr noundef %arraydecay8, ptr noundef %arraydecay9, ptr noundef %arraydecay10, ptr noundef %arraydecay11)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arraydecay13 = getelementptr inbounds [1900 x double], ptr %17, i64 0, i64 0
  %18 = load ptr, ptr %q, align 8, !tbaa !9
  %arraydecay14 = getelementptr inbounds [2100 x double], ptr %18, i64 0, i64 0
  call void @print_array(i32 noundef %15, i32 noundef %16, ptr noundef %arraydecay13, ptr noundef %arraydecay14)
  br label %if.end
...
; Function Attrs: nounwind uwtable
define internal void @init_array(i32 noundef %m, i32 noundef %n, ptr noundef %A, ptr noundef %r, ptr noundef %p) #0 {
entry:
...
for.body5:                                        ; preds = %for.cond2
  ...
  store double %div9, ptr %arrayidx11, align 8, !tbaa !12
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond12

for.cond12:                                       ; preds = %for.inc24, %for.body5
  %15 = load i32, ptr %j, align 4, !tbaa !5
  %16 = load i32, ptr %m.addr, align 4, !tbaa !5
...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx21 = getelementptr inbounds [1900 x double], ptr %21, i64 %idxprom20
  %23 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom22 = sext i32 %23 to i64
  %arrayidx23 = getelementptr inbounds [1900 x double], ptr %arrayidx21, i64 0, i64 %idxprom22
...
for.body3:                                        ; preds = %for.cond1
  %7 = load ptr, ptr %q.addr, align 8, !tbaa !9
  %8 = load i32, ptr %i, align 4, !tbaa !5
...
for.cond6:                                        ; preds = %for.inc29, %for.body3
  %9 = load i32, ptr %j, align 4, !tbaa !5
  %10 = load i32, ptr %m.addr, align 4, !tbaa !5
  %cmp7 = icmp slt i32 %9, %10
  br i1 %cmp7, label %for.body8, label %for.end31

for.body8:                                        ; preds = %for.cond6
  %11 = load ptr, ptr %s.addr, align 8, !tbaa !9
  %12 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom9 = sext i32 %12 to i64
  %arrayidx10 = getelementptr inbounds double, ptr %11, i64 %idxprom9
  %13 = load double, ptr %arrayidx10, align 8, !tbaa !12
  %14 = load ptr, ptr %r.addr, align 8, !tbaa !9
  %15 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom11 = sext i32 %15 to i64
  %arrayidx12 = getelementptr inbounds double, ptr %14, i64 %idxprom11
  %16 = load double, ptr %arrayidx12, align 8, !tbaa !12
  %17 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %18 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom13 = sext i32 %18 to i64
  %arrayidx14 = getelementptr inbounds [1900 x double], ptr %17, i64 %idxprom13
  %19 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom15 = sext i32 %19 to i64
  %arrayidx16 = getelementptr inbounds [1900 x double], ptr %arrayidx14, i64 0, i64 %idxprom15
  %20 = load double, ptr %arrayidx16, align 8, !tbaa !12
  %21 = call double @llvm.fmuladd.f64(double %16, double %20, double %13)
  %22 = load ptr, ptr %s.addr, align 8, !tbaa !9
  %23 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom17 = sext i32 %23 to i64
  %arrayidx18 = getelementptr inbounds double, ptr %22, i64 %idxprom17
  store double %21, ptr %arrayidx18, align 8, !tbaa !12
  %24 = load ptr, ptr %q.addr, align 8, !tbaa !9
  %25 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom19 = sext i32 %25 to i64
  %arrayidx20 = getelementptr inbounds double, ptr %24, i64 %idxprom19
  %26 = load double, ptr %arrayidx20, align 8, !tbaa !12
  %27 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %28 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom21 = sext i32 %28 to i64
  %arrayidx22 = getelementptr inbounds [1900 x double], ptr %27, i64 %idxprom21
  %29 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom23 = sext i32 %29 to i64
  %arrayidx24 = getelementptr inbounds [1900 x double], ptr %arrayidx22, i64 0, i64 %idxprom23
  %30 = load double, ptr %arrayidx24, align 8, !tbaa !12
  %31 = load ptr, ptr %p.addr, align 8, !tbaa !9
  %32 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom25 = sext i32 %32 to i64
  %arrayidx26 = getelementptr inbounds double, ptr %31, i64 %idxprom25
  %33 = load double, ptr %arrayidx26, align 8, !tbaa !12
  %34 = call double @llvm.fmuladd.f64(double %30, double %33, double %26)
  %35 = load ptr, ptr %q.addr, align 8, !tbaa !9
  ...
  store double %34, ptr %arrayidx28, align 8, !tbaa !12
  br label %for.inc29

for.inc29:                                        ; preds = %for.body8
...
if.end:                                           ; preds = %if.then, %for.body
  %6 = load ptr, ptr @stderr, align 8, !tbaa !24
  %7 = load ptr, ptr %s.addr, align 8, !tbaa !9
  %8 = load i32, ptr %i, align 4, !tbaa !5
...
if.end14:                                         ; preds = %if.then12, %for.body9
  ...
  %18 = load ptr, ptr %q.addr, align 8, !tbaa !9
