...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call4, ptr nofree noundef writeonly captures(none) %call3) #13
  unreachable
}
