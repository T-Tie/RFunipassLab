...
if.then.i:                                        ; preds = %entry
  call void @outlined_ir_func_0.2() #16
...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 3990000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1900, i32 noundef 8) #16
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #16
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1900, i32 noundef 8) #16
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #16
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call4, ptr nofree noundef writeonly captures(none) %call3) #18
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %r, ptr nofree noundef writeonly captures(none) %p) unnamed_addr #8 {
entry:
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %exitcond.not, label %for.body5, label %for.inc

for.inc:                                          ; preds = %for.cond
  %0 = trunc nuw nsw i64 %indvars.iv to i32
  %conv = uitofp nneg i32 %0 to double
  %div = fdiv double %conv, 1.900000e+03
  %arrayidx = getelementptr inbounds nuw double, ptr %p, i64 %indvars.iv
  store double %div, ptr %arrayidx, align 8, !tbaa !11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !15

for.body5:                                        ; preds = %for.cond, %for.end26
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.end26 ], [ 0, %for.cond ]
  store double 0.000000e+00, ptr %r, align 8, !tbaa !11
  br label %for.cond12

for.cond12:                                       ; preds = %for.inc24, %for.body5
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc24 ], [ 0, %for.body5 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, 1900
  br i1 %exitcond15.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond12
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %1 = mul nuw nsw i64 %indvars.iv.next12, %indvars.iv16
  %2 = trunc nuw i64 %1 to i32
  %rem16 = urem i32 %2, 2100
  %conv17 = uitofp nneg i32 %rem16 to double
  %div19 = fdiv double %conv17, 2.100000e+03
  %arrayidx23 = getelementptr inbounds nuw [1900 x double], ptr %A, i64 %indvars.iv16, i64 %indvars.iv11
  store double %div19, ptr %arrayidx23, align 8, !tbaa !11
...
define internal void @outlined_ir_func_0.2() #10 {
