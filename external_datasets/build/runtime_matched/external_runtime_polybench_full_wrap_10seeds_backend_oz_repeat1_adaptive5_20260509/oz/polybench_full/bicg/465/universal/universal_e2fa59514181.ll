...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call4, ptr nofree noundef writeonly captures(none) %call3) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %r, ptr nofree noundef writeonly captures(none) %p) unnamed_addr #12 {
entry:
  br label %for.cond
...
for.cond2:                                        ; preds = %for.cond, %for.end26
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.end26 ], [ 0, %for.cond ]
  store double 0.000000e+00, ptr %r, align 8, !tbaa !11
  br label %for.cond12

for.cond12:                                       ; preds = %for.body15, %for.cond2
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.body15 ], [ 0, %for.cond2 ]
  %exitcond15.not = icmp eq i64 %indvars.iv11, 1900
  br i1 %exitcond15.not, label %for.end26, label %for.body15
