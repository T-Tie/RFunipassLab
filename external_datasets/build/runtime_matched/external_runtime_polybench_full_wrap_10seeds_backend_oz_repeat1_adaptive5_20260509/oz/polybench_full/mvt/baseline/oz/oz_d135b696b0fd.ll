...
for.cond.i:                                       ; preds = %for.cond22.i, %entry
  %indvars.iv28.i = phi i64 [ 0, %entry ], [ %indvars.iv.next29.i, %for.cond22.i ]
  %exitcond31.not.i = icmp eq i64 %indvars.iv28.i, 2000
  br i1 %exitcond31.not.i, label %init_array.exit, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i
  %0 = trunc nuw nsw i64 %indvars.iv28.i to i32
  %conv.i = uitofp nneg i32 %0 to double
  %div.i = fdiv double %conv.i, 2.000000e+03
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv28.i
  store double %div.i, ptr %arrayidx.i, align 8, !tbaa !5
  %indvars.iv.next29.i = add nuw nsw i64 %indvars.iv28.i, 1
  %1 = icmp eq i64 %indvars.iv.next29.i, 2000
  %2 = trunc nuw nsw i64 %indvars.iv.next29.i to i32
  %3 = uitofp nneg i32 %2 to double
  %4 = fdiv double %3, 2.000000e+03
  %div5.i = select i1 %1, double 0.000000e+00, double %4
  %arrayidx7.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv28.i
  store double %div5.i, ptr %arrayidx7.i, align 8, !tbaa !5
  %rem9.cmp.i = icmp samesign ult i64 %indvars.iv28.i, 1997
  %rem9.v.i = select i1 %rem9.cmp.i, i32 3, i32 -1997
  %rem9.i = add nsw i32 %rem9.v.i, %0
  %conv10.i = uitofp nneg i32 %rem9.i to double
  %div12.i = fdiv double %conv10.i, 2.000000e+03
  %arrayidx14.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv28.i
  store double %div12.i, ptr %arrayidx14.i, align 8, !tbaa !5
  %rem16.cmp.i = icmp samesign ult i64 %indvars.iv28.i, 1996
  %rem16.v.i = select i1 %rem16.cmp.i, i32 4, i32 -1996
  %rem16.i = add nsw i32 %rem16.v.i, %0
  %conv17.i = uitofp nneg i32 %rem16.i to double
  %div19.i = fdiv double %conv17.i, 2.000000e+03
  %arrayidx21.i = getelementptr inbounds nuw double, ptr %call4, i64 %indvars.iv28.i
  store double %div19.i, ptr %arrayidx21.i, align 8, !tbaa !5
  br label %for.cond22.i

for.cond22.i:                                     ; preds = %for.body25.i, %for.body.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body25.i ], [ 0, %for.body.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, 2000
  br i1 %exitcond.not.i, label %for.cond.i, label %for.body25.i, !llvm.loop !17

for.body25.i:                                     ; preds = %for.cond22.i
  %5 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv28.i
  %6 = trunc nuw nsw i64 %5 to i32
  %rem26.i = urem i32 %6, 2000
  %conv27.i = uitofp nneg i32 %rem26.i to double
  %div29.i = fdiv double %conv27.i, 2.000000e+03
  %arrayidx33.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv28.i, i64 %indvars.iv.i
  store double %div29.i, ptr %arrayidx33.i, align 8, !tbaa !5
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond22.i, !llvm.loop !19
...
for.cond.i15:                                     ; preds = %for.inc12.i, %init_array.exit
  %indvars.iv24.i = phi i64 [ %indvars.iv.next25.i, %for.inc12.i ], [ 0, %init_array.exit ]
  %exitcond27.not.i = icmp eq i64 %indvars.iv24.i, 2000
  br i1 %exitcond27.not.i, label %for.cond15.i, label %for.cond1.preheader.i

for.cond1.preheader.i:                            ; preds = %for.cond.i15
  %arrayidx.i16 = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv24.i
  %arrayidx.promoted.i = load double, ptr %arrayidx.i16, align 8, !tbaa !5
  br label %for.cond1.i

for.cond1.i:                                      ; preds = %for.body3.i, %for.cond1.preheader.i
  %indvars.iv.i17 = phi i64 [ 0, %for.cond1.preheader.i ], [ %indvars.iv.next.i20, %for.body3.i ]
  %7 = phi double [ %arrayidx.promoted.i, %for.cond1.preheader.i ], [ %10, %for.body3.i ]
  %exitcond.not.i18 = icmp eq i64 %indvars.iv.i17, 2000
  br i1 %exitcond.not.i18, label %for.inc12.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx7.i19 = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv24.i, i64 %indvars.iv.i17
  %8 = load double, ptr %arrayidx7.i19, align 8, !tbaa !5
  %arrayidx9.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv.i17
  %9 = load double, ptr %arrayidx9.i, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %8, double %9, double %7)
  store double %10, ptr %arrayidx.i16, align 8, !tbaa !5
...
for.cond15.i:                                     ; preds = %for.cond.i15, %for.inc34.i
  %indvars.iv32.i = phi i64 [ %indvars.iv.next33.i, %for.inc34.i ], [ 0, %for.cond.i15 ]
  %exitcond35.not.i = icmp eq i64 %indvars.iv32.i, 2000
  br i1 %exitcond35.not.i, label %kernel_mvt.exit, label %for.cond18.preheader.i

for.cond18.preheader.i:                           ; preds = %for.cond15.i
  %arrayidx22.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv32.i
  %arrayidx22.promoted.i = load double, ptr %arrayidx22.i, align 8, !tbaa !5
  br label %for.cond18.i

for.cond18.i:                                     ; preds = %for.body20.i, %for.cond18.preheader.i
  %indvars.iv28.i21 = phi i64 [ 0, %for.cond18.preheader.i ], [ %indvars.iv.next29.i23, %for.body20.i ]
  %11 = phi double [ %arrayidx22.promoted.i, %for.cond18.preheader.i ], [ %14, %for.body20.i ]
  %exitcond31.not.i22 = icmp eq i64 %indvars.iv28.i21, 2000
  br i1 %exitcond31.not.i22, label %for.inc34.i, label %for.body20.i

for.body20.i:                                     ; preds = %for.cond18.i
  %arrayidx26.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv28.i21, i64 %indvars.iv32.i
  %12 = load double, ptr %arrayidx26.i, align 8, !tbaa !5
  %arrayidx28.i = getelementptr inbounds nuw double, ptr %call4, i64 %indvars.iv28.i21
  %13 = load double, ptr %arrayidx28.i, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %12, double %13, double %11)
  store double %14, ptr %arrayidx22.i, align 8, !tbaa !5
  %indvars.iv.next29.i23 = add nuw nsw i64 %indvars.iv28.i21, 1
  br label %for.cond18.i, !llvm.loop !22

for.inc34.i:                                      ; preds = %for.cond18.i
  %indvars.iv.next33.i = add nuw nsw i64 %indvars.iv32.i, 1
  br label %for.cond15.i, !llvm.loop !23

kernel_mvt.exit:                                  ; preds = %for.cond15.i
...
land.lhs.true:                                    ; preds = %kernel_mvt.exit
  %15 = load ptr, ptr %argv, align 8, !tbaa !24
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_mvt.exit
...
for.cond7:                                        ; preds = %if.end14, %for.end
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %if.end14 ], [ 0, %for.end ]
  %exitcond17.not = icmp eq i64 %indvars.iv14, 2000
  br i1 %exitcond17.not, label %for.end20, label %for.body9
...
if.end14:                                         ; preds = %if.then12, %for.body9
  ...
  %arrayidx16 = getelementptr inbounds nuw double, ptr %x2, i64 %indvars.iv14
