...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call1, ptr nofree noundef writeonly captures(none) %call2, ptr nofree noundef writeonly captures(none) %call3, ptr nofree noundef writeonly captures(none) %call4, ptr nofree noundef writeonly captures(none) %call) #13
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) initializes((0, 8)) %x1, ptr nofree noundef writeonly captures(none) initializes((0, 8)) %x2, ptr nofree noundef writeonly captures(none) initializes((0, 8)) %y_1, ptr nofree noundef writeonly captures(none) initializes((0, 8)) %y_2, ptr nofree noundef writeonly captures(none) %A) unnamed_addr #8 {
entry:
  br label %for.body
