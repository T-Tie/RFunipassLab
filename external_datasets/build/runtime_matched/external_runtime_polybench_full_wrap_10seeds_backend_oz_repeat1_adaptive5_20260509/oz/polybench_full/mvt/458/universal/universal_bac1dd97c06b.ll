...
if.then.i:                                        ; preds = %entry
  ...
  %2 = call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %1) #14
...
for.body:                                         ; preds = %entry, %for.end
  %indvars.iv17 = phi i64 [ 0, %entry ], [ %indvars.iv.next18, %for.end ]
...
for.inc:                                          ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv17, i64 %indvars.iv
