...
if.then.i:                                        ; preds = %entry
  ...
  %2 = call i64 @fwrite(ptr nonnull @.str.4, i64 50, i64 1, ptr %1) #19
...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call1, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call2, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call3, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call4, ptr nofree noundef writeonly captures(none) %call) #21
  unreachable
}
...
for.cond22:                                       ; preds = %for.body25, %for.cond
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body25 ], [ 0, %for.cond ]
