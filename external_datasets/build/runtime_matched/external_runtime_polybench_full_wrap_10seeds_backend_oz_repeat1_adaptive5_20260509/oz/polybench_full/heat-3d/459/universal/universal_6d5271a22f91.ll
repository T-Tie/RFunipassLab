...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #14
  unreachable
}
...
for.body:                                         ; preds = %entry, %for.end21
  %indvars.iv17 = phi i64 [ 0, %entry ], [ %indvars.iv.next18, %for.end21 ]
  %0 = trunc i64 %indvars.iv17 to i32
  %1 = add i32 %0, 120
  br label %for.cond1

for.cond1:                                        ; preds = %for.inc19, %for.body
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc19 ], [ 0, %for.body ]
  %exitcond16.not = icmp eq i64 %indvars.iv13, 120
  br i1 %exitcond16.not, label %for.end21, label %for.cond4.preheader
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx12 = getelementptr inbounds nuw [120 x [120 x double]], ptr %B, i64 %indvars.iv17, i64 %indvars.iv13, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !5
  %arrayidx18 = getelementptr inbounds nuw [120 x [120 x double]], ptr %A, i64 %indvars.iv17, i64 %indvars.iv13, i64 %indvars.iv
  store double %div, ptr %arrayidx18, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
