...
for.body.i:                                       ; preds = %for.cond8.i, %entry
  br label %for.cond8.i

for.cond8.i:                                      ; preds = %for.body11.i, %for.body.i
  %indvars.iv.i = phi i64 [ 1, %for.body.i ], [ %indvars.iv.next.i, %for.body11.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, 2000
  br i1 %exitcond.not.i, label %for.body.i, label %for.body11.i

for.body11.i:                                     ; preds = %for.cond8.i
  %arrayidx15.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 0, i64 %indvars.iv.i
  store double 0.000000e+00, ptr %arrayidx15.i, align 8, !tbaa !11
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond8.i
}

; Function Attrs: cold minsize nofree nounwind optsize memory(readwrite, argmem: none) uwtable
define internal fastcc void @outlined_ir_func_0() unnamed_addr #11 {
...
attributes #17 = { cold nofree noreturn nounwind }
