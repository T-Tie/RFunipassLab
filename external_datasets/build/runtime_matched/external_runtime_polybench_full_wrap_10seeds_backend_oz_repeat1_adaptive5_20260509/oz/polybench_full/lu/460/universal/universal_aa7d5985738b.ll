...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call) #18
  unreachable
}
...
for.body:                                         ; preds = %entry, %for.end18
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6, %for.end18 ]
  br label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv5, i64 %j.0
...
for.cond8:                                        ; preds = %for.cond1, %for.inc16
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc16 ], [ 1, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, 2000
  br i1 %exitcond.not, label %for.end18, label %for.inc16

for.inc16:                                        ; preds = %for.cond8
  %arrayidx15 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv5, i64 %indvars.iv
...
define internal void @outlined_ir_func_0() #10 {
