...
for.cond.i7:                                      ; preds = %for.inc53.i, %init_array.exit
  %indvars.iv46.i = phi i64 [ %indvars.iv.next47.i, %for.inc53.i ], [ 0, %init_array.exit ]
  %exitcond53.not.i = icmp eq i64 %indvars.iv46.i, 2000
  br i1 %exitcond53.not.i, label %kernel_lu.exit, label %for.cond1.i8

for.cond1.i8:                                     ; preds = %for.cond.i7, %for.end.i
  %indvars.iv37.i = phi i64 [ %indvars.iv.next38.i, %for.end.i ], [ 0, %for.cond.i7 ]
  %exitcond41.not.i = icmp eq i64 %indvars.iv37.i, %indvars.iv46.i
  br i1 %exitcond41.not.i, label %for.cond28.i, label %for.cond4.preheader.i

for.cond4.preheader.i:                            ; preds = %for.cond1.i8
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv46.i, i64 %indvars.iv37.i
...
for.cond4.i:                                      ; preds = %for.body6.i, %for.cond4.preheader.i
  ...
  %exitcond.not.i = icmp eq i64 %indvars.iv.i9, %indvars.iv37.i
  br i1 %exitcond.not.i, label %for.end.i, label %for.body6.i

for.body6.i:                                      ; preds = %for.cond4.i
  %arrayidx8.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv46.i, i64 %indvars.iv.i9
  %7 = load double, ptr %arrayidx8.i, align 8, !tbaa !5
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i9, i64 %indvars.iv37.i
...
for.end.i:                                        ; preds = %for.cond4.i
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv37.i, i64 %indvars.iv37.i
...
for.cond28.i:                                     ; preds = %for.cond1.i8, %for.inc50.i
  %indvars.iv48.i = phi i64 [ %indvars.iv.next49.i, %for.inc50.i ], [ %indvars.iv46.i, %for.cond1.i8 ]
  %exitcond51.not.i = icmp eq i64 %indvars.iv48.i, 2000
  br i1 %exitcond51.not.i, label %for.inc53.i, label %for.cond31.preheader.i

for.cond31.preheader.i:                           ; preds = %for.cond28.i
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv46.i, i64 %indvars.iv48.i
  br label %for.cond31.i

for.cond31.i:                                     ; preds = %for.body33.i12, %for.cond31.preheader.i
  %indvars.iv42.i = phi i64 [ 0, %for.cond31.preheader.i ], [ %indvars.iv.next43.i, %for.body33.i12 ]
  %exitcond45.not.i = icmp eq i64 %indvars.iv42.i, %indvars.iv46.i
  br i1 %exitcond45.not.i, label %for.inc50.i, label %for.body33.i12

for.body33.i12:                                   ; preds = %for.cond31.i
  %arrayidx37.i13 = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv46.i, i64 %indvars.iv42.i
  %13 = load double, ptr %arrayidx37.i13, align 8, !tbaa !5
  %arrayidx41.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv42.i, i64 %indvars.iv48.i
  %14 = load double, ptr %arrayidx41.i, align 8, !tbaa !5
  %15 = load double, ptr %arrayidx45.i, align 8, !tbaa !5
  %neg46.i = fneg double %13
  %16 = tail call double @llvm.fmuladd.f64(double %neg46.i, double %14, double %15)
  store double %16, ptr %arrayidx45.i, align 8, !tbaa !5
...
for.inc53.i:                                      ; preds = %for.cond28.i
  %indvars.iv.next47.i = add nuw nsw i64 %indvars.iv46.i, 1
  br label %for.cond.i7, !llvm.loop !32

kernel_lu.exit:                                   ; preds = %for.cond.i7
...
land.lhs.true:                                    ; preds = %kernel_lu.exit
  %17 = load ptr, ptr %argv, align 8, !tbaa !33
