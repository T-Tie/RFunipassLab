...
for.cond.i:                                       ; preds = %for.end18.i, %entry
  %indvars.iv61.i = phi i64 [ %indvars.iv.next62.i, %for.end18.i ], [ 1, %entry ]
  %indvars.iv55.i = phi i64 [ %indvars.iv.next56.i, %for.end18.i ], [ 0, %entry ]
...
for.cond8.i:                                      ; preds = %for.cond1.i, %for.body11.i
  ...
  br i1 %exitcond60.not.i, label %for.end18.i, label %for.body11.i
...
for.inc41.i:                                      ; preds = %for.cond30.i
  ...
  br label %for.cond26.i, !llvm.loop !20
...
for.cond52.preheader.i:                           ; preds = %for.cond48.i
  ...
  %2 = load double, ptr %arrayidx59.i, align 8, !tbaa !5, !invariant.load !21
...
for.inc68.i:                                      ; preds = %for.cond52.i
  ...
  %3 = load double, ptr %arrayidx63.i, align 8, !tbaa !5, !invariant.load !21
  %arrayidx67.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv79.i, i64 %indvars.iv75.i
  %4 = load double, ptr %arrayidx67.i, align 8, !tbaa !5, !invariant.load !21
  ...
  br label %for.cond52.i, !llvm.loop !22

for.inc71.i:                                      ; preds = %for.cond52.i
  %indvars.iv.next80.i = add nuw nsw i64 %indvars.iv79.i, 1
  br label %for.cond48.i, !llvm.loop !23
...
for.inc93.i:                                      ; preds = %for.cond81.i
  ...
  %6 = load double, ptr %arrayidx88.i, align 8, !tbaa !5, !invariant.load !21
  ...
  br label %for.cond81.i, !llvm.loop !25

for.inc96.i:                                      ; preds = %for.cond81.i
  %indvars.iv.next92.i = add nuw nsw i64 %indvars.iv91.i, 1
  br label %for.cond77.i, !llvm.loop !26

init_array.exit:                                  ; preds = %for.cond77.i
  tail call void @free(ptr noundef %call.i) #22
  %call.i14 = tail call fastcc double @rtclock() #14
  store double %call.i14, ptr @polybench_t_start, align 8, !tbaa !5
  br label %for.cond.i4

for.cond.i4:                                      ; preds = %for.end52.i, %init_array.exit
  %indvars.iv39.i = phi i64 [ %indvars.iv.next40.i, %for.end52.i ], [ 0, %init_array.exit ]
  %exitcond46.not.i = icmp eq i64 %indvars.iv39.i, 2000
  br i1 %exitcond46.not.i, label %kernel_lu.exit, label %for.cond1.i5

for.cond1.i5:                                     ; preds = %for.cond.i4, %for.end.i
  %indvars.iv30.i = phi i64 [ %indvars.iv.next31.i, %for.end.i ], [ 0, %for.cond.i4 ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv30.i, %indvars.iv39.i
  br i1 %exitcond34.not.i, label %for.cond28.i, label %for.cond4.preheader.i
...
for.cond4.preheader.i:                            ; preds = %for.cond1.i5
  ...
  %7 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !21
...
for.cond4.i:                                      ; preds = %for.inc.i7, %for.cond4.preheader.i
  ...
  br i1 %exitcond.not.i, label %for.end.i, label %for.inc.i7
...
for.inc.i7:                                       ; preds = %for.cond4.i
  ...
  %8 = load double, ptr %arrayidx8.i, align 8, !tbaa !5, !invariant.load !21
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i6, i64 %indvars.iv30.i
  %9 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !21
  %neg.i = fneg double %8
  %10 = tail call double @llvm.fmuladd.f64(double %neg.i, double %9, double %7) #23
...
for.end.i:                                        ; preds = %for.cond4.i
  ...
  %div.i9 = fdiv double %7, %11
  store double %div.i9, ptr %arrayidx16.i, align 8, !tbaa !5
  %indvars.iv.next31.i = add nuw nsw i64 %indvars.iv30.i, 1
  br label %for.cond1.i5

for.cond28.i:                                     ; preds = %for.cond1.i5, %for.inc50.i
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %for.inc50.i ], [ %indvars.iv39.i, %for.cond1.i5 ]
  %exitcond44.not.i = icmp eq i64 %indvars.iv41.i, 2000
  br i1 %exitcond44.not.i, label %for.end52.i, label %for.cond31.preheader.i

for.cond31.preheader.i:                           ; preds = %for.cond28.i
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv39.i, i64 %indvars.iv41.i
  br label %for.cond31.i

for.cond31.i:                                     ; preds = %for.inc47.i, %for.cond31.preheader.i
  %indvars.iv35.i = phi i64 [ 0, %for.cond31.preheader.i ], [ %indvars.iv.next36.i, %for.inc47.i ]
  %exitcond38.not.i = icmp eq i64 %indvars.iv35.i, %indvars.iv39.i
  br i1 %exitcond38.not.i, label %for.inc50.i, label %for.inc47.i

for.inc47.i:                                      ; preds = %for.cond31.i
  %arrayidx37.i10 = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv39.i, i64 %indvars.iv35.i
  %12 = load double, ptr %arrayidx37.i10, align 8, !tbaa !5, !invariant.load !21
  %arrayidx41.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv35.i, i64 %indvars.iv41.i
  %13 = load double, ptr %arrayidx41.i, align 8, !tbaa !5, !invariant.load !21
  %14 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !21
  %neg46.i = fneg double %12
  %15 = tail call double @llvm.fmuladd.f64(double %neg46.i, double %13, double %14) #23
  store double %15, ptr %arrayidx45.i, align 8, !tbaa !5
  %indvars.iv.next36.i = add nuw nsw i64 %indvars.iv35.i, 1
  br label %for.cond31.i, !llvm.loop !28

for.inc50.i:                                      ; preds = %for.cond31.i
  %indvars.iv.next42.i = add nuw nsw i64 %indvars.iv41.i, 1
  br label %for.cond28.i, !llvm.loop !29

for.end52.i:                                      ; preds = %for.cond28.i
  %indvars.iv.next40.i = add nuw nsw i64 %indvars.iv39.i, 1
  br label %for.cond.i4

kernel_lu.exit:                                   ; preds = %for.cond.i4
  %call.i15 = tail call fastcc double @rtclock() #14
...
land.lhs.true:                                    ; preds = %kernel_lu.exit
  %16 = load ptr, ptr %argv, align 8, !tbaa !30, !invariant.load !21
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_lu.exit
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv11, i64 %indvars.iv
  %6 = load double, ptr %arrayidx8, align 8, !tbaa !5, !invariant.load !21
