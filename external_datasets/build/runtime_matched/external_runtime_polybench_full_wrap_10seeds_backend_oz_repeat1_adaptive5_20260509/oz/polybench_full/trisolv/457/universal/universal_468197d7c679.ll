...
rtclock.exit:                                     ; preds = %entry, %if.then.i
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %conv2.i, double noundef 0x3EB0C6F7A0B5ED8D, double %conv.i) #14
...
entry:
  tail call void @free(ptr noundef captures(none) %ptr) #15
  ret void
}
...
if.then.i:                                        ; preds = %entry
  call fastcc void @outlined_ir_func_1() #12
...
attributes #16 = { cold nofree noreturn nounwind }
