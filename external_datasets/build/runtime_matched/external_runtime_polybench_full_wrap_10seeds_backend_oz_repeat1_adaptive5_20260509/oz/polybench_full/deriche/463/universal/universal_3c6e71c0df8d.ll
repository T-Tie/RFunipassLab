...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 captures(none) dereferenceable(4) %alpha) #16
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %imgIn) #16
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %imgIn) #14
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %imgOut) #14
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %imgOut) #14
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %y1) #14
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %y1) #14
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %y2) #14
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %y2) #14
  %0 = load ptr, ptr %imgIn, align 8, !tbaa !15
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) %alpha, ptr nofree noundef writeonly captures(none) %0) #17
  tail call void @polybench_timer_start() #12
  unreachable
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 4 captures(none) dereferenceable(4) initializes((0, 4)) %alpha, ptr nofree noundef writeonly captures(none) %imgIn) unnamed_addr #8 {
entry:
  store float 2.500000e-01, ptr %alpha, align 4, !tbaa !17
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.end ], [ 0, %entry ]
  %exitcond10.not = icmp eq i64 %indvars.iv6, 4096
  br i1 %exitcond10.not, label %for.end9, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %for.cond
  %0 = mul nuw nsw i64 %indvars.iv6, 313
  br label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [2160 x float], ptr %imgIn, i64 %indvars.iv6, i64 %indvars.iv
  store float %div, ptr %arrayidx6, align 4, !tbaa !17
...
define internal fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) unnamed_addr #10 {
entry_after_outline.exitStub:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #14
  store ptr %call, ptr %0, align 8, !tbaa !15
  ret void
}
...
attributes #10 = { minsize nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
