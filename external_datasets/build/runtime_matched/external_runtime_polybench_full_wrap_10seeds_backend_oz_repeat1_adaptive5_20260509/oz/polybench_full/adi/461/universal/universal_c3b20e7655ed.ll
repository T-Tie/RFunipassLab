...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %u) #21
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %u) #14
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %v) #14
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %v) #14
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %p) #14
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %p) #14
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %q) #14
  call void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %q) #14
  %0 = load ptr, ptr %u, align 8, !tbaa !17
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %0) #22
  unreachable
}
...
for.inc:                                          ; preds = %for.cond1
  ...
  %conv = uitofp nneg i32 %2 to double
  %div = fdiv double %conv, 1.000000e+03
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %u, i64 %indvars.iv8, i64 %indvars.iv
...
define internal void @outlined_ir_func_0(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) #13 {
entry_after_outline.exitStub:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #14
  store ptr %call, ptr %0, align 8, !tbaa !17
  ret void
}
...
attributes #13 = { minsize nofree nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
