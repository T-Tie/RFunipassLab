...
if.then.i:                                        ; preds = %entry
  call fastcc void @outlined_ir_func_1() #17
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %u) #19
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %u) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %v) #17
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %v) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %p) #17
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %p) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %q) #17
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %q) #17
  %0 = load ptr, ptr %u, align 8, !tbaa !15
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %0) #20
  unreachable
}
...
define internal fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) unnamed_addr #11 {
entry_after_outline.exitStub:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #17
...
attributes #11 = { minsize nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #19 = { nofree nounwind willreturn }
