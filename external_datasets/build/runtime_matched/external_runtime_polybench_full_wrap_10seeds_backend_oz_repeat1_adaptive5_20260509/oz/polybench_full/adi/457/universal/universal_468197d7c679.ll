...
define dso_local void @polybench_prepare_instruments() local_unnamed_addr #4 {
entry:
  unreachable
}
...
rtclock.exit:                                     ; preds = %entry, %if.then.i
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %conv2.i, double noundef 0x3EB0C6F7A0B5ED8D, double %conv.i) #17
...
; Function Attrs: nofree nounwind uwtable
define dso_local nonnull ptr @polybench_alloc_data(i64 noundef %n, i32 noundef %elt_size) local_unnamed_addr #7 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %u) #20
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %u) #15
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %v) #15
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %v) #15
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %p) #15
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %p) #15
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %q) #15
  call fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %q) #15
  %0 = load ptr, ptr %u, align 8, !tbaa !15
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %0) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %u) unnamed_addr #11 {
entry:
  br label %for.body

for.body:                                         ; preds = %for.cond1, %entry
  br label %for.cond1

for.cond1:                                        ; preds = %for.inc, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.body ]
  %exitcond.not = icmp eq i64 %indvars.iv, 1000
  br i1 %exitcond.not, label %for.body, label %for.inc
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %u, i64 0, i64 %indvars.iv
...
if.then_after_outline.exitStub:
  ...
  %1 = tail call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %0) #22
  ret void
}

; Function Attrs: minsize nofree nounwind optsize uwtable
define internal fastcc void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) unnamed_addr #14 {
entry_after_outline.exitStub:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
...
attributes #14 = { minsize nofree nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #20 = { nofree nounwind willreturn }
