...
entry:
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !16
  %call.i3 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !19
  %call.i4 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !22
  %call.i5 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !25
  br label %for.cond.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  br label %for.cond1.i, !llvm.loop !28
...
init_array.exit:                                  ; preds = %for.cond.i
  ...
  %arrayidx85.i = getelementptr inbounds nuw i8, ptr %call.i3, i64 7992000
  %invariant.gep.i = getelementptr inbounds nuw i8, ptr %call.i3, i64 8000
  %invariant.gep98.i = getelementptr i8, ptr %call.i3, i64 -8000
  br label %for.cond.i6

for.cond.i6:                                      ; preds = %for.end224.i, %init_array.exit
  %t.0.i = phi i32 [ 1, %init_array.exit ], [ %inc.i1.i, %for.end224.i ]
  %exitcond124.not.i = icmp eq i32 %t.0.i, 501
  br i1 %exitcond124.not.i, label %kernel_adi.exit, label %for.cond15.i

for.cond15.i:                                     ; preds = %for.cond89.i, %for.cond.i6
  %indvars.iv106.i = phi i64 [ 1, %for.cond.i6 ], [ %indvars.iv.next107.i, %for.cond89.i ]
  %exitcond110.not.i = icmp eq i64 %indvars.iv106.i, 999
  br i1 %exitcond110.not.i, label %for.cond116.i, label %for.body18.i

for.body18.i:                                     ; preds = %for.cond15.i
  %arrayidx19.i = getelementptr inbounds nuw [1000 x double], ptr %call.i3, i64 0, i64 %indvars.iv106.i
  store double 1.000000e+00, ptr %arrayidx19.i, align 8, !tbaa !5
  %arrayidx21.i = getelementptr inbounds nuw [1000 x double], ptr %call.i4, i64 %indvars.iv106.i
  store double 0.000000e+00, ptr %arrayidx21.i, align 8, !tbaa !5
  %arrayidx27.i = getelementptr inbounds nuw [1000 x double], ptr %call.i5, i64 %indvars.iv106.i
  store double 1.000000e+00, ptr %arrayidx27.i, align 8, !tbaa !5
  %3 = add nsw i64 %indvars.iv106.i, -1
  %indvars.iv.next107.i = add nuw nsw i64 %indvars.iv106.i, 1
  br label %for.cond29.i

for.cond29.i:                                     ; preds = %for.inc.i9, %for.body18.i
  %indvars.iv.i7 = phi i64 [ %indvars.iv.next.i10, %for.inc.i9 ], [ 1, %for.body18.i ]
  %exitcond.not.i8 = icmp eq i64 %indvars.iv.i7, 999
  br i1 %exitcond.not.i8, label %for.end.i11, label %for.inc.i9

for.inc.i9:                                       ; preds = %for.cond29.i
  %4 = add nsw i64 %indvars.iv.i7, -1
  %arrayidx39.i = getelementptr inbounds [1000 x double], ptr %call.i4, i64 %indvars.iv106.i, i64 %4
  %5 = load double, ptr %arrayidx39.i, align 8, !tbaa !5, !invariant.load !9
  %6 = tail call double @llvm.fmuladd.f64(double %5, double 0xC09F400000000001, double 0x40AF420000000001) #16
  %div41.i = fdiv double 0x409F400000000001, %6
  %arrayidx45.i = getelementptr inbounds nuw [1000 x double], ptr %call.i4, i64 %indvars.iv106.i, i64 %indvars.iv.i7
  store double %div41.i, ptr %arrayidx45.i, align 8, !tbaa !5
  %arrayidx51.i = getelementptr inbounds [1000 x double], ptr %call.i, i64 %indvars.iv.i7, i64 %3
  %7 = load double, ptr %arrayidx51.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx57.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv.i7, i64 %indvars.iv106.i
  %8 = load double, ptr %arrayidx57.i, align 8, !tbaa !5, !invariant.load !9
  %mul58.i = fmul double %8, 0xC09F3C0000000001
  %9 = tail call double @llvm.fmuladd.f64(double %7, double 0x408F400000000001, double %mul58.i) #16
  %arrayidx63.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv.i7, i64 %indvars.iv.next107.i
  %10 = load double, ptr %arrayidx63.i, align 8, !tbaa !5, !invariant.load !9
  %11 = tail call double @llvm.fmuladd.f64(double %10, double 0x408F400000000001, double %9) #16
  %arrayidx69.i = getelementptr inbounds [1000 x double], ptr %call.i5, i64 %indvars.iv106.i, i64 %4
  %12 = load double, ptr %arrayidx69.i, align 8, !tbaa !5, !invariant.load !9
  %13 = tail call double @llvm.fmuladd.f64(double %12, double 0x409F400000000001, double %11) #16
  %div78.i = fdiv double %13, %6
  %arrayidx82.i = getelementptr inbounds nuw [1000 x double], ptr %call.i5, i64 %indvars.iv106.i, i64 %indvars.iv.i7
...
for.end.i11:                                      ; preds = %for.cond29.i
  %arrayidx87.i = getelementptr inbounds nuw [1000 x double], ptr %arrayidx85.i, i64 0, i64 %indvars.iv106.i
  store double 1.000000e+00, ptr %arrayidx87.i, align 8, !tbaa !5
  %invariant.gep96.i = getelementptr inbounds nuw [1000 x double], ptr %invariant.gep.i, i64 0, i64 %indvars.iv106.i
  br label %for.cond89.i

for.cond89.i:                                     ; preds = %for.inc111.i, %for.end.i11
  %indvars.iv103.i = phi i64 [ %indvars.iv.next104.i, %for.inc111.i ], [ 998, %for.end.i11 ]
  %cmp90.not.i = icmp eq i64 %indvars.iv103.i, 0
  br i1 %cmp90.not.i, label %for.cond15.i, label %for.inc111.i

for.inc111.i:                                     ; preds = %for.cond89.i
  %arrayidx96.i = getelementptr inbounds nuw [1000 x double], ptr %call.i4, i64 %indvars.iv106.i, i64 %indvars.iv103.i
  %14 = load double, ptr %arrayidx96.i, align 8, !tbaa !5, !invariant.load !9
  %gep97.i = getelementptr inbounds nuw [1000 x double], ptr %invariant.gep96.i, i64 %indvars.iv103.i
  %15 = load double, ptr %gep97.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx106.i = getelementptr inbounds nuw [1000 x double], ptr %call.i5, i64 %indvars.iv106.i, i64 %indvars.iv103.i
  %16 = load double, ptr %arrayidx106.i, align 8, !tbaa !5, !invariant.load !9
  %17 = tail call double @llvm.fmuladd.f64(double %14, double %15, double %16) #16
  %arrayidx110.i = getelementptr inbounds nuw [1000 x double], ptr %call.i3, i64 %indvars.iv103.i, i64 %indvars.iv106.i
  store double %17, ptr %arrayidx110.i, align 8, !tbaa !5
...
for.cond116.i:                                    ; preds = %for.cond15.i, %for.inc222.i
  %indvars.iv120.i = phi i64 [ %indvars.iv.next121.i, %for.inc222.i ], [ 1, %for.cond15.i ]
  %exitcond123.not.i = icmp eq i64 %indvars.iv120.i, 999
  br i1 %exitcond123.not.i, label %for.end224.i, label %for.body120.i

for.body120.i:                                    ; preds = %for.cond116.i
  %arrayidx122.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv120.i
  store double 1.000000e+00, ptr %arrayidx122.i, align 8, !tbaa !5
  %arrayidx125.i = getelementptr inbounds nuw [1000 x double], ptr %call.i4, i64 %indvars.iv120.i
  store double 0.000000e+00, ptr %arrayidx125.i, align 8, !tbaa !5
  %arrayidx131.i = getelementptr inbounds nuw [1000 x double], ptr %call.i5, i64 %indvars.iv120.i
  store double 1.000000e+00, ptr %arrayidx131.i, align 8, !tbaa !5
  br label %for.cond133.i

for.cond133.i:                                    ; preds = %for.inc188.i, %for.body120.i
  %indvars.iv111.i = phi i64 [ %indvars.iv.next112.i, %for.inc188.i ], [ 1, %for.body120.i ]
  %exitcond115.not.i = icmp eq i64 %indvars.iv111.i, 999
  br i1 %exitcond115.not.i, label %for.end190.i, label %for.inc188.i

for.inc188.i:                                     ; preds = %for.cond133.i
  %18 = add nsw i64 %indvars.iv111.i, -1
  %arrayidx143.i = getelementptr inbounds [1000 x double], ptr %call.i4, i64 %indvars.iv120.i, i64 %18
  %19 = load double, ptr %arrayidx143.i, align 8, !tbaa !5, !invariant.load !9
  %20 = tail call double @llvm.fmuladd.f64(double %19, double 0xC08F400000000001, double 0x409F440000000001) #16
  %div145.i = fdiv double 0x408F400000000001, %20
  %arrayidx149.i = getelementptr inbounds nuw [1000 x double], ptr %call.i4, i64 %indvars.iv120.i, i64 %indvars.iv111.i
  store double %div145.i, ptr %arrayidx149.i, align 8, !tbaa !5
  %arrayidx155.i = getelementptr [1000 x double], ptr %invariant.gep98.i, i64 %indvars.iv120.i, i64 %indvars.iv111.i
  %21 = load double, ptr %arrayidx155.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx161.i = getelementptr inbounds nuw [1000 x double], ptr %call.i3, i64 %indvars.iv120.i, i64 %indvars.iv111.i
  %22 = load double, ptr %arrayidx161.i, align 8, !tbaa !5, !invariant.load !9
  %mul162.i = fmul double %22, 0xC0AF3E0000000001
  %23 = tail call double @llvm.fmuladd.f64(double %21, double 0x409F400000000001, double %mul162.i) #16
  %arrayidx167.i = getelementptr inbounds nuw [1000 x double], ptr %invariant.gep.i, i64 %indvars.iv120.i, i64 %indvars.iv111.i
  %24 = load double, ptr %arrayidx167.i, align 8, !tbaa !5, !invariant.load !9
  %25 = tail call double @llvm.fmuladd.f64(double %24, double 0x409F400000000001, double %23) #16
  %arrayidx174.i = getelementptr inbounds [1000 x double], ptr %call.i5, i64 %indvars.iv120.i, i64 %18
  %26 = load double, ptr %arrayidx174.i, align 8, !tbaa !5, !invariant.load !9
  %27 = tail call double @llvm.fmuladd.f64(double %26, double 0x408F400000000001, double %25) #16
  %div183.i = fdiv double %27, %20
  %arrayidx187.i = getelementptr inbounds nuw [1000 x double], ptr %call.i5, i64 %indvars.iv120.i, i64 %indvars.iv111.i
...
for.cond197.i:                                    ; preds = %for.inc219.i, %for.end190.i
  %indvars.iv116.i = phi i64 [ %indvars.iv.next117.i, %for.inc219.i ], [ 998, %for.end190.i ]
  %cmp198.not.i = icmp eq i64 %indvars.iv116.i, 0
  br i1 %cmp198.not.i, label %for.inc222.i, label %for.inc219.i

for.inc219.i:                                     ; preds = %for.cond197.i
  %arrayidx204.i = getelementptr inbounds nuw [1000 x double], ptr %call.i4, i64 %indvars.iv120.i, i64 %indvars.iv116.i
  %28 = load double, ptr %arrayidx204.i, align 8, !tbaa !5, !invariant.load !9
  %29 = add nuw nsw i64 %indvars.iv116.i, 1
  %arrayidx209.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv120.i, i64 %29
  %30 = load double, ptr %arrayidx209.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx214.i = getelementptr inbounds nuw [1000 x double], ptr %call.i5, i64 %indvars.iv120.i, i64 %indvars.iv116.i
  %31 = load double, ptr %arrayidx214.i, align 8, !tbaa !5, !invariant.load !9
  %32 = tail call double @llvm.fmuladd.f64(double %28, double %30, double %31) #16
  %arrayidx218.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv120.i, i64 %indvars.iv116.i
  store double %32, ptr %arrayidx218.i, align 8, !tbaa !5
...
kernel_adi.exit:                                  ; preds = %for.cond.i6
  %call.i18 = tail call fastcc double @rtclock() #13
...
land.lhs.true:                                    ; preds = %kernel_adi.exit
  %33 = load ptr, ptr %argv, align 8, !tbaa !35, !invariant.load !9
  %strcmpload = load i8, ptr %33, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1000, ptr nofree noundef readonly captures(none) %call.i) #13
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %n, ptr nofree noundef readonly captures(none) %u) unnamed_addr #8 {
entry:
