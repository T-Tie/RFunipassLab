...
entry:
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
  %call.i1 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
  %call.i2 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
  %call.i3 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.end.i ], [ 0, %entry ]
  %exitcond16.not.i = icmp eq i64 %indvars.iv11.i, 1000
  br i1 %exitcond16.not.i, label %init_array.exit, label %for.cond1.preheader.i

for.cond1.preheader.i:                            ; preds = %for.cond.i
  %0 = trunc i64 %indvars.iv11.i to i32
  %1 = add i32 %0, 1000
...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  %arrayidx6.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv11.i, i64 %indvars.iv.i
...
define internal fastcc void @print_array(i32 noundef %n, ptr noundef readonly captures(none) %u) unnamed_addr #9 {
entry:
