...
entry:
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15, !noalias !15
  %call.i2 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15, !noalias !18
  %call.i3 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15, !noalias !21
  %call.i4 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15, !noalias !24
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv12.i = phi i64 [ %indvars.iv.next13.i, %for.end.i ], [ 0, %entry ]
...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  %arrayidx6.i = getelementptr inbounds nuw [1000 x double], ptr %call.i, i64 %indvars.iv12.i, i64 %indvars.iv.i
