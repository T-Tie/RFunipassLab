...
entry:
  tail call void @polybench_flush_cache() #10
  unreachable
}
...
entry:
  tail call void @polybench_prepare_instruments() #10
  unreachable
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 16, ptr noundef nonnull align 8 %Tp.i) #11
  %call.i = call i32 @gettimeofday(ptr noundef nonnull align 8 %Tp.i, ptr noundef null) #12
  %cmp.not.i = icmp eq i32 %call.i, 0
  br i1 %cmp.not.i, label %rtclock.exit, label %if.then.i

if.then.i:                                        ; preds = %entry
  %call1.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %call.i) #12
...
rtclock.exit:                                     ; preds = %entry, %if.then.i
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 16, ptr noundef nonnull %Tp.i) #12
...
entry:
  ...
  %mul = mul i64 %n, %conv
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %ret.i) #11
...
if.then.i:                                        ; preds = %entry
  ...
  %2 = call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %1) #13
...
entry:
  ...
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 500, i32 noundef 8) #12
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.end38.i
  %indvars.iv34.i = phi i64 [ %indvars.iv.next35.i, %for.end38.i ], [ 0, %for.cond.i ]
  %exitcond37.not.i = icmp eq i64 %indvars.iv34.i, 1000
  br i1 %exitcond37.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.body8.i
  %indvars.iv28.i = phi i64 [ %indvars.iv.next29.i, %for.body8.i ], [ 0, %for.cond1.i ]
  %exitcond33.not.i = icmp eq i64 %indvars.iv28.i, 1200
  br i1 %exitcond33.not.i, label %for.end38.i, label %for.body8.i

for.body8.i:                                      ; preds = %for.cond5.i
  %indvars.iv.next29.i = add nuw nsw i64 %indvars.iv28.i, 1
  %1 = mul nuw nsw i64 %indvars.iv.next29.i, %indvars.iv34.i
  %2 = trunc nuw nsw i64 %1 to i32
  %mul.i = uitofp nneg i32 %2 to double
  %div.i = fdiv double %mul.i, 1.000000e+03
  %arrayidx15.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv34.i, i64 %indvars.iv28.i
  store double %div.i, ptr %arrayidx15.i, align 8, !tbaa !11
  %3 = add nuw nsw i64 %indvars.iv28.i, 2
  %4 = mul nuw nsw i64 %3, %indvars.iv34.i
  %5 = trunc nuw nsw i64 %4 to i32
  %mul19.i = uitofp nneg i32 %5 to double
  %div21.i = fdiv double %mul19.i, 1.200000e+03
  %arrayidx25.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv34.i, i64 %indvars.iv28.i
  store double %div21.i, ptr %arrayidx25.i, align 8, !tbaa !11
  %6 = add nuw nsw i64 %indvars.iv28.i, 3
  %7 = mul nuw nsw i64 %6, %indvars.iv34.i
  %8 = trunc nuw nsw i64 %7 to i32
  %mul29.i = uitofp nneg i32 %8 to double
  %div31.i = fdiv double %mul29.i, 1.000000e+03
  %arrayidx35.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv34.i, i64 %indvars.iv28.i
...
attributes #11 = { nofree nounwind willreturn memory(readwrite) }
