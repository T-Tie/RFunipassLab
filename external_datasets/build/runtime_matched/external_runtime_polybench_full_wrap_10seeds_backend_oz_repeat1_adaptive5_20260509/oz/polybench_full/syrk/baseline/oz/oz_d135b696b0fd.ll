...
for.cond10.i:                                     ; preds = %for.cond.i, %for.inc31.i
  %indvars.iv34.i = phi i64 [ %indvars.iv.next35.i, %for.inc31.i ], [ 0, %for.cond.i ]
...
for.cond14.i:                                     ; preds = %for.cond10.i, %for.body17.i
  %indvars.iv28.i = phi i64 [ %indvars.iv.next29.i, %for.body17.i ], [ 0, %for.cond10.i ]
  %exitcond33.not.i = icmp eq i64 %indvars.iv28.i, 1200
  br i1 %exitcond33.not.i, label %for.inc31.i, label %for.body17.i
...
for.cond.i9:                                      ; preds = %for.inc32.i, %init_array.exit
  %indvars.iv32.i = phi i64 [ %indvars.iv.next33.i, %for.inc32.i ], [ 0, %init_array.exit ]
  %indvars.iv30.i = phi i64 [ %indvars.iv.next31.i, %for.inc32.i ], [ 1, %init_array.exit ]
  %exitcond37.not.i10 = icmp eq i64 %indvars.iv32.i, 1200
  br i1 %exitcond37.not.i10, label %kernel_syrk.exit, label %for.cond1.i11

for.cond1.i11:                                    ; preds = %for.cond.i9, %for.body3.i13
  %indvars.iv.i12 = phi i64 [ %indvars.iv.next.i14, %for.body3.i13 ], [ 0, %for.cond.i9 ]
  %exitcond.i = icmp eq i64 %indvars.iv.i12, %indvars.iv30.i
  br i1 %exitcond.i, label %for.cond6.i, label %for.body3.i13

for.body3.i13:                                    ; preds = %for.cond1.i11
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv32.i, i64 %indvars.iv.i12
  %6 = load double, ptr %arrayidx5.i, align 8, !tbaa !5
  ...
  br label %for.cond1.i11, !llvm.loop !22

for.cond6.i:                                      ; preds = %for.cond1.i11, %for.inc29.i
  %indvars.iv26.i = phi i64 [ %indvars.iv.next27.i, %for.inc29.i ], [ 0, %for.cond1.i11 ]
  %exitcond29.not.i = icmp eq i64 %indvars.iv26.i, 1000
  br i1 %exitcond29.not.i, label %for.inc32.i, label %for.cond9.preheader.i

for.cond9.preheader.i:                            ; preds = %for.cond6.i
  %arrayidx15.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv32.i, i64 %indvars.iv26.i
  br label %for.cond9.i

for.cond9.i:                                      ; preds = %for.body11.i, %for.cond9.preheader.i
  %indvars.iv21.i = phi i64 [ 0, %for.cond9.preheader.i ], [ %indvars.iv.next22.i, %for.body11.i ]
  %exitcond25.i = icmp eq i64 %indvars.iv21.i, %indvars.iv30.i
  br i1 %exitcond25.i, label %for.inc29.i, label %for.body11.i

for.body11.i:                                     ; preds = %for.cond9.i
  %7 = load double, ptr %arrayidx15.i, align 8, !tbaa !5
  %mul16.i = fmul double %7, 1.500000e+00
  %arrayidx20.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv21.i, i64 %indvars.iv26.i
  %8 = load double, ptr %arrayidx20.i, align 8, !tbaa !5
  %arrayidx25.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv32.i, i64 %indvars.iv21.i
  %9 = load double, ptr %arrayidx25.i, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %mul16.i, double %8, double %9)
...
for.inc32.i:                                      ; preds = %for.cond6.i
  ...
  br label %for.cond.i9, !llvm.loop !25

kernel_syrk.exit:                                 ; preds = %for.cond.i9
  %call.i15 = tail call fastcc double @rtclock()
...
land.lhs.true:                                    ; preds = %kernel_syrk.exit
  %11 = load ptr, ptr %argv, align 8, !tbaa !26
