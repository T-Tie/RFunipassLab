...
for.cond.i:                                       ; preds = %for.inc7.i, %entry
  ...
  %exitcond29.not.i = icmp eq i64 %indvars.iv24.i, 1200
  br i1 %exitcond29.not.i, label %for.cond10.i, label %for.cond1.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.end30.i
  %indvars.iv37.i = phi i64 [ %indvars.iv.next38.i, %for.end30.i ], [ 0, %for.cond.i ]
  %exitcond41.not.i = icmp eq i64 %indvars.iv37.i, 1200
  br i1 %exitcond41.not.i, label %init_array.exit, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv30.i = phi i64 [ %indvars.iv.next31.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond36.not.i = icmp eq i64 %indvars.iv30.i, 1200
  br i1 %exitcond36.not.i, label %for.end30.i, label %for.inc28.i

for.inc28.i:                                      ; preds = %for.cond14.i
  %3 = mul nuw nsw i64 %indvars.iv30.i, %indvars.iv37.i
  %4 = trunc i64 %3 to i32
  %5 = add i32 %4, 2
  %rem20.i = srem i32 %5, 1000
  %conv21.i = uitofp nneg i32 %rem20.i to double
  %div23.i = fdiv double %conv21.i, 1.000000e+03
  %arrayidx27.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv37.i, i64 %indvars.iv30.i
