...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %exitcond18.not = icmp eq i64 %indvars.iv15, 1200
  br i1 %exitcond18.not, label %for.body17.preheader, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %0 = mul nuw nsw i64 %indvars.iv, %indvars.iv15
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem = urem i32 %2, 1200
  %conv = uitofp nneg i32 %rem to double
  %div = fdiv double %conv, 1.200000e+03
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv15, i64 %indvars.iv
