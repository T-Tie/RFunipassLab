...
for.cond.i:                                       ; preds = %for.cond35.i, %entry
  ...
  %exitcond35.not.i = icmp eq i64 %indvars.iv31.i, 2000
  br i1 %exitcond35.not.i, label %init_array.exit, label %for.body.i
...
for.body.i:                                       ; preds = %for.cond.i
  ...
  %1 = trunc nuw i64 %indvars.iv.next32.i to i32
...
define internal fastcc void @print_array(i32 noundef %n, ptr noundef readonly captures(none) %w) unnamed_addr #9 {
entry:
