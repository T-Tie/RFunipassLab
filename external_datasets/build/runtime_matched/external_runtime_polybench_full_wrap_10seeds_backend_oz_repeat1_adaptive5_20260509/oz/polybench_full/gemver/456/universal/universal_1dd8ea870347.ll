...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 4000000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call4 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call5 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call6 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call7 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  %call8 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #14
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.cond35.i, %entry
  %indvars.iv4.i = phi i64 [ 0, %entry ], [ %indvars.iv.next5.i, %for.cond35.i ]
  %exitcond7.not.i = icmp eq i64 %indvars.iv4.i, 2000
  br i1 %exitcond7.not.i, label %init_array.exit, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i
  %0 = trunc nuw nsw i64 %indvars.iv4.i to i32
  %conv2.i = uitofp nneg i32 %0 to double
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv4.i
  store double %conv2.i, ptr %arrayidx.i, align 8, !tbaa !11
  %indvars.iv.next5.i = add nuw nsw i64 %indvars.iv4.i, 1
  %1 = trunc nuw nsw i64 %indvars.iv.next5.i to i32
  %conv3.i = uitofp nneg i32 %1 to double
  %div.i = fdiv double %conv3.i, 2.000000e+03
  %div4.i = fmul double %div.i, 5.000000e-01
  %arrayidx6.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv4.i
  store double %div4.i, ptr %arrayidx6.i, align 8, !tbaa !11
  %div10.i = fmul double %div.i, 2.500000e-01
  %arrayidx12.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv4.i
  store double %div10.i, ptr %arrayidx12.i, align 8, !tbaa !11
  %div16.i = fdiv double %div.i, 6.000000e+00
  %arrayidx18.i = getelementptr inbounds nuw double, ptr %call4, i64 %indvars.iv4.i
  store double %div16.i, ptr %arrayidx18.i, align 8, !tbaa !11
  %div22.i = fmul double %div.i, 1.250000e-01
  %arrayidx24.i = getelementptr inbounds nuw double, ptr %call7, i64 %indvars.iv4.i
  store double %div22.i, ptr %arrayidx24.i, align 8, !tbaa !11
  %div28.i = fdiv double %div.i, 9.000000e+00
  %arrayidx30.i = getelementptr inbounds nuw double, ptr %call8, i64 %indvars.iv4.i
  store double %div28.i, ptr %arrayidx30.i, align 8, !tbaa !11
  %arrayidx32.i = getelementptr inbounds nuw double, ptr %call6, i64 %indvars.iv4.i
  store double 0.000000e+00, ptr %arrayidx32.i, align 8, !tbaa !11
  %arrayidx34.i = getelementptr inbounds nuw double, ptr %call5, i64 %indvars.iv4.i
...
for.inc.i:                                        ; preds = %for.cond35.i
  %2 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv4.i
  %3 = trunc nuw nsw i64 %2 to i32
  %rem.i = urem i32 %3, 2000
  %conv39.i = uitofp nneg i32 %rem.i to double
  %div41.i = fdiv double %conv39.i, 2.000000e+03
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv4.i, i64 %indvars.iv.i
  store double %div41.i, ptr %arrayidx45.i, align 8, !tbaa !11
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond35.i, !llvm.loop !15
