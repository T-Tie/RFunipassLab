...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1100000, i32 noundef 8) #15
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #15
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1320000, i32 noundef 8) #15
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv35.i = phi i64 [ %indvars.iv.next36.i, %for.inc7.i ], [ 0, %entry ]
  %exitcond40.not.i = icmp eq i64 %indvars.iv35.i, 1000
  br i1 %exitcond40.not.i, label %for.cond10.i, label %for.cond1.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.inc31.i
  %indvars.iv48.i = phi i64 [ %indvars.iv.next49.i, %for.inc31.i ], [ 0, %for.cond.i ]
  %exitcond52.not.i = icmp eq i64 %indvars.iv48.i, 1000
  br i1 %exitcond52.not.i, label %for.cond34.i, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond47.not.i = icmp eq i64 %indvars.iv41.i, 1200
  br i1 %exitcond47.not.i, label %for.inc31.i, label %for.inc28.i

for.inc28.i:                                      ; preds = %for.cond14.i
  %indvars.iv.next42.i = add nuw nsw i64 %indvars.iv41.i, 1
  %3 = mul nuw nsw i64 %indvars.iv.next42.i, %indvars.iv48.i
  %4 = trunc nuw i64 %3 to i32
  %rem20.i = srem i32 %4, 1200
  %conv21.i = uitofp nneg i32 %rem20.i to double
  %div23.i = fdiv double %conv21.i, 1.200000e+03
  %arrayidx27.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv48.i, i64 %indvars.iv41.i
...
for.cond34.i:                                     ; preds = %for.cond10.i, %for.end54.i
  %indvars.iv60.i = phi i64 [ %indvars.iv.next61.i, %for.end54.i ], [ 0, %for.cond10.i ]
  %exitcond64.not.i = icmp eq i64 %indvars.iv60.i, 1200
  br i1 %exitcond64.not.i, label %init_array.exit, label %for.cond38.i

for.cond38.i:                                     ; preds = %for.cond34.i, %for.inc52.i
  %indvars.iv53.i = phi i64 [ %indvars.iv.next54.i, %for.inc52.i ], [ 0, %for.cond34.i ]
  %exitcond59.not.i = icmp eq i64 %indvars.iv53.i, 1100
  br i1 %exitcond59.not.i, label %for.end54.i, label %for.inc52.i

for.inc52.i:                                      ; preds = %for.cond38.i
  %5 = add nuw nsw i64 %indvars.iv53.i, 2
  %6 = mul nuw nsw i64 %5, %indvars.iv60.i
  %7 = trunc nuw i64 %6 to i32
  %rem44.i = srem i32 %7, 1100
  %conv45.i = uitofp nneg i32 %rem44.i to double
  %div47.i = fdiv double %conv45.i, 1.100000e+03
  %arrayidx51.i = getelementptr inbounds nuw [1100 x double], ptr %call2, i64 %indvars.iv60.i, i64 %indvars.iv53.i
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nj, ptr noundef readonly captures(none) %C) unnamed_addr #9 {
entry:
