...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1100000, i32 noundef 8) #15
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #15
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1320000, i32 noundef 8) #15
  br label %for.cond.i
...
for.cond.i:                                       ; preds = %for.inc7.i, %entry
  ...
  br i1 %exitcond13.not.i, label %for.cond10.i, label %for.cond1.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  %0 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv10.i
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem.i = urem i32 %2, 1000
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.000000e+03
  %arrayidx6.i = getelementptr inbounds nuw [1100 x double], ptr %call, i64 %indvars.iv10.i, i64 %indvars.iv.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.inc31.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.inc31.i ], [ 0, %for.cond.i ]
  %exitcond22.not.i = icmp eq i64 %indvars.iv19.i, 1000
  br i1 %exitcond22.not.i, label %for.cond34.i, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv14.i = phi i64 [ %indvars.iv.next15.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond18.not.i = icmp eq i64 %indvars.iv14.i, 1200
  br i1 %exitcond18.not.i, label %for.inc31.i, label %for.inc28.i
...
for.inc28.i:                                      ; preds = %for.cond14.i
  ...
  %arrayidx27.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv19.i, i64 %indvars.iv14.i
...
for.cond34.i:                                     ; preds = %for.cond10.i, %for.end54.i
  %indvars.iv29.i = phi i64 [ %indvars.iv.next30.i, %for.end54.i ], [ 0, %for.cond10.i ]
  %exitcond32.not.i = icmp eq i64 %indvars.iv29.i, 1200
  br i1 %exitcond32.not.i, label %for.body.i.i.i, label %for.cond38.i

for.cond38.i:                                     ; preds = %for.cond34.i, %for.body41.i
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %for.body41.i ], [ 0, %for.cond34.i ]
  %exitcond28.not.i = icmp eq i64 %indvars.iv23.i, 1100
  br i1 %exitcond28.not.i, label %for.end54.i, label %for.body41.i

for.body41.i:                                     ; preds = %for.cond38.i
  %5 = add nuw nsw i64 %indvars.iv23.i, 2
  %6 = mul nuw nsw i64 %5, %indvars.iv29.i
  %7 = trunc nuw nsw i64 %6 to i32
  %rem44.i = urem i32 %7, 1100
  %conv45.i = uitofp nneg i32 %rem44.i to double
  %div47.i = fdiv double %conv45.i, 1.100000e+03
  %arrayidx51.i = getelementptr inbounds nuw [1100 x double], ptr %call2, i64 %indvars.iv29.i, i64 %indvars.iv23.i
...
for.body.i.i.i:                                   ; preds = %for.cond34.i, %for.body.i.i.i
