...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #12
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #12
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %entry
  store double 1.000000e-03, ptr %call, align 8, !tbaa !11
  store double 1.500000e-03, ptr %call1, align 8, !tbaa !11
  br label %for.body.i
}
