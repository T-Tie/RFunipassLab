...
for.cond.i:                                       ; preds = %for.inc8.i, %entry
  ...
  %exitcond14.not.i = icmp eq i64 %indvars.iv11.i, 2000
...
for.body3.i:                                      ; preds = %for.cond1.i
  ...
  %div.i = fdiv double %3, 2.000000e+03
  %arrayidx7.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv11.i, i64 %indvars.iv.i
...
for.cond.i6:                                      ; preds = %for.inc69.i, %init_array.exit
  %t.0.i = phi i32 [ 0, %init_array.exit ], [ %inc70.i, %for.inc69.i ]
  %exitcond40.not.i = icmp eq i32 %t.0.i, 500
  br i1 %exitcond40.not.i, label %kernel_seidel_2d.exit, label %for.cond1.i7

for.cond1.i7:                                     ; preds = %for.cond.i6, %for.inc66.i
  %indvars.iv36.i = phi i64 [ %indvars.iv.next37.i, %for.inc66.i ], [ 1, %for.cond.i6 ]
  %exitcond39.not.i = icmp eq i64 %indvars.iv36.i, 1999
  br i1 %exitcond39.not.i, label %for.inc69.i, label %for.cond5.preheader.i

for.cond5.preheader.i:                            ; preds = %for.cond1.i7
  %4 = getelementptr [2000 x double], ptr %call, i64 %indvars.iv36.i
  %arrayidx.i = getelementptr i8, ptr %4, i64 -16000
  %arrayidx44.i = getelementptr inbounds nuw i8, ptr %4, i64 16000
  br label %for.cond5.i

for.cond5.i:                                      ; preds = %for.body8.i, %for.cond5.preheader.i
  %indvars.iv.i8 = phi i64 [ 1, %for.cond5.preheader.i ], [ %indvars.iv.next.i10, %for.body8.i ]
  %exitcond.not.i9 = icmp eq i64 %indvars.iv.i8, 1999
  br i1 %exitcond.not.i9, label %for.inc66.i, label %for.body8.i

for.body8.i:                                      ; preds = %for.cond5.i
  %5 = add nsw i64 %indvars.iv.i8, -1
  %arrayidx12.i = getelementptr inbounds [2000 x double], ptr %arrayidx.i, i64 0, i64 %5
  %6 = load double, ptr %arrayidx12.i, align 8, !tbaa !5
  %arrayidx17.i = getelementptr inbounds nuw [2000 x double], ptr %arrayidx.i, i64 0, i64 %indvars.iv.i8
  %7 = load double, ptr %arrayidx17.i, align 8, !tbaa !5
  ...
  %8 = load double, ptr %arrayidx23.i, align 8, !tbaa !5
  %add24.i = fadd double %add.i, %8
  %arrayidx29.i = getelementptr inbounds [2000 x double], ptr %call, i64 %indvars.iv36.i, i64 %5
  %9 = load double, ptr %arrayidx29.i, align 8, !tbaa !5
  %add30.i = fadd double %add24.i, %9
  %arrayidx34.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv36.i, i64 %indvars.iv.i8
  %10 = load double, ptr %arrayidx34.i, align 8, !tbaa !5
  %add35.i = fadd double %add30.i, %10
  %arrayidx40.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv36.i, i64 %indvars.iv.next.i10
  %11 = load double, ptr %arrayidx40.i, align 8, !tbaa !5
  %add41.i = fadd double %add35.i, %11
  %arrayidx47.i = getelementptr inbounds [2000 x double], ptr %arrayidx44.i, i64 0, i64 %5
  %12 = load double, ptr %arrayidx47.i, align 8, !tbaa !5
  %add48.i = fadd double %add41.i, %12
  %arrayidx53.i = getelementptr inbounds nuw [2000 x double], ptr %arrayidx44.i, i64 0, i64 %indvars.iv.i8
  %13 = load double, ptr %arrayidx53.i, align 8, !tbaa !5
  %add54.i = fadd double %add48.i, %13
  %arrayidx60.i = getelementptr inbounds nuw [2000 x double], ptr %arrayidx44.i, i64 0, i64 %indvars.iv.next.i10
  %14 = load double, ptr %arrayidx60.i, align 8, !tbaa !5
  %add61.i = fadd double %add54.i, %14
  %div.i11 = fdiv double %add61.i, 9.000000e+00
  store double %div.i11, ptr %arrayidx34.i, align 8, !tbaa !5
  br label %for.cond5.i, !llvm.loop !20

for.inc66.i:                                      ; preds = %for.cond5.i
  %indvars.iv.next37.i = add nuw nsw i64 %indvars.iv36.i, 1
  br label %for.cond1.i7, !llvm.loop !21

for.inc69.i:                                      ; preds = %for.cond1.i7
  %inc70.i = add nuw nsw i32 %t.0.i, 1
  br label %for.cond.i6, !llvm.loop !22

kernel_seidel_2d.exit:                            ; preds = %for.cond.i6
...
land.lhs.true:                                    ; preds = %kernel_seidel_2d.exit
  %15 = load ptr, ptr %argv, align 8, !tbaa !23
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_seidel_2d.exit
...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  %exitcond15.not = icmp eq i64 %indvars.iv11, 2000
