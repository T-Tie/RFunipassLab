...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %0 = trunc nuw nsw i64 %indvars.iv8 to i32
...
for.body3:                                        ; preds = %for.cond1
  ...
  %div = fdiv double %3, 2.000000e+03
  %arrayidx7 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv8, i64 %indvars.iv
