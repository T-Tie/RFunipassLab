...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 0, i64 %indvars.iv
  store double %div, ptr %arrayidx6, align 8, !tbaa !11
  %1 = trunc i64 %indvars.iv to i32
  %2 = sub i32 1200, %1
  %rem83 = urem i32 %2, 100
  %conv9 = uitofp nneg i32 %rem83 to double
  %div11 = fdiv double %conv9, 1.000000e+03
  %arrayidx15 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 0, i64 %indvars.iv
