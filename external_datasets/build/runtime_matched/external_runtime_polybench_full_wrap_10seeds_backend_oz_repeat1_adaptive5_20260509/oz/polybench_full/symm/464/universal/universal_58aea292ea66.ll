...
entry:
  ...
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #15
  call fastcc void @init_array(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call2) #19
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %beta, ptr nofree noundef writeonly captures(none) %C, ptr nofree noundef writeonly captures(none) %B) unnamed_addr #8 {
entry:
...
if.then_after_outline.exitStub:
  ...
  %1 = tail call i64 @fwrite(ptr nonnull @.str.4, i64 50, i64 1, ptr %0) #20
  ret void
}
...
attributes #19 = { noreturn nosync nounwind }
attributes #20 = { cold }
