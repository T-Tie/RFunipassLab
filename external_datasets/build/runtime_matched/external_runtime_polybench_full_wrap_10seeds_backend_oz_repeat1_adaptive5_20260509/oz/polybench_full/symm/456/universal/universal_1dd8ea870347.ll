...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %alpha) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %beta) #17
...
for.body:                                         ; preds = %entry, %for.end
  ...
  %0 = add nuw nsw i64 %indvars.iv5, 1200
  br label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv5, i64 %indvars.iv
  ...
  %arrayidx15 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 %indvars.iv5, i64 %indvars.iv
...
attributes #18 = { noreturn nosync nounwind memory(write) }
