...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 2500, i32 noundef 1) #12
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 6250000, i32 noundef 4) #12
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.inc16.i
  %indvars.iv17.i = phi i64 [ %indvars.iv.next18.i, %for.inc16.i ], [ 0, %for.cond.i ]
  %exitcond21.not.i = icmp eq i64 %indvars.iv17.i, 2500
  br i1 %exitcond21.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.inc13.i
  %indvars.iv12.i = phi i64 [ %indvars.iv.next13.i, %for.inc13.i ], [ 0, %for.cond1.i ]
  %exitcond16.not.i = icmp eq i64 %indvars.iv12.i, 2500
  br i1 %exitcond16.not.i, label %for.inc16.i, label %for.inc13.i

for.inc13.i:                                      ; preds = %for.cond5.i
  %arrayidx12.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv17.i, i64 %indvars.iv12.i
...
for.cond.i1:                                      ; preds = %for.cond1.i5, %init_array.exit
  %indvars.iv115.i = phi i64 [ 2500, %init_array.exit ], [ %indvars.iv.next116.i, %for.cond1.i5 ]
  %indvars.iv.next116.i = add nsw i64 %indvars.iv115.i, -1
  %cmp.i.not = icmp eq i64 %indvars.iv115.i, 0
  br i1 %cmp.i.not, label %kernel_nussinov.exit, label %for.cond1.preheader.i4

for.cond1.preheader.i4:                           ; preds = %for.cond.i1
  %arrayidx77.i = getelementptr inbounds i8, ptr %call, i64 %indvars.iv.next116.i
  br label %for.cond1.i5

for.cond1.i5:                                     ; preds = %for.inc192.i, %for.cond1.preheader.i4
  %indvars.iv112.i = phi i64 [ %indvars.iv115.i, %for.cond1.preheader.i4 ], [ %indvars.iv.next113.i, %for.inc192.i ]
  %exitcond.not = icmp eq i64 %indvars.iv112.i, 2500
  br i1 %exitcond.not, label %for.cond.i1, label %if.then29.i, !llvm.loop !24

if.then29.i:                                      ; preds = %for.cond1.i5
  %sub4.i = add nuw nsw i64 %indvars.iv112.i, 4294967295
  %arrayidx7.i = getelementptr inbounds [2500 x i32], ptr %call1, i64 %indvars.iv.next116.i, i64 %indvars.iv112.i
  %1 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20, !invariant.load !9
  %idxprom11.i = and i64 %sub4.i, 4294967295
  %arrayidx12.i6 = getelementptr inbounds [2500 x i32], ptr %call1, i64 %indvars.iv.next116.i, i64 %idxprom11.i
  %2 = load i32, ptr %arrayidx12.i6, align 4, !tbaa !20, !invariant.load !9
  %spec.select.i = tail call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv115.i, i64 %indvars.iv112.i
  %3 = load i32, ptr %arrayidx38.i, align 4, !tbaa !20, !invariant.load !9
  %spec.select105.i = tail call i32 @llvm.smax.i32(i32 %spec.select.i, i32 %3)
  store i32 %spec.select105.i, ptr %arrayidx7.i, align 4, !tbaa !20
  %sext.i = shl nuw i64 %indvars.iv112.i, 32
  %4 = ashr exact i64 %sext.i, 32
  %cmp64.i = icmp samesign ult i64 %indvars.iv115.i, %4
  %arrayidx75.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv115.i, i64 %idxprom11.i
  %5 = load i32, ptr %arrayidx75.i, align 4, !tbaa !20
  br i1 %cmp64.i, label %if.then65.i, label %if.end148.i

if.then65.i:                                      ; preds = %if.then29.i
  %6 = load i8, ptr %arrayidx77.i, align 1, !tbaa !18
  %conv.i7 = sext i8 %6 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv112.i
  %7 = load i8, ptr %arrayidx79.i, align 1, !tbaa !18
  %conv80.i = sext i8 %7 to i32
  %add81.i = add nsw i32 %conv80.i, %conv.i7
  %cmp82.i = icmp eq i32 %add81.i, 3
  %cond84.i = zext i1 %cmp82.i to i32
  %add85.i = add nsw i32 %5, %cond84.i
  br label %if.end148.i

if.end148.i:                                      ; preds = %if.then65.i, %if.then29.i
  %add85.sink.i = phi i32 [ %add85.i, %if.then65.i ], [ %5, %if.then29.i ]
  %spec.select106.i = tail call i32 @llvm.smax.i32(i32 %spec.select105.i, i32 %add85.sink.i)
  br label %for.cond150.i

for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  %storemerge118.i = phi i32 [ %spec.select106.i, %if.end148.i ], [ %spec.select108.i, %for.body153.i ]
  %indvars.iv109.i = phi i64 [ %indvars.iv115.i, %if.end148.i ], [ %indvars.iv.next110.i, %for.body153.i ]
  store i32 %storemerge118.i, ptr %arrayidx7.i, align 4, !tbaa !20
  %8 = icmp ult i64 %indvars.iv109.i, %indvars.iv112.i
  br i1 %8, label %for.body153.i, label %for.inc192.i

for.body153.i:                                    ; preds = %for.cond150.i
  %arrayidx161.i = getelementptr inbounds [2500 x i32], ptr %call1, i64 %indvars.iv.next116.i, i64 %indvars.iv109.i
  %9 = load i32, ptr %arrayidx161.i, align 4, !tbaa !20, !invariant.load !9
  %indvars.iv.next110.i = add nuw nsw i64 %indvars.iv109.i, 1
  %arrayidx166.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv.next110.i, i64 %indvars.iv112.i
  %10 = load i32, ptr %arrayidx166.i, align 4, !tbaa !20, !invariant.load !9
  %add167.i = add nsw i32 %10, %9
  %spec.select108.i = tail call i32 @llvm.smax.i32(i32 %storemerge118.i, i32 %add167.i)
  br label %for.cond150.i, !llvm.loop !25

for.inc192.i:                                     ; preds = %for.cond150.i
  %indvars.iv.next113.i = add nuw nsw i64 %indvars.iv112.i, 1
  br label %for.cond1.i5, !llvm.loop !26
...
land.lhs.true:                                    ; preds = %kernel_nussinov.exit
  %11 = load ptr, ptr %argv, align 8, !tbaa !27, !invariant.load !9
  %strcmpload = load i8, ptr %11, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 2500, ptr noundef %call1) #12
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %n, ptr noundef readonly captures(none) %table) unnamed_addr #8 {
entry:
...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv10 = phi i32 [ %indvars.iv.next11, %for.inc11 ], [ %n, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc11 ], [ 0, %entry ]
  %t.0 = phi i32 [ %3, %for.inc11 ], [ 0, %entry ]
  %exitcond15.not = icmp eq i64 %indvars.iv, %wide.trip.count14
  br i1 %exitcond15.not, label %for.end13, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %for.inc
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc ], [ %indvars.iv, %for.cond ]
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %2 = load i32, ptr %arrayidx8, align 4, !tbaa !20
