...
for.cond.i4:                                      ; preds = %for.inc195.i, %init_array.exit
  %indvars.iv115.i = phi i64 [ %indvars.iv.next116.i, %for.inc195.i ], [ 2499, %init_array.exit ]
  %indvars.iv.i5 = phi i64 [ %indvars.iv.next.i10, %for.inc195.i ], [ 2500, %init_array.exit ]
  %cmp.i = icmp sgt i64 %indvars.iv115.i, -1
  br i1 %cmp.i, label %for.body.i, label %kernel_nussinov.exit

for.body.i:                                       ; preds = %for.cond.i4
  %1 = add nuw nsw i64 %indvars.iv115.i, 1
  %arrayidx77.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv115.i
  br label %for.cond1.i6

for.cond1.i6:                                     ; preds = %for.inc192.i, %for.body.i
  %indvars.iv111.i = phi i64 [ %indvars.iv.next112.i, %for.inc192.i ], [ %indvars.iv.i5, %for.body.i ]
  %exitcond.not.i7 = icmp eq i64 %indvars.iv111.i, 2500
  br i1 %exitcond.not.i7, label %for.inc195.i, label %if.then29.i

if.then29.i:                                      ; preds = %for.cond1.i6
  %2 = add nsw i64 %indvars.iv111.i, -1
  %arrayidx7.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv115.i, i64 %indvars.iv111.i
  %3 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20, !invariant.load !9
  %arrayidx12.i8 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv115.i, i64 %2
  %4 = load i32, ptr %arrayidx12.i8, align 4, !tbaa !20, !invariant.load !9
  %spec.select.i = tail call i32 @llvm.smax.i32(i32 %3, i32 %4)
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %1, i64 %indvars.iv111.i
  %5 = load i32, ptr %arrayidx38.i, align 4, !tbaa !20, !invariant.load !9
  %spec.select104.i = tail call i32 @llvm.smax.i32(i32 %spec.select.i, i32 %5)
  store i32 %spec.select104.i, ptr %arrayidx7.i, align 4, !tbaa !20
  %cmp64.i = icmp slt i64 %indvars.iv115.i, %2
...
if.then65.i:                                      ; preds = %if.then29.i
  %7 = load i8, ptr %arrayidx77.i, align 1, !tbaa !18
  %conv.i9 = sext i8 %7 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv111.i
  %8 = load i8, ptr %arrayidx79.i, align 1, !tbaa !18
...
if.end148.i:                                      ; preds = %if.then65.i, %if.then29.i
  ...
  %spec.select105.i = tail call i32 @llvm.smax.i32(i32 %spec.select104.i, i32 %add85.sink.i)
  br label %for.cond150.i

for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  %storemerge119.i = phi i32 [ %spec.select105.i, %if.end148.i ], [ %spec.select107.i, %for.body153.i ]
  %indvars.iv108.i = phi i64 [ %indvars.iv.i5, %if.end148.i ], [ %indvars.iv.next109.i, %for.body153.i ]
  store i32 %storemerge119.i, ptr %arrayidx7.i, align 4, !tbaa !20
  %cmp151.i = icmp samesign ult i64 %indvars.iv108.i, %indvars.iv111.i
  br i1 %cmp151.i, label %for.body153.i, label %for.inc192.i

for.body153.i:                                    ; preds = %for.cond150.i
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv115.i, i64 %indvars.iv108.i
  %9 = load i32, ptr %arrayidx161.i, align 4, !tbaa !20, !invariant.load !9
  %indvars.iv.next109.i = add nuw nsw i64 %indvars.iv108.i, 1
  %arrayidx166.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv.next109.i, i64 %indvars.iv111.i
  %10 = load i32, ptr %arrayidx166.i, align 4, !tbaa !20, !invariant.load !9
  %add167.i = add nsw i32 %10, %9
  %spec.select107.i = tail call i32 @llvm.smax.i32(i32 %storemerge119.i, i32 %add167.i)
  br label %for.cond150.i, !llvm.loop !24

for.inc192.i:                                     ; preds = %for.cond150.i
  %indvars.iv.next112.i = add nuw nsw i64 %indvars.iv111.i, 1
  br label %for.cond1.i6, !llvm.loop !25

for.inc195.i:                                     ; preds = %for.cond1.i6
  %indvars.iv.next116.i = add nsw i64 %indvars.iv115.i, -1
  %indvars.iv.next.i10 = add nsw i64 %indvars.iv.i5, -1
