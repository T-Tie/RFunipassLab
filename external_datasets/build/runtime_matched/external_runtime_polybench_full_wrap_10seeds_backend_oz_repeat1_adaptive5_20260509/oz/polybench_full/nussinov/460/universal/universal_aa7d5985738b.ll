...
for.cond1.i:                                      ; preds = %for.cond.i, %for.inc16.i
  %indvars.iv6.i = phi i64 [ %indvars.iv.next7.i, %for.inc16.i ], [ 0, %for.cond.i ]
  %exitcond9.not.i = icmp eq i64 %indvars.iv6.i, 2500
  br i1 %exitcond9.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.inc13.i
  %indvars.iv2.i = phi i64 [ %indvars.iv.next3.i, %for.inc13.i ], [ 0, %for.cond1.i ]
  %exitcond5.not.i = icmp eq i64 %indvars.iv2.i, 2500
  br i1 %exitcond5.not.i, label %for.inc16.i, label %for.inc13.i

for.inc13.i:                                      ; preds = %for.cond5.i
  %arrayidx12.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv6.i, i64 %indvars.iv2.i
...
for.cond.i4:                                      ; preds = %for.inc195.i, %init_array.exit
  %indvars.iv14.i = phi i64 [ %indvars.iv.next15.i, %for.inc195.i ], [ 2499, %init_array.exit ]
  %1 = and i64 %indvars.iv14.i, 4294967295
...
for.cond1.preheader.i:                            ; preds = %for.cond.i4
  %cmp28.i = icmp samesign ult i64 %indvars.iv14.i, 2499
  %2 = add nuw nsw i64 %indvars.iv14.i, 1
  %arrayidx77.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv14.i
  br label %for.cond1.i5

for.cond1.i5:                                     ; preds = %for.cond150.i, %for.cond1.preheader.i
  %indvars.iv16.i = phi i64 [ %indvars.iv14.i, %for.cond1.preheader.i ], [ %indvars.iv.next17.i, %for.cond150.i ]
  %indvars.iv.next17.i = add nuw nsw i64 %indvars.iv16.i, 1
  %exitcond.not.i6 = icmp eq i64 %indvars.iv16.i, 2499
  br i1 %exitcond.not.i6, label %for.inc195.i, label %if.then.i

if.then.i:                                        ; preds = %for.cond1.i5
  %arrayidx7.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv14.i, i64 %indvars.iv.next17.i
  %3 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20, !invariant.load !9
  %arrayidx12.i7 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv14.i, i64 %indvars.iv16.i
  %4 = load i32, ptr %arrayidx12.i7, align 4, !tbaa !20, !invariant.load !9
  %cmp13.not.i = icmp slt i32 %3, %4
  %spec.select.i = select i1 %cmp13.not.i, i64 %indvars.iv16.i, i64 %indvars.iv.next17.i
  %idxprom21.i = and i64 %spec.select.i, 4294967295
  %arrayidx22.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv14.i, i64 %idxprom21.i
...
if.then62.i:                                      ; preds = %if.then.i
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv.next17.i
  %6 = load i32, ptr %arrayidx38.i, align 4, !tbaa !20, !invariant.load !9
  %cmp39.not.i = icmp slt i32 %5, %6
  %add274.i = zext i1 %cmp39.not.i to i64
  %spec.select6.i = add nuw nsw i64 %indvars.iv14.i, %add274.i
  %arrayidx50.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select6.i, i64 %indvars.iv.next17.i
  %7 = load i32, ptr %arrayidx50.i, align 4, !tbaa !20, !invariant.load !9
  %cmp64.i = icmp slt i64 %indvars.iv14.i, %indvars.iv16.i
  %arrayidx75.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv16.i
...
if.then65.i:                                      ; preds = %if.then62.i
  ...
  %conv.i10 = sext i8 %9 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv.next17.i
  %10 = load i8, ptr %arrayidx79.i, align 1, !tbaa !18, !invariant.load !9
  %conv80.i = sext i8 %10 to i32
  %add81.i = add nsw i32 %conv80.i, %conv.i10
  %cmp82.i = icmp eq i32 %add81.i, 3
  %cond84.i = zext i1 %cmp82.i to i32
  %add85.i = add nsw i32 %8, %cond84.i
  %spec.select7.i = tail call i32 @llvm.smax.i32(i32 %7, i32 %add85.i)
  br label %if.end147.i

if.else.i:                                        ; preds = %if.then62.i
  %cmp127.not.i = icmp slt i32 %7, %8
  %spec.select8.v.i = select i1 %cmp127.not.i, i64 %indvars.iv16.i, i64 %indvars.iv.next17.i
  %spec.select9.v.i = select i1 %cmp127.not.i, i64 %2, i64 %indvars.iv14.i
  %idxprom139.i = and i64 %spec.select8.v.i, 4294967295
  %arrayidx140.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select9.v.i, i64 %idxprom139.i
  %11 = load i32, ptr %arrayidx140.i, align 4, !tbaa !20, !invariant.load !9
  br label %if.end147.i

if.end147.i:                                      ; preds = %if.else.i, %if.then65.i
  %.sink.i = phi i32 [ %11, %if.else.i ], [ %spec.select7.i, %if.then65.i ]
  store i32 %.sink.i, ptr %arrayidx7.i, align 4, !tbaa !20
  br label %if.end148.i

if.end148.i:                                      ; preds = %if.end147.i, %if.then.i
  %invariant.gep11.i = getelementptr [2500 x i32], ptr %invariant.gep.i, i64 0, i64 %indvars.iv.next17.i
  br label %for.cond150.i

for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  %indvars.iv.i8 = phi i64 [ %indvars.iv.next.i9, %for.body153.i ], [ %1, %if.end148.i ]
  %cmp151.i = icmp slt i64 %indvars.iv.i8, %indvars.iv16.i
  br i1 %cmp151.i, label %for.body153.i, label %for.cond1.i5, !llvm.loop !24

for.body153.i:                                    ; preds = %for.cond150.i
  %indvars.iv.next.i9 = add nuw nsw i64 %indvars.iv.i8, 1
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv14.i, i64 %indvars.iv.next.i9
  %12 = load i32, ptr %arrayidx161.i, align 4, !tbaa !20, !invariant.load !9
  %gep12.i = getelementptr [2500 x i32], ptr %invariant.gep11.i, i64 %indvars.iv.i8
  %13 = load i32, ptr %gep12.i, align 4, !tbaa !20, !invariant.load !9
  %add167.i = add nsw i32 %13, %12
  %spec.select10.i = tail call i32 @llvm.smax.i32(i32 %5, i32 %add167.i)
  store i32 %spec.select10.i, ptr %arrayidx7.i, align 4, !tbaa !20
  br label %for.cond150.i, !llvm.loop !25

for.inc195.i:                                     ; preds = %for.cond1.i5
  %indvars.iv.next15.i = add nsw i64 %indvars.iv14.i, -1
  br label %for.cond.i4, !llvm.loop !26

kernel_nussinov.exit:                             ; preds = %for.cond.i4
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef readonly captures(none) %call1) #12
  br label %if.end
...
define internal fastcc void @print_array(ptr nofree noundef readonly captures(none) %table) unnamed_addr #8 {
entry:
