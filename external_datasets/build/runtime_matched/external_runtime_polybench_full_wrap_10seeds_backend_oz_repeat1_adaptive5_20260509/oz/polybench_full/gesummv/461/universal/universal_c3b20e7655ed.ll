...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %alpha) #20
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %beta) #20
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #13
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #13
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #13
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #13
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #13
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call3) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %beta, ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %B, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %x) unnamed_addr #11 {
entry:
...
for.inc:                                          ; preds = %for.cond2
  ...
  %2 = add i32 %1, 1
  %rem6 = urem i32 %2, 1300
  %conv7 = uitofp nneg i32 %rem6 to double
  %div9 = fdiv double %conv7, 1.300000e+03
  %arrayidx13 = getelementptr inbounds nuw [1300 x double], ptr %A, i64 %indvars.iv14, i64 %indvars.iv
  store double %div9, ptr %arrayidx13, align 8, !tbaa !5
  %3 = add i32 %1, 2
  %rem16 = urem i32 %3, 1300
  %conv17 = uitofp nneg i32 %rem16 to double
  %div19 = fdiv double %conv17, 1.300000e+03
  %arrayidx23 = getelementptr inbounds nuw [1300 x double], ptr %B, i64 %indvars.iv14, i64 %indvars.iv
...
attributes #21 = { nofree noreturn nosync nounwind memory(write) }
