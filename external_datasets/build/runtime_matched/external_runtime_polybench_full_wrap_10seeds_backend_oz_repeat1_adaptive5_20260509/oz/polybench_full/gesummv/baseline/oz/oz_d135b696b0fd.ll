...
entry:
  ...
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8)
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8)
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8)
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc24.i, %entry
  %indvars.iv24.i = phi i64 [ %indvars.iv.next25.i, %for.inc24.i ], [ 0, %entry ]
  %exitcond27.not.i = icmp eq i64 %indvars.iv24.i, 1300
  br i1 %exitcond27.not.i, label %init_array.exit, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i
  %0 = trunc nuw nsw i64 %indvars.iv24.i to i32
  %conv.i = uitofp nneg i32 %0 to double
  %div.i = fdiv double %conv.i, 1.300000e+03
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv24.i
  store double %div.i, ptr %arrayidx.i, align 8, !tbaa !5
  br label %for.cond2.i

for.cond2.i:                                      ; preds = %for.body5.i, %for.body.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body5.i ], [ 0, %for.body.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, 1300
  br i1 %exitcond.not.i, label %for.inc24.i, label %for.body5.i

for.body5.i:                                      ; preds = %for.cond2.i
  %1 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv24.i
  %2 = trunc i64 %1 to i32
  %3 = add i32 %2, 1
  %rem6.i = urem i32 %3, 1300
  %conv7.i = uitofp nneg i32 %rem6.i to double
  %div9.i = fdiv double %conv7.i, 1.300000e+03
  %arrayidx13.i = getelementptr inbounds nuw [1300 x double], ptr %call, i64 %indvars.iv24.i, i64 %indvars.iv.i
  ...
  %arrayidx23.i = getelementptr inbounds nuw [1300 x double], ptr %call1, i64 %indvars.iv24.i, i64 %indvars.iv.i
  store double %div19.i, ptr %arrayidx23.i, align 8, !tbaa !5
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond2.i, !llvm.loop !17

for.inc24.i:                                      ; preds = %for.cond2.i
...
for.cond.i12:                                     ; preds = %for.end.i, %init_array.exit
  %indvars.iv28.i = phi i64 [ %indvars.iv.next29.i, %for.end.i ], [ 0, %init_array.exit ]
  %exitcond31.not.i = icmp eq i64 %indvars.iv28.i, 1300
  br i1 %exitcond31.not.i, label %kernel_gesummv.exit, label %for.body.i13

for.body.i13:                                     ; preds = %for.cond.i12
  %arrayidx.i14 = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv28.i
  store double 0.000000e+00, ptr %arrayidx.i14, align 8, !tbaa !5
  %arrayidx2.i = getelementptr inbounds nuw double, ptr %call4, i64 %indvars.iv28.i
  store double 0.000000e+00, ptr %arrayidx2.i, align 8, !tbaa !5
  br label %for.cond3.i

for.cond3.i:                                      ; preds = %for.body5.i17, %for.body.i13
  %5 = phi double [ %13, %for.body5.i17 ], [ 0.000000e+00, %for.body.i13 ]
  %indvars.iv.i15 = phi i64 [ %indvars.iv.next.i18, %for.body5.i17 ], [ 0, %for.body.i13 ]
  %exitcond.not.i16 = icmp eq i64 %indvars.iv.i15, 1300
  br i1 %exitcond.not.i16, label %for.end.i, label %for.body5.i17

for.body5.i17:                                    ; preds = %for.cond3.i
  %arrayidx9.i = getelementptr inbounds nuw [1300 x double], ptr %call, i64 %indvars.iv28.i, i64 %indvars.iv.i15
  %6 = load double, ptr %arrayidx9.i, align 8, !tbaa !5
  %arrayidx11.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv.i15
  %7 = load double, ptr %arrayidx11.i, align 8, !tbaa !5
  %8 = load double, ptr %arrayidx.i14, align 8, !tbaa !5
  %9 = tail call double @llvm.fmuladd.f64(double %6, double %7, double %8)
  store double %9, ptr %arrayidx.i14, align 8, !tbaa !5
  %arrayidx19.i = getelementptr inbounds nuw [1300 x double], ptr %call1, i64 %indvars.iv28.i, i64 %indvars.iv.i15
  %10 = load double, ptr %arrayidx19.i, align 8, !tbaa !5
  %11 = load double, ptr %arrayidx11.i, align 8, !tbaa !5
  %12 = load double, ptr %arrayidx2.i, align 8, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %10, double %11, double %12)
  store double %13, ptr %arrayidx2.i, align 8, !tbaa !5
  %indvars.iv.next.i18 = add nuw nsw i64 %indvars.iv.i15, 1
  br label %for.cond3.i, !llvm.loop !20

for.end.i:                                        ; preds = %for.cond3.i
  %14 = load double, ptr %arrayidx.i14, align 8, !tbaa !5
  %mul30.i = fmul double %5, 1.200000e+00
  %15 = tail call double @llvm.fmuladd.f64(double %14, double 1.500000e+00, double %mul30.i)
  store double %15, ptr %arrayidx2.i, align 8, !tbaa !5
  %indvars.iv.next29.i = add nuw nsw i64 %indvars.iv28.i, 1
  br label %for.cond.i12, !llvm.loop !21

kernel_gesummv.exit:                              ; preds = %for.cond.i12
...
land.lhs.true:                                    ; preds = %kernel_gesummv.exit
  %16 = load ptr, ptr %argv, align 8, !tbaa !22
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_gesummv.exit
