...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 3990000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #14
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #14
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1900, i32 noundef 8) #14
...
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %A, ptr nofree noundef nonnull writeonly captures(none) %x) unnamed_addr #11 {
entry:
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %exitcond.not, label %for.body10.preheader, label %for.inc

for.body10.preheader:                             ; preds = %for.cond
  store double 0.000000e+00, ptr %A, align 8, !tbaa !11
  br label %for.body10
