...
for.cond.i:                                       ; preds = %for.inc7.i, %entry
  ...
  %exitcond52.not.i = icmp eq i64 %indvars.iv47.i, 800
  br i1 %exitcond52.not.i, label %for.cond10.i, label %for.cond1.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.inc31.i
  %indvars.iv60.i = phi i64 [ %indvars.iv.next61.i, %for.inc31.i ], [ 0, %for.cond.i ]
  %exitcond64.not.i = icmp eq i64 %indvars.iv60.i, 1100
  br i1 %exitcond64.not.i, label %for.cond34.i, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv53.i = phi i64 [ %indvars.iv.next54.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond59.not.i = icmp eq i64 %indvars.iv53.i, 900
  br i1 %exitcond59.not.i, label %for.inc31.i, label %for.inc28.i

for.inc28.i:                                      ; preds = %for.cond14.i
  %indvars.iv.next54.i = add nuw nsw i64 %indvars.iv53.i, 1
  %3 = mul nuw nsw i64 %indvars.iv.next54.i, %indvars.iv60.i
  %4 = trunc nuw i64 %3 to i32
  %rem20.i = srem i32 %4, 900
  %conv21.i = uitofp nneg i32 %rem20.i to double
  %div23.i = fdiv double %conv21.i, 9.000000e+02
  %arrayidx27.i = getelementptr inbounds nuw [900 x double], ptr %call2, i64 %indvars.iv60.i, i64 %indvars.iv53.i
...
for.cond34.i:                                     ; preds = %for.cond10.i, %for.inc56.i
  %indvars.iv74.i = phi i64 [ %indvars.iv.next75.i, %for.inc56.i ], [ 0, %for.cond10.i ]
  %exitcond78.not.i = icmp eq i64 %indvars.iv74.i, 900
  br i1 %exitcond78.not.i, label %for.cond59.i, label %for.cond38.i

for.cond38.i:                                     ; preds = %for.cond34.i, %for.inc53.i
  %indvars.iv65.i = phi i64 [ %indvars.iv.next66.i, %for.inc53.i ], [ 0, %for.cond34.i ]
  %exitcond73.not.i = icmp eq i64 %indvars.iv65.i, 1200
  br i1 %exitcond73.not.i, label %for.inc56.i, label %for.inc53.i

for.inc53.i:                                      ; preds = %for.cond38.i
  %5 = add nuw nsw i64 %indvars.iv65.i, 3
  %6 = mul nuw nsw i64 %5, %indvars.iv74.i
  %7 = trunc i64 %6 to i32
  %8 = add i32 %7, 1
  %rem45.i = srem i32 %8, 1200
  %conv46.i = uitofp nneg i32 %rem45.i to double
  %div48.i = fdiv double %conv46.i, 1.200000e+03
  %arrayidx52.i = getelementptr inbounds nuw [1200 x double], ptr %call3, i64 %indvars.iv74.i, i64 %indvars.iv65.i
...
for.cond59.i:                                     ; preds = %for.cond34.i, %for.end79.i
  %indvars.iv86.i = phi i64 [ %indvars.iv.next87.i, %for.end79.i ], [ 0, %for.cond34.i ]
  %exitcond90.not.i = icmp eq i64 %indvars.iv86.i, 800
  br i1 %exitcond90.not.i, label %init_array.exit, label %for.cond63.i

for.cond63.i:                                     ; preds = %for.cond59.i, %for.inc77.i
  %indvars.iv79.i = phi i64 [ %indvars.iv.next80.i, %for.inc77.i ], [ 0, %for.cond59.i ]
  %exitcond85.not.i = icmp eq i64 %indvars.iv79.i, 1200
  br i1 %exitcond85.not.i, label %for.end79.i, label %for.inc77.i

for.inc77.i:                                      ; preds = %for.cond63.i
  %9 = add nuw nsw i64 %indvars.iv79.i, 2
  %10 = mul nuw nsw i64 %9, %indvars.iv86.i
  %11 = trunc nuw i64 %10 to i32
  %rem69.i = srem i32 %11, 1100
  %conv70.i = uitofp nneg i32 %rem69.i to double
  %div72.i = fdiv double %conv70.i, 1.100000e+03
  %arrayidx76.i = getelementptr inbounds nuw [1200 x double], ptr %call4, i64 %indvars.iv86.i, i64 %indvars.iv79.i
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nl, ptr noundef readonly captures(none) %D) unnamed_addr #9 {
entry:
