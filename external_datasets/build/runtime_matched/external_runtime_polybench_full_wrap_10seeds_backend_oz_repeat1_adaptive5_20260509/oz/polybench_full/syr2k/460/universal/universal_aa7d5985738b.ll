...
for.cond:                                         ; preds = %for.inc17, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.inc17 ], [ 0, %entry ]
  %exitcond16.not = icmp eq i64 %indvars.iv13, 1200
  br i1 %exitcond16.not, label %for.body23, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv13, i64 %indvars.iv
  ...
  %arrayidx16 = getelementptr inbounds nuw [1000 x double], ptr %B, i64 %indvars.iv13, i64 %indvars.iv
...
for.body23:                                       ; preds = %for.cond, %for.end40
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.end40 ], [ 0, %for.cond ]
  br label %for.cond24

for.cond24:                                       ; preds = %for.inc38, %for.body23
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %for.inc38 ], [ 0, %for.body23 ]
  %exitcond22.not = icmp eq i64 %indvars.iv17, 1200
  br i1 %exitcond22.not, label %for.end40, label %for.inc38

for.inc38:                                        ; preds = %for.cond24
  %4 = mul nuw nsw i64 %indvars.iv17, %indvars.iv23
  %5 = trunc i64 %4 to i32
  %6 = add i32 %5, 3
  %rem30 = urem i32 %6, 1200
  %conv31 = uitofp nneg i32 %rem30 to double
  %div33 = fdiv double %conv31, 1.000000e+03
  %arrayidx37 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv23, i64 %indvars.iv17
