...
for.cond:                                         ; preds = %for.end, %entry
  ...
  br i1 %exitcond15.not, label %for.body23, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv12, i64 %indvars.iv
  ...
  %arrayidx16 = getelementptr inbounds nuw [1000 x double], ptr %B, i64 %indvars.iv12, i64 %indvars.iv
...
for.cond24:                                       ; preds = %for.body27, %for.body23
  %indvars.iv16 = phi i64 [ %indvars.iv.next17, %for.body27 ], [ 0, %for.body23 ]
  %exitcond19.not = icmp eq i64 %indvars.iv16, 1200
  br i1 %exitcond19.not, label %for.body23, label %for.body27

for.body27:                                       ; preds = %for.cond24
  %arrayidx37 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 0, i64 %indvars.iv16
