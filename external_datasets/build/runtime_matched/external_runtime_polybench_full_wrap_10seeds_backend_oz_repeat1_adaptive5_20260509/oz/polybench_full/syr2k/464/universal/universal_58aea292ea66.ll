...
for.cond.i:                                       ; preds = %for.inc17.i, %entry
  ...
  %exitcond36.not.i = icmp eq i64 %indvars.iv31.i, 1200
  br i1 %exitcond36.not.i, label %for.cond20.i, label %for.cond1.i
...
for.cond20.i:                                     ; preds = %for.cond.i, %for.end40.i
  %indvars.iv44.i = phi i64 [ %indvars.iv.next45.i, %for.end40.i ], [ 0, %for.cond.i ]
  %exitcond48.not.i = icmp eq i64 %indvars.iv44.i, 1200
  br i1 %exitcond48.not.i, label %init_array.exit, label %for.cond24.i

for.cond24.i:                                     ; preds = %for.cond20.i, %for.inc38.i
  %indvars.iv37.i = phi i64 [ %indvars.iv.next38.i, %for.inc38.i ], [ 0, %for.cond20.i ]
  %exitcond43.not.i = icmp eq i64 %indvars.iv37.i, 1200
  br i1 %exitcond43.not.i, label %for.end40.i, label %for.inc38.i

for.inc38.i:                                      ; preds = %for.cond24.i
  %4 = mul nuw nsw i64 %indvars.iv37.i, %indvars.iv44.i
  %5 = trunc i64 %4 to i32
  %6 = add i32 %5, 3
  %rem30.i = srem i32 %6, 1200
  %conv31.i = uitofp nneg i32 %rem30.i to double
  %div33.i = fdiv double %conv31.i, 1.000000e+03
  %arrayidx37.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv44.i, i64 %indvars.iv37.i
  store double %div33.i, ptr %arrayidx37.i, align 8, !tbaa !11
  %indvars.iv.next38.i = add nuw nsw i64 %indvars.iv37.i, 1
  br label %for.cond24.i, !llvm.loop !18
...
define internal fastcc void @print_array(i32 noundef %n, ptr noundef readonly captures(none) %C) unnamed_addr #9 {
entry:
