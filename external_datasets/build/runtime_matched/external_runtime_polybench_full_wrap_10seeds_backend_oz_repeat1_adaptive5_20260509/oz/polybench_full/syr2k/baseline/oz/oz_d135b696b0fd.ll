...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8)
...
for.cond20.i:                                     ; preds = %for.cond.i, %for.inc41.i
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %for.inc41.i ], [ 0, %for.cond.i ]
  %exitcond44.not.i = icmp eq i64 %indvars.iv41.i, 1200
  br i1 %exitcond44.not.i, label %init_array.exit, label %for.cond24.i

for.cond24.i:                                     ; preds = %for.cond20.i, %for.body27.i
  %indvars.iv35.i = phi i64 [ %indvars.iv.next36.i, %for.body27.i ], [ 0, %for.cond20.i ]
  %exitcond40.not.i = icmp eq i64 %indvars.iv35.i, 1200
  br i1 %exitcond40.not.i, label %for.inc41.i, label %for.body27.i
...
for.body27.i:                                     ; preds = %for.cond24.i
  ...
  store double %div33.i, ptr %arrayidx37.i, align 8, !tbaa !5
  %indvars.iv.next36.i = add nuw nsw i64 %indvars.iv35.i, 1
  br label %for.cond24.i, !llvm.loop !20

for.inc41.i:                                      ; preds = %for.cond24.i
  %indvars.iv.next42.i = add nuw nsw i64 %indvars.iv41.i, 1
  br label %for.cond20.i, !llvm.loop !21
...
for.cond.i11:                                     ; preds = %for.inc42.i, %init_array.exit
  %indvars.iv38.i = phi i64 [ %indvars.iv.next39.i, %for.inc42.i ], [ 0, %init_array.exit ]
  %indvars.iv36.i = phi i64 [ %indvars.iv.next37.i, %for.inc42.i ], [ 1, %init_array.exit ]
  %exitcond43.not.i = icmp eq i64 %indvars.iv38.i, 1200
  br i1 %exitcond43.not.i, label %kernel_syr2k.exit, label %for.cond1.i12

for.cond1.i12:                                    ; preds = %for.cond.i11, %for.body3.i14
  %indvars.iv.i13 = phi i64 [ %indvars.iv.next.i15, %for.body3.i14 ], [ 0, %for.cond.i11 ]
  %exitcond.i = icmp eq i64 %indvars.iv.i13, %indvars.iv36.i
  br i1 %exitcond.i, label %for.cond6.i, label %for.body3.i14

for.body3.i14:                                    ; preds = %for.cond1.i12
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv38.i, i64 %indvars.iv.i13
  %7 = load double, ptr %arrayidx5.i, align 8, !tbaa !5
  ...
  br label %for.cond1.i12, !llvm.loop !22

for.cond6.i:                                      ; preds = %for.cond1.i12, %for.inc39.i
  %indvars.iv32.i = phi i64 [ %indvars.iv.next33.i, %for.inc39.i ], [ 0, %for.cond1.i12 ]
  %exitcond35.not.i = icmp eq i64 %indvars.iv32.i, 1000
  br i1 %exitcond35.not.i, label %for.inc42.i, label %for.cond9.preheader.i

for.cond9.preheader.i:                            ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [1000 x double], ptr %call2, i64 %indvars.iv38.i, i64 %indvars.iv32.i
  %arrayidx30.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv38.i, i64 %indvars.iv32.i
  br label %for.cond9.i

for.cond9.i:                                      ; preds = %for.body11.i, %for.cond9.preheader.i
  %indvars.iv27.i = phi i64 [ 0, %for.cond9.preheader.i ], [ %indvars.iv.next28.i, %for.body11.i ]
  %exitcond31.i = icmp eq i64 %indvars.iv27.i, %indvars.iv36.i
  br i1 %exitcond31.i, label %for.inc39.i, label %for.body11.i

for.body11.i:                                     ; preds = %for.cond9.i
  %arrayidx15.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv27.i, i64 %indvars.iv32.i
  %8 = load double, ptr %arrayidx15.i, align 8, !tbaa !5
  %mul16.i = fmul double %8, 1.500000e+00
  %9 = load double, ptr %arrayidx20.i, align 8, !tbaa !5
  %arrayidx25.i = getelementptr inbounds nuw [1000 x double], ptr %call2, i64 %indvars.iv27.i, i64 %indvars.iv32.i
  %10 = load double, ptr %arrayidx25.i, align 8, !tbaa !5
  %mul26.i = fmul double %10, 1.500000e+00
  %11 = load double, ptr %arrayidx30.i, align 8, !tbaa !5
  %mul31.i = fmul double %mul26.i, %11
  %12 = tail call double @llvm.fmuladd.f64(double %mul16.i, double %9, double %mul31.i)
  %arrayidx35.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv38.i, i64 %indvars.iv27.i
  %13 = load double, ptr %arrayidx35.i, align 8, !tbaa !5
  %add.i = fadd double %13, %12
  store double %add.i, ptr %arrayidx35.i, align 8, !tbaa !5
  %indvars.iv.next28.i = add nuw nsw i64 %indvars.iv27.i, 1
  br label %for.cond9.i, !llvm.loop !23

for.inc39.i:                                      ; preds = %for.cond9.i
  %indvars.iv.next33.i = add nuw nsw i64 %indvars.iv32.i, 1
  br label %for.cond6.i, !llvm.loop !24

for.inc42.i:                                      ; preds = %for.cond6.i
  %indvars.iv.next39.i = add nuw nsw i64 %indvars.iv38.i, 1
  %indvars.iv.next37.i = add nuw nsw i64 %indvars.iv36.i, 1
  br label %for.cond.i11, !llvm.loop !25

kernel_syr2k.exit:                                ; preds = %for.cond.i11
...
land.lhs.true:                                    ; preds = %kernel_syr2k.exit
  %14 = load ptr, ptr %argv, align 8, !tbaa !26
