...
for.cond24:                                       ; preds = %for.body27, %for.body23
  %indvars.iv26 = phi i64 [ %indvars.iv.next27, %for.body27 ], [ 0, %for.body23 ]
  %exitcond31.not = icmp eq i64 %indvars.iv26, 1200
  br i1 %exitcond31.not, label %for.end40, label %for.body27
...
for.body27:                                       ; preds = %for.cond24
  ...
  store double %div33, ptr %arrayidx37, align 8, !tbaa !11
