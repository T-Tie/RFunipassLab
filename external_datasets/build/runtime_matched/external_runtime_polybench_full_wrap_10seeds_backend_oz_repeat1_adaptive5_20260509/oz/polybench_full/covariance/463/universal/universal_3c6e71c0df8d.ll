...
for.body.i:                                       ; preds = %for.cond2.i, %entry
...
for.cond2.i:                                      ; preds = %for.body5.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.body.i, label %for.body5.i

for.body5.i:                                      ; preds = %for.cond2.i
  %arrayidx9.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 0, i64 %indvars.iv.i
  store double 0.000000e+00, ptr %arrayidx9.i, align 8, !tbaa !11, !noalias !15
