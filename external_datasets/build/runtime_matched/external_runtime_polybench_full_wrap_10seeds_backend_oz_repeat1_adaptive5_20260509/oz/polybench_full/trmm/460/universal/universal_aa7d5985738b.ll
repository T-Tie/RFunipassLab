...
for.cond.i:                                       ; preds = %for.inc27.i, %entry
  %indvars.iv8.i = phi i64 [ %indvars.iv.next9.i, %for.inc27.i ], [ 0, %entry ]
  %exitcond12.not.i = icmp eq i64 %indvars.iv8.i, 1000
  br i1 %exitcond12.not.i, label %init_array.exit, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i, %for.inc.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.i ], [ 0, %for.cond.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, %indvars.iv8.i
  br i1 %exitcond.not.i, label %for.end.i, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond1.i
  %0 = add nuw nsw i64 %indvars.iv.i, %indvars.iv8.i
  %1 = trunc nuw nsw i64 %0 to i32
  %rem.i = urem i32 %1, 1000
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.000000e+03
  %arrayidx6.i = getelementptr inbounds nuw [1000 x double], ptr %call, i64 %indvars.iv8.i, i64 %indvars.iv.i
...
for.end.i:                                        ; preds = %for.cond1.i
  %arrayidx10.i = getelementptr inbounds nuw [1000 x double], ptr %call, i64 %indvars.iv8.i, i64 %indvars.iv8.i
  store double 1.000000e+00, ptr %arrayidx10.i, align 8, !tbaa !5, !noalias !18
  %2 = add nuw nsw i64 %indvars.iv8.i, 1200
  br label %for.cond11.i

for.cond11.i:                                     ; preds = %for.inc24.i, %for.end.i
  %indvars.iv3.i = phi i64 [ %indvars.iv.next4.i, %for.inc24.i ], [ 0, %for.end.i ]
  %exitcond7.not.i = icmp eq i64 %indvars.iv3.i, 1200
  br i1 %exitcond7.not.i, label %for.inc27.i, label %for.inc24.i

for.inc24.i:                                      ; preds = %for.cond11.i
  %3 = sub nuw nsw i64 %2, %indvars.iv3.i
  %4 = trunc nuw nsw i64 %3 to i32
  %rem16.i = urem i32 %4, 1200
  %conv17.i = uitofp nneg i32 %rem16.i to double
  %div19.i = fdiv double %conv17.i, 1.200000e+03
  %arrayidx23.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv8.i, i64 %indvars.iv3.i
...
for.cond.i5:                                      ; preds = %for.inc28.i, %init_array.exit
  %indvars.iv.i6 = phi i64 [ %indvars.iv.next.i11, %for.inc28.i ], [ 0, %init_array.exit ]
  %exitcond9.not.i = icmp eq i64 %indvars.iv.i6, 1000
  br i1 %exitcond9.not.i, label %kernel_trmm.exit, label %for.cond1.i7

for.cond1.i7:                                     ; preds = %for.cond.i5, %for.inc25.i
  %indvars.iv4.i = phi i64 [ %indvars.iv.next5.i, %for.inc25.i ], [ 0, %for.cond.i5 ]
  %exitcond7.not.i8 = icmp eq i64 %indvars.iv4.i, 1200
  br i1 %exitcond7.not.i8, label %for.inc28.i, label %for.cond4.preheader.i

for.cond4.preheader.i:                            ; preds = %for.cond1.i7
  %arrayidx16.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv.i6, i64 %indvars.iv4.i
  br label %for.cond4.i

for.cond4.i:                                      ; preds = %for.inc.i10, %for.cond4.preheader.i
  %indvars.iv1.i = phi i64 [ %indvars.iv.i6, %for.cond4.preheader.i ], [ %indvars.iv.next2.i, %for.inc.i10 ]
  %exitcond.not.i9 = icmp eq i64 %indvars.iv1.i, 999
  br i1 %exitcond.not.i9, label %for.inc25.i, label %for.inc.i10

for.inc.i10:                                      ; preds = %for.cond4.i
  %indvars.iv.next2.i = add nuw nsw i64 %indvars.iv1.i, 1
  %arrayidx8.i = getelementptr inbounds nuw [1000 x double], ptr %call, i64 %indvars.iv.next2.i, i64 %indvars.iv.i6
  %5 = load double, ptr %arrayidx8.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx12.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv.next2.i, i64 %indvars.iv4.i
