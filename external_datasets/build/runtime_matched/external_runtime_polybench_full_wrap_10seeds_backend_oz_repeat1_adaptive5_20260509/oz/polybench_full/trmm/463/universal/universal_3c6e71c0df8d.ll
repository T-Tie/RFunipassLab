...
entry:
  ...
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #14
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call, ptr nofree noundef nonnull writeonly captures(none) %call1) #17
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %A, ptr nofree noundef nonnull writeonly captures(none) %B) unnamed_addr #8 {
entry:
...
for.body14:                                       ; preds = %for.cond11
  ...
  %1 = sub i32 1200, %0
  %rem163 = urem i32 %1, 1200
  %conv17 = uitofp nneg i32 %rem163 to double
