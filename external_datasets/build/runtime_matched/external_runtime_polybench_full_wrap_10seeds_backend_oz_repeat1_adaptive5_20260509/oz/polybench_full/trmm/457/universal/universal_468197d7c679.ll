...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %alpha) #20
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #15
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #15
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call1) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %A, ptr nofree noundef nonnull writeonly captures(none) %B) unnamed_addr #11 {
entry:
  store double 1.500000e+00, ptr %alpha, align 8, !tbaa !5
  br label %for.end

for.end:                                          ; preds = %for.cond11, %entry
...
for.cond11:                                       ; preds = %for.inc24, %for.end
  ...
  br i1 %exitcond.not, label %for.end, label %for.inc24

for.inc24:                                        ; preds = %for.cond11
  %0 = trunc i64 %indvars.iv to i32
  %1 = sub i32 1200, %0
  %rem161 = urem i32 %1, 1200
  %conv17 = uitofp nneg i32 %rem161 to double
  %div19 = fdiv double %conv17, 1.200000e+03
  %arrayidx23 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 0, i64 %indvars.iv
...
define internal fastcc void @outlined_ir_func_0() unnamed_addr #13 {
