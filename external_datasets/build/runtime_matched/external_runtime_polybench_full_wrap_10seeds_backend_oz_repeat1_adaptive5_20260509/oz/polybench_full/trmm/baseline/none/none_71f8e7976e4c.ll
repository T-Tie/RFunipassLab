; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/trmm/trmm.linked.bc'
...
entry:
  ...
  %arraydecay = getelementptr inbounds [1000 x [1000 x double]], ptr %2, i64 0, i64 0
  %3 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay2 = getelementptr inbounds [1000 x [1200 x double]], ptr %3, i64 0, i64 0
  call void @init_array(i32 noundef %0, i32 noundef %1, ptr noundef %alpha, ptr noundef %arraydecay, ptr noundef %arraydecay2)
  call void (...) @polybench_timer_start()
  %4 = load i32, ptr %m, align 4, !tbaa !5
  %5 = load i32, ptr %n, align 4, !tbaa !5
  %6 = load double, ptr %alpha, align 8, !tbaa !12
  %7 = load ptr, ptr %A, align 8, !tbaa !9
  %arraydecay3 = getelementptr inbounds [1000 x [1000 x double]], ptr %7, i64 0, i64 0
  %8 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay4 = getelementptr inbounds [1000 x [1200 x double]], ptr %8, i64 0, i64 0
  call void @kernel_trmm(i32 noundef %4, i32 noundef %5, double noundef %6, ptr noundef %arraydecay3, ptr noundef %arraydecay4)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call5 = call i32 @strcmp(ptr noundef %11, ptr noundef @.str.5) #11
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %14 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay6 = getelementptr inbounds [1000 x [1200 x double]], ptr %14, i64 0, i64 0
  call void @print_array(i32 noundef %12, i32 noundef %13, ptr noundef %arraydecay6)
  br label %if.end
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [1000 x double], ptr %9, i64 %idxprom
...
for.end:                                          ; preds = %for.cond1
  ...
  %arrayidx8 = getelementptr inbounds [1000 x double], ptr %13, i64 %idxprom7
  %15 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom9 = sext i32 %15 to i64
  %arrayidx10 = getelementptr inbounds [1000 x double], ptr %arrayidx8, i64 0, i64 %idxprom9
  store double 1.000000e+00, ptr %arrayidx10, align 8, !tbaa !12
  store i32 0, ptr %j, align 4, !tbaa !5
  br label %for.cond11
...
for.body14:                                       ; preds = %for.cond11
  ...
  %arrayidx21 = getelementptr inbounds [1200 x double], ptr %23, i64 %idxprom20
  %25 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom22 = sext i32 %25 to i64
  %arrayidx23 = getelementptr inbounds [1200 x double], ptr %arrayidx21, i64 0, i64 %idxprom22
...
; Function Attrs: nounwind uwtable
define internal void @kernel_trmm(i32 noundef %m, i32 noundef %n, double noundef %alpha, ptr noundef %A, ptr noundef %B) #0 {
entry:
  %m.addr = alloca i32, align 4
  %n.addr = alloca i32, align 4
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx = getelementptr inbounds [1000 x double], ptr %7, i64 %idxprom
  ...
  %arrayidx10 = getelementptr inbounds [1200 x double], ptr %11, i64 %idxprom9
  %13 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom11 = sext i32 %13 to i64
  %arrayidx12 = getelementptr inbounds [1200 x double], ptr %arrayidx10, i64 0, i64 %idxprom11
  %14 = load double, ptr %arrayidx12, align 8, !tbaa !12
  %15 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %16 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom13 = sext i32 %16 to i64
  %arrayidx14 = getelementptr inbounds [1200 x double], ptr %15, i64 %idxprom13
  %17 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom15 = sext i32 %17 to i64
  %arrayidx16 = getelementptr inbounds [1200 x double], ptr %arrayidx14, i64 0, i64 %idxprom15
  %18 = load double, ptr %arrayidx16, align 8, !tbaa !12
  %19 = call double @llvm.fmuladd.f64(double %10, double %14, double %18)
  store double %19, ptr %arrayidx16, align 8, !tbaa !12
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  %21 = load double, ptr %alpha.addr, align 8, !tbaa !12
  %22 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %23 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom17 = sext i32 %23 to i64
  %arrayidx18 = getelementptr inbounds [1200 x double], ptr %22, i64 %idxprom17
