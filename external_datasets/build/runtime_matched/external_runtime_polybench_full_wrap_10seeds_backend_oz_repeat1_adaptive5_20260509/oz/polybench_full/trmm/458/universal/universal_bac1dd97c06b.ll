...
entry:
  ...
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %call, ptr nofree noundef writeonly captures(none) %call1) #17
  unreachable
}
...
for.end:                                          ; preds = %entry, %for.end26
  %indvars.iv13 = phi i64 [ 0, %entry ], [ %indvars.iv.next14, %for.end26 ]
  store double 1.000000e+00, ptr %A, align 8, !tbaa !5
  %0 = add nuw i64 %indvars.iv13, 1200
  br label %for.cond11
...
for.inc24:                                        ; preds = %for.cond11
  ...
  %arrayidx23 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 %indvars.iv13, i64 %indvars.iv
