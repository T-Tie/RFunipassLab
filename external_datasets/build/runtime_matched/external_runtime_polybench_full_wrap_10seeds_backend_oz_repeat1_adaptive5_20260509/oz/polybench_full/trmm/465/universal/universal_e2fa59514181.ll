...
if.then.i:                                        ; preds = %entry
  call void @outlined_ir_func_0() #16
...
entry:
  ...
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #22
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr nofree noundef writeonly captures(none) initializes((0, 8)) %A, ptr nofree noundef writeonly captures(none) %B) unnamed_addr #12 {
entry:
  store double 1.500000e+00, ptr %alpha, align 8, !tbaa !5
  br label %for.end

for.end:                                          ; preds = %entry, %for.end26
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.end26 ]
  store double 1.000000e+00, ptr %A, align 8, !tbaa !5
  %0 = add nuw i64 %indvars.iv8, 1200
  br label %for.cond11
...
for.cond11:                                       ; preds = %for.body14, %for.end
  ...
  br i1 %exitcond.not, label %for.end26, label %for.body14

for.body14:                                       ; preds = %for.cond11
  %1 = sub nuw i64 %0, %indvars.iv
  %2 = trunc nuw i64 %1 to i32
  %rem16 = srem i32 %2, 1200
  %conv17 = sitofp i32 %rem16 to double
  %div19 = fdiv double %conv17, 1.200000e+03
  %arrayidx23 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 %indvars.iv8, i64 %indvars.iv
  store double %div19, ptr %arrayidx23, align 8, !tbaa !5
...
define internal void @outlined_ir_func_0() #14 {
