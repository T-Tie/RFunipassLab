; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/jacobi-2d/jacobi-2d.linked.bc'
...
entry:
  ...
  %arraydecay2 = getelementptr inbounds [1300 x [1300 x double]], ptr %2, i64 0, i64 0
  ...
  %arraydecay3 = getelementptr inbounds [1300 x [1300 x double]], ptr %5, i64 0, i64 0
  %6 = load ptr, ptr %B, align 8, !tbaa !9
  %arraydecay4 = getelementptr inbounds [1300 x [1300 x double]], ptr %6, i64 0, i64 0
  call void @kernel_jacobi_2d(i32 noundef %3, i32 noundef %4, ptr noundef %arraydecay3, ptr noundef %arraydecay4)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arraydecay6 = getelementptr inbounds [1300 x [1300 x double]], ptr %11, i64 0, i64 0
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [1300 x double], ptr %8, i64 %idxprom
  %10 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom6 = sext i32 %10 to i64
  %arrayidx7 = getelementptr inbounds [1300 x double], ptr %arrayidx, i64 0, i64 %idxprom6
  ...
  %13 = call double @llvm.fmuladd.f64(double %conv8, double %conv10, double 3.000000e+00)
  %14 = load i32, ptr %n.addr, align 4, !tbaa !5
  %conv11 = sitofp i32 %14 to double
  %div12 = fdiv double %13, %conv11
  %15 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %16 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom13 = sext i32 %16 to i64
  %arrayidx14 = getelementptr inbounds [1300 x double], ptr %15, i64 %idxprom13
  %17 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom15 = sext i32 %17 to i64
  %arrayidx16 = getelementptr inbounds [1300 x double], ptr %arrayidx14, i64 0, i64 %idxprom15
  store double %div12, ptr %arrayidx16, align 8, !tbaa !12
  br label %for.inc
...
for.body7:                                        ; preds = %for.cond4
  ...
  %arrayidx = getelementptr inbounds [1300 x double], ptr %6, i64 %idxprom
  %8 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom8 = sext i32 %8 to i64
  %arrayidx9 = getelementptr inbounds [1300 x double], ptr %arrayidx, i64 0, i64 %idxprom8
  %9 = load double, ptr %arrayidx9, align 8, !tbaa !12
  %10 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %11 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom10 = sext i32 %11 to i64
  %arrayidx11 = getelementptr inbounds [1300 x double], ptr %10, i64 %idxprom10
  %12 = load i32, ptr %j, align 4, !tbaa !5
  %sub12 = sub nsw i32 %12, 1
  %idxprom13 = sext i32 %sub12 to i64
  %arrayidx14 = getelementptr inbounds [1300 x double], ptr %arrayidx11, i64 0, i64 %idxprom13
  %13 = load double, ptr %arrayidx14, align 8, !tbaa !12
  %add = fadd double %9, %13
  %14 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %15 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom15 = sext i32 %15 to i64
  %arrayidx16 = getelementptr inbounds [1300 x double], ptr %14, i64 %idxprom15
  %16 = load i32, ptr %j, align 4, !tbaa !5
  %add17 = add nsw i32 1, %16
  %idxprom18 = sext i32 %add17 to i64
  %arrayidx19 = getelementptr inbounds [1300 x double], ptr %arrayidx16, i64 0, i64 %idxprom18
  %17 = load double, ptr %arrayidx19, align 8, !tbaa !12
  %add20 = fadd double %add, %17
  %18 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %19 = load i32, ptr %i, align 4, !tbaa !5
  %add21 = add nsw i32 1, %19
  %idxprom22 = sext i32 %add21 to i64
  %arrayidx23 = getelementptr inbounds [1300 x double], ptr %18, i64 %idxprom22
  %20 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom24 = sext i32 %20 to i64
  %arrayidx25 = getelementptr inbounds [1300 x double], ptr %arrayidx23, i64 0, i64 %idxprom24
  %21 = load double, ptr %arrayidx25, align 8, !tbaa !12
  %add26 = fadd double %add20, %21
  %22 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %23 = load i32, ptr %i, align 4, !tbaa !5
  %sub27 = sub nsw i32 %23, 1
  %idxprom28 = sext i32 %sub27 to i64
  %arrayidx29 = getelementptr inbounds [1300 x double], ptr %22, i64 %idxprom28
  %24 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom30 = sext i32 %24 to i64
  %arrayidx31 = getelementptr inbounds [1300 x double], ptr %arrayidx29, i64 0, i64 %idxprom30
  %25 = load double, ptr %arrayidx31, align 8, !tbaa !12
  ...
  %arrayidx34 = getelementptr inbounds [1300 x double], ptr %26, i64 %idxprom33
  %28 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom35 = sext i32 %28 to i64
  %arrayidx36 = getelementptr inbounds [1300 x double], ptr %arrayidx34, i64 0, i64 %idxprom35
  store double %mul, ptr %arrayidx36, align 8, !tbaa !12
  br label %for.inc
...
for.body47:                                       ; preds = %for.cond44
  %35 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %36 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom48 = sext i32 %36 to i64
  %arrayidx49 = getelementptr inbounds [1300 x double], ptr %35, i64 %idxprom48
  %37 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom50 = sext i32 %37 to i64
  %arrayidx51 = getelementptr inbounds [1300 x double], ptr %arrayidx49, i64 0, i64 %idxprom50
  %38 = load double, ptr %arrayidx51, align 8, !tbaa !12
  %39 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %40 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom52 = sext i32 %40 to i64
  %arrayidx53 = getelementptr inbounds [1300 x double], ptr %39, i64 %idxprom52
  %41 = load i32, ptr %j, align 4, !tbaa !5
  %sub54 = sub nsw i32 %41, 1
  %idxprom55 = sext i32 %sub54 to i64
  %arrayidx56 = getelementptr inbounds [1300 x double], ptr %arrayidx53, i64 0, i64 %idxprom55
  %42 = load double, ptr %arrayidx56, align 8, !tbaa !12
  %add57 = fadd double %38, %42
  %43 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %44 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom58 = sext i32 %44 to i64
  %arrayidx59 = getelementptr inbounds [1300 x double], ptr %43, i64 %idxprom58
  %45 = load i32, ptr %j, align 4, !tbaa !5
  %add60 = add nsw i32 1, %45
  %idxprom61 = sext i32 %add60 to i64
  %arrayidx62 = getelementptr inbounds [1300 x double], ptr %arrayidx59, i64 0, i64 %idxprom61
  %46 = load double, ptr %arrayidx62, align 8, !tbaa !12
  %add63 = fadd double %add57, %46
  %47 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %48 = load i32, ptr %i, align 4, !tbaa !5
  %add64 = add nsw i32 1, %48
  %idxprom65 = sext i32 %add64 to i64
  %arrayidx66 = getelementptr inbounds [1300 x double], ptr %47, i64 %idxprom65
  %49 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom67 = sext i32 %49 to i64
  %arrayidx68 = getelementptr inbounds [1300 x double], ptr %arrayidx66, i64 0, i64 %idxprom67
  %50 = load double, ptr %arrayidx68, align 8, !tbaa !12
  %add69 = fadd double %add63, %50
  %51 = load ptr, ptr %B.addr, align 8, !tbaa !9
  %52 = load i32, ptr %i, align 4, !tbaa !5
  %sub70 = sub nsw i32 %52, 1
  %idxprom71 = sext i32 %sub70 to i64
  %arrayidx72 = getelementptr inbounds [1300 x double], ptr %51, i64 %idxprom71
  %53 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom73 = sext i32 %53 to i64
  %arrayidx74 = getelementptr inbounds [1300 x double], ptr %arrayidx72, i64 0, i64 %idxprom73
  %54 = load double, ptr %arrayidx74, align 8, !tbaa !12
  %add75 = fadd double %add69, %54
  %mul76 = fmul double 2.000000e-01, %add75
  %55 = load ptr, ptr %A.addr, align 8, !tbaa !9
  %56 = load i32, ptr %i, align 4, !tbaa !5
  %idxprom77 = sext i32 %56 to i64
  %arrayidx78 = getelementptr inbounds [1300 x double], ptr %55, i64 %idxprom77
  %57 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom79 = sext i32 %57 to i64
  %arrayidx80 = getelementptr inbounds [1300 x double], ptr %arrayidx78, i64 0, i64 %idxprom79
  store double %mul76, ptr %arrayidx80, align 8, !tbaa !12
  br label %for.inc81

for.inc81:                                        ; preds = %for.body47
  %58 = load i32, ptr %j, align 4, !tbaa !5
  %inc82 = add nsw i32 %58, 1
  store i32 %inc82, ptr %j, align 4, !tbaa !5
  br label %for.cond44, !llvm.loop !35
...
for.inc87:                                        ; preds = %for.end86
  %60 = load i32, ptr %t, align 4, !tbaa !5
  %inc88 = add nsw i32 %60, 1
  store i32 %inc88, ptr %t, align 4, !tbaa !5
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %arrayidx = getelementptr inbounds [1300 x double], ptr %11, i64 %idxprom
  %13 = load i32, ptr %j, align 4, !tbaa !5
  %idxprom7 = sext i32 %13 to i64
  %arrayidx8 = getelementptr inbounds [1300 x double], ptr %arrayidx, i64 0, i64 %idxprom7
