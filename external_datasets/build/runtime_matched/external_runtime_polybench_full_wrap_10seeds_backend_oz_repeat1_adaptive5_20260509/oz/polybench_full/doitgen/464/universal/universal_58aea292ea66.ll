...
if.then.i:                                        ; preds = %entry
  call void @outlined_ir_func_1(ptr noundef nonnull dereferenceable(51) @.str.4) #16
...
for.cond:                                         ; preds = %for.end41, %entry
  %indvars.iv40 = phi i64 [ %indvars.iv.next41, %for.end41 ], [ 0, %entry ]
...
for.cond1:                                        ; preds = %for.cond, %for.inc39
  ...
  br i1 %exitcond39.not, label %for.end41, label %for.cond4
...
for.inc:                                          ; preds = %for.cond7
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %0, double %1, double 0.000000e+00) #18
...
for.cond25:                                       ; preds = %for.cond4, %for.inc36
  %indvars.iv29 = phi i64 [ %indvars.iv.next30, %for.inc36 ], [ 0, %for.cond4 ]
  %exitcond33.not = icmp eq i64 %indvars.iv29, %wide.trip.count27
  br i1 %exitcond33.not, label %for.inc39, label %for.inc36
...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 3360000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 160, i32 noundef 8) #16
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 25600, i32 noundef 8) #16
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc15.i, %entry
  %indvars.iv33.i = phi i64 [ %indvars.iv.next34.i, %for.inc15.i ], [ 0, %entry ]
  %exitcond38.not.i = icmp eq i64 %indvars.iv33.i, 150
  br i1 %exitcond38.not.i, label %for.cond18.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i, %for.inc12.i
  %indvars.iv26.i = phi i64 [ %indvars.iv.next27.i, %for.inc12.i ], [ 0, %for.cond.i ]
  %exitcond32.not.i = icmp eq i64 %indvars.iv26.i, 140
  br i1 %exitcond32.not.i, label %for.inc15.i, label %for.cond4.preheader.i

for.cond4.preheader.i:                            ; preds = %for.cond1.i
  %0 = mul nuw nsw i64 %indvars.iv26.i, %indvars.iv33.i
...
for.inc.i:                                        ; preds = %for.cond4.i
  ...
  %rem.i = srem i32 %2, 160
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.600000e+02
  %arrayidx11.i = getelementptr inbounds nuw [140 x [160 x double]], ptr %call, i64 %indvars.iv33.i, i64 %indvars.iv26.i, i64 %indvars.iv.i
...
for.cond18.i:                                     ; preds = %for.cond.i, %for.end37.i
  %indvars.iv45.i = phi i64 [ %indvars.iv.next46.i, %for.end37.i ], [ 0, %for.cond.i ]
  %exitcond49.not.i = icmp eq i64 %indvars.iv45.i, 160
  br i1 %exitcond49.not.i, label %init_array.exit, label %for.cond22.i

for.cond22.i:                                     ; preds = %for.cond18.i, %for.inc35.i
  %indvars.iv39.i = phi i64 [ %indvars.iv.next40.i, %for.inc35.i ], [ 0, %for.cond18.i ]
  %exitcond44.not.i = icmp eq i64 %indvars.iv39.i, 160
  br i1 %exitcond44.not.i, label %for.end37.i, label %for.inc35.i

for.inc35.i:                                      ; preds = %for.cond22.i
  %3 = mul nuw nsw i64 %indvars.iv39.i, %indvars.iv45.i
  %4 = trunc nuw i64 %3 to i32
  %rem27.i = srem i32 %4, 160
  %conv28.i = uitofp nneg i32 %rem27.i to double
  %div30.i = fdiv double %conv28.i, 1.600000e+02
  %arrayidx34.i = getelementptr inbounds nuw [160 x double], ptr %call2, i64 %indvars.iv45.i, i64 %indvars.iv39.i
...
init_array.exit:                                  ; preds = %for.cond18.i
  tail call void @polybench_timer_start() #16
  unreachable
}
...
define internal fastcc void @print_array(i32 noundef %nr, i32 noundef %nq, i32 noundef %np, ptr noundef readonly captures(none) %A) unnamed_addr #10 {
entry:
  tail call void @outlined_ir_func_1(ptr nonnull @.str.1.6)
  %0 = load ptr, ptr @stderr, align 8, !tbaa !25
  %call1 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.2.7, ptr noundef nonnull @.str.3.8) #19
  %smax = tail call i32 @llvm.smax.i32(i32 %np, i32 0)
  %smax19 = tail call i32 @llvm.smax.i32(i32 %nq, i32 0)
  %smax26 = tail call i32 @llvm.smax.i32(i32 %nr, i32 0)
...
for.inc:                                          ; preds = %for.body7, %if.then
  ...
  %call17 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.5.10, double noundef %7) #19
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end23:                                        ; preds = %for.cond
  ...
  %call24 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3.8) #19
  tail call void @outlined_ir_func_1(ptr nonnull @.str.7)
  ret void
}

; Function Attrs: cold minsize nounwind optsize uwtable
define internal void @outlined_ir_func_1(ptr %0) #11 {
if.then_after_outline.exitStub:
  %1 = load ptr, ptr @stderr, align 8, !tbaa !25
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef %0) #19
  ret void
}
...
attributes #11 = { cold minsize nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
