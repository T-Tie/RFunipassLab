...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1, ptr nofree noundef writeonly captures(none) %call2) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %R, ptr nofree noundef writeonly captures(none) %Q) unnamed_addr #11 {
entry:
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc12, %entry
  ...
  br i1 %exitcond19.not, label %for.body18, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %0 = mul nuw nsw i64 %indvars.iv, %indvars.iv16
  ...
  %arrayidx7 = getelementptr inbounds nuw [1200 x double], ptr %A, i64 %indvars.iv16, i64 %indvars.iv
  store double %2, ptr %arrayidx7, align 8, !tbaa !5
  %arrayidx11 = getelementptr inbounds nuw [1200 x double], ptr %Q, i64 %indvars.iv16, i64 %indvars.iv
...
for.body18:                                       ; preds = %for.cond, %for.end29
  %indvars.iv24 = phi i64 [ %indvars.iv.next25, %for.end29 ], [ 0, %for.cond ]
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc27, %for.body18
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.inc27 ], [ 0, %for.body18 ]
  %exitcond23.not = icmp eq i64 %indvars.iv20, 1200
  br i1 %exitcond23.not, label %for.end29, label %for.inc27

for.inc27:                                        ; preds = %for.cond19
  %arrayidx26 = getelementptr inbounds nuw [1200 x double], ptr %R, i64 %indvars.iv24, i64 %indvars.iv20
