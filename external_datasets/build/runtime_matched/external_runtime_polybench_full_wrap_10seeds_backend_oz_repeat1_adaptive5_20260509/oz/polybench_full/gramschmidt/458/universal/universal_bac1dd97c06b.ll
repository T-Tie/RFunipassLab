...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #12
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #12
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #12
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc12.i, %entry
  %indvars.iv22.i = phi i64 [ %indvars.iv.next23.i, %for.inc12.i ], [ 0, %entry ]
  %exitcond25.not.i = icmp eq i64 %indvars.iv22.i, 1000
  br i1 %exitcond25.not.i, label %for.cond15.i, label %for.cond1.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  %0 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv22.i
  %1 = trunc nuw nsw i64 %0 to i32
  %rem.i = urem i32 %1, 1000
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.000000e+03
  %2 = tail call double @llvm.fmuladd.f64(double %div.i, double noundef 1.000000e+02, double noundef 1.000000e+01) #15
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv22.i, i64 %indvars.iv.i
  store double %2, ptr %arrayidx7.i, align 8, !tbaa !5
  %arrayidx11.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv22.i, i64 %indvars.iv.i
...
for.cond15.i:                                     ; preds = %for.cond.i, %for.inc30.i
  %indvars.iv30.i = phi i64 [ %indvars.iv.next31.i, %for.inc30.i ], [ 0, %for.cond.i ]
  %exitcond33.not.i = icmp eq i64 %indvars.iv30.i, 1200
  br i1 %exitcond33.not.i, label %init_array.exit, label %for.cond19.i

for.cond19.i:                                     ; preds = %for.cond15.i, %for.inc27.i
  %indvars.iv26.i = phi i64 [ %indvars.iv.next27.i, %for.inc27.i ], [ 0, %for.cond15.i ]
  %exitcond29.not.i = icmp eq i64 %indvars.iv26.i, 1200
  br i1 %exitcond29.not.i, label %for.inc30.i, label %for.inc27.i

for.inc27.i:                                      ; preds = %for.cond19.i
  %arrayidx26.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv30.i, i64 %indvars.iv26.i
...
for.cond.i6:                                      ; preds = %for.inc82.i, %init_array.exit
  %indvars.iv72.i = phi i64 [ %indvars.iv.next73.i, %for.inc82.i ], [ 0, %init_array.exit ]
  %exitcond79.not.i = icmp eq i64 %indvars.iv72.i, 1200
  br i1 %exitcond79.not.i, label %kernel_gramschmidt.exit, label %for.cond1.i7

for.cond1.i7:                                     ; preds = %for.cond.i6, %for.inc.i10
  %indvars.iv.i8 = phi i64 [ %indvars.iv.next.i11, %for.inc.i10 ], [ 0, %for.cond.i6 ]
  %nrm.0.i = phi double [ %4, %for.inc.i10 ], [ 0.000000e+00, %for.cond.i6 ]
  %exitcond.not.i9 = icmp eq i64 %indvars.iv.i8, 1000
  br i1 %exitcond.not.i9, label %for.end.i, label %for.inc.i10

for.inc.i10:                                      ; preds = %for.cond1.i7
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i8, i64 %indvars.iv72.i
  %3 = load double, ptr %arrayidx5.i, align 8, !tbaa !5, !invariant.load !9
  %4 = tail call double @llvm.fmuladd.f64(double %3, double %3, double %nrm.0.i) #15
  %indvars.iv.next.i11 = add nuw nsw i64 %indvars.iv.i8, 1
  br label %for.cond1.i7, !llvm.loop !22

for.end.i:                                        ; preds = %for.cond1.i7
  %call.i = tail call double @sqrt(double noundef %nrm.0.i) #12, !tbaa !23
  %arrayidx13.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv72.i, i64 %indvars.iv72.i
  store double %call.i, ptr %arrayidx13.i, align 8, !tbaa !5
  br label %for.cond14.i

for.cond14.i:                                     ; preds = %for.inc29.i, %for.end.i
  %indvars.iv60.i = phi i64 [ %indvars.iv.next61.i, %for.inc29.i ], [ 0, %for.end.i ]
  %exitcond63.not.i = icmp eq i64 %indvars.iv60.i, 1000
  br i1 %exitcond63.not.i, label %for.cond32.i, label %for.inc29.i

for.inc29.i:                                      ; preds = %for.cond14.i
  %arrayidx20.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv60.i, i64 %indvars.iv72.i
  %5 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !9
  %div.i12 = fdiv double %5, %call.i
  %arrayidx28.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv60.i, i64 %indvars.iv72.i
  store double %div.i12, ptr %arrayidx28.i, align 8, !tbaa !5
  %indvars.iv.next61.i = add nuw nsw i64 %indvars.iv60.i, 1
  br label %for.cond14.i, !llvm.loop !25

for.cond32.i:                                     ; preds = %for.cond57.i, %for.cond14.i
  %indvars.iv74.i = phi i64 [ %indvars.iv72.i, %for.cond14.i ], [ %indvars.iv.next75.i, %for.cond57.i ]
  %indvars.iv.next75.i = add nuw nsw i64 %indvars.iv74.i, 1
  %exitcond77.not.i = icmp eq i64 %indvars.iv74.i, 1199
  br i1 %exitcond77.not.i, label %for.inc82.i, label %for.body34.i

for.body34.i:                                     ; preds = %for.cond32.i
  %arrayidx38.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv72.i, i64 %indvars.iv.next75.i
...
for.cond39.i:                                     ; preds = %for.inc54.i, %for.body34.i
  %indvars.iv64.i = phi i64 [ %indvars.iv.next65.i, %for.inc54.i ], [ 0, %for.body34.i ]
  %exitcond67.not.i = icmp eq i64 %indvars.iv64.i, 1000
  br i1 %exitcond67.not.i, label %for.cond57.i, label %for.inc54.i

for.inc54.i:                                      ; preds = %for.cond39.i
  %arrayidx45.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv64.i, i64 %indvars.iv72.i
  %6 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx49.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv64.i, i64 %indvars.iv.next75.i
...
for.cond57.i:                                     ; preds = %for.cond39.i, %for.inc76.i
  %indvars.iv68.i = phi i64 [ %indvars.iv.next69.i, %for.inc76.i ], [ 0, %for.cond39.i ]
  %exitcond71.not.i = icmp eq i64 %indvars.iv68.i, 1000
  br i1 %exitcond71.not.i, label %for.cond32.i, label %for.inc76.i, !llvm.loop !27

for.inc76.i:                                      ; preds = %for.cond57.i
  %arrayidx63.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv68.i, i64 %indvars.iv.next75.i
  %9 = load double, ptr %arrayidx63.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx67.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv68.i, i64 %indvars.iv72.i
...
for.inc82.i:                                      ; preds = %for.cond32.i
  ...
  br label %for.cond.i6, !llvm.loop !29

kernel_gramschmidt.exit:                          ; preds = %for.cond.i6
  %call.i21 = tail call fastcc double @rtclock() #12
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef readonly captures(none) %call1, ptr nofree noundef readonly captures(none) %call2) #12
  br label %if.end
...
define internal fastcc void @print_array(ptr nofree noundef readonly captures(none) %R, ptr nofree noundef readonly captures(none) %Q) unnamed_addr #7 {
entry:
...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  %exitcond27.not = icmp eq i64 %indvars.iv22, 1200
  br i1 %exitcond27.not, label %for.end12, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond
  %1 = mul nuw nsw i64 %indvars.iv22, 1200
  br label %for.cond2
...
if.then:                                          ; preds = %for.body4
  ...
  %fputc19 = tail call i32 @fputc(i32 noundef 10, ptr noundef %4) #12
  br label %for.inc
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %call9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.5.10, double noundef %6) #16
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end12:                                        ; preds = %for.cond
  ...
  %call14 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str.2.7, ptr noundef nonnull @.str.7) #16
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc36, %for.end12
  %indvars.iv34 = phi i64 [ %indvars.iv.next35, %for.inc36 ], [ 0, %for.end12 ]
  %exitcond40.not = icmp eq i64 %indvars.iv34, 1000
  br i1 %exitcond40.not, label %for.end38, label %for.cond18.preheader

for.cond18.preheader:                             ; preds = %for.cond15
  %9 = mul nuw nsw i64 %indvars.iv34, 1200
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond18.preheader, %for.inc33
  %indvars.iv28 = phi i64 [ 0, %for.cond18.preheader ], [ %indvars.iv.next29, %for.inc33 ]
  %exitcond33.not = icmp eq i64 %indvars.iv28, 1200
  br i1 %exitcond33.not, label %for.inc36, label %for.body20

for.body20:                                       ; preds = %for.cond18
  %10 = add nuw nsw i64 %indvars.iv28, %9
  %11 = trunc i64 %10 to i32
  %rem23 = srem i32 %11, 20
  %cmp24 = icmp eq i32 %rem23, 0
  br i1 %cmp24, label %if.then25, label %for.inc33

if.then25:                                        ; preds = %for.body20
  %12 = load ptr, ptr @stderr, align 8, !tbaa !32
  %fputc = tail call i32 @fputc(i32 noundef 10, ptr noundef %12) #12
  br label %for.inc33
...
for.inc33:                                        ; preds = %for.body20, %if.then25
  ...
  %call32 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull @.str.5.10, double noundef %14) #16
...
for.end38:                                        ; preds = %for.cond15
  ...
  %call39 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %15, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7) #16
  tail call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(23) @.str.8) #12
  ret void
}
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(23) %0) unnamed_addr #8 {
if.then_after_outline.exitStub:
  %1 = load ptr, ptr @stderr, align 8, !tbaa !32
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull dereferenceable(23) %0) #16
  ret void
}
