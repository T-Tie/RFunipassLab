...
entry:
  ...
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 880000, i32 noundef 8) #14
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 990000, i32 noundef 8) #14
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1080000, i32 noundef 8) #14
  %call4 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 960000, i32 noundef 8) #14
  br label %for.cond.i
...
for.cond59.i:                                     ; preds = %for.cond34.i, %for.end79.i
  ...
  br i1 %exitcond44.not.i, label %init_array.exit, label %for.cond63.i
