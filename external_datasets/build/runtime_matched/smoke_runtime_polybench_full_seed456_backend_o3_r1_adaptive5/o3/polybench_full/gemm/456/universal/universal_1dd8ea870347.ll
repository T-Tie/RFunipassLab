...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1100000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #14
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1320000, i32 noundef 8) #14
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv9.i = phi i64 [ %indvars.iv.next10.i, %for.inc7.i ], [ 0, %entry ]
  %exitcond12.not.i = icmp eq i64 %indvars.iv9.i, 1000
  br i1 %exitcond12.not.i, label %for.cond10.i, label %for.cond1.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  %arrayidx6.i = getelementptr inbounds nuw [1100 x double], ptr %call, i64 %indvars.iv9.i, i64 %indvars.iv.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.inc31.i
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.inc31.i ], [ 0, %for.cond.i ]
  %exitcond21.not.i = icmp eq i64 %indvars.iv18.i, 1000
  br i1 %exitcond21.not.i, label %for.cond34.i, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv13.i = phi i64 [ %indvars.iv.next14.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond17.not.i = icmp eq i64 %indvars.iv13.i, 1200
  br i1 %exitcond17.not.i, label %for.inc31.i, label %for.inc28.i

for.inc28.i:                                      ; preds = %for.cond14.i
  %indvars.iv.next14.i = add nuw nsw i64 %indvars.iv13.i, 1
  %3 = mul nuw nsw i64 %indvars.iv.next14.i, %indvars.iv18.i
  %4 = trunc nuw nsw i64 %3 to i32
  %rem20.i = urem i32 %4, 1200
  %conv21.i = uitofp nneg i32 %rem20.i to double
  %div23.i = fdiv double %conv21.i, 1.200000e+03
  %arrayidx27.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv18.i, i64 %indvars.iv13.i
...
for.cond34.i:                                     ; preds = %for.cond10.i, %for.end54.i
  %indvars.iv28.i = phi i64 [ %indvars.iv.next29.i, %for.end54.i ], [ 0, %for.cond10.i ]
  %exitcond31.not.i = icmp eq i64 %indvars.iv28.i, 1200
  br i1 %exitcond31.not.i, label %init_array.exit, label %for.cond38.i

for.cond38.i:                                     ; preds = %for.cond34.i, %for.inc52.i
  %indvars.iv22.i = phi i64 [ %indvars.iv.next23.i, %for.inc52.i ], [ 0, %for.cond34.i ]
  %exitcond27.not.i = icmp eq i64 %indvars.iv22.i, 1100
  br i1 %exitcond27.not.i, label %for.end54.i, label %for.inc52.i

for.inc52.i:                                      ; preds = %for.cond38.i
  %5 = add nuw nsw i64 %indvars.iv22.i, 2
  %6 = mul nuw nsw i64 %5, %indvars.iv28.i
  %7 = trunc nuw nsw i64 %6 to i32
  %rem44.i = urem i32 %7, 1100
  %conv45.i = uitofp nneg i32 %rem44.i to double
  %div47.i = fdiv double %conv45.i, 1.100000e+03
  %arrayidx51.i = getelementptr inbounds nuw [1100 x double], ptr %call2, i64 %indvars.iv28.i, i64 %indvars.iv22.i
  store double %div47.i, ptr %arrayidx51.i, align 8, !tbaa !11
