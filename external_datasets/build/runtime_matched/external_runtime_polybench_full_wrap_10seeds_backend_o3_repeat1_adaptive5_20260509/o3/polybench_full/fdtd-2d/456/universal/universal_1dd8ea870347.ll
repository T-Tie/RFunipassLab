...
entry:
  ...
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 500, i32 noundef 8) #14
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.end38.i
  %indvars.iv10.i = phi i64 [ %indvars.iv.next11.i, %for.end38.i ], [ 0, %for.cond.i ]
  %exitcond13.not.i = icmp eq i64 %indvars.iv10.i, 1000
  br i1 %exitcond13.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.inc36.i
  %indvars.iv4.i = phi i64 [ %indvars.iv.next5.i, %for.inc36.i ], [ 0, %for.cond1.i ]
  %exitcond9.not.i = icmp eq i64 %indvars.iv4.i, 1200
  br i1 %exitcond9.not.i, label %for.end38.i, label %for.inc36.i

for.inc36.i:                                      ; preds = %for.cond5.i
  %indvars.iv.next5.i = add nuw nsw i64 %indvars.iv4.i, 1
  %1 = mul nuw nsw i64 %indvars.iv.next5.i, %indvars.iv10.i
  %2 = trunc nuw nsw i64 %1 to i32
  %mul.i = uitofp nneg i32 %2 to double
  %div.i = fdiv double %mul.i, 1.000000e+03
  %arrayidx15.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv10.i, i64 %indvars.iv4.i
  store double %div.i, ptr %arrayidx15.i, align 8, !tbaa !11
  %3 = add nuw nsw i64 %indvars.iv4.i, 2
  %4 = mul nuw nsw i64 %3, %indvars.iv10.i
  %5 = trunc nuw nsw i64 %4 to i32
  %mul19.i = uitofp nneg i32 %5 to double
  %div21.i = fdiv double %mul19.i, 1.200000e+03
  %arrayidx25.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv10.i, i64 %indvars.iv4.i
  store double %div21.i, ptr %arrayidx25.i, align 8, !tbaa !11
  %6 = add nuw nsw i64 %indvars.iv4.i, 3
  %7 = mul nuw nsw i64 %6, %indvars.iv10.i
  %8 = trunc nuw nsw i64 %7 to i32
  %mul29.i = uitofp nneg i32 %8 to double
  %div31.i = fdiv double %mul29.i, 1.000000e+03
  %arrayidx35.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv10.i, i64 %indvars.iv4.i
