...
if.then.i:                                        ; preds = %entry
  ...
  %2 = call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %1) #16
...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1, ptr nofree noundef writeonly captures(none) %call2, ptr nofree noundef writeonly captures(none) %call3) #18
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %ex, ptr nofree noundef writeonly captures(none) %ey, ptr nofree noundef writeonly captures(none) %hz, ptr nofree noundef writeonly captures(none) %_fict_) unnamed_addr #8 {
entry:
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %exitcond.not, label %for.body4, label %for.inc

for.inc:                                          ; preds = %for.cond
  %0 = trunc nuw nsw i64 %indvars.iv to i32
  %conv = uitofp nneg i32 %0 to double
  %arrayidx = getelementptr inbounds nuw double, ptr %_fict_, i64 %indvars.iv
  store double %conv, ptr %arrayidx, align 8, !tbaa !11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !17

for.body4:                                        ; preds = %for.cond, %for.end38
...
for.cond5:                                        ; preds = %for.inc36, %for.body4
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.inc36 ], [ 0, %for.body4 ]
  %exitcond17.not = icmp eq i64 %indvars.iv12, 1200
  br i1 %exitcond17.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond5
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %2 = trunc nuw nsw i64 %indvars.iv.next13 to i32
  %conv10 = uitofp nneg i32 %2 to double
  %mul = fmul double %conv9, %conv10
  %div = fdiv double %mul, 1.000000e+03
  %arrayidx15 = getelementptr inbounds nuw [1200 x double], ptr %ex, i64 %indvars.iv18, i64 %indvars.iv12
  store double %div, ptr %arrayidx15, align 8, !tbaa !11
  %3 = trunc i64 %indvars.iv12 to i32
  %4 = add i32 %3, 2
  %conv18 = uitofp nneg i32 %4 to double
  %mul19 = fmul double %conv9, %conv18
  %div21 = fdiv double %mul19, 1.200000e+03
  %arrayidx25 = getelementptr inbounds nuw [1200 x double], ptr %ey, i64 %indvars.iv18, i64 %indvars.iv12
  store double %div21, ptr %arrayidx25, align 8, !tbaa !11
  %5 = add i32 %3, 3
  %conv28 = uitofp nneg i32 %5 to double
  %mul29 = fmul double %conv9, %conv28
  %div31 = fdiv double %mul29, 1.000000e+03
  %arrayidx35 = getelementptr inbounds nuw [1200 x double], ptr %hz, i64 %indvars.iv18, i64 %indvars.iv12
  store double %div31, ptr %arrayidx35, align 8, !tbaa !11
