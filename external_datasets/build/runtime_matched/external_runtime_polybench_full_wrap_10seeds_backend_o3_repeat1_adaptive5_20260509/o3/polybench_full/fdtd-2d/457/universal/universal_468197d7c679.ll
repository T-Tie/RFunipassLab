...
entry:
  ...
  %call.i = call i32 @gettimeofday(ptr noundef nonnull align 8 captures(none) %Tp.i, ptr noundef null) #12
  %cmp.not.i = icmp eq i32 %call.i, 0
  br i1 %cmp.not.i, label %rtclock.exit, label %if.then.i

if.then.i:                                        ; preds = %entry
  %call1.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %call.i) #12
...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #12
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #12
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #12
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 500, i32 noundef 8) #12
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.end38.i
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.end38.i ], [ 0, %for.cond.i ]
  %exitcond14.not.i = icmp eq i64 %indvars.iv11.i, 1000
  br i1 %exitcond14.not.i, label %for.body.i.i.i, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.body8.i
  %indvars.iv5.i = phi i64 [ %indvars.iv.next6.i, %for.body8.i ], [ 0, %for.cond1.i ]
  %exitcond10.not.i = icmp eq i64 %indvars.iv5.i, 1200
  br i1 %exitcond10.not.i, label %for.end38.i, label %for.body8.i

for.body8.i:                                      ; preds = %for.cond5.i
  %indvars.iv.next6.i = add nuw nsw i64 %indvars.iv5.i, 1
  %1 = mul nuw nsw i64 %indvars.iv.next6.i, %indvars.iv11.i
  %2 = trunc nuw nsw i64 %1 to i32
  %mul.i = uitofp nneg i32 %2 to double
  %div.i = fdiv double %mul.i, 1.000000e+03
  %arrayidx15.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv11.i, i64 %indvars.iv5.i
  store double %div.i, ptr %arrayidx15.i, align 8, !tbaa !11
  %3 = add nuw nsw i64 %indvars.iv5.i, 2
  %4 = mul nuw nsw i64 %3, %indvars.iv11.i
  %5 = trunc nuw nsw i64 %4 to i32
  %mul19.i = uitofp nneg i32 %5 to double
  %div21.i = fdiv double %mul19.i, 1.200000e+03
  %arrayidx25.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv11.i, i64 %indvars.iv5.i
  store double %div21.i, ptr %arrayidx25.i, align 8, !tbaa !11
  %6 = add nuw nsw i64 %indvars.iv5.i, 3
  %7 = mul nuw nsw i64 %6, %indvars.iv11.i
  %8 = trunc nuw nsw i64 %7 to i32
  %mul29.i = uitofp nneg i32 %8 to double
  %div31.i = fdiv double %mul29.i, 1.000000e+03
  %arrayidx35.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv11.i, i64 %indvars.iv5.i
...
for.body.i.i.i:                                   ; preds = %for.cond1.i, %for.body.i.i.i
...
; Function Attrs: nofree nounwind
declare noundef i32 @fputc(i32 noundef, ptr noundef captures(none)) #12
