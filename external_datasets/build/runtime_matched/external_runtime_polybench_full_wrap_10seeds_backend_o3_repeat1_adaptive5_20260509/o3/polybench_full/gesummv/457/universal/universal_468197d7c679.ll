...
entry:
  ...
  %call = call i32 @gettimeofday(ptr noundef nonnull align 8 captures(none) %Tp, ptr noundef null) #12
  %cmp.not = icmp eq i32 %call, 0
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %call) #12
  br label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %conv2, double noundef 0x3EB0C6F7A0B5ED8D, double %conv) #15
...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #12
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #12
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #12
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #12
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #12
  store double 0.000000e+00, ptr %call3, align 8, !tbaa !5, !noalias !15
  br label %for.body5.i

for.body5.i:                                      ; preds = %for.body5.i, %entry
  store double 0x3F4934C67F9B2CE6, ptr %call, align 8, !tbaa !5, !noalias !15
  store double 0x3F5934C67F9B2CE6, ptr %call1, align 8, !tbaa !5, !noalias !15
  br label %for.body5.i
}
