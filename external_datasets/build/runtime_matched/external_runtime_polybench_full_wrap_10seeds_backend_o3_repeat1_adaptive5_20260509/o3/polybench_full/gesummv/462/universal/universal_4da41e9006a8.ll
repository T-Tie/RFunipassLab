...
entry:
  ...
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #15
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #15
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #15
  store double 0.000000e+00, ptr %call3, align 8, !tbaa !11, !noalias !15
  br label %for.body5.i

for.body5.i:                                      ; preds = %for.body5.i, %entry
  store double 0x3F4934C67F9B2CE6, ptr %call, align 8, !tbaa !11, !noalias !15
  store double 0x3F5934C67F9B2CE6, ptr %call1, align 8, !tbaa !11, !noalias !15
  br label %for.body5.i
}
