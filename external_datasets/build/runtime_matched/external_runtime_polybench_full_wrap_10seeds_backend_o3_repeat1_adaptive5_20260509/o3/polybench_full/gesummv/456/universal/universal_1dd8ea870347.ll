...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #13
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #13
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #13
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #13
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 1300, i32 noundef 8) #13
  store double 0.000000e+00, ptr %call3, align 8, !tbaa !5, !noalias !18
  br label %for.body5.i

for.body5.i:                                      ; preds = %for.body5.i, %entry
  store double 0x3F4934C67F9B2CE6, ptr %call, align 8, !tbaa !5, !noalias !18
  store double 0x3F5934C67F9B2CE6, ptr %call1, align 8, !tbaa !5, !noalias !18
  br label %for.body5.i
}
...
if.then_after_outline.exitStub:
  ...
  %1 = tail call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %0) #16
  ret void
}
...
!21 = distinct !{!21, !20, !"init_array: %beta"}
!22 = !{!23, !23, i64 0}
