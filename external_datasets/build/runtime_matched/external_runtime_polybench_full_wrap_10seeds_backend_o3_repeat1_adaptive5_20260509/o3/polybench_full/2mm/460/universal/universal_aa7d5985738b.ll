...
entry:
  ...
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 880000, i32 noundef 8) #15
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 990000, i32 noundef 8) #15
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1080000, i32 noundef 8) #15
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 960000, i32 noundef 8) #15
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.inc7.i ], [ 0, %entry ]
  %exitcond22.not.i = icmp eq i64 %indvars.iv19.i, 800
  br i1 %exitcond22.not.i, label %for.cond10.i, label %for.cond1.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  %0 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv19.i
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem.i = urem i32 %2, 800
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 8.000000e+02
  %arrayidx6.i = getelementptr inbounds nuw [1100 x double], ptr %call1, i64 %indvars.iv19.i, i64 %indvars.iv.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.inc31.i
  %indvars.iv28.i = phi i64 [ %indvars.iv.next29.i, %for.inc31.i ], [ 0, %for.cond.i ]
  %exitcond31.not.i = icmp eq i64 %indvars.iv28.i, 1100
  br i1 %exitcond31.not.i, label %for.cond34.i, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond27.not.i = icmp eq i64 %indvars.iv23.i, 900
  br i1 %exitcond27.not.i, label %for.inc31.i, label %for.inc28.i

for.inc28.i:                                      ; preds = %for.cond14.i
  %indvars.iv.next24.i = add nuw nsw i64 %indvars.iv23.i, 1
  %3 = mul nuw nsw i64 %indvars.iv.next24.i, %indvars.iv28.i
  %4 = trunc nuw nsw i64 %3 to i32
  %rem20.i = urem i32 %4, 900
  %conv21.i = uitofp nneg i32 %rem20.i to double
  %div23.i = fdiv double %conv21.i, 9.000000e+02
  %arrayidx27.i = getelementptr inbounds nuw [900 x double], ptr %call2, i64 %indvars.iv28.i, i64 %indvars.iv23.i
...
for.cond34.i:                                     ; preds = %for.cond10.i, %for.inc56.i
  %indvars.iv39.i = phi i64 [ %indvars.iv.next40.i, %for.inc56.i ], [ 0, %for.cond10.i ]
  %exitcond42.not.i = icmp eq i64 %indvars.iv39.i, 900
  br i1 %exitcond42.not.i, label %for.cond59.i, label %for.cond38.i

for.cond38.i:                                     ; preds = %for.cond34.i, %for.inc53.i
  %indvars.iv32.i = phi i64 [ %indvars.iv.next33.i, %for.inc53.i ], [ 0, %for.cond34.i ]
  %exitcond38.not.i = icmp eq i64 %indvars.iv32.i, 1200
  br i1 %exitcond38.not.i, label %for.inc56.i, label %for.inc53.i

for.inc53.i:                                      ; preds = %for.cond38.i
  %5 = add nuw nsw i64 %indvars.iv32.i, 3
  %6 = mul nuw nsw i64 %5, %indvars.iv39.i
  %7 = trunc i64 %6 to i32
  %8 = add i32 %7, 1
  %rem45.i = urem i32 %8, 1200
  %conv46.i = uitofp nneg i32 %rem45.i to double
  %div48.i = fdiv double %conv46.i, 1.200000e+03
  %arrayidx52.i = getelementptr inbounds nuw [1200 x double], ptr %call3, i64 %indvars.iv39.i, i64 %indvars.iv32.i
...
for.cond59.i:                                     ; preds = %for.cond34.i, %for.end79.i
  %indvars.iv49.i = phi i64 [ %indvars.iv.next50.i, %for.end79.i ], [ 0, %for.cond34.i ]
  %exitcond52.not.i = icmp eq i64 %indvars.iv49.i, 800
  br i1 %exitcond52.not.i, label %init_array.exit, label %for.cond63.i

for.cond63.i:                                     ; preds = %for.cond59.i, %for.inc77.i
  %indvars.iv43.i = phi i64 [ %indvars.iv.next44.i, %for.inc77.i ], [ 0, %for.cond59.i ]
  %exitcond48.not.i = icmp eq i64 %indvars.iv43.i, 1200
  br i1 %exitcond48.not.i, label %for.end79.i, label %for.inc77.i

for.inc77.i:                                      ; preds = %for.cond63.i
  %9 = add nuw nsw i64 %indvars.iv43.i, 2
  %10 = mul nuw nsw i64 %9, %indvars.iv49.i
  %11 = trunc nuw nsw i64 %10 to i32
  %rem69.i = urem i32 %11, 1100
  %conv70.i = uitofp nneg i32 %rem69.i to double
  %div72.i = fdiv double %conv70.i, 1.100000e+03
  %arrayidx76.i = getelementptr inbounds nuw [1200 x double], ptr %call4, i64 %indvars.iv49.i, i64 %indvars.iv43.i
...
define internal void @outlined_ir_func_1() #9 {
