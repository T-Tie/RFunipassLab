...
entry:
  ...
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 880000, i32 noundef 8) #14
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 990000, i32 noundef 8) #14
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1080000, i32 noundef 8) #14
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 960000, i32 noundef 8) #14
  br label %for.cond.i
...
for.inc53.i:                                      ; preds = %for.cond38.i
  ...
  store double %div48.i, ptr %arrayidx52.i, align 8, !tbaa !5, !noalias !17
  %indvars.iv.next61.i = add nuw nsw i64 %indvars.iv60.i, 1
  br label %for.cond38.i, !llvm.loop !26

for.inc56.i:                                      ; preds = %for.cond38.i
  %indvars.iv.next68.i = add nuw nsw i64 %indvars.iv67.i, 1
  br label %for.cond34.i, !llvm.loop !27
...
for.inc77.i:                                      ; preds = %for.cond63.i
  ...
  store double %div72.i, ptr %arrayidx76.i, align 8, !tbaa !5, !noalias !17
  %indvars.iv.next72.i = add nuw nsw i64 %indvars.iv71.i, 1
  br label %for.cond63.i, !llvm.loop !28
...
for.cond.i4:                                      ; preds = %for.inc25.i, %init_array.exit
...
for.cond1.i5:                                     ; preds = %for.cond.i4, %for.inc22.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %for.inc22.i ], [ 0, %for.cond.i4 ]
...
for.cond6.i:                                      ; preds = %for.inc.i8, %for.body3.i
  ...
  br i1 %exitcond.not.i7, label %for.inc22.i, label %for.inc.i8

for.inc.i8:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [1100 x double], ptr %call1, i64 %indvars.iv31.i, i64 %indvars.iv.i6
  %12 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !29
  %mul.i = fmul double %12, 1.500000e+00
  %arrayidx16.i = getelementptr inbounds nuw [900 x double], ptr %call2, i64 %indvars.iv.i6, i64 %indvars.iv27.i
  %13 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !29
  %14 = tail call double @llvm.fmuladd.f64(double %mul.i, double %13, double noundef 0.000000e+00) #22
...
for.inc22.i:                                      ; preds = %for.cond6.i
  ...
  br label %for.cond1.i5, !llvm.loop !31

for.inc25.i:                                      ; preds = %for.cond1.i5
...
for.body33.i:                                     ; preds = %for.cond31.i
  ...
  %15 = load double, ptr %arrayidx37.i, align 8, !tbaa !5, !invariant.load !29
...
for.inc55.i:                                      ; preds = %for.cond39.i
  ...
  %16 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !29
  %arrayidx49.i = getelementptr inbounds nuw [1200 x double], ptr %call3, i64 %indvars.iv35.i, i64 %indvars.iv39.i
  %17 = load double, ptr %arrayidx49.i, align 8, !tbaa !5, !invariant.load !29
  ...
  br label %for.cond39.i, !llvm.loop !33

for.inc58.i:                                      ; preds = %for.cond39.i
  %indvars.iv.next40.i = add nuw nsw i64 %indvars.iv39.i, 1
  br label %for.cond31.i, !llvm.loop !34
...
land.lhs.true:                                    ; preds = %kernel_2mm.exit
  %19 = load ptr, ptr %argv, align 8, !tbaa !35, !invariant.load !29
  %strcmpload = load i8, ptr %19, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 800, i32 noundef 1200, ptr nofree noundef readonly captures(none) %call4) #23
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nl, ptr nofree noundef readonly captures(none) %D) unnamed_addr #12 {
entry:
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %6 = load double, ptr %arrayidx8, align 8, !tbaa !5, !invariant.load !29
