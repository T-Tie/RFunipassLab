...
entry:
  ...
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #16
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #18
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef writeonly captures(none) %x) unnamed_addr #8 {
entry:
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  br i1 %exitcond.not, label %for.body6, label %for.inc
...
for.inc:                                          ; preds = %for.cond
  ...
  store double %add, ptr %arrayidx, align 8, !tbaa !11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %for.cond, !llvm.loop !15

for.body6:                                        ; preds = %for.cond, %for.end21
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end21 ], [ 0, %for.cond ]
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc19, %for.body6
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.inc19 ], [ 0, %for.body6 ]
  %exitcond12.not = icmp eq i64 %indvars.iv8, 2100
  br i1 %exitcond12.not, label %for.end21, label %for.inc19

for.inc19:                                        ; preds = %for.cond7
  %1 = add nuw nsw i64 %indvars.iv8, %indvars.iv13
  %2 = trunc nuw i64 %1 to i32
  %rem = urem i32 %2, 2100
  %conv12 = uitofp nneg i32 %rem to double
  %div14 = fdiv double %conv12, 9.500000e+03
  %arrayidx18 = getelementptr inbounds nuw [2100 x double], ptr %A, i64 %indvars.iv13, i64 %indvars.iv8
  store double %div14, ptr %arrayidx18, align 8, !tbaa !11
