...
entry:
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !15
  %call.i8 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !18
  %call.i9 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !21
  %call.i10 = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #13, !noalias !24
  store double 1.000000e+00, ptr %call.i, align 8, !tbaa !11
  unreachable
}
