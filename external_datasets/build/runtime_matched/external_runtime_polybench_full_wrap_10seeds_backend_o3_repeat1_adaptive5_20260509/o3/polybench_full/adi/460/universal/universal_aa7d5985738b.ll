...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %u) #19
  call void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %u) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %v) #17
  call void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %v) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %p) #17
  call void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %p) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %q) #17
  call void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %q) #17
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %u, i64 %indvars.iv5, i64 %indvars.iv
...
define internal void @outlined_ir_func_2(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %0) #11 {
