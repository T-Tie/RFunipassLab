...
entry:
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #15, !noalias !15
  %call.i3 = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #15, !noalias !18
  %call.i4 = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #15, !noalias !21
  %call.i5 = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #15, !noalias !24
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.end.i ], [ 0, %entry ]
  %exitcond11.not.i = icmp eq i64 %indvars.iv7.i, 4096
  br i1 %exitcond11.not.i, label %init_array.exit, label %for.cond1.preheader.i

for.cond1.preheader.i:                            ; preds = %for.cond.i
  %0 = mul nuw nsw i64 %indvars.iv7.i, 313
...
for.inc.i:                                        ; preds = %for.cond1.i
  ...
  %arrayidx6.i = getelementptr inbounds nuw [2160 x float], ptr %call.i, i64 %indvars.iv7.i, i64 %indvars.iv.i
