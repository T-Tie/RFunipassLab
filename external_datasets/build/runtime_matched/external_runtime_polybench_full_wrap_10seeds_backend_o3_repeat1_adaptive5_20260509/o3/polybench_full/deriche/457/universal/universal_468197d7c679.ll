...
entry:
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #16
  %call.i2 = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #16
  %call.i3 = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #16
  %call.i4 = tail call ptr @polybench_alloc_data(i64 noundef 8847360, i32 noundef 4) #16
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv6.i = phi i64 [ %indvars.iv.next7.i, %for.end.i ], [ 0, %entry ]
  %exitcond10.not.i = icmp eq i64 %indvars.iv6.i, 4096
  br i1 %exitcond10.not.i, label %for.body.i.i.i, label %for.cond1.preheader.i

for.cond1.preheader.i:                            ; preds = %for.cond.i
  %0 = mul nuw nsw i64 %indvars.iv6.i, 313
...
for.body3.i:                                      ; preds = %for.cond1.i
  ...
  %arrayidx6.i = getelementptr inbounds nuw [2160 x float], ptr %call.i, i64 %indvars.iv6.i, i64 %indvars.iv.i
  store float %div.i, ptr %arrayidx6.i, align 4, !tbaa !15
...
if.then_after_outline.exitStub:
  ...
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull readonly captures(none) dereferenceable(51) @.str.4) #20
  ret void
}
...
attributes #20 = { cold nofree nounwind }
