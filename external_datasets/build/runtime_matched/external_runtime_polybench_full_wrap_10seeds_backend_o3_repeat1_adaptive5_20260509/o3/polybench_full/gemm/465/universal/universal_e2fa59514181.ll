...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1100000, i32 noundef 8) #18
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #18
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1320000, i32 noundef 8) #18
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv35.i = phi i64 [ %indvars.iv.next36.i, %for.end.i ], [ 0, %entry ]
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.end30.i
  %indvars.iv44.i = phi i64 [ %indvars.iv.next45.i, %for.end30.i ], [ 0, %for.cond.i ]
...
for.cond14.i:                                     ; preds = %for.cond10.i, %for.body17.i
  ...
  br i1 %exitcond43.not.i, label %for.end30.i, label %for.body17.i
...
for.cond34.i:                                     ; preds = %for.cond10.i, %for.end54.i
  ...
  br i1 %exitcond57.not.i, label %for.cond.i4, label %for.cond38.i
...
for.cond38.i:                                     ; preds = %for.cond34.i, %for.body41.i
  ...
  br i1 %exitcond53.not.i, label %for.end54.i, label %for.body41.i
...
for.cond.i4:                                      ; preds = %for.cond34.i, %for.end31.i
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %for.end31.i ], [ 0, %for.cond34.i ]
...
for.cond1.i5:                                     ; preds = %for.cond.i4, %for.body3.i8
  ...
  br i1 %exitcond.not.i7, label %for.cond6.i, label %for.body3.i8
...
for.body3.i8:                                     ; preds = %for.cond1.i5
  ...
  %8 = load double, ptr %arrayidx5.i, align 8, !tbaa !11, !invariant.load !25
...
for.cond6.i:                                      ; preds = %for.cond1.i5, %for.end28.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.end28.i ], [ 0, %for.cond1.i5 ]
...
for.cond9.preheader.i:                            ; preds = %for.cond6.i
  ...
  %9 = load double, ptr %arrayidx15.i, align 8, !tbaa !11, !invariant.load !25
  %mul16.i = fmul double %9, 1.500000e+00
  br label %for.cond9.i

for.cond9.i:                                      ; preds = %for.body11.i, %for.cond9.preheader.i
  %indvars.iv15.i = phi i64 [ 0, %for.cond9.preheader.i ], [ %indvars.iv.next16.i, %for.body11.i ]
  %exitcond18.not.i = icmp eq i64 %indvars.iv15.i, 1100
  br i1 %exitcond18.not.i, label %for.end28.i, label %for.body11.i
...
land.lhs.true:                                    ; preds = %kernel_gemm.exit
  %13 = load ptr, ptr %argv, align 8, !tbaa !29, !invariant.load !25
  %strcmpload = load i8, ptr %13, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1000, i32 noundef 1100, ptr nofree noundef readonly captures(none) %call) #18
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nj, ptr nofree noundef readonly captures(none) %C) unnamed_addr #13 {
entry:
  ...
  %smax = call i32 @llvm.smax.i32(i32 %nj, i32 0)
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %6 = load double, ptr %arrayidx8, align 8, !tbaa !11, !invariant.load !25
