...
entry:
  ...
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1100000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1320000, i32 noundef 8) #16
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1, ptr nofree noundef writeonly captures(none) %call2) #19
  unreachable
}
...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %exitcond17.not = icmp eq i64 %indvars.iv14, 1000
  br i1 %exitcond17.not, label %for.cond10, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %0 = mul nuw nsw i64 %indvars.iv, %indvars.iv14
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem = urem i32 %2, 1000
  %conv = uitofp nneg i32 %rem to double
  %div = fdiv double %conv, 1.000000e+03
  %arrayidx6 = getelementptr inbounds nuw [1100 x double], ptr %C, i64 %indvars.iv14, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond, %for.inc31
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc31 ], [ 0, %for.cond ]
  %exitcond26.not = icmp eq i64 %indvars.iv23, 1000
  br i1 %exitcond26.not, label %for.body37, label %for.cond14

for.cond14:                                       ; preds = %for.cond10, %for.inc28
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc28 ], [ 0, %for.cond10 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, 1200
  br i1 %exitcond22.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond14
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %3 = mul nuw nsw i64 %indvars.iv.next19, %indvars.iv23
  %4 = trunc nuw nsw i64 %3 to i32
  %rem20 = urem i32 %4, 1200
  %conv21 = uitofp nneg i32 %rem20 to double
  %div23 = fdiv double %conv21, 1.200000e+03
  %arrayidx27 = getelementptr inbounds nuw [1200 x double], ptr %A, i64 %indvars.iv23, i64 %indvars.iv18
...
for.body37:                                       ; preds = %for.cond10, %for.end54
  %indvars.iv33 = phi i64 [ %indvars.iv.next34, %for.end54 ], [ 0, %for.cond10 ]
  br label %for.cond38

for.cond38:                                       ; preds = %for.inc52, %for.body37
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc52 ], [ 0, %for.body37 ]
  %exitcond32.not = icmp eq i64 %indvars.iv27, 1100
  br i1 %exitcond32.not, label %for.end54, label %for.inc52

for.inc52:                                        ; preds = %for.cond38
  %5 = add nuw nsw i64 %indvars.iv27, 2
  %6 = mul nuw nsw i64 %5, %indvars.iv33
  %7 = trunc nuw i64 %6 to i32
  %rem44 = urem i32 %7, 1100
  %conv45 = uitofp nneg i32 %rem44 to double
  %div47 = fdiv double %conv45, 1.100000e+03
  %arrayidx51 = getelementptr inbounds nuw [1100 x double], ptr %B, i64 %indvars.iv33, i64 %indvars.iv27
