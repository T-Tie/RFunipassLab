...
for.inc52.i:                                      ; preds = %for.cond38.i
  ...
  store double %div47.i, ptr %arrayidx51.i, align 8, !tbaa !5, !noalias !16
...
for.cond1.i4:                                     ; preds = %for.cond.i3, %for.inc.i7
  ...
  br i1 %exitcond.not.i6, label %for.cond6.i, label %for.inc.i7

for.inc.i7:                                       ; preds = %for.cond1.i4
  %arrayidx5.i = getelementptr inbounds nuw [1100 x double], ptr %call, i64 %indvars.iv23.i, i64 %indvars.iv.i5
  ...
  br label %for.cond1.i4, !llvm.loop !26

for.cond6.i:                                      ; preds = %for.cond1.i4, %for.inc29.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.inc29.i ], [ 0, %for.cond1.i4 ]
...
for.cond9.preheader.i:                            ; preds = %for.cond6.i
  ...
  %9 = load double, ptr %arrayidx15.i, align 8, !tbaa !5, !invariant.load !9
...
for.inc26.i:                                      ; preds = %for.cond9.i
  ...
  %10 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx25.i = getelementptr inbounds nuw [1100 x double], ptr %call, i64 %indvars.iv23.i, i64 %indvars.iv15.i
  %11 = load double, ptr %arrayidx25.i, align 8, !tbaa !5, !invariant.load !9
  %12 = tail call double @llvm.fmuladd.f64(double %mul16.i, double %10, double %11) #16
...
kernel_gemm.exit:                                 ; preds = %for.cond.i3
...
land.lhs.true:                                    ; preds = %kernel_gemm.exit
  %13 = load ptr, ptr %argv, align 8, !tbaa !29, !invariant.load !9
  %strcmpload = load i8, ptr %13, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1000, i32 noundef 1100, ptr nofree noundef readonly captures(none) %call) #13
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %ni, i32 noundef %nj, ptr nofree noundef readonly captures(none) %C) unnamed_addr #8 {
entry:
