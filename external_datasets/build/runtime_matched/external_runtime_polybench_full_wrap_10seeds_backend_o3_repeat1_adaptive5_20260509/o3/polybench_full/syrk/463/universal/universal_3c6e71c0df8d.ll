...
for.cond14:                                       ; preds = %for.body17, %for.body13
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.body17 ], [ 0, %for.body13 ]
  %exitcond17.not = icmp eq i64 %indvars.iv14, 1200
  br i1 %exitcond17.not, label %for.body13, label %for.body17

for.body17:                                       ; preds = %for.cond14
  %arrayidx27 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 0, i64 %indvars.iv14
