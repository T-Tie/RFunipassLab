...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  br i1 %exitcond9.not, label %for.body13, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv6, i64 %indvars.iv
...
for.body13:                                       ; preds = %for.cond14, %for.cond
  br label %for.cond14

for.cond14:                                       ; preds = %for.inc28, %for.body13
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %for.inc28 ], [ 0, %for.body13 ]
  %exitcond13.not = icmp eq i64 %indvars.iv10, 1200
  br i1 %exitcond13.not, label %for.body13, label %for.inc28

for.inc28:                                        ; preds = %for.cond14
  %arrayidx27 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 0, i64 %indvars.iv10
  store double 2.000000e-03, ptr %arrayidx27, align 8, !tbaa !11
