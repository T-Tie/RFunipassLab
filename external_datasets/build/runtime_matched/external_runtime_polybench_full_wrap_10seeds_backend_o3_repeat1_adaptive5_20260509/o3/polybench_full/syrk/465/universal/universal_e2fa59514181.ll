...
entry:
  ...
  %call.i = call i32 @gettimeofday(ptr noundef nonnull align 8 captures(none) %Tp.i, ptr noundef null) #16
  %cmp.not.i = icmp eq i32 %call.i, 0
  br i1 %cmp.not.i, label %rtclock.exit, label %if.then.i

if.then.i:                                        ; preds = %entry
  %call1.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %call.i) #16
...
define dso_local noundef i32 @main(i32 noundef %argc, ptr nofree noundef readnone captures(none) %argv) local_unnamed_addr #11 {
entry:
  %alpha = alloca double, align 8
  %beta = alloca double, align 8
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %alpha) #21
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %beta) #21
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #22
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %beta, ptr nofree noundef writeonly captures(none) %C, ptr nofree noundef writeonly captures(none) %A) unnamed_addr #12 {
entry:
...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %exitcond20.not = icmp eq i64 %indvars.iv17, 1200
  br i1 %exitcond20.not, label %for.body13, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv17, i64 %indvars.iv
...
for.body13:                                       ; preds = %for.cond, %for.end30
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.end30 ], [ 0, %for.cond ]
  br label %for.cond14

for.cond14:                                       ; preds = %for.body17, %for.body13
  %indvars.iv21 = phi i64 [ %indvars.iv.next22, %for.body17 ], [ 0, %for.body13 ]
  %exitcond26.not = icmp eq i64 %indvars.iv21, 1200
  br i1 %exitcond26.not, label %for.end30, label %for.body17

for.body17:                                       ; preds = %for.cond14
  %3 = mul nuw nsw i64 %indvars.iv21, %indvars.iv27
  %4 = trunc i64 %3 to i32
  %5 = add i32 %4, 2
  %rem20 = urem i32 %5, 1000
  %conv21 = uitofp nneg i32 %rem20 to double
  %div23 = fdiv double %conv21, 1.000000e+03
  %arrayidx27 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv27, i64 %indvars.iv21
...
define internal void @outlined_ir_func_1() #14 {
if.then_after_outline.exitStub:
  %0 = load ptr, ptr @stderr, align 8, !tbaa !19
  %1 = tail call i64 @fwrite(ptr nonnull @.str.4, i64 50, i64 1, ptr %0) #23
  ret void
}
...
attributes #11 = { nofree noreturn nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #12 = { nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #22 = { nofree noreturn nounwind }
attributes #23 = { cold }
