...
for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv24.i = phi i64 [ %indvars.iv.next25.i, %for.inc7.i ], [ 0, %entry ]
  %exitcond27.not.i = icmp eq i64 %indvars.iv24.i, 1200
  br i1 %exitcond27.not.i, label %for.cond10.i, label %for.cond1.i
...
for.inc.i:                                        ; preds = %for.cond1.i
  %0 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv24.i
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem.i = urem i32 %2, 1200
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.200000e+03
  %arrayidx6.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv24.i, i64 %indvars.iv.i
...
for.cond10.i:                                     ; preds = %for.cond.i, %for.end30.i
  %indvars.iv34.i = phi i64 [ %indvars.iv.next35.i, %for.end30.i ], [ 0, %for.cond.i ]
  %exitcond37.not.i = icmp eq i64 %indvars.iv34.i, 1200
  br i1 %exitcond37.not.i, label %init_array.exit, label %for.cond14.i

for.cond14.i:                                     ; preds = %for.cond10.i, %for.inc28.i
  %indvars.iv28.i = phi i64 [ %indvars.iv.next29.i, %for.inc28.i ], [ 0, %for.cond10.i ]
  %exitcond33.not.i = icmp eq i64 %indvars.iv28.i, 1200
  br i1 %exitcond33.not.i, label %for.end30.i, label %for.inc28.i

for.inc28.i:                                      ; preds = %for.cond14.i
  %3 = mul nuw nsw i64 %indvars.iv28.i, %indvars.iv34.i
  %4 = trunc i64 %3 to i32
  %5 = add i32 %4, 2
  %rem20.i = urem i32 %5, 1000
  %conv21.i = uitofp nneg i32 %rem20.i to double
  %div23.i = fdiv double %conv21.i, 1.000000e+03
  %arrayidx27.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv34.i, i64 %indvars.iv28.i
...
init_array.exit:                                  ; preds = %for.cond10.i
...
for.cond.i4:                                      ; preds = %for.end31.i, %init_array.exit
  %indvars.iv30.i = phi i64 [ %indvars.iv.next31.i, %for.end31.i ], [ 0, %init_array.exit ]
  %indvars.iv28.i5 = phi i64 [ %indvars.iv.next29.i13, %for.end31.i ], [ 1, %init_array.exit ]
  %exitcond35.not.i = icmp eq i64 %indvars.iv30.i, 1200
  br i1 %exitcond35.not.i, label %kernel_syrk.exit, label %for.cond1.i6

for.cond1.i6:                                     ; preds = %for.cond.i4, %for.inc.i8
  %indvars.iv.i7 = phi i64 [ %indvars.iv.next.i9, %for.inc.i8 ], [ 0, %for.cond.i4 ]
  %exitcond.i = icmp eq i64 %indvars.iv.i7, %indvars.iv28.i5
  br i1 %exitcond.i, label %for.cond6.i, label %for.inc.i8

for.inc.i8:                                       ; preds = %for.cond1.i6
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv30.i, i64 %indvars.iv.i7
  %6 = load double, ptr %arrayidx5.i, align 8, !tbaa !5, !invariant.load !25
  %mul.i = fmul double %6, 1.200000e+00
  store double %mul.i, ptr %arrayidx5.i, align 8, !tbaa !5
  %indvars.iv.next.i9 = add nuw nsw i64 %indvars.iv.i7, 1
  br label %for.cond1.i6, !llvm.loop !26

for.cond6.i:                                      ; preds = %for.cond1.i6, %for.inc29.i
  %indvars.iv24.i10 = phi i64 [ %indvars.iv.next25.i12, %for.inc29.i ], [ 0, %for.cond1.i6 ]
  %exitcond27.not.i11 = icmp eq i64 %indvars.iv24.i10, 1000
  br i1 %exitcond27.not.i11, label %for.end31.i, label %for.cond9.preheader.i

for.cond9.preheader.i:                            ; preds = %for.cond6.i
  %arrayidx15.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv30.i, i64 %indvars.iv24.i10
  %7 = load double, ptr %arrayidx15.i, align 8, !tbaa !5, !invariant.load !25
  %mul16.i = fmul double %7, 1.500000e+00
  br label %for.cond9.i

for.cond9.i:                                      ; preds = %for.inc26.i, %for.cond9.preheader.i
  %indvars.iv19.i = phi i64 [ 0, %for.cond9.preheader.i ], [ %indvars.iv.next20.i, %for.inc26.i ]
  %exitcond23.i = icmp eq i64 %indvars.iv19.i, %indvars.iv28.i5
  br i1 %exitcond23.i, label %for.inc29.i, label %for.inc26.i

for.inc26.i:                                      ; preds = %for.cond9.i
  %arrayidx20.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv19.i, i64 %indvars.iv24.i10
  %8 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !25
  %arrayidx25.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv30.i, i64 %indvars.iv19.i
  %9 = load double, ptr %arrayidx25.i, align 8, !tbaa !5, !invariant.load !25
  %10 = tail call double @llvm.fmuladd.f64(double %mul16.i, double %8, double %9) #22
  store double %10, ptr %arrayidx25.i, align 8, !tbaa !5
  %indvars.iv.next20.i = add nuw nsw i64 %indvars.iv19.i, 1
  br label %for.cond9.i, !llvm.loop !27

for.inc29.i:                                      ; preds = %for.cond9.i
  %indvars.iv.next25.i12 = add nuw nsw i64 %indvars.iv24.i10, 1
  br label %for.cond6.i, !llvm.loop !28

for.end31.i:                                      ; preds = %for.cond6.i
  %indvars.iv.next31.i = add nuw nsw i64 %indvars.iv30.i, 1
  %indvars.iv.next29.i13 = add nuw nsw i64 %indvars.iv28.i5, 1
  br label %for.cond.i4

kernel_syrk.exit:                                 ; preds = %for.cond.i4
...
land.lhs.true:                                    ; preds = %kernel_syrk.exit
  %11 = load ptr, ptr %argv, align 8, !tbaa !29, !invariant.load !25
  %strcmpload = load i8, ptr %11, align 1, !invariant.load !25
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_syrk.exit
