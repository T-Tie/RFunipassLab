...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  br i1 %exitcond13.not, label %for.body13, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %0 = mul nuw nsw i64 %indvars.iv, %indvars.iv10
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem = urem i32 %2, 1200
  %conv = uitofp nneg i32 %rem to double
  %div = fdiv double %conv, 1.200000e+03
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv10, i64 %indvars.iv
...
for.body13:                                       ; preds = %for.cond, %for.end30
  %indvars.iv20 = phi i64 [ %indvars.iv.next21, %for.end30 ], [ 0, %for.cond ]
  br label %for.cond14

for.cond14:                                       ; preds = %for.inc28, %for.body13
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %for.inc28 ], [ 0, %for.body13 ]
  %exitcond19.not = icmp eq i64 %indvars.iv14, 1200
  br i1 %exitcond19.not, label %for.end30, label %for.inc28

for.inc28:                                        ; preds = %for.cond14
  %3 = mul nuw nsw i64 %indvars.iv14, %indvars.iv20
  %4 = trunc i64 %3 to i32
  %5 = add i32 %4, 2
  %rem20 = urem i32 %5, 1000
  %conv21 = uitofp nneg i32 %rem20 to double
  %div23 = fdiv double %conv21, 1.000000e+03
  %arrayidx27 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv20, i64 %indvars.iv14
