...
for.cond:                                         ; preds = %for.inc7, %entry
  ...
  %exitcond7.not = icmp eq i64 %indvars.iv4, 1200
  br i1 %exitcond7.not, label %for.body17.preheader, label %for.cond1

for.body17.preheader:                             ; preds = %for.cond
  store double 2.000000e-03, ptr %C, align 8, !tbaa !11
  br label %for.body17
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv4, i64 %indvars.iv
