; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/syrk/syrk.linked.bc'
...
entry:
  ...
  %arraydecay2 = getelementptr inbounds [1200 x [1000 x double]], ptr %3, i64 0, i64 0
  call void @init_array(i32 noundef %0, i32 noundef %1, ptr noundef %alpha, ptr noundef %beta, ptr noundef %arraydecay, ptr noundef %arraydecay2)
  call void (...) @polybench_timer_start()
  %4 = load i32, ptr %n, align 4, !tbaa !5
  %5 = load i32, ptr %m, align 4, !tbaa !5
  %6 = load double, ptr %alpha, align 8, !tbaa !12
  %7 = load double, ptr %beta, align 8, !tbaa !12
  %8 = load ptr, ptr %C, align 8, !tbaa !9
  %arraydecay3 = getelementptr inbounds [1200 x [1200 x double]], ptr %8, i64 0, i64 0
  %9 = load ptr, ptr %A, align 8, !tbaa !9
  %arraydecay4 = getelementptr inbounds [1200 x [1000 x double]], ptr %9, i64 0, i64 0
  call void @kernel_syrk(i32 noundef %4, i32 noundef %5, double noundef %6, double noundef %7, ptr noundef %arraydecay3, ptr noundef %arraydecay4)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call5 = call i32 @strcmp(ptr noundef %12, ptr noundef @.str.5) #11
  %tobool = icmp ne i32 %call5, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %13 = load i32, ptr %n, align 4, !tbaa !5
  %14 = load ptr, ptr %C, align 8, !tbaa !9
  %arraydecay6 = getelementptr inbounds [1200 x [1200 x double]], ptr %14, i64 0, i64 0
  call void @print_array(i32 noundef %13, ptr noundef %arraydecay6)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %15 = load ptr, ptr %C, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define internal void @init_array(i32 noundef %n, i32 noundef %m, ptr noundef %alpha, ptr noundef %beta, ptr noundef %C, ptr noundef %A) #0 {
entry:
...
for.body17:                                       ; preds = %for.cond14
  ...
  %21 = load i32, ptr %m.addr, align 4, !tbaa !5
...
; Function Attrs: nounwind uwtable
define internal void @kernel_syrk(i32 noundef %n, i32 noundef %m, double noundef %alpha, double noundef %beta, ptr noundef %C, ptr noundef %A) #0 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx13 = getelementptr inbounds [1000 x double], ptr %15, i64 %idxprom12
  ...
  %arrayidx23 = getelementptr inbounds [1200 x double], ptr %23, i64 %idxprom22
  %25 = load i32, ptr %j, align 4, !tbaa !5
