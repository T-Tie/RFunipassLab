...
if.then.i:                                        ; preds = %entry
  call fastcc void @outlined_ir_func_1() #16
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %alpha) #18
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 dereferenceable(8) %beta) #18
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #16
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef nonnull writeonly captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call1, ptr nofree noundef nonnull writeonly captures(none) %call2) #19
  unreachable
}
...
for.cond:                                         ; preds = %for.inc17, %entry
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %for.inc17 ], [ 0, %entry ]
  %exitcond10.not = icmp eq i64 %indvars.iv7, 1200
  br i1 %exitcond10.not, label %for.body23, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv7, i64 %indvars.iv
  ...
  %arrayidx16 = getelementptr inbounds nuw [1000 x double], ptr %B, i64 %indvars.iv7, i64 %indvars.iv
...
for.body23:                                       ; preds = %for.cond24, %for.cond
  br label %for.cond24

for.cond24:                                       ; preds = %for.inc38, %for.body23
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %for.inc38 ], [ 0, %for.body23 ]
  %exitcond14.not = icmp eq i64 %indvars.iv11, 1200
  br i1 %exitcond14.not, label %for.body23, label %for.inc38

for.inc38:                                        ; preds = %for.cond24
  %arrayidx37 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 0, i64 %indvars.iv11
  store double 3.000000e-03, ptr %arrayidx37, align 8, !tbaa !11
