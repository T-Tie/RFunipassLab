; ModuleID = '/root/exp/RFunipassLab/external_datasets/build/ir_build/polybench_full/syr2k/syr2k.linked.bc'
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %16 = load ptr, ptr %C, align 8, !tbaa !9
  %arraydecay9 = getelementptr inbounds [1200 x [1200 x double]], ptr %16, i64 0, i64 0
  call void @print_array(i32 noundef %15, ptr noundef %arraydecay9)
  br label %if.end
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  ...
  %19 = load ptr, ptr %B, align 8, !tbaa !9
...
for.body27:                                       ; preds = %for.cond24
  ...
  %29 = load i32, ptr %m.addr, align 4, !tbaa !5
  %conv32 = sitofp i32 %29 to double
  %div33 = fdiv double %conv31, %conv32
  %30 = load ptr, ptr %C.addr, align 8, !tbaa !9
  ...
  store double %div33, ptr %arrayidx37, align 8, !tbaa !12
  br label %for.inc38
...
for.body11:                                       ; preds = %for.cond9
  ...
  %17 = load double, ptr %arrayidx15, align 8, !tbaa !12
  %18 = load double, ptr %alpha.addr, align 8, !tbaa !12
  ...
  %27 = load double, ptr %alpha.addr, align 8, !tbaa !12
  ...
  %36 = load double, ptr %arrayidx35, align 8, !tbaa !12
  %add = fadd double %36, %32
  store double %add, ptr %arrayidx35, align 8, !tbaa !12
  br label %for.inc36
