...
for.cond.i:                                       ; preds = %for.inc17.i, %entry
  %indvars.iv31.i = phi i64 [ %indvars.iv.next32.i, %for.inc17.i ], [ 0, %entry ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv31.i, 1200
  br i1 %exitcond34.not.i, label %for.cond20.i, label %for.cond1.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.inc.i
  ...
  br i1 %exitcond.not.i, label %for.inc17.i, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond1.i
  %0 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv31.i
  %1 = trunc i64 %0 to i32
  %2 = add i32 %1, 1
  %rem.i = urem i32 %2, 1200
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.200000e+03
  %arrayidx6.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv31.i, i64 %indvars.iv.i
  store double %div.i, ptr %arrayidx6.i, align 8, !tbaa !5, !noalias !17
  %3 = add i32 %1, 2
  %rem9.i = urem i32 %3, 1000
  %conv10.i = uitofp nneg i32 %rem9.i to double
  %div12.i = fdiv double %conv10.i, 1.000000e+03
  %arrayidx16.i = getelementptr inbounds nuw [1000 x double], ptr %call2, i64 %indvars.iv31.i, i64 %indvars.iv.i
  store double %div12.i, ptr %arrayidx16.i, align 8, !tbaa !5, !noalias !17
...
for.cond20.i:                                     ; preds = %for.cond.i, %for.end40.i
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %for.end40.i ], [ 0, %for.cond.i ]
  %exitcond44.not.i = icmp eq i64 %indvars.iv41.i, 1200
  br i1 %exitcond44.not.i, label %init_array.exit, label %for.cond24.i

for.cond24.i:                                     ; preds = %for.cond20.i, %for.inc38.i
  %indvars.iv35.i = phi i64 [ %indvars.iv.next36.i, %for.inc38.i ], [ 0, %for.cond20.i ]
  %exitcond40.not.i = icmp eq i64 %indvars.iv35.i, 1200
  br i1 %exitcond40.not.i, label %for.end40.i, label %for.inc38.i

for.inc38.i:                                      ; preds = %for.cond24.i
  %4 = mul nuw nsw i64 %indvars.iv35.i, %indvars.iv41.i
  %5 = trunc i64 %4 to i32
  %6 = add i32 %5, 3
  %rem30.i = urem i32 %6, 1200
  %conv31.i = uitofp nneg i32 %rem30.i to double
  %div33.i = fdiv double %conv31.i, 1.000000e+03
  %arrayidx37.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv41.i, i64 %indvars.iv35.i
  store double %div33.i, ptr %arrayidx37.i, align 8, !tbaa !5, !noalias !17
...
init_array.exit:                                  ; preds = %for.cond20.i
  %call.i = tail call fastcc double @rtclock() #14
  store double %call.i, ptr @polybench_t_start, align 8, !tbaa !5
  br label %for.cond.i4

for.cond.i4:                                      ; preds = %for.end41.i, %init_array.exit
  %indvars.iv35.i5 = phi i64 [ %indvars.iv.next36.i11, %for.end41.i ], [ 0, %init_array.exit ]
  %indvars.iv33.i = phi i64 [ %indvars.iv.next34.i, %for.end41.i ], [ 1, %init_array.exit ]
  %exitcond40.not.i6 = icmp eq i64 %indvars.iv35.i5, 1200
  br i1 %exitcond40.not.i6, label %kernel_syr2k.exit, label %for.cond1.i7

for.cond1.i7:                                     ; preds = %for.cond.i4, %for.inc.i9
  %indvars.iv.i8 = phi i64 [ %indvars.iv.next.i10, %for.inc.i9 ], [ 0, %for.cond.i4 ]
  %exitcond.i = icmp eq i64 %indvars.iv.i8, %indvars.iv33.i
  br i1 %exitcond.i, label %for.cond6.i, label %for.inc.i9

for.inc.i9:                                       ; preds = %for.cond1.i7
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv35.i5, i64 %indvars.iv.i8
  %7 = load double, ptr %arrayidx5.i, align 8, !tbaa !5, !invariant.load !25
  %mul.i = fmul double %7, 1.200000e+00
  store double %mul.i, ptr %arrayidx5.i, align 8, !tbaa !5
  %indvars.iv.next.i10 = add nuw nsw i64 %indvars.iv.i8, 1
  br label %for.cond1.i7, !llvm.loop !26

for.cond6.i:                                      ; preds = %for.cond1.i7, %for.inc39.i
  %indvars.iv29.i = phi i64 [ %indvars.iv.next30.i, %for.inc39.i ], [ 0, %for.cond1.i7 ]
  %exitcond32.not.i = icmp eq i64 %indvars.iv29.i, 1000
  br i1 %exitcond32.not.i, label %for.end41.i, label %for.cond9.preheader.i

for.cond9.preheader.i:                            ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [1000 x double], ptr %call2, i64 %indvars.iv35.i5, i64 %indvars.iv29.i
  %8 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !25
  %arrayidx30.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv35.i5, i64 %indvars.iv29.i
  %9 = load double, ptr %arrayidx30.i, align 8, !tbaa !5, !invariant.load !25
  br label %for.cond9.i

for.cond9.i:                                      ; preds = %for.inc36.i, %for.cond9.preheader.i
  %indvars.iv24.i = phi i64 [ 0, %for.cond9.preheader.i ], [ %indvars.iv.next25.i, %for.inc36.i ]
  %exitcond28.i = icmp eq i64 %indvars.iv24.i, %indvars.iv33.i
  br i1 %exitcond28.i, label %for.inc39.i, label %for.inc36.i

for.inc36.i:                                      ; preds = %for.cond9.i
  %arrayidx15.i = getelementptr inbounds nuw [1000 x double], ptr %call1, i64 %indvars.iv24.i, i64 %indvars.iv29.i
  %10 = load double, ptr %arrayidx15.i, align 8, !tbaa !5, !invariant.load !25
  %mul16.i = fmul double %10, 1.500000e+00
  %arrayidx25.i = getelementptr inbounds nuw [1000 x double], ptr %call2, i64 %indvars.iv24.i, i64 %indvars.iv29.i
  %11 = load double, ptr %arrayidx25.i, align 8, !tbaa !5, !invariant.load !25
  %mul26.i = fmul double %11, 1.500000e+00
  %mul31.i = fmul double %9, %mul26.i
  %12 = tail call double @llvm.fmuladd.f64(double %mul16.i, double %8, double %mul31.i) #22
  %arrayidx35.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv35.i5, i64 %indvars.iv24.i
  %13 = load double, ptr %arrayidx35.i, align 8, !tbaa !5, !invariant.load !25
  %add.i = fadd double %13, %12
  store double %add.i, ptr %arrayidx35.i, align 8, !tbaa !5
  %indvars.iv.next25.i = add nuw nsw i64 %indvars.iv24.i, 1
  br label %for.cond9.i, !llvm.loop !27

for.inc39.i:                                      ; preds = %for.cond9.i
  %indvars.iv.next30.i = add nuw nsw i64 %indvars.iv29.i, 1
  br label %for.cond6.i, !llvm.loop !28

for.end41.i:                                      ; preds = %for.cond6.i
  %indvars.iv.next36.i11 = add nuw nsw i64 %indvars.iv35.i5, 1
  %indvars.iv.next34.i = add nuw nsw i64 %indvars.iv33.i, 1
  br label %for.cond.i4

kernel_syr2k.exit:                                ; preds = %for.cond.i4
  %call.i19 = tail call fastcc double @rtclock() #14
...
land.lhs.true:                                    ; preds = %kernel_syr2k.exit
  %14 = load ptr, ptr %argv, align 8, !tbaa !29, !invariant.load !25
  %strcmpload = load i8, ptr %14, align 1, !invariant.load !25
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef readonly captures(none) %call) #23
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_syr2k.exit
...
define internal fastcc void @print_array(ptr nofree noundef readonly captures(none) %C) unnamed_addr #12 {
entry:
...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %exitcond16.not = icmp eq i64 %indvars.iv11, 1200
  br i1 %exitcond16.not, label %for.end12, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond
  %1 = mul nuw nsw i64 %indvars.iv11, 1200
  br label %for.cond2
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %arrayidx8 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv11, i64 %indvars.iv
  %5 = load double, ptr %arrayidx8, align 8, !tbaa !5, !invariant.load !25
  %call9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.5.10, double noundef %5) #24
...
for.end12:                                        ; preds = %for.cond
  ...
  %call13 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3.8) #24
