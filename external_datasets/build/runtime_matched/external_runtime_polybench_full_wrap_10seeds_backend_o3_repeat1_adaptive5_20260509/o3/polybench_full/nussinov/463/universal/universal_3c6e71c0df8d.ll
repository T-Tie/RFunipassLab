...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2500, i32 noundef 1) #11
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 6250000, i32 noundef 4) #11
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.end15.i
  %indvars.iv9.i = phi i64 [ %indvars.iv.next10.i, %for.end15.i ], [ 0, %for.cond.i ]
  %exitcond12.not.i = icmp eq i64 %indvars.iv9.i, 2500
  br i1 %exitcond12.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.body8.i
  %indvars.iv5.i = phi i64 [ %indvars.iv.next6.i, %for.body8.i ], [ 0, %for.cond1.i ]
  %exitcond8.not.i = icmp eq i64 %indvars.iv5.i, 2500
  br i1 %exitcond8.not.i, label %for.end15.i, label %for.body8.i

for.body8.i:                                      ; preds = %for.cond5.i
  %arrayidx12.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv9.i, i64 %indvars.iv5.i
  store i32 0, ptr %arrayidx12.i, align 4, !tbaa !20
  %indvars.iv.next6.i = add nuw nsw i64 %indvars.iv5.i, 1
  br label %for.cond5.i, !llvm.loop !22

for.end15.i:                                      ; preds = %for.cond5.i
...
for.cond.i5:                                      ; preds = %for.end194.i, %init_array.exit
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %for.end194.i ], [ 2499, %init_array.exit ]
  %1 = and i64 %indvars.iv19.i, 4294967295
  %cmp.i = icmp sgt i64 %indvars.iv19.i, -1
  br i1 %cmp.i, label %for.cond1.preheader.i, label %kernel_nussinov.exit

for.cond1.preheader.i:                            ; preds = %for.cond.i5
  %cmp28.i = icmp samesign ult i64 %indvars.iv19.i, 2499
  %2 = add nuw nsw i64 %indvars.iv19.i, 1
  %arrayidx77.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv19.i
  br label %for.cond1.i6

for.cond1.i6:                                     ; preds = %for.cond150.i, %for.cond1.preheader.i
  %indvars.iv21.i = phi i64 [ %indvars.iv19.i, %for.cond1.preheader.i ], [ %indvars.iv.next22.i, %for.cond150.i ]
  %indvars.iv.next22.i = add nuw nsw i64 %indvars.iv21.i, 1
  %exitcond.not.i7 = icmp eq i64 %indvars.iv21.i, 2499
  br i1 %exitcond.not.i7, label %for.end194.i, label %if.then.i

if.then.i:                                        ; preds = %for.cond1.i6
  %arrayidx7.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv19.i, i64 %indvars.iv.next22.i
  %3 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20, !invariant.load !9
  %arrayidx12.i8 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv19.i, i64 %indvars.iv21.i
  %4 = load i32, ptr %arrayidx12.i8, align 4, !tbaa !20, !invariant.load !9
  %cmp13.not.i = icmp slt i32 %3, %4
  %spec.select.i = select i1 %cmp13.not.i, i64 %indvars.iv21.i, i64 %indvars.iv.next22.i
  %idxprom21.i = and i64 %spec.select.i, 4294967295
  %arrayidx22.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv19.i, i64 %idxprom21.i
...
if.then62.i:                                      ; preds = %if.then.i
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv.next22.i
  %6 = load i32, ptr %arrayidx38.i, align 4, !tbaa !20, !invariant.load !9
  %cmp39.not.i = icmp slt i32 %5, %6
  %add279.i = zext i1 %cmp39.not.i to i64
  %spec.select11.i = add nuw nsw i64 %indvars.iv19.i, %add279.i
  %arrayidx50.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select11.i, i64 %indvars.iv.next22.i
  %7 = load i32, ptr %arrayidx50.i, align 4, !tbaa !20, !invariant.load !9
  %cmp64.i = icmp slt i64 %indvars.iv19.i, %indvars.iv21.i
  %8 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv21.i
  %9 = load i32, ptr %8, align 4, !tbaa !20, !invariant.load !9
  br i1 %cmp64.i, label %if.then65.i, label %if.else.i

if.then65.i:                                      ; preds = %if.then62.i
  %10 = load i8, ptr %arrayidx77.i, align 1, !tbaa !18, !invariant.load !9
  %conv.i11 = sext i8 %10 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv.next22.i
  %11 = load i8, ptr %arrayidx79.i, align 1, !tbaa !18, !invariant.load !9
  %conv80.i = sext i8 %11 to i32
  %add81.i = add nsw i32 %conv80.i, %conv.i11
  %cmp82.i = icmp eq i32 %add81.i, 3
  %cond84.i = zext i1 %cmp82.i to i32
  %add85.i = add nsw i32 %9, %cond84.i
  %spec.select12.i = tail call i32 @llvm.smax.i32(i32 %7, i32 %add85.i)
  br label %if.end147.i

if.else.i:                                        ; preds = %if.then62.i
  %cmp127.not.i = icmp slt i32 %7, %9
  %spec.select13.v.i = select i1 %cmp127.not.i, i64 %indvars.iv21.i, i64 %indvars.iv.next22.i
  %spec.select14.v.i = select i1 %cmp127.not.i, i64 %2, i64 %indvars.iv19.i
  %idxprom139.i = and i64 %spec.select13.v.i, 4294967295
  %arrayidx140.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select14.v.i, i64 %idxprom139.i
  %12 = load i32, ptr %arrayidx140.i, align 4, !tbaa !20, !invariant.load !9
  br label %if.end147.i

if.end147.i:                                      ; preds = %if.else.i, %if.then65.i
  %.sink.i = phi i32 [ %12, %if.else.i ], [ %spec.select12.i, %if.then65.i ]
  store i32 %.sink.i, ptr %arrayidx7.i, align 4, !tbaa !20
  br label %if.end148.i

if.end148.i:                                      ; preds = %if.end147.i, %if.then.i
  %invariant.gep16.i = getelementptr [2500 x i32], ptr %invariant.gep.i, i64 0, i64 %indvars.iv.next22.i
...
for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  ...
  %cmp151.i = icmp slt i64 %indvars.iv.i9, %indvars.iv21.i
  br i1 %cmp151.i, label %for.body153.i, label %for.cond1.i6, !llvm.loop !24

for.body153.i:                                    ; preds = %for.cond150.i
  %indvars.iv.next.i10 = add nuw nsw i64 %indvars.iv.i9, 1
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv19.i, i64 %indvars.iv.next.i10
  %13 = load i32, ptr %arrayidx161.i, align 4, !tbaa !20, !invariant.load !9
  %gep17.i = getelementptr [2500 x i32], ptr %invariant.gep16.i, i64 %indvars.iv.i9
  %14 = load i32, ptr %gep17.i, align 4, !tbaa !20, !invariant.load !9
  %add167.i = add nsw i32 %14, %13
  %spec.select15.i = tail call i32 @llvm.smax.i32(i32 %5, i32 %add167.i)
  store i32 %spec.select15.i, ptr %arrayidx7.i, align 4, !tbaa !20
  br label %for.cond150.i, !llvm.loop !25

for.end194.i:                                     ; preds = %for.cond1.i6
  %indvars.iv.next20.i = add nsw i64 %indvars.iv19.i, -1
  br label %for.cond.i5, !llvm.loop !26

kernel_nussinov.exit:                             ; preds = %for.cond.i5
  %call.i = tail call fastcc double @rtclock() #11
...
land.lhs.true:                                    ; preds = %kernel_nussinov.exit
  %15 = load ptr, ptr %argv, align 8, !tbaa !27, !invariant.load !9
  %strcmpload = load i8, ptr %15, align 1, !invariant.load !9
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(ptr nofree noundef nonnull readonly captures(none) %call1) #11
  br label %if.end
...
define internal fastcc void @print_array(ptr nofree noundef nonnull readonly captures(none) %table) unnamed_addr #7 {
entry:
  ...
  %call1 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.2.7, ptr noundef nonnull @.str.3.8) #14
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv4 = phi i32 [ %indvars.iv.next5, %for.end ], [ 2500, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.end ], [ 0, %entry ]
  %t.0 = phi i32 [ %3, %for.end ], [ 0, %entry ]
  %exitcond8.not = icmp eq i64 %indvars.iv, 2500
  br i1 %exitcond8.not, label %for.end13, label %for.cond2

for.cond2:                                        ; preds = %for.cond, %if.end
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %if.end ], [ %indvars.iv, %for.cond ]
  %t.1 = phi i32 [ %inc, %if.end ], [ %t.0, %for.cond ]
  %exitcond.not = icmp eq i64 %indvars.iv2, 2500
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %arrayidx8 = getelementptr inbounds nuw [2500 x i32], ptr %table, i64 %indvars.iv, i64 %indvars.iv2
  %2 = load i32, ptr %arrayidx8, align 4, !tbaa !20, !invariant.load !9
  %call9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.5.10, i32 noundef %2) #14
  %inc = add nsw i32 %t.1, 1
  %indvars.iv.next3 = add nuw nsw i64 %indvars.iv2, 1
  br label %for.cond2, !llvm.loop !31

for.end:                                          ; preds = %for.cond2
  %3 = add i32 %t.0, %indvars.iv4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end13:                                        ; preds = %for.cond
  ...
  %call14 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3.8) #14
...
if.then_after_outline.exitStub:
  %1 = load ptr, ptr @stderr, align 8, !tbaa !29
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull dereferenceable(2) %0) #14
  ret void
}
