...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 2500, i32 noundef 1) #15
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 6250000, i32 noundef 4) #15
  br label %for.cond.i
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.end15.i
  %indvars.iv14.i = phi i64 [ %indvars.iv.next15.i, %for.end15.i ], [ 0, %for.cond.i ]
...
for.cond5.i:                                      ; preds = %for.cond1.i, %for.body8.i
  %indvars.iv10.i = phi i64 [ %indvars.iv.next11.i, %for.body8.i ], [ 0, %for.cond1.i ]
  %exitcond13.not.i = icmp eq i64 %indvars.iv10.i, 2500
  br i1 %exitcond13.not.i, label %for.end15.i, label %for.body8.i
...
for.cond.i5:                                      ; preds = %for.end194.i, %init_array.exit
  %indvars.iv144.i = phi i64 [ %indvars.iv.next145.i, %for.end194.i ], [ 2499, %init_array.exit ]
  %1 = and i64 %indvars.iv144.i, 4294967295
  %cmp.i = icmp sgt i64 %indvars.iv144.i, -1
  br i1 %cmp.i, label %for.cond1.preheader.i, label %kernel_nussinov.exit

for.cond1.preheader.i:                            ; preds = %for.cond.i5
  %cmp28.i = icmp samesign ult i64 %indvars.iv144.i, 2499
  %2 = add nuw nsw i64 %indvars.iv144.i, 1
  %arrayidx77.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv144.i
  br label %for.cond1.i6

for.cond1.i6:                                     ; preds = %for.cond150.i, %for.cond1.preheader.i
  %indvars.iv146.i = phi i64 [ %indvars.iv144.i, %for.cond1.preheader.i ], [ %indvars.iv.next147.i, %for.cond150.i ]
  %indvars.iv.next147.i = add nuw nsw i64 %indvars.iv146.i, 1
  %exitcond.not.i7 = icmp eq i64 %indvars.iv146.i, 2499
  br i1 %exitcond.not.i7, label %for.end194.i, label %if.then.i

if.then.i:                                        ; preds = %for.cond1.i6
  %arrayidx7.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv144.i, i64 %indvars.iv.next147.i
  %3 = load i32, ptr %arrayidx7.i, align 4, !tbaa !18, !invariant.load !22
  %arrayidx12.i8 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv144.i, i64 %indvars.iv146.i
  %4 = load i32, ptr %arrayidx12.i8, align 4, !tbaa !18, !invariant.load !22
  %cmp13.not.i = icmp slt i32 %3, %4
  %spec.select.i = select i1 %cmp13.not.i, i64 %indvars.iv146.i, i64 %indvars.iv.next147.i
  %idxprom21.i = and i64 %spec.select.i, 4294967295
  %arrayidx22.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv144.i, i64 %idxprom21.i
  %5 = load i32, ptr %arrayidx22.i, align 4, !tbaa !18, !invariant.load !22
  store i32 %5, ptr %arrayidx7.i, align 4, !tbaa !18
  br i1 %cmp28.i, label %if.then62.i, label %if.end148.i

if.then62.i:                                      ; preds = %if.then.i
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv.next147.i
  %6 = load i32, ptr %arrayidx38.i, align 4, !tbaa !18, !invariant.load !22
  %cmp39.not.i = icmp slt i32 %5, %6
  %add27134.i = zext i1 %cmp39.not.i to i64
  %spec.select136.i = add nuw nsw i64 %indvars.iv144.i, %add27134.i
  %arrayidx50.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select136.i, i64 %indvars.iv.next147.i
  %7 = load i32, ptr %arrayidx50.i, align 4, !tbaa !18, !invariant.load !22
  store i32 %7, ptr %arrayidx7.i, align 4, !tbaa !18
  %cmp64.i = icmp slt i64 %indvars.iv144.i, %indvars.iv146.i
  %arrayidx75.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv146.i
  %8 = load i32, ptr %arrayidx75.i, align 4, !tbaa !18
  br i1 %cmp64.i, label %if.then65.i, label %if.else.i

if.then65.i:                                      ; preds = %if.then62.i
  %9 = load i8, ptr %arrayidx77.i, align 1, !tbaa !15
  %conv.i11 = sext i8 %9 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv.next147.i
  %10 = load i8, ptr %arrayidx79.i, align 1, !tbaa !15
  ...
  %spec.select137.i = tail call i32 @llvm.smax.i32(i32 %7, i32 %add85.i)
  br label %if.end147.i

if.else.i:                                        ; preds = %if.then62.i
  %cmp127.not.i = icmp slt i32 %7, %8
  %spec.select138.v.i = select i1 %cmp127.not.i, i64 %indvars.iv146.i, i64 %indvars.iv.next147.i
  %spec.select139.v.i = select i1 %cmp127.not.i, i64 %2, i64 %indvars.iv144.i
  %idxprom139.i = and i64 %spec.select138.v.i, 4294967295
  %arrayidx140.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select139.v.i, i64 %idxprom139.i
  %11 = load i32, ptr %arrayidx140.i, align 4, !tbaa !18
  br label %if.end147.i

if.end147.i:                                      ; preds = %if.else.i, %if.then65.i
  %.sink1.i = phi i32 [ %11, %if.else.i ], [ %spec.select137.i, %if.then65.i ]
  store i32 %.sink1.i, ptr %arrayidx7.i, align 4, !tbaa !18
  br label %if.end148.i

if.end148.i:                                      ; preds = %if.end147.i, %if.then.i
  %invariant.gep141.i = getelementptr [2500 x i32], ptr %invariant.gep.i, i64 0, i64 %indvars.iv.next147.i
...
for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  ...
  %cmp151.i = icmp slt i64 %indvars.iv.i9, %indvars.iv146.i
  br i1 %cmp151.i, label %for.body153.i, label %for.cond1.i6, !llvm.loop !23

for.body153.i:                                    ; preds = %for.cond150.i
  %indvars.iv.next.i10 = add nuw nsw i64 %indvars.iv.i9, 1
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv144.i, i64 %indvars.iv.next.i10
  %12 = load i32, ptr %arrayidx161.i, align 4, !tbaa !18, !invariant.load !22
  %gep142.i = getelementptr [2500 x i32], ptr %invariant.gep141.i, i64 %indvars.iv.i9
  %13 = load i32, ptr %gep142.i, align 4, !tbaa !18, !invariant.load !22
  %add167.i = add nsw i32 %13, %12
  %spec.select140.i = tail call i32 @llvm.smax.i32(i32 %5, i32 %add167.i)
  store i32 %spec.select140.i, ptr %arrayidx7.i, align 4, !tbaa !18
...
land.lhs.true:                                    ; preds = %kernel_nussinov.exit
  %14 = load ptr, ptr %argv, align 8, !tbaa !26, !invariant.load !22
...
for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv9 = phi i32 [ %indvars.iv.next10, %for.end ], [ 2500, %entry ]
...
for.cond2:                                        ; preds = %for.cond, %if.end
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %if.end ], [ %indvars.iv, %for.cond ]
