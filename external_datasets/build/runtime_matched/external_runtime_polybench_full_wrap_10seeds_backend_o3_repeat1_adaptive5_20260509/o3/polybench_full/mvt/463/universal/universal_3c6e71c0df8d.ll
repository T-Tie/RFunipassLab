...
if.then.i:                                        ; preds = %entry
  call fastcc void @outlined_ir_func_0.3() #13
...
for.body.i:                                       ; preds = %for.cond22.i, %entry
  store double 0.000000e+00, ptr %call1, align 8, !tbaa !11
  store double 5.000000e-04, ptr %call2, align 8, !tbaa !11
  store double 1.500000e-03, ptr %call3, align 8, !tbaa !11
  store double 2.000000e-03, ptr %call4, align 8, !tbaa !11
...
for.cond22.i:                                     ; preds = %for.body25.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.body.i, label %for.body25.i

for.body25.i:                                     ; preds = %for.cond22.i
  %arrayidx33.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 0, i64 %indvars.iv.i
  store double 0.000000e+00, ptr %arrayidx33.i, align 8, !tbaa !11
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond22.i, !llvm.loop !15
}

; Function Attrs: cold minsize nofree nounwind optsize memory(readwrite, argmem: none) uwtable
define internal fastcc void @outlined_ir_func_0.3() unnamed_addr #8 {
