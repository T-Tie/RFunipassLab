...
for.inc:                                          ; preds = %for.cond22
  ...
  %arrayidx33 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv4, i64 %indvars.iv
