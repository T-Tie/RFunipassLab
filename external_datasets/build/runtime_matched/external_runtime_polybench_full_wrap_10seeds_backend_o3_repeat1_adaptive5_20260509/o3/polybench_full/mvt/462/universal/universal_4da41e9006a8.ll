...
if.then.i:                                        ; preds = %entry
  call void @outlined_ir_func_0.3() #16
...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly align 8 captures(none) %call1, ptr nofree noundef writeonly align 8 captures(none) %call2, ptr nofree noundef writeonly align 8 captures(none) %call3, ptr nofree noundef writeonly align 8 captures(none) %call4, ptr nofree noundef writeonly captures(none) %call) #18
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %x1, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %x2, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %y_1, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %y_2, ptr nofree noundef writeonly captures(none) %A) unnamed_addr #8 {
entry:
  br label %for.body

for.body:                                         ; preds = %entry, %for.end
  %indvars.iv8 = phi i64 [ 0, %entry ], [ %indvars.iv.next9, %for.end ]
  store double 0.000000e+00, ptr %x1, align 8, !tbaa !11
  store double 5.000000e-04, ptr %x2, align 8, !tbaa !11
  store double 1.500000e-03, ptr %y_1, align 8, !tbaa !11
  store double 2.000000e-03, ptr %y_2, align 8, !tbaa !11
  br label %for.cond22
...
for.inc:                                          ; preds = %for.cond22
  ...
  %rem26 = urem i32 %1, 2000
  %conv27 = uitofp nneg i32 %rem26 to double
  %div29 = fdiv double %conv27, 2.000000e+03
  %arrayidx33 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv8, i64 %indvars.iv
  store double %div29, ptr %arrayidx33, align 8, !tbaa !11
...
define internal void @outlined_ir_func_0.3() #10 {
...
attributes #18 = { noreturn nounwind memory(write) }
