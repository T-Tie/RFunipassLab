...
if.then.i:                                        ; preds = %entry
  ...
  %2 = call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %1) #19
...
for.cond29.i:                                     ; preds = %for.cond13.i, %for.body32.i
  ...
  br i1 %exitcond72.not.i, label %for.inc44.i, label %for.body32.i
...
for.end46.i:                                      ; preds = %for.cond9.i
  %call.i = tail call ptr @polybench_alloc_data(i64 noundef 4000000, i32 noundef 8) #14
...
for.inc59.i:                                      ; preds = %for.cond51.i
  ...
  br label %for.cond51.i, !llvm.loop !21

for.inc62.i:                                      ; preds = %for.cond51.i
  %indvars.iv.next84.i = add nuw nsw i64 %indvars.iv83.i, 1
  br label %for.cond47.i, !llvm.loop !22
...
for.cond73.preheader.i:                           ; preds = %for.cond69.i
  ...
  %3 = load double, ptr %arrayidx80.i, align 8, !tbaa !5, !invariant.load !23
...
for.inc89.i:                                      ; preds = %for.cond73.i
  ...
  %4 = load double, ptr %arrayidx84.i, align 8, !tbaa !5, !invariant.load !23
  %arrayidx88.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv91.i, i64 %indvars.iv87.i
  %5 = load double, ptr %arrayidx88.i, align 8, !tbaa !5, !invariant.load !23
...
for.inc114.i:                                     ; preds = %for.cond102.i
  ...
  %7 = load double, ptr %arrayidx109.i, align 8, !tbaa !5, !invariant.load !23
...
init_array.exit:                                  ; preds = %for.cond98.i
  ...
  %call.i34 = tail call fastcc double @rtclock() #14
  store double %call.i34, ptr @polybench_t_start, align 8, !tbaa !5
  br label %for.cond.i4

for.cond.i4:                                      ; preds = %for.inc57.i, %init_array.exit
  %indvars.iv91.i5 = phi i64 [ %indvars.iv.next92.i17, %for.inc57.i ], [ 0, %init_array.exit ]
  %exitcond98.not.i6 = icmp eq i64 %indvars.iv91.i5, 2000
  br i1 %exitcond98.not.i6, label %for.cond60.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i4, %for.inc25.i12
  %indvars.iv82.i = phi i64 [ %indvars.iv.next83.i, %for.inc25.i12 ], [ 0, %for.cond.i4 ]
  %exitcond86.not.i7 = icmp eq i64 %indvars.iv82.i, %indvars.iv91.i5
  br i1 %exitcond86.not.i7, label %for.cond28.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx5.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv91.i5, i64 %indvars.iv82.i
  %8 = load double, ptr %arrayidx5.i, align 8, !tbaa !5, !invariant.load !23
...
for.cond6.i:                                      ; preds = %for.inc.i10, %for.body3.i
  ...
  %exitcond.not.i9 = icmp eq i64 %indvars.iv.i8, %indvars.iv82.i
  br i1 %exitcond.not.i9, label %for.inc25.i12, label %for.inc.i10

for.inc.i10:                                      ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv91.i5, i64 %indvars.iv.i8
  %9 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !23
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i8, i64 %indvars.iv82.i
  %10 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !23
  %neg.i = fneg double %9
  %11 = tail call double @llvm.fmuladd.f64(double %neg.i, double %10, double %w.0.i) #22
  %indvars.iv.next.i11 = add nuw nsw i64 %indvars.iv.i8, 1
  br label %for.cond6.i, !llvm.loop !29

for.inc25.i12:                                    ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv82.i, i64 %indvars.iv82.i
  %12 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !23
...
for.cond28.i:                                     ; preds = %for.cond1.i, %for.inc54.i
  %indvars.iv93.i = phi i64 [ %indvars.iv.next94.i, %for.inc54.i ], [ %indvars.iv91.i5, %for.cond1.i ]
  %exitcond96.not.i = icmp eq i64 %indvars.iv93.i, 2000
  br i1 %exitcond96.not.i, label %for.inc57.i, label %for.body30.i

for.body30.i:                                     ; preds = %for.cond28.i
  %arrayidx34.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv91.i5, i64 %indvars.iv93.i
  %13 = load double, ptr %arrayidx34.i, align 8, !tbaa !5, !invariant.load !23
  br label %for.cond35.i

for.cond35.i:                                     ; preds = %for.inc47.i, %for.body30.i
  %indvars.iv87.i14 = phi i64 [ %indvars.iv.next88.i16, %for.inc47.i ], [ 0, %for.body30.i ]
  %w.1.i = phi double [ %16, %for.inc47.i ], [ %13, %for.body30.i ]
  %exitcond90.not.i15 = icmp eq i64 %indvars.iv87.i14, %indvars.iv91.i5
  br i1 %exitcond90.not.i15, label %for.inc54.i, label %for.inc47.i

for.inc47.i:                                      ; preds = %for.cond35.i
  %arrayidx41.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv91.i5, i64 %indvars.iv87.i14
  %14 = load double, ptr %arrayidx41.i, align 8, !tbaa !5, !invariant.load !23
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv87.i14, i64 %indvars.iv93.i
  %15 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !23
  %neg46.i = fneg double %14
  %16 = tail call double @llvm.fmuladd.f64(double %neg46.i, double %15, double %w.1.i) #22
  %indvars.iv.next88.i16 = add nuw nsw i64 %indvars.iv87.i14, 1
...
for.inc57.i:                                      ; preds = %for.cond28.i
  %indvars.iv.next92.i17 = add nuw nsw i64 %indvars.iv91.i5, 1
  br label %for.cond.i4, !llvm.loop !33

for.cond60.i:                                     ; preds = %for.cond.i4, %for.inc80.i
  %indvars.iv103.i18 = phi i64 [ %indvars.iv.next104.i24, %for.inc80.i ], [ 0, %for.cond.i4 ]
  %exitcond106.not.i19 = icmp eq i64 %indvars.iv103.i18, 2000
  br i1 %exitcond106.not.i19, label %for.cond83.i, label %for.body62.i

for.body62.i:                                     ; preds = %for.cond60.i
  %arrayidx64.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv103.i18
  %17 = load double, ptr %arrayidx64.i, align 8, !tbaa !5, !invariant.load !23
  br label %for.cond65.i20

for.cond65.i20:                                   ; preds = %for.inc75.i, %for.body62.i
  %indvars.iv99.i21 = phi i64 [ %indvars.iv.next100.i23, %for.inc75.i ], [ 0, %for.body62.i ]
  %w.2.i = phi double [ %20, %for.inc75.i ], [ %17, %for.body62.i ]
  %exitcond102.not.i22 = icmp eq i64 %indvars.iv99.i21, %indvars.iv103.i18
  br i1 %exitcond102.not.i22, label %for.inc80.i, label %for.inc75.i

for.inc75.i:                                      ; preds = %for.cond65.i20
  %arrayidx71.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv103.i18, i64 %indvars.iv99.i21
  %18 = load double, ptr %arrayidx71.i, align 8, !tbaa !5, !invariant.load !23
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv99.i21
  %19 = load double, ptr %arrayidx73.i, align 8, !tbaa !5, !invariant.load !23
  %neg74.i = fneg double %18
  %20 = tail call double @llvm.fmuladd.f64(double %neg74.i, double %19, double %w.2.i) #22
  %indvars.iv.next100.i23 = add nuw nsw i64 %indvars.iv99.i21, 1
  br label %for.cond65.i20, !llvm.loop !34

for.inc80.i:                                      ; preds = %for.cond65.i20
  %arrayidx79.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv103.i18
  store double %w.2.i, ptr %arrayidx79.i, align 8, !tbaa !5
  %indvars.iv.next104.i24 = add nuw nsw i64 %indvars.iv103.i18, 1
...
for.body85.i:                                     ; preds = %for.cond83.i
  ...
  %22 = load double, ptr %arrayidx87.i, align 8, !tbaa !5, !invariant.load !23
  br label %for.cond88.i

for.cond88.i:                                     ; preds = %for.body90.i, %for.body85.i
  %indvars.iv107.i = phi i64 [ %indvars.iv.next108.i, %for.body90.i ], [ %21, %for.body85.i ]
  %w.3.i = phi double [ %25, %for.body90.i ], [ %22, %for.body85.i ]
  %exitcond110.not.i = icmp eq i64 %indvars.iv107.i, 1999
  br i1 %exitcond110.not.i, label %for.inc108.i, label %for.body90.i

for.body90.i:                                     ; preds = %for.cond88.i
  %indvars.iv.next108.i = add nuw nsw i64 %indvars.iv107.i, 1
  %arrayidx94.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %21, i64 %indvars.iv.next108.i
  %23 = load double, ptr %arrayidx94.i, align 8, !tbaa !5, !invariant.load !23
  %arrayidx96.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv.next108.i
  %24 = load double, ptr %arrayidx96.i, align 8, !tbaa !5, !invariant.load !23
  %neg97.i = fneg double %23
  %25 = tail call double @llvm.fmuladd.f64(double %neg97.i, double %24, double %w.3.i) #22
  br label %for.cond88.i

for.inc108.i:                                     ; preds = %for.cond88.i
  %arrayidx104.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %21, i64 %21
  %26 = load double, ptr %arrayidx104.i, align 8, !tbaa !5, !invariant.load !23
...
kernel_ludcmp.exit:                               ; preds = %for.cond83.i
  %call.i35 = tail call fastcc double @rtclock() #14
  store double %call.i35, ptr @polybench_t_end, align 8, !tbaa !5
  tail call void @polybench_timer_print() #14
  %cmp = icmp sgt i32 %argc, 42
  br i1 %cmp, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %kernel_ludcmp.exit
  %27 = load ptr, ptr %argv, align 8, !tbaa !37, !invariant.load !23
  %strcmpload = load i8, ptr %27, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 2000, ptr nofree noundef readonly captures(none) %call2) #23
  br label %if.end
...
attributes #21 = { nounwind memory(readwrite) }
