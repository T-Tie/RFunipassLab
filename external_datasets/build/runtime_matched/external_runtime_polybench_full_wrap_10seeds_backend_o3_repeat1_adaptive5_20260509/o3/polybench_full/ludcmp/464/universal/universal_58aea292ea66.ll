...
for.cond9.i:                                      ; preds = %for.cond.i, %for.inc44.i
  %indvars.iv78.i = phi i64 [ %indvars.iv.next79.i, %for.inc44.i ], [ 0, %for.cond.i ]
  %indvars.iv71.i = phi i64 [ %indvars.iv.next72.i, %for.inc44.i ], [ 1, %for.cond.i ]
  %exitcond84.not.i = icmp eq i64 %indvars.iv78.i, 2000
  br i1 %exitcond84.not.i, label %for.end46.i, label %for.cond13.i

for.cond13.i:                                     ; preds = %for.cond9.i, %for.inc25.i
  %indvars.iv64.i = phi i64 [ %indvars.iv.next65.i, %for.inc25.i ], [ 0, %for.cond9.i ]
  %exitcond70.i = icmp eq i64 %indvars.iv64.i, %indvars.iv71.i
  br i1 %exitcond70.i, label %for.cond29.i, label %for.inc25.i
...
for.inc25.i:                                      ; preds = %for.cond13.i
  ...
  %arrayidx24.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv78.i, i64 %indvars.iv64.i
...
for.cond29.i:                                     ; preds = %for.cond13.i, %for.inc37.i
  %indvars.iv73.i = phi i64 [ %indvars.iv.next74.i, %for.inc37.i ], [ %indvars.iv71.i, %for.cond13.i ]
  %exitcond77.not.i = icmp eq i64 %indvars.iv73.i, 2000
  br i1 %exitcond77.not.i, label %for.inc44.i, label %for.inc37.i

for.inc37.i:                                      ; preds = %for.cond29.i
  %arrayidx36.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv78.i, i64 %indvars.iv73.i
...
for.inc44.i:                                      ; preds = %for.cond29.i
  ...
  %arrayidx43.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv78.i, i64 %indvars.iv78.i
...
for.cond47.i:                                     ; preds = %for.inc62.i, %for.end46.i
  %indvars.iv90.i = phi i64 [ %indvars.iv.next91.i, %for.inc62.i ], [ 0, %for.end46.i ]
  %exitcond94.not.i = icmp eq i64 %indvars.iv90.i, 2000
  br i1 %exitcond94.not.i, label %for.cond65.i, label %for.cond51.i

for.cond51.i:                                     ; preds = %for.cond47.i, %for.inc59.i
  %indvars.iv85.i = phi i64 [ %indvars.iv.next86.i, %for.inc59.i ], [ 0, %for.cond47.i ]
  %exitcond89.not.i = icmp eq i64 %indvars.iv85.i, 2000
  br i1 %exitcond89.not.i, label %for.inc62.i, label %for.inc59.i

for.inc59.i:                                      ; preds = %for.cond51.i
  %arrayidx58.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv90.i, i64 %indvars.iv85.i
...
for.cond65.i:                                     ; preds = %for.cond47.i, %for.inc95.i
  %indvars.iv105.i = phi i64 [ %indvars.iv.next106.i, %for.inc95.i ], [ 0, %for.cond47.i ]
  %exitcond109.not.i = icmp eq i64 %indvars.iv105.i, 2000
  br i1 %exitcond109.not.i, label %for.cond98.i, label %for.cond69.i

for.cond69.i:                                     ; preds = %for.cond65.i, %for.inc92.i
  %indvars.iv100.i = phi i64 [ %indvars.iv.next101.i, %for.inc92.i ], [ 0, %for.cond65.i ]
  %exitcond104.not.i = icmp eq i64 %indvars.iv100.i, 2000
  br i1 %exitcond104.not.i, label %for.inc95.i, label %for.cond73.preheader.i

for.cond73.preheader.i:                           ; preds = %for.cond69.i
  %arrayidx80.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv100.i, i64 %indvars.iv105.i
  br label %for.cond73.i

for.cond73.i:                                     ; preds = %for.inc89.i, %for.cond73.preheader.i
  %indvars.iv95.i = phi i64 [ 0, %for.cond73.preheader.i ], [ %indvars.iv.next96.i, %for.inc89.i ]
  %exitcond99.not.i = icmp eq i64 %indvars.iv95.i, 2000
  br i1 %exitcond99.not.i, label %for.inc92.i, label %for.inc89.i

for.inc89.i:                                      ; preds = %for.cond73.i
  %3 = load double, ptr %arrayidx80.i, align 8, !tbaa !5
  %arrayidx84.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv95.i, i64 %indvars.iv105.i
  %4 = load double, ptr %arrayidx84.i, align 8, !tbaa !5
  %arrayidx88.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv100.i, i64 %indvars.iv95.i
...
for.cond98.i:                                     ; preds = %for.cond65.i, %for.inc117.i
  %indvars.iv115.i = phi i64 [ %indvars.iv.next116.i, %for.inc117.i ], [ 0, %for.cond65.i ]
  %exitcond119.not.i = icmp eq i64 %indvars.iv115.i, 2000
  br i1 %exitcond119.not.i, label %init_array.exit, label %for.cond102.i

for.cond102.i:                                    ; preds = %for.cond98.i, %for.inc114.i
  %indvars.iv110.i = phi i64 [ %indvars.iv.next111.i, %for.inc114.i ], [ 0, %for.cond98.i ]
  %exitcond114.not.i = icmp eq i64 %indvars.iv110.i, 2000
  br i1 %exitcond114.not.i, label %for.inc117.i, label %for.inc114.i

for.inc114.i:                                     ; preds = %for.cond102.i
  %arrayidx109.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv115.i, i64 %indvars.iv110.i
  %7 = load double, ptr %arrayidx109.i, align 8, !tbaa !5
  %arrayidx113.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv115.i, i64 %indvars.iv110.i
...
for.cond.i2:                                      ; preds = %for.inc57.i, %init_array.exit
  ...
  %exitcond96.not.i = icmp eq i64 %indvars.iv87.i, 2000
  br i1 %exitcond96.not.i, label %for.cond60.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i2, %for.inc25.i8
  %indvars.iv78.i3 = phi i64 [ %indvars.iv.next79.i10, %for.inc25.i8 ], [ 0, %for.cond.i2 ]
  %exitcond82.not.i = icmp eq i64 %indvars.iv78.i3, %indvars.iv87.i
  br i1 %exitcond82.not.i, label %for.cond28.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx5.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv87.i, i64 %indvars.iv78.i3
...
for.cond6.i:                                      ; preds = %for.inc.i6, %for.body3.i
  ...
  %exitcond.not.i5 = icmp eq i64 %indvars.iv.i4, %indvars.iv78.i3
  br i1 %exitcond.not.i5, label %for.inc25.i8, label %for.inc.i6

for.inc.i6:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv87.i, i64 %indvars.iv.i4
  %9 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i4, i64 %indvars.iv78.i3
...
for.inc25.i8:                                     ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv78.i3, i64 %indvars.iv78.i3
  ...
  %indvars.iv.next79.i10 = add nuw nsw i64 %indvars.iv78.i3, 1
  br label %for.cond1.i, !llvm.loop !30

for.cond28.i:                                     ; preds = %for.cond1.i, %for.inc54.i
  %indvars.iv89.i = phi i64 [ %indvars.iv.next90.i, %for.inc54.i ], [ %indvars.iv87.i, %for.cond1.i ]
  %exitcond93.not.i = icmp eq i64 %indvars.iv89.i, 2000
  br i1 %exitcond93.not.i, label %for.inc57.i, label %for.body30.i
...
for.cond35.i:                                     ; preds = %for.inc47.i, %for.body30.i
  %indvars.iv83.i = phi i64 [ %indvars.iv.next84.i, %for.inc47.i ], [ 0, %for.body30.i ]
  %w.1.i = phi double [ %16, %for.inc47.i ], [ %13, %for.body30.i ]
  %exitcond86.not.i = icmp eq i64 %indvars.iv83.i, %indvars.iv87.i
  br i1 %exitcond86.not.i, label %for.inc54.i, label %for.inc47.i
...
for.cond60.i:                                     ; preds = %for.cond.i2, %for.inc80.i
  %indvars.iv101.i = phi i64 [ %indvars.iv.next102.i, %for.inc80.i ], [ 0, %for.cond.i2 ]
  %exitcond105.not.i = icmp eq i64 %indvars.iv101.i, 2000
  br i1 %exitcond105.not.i, label %for.cond83.i, label %for.body62.i

for.body62.i:                                     ; preds = %for.cond60.i
  %arrayidx64.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv101.i
  %17 = load double, ptr %arrayidx64.i, align 8, !tbaa !5, !invariant.load !9
  br label %for.cond65.i11

for.cond65.i11:                                   ; preds = %for.inc75.i, %for.body62.i
  %indvars.iv97.i = phi i64 [ %indvars.iv.next98.i, %for.inc75.i ], [ 0, %for.body62.i ]
  %w.2.i = phi double [ %20, %for.inc75.i ], [ %17, %for.body62.i ]
  %exitcond100.not.i = icmp eq i64 %indvars.iv97.i, %indvars.iv101.i
  br i1 %exitcond100.not.i, label %for.inc80.i, label %for.inc75.i

for.inc75.i:                                      ; preds = %for.cond65.i11
  %arrayidx71.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv101.i, i64 %indvars.iv97.i
  %18 = load double, ptr %arrayidx71.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv97.i
  ...
  br label %for.cond65.i11, !llvm.loop !34

for.inc80.i:                                      ; preds = %for.cond65.i11
  %arrayidx79.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv101.i
...
for.cond83.i:                                     ; preds = %for.cond60.i, %for.inc108.i
  %indvars.iv106.i = phi i64 [ %21, %for.inc108.i ], [ 2000, %for.cond60.i ]
  %21 = add nsw i64 %indvars.iv106.i, -1
  %.not = icmp eq i64 %indvars.iv106.i, 0
  br i1 %.not, label %kernel_ludcmp.exit, label %for.body85.i
...
for.cond88.i:                                     ; preds = %for.inc98.i, %for.body85.i
  %indvars.iv108.i = phi i64 [ %indvars.iv.next109.i, %for.inc98.i ], [ %indvars.iv106.i, %for.body85.i ]
  %w.3.i = phi double [ %25, %for.inc98.i ], [ %22, %for.body85.i ]
  %exitcond.not = icmp eq i64 %indvars.iv108.i, 2000
  br i1 %exitcond.not, label %for.inc108.i, label %for.inc98.i

for.inc98.i:                                      ; preds = %for.cond88.i
  %arrayidx94.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %21, i64 %indvars.iv108.i
  %23 = load double, ptr %arrayidx94.i, align 8, !tbaa !5
  %arrayidx96.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv108.i
...
kernel_ludcmp.exit:                               ; preds = %for.cond83.i
  %call.i23 = tail call fastcc double @rtclock() #12
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 2000, ptr noundef %call2) #12
  br label %if.end
