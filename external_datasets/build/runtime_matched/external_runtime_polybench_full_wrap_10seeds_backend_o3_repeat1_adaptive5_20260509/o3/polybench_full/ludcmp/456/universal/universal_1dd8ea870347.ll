...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 4000000, i32 noundef 8) #12
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #12
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #12
  %call3 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #12
  br label %for.cond.i
...
for.cond9.i:                                      ; preds = %for.cond.i, %for.inc44.i
  %indvars.iv21.i = phi i64 [ %indvars.iv.next22.i, %for.inc44.i ], [ 1, %for.cond.i ]
  %indvars.iv15.i = phi i64 [ %indvars.iv.next16.i, %for.inc44.i ], [ 0, %for.cond.i ]
  %exitcond26.not.i = icmp eq i64 %indvars.iv15.i, 2000
  br i1 %exitcond26.not.i, label %for.end46.i, label %for.cond13.i

for.cond13.i:                                     ; preds = %for.cond9.i, %for.inc25.i
  %indvars.iv9.i = phi i64 [ %indvars.iv.next10.i, %for.inc25.i ], [ 0, %for.cond9.i ]
  %exitcond14.i = icmp eq i64 %indvars.iv9.i, %indvars.iv21.i
  br i1 %exitcond14.i, label %for.cond29.i, label %for.inc25.i

for.inc25.i:                                      ; preds = %for.cond13.i
  %1 = trunc nuw nsw i64 %indvars.iv9.i to i32
  %2 = urem i32 %1, 2000
  ...
  %arrayidx24.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv15.i, i64 %indvars.iv9.i
...
for.cond29.i:                                     ; preds = %for.cond13.i, %for.inc37.i
  %indvars.iv17.i = phi i64 [ %indvars.iv.next18.i, %for.inc37.i ], [ %indvars.iv15.i, %for.cond13.i ]
  %exitcond20.not.i = icmp eq i64 %indvars.iv17.i, 1999
  br i1 %exitcond20.not.i, label %for.inc44.i, label %for.inc37.i

for.inc37.i:                                      ; preds = %for.cond29.i
  %indvars.iv.next18.i = add nuw nsw i64 %indvars.iv17.i, 1
  %arrayidx36.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv15.i, i64 %indvars.iv.next18.i
...
for.inc44.i:                                      ; preds = %for.cond29.i
  %arrayidx43.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv15.i, i64 %indvars.iv15.i
...
for.cond47.i:                                     ; preds = %for.inc62.i, %for.end46.i
  %indvars.iv31.i = phi i64 [ %indvars.iv.next32.i, %for.inc62.i ], [ 0, %for.end46.i ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv31.i, 2000
  br i1 %exitcond34.not.i, label %for.cond65.i, label %for.cond51.i

for.cond51.i:                                     ; preds = %for.cond47.i, %for.inc59.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %for.inc59.i ], [ 0, %for.cond47.i ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv27.i, 2000
  br i1 %exitcond30.not.i, label %for.inc62.i, label %for.inc59.i

for.inc59.i:                                      ; preds = %for.cond51.i
  %arrayidx58.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv31.i, i64 %indvars.iv27.i
...
for.cond65.i:                                     ; preds = %for.cond47.i, %for.inc95.i
  %indvars.iv43.i = phi i64 [ %indvars.iv.next44.i, %for.inc95.i ], [ 0, %for.cond47.i ]
  %exitcond46.not.i = icmp eq i64 %indvars.iv43.i, 2000
  br i1 %exitcond46.not.i, label %for.cond98.i, label %for.cond69.i

for.cond69.i:                                     ; preds = %for.cond65.i, %for.inc92.i
  %indvars.iv39.i = phi i64 [ %indvars.iv.next40.i, %for.inc92.i ], [ 0, %for.cond65.i ]
  %exitcond42.not.i = icmp eq i64 %indvars.iv39.i, 2000
  br i1 %exitcond42.not.i, label %for.inc95.i, label %for.cond73.preheader.i

for.cond73.preheader.i:                           ; preds = %for.cond69.i
  %arrayidx80.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv39.i, i64 %indvars.iv43.i
  br label %for.cond73.i

for.cond73.i:                                     ; preds = %for.inc89.i, %for.cond73.preheader.i
  %indvars.iv35.i = phi i64 [ 0, %for.cond73.preheader.i ], [ %indvars.iv.next36.i, %for.inc89.i ]
  %exitcond38.not.i = icmp eq i64 %indvars.iv35.i, 2000
  br i1 %exitcond38.not.i, label %for.inc92.i, label %for.inc89.i

for.inc89.i:                                      ; preds = %for.cond73.i
  %3 = load double, ptr %arrayidx80.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx84.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv35.i, i64 %indvars.iv43.i
  %4 = load double, ptr %arrayidx84.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx88.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv39.i, i64 %indvars.iv35.i
...
for.cond98.i:                                     ; preds = %for.cond65.i, %for.inc117.i
  %indvars.iv51.i = phi i64 [ %indvars.iv.next52.i, %for.inc117.i ], [ 0, %for.cond65.i ]
  %exitcond54.not.i = icmp eq i64 %indvars.iv51.i, 2000
  br i1 %exitcond54.not.i, label %init_array.exit, label %for.cond102.i

for.cond102.i:                                    ; preds = %for.cond98.i, %for.inc114.i
  %indvars.iv47.i = phi i64 [ %indvars.iv.next48.i, %for.inc114.i ], [ 0, %for.cond98.i ]
  %exitcond50.not.i = icmp eq i64 %indvars.iv47.i, 2000
  br i1 %exitcond50.not.i, label %for.inc117.i, label %for.inc114.i

for.inc114.i:                                     ; preds = %for.cond102.i
  %arrayidx109.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv51.i, i64 %indvars.iv47.i
  %7 = load double, ptr %arrayidx109.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx113.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv51.i, i64 %indvars.iv47.i
...
for.cond.i1:                                      ; preds = %for.inc57.i, %init_array.exit
  %indvars.iv27.i2 = phi i64 [ %indvars.iv.next28.i11, %for.inc57.i ], [ 0, %init_array.exit ]
  %exitcond34.not.i3 = icmp eq i64 %indvars.iv27.i2, 2000
  br i1 %exitcond34.not.i3, label %for.cond60.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i1, %for.inc25.i8
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.inc25.i8 ], [ 0, %for.cond.i1 ]
  %exitcond22.not.i = icmp eq i64 %indvars.iv18.i, %indvars.iv27.i2
  br i1 %exitcond22.not.i, label %for.cond28.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx5.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv27.i2, i64 %indvars.iv18.i
...
for.cond6.i:                                      ; preds = %for.inc.i6, %for.body3.i
  ...
  %exitcond.not.i5 = icmp eq i64 %indvars.iv.i4, %indvars.iv18.i
  br i1 %exitcond.not.i5, label %for.inc25.i8, label %for.inc.i6

for.inc.i6:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv27.i2, i64 %indvars.iv.i4
  %9 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i4, i64 %indvars.iv18.i
...
for.inc25.i8:                                     ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv18.i, i64 %indvars.iv18.i
...
for.cond28.i:                                     ; preds = %for.cond1.i, %for.inc54.i
  %indvars.iv29.i = phi i64 [ %indvars.iv.next30.i, %for.inc54.i ], [ %indvars.iv27.i2, %for.cond1.i ]
  %exitcond32.not.i = icmp eq i64 %indvars.iv29.i, 2000
  br i1 %exitcond32.not.i, label %for.inc57.i, label %for.body30.i

for.body30.i:                                     ; preds = %for.cond28.i
  %arrayidx34.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv27.i2, i64 %indvars.iv29.i
...
for.cond35.i:                                     ; preds = %for.inc47.i, %for.body30.i
  %indvars.iv23.i = phi i64 [ %indvars.iv.next24.i, %for.inc47.i ], [ 0, %for.body30.i ]
  %w.1.i = phi double [ %16, %for.inc47.i ], [ %13, %for.body30.i ]
  %exitcond26.not.i10 = icmp eq i64 %indvars.iv23.i, %indvars.iv27.i2
  br i1 %exitcond26.not.i10, label %for.inc54.i, label %for.inc47.i

for.inc47.i:                                      ; preds = %for.cond35.i
  %arrayidx41.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv27.i2, i64 %indvars.iv23.i
  %14 = load double, ptr %arrayidx41.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv23.i, i64 %indvars.iv29.i
...
for.inc57.i:                                      ; preds = %for.cond28.i
  %indvars.iv.next28.i11 = add nuw nsw i64 %indvars.iv27.i2, 1
  br label %for.cond.i1, !llvm.loop !33

for.cond60.i:                                     ; preds = %for.cond.i1, %for.inc80.i
  %indvars.iv39.i12 = phi i64 [ %indvars.iv.next40.i18, %for.inc80.i ], [ 0, %for.cond.i1 ]
  %exitcond42.not.i13 = icmp eq i64 %indvars.iv39.i12, 2000
  br i1 %exitcond42.not.i13, label %for.cond83.i, label %for.body62.i

for.body62.i:                                     ; preds = %for.cond60.i
  %arrayidx64.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv39.i12
  %17 = load double, ptr %arrayidx64.i, align 8, !tbaa !5, !invariant.load !9
  br label %for.cond65.i14

for.cond65.i14:                                   ; preds = %for.inc75.i, %for.body62.i
  %indvars.iv35.i15 = phi i64 [ %indvars.iv.next36.i17, %for.inc75.i ], [ 0, %for.body62.i ]
  %w.2.i = phi double [ %20, %for.inc75.i ], [ %17, %for.body62.i ]
  %exitcond38.not.i16 = icmp eq i64 %indvars.iv35.i15, %indvars.iv39.i12
  br i1 %exitcond38.not.i16, label %for.inc80.i, label %for.inc75.i

for.inc75.i:                                      ; preds = %for.cond65.i14
  %arrayidx71.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv39.i12, i64 %indvars.iv35.i15
  %18 = load double, ptr %arrayidx71.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv35.i15
  ...
  %indvars.iv.next36.i17 = add nuw nsw i64 %indvars.iv35.i15, 1
  br label %for.cond65.i14, !llvm.loop !34

for.inc80.i:                                      ; preds = %for.cond65.i14
  %arrayidx79.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv39.i12
...
for.cond88.i:                                     ; preds = %for.inc98.i, %for.body85.i
  %indvars.iv43.i19 = phi i64 [ %indvars.iv.next44.i21, %for.inc98.i ], [ %21, %for.body85.i ]
  %w.3.i = phi double [ %25, %for.inc98.i ], [ %22, %for.body85.i ]
  %exitcond46.not.i20 = icmp eq i64 %indvars.iv43.i19, 1999
  br i1 %exitcond46.not.i20, label %for.inc108.i, label %for.inc98.i

for.inc98.i:                                      ; preds = %for.cond88.i
  %indvars.iv.next44.i21 = add nuw nsw i64 %indvars.iv43.i19, 1
  %arrayidx94.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %21, i64 %indvars.iv.next44.i21
  %23 = load double, ptr %arrayidx94.i, align 8, !tbaa !5
  %arrayidx96.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv.next44.i21
...
kernel_ludcmp.exit:                               ; preds = %for.cond83.i
  %call.i22 = tail call fastcc double @rtclock() #12
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 2000, ptr nofree noundef nonnull readonly captures(none) %call2) #12
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %n, ptr noundef readonly captures(none) %x) unnamed_addr #8 {
entry:
...
if.then_after_outline.exitStub:
  ...
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef %0) #16
  ret void
}
