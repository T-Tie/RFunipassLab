...
for.cond.i3:                                      ; preds = %for.inc57.i, %init_array.exit
  %indvars.iv68.i4 = phi i64 [ %indvars.iv.next69.i15, %for.inc57.i ], [ 0, %init_array.exit ]
  %exitcond75.not.i = icmp eq i64 %indvars.iv68.i4, 2000
  br i1 %exitcond75.not.i, label %for.cond60.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i3, %for.inc25.i9
  %indvars.iv59.i = phi i64 [ %indvars.iv.next60.i, %for.inc25.i9 ], [ 0, %for.cond.i3 ]
  %exitcond63.not.i = icmp eq i64 %indvars.iv59.i, %indvars.iv68.i4
  br i1 %exitcond63.not.i, label %for.cond28.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx5.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i4, i64 %indvars.iv59.i
...
for.cond6.i:                                      ; preds = %for.inc.i7, %for.body3.i
  ...
  %exitcond.not.i6 = icmp eq i64 %indvars.iv.i5, %indvars.iv59.i
  br i1 %exitcond.not.i6, label %for.inc25.i9, label %for.inc.i7

for.inc.i7:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i4, i64 %indvars.iv.i5
  %9 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i5, i64 %indvars.iv59.i
...
for.inc25.i9:                                     ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv59.i, i64 %indvars.iv59.i
...
for.cond28.i:                                     ; preds = %for.cond1.i, %for.inc54.i
  %indvars.iv70.i = phi i64 [ %indvars.iv.next71.i, %for.inc54.i ], [ %indvars.iv68.i4, %for.cond1.i ]
  %exitcond73.not.i11 = icmp eq i64 %indvars.iv70.i, 2000
  br i1 %exitcond73.not.i11, label %for.inc57.i, label %for.body30.i

for.body30.i:                                     ; preds = %for.cond28.i
  %arrayidx34.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i4, i64 %indvars.iv70.i
...
for.cond35.i:                                     ; preds = %for.inc47.i, %for.body30.i
  %indvars.iv64.i12 = phi i64 [ %indvars.iv.next65.i14, %for.inc47.i ], [ 0, %for.body30.i ]
  %w.1.i = phi double [ %16, %for.inc47.i ], [ %13, %for.body30.i ]
  %exitcond67.not.i13 = icmp eq i64 %indvars.iv64.i12, %indvars.iv68.i4
  br i1 %exitcond67.not.i13, label %for.inc54.i, label %for.inc47.i

for.inc47.i:                                      ; preds = %for.cond35.i
  %arrayidx41.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i4, i64 %indvars.iv64.i12
  %14 = load double, ptr %arrayidx41.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv64.i12, i64 %indvars.iv70.i
  ...
  %indvars.iv.next65.i14 = add nuw nsw i64 %indvars.iv64.i12, 1
...
for.inc57.i:                                      ; preds = %for.cond28.i
  %indvars.iv.next69.i15 = add nuw nsw i64 %indvars.iv68.i4, 1
  br label %for.cond.i3, !llvm.loop !33

for.cond60.i:                                     ; preds = %for.cond.i3, %for.inc80.i
  %indvars.iv80.i = phi i64 [ %indvars.iv.next81.i, %for.inc80.i ], [ 0, %for.cond.i3 ]
  %exitcond83.not.i = icmp eq i64 %indvars.iv80.i, 2000
  br i1 %exitcond83.not.i, label %for.cond83.i, label %for.body62.i

for.body62.i:                                     ; preds = %for.cond60.i
  %arrayidx64.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv80.i
  %17 = load double, ptr %arrayidx64.i, align 8, !tbaa !5, !invariant.load !9
  br label %for.cond65.i16

for.cond65.i16:                                   ; preds = %for.inc75.i, %for.body62.i
  %indvars.iv76.i = phi i64 [ %indvars.iv.next77.i, %for.inc75.i ], [ 0, %for.body62.i ]
  %w.2.i = phi double [ %20, %for.inc75.i ], [ %17, %for.body62.i ]
  %exitcond79.not.i = icmp eq i64 %indvars.iv76.i, %indvars.iv80.i
  br i1 %exitcond79.not.i, label %for.inc80.i, label %for.inc75.i

for.inc75.i:                                      ; preds = %for.cond65.i16
  %arrayidx71.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv80.i, i64 %indvars.iv76.i
  %18 = load double, ptr %arrayidx71.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv76.i
  ...
  br label %for.cond65.i16, !llvm.loop !34

for.inc80.i:                                      ; preds = %for.cond65.i16
  %arrayidx79.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv80.i
...
for.cond88.i:                                     ; preds = %for.inc98.i, %for.body85.i
  %indvars.iv84.i = phi i64 [ %indvars.iv.next85.i, %for.inc98.i ], [ %21, %for.body85.i ]
  %w.3.i = phi double [ %25, %for.inc98.i ], [ %22, %for.body85.i ]
  %exitcond87.not.i = icmp eq i64 %indvars.iv84.i, 1999
  br i1 %exitcond87.not.i, label %for.inc108.i, label %for.inc98.i

for.inc98.i:                                      ; preds = %for.cond88.i
  %indvars.iv.next85.i = add nuw nsw i64 %indvars.iv84.i, 1
  %arrayidx94.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %21, i64 %indvars.iv.next85.i
  %23 = load double, ptr %arrayidx94.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx96.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv.next85.i
...
kernel_ludcmp.exit:                               ; preds = %for.cond83.i
  %call.i26 = tail call fastcc double @rtclock() #12
  store double %call.i26, ptr @polybench_t_end, align 8, !tbaa !5
