...
for.cond9.i:                                      ; preds = %for.cond.i, %for.inc44.i
  %indvars.iv68.i = phi i64 [ %indvars.iv.next69.i, %for.inc44.i ], [ 0, %for.cond.i ]
  %indvars.iv62.i = phi i64 [ %indvars.iv.next63.i, %for.inc44.i ], [ 1, %for.cond.i ]
  %exitcond73.not.i = icmp eq i64 %indvars.iv68.i, 2000
  br i1 %exitcond73.not.i, label %for.end46.i, label %for.cond13.i

for.cond13.i:                                     ; preds = %for.cond9.i, %for.inc25.i
  %indvars.iv56.i = phi i64 [ %indvars.iv.next57.i, %for.inc25.i ], [ 0, %for.cond9.i ]
  %exitcond61.i = icmp eq i64 %indvars.iv56.i, %indvars.iv62.i
  br i1 %exitcond61.i, label %for.cond29.i, label %for.inc25.i

for.inc25.i:                                      ; preds = %for.cond13.i
  %1 = trunc nuw nsw i64 %indvars.iv56.i to i32
  %2 = urem i32 %1, 2000
  ...
  %arrayidx24.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i, i64 %indvars.iv56.i
...
for.cond29.i:                                     ; preds = %for.cond13.i, %for.inc37.i
  %indvars.iv64.i = phi i64 [ %indvars.iv.next65.i, %for.inc37.i ], [ %indvars.iv62.i, %for.cond13.i ]
  %exitcond67.not.i = icmp eq i64 %indvars.iv64.i, 2000
  br i1 %exitcond67.not.i, label %for.inc44.i, label %for.inc37.i

for.inc37.i:                                      ; preds = %for.cond29.i
  %arrayidx36.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i, i64 %indvars.iv64.i
...
for.inc44.i:                                      ; preds = %for.cond29.i
  ...
  %arrayidx43.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv68.i, i64 %indvars.iv68.i
...
for.cond47.i:                                     ; preds = %for.inc62.i, %for.end46.i
  %indvars.iv78.i = phi i64 [ %indvars.iv.next79.i, %for.inc62.i ], [ 0, %for.end46.i ]
  %exitcond81.not.i = icmp eq i64 %indvars.iv78.i, 2000
  br i1 %exitcond81.not.i, label %for.cond65.i, label %for.cond51.i

for.cond51.i:                                     ; preds = %for.cond47.i, %for.inc59.i
  %indvars.iv74.i = phi i64 [ %indvars.iv.next75.i, %for.inc59.i ], [ 0, %for.cond47.i ]
  %exitcond77.not.i = icmp eq i64 %indvars.iv74.i, 2000
  br i1 %exitcond77.not.i, label %for.inc62.i, label %for.inc59.i

for.inc59.i:                                      ; preds = %for.cond51.i
  %arrayidx58.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv78.i, i64 %indvars.iv74.i
...
for.cond65.i:                                     ; preds = %for.cond47.i, %for.inc95.i
  %indvars.iv90.i = phi i64 [ %indvars.iv.next91.i, %for.inc95.i ], [ 0, %for.cond47.i ]
  %exitcond93.not.i = icmp eq i64 %indvars.iv90.i, 2000
  br i1 %exitcond93.not.i, label %for.cond98.i, label %for.cond69.i

for.cond69.i:                                     ; preds = %for.cond65.i, %for.inc92.i
  %indvars.iv86.i = phi i64 [ %indvars.iv.next87.i, %for.inc92.i ], [ 0, %for.cond65.i ]
  %exitcond89.not.i = icmp eq i64 %indvars.iv86.i, 2000
  br i1 %exitcond89.not.i, label %for.inc95.i, label %for.cond73.preheader.i

for.cond73.preheader.i:                           ; preds = %for.cond69.i
  %arrayidx80.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv86.i, i64 %indvars.iv90.i
...
for.cond73.i:                                     ; preds = %for.inc89.i, %for.cond73.preheader.i
  %indvars.iv82.i = phi i64 [ 0, %for.cond73.preheader.i ], [ %indvars.iv.next83.i, %for.inc89.i ]
  %exitcond85.not.i = icmp eq i64 %indvars.iv82.i, 2000
  br i1 %exitcond85.not.i, label %for.inc92.i, label %for.inc89.i

for.inc89.i:                                      ; preds = %for.cond73.i
  %arrayidx84.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv82.i, i64 %indvars.iv90.i
  %4 = load double, ptr %arrayidx84.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx88.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv86.i, i64 %indvars.iv82.i
...
for.cond98.i:                                     ; preds = %for.cond65.i, %for.inc117.i
  %indvars.iv98.i = phi i64 [ %indvars.iv.next99.i, %for.inc117.i ], [ 0, %for.cond65.i ]
  %exitcond101.not.i = icmp eq i64 %indvars.iv98.i, 2000
  br i1 %exitcond101.not.i, label %init_array.exit, label %for.cond102.i

for.cond102.i:                                    ; preds = %for.cond98.i, %for.inc114.i
  %indvars.iv94.i = phi i64 [ %indvars.iv.next95.i, %for.inc114.i ], [ 0, %for.cond98.i ]
  %exitcond97.not.i = icmp eq i64 %indvars.iv94.i, 2000
  br i1 %exitcond97.not.i, label %for.inc117.i, label %for.inc114.i

for.inc114.i:                                     ; preds = %for.cond102.i
  %arrayidx109.i = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %call.i, i64 0, i64 %indvars.iv98.i, i64 %indvars.iv94.i
  %7 = load double, ptr %arrayidx109.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx113.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv98.i, i64 %indvars.iv94.i
...
for.cond.i2:                                      ; preds = %for.inc57.i, %init_array.exit
  %indvars.iv69.i = phi i64 [ %indvars.iv.next70.i, %for.inc57.i ], [ 0, %init_array.exit ]
  %exitcond76.not.i = icmp eq i64 %indvars.iv69.i, 2000
  br i1 %exitcond76.not.i, label %for.cond60.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i2, %for.inc25.i7
  %indvars.iv60.i = phi i64 [ %indvars.iv.next61.i, %for.inc25.i7 ], [ 0, %for.cond.i2 ]
  %exitcond64.not.i = icmp eq i64 %indvars.iv60.i, %indvars.iv69.i
  br i1 %exitcond64.not.i, label %for.cond28.i, label %for.body3.i

for.body3.i:                                      ; preds = %for.cond1.i
  %arrayidx5.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv69.i, i64 %indvars.iv60.i
  %8 = load double, ptr %arrayidx5.i, align 8, !tbaa !5, !invariant.load !9
  br label %for.cond6.i

for.cond6.i:                                      ; preds = %for.inc.i5, %for.body3.i
  %indvars.iv.i3 = phi i64 [ %indvars.iv.next.i6, %for.inc.i5 ], [ 0, %for.body3.i ]
  %w.0.i = phi double [ %11, %for.inc.i5 ], [ %8, %for.body3.i ]
  %exitcond.not.i4 = icmp eq i64 %indvars.iv.i3, %indvars.iv60.i
  br i1 %exitcond.not.i4, label %for.inc25.i7, label %for.inc.i5

for.inc.i5:                                       ; preds = %for.cond6.i
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv69.i, i64 %indvars.iv.i3
  %9 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv.i3, i64 %indvars.iv60.i
...
for.inc25.i7:                                     ; preds = %for.cond6.i
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv60.i, i64 %indvars.iv60.i
  %12 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !9
  %div.i8 = fdiv double %w.0.i, %12
  store double %div.i8, ptr %arrayidx5.i, align 8, !tbaa !5
  %indvars.iv.next61.i = add nuw nsw i64 %indvars.iv60.i, 1
  br label %for.cond1.i, !llvm.loop !30

for.cond28.i:                                     ; preds = %for.cond1.i, %for.inc54.i
  %indvars.iv71.i = phi i64 [ %indvars.iv.next72.i, %for.inc54.i ], [ %indvars.iv69.i, %for.cond1.i ]
  %exitcond74.not.i = icmp eq i64 %indvars.iv71.i, 2000
  br i1 %exitcond74.not.i, label %for.inc57.i, label %for.body30.i

for.body30.i:                                     ; preds = %for.cond28.i
  %arrayidx34.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv69.i, i64 %indvars.iv71.i
...
for.cond35.i:                                     ; preds = %for.inc47.i, %for.body30.i
  %indvars.iv65.i = phi i64 [ %indvars.iv.next66.i, %for.inc47.i ], [ 0, %for.body30.i ]
  %w.1.i = phi double [ %16, %for.inc47.i ], [ %13, %for.body30.i ]
  %exitcond68.not.i = icmp eq i64 %indvars.iv65.i, %indvars.iv69.i
  br i1 %exitcond68.not.i, label %for.inc54.i, label %for.inc47.i

for.inc47.i:                                      ; preds = %for.cond35.i
  %arrayidx41.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv69.i, i64 %indvars.iv65.i
  %14 = load double, ptr %arrayidx41.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx45.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv65.i, i64 %indvars.iv71.i
...
for.inc57.i:                                      ; preds = %for.cond28.i
  ...
  br label %for.cond.i2, !llvm.loop !33

for.cond60.i:                                     ; preds = %for.cond.i2, %for.inc80.i
  %indvars.iv81.i = phi i64 [ %indvars.iv.next82.i, %for.inc80.i ], [ 0, %for.cond.i2 ]
  %exitcond84.not.i = icmp eq i64 %indvars.iv81.i, 2000
  br i1 %exitcond84.not.i, label %for.cond83.i, label %for.body62.i

for.body62.i:                                     ; preds = %for.cond60.i
  %arrayidx64.i = getelementptr inbounds nuw double, ptr %call1, i64 %indvars.iv81.i
  %17 = load double, ptr %arrayidx64.i, align 8, !tbaa !5, !invariant.load !9
  br label %for.cond65.i9

for.cond65.i9:                                    ; preds = %for.inc75.i, %for.body62.i
  %indvars.iv77.i = phi i64 [ %indvars.iv.next78.i, %for.inc75.i ], [ 0, %for.body62.i ]
  %w.2.i = phi double [ %20, %for.inc75.i ], [ %17, %for.body62.i ]
  %exitcond80.not.i = icmp eq i64 %indvars.iv77.i, %indvars.iv81.i
  br i1 %exitcond80.not.i, label %for.inc80.i, label %for.inc75.i

for.inc75.i:                                      ; preds = %for.cond65.i9
  %arrayidx71.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %indvars.iv81.i, i64 %indvars.iv77.i
  %18 = load double, ptr %arrayidx71.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv77.i
  ...
  br label %for.cond65.i9, !llvm.loop !34

for.inc80.i:                                      ; preds = %for.cond65.i9
  %arrayidx79.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv81.i
...
for.cond88.i:                                     ; preds = %for.inc98.i, %for.body85.i
  %indvars.iv85.i = phi i64 [ %indvars.iv.next86.i, %for.inc98.i ], [ %21, %for.body85.i ]
  %w.3.i = phi double [ %25, %for.inc98.i ], [ %22, %for.body85.i ]
  %exitcond88.not.i = icmp eq i64 %indvars.iv85.i, 1999
  br i1 %exitcond88.not.i, label %for.inc108.i, label %for.inc98.i

for.inc98.i:                                      ; preds = %for.cond88.i
  %indvars.iv.next86.i = add nuw nsw i64 %indvars.iv85.i, 1
  %arrayidx94.i = getelementptr inbounds nuw [2000 x double], ptr %call, i64 %21, i64 %indvars.iv.next86.i
  %23 = load double, ptr %arrayidx94.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx96.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv.next86.i
...
kernel_ludcmp.exit:                               ; preds = %for.cond83.i
  %call.i19 = tail call fastcc double @rtclock() #12
