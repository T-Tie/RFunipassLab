...
for.cond.i:                                       ; preds = %for.inc7.i, %entry
  %indvars.iv8.i = phi i64 [ %indvars.iv.next9.i, %for.inc7.i ], [ 0, %entry ]
...
for.inc.i8:                                       ; preds = %for.cond1.i5
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i6, i64 %indvars.iv65.i
...
for.cond15.i:                                     ; preds = %for.cond.i4, %for.end40.i
  %indvars.iv73.i = phi i64 [ %indvars.iv.next74.i, %for.end40.i ], [ 0, %for.cond.i4 ]
...
for.inc38.i:                                      ; preds = %for.cond20.i
  ...
  %6 = tail call double @llvm.fmuladd.f64(double %sub.i, double %sub.i, double 0.000000e+00) #16
...
for.inc117.i:                                     ; preds = %for.cond101.i
  ...
  %12 = tail call double @llvm.fmuladd.f64(double %10, double %11, double 0.000000e+00)
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1200, ptr nofree noundef nonnull readonly captures(none) %call1) #13
  br label %if.end
