...
entry:
  %call = tail call fastcc double @rtclock() #18
  store double %call, ptr @polybench_t_start, align 8, !tbaa !5
  ret void
}

; Function Attrs: nofree nounwind uwtable
define internal fastcc double @rtclock() unnamed_addr #6 {
entry:
  %Tp = alloca %struct.timeval, align 8
  call void @llvm.lifetime.start.p0(i64 noundef 16, ptr noundef nonnull align 8 %Tp) #19
  %call = call i32 @gettimeofday(ptr noundef nonnull align 8 captures(none) %Tp, ptr noundef null) #18
  %cmp.not = icmp eq i32 %call, 0
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %call) #18
  br label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %conv2, double noundef 0x3EB0C6F7A0B5ED8D, double %conv) #20
  call void @llvm.lifetime.end.p0(i64 noundef 16, ptr noundef nonnull %Tp) #18
  ret double %2
}
...
entry:
  ...
  %mul = mul i64 %n, %conv
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 %ret.i) #19
...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1680000, i32 noundef 8) #18
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #18
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #18
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 1200, i32 noundef 8) #18
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv13.i = phi i64 [ %indvars.iv.next14.i, %for.end.i ], [ 0, %entry ]
  %exitcond16.not.i = icmp eq i64 %indvars.iv13.i, 1400
  br i1 %exitcond16.not.i, label %init_array.exit, label %for.cond1.preheader.i

for.cond1.preheader.i:                            ; preds = %for.cond.i
  %0 = trunc nuw nsw i64 %indvars.iv13.i to i32
...
for.body3.i:                                      ; preds = %for.cond1.i
  %1 = mul nuw nsw i64 %indvars.iv.i, %indvars.iv13.i
  %2 = trunc nuw nsw i64 %1 to i32
  %conv.i = uitofp nneg i32 %2 to double
  %div.i = fdiv double %conv.i, 1.200000e+03
  %add.i = fadd double %div.i, %conv4.i
  %arrayidx6.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv13.i, i64 %indvars.iv.i
  store double %add.i, ptr %arrayidx6.i, align 8, !tbaa !5, !noalias !15
...
init_array.exit:                                  ; preds = %for.cond.i
  %call.i = tail call fastcc double @rtclock() #18
  store double %call.i, ptr @polybench_t_start, align 8, !tbaa !5
  br label %for.cond.i5

for.cond.i5:                                      ; preds = %for.end.i12, %init_array.exit
  %indvars.iv88.i = phi i64 [ %indvars.iv.next89.i, %for.end.i12 ], [ 0, %init_array.exit ]
  %exitcond91.not.i = icmp eq i64 %indvars.iv88.i, 1200
  br i1 %exitcond91.not.i, label %for.cond15.i, label %for.body.i

for.body.i:                                       ; preds = %for.cond.i5
  %arrayidx.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv88.i
  br label %for.cond1.i6

for.cond1.i6:                                     ; preds = %for.body3.i9, %for.body.i
  %indvars.iv.i7 = phi i64 [ %indvars.iv.next.i11, %for.body3.i9 ], [ 0, %for.body.i ]
  %exitcond.not.i8 = icmp eq i64 %indvars.iv.i7, 1400
  br i1 %exitcond.not.i8, label %for.end.i12, label %for.body3.i9

for.body3.i9:                                     ; preds = %for.cond1.i6
  %arrayidx7.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i7, i64 %indvars.iv88.i
  %3 = load double, ptr %arrayidx7.i, align 8, !tbaa !5, !invariant.load !20
...
for.end.i12:                                      ; preds = %for.cond1.i6
  store double 0.000000e+00, ptr %arrayidx.i, align 8, !tbaa !5
  %indvars.iv.next89.i = add nuw nsw i64 %indvars.iv88.i, 1
  br label %for.cond.i5, !llvm.loop !22

for.cond15.i:                                     ; preds = %for.cond.i5, %for.end40.i
  %indvars.iv96.i = phi i64 [ %indvars.iv.next97.i, %for.end40.i ], [ 0, %for.cond.i5 ]
  %exitcond99.not.i = icmp eq i64 %indvars.iv96.i, 1200
  br i1 %exitcond99.not.i, label %for.cond58.i, label %for.body17.i

for.body17.i:                                     ; preds = %for.cond15.i
  %arrayidx19.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv96.i
  %arrayidx28.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv96.i
  %4 = load double, ptr %arrayidx28.i, align 8, !tbaa !5, !invariant.load !20
  br label %for.cond20.i

for.cond20.i:                                     ; preds = %for.body22.i, %for.body17.i
  %indvars.iv92.i = phi i64 [ %indvars.iv.next93.i, %for.body22.i ], [ 0, %for.body17.i ]
  %exitcond95.not.i = icmp eq i64 %indvars.iv92.i, 1400
  br i1 %exitcond95.not.i, label %for.end40.i, label %for.body22.i

for.body22.i:                                     ; preds = %for.cond20.i
  %arrayidx26.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv92.i, i64 %indvars.iv96.i
  %5 = load double, ptr %arrayidx26.i, align 8, !tbaa !5, !invariant.load !20
  %sub.i = fsub double %5, %4
  %6 = tail call double @llvm.fmuladd.f64(double %sub.i, double %sub.i, double 0.000000e+00) #23
...
for.cond58.i:                                     ; preds = %for.cond15.i, %for.end81.i
  %indvars.iv104.i = phi i64 [ %indvars.iv.next105.i, %for.end81.i ], [ 0, %for.cond15.i ]
  %exitcond107.not.i = icmp eq i64 %indvars.iv104.i, 1400
  br i1 %exitcond107.not.i, label %for.cond85.i, label %for.cond61.i

for.cond61.i:                                     ; preds = %for.cond58.i, %for.body63.i
  %indvars.iv100.i = phi i64 [ %indvars.iv.next101.i, %for.body63.i ], [ 0, %for.cond58.i ]
  %exitcond103.not.i = icmp eq i64 %indvars.iv100.i, 1200
  br i1 %exitcond103.not.i, label %for.end81.i, label %for.body63.i

for.body63.i:                                     ; preds = %for.cond61.i
  %arrayidx65.i = getelementptr inbounds nuw double, ptr %call2, i64 %indvars.iv100.i
  %7 = load double, ptr %arrayidx65.i, align 8, !tbaa !5, !invariant.load !20
  %arrayidx69.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv104.i, i64 %indvars.iv100.i
  %8 = load double, ptr %arrayidx69.i, align 8, !tbaa !5, !invariant.load !20
  %sub70.i = fsub double %8, %7
  %arrayidx73.i = getelementptr inbounds nuw double, ptr %call3, i64 %indvars.iv100.i
  %9 = load double, ptr %arrayidx73.i, align 8, !tbaa !5, !invariant.load !20
...
for.end81.i:                                      ; preds = %for.cond61.i
  %indvars.iv.next105.i = add nuw nsw i64 %indvars.iv104.i, 1
  br label %for.cond58.i, !llvm.loop !26

for.cond85.i:                                     ; preds = %for.cond58.i, %for.end130.i
  %indvars.iv112.i = phi i64 [ %indvars.iv.next113.i, %for.end130.i ], [ 0, %for.cond58.i ]
  %exitcond119.not.i = icmp eq i64 %indvars.iv112.i, 1199
  br i1 %exitcond119.not.i, label %kernel_correlation.exit, label %for.cond94.i

for.cond94.i:                                     ; preds = %for.cond101.i, %for.cond85.i
  %indvars.iv.next115.sink.i = phi i64 [ %indvars.iv112.i, %for.cond85.i ], [ %indvars.iv.next115.i, %for.cond101.i ]
  %.sink.i = phi double [ 1.000000e+00, %for.cond85.i ], [ 0.000000e+00, %for.cond101.i ]
  %arrayidx127.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv.next115.sink.i, i64 %indvars.iv112.i
  store double %.sink.i, ptr %arrayidx127.i, align 8, !tbaa !5
  %indvars.iv.next115.i = add nuw nsw i64 %indvars.iv.next115.sink.i, 1
  %exitcond117.not.i = icmp eq i64 %indvars.iv.next115.sink.i, 1199
  br i1 %exitcond117.not.i, label %for.end130.i, label %for.body96.i

for.body96.i:                                     ; preds = %for.cond94.i
  %arrayidx100.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv112.i, i64 %indvars.iv.next115.i
...
for.cond101.i:                                    ; preds = %for.body103.i, %for.body96.i
  %indvars.iv108.i = phi i64 [ %indvars.iv.next109.i, %for.body103.i ], [ 0, %for.body96.i ]
  %exitcond111.not.i = icmp eq i64 %indvars.iv108.i, 1400
  br i1 %exitcond111.not.i, label %for.cond94.i, label %for.body103.i, !llvm.loop !27

for.body103.i:                                    ; preds = %for.cond101.i
  %arrayidx107.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv108.i, i64 %indvars.iv112.i
  %10 = load double, ptr %arrayidx107.i, align 8, !tbaa !5, !invariant.load !20
  %arrayidx111.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv108.i, i64 %indvars.iv.next115.i
  %11 = load double, ptr %arrayidx111.i, align 8, !tbaa !5, !invariant.load !20
  %12 = tail call double @llvm.fmuladd.f64(double %10, double %11, double 0.000000e+00) #20
  store double %12, ptr %arrayidx100.i, align 8, !tbaa !5
  %indvars.iv.next109.i = add nuw nsw i64 %indvars.iv108.i, 1
  br label %for.cond101.i, !llvm.loop !28
...
kernel_correlation.exit:                          ; preds = %for.cond85.i
  ...
  %call.i19 = tail call fastcc double @rtclock() #18
...
land.lhs.true:                                    ; preds = %kernel_correlation.exit
  %13 = load ptr, ptr %argv, align 8, !tbaa !29, !invariant.load !20
  %strcmpload = load i8, ptr %13, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1200, ptr nofree noundef nonnull readonly captures(none) %call1) #24
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %kernel_correlation.exit
  tail call void @free(ptr noundef %call) #24
  tail call void @free(ptr noundef nonnull %call1) #24
...
define internal fastcc void @print_array(i32 noundef %m, ptr nofree noundef readonly captures(none) %corr) unnamed_addr #13 {
entry:
  tail call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly captures(none) dereferenceable(23) @.str.1.6) #18
...
if.then:                                          ; preds = %for.body4
  tail call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly captures(none) dereferenceable(2) @.str.4.9) #18
  br label %if.end
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %6 = load double, ptr %arrayidx8, align 8, !tbaa !5, !invariant.load !20
...
for.end12:                                        ; preds = %for.cond
  ...
  tail call void @outlined_ir_func_0(ptr nofree noundef nonnull readonly captures(none) dereferenceable(23) @.str.7) #18
  ret void
}
...
define internal void @outlined_ir_func_0(ptr nofree noundef nonnull readonly captures(none) dereferenceable(2) %0) #15 {
if.then_after_outline.exitStub:
  %1 = load ptr, ptr @stderr, align 8, !tbaa !31
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull readonly captures(none) dereferenceable(2) %0) #25
  ret void
}
...
attributes #19 = { nofree nounwind willreturn memory(readwrite) }
...
!15 = !{!16}
!16 = distinct !{!16, !17, !"init_array: %float_n"}
