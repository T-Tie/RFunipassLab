...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call) #20
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A) unnamed_addr #11 {
entry:
  br label %for.body
