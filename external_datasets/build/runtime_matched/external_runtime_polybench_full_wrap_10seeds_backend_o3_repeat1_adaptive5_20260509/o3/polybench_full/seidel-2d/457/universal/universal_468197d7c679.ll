...
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %A) unnamed_addr #11 {
entry:
  br label %for.body
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx7 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv4, i64 %indvars.iv
