...
for.cond.i:                                       ; preds = %for.inc12.i, %entry
  %indvars.iv17.i = phi i64 [ %indvars.iv.next18.i, %for.inc12.i ], [ 0, %entry ]
...
for.cond15.i:                                     ; preds = %for.cond.i, %for.inc30.i
  %indvars.iv25.i = phi i64 [ %indvars.iv.next26.i, %for.inc30.i ], [ 0, %for.cond.i ]
...
for.cond19.i:                                     ; preds = %for.cond15.i, %for.inc27.i
  %indvars.iv21.i = phi i64 [ %indvars.iv.next22.i, %for.inc27.i ], [ 0, %for.cond15.i ]
  %exitcond24.not.i = icmp eq i64 %indvars.iv21.i, 1200
  br i1 %exitcond24.not.i, label %for.inc30.i, label %for.inc27.i
...
for.cond.loopexit.i:                              ; preds = %for.cond32.i
  ...
  br label %for.cond.i2, !llvm.loop !22

for.cond.i2:                                      ; preds = %for.cond.loopexit.i, %init_array.exit
  %indvars.iv59.i = phi i64 [ %indvars.iv.next60.i, %for.cond.loopexit.i ], [ 0, %init_array.exit ]
  %indvars.iv53.i = phi i64 [ %indvars.iv.next54.i, %for.cond.loopexit.i ], [ 1, %init_array.exit ]
  %exitcond62.not.i = icmp eq i64 %indvars.iv59.i, 1200
  br i1 %exitcond62.not.i, label %kernel_gramschmidt.exit, label %for.cond1.i3

for.cond1.i3:                                     ; preds = %for.cond.i2, %for.inc.i6
  %indvars.iv.i4 = phi i64 [ %indvars.iv.next.i7, %for.inc.i6 ], [ 0, %for.cond.i2 ]
  %nrm.0.i = phi double [ %4, %for.inc.i6 ], [ 0.000000e+00, %for.cond.i2 ]
  %exitcond.not.i5 = icmp eq i64 %indvars.iv.i4, 1000
  br i1 %exitcond.not.i5, label %for.end.i, label %for.inc.i6

for.inc.i6:                                       ; preds = %for.cond1.i3
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i4, i64 %indvars.iv59.i
  ...
  br label %for.cond1.i3, !llvm.loop !23

for.end.i:                                        ; preds = %for.cond1.i3
  %call.i = tail call double @sqrt(double noundef %nrm.0.i) #13, !tbaa !24
  %arrayidx13.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv59.i, i64 %indvars.iv59.i
  store double %call.i, ptr %arrayidx13.i, align 8, !tbaa !5
  br label %for.cond14.i

for.cond14.i:                                     ; preds = %for.inc29.i, %for.end.i
  %indvars.iv41.i = phi i64 [ %indvars.iv.next42.i, %for.inc29.i ], [ 0, %for.end.i ]
  %exitcond44.not.i = icmp eq i64 %indvars.iv41.i, 1000
  br i1 %exitcond44.not.i, label %for.cond32.i, label %for.inc29.i

for.inc29.i:                                      ; preds = %for.cond14.i
  %arrayidx20.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv41.i, i64 %indvars.iv59.i
  %5 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !9
  %div.i8 = fdiv double %5, %call.i
  %arrayidx28.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv41.i, i64 %indvars.iv59.i
  store double %div.i8, ptr %arrayidx28.i, align 8, !tbaa !5
  %indvars.iv.next42.i = add nuw nsw i64 %indvars.iv41.i, 1
  br label %for.cond14.i, !llvm.loop !26

for.cond32.i:                                     ; preds = %for.cond14.i, %for.inc79.i
  %indvars.iv55.i = phi i64 [ %indvars.iv.next56.i, %for.inc79.i ], [ %indvars.iv53.i, %for.cond14.i ]
  %exitcond58.not.i = icmp eq i64 %indvars.iv55.i, 1200
  br i1 %exitcond58.not.i, label %for.cond.loopexit.i, label %for.body34.i

for.body34.i:                                     ; preds = %for.cond32.i
  %arrayidx38.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv59.i, i64 %indvars.iv55.i
...
for.cond39.i:                                     ; preds = %for.inc54.i, %for.body34.i
  %indvars.iv45.i = phi i64 [ %indvars.iv.next46.i, %for.inc54.i ], [ 0, %for.body34.i ]
  %exitcond48.not.i = icmp eq i64 %indvars.iv45.i, 1000
  br i1 %exitcond48.not.i, label %for.cond57.i, label %for.inc54.i

for.inc54.i:                                      ; preds = %for.cond39.i
  %arrayidx45.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv45.i, i64 %indvars.iv59.i
  %6 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx49.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv45.i, i64 %indvars.iv55.i
...
for.cond57.i:                                     ; preds = %for.cond39.i, %for.inc76.i
  %indvars.iv49.i = phi i64 [ %indvars.iv.next50.i, %for.inc76.i ], [ 0, %for.cond39.i ]
  %exitcond52.not.i = icmp eq i64 %indvars.iv49.i, 1000
  br i1 %exitcond52.not.i, label %for.inc79.i, label %for.inc76.i

for.inc76.i:                                      ; preds = %for.cond57.i
  %arrayidx63.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv49.i, i64 %indvars.iv55.i
  %9 = load double, ptr %arrayidx63.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx67.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv49.i, i64 %indvars.iv59.i
...
kernel_gramschmidt.exit:                          ; preds = %for.cond.i2
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1000, i32 noundef 1200, ptr nofree noundef readonly captures(none) %call1, ptr nofree noundef readonly captures(none) %call2) #13
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %m, i32 noundef %n, ptr nofree noundef readonly captures(none) %R, ptr nofree noundef readonly captures(none) %Q) unnamed_addr #8 {
entry:
...
for.cond2.preheader:                              ; preds = %for.cond
  %2 = mul nuw nsw i64 %indvars.iv22, %1
  br label %for.cond2
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %7 = load double, ptr %arrayidx8, align 8, !tbaa !5, !invariant.load !9
...
for.end12:                                        ; preds = %for.cond
  ...
  %smax38 = tail call i32 @llvm.smax.i32(i32 %m, i32 0)
...
for.cond18.preheader:                             ; preds = %for.cond15
  %10 = mul nuw nsw i64 %indvars.iv34, %1
  br label %for.cond18
...
for.body20:                                       ; preds = %for.cond18
  %11 = add nuw nsw i64 %indvars.iv28, %10
...
for.inc33:                                        ; preds = %for.body20, %if.then25
  ...
  %15 = load double, ptr %arrayidx31, align 8, !tbaa !5, !invariant.load !9
...
for.end38:                                        ; preds = %for.cond15
  ...
  tail call fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(23) @.str.8) #13
  ret void
}
...
define internal fastcc void @outlined_ir_func_0(ptr noundef nonnull dereferenceable(23) %0) unnamed_addr #9 {
