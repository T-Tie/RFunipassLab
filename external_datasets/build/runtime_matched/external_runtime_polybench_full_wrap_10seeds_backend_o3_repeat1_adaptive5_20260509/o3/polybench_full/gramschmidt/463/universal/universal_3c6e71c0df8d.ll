...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #14
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #14
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #14
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call1, ptr nofree noundef nonnull writeonly captures(none) %call2) #16
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %A, ptr nofree noundef nonnull writeonly captures(none) %R, ptr nofree noundef nonnull writeonly captures(none) %Q) unnamed_addr #8 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.end, %entry
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %for.end ], [ 0, %entry ]
  %exitcond11.not = icmp eq i64 %indvars.iv8, 1000
  br i1 %exitcond11.not, label %for.body18, label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %div, double noundef 1.000000e+02, double noundef 1.000000e+01) #17
  %arrayidx7 = getelementptr inbounds nuw [1200 x double], ptr %A, i64 %indvars.iv8, i64 %indvars.iv
  store double %2, ptr %arrayidx7, align 8, !tbaa !11
  %arrayidx11 = getelementptr inbounds nuw [1200 x double], ptr %Q, i64 %indvars.iv8, i64 %indvars.iv
  store double 0.000000e+00, ptr %arrayidx11, align 8, !tbaa !11
...
for.cond19:                                       ; preds = %for.body22, %for.body18
  %indvars.iv12 = phi i64 [ %indvars.iv.next13, %for.body22 ], [ 0, %for.body18 ]
  %exitcond15.not = icmp eq i64 %indvars.iv12, 1200
  br i1 %exitcond15.not, label %for.body18, label %for.body22

for.body22:                                       ; preds = %for.cond19
  %arrayidx26 = getelementptr inbounds nuw [1200 x double], ptr %R, i64 0, i64 %indvars.iv12
  store double 0.000000e+00, ptr %arrayidx26, align 8, !tbaa !11
