...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1440000, i32 noundef 8) #16
  %call2 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #16
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call1, ptr nofree noundef nonnull writeonly captures(none) %call2) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %A, ptr nofree noundef nonnull writeonly captures(none) %R, ptr nofree noundef nonnull writeonly captures(none) %Q) unnamed_addr #11 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc12, %entry
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %for.inc12 ], [ 0, %entry ]
  %exitcond8.not = icmp eq i64 %indvars.iv5, 1000
  br i1 %exitcond8.not, label %for.body18, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %div, double noundef 1.000000e+02, double noundef 1.000000e+01) #22
  %arrayidx7 = getelementptr inbounds nuw [1200 x double], ptr %A, i64 %indvars.iv5, i64 %indvars.iv
  store double %2, ptr %arrayidx7, align 8, !tbaa !5
  %arrayidx11 = getelementptr inbounds nuw [1200 x double], ptr %Q, i64 %indvars.iv5, i64 %indvars.iv
...
for.body18:                                       ; preds = %for.cond19, %for.cond
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc27, %for.body18
  %indvars.iv9 = phi i64 [ %indvars.iv.next10, %for.inc27 ], [ 0, %for.body18 ]
  %exitcond12.not = icmp eq i64 %indvars.iv9, 1200
  br i1 %exitcond12.not, label %for.body18, label %for.inc27

for.inc27:                                        ; preds = %for.cond19
  %arrayidx26 = getelementptr inbounds nuw [1200 x double], ptr %R, i64 0, i64 %indvars.iv9
  store double 0.000000e+00, ptr %arrayidx26, align 8, !tbaa !5
...
attributes #21 = { nofree noreturn nounwind memory(write) }
