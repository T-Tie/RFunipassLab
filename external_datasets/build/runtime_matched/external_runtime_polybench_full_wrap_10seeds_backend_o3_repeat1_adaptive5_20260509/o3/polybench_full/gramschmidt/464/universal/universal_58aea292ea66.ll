...
for.cond.i:                                       ; preds = %for.inc12.i, %entry
  ...
  %exitcond26.not.i = icmp eq i64 %indvars.iv21.i, 1000
  br i1 %exitcond26.not.i, label %for.cond15.i, label %for.cond1.i
...
for.cond15.i:                                     ; preds = %for.cond.i, %for.inc30.i
  %indvars.iv32.i = phi i64 [ %indvars.iv.next33.i, %for.inc30.i ], [ 0, %for.cond.i ]
  %exitcond36.not.i = icmp eq i64 %indvars.iv32.i, 1200
  br i1 %exitcond36.not.i, label %init_array.exit, label %for.cond19.i

for.cond19.i:                                     ; preds = %for.cond15.i, %for.inc27.i
  %indvars.iv27.i = phi i64 [ %indvars.iv.next28.i, %for.inc27.i ], [ 0, %for.cond15.i ]
  %exitcond31.not.i = icmp eq i64 %indvars.iv27.i, 1200
  br i1 %exitcond31.not.i, label %for.inc30.i, label %for.inc27.i

for.inc27.i:                                      ; preds = %for.cond19.i
  %arrayidx26.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv32.i, i64 %indvars.iv27.i
...
for.cond.i3:                                      ; preds = %for.cond.loopexit.i, %init_array.exit
  %indvars.iv78.i = phi i64 [ %indvars.iv.next79.i, %for.cond.loopexit.i ], [ 0, %init_array.exit ]
  %indvars.iv71.i = phi i64 [ %indvars.iv.next72.i, %for.cond.loopexit.i ], [ 1, %init_array.exit ]
  %exitcond83.not.i = icmp eq i64 %indvars.iv78.i, 1200
  br i1 %exitcond83.not.i, label %kernel_gramschmidt.exit, label %for.cond1.i4
...
for.inc.i7:                                       ; preds = %for.cond1.i4
  %arrayidx5.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv.i5, i64 %indvars.iv78.i
...
for.end.i:                                        ; preds = %for.cond1.i4
  ...
  %arrayidx13.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv78.i, i64 %indvars.iv78.i
  store double %call.i, ptr %arrayidx13.i, align 8, !tbaa !5
  br label %for.cond14.i

for.cond14.i:                                     ; preds = %for.inc29.i, %for.end.i
  %indvars.iv56.i = phi i64 [ %indvars.iv.next57.i, %for.inc29.i ], [ 0, %for.end.i ]
  %exitcond60.not.i = icmp eq i64 %indvars.iv56.i, 1000
  br i1 %exitcond60.not.i, label %for.cond32.i, label %for.inc29.i

for.inc29.i:                                      ; preds = %for.cond14.i
  %arrayidx20.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv56.i, i64 %indvars.iv78.i
  %5 = load double, ptr %arrayidx20.i, align 8, !tbaa !5, !invariant.load !9
  %div.i9 = fdiv double %5, %call.i
  %arrayidx28.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv56.i, i64 %indvars.iv78.i
...
for.cond32.i:                                     ; preds = %for.cond14.i, %for.inc79.i
  %indvars.iv73.i = phi i64 [ %indvars.iv.next74.i, %for.inc79.i ], [ %indvars.iv71.i, %for.cond14.i ]
  %exitcond77.not.i = icmp eq i64 %indvars.iv73.i, 1200
  br i1 %exitcond77.not.i, label %for.cond.loopexit.i, label %for.body34.i

for.body34.i:                                     ; preds = %for.cond32.i
  %arrayidx38.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv78.i, i64 %indvars.iv73.i
...
for.cond39.i:                                     ; preds = %for.inc54.i, %for.body34.i
  %indvars.iv61.i = phi i64 [ %indvars.iv.next62.i, %for.inc54.i ], [ 0, %for.body34.i ]
  %exitcond65.not.i = icmp eq i64 %indvars.iv61.i, 1000
  br i1 %exitcond65.not.i, label %for.cond57.i, label %for.inc54.i

for.inc54.i:                                      ; preds = %for.cond39.i
  %arrayidx45.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv61.i, i64 %indvars.iv78.i
  %6 = load double, ptr %arrayidx45.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx49.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv61.i, i64 %indvars.iv73.i
...
for.cond57.i:                                     ; preds = %for.cond39.i, %for.inc76.i
  %indvars.iv66.i = phi i64 [ %indvars.iv.next67.i, %for.inc76.i ], [ 0, %for.cond39.i ]
  %exitcond70.not.i = icmp eq i64 %indvars.iv66.i, 1000
  br i1 %exitcond70.not.i, label %for.inc79.i, label %for.inc76.i

for.inc76.i:                                      ; preds = %for.cond57.i
  %arrayidx63.i = getelementptr inbounds nuw [1200 x double], ptr %call, i64 %indvars.iv66.i, i64 %indvars.iv73.i
  %9 = load double, ptr %arrayidx63.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx67.i = getelementptr inbounds nuw [1200 x double], ptr %call2, i64 %indvars.iv66.i, i64 %indvars.iv78.i
...
kernel_gramschmidt.exit:                          ; preds = %for.cond.i3
  %call.i23 = tail call fastcc double @rtclock() #13
...
if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1000, i32 noundef 1200, ptr noundef %call, ptr noundef %call1, ptr noundef %call2) #13
  br label %if.end
...
for.end38:                                        ; preds = %for.cond15
  ...
  tail call void @outlined_ir_func_0(ptr nonnull @.str.8)
  ret void
}
