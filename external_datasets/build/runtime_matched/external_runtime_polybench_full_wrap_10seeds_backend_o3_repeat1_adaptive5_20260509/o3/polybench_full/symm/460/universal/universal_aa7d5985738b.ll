...
for.body:                                         ; preds = %entry, %for.end
  ...
  %0 = add nuw nsw i64 %indvars.iv8, 1200
  br label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  %1 = add nuw nsw i64 %indvars.iv, %indvars.iv8
  %2 = trunc nuw i64 %1 to i32
  %rem = urem i32 %2, 100
  %conv = uitofp nneg i32 %rem to double
  %div = fdiv double %conv, 1.000000e+03
  %arrayidx6 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv8, i64 %indvars.iv
  ...
  %arrayidx15 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 %indvars.iv8, i64 %indvars.iv
