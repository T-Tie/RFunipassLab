...
entry:
  ...
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr nofree noundef writeonly align 8 captures(none) %call, ptr nofree noundef writeonly captures(none) %call1) #19
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %A, ptr nofree noundef writeonly captures(none) %B) unnamed_addr #8 {
entry:
...
for.cond11:                                       ; preds = %for.inc24, %for.end
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc24 ], [ 0, %for.end ]
  %exitcond.not = icmp eq i64 %indvars.iv, 1200
  br i1 %exitcond.not, label %for.end26, label %for.inc24

for.inc24:                                        ; preds = %for.cond11
