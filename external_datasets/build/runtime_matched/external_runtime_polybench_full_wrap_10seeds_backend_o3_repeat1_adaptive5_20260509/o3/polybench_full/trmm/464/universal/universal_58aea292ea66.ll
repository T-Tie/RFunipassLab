...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1000000, i32 noundef 8) #12
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1200000, i32 noundef 8) #12
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.inc27.i, %entry
  %indvars.iv29.i = phi i64 [ %indvars.iv.next30.i, %for.inc27.i ], [ 0, %entry ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv29.i, 1000
  br i1 %exitcond34.not.i, label %init_array.exit, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i, %for.inc.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.inc.i ], [ 0, %for.cond.i ]
  %exitcond.not.i = icmp eq i64 %indvars.iv.i, %indvars.iv29.i
  br i1 %exitcond.not.i, label %for.end.i, label %for.inc.i

for.inc.i:                                        ; preds = %for.cond1.i
  %0 = add nuw nsw i64 %indvars.iv.i, %indvars.iv29.i
  %1 = trunc nuw i64 %0 to i32
  %rem.i = srem i32 %1, 1000
  %conv.i = uitofp nneg i32 %rem.i to double
  %div.i = fdiv double %conv.i, 1.000000e+03
  %arrayidx6.i = getelementptr inbounds nuw [1000 x double], ptr %call, i64 %indvars.iv29.i, i64 %indvars.iv.i
  store double %div.i, ptr %arrayidx6.i, align 8, !tbaa !5
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br label %for.cond1.i, !llvm.loop !18

for.end.i:                                        ; preds = %for.cond1.i
  %arrayidx10.i = getelementptr inbounds nuw [1000 x double], ptr %call, i64 %indvars.iv29.i, i64 %indvars.iv29.i
  store double 1.000000e+00, ptr %arrayidx10.i, align 8, !tbaa !5
  %2 = trunc nuw nsw i64 %indvars.iv29.i to i32
  %sub.i = add i32 %2, 1200
  br label %for.cond11.i

for.cond11.i:                                     ; preds = %for.inc24.i, %for.end.i
  %indvars.iv24.i = phi i64 [ %indvars.iv.next25.i, %for.inc24.i ], [ 0, %for.end.i ]
  %exitcond28.not.i = icmp eq i64 %indvars.iv24.i, 1200
  br i1 %exitcond28.not.i, label %for.inc27.i, label %for.inc24.i

for.inc24.i:                                      ; preds = %for.cond11.i
  %3 = trunc nuw nsw i64 %indvars.iv24.i to i32
  %add15.i = sub i32 %sub.i, %3
  %rem16.i = srem i32 %add15.i, 1200
  %conv17.i = sitofp i32 %rem16.i to double
  %div19.i = fdiv double %conv17.i, 1.200000e+03
  %arrayidx23.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv29.i, i64 %indvars.iv24.i
...
for.cond.i2:                                      ; preds = %for.inc28.i, %init_array.exit
  %indvars.iv.i3 = phi i64 [ %indvars.iv.next.i7, %for.inc28.i ], [ 0, %init_array.exit ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv.i3, 1000
  br i1 %exitcond30.not.i, label %kernel_trmm.exit, label %for.cond1.i4

for.cond1.i4:                                     ; preds = %for.cond.i2, %for.inc25.i
  %indvars.iv22.i = phi i64 [ %indvars.iv.next23.i, %for.inc25.i ], [ 0, %for.cond.i2 ]
  %exitcond26.not.i = icmp eq i64 %indvars.iv22.i, 1200
  br i1 %exitcond26.not.i, label %for.inc28.i, label %for.cond4.preheader.i

for.cond4.preheader.i:                            ; preds = %for.cond1.i4
  %arrayidx16.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv.i3, i64 %indvars.iv22.i
  br label %for.cond4.i

for.cond4.i:                                      ; preds = %for.inc.i6, %for.cond4.preheader.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.i3, %for.cond4.preheader.i ], [ %indvars.iv.next20.i, %for.inc.i6 ]
  %exitcond.not.i5 = icmp eq i64 %indvars.iv19.i, 999
  br i1 %exitcond.not.i5, label %for.inc25.i, label %for.inc.i6

for.inc.i6:                                       ; preds = %for.cond4.i
  %indvars.iv.next20.i = add nuw nsw i64 %indvars.iv19.i, 1
  %arrayidx8.i = getelementptr inbounds nuw [1000 x double], ptr %call, i64 %indvars.iv.next20.i, i64 %indvars.iv.i3
  %4 = load double, ptr %arrayidx8.i, align 8, !tbaa !5, !invariant.load !9
  %arrayidx12.i = getelementptr inbounds nuw [1200 x double], ptr %call1, i64 %indvars.iv.next20.i, i64 %indvars.iv22.i
  %5 = load double, ptr %arrayidx12.i, align 8, !tbaa !5, !invariant.load !9
  %6 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !9
  %7 = tail call double @llvm.fmuladd.f64(double %4, double %5, double %6) #15
  store double %7, ptr %arrayidx16.i, align 8, !tbaa !5
  br label %for.cond4.i, !llvm.loop !21

for.inc25.i:                                      ; preds = %for.cond4.i
  %8 = load double, ptr %arrayidx16.i, align 8, !tbaa !5, !invariant.load !9
  %mul.i = fmul double %8, 1.500000e+00
  store double %mul.i, ptr %arrayidx16.i, align 8, !tbaa !5
  %indvars.iv.next23.i = add nuw nsw i64 %indvars.iv22.i, 1
  br label %for.cond1.i4, !llvm.loop !22

for.inc28.i:                                      ; preds = %for.cond1.i4
  %indvars.iv.next.i7 = add nuw nsw i64 %indvars.iv.i3, 1
  br label %for.cond.i2, !llvm.loop !23

kernel_trmm.exit:                                 ; preds = %for.cond.i2
...
land.lhs.true:                                    ; preds = %kernel_trmm.exit
  %9 = load ptr, ptr %argv, align 8, !tbaa !24
  %strcmpload = load i8, ptr %9, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 1000, i32 noundef 1200, ptr noundef %call1) #12
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %m, i32 noundef %n, ptr noundef readonly captures(none) %B) unnamed_addr #8 {
entry:
  ...
  %1 = zext i32 %m to i64
  %smax14 = tail call i32 @llvm.smax.i32(i32 %m, i32 0)
