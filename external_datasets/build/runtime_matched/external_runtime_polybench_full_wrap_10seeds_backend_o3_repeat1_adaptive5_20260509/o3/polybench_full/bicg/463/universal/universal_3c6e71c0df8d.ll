...
if.then.i:                                        ; preds = %entry
  call fastcc void @outlined_ir_func_0.2() #14
...
entry:
  ...
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1900, i32 noundef 8) #14
  ...
  %call4 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 2100, i32 noundef 8) #14
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call4, ptr nofree noundef nonnull writeonly captures(none) %call3) #16
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %A, ptr nofree noundef nonnull writeonly captures(none) %r, ptr nofree noundef nonnull writeonly captures(none) %p) unnamed_addr #8 {
entry:
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond12, %for.cond
  store double 0.000000e+00, ptr %r, align 8, !tbaa !11
  br label %for.cond12

for.cond12:                                       ; preds = %for.body15, %for.body5
  %indvars.iv6 = phi i64 [ %indvars.iv.next7, %for.body15 ], [ 0, %for.body5 ]
  %exitcond9.not = icmp eq i64 %indvars.iv6, 1900
  br i1 %exitcond9.not, label %for.body5, label %for.body15

for.body15:                                       ; preds = %for.cond12
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %arrayidx23 = getelementptr inbounds nuw [1900 x double], ptr %A, i64 0, i64 %indvars.iv6
  store double 0.000000e+00, ptr %arrayidx23, align 8, !tbaa !11
  br label %for.cond12, !llvm.loop !17
}

; Function Attrs: cold minsize nofree nounwind optsize memory(readwrite, argmem: none) uwtable
define internal fastcc void @outlined_ir_func_0.2() unnamed_addr #9 {
