...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 7840000, i32 noundef 4) #15
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end.i, %entry
  %indvars.iv21.i = phi i64 [ %indvars.iv.next22.i, %for.end.i ], [ 0, %entry ]
  %exitcond25.not.i = icmp eq i64 %indvars.iv21.i, 2800
  br i1 %exitcond25.not.i, label %init_array.exit, label %for.cond1.i
...
for.body3.i:                                      ; preds = %for.cond1.i
  ...
  store i32 %spec.select.i, ptr %arrayidx5.i, align 4, !tbaa !15
...
define internal fastcc void @print_array(i32 noundef %n, ptr noundef readonly captures(none) %path) unnamed_addr #9 {
entry:
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %6 = load i32, ptr %arrayidx8, align 4, !tbaa !15
  %call9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.5.10, i32 noundef %6) #17
