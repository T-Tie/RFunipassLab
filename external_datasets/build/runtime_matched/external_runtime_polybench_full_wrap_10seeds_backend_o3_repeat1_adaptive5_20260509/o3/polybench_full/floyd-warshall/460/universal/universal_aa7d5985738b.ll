...
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %path) unnamed_addr #8 {
entry:
  br label %for.body
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds nuw [2800 x i32], ptr %path, i64 %indvars.iv11, i64 %indvars.iv
  ...
  %spec.select = select i1 %or.cond7, i32 999, i32 %add
