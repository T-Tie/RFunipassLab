...
entry:
  tail call void @polybench_prepare_instruments() #14
  unreachable
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 16, ptr noundef nonnull align 8 %Tp.i) #15
  %call.i = call i32 @gettimeofday(ptr noundef nonnull align 8 %Tp.i, ptr noundef null) #16
  %cmp.not.i = icmp eq i32 %call.i, 0
  br i1 %cmp.not.i, label %rtclock.exit, label %if.then.i

if.then.i:                                        ; preds = %entry
  %call1.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %call.i) #16
...
rtclock.exit:                                     ; preds = %entry, %if.then.i
  ...
  call void @llvm.lifetime.end.p0(i64 noundef 16, ptr noundef nonnull %Tp.i) #16
...
if.then.i:                                        ; preds = %entry
  call void @outlined_ir_func_1() #16
...
entry:
  ...
  %call = tail call ptr @polybench_alloc_data(i64 noundef 4000000, i32 noundef 8) #16
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call3 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call4 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call5 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call6 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call7 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  %call8 = tail call ptr @polybench_alloc_data(i64 noundef 2000, i32 noundef 8) #16
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef writeonly captures(none) %call, ptr nofree noundef writeonly align 8 captures(none) %call1, ptr nofree noundef writeonly align 8 captures(none) %call2, ptr nofree noundef writeonly align 8 captures(none) %call3, ptr nofree noundef writeonly align 8 captures(none) %call4, ptr nofree noundef writeonly align 8 captures(none) %call5, ptr nofree noundef writeonly align 8 captures(none) %call6, ptr nofree noundef writeonly align 8 captures(none) %call7, ptr nofree noundef writeonly align 8 captures(none) %call8) #19
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %beta, ptr nofree noundef writeonly captures(none) %A, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %u1, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %v1, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %u2, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %v2, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %w, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %x, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %y, ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) initializes((0, 8)) %z) unnamed_addr #8 {
entry:
...
for.body:                                         ; preds = %entry, %for.end
  ...
  store double 0.000000e+00, ptr %u1, align 8, !tbaa !11
  store double 2.500000e-04, ptr %u2, align 8, !tbaa !11
  store double 1.250000e-04, ptr %v1, align 8, !tbaa !11
  store double 0x3F15D867C3ECE2A5, ptr %v2, align 8, !tbaa !11
  store double 6.250000e-05, ptr %y, align 8, !tbaa !11
  store double 0x3F0D208A5A912E32, ptr %z, align 8, !tbaa !11
  store double 0.000000e+00, ptr %x, align 8, !tbaa !11
  store double 0.000000e+00, ptr %w, align 8, !tbaa !11
  br label %for.cond35
...
if.then_after_outline.exitStub:
  ...
  %1 = tail call i64 @fwrite(ptr noundef nonnull @.str.4, i64 noundef 50, i64 noundef 1, ptr noundef %0) #20
  ret void
}
...
attributes #19 = { noreturn nounwind memory(write) }
