...
define dso_local void @kernel_doitgen(i32 noundef %nr, i32 noundef %nq, i32 noundef %np, ptr nofree noundef captures(none) %A, ptr nofree noundef readonly captures(none) %C4, ptr nofree noundef captures(none) %sum) local_unnamed_addr #11 {
entry:
  %smax = call i32 @llvm.smax.i32(i32 %np, i32 0)
  %smax44 = call i32 @llvm.smax.i32(i32 %nq, i32 0)
  %smax50 = call i32 @llvm.smax.i32(i32 %nr, i32 0)
...
for.cond1:                                        ; preds = %for.cond, %for.end38
  %indvars.iv41 = phi i64 [ %indvars.iv.next42, %for.end38 ], [ 0, %for.cond ]
...
for.cond4:                                        ; preds = %for.cond1, %for.end
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.end ], [ 0, %for.cond1 ]
...
for.body9:                                        ; preds = %for.cond7
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %0, double %1, double 0.000000e+00) #23
...
for.cond25:                                       ; preds = %for.cond4, %for.body27
  %indvars.iv36 = phi i64 [ %indvars.iv.next37, %for.body27 ], [ 0, %for.cond4 ]
  %exitcond40.not = icmp eq i64 %indvars.iv36, %wide.trip.count34
  br i1 %exitcond40.not, label %for.end38, label %for.body27
...
define dso_local noundef i32 @main(i32 noundef %argc, ptr nofree noundef readonly captures(none) %argv) local_unnamed_addr #12 {
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 3360000, i32 noundef 8) #19
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 160, i32 noundef 8) #19
  %call2 = tail call ptr @polybench_alloc_data(i64 noundef 25600, i32 noundef 8) #19
  br label %for.cond.i

for.cond.i:                                       ; preds = %for.end14.i, %entry
  %indvars.iv31.i = phi i64 [ %indvars.iv.next32.i, %for.end14.i ], [ 0, %entry ]
  %exitcond34.not.i = icmp eq i64 %indvars.iv31.i, 150
  br i1 %exitcond34.not.i, label %for.cond18.i, label %for.cond1.i

for.cond1.i:                                      ; preds = %for.cond.i, %for.end.i
  %indvars.iv26.i = phi i64 [ %indvars.iv.next27.i, %for.end.i ], [ 0, %for.cond.i ]
  %exitcond30.not.i = icmp eq i64 %indvars.iv26.i, 140
  br i1 %exitcond30.not.i, label %for.end14.i, label %for.cond4.preheader.i
...
for.cond22.i:                                     ; preds = %for.cond18.i, %for.body25.i
  ...
  br i1 %exitcond39.not.i, label %for.end37.i, label %for.body25.i
...
init_array.exit:                                  ; preds = %for.cond18.i
  tail call void @kernel_doitgen(i32 noundef 150, i32 noundef 140, i32 noundef 160, ptr nofree noundef captures(none) %call, ptr nofree noundef readonly captures(none) %call2, ptr nofree noundef captures(none) %call1) #19
...
land.lhs.true:                                    ; preds = %init_array.exit
  %5 = load ptr, ptr %argv, align 8, !tbaa !25, !invariant.load !15
  %strcmpload = load i8, ptr %5, align 1
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 150, i32 noundef 140, i32 noundef 160, ptr nofree noundef readonly captures(none) %call) #19
  br label %if.end
...
define internal fastcc void @print_array(i32 noundef %nr, i32 noundef %nq, i32 noundef %np, ptr nofree noundef readonly captures(none) %A) unnamed_addr #14 {
entry:
...
for.cond2:                                        ; preds = %for.cond2.preheader, %for.end
  %indvars.iv16 = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next17, %for.end ]
...
if.end:                                           ; preds = %if.then, %for.body7
  ...
  %7 = load double, ptr %arrayidx16, align 8, !tbaa !11, !invariant.load !15
