...
for.cond.preheader:                               ; preds = %entry
  ...
  br i1 %cmp2, label %for.cond1.preheader.split, label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.cond
  br label %for.cond

for.cond1.preheader.split:                        ; preds = %for.cond.preheader
...
for.cond1:                                        ; preds = %for.cond1.preheader.split, %for.end38
  %indvars.iv28 = phi i64 [ 0, %for.cond1.preheader.split ], [ %indvars.iv.next29, %for.end38 ]
  br label %for.cond4

for.cond4:                                        ; preds = %for.cond1, %for.inc22
  %indvars.iv18 = phi i64 [ 0, %for.cond1 ], [ %indvars.iv.next19, %for.inc22 ]
  %exitcond22.not = icmp eq i64 %indvars.iv18, %wide.trip.count21
  br i1 %exitcond22.not, label %for.cond25, label %for.body6

for.body6:                                        ; preds = %for.cond4
  %arrayidx = getelementptr inbounds nuw double, ptr %sum, i64 %indvars.iv18
...
for.inc:                                          ; preds = %for.cond7
  %arrayidx15 = getelementptr inbounds nuw [140 x [160 x double]], ptr %A, i64 0, i64 %indvars.iv28, i64 %indvars.iv
  %0 = load double, ptr %arrayidx15, align 8, !tbaa !11, !invariant.load !15
  %arrayidx19 = getelementptr inbounds nuw [160 x double], ptr %C4, i64 %indvars.iv, i64 %indvars.iv18
...
for.cond25:                                       ; preds = %for.cond4, %for.inc36
  %indvars.iv23 = phi i64 [ %indvars.iv.next24, %for.inc36 ], [ 0, %for.cond4 ]
  %exitcond27.not = icmp eq i64 %indvars.iv23, %wide.trip.count21
  br i1 %exitcond27.not, label %for.end38, label %for.inc36

for.inc36:                                        ; preds = %for.cond25
  %arrayidx29 = getelementptr inbounds nuw double, ptr %sum, i64 %indvars.iv23
  %3 = load double, ptr %arrayidx29, align 8, !tbaa !11, !invariant.load !15
  %arrayidx35 = getelementptr inbounds nuw [140 x [160 x double]], ptr %A, i64 0, i64 %indvars.iv28, i64 %indvars.iv23
...
for.cond:                                         ; preds = %for.inc15, %entry
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc15 ], [ 0, %entry ]
  %exitcond21.not = icmp eq i64 %indvars.iv18, 150
  br i1 %exitcond21.not, label %for.body25.preheader, label %for.cond1
...
for.cond1:                                        ; preds = %for.cond, %for.inc12
  ...
  %exitcond17.not = icmp eq i64 %indvars.iv13, 140
  br i1 %exitcond17.not, label %for.inc15, label %for.cond4.preheader
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx11 = getelementptr inbounds nuw [140 x [160 x double]], ptr %A, i64 %indvars.iv18, i64 %indvars.iv13, i64 %indvars.iv
