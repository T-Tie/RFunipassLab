...
entry:
  ...
  store double -9.990000e+02, ptr %call1, align 8, !tbaa !11
  store double 0.000000e+00, ptr %call2, align 8, !tbaa !11
  store double 2.001000e+00, ptr %call, align 8, !tbaa !11
  call void @outlined_ir_func_0()
  unreachable
}
...
define internal void @outlined_ir_func_0() #12 {
newFuncRoot:
...
for.body.i:                                       ; preds = %for.body.i, %entry_to_outline
  br label %for.body.i
}
...
attributes #12 = { minsize noreturn nounwind optsize uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
