...
entry:
  %call = tail call ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #14
  %call1 = tail call ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #14
  br label %for.cond.i
...
for.cond.i4:                                      ; preds = %for.end191.i, %init_array.exit
  %t.0.i = phi i32 [ 1, %init_array.exit ], [ %inc23.i1.i, %for.end191.i ]
...
for.cond8.i:                                      ; preds = %for.inc.i9, %for.cond8.preheader.i
  %indvars.iv.i7 = phi i64 [ 1, %for.cond8.preheader.i ], [ %indvars.iv.next.i10, %for.inc.i9 ]
  %exitcond.not.i8 = icmp eq i64 %indvars.iv.i7, 119
  br i1 %exitcond.not.i8, label %for.cond4.i6, label %for.inc.i9, !llvm.loop !20

for.inc.i9:                                       ; preds = %for.cond8.i
  ...
  %5 = load double, ptr %arrayidx15.i, align 8, !tbaa !5, !invariant.load !21
  ...
  %6 = load double, ptr %arrayidx21.i, align 8, !tbaa !5, !invariant.load !21
  %7 = tail call double @llvm.fmuladd.f64(double noundef %6, double noundef -2.000000e+00, double %5) #22
  ...
  %8 = load double, ptr %arrayidx28.i, align 8, !tbaa !5, !invariant.load !21
  ...
  %9 = load double, ptr %arrayidx36.i, align 8, !tbaa !5, !invariant.load !21
  %10 = tail call double @llvm.fmuladd.f64(double noundef %6, double noundef -2.000000e+00, double %9) #22
  %arrayidx50.i = getelementptr inbounds [120 x [120 x double]], ptr %call, i64 %indvars.iv96.i, i64 %4, i64 %indvars.iv.i7
  %11 = load double, ptr %arrayidx50.i, align 8, !tbaa !5, !invariant.load !21
  %add51.i = fadd double %10, %11
  %mul52.i = fmul double %add51.i, 1.250000e-01
  %12 = tail call double @llvm.fmuladd.f64(double noundef %add29.i, double noundef 1.250000e-01, double %mul52.i) #22
  %indvars.iv.next.i10 = add nuw nsw i64 %indvars.iv.i7, 1
  %arrayidx59.i = getelementptr inbounds nuw [120 x [120 x double]], ptr %call, i64 %indvars.iv96.i, i64 %indvars.iv91.i, i64 %indvars.iv.next.i10
  %13 = load double, ptr %arrayidx59.i, align 8, !tbaa !5, !invariant.load !21
  %14 = tail call double @llvm.fmuladd.f64(double noundef %6, double noundef -2.000000e+00, double %13) #22
  ...
  %16 = load double, ptr %arrayidx72.i, align 8, !tbaa !5, !invariant.load !21
  %add73.i = fadd double %14, %16
  %17 = tail call double @llvm.fmuladd.f64(double noundef %add73.i, double noundef 1.250000e-01, double %12) #22
...
for.cond93.i:                                     ; preds = %for.cond1.i5, %for.inc189.i
  %indvars.iv110.i = phi i64 [ %indvars.iv.next111.i, %for.inc189.i ], [ 1, %for.cond1.i5 ]
...
for.cond97.i:                                     ; preds = %for.cond101.i, %for.cond93.i
  ...
  br i1 %exitcond109.not.i, label %for.inc189.i, label %for.cond101.preheader.i
...
for.cond101.i:                                    ; preds = %for.inc183.i, %for.cond101.preheader.i
  %indvars.iv100.i = phi i64 [ 1, %for.cond101.preheader.i ], [ %indvars.iv.next101.i, %for.inc183.i ]
  %exitcond104.not.i = icmp eq i64 %indvars.iv100.i, 119
  br i1 %exitcond104.not.i, label %for.cond97.i, label %for.inc183.i, !llvm.loop !23

for.inc183.i:                                     ; preds = %for.cond101.i
  ...
  %19 = load double, ptr %arrayidx111.i, align 8, !tbaa !5, !invariant.load !21
  ...
  %20 = load double, ptr %arrayidx117.i, align 8, !tbaa !5, !invariant.load !21
  %21 = tail call double @llvm.fmuladd.f64(double noundef %20, double noundef -2.000000e+00, double %19) #22
  ...
  %22 = load double, ptr %arrayidx124.i, align 8, !tbaa !5, !invariant.load !21
  ...
  %23 = load double, ptr %arrayidx132.i, align 8, !tbaa !5, !invariant.load !21
  %24 = tail call double @llvm.fmuladd.f64(double noundef %20, double noundef -2.000000e+00, double %23) #22
  %arrayidx146.i = getelementptr inbounds [120 x [120 x double]], ptr %call1, i64 %indvars.iv110.i, i64 %18, i64 %indvars.iv100.i
  %25 = load double, ptr %arrayidx146.i, align 8, !tbaa !5, !invariant.load !21
  %add147.i = fadd double %24, %25
  %mul148.i = fmul double %add147.i, 1.250000e-01
  %26 = tail call double @llvm.fmuladd.f64(double noundef %add125.i, double noundef 1.250000e-01, double %mul148.i) #22
  ...
  %27 = load double, ptr %arrayidx155.i, align 8, !tbaa !5, !invariant.load !21
  %28 = tail call double @llvm.fmuladd.f64(double noundef %20, double noundef -2.000000e+00, double %27) #22
  ...
  %30 = load double, ptr %arrayidx168.i, align 8, !tbaa !5, !invariant.load !21
  %add169.i = fadd double %28, %30
  %31 = tail call double @llvm.fmuladd.f64(double noundef %add169.i, double noundef 1.250000e-01, double %26) #22
  ...
  br label %for.cond101.i, !llvm.loop !24

for.inc189.i:                                     ; preds = %for.cond97.i
  %indvars.iv.next111.i = add nuw nsw i64 %indvars.iv110.i, 1
  br label %for.cond93.i, !llvm.loop !25

for.end191.i:                                     ; preds = %for.cond93.i
  %inc23.i1.i = add nuw nsw i32 %t.0.i, 1
  br label %for.cond.i4
...
land.lhs.true:                                    ; preds = %kernel_heat_3d.exit
  %32 = load ptr, ptr %argv, align 8, !tbaa !26, !invariant.load !21
  %strcmpload = load i8, ptr %32, align 1, !invariant.load !21
  %tobool.not = icmp eq i8 %strcmpload, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call fastcc void @print_array(i32 noundef 120, ptr nofree noundef readonly captures(none) %call) #23
  br label %if.end
...
for.inc:                                          ; preds = %for.body7, %if.then
  ...
  %7 = load double, ptr %arrayidx16, align 8, !tbaa !5, !invariant.load !21
