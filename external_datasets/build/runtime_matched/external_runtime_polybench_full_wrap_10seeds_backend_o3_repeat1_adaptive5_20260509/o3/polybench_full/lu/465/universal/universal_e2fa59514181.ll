...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef writeonly captures(none) %call) #21
  unreachable
}

; Function Attrs: nofree norecurse noreturn nosync nounwind memory(argmem: write) uwtable
define internal fastcc void @init_array(ptr nofree noundef writeonly captures(none) %A) unnamed_addr #12 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.end18, %entry
  %indvars.iv13 = phi i64 [ %indvars.iv.next14, %for.end18 ], [ 0, %entry ]
  br label %for.cond1

for.cond1:                                        ; preds = %for.body3, %for.cond
  %cmp2 = phi i1 [ true, %for.cond ], [ false, %for.body3 ]
  %j.0 = phi i64 [ 0, %for.cond ], [ 1, %for.body3 ]
  br i1 %cmp2, label %for.body3, label %for.cond8

for.body3:                                        ; preds = %for.cond1
  %arrayidx6 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv13, i64 %j.0
...
for.cond8:                                        ; preds = %for.cond1, %for.body11
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body11 ], [ 1, %for.cond1 ]
  %exitcond.not = icmp eq i64 %indvars.iv, 2000
  br i1 %exitcond.not, label %for.end18, label %for.body11

for.body11:                                       ; preds = %for.cond8
  %arrayidx15 = getelementptr inbounds nuw [2000 x double], ptr %A, i64 %indvars.iv13, i64 %indvars.iv
...
if.then_after_outline.exitStub:
  ...
  %1 = tail call i64 @fwrite(ptr nonnull @.str.4, i64 50, i64 1, ptr %0) #22
  ret void
}
