; ModuleID = '/root/exp/RFunipassLab/external_datasets/ir/polybench_full/lu.ll'
...
if.then.i.i.i:                                    ; preds = %for.end25.i
  ...
  %18 = call i64 @fwrite(ptr nonnull @.str.4, i64 50, i64 1, ptr %17) #14
  call void @exit(i32 noundef 1) #15
  unreachable
...
for.cond48.preheader.i:                           ; preds = %for.inc74.i, %polybench_alloc_data.exit.i
  ...
  %scevgep23 = getelementptr nuw i8, ptr %0, i64 %19
...
for.cond52.preheader.i:                           ; preds = %for.inc71.i, %for.cond48.preheader.i
  ...
  br i1 %found.conflict, label %for.body55.i, label %vector.body30.preheader

vector.body30.preheader:                          ; preds = %for.cond52.preheader.i
...
vector.body30:                                    ; preds = %vector.body30.preheader, %vector.body30
  %index31 = phi i64 [ %index.next32, %vector.body30 ], [ 0, %vector.body30.preheader ]
  %21 = or disjoint i64 %index31, 1
  %22 = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %index31, i64 %indvars.iv94.i
  ...
  %28 = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %15, i64 0, i64 %indvars.iv90.i, i64 %index31
  ...
  %index.next32 = add nuw i64 %index31, 2
  %30 = icmp eq i64 %index.next32, 2000
  br i1 %30, label %for.inc71.i, label %vector.body30, !llvm.loop !31
...
for.inc71.i:                                      ; preds = %vector.body30, %for.body55.i
...
for.cond81.preheader.i.preheader:                 ; preds = %for.inc74.i
  ...
  br label %vector.memcheck35

vector.memcheck35:                                ; preds = %for.inc96.i, %for.cond81.preheader.i.preheader
  %indvars.iv106.i = phi i64 [ %indvars.iv.next107.i, %for.inc96.i ], [ 0, %for.cond81.preheader.i.preheader ]
  br i1 %diff.check, label %for.body84.i, label %vector.body38

vector.body38:                                    ; preds = %vector.memcheck35, %vector.body38
  %index39 = phi i64 [ %index.next41, %vector.body38 ], [ 0, %vector.memcheck35 ]
  %36 = getelementptr inbounds nuw [2000 x [2000 x double]], ptr %15, i64 0, i64 %indvars.iv106.i, i64 %index39
  %wide.load40 = load <2 x double>, ptr %36, align 8, !tbaa !11
  %37 = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv106.i, i64 %index39
  store <2 x double> %wide.load40, ptr %37, align 8, !tbaa !11
  %index.next41 = add nuw i64 %index39, 2
  %38 = icmp eq i64 %index.next41, 2000
  br i1 %38, label %for.inc96.i, label %vector.body38, !llvm.loop !35

for.body84.i:                                     ; preds = %vector.memcheck35, %for.body84.i
  %indvars.iv102.i = phi i64 [ %indvars.iv.next103.i, %for.body84.i ], [ 0, %vector.memcheck35 ]
...
for.inc96.i:                                      ; preds = %vector.body38, %for.body84.i
  %indvars.iv.next107.i = add nuw nsw i64 %indvars.iv106.i, 1
  %exitcond109.not.i = icmp eq i64 %indvars.iv.next107.i, 2000
  br i1 %exitcond109.not.i, label %init_array.exit, label %vector.memcheck35, !llvm.loop !37
...
init_array.exit:                                  ; preds = %for.inc96.i
  ...
  %call.i.i6 = call i32 @gettimeofday(ptr noundef nonnull %Tp.i.i, ptr noundef null) #13
...
for.cond1.preheader.i8:                           ; preds = %for.inc53.i, %polybench_timer_start.exit
  %indvars.iv57.i = phi i64 [ 0, %polybench_timer_start.exit ], [ %indvars.iv.next58.i, %for.inc53.i ]
  %cmp238.not.i = icmp eq i64 %indvars.iv57.i, 0
  br i1 %cmp238.not.i, label %for.inc53.i, label %for.cond4.preheader.lr.ph.i

for.cond4.preheader.lr.ph.i:                      ; preds = %for.cond1.preheader.i8
  %arrayidx24.phi.trans.insert.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv57.i, i64 0
  br label %for.cond4.preheader.i

for.cond31.preheader.us.i:                        ; preds = %for.end.i12, %for.cond31.for.inc50_crit_edge.us.i
  %indvars.iv59.i = phi i64 [ %indvars.iv.next60.i, %for.cond31.for.inc50_crit_edge.us.i ], [ %indvars.iv57.i, %for.end.i12 ]
  %arrayidx45.us.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv57.i, i64 %indvars.iv59.i
  %arrayidx45.promoted.us.i = load double, ptr %arrayidx45.us.i, align 8, !tbaa !11
  br label %for.body33.us.i

for.body33.us.i:                                  ; preds = %for.body33.us.i, %for.cond31.preheader.us.i
  %indvars.iv53.i = phi i64 [ 0, %for.cond31.preheader.us.i ], [ %indvars.iv.next54.i, %for.body33.us.i ]
  %43 = phi double [ %arrayidx45.promoted.us.i, %for.cond31.preheader.us.i ], [ %46, %for.body33.us.i ]
  %arrayidx37.us.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv57.i, i64 %indvars.iv53.i
  %44 = load double, ptr %arrayidx37.us.i, align 8, !tbaa !11
  %arrayidx41.us.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv53.i, i64 %indvars.iv59.i
  %45 = load double, ptr %arrayidx41.us.i, align 8, !tbaa !11
  %neg46.us.i = fneg double %44
  %46 = call double @llvm.fmuladd.f64(double %neg46.us.i, double %45, double %43)
  store double %46, ptr %arrayidx45.us.i, align 8, !tbaa !11
  %indvars.iv.next54.i = add nuw nsw i64 %indvars.iv53.i, 1
  %exitcond56.not.i = icmp eq i64 %indvars.iv.next54.i, %indvars.iv57.i
  br i1 %exitcond56.not.i, label %for.cond31.for.inc50_crit_edge.us.i, label %for.body33.us.i, !llvm.loop !38

for.cond31.for.inc50_crit_edge.us.i:              ; preds = %for.body33.us.i
  %indvars.iv.next60.i = add nuw nsw i64 %indvars.iv59.i, 1
  %exitcond62.not.i = icmp eq i64 %indvars.iv.next60.i, 2000
  br i1 %exitcond62.not.i, label %for.inc53.i, label %for.cond31.preheader.us.i, !llvm.loop !39

for.cond4.preheader.i:                            ; preds = %for.end.i12, %for.cond4.preheader.lr.ph.i
  %indvars.iv48.i = phi i64 [ 0, %for.cond4.preheader.lr.ph.i ], [ %indvars.iv.next49.i, %for.end.i12 ]
  %cmp536.not.i = icmp eq i64 %indvars.iv48.i, 0
  br i1 %cmp536.not.i, label %for.cond4.preheader.for.end_crit_edge.i, label %for.body6.lr.ph.i
...
for.body6.lr.ph.i:                                ; preds = %for.cond4.preheader.i
  %arrayidx16.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv57.i, i64 %indvars.iv48.i
...
for.body6.i:                                      ; preds = %for.body6.i, %for.body6.lr.ph.i
  ...
  %47 = phi double [ %arrayidx16.promoted.i, %for.body6.lr.ph.i ], [ %50, %for.body6.i ]
  %arrayidx8.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv57.i, i64 %indvars.iv.i9
  %48 = load double, ptr %arrayidx8.i, align 8, !tbaa !11
  %arrayidx12.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv.i9, i64 %indvars.iv48.i
  %49 = load double, ptr %arrayidx12.i, align 8, !tbaa !11
  %neg.i = fneg double %48
  %50 = call double @llvm.fmuladd.f64(double %neg.i, double %49, double %47)
  store double %50, ptr %arrayidx16.i, align 8, !tbaa !11
  %indvars.iv.next.i10 = add nuw nsw i64 %indvars.iv.i9, 1
  %exitcond.not.i11 = icmp eq i64 %indvars.iv.next.i10, %indvars.iv48.i
  br i1 %exitcond.not.i11, label %for.end.i12, label %for.body6.i, !llvm.loop !40

for.end.i12:                                      ; preds = %for.body6.i, %for.cond4.preheader.for.end_crit_edge.i
  %51 = phi double [ %.pre.i, %for.cond4.preheader.for.end_crit_edge.i ], [ %50, %for.body6.i ]
  %arrayidx20.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv48.i, i64 %indvars.iv48.i
  %52 = load double, ptr %arrayidx20.i, align 8, !tbaa !11
  %arrayidx24.i = getelementptr inbounds nuw [2000 x double], ptr %0, i64 %indvars.iv57.i, i64 %indvars.iv48.i
  %div.i13 = fdiv double %51, %52
  store double %div.i13, ptr %arrayidx24.i, align 8, !tbaa !11
  %indvars.iv.next49.i = add nuw nsw i64 %indvars.iv48.i, 1
  %exitcond52.not.i = icmp eq i64 %indvars.iv.next49.i, %indvars.iv57.i
  br i1 %exitcond52.not.i, label %for.cond31.preheader.us.i, label %for.cond4.preheader.i, !llvm.loop !41

for.inc53.i:                                      ; preds = %for.cond31.for.inc50_crit_edge.us.i, %for.cond1.preheader.i8
  %indvars.iv.next58.i = add nuw nsw i64 %indvars.iv57.i, 1
  %exitcond64.not.i = icmp eq i64 %indvars.iv.next58.i, 2000
  br i1 %exitcond64.not.i, label %kernel_lu.exit, label %for.cond1.preheader.i8, !llvm.loop !42

kernel_lu.exit:                                   ; preds = %for.inc53.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %Tp.i.i14) #13
  %call.i.i15 = call i32 @gettimeofday(ptr noundef nonnull %Tp.i.i14, ptr noundef null) #13
  %cmp.not.i.i16 = icmp eq i32 %call.i.i15, 0
  br i1 %cmp.not.i.i16, label %polybench_timer_stop.exit, label %if.then.i.i17

if.then.i.i17:                                    ; preds = %kernel_lu.exit
...
polybench_timer_stop.exit:                        ; preds = %kernel_lu.exit, %if.then.i.i17
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %Tp.i.i14) #13
...
land.lhs.true:                                    ; preds = %polybench_timer_stop.exit
  %57 = load ptr, ptr %argv, align 8, !tbaa !43
...
if.end:                                           ; preds = %if.then, %for.body4
  ...
  %call9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.5.10, double noundef %8) #16
...
for.end12:                                        ; preds = %for.inc10
  ...
  %call13 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %9, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3.8) #16
  %10 = load ptr, ptr @stderr, align 8, !tbaa !15
  %11 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 22, i64 1, ptr %10) #14
  ret void
}
