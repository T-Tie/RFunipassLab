...
for.cond:                                         ; preds = %if.end62, %entry
  %outp.0 = phi ptr [ %outdata, %entry ], [ %outp.1, %if.end62 ]
  %inp.0 = phi ptr [ %indata, %entry ], [ %incdec.ptr, %if.end62 ]
  %len.addr.0 = phi i32 [ %len, %entry ], [ %dec, %if.end62 ]
  %step.0 = phi i32 [ %2, %entry ], [ %6, %if.end62 ]
  %valpred.0 = phi i32 [ %conv, %entry ], [ %valpred.2, %if.end62 ]
  %index.0 = phi i32 [ %conv2, %entry ], [ %spec.store.select2, %if.end62 ]
  %outputbuffer.0 = phi i32 [ 0, %entry ], [ %outputbuffer.1, %if.end62 ]
  %bufferstep.0 = phi i1 [ false, %entry ], [ %7, %if.end62 ]
  %cmp = icmp sgt i32 %len.addr.0, 0
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %incdec.ptr = getelementptr inbounds nuw i8, ptr %inp.0, i64 2
  %3 = load i16, ptr %inp.0, align 2, !tbaa !13
  ...
  %valpred.1 = add i32 %valpred.1.p, %valpred.0
...
if.else57:                                        ; preds = %for.body
  ...
  store i8 %conv60, ptr %outp.0, align 1, !tbaa !14
  br label %if.end62
...
if.end62:                                         ; preds = %if.else57, %if.then56
  ...
  %7 = xor i1 %bufferstep.0, true
  br label %for.cond, !llvm.loop !15

for.end:                                          ; preds = %for.cond
  %smin = tail call i32 @llvm.smin.i32(i32 %len, i32 0)
  %8 = sub i32 %len, %smin
  %9 = trunc i32 %8 to i1
  br i1 %9, label %if.then65, label %if.end68

if.then65:                                        ; preds = %for.end
  %conv66 = trunc nuw i32 %outputbuffer.0 to i8
  store i8 %conv66, ptr %outp.0, align 1, !tbaa !14
  br label %if.end68
...
for.cond:                                         ; preds = %if.end, %entry
  ...
  %step.0 = phi i32 [ %2, %entry ], [ %6, %if.end ]
  %valpred.0 = phi i32 [ %conv, %entry ], [ %valpred.2, %if.end ]
  %index.0 = phi i32 [ %conv2, %entry ], [ %spec.store.select2, %if.end ]
  %inputbuffer.0 = phi i32 [ 0, %entry ], [ %inputbuffer.1, %if.end ]
  %bufferstep.0 = phi i1 [ true, %entry ], [ %7, %if.end ]
  %cmp = icmp sgt i32 %len.addr.0, 0
  br i1 %cmp, label %for.body, label %for.end
...
if.else:                                          ; preds = %for.body
  ...
  %3 = load i8, ptr %inp.0, align 1, !tbaa !14
  %conv431 = zext i8 %3 to i32
  %shr = lshr i32 %conv431, 4
  br label %if.end

if.end:                                           ; preds = %for.body, %if.else
  %inp.1 = phi ptr [ %incdec.ptr, %if.else ], [ %inp.0, %for.body ]
  %delta.0.in = phi i32 [ %shr, %if.else ], [ %inputbuffer.0, %for.body ]
  %inputbuffer.1 = phi i32 [ %conv431, %if.else ], [ %inputbuffer.0, %for.body ]
...
for.cond.preheader:                               ; preds = %if.end8
  %3 = load i64, ptr %loop_wrap2, align 8, !tbaa !21
  %div7 = lshr i32 %conv, 1
  %smax = call i64 @llvm.smax.i64(i64 %3, i64 0)
  br label %for.cond

for.cond:                                         ; preds = %for.cond.preheader, %for.body
  %loop_wrap1.0 = phi i64 [ %inc, %for.body ], [ 0, %for.cond.preheader ]
  %exitcond.not = icmp eq i64 %loop_wrap1.0, %smax
  br i1 %exitcond.not, label %cleanup, label %for.body

for.body:                                         ; preds = %for.cond
  store i32 %2, ptr @state, align 4
  call void @adpcm_coder(ptr noundef nonnull @sbuf, ptr noundef nonnull @abuf, i32 noundef %div7, ptr noundef nonnull @state)
