...
entry:
  ...
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call1, ptr nofree noundef nonnull writeonly captures(none) %call2, ptr nofree noundef nonnull writeonly captures(none) %call4, ptr nofree noundef nonnull writeonly captures(none) %call5) #17
...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  br i1 %exitcond21.not, label %for.cond11, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx7 = getelementptr inbounds nuw [1000 x double], ptr %A, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond11:                                       ; preds = %for.cond, %for.inc34
  %indvars.iv28 = phi i64 [ %indvars.iv.next29, %for.inc34 ], [ 0, %for.cond ]
  %exitcond31.not = icmp eq i64 %indvars.iv28, 1000
  br i1 %exitcond31.not, label %for.cond37, label %for.cond15

for.cond15:                                       ; preds = %for.cond11, %for.inc31
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc31 ], [ 0, %for.cond11 ]
  %exitcond27.not = icmp eq i64 %indvars.iv22, 900
  br i1 %exitcond27.not, label %for.inc34, label %for.inc31

for.inc31:                                        ; preds = %for.cond15
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %3 = mul nuw nsw i64 %indvars.iv.next23, %indvars.iv28
  %4 = trunc i64 %3 to i32
  %5 = add i32 %4, 2
  %rem22 = urem i32 %5, 900
  %conv23 = uitofp nneg i32 %rem22 to double
  %div26 = fdiv double %conv23, 4.500000e+03
  %arrayidx30 = getelementptr inbounds nuw [900 x double], ptr %B, i64 %indvars.iv28, i64 %indvars.iv22
...
for.cond37:                                       ; preds = %for.cond11, %for.inc59
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc59 ], [ 0, %for.cond11 ]
  %exitcond41.not = icmp eq i64 %indvars.iv38, 900
  br i1 %exitcond41.not, label %for.cond62, label %for.cond41

for.cond41:                                       ; preds = %for.cond37, %for.inc56
  %indvars.iv32 = phi i64 [ %indvars.iv.next33, %for.inc56 ], [ 0, %for.cond37 ]
  %exitcond37.not = icmp eq i64 %indvars.iv32, 1200
  br i1 %exitcond37.not, label %for.inc59, label %for.inc56

for.inc56:                                        ; preds = %for.cond41
  %6 = add nuw nsw i64 %indvars.iv32, 3
  %7 = mul nuw nsw i64 %6, %indvars.iv38
  %8 = trunc nuw nsw i64 %7 to i32
  %rem47 = urem i32 %8, 1100
  %conv48 = uitofp nneg i32 %rem47 to double
  %div51 = fdiv double %conv48, 5.500000e+03
  %arrayidx55 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv38, i64 %indvars.iv32
  store double %div51, ptr %arrayidx55, align 8, !tbaa !11
  %indvars.iv.next33 = add nuw nsw i64 %indvars.iv32, 1
  br label %for.cond41, !llvm.loop !20

for.inc59:                                        ; preds = %for.cond41
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  br label %for.cond37, !llvm.loop !21

for.cond62:                                       ; preds = %for.cond37, %for.end84
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.end84 ], [ 0, %for.cond37 ]
  %exitcond52.not = icmp eq i64 %indvars.iv49, 1200
  br i1 %exitcond52.not, label %for.end87, label %for.cond66

for.cond66:                                       ; preds = %for.cond62, %for.inc82
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc82 ], [ 0, %for.cond62 ]
  %exitcond48.not = icmp eq i64 %indvars.iv42, 1100
  br i1 %exitcond48.not, label %for.end84, label %for.inc82
...
for.inc82:                                        ; preds = %for.cond66
  ...
  %arrayidx81 = getelementptr inbounds nuw [1100 x double], ptr %D, i64 %indvars.iv49, i64 %indvars.iv42
