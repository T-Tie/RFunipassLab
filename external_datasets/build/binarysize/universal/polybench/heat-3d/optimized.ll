...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #15
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1728000, i32 noundef 8) #15
...
for.inc:                                          ; preds = %for.cond4
  ...
  %arrayidx12 = getelementptr inbounds nuw [120 x [120 x double]], ptr %B, i64 0, i64 %indvars.iv8, i64 %indvars.iv
  store double %div, ptr %arrayidx12, align 8, !tbaa !11
  %arrayidx18 = getelementptr inbounds nuw [120 x [120 x double]], ptr %A, i64 0, i64 %indvars.iv8, i64 %indvars.iv
