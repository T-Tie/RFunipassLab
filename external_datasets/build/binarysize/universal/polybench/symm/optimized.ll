...
for.body:                                         ; preds = %entry, %for.end
  %indvars.iv9 = phi i64 [ 0, %entry ], [ %indvars.iv.next10, %for.end ]
  %0 = add nuw nsw i64 %indvars.iv9, 1200
  br label %for.cond1
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv9, i64 %indvars.iv
  ...
  %arrayidx15 = getelementptr inbounds nuw [1200 x double], ptr %B, i64 %indvars.iv9, i64 %indvars.iv
