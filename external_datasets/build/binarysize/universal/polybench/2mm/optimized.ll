...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %alpha) #17
  call void @llvm.lifetime.start.p0(i64 noundef 8, ptr noundef nonnull align 8 captures(none) dereferenceable(8) %beta) #17
  ...
  call fastcc void @init_array(ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %alpha, ptr noalias nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(8) %beta, ptr nofree noundef nonnull writeonly captures(none) %call1, ptr nofree noundef nonnull writeonly captures(none) %call2, ptr nofree noundef nonnull writeonly captures(none) %call3, ptr nofree noundef nonnull writeonly captures(none) %call4) #18
...
for.cond:                                         ; preds = %for.inc7, %entry
  %indvars.iv18 = phi i64 [ %indvars.iv.next19, %for.inc7 ], [ 0, %entry ]
  %exitcond21.not = icmp eq i64 %indvars.iv18, 800
  br i1 %exitcond21.not, label %for.cond10, label %for.cond1
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds nuw [1100 x double], ptr %A, i64 %indvars.iv18, i64 %indvars.iv
...
for.cond10:                                       ; preds = %for.cond, %for.inc31
  %indvars.iv27 = phi i64 [ %indvars.iv.next28, %for.inc31 ], [ 0, %for.cond ]
  %exitcond30.not = icmp eq i64 %indvars.iv27, 1100
  br i1 %exitcond30.not, label %for.cond34, label %for.cond14

for.cond14:                                       ; preds = %for.cond10, %for.inc28
  %indvars.iv22 = phi i64 [ %indvars.iv.next23, %for.inc28 ], [ 0, %for.cond10 ]
  %exitcond26.not = icmp eq i64 %indvars.iv22, 900
  br i1 %exitcond26.not, label %for.inc31, label %for.inc28

for.inc28:                                        ; preds = %for.cond14
  %indvars.iv.next23 = add nuw nsw i64 %indvars.iv22, 1
  %3 = mul nuw nsw i64 %indvars.iv.next23, %indvars.iv27
  %4 = trunc nuw nsw i64 %3 to i32
  %rem20 = urem i32 %4, 900
  %conv21 = uitofp nneg i32 %rem20 to double
  %div23 = fdiv double %conv21, 9.000000e+02
  %arrayidx27 = getelementptr inbounds nuw [900 x double], ptr %B, i64 %indvars.iv27, i64 %indvars.iv22
  store double %div23, ptr %arrayidx27, align 8, !tbaa !11
  br label %for.cond14, !llvm.loop !18

for.inc31:                                        ; preds = %for.cond14
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  br label %for.cond10, !llvm.loop !19

for.cond34:                                       ; preds = %for.cond10, %for.inc56
  %indvars.iv38 = phi i64 [ %indvars.iv.next39, %for.inc56 ], [ 0, %for.cond10 ]
  %exitcond41.not = icmp eq i64 %indvars.iv38, 900
  br i1 %exitcond41.not, label %for.cond59, label %for.cond38

for.cond38:                                       ; preds = %for.cond34, %for.inc53
  %indvars.iv31 = phi i64 [ %indvars.iv.next32, %for.inc53 ], [ 0, %for.cond34 ]
  %exitcond37.not = icmp eq i64 %indvars.iv31, 1200
  br i1 %exitcond37.not, label %for.inc56, label %for.inc53

for.inc53:                                        ; preds = %for.cond38
  %5 = add nuw nsw i64 %indvars.iv31, 3
  %6 = mul nuw nsw i64 %5, %indvars.iv38
  %7 = trunc i64 %6 to i32
  %8 = add i32 %7, 1
  %rem45 = urem i32 %8, 1200
  %conv46 = uitofp nneg i32 %rem45 to double
  %div48 = fdiv double %conv46, 1.200000e+03
  %arrayidx52 = getelementptr inbounds nuw [1200 x double], ptr %C, i64 %indvars.iv38, i64 %indvars.iv31
...
for.cond59:                                       ; preds = %for.cond34, %for.end79
  %indvars.iv48 = phi i64 [ %indvars.iv.next49, %for.end79 ], [ 0, %for.cond34 ]
  %exitcond51.not = icmp eq i64 %indvars.iv48, 800
  br i1 %exitcond51.not, label %for.end82, label %for.cond63

for.cond63:                                       ; preds = %for.cond59, %for.inc77
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %for.inc77 ], [ 0, %for.cond59 ]
  %exitcond47.not = icmp eq i64 %indvars.iv42, 1200
  br i1 %exitcond47.not, label %for.end79, label %for.inc77

for.inc77:                                        ; preds = %for.cond63
  %9 = add nuw nsw i64 %indvars.iv42, 2
  %10 = mul nuw nsw i64 %9, %indvars.iv48
  %11 = trunc nuw nsw i64 %10 to i32
  %rem69 = urem i32 %11, 1100
  %conv70 = uitofp nneg i32 %rem69 to double
  %div72 = fdiv double %conv70, 1.100000e+03
  %arrayidx76 = getelementptr inbounds nuw [1200 x double], ptr %D, i64 %indvars.iv48, i64 %indvars.iv42
...
if.then_after_outline.exitStub:
  ...
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull dereferenceable(51) @.str.4) #19
  ret void
}
