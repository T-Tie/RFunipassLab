...
entry:
  %call = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #15
  %call1 = tail call nonnull ptr @polybench_alloc_data(i64 noundef 1690000, i32 noundef 8) #15
  tail call fastcc void @init_array(ptr nofree noundef nonnull writeonly captures(none) %call, ptr nofree noundef nonnull writeonly captures(none) %call1) #17
  unreachable
}
...
for.inc:                                          ; preds = %for.cond1
  ...
  %arrayidx7 = getelementptr inbounds nuw [1300 x double], ptr %A, i64 %indvars.iv7, i64 %indvars.iv
  store double %div, ptr %arrayidx7, align 8, !tbaa !11
  %4 = trunc i64 %indvars.iv to i32
  %5 = add i32 %4, 3
  %conv10 = uitofp nneg i32 %5 to double
  %6 = tail call double @llvm.fmuladd.f64(double %conv, double %conv10, double noundef 3.000000e+00) #18
  %div12 = fdiv double %6, 1.300000e+03
  %arrayidx16 = getelementptr inbounds nuw [1300 x double], ptr %B, i64 %indvars.iv7, i64 %indvars.iv
