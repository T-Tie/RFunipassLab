...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %0 = phi double [ %add, %for.inc ], [ 0.000000e+00, %entry ]
...
for.cond1.i:                                      ; preds = %for.cond.i, %for.inc16.i
  %indvars.iv12.i = phi i64 [ %indvars.iv.next13.i, %for.inc16.i ], [ 0, %for.cond.i ]
  %exitcond15.not.i = icmp eq i64 %indvars.iv12.i, 2500
  br i1 %exitcond15.not.i, label %init_array.exit, label %for.cond5.i

for.cond5.i:                                      ; preds = %for.cond1.i, %for.inc13.i
  %indvars.iv8.i = phi i64 [ %indvars.iv.next9.i, %for.inc13.i ], [ 0, %for.cond1.i ]
  %exitcond11.not.i = icmp eq i64 %indvars.iv8.i, 2500
  br i1 %exitcond11.not.i, label %for.inc16.i, label %for.inc13.i

for.inc13.i:                                      ; preds = %for.cond5.i
  %arrayidx12.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv12.i, i64 %indvars.iv8.i
...
for.cond.i7:                                      ; preds = %for.inc195.i, %init_array.exit
  %indvars.iv17.i = phi i64 [ %indvars.iv.next18.i, %for.inc195.i ], [ 2499, %init_array.exit ]
  %1 = and i64 %indvars.iv17.i, 4294967295
  %cmp.i = icmp sgt i64 %indvars.iv17.i, -1
  br i1 %cmp.i, label %for.cond1.preheader.i, label %kernel_nussinov.exit

for.cond1.preheader.i:                            ; preds = %for.cond.i7
  %cmp28.i = icmp samesign ult i64 %indvars.iv17.i, 2499
  %2 = add nuw nsw i64 %indvars.iv17.i, 1
  %arrayidx77.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv17.i
  br label %for.cond1.i8

for.cond1.i8:                                     ; preds = %for.cond150.i, %for.cond1.preheader.i
  %indvars.iv19.i = phi i64 [ %indvars.iv17.i, %for.cond1.preheader.i ], [ %indvars.iv.next20.i, %for.cond150.i ]
  %indvars.iv.next20.i = add nuw nsw i64 %indvars.iv19.i, 1
  %exitcond.not.i9 = icmp eq i64 %indvars.iv19.i, 2499
  br i1 %exitcond.not.i9, label %for.inc195.i, label %if.then.i

if.then.i:                                        ; preds = %for.cond1.i8
  %arrayidx7.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv17.i, i64 %indvars.iv.next20.i
  %3 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20, !invariant.load !9
  %arrayidx12.i10 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv17.i, i64 %indvars.iv19.i
  %4 = load i32, ptr %arrayidx12.i10, align 4, !tbaa !20, !invariant.load !9
  %cmp13.not.i = icmp slt i32 %3, %4
  %spec.select.i = select i1 %cmp13.not.i, i64 %indvars.iv19.i, i64 %indvars.iv.next20.i
  %idxprom21.i = and i64 %spec.select.i, 4294967295
  %arrayidx22.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv17.i, i64 %idxprom21.i
...
if.then62.i:                                      ; preds = %if.then.i
  %arrayidx38.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv.next20.i
  %6 = load i32, ptr %arrayidx38.i, align 4, !tbaa !20, !invariant.load !9
  %cmp39.not.i = icmp slt i32 %5, %6
  %add277.i = zext i1 %cmp39.not.i to i64
  %spec.select9.i = add nuw nsw i64 %indvars.iv17.i, %add277.i
  %arrayidx50.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select9.i, i64 %indvars.iv.next20.i
  %7 = load i32, ptr %arrayidx50.i, align 4, !tbaa !20, !invariant.load !9
  store i32 %7, ptr %arrayidx7.i, align 4, !tbaa !20
  %cmp64.i = icmp slt i64 %indvars.iv17.i, %indvars.iv19.i
  %8 = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %2, i64 %indvars.iv19.i
...
if.then65.i:                                      ; preds = %if.then62.i
  ...
  %conv.i13 = sext i8 %10 to i32
  %arrayidx79.i = getelementptr inbounds nuw i8, ptr %call, i64 %indvars.iv.next20.i
  %11 = load i8, ptr %arrayidx79.i, align 1, !tbaa !18, !invariant.load !9
  %conv80.i = sext i8 %11 to i32
  %add81.i = add nsw i32 %conv80.i, %conv.i13
  %cmp82.i = icmp eq i32 %add81.i, 3
  %cond84.i = zext i1 %cmp82.i to i32
  %add85.i = add nsw i32 %9, %cond84.i
  %spec.select10.i = tail call i32 @llvm.smax.i32(i32 %7, i32 %add85.i)
  br label %if.end148.gvnsink.split.i

if.else.i:                                        ; preds = %if.then62.i
  %cmp127.not.i = icmp slt i32 %7, %9
  %spec.select11.v.i = select i1 %cmp127.not.i, i64 %indvars.iv19.i, i64 %indvars.iv.next20.i
  %spec.select12.v.i = select i1 %cmp127.not.i, i64 %2, i64 %indvars.iv17.i
  %idxprom139.i = and i64 %spec.select11.v.i, 4294967295
  %arrayidx140.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %spec.select12.v.i, i64 %idxprom139.i
  %12 = load i32, ptr %arrayidx140.i, align 4, !tbaa !20, !invariant.load !9
  br label %if.end148.gvnsink.split.i

if.end148.gvnsink.split.i:                        ; preds = %if.else.i, %if.then65.i
  %.sink.i = phi i32 [ %12, %if.else.i ], [ %spec.select10.i, %if.then65.i ]
  store i32 %.sink.i, ptr %arrayidx7.i, align 4, !tbaa !20
  br label %if.end148.i

if.end148.i:                                      ; preds = %if.end148.gvnsink.split.i, %if.then.i
  %invariant.gep14.i = getelementptr [2500 x i32], ptr %invariant.gep.i, i64 0, i64 %indvars.iv.next20.i
  br label %for.cond150.i

for.cond150.i:                                    ; preds = %for.body153.i, %if.end148.i
  %indvars.iv.i11 = phi i64 [ %indvars.iv.next.i12, %for.body153.i ], [ %1, %if.end148.i ]
  %cmp151.i = icmp slt i64 %indvars.iv.i11, %indvars.iv19.i
  br i1 %cmp151.i, label %for.body153.i, label %for.cond1.i8, !llvm.loop !24

for.body153.i:                                    ; preds = %for.cond150.i
  %indvars.iv.next.i12 = add nuw nsw i64 %indvars.iv.i11, 1
  %arrayidx161.i = getelementptr inbounds nuw [2500 x i32], ptr %call1, i64 %indvars.iv17.i, i64 %indvars.iv.next.i12
  %13 = load i32, ptr %arrayidx161.i, align 4, !tbaa !20, !invariant.load !9
  %gep15.i = getelementptr [2500 x i32], ptr %invariant.gep14.i, i64 %indvars.iv.i11
  %14 = load i32, ptr %gep15.i, align 4, !tbaa !20, !invariant.load !9
  %add167.i = add nsw i32 %14, %13
  %spec.select13.i = tail call i32 @llvm.smax.i32(i32 %5, i32 %add167.i)
  store i32 %spec.select13.i, ptr %arrayidx7.i, align 4, !tbaa !20
  br label %for.cond150.i, !llvm.loop !25

for.inc195.i:                                     ; preds = %for.cond1.i8
  %indvars.iv.next18.i = add nsw i64 %indvars.iv17.i, -1
  br label %for.cond.i7, !llvm.loop !26

kernel_nussinov.exit:                             ; preds = %for.cond.i7
...
for.cond:                                         ; preds = %for.inc11, %entry
  %indvars.iv4 = phi i32 [ %indvars.iv.next5, %for.inc11 ], [ 2500, %entry ]
...
for.cond2:                                        ; preds = %for.cond, %for.inc
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %for.inc ], [ %indvars.iv, %for.cond ]
